...
if TYPE_CHECKING:
    import capo_omics.types.activate_read_set_job_list
...
class ListReadSetActivationJobsResponse(TypedDict, closed=True):
    ...
    activation_jobs: NotRequired[
        "capo_omics.types.activate_read_set_job_list.ActivateReadSetJobList"
    ]
    """<p>A list of jobs.</p>"""
...
def serialize_json(value: ListReadSetActivationJobsResponse) -> dict:
    ...
    if "activation_jobs" in value:
        ...
        out["activationJobs"] = (
            capo_omics.types.activate_read_set_job_list.serialize_json(
...
def deserialize_json(data: dict) -> ListReadSetActivationJobsResponse:
    ...
    if "activationJobs" in data:
        ...
        out["activation_jobs"] = (
            capo_omics.types.activate_read_set_job_list.deserialize_json(
                data["activationJobs"]
            )
        )
    return out
