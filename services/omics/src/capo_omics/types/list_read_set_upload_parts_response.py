...
class ListReadSetUploadPartsResponse(TypedDict, closed=True):
    ...
    parts: NotRequired[
        "capo_omics.types.read_set_upload_part_list.ReadSetUploadPartList"
    ]
...
def serialize_json(value: ListReadSetUploadPartsResponse) -> dict:
    ...
    if "parts" in value:
        ...
        out["parts"] = capo_omics.types.read_set_upload_part_list.serialize_json(
            value["parts"]
        )
    return out
...
def deserialize_json(data: dict) -> ListReadSetUploadPartsResponse:
    ...
    if "parts" in data:
        ...
        out["parts"] = capo_omics.types.read_set_upload_part_list.deserialize_json(
            data["parts"]
        )
    return out
