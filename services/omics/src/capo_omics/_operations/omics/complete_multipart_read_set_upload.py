"""Generated from Smithy shape ``com.amazonaws.omics#CompleteMultipartReadSetUpload``."""
...
def handle_response(
    ...
    out: capo_omics.types.complete_multipart_read_set_upload_response.CompleteMultipartReadSetUploadResponse = capo_omics.types.complete_multipart_read_set_upload_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.complete_multipart_read_set_upload_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_complete_multipart_read_set_upload(
