...
def handle_response(
    ...
    out: capo_omics.types.get_annotation_store_version_response.GetAnnotationStoreVersionResponse = capo_omics.types.get_annotation_store_version_response.deserialize_json(
