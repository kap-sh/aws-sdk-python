...
def handle_response(
    ...
    out: capo_omics.types.update_variant_store_response.UpdateVariantStoreResponse = (
        capo_omics.types.update_variant_store_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.update_variant_store_request.serialize_json(input_)
    ).encode()
