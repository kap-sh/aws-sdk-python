"""Generated from Smithy shape ``com.amazonaws.omics#CreateRunGroup``."""
...
def handle_response(
    ...
    out: capo_omics.types.create_run_group_response.CreateRunGroupResponse = (
        capo_omics.types.create_run_group_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/runGroup"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_omics.types.create_run_group_request.serialize_json(input_)
    ).encode()
...
def create_run_group(
    ...
    capo_omics.types.create_run_group_response.CreateRunGroupResponse, zapros.Response
]:
...
async def async_create_run_group(
