"""Generated from Smithy shape ``com.amazonaws.omics#AcceptShare``."""
...
def handle_response(
    ...
    out: capo_omics.types.accept_share_response.AcceptShareResponse = (
        capo_omics.types.accept_share_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/share/{shareId}"
...
def accept_share(
    ...
    input_: capo_omics.types.accept_share_request.AcceptShareRequest,
) -> tuple[capo_omics.types.accept_share_response.AcceptShareResponse, zapros.Response]:
