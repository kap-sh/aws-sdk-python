"""Generated from Smithy shape ``com.amazonaws.omics#StartReadSetExportJob``."""
...
def handle_response(
    ...
    out: capo_omics.types.start_read_set_export_job_response.StartReadSetExportJobResponse = capo_omics.types.start_read_set_export_job_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sequencestore/{sequenceStoreId}/exportjob"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.start_read_set_export_job_request.serialize_json(input_)
    ).encode()
...
async def async_start_read_set_export_job(
