"""Generated from Smithy shape ``com.amazonaws.omics#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_omics.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_omics.types.list_tags_for_resource_response.deserialize_json(
