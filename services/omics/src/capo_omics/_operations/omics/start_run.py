"""Generated from Smithy shape ``com.amazonaws.omics#StartRun``."""
...
def handle_response(
    ...
    out: capo_omics.types.start_run_response.StartRunResponse = (
        capo_omics.types.start_run_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.start_run_request.serialize_json(input_)
    ).encode()
...
def start_run(
    ...
    input_: capo_omics.types.start_run_request.StartRunRequest,
) -> tuple[capo_omics.types.start_run_response.StartRunResponse, zapros.Response]:
