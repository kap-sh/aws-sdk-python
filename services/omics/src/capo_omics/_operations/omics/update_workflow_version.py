"""Generated from Smithy shape ``com.amazonaws.omics#UpdateWorkflowVersion``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.update_workflow_version_request.serialize_json(input_)
    ).encode()
...
async def async_update_workflow_version(
