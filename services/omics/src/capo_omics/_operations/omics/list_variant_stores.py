...
def handle_response(
    ...
    out: capo_omics.types.list_variant_stores_response.ListVariantStoresResponse = (
        capo_omics.types.list_variant_stores_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.list_variant_stores_request.serialize_json(input_)
    ).encode()
