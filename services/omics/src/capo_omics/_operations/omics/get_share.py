"""Generated from Smithy shape ``com.amazonaws.omics#GetShare``."""
...
def handle_response(
    ...
    out: capo_omics.types.get_share_response.GetShareResponse = (
        capo_omics.types.get_share_response.deserialize_json(
...
def get_share(
    ...
    input_: capo_omics.types.get_share_request.GetShareRequest,
) -> tuple[capo_omics.types.get_share_response.GetShareResponse, zapros.Response]:
