"""Generated from Smithy shape ``com.amazonaws.omics#BatchDeleteReadSet``."""
...
def handle_response(
    ...
    out: capo_omics.types.batch_delete_read_set_response.BatchDeleteReadSetResponse = (
        capo_omics.types.batch_delete_read_set_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.batch_delete_read_set_request.serialize_json(input_)
    ).encode()
...
async def async_batch_delete_read_set(
