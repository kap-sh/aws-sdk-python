"""Generated from Smithy shape ``com.amazonaws.omics#DeleteAnnotationStore``."""
...
def handle_response(
    ...
    out: capo_omics.types.delete_annotation_store_response.DeleteAnnotationStoreResponse = capo_omics.types.delete_annotation_store_response.deserialize_json(
...
async def async_delete_annotation_store(
