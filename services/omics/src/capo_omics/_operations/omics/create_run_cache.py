"""Generated from Smithy shape ``com.amazonaws.omics#CreateRunCache``."""
...
def handle_response(
    ...
    out: capo_omics.types.create_run_cache_response.CreateRunCacheResponse = (
        capo_omics.types.create_run_cache_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/runCache"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_omics.types.create_run_cache_request.serialize_json(input_)
    ).encode()
...
def create_run_cache(
    ...
    capo_omics.types.create_run_cache_response.CreateRunCacheResponse, zapros.Response
]:
...
async def async_create_run_cache(
