"""Generated from Smithy shape ``com.amazonaws.omics#ListAnnotationImportJobs``."""
...
import capo_omics.types.annotation_import_job_items
...
def handle_response(
    ...
    out: capo_omics.types.list_annotation_import_jobs_response.ListAnnotationImportJobsResponse = capo_omics.types.list_annotation_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/import/annotations"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.list_annotation_import_jobs_request.serialize_json(input_)
    ).encode()
...
async def async_list_annotation_import_jobs(
