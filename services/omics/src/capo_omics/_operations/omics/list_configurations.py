"""Generated from Smithy shape ``com.amazonaws.omics#ListConfigurations``."""
...
def handle_response(
    ...
    out: capo_omics.types.list_configurations_response.ListConfigurationsResponse = (
        capo_omics.types.list_configurations_response.deserialize_json(
