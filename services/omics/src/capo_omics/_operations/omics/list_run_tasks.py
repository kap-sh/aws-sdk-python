...
def handle_response(
    ...
    out: capo_omics.types.list_run_tasks_response.ListRunTasksResponse = (
        capo_omics.types.list_run_tasks_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_omics.types.list_run_tasks_request.ListRunTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_run_tasks(
    ...
    capo_omics.types.list_run_tasks_response.ListRunTasksResponse, zapros.Response
]:
