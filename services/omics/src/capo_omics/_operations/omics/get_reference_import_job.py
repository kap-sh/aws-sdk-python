...
def handle_response(
    ...
    out: capo_omics.types.get_reference_import_job_response.GetReferenceImportJobResponse = capo_omics.types.get_reference_import_job_response.deserialize_json(
