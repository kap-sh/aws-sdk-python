"""Generated from Smithy shape ``com.amazonaws.omics#ListReferenceImportJobs``."""
...
def handle_response(
    ...
    out: capo_omics.types.list_reference_import_jobs_response.ListReferenceImportJobsResponse = capo_omics.types.list_reference_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/referencestore/{referenceStoreId}/importjobs"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.list_reference_import_jobs_request.serialize_json(input_)
    ).encode()
...
async def async_list_reference_import_jobs(
