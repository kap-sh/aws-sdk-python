"""Generated from Smithy shape ``com.amazonaws.omics#CreateVariantStore``."""
...
def handle_response(
    ...
    out: capo_omics.types.create_variant_store_response.CreateVariantStoreResponse = (
        capo_omics.types.create_variant_store_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.create_variant_store_request.serialize_json(input_)
    ).encode()
...
async def async_create_variant_store(
