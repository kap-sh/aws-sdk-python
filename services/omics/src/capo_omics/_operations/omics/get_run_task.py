"""Generated from Smithy shape ``com.amazonaws.omics#GetRunTask``."""
...
import capo_omics.types.image_details
...
def handle_response(
    ...
    out: capo_omics.types.get_run_task_response.GetRunTaskResponse = (
        capo_omics.types.get_run_task_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/run/{id}/task/{taskId}"
...
def get_run_task(
    ...
    input_: capo_omics.types.get_run_task_request.GetRunTaskRequest,
) -> tuple[capo_omics.types.get_run_task_response.GetRunTaskResponse, zapros.Response]:
