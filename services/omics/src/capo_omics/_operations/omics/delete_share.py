"""Generated from Smithy shape ``com.amazonaws.omics#DeleteShare``."""
...
def handle_response(
    ...
    out: capo_omics.types.delete_share_response.DeleteShareResponse = (
        capo_omics.types.delete_share_response.deserialize_json(
...
def delete_share(
    ...
    input_: capo_omics.types.delete_share_request.DeleteShareRequest,
) -> tuple[capo_omics.types.delete_share_response.DeleteShareResponse, zapros.Response]:
