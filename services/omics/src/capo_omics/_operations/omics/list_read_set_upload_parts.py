"""Generated from Smithy shape ``com.amazonaws.omics#ListReadSetUploadParts``."""
...
import capo_omics.errors.not_supported_operation_exception
...
import capo_omics.types.read_set_upload_part_list
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NotSupportedOperationException":
            raise capo_omics.errors.not_supported_operation_exception.NotSupportedOperationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_omics.types.list_read_set_upload_parts_response.ListReadSetUploadPartsResponse = capo_omics.types.list_read_set_upload_parts_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.list_read_set_upload_parts_request.serialize_json(input_)
    ).encode()
...
async def async_list_read_set_upload_parts(
