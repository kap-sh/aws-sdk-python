"""Generated from Smithy shape ``com.amazonaws.omics#ListBatch``."""
...
import capo_omics.types.batch_list
...
def handle_response(
    ...
    out: capo_omics.types.list_batch_response.ListBatchResponse = (
        capo_omics.types.list_batch_response.deserialize_json(
...
def list_batch(
    ...
    input_: capo_omics.types.list_batch_request.ListBatchRequest,
) -> tuple[capo_omics.types.list_batch_response.ListBatchResponse, zapros.Response]:
