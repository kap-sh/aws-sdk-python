"""Generated from Smithy shape ``com.amazonaws.omics#ListReferenceStores``."""
...
def handle_response(
    ...
    out: capo_omics.types.list_reference_stores_response.ListReferenceStoresResponse = (
        capo_omics.types.list_reference_stores_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/referencestores"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.list_reference_stores_request.serialize_json(input_)
    ).encode()
...
async def async_list_reference_stores(
