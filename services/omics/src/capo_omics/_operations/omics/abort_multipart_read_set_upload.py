"""Generated from Smithy shape ``com.amazonaws.omics#AbortMultipartReadSetUpload``."""
...
def handle_response(
    ...
    out: capo_omics.types.abort_multipart_read_set_upload_response.AbortMultipartReadSetUploadResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_abort_multipart_read_set_upload(
