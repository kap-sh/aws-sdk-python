"""Generated from Smithy shape ``com.amazonaws.omics#GetS3AccessPolicy``."""
...
def handle_response(
    ...
    out: capo_omics.types.get_s3_access_policy_response.GetS3AccessPolicyResponse = (
        capo_omics.types.get_s3_access_policy_response.deserialize_json(
