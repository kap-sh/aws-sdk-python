"""Generated from Smithy shape ``com.amazonaws.omics#ListRunCaches``."""
...
import capo_omics.types.run_cache_list
...
def handle_response(
    ...
    out: capo_omics.types.list_run_caches_response.ListRunCachesResponse = (
        capo_omics.types.list_run_caches_response.deserialize_json(
...
def list_run_caches(
    ...
    capo_omics.types.list_run_caches_response.ListRunCachesResponse, zapros.Response
]:
...
async def async_list_run_caches(
