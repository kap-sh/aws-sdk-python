"""Generated from Smithy shape ``com.amazonaws.omics#UpdateRunCache``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.update_run_cache_request.serialize_json(input_)
    ).encode()
...
async def async_update_run_cache(
