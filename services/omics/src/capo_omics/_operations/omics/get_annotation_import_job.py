"""Generated from Smithy shape ``com.amazonaws.omics#GetAnnotationImportJob``."""
...
def handle_response(
    ...
    out: capo_omics.types.get_annotation_import_response.GetAnnotationImportResponse = (
        capo_omics.types.get_annotation_import_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/import/annotation/{jobId}"
...
async def async_get_annotation_import_job(
