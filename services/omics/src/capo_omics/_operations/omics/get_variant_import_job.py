"""Generated from Smithy shape ``com.amazonaws.omics#GetVariantImportJob``."""
...
import capo_omics.types.variant_import_item_details
...
def handle_response(
    ...
    out: capo_omics.types.get_variant_import_response.GetVariantImportResponse = (
        capo_omics.types.get_variant_import_response.deserialize_json(
...
async def async_get_variant_import_job(
