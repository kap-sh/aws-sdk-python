...
def handle_response(
    ...
    out: capo_omics.types.list_annotation_store_versions_response.ListAnnotationStoreVersionsResponse = capo_omics.types.list_annotation_store_versions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.list_annotation_store_versions_request.serialize_json(input_)
    ).encode()
