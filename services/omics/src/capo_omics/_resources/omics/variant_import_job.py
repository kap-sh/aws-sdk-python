...
class VariantImportJob:
    ...
    def create(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_omics.types.start_variant_import_request.StartVariantImportRequest]",
        ) -> OperationResponse[
            "capo_omics.types.start_variant_import_response.StartVariantImportResponse"
        ]:
            ...
            output, http_response = (
                capo_omics._operations.omics.start_variant_import_job.start_variant_import_job(
    ...
    def read(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_omics.types.get_variant_import_request.GetVariantImportRequest]",
        ) -> OperationResponse[
            "capo_omics.types.get_variant_import_response.GetVariantImportResponse"
        ]:
            ...
            output, http_response = (
                capo_omics._operations.omics.get_variant_import_job.get_variant_import_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_omics.types.cancel_variant_import_request.CancelVariantImportRequest]",
        ) -> OperationResponse[
            "capo_omics.types.cancel_variant_import_response.CancelVariantImportResponse"
        ]:
            ...
            output, http_response = (
                capo_omics._operations.omics.cancel_variant_import_job.cancel_variant_import_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_omics.types.list_variant_import_jobs_request.ListVariantImportJobsRequest]",
        ) -> OperationResponse[
            "capo_omics.types.list_variant_import_jobs_response.ListVariantImportJobsResponse"
        ]:
            ...
            output, http_response = (
                capo_omics._operations.omics.list_variant_import_jobs.list_variant_import_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
