...
class AnnotationImportJob:
    ...
    def create(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_omics.types.start_annotation_import_request.StartAnnotationImportRequest]",
        ) -> OperationResponse[
            "capo_omics.types.start_annotation_import_response.StartAnnotationImportResponse"
        ]:
            ...
            output, http_response = (
                capo_omics._operations.omics.start_annotation_import_job.start_annotation_import_job(
    ...
    def read(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_omics.types.get_annotation_import_request.GetAnnotationImportRequest]",
        ) -> OperationResponse[
            "capo_omics.types.get_annotation_import_response.GetAnnotationImportResponse"
        ]:
            ...
            output, http_response = (
                capo_omics._operations.omics.get_annotation_import_job.get_annotation_import_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_omics.types.cancel_annotation_import_request.CancelAnnotationImportRequest]",
        ) -> OperationResponse[
            "capo_omics.types.cancel_annotation_import_response.CancelAnnotationImportResponse"
        ]:
            ...
            output, http_response = (
                capo_omics._operations.omics.cancel_annotation_import_job.cancel_annotation_import_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_omics.types.list_annotation_import_jobs_request.ListAnnotationImportJobsRequest]",
        ) -> OperationResponse[
            "capo_omics.types.list_annotation_import_jobs_response.ListAnnotationImportJobsResponse"
        ]:
            ...
            output, http_response = (
                capo_omics._operations.omics.list_annotation_import_jobs.list_annotation_import_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
