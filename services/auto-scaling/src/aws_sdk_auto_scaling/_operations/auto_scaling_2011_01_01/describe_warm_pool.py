...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.describe_warm_pool_answer.DescribeWarmPoolAnswer = (
        aws_sdk_auto_scaling.types.describe_warm_pool_answer.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_auto_scaling.types.describe_warm_pool_type.DescribeWarmPoolType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.describe_warm_pool_type.serialize_query(input, pairs, "")
