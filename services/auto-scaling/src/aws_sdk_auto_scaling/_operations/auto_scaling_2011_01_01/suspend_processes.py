"""Generated from Smithy shape ``com.amazonaws.autoscaling#SuspendProcesses``."""
...
def build_request(
    ...
    input: aws_sdk_auto_scaling.types.scaling_process_query.ScalingProcessQuery,
) -> zapros.Request:
    ...
    aws_sdk_auto_scaling.types.scaling_process_query.serialize_query(input, pairs, "")
...
async def async_suspend_processes(
