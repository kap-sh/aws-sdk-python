"""Generated from Smithy shape ``com.amazonaws.autoscaling#PutNotificationConfiguration``."""
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.put_notification_configuration_type.PutNotificationConfigurationType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "PutNotificationConfiguration"))
    pairs.append(("Version", "2011-01-01"))
    import aws_sdk_auto_scaling.types.put_notification_configuration_type

    aws_sdk_auto_scaling.types.put_notification_configuration_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_put_notification_configuration(
