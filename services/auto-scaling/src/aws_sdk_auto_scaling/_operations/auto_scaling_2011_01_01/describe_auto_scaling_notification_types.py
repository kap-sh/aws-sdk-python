"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeAutoScalingNotificationTypes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeAutoScalingNotificationTypesResult")
    out: aws_sdk_auto_scaling.types.describe_auto_scaling_notification_types_answer.DescribeAutoScalingNotificationTypesAnswer = aws_sdk_auto_scaling.types.describe_auto_scaling_notification_types_answer.deserialize_query(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    pairs.append(("Action", "DescribeAutoScalingNotificationTypes"))
...
async def async_describe_auto_scaling_notification_types(
