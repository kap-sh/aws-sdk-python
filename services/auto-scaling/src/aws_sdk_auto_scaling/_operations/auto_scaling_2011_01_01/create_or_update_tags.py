...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.create_or_update_tags_type.CreateOrUpdateTagsType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.create_or_update_tags_type.serialize_query(
        input_, pairs, ""
    )
