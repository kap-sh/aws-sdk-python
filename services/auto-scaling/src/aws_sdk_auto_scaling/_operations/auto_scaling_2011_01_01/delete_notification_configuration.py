...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.delete_notification_configuration_type.DeleteNotificationConfigurationType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.delete_notification_configuration_type.serialize_query(
        input_, pairs, ""
    )
