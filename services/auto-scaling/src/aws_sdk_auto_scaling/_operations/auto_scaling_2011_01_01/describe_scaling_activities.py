"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeScalingActivities``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeScalingActivitiesResult")
    out: aws_sdk_auto_scaling.types.activities_type.ActivitiesType = (
        aws_sdk_auto_scaling.types.activities_type.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.describe_scaling_activities_type.DescribeScalingActivitiesType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeScalingActivities"))
    pairs.append(("Version", "2011-01-01"))
    aws_sdk_auto_scaling.types.describe_scaling_activities_type.serialize_query(
        input_, pairs, ""
    )
...
def describe_scaling_activities(
    ...
    input_: aws_sdk_auto_scaling.types.describe_scaling_activities_type.DescribeScalingActivitiesType,
) -> tuple[aws_sdk_auto_scaling.types.activities_type.ActivitiesType, zapros.Response]:
