...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.attach_traffic_sources_result_type.AttachTrafficSourcesResultType = aws_sdk_auto_scaling.types.attach_traffic_sources_result_type.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.attach_traffic_sources_type.AttachTrafficSourcesType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.attach_traffic_sources_type.serialize_query(
        input_, pairs, ""
    )
