...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.start_instance_refresh_answer.StartInstanceRefreshAnswer = aws_sdk_auto_scaling.types.start_instance_refresh_answer.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.start_instance_refresh_type.StartInstanceRefreshType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
