...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.enable_metrics_collection_query.EnableMetricsCollectionQuery,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.enable_metrics_collection_query.serialize_query(
        input_, pairs, ""
    )
