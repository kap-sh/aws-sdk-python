...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.detach_instances_answer.DetachInstancesAnswer = (
        aws_sdk_auto_scaling.types.detach_instances_answer.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_auto_scaling.types.detach_instances_query.DetachInstancesQuery,
) -> zapros.Request:
    ...
    aws_sdk_auto_scaling.types.detach_instances_query.serialize_query(input, pairs, "")
