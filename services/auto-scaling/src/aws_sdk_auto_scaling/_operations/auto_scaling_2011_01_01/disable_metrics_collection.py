"""Generated from Smithy shape ``com.amazonaws.autoscaling#DisableMetricsCollection``."""
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.disable_metrics_collection_query.DisableMetricsCollectionQuery,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_disable_metrics_collection(
