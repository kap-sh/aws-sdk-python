...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.policy_arn_type.PolicyARNType = (
        aws_sdk_auto_scaling.types.policy_arn_type.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_auto_scaling.types.put_scaling_policy_type.PutScalingPolicyType,
) -> zapros.Request:
    ...
    aws_sdk_auto_scaling.types.put_scaling_policy_type.serialize_query(input, pairs, "")
...
def put_scaling_policy(
    ...
    input: aws_sdk_auto_scaling.types.put_scaling_policy_type.PutScalingPolicyType,
) -> tuple[aws_sdk_auto_scaling.types.policy_arn_type.PolicyARNType, zapros.Response]:
