...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.put_warm_pool_answer.PutWarmPoolAnswer = (
        aws_sdk_auto_scaling.types.put_warm_pool_answer.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.put_warm_pool_type.PutWarmPoolType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.put_warm_pool_type.serialize_query(input_, pairs, "")
...
def put_warm_pool(
    ...
    aws_sdk_auto_scaling.types.put_warm_pool_answer.PutWarmPoolAnswer, zapros.Response
]:
