...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.delete_auto_scaling_group_type.DeleteAutoScalingGroupType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.delete_auto_scaling_group_type.serialize_query(
        input_, pairs, ""
    )
