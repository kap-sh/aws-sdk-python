...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.attach_instances_query.AttachInstancesQuery,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.attach_instances_query.serialize_query(input_, pairs, "")
