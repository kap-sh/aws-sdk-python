...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.describe_traffic_sources_response.DescribeTrafficSourcesResponse = aws_sdk_auto_scaling.types.describe_traffic_sources_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.describe_traffic_sources_request.DescribeTrafficSourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.describe_traffic_sources_request.serialize_query(
        input_, pairs, ""
    )
