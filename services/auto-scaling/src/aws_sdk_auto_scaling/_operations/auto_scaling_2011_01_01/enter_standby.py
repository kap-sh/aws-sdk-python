"""Generated from Smithy shape ``com.amazonaws.autoscaling#EnterStandby``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("EnterStandbyResult")
    out: aws_sdk_auto_scaling.types.enter_standby_answer.EnterStandbyAnswer = (
        aws_sdk_auto_scaling.types.enter_standby_answer.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.enter_standby_query.EnterStandbyQuery,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "EnterStandby"))
    pairs.append(("Version", "2011-01-01"))
    import aws_sdk_auto_scaling.types.enter_standby_query

    aws_sdk_auto_scaling.types.enter_standby_query.serialize_query(input_, pairs, "")
...
def enter_standby(
    ...
    aws_sdk_auto_scaling.types.enter_standby_answer.EnterStandbyAnswer, zapros.Response
]:
