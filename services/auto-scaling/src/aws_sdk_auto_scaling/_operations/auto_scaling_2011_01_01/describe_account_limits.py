...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.describe_account_limits_answer.DescribeAccountLimitsAnswer = aws_sdk_auto_scaling.types.describe_account_limits_answer.deserialize_query(
