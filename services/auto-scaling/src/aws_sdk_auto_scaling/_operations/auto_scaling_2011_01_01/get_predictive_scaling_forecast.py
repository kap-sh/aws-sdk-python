...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.get_predictive_scaling_forecast_answer.GetPredictiveScalingForecastAnswer = aws_sdk_auto_scaling.types.get_predictive_scaling_forecast_answer.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.get_predictive_scaling_forecast_type.GetPredictiveScalingForecastType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
