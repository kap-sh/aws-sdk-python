"""Generated from Smithy shape ``com.amazonaws.autoscaling#DetachLoadBalancers``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DetachLoadBalancersResult")
    out: aws_sdk_auto_scaling.types.detach_load_balancers_result_type.DetachLoadBalancersResultType = aws_sdk_auto_scaling.types.detach_load_balancers_result_type.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.detach_load_balancers_type.DetachLoadBalancersType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DetachLoadBalancers"))
    pairs.append(("Version", "2011-01-01"))
    import aws_sdk_auto_scaling.types.detach_load_balancers_type

    aws_sdk_auto_scaling.types.detach_load_balancers_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_detach_load_balancers(
