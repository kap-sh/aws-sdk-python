...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.record_lifecycle_action_heartbeat_answer.RecordLifecycleActionHeartbeatAnswer = aws_sdk_auto_scaling.types.record_lifecycle_action_heartbeat_answer.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.record_lifecycle_action_heartbeat_type.RecordLifecycleActionHeartbeatType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.record_lifecycle_action_heartbeat_type.serialize_query(
        input_, pairs, ""
    )
