...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.auto_scaling_instances_type.AutoScalingInstancesType = aws_sdk_auto_scaling.types.auto_scaling_instances_type.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.describe_auto_scaling_instances_type.DescribeAutoScalingInstancesType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.describe_auto_scaling_instances_type.serialize_query(
        input_, pairs, ""
    )
