"""Generated from Smithy shape ``com.amazonaws.autoscaling#DeleteLaunchConfiguration``."""
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.launch_configuration_name_type.LaunchConfigurationNameType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteLaunchConfiguration"))
    pairs.append(("Version", "2011-01-01"))
    aws_sdk_auto_scaling.types.launch_configuration_name_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_launch_configuration(
