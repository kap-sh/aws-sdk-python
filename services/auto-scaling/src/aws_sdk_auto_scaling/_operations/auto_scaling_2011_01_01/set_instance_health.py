"""Generated from Smithy shape ``com.amazonaws.autoscaling#SetInstanceHealth``."""
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.set_instance_health_query.SetInstanceHealthQuery,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_set_instance_health(
