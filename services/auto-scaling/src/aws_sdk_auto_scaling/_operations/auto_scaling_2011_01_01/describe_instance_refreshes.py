...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.describe_instance_refreshes_answer.DescribeInstanceRefreshesAnswer = aws_sdk_auto_scaling.types.describe_instance_refreshes_answer.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.describe_instance_refreshes_type.DescribeInstanceRefreshesType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.describe_instance_refreshes_type.serialize_query(
        input_, pairs, ""
    )
