"""Generated from Smithy shape ``com.amazonaws.autoscaling#DeleteScheduledAction``."""
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.delete_scheduled_action_type.DeleteScheduledActionType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteScheduledAction"))
    pairs.append(("Version", "2011-01-01"))
    import aws_sdk_auto_scaling.types.delete_scheduled_action_type

    aws_sdk_auto_scaling.types.delete_scheduled_action_type.serialize_query(
        input_, pairs, ""
    )
