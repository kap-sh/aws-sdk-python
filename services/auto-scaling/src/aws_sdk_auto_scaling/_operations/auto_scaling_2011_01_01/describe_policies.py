...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.describe_policies_type.DescribePoliciesType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.describe_policies_type.serialize_query(input_, pairs, "")
...
def describe_policies(
    ...
    input_: aws_sdk_auto_scaling.types.describe_policies_type.DescribePoliciesType,
) -> tuple[aws_sdk_auto_scaling.types.policies_type.PoliciesType, zapros.Response]:
