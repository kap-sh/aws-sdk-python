...
def build_request(
    ...
    input: aws_sdk_auto_scaling.types.describe_policies_type.DescribePoliciesType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.describe_policies_type.serialize_query(input, pairs, "")
