"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeLifecycleHooks``."""
...
import aws_sdk_auto_scaling.types.lifecycle_hooks
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeLifecycleHooksResult")
    out: aws_sdk_auto_scaling.types.describe_lifecycle_hooks_answer.DescribeLifecycleHooksAnswer = aws_sdk_auto_scaling.types.describe_lifecycle_hooks_answer.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.describe_lifecycle_hooks_type.DescribeLifecycleHooksType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeLifecycleHooks"))
    pairs.append(("Version", "2011-01-01"))
    aws_sdk_auto_scaling.types.describe_lifecycle_hooks_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_lifecycle_hooks(
