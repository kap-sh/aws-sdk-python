"""Generated from Smithy shape ``com.amazonaws.autoscaling#DetachLoadBalancerTargetGroups``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DetachLoadBalancerTargetGroupsResult")
    out: aws_sdk_auto_scaling.types.detach_load_balancer_target_groups_result_type.DetachLoadBalancerTargetGroupsResultType = aws_sdk_auto_scaling.types.detach_load_balancer_target_groups_result_type.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.detach_load_balancer_target_groups_type.DetachLoadBalancerTargetGroupsType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DetachLoadBalancerTargetGroups"))
    pairs.append(("Version", "2011-01-01"))
    aws_sdk_auto_scaling.types.detach_load_balancer_target_groups_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_detach_load_balancer_target_groups(
