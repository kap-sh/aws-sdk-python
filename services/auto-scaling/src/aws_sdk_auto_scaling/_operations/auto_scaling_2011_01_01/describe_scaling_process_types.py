...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.processes_type.ProcessesType = (
        aws_sdk_auto_scaling.types.processes_type.deserialize_query(
...
) -> tuple[aws_sdk_auto_scaling.types.processes_type.ProcessesType, zapros.Response]:
