...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.create_launch_configuration_type.CreateLaunchConfigurationType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.create_launch_configuration_type.serialize_query(
        input_, pairs, ""
    )
