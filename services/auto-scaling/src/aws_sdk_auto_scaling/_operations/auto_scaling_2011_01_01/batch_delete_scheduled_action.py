"""Generated from Smithy shape ``com.amazonaws.autoscaling#BatchDeleteScheduledAction``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("BatchDeleteScheduledActionResult")
    out: aws_sdk_auto_scaling.types.batch_delete_scheduled_action_answer.BatchDeleteScheduledActionAnswer = aws_sdk_auto_scaling.types.batch_delete_scheduled_action_answer.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.batch_delete_scheduled_action_type.BatchDeleteScheduledActionType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_batch_delete_scheduled_action(
