...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.describe_adjustment_types_answer.DescribeAdjustmentTypesAnswer = aws_sdk_auto_scaling.types.describe_adjustment_types_answer.deserialize_query(
