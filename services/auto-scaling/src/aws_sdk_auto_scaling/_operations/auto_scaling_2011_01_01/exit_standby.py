...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.exit_standby_answer.ExitStandbyAnswer = (
        aws_sdk_auto_scaling.types.exit_standby_answer.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.exit_standby_query.ExitStandbyQuery,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.exit_standby_query.serialize_query(input_, pairs, "")
...
def exit_standby(
    ...
    aws_sdk_auto_scaling.types.exit_standby_answer.ExitStandbyAnswer, zapros.Response
]:
