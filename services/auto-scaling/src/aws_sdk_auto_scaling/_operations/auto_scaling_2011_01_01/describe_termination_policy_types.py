"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeTerminationPolicyTypes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeTerminationPolicyTypesResult")
    out: aws_sdk_auto_scaling.types.describe_termination_policy_types_answer.DescribeTerminationPolicyTypesAnswer = aws_sdk_auto_scaling.types.describe_termination_policy_types_answer.deserialize_query(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    pairs.append(("Action", "DescribeTerminationPolicyTypes"))
...
async def async_describe_termination_policy_types(
