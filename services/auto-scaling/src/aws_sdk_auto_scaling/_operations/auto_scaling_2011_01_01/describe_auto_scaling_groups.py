"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeAutoScalingGroups``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeAutoScalingGroupsResult")
    out: aws_sdk_auto_scaling.types.auto_scaling_groups_type.AutoScalingGroupsType = (
        aws_sdk_auto_scaling.types.auto_scaling_groups_type.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.auto_scaling_group_names_type.AutoScalingGroupNamesType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeAutoScalingGroups"))
    pairs.append(("Version", "2011-01-01"))
    import aws_sdk_auto_scaling.types.auto_scaling_group_names_type

    aws_sdk_auto_scaling.types.auto_scaling_group_names_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_auto_scaling_groups(
