"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeScheduledActions``."""
...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.scheduled_actions_type.ScheduledActionsType = (
        aws_sdk_auto_scaling.types.scheduled_actions_type.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.describe_scheduled_actions_type.DescribeScheduledActionsType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
