"""Generated from Smithy shape ``com.amazonaws.autoscaling#DeleteLifecycleHook``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteLifecycleHookResult")
    out: aws_sdk_auto_scaling.types.delete_lifecycle_hook_answer.DeleteLifecycleHookAnswer = aws_sdk_auto_scaling.types.delete_lifecycle_hook_answer.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.delete_lifecycle_hook_type.DeleteLifecycleHookType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteLifecycleHook"))
    pairs.append(("Version", "2011-01-01"))
    aws_sdk_auto_scaling.types.delete_lifecycle_hook_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_lifecycle_hook(
