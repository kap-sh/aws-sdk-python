"""Generated from Smithy shape ``com.amazonaws.autoscaling#TerminateInstanceInAutoScalingGroup``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("TerminateInstanceInAutoScalingGroupResult")
    out: aws_sdk_auto_scaling.types.activity_type.ActivityType = (
        aws_sdk_auto_scaling.types.activity_type.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "TerminateInstanceInAutoScalingGroup"))
