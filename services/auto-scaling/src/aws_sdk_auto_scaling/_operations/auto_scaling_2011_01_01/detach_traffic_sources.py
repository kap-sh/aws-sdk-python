"""Generated from Smithy shape ``com.amazonaws.autoscaling#DetachTrafficSources``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DetachTrafficSourcesResult")
    out: aws_sdk_auto_scaling.types.detach_traffic_sources_result_type.DetachTrafficSourcesResultType = aws_sdk_auto_scaling.types.detach_traffic_sources_result_type.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.detach_traffic_sources_type.DetachTrafficSourcesType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DetachTrafficSources"))
    pairs.append(("Version", "2011-01-01"))
    import aws_sdk_auto_scaling.types.detach_traffic_sources_type

    aws_sdk_auto_scaling.types.detach_traffic_sources_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_detach_traffic_sources(
