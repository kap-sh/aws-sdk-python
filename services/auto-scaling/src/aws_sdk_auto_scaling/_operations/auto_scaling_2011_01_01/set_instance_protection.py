...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.set_instance_protection_answer.SetInstanceProtectionAnswer = aws_sdk_auto_scaling.types.set_instance_protection_answer.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.set_instance_protection_query.SetInstanceProtectionQuery,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
