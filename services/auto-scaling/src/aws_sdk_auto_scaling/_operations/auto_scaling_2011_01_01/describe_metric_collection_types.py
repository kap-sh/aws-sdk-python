"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeMetricCollectionTypes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeMetricCollectionTypesResult")
    out: aws_sdk_auto_scaling.types.describe_metric_collection_types_answer.DescribeMetricCollectionTypesAnswer = aws_sdk_auto_scaling.types.describe_metric_collection_types_answer.deserialize_query(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    pairs.append(("Action", "DescribeMetricCollectionTypes"))
...
async def async_describe_metric_collection_types(
