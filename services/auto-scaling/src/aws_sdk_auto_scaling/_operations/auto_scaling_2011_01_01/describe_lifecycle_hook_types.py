"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeLifecycleHookTypes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeLifecycleHookTypesResult")
    out: aws_sdk_auto_scaling.types.describe_lifecycle_hook_types_answer.DescribeLifecycleHookTypesAnswer = aws_sdk_auto_scaling.types.describe_lifecycle_hook_types_answer.deserialize_query(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    pairs.append(("Action", "DescribeLifecycleHookTypes"))
...
async def async_describe_lifecycle_hook_types(
