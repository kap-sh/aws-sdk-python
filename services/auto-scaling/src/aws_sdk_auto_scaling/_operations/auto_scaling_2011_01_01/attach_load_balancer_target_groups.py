...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.attach_load_balancer_target_groups_result_type.AttachLoadBalancerTargetGroupsResultType = aws_sdk_auto_scaling.types.attach_load_balancer_target_groups_result_type.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.attach_load_balancer_target_groups_type.AttachLoadBalancerTargetGroupsType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.attach_load_balancer_target_groups_type.serialize_query(
        input_, pairs, ""
    )
