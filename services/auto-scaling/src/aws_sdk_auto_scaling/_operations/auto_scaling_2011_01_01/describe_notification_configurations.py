"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeNotificationConfigurations``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeNotificationConfigurationsResult")
    out: aws_sdk_auto_scaling.types.describe_notification_configurations_answer.DescribeNotificationConfigurationsAnswer = aws_sdk_auto_scaling.types.describe_notification_configurations_answer.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.describe_notification_configurations_type.DescribeNotificationConfigurationsType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeNotificationConfigurations"))
    pairs.append(("Version", "2011-01-01"))
    import aws_sdk_auto_scaling.types.describe_notification_configurations_type

    aws_sdk_auto_scaling.types.describe_notification_configurations_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_notification_configurations(
