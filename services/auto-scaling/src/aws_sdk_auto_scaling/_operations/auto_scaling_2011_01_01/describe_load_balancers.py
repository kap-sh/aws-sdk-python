...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.describe_load_balancers_response.DescribeLoadBalancersResponse = aws_sdk_auto_scaling.types.describe_load_balancers_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.describe_load_balancers_request.DescribeLoadBalancersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.describe_load_balancers_request.serialize_query(
        input_, pairs, ""
    )
