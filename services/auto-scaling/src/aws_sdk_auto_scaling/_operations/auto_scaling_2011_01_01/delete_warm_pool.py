...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.delete_warm_pool_answer.DeleteWarmPoolAnswer = (
        aws_sdk_auto_scaling.types.delete_warm_pool_answer.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.delete_warm_pool_type.DeleteWarmPoolType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.delete_warm_pool_type.serialize_query(input_, pairs, "")
