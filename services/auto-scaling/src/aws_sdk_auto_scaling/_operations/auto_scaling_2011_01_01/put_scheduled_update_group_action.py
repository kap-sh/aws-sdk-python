"""Generated from Smithy shape ``com.amazonaws.autoscaling#PutScheduledUpdateGroupAction``."""
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.put_scheduled_update_group_action_type.PutScheduledUpdateGroupActionType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "PutScheduledUpdateGroupAction"))
    pairs.append(("Version", "2011-01-01"))
    import aws_sdk_auto_scaling.types.put_scheduled_update_group_action_type

    aws_sdk_auto_scaling.types.put_scheduled_update_group_action_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_put_scheduled_update_group_action(
