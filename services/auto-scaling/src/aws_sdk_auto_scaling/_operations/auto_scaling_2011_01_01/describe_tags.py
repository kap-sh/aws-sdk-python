...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.tags_type.TagsType = (
        aws_sdk_auto_scaling.types.tags_type.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.describe_tags_type.DescribeTagsType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.describe_tags_type.serialize_query(input_, pairs, "")
...
def describe_tags(
    ...
    input_: aws_sdk_auto_scaling.types.describe_tags_type.DescribeTagsType,
) -> tuple[aws_sdk_auto_scaling.types.tags_type.TagsType, zapros.Response]:
