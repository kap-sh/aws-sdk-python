...
import aws_sdk_auto_scaling.errors.irreversible_instance_refresh_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IrreversibleInstanceRefreshFault":
            raise aws_sdk_auto_scaling.errors.irreversible_instance_refresh_fault.IrreversibleInstanceRefreshFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.rollback_instance_refresh_answer.RollbackInstanceRefreshAnswer = aws_sdk_auto_scaling.types.rollback_instance_refresh_answer.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.rollback_instance_refresh_type.RollbackInstanceRefreshType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_auto_scaling.types.rollback_instance_refresh_type.serialize_query(
        input_, pairs, ""
    )
