...
def handle_response(
    ...
    out: aws_sdk_auto_scaling.types.complete_lifecycle_action_answer.CompleteLifecycleActionAnswer = aws_sdk_auto_scaling.types.complete_lifecycle_action_answer.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.complete_lifecycle_action_type.CompleteLifecycleActionType,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
