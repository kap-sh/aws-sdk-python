"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeLoadBalancerTargetGroups``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeLoadBalancerTargetGroupsResult")
    out: aws_sdk_auto_scaling.types.describe_load_balancer_target_groups_response.DescribeLoadBalancerTargetGroupsResponse = aws_sdk_auto_scaling.types.describe_load_balancer_target_groups_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_auto_scaling.types.describe_load_balancer_target_groups_request.DescribeLoadBalancerTargetGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeLoadBalancerTargetGroups"))
    pairs.append(("Version", "2011-01-01"))
    import aws_sdk_auto_scaling.types.describe_load_balancer_target_groups_request

    aws_sdk_auto_scaling.types.describe_load_balancer_target_groups_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_load_balancer_target_groups(
