...
from aws_sdk_auto_scaling._auth._identity import Credentials
from aws_sdk_auto_scaling._auth._providers import (
    CredentialsProvider,
    IdentityProvider,
    StaticAwsCredentialsProvider,
    default_aws_credentials_chain,
)
from aws_sdk_auto_scaling._auth._zapros_handler import AuthMiddleware
from aws_sdk_auto_scaling._pagination import resolve_path as _resolve_path
from aws_sdk_auto_scaling._services._aws_config import aaws_config
...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.activities_type
    import aws_sdk_auto_scaling.types.activity
    import aws_sdk_auto_scaling.types.activity_ids
    import aws_sdk_auto_scaling.types.activity_type
    import aws_sdk_auto_scaling.types.any_printable_ascii_string_max_len4000
    import aws_sdk_auto_scaling.types.ascii_string_max_len255
    import aws_sdk_auto_scaling.types.associate_public_ip_address
    import aws_sdk_auto_scaling.types.attach_instances_query
    import aws_sdk_auto_scaling.types.attach_load_balancer_target_groups_result_type
    import aws_sdk_auto_scaling.types.attach_load_balancer_target_groups_type
    ...
    import aws_sdk_auto_scaling.types.attach_traffic_sources_result_type
    import aws_sdk_auto_scaling.types.attach_traffic_sources_type
    ...
    import aws_sdk_auto_scaling.types.auto_scaling_group_names_type
    import aws_sdk_auto_scaling.types.auto_scaling_groups_type
    import aws_sdk_auto_scaling.types.auto_scaling_instance_details
    import aws_sdk_auto_scaling.types.auto_scaling_instances_type
    ...
    import aws_sdk_auto_scaling.types.batch_delete_scheduled_action_answer
    ...
    import aws_sdk_auto_scaling.types.cancel_instance_refresh_answer
    import aws_sdk_auto_scaling.types.cancel_instance_refresh_type
    ...
    import aws_sdk_auto_scaling.types.complete_lifecycle_action_answer
    ...
    import aws_sdk_auto_scaling.types.create_launch_configuration_type
    import aws_sdk_auto_scaling.types.create_or_update_tags_type
    import aws_sdk_auto_scaling.types.default_instance_warmup
    import aws_sdk_auto_scaling.types.delete_auto_scaling_group_type
    import aws_sdk_auto_scaling.types.delete_lifecycle_hook_answer
    import aws_sdk_auto_scaling.types.delete_lifecycle_hook_type
    import aws_sdk_auto_scaling.types.delete_notification_configuration_type
    import aws_sdk_auto_scaling.types.delete_policy_type
    import aws_sdk_auto_scaling.types.delete_scheduled_action_type
    import aws_sdk_auto_scaling.types.delete_tags_type
    import aws_sdk_auto_scaling.types.delete_warm_pool_answer
    import aws_sdk_auto_scaling.types.delete_warm_pool_type
    import aws_sdk_auto_scaling.types.deletion_protection
    import aws_sdk_auto_scaling.types.describe_account_limits_answer
    import aws_sdk_auto_scaling.types.describe_adjustment_types_answer
    import aws_sdk_auto_scaling.types.describe_auto_scaling_instances_type
    import aws_sdk_auto_scaling.types.describe_auto_scaling_notification_types_answer
    import aws_sdk_auto_scaling.types.describe_instance_refreshes_answer
    import aws_sdk_auto_scaling.types.describe_instance_refreshes_type
    import aws_sdk_auto_scaling.types.describe_lifecycle_hook_types_answer
    import aws_sdk_auto_scaling.types.describe_lifecycle_hooks_answer
    import aws_sdk_auto_scaling.types.describe_lifecycle_hooks_type
    import aws_sdk_auto_scaling.types.describe_load_balancer_target_groups_request
    import aws_sdk_auto_scaling.types.describe_load_balancer_target_groups_response
    import aws_sdk_auto_scaling.types.describe_load_balancers_request
    import aws_sdk_auto_scaling.types.describe_load_balancers_response
    import aws_sdk_auto_scaling.types.describe_metric_collection_types_answer
    import aws_sdk_auto_scaling.types.describe_notification_configurations_answer
    import aws_sdk_auto_scaling.types.describe_notification_configurations_type
    import aws_sdk_auto_scaling.types.describe_policies_type
    import aws_sdk_auto_scaling.types.describe_scaling_activities_type
    import aws_sdk_auto_scaling.types.describe_scheduled_actions_type
    import aws_sdk_auto_scaling.types.describe_tags_type
    import aws_sdk_auto_scaling.types.describe_termination_policy_types_answer
    import aws_sdk_auto_scaling.types.describe_traffic_sources_request
    import aws_sdk_auto_scaling.types.describe_traffic_sources_response
    import aws_sdk_auto_scaling.types.describe_warm_pool_answer
    import aws_sdk_auto_scaling.types.describe_warm_pool_type
    import aws_sdk_auto_scaling.types.desired_configuration
    import aws_sdk_auto_scaling.types.detach_instances_answer
    import aws_sdk_auto_scaling.types.detach_instances_query
    import aws_sdk_auto_scaling.types.detach_load_balancer_target_groups_result_type
    import aws_sdk_auto_scaling.types.detach_load_balancer_target_groups_type
    import aws_sdk_auto_scaling.types.detach_load_balancers_result_type
    import aws_sdk_auto_scaling.types.detach_load_balancers_type
    import aws_sdk_auto_scaling.types.detach_traffic_sources_result_type
    import aws_sdk_auto_scaling.types.detach_traffic_sources_type
    import aws_sdk_auto_scaling.types.disable_metrics_collection_query
    import aws_sdk_auto_scaling.types.ebs_optimized
    import aws_sdk_auto_scaling.types.enable_metrics_collection_query
    import aws_sdk_auto_scaling.types.enter_standby_answer
    import aws_sdk_auto_scaling.types.enter_standby_query
    import aws_sdk_auto_scaling.types.estimated_instance_warmup
    import aws_sdk_auto_scaling.types.execute_policy_type
    import aws_sdk_auto_scaling.types.exit_standby_answer
    import aws_sdk_auto_scaling.types.exit_standby_query
    import aws_sdk_auto_scaling.types.filters
    import aws_sdk_auto_scaling.types.force_delete
    import aws_sdk_auto_scaling.types.get_predictive_scaling_forecast_answer
    ...
    import aws_sdk_auto_scaling.types.heartbeat_timeout
    ...
    import aws_sdk_auto_scaling.types.instance_reuse_policy
    import aws_sdk_auto_scaling.types.launch_configuration
    import aws_sdk_auto_scaling.types.launch_configuration_name_type
    ...
    import aws_sdk_auto_scaling.types.lifecycle_action_result
    ...
    import aws_sdk_auto_scaling.types.lifecycle_transition
    import aws_sdk_auto_scaling.types.load_balancer_names
    import aws_sdk_auto_scaling.types.max_group_prepared_capacity
    ...
    import aws_sdk_auto_scaling.types.metrics
    ...
    import aws_sdk_auto_scaling.types.notification_target_resource_name
    import aws_sdk_auto_scaling.types.policies_type
    import aws_sdk_auto_scaling.types.policy_arn_type
    ...
    import aws_sdk_auto_scaling.types.processes_type
    import aws_sdk_auto_scaling.types.protected_from_scale_in
    import aws_sdk_auto_scaling.types.put_lifecycle_hook_answer
    import aws_sdk_auto_scaling.types.put_lifecycle_hook_type
    import aws_sdk_auto_scaling.types.put_notification_configuration_type
    import aws_sdk_auto_scaling.types.put_scaling_policy_type
    import aws_sdk_auto_scaling.types.put_scheduled_update_group_action_type
    import aws_sdk_auto_scaling.types.put_warm_pool_answer
    import aws_sdk_auto_scaling.types.put_warm_pool_type
    import aws_sdk_auto_scaling.types.record_lifecycle_action_heartbeat_answer
    import aws_sdk_auto_scaling.types.record_lifecycle_action_heartbeat_type
    ...
    import aws_sdk_auto_scaling.types.rollback_instance_refresh_answer
    import aws_sdk_auto_scaling.types.rollback_instance_refresh_type
    import aws_sdk_auto_scaling.types.scaling_policy
    import aws_sdk_auto_scaling.types.scaling_policy_enabled
    import aws_sdk_auto_scaling.types.scaling_process_query
    import aws_sdk_auto_scaling.types.scheduled_action_names
    import aws_sdk_auto_scaling.types.scheduled_actions_type
    import aws_sdk_auto_scaling.types.scheduled_update_group_action
    ...
    import aws_sdk_auto_scaling.types.set_instance_protection_answer
    ...
    import aws_sdk_auto_scaling.types.start_instance_refresh_answer
    ...
    import aws_sdk_auto_scaling.types.tags_type
    ...
    import aws_sdk_auto_scaling.types.update_placement_group_param
    import aws_sdk_auto_scaling.types.warm_pool_min_size
    import aws_sdk_auto_scaling.types.warm_pool_state
...
class AsyncAutoScalingClientConfig(TypedDict, total=False, closed=True):
...
class AsyncAutoScalingClient:
    ...
    async def attach_instances(
        self,
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        *,
        ...
        Examples:
            ...
            >>> await client.attach_instances(instance_ids=['i-93633f9b'], auto_scaling_group_name='my-auto-scaling-group')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.attach_instances_query.AttachInstancesQuery]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.attach_instances

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.attach_instances.async_attach_instances(
    ...
    async def attach_load_balancers(
        self,
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        load_balancer_names: "aws_sdk_auto_scaling.types.load_balancer_names.LoadBalancerNames",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        ...
        Examples:
            ...
            >>> await client.attach_load_balancers(auto_scaling_group_name='my-auto-scaling-group', load_balancer_names=['my-load-balancer'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.attach_load_balancers_type.AttachLoadBalancersType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.attach_load_balancers_result_type.AttachLoadBalancersResultType"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.attach_load_balancers

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.attach_load_balancers.async_attach_load_balancers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def attach_load_balancer_target_groups(
        self,
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        target_group_ar_ns: "aws_sdk_auto_scaling.types.target_group_ar_ns.TargetGroupARNs",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        ...
        Examples:
            ...
            >>> await client.attach_load_balancer_target_groups(auto_scaling_group_name='my-auto-scaling-group', target_group_ar_ns=['arn:aws:elasticloadbalancing:us-west-2:123456789012:targetgroup/my-targets/73e2d6bc24d8a067'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.attach_load_balancer_target_groups_type.AttachLoadBalancerTargetGroupsType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.attach_load_balancer_target_groups_result_type.AttachLoadBalancerTargetGroupsResultType"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.attach_load_balancer_target_groups

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.attach_load_balancer_target_groups.async_attach_load_balancer_target_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def attach_traffic_sources(
        self,
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        traffic_sources: "aws_sdk_auto_scaling.types.traffic_sources.TrafficSources",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        ...
        Examples:
            ...
            >>> await client.attach_traffic_sources(auto_scaling_group_name='my-auto-scaling-group', traffic_sources=[{'Identifier': 'arn:aws:elasticloadbalancing:us-west-2:123456789012:targetgroup/my-targets/73e2d6bc24d8a067'}])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.attach_traffic_sources_type.AttachTrafficSourcesType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.attach_traffic_sources_result_type.AttachTrafficSourcesResultType"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.attach_traffic_sources

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.attach_traffic_sources.async_attach_traffic_sources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_delete_scheduled_action(
        self,
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        scheduled_action_names: "aws_sdk_auto_scaling.types.scheduled_action_names.ScheduledActionNames",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
    ) -> "aws_sdk_auto_scaling.types.batch_delete_scheduled_action_answer.BatchDeleteScheduledActionAnswer":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.batch_delete_scheduled_action_type.BatchDeleteScheduledActionType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.batch_delete_scheduled_action_answer.BatchDeleteScheduledActionAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.batch_delete_scheduled_action

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.batch_delete_scheduled_action.async_batch_delete_scheduled_action(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_put_scheduled_update_group_action(
        self,
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        scheduled_update_group_actions: "aws_sdk_auto_scaling.types.scheduled_update_group_action_requests.ScheduledUpdateGroupActionRequests",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.batch_put_scheduled_update_group_action_type.BatchPutScheduledUpdateGroupActionType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.batch_put_scheduled_update_group_action_answer.BatchPutScheduledUpdateGroupActionAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.batch_put_scheduled_update_group_action

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.batch_put_scheduled_update_group_action.async_batch_put_scheduled_update_group_action(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_instance_refresh(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.cancel_instance_refresh(auto_scaling_group_name='my-auto-scaling-group')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.cancel_instance_refresh_type.CancelInstanceRefreshType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.cancel_instance_refresh_answer.CancelInstanceRefreshAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.cancel_instance_refresh

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.cancel_instance_refresh.async_cancel_instance_refresh(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def complete_lifecycle_action(
        self,
        lifecycle_hook_name: "aws_sdk_auto_scaling.types.ascii_string_max_len255.AsciiStringMaxLen255",
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.resource_name.ResourceName",
        lifecycle_action_result: "aws_sdk_auto_scaling.types.lifecycle_action_result.LifecycleActionResult",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        ...
        Examples:
            ...
            >>> await client.complete_lifecycle_action(lifecycle_hook_name='my-lifecycle-hook', auto_scaling_group_name='my-auto-scaling-group', lifecycle_action_token='bcd2f1b8-9a78-44d3-8a7a-4dd07d7cf635', lifecycle_action_result='CONTINUE')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.complete_lifecycle_action_type.CompleteLifecycleActionType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.complete_lifecycle_action_answer.CompleteLifecycleActionAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.complete_lifecycle_action

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.complete_lifecycle_action.async_complete_lifecycle_action(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_auto_scaling_group(
        self,
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        min_size: "aws_sdk_auto_scaling.types.auto_scaling_group_min_size.AutoScalingGroupMinSize",
        max_size: "aws_sdk_auto_scaling.types.auto_scaling_group_max_size.AutoScalingGroupMaxSize",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        ...
        default_cooldown: Optional[
            "aws_sdk_auto_scaling.types.cooldown.Cooldown"
        ] = None,
        ...
        tags: Optional["aws_sdk_auto_scaling.types.tags.Tags"] = None,
        ...
        context: Optional["aws_sdk_auto_scaling.types.context.Context"] = None,
        ...
        Examples:
            ...
            >>> await client.create_auto_scaling_group(auto_scaling_group_name='my-auto-scaling-group', launch_template={'LaunchTemplateName': 'my-template-for-auto-scaling', 'Version': '$Default'}, min_size=1, max_size=3, max_instance_lifetime=2592000, default_instance_warmup=120, vpc_zone_identifier='subnet-057fa0918fEXAMPLE')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.create_auto_scaling_group_type.CreateAutoScalingGroupType]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.create_auto_scaling_group

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.create_auto_scaling_group.async_create_auto_scaling_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_launch_configuration(
        self,
        launch_configuration_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        image_id: Optional[
            "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255"
        ...
        spot_price: Optional["aws_sdk_auto_scaling.types.spot_price.SpotPrice"] = None,
        iam_instance_profile: Optional[
            "aws_sdk_auto_scaling.types.xml_string_max_len1600.XmlStringMaxLen1600"
        ] = None,
        ebs_optimized: Optional[
            "aws_sdk_auto_scaling.types.ebs_optimized.EbsOptimized"
        ] = None,
        ...
        Examples:
            ...
            >>> await client.create_launch_configuration(launch_configuration_name='my-launch-config', image_id='ami-12345678', security_groups=['sg-eb2af88e'], instance_type='m3.medium', iam_instance_profile='my-iam-role')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.create_launch_configuration_type.CreateLaunchConfigurationType]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.create_launch_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.create_launch_configuration.async_create_launch_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_or_update_tags(
        self,
        tags: "aws_sdk_auto_scaling.types.tags.Tags",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
    ) -> None:
        ...
        Examples:
            ...
            >>> await client.create_or_update_tags(tags=[{'ResourceId': 'my-auto-scaling-group', 'ResourceType': 'auto-scaling-group', 'Key': 'Role', 'Value': 'WebServer', 'PropagateAtLaunch': True}, {'ResourceId': 'my-auto-scaling-group', 'ResourceType': 'auto-scaling-group', 'Key': 'Dept', 'Value': 'Research', 'PropagateAtLaunch': True}])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.create_or_update_tags_type.CreateOrUpdateTagsType]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.create_or_update_tags

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.create_or_update_tags.async_create_or_update_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_auto_scaling_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_auto_scaling_group(auto_scaling_group_name='my-auto-scaling-group')
            To delete an Auto Scaling group and all its instances
            This example deletes the specified Auto Scaling group and all its instances.

            >>> await client.delete_auto_scaling_group(auto_scaling_group_name='my-auto-scaling-group', force_delete=True)
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.delete_auto_scaling_group_type.DeleteAutoScalingGroupType]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_auto_scaling_group

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_auto_scaling_group.async_delete_auto_scaling_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_launch_configuration(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_launch_configuration(launch_configuration_name='my-launch-config')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.launch_configuration_name_type.LaunchConfigurationNameType]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_launch_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_launch_configuration.async_delete_launch_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_lifecycle_hook(
        ...
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
    ) -> "aws_sdk_auto_scaling.types.delete_lifecycle_hook_answer.DeleteLifecycleHookAnswer":
        ...
        Examples:
            ...
            >>> await client.delete_lifecycle_hook(lifecycle_hook_name='my-lifecycle-hook', auto_scaling_group_name='my-auto-scaling-group')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.delete_lifecycle_hook_type.DeleteLifecycleHookType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.delete_lifecycle_hook_answer.DeleteLifecycleHookAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_lifecycle_hook

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_lifecycle_hook.async_delete_lifecycle_hook(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_notification_configuration(
        self,
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        topic_arn: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
    ) -> None:
        ...
        Examples:
            ...
            >>> await client.delete_notification_configuration(auto_scaling_group_name='my-auto-scaling-group', topic_arn='arn:aws:sns:us-west-2:123456789012:my-sns-topic')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.delete_notification_configuration_type.DeleteNotificationConfigurationType]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_notification_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_notification_configuration.async_delete_notification_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_policy(
        self,
        policy_name: "aws_sdk_auto_scaling.types.resource_name.ResourceName",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        ...
        Examples:
            ...
            >>> await client.delete_policy(auto_scaling_group_name='my-auto-scaling-group', policy_name='my-step-scale-out-policy')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.delete_policy_type.DeletePolicyType]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_policy

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_policy.async_delete_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_scheduled_action(
        self,
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        scheduled_action_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
    ) -> None:
        ...
        Examples:
            ...
            >>> await client.delete_scheduled_action(auto_scaling_group_name='my-auto-scaling-group', scheduled_action_name='my-scheduled-action')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.delete_scheduled_action_type.DeleteScheduledActionType]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_scheduled_action

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_scheduled_action.async_delete_scheduled_action(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_tags(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_tags(tags=[{'ResourceId': 'my-auto-scaling-group', 'ResourceType': 'auto-scaling-group', 'Key': 'Dept', 'Value': 'Research'}])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.delete_tags_type.DeleteTagsType]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_tags

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_tags.async_delete_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_warm_pool(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.delete_warm_pool_type.DeleteWarmPoolType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.delete_warm_pool_answer.DeleteWarmPoolAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_warm_pool

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.delete_warm_pool.async_delete_warm_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_limits(
        ...
        Examples:
            ...
            >>> await client.describe_account_limits()
        """
        ...
        async def _handler(
            ...
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_account_limits

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_account_limits.async_describe_account_limits(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_adjustment_types(
        ...
        Examples:
            ...
            >>> await client.describe_adjustment_types()
        """
        ...
        async def _handler(
            ...
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_adjustment_types

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_adjustment_types.async_describe_adjustment_types(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_auto_scaling_groups(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_auto_scaling_groups(auto_scaling_group_names=['my-auto-scaling-group'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.auto_scaling_group_names_type.AutoScalingGroupNamesType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.auto_scaling_groups_type.AutoScalingGroupsType"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_auto_scaling_groups

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_auto_scaling_groups.async_describe_auto_scaling_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_auto_scaling_groups(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_auto_scaling.types.auto_scaling_group.AutoScalingGroup]"
    ):
        _token = next_token
        while True:
            _response = await self.describe_auto_scaling_groups(
    ...
    async def describe_auto_scaling_instances(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_auto_scaling.types.xml_string.XmlString"] = None,
    ) -> "aws_sdk_auto_scaling.types.auto_scaling_instances_type.AutoScalingInstancesType":
        ...
        Examples:
            ...
            >>> await client.describe_auto_scaling_instances(instance_ids=['i-05b4f7d5be44822a6'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.describe_auto_scaling_instances_type.DescribeAutoScalingInstancesType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.auto_scaling_instances_type.AutoScalingInstancesType"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_auto_scaling_instances

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_auto_scaling_instances.async_describe_auto_scaling_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_auto_scaling_instances(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_auto_scaling.types.xml_string.XmlString"] = None,
    ) -> "AsyncIterator[aws_sdk_auto_scaling.types.auto_scaling_instance_details.AutoScalingInstanceDetails]":
        _token = next_token
        while True:
            _response = await self.describe_auto_scaling_instances(
                config_overrides=config_overrides,
    ...
    async def describe_auto_scaling_notification_types(
        ...
        Examples:
            ...
            >>> await client.describe_auto_scaling_notification_types()
        """
        ...
        async def _handler(
            ...
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_auto_scaling_notification_types

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_auto_scaling_notification_types.async_describe_auto_scaling_notification_types(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_instance_refreshes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.describe_instance_refreshes_type.DescribeInstanceRefreshesType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.describe_instance_refreshes_answer.DescribeInstanceRefreshesAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_instance_refreshes

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_instance_refreshes.async_describe_instance_refreshes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_launch_configurations(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_launch_configurations(launch_configuration_names=['my-launch-config'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.launch_configuration_names_type.LaunchConfigurationNamesType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.launch_configurations_type.LaunchConfigurationsType"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_launch_configurations

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_launch_configurations.async_describe_launch_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_auto_scaling.types.launch_configuration.LaunchConfiguration]":
        _token = next_token
        while True:
            _response = await self.describe_launch_configurations(
                config_overrides=config_overrides,
    ...
    async def describe_lifecycle_hooks(
        ...
        *,
    ...
    ) -> "aws_sdk_auto_scaling.types.describe_lifecycle_hooks_answer.DescribeLifecycleHooksAnswer":
        ...
        Examples:
            ...
            >>> await client.describe_lifecycle_hooks(auto_scaling_group_name='my-auto-scaling-group')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.describe_lifecycle_hooks_type.DescribeLifecycleHooksType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.describe_lifecycle_hooks_answer.DescribeLifecycleHooksAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_lifecycle_hooks

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_lifecycle_hooks.async_describe_lifecycle_hooks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_lifecycle_hook_types(
        ...
        Examples:
            ...
            >>> await client.describe_lifecycle_hook_types()
        """
        ...
        async def _handler(
            ...
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_lifecycle_hook_types

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_lifecycle_hook_types.async_describe_lifecycle_hook_types(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_load_balancers(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_load_balancers(auto_scaling_group_name='my-auto-scaling-group')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.describe_load_balancers_request.DescribeLoadBalancersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.describe_load_balancers_response.DescribeLoadBalancersResponse"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_load_balancers

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_load_balancers.async_describe_load_balancers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_load_balancer_target_groups(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_load_balancer_target_groups(auto_scaling_group_name='my-auto-scaling-group')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.describe_load_balancer_target_groups_request.DescribeLoadBalancerTargetGroupsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.describe_load_balancer_target_groups_response.DescribeLoadBalancerTargetGroupsResponse"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_load_balancer_target_groups

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_load_balancer_target_groups.async_describe_load_balancer_target_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_metric_collection_types(
        ...
        Examples:
            ...
            >>> await client.describe_metric_collection_types()
        """
        ...
        async def _handler(
            ...
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_metric_collection_types

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_metric_collection_types.async_describe_metric_collection_types(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_notification_configurations(
        ...
        *,
    ...
    ) -> "aws_sdk_auto_scaling.types.describe_notification_configurations_answer.DescribeNotificationConfigurationsAnswer":
        ...
        Examples:
            ...
            >>> await client.describe_notification_configurations(auto_scaling_group_names=['my-auto-scaling-group'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.describe_notification_configurations_type.DescribeNotificationConfigurationsType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.describe_notification_configurations_answer.DescribeNotificationConfigurationsAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_notification_configurations

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_notification_configurations.async_describe_notification_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_auto_scaling.types.notification_configuration.NotificationConfiguration]":
        _token = next_token
        while True:
            _response = await self.describe_notification_configurations(
                config_overrides=config_overrides,
                auto_scaling_group_names=auto_scaling_group_names,
                next_token=_token,
                max_records=max_records,
    ...
    async def describe_policies(
        ...
        *,
        ...
        policy_names: Optional[
            "aws_sdk_auto_scaling.types.policy_names.PolicyNames"
        ] = None,
        policy_types: Optional[
            "aws_sdk_auto_scaling.types.policy_types.PolicyTypes"
        ] = None,
        next_token: Optional["aws_sdk_auto_scaling.types.xml_string.XmlString"] = None,
        max_records: Optional[
            "aws_sdk_auto_scaling.types.max_records.MaxRecords"
        ...
        Examples:
            ...
            >>> await client.describe_policies(auto_scaling_group_name='my-auto-scaling-group')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.describe_policies_type.DescribePoliciesType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.policies_type.PoliciesType"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_policies

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_policies.async_describe_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_auto_scaling.types.scaling_policy.ScalingPolicy]":
        _token = next_token
        while True:
            _response = await self.describe_policies(
                config_overrides=config_overrides,
    ...
    async def describe_scaling_activities(
        ...
        *,
        ...
        activity_ids: Optional[
            "aws_sdk_auto_scaling.types.activity_ids.ActivityIds"
        ] = None,
        auto_scaling_group_name: Optional[
            "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255"
        ] = None,
        ...
        Examples:
            ...
            >>> await client.describe_scaling_activities(auto_scaling_group_name='my-auto-scaling-group')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.describe_scaling_activities_type.DescribeScalingActivitiesType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.activities_type.ActivitiesType"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_scaling_activities

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_scaling_activities.async_describe_scaling_activities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_scaling_activities(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_auto_scaling.types.xml_string.XmlString"] = None,
        filters: Optional["aws_sdk_auto_scaling.types.filters.Filters"] = None,
    ) -> "AsyncIterator[aws_sdk_auto_scaling.types.activity.Activity]":
        _token = next_token
        while True:
            _response = await self.describe_scaling_activities(
                config_overrides=config_overrides,
    ...
    async def describe_scaling_process_types(
        ...
        Examples:
            ...
            >>> await client.describe_scaling_process_types()
        """
        ...
        async def _handler(
            ...
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_scaling_process_types

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_scaling_process_types.async_describe_scaling_process_types(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_scheduled_actions(
        ...
        *,
        ...
        scheduled_action_names: Optional[
            "aws_sdk_auto_scaling.types.scheduled_action_names.ScheduledActionNames"
        ] = None,
        start_time: Optional[
        ...
        Examples:
            ...
            >>> await client.describe_scheduled_actions(auto_scaling_group_name='my-auto-scaling-group')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.describe_scheduled_actions_type.DescribeScheduledActionsType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.scheduled_actions_type.ScheduledActionsType"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_scheduled_actions

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_scheduled_actions.async_describe_scheduled_actions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_auto_scaling.types.scheduled_update_group_action.ScheduledUpdateGroupAction]":
        _token = next_token
        while True:
    ...
    async def describe_tags(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_tags(filters=[{'Values': ['my-auto-scaling-group'], 'Name': 'auto-scaling-group'}])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.describe_tags_type.DescribeTagsType]",
        ) -> AsyncOperationResponse["aws_sdk_auto_scaling.types.tags_type.TagsType"]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_tags

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_tags.async_describe_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_auto_scaling.types.tag_description.TagDescription]":
        _token = next_token
        while True:
    ...
    async def describe_termination_policy_types(
        ...
        Examples:
            ...
            >>> await client.describe_termination_policy_types()
        """
        ...
        async def _handler(
            ...
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_termination_policy_types

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_termination_policy_types.async_describe_termination_policy_types(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_traffic_sources(
        ...
        *,
    ...
    ) -> "aws_sdk_auto_scaling.types.describe_traffic_sources_response.DescribeTrafficSourcesResponse":
        ...
        Examples:
            ...
            >>> await client.describe_traffic_sources(auto_scaling_group_name='my-auto-scaling-group')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.describe_traffic_sources_request.DescribeTrafficSourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.describe_traffic_sources_response.DescribeTrafficSourcesResponse"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_traffic_sources

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_traffic_sources.async_describe_traffic_sources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_warm_pool(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.describe_warm_pool_type.DescribeWarmPoolType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.describe_warm_pool_answer.DescribeWarmPoolAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_warm_pool

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.describe_warm_pool.async_describe_warm_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_warm_pool(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_auto_scaling.types.xml_string.XmlString"] = None,
    ) -> "AsyncIterator[aws_sdk_auto_scaling.types.instance.Instance]":
        _token = next_token
        while True:
            _response = await self.describe_warm_pool(
    ...
    async def detach_instances(
        self,
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        should_decrement_desired_capacity: "aws_sdk_auto_scaling.types.should_decrement_desired_capacity.ShouldDecrementDesiredCapacity",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        instance_ids: Optional[
            "aws_sdk_auto_scaling.types.instance_ids.InstanceIds"
        ...
        Examples:
            ...
            >>> await client.detach_instances(instance_ids=['i-93633f9b'], auto_scaling_group_name='my-auto-scaling-group', should_decrement_desired_capacity=True)
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.detach_instances_query.DetachInstancesQuery]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.detach_instances_answer.DetachInstancesAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.detach_instances

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.detach_instances.async_detach_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detach_load_balancers(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.detach_load_balancers(auto_scaling_group_name='my-auto-scaling-group', load_balancer_names=['my-load-balancer'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.detach_load_balancers_type.DetachLoadBalancersType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.detach_load_balancers_result_type.DetachLoadBalancersResultType"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.detach_load_balancers

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.detach_load_balancers.async_detach_load_balancers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detach_load_balancer_target_groups(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.detach_load_balancer_target_groups(auto_scaling_group_name='my-auto-scaling-group', target_group_ar_ns=['arn:aws:elasticloadbalancing:us-west-2:123456789012:targetgroup/my-targets/73e2d6bc24d8a067'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.detach_load_balancer_target_groups_type.DetachLoadBalancerTargetGroupsType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.detach_load_balancer_target_groups_result_type.DetachLoadBalancerTargetGroupsResultType"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.detach_load_balancer_target_groups

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.detach_load_balancer_target_groups.async_detach_load_balancer_target_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detach_traffic_sources(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.detach_traffic_sources(auto_scaling_group_name='my-auto-scaling-group', traffic_sources=[{'Identifier': 'arn:aws:elasticloadbalancing:us-west-2:123456789012:targetgroup/my-targets/73e2d6bc24d8a067'}])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.detach_traffic_sources_type.DetachTrafficSourcesType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.detach_traffic_sources_result_type.DetachTrafficSourcesResultType"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.detach_traffic_sources

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.detach_traffic_sources.async_detach_traffic_sources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_metrics_collection(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.disable_metrics_collection(auto_scaling_group_name='my-auto-scaling-group', metrics=['GroupDesiredCapacity'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.disable_metrics_collection_query.DisableMetricsCollectionQuery]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.disable_metrics_collection

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.disable_metrics_collection.async_disable_metrics_collection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_metrics_collection(
        self,
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        granularity: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        metrics: Optional["aws_sdk_auto_scaling.types.metrics.Metrics"] = None,
    ) -> None:
        ...
        Examples:
            ...
            >>> await client.enable_metrics_collection(auto_scaling_group_name='my-auto-scaling-group', granularity='1Minute')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.enable_metrics_collection_query.EnableMetricsCollectionQuery]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.enable_metrics_collection

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.enable_metrics_collection.async_enable_metrics_collection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enter_standby(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.enter_standby(instance_ids=['i-93633f9b'], auto_scaling_group_name='my-auto-scaling-group', should_decrement_desired_capacity=True)
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.enter_standby_query.EnterStandbyQuery]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.enter_standby_answer.EnterStandbyAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.enter_standby

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.enter_standby.async_enter_standby(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def execute_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.execute_policy(auto_scaling_group_name='my-auto-scaling-group', policy_name='my-step-scale-out-policy', breach_threshold=50.0, metric_value=59.0)
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.execute_policy_type.ExecutePolicyType]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.execute_policy

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.execute_policy.async_execute_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def exit_standby(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.exit_standby(instance_ids=['i-93633f9b'], auto_scaling_group_name='my-auto-scaling-group')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.exit_standby_query.ExitStandbyQuery]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.exit_standby_answer.ExitStandbyAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.exit_standby

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.exit_standby.async_exit_standby(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_predictive_scaling_forecast(
        self,
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        policy_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        start_time: "aws_sdk_auto_scaling.types.timestamp_type.TimestampType",
        end_time: "aws_sdk_auto_scaling.types.timestamp_type.TimestampType",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.get_predictive_scaling_forecast_type.GetPredictiveScalingForecastType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.get_predictive_scaling_forecast_answer.GetPredictiveScalingForecastAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.get_predictive_scaling_forecast

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.get_predictive_scaling_forecast.async_get_predictive_scaling_forecast(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def launch_instances(
        self,
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        requested_capacity: "aws_sdk_auto_scaling.types.requested_capacity.RequestedCapacity",
        client_token: "aws_sdk_auto_scaling.types.client_token.ClientToken",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        availability_zones: Optional[
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.launch_instances_request.LaunchInstancesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.launch_instances_result.LaunchInstancesResult"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.launch_instances

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.launch_instances.async_launch_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_lifecycle_hook(
        ...
        *,
        ...
        lifecycle_transition: Optional[
            "aws_sdk_auto_scaling.types.lifecycle_transition.LifecycleTransition"
        ] = None,
        role_arn: Optional[
            "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255"
        ] = None,
        notification_target_arn: Optional[
            "aws_sdk_auto_scaling.types.notification_target_resource_name.NotificationTargetResourceName"
        ] = None,
        notification_metadata: Optional[
            "aws_sdk_auto_scaling.types.any_printable_ascii_string_max_len4000.AnyPrintableAsciiStringMaxLen4000"
        ] = None,
        heartbeat_timeout: Optional[
            "aws_sdk_auto_scaling.types.heartbeat_timeout.HeartbeatTimeout"
        ] = None,
        ...
        Examples:
            ...
            >>> await client.put_lifecycle_hook(lifecycle_hook_name='my-launch-lifecycle-hook', heartbeat_timeout=300, auto_scaling_group_name='my-auto-scaling-group', lifecycle_transition='autoscaling:EC2_INSTANCE_LAUNCHING', default_result='CONTINUE')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.put_lifecycle_hook_type.PutLifecycleHookType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.put_lifecycle_hook_answer.PutLifecycleHookAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.put_lifecycle_hook

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.put_lifecycle_hook.async_put_lifecycle_hook(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_notification_configuration(
        ...
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        topic_arn: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        notification_types: "aws_sdk_auto_scaling.types.auto_scaling_notification_types.AutoScalingNotificationTypes",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
    ) -> None:
        ...
        Examples:
            ...
            >>> await client.put_notification_configuration(auto_scaling_group_name='my-auto-scaling-group', topic_arn='arn:aws:sns:us-west-2:123456789012:my-sns-topic', notification_types=['autoscaling:TEST_NOTIFICATION'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.put_notification_configuration_type.PutNotificationConfigurationType]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.put_notification_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.put_notification_configuration.async_put_notification_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_scaling_policy(
        ...
        *,
        ...
        cooldown: Optional["aws_sdk_auto_scaling.types.cooldown.Cooldown"] = None,
        ...
        Examples:
            ...
            >>> await client.put_scaling_policy(auto_scaling_group_name='my-auto-scaling-group', policy_name='alb1000-target-tracking-scaling-policy', policy_type='TargetTrackingScaling', target_tracking_configuration={'TargetValue': 1000.0, 'PredefinedMetricSpecification': {'PredefinedMetricType': 'ALBRequestCountPerTarget', 'ResourceLabel': 'app/my-alb/778d41231b141a0f/targetgroup/my-alb-target-group/943f017f100becff'}})
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.put_scaling_policy_type.PutScalingPolicyType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.policy_arn_type.PolicyARNType"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.put_scaling_policy

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.put_scaling_policy.async_put_scaling_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_scheduled_update_group_action(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.put_scheduled_update_group_action(auto_scaling_group_name='my-auto-scaling-group', scheduled_action_name='my-scheduled-action', start_time='2014-05-12T08:00:00Z', end_time='2014-05-12T08:00:00Z', min_size=2, max_size=6, desired_capacity=4)
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.put_scheduled_update_group_action_type.PutScheduledUpdateGroupActionType]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.put_scheduled_update_group_action

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.put_scheduled_update_group_action.async_put_scheduled_update_group_action(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_warm_pool(
        ...
        *,
        ...
        min_size: Optional[
            "aws_sdk_auto_scaling.types.warm_pool_min_size.WarmPoolMinSize"
        ] = None,
        pool_state: Optional[
            "aws_sdk_auto_scaling.types.warm_pool_state.WarmPoolState"
        ] = None,
        ...
        Examples:
            ...
            >>> await client.put_warm_pool(auto_scaling_group_name='my-auto-scaling-group', min_size=30, pool_state='Hibernated', instance_reuse_policy={'ReuseOnScaleIn': True})
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.put_warm_pool_type.PutWarmPoolType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.put_warm_pool_answer.PutWarmPoolAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.put_warm_pool

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.put_warm_pool.async_put_warm_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def record_lifecycle_action_heartbeat(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.record_lifecycle_action_heartbeat(lifecycle_hook_name='my-lifecycle-hook', auto_scaling_group_name='my-auto-scaling-group', lifecycle_action_token='bcd2f1b8-9a78-44d3-8a7a-4dd07d7cf635')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.record_lifecycle_action_heartbeat_type.RecordLifecycleActionHeartbeatType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.record_lifecycle_action_heartbeat_answer.RecordLifecycleActionHeartbeatAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.record_lifecycle_action_heartbeat

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.record_lifecycle_action_heartbeat.async_record_lifecycle_action_heartbeat(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def resume_processes(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.resume_processes(auto_scaling_group_name='my-auto-scaling-group', scaling_processes=['AlarmNotification'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.scaling_process_query.ScalingProcessQuery]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.resume_processes

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.resume_processes.async_resume_processes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def rollback_instance_refresh(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.rollback_instance_refresh_type.RollbackInstanceRefreshType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.rollback_instance_refresh_answer.RollbackInstanceRefreshAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.rollback_instance_refresh

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.rollback_instance_refresh.async_rollback_instance_refresh(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_desired_capacity(
        self,
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        desired_capacity: "aws_sdk_auto_scaling.types.auto_scaling_group_desired_capacity.AutoScalingGroupDesiredCapacity",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        honor_cooldown: Optional[
            "aws_sdk_auto_scaling.types.honor_cooldown.HonorCooldown"
        ...
        Examples:
            ...
            >>> await client.set_desired_capacity(auto_scaling_group_name='my-auto-scaling-group', desired_capacity=2, honor_cooldown=True)
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.set_desired_capacity_type.SetDesiredCapacityType]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.set_desired_capacity

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.set_desired_capacity.async_set_desired_capacity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_instance_health(
        self,
        instance_id: "aws_sdk_auto_scaling.types.xml_string_max_len19.XmlStringMaxLen19",
        health_status: "aws_sdk_auto_scaling.types.xml_string_max_len32.XmlStringMaxLen32",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        ...
        Examples:
            ...
            >>> await client.set_instance_health(instance_id='i-93633f9b', health_status='Unhealthy')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.set_instance_health_query.SetInstanceHealthQuery]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.set_instance_health

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.set_instance_health.async_set_instance_health(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_instance_protection(
        self,
        instance_ids: "aws_sdk_auto_scaling.types.instance_ids.InstanceIds",
        auto_scaling_group_name: "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255",
        protected_from_scale_in: "aws_sdk_auto_scaling.types.protected_from_scale_in.ProtectedFromScaleIn",
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        ...
        Examples:
            ...
            >>> await client.set_instance_protection(instance_ids=['i-93633f9b'], auto_scaling_group_name='my-auto-scaling-group', protected_from_scale_in=True)
            To disable instance protection for an instance
            This example disables instance protection for the specified instance.

            >>> await client.set_instance_protection(instance_ids=['i-93633f9b'], auto_scaling_group_name='my-auto-scaling-group', protected_from_scale_in=False)
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.set_instance_protection_query.SetInstanceProtectionQuery]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.set_instance_protection_answer.SetInstanceProtectionAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.set_instance_protection

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.set_instance_protection.async_set_instance_protection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_instance_refresh(
        ...
        *,
        config_overrides: Optional[AsyncAutoScalingClientConfig] = None,
        strategy: Optional[
            "aws_sdk_auto_scaling.types.refresh_strategy.RefreshStrategy"
        ] = None,
        ...
        Examples:
            ...
            >>> await client.start_instance_refresh(auto_scaling_group_name='my-auto-scaling-group', desired_configuration={'LaunchTemplate': {'LaunchTemplateName': 'my-template-for-auto-scaling', 'Version': '$Latest'}}, preferences={'AutoRollback': True, 'InstanceWarmup': 200, 'MinHealthyPercentage': 90, 'MaxHealthyPercentage': 120, 'AlarmSpecification': {'Alarms': ['my-alarm']}})
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.start_instance_refresh_type.StartInstanceRefreshType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.start_instance_refresh_answer.StartInstanceRefreshAnswer"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.start_instance_refresh

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.start_instance_refresh.async_start_instance_refresh(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def suspend_processes(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.suspend_processes(auto_scaling_group_name='my-auto-scaling-group', scaling_processes=['AlarmNotification'])
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.scaling_process_query.ScalingProcessQuery]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.suspend_processes

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.suspend_processes.async_suspend_processes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def terminate_instance_in_auto_scaling_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.terminate_instance_in_auto_scaling_group(instance_id='i-93633f9b', should_decrement_desired_capacity=False)
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.terminate_instance_in_auto_scaling_group_type.TerminateInstanceInAutoScalingGroupType]",
        ) -> AsyncOperationResponse[
            "aws_sdk_auto_scaling.types.activity_type.ActivityType"
        ]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.terminate_instance_in_auto_scaling_group

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.terminate_instance_in_auto_scaling_group.async_terminate_instance_in_auto_scaling_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_auto_scaling_group(
        ...
        *,
        ...
        placement_group: Optional[
            "aws_sdk_auto_scaling.types.update_placement_group_param.UpdatePlacementGroupParam"
        ] = None,
        vpc_zone_identifier: Optional[
            "aws_sdk_auto_scaling.types.xml_string_max_len5000.XmlStringMaxLen5000"
        ] = None,
        ...
        Examples:
            ...
            >>> await client.update_auto_scaling_group(auto_scaling_group_name='my-auto-scaling-group', launch_template={'LaunchTemplateName': 'my-template-for-auto-scaling', 'Version': '2'}, min_size=1, max_size=5, new_instances_protected_from_scale_in=True)
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_auto_scaling.types.update_auto_scaling_group_type.UpdateAutoScalingGroupType]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.update_auto_scaling_group

            (
                output,
                http_response,
            ) = await aws_sdk_auto_scaling._operations.auto_scaling_2011_01_01.update_auto_scaling_group.async_update_auto_scaling_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
