...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.auto_scaling_group_state
    import aws_sdk_auto_scaling.types.progress
    import aws_sdk_auto_scaling.types.resource_name
    import aws_sdk_auto_scaling.types.scaling_activity_status_code
...
class Activity(TypedDict):
    ...
    description: NotRequired["aws_sdk_auto_scaling.types.xml_string.XmlString"]
    ...
    status_code: NotRequired[
        "aws_sdk_auto_scaling.types.scaling_activity_status_code.ScalingActivityStatusCode"
    ]
    ...
    progress: NotRequired["aws_sdk_auto_scaling.types.progress.Progress"]
    """<p>A value between 0 and 100 that indicates the progress of the activity.</p>"""
    details: NotRequired["aws_sdk_auto_scaling.types.xml_string.XmlString"]
    """<p>The details about the activity.</p>"""
    auto_scaling_group_state: NotRequired[
        "aws_sdk_auto_scaling.types.auto_scaling_group_state.AutoScalingGroupState"
    ]
...
def serialize_query(value: Activity, pairs: list[tuple[str, str]], prefix: str) -> None:
    ...
    if "status_code" in value:
        ...
        aws_sdk_auto_scaling.types.scaling_activity_status_code.serialize_query(
...
def deserialize_query(el: Element) -> Activity:
    ...
    if child_status_code is not None:
        ...
        out["status_code"] = (
            aws_sdk_auto_scaling.types.scaling_activity_status_code.deserialize_query(
                child_status_code
            )
        )
