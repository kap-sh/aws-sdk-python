...
if TYPE_CHECKING:
    ...
    import aws_sdk_auto_scaling.types.metric_statistic
    import aws_sdk_auto_scaling.types.metric_unit
    import aws_sdk_auto_scaling.types.target_tracking_metric_data_queries
...
class CustomizedMetricSpecification(TypedDict):
    ...
    statistic: NotRequired[
        "aws_sdk_auto_scaling.types.metric_statistic.MetricStatistic"
    ]
...
def serialize_query(
    ...
    if "statistic" in value:
        ...
        aws_sdk_auto_scaling.types.metric_statistic.serialize_query(
    ...
    if "metrics" in value:
        ...
        aws_sdk_auto_scaling.types.target_tracking_metric_data_queries.serialize_query(
...
def deserialize_query(el: Element) -> CustomizedMetricSpecification:
    ...
    if child_statistic is not None:
        ...
        out["statistic"] = (
            aws_sdk_auto_scaling.types.metric_statistic.deserialize_query(
                child_statistic
            )
        )
    ...
    if child_metrics is not None:
        ...
        out["metrics"] = (
            aws_sdk_auto_scaling.types.target_tracking_metric_data_queries.deserialize_query(
                child_metrics
            )
        )
    return out
