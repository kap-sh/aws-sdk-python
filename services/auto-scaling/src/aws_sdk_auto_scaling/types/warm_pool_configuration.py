...
class WarmPoolConfiguration(TypedDict):
    ...
    pool_state: NotRequired["aws_sdk_auto_scaling.types.warm_pool_state.WarmPoolState"]
    """<p>The instance state to transition to after the lifecycle actions are complete.</p>"""
    status: NotRequired["aws_sdk_auto_scaling.types.warm_pool_status.WarmPoolStatus"]
...
def serialize_query(
    ...
    if "pool_state" in value:
        ...
        aws_sdk_auto_scaling.types.warm_pool_state.serialize_query(
            value["pool_state"], pairs, f"{prefix}.PoolState"
        )
    if "status" in value:
        import aws_sdk_auto_scaling.types.warm_pool_status

        aws_sdk_auto_scaling.types.warm_pool_status.serialize_query(
            value["status"], pairs, f"{prefix}.Status"
        )
    if "instance_reuse_policy" in value:
        import aws_sdk_auto_scaling.types.instance_reuse_policy

        aws_sdk_auto_scaling.types.instance_reuse_policy.serialize_query(
...
def deserialize_query(el: Element) -> WarmPoolConfiguration:
    ...
    if child_pool_state is not None:
        ...
        out["pool_state"] = (
            aws_sdk_auto_scaling.types.warm_pool_state.deserialize_query(
                child_pool_state
            )
        )
    ...
    if child_status is not None:
        ...
        out["status"] = aws_sdk_auto_scaling.types.warm_pool_status.deserialize_query(
            child_status
        )
    ...
    if child_instance_reuse_policy is not None:
        ...
        out["instance_reuse_policy"] = (
            aws_sdk_auto_scaling.types.instance_reuse_policy.deserialize_query(
