"""Generated from Smithy shape ``com.amazonaws.autoscaling#EnableMetricsCollectionQuery``."""
...
class EnableMetricsCollectionQuery(TypedDict, closed=True):
    auto_scaling_group_name: NotRequired[
        "aws_sdk_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255"
    ]
    """<p>The name of the Auto Scaling group.</p>"""
    metrics: NotRequired["aws_sdk_auto_scaling.types.metrics.Metrics"]
...
def serialize_query(
    ...
    if "metrics" in value:
        ...
        aws_sdk_auto_scaling.types.metrics.serialize_query(
...
def deserialize_query(el: Element) -> EnableMetricsCollectionQuery:
    out: EnableMetricsCollectionQuery = {}  # type: ignore[typeddict-item]
    ...
    if child_metrics is not None:
        ...
        out["metrics"] = aws_sdk_auto_scaling.types.metrics.deserialize_query(
            child_metrics
        )
