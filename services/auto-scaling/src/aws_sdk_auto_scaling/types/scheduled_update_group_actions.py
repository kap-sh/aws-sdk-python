...
ScheduledUpdateGroupActions: TypeAlias = list[
    "aws_sdk_auto_scaling.types.scheduled_update_group_action.ScheduledUpdateGroupAction"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_auto_scaling.types.scheduled_update_group_action.serialize_query(
...
def deserialize_query(el: Element) -> ScheduledUpdateGroupActions:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_auto_scaling.types.scheduled_update_group_action.deserialize_query(
                child
            )
        )
    return out
