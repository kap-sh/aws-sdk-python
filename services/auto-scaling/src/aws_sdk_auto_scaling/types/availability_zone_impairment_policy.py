...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.impaired_zone_health_check_behavior
    import aws_sdk_auto_scaling.types.zonal_shift_enabled


class AvailabilityZoneImpairmentPolicy(TypedDict):
    zonal_shift_enabled: NotRequired[
        "aws_sdk_auto_scaling.types.zonal_shift_enabled.ZonalShiftEnabled"
    ]
    """<p> If <code>true</code>, enable zonal shift for your Auto Scaling group. </p>"""
    impaired_zone_health_check_behavior: NotRequired[
        "aws_sdk_auto_scaling.types.impaired_zone_health_check_behavior.ImpairedZoneHealthCheckBehavior"
    ]
...
def serialize_query(
    ...
    if "impaired_zone_health_check_behavior" in value:
        ...
        aws_sdk_auto_scaling.types.impaired_zone_health_check_behavior.serialize_query(
...
def deserialize_query(el: Element) -> AvailabilityZoneImpairmentPolicy:
    ...
    if child_impaired_zone_health_check_behavior is not None:
        ...
        out["impaired_zone_health_check_behavior"] = (
            aws_sdk_auto_scaling.types.impaired_zone_health_check_behavior.deserialize_query(
