...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.capacity_distribution_strategy


class AvailabilityZoneDistribution(TypedDict):
    capacity_distribution_strategy: NotRequired[
        "aws_sdk_auto_scaling.types.capacity_distribution_strategy.CapacityDistributionStrategy"
    ]
...
def serialize_query(
    ...
    if "capacity_distribution_strategy" in value:
        ...
        aws_sdk_auto_scaling.types.capacity_distribution_strategy.serialize_query(
...
def deserialize_query(el: Element) -> AvailabilityZoneDistribution:
    ...
    if child_capacity_distribution_strategy is not None:
        ...
        out["capacity_distribution_strategy"] = (
            aws_sdk_auto_scaling.types.capacity_distribution_strategy.deserialize_query(
