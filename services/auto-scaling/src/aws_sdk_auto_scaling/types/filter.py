...
def serialize_query(value: Filter, pairs: list[tuple[str, str]], prefix: str) -> None:
    ...
    if "values" in value:
        ...
        aws_sdk_auto_scaling.types.values.serialize_query(
...
def deserialize_query(el: Element) -> Filter:
    ...
    if child_values is not None:
        ...
        out["values"] = aws_sdk_auto_scaling.types.values.deserialize_query(
            child_values
        )
    return out
