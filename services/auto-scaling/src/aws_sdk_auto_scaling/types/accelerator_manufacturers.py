...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.accelerator_manufacturer

AcceleratorManufacturers: TypeAlias = list[
    "aws_sdk_auto_scaling.types.accelerator_manufacturer.AcceleratorManufacturer"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_auto_scaling.types.accelerator_manufacturer.serialize_query(
...
def deserialize_query(el: Element) -> AcceleratorManufacturers:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_auto_scaling.types.accelerator_manufacturer.deserialize_query(child)
        )
    return out
