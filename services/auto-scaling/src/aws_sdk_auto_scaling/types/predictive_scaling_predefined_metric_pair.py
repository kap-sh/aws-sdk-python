"""Generated from Smithy shape ``com.amazonaws.autoscaling#PredictiveScalingPredefinedMetricPair``."""
...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.predefined_metric_pair_type
    import aws_sdk_auto_scaling.types.xml_string_max_len1023


class PredictiveScalingPredefinedMetricPair(TypedDict, closed=True):
    predefined_metric_type: NotRequired[
        "aws_sdk_auto_scaling.types.predefined_metric_pair_type.PredefinedMetricPairType"
    ]
...
def serialize_query(
    ...
    if "predefined_metric_type" in value:
        ...
        aws_sdk_auto_scaling.types.predefined_metric_pair_type.serialize_query(
...
def deserialize_query(el: Element) -> PredictiveScalingPredefinedMetricPair:
    out: PredictiveScalingPredefinedMetricPair = {}  # type: ignore[typeddict-item]
    ...
    if child_predefined_metric_type is not None:
        ...
        out["predefined_metric_type"] = (
            aws_sdk_auto_scaling.types.predefined_metric_pair_type.deserialize_query(
