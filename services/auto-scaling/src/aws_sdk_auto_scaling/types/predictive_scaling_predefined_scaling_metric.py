"""Generated from Smithy shape ``com.amazonaws.autoscaling#PredictiveScalingPredefinedScalingMetric``."""
...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.predefined_scaling_metric_type
    import aws_sdk_auto_scaling.types.xml_string_max_len1023


class PredictiveScalingPredefinedScalingMetric(TypedDict, closed=True):
    predefined_metric_type: NotRequired[
        "aws_sdk_auto_scaling.types.predefined_scaling_metric_type.PredefinedScalingMetricType"
    ]
    """<p>The metric type.</p>"""
...
def serialize_query(
    ...
    if "predefined_metric_type" in value:
        ...
        aws_sdk_auto_scaling.types.predefined_scaling_metric_type.serialize_query(
...
def deserialize_query(el: Element) -> PredictiveScalingPredefinedScalingMetric:
    out: PredictiveScalingPredefinedScalingMetric = {}  # type: ignore[typeddict-item]
    ...
    if child_predefined_metric_type is not None:
        ...
        out["predefined_metric_type"] = (
            aws_sdk_auto_scaling.types.predefined_scaling_metric_type.deserialize_query(
