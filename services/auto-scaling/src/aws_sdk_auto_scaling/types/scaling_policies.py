...
ScalingPolicies: TypeAlias = list[
    "aws_sdk_auto_scaling.types.scaling_policy.ScalingPolicy"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_auto_scaling.types.scaling_policy.serialize_query(
...
def deserialize_query(el: Element) -> ScalingPolicies:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_auto_scaling.types.scaling_policy.deserialize_query(child))
    return out
