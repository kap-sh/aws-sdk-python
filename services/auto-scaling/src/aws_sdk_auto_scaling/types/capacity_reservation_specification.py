...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.capacity_reservation_preference
    import aws_sdk_auto_scaling.types.capacity_reservation_target


class CapacityReservationSpecification(TypedDict):
    capacity_reservation_preference: NotRequired[
        "aws_sdk_auto_scaling.types.capacity_reservation_preference.CapacityReservationPreference"
    ]
    ...
    capacity_reservation_target: NotRequired[
        "aws_sdk_auto_scaling.types.capacity_reservation_target.CapacityReservationTarget"
    ]
...
def serialize_query(
    ...
    if "capacity_reservation_preference" in value:
        ...
        aws_sdk_auto_scaling.types.capacity_reservation_preference.serialize_query(
    ...
    if "capacity_reservation_target" in value:
        ...
        aws_sdk_auto_scaling.types.capacity_reservation_target.serialize_query(
...
def deserialize_query(el: Element) -> CapacityReservationSpecification:
    ...
    if child_capacity_reservation_preference is not None:
        ...
        out["capacity_reservation_preference"] = (
            aws_sdk_auto_scaling.types.capacity_reservation_preference.deserialize_query(
    ...
    if child_capacity_reservation_target is not None:
        ...
        out["capacity_reservation_target"] = (
            aws_sdk_auto_scaling.types.capacity_reservation_target.deserialize_query(
