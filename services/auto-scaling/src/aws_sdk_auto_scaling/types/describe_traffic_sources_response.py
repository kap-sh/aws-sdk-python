...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.traffic_source_states
    import aws_sdk_auto_scaling.types.xml_string


class DescribeTrafficSourcesResponse(TypedDict):
    traffic_sources: NotRequired[
        "aws_sdk_auto_scaling.types.traffic_source_states.TrafficSourceStates"
    ]
...
def serialize_query(
    ...
    if "traffic_sources" in value:
        ...
        aws_sdk_auto_scaling.types.traffic_source_states.serialize_query(
...
def deserialize_query(el: Element) -> DescribeTrafficSourcesResponse:
    ...
    if child_traffic_sources is not None:
        ...
        out["traffic_sources"] = (
            aws_sdk_auto_scaling.types.traffic_source_states.deserialize_query(
