...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.alarm_specification
    import aws_sdk_auto_scaling.types.auto_rollback
    import aws_sdk_auto_scaling.types.bake_time
    import aws_sdk_auto_scaling.types.checkpoint_delay
    import aws_sdk_auto_scaling.types.checkpoint_percentages
    import aws_sdk_auto_scaling.types.int_percent
    import aws_sdk_auto_scaling.types.int_percent100_to200
    import aws_sdk_auto_scaling.types.refresh_instance_warmup
    import aws_sdk_auto_scaling.types.scale_in_protected_instances
    import aws_sdk_auto_scaling.types.skip_matching
...
class RefreshPreferences(TypedDict, closed=True):
    ...
    instance_warmup: NotRequired[
        "aws_sdk_auto_scaling.types.refresh_instance_warmup.RefreshInstanceWarmup"
    ]
    ...
    checkpoint_percentages: NotRequired[
        "aws_sdk_auto_scaling.types.checkpoint_percentages.CheckpointPercentages"
    ]
    ...
    checkpoint_delay: NotRequired[
        "aws_sdk_auto_scaling.types.checkpoint_delay.CheckpointDelay"
    ]
    ...
    skip_matching: NotRequired["aws_sdk_auto_scaling.types.skip_matching.SkipMatching"]
    ...
    auto_rollback: NotRequired["aws_sdk_auto_scaling.types.auto_rollback.AutoRollback"]
    ...
    scale_in_protected_instances: NotRequired[
        "aws_sdk_auto_scaling.types.scale_in_protected_instances.ScaleInProtectedInstances"
    ]
    ...
    standby_instances: NotRequired[
        "aws_sdk_auto_scaling.types.standby_instances.StandbyInstances"
    ]
    ...
    alarm_specification: NotRequired[
        "aws_sdk_auto_scaling.types.alarm_specification.AlarmSpecification"
    ]
    ...
    max_healthy_percentage: NotRequired[
        "aws_sdk_auto_scaling.types.int_percent100_to200.IntPercent100To200"
    ]
    ...
    bake_time: NotRequired["aws_sdk_auto_scaling.types.bake_time.BakeTime"]
...
def serialize_query(
    ...
    if "checkpoint_percentages" in value:
        ...
        aws_sdk_auto_scaling.types.checkpoint_percentages.serialize_query(
    ...
    if "scale_in_protected_instances" in value:
        ...
        aws_sdk_auto_scaling.types.scale_in_protected_instances.serialize_query(
    ...
    if "standby_instances" in value:
        ...
        aws_sdk_auto_scaling.types.standby_instances.serialize_query(
            value["standby_instances"], pairs, f"{prefix}.StandbyInstances"
        )
    if "alarm_specification" in value:
        import aws_sdk_auto_scaling.types.alarm_specification

        aws_sdk_auto_scaling.types.alarm_specification.serialize_query(
...
def deserialize_query(el: Element) -> RefreshPreferences:
    ...
    if child_checkpoint_percentages is not None:
        ...
        out["checkpoint_percentages"] = (
            aws_sdk_auto_scaling.types.checkpoint_percentages.deserialize_query(
    ...
    if child_scale_in_protected_instances is not None:
        ...
        out["scale_in_protected_instances"] = (
            aws_sdk_auto_scaling.types.scale_in_protected_instances.deserialize_query(
    ...
    if child_standby_instances is not None:
        ...
        out["standby_instances"] = (
            aws_sdk_auto_scaling.types.standby_instances.deserialize_query(
    ...
    if child_alarm_specification is not None:
        ...
        out["alarm_specification"] = (
            aws_sdk_auto_scaling.types.alarm_specification.deserialize_query(
