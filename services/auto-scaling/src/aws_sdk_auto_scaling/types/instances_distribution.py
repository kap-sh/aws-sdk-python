...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.mixed_instance_spot_price
    import aws_sdk_auto_scaling.types.on_demand_base_capacity
    import aws_sdk_auto_scaling.types.on_demand_percentage_above_base_capacity
    import aws_sdk_auto_scaling.types.spot_instance_pools
    import aws_sdk_auto_scaling.types.xml_string


class InstancesDistribution(TypedDict):
    on_demand_allocation_strategy: NotRequired[
        "aws_sdk_auto_scaling.types.xml_string.XmlString"
    ]
    ...
    on_demand_base_capacity: NotRequired[
        "aws_sdk_auto_scaling.types.on_demand_base_capacity.OnDemandBaseCapacity"
    ]
    ...
    on_demand_percentage_above_base_capacity: NotRequired[
        "aws_sdk_auto_scaling.types.on_demand_percentage_above_base_capacity.OnDemandPercentageAboveBaseCapacity"
    ]
    ...
    spot_instance_pools: NotRequired[
        "aws_sdk_auto_scaling.types.spot_instance_pools.SpotInstancePools"
    ]
    ...
    spot_max_price: NotRequired[
        "aws_sdk_auto_scaling.types.mixed_instance_spot_price.MixedInstanceSpotPrice"
    ]
