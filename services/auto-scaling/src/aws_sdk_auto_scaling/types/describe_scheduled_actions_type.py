...
class DescribeScheduledActionsType(TypedDict):
...
def serialize_query(
    ...
    if "scheduled_action_names" in value:
        ...
        aws_sdk_auto_scaling.types.scheduled_action_names.serialize_query(
...
def deserialize_query(el: Element) -> DescribeScheduledActionsType:
    ...
    if child_scheduled_action_names is not None:
        ...
        out["scheduled_action_names"] = (
            aws_sdk_auto_scaling.types.scheduled_action_names.deserialize_query(
