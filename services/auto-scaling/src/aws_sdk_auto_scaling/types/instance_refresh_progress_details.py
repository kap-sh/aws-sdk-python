...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.instance_refresh_live_pool_progress
...
class InstanceRefreshProgressDetails(TypedDict, closed=True):
    ...
    warm_pool_progress: NotRequired[
        "aws_sdk_auto_scaling.types.instance_refresh_warm_pool_progress.InstanceRefreshWarmPoolProgress"
    ]
...
def serialize_query(
    ...
    if "live_pool_progress" in value:
        ...
        aws_sdk_auto_scaling.types.instance_refresh_live_pool_progress.serialize_query(
            value["live_pool_progress"], pairs, f"{prefix}.LivePoolProgress"
        )
    if "warm_pool_progress" in value:
        import aws_sdk_auto_scaling.types.instance_refresh_warm_pool_progress

        aws_sdk_auto_scaling.types.instance_refresh_warm_pool_progress.serialize_query(
...
def deserialize_query(el: Element) -> InstanceRefreshProgressDetails:
    ...
    if child_live_pool_progress is not None:
        ...
        out["live_pool_progress"] = (
            aws_sdk_auto_scaling.types.instance_refresh_live_pool_progress.deserialize_query(
    ...
    if child_warm_pool_progress is not None:
        ...
        out["warm_pool_progress"] = (
            aws_sdk_auto_scaling.types.instance_refresh_warm_pool_progress.deserialize_query(
