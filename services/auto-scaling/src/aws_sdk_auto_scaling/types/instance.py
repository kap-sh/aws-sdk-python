...
if TYPE_CHECKING:
    ...
    import aws_sdk_auto_scaling.types.lifecycle_state
...
def serialize_query(value: Instance, pairs: list[tuple[str, str]], prefix: str) -> None:
    ...
    if "lifecycle_state" in value:
        ...
        aws_sdk_auto_scaling.types.lifecycle_state.serialize_query(
...
def deserialize_query(el: Element) -> Instance:
    ...
    if child_lifecycle_state is not None:
        ...
        out["lifecycle_state"] = (
            aws_sdk_auto_scaling.types.lifecycle_state.deserialize_query(
