...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.int_percent100_to200_resettable
    import aws_sdk_auto_scaling.types.int_percent_resettable


class InstanceMaintenancePolicy(TypedDict):
    min_healthy_percentage: NotRequired[
        "aws_sdk_auto_scaling.types.int_percent_resettable.IntPercentResettable"
    ]
    ...
    max_healthy_percentage: NotRequired[
        "aws_sdk_auto_scaling.types.int_percent100_to200_resettable.IntPercent100To200Resettable"
    ]
