...
if TYPE_CHECKING:
    ...
    import aws_sdk_auto_scaling.types.predictive_scaling_customized_capacity_metric
    import aws_sdk_auto_scaling.types.predictive_scaling_customized_load_metric
    import aws_sdk_auto_scaling.types.predictive_scaling_customized_scaling_metric
    import aws_sdk_auto_scaling.types.predictive_scaling_predefined_load_metric
    import aws_sdk_auto_scaling.types.predictive_scaling_predefined_metric_pair
...
class PredictiveScalingMetricSpecification(TypedDict):
    ...
    predefined_metric_pair_specification: NotRequired[
        "aws_sdk_auto_scaling.types.predictive_scaling_predefined_metric_pair.PredictiveScalingPredefinedMetricPair"
    ]
    ...
    predefined_scaling_metric_specification: NotRequired[
        "aws_sdk_auto_scaling.types.predictive_scaling_predefined_scaling_metric.PredictiveScalingPredefinedScalingMetric"
    ]
    """<p>The predefined scaling metric specification.</p>"""
    predefined_load_metric_specification: NotRequired[
        "aws_sdk_auto_scaling.types.predictive_scaling_predefined_load_metric.PredictiveScalingPredefinedLoadMetric"
    ]
    """<p>The predefined load metric specification.</p>"""
    customized_scaling_metric_specification: NotRequired[
        "aws_sdk_auto_scaling.types.predictive_scaling_customized_scaling_metric.PredictiveScalingCustomizedScalingMetric"
    ]
    """<p>The customized scaling metric specification.</p>"""
    customized_load_metric_specification: NotRequired[
        "aws_sdk_auto_scaling.types.predictive_scaling_customized_load_metric.PredictiveScalingCustomizedLoadMetric"
    ]
    """<p>The customized load metric specification.</p>"""
    customized_capacity_metric_specification: NotRequired[
        "aws_sdk_auto_scaling.types.predictive_scaling_customized_capacity_metric.PredictiveScalingCustomizedCapacityMetric"
    ]
...
def serialize_query(
    ...
    if "predefined_metric_pair_specification" in value:
        ...
        aws_sdk_auto_scaling.types.predictive_scaling_predefined_metric_pair.serialize_query(
    ...
    if "predefined_scaling_metric_specification" in value:
        ...
        aws_sdk_auto_scaling.types.predictive_scaling_predefined_scaling_metric.serialize_query(
    ...
    if "predefined_load_metric_specification" in value:
        ...
        aws_sdk_auto_scaling.types.predictive_scaling_predefined_load_metric.serialize_query(
    ...
    if "customized_scaling_metric_specification" in value:
        ...
        aws_sdk_auto_scaling.types.predictive_scaling_customized_scaling_metric.serialize_query(
    ...
    if "customized_load_metric_specification" in value:
        ...
        aws_sdk_auto_scaling.types.predictive_scaling_customized_load_metric.serialize_query(
    ...
    if "customized_capacity_metric_specification" in value:
        ...
        aws_sdk_auto_scaling.types.predictive_scaling_customized_capacity_metric.serialize_query(
...
def deserialize_query(el: Element) -> PredictiveScalingMetricSpecification:
    ...
    if child_predefined_metric_pair_specification is not None:
        ...
        out["predefined_metric_pair_specification"] = (
            aws_sdk_auto_scaling.types.predictive_scaling_predefined_metric_pair.deserialize_query(
    ...
    if child_predefined_scaling_metric_specification is not None:
        ...
        out["predefined_scaling_metric_specification"] = (
            aws_sdk_auto_scaling.types.predictive_scaling_predefined_scaling_metric.deserialize_query(
    ...
    if child_predefined_load_metric_specification is not None:
        ...
        out["predefined_load_metric_specification"] = (
            aws_sdk_auto_scaling.types.predictive_scaling_predefined_load_metric.deserialize_query(
    ...
    if child_customized_scaling_metric_specification is not None:
        ...
        out["customized_scaling_metric_specification"] = (
            aws_sdk_auto_scaling.types.predictive_scaling_customized_scaling_metric.deserialize_query(
    ...
    if child_customized_load_metric_specification is not None:
        ...
        out["customized_load_metric_specification"] = (
            aws_sdk_auto_scaling.types.predictive_scaling_customized_load_metric.deserialize_query(
    ...
    if child_customized_capacity_metric_specification is not None:
        ...
        out["customized_capacity_metric_specification"] = (
            aws_sdk_auto_scaling.types.predictive_scaling_customized_capacity_metric.deserialize_query(
