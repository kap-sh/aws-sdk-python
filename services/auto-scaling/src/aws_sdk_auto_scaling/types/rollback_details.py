...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.instance_refresh_progress_details
...
class RollbackDetails(TypedDict):
    ...
    progress_details_on_rollback: NotRequired[
        "aws_sdk_auto_scaling.types.instance_refresh_progress_details.InstanceRefreshProgressDetails"
    ]
...
def serialize_query(
    ...
    if "progress_details_on_rollback" in value:
        ...
        aws_sdk_auto_scaling.types.instance_refresh_progress_details.serialize_query(
...
def deserialize_query(el: Element) -> RollbackDetails:
    ...
    if child_progress_details_on_rollback is not None:
        ...
        out["progress_details_on_rollback"] = (
            aws_sdk_auto_scaling.types.instance_refresh_progress_details.deserialize_query(
