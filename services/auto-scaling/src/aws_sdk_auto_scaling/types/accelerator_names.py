...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.accelerator_name

AcceleratorNames: TypeAlias = list[
    "aws_sdk_auto_scaling.types.accelerator_name.AcceleratorName"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_auto_scaling.types.accelerator_name.serialize_query(
...
def deserialize_query(el: Element) -> AcceleratorNames:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_auto_scaling.types.accelerator_name.deserialize_query(child))
    return out
