...
AutoScalingInstances: TypeAlias = list[
    "aws_sdk_auto_scaling.types.auto_scaling_instance_details.AutoScalingInstanceDetails"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_auto_scaling.types.auto_scaling_instance_details.serialize_query(
...
def deserialize_query(el: Element) -> AutoScalingInstances:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_auto_scaling.types.auto_scaling_instance_details.deserialize_query(
                child
            )
        )
    return out
