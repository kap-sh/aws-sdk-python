...
if TYPE_CHECKING:
    ...
    import aws_sdk_auto_scaling.types.global_timeout
...
class LifecycleHook(TypedDict):
    ...
    global_timeout: NotRequired[
        "aws_sdk_auto_scaling.types.global_timeout.GlobalTimeout"
    ]
