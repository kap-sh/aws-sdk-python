...
if TYPE_CHECKING:
    ...
    import aws_sdk_auto_scaling.types.instance_refresh_status
    ...
    import aws_sdk_auto_scaling.types.rollback_details
...
class InstanceRefresh(TypedDict):
    ...
    status: NotRequired[
        "aws_sdk_auto_scaling.types.instance_refresh_status.InstanceRefreshStatus"
    ]
    ...
    rollback_details: NotRequired[
        "aws_sdk_auto_scaling.types.rollback_details.RollbackDetails"
    ]
...
def serialize_query(
    ...
    if "status" in value:
        ...
        aws_sdk_auto_scaling.types.instance_refresh_status.serialize_query(
    ...
    if "rollback_details" in value:
        ...
        aws_sdk_auto_scaling.types.rollback_details.serialize_query(
...
def deserialize_query(el: Element) -> InstanceRefresh:
    ...
    if child_status is not None:
        ...
        out["status"] = (
            aws_sdk_auto_scaling.types.instance_refresh_status.deserialize_query(
                child_status
            )
        )
    ...
    if child_rollback_details is not None:
        ...
        out["rollback_details"] = (
            aws_sdk_auto_scaling.types.rollback_details.deserialize_query(
