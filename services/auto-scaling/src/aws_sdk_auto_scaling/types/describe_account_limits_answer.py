...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.max_number_of_auto_scaling_groups
    import aws_sdk_auto_scaling.types.max_number_of_launch_configurations
    import aws_sdk_auto_scaling.types.number_of_auto_scaling_groups
...
class DescribeAccountLimitsAnswer(TypedDict):
    ...
    max_number_of_launch_configurations: NotRequired[
        "aws_sdk_auto_scaling.types.max_number_of_launch_configurations.MaxNumberOfLaunchConfigurations"
    ]
    ...
    number_of_auto_scaling_groups: NotRequired[
        "aws_sdk_auto_scaling.types.number_of_auto_scaling_groups.NumberOfAutoScalingGroups"
    ]
    """<p>The current number of groups for your account.</p>"""
    number_of_launch_configurations: NotRequired[
        "aws_sdk_auto_scaling.types.number_of_launch_configurations.NumberOfLaunchConfigurations"
    ]
