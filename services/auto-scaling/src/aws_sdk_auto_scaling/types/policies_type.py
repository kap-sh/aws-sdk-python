...
class PoliciesType(TypedDict):
    scaling_policies: NotRequired[
        "aws_sdk_auto_scaling.types.scaling_policies.ScalingPolicies"
    ]
...
def serialize_query(
    ...
    if "scaling_policies" in value:
        ...
        aws_sdk_auto_scaling.types.scaling_policies.serialize_query(
...
def deserialize_query(el: Element) -> PoliciesType:
    ...
    if child_scaling_policies is not None:
        ...
        out["scaling_policies"] = (
            aws_sdk_auto_scaling.types.scaling_policies.deserialize_query(
