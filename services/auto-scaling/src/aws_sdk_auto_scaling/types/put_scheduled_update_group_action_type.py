...
class PutScheduledUpdateGroupActionType(TypedDict, closed=True):
    ...
    r"""<p>The date and time for the recurring schedule to end, in UTC. For example, <code>\"2021-06-01T00:00:00Z\"</code>.</p>"""
