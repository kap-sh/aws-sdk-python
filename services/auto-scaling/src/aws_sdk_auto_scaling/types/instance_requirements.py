...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.accelerator_count_request
    import aws_sdk_auto_scaling.types.accelerator_manufacturers
    import aws_sdk_auto_scaling.types.accelerator_names
    import aws_sdk_auto_scaling.types.accelerator_total_memory_mi_b_request
    import aws_sdk_auto_scaling.types.accelerator_types
    import aws_sdk_auto_scaling.types.allowed_instance_types
    import aws_sdk_auto_scaling.types.bare_metal
    import aws_sdk_auto_scaling.types.baseline_ebs_bandwidth_mbps_request
    import aws_sdk_auto_scaling.types.baseline_performance_factors_request
    import aws_sdk_auto_scaling.types.burstable_performance
    import aws_sdk_auto_scaling.types.cpu_manufacturers
    import aws_sdk_auto_scaling.types.excluded_instance_types
    import aws_sdk_auto_scaling.types.instance_generations
    import aws_sdk_auto_scaling.types.local_storage
    import aws_sdk_auto_scaling.types.local_storage_types
    import aws_sdk_auto_scaling.types.memory_gi_b_per_v_cpu_request
    import aws_sdk_auto_scaling.types.memory_mi_b_request
    import aws_sdk_auto_scaling.types.network_bandwidth_gbps_request
    import aws_sdk_auto_scaling.types.network_interface_count_request
    import aws_sdk_auto_scaling.types.nullable_boolean
    import aws_sdk_auto_scaling.types.nullable_positive_integer
    import aws_sdk_auto_scaling.types.total_local_storage_gb_request
...
class InstanceRequirements(TypedDict):
    ...
    memory_mi_b: NotRequired[
        "aws_sdk_auto_scaling.types.memory_mi_b_request.MemoryMiBRequest"
    ]
    """<p>The minimum and maximum instance memory size for an instance type, in MiB.</p>"""
    cpu_manufacturers: NotRequired[
        "aws_sdk_auto_scaling.types.cpu_manufacturers.CpuManufacturers"
    ]
    ...
    memory_gi_b_per_v_cpu: NotRequired[
        "aws_sdk_auto_scaling.types.memory_gi_b_per_v_cpu_request.MemoryGiBPerVCpuRequest"
    ]
    ...
    excluded_instance_types: NotRequired[
        "aws_sdk_auto_scaling.types.excluded_instance_types.ExcludedInstanceTypes"
    ]
    ...
    bare_metal: NotRequired["aws_sdk_auto_scaling.types.bare_metal.BareMetal"]
    ...
    network_interface_count: NotRequired[
        "aws_sdk_auto_scaling.types.network_interface_count_request.NetworkInterfaceCountRequest"
    ]
    ...
    total_local_storage_gb: NotRequired[
        "aws_sdk_auto_scaling.types.total_local_storage_gb_request.TotalLocalStorageGBRequest"
    ]
    ...
    accelerator_count: NotRequired[
        "aws_sdk_auto_scaling.types.accelerator_count_request.AcceleratorCountRequest"
    ]
    ...
    accelerator_manufacturers: NotRequired[
        "aws_sdk_auto_scaling.types.accelerator_manufacturers.AcceleratorManufacturers"
    ]
    ...
    accelerator_names: NotRequired[
        "aws_sdk_auto_scaling.types.accelerator_names.AcceleratorNames"
    ]
    ...
    accelerator_total_memory_mi_b: NotRequired[
        "aws_sdk_auto_scaling.types.accelerator_total_memory_mi_b_request.AcceleratorTotalMemoryMiBRequest"
    ]
    ...
    network_bandwidth_gbps: NotRequired[
        "aws_sdk_auto_scaling.types.network_bandwidth_gbps_request.NetworkBandwidthGbpsRequest"
    ]
    ...
    allowed_instance_types: NotRequired[
        "aws_sdk_auto_scaling.types.allowed_instance_types.AllowedInstanceTypes"
    ]
    ...
    baseline_performance_factors: NotRequired[
        "aws_sdk_auto_scaling.types.baseline_performance_factors_request.BaselinePerformanceFactorsRequest"
    ]
...
def serialize_query(
    ...
    if "bare_metal" in value:
        ...
        aws_sdk_auto_scaling.types.bare_metal.serialize_query(
            value["bare_metal"], pairs, f"{prefix}.BareMetal"
        )
    if "burstable_performance" in value:
        import aws_sdk_auto_scaling.types.burstable_performance

        aws_sdk_auto_scaling.types.burstable_performance.serialize_query(
    ...
    if "accelerator_types" in value:
        ...
        aws_sdk_auto_scaling.types.accelerator_types.serialize_query(
            value["accelerator_types"], pairs, f"{prefix}.AcceleratorTypes"
        )
    if "accelerator_count" in value:
        import aws_sdk_auto_scaling.types.accelerator_count_request

        aws_sdk_auto_scaling.types.accelerator_count_request.serialize_query(
            value["accelerator_count"], pairs, f"{prefix}.AcceleratorCount"
        )
    if "accelerator_manufacturers" in value:
        import aws_sdk_auto_scaling.types.accelerator_manufacturers

        aws_sdk_auto_scaling.types.accelerator_manufacturers.serialize_query(
    ...
    if "accelerator_names" in value:
        ...
        aws_sdk_auto_scaling.types.accelerator_names.serialize_query(
            value["accelerator_names"], pairs, f"{prefix}.AcceleratorNames"
        )
    if "accelerator_total_memory_mi_b" in value:
        import aws_sdk_auto_scaling.types.accelerator_total_memory_mi_b_request

        aws_sdk_auto_scaling.types.accelerator_total_memory_mi_b_request.serialize_query(
    ...
    if "network_bandwidth_gbps" in value:
        ...
        aws_sdk_auto_scaling.types.network_bandwidth_gbps_request.serialize_query(
            value["network_bandwidth_gbps"], pairs, f"{prefix}.NetworkBandwidthGbps"
        )
    if "allowed_instance_types" in value:
        import aws_sdk_auto_scaling.types.allowed_instance_types

        aws_sdk_auto_scaling.types.allowed_instance_types.serialize_query(
            value["allowed_instance_types"], pairs, f"{prefix}.AllowedInstanceTypes"
        )
    if "baseline_performance_factors" in value:
        import aws_sdk_auto_scaling.types.baseline_performance_factors_request

        aws_sdk_auto_scaling.types.baseline_performance_factors_request.serialize_query(
...
def deserialize_query(el: Element) -> InstanceRequirements:
    ...
    if child_v_cpu_count is not None:
        ...
        out["v_cpu_count"] = (
            aws_sdk_auto_scaling.types.v_cpu_count_request.deserialize_query(
                child_v_cpu_count
            )
        )
    ...
    if child_memory_mi_b is not None:
        ...
        out["memory_mi_b"] = (
            aws_sdk_auto_scaling.types.memory_mi_b_request.deserialize_query(
                child_memory_mi_b
            )
        )
    ...
    if child_cpu_manufacturers is not None:
        ...
        out["cpu_manufacturers"] = (
            aws_sdk_auto_scaling.types.cpu_manufacturers.deserialize_query(
    ...
    if child_memory_gi_b_per_v_cpu is not None:
        ...
        out["memory_gi_b_per_v_cpu"] = (
            aws_sdk_auto_scaling.types.memory_gi_b_per_v_cpu_request.deserialize_query(
    ...
    if child_excluded_instance_types is not None:
        ...
        out["excluded_instance_types"] = (
            aws_sdk_auto_scaling.types.excluded_instance_types.deserialize_query(
    ...
    if child_instance_generations is not None:
        ...
        out["instance_generations"] = (
            aws_sdk_auto_scaling.types.instance_generations.deserialize_query(
    ...
    if child_bare_metal is not None:
        ...
        out["bare_metal"] = aws_sdk_auto_scaling.types.bare_metal.deserialize_query(
            child_bare_metal
        )
    ...
    if child_burstable_performance is not None:
        ...
        out["burstable_performance"] = (
            aws_sdk_auto_scaling.types.burstable_performance.deserialize_query(
    ...
    if child_network_interface_count is not None:
        ...
        out["network_interface_count"] = (
            aws_sdk_auto_scaling.types.network_interface_count_request.deserialize_query(
    ...
    if child_local_storage is not None:
        ...
        out["local_storage"] = (
            aws_sdk_auto_scaling.types.local_storage.deserialize_query(
                child_local_storage
            )
        )
    ...
    if child_local_storage_types is not None:
        ...
        out["local_storage_types"] = (
            aws_sdk_auto_scaling.types.local_storage_types.deserialize_query(
    ...
    if child_total_local_storage_gb is not None:
        ...
        out["total_local_storage_gb"] = (
            aws_sdk_auto_scaling.types.total_local_storage_gb_request.deserialize_query(
    ...
    if child_baseline_ebs_bandwidth_mbps is not None:
        ...
        out["baseline_ebs_bandwidth_mbps"] = (
            aws_sdk_auto_scaling.types.baseline_ebs_bandwidth_mbps_request.deserialize_query(
    ...
    if child_accelerator_types is not None:
        ...
        out["accelerator_types"] = (
            aws_sdk_auto_scaling.types.accelerator_types.deserialize_query(
    ...
    if child_accelerator_count is not None:
        ...
        out["accelerator_count"] = (
            aws_sdk_auto_scaling.types.accelerator_count_request.deserialize_query(
    ...
    if child_accelerator_manufacturers is not None:
        ...
        out["accelerator_manufacturers"] = (
            aws_sdk_auto_scaling.types.accelerator_manufacturers.deserialize_query(
    ...
    if child_accelerator_names is not None:
        ...
        out["accelerator_names"] = (
            aws_sdk_auto_scaling.types.accelerator_names.deserialize_query(
    ...
    if child_accelerator_total_memory_mi_b is not None:
        ...
        out["accelerator_total_memory_mi_b"] = (
            aws_sdk_auto_scaling.types.accelerator_total_memory_mi_b_request.deserialize_query(
    ...
    if child_network_bandwidth_gbps is not None:
        ...
        out["network_bandwidth_gbps"] = (
            aws_sdk_auto_scaling.types.network_bandwidth_gbps_request.deserialize_query(
    ...
    if child_allowed_instance_types is not None:
        ...
        out["allowed_instance_types"] = (
            aws_sdk_auto_scaling.types.allowed_instance_types.deserialize_query(
    ...
    if child_baseline_performance_factors is not None:
        ...
        out["baseline_performance_factors"] = (
            aws_sdk_auto_scaling.types.baseline_performance_factors_request.deserialize_query(
