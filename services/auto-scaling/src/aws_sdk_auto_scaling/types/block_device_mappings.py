...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.block_device_mapping

BlockDeviceMappings: TypeAlias = list[
    "aws_sdk_auto_scaling.types.block_device_mapping.BlockDeviceMapping"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_auto_scaling.types.block_device_mapping.serialize_query(
...
def deserialize_query(el: Element) -> BlockDeviceMappings:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_auto_scaling.types.block_device_mapping.deserialize_query(child)
        )
    return out
