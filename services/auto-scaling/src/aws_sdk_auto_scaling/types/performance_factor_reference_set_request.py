...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.performance_factor_reference_request

PerformanceFactorReferenceSetRequest: TypeAlias = list[
    "aws_sdk_auto_scaling.types.performance_factor_reference_request.PerformanceFactorReferenceRequest"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_auto_scaling.types.performance_factor_reference_request.serialize_query(
...
def deserialize_query(el: Element) -> PerformanceFactorReferenceSetRequest:
    ...
    for child in el.findall("item"):
        out.append(
            aws_sdk_auto_scaling.types.performance_factor_reference_request.deserialize_query(
                child
            )
        )
    return out
