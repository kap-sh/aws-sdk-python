...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.capacity_reservation_ids
...
class CapacityReservationTarget(TypedDict, closed=True):
    ...
    capacity_reservation_resource_group_arns: NotRequired[
        "aws_sdk_auto_scaling.types.capacity_reservation_resource_group_arns.CapacityReservationResourceGroupArns"
    ]
...
def serialize_query(
    ...
    if "capacity_reservation_ids" in value:
        ...
        aws_sdk_auto_scaling.types.capacity_reservation_ids.serialize_query(
            value["capacity_reservation_ids"], pairs, f"{prefix}.CapacityReservationIds"
        )
    if "capacity_reservation_resource_group_arns" in value:
        import aws_sdk_auto_scaling.types.capacity_reservation_resource_group_arns

        aws_sdk_auto_scaling.types.capacity_reservation_resource_group_arns.serialize_query(
...
def deserialize_query(el: Element) -> CapacityReservationTarget:
    ...
    if child_capacity_reservation_ids is not None:
        ...
        out["capacity_reservation_ids"] = (
            aws_sdk_auto_scaling.types.capacity_reservation_ids.deserialize_query(
    ...
    if child_capacity_reservation_resource_group_arns is not None:
        ...
        out["capacity_reservation_resource_group_arns"] = (
            aws_sdk_auto_scaling.types.capacity_reservation_resource_group_arns.deserialize_query(
