...
class DescribeLifecycleHooksAnswer(TypedDict):
    lifecycle_hooks: NotRequired[
        "aws_sdk_auto_scaling.types.lifecycle_hooks.LifecycleHooks"
    ]
...
def serialize_query(
    ...
    if "lifecycle_hooks" in value:
        ...
        aws_sdk_auto_scaling.types.lifecycle_hooks.serialize_query(
...
def deserialize_query(el: Element) -> DescribeLifecycleHooksAnswer:
    ...
    if child_lifecycle_hooks is not None:
        ...
        out["lifecycle_hooks"] = (
            aws_sdk_auto_scaling.types.lifecycle_hooks.deserialize_query(
