...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.auto_scaling_instances
    import aws_sdk_auto_scaling.types.xml_string


class AutoScalingInstancesType(TypedDict):
    auto_scaling_instances: NotRequired[
        "aws_sdk_auto_scaling.types.auto_scaling_instances.AutoScalingInstances"
    ]
    """<p>The instances.</p>"""
...
def serialize_query(
    ...
    if "auto_scaling_instances" in value:
        ...
        aws_sdk_auto_scaling.types.auto_scaling_instances.serialize_query(
...
def deserialize_query(el: Element) -> AutoScalingInstancesType:
    ...
    if child_auto_scaling_instances is not None:
        ...
        out["auto_scaling_instances"] = (
            aws_sdk_auto_scaling.types.auto_scaling_instances.deserialize_query(
