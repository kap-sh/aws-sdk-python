...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.predictive_scaling_max_capacity_breach_behavior
    import aws_sdk_auto_scaling.types.predictive_scaling_max_capacity_buffer
    import aws_sdk_auto_scaling.types.predictive_scaling_metric_specifications
    import aws_sdk_auto_scaling.types.predictive_scaling_mode
    import aws_sdk_auto_scaling.types.predictive_scaling_scheduling_buffer_time


class PredictiveScalingConfiguration(TypedDict):
    metric_specifications: NotRequired[
        "aws_sdk_auto_scaling.types.predictive_scaling_metric_specifications.PredictiveScalingMetricSpecifications"
    ]
    ...
    mode: NotRequired[
        "aws_sdk_auto_scaling.types.predictive_scaling_mode.PredictiveScalingMode"
    ]
    """<p>The predictive scaling mode. Defaults to <code>ForecastOnly</code> if not specified.</p>"""
    scheduling_buffer_time: NotRequired[
        "aws_sdk_auto_scaling.types.predictive_scaling_scheduling_buffer_time.PredictiveScalingSchedulingBufferTime"
    ]
    ...
    max_capacity_breach_behavior: NotRequired[
        "aws_sdk_auto_scaling.types.predictive_scaling_max_capacity_breach_behavior.PredictiveScalingMaxCapacityBreachBehavior"
    ]
    ...
    max_capacity_buffer: NotRequired[
        "aws_sdk_auto_scaling.types.predictive_scaling_max_capacity_buffer.PredictiveScalingMaxCapacityBuffer"
    ]
...
def serialize_query(
    ...
    if "metric_specifications" in value:
        ...
        aws_sdk_auto_scaling.types.predictive_scaling_metric_specifications.serialize_query(
            value["metric_specifications"], pairs, f"{prefix}.MetricSpecifications"
        )
    if "mode" in value:
        import aws_sdk_auto_scaling.types.predictive_scaling_mode

        aws_sdk_auto_scaling.types.predictive_scaling_mode.serialize_query(
    ...
    if "max_capacity_breach_behavior" in value:
        ...
        aws_sdk_auto_scaling.types.predictive_scaling_max_capacity_breach_behavior.serialize_query(
...
def deserialize_query(el: Element) -> PredictiveScalingConfiguration:
    ...
    if child_metric_specifications is not None:
        ...
        out["metric_specifications"] = (
            aws_sdk_auto_scaling.types.predictive_scaling_metric_specifications.deserialize_query(
    ...
    if child_mode is not None:
        ...
        out["mode"] = (
            aws_sdk_auto_scaling.types.predictive_scaling_mode.deserialize_query(
                child_mode
            )
        )
    ...
    if child_max_capacity_breach_behavior is not None:
        ...
        out["max_capacity_breach_behavior"] = (
            aws_sdk_auto_scaling.types.predictive_scaling_max_capacity_breach_behavior.deserialize_query(
