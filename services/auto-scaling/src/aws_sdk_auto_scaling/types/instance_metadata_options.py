...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.instance_metadata_endpoint_state
    import aws_sdk_auto_scaling.types.instance_metadata_http_put_response_hop_limit
    import aws_sdk_auto_scaling.types.instance_metadata_http_tokens_state


class InstanceMetadataOptions(TypedDict, closed=True):
    http_tokens: NotRequired[
        "aws_sdk_auto_scaling.types.instance_metadata_http_tokens_state.InstanceMetadataHttpTokensState"
    ]
    ...
    http_put_response_hop_limit: NotRequired[
        "aws_sdk_auto_scaling.types.instance_metadata_http_put_response_hop_limit.InstanceMetadataHttpPutResponseHopLimit"
    ]
    ...
    http_endpoint: NotRequired[
        "aws_sdk_auto_scaling.types.instance_metadata_endpoint_state.InstanceMetadataEndpointState"
    ]
...
def serialize_query(
    ...
    if "http_tokens" in value:
        ...
        aws_sdk_auto_scaling.types.instance_metadata_http_tokens_state.serialize_query(
    ...
    if "http_endpoint" in value:
        ...
        aws_sdk_auto_scaling.types.instance_metadata_endpoint_state.serialize_query(
...
def deserialize_query(el: Element) -> InstanceMetadataOptions:
    ...
    if child_http_tokens is not None:
        ...
        out["http_tokens"] = (
            aws_sdk_auto_scaling.types.instance_metadata_http_tokens_state.deserialize_query(
                child_http_tokens
            )
        )
    ...
    if child_http_endpoint is not None:
        ...
        out["http_endpoint"] = (
            aws_sdk_auto_scaling.types.instance_metadata_endpoint_state.deserialize_query(
                child_http_endpoint
            )
        )
    return out
