...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.metric_stat
...
class MetricDataQuery(TypedDict):
    ...
    metric_stat: NotRequired["aws_sdk_auto_scaling.types.metric_stat.MetricStat"]
...
def serialize_query(
    ...
    if "metric_stat" in value:
        ...
        aws_sdk_auto_scaling.types.metric_stat.serialize_query(
...
def deserialize_query(el: Element) -> MetricDataQuery:
    ...
    if child_metric_stat is not None:
        ...
        out["metric_stat"] = aws_sdk_auto_scaling.types.metric_stat.deserialize_query(
            child_metric_stat
        )
