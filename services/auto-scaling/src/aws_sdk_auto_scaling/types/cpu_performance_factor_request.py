...
if TYPE_CHECKING:
    import aws_sdk_auto_scaling.types.performance_factor_reference_set_request


class CpuPerformanceFactorRequest(TypedDict, closed=True):
    references: NotRequired[
        "aws_sdk_auto_scaling.types.performance_factor_reference_set_request.PerformanceFactorReferenceSetRequest"
    ]
...
def serialize_query(
    ...
    if "references" in value:
        ...
        aws_sdk_auto_scaling.types.performance_factor_reference_set_request.serialize_query(
...
def deserialize_query(el: Element) -> CpuPerformanceFactorRequest:
    ...
    if child_references is not None:
        ...
        out["references"] = (
            aws_sdk_auto_scaling.types.performance_factor_reference_set_request.deserialize_query(
                child_references
            )
        )
    return out
