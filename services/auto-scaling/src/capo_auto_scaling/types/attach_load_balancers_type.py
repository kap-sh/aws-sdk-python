"""Generated from Smithy shape ``com.amazonaws.autoscaling#AttachLoadBalancersType``."""
...
class AttachLoadBalancersType(TypedDict, closed=True):
...
def deserialize_query(el: Element) -> AttachLoadBalancersType:
    out: AttachLoadBalancersType = {}  # type: ignore[typeddict-item]
    ...
    if child_load_balancer_names is not None:
        ...
        out["load_balancer_names"] = (
            capo_auto_scaling.types.load_balancer_names.deserialize_query(
