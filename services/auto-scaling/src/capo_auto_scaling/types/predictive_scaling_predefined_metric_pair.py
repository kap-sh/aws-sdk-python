...
if TYPE_CHECKING:
    import capo_auto_scaling.types.predefined_metric_pair_type
...
class PredictiveScalingPredefinedMetricPair(TypedDict, closed=True):
    predefined_metric_type: NotRequired[
        "capo_auto_scaling.types.predefined_metric_pair_type.PredefinedMetricPairType"
    ]
...
def serialize_query(
    ...
    if "predefined_metric_type" in value:
        ...
        capo_auto_scaling.types.predefined_metric_pair_type.serialize_query(
...
def deserialize_query(el: Element) -> PredictiveScalingPredefinedMetricPair:
    ...
    if child_predefined_metric_type is not None:
        ...
        out["predefined_metric_type"] = (
            capo_auto_scaling.types.predefined_metric_pair_type.deserialize_query(
