...
def serialize_query(
    ...
    if "lifecycle_hook_names" in value:
        ...
        capo_auto_scaling.types.lifecycle_hook_names.serialize_query(
            value["lifecycle_hook_names"], pairs, f"{key_prefix}LifecycleHookNames"
        )
...
def deserialize_query(el: Element) -> DescribeLifecycleHooksType:
    ...
    if child_lifecycle_hook_names is not None:
        ...
        out["lifecycle_hook_names"] = (
            capo_auto_scaling.types.lifecycle_hook_names.deserialize_query(
