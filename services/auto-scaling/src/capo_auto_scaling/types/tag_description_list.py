...
TagDescriptionList: TypeAlias = list[
    "capo_auto_scaling.types.tag_description.TagDescription"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        capo_auto_scaling.types.tag_description.serialize_query(
...
def deserialize_query(el: Element) -> TagDescriptionList:
    ...
    for child in el.findall("member"):
        out.append(capo_auto_scaling.types.tag_description.deserialize_query(child))
    return out
