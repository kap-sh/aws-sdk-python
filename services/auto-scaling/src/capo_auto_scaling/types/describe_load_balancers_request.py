"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeLoadBalancersRequest``."""
...
class DescribeLoadBalancersRequest(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DescribeLoadBalancersRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DescribeLoadBalancersRequest:
    out: DescribeLoadBalancersRequest = {}  # type: ignore[typeddict-item]
