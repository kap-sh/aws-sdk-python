...
if TYPE_CHECKING:
    import capo_auto_scaling.types.launch_configurations
    import capo_auto_scaling.types.xml_string


class LaunchConfigurationsType(TypedDict, closed=True):
    launch_configurations: NotRequired[
        "capo_auto_scaling.types.launch_configurations.LaunchConfigurations"
    ]
...
def serialize_query(
    ...
    if "launch_configurations" in value:
        ...
        capo_auto_scaling.types.launch_configurations.serialize_query(
...
def deserialize_query(el: Element) -> LaunchConfigurationsType:
    ...
    if child_launch_configurations is not None:
        ...
        out["launch_configurations"] = (
            capo_auto_scaling.types.launch_configurations.deserialize_query(
