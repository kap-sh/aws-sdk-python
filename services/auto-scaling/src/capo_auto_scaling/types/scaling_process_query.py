...
class ScalingProcessQuery(TypedDict, closed=True):
    auto_scaling_group_name: NotRequired[
        "capo_auto_scaling.types.xml_string_max_len255.XmlStringMaxLen255"
    ]
    """<p>The name of the Auto Scaling group.</p>"""
    scaling_processes: NotRequired["capo_auto_scaling.types.process_names.ProcessNames"]
...
def deserialize_query(el: Element) -> ScalingProcessQuery:
    ...
    if child_scaling_processes is not None:
        ...
        out["scaling_processes"] = (
            capo_auto_scaling.types.process_names.deserialize_query(
