...
class LaunchInstancesRequest(TypedDict, closed=True):
    ...
    subnet_ids: NotRequired["capo_auto_scaling.types.subnet_ids_limit1.SubnetIdsLimit1"]
    ...
    retry_strategy: NotRequired["capo_auto_scaling.types.retry_strategy.RetryStrategy"]
...
def deserialize_query(el: Element) -> LaunchInstancesRequest:
    ...
    if child_availability_zones is not None:
        ...
        out["availability_zones"] = (
            capo_auto_scaling.types.availability_zones_limit1.deserialize_query(
    ...
    if child_availability_zone_ids is not None:
        ...
        out["availability_zone_ids"] = (
            capo_auto_scaling.types.availability_zone_ids_limit1.deserialize_query(
    ...
    if child_subnet_ids is not None:
        ...
        out["subnet_ids"] = capo_auto_scaling.types.subnet_ids_limit1.deserialize_query(
            child_subnet_ids
        )
    ...
    if child_retry_strategy is not None:
        ...
        out["retry_strategy"] = (
            capo_auto_scaling.types.retry_strategy.deserialize_query(
