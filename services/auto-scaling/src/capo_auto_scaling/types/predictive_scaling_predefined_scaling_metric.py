...
if TYPE_CHECKING:
    import capo_auto_scaling.types.predefined_scaling_metric_type
...
class PredictiveScalingPredefinedScalingMetric(TypedDict, closed=True):
    predefined_metric_type: NotRequired[
        "capo_auto_scaling.types.predefined_scaling_metric_type.PredefinedScalingMetricType"
    ]
    """<p>The metric type.</p>"""
...
def serialize_query(
    ...
    if "predefined_metric_type" in value:
        ...
        capo_auto_scaling.types.predefined_scaling_metric_type.serialize_query(
...
def deserialize_query(el: Element) -> PredictiveScalingPredefinedScalingMetric:
    ...
    if child_predefined_metric_type is not None:
        ...
        out["predefined_metric_type"] = (
            capo_auto_scaling.types.predefined_scaling_metric_type.deserialize_query(
