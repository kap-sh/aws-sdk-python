"""Generated from Smithy shape ``com.amazonaws.autoscaling#EnterStandbyQuery``."""
...
class EnterStandbyQuery(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: EnterStandbyQuery, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> EnterStandbyQuery:
    out: EnterStandbyQuery = {}  # type: ignore[typeddict-item]
