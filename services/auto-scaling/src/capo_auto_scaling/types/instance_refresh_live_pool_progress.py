"""Generated from Smithy shape ``com.amazonaws.autoscaling#InstanceRefreshLivePoolProgress``."""
...
class InstanceRefreshLivePoolProgress(TypedDict, closed=True):
...
def deserialize_query(el: Element) -> InstanceRefreshLivePoolProgress:
    out: InstanceRefreshLivePoolProgress = {}  # type: ignore[typeddict-item]
