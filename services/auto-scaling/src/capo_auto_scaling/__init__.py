...
from ._services.async_auto_scaling import (
    AsyncAutoScalingClient as AsyncAutoScalingClient,
)
from ._services.auto_scaling import AutoScalingClient as AutoScalingClient
