"""Generated from Smithy shape ``com.amazonaws.autoscaling#DeleteTags``."""
...
def build_request(
    ...
    pairs.append(("Action", "DeleteTags"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.delete_tags_type.serialize_query(input_, pairs, "")
