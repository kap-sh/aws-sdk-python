"""Generated from Smithy shape ``com.amazonaws.autoscaling#LaunchInstances``."""
...
def handle_response(
    ...
    out: capo_auto_scaling.types.launch_instances_result.LaunchInstancesResult = (
        capo_auto_scaling.types.launch_instances_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "LaunchInstances"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.launch_instances_request.serialize_query(input_, pairs, "")
...
async def async_launch_instances(
