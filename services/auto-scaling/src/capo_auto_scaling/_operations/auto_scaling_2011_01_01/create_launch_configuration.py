"""Generated from Smithy shape ``com.amazonaws.autoscaling#CreateLaunchConfiguration``."""
...
import capo_auto_scaling.errors.already_exists_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AlreadyExistsFault":
            raise capo_auto_scaling.errors.already_exists_fault.AlreadyExistsFault.from_query(
                root
            )
...
def build_request(
    ...
    pairs.append(("Action", "CreateLaunchConfiguration"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.create_launch_configuration_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_launch_configuration(
