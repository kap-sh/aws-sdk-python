"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeAutoScalingInstances``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeAutoScalingInstancesResult")
    out: capo_auto_scaling.types.auto_scaling_instances_type.AutoScalingInstancesType = capo_auto_scaling.types.auto_scaling_instances_type.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeAutoScalingInstances"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.describe_auto_scaling_instances_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_auto_scaling_instances(
