"""Generated from Smithy shape ``com.amazonaws.autoscaling#AttachInstances``."""
...
def build_request(
    ...
    pairs.append(("Action", "AttachInstances"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.attach_instances_query.serialize_query(input_, pairs, "")
...
async def async_attach_instances(
