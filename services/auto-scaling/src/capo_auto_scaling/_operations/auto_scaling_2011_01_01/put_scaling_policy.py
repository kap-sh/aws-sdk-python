"""Generated from Smithy shape ``com.amazonaws.autoscaling#PutScalingPolicy``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("PutScalingPolicyResult")
    out: capo_auto_scaling.types.policy_arn_type.PolicyARNType = (
        capo_auto_scaling.types.policy_arn_type.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "PutScalingPolicy"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.put_scaling_policy_type.serialize_query(input_, pairs, "")
...
def put_scaling_policy(
    ...
    input_: capo_auto_scaling.types.put_scaling_policy_type.PutScalingPolicyType,
) -> tuple[capo_auto_scaling.types.policy_arn_type.PolicyARNType, zapros.Response]:
