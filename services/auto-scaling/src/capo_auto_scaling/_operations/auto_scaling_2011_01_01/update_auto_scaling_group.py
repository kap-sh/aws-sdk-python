"""Generated from Smithy shape ``com.amazonaws.autoscaling#UpdateAutoScalingGroup``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ScalingActivityInProgressFault":
            raise capo_auto_scaling.errors.scaling_activity_in_progress_fault.ScalingActivityInProgressFault.from_query(
                root
            )
...
def build_request(
    ...
    capo_auto_scaling.types.update_auto_scaling_group_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_update_auto_scaling_group(
