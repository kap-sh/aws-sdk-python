...
def handle_response(
    ...
    out: capo_auto_scaling.types.enter_standby_answer.EnterStandbyAnswer = (
        capo_auto_scaling.types.enter_standby_answer.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.enter_standby_query.serialize_query(input_, pairs, "")
...
def enter_standby(
    ...
    capo_auto_scaling.types.enter_standby_answer.EnterStandbyAnswer, zapros.Response
]:
