"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeTrafficSources``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeTrafficSourcesResult")
    out: capo_auto_scaling.types.describe_traffic_sources_response.DescribeTrafficSourcesResponse = capo_auto_scaling.types.describe_traffic_sources_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeTrafficSources"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.describe_traffic_sources_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_traffic_sources(
