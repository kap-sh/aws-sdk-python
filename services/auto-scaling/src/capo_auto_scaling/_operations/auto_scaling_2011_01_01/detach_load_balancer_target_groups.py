...
def handle_response(
    ...
    out: capo_auto_scaling.types.detach_load_balancer_target_groups_result_type.DetachLoadBalancerTargetGroupsResultType = capo_auto_scaling.types.detach_load_balancer_target_groups_result_type.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.detach_load_balancer_target_groups_type.serialize_query(
        input_, pairs, ""
    )
