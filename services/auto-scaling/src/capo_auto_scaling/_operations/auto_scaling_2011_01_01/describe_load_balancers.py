"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeLoadBalancers``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeLoadBalancersResult")
    out: capo_auto_scaling.types.describe_load_balancers_response.DescribeLoadBalancersResponse = capo_auto_scaling.types.describe_load_balancers_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeLoadBalancers"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.describe_load_balancers_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_load_balancers(
