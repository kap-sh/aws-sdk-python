"""Generated from Smithy shape ``com.amazonaws.autoscaling#SetDesiredCapacity``."""
...
def build_request(
    ...
    capo_auto_scaling.types.set_desired_capacity_type.serialize_query(input_, pairs, "")
...
async def async_set_desired_capacity(
