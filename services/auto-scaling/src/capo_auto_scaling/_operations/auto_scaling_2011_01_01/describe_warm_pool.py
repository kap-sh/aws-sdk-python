"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeWarmPool``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeWarmPoolResult")
    out: capo_auto_scaling.types.describe_warm_pool_answer.DescribeWarmPoolAnswer = (
        capo_auto_scaling.types.describe_warm_pool_answer.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeWarmPool"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.describe_warm_pool_type.serialize_query(input_, pairs, "")
...
async def async_describe_warm_pool(
