"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeTags``."""
...
def handle_response(
    ...
    out: capo_auto_scaling.types.tags_type.TagsType = (
        capo_auto_scaling.types.tags_type.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.describe_tags_type.serialize_query(input_, pairs, "")
...
def describe_tags(
    ...
    input_: capo_auto_scaling.types.describe_tags_type.DescribeTagsType,
) -> tuple[capo_auto_scaling.types.tags_type.TagsType, zapros.Response]:
