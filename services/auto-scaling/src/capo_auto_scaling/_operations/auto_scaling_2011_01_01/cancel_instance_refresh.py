...
import capo_auto_scaling.errors.active_instance_refresh_not_found_fault
import capo_auto_scaling.errors.limit_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ActiveInstanceRefreshNotFoundFault":
            raise capo_auto_scaling.errors.active_instance_refresh_not_found_fault.ActiveInstanceRefreshNotFoundFault.from_query(
                root
            )
        case "LimitExceededFault":
            raise capo_auto_scaling.errors.limit_exceeded_fault.LimitExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_auto_scaling.types.cancel_instance_refresh_answer.CancelInstanceRefreshAnswer = capo_auto_scaling.types.cancel_instance_refresh_answer.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.cancel_instance_refresh_type.serialize_query(
        input_, pairs, ""
    )
