...
def handle_response(
    ...
    out: capo_auto_scaling.types.activities_type.ActivitiesType = (
        capo_auto_scaling.types.activities_type.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.describe_scaling_activities_type.serialize_query(
        input_, pairs, ""
    )
...
def describe_scaling_activities(
    ...
    input_: capo_auto_scaling.types.describe_scaling_activities_type.DescribeScalingActivitiesType,
) -> tuple[capo_auto_scaling.types.activities_type.ActivitiesType, zapros.Response]:
