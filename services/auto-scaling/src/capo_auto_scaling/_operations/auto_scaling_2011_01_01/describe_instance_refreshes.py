"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeInstanceRefreshes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeInstanceRefreshesResult")
    out: capo_auto_scaling.types.describe_instance_refreshes_answer.DescribeInstanceRefreshesAnswer = capo_auto_scaling.types.describe_instance_refreshes_answer.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeInstanceRefreshes"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.describe_instance_refreshes_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_instance_refreshes(
