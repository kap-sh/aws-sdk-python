...
def handle_response(
    ...
    out: capo_auto_scaling.types.auto_scaling_groups_type.AutoScalingGroupsType = (
        capo_auto_scaling.types.auto_scaling_groups_type.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.auto_scaling_group_names_type.serialize_query(
        input_, pairs, ""
    )
