"""Generated from Smithy shape ``com.amazonaws.autoscaling#GetPredictiveScalingForecast``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetPredictiveScalingForecastResult")
    out: capo_auto_scaling.types.get_predictive_scaling_forecast_answer.GetPredictiveScalingForecastAnswer = capo_auto_scaling.types.get_predictive_scaling_forecast_answer.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.get_predictive_scaling_forecast_type.serialize_query(
        input_, pairs, ""
    )
