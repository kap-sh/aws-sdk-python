"""Generated from Smithy shape ``com.amazonaws.autoscaling#PutWarmPool``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("PutWarmPoolResult")
    out: capo_auto_scaling.types.put_warm_pool_answer.PutWarmPoolAnswer = (
        capo_auto_scaling.types.put_warm_pool_answer.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "PutWarmPool"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.put_warm_pool_type.serialize_query(input_, pairs, "")
...
def put_warm_pool(
    ...
    capo_auto_scaling.types.put_warm_pool_answer.PutWarmPoolAnswer, zapros.Response
]:
