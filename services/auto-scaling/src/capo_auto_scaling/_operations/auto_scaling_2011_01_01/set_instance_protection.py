"""Generated from Smithy shape ``com.amazonaws.autoscaling#SetInstanceProtection``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("SetInstanceProtectionResult")
    out: capo_auto_scaling.types.set_instance_protection_answer.SetInstanceProtectionAnswer = capo_auto_scaling.types.set_instance_protection_answer.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.set_instance_protection_query.serialize_query(
        input_, pairs, ""
    )
...
async def async_set_instance_protection(
