"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeAccountLimits``."""
...
def handle_response(
    ...
    out: capo_auto_scaling.types.describe_account_limits_answer.DescribeAccountLimitsAnswer = capo_auto_scaling.types.describe_account_limits_answer.deserialize_query(
