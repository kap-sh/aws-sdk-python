"""Generated from Smithy shape ``com.amazonaws.autoscaling#StartInstanceRefresh``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("StartInstanceRefreshResult")
    out: capo_auto_scaling.types.start_instance_refresh_answer.StartInstanceRefreshAnswer = capo_auto_scaling.types.start_instance_refresh_answer.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.start_instance_refresh_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_start_instance_refresh(
