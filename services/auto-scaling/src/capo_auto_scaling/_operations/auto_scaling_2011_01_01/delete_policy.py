"""Generated from Smithy shape ``com.amazonaws.autoscaling#DeletePolicy``."""
...
def build_request(
    ...
    pairs.append(("Action", "DeletePolicy"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.delete_policy_type.serialize_query(input_, pairs, "")
