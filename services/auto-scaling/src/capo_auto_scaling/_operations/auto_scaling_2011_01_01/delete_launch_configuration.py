...
import capo_auto_scaling.errors.resource_in_use_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseFault":
            raise capo_auto_scaling.errors.resource_in_use_fault.ResourceInUseFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    capo_auto_scaling.types.launch_configuration_name_type.serialize_query(
        input_, pairs, ""
    )
