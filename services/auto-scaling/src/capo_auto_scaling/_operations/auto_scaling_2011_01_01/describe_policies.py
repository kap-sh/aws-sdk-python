"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribePolicies``."""
...
import capo_auto_scaling.errors.invalid_next_token
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidNextToken":
            raise capo_auto_scaling.errors.invalid_next_token.InvalidNextToken.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_auto_scaling.types.policies_type.PoliciesType = (
        capo_auto_scaling.types.policies_type.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribePolicies"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.describe_policies_type.serialize_query(input_, pairs, "")
...
def describe_policies(
    ...
    input_: capo_auto_scaling.types.describe_policies_type.DescribePoliciesType,
) -> tuple[capo_auto_scaling.types.policies_type.PoliciesType, zapros.Response]:
...
async def async_describe_policies(
