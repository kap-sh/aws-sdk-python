"""Generated from Smithy shape ``com.amazonaws.deadline#ListJobMembersRequest``."""
...
class ListJobMembersRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListJobMembersRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListJobMembersRequest:
    out: ListJobMembersRequest = {}  # type: ignore[typeddict-item]
    return out
