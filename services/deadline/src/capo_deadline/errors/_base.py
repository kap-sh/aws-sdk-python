...
class deadlineError(Exception):
    """Base class for all deadline service errors."""


class ServiceError(deadlineError):
...
class SerializationError(deadlineError):
    """Raised when a value cannot be serialized."""


class DeserializationError(deadlineError):
...
class WaiterFailedError(deadlineError):
...
class WaiterTimeoutError(deadlineError):
