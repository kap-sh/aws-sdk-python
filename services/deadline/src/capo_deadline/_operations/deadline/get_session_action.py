"""Generated from Smithy shape ``com.amazonaws.deadline#GetSessionAction``."""
...
def handle_response(
    ...
    out: capo_deadline.types.get_session_action_response.GetSessionActionResponse = (
        capo_deadline.types.get_session_action_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{sessionActionId}", quote(str(input_["session_action_id"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_get_session_action(
