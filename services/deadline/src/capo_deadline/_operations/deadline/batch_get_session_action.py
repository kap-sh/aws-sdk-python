...
def handle_response(
    ...
    out: capo_deadline.types.batch_get_session_action_response.BatchGetSessionActionResponse = capo_deadline.types.batch_get_session_action_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.batch_get_session_action_request.serialize_json(input_)
    ).encode()
