...
def handle_response(
    ...
    out: capo_deadline.types.delete_monitor_response.DeleteMonitorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_monitor(
    ...
    capo_deadline.types.delete_monitor_response.DeleteMonitorResponse, zapros.Response
]:
