...
def handle_response(
    ...
    out: capo_deadline.types.update_queue_fleet_association_response.UpdateQueueFleetAssociationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.update_queue_fleet_association_request.serialize_json(
            input_
        )
    ).encode()
