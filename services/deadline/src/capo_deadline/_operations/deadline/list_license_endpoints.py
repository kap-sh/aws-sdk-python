"""Generated from Smithy shape ``com.amazonaws.deadline#ListLicenseEndpoints``."""
...
import capo_deadline.types.license_endpoint_summaries
...
def handle_response(
    ...
    out: capo_deadline.types.list_license_endpoints_response.ListLicenseEndpointsResponse = capo_deadline.types.list_license_endpoints_response.deserialize_json(
...
async def async_list_license_endpoints(
