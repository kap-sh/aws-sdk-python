...
def handle_response(
    ...
    out: capo_deadline.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_deadline.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
