"""Generated from Smithy shape ``com.amazonaws.deadline#ListFleetMembers``."""
...
def handle_response(
    ...
    out: capo_deadline.types.list_fleet_members_response.ListFleetMembersResponse = (
        capo_deadline.types.list_fleet_members_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/2023-10-12/farms/{farmId}/fleets/{fleetId}/members"
    )
...
async def async_list_fleet_members(
