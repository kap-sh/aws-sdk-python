"""Generated from Smithy shape ``com.amazonaws.deadline#ListJobParameterDefinitions``."""
...
def handle_response(
    ...
    out: capo_deadline.types.list_job_parameter_definitions_response.ListJobParameterDefinitionsResponse = capo_deadline.types.list_job_parameter_definitions_response.deserialize_json(
...
async def async_list_job_parameter_definitions(
