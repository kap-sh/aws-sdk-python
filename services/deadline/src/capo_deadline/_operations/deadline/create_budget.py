...
def handle_response(
    ...
    out: capo_deadline.types.create_budget_response.CreateBudgetResponse = (
        capo_deadline.types.create_budget_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.create_budget_request.serialize_json(input_)
    ).encode()
...
def create_budget(
    ...
    capo_deadline.types.create_budget_response.CreateBudgetResponse, zapros.Response
]:
