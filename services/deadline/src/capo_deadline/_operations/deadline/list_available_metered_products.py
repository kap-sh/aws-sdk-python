"""Generated from Smithy shape ``com.amazonaws.deadline#ListAvailableMeteredProducts``."""
...
def handle_response(
    ...
    out: capo_deadline.types.list_available_metered_products_response.ListAvailableMeteredProductsResponse = capo_deadline.types.list_available_metered_products_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2023-10-12/metered-products"
    params: dict[str, str] = {}
...
async def async_list_available_metered_products(
