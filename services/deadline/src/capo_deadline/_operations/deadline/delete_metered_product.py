"""Generated from Smithy shape ``com.amazonaws.deadline#DeleteMeteredProduct``."""
...
def handle_response(
    ...
    out: capo_deadline.types.delete_metered_product_response.DeleteMeteredProductResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_metered_product(
