"""Generated from Smithy shape ``com.amazonaws.deadline#DeleteStorageProfile``."""
...
def handle_response(
    ...
    out: capo_deadline.types.delete_storage_profile_response.DeleteStorageProfileResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_storage_profile(
