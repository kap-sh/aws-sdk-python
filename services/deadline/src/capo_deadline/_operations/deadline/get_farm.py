...
def handle_response(
    ...
    out: capo_deadline.types.get_farm_response.GetFarmResponse = (
        capo_deadline.types.get_farm_response.deserialize_json(
...
def get_farm(
    ...
    input_: capo_deadline.types.get_farm_request.GetFarmRequest,
) -> tuple[capo_deadline.types.get_farm_response.GetFarmResponse, zapros.Response]:
