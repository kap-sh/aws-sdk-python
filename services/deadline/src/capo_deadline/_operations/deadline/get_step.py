"""Generated from Smithy shape ``com.amazonaws.deadline#GetStep``."""
...
def handle_response(
    ...
    out: capo_deadline.types.get_step_response.GetStepResponse = (
        capo_deadline.types.get_step_response.deserialize_json(
...
def get_step(
    ...
    input_: capo_deadline.types.get_step_request.GetStepRequest,
) -> tuple[capo_deadline.types.get_step_response.GetStepResponse, zapros.Response]:
