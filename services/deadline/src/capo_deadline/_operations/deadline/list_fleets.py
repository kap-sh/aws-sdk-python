"""Generated from Smithy shape ``com.amazonaws.deadline#ListFleets``."""
...
def handle_response(
    ...
    out: capo_deadline.types.list_fleets_response.ListFleetsResponse = (
        capo_deadline.types.list_fleets_response.deserialize_json(
...
def build_request(
    ...
    if "display_name" in input_:
        params["displayName"] = str(input_["display_name"])
    if "status" in input_:
...
def list_fleets(
    ...
    capo_deadline.types.list_fleets_response.ListFleetsResponse, zapros.Response
]:
