...
def handle_response(
    ...
    out: capo_deadline.types.create_queue_fleet_association_response.CreateQueueFleetAssociationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.create_queue_fleet_association_request.serialize_json(
            input_
        )
    ).encode()
