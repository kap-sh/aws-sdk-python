"""Generated from Smithy shape ``com.amazonaws.deadline#AssumeQueueRoleForUser``."""
...
def handle_response(
    ...
    out: capo_deadline.types.assume_queue_role_for_user_response.AssumeQueueRoleForUserResponse = capo_deadline.types.assume_queue_role_for_user_response.deserialize_json(
...
async def async_assume_queue_role_for_user(
