...
def handle_response(
    ...
    out: capo_deadline.types.create_farm_response.CreateFarmResponse = (
        capo_deadline.types.create_farm_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.create_farm_request.serialize_json(input_)
    ).encode()
...
def create_farm(
    ...
    capo_deadline.types.create_farm_response.CreateFarmResponse, zapros.Response
]:
