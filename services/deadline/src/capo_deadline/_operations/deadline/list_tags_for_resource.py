"""Generated from Smithy shape ``com.amazonaws.deadline#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_deadline.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_deadline.types.list_tags_for_resource_response.deserialize_json(
