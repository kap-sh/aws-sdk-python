...
def handle_response(
    ...
    out: capo_deadline.types.batch_get_step_response.BatchGetStepResponse = (
        capo_deadline.types.batch_get_step_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.batch_get_step_request.serialize_json(input_)
    ).encode()
...
def batch_get_step(
    ...
    capo_deadline.types.batch_get_step_response.BatchGetStepResponse, zapros.Response
]:
