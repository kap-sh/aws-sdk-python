...
def handle_response(
    ...
    out: capo_deadline.types.get_queue_limit_association_response.GetQueueLimitAssociationResponse = capo_deadline.types.get_queue_limit_association_response.deserialize_json(
