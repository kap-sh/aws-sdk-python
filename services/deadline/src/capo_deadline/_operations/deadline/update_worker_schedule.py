...
def handle_response(
    ...
    out: capo_deadline.types.update_worker_schedule_response.UpdateWorkerScheduleResponse = capo_deadline.types.update_worker_schedule_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.update_worker_schedule_request.serialize_json(input_)
    ).encode()
