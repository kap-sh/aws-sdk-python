"""Generated from Smithy shape ``com.amazonaws.deadline#ListJobs``."""
...
def handle_response(
    ...
    out: capo_deadline.types.list_jobs_response.ListJobsResponse = (
        capo_deadline.types.list_jobs_response.deserialize_json(
...
def list_jobs(
    ...
    input_: capo_deadline.types.list_jobs_request.ListJobsRequest,
) -> tuple[capo_deadline.types.list_jobs_response.ListJobsResponse, zapros.Response]:
