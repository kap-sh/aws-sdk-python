...
def handle_response(
    ...
    out: capo_deadline.types.create_queue_limit_association_response.CreateQueueLimitAssociationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.create_queue_limit_association_request.serialize_json(
            input_
        )
    ).encode()
