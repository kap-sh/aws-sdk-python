...
def handle_response(
    ...
    out: capo_deadline.types.create_job_response.CreateJobResponse = (
        capo_deadline.types.create_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.create_job_request.serialize_json(input_)
    ).encode()
...
def create_job(
    ...
    input_: capo_deadline.types.create_job_request.CreateJobRequest,
) -> tuple[capo_deadline.types.create_job_response.CreateJobResponse, zapros.Response]:
