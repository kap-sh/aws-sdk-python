"""Generated from Smithy shape ``com.amazonaws.deadline#AssociateMemberToFleet``."""
...
def handle_response(
    ...
    out: capo_deadline.types.associate_member_to_fleet_response.AssociateMemberToFleetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.associate_member_to_fleet_request.serialize_json(input_)
    ).encode()
...
async def async_associate_member_to_fleet(
