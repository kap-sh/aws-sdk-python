"""Generated from Smithy shape ``com.amazonaws.deadline#UpdateQueueLimitAssociation``."""
...
def handle_response(
    ...
    out: capo_deadline.types.update_queue_limit_association_response.UpdateQueueLimitAssociationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.update_queue_limit_association_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_queue_limit_association(
