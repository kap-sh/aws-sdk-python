...
def handle_response(
    ...
    out: capo_deadline.types.get_fleet_response.GetFleetResponse = (
        capo_deadline.types.get_fleet_response.deserialize_json(
...
def get_fleet(
    ...
    input_: capo_deadline.types.get_fleet_request.GetFleetRequest,
) -> tuple[capo_deadline.types.get_fleet_response.GetFleetResponse, zapros.Response]:
