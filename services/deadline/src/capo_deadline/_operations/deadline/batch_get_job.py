...
def handle_response(
    ...
    out: capo_deadline.types.batch_get_job_response.BatchGetJobResponse = (
        capo_deadline.types.batch_get_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.batch_get_job_request.serialize_json(input_)
    ).encode()
...
def batch_get_job(
    ...
    capo_deadline.types.batch_get_job_response.BatchGetJobResponse, zapros.Response
]:
