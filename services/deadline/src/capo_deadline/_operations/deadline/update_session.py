...
def handle_response(
    ...
    out: capo_deadline.types.update_session_response.UpdateSessionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.update_session_request.serialize_json(input_)
    ).encode()
...
def update_session(
    ...
    capo_deadline.types.update_session_response.UpdateSessionResponse, zapros.Response
]:
