"""Generated from Smithy shape ``com.amazonaws.deadline#UpdateMonitor``."""
...
def handle_response(
    ...
    out: capo_deadline.types.update_monitor_response.UpdateMonitorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.update_monitor_request.serialize_json(input_)
    ).encode()
...
def update_monitor(
    ...
    capo_deadline.types.update_monitor_response.UpdateMonitorResponse, zapros.Response
]:
