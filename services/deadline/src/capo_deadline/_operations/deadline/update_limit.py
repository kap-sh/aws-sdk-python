"""Generated from Smithy shape ``com.amazonaws.deadline#UpdateLimit``."""
...
def handle_response(
    ...
    out: capo_deadline.types.update_limit_response.UpdateLimitResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2023-10-12/farms/{farmId}/limits/{limitId}"
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.update_limit_request.serialize_json(input_)
    ).encode()
...
def update_limit(
    ...
    capo_deadline.types.update_limit_response.UpdateLimitResponse, zapros.Response
]:
