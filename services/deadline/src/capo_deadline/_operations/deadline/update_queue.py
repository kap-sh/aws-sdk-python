...
def handle_response(
    ...
    out: capo_deadline.types.update_queue_response.UpdateQueueResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.update_queue_request.serialize_json(input_)
    ).encode()
...
def update_queue(
    ...
    capo_deadline.types.update_queue_response.UpdateQueueResponse, zapros.Response
]:
