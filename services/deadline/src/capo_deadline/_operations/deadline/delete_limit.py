"""Generated from Smithy shape ``com.amazonaws.deadline#DeleteLimit``."""
...
def handle_response(
    ...
    out: capo_deadline.types.delete_limit_response.DeleteLimitResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_limit(
    ...
    capo_deadline.types.delete_limit_response.DeleteLimitResponse, zapros.Response
]:
