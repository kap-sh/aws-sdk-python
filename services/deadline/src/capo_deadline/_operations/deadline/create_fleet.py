"""Generated from Smithy shape ``com.amazonaws.deadline#CreateFleet``."""
...
def handle_response(
    ...
    out: capo_deadline.types.create_fleet_response.CreateFleetResponse = (
        capo_deadline.types.create_fleet_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2023-10-12/farms/{farmId}/fleets"
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.create_fleet_request.serialize_json(input_)
    ).encode()
...
def create_fleet(
    ...
    capo_deadline.types.create_fleet_response.CreateFleetResponse, zapros.Response
]:
