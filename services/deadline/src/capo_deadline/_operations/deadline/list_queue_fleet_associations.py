"""Generated from Smithy shape ``com.amazonaws.deadline#ListQueueFleetAssociations``."""
...
import capo_deadline.types.queue_fleet_association_summaries
...
def handle_response(
    ...
    out: capo_deadline.types.list_queue_fleet_associations_response.ListQueueFleetAssociationsResponse = capo_deadline.types.list_queue_fleet_associations_response.deserialize_json(
...
def build_request(
    ...
    if "fleet_id" in input_:
        params["fleetId"] = str(input_["fleet_id"])
...
async def async_list_queue_fleet_associations(
