"""Generated from Smithy shape ``com.amazonaws.deadline#ListSteps``."""
...
import capo_deadline.types.step_summaries
...
def handle_response(
    ...
    out: capo_deadline.types.list_steps_response.ListStepsResponse = (
        capo_deadline.types.list_steps_response.deserialize_json(
...
def list_steps(
    ...
    input_: capo_deadline.types.list_steps_request.ListStepsRequest,
) -> tuple[capo_deadline.types.list_steps_response.ListStepsResponse, zapros.Response]:
