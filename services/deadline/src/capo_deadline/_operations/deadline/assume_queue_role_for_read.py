...
def handle_response(
    ...
    out: capo_deadline.types.assume_queue_role_for_read_response.AssumeQueueRoleForReadResponse = capo_deadline.types.assume_queue_role_for_read_response.deserialize_json(
