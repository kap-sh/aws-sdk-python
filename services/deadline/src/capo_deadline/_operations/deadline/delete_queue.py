"""Generated from Smithy shape ``com.amazonaws.deadline#DeleteQueue``."""
...
def handle_response(
    ...
    out: capo_deadline.types.delete_queue_response.DeleteQueueResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_queue(
    ...
    capo_deadline.types.delete_queue_response.DeleteQueueResponse, zapros.Response
]:
