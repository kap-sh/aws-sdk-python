...
def handle_response(
    ...
    out: capo_deadline.types.get_storage_profile_for_queue_response.GetStorageProfileForQueueResponse = capo_deadline.types.get_storage_profile_for_queue_response.deserialize_json(
