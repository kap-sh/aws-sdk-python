...
def handle_response(
    ...
    out: capo_deadline.types.list_queue_environments_response.ListQueueEnvironmentsResponse = capo_deadline.types.list_queue_environments_response.deserialize_json(
