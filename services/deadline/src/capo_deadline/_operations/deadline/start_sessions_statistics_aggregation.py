"""Generated from Smithy shape ``com.amazonaws.deadline#StartSessionsStatisticsAggregation``."""
...
def handle_response(
    ...
    out: capo_deadline.types.start_sessions_statistics_aggregation_response.StartSessionsStatisticsAggregationResponse = capo_deadline.types.start_sessions_statistics_aggregation_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.start_sessions_statistics_aggregation_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_sessions_statistics_aggregation(
