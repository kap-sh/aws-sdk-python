...
def handle_response(
    ...
    out: capo_deadline.types.list_queues_response.ListQueuesResponse = (
        capo_deadline.types.list_queues_response.deserialize_json(
...
def list_queues(
    ...
    capo_deadline.types.list_queues_response.ListQueuesResponse, zapros.Response
]:
