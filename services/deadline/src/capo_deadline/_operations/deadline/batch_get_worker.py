...
def handle_response(
    ...
    out: capo_deadline.types.batch_get_worker_response.BatchGetWorkerResponse = (
        capo_deadline.types.batch_get_worker_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.batch_get_worker_request.serialize_json(input_)
    ).encode()
