"""Generated from Smithy shape ``com.amazonaws.deadline#BatchGetTask``."""
...
def handle_response(
    ...
    out: capo_deadline.types.batch_get_task_response.BatchGetTaskResponse = (
        capo_deadline.types.batch_get_task_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.batch_get_task_request.serialize_json(input_)
    ).encode()
...
def batch_get_task(
    ...
    capo_deadline.types.batch_get_task_response.BatchGetTaskResponse, zapros.Response
]:
...
async def async_batch_get_task(
