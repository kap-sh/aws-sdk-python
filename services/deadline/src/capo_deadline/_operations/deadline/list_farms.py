"""Generated from Smithy shape ``com.amazonaws.deadline#ListFarms``."""
...
def handle_response(
    ...
    out: capo_deadline.types.list_farms_response.ListFarmsResponse = (
        capo_deadline.types.list_farms_response.deserialize_json(
...
def list_farms(
    ...
    input_: capo_deadline.types.list_farms_request.ListFarmsRequest,
) -> tuple[capo_deadline.types.list_farms_response.ListFarmsResponse, zapros.Response]:
