...
def handle_response(
    ...
    out: capo_deadline.types.delete_farm_response.DeleteFarmResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_farm(
    ...
    capo_deadline.types.delete_farm_response.DeleteFarmResponse, zapros.Response
]:
