"""Generated from Smithy shape ``com.amazonaws.deadline#ListStepConsumers``."""
...
import capo_deadline.types.step_consumers
...
def handle_response(
    ...
    out: capo_deadline.types.list_step_consumers_response.ListStepConsumersResponse = (
        capo_deadline.types.list_step_consumers_response.deserialize_json(
...
async def async_list_step_consumers(
