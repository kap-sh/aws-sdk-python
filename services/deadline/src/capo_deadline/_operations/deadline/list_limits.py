"""Generated from Smithy shape ``com.amazonaws.deadline#ListLimits``."""
...
def handle_response(
    ...
    out: capo_deadline.types.list_limits_response.ListLimitsResponse = (
        capo_deadline.types.list_limits_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2023-10-12/farms/{farmId}/limits"
...
def list_limits(
    ...
    capo_deadline.types.list_limits_response.ListLimitsResponse, zapros.Response
]:
