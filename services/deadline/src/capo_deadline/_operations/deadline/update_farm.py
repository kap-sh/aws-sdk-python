...
def handle_response(
    ...
    out: capo_deadline.types.update_farm_response.UpdateFarmResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.update_farm_request.serialize_json(input_)
    ).encode()
...
def update_farm(
    ...
    capo_deadline.types.update_farm_response.UpdateFarmResponse, zapros.Response
]:
