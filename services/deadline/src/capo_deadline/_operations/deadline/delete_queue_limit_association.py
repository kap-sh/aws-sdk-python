"""Generated from Smithy shape ``com.amazonaws.deadline#DeleteQueueLimitAssociation``."""
...
def handle_response(
    ...
    out: capo_deadline.types.delete_queue_limit_association_response.DeleteQueueLimitAssociationResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_queue_limit_association(
