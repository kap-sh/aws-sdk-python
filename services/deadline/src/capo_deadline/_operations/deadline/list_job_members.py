...
import capo_deadline.types.job_members
...
def handle_response(
    ...
    out: capo_deadline.types.list_job_members_response.ListJobMembersResponse = (
        capo_deadline.types.list_job_members_response.deserialize_json(
