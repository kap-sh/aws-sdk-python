...
def handle_response(
    ...
    out: capo_deadline.types.batch_update_job_response.BatchUpdateJobResponse = (
        capo_deadline.types.batch_update_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.batch_update_job_request.serialize_json(input_)
    ).encode()
