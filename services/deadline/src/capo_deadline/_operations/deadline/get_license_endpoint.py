"""Generated from Smithy shape ``com.amazonaws.deadline#GetLicenseEndpoint``."""
...
def handle_response(
    ...
    out: capo_deadline.types.get_license_endpoint_response.GetLicenseEndpointResponse = capo_deadline.types.get_license_endpoint_response.deserialize_json(
...
async def async_get_license_endpoint(
