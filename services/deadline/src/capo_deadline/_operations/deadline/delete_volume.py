"""Generated from Smithy shape ``com.amazonaws.deadline#DeleteVolume``."""
...
def handle_response(
    ...
    out: capo_deadline.types.delete_volume_response.DeleteVolumeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_volume(
    ...
    capo_deadline.types.delete_volume_response.DeleteVolumeResponse, zapros.Response
]:
