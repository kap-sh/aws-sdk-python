...
def handle_response(
    ...
    out: capo_deadline.types.batch_update_task_response.BatchUpdateTaskResponse = (
        capo_deadline.types.batch_update_task_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.batch_update_task_request.serialize_json(input_)
    ).encode()
