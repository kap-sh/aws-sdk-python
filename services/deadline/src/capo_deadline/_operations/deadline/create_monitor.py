...
import capo_deadline.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_deadline.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_deadline.types.create_monitor_response.CreateMonitorResponse = (
        capo_deadline.types.create_monitor_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.create_monitor_request.serialize_json(input_)
    ).encode()
...
def create_monitor(
    ...
    capo_deadline.types.create_monitor_response.CreateMonitorResponse, zapros.Response
]:
