"""Generated from Smithy shape ``com.amazonaws.deadline#ListSessionActions``."""
...
import capo_deadline.types.session_action_summaries
...
def handle_response(
    ...
    out: capo_deadline.types.list_session_actions_response.ListSessionActionsResponse = capo_deadline.types.list_session_actions_response.deserialize_json(
...
async def async_list_session_actions(
