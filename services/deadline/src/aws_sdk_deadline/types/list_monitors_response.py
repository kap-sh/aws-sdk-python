...
class ListMonitorsResponse(TypedDict):
    monitors: "aws_sdk_deadline.types.monitor_summaries.MonitorSummaries"
...
def serialize_json(value: ListMonitorsResponse) -> dict:
    ...
    out["monitors"] = aws_sdk_deadline.types.monitor_summaries.serialize_json(
        value["monitors"]
    )
...
def deserialize_json(data: dict) -> ListMonitorsResponse:
    ...
    if "monitors" in data:
        ...
        out["monitors"] = aws_sdk_deadline.types.monitor_summaries.deserialize_json(
            data["monitors"]
        )
    else:
