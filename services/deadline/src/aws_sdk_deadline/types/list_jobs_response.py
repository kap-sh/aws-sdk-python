...
class ListJobsResponse(TypedDict, closed=True):
    jobs: "aws_sdk_deadline.types.job_summaries.JobSummaries"
...
def serialize_json(value: ListJobsResponse) -> dict:
    ...
    out["jobs"] = aws_sdk_deadline.types.job_summaries.serialize_json(value["jobs"])
...
def deserialize_json(data: dict) -> ListJobsResponse:
    ...
    if "jobs" in data:
        ...
        out["jobs"] = aws_sdk_deadline.types.job_summaries.deserialize_json(
            data["jobs"]
        )
    else:
