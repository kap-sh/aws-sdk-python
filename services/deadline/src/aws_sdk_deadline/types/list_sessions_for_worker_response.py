...
class ListSessionsForWorkerResponse(TypedDict):
    sessions: "aws_sdk_deadline.types.list_sessions_for_worker_summaries.ListSessionsForWorkerSummaries"
...
def serialize_json(value: ListSessionsForWorkerResponse) -> dict:
    ...
    out["sessions"] = (
        aws_sdk_deadline.types.list_sessions_for_worker_summaries.serialize_json(
            value["sessions"]
        )
    )
...
def deserialize_json(data: dict) -> ListSessionsForWorkerResponse:
    ...
    if "sessions" in data:
        ...
        out["sessions"] = (
            aws_sdk_deadline.types.list_sessions_for_worker_summaries.deserialize_json(
                data["sessions"]
            )
        )
    else:
