...
if TYPE_CHECKING:
    import aws_sdk_deadline.types.batch_get_job_error_code
...
class BatchGetJobError(TypedDict):
    ...
    code: "aws_sdk_deadline.types.batch_get_job_error_code.BatchGetJobErrorCode"
    """<p>The error code.</p>"""
...
def serialize_json(value: BatchGetJobError) -> dict:
    ...
    out["code"] = aws_sdk_deadline.types.batch_get_job_error_code.serialize_json(
        value["code"]
    )
...
def deserialize_json(data: dict) -> BatchGetJobError:
    ...
    if "code" in data:
        ...
        out["code"] = aws_sdk_deadline.types.batch_get_job_error_code.deserialize_json(
            data["code"]
        )
    else:
