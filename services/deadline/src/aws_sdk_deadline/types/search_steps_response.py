...
if TYPE_CHECKING:
    ...
    import aws_sdk_deadline.types.step_search_summaries
    import aws_sdk_deadline.types.total_results


class SearchStepsResponse(TypedDict):
    steps: "aws_sdk_deadline.types.step_search_summaries.StepSearchSummaries"
...
def serialize_json(value: SearchStepsResponse) -> dict:
    ...
    out["steps"] = aws_sdk_deadline.types.step_search_summaries.serialize_json(
        value["steps"]
    )
...
def deserialize_json(data: dict) -> SearchStepsResponse:
    ...
    if "steps" in data:
        ...
        out["steps"] = aws_sdk_deadline.types.step_search_summaries.deserialize_json(
            data["steps"]
        )
    else:
