...
class ListLimitsResponse(TypedDict):
    limits: "aws_sdk_deadline.types.limit_summaries.LimitSummaries"
...
def serialize_json(value: ListLimitsResponse) -> dict:
    ...
    out["limits"] = aws_sdk_deadline.types.limit_summaries.serialize_json(
        value["limits"]
    )
...
def deserialize_json(data: dict) -> ListLimitsResponse:
    ...
    if "limits" in data:
        ...
        out["limits"] = aws_sdk_deadline.types.limit_summaries.deserialize_json(
            data["limits"]
        )
    else:
