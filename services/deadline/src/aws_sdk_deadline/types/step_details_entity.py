...
if TYPE_CHECKING:
    import aws_sdk_deadline.types.dependencies_list
...
class StepDetailsEntity(TypedDict):
    ...
    dependencies: "aws_sdk_deadline.types.dependencies_list.DependenciesList"
...
def serialize_json(value: StepDetailsEntity) -> dict:
    ...
    out["dependencies"] = aws_sdk_deadline.types.dependencies_list.serialize_json(
        value["dependencies"]
    )
    return out
...
def deserialize_json(data: dict) -> StepDetailsEntity:
    ...
    if "dependencies" in data:
        ...
        out["dependencies"] = aws_sdk_deadline.types.dependencies_list.deserialize_json(
            data["dependencies"]
        )
    else:
