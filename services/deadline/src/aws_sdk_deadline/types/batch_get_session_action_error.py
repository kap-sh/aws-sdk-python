...
if TYPE_CHECKING:
    import aws_sdk_deadline.types.batch_get_session_action_error_code
...
class BatchGetSessionActionError(TypedDict):
    ...
    code: "aws_sdk_deadline.types.batch_get_session_action_error_code.BatchGetSessionActionErrorCode"
    """<p>The error code.</p>"""
...
def serialize_json(value: BatchGetSessionActionError) -> dict:
    ...
    out["code"] = (
        aws_sdk_deadline.types.batch_get_session_action_error_code.serialize_json(
            value["code"]
        )
    )
...
def deserialize_json(data: dict) -> BatchGetSessionActionError:
    ...
    if "code" in data:
        ...
        out["code"] = (
            aws_sdk_deadline.types.batch_get_session_action_error_code.deserialize_json(
                data["code"]
            )
        )
    else:
