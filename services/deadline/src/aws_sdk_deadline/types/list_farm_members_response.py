...
class ListFarmMembersResponse(TypedDict):
    members: "aws_sdk_deadline.types.farm_members.FarmMembers"
...
def serialize_json(value: ListFarmMembersResponse) -> dict:
    ...
    out["members"] = aws_sdk_deadline.types.farm_members.serialize_json(
        value["members"]
    )
...
def deserialize_json(data: dict) -> ListFarmMembersResponse:
    ...
    if "members" in data:
        ...
        out["members"] = aws_sdk_deadline.types.farm_members.deserialize_json(
            data["members"]
        )
    else:
