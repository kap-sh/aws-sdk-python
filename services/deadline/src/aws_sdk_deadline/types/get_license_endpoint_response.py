...
if TYPE_CHECKING:
    import aws_sdk_deadline.types.dns_name
...
class GetLicenseEndpointResponse(TypedDict):
    license_endpoint_id: "aws_sdk_deadline.types.license_endpoint_id.LicenseEndpointId"
    """<p>The license endpoint ID.</p>"""
    status: "aws_sdk_deadline.types.license_endpoint_status.LicenseEndpointStatus"
    """<p>The status of the license endpoint.</p>"""
    status_message: "aws_sdk_deadline.types.status_message.StatusMessage"
    ...
    dns_name: NotRequired["aws_sdk_deadline.types.dns_name.DnsName"]
    """<p>The DNS name.</p>"""
    subnet_ids: NotRequired["aws_sdk_deadline.types.subnet_id_list.SubnetIdList"]
    """<p>The subnet IDs.</p>"""
