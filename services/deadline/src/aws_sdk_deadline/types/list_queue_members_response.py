...
class ListQueueMembersResponse(TypedDict):
    members: "aws_sdk_deadline.types.queue_member_list.QueueMemberList"
...
def serialize_json(value: ListQueueMembersResponse) -> dict:
    ...
    out["members"] = aws_sdk_deadline.types.queue_member_list.serialize_json(
        value["members"]
    )
...
def deserialize_json(data: dict) -> ListQueueMembersResponse:
    ...
    if "members" in data:
        ...
        out["members"] = aws_sdk_deadline.types.queue_member_list.deserialize_json(
            data["members"]
        )
    else:
