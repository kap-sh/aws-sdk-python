...
class ServiceManagedEc2AutoScalingConfiguration(TypedDict, closed=True):
    ...
    worker_idle_duration_seconds: "aws_sdk_deadline.types.service_managed_ec2_worker_idle_duration_seconds.ServiceManagedEc2WorkerIdleDurationSeconds"
    ...
    scale_out_workers_per_minute: NotRequired[
        "aws_sdk_deadline.types.min_one_max_integer.MinOneMaxInteger"
    ]
