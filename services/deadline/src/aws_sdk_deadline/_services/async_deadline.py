...
from aws_sdk_deadline._services._aws_config import aaws_config
...
class AsyncdeadlineClientConfig(TypedDict, total=False):
...
class AsyncdeadlineClient:
    ...
    async def batch_get_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.batch_get_job_request.BatchGetJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.batch_get_job_response.BatchGetJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.batch_get_job.async_batch_get_job(
    ...
    async def batch_get_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.batch_get_session_request.BatchGetSessionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.batch_get_session_response.BatchGetSessionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.batch_get_session.async_batch_get_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_get_session_action(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.batch_get_session_action_request.BatchGetSessionActionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.batch_get_session_action_response.BatchGetSessionActionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.batch_get_session_action.async_batch_get_session_action(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_get_step(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.batch_get_step_request.BatchGetStepRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.batch_get_step_response.BatchGetStepResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.batch_get_step.async_batch_get_step(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_get_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.batch_get_task_request.BatchGetTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.batch_get_task_response.BatchGetTaskResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.batch_get_task.async_batch_get_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_get_worker(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.batch_get_worker_request.BatchGetWorkerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.batch_get_worker_response.BatchGetWorkerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.batch_get_worker.async_batch_get_worker(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_update_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.batch_update_job_request.BatchUpdateJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.batch_update_job_response.BatchUpdateJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.batch_update_job.async_batch_update_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_update_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.batch_update_task_request.BatchUpdateTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.batch_update_task_response.BatchUpdateTaskResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.batch_update_task.async_batch_update_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_queue_fleet_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.create_queue_fleet_association_request.CreateQueueFleetAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.create_queue_fleet_association_response.CreateQueueFleetAssociationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.create_queue_fleet_association.async_create_queue_fleet_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_queue_limit_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.create_queue_limit_association_request.CreateQueueLimitAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.create_queue_limit_association_response.CreateQueueLimitAssociationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.create_queue_limit_association.async_create_queue_limit_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_queue_fleet_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.delete_queue_fleet_association_request.DeleteQueueFleetAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.delete_queue_fleet_association_response.DeleteQueueFleetAssociationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.delete_queue_fleet_association.async_delete_queue_fleet_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_queue_limit_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.delete_queue_limit_association_request.DeleteQueueLimitAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.delete_queue_limit_association_response.DeleteQueueLimitAssociationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.delete_queue_limit_association.async_delete_queue_limit_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_queue_fleet_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.get_queue_fleet_association_request.GetQueueFleetAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.get_queue_fleet_association_response.GetQueueFleetAssociationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.get_queue_fleet_association.async_get_queue_fleet_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_queue_limit_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.get_queue_limit_association_request.GetQueueLimitAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.get_queue_limit_association_response.GetQueueLimitAssociationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.get_queue_limit_association.async_get_queue_limit_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sessions_statistics_aggregation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.get_sessions_statistics_aggregation_request.GetSessionsStatisticsAggregationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.get_sessions_statistics_aggregation_response.GetSessionsStatisticsAggregationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.get_sessions_statistics_aggregation.async_get_sessions_statistics_aggregation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_sessions_statistics_aggregation(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_deadline.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_deadline.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_deadline.types.statistics.Statistics]":
        _token = next_token
        while True:
    ...
    async def list_available_metered_products(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.list_available_metered_products_request.ListAvailableMeteredProductsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.list_available_metered_products_response.ListAvailableMeteredProductsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.list_available_metered_products.async_list_available_metered_products(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_available_metered_products(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_deadline.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_deadline.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_deadline.types.metered_product_summary.MeteredProductSummary]":
        _token = next_token
        while True:
    ...
    async def list_queue_fleet_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.list_queue_fleet_associations_request.ListQueueFleetAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.list_queue_fleet_associations_response.ListQueueFleetAssociationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.list_queue_fleet_associations.async_list_queue_fleet_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_queue_fleet_associations(
        ...
        *,
        ...
        queue_id: Optional["aws_sdk_deadline.types.queue_id.QueueId"] = None,
        fleet_id: Optional["aws_sdk_deadline.types.fleet_id.FleetId"] = None,
    ) -> "AsyncIterator[aws_sdk_deadline.types.queue_fleet_association_summary.QueueFleetAssociationSummary]":
        _token = next_token
        while True:
    ...
    async def list_queue_limit_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.list_queue_limit_associations_request.ListQueueLimitAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.list_queue_limit_associations_response.ListQueueLimitAssociationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.list_queue_limit_associations.async_list_queue_limit_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_queue_limit_associations(
        ...
        *,
        ...
        queue_id: Optional["aws_sdk_deadline.types.queue_id.QueueId"] = None,
        limit_id: Optional["aws_sdk_deadline.types.limit_id.LimitId"] = None,
    ) -> "AsyncIterator[aws_sdk_deadline.types.queue_limit_association_summary.QueueLimitAssociationSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.search_jobs_request.SearchJobsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.search_jobs_response.SearchJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.search_jobs.async_search_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_steps(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.search_steps_request.SearchStepsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.search_steps_response.SearchStepsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.search_steps.async_search_steps(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_tasks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.search_tasks_request.SearchTasksRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.search_tasks_response.SearchTasksResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.search_tasks.async_search_tasks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_workers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.search_workers_request.SearchWorkersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.search_workers_response.SearchWorkersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.search_workers.async_search_workers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_sessions_statistics_aggregation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.start_sessions_statistics_aggregation_request.StartSessionsStatisticsAggregationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.start_sessions_statistics_aggregation_response.StartSessionsStatisticsAggregationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.start_sessions_statistics_aggregation.async_start_sessions_statistics_aggregation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_queue_fleet_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.update_queue_fleet_association_request.UpdateQueueFleetAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.update_queue_fleet_association_response.UpdateQueueFleetAssociationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.update_queue_fleet_association.async_update_queue_fleet_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_queue_limit_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_deadline.types.update_queue_limit_association_request.UpdateQueueLimitAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_deadline.types.update_queue_limit_association_response.UpdateQueueLimitAssociationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_deadline._operations.deadline.update_queue_limit_association.async_update_queue_limit_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
