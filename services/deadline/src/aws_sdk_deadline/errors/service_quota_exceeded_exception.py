...
if TYPE_CHECKING:
    ...
    import aws_sdk_deadline.types.service_quota_exceeded_exception_reason
...
class ServiceQuotaExceededException_(TypedDict, closed=True):
    ...
    service_code: "aws_sdk_deadline.types.string.String"
    """<p>Identifies the service that exceeded the quota.</p>"""
    quota_code: "aws_sdk_deadline.types.string.String"
    """<p>Identifies the quota that has been exceeded.</p>"""
    resource_id: NotRequired["aws_sdk_deadline.types.string.String"]
...
def serialize_json(value: ServiceQuotaExceededException_) -> dict:
    ...
    out["reason"] = (
        aws_sdk_deadline.types.service_quota_exceeded_exception_reason.serialize_json(
            value["reason"]
        )
    )
...
def deserialize_json(data: dict) -> ServiceQuotaExceededException_:
    ...
    if "reason" in data:
        ...
        out["reason"] = (
            aws_sdk_deadline.types.service_quota_exceeded_exception_reason.deserialize_json(
                data["reason"]
            )
        )
    else:
