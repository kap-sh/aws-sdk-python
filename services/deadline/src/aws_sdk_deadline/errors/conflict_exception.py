...
if TYPE_CHECKING:
    import aws_sdk_deadline.types.conflict_exception_reason
...
def serialize_json(value: ConflictException_) -> dict:
    ...
    out["reason"] = aws_sdk_deadline.types.conflict_exception_reason.serialize_json(
        value["reason"]
    )
...
def deserialize_json(data: dict) -> ConflictException_:
    ...
    if "reason" in data:
        ...
        out["reason"] = (
            aws_sdk_deadline.types.conflict_exception_reason.deserialize_json(
                data["reason"]
            )
        )
    else:
