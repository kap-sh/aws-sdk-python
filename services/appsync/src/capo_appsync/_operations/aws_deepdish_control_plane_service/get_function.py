"""Generated from Smithy shape ``com.amazonaws.appsync#GetFunction``."""
...
def handle_response(
    ...
    out: capo_appsync.types.get_function_response.GetFunctionResponse = (
        capo_appsync.types.get_function_response.deserialize_json(
...
def get_function(
    ...
    capo_appsync.types.get_function_response.GetFunctionResponse, zapros.Response
]:
