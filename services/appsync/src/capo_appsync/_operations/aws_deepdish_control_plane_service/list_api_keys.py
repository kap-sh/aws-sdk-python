...
def handle_response(
    ...
    out: capo_appsync.types.list_api_keys_response.ListApiKeysResponse = (
        capo_appsync.types.list_api_keys_response.deserialize_json(
...
def list_api_keys(
    ...
    capo_appsync.types.list_api_keys_response.ListApiKeysResponse, zapros.Response
]:
