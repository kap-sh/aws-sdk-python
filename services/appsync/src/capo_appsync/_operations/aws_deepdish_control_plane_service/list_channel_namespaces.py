...
import capo_appsync.types.channel_namespaces
...
def handle_response(
    ...
    out: capo_appsync.types.list_channel_namespaces_response.ListChannelNamespacesResponse = capo_appsync.types.list_channel_namespaces_response.deserialize_json(
