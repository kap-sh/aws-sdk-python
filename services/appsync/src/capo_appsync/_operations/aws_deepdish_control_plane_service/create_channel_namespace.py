...
import capo_appsync.errors.conflict_exception
import capo_appsync.errors.internal_failure_exception
import capo_appsync.errors.not_found_exception
import capo_appsync.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_appsync.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_appsync.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_appsync.types.create_channel_namespace_response.CreateChannelNamespaceResponse = capo_appsync.types.create_channel_namespace_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.create_channel_namespace_request.serialize_json(input_)
    ).encode()
