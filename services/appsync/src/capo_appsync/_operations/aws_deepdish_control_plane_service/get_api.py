"""Generated from Smithy shape ``com.amazonaws.appsync#GetApi``."""
...
def handle_response(
    ...
    out: capo_appsync.types.get_api_response.GetApiResponse = (
        capo_appsync.types.get_api_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_appsync.types.get_api_request.GetApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_api(
    options: OperationOptions, input_: capo_appsync.types.get_api_request.GetApiRequest
) -> tuple[capo_appsync.types.get_api_response.GetApiResponse, zapros.Response]:
