...
def handle_response(
    ...
    out: capo_appsync.types.get_schema_creation_status_response.GetSchemaCreationStatusResponse = capo_appsync.types.get_schema_creation_status_response.deserialize_json(
