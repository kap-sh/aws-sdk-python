"""Generated from Smithy shape ``com.amazonaws.appsync#AssociateMergedGraphqlApi``."""
...
def handle_response(
    ...
    out: capo_appsync.types.associate_merged_graphql_api_response.AssociateMergedGraphqlApiResponse = capo_appsync.types.associate_merged_graphql_api_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.associate_merged_graphql_api_request.serialize_json(input_)
    ).encode()
...
async def async_associate_merged_graphql_api(
