...
def handle_response(
    ...
    out: capo_appsync.types.delete_function_response.DeleteFunctionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_function(
    ...
    capo_appsync.types.delete_function_response.DeleteFunctionResponse, zapros.Response
]:
