"""Generated from Smithy shape ``com.amazonaws.appsync#UpdateGraphqlApi``."""
...
def handle_response(
    ...
    out: capo_appsync.types.update_graphql_api_response.UpdateGraphqlApiResponse = (
        capo_appsync.types.update_graphql_api_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.update_graphql_api_request.serialize_json(input_)
    ).encode()
...
async def async_update_graphql_api(
