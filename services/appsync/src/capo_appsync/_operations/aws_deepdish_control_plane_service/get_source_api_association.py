"""Generated from Smithy shape ``com.amazonaws.appsync#GetSourceApiAssociation``."""
...
def handle_response(
    ...
    out: capo_appsync.types.get_source_api_association_response.GetSourceApiAssociationResponse = capo_appsync.types.get_source_api_association_response.deserialize_json(
...
async def async_get_source_api_association(
