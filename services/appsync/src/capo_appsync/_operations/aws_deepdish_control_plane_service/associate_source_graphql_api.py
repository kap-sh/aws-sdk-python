"""Generated from Smithy shape ``com.amazonaws.appsync#AssociateSourceGraphqlApi``."""
...
def handle_response(
    ...
    out: capo_appsync.types.associate_source_graphql_api_response.AssociateSourceGraphqlApiResponse = capo_appsync.types.associate_source_graphql_api_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.associate_source_graphql_api_request.serialize_json(input_)
    ).encode()
...
async def async_associate_source_graphql_api(
