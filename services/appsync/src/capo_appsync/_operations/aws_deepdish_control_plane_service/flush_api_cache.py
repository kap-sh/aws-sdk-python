"""Generated from Smithy shape ``com.amazonaws.appsync#FlushApiCache``."""
...
def handle_response(
    ...
    out: capo_appsync.types.flush_api_cache_response.FlushApiCacheResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apis/{apiId}/FlushCache"
...
def flush_api_cache(
    ...
    capo_appsync.types.flush_api_cache_response.FlushApiCacheResponse, zapros.Response
]:
...
async def async_flush_api_cache(
