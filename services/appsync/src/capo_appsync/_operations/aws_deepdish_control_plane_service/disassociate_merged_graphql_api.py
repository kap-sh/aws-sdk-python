...
def handle_response(
    ...
    out: capo_appsync.types.disassociate_merged_graphql_api_response.DisassociateMergedGraphqlApiResponse = capo_appsync.types.disassociate_merged_graphql_api_response.deserialize_json(
