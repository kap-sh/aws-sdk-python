"""Generated from Smithy shape ``com.amazonaws.appsync#GetResolver``."""
...
def handle_response(
    ...
    out: capo_appsync.types.get_resolver_response.GetResolverResponse = (
        capo_appsync.types.get_resolver_response.deserialize_json(
...
def get_resolver(
    ...
    capo_appsync.types.get_resolver_response.GetResolverResponse, zapros.Response
]:
