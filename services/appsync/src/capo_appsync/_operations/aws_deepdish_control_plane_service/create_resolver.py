"""Generated from Smithy shape ``com.amazonaws.appsync#CreateResolver``."""
...
def handle_response(
    ...
    out: capo_appsync.types.create_resolver_response.CreateResolverResponse = (
        capo_appsync.types.create_resolver_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.create_resolver_request.serialize_json(input_)
    ).encode()
...
def create_resolver(
    ...
    capo_appsync.types.create_resolver_response.CreateResolverResponse, zapros.Response
]:
...
async def async_create_resolver(
