...
def handle_response(
    ...
    out: capo_appsync.types.list_resolvers_by_function_response.ListResolversByFunctionResponse = capo_appsync.types.list_resolvers_by_function_response.deserialize_json(
