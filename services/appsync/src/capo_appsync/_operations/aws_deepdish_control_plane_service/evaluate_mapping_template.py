...
import capo_appsync.types.error_detail
...
def handle_response(
    ...
    out: capo_appsync.types.evaluate_mapping_template_response.EvaluateMappingTemplateResponse = capo_appsync.types.evaluate_mapping_template_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.evaluate_mapping_template_request.serialize_json(input_)
    ).encode()
