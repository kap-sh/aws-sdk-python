...
def handle_response(
    ...
    out: capo_appsync.types.list_types_response.ListTypesResponse = (
        capo_appsync.types.list_types_response.deserialize_json(
...
def list_types(
    ...
    input_: capo_appsync.types.list_types_request.ListTypesRequest,
) -> tuple[capo_appsync.types.list_types_response.ListTypesResponse, zapros.Response]:
