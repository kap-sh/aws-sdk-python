...
def handle_response(
    ...
    out: capo_appsync.types.get_graphql_api_response.GetGraphqlApiResponse = (
        capo_appsync.types.get_graphql_api_response.deserialize_json(
...
def get_graphql_api(
    ...
    capo_appsync.types.get_graphql_api_response.GetGraphqlApiResponse, zapros.Response
]:
