...
def handle_response(
    ...
    out: capo_appsync.types.list_source_api_associations_response.ListSourceApiAssociationsResponse = capo_appsync.types.list_source_api_associations_response.deserialize_json(
