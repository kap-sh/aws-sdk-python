...
import capo_appsync.errors.api_key_validity_out_of_bounds_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ApiKeyValidityOutOfBoundsException":
            raise capo_appsync.errors.api_key_validity_out_of_bounds_exception.ApiKeyValidityOutOfBoundsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_appsync.types.update_api_key_response.UpdateApiKeyResponse = (
        capo_appsync.types.update_api_key_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.update_api_key_request.serialize_json(input_)
    ).encode()
...
def update_api_key(
    ...
    capo_appsync.types.update_api_key_response.UpdateApiKeyResponse, zapros.Response
]:
