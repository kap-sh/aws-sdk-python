...
def handle_response(
    ...
    out: capo_appsync.types.delete_type_response.DeleteTypeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_type(
    ...
    input_: capo_appsync.types.delete_type_request.DeleteTypeRequest,
) -> tuple[capo_appsync.types.delete_type_response.DeleteTypeResponse, zapros.Response]:
