...
class RdsHttpEndpointConfig(TypedDict, closed=True):
    aws_region: NotRequired["capo_appsync.types.string.String"]
    """<p>Amazon Web Services Region for Amazon RDS HTTP endpoint.</p>"""
    db_cluster_identifier: NotRequired["capo_appsync.types.string.String"]
    """<p>Amazon RDS cluster Amazon Resource Name (ARN).</p>"""
    database_name: NotRequired["capo_appsync.types.string.String"]
    """<p>Logical database name.</p>"""
    schema: NotRequired["capo_appsync.types.string.String"]
    """<p>Logical schema name.</p>"""
    aws_secret_store_arn: NotRequired["capo_appsync.types.string.String"]
