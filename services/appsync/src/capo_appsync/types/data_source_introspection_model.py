...
class DataSourceIntrospectionModel(TypedDict, closed=True):
    ...
    fields: NotRequired[
        "capo_appsync.types.data_source_introspection_model_fields.DataSourceIntrospectionModelFields"
    ]
    ...
    indexes: NotRequired[
        "capo_appsync.types.data_source_introspection_model_indexes.DataSourceIntrospectionModelIndexes"
    ]
    """<p>The array of <code>DataSourceIntrospectionModelIndex</code> objects.</p>"""
    sdl: NotRequired["capo_appsync.types.string.String"]
...
def serialize_json(value: DataSourceIntrospectionModel) -> dict:
    ...
    if "fields" in value:
        ...
        out["fields"] = (
            capo_appsync.types.data_source_introspection_model_fields.serialize_json(
                value["fields"]
            )
        )
    ...
    if "indexes" in value:
        ...
        out["indexes"] = (
            capo_appsync.types.data_source_introspection_model_indexes.serialize_json(
                value["indexes"]
            )
        )
    if "sdl" in value:
...
def deserialize_json(data: dict) -> DataSourceIntrospectionModel:
    ...
    if "fields" in data:
        ...
        out["fields"] = (
            capo_appsync.types.data_source_introspection_model_fields.deserialize_json(
                data["fields"]
            )
        )
    ...
    if "indexes" in data:
        ...
        out["indexes"] = (
            capo_appsync.types.data_source_introspection_model_indexes.deserialize_json(
                data["indexes"]
            )
        )
    if "sdl" in data:
