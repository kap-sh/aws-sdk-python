...
class ListTypesResponse(TypedDict, closed=True):
    types: NotRequired["capo_appsync.types.type_list.TypeList"]
...
def serialize_json(value: ListTypesResponse) -> dict:
    ...
    if "types" in value:
        ...
        out["types"] = capo_appsync.types.type_list.serialize_json(value["types"])
...
def deserialize_json(data: dict) -> ListTypesResponse:
    ...
    if "types" in data:
        ...
        out["types"] = capo_appsync.types.type_list.deserialize_json(data["types"])
