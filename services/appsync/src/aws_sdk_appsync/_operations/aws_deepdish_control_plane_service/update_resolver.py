...
def handle_response(
    ...
    out: aws_sdk_appsync.types.update_resolver_response.UpdateResolverResponse = (
        aws_sdk_appsync.types.update_resolver_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_appsync.types.update_resolver_request.UpdateResolverRequest,
) -> zapros.Request:
    ...
    url = url.replace("{fieldName}", quote(str(input["field_name"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_appsync.types.update_resolver_request

    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.update_resolver_request.serialize_json(input)
    ).encode()
