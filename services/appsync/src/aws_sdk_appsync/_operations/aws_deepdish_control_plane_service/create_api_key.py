...
import aws_sdk_appsync.errors.api_key_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ApiKeyLimitExceededException":
            raise aws_sdk_appsync.errors.api_key_limit_exceeded_exception.ApiKeyLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.create_api_key_response.CreateApiKeyResponse = (
        aws_sdk_appsync.types.create_api_key_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.create_api_key_request.CreateApiKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.create_api_key_request.serialize_json(input_)
    ).encode()
...
def create_api_key(
    ...
    aws_sdk_appsync.types.create_api_key_response.CreateApiKeyResponse, zapros.Response
]:
