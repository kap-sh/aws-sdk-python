"""Generated from Smithy shape ``com.amazonaws.appsync#UpdateDomainName``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.update_domain_name_response.UpdateDomainNameResponse = (
        aws_sdk_appsync.types.update_domain_name_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.update_domain_name_request.UpdateDomainNameRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/domainnames/{domainName}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.update_domain_name_request.serialize_json(input_)
    ).encode()
...
async def async_update_domain_name(
