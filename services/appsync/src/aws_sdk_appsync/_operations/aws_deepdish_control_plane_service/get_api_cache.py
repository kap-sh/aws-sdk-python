...
def handle_response(
    ...
    out: aws_sdk_appsync.types.get_api_cache_response.GetApiCacheResponse = (
        aws_sdk_appsync.types.get_api_cache_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.get_api_cache_request.GetApiCacheRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_api_cache(
    ...
    aws_sdk_appsync.types.get_api_cache_response.GetApiCacheResponse, zapros.Response
]:
