"""Generated from Smithy shape ``com.amazonaws.appsync#GetGraphqlApiEnvironmentVariables``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.get_graphql_api_environment_variables_response.GetGraphqlApiEnvironmentVariablesResponse = aws_sdk_appsync.types.get_graphql_api_environment_variables_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.get_graphql_api_environment_variables_request.GetGraphqlApiEnvironmentVariablesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_graphql_api_environment_variables(
