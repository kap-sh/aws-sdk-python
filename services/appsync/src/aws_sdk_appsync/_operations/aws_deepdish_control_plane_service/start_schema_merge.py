"""Generated from Smithy shape ``com.amazonaws.appsync#StartSchemaMerge``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.start_schema_merge_response.StartSchemaMergeResponse = (
        aws_sdk_appsync.types.start_schema_merge_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.start_schema_merge_request.StartSchemaMergeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_start_schema_merge(
