...
def handle_response(
    ...
    out: aws_sdk_appsync.types.delete_resolver_response.DeleteResolverResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_appsync.types.delete_resolver_request.DeleteResolverRequest,
) -> zapros.Request:
