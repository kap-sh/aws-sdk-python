"""Generated from Smithy shape ``com.amazonaws.appsync#DeleteApiKey``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.delete_api_key_response.DeleteApiKeyResponse = {}  # type: ignore[typeddict-item]
    return out
