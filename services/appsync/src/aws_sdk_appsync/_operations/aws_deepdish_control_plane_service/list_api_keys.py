"""Generated from Smithy shape ``com.amazonaws.appsync#ListApiKeys``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.list_api_keys_response.ListApiKeysResponse = (
        aws_sdk_appsync.types.list_api_keys_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.list_api_keys_request.ListApiKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apis/{apiId}/apikeys"
...
def list_api_keys(
    ...
    aws_sdk_appsync.types.list_api_keys_response.ListApiKeysResponse, zapros.Response
]:
