"""Generated from Smithy shape ``com.amazonaws.appsync#ListTypes``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.list_types_response.ListTypesResponse = (
        aws_sdk_appsync.types.list_types_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.list_types_request.ListTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_types(
    ...
    aws_sdk_appsync.types.list_types_response.ListTypesResponse, zapros.Response
]:
