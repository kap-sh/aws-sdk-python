...
def handle_response(
    ...
    out: aws_sdk_appsync.types.list_types_by_association_response.ListTypesByAssociationResponse = aws_sdk_appsync.types.list_types_by_association_response.deserialize_json(
