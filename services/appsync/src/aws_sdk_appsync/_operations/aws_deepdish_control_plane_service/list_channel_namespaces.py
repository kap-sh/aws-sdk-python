"""Generated from Smithy shape ``com.amazonaws.appsync#ListChannelNamespaces``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.list_channel_namespaces_response.ListChannelNamespacesResponse = aws_sdk_appsync.types.list_channel_namespaces_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.list_channel_namespaces_request.ListChannelNamespacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_channel_namespaces(
