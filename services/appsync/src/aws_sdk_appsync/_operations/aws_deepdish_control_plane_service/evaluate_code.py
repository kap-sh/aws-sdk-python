...
def handle_response(
    ...
    out: aws_sdk_appsync.types.evaluate_code_response.EvaluateCodeResponse = (
        aws_sdk_appsync.types.evaluate_code_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.evaluate_code_request.EvaluateCodeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.evaluate_code_request.serialize_json(input_)
    ).encode()
...
def evaluate_code(
    ...
    aws_sdk_appsync.types.evaluate_code_response.EvaluateCodeResponse, zapros.Response
]:
