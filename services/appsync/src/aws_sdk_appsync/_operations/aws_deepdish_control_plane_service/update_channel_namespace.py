...
def build_request(
    ...
    input: aws_sdk_appsync.types.update_channel_namespace_request.UpdateChannelNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.update_channel_namespace_request.serialize_json(input)
    ).encode()
