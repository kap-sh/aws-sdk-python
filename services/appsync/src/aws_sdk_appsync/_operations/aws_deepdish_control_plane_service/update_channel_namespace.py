...
def handle_response(
    ...
    out: aws_sdk_appsync.types.update_channel_namespace_response.UpdateChannelNamespaceResponse = aws_sdk_appsync.types.update_channel_namespace_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.update_channel_namespace_request.UpdateChannelNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.update_channel_namespace_request.serialize_json(input_)
    ).encode()
