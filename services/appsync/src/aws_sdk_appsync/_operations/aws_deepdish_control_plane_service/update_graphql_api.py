...
def handle_response(
    ...
    out: aws_sdk_appsync.types.update_graphql_api_response.UpdateGraphqlApiResponse = (
        aws_sdk_appsync.types.update_graphql_api_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.update_graphql_api_request.UpdateGraphqlApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.update_graphql_api_request.serialize_json(input_)
    ).encode()
