...
def handle_response(
    ...
    out: aws_sdk_appsync.types.get_resolver_response.GetResolverResponse = (
        aws_sdk_appsync.types.get_resolver_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_appsync.types.get_resolver_request.GetResolverRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_resolver(
    ...
    aws_sdk_appsync.types.get_resolver_response.GetResolverResponse, zapros.Response
]:
