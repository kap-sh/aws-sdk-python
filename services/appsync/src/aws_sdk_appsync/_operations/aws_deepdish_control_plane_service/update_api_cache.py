"""Generated from Smithy shape ``com.amazonaws.appsync#UpdateApiCache``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.update_api_cache_response.UpdateApiCacheResponse = (
        aws_sdk_appsync.types.update_api_cache_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.update_api_cache_request.UpdateApiCacheRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apis/{apiId}/ApiCaches/update"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.update_api_cache_request.serialize_json(input_)
    ).encode()
...
async def async_update_api_cache(
