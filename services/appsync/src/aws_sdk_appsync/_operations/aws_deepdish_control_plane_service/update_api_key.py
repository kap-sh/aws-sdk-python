"""Generated from Smithy shape ``com.amazonaws.appsync#UpdateApiKey``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ApiKeyValidityOutOfBoundsException":
            import aws_sdk_appsync.errors.api_key_validity_out_of_bounds_exception

            raise aws_sdk_appsync.errors.api_key_validity_out_of_bounds_exception.ApiKeyValidityOutOfBoundsException.from_json(
                data
            )
        ...
        case "LimitExceededException":
            import aws_sdk_appsync.errors.limit_exceeded_exception

            raise aws_sdk_appsync.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.update_api_key_response.UpdateApiKeyResponse = (
        aws_sdk_appsync.types.update_api_key_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.update_api_key_request.UpdateApiKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.update_api_key_request.serialize_json(input_)
    ).encode()
...
def update_api_key(
    ...
    aws_sdk_appsync.types.update_api_key_response.UpdateApiKeyResponse, zapros.Response
]:
...
async def async_update_api_key(
