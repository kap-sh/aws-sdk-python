...
def handle_response(
    ...
    out: aws_sdk_appsync.types.associate_source_graphql_api_response.AssociateSourceGraphqlApiResponse = aws_sdk_appsync.types.associate_source_graphql_api_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_appsync.types.associate_source_graphql_api_request.AssociateSourceGraphqlApiRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.associate_source_graphql_api_request.serialize_json(input)
    ).encode()
