...
def build_request(
    ...
    input_: aws_sdk_appsync.types.associate_source_graphql_api_request.AssociateSourceGraphqlApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.associate_source_graphql_api_request.serialize_json(
            input_
        )
    ).encode()
