"""Generated from Smithy shape ``com.amazonaws.appsync#ListSourceApiAssociations``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.list_source_api_associations_response.ListSourceApiAssociationsResponse = aws_sdk_appsync.types.list_source_api_associations_response.deserialize_json(
