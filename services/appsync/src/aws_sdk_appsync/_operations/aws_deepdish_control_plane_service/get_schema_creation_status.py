"""Generated from Smithy shape ``com.amazonaws.appsync#GetSchemaCreationStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.get_schema_creation_status_response.GetSchemaCreationStatusResponse = aws_sdk_appsync.types.get_schema_creation_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.get_schema_creation_status_request.GetSchemaCreationStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apis/{apiId}/schemacreation"
...
async def async_get_schema_creation_status(
