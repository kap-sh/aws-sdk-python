"""Generated from Smithy shape ``com.amazonaws.appsync#ListGraphqlApis``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.list_graphql_apis_response.ListGraphqlApisResponse = (
        aws_sdk_appsync.types.list_graphql_apis_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.list_graphql_apis_request.ListGraphqlApisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "api_type" in input_:
        params["apiType"] = str(input_["api_type"])
    if "owner" in input_:
        params["owner"] = str(input_["owner"])
...
async def async_list_graphql_apis(
