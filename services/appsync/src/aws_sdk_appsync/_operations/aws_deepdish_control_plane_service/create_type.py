"""Generated from Smithy shape ``com.amazonaws.appsync#CreateType``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.create_type_response.CreateTypeResponse = (
        aws_sdk_appsync.types.create_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.create_type_request.CreateTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apis/{apiId}/types"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.create_type_request.serialize_json(input_)
    ).encode()
...
def create_type(
    ...
    aws_sdk_appsync.types.create_type_response.CreateTypeResponse, zapros.Response
]:
