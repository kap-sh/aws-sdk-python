...
def handle_response(
    ...
    out: aws_sdk_appsync.types.list_functions_response.ListFunctionsResponse = (
        aws_sdk_appsync.types.list_functions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.list_functions_request.ListFunctionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_functions(
    ...
    aws_sdk_appsync.types.list_functions_response.ListFunctionsResponse, zapros.Response
]:
