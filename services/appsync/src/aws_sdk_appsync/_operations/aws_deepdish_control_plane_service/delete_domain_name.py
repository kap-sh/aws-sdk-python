...
def handle_response(
    ...
    out: aws_sdk_appsync.types.delete_domain_name_response.DeleteDomainNameResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.delete_domain_name_request.DeleteDomainNameRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
