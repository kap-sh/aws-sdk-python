...
def handle_response(
    ...
    out: aws_sdk_appsync.types.get_source_api_association_response.GetSourceApiAssociationResponse = aws_sdk_appsync.types.get_source_api_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.get_source_api_association_request.GetSourceApiAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
