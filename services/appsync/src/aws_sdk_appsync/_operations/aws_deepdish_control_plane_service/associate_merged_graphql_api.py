...
def build_request(
    ...
    input_: aws_sdk_appsync.types.associate_merged_graphql_api_request.AssociateMergedGraphqlApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.associate_merged_graphql_api_request.serialize_json(
            input_
        )
    ).encode()
