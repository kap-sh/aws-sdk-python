...
def handle_response(
    ...
    out: aws_sdk_appsync.types.associate_merged_graphql_api_response.AssociateMergedGraphqlApiResponse = aws_sdk_appsync.types.associate_merged_graphql_api_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_appsync.types.associate_merged_graphql_api_request.AssociateMergedGraphqlApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.associate_merged_graphql_api_request.serialize_json(input)
    ).encode()
