"""Generated from Smithy shape ``com.amazonaws.appsync#CreateDataSource``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.create_data_source_response.CreateDataSourceResponse = (
        aws_sdk_appsync.types.create_data_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.create_data_source_request.CreateDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apis/{apiId}/datasources"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.create_data_source_request.serialize_json(input_)
    ).encode()
