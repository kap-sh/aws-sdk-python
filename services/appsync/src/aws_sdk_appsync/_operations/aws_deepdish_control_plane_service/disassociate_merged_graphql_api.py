"""Generated from Smithy shape ``com.amazonaws.appsync#DisassociateMergedGraphqlApi``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.disassociate_merged_graphql_api_response.DisassociateMergedGraphqlApiResponse = aws_sdk_appsync.types.disassociate_merged_graphql_api_response.deserialize_json(
