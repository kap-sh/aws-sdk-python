"""Generated from Smithy shape ``com.amazonaws.appsync#DisassociateSourceGraphqlApi``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.disassociate_source_graphql_api_response.DisassociateSourceGraphqlApiResponse = aws_sdk_appsync.types.disassociate_source_graphql_api_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.disassociate_source_graphql_api_request.DisassociateSourceGraphqlApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_disassociate_source_graphql_api(
