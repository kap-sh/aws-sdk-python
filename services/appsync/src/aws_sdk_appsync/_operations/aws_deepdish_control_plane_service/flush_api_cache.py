...
def handle_response(
    ...
    out: aws_sdk_appsync.types.flush_api_cache_response.FlushApiCacheResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.flush_api_cache_request.FlushApiCacheRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
