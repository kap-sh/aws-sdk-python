...
def build_request(
    ...
    input: aws_sdk_appsync.types.evaluate_mapping_template_request.EvaluateMappingTemplateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.evaluate_mapping_template_request.serialize_json(input)
    ).encode()
