"""Generated from Smithy shape ``com.amazonaws.appsync#EvaluateMappingTemplate``."""
...
import aws_sdk_appsync.types.error_detail
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.evaluate_mapping_template_response.EvaluateMappingTemplateResponse = aws_sdk_appsync.types.evaluate_mapping_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.evaluate_mapping_template_request.EvaluateMappingTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/dataplane-evaluatetemplate"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_appsync.types.evaluate_mapping_template_request

    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.evaluate_mapping_template_request.serialize_json(input_)
    ).encode()
...
async def async_evaluate_mapping_template(
