"""Generated from Smithy shape ``com.amazonaws.appsync#DeleteDataSource``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.delete_data_source_response.DeleteDataSourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.delete_data_source_request.DeleteDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
