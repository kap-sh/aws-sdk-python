"""Generated from Smithy shape ``com.amazonaws.appsync#GetGraphqlApi``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.get_graphql_api_response.GetGraphqlApiResponse = (
        aws_sdk_appsync.types.get_graphql_api_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.get_graphql_api_request.GetGraphqlApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_graphql_api(
