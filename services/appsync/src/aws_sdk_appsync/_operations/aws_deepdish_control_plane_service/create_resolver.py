...
def handle_response(
    ...
    out: aws_sdk_appsync.types.create_resolver_response.CreateResolverResponse = (
        aws_sdk_appsync.types.create_resolver_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.create_resolver_request.CreateResolverRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.create_resolver_request.serialize_json(input_)
    ).encode()
