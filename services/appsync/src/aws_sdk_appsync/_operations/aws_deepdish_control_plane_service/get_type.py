...
def handle_response(
    ...
    out: aws_sdk_appsync.types.get_type_response.GetTypeResponse = (
        aws_sdk_appsync.types.get_type_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.get_type_request.GetTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_type(
    ...
    input_: aws_sdk_appsync.types.get_type_request.GetTypeRequest,
) -> tuple[aws_sdk_appsync.types.get_type_response.GetTypeResponse, zapros.Response]:
