...
def handle_response(
    ...
    out: aws_sdk_appsync.types.get_api_response.GetApiResponse = (
        aws_sdk_appsync.types.get_api_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.get_api_request.GetApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_api(
    ...
    input_: aws_sdk_appsync.types.get_api_request.GetApiRequest,
) -> tuple[aws_sdk_appsync.types.get_api_response.GetApiResponse, zapros.Response]:
