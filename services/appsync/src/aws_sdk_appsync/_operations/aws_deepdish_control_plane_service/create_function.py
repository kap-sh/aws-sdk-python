...
def handle_response(
    ...
    out: aws_sdk_appsync.types.create_function_response.CreateFunctionResponse = (
        aws_sdk_appsync.types.create_function_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_appsync.types.create_function_request.CreateFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.create_function_request.serialize_json(input)
    ).encode()
