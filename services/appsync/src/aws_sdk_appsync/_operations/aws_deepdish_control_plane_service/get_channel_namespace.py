...
def handle_response(
    ...
    out: aws_sdk_appsync.types.get_channel_namespace_response.GetChannelNamespaceResponse = aws_sdk_appsync.types.get_channel_namespace_response.deserialize_json(
