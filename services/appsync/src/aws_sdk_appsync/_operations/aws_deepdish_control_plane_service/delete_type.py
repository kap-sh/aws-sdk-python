"""Generated from Smithy shape ``com.amazonaws.appsync#DeleteType``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.delete_type_response.DeleteTypeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.delete_type_request.DeleteTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_type(
    ...
    aws_sdk_appsync.types.delete_type_response.DeleteTypeResponse, zapros.Response
]:
