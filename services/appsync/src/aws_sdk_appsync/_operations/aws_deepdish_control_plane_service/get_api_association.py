"""Generated from Smithy shape ``com.amazonaws.appsync#GetApiAssociation``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.get_api_association_response.GetApiAssociationResponse = aws_sdk_appsync.types.get_api_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.get_api_association_request.GetApiAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_api_association(
