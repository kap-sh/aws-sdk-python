"""Generated from Smithy shape ``com.amazonaws.appsync#ListApis``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.list_apis_response.ListApisResponse = (
        aws_sdk_appsync.types.list_apis_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.list_apis_request.ListApisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_apis(
    ...
    input_: aws_sdk_appsync.types.list_apis_request.ListApisRequest,
) -> tuple[aws_sdk_appsync.types.list_apis_response.ListApisResponse, zapros.Response]:
