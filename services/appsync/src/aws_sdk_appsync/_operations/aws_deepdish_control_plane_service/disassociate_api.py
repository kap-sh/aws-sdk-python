...
def handle_response(
    ...
    out: aws_sdk_appsync.types.disassociate_api_response.DisassociateApiResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.disassociate_api_request.DisassociateApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
