...
def handle_response(
    ...
    out: aws_sdk_appsync.types.start_schema_creation_response.StartSchemaCreationResponse = aws_sdk_appsync.types.start_schema_creation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.start_schema_creation_request.StartSchemaCreationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.start_schema_creation_request.serialize_json(input_)
    ).encode()
