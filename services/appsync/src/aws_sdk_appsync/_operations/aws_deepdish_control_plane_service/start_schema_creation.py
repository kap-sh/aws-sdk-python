...
def build_request(
    ...
    input: aws_sdk_appsync.types.start_schema_creation_request.StartSchemaCreationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.start_schema_creation_request.serialize_json(input)
    ).encode()
