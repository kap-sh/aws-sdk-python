...
def handle_response(
    ...
    out: aws_sdk_appsync.types.get_domain_name_response.GetDomainNameResponse = (
        aws_sdk_appsync.types.get_domain_name_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.get_domain_name_request.GetDomainNameRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
