"""Generated from Smithy shape ``com.amazonaws.appsync#DeleteGraphqlApi``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.delete_graphql_api_response.DeleteGraphqlApiResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.delete_graphql_api_request.DeleteGraphqlApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apis/{apiId}"
...
async def async_delete_graphql_api(
