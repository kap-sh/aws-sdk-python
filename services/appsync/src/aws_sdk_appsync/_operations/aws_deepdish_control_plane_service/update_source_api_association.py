"""Generated from Smithy shape ``com.amazonaws.appsync#UpdateSourceApiAssociation``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.update_source_api_association_response.UpdateSourceApiAssociationResponse = aws_sdk_appsync.types.update_source_api_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.update_source_api_association_request.UpdateSourceApiAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.update_source_api_association_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_source_api_association(
