"""Generated from Smithy shape ``com.amazonaws.appsync#ListResolversByFunction``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.list_resolvers_by_function_response.ListResolversByFunctionResponse = aws_sdk_appsync.types.list_resolvers_by_function_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.list_resolvers_by_function_request.ListResolversByFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apis/{apiId}/functions/{functionId}/resolvers"
...
async def async_list_resolvers_by_function(
