...
def handle_response(
    ...
    out: aws_sdk_appsync.types.delete_api_cache_response.DeleteApiCacheResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.delete_api_cache_request.DeleteApiCacheRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
