"""Generated from Smithy shape ``com.amazonaws.appsync#PutGraphqlApiEnvironmentVariables``."""
...
import aws_sdk_appsync.errors.access_denied_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise aws_sdk_appsync.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.put_graphql_api_environment_variables_response.PutGraphqlApiEnvironmentVariablesResponse = aws_sdk_appsync.types.put_graphql_api_environment_variables_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.put_graphql_api_environment_variables_request.PutGraphqlApiEnvironmentVariablesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apis/{apiId}/environmentVariables"
...
async def async_put_graphql_api_environment_variables(
