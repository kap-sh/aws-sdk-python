"""Generated from Smithy shape ``com.amazonaws.appsync#DeleteChannelNamespace``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.delete_channel_namespace_response.DeleteChannelNamespaceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.delete_channel_namespace_request.DeleteChannelNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_channel_namespace(
