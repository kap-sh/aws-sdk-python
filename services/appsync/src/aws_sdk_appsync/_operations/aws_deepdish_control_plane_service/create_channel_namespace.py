"""Generated from Smithy shape ``com.amazonaws.appsync#CreateChannelNamespace``."""
...
import aws_sdk_appsync.errors.concurrent_modification_exception
import aws_sdk_appsync.errors.conflict_exception
import aws_sdk_appsync.errors.internal_failure_exception
import aws_sdk_appsync.errors.not_found_exception
import aws_sdk_appsync.errors.service_quota_exceeded_exception
import aws_sdk_appsync.errors.unauthorized_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConcurrentModificationException":
            raise aws_sdk_appsync.errors.concurrent_modification_exception.ConcurrentModificationException.from_json(
                data
            )
        case "ConflictException":
            raise aws_sdk_appsync.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_appsync.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
        case "UnauthorizedException":
            raise aws_sdk_appsync.errors.unauthorized_exception.UnauthorizedException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.create_channel_namespace_response.CreateChannelNamespaceResponse = aws_sdk_appsync.types.create_channel_namespace_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.create_channel_namespace_request.CreateChannelNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/apis/{apiId}/channelNamespaces"
    url = url.replace("{apiId}", quote(str(input_["api_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.create_channel_namespace_request.serialize_json(input_)
    ).encode()
...
async def async_create_channel_namespace(
