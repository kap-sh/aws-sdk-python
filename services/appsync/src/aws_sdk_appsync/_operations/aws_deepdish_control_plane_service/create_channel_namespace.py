...
def build_request(
    ...
    input: aws_sdk_appsync.types.create_channel_namespace_request.CreateChannelNamespaceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.create_channel_namespace_request.serialize_json(input)
    ).encode()
