...
def handle_response(
    ...
    out: aws_sdk_appsync.types.delete_api_response.DeleteApiResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.delete_api_request.DeleteApiRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_api(
    ...
    aws_sdk_appsync.types.delete_api_response.DeleteApiResponse, zapros.Response
]:
