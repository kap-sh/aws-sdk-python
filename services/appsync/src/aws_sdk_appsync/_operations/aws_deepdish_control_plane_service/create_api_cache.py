...
def handle_response(
    ...
    out: aws_sdk_appsync.types.create_api_cache_response.CreateApiCacheResponse = (
        aws_sdk_appsync.types.create_api_cache_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.create_api_cache_request.CreateApiCacheRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_appsync.types.create_api_cache_request.serialize_json(input_)
    ).encode()
