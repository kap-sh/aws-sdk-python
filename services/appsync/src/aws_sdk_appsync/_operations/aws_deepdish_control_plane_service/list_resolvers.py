"""Generated from Smithy shape ``com.amazonaws.appsync#ListResolvers``."""
...
def handle_response(
    ...
    out: aws_sdk_appsync.types.list_resolvers_response.ListResolversResponse = (
        aws_sdk_appsync.types.list_resolvers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_appsync.types.list_resolvers_request.ListResolversRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apis/{apiId}/types/{typeName}/resolvers"
...
def list_resolvers(
    ...
    aws_sdk_appsync.types.list_resolvers_response.ListResolversResponse, zapros.Response
]:
...
async def async_list_resolvers(
