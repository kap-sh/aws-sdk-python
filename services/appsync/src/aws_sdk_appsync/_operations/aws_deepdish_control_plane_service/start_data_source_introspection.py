...
def handle_response(
    ...
    out: aws_sdk_appsync.types.start_data_source_introspection_response.StartDataSourceIntrospectionResponse = aws_sdk_appsync.types.start_data_source_introspection_response.deserialize_json(
