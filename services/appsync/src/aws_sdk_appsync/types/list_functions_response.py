...
if TYPE_CHECKING:
    import aws_sdk_appsync.types.functions
    import aws_sdk_appsync.types.pagination_token


class ListFunctionsResponse(TypedDict, closed=True):
    functions: NotRequired["aws_sdk_appsync.types.functions.Functions"]
...
def serialize_json(value: ListFunctionsResponse) -> dict:
    ...
    if "functions" in value:
        ...
        out["functions"] = aws_sdk_appsync.types.functions.serialize_json(
            value["functions"]
        )
...
def deserialize_json(data: dict) -> ListFunctionsResponse:
    ...
    if "functions" in data:
        ...
        out["functions"] = aws_sdk_appsync.types.functions.deserialize_json(
            data["functions"]
        )
