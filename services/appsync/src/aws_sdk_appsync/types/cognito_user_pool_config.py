"""Generated from Smithy shape ``com.amazonaws.appsync#CognitoUserPoolConfig``."""
...
class CognitoUserPoolConfig(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CognitoUserPoolConfig) -> dict:
    out: dict = {}
