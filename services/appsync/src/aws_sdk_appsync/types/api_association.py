...
if TYPE_CHECKING:
    import aws_sdk_appsync.types.association_status
    import aws_sdk_appsync.types.domain_name
    import aws_sdk_appsync.types.string


class ApiAssociation(TypedDict):
    ...
    association_status: NotRequired[
        "aws_sdk_appsync.types.association_status.AssociationStatus"
    ]
    ...
    deployment_detail: NotRequired["aws_sdk_appsync.types.string.String"]
...
def serialize_json(value: ApiAssociation) -> dict:
    ...
    if "association_status" in value:
        ...
        out["associationStatus"] = (
            aws_sdk_appsync.types.association_status.serialize_json(
...
def deserialize_json(data: dict) -> ApiAssociation:
    ...
    if "associationStatus" in data:
        ...
        out["association_status"] = (
            aws_sdk_appsync.types.association_status.deserialize_json(
