...
# --- restJson1 ser/de ---
def serialize_json(value: GetChannelNamespaceResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetChannelNamespaceResponse:
    out: GetChannelNamespaceResponse = {}  # type: ignore[typeddict-item]
