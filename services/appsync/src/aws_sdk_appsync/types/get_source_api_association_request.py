"""Generated from Smithy shape ``com.amazonaws.appsync#GetSourceApiAssociationRequest``."""
...
class GetSourceApiAssociationRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetSourceApiAssociationRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> GetSourceApiAssociationRequest:
    out: GetSourceApiAssociationRequest = {}  # type: ignore[typeddict-item]
    return out
