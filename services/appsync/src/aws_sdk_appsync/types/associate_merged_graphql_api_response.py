"""Generated from Smithy shape ``com.amazonaws.appsync#AssociateMergedGraphqlApiResponse``."""
...
class AssociateMergedGraphqlApiResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: AssociateMergedGraphqlApiResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> AssociateMergedGraphqlApiResponse:
    out: AssociateMergedGraphqlApiResponse = {}  # type: ignore[typeddict-item]
