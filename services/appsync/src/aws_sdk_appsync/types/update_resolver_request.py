"""Generated from Smithy shape ``com.amazonaws.appsync#UpdateResolverRequest``."""
...
class UpdateResolverRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateResolverRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateResolverRequest:
    out: UpdateResolverRequest = {}  # type: ignore[typeddict-item]
