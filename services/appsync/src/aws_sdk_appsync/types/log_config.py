...
if TYPE_CHECKING:
    ...
    import aws_sdk_appsync.types.field_log_level
    import aws_sdk_appsync.types.string


class LogConfig(TypedDict, closed=True):
    field_log_level: "aws_sdk_appsync.types.field_log_level.FieldLogLevel"
    ...
    exclude_verbose_content: "aws_sdk_appsync.types.boolean.Boolean"
...
def serialize_json(value: LogConfig) -> dict:
    ...
    out["fieldLogLevel"] = aws_sdk_appsync.types.field_log_level.serialize_json(
...
def deserialize_json(data: dict) -> LogConfig:
    ...
    if "fieldLogLevel" in data:
        ...
        out["field_log_level"] = aws_sdk_appsync.types.field_log_level.deserialize_json(
            data["fieldLogLevel"]
        )
    else:
