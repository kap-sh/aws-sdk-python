...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.start_db_instance_result
...
) -> aws_sdk_rds.types.start_db_instance_result.StartDBInstanceResult:
    import aws_sdk_rds.types.start_db_instance_result

    root = fromstring(response.read())
    result = root.find("StartDBInstanceResult")
    out: aws_sdk_rds.types.start_db_instance_result.StartDBInstanceResult = (
        aws_sdk_rds.types.start_db_instance_result.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_rds.types.start_db_instance_message.StartDBInstanceMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.start_db_instance_message.serialize_query(input, pairs, "")
...
def start_db_instance(
    ...
    aws_sdk_rds.types.start_db_instance_result.StartDBInstanceResult, zapros.Response
]:
