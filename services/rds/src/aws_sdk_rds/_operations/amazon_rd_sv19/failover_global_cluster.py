...
def build_request(
    ...
    input: aws_sdk_rds.types.failover_global_cluster_message.FailoverGlobalClusterMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.failover_global_cluster_message.serialize_query(input, pairs, "")
