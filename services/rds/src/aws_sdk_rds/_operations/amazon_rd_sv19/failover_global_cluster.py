"""Generated from Smithy shape ``com.amazonaws.rds#FailoverGlobalCluster``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.failover_global_cluster_message
    import aws_sdk_rds.types.failover_global_cluster_result
...
) -> aws_sdk_rds.types.failover_global_cluster_result.FailoverGlobalClusterResult:
    import aws_sdk_rds.types.failover_global_cluster_result

    root = fromstring(response.read())
    result = root.find("FailoverGlobalClusterResult")
    out: aws_sdk_rds.types.failover_global_cluster_result.FailoverGlobalClusterResult = aws_sdk_rds.types.failover_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.failover_global_cluster_message.FailoverGlobalClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "FailoverGlobalCluster"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.failover_global_cluster_message

    aws_sdk_rds.types.failover_global_cluster_message.serialize_query(input_, pairs, "")
...
async def async_failover_global_cluster(
