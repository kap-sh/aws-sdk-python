...
import aws_sdk_rds.types.modify_db_cluster_endpoint_message
...
def build_request(
    ...
    input_: aws_sdk_rds.types.modify_db_cluster_endpoint_message.ModifyDBClusterEndpointMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.modify_db_cluster_endpoint_message.serialize_query(
        input_, pairs, ""
    )
