...
def build_request(
    ...
    input: aws_sdk_rds.types.create_tenant_database_message.CreateTenantDatabaseMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.create_tenant_database_message.serialize_query(input, pairs, "")
