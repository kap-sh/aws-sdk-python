"""Generated from Smithy shape ``com.amazonaws.rds#CreateTenantDatabase``."""
...
import aws_sdk_rds.errors.tenant_database_already_exists_fault
import aws_sdk_rds.errors.tenant_database_quota_exceeded_fault
import aws_sdk_rds.types.create_tenant_database_message
import aws_sdk_rds.types.create_tenant_database_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TenantDatabaseAlreadyExistsFault":
            raise aws_sdk_rds.errors.tenant_database_already_exists_fault.TenantDatabaseAlreadyExistsFault.from_query(
                root
            )
...
) -> aws_sdk_rds.types.create_tenant_database_result.CreateTenantDatabaseResult:
    root = fromstring(response.read())
    result = root.find("CreateTenantDatabaseResult")
    out: aws_sdk_rds.types.create_tenant_database_result.CreateTenantDatabaseResult = (
        aws_sdk_rds.types.create_tenant_database_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.create_tenant_database_message.CreateTenantDatabaseMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateTenantDatabase"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.create_tenant_database_message

    aws_sdk_rds.types.create_tenant_database_message.serialize_query(input_, pairs, "")
...
async def async_create_tenant_database(
