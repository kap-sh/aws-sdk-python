...
import aws_sdk_rds.types.delete_custom_db_engine_version_message
...
def build_request(
    ...
    input_: aws_sdk_rds.types.delete_custom_db_engine_version_message.DeleteCustomDBEngineVersionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.delete_custom_db_engine_version_message.serialize_query(
        input_, pairs, ""
    )
