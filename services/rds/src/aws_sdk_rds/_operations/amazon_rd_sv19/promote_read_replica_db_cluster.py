"""Generated from Smithy shape ``com.amazonaws.rds#PromoteReadReplicaDBCluster``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.promote_read_replica_db_cluster_message
    import aws_sdk_rds.types.promote_read_replica_db_cluster_result
...
) -> aws_sdk_rds.types.promote_read_replica_db_cluster_result.PromoteReadReplicaDBClusterResult:
    import aws_sdk_rds.types.promote_read_replica_db_cluster_result

    root = fromstring(response.read())
    result = root.find("PromoteReadReplicaDBClusterResult")
    out: aws_sdk_rds.types.promote_read_replica_db_cluster_result.PromoteReadReplicaDBClusterResult = aws_sdk_rds.types.promote_read_replica_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.promote_read_replica_db_cluster_message.PromoteReadReplicaDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "PromoteReadReplicaDBCluster"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.promote_read_replica_db_cluster_message

    aws_sdk_rds.types.promote_read_replica_db_cluster_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_promote_read_replica_db_cluster(
