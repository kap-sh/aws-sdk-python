...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidExportTaskStateFault":
            import aws_sdk_rds.errors.invalid_export_task_state_fault

            raise aws_sdk_rds.errors.invalid_export_task_state_fault.InvalidExportTaskStateFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    input: aws_sdk_rds.types.cancel_export_task_message.CancelExportTaskMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.cancel_export_task_message.serialize_query(input, pairs, "")
