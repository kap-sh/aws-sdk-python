...
if TYPE_CHECKING:
    import aws_sdk_rds.types.describe_db_proxy_targets_request
    import aws_sdk_rds.types.describe_db_proxy_targets_response
...
def handle_response(
    ...
    aws_sdk_rds.types.describe_db_proxy_targets_response.DescribeDBProxyTargetsResponse
):
    import aws_sdk_rds.types.describe_db_proxy_targets_response

    root = fromstring(response.read())
    result = root.find("DescribeDBProxyTargetsResult")
    out: aws_sdk_rds.types.describe_db_proxy_targets_response.DescribeDBProxyTargetsResponse = aws_sdk_rds.types.describe_db_proxy_targets_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_db_proxy_targets_request.DescribeDBProxyTargetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.describe_db_proxy_targets_request.serialize_query(
        input_, pairs, ""
    )
