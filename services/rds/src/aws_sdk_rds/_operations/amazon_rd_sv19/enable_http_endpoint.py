...
def build_request(
    ...
    input: aws_sdk_rds.types.enable_http_endpoint_request.EnableHttpEndpointRequest,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.enable_http_endpoint_request.serialize_query(input, pairs, "")
