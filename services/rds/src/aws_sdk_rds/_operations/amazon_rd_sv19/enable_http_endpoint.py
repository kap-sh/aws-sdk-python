"""Generated from Smithy shape ``com.amazonaws.rds#EnableHttpEndpoint``."""
...
import aws_sdk_rds.types.enable_http_endpoint_request
import aws_sdk_rds.types.enable_http_endpoint_response
...
) -> aws_sdk_rds.types.enable_http_endpoint_response.EnableHttpEndpointResponse:
    root = fromstring(response.read())
    result = root.find("EnableHttpEndpointResult")
    out: aws_sdk_rds.types.enable_http_endpoint_response.EnableHttpEndpointResponse = (
        aws_sdk_rds.types.enable_http_endpoint_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.enable_http_endpoint_request.EnableHttpEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "EnableHttpEndpoint"))
    pairs.append(("Version", "2014-10-31"))
    aws_sdk_rds.types.enable_http_endpoint_request.serialize_query(input_, pairs, "")
...
async def async_enable_http_endpoint(
