"""Generated from Smithy shape ``com.amazonaws.rds#CreateDBClusterSnapshot``."""
...
def build_request(
    ...
    input_: aws_sdk_rds.types.create_db_cluster_snapshot_message.CreateDBClusterSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.create_db_cluster_snapshot_message.serialize_query(
        input_, pairs, ""
    )
