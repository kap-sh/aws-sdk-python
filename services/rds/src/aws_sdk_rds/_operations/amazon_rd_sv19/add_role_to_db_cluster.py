...
def build_request(
    ...
    input: aws_sdk_rds.types.add_role_to_db_cluster_message.AddRoleToDBClusterMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.add_role_to_db_cluster_message.serialize_query(input, pairs, "")
