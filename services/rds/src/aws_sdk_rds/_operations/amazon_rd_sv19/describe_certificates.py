"""Generated from Smithy shape ``com.amazonaws.rds#DescribeCertificates``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.certificate_message
    import aws_sdk_rds.types.describe_certificates_message
...
) -> aws_sdk_rds.types.certificate_message.CertificateMessage:
    import aws_sdk_rds.types.certificate_message

    root = fromstring(response.read())
    result = root.find("DescribeCertificatesResult")
    out: aws_sdk_rds.types.certificate_message.CertificateMessage = (
        aws_sdk_rds.types.certificate_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_certificates_message.DescribeCertificatesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.describe_certificates_message.serialize_query(input_, pairs, "")
...
def describe_certificates(
    ...
    input_: aws_sdk_rds.types.describe_certificates_message.DescribeCertificatesMessage,
) -> tuple[aws_sdk_rds.types.certificate_message.CertificateMessage, zapros.Response]:
