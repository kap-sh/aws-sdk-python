...
def build_request(
    ...
    input: aws_sdk_rds.types.describe_certificates_message.DescribeCertificatesMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.describe_certificates_message.serialize_query(input, pairs, "")
