...
if TYPE_CHECKING:
    import aws_sdk_rds.types.remove_from_global_cluster_message
    import aws_sdk_rds.types.remove_from_global_cluster_result
...
) -> aws_sdk_rds.types.remove_from_global_cluster_result.RemoveFromGlobalClusterResult:
    import aws_sdk_rds.types.remove_from_global_cluster_result

    root = fromstring(response.read())
    result = root.find("RemoveFromGlobalClusterResult")
    out: aws_sdk_rds.types.remove_from_global_cluster_result.RemoveFromGlobalClusterResult = aws_sdk_rds.types.remove_from_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.remove_from_global_cluster_message.RemoveFromGlobalClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.remove_from_global_cluster_message.serialize_query(
        input_, pairs, ""
    )
