...
import aws_sdk_rds.types.describe_db_log_files_list
import aws_sdk_rds.types.describe_db_log_files_message
import aws_sdk_rds.types.describe_db_log_files_response
...
) -> aws_sdk_rds.types.describe_db_log_files_response.DescribeDBLogFilesResponse:
    root = fromstring(response.read())
    result = root.find("DescribeDBLogFilesResult")
    out: aws_sdk_rds.types.describe_db_log_files_response.DescribeDBLogFilesResponse = (
        aws_sdk_rds.types.describe_db_log_files_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_db_log_files_message.DescribeDBLogFilesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.describe_db_log_files_message.serialize_query(input_, pairs, "")
