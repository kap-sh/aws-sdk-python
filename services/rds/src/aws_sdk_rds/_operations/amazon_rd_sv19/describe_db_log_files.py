...
def build_request(
    ...
    input: aws_sdk_rds.types.describe_db_log_files_message.DescribeDBLogFilesMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.describe_db_log_files_message.serialize_query(input, pairs, "")
