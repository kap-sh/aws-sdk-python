"""Generated from Smithy shape ``com.amazonaws.rds#DeleteDBSecurityGroup``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.delete_db_security_group_message
...
def build_request(
    ...
    input: aws_sdk_rds.types.delete_db_security_group_message.DeleteDBSecurityGroupMessage,
) -> zapros.Request:
    ...
    pairs.append(("Action", "DeleteDBSecurityGroup"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.delete_db_security_group_message

    aws_sdk_rds.types.delete_db_security_group_message.serialize_query(input, pairs, "")
...
async def async_delete_db_security_group(
