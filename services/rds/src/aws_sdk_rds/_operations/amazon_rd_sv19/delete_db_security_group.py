...
def build_request(
    ...
    input_: aws_sdk_rds.types.delete_db_security_group_message.DeleteDBSecurityGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.delete_db_security_group_message.serialize_query(
        input_, pairs, ""
    )
