"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBClusterParameters``."""
...
import aws_sdk_rds.types.db_cluster_parameter_group_details
import aws_sdk_rds.types.describe_db_cluster_parameters_message
...
def handle_response(
    ...
    aws_sdk_rds.types.db_cluster_parameter_group_details.DBClusterParameterGroupDetails
):
    root = fromstring(response.read())
    result = root.find("DescribeDBClusterParametersResult")
    out: aws_sdk_rds.types.db_cluster_parameter_group_details.DBClusterParameterGroupDetails = aws_sdk_rds.types.db_cluster_parameter_group_details.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_db_cluster_parameters_message.DescribeDBClusterParametersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeDBClusterParameters"))
    pairs.append(("Version", "2014-10-31"))
    aws_sdk_rds.types.describe_db_cluster_parameters_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_db_cluster_parameters(
