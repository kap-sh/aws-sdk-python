...
if TYPE_CHECKING:
    import aws_sdk_rds.types.add_role_to_db_instance_message
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBInstanceRoleAlreadyExistsFault":
            import aws_sdk_rds.errors.db_instance_role_already_exists_fault

            raise aws_sdk_rds.errors.db_instance_role_already_exists_fault.DBInstanceRoleAlreadyExistsFault.from_query(
                root
            )
        case "DBInstanceRoleQuotaExceededFault":
            import aws_sdk_rds.errors.db_instance_role_quota_exceeded_fault

            raise aws_sdk_rds.errors.db_instance_role_quota_exceeded_fault.DBInstanceRoleQuotaExceededFault.from_query(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_rds.types.add_role_to_db_instance_message.AddRoleToDBInstanceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.add_role_to_db_instance_message.serialize_query(input_, pairs, "")
