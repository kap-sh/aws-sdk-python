...
def build_request(
    ...
    input: aws_sdk_rds.types.add_role_to_db_instance_message.AddRoleToDBInstanceMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.add_role_to_db_instance_message.serialize_query(input, pairs, "")
