"""Generated from Smithy shape ``com.amazonaws.rds#CreateDBSnapshot``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.create_db_snapshot_message
    import aws_sdk_rds.types.create_db_snapshot_result
...
) -> aws_sdk_rds.types.create_db_snapshot_result.CreateDBSnapshotResult:
    import aws_sdk_rds.types.create_db_snapshot_result

    root = fromstring(response.read())
    result = root.find("CreateDBSnapshotResult")
    out: aws_sdk_rds.types.create_db_snapshot_result.CreateDBSnapshotResult = (
        aws_sdk_rds.types.create_db_snapshot_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.create_db_snapshot_message.CreateDBSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateDBSnapshot"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.create_db_snapshot_message

    aws_sdk_rds.types.create_db_snapshot_message.serialize_query(input_, pairs, "")
...
def create_db_snapshot(
    ...
    aws_sdk_rds.types.create_db_snapshot_result.CreateDBSnapshotResult, zapros.Response
]:
...
async def async_create_db_snapshot(
