...
def build_request(
    ...
    input_: aws_sdk_rds.types.delete_db_cluster_automated_backup_message.DeleteDBClusterAutomatedBackupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.delete_db_cluster_automated_backup_message.serialize_query(
        input_, pairs, ""
    )
