"""Generated from Smithy shape ``com.amazonaws.rds#RebootDBCluster``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.reboot_db_cluster_message
    import aws_sdk_rds.types.reboot_db_cluster_result
...
) -> aws_sdk_rds.types.reboot_db_cluster_result.RebootDBClusterResult:
    import aws_sdk_rds.types.reboot_db_cluster_result

    root = fromstring(response.read())
    result = root.find("RebootDBClusterResult")
    out: aws_sdk_rds.types.reboot_db_cluster_result.RebootDBClusterResult = (
        aws_sdk_rds.types.reboot_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.reboot_db_cluster_message.RebootDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RebootDBCluster"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.reboot_db_cluster_message

    aws_sdk_rds.types.reboot_db_cluster_message.serialize_query(input_, pairs, "")
...
def reboot_db_cluster(
    ...
    aws_sdk_rds.types.reboot_db_cluster_result.RebootDBClusterResult, zapros.Response
]:
...
async def async_reboot_db_cluster(
