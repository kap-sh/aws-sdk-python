...
import aws_sdk_rds.errors.db_instance_automated_backup_not_found_fault
...
import aws_sdk_rds.errors.point_in_time_restore_not_enabled_fault
...
import aws_sdk_rds.types.restore_db_instance_to_point_in_time_message
import aws_sdk_rds.types.restore_db_instance_to_point_in_time_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBInstanceAutomatedBackupNotFoundFault":
            raise aws_sdk_rds.errors.db_instance_automated_backup_not_found_fault.DBInstanceAutomatedBackupNotFoundFault.from_query(
                root
            )
        ...
        case "PointInTimeRestoreNotEnabledFault":
            raise aws_sdk_rds.errors.point_in_time_restore_not_enabled_fault.PointInTimeRestoreNotEnabledFault.from_query(
                root
            )
...
) -> aws_sdk_rds.types.restore_db_instance_to_point_in_time_result.RestoreDBInstanceToPointInTimeResult:
    root = fromstring(response.read())
    result = root.find("RestoreDBInstanceToPointInTimeResult")
    out: aws_sdk_rds.types.restore_db_instance_to_point_in_time_result.RestoreDBInstanceToPointInTimeResult = aws_sdk_rds.types.restore_db_instance_to_point_in_time_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.restore_db_instance_to_point_in_time_message.RestoreDBInstanceToPointInTimeMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.restore_db_instance_to_point_in_time_message.serialize_query(
        input_, pairs, ""
    )
