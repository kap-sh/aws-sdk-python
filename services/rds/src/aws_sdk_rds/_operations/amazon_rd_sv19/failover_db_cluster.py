"""Generated from Smithy shape ``com.amazonaws.rds#FailoverDBCluster``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.failover_db_cluster_message
    import aws_sdk_rds.types.failover_db_cluster_result
...
) -> aws_sdk_rds.types.failover_db_cluster_result.FailoverDBClusterResult:
    import aws_sdk_rds.types.failover_db_cluster_result

    root = fromstring(response.read())
    result = root.find("FailoverDBClusterResult")
    out: aws_sdk_rds.types.failover_db_cluster_result.FailoverDBClusterResult = (
        aws_sdk_rds.types.failover_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.failover_db_cluster_message.FailoverDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "FailoverDBCluster"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.failover_db_cluster_message

    aws_sdk_rds.types.failover_db_cluster_message.serialize_query(input_, pairs, "")
...
async def async_failover_db_cluster(
