...
def build_request(
    ...
    input: aws_sdk_rds.types.backtrack_db_cluster_message.BacktrackDBClusterMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.backtrack_db_cluster_message.serialize_query(input, pairs, "")
