"""Generated from Smithy shape ``com.amazonaws.rds#BacktrackDBCluster``."""
...
import aws_sdk_rds.types.backtrack_db_cluster_message
import aws_sdk_rds.types.db_cluster_backtrack
...
) -> aws_sdk_rds.types.db_cluster_backtrack.DBClusterBacktrack:
    root = fromstring(response.read())
    result = root.find("BacktrackDBClusterResult")
    out: aws_sdk_rds.types.db_cluster_backtrack.DBClusterBacktrack = (
        aws_sdk_rds.types.db_cluster_backtrack.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.backtrack_db_cluster_message.BacktrackDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "BacktrackDBCluster"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.backtrack_db_cluster_message

    aws_sdk_rds.types.backtrack_db_cluster_message.serialize_query(input_, pairs, "")
...
def backtrack_db_cluster(
    ...
    input_: aws_sdk_rds.types.backtrack_db_cluster_message.BacktrackDBClusterMessage,
) -> tuple[aws_sdk_rds.types.db_cluster_backtrack.DBClusterBacktrack, zapros.Response]:
...
async def async_backtrack_db_cluster(
