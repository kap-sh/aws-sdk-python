"""Generated from Smithy shape ``com.amazonaws.rds#DescribeBlueGreenDeployments``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.describe_blue_green_deployments_response
...
) -> aws_sdk_rds.types.describe_blue_green_deployments_response.DescribeBlueGreenDeploymentsResponse:
    import aws_sdk_rds.types.describe_blue_green_deployments_response

    root = fromstring(response.read())
    result = root.find("DescribeBlueGreenDeploymentsResult")
    out: aws_sdk_rds.types.describe_blue_green_deployments_response.DescribeBlueGreenDeploymentsResponse = aws_sdk_rds.types.describe_blue_green_deployments_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_blue_green_deployments_request.DescribeBlueGreenDeploymentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_blue_green_deployments(
