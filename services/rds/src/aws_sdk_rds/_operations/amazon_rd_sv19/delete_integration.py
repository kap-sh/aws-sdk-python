"""Generated from Smithy shape ``com.amazonaws.rds#DeleteIntegration``."""
...
import aws_sdk_rds.errors.invalid_integration_state_fault
import aws_sdk_rds.types.delete_integration_message
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidIntegrationStateFault":
            raise aws_sdk_rds.errors.invalid_integration_state_fault.InvalidIntegrationStateFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_rds.types.delete_integration_message.DeleteIntegrationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.delete_integration_message.serialize_query(input_, pairs, "")
