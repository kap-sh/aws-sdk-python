...
def build_request(
    ...
    input: aws_sdk_rds.types.delete_tenant_database_message.DeleteTenantDatabaseMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.delete_tenant_database_message.serialize_query(input, pairs, "")
