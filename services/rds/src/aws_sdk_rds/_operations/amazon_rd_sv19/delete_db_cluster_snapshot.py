...
if TYPE_CHECKING:
    import aws_sdk_rds.types.delete_db_cluster_snapshot_message
    import aws_sdk_rds.types.delete_db_cluster_snapshot_result
...
) -> aws_sdk_rds.types.delete_db_cluster_snapshot_result.DeleteDBClusterSnapshotResult:
    import aws_sdk_rds.types.delete_db_cluster_snapshot_result

    root = fromstring(response.read())
    result = root.find("DeleteDBClusterSnapshotResult")
    out: aws_sdk_rds.types.delete_db_cluster_snapshot_result.DeleteDBClusterSnapshotResult = aws_sdk_rds.types.delete_db_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.delete_db_cluster_snapshot_message.DeleteDBClusterSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.delete_db_cluster_snapshot_message.serialize_query(
        input_, pairs, ""
    )
