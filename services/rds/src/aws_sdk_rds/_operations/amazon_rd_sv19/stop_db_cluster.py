...
if TYPE_CHECKING:
    import aws_sdk_rds.types.stop_db_cluster_message
    import aws_sdk_rds.types.stop_db_cluster_result
...
) -> aws_sdk_rds.types.stop_db_cluster_result.StopDBClusterResult:
    import aws_sdk_rds.types.stop_db_cluster_result

    root = fromstring(response.read())
    result = root.find("StopDBClusterResult")
    out: aws_sdk_rds.types.stop_db_cluster_result.StopDBClusterResult = (
        aws_sdk_rds.types.stop_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.stop_db_cluster_message.StopDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.stop_db_cluster_message.serialize_query(input_, pairs, "")
...
def stop_db_cluster(
    ...
    aws_sdk_rds.types.stop_db_cluster_result.StopDBClusterResult, zapros.Response
]:
