...
def build_request(
    ...
    input_: aws_sdk_rds.types.disable_http_endpoint_request.DisableHttpEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.disable_http_endpoint_request.serialize_query(input_, pairs, "")
