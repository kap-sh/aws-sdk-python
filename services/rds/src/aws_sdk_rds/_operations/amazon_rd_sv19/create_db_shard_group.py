...
def build_request(
    ...
    input: aws_sdk_rds.types.create_db_shard_group_message.CreateDBShardGroupMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.create_db_shard_group_message.serialize_query(input, pairs, "")
