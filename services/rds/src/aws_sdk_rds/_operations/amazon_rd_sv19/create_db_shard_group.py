"""Generated from Smithy shape ``com.amazonaws.rds#CreateDBShardGroup``."""
...
import aws_sdk_rds.errors.db_shard_group_already_exists_fault
import aws_sdk_rds.errors.invalid_db_cluster_state_fault
import aws_sdk_rds.errors.invalid_vpc_network_state_fault
import aws_sdk_rds.errors.max_db_shard_group_limit_reached
import aws_sdk_rds.errors.network_type_not_supported
import aws_sdk_rds.errors.unsupported_db_engine_version_fault
import aws_sdk_rds.types.create_db_shard_group_message
import aws_sdk_rds.types.db_shard_group
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBShardGroupAlreadyExistsFault":
            raise aws_sdk_rds.errors.db_shard_group_already_exists_fault.DBShardGroupAlreadyExistsFault.from_query(
                root
            )
        ...
        case "MaxDBShardGroupLimitReached":
            raise aws_sdk_rds.errors.max_db_shard_group_limit_reached.MaxDBShardGroupLimitReached.from_query(
                root
            )
        ...
        case "UnsupportedDBEngineVersionFault":
            raise aws_sdk_rds.errors.unsupported_db_engine_version_fault.UnsupportedDBEngineVersionFault.from_query(
                root
            )
        case _:
...
) -> aws_sdk_rds.types.db_shard_group.DBShardGroup:
    root = fromstring(response.read())
    result = root.find("CreateDBShardGroupResult")
    out: aws_sdk_rds.types.db_shard_group.DBShardGroup = (
        aws_sdk_rds.types.db_shard_group.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.create_db_shard_group_message.CreateDBShardGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.create_db_shard_group_message.serialize_query(input_, pairs, "")
...
def create_db_shard_group(
    ...
    input_: aws_sdk_rds.types.create_db_shard_group_message.CreateDBShardGroupMessage,
) -> tuple[aws_sdk_rds.types.db_shard_group.DBShardGroup, zapros.Response]:
...
async def async_create_db_shard_group(
