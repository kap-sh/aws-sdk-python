...
def build_request(
    ...
    input: aws_sdk_rds.types.modify_db_subnet_group_message.ModifyDBSubnetGroupMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.modify_db_subnet_group_message.serialize_query(input, pairs, "")
