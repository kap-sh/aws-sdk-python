"""Generated from Smithy shape ``com.amazonaws.rds#ModifyDBSubnetGroup``."""
...
import aws_sdk_rds.errors.subnet_already_in_use
import aws_sdk_rds.types.db_subnet_group
import aws_sdk_rds.types.modify_db_subnet_group_message
import aws_sdk_rds.types.modify_db_subnet_group_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubnetAlreadyInUse":
            raise aws_sdk_rds.errors.subnet_already_in_use.SubnetAlreadyInUse.from_query(
                root
            )
        case _:
...
) -> aws_sdk_rds.types.modify_db_subnet_group_result.ModifyDBSubnetGroupResult:
    root = fromstring(response.read())
    result = root.find("ModifyDBSubnetGroupResult")
    out: aws_sdk_rds.types.modify_db_subnet_group_result.ModifyDBSubnetGroupResult = (
        aws_sdk_rds.types.modify_db_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.modify_db_subnet_group_message.ModifyDBSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.modify_db_subnet_group_message.serialize_query(input_, pairs, "")
