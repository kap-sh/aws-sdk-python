...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.describe_db_major_engine_versions_response
...
) -> aws_sdk_rds.types.describe_db_major_engine_versions_response.DescribeDBMajorEngineVersionsResponse:
    import aws_sdk_rds.types.describe_db_major_engine_versions_response

    root = fromstring(response.read())
    result = root.find("DescribeDBMajorEngineVersionsResult")
    out: aws_sdk_rds.types.describe_db_major_engine_versions_response.DescribeDBMajorEngineVersionsResponse = aws_sdk_rds.types.describe_db_major_engine_versions_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_db_major_engine_versions_request.DescribeDBMajorEngineVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
