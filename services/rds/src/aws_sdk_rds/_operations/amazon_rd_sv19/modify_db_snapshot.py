"""Generated from Smithy shape ``com.amazonaws.rds#ModifyDBSnapshot``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.modify_db_snapshot_message
    import aws_sdk_rds.types.modify_db_snapshot_result
...
) -> aws_sdk_rds.types.modify_db_snapshot_result.ModifyDBSnapshotResult:
    import aws_sdk_rds.types.modify_db_snapshot_result

    root = fromstring(response.read())
    result = root.find("ModifyDBSnapshotResult")
    out: aws_sdk_rds.types.modify_db_snapshot_result.ModifyDBSnapshotResult = (
        aws_sdk_rds.types.modify_db_snapshot_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.modify_db_snapshot_message.ModifyDBSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyDBSnapshot"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.modify_db_snapshot_message

    aws_sdk_rds.types.modify_db_snapshot_message.serialize_query(input_, pairs, "")
...
def modify_db_snapshot(
    ...
    aws_sdk_rds.types.modify_db_snapshot_result.ModifyDBSnapshotResult, zapros.Response
]:
...
async def async_modify_db_snapshot(
