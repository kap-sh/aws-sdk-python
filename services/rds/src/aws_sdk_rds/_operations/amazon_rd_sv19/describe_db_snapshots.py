"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBSnapshots``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.db_snapshot_message
    import aws_sdk_rds.types.describe_db_snapshots_message
...
) -> aws_sdk_rds.types.db_snapshot_message.DBSnapshotMessage:
    import aws_sdk_rds.types.db_snapshot_message

    root = fromstring(response.read())
    result = root.find("DescribeDBSnapshotsResult")
    out: aws_sdk_rds.types.db_snapshot_message.DBSnapshotMessage = (
        aws_sdk_rds.types.db_snapshot_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_db_snapshots_message.DescribeDBSnapshotsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeDBSnapshots"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.describe_db_snapshots_message

    aws_sdk_rds.types.describe_db_snapshots_message.serialize_query(input_, pairs, "")
...
def describe_db_snapshots(
    ...
    input_: aws_sdk_rds.types.describe_db_snapshots_message.DescribeDBSnapshotsMessage,
) -> tuple[aws_sdk_rds.types.db_snapshot_message.DBSnapshotMessage, zapros.Response]:
...
async def async_describe_db_snapshots(
