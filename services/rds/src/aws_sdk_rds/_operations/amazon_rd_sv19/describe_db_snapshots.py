...
def build_request(
    ...
    input: aws_sdk_rds.types.describe_db_snapshots_message.DescribeDBSnapshotsMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.describe_db_snapshots_message.serialize_query(input, pairs, "")
