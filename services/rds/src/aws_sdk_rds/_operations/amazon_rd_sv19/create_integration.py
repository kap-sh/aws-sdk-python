...
def build_request(
    ...
    input_: aws_sdk_rds.types.create_integration_message.CreateIntegrationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.create_integration_message.serialize_query(input_, pairs, "")
...
def create_integration(
    ...
    input_: aws_sdk_rds.types.create_integration_message.CreateIntegrationMessage,
) -> tuple[aws_sdk_rds.types.integration.Integration, zapros.Response]:
