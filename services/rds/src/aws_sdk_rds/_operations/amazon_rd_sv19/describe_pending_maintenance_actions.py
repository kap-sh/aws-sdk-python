"""Generated from Smithy shape ``com.amazonaws.rds#DescribePendingMaintenanceActions``."""
...
import aws_sdk_rds.types.describe_pending_maintenance_actions_message
import aws_sdk_rds.types.filter_list
import aws_sdk_rds.types.pending_maintenance_actions
import aws_sdk_rds.types.pending_maintenance_actions_message
...
) -> aws_sdk_rds.types.pending_maintenance_actions_message.PendingMaintenanceActionsMessage:
    root = fromstring(response.read())
    result = root.find("DescribePendingMaintenanceActionsResult")
    out: aws_sdk_rds.types.pending_maintenance_actions_message.PendingMaintenanceActionsMessage = aws_sdk_rds.types.pending_maintenance_actions_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_pending_maintenance_actions_message.DescribePendingMaintenanceActionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.describe_pending_maintenance_actions_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_pending_maintenance_actions(
