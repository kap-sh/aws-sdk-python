...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_db_cluster_backtracks_message.DescribeDBClusterBacktracksMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.describe_db_cluster_backtracks_message.serialize_query(
        input_, pairs, ""
    )
