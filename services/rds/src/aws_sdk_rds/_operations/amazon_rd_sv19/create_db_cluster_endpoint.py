...
if TYPE_CHECKING:
    import aws_sdk_rds.types.create_db_cluster_endpoint_message
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBClusterEndpointAlreadyExistsFault":
            import aws_sdk_rds.errors.db_cluster_endpoint_already_exists_fault

            raise aws_sdk_rds.errors.db_cluster_endpoint_already_exists_fault.DBClusterEndpointAlreadyExistsFault.from_query(
                root
            )
        case "DBClusterEndpointQuotaExceededFault":
            import aws_sdk_rds.errors.db_cluster_endpoint_quota_exceeded_fault

            raise aws_sdk_rds.errors.db_cluster_endpoint_quota_exceeded_fault.DBClusterEndpointQuotaExceededFault.from_query(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_rds.types.create_db_cluster_endpoint_message.CreateDBClusterEndpointMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.create_db_cluster_endpoint_message.serialize_query(
        input_, pairs, ""
    )
