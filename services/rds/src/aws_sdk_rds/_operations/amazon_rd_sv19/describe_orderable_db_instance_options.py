"""Generated from Smithy shape ``com.amazonaws.rds#DescribeOrderableDBInstanceOptions``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.orderable_db_instance_options_message
...
) -> aws_sdk_rds.types.orderable_db_instance_options_message.OrderableDBInstanceOptionsMessage:
    import aws_sdk_rds.types.orderable_db_instance_options_message

    root = fromstring(response.read())
    result = root.find("DescribeOrderableDBInstanceOptionsResult")
    out: aws_sdk_rds.types.orderable_db_instance_options_message.OrderableDBInstanceOptionsMessage = aws_sdk_rds.types.orderable_db_instance_options_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_orderable_db_instance_options_message.DescribeOrderableDBInstanceOptionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
