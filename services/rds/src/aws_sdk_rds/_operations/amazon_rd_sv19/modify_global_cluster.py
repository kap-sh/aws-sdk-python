...
def build_request(
    ...
    input: aws_sdk_rds.types.modify_global_cluster_message.ModifyGlobalClusterMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.modify_global_cluster_message.serialize_query(input, pairs, "")
