...
if TYPE_CHECKING:
    import aws_sdk_rds.types.modify_global_cluster_message
    import aws_sdk_rds.types.modify_global_cluster_result
...
) -> aws_sdk_rds.types.modify_global_cluster_result.ModifyGlobalClusterResult:
    import aws_sdk_rds.types.modify_global_cluster_result

    root = fromstring(response.read())
    result = root.find("ModifyGlobalClusterResult")
    out: aws_sdk_rds.types.modify_global_cluster_result.ModifyGlobalClusterResult = (
        aws_sdk_rds.types.modify_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.modify_global_cluster_message.ModifyGlobalClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.modify_global_cluster_message.serialize_query(input_, pairs, "")
