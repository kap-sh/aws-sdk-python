...
def build_request(
    ...
    input_: aws_sdk_rds.types.apply_pending_maintenance_action_message.ApplyPendingMaintenanceActionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.apply_pending_maintenance_action_message.serialize_query(
        input_, pairs, ""
    )
