...
def build_request(
    ...
    input: aws_sdk_rds.types.switchover_read_replica_message.SwitchoverReadReplicaMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.switchover_read_replica_message.serialize_query(input, pairs, "")
