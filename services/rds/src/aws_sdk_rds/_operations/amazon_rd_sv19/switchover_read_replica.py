"""Generated from Smithy shape ``com.amazonaws.rds#SwitchoverReadReplica``."""
...
import aws_sdk_rds.types.switchover_read_replica_message
import aws_sdk_rds.types.switchover_read_replica_result
...
) -> aws_sdk_rds.types.switchover_read_replica_result.SwitchoverReadReplicaResult:
    root = fromstring(response.read())
    result = root.find("SwitchoverReadReplicaResult")
    out: aws_sdk_rds.types.switchover_read_replica_result.SwitchoverReadReplicaResult = aws_sdk_rds.types.switchover_read_replica_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.switchover_read_replica_message.SwitchoverReadReplicaMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "SwitchoverReadReplica"))
    pairs.append(("Version", "2014-10-31"))
    aws_sdk_rds.types.switchover_read_replica_message.serialize_query(input_, pairs, "")
...
async def async_switchover_read_replica(
