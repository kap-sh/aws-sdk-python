"""Generated from Smithy shape ``com.amazonaws.rds#ResetDBClusterParameterGroup``."""
...
import aws_sdk_rds.types.db_cluster_parameter_group_name_message
import aws_sdk_rds.types.parameters_list
import aws_sdk_rds.types.reset_db_cluster_parameter_group_message
...
) -> aws_sdk_rds.types.db_cluster_parameter_group_name_message.DBClusterParameterGroupNameMessage:
    root = fromstring(response.read())
    result = root.find("ResetDBClusterParameterGroupResult")
    out: aws_sdk_rds.types.db_cluster_parameter_group_name_message.DBClusterParameterGroupNameMessage = aws_sdk_rds.types.db_cluster_parameter_group_name_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.reset_db_cluster_parameter_group_message.ResetDBClusterParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ResetDBClusterParameterGroup"))
    pairs.append(("Version", "2014-10-31"))
    aws_sdk_rds.types.reset_db_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_reset_db_cluster_parameter_group(
