"""Generated from Smithy shape ``com.amazonaws.rds#DeleteGlobalCluster``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.delete_global_cluster_message
    import aws_sdk_rds.types.delete_global_cluster_result
...
) -> aws_sdk_rds.types.delete_global_cluster_result.DeleteGlobalClusterResult:
    import aws_sdk_rds.types.delete_global_cluster_result

    root = fromstring(response.read())
    result = root.find("DeleteGlobalClusterResult")
    out: aws_sdk_rds.types.delete_global_cluster_result.DeleteGlobalClusterResult = (
        aws_sdk_rds.types.delete_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.delete_global_cluster_message.DeleteGlobalClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.delete_global_cluster_message.serialize_query(input_, pairs, "")
