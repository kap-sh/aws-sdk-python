...
def build_request(
    ...
    input: aws_sdk_rds.types.modify_activity_stream_request.ModifyActivityStreamRequest,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.modify_activity_stream_request.serialize_query(input, pairs, "")
