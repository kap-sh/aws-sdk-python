...
if TYPE_CHECKING:
    import aws_sdk_rds.types.db_subnet_group_message
...
) -> aws_sdk_rds.types.db_subnet_group_message.DBSubnetGroupMessage:
    import aws_sdk_rds.types.db_subnet_group_message

    root = fromstring(response.read())
    result = root.find("DescribeDBSubnetGroupsResult")
    out: aws_sdk_rds.types.db_subnet_group_message.DBSubnetGroupMessage = (
        aws_sdk_rds.types.db_subnet_group_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_db_subnet_groups_message.DescribeDBSubnetGroupsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_db_subnet_groups(
    ...
    aws_sdk_rds.types.db_subnet_group_message.DBSubnetGroupMessage, zapros.Response
]:
