"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBClusterSnapshots``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.db_cluster_snapshot_message
    import aws_sdk_rds.types.describe_db_cluster_snapshots_message
...
) -> aws_sdk_rds.types.db_cluster_snapshot_message.DBClusterSnapshotMessage:
    import aws_sdk_rds.types.db_cluster_snapshot_message

    root = fromstring(response.read())
    result = root.find("DescribeDBClusterSnapshotsResult")
    out: aws_sdk_rds.types.db_cluster_snapshot_message.DBClusterSnapshotMessage = (
        aws_sdk_rds.types.db_cluster_snapshot_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_db_cluster_snapshots_message.DescribeDBClusterSnapshotsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.describe_db_cluster_snapshots_message.serialize_query(
        input_, pairs, ""
    )
