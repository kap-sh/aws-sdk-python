...
def build_request(
    ...
    input: aws_sdk_rds.types.describe_db_instances_message.DescribeDBInstancesMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.describe_db_instances_message.serialize_query(input, pairs, "")
