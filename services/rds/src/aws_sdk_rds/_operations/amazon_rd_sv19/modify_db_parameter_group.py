"""Generated from Smithy shape ``com.amazonaws.rds#ModifyDBParameterGroup``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.db_parameter_group_name_message
    import aws_sdk_rds.types.modify_db_parameter_group_message
...
) -> aws_sdk_rds.types.db_parameter_group_name_message.DBParameterGroupNameMessage:
    import aws_sdk_rds.types.db_parameter_group_name_message

    root = fromstring(response.read())
    result = root.find("ModifyDBParameterGroupResult")
    out: aws_sdk_rds.types.db_parameter_group_name_message.DBParameterGroupNameMessage = aws_sdk_rds.types.db_parameter_group_name_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.modify_db_parameter_group_message.ModifyDBParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyDBParameterGroup"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.modify_db_parameter_group_message

    aws_sdk_rds.types.modify_db_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_db_parameter_group(
