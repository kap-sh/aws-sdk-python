"""Generated from Smithy shape ``com.amazonaws.rds#ModifyDBProxy``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.modify_db_proxy_request
    import aws_sdk_rds.types.modify_db_proxy_response
...
) -> aws_sdk_rds.types.modify_db_proxy_response.ModifyDBProxyResponse:
    import aws_sdk_rds.types.modify_db_proxy_response

    root = fromstring(response.read())
    result = root.find("ModifyDBProxyResult")
    out: aws_sdk_rds.types.modify_db_proxy_response.ModifyDBProxyResponse = (
        aws_sdk_rds.types.modify_db_proxy_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.modify_db_proxy_request.ModifyDBProxyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyDBProxy"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.modify_db_proxy_request

    aws_sdk_rds.types.modify_db_proxy_request.serialize_query(input_, pairs, "")
...
def modify_db_proxy(
    ...
    aws_sdk_rds.types.modify_db_proxy_response.ModifyDBProxyResponse, zapros.Response
]:
...
async def async_modify_db_proxy(
