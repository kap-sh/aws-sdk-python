...
def build_request(
    ...
    input: aws_sdk_rds.types.modify_db_shard_group_message.ModifyDBShardGroupMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.modify_db_shard_group_message.serialize_query(input, pairs, "")
