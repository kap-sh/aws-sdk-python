...
if TYPE_CHECKING:
    import aws_sdk_rds.types.create_db_instance_message
    import aws_sdk_rds.types.create_db_instance_result
...
) -> aws_sdk_rds.types.create_db_instance_result.CreateDBInstanceResult:
    import aws_sdk_rds.types.create_db_instance_result

    root = fromstring(response.read())
    result = root.find("CreateDBInstanceResult")
    out: aws_sdk_rds.types.create_db_instance_result.CreateDBInstanceResult = (
        aws_sdk_rds.types.create_db_instance_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.create_db_instance_message.CreateDBInstanceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.create_db_instance_message.serialize_query(input_, pairs, "")
...
def create_db_instance(
    ...
    aws_sdk_rds.types.create_db_instance_result.CreateDBInstanceResult, zapros.Response
]:
