...
def build_request(
    ...
    input: aws_sdk_rds.types.start_activity_stream_request.StartActivityStreamRequest,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.start_activity_stream_request.serialize_query(input, pairs, "")
