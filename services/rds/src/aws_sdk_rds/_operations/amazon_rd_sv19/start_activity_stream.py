...
if TYPE_CHECKING:
    import aws_sdk_rds.types.start_activity_stream_request
    import aws_sdk_rds.types.start_activity_stream_response
...
) -> aws_sdk_rds.types.start_activity_stream_response.StartActivityStreamResponse:
    import aws_sdk_rds.types.start_activity_stream_response

    root = fromstring(response.read())
    result = root.find("StartActivityStreamResult")
    out: aws_sdk_rds.types.start_activity_stream_response.StartActivityStreamResponse = aws_sdk_rds.types.start_activity_stream_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.start_activity_stream_request.StartActivityStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.start_activity_stream_request.serialize_query(input_, pairs, "")
