...
def build_request(
    ...
    input_: aws_sdk_rds.types.modify_db_instance_message.ModifyDBInstanceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.modify_db_instance_message.serialize_query(input_, pairs, "")
...
def modify_db_instance(
    ...
    aws_sdk_rds.types.modify_db_instance_result.ModifyDBInstanceResult, zapros.Response
]:
