...
import aws_sdk_rds.types.connection_pool_configuration
import aws_sdk_rds.types.db_proxy_target_group
import aws_sdk_rds.types.modify_db_proxy_target_group_request
import aws_sdk_rds.types.modify_db_proxy_target_group_response
...
) -> aws_sdk_rds.types.modify_db_proxy_target_group_response.ModifyDBProxyTargetGroupResponse:
    root = fromstring(response.read())
    result = root.find("ModifyDBProxyTargetGroupResult")
    out: aws_sdk_rds.types.modify_db_proxy_target_group_response.ModifyDBProxyTargetGroupResponse = aws_sdk_rds.types.modify_db_proxy_target_group_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.modify_db_proxy_target_group_request.ModifyDBProxyTargetGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.modify_db_proxy_target_group_request.serialize_query(
        input_, pairs, ""
    )
