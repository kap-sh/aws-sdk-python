...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBClusterRoleNotFoundFault":
            import aws_sdk_rds.errors.db_cluster_role_not_found_fault

            raise aws_sdk_rds.errors.db_cluster_role_not_found_fault.DBClusterRoleNotFoundFault.from_query(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_rds.types.remove_role_from_db_cluster_message.RemoveRoleFromDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
