...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.delete_blue_green_deployment_response
...
) -> aws_sdk_rds.types.delete_blue_green_deployment_response.DeleteBlueGreenDeploymentResponse:
    import aws_sdk_rds.types.delete_blue_green_deployment_response

    root = fromstring(response.read())
    result = root.find("DeleteBlueGreenDeploymentResult")
    out: aws_sdk_rds.types.delete_blue_green_deployment_response.DeleteBlueGreenDeploymentResponse = aws_sdk_rds.types.delete_blue_green_deployment_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.delete_blue_green_deployment_request.DeleteBlueGreenDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
