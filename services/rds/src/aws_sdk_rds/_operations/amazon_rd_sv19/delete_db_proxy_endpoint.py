"""Generated from Smithy shape ``com.amazonaws.rds#DeleteDBProxyEndpoint``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.delete_db_proxy_endpoint_request
    import aws_sdk_rds.types.delete_db_proxy_endpoint_response
...
) -> aws_sdk_rds.types.delete_db_proxy_endpoint_response.DeleteDBProxyEndpointResponse:
    import aws_sdk_rds.types.delete_db_proxy_endpoint_response

    root = fromstring(response.read())
    result = root.find("DeleteDBProxyEndpointResult")
    out: aws_sdk_rds.types.delete_db_proxy_endpoint_response.DeleteDBProxyEndpointResponse = aws_sdk_rds.types.delete_db_proxy_endpoint_response.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_rds.types.delete_db_proxy_endpoint_request.DeleteDBProxyEndpointRequest,
) -> zapros.Request:
    ...
    pairs.append(("Action", "DeleteDBProxyEndpoint"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.delete_db_proxy_endpoint_request

    aws_sdk_rds.types.delete_db_proxy_endpoint_request.serialize_query(input, pairs, "")
...
async def async_delete_db_proxy_endpoint(
