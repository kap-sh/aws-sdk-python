...
def build_request(
    ...
    input_: aws_sdk_rds.types.delete_db_proxy_endpoint_request.DeleteDBProxyEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.delete_db_proxy_endpoint_request.serialize_query(
        input_, pairs, ""
    )
