"""Generated from Smithy shape ``com.amazonaws.rds#PromoteReadReplica``."""
...
import aws_sdk_rds.types.promote_read_replica_message
import aws_sdk_rds.types.promote_read_replica_result
...
) -> aws_sdk_rds.types.promote_read_replica_result.PromoteReadReplicaResult:
    root = fromstring(response.read())
    result = root.find("PromoteReadReplicaResult")
    out: aws_sdk_rds.types.promote_read_replica_result.PromoteReadReplicaResult = (
        aws_sdk_rds.types.promote_read_replica_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.promote_read_replica_message.PromoteReadReplicaMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "PromoteReadReplica"))
    pairs.append(("Version", "2014-10-31"))
    aws_sdk_rds.types.promote_read_replica_message.serialize_query(input_, pairs, "")
...
async def async_promote_read_replica(
