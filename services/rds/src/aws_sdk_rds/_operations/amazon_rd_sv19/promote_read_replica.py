...
def build_request(
    ...
    input: aws_sdk_rds.types.promote_read_replica_message.PromoteReadReplicaMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.promote_read_replica_message.serialize_query(input, pairs, "")
