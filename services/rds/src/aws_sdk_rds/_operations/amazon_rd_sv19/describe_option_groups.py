...
def build_request(
    ...
    input: aws_sdk_rds.types.describe_option_groups_message.DescribeOptionGroupsMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.describe_option_groups_message.serialize_query(input, pairs, "")
