"""Generated from Smithy shape ``com.amazonaws.rds#DescribeOptionGroups``."""
...
import aws_sdk_rds.types.describe_option_groups_message
import aws_sdk_rds.types.filter_list
import aws_sdk_rds.types.option_groups
...
) -> aws_sdk_rds.types.option_groups.OptionGroups:
    root = fromstring(response.read())
    result = root.find("DescribeOptionGroupsResult")
    out: aws_sdk_rds.types.option_groups.OptionGroups = (
        aws_sdk_rds.types.option_groups.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_option_groups_message.DescribeOptionGroupsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeOptionGroups"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.describe_option_groups_message

    aws_sdk_rds.types.describe_option_groups_message.serialize_query(input_, pairs, "")
...
def describe_option_groups(
    ...
    input_: aws_sdk_rds.types.describe_option_groups_message.DescribeOptionGroupsMessage,
) -> tuple[aws_sdk_rds.types.option_groups.OptionGroups, zapros.Response]:
...
async def async_describe_option_groups(
