"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBSnapshotTenantDatabases``."""
...
import aws_sdk_rds.types.db_snapshot_tenant_databases_message
import aws_sdk_rds.types.describe_db_snapshot_tenant_databases_message
...
) -> aws_sdk_rds.types.db_snapshot_tenant_databases_message.DBSnapshotTenantDatabasesMessage:
    root = fromstring(response.read())
    result = root.find("DescribeDBSnapshotTenantDatabasesResult")
    out: aws_sdk_rds.types.db_snapshot_tenant_databases_message.DBSnapshotTenantDatabasesMessage = aws_sdk_rds.types.db_snapshot_tenant_databases_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_db_snapshot_tenant_databases_message.DescribeDBSnapshotTenantDatabasesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeDBSnapshotTenantDatabases"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.describe_db_snapshot_tenant_databases_message

    aws_sdk_rds.types.describe_db_snapshot_tenant_databases_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_db_snapshot_tenant_databases(
