...
if TYPE_CHECKING:
    import aws_sdk_rds.types.switchover_global_cluster_message
    import aws_sdk_rds.types.switchover_global_cluster_result
...
) -> aws_sdk_rds.types.switchover_global_cluster_result.SwitchoverGlobalClusterResult:
    import aws_sdk_rds.types.switchover_global_cluster_result

    root = fromstring(response.read())
    result = root.find("SwitchoverGlobalClusterResult")
    out: aws_sdk_rds.types.switchover_global_cluster_result.SwitchoverGlobalClusterResult = aws_sdk_rds.types.switchover_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.switchover_global_cluster_message.SwitchoverGlobalClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.switchover_global_cluster_message.serialize_query(
        input_, pairs, ""
    )
