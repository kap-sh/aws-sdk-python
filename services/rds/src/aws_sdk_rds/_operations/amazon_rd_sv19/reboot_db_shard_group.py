"""Generated from Smithy shape ``com.amazonaws.rds#RebootDBShardGroup``."""
...
import aws_sdk_rds.types.reboot_db_shard_group_message
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("RebootDBShardGroupResult")
...
def build_request(
    ...
    input_: aws_sdk_rds.types.reboot_db_shard_group_message.RebootDBShardGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RebootDBShardGroup"))
    pairs.append(("Version", "2014-10-31"))
    aws_sdk_rds.types.reboot_db_shard_group_message.serialize_query(input_, pairs, "")
...
async def async_reboot_db_shard_group(
