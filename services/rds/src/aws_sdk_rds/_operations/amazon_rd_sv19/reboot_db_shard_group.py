...
def build_request(
    ...
    input: aws_sdk_rds.types.reboot_db_shard_group_message.RebootDBShardGroupMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.reboot_db_shard_group_message.serialize_query(input, pairs, "")
