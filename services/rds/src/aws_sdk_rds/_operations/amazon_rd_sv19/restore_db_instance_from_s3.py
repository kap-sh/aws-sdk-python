"""Generated from Smithy shape ``com.amazonaws.rds#RestoreDBInstanceFromS3``."""
...
import aws_sdk_rds.types.restore_db_instance_from_s3_message
import aws_sdk_rds.types.restore_db_instance_from_s3_result
...
) -> aws_sdk_rds.types.restore_db_instance_from_s3_result.RestoreDBInstanceFromS3Result:
    root = fromstring(response.read())
    result = root.find("RestoreDBInstanceFromS3Result")
    out: aws_sdk_rds.types.restore_db_instance_from_s3_result.RestoreDBInstanceFromS3Result = aws_sdk_rds.types.restore_db_instance_from_s3_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.restore_db_instance_from_s3_message.RestoreDBInstanceFromS3Message,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.restore_db_instance_from_s3_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_restore_db_instance_from_s3(
