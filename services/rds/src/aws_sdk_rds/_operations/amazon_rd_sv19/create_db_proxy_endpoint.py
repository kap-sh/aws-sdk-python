...
def build_request(
    ...
    input_: aws_sdk_rds.types.create_db_proxy_endpoint_request.CreateDBProxyEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.create_db_proxy_endpoint_request.serialize_query(
        input_, pairs, ""
    )
