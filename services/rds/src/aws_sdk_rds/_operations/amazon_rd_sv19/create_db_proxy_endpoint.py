"""Generated from Smithy shape ``com.amazonaws.rds#CreateDBProxyEndpoint``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.create_db_proxy_endpoint_request
    import aws_sdk_rds.types.create_db_proxy_endpoint_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBProxyEndpointQuotaExceededFault":
            import aws_sdk_rds.errors.db_proxy_endpoint_quota_exceeded_fault

            raise aws_sdk_rds.errors.db_proxy_endpoint_quota_exceeded_fault.DBProxyEndpointQuotaExceededFault.from_query(
                root
            )
...
) -> aws_sdk_rds.types.create_db_proxy_endpoint_response.CreateDBProxyEndpointResponse:
    import aws_sdk_rds.types.create_db_proxy_endpoint_response

    root = fromstring(response.read())
    result = root.find("CreateDBProxyEndpointResult")
    out: aws_sdk_rds.types.create_db_proxy_endpoint_response.CreateDBProxyEndpointResponse = aws_sdk_rds.types.create_db_proxy_endpoint_response.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_rds.types.create_db_proxy_endpoint_request.CreateDBProxyEndpointRequest,
) -> zapros.Request:
    ...
    pairs.append(("Action", "CreateDBProxyEndpoint"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.create_db_proxy_endpoint_request

    aws_sdk_rds.types.create_db_proxy_endpoint_request.serialize_query(input, pairs, "")
...
async def async_create_db_proxy_endpoint(
