"""Generated from Smithy shape ``com.amazonaws.rds#RemoveRoleFromDBInstance``."""
...
import aws_sdk_rds.errors.db_instance_role_not_found_fault
import aws_sdk_rds.errors.invalid_db_instance_state_fault
import aws_sdk_rds.types.remove_role_from_db_instance_message
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBInstanceRoleNotFoundFault":
            raise aws_sdk_rds.errors.db_instance_role_not_found_fault.DBInstanceRoleNotFoundFault.from_query(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_rds.types.remove_role_from_db_instance_message.RemoveRoleFromDBInstanceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RemoveRoleFromDBInstance"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.remove_role_from_db_instance_message

    aws_sdk_rds.types.remove_role_from_db_instance_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_remove_role_from_db_instance(
