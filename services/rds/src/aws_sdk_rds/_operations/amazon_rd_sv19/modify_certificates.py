"""Generated from Smithy shape ``com.amazonaws.rds#ModifyCertificates``."""
...
import aws_sdk_rds.types.modify_certificates_message
import aws_sdk_rds.types.modify_certificates_result
...
) -> aws_sdk_rds.types.modify_certificates_result.ModifyCertificatesResult:
    root = fromstring(response.read())
    result = root.find("ModifyCertificatesResult")
    out: aws_sdk_rds.types.modify_certificates_result.ModifyCertificatesResult = (
        aws_sdk_rds.types.modify_certificates_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.modify_certificates_message.ModifyCertificatesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyCertificates"))
    pairs.append(("Version", "2014-10-31"))
    aws_sdk_rds.types.modify_certificates_message.serialize_query(input_, pairs, "")
...
async def async_modify_certificates(
