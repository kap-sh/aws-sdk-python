...
def build_request(
    ...
    input: aws_sdk_rds.types.modify_certificates_message.ModifyCertificatesMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.modify_certificates_message.serialize_query(input, pairs, "")
