"""Generated from Smithy shape ``com.amazonaws.rds#StopDBInstance``."""
...
import aws_sdk_rds.types.stop_db_instance_message
import aws_sdk_rds.types.stop_db_instance_result
...
) -> aws_sdk_rds.types.stop_db_instance_result.StopDBInstanceResult:
    root = fromstring(response.read())
    result = root.find("StopDBInstanceResult")
    out: aws_sdk_rds.types.stop_db_instance_result.StopDBInstanceResult = (
        aws_sdk_rds.types.stop_db_instance_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.stop_db_instance_message.StopDBInstanceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "StopDBInstance"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.stop_db_instance_message

    aws_sdk_rds.types.stop_db_instance_message.serialize_query(input_, pairs, "")
...
def stop_db_instance(
    ...
    aws_sdk_rds.types.stop_db_instance_result.StopDBInstanceResult, zapros.Response
]:
...
async def async_stop_db_instance(
