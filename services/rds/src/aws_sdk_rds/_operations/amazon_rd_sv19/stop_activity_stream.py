...
if TYPE_CHECKING:
    import aws_sdk_rds.types.stop_activity_stream_request
    import aws_sdk_rds.types.stop_activity_stream_response
...
) -> aws_sdk_rds.types.stop_activity_stream_response.StopActivityStreamResponse:
    import aws_sdk_rds.types.stop_activity_stream_response

    root = fromstring(response.read())
    result = root.find("StopActivityStreamResult")
    out: aws_sdk_rds.types.stop_activity_stream_response.StopActivityStreamResponse = (
        aws_sdk_rds.types.stop_activity_stream_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.stop_activity_stream_request.StopActivityStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.stop_activity_stream_request.serialize_query(input_, pairs, "")
