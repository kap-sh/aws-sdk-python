...
def build_request(
    ...
    input: aws_sdk_rds.types.stop_activity_stream_request.StopActivityStreamRequest,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.stop_activity_stream_request.serialize_query(input, pairs, "")
