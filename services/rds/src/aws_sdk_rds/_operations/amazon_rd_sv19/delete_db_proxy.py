"""Generated from Smithy shape ``com.amazonaws.rds#DeleteDBProxy``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.delete_db_proxy_request
    import aws_sdk_rds.types.delete_db_proxy_response
...
) -> aws_sdk_rds.types.delete_db_proxy_response.DeleteDBProxyResponse:
    import aws_sdk_rds.types.delete_db_proxy_response

    root = fromstring(response.read())
    result = root.find("DeleteDBProxyResult")
    out: aws_sdk_rds.types.delete_db_proxy_response.DeleteDBProxyResponse = (
        aws_sdk_rds.types.delete_db_proxy_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.delete_db_proxy_request.DeleteDBProxyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteDBProxy"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.delete_db_proxy_request

    aws_sdk_rds.types.delete_db_proxy_request.serialize_query(input_, pairs, "")
...
def delete_db_proxy(
    ...
    aws_sdk_rds.types.delete_db_proxy_response.DeleteDBProxyResponse, zapros.Response
]:
...
async def async_delete_db_proxy(
