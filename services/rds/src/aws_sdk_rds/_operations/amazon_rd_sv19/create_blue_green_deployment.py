...
def build_request(
    ...
    input_: aws_sdk_rds.types.create_blue_green_deployment_request.CreateBlueGreenDeploymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.create_blue_green_deployment_request.serialize_query(
        input_, pairs, ""
    )
