...
def build_request(
    ...
    input_: aws_sdk_rds.types.modify_option_group_message.ModifyOptionGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.modify_option_group_message.serialize_query(input_, pairs, "")
