"""Generated from Smithy shape ``com.amazonaws.rds#CopyDBClusterSnapshot``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.copy_db_cluster_snapshot_message
    import aws_sdk_rds.types.copy_db_cluster_snapshot_result
...
) -> aws_sdk_rds.types.copy_db_cluster_snapshot_result.CopyDBClusterSnapshotResult:
    import aws_sdk_rds.types.copy_db_cluster_snapshot_result

    root = fromstring(response.read())
    result = root.find("CopyDBClusterSnapshotResult")
    out: aws_sdk_rds.types.copy_db_cluster_snapshot_result.CopyDBClusterSnapshotResult = aws_sdk_rds.types.copy_db_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_rds.types.copy_db_cluster_snapshot_message.CopyDBClusterSnapshotMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.copy_db_cluster_snapshot_message.serialize_query(input, pairs, "")
