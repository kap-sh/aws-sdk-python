...
def build_request(
    ...
    input_: aws_sdk_rds.types.copy_db_cluster_snapshot_message.CopyDBClusterSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.copy_db_cluster_snapshot_message.serialize_query(
        input_, pairs, ""
    )
