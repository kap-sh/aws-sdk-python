...
def build_request(
    ...
    input: aws_sdk_rds.types.describe_db_parameters_message.DescribeDBParametersMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.describe_db_parameters_message.serialize_query(input, pairs, "")
