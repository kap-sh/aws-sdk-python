"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBParameters``."""
...
import aws_sdk_rds.types.db_parameter_group_details
import aws_sdk_rds.types.describe_db_parameters_message
...
) -> aws_sdk_rds.types.db_parameter_group_details.DBParameterGroupDetails:
    root = fromstring(response.read())
    result = root.find("DescribeDBParametersResult")
    out: aws_sdk_rds.types.db_parameter_group_details.DBParameterGroupDetails = (
        aws_sdk_rds.types.db_parameter_group_details.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_db_parameters_message.DescribeDBParametersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeDBParameters"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.describe_db_parameters_message

    aws_sdk_rds.types.describe_db_parameters_message.serialize_query(input_, pairs, "")
...
async def async_describe_db_parameters(
