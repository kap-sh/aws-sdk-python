...
import aws_sdk_rds.types.describe_db_proxies_request
import aws_sdk_rds.types.describe_db_proxies_response
...
) -> aws_sdk_rds.types.describe_db_proxies_response.DescribeDBProxiesResponse:
    root = fromstring(response.read())
    result = root.find("DescribeDBProxiesResult")
    out: aws_sdk_rds.types.describe_db_proxies_response.DescribeDBProxiesResponse = (
        aws_sdk_rds.types.describe_db_proxies_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_db_proxies_request.DescribeDBProxiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.describe_db_proxies_request.serialize_query(input_, pairs, "")
