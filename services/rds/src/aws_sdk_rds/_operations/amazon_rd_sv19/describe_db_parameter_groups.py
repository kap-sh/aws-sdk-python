...
import aws_sdk_rds.types.db_parameter_group_list
import aws_sdk_rds.types.db_parameter_groups_message
import aws_sdk_rds.types.describe_db_parameter_groups_message
...
) -> aws_sdk_rds.types.db_parameter_groups_message.DBParameterGroupsMessage:
    root = fromstring(response.read())
    result = root.find("DescribeDBParameterGroupsResult")
    out: aws_sdk_rds.types.db_parameter_groups_message.DBParameterGroupsMessage = (
        aws_sdk_rds.types.db_parameter_groups_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_db_parameter_groups_message.DescribeDBParameterGroupsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.describe_db_parameter_groups_message.serialize_query(
        input_, pairs, ""
    )
