...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_db_shard_groups_message.DescribeDBShardGroupsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.describe_db_shard_groups_message.serialize_query(
        input_, pairs, ""
    )
