"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBShardGroups``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.describe_db_shard_groups_message
    import aws_sdk_rds.types.describe_db_shard_groups_response
...
) -> aws_sdk_rds.types.describe_db_shard_groups_response.DescribeDBShardGroupsResponse:
    import aws_sdk_rds.types.describe_db_shard_groups_response

    root = fromstring(response.read())
    result = root.find("DescribeDBShardGroupsResult")
    out: aws_sdk_rds.types.describe_db_shard_groups_response.DescribeDBShardGroupsResponse = aws_sdk_rds.types.describe_db_shard_groups_response.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_rds.types.describe_db_shard_groups_message.DescribeDBShardGroupsMessage,
) -> zapros.Request:
    ...
    pairs.append(("Action", "DescribeDBShardGroups"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.describe_db_shard_groups_message

    aws_sdk_rds.types.describe_db_shard_groups_message.serialize_query(input, pairs, "")
...
async def async_describe_db_shard_groups(
