"""Generated from Smithy shape ``com.amazonaws.rds#DeleteOptionGroup``."""
...
import aws_sdk_rds.types.delete_option_group_message
...
def build_request(
    ...
    input_: aws_sdk_rds.types.delete_option_group_message.DeleteOptionGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteOptionGroup"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.delete_option_group_message

    aws_sdk_rds.types.delete_option_group_message.serialize_query(input_, pairs, "")
...
async def async_delete_option_group(
