"""Generated from Smithy shape ``com.amazonaws.rds#DescribeIntegrations``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.describe_integrations_response
...
) -> aws_sdk_rds.types.describe_integrations_response.DescribeIntegrationsResponse:
    import aws_sdk_rds.types.describe_integrations_response

    root = fromstring(response.read())
    result = root.find("DescribeIntegrationsResult")
    out: aws_sdk_rds.types.describe_integrations_response.DescribeIntegrationsResponse = aws_sdk_rds.types.describe_integrations_response.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_rds.types.describe_integrations_message.DescribeIntegrationsMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.describe_integrations_message.serialize_query(input, pairs, "")
