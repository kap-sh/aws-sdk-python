"""Generated from Smithy shape ``com.amazonaws.rds#RevokeDBSecurityGroupIngress``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.revoke_db_security_group_ingress_message
    import aws_sdk_rds.types.revoke_db_security_group_ingress_result
...
) -> aws_sdk_rds.types.revoke_db_security_group_ingress_result.RevokeDBSecurityGroupIngressResult:
    import aws_sdk_rds.types.revoke_db_security_group_ingress_result

    root = fromstring(response.read())
    result = root.find("RevokeDBSecurityGroupIngressResult")
    out: aws_sdk_rds.types.revoke_db_security_group_ingress_result.RevokeDBSecurityGroupIngressResult = aws_sdk_rds.types.revoke_db_security_group_ingress_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.revoke_db_security_group_ingress_message.RevokeDBSecurityGroupIngressMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RevokeDBSecurityGroupIngress"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.revoke_db_security_group_ingress_message

    aws_sdk_rds.types.revoke_db_security_group_ingress_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_revoke_db_security_group_ingress(
