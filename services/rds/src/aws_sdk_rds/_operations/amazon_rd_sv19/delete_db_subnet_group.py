"""Generated from Smithy shape ``com.amazonaws.rds#DeleteDBSubnetGroup``."""
...
import aws_sdk_rds.errors.invalid_db_subnet_state_fault
import aws_sdk_rds.types.delete_db_subnet_group_message
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDBSubnetStateFault":
            raise aws_sdk_rds.errors.invalid_db_subnet_state_fault.InvalidDBSubnetStateFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_rds.types.delete_db_subnet_group_message.DeleteDBSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.delete_db_subnet_group_message.serialize_query(input_, pairs, "")
