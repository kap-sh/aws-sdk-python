...
def build_request(
    ...
    input: aws_sdk_rds.types.delete_db_subnet_group_message.DeleteDBSubnetGroupMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.delete_db_subnet_group_message.serialize_query(input, pairs, "")
