"""Generated from Smithy shape ``com.amazonaws.rds#DescribeEvents``."""
...
import aws_sdk_rds.types.describe_events_message
import aws_sdk_rds.types.event_categories_list
import aws_sdk_rds.types.event_list
import aws_sdk_rds.types.events_message
import aws_sdk_rds.types.filter_list
import aws_sdk_rds.types.source_type
...
) -> aws_sdk_rds.types.events_message.EventsMessage:
    root = fromstring(response.read())
    result = root.find("DescribeEventsResult")
    out: aws_sdk_rds.types.events_message.EventsMessage = (
        aws_sdk_rds.types.events_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_events_message.DescribeEventsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeEvents"))
    pairs.append(("Version", "2014-10-31"))
    aws_sdk_rds.types.describe_events_message.serialize_query(input_, pairs, "")
...
def describe_events(
    ...
    input_: aws_sdk_rds.types.describe_events_message.DescribeEventsMessage,
) -> tuple[aws_sdk_rds.types.events_message.EventsMessage, zapros.Response]:
