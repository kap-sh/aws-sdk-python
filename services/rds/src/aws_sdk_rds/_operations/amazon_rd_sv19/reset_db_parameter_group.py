...
def build_request(
    ...
    input_: aws_sdk_rds.types.reset_db_parameter_group_message.ResetDBParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.reset_db_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
