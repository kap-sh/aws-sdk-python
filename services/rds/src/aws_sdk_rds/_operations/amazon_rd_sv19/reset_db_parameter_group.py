...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.reset_db_parameter_group_message
...
def build_request(
    ...
    input: aws_sdk_rds.types.reset_db_parameter_group_message.ResetDBParameterGroupMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.reset_db_parameter_group_message.serialize_query(input, pairs, "")
