"""Generated from Smithy shape ``com.amazonaws.rds#ModifyCustomDBEngineVersion``."""
...
def build_request(
    ...
    input_: aws_sdk_rds.types.modify_custom_db_engine_version_message.ModifyCustomDBEngineVersionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyCustomDBEngineVersion"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.modify_custom_db_engine_version_message

    aws_sdk_rds.types.modify_custom_db_engine_version_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_custom_db_engine_version(
