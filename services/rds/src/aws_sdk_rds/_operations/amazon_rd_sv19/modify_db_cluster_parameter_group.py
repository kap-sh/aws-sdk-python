"""Generated from Smithy shape ``com.amazonaws.rds#ModifyDBClusterParameterGroup``."""
...
import aws_sdk_rds.types.modify_db_cluster_parameter_group_message
...
def build_request(
    ...
    input_: aws_sdk_rds.types.modify_db_cluster_parameter_group_message.ModifyDBClusterParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.modify_db_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
