...
import aws_sdk_rds.types.serverless_v2_platform_versions_message
...
) -> aws_sdk_rds.types.serverless_v2_platform_versions_message.ServerlessV2PlatformVersionsMessage:
    root = fromstring(response.read())
    result = root.find("DescribeServerlessV2PlatformVersionsResult")
    out: aws_sdk_rds.types.serverless_v2_platform_versions_message.ServerlessV2PlatformVersionsMessage = aws_sdk_rds.types.serverless_v2_platform_versions_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_serverless_v2_platform_versions_message.DescribeServerlessV2PlatformVersionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
