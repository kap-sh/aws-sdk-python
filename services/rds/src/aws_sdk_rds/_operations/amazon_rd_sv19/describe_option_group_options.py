"""Generated from Smithy shape ``com.amazonaws.rds#DescribeOptionGroupOptions``."""
...
import aws_sdk_rds.types.option_group_options_message
...
) -> aws_sdk_rds.types.option_group_options_message.OptionGroupOptionsMessage:
    root = fromstring(response.read())
    result = root.find("DescribeOptionGroupOptionsResult")
    out: aws_sdk_rds.types.option_group_options_message.OptionGroupOptionsMessage = (
        aws_sdk_rds.types.option_group_options_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_option_group_options_message.DescribeOptionGroupOptionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_option_group_options(
