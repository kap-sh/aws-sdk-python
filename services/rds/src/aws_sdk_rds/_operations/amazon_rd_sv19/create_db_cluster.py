...
def build_request(
    ...
    input_: aws_sdk_rds.types.create_db_cluster_message.CreateDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.create_db_cluster_message.serialize_query(input_, pairs, "")
...
def create_db_cluster(
    ...
    aws_sdk_rds.types.create_db_cluster_result.CreateDBClusterResult, zapros.Response
]:
