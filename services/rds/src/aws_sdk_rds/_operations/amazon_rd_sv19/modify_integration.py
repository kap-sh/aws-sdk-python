"""Generated from Smithy shape ``com.amazonaws.rds#ModifyIntegration``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.modify_integration_message
...
def build_request(
    ...
    input_: aws_sdk_rds.types.modify_integration_message.ModifyIntegrationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.modify_integration_message.serialize_query(input_, pairs, "")
