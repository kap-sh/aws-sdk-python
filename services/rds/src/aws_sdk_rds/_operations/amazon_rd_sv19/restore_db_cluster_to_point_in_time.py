...
if TYPE_CHECKING:
    import aws_sdk_rds.types.restore_db_cluster_to_point_in_time_message
    import aws_sdk_rds.types.restore_db_cluster_to_point_in_time_result
...
) -> aws_sdk_rds.types.restore_db_cluster_to_point_in_time_result.RestoreDBClusterToPointInTimeResult:
    import aws_sdk_rds.types.restore_db_cluster_to_point_in_time_result

    root = fromstring(response.read())
    result = root.find("RestoreDBClusterToPointInTimeResult")
    out: aws_sdk_rds.types.restore_db_cluster_to_point_in_time_result.RestoreDBClusterToPointInTimeResult = aws_sdk_rds.types.restore_db_cluster_to_point_in_time_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.restore_db_cluster_to_point_in_time_message.RestoreDBClusterToPointInTimeMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.restore_db_cluster_to_point_in_time_message.serialize_query(
        input_, pairs, ""
    )
