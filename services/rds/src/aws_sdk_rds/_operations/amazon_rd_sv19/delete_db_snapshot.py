"""Generated from Smithy shape ``com.amazonaws.rds#DeleteDBSnapshot``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.delete_db_snapshot_message
    import aws_sdk_rds.types.delete_db_snapshot_result
...
) -> aws_sdk_rds.types.delete_db_snapshot_result.DeleteDBSnapshotResult:
    import aws_sdk_rds.types.delete_db_snapshot_result

    root = fromstring(response.read())
    result = root.find("DeleteDBSnapshotResult")
    out: aws_sdk_rds.types.delete_db_snapshot_result.DeleteDBSnapshotResult = (
        aws_sdk_rds.types.delete_db_snapshot_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.delete_db_snapshot_message.DeleteDBSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteDBSnapshot"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.delete_db_snapshot_message

    aws_sdk_rds.types.delete_db_snapshot_message.serialize_query(input_, pairs, "")
...
def delete_db_snapshot(
    ...
    aws_sdk_rds.types.delete_db_snapshot_result.DeleteDBSnapshotResult, zapros.Response
]:
...
async def async_delete_db_snapshot(
