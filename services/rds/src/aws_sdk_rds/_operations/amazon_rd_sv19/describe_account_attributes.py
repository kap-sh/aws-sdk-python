...
if TYPE_CHECKING:
    import aws_sdk_rds.types.account_attributes_message
    import aws_sdk_rds.types.describe_account_attributes_message
...
def handle_response(
    ...
    out: aws_sdk_rds.types.account_attributes_message.AccountAttributesMessage = (
        aws_sdk_rds.types.account_attributes_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_account_attributes_message.DescribeAccountAttributesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.describe_account_attributes_message.serialize_query(
        input_, pairs, ""
    )
