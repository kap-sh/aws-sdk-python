...
def build_request(
    ...
    input_: aws_sdk_rds.types.reboot_db_instance_message.RebootDBInstanceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.reboot_db_instance_message.serialize_query(input_, pairs, "")
...
def reboot_db_instance(
    ...
    aws_sdk_rds.types.reboot_db_instance_result.RebootDBInstanceResult, zapros.Response
]:
