...
def build_request(
    ...
    input: aws_sdk_rds.types.list_tags_for_resource_message.ListTagsForResourceMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.list_tags_for_resource_message.serialize_query(input, pairs, "")
