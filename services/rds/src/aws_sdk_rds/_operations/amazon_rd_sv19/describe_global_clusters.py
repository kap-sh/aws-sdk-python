...
if TYPE_CHECKING:
    import aws_sdk_rds.types.describe_global_clusters_message
    import aws_sdk_rds.types.global_clusters_message
...
) -> aws_sdk_rds.types.global_clusters_message.GlobalClustersMessage:
    import aws_sdk_rds.types.global_clusters_message

    root = fromstring(response.read())
    result = root.find("DescribeGlobalClustersResult")
    out: aws_sdk_rds.types.global_clusters_message.GlobalClustersMessage = (
        aws_sdk_rds.types.global_clusters_message.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_rds.types.describe_global_clusters_message.DescribeGlobalClustersMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.describe_global_clusters_message.serialize_query(input, pairs, "")
...
def describe_global_clusters(
    ...
    aws_sdk_rds.types.global_clusters_message.GlobalClustersMessage, zapros.Response
]:
