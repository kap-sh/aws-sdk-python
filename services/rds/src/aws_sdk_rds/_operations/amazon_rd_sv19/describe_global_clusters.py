...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_global_clusters_message.DescribeGlobalClustersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.describe_global_clusters_message.serialize_query(
        input_, pairs, ""
    )
