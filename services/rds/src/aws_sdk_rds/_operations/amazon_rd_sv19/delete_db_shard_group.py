...
import aws_sdk_rds.types.delete_db_shard_group_message
...
def build_request(
    ...
    input_: aws_sdk_rds.types.delete_db_shard_group_message.DeleteDBShardGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.delete_db_shard_group_message.serialize_query(input_, pairs, "")
