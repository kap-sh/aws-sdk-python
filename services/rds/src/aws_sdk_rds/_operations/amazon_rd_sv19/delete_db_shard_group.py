...
def build_request(
    ...
    input: aws_sdk_rds.types.delete_db_shard_group_message.DeleteDBShardGroupMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.delete_db_shard_group_message.serialize_query(input, pairs, "")
