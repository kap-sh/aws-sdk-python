"""Generated from Smithy shape ``com.amazonaws.rds#ModifyDBProxyEndpoint``."""
...
def build_request(
    ...
    input: aws_sdk_rds.types.modify_db_proxy_endpoint_request.ModifyDBProxyEndpointRequest,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.modify_db_proxy_endpoint_request.serialize_query(input, pairs, "")
...
async def async_modify_db_proxy_endpoint(
