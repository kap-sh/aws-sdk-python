"""Generated from Smithy shape ``com.amazonaws.rds#DeleteDBParameterGroup``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.delete_db_parameter_group_message
...
def build_request(
    ...
    input_: aws_sdk_rds.types.delete_db_parameter_group_message.DeleteDBParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.delete_db_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
