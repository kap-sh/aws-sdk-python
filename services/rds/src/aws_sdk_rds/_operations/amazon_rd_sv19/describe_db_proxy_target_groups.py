"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBProxyTargetGroups``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.describe_db_proxy_target_groups_request
    import aws_sdk_rds.types.describe_db_proxy_target_groups_response
...
) -> aws_sdk_rds.types.describe_db_proxy_target_groups_response.DescribeDBProxyTargetGroupsResponse:
    import aws_sdk_rds.types.describe_db_proxy_target_groups_response

    root = fromstring(response.read())
    result = root.find("DescribeDBProxyTargetGroupsResult")
    out: aws_sdk_rds.types.describe_db_proxy_target_groups_response.DescribeDBProxyTargetGroupsResponse = aws_sdk_rds.types.describe_db_proxy_target_groups_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_db_proxy_target_groups_request.DescribeDBProxyTargetGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeDBProxyTargetGroups"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.describe_db_proxy_target_groups_request

    aws_sdk_rds.types.describe_db_proxy_target_groups_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_db_proxy_target_groups(
