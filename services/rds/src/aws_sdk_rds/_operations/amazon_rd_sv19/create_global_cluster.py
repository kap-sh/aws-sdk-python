...
def build_request(
    ...
    input: aws_sdk_rds.types.create_global_cluster_message.CreateGlobalClusterMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.create_global_cluster_message.serialize_query(input, pairs, "")
