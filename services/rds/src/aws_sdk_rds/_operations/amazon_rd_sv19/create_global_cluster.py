"""Generated from Smithy shape ``com.amazonaws.rds#CreateGlobalCluster``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.create_global_cluster_message
    import aws_sdk_rds.types.create_global_cluster_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "GlobalClusterAlreadyExistsFault":
            import aws_sdk_rds.errors.global_cluster_already_exists_fault

            raise aws_sdk_rds.errors.global_cluster_already_exists_fault.GlobalClusterAlreadyExistsFault.from_query(
                root
            )
        case "GlobalClusterQuotaExceededFault":
            import aws_sdk_rds.errors.global_cluster_quota_exceeded_fault

            raise aws_sdk_rds.errors.global_cluster_quota_exceeded_fault.GlobalClusterQuotaExceededFault.from_query(
                root
            )
...
) -> aws_sdk_rds.types.create_global_cluster_result.CreateGlobalClusterResult:
    import aws_sdk_rds.types.create_global_cluster_result

    root = fromstring(response.read())
    result = root.find("CreateGlobalClusterResult")
    out: aws_sdk_rds.types.create_global_cluster_result.CreateGlobalClusterResult = (
        aws_sdk_rds.types.create_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.create_global_cluster_message.CreateGlobalClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateGlobalCluster"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_rds.types.create_global_cluster_message

    aws_sdk_rds.types.create_global_cluster_message.serialize_query(input_, pairs, "")
...
async def async_create_global_cluster(
