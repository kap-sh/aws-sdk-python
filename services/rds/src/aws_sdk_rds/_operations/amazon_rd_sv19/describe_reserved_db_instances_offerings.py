...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.reserved_db_instances_offering_message
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ReservedDBInstancesOfferingNotFoundFault":
            import aws_sdk_rds.errors.reserved_db_instances_offering_not_found_fault

            raise aws_sdk_rds.errors.reserved_db_instances_offering_not_found_fault.ReservedDBInstancesOfferingNotFoundFault.from_query(
                root
            )
        case _:
...
) -> aws_sdk_rds.types.reserved_db_instances_offering_message.ReservedDBInstancesOfferingMessage:
    import aws_sdk_rds.types.reserved_db_instances_offering_message

    root = fromstring(response.read())
    result = root.find("DescribeReservedDBInstancesOfferingsResult")
    out: aws_sdk_rds.types.reserved_db_instances_offering_message.ReservedDBInstancesOfferingMessage = aws_sdk_rds.types.reserved_db_instances_offering_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_reserved_db_instances_offerings_message.DescribeReservedDBInstancesOfferingsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
