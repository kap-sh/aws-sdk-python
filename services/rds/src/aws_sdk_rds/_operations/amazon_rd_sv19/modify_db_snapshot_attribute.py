"""Generated from Smithy shape ``com.amazonaws.rds#ModifyDBSnapshotAttribute``."""
...
import aws_sdk_rds.types.modify_db_snapshot_attribute_result
...
) -> aws_sdk_rds.types.modify_db_snapshot_attribute_result.ModifyDBSnapshotAttributeResult:
    root = fromstring(response.read())
    result = root.find("ModifyDBSnapshotAttributeResult")
    out: aws_sdk_rds.types.modify_db_snapshot_attribute_result.ModifyDBSnapshotAttributeResult = aws_sdk_rds.types.modify_db_snapshot_attribute_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.modify_db_snapshot_attribute_message.ModifyDBSnapshotAttributeMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_modify_db_snapshot_attribute(
