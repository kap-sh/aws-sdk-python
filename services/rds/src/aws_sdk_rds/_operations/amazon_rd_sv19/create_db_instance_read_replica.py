...
import aws_sdk_rds.errors.db_subnet_group_not_allowed_fault
...
import aws_sdk_rds.types.create_db_instance_read_replica_message
import aws_sdk_rds.types.create_db_instance_read_replica_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBSubnetGroupNotAllowedFault":
            raise aws_sdk_rds.errors.db_subnet_group_not_allowed_fault.DBSubnetGroupNotAllowedFault.from_query(
                root
            )
...
) -> aws_sdk_rds.types.create_db_instance_read_replica_result.CreateDBInstanceReadReplicaResult:
    root = fromstring(response.read())
    result = root.find("CreateDBInstanceReadReplicaResult")
    out: aws_sdk_rds.types.create_db_instance_read_replica_result.CreateDBInstanceReadReplicaResult = aws_sdk_rds.types.create_db_instance_read_replica_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.create_db_instance_read_replica_message.CreateDBInstanceReadReplicaMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.create_db_instance_read_replica_message.serialize_query(
        input_, pairs, ""
    )
