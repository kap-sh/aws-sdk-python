...
def build_request(
    ...
    input: aws_sdk_rds.types.describe_db_clusters_message.DescribeDBClustersMessage,
) -> zapros.Request:
    ...
    aws_sdk_rds.types.describe_db_clusters_message.serialize_query(input, pairs, "")
