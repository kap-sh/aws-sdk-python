"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBClusters``."""
...
import aws_sdk_rds.types.db_cluster_message
import aws_sdk_rds.types.describe_db_clusters_message
...
) -> aws_sdk_rds.types.db_cluster_message.DBClusterMessage:
    root = fromstring(response.read())
    result = root.find("DescribeDBClustersResult")
    out: aws_sdk_rds.types.db_cluster_message.DBClusterMessage = (
        aws_sdk_rds.types.db_cluster_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_rds.types.describe_db_clusters_message.DescribeDBClustersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_rds.types.describe_db_clusters_message.serialize_query(input_, pairs, "")
...
def describe_db_clusters(
    ...
    input_: aws_sdk_rds.types.describe_db_clusters_message.DescribeDBClustersMessage,
) -> tuple[aws_sdk_rds.types.db_cluster_message.DBClusterMessage, zapros.Response]:
...
async def async_describe_db_clusters(
