"""Generated from Smithy shape ``com.amazonaws.rds#DBParameterGroupAlreadyExistsFault``."""
...
class DBParameterGroupAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rds#DBParameterGroupAlreadyExistsFault``."""
