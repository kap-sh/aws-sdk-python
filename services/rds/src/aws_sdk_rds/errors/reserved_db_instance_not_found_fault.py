...
class ReservedDBInstanceNotFoundFault_(TypedDict):
...
class ReservedDBInstanceNotFoundFault(ServiceError):
    ...
    def __init__(self, data: ReservedDBInstanceNotFoundFault_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_query(cls, el: Element) -> "ReservedDBInstanceNotFoundFault":
