"""Generated from Smithy shape ``com.amazonaws.rds#SourceNotFoundFault``."""
...
class SourceNotFoundFault_(TypedDict):
...
class SourceNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rds#SourceNotFoundFault``."""
