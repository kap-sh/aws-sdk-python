...
class DBEngineVersion(TypedDict, closed=True):
    ...
    db_engine_version_arn: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>The ARN of the custom engine version.</p>"""
    db_engine_version_description: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>The description of the database engine version.</p>"""
    default_character_set: NotRequired["aws_sdk_rds.types.character_set.CharacterSet"]
    ...
    failure_reason: NotRequired["aws_sdk_rds.types.string.String"]
    ...
    image: NotRequired[
        "aws_sdk_rds.types.custom_db_engine_version_ami.CustomDBEngineVersionAMI"
    ]
    """<p>The EC2 image</p>"""
    db_engine_media_type: NotRequired["aws_sdk_rds.types.string.String"]
    ...
    supported_character_sets: NotRequired[
        "aws_sdk_rds.types.supported_character_sets_list.SupportedCharacterSetsList"
    ]
    ...
    valid_upgrade_target: NotRequired[
        "aws_sdk_rds.types.valid_upgrade_target_list.ValidUpgradeTargetList"
    ]
    """<p>A list of engine versions that this database engine version can be upgraded to.</p>"""
    supported_timezones: NotRequired[
        "aws_sdk_rds.types.supported_timezones_list.SupportedTimezonesList"
    ]
    ...
    exportable_log_types: NotRequired["aws_sdk_rds.types.log_type_list.LogTypeList"]
    ...
    supports_read_replica: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
    ...
    supported_feature_names: NotRequired[
        "aws_sdk_rds.types.feature_name_list.FeatureNameList"
    ]
    ...
    supports_parallel_query: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
    ...
    supports_babelfish: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
    """<p>Indicates whether the engine version supports Babelfish for Aurora PostgreSQL.</p>"""
    supports_limitless_database: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
    ...
    supports_integrations: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
...
def serialize_query(
    ...
    if "image" in value:
        ...
        aws_sdk_rds.types.custom_db_engine_version_ami.serialize_query(
    ...
    if "supported_character_sets" in value:
        ...
        aws_sdk_rds.types.supported_character_sets_list.serialize_query(
    ...
    if "valid_upgrade_target" in value:
        ...
        aws_sdk_rds.types.valid_upgrade_target_list.serialize_query(
            value["valid_upgrade_target"], pairs, f"{prefix}.ValidUpgradeTarget"
        )
    if "supported_timezones" in value:
        import aws_sdk_rds.types.supported_timezones_list

        aws_sdk_rds.types.supported_timezones_list.serialize_query(
    ...
    if "supported_feature_names" in value:
        ...
        aws_sdk_rds.types.feature_name_list.serialize_query(
    ...
    if "supported_ca_certificate_identifiers" in value:
        ...
        aws_sdk_rds.types.ca_certificate_identifiers_list.serialize_query(
...
def deserialize_query(el: Element) -> DBEngineVersion:
    ...
    if child_default_character_set is not None:
        ...
        out["default_character_set"] = (
            aws_sdk_rds.types.character_set.deserialize_query(
    ...
    if child_image is not None:
        ...
        out["image"] = aws_sdk_rds.types.custom_db_engine_version_ami.deserialize_query(
            child_image
        )
    ...
    if child_supported_character_sets is not None:
        ...
        out["supported_character_sets"] = (
            aws_sdk_rds.types.supported_character_sets_list.deserialize_query(
    ...
    if child_valid_upgrade_target is not None:
        ...
        out["valid_upgrade_target"] = (
            aws_sdk_rds.types.valid_upgrade_target_list.deserialize_query(
    ...
    if child_supported_timezones is not None:
        ...
        out["supported_timezones"] = (
            aws_sdk_rds.types.supported_timezones_list.deserialize_query(
    ...
    if child_exportable_log_types is not None:
        ...
        out["exportable_log_types"] = aws_sdk_rds.types.log_type_list.deserialize_query(
    ...
    if child_supported_feature_names is not None:
        ...
        out["supported_feature_names"] = (
            aws_sdk_rds.types.feature_name_list.deserialize_query(
    ...
    if child_supported_ca_certificate_identifiers is not None:
        ...
        out["supported_ca_certificate_identifiers"] = (
            aws_sdk_rds.types.ca_certificate_identifiers_list.deserialize_query(
