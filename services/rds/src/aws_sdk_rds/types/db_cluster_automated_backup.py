...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.restore_window
...
class DBClusterAutomatedBackup(TypedDict):
    ...
    db_cluster_automated_backups_arn: NotRequired["aws_sdk_rds.types.string.String"]
    ...
    restore_window: NotRequired["aws_sdk_rds.types.restore_window.RestoreWindow"]
    ...
    region: NotRequired["aws_sdk_rds.types.string.String"]
...
def serialize_query(
    ...
    if "restore_window" in value:
        ...
        aws_sdk_rds.types.restore_window.serialize_query(
...
def deserialize_query(el: Element) -> DBClusterAutomatedBackup:
    ...
    if child_restore_window is not None:
        ...
        out["restore_window"] = aws_sdk_rds.types.restore_window.deserialize_query(
