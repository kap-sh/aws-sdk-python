"""Generated from Smithy shape ``com.amazonaws.rds#DisableHttpEndpointResponse``."""
...
class DisableHttpEndpointResponse(TypedDict, closed=True):
    resource_arn: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>The ARN of the DB cluster.</p>"""
    http_endpoint_enabled: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
    """<p>Indicates whether the HTTP endpoint is enabled or disabled for the DB cluster.</p>"""


# --- awsQuery ser/de ---
def serialize_query(
    value: DisableHttpEndpointResponse, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DisableHttpEndpointResponse:
    out: DisableHttpEndpointResponse = {}  # type: ignore[typeddict-item]
