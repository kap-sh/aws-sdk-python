...
class DownloadDBLogFilePortionDetails(TypedDict):
    log_file_data: NotRequired["aws_sdk_rds.types.sensitive_string.SensitiveString"]
    ...
    additional_data_pending: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
