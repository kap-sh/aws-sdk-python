...
if TYPE_CHECKING:
    import aws_sdk_rds.types.minimum_engine_version_per_allowed_value

MinimumEngineVersionPerAllowedValueList: TypeAlias = list[
    "aws_sdk_rds.types.minimum_engine_version_per_allowed_value.MinimumEngineVersionPerAllowedValue"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_rds.types.minimum_engine_version_per_allowed_value.serialize_query(
...
def deserialize_query(el: Element) -> MinimumEngineVersionPerAllowedValueList:
    ...
    for child in el.findall("MinimumEngineVersionPerAllowedValue"):
        out.append(
            aws_sdk_rds.types.minimum_engine_version_per_allowed_value.deserialize_query(
                child
            )
        )
    return out
