"""Generated from Smithy shape ``com.amazonaws.rds#DBSubnetGroupMessage``."""
...
if TYPE_CHECKING:
    import aws_sdk_rds.types.db_subnet_groups
    import aws_sdk_rds.types.string


class DBSubnetGroupMessage(TypedDict):
    marker: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by <code>MaxRecords</code>.</p>"""
    db_subnet_groups: NotRequired["aws_sdk_rds.types.db_subnet_groups.DBSubnetGroups"]
...
def serialize_query(
    ...
    if "db_subnet_groups" in value:
        ...
        aws_sdk_rds.types.db_subnet_groups.serialize_query(
...
def deserialize_query(el: Element) -> DBSubnetGroupMessage:
    ...
    if child_db_subnet_groups is not None:
        ...
        out["db_subnet_groups"] = aws_sdk_rds.types.db_subnet_groups.deserialize_query(
