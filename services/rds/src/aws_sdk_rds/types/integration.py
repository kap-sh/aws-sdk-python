...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.integration_arn
...
class Integration(TypedDict, closed=True):
    ...
    integration_arn: NotRequired["aws_sdk_rds.types.integration_arn.IntegrationArn"]
    ...
    status: NotRequired["aws_sdk_rds.types.integration_status.IntegrationStatus"]
    ...
    errors: NotRequired["aws_sdk_rds.types.integration_error_list.IntegrationErrorList"]
...
def serialize_query(
    ...
    if "status" in value:
        ...
        aws_sdk_rds.types.integration_status.serialize_query(
    ...
    if "errors" in value:
        ...
        aws_sdk_rds.types.integration_error_list.serialize_query(
...
def deserialize_query(el: Element) -> Integration:
    ...
    if child_status is not None:
        ...
        out["status"] = aws_sdk_rds.types.integration_status.deserialize_query(
            child_status
        )
    ...
    if child_errors is not None:
        ...
        out["errors"] = aws_sdk_rds.types.integration_error_list.deserialize_query(
            child_errors
        )
    return out
