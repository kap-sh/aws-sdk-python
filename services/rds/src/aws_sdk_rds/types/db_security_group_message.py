...
def serialize_query(
    ...
    if "db_security_groups" in value:
        ...
        aws_sdk_rds.types.db_security_groups.serialize_query(
...
def deserialize_query(el: Element) -> DBSecurityGroupMessage:
    ...
    if child_db_security_groups is not None:
        ...
        out["db_security_groups"] = (
            aws_sdk_rds.types.db_security_groups.deserialize_query(
