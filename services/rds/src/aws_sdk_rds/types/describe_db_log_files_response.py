...
class DescribeDBLogFilesResponse(TypedDict):
    describe_db_log_files: NotRequired[
        "aws_sdk_rds.types.describe_db_log_files_list.DescribeDBLogFilesList"
    ]
...
def serialize_query(
    ...
    if "describe_db_log_files" in value:
        ...
        aws_sdk_rds.types.describe_db_log_files_list.serialize_query(
...
def deserialize_query(el: Element) -> DescribeDBLogFilesResponse:
    ...
    if child_describe_db_log_files is not None:
        ...
        out["describe_db_log_files"] = (
            aws_sdk_rds.types.describe_db_log_files_list.deserialize_query(
