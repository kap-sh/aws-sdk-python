...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.option_group_option_settings_list
    import aws_sdk_rds.types.option_group_option_versions_list
    import aws_sdk_rds.types.options_conflicts_with
    import aws_sdk_rds.types.options_depended_on
    import aws_sdk_rds.types.string


class OptionGroupOption(TypedDict):
    ...
    vpc_only: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
    ...
    option_group_option_settings: NotRequired[
        "aws_sdk_rds.types.option_group_option_settings_list.OptionGroupOptionSettingsList"
    ]
    ...
    option_group_option_versions: NotRequired[
        "aws_sdk_rds.types.option_group_option_versions_list.OptionGroupOptionVersionsList"
    ]
...
def serialize_query(
    ...
    if "options_depended_on" in value:
        ...
        aws_sdk_rds.types.options_depended_on.serialize_query(
            value["options_depended_on"], pairs, f"{prefix}.OptionsDependedOn"
        )
    if "options_conflicts_with" in value:
        import aws_sdk_rds.types.options_conflicts_with

        aws_sdk_rds.types.options_conflicts_with.serialize_query(
    ...
    if "option_group_option_settings" in value:
        ...
        aws_sdk_rds.types.option_group_option_settings_list.serialize_query(
    ...
    if "option_group_option_versions" in value:
        ...
        aws_sdk_rds.types.option_group_option_versions_list.serialize_query(
...
def deserialize_query(el: Element) -> OptionGroupOption:
    ...
    if child_options_depended_on is not None:
        ...
        out["options_depended_on"] = (
            aws_sdk_rds.types.options_depended_on.deserialize_query(
    ...
    if child_options_conflicts_with is not None:
        ...
        out["options_conflicts_with"] = (
            aws_sdk_rds.types.options_conflicts_with.deserialize_query(
    ...
    if child_option_group_option_settings is not None:
        ...
        out["option_group_option_settings"] = (
            aws_sdk_rds.types.option_group_option_settings_list.deserialize_query(
    ...
    if child_option_group_option_versions is not None:
        ...
        out["option_group_option_versions"] = (
            aws_sdk_rds.types.option_group_option_versions_list.deserialize_query(
