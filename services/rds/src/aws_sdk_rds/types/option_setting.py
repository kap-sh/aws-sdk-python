...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.potentially_sensitive_option_setting_value
    import aws_sdk_rds.types.string


class OptionSetting(TypedDict):
    name: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>The name of the option that has settings that you can set.</p>"""
    value: NotRequired[
        "aws_sdk_rds.types.potentially_sensitive_option_setting_value.PotentiallySensitiveOptionSettingValue"
    ]
    ...
    data_type: NotRequired["aws_sdk_rds.types.string.String"]
    ...
    is_collection: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
