...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.switchover_detail_status


class SwitchoverDetail(TypedDict):
    source_member: NotRequired["aws_sdk_rds.types.database_arn.DatabaseArn"]
    """<p>The Amazon Resource Name (ARN) of a resource in the blue environment.</p>"""
    target_member: NotRequired["aws_sdk_rds.types.database_arn.DatabaseArn"]
    """<p>The Amazon Resource Name (ARN) of a resource in the green environment.</p>"""
    status: NotRequired[
        "aws_sdk_rds.types.switchover_detail_status.SwitchoverDetailStatus"
    ]
