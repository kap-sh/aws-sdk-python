"""Generated from Smithy shape ``com.amazonaws.rds#DBClusterParameterGroup``."""
...
class DBClusterParameterGroup(TypedDict):
    ...
    db_cluster_parameter_group_arn: NotRequired["aws_sdk_rds.types.string.String"]
