...
if TYPE_CHECKING:
    import aws_sdk_rds.types.pending_maintenance_action_details
...
class ResourcePendingMaintenanceActions(TypedDict, closed=True):
    ...
    pending_maintenance_action_details: NotRequired[
        "aws_sdk_rds.types.pending_maintenance_action_details.PendingMaintenanceActionDetails"
    ]
...
def serialize_query(
    ...
    if "pending_maintenance_action_details" in value:
        ...
        aws_sdk_rds.types.pending_maintenance_action_details.serialize_query(
...
def deserialize_query(el: Element) -> ResourcePendingMaintenanceActions:
    ...
    if child_pending_maintenance_action_details is not None:
        ...
        out["pending_maintenance_action_details"] = (
            aws_sdk_rds.types.pending_maintenance_action_details.deserialize_query(
