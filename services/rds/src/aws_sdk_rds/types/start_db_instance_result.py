"""Generated from Smithy shape ``com.amazonaws.rds#StartDBInstanceResult``."""
...
class StartDBInstanceResult(TypedDict, closed=True):
    db_instance: NotRequired["aws_sdk_rds.types.db_instance.DBInstance"]


# --- awsQuery ser/de ---
def serialize_query(
    value: StartDBInstanceResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> StartDBInstanceResult:
    out: StartDBInstanceResult = {}  # type: ignore[typeddict-item]
