...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.subnet_list
...
class DBSubnetGroup(TypedDict):
    ...
    subnet_group_status: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>Provides the status of the DB subnet group.</p>"""
    subnets: NotRequired["aws_sdk_rds.types.subnet_list.SubnetList"]
...
def serialize_query(
    ...
    if "subnets" in value:
        ...
        aws_sdk_rds.types.subnet_list.serialize_query(
...
def deserialize_query(el: Element) -> DBSubnetGroup:
    ...
    if child_subnets is not None:
        ...
        out["subnets"] = aws_sdk_rds.types.subnet_list.deserialize_query(child_subnets)
