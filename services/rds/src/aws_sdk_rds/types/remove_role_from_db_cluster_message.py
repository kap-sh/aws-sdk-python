"""Generated from Smithy shape ``com.amazonaws.rds#RemoveRoleFromDBClusterMessage``."""
...
class RemoveRoleFromDBClusterMessage(TypedDict, closed=True):
    ...
    """<p>The name of the feature for the DB cluster that the IAM role is to be disassociated from. For information about supported feature names, see <a>DBEngineVersion</a>.</p>"""
