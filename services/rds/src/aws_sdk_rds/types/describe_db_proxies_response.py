...
if TYPE_CHECKING:
    import aws_sdk_rds.types.db_proxy_list
    import aws_sdk_rds.types.string


class DescribeDBProxiesResponse(TypedDict):
    db_proxies: NotRequired["aws_sdk_rds.types.db_proxy_list.DBProxyList"]
...
def serialize_query(
    ...
    if "db_proxies" in value:
        ...
        aws_sdk_rds.types.db_proxy_list.serialize_query(
...
def deserialize_query(el: Element) -> DescribeDBProxiesResponse:
    ...
    if child_db_proxies is not None:
        ...
        out["db_proxies"] = aws_sdk_rds.types.db_proxy_list.deserialize_query(
            child_db_proxies
        )
