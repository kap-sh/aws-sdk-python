...
Range = TypedDict(
    "Range",
    {
        "from": NotRequired["aws_sdk_rds.types.integer.Integer"],
        "to": NotRequired["aws_sdk_rds.types.integer.Integer"],
        "step": NotRequired["aws_sdk_rds.types.integer_optional.IntegerOptional"],
    },
    closed=True,
)
