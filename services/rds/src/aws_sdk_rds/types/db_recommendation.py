...
if TYPE_CHECKING:
    import aws_sdk_rds.types.doc_link_list
    import aws_sdk_rds.types.issue_details
    import aws_sdk_rds.types.recommended_action_list
...
class DBRecommendation(TypedDict, closed=True):
    ...
    severity: NotRequired["aws_sdk_rds.types.string.String"]
    ...
    reason: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>The reason why this recommendation was created. The information might contain markdown.</p>"""
    recommended_actions: NotRequired[
        "aws_sdk_rds.types.recommended_action_list.RecommendedActionList"
    ]
    """<p>A list of recommended actions.</p>"""
    category: NotRequired["aws_sdk_rds.types.string.String"]
    ...
    type_detection: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>A short description of the recommendation type. The description might contain markdown.</p>"""
    type_recommendation: NotRequired["aws_sdk_rds.types.string.String"]
    ...
    impact: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>A short description that explains the possible impact of an issue.</p>"""
    additional_info: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>Additional information about the recommendation. The information might contain markdown.</p>"""
    links: NotRequired["aws_sdk_rds.types.doc_link_list.DocLinkList"]
...
def serialize_query(
    ...
    if "recommended_actions" in value:
        ...
        aws_sdk_rds.types.recommended_action_list.serialize_query(
    ...
    if "links" in value:
        ...
        aws_sdk_rds.types.doc_link_list.serialize_query(
...
def deserialize_query(el: Element) -> DBRecommendation:
    ...
    if child_created_time is not None:
        ...
        out["created_time"] = aws_sdk_rds.types.t_stamp.deserialize_query(
            child_created_time
        )
    ...
    if child_updated_time is not None:
        ...
        out["updated_time"] = aws_sdk_rds.types.t_stamp.deserialize_query(
            child_updated_time
        )
    ...
    if child_recommended_actions is not None:
        ...
        out["recommended_actions"] = (
            aws_sdk_rds.types.recommended_action_list.deserialize_query(
    ...
    if child_links is not None:
        ...
        out["links"] = aws_sdk_rds.types.doc_link_list.deserialize_query(child_links)
