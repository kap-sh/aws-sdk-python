...
class RestoreDBClusterFromS3Message(TypedDict):
    ...
    source_engine: NotRequired["aws_sdk_rds.types.string.String"]
    ...
    source_engine_version: NotRequired["aws_sdk_rds.types.string.String"]
    ...
    s3_ingestion_role_arn: NotRequired["aws_sdk_rds.types.string.String"]
