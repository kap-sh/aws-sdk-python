"""Generated from Smithy shape ``com.amazonaws.rds#DBClusterEndpoint``."""
...
class DBClusterEndpoint(TypedDict, closed=True):
    ...
    custom_endpoint_type: NotRequired["aws_sdk_rds.types.string.String"]
    ...
    db_cluster_endpoint_arn: NotRequired["aws_sdk_rds.types.string.String"]
