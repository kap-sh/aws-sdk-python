...
if TYPE_CHECKING:
    import aws_sdk_rds.types.switchover_detail

SwitchoverDetailList: TypeAlias = list[
    "aws_sdk_rds.types.switchover_detail.SwitchoverDetail"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_rds.types.switchover_detail.serialize_query(
...
def deserialize_query(el: Element) -> SwitchoverDetailList:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_rds.types.switchover_detail.deserialize_query(child))
    return out
