...
class RdsCustomClusterConfiguration(TypedDict):
    interconnect_subnet_id: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>Reserved for future use.</p>"""
    transit_gateway_multicast_domain_id: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>Reserved for future use.</p>"""
