"""Generated from Smithy shape ``com.amazonaws.rds#StopDBInstanceResult``."""
...
class StopDBInstanceResult(TypedDict, closed=True):
    db_instance: NotRequired["aws_sdk_rds.types.db_instance.DBInstance"]


# --- awsQuery ser/de ---
def serialize_query(
    value: StopDBInstanceResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> StopDBInstanceResult:
    out: StopDBInstanceResult = {}  # type: ignore[typeddict-item]
