...
class ModifyDBRecommendationMessage(TypedDict):
    ...
    recommended_action_updates: NotRequired[
        "aws_sdk_rds.types.recommended_action_update_list.RecommendedActionUpdateList"
    ]
...
def serialize_query(
    ...
    if "recommended_action_updates" in value:
        ...
        aws_sdk_rds.types.recommended_action_update_list.serialize_query(
...
def deserialize_query(el: Element) -> ModifyDBRecommendationMessage:
    ...
    if child_recommended_action_updates is not None:
        ...
        out["recommended_action_updates"] = (
            aws_sdk_rds.types.recommended_action_update_list.deserialize_query(
