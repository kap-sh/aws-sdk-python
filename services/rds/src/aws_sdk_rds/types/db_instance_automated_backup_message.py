...
if TYPE_CHECKING:
    import aws_sdk_rds.types.db_instance_automated_backup_list
    import aws_sdk_rds.types.string


class DBInstanceAutomatedBackupMessage(TypedDict):
    ...
    db_instance_automated_backups: NotRequired[
        "aws_sdk_rds.types.db_instance_automated_backup_list.DBInstanceAutomatedBackupList"
    ]
...
def serialize_query(
    ...
    if "db_instance_automated_backups" in value:
        ...
        aws_sdk_rds.types.db_instance_automated_backup_list.serialize_query(
...
def deserialize_query(el: Element) -> DBInstanceAutomatedBackupMessage:
    ...
    if child_db_instance_automated_backups is not None:
        ...
        out["db_instance_automated_backups"] = (
            aws_sdk_rds.types.db_instance_automated_backup_list.deserialize_query(
