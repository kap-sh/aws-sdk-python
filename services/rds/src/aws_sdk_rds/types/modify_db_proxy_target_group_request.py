...
class ModifyDBProxyTargetGroupRequest(TypedDict):
    ...
    connection_pool_config: NotRequired[
        "aws_sdk_rds.types.connection_pool_configuration.ConnectionPoolConfiguration"
    ]
    """<p>The settings that determine the size and behavior of the connection pool for the target group.</p>"""
    new_name: NotRequired["aws_sdk_rds.types.string.String"]
...
def serialize_query(
    ...
    if "connection_pool_config" in value:
        ...
        aws_sdk_rds.types.connection_pool_configuration.serialize_query(
...
def deserialize_query(el: Element) -> ModifyDBProxyTargetGroupRequest:
    ...
    if child_connection_pool_config is not None:
        ...
        out["connection_pool_config"] = (
            aws_sdk_rds.types.connection_pool_configuration.deserialize_query(
