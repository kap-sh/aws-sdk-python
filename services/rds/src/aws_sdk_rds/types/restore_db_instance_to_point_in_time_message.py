...
class RestoreDBInstanceToPointInTimeMessage(TypedDict):
    ...
    restore_time: NotRequired["aws_sdk_rds.types.t_stamp.TStamp"]
    ...
    source_dbi_resource_id: NotRequired["aws_sdk_rds.types.string.String"]
...
def deserialize_query(el: Element) -> RestoreDBInstanceToPointInTimeMessage:
    ...
    if child_restore_time is not None:
        ...
        out["restore_time"] = aws_sdk_rds.types.t_stamp.deserialize_query(
            child_restore_time
        )
