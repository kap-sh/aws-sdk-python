...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.db_proxy_status
    ...
    import aws_sdk_rds.types.user_auth_config_info_list


class DBProxy(TypedDict):
    ...
    db_proxy_arn: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>The Amazon Resource Name (ARN) for the proxy.</p>"""
    status: NotRequired["aws_sdk_rds.types.db_proxy_status.DBProxyStatus"]
    ...
    engine_family: NotRequired["aws_sdk_rds.types.string.String"]
    ...
    default_auth_scheme: NotRequired["aws_sdk_rds.types.string.String"]
    ...
    auth: NotRequired[
        "aws_sdk_rds.types.user_auth_config_info_list.UserAuthConfigInfoList"
    ]
    ...
    idle_client_timeout: NotRequired["aws_sdk_rds.types.integer.Integer"]
...
def serialize_query(value: DBProxy, pairs: list[tuple[str, str]], prefix: str) -> None:
    ...
    if "status" in value:
        ...
        aws_sdk_rds.types.db_proxy_status.serialize_query(
    ...
    if "auth" in value:
        ...
        aws_sdk_rds.types.user_auth_config_info_list.serialize_query(
...
def deserialize_query(el: Element) -> DBProxy:
    ...
    if child_status is not None:
        ...
        out["status"] = aws_sdk_rds.types.db_proxy_status.deserialize_query(
            child_status
        )
    ...
    if child_auth is not None:
        ...
        out["auth"] = aws_sdk_rds.types.user_auth_config_info_list.deserialize_query(
            child_auth
        )
