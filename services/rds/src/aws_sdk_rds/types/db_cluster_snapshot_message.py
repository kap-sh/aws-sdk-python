...
if TYPE_CHECKING:
    import aws_sdk_rds.types.db_cluster_snapshot_list
...
class DBClusterSnapshotMessage(TypedDict):
    ...
    db_cluster_snapshots: NotRequired[
        "aws_sdk_rds.types.db_cluster_snapshot_list.DBClusterSnapshotList"
    ]
...
def serialize_query(
    ...
    if "db_cluster_snapshots" in value:
        ...
        aws_sdk_rds.types.db_cluster_snapshot_list.serialize_query(
...
def deserialize_query(el: Element) -> DBClusterSnapshotMessage:
    ...
    if child_db_cluster_snapshots is not None:
        ...
        out["db_cluster_snapshots"] = (
            aws_sdk_rds.types.db_cluster_snapshot_list.deserialize_query(
