...
if TYPE_CHECKING:
    import aws_sdk_rds.types.option_group_option

OptionGroupOptionsList: TypeAlias = list[
    "aws_sdk_rds.types.option_group_option.OptionGroupOption"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_rds.types.option_group_option.serialize_query(
...
def deserialize_query(el: Element) -> OptionGroupOptionsList:
    ...
    for child in el.findall("OptionGroupOption"):
        out.append(aws_sdk_rds.types.option_group_option.deserialize_query(child))
    return out
