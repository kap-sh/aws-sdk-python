...
if TYPE_CHECKING:
    import aws_sdk_rds.types.available_processor_feature_list
    import aws_sdk_rds.types.boolean
    import aws_sdk_rds.types.valid_additional_storage_options
    import aws_sdk_rds.types.valid_storage_options_list


class ValidDBInstanceModificationsMessage(TypedDict):
    storage: NotRequired[
        "aws_sdk_rds.types.valid_storage_options_list.ValidStorageOptionsList"
    ]
    """<p>Valid storage options for your DB instance.</p>"""
    valid_processor_features: NotRequired[
        "aws_sdk_rds.types.available_processor_feature_list.AvailableProcessorFeatureList"
    ]
    ...
    additional_storage: NotRequired[
        "aws_sdk_rds.types.valid_additional_storage_options.ValidAdditionalStorageOptions"
    ]
...
def serialize_query(
    ...
    if "valid_processor_features" in value:
        ...
        aws_sdk_rds.types.available_processor_feature_list.serialize_query(
    ...
    if "additional_storage" in value:
        ...
        aws_sdk_rds.types.valid_additional_storage_options.serialize_query(
...
def deserialize_query(el: Element) -> ValidDBInstanceModificationsMessage:
    ...
    if child_valid_processor_features is not None:
        ...
        out["valid_processor_features"] = (
            aws_sdk_rds.types.available_processor_feature_list.deserialize_query(
    ...
    if child_additional_storage is not None:
        ...
        out["additional_storage"] = (
            aws_sdk_rds.types.valid_additional_storage_options.deserialize_query(
