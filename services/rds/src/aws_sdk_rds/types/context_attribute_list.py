...
if TYPE_CHECKING:
    import aws_sdk_rds.types.context_attribute

ContextAttributeList: TypeAlias = list[
    "aws_sdk_rds.types.context_attribute.ContextAttribute"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_rds.types.context_attribute.serialize_query(
...
def deserialize_query(el: Element) -> ContextAttributeList:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_rds.types.context_attribute.deserialize_query(child))
    return out
