...
if TYPE_CHECKING:
    import aws_sdk_rds.types.activity_stream_mode_list
    import aws_sdk_rds.types.availability_zone_list
    import aws_sdk_rds.types.available_additional_storage_volumes_option_list
...
class OrderableDBInstanceOption(TypedDict, closed=True):
    ...
    availability_zones: NotRequired[
        "aws_sdk_rds.types.availability_zone_list.AvailabilityZoneList"
    ]
    """<p>A list of Availability Zones for a DB instance.</p>"""
    multi_az_capable: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
    """<p>Indicates whether a DB instance is Multi-AZ capable.</p>"""
    read_replica_capable: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
    """<p>Indicates whether a DB instance can have a read replica.</p>"""
    vpc: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
    """<p>Indicates whether a DB instance is in a VPC.</p>"""
    supports_storage_encryption: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
    ...
    supports_enhanced_monitoring: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
    ...
    supports_performance_insights: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
    ...
    min_storage_throughput_per_iops: NotRequired[
        "aws_sdk_rds.types.double_optional.DoubleOptional"
    ]
    ...
    supports_http_endpoint: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
    """<p>Indicates whether a DB instance supports HTTP endpoints.</p>"""
    available_additional_storage_volumes_options: NotRequired[
        "aws_sdk_rds.types.available_additional_storage_volumes_option_list.AvailableAdditionalStorageVolumesOptionList"
    ]
...
def serialize_query(
    ...
    if "availability_zones" in value:
        ...
        aws_sdk_rds.types.availability_zone_list.serialize_query(
    ...
    if "supported_activity_stream_modes" in value:
        ...
        aws_sdk_rds.types.activity_stream_mode_list.serialize_query(
    ...
    if "available_additional_storage_volumes_options" in value:
        ...
        aws_sdk_rds.types.available_additional_storage_volumes_option_list.serialize_query(
...
def deserialize_query(el: Element) -> OrderableDBInstanceOption:
    ...
    if child_availability_zones is not None:
        ...
        out["availability_zones"] = (
            aws_sdk_rds.types.availability_zone_list.deserialize_query(
    ...
    if child_supported_activity_stream_modes is not None:
        ...
        out["supported_activity_stream_modes"] = (
            aws_sdk_rds.types.activity_stream_mode_list.deserialize_query(
    ...
    if child_available_additional_storage_volumes_options is not None:
        ...
        out["available_additional_storage_volumes_options"] = (
            aws_sdk_rds.types.available_additional_storage_volumes_option_list.deserialize_query(
