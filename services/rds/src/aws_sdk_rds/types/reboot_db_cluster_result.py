"""Generated from Smithy shape ``com.amazonaws.rds#RebootDBClusterResult``."""
...
class RebootDBClusterResult(TypedDict, closed=True):
    db_cluster: NotRequired["aws_sdk_rds.types.db_cluster.DBCluster"]


# --- awsQuery ser/de ---
def serialize_query(
    value: RebootDBClusterResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> RebootDBClusterResult:
    out: RebootDBClusterResult = {}  # type: ignore[typeddict-item]
