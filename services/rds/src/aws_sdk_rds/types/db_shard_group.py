...
class DBShardGroup(TypedDict):
    db_shard_group_resource_id: NotRequired["aws_sdk_rds.types.string.String"]
    ...
    db_shard_group_arn: NotRequired["aws_sdk_rds.types.string.String"]
...
def serialize_query(
    ...
    if "db_shard_group_resource_id" in value:
        pairs.append(
            (
                f"{prefix}.DBShardGroupResourceId",
    ...
    if "db_shard_group_arn" in value:
        pairs.append((f"{prefix}.DBShardGroupArn", str(value["db_shard_group_arn"])))
