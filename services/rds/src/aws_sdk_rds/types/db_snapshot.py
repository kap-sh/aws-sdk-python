...
class DBSnapshot(TypedDict):
    ...
    source_region: NotRequired["aws_sdk_rds.types.string.String"]
    ...
    db_snapshot_arn: NotRequired["aws_sdk_rds.types.string.String"]
    ...
    original_snapshot_create_time: NotRequired["aws_sdk_rds.types.t_stamp.TStamp"]
    ...
    snapshot_database_time: NotRequired["aws_sdk_rds.types.t_stamp.TStamp"]
...
def serialize_query(
    ...
    if "db_snapshot_arn" in value:
        pairs.append((f"{prefix}.DBSnapshotArn", str(value["db_snapshot_arn"])))
    ...
    if "original_snapshot_create_time" in value:
        ...
        aws_sdk_rds.types.t_stamp.serialize_query(
            ...
            pairs,
            f"{prefix}.OriginalSnapshotCreateTime",
        )
    if "snapshot_database_time" in value:
        import aws_sdk_rds.types.t_stamp

        aws_sdk_rds.types.t_stamp.serialize_query(
            value["snapshot_database_time"], pairs, f"{prefix}.SnapshotDatabaseTime"
        )
...
def deserialize_query(el: Element) -> DBSnapshot:
    ...
    if child_original_snapshot_create_time is not None:
        ...
        out["original_snapshot_create_time"] = (
    ...
    if child_snapshot_database_time is not None:
        ...
        out["snapshot_database_time"] = aws_sdk_rds.types.t_stamp.deserialize_query(
