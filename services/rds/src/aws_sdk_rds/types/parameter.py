...
if TYPE_CHECKING:
    import aws_sdk_rds.types.apply_method
    import aws_sdk_rds.types.boolean
    import aws_sdk_rds.types.engine_mode_list
    import aws_sdk_rds.types.potentially_sensitive_parameter_value
    import aws_sdk_rds.types.string


class Parameter(TypedDict, closed=True):
    parameter_name: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>The name of the parameter.</p>"""
    parameter_value: NotRequired[
        "aws_sdk_rds.types.potentially_sensitive_parameter_value.PotentiallySensitiveParameterValue"
    ]
    ...
    apply_method: NotRequired["aws_sdk_rds.types.apply_method.ApplyMethod"]
...
def serialize_query(
    ...
    if "apply_method" in value:
        ...
        aws_sdk_rds.types.apply_method.serialize_query(
...
def deserialize_query(el: Element) -> Parameter:
    ...
    if child_apply_method is not None:
        ...
        out["apply_method"] = aws_sdk_rds.types.apply_method.deserialize_query(
            child_apply_method
        )
