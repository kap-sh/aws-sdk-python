...
if TYPE_CHECKING:
    import aws_sdk_rds.types.performance_insights_metric_query


class MetricQuery(TypedDict, closed=True):
    performance_insights_metric_query: NotRequired[
        "aws_sdk_rds.types.performance_insights_metric_query.PerformanceInsightsMetricQuery"
    ]
...
def serialize_query(
    ...
    if "performance_insights_metric_query" in value:
        ...
        aws_sdk_rds.types.performance_insights_metric_query.serialize_query(
...
def deserialize_query(el: Element) -> MetricQuery:
    ...
    if child_performance_insights_metric_query is not None:
        ...
        out["performance_insights_metric_query"] = (
            aws_sdk_rds.types.performance_insights_metric_query.deserialize_query(
