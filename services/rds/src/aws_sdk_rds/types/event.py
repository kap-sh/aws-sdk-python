...
class Event(TypedDict, closed=True):
    ...
    date: NotRequired["aws_sdk_rds.types.t_stamp.TStamp"]
...
def serialize_query(value: Event, pairs: list[tuple[str, str]], prefix: str) -> None:
    ...
    if "source_type" in value:
        ...
        aws_sdk_rds.types.source_type.serialize_query(
...
def deserialize_query(el: Element) -> Event:
    ...
    if child_source_type is not None:
        ...
        out["source_type"] = aws_sdk_rds.types.source_type.deserialize_query(
            child_source_type
        )
    ...
    if child_date is not None:
        ...
        out["date"] = aws_sdk_rds.types.t_stamp.deserialize_query(child_date)
