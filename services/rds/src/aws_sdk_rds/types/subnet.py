...
if TYPE_CHECKING:
    import aws_sdk_rds.types.availability_zone
    import aws_sdk_rds.types.outpost
    import aws_sdk_rds.types.string


class Subnet(TypedDict, closed=True):
    subnet_identifier: NotRequired["aws_sdk_rds.types.string.String"]
...
def deserialize_query(el: Element) -> Subnet:
    ...
    if child_subnet_availability_zone is not None:
        ...
        out["subnet_availability_zone"] = (
            aws_sdk_rds.types.availability_zone.deserialize_query(
    ...
    if child_subnet_outpost is not None:
        ...
        out["subnet_outpost"] = aws_sdk_rds.types.outpost.deserialize_query(
