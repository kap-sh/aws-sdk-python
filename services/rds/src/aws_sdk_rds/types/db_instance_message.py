...
class DBInstanceMessage(TypedDict):
    ...
    db_instances: NotRequired["aws_sdk_rds.types.db_instance_list.DBInstanceList"]
...
def serialize_query(
    ...
    if "db_instances" in value:
        ...
        aws_sdk_rds.types.db_instance_list.serialize_query(
...
def deserialize_query(el: Element) -> DBInstanceMessage:
    ...
    if child_db_instances is not None:
        ...
        out["db_instances"] = aws_sdk_rds.types.db_instance_list.deserialize_query(
            child_db_instances
        )
    return out
