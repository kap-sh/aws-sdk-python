...
if TYPE_CHECKING:
    import aws_sdk_rds.types.db_cluster_snapshot_attribute

DBClusterSnapshotAttributeList: TypeAlias = list[
    "aws_sdk_rds.types.db_cluster_snapshot_attribute.DBClusterSnapshotAttribute"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_rds.types.db_cluster_snapshot_attribute.serialize_query(
...
def deserialize_query(el: Element) -> DBClusterSnapshotAttributeList:
    ...
    for child in el.findall("DBClusterSnapshotAttribute"):
        out.append(
            aws_sdk_rds.types.db_cluster_snapshot_attribute.deserialize_query(child)
        )
    return out
