...
if TYPE_CHECKING:
    import aws_sdk_rds.types.reference_details
...
class MetricReference(TypedDict, closed=True):
    ...
    reference_details: NotRequired[
        "aws_sdk_rds.types.reference_details.ReferenceDetails"
    ]
...
def serialize_query(
    ...
    if "reference_details" in value:
        ...
        aws_sdk_rds.types.reference_details.serialize_query(
...
def deserialize_query(el: Element) -> MetricReference:
    ...
    if child_reference_details is not None:
        ...
        out["reference_details"] = (
            aws_sdk_rds.types.reference_details.deserialize_query(
