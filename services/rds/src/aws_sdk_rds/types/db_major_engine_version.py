...
if TYPE_CHECKING:
    ...
    import aws_sdk_rds.types.supported_engine_lifecycle_list


class DBMajorEngineVersion(TypedDict):
    ...
    supported_engine_lifecycles: NotRequired[
        "aws_sdk_rds.types.supported_engine_lifecycle_list.SupportedEngineLifecycleList"
    ]
...
def serialize_query(
    ...
    if "supported_engine_lifecycles" in value:
        ...
        aws_sdk_rds.types.supported_engine_lifecycle_list.serialize_query(
...
def deserialize_query(el: Element) -> DBMajorEngineVersion:
    ...
    if child_supported_engine_lifecycles is not None:
        ...
        out["supported_engine_lifecycles"] = (
            aws_sdk_rds.types.supported_engine_lifecycle_list.deserialize_query(
