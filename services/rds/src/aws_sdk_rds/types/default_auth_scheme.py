"""Generated from Smithy shape ``com.amazonaws.rds#DefaultAuthScheme``."""
...
def serialize_query(
    value: DefaultAuthScheme, pairs: list[tuple[str, str]], prefix: str
) -> None:
    pairs.append((prefix, to_query_text(value)))


def deserialize_query(el: Element) -> DefaultAuthScheme:
