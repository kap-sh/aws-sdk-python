...
class UpgradeTarget(TypedDict):
    ...
    auto_upgrade: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
    ...
    is_major_version_upgrade: NotRequired["aws_sdk_rds.types.boolean.Boolean"]
    ...
    supported_engine_modes: NotRequired[
        "aws_sdk_rds.types.engine_mode_list.EngineModeList"
    ]
    ...
    supports_babelfish: NotRequired[
        "aws_sdk_rds.types.boolean_optional.BooleanOptional"
    ]
...
def serialize_query(
    ...
    if "supported_engine_modes" in value:
        ...
        aws_sdk_rds.types.engine_mode_list.serialize_query(
...
def deserialize_query(el: Element) -> UpgradeTarget:
    ...
    if child_supported_engine_modes is not None:
        ...
        out["supported_engine_modes"] = (
            aws_sdk_rds.types.engine_mode_list.deserialize_query(
