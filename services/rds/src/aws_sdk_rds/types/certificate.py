...
class Certificate(TypedDict, closed=True):
    ...
    thumbprint: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>The thumbprint of the certificate.</p>"""
    valid_from: NotRequired["aws_sdk_rds.types.t_stamp.TStamp"]
    ...
    certificate_arn: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>The Amazon Resource Name (ARN) for the certificate.</p>"""
    customer_override: NotRequired["aws_sdk_rds.types.boolean_optional.BooleanOptional"]
    """<p>Indicates whether there is an override for the default certificate identifier.</p>"""
    customer_override_valid_till: NotRequired["aws_sdk_rds.types.t_stamp.TStamp"]
...
def deserialize_query(el: Element) -> Certificate:
    ...
    if child_valid_from is not None:
        ...
        out["valid_from"] = aws_sdk_rds.types.t_stamp.deserialize_query(
            child_valid_from
        )
    ...
    if child_customer_override_valid_till is not None:
        ...
        out["customer_override_valid_till"] = (
