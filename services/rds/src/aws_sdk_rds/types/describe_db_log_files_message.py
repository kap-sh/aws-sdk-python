...
class DescribeDBLogFilesMessage(TypedDict):
    ...
    filename_contains: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>Filters the available log files for log file names that contain the specified string.</p>"""
    file_last_written: NotRequired["aws_sdk_rds.types.long.Long"]
    ...
    file_size: NotRequired["aws_sdk_rds.types.long.Long"]
