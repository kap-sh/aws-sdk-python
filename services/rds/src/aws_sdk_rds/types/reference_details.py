...
if TYPE_CHECKING:
    import aws_sdk_rds.types.scalar_reference_details


class ReferenceDetails(TypedDict):
    scalar_reference_details: NotRequired[
        "aws_sdk_rds.types.scalar_reference_details.ScalarReferenceDetails"
    ]
...
def serialize_query(
    ...
    if "scalar_reference_details" in value:
        ...
        aws_sdk_rds.types.scalar_reference_details.serialize_query(
...
def deserialize_query(el: Element) -> ReferenceDetails:
    ...
    if child_scalar_reference_details is not None:
        ...
        out["scalar_reference_details"] = (
            aws_sdk_rds.types.scalar_reference_details.deserialize_query(
