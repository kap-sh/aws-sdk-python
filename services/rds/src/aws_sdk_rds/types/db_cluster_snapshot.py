...
class DBClusterSnapshot(TypedDict):
    ...
    snapshot_create_time: NotRequired["aws_sdk_rds.types.t_stamp.TStamp"]
    ...
    db_cluster_snapshot_arn: NotRequired["aws_sdk_rds.types.string.String"]
    """<p>The Amazon Resource Name (ARN) for the DB cluster snapshot.</p>"""
    source_db_cluster_snapshot_arn: NotRequired["aws_sdk_rds.types.string.String"]
...
def deserialize_query(el: Element) -> DBClusterSnapshot:
    ...
    if child_snapshot_create_time is not None:
        ...
        out["snapshot_create_time"] = aws_sdk_rds.types.t_stamp.deserialize_query(
