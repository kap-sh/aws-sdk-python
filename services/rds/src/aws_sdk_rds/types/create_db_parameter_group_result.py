"""Generated from Smithy shape ``com.amazonaws.rds#CreateDBParameterGroupResult``."""
...
class CreateDBParameterGroupResult(TypedDict, closed=True):
...
def deserialize_query(el: Element) -> CreateDBParameterGroupResult:
    ...
    if child_db_parameter_group is not None:
        ...
        out["db_parameter_group"] = (
            aws_sdk_rds.types.db_parameter_group.deserialize_query(
