"""Generated from Smithy shape ``com.amazonaws.rds#RestoreDBInstanceFromDBSnapshotResult``."""
...
class RestoreDBInstanceFromDBSnapshotResult(TypedDict, closed=True):
    db_instance: NotRequired["aws_sdk_rds.types.db_instance.DBInstance"]


# --- awsQuery ser/de ---
def serialize_query(
    value: RestoreDBInstanceFromDBSnapshotResult,
...
def deserialize_query(el: Element) -> RestoreDBInstanceFromDBSnapshotResult:
    out: RestoreDBInstanceFromDBSnapshotResult = {}  # type: ignore[typeddict-item]
