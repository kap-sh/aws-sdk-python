"""Generated from Smithy shape ``com.amazonaws.rds#PromoteReadReplicaResult``."""
...
class PromoteReadReplicaResult(TypedDict, closed=True):
    db_instance: NotRequired["aws_sdk_rds.types.db_instance.DBInstance"]


# --- awsQuery ser/de ---
def serialize_query(
    value: PromoteReadReplicaResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> PromoteReadReplicaResult:
    out: PromoteReadReplicaResult = {}  # type: ignore[typeddict-item]
