...
if TYPE_CHECKING:
    import aws_sdk_rds.types.recommended_action

RecommendedActionList: TypeAlias = list[
    "aws_sdk_rds.types.recommended_action.RecommendedAction"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_rds.types.recommended_action.serialize_query(
...
def deserialize_query(el: Element) -> RecommendedActionList:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_rds.types.recommended_action.deserialize_query(child))
    return out
