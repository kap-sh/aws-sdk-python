"""Generated from Smithy shape ``com.amazonaws.rds#SubscriptionNotFoundFault``."""
...
class SubscriptionNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rds#SubscriptionNotFoundFault``."""

    code: str | None = "SubscriptionNotFoundFault"

    def __init__(self, data: SubscriptionNotFoundFault_, message: str | None = None):
        super().__init__(
            "client",
