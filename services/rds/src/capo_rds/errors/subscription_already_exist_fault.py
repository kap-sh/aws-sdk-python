"""Generated from Smithy shape ``com.amazonaws.rds#SubscriptionAlreadyExistFault``."""
...
class SubscriptionAlreadyExistFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rds#SubscriptionAlreadyExistFault``."""
