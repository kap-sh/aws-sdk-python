"""Generated from Smithy shape ``com.amazonaws.rds#DBClusterRoleNotFoundFault``."""
...
class DBClusterRoleNotFoundFault_(TypedDict, closed=True):
...
class DBClusterRoleNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rds#DBClusterRoleNotFoundFault``."""

    code: str | None = "DBClusterRoleNotFoundFault"

    def __init__(self, data: DBClusterRoleNotFoundFault_, message: str | None = None):
        super().__init__(
            "client",
