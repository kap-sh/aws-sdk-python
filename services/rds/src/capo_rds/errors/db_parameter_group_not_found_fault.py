"""Generated from Smithy shape ``com.amazonaws.rds#DBParameterGroupNotFoundFault``."""
...
class DBParameterGroupNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rds#DBParameterGroupNotFoundFault``."""

    code: str | None = "DBParameterGroupNotFoundFault"

    def __init__(
        self, data: DBParameterGroupNotFoundFault_, message: str | None = None
    ):
        super().__init__(
            "client",
