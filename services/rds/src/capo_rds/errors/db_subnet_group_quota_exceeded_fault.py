"""Generated from Smithy shape ``com.amazonaws.rds#DBSubnetGroupQuotaExceededFault``."""
...
class DBSubnetGroupQuotaExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rds#DBSubnetGroupQuotaExceededFault``."""
