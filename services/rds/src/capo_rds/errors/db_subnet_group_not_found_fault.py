"""Generated from Smithy shape ``com.amazonaws.rds#DBSubnetGroupNotFoundFault``."""
...
class DBSubnetGroupNotFoundFault_(TypedDict, closed=True):
...
class DBSubnetGroupNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rds#DBSubnetGroupNotFoundFault``."""

    code: str | None = "DBSubnetGroupNotFoundFault"

    def __init__(self, data: DBSubnetGroupNotFoundFault_, message: str | None = None):
        super().__init__(
            "client",
