"""Generated from Smithy shape ``com.amazonaws.rds#DomainNotFoundFault``."""
...
class DomainNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rds#DomainNotFoundFault``."""

    code: str | None = "DomainNotFoundFault"

    def __init__(self, data: DomainNotFoundFault_, message: str | None = None):
        super().__init__(
            "client",
