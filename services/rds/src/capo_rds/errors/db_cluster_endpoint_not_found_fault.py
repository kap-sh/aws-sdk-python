"""Generated from Smithy shape ``com.amazonaws.rds#DBClusterEndpointNotFoundFault``."""
...
class DBClusterEndpointNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rds#DBClusterEndpointNotFoundFault``."""
