...
import capo_rds.types.option_group_options_message
...
) -> capo_rds.types.option_group_options_message.OptionGroupOptionsMessage:
    root = fromstring(response.read())
    result = root.find("DescribeOptionGroupOptionsResult")
    out: capo_rds.types.option_group_options_message.OptionGroupOptionsMessage = (
        capo_rds.types.option_group_options_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_option_group_options_message.serialize_query(
        input_, pairs, ""
    )
