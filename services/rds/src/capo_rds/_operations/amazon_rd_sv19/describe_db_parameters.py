...
) -> capo_rds.types.db_parameter_group_details.DBParameterGroupDetails:
    root = fromstring(response.read())
    result = root.find("DescribeDBParametersResult")
    out: capo_rds.types.db_parameter_group_details.DBParameterGroupDetails = (
        capo_rds.types.db_parameter_group_details.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_parameters_message.serialize_query(input_, pairs, "")
...
def describe_db_parameters(
    ...
    capo_rds.types.db_parameter_group_details.DBParameterGroupDetails, zapros.Response
]:
