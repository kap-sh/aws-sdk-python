"""Generated from Smithy shape ``com.amazonaws.rds#ModifyDBShardGroup``."""
...
import capo_rds.errors.db_shard_group_already_exists_fault
...
import capo_rds.types.modify_db_shard_group_message
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyDBShardGroupResult")
...
def build_request(
    ...
    pairs.append(("Action", "ModifyDBShardGroup"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.modify_db_shard_group_message.serialize_query(input_, pairs, "")
...
async def async_modify_db_shard_group(
