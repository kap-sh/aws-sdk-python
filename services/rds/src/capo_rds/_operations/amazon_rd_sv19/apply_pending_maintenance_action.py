"""Generated from Smithy shape ``com.amazonaws.rds#ApplyPendingMaintenanceAction``."""
...
import capo_rds.types.apply_pending_maintenance_action_message
import capo_rds.types.apply_pending_maintenance_action_result
import capo_rds.types.resource_pending_maintenance_actions
...
def handle_response(
    ...
    out: capo_rds.types.apply_pending_maintenance_action_result.ApplyPendingMaintenanceActionResult = capo_rds.types.apply_pending_maintenance_action_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.apply_pending_maintenance_action_message.serialize_query(
        input_, pairs, ""
    )
