...
import capo_rds.types.db_snapshot_tenant_databases_message
import capo_rds.types.describe_db_snapshot_tenant_databases_message
...
def handle_response(
    ...
    capo_rds.types.db_snapshot_tenant_databases_message.DBSnapshotTenantDatabasesMessage
):
    root = fromstring(response.read())
    result = root.find("DescribeDBSnapshotTenantDatabasesResult")
    out: capo_rds.types.db_snapshot_tenant_databases_message.DBSnapshotTenantDatabasesMessage = capo_rds.types.db_snapshot_tenant_databases_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_snapshot_tenant_databases_message.serialize_query(
        input_, pairs, ""
    )
