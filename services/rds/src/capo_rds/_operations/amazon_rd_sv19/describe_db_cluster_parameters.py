...
import capo_rds.types.db_cluster_parameter_group_details
import capo_rds.types.describe_db_cluster_parameters_message
...
) -> capo_rds.types.db_cluster_parameter_group_details.DBClusterParameterGroupDetails:
    root = fromstring(response.read())
    result = root.find("DescribeDBClusterParametersResult")
    out: capo_rds.types.db_cluster_parameter_group_details.DBClusterParameterGroupDetails = capo_rds.types.db_cluster_parameter_group_details.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_cluster_parameters_message.serialize_query(
        input_, pairs, ""
    )
