"""Generated from Smithy shape ``com.amazonaws.rds#DescribeReservedDBInstancesOfferings``."""
...
import capo_rds.errors.reserved_db_instances_offering_not_found_fault
import capo_rds.types.describe_reserved_db_instances_offerings_message
import capo_rds.types.filter_list
import capo_rds.types.reserved_db_instances_offering_list
import capo_rds.types.reserved_db_instances_offering_message
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ReservedDBInstancesOfferingNotFound":
            raise capo_rds.errors.reserved_db_instances_offering_not_found_fault.ReservedDBInstancesOfferingNotFoundFault.from_query(
                error_el, message
            )
        case _:
...
) -> capo_rds.types.reserved_db_instances_offering_message.ReservedDBInstancesOfferingMessage:
    root = fromstring(response.read())
    result = root.find("DescribeReservedDBInstancesOfferingsResult")
    out: capo_rds.types.reserved_db_instances_offering_message.ReservedDBInstancesOfferingMessage = capo_rds.types.reserved_db_instances_offering_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_reserved_db_instances_offerings_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_reserved_db_instances_offerings(
