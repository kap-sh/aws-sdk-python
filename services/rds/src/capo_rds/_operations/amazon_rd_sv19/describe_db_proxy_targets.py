"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBProxyTargets``."""
...
import capo_rds.errors.db_proxy_target_not_found_fault
import capo_rds.errors.invalid_db_proxy_state_fault
import capo_rds.types.describe_db_proxy_targets_request
import capo_rds.types.describe_db_proxy_targets_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBProxyTargetNotFoundFault":
            raise capo_rds.errors.db_proxy_target_not_found_fault.DBProxyTargetNotFoundFault.from_query(
                error_el, message
            )
...
) -> capo_rds.types.describe_db_proxy_targets_response.DescribeDBProxyTargetsResponse:
    root = fromstring(response.read())
    result = root.find("DescribeDBProxyTargetsResult")
    out: capo_rds.types.describe_db_proxy_targets_response.DescribeDBProxyTargetsResponse = capo_rds.types.describe_db_proxy_targets_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeDBProxyTargets"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.describe_db_proxy_targets_request.serialize_query(input_, pairs, "")
...
async def async_describe_db_proxy_targets(
