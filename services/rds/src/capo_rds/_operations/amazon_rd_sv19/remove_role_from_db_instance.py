...
import capo_rds.errors.db_instance_role_not_found_fault
import capo_rds.errors.invalid_db_instance_state_fault
import capo_rds.types.remove_role_from_db_instance_message
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBInstanceRoleNotFound":
            raise capo_rds.errors.db_instance_role_not_found_fault.DBInstanceRoleNotFoundFault.from_query(
                error_el, message
            )
...
def build_request(
    ...
    capo_rds.types.remove_role_from_db_instance_message.serialize_query(
        input_, pairs, ""
    )
