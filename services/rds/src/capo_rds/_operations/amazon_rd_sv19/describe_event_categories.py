...
import capo_rds.types.describe_event_categories_message
import capo_rds.types.event_categories_map_list
import capo_rds.types.event_categories_message
...
) -> capo_rds.types.event_categories_message.EventCategoriesMessage:
    root = fromstring(response.read())
    result = root.find("DescribeEventCategoriesResult")
    out: capo_rds.types.event_categories_message.EventCategoriesMessage = (
        capo_rds.types.event_categories_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_event_categories_message.serialize_query(input_, pairs, "")
...
def describe_event_categories(
    ...
    capo_rds.types.event_categories_message.EventCategoriesMessage, zapros.Response
]:
