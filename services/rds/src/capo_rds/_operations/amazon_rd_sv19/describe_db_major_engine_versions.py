"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBMajorEngineVersions``."""
...
import capo_rds.types.describe_db_major_engine_versions_request
import capo_rds.types.describe_db_major_engine_versions_response
...
) -> capo_rds.types.describe_db_major_engine_versions_response.DescribeDBMajorEngineVersionsResponse:
    root = fromstring(response.read())
    result = root.find("DescribeDBMajorEngineVersionsResult")
    out: capo_rds.types.describe_db_major_engine_versions_response.DescribeDBMajorEngineVersionsResponse = capo_rds.types.describe_db_major_engine_versions_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_major_engine_versions_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_db_major_engine_versions(
