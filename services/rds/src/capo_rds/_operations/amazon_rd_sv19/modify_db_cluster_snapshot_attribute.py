"""Generated from Smithy shape ``com.amazonaws.rds#ModifyDBClusterSnapshotAttribute``."""
...
import capo_rds.errors.shared_snapshot_quota_exceeded_fault
import capo_rds.types.attribute_value_list
import capo_rds.types.db_cluster_snapshot_attributes_result
import capo_rds.types.modify_db_cluster_snapshot_attribute_message
import capo_rds.types.modify_db_cluster_snapshot_attribute_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SharedSnapshotQuotaExceeded":
            raise capo_rds.errors.shared_snapshot_quota_exceeded_fault.SharedSnapshotQuotaExceededFault.from_query(
                error_el, message
            )
        case _:
...
) -> capo_rds.types.modify_db_cluster_snapshot_attribute_result.ModifyDBClusterSnapshotAttributeResult:
    root = fromstring(response.read())
    result = root.find("ModifyDBClusterSnapshotAttributeResult")
    out: capo_rds.types.modify_db_cluster_snapshot_attribute_result.ModifyDBClusterSnapshotAttributeResult = capo_rds.types.modify_db_cluster_snapshot_attribute_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyDBClusterSnapshotAttribute"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.modify_db_cluster_snapshot_attribute_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_db_cluster_snapshot_attribute(
