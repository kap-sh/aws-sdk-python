...
import capo_rds.types.db_cluster_snapshot_message
import capo_rds.types.describe_db_cluster_snapshots_message
...
) -> capo_rds.types.db_cluster_snapshot_message.DBClusterSnapshotMessage:
    root = fromstring(response.read())
    result = root.find("DescribeDBClusterSnapshotsResult")
    out: capo_rds.types.db_cluster_snapshot_message.DBClusterSnapshotMessage = (
        capo_rds.types.db_cluster_snapshot_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_cluster_snapshots_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_db_cluster_snapshots(
    ...
    capo_rds.types.db_cluster_snapshot_message.DBClusterSnapshotMessage, zapros.Response
]:
