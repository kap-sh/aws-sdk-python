"""Generated from Smithy shape ``com.amazonaws.rds#DeleteDBClusterAutomatedBackup``."""
...
import capo_rds.errors.invalid_db_cluster_automated_backup_state_fault
import capo_rds.types.db_cluster_automated_backup
import capo_rds.types.delete_db_cluster_automated_backup_message
import capo_rds.types.delete_db_cluster_automated_backup_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDBClusterAutomatedBackupStateFault":
            raise capo_rds.errors.invalid_db_cluster_automated_backup_state_fault.InvalidDBClusterAutomatedBackupStateFault.from_query(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_rds.types.delete_db_cluster_automated_backup_result.DeleteDBClusterAutomatedBackupResult = capo_rds.types.delete_db_cluster_automated_backup_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteDBClusterAutomatedBackup"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.delete_db_cluster_automated_backup_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_db_cluster_automated_backup(
