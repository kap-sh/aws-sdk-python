"""Generated from Smithy shape ``com.amazonaws.rds#DeleteDBShardGroup``."""
...
import capo_rds.types.delete_db_shard_group_message
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteDBShardGroupResult")
    out: capo_rds.types.db_shard_group.DBShardGroup = (
        capo_rds.types.db_shard_group.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteDBShardGroup"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.delete_db_shard_group_message.serialize_query(input_, pairs, "")
...
def delete_db_shard_group(
    ...
    input_: capo_rds.types.delete_db_shard_group_message.DeleteDBShardGroupMessage,
) -> tuple[capo_rds.types.db_shard_group.DBShardGroup, zapros.Response]:
...
async def async_delete_db_shard_group(
