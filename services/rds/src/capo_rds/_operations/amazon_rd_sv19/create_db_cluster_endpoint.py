"""Generated from Smithy shape ``com.amazonaws.rds#CreateDBClusterEndpoint``."""
...
import capo_rds.errors.db_cluster_endpoint_already_exists_fault
import capo_rds.errors.db_cluster_endpoint_quota_exceeded_fault
...
import capo_rds.types.create_db_cluster_endpoint_message
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBClusterEndpointAlreadyExistsFault":
            raise capo_rds.errors.db_cluster_endpoint_already_exists_fault.DBClusterEndpointAlreadyExistsFault.from_query(
                root
            )
        case "DBClusterEndpointQuotaExceededFault":
            raise capo_rds.errors.db_cluster_endpoint_quota_exceeded_fault.DBClusterEndpointQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateDBClusterEndpointResult")
    out: capo_rds.types.db_cluster_endpoint.DBClusterEndpoint = (
        capo_rds.types.db_cluster_endpoint.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateDBClusterEndpoint"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.create_db_cluster_endpoint_message.serialize_query(input_, pairs, "")
...
def create_db_cluster_endpoint(
    ...
    input_: capo_rds.types.create_db_cluster_endpoint_message.CreateDBClusterEndpointMessage,
) -> tuple[capo_rds.types.db_cluster_endpoint.DBClusterEndpoint, zapros.Response]:
...
async def async_create_db_cluster_endpoint(
