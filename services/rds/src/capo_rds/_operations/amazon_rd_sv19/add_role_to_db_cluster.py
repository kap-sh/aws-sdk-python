...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBClusterRoleAlreadyExistsFault":
            raise capo_rds.errors.db_cluster_role_already_exists_fault.DBClusterRoleAlreadyExistsFault.from_query(
                root
            )
...
def build_request(
    ...
    capo_rds.types.add_role_to_db_cluster_message.serialize_query(input_, pairs, "")
