...
import capo_rds.types.disable_http_endpoint_request
import capo_rds.types.disable_http_endpoint_response
...
def handle_response(
    ...
    out: capo_rds.types.disable_http_endpoint_response.DisableHttpEndpointResponse = (
        capo_rds.types.disable_http_endpoint_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.disable_http_endpoint_request.serialize_query(input_, pairs, "")
