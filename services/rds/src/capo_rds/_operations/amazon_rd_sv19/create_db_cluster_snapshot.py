...
import capo_rds.types.create_db_cluster_snapshot_message
import capo_rds.types.create_db_cluster_snapshot_result
...
def handle_response(
    ...
    out: capo_rds.types.create_db_cluster_snapshot_result.CreateDBClusterSnapshotResult = capo_rds.types.create_db_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.create_db_cluster_snapshot_message.serialize_query(input_, pairs, "")
