"""Generated from Smithy shape ``com.amazonaws.rds#DeleteTenantDatabase``."""
...
import capo_rds.types.delete_tenant_database_message
import capo_rds.types.delete_tenant_database_result
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteTenantDatabaseResult")
    out: capo_rds.types.delete_tenant_database_result.DeleteTenantDatabaseResult = (
        capo_rds.types.delete_tenant_database_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteTenantDatabase"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.delete_tenant_database_message.serialize_query(input_, pairs, "")
...
async def async_delete_tenant_database(
