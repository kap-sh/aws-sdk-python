"""Generated from Smithy shape ``com.amazonaws.rds#ModifyDBClusterEndpoint``."""
...
import capo_rds.errors.db_cluster_endpoint_not_found_fault
...
import capo_rds.types.modify_db_cluster_endpoint_message
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBClusterEndpointNotFoundFault":
            raise capo_rds.errors.db_cluster_endpoint_not_found_fault.DBClusterEndpointNotFoundFault.from_query(
                error_el, message
            )
...
def build_request(
    ...
    capo_rds.types.modify_db_cluster_endpoint_message.serialize_query(input_, pairs, "")
