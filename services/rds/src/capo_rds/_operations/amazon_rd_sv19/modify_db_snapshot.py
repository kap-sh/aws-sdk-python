...
import capo_rds.types.modify_db_snapshot_message
import capo_rds.types.modify_db_snapshot_result
...
def handle_response(
    ...
    out: capo_rds.types.modify_db_snapshot_result.ModifyDBSnapshotResult = (
        capo_rds.types.modify_db_snapshot_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.modify_db_snapshot_message.serialize_query(input_, pairs, "")
...
def modify_db_snapshot(
    ...
    capo_rds.types.modify_db_snapshot_result.ModifyDBSnapshotResult, zapros.Response
]:
