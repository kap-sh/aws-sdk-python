...
import capo_rds.errors.subnet_already_in_use
import capo_rds.types.db_subnet_group
import capo_rds.types.modify_db_subnet_group_message
import capo_rds.types.modify_db_subnet_group_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubnetAlreadyInUse":
            raise capo_rds.errors.subnet_already_in_use.SubnetAlreadyInUse.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_rds.types.modify_db_subnet_group_result.ModifyDBSubnetGroupResult = (
        capo_rds.types.modify_db_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.modify_db_subnet_group_message.serialize_query(input_, pairs, "")
