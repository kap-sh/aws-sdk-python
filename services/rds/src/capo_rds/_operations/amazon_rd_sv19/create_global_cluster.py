...
import capo_rds.errors.global_cluster_quota_exceeded_fault
import capo_rds.errors.invalid_db_cluster_state_fault
import capo_rds.errors.invalid_db_shard_group_state_fault
import capo_rds.errors.resource_not_found_fault
import capo_rds.types.create_global_cluster_message
import capo_rds.types.create_global_cluster_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "GlobalClusterQuotaExceededFault":
            raise capo_rds.errors.global_cluster_quota_exceeded_fault.GlobalClusterQuotaExceededFault.from_query(
                error_el, message
            )
        ...
        case "InvalidDBShardGroupState":
            raise capo_rds.errors.invalid_db_shard_group_state_fault.InvalidDBShardGroupStateFault.from_query(
                error_el, message
            )
...
) -> capo_rds.types.create_global_cluster_result.CreateGlobalClusterResult:
    root = fromstring(response.read())
    result = root.find("CreateGlobalClusterResult")
    out: capo_rds.types.create_global_cluster_result.CreateGlobalClusterResult = (
        capo_rds.types.create_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.create_global_cluster_message.serialize_query(input_, pairs, "")
