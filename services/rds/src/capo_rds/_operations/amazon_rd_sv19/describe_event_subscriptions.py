"""Generated from Smithy shape ``com.amazonaws.rds#DescribeEventSubscriptions``."""
...
import capo_rds.types.describe_event_subscriptions_message
import capo_rds.types.event_subscriptions_list
import capo_rds.types.event_subscriptions_message
...
) -> capo_rds.types.event_subscriptions_message.EventSubscriptionsMessage:
    root = fromstring(response.read())
    result = root.find("DescribeEventSubscriptionsResult")
    out: capo_rds.types.event_subscriptions_message.EventSubscriptionsMessage = (
        capo_rds.types.event_subscriptions_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_event_subscriptions_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_event_subscriptions(
