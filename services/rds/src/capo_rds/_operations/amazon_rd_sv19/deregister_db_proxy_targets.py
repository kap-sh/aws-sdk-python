...
import capo_rds.types.deregister_db_proxy_targets_request
import capo_rds.types.deregister_db_proxy_targets_response
...
def handle_response(
    ...
    capo_rds.types.deregister_db_proxy_targets_response.DeregisterDBProxyTargetsResponse
):
    root = fromstring(response.read())
    result = root.find("DeregisterDBProxyTargetsResult")
    out: capo_rds.types.deregister_db_proxy_targets_response.DeregisterDBProxyTargetsResponse = capo_rds.types.deregister_db_proxy_targets_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.deregister_db_proxy_targets_request.serialize_query(
        input_, pairs, ""
    )
