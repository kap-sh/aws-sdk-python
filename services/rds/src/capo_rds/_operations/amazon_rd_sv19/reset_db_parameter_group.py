"""Generated from Smithy shape ``com.amazonaws.rds#ResetDBParameterGroup``."""
...
import capo_rds.types.db_parameter_group_name_message
import capo_rds.types.parameters_list
import capo_rds.types.reset_db_parameter_group_message
...
def handle_response(
    ...
    out: capo_rds.types.db_parameter_group_name_message.DBParameterGroupNameMessage = (
        capo_rds.types.db_parameter_group_name_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.reset_db_parameter_group_message.serialize_query(input_, pairs, "")
