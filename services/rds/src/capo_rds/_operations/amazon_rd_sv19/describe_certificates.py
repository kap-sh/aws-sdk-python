...
import capo_rds.types.certificate_message
import capo_rds.types.describe_certificates_message
...
) -> capo_rds.types.certificate_message.CertificateMessage:
    root = fromstring(response.read())
    result = root.find("DescribeCertificatesResult")
    out: capo_rds.types.certificate_message.CertificateMessage = (
        capo_rds.types.certificate_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_certificates_message.serialize_query(input_, pairs, "")
...
def describe_certificates(
    ...
    input_: capo_rds.types.describe_certificates_message.DescribeCertificatesMessage,
) -> tuple[capo_rds.types.certificate_message.CertificateMessage, zapros.Response]:
