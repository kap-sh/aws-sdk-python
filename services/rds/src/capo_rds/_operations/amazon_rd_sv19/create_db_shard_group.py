...
import capo_rds.errors.max_db_shard_group_limit_reached
import capo_rds.errors.network_type_not_supported
import capo_rds.errors.unsupported_db_engine_version_fault
...
def build_request(
    ...
    capo_rds.types.create_db_shard_group_message.serialize_query(input_, pairs, "")
