...
import capo_rds.types.delete_db_proxy_request
import capo_rds.types.delete_db_proxy_response
...
def handle_response(
    ...
    out: capo_rds.types.delete_db_proxy_response.DeleteDBProxyResponse = (
        capo_rds.types.delete_db_proxy_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.delete_db_proxy_request.serialize_query(input_, pairs, "")
...
def delete_db_proxy(
    ...
    capo_rds.types.delete_db_proxy_response.DeleteDBProxyResponse, zapros.Response
]:
