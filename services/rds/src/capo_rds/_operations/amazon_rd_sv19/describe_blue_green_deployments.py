...
import capo_rds.types.describe_blue_green_deployments_request
import capo_rds.types.describe_blue_green_deployments_response
...
) -> capo_rds.types.describe_blue_green_deployments_response.DescribeBlueGreenDeploymentsResponse:
    root = fromstring(response.read())
    result = root.find("DescribeBlueGreenDeploymentsResult")
    out: capo_rds.types.describe_blue_green_deployments_response.DescribeBlueGreenDeploymentsResponse = capo_rds.types.describe_blue_green_deployments_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_blue_green_deployments_request.serialize_query(
        input_, pairs, ""
    )
