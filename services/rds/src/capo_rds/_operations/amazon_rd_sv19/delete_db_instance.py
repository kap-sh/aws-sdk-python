...
import capo_rds.errors.db_snapshot_already_exists_fault
...
import capo_rds.errors.snapshot_quota_exceeded_fault
import capo_rds.types.db_instance
import capo_rds.types.delete_db_instance_message
import capo_rds.types.delete_db_instance_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBSnapshotAlreadyExists":
            raise capo_rds.errors.db_snapshot_already_exists_fault.DBSnapshotAlreadyExistsFault.from_query(
                error_el, message
            )
        ...
        case "SnapshotQuotaExceeded":
            raise capo_rds.errors.snapshot_quota_exceeded_fault.SnapshotQuotaExceededFault.from_query(
                error_el, message
            )
        case _:
...
) -> capo_rds.types.delete_db_instance_result.DeleteDBInstanceResult:
    root = fromstring(response.read())
    result = root.find("DeleteDBInstanceResult")
    out: capo_rds.types.delete_db_instance_result.DeleteDBInstanceResult = (
        capo_rds.types.delete_db_instance_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.delete_db_instance_message.serialize_query(input_, pairs, "")
...
def delete_db_instance(
    ...
    capo_rds.types.delete_db_instance_result.DeleteDBInstanceResult, zapros.Response
]:
