...
import capo_rds.types.db_cluster_parameter_group_list
import capo_rds.types.db_cluster_parameter_groups_message
import capo_rds.types.describe_db_cluster_parameter_groups_message
...
) -> capo_rds.types.db_cluster_parameter_groups_message.DBClusterParameterGroupsMessage:
    root = fromstring(response.read())
    result = root.find("DescribeDBClusterParameterGroupsResult")
    out: capo_rds.types.db_cluster_parameter_groups_message.DBClusterParameterGroupsMessage = capo_rds.types.db_cluster_parameter_groups_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_cluster_parameter_groups_message.serialize_query(
        input_, pairs, ""
    )
