...
import capo_rds.errors.subscription_already_exist_fault
import capo_rds.errors.subscription_category_not_found_fault
import capo_rds.types.create_event_subscription_message
import capo_rds.types.create_event_subscription_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubscriptionAlreadyExist":
            raise capo_rds.errors.subscription_already_exist_fault.SubscriptionAlreadyExistFault.from_query(
                error_el, message
            )
...
) -> capo_rds.types.create_event_subscription_result.CreateEventSubscriptionResult:
    root = fromstring(response.read())
    result = root.find("CreateEventSubscriptionResult")
    out: capo_rds.types.create_event_subscription_result.CreateEventSubscriptionResult = capo_rds.types.create_event_subscription_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.create_event_subscription_message.serialize_query(input_, pairs, "")
