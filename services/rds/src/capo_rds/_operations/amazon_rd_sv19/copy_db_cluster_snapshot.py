...
import capo_rds.types.copy_db_cluster_snapshot_message
import capo_rds.types.copy_db_cluster_snapshot_result
...
) -> capo_rds.types.copy_db_cluster_snapshot_result.CopyDBClusterSnapshotResult:
    root = fromstring(response.read())
    result = root.find("CopyDBClusterSnapshotResult")
    out: capo_rds.types.copy_db_cluster_snapshot_result.CopyDBClusterSnapshotResult = (
        capo_rds.types.copy_db_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.copy_db_cluster_snapshot_message.serialize_query(input_, pairs, "")
