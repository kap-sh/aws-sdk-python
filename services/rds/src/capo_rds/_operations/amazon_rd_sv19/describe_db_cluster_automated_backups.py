...
import capo_rds.types.db_cluster_automated_backup_message
import capo_rds.types.describe_db_cluster_automated_backups_message
...
) -> capo_rds.types.db_cluster_automated_backup_message.DBClusterAutomatedBackupMessage:
    root = fromstring(response.read())
    result = root.find("DescribeDBClusterAutomatedBackupsResult")
    out: capo_rds.types.db_cluster_automated_backup_message.DBClusterAutomatedBackupMessage = capo_rds.types.db_cluster_automated_backup_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_cluster_automated_backups_message.serialize_query(
        input_, pairs, ""
    )
