...
import capo_rds.types.copy_db_parameter_group_message
import capo_rds.types.copy_db_parameter_group_result
...
def handle_response(
    ...
    out: capo_rds.types.copy_db_parameter_group_result.CopyDBParameterGroupResult = (
        capo_rds.types.copy_db_parameter_group_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.copy_db_parameter_group_message.serialize_query(input_, pairs, "")
