...
import capo_rds.errors.invalid_event_subscription_state_fault
import capo_rds.errors.subscription_not_found_fault
import capo_rds.types.delete_event_subscription_message
import capo_rds.types.delete_event_subscription_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidEventSubscriptionState":
            raise capo_rds.errors.invalid_event_subscription_state_fault.InvalidEventSubscriptionStateFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_rds.types.delete_event_subscription_result.DeleteEventSubscriptionResult = capo_rds.types.delete_event_subscription_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.delete_event_subscription_message.serialize_query(input_, pairs, "")
