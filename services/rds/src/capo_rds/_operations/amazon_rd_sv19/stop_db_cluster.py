"""Generated from Smithy shape ``com.amazonaws.rds#StopDBCluster``."""
...
import capo_rds.types.stop_db_cluster_message
import capo_rds.types.stop_db_cluster_result
...
def handle_response(
    ...
    out: capo_rds.types.stop_db_cluster_result.StopDBClusterResult = (
        capo_rds.types.stop_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.stop_db_cluster_message.serialize_query(input_, pairs, "")
...
def stop_db_cluster(
    ...
    input_: capo_rds.types.stop_db_cluster_message.StopDBClusterMessage,
) -> tuple[capo_rds.types.stop_db_cluster_result.StopDBClusterResult, zapros.Response]:
