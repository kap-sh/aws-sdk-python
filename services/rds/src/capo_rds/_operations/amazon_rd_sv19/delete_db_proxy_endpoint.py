...
import capo_rds.errors.invalid_db_proxy_endpoint_state_fault
import capo_rds.types.db_proxy_endpoint
import capo_rds.types.delete_db_proxy_endpoint_request
import capo_rds.types.delete_db_proxy_endpoint_response
...
def handle_response(
    ...
    out: capo_rds.types.delete_db_proxy_endpoint_response.DeleteDBProxyEndpointResponse = capo_rds.types.delete_db_proxy_endpoint_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.delete_db_proxy_endpoint_request.serialize_query(input_, pairs, "")
