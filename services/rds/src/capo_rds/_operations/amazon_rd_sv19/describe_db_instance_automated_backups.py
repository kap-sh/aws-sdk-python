"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBInstanceAutomatedBackups``."""
...
import capo_rds.types.db_instance_automated_backup_message
import capo_rds.types.describe_db_instance_automated_backups_message
...
def handle_response(
    ...
    capo_rds.types.db_instance_automated_backup_message.DBInstanceAutomatedBackupMessage
):
    root = fromstring(response.read())
    result = root.find("DescribeDBInstanceAutomatedBackupsResult")
    out: capo_rds.types.db_instance_automated_backup_message.DBInstanceAutomatedBackupMessage = capo_rds.types.db_instance_automated_backup_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_instance_automated_backups_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_db_instance_automated_backups(
