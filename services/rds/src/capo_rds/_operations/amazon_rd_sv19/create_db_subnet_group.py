...
import capo_rds.errors.db_subnet_group_already_exists_fault
import capo_rds.errors.db_subnet_group_does_not_cover_enough_a_zs
import capo_rds.errors.db_subnet_group_quota_exceeded_fault
import capo_rds.errors.db_subnet_quota_exceeded_fault
import capo_rds.errors.invalid_subnet
import capo_rds.types.create_db_subnet_group_message
import capo_rds.types.create_db_subnet_group_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBSubnetGroupAlreadyExists":
            raise capo_rds.errors.db_subnet_group_already_exists_fault.DBSubnetGroupAlreadyExistsFault.from_query(
                error_el, message
            )
        ...
        case "DBSubnetGroupQuotaExceeded":
            raise capo_rds.errors.db_subnet_group_quota_exceeded_fault.DBSubnetGroupQuotaExceededFault.from_query(
                error_el, message
            )
        case "DBSubnetQuotaExceededFault":
            raise capo_rds.errors.db_subnet_quota_exceeded_fault.DBSubnetQuotaExceededFault.from_query(
                error_el, message
            )
        case "InvalidSubnet":
...
def handle_response(
    ...
    out: capo_rds.types.create_db_subnet_group_result.CreateDBSubnetGroupResult = (
        capo_rds.types.create_db_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.create_db_subnet_group_message.serialize_query(input_, pairs, "")
