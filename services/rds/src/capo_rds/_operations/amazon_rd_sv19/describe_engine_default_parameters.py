"""Generated from Smithy shape ``com.amazonaws.rds#DescribeEngineDefaultParameters``."""
...
import capo_rds.types.describe_engine_default_parameters_message
import capo_rds.types.describe_engine_default_parameters_result
...
) -> capo_rds.types.describe_engine_default_parameters_result.DescribeEngineDefaultParametersResult:
    root = fromstring(response.read())
    result = root.find("DescribeEngineDefaultParametersResult")
    out: capo_rds.types.describe_engine_default_parameters_result.DescribeEngineDefaultParametersResult = capo_rds.types.describe_engine_default_parameters_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeEngineDefaultParameters"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.describe_engine_default_parameters_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_engine_default_parameters(
