"""Generated from Smithy shape ``com.amazonaws.rds#RemoveRoleFromDBCluster``."""
...
import capo_rds.errors.db_cluster_role_not_found_fault
import capo_rds.errors.invalid_db_cluster_state_fault
import capo_rds.types.remove_role_from_db_cluster_message
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBClusterRoleNotFound":
            raise capo_rds.errors.db_cluster_role_not_found_fault.DBClusterRoleNotFoundFault.from_query(
                error_el, message
            )
...
def build_request(
    ...
    capo_rds.types.remove_role_from_db_cluster_message.serialize_query(
        input_, pairs, ""
    )
