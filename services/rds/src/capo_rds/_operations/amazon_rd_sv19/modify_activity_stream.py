"""Generated from Smithy shape ``com.amazonaws.rds#ModifyActivityStream``."""
...
import capo_rds.types.modify_activity_stream_request
import capo_rds.types.modify_activity_stream_response
...
def handle_response(
    ...
    out: capo_rds.types.modify_activity_stream_response.ModifyActivityStreamResponse = (
        capo_rds.types.modify_activity_stream_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.modify_activity_stream_request.serialize_query(input_, pairs, "")
...
async def async_modify_activity_stream(
