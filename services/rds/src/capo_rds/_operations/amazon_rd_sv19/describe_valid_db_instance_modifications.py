"""Generated from Smithy shape ``com.amazonaws.rds#DescribeValidDBInstanceModifications``."""
...
import capo_rds.types.describe_valid_db_instance_modifications_message
import capo_rds.types.describe_valid_db_instance_modifications_result
import capo_rds.types.valid_db_instance_modifications_message
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeValidDBInstanceModificationsResult")
    out: capo_rds.types.describe_valid_db_instance_modifications_result.DescribeValidDBInstanceModificationsResult = capo_rds.types.describe_valid_db_instance_modifications_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeValidDBInstanceModifications"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.describe_valid_db_instance_modifications_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_valid_db_instance_modifications(
