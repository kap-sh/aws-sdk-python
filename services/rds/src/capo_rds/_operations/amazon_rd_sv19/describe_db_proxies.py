"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBProxies``."""
...
import capo_rds.types.describe_db_proxies_request
import capo_rds.types.describe_db_proxies_response
...
) -> capo_rds.types.describe_db_proxies_response.DescribeDBProxiesResponse:
    root = fromstring(response.read())
    result = root.find("DescribeDBProxiesResult")
    out: capo_rds.types.describe_db_proxies_response.DescribeDBProxiesResponse = (
        capo_rds.types.describe_db_proxies_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeDBProxies"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.describe_db_proxies_request.serialize_query(input_, pairs, "")
...
async def async_describe_db_proxies(
