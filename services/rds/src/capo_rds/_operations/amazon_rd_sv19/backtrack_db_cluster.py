...
import capo_rds.types.backtrack_db_cluster_message
...
def handle_response(
    ...
    out: capo_rds.types.db_cluster_backtrack.DBClusterBacktrack = (
        capo_rds.types.db_cluster_backtrack.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.backtrack_db_cluster_message.serialize_query(input_, pairs, "")
...
def backtrack_db_cluster(
    ...
    input_: capo_rds.types.backtrack_db_cluster_message.BacktrackDBClusterMessage,
) -> tuple[capo_rds.types.db_cluster_backtrack.DBClusterBacktrack, zapros.Response]:
