...
import capo_rds.types.copy_option_group_message
import capo_rds.types.copy_option_group_result
...
def handle_response(
    ...
    out: capo_rds.types.copy_option_group_result.CopyOptionGroupResult = (
        capo_rds.types.copy_option_group_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.copy_option_group_message.serialize_query(input_, pairs, "")
...
def copy_option_group(
    ...
    capo_rds.types.copy_option_group_result.CopyOptionGroupResult, zapros.Response
]:
