"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBProxyEndpoints``."""
...
import capo_rds.types.describe_db_proxy_endpoints_request
import capo_rds.types.describe_db_proxy_endpoints_response
...
def handle_response(
    ...
    capo_rds.types.describe_db_proxy_endpoints_response.DescribeDBProxyEndpointsResponse
):
    root = fromstring(response.read())
    result = root.find("DescribeDBProxyEndpointsResult")
    out: capo_rds.types.describe_db_proxy_endpoints_response.DescribeDBProxyEndpointsResponse = capo_rds.types.describe_db_proxy_endpoints_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeDBProxyEndpoints"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.describe_db_proxy_endpoints_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_db_proxy_endpoints(
