...
import capo_rds.types.db_cluster_message
import capo_rds.types.describe_db_clusters_message
...
) -> capo_rds.types.db_cluster_message.DBClusterMessage:
    root = fromstring(response.read())
    result = root.find("DescribeDBClustersResult")
    out: capo_rds.types.db_cluster_message.DBClusterMessage = (
        capo_rds.types.db_cluster_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_clusters_message.serialize_query(input_, pairs, "")
...
def describe_db_clusters(
    ...
    input_: capo_rds.types.describe_db_clusters_message.DescribeDBClustersMessage,
) -> tuple[capo_rds.types.db_cluster_message.DBClusterMessage, zapros.Response]:
