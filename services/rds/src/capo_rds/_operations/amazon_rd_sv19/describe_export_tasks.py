...
import capo_rds.types.export_tasks_message
...
) -> capo_rds.types.export_tasks_message.ExportTasksMessage:
    root = fromstring(response.read())
    result = root.find("DescribeExportTasksResult")
    out: capo_rds.types.export_tasks_message.ExportTasksMessage = (
        capo_rds.types.export_tasks_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_export_tasks_message.serialize_query(input_, pairs, "")
...
def describe_export_tasks(
    ...
    input_: capo_rds.types.describe_export_tasks_message.DescribeExportTasksMessage,
) -> tuple[capo_rds.types.export_tasks_message.ExportTasksMessage, zapros.Response]:
