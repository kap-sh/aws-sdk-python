"""Generated from Smithy shape ``com.amazonaws.rds#SwitchoverGlobalCluster``."""
...
import capo_rds.types.switchover_global_cluster_message
import capo_rds.types.switchover_global_cluster_result
...
def handle_response(
    ...
    out: capo_rds.types.switchover_global_cluster_result.SwitchoverGlobalClusterResult = capo_rds.types.switchover_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.switchover_global_cluster_message.serialize_query(input_, pairs, "")
