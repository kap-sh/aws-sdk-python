"""Generated from Smithy shape ``com.amazonaws.rds#DescribeGlobalClusters``."""
...
import capo_rds.types.describe_global_clusters_message
import capo_rds.types.filter_list
import capo_rds.types.global_cluster_list
import capo_rds.types.global_clusters_message
...
) -> capo_rds.types.global_clusters_message.GlobalClustersMessage:
    root = fromstring(response.read())
    result = root.find("DescribeGlobalClustersResult")
    out: capo_rds.types.global_clusters_message.GlobalClustersMessage = (
        capo_rds.types.global_clusters_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_global_clusters_message.serialize_query(input_, pairs, "")
...
def describe_global_clusters(
    ...
    capo_rds.types.global_clusters_message.GlobalClustersMessage, zapros.Response
]:
