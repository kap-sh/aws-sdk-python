...
import capo_rds.types.failover_global_cluster_message
import capo_rds.types.failover_global_cluster_result
...
) -> capo_rds.types.failover_global_cluster_result.FailoverGlobalClusterResult:
    root = fromstring(response.read())
    result = root.find("FailoverGlobalClusterResult")
    out: capo_rds.types.failover_global_cluster_result.FailoverGlobalClusterResult = (
        capo_rds.types.failover_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.failover_global_cluster_message.serialize_query(input_, pairs, "")
