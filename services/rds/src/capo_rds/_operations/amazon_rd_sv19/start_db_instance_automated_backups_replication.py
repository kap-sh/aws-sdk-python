"""Generated from Smithy shape ``com.amazonaws.rds#StartDBInstanceAutomatedBackupsReplication``."""
...
import capo_rds.errors.db_instance_automated_backup_quota_exceeded_fault
import capo_rds.errors.db_instance_not_found_fault
import capo_rds.errors.invalid_db_instance_automated_backup_state_fault
...
import capo_rds.types.start_db_instance_automated_backups_replication_message
import capo_rds.types.start_db_instance_automated_backups_replication_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBInstanceAutomatedBackupQuotaExceeded":
            raise capo_rds.errors.db_instance_automated_backup_quota_exceeded_fault.DBInstanceAutomatedBackupQuotaExceededFault.from_query(
                error_el, message
            )
        ...
        case "InvalidDBInstanceAutomatedBackupState":
            raise capo_rds.errors.invalid_db_instance_automated_backup_state_fault.InvalidDBInstanceAutomatedBackupStateFault.from_query(
                error_el, message
            )
...
) -> capo_rds.types.start_db_instance_automated_backups_replication_result.StartDBInstanceAutomatedBackupsReplicationResult:
    root = fromstring(response.read())
    result = root.find("StartDBInstanceAutomatedBackupsReplicationResult")
    out: capo_rds.types.start_db_instance_automated_backups_replication_result.StartDBInstanceAutomatedBackupsReplicationResult = capo_rds.types.start_db_instance_automated_backups_replication_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "StartDBInstanceAutomatedBackupsReplication"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.start_db_instance_automated_backups_replication_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_start_db_instance_automated_backups_replication(
