"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBRecommendations``."""
...
import capo_rds.types.db_recommendations_message
import capo_rds.types.describe_db_recommendations_message
...
) -> capo_rds.types.db_recommendations_message.DBRecommendationsMessage:
    root = fromstring(response.read())
    result = root.find("DescribeDBRecommendationsResult")
    out: capo_rds.types.db_recommendations_message.DBRecommendationsMessage = (
        capo_rds.types.db_recommendations_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeDBRecommendations"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.describe_db_recommendations_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_db_recommendations(
    ...
    capo_rds.types.db_recommendations_message.DBRecommendationsMessage, zapros.Response
]:
...
async def async_describe_db_recommendations(
