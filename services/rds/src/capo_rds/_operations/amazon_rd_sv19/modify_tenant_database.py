...
import capo_rds.types.modify_tenant_database_message
import capo_rds.types.modify_tenant_database_result
...
) -> capo_rds.types.modify_tenant_database_result.ModifyTenantDatabaseResult:
    root = fromstring(response.read())
    result = root.find("ModifyTenantDatabaseResult")
    out: capo_rds.types.modify_tenant_database_result.ModifyTenantDatabaseResult = (
        capo_rds.types.modify_tenant_database_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.modify_tenant_database_message.serialize_query(input_, pairs, "")
