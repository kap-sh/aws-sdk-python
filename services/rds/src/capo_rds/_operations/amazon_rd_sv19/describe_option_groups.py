...
import capo_rds.types.describe_option_groups_message
import capo_rds.types.filter_list
import capo_rds.types.option_groups
import capo_rds.types.option_groups_list
...
) -> capo_rds.types.option_groups.OptionGroups:
    root = fromstring(response.read())
    result = root.find("DescribeOptionGroupsResult")
    out: capo_rds.types.option_groups.OptionGroups = (
        capo_rds.types.option_groups.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_option_groups_message.serialize_query(input_, pairs, "")
...
def describe_option_groups(
    ...
    input_: capo_rds.types.describe_option_groups_message.DescribeOptionGroupsMessage,
) -> tuple[capo_rds.types.option_groups.OptionGroups, zapros.Response]:
