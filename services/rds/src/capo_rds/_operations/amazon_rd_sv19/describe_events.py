...
import capo_rds.types.describe_events_message
import capo_rds.types.event_categories_list
import capo_rds.types.event_list
import capo_rds.types.events_message
...
) -> capo_rds.types.events_message.EventsMessage:
    root = fromstring(response.read())
    result = root.find("DescribeEventsResult")
    out: capo_rds.types.events_message.EventsMessage = (
        capo_rds.types.events_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_events_message.serialize_query(input_, pairs, "")
...
def describe_events(
    ...
    input_: capo_rds.types.describe_events_message.DescribeEventsMessage,
) -> tuple[capo_rds.types.events_message.EventsMessage, zapros.Response]:
