...
import capo_rds.types.promote_read_replica_message
import capo_rds.types.promote_read_replica_result
...
) -> capo_rds.types.promote_read_replica_result.PromoteReadReplicaResult:
    root = fromstring(response.read())
    result = root.find("PromoteReadReplicaResult")
    out: capo_rds.types.promote_read_replica_result.PromoteReadReplicaResult = (
        capo_rds.types.promote_read_replica_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.promote_read_replica_message.serialize_query(input_, pairs, "")
...
def promote_read_replica(
    ...
    capo_rds.types.promote_read_replica_result.PromoteReadReplicaResult, zapros.Response
]:
