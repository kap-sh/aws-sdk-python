...
import capo_rds.types.db_instance_list
import capo_rds.types.db_instance_message
import capo_rds.types.describe_db_instances_message
...
) -> capo_rds.types.db_instance_message.DBInstanceMessage:
    root = fromstring(response.read())
    result = root.find("DescribeDBInstancesResult")
    out: capo_rds.types.db_instance_message.DBInstanceMessage = (
        capo_rds.types.db_instance_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_instances_message.serialize_query(input_, pairs, "")
...
def describe_db_instances(
    ...
    input_: capo_rds.types.describe_db_instances_message.DescribeDBInstancesMessage,
) -> tuple[capo_rds.types.db_instance_message.DBInstanceMessage, zapros.Response]:
