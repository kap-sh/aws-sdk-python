...
import capo_rds.types.db_security_group_message
import capo_rds.types.db_security_groups
import capo_rds.types.describe_db_security_groups_message
...
) -> capo_rds.types.db_security_group_message.DBSecurityGroupMessage:
    root = fromstring(response.read())
    result = root.find("DescribeDBSecurityGroupsResult")
    out: capo_rds.types.db_security_group_message.DBSecurityGroupMessage = (
        capo_rds.types.db_security_group_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_security_groups_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_db_security_groups(
    ...
    capo_rds.types.db_security_group_message.DBSecurityGroupMessage, zapros.Response
]:
