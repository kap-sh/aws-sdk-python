...
import capo_rds.types.db_snapshot_message
import capo_rds.types.describe_db_snapshots_message
...
) -> capo_rds.types.db_snapshot_message.DBSnapshotMessage:
    root = fromstring(response.read())
    result = root.find("DescribeDBSnapshotsResult")
    out: capo_rds.types.db_snapshot_message.DBSnapshotMessage = (
        capo_rds.types.db_snapshot_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_snapshots_message.serialize_query(input_, pairs, "")
...
def describe_db_snapshots(
    ...
    input_: capo_rds.types.describe_db_snapshots_message.DescribeDBSnapshotsMessage,
) -> tuple[capo_rds.types.db_snapshot_message.DBSnapshotMessage, zapros.Response]:
