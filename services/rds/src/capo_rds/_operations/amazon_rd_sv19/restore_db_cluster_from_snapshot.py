...
import capo_rds.types.restore_db_cluster_from_snapshot_message
import capo_rds.types.restore_db_cluster_from_snapshot_result
...
) -> capo_rds.types.restore_db_cluster_from_snapshot_result.RestoreDBClusterFromSnapshotResult:
    root = fromstring(response.read())
    result = root.find("RestoreDBClusterFromSnapshotResult")
    out: capo_rds.types.restore_db_cluster_from_snapshot_result.RestoreDBClusterFromSnapshotResult = capo_rds.types.restore_db_cluster_from_snapshot_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.restore_db_cluster_from_snapshot_message.serialize_query(
        input_, pairs, ""
    )
