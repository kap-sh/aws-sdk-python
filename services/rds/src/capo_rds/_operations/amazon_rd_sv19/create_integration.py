"""Generated from Smithy shape ``com.amazonaws.rds#CreateIntegration``."""
...
import capo_rds.errors.integration_already_exists_fault
import capo_rds.errors.integration_conflict_operation_fault
import capo_rds.errors.integration_quota_exceeded_fault
import capo_rds.errors.kms_key_not_accessible_fault
import capo_rds.types.create_integration_message
...
def handle_response(
    ...
    out: capo_rds.types.integration.Integration = (
        capo_rds.types.integration.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.create_integration_message.serialize_query(input_, pairs, "")
...
def create_integration(
    ...
    input_: capo_rds.types.create_integration_message.CreateIntegrationMessage,
) -> tuple[capo_rds.types.integration.Integration, zapros.Response]:
