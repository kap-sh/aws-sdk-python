...
import capo_rds.types.promote_read_replica_db_cluster_message
import capo_rds.types.promote_read_replica_db_cluster_result
...
def handle_response(
    ...
    out: capo_rds.types.promote_read_replica_db_cluster_result.PromoteReadReplicaDBClusterResult = capo_rds.types.promote_read_replica_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.promote_read_replica_db_cluster_message.serialize_query(
        input_, pairs, ""
    )
