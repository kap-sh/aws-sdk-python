"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBLogFiles``."""
...
import capo_rds.types.describe_db_log_files_message
import capo_rds.types.describe_db_log_files_response
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeDBLogFilesResult")
    out: capo_rds.types.describe_db_log_files_response.DescribeDBLogFilesResponse = (
        capo_rds.types.describe_db_log_files_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeDBLogFiles"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.describe_db_log_files_message.serialize_query(input_, pairs, "")
...
async def async_describe_db_log_files(
