...
import capo_rds.types.restore_db_instance_from_db_snapshot_message
import capo_rds.types.restore_db_instance_from_db_snapshot_result
...
) -> capo_rds.types.restore_db_instance_from_db_snapshot_result.RestoreDBInstanceFromDBSnapshotResult:
    root = fromstring(response.read())
    result = root.find("RestoreDBInstanceFromDBSnapshotResult")
    out: capo_rds.types.restore_db_instance_from_db_snapshot_result.RestoreDBInstanceFromDBSnapshotResult = capo_rds.types.restore_db_instance_from_db_snapshot_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.restore_db_instance_from_db_snapshot_message.serialize_query(
        input_, pairs, ""
    )
