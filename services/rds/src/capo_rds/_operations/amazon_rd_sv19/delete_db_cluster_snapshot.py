"""Generated from Smithy shape ``com.amazonaws.rds#DeleteDBClusterSnapshot``."""
...
import capo_rds.types.delete_db_cluster_snapshot_message
import capo_rds.types.delete_db_cluster_snapshot_result
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteDBClusterSnapshotResult")
    out: capo_rds.types.delete_db_cluster_snapshot_result.DeleteDBClusterSnapshotResult = capo_rds.types.delete_db_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteDBClusterSnapshot"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.delete_db_cluster_snapshot_message.serialize_query(input_, pairs, "")
...
async def async_delete_db_cluster_snapshot(
