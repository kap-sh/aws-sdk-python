"""Generated from Smithy shape ``com.amazonaws.rds#DeleteDBCluster``."""
...
import capo_rds.errors.db_cluster_automated_backup_quota_exceeded_fault
...
import capo_rds.types.delete_db_cluster_message
import capo_rds.types.delete_db_cluster_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBClusterAutomatedBackupQuotaExceededFault":
            raise capo_rds.errors.db_cluster_automated_backup_quota_exceeded_fault.DBClusterAutomatedBackupQuotaExceededFault.from_query(
                error_el, message
            )
        ...
        case "DBClusterSnapshotAlreadyExistsFault":
            raise capo_rds.errors.db_cluster_snapshot_already_exists_fault.DBClusterSnapshotAlreadyExistsFault.from_query(
                error_el, message
            )
...
) -> capo_rds.types.delete_db_cluster_result.DeleteDBClusterResult:
    root = fromstring(response.read())
    result = root.find("DeleteDBClusterResult")
    out: capo_rds.types.delete_db_cluster_result.DeleteDBClusterResult = (
        capo_rds.types.delete_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.delete_db_cluster_message.serialize_query(input_, pairs, "")
...
def delete_db_cluster(
    ...
    capo_rds.types.delete_db_cluster_result.DeleteDBClusterResult, zapros.Response
]:
