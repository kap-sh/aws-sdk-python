"""Generated from Smithy shape ``com.amazonaws.rds#RemoveSourceIdentifierFromSubscription``."""
...
import capo_rds.errors.source_not_found_fault
import capo_rds.errors.subscription_not_found_fault
import capo_rds.types.event_subscription
import capo_rds.types.remove_source_identifier_from_subscription_message
import capo_rds.types.remove_source_identifier_from_subscription_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "SourceNotFound":
            raise capo_rds.errors.source_not_found_fault.SourceNotFoundFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_rds.types.remove_source_identifier_from_subscription_result.RemoveSourceIdentifierFromSubscriptionResult = capo_rds.types.remove_source_identifier_from_subscription_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.remove_source_identifier_from_subscription_message.serialize_query(
        input_, pairs, ""
    )
