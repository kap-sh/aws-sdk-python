...
import capo_rds.types.restore_db_instance_from_s3_message
import capo_rds.types.restore_db_instance_from_s3_result
...
) -> capo_rds.types.restore_db_instance_from_s3_result.RestoreDBInstanceFromS3Result:
    root = fromstring(response.read())
    result = root.find("RestoreDBInstanceFromS3Result")
    out: capo_rds.types.restore_db_instance_from_s3_result.RestoreDBInstanceFromS3Result = capo_rds.types.restore_db_instance_from_s3_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.restore_db_instance_from_s3_message.serialize_query(
        input_, pairs, ""
    )
