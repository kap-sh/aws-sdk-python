...
import capo_rds.types.describe_db_proxy_target_groups_request
import capo_rds.types.describe_db_proxy_target_groups_response
...
) -> capo_rds.types.describe_db_proxy_target_groups_response.DescribeDBProxyTargetGroupsResponse:
    root = fromstring(response.read())
    result = root.find("DescribeDBProxyTargetGroupsResult")
    out: capo_rds.types.describe_db_proxy_target_groups_response.DescribeDBProxyTargetGroupsResponse = capo_rds.types.describe_db_proxy_target_groups_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_proxy_target_groups_request.serialize_query(
        input_, pairs, ""
    )
