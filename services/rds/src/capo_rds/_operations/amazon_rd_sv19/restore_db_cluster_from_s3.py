...
import capo_rds.types.restore_db_cluster_from_s3_message
import capo_rds.types.restore_db_cluster_from_s3_result
...
) -> capo_rds.types.restore_db_cluster_from_s3_result.RestoreDBClusterFromS3Result:
    root = fromstring(response.read())
    result = root.find("RestoreDBClusterFromS3Result")
    out: capo_rds.types.restore_db_cluster_from_s3_result.RestoreDBClusterFromS3Result = capo_rds.types.restore_db_cluster_from_s3_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.restore_db_cluster_from_s3_message.serialize_query(input_, pairs, "")
