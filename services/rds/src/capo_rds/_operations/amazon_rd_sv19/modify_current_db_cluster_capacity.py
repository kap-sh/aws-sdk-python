...
import capo_rds.errors.invalid_db_cluster_capacity_fault
import capo_rds.errors.invalid_db_cluster_state_fault
import capo_rds.types.db_cluster_capacity_info
import capo_rds.types.modify_current_db_cluster_capacity_message
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDBClusterCapacityFault":
            raise capo_rds.errors.invalid_db_cluster_capacity_fault.InvalidDBClusterCapacityFault.from_query(
                error_el, message
            )
...
) -> capo_rds.types.db_cluster_capacity_info.DBClusterCapacityInfo:
    root = fromstring(response.read())
    result = root.find("ModifyCurrentDBClusterCapacityResult")
    out: capo_rds.types.db_cluster_capacity_info.DBClusterCapacityInfo = (
        capo_rds.types.db_cluster_capacity_info.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.modify_current_db_cluster_capacity_message.serialize_query(
        input_, pairs, ""
    )
...
def modify_current_db_cluster_capacity(
    ...
    capo_rds.types.db_cluster_capacity_info.DBClusterCapacityInfo, zapros.Response
]:
