...
import capo_rds.types.stop_db_instance_message
import capo_rds.types.stop_db_instance_result
...
def handle_response(
    ...
    out: capo_rds.types.stop_db_instance_result.StopDBInstanceResult = (
        capo_rds.types.stop_db_instance_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.stop_db_instance_message.serialize_query(input_, pairs, "")
...
def stop_db_instance(
    ...
    capo_rds.types.stop_db_instance_result.StopDBInstanceResult, zapros.Response
]:
