...
import capo_rds.errors.invalid_integration_state_fault
...
import capo_rds.types.modify_integration_message
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidIntegrationStateFault":
            raise capo_rds.errors.invalid_integration_state_fault.InvalidIntegrationStateFault.from_query(
                error_el, message
            )
        case _:
...
def build_request(
    ...
    capo_rds.types.modify_integration_message.serialize_query(input_, pairs, "")
