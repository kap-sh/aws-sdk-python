"""Generated from Smithy shape ``com.amazonaws.rds#DescribeTenantDatabases``."""
...
import capo_rds.types.describe_tenant_databases_message
...
) -> capo_rds.types.tenant_databases_message.TenantDatabasesMessage:
    root = fromstring(response.read())
    result = root.find("DescribeTenantDatabasesResult")
    out: capo_rds.types.tenant_databases_message.TenantDatabasesMessage = (
        capo_rds.types.tenant_databases_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeTenantDatabases"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.describe_tenant_databases_message.serialize_query(input_, pairs, "")
...
def describe_tenant_databases(
    ...
    capo_rds.types.tenant_databases_message.TenantDatabasesMessage, zapros.Response
]:
...
async def async_describe_tenant_databases(
