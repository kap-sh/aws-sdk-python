...
import capo_rds.types.failover_db_cluster_message
import capo_rds.types.failover_db_cluster_result
...
def handle_response(
    ...
    out: capo_rds.types.failover_db_cluster_result.FailoverDBClusterResult = (
        capo_rds.types.failover_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.failover_db_cluster_message.serialize_query(input_, pairs, "")
...
def failover_db_cluster(
    ...
    capo_rds.types.failover_db_cluster_result.FailoverDBClusterResult, zapros.Response
]:
