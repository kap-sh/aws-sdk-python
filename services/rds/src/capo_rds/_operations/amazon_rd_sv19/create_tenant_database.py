...
import capo_rds.errors.tenant_database_already_exists_fault
import capo_rds.errors.tenant_database_quota_exceeded_fault
import capo_rds.types.create_tenant_database_message
import capo_rds.types.create_tenant_database_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TenantDatabaseAlreadyExists":
            raise capo_rds.errors.tenant_database_already_exists_fault.TenantDatabaseAlreadyExistsFault.from_query(
                error_el, message
            )
...
) -> capo_rds.types.create_tenant_database_result.CreateTenantDatabaseResult:
    root = fromstring(response.read())
    result = root.find("CreateTenantDatabaseResult")
    out: capo_rds.types.create_tenant_database_result.CreateTenantDatabaseResult = (
        capo_rds.types.create_tenant_database_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.create_tenant_database_message.serialize_query(input_, pairs, "")
