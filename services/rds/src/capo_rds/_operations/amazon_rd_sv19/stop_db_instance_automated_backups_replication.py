...
import capo_rds.types.stop_db_instance_automated_backups_replication_message
import capo_rds.types.stop_db_instance_automated_backups_replication_result
...
def handle_response(
    ...
    out: capo_rds.types.stop_db_instance_automated_backups_replication_result.StopDBInstanceAutomatedBackupsReplicationResult = capo_rds.types.stop_db_instance_automated_backups_replication_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.stop_db_instance_automated_backups_replication_message.serialize_query(
        input_, pairs, ""
    )
