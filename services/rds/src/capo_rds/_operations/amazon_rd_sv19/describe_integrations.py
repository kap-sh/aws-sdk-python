...
import capo_rds.types.describe_integrations_message
import capo_rds.types.describe_integrations_response
...
) -> capo_rds.types.describe_integrations_response.DescribeIntegrationsResponse:
    root = fromstring(response.read())
    result = root.find("DescribeIntegrationsResult")
    out: capo_rds.types.describe_integrations_response.DescribeIntegrationsResponse = (
        capo_rds.types.describe_integrations_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_integrations_message.serialize_query(input_, pairs, "")
