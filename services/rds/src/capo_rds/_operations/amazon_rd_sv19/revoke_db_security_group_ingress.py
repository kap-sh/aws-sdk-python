...
import capo_rds.types.revoke_db_security_group_ingress_message
import capo_rds.types.revoke_db_security_group_ingress_result
...
) -> capo_rds.types.revoke_db_security_group_ingress_result.RevokeDBSecurityGroupIngressResult:
    root = fromstring(response.read())
    result = root.find("RevokeDBSecurityGroupIngressResult")
    out: capo_rds.types.revoke_db_security_group_ingress_result.RevokeDBSecurityGroupIngressResult = capo_rds.types.revoke_db_security_group_ingress_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.revoke_db_security_group_ingress_message.serialize_query(
        input_, pairs, ""
    )
