"""Generated from Smithy shape ``com.amazonaws.rds#StopActivityStream``."""
...
import capo_rds.types.stop_activity_stream_request
import capo_rds.types.stop_activity_stream_response
...
) -> capo_rds.types.stop_activity_stream_response.StopActivityStreamResponse:
    root = fromstring(response.read())
    result = root.find("StopActivityStreamResult")
    out: capo_rds.types.stop_activity_stream_response.StopActivityStreamResponse = (
        capo_rds.types.stop_activity_stream_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "StopActivityStream"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.stop_activity_stream_request.serialize_query(input_, pairs, "")
...
async def async_stop_activity_stream(
