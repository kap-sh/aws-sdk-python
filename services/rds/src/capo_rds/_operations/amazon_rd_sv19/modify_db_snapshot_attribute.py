...
import capo_rds.types.modify_db_snapshot_attribute_message
import capo_rds.types.modify_db_snapshot_attribute_result
...
def handle_response(
    ...
    out: capo_rds.types.modify_db_snapshot_attribute_result.ModifyDBSnapshotAttributeResult = capo_rds.types.modify_db_snapshot_attribute_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.modify_db_snapshot_attribute_message.serialize_query(
        input_, pairs, ""
    )
