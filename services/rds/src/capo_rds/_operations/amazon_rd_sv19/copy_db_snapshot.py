...
import capo_rds.errors.custom_availability_zone_not_found_fault
...
import capo_rds.types.copy_db_snapshot_message
import capo_rds.types.copy_db_snapshot_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CustomAvailabilityZoneNotFound":
            raise capo_rds.errors.custom_availability_zone_not_found_fault.CustomAvailabilityZoneNotFoundFault.from_query(
                error_el, message
            )
...
) -> capo_rds.types.copy_db_snapshot_result.CopyDBSnapshotResult:
    root = fromstring(response.read())
    result = root.find("CopyDBSnapshotResult")
    out: capo_rds.types.copy_db_snapshot_result.CopyDBSnapshotResult = (
        capo_rds.types.copy_db_snapshot_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.copy_db_snapshot_message.serialize_query(input_, pairs, "")
...
def copy_db_snapshot(
    ...
    capo_rds.types.copy_db_snapshot_result.CopyDBSnapshotResult, zapros.Response
]:
