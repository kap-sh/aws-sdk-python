"""Generated from Smithy shape ``com.amazonaws.rds#AddRoleToDBInstance``."""
...
import capo_rds.errors.db_instance_role_already_exists_fault
import capo_rds.errors.db_instance_role_quota_exceeded_fault
import capo_rds.errors.invalid_db_instance_state_fault
import capo_rds.types.add_role_to_db_instance_message
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBInstanceRoleAlreadyExists":
            raise capo_rds.errors.db_instance_role_already_exists_fault.DBInstanceRoleAlreadyExistsFault.from_query(
                error_el, message
            )
        case "DBInstanceRoleQuotaExceeded":
            raise capo_rds.errors.db_instance_role_quota_exceeded_fault.DBInstanceRoleQuotaExceededFault.from_query(
                error_el, message
            )
...
def build_request(
    ...
    pairs.append(("Action", "AddRoleToDBInstance"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.add_role_to_db_instance_message.serialize_query(input_, pairs, "")
...
async def async_add_role_to_db_instance(
