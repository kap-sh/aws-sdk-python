...
import capo_rds.errors.invalid_resource_state_fault
import capo_rds.errors.resource_not_found_fault
import capo_rds.types.enable_http_endpoint_request
import capo_rds.types.enable_http_endpoint_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidResourceStateFault":
            raise capo_rds.errors.invalid_resource_state_fault.InvalidResourceStateFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_rds.types.enable_http_endpoint_response.EnableHttpEndpointResponse = (
        capo_rds.types.enable_http_endpoint_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.enable_http_endpoint_request.serialize_query(input_, pairs, "")
