...
import capo_rds.types.delete_db_instance_automated_backup_message
import capo_rds.types.delete_db_instance_automated_backup_result
...
) -> capo_rds.types.delete_db_instance_automated_backup_result.DeleteDBInstanceAutomatedBackupResult:
    root = fromstring(response.read())
    result = root.find("DeleteDBInstanceAutomatedBackupResult")
    out: capo_rds.types.delete_db_instance_automated_backup_result.DeleteDBInstanceAutomatedBackupResult = capo_rds.types.delete_db_instance_automated_backup_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.delete_db_instance_automated_backup_message.serialize_query(
        input_, pairs, ""
    )
