...
) -> capo_rds.types.db_recommendation_message.DBRecommendationMessage:
    root = fromstring(response.read())
    result = root.find("ModifyDBRecommendationResult")
    out: capo_rds.types.db_recommendation_message.DBRecommendationMessage = (
        capo_rds.types.db_recommendation_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.modify_db_recommendation_message.serialize_query(input_, pairs, "")
...
def modify_db_recommendation(
    ...
    capo_rds.types.db_recommendation_message.DBRecommendationMessage, zapros.Response
]:
