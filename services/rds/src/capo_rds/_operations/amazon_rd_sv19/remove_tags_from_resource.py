"""Generated from Smithy shape ``com.amazonaws.rds#RemoveTagsFromResource``."""
...
import capo_rds.errors.invalid_db_cluster_endpoint_state_fault
...
def build_request(
    ...
    capo_rds.types.remove_tags_from_resource_message.serialize_query(input_, pairs, "")
