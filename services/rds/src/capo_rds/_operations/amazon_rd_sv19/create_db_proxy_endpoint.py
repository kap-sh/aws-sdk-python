...
import capo_rds.errors.db_proxy_endpoint_already_exists_fault
import capo_rds.errors.db_proxy_endpoint_quota_exceeded_fault
...
import capo_rds.types.create_db_proxy_endpoint_request
import capo_rds.types.create_db_proxy_endpoint_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBProxyEndpointQuotaExceededFault":
            raise capo_rds.errors.db_proxy_endpoint_quota_exceeded_fault.DBProxyEndpointQuotaExceededFault.from_query(
                error_el, message
            )
...
) -> capo_rds.types.create_db_proxy_endpoint_response.CreateDBProxyEndpointResponse:
    root = fromstring(response.read())
    result = root.find("CreateDBProxyEndpointResult")
    out: capo_rds.types.create_db_proxy_endpoint_response.CreateDBProxyEndpointResponse = capo_rds.types.create_db_proxy_endpoint_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.create_db_proxy_endpoint_request.serialize_query(input_, pairs, "")
