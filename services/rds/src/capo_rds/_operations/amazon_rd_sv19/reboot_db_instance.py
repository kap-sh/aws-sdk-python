"""Generated from Smithy shape ``com.amazonaws.rds#RebootDBInstance``."""
...
import capo_rds.types.reboot_db_instance_message
import capo_rds.types.reboot_db_instance_result
...
) -> capo_rds.types.reboot_db_instance_result.RebootDBInstanceResult:
    root = fromstring(response.read())
    result = root.find("RebootDBInstanceResult")
    out: capo_rds.types.reboot_db_instance_result.RebootDBInstanceResult = (
        capo_rds.types.reboot_db_instance_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.reboot_db_instance_message.serialize_query(input_, pairs, "")
...
def reboot_db_instance(
    ...
    capo_rds.types.reboot_db_instance_result.RebootDBInstanceResult, zapros.Response
]:
