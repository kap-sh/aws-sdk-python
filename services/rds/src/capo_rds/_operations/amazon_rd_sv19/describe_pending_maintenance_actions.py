...
import capo_rds.types.describe_pending_maintenance_actions_message
import capo_rds.types.filter_list
import capo_rds.types.pending_maintenance_actions
import capo_rds.types.pending_maintenance_actions_message
...
def handle_response(
    ...
    capo_rds.types.pending_maintenance_actions_message.PendingMaintenanceActionsMessage
):
    root = fromstring(response.read())
    result = root.find("DescribePendingMaintenanceActionsResult")
    out: capo_rds.types.pending_maintenance_actions_message.PendingMaintenanceActionsMessage = capo_rds.types.pending_maintenance_actions_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_pending_maintenance_actions_message.serialize_query(
        input_, pairs, ""
    )
