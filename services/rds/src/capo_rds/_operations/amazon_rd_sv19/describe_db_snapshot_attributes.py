"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBSnapshotAttributes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeDBSnapshotAttributesResult")
    out: capo_rds.types.describe_db_snapshot_attributes_result.DescribeDBSnapshotAttributesResult = capo_rds.types.describe_db_snapshot_attributes_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_snapshot_attributes_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_db_snapshot_attributes(
