...
import capo_rds.types.switchover_read_replica_message
import capo_rds.types.switchover_read_replica_result
...
def handle_response(
    ...
    out: capo_rds.types.switchover_read_replica_result.SwitchoverReadReplicaResult = (
        capo_rds.types.switchover_read_replica_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.switchover_read_replica_message.serialize_query(input_, pairs, "")
