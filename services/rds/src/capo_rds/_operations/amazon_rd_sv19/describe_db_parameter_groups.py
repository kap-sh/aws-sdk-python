"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBParameterGroups``."""
...
import capo_rds.types.db_parameter_groups_message
import capo_rds.types.describe_db_parameter_groups_message
...
) -> capo_rds.types.db_parameter_groups_message.DBParameterGroupsMessage:
    root = fromstring(response.read())
    result = root.find("DescribeDBParameterGroupsResult")
    out: capo_rds.types.db_parameter_groups_message.DBParameterGroupsMessage = (
        capo_rds.types.db_parameter_groups_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeDBParameterGroups"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.describe_db_parameter_groups_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_db_parameter_groups(
    ...
    capo_rds.types.db_parameter_groups_message.DBParameterGroupsMessage, zapros.Response
]:
...
async def async_describe_db_parameter_groups(
