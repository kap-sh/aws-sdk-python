...
import capo_rds.errors.invalid_db_subnet_state_fault
import capo_rds.types.delete_db_subnet_group_message
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDBSubnetStateFault":
            raise capo_rds.errors.invalid_db_subnet_state_fault.InvalidDBSubnetStateFault.from_query(
                error_el, message
            )
        case _:
...
def build_request(
    ...
    capo_rds.types.delete_db_subnet_group_message.serialize_query(input_, pairs, "")
