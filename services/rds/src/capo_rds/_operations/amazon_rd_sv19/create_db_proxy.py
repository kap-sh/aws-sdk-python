...
import capo_rds.errors.db_proxy_already_exists_fault
import capo_rds.errors.db_proxy_quota_exceeded_fault
import capo_rds.errors.invalid_subnet
import capo_rds.types.create_db_proxy_request
import capo_rds.types.create_db_proxy_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBProxyAlreadyExistsFault":
            raise capo_rds.errors.db_proxy_already_exists_fault.DBProxyAlreadyExistsFault.from_query(
                error_el, message
            )
        case "DBProxyQuotaExceededFault":
            raise capo_rds.errors.db_proxy_quota_exceeded_fault.DBProxyQuotaExceededFault.from_query(
                error_el, message
            )
        case "InvalidSubnet":
...
) -> capo_rds.types.create_db_proxy_response.CreateDBProxyResponse:
    root = fromstring(response.read())
    result = root.find("CreateDBProxyResult")
    out: capo_rds.types.create_db_proxy_response.CreateDBProxyResponse = (
        capo_rds.types.create_db_proxy_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.create_db_proxy_request.serialize_query(input_, pairs, "")
...
def create_db_proxy(
    ...
    capo_rds.types.create_db_proxy_response.CreateDBProxyResponse, zapros.Response
]:
