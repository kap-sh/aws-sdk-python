...
import capo_rds.types.db_cluster_endpoint_message
import capo_rds.types.describe_db_cluster_endpoints_message
...
def handle_response(
    ...
    out: capo_rds.types.db_cluster_endpoint_message.DBClusterEndpointMessage = (
        capo_rds.types.db_cluster_endpoint_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_cluster_endpoints_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_db_cluster_endpoints(
    ...
    capo_rds.types.db_cluster_endpoint_message.DBClusterEndpointMessage, zapros.Response
]:
