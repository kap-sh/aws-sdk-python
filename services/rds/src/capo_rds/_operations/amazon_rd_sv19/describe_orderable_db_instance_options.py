...
import capo_rds.types.describe_orderable_db_instance_options_message
import capo_rds.types.filter_list
import capo_rds.types.orderable_db_instance_options_list
import capo_rds.types.orderable_db_instance_options_message
...
) -> capo_rds.types.orderable_db_instance_options_message.OrderableDBInstanceOptionsMessage:
    root = fromstring(response.read())
    result = root.find("DescribeOrderableDBInstanceOptionsResult")
    out: capo_rds.types.orderable_db_instance_options_message.OrderableDBInstanceOptionsMessage = capo_rds.types.orderable_db_instance_options_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_orderable_db_instance_options_message.serialize_query(
        input_, pairs, ""
    )
