"""Generated from Smithy shape ``com.amazonaws.rds#CreateDBInstance``."""
...
import capo_rds.types.create_db_instance_message
import capo_rds.types.create_db_instance_result
...
) -> capo_rds.types.create_db_instance_result.CreateDBInstanceResult:
    root = fromstring(response.read())
    result = root.find("CreateDBInstanceResult")
    out: capo_rds.types.create_db_instance_result.CreateDBInstanceResult = (
        capo_rds.types.create_db_instance_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.create_db_instance_message.serialize_query(input_, pairs, "")
...
def create_db_instance(
    ...
    capo_rds.types.create_db_instance_result.CreateDBInstanceResult, zapros.Response
]:
