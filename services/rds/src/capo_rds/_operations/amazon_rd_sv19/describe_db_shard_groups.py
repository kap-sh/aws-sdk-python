...
import capo_rds.types.db_shard_groups_list
import capo_rds.types.describe_db_shard_groups_message
import capo_rds.types.describe_db_shard_groups_response
...
) -> capo_rds.types.describe_db_shard_groups_response.DescribeDBShardGroupsResponse:
    root = fromstring(response.read())
    result = root.find("DescribeDBShardGroupsResult")
    out: capo_rds.types.describe_db_shard_groups_response.DescribeDBShardGroupsResponse = capo_rds.types.describe_db_shard_groups_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_shard_groups_message.serialize_query(input_, pairs, "")
