"""Generated from Smithy shape ``com.amazonaws.rds#DeleteBlueGreenDeployment``."""
...
import capo_rds.types.delete_blue_green_deployment_request
import capo_rds.types.delete_blue_green_deployment_response
...
) -> capo_rds.types.delete_blue_green_deployment_response.DeleteBlueGreenDeploymentResponse:
    root = fromstring(response.read())
    result = root.find("DeleteBlueGreenDeploymentResult")
    out: capo_rds.types.delete_blue_green_deployment_response.DeleteBlueGreenDeploymentResponse = capo_rds.types.delete_blue_green_deployment_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.delete_blue_green_deployment_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_blue_green_deployment(
