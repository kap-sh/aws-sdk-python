"""Generated from Smithy shape ``com.amazonaws.rds#ListTagsForResource``."""
...
import capo_rds.errors.blue_green_deployment_not_found_fault
import capo_rds.errors.db_cluster_not_found_fault
import capo_rds.errors.db_instance_not_found_fault
import capo_rds.errors.db_proxy_endpoint_not_found_fault
import capo_rds.errors.db_proxy_not_found_fault
import capo_rds.errors.db_proxy_target_group_not_found_fault
import capo_rds.errors.db_shard_group_not_found_fault
import capo_rds.errors.db_snapshot_not_found_fault
import capo_rds.errors.db_snapshot_tenant_database_not_found_fault
import capo_rds.errors.integration_not_found_fault
import capo_rds.errors.tenant_database_not_found_fault
import capo_rds.types.filter_list
import capo_rds.types.list_tags_for_resource_message
import capo_rds.types.tag_list
import capo_rds.types.tag_list_message
...
def handle_response(
    ...
    out: capo_rds.types.tag_list_message.TagListMessage = (
        capo_rds.types.tag_list_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.list_tags_for_resource_message.serialize_query(input_, pairs, "")
...
def list_tags_for_resource(
    ...
    input_: capo_rds.types.list_tags_for_resource_message.ListTagsForResourceMessage,
) -> tuple[capo_rds.types.tag_list_message.TagListMessage, zapros.Response]:
