"""Generated from Smithy shape ``com.amazonaws.rds#ModifyOptionGroup``."""
...
import capo_rds.errors.invalid_option_group_state_fault
import capo_rds.errors.option_group_not_found_fault
import capo_rds.types.modify_option_group_message
import capo_rds.types.modify_option_group_result
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidOptionGroupStateFault":
            raise capo_rds.errors.invalid_option_group_state_fault.InvalidOptionGroupStateFault.from_query(
                error_el, message
            )
...
) -> capo_rds.types.modify_option_group_result.ModifyOptionGroupResult:
    root = fromstring(response.read())
    result = root.find("ModifyOptionGroupResult")
    out: capo_rds.types.modify_option_group_result.ModifyOptionGroupResult = (
        capo_rds.types.modify_option_group_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyOptionGroup"))
    pairs.append(("Version", "2014-10-31"))
    capo_rds.types.modify_option_group_message.serialize_query(input_, pairs, "")
...
def modify_option_group(
    ...
    capo_rds.types.modify_option_group_result.ModifyOptionGroupResult, zapros.Response
]:
...
async def async_modify_option_group(
