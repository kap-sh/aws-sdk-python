...
) -> capo_rds.types.modify_db_proxy_endpoint_response.ModifyDBProxyEndpointResponse:
    root = fromstring(response.read())
    result = root.find("ModifyDBProxyEndpointResult")
    out: capo_rds.types.modify_db_proxy_endpoint_response.ModifyDBProxyEndpointResponse = capo_rds.types.modify_db_proxy_endpoint_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.modify_db_proxy_endpoint_request.serialize_query(input_, pairs, "")
