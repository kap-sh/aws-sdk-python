...
import capo_rds.types.modify_certificates_message
import capo_rds.types.modify_certificates_result
...
) -> capo_rds.types.modify_certificates_result.ModifyCertificatesResult:
    root = fromstring(response.read())
    result = root.find("ModifyCertificatesResult")
    out: capo_rds.types.modify_certificates_result.ModifyCertificatesResult = (
        capo_rds.types.modify_certificates_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.modify_certificates_message.serialize_query(input_, pairs, "")
...
def modify_certificates(
    ...
    capo_rds.types.modify_certificates_result.ModifyCertificatesResult, zapros.Response
]:
