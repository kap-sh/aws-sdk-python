...
import capo_rds.types.modify_db_proxy_request
import capo_rds.types.modify_db_proxy_response
...
) -> capo_rds.types.modify_db_proxy_response.ModifyDBProxyResponse:
    root = fromstring(response.read())
    result = root.find("ModifyDBProxyResult")
    out: capo_rds.types.modify_db_proxy_response.ModifyDBProxyResponse = (
        capo_rds.types.modify_db_proxy_response.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.modify_db_proxy_request.serialize_query(input_, pairs, "")
...
def modify_db_proxy(
    ...
    capo_rds.types.modify_db_proxy_response.ModifyDBProxyResponse, zapros.Response
]:
