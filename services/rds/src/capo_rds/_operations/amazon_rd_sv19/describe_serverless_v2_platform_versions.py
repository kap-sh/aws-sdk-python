"""Generated from Smithy shape ``com.amazonaws.rds#DescribeServerlessV2PlatformVersions``."""
...
import capo_rds.types.describe_serverless_v2_platform_versions_message
import capo_rds.types.filter_list
import capo_rds.types.serverless_v2_platform_version_list
import capo_rds.types.serverless_v2_platform_versions_message
...
) -> capo_rds.types.serverless_v2_platform_versions_message.ServerlessV2PlatformVersionsMessage:
    root = fromstring(response.read())
    result = root.find("DescribeServerlessV2PlatformVersionsResult")
    out: capo_rds.types.serverless_v2_platform_versions_message.ServerlessV2PlatformVersionsMessage = capo_rds.types.serverless_v2_platform_versions_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_serverless_v2_platform_versions_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_serverless_v2_platform_versions(
