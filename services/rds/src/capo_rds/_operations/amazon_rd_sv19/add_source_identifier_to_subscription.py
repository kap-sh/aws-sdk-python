...
import capo_rds.types.add_source_identifier_to_subscription_message
import capo_rds.types.add_source_identifier_to_subscription_result
...
def handle_response(
    ...
    out: capo_rds.types.add_source_identifier_to_subscription_result.AddSourceIdentifierToSubscriptionResult = capo_rds.types.add_source_identifier_to_subscription_result.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.add_source_identifier_to_subscription_message.serialize_query(
        input_, pairs, ""
    )
