"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBSubnetGroups``."""
...
import capo_rds.types.db_subnet_group_message
import capo_rds.types.db_subnet_groups
import capo_rds.types.describe_db_subnet_groups_message
...
) -> capo_rds.types.db_subnet_group_message.DBSubnetGroupMessage:
    root = fromstring(response.read())
    result = root.find("DescribeDBSubnetGroupsResult")
    out: capo_rds.types.db_subnet_group_message.DBSubnetGroupMessage = (
        capo_rds.types.db_subnet_group_message.deserialize_query(
...
def build_request(
    ...
    capo_rds.types.describe_db_subnet_groups_message.serialize_query(input_, pairs, "")
...
def describe_db_subnet_groups(
    ...
    capo_rds.types.db_subnet_group_message.DBSubnetGroupMessage, zapros.Response
]:
...
async def async_describe_db_subnet_groups(
