"""Generated from Smithy shape ``com.amazonaws.rds#RegisterDBProxyTargetsRequest``."""
...
class RegisterDBProxyTargetsRequest(TypedDict, closed=True):
    ...
    db_instance_identifiers: NotRequired["capo_rds.types.string_list.StringList"]
    """<p>One or more DB instance identifiers.</p>"""
    db_cluster_identifiers: NotRequired["capo_rds.types.string_list.StringList"]
    """<p>One or more DB cluster identifiers.</p>"""


# --- awsQuery ser/de ---
def serialize_query(
    value: RegisterDBProxyTargetsRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
    ...
    if "db_instance_identifiers" in value:
        ...
        capo_rds.types.string_list.serialize_query(
            value["db_instance_identifiers"],
            pairs,
            f"{key_prefix}DBInstanceIdentifiers",
        )
    if "db_cluster_identifiers" in value:
        import capo_rds.types.string_list

        capo_rds.types.string_list.serialize_query(
            value["db_cluster_identifiers"], pairs, f"{key_prefix}DBClusterIdentifiers"
        )


def deserialize_query(el: Element) -> RegisterDBProxyTargetsRequest:
    out: RegisterDBProxyTargetsRequest = {}  # type: ignore[typeddict-item]
    ...
    if child_db_instance_identifiers is not None:
        ...
        out["db_instance_identifiers"] = capo_rds.types.string_list.deserialize_query(
    ...
    if child_db_cluster_identifiers is not None:
        ...
        out["db_cluster_identifiers"] = capo_rds.types.string_list.deserialize_query(
