"""Generated from Smithy shape ``com.amazonaws.rds#EventCategoriesMessage``."""
...
if TYPE_CHECKING:
    import capo_rds.types.event_categories_map_list


class EventCategoriesMessage(TypedDict, closed=True):
    event_categories_map_list: NotRequired[
        "capo_rds.types.event_categories_map_list.EventCategoriesMapList"
    ]
...
def serialize_query(
    ...
    if "event_categories_map_list" in value:
        ...
        capo_rds.types.event_categories_map_list.serialize_query(
...
def deserialize_query(el: Element) -> EventCategoriesMessage:
    ...
    if child_event_categories_map_list is not None:
        ...
        out["event_categories_map_list"] = (
            capo_rds.types.event_categories_map_list.deserialize_query(
