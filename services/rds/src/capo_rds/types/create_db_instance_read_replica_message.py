...
def serialize_query(
    ...
    if "upgrade_storage_config" in value:
        pairs.append(
            (
                f"{key_prefix}UpgradeStorageConfig",
