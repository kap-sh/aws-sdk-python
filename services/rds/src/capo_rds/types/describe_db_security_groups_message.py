"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBSecurityGroupsMessage``."""
...
class DescribeDBSecurityGroupsMessage(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DescribeDBSecurityGroupsMessage, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DescribeDBSecurityGroupsMessage:
    out: DescribeDBSecurityGroupsMessage = {}  # type: ignore[typeddict-item]
