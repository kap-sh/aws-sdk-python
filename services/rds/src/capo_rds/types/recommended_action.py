...
class RecommendedAction(TypedDict, closed=True):
    ...
    title: NotRequired["capo_rds.types.string.String"]
    ...
    operation: NotRequired["capo_rds.types.string.String"]
    """<p>An API operation for the action.</p>"""
    parameters: NotRequired[
        "capo_rds.types.recommended_action_parameter_list.RecommendedActionParameterList"
    ]
    """<p>The parameters for the API operation.</p>"""
    apply_modes: NotRequired["capo_rds.types.string_list.StringList"]
    ...
    context_attributes: NotRequired[
        "capo_rds.types.context_attribute_list.ContextAttributeList"
    ]
...
def deserialize_query(el: Element) -> RecommendedAction:
    ...
    if child_parameters is not None:
        ...
        out["parameters"] = (
            capo_rds.types.recommended_action_parameter_list.deserialize_query(
                child_parameters
            )
        )
    ...
    if child_apply_modes is not None:
        ...
        out["apply_modes"] = capo_rds.types.string_list.deserialize_query(
            child_apply_modes
        )
    ...
    if child_context_attributes is not None:
        ...
        out["context_attributes"] = (
            capo_rds.types.context_attribute_list.deserialize_query(
