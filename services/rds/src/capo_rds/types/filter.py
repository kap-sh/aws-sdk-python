...
if TYPE_CHECKING:
    import capo_rds.types.filter_value_list
...
class Filter(TypedDict, closed=True):
    ...
    values: NotRequired["capo_rds.types.filter_value_list.FilterValueList"]
...
def serialize_query(value: Filter, pairs: list[tuple[str, str]], prefix: str) -> None:
    ...
    if "values" in value:
        ...
        capo_rds.types.filter_value_list.serialize_query(
...
def deserialize_query(el: Element) -> Filter:
    ...
    if child_values is not None:
        ...
        out["values"] = capo_rds.types.filter_value_list.deserialize_query(child_values)
    return out
