...
class DBClusterCapacityInfo(TypedDict, closed=True):
    ...
    pending_capacity: NotRequired["capo_rds.types.integer_optional.IntegerOptional"]
    """<p>A value that specifies the capacity that the DB cluster scales to next.</p>"""
    current_capacity: NotRequired["capo_rds.types.integer_optional.IntegerOptional"]
