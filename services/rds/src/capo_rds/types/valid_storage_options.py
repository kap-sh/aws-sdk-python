...
class ValidStorageOptions(TypedDict, closed=True):
    ...
    storage_size: NotRequired["capo_rds.types.range_list.RangeList"]
    """<p>The valid range of storage in gibibytes (GiB). For example, 100 to 16,384.</p>"""
    provisioned_iops: NotRequired["capo_rds.types.range_list.RangeList"]
    """<p>The valid range of provisioned IOPS. For example, 1000-256,000.</p>"""
    iops_to_storage_ratio: NotRequired[
        "capo_rds.types.double_range_list.DoubleRangeList"
    ]
    ...
    provisioned_storage_throughput: NotRequired["capo_rds.types.range_list.RangeList"]
...
def deserialize_query(el: Element) -> ValidStorageOptions:
    ...
    if child_storage_size is not None:
        ...
        out["storage_size"] = capo_rds.types.range_list.deserialize_query(
            child_storage_size
        )
    ...
    if child_provisioned_iops is not None:
        ...
        out["provisioned_iops"] = capo_rds.types.range_list.deserialize_query(
    ...
    if child_iops_to_storage_ratio is not None:
        ...
        out["iops_to_storage_ratio"] = (
            capo_rds.types.double_range_list.deserialize_query(
    ...
    if child_provisioned_storage_throughput is not None:
        ...
        out["provisioned_storage_throughput"] = (
            capo_rds.types.range_list.deserialize_query(
