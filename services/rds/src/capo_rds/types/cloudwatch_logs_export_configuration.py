...
class CloudwatchLogsExportConfiguration(TypedDict, closed=True):
    enable_log_types: NotRequired["capo_rds.types.log_type_list.LogTypeList"]
    ...
    disable_log_types: NotRequired["capo_rds.types.log_type_list.LogTypeList"]
...
def deserialize_query(el: Element) -> CloudwatchLogsExportConfiguration:
    ...
    if child_enable_log_types is not None:
        ...
        out["enable_log_types"] = capo_rds.types.log_type_list.deserialize_query(
    ...
    if child_disable_log_types is not None:
        ...
        out["disable_log_types"] = capo_rds.types.log_type_list.deserialize_query(
