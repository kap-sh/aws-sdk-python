...
class ModifyDBProxyRequest(TypedDict, closed=True):
    ...
    new_db_proxy_name: NotRequired["capo_rds.types.db_proxy_name.DBProxyName"]
    ...
    auth: NotRequired["capo_rds.types.user_auth_config_list.UserAuthConfigList"]
    """<p>The new authentication settings for the <code>DBProxy</code>.</p>"""
    require_tls: NotRequired["capo_rds.types.boolean_optional.BooleanOptional"]
    ...
    idle_client_timeout: NotRequired["capo_rds.types.integer_optional.IntegerOptional"]
    ...
    debug_logging: NotRequired["capo_rds.types.boolean_optional.BooleanOptional"]
    ...
    role_arn: NotRequired["capo_rds.types.arn.Arn"]
    ...
    security_groups: NotRequired["capo_rds.types.string_list.StringList"]
...
def deserialize_query(el: Element) -> ModifyDBProxyRequest:
    ...
    if child_default_auth_scheme is not None:
        ...
        out["default_auth_scheme"] = (
            capo_rds.types.default_auth_scheme.deserialize_query(
    ...
    if child_auth is not None:
        ...
        out["auth"] = capo_rds.types.user_auth_config_list.deserialize_query(child_auth)
    ...
    if child_security_groups is not None:
        ...
        out["security_groups"] = capo_rds.types.string_list.deserialize_query(
