"""Generated from Smithy shape ``com.amazonaws.rds#ModifyDBClusterSnapshotAttributeMessage``."""
...
class ModifyDBClusterSnapshotAttributeMessage(TypedDict, closed=True):
    ...
    values_to_add: NotRequired["capo_rds.types.attribute_value_list.AttributeValueList"]
...
def deserialize_query(el: Element) -> ModifyDBClusterSnapshotAttributeMessage:
    ...
    if child_values_to_add is not None:
        ...
        out["values_to_add"] = capo_rds.types.attribute_value_list.deserialize_query(
            child_values_to_add
        )
    ...
    if child_values_to_remove is not None:
        ...
        out["values_to_remove"] = capo_rds.types.attribute_value_list.deserialize_query(
