...
if TYPE_CHECKING:
    ...
    import capo_rds.types.custom_engine_version_status
...
def serialize_query(
    ...
    if "status" in value:
        ...
        capo_rds.types.custom_engine_version_status.serialize_query(
...
def deserialize_query(el: Element) -> ModifyCustomDBEngineVersionMessage:
    ...
    if child_status is not None:
        ...
        out["status"] = capo_rds.types.custom_engine_version_status.deserialize_query(
            child_status
        )
    return out
