"""Generated from Smithy shape ``com.amazonaws.rds#Range``."""
...
Range = TypedDict(
    "Range",
    {
        "from": NotRequired["capo_rds.types.integer.Integer"],
        "to": NotRequired["capo_rds.types.integer.Integer"],
        "step": NotRequired["capo_rds.types.integer_optional.IntegerOptional"],
    },
    closed=True,
)
