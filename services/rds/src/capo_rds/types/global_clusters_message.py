...
class GlobalClustersMessage(TypedDict, closed=True):
    ...
    global_clusters: NotRequired["capo_rds.types.global_cluster_list.GlobalClusterList"]
...
def serialize_query(
    ...
    if "global_clusters" in value:
        ...
        capo_rds.types.global_cluster_list.serialize_query(
...
def deserialize_query(el: Element) -> GlobalClustersMessage:
    ...
    if child_global_clusters is not None:
        ...
        out["global_clusters"] = capo_rds.types.global_cluster_list.deserialize_query(
