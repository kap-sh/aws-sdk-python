...
class DBSecurityGroup(TypedDict, closed=True):
    owner_id: NotRequired["capo_rds.types.string.String"]
    ...
    ec2_security_groups: NotRequired[
        "capo_rds.types.ec2_security_group_list.EC2SecurityGroupList"
    ]
    """<p>Contains a list of <code>EC2SecurityGroup</code> elements.</p>"""
    ip_ranges: NotRequired["capo_rds.types.ip_range_list.IPRangeList"]
    """<p>Contains a list of <code>IPRange</code> elements.</p>"""
    db_security_group_arn: NotRequired["capo_rds.types.string.String"]
...
def deserialize_query(el: Element) -> DBSecurityGroup:
    ...
    if child_ec2_security_groups is not None:
        ...
        out["ec2_security_groups"] = (
            capo_rds.types.ec2_security_group_list.deserialize_query(
    ...
    if child_ip_ranges is not None:
        ...
        out["ip_ranges"] = capo_rds.types.ip_range_list.deserialize_query(
            child_ip_ranges
        )
