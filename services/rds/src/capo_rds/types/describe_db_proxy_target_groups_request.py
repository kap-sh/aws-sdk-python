"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBProxyTargetGroupsRequest``."""
...
class DescribeDBProxyTargetGroupsRequest(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DescribeDBProxyTargetGroupsRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DescribeDBProxyTargetGroupsRequest:
    out: DescribeDBProxyTargetGroupsRequest = {}  # type: ignore[typeddict-item]
