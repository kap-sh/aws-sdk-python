...
class ReservedDBInstanceMessage(TypedDict, closed=True):
    ...
    reserved_db_instances: NotRequired[
        "capo_rds.types.reserved_db_instance_list.ReservedDBInstanceList"
    ]
...
def serialize_query(
    ...
    if "reserved_db_instances" in value:
        ...
        capo_rds.types.reserved_db_instance_list.serialize_query(
            value["reserved_db_instances"], pairs, f"{key_prefix}ReservedDBInstances"
        )
...
def deserialize_query(el: Element) -> ReservedDBInstanceMessage:
    ...
    if child_reserved_db_instances is not None:
        ...
        out["reserved_db_instances"] = (
            capo_rds.types.reserved_db_instance_list.deserialize_query(
