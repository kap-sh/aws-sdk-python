...
class ReservedDBInstance(TypedDict, closed=True):
    ...
    db_instance_count: NotRequired["capo_rds.types.integer.Integer"]
    ...
    state: NotRequired["capo_rds.types.string.String"]
    ...
    reserved_db_instance_arn: NotRequired["capo_rds.types.string.String"]
