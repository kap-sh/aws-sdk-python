...
class DBClusterEndpoint(TypedDict, closed=True):
    ...
    db_cluster_endpoint_resource_identifier: NotRequired["capo_rds.types.string.String"]
    ...
    custom_endpoint_type: NotRequired["capo_rds.types.string.String"]
    ...
    db_cluster_endpoint_arn: NotRequired["capo_rds.types.string.String"]
