...
class ExportTask(TypedDict, closed=True):
    ...
    export_only: NotRequired["capo_rds.types.string_list.StringList"]
    ...
    snapshot_time: NotRequired["capo_rds.types.t_stamp.TStamp"]
    """<p>The time when the snapshot was created.</p>"""
    task_start_time: NotRequired["capo_rds.types.t_stamp.TStamp"]
    """<p>The time when the snapshot or cluster export task started.</p>"""
    task_end_time: NotRequired["capo_rds.types.t_stamp.TStamp"]
    """<p>The time when the snapshot or cluster export task ended.</p>"""
    s3_bucket: NotRequired["capo_rds.types.string.String"]
    ...
    iam_role_arn: NotRequired["capo_rds.types.string.String"]
    ...
    total_extracted_data_in_gb: NotRequired["capo_rds.types.integer.Integer"]
    """<p>The total amount of data exported, in gigabytes.</p>"""
    failure_cause: NotRequired["capo_rds.types.string.String"]
    """<p>The reason the export failed, if it failed.</p>"""
    warning_message: NotRequired["capo_rds.types.string.String"]
...
def deserialize_query(el: Element) -> ExportTask:
    ...
    if child_export_only is not None:
        ...
        out["export_only"] = capo_rds.types.string_list.deserialize_query(
            child_export_only
        )
    ...
    if child_snapshot_time is not None:
        ...
        out["snapshot_time"] = capo_rds.types.t_stamp.deserialize_query(
            child_snapshot_time
        )
    ...
    if child_task_start_time is not None:
        ...
        out["task_start_time"] = capo_rds.types.t_stamp.deserialize_query(
    ...
    if child_task_end_time is not None:
        ...
        out["task_end_time"] = capo_rds.types.t_stamp.deserialize_query(
            child_task_end_time
        )
