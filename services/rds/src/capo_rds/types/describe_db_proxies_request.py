"""Generated from Smithy shape ``com.amazonaws.rds#DescribeDBProxiesRequest``."""
...
class DescribeDBProxiesRequest(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DescribeDBProxiesRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DescribeDBProxiesRequest:
    out: DescribeDBProxiesRequest = {}  # type: ignore[typeddict-item]
