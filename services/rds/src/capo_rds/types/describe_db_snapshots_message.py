...
class DescribeDBSnapshotsMessage(TypedDict, closed=True):
    ...
    include_shared: NotRequired["capo_rds.types.boolean.Boolean"]
    ...
    include_public: NotRequired["capo_rds.types.boolean.Boolean"]
