"""Generated from Smithy shape ``com.amazonaws.rds#RemoveRoleFromDBInstanceMessage``."""
...
class RemoveRoleFromDBInstanceMessage(TypedDict, closed=True):
...
def deserialize_query(el: Element) -> RemoveRoleFromDBInstanceMessage:
    out: RemoveRoleFromDBInstanceMessage = {}  # type: ignore[typeddict-item]
