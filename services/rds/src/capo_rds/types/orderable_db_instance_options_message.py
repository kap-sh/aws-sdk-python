...
if TYPE_CHECKING:
    import capo_rds.types.orderable_db_instance_options_list
    import capo_rds.types.string


class OrderableDBInstanceOptionsMessage(TypedDict, closed=True):
    orderable_db_instance_options: NotRequired[
        "capo_rds.types.orderable_db_instance_options_list.OrderableDBInstanceOptionsList"
    ]
...
def serialize_query(
    ...
    if "orderable_db_instance_options" in value:
        ...
        capo_rds.types.orderable_db_instance_options_list.serialize_query(
...
def deserialize_query(el: Element) -> OrderableDBInstanceOptionsMessage:
    ...
    if child_orderable_db_instance_options is not None:
        ...
        out["orderable_db_instance_options"] = (
            capo_rds.types.orderable_db_instance_options_list.deserialize_query(
