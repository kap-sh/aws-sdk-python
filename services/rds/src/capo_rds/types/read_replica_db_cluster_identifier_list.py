"""Generated from Smithy shape ``com.amazonaws.rds#ReadReplicaDBClusterIdentifierList``."""
...
ReadReplicaDBClusterIdentifierList: TypeAlias = list["capo_rds.types.string.String"]
