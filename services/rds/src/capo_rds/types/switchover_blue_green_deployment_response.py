"""Generated from Smithy shape ``com.amazonaws.rds#SwitchoverBlueGreenDeploymentResponse``."""
...
class SwitchoverBlueGreenDeploymentResponse(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: SwitchoverBlueGreenDeploymentResponse,
...
def deserialize_query(el: Element) -> SwitchoverBlueGreenDeploymentResponse:
    out: SwitchoverBlueGreenDeploymentResponse = {}  # type: ignore[typeddict-item]
