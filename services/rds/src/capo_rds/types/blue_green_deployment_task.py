...
if TYPE_CHECKING:
    import capo_rds.types.blue_green_deployment_task_name
    import capo_rds.types.blue_green_deployment_task_status


class BlueGreenDeploymentTask(TypedDict, closed=True):
    name: NotRequired[
        "capo_rds.types.blue_green_deployment_task_name.BlueGreenDeploymentTaskName"
    ]
    """<p>The name of the blue/green deployment task.</p>"""
    status: NotRequired[
        "capo_rds.types.blue_green_deployment_task_status.BlueGreenDeploymentTaskStatus"
    ]
