...
from aws_sdk_partnercentral_channel._auth._identity import Credentials, Identity
from aws_sdk_partnercentral_channel._auth._providers import IdentityProvider
from aws_sdk_partnercentral_channel._auth._sigv4 import SigV4AuthContext, sign_sigv4
...
class SigV4ASigner(Signer[Credentials]):
    """aws.auth#sigv4a — SigV4 multi-region asymmetric variant. Not yet implemented."""
    ...
    async def asign(self, req: Request) -> Request:
        raise NotImplementedError("SigV4A signing is not yet implemented")
