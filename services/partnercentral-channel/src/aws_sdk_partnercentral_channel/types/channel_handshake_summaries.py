...
ChannelHandshakeSummaries: TypeAlias = list[
    "aws_sdk_partnercentral_channel.types.channel_handshake_summary.ChannelHandshakeSummary"
]
...
def serialize_aws_json_1_0(value: ChannelHandshakeSummaries) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_partnercentral_channel.types.channel_handshake_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ChannelHandshakeSummaries:
    ...
    for item in data:
        out.append(
            aws_sdk_partnercentral_channel.types.channel_handshake_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
