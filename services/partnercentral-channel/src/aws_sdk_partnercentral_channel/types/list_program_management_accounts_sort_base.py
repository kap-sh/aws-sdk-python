...
if TYPE_CHECKING:
    import aws_sdk_partnercentral_channel.types.list_program_management_accounts_sort_name
...
def serialize_aws_json_1_0(value: ListProgramManagementAccountsSortBase) -> dict:
    ...
    out["sortBy"] = (
        aws_sdk_partnercentral_channel.types.list_program_management_accounts_sort_name.serialize_aws_json_1_0(
            value["sort_by"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ListProgramManagementAccountsSortBase:
    ...
    if "sortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_partnercentral_channel.types.list_program_management_accounts_sort_name.deserialize_aws_json_1_0(
                data["sortBy"]
            )
        )
    else:
