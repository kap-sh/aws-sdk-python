...
class AcceptChannelHandshakeResponse(TypedDict, closed=True):
    channel_handshake_detail: NotRequired[
        "capo_partnercentral_channel.types.accept_channel_handshake_detail.AcceptChannelHandshakeDetail"
    ]
...
def serialize_aws_json_1_0(value: AcceptChannelHandshakeResponse) -> dict:
    ...
    if "channel_handshake_detail" in value:
        ...
        out["channelHandshakeDetail"] = (
            capo_partnercentral_channel.types.accept_channel_handshake_detail.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> AcceptChannelHandshakeResponse:
    ...
    if "channelHandshakeDetail" in data:
        ...
        out["channel_handshake_detail"] = (
            capo_partnercentral_channel.types.accept_channel_handshake_detail.deserialize_aws_json_1_0(
