"""Generated from Smithy shape ``com.amazonaws.partnercentralchannel#CancelChannelHandshakeDetail``."""
...
class CancelChannelHandshakeDetail(TypedDict, closed=True):
    id: NotRequired[
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: CancelChannelHandshakeDetail) -> dict:
    out: dict = {}
    if "id" in value:
        out["id"] = value["id"]
    if "arn" in value:
...
def deserialize_aws_json_1_0(data: dict) -> CancelChannelHandshakeDetail:
    out: CancelChannelHandshakeDetail = {}  # type: ignore[typeddict-item]
    if "id" in data:
        out["id"] = data["id"]
    if "arn" in data:
        out["arn"] = data["arn"]
