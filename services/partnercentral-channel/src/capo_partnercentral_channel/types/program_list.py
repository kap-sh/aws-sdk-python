...
ProgramList: TypeAlias = list["capo_partnercentral_channel.types.program.Program"]
...
def serialize_aws_json_1_0(value: ProgramList) -> list:
    ...
    for item in value:
        out.append(
            capo_partnercentral_channel.types.program.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ProgramList:
    ...
    for item in data:
        out.append(
            capo_partnercentral_channel.types.program.deserialize_aws_json_1_0(item)
        )
    return out
