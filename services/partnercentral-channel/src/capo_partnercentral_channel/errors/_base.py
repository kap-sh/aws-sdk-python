...
class PartnerCentralChannelError(Exception):
    """Base class for all PartnerCentralChannel service errors."""


class ServiceError(PartnerCentralChannelError):
...
class SerializationError(PartnerCentralChannelError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PartnerCentralChannelError):
...
class WaiterFailedError(PartnerCentralChannelError):
...
class WaiterTimeoutError(PartnerCentralChannelError):
