...
def build_request(
    ...
    input: aws_sdk_sso_oidc.types.create_token_with_iam_request.CreateTokenWithIAMRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_oidc.types.create_token_with_iam_request.serialize_json(input)
    ).encode()
