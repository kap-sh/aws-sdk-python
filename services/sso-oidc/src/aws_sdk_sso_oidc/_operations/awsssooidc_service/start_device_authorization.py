...
def handle_response(
    ...
    out: aws_sdk_sso_oidc.types.start_device_authorization_response.StartDeviceAuthorizationResponse = aws_sdk_sso_oidc.types.start_device_authorization_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sso_oidc.types.start_device_authorization_request.StartDeviceAuthorizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_oidc.types.start_device_authorization_request.serialize_json(input_)
    ).encode()
