...
def build_request(
    ...
    input: aws_sdk_sso_oidc.types.start_device_authorization_request.StartDeviceAuthorizationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_oidc.types.start_device_authorization_request.serialize_json(input)
    ).encode()
