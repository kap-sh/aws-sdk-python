...
from aws_sdk_sso_oidc._services._aws_config import aws_config
...
class SSOOIDCClientConfig(TypedDict, total=False, closed=True):
...
class SSOOIDCClient:
    ...
    def __init__(
        ...
        self._config = SSOOIDCClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[SSOOIDCClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: SSOOIDCClientConfig = config_overrides or {}
    ...
    def create_token(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_token(client_id='_yzkThXVzLWVhc3QtMQEXAMPLECLIENTID', client_secret='VERYLONGSECRETeyJraWQiOiJrZXktMTU2NDAyODA5OSIsImFsZyI6IkhTMzg0In0', grant_type='urn:ietf:params:oauth:grant-type:device-code', device_code='yJraWQiOiJrZXktMTU2Njk2ODA4OCIsImFsZyI6IkhTMzIn0EXAMPLEDEVICECODE')
            Call OAuth/OIDC /token endpoint for Refresh Token grant with Secret authentication

            >>> client.create_token(client_id='_yzkThXVzLWVhc3QtMQEXAMPLECLIENTID', client_secret='VERYLONGSECRETeyJraWQiOiJrZXktMTU2NDAyODA5OSIsImFsZyI6IkhTMzg0In0', grant_type='refresh_token', refresh_token='aorvJYubGpU6i91YnH7Mfo-AT2fIVa1zCfA_Rvq9yjVKIP3onFmmykuQ7E93y2I-9Nyj-A_sVvMufaLNL0bqnDRtgAkc0:MGUCMFrRsktMRVlWaOR70XGMFGLL0SlcCw4DiYveIiOVx1uK9BbD0gvAddsW3UTLozXKMgIxAJ3qxUvjpnlLIOaaKOoa/FuNgqJVvr9GMwDtnAtlh9iZzAkEXAMPLEREFRESHTOKEN', scope=['codewhisperer:completions'])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_sso_oidc.types.create_token_request.CreateTokenRequest]",
        ) -> OperationResponse[
            "aws_sdk_sso_oidc.types.create_token_response.CreateTokenResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sso_oidc._operations.awsssooidc_service.create_token.create_token(
    ...
    def create_token_with_iam(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sso_oidc.types.create_token_with_iam_request.CreateTokenWithIAMRequest]",
        ) -> OperationResponse[
            "aws_sdk_sso_oidc.types.create_token_with_iam_response.CreateTokenWithIAMResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sso_oidc._operations.awsssooidc_service.create_token_with_iam.create_token_with_iam(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_client(
        ...
        *,
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_sso_oidc._operations.awsssooidc_service.register_client.register_client(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_device_authorization(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.start_device_authorization(client_id='_yzkThXVzLWVhc3QtMQEXAMPLECLIENTID', client_secret='VERYLONGSECRETeyJraWQiOiJrZXktMTU2NDAyODA5OSIsImFsZyI6IkhTMzg0In0', start_url='https://identitycenter.amazonaws.com/ssoins-111111111111')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_sso_oidc.types.start_device_authorization_request.StartDeviceAuthorizationRequest]",
        ) -> OperationResponse[
            "aws_sdk_sso_oidc.types.start_device_authorization_response.StartDeviceAuthorizationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sso_oidc._operations.awsssooidc_service.start_device_authorization.start_device_authorization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
