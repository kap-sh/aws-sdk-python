...
class SSOOIDCError(Exception):
    """Base class for all SSOOIDC service errors."""


class ServiceError(SSOOIDCError):
...
class SerializationError(SSOOIDCError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SSOOIDCError):
...
class WaiterFailedError(SSOOIDCError):
...
class WaiterTimeoutError(SSOOIDCError):
