"""Generated from Smithy shape ``com.amazonaws.ssooidc#InvalidClientException``."""
...
class InvalidClientException_(TypedDict):
...
class InvalidClientException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ssooidc#InvalidClientException``."""
