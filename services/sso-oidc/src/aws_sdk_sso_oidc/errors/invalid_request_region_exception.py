...
if TYPE_CHECKING:
    ...
    import aws_sdk_sso_oidc.types.location
    import aws_sdk_sso_oidc.types.region


class InvalidRequestRegionException_(TypedDict):
    ...
    endpoint: NotRequired["aws_sdk_sso_oidc.types.location.Location"]
    """<p>Indicates the IAM Identity Center endpoint which the requester may call with this token.</p>"""
    region: NotRequired["aws_sdk_sso_oidc.types.region.Region"]
