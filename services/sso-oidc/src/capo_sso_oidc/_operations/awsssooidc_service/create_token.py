...
def handle_response(
    ...
    out: capo_sso_oidc.types.create_token_response.CreateTokenResponse = (
        capo_sso_oidc.types.create_token_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_oidc.types.create_token_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_token(
    ...
    capo_sso_oidc.types.create_token_response.CreateTokenResponse, zapros.Response
]:
