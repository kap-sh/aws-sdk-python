...
import capo_sso_oidc.errors.access_denied_exception
import capo_sso_oidc.errors.authorization_pending_exception
import capo_sso_oidc.errors.expired_token_exception
import capo_sso_oidc.errors.internal_server_exception
import capo_sso_oidc.errors.invalid_client_exception
import capo_sso_oidc.errors.invalid_grant_exception
import capo_sso_oidc.errors.invalid_request_exception
import capo_sso_oidc.errors.invalid_request_region_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise capo_sso_oidc.errors.access_denied_exception.AccessDeniedException.from_json(
                data, message
            )
        case "AuthorizationPendingException":
            raise capo_sso_oidc.errors.authorization_pending_exception.AuthorizationPendingException.from_json(
                data, message
            )
        case "ExpiredTokenException":
            raise capo_sso_oidc.errors.expired_token_exception.ExpiredTokenException.from_json(
                data, message
            )
        ...
        case "InvalidGrantException":
            raise capo_sso_oidc.errors.invalid_grant_exception.InvalidGrantException.from_json(
                data, message
            )
        ...
        case "InvalidRequestRegionException":
            raise capo_sso_oidc.errors.invalid_request_region_exception.InvalidRequestRegionException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_sso_oidc.types.create_token_with_iam_response.CreateTokenWithIAMResponse = capo_sso_oidc.types.create_token_with_iam_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_oidc.types.create_token_with_iam_request.serialize_json(input_)
    ).encode()
