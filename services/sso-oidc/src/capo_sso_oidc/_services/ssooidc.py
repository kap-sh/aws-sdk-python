...
from capo_sso_oidc._services._aws_config import aws_config
...
class SSOOIDCClient:
    ...
    def create_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sso_oidc.types.create_token_request.CreateTokenRequest]",
        ) -> OperationResponse[
            "capo_sso_oidc.types.create_token_response.CreateTokenResponse"
        ]:
            ...
            output, http_response = (
                capo_sso_oidc._operations.awsssooidc_service.create_token.create_token(
    ...
    def create_token_with_iam(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sso_oidc.types.create_token_with_iam_request.CreateTokenWithIAMRequest]",
        ) -> OperationResponse[
            "capo_sso_oidc.types.create_token_with_iam_response.CreateTokenWithIAMResponse"
        ]:
            ...
            output, http_response = (
                capo_sso_oidc._operations.awsssooidc_service.create_token_with_iam.create_token_with_iam(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_client(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sso_oidc.types.register_client_request.RegisterClientRequest]",
        ) -> OperationResponse[
            "capo_sso_oidc.types.register_client_response.RegisterClientResponse"
        ]:
            ...
            output, http_response = (
                capo_sso_oidc._operations.awsssooidc_service.register_client.register_client(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_device_authorization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sso_oidc.types.start_device_authorization_request.StartDeviceAuthorizationRequest]",
        ) -> OperationResponse[
            "capo_sso_oidc.types.start_device_authorization_response.StartDeviceAuthorizationResponse"
        ]:
            ...
            output, http_response = (
                capo_sso_oidc._operations.awsssooidc_service.start_device_authorization.start_device_authorization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
