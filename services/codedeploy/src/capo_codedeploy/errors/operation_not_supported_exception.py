"""Generated from Smithy shape ``com.amazonaws.codedeploy#OperationNotSupportedException``."""
...
class OperationNotSupportedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codedeploy#OperationNotSupportedException``."""
