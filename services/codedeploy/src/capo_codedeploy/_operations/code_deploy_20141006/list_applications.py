...
def handle_response(
    ...
    out: capo_codedeploy.types.list_applications_output.ListApplicationsOutput = (
        capo_codedeploy.types.list_applications_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.list_applications_input.serialize_aws_json_1_1(input_)
    ).encode()
