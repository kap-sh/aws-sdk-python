...
def handle_response(
    ...
    out: capo_codedeploy.types.list_deployment_groups_output.ListDeploymentGroupsOutput = capo_codedeploy.types.list_deployment_groups_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.list_deployment_groups_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
