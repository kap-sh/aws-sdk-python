"""Generated from Smithy shape ``com.amazonaws.codedeploy#SkipWaitTimeForInstanceTermination``."""
...
import capo_codedeploy.errors.deployment_already_completed_exception
...
import capo_codedeploy.errors.unsupported_action_for_deployment_type_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DeploymentAlreadyCompletedException":
            raise capo_codedeploy.errors.deployment_already_completed_exception.DeploymentAlreadyCompletedException.from_aws_json_1_1(
                data
            )
        ...
        case "UnsupportedActionForDeploymentTypeException":
            raise capo_codedeploy.errors.unsupported_action_for_deployment_type_exception.UnsupportedActionForDeploymentTypeException.from_aws_json_1_1(
                data
            )
        case _:
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CodeDeploy_20141006.SkipWaitTimeForInstanceTermination"
    body: bytes | None = json.dumps(
        capo_codedeploy.types.skip_wait_time_for_instance_termination_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_skip_wait_time_for_instance_termination(
