"""Generated from Smithy shape ``com.amazonaws.codedeploy#DeleteResourcesByExternalId``."""
...
def handle_response(
    ...
    out: capo_codedeploy.types.delete_resources_by_external_id_output.DeleteResourcesByExternalIdOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CodeDeploy_20141006.DeleteResourcesByExternalId"
    body: bytes | None = json.dumps(
        capo_codedeploy.types.delete_resources_by_external_id_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_resources_by_external_id(
