"""Generated from Smithy shape ``com.amazonaws.codedeploy#ListTagsForResource``."""
...
import capo_codedeploy.errors.arn_not_supported_exception
import capo_codedeploy.errors.invalid_arn_exception
import capo_codedeploy.errors.resource_arn_required_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ArnNotSupportedException":
            raise capo_codedeploy.errors.arn_not_supported_exception.ArnNotSupportedException.from_aws_json_1_1(
                data
            )
        case "InvalidArnException":
            raise capo_codedeploy.errors.invalid_arn_exception.InvalidArnException.from_aws_json_1_1(
                data
            )
        case "ResourceArnRequiredException":
            raise capo_codedeploy.errors.resource_arn_required_exception.ResourceArnRequiredException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_codedeploy.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_codedeploy.types.list_tags_for_resource_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.list_tags_for_resource_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
