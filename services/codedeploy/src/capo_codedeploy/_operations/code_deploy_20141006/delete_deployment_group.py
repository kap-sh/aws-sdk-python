"""Generated from Smithy shape ``com.amazonaws.codedeploy#DeleteDeploymentGroup``."""
...
def handle_response(
    ...
    out: capo_codedeploy.types.delete_deployment_group_output.DeleteDeploymentGroupOutput = capo_codedeploy.types.delete_deployment_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.delete_deployment_group_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_deployment_group(
