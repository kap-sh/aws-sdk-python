"""Generated from Smithy shape ``com.amazonaws.codedeploy#GetDeployment``."""
...
def handle_response(
    ...
    out: capo_codedeploy.types.get_deployment_output.GetDeploymentOutput = (
        capo_codedeploy.types.get_deployment_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.get_deployment_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_deployment(
    ...
    capo_codedeploy.types.get_deployment_output.GetDeploymentOutput, zapros.Response
]:
