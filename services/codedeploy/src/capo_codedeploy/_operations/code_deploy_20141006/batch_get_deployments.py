"""Generated from Smithy shape ``com.amazonaws.codedeploy#BatchGetDeployments``."""
...
def handle_response(
    ...
    out: capo_codedeploy.types.batch_get_deployments_output.BatchGetDeploymentsOutput = capo_codedeploy.types.batch_get_deployments_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.batch_get_deployments_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_batch_get_deployments(
