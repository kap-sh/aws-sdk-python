"""Generated from Smithy shape ``com.amazonaws.codedeploy#BatchGetDeploymentInstances``."""
...
import capo_codedeploy.errors.instance_id_required_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InstanceIdRequiredException":
            raise capo_codedeploy.errors.instance_id_required_exception.InstanceIdRequiredException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codedeploy.types.batch_get_deployment_instances_output.BatchGetDeploymentInstancesOutput = capo_codedeploy.types.batch_get_deployment_instances_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.batch_get_deployment_instances_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_get_deployment_instances(
