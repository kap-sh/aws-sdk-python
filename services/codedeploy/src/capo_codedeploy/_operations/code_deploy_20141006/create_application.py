"""Generated from Smithy shape ``com.amazonaws.codedeploy#CreateApplication``."""
...
import capo_codedeploy.errors.application_already_exists_exception
import capo_codedeploy.errors.application_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ApplicationAlreadyExistsException":
            raise capo_codedeploy.errors.application_already_exists_exception.ApplicationAlreadyExistsException.from_aws_json_1_1(
                data
            )
        case "ApplicationLimitExceededException":
            raise capo_codedeploy.errors.application_limit_exceeded_exception.ApplicationLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codedeploy.types.create_application_output.CreateApplicationOutput = (
        capo_codedeploy.types.create_application_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.create_application_input.serialize_aws_json_1_1(input_)
    ).encode()
