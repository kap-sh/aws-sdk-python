...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.add_tags_to_on_premises_instances_input.AddTagsToOnPremisesInstancesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.add_tags_to_on_premises_instances_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
