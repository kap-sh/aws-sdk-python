...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.list_deployment_instances_output.ListDeploymentInstancesOutput = aws_sdk_codedeploy.types.list_deployment_instances_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.list_deployment_instances_input.ListDeploymentInstancesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.list_deployment_instances_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
