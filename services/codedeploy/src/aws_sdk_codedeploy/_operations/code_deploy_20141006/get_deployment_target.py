...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DeploymentTargetDoesNotExistException":
            import aws_sdk_codedeploy.errors.deployment_target_does_not_exist_exception

            raise aws_sdk_codedeploy.errors.deployment_target_does_not_exist_exception.DeploymentTargetDoesNotExistException.from_aws_json_1_1(
                data
            )
        case "DeploymentTargetIdRequiredException":
            import aws_sdk_codedeploy.errors.deployment_target_id_required_exception

            raise aws_sdk_codedeploy.errors.deployment_target_id_required_exception.DeploymentTargetIdRequiredException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidDeploymentTargetIdException":
            import aws_sdk_codedeploy.errors.invalid_deployment_target_id_exception

            raise aws_sdk_codedeploy.errors.invalid_deployment_target_id_exception.InvalidDeploymentTargetIdException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.get_deployment_target_output.GetDeploymentTargetOutput = aws_sdk_codedeploy.types.get_deployment_target_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.get_deployment_target_input.GetDeploymentTargetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.get_deployment_target_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
