"""Generated from Smithy shape ``com.amazonaws.codedeploy#StopDeployment``."""
...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.stop_deployment_output.StopDeploymentOutput = (
        aws_sdk_codedeploy.types.stop_deployment_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.stop_deployment_input.StopDeploymentInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.stop_deployment_input.serialize_aws_json_1_1(input_)
    ).encode()
