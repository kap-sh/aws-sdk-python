...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.register_on_premises_instance_input.RegisterOnPremisesInstanceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.register_on_premises_instance_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
