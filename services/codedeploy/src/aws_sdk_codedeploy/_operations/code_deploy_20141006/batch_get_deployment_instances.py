...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.batch_get_deployment_instances_output.BatchGetDeploymentInstancesOutput = aws_sdk_codedeploy.types.batch_get_deployment_instances_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.batch_get_deployment_instances_input.BatchGetDeploymentInstancesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.batch_get_deployment_instances_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
