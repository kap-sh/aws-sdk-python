...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.get_deployment_output.GetDeploymentOutput = (
        aws_sdk_codedeploy.types.get_deployment_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.get_deployment_input.GetDeploymentInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.get_deployment_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_deployment(
    ...
    aws_sdk_codedeploy.types.get_deployment_output.GetDeploymentOutput, zapros.Response
]:
