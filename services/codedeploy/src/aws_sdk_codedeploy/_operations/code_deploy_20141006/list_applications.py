"""Generated from Smithy shape ``com.amazonaws.codedeploy#ListApplications``."""
...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.list_applications_output.ListApplicationsOutput = (
        aws_sdk_codedeploy.types.list_applications_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.list_applications_input.ListApplicationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.list_applications_input.serialize_aws_json_1_1(input_)
    ).encode()
