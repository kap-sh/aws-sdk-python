...
def build_request(
    ...
    input: aws_sdk_codedeploy.types.list_applications_input.ListApplicationsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.list_applications_input.serialize_aws_json_1_1(input)
    ).encode()
