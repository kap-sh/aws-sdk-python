"""Generated from Smithy shape ``com.amazonaws.codedeploy#GetDeploymentGroup``."""
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.get_deployment_group_input.GetDeploymentGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.get_deployment_group_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_deployment_group(
