...
import aws_sdk_codedeploy.errors.instance_id_required_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InstanceIdRequiredException":
            raise aws_sdk_codedeploy.errors.instance_id_required_exception.InstanceIdRequiredException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.get_deployment_instance_output.GetDeploymentInstanceOutput = aws_sdk_codedeploy.types.get_deployment_instance_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.get_deployment_instance_input.GetDeploymentInstanceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.get_deployment_instance_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
