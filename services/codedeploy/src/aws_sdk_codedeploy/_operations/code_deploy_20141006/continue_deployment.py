"""Generated from Smithy shape ``com.amazonaws.codedeploy#ContinueDeployment``."""
...
def build_request(
    ...
    input: aws_sdk_codedeploy.types.continue_deployment_input.ContinueDeploymentInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.continue_deployment_input.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_continue_deployment(
