"""Generated from Smithy shape ``com.amazonaws.codedeploy#BatchGetOnPremisesInstances``."""
...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.batch_get_on_premises_instances_output.BatchGetOnPremisesInstancesOutput = aws_sdk_codedeploy.types.batch_get_on_premises_instances_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.batch_get_on_premises_instances_input.BatchGetOnPremisesInstancesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.batch_get_on_premises_instances_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_get_on_premises_instances(
