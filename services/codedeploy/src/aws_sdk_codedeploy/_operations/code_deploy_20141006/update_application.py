...
def build_request(
    ...
    input: aws_sdk_codedeploy.types.update_application_input.UpdateApplicationInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.update_application_input.serialize_aws_json_1_1(input)
    ).encode()
