...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.remove_tags_from_on_premises_instances_input.RemoveTagsFromOnPremisesInstancesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.remove_tags_from_on_premises_instances_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
