"""Generated from Smithy shape ``com.amazonaws.codedeploy#GetApplicationRevision``."""
...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.get_application_revision_output.GetApplicationRevisionOutput = aws_sdk_codedeploy.types.get_application_revision_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.get_application_revision_input.GetApplicationRevisionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.get_application_revision_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_application_revision(
