...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.get_deployment_config_output.GetDeploymentConfigOutput = aws_sdk_codedeploy.types.get_deployment_config_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.get_deployment_config_input.GetDeploymentConfigInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.get_deployment_config_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
