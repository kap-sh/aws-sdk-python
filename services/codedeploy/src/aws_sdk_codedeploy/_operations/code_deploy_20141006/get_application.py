...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.get_application_output.GetApplicationOutput = (
        aws_sdk_codedeploy.types.get_application_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.get_application_input.GetApplicationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.get_application_input.serialize_aws_json_1_1(input_)
    ).encode()
