...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.skip_wait_time_for_instance_termination_input.SkipWaitTimeForInstanceTerminationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.skip_wait_time_for_instance_termination_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
