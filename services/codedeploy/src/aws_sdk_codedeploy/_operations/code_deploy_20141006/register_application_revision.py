"""Generated from Smithy shape ``com.amazonaws.codedeploy#RegisterApplicationRevision``."""
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.register_application_revision_input.RegisterApplicationRevisionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.register_application_revision_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_register_application_revision(
