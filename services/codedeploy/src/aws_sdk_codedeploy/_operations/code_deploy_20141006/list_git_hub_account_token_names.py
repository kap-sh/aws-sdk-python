"""Generated from Smithy shape ``com.amazonaws.codedeploy#ListGitHubAccountTokenNames``."""
...
import aws_sdk_codedeploy.errors.operation_not_supported_exception
import aws_sdk_codedeploy.errors.resource_validation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OperationNotSupportedException":
            raise aws_sdk_codedeploy.errors.operation_not_supported_exception.OperationNotSupportedException.from_aws_json_1_1(
                data
            )
        case "ResourceValidationException":
            raise aws_sdk_codedeploy.errors.resource_validation_exception.ResourceValidationException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.list_git_hub_account_token_names_output.ListGitHubAccountTokenNamesOutput = aws_sdk_codedeploy.types.list_git_hub_account_token_names_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.list_git_hub_account_token_names_input.ListGitHubAccountTokenNamesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.list_git_hub_account_token_names_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_git_hub_account_token_names(
