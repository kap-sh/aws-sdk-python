...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.delete_deployment_config_input.DeleteDeploymentConfigInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.delete_deployment_config_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
