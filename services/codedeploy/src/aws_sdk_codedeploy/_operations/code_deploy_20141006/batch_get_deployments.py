...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.batch_get_deployments_input.BatchGetDeploymentsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.batch_get_deployments_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
