"""Generated from Smithy shape ``com.amazonaws.codedeploy#GetOnPremisesInstance``."""
...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.get_on_premises_instance_output.GetOnPremisesInstanceOutput = aws_sdk_codedeploy.types.get_on_premises_instance_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.get_on_premises_instance_input.GetOnPremisesInstanceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.get_on_premises_instance_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_on_premises_instance(
