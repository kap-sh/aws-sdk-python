"""Generated from Smithy shape ``com.amazonaws.codedeploy#ListDeploymentGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.list_deployment_groups_output.ListDeploymentGroupsOutput = aws_sdk_codedeploy.types.list_deployment_groups_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.list_deployment_groups_input.ListDeploymentGroupsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.list_deployment_groups_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_deployment_groups(
