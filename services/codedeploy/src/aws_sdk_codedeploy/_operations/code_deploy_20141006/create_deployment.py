...
def build_request(
    ...
    input: aws_sdk_codedeploy.types.create_deployment_input.CreateDeploymentInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.create_deployment_input.serialize_aws_json_1_1(input)
    ).encode()
