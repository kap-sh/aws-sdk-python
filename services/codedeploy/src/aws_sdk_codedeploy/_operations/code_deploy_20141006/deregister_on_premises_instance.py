"""Generated from Smithy shape ``com.amazonaws.codedeploy#DeregisterOnPremisesInstance``."""
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.deregister_on_premises_instance_input.DeregisterOnPremisesInstanceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.deregister_on_premises_instance_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_deregister_on_premises_instance(
