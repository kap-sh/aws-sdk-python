...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.batch_get_applications_output.BatchGetApplicationsOutput = aws_sdk_codedeploy.types.batch_get_applications_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.batch_get_applications_input.BatchGetApplicationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.batch_get_applications_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
