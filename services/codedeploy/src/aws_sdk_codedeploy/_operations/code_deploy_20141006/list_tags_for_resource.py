...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.list_tags_for_resource_output.ListTagsForResourceOutput = aws_sdk_codedeploy.types.list_tags_for_resource_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.list_tags_for_resource_input.ListTagsForResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.list_tags_for_resource_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
