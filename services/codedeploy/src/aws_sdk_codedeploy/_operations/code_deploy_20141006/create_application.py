...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.create_application_input.CreateApplicationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.create_application_input.serialize_aws_json_1_1(input_)
    ).encode()
