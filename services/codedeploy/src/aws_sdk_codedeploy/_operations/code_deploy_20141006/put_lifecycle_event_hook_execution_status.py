"""Generated from Smithy shape ``com.amazonaws.codedeploy#PutLifecycleEventHookExecutionStatus``."""
...
import aws_sdk_codedeploy.errors.invalid_lifecycle_event_hook_execution_id_exception
import aws_sdk_codedeploy.errors.invalid_lifecycle_event_hook_execution_status_exception
import aws_sdk_codedeploy.errors.lifecycle_event_already_completed_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidLifecycleEventHookExecutionIdException":
            raise aws_sdk_codedeploy.errors.invalid_lifecycle_event_hook_execution_id_exception.InvalidLifecycleEventHookExecutionIdException.from_aws_json_1_1(
                data
            )
        case "InvalidLifecycleEventHookExecutionStatusException":
            raise aws_sdk_codedeploy.errors.invalid_lifecycle_event_hook_execution_status_exception.InvalidLifecycleEventHookExecutionStatusException.from_aws_json_1_1(
                data
            )
        case "LifecycleEventAlreadyCompletedException":
            raise aws_sdk_codedeploy.errors.lifecycle_event_already_completed_exception.LifecycleEventAlreadyCompletedException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codedeploy.types.put_lifecycle_event_hook_execution_status_output.PutLifecycleEventHookExecutionStatusOutput = aws_sdk_codedeploy.types.put_lifecycle_event_hook_execution_status_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codedeploy.types.put_lifecycle_event_hook_execution_status_input.PutLifecycleEventHookExecutionStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeDeploy_20141006.PutLifecycleEventHookExecutionStatus"
    body: bytes | None = json.dumps(
        aws_sdk_codedeploy.types.put_lifecycle_event_hook_execution_status_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_lifecycle_event_hook_execution_status(
