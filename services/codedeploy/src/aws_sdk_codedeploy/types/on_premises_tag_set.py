...
if TYPE_CHECKING:
    import aws_sdk_codedeploy.types.on_premises_tag_set_list


class OnPremisesTagSet(TypedDict):
    on_premises_tag_set_list: NotRequired[
        "aws_sdk_codedeploy.types.on_premises_tag_set_list.OnPremisesTagSetList"
    ]
...
def serialize_aws_json_1_1(value: OnPremisesTagSet) -> dict:
    ...
    if "on_premises_tag_set_list" in value:
        ...
        out["onPremisesTagSetList"] = (
            aws_sdk_codedeploy.types.on_premises_tag_set_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> OnPremisesTagSet:
    ...
    if "onPremisesTagSetList" in data:
        ...
        out["on_premises_tag_set_list"] = (
            aws_sdk_codedeploy.types.on_premises_tag_set_list.deserialize_aws_json_1_1(
