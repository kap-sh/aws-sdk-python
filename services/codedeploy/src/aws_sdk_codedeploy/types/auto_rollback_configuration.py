...
class AutoRollbackConfiguration(TypedDict):
    ...
    events: NotRequired[
        "aws_sdk_codedeploy.types.auto_rollback_events_list.AutoRollbackEventsList"
    ]
...
def serialize_aws_json_1_1(value: AutoRollbackConfiguration) -> dict:
    ...
    if "events" in value:
        ...
        out["events"] = (
            aws_sdk_codedeploy.types.auto_rollback_events_list.serialize_aws_json_1_1(
                value["events"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> AutoRollbackConfiguration:
    ...
    if "events" in data:
        ...
        out["events"] = (
            aws_sdk_codedeploy.types.auto_rollback_events_list.deserialize_aws_json_1_1(
                data["events"]
            )
        )
    return out
