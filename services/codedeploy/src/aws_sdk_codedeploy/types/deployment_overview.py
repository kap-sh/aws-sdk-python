...
if TYPE_CHECKING:
    import aws_sdk_codedeploy.types.instance_count


class DeploymentOverview(TypedDict):
    pending: "aws_sdk_codedeploy.types.instance_count.InstanceCount"
    """<p>The number of instances in the deployment in a pending state.</p>"""
    in_progress: "aws_sdk_codedeploy.types.instance_count.InstanceCount"
    """<p>The number of instances in which the deployment is in progress.</p>"""
    succeeded: "aws_sdk_codedeploy.types.instance_count.InstanceCount"
    """<p>The number of instances in the deployment to which revisions have been successfully deployed.</p>"""
    failed: "aws_sdk_codedeploy.types.instance_count.InstanceCount"
    """<p>The number of instances in the deployment in a failed state.</p>"""
    skipped: "aws_sdk_codedeploy.types.instance_count.InstanceCount"
    """<p>The number of instances in the deployment in a skipped state.</p>"""
    ready: "aws_sdk_codedeploy.types.instance_count.InstanceCount"
