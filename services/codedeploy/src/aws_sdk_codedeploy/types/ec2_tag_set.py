...
if TYPE_CHECKING:
    import aws_sdk_codedeploy.types.ec2_tag_set_list


class EC2TagSet(TypedDict):
    ec2_tag_set_list: NotRequired[
        "aws_sdk_codedeploy.types.ec2_tag_set_list.EC2TagSetList"
    ]
...
def serialize_aws_json_1_1(value: EC2TagSet) -> dict:
    ...
    if "ec2_tag_set_list" in value:
        ...
        out["ec2TagSetList"] = (
            aws_sdk_codedeploy.types.ec2_tag_set_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> EC2TagSet:
    ...
    if "ec2TagSetList" in data:
        ...
        out["ec2_tag_set_list"] = (
            aws_sdk_codedeploy.types.ec2_tag_set_list.deserialize_aws_json_1_1(
                data["ec2TagSetList"]
            )
        )
    return out
