...
InstanceTypeList: TypeAlias = list[
    "aws_sdk_codedeploy.types.instance_type.InstanceType"
]
...
def serialize_aws_json_1_1(value: InstanceTypeList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_codedeploy.types.instance_type.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> InstanceTypeList:
    ...
    for item in data:
        out.append(
            aws_sdk_codedeploy.types.instance_type.deserialize_aws_json_1_1(item)
        )
    return out
