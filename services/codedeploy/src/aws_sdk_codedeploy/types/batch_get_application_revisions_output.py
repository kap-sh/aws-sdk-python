...
class BatchGetApplicationRevisionsOutput(TypedDict):
    ...
    revisions: NotRequired[
        "aws_sdk_codedeploy.types.revision_info_list.RevisionInfoList"
    ]
...
def serialize_aws_json_1_1(value: BatchGetApplicationRevisionsOutput) -> dict:
    ...
    if "revisions" in value:
        ...
        out["revisions"] = (
            aws_sdk_codedeploy.types.revision_info_list.serialize_aws_json_1_1(
                value["revisions"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> BatchGetApplicationRevisionsOutput:
    ...
    if "revisions" in data:
        ...
        out["revisions"] = (
            aws_sdk_codedeploy.types.revision_info_list.deserialize_aws_json_1_1(
                data["revisions"]
            )
        )
    return out
