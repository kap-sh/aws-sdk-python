...
if TYPE_CHECKING:
    import aws_sdk_codedeploy.types.diagnostics
    import aws_sdk_codedeploy.types.lifecycle_event_name
...
class LifecycleEvent(TypedDict, closed=True):
    lifecycle_event_name: NotRequired[
        "aws_sdk_codedeploy.types.lifecycle_event_name.LifecycleEventName"
    ]
    ...
    diagnostics: NotRequired["aws_sdk_codedeploy.types.diagnostics.Diagnostics"]
...
def serialize_aws_json_1_1(value: LifecycleEvent) -> dict:
    ...
    if "diagnostics" in value:
        ...
        out["diagnostics"] = (
            aws_sdk_codedeploy.types.diagnostics.serialize_aws_json_1_1(
                value["diagnostics"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> LifecycleEvent:
    ...
    if "diagnostics" in data:
        ...
        out["diagnostics"] = (
            aws_sdk_codedeploy.types.diagnostics.deserialize_aws_json_1_1(
                data["diagnostics"]
            )
        )
