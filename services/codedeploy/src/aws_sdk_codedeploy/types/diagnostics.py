...
if TYPE_CHECKING:
    import aws_sdk_codedeploy.types.lifecycle_error_code
    import aws_sdk_codedeploy.types.lifecycle_message
    import aws_sdk_codedeploy.types.log_tail
    import aws_sdk_codedeploy.types.script_name


class Diagnostics(TypedDict, closed=True):
    error_code: NotRequired[
        "aws_sdk_codedeploy.types.lifecycle_error_code.LifecycleErrorCode"
    ]
    ...
    script_name: NotRequired["aws_sdk_codedeploy.types.script_name.ScriptName"]
    """<p>The name of the script.</p>"""
    message: NotRequired["aws_sdk_codedeploy.types.lifecycle_message.LifecycleMessage"]
    """<p>The message associated with the error.</p>"""
    log_tail: NotRequired["aws_sdk_codedeploy.types.log_tail.LogTail"]
...
def serialize_aws_json_1_1(value: Diagnostics) -> dict:
    ...
    if "error_code" in value:
        ...
        out["errorCode"] = (
            aws_sdk_codedeploy.types.lifecycle_error_code.serialize_aws_json_1_1(
                value["error_code"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> Diagnostics:
    ...
    if "errorCode" in data:
        ...
        out["error_code"] = (
            aws_sdk_codedeploy.types.lifecycle_error_code.deserialize_aws_json_1_1(
                data["errorCode"]
            )
        )
