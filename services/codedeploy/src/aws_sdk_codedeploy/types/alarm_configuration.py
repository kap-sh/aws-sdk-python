...
class AlarmConfiguration(TypedDict, closed=True):
    ...
    alarms: NotRequired["aws_sdk_codedeploy.types.alarm_list.AlarmList"]
...
def serialize_aws_json_1_1(value: AlarmConfiguration) -> dict:
    ...
    if "alarms" in value:
        ...
        out["alarms"] = aws_sdk_codedeploy.types.alarm_list.serialize_aws_json_1_1(
            value["alarms"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> AlarmConfiguration:
    ...
    if "alarms" in data:
        ...
        out["alarms"] = aws_sdk_codedeploy.types.alarm_list.deserialize_aws_json_1_1(
            data["alarms"]
        )
    return out
