...
class InvalidDeploymentConfigNameException_(TypedDict):
...
class InvalidDeploymentConfigNameException(ServiceError):
    ...
    def __init__(self, data: InvalidDeploymentConfigNameException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "InvalidDeploymentConfigNameException":
