"""Generated from Smithy shape ``com.amazonaws.codedeploy#InvalidNextTokenException``."""
...
class InvalidNextTokenException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codedeploy#InvalidNextTokenException``."""
