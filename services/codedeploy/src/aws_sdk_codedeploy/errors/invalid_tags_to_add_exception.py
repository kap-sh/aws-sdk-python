...
class InvalidTagsToAddException_(TypedDict):
...
class InvalidTagsToAddException(ServiceError):
    ...
    def __init__(self, data: InvalidTagsToAddException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "InvalidTagsToAddException":
