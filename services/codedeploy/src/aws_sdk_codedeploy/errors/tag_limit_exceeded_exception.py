"""Generated from Smithy shape ``com.amazonaws.codedeploy#TagLimitExceededException``."""
...
class TagLimitExceededException_(TypedDict):
...
class TagLimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codedeploy#TagLimitExceededException``."""
