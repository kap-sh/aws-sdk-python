...
class ApplicationLimitExceededException_(TypedDict):
...
class ApplicationLimitExceededException(ServiceError):
    ...
    def __init__(self, data: ApplicationLimitExceededException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "ApplicationLimitExceededException":
