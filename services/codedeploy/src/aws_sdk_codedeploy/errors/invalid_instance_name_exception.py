...
class InvalidInstanceNameException_(TypedDict):
...
class InvalidInstanceNameException(ServiceError):
    ...
    def __init__(self, data: InvalidInstanceNameException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "InvalidInstanceNameException":
