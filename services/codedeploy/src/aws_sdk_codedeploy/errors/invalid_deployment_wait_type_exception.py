...
class InvalidDeploymentWaitTypeException_(TypedDict):
...
class InvalidDeploymentWaitTypeException(ServiceError):
    ...
    def __init__(self, data: InvalidDeploymentWaitTypeException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "InvalidDeploymentWaitTypeException":
