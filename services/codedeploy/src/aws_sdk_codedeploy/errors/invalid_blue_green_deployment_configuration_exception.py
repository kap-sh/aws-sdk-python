"""Generated from Smithy shape ``com.amazonaws.codedeploy#InvalidBlueGreenDeploymentConfigurationException``."""
...
class InvalidBlueGreenDeploymentConfigurationException_(TypedDict, closed=True):
...
def serialize_aws_json_1_1(
    value: InvalidBlueGreenDeploymentConfigurationException_,
) -> dict:
    out: dict = {}
    if "message" in value:
...
class InvalidBlueGreenDeploymentConfigurationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codedeploy#InvalidBlueGreenDeploymentConfigurationException``."""
