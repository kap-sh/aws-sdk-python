"""Generated from Smithy shape ``com.amazonaws.codedeploy#InvalidInputException``."""
...
class InvalidInputException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codedeploy#InvalidInputException``."""
