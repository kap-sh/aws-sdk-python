...
class ListStreamsOutput(TypedDict, closed=True):
    streams: NotRequired["capo_keyspacesstreams.types.stream_list.StreamList"]
...
def serialize_aws_json_1_0(value: ListStreamsOutput) -> dict:
    ...
    if "streams" in value:
        ...
        out["streams"] = capo_keyspacesstreams.types.stream_list.serialize_aws_json_1_0(
            value["streams"]
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListStreamsOutput:
    ...
    if "streams" in data:
        ...
        out["streams"] = (
            capo_keyspacesstreams.types.stream_list.deserialize_aws_json_1_0(
                data["streams"]
            )
        )
