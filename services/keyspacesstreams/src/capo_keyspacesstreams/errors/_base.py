...
class KeyspacesStreamsError(Exception):
    """Base class for all KeyspacesStreams service errors."""


class ServiceError(KeyspacesStreamsError):
...
class SerializationError(KeyspacesStreamsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(KeyspacesStreamsError):
...
class WaiterFailedError(KeyspacesStreamsError):
...
class WaiterTimeoutError(KeyspacesStreamsError):
