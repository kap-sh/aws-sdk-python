...
class GetShardIteratorInput(TypedDict):
    ...
    sequence_number: NotRequired["aws_sdk_keyspacesstreams.types.sequence_number.SequenceNumber"]
...
def serialize_aws_json_1_0(value: GetShardIteratorInput) -> dict:
    ...
    import aws_sdk_keyspacesstreams.types.shard_iterator_type
    out["shardIteratorType"] = aws_sdk_keyspacesstreams.types.shard_iterator_type.serialize_aws_json_1_0(value["shard_iterator_type"])
...
def deserialize_aws_json_1_0(data: dict) -> GetShardIteratorInput:
    ...
    if "shardIteratorType" in data:
        import aws_sdk_keyspacesstreams.types.shard_iterator_type
        out["shard_iterator_type"] = aws_sdk_keyspacesstreams.types.shard_iterator_type.deserialize_aws_json_1_0(data["shardIteratorType"])
    else:
