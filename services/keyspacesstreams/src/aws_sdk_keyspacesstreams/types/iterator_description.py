...
class IteratorDescription(TypedDict):
    iterator_position: NotRequired["aws_sdk_keyspacesstreams.types.iterator_position.IteratorPosition"]
...
def serialize_aws_json_1_0(value: IteratorDescription) -> dict:
    ...
    if "iterator_position" in value:
        import aws_sdk_keyspacesstreams.types.iterator_position
        out["iteratorPosition"] = aws_sdk_keyspacesstreams.types.iterator_position.serialize_aws_json_1_0(value["iterator_position"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> IteratorDescription:
    ...
    if "iteratorPosition" in data:
        import aws_sdk_keyspacesstreams.types.iterator_position
        out["iterator_position"] = aws_sdk_keyspacesstreams.types.iterator_position.deserialize_aws_json_1_0(data["iteratorPosition"])
    return out