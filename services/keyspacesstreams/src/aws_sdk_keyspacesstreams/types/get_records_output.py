...
class GetRecordsOutput(TypedDict):
    ...
    iterator_description: NotRequired[
        "aws_sdk_keyspacesstreams.types.iterator_description.IteratorDescription"
    ]
...
def serialize_aws_json_1_0(value: GetRecordsOutput) -> dict:
    ...
    if "change_records" in value:
        ...
        out["changeRecords"] = (
            aws_sdk_keyspacesstreams.types.record_list.serialize_aws_json_1_0(
    ...
    if "iterator_description" in value:
        ...
        out["iteratorDescription"] = (
            aws_sdk_keyspacesstreams.types.iterator_description.serialize_aws_json_1_0(
                value["iterator_description"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> GetRecordsOutput:
    ...
    if "changeRecords" in data:
        ...
        out["change_records"] = (
            aws_sdk_keyspacesstreams.types.record_list.deserialize_aws_json_1_0(
                data["changeRecords"]
            )
        )
    ...
    if "iteratorDescription" in data:
        ...
        out["iterator_description"] = (
            aws_sdk_keyspacesstreams.types.iterator_description.deserialize_aws_json_1_0(
                data["iteratorDescription"]
            )
        )
    return out
