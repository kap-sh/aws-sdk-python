...
from aws_sdk_keyspacesstreams._services._aws_config import aaws_config
...
class AsyncKeyspacesStreamsClientConfig(TypedDict, total=False):
...
class AsyncKeyspacesStreamsClient:
    ...
    async def get_records(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_keyspacesstreams.types.get_records_input.GetRecordsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_keyspacesstreams.types.get_records_output.GetRecordsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_keyspacesstreams._operations.keyspaces_streams.get_records.async_get_records(
    ...
    async def get_shard_iterator(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_keyspacesstreams.types.get_shard_iterator_input.GetShardIteratorInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_keyspacesstreams.types.get_shard_iterator_output.GetShardIteratorOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_keyspacesstreams._operations.keyspaces_streams.get_shard_iterator.async_get_shard_iterator(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_stream(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_keyspacesstreams.types.get_stream_input.GetStreamInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_keyspacesstreams.types.get_stream_output.GetStreamOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_keyspacesstreams._operations.keyspaces_streams.get_stream.async_get_stream(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_keyspacesstreams.types.shard.Shard]":
        _token = next_token
        while True:
    ...
    async def list_streams(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_keyspacesstreams.types.list_streams_input.ListStreamsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_keyspacesstreams.types.list_streams_output.ListStreamsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_keyspacesstreams._operations.keyspaces_streams.list_streams.async_list_streams(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_keyspacesstreams.types.stream.Stream]":
        _token = next_token
        while True:
