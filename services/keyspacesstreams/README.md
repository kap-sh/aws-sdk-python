...
```
pip install aws-sdk-keyspacesstreams
```

## Usage

```python
from aws_sdk_keyspacesstreams import AsyncKeyspacesStreamsClient
...
```python
from aws_sdk_keyspacesstreams import AsyncKeyspacesStreamsClient
from aws_sdk_keyspacesstreams.error import AccessDeniedException
