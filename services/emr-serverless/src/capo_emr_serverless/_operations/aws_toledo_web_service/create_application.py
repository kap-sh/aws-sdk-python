...
def handle_response(
    ...
    out: capo_emr_serverless.types.create_application_response.CreateApplicationResponse = capo_emr_serverless.types.create_application_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr_serverless.types.create_application_request.serialize_json(input_)
    ).encode()
