...
class NetworkConfiguration(TypedDict, closed=True):
    subnet_ids: NotRequired["capo_emr_serverless.types.subnet_ids.SubnetIds"]
    """<p>The array of subnet Ids for customer VPC connectivity.</p>"""
    security_group_ids: NotRequired[
        "capo_emr_serverless.types.security_group_ids.SecurityGroupIds"
    ]
...
def serialize_json(value: NetworkConfiguration) -> dict:
    ...
    if "subnet_ids" in value:
        ...
        out["subnetIds"] = capo_emr_serverless.types.subnet_ids.serialize_json(
            value["subnet_ids"]
        )
    if "security_group_ids" in value:
        ...
        out["securityGroupIds"] = (
            capo_emr_serverless.types.security_group_ids.serialize_json(
...
def deserialize_json(data: dict) -> NetworkConfiguration:
    ...
    if "securityGroupIds" in data:
        ...
        out["security_group_ids"] = (
            capo_emr_serverless.types.security_group_ids.deserialize_json(
