"""Generated from Smithy shape ``com.amazonaws.emrserverless#GetJobRun``."""
...
def handle_response(
    ...
    out: aws_sdk_emr_serverless.types.get_job_run_response.GetJobRunResponse = (
        aws_sdk_emr_serverless.types.get_job_run_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_serverless.types.get_job_run_request.GetJobRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_job_run(
    ...
    aws_sdk_emr_serverless.types.get_job_run_response.GetJobRunResponse, zapros.Response
]:
