...
def handle_response(
    ...
    out: aws_sdk_emr_serverless.types.start_job_run_response.StartJobRunResponse = (
        aws_sdk_emr_serverless.types.start_job_run_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_serverless.types.start_job_run_request.StartJobRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr_serverless.types.start_job_run_request.serialize_json(input_)
    ).encode()
