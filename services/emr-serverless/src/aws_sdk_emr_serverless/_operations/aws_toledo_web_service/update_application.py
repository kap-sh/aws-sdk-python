...
def handle_response(
    ...
    out: aws_sdk_emr_serverless.types.update_application_response.UpdateApplicationResponse = aws_sdk_emr_serverless.types.update_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_serverless.types.update_application_request.UpdateApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr_serverless.types.update_application_request.serialize_json(input_)
    ).encode()
