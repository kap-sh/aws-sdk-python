...
def build_request(
    ...
    input: aws_sdk_emr_serverless.types.update_application_request.UpdateApplicationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr_serverless.types.update_application_request.serialize_json(input)
    ).encode()
