...
def handle_response(
    ...
    out: aws_sdk_emr_serverless.types.start_session_response.StartSessionResponse = (
        aws_sdk_emr_serverless.types.start_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_serverless.types.start_session_request.StartSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr_serverless.types.start_session_request.serialize_json(input_)
    ).encode()
