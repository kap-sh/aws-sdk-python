"""Generated from Smithy shape ``com.amazonaws.emrserverless#ListJobRunAttempts``."""
...
def handle_response(
    ...
    out: aws_sdk_emr_serverless.types.list_job_run_attempts_response.ListJobRunAttemptsResponse = aws_sdk_emr_serverless.types.list_job_run_attempts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_serverless.types.list_job_run_attempts_request.ListJobRunAttemptsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_job_run_attempts(
