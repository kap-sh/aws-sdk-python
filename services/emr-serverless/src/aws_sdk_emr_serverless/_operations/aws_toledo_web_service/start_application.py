"""Generated from Smithy shape ``com.amazonaws.emrserverless#StartApplication``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_emr_serverless.errors.service_quota_exceeded_exception

            raise aws_sdk_emr_serverless.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_emr_serverless.types.start_application_response.StartApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_emr_serverless.types.start_application_request.StartApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
