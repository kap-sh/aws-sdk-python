...
def handle_response(
    ...
    out: aws_sdk_emr_serverless.types.get_session_endpoint_response.GetSessionEndpointResponse = aws_sdk_emr_serverless.types.get_session_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_serverless.types.get_session_endpoint_request.GetSessionEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
