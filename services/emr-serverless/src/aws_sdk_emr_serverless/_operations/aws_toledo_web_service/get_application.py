"""Generated from Smithy shape ``com.amazonaws.emrserverless#GetApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_emr_serverless.types.get_application_response.GetApplicationResponse = aws_sdk_emr_serverless.types.get_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_serverless.types.get_application_request.GetApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
