"""Generated from Smithy shape ``com.amazonaws.emrserverless#CancelJobRun``."""
...
def handle_response(
    ...
    out: aws_sdk_emr_serverless.types.cancel_job_run_response.CancelJobRunResponse = (
        aws_sdk_emr_serverless.types.cancel_job_run_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_emr_serverless.types.cancel_job_run_request.CancelJobRunRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/applications/{applicationId}/jobruns/{jobRunId}"
    ...
    params: dict[str, str] = {}
    if "shutdown_grace_period_in_seconds" in input:
        params["shutdownGracePeriodInSeconds"] = str(
            input["shutdown_grace_period_in_seconds"]
        )
...
async def async_cancel_job_run(
