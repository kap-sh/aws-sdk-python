...
def handle_response(
    ...
    out: aws_sdk_emr_serverless.types.terminate_session_response.TerminateSessionResponse = aws_sdk_emr_serverless.types.terminate_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_serverless.types.terminate_session_request.TerminateSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
