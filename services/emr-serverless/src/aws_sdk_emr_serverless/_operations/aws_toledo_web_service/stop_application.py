"""Generated from Smithy shape ``com.amazonaws.emrserverless#StopApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_emr_serverless.types.stop_application_response.StopApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_emr_serverless.types.stop_application_request.StopApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
