...
def handle_response(
    ...
    out: aws_sdk_emr_serverless.types.get_resource_dashboard_response.GetResourceDashboardResponse = aws_sdk_emr_serverless.types.get_resource_dashboard_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_serverless.types.get_resource_dashboard_request.GetResourceDashboardRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
