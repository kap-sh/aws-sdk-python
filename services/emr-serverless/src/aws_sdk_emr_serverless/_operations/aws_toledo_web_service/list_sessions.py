...
def handle_response(
    ...
    out: aws_sdk_emr_serverless.types.list_sessions_response.ListSessionsResponse = (
        aws_sdk_emr_serverless.types.list_sessions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_emr_serverless.types.list_sessions_request.ListSessionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
