...
if TYPE_CHECKING:
    import aws_sdk_emr_serverless.types.identity_center_application_arn
...
class IdentityCenterConfiguration(TypedDict):
    ...
    identity_center_application_arn: NotRequired[
        "aws_sdk_emr_serverless.types.identity_center_application_arn.IdentityCenterApplicationArn"
    ]
