...
if TYPE_CHECKING:
    ...
    import aws_sdk_emr_serverless.types.sensitive_properties_map
...
class Configuration(TypedDict):
    ...
    properties: NotRequired[
        "aws_sdk_emr_serverless.types.sensitive_properties_map.SensitivePropertiesMap"
    ]
...
def serialize_json(value: Configuration) -> dict:
    ...
    if "properties" in value:
        ...
        out["properties"] = (
            aws_sdk_emr_serverless.types.sensitive_properties_map.serialize_json(
                value["properties"]
            )
        )
...
def deserialize_json(data: dict) -> Configuration:
    ...
    if "properties" in data:
        ...
        out["properties"] = (
            aws_sdk_emr_serverless.types.sensitive_properties_map.deserialize_json(
                data["properties"]
            )
        )
