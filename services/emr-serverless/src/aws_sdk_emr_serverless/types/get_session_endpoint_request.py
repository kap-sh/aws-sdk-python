"""Generated from Smithy shape ``com.amazonaws.emrserverless#GetSessionEndpointRequest``."""
...
# --- restJson1 ser/de ---
def serialize_json(value: GetSessionEndpointRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> GetSessionEndpointRequest:
