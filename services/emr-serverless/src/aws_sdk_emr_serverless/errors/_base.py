...
class EMRServerlessError(Exception):
    """Base class for all EMRServerless service errors."""


class ServiceError(EMRServerlessError):
...
class SerializationError(EMRServerlessError):
    """Raised when a value cannot be serialized."""


class DeserializationError(EMRServerlessError):
...
class WaiterFailedError(EMRServerlessError):
...
class WaiterTimeoutError(EMRServerlessError):
