...
if TYPE_CHECKING:
    ...
    import aws_sdk_emr_serverless.types.delete_application_request
    import aws_sdk_emr_serverless.types.delete_application_response
    import aws_sdk_emr_serverless.types.disk_encryption_configuration
    import aws_sdk_emr_serverless.types.engine_type
    import aws_sdk_emr_serverless.types.get_application_request
    import aws_sdk_emr_serverless.types.get_application_response
    import aws_sdk_emr_serverless.types.get_resource_dashboard_request
    import aws_sdk_emr_serverless.types.get_resource_dashboard_response
    ...
    import aws_sdk_emr_serverless.types.list_applications_request
    import aws_sdk_emr_serverless.types.list_applications_response
    ...
    import aws_sdk_emr_serverless.types.resource_id
    import aws_sdk_emr_serverless.types.resource_type
    import aws_sdk_emr_serverless.types.scheduler_configuration
    import aws_sdk_emr_serverless.types.start_application_request
    import aws_sdk_emr_serverless.types.start_application_response
    import aws_sdk_emr_serverless.types.stop_application_request
    import aws_sdk_emr_serverless.types.stop_application_response
    import aws_sdk_emr_serverless.types.tag_map
    import aws_sdk_emr_serverless.types.update_application_request
    import aws_sdk_emr_serverless.types.update_application_response
...
class ApplicationResource:
    ...
    def create(
        ...
        *,
        ...
        name: Optional[
            "aws_sdk_emr_serverless.types.application_name.ApplicationName"
        ] = None,
        ...
        architecture: Optional[
            "aws_sdk_emr_serverless.types.architecture.Architecture"
        ] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_emr_serverless.types.create_application_request.CreateApplicationRequest]",
        ) -> OperationResponse[
            "aws_sdk_emr_serverless.types.create_application_response.CreateApplicationResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.create_application

            output, http_response = (
                aws_sdk_emr_serverless._operations.aws_toledo_web_service.create_application.create_application(
    ...
    def read(
        ...
        *,
        config_overrides: Optional[EMRServerlessClientConfig] = None,
    ) -> "aws_sdk_emr_serverless.types.get_application_response.GetApplicationResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_emr_serverless.types.get_application_request.GetApplicationRequest]",
        ) -> OperationResponse[
            "aws_sdk_emr_serverless.types.get_application_response.GetApplicationResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.get_application

            output, http_response = (
                aws_sdk_emr_serverless._operations.aws_toledo_web_service.get_application.get_application(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_emr_serverless.types.update_application_request.UpdateApplicationRequest]",
        ) -> OperationResponse[
            "aws_sdk_emr_serverless.types.update_application_response.UpdateApplicationResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.update_application

            output, http_response = (
                aws_sdk_emr_serverless._operations.aws_toledo_web_service.update_application.update_application(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        config_overrides: Optional[EMRServerlessClientConfig] = None,
    ) -> "aws_sdk_emr_serverless.types.delete_application_response.DeleteApplicationResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_emr_serverless.types.delete_application_request.DeleteApplicationRequest]",
        ) -> OperationResponse[
            "aws_sdk_emr_serverless.types.delete_application_response.DeleteApplicationResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.delete_application

            output, http_response = (
                aws_sdk_emr_serverless._operations.aws_toledo_web_service.delete_application.delete_application(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_emr_serverless.types.list_applications_response.ListApplicationsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_emr_serverless.types.list_applications_request.ListApplicationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_emr_serverless.types.list_applications_response.ListApplicationsResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.list_applications

            output, http_response = (
                aws_sdk_emr_serverless._operations.aws_toledo_web_service.list_applications.list_applications(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_dashboard(
        self,
        application_id: "aws_sdk_emr_serverless.types.application_id.ApplicationId",
        resource_id: "aws_sdk_emr_serverless.types.resource_id.ResourceId",
        resource_type: "aws_sdk_emr_serverless.types.resource_type.ResourceType",
        *,
        config_overrides: Optional[EMRServerlessClientConfig] = None,
    ) -> "aws_sdk_emr_serverless.types.get_resource_dashboard_response.GetResourceDashboardResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_emr_serverless.types.get_resource_dashboard_request.GetResourceDashboardRequest]",
        ) -> OperationResponse[
            "aws_sdk_emr_serverless.types.get_resource_dashboard_response.GetResourceDashboardResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.get_resource_dashboard

            output, http_response = (
                aws_sdk_emr_serverless._operations.aws_toledo_web_service.get_resource_dashboard.get_resource_dashboard(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_application(
        ...
        *,
        config_overrides: Optional[EMRServerlessClientConfig] = None,
    ) -> "aws_sdk_emr_serverless.types.start_application_response.StartApplicationResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_emr_serverless.types.start_application_request.StartApplicationRequest]",
        ) -> OperationResponse[
            "aws_sdk_emr_serverless.types.start_application_response.StartApplicationResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.start_application

            output, http_response = (
                aws_sdk_emr_serverless._operations.aws_toledo_web_service.start_application.start_application(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_application(
        ...
        *,
        ...
        "aws_sdk_emr_serverless.types.stop_application_response.StopApplicationResponse"
    ):
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_emr_serverless.types.stop_application_request.StopApplicationRequest]",
        ) -> OperationResponse[
            "aws_sdk_emr_serverless.types.stop_application_response.StopApplicationResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.stop_application

            output, http_response = (
                aws_sdk_emr_serverless._operations.aws_toledo_web_service.stop_application.stop_application(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncApplicationResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_serverless.types.create_application_request.CreateApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_serverless.types.create_application_response.CreateApplicationResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.create_application
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_serverless._operations.aws_toledo_web_service.create_application.async_create_application(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_serverless.types.get_application_request.GetApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_serverless.types.get_application_response.GetApplicationResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.get_application
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_serverless._operations.aws_toledo_web_service.get_application.async_get_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_serverless.types.update_application_request.UpdateApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_serverless.types.update_application_response.UpdateApplicationResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.update_application
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_serverless._operations.aws_toledo_web_service.update_application.async_update_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_serverless.types.delete_application_request.DeleteApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_serverless.types.delete_application_response.DeleteApplicationResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.delete_application
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_serverless._operations.aws_toledo_web_service.delete_application.async_delete_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_serverless.types.list_applications_request.ListApplicationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_serverless.types.list_applications_response.ListApplicationsResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.list_applications
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_serverless._operations.aws_toledo_web_service.list_applications.async_list_applications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resource_dashboard(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_serverless.types.get_resource_dashboard_request.GetResourceDashboardRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_serverless.types.get_resource_dashboard_response.GetResourceDashboardResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.get_resource_dashboard
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_serverless._operations.aws_toledo_web_service.get_resource_dashboard.async_get_resource_dashboard(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_serverless.types.start_application_request.StartApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_serverless.types.start_application_response.StartApplicationResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.start_application
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_serverless._operations.aws_toledo_web_service.start_application.async_start_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_emr_serverless.types.stop_application_request.StopApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_emr_serverless.types.stop_application_response.StopApplicationResponse"
        ]:
            import aws_sdk_emr_serverless._operations.aws_toledo_web_service.stop_application
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_emr_serverless._operations.aws_toledo_web_service.stop_application.async_stop_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
