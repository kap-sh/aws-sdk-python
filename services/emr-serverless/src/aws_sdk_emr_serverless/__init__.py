...
from ._services.async_emr_serverless import (
    AsyncEMRServerlessClient as AsyncEMRServerlessClient,
)
from ._services.emr_serverless import EMRServerlessClient as EMRServerlessClient
