...
```
pip install aws-sdk-emr-serverless
```

## Usage

```python
from aws_sdk_emr_serverless import AsyncEMRServerlessClient


async def main():
    async with AsyncEMRServerlessClient() as s3:
...
```python
from aws_sdk_emr_serverless import AsyncEMRServerlessClient
from aws_sdk_emr_serverless.error import InternalServerException
