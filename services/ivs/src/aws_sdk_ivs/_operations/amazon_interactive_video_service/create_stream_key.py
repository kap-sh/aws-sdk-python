...
def handle_response(
    ...
    out: aws_sdk_ivs.types.create_stream_key_response.CreateStreamKeyResponse = (
        aws_sdk_ivs.types.create_stream_key_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.create_stream_key_request.CreateStreamKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.create_stream_key_request.serialize_json(input_)
    ).encode()
