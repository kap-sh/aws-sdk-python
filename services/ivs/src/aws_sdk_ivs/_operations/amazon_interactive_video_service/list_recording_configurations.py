"""Generated from Smithy shape ``com.amazonaws.ivs#ListRecordingConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_ivs.types.list_recording_configurations_response.ListRecordingConfigurationsResponse = aws_sdk_ivs.types.list_recording_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.list_recording_configurations_request.ListRecordingConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListRecordingConfigurations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivs.types.list_recording_configurations_request

    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.list_recording_configurations_request.serialize_json(input_)
    ).encode()
...
async def async_list_recording_configurations(
