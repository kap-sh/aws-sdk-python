...
def build_request(
    ...
    input: aws_sdk_ivs.types.list_recording_configurations_request.ListRecordingConfigurationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.list_recording_configurations_request.serialize_json(input)
    ).encode()
