...
def build_request(
    ...
    input_: aws_sdk_ivs.types.delete_ad_configuration_request.DeleteAdConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.delete_ad_configuration_request.serialize_json(input_)
    ).encode()
