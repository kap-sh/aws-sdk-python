...
def handle_response(
    ...
    out: aws_sdk_ivs.types.get_stream_session_response.GetStreamSessionResponse = (
        aws_sdk_ivs.types.get_stream_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.get_stream_session_request.GetStreamSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.get_stream_session_request.serialize_json(input_)
    ).encode()
