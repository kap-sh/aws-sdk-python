"""Generated from Smithy shape ``com.amazonaws.ivs#DeletePlaybackRestrictionPolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.delete_playback_restriction_policy_request.DeletePlaybackRestrictionPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/DeletePlaybackRestrictionPolicy"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivs.types.delete_playback_restriction_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.delete_playback_restriction_policy_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_delete_playback_restriction_policy(
