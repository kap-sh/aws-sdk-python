...
def handle_response(
    ...
    out: aws_sdk_ivs.types.list_playback_restriction_policies_response.ListPlaybackRestrictionPoliciesResponse = aws_sdk_ivs.types.list_playback_restriction_policies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.list_playback_restriction_policies_request.ListPlaybackRestrictionPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.list_playback_restriction_policies_request.serialize_json(
            input_
        )
    ).encode()
