"""Generated from Smithy shape ``com.amazonaws.ivs#ListChannels``."""
...
def handle_response(
    ...
    out: aws_sdk_ivs.types.list_channels_response.ListChannelsResponse = (
        aws_sdk_ivs.types.list_channels_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.list_channels_request.ListChannelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListChannels"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivs.types.list_channels_request

    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.list_channels_request.serialize_json(input_)
    ).encode()
...
def list_channels(
    ...
    aws_sdk_ivs.types.list_channels_response.ListChannelsResponse, zapros.Response
]:
