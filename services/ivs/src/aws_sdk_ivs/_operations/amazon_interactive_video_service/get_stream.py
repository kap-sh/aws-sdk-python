...
import aws_sdk_ivs.types.stream
...
def handle_response(
    ...
    out: aws_sdk_ivs.types.get_stream_response.GetStreamResponse = (
        aws_sdk_ivs.types.get_stream_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.get_stream_request.GetStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.get_stream_request.serialize_json(input_)
    ).encode()
...
def get_stream(
    ...
    input_: aws_sdk_ivs.types.get_stream_request.GetStreamRequest,
) -> tuple[aws_sdk_ivs.types.get_stream_response.GetStreamResponse, zapros.Response]:
