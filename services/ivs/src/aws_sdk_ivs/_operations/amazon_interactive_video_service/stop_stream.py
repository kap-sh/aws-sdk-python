"""Generated from Smithy shape ``com.amazonaws.ivs#StopStream``."""
...
import aws_sdk_ivs.errors.channel_not_broadcasting
import aws_sdk_ivs.errors.resource_not_found_exception
import aws_sdk_ivs.errors.stream_unavailable
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ChannelNotBroadcasting":
            raise aws_sdk_ivs.errors.channel_not_broadcasting.ChannelNotBroadcasting.from_json(
                data
            )
        ...
        case "StreamUnavailable":
            raise aws_sdk_ivs.errors.stream_unavailable.StreamUnavailable.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ivs.types.stop_stream_response.StopStreamResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.stop_stream_request.StopStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/StopStream"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivs.types.stop_stream_request

    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.stop_stream_request.serialize_json(input_)
    ).encode()
...
def stop_stream(
    ...
    input_: aws_sdk_ivs.types.stop_stream_request.StopStreamRequest,
) -> tuple[aws_sdk_ivs.types.stop_stream_response.StopStreamResponse, zapros.Response]:
