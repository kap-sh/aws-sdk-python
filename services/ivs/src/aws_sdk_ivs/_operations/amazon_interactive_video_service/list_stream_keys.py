...
def handle_response(
    ...
    out: aws_sdk_ivs.types.list_stream_keys_response.ListStreamKeysResponse = (
        aws_sdk_ivs.types.list_stream_keys_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.list_stream_keys_request.ListStreamKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.list_stream_keys_request.serialize_json(input_)
    ).encode()
...
def list_stream_keys(
    ...
    aws_sdk_ivs.types.list_stream_keys_response.ListStreamKeysResponse, zapros.Response
]:
