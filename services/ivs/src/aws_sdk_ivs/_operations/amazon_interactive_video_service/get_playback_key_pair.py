"""Generated from Smithy shape ``com.amazonaws.ivs#GetPlaybackKeyPair``."""
...
def handle_response(
    ...
    out: aws_sdk_ivs.types.get_playback_key_pair_response.GetPlaybackKeyPairResponse = (
        aws_sdk_ivs.types.get_playback_key_pair_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.get_playback_key_pair_request.GetPlaybackKeyPairRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetPlaybackKeyPair"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivs.types.get_playback_key_pair_request

    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.get_playback_key_pair_request.serialize_json(input_)
    ).encode()
...
async def async_get_playback_key_pair(
