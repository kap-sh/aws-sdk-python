...
def handle_response(
    ...
    out: aws_sdk_ivs.types.insert_ad_break_response.InsertAdBreakResponse = (
        aws_sdk_ivs.types.insert_ad_break_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.insert_ad_break_request.InsertAdBreakRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.insert_ad_break_request.serialize_json(input_)
    ).encode()
...
def insert_ad_break(
    ...
    aws_sdk_ivs.types.insert_ad_break_response.InsertAdBreakResponse, zapros.Response
]:
