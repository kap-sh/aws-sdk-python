...
def handle_response(
    ...
    out: aws_sdk_ivs.types.get_recording_configuration_response.GetRecordingConfigurationResponse = aws_sdk_ivs.types.get_recording_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.get_recording_configuration_request.GetRecordingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.get_recording_configuration_request.serialize_json(input_)
    ).encode()
