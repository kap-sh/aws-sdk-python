...
def build_request(
    ...
    input: aws_sdk_ivs.types.get_recording_configuration_request.GetRecordingConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.get_recording_configuration_request.serialize_json(input)
    ).encode()
