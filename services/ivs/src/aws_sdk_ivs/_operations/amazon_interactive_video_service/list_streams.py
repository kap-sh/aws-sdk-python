...
def handle_response(
    ...
    out: aws_sdk_ivs.types.list_streams_response.ListStreamsResponse = (
        aws_sdk_ivs.types.list_streams_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.list_streams_request.ListStreamsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.list_streams_request.serialize_json(input_)
    ).encode()
...
def list_streams(
    ...
    aws_sdk_ivs.types.list_streams_response.ListStreamsResponse, zapros.Response
]:
