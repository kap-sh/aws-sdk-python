...
def handle_response(
    ...
    out: aws_sdk_ivs.types.update_ad_configuration_response.UpdateAdConfigurationResponse = aws_sdk_ivs.types.update_ad_configuration_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_ivs.types.update_ad_configuration_request.UpdateAdConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.update_ad_configuration_request.serialize_json(input)
    ).encode()
