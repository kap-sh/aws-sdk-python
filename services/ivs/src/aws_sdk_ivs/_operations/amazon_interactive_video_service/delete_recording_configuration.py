...
def build_request(
    ...
    input_: aws_sdk_ivs.types.delete_recording_configuration_request.DeleteRecordingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.delete_recording_configuration_request.serialize_json(input_)
    ).encode()
