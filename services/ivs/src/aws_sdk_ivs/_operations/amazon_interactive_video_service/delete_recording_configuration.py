...
def build_request(
    ...
    input: aws_sdk_ivs.types.delete_recording_configuration_request.DeleteRecordingConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.delete_recording_configuration_request.serialize_json(input)
    ).encode()
