...
def handle_response(
    ...
    out: aws_sdk_ivs.types.list_stream_sessions_response.ListStreamSessionsResponse = (
        aws_sdk_ivs.types.list_stream_sessions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.list_stream_sessions_request.ListStreamSessionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.list_stream_sessions_request.serialize_json(input_)
    ).encode()
