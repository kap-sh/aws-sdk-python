...
def handle_response(
    ...
    out: aws_sdk_ivs.types.get_stream_key_response.GetStreamKeyResponse = (
        aws_sdk_ivs.types.get_stream_key_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.get_stream_key_request.GetStreamKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.get_stream_key_request.serialize_json(input_)
    ).encode()
...
def get_stream_key(
    ...
    aws_sdk_ivs.types.get_stream_key_response.GetStreamKeyResponse, zapros.Response
]:
