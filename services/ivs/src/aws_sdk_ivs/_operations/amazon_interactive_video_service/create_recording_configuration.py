...
def build_request(
    ...
    input: aws_sdk_ivs.types.create_recording_configuration_request.CreateRecordingConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.create_recording_configuration_request.serialize_json(input)
    ).encode()
