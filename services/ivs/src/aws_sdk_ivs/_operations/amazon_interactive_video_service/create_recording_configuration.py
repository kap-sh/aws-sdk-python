"""Generated from Smithy shape ``com.amazonaws.ivs#CreateRecordingConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_ivs.types.create_recording_configuration_response.CreateRecordingConfigurationResponse = aws_sdk_ivs.types.create_recording_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.create_recording_configuration_request.CreateRecordingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/CreateRecordingConfiguration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivs.types.create_recording_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.create_recording_configuration_request.serialize_json(input_)
    ).encode()
...
async def async_create_recording_configuration(
