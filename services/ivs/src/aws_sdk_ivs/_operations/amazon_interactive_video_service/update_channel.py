"""Generated from Smithy shape ``com.amazonaws.ivs#UpdateChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_ivs.types.update_channel_response.UpdateChannelResponse = (
        aws_sdk_ivs.types.update_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.update_channel_request.UpdateChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/UpdateChannel"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivs.types.update_channel_request

    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.update_channel_request.serialize_json(input_)
    ).encode()
...
def update_channel(
    ...
    aws_sdk_ivs.types.update_channel_response.UpdateChannelResponse, zapros.Response
]:
