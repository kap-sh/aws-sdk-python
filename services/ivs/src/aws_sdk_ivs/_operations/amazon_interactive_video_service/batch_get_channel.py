...
def handle_response(
    ...
    out: aws_sdk_ivs.types.batch_get_channel_response.BatchGetChannelResponse = (
        aws_sdk_ivs.types.batch_get_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.batch_get_channel_request.BatchGetChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.batch_get_channel_request.serialize_json(input_)
    ).encode()
