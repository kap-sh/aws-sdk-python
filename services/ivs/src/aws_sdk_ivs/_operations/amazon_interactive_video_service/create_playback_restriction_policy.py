"""Generated from Smithy shape ``com.amazonaws.ivs#CreatePlaybackRestrictionPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_ivs.types.create_playback_restriction_policy_response.CreatePlaybackRestrictionPolicyResponse = aws_sdk_ivs.types.create_playback_restriction_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.create_playback_restriction_policy_request.CreatePlaybackRestrictionPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/CreatePlaybackRestrictionPolicy"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivs.types.create_playback_restriction_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.create_playback_restriction_policy_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_playback_restriction_policy(
