...
def build_request(
    ...
    input: aws_sdk_ivs.types.create_ad_configuration_request.CreateAdConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.create_ad_configuration_request.serialize_json(input)
    ).encode()
