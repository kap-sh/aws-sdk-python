"""Generated from Smithy shape ``com.amazonaws.ivs#CreateAdConfiguration``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_ivs.errors.conflict_exception

            raise aws_sdk_ivs.errors.conflict_exception.ConflictException.from_json(
                data
            )
        case "InternalServerException":
            import aws_sdk_ivs.errors.internal_server_exception

            raise aws_sdk_ivs.errors.internal_server_exception.InternalServerException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_ivs.errors.service_quota_exceeded_exception

            raise aws_sdk_ivs.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
        case "ThrottlingException":
            import aws_sdk_ivs.errors.throttling_exception

            raise aws_sdk_ivs.errors.throttling_exception.ThrottlingException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_ivs.types.create_ad_configuration_response.CreateAdConfigurationResponse = aws_sdk_ivs.types.create_ad_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.create_ad_configuration_request.CreateAdConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/CreateAdConfiguration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivs.types.create_ad_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.create_ad_configuration_request.serialize_json(input_)
    ).encode()
...
async def async_create_ad_configuration(
