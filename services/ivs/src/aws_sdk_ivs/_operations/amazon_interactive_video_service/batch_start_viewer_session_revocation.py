...
def handle_response(
    ...
    out: aws_sdk_ivs.types.batch_start_viewer_session_revocation_response.BatchStartViewerSessionRevocationResponse = aws_sdk_ivs.types.batch_start_viewer_session_revocation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.batch_start_viewer_session_revocation_request.BatchStartViewerSessionRevocationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
