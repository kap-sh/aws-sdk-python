...
def handle_response(
    ...
    out: aws_sdk_ivs.types.delete_playback_key_pair_response.DeletePlaybackKeyPairResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.delete_playback_key_pair_request.DeletePlaybackKeyPairRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.delete_playback_key_pair_request.serialize_json(input_)
    ).encode()
