...
def build_request(
    ...
    input: aws_sdk_ivs.types.delete_playback_key_pair_request.DeletePlaybackKeyPairRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.delete_playback_key_pair_request.serialize_json(input)
    ).encode()
