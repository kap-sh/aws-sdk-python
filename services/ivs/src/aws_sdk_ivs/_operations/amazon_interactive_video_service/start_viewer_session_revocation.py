...
def build_request(
    ...
    input: aws_sdk_ivs.types.start_viewer_session_revocation_request.StartViewerSessionRevocationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.start_viewer_session_revocation_request.serialize_json(input)
    ).encode()
