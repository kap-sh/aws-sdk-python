...
def handle_response(
    ...
    out: aws_sdk_ivs.types.start_viewer_session_revocation_response.StartViewerSessionRevocationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.start_viewer_session_revocation_request.StartViewerSessionRevocationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.start_viewer_session_revocation_request.serialize_json(input_)
    ).encode()
