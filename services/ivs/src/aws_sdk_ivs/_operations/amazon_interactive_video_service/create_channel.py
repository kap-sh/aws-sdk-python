"""Generated from Smithy shape ``com.amazonaws.ivs#CreateChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_ivs.types.create_channel_response.CreateChannelResponse = (
        aws_sdk_ivs.types.create_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.create_channel_request.CreateChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/CreateChannel"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivs.types.create_channel_request

    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.create_channel_request.serialize_json(input_)
    ).encode()
...
def create_channel(
    ...
    aws_sdk_ivs.types.create_channel_response.CreateChannelResponse, zapros.Response
]:
