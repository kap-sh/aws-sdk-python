...
def handle_response(
    ...
    out: aws_sdk_ivs.types.get_channel_response.GetChannelResponse = (
        aws_sdk_ivs.types.get_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.get_channel_request.GetChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.get_channel_request.serialize_json(input_)
    ).encode()
...
def get_channel(
    ...
    input_: aws_sdk_ivs.types.get_channel_request.GetChannelRequest,
) -> tuple[aws_sdk_ivs.types.get_channel_response.GetChannelResponse, zapros.Response]:
