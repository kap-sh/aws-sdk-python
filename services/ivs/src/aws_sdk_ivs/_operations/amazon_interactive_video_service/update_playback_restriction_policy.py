...
def handle_response(
    ...
    out: aws_sdk_ivs.types.update_playback_restriction_policy_response.UpdatePlaybackRestrictionPolicyResponse = aws_sdk_ivs.types.update_playback_restriction_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.update_playback_restriction_policy_request.UpdatePlaybackRestrictionPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
