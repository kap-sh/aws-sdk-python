"""Generated from Smithy shape ``com.amazonaws.ivs#ListPlaybackKeyPairs``."""
...
def handle_response(
    ...
    out: aws_sdk_ivs.types.list_playback_key_pairs_response.ListPlaybackKeyPairsResponse = aws_sdk_ivs.types.list_playback_key_pairs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.list_playback_key_pairs_request.ListPlaybackKeyPairsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListPlaybackKeyPairs"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivs.types.list_playback_key_pairs_request

    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.list_playback_key_pairs_request.serialize_json(input_)
    ).encode()
...
async def async_list_playback_key_pairs(
