...
def build_request(
    ...
    input: aws_sdk_ivs.types.list_playback_key_pairs_request.ListPlaybackKeyPairsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.list_playback_key_pairs_request.serialize_json(input)
    ).encode()
