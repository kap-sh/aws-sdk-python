"""Generated from Smithy shape ``com.amazonaws.ivs#ListAdConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_ivs.types.list_ad_configurations_response.ListAdConfigurationsResponse = aws_sdk_ivs.types.list_ad_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.list_ad_configurations_request.ListAdConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListAdConfigurations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivs.types.list_ad_configurations_request

    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.list_ad_configurations_request.serialize_json(input_)
    ).encode()
...
async def async_list_ad_configurations(
