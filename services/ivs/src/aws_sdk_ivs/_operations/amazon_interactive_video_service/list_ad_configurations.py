...
def build_request(
    ...
    input: aws_sdk_ivs.types.list_ad_configurations_request.ListAdConfigurationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.list_ad_configurations_request.serialize_json(input)
    ).encode()
