...
def build_request(
    ...
    input: aws_sdk_ivs.types.get_playback_restriction_policy_request.GetPlaybackRestrictionPolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.get_playback_restriction_policy_request.serialize_json(input)
    ).encode()
