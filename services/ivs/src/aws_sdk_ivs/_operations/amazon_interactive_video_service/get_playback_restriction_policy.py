...
def handle_response(
    ...
    out: aws_sdk_ivs.types.get_playback_restriction_policy_response.GetPlaybackRestrictionPolicyResponse = aws_sdk_ivs.types.get_playback_restriction_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.get_playback_restriction_policy_request.GetPlaybackRestrictionPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.get_playback_restriction_policy_request.serialize_json(input_)
    ).encode()
