...
def build_request(
    ...
    input: aws_sdk_ivs.types.import_playback_key_pair_request.ImportPlaybackKeyPairRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.import_playback_key_pair_request.serialize_json(input)
    ).encode()
