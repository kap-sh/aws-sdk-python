"""Generated from Smithy shape ``com.amazonaws.ivs#ImportPlaybackKeyPair``."""
...
def handle_response(
    ...
    out: aws_sdk_ivs.types.import_playback_key_pair_response.ImportPlaybackKeyPairResponse = aws_sdk_ivs.types.import_playback_key_pair_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs.types.import_playback_key_pair_request.ImportPlaybackKeyPairRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ImportPlaybackKeyPair"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivs.types.import_playback_key_pair_request

    body: bytes | None = json.dumps(
        aws_sdk_ivs.types.import_playback_key_pair_request.serialize_json(input_)
    ).encode()
...
async def async_import_playback_key_pair(
