...
class ivsError(Exception):
    """Base class for all ivs service errors."""


class ServiceError(ivsError):
...
class SerializationError(ivsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ivsError):
...
class WaiterFailedError(ivsError):
...
class WaiterTimeoutError(ivsError):
