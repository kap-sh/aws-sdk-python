...
if TYPE_CHECKING:
    ...
    import aws_sdk_ivs.types.playback_key_pair_fingerprint
    import aws_sdk_ivs.types.playback_key_pair_name
    import aws_sdk_ivs.types.tags


class PlaybackKeyPair(TypedDict):
    ...
    fingerprint: NotRequired[
        "aws_sdk_ivs.types.playback_key_pair_fingerprint.PlaybackKeyPairFingerprint"
    ]
