...
class VideoConfiguration(TypedDict, closed=True):
    ...
    encoder: NotRequired["aws_sdk_ivs.types.string.String"]
    ...
    target_framerate: "aws_sdk_ivs.types.integer.Integer"
    """<p>The expected ingest framerate. This is configured in the encoder.</p>"""
    video_height: "aws_sdk_ivs.types.integer.Integer"
    """<p>Video-resolution height in pixels.</p>"""
    video_width: "aws_sdk_ivs.types.integer.Integer"
    """<p>Video-resolution width in pixels.</p>"""
    level: NotRequired["aws_sdk_ivs.types.string.String"]
    ...
    profile: NotRequired["aws_sdk_ivs.types.string.String"]
