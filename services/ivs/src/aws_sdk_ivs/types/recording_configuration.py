...
class RecordingConfiguration(TypedDict):
    ...
    recording_reconnect_window_seconds: "aws_sdk_ivs.types.recording_reconnect_window_seconds.RecordingReconnectWindowSeconds"
...
def serialize_json(value: RecordingConfiguration) -> dict:
    ...
    if "thumbnail_configuration" in value:
        ...
        out["thumbnailConfiguration"] = (
            aws_sdk_ivs.types.thumbnail_configuration.serialize_json(
    ...
    if "rendition_configuration" in value:
        ...
        out["renditionConfiguration"] = (
            aws_sdk_ivs.types.rendition_configuration.serialize_json(
...
def deserialize_json(data: dict) -> RecordingConfiguration:
    ...
    if "thumbnailConfiguration" in data:
        ...
        out["thumbnail_configuration"] = (
            aws_sdk_ivs.types.thumbnail_configuration.deserialize_json(
    ...
    if "renditionConfiguration" in data:
        ...
        out["rendition_configuration"] = (
            aws_sdk_ivs.types.rendition_configuration.deserialize_json(
