...
def handle_response(
    ...
    out: capo_ivs.types.create_recording_configuration_response.CreateRecordingConfigurationResponse = capo_ivs.types.create_recording_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.create_recording_configuration_request.serialize_json(input_)
    ).encode()
