"""Generated from Smithy shape ``com.amazonaws.ivs#DeleteStreamKey``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.delete_stream_key_request.serialize_json(input_)
    ).encode()
...
async def async_delete_stream_key(
