...
def handle_response(
    ...
    out: capo_ivs.types.list_recording_configurations_response.ListRecordingConfigurationsResponse = capo_ivs.types.list_recording_configurations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.list_recording_configurations_request.serialize_json(input_)
    ).encode()
