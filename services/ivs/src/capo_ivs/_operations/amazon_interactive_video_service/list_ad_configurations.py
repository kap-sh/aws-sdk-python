...
def handle_response(
    ...
    out: capo_ivs.types.list_ad_configurations_response.ListAdConfigurationsResponse = (
        capo_ivs.types.list_ad_configurations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.list_ad_configurations_request.serialize_json(input_)
    ).encode()
