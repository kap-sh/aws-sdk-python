...
def handle_response(
    ...
    out: capo_ivs.types.list_channels_response.ListChannelsResponse = (
        capo_ivs.types.list_channels_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.list_channels_request.serialize_json(input_)
    ).encode()
...
def list_channels(
    ...
    input_: capo_ivs.types.list_channels_request.ListChannelsRequest,
) -> tuple[capo_ivs.types.list_channels_response.ListChannelsResponse, zapros.Response]:
