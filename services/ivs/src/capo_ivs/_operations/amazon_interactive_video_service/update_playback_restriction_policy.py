"""Generated from Smithy shape ``com.amazonaws.ivs#UpdatePlaybackRestrictionPolicy``."""
...
def handle_response(
    ...
    out: capo_ivs.types.update_playback_restriction_policy_response.UpdatePlaybackRestrictionPolicyResponse = capo_ivs.types.update_playback_restriction_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.update_playback_restriction_policy_request.serialize_json(input_)
    ).encode()
...
async def async_update_playback_restriction_policy(
