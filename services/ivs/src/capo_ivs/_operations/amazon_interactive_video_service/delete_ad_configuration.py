"""Generated from Smithy shape ``com.amazonaws.ivs#DeleteAdConfiguration``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteAdConfiguration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_ivs.types.delete_ad_configuration_request.serialize_json(input_)
    ).encode()
...
async def async_delete_ad_configuration(
