"""Generated from Smithy shape ``com.amazonaws.ivs#UpdateAdConfiguration``."""
...
import capo_ivs.errors.conflict_exception
import capo_ivs.errors.internal_server_exception
import capo_ivs.errors.pending_verification
import capo_ivs.errors.resource_not_found_exception
import capo_ivs.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_ivs.errors.conflict_exception.ConflictException.from_json(data)
        case "InternalServerException":
            raise capo_ivs.errors.internal_server_exception.InternalServerException.from_json(
                data
            )
        ...
        case "ResourceNotFoundException":
            raise capo_ivs.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
        case "ServiceQuotaExceededException":
            raise capo_ivs.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_ivs.types.update_ad_configuration_response.UpdateAdConfigurationResponse = capo_ivs.types.update_ad_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.update_ad_configuration_request.serialize_json(input_)
    ).encode()
...
async def async_update_ad_configuration(
