...
def handle_response(
    ...
    out: capo_ivs.types.list_playback_key_pairs_response.ListPlaybackKeyPairsResponse = capo_ivs.types.list_playback_key_pairs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.list_playback_key_pairs_request.serialize_json(input_)
    ).encode()
