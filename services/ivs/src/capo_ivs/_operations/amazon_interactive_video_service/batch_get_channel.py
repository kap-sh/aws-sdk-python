"""Generated from Smithy shape ``com.amazonaws.ivs#BatchGetChannel``."""
...
import capo_ivs.errors.service_unavailable
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceUnavailable":
            raise capo_ivs.errors.service_unavailable.ServiceUnavailable.from_json(data)
...
def handle_response(
    ...
    out: capo_ivs.types.batch_get_channel_response.BatchGetChannelResponse = (
        capo_ivs.types.batch_get_channel_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/BatchGetChannel"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_ivs.types.batch_get_channel_request.serialize_json(input_)
    ).encode()
...
def batch_get_channel(
    ...
    capo_ivs.types.batch_get_channel_response.BatchGetChannelResponse, zapros.Response
]:
...
async def async_batch_get_channel(
