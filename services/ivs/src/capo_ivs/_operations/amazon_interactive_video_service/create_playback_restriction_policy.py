...
def handle_response(
    ...
    out: capo_ivs.types.create_playback_restriction_policy_response.CreatePlaybackRestrictionPolicyResponse = capo_ivs.types.create_playback_restriction_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.create_playback_restriction_policy_request.serialize_json(input_)
    ).encode()
