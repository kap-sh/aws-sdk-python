...
if TYPE_CHECKING:
    import capo_ivs.types.recording_configuration_summary

RecordingConfigurationList: TypeAlias = list[
    "capo_ivs.types.recording_configuration_summary.RecordingConfigurationSummary"
]
...
def serialize_json(value: RecordingConfigurationList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_ivs.types.recording_configuration_summary.serialize_json(item))
    return out
