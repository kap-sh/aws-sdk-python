...
if TYPE_CHECKING:
    import capo_ivs.types.media_tailor_playback_configuration_arn


class MediaTailorPlaybackConfiguration(TypedDict, closed=True):
    playback_configuration_arn: NotRequired[
        "capo_ivs.types.media_tailor_playback_configuration_arn.MediaTailorPlaybackConfigurationArn"
    ]
