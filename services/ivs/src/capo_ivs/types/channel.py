...
if TYPE_CHECKING:
    ...
    import capo_ivs.types.ingest_endpoint
    import capo_ivs.types.insecure_ingest
    import capo_ivs.types.is_authorized
...
class Channel(TypedDict, closed=True):
    arn: NotRequired["capo_ivs.types.channel_arn.ChannelArn"]
    """<p>Channel ARN.</p>"""
    ...
    ingest_endpoint: NotRequired["capo_ivs.types.ingest_endpoint.IngestEndpoint"]
    ...
    authorized: "capo_ivs.types.is_authorized.IsAuthorized"
    ...
    srt: NotRequired["capo_ivs.types.srt.Srt"]
...
def serialize_json(value: Channel) -> dict:
    ...
    if "srt" in value:
        ...
        out["srt"] = capo_ivs.types.srt.serialize_json(value["srt"])
