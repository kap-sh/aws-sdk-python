...
if TYPE_CHECKING:
    import aws_sdk_inspector.types.assessment_run_in_progress_arn_list
...
class AssessmentRunInProgressException_(TypedDict):
    ...
    assessment_run_arns_truncated: "aws_sdk_inspector.types.bool.Bool"
...
def serialize_aws_json_1_1(value: AssessmentRunInProgressException_) -> dict:
    ...
    out["assessmentRunArns"] = (
        aws_sdk_inspector.types.assessment_run_in_progress_arn_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AssessmentRunInProgressException_:
    ...
    if "assessmentRunArns" in data:
        ...
        out["assessment_run_arns"] = (
            aws_sdk_inspector.types.assessment_run_in_progress_arn_list.deserialize_aws_json_1_1(
