...
def build_request(
    ...
    input_: aws_sdk_inspector.types.stop_assessment_run_request.StopAssessmentRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.stop_assessment_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
