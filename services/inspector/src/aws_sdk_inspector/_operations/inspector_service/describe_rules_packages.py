...
def handle_response(
    ...
    out: aws_sdk_inspector.types.describe_rules_packages_response.DescribeRulesPackagesResponse = aws_sdk_inspector.types.describe_rules_packages_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.describe_rules_packages_request.DescribeRulesPackagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.describe_rules_packages_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
