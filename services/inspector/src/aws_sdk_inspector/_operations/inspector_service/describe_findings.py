...
def build_request(
    ...
    input: aws_sdk_inspector.types.describe_findings_request.DescribeFindingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.describe_findings_request.serialize_aws_json_1_1(input)
    ).encode()
