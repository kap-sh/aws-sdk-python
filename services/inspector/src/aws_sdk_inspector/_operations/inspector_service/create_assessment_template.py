...
def handle_response(
    ...
    out: aws_sdk_inspector.types.create_assessment_template_response.CreateAssessmentTemplateResponse = aws_sdk_inspector.types.create_assessment_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.create_assessment_template_request.CreateAssessmentTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.create_assessment_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
