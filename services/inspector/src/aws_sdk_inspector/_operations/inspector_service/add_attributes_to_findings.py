...
def handle_response(
    ...
    out: aws_sdk_inspector.types.add_attributes_to_findings_response.AddAttributesToFindingsResponse = aws_sdk_inspector.types.add_attributes_to_findings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.add_attributes_to_findings_request.AddAttributesToFindingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.add_attributes_to_findings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
