"""Generated from Smithy shape ``com.amazonaws.inspector#ListAssessmentTargets``."""
...
def handle_response(
    ...
    out: aws_sdk_inspector.types.list_assessment_targets_response.ListAssessmentTargetsResponse = aws_sdk_inspector.types.list_assessment_targets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.list_assessment_targets_request.ListAssessmentTargetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.list_assessment_targets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_assessment_targets(
