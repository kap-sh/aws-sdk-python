...
def handle_response(
    ...
    out: aws_sdk_inspector.types.list_rules_packages_response.ListRulesPackagesResponse = aws_sdk_inspector.types.list_rules_packages_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.list_rules_packages_request.ListRulesPackagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.list_rules_packages_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
