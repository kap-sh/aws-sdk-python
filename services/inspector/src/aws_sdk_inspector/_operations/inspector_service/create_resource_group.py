...
def handle_response(
    ...
    out: aws_sdk_inspector.types.create_resource_group_response.CreateResourceGroupResponse = aws_sdk_inspector.types.create_resource_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.create_resource_group_request.CreateResourceGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.create_resource_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
