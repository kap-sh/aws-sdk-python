...
def handle_response(
    ...
    out: aws_sdk_inspector.types.list_findings_response.ListFindingsResponse = (
        aws_sdk_inspector.types.list_findings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.list_findings_request.ListFindingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.list_findings_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_findings(
    ...
    aws_sdk_inspector.types.list_findings_response.ListFindingsResponse, zapros.Response
]:
