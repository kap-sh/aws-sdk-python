"""Generated from Smithy shape ``com.amazonaws.inspector#DeleteAssessmentTemplate``."""
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.delete_assessment_template_request.DeleteAssessmentTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.delete_assessment_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_assessment_template(
