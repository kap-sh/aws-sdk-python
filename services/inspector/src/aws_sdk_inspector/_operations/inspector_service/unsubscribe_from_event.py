"""Generated from Smithy shape ``com.amazonaws.inspector#UnsubscribeFromEvent``."""
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.unsubscribe_from_event_request.UnsubscribeFromEventRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.unsubscribe_from_event_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_unsubscribe_from_event(
