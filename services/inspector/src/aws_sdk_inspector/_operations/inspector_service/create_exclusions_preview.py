"""Generated from Smithy shape ``com.amazonaws.inspector#CreateExclusionsPreview``."""
...
import aws_sdk_inspector.errors.preview_generation_in_progress_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PreviewGenerationInProgressException":
            raise aws_sdk_inspector.errors.preview_generation_in_progress_exception.PreviewGenerationInProgressException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_inspector.types.create_exclusions_preview_response.CreateExclusionsPreviewResponse = aws_sdk_inspector.types.create_exclusions_preview_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.create_exclusions_preview_request.CreateExclusionsPreviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.create_exclusions_preview_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_exclusions_preview(
