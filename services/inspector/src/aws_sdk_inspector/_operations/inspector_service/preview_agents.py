...
def handle_response(
    ...
    out: aws_sdk_inspector.types.preview_agents_response.PreviewAgentsResponse = (
        aws_sdk_inspector.types.preview_agents_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.preview_agents_request.PreviewAgentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.preview_agents_request.serialize_aws_json_1_1(input_)
    ).encode()
