"""Generated from Smithy shape ``com.amazonaws.inspector#DescribeCrossAccountAccessRole``."""
...
def handle_response(
    ...
    out: aws_sdk_inspector.types.describe_cross_account_access_role_response.DescribeCrossAccountAccessRoleResponse = aws_sdk_inspector.types.describe_cross_account_access_role_response.deserialize_aws_json_1_1(
...
async def async_describe_cross_account_access_role(
