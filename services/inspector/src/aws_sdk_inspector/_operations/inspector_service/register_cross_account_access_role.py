"""Generated from Smithy shape ``com.amazonaws.inspector#RegisterCrossAccountAccessRole``."""
...
import aws_sdk_inspector.errors.invalid_cross_account_role_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidCrossAccountRoleException":
            raise aws_sdk_inspector.errors.invalid_cross_account_role_exception.InvalidCrossAccountRoleException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.register_cross_account_access_role_request.RegisterCrossAccountAccessRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.register_cross_account_access_role_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_register_cross_account_access_role(
