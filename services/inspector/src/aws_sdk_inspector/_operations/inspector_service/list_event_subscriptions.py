...
def handle_response(
    ...
    out: aws_sdk_inspector.types.list_event_subscriptions_response.ListEventSubscriptionsResponse = aws_sdk_inspector.types.list_event_subscriptions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.list_event_subscriptions_request.ListEventSubscriptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.list_event_subscriptions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
