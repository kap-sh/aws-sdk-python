...
import aws_sdk_inspector.errors.agents_already_running_assessment_exception
...
import aws_sdk_inspector.errors.limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AgentsAlreadyRunningAssessmentException":
            raise aws_sdk_inspector.errors.agents_already_running_assessment_exception.AgentsAlreadyRunningAssessmentException.from_aws_json_1_1(
                data
            )
        ...
        case "LimitExceededException":
            raise aws_sdk_inspector.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_inspector.types.start_assessment_run_response.StartAssessmentRunResponse = aws_sdk_inspector.types.start_assessment_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.start_assessment_run_request.StartAssessmentRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.start_assessment_run_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
