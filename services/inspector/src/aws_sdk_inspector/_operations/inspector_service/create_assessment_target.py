...
def handle_response(
    ...
    out: aws_sdk_inspector.types.create_assessment_target_response.CreateAssessmentTargetResponse = aws_sdk_inspector.types.create_assessment_target_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.create_assessment_target_request.CreateAssessmentTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.create_assessment_target_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
