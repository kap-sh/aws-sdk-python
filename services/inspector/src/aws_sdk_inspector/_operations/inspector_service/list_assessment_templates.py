"""Generated from Smithy shape ``com.amazonaws.inspector#ListAssessmentTemplates``."""
...
def handle_response(
    ...
    out: aws_sdk_inspector.types.list_assessment_templates_response.ListAssessmentTemplatesResponse = aws_sdk_inspector.types.list_assessment_templates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.list_assessment_templates_request.ListAssessmentTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.list_assessment_templates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_assessment_templates(
