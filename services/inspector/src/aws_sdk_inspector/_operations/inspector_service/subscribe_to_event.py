...
def build_request(
    ...
    input: aws_sdk_inspector.types.subscribe_to_event_request.SubscribeToEventRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.subscribe_to_event_request.serialize_aws_json_1_1(input)
    ).encode()
