...
def handle_response(
    ...
    out: aws_sdk_inspector.types.list_assessment_runs_response.ListAssessmentRunsResponse = aws_sdk_inspector.types.list_assessment_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.list_assessment_runs_request.ListAssessmentRunsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.list_assessment_runs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
