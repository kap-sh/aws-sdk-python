...
import aws_sdk_inspector.types.assessment_target_list
...
def handle_response(
    ...
    out: aws_sdk_inspector.types.describe_assessment_targets_response.DescribeAssessmentTargetsResponse = aws_sdk_inspector.types.describe_assessment_targets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.describe_assessment_targets_request.DescribeAssessmentTargetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.describe_assessment_targets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
