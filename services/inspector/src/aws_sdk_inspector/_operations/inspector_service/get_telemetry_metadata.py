...
def handle_response(
    ...
    out: aws_sdk_inspector.types.get_telemetry_metadata_response.GetTelemetryMetadataResponse = aws_sdk_inspector.types.get_telemetry_metadata_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.get_telemetry_metadata_request.GetTelemetryMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.get_telemetry_metadata_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
