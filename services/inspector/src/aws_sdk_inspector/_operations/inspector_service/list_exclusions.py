...
def handle_response(
    ...
    out: aws_sdk_inspector.types.list_exclusions_response.ListExclusionsResponse = (
        aws_sdk_inspector.types.list_exclusions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.list_exclusions_request.ListExclusionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.list_exclusions_request.serialize_aws_json_1_1(input_)
    ).encode()
