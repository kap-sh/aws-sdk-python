...
def build_request(
    ...
    input: aws_sdk_inspector.types.list_exclusions_request.ListExclusionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.list_exclusions_request.serialize_aws_json_1_1(input)
    ).encode()
