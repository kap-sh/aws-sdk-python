...
def build_request(
    ...
    input_: aws_sdk_inspector.types.update_assessment_target_request.UpdateAssessmentTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.update_assessment_target_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
