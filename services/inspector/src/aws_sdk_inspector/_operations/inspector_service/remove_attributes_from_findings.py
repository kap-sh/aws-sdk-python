...
def build_request(
    ...
    input_: aws_sdk_inspector.types.remove_attributes_from_findings_request.RemoveAttributesFromFindingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.remove_attributes_from_findings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
