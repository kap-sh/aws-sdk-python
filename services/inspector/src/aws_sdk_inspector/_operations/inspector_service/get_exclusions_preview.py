...
def handle_response(
    ...
    out: aws_sdk_inspector.types.get_exclusions_preview_response.GetExclusionsPreviewResponse = aws_sdk_inspector.types.get_exclusions_preview_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_inspector.types.get_exclusions_preview_request.GetExclusionsPreviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_inspector.types.get_exclusions_preview_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
