...
class GetAssessmentReportRequest(TypedDict):
...
def serialize_aws_json_1_1(value: GetAssessmentReportRequest) -> dict:
    ...
    out["reportFileFormat"] = (
        aws_sdk_inspector.types.report_file_format.serialize_aws_json_1_1(
            value["report_file_format"]
        )
    )
    import aws_sdk_inspector.types.report_type

    out["reportType"] = aws_sdk_inspector.types.report_type.serialize_aws_json_1_1(
        value["report_type"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetAssessmentReportRequest:
    ...
    if "reportFileFormat" in data:
        ...
        out["report_file_format"] = (
            aws_sdk_inspector.types.report_file_format.deserialize_aws_json_1_1(
    ...
    if "reportType" in data:
        ...
        out["report_type"] = (
            aws_sdk_inspector.types.report_type.deserialize_aws_json_1_1(
                data["reportType"]
            )
        )
    else:
