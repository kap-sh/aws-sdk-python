...
if TYPE_CHECKING:
    ...
    import aws_sdk_inspector.types.arn_count
...
class AssessmentTemplate(TypedDict):
    arn: "aws_sdk_inspector.types.arn.Arn"
    """<p>The ARN of the assessment template.</p>"""
    name: "aws_sdk_inspector.types.assessment_template_name.AssessmentTemplateName"
    ...
    last_assessment_run_arn: NotRequired["aws_sdk_inspector.types.arn.Arn"]
    ...
    assessment_run_count: "aws_sdk_inspector.types.arn_count.ArnCount"
