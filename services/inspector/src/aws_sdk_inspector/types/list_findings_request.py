...
class ListFindingsRequest(TypedDict, closed=True):
    ...
    filter: NotRequired["aws_sdk_inspector.types.finding_filter.FindingFilter"]
...
def serialize_aws_json_1_1(value: ListFindingsRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["filter"] = aws_sdk_inspector.types.finding_filter.serialize_aws_json_1_1(
            value["filter"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListFindingsRequest:
    ...
    if "filter" in data:
        ...
        out["filter"] = aws_sdk_inspector.types.finding_filter.deserialize_aws_json_1_1(
            data["filter"]
        )
