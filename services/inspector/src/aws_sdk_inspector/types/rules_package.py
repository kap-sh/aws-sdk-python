...
if TYPE_CHECKING:
    ...
    import aws_sdk_inspector.types.provider_name
    import aws_sdk_inspector.types.rules_package_name
    import aws_sdk_inspector.types.text
    import aws_sdk_inspector.types.version


class RulesPackage(TypedDict):
    arn: "aws_sdk_inspector.types.arn.Arn"
    """<p>The ARN of the rules package.</p>"""
    name: "aws_sdk_inspector.types.rules_package_name.RulesPackageName"
    """<p>The name of the rules package.</p>"""
    version: "aws_sdk_inspector.types.version.Version"
    """<p>The version ID of the rules package.</p>"""
    provider: "aws_sdk_inspector.types.provider_name.ProviderName"
    """<p>The provider of the rules package.</p>"""
    description: NotRequired["aws_sdk_inspector.types.text.Text"]
