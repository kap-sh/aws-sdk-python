...
class AssessmentTarget(TypedDict):
    ...
    name: "aws_sdk_inspector.types.assessment_target_name.AssessmentTargetName"
    ...
    updated_at: "aws_sdk_inspector.types.timestamp.Timestamp"
...
def serialize_aws_json_1_1(value: AssessmentTarget) -> dict:
    ...
    out["updatedAt"] = aws_sdk_inspector.types.timestamp.serialize_aws_json_1_1(
        value["updated_at"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> AssessmentTarget:
    ...
    if "updatedAt" in data:
        ...
        out["updated_at"] = aws_sdk_inspector.types.timestamp.deserialize_aws_json_1_1(
            data["updatedAt"]
        )
    else:
