...
class StopAssessmentRunRequest(TypedDict):
    assessment_run_arn: "aws_sdk_inspector.types.arn.Arn"
    """<p>The ARN of the assessment run that you want to stop.</p>"""
    stop_action: NotRequired["aws_sdk_inspector.types.stop_action.StopAction"]
...
def serialize_aws_json_1_1(value: StopAssessmentRunRequest) -> dict:
    ...
    if "stop_action" in value:
        ...
        out["stopAction"] = aws_sdk_inspector.types.stop_action.serialize_aws_json_1_1(
            value["stop_action"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> StopAssessmentRunRequest:
    ...
    if "stopAction" in data:
        ...
        out["stop_action"] = (
            aws_sdk_inspector.types.stop_action.deserialize_aws_json_1_1(
                data["stopAction"]
            )
        )
    return out
