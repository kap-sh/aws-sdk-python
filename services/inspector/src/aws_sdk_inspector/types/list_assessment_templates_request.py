...
class ListAssessmentTemplatesRequest(TypedDict):
...
def serialize_aws_json_1_1(value: ListAssessmentTemplatesRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["filter"] = (
            aws_sdk_inspector.types.assessment_template_filter.serialize_aws_json_1_1(
                value["filter"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListAssessmentTemplatesRequest:
    ...
    if "filter" in data:
        ...
        out["filter"] = (
            aws_sdk_inspector.types.assessment_template_filter.deserialize_aws_json_1_1(
                data["filter"]
            )
        )
