...
if TYPE_CHECKING:
    ...
    import aws_sdk_inspector.types.assessment_rules_package_arn_list
    import aws_sdk_inspector.types.assessment_run_duration
    import aws_sdk_inspector.types.assessment_run_finding_counts
    import aws_sdk_inspector.types.assessment_run_name
    import aws_sdk_inspector.types.assessment_run_notification_list
    import aws_sdk_inspector.types.assessment_run_state
    import aws_sdk_inspector.types.assessment_run_state_change_list
...
class AssessmentRun(TypedDict):
    arn: "aws_sdk_inspector.types.arn.Arn"
    """<p>The ARN of the assessment run.</p>"""
    name: "aws_sdk_inspector.types.assessment_run_name.AssessmentRunName"
    ...
    rules_package_arns: "aws_sdk_inspector.types.assessment_rules_package_arn_list.AssessmentRulesPackageArnList"
    ...
    started_at: NotRequired["aws_sdk_inspector.types.timestamp.Timestamp"]
    """<p>The time when <a>StartAssessmentRun</a> was called.</p>"""
    completed_at: NotRequired["aws_sdk_inspector.types.timestamp.Timestamp"]
    ...
    data_collected: "aws_sdk_inspector.types.bool.Bool"
    """<p>A Boolean value (true or false) that specifies whether the process of collecting data from the agents is completed.</p>"""
    state_changes: "aws_sdk_inspector.types.assessment_run_state_change_list.AssessmentRunStateChangeList"
    """<p>A list of the assessment run state changes.</p>"""
    notifications: "aws_sdk_inspector.types.assessment_run_notification_list.AssessmentRunNotificationList"
    ...
    finding_counts: "aws_sdk_inspector.types.assessment_run_finding_counts.AssessmentRunFindingCounts"
...
def serialize_aws_json_1_1(value: AssessmentRun) -> dict:
    ...
    out["rulesPackageArns"] = (
        aws_sdk_inspector.types.assessment_rules_package_arn_list.serialize_aws_json_1_1(
    ...
    if "started_at" in value:
        ...
        out["startedAt"] = aws_sdk_inspector.types.timestamp.serialize_aws_json_1_1(
            value["started_at"]
        )
    if "completed_at" in value:
        import aws_sdk_inspector.types.timestamp

        out["completedAt"] = aws_sdk_inspector.types.timestamp.serialize_aws_json_1_1(
            value["completed_at"]
        )
    import aws_sdk_inspector.types.timestamp
    ...
    out["stateChanges"] = (
        aws_sdk_inspector.types.assessment_run_state_change_list.serialize_aws_json_1_1(
            value["state_changes"]
        )
    )
    import aws_sdk_inspector.types.assessment_run_notification_list
    ...
    out["notifications"] = (
        aws_sdk_inspector.types.assessment_run_notification_list.serialize_aws_json_1_1(
            value["notifications"]
        )
    )
    import aws_sdk_inspector.types.assessment_run_finding_counts
    ...
    out["findingCounts"] = (
        aws_sdk_inspector.types.assessment_run_finding_counts.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AssessmentRun:
    ...
    if "rulesPackageArns" in data:
        ...
        out["rules_package_arns"] = (
            aws_sdk_inspector.types.assessment_rules_package_arn_list.deserialize_aws_json_1_1(
    ...
    if "startedAt" in data:
        ...
        out["started_at"] = aws_sdk_inspector.types.timestamp.deserialize_aws_json_1_1(
            data["startedAt"]
        )
    ...
    if "stateChanges" in data:
        ...
        out["state_changes"] = (
            aws_sdk_inspector.types.assessment_run_state_change_list.deserialize_aws_json_1_1(
                data["stateChanges"]
            )
        )
    else:
    ...
    if "notifications" in data:
        ...
        out["notifications"] = (
            aws_sdk_inspector.types.assessment_run_notification_list.deserialize_aws_json_1_1(
                data["notifications"]
            )
        )
    else:
    ...
    if "findingCounts" in data:
        ...
        out["finding_counts"] = (
            aws_sdk_inspector.types.assessment_run_finding_counts.deserialize_aws_json_1_1(
                data["findingCounts"]
            )
        )
    else:
