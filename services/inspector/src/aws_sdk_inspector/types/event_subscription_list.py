...
if TYPE_CHECKING:
    import aws_sdk_inspector.types.event_subscription

EventSubscriptionList: TypeAlias = list[
    "aws_sdk_inspector.types.event_subscription.EventSubscription"
]
...
def serialize_aws_json_1_1(value: EventSubscriptionList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_inspector.types.event_subscription.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> EventSubscriptionList:
    ...
    for item in data:
        out.append(
            aws_sdk_inspector.types.event_subscription.deserialize_aws_json_1_1(item)
        )
    return out
