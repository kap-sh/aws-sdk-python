...
if TYPE_CHECKING:
    ...
    import aws_sdk_inspector.types.asset_attributes
    import aws_sdk_inspector.types.asset_type
    import aws_sdk_inspector.types.attribute_list
    import aws_sdk_inspector.types.bool
    import aws_sdk_inspector.types.finding_id
    import aws_sdk_inspector.types.inspector_service_attributes
    import aws_sdk_inspector.types.ioc_confidence
    import aws_sdk_inspector.types.numeric_severity
    import aws_sdk_inspector.types.numeric_version
    import aws_sdk_inspector.types.service_name
...
class Finding(TypedDict):
    ...
    asset_type: NotRequired["aws_sdk_inspector.types.asset_type.AssetType"]
    """<p>The type of the host from which the finding is generated.</p>"""
    asset_attributes: NotRequired[
        "aws_sdk_inspector.types.asset_attributes.AssetAttributes"
    ]
    """<p>A collection of attributes of the host from which the finding is generated.</p>"""
    id: NotRequired["aws_sdk_inspector.types.finding_id.FindingId"]
    """<p>The ID of the finding.</p>"""
    title: NotRequired["aws_sdk_inspector.types.text.Text"]
    """<p>The name of the finding.</p>"""
    description: NotRequired["aws_sdk_inspector.types.text.Text"]
    """<p>The description of the finding.</p>"""
    recommendation: NotRequired["aws_sdk_inspector.types.text.Text"]
    """<p>The recommendation for the finding.</p>"""
    severity: NotRequired["aws_sdk_inspector.types.severity.Severity"]
    """<p>The finding severity. Values can be set to High, Medium, Low, and Informational.</p>"""
    numeric_severity: "aws_sdk_inspector.types.numeric_severity.NumericSeverity"
    """<p>The numeric value of the finding severity.</p>"""
    confidence: "aws_sdk_inspector.types.ioc_confidence.IocConfidence"
    """<p>This data element is currently not used.</p>"""
    indicator_of_compromise: NotRequired["aws_sdk_inspector.types.bool.Bool"]
    """<p>This data element is currently not used.</p>"""
    attributes: "aws_sdk_inspector.types.attribute_list.AttributeList"
    """<p>The system-defined attributes for the finding.</p>"""
    user_attributes: "aws_sdk_inspector.types.user_attribute_list.UserAttributeList"
...
def serialize_aws_json_1_1(value: Finding) -> dict:
    ...
    if "service_attributes" in value:
        ...
        out["serviceAttributes"] = (
            aws_sdk_inspector.types.inspector_service_attributes.serialize_aws_json_1_1(
    ...
    if "asset_type" in value:
        ...
        out["assetType"] = aws_sdk_inspector.types.asset_type.serialize_aws_json_1_1(
            value["asset_type"]
        )
    if "asset_attributes" in value:
        ...
        out["assetAttributes"] = (
            aws_sdk_inspector.types.asset_attributes.serialize_aws_json_1_1(
    ...
    if "severity" in value:
        ...
        out["severity"] = aws_sdk_inspector.types.severity.serialize_aws_json_1_1(
            value["severity"]
        )
    ...
    out["attributes"] = aws_sdk_inspector.types.attribute_list.serialize_aws_json_1_1(
        value["attributes"]
    )
    import aws_sdk_inspector.types.user_attribute_list
...
def deserialize_aws_json_1_1(data: dict) -> Finding:
    ...
    if "serviceAttributes" in data:
        ...
        out["service_attributes"] = (
            aws_sdk_inspector.types.inspector_service_attributes.deserialize_aws_json_1_1(
    ...
    if "assetType" in data:
        ...
        out["asset_type"] = aws_sdk_inspector.types.asset_type.deserialize_aws_json_1_1(
            data["assetType"]
        )
    if "assetAttributes" in data:
        ...
        out["asset_attributes"] = (
            aws_sdk_inspector.types.asset_attributes.deserialize_aws_json_1_1(
    ...
    if "severity" in data:
        ...
        out["severity"] = aws_sdk_inspector.types.severity.deserialize_aws_json_1_1(
            data["severity"]
        )
