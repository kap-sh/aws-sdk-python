...
class AssessmentRunFilter(TypedDict, closed=True):
    ...
    states: NotRequired[
        "capo_inspector.types.assessment_run_state_list.AssessmentRunStateList"
    ]
    ...
    start_time_range: NotRequired["capo_inspector.types.timestamp_range.TimestampRange"]
...
def serialize_aws_json_1_1(value: AssessmentRunFilter) -> dict:
    ...
    if "states" in value:
        ...
        out["states"] = (
            capo_inspector.types.assessment_run_state_list.serialize_aws_json_1_1(
                value["states"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> AssessmentRunFilter:
    ...
    if "states" in data:
        ...
        out["states"] = (
            capo_inspector.types.assessment_run_state_list.deserialize_aws_json_1_1(
                data["states"]
            )
        )
