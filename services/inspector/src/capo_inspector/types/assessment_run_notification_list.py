...
if TYPE_CHECKING:
    import capo_inspector.types.assessment_run_notification

AssessmentRunNotificationList: TypeAlias = list[
    "capo_inspector.types.assessment_run_notification.AssessmentRunNotification"
]
...
def serialize_aws_json_1_1(value: AssessmentRunNotificationList) -> list:
    ...
    for item in value:
        out.append(
            capo_inspector.types.assessment_run_notification.serialize_aws_json_1_1(
                item
            )
        )
    return out
