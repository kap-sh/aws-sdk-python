...
if TYPE_CHECKING:
    import capo_inspector.types.assessment_run_agent

AssessmentRunAgentList: TypeAlias = list[
    "capo_inspector.types.assessment_run_agent.AssessmentRunAgent"
]
...
def serialize_aws_json_1_1(value: AssessmentRunAgentList) -> list:
    ...
    for item in value:
        out.append(
            capo_inspector.types.assessment_run_agent.serialize_aws_json_1_1(item)
        )
    return out
