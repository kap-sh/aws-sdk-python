...
class InspectorError(Exception):
    """Base class for all Inspector service errors."""


class ServiceError(InspectorError):
...
class SerializationError(InspectorError):
    """Raised when a value cannot be serialized."""


class DeserializationError(InspectorError):
...
class WaiterFailedError(InspectorError):
...
class WaiterTimeoutError(InspectorError):
