"""Generated from Smithy shape ``com.amazonaws.inspector#DescribeAssessmentTemplates``."""
...
def handle_response(
    ...
    out: capo_inspector.types.describe_assessment_templates_response.DescribeAssessmentTemplatesResponse = capo_inspector.types.describe_assessment_templates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector.types.describe_assessment_templates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_assessment_templates(
