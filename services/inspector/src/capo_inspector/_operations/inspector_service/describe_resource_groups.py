"""Generated from Smithy shape ``com.amazonaws.inspector#DescribeResourceGroups``."""
...
def handle_response(
    ...
    out: capo_inspector.types.describe_resource_groups_response.DescribeResourceGroupsResponse = capo_inspector.types.describe_resource_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector.types.describe_resource_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_resource_groups(
