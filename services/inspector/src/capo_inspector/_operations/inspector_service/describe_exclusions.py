...
def handle_response(
    ...
    out: capo_inspector.types.describe_exclusions_response.DescribeExclusionsResponse = capo_inspector.types.describe_exclusions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector.types.describe_exclusions_request.serialize_aws_json_1_1(input_)
    ).encode()
