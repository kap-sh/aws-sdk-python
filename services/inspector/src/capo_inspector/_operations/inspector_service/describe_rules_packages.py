"""Generated from Smithy shape ``com.amazonaws.inspector#DescribeRulesPackages``."""
...
def handle_response(
    ...
    out: capo_inspector.types.describe_rules_packages_response.DescribeRulesPackagesResponse = capo_inspector.types.describe_rules_packages_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector.types.describe_rules_packages_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_rules_packages(
