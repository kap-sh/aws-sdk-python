"""Generated from Smithy shape ``com.amazonaws.inspector#DescribeAssessmentTargets``."""
...
def handle_response(
    ...
    out: capo_inspector.types.describe_assessment_targets_response.DescribeAssessmentTargetsResponse = capo_inspector.types.describe_assessment_targets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector.types.describe_assessment_targets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_assessment_targets(
