...
from aws_sdk_lambda._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_1_for_region_af_south_1_with_fips_disabled():
    ...
    assert result.url == 'https://lambda.af-south-1.amazonaws.com'
...
def test_2_for_region_af_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.af-south-1.api.aws'
...
def test_3_for_region_ap_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ap-east-1.amazonaws.com'
...
def test_4_for_region_ap_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ap-east-1.api.aws'
...
def test_5_for_region_ap_northeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ap-northeast-1.amazonaws.com'
...
def test_6_for_region_ap_northeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ap-northeast-1.api.aws'
...
def test_7_for_region_ap_northeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ap-northeast-2.amazonaws.com'
...
def test_8_for_region_ap_northeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ap-northeast-2.api.aws'
...
def test_9_for_region_ap_northeast_3_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ap-northeast-3.amazonaws.com'

def test_10_for_region_ap_northeast_3_with_fips_disa():
    """For region ap-northeast-3 with FIPS disabled and DualStack enabled"""
    params = EndpointParams(Region='ap-northeast-3', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://lambda.ap-northeast-3.api.aws'
...
def test_11_for_region_ap_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ap-south-1.amazonaws.com'

def test_12_for_region_ap_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ap-south-1.api.aws'
...
def test_13_for_region_ap_southeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ap-southeast-1.amazonaws.com'

def test_14_for_region_ap_southeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ap-southeast-1.api.aws'
...
def test_15_for_region_ap_southeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ap-southeast-2.amazonaws.com'

def test_16_for_region_ap_southeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ap-southeast-2.api.aws'
...
def test_17_for_region_ap_southeast_3_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ap-southeast-3.amazonaws.com'

def test_18_for_region_ap_southeast_3_with_fips_disa():
    """For region ap-southeast-3 with FIPS disabled and DualStack enabled"""
    params = EndpointParams(Region='ap-southeast-3', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://lambda.ap-southeast-3.api.aws'
...
def test_19_for_region_ca_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ca-central-1.amazonaws.com'

def test_20_for_region_ca_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.ca-central-1.api.aws'
...
def test_21_for_region_eu_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.eu-central-1.amazonaws.com'

def test_22_for_region_eu_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.eu-central-1.api.aws'
...
def test_23_for_region_eu_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.eu-north-1.amazonaws.com'

def test_24_for_region_eu_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.eu-north-1.api.aws'
...
def test_25_for_region_eu_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.eu-south-1.amazonaws.com'

def test_26_for_region_eu_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.eu-south-1.api.aws'
...
def test_27_for_region_eu_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.eu-west-1.amazonaws.com'

def test_28_for_region_eu_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.eu-west-1.api.aws'
...
def test_29_for_region_eu_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.eu-west-2.amazonaws.com'

def test_30_for_region_eu_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.eu-west-2.api.aws'
...
def test_31_for_region_eu_west_3_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.eu-west-3.amazonaws.com'

def test_32_for_region_eu_west_3_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.eu-west-3.api.aws'
...
def test_33_for_region_me_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.me-south-1.amazonaws.com'

def test_34_for_region_me_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.me-south-1.api.aws'
...
def test_35_for_region_sa_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.sa-east-1.amazonaws.com'

def test_36_for_region_sa_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.sa-east-1.api.aws'
...
def test_39_for_region_us_east_1_with_fips_disabled_():
...
def test_40_for_region_us_east_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.us-east-2.amazonaws.com'

def test_41_for_region_us_east_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda-fips.us-east-2.amazonaws.com'

def test_42_for_region_us_east_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.us-east-2.api.aws'
...
def test_43_for_region_us_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.us-west-1.amazonaws.com'
...
def test_44_for_region_us_west_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda-fips.us-west-1.amazonaws.com'

def test_45_for_region_us_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.us-west-1.api.aws'

def test_46_for_region_us_west_2_with_fips_disabled_():
    """For region us-west-2 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='us-west-2', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://lambda.us-west-2.amazonaws.com'

def test_47_for_region_us_west_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda-fips.us-west-2.amazonaws.com'

def test_48_for_region_us_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.us-west-2.api.aws'

def test_49_for_region_us_east_1_with_fips_enabled_a():
...
def test_51_for_region_cn_north_1_with_fips_disabled():
...
def test_52_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.cn-northwest-1.amazonaws.com.cn'

def test_53_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.cn-northwest-1.api.amazonwebservices.com.cn'
...
def test_55_for_region_cn_north_1_with_fips_enabled_():
...
def test_56_for_region_us_gov_east_1_with_fips_disab():
...
def test_58_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.us-gov-west-1.amazonaws.com'

def test_59_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda-fips.us-gov-west-1.amazonaws.com'

def test_60_for_region_us_gov_east_1_with_fips_enabl():
...
def test_61_for_region_us_gov_east_1_with_fips_disab():
...
def test_62_for_region_us_iso_east_1_with_fips_disab():
...
def test_63_for_region_us_iso_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://lambda.us-iso-west-1.c2s.ic.gov'
