"""Generated from Smithy shape ``com.amazonaws.lambda#ListVersionsByFunction``."""
...
def handle_response(
    ...
    out: capo_lambda.types.list_versions_by_function_response.ListVersionsByFunctionResponse = capo_lambda.types.list_versions_by_function_response.deserialize_json(
...
async def async_list_versions_by_function(
