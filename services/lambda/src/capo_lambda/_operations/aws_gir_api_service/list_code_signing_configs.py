...
def handle_response(
    ...
    out: capo_lambda.types.list_code_signing_configs_response.ListCodeSigningConfigsResponse = capo_lambda.types.list_code_signing_configs_response.deserialize_json(
