...
import capo_lambda.errors.provisioned_concurrency_config_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ProvisionedConcurrencyConfigNotFoundException":
            raise capo_lambda.errors.provisioned_concurrency_config_not_found_exception.ProvisionedConcurrencyConfigNotFoundException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_lambda.types.get_provisioned_concurrency_config_response.GetProvisionedConcurrencyConfigResponse = capo_lambda.types.get_provisioned_concurrency_config_response.deserialize_json(
