...
def handle_response(
    ...
    out: capo_lambda.types.get_function_recursion_config_response.GetFunctionRecursionConfigResponse = capo_lambda.types.get_function_recursion_config_response.deserialize_json(
