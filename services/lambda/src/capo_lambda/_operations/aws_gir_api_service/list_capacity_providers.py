...
def handle_response(
    ...
    out: capo_lambda.types.list_capacity_providers_response.ListCapacityProvidersResponse = capo_lambda.types.list_capacity_providers_response.deserialize_json(
...
def build_request(
    ...
    if "state" in input_:
        params.append(
            (
                "State",
                capo_lambda.types.capacity_provider_state.serialize_json(
                    input_["state"]
                ),
            )
        )
