...
def handle_response(
    ...
    out: capo_lambda.types.list_aliases_response.ListAliasesResponse = (
        capo_lambda.types.list_aliases_response.deserialize_json(
...
def build_request(
    ...
    if "function_version" in input_:
        params.append(("FunctionVersion", input_["function_version"]))
    if "marker" in input_:
...
def list_aliases(
    ...
    capo_lambda.types.list_aliases_response.ListAliasesResponse, zapros.Response
]:
