...
def handle_response(
    ...
    out: capo_lambda.types.get_layer_version_policy_response.GetLayerVersionPolicyResponse = capo_lambda.types.get_layer_version_policy_response.deserialize_json(
