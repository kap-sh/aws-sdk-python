...
def handle_response(
    ...
    out: capo_lambda.types.list_functions_by_code_signing_config_response.ListFunctionsByCodeSigningConfigResponse = capo_lambda.types.list_functions_by_code_signing_config_response.deserialize_json(
