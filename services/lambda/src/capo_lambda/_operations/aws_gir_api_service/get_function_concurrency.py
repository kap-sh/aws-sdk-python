...
def handle_response(
    ...
    out: capo_lambda.types.get_function_concurrency_response.GetFunctionConcurrencyResponse = capo_lambda.types.get_function_concurrency_response.deserialize_json(
