...
import capo_lambda.errors.resource_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise capo_lambda.errors.resource_in_use_exception.ResourceInUseException.from_json(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lambda.types.update_event_source_mapping_request.serialize_json(input_)
    ).encode()
