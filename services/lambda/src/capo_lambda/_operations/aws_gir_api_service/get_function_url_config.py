...
def handle_response(
    ...
    out: capo_lambda.types.get_function_url_config_response.GetFunctionUrlConfigResponse = capo_lambda.types.get_function_url_config_response.deserialize_json(
