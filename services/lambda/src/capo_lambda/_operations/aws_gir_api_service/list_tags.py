...
def handle_response(
    ...
    out: capo_lambda.types.list_tags_response.ListTagsResponse = (
        capo_lambda.types.list_tags_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{Resource}", quote(input_["resource"], safe=""))
...
def list_tags(
    ...
    input_: capo_lambda.types.list_tags_request.ListTagsRequest,
) -> tuple[capo_lambda.types.list_tags_response.ListTagsResponse, zapros.Response]:
