"""Generated from Smithy shape ``com.amazonaws.lambda#DeleteCapacityProvider``."""
...
def handle_response(
    ...
    out: capo_lambda.types.delete_capacity_provider_response.DeleteCapacityProviderResponse = capo_lambda.types.delete_capacity_provider_response.deserialize_json(
