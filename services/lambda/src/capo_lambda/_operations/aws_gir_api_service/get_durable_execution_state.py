"""Generated from Smithy shape ``com.amazonaws.lambda#GetDurableExecutionState``."""
...
def handle_response(
    ...
    out: capo_lambda.types.get_durable_execution_state_response.GetDurableExecutionStateResponse = capo_lambda.types.get_durable_execution_state_response.deserialize_json(
...
def build_request(
    ...
    if "checkpoint_token" in input_:
        params.append(("CheckpointToken", input_["checkpoint_token"]))
    if "marker" in input_:
