"""Generated from Smithy shape ``com.amazonaws.lambda#GetEventSourceMapping``."""
...
def handle_response(
    ...
    out: capo_lambda.types.event_source_mapping_configuration.EventSourceMappingConfiguration = capo_lambda.types.event_source_mapping_configuration.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{UUID}", quote(str(input_["uuid"]), safe=""))
    params: dict[str, str] = {}
...
async def async_get_event_source_mapping(
