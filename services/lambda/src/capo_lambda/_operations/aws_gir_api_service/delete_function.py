...
def handle_response(
    ...
    out: capo_lambda.types.delete_function_response.DeleteFunctionResponse = {}  # type: ignore[typeddict-item]
...
def delete_function(
    ...
    capo_lambda.types.delete_function_response.DeleteFunctionResponse, zapros.Response
]:
