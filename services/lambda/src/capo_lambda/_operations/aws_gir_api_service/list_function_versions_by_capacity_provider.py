...
def handle_response(
    ...
    out: capo_lambda.types.list_function_versions_by_capacity_provider_response.ListFunctionVersionsByCapacityProviderResponse = capo_lambda.types.list_function_versions_by_capacity_provider_response.deserialize_json(
