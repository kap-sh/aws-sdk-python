"""Generated from Smithy shape ``com.amazonaws.lambda#UpdateCodeSigningConfig``."""
...
def handle_response(
    ...
    out: capo_lambda.types.update_code_signing_config_response.UpdateCodeSigningConfigResponse = capo_lambda.types.update_code_signing_config_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lambda.types.update_code_signing_config_request.serialize_json(input_)
    ).encode()
...
async def async_update_code_signing_config(
