...
def handle_response(
    ...
    out: capo_lambda.types.put_function_scaling_config_response.PutFunctionScalingConfigResponse = capo_lambda.types.put_function_scaling_config_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lambda.types.put_function_scaling_config_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
