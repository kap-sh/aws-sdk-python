...
def handle_response(
    ...
    out: capo_lambda.types.list_function_event_invoke_configs_response.ListFunctionEventInvokeConfigsResponse = capo_lambda.types.list_function_event_invoke_configs_response.deserialize_json(
