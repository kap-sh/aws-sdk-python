...
def handle_response(
    ...
    out: capo_lambda.types.get_policy_response.GetPolicyResponse = (
        capo_lambda.types.get_policy_response.deserialize_json(
...
def get_policy(
    ...
    input_: capo_lambda.types.get_policy_request.GetPolicyRequest,
) -> tuple[capo_lambda.types.get_policy_response.GetPolicyResponse, zapros.Response]:
