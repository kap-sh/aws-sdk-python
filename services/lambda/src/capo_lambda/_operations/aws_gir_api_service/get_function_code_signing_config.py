"""Generated from Smithy shape ``com.amazonaws.lambda#GetFunctionCodeSigningConfig``."""
...
def handle_response(
    ...
    out: capo_lambda.types.get_function_code_signing_config_response.GetFunctionCodeSigningConfigResponse = capo_lambda.types.get_function_code_signing_config_response.deserialize_json(
...
async def async_get_function_code_signing_config(
