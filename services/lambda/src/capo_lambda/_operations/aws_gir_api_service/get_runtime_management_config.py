...
def handle_response(
    ...
    out: capo_lambda.types.get_runtime_management_config_response.GetRuntimeManagementConfigResponse = capo_lambda.types.get_runtime_management_config_response.deserialize_json(
