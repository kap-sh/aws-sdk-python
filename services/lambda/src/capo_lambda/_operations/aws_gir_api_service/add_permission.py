"""Generated from Smithy shape ``com.amazonaws.lambda#AddPermission``."""
...
def handle_response(
    ...
    out: capo_lambda.types.add_permission_response.AddPermissionResponse = (
        capo_lambda.types.add_permission_response.deserialize_json(
...
def add_permission(
    ...
    capo_lambda.types.add_permission_response.AddPermissionResponse, zapros.Response
]:
