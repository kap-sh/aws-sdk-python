...
def handle_response(
    ...
    out: capo_lambda.types.get_function_response.GetFunctionResponse = (
        capo_lambda.types.get_function_response.deserialize_json(
...
def get_function(
    ...
    capo_lambda.types.get_function_response.GetFunctionResponse, zapros.Response
]:
