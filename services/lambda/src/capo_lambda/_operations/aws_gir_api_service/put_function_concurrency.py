...
def handle_response(
    ...
    out: capo_lambda.types.concurrency.Concurrency = (
        capo_lambda.types.concurrency.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_lambda.types.concurrency.Concurrency = (
        capo_lambda.types.concurrency.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lambda.types.put_function_concurrency_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def put_function_concurrency(
    ...
    input_: capo_lambda.types.put_function_concurrency_request.PutFunctionConcurrencyRequest,
) -> tuple[capo_lambda.types.concurrency.Concurrency, zapros.Response]:
