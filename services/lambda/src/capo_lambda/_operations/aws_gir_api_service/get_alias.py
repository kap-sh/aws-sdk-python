"""Generated from Smithy shape ``com.amazonaws.lambda#GetAlias``."""
...
def handle_response(
    ...
    out: capo_lambda.types.alias_configuration.AliasConfiguration = (
        capo_lambda.types.alias_configuration.deserialize_json(
...
def get_alias(
    ...
    input_: capo_lambda.types.get_alias_request.GetAliasRequest,
) -> tuple[capo_lambda.types.alias_configuration.AliasConfiguration, zapros.Response]:
