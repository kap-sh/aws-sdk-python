"""Generated from Smithy shape ``com.amazonaws.lambda#GetFunctionScalingConfig``."""
...
def handle_response(
    ...
    out: capo_lambda.types.get_function_scaling_config_response.GetFunctionScalingConfigResponse = capo_lambda.types.get_function_scaling_config_response.deserialize_json(
...
async def async_get_function_scaling_config(
