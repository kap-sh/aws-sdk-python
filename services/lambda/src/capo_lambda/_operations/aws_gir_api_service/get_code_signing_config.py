...
def handle_response(
    ...
    out: capo_lambda.types.get_code_signing_config_response.GetCodeSigningConfigResponse = capo_lambda.types.get_code_signing_config_response.deserialize_json(
