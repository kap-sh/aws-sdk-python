...
def handle_response(
    ...
    out: capo_lambda.types.add_layer_version_permission_response.AddLayerVersionPermissionResponse = capo_lambda.types.add_layer_version_permission_response.deserialize_json(
