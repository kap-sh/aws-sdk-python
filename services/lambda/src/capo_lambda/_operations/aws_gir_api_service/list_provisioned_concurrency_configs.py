"""Generated from Smithy shape ``com.amazonaws.lambda#ListProvisionedConcurrencyConfigs``."""
...
def handle_response(
    ...
    out: capo_lambda.types.list_provisioned_concurrency_configs_response.ListProvisionedConcurrencyConfigsResponse = capo_lambda.types.list_provisioned_concurrency_configs_response.deserialize_json(
...
async def async_list_provisioned_concurrency_configs(
