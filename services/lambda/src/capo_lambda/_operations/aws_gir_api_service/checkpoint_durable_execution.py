...
def handle_response(
    ...
    out: capo_lambda.types.checkpoint_durable_execution_response.CheckpointDurableExecutionResponse = capo_lambda.types.checkpoint_durable_execution_response.deserialize_json(
