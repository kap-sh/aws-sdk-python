...
def handle_response(
    ...
    out: capo_lambda.types.get_durable_execution_response.GetDurableExecutionResponse = capo_lambda.types.get_durable_execution_response.deserialize_json(
...
def build_request(
    ...
    params.append(
        (
            ...
            "true" if input_.get("include_execution_data", True) else "false",
        )
    )
