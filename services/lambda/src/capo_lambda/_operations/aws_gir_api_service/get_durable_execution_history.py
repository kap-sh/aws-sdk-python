...
def handle_response(
    ...
    out: capo_lambda.types.get_durable_execution_history_response.GetDurableExecutionHistoryResponse = capo_lambda.types.get_durable_execution_history_response.deserialize_json(
