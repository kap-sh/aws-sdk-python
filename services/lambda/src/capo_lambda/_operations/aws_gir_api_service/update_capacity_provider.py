...
def handle_response(
    ...
    out: capo_lambda.types.update_capacity_provider_response.UpdateCapacityProviderResponse = capo_lambda.types.update_capacity_provider_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lambda.types.update_capacity_provider_request.serialize_json(input_)
    ).encode()
