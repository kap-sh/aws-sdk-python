...
def handle_response(
    ...
    out: capo_lambda.types.put_runtime_management_config_response.PutRuntimeManagementConfigResponse = capo_lambda.types.put_runtime_management_config_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lambda.types.put_runtime_management_config_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
