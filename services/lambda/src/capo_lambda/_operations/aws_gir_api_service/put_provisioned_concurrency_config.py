...
def handle_response(
    ...
    out: capo_lambda.types.put_provisioned_concurrency_config_response.PutProvisionedConcurrencyConfigResponse = capo_lambda.types.put_provisioned_concurrency_config_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lambda.types.put_provisioned_concurrency_config_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
