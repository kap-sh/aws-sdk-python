...
def handle_response(
    ...
    out: capo_lambda.types.list_functions_response.ListFunctionsResponse = (
        capo_lambda.types.list_functions_response.deserialize_json(
...
def list_functions(
    ...
    capo_lambda.types.list_functions_response.ListFunctionsResponse, zapros.Response
]:
