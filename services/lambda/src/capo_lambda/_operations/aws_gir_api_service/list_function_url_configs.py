"""Generated from Smithy shape ``com.amazonaws.lambda#ListFunctionUrlConfigs``."""
...
def handle_response(
    ...
    out: capo_lambda.types.list_function_url_configs_response.ListFunctionUrlConfigsResponse = capo_lambda.types.list_function_url_configs_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2021-10-31/functions/{FunctionName}/urls"
...
async def async_list_function_url_configs(
