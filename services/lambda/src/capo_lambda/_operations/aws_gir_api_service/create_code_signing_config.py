...
def handle_response(
    ...
    out: capo_lambda.types.create_code_signing_config_response.CreateCodeSigningConfigResponse = capo_lambda.types.create_code_signing_config_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lambda.types.create_code_signing_config_request.serialize_json(input_)
    ).encode()
