...
def handle_response(
    ...
    out: capo_lambda.types.update_function_url_config_response.UpdateFunctionUrlConfigResponse = capo_lambda.types.update_function_url_config_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lambda.types.update_function_url_config_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
