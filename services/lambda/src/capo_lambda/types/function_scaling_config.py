...
if TYPE_CHECKING:
    import capo_lambda.types.function_scaling_config_execution_environments


class FunctionScalingConfig(TypedDict, closed=True):
    min_execution_environments: NotRequired[
        "capo_lambda.types.function_scaling_config_execution_environments.FunctionScalingConfigExecutionEnvironments"
    ]
