"""Generated from Smithy shape ``com.amazonaws.lambda#UpdateFunctionUrlConfigRequest``."""
...
class UpdateFunctionUrlConfigRequest(TypedDict, closed=True):
    function_name: (
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateFunctionUrlConfigRequest) -> dict:
    out: dict = {}
