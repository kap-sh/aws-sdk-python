"""Generated from Smithy shape ``com.amazonaws.lambda#ProvisionedConcurrencyConfigListItem``."""
...
class ProvisionedConcurrencyConfigListItem(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ProvisionedConcurrencyConfigListItem) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ProvisionedConcurrencyConfigListItem:
    out: ProvisionedConcurrencyConfigListItem = {}  # type: ignore[typeddict-item]
