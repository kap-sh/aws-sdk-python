...
if TYPE_CHECKING:
    import capo_lambda.types.maximum_number_of_pollers
    import capo_lambda.types.minimum_number_of_pollers
    import capo_lambda.types.provisioned_poller_group_name


class ProvisionedPollerConfig(TypedDict, closed=True):
    minimum_pollers: NotRequired[
        "capo_lambda.types.minimum_number_of_pollers.MinimumNumberOfPollers"
    ]
