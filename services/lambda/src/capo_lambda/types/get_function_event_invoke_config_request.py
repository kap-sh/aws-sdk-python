"""Generated from Smithy shape ``com.amazonaws.lambda#GetFunctionEventInvokeConfigRequest``."""
...
class GetFunctionEventInvokeConfigRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetFunctionEventInvokeConfigRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> GetFunctionEventInvokeConfigRequest:
    out: GetFunctionEventInvokeConfigRequest = {}  # type: ignore[typeddict-item]
    return out
