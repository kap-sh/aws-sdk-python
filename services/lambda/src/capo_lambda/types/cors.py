...
if TYPE_CHECKING:
    import capo_lambda.types.allow_credentials
...
class Cors(TypedDict, closed=True):
    ...
    allow_methods: NotRequired["capo_lambda.types.allow_methods_list.AllowMethodsList"]
    ...
    allow_origins: NotRequired["capo_lambda.types.allow_origins_list.AllowOriginsList"]
    ...
    expose_headers: NotRequired["capo_lambda.types.headers_list.HeadersList"]
    ...
    max_age: NotRequired["capo_lambda.types.max_age.MaxAge"]
...
def serialize_json(value: Cors) -> dict:
    ...
    if "allow_headers" in value:
        ...
        out["AllowHeaders"] = capo_lambda.types.headers_list.serialize_json(
            value["allow_headers"]
        )
    if "allow_methods" in value:
        import capo_lambda.types.allow_methods_list

        out["AllowMethods"] = capo_lambda.types.allow_methods_list.serialize_json(
            value["allow_methods"]
        )
    if "allow_origins" in value:
        import capo_lambda.types.allow_origins_list

        out["AllowOrigins"] = capo_lambda.types.allow_origins_list.serialize_json(
            value["allow_origins"]
        )
    if "expose_headers" in value:
        import capo_lambda.types.headers_list

        out["ExposeHeaders"] = capo_lambda.types.headers_list.serialize_json(
