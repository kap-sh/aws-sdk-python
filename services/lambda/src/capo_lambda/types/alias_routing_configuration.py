...
class AliasRoutingConfiguration(TypedDict, closed=True):
    additional_version_weights: NotRequired[
        "capo_lambda.types.additional_version_weights.AdditionalVersionWeights"
    ]
...
def serialize_json(value: AliasRoutingConfiguration) -> dict:
    ...
    if "additional_version_weights" in value:
        ...
        out["AdditionalVersionWeights"] = (
            capo_lambda.types.additional_version_weights.serialize_json(
...
def deserialize_json(data: dict) -> AliasRoutingConfiguration:
    ...
    if data.get("AdditionalVersionWeights") is not None:
        ...
        out["additional_version_weights"] = (
            capo_lambda.types.additional_version_weights.deserialize_json(
