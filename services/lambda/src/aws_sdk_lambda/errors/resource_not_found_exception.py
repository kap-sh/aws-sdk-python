"""Generated from Smithy shape ``com.amazonaws.lambda#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.lambda#ResourceNotFoundException``."""
