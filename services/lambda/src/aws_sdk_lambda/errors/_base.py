...
class LambdaError(Exception):
    """Base class for all Lambda service errors."""


class ServiceError(LambdaError):
...
class SerializationError(LambdaError):
    """Raised when a value cannot be serialized."""


class DeserializationError(LambdaError):
...
class WaiterFailedError(LambdaError):
...
class WaiterTimeoutError(LambdaError):
