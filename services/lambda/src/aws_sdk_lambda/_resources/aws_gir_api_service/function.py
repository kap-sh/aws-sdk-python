...
from aws_sdk_lambda._services.async_aws_gir_api_service import ensure_async_iterator
from aws_sdk_lambda._services.aws_gir_api_service import ensure_sync_iterator
