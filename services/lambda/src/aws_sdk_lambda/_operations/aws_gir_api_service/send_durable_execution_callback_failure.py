...
def handle_response(
    ...
    out: aws_sdk_lambda.types.send_durable_execution_callback_failure_response.SendDurableExecutionCallbackFailureResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_lambda.types.send_durable_execution_callback_failure_request.SendDurableExecutionCallbackFailureRequest,
) -> zapros.Request:
    ...
    if "error" in input:
        ...
        body: bytes | None = json.dumps(
            aws_sdk_lambda.types.error_object.serialize_json(input["error"])
        ).encode()
