...
def build_request(
    ...
    input: aws_sdk_lambda.types.get_code_signing_config_request.GetCodeSigningConfigRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{CodeSigningConfigArn}", quote(str(input["code_signing_config_arn"]), safe="")
    )
    params: dict[str, str] = {}
