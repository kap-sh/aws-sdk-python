...
def build_request(
    ...
    input: aws_sdk_lambda.types.create_function_url_config_request.CreateFunctionUrlConfigRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.create_function_url_config_request.serialize_json(input)
    ).encode()
