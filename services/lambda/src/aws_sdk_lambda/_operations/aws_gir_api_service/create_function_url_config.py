"""Generated from Smithy shape ``com.amazonaws.lambda#CreateFunctionUrlConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.create_function_url_config_response.CreateFunctionUrlConfigResponse = aws_sdk_lambda.types.create_function_url_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.create_function_url_config_request.CreateFunctionUrlConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2021-10-31/functions/{FunctionName}/url"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.create_function_url_config_request.serialize_json(input_)
    ).encode()
...
async def async_create_function_url_config(
