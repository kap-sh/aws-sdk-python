"""Generated from Smithy shape ``com.amazonaws.lambda#UpdateAlias``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.alias_configuration.AliasConfiguration = (
        aws_sdk_lambda.types.alias_configuration.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.update_alias_request.UpdateAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.update_alias_request.serialize_json(input_)
    ).encode()
