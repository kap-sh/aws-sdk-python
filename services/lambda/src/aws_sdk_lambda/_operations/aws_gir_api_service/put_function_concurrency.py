...
def build_request(
    ...
    input: aws_sdk_lambda.types.put_function_concurrency_request.PutFunctionConcurrencyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.put_function_concurrency_request.serialize_json(input)
    ).encode()
