"""Generated from Smithy shape ``com.amazonaws.lambda#PutFunctionConcurrency``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.concurrency.Concurrency = (
        aws_sdk_lambda.types.concurrency.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_lambda.types.concurrency.Concurrency = (
        aws_sdk_lambda.types.concurrency.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.put_function_concurrency_request.PutFunctionConcurrencyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.put_function_concurrency_request.serialize_json(input_)
    ).encode()
...
def put_function_concurrency(
    ...
    input_: aws_sdk_lambda.types.put_function_concurrency_request.PutFunctionConcurrencyRequest,
) -> tuple[aws_sdk_lambda.types.concurrency.Concurrency, zapros.Response]:
...
async def async_put_function_concurrency(
