"""Generated from Smithy shape ``com.amazonaws.lambda#GetProvisionedConcurrencyConfig``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ProvisionedConcurrencyConfigNotFoundException":
            import aws_sdk_lambda.errors.provisioned_concurrency_config_not_found_exception

            raise aws_sdk_lambda.errors.provisioned_concurrency_config_not_found_exception.ProvisionedConcurrencyConfigNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.get_provisioned_concurrency_config_response.GetProvisionedConcurrencyConfigResponse = aws_sdk_lambda.types.get_provisioned_concurrency_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.get_provisioned_concurrency_config_request.GetProvisionedConcurrencyConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_provisioned_concurrency_config(
