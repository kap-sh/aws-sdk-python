"""Generated from Smithy shape ``com.amazonaws.lambda#GetFunctionEventInvokeConfig``."""
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.get_function_event_invoke_config_request.GetFunctionEventInvokeConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_function_event_invoke_config(
