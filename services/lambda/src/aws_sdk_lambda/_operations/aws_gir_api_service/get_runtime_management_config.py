"""Generated from Smithy shape ``com.amazonaws.lambda#GetRuntimeManagementConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.get_runtime_management_config_response.GetRuntimeManagementConfigResponse = aws_sdk_lambda.types.get_runtime_management_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.get_runtime_management_config_request.GetRuntimeManagementConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_runtime_management_config(
