...
def build_request(
    ...
    input: aws_sdk_lambda.types.create_event_source_mapping_request.CreateEventSourceMappingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.create_event_source_mapping_request.serialize_json(input)
    ).encode()
