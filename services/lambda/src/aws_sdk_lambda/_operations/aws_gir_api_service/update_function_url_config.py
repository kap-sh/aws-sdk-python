"""Generated from Smithy shape ``com.amazonaws.lambda#UpdateFunctionUrlConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.update_function_url_config_response.UpdateFunctionUrlConfigResponse = aws_sdk_lambda.types.update_function_url_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.update_function_url_config_request.UpdateFunctionUrlConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.update_function_url_config_request.serialize_json(input_)
    ).encode()
...
async def async_update_function_url_config(
