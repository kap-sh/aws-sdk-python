...
def build_request(
    ...
    input: aws_sdk_lambda.types.update_function_url_config_request.UpdateFunctionUrlConfigRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.update_function_url_config_request.serialize_json(input)
    ).encode()
