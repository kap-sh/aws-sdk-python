"""Generated from Smithy shape ``com.amazonaws.lambda#GetFunctionConcurrency``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.get_function_concurrency_response.GetFunctionConcurrencyResponse = aws_sdk_lambda.types.get_function_concurrency_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.get_function_concurrency_request.GetFunctionConcurrencyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2019-09-30/functions/{FunctionName}/concurrency"
...
async def async_get_function_concurrency(
