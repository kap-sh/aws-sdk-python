...
def handle_response(
    ...
    out: aws_sdk_lambda.types.get_function_scaling_config_response.GetFunctionScalingConfigResponse = aws_sdk_lambda.types.get_function_scaling_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.get_function_scaling_config_request.GetFunctionScalingConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
