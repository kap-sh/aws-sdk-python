...
def handle_response(
    ...
    out: aws_sdk_lambda.types.list_event_source_mappings_response.ListEventSourceMappingsResponse = aws_sdk_lambda.types.list_event_source_mappings_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lambda.types.list_event_source_mappings_request.ListEventSourceMappingsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "event_source_arn" in input:
        params["EventSourceArn"] = str(input["event_source_arn"])
    if "function_name" in input:
        params["FunctionName"] = str(input["function_name"])
    if "marker" in input:
