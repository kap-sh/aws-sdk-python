...
def build_request(
    ...
    input: aws_sdk_lambda.types.update_capacity_provider_request.UpdateCapacityProviderRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.update_capacity_provider_request.serialize_json(input)
    ).encode()
