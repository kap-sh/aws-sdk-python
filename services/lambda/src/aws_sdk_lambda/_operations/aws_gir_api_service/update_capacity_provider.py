"""Generated from Smithy shape ``com.amazonaws.lambda#UpdateCapacityProvider``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.update_capacity_provider_response.UpdateCapacityProviderResponse = aws_sdk_lambda.types.update_capacity_provider_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.update_capacity_provider_request.UpdateCapacityProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.update_capacity_provider_request.serialize_json(input_)
    ).encode()
