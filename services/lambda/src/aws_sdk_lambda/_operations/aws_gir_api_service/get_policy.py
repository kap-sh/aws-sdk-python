"""Generated from Smithy shape ``com.amazonaws.lambda#GetPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.get_policy_response.GetPolicyResponse = (
        aws_sdk_lambda.types.get_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.get_policy_request.GetPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_policy(
    ...
    input_: aws_sdk_lambda.types.get_policy_request.GetPolicyRequest,
) -> tuple[aws_sdk_lambda.types.get_policy_response.GetPolicyResponse, zapros.Response]:
