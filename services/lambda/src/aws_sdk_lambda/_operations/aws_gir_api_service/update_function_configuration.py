...
def build_request(
    ...
    input_: aws_sdk_lambda.types.update_function_configuration_request.UpdateFunctionConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.update_function_configuration_request.serialize_json(
            input_
        )
    ).encode()
