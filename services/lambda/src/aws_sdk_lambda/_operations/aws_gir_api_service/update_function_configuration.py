...
def build_request(
    ...
    input: aws_sdk_lambda.types.update_function_configuration_request.UpdateFunctionConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.update_function_configuration_request.serialize_json(input)
    ).encode()
