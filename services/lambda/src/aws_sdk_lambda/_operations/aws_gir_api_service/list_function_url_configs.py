...
def handle_response(
    ...
    out: aws_sdk_lambda.types.list_function_url_configs_response.ListFunctionUrlConfigsResponse = aws_sdk_lambda.types.list_function_url_configs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.list_function_url_configs_request.ListFunctionUrlConfigsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
