...
def handle_response(
    ...
    out: aws_sdk_lambda.types.list_provisioned_concurrency_configs_response.ListProvisionedConcurrencyConfigsResponse = aws_sdk_lambda.types.list_provisioned_concurrency_configs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.list_provisioned_concurrency_configs_request.ListProvisionedConcurrencyConfigsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
