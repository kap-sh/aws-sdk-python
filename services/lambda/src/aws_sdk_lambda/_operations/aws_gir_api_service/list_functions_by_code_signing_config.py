"""Generated from Smithy shape ``com.amazonaws.lambda#ListFunctionsByCodeSigningConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.list_functions_by_code_signing_config_response.ListFunctionsByCodeSigningConfigResponse = aws_sdk_lambda.types.list_functions_by_code_signing_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.list_functions_by_code_signing_config_request.ListFunctionsByCodeSigningConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_functions_by_code_signing_config(
