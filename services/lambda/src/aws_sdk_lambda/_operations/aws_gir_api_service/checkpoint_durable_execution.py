...
def build_request(
    ...
    input: aws_sdk_lambda.types.checkpoint_durable_execution_request.CheckpointDurableExecutionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.checkpoint_durable_execution_request.serialize_json(input)
    ).encode()
