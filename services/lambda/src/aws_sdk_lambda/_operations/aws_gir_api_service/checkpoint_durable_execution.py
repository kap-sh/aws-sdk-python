"""Generated from Smithy shape ``com.amazonaws.lambda#CheckpointDurableExecution``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.checkpoint_durable_execution_response.CheckpointDurableExecutionResponse = aws_sdk_lambda.types.checkpoint_durable_execution_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.checkpoint_durable_execution_request.CheckpointDurableExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.checkpoint_durable_execution_request.serialize_json(input_)
    ).encode()
...
async def async_checkpoint_durable_execution(
