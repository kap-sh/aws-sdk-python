"""Generated from Smithy shape ``com.amazonaws.lambda#GetDurableExecutionHistory``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.get_durable_execution_history_response.GetDurableExecutionHistoryResponse = aws_sdk_lambda.types.get_durable_execution_history_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lambda.types.get_durable_execution_history_request.GetDurableExecutionHistoryRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "include_execution_data" in input:
        params["IncludeExecutionData"] = str(input["include_execution_data"])
...
async def async_get_durable_execution_history(
