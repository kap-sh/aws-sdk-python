"""Generated from Smithy shape ``com.amazonaws.lambda#ListCapacityProviders``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.list_capacity_providers_response.ListCapacityProvidersResponse = aws_sdk_lambda.types.list_capacity_providers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.list_capacity_providers_request.ListCapacityProvidersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_capacity_providers(
