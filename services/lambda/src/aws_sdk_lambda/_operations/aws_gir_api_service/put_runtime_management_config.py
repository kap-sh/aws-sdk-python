"""Generated from Smithy shape ``com.amazonaws.lambda#PutRuntimeManagementConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.put_runtime_management_config_response.PutRuntimeManagementConfigResponse = aws_sdk_lambda.types.put_runtime_management_config_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lambda.types.put_runtime_management_config_request.PutRuntimeManagementConfigRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.put_runtime_management_config_request.serialize_json(input)
    ).encode()
...
async def async_put_runtime_management_config(
