...
def build_request(
    ...
    input_: aws_sdk_lambda.types.put_runtime_management_config_request.PutRuntimeManagementConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.put_runtime_management_config_request.serialize_json(
            input_
        )
    ).encode()
