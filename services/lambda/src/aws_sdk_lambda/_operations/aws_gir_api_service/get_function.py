"""Generated from Smithy shape ``com.amazonaws.lambda#GetFunction``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.get_function_response.GetFunctionResponse = (
        aws_sdk_lambda.types.get_function_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.get_function_request.GetFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2015-03-31/functions/{FunctionName}"
...
def get_function(
    ...
    aws_sdk_lambda.types.get_function_response.GetFunctionResponse, zapros.Response
]:
