"""Generated from Smithy shape ``com.amazonaws.lambda#PutFunctionRecursionConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.put_function_recursion_config_response.PutFunctionRecursionConfigResponse = aws_sdk_lambda.types.put_function_recursion_config_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lambda.types.put_function_recursion_config_request.PutFunctionRecursionConfigRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.put_function_recursion_config_request.serialize_json(input)
    ).encode()
...
async def async_put_function_recursion_config(
