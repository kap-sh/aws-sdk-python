"""Generated from Smithy shape ``com.amazonaws.lambda#GetFunctionUrlConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.get_function_url_config_response.GetFunctionUrlConfigResponse = aws_sdk_lambda.types.get_function_url_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.get_function_url_config_request.GetFunctionUrlConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_function_url_config(
