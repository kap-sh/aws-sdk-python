"""Generated from Smithy shape ``com.amazonaws.lambda#GetLayerVersion``."""
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.get_layer_version_request.GetLayerVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_layer_version(
