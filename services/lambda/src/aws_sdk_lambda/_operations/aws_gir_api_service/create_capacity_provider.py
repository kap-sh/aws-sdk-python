...
def build_request(
    ...
    input: aws_sdk_lambda.types.create_capacity_provider_request.CreateCapacityProviderRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.create_capacity_provider_request.serialize_json(input)
    ).encode()
