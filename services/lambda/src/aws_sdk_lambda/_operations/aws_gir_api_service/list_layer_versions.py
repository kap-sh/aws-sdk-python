"""Generated from Smithy shape ``com.amazonaws.lambda#ListLayerVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.list_layer_versions_response.ListLayerVersionsResponse = (
        aws_sdk_lambda.types.list_layer_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.list_layer_versions_request.ListLayerVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_layer_versions(
