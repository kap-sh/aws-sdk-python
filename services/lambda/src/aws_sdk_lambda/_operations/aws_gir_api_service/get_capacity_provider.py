"""Generated from Smithy shape ``com.amazonaws.lambda#GetCapacityProvider``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.get_capacity_provider_response.GetCapacityProviderResponse = aws_sdk_lambda.types.get_capacity_provider_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.get_capacity_provider_request.GetCapacityProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_capacity_provider(
