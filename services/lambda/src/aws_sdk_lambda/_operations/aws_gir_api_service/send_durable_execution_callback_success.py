...
def build_request(
    ...
    input: aws_sdk_lambda.types.send_durable_execution_callback_success_request.SendDurableExecutionCallbackSuccessRequest,
) -> zapros.Request:
    ...
    url = url.replace("{CallbackId}", quote(str(input["callback_id"]), safe=""))
    params: dict[str, str] = {}
