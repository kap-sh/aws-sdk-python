...
def handle_response(
    ...
    out: aws_sdk_lambda.types.publish_layer_version_response.PublishLayerVersionResponse = aws_sdk_lambda.types.publish_layer_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.publish_layer_version_request.PublishLayerVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.publish_layer_version_request.serialize_json(input_)
    ).encode()
