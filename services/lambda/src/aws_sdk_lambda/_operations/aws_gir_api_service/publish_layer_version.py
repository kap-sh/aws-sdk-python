...
def build_request(
    ...
    input: aws_sdk_lambda.types.publish_layer_version_request.PublishLayerVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.publish_layer_version_request.serialize_json(input)
    ).encode()
