"""Generated from Smithy shape ``com.amazonaws.lambda#PutFunctionEventInvokeConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.function_event_invoke_config.FunctionEventInvokeConfig = (
        aws_sdk_lambda.types.function_event_invoke_config.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.put_function_event_invoke_config_request.PutFunctionEventInvokeConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.put_function_event_invoke_config_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_function_event_invoke_config(
