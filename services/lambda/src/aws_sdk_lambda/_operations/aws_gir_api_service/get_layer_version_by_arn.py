"""Generated from Smithy shape ``com.amazonaws.lambda#GetLayerVersionByArn``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.get_layer_version_response.GetLayerVersionResponse = (
        aws_sdk_lambda.types.get_layer_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.get_layer_version_by_arn_request.GetLayerVersionByArnRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2018-10-31/layers?find=LayerVersion"
    params: dict[str, str] = {}
    if "arn" in input_:
...
async def async_get_layer_version_by_arn(
