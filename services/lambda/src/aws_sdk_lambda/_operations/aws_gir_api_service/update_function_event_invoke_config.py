"""Generated from Smithy shape ``com.amazonaws.lambda#UpdateFunctionEventInvokeConfig``."""
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.update_function_event_invoke_config_request.UpdateFunctionEventInvokeConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.update_function_event_invoke_config_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_function_event_invoke_config(
