"""Generated from Smithy shape ``com.amazonaws.lambda#ListCodeSigningConfigs``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.list_code_signing_configs_response.ListCodeSigningConfigsResponse = aws_sdk_lambda.types.list_code_signing_configs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.list_code_signing_configs_request.ListCodeSigningConfigsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_code_signing_configs(
