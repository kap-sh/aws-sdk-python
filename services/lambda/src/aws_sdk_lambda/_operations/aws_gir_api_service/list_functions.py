"""Generated from Smithy shape ``com.amazonaws.lambda#ListFunctions``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.list_functions_response.ListFunctionsResponse = (
        aws_sdk_lambda.types.list_functions_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lambda.types.list_functions_request.ListFunctionsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "master_region" in input:
        params["MasterRegion"] = str(input["master_region"])
    if "function_version" in input:
        params["FunctionVersion"] = str(input["function_version"])
    if "marker" in input:
...
def list_functions(
    ...
    aws_sdk_lambda.types.list_functions_response.ListFunctionsResponse, zapros.Response
]:
