...
def build_request(
    ...
    input: aws_sdk_lambda.types.create_code_signing_config_request.CreateCodeSigningConfigRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.create_code_signing_config_request.serialize_json(input)
    ).encode()
