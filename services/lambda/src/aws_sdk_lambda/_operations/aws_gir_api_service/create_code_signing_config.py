"""Generated from Smithy shape ``com.amazonaws.lambda#CreateCodeSigningConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.create_code_signing_config_response.CreateCodeSigningConfigResponse = aws_sdk_lambda.types.create_code_signing_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.create_code_signing_config_request.CreateCodeSigningConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2020-04-22/code-signing-configs"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_lambda.types.create_code_signing_config_request

    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.create_code_signing_config_request.serialize_json(input_)
    ).encode()
...
async def async_create_code_signing_config(
