"""Generated from Smithy shape ``com.amazonaws.lambda#ListFunctionVersionsByCapacityProvider``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.list_function_versions_by_capacity_provider_response.ListFunctionVersionsByCapacityProviderResponse = aws_sdk_lambda.types.list_function_versions_by_capacity_provider_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.list_function_versions_by_capacity_provider_request.ListFunctionVersionsByCapacityProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{CapacityProviderName}", quote(str(input_["capacity_provider_name"]), safe="")
    )
    params: dict[str, str] = {}
    if "marker" in input_:
...
async def async_list_function_versions_by_capacity_provider(
