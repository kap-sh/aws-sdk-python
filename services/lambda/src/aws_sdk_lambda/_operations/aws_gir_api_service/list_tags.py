"""Generated from Smithy shape ``com.amazonaws.lambda#ListTags``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.list_tags_response.ListTagsResponse = (
        aws_sdk_lambda.types.list_tags_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lambda.types.list_tags_request.ListTagsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/2017-03-31/tags/{Resource}"
    url = url.replace("{Resource}", quote(str(input["resource"]), safe=""))
    params: dict[str, str] = {}
...
def list_tags(
    ...
    input: aws_sdk_lambda.types.list_tags_request.ListTagsRequest,
) -> tuple[aws_sdk_lambda.types.list_tags_response.ListTagsResponse, zapros.Response]:
