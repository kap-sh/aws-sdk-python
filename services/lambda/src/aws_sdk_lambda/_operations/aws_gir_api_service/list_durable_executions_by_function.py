...
def handle_response(
    ...
    out: aws_sdk_lambda.types.list_durable_executions_by_function_response.ListDurableExecutionsByFunctionResponse = aws_sdk_lambda.types.list_durable_executions_by_function_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lambda.types.list_durable_executions_by_function_request.ListDurableExecutionsByFunctionRequest,
) -> zapros.Request:
    ...
    if "durable_execution_name" in input:
        params["DurableExecutionName"] = str(input["durable_execution_name"])
