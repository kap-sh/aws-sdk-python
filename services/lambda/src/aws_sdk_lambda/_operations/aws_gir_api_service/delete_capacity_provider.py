...
def handle_response(
    ...
    out: aws_sdk_lambda.types.delete_capacity_provider_response.DeleteCapacityProviderResponse = aws_sdk_lambda.types.delete_capacity_provider_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.delete_capacity_provider_request.DeleteCapacityProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
