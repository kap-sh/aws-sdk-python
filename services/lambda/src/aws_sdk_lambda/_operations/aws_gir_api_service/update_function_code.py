...
def build_request(
    ...
    input_: aws_sdk_lambda.types.update_function_code_request.UpdateFunctionCodeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.update_function_code_request.serialize_json(input_)
    ).encode()
