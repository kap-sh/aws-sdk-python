"""Generated from Smithy shape ``com.amazonaws.lambda#GetLayerVersionPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.get_layer_version_policy_response.GetLayerVersionPolicyResponse = aws_sdk_lambda.types.get_layer_version_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.get_layer_version_policy_request.GetLayerVersionPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_layer_version_policy(
