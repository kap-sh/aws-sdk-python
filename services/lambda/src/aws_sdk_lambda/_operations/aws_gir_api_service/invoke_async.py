...
def handle_response(
    ...
    out: aws_sdk_lambda.types.invoke_async_response.InvokeAsyncResponse = {}  # type: ignore[typeddict-item]
...
def build_request(
    ...
    input: aws_sdk_lambda.types.invoke_async_request.InvokeAsyncRequest,
) -> zapros.Request:
...
def invoke_async(
    ...
    aws_sdk_lambda.types.invoke_async_response.InvokeAsyncResponse, zapros.Response
]:
