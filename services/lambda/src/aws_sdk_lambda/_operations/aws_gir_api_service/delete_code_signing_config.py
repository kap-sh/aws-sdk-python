"""Generated from Smithy shape ``com.amazonaws.lambda#DeleteCodeSigningConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.delete_code_signing_config_response.DeleteCodeSigningConfigResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.delete_code_signing_config_request.DeleteCodeSigningConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_code_signing_config(
