...
def handle_response(
    ...
    out: aws_sdk_lambda.types.get_function_code_signing_config_response.GetFunctionCodeSigningConfigResponse = aws_sdk_lambda.types.get_function_code_signing_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.get_function_code_signing_config_request.GetFunctionCodeSigningConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
