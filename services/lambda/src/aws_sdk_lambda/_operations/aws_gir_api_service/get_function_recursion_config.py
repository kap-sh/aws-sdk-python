"""Generated from Smithy shape ``com.amazonaws.lambda#GetFunctionRecursionConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.get_function_recursion_config_response.GetFunctionRecursionConfigResponse = aws_sdk_lambda.types.get_function_recursion_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.get_function_recursion_config_request.GetFunctionRecursionConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_function_recursion_config(
