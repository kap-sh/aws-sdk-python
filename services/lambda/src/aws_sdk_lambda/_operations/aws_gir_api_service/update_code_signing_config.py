...
def handle_response(
    ...
    out: aws_sdk_lambda.types.update_code_signing_config_response.UpdateCodeSigningConfigResponse = aws_sdk_lambda.types.update_code_signing_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.update_code_signing_config_request.UpdateCodeSigningConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.update_code_signing_config_request.serialize_json(input_)
    ).encode()
