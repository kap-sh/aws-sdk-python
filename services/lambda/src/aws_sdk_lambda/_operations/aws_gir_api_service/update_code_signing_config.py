...
def build_request(
    ...
    input: aws_sdk_lambda.types.update_code_signing_config_request.UpdateCodeSigningConfigRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.update_code_signing_config_request.serialize_json(input)
    ).encode()
