...
def handle_response(
    ...
    out: aws_sdk_lambda.types.list_versions_by_function_response.ListVersionsByFunctionResponse = aws_sdk_lambda.types.list_versions_by_function_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.list_versions_by_function_request.ListVersionsByFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
