...
def handle_response(
    ...
    out: aws_sdk_lambda.types.stop_durable_execution_response.StopDurableExecutionResponse = aws_sdk_lambda.types.stop_durable_execution_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_lambda.types.stop_durable_execution_request.StopDurableExecutionRequest,
) -> zapros.Request:
