...
def build_request(
    ...
    input_: aws_sdk_lambda.types.update_event_source_mapping_request.UpdateEventSourceMappingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.update_event_source_mapping_request.serialize_json(input_)
    ).encode()
