"""Generated from Smithy shape ``com.amazonaws.lambda#GetDurableExecution``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.get_durable_execution_response.GetDurableExecutionResponse = aws_sdk_lambda.types.get_durable_execution_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.get_durable_execution_request.GetDurableExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_durable_execution(
