...
def build_request(
    ...
    input_: aws_sdk_lambda.types.put_function_scaling_config_request.PutFunctionScalingConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.put_function_scaling_config_request.serialize_json(input_)
    ).encode()
