"""Generated from Smithy shape ``com.amazonaws.lambda#ListFunctionEventInvokeConfigs``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.list_function_event_invoke_configs_response.ListFunctionEventInvokeConfigsResponse = aws_sdk_lambda.types.list_function_event_invoke_configs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.list_function_event_invoke_configs_request.ListFunctionEventInvokeConfigsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_function_event_invoke_configs(
