"""Generated from Smithy shape ``com.amazonaws.lambda#DeleteEventSourceMapping``."""
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.delete_event_source_mapping_request.DeleteEventSourceMappingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_event_source_mapping(
