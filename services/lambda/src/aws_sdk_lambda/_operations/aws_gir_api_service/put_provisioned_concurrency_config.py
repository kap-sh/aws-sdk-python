"""Generated from Smithy shape ``com.amazonaws.lambda#PutProvisionedConcurrencyConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.put_provisioned_concurrency_config_response.PutProvisionedConcurrencyConfigResponse = aws_sdk_lambda.types.put_provisioned_concurrency_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.put_provisioned_concurrency_config_request.PutProvisionedConcurrencyConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_put_provisioned_concurrency_config(
