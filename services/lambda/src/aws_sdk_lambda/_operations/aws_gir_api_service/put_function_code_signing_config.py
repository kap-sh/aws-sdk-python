"""Generated from Smithy shape ``com.amazonaws.lambda#PutFunctionCodeSigningConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.put_function_code_signing_config_response.PutFunctionCodeSigningConfigResponse = aws_sdk_lambda.types.put_function_code_signing_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.put_function_code_signing_config_request.PutFunctionCodeSigningConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lambda.types.put_function_code_signing_config_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_function_code_signing_config(
