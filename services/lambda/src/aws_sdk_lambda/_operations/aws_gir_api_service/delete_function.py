"""Generated from Smithy shape ``com.amazonaws.lambda#DeleteFunction``."""
...
def handle_response(
    ...
    out: aws_sdk_lambda.types.delete_function_response.DeleteFunctionResponse = {}  # type: ignore[typeddict-item]
...
def build_request(
    ...
    input_: aws_sdk_lambda.types.delete_function_request.DeleteFunctionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
