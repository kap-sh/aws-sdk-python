...
from aws_sdk_lambda._resources.aws_gir_api_service.function import AsyncFunction
from aws_sdk_lambda._resources.aws_gir_api_service.function_alias import (
    AsyncFunctionAlias,
)
from aws_sdk_lambda._resources.aws_gir_api_service.function_version_resource import (
    AsyncFunctionVersionResource,
)
from aws_sdk_lambda._resources.aws_gir_api_service.layer_resource import (
    AsyncLayerResource,
)
from aws_sdk_lambda._resources.aws_gir_api_service.layer_version import (
    AsyncLayerVersion,
)
from aws_sdk_lambda._resources.aws_gir_api_service.permission import AsyncPermission
...
from aws_sdk_lambda._resources.aws_gir_api_service.resource_policy import (
    AsyncResourcePolicy,
)
from aws_sdk_lambda._services._aws_config import aaws_config
...
class AsyncLambdaClientConfig(TypedDict, total=False):
...
class AsyncLambdaClient:
    ...
    async def checkpoint_durable_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.checkpoint_durable_execution_request.CheckpointDurableExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.checkpoint_durable_execution_response.CheckpointDurableExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.checkpoint_durable_execution.async_checkpoint_durable_execution(
    ...
    async def delete_function(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.delete_function_request.DeleteFunctionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.delete_function_response.DeleteFunctionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.delete_function.async_delete_function(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_function_event_invoke_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.delete_function_event_invoke_config_request.DeleteFunctionEventInvokeConfigRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.delete_function_event_invoke_config.async_delete_function_event_invoke_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_account_settings(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.get_account_settings_request.GetAccountSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.get_account_settings_response.GetAccountSettingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.get_account_settings.async_get_account_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_durable_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.get_durable_execution_request.GetDurableExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.get_durable_execution_response.GetDurableExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.get_durable_execution.async_get_durable_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_durable_execution_history(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.get_durable_execution_history_request.GetDurableExecutionHistoryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.get_durable_execution_history_response.GetDurableExecutionHistoryResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.get_durable_execution_history.async_get_durable_execution_history(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_lambda.types.event.Event]":
        _token = marker
        while True:
    ...
    async def get_durable_execution_state(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.get_durable_execution_state_request.GetDurableExecutionStateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.get_durable_execution_state_response.GetDurableExecutionStateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.get_durable_execution_state.async_get_durable_execution_state(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_durable_execution_state(
        ...
        *,
        ...
        marker: Optional["aws_sdk_lambda.types.string.String"] = None,
        max_items: Optional["aws_sdk_lambda.types.item_count.ItemCount"] = None,
    ) -> "AsyncIterator[aws_sdk_lambda.types.operation.Operation]":
        _token = marker
        while True:
    ...
    async def get_function_event_invoke_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.get_function_event_invoke_config_request.GetFunctionEventInvokeConfigRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.function_event_invoke_config.FunctionEventInvokeConfig"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.get_function_event_invoke_config.async_get_function_event_invoke_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_durable_executions_by_function(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.list_durable_executions_by_function_request.ListDurableExecutionsByFunctionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.list_durable_executions_by_function_response.ListDurableExecutionsByFunctionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.list_durable_executions_by_function.async_list_durable_executions_by_function(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_durable_executions_by_function(
        ...
        *,
        ...
        marker: Optional["aws_sdk_lambda.types.string.String"] = None,
        max_items: Optional["aws_sdk_lambda.types.item_count.ItemCount"] = None,
    ) -> "AsyncIterator[aws_sdk_lambda.types.execution.Execution]":
        _token = marker
        while True:
    ...
    async def list_function_event_invoke_configs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.list_function_event_invoke_configs_request.ListFunctionEventInvokeConfigsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.list_function_event_invoke_configs_response.ListFunctionEventInvokeConfigsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.list_function_event_invoke_configs.async_list_function_event_invoke_configs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.list_tags_request.ListTagsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.list_tags_response.ListTagsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.list_tags.async_list_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_function_event_invoke_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.put_function_event_invoke_config_request.PutFunctionEventInvokeConfigRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.function_event_invoke_config.FunctionEventInvokeConfig"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.put_function_event_invoke_config.async_put_function_event_invoke_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def send_durable_execution_callback_failure(
        ...
        *,
        ...
        Raises:
            aws_sdk_lambda.errors.callback_timeout_exception.CallbackTimeoutException: <p>The callback ID token has either expired or the callback associated with the token has already been closed.</p>
            aws_sdk_lambda.errors.invalid_parameter_value_exception.InvalidParameterValueException: <p>One of the parameters in the request is not valid.</p>
            aws_sdk_lambda.errors.service_exception.ServiceException: <p>The Lambda service encountered an internal error.</p>
            aws_sdk_lambda.errors.too_many_requests_exception.TooManyRequestsException: <p>The request throughput limit was exceeded. For more information, see <a href=\"https://docs.aws.amazon.com/lambda/latest/dg/gettingstarted-limits.html#api-requests\">Lambda quotas</a>.</p>
            aws_sdk_lambda.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.send_durable_execution_callback_failure_request.SendDurableExecutionCallbackFailureRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.send_durable_execution_callback_failure_response.SendDurableExecutionCallbackFailureResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.send_durable_execution_callback_failure.async_send_durable_execution_callback_failure(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def send_durable_execution_callback_heartbeat(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.send_durable_execution_callback_heartbeat_request.SendDurableExecutionCallbackHeartbeatRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.send_durable_execution_callback_heartbeat_response.SendDurableExecutionCallbackHeartbeatResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.send_durable_execution_callback_heartbeat.async_send_durable_execution_callback_heartbeat(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def send_durable_execution_callback_success(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.send_durable_execution_callback_success_request.SendDurableExecutionCallbackSuccessRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.send_durable_execution_callback_success_response.SendDurableExecutionCallbackSuccessResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.send_durable_execution_callback_success.async_send_durable_execution_callback_success(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_durable_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.stop_durable_execution_request.StopDurableExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.stop_durable_execution_response.StopDurableExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.stop_durable_execution.async_stop_durable_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_function_event_invoke_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_lambda.types.update_function_event_invoke_config_request.UpdateFunctionEventInvokeConfigRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_lambda.types.function_event_invoke_config.FunctionEventInvokeConfig"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_lambda._operations.aws_gir_api_service.update_function_event_invoke_config.async_update_function_event_invoke_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
