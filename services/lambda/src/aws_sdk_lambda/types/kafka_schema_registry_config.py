...
if TYPE_CHECKING:
    ...
    import aws_sdk_lambda.types.kafka_schema_validation_config_list
    import aws_sdk_lambda.types.schema_registry_event_record_format
...
class KafkaSchemaRegistryConfig(TypedDict):
    ...
    event_record_format: NotRequired[
        "aws_sdk_lambda.types.schema_registry_event_record_format.SchemaRegistryEventRecordFormat"
    ]
    ...
    access_configs: NotRequired[
        "aws_sdk_lambda.types.kafka_schema_registry_access_config_list.KafkaSchemaRegistryAccessConfigList"
    ]
    ...
    schema_validation_configs: NotRequired[
        "aws_sdk_lambda.types.kafka_schema_validation_config_list.KafkaSchemaValidationConfigList"
    ]
...
def serialize_json(value: KafkaSchemaRegistryConfig) -> dict:
    ...
    if "event_record_format" in value:
        ...
        out["EventRecordFormat"] = (
            aws_sdk_lambda.types.schema_registry_event_record_format.serialize_json(
    ...
    if "access_configs" in value:
        ...
        out["AccessConfigs"] = (
            aws_sdk_lambda.types.kafka_schema_registry_access_config_list.serialize_json(
    ...
    if "schema_validation_configs" in value:
        ...
        out["SchemaValidationConfigs"] = (
            aws_sdk_lambda.types.kafka_schema_validation_config_list.serialize_json(
...
def deserialize_json(data: dict) -> KafkaSchemaRegistryConfig:
    ...
    if "EventRecordFormat" in data:
        ...
        out["event_record_format"] = (
            aws_sdk_lambda.types.schema_registry_event_record_format.deserialize_json(
    ...
    if "AccessConfigs" in data:
        ...
        out["access_configs"] = (
            aws_sdk_lambda.types.kafka_schema_registry_access_config_list.deserialize_json(
                data["AccessConfigs"]
            )
        )
    if "SchemaValidationConfigs" in data:
        ...
        out["schema_validation_configs"] = (
            aws_sdk_lambda.types.kafka_schema_validation_config_list.deserialize_json(
