"""Generated from Smithy shape ``com.amazonaws.lambda#GetFunctionUrlConfigRequest``."""
...
class GetFunctionUrlConfigRequest(TypedDict):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetFunctionUrlConfigRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> GetFunctionUrlConfigRequest:
    out: GetFunctionUrlConfigRequest = {}  # type: ignore[typeddict-item]
    return out
