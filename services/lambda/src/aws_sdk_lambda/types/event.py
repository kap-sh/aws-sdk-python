...
if TYPE_CHECKING:
    ...
    import aws_sdk_lambda.types.callback_started_details
    import aws_sdk_lambda.types.callback_succeeded_details
    import aws_sdk_lambda.types.callback_timed_out_details
    import aws_sdk_lambda.types.chained_invoke_failed_details
    import aws_sdk_lambda.types.chained_invoke_started_details
    import aws_sdk_lambda.types.chained_invoke_stopped_details
    import aws_sdk_lambda.types.chained_invoke_succeeded_details
    import aws_sdk_lambda.types.chained_invoke_timed_out_details
    import aws_sdk_lambda.types.context_failed_details
    import aws_sdk_lambda.types.context_started_details
    import aws_sdk_lambda.types.context_succeeded_details
    import aws_sdk_lambda.types.event_id
    import aws_sdk_lambda.types.event_type
    import aws_sdk_lambda.types.execution_failed_details
    import aws_sdk_lambda.types.execution_started_details
    import aws_sdk_lambda.types.execution_stopped_details
    import aws_sdk_lambda.types.execution_succeeded_details
    import aws_sdk_lambda.types.execution_timed_out_details
    import aws_sdk_lambda.types.execution_timestamp
    import aws_sdk_lambda.types.invocation_completed_details
    ...
    import aws_sdk_lambda.types.step_failed_details
    import aws_sdk_lambda.types.step_started_details
    import aws_sdk_lambda.types.step_succeeded_details
    import aws_sdk_lambda.types.wait_cancelled_details
    import aws_sdk_lambda.types.wait_started_details
...
class Event(TypedDict):
    ...
    event_id: "aws_sdk_lambda.types.event_id.EventId"
    """<p>The unique identifier for this event. Event IDs increment sequentially.</p>"""
    id: NotRequired["aws_sdk_lambda.types.operation_id.OperationId"]
    ...
    execution_started_details: NotRequired[
        "aws_sdk_lambda.types.execution_started_details.ExecutionStartedDetails"
    ]
    """<p>Details about an execution that started.</p>"""
    execution_succeeded_details: NotRequired[
        "aws_sdk_lambda.types.execution_succeeded_details.ExecutionSucceededDetails"
    ]
    """<p>Details about an execution that succeeded.</p>"""
    execution_failed_details: NotRequired[
        "aws_sdk_lambda.types.execution_failed_details.ExecutionFailedDetails"
    ]
    """<p>Details about an execution that failed.</p>"""
    execution_timed_out_details: NotRequired[
        "aws_sdk_lambda.types.execution_timed_out_details.ExecutionTimedOutDetails"
    ]
    """<p>Details about an execution that timed out.</p>"""
    execution_stopped_details: NotRequired[
        "aws_sdk_lambda.types.execution_stopped_details.ExecutionStoppedDetails"
    ]
    """<p>Details about an execution that was stopped.</p>"""
    context_started_details: NotRequired[
        "aws_sdk_lambda.types.context_started_details.ContextStartedDetails"
    ]
    """<p>Details about a context that started.</p>"""
    context_succeeded_details: NotRequired[
        "aws_sdk_lambda.types.context_succeeded_details.ContextSucceededDetails"
    ]
    """<p>Details about a context that succeeded.</p>"""
    context_failed_details: NotRequired[
        "aws_sdk_lambda.types.context_failed_details.ContextFailedDetails"
    ]
    """<p>Details about a context that failed.</p>"""
    wait_started_details: NotRequired[
        "aws_sdk_lambda.types.wait_started_details.WaitStartedDetails"
    ]
    """<p>Details about a wait operation that started.</p>"""
    wait_succeeded_details: NotRequired[
        "aws_sdk_lambda.types.wait_succeeded_details.WaitSucceededDetails"
    ]
    """<p>Details about a wait operation that succeeded.</p>"""
    wait_cancelled_details: NotRequired[
        "aws_sdk_lambda.types.wait_cancelled_details.WaitCancelledDetails"
    ]
    """<p>Details about a wait operation that was cancelled.</p>"""
    step_started_details: NotRequired[
        "aws_sdk_lambda.types.step_started_details.StepStartedDetails"
    ]
    """<p>Details about a step that started.</p>"""
    step_succeeded_details: NotRequired[
        "aws_sdk_lambda.types.step_succeeded_details.StepSucceededDetails"
    ]
    """<p>Details about a step that succeeded.</p>"""
    step_failed_details: NotRequired[
        "aws_sdk_lambda.types.step_failed_details.StepFailedDetails"
    ]
    """<p>Details about a step that failed.</p>"""
    chained_invoke_started_details: NotRequired[
        "aws_sdk_lambda.types.chained_invoke_started_details.ChainedInvokeStartedDetails"
    ]
    chained_invoke_succeeded_details: NotRequired[
        "aws_sdk_lambda.types.chained_invoke_succeeded_details.ChainedInvokeSucceededDetails"
    ]
    """<p>Details about a chained invocation that succeeded.</p>"""
    chained_invoke_failed_details: NotRequired[
        "aws_sdk_lambda.types.chained_invoke_failed_details.ChainedInvokeFailedDetails"
    ]
    chained_invoke_timed_out_details: NotRequired[
        "aws_sdk_lambda.types.chained_invoke_timed_out_details.ChainedInvokeTimedOutDetails"
    ]
    """<p>Details about a chained invocation that timed out.</p>"""
    chained_invoke_stopped_details: NotRequired[
        "aws_sdk_lambda.types.chained_invoke_stopped_details.ChainedInvokeStoppedDetails"
    ]
    """<p>Details about a chained invocation that was stopped.</p>"""
    callback_started_details: NotRequired[
        "aws_sdk_lambda.types.callback_started_details.CallbackStartedDetails"
    ]
    callback_succeeded_details: NotRequired[
        "aws_sdk_lambda.types.callback_succeeded_details.CallbackSucceededDetails"
    ]
    callback_failed_details: NotRequired[
        "aws_sdk_lambda.types.callback_failed_details.CallbackFailedDetails"
    ]
    callback_timed_out_details: NotRequired[
        "aws_sdk_lambda.types.callback_timed_out_details.CallbackTimedOutDetails"
    ]
    invocation_completed_details: NotRequired[
        "aws_sdk_lambda.types.invocation_completed_details.InvocationCompletedDetails"
    ]
...
def serialize_json(value: Event) -> dict:
    ...
    if "event_type" in value:
        ...
        out["EventType"] = aws_sdk_lambda.types.event_type.serialize_json(
            value["event_type"]
        )
    ...
    if "event_timestamp" in value:
        ...
        out["EventTimestamp"] = aws_sdk_lambda.types.execution_timestamp.serialize_json(
    ...
    if "execution_started_details" in value:
        ...
        out["ExecutionStartedDetails"] = (
            aws_sdk_lambda.types.execution_started_details.serialize_json(
    ...
    if "execution_succeeded_details" in value:
        ...
        out["ExecutionSucceededDetails"] = (
            aws_sdk_lambda.types.execution_succeeded_details.serialize_json(
    ...
    if "execution_failed_details" in value:
        ...
        out["ExecutionFailedDetails"] = (
            aws_sdk_lambda.types.execution_failed_details.serialize_json(
    ...
    if "execution_timed_out_details" in value:
        ...
        out["ExecutionTimedOutDetails"] = (
            aws_sdk_lambda.types.execution_timed_out_details.serialize_json(
    ...
    if "execution_stopped_details" in value:
        ...
        out["ExecutionStoppedDetails"] = (
            aws_sdk_lambda.types.execution_stopped_details.serialize_json(
    ...
    if "context_started_details" in value:
        ...
        out["ContextStartedDetails"] = (
            aws_sdk_lambda.types.context_started_details.serialize_json(
    ...
    if "context_succeeded_details" in value:
        ...
        out["ContextSucceededDetails"] = (
            aws_sdk_lambda.types.context_succeeded_details.serialize_json(
    ...
    if "context_failed_details" in value:
        ...
        out["ContextFailedDetails"] = (
            aws_sdk_lambda.types.context_failed_details.serialize_json(
    ...
    if "wait_started_details" in value:
        ...
        out["WaitStartedDetails"] = (
            aws_sdk_lambda.types.wait_started_details.serialize_json(
    ...
    if "wait_succeeded_details" in value:
        ...
        out["WaitSucceededDetails"] = (
            aws_sdk_lambda.types.wait_succeeded_details.serialize_json(
    ...
    if "wait_cancelled_details" in value:
        ...
        out["WaitCancelledDetails"] = (
            aws_sdk_lambda.types.wait_cancelled_details.serialize_json(
    ...
    if "step_started_details" in value:
        ...
        out["StepStartedDetails"] = (
            aws_sdk_lambda.types.step_started_details.serialize_json(
    ...
    if "step_succeeded_details" in value:
        ...
        out["StepSucceededDetails"] = (
            aws_sdk_lambda.types.step_succeeded_details.serialize_json(
    ...
    if "step_failed_details" in value:
        ...
        out["StepFailedDetails"] = (
            aws_sdk_lambda.types.step_failed_details.serialize_json(
    ...
    if "chained_invoke_started_details" in value:
        ...
        out["ChainedInvokeStartedDetails"] = (
            aws_sdk_lambda.types.chained_invoke_started_details.serialize_json(
    ...
    if "chained_invoke_succeeded_details" in value:
        ...
        out["ChainedInvokeSucceededDetails"] = (
            aws_sdk_lambda.types.chained_invoke_succeeded_details.serialize_json(
    ...
    if "chained_invoke_failed_details" in value:
        ...
        out["ChainedInvokeFailedDetails"] = (
            aws_sdk_lambda.types.chained_invoke_failed_details.serialize_json(
    ...
    if "chained_invoke_timed_out_details" in value:
        ...
        out["ChainedInvokeTimedOutDetails"] = (
            aws_sdk_lambda.types.chained_invoke_timed_out_details.serialize_json(
    ...
    if "chained_invoke_stopped_details" in value:
        ...
        out["ChainedInvokeStoppedDetails"] = (
            aws_sdk_lambda.types.chained_invoke_stopped_details.serialize_json(
    ...
    if "callback_started_details" in value:
        ...
        out["CallbackStartedDetails"] = (
            aws_sdk_lambda.types.callback_started_details.serialize_json(
    ...
    if "callback_succeeded_details" in value:
        ...
        out["CallbackSucceededDetails"] = (
            aws_sdk_lambda.types.callback_succeeded_details.serialize_json(
    ...
    if "callback_failed_details" in value:
        ...
        out["CallbackFailedDetails"] = (
            aws_sdk_lambda.types.callback_failed_details.serialize_json(
    ...
    if "callback_timed_out_details" in value:
        ...
        out["CallbackTimedOutDetails"] = (
            aws_sdk_lambda.types.callback_timed_out_details.serialize_json(
    ...
    if "invocation_completed_details" in value:
        ...
        out["InvocationCompletedDetails"] = (
            aws_sdk_lambda.types.invocation_completed_details.serialize_json(
...
def deserialize_json(data: dict) -> Event:
    ...
    if "EventType" in data:
        ...
        out["event_type"] = aws_sdk_lambda.types.event_type.deserialize_json(
            data["EventType"]
        )
    if "SubType" in data:
    ...
    if "ExecutionStartedDetails" in data:
        ...
        out["execution_started_details"] = (
            aws_sdk_lambda.types.execution_started_details.deserialize_json(
    ...
    if "ExecutionSucceededDetails" in data:
        ...
        out["execution_succeeded_details"] = (
            aws_sdk_lambda.types.execution_succeeded_details.deserialize_json(
    ...
    if "ExecutionFailedDetails" in data:
        ...
        out["execution_failed_details"] = (
            aws_sdk_lambda.types.execution_failed_details.deserialize_json(
    ...
    if "ExecutionTimedOutDetails" in data:
        ...
        out["execution_timed_out_details"] = (
            aws_sdk_lambda.types.execution_timed_out_details.deserialize_json(
    ...
    if "ExecutionStoppedDetails" in data:
        ...
        out["execution_stopped_details"] = (
            aws_sdk_lambda.types.execution_stopped_details.deserialize_json(
    ...
    if "ContextStartedDetails" in data:
        ...
        out["context_started_details"] = (
            aws_sdk_lambda.types.context_started_details.deserialize_json(
    ...
    if "ContextSucceededDetails" in data:
        ...
        out["context_succeeded_details"] = (
            aws_sdk_lambda.types.context_succeeded_details.deserialize_json(
    ...
    if "ContextFailedDetails" in data:
        ...
        out["context_failed_details"] = (
            aws_sdk_lambda.types.context_failed_details.deserialize_json(
    ...
    if "WaitStartedDetails" in data:
        ...
        out["wait_started_details"] = (
            aws_sdk_lambda.types.wait_started_details.deserialize_json(
    ...
    if "WaitSucceededDetails" in data:
        ...
        out["wait_succeeded_details"] = (
            aws_sdk_lambda.types.wait_succeeded_details.deserialize_json(
    ...
    if "WaitCancelledDetails" in data:
        ...
        out["wait_cancelled_details"] = (
            aws_sdk_lambda.types.wait_cancelled_details.deserialize_json(
    ...
    if "StepStartedDetails" in data:
        ...
        out["step_started_details"] = (
            aws_sdk_lambda.types.step_started_details.deserialize_json(
    ...
    if "StepSucceededDetails" in data:
        ...
        out["step_succeeded_details"] = (
            aws_sdk_lambda.types.step_succeeded_details.deserialize_json(
    ...
    if "StepFailedDetails" in data:
        ...
        out["step_failed_details"] = (
            aws_sdk_lambda.types.step_failed_details.deserialize_json(
    ...
    if "ChainedInvokeStartedDetails" in data:
        ...
        out["chained_invoke_started_details"] = (
            aws_sdk_lambda.types.chained_invoke_started_details.deserialize_json(
    ...
    if "ChainedInvokeSucceededDetails" in data:
        ...
        out["chained_invoke_succeeded_details"] = (
            aws_sdk_lambda.types.chained_invoke_succeeded_details.deserialize_json(
    ...
    if "ChainedInvokeFailedDetails" in data:
        ...
        out["chained_invoke_failed_details"] = (
            aws_sdk_lambda.types.chained_invoke_failed_details.deserialize_json(
    ...
    if "ChainedInvokeTimedOutDetails" in data:
        ...
        out["chained_invoke_timed_out_details"] = (
            aws_sdk_lambda.types.chained_invoke_timed_out_details.deserialize_json(
    ...
    if "ChainedInvokeStoppedDetails" in data:
        ...
        out["chained_invoke_stopped_details"] = (
            aws_sdk_lambda.types.chained_invoke_stopped_details.deserialize_json(
    ...
    if "CallbackStartedDetails" in data:
        ...
        out["callback_started_details"] = (
            aws_sdk_lambda.types.callback_started_details.deserialize_json(
    ...
    if "CallbackSucceededDetails" in data:
        ...
        out["callback_succeeded_details"] = (
            aws_sdk_lambda.types.callback_succeeded_details.deserialize_json(
    ...
    if "CallbackFailedDetails" in data:
        ...
        out["callback_failed_details"] = (
            aws_sdk_lambda.types.callback_failed_details.deserialize_json(
    ...
    if "CallbackTimedOutDetails" in data:
        ...
        out["callback_timed_out_details"] = (
            aws_sdk_lambda.types.callback_timed_out_details.deserialize_json(
    ...
    if "InvocationCompletedDetails" in data:
        ...
        out["invocation_completed_details"] = (
            aws_sdk_lambda.types.invocation_completed_details.deserialize_json(
