...
class CapacityProvider(TypedDict):
    ...
    state: "aws_sdk_lambda.types.capacity_provider_state.CapacityProviderState"
...
def serialize_json(value: CapacityProvider) -> dict:
    ...
    out["State"] = aws_sdk_lambda.types.capacity_provider_state.serialize_json(
        value["state"]
    )
    import aws_sdk_lambda.types.capacity_provider_vpc_config
...
def deserialize_json(data: dict) -> CapacityProvider:
    ...
    if "State" in data:
        ...
        out["state"] = aws_sdk_lambda.types.capacity_provider_state.deserialize_json(
            data["State"]
        )
    else:
