...
if TYPE_CHECKING:
    ...
    import capo_partnercentral_account.types.connection_type_summary_map
...
class ConnectionSummary(TypedDict, closed=True):
    ...
    connection_types: "capo_partnercentral_account.types.connection_type_summary_map.ConnectionTypeSummaryMap"
...
def serialize_aws_json_1_0(value: ConnectionSummary) -> dict:
    ...
    out["ConnectionTypes"] = (
        capo_partnercentral_account.types.connection_type_summary_map.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ConnectionSummary:
    ...
    if "ConnectionTypes" in data:
        ...
        out["connection_types"] = (
            capo_partnercentral_account.types.connection_type_summary_map.deserialize_aws_json_1_0(
