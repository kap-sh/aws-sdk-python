...
if TYPE_CHECKING:
    import capo_partnercentral_account.types.tag_key
    import capo_partnercentral_account.types.tag_value


class Tag(TypedDict, closed=True):
    key: "capo_partnercentral_account.types.tag_key.TagKey"
    """<p>The key name of the tag. Tag keys are case-sensitive.</p>"""
    value: "capo_partnercentral_account.types.tag_value.TagValue"
