...
class PartnerCentralAccountClient:
    ...
    def __init__(
        ...
        self.config = PartnerCentralAccountClientConfig(
            {
    ...
    def get_verification(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_partnercentral_account.types.get_verification_request.GetVerificationRequest]",
        ) -> OperationResponse[
            "aws_sdk_partnercentral_account.types.get_verification_response.GetVerificationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_partnercentral_account._operations.partner_central_account.get_verification.get_verification(
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_partnercentral_account.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_partnercentral_account.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_partnercentral_account._operations.partner_central_account.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def send_email_verification_code(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_partnercentral_account.types.send_email_verification_code_request.SendEmailVerificationCodeRequest]",
        ) -> OperationResponse[
            "aws_sdk_partnercentral_account.types.send_email_verification_code_response.SendEmailVerificationCodeResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_partnercentral_account._operations.partner_central_account.send_email_verification_code.send_email_verification_code(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_verification(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_partnercentral_account.types.start_verification_request.StartVerificationRequest]",
        ) -> OperationResponse[
            "aws_sdk_partnercentral_account.types.start_verification_response.StartVerificationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_partnercentral_account._operations.partner_central_account.start_verification.start_verification(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_partnercentral_account.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_partnercentral_account.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_partnercentral_account._operations.partner_central_account.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_partnercentral_account.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_partnercentral_account.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_partnercentral_account._operations.partner_central_account.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
