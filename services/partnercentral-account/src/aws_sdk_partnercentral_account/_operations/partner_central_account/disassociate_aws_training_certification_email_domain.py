...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.disassociate_aws_training_certification_email_domain_response.DisassociateAwsTrainingCertificationEmailDomainResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.disassociate_aws_training_certification_email_domain_request.DisassociateAwsTrainingCertificationEmailDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
