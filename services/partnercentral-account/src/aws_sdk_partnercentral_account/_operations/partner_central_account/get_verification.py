...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.get_verification_response.GetVerificationResponse = aws_sdk_partnercentral_account.types.get_verification_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.get_verification_request.GetVerificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_account.types.get_verification_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
