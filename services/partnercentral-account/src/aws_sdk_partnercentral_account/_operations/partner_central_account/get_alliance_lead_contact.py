...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.get_alliance_lead_contact_response.GetAllianceLeadContactResponse = aws_sdk_partnercentral_account.types.get_alliance_lead_contact_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.get_alliance_lead_contact_request.GetAllianceLeadContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_account.types.get_alliance_lead_contact_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
