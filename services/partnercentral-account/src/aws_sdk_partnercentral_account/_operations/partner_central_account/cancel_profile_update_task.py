...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.cancel_profile_update_task_response.CancelProfileUpdateTaskResponse = aws_sdk_partnercentral_account.types.cancel_profile_update_task_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.cancel_profile_update_task_request.CancelProfileUpdateTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_account.types.cancel_profile_update_task_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
