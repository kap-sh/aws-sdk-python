"""Generated from Smithy shape ``com.amazonaws.partnercentralaccount#PutProfileVisibility``."""
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.put_profile_visibility_response.PutProfileVisibilityResponse = aws_sdk_partnercentral_account.types.put_profile_visibility_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.put_profile_visibility_request.PutProfileVisibilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PartnerCentralAccount.PutProfileVisibility"
    import aws_sdk_partnercentral_account.types.put_profile_visibility_request

    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_account.types.put_profile_visibility_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_put_profile_visibility(
