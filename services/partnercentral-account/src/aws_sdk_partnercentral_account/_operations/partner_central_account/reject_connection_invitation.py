...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.reject_connection_invitation_response.RejectConnectionInvitationResponse = aws_sdk_partnercentral_account.types.reject_connection_invitation_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.reject_connection_invitation_request.RejectConnectionInvitationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_account.types.reject_connection_invitation_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
