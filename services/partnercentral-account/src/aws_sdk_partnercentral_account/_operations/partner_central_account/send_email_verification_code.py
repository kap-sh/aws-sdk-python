...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.send_email_verification_code_response.SendEmailVerificationCodeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.send_email_verification_code_request.SendEmailVerificationCodeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_account.types.send_email_verification_code_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
