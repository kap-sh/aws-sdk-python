...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.list_partners_response.ListPartnersResponse = aws_sdk_partnercentral_account.types.list_partners_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.list_partners_request.ListPartnersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_account.types.list_partners_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
