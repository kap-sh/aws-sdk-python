"""Generated from Smithy shape ``com.amazonaws.partnercentralaccount#GetPartner``."""
...
import aws_sdk_partnercentral_account.types.partner_domain_list
import aws_sdk_partnercentral_account.types.partner_profile
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.get_partner_response.GetPartnerResponse = aws_sdk_partnercentral_account.types.get_partner_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.get_partner_request.GetPartnerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PartnerCentralAccount.GetPartner"
    import aws_sdk_partnercentral_account.types.get_partner_request

    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_account.types.get_partner_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
