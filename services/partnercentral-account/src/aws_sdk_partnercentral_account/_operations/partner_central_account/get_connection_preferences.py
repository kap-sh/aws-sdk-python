...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.get_connection_preferences_response.GetConnectionPreferencesResponse = aws_sdk_partnercentral_account.types.get_connection_preferences_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.get_connection_preferences_request.GetConnectionPreferencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_account.types.get_connection_preferences_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
