...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.list_connection_invitations_response.ListConnectionInvitationsResponse = aws_sdk_partnercentral_account.types.list_connection_invitations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.list_connection_invitations_request.ListConnectionInvitationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_account.types.list_connection_invitations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
