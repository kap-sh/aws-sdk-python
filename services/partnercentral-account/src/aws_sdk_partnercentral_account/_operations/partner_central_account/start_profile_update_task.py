"""Generated from Smithy shape ``com.amazonaws.partnercentralaccount#StartProfileUpdateTask``."""
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.start_profile_update_task_response.StartProfileUpdateTaskResponse = aws_sdk_partnercentral_account.types.start_profile_update_task_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.start_profile_update_task_request.StartProfileUpdateTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PartnerCentralAccount.StartProfileUpdateTask"
    import aws_sdk_partnercentral_account.types.start_profile_update_task_request

    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_account.types.start_profile_update_task_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_start_profile_update_task(
