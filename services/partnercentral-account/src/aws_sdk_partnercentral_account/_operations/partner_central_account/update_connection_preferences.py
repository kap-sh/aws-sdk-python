"""Generated from Smithy shape ``com.amazonaws.partnercentralaccount#UpdateConnectionPreferences``."""
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.update_connection_preferences_response.UpdateConnectionPreferencesResponse = aws_sdk_partnercentral_account.types.update_connection_preferences_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.update_connection_preferences_request.UpdateConnectionPreferencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PartnerCentralAccount.UpdateConnectionPreferences"
    import aws_sdk_partnercentral_account.types.update_connection_preferences_request

    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_account.types.update_connection_preferences_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_connection_preferences(
