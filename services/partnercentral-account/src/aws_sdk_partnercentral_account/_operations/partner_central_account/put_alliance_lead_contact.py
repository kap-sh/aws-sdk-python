"""Generated from Smithy shape ``com.amazonaws.partnercentralaccount#PutAllianceLeadContact``."""
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.put_alliance_lead_contact_response.PutAllianceLeadContactResponse = aws_sdk_partnercentral_account.types.put_alliance_lead_contact_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.put_alliance_lead_contact_request.PutAllianceLeadContactRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_put_alliance_lead_contact(
