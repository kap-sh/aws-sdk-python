"""Generated from Smithy shape ``com.amazonaws.partnercentralaccount#StartVerification``."""
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.start_verification_response.StartVerificationResponse = aws_sdk_partnercentral_account.types.start_verification_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.start_verification_request.StartVerificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PartnerCentralAccount.StartVerification"
    import aws_sdk_partnercentral_account.types.start_verification_request

    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_account.types.start_verification_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
