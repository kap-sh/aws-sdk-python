...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.create_connection_invitation_response.CreateConnectionInvitationResponse = aws_sdk_partnercentral_account.types.create_connection_invitation_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.create_connection_invitation_request.CreateConnectionInvitationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
