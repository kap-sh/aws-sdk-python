"""Generated from Smithy shape ``com.amazonaws.partnercentralaccount#GetConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.get_connection_response.GetConnectionResponse = aws_sdk_partnercentral_account.types.get_connection_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.get_connection_request.GetConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "PartnerCentralAccount.GetConnection"
    import aws_sdk_partnercentral_account.types.get_connection_request

    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_account.types.get_connection_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
