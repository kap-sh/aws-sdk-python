...
def build_request(
    ...
    input: aws_sdk_partnercentral_account.types.associate_aws_training_certification_email_domain_request.AssociateAwsTrainingCertificationEmailDomainRequest,
) -> zapros.Request:
