...
import aws_sdk_partnercentral_account.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_partnercentral_account.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_partnercentral_account.types.associate_aws_training_certification_email_domain_response.AssociateAwsTrainingCertificationEmailDomainResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_partnercentral_account.types.associate_aws_training_certification_email_domain_request.AssociateAwsTrainingCertificationEmailDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_partnercentral_account.types.associate_aws_training_certification_email_domain_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
