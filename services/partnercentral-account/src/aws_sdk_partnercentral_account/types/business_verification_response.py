...
if TYPE_CHECKING:
    ...
    import aws_sdk_partnercentral_account.types.completion_url
...
class BusinessVerificationResponse(TypedDict, closed=True):
    ...
    completion_url: NotRequired[
        "aws_sdk_partnercentral_account.types.completion_url.CompletionUrl"
    ]
    ...
    completion_url_expires_at: NotRequired[
        "aws_sdk_partnercentral_account.types.date_time.DateTime"
    ]
...
def serialize_aws_json_1_0(value: BusinessVerificationResponse) -> dict:
    ...
    out["BusinessVerificationDetails"] = (
        aws_sdk_partnercentral_account.types.business_verification_details.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> BusinessVerificationResponse:
    ...
    if "BusinessVerificationDetails" in data:
        ...
        out["business_verification_details"] = (
            aws_sdk_partnercentral_account.types.business_verification_details.deserialize_aws_json_1_0(
