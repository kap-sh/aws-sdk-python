...
if TYPE_CHECKING:
    ...
    import aws_sdk_partnercentral_account.types.connection_type_summary

ConnectionTypeSummaryMap: TypeAlias = dict[
    "aws_sdk_partnercentral_account.types.connection_type.ConnectionType",
    "aws_sdk_partnercentral_account.types.connection_type_summary.ConnectionTypeSummary",
]
...
def serialize_aws_json_1_0(input_to_serialize: ConnectionTypeSummaryMap) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        ] = aws_sdk_partnercentral_account.types.connection_type_summary.serialize_aws_json_1_0(
            value
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ConnectionTypeSummaryMap:
    ...
    for key, value in data.items():
        ...
        ] = aws_sdk_partnercentral_account.types.connection_type_summary.deserialize_aws_json_1_0(
            value
        )
    return out
