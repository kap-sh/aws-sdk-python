...
ConnectionSummaryList: TypeAlias = list[
    "aws_sdk_partnercentral_account.types.connection_summary.ConnectionSummary"
]
...
def serialize_aws_json_1_0(value: ConnectionSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_partnercentral_account.types.connection_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ConnectionSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_partnercentral_account.types.connection_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
