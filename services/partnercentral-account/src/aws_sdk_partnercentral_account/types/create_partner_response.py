...
class CreatePartnerResponse(TypedDict):
    ...
    profile: "aws_sdk_partnercentral_account.types.partner_profile.PartnerProfile"
    ...
    aws_training_certification_email_domains: NotRequired[
        "aws_sdk_partnercentral_account.types.partner_domain_list.PartnerDomainList"
    ]
...
def serialize_aws_json_1_0(value: CreatePartnerResponse) -> dict:
    ...
    out["Profile"] = (
        aws_sdk_partnercentral_account.types.partner_profile.serialize_aws_json_1_0(
            value["profile"]
        )
    )
    if "aws_training_certification_email_domains" in value:
        ...
        out["AwsTrainingCertificationEmailDomains"] = (
            aws_sdk_partnercentral_account.types.partner_domain_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> CreatePartnerResponse:
    ...
    if "Profile" in data:
        ...
        out["profile"] = (
            aws_sdk_partnercentral_account.types.partner_profile.deserialize_aws_json_1_0(
                data["Profile"]
            )
        )
    else:
    ...
    if "AwsTrainingCertificationEmailDomains" in data:
        ...
        out["aws_training_certification_email_domains"] = (
            aws_sdk_partnercentral_account.types.partner_domain_list.deserialize_aws_json_1_0(
