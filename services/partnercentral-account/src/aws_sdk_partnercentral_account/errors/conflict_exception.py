...
if TYPE_CHECKING:
    import aws_sdk_partnercentral_account.types.conflict_exception_reason


class ConflictException_(TypedDict, closed=True):
    message: "str"
    reason: "aws_sdk_partnercentral_account.types.conflict_exception_reason.ConflictExceptionReason"
...
def serialize_aws_json_1_0(value: ConflictException_) -> dict:
    ...
    out["Reason"] = (
        aws_sdk_partnercentral_account.types.conflict_exception_reason.serialize_aws_json_1_0(
            value["reason"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ConflictException_:
    ...
    if "Reason" in data:
        ...
        out["reason"] = (
            aws_sdk_partnercentral_account.types.conflict_exception_reason.deserialize_aws_json_1_0(
                data["Reason"]
            )
        )
    else:
