...
class PartnerCentralAccountError(Exception):
    """Base class for all PartnerCentralAccount service errors."""


class ServiceError(PartnerCentralAccountError):
...
class SerializationError(PartnerCentralAccountError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PartnerCentralAccountError):
...
class WaiterFailedError(PartnerCentralAccountError):
...
class WaiterTimeoutError(PartnerCentralAccountError):
