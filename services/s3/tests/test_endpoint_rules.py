...
from aws_sdk_s3._rule_engine._endpoint_runtime import EndpointError
import re
import zapros


def test_1_region_is_not_a_valid_dns_suffix():
...
def test_2_invalid_access_point_arn__not_s3():
...
def test_3_invalid_access_point_arn__invalid_resource():
...
def test_4_invalid_access_point_arn__invalid_no_ap_name():
...
def test_5_invalid_access_point_arn__accountid_is_i():
...
def test_6_invalid_access_point_arn__access_point_n():
...
def test_7_access_points__disable_access_points_exp():
...
def test_8_access_points__partition_does_not_suppor():
...
def test_9_bucket_region_is_invalid():
...
def test_10_access_points_when_access_points_explici():
...
def test_12_sdk__host___access_point___dualstack_is_():
...
def test_13_access_point_arn_with_fips___dualstack():
...
def test_14_access_point_arn_with_dualstack():
...
def test_16_mrap_does_not_support_fips():
...
def test_17_mrap_does_not_support_dualstack():
...
def test_18_mrap_does_not_support_s3_accelerate():
...
def test_19_mrap_explicitly_disabled():
...
def test_20_dual_stack_endpoint_with_path_style_forced():
...
def test_21_dual_stack_endpoint___sdk__host_is_error():
...
def test_22_path_style___arn_bucket():
...
def test_23_implicit_path_style_bucket___dualstack():
...
def test_24_implicit_path_style_bucket___dualstack():
    """implicit path style bucket + dualstack"""
    params = EndpointParams(
        Accelerate=False,
        Bucket='99_ab',
...
def test_25_don_t_allow_url_injections_in_the_bucket():
...
def test_26_uri_encode_bucket_names_in_the_path():
...
def test_27_scheme_is_respected():
    """scheme is respected"""
    params = EndpointParams(
        Accelerate=False,
        Bucket='99_ab',
...
def test_28_scheme_is_respected__virtual_addressing_():
...
def test_29_path_style___implicit_private_link():
...
def test_30_invalid_endpoint_override():
...
def test_31_using_an_ipv4_address_forces_path_style():
...
def test_32_vanilla_access_point_arn_with_region_mis():
...
def test_33_vanilla_access_point_arn_with_region_mis():
...
def test_34_vanilla_access_point_arn_with_region_mis():
...
def test_35_subdomains_are_not_allowed_in_virtual_buckets():
...
def test_36_bucket_names_with_3_characters_are_allow():
...
def test_37_bucket_names_with_fewer_than_3_character():
...
def test_38_bucket_names_with_uppercase_characters_a():
...
def test_39_subdomains_are_allowed_in_virtual_bucket():
...
def test_41_useglobalendpoints_true__region_us_east_():
...
def test_42_useglobalendpoints_true__region_us_west_():
...
def test_43_useglobalendpoints_true__region_cn_north():
...
def test_44_useglobalendpoints_true__region_us_east_():
...
def test_45_useglobalendpoints_true__region_us_east_():
...
def test_46_useglobalendpoints_true__region_us_east_():
...
def test_47_useglobalendpoints_true__region_us_east_():
...
def test_48_useglobalendpoints_true__region_us_west_():
...
def test_49_useglobalendpoints_true__region_us_east_():
...
def test_50_aws_global_region_uses_the_global_endpoint():
...
def test_51_aws_global_region_with_fips_uses_the_reg():
...
def test_52_aws_global_region_with_dualstack_uses_th():
...
def test_53_aws_global_region_with_fips_and_dualstac():
...
def test_54_aws_global_region_with_accelerate_on_non():
...
def test_55_aws_global_region_with_custom_endpoint__():
...
def test_56_virtual_addressing__aws_global_region_us():
...
def test_57_virtual_addressing__aws_global_region_wi():
...
def test_58_virtual_addressing__aws_global_region_wi():
...
def test_59_virtual_addressing__aws_global_region_wi():
...
def test_60_virtual_addressing__aws_global_region_wi():
...
def test_61_virtual_addressing__aws_global_region_wi():
...
def test_62_virtual_addressing__aws_global_region_wi():
...
def test_63_virtual_addressing__aws_global_region_wi():
...
def test_64_virtual_addressing__useglobalendpoint_an():
...
def test_65_virtual_addressing__useglobalendpoint_an():
...
def test_66_virtual_addressing__useglobalendpoint_an():
...
def test_67_virtual_addressing__useglobalendpoint_an():
...
def test_68_virtual_addressing__useglobalendpoint_an():
...
def test_69_virtual_addressing__useglobalendpoint_an():
...
def test_70_forcepathstyle__aws_global_region_uses_t():
...
def test_71_forcepathstyle__aws_global_region_with_f():
...
def test_72_forcepathstyle__aws_global_region_with_d():
...
def test_73_forcepathstyle__aws_global_region_custom():
...
def test_74_forcepathstyle__useglobalendpoint_us_eas():
...
def test_75_forcepathstyle__useglobalendpoint_us_wes():
...
def test_76_forcepathstyle__useglobalendpoint_us_eas():
...
def test_77_forcepathstyle__useglobalendpoint_us_eas():
...
def test_78_arn_with_aws_global_region_and__usearnre():
...
def test_79_cross_partition_mrap_arn_is_an_error():
...
def test_80_endpoint_override__accesspoint_with_http():
...
def test_81_endpoint_override__accesspoint_with_http():
...
def test_82_non_bucket_endpoint_override_with_fips__():
...
def test_83_fips___dualstack___custom_endpoint():
...
def test_84_dualstack___custom_endpoint():
...
def test_85_custom_endpoint_without_fips_dualstack():
...
def test_86_s3_object_lambda_with_access_points_disabled():
...
def test_88_standard_non_bucket_endpoint():
...
def test_89_non_bucket_endpoint_with_fips___dualstack():
...
def test_90_non_bucket_endpoint_with_dualstack():
...
def test_91_use_global_endpoint___ip_address_endpoin():
...
def test_92_non_dns_endpoint___global_endpoint():
...
def test_93_endpoint_override___use_global_endpoint():
...
def test_94_fips___dualstack___non_bucket_endpoint():
...
def test_95_fips___dualstack___non_dns_endpoint():
...
def test_96_endpoint_override___fips___dualstack__bug_():
...
def test_97_endpoint_override___non_dns_bucket___fip():
...
def test_98_fips___bucket_endpoint___force_path_style():
...
def test_99_bucket___fips___force_path_style():
...
def test_100_fips___dualstack___use_global_endpoint():
...
def test_101_uri_encoded_bucket___use_global_endpoint():
...
def test_102_fips___path_based_endpoint():
...
def test_103_accelerate___dualstack___global_endpoint():
...
def test_104_dualstack___global_endpoint___non_uri_sa():
...
def test_105_fips___uri_encoded_bucket():
...
def test_106_endpoint_override___non_uri_safe_endpoin():
...
def test_107_fips___dualstack___global_endpoint___non():
...
def test_108_endpoint_override___fips___dualstack():
...
def test_109_non_bucket_endpoint_override___dualstack():
...
def test_110_endpoint_override___useglobalendpoint___():
...
def test_111_non_fips_partition_with_fips_set___custo():
...
def test_112_aws_global_signs_as_us_east_1():
...
def test_113_aws_global_signs_as_us_east_1():
    """aws-global signs as us-east-1"""
    params = EndpointParams(
        Region='aws-global',
        Bucket='bucket',
...
def test_114_aws_global___dualstack___path_only_bucket():
...
def test_115_aws_global___path_only_bucket():
...
def test_116_aws_global___fips___custom_endpoint():
...
def test_117_aws_global__endpoint_override___path_onl():
...
def test_118_aws_global___dualstack___custom_endpoint():
...
def test_119_accelerate__dualstack___aws_global():
...
def test_120_fips___aws_global___path_only_bucket__th():
...
def test_121_aws_global___fips___endpoint_override_():
...
def test_122_force_path_style__fips__aws_global___end():
...
def test_123_ip_address_causes_path_style_to_be_forced():
...
def test_124_endpoint_override_with_aws_global_region():
...
def test_125_fips___path_only__todo__consider_making_():
...
def test_127_path_style_can_t_be_used_with_accelerate():
...
def test_132_invalid_arn_region():
    """invalid arn region"""
    params = EndpointParams(
        Region='us-east-2',
...
def test_133_invalid_arn_outpost():
    """invalid ARN outpost"""
    params = EndpointParams(
        Region='us-east-2',
...
def test_136_invalid_outpost_type():
...
def test_137_invalid_outpost_type():
    """invalid outpost type"""
    params = EndpointParams(
        Region='us-east-2',
...
def test_138_invalid_outpost_type():
    """invalid outpost type"""
    params = EndpointParams(
        Region='us-east-2',
...
def test_139_invalid_outpost_type():
    """invalid outpost type"""
    params = EndpointParams(
        Region='us-east-2',
...
def test_140_use_global_endpoint_virtual_addressing():
...
def test_141_global_endpoint___ip_address():
...
def test_142_invalid_outpost_type():
    """invalid outpost type"""
    params = EndpointParams(
        Region='us-east-2',
        Bucket='bucket!',
...
def test_143_invalid_outpost_type():
    """invalid outpost type"""
    params = EndpointParams(
        Region='us-east-2',
        Bucket='bucket',
...
def test_144_use_global_endpoint___custom_endpoint():
...
def test_145_use_global_endpoint__not_us_east_1__forc():
...
def test_146_vanilla_virtual_addressing_us_west_2():
...
def test_147_virtual_addressing___dualstack_us_west_2():
...
def test_148_accelerate___dualstack_us_west_2():
...
def test_149_accelerate__dualstack_false__us_west_2():
...
def test_150_virtual_addressing___fips_us_west_2():
...
def test_151_virtual_addressing___dualstack___fips_us():
...
def test_152_accelerate___fips___error_us_west_2():
...
def test_153_vanilla_virtual_addressing_cn_north_1():
...
def test_154_virtual_addressing___dualstack_cn_north_1():
...
def test_155_accelerate__dualstack_false__cn_north_1():
...
def test_156_virtual_addressing___fips_cn_north_1():
...
def test_157_vanilla_virtual_addressing_af_south_1():
...
def test_158_virtual_addressing___dualstack_af_south_1():
...
def test_159_accelerate___dualstack_af_south_1():
...
def test_160_accelerate__dualstack_false__af_south_1():
...
def test_161_virtual_addressing___fips_af_south_1():
...
def test_162_virtual_addressing___dualstack___fips_af():
...
def test_163_accelerate___fips___error_af_south_1():
...
def test_164_vanilla_path_style_us_west_2():
...
def test_165_fips_us_gov_west_2__bucket_is_not_s3_dns():
...
def test_166_path_style___accelerate___error_us_west_2():
...
def test_167_path_style___dualstack_us_west_2():
...
def test_168_path_style___arn_is_error_us_west_2():
...
def test_169_path_style___invalid_dns_name_us_west_2():
...
def test_170_no_path_style___invalid_dns_name_us_west_2():
...
def test_171_vanilla_path_style_cn_north_1():
...
def test_172_path_style___fips_cn_north_1():
...
def test_173_path_style___accelerate___error_cn_north_1():
...
def test_174_path_style___dualstack_cn_north_1():
...
def test_175_path_style___arn_is_error_cn_north_1():
...
def test_176_path_style___invalid_dns_name_cn_north_1():
...
def test_177_no_path_style___invalid_dns_name_cn_north_1():
...
def test_178_vanilla_path_style_af_south_1():
...
def test_179_path_style___fips_af_south_1():
...
def test_180_path_style___accelerate___error_af_south_1():
...
def test_181_path_style___dualstack_af_south_1():
...
def test_182_path_style___arn_is_error_af_south_1():
...
def test_183_path_style___invalid_dns_name_af_south_1():
...
def test_184_no_path_style___invalid_dns_name_af_south_1():
...
def test_185_virtual_addressing___private_link_us_west_2():
...
def test_186_path_style___private_link_us_west_2():
...
def test_187_sdk__host___fips_us_west_2():
...
def test_188_sdk__host___dualstack_us_west_2():
...
def test_189_sdk__host___accelerate_us_west_2():
...
def test_190_sdk__host___access_point_arn_us_west_2():
...
def test_191_virtual_addressing___private_link_cn_north_1():
...
def test_192_path_style___private_link_cn_north_1():
...
def test_194_sdk__host___dualstack_cn_north_1():
...
def test_195_sdk__host___accelerate_cn_north_1():
...
def test_196_sdk__host___access_point_arn_cn_north_1():
...
def test_197_virtual_addressing___private_link_af_south_1():
...
def test_198_path_style___private_link_af_south_1():
...
def test_199_sdk__host___fips_af_south_1():
...
def test_200_sdk__host___dualstack_af_south_1():
...
def test_201_sdk__host___accelerate_af_south_1():
...
def test_202_sdk__host___access_point_arn_af_south_1():
...
def test_203_vanilla_access_point_arn_us_west_2():
...
def test_204_access_point_arn___fips_us_west_2():
...
def test_205_access_point_arn___accelerate___error_us():
...
def test_206_access_point_arn___fips___dualstack_us_west_2():
...
def test_207_vanilla_access_point_arn_cn_north_1():
...
def test_208_access_point_arn___fips_cn_north_1():
...
def test_209_access_point_arn___accelerate___error_cn():
...
def test_210_access_point_arn___fips___dualstack_cn_n():
...
def test_211_vanilla_access_point_arn_af_south_1():
...
def test_212_access_point_arn___fips_af_south_1():
...
def test_213_access_point_arn___accelerate___error_af():
...
def test_214_access_point_arn___fips___dualstack_af_s():
...
def test_215_s3_outposts_vanilla_test():
...
def test_216_s3_outposts_custom_endpoint():
...
def test_217_outposts_arn_with_region_mismatch_and_us():
...
def test_218_outposts_arn_with_region_mismatch__custo():
...
def test_219_outposts_arn_with_region_mismatch_and_us():
...
def test_220_outposts_arn_with_region_mismatch_and_us():
...
def test_221_outposts_arn_with_partition_mismatch_and():
...
def test_222_arn_with_useglobalendpoint_and_use_east_():
...
def test_223_s3_outposts_does_not_support_dualstack():
...
def test_224_s3_outposts_does_not_support_fips():
...
def test_225_s3_outposts_does_not_support_accelerate():
...
def test_226_validates_against_subresource():
...
def test_227_validates_against_access_point_host_label():
...
def test_228_object_lambda__us_east_1():
...
def test_229_object_lambda__us_west_2():
...
def test_230_object_lambda__colon_resource_deliminato():
...
def test_231_object_lambda__us_east_1__client_region_():
...
def test_232_object_lambda__us_east_1__client_region_():
...
def test_233_object_lambda__us_east_1__client_region_():
...
def test_234_object_lambda__us_east_1__client_region_():
...
def test_235_object_lambda__us_east_1__client_region_():
...
def test_236_object_lambda__cn_north_1__client_region():
...
def test_237_object_lambda_with_dualstack():
...
def test_238_object_lambda__us_gov_east_1():
...
def test_239_object_lambda__us_gov_east_1__with_fips():
...
def test_240_object_lambda__cn_north_1__with_fips():
...
def test_241_object_lambda_with_accelerate():
...
def test_242_object_lambda_with_invalid_arn___bad_ser():
...
def test_243_object_lambda_with_invalid_arn___invalid():
...
def test_244_object_lambda_with_invalid_arn___missing():
...
def test_245_object_lambda_with_invalid_arn___missing():
...
def test_246_object_lambda_with_invalid_arn___account():
...
def test_247_object_lambda_with_invalid_arn___missing():
...
def test_248_object_lambda_with_invalid_arn___access_():
...
def test_249_object_lambda_with_invalid_arn___access_():
    """object lambda with invalid arn - access point name contains invalid character: ."""
    params = EndpointParams(
        Region='us-west-2',
        UseFIPS=False,
...
def test_250_object_lambda_with_invalid_arn___access_():
...
def test_251_object_lambda_with_custom_endpoint():
...
def test_252_object_lambda_arn_with_region_mismatch_a():
...
def test_253_writegetobjectresponse___us_west_2():
...
def test_254_writegetobjectresponse_with_custom_endpoint():
...
def test_255_writegetobjectresponse___us_east_1():
...
def test_256_writegetobjectresponse_with_fips():
...
def test_257_writegetobjectresponse_with_dualstack():
...
def test_258_writegetobjectresponse_with_accelerate():
...
def test_259_writegetobjectresponse_with_fips_in_cn():
...
def test_260_writegetobjectresponse_with_invalid_partition():
...
def test_261_writegetobjectresponse_with_an_unknown_p():
...
def test_262_s3_outposts_bucketalias_real_outpost_pro():
...
def test_263_s3_outposts_bucketalias_real_outpost_pro():
...
def test_264_s3_outposts_bucketalias_ec2_outpost_prod():
...
def test_265_s3_outposts_bucketalias_ec2_outpost_prod():
...
def test_266_s3_outposts_bucketalias_real_outpost_beta():
...
def test_267_s3_outposts_bucketalias_ec2_outpost_beta():
...
def test_268_s3_outposts_bucketalias___no_endpoint_se():
...
def test_269_s3_outposts_invalid_bucket_name():
...
def test_270_s3_outposts_bucketalias_invalid_hardware_type():
...
def test_271_s3_outposts_bucketalias_special_characte():
...
def test_272_s3_outposts_bucketalias___no_endpoint_se():
    """S3 Outposts bucketAlias - No endpoint set for beta"""
    params = EndpointParams(
        Region='us-east-1',
...
def test_273_s3_snow_with_bucket():
    """S3 Snow with bucket"""
    params = EndpointParams(
        Region='snow',
        Bucket='bucketName',
...
def test_274_s3_snow_without_bucket():
...
def test_276_s3_snow_dns_endpoint():
...
def test_277_data_plane_with_short_zone_name():
...
def test_278_data_plane_with_short_zone_name_china_region():
...
def test_279_data_plane_with_short_zone_name_with_ap():
...
def test_280_data_plane_with_short_zone_name_with_ap_():
...
def test_281_data_plane_with_short_zone_names__13_chars_():
...
def test_282_data_plane_with_short_zone_names__13_cha():
...
def test_283_data_plane_with_medium_zone_names__14_chars_():
...
def test_284_data_plane_with_medium_zone_names__14_ch():
...
def test_285_data_plane_with_long_zone_names__20_chars_():
...
def test_286_data_plane_with_long_zone_names__20_chars_():
    """Data Plane with long zone names (20 chars)"""
    params = EndpointParams(
        Region='us-west-2',
...
def test_287_data_plane_with_short_zone_fips():
...
def test_288_data_plane_with_short_zone_fips_china_region():
...
def test_289_data_plane_with_short_zone_fips_with_ap():
...
def test_290_data_plane_with_short_zone_fips_with_ap_():
...
def test_291_data_plane_with_short_zone__13_chars__fips():
...
def test_292_data_plane_with_short_zone__13_chars__fi():
...
def test_293_data_plane_with_medium_zone__14_chars__fips():
...
def test_294_data_plane_with_medium_zone__14_chars__f():
...
def test_295_data_plane_with_long_zone__20_chars__fips():
...
def test_296_data_plane_with_long_zone__20_chars__fip():
...
def test_297_data_plane_with_long_az():
...
def test_298_data_plane_with_long_az_with_ap():
...
def test_299_data_plane_with_long_az_fips():
...
def test_300_data_plane_with_long_az_fips_with_ap():
...
def test_301_control_plane_with_short_az_bucket():
...
def test_302_control_plane_with_short_az_bucket_china():
...
def test_303_control_plane_with_short_az_bucket_and_fips():
...
def test_304_control_plane_with_short_az_bucket_and_f():
...
def test_305_control_plane_without_bucket():
...
def test_306_control_plane_without_bucket_and_fips():
...
def test_307_data_plane_sigv4_auth_with_short_az():
...
def test_308_data_plane_sigv4_auth_with_short_az_with_ap():
...
def test_309_data_plane_sigv4_auth_with_short_zone__1():
...
def test_310_data_plane_sigv4_auth_with_short_zone__1():
...
def test_311_data_plane_sigv4_auth_with_short_az_fips():
...
def test_312_data_plane_sigv4_auth_with_short_az_fips():
...
def test_313_data_plane_sigv4_auth_with_short_zone__1():
...
def test_314_data_plane_sigv4_auth_with_short_zone__1():
...
def test_315_data_plane_sigv4_auth_with_long_az():
...
def test_316_data_plane_sigv4_auth_with_long_az_with_ap():
...
def test_317_data_plane_sigv4_auth_with_medium_zone_1():
...
def test_318_data_plane_sigv4_auth_with_medium_zone_1():
...
def test_319_data_plane_sigv4_auth_with_long_zone_20_():
...
def test_320_data_plane_sigv4_auth_with_long_zone_20_():
...
def test_321_data_plane_sigv4_auth_with_long_az_fips():
...
def test_322_data_plane_sigv4_auth_with_long_az_fips_():
...
def test_323_data_plane_sigv4_auth_with_medium_zone__():
...
def test_324_data_plane_sigv4_auth_with_medium_zone__():
...
def test_325_data_plane_sigv4_auth_with_long_zone__20():
...
def test_326_data_plane_sigv4_auth_with_long_zone__20():
...
def test_327_control_plane_host_override():
...
def test_328_control_plane_host_override_with_ap():
...
def test_329_control_plane_host_override_no_bucket():
...
def test_330_data_plane_host_override_non_virtual_ses():
...
def test_331_data_plane_host_override_non_virtual_ses():
...
def test_332_control_plane_host_override_ip():
...
def test_333_control_plane_host_override_ip_with_ap():
...
def test_334_data_plane_host_override():
...
def test_335_data_plane_host_override_with_ap():
...
def test_337_bad_ap_format_error():
    """bad AP format error"""
    params = EndpointParams(
        Region='us-east-1',
...
def test_338_bad_format_error_no_session_auth():
...
def test_339_bad_ap_format_error_no_session_auth():
...
def test_341_accelerate_error_with_ap():
...
def test_342_data_plane_bucket_format_error():
...
def test_343_data_plane_ap_format_error():
...
def test_344_host_override_data_plane_bucket_error_se():
...
def test_345_host_override_data_plane_ap_error_sessio():
...
def test_346_host_override_data_plane_bucket_error():
...
def test_347_host_override_data_plane_ap_error():
...
def test_348_control_plane_without_bucket_and_dualstack():
...
def test_349_control_plane_without_bucket__fips_and_d():
...
def test_350_data_plane_with_bucket_containing_delimiters():
...
def test_351_control_plane_with_with_bucket_containin():
...
def test_352_data_plane_with_short_az_and_dualstack():
...
def test_353_data_plane_with_short_az_and_fips_with_d():
...
def test_354_data_plane_sigv4_auth_with_short_az_and_():
...
def test_355_data_plane_sigv4_auth_with_short_az_and_():
...
def test_356_data_plane_with_zone_and_dualstack():
...
def test_357_data_plane_with_zone_and_fips_with_dualstack():
...
def test_358_data_plane_sigv4_auth_with_zone_and_dualstack():
...
def test_359_data_plane_sigv4_auth_with_9_char_zone_a():
...
def test_360_data_plane_with_13_char_zone_and_dualstack():
...
def test_361_data_plane_with_13_char_zone_and_fips_wi():
...
def test_362_data_plane_sigv4_auth_with_13_char_zone_():
...
def test_363_data_plane_sigv4_auth_with_13_char_zone_():
...
def test_364_data_plane_with_14_char_zone_and_dualstack():
...
def test_365_data_plane_with_14_char_zone_and_fips_wi():
...
def test_366_data_plane_sigv4_auth_with_14_char_zone_():
...
def test_367_data_plane_sigv4_auth_with_14_char_zone_():
...
def test_368_data_plane_with_long_zone__20_cha__and_d():
...
def test_369_data_plane_with_long_zone__20_char__and_():
...
def test_370_data_plane_sigv4_auth_with_long_zone__20():
...
def test_371_data_plane_sigv4_auth_with_long_zone__20():
...
def test_372_control_plane_and_fips_with_dualstack():
...
def test_373_data_plane_with_zone_and_dualstack_and_ap():
...
def test_374_data_plane_with_zone_and_fips_with_duals():
...
def test_375_data_plane_sigv4_auth_with_zone_and_dual():
...
def test_376_data_plane_ap_sigv4_auth_with_zone_and_f():
...
def test_377_data_plane_with_zone__9_char__and_ap_wit():
...
def test_378_data_plane_with_zone__9_char__and_fips_w():
...
def test_379_data_plane_sigv4_auth_with__9_char__zone():
...
def test_380_access_point_sigv4_auth_with__9_char__zo():
...
def test_381_data_plane_with_zone__13_char__and_ap_wi():
...
def test_382_data_plane_with_zone__13_char__and_ap_wi():
...
def test_383_data_plane_sigv4_auth_with__13_char__zon():
...
def test_384_data_plane_sigv4_auth_with__13_char__zon():
...
def test_385_data_plane_with__14_char__zone_and_ap_wi():
...
def test_386_data_plane_with__14_char__zone_and_ap_wi():
...
def test_387_data_plane_sigv4_auth_with__14_char__zon():
...
def test_388_data_plane_with__14_char__zone_and_ap_wi():
    """Data Plane with (14 char) zone and AP with FIPS and dualstack"""
    params = EndpointParams(
        Region='us-west-2',
        Bucket='myaccesspoint--test1-zone-ab1--xa-s3',
...
def test_389_data_plane_with__20_char__zone_and_ap_wi():
...
def test_390_data_plane_with__20_char__zone_and_ap_wi():
...
def test_391_data_plane_ap_with_sigv4_and_dualstack():
...
def test_392_data_plane_ap_sigv4_with_fips_and_dualstack():
...
def test_393_control_plane_with_dualstack_and_bucket():
