"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketLocation``."""
...
import capo_s3.types.bucket_location_constraint
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?location"
...
def get_bucket_location(
    ...
    capo_s3.types.get_bucket_location_output.GetBucketLocationOutput, zapros.Response
]:
...
async def async_get_bucket_location(
