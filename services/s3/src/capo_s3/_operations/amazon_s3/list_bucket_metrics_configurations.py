"""Generated from Smithy shape ``com.amazonaws.s3#ListBucketMetricsConfigurations``."""
...
import capo_s3.types.list_bucket_metrics_configurations_output
import capo_s3.types.list_bucket_metrics_configurations_request
import capo_s3.types.metrics_configuration_list
...
) -> capo_s3.types.list_bucket_metrics_configurations_output.ListBucketMetricsConfigurationsOutput:
    out: capo_s3.types.list_bucket_metrics_configurations_output.ListBucketMetricsConfigurationsOutput = capo_s3.types.list_bucket_metrics_configurations_output.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "?metrics&x-id=ListBucketMetricsConfigurations"
...
async def async_list_bucket_metrics_configurations(
