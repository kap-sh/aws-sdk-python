...
import capo_s3.types.get_bucket_logging_output
import capo_s3.types.get_bucket_logging_request
...
) -> capo_s3.types.get_bucket_logging_output.GetBucketLoggingOutput:
    out: capo_s3.types.get_bucket_logging_output.GetBucketLoggingOutput = (
        capo_s3.types.get_bucket_logging_output.deserialize_xml(
...
def get_bucket_logging(
    ...
    capo_s3.types.get_bucket_logging_output.GetBucketLoggingOutput, zapros.Response
]:
