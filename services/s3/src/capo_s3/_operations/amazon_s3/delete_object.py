...
import capo_s3.types.if_match_last_modified_time
...
) -> capo_s3.types.delete_object_output.DeleteObjectOutput:
    out: capo_s3.types.delete_object_output.DeleteObjectOutput = {}  # type: ignore[typeddict-item]
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/{Key+}?x-id=DeleteObject"
