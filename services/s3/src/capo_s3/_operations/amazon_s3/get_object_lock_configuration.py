...
import capo_s3.types.get_object_lock_configuration_output
import capo_s3.types.get_object_lock_configuration_request
...
def handle_response(
    ...
    capo_s3.types.get_object_lock_configuration_output.GetObjectLockConfigurationOutput
):
    out: capo_s3.types.get_object_lock_configuration_output.GetObjectLockConfigurationOutput = {
        "object_lock_configuration": capo_s3.types.object_lock_configuration.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "?object-lock"
