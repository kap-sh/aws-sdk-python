"""Generated from Smithy shape ``com.amazonaws.s3#ListDirectoryBuckets``."""
...
import capo_s3.types.list_directory_buckets_output
...
) -> capo_s3.types.list_directory_buckets_output.ListDirectoryBucketsOutput:
    out: capo_s3.types.list_directory_buckets_output.ListDirectoryBucketsOutput = (
        capo_s3.types.list_directory_buckets_output.deserialize_xml(
