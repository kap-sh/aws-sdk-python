"""Generated from Smithy shape ``com.amazonaws.s3#PutBucketAnalyticsConfiguration``."""
...
import capo_s3.types.put_bucket_analytics_configuration_request
...
def build_request(
    ...
    capo_s3.types.analytics_configuration.serialize_xml(
