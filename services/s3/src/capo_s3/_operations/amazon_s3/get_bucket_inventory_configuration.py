...
import capo_s3.types.get_bucket_inventory_configuration_output
import capo_s3.types.get_bucket_inventory_configuration_request
...
) -> capo_s3.types.get_bucket_inventory_configuration_output.GetBucketInventoryConfigurationOutput:
    out: capo_s3.types.get_bucket_inventory_configuration_output.GetBucketInventoryConfigurationOutput = {
        "inventory_configuration": capo_s3.types.inventory_configuration.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "?inventory&x-id=GetBucketInventoryConfiguration"
