"""Generated from Smithy shape ``com.amazonaws.s3#PutBucketInventoryConfiguration``."""
...
import capo_s3.types.put_bucket_inventory_configuration_request
...
async def async_put_bucket_inventory_configuration(
