...
) -> capo_s3.types.list_bucket_inventory_configurations_output.ListBucketInventoryConfigurationsOutput:
    out: capo_s3.types.list_bucket_inventory_configurations_output.ListBucketInventoryConfigurationsOutput = capo_s3.types.list_bucket_inventory_configurations_output.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "?inventory&x-id=ListBucketInventoryConfigurations"
