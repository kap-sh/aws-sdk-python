"""Generated from Smithy shape ``com.amazonaws.s3#PutObjectRetention``."""
...
import capo_s3.types.put_object_retention_output
import capo_s3.types.put_object_retention_request
...
) -> capo_s3.types.put_object_retention_output.PutObjectRetentionOutput:
    out: capo_s3.types.put_object_retention_output.PutObjectRetentionOutput = {}  # type: ignore[typeddict-item]
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/{Key+}?retention"
    ...
    if "retention" in input_:
        ...
        capo_s3.types.object_lock_retention.serialize_xml(
...
def put_object_retention(
    ...
    capo_s3.types.put_object_retention_output.PutObjectRetentionOutput, zapros.Response
]:
...
async def async_put_object_retention(
