"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketNotificationConfiguration``."""
...
import capo_s3.types.event_bridge_configuration
import capo_s3.types.get_bucket_notification_configuration_request
import capo_s3.types.lambda_function_configuration_list
import capo_s3.types.notification_configuration
import capo_s3.types.queue_configuration_list
import capo_s3.types.topic_configuration_list
...
) -> capo_s3.types.notification_configuration.NotificationConfiguration:
    out: capo_s3.types.notification_configuration.NotificationConfiguration = (
        capo_s3.types.notification_configuration.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?notification"
...
def get_bucket_notification_configuration(
    ...
    capo_s3.types.notification_configuration.NotificationConfiguration, zapros.Response
]:
...
async def async_get_bucket_notification_configuration(
