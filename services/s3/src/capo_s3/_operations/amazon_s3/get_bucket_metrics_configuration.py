...
import capo_s3.types.get_bucket_metrics_configuration_output
import capo_s3.types.get_bucket_metrics_configuration_request
...
) -> capo_s3.types.get_bucket_metrics_configuration_output.GetBucketMetricsConfigurationOutput:
    out: capo_s3.types.get_bucket_metrics_configuration_output.GetBucketMetricsConfigurationOutput = {
        "metrics_configuration": capo_s3.types.metrics_configuration.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "?metrics&x-id=GetBucketMetricsConfiguration"
