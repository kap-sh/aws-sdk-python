"""Generated from Smithy shape ``com.amazonaws.s3#GetObjectTagging``."""
...
import capo_s3.types.get_object_tagging_output
import capo_s3.types.get_object_tagging_request
...
) -> capo_s3.types.get_object_tagging_output.GetObjectTaggingOutput:
    out: capo_s3.types.get_object_tagging_output.GetObjectTaggingOutput = (
        capo_s3.types.get_object_tagging_output.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/{Key+}?tagging"
...
def get_object_tagging(
    ...
    capo_s3.types.get_object_tagging_output.GetObjectTaggingOutput, zapros.Response
]:
