"""Generated from Smithy shape ``com.amazonaws.s3#DeleteBucketPolicy``."""
...
import capo_s3.types.delete_bucket_policy_request
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "?policy"
...
async def async_delete_bucket_policy(
