"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketLifecycleConfiguration``."""
...
import capo_s3.types.get_bucket_lifecycle_configuration_output
import capo_s3.types.get_bucket_lifecycle_configuration_request
...
) -> capo_s3.types.get_bucket_lifecycle_configuration_output.GetBucketLifecycleConfigurationOutput:
    out: capo_s3.types.get_bucket_lifecycle_configuration_output.GetBucketLifecycleConfigurationOutput = capo_s3.types.get_bucket_lifecycle_configuration_output.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "?lifecycle"
