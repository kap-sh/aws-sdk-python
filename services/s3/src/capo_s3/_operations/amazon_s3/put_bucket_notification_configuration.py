"""Generated from Smithy shape ``com.amazonaws.s3#PutBucketNotificationConfiguration``."""
...
import capo_s3.types.put_bucket_notification_configuration_request
...
def build_request(
    ...
    if "skip_destination_validation" in input_:
        headers["x-amz-skip-destination-validation"] = (
            "true" if input_["skip_destination_validation"] else "false"
        )
    payload_root = Element("_")
    capo_s3.types.notification_configuration.serialize_xml(
        input_["notification_configuration"], payload_root, "NotificationConfiguration"
    )
...
async def async_put_bucket_notification_configuration(
