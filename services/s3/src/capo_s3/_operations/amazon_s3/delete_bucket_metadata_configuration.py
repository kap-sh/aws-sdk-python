"""Generated from Smithy shape ``com.amazonaws.s3#DeleteBucketMetadataConfiguration``."""
...
import capo_s3.types.delete_bucket_metadata_configuration_request
...
async def async_delete_bucket_metadata_configuration(
