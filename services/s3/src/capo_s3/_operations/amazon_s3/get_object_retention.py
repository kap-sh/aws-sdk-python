"""Generated from Smithy shape ``com.amazonaws.s3#GetObjectRetention``."""
...
import capo_s3.types.get_object_retention_output
import capo_s3.types.get_object_retention_request
...
) -> capo_s3.types.get_object_retention_output.GetObjectRetentionOutput:
    out: capo_s3.types.get_object_retention_output.GetObjectRetentionOutput = {
        "retention": capo_s3.types.object_lock_retention.deserialize_xml(
...
def get_object_retention(
    ...
    capo_s3.types.get_object_retention_output.GetObjectRetentionOutput, zapros.Response
]:
