"""Generated from Smithy shape ``com.amazonaws.s3#DeleteBucketIntelligentTieringConfiguration``."""
...
import capo_s3.types.delete_bucket_intelligent_tiering_configuration_request
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "?intelligent-tiering"
...
async def async_delete_bucket_intelligent_tiering_configuration(
