"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketOwnershipControls``."""
...
import capo_s3.types.get_bucket_ownership_controls_output
import capo_s3.types.get_bucket_ownership_controls_request
...
def handle_response(
    ...
    capo_s3.types.get_bucket_ownership_controls_output.GetBucketOwnershipControlsOutput
):
    out: capo_s3.types.get_bucket_ownership_controls_output.GetBucketOwnershipControlsOutput = {
        "ownership_controls": capo_s3.types.ownership_controls.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?ownershipControls"
...
async def async_get_bucket_ownership_controls(
