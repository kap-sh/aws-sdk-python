...
import capo_s3.types.get_bucket_metadata_configuration_output
import capo_s3.types.get_bucket_metadata_configuration_request
import capo_s3.types.get_bucket_metadata_configuration_result
...
) -> capo_s3.types.get_bucket_metadata_configuration_output.GetBucketMetadataConfigurationOutput:
    out: capo_s3.types.get_bucket_metadata_configuration_output.GetBucketMetadataConfigurationOutput = {
        "get_bucket_metadata_configuration_result": capo_s3.types.get_bucket_metadata_configuration_result.deserialize_xml(
