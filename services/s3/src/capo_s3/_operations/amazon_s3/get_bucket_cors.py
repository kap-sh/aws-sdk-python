...
import capo_s3.types.get_bucket_cors_output
import capo_s3.types.get_bucket_cors_request
...
) -> capo_s3.types.get_bucket_cors_output.GetBucketCorsOutput:
    out: capo_s3.types.get_bucket_cors_output.GetBucketCorsOutput = (
        capo_s3.types.get_bucket_cors_output.deserialize_xml(
...
def get_bucket_cors(
    ...
    input_: capo_s3.types.get_bucket_cors_request.GetBucketCorsRequest,
) -> tuple[capo_s3.types.get_bucket_cors_output.GetBucketCorsOutput, zapros.Response]:
