...
import capo_s3.types.list_buckets_output
import capo_s3.types.list_buckets_request
...
) -> capo_s3.types.list_buckets_output.ListBucketsOutput:
    out: capo_s3.types.list_buckets_output.ListBucketsOutput = (
        capo_s3.types.list_buckets_output.deserialize_xml(fromstring(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_s3.types.list_buckets_output.ListBucketsOutput = (
        capo_s3.types.list_buckets_output.deserialize_xml(
...
def build_request(
    ...
    if "max_buckets" in input_:
        params.append(("max-buckets", str(input_["max_buckets"])))
    ...
    if "bucket_region" in input_:
        params.append(("bucket-region", input_["bucket_region"]))
...
def list_buckets(
    ...
    input_: capo_s3.types.list_buckets_request.ListBucketsRequest,
) -> tuple[capo_s3.types.list_buckets_output.ListBucketsOutput, zapros.Response]:
