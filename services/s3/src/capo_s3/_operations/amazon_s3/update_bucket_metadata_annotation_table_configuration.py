"""Generated from Smithy shape ``com.amazonaws.s3#UpdateBucketMetadataAnnotationTableConfiguration``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?metadataAnnotationTable"
    ...
    capo_s3.types.annotation_table_configuration_updates.serialize_xml(
        input_["annotation_table_configuration"],
        payload_root,
...
async def async_update_bucket_metadata_annotation_table_configuration(
