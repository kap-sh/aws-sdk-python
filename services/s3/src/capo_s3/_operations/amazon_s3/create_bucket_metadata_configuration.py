"""Generated from Smithy shape ``com.amazonaws.s3#CreateBucketMetadataConfiguration``."""
...
import capo_s3.types.metadata_configuration
...
def build_request(
    ...
    if "metadata_configuration" in input_:
        payload_root = Element("_")
        capo_s3.types.metadata_configuration.serialize_xml(
            input_["metadata_configuration"], payload_root, "MetadataConfiguration"
        )
...
async def async_create_bucket_metadata_configuration(
