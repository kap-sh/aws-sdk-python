...
import capo_s3.types.analytics_configuration_list
import capo_s3.types.list_bucket_analytics_configurations_output
import capo_s3.types.list_bucket_analytics_configurations_request
...
) -> capo_s3.types.list_bucket_analytics_configurations_output.ListBucketAnalyticsConfigurationsOutput:
    out: capo_s3.types.list_bucket_analytics_configurations_output.ListBucketAnalyticsConfigurationsOutput = capo_s3.types.list_bucket_analytics_configurations_output.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "?analytics&x-id=ListBucketAnalyticsConfigurations"
