"""Generated from Smithy shape ``com.amazonaws.s3#ListObjectVersions``."""
...
) -> capo_s3.types.list_object_versions_output.ListObjectVersionsOutput:
    out: capo_s3.types.list_object_versions_output.ListObjectVersionsOutput = (
        capo_s3.types.list_object_versions_output.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "?versions"
...
def list_object_versions(
    ...
    capo_s3.types.list_object_versions_output.ListObjectVersionsOutput, zapros.Response
]:
