"""Generated from Smithy shape ``com.amazonaws.s3#PutObjectLockConfiguration``."""
...
import capo_s3.types.put_object_lock_configuration_request
...
def handle_response(
    ...
    out: capo_s3.types.put_object_lock_configuration_output.PutObjectLockConfigurationOutput = {}  # type: ignore[typeddict-item]
...
def build_request(
    ...
    if "token" in input_:
        headers["x-amz-bucket-object-lock-token"] = input_["token"]
