...
import capo_s3.types.get_bucket_abac_output
import capo_s3.types.get_bucket_abac_request
...
) -> capo_s3.types.get_bucket_abac_output.GetBucketAbacOutput:
    out: capo_s3.types.get_bucket_abac_output.GetBucketAbacOutput = {
        "abac_status": capo_s3.types.abac_status.deserialize_xml(
...
def get_bucket_abac(
    ...
    input_: capo_s3.types.get_bucket_abac_request.GetBucketAbacRequest,
) -> tuple[capo_s3.types.get_bucket_abac_output.GetBucketAbacOutput, zapros.Response]:
