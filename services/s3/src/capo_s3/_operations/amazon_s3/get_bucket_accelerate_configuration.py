...
import capo_s3.types.get_bucket_accelerate_configuration_output
import capo_s3.types.get_bucket_accelerate_configuration_request
...
) -> capo_s3.types.get_bucket_accelerate_configuration_output.GetBucketAccelerateConfigurationOutput:
    out: capo_s3.types.get_bucket_accelerate_configuration_output.GetBucketAccelerateConfigurationOutput = capo_s3.types.get_bucket_accelerate_configuration_output.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "?accelerate"
