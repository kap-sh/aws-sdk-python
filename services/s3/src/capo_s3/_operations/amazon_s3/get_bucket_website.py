...
import capo_s3.types.get_bucket_website_output
...
) -> capo_s3.types.get_bucket_website_output.GetBucketWebsiteOutput:
    out: capo_s3.types.get_bucket_website_output.GetBucketWebsiteOutput = (
        capo_s3.types.get_bucket_website_output.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "?website"
...
def get_bucket_website(
    ...
    capo_s3.types.get_bucket_website_output.GetBucketWebsiteOutput, zapros.Response
]:
