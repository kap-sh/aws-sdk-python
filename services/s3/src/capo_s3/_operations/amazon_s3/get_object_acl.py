...
) -> capo_s3.types.get_object_acl_output.GetObjectAclOutput:
    out: capo_s3.types.get_object_acl_output.GetObjectAclOutput = (
        capo_s3.types.get_object_acl_output.deserialize_xml(fromstring(response.read()))
    )
...
async def async_handle_response(
    ...
    out: capo_s3.types.get_object_acl_output.GetObjectAclOutput = (
        capo_s3.types.get_object_acl_output.deserialize_xml(
...
def get_object_acl(
    ...
    input_: capo_s3.types.get_object_acl_request.GetObjectAclRequest,
) -> tuple[capo_s3.types.get_object_acl_output.GetObjectAclOutput, zapros.Response]:
