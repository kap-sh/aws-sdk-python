...
import capo_s3.types.get_bucket_policy_status_output
import capo_s3.types.get_bucket_policy_status_request
...
) -> capo_s3.types.get_bucket_policy_status_output.GetBucketPolicyStatusOutput:
    out: capo_s3.types.get_bucket_policy_status_output.GetBucketPolicyStatusOutput = {
        "policy_status": capo_s3.types.policy_status.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "?policyStatus"
