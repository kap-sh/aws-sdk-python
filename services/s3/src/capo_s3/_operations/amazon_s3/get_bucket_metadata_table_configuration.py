"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketMetadataTableConfiguration``."""
...
import capo_s3.types.get_bucket_metadata_table_configuration_output
import capo_s3.types.get_bucket_metadata_table_configuration_request
...
) -> capo_s3.types.get_bucket_metadata_table_configuration_output.GetBucketMetadataTableConfigurationOutput:
    out: capo_s3.types.get_bucket_metadata_table_configuration_output.GetBucketMetadataTableConfigurationOutput = {
        "get_bucket_metadata_table_configuration_result": capo_s3.types.get_bucket_metadata_table_configuration_result.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "?metadataTable"
...
async def async_get_bucket_metadata_table_configuration(
