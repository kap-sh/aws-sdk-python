...
import capo_s3.types.get_bucket_encryption_output
import capo_s3.types.get_bucket_encryption_request
...
) -> capo_s3.types.get_bucket_encryption_output.GetBucketEncryptionOutput:
    out: capo_s3.types.get_bucket_encryption_output.GetBucketEncryptionOutput = {
        "server_side_encryption_configuration": capo_s3.types.server_side_encryption_configuration.deserialize_xml(
