"""Generated from Smithy shape ``com.amazonaws.s3#DeleteBucketEncryption``."""
...
import capo_s3.types.delete_bucket_encryption_request
...
async def async_delete_bucket_encryption(
