...
import capo_s3.types.get_bucket_acl_output
import capo_s3.types.get_bucket_acl_request
...
def handle_response(
    ...
    out: capo_s3.types.get_bucket_acl_output.GetBucketAclOutput = (
        capo_s3.types.get_bucket_acl_output.deserialize_xml(fromstring(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_s3.types.get_bucket_acl_output.GetBucketAclOutput = (
        capo_s3.types.get_bucket_acl_output.deserialize_xml(
...
def get_bucket_acl(
    ...
    input_: capo_s3.types.get_bucket_acl_request.GetBucketAclRequest,
) -> tuple[capo_s3.types.get_bucket_acl_output.GetBucketAclOutput, zapros.Response]:
