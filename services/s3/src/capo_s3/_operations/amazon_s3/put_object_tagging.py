...
import capo_s3.types.put_object_tagging_request
...
) -> capo_s3.types.put_object_tagging_output.PutObjectTaggingOutput:
    out: capo_s3.types.put_object_tagging_output.PutObjectTaggingOutput = {}  # type: ignore[typeddict-item]
...
def put_object_tagging(
    ...
    capo_s3.types.put_object_tagging_output.PutObjectTaggingOutput, zapros.Response
]:
