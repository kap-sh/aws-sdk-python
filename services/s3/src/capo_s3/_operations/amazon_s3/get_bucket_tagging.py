...
import capo_s3.types.get_bucket_tagging_output
import capo_s3.types.get_bucket_tagging_request
...
) -> capo_s3.types.get_bucket_tagging_output.GetBucketTaggingOutput:
    out: capo_s3.types.get_bucket_tagging_output.GetBucketTaggingOutput = (
        capo_s3.types.get_bucket_tagging_output.deserialize_xml(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "?tagging"
...
def get_bucket_tagging(
    ...
    capo_s3.types.get_bucket_tagging_output.GetBucketTaggingOutput, zapros.Response
]:
