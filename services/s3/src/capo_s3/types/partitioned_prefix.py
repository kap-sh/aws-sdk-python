...
if TYPE_CHECKING:
    import capo_s3.types.partition_date_source


class PartitionedPrefix(TypedDict, closed=True):
    partition_date_source: NotRequired[
        "capo_s3.types.partition_date_source.PartitionDateSource"
    ]
...
def serialize_xml(value: PartitionedPrefix, parent: Element, tag: str) -> None:
    ...
    if "partition_date_source" in value:
        ...
        capo_s3.types.partition_date_source.serialize_xml(
...
def deserialize_xml(el: Element) -> PartitionedPrefix:
    ...
    if child_partition_date_source is not None:
        ...
        out["partition_date_source"] = (
            capo_s3.types.partition_date_source.deserialize_xml(
