...
if TYPE_CHECKING:
    import capo_s3.types.event

EventList: TypeAlias = list["capo_s3.types.event.Event"]
...
def serialize_xml(value: EventList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3.types.event.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> EventList:
    ...
    for child in el.findall("member"):
        out.append(capo_s3.types.event.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: EventList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3.types.event.serialize_xml(item, parent, tag)
