...
if TYPE_CHECKING:
    import capo_s3.types.bytes_processed
    import capo_s3.types.bytes_returned
    import capo_s3.types.bytes_scanned


class Stats(TypedDict, closed=True):
    bytes_scanned: NotRequired["capo_s3.types.bytes_scanned.BytesScanned"]
    """<p>The total number of object bytes scanned.</p>"""
    bytes_processed: NotRequired["capo_s3.types.bytes_processed.BytesProcessed"]
    """<p>The total number of uncompressed object bytes processed.</p>"""
    bytes_returned: NotRequired["capo_s3.types.bytes_returned.BytesReturned"]
    """<p>The total number of bytes of records payload data returned.</p>"""


# --- restXml ser/de ---
def serialize_xml(value: Stats, parent: Element, tag: str) -> None:
...
def deserialize_xml(el: Element) -> Stats:
