...
class ListBucketAnalyticsConfigurationsOutput(TypedDict, closed=True):
    ...
    analytics_configuration_list: NotRequired[
        "capo_s3.types.analytics_configuration_list.AnalyticsConfigurationList"
    ]
...
def serialize_xml(
    ...
    if "analytics_configuration_list" in value:
        ...
        capo_s3.types.analytics_configuration_list.serialize_xml_flat(
...
def deserialize_xml(el: Element) -> ListBucketAnalyticsConfigurationsOutput:
    ...
    if el.find("AnalyticsConfiguration") is not None:
        ...
        out["analytics_configuration_list"] = (
            capo_s3.types.analytics_configuration_list.deserialize_xml_flat(
