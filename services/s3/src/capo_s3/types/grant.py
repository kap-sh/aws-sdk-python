...
def serialize_xml(value: Grant, parent: Element, tag: str) -> None:
    ...
    if "permission" in value:
        ...
        capo_s3.types.permission.serialize_xml(value["permission"], el, "Permission")
...
def deserialize_xml(el: Element) -> Grant:
    ...
    if child_permission is not None:
        ...
        out["permission"] = capo_s3.types.permission.deserialize_xml(child_permission)
    return out
