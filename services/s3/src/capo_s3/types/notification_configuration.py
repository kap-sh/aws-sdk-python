...
class NotificationConfiguration(TypedDict, closed=True):
    topic_configurations: NotRequired[
        "capo_s3.types.topic_configuration_list.TopicConfigurationList"
    ]
    ...
    queue_configurations: NotRequired[
        "capo_s3.types.queue_configuration_list.QueueConfigurationList"
    ]
    ...
    lambda_function_configurations: NotRequired[
        "capo_s3.types.lambda_function_configuration_list.LambdaFunctionConfigurationList"
    ]
    ...
    event_bridge_configuration: NotRequired[
        "capo_s3.types.event_bridge_configuration.EventBridgeConfiguration"
    ]
...
def deserialize_xml(el: Element) -> NotificationConfiguration:
    ...
    if el.find("TopicConfiguration") is not None:
        ...
        out["topic_configurations"] = (
            capo_s3.types.topic_configuration_list.deserialize_xml_flat(
    ...
    if el.find("QueueConfiguration") is not None:
        ...
        out["queue_configurations"] = (
            capo_s3.types.queue_configuration_list.deserialize_xml_flat(
    ...
    if el.find("CloudFunctionConfiguration") is not None:
        ...
        out["lambda_function_configurations"] = (
            capo_s3.types.lambda_function_configuration_list.deserialize_xml_flat(
    ...
    if child_event_bridge_configuration is not None:
        ...
        out["event_bridge_configuration"] = (
            capo_s3.types.event_bridge_configuration.deserialize_xml(
