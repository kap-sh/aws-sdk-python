"""Generated from Smithy shape ``com.amazonaws.s3#DeleteBucketMetricsConfigurationRequest``."""
...
# --- restXml ser/de ---
def serialize_xml(
    value: DeleteBucketMetricsConfigurationRequest, parent: Element, tag: str
) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> DeleteBucketMetricsConfigurationRequest:
    out: DeleteBucketMetricsConfigurationRequest = {}  # type: ignore[typeddict-item]
    return out
