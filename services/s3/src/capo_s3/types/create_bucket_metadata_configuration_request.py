...
class CreateBucketMetadataConfigurationRequest(TypedDict, closed=True):
    ...
    metadata_configuration: "capo_s3.types.metadata_configuration.MetadataConfiguration"
...
def deserialize_xml(el: Element) -> CreateBucketMetadataConfigurationRequest:
    ...
    if child_metadata_configuration is not None:
        ...
        out["metadata_configuration"] = (
            capo_s3.types.metadata_configuration.deserialize_xml(
