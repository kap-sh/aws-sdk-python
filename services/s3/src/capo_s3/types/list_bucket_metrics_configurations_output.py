...
class ListBucketMetricsConfigurationsOutput(TypedDict, closed=True):
    ...
    metrics_configuration_list: NotRequired[
        "capo_s3.types.metrics_configuration_list.MetricsConfigurationList"
    ]
...
def serialize_xml(
    ...
    if "metrics_configuration_list" in value:
        ...
        capo_s3.types.metrics_configuration_list.serialize_xml_flat(
...
def deserialize_xml(el: Element) -> ListBucketMetricsConfigurationsOutput:
    ...
    if el.find("MetricsConfiguration") is not None:
        ...
        out["metrics_configuration_list"] = (
            capo_s3.types.metrics_configuration_list.deserialize_xml_flat(
