...
if TYPE_CHECKING:
    import capo_s3.types.object_part

PartsList: TypeAlias = list["capo_s3.types.object_part.ObjectPart"]
...
def serialize_xml(value: PartsList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3.types.object_part.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> PartsList:
    ...
    for child in el.findall("member"):
        out.append(capo_s3.types.object_part.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: PartsList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3.types.object_part.serialize_xml(item, parent, tag)
