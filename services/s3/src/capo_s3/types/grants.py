...
if TYPE_CHECKING:
    import capo_s3.types.grant

Grants: TypeAlias = list["capo_s3.types.grant.Grant"]
...
def serialize_xml(value: Grants, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3.types.grant.serialize_xml(item, el, "Grant")
...
def deserialize_xml(el: Element) -> Grants:
    ...
    for child in el.findall("Grant"):
        out.append(capo_s3.types.grant.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: Grants, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3.types.grant.serialize_xml(item, parent, tag)
