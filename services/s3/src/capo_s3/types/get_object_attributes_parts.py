...
if TYPE_CHECKING:
    ...
    import capo_s3.types.max_parts
    import capo_s3.types.next_part_number_marker
    import capo_s3.types.part_number_marker
    import capo_s3.types.parts_count
    import capo_s3.types.parts_list


class GetObjectAttributesParts(TypedDict, closed=True):
    total_parts_count: NotRequired["capo_s3.types.parts_count.PartsCount"]
    """<p>The total number of parts.</p>"""
    part_number_marker: NotRequired["capo_s3.types.part_number_marker.PartNumberMarker"]
    """<p>The marker for the current part.</p>"""
    next_part_number_marker: NotRequired[
        "capo_s3.types.next_part_number_marker.NextPartNumberMarker"
    ]
    ...
    max_parts: NotRequired["capo_s3.types.max_parts.MaxParts"]
    ...
    parts: NotRequired["capo_s3.types.parts_list.PartsList"]
...
def serialize_xml(value: GetObjectAttributesParts, parent: Element, tag: str) -> None:
    ...
    if "parts" in value:
        ...
        capo_s3.types.parts_list.serialize_xml_flat(value["parts"], el, "Part")
...
def deserialize_xml(el: Element) -> GetObjectAttributesParts:
    ...
    if el.find("Part") is not None:
        ...
        out["parts"] = capo_s3.types.parts_list.deserialize_xml_flat(el, "Part")
    return out
