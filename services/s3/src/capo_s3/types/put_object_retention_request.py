"""Generated from Smithy shape ``com.amazonaws.s3#PutObjectRetentionRequest``."""
...
class PutObjectRetentionRequest(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(value: PutObjectRetentionRequest, parent: Element, tag: str) -> None:
...
def deserialize_xml(el: Element) -> PutObjectRetentionRequest:
    out: PutObjectRetentionRequest = {}  # type: ignore[typeddict-item]
