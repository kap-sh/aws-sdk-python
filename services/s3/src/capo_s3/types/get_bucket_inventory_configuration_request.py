"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketInventoryConfigurationRequest``."""
...
# --- restXml ser/de ---
def serialize_xml(
    value: GetBucketInventoryConfigurationRequest, parent: Element, tag: str
) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> GetBucketInventoryConfigurationRequest:
    out: GetBucketInventoryConfigurationRequest = {}  # type: ignore[typeddict-item]
    return out
