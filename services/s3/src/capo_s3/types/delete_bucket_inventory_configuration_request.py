"""Generated from Smithy shape ``com.amazonaws.s3#DeleteBucketInventoryConfigurationRequest``."""
...
# --- restXml ser/de ---
def serialize_xml(
    value: DeleteBucketInventoryConfigurationRequest, parent: Element, tag: str
) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> DeleteBucketInventoryConfigurationRequest:
    out: DeleteBucketInventoryConfigurationRequest = {}  # type: ignore[typeddict-item]
    return out
