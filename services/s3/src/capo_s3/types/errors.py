...
if TYPE_CHECKING:
    import capo_s3.types.error

Errors: TypeAlias = list["capo_s3.types.error.Error"]
...
def serialize_xml(value: Errors, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3.types.error.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> Errors:
    ...
    for child in el.findall("member"):
        out.append(capo_s3.types.error.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: Errors, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3.types.error.serialize_xml(item, parent, tag)
