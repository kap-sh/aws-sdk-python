...
class GetObjectAttributesRequest(TypedDict, closed=True):
    ...
    r"""<p>Sets the maximum number of parts to return. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/userguide/mpuoverview.html\">Uploading and copying objects using multipart upload in Amazon S3 </a> in the <i>Amazon Simple Storage Service user guide</i>.</p>"""
    part_number_marker: NotRequired["capo_s3.types.part_number_marker.PartNumberMarker"]
    r"""<p>Specifies the part after which listing should begin. Only parts with higher part numbers will be listed. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonS3/latest/userguide/mpuoverview.html\">Uploading and copying objects using multipart upload in Amazon S3 </a> in the <i>Amazon Simple Storage Service user guide</i>.</p>"""
    ...
    object_attributes: "capo_s3.types.object_attributes_list.ObjectAttributesList"
