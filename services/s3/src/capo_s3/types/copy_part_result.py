"""Generated from Smithy shape ``com.amazonaws.s3#CopyPartResult``."""
...
class CopyPartResult(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(value: CopyPartResult, parent: Element, tag: str) -> None:
...
def deserialize_xml(el: Element) -> CopyPartResult:
    out: CopyPartResult = {}  # type: ignore[typeddict-item]
