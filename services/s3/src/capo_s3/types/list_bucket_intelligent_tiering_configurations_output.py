...
class ListBucketIntelligentTieringConfigurationsOutput(TypedDict, closed=True):
    ...
    intelligent_tiering_configuration_list: NotRequired[
        "capo_s3.types.intelligent_tiering_configuration_list.IntelligentTieringConfigurationList"
    ]
...
def serialize_xml(
    ...
    if "intelligent_tiering_configuration_list" in value:
        ...
        capo_s3.types.intelligent_tiering_configuration_list.serialize_xml_flat(
...
def deserialize_xml(el: Element) -> ListBucketIntelligentTieringConfigurationsOutput:
    ...
    if el.find("IntelligentTieringConfiguration") is not None:
        ...
        out["intelligent_tiering_configuration_list"] = (
            capo_s3.types.intelligent_tiering_configuration_list.deserialize_xml_flat(
