...
if TYPE_CHECKING:
    import capo_s3.types.s3_tables_destination_result


class MetadataTableConfigurationResult(TypedDict, closed=True):
    s3_tables_destination_result: (
        "capo_s3.types.s3_tables_destination_result.S3TablesDestinationResult"
    )
...
def serialize_xml(
    ...
    capo_s3.types.s3_tables_destination_result.serialize_xml(
...
def deserialize_xml(el: Element) -> MetadataTableConfigurationResult:
    ...
    if child_s3_tables_destination_result is not None:
        ...
        out["s3_tables_destination_result"] = (
            capo_s3.types.s3_tables_destination_result.deserialize_xml(
