...
class PutBucketEncryptionRequest(TypedDict, closed=True):
    ...
    server_side_encryption_configuration: "capo_s3.types.server_side_encryption_configuration.ServerSideEncryptionConfiguration"
