"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketNotificationConfigurationRequest``."""
...
class GetBucketNotificationConfigurationRequest(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(
    value: GetBucketNotificationConfigurationRequest, parent: Element, tag: str
) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> GetBucketNotificationConfigurationRequest:
    out: GetBucketNotificationConfigurationRequest = {}  # type: ignore[typeddict-item]
    return out
