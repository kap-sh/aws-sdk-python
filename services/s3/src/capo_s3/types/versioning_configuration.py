"""Generated from Smithy shape ``com.amazonaws.s3#VersioningConfiguration``."""
...
if TYPE_CHECKING:
    ...
    import capo_s3.types.mfa_delete


class VersioningConfiguration(TypedDict, closed=True):
    mfa_delete: NotRequired["capo_s3.types.mfa_delete.MFADelete"]
...
def serialize_xml(value: VersioningConfiguration, parent: Element, tag: str) -> None:
    ...
    if "mfa_delete" in value:
        ...
        capo_s3.types.mfa_delete.serialize_xml(value["mfa_delete"], el, "MfaDelete")
    if "status" in value:
        import capo_s3.types.bucket_versioning_status
...
def deserialize_xml(el: Element) -> VersioningConfiguration:
    ...
    if child_mfa_delete is not None:
        ...
        out["mfa_delete"] = capo_s3.types.mfa_delete.deserialize_xml(child_mfa_delete)
