...
class GetObjectRetentionOutput(TypedDict, closed=True):
    retention: NotRequired["capo_s3.types.object_lock_retention.ObjectLockRetention"]
...
def deserialize_xml(el: Element) -> GetObjectRetentionOutput:
    ...
    if child_retention is not None:
        ...
        out["retention"] = capo_s3.types.object_lock_retention.deserialize_xml(
            child_retention
        )
    return out
