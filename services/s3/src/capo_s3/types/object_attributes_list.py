...
ObjectAttributesList: TypeAlias = list[
    "capo_s3.types.object_attributes.ObjectAttributes"
]
...
def serialize_xml(value: ObjectAttributesList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3.types.object_attributes.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> ObjectAttributesList:
    ...
    for child in el.findall("member"):
        out.append(capo_s3.types.object_attributes.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: ObjectAttributesList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3.types.object_attributes.serialize_xml(item, parent, tag)
