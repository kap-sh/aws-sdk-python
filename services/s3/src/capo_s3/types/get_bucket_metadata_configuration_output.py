...
class GetBucketMetadataConfigurationOutput(TypedDict, closed=True):
    get_bucket_metadata_configuration_result: NotRequired[
        "capo_s3.types.get_bucket_metadata_configuration_result.GetBucketMetadataConfigurationResult"
    ]
...
def serialize_xml(
    ...
    if "get_bucket_metadata_configuration_result" in value:
        ...
        capo_s3.types.get_bucket_metadata_configuration_result.serialize_xml(
...
def deserialize_xml(el: Element) -> GetBucketMetadataConfigurationOutput:
    ...
    if child_get_bucket_metadata_configuration_result is not None:
        ...
        out["get_bucket_metadata_configuration_result"] = (
            capo_s3.types.get_bucket_metadata_configuration_result.deserialize_xml(
