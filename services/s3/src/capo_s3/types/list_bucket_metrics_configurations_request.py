"""Generated from Smithy shape ``com.amazonaws.s3#ListBucketMetricsConfigurationsRequest``."""
...
# --- restXml ser/de ---
def serialize_xml(
    value: ListBucketMetricsConfigurationsRequest, parent: Element, tag: str
) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> ListBucketMetricsConfigurationsRequest:
    out: ListBucketMetricsConfigurationsRequest = {}  # type: ignore[typeddict-item]
    return out
