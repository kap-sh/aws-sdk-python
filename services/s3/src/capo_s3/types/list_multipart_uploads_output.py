...
class ListMultipartUploadsOutput(TypedDict, closed=True):
    ...
    upload_id_marker: NotRequired["capo_s3.types.upload_id_marker.UploadIdMarker"]
    ...
    next_upload_id_marker: NotRequired[
        "capo_s3.types.next_upload_id_marker.NextUploadIdMarker"
    ]
    ...
    max_uploads: NotRequired["capo_s3.types.max_uploads.MaxUploads"]
    ...
    uploads: NotRequired["capo_s3.types.multipart_upload_list.MultipartUploadList"]
...
def serialize_xml(value: ListMultipartUploadsOutput, parent: Element, tag: str) -> None:
    ...
    if "uploads" in value:
        ...
        capo_s3.types.multipart_upload_list.serialize_xml_flat(
...
def deserialize_xml(el: Element) -> ListMultipartUploadsOutput:
    ...
    if el.find("Upload") is not None:
        ...
        out["uploads"] = capo_s3.types.multipart_upload_list.deserialize_xml_flat(
            el, "Upload"
        )
