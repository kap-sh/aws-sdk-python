...
if TYPE_CHECKING:
    import capo_s3.types.ownership_controls_rule

OwnershipControlsRules: TypeAlias = list[
    "capo_s3.types.ownership_controls_rule.OwnershipControlsRule"
]
...
def serialize_xml(value: OwnershipControlsRules, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3.types.ownership_controls_rule.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> OwnershipControlsRules:
    ...
    for child in el.findall("member"):
        out.append(capo_s3.types.ownership_controls_rule.deserialize_xml(child))
    return out
...
def serialize_xml_flat(
    ...
    for item in value:
        ...
        capo_s3.types.ownership_controls_rule.serialize_xml(item, parent, tag)
