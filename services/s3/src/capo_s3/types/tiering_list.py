...
if TYPE_CHECKING:
    import capo_s3.types.tiering

TieringList: TypeAlias = list["capo_s3.types.tiering.Tiering"]
...
def serialize_xml(value: TieringList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3.types.tiering.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> TieringList:
    ...
    for child in el.findall("member"):
        out.append(capo_s3.types.tiering.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: TieringList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3.types.tiering.serialize_xml(item, parent, tag)
