...
if TYPE_CHECKING:
    import capo_s3.types.object

ObjectList: TypeAlias = list["capo_s3.types.object.Object"]
...
def serialize_xml(value: ObjectList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3.types.object.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> ObjectList:
    ...
    for child in el.findall("member"):
        out.append(capo_s3.types.object.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: ObjectList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        capo_s3.types.object.serialize_xml(item, parent, tag)
