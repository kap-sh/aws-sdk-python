"""Generated from Smithy shape ``com.amazonaws.s3#PutPublicAccessBlock``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.put_public_access_block_request
...
def build_request(
    ...
    input: aws_sdk_s3.types.put_public_access_block_request.PutPublicAccessBlockRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?publicAccessBlock"
    ...
    if "public_access_block_configuration" in input:
...
async def async_put_public_access_block(
