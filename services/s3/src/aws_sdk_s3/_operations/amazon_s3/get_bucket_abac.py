"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketAbac``."""
...
import aws_sdk_s3.types.get_bucket_abac_output
import aws_sdk_s3.types.get_bucket_abac_request
...
) -> aws_sdk_s3.types.get_bucket_abac_output.GetBucketAbacOutput:
    out: aws_sdk_s3.types.get_bucket_abac_output.GetBucketAbacOutput = {
        "abac_status": aws_sdk_s3.types.abac_status.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_abac_request.GetBucketAbacRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_bucket_abac(
    ...
    aws_sdk_s3.types.get_bucket_abac_output.GetBucketAbacOutput, zapros.Response
]:
...
async def async_get_bucket_abac(
