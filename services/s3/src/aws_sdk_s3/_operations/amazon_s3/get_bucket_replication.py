"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketReplication``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.get_bucket_replication_output
    import aws_sdk_s3.types.get_bucket_replication_request
...
) -> aws_sdk_s3.types.get_bucket_replication_output.GetBucketReplicationOutput:
    import aws_sdk_s3.types.replication_configuration

    out: aws_sdk_s3.types.get_bucket_replication_output.GetBucketReplicationOutput = {
        "replication_configuration": aws_sdk_s3.types.replication_configuration.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_replication_request.GetBucketReplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?replication"
...
async def async_get_bucket_replication(
