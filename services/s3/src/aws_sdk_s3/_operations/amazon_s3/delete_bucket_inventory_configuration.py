"""Generated from Smithy shape ``com.amazonaws.s3#DeleteBucketInventoryConfiguration``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.delete_bucket_inventory_configuration_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.delete_bucket_inventory_configuration_request.DeleteBucketInventoryConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?inventory"
...
async def async_delete_bucket_inventory_configuration(
