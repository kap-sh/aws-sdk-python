"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketVersioning``."""
...
import aws_sdk_s3.types.get_bucket_versioning_output
import aws_sdk_s3.types.get_bucket_versioning_request
...
) -> aws_sdk_s3.types.get_bucket_versioning_output.GetBucketVersioningOutput:
    out: aws_sdk_s3.types.get_bucket_versioning_output.GetBucketVersioningOutput = (
        aws_sdk_s3.types.get_bucket_versioning_output.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_versioning_request.GetBucketVersioningRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?versioning"
