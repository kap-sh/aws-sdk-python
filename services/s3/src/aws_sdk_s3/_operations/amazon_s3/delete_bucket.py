"""Generated from Smithy shape ``com.amazonaws.s3#DeleteBucket``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.delete_bucket_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.delete_bucket_request.DeleteBucketRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
