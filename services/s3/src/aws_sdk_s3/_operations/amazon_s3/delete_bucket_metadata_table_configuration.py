"""Generated from Smithy shape ``com.amazonaws.s3#DeleteBucketMetadataTableConfiguration``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.delete_bucket_metadata_table_configuration_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.delete_bucket_metadata_table_configuration_request.DeleteBucketMetadataTableConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_bucket_metadata_table_configuration(
