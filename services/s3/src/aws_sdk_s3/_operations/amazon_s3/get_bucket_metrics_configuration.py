"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketMetricsConfiguration``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.get_bucket_metrics_configuration_output
    import aws_sdk_s3.types.get_bucket_metrics_configuration_request
...
) -> aws_sdk_s3.types.get_bucket_metrics_configuration_output.GetBucketMetricsConfigurationOutput:
    import aws_sdk_s3.types.metrics_configuration

    out: aws_sdk_s3.types.get_bucket_metrics_configuration_output.GetBucketMetricsConfigurationOutput = {
        "metrics_configuration": aws_sdk_s3.types.metrics_configuration.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_metrics_configuration_request.GetBucketMetricsConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_bucket_metrics_configuration(
