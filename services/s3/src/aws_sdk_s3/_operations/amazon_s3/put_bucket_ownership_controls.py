"""Generated from Smithy shape ``com.amazonaws.s3#PutBucketOwnershipControls``."""
...
def build_request(
    ...
    input: aws_sdk_s3.types.put_bucket_ownership_controls_request.PutBucketOwnershipControlsRequest,
) -> zapros.Request:
...
async def async_put_bucket_ownership_controls(
