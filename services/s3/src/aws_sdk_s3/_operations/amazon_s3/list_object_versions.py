...
if TYPE_CHECKING:
    import aws_sdk_s3.types.list_object_versions_request
    import aws_sdk_s3.types.list_object_versions_output
...
def handle_response(
    ...
    out: aws_sdk_s3.types.list_object_versions_output.ListObjectVersionsOutput = (
        aws_sdk_s3.types.list_object_versions_output.deserialize_xml(
