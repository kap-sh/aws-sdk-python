...
if TYPE_CHECKING:
    import aws_sdk_s3.types.list_multipart_uploads_output
    import aws_sdk_s3.types.list_multipart_uploads_request
...
) -> aws_sdk_s3.types.list_multipart_uploads_output.ListMultipartUploadsOutput:
    import aws_sdk_s3.types.list_multipart_uploads_output

    out: aws_sdk_s3.types.list_multipart_uploads_output.ListMultipartUploadsOutput = (
        aws_sdk_s3.types.list_multipart_uploads_output.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_s3.types.list_multipart_uploads_request.ListMultipartUploadsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?uploads"
    ...
    if "max_uploads" in input:
        params["max-uploads"] = str(input["max_uploads"])
    if "prefix" in input:
        params["prefix"] = str(input["prefix"])
    if "upload_id_marker" in input:
        params["upload-id-marker"] = str(input["upload_id_marker"])
