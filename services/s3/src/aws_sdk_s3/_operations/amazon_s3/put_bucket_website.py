...
def build_request(
    ...
    input: aws_sdk_s3.types.put_bucket_website_request.PutBucketWebsiteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
