"""Generated from Smithy shape ``com.amazonaws.s3#PutBucketWebsite``."""
...
import aws_sdk_s3.types.put_bucket_website_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.put_bucket_website_request.PutBucketWebsiteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "website_configuration" in input_:
        import aws_sdk_s3.types.website_configuration

        payload_root = Element("_")
        aws_sdk_s3.types.website_configuration.serialize_xml(
            input_["website_configuration"], payload_root, "WebsiteConfiguration"
        )
...
async def async_put_bucket_website(
