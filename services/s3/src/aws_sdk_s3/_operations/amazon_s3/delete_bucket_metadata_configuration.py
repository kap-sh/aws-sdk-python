...
import aws_sdk_s3.types.delete_bucket_metadata_configuration_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.delete_bucket_metadata_configuration_request.DeleteBucketMetadataConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
