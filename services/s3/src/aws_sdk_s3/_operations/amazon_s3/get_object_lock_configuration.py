"""Generated from Smithy shape ``com.amazonaws.s3#GetObjectLockConfiguration``."""
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_object_lock_configuration_request.GetObjectLockConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_object_lock_configuration(
