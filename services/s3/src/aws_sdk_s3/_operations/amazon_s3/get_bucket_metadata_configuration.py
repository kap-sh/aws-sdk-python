"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketMetadataConfiguration``."""
...
import aws_sdk_s3.types.get_bucket_metadata_configuration_output
import aws_sdk_s3.types.get_bucket_metadata_configuration_request
...
) -> aws_sdk_s3.types.get_bucket_metadata_configuration_output.GetBucketMetadataConfigurationOutput:
    out: aws_sdk_s3.types.get_bucket_metadata_configuration_output.GetBucketMetadataConfigurationOutput = {
        "get_bucket_metadata_configuration_result": aws_sdk_s3.types.get_bucket_metadata_configuration_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_metadata_configuration_request.GetBucketMetadataConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?metadataConfiguration"
...
async def async_get_bucket_metadata_configuration(
