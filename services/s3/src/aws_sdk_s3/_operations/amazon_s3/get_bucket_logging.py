"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketLogging``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.get_bucket_logging_output
    import aws_sdk_s3.types.get_bucket_logging_request
...
) -> aws_sdk_s3.types.get_bucket_logging_output.GetBucketLoggingOutput:
    import aws_sdk_s3.types.get_bucket_logging_output

    out: aws_sdk_s3.types.get_bucket_logging_output.GetBucketLoggingOutput = (
        aws_sdk_s3.types.get_bucket_logging_output.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_logging_request.GetBucketLoggingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_bucket_logging(
    ...
    aws_sdk_s3.types.get_bucket_logging_output.GetBucketLoggingOutput, zapros.Response
]:
...
async def async_get_bucket_logging(
