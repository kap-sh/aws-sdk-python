"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketEncryption``."""
...
import aws_sdk_s3.types.get_bucket_encryption_output
import aws_sdk_s3.types.get_bucket_encryption_request
...
) -> aws_sdk_s3.types.get_bucket_encryption_output.GetBucketEncryptionOutput:
    out: aws_sdk_s3.types.get_bucket_encryption_output.GetBucketEncryptionOutput = {
        "server_side_encryption_configuration": aws_sdk_s3.types.server_side_encryption_configuration.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_encryption_request.GetBucketEncryptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?encryption"
...
async def async_get_bucket_encryption(
