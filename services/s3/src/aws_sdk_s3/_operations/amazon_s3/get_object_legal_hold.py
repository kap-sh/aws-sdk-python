...
import aws_sdk_s3.types.get_object_legal_hold_output
import aws_sdk_s3.types.get_object_legal_hold_request
...
) -> aws_sdk_s3.types.get_object_legal_hold_output.GetObjectLegalHoldOutput:
    out: aws_sdk_s3.types.get_object_legal_hold_output.GetObjectLegalHoldOutput = {
        "legal_hold": aws_sdk_s3.types.object_lock_legal_hold.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_object_legal_hold_request.GetObjectLegalHoldRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
