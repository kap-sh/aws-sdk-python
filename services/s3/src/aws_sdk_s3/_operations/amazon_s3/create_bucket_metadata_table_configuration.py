"""Generated from Smithy shape ``com.amazonaws.s3#CreateBucketMetadataTableConfiguration``."""
...
import aws_sdk_s3.types.create_bucket_metadata_table_configuration_request
