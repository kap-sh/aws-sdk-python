...
import aws_sdk_s3.types.get_object_retention_output
import aws_sdk_s3.types.get_object_retention_request
...
def handle_response(
    ...
    out: aws_sdk_s3.types.get_object_retention_output.GetObjectRetentionOutput = {
        "retention": aws_sdk_s3.types.object_lock_retention.deserialize_xml(
