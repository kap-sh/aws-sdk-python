...
if TYPE_CHECKING:
    import aws_sdk_s3.types.put_bucket_inventory_configuration_request
...
def build_request(
    ...
    input: aws_sdk_s3.types.put_bucket_inventory_configuration_request.PutBucketInventoryConfigurationRequest,
) -> zapros.Request:
