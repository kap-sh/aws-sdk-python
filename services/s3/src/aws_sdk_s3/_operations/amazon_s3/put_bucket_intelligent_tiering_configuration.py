"""Generated from Smithy shape ``com.amazonaws.s3#PutBucketIntelligentTieringConfiguration``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.put_bucket_intelligent_tiering_configuration_request
...
def build_request(
    ...
    input: aws_sdk_s3.types.put_bucket_intelligent_tiering_configuration_request.PutBucketIntelligentTieringConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "intelligent_tiering_configuration" in input:
...
async def async_put_bucket_intelligent_tiering_configuration(
