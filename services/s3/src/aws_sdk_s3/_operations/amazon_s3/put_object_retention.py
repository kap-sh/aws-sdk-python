...
if TYPE_CHECKING:
    import aws_sdk_s3.types.put_object_retention_output
    import aws_sdk_s3.types.put_object_retention_request
...
) -> aws_sdk_s3.types.put_object_retention_output.PutObjectRetentionOutput:
    out: aws_sdk_s3.types.put_object_retention_output.PutObjectRetentionOutput = {}  # type: ignore[typeddict-item]
...
def build_request(
    ...
    input: aws_sdk_s3.types.put_object_retention_request.PutObjectRetentionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "retention" in input:
        ...
        aws_sdk_s3.types.object_lock_retention.serialize_xml(
            input["retention"], payload_root, "Retention"
        )
