"""Generated from Smithy shape ``com.amazonaws.s3#PutBucketReplication``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.put_bucket_replication_request
...
def build_request(
    ...
    input: aws_sdk_s3.types.put_bucket_replication_request.PutBucketReplicationRequest,
) -> zapros.Request:
