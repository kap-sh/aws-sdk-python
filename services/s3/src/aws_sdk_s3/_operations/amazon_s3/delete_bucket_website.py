"""Generated from Smithy shape ``com.amazonaws.s3#DeleteBucketWebsite``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.delete_bucket_website_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.delete_bucket_website_request.DeleteBucketWebsiteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_bucket_website(
