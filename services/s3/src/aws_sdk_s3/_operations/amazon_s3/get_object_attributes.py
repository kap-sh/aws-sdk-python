...
if TYPE_CHECKING:
    import aws_sdk_s3.types.get_object_attributes_output
    import aws_sdk_s3.types.get_object_attributes_request
...
) -> aws_sdk_s3.types.get_object_attributes_output.GetObjectAttributesOutput:
    import aws_sdk_s3.types.get_object_attributes_output

    out: aws_sdk_s3.types.get_object_attributes_output.GetObjectAttributesOutput = (
        aws_sdk_s3.types.get_object_attributes_output.deserialize_xml(
...
def build_request(
    ...
    input: aws_sdk_s3.types.get_object_attributes_request.GetObjectAttributesRequest,
) -> zapros.Request:
    ...
    if "max_parts" in input:
        headers["x-amz-max-parts"] = str(input["max_parts"])
    if "part_number_marker" in input:
        headers["x-amz-part-number-marker"] = str(input["part_number_marker"])
    ...
    if "object_attributes" in input:
        headers["x-amz-object-attributes"] = str(input["object_attributes"])
    body: bytes | None = b""
