"""Generated from Smithy shape ``com.amazonaws.s3#PutBucketEncryption``."""
...
import aws_sdk_s3.types.put_bucket_encryption_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.put_bucket_encryption_request.PutBucketEncryptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "server_side_encryption_configuration" in input_:
        import aws_sdk_s3.types.server_side_encryption_configuration
...
async def async_put_bucket_encryption(
