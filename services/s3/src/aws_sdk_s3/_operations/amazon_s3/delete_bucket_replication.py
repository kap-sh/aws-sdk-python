"""Generated from Smithy shape ``com.amazonaws.s3#DeleteBucketReplication``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.delete_bucket_replication_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.delete_bucket_replication_request.DeleteBucketReplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
