...
import aws_sdk_s3.types.get_bucket_location_output
import aws_sdk_s3.types.get_bucket_location_request
...
) -> aws_sdk_s3.types.get_bucket_location_output.GetBucketLocationOutput:
    out: aws_sdk_s3.types.get_bucket_location_output.GetBucketLocationOutput = (
        aws_sdk_s3.types.get_bucket_location_output.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_location_request.GetBucketLocationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_bucket_location(
    ...
    aws_sdk_s3.types.get_bucket_location_output.GetBucketLocationOutput, zapros.Response
]:
