"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketIntelligentTieringConfiguration``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.get_bucket_intelligent_tiering_configuration_output
    import aws_sdk_s3.types.get_bucket_intelligent_tiering_configuration_request
...
) -> aws_sdk_s3.types.get_bucket_intelligent_tiering_configuration_output.GetBucketIntelligentTieringConfigurationOutput:
    import aws_sdk_s3.types.intelligent_tiering_configuration

    out: aws_sdk_s3.types.get_bucket_intelligent_tiering_configuration_output.GetBucketIntelligentTieringConfigurationOutput = {
        "intelligent_tiering_configuration": aws_sdk_s3.types.intelligent_tiering_configuration.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_intelligent_tiering_configuration_request.GetBucketIntelligentTieringConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_bucket_intelligent_tiering_configuration(
