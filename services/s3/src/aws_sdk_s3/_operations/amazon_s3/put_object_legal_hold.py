...
if TYPE_CHECKING:
    import aws_sdk_s3.types.put_object_legal_hold_request
    import aws_sdk_s3.types.put_object_legal_hold_output
...
) -> aws_sdk_s3.types.put_object_legal_hold_output.PutObjectLegalHoldOutput:
    out: aws_sdk_s3.types.put_object_legal_hold_output.PutObjectLegalHoldOutput = {}  # type: ignore[typeddict-item]
...
def build_request(
    ...
    input: aws_sdk_s3.types.put_object_legal_hold_request.PutObjectLegalHoldRequest,
) -> zapros.Request:
