...
import aws_sdk_s3.types.delete_bucket_intelligent_tiering_configuration_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.delete_bucket_intelligent_tiering_configuration_request.DeleteBucketIntelligentTieringConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
