"""Generated from Smithy shape ``com.amazonaws.s3#ListBucketInventoryConfigurations``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.list_bucket_inventory_configurations_output
    import aws_sdk_s3.types.list_bucket_inventory_configurations_request
...
) -> aws_sdk_s3.types.list_bucket_inventory_configurations_output.ListBucketInventoryConfigurationsOutput:
    import aws_sdk_s3.types.list_bucket_inventory_configurations_output

    out: aws_sdk_s3.types.list_bucket_inventory_configurations_output.ListBucketInventoryConfigurationsOutput = aws_sdk_s3.types.list_bucket_inventory_configurations_output.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.list_bucket_inventory_configurations_request.ListBucketInventoryConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_bucket_inventory_configurations(
