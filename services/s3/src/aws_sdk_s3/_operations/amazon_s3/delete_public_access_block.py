"""Generated from Smithy shape ``com.amazonaws.s3#DeletePublicAccessBlock``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.delete_public_access_block_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.delete_public_access_block_request.DeletePublicAccessBlockRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_public_access_block(
