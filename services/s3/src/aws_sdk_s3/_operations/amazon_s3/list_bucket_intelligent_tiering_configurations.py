...
if TYPE_CHECKING:
    import aws_sdk_s3.types.list_bucket_intelligent_tiering_configurations_output
    import aws_sdk_s3.types.list_bucket_intelligent_tiering_configurations_request
...
def handle_response(
    ...
    out: aws_sdk_s3.types.list_bucket_intelligent_tiering_configurations_output.ListBucketIntelligentTieringConfigurationsOutput = aws_sdk_s3.types.list_bucket_intelligent_tiering_configurations_output.deserialize_xml(
