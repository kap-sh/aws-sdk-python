"""Generated from Smithy shape ``com.amazonaws.s3#DeleteObjectTagging``."""
...
import aws_sdk_s3.types.delete_object_tagging_output
import aws_sdk_s3.types.delete_object_tagging_request
...
) -> aws_sdk_s3.types.delete_object_tagging_output.DeleteObjectTaggingOutput:
    out: aws_sdk_s3.types.delete_object_tagging_output.DeleteObjectTaggingOutput = {}  # type: ignore[typeddict-item]
...
def build_request(
    ...
    input_: aws_sdk_s3.types.delete_object_tagging_request.DeleteObjectTaggingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_object_tagging(
