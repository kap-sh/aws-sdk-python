"""Generated from Smithy shape ``com.amazonaws.s3#ListBucketAnalyticsConfigurations``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.list_bucket_analytics_configurations_output
    import aws_sdk_s3.types.list_bucket_analytics_configurations_request
...
) -> aws_sdk_s3.types.list_bucket_analytics_configurations_output.ListBucketAnalyticsConfigurationsOutput:
    import aws_sdk_s3.types.list_bucket_analytics_configurations_output

    out: aws_sdk_s3.types.list_bucket_analytics_configurations_output.ListBucketAnalyticsConfigurationsOutput = aws_sdk_s3.types.list_bucket_analytics_configurations_output.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.list_bucket_analytics_configurations_request.ListBucketAnalyticsConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_bucket_analytics_configurations(
