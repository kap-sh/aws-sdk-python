...
if TYPE_CHECKING:
    import aws_sdk_s3.types.create_bucket_metadata_configuration_request
...
def build_request(
    ...
    input: aws_sdk_s3.types.create_bucket_metadata_configuration_request.CreateBucketMetadataConfigurationRequest,
) -> zapros.Request:
