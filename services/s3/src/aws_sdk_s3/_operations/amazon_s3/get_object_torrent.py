"""Generated from Smithy shape ``com.amazonaws.s3#GetObjectTorrent``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.get_object_torrent_output
    import aws_sdk_s3.types.get_object_torrent_request
...
) -> aws_sdk_s3.types.get_object_torrent_output.GetObjectTorrentOutput:
    _iter = cast(
        Any, response.async_iter_bytes() if is_async else response.iter_bytes()
    )
    out: aws_sdk_s3.types.get_object_torrent_output.GetObjectTorrentOutput = {
        "body": _iter
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_object_torrent_request.GetObjectTorrentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}/{Key+}?torrent"
...
def get_object_torrent(
    ...
    aws_sdk_s3.types.get_object_torrent_output.GetObjectTorrentOutput, zapros.Response
]:
...
async def async_get_object_torrent(
