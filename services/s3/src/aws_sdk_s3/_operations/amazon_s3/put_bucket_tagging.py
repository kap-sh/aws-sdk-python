"""Generated from Smithy shape ``com.amazonaws.s3#PutBucketTagging``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.put_bucket_tagging_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.put_bucket_tagging_request.PutBucketTaggingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
