"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketPolicyStatus``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.get_bucket_policy_status_output
    import aws_sdk_s3.types.get_bucket_policy_status_request
...
) -> aws_sdk_s3.types.get_bucket_policy_status_output.GetBucketPolicyStatusOutput:
    import aws_sdk_s3.types.policy_status

    out: aws_sdk_s3.types.get_bucket_policy_status_output.GetBucketPolicyStatusOutput = {
        "policy_status": aws_sdk_s3.types.policy_status.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_policy_status_request.GetBucketPolicyStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?policyStatus"
...
async def async_get_bucket_policy_status(
