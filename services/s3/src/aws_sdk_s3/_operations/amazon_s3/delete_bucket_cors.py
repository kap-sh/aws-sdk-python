"""Generated from Smithy shape ``com.amazonaws.s3#DeleteBucketCors``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.delete_bucket_cors_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.delete_bucket_cors_request.DeleteBucketCorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_bucket_cors(
