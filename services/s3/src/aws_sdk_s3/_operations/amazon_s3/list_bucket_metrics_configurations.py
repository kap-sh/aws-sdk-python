...
import aws_sdk_s3.types.list_bucket_metrics_configurations_output
import aws_sdk_s3.types.list_bucket_metrics_configurations_request
...
) -> aws_sdk_s3.types.list_bucket_metrics_configurations_output.ListBucketMetricsConfigurationsOutput:
    out: aws_sdk_s3.types.list_bucket_metrics_configurations_output.ListBucketMetricsConfigurationsOutput = aws_sdk_s3.types.list_bucket_metrics_configurations_output.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.list_bucket_metrics_configurations_request.ListBucketMetricsConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
