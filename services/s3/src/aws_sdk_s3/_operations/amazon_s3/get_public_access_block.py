"""Generated from Smithy shape ``com.amazonaws.s3#GetPublicAccessBlock``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.get_public_access_block_output
    import aws_sdk_s3.types.get_public_access_block_request
...
) -> aws_sdk_s3.types.get_public_access_block_output.GetPublicAccessBlockOutput:
    import aws_sdk_s3.types.public_access_block_configuration

    out: aws_sdk_s3.types.get_public_access_block_output.GetPublicAccessBlockOutput = {
        "public_access_block_configuration": aws_sdk_s3.types.public_access_block_configuration.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_public_access_block_request.GetPublicAccessBlockRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
