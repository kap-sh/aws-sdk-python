"""Generated from Smithy shape ``com.amazonaws.s3#PutObjectTagging``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.put_object_tagging_output
    import aws_sdk_s3.types.put_object_tagging_request
...
) -> aws_sdk_s3.types.put_object_tagging_output.PutObjectTaggingOutput:
    out: aws_sdk_s3.types.put_object_tagging_output.PutObjectTaggingOutput = {}  # type: ignore[typeddict-item]
...
def build_request(
    ...
    input: aws_sdk_s3.types.put_object_tagging_request.PutObjectTaggingRequest,
) -> zapros.Request:
    ...
    if "tagging" in input:
        ...
        aws_sdk_s3.types.tagging.serialize_xml(
            input["tagging"], payload_root, "Tagging"
        )
...
def put_object_tagging(
    ...
    aws_sdk_s3.types.put_object_tagging_output.PutObjectTaggingOutput, zapros.Response
]:
...
async def async_put_object_tagging(
