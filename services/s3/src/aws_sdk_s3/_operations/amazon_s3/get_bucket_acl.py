"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketAcl``."""
...
import aws_sdk_s3.types.get_bucket_acl_output
import aws_sdk_s3.types.get_bucket_acl_request
...
) -> aws_sdk_s3.types.get_bucket_acl_output.GetBucketAclOutput:
    out: aws_sdk_s3.types.get_bucket_acl_output.GetBucketAclOutput = (
        aws_sdk_s3.types.get_bucket_acl_output.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_acl_request.GetBucketAclRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_bucket_acl(
    ...
    input_: aws_sdk_s3.types.get_bucket_acl_request.GetBucketAclRequest,
) -> tuple[aws_sdk_s3.types.get_bucket_acl_output.GetBucketAclOutput, zapros.Response]:
...
async def async_get_bucket_acl(
