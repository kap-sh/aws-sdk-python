"""Generated from Smithy shape ``com.amazonaws.s3#UpdateBucketMetadataInventoryTableConfiguration``."""
...
import aws_sdk_s3.types.update_bucket_metadata_inventory_table_configuration_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.update_bucket_metadata_inventory_table_configuration_request.UpdateBucketMetadataInventoryTableConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?metadataInventoryTable"
    ...
    if "inventory_table_configuration" in input_:
        import aws_sdk_s3.types.inventory_table_configuration_updates

        payload_root = Element("_")
        aws_sdk_s3.types.inventory_table_configuration_updates.serialize_xml(
            input_["inventory_table_configuration"],
            payload_root,
...
async def async_update_bucket_metadata_inventory_table_configuration(
