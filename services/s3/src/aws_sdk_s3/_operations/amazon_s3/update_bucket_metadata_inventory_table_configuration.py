...
def build_request(
    ...
    input: aws_sdk_s3.types.update_bucket_metadata_inventory_table_configuration_request.UpdateBucketMetadataInventoryTableConfigurationRequest,
) -> zapros.Request:
    ...
    if "inventory_table_configuration" in input:
