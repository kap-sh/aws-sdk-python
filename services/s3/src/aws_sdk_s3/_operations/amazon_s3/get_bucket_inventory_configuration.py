"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketInventoryConfiguration``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.get_bucket_inventory_configuration_output
    import aws_sdk_s3.types.get_bucket_inventory_configuration_request
...
) -> aws_sdk_s3.types.get_bucket_inventory_configuration_output.GetBucketInventoryConfigurationOutput:
    import aws_sdk_s3.types.inventory_configuration

    out: aws_sdk_s3.types.get_bucket_inventory_configuration_output.GetBucketInventoryConfigurationOutput = {
        "inventory_configuration": aws_sdk_s3.types.inventory_configuration.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_inventory_configuration_request.GetBucketInventoryConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_bucket_inventory_configuration(
