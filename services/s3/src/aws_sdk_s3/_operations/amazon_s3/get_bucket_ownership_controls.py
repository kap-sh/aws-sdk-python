...
import aws_sdk_s3.types.get_bucket_ownership_controls_output
import aws_sdk_s3.types.get_bucket_ownership_controls_request
...
) -> aws_sdk_s3.types.get_bucket_ownership_controls_output.GetBucketOwnershipControlsOutput:
    out: aws_sdk_s3.types.get_bucket_ownership_controls_output.GetBucketOwnershipControlsOutput = {
        "ownership_controls": aws_sdk_s3.types.ownership_controls.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_ownership_controls_request.GetBucketOwnershipControlsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
