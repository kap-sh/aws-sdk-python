...
if TYPE_CHECKING:
    import aws_sdk_s3.types.get_bucket_metadata_table_configuration_output
    import aws_sdk_s3.types.get_bucket_metadata_table_configuration_request
...
) -> aws_sdk_s3.types.get_bucket_metadata_table_configuration_output.GetBucketMetadataTableConfigurationOutput:
    import aws_sdk_s3.types.get_bucket_metadata_table_configuration_result

    out: aws_sdk_s3.types.get_bucket_metadata_table_configuration_output.GetBucketMetadataTableConfigurationOutput = {
        "get_bucket_metadata_table_configuration_result": aws_sdk_s3.types.get_bucket_metadata_table_configuration_result.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_metadata_table_configuration_request.GetBucketMetadataTableConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
