"""Generated from Smithy shape ``com.amazonaws.s3#DeleteBucketAnalyticsConfiguration``."""
...
import aws_sdk_s3.types.delete_bucket_analytics_configuration_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.delete_bucket_analytics_configuration_request.DeleteBucketAnalyticsConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_bucket_analytics_configuration(
