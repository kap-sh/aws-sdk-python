"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketTagging``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.get_bucket_tagging_output
    import aws_sdk_s3.types.get_bucket_tagging_request
...
) -> aws_sdk_s3.types.get_bucket_tagging_output.GetBucketTaggingOutput:
    import aws_sdk_s3.types.get_bucket_tagging_output

    out: aws_sdk_s3.types.get_bucket_tagging_output.GetBucketTaggingOutput = (
        aws_sdk_s3.types.get_bucket_tagging_output.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_tagging_request.GetBucketTaggingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?tagging"
...
def get_bucket_tagging(
    ...
    aws_sdk_s3.types.get_bucket_tagging_output.GetBucketTaggingOutput, zapros.Response
]:
...
async def async_get_bucket_tagging(
