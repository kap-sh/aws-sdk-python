"""Generated from Smithy shape ``com.amazonaws.s3#PutBucketAbac``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.put_bucket_abac_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.put_bucket_abac_request.PutBucketAbacRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?abac"
...
async def async_put_bucket_abac(
