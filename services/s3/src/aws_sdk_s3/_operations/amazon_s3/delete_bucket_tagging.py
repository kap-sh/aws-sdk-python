"""Generated from Smithy shape ``com.amazonaws.s3#DeleteBucketTagging``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.delete_bucket_tagging_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.delete_bucket_tagging_request.DeleteBucketTaggingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
