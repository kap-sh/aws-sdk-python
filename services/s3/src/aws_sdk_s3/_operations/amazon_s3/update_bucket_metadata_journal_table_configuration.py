"""Generated from Smithy shape ``com.amazonaws.s3#UpdateBucketMetadataJournalTableConfiguration``."""
...
import aws_sdk_s3.types.update_bucket_metadata_journal_table_configuration_request
...
def build_request(
    ...
    input_: aws_sdk_s3.types.update_bucket_metadata_journal_table_configuration_request.UpdateBucketMetadataJournalTableConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?metadataJournalTable"
    ...
    if "journal_table_configuration" in input_:
        payload_root = Element("_")
        aws_sdk_s3.types.journal_table_configuration_updates.serialize_xml(
            input_["journal_table_configuration"],
            payload_root,
...
async def async_update_bucket_metadata_journal_table_configuration(
