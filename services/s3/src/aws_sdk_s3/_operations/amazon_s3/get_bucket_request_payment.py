"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketRequestPayment``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.get_bucket_request_payment_output
    import aws_sdk_s3.types.get_bucket_request_payment_request
...
) -> aws_sdk_s3.types.get_bucket_request_payment_output.GetBucketRequestPaymentOutput:
    import aws_sdk_s3.types.get_bucket_request_payment_output

    out: aws_sdk_s3.types.get_bucket_request_payment_output.GetBucketRequestPaymentOutput = aws_sdk_s3.types.get_bucket_request_payment_output.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_request_payment_request.GetBucketRequestPaymentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_bucket_request_payment(
