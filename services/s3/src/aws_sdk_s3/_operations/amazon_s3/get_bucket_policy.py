"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketPolicy``."""
...
import aws_sdk_s3.types.get_bucket_policy_output
import aws_sdk_s3.types.get_bucket_policy_request
...
) -> aws_sdk_s3.types.get_bucket_policy_output.GetBucketPolicyOutput:
    out: aws_sdk_s3.types.get_bucket_policy_output.GetBucketPolicyOutput = {
...
async def async_handle_response(
    ...
    out: aws_sdk_s3.types.get_bucket_policy_output.GetBucketPolicyOutput = {
        "policy": (await response.aread()).decode()
    }  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_policy_request.GetBucketPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_bucket_policy(
    ...
    aws_sdk_s3.types.get_bucket_policy_output.GetBucketPolicyOutput, zapros.Response
]:
