"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketAccelerateConfiguration``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.get_bucket_accelerate_configuration_output
    import aws_sdk_s3.types.get_bucket_accelerate_configuration_request
...
) -> aws_sdk_s3.types.get_bucket_accelerate_configuration_output.GetBucketAccelerateConfigurationOutput:
    import aws_sdk_s3.types.get_bucket_accelerate_configuration_output

    out: aws_sdk_s3.types.get_bucket_accelerate_configuration_output.GetBucketAccelerateConfigurationOutput = aws_sdk_s3.types.get_bucket_accelerate_configuration_output.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_accelerate_configuration_request.GetBucketAccelerateConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_bucket_accelerate_configuration(
