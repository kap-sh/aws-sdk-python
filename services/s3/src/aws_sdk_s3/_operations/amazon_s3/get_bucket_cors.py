"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketCors``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.get_bucket_cors_output
    import aws_sdk_s3.types.get_bucket_cors_request
...
) -> aws_sdk_s3.types.get_bucket_cors_output.GetBucketCorsOutput:
    import aws_sdk_s3.types.get_bucket_cors_output

    out: aws_sdk_s3.types.get_bucket_cors_output.GetBucketCorsOutput = (
        aws_sdk_s3.types.get_bucket_cors_output.deserialize_xml(
...
def build_request(
    ...
    input_: aws_sdk_s3.types.get_bucket_cors_request.GetBucketCorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/{Bucket}?cors"
...
def get_bucket_cors(
    ...
    aws_sdk_s3.types.get_bucket_cors_output.GetBucketCorsOutput, zapros.Response
]:
...
async def async_get_bucket_cors(
