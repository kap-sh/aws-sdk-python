"""Generated from Smithy shape ``com.amazonaws.s3#PutBucketVersioning``."""
...
if TYPE_CHECKING:
    import aws_sdk_s3.types.put_bucket_versioning_request
...
def build_request(
    ...
    input: aws_sdk_s3.types.put_bucket_versioning_request.PutBucketVersioningRequest,
) -> zapros.Request:
