...
if TYPE_CHECKING:
    import aws_sdk_s3.types.analytics_filter
...
class AnalyticsConfiguration(TypedDict):
    ...
    storage_class_analysis: (
        "aws_sdk_s3.types.storage_class_analysis.StorageClassAnalysis"
    )
...
def serialize_xml(value: AnalyticsConfiguration, parent: Element, tag: str) -> None:
    ...
    if "filter" in value:
        ...
        aws_sdk_s3.types.analytics_filter.serialize_xml(value["filter"], el, "Filter")
    import aws_sdk_s3.types.storage_class_analysis

    aws_sdk_s3.types.storage_class_analysis.serialize_xml(
...
def deserialize_xml(el: Element) -> AnalyticsConfiguration:
    ...
    if child_filter is not None:
        ...
        out["filter"] = aws_sdk_s3.types.analytics_filter.deserialize_xml(child_filter)
    ...
    if child_storage_class_analysis is not None:
        ...
        out["storage_class_analysis"] = (
            aws_sdk_s3.types.storage_class_analysis.deserialize_xml(
