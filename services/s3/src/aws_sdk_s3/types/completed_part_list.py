...
if TYPE_CHECKING:
    import aws_sdk_s3.types.completed_part

CompletedPartList: TypeAlias = list["aws_sdk_s3.types.completed_part.CompletedPart"]
...
def serialize_xml(value: CompletedPartList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3.types.completed_part.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> CompletedPartList:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_s3.types.completed_part.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: CompletedPartList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3.types.completed_part.serialize_xml(item, parent, tag)
