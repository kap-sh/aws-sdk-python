...
if TYPE_CHECKING:
    import aws_sdk_s3.types.access_point_alias
    import aws_sdk_s3.types.bucket_location_name
    import aws_sdk_s3.types.location_type
    import aws_sdk_s3.types.region
...
class HeadBucketOutput(TypedDict):
    ...
    bucket_location_type: NotRequired["aws_sdk_s3.types.location_type.LocationType"]
    ...
    bucket_location_name: NotRequired[
        "aws_sdk_s3.types.bucket_location_name.BucketLocationName"
    ]
    ...
    bucket_region: NotRequired["aws_sdk_s3.types.region.Region"]
    """<p>The Region that the bucket is located.</p>"""
    access_point_alias: NotRequired[
        "aws_sdk_s3.types.access_point_alias.AccessPointAlias"
    ]
