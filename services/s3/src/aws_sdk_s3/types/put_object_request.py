...
if TYPE_CHECKING:
    ...
    import aws_sdk_s3.types.tagging_header
...
class PutObjectRequest(TypedDict, closed=True):
    ...
    write_offset_bytes: NotRequired[
        "aws_sdk_s3.types.write_offset_bytes.WriteOffsetBytes"
    ]
