...
class PutBucketPolicyRequest(TypedDict):
    ...
    confirm_remove_self_bucket_access: NotRequired[
        "aws_sdk_s3.types.confirm_remove_self_bucket_access.ConfirmRemoveSelfBucketAccess"
    ]
    ...
    policy: "aws_sdk_s3.types.policy.Policy"
