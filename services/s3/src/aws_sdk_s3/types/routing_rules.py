...
if TYPE_CHECKING:
    import aws_sdk_s3.types.routing_rule

RoutingRules: TypeAlias = list["aws_sdk_s3.types.routing_rule.RoutingRule"]
...
def serialize_xml(value: RoutingRules, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3.types.routing_rule.serialize_xml(item, el, "RoutingRule")
...
def deserialize_xml(el: Element) -> RoutingRules:
    ...
    for child in el.findall("RoutingRule"):
        out.append(aws_sdk_s3.types.routing_rule.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: RoutingRules, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3.types.routing_rule.serialize_xml(item, parent, tag)
