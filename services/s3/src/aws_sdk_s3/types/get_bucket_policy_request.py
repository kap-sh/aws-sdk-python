...
# --- restXml ser/de ---
def serialize_xml(value: GetBucketPolicyRequest, parent: Element, tag: str) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> GetBucketPolicyRequest:
    out: GetBucketPolicyRequest = {}  # type: ignore[typeddict-item]
    return out
