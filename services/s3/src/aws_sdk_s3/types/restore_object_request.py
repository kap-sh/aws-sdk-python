...
class RestoreObjectRequest(TypedDict):
    ...
    restore_request: NotRequired["aws_sdk_s3.types.restore_request.RestoreRequest"]
...
def deserialize_xml(el: Element) -> RestoreObjectRequest:
    ...
    if child_restore_request is not None:
        ...
        out["restore_request"] = aws_sdk_s3.types.restore_request.deserialize_xml(
