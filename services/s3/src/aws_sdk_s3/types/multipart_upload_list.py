...
if TYPE_CHECKING:
    import aws_sdk_s3.types.multipart_upload

MultipartUploadList: TypeAlias = list[
    "aws_sdk_s3.types.multipart_upload.MultipartUpload"
]
...
def serialize_xml(value: MultipartUploadList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3.types.multipart_upload.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> MultipartUploadList:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_s3.types.multipart_upload.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: MultipartUploadList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3.types.multipart_upload.serialize_xml(item, parent, tag)
