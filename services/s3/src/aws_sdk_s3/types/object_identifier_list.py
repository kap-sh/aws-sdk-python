...
if TYPE_CHECKING:
    import aws_sdk_s3.types.object_identifier

ObjectIdentifierList: TypeAlias = list[
    "aws_sdk_s3.types.object_identifier.ObjectIdentifier"
]
...
def serialize_xml(value: ObjectIdentifierList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3.types.object_identifier.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> ObjectIdentifierList:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_s3.types.object_identifier.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: ObjectIdentifierList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3.types.object_identifier.serialize_xml(item, parent, tag)
