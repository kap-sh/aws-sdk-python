...
if TYPE_CHECKING:
    import aws_sdk_s3.types.common_prefix

CommonPrefixList: TypeAlias = list["aws_sdk_s3.types.common_prefix.CommonPrefix"]
...
def serialize_xml(value: CommonPrefixList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3.types.common_prefix.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> CommonPrefixList:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_s3.types.common_prefix.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: CommonPrefixList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3.types.common_prefix.serialize_xml(item, parent, tag)
