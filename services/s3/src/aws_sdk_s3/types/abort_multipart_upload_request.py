...
class AbortMultipartUploadRequest(TypedDict):
    ...
    if_match_initiated_time: NotRequired[
        "aws_sdk_s3.types.if_match_initiated_time.IfMatchInitiatedTime"
    ]
