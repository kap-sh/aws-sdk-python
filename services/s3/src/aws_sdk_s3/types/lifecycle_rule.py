...
if TYPE_CHECKING:
    import aws_sdk_s3.types.abort_incomplete_multipart_upload
    import aws_sdk_s3.types.expiration_status
    import aws_sdk_s3.types.id
    import aws_sdk_s3.types.lifecycle_expiration
    import aws_sdk_s3.types.lifecycle_rule_filter
    import aws_sdk_s3.types.noncurrent_version_expiration
    import aws_sdk_s3.types.noncurrent_version_transition_list
...
class LifecycleRule(TypedDict, closed=True):
    ...
    filter: NotRequired["aws_sdk_s3.types.lifecycle_rule_filter.LifecycleRuleFilter"]
    ...
    status: "aws_sdk_s3.types.expiration_status.ExpirationStatus"
    """<p>If 'Enabled', the rule is currently being applied. If 'Disabled', the rule is not currently being applied.</p>"""
    transitions: NotRequired["aws_sdk_s3.types.transition_list.TransitionList"]
    ...
    noncurrent_version_transitions: NotRequired[
        "aws_sdk_s3.types.noncurrent_version_transition_list.NoncurrentVersionTransitionList"
    ]
    ...
    noncurrent_version_expiration: NotRequired[
        "aws_sdk_s3.types.noncurrent_version_expiration.NoncurrentVersionExpiration"
    ]
    abort_incomplete_multipart_upload: NotRequired[
        "aws_sdk_s3.types.abort_incomplete_multipart_upload.AbortIncompleteMultipartUpload"
    ]
...
def serialize_xml(value: LifecycleRule, parent: Element, tag: str) -> None:
    ...
    if "expiration" in value:
        ...
        aws_sdk_s3.types.lifecycle_expiration.serialize_xml(
    ...
    if "filter" in value:
        ...
        aws_sdk_s3.types.lifecycle_rule_filter.serialize_xml(
            value["filter"], el, "Filter"
        )
    import aws_sdk_s3.types.expiration_status

    aws_sdk_s3.types.expiration_status.serialize_xml(value["status"], el, "Status")
    if "transitions" in value:
        import aws_sdk_s3.types.transition_list

        aws_sdk_s3.types.transition_list.serialize_xml_flat(
            value["transitions"], el, "Transition"
        )
    if "noncurrent_version_transitions" in value:
        import aws_sdk_s3.types.noncurrent_version_transition_list

        aws_sdk_s3.types.noncurrent_version_transition_list.serialize_xml_flat(
            value["noncurrent_version_transitions"], el, "NoncurrentVersionTransition"
        )
    if "noncurrent_version_expiration" in value:
        import aws_sdk_s3.types.noncurrent_version_expiration

        aws_sdk_s3.types.noncurrent_version_expiration.serialize_xml(
            value["noncurrent_version_expiration"], el, "NoncurrentVersionExpiration"
        )
    if "abort_incomplete_multipart_upload" in value:
        import aws_sdk_s3.types.abort_incomplete_multipart_upload

        aws_sdk_s3.types.abort_incomplete_multipart_upload.serialize_xml(
...
def deserialize_xml(el: Element) -> LifecycleRule:
    ...
    if child_expiration is not None:
        ...
        out["expiration"] = aws_sdk_s3.types.lifecycle_expiration.deserialize_xml(
            child_expiration
        )
    child_id = el.find("ID")
    ...
    if child_filter is not None:
        ...
        out["filter"] = aws_sdk_s3.types.lifecycle_rule_filter.deserialize_xml(
            child_filter
        )
    ...
    if child_status is not None:
        ...
        out["status"] = aws_sdk_s3.types.expiration_status.deserialize_xml(child_status)
    else:
        raise DeserializationError("LifecycleRule.status required")
    if el.find("Transition") is not None:
        import aws_sdk_s3.types.transition_list

        out["transitions"] = aws_sdk_s3.types.transition_list.deserialize_xml_flat(
            el, "Transition"
        )
    if el.find("NoncurrentVersionTransition") is not None:
        ...
        out["noncurrent_version_transitions"] = (
            aws_sdk_s3.types.noncurrent_version_transition_list.deserialize_xml_flat(
    ...
    if child_noncurrent_version_expiration is not None:
        ...
        out["noncurrent_version_expiration"] = (
            aws_sdk_s3.types.noncurrent_version_expiration.deserialize_xml(
    ...
    if child_abort_incomplete_multipart_upload is not None:
        ...
        out["abort_incomplete_multipart_upload"] = (
            aws_sdk_s3.types.abort_incomplete_multipart_upload.deserialize_xml(
