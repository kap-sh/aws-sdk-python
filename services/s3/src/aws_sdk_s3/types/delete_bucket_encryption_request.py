"""Generated from Smithy shape ``com.amazonaws.s3#DeleteBucketEncryptionRequest``."""
...
# --- restXml ser/de ---
def serialize_xml(
    value: DeleteBucketEncryptionRequest, parent: Element, tag: str
) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> DeleteBucketEncryptionRequest:
    out: DeleteBucketEncryptionRequest = {}  # type: ignore[typeddict-item]
    return out
