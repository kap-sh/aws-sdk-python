...
class PutBucketRequestPaymentRequest(TypedDict):
    ...
    request_payment_configuration: (
        "aws_sdk_s3.types.request_payment_configuration.RequestPaymentConfiguration"
    )
...
def deserialize_xml(el: Element) -> PutBucketRequestPaymentRequest:
    ...
    if child_request_payment_configuration is not None:
        ...
        out["request_payment_configuration"] = (
            aws_sdk_s3.types.request_payment_configuration.deserialize_xml(
