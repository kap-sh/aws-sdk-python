...
if TYPE_CHECKING:
    import aws_sdk_s3.types.object_lock_enabled
    import aws_sdk_s3.types.object_lock_rule


class ObjectLockConfiguration(TypedDict):
    object_lock_enabled: NotRequired[
        "aws_sdk_s3.types.object_lock_enabled.ObjectLockEnabled"
    ]
    ...
    rule: NotRequired["aws_sdk_s3.types.object_lock_rule.ObjectLockRule"]
...
def serialize_xml(value: ObjectLockConfiguration, parent: Element, tag: str) -> None:
    ...
    if "object_lock_enabled" in value:
        ...
        aws_sdk_s3.types.object_lock_enabled.serialize_xml(
            value["object_lock_enabled"], el, "ObjectLockEnabled"
        )
    if "rule" in value:
        import aws_sdk_s3.types.object_lock_rule

        aws_sdk_s3.types.object_lock_rule.serialize_xml(value["rule"], el, "Rule")
...
def deserialize_xml(el: Element) -> ObjectLockConfiguration:
    ...
    if child_object_lock_enabled is not None:
        ...
        out["object_lock_enabled"] = (
            aws_sdk_s3.types.object_lock_enabled.deserialize_xml(
    ...
    if child_rule is not None:
        ...
        out["rule"] = aws_sdk_s3.types.object_lock_rule.deserialize_xml(child_rule)
    return out
