...
if TYPE_CHECKING:
    ...
    import aws_sdk_s3.types.mfa_delete


class VersioningConfiguration(TypedDict, closed=True):
    mfa_delete: NotRequired["aws_sdk_s3.types.mfa_delete.MFADelete"]
...
def serialize_xml(value: VersioningConfiguration, parent: Element, tag: str) -> None:
    ...
    if "mfa_delete" in value:
        ...
        aws_sdk_s3.types.mfa_delete.serialize_xml(value["mfa_delete"], el, "MfaDelete")
    if "status" in value:
        import aws_sdk_s3.types.bucket_versioning_status
...
def deserialize_xml(el: Element) -> VersioningConfiguration:
    ...
    if child_mfa_delete is not None:
        ...
        out["mfa_delete"] = aws_sdk_s3.types.mfa_delete.deserialize_xml(
            child_mfa_delete
        )
