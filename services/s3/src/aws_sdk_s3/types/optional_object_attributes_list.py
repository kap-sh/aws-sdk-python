...
if TYPE_CHECKING:
    import aws_sdk_s3.types.optional_object_attributes

OptionalObjectAttributesList: TypeAlias = list[
    "aws_sdk_s3.types.optional_object_attributes.OptionalObjectAttributes"
]
...
def serialize_xml(
    ...
    for item in value:
        ...
        aws_sdk_s3.types.optional_object_attributes.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> OptionalObjectAttributesList:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_s3.types.optional_object_attributes.deserialize_xml(child))
    return out
...
def serialize_xml_flat(
    ...
    for item in value:
        ...
        aws_sdk_s3.types.optional_object_attributes.serialize_xml(item, parent, tag)
