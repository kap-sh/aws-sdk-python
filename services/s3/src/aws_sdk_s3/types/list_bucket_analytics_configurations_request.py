...
# --- restXml ser/de ---
def serialize_xml(
    value: ListBucketAnalyticsConfigurationsRequest, parent: Element, tag: str
) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> ListBucketAnalyticsConfigurationsRequest:
    out: ListBucketAnalyticsConfigurationsRequest = {}  # type: ignore[typeddict-item]
    return out
