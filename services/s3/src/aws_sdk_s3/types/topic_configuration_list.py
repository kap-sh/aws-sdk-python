...
if TYPE_CHECKING:
    import aws_sdk_s3.types.topic_configuration

TopicConfigurationList: TypeAlias = list[
    "aws_sdk_s3.types.topic_configuration.TopicConfiguration"
]
...
def serialize_xml(value: TopicConfigurationList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3.types.topic_configuration.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> TopicConfigurationList:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_s3.types.topic_configuration.deserialize_xml(child))
    return out
...
def serialize_xml_flat(
    ...
    for item in value:
        ...
        aws_sdk_s3.types.topic_configuration.serialize_xml(item, parent, tag)
