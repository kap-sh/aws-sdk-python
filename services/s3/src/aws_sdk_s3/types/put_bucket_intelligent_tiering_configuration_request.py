...
class PutBucketIntelligentTieringConfigurationRequest(TypedDict):
    ...
    intelligent_tiering_configuration: "aws_sdk_s3.types.intelligent_tiering_configuration.IntelligentTieringConfiguration"
