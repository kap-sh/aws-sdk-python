...
if TYPE_CHECKING:
    import aws_sdk_s3.types.access_key_id_value
    import aws_sdk_s3.types.session_credential_value
...
class SessionCredentials(TypedDict):
    ...
    secret_access_key: (
        "aws_sdk_s3.types.session_credential_value.SessionCredentialValue"
    )
    ...
    session_token: "aws_sdk_s3.types.session_credential_value.SessionCredentialValue"
    ...
    expiration: "aws_sdk_s3.types.session_expiration.SessionExpiration"
...
def serialize_xml(value: SessionCredentials, parent: Element, tag: str) -> None:
    ...
    aws_sdk_s3.types.session_expiration.serialize_xml(
...
def deserialize_xml(el: Element) -> SessionCredentials:
    ...
    if child_expiration is not None:
        ...
        out["expiration"] = aws_sdk_s3.types.session_expiration.deserialize_xml(
            child_expiration
        )
    else:
