...
if TYPE_CHECKING:
    import aws_sdk_s3.types.replication_time_status
...
def serialize_xml(value: ReplicationTime, parent: Element, tag: str) -> None:
    ...
    aws_sdk_s3.types.replication_time_status.serialize_xml(
        value["status"], el, "Status"
    )
    import aws_sdk_s3.types.replication_time_value

    aws_sdk_s3.types.replication_time_value.serialize_xml(value["time"], el, "Time")
...
def deserialize_xml(el: Element) -> ReplicationTime:
    ...
    if child_status is not None:
        ...
        out["status"] = aws_sdk_s3.types.replication_time_status.deserialize_xml(
            child_status
        )
    else:
    ...
    if child_time is not None:
        ...
        out["time"] = aws_sdk_s3.types.replication_time_value.deserialize_xml(
            child_time
        )
    else:
