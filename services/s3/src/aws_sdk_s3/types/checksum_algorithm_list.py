...
def serialize_xml(value: ChecksumAlgorithmList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3.types.checksum_algorithm.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> ChecksumAlgorithmList:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_s3.types.checksum_algorithm.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: ChecksumAlgorithmList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3.types.checksum_algorithm.serialize_xml(item, parent, tag)
