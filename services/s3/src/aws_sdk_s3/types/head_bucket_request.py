"""Generated from Smithy shape ``com.amazonaws.s3#HeadBucketRequest``."""
...
class HeadBucketRequest(TypedDict, closed=True):
...
# --- restXml ser/de ---
def serialize_xml(value: HeadBucketRequest, parent: Element, tag: str) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> HeadBucketRequest:
    out: HeadBucketRequest = {}  # type: ignore[typeddict-item]
    return out
