...
if TYPE_CHECKING:
    ...
    import aws_sdk_s3.types.creation_date
...
class Bucket(TypedDict):
    ...
    creation_date: NotRequired["aws_sdk_s3.types.creation_date.CreationDate"]
...
def serialize_xml(value: Bucket, parent: Element, tag: str) -> None:
    ...
    if "creation_date" in value:
        ...
        aws_sdk_s3.types.creation_date.serialize_xml(
...
def deserialize_xml(el: Element) -> Bucket:
    ...
    if child_creation_date is not None:
        ...
        out["creation_date"] = aws_sdk_s3.types.creation_date.deserialize_xml(
            child_creation_date
        )
