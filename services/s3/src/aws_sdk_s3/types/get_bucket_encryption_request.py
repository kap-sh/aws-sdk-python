"""Generated from Smithy shape ``com.amazonaws.s3#GetBucketEncryptionRequest``."""
...
# --- restXml ser/de ---
def serialize_xml(value: GetBucketEncryptionRequest, parent: Element, tag: str) -> None:
    SubElement(parent, tag)


def deserialize_xml(el: Element) -> GetBucketEncryptionRequest:
    out: GetBucketEncryptionRequest = {}  # type: ignore[typeddict-item]
    return out
