...
if TYPE_CHECKING:
    import aws_sdk_s3.types.noncurrent_version_transition

NoncurrentVersionTransitionList: TypeAlias = list[
    "aws_sdk_s3.types.noncurrent_version_transition.NoncurrentVersionTransition"
]
...
def serialize_xml(
    ...
    for item in value:
        ...
        aws_sdk_s3.types.noncurrent_version_transition.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> NoncurrentVersionTransitionList:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_s3.types.noncurrent_version_transition.deserialize_xml(child)
        )
    return out
...
def serialize_xml_flat(
    ...
    for item in value:
        ...
        aws_sdk_s3.types.noncurrent_version_transition.serialize_xml(item, parent, tag)
