...
if TYPE_CHECKING:
    ...
    import aws_sdk_s3.types.email_address
    import aws_sdk_s3.types.id
    import aws_sdk_s3.types.type
    import aws_sdk_s3.types.uri


class Grantee(TypedDict):
    display_name: NotRequired["aws_sdk_s3.types.display_name.DisplayName"]
    """<p></p>"""
    email_address: NotRequired["aws_sdk_s3.types.email_address.EmailAddress"]
    """<p></p>"""
    id: NotRequired["aws_sdk_s3.types.id.ID"]
    """<p>The canonical user ID of the grantee.</p>"""
    uri: NotRequired["aws_sdk_s3.types.uri.URI"]
    """<p>URI of the grantee group.</p>"""
    type: "aws_sdk_s3.types.type.Type"
    """<p>Type of grantee</p>"""
...
def serialize_xml(value: Grantee, parent: Element, tag: str) -> None:
    ...
    el.set("xsi:type", aws_sdk_s3.types.type.to_xml_text(value["type"]))
...
def deserialize_xml(el: Element) -> Grantee:
    ...
    if attr_type is not None:
        ...
        out["type"] = aws_sdk_s3.types.type.from_xml_text(attr_type)
    else:
