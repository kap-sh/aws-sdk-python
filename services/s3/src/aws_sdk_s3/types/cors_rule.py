...
if TYPE_CHECKING:
    import aws_sdk_s3.types.allowed_headers
    import aws_sdk_s3.types.allowed_methods
    import aws_sdk_s3.types.allowed_origins
    import aws_sdk_s3.types.expose_headers
    import aws_sdk_s3.types.id
    import aws_sdk_s3.types.max_age_seconds


class CORSRule(TypedDict):
    id: NotRequired["aws_sdk_s3.types.id.ID"]
    """<p>Unique identifier for the rule. The value cannot be longer than 255 characters.</p>"""
    allowed_headers: NotRequired["aws_sdk_s3.types.allowed_headers.AllowedHeaders"]
    ...
    allowed_methods: "aws_sdk_s3.types.allowed_methods.AllowedMethods"
    ...
    allowed_origins: "aws_sdk_s3.types.allowed_origins.AllowedOrigins"
    """<p>One or more origins you want customers to be able to access the bucket from.</p>"""
    expose_headers: NotRequired["aws_sdk_s3.types.expose_headers.ExposeHeaders"]
    ...
    max_age_seconds: NotRequired["aws_sdk_s3.types.max_age_seconds.MaxAgeSeconds"]
...
def serialize_xml(value: CORSRule, parent: Element, tag: str) -> None:
    ...
    if "allowed_headers" in value:
        ...
        aws_sdk_s3.types.allowed_headers.serialize_xml_flat(
            value["allowed_headers"], el, "AllowedHeader"
        )
    import aws_sdk_s3.types.allowed_methods

    aws_sdk_s3.types.allowed_methods.serialize_xml_flat(
        value["allowed_methods"], el, "AllowedMethod"
    )
    import aws_sdk_s3.types.allowed_origins

    aws_sdk_s3.types.allowed_origins.serialize_xml_flat(
        value["allowed_origins"], el, "AllowedOrigin"
    )
    if "expose_headers" in value:
        import aws_sdk_s3.types.expose_headers

        aws_sdk_s3.types.expose_headers.serialize_xml_flat(
...
def deserialize_xml(el: Element) -> CORSRule:
    ...
    if el.find("AllowedHeader") is not None:
        ...
        out["allowed_headers"] = aws_sdk_s3.types.allowed_headers.deserialize_xml_flat(
            el, "AllowedHeader"
        )
    if el.find("AllowedMethod") is not None:
        import aws_sdk_s3.types.allowed_methods

        out["allowed_methods"] = aws_sdk_s3.types.allowed_methods.deserialize_xml_flat(
            el, "AllowedMethod"
        )
    else:
    ...
    if el.find("AllowedOrigin") is not None:
        ...
        out["allowed_origins"] = aws_sdk_s3.types.allowed_origins.deserialize_xml_flat(
            el, "AllowedOrigin"
        )
    else:
    ...
    if el.find("ExposeHeader") is not None:
        ...
        out["expose_headers"] = aws_sdk_s3.types.expose_headers.deserialize_xml_flat(
            el, "ExposeHeader"
        )
