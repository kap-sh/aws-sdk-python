...
if TYPE_CHECKING:
    import aws_sdk_s3.types.filter_rule

FilterRuleList: TypeAlias = list["aws_sdk_s3.types.filter_rule.FilterRule"]
...
def serialize_xml(value: FilterRuleList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3.types.filter_rule.serialize_xml(item, el, "member")
...
def deserialize_xml(el: Element) -> FilterRuleList:
    ...
    for child in el.findall("member"):
        out.append(aws_sdk_s3.types.filter_rule.deserialize_xml(child))
    return out
...
def serialize_xml_flat(value: FilterRuleList, parent: Element, tag: str) -> None:
    ...
    for item in value:
        ...
        aws_sdk_s3.types.filter_rule.serialize_xml(item, parent, tag)
