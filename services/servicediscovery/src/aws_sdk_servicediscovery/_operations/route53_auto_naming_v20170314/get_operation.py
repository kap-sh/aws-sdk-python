...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OperationNotFound":
            import aws_sdk_servicediscovery.errors.operation_not_found

            raise aws_sdk_servicediscovery.errors.operation_not_found.OperationNotFound.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.get_operation_response.GetOperationResponse = (
        aws_sdk_servicediscovery.types.get_operation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.get_operation_request.GetOperationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.get_operation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
