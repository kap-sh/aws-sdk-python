"""Generated from Smithy shape ``com.amazonaws.servicediscovery#CreatePublicDnsNamespace``."""
...
import aws_sdk_servicediscovery.errors.namespace_already_exists
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NamespaceAlreadyExists":
            raise aws_sdk_servicediscovery.errors.namespace_already_exists.NamespaceAlreadyExists.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.create_public_dns_namespace_response.CreatePublicDnsNamespaceResponse = aws_sdk_servicediscovery.types.create_public_dns_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.create_public_dns_namespace_request.CreatePublicDnsNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.create_public_dns_namespace_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_public_dns_namespace(
