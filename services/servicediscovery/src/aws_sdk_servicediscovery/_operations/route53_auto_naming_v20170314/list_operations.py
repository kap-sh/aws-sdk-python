"""Generated from Smithy shape ``com.amazonaws.servicediscovery#ListOperations``."""
...
import aws_sdk_servicediscovery.types.operation_summary_list
...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.list_operations_response.ListOperationsResponse = aws_sdk_servicediscovery.types.list_operations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.list_operations_request.ListOperationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.list_operations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
