...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.update_http_namespace_response.UpdateHttpNamespaceResponse = aws_sdk_servicediscovery.types.update_http_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.update_http_namespace_request.UpdateHttpNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.update_http_namespace_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
