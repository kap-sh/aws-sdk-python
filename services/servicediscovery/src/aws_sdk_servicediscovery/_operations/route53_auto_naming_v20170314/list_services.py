...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.list_services_response.ListServicesResponse = (
        aws_sdk_servicediscovery.types.list_services_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.list_services_request.ListServicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.list_services_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
