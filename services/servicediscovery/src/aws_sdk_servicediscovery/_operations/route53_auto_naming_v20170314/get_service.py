"""Generated from Smithy shape ``com.amazonaws.servicediscovery#GetService``."""
...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.get_service_response.GetServiceResponse = (
        aws_sdk_servicediscovery.types.get_service_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_servicediscovery.types.get_service_request.GetServiceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.get_service_request.serialize_aws_json_1_1(input)
    ).encode()
