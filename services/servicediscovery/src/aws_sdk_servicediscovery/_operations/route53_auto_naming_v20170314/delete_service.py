...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.delete_service_response.DeleteServiceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.delete_service_request.DeleteServiceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.delete_service_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
