"""Generated from Smithy shape ``com.amazonaws.servicediscovery#UpdateInstanceCustomHealthStatus``."""
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.update_instance_custom_health_status_request.UpdateInstanceCustomHealthStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_instance_custom_health_status(
