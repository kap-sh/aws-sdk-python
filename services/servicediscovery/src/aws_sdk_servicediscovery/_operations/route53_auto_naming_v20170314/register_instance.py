...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.register_instance_response.RegisterInstanceResponse = aws_sdk_servicediscovery.types.register_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.register_instance_request.RegisterInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.register_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
