"""Generated from Smithy shape ``com.amazonaws.servicediscovery#UpdatePublicDnsNamespace``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DuplicateRequest":
            import aws_sdk_servicediscovery.errors.duplicate_request

            raise aws_sdk_servicediscovery.errors.duplicate_request.DuplicateRequest.from_aws_json_1_1(
                data
            )
        case "InvalidInput":
        ...
        case "ResourceInUse":
            import aws_sdk_servicediscovery.errors.resource_in_use

            raise aws_sdk_servicediscovery.errors.resource_in_use.ResourceInUse.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.update_public_dns_namespace_response.UpdatePublicDnsNamespaceResponse = aws_sdk_servicediscovery.types.update_public_dns_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.update_public_dns_namespace_request.UpdatePublicDnsNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53AutoNaming_v20170314.UpdatePublicDnsNamespace"
    import aws_sdk_servicediscovery.types.update_public_dns_namespace_request

    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.update_public_dns_namespace_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_public_dns_namespace(
