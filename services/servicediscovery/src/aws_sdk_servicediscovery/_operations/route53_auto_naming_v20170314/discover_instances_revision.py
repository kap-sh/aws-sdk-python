"""Generated from Smithy shape ``com.amazonaws.servicediscovery#DiscoverInstancesRevision``."""
...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.discover_instances_revision_response.DiscoverInstancesRevisionResponse = aws_sdk_servicediscovery.types.discover_instances_revision_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.discover_instances_revision_request.DiscoverInstancesRevisionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53AutoNaming_v20170314.DiscoverInstancesRevision"
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.discover_instances_revision_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_discover_instances_revision(
