"""Generated from Smithy shape ``com.amazonaws.servicediscovery#ListInstances``."""
...
import aws_sdk_servicediscovery.types.instance_summary_list
...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.list_instances_response.ListInstancesResponse = aws_sdk_servicediscovery.types.list_instances_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.list_instances_request.ListInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.list_instances_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
