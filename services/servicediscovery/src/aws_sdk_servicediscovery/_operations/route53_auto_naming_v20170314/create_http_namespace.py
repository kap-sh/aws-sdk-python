"""Generated from Smithy shape ``com.amazonaws.servicediscovery#CreateHttpNamespace``."""
...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.create_http_namespace_response.CreateHttpNamespaceResponse = aws_sdk_servicediscovery.types.create_http_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.create_http_namespace_request.CreateHttpNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_http_namespace(
