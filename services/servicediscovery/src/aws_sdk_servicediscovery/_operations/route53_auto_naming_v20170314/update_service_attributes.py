"""Generated from Smithy shape ``com.amazonaws.servicediscovery#UpdateServiceAttributes``."""
...
import aws_sdk_servicediscovery.errors.service_attributes_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceAttributesLimitExceededException":
            raise aws_sdk_servicediscovery.errors.service_attributes_limit_exceeded_exception.ServiceAttributesLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.update_service_attributes_response.UpdateServiceAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.update_service_attributes_request.UpdateServiceAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53AutoNaming_v20170314.UpdateServiceAttributes"
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.update_service_attributes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_service_attributes(
