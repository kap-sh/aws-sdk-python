...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.deregister_instance_response.DeregisterInstanceResponse = aws_sdk_servicediscovery.types.deregister_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.deregister_instance_request.DeregisterInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.deregister_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
