"""Generated from Smithy shape ``com.amazonaws.servicediscovery#ListTagsForResource``."""
...
import aws_sdk_servicediscovery.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise aws_sdk_servicediscovery.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.list_tags_for_resource_response.ListTagsForResourceResponse = aws_sdk_servicediscovery.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53AutoNaming_v20170314.ListTagsForResource"
    import aws_sdk_servicediscovery.types.list_tags_for_resource_request

    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.list_tags_for_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
