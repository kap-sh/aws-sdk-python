...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.get_service_attributes_response.GetServiceAttributesResponse = aws_sdk_servicediscovery.types.get_service_attributes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.get_service_attributes_request.GetServiceAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.get_service_attributes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
