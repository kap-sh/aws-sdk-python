"""Generated from Smithy shape ``com.amazonaws.servicediscovery#ListNamespaces``."""
...
import aws_sdk_servicediscovery.types.namespace_summaries_list
...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.list_namespaces_response.ListNamespacesResponse = aws_sdk_servicediscovery.types.list_namespaces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.list_namespaces_request.ListNamespacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.list_namespaces_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
