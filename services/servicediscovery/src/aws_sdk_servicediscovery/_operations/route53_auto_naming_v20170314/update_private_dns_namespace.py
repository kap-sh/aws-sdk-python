...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.update_private_dns_namespace_response.UpdatePrivateDnsNamespaceResponse = aws_sdk_servicediscovery.types.update_private_dns_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.update_private_dns_namespace_request.UpdatePrivateDnsNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.update_private_dns_namespace_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
