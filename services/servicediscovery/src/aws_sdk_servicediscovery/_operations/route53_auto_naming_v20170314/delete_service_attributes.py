"""Generated from Smithy shape ``com.amazonaws.servicediscovery#DeleteServiceAttributes``."""
...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.delete_service_attributes_response.DeleteServiceAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.delete_service_attributes_request.DeleteServiceAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Route53AutoNaming_v20170314.DeleteServiceAttributes"
    import aws_sdk_servicediscovery.types.delete_service_attributes_request

    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.delete_service_attributes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_service_attributes(
