...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.get_instances_health_status_response.GetInstancesHealthStatusResponse = aws_sdk_servicediscovery.types.get_instances_health_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.get_instances_health_status_request.GetInstancesHealthStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
