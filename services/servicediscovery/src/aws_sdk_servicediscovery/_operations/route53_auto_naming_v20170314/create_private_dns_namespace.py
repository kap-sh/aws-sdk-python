...
def handle_response(
    ...
    out: aws_sdk_servicediscovery.types.create_private_dns_namespace_response.CreatePrivateDnsNamespaceResponse = aws_sdk_servicediscovery.types.create_private_dns_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_servicediscovery.types.create_private_dns_namespace_request.CreatePrivateDnsNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_servicediscovery.types.create_private_dns_namespace_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
