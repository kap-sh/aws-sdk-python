...
if TYPE_CHECKING:
    ...
    import aws_sdk_servicediscovery.types.service_summaries_list


class ListServicesResponse(TypedDict, closed=True):
    services: NotRequired[
        "aws_sdk_servicediscovery.types.service_summaries_list.ServiceSummariesList"
    ]
...
def serialize_aws_json_1_1(value: ListServicesResponse) -> dict:
    ...
    if "services" in value:
        ...
        out["Services"] = (
            aws_sdk_servicediscovery.types.service_summaries_list.serialize_aws_json_1_1(
                value["services"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListServicesResponse:
    ...
    if "Services" in data:
        ...
        out["services"] = (
            aws_sdk_servicediscovery.types.service_summaries_list.deserialize_aws_json_1_1(
                data["Services"]
            )
        )
