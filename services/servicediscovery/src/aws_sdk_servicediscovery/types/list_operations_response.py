...
class ListOperationsResponse(TypedDict, closed=True):
    operations: NotRequired[
        "aws_sdk_servicediscovery.types.operation_summary_list.OperationSummaryList"
    ]
...
def serialize_aws_json_1_1(value: ListOperationsResponse) -> dict:
    ...
    if "operations" in value:
        ...
        out["Operations"] = (
            aws_sdk_servicediscovery.types.operation_summary_list.serialize_aws_json_1_1(
                value["operations"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListOperationsResponse:
    ...
    if "Operations" in data:
        ...
        out["operations"] = (
            aws_sdk_servicediscovery.types.operation_summary_list.deserialize_aws_json_1_1(
                data["Operations"]
            )
        )
