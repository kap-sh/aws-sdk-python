"""Generated from Smithy shape ``com.amazonaws.servicediscovery#CreatePublicDnsNamespaceResponse``."""
...
class CreatePublicDnsNamespaceResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreatePublicDnsNamespaceResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> CreatePublicDnsNamespaceResponse:
    out: CreatePublicDnsNamespaceResponse = {}  # type: ignore[typeddict-item]
