"""Generated from Smithy shape ``com.amazonaws.servicediscovery#DnsRecord``."""
...
def serialize_aws_json_1_1(value: DnsRecord) -> dict:
    ...
    out["Type"] = aws_sdk_servicediscovery.types.record_type.serialize_aws_json_1_1(
        value["type"]
    )
    out["TTL"] = value["ttl"]
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DnsRecord:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_servicediscovery.types.record_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    else:
