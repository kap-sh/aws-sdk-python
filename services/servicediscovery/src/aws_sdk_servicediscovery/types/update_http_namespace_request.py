...
class UpdateHttpNamespaceRequest(TypedDict):
    ...
    namespace: (
        "aws_sdk_servicediscovery.types.http_namespace_change.HttpNamespaceChange"
    )
...
def serialize_aws_json_1_1(value: UpdateHttpNamespaceRequest) -> dict:
    ...
    out["Namespace"] = (
        aws_sdk_servicediscovery.types.http_namespace_change.serialize_aws_json_1_1(
            value["namespace"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UpdateHttpNamespaceRequest:
    ...
    if "Namespace" in data:
        ...
        out["namespace"] = (
            aws_sdk_servicediscovery.types.http_namespace_change.deserialize_aws_json_1_1(
                data["Namespace"]
            )
        )
    else:
