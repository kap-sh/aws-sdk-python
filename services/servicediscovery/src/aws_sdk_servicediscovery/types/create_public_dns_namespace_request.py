"""Generated from Smithy shape ``com.amazonaws.servicediscovery#CreatePublicDnsNamespaceRequest``."""
...
class CreatePublicDnsNamespaceRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreatePublicDnsNamespaceRequest) -> dict:
    out: dict = {}
    out["Name"] = value["name"]
    ...
    if "properties" in value:
        ...
        out["Properties"] = (
            aws_sdk_servicediscovery.types.public_dns_namespace_properties.serialize_aws_json_1_1(
                value["properties"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CreatePublicDnsNamespaceRequest:
    out: CreatePublicDnsNamespaceRequest = {}  # type: ignore[typeddict-item]
    if "Name" in data:
        out["name"] = data["Name"]
    else:
        raise DeserializationError("CreatePublicDnsNamespaceRequest.name required")
    ...
    if "Properties" in data:
        ...
        out["properties"] = (
            aws_sdk_servicediscovery.types.public_dns_namespace_properties.deserialize_aws_json_1_1(
                data["Properties"]
            )
        )
    return out
