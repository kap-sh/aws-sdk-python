...
class GetInstanceResponse(TypedDict):
    ...
    instance: NotRequired["aws_sdk_servicediscovery.types.instance.Instance"]
...
def serialize_aws_json_1_1(value: GetInstanceResponse) -> dict:
    ...
    if "instance" in value:
        ...
        out["Instance"] = (
            aws_sdk_servicediscovery.types.instance.serialize_aws_json_1_1(
                value["instance"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetInstanceResponse:
    ...
    if "Instance" in data:
        ...
        out["instance"] = (
            aws_sdk_servicediscovery.types.instance.deserialize_aws_json_1_1(
                data["Instance"]
            )
        )
    return out
