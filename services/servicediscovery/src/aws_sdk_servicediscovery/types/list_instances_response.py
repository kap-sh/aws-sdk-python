...
class ListInstancesResponse(TypedDict, closed=True):
    ...
    instances: NotRequired[
        "aws_sdk_servicediscovery.types.instance_summary_list.InstanceSummaryList"
    ]
...
def serialize_aws_json_1_1(value: ListInstancesResponse) -> dict:
    ...
    if "instances" in value:
        ...
        out["Instances"] = (
            aws_sdk_servicediscovery.types.instance_summary_list.serialize_aws_json_1_1(
                value["instances"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListInstancesResponse:
    ...
    if "Instances" in data:
        ...
        out["instances"] = (
            aws_sdk_servicediscovery.types.instance_summary_list.deserialize_aws_json_1_1(
                data["Instances"]
            )
        )
