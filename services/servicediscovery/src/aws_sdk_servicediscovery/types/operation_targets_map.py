...
if TYPE_CHECKING:
    import aws_sdk_servicediscovery.types.operation_target_type
    import aws_sdk_servicediscovery.types.resource_id

OperationTargetsMap: TypeAlias = dict[
    "aws_sdk_servicediscovery.types.operation_target_type.OperationTargetType",
...
def serialize_aws_json_1_1(input_to_serialize: OperationTargetsMap) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[
            aws_sdk_servicediscovery.types.operation_target_type.serialize_aws_json_1_1(
                key
            )
        ] = value
    return out
...
def deserialize_aws_json_1_1(data: dict) -> OperationTargetsMap:
    ...
    for key, value in data.items():
        ...
        out[
            aws_sdk_servicediscovery.types.operation_target_type.deserialize_aws_json_1_1(
                key
            )
        ] = value
    return out
