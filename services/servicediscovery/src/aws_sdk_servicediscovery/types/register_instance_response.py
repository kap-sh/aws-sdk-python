"""Generated from Smithy shape ``com.amazonaws.servicediscovery#RegisterInstanceResponse``."""
...
class RegisterInstanceResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: RegisterInstanceResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> RegisterInstanceResponse:
    out: RegisterInstanceResponse = {}  # type: ignore[typeddict-item]
