...
class DiscoverInstancesResponse(TypedDict):
    instances: NotRequired[
        "aws_sdk_servicediscovery.types.http_instance_summary_list.HttpInstanceSummaryList"
    ]
...
def serialize_aws_json_1_1(value: DiscoverInstancesResponse) -> dict:
    ...
    if "instances" in value:
        ...
        out["Instances"] = (
            aws_sdk_servicediscovery.types.http_instance_summary_list.serialize_aws_json_1_1(
                value["instances"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DiscoverInstancesResponse:
    ...
    if "Instances" in data:
        ...
        out["instances"] = (
            aws_sdk_servicediscovery.types.http_instance_summary_list.deserialize_aws_json_1_1(
                data["Instances"]
            )
        )
