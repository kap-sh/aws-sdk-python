...
class ListNamespacesResponse(TypedDict, closed=True):
    namespaces: NotRequired[
        "aws_sdk_servicediscovery.types.namespace_summaries_list.NamespaceSummariesList"
    ]
...
def serialize_aws_json_1_1(value: ListNamespacesResponse) -> dict:
    ...
    if "namespaces" in value:
        ...
        out["Namespaces"] = (
            aws_sdk_servicediscovery.types.namespace_summaries_list.serialize_aws_json_1_1(
                value["namespaces"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListNamespacesResponse:
    ...
    if "Namespaces" in data:
        ...
        out["namespaces"] = (
            aws_sdk_servicediscovery.types.namespace_summaries_list.deserialize_aws_json_1_1(
                data["Namespaces"]
            )
        )
