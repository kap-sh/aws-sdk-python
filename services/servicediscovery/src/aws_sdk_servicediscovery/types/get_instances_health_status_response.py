...
def serialize_aws_json_1_1(value: GetInstancesHealthStatusResponse) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            aws_sdk_servicediscovery.types.instance_health_status_map.serialize_aws_json_1_1(
                value["status"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetInstancesHealthStatusResponse:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_servicediscovery.types.instance_health_status_map.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
