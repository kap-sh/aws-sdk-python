...
if TYPE_CHECKING:
    import aws_sdk_servicediscovery.types.dns_properties
    import aws_sdk_servicediscovery.types.http_properties


class NamespaceProperties(TypedDict):
    dns_properties: NotRequired[
        "aws_sdk_servicediscovery.types.dns_properties.DnsProperties"
    ]
    ...
    http_properties: NotRequired[
        "aws_sdk_servicediscovery.types.http_properties.HttpProperties"
    ]
...
def serialize_aws_json_1_1(value: NamespaceProperties) -> dict:
    ...
    if "dns_properties" in value:
        ...
        out["DnsProperties"] = (
            aws_sdk_servicediscovery.types.dns_properties.serialize_aws_json_1_1(
    ...
    if "http_properties" in value:
        ...
        out["HttpProperties"] = (
            aws_sdk_servicediscovery.types.http_properties.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> NamespaceProperties:
    ...
    if "DnsProperties" in data:
        ...
        out["dns_properties"] = (
            aws_sdk_servicediscovery.types.dns_properties.deserialize_aws_json_1_1(
                data["DnsProperties"]
            )
        )
    if "HttpProperties" in data:
        ...
        out["http_properties"] = (
            aws_sdk_servicediscovery.types.http_properties.deserialize_aws_json_1_1(
                data["HttpProperties"]
            )
        )
    return out
