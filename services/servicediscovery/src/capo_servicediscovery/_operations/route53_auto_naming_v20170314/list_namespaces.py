...
def handle_response(
    ...
    out: capo_servicediscovery.types.list_namespaces_response.ListNamespacesResponse = (
        capo_servicediscovery.types.list_namespaces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.list_namespaces_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
