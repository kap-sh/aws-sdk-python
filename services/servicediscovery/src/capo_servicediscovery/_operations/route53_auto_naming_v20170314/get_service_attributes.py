"""Generated from Smithy shape ``com.amazonaws.servicediscovery#GetServiceAttributes``."""
...
def handle_response(
    ...
    out: capo_servicediscovery.types.get_service_attributes_response.GetServiceAttributesResponse = capo_servicediscovery.types.get_service_attributes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53AutoNaming_v20170314.GetServiceAttributes"
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.get_service_attributes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_service_attributes(
