...
import capo_servicediscovery.errors.service_already_exists
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceAlreadyExists":
            raise capo_servicediscovery.errors.service_already_exists.ServiceAlreadyExists.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_servicediscovery.types.create_service_response.CreateServiceResponse = (
        capo_servicediscovery.types.create_service_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.create_service_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
