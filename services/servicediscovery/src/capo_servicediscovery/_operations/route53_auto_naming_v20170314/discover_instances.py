"""Generated from Smithy shape ``com.amazonaws.servicediscovery#DiscoverInstances``."""
...
import capo_servicediscovery.errors.request_limit_exceeded
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RequestLimitExceeded":
            raise capo_servicediscovery.errors.request_limit_exceeded.RequestLimitExceeded.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_servicediscovery.types.discover_instances_response.DiscoverInstancesResponse = capo_servicediscovery.types.discover_instances_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.discover_instances_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_discover_instances(
