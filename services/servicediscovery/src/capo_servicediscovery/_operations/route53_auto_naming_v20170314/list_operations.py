...
def handle_response(
    ...
    out: capo_servicediscovery.types.list_operations_response.ListOperationsResponse = (
        capo_servicediscovery.types.list_operations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.list_operations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
