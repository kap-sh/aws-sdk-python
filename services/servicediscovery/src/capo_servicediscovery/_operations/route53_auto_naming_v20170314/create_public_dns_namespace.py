...
def handle_response(
    ...
    out: capo_servicediscovery.types.create_public_dns_namespace_response.CreatePublicDnsNamespaceResponse = capo_servicediscovery.types.create_public_dns_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.create_public_dns_namespace_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
