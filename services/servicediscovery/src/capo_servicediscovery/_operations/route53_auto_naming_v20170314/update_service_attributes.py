...
import capo_servicediscovery.errors.service_attributes_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceAttributesLimitExceededException":
            raise capo_servicediscovery.errors.service_attributes_limit_exceeded_exception.ServiceAttributesLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_servicediscovery.types.update_service_attributes_response.UpdateServiceAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_servicediscovery._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.update_service_attributes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
