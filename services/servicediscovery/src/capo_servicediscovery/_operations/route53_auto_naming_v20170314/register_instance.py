"""Generated from Smithy shape ``com.amazonaws.servicediscovery#RegisterInstance``."""
...
def handle_response(
    ...
    out: capo_servicediscovery.types.register_instance_response.RegisterInstanceResponse = capo_servicediscovery.types.register_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.register_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_register_instance(
