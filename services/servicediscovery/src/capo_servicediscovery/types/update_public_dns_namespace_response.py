"""Generated from Smithy shape ``com.amazonaws.servicediscovery#UpdatePublicDnsNamespaceResponse``."""
...
class UpdatePublicDnsNamespaceResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdatePublicDnsNamespaceResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> UpdatePublicDnsNamespaceResponse:
    out: UpdatePublicDnsNamespaceResponse = {}  # type: ignore[typeddict-item]
