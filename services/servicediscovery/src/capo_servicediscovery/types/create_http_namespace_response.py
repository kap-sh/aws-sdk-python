"""Generated from Smithy shape ``com.amazonaws.servicediscovery#CreateHttpNamespaceResponse``."""
...
class CreateHttpNamespaceResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateHttpNamespaceResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> CreateHttpNamespaceResponse:
    out: CreateHttpNamespaceResponse = {}  # type: ignore[typeddict-item]
