...
from ._services.async_service_discovery import (
    AsyncServiceDiscoveryClient as AsyncServiceDiscoveryClient,
)
from ._services.service_discovery import (
    ServiceDiscoveryClient as ServiceDiscoveryClient,
)
