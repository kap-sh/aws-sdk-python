"""Generated from Smithy shape ``com.amazonaws.servicediscovery#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.servicediscovery#ResourceNotFoundException``."""
