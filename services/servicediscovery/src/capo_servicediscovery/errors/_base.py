...
class ServiceDiscoveryError(Exception):
    """Base class for all ServiceDiscovery service errors."""


class ServiceError(ServiceDiscoveryError):
...
class SerializationError(ServiceDiscoveryError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ServiceDiscoveryError):
...
class WaiterFailedError(ServiceDiscoveryError):
...
class WaiterTimeoutError(ServiceDiscoveryError):
