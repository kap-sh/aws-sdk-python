...
class AsyncServiceDiscoveryClient:
    ...
    async def create_http_namespace(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.create_http_namespace_request.CreateHttpNamespaceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.create_http_namespace_response.CreateHttpNamespaceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.create_http_namespace.async_create_http_namespace(
    ...
    async def create_private_dns_namespace(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.create_private_dns_namespace_request.CreatePrivateDnsNamespaceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.create_private_dns_namespace_response.CreatePrivateDnsNamespaceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.create_private_dns_namespace.async_create_private_dns_namespace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_public_dns_namespace(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.create_public_dns_namespace_request.CreatePublicDnsNamespaceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.create_public_dns_namespace_response.CreatePublicDnsNamespaceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.create_public_dns_namespace.async_create_public_dns_namespace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.create_service_request.CreateServiceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.create_service_response.CreateServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.create_service.async_create_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_namespace(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.delete_namespace_request.DeleteNamespaceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.delete_namespace_response.DeleteNamespaceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.delete_namespace.async_delete_namespace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.delete_service_request.DeleteServiceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.delete_service_response.DeleteServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.delete_service.async_delete_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_service_attributes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.delete_service_attributes_request.DeleteServiceAttributesRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.delete_service_attributes_response.DeleteServiceAttributesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.delete_service_attributes.async_delete_service_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deregister_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.deregister_instance_request.DeregisterInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.deregister_instance_response.DeregisterInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.deregister_instance.async_deregister_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def discover_instances(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.discover_instances_request.DiscoverInstancesRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.discover_instances_response.DiscoverInstancesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.discover_instances.async_discover_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def discover_instances_revision(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.discover_instances_revision_request.DiscoverInstancesRevisionRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.discover_instances_revision_response.DiscoverInstancesRevisionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.discover_instances_revision.async_discover_instances_revision(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.get_instance_request.GetInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.get_instance_response.GetInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.get_instance.async_get_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_instances_health_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.get_instances_health_status_request.GetInstancesHealthStatusRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.get_instances_health_status_response.GetInstancesHealthStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.get_instances_health_status.async_get_instances_health_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_namespace(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.get_namespace_request.GetNamespaceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.get_namespace_response.GetNamespaceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.get_namespace.async_get_namespace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_operation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.get_operation_request.GetOperationRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.get_operation_response.GetOperationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.get_operation.async_get_operation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.get_service_request.GetServiceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.get_service_response.GetServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.get_service.async_get_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_service_attributes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.get_service_attributes_request.GetServiceAttributesRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.get_service_attributes_response.GetServiceAttributesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.get_service_attributes.async_get_service_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_instances(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.list_instances_request.ListInstancesRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.list_instances_response.ListInstancesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.list_instances.async_list_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_namespaces(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.list_namespaces_request.ListNamespacesRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.list_namespaces_response.ListNamespacesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.list_namespaces.async_list_namespaces(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_operations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.list_operations_request.ListOperationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.list_operations_response.ListOperationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.list_operations.async_list_operations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_services(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.list_services_request.ListServicesRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.list_services_response.ListServicesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.list_services.async_list_services(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.register_instance_request.RegisterInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.register_instance_response.RegisterInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.register_instance.async_register_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_http_namespace(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.update_http_namespace_request.UpdateHttpNamespaceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.update_http_namespace_response.UpdateHttpNamespaceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.update_http_namespace.async_update_http_namespace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_instance_custom_health_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.update_instance_custom_health_status_request.UpdateInstanceCustomHealthStatusRequest]",
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.update_instance_custom_health_status.async_update_instance_custom_health_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_private_dns_namespace(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.update_private_dns_namespace_request.UpdatePrivateDnsNamespaceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.update_private_dns_namespace_response.UpdatePrivateDnsNamespaceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.update_private_dns_namespace.async_update_private_dns_namespace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_public_dns_namespace(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.update_public_dns_namespace_request.UpdatePublicDnsNamespaceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.update_public_dns_namespace_response.UpdatePublicDnsNamespaceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.update_public_dns_namespace.async_update_public_dns_namespace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_service(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.update_service_request.UpdateServiceRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.update_service_response.UpdateServiceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.update_service.async_update_service(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_service_attributes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_servicediscovery.types.update_service_attributes_request.UpdateServiceAttributesRequest]",
        ) -> AsyncOperationResponse[
            "capo_servicediscovery.types.update_service_attributes_response.UpdateServiceAttributesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_servicediscovery._operations.route53_auto_naming_v20170314.update_service_attributes.async_update_service_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
