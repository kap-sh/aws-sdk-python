...
DBEngineVersionList: TypeAlias = list[
    "aws_sdk_docdb.types.db_engine_version.DBEngineVersion"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_docdb.types.db_engine_version.serialize_query(
...
def deserialize_query(el: Element) -> DBEngineVersionList:
    ...
    for child in el.findall("DBEngineVersion"):
        out.append(aws_sdk_docdb.types.db_engine_version.deserialize_query(child))
    return out
