...
if TYPE_CHECKING:
    ...
    import aws_sdk_docdb.types.pending_cloudwatch_logs_exports
...
class PendingModifiedValues(TypedDict):
    ...
    multi_az: NotRequired["aws_sdk_docdb.types.boolean_optional.BooleanOptional"]
    ...
    iops: NotRequired["aws_sdk_docdb.types.integer_optional.IntegerOptional"]
    ...
    pending_cloudwatch_logs_exports: NotRequired[
        "aws_sdk_docdb.types.pending_cloudwatch_logs_exports.PendingCloudwatchLogsExports"
    ]
...
def serialize_query(
    ...
    if "pending_cloudwatch_logs_exports" in value:
        ...
        aws_sdk_docdb.types.pending_cloudwatch_logs_exports.serialize_query(
...
def deserialize_query(el: Element) -> PendingModifiedValues:
    ...
    if child_pending_cloudwatch_logs_exports is not None:
        ...
        out["pending_cloudwatch_logs_exports"] = (
            aws_sdk_docdb.types.pending_cloudwatch_logs_exports.deserialize_query(
