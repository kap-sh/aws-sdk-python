"""Generated from Smithy shape ``com.amazonaws.docdb#EventSubscription``."""
...
class EventSubscription(TypedDict, closed=True):
    customer_aws_id: NotRequired["aws_sdk_docdb.types.string.String"]
    ...
    cust_subscription_id: NotRequired["aws_sdk_docdb.types.string.String"]
    ...
    subscription_creation_time: NotRequired["aws_sdk_docdb.types.string.String"]
    ...
    source_ids_list: NotRequired["aws_sdk_docdb.types.source_ids_list.SourceIdsList"]
    ...
    enabled: NotRequired["aws_sdk_docdb.types.boolean.Boolean"]
    ...
    event_subscription_arn: NotRequired["aws_sdk_docdb.types.string.String"]
...
def serialize_query(
    ...
    if "source_ids_list" in value:
        ...
        aws_sdk_docdb.types.source_ids_list.serialize_query(
...
def deserialize_query(el: Element) -> EventSubscription:
    ...
    if child_source_ids_list is not None:
        ...
        out["source_ids_list"] = aws_sdk_docdb.types.source_ids_list.deserialize_query(
