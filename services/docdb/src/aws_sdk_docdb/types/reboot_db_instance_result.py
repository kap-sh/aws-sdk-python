"""Generated from Smithy shape ``com.amazonaws.docdb#RebootDBInstanceResult``."""
...
class RebootDBInstanceResult(TypedDict, closed=True):
    db_instance: NotRequired["aws_sdk_docdb.types.db_instance.DBInstance"]


# --- awsQuery ser/de ---
def serialize_query(
    value: RebootDBInstanceResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> RebootDBInstanceResult:
    out: RebootDBInstanceResult = {}  # type: ignore[typeddict-item]
