...
class Subnet(TypedDict, closed=True):
    subnet_identifier: NotRequired["aws_sdk_docdb.types.string.String"]
    ...
    subnet_status: NotRequired["aws_sdk_docdb.types.string.String"]
...
def deserialize_query(el: Element) -> Subnet:
    ...
    if child_subnet_availability_zone is not None:
        ...
        out["subnet_availability_zone"] = (
            aws_sdk_docdb.types.availability_zone.deserialize_query(
