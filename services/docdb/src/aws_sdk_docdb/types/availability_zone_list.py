"""Generated from Smithy shape ``com.amazonaws.docdb#AvailabilityZoneList``."""
...
if TYPE_CHECKING:
    import aws_sdk_docdb.types.availability_zone

AvailabilityZoneList: TypeAlias = list[
    "aws_sdk_docdb.types.availability_zone.AvailabilityZone"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_docdb.types.availability_zone.serialize_query(
...
def deserialize_query(el: Element) -> AvailabilityZoneList:
    ...
    for child in el.findall("AvailabilityZone"):
        out.append(aws_sdk_docdb.types.availability_zone.deserialize_query(child))
    return out
