...
class RemoveTagsFromResourceMessage(TypedDict):
    ...
    tag_keys: NotRequired["aws_sdk_docdb.types.key_list.KeyList"]
...
def serialize_query(
    ...
    if "tag_keys" in value:
        ...
        aws_sdk_docdb.types.key_list.serialize_query(
...
def deserialize_query(el: Element) -> RemoveTagsFromResourceMessage:
    ...
    if child_tag_keys is not None:
        ...
        out["tag_keys"] = aws_sdk_docdb.types.key_list.deserialize_query(child_tag_keys)
    return out
