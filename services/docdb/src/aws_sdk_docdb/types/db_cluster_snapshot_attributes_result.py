...
if TYPE_CHECKING:
    import aws_sdk_docdb.types.db_cluster_snapshot_attribute_list
...
class DBClusterSnapshotAttributesResult(TypedDict, closed=True):
    ...
    db_cluster_snapshot_attributes: NotRequired[
        "aws_sdk_docdb.types.db_cluster_snapshot_attribute_list.DBClusterSnapshotAttributeList"
    ]
...
def serialize_query(
    ...
    if "db_cluster_snapshot_attributes" in value:
        ...
        aws_sdk_docdb.types.db_cluster_snapshot_attribute_list.serialize_query(
...
def deserialize_query(el: Element) -> DBClusterSnapshotAttributesResult:
    ...
    if child_db_cluster_snapshot_attributes is not None:
        ...
        out["db_cluster_snapshot_attributes"] = (
            aws_sdk_docdb.types.db_cluster_snapshot_attribute_list.deserialize_query(
