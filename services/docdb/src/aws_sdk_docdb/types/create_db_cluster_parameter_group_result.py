"""Generated from Smithy shape ``com.amazonaws.docdb#CreateDBClusterParameterGroupResult``."""
...
class CreateDBClusterParameterGroupResult(TypedDict, closed=True):
    db_cluster_parameter_group: NotRequired[
        "aws_sdk_docdb.types.db_cluster_parameter_group.DBClusterParameterGroup"
    ]
...
def serialize_query(
    ...
    if "db_cluster_parameter_group" in value:
        ...
        aws_sdk_docdb.types.db_cluster_parameter_group.serialize_query(
...
def deserialize_query(el: Element) -> CreateDBClusterParameterGroupResult:
    ...
    if child_db_cluster_parameter_group is not None:
        ...
        out["db_cluster_parameter_group"] = (
            aws_sdk_docdb.types.db_cluster_parameter_group.deserialize_query(
