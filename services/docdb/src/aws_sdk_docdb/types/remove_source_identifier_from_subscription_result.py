"""Generated from Smithy shape ``com.amazonaws.docdb#RemoveSourceIdentifierFromSubscriptionResult``."""
...
class RemoveSourceIdentifierFromSubscriptionResult(TypedDict):
