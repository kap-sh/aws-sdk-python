"""Generated from Smithy shape ``com.amazonaws.docdb#ModifyEventSubscriptionMessage``."""
...
class ModifyEventSubscriptionMessage(TypedDict, closed=True):
    ...
    sns_topic_arn: NotRequired["aws_sdk_docdb.types.string.String"]
    ...
    enabled: NotRequired["aws_sdk_docdb.types.boolean_optional.BooleanOptional"]
