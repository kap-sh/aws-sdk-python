...
class FailoverGlobalClusterMessage(TypedDict):
    ...
    allow_data_loss: NotRequired["aws_sdk_docdb.types.boolean_optional.BooleanOptional"]
    ...
    switchover: NotRequired["aws_sdk_docdb.types.boolean_optional.BooleanOptional"]
