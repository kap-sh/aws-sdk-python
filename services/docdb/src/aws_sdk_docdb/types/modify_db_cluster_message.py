...
class ModifyDBClusterMessage(TypedDict):
    ...
    new_db_cluster_identifier: NotRequired["aws_sdk_docdb.types.string.String"]
    ...
    apply_immediately: NotRequired["aws_sdk_docdb.types.boolean.Boolean"]
    ...
    allow_major_version_upgrade: NotRequired["aws_sdk_docdb.types.boolean.Boolean"]
...
def serialize_query(
    ...
    if "cloudwatch_logs_export_configuration" in value:
        ...
        aws_sdk_docdb.types.cloudwatch_logs_export_configuration.serialize_query(
...
def deserialize_query(el: Element) -> ModifyDBClusterMessage:
    ...
    if child_cloudwatch_logs_export_configuration is not None:
        ...
        out["cloudwatch_logs_export_configuration"] = (
            aws_sdk_docdb.types.cloudwatch_logs_export_configuration.deserialize_query(
