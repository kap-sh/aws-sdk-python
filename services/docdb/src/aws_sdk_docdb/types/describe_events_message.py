...
def serialize_query(
    ...
    if "source_type" in value:
        ...
        aws_sdk_docdb.types.source_type.serialize_query(
    ...
    if "event_categories" in value:
        ...
        aws_sdk_docdb.types.event_categories_list.serialize_query(
...
def deserialize_query(el: Element) -> DescribeEventsMessage:
    ...
    if child_source_type is not None:
        ...
        out["source_type"] = aws_sdk_docdb.types.source_type.deserialize_query(
            child_source_type
        )
    ...
    if child_start_time is not None:
        ...
        out["start_time"] = aws_sdk_docdb.types.t_stamp.deserialize_query(
            child_start_time
        )
    ...
    if child_end_time is not None:
        ...
        out["end_time"] = aws_sdk_docdb.types.t_stamp.deserialize_query(child_end_time)
    ...
    if child_event_categories is not None:
        ...
        out["event_categories"] = (
            aws_sdk_docdb.types.event_categories_list.deserialize_query(
