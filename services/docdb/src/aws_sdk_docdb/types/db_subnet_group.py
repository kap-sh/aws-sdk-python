...
if TYPE_CHECKING:
    import aws_sdk_docdb.types.network_type_list
    import aws_sdk_docdb.types.string
    import aws_sdk_docdb.types.subnet_list


class DBSubnetGroup(TypedDict):
    ...
    subnet_group_status: NotRequired["aws_sdk_docdb.types.string.String"]
    """<p>Provides the status of the subnet group.</p>"""
    subnets: NotRequired["aws_sdk_docdb.types.subnet_list.SubnetList"]
    """<p>Detailed information about one or more subnets within a subnet group.</p>"""
    db_subnet_group_arn: NotRequired["aws_sdk_docdb.types.string.String"]
    """<p>The Amazon Resource Name (ARN) for the DB subnet group.</p>"""
    supported_network_types: NotRequired[
        "aws_sdk_docdb.types.network_type_list.NetworkTypeList"
    ]
...
def serialize_query(
    ...
    if "subnets" in value:
        ...
        aws_sdk_docdb.types.subnet_list.serialize_query(
    ...
    if "supported_network_types" in value:
        ...
        aws_sdk_docdb.types.network_type_list.serialize_query(
...
def deserialize_query(el: Element) -> DBSubnetGroup:
    ...
    if child_subnets is not None:
        ...
        out["subnets"] = aws_sdk_docdb.types.subnet_list.deserialize_query(
            child_subnets
        )
    ...
    if child_supported_network_types is not None:
        ...
        out["supported_network_types"] = (
            aws_sdk_docdb.types.network_type_list.deserialize_query(
