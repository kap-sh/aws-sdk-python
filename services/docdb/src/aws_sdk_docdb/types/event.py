...
class Event(TypedDict):
    ...
    message: NotRequired["aws_sdk_docdb.types.string.String"]
    """<p>Provides the text of this event.</p>"""
    event_categories: NotRequired[
        "aws_sdk_docdb.types.event_categories_list.EventCategoriesList"
    ]
    """<p>Specifies the category for the event.</p>"""
    date: NotRequired["aws_sdk_docdb.types.t_stamp.TStamp"]
    """<p>Specifies the date and time of the event.</p>"""
    source_arn: NotRequired["aws_sdk_docdb.types.string.String"]
...
def deserialize_query(el: Element) -> Event:
    ...
    if child_date is not None:
        ...
        out["date"] = aws_sdk_docdb.types.t_stamp.deserialize_query(child_date)
