...
class DeleteDBClusterMessage(TypedDict):
    ...
    skip_final_snapshot: NotRequired["aws_sdk_docdb.types.boolean.Boolean"]
    ...
    final_db_snapshot_identifier: NotRequired["aws_sdk_docdb.types.string.String"]
