...
if TYPE_CHECKING:
    ...
    import aws_sdk_docdb.types.failover_status
...
class FailoverState(TypedDict):
    ...
    to_db_cluster_arn: NotRequired["aws_sdk_docdb.types.string.String"]
    ...
    is_data_loss_allowed: NotRequired["aws_sdk_docdb.types.boolean.Boolean"]
...
def serialize_query(
    ...
    if "status" in value:
        ...
        aws_sdk_docdb.types.failover_status.serialize_query(
...
def deserialize_query(el: Element) -> FailoverState:
    ...
    if child_status is not None:
        ...
        out["status"] = aws_sdk_docdb.types.failover_status.deserialize_query(
            child_status
        )
