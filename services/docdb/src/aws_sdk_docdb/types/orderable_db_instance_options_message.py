...
if TYPE_CHECKING:
    import aws_sdk_docdb.types.orderable_db_instance_options_list
...
class OrderableDBInstanceOptionsMessage(TypedDict, closed=True):
    orderable_db_instance_options: NotRequired[
        "aws_sdk_docdb.types.orderable_db_instance_options_list.OrderableDBInstanceOptionsList"
    ]
...
def serialize_query(
    ...
    if "orderable_db_instance_options" in value:
        ...
        aws_sdk_docdb.types.orderable_db_instance_options_list.serialize_query(
...
def deserialize_query(el: Element) -> OrderableDBInstanceOptionsMessage:
    ...
    if child_orderable_db_instance_options is not None:
        ...
        out["orderable_db_instance_options"] = (
            aws_sdk_docdb.types.orderable_db_instance_options_list.deserialize_query(
