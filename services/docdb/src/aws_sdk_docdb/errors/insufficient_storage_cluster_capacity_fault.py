"""Generated from Smithy shape ``com.amazonaws.docdb#InsufficientStorageClusterCapacityFault``."""
...
class InsufficientStorageClusterCapacityFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdb#InsufficientStorageClusterCapacityFault``."""
