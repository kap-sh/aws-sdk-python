"""Generated from Smithy shape ``com.amazonaws.docdb#InvalidDBClusterSnapshotStateFault``."""
...
class InvalidDBClusterSnapshotStateFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdb#InvalidDBClusterSnapshotStateFault``."""
