"""Generated from Smithy shape ``com.amazonaws.docdb#SubscriptionAlreadyExistFault``."""
...
class SubscriptionAlreadyExistFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdb#SubscriptionAlreadyExistFault``."""
