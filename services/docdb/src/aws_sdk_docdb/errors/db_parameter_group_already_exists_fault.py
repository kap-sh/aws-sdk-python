"""Generated from Smithy shape ``com.amazonaws.docdb#DBParameterGroupAlreadyExistsFault``."""
...
class DBParameterGroupAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdb#DBParameterGroupAlreadyExistsFault``."""
