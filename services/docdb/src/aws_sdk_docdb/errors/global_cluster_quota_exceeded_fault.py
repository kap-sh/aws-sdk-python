"""Generated from Smithy shape ``com.amazonaws.docdb#GlobalClusterQuotaExceededFault``."""
...
class GlobalClusterQuotaExceededFault_(TypedDict):
...
class GlobalClusterQuotaExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdb#GlobalClusterQuotaExceededFault``."""
