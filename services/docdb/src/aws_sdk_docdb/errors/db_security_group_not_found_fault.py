"""Generated from Smithy shape ``com.amazonaws.docdb#DBSecurityGroupNotFoundFault``."""
...
class DBSecurityGroupNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdb#DBSecurityGroupNotFoundFault``."""
