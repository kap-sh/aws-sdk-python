"""Generated from Smithy shape ``com.amazonaws.docdb#DBSnapshotAlreadyExistsFault``."""
...
class DBSnapshotAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdb#DBSnapshotAlreadyExistsFault``."""
