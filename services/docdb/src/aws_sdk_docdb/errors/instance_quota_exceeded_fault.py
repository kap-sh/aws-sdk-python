"""Generated from Smithy shape ``com.amazonaws.docdb#InstanceQuotaExceededFault``."""
...
class InstanceQuotaExceededFault_(TypedDict, closed=True):
...
class InstanceQuotaExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdb#InstanceQuotaExceededFault``."""
