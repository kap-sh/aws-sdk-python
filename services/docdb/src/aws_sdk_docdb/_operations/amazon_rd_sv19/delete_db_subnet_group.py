...
def build_request(
    ...
    input_: aws_sdk_docdb.types.delete_db_subnet_group_message.DeleteDBSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.delete_db_subnet_group_message.serialize_query(
        input_, pairs, ""
    )
