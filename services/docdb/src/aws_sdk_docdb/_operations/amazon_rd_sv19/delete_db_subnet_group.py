"""Generated from Smithy shape ``com.amazonaws.docdb#DeleteDBSubnetGroup``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDBSubnetStateFault":
            import aws_sdk_docdb.errors.invalid_db_subnet_state_fault

            raise aws_sdk_docdb.errors.invalid_db_subnet_state_fault.InvalidDBSubnetStateFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    input: aws_sdk_docdb.types.delete_db_subnet_group_message.DeleteDBSubnetGroupMessage,
) -> zapros.Request:
    ...
    aws_sdk_docdb.types.delete_db_subnet_group_message.serialize_query(input, pairs, "")
...
async def async_delete_db_subnet_group(
