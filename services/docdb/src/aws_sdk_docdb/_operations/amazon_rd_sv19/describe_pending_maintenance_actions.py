...
def handle_response(
    ...
    out: aws_sdk_docdb.types.pending_maintenance_actions_message.PendingMaintenanceActionsMessage = aws_sdk_docdb.types.pending_maintenance_actions_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.describe_pending_maintenance_actions_message.DescribePendingMaintenanceActionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
