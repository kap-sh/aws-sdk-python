"""Generated from Smithy shape ``com.amazonaws.docdb#SwitchoverGlobalCluster``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("SwitchoverGlobalClusterResult")
    out: aws_sdk_docdb.types.switchover_global_cluster_result.SwitchoverGlobalClusterResult = aws_sdk_docdb.types.switchover_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.switchover_global_cluster_message.SwitchoverGlobalClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.switchover_global_cluster_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_switchover_global_cluster(
