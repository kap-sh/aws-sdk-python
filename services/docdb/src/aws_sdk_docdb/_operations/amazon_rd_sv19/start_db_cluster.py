...
def handle_response(
    ...
    out: aws_sdk_docdb.types.start_db_cluster_result.StartDBClusterResult = (
        aws_sdk_docdb.types.start_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.start_db_cluster_message.StartDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.start_db_cluster_message.serialize_query(input_, pairs, "")
...
def start_db_cluster(
    ...
    aws_sdk_docdb.types.start_db_cluster_result.StartDBClusterResult, zapros.Response
]:
