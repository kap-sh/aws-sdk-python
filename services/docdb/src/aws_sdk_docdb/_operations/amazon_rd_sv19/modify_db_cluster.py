...
def handle_response(
    ...
    out: aws_sdk_docdb.types.modify_db_cluster_result.ModifyDBClusterResult = (
        aws_sdk_docdb.types.modify_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.modify_db_cluster_message.ModifyDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.modify_db_cluster_message.serialize_query(input_, pairs, "")
...
def modify_db_cluster(
    ...
    aws_sdk_docdb.types.modify_db_cluster_result.ModifyDBClusterResult, zapros.Response
]:
