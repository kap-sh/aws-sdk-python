...
def handle_response(
    ...
    out: aws_sdk_docdb.types.failover_global_cluster_result.FailoverGlobalClusterResult = aws_sdk_docdb.types.failover_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.failover_global_cluster_message.FailoverGlobalClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.failover_global_cluster_message.serialize_query(
        input_, pairs, ""
    )
