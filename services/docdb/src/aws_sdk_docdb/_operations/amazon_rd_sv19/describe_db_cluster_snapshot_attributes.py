...
def handle_response(
    ...
    out: aws_sdk_docdb.types.describe_db_cluster_snapshot_attributes_result.DescribeDBClusterSnapshotAttributesResult = aws_sdk_docdb.types.describe_db_cluster_snapshot_attributes_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.describe_db_cluster_snapshot_attributes_message.DescribeDBClusterSnapshotAttributesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.describe_db_cluster_snapshot_attributes_message.serialize_query(
        input_, pairs, ""
    )
