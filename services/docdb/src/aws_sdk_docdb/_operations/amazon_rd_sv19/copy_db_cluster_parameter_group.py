...
def handle_response(
    ...
    out: aws_sdk_docdb.types.copy_db_cluster_parameter_group_result.CopyDBClusterParameterGroupResult = aws_sdk_docdb.types.copy_db_cluster_parameter_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.copy_db_cluster_parameter_group_message.CopyDBClusterParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.copy_db_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
