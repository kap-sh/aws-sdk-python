...
def build_request(
    ...
    input: aws_sdk_docdb.types.delete_global_cluster_message.DeleteGlobalClusterMessage,
) -> zapros.Request:
    ...
    aws_sdk_docdb.types.delete_global_cluster_message.serialize_query(input, pairs, "")
