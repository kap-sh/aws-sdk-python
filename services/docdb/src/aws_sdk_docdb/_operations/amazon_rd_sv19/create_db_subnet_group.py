...
def build_request(
    ...
    input_: aws_sdk_docdb.types.create_db_subnet_group_message.CreateDBSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.create_db_subnet_group_message.serialize_query(
        input_, pairs, ""
    )
