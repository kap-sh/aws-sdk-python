...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBSubnetGroupAlreadyExistsFault":
            import aws_sdk_docdb.errors.db_subnet_group_already_exists_fault

            raise aws_sdk_docdb.errors.db_subnet_group_already_exists_fault.DBSubnetGroupAlreadyExistsFault.from_query(
                root
            )
        ...
        case "DBSubnetGroupQuotaExceededFault":
            import aws_sdk_docdb.errors.db_subnet_group_quota_exceeded_fault

            raise aws_sdk_docdb.errors.db_subnet_group_quota_exceeded_fault.DBSubnetGroupQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_docdb.types.create_db_subnet_group_result.CreateDBSubnetGroupResult = (
        aws_sdk_docdb.types.create_db_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_docdb.types.create_db_subnet_group_message.CreateDBSubnetGroupMessage,
) -> zapros.Request:
    ...
    aws_sdk_docdb.types.create_db_subnet_group_message.serialize_query(input, pairs, "")
