"""Generated from Smithy shape ``com.amazonaws.docdb#DescribeEngineDefaultClusterParameters``."""
...
import aws_sdk_docdb.types.engine_defaults
...
def handle_response(
    ...
    out: aws_sdk_docdb.types.describe_engine_default_cluster_parameters_result.DescribeEngineDefaultClusterParametersResult = aws_sdk_docdb.types.describe_engine_default_cluster_parameters_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.describe_engine_default_cluster_parameters_message.DescribeEngineDefaultClusterParametersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.describe_engine_default_cluster_parameters_message.serialize_query(
        input_, pairs, ""
    )
