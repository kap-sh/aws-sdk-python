"""Generated from Smithy shape ``com.amazonaws.docdb#AddTagsToResource``."""
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.add_tags_to_resource_message.AddTagsToResourceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.add_tags_to_resource_message.serialize_query(input_, pairs, "")
