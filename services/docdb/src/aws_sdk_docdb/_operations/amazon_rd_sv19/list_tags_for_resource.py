"""Generated from Smithy shape ``com.amazonaws.docdb#ListTagsForResource``."""
...
def handle_response(
    ...
    out: aws_sdk_docdb.types.tag_list_message.TagListMessage = (
        aws_sdk_docdb.types.tag_list_message.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_docdb.types.list_tags_for_resource_message.ListTagsForResourceMessage,
) -> zapros.Request:
    ...
    aws_sdk_docdb.types.list_tags_for_resource_message.serialize_query(input, pairs, "")
...
def list_tags_for_resource(
    ...
    input: aws_sdk_docdb.types.list_tags_for_resource_message.ListTagsForResourceMessage,
) -> tuple[aws_sdk_docdb.types.tag_list_message.TagListMessage, zapros.Response]:
