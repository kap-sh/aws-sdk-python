...
def build_request(
    ...
    input_: aws_sdk_docdb.types.list_tags_for_resource_message.ListTagsForResourceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.list_tags_for_resource_message.serialize_query(
        input_, pairs, ""
    )
