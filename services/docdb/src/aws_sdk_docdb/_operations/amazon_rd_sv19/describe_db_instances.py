"""Generated from Smithy shape ``com.amazonaws.docdb#DescribeDBInstances``."""
...
def handle_response(
    ...
    out: aws_sdk_docdb.types.db_instance_message.DBInstanceMessage = (
        aws_sdk_docdb.types.db_instance_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.describe_db_instances_message.DescribeDBInstancesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.describe_db_instances_message.serialize_query(input_, pairs, "")
...
def describe_db_instances(
    ...
    input_: aws_sdk_docdb.types.describe_db_instances_message.DescribeDBInstancesMessage,
) -> tuple[aws_sdk_docdb.types.db_instance_message.DBInstanceMessage, zapros.Response]:
