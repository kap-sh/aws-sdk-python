...
def build_request(
    ...
    input: aws_sdk_docdb.types.describe_db_instances_message.DescribeDBInstancesMessage,
) -> zapros.Request:
    ...
    aws_sdk_docdb.types.describe_db_instances_message.serialize_query(input, pairs, "")
