...
def build_request(
    ...
    input_: aws_sdk_docdb.types.create_db_instance_message.CreateDBInstanceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.create_db_instance_message.serialize_query(input_, pairs, "")
