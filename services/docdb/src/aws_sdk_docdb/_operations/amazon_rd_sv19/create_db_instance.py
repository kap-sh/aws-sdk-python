...
def build_request(
    ...
    input: aws_sdk_docdb.types.create_db_instance_message.CreateDBInstanceMessage,
) -> zapros.Request:
    ...
    aws_sdk_docdb.types.create_db_instance_message.serialize_query(input, pairs, "")
