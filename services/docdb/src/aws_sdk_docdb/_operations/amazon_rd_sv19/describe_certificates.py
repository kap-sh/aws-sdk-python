"""Generated from Smithy shape ``com.amazonaws.docdb#DescribeCertificates``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeCertificatesResult")
    out: aws_sdk_docdb.types.certificate_message.CertificateMessage = (
        aws_sdk_docdb.types.certificate_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.describe_certificates_message.DescribeCertificatesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeCertificates"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_docdb.types.describe_certificates_message

    aws_sdk_docdb.types.describe_certificates_message.serialize_query(input_, pairs, "")
...
def describe_certificates(
    ...
    input_: aws_sdk_docdb.types.describe_certificates_message.DescribeCertificatesMessage,
) -> tuple[aws_sdk_docdb.types.certificate_message.CertificateMessage, zapros.Response]:
...
async def async_describe_certificates(
