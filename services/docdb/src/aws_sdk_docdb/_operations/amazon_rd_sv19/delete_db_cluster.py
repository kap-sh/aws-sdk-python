...
def handle_response(
    ...
    out: aws_sdk_docdb.types.delete_db_cluster_result.DeleteDBClusterResult = (
        aws_sdk_docdb.types.delete_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.delete_db_cluster_message.DeleteDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.delete_db_cluster_message.serialize_query(input_, pairs, "")
...
def delete_db_cluster(
    ...
    aws_sdk_docdb.types.delete_db_cluster_result.DeleteDBClusterResult, zapros.Response
]:
