"""Generated from Smithy shape ``com.amazonaws.docdb#ModifyDBSubnetGroup``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBSubnetQuotaExceededFault":
            import aws_sdk_docdb.errors.db_subnet_quota_exceeded_fault

            raise aws_sdk_docdb.errors.db_subnet_quota_exceeded_fault.DBSubnetQuotaExceededFault.from_query(
                root
            )
        case "InvalidSubnet":
        ...
        case "SubnetAlreadyInUse":
            import aws_sdk_docdb.errors.subnet_already_in_use

            raise aws_sdk_docdb.errors.subnet_already_in_use.SubnetAlreadyInUse.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyDBSubnetGroupResult")
    out: aws_sdk_docdb.types.modify_db_subnet_group_result.ModifyDBSubnetGroupResult = (
        aws_sdk_docdb.types.modify_db_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    input: aws_sdk_docdb.types.modify_db_subnet_group_message.ModifyDBSubnetGroupMessage,
) -> zapros.Request:
    ...
    pairs.append(("Action", "ModifyDBSubnetGroup"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_docdb.types.modify_db_subnet_group_message

    aws_sdk_docdb.types.modify_db_subnet_group_message.serialize_query(input, pairs, "")
...
async def async_modify_db_subnet_group(
