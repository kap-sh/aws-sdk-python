...
def build_request(
    ...
    input_: aws_sdk_docdb.types.modify_db_subnet_group_message.ModifyDBSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.modify_db_subnet_group_message.serialize_query(
        input_, pairs, ""
    )
