...
def handle_response(
    ...
    out: aws_sdk_docdb.types.db_cluster_parameter_group_name_message.DBClusterParameterGroupNameMessage = aws_sdk_docdb.types.db_cluster_parameter_group_name_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.reset_db_cluster_parameter_group_message.ResetDBClusterParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.reset_db_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
