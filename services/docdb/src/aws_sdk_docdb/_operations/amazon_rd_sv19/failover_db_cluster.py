...
def build_request(
    ...
    input: aws_sdk_docdb.types.failover_db_cluster_message.FailoverDBClusterMessage,
) -> zapros.Request:
    ...
    aws_sdk_docdb.types.failover_db_cluster_message.serialize_query(input, pairs, "")
