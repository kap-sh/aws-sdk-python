...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBClusterParameterGroupNotFoundFault":
            import aws_sdk_docdb.errors.db_cluster_parameter_group_not_found_fault

            raise aws_sdk_docdb.errors.db_cluster_parameter_group_not_found_fault.DBClusterParameterGroupNotFoundFault.from_query(
                root
            )
        ...
        case "DBInstanceNotFoundFault":
            import aws_sdk_docdb.errors.db_instance_not_found_fault

            raise aws_sdk_docdb.errors.db_instance_not_found_fault.DBInstanceNotFoundFault.from_query(
                root
            )
        ...
        case "GlobalClusterNotFoundFault":
            import aws_sdk_docdb.errors.global_cluster_not_found_fault

            raise aws_sdk_docdb.errors.global_cluster_not_found_fault.GlobalClusterNotFoundFault.from_query(
                root
            )
        ...
        case "InvalidDBInstanceStateFault":
            import aws_sdk_docdb.errors.invalid_db_instance_state_fault

            raise aws_sdk_docdb.errors.invalid_db_instance_state_fault.InvalidDBInstanceStateFault.from_query(
                root
            )
        case "InvalidDBSubnetGroupStateFault":
            import aws_sdk_docdb.errors.invalid_db_subnet_group_state_fault

            raise aws_sdk_docdb.errors.invalid_db_subnet_group_state_fault.InvalidDBSubnetGroupStateFault.from_query(
                root
            )
        case "InvalidGlobalClusterStateFault":
            import aws_sdk_docdb.errors.invalid_global_cluster_state_fault

            raise aws_sdk_docdb.errors.invalid_global_cluster_state_fault.InvalidGlobalClusterStateFault.from_query(
                root
            )
        case "InvalidSubnet":
...
def handle_response(
    ...
    out: aws_sdk_docdb.types.create_db_cluster_result.CreateDBClusterResult = (
        aws_sdk_docdb.types.create_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.create_db_cluster_message.CreateDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.create_db_cluster_message.serialize_query(input_, pairs, "")
...
def create_db_cluster(
    ...
    aws_sdk_docdb.types.create_db_cluster_result.CreateDBClusterResult, zapros.Response
]:
