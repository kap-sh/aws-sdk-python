...
def handle_response(
    ...
    out: aws_sdk_docdb.types.db_cluster_parameter_group_details.DBClusterParameterGroupDetails = aws_sdk_docdb.types.db_cluster_parameter_group_details.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.describe_db_cluster_parameters_message.DescribeDBClusterParametersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.describe_db_cluster_parameters_message.serialize_query(
        input_, pairs, ""
    )
