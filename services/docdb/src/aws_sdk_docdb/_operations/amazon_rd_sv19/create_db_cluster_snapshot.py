...
def handle_response(
    ...
    out: aws_sdk_docdb.types.create_db_cluster_snapshot_result.CreateDBClusterSnapshotResult = aws_sdk_docdb.types.create_db_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.create_db_cluster_snapshot_message.CreateDBClusterSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.create_db_cluster_snapshot_message.serialize_query(
        input_, pairs, ""
    )
