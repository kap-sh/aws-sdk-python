"""Generated from Smithy shape ``com.amazonaws.docdb#CopyDBClusterSnapshot``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBClusterSnapshotAlreadyExistsFault":
            import aws_sdk_docdb.errors.db_cluster_snapshot_already_exists_fault

            raise aws_sdk_docdb.errors.db_cluster_snapshot_already_exists_fault.DBClusterSnapshotAlreadyExistsFault.from_query(
                root
            )
        ...
        case "SnapshotQuotaExceededFault":
            import aws_sdk_docdb.errors.snapshot_quota_exceeded_fault

            raise aws_sdk_docdb.errors.snapshot_quota_exceeded_fault.SnapshotQuotaExceededFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CopyDBClusterSnapshotResult")
    out: aws_sdk_docdb.types.copy_db_cluster_snapshot_result.CopyDBClusterSnapshotResult = aws_sdk_docdb.types.copy_db_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.copy_db_cluster_snapshot_message.CopyDBClusterSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.copy_db_cluster_snapshot_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_copy_db_cluster_snapshot(
