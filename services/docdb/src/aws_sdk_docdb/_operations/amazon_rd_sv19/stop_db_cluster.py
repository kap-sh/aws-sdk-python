"""Generated from Smithy shape ``com.amazonaws.docdb#StopDBCluster``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("StopDBClusterResult")
    out: aws_sdk_docdb.types.stop_db_cluster_result.StopDBClusterResult = (
        aws_sdk_docdb.types.stop_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.stop_db_cluster_message.StopDBClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "StopDBCluster"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_docdb.types.stop_db_cluster_message

    aws_sdk_docdb.types.stop_db_cluster_message.serialize_query(input_, pairs, "")
...
def stop_db_cluster(
    ...
    aws_sdk_docdb.types.stop_db_cluster_result.StopDBClusterResult, zapros.Response
]:
...
async def async_stop_db_cluster(
