...
def build_request(
    ...
    input: aws_sdk_docdb.types.describe_db_clusters_message.DescribeDBClustersMessage,
) -> zapros.Request:
    ...
    aws_sdk_docdb.types.describe_db_clusters_message.serialize_query(input, pairs, "")
