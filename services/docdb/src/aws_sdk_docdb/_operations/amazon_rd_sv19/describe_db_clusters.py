...
def handle_response(
    ...
    out: aws_sdk_docdb.types.db_cluster_message.DBClusterMessage = (
        aws_sdk_docdb.types.db_cluster_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.describe_db_clusters_message.DescribeDBClustersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.describe_db_clusters_message.serialize_query(input_, pairs, "")
...
def describe_db_clusters(
    ...
    input_: aws_sdk_docdb.types.describe_db_clusters_message.DescribeDBClustersMessage,
) -> tuple[aws_sdk_docdb.types.db_cluster_message.DBClusterMessage, zapros.Response]:
