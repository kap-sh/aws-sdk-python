...
def build_request(
    ...
    input: aws_sdk_docdb.types.reboot_db_instance_message.RebootDBInstanceMessage,
) -> zapros.Request:
    ...
    aws_sdk_docdb.types.reboot_db_instance_message.serialize_query(input, pairs, "")
