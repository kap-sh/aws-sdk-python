"""Generated from Smithy shape ``com.amazonaws.docdb#RebootDBInstance``."""
...
def handle_response(
    ...
    out: aws_sdk_docdb.types.reboot_db_instance_result.RebootDBInstanceResult = (
        aws_sdk_docdb.types.reboot_db_instance_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.reboot_db_instance_message.RebootDBInstanceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RebootDBInstance"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_docdb.types.reboot_db_instance_message

    aws_sdk_docdb.types.reboot_db_instance_message.serialize_query(input_, pairs, "")
