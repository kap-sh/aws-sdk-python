"""Generated from Smithy shape ``com.amazonaws.docdb#DeleteDBClusterParameterGroup``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDBParameterGroupStateFault":
            import aws_sdk_docdb.errors.invalid_db_parameter_group_state_fault

            raise aws_sdk_docdb.errors.invalid_db_parameter_group_state_fault.InvalidDBParameterGroupStateFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.delete_db_cluster_parameter_group_message.DeleteDBClusterParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.delete_db_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
