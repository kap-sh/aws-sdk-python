...
import aws_sdk_docdb.errors.resource_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundFault":
            raise aws_sdk_docdb.errors.resource_not_found_fault.ResourceNotFoundFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_docdb.types.apply_pending_maintenance_action_result.ApplyPendingMaintenanceActionResult = aws_sdk_docdb.types.apply_pending_maintenance_action_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.apply_pending_maintenance_action_message.ApplyPendingMaintenanceActionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.apply_pending_maintenance_action_message.serialize_query(
        input_, pairs, ""
    )
