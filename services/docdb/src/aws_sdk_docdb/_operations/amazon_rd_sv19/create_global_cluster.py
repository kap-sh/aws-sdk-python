...
import aws_sdk_docdb.errors.global_cluster_already_exists_fault
import aws_sdk_docdb.errors.global_cluster_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "GlobalClusterAlreadyExistsFault":
            raise aws_sdk_docdb.errors.global_cluster_already_exists_fault.GlobalClusterAlreadyExistsFault.from_query(
                root
            )
        case "GlobalClusterQuotaExceededFault":
            raise aws_sdk_docdb.errors.global_cluster_quota_exceeded_fault.GlobalClusterQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_docdb.types.create_global_cluster_result.CreateGlobalClusterResult = (
        aws_sdk_docdb.types.create_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.create_global_cluster_message.CreateGlobalClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.create_global_cluster_message.serialize_query(input_, pairs, "")
