...
def build_request(
    ...
    input: aws_sdk_docdb.types.modify_db_instance_message.ModifyDBInstanceMessage,
) -> zapros.Request:
    ...
    aws_sdk_docdb.types.modify_db_instance_message.serialize_query(input, pairs, "")
