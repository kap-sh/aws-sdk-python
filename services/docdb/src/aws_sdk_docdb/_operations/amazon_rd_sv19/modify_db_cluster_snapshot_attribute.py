"""Generated from Smithy shape ``com.amazonaws.docdb#ModifyDBClusterSnapshotAttribute``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SharedSnapshotQuotaExceededFault":
            import aws_sdk_docdb.errors.shared_snapshot_quota_exceeded_fault

            raise aws_sdk_docdb.errors.shared_snapshot_quota_exceeded_fault.SharedSnapshotQuotaExceededFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_docdb.types.modify_db_cluster_snapshot_attribute_result.ModifyDBClusterSnapshotAttributeResult = aws_sdk_docdb.types.modify_db_cluster_snapshot_attribute_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.modify_db_cluster_snapshot_attribute_message.ModifyDBClusterSnapshotAttributeMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.modify_db_cluster_snapshot_attribute_message.serialize_query(
        input_, pairs, ""
    )
