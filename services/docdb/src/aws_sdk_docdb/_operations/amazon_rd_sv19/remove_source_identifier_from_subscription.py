...
def handle_response(
    ...
    out: aws_sdk_docdb.types.remove_source_identifier_from_subscription_result.RemoveSourceIdentifierFromSubscriptionResult = aws_sdk_docdb.types.remove_source_identifier_from_subscription_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.remove_source_identifier_from_subscription_message.RemoveSourceIdentifierFromSubscriptionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.remove_source_identifier_from_subscription_message.serialize_query(
        input_, pairs, ""
    )
