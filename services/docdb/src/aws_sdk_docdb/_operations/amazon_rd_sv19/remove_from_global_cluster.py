"""Generated from Smithy shape ``com.amazonaws.docdb#RemoveFromGlobalCluster``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("RemoveFromGlobalClusterResult")
    out: aws_sdk_docdb.types.remove_from_global_cluster_result.RemoveFromGlobalClusterResult = aws_sdk_docdb.types.remove_from_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.remove_from_global_cluster_message.RemoveFromGlobalClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RemoveFromGlobalCluster"))
    pairs.append(("Version", "2014-10-31"))
    import aws_sdk_docdb.types.remove_from_global_cluster_message

    aws_sdk_docdb.types.remove_from_global_cluster_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_remove_from_global_cluster(
