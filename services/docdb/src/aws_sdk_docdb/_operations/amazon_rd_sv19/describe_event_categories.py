"""Generated from Smithy shape ``com.amazonaws.docdb#DescribeEventCategories``."""
...
def handle_response(
    ...
    out: aws_sdk_docdb.types.event_categories_message.EventCategoriesMessage = (
        aws_sdk_docdb.types.event_categories_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.describe_event_categories_message.DescribeEventCategoriesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.describe_event_categories_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_event_categories(
    ...
    aws_sdk_docdb.types.event_categories_message.EventCategoriesMessage, zapros.Response
]:
