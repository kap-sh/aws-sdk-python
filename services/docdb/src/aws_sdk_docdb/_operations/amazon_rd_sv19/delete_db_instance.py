...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBSnapshotAlreadyExistsFault":
            import aws_sdk_docdb.errors.db_snapshot_already_exists_fault

            raise aws_sdk_docdb.errors.db_snapshot_already_exists_fault.DBSnapshotAlreadyExistsFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_docdb.types.delete_db_instance_result.DeleteDBInstanceResult = (
        aws_sdk_docdb.types.delete_db_instance_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.delete_db_instance_message.DeleteDBInstanceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.delete_db_instance_message.serialize_query(input_, pairs, "")
