...
def build_request(
    ...
    input: aws_sdk_docdb.types.delete_db_instance_message.DeleteDBInstanceMessage,
) -> zapros.Request:
    ...
    aws_sdk_docdb.types.delete_db_instance_message.serialize_query(input, pairs, "")
