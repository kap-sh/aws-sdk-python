...
def build_request(
    ...
    input_: aws_sdk_docdb.types.modify_event_subscription_message.ModifyEventSubscriptionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.modify_event_subscription_message.serialize_query(
        input_, pairs, ""
    )
