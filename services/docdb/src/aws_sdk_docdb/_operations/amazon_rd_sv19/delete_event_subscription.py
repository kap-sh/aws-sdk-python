...
import aws_sdk_docdb.errors.invalid_event_subscription_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidEventSubscriptionStateFault":
            raise aws_sdk_docdb.errors.invalid_event_subscription_state_fault.InvalidEventSubscriptionStateFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_docdb.types.delete_event_subscription_result.DeleteEventSubscriptionResult = aws_sdk_docdb.types.delete_event_subscription_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.delete_event_subscription_message.DeleteEventSubscriptionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.delete_event_subscription_message.serialize_query(
        input_, pairs, ""
    )
