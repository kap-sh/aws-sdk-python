"""Generated from Smithy shape ``com.amazonaws.docdb#ModifyGlobalCluster``."""
...
def handle_response(
    ...
    out: aws_sdk_docdb.types.modify_global_cluster_result.ModifyGlobalClusterResult = (
        aws_sdk_docdb.types.modify_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_docdb.types.modify_global_cluster_message.ModifyGlobalClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_docdb.types.modify_global_cluster_message.serialize_query(input_, pairs, "")
