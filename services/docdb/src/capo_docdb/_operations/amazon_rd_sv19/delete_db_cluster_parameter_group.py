...
import capo_docdb.errors.invalid_db_parameter_group_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDBParameterGroupStateFault":
            raise capo_docdb.errors.invalid_db_parameter_group_state_fault.InvalidDBParameterGroupStateFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    capo_docdb.types.delete_db_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
