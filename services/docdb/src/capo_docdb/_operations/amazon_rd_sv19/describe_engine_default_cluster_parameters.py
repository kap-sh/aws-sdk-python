...
import capo_docdb.types.engine_defaults
...
def handle_response(
    ...
    out: capo_docdb.types.describe_engine_default_cluster_parameters_result.DescribeEngineDefaultClusterParametersResult = capo_docdb.types.describe_engine_default_cluster_parameters_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.describe_engine_default_cluster_parameters_message.serialize_query(
        input_, pairs, ""
    )
