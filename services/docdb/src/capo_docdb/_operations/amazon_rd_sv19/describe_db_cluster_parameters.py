"""Generated from Smithy shape ``com.amazonaws.docdb#DescribeDBClusterParameters``."""
...
def handle_response(
    ...
    out: capo_docdb.types.db_cluster_parameter_group_details.DBClusterParameterGroupDetails = capo_docdb.types.db_cluster_parameter_group_details.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.describe_db_cluster_parameters_message.serialize_query(
        input_, pairs, ""
    )
