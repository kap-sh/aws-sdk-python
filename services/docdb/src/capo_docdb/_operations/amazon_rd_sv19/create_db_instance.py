"""Generated from Smithy shape ``com.amazonaws.docdb#CreateDBInstance``."""
...
import capo_docdb.errors.instance_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InstanceQuotaExceededFault":
            raise capo_docdb.errors.instance_quota_exceeded_fault.InstanceQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_docdb.types.create_db_instance_result.CreateDBInstanceResult = (
        capo_docdb.types.create_db_instance_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.create_db_instance_message.serialize_query(input_, pairs, "")
...
def create_db_instance(
    ...
    capo_docdb.types.create_db_instance_result.CreateDBInstanceResult, zapros.Response
]:
