"""Generated from Smithy shape ``com.amazonaws.docdb#DeleteDBInstance``."""
...
import capo_docdb.errors.db_snapshot_already_exists_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBSnapshotAlreadyExistsFault":
            raise capo_docdb.errors.db_snapshot_already_exists_fault.DBSnapshotAlreadyExistsFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_docdb.types.delete_db_instance_result.DeleteDBInstanceResult = (
        capo_docdb.types.delete_db_instance_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.delete_db_instance_message.serialize_query(input_, pairs, "")
...
def delete_db_instance(
    ...
    capo_docdb.types.delete_db_instance_result.DeleteDBInstanceResult, zapros.Response
]:
