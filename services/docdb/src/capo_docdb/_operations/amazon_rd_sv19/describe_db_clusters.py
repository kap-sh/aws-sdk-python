"""Generated from Smithy shape ``com.amazonaws.docdb#DescribeDBClusters``."""
...
def handle_response(
    ...
    out: capo_docdb.types.db_cluster_message.DBClusterMessage = (
        capo_docdb.types.db_cluster_message.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.describe_db_clusters_message.serialize_query(input_, pairs, "")
...
def describe_db_clusters(
    ...
    input_: capo_docdb.types.describe_db_clusters_message.DescribeDBClustersMessage,
) -> tuple[capo_docdb.types.db_cluster_message.DBClusterMessage, zapros.Response]:
