...
def handle_response(
    ...
    out: capo_docdb.types.db_engine_version_message.DBEngineVersionMessage = (
        capo_docdb.types.db_engine_version_message.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.describe_db_engine_versions_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_db_engine_versions(
    ...
    capo_docdb.types.db_engine_version_message.DBEngineVersionMessage, zapros.Response
]:
