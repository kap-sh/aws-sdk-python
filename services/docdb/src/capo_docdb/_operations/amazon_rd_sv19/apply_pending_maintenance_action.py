"""Generated from Smithy shape ``com.amazonaws.docdb#ApplyPendingMaintenanceAction``."""
...
import capo_docdb.errors.resource_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundFault":
            raise capo_docdb.errors.resource_not_found_fault.ResourceNotFoundFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_docdb.types.apply_pending_maintenance_action_result.ApplyPendingMaintenanceActionResult = capo_docdb.types.apply_pending_maintenance_action_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.apply_pending_maintenance_action_message.serialize_query(
        input_, pairs, ""
    )
