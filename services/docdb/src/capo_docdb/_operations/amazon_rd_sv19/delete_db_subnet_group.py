...
import capo_docdb.errors.invalid_db_subnet_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDBSubnetStateFault":
            raise capo_docdb.errors.invalid_db_subnet_state_fault.InvalidDBSubnetStateFault.from_query(
                root
            )
        case _:
...
def build_request(
    ...
    capo_docdb.types.delete_db_subnet_group_message.serialize_query(input_, pairs, "")
