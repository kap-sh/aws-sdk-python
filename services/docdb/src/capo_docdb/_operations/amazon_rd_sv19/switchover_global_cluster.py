...
def handle_response(
    ...
    out: capo_docdb.types.switchover_global_cluster_result.SwitchoverGlobalClusterResult = capo_docdb.types.switchover_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.switchover_global_cluster_message.serialize_query(
        input_, pairs, ""
    )
