...
import capo_docdb.errors.db_subnet_quota_exceeded_fault
import capo_docdb.errors.invalid_subnet
import capo_docdb.errors.subnet_already_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBSubnetQuotaExceededFault":
            raise capo_docdb.errors.db_subnet_quota_exceeded_fault.DBSubnetQuotaExceededFault.from_query(
                root
            )
        case "InvalidSubnet":
            raise capo_docdb.errors.invalid_subnet.InvalidSubnet.from_query(root)
        case "SubnetAlreadyInUse":
            raise capo_docdb.errors.subnet_already_in_use.SubnetAlreadyInUse.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_docdb.types.modify_db_subnet_group_result.ModifyDBSubnetGroupResult = (
        capo_docdb.types.modify_db_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.modify_db_subnet_group_message.serialize_query(input_, pairs, "")
