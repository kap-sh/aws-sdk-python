...
def handle_response(
    ...
    out: capo_docdb.types.orderable_db_instance_options_message.OrderableDBInstanceOptionsMessage = capo_docdb.types.orderable_db_instance_options_message.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.describe_orderable_db_instance_options_message.serialize_query(
        input_, pairs, ""
    )
