"""Generated from Smithy shape ``com.amazonaws.docdb#ModifyEventSubscription``."""
...
import capo_docdb.errors.subscription_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubscriptionNotFoundFault":
            raise capo_docdb.errors.subscription_not_found_fault.SubscriptionNotFoundFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_docdb.types.modify_event_subscription_result.ModifyEventSubscriptionResult = capo_docdb.types.modify_event_subscription_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.modify_event_subscription_message.serialize_query(
        input_, pairs, ""
    )
