...
import capo_docdb.errors.shared_snapshot_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SharedSnapshotQuotaExceededFault":
            raise capo_docdb.errors.shared_snapshot_quota_exceeded_fault.SharedSnapshotQuotaExceededFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_docdb.types.modify_db_cluster_snapshot_attribute_result.ModifyDBClusterSnapshotAttributeResult = capo_docdb.types.modify_db_cluster_snapshot_attribute_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.modify_db_cluster_snapshot_attribute_message.serialize_query(
        input_, pairs, ""
    )
