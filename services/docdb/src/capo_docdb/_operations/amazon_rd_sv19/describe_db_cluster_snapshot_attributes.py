"""Generated from Smithy shape ``com.amazonaws.docdb#DescribeDBClusterSnapshotAttributes``."""
...
def handle_response(
    ...
    out: capo_docdb.types.describe_db_cluster_snapshot_attributes_result.DescribeDBClusterSnapshotAttributesResult = capo_docdb.types.describe_db_cluster_snapshot_attributes_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.describe_db_cluster_snapshot_attributes_message.serialize_query(
        input_, pairs, ""
    )
