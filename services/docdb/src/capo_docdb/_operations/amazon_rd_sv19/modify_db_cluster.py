"""Generated from Smithy shape ``com.amazonaws.docdb#ModifyDBCluster``."""
...
def handle_response(
    ...
    out: capo_docdb.types.modify_db_cluster_result.ModifyDBClusterResult = (
        capo_docdb.types.modify_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.modify_db_cluster_message.serialize_query(input_, pairs, "")
...
def modify_db_cluster(
    ...
    capo_docdb.types.modify_db_cluster_result.ModifyDBClusterResult, zapros.Response
]:
