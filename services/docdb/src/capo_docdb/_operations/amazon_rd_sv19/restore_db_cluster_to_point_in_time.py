...
def handle_response(
    ...
    out: capo_docdb.types.restore_db_cluster_to_point_in_time_result.RestoreDBClusterToPointInTimeResult = capo_docdb.types.restore_db_cluster_to_point_in_time_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.restore_db_cluster_to_point_in_time_message.serialize_query(
        input_, pairs, ""
    )
