"""Generated from Smithy shape ``com.amazonaws.docdb#DeleteDBCluster``."""
...
import capo_docdb.errors.db_cluster_snapshot_already_exists_fault
import capo_docdb.errors.invalid_db_cluster_snapshot_state_fault
import capo_docdb.errors.invalid_db_cluster_state_fault
import capo_docdb.errors.snapshot_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBClusterSnapshotAlreadyExistsFault":
            raise capo_docdb.errors.db_cluster_snapshot_already_exists_fault.DBClusterSnapshotAlreadyExistsFault.from_query(
                root
            )
        ...
        case "SnapshotQuotaExceededFault":
            raise capo_docdb.errors.snapshot_quota_exceeded_fault.SnapshotQuotaExceededFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_docdb.types.delete_db_cluster_result.DeleteDBClusterResult = (
        capo_docdb.types.delete_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.delete_db_cluster_message.serialize_query(input_, pairs, "")
...
def delete_db_cluster(
    ...
    capo_docdb.types.delete_db_cluster_result.DeleteDBClusterResult, zapros.Response
]:
