...
class PendingCloudwatchLogsExports(TypedDict, closed=True):
    log_types_to_enable: NotRequired["capo_docdb.types.log_type_list.LogTypeList"]
    ...
    log_types_to_disable: NotRequired["capo_docdb.types.log_type_list.LogTypeList"]
...
def deserialize_query(el: Element) -> PendingCloudwatchLogsExports:
    ...
    if child_log_types_to_enable is not None:
        ...
        out["log_types_to_enable"] = capo_docdb.types.log_type_list.deserialize_query(
    ...
    if child_log_types_to_disable is not None:
        ...
        out["log_types_to_disable"] = capo_docdb.types.log_type_list.deserialize_query(
