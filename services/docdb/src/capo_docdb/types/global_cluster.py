...
if TYPE_CHECKING:
    ...
    import capo_docdb.types.failover_state
    import capo_docdb.types.global_cluster_identifier
    import capo_docdb.types.global_cluster_member_list
...
class GlobalCluster(TypedDict, closed=True):
    ...
    global_cluster_resource_id: NotRequired["capo_docdb.types.string.String"]
    ...
    global_cluster_arn: NotRequired["capo_docdb.types.string.String"]
    ...
    database_name: NotRequired["capo_docdb.types.string.String"]
    ...
    global_cluster_members: NotRequired[
        "capo_docdb.types.global_cluster_member_list.GlobalClusterMemberList"
    ]
    """<p>The list of cluster IDs for secondary clusters within the global cluster. Currently limited to one item. </p>"""
    failover_state: NotRequired["capo_docdb.types.failover_state.FailoverState"]
...
def serialize_query(
    ...
    if "global_cluster_members" in value:
        ...
        capo_docdb.types.global_cluster_member_list.serialize_query(
            value["global_cluster_members"], pairs, f"{prefix}.GlobalClusterMembers"
        )
    if "failover_state" in value:
        import capo_docdb.types.failover_state

        capo_docdb.types.failover_state.serialize_query(
...
def deserialize_query(el: Element) -> GlobalCluster:
    ...
    if child_global_cluster_members is not None:
        ...
        out["global_cluster_members"] = (
            capo_docdb.types.global_cluster_member_list.deserialize_query(
    ...
    if child_failover_state is not None:
        ...
        out["failover_state"] = capo_docdb.types.failover_state.deserialize_query(
