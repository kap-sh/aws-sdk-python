...
class EventSubscription(TypedDict, closed=True):
    customer_aws_id: NotRequired["capo_docdb.types.string.String"]
    ...
    cust_subscription_id: NotRequired["capo_docdb.types.string.String"]
    ...
    subscription_creation_time: NotRequired["capo_docdb.types.string.String"]
    ...
    source_ids_list: NotRequired["capo_docdb.types.source_ids_list.SourceIdsList"]
    ...
    enabled: NotRequired["capo_docdb.types.boolean.Boolean"]
    ...
    event_subscription_arn: NotRequired["capo_docdb.types.string.String"]
...
def deserialize_query(el: Element) -> EventSubscription:
    ...
    if child_source_ids_list is not None:
        ...
        out["source_ids_list"] = capo_docdb.types.source_ids_list.deserialize_query(
