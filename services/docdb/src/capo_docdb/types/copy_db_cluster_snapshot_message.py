...
class CopyDBClusterSnapshotMessage(TypedDict, closed=True):
    source_db_cluster_snapshot_identifier: NotRequired["capo_docdb.types.string.String"]
    ...
    target_db_cluster_snapshot_identifier: NotRequired["capo_docdb.types.string.String"]
    ...
    copy_tags: NotRequired["capo_docdb.types.boolean_optional.BooleanOptional"]
...
def serialize_query(
    ...
    if "source_db_cluster_snapshot_identifier" in value:
        pairs.append(
            (
                f"{key_prefix}SourceDBClusterSnapshotIdentifier",
    ...
    if "target_db_cluster_snapshot_identifier" in value:
        pairs.append(
            (
                f"{key_prefix}TargetDBClusterSnapshotIdentifier",
