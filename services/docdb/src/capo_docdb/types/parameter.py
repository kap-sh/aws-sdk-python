...
if TYPE_CHECKING:
    import capo_docdb.types.apply_method
    import capo_docdb.types.boolean
    import capo_docdb.types.string


class Parameter(TypedDict, closed=True):
    parameter_name: NotRequired["capo_docdb.types.string.String"]
    """<p>Specifies the name of the parameter.</p>"""
    parameter_value: NotRequired["capo_docdb.types.string.String"]
    ...
    apply_type: NotRequired["capo_docdb.types.string.String"]
    """<p>Specifies the engine-specific parameters type.</p>"""
    data_type: NotRequired["capo_docdb.types.string.String"]
    """<p>Specifies the valid data type for the parameter.</p>"""
    allowed_values: NotRequired["capo_docdb.types.string.String"]
    """<p>Specifies the valid range of values for the parameter.</p>"""
    is_modifiable: NotRequired["capo_docdb.types.boolean.Boolean"]
    ...
    minimum_engine_version: NotRequired["capo_docdb.types.string.String"]
    """<p>The earliest engine version to which the parameter can apply.</p>"""
    apply_method: NotRequired["capo_docdb.types.apply_method.ApplyMethod"]
...
def serialize_query(
    ...
    if "apply_method" in value:
        ...
        capo_docdb.types.apply_method.serialize_query(
...
def deserialize_query(el: Element) -> Parameter:
    ...
    if child_apply_method is not None:
        ...
        out["apply_method"] = capo_docdb.types.apply_method.deserialize_query(
            child_apply_method
        )
    return out
