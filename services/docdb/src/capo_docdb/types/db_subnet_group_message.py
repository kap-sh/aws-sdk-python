...
if TYPE_CHECKING:
    import capo_docdb.types.db_subnet_groups
...
class DBSubnetGroupMessage(TypedDict, closed=True):
    ...
    db_subnet_groups: NotRequired["capo_docdb.types.db_subnet_groups.DBSubnetGroups"]
...
def serialize_query(
    ...
    if "db_subnet_groups" in value:
        ...
        capo_docdb.types.db_subnet_groups.serialize_query(
...
def deserialize_query(el: Element) -> DBSubnetGroupMessage:
    ...
    if child_db_subnet_groups is not None:
        ...
        out["db_subnet_groups"] = capo_docdb.types.db_subnet_groups.deserialize_query(
