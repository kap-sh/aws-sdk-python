"""Generated from Smithy shape ``com.amazonaws.docdb#DBClusterMember``."""
...
class DBClusterMember(TypedDict, closed=True):
    ...
    is_cluster_writer: NotRequired["capo_docdb.types.boolean.Boolean"]
    ...
    db_cluster_parameter_group_status: NotRequired["capo_docdb.types.string.String"]
