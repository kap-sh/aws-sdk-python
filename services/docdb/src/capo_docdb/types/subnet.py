"""Generated from Smithy shape ``com.amazonaws.docdb#Subnet``."""
...
class Subnet(TypedDict, closed=True):
    subnet_identifier: NotRequired["capo_docdb.types.string.String"]
    """<p>Specifies the identifier of the subnet.</p>"""
    subnet_availability_zone: NotRequired[
        "capo_docdb.types.availability_zone.AvailabilityZone"
    ]
    """<p>Specifies the Availability Zone for the subnet.</p>"""
    subnet_status: NotRequired["capo_docdb.types.string.String"]
...
def deserialize_query(el: Element) -> Subnet:
    ...
    if child_subnet_availability_zone is not None:
        ...
        out["subnet_availability_zone"] = (
            capo_docdb.types.availability_zone.deserialize_query(
