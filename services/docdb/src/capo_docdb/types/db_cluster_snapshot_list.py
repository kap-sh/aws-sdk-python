"""Generated from Smithy shape ``com.amazonaws.docdb#DBClusterSnapshotList``."""
...
DBClusterSnapshotList: TypeAlias = list[
    "capo_docdb.types.db_cluster_snapshot.DBClusterSnapshot"
]
...
def deserialize_query(el: Element) -> DBClusterSnapshotList:
    ...
    for child in el.findall("DBClusterSnapshot"):
        out.append(capo_docdb.types.db_cluster_snapshot.deserialize_query(child))
    return out
