...
class DBInstance(TypedDict, closed=True):
    ...
    db_instance_status: NotRequired["capo_docdb.types.string.String"]
    """<p>Specifies the current state of this database.</p>"""
    endpoint: NotRequired["capo_docdb.types.endpoint.Endpoint"]
    """<p>Specifies the connection endpoint.</p>"""
    instance_create_time: NotRequired["capo_docdb.types.t_stamp.TStamp"]
    ...
    backup_retention_period: NotRequired["capo_docdb.types.integer.Integer"]
    ...
    pending_modified_values: NotRequired[
        "capo_docdb.types.pending_modified_values.PendingModifiedValues"
    ]
    ...
    auto_minor_version_upgrade: NotRequired["capo_docdb.types.boolean.Boolean"]
    ...
    publicly_accessible: NotRequired["capo_docdb.types.boolean.Boolean"]
    ...
    status_infos: NotRequired[
        "capo_docdb.types.db_instance_status_info_list.DBInstanceStatusInfoList"
    ]
    ...
    dbi_resource_id: NotRequired["capo_docdb.types.string.String"]
    ...
    db_instance_arn: NotRequired["capo_docdb.types.string.String"]
    ...
    certificate_details: NotRequired[
        "capo_docdb.types.certificate_details.CertificateDetails"
    ]
...
def deserialize_query(el: Element) -> DBInstance:
    ...
    if child_endpoint is not None:
        ...
        out["endpoint"] = capo_docdb.types.endpoint.deserialize_query(child_endpoint)
    child_instance_create_time = el.find("InstanceCreateTime")
    if child_instance_create_time is not None:
        import capo_docdb.types.t_stamp

        out["instance_create_time"] = capo_docdb.types.t_stamp.deserialize_query(
    ...
    if child_pending_modified_values is not None:
        ...
        out["pending_modified_values"] = (
            capo_docdb.types.pending_modified_values.deserialize_query(
    ...
    if child_status_infos is not None:
        ...
        out["status_infos"] = (
            capo_docdb.types.db_instance_status_info_list.deserialize_query(
                child_status_infos
            )
        )
    ...
    if child_certificate_details is not None:
        ...
        out["certificate_details"] = (
            capo_docdb.types.certificate_details.deserialize_query(
