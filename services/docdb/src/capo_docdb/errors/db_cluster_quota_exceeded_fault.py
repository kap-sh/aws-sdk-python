"""Generated from Smithy shape ``com.amazonaws.docdb#DBClusterQuotaExceededFault``."""
...
class DBClusterQuotaExceededFault_(TypedDict, closed=True):
...
class DBClusterQuotaExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdb#DBClusterQuotaExceededFault``."""
