"""Generated from Smithy shape ``com.amazonaws.docdb#DBInstanceNotFoundFault``."""
...
class DBInstanceNotFoundFault_(TypedDict, closed=True):
...
class DBInstanceNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdb#DBInstanceNotFoundFault``."""
