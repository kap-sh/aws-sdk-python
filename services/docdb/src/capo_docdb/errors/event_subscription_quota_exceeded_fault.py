"""Generated from Smithy shape ``com.amazonaws.docdb#EventSubscriptionQuotaExceededFault``."""
...
class EventSubscriptionQuotaExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdb#EventSubscriptionQuotaExceededFault``."""
