...
class DocDBError(Exception):
    """Base class for all DocDB service errors."""


class ServiceError(DocDBError):
...
class SerializationError(DocDBError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DocDBError):
...
class WaiterFailedError(DocDBError):
...
class WaiterTimeoutError(DocDBError):
