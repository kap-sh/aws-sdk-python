"""Generated from Smithy shape ``com.amazonaws.docdb#DBClusterSnapshotNotFoundFault``."""
...
class DBClusterSnapshotNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdb#DBClusterSnapshotNotFoundFault``."""
