"""Generated from Smithy shape ``com.amazonaws.docdb#AuthorizationNotFoundFault``."""
...
class AuthorizationNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdb#AuthorizationNotFoundFault``."""
