...
```
pip install aws-sdk-bedrock-data-automation-runtime
```

## Usage

```python
from aws_sdk_bedrock_data_automation_runtime import AsyncBedrockDataAutomationRuntimeClient
...
```python
from aws_sdk_bedrock_data_automation_runtime import AsyncBedrockDataAutomationRuntimeClient
from aws_sdk_bedrock_data_automation_runtime.error import AccessDeniedException
