"""Generated from Smithy shape ``com.amazonaws.bedrockdataautomationruntime#InvokeDataAutomation``."""
...
import capo_bedrock_data_automation_runtime.errors.service_unavailable_exception
import capo_bedrock_data_automation_runtime.errors.throttling_exception
import capo_bedrock_data_automation_runtime.errors.validation_exception
...
from capo_bedrock_data_automation_runtime._protocol.errors import (
    parse_error_metadata_json,
)
from capo_bedrock_data_automation_runtime._rule_engine._endpoint_rule_set import (
    EndpointParams,
    resolve,
)
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceUnavailableException":
            raise capo_bedrock_data_automation_runtime.errors.service_unavailable_exception.ServiceUnavailableException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_bedrock_data_automation_runtime.types.invoke_data_automation_response.InvokeDataAutomationResponse = capo_bedrock_data_automation_runtime.types.invoke_data_automation_response.deserialize_aws_json_1_1(
...
def get_signer(
...
) -> capo_bedrock_data_automation_runtime._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_bedrock_data_automation_runtime._auth._sigv4.build_sigv4_auth_scheme(
                "bedrock", options.region, endpoint_scheme
            )
            if sigv4_config is not None:
                return capo_bedrock_data_automation_runtime._auth._signers.SigV4Signer(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonBedrockKeystoneRuntimeService.InvokeDataAutomation"
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation_runtime.types.invoke_data_automation_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_invoke_data_automation(
