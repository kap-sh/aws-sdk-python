...
def handle_response(
    ...
    out: capo_bedrock_data_automation_runtime.types.get_data_automation_status_response.GetDataAutomationStatusResponse = capo_bedrock_data_automation_runtime.types.get_data_automation_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation_runtime.types.get_data_automation_status_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
