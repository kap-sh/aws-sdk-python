"""Generated from Smithy shape ``com.amazonaws.bedrockdataautomationruntime#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_bedrock_data_automation_runtime.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_bedrock_data_automation_runtime.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonBedrockKeystoneRuntimeService.ListTagsForResource"
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation_runtime.types.list_tags_for_resource_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
