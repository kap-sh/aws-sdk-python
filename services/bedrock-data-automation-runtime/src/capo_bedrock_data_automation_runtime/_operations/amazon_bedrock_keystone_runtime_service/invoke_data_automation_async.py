...
def handle_response(
    ...
    out: capo_bedrock_data_automation_runtime.types.invoke_data_automation_async_response.InvokeDataAutomationAsyncResponse = capo_bedrock_data_automation_runtime.types.invoke_data_automation_async_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock_data_automation_runtime.types.invoke_data_automation_async_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
