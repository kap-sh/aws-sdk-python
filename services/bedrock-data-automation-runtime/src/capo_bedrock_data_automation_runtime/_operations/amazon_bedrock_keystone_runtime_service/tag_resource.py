...
import capo_bedrock_data_automation_runtime.errors.service_quota_exceeded_exception
...
def handle_response(
    ...
    out: capo_bedrock_data_automation_runtime.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
