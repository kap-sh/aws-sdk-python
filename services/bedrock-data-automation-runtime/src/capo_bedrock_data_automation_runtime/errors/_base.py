...
class BedrockDataAutomationRuntimeError(Exception):
    """Base class for all BedrockDataAutomationRuntime service errors."""


class ServiceError(BedrockDataAutomationRuntimeError):
...
class SerializationError(BedrockDataAutomationRuntimeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(BedrockDataAutomationRuntimeError):
...
class WaiterFailedError(BedrockDataAutomationRuntimeError):
...
class WaiterTimeoutError(BedrockDataAutomationRuntimeError):
