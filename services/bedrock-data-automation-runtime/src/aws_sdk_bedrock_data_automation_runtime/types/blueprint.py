...
class Blueprint(TypedDict):
    blueprint_arn: "aws_sdk_bedrock_data_automation_runtime.types.blueprint_arn.BlueprintArn"
    """Arn of blueprint."""
    version: NotRequired["aws_sdk_bedrock_data_automation_runtime.types.blueprint_version.BlueprintVersion"]
    """Version of blueprint."""
    stage: NotRequired["aws_sdk_bedrock_data_automation_runtime.types.blueprint_stage.BlueprintStage"]
    """Stage of blueprint."""
...
def serialize_aws_json_1_1(value: Blueprint) -> dict:
    ...
    if "stage" in value:
        import aws_sdk_bedrock_data_automation_runtime.types.blueprint_stage
        out["stage"] = aws_sdk_bedrock_data_automation_runtime.types.blueprint_stage.serialize_aws_json_1_1(value["stage"])
    return out
...
def deserialize_aws_json_1_1(data: dict) -> Blueprint:
    ...
    if "stage" in data:
        import aws_sdk_bedrock_data_automation_runtime.types.blueprint_stage
        out["stage"] = aws_sdk_bedrock_data_automation_runtime.types.blueprint_stage.deserialize_aws_json_1_1(data["stage"])
    return out