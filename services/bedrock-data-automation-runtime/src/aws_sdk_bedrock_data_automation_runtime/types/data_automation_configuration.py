...
class DataAutomationConfiguration(TypedDict):
    ...
    stage: NotRequired[
        "aws_sdk_bedrock_data_automation_runtime.types.data_automation_stage.DataAutomationStage"
    ]
...
def serialize_aws_json_1_1(value: DataAutomationConfiguration) -> dict:
    ...
    if "stage" in value:
        ...
        out["stage"] = (
            aws_sdk_bedrock_data_automation_runtime.types.data_automation_stage.serialize_aws_json_1_1(
                value["stage"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DataAutomationConfiguration:
    ...
    if "stage" in data:
        ...
        out["stage"] = (
            aws_sdk_bedrock_data_automation_runtime.types.data_automation_stage.deserialize_aws_json_1_1(
                data["stage"]
            )
        )
    return out
