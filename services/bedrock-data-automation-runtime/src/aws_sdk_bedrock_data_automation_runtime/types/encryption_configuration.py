...
class EncryptionConfiguration(TypedDict):
    ...
    kms_encryption_context: NotRequired["aws_sdk_bedrock_data_automation_runtime.types.encryption_context_map.EncryptionContextMap"]
...
def serialize_aws_json_1_1(value: EncryptionConfiguration) -> dict:
    ...
    if "kms_encryption_context" in value:
        import aws_sdk_bedrock_data_automation_runtime.types.encryption_context_map
        out["kmsEncryptionContext"] = aws_sdk_bedrock_data_automation_runtime.types.encryption_context_map.serialize_aws_json_1_1(value["kms_encryption_context"])
    return out
...
def deserialize_aws_json_1_1(data: dict) -> EncryptionConfiguration:
    ...
    if "kmsEncryptionContext" in data:
        import aws_sdk_bedrock_data_automation_runtime.types.encryption_context_map
        out["kms_encryption_context"] = aws_sdk_bedrock_data_automation_runtime.types.encryption_context_map.deserialize_aws_json_1_1(data["kmsEncryptionContext"])
    return out