...
if TYPE_CHECKING:
    import aws_sdk_bedrock_data_automation_runtime.types.custom_output_status


class OutputSegment(TypedDict):
    custom_output_status: NotRequired[
        "aws_sdk_bedrock_data_automation_runtime.types.custom_output_status.CustomOutputStatus"
    ]
...
def serialize_aws_json_1_1(value: OutputSegment) -> dict:
    ...
    if "custom_output_status" in value:
        ...
        out["customOutputStatus"] = (
            aws_sdk_bedrock_data_automation_runtime.types.custom_output_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> OutputSegment:
    ...
    if "customOutputStatus" in data:
        ...
        out["custom_output_status"] = (
            aws_sdk_bedrock_data_automation_runtime.types.custom_output_status.deserialize_aws_json_1_1(
