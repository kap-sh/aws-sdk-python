...
if TYPE_CHECKING:
    import aws_sdk_bedrock_data_automation_runtime.types.asset_processing_configuration
...
class InputConfiguration(TypedDict, closed=True):
    ...
    asset_processing_configuration: NotRequired[
        "aws_sdk_bedrock_data_automation_runtime.types.asset_processing_configuration.AssetProcessingConfiguration"
    ]
...
def serialize_aws_json_1_1(value: InputConfiguration) -> dict:
    ...
    if "asset_processing_configuration" in value:
        ...
        out["assetProcessingConfiguration"] = (
            aws_sdk_bedrock_data_automation_runtime.types.asset_processing_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InputConfiguration:
    ...
    if "assetProcessingConfiguration" in data:
        ...
        out["asset_processing_configuration"] = (
            aws_sdk_bedrock_data_automation_runtime.types.asset_processing_configuration.deserialize_aws_json_1_1(
