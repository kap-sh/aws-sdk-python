"""Generated from Smithy shape ``com.amazonaws.bedrockdataautomationruntime#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockdataautomationruntime#ResourceNotFoundException``."""
