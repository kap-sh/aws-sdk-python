...
from aws_sdk_bedrock_data_automation_runtime._services._aws_config import aaws_config
...
class AsyncBedrockDataAutomationRuntimeClient:
    ...
    async def invoke_data_automation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock_data_automation_runtime.types.invoke_data_automation_request.InvokeDataAutomationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock_data_automation_runtime.types.invoke_data_automation_response.InvokeDataAutomationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_data_automation_runtime._operations.amazon_bedrock_keystone_runtime_service.invoke_data_automation.async_invoke_data_automation(
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_data_automation_runtime._operations.amazon_bedrock_keystone_runtime_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_data_automation_runtime._operations.amazon_bedrock_keystone_runtime_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock_data_automation_runtime._operations.amazon_bedrock_keystone_runtime_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
