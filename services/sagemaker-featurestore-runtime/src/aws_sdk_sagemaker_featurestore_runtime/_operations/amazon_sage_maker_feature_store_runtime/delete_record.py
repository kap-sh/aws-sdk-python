...
def build_request(
    ...
    input: aws_sdk_sagemaker_featurestore_runtime.types.delete_record_request.DeleteRecordRequest,
) -> zapros.Request:
    ...
    if "event_time" in input:
        params["EventTime"] = str(input["event_time"])
    if "target_stores" in input:
        params["TargetStores"] = str(input["target_stores"])
