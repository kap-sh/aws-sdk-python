...
from aws_sdk_sagemaker_featurestore_runtime._auth._identity import (
    Credentials,
    Identity,
)
from aws_sdk_sagemaker_featurestore_runtime._services._aws_config import _load_profile
