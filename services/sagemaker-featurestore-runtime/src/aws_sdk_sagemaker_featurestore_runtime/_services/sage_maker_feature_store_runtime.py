...
from aws_sdk_sagemaker_featurestore_runtime._services._aws_config import aws_config
...
class SageMakerFeatureStoreRuntimeClientConfig(TypedDict, total=False):
...
class SageMakerFeatureStoreRuntimeClient:
    ...
    def batch_get_record(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sagemaker_featurestore_runtime.types.batch_get_record_request.BatchGetRecordRequest]",
        ) -> OperationResponse[
            "aws_sdk_sagemaker_featurestore_runtime.types.batch_get_record_response.BatchGetRecordResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sagemaker_featurestore_runtime._operations.amazon_sage_maker_feature_store_runtime.batch_get_record.batch_get_record(
    ...
    def delete_record(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sagemaker_featurestore_runtime.types.delete_record_request.DeleteRecordRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_sagemaker_featurestore_runtime._operations.amazon_sage_maker_feature_store_runtime.delete_record

            output, http_response = (
                aws_sdk_sagemaker_featurestore_runtime._operations.amazon_sage_maker_feature_store_runtime.delete_record.delete_record(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_record(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sagemaker_featurestore_runtime.types.get_record_request.GetRecordRequest]",
        ) -> OperationResponse[
            "aws_sdk_sagemaker_featurestore_runtime.types.get_record_response.GetRecordResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sagemaker_featurestore_runtime._operations.amazon_sage_maker_feature_store_runtime.get_record.get_record(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_record(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sagemaker_featurestore_runtime.types.put_record_request.PutRecordRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_sagemaker_featurestore_runtime._operations.amazon_sage_maker_feature_store_runtime.put_record

            output, http_response = (
                aws_sdk_sagemaker_featurestore_runtime._operations.amazon_sage_maker_feature_store_runtime.put_record.put_record(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
