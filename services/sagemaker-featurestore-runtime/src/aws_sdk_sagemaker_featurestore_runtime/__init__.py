...
from ._services.async_sage_maker_feature_store_runtime import (
    AsyncSageMakerFeatureStoreRuntimeClient as AsyncSageMakerFeatureStoreRuntimeClient,
)
from ._services.sage_maker_feature_store_runtime import (
    SageMakerFeatureStoreRuntimeClient as SageMakerFeatureStoreRuntimeClient,
)
