...
class FeatureValue(TypedDict, closed=True):
    ...
    value_as_string_list: NotRequired[
        "capo_sagemaker_featurestore_runtime.types.value_as_string_list.ValueAsStringList"
    ]
...
def serialize_json(value: FeatureValue) -> dict:
    ...
    if "value_as_string_list" in value:
        ...
        out["ValueAsStringList"] = (
            capo_sagemaker_featurestore_runtime.types.value_as_string_list.serialize_json(
...
def deserialize_json(data: dict) -> FeatureValue:
    ...
    if "ValueAsStringList" in data:
        ...
        out["value_as_string_list"] = (
            capo_sagemaker_featurestore_runtime.types.value_as_string_list.deserialize_json(
