...
def serialize_json(value: BatchGetRecordRequest) -> dict:
    ...
    if "identifiers" in value:
        ...
        out["Identifiers"] = (
            capo_sagemaker_featurestore_runtime.types.batch_get_record_identifiers.serialize_json(
                value["identifiers"]
            )
        )
...
def deserialize_json(data: dict) -> BatchGetRecordRequest:
    ...
    if "Identifiers" in data:
        ...
        out["identifiers"] = (
            capo_sagemaker_featurestore_runtime.types.batch_get_record_identifiers.deserialize_json(
                data["Identifiers"]
            )
        )
    if "ExpirationTimeResponse" in data:
        ...
        out["expiration_time_response"] = (
            capo_sagemaker_featurestore_runtime.types.expiration_time_response.deserialize_json(
