...
class SageMakerFeatureStoreRuntimeError(Exception):
    """Base class for all SageMakerFeatureStoreRuntime service errors."""


class ServiceError(SageMakerFeatureStoreRuntimeError):
...
class SerializationError(SageMakerFeatureStoreRuntimeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SageMakerFeatureStoreRuntimeError):
...
class WaiterFailedError(SageMakerFeatureStoreRuntimeError):
...
class WaiterTimeoutError(SageMakerFeatureStoreRuntimeError):
