...
def handle_response(
    ...
    out: capo_sagemaker_featurestore_runtime.types.get_record_response.GetRecordResponse = capo_sagemaker_featurestore_runtime.types.get_record_response.deserialize_json(
