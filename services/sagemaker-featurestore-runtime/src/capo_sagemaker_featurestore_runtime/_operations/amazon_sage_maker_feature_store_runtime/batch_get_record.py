...
def handle_response(
    ...
    out: capo_sagemaker_featurestore_runtime.types.batch_get_record_response.BatchGetRecordResponse = capo_sagemaker_featurestore_runtime.types.batch_get_record_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker_featurestore_runtime.types.batch_get_record_request.serialize_json(
            input_
        )
    ).encode()
