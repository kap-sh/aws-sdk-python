...
if TYPE_CHECKING:
    import capo_batch.types.compute_environment_detail_list
    import capo_batch.types.string


class DescribeComputeEnvironmentsResponse(TypedDict, closed=True):
    compute_environments: NotRequired[
        "capo_batch.types.compute_environment_detail_list.ComputeEnvironmentDetailList"
    ]
...
def serialize_json(value: DescribeComputeEnvironmentsResponse) -> dict:
    ...
    if "compute_environments" in value:
        ...
        out["computeEnvironments"] = (
            capo_batch.types.compute_environment_detail_list.serialize_json(
...
def deserialize_json(data: dict) -> DescribeComputeEnvironmentsResponse:
    ...
    if "computeEnvironments" in data:
        ...
        out["compute_environments"] = (
            capo_batch.types.compute_environment_detail_list.deserialize_json(
