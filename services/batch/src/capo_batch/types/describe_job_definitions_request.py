...
class DescribeJobDefinitionsRequest(TypedDict, closed=True):
    job_definitions: NotRequired["capo_batch.types.string_list.StringList"]
...
def serialize_json(value: DescribeJobDefinitionsRequest) -> dict:
    ...
    if "job_definitions" in value:
        ...
        out["jobDefinitions"] = capo_batch.types.string_list.serialize_json(
...
def deserialize_json(data: dict) -> DescribeJobDefinitionsRequest:
    ...
    if "jobDefinitions" in data:
        ...
        out["job_definitions"] = capo_batch.types.string_list.deserialize_json(
            data["jobDefinitions"]
        )
