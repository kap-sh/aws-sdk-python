...
class FairsharePolicy(TypedDict, closed=True):
    share_decay_seconds: NotRequired["capo_batch.types.integer.Integer"]
    ...
    compute_reservation: NotRequired["capo_batch.types.integer.Integer"]
    ...
    share_distribution: NotRequired[
        "capo_batch.types.share_attributes_list.ShareAttributesList"
    ]
...
def serialize_json(value: FairsharePolicy) -> dict:
    ...
    if "share_distribution" in value:
        ...
        out["shareDistribution"] = (
            capo_batch.types.share_attributes_list.serialize_json(
...
def deserialize_json(data: dict) -> FairsharePolicy:
    ...
    if "shareDistribution" in data:
        ...
        out["share_distribution"] = (
            capo_batch.types.share_attributes_list.deserialize_json(
