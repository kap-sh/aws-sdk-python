...
def serialize_json(value: JobDependency) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = capo_batch.types.array_job_dependency.serialize_json(
            value["type"]
        )
    return out
