...
def handle_response(
    ...
    out: capo_batch.types.get_job_queue_snapshot_response.GetJobQueueSnapshotResponse = capo_batch.types.get_job_queue_snapshot_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_batch.types.get_job_queue_snapshot_request.serialize_json(input_)
    ).encode()
