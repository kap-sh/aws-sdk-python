"""Generated from Smithy shape ``com.amazonaws.batch#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_batch.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_batch.types.list_tags_for_resource_response.deserialize_json(
