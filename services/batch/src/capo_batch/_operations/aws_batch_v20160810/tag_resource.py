"""Generated from Smithy shape ``com.amazonaws.batch#TagResource``."""
...
def handle_response(
    ...
    out: capo_batch.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_batch.types.tag_resource_request.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    input_: capo_batch.types.tag_resource_request.TagResourceRequest,
) -> tuple[capo_batch.types.tag_resource_response.TagResourceResponse, zapros.Response]:
