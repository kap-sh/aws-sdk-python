"""Generated from Smithy shape ``com.amazonaws.batch#CreateQuotaShare``."""
...
def handle_response(
    ...
    out: capo_batch.types.create_quota_share_response.CreateQuotaShareResponse = (
        capo_batch.types.create_quota_share_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_batch.types.create_quota_share_request.serialize_json(input_)
    ).encode()
...
async def async_create_quota_share(
