"""Generated from Smithy shape ``com.amazonaws.batch#DeleteServiceEnvironment``."""
...
def handle_response(
    ...
    out: capo_batch.types.delete_service_environment_response.DeleteServiceEnvironmentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/deleteserviceenvironment"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_batch.types.delete_service_environment_request.serialize_json(input_)
    ).encode()
...
async def async_delete_service_environment(
