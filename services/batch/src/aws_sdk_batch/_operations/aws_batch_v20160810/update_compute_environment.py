...
def handle_response(
    ...
    out: aws_sdk_batch.types.update_compute_environment_response.UpdateComputeEnvironmentResponse = aws_sdk_batch.types.update_compute_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.update_compute_environment_request.UpdateComputeEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.update_compute_environment_request.serialize_json(input_)
    ).encode()
