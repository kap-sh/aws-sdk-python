...
def handle_response(
    ...
    out: aws_sdk_batch.types.delete_compute_environment_response.DeleteComputeEnvironmentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_batch.types.delete_compute_environment_request.DeleteComputeEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.delete_compute_environment_request.serialize_json(input_)
    ).encode()
