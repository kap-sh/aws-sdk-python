...
def build_request(
    ...
    input: aws_sdk_batch.types.delete_compute_environment_request.DeleteComputeEnvironmentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.delete_compute_environment_request.serialize_json(input)
    ).encode()
