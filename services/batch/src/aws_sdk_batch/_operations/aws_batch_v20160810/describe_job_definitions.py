...
def handle_response(
    ...
    out: aws_sdk_batch.types.describe_job_definitions_response.DescribeJobDefinitionsResponse = aws_sdk_batch.types.describe_job_definitions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.describe_job_definitions_request.DescribeJobDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.describe_job_definitions_request.serialize_json(input_)
    ).encode()
