...
def build_request(
    ...
    input: aws_sdk_batch.types.describe_job_definitions_request.DescribeJobDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.describe_job_definitions_request.serialize_json(input)
    ).encode()
