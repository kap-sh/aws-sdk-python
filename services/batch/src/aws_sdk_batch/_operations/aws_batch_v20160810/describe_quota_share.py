...
def handle_response(
    ...
    out: aws_sdk_batch.types.describe_quota_share_response.DescribeQuotaShareResponse = aws_sdk_batch.types.describe_quota_share_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.describe_quota_share_request.DescribeQuotaShareRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.describe_quota_share_request.serialize_json(input_)
    ).encode()
