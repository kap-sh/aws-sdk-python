...
def handle_response(
    ...
    out: aws_sdk_batch.types.create_quota_share_response.CreateQuotaShareResponse = (
        aws_sdk_batch.types.create_quota_share_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_batch.types.create_quota_share_request.CreateQuotaShareRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.create_quota_share_request.serialize_json(input)
    ).encode()
