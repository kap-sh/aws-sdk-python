...
def build_request(
    ...
    input: aws_sdk_batch.types.terminate_service_job_request.TerminateServiceJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.terminate_service_job_request.serialize_json(input)
    ).encode()
