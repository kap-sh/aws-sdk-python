...
def handle_response(
    ...
    out: aws_sdk_batch.types.terminate_service_job_response.TerminateServiceJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_batch.types.terminate_service_job_request.TerminateServiceJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.terminate_service_job_request.serialize_json(input_)
    ).encode()
