...
def build_request(
    ...
    input: aws_sdk_batch.types.register_job_definition_request.RegisterJobDefinitionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.register_job_definition_request.serialize_json(input)
    ).encode()
