...
def build_request(
    ...
    input_: aws_sdk_batch.types.register_job_definition_request.RegisterJobDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.register_job_definition_request.serialize_json(input_)
    ).encode()
