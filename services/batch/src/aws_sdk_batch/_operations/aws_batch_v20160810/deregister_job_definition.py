...
def handle_response(
    ...
    out: aws_sdk_batch.types.deregister_job_definition_response.DeregisterJobDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_batch.types.deregister_job_definition_request.DeregisterJobDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.deregister_job_definition_request.serialize_json(input_)
    ).encode()
