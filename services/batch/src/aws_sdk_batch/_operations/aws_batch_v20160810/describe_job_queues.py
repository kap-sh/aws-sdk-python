"""Generated from Smithy shape ``com.amazonaws.batch#DescribeJobQueues``."""
...
def handle_response(
    ...
    out: aws_sdk_batch.types.describe_job_queues_response.DescribeJobQueuesResponse = (
        aws_sdk_batch.types.describe_job_queues_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.describe_job_queues_request.DescribeJobQueuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/describejobqueues"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_batch.types.describe_job_queues_request

    body: bytes | None = json.dumps(
        aws_sdk_batch.types.describe_job_queues_request.serialize_json(input_)
    ).encode()
...
async def async_describe_job_queues(
