"""Generated from Smithy shape ``com.amazonaws.batch#ListSchedulingPolicies``."""
...
def handle_response(
    ...
    out: aws_sdk_batch.types.list_scheduling_policies_response.ListSchedulingPoliciesResponse = aws_sdk_batch.types.list_scheduling_policies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.list_scheduling_policies_request.ListSchedulingPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/listschedulingpolicies"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_batch.types.list_scheduling_policies_request

    body: bytes | None = json.dumps(
        aws_sdk_batch.types.list_scheduling_policies_request.serialize_json(input_)
    ).encode()
...
async def async_list_scheduling_policies(
