...
def build_request(
    ...
    input: aws_sdk_batch.types.list_scheduling_policies_request.ListSchedulingPoliciesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.list_scheduling_policies_request.serialize_json(input)
    ).encode()
