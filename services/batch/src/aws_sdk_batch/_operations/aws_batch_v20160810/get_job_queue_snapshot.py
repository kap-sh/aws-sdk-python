...
def build_request(
    ...
    input: aws_sdk_batch.types.get_job_queue_snapshot_request.GetJobQueueSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.get_job_queue_snapshot_request.serialize_json(input)
    ).encode()
