...
def build_request(
    ...
    input: aws_sdk_batch.types.update_scheduling_policy_request.UpdateSchedulingPolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.update_scheduling_policy_request.serialize_json(input)
    ).encode()
