...
def build_request(
    ...
    input: aws_sdk_batch.types.create_service_environment_request.CreateServiceEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.create_service_environment_request.serialize_json(input)
    ).encode()
