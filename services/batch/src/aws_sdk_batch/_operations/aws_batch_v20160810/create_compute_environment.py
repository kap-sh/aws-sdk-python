...
def handle_response(
    ...
    out: aws_sdk_batch.types.create_compute_environment_response.CreateComputeEnvironmentResponse = aws_sdk_batch.types.create_compute_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.create_compute_environment_request.CreateComputeEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.create_compute_environment_request.serialize_json(input_)
    ).encode()
