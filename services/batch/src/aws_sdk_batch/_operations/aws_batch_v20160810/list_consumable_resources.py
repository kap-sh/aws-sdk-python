...
def build_request(
    ...
    input: aws_sdk_batch.types.list_consumable_resources_request.ListConsumableResourcesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.list_consumable_resources_request.serialize_json(input)
    ).encode()
