"""Generated from Smithy shape ``com.amazonaws.batch#ListConsumableResources``."""
...
def build_request(
    ...
    input_: aws_sdk_batch.types.list_consumable_resources_request.ListConsumableResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/listconsumableresources"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_batch.types.list_consumable_resources_request

    body: bytes | None = json.dumps(
        aws_sdk_batch.types.list_consumable_resources_request.serialize_json(input_)
    ).encode()
...
async def async_list_consumable_resources(
