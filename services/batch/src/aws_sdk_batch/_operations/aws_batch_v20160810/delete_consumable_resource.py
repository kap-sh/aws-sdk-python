...
def handle_response(
    ...
    out: aws_sdk_batch.types.delete_consumable_resource_response.DeleteConsumableResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_batch.types.delete_consumable_resource_request.DeleteConsumableResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.delete_consumable_resource_request.serialize_json(input_)
    ).encode()
