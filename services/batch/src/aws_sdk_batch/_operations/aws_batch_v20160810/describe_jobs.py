"""Generated from Smithy shape ``com.amazonaws.batch#DescribeJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_batch.types.describe_jobs_response.DescribeJobsResponse = (
        aws_sdk_batch.types.describe_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.describe_jobs_request.DescribeJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/describejobs"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_batch.types.describe_jobs_request

    body: bytes | None = json.dumps(
        aws_sdk_batch.types.describe_jobs_request.serialize_json(input_)
    ).encode()
...
def describe_jobs(
    ...
    aws_sdk_batch.types.describe_jobs_response.DescribeJobsResponse, zapros.Response
]:
