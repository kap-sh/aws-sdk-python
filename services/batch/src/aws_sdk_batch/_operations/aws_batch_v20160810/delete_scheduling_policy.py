...
def build_request(
    ...
    input: aws_sdk_batch.types.delete_scheduling_policy_request.DeleteSchedulingPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.delete_scheduling_policy_request.serialize_json(input)
    ).encode()
