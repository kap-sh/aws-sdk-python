...
def handle_response(
    ...
    out: aws_sdk_batch.types.delete_scheduling_policy_response.DeleteSchedulingPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_batch.types.delete_scheduling_policy_request.DeleteSchedulingPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.delete_scheduling_policy_request.serialize_json(input_)
    ).encode()
