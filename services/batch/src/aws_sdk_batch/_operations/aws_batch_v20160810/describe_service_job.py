...
def handle_response(
    ...
    out: aws_sdk_batch.types.describe_service_job_response.DescribeServiceJobResponse = aws_sdk_batch.types.describe_service_job_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_batch.types.describe_service_job_request.DescribeServiceJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.describe_service_job_request.serialize_json(input)
    ).encode()
