...
def handle_response(
    ...
    out: aws_sdk_batch.types.update_consumable_resource_response.UpdateConsumableResourceResponse = aws_sdk_batch.types.update_consumable_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.update_consumable_resource_request.UpdateConsumableResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.update_consumable_resource_request.serialize_json(input_)
    ).encode()
