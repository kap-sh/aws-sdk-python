...
def build_request(
    ...
    input: aws_sdk_batch.types.update_consumable_resource_request.UpdateConsumableResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.update_consumable_resource_request.serialize_json(input)
    ).encode()
