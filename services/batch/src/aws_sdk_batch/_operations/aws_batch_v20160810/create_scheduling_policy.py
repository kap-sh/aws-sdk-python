...
def handle_response(
    ...
    out: aws_sdk_batch.types.create_scheduling_policy_response.CreateSchedulingPolicyResponse = aws_sdk_batch.types.create_scheduling_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.create_scheduling_policy_request.CreateSchedulingPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.create_scheduling_policy_request.serialize_json(input_)
    ).encode()
