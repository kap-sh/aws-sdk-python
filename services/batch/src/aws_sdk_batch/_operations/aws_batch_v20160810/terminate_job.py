...
def handle_response(
    ...
    out: aws_sdk_batch.types.terminate_job_response.TerminateJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_batch.types.terminate_job_request.TerminateJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.terminate_job_request.serialize_json(input_)
    ).encode()
...
def terminate_job(
    ...
    aws_sdk_batch.types.terminate_job_response.TerminateJobResponse, zapros.Response
]:
