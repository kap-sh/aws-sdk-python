...
def handle_response(
    ...
    out: aws_sdk_batch.types.update_service_environment_response.UpdateServiceEnvironmentResponse = aws_sdk_batch.types.update_service_environment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.update_service_environment_request.UpdateServiceEnvironmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.update_service_environment_request.serialize_json(input_)
    ).encode()
