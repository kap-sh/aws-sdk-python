...
def build_request(
    ...
    input: aws_sdk_batch.types.update_service_environment_request.UpdateServiceEnvironmentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.update_service_environment_request.serialize_json(input)
    ).encode()
