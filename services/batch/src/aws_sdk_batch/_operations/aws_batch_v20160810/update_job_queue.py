...
def handle_response(
    ...
    out: aws_sdk_batch.types.update_job_queue_response.UpdateJobQueueResponse = (
        aws_sdk_batch.types.update_job_queue_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.update_job_queue_request.UpdateJobQueueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.update_job_queue_request.serialize_json(input_)
    ).encode()
