...
def handle_response(
    ...
    out: aws_sdk_batch.types.update_service_job_response.UpdateServiceJobResponse = (
        aws_sdk_batch.types.update_service_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.update_service_job_request.UpdateServiceJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.update_service_job_request.serialize_json(input_)
    ).encode()
