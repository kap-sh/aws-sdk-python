...
def handle_response(
    ...
    out: aws_sdk_batch.types.delete_job_queue_response.DeleteJobQueueResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_batch.types.delete_job_queue_request.DeleteJobQueueRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.delete_job_queue_request.serialize_json(input_)
    ).encode()
