"""Generated from Smithy shape ``com.amazonaws.batch#SubmitJob``."""
...
def handle_response(
    ...
    out: aws_sdk_batch.types.submit_job_response.SubmitJobResponse = (
        aws_sdk_batch.types.submit_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.submit_job_request.SubmitJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/submitjob"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_batch.types.submit_job_request

    body: bytes | None = json.dumps(
        aws_sdk_batch.types.submit_job_request.serialize_json(input_)
    ).encode()
...
def submit_job(
    ...
    input_: aws_sdk_batch.types.submit_job_request.SubmitJobRequest,
) -> tuple[aws_sdk_batch.types.submit_job_response.SubmitJobResponse, zapros.Response]:
