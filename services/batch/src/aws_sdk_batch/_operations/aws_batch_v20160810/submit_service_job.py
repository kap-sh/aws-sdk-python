"""Generated from Smithy shape ``com.amazonaws.batch#SubmitServiceJob``."""
...
def handle_response(
    ...
    out: aws_sdk_batch.types.submit_service_job_response.SubmitServiceJobResponse = (
        aws_sdk_batch.types.submit_service_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.submit_service_job_request.SubmitServiceJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/submitservicejob"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_batch.types.submit_service_job_request

    body: bytes | None = json.dumps(
        aws_sdk_batch.types.submit_service_job_request.serialize_json(input_)
    ).encode()
...
async def async_submit_service_job(
