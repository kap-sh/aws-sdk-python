...
def handle_response(
    ...
    out: aws_sdk_batch.types.list_jobs_response.ListJobsResponse = (
        aws_sdk_batch.types.list_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.list_jobs_request.ListJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.list_jobs_request.serialize_json(input_)
    ).encode()
...
def list_jobs(
    ...
    input_: aws_sdk_batch.types.list_jobs_request.ListJobsRequest,
) -> tuple[aws_sdk_batch.types.list_jobs_response.ListJobsResponse, zapros.Response]:
