"""Generated from Smithy shape ``com.amazonaws.batch#ListServiceJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_batch.types.list_service_jobs_response.ListServiceJobsResponse = (
        aws_sdk_batch.types.list_service_jobs_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/listservicejobs"
    params: dict[str, str] = {}
