...
def handle_response(
    ...
    out: aws_sdk_batch.types.create_consumable_resource_response.CreateConsumableResourceResponse = aws_sdk_batch.types.create_consumable_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.create_consumable_resource_request.CreateConsumableResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.create_consumable_resource_request.serialize_json(input_)
    ).encode()
