...
def build_request(
    ...
    input: aws_sdk_batch.types.create_consumable_resource_request.CreateConsumableResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.create_consumable_resource_request.serialize_json(input)
    ).encode()
