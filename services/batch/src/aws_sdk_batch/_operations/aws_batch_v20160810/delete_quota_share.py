...
def handle_response(
    ...
    out: aws_sdk_batch.types.delete_quota_share_response.DeleteQuotaShareResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_batch.types.delete_quota_share_request.DeleteQuotaShareRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.delete_quota_share_request.serialize_json(input_)
    ).encode()
