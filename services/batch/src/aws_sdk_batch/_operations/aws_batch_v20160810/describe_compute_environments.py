...
def handle_response(
    ...
    out: aws_sdk_batch.types.describe_compute_environments_response.DescribeComputeEnvironmentsResponse = aws_sdk_batch.types.describe_compute_environments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.describe_compute_environments_request.DescribeComputeEnvironmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.describe_compute_environments_request.serialize_json(input_)
    ).encode()
