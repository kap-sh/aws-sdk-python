...
def build_request(
    ...
    input: aws_sdk_batch.types.describe_compute_environments_request.DescribeComputeEnvironmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.describe_compute_environments_request.serialize_json(input)
    ).encode()
