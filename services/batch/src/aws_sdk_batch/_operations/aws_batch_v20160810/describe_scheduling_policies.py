...
def build_request(
    ...
    input: aws_sdk_batch.types.describe_scheduling_policies_request.DescribeSchedulingPoliciesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.describe_scheduling_policies_request.serialize_json(input)
    ).encode()
