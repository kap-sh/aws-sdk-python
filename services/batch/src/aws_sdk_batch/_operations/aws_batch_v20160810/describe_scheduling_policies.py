...
def handle_response(
    ...
    out: aws_sdk_batch.types.describe_scheduling_policies_response.DescribeSchedulingPoliciesResponse = aws_sdk_batch.types.describe_scheduling_policies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.describe_scheduling_policies_request.DescribeSchedulingPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.describe_scheduling_policies_request.serialize_json(input_)
    ).encode()
