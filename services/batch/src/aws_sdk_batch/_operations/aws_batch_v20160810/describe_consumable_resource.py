...
def build_request(
    ...
    input: aws_sdk_batch.types.describe_consumable_resource_request.DescribeConsumableResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.describe_consumable_resource_request.serialize_json(input)
    ).encode()
