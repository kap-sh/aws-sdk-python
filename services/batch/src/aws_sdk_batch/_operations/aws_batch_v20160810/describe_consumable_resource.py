"""Generated from Smithy shape ``com.amazonaws.batch#DescribeConsumableResource``."""
...
def handle_response(
    ...
    out: aws_sdk_batch.types.describe_consumable_resource_response.DescribeConsumableResourceResponse = aws_sdk_batch.types.describe_consumable_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.describe_consumable_resource_request.DescribeConsumableResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/describeconsumableresource"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_batch.types.describe_consumable_resource_request

    body: bytes | None = json.dumps(
        aws_sdk_batch.types.describe_consumable_resource_request.serialize_json(input_)
    ).encode()
...
async def async_describe_consumable_resource(
