...
def handle_response(
    ...
    out: aws_sdk_batch.types.describe_service_environments_response.DescribeServiceEnvironmentsResponse = aws_sdk_batch.types.describe_service_environments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_batch.types.describe_service_environments_request.DescribeServiceEnvironmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.describe_service_environments_request.serialize_json(input_)
    ).encode()
