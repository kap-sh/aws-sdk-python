...
def build_request(
    ...
    input: aws_sdk_batch.types.describe_service_environments_request.DescribeServiceEnvironmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_batch.types.describe_service_environments_request.serialize_json(input)
    ).encode()
