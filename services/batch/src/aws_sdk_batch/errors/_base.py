...
class BatchError(Exception):
    """Base class for all Batch service errors."""


class ServiceError(BatchError):
...
class SerializationError(BatchError):
    """Raised when a value cannot be serialized."""


class DeserializationError(BatchError):
...
class WaiterFailedError(BatchError):
...
class WaiterTimeoutError(BatchError):
