...
if TYPE_CHECKING:
    ...
    import aws_sdk_batch.types.service_job_capacity_usage_summary_list
...
class ServiceJobSummary(TypedDict):
    ...
    capacity_usage: NotRequired[
        "aws_sdk_batch.types.service_job_capacity_usage_summary_list.ServiceJobCapacityUsageSummaryList"
    ]
...
def serialize_json(value: ServiceJobSummary) -> dict:
    ...
    if "capacity_usage" in value:
        ...
        out["capacityUsage"] = (
            aws_sdk_batch.types.service_job_capacity_usage_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ServiceJobSummary:
    ...
    if "capacityUsage" in data:
        ...
        out["capacity_usage"] = (
            aws_sdk_batch.types.service_job_capacity_usage_summary_list.deserialize_json(
                data["capacityUsage"]
            )
        )
