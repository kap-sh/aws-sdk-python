...
if TYPE_CHECKING:
    import aws_sdk_batch.types.image_id_override
    import aws_sdk_batch.types.image_type
    import aws_sdk_batch.types.kubernetes_version
    import aws_sdk_batch.types.string


class Ec2Configuration(TypedDict, closed=True):
    image_type: NotRequired["aws_sdk_batch.types.image_type.ImageType"]
    ...
    image_id_override: NotRequired[
        "aws_sdk_batch.types.image_id_override.ImageIdOverride"
    ]
    ...
    batch_image_status: NotRequired["aws_sdk_batch.types.string.String"]
    ...
    image_kubernetes_version: NotRequired[
        "aws_sdk_batch.types.kubernetes_version.KubernetesVersion"
    ]
