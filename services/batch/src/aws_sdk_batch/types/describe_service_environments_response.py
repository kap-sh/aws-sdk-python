...
if TYPE_CHECKING:
    import aws_sdk_batch.types.service_environment_detail_list
    import aws_sdk_batch.types.string


class DescribeServiceEnvironmentsResponse(TypedDict):
    service_environments: NotRequired[
        "aws_sdk_batch.types.service_environment_detail_list.ServiceEnvironmentDetailList"
    ]
...
def serialize_json(value: DescribeServiceEnvironmentsResponse) -> dict:
    ...
    if "service_environments" in value:
        ...
        out["serviceEnvironments"] = (
            aws_sdk_batch.types.service_environment_detail_list.serialize_json(
...
def deserialize_json(data: dict) -> DescribeServiceEnvironmentsResponse:
    ...
    if "serviceEnvironments" in data:
        ...
        out["service_environments"] = (
            aws_sdk_batch.types.service_environment_detail_list.deserialize_json(
