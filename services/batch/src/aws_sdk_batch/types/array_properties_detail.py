"""Generated from Smithy shape ``com.amazonaws.batch#ArrayPropertiesDetail``."""
...
class ArrayPropertiesDetail(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ArrayPropertiesDetail) -> dict:
    out: dict = {}
