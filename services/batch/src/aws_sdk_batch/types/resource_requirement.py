"""Generated from Smithy shape ``com.amazonaws.batch#ResourceRequirement``."""
...
# --- restJson1 ser/de ---
def serialize_json(value: ResourceRequirement) -> dict:
    out: dict = {}
    if "value" in value:
    ...
    if "type" in value:
        ...
        out["type"] = aws_sdk_batch.types.resource_type.serialize_json(value["type"])
    return out
...
def deserialize_json(data: dict) -> ResourceRequirement:
    ...
    if "type" in data:
        ...
        out["type"] = aws_sdk_batch.types.resource_type.deserialize_json(data["type"])
    return out
