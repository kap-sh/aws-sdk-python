...
if TYPE_CHECKING:
    import aws_sdk_batch.types.service_job_retry_action
    import aws_sdk_batch.types.string


class ServiceJobEvaluateOnExit(TypedDict):
    action: NotRequired[
        "aws_sdk_batch.types.service_job_retry_action.ServiceJobRetryAction"
    ]
...
def serialize_json(value: ServiceJobEvaluateOnExit) -> dict:
    ...
    if "action" in value:
        ...
        out["action"] = aws_sdk_batch.types.service_job_retry_action.serialize_json(
            value["action"]
        )
...
def deserialize_json(data: dict) -> ServiceJobEvaluateOnExit:
    ...
    if "action" in data:
        ...
        out["action"] = aws_sdk_batch.types.service_job_retry_action.deserialize_json(
            data["action"]
        )
