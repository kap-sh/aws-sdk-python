...
if TYPE_CHECKING:
    import aws_sdk_batch.types.launch_template_specification_override

LaunchTemplateSpecificationOverrideList: TypeAlias = list[
    "aws_sdk_batch.types.launch_template_specification_override.LaunchTemplateSpecificationOverride"
]
...
def serialize_json(value: LaunchTemplateSpecificationOverrideList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_batch.types.launch_template_specification_override.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> LaunchTemplateSpecificationOverrideList:
    ...
    for item in data:
        out.append(
            aws_sdk_batch.types.launch_template_specification_override.deserialize_json(
                item
            )
        )
    return out
