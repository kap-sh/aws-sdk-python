"""Generated from Smithy shape ``com.amazonaws.batch#TaskContainerDetails``."""
...
class TaskContainerDetails(TypedDict, closed=True):
    ...
    r"""<p>The secrets to pass to the container. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonECS/latest/developerguide/specifying-sensitive-data.html\">Specifying Sensitive Data</a> in the Amazon Elastic Container Service Developer Guide.</p>"""
...
# --- restJson1 ser/de ---
def serialize_json(value: TaskContainerDetails) -> dict:
    out: dict = {}
    if "command" in value:
        import aws_sdk_batch.types.string_list
...
def deserialize_json(data: dict) -> TaskContainerDetails:
    out: TaskContainerDetails = {}  # type: ignore[typeddict-item]
    if "command" in data:
        import aws_sdk_batch.types.string_list
