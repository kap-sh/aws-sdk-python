...
if TYPE_CHECKING:
    import aws_sdk_batch.types.device_cgroup_permissions
    import aws_sdk_batch.types.string


class Device(TypedDict, closed=True):
    host_path: NotRequired["aws_sdk_batch.types.string.String"]
    ...
    permissions: NotRequired[
        "aws_sdk_batch.types.device_cgroup_permissions.DeviceCgroupPermissions"
    ]
...
def serialize_json(value: Device) -> dict:
    ...
    if "permissions" in value:
        ...
        out["permissions"] = (
            aws_sdk_batch.types.device_cgroup_permissions.serialize_json(
                value["permissions"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> Device:
    ...
    if "permissions" in data:
        ...
        out["permissions"] = (
            aws_sdk_batch.types.device_cgroup_permissions.deserialize_json(
                data["permissions"]
            )
        )
    return out
