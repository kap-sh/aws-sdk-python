...
class DescribeServiceEnvironmentsRequest(TypedDict):
    service_environments: NotRequired["aws_sdk_batch.types.string_list.StringList"]
...
def serialize_json(value: DescribeServiceEnvironmentsRequest) -> dict:
    ...
    if "service_environments" in value:
        ...
        out["serviceEnvironments"] = aws_sdk_batch.types.string_list.serialize_json(
...
def deserialize_json(data: dict) -> DescribeServiceEnvironmentsRequest:
    ...
    if "serviceEnvironments" in data:
        ...
        out["service_environments"] = aws_sdk_batch.types.string_list.deserialize_json(
