...
if TYPE_CHECKING:
    ...
    import aws_sdk_batch.types.list_task_container_properties
...
class EcsTaskProperties(TypedDict):
    containers: NotRequired[
        "aws_sdk_batch.types.list_task_container_properties.ListTaskContainerProperties"
    ]
...
def serialize_json(value: EcsTaskProperties) -> dict:
    ...
    if "containers" in value:
        ...
        out["containers"] = (
            aws_sdk_batch.types.list_task_container_properties.serialize_json(
                value["containers"]
            )
        )
...
def deserialize_json(data: dict) -> EcsTaskProperties:
    ...
    if "containers" in data:
        ...
        out["containers"] = (
            aws_sdk_batch.types.list_task_container_properties.deserialize_json(
                data["containers"]
            )
        )
