...
if TYPE_CHECKING:
    import aws_sdk_batch.types.front_of_queue_detail
    import aws_sdk_batch.types.front_of_quota_shares_detail
    import aws_sdk_batch.types.queue_snapshot_utilization_detail


class GetJobQueueSnapshotResponse(TypedDict):
    front_of_queue: NotRequired[
        "aws_sdk_batch.types.front_of_queue_detail.FrontOfQueueDetail"
    ]
    ...
    front_of_quota_shares: NotRequired[
        "aws_sdk_batch.types.front_of_quota_shares_detail.FrontOfQuotaSharesDetail"
    ]
    ...
    queue_utilization: NotRequired[
        "aws_sdk_batch.types.queue_snapshot_utilization_detail.QueueSnapshotUtilizationDetail"
    ]
...
def serialize_json(value: GetJobQueueSnapshotResponse) -> dict:
    ...
    if "front_of_queue" in value:
        ...
        out["frontOfQueue"] = aws_sdk_batch.types.front_of_queue_detail.serialize_json(
    ...
    if "front_of_quota_shares" in value:
        ...
        out["frontOfQuotaShares"] = (
            aws_sdk_batch.types.front_of_quota_shares_detail.serialize_json(
    ...
    if "queue_utilization" in value:
        ...
        out["queueUtilization"] = (
            aws_sdk_batch.types.queue_snapshot_utilization_detail.serialize_json(
...
def deserialize_json(data: dict) -> GetJobQueueSnapshotResponse:
    ...
    if "frontOfQueue" in data:
        ...
        out["front_of_queue"] = (
            aws_sdk_batch.types.front_of_queue_detail.deserialize_json(
                data["frontOfQueue"]
            )
        )
    if "frontOfQuotaShares" in data:
        ...
        out["front_of_quota_shares"] = (
            aws_sdk_batch.types.front_of_quota_shares_detail.deserialize_json(
    ...
    if "queueUtilization" in data:
        ...
        out["queue_utilization"] = (
            aws_sdk_batch.types.queue_snapshot_utilization_detail.deserialize_json(
