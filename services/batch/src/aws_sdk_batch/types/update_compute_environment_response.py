"""Generated from Smithy shape ``com.amazonaws.batch#UpdateComputeEnvironmentResponse``."""
...
class UpdateComputeEnvironmentResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateComputeEnvironmentResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateComputeEnvironmentResponse:
    out: UpdateComputeEnvironmentResponse = {}  # type: ignore[typeddict-item]
