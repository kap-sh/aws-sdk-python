...
class ListJobsRequest(TypedDict):
    ...
    array_job_id: NotRequired["aws_sdk_batch.types.string.String"]
    ...
    multi_node_job_id: NotRequired["aws_sdk_batch.types.string.String"]
    ...
    job_status: NotRequired["aws_sdk_batch.types.job_status.JobStatus"]
    ...
    filters: NotRequired["aws_sdk_batch.types.list_jobs_filter_list.ListJobsFilterList"]
...
def serialize_json(value: ListJobsRequest) -> dict:
    ...
    if "job_status" in value:
        ...
        out["jobStatus"] = aws_sdk_batch.types.job_status.serialize_json(
            value["job_status"]
        )
    ...
    if "filters" in value:
        ...
        out["filters"] = aws_sdk_batch.types.list_jobs_filter_list.serialize_json(
            value["filters"]
        )
    return out
...
def deserialize_json(data: dict) -> ListJobsRequest:
    ...
    if "jobStatus" in data:
        ...
        out["job_status"] = aws_sdk_batch.types.job_status.deserialize_json(
            data["jobStatus"]
        )
    ...
    if "filters" in data:
        ...
        out["filters"] = aws_sdk_batch.types.list_jobs_filter_list.deserialize_json(
            data["filters"]
        )
    return out
