...
class SubmitJobRequest(TypedDict):
    ...
    scheduling_priority_override: NotRequired["aws_sdk_batch.types.integer.Integer"]
    ...
    node_overrides: NotRequired["aws_sdk_batch.types.node_overrides.NodeOverrides"]
...
def serialize_json(value: SubmitJobRequest) -> dict:
    ...
    if "array_properties" in value:
        ...
        out["arrayProperties"] = aws_sdk_batch.types.array_properties.serialize_json(
    ...
    if "node_overrides" in value:
        ...
        out["nodeOverrides"] = aws_sdk_batch.types.node_overrides.serialize_json(
...
def deserialize_json(data: dict) -> SubmitJobRequest:
    ...
    if "arrayProperties" in data:
        ...
        out["array_properties"] = aws_sdk_batch.types.array_properties.deserialize_json(
    ...
    if "nodeOverrides" in data:
        ...
        out["node_overrides"] = aws_sdk_batch.types.node_overrides.deserialize_json(
            data["nodeOverrides"]
        )
