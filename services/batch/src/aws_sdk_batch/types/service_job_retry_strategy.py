...
class ServiceJobRetryStrategy(TypedDict, closed=True):
    ...
    evaluate_on_exit: NotRequired[
        "aws_sdk_batch.types.service_job_evaluate_on_exit_list.ServiceJobEvaluateOnExitList"
    ]
...
def serialize_json(value: ServiceJobRetryStrategy) -> dict:
    ...
    if "evaluate_on_exit" in value:
        ...
        out["evaluateOnExit"] = (
            aws_sdk_batch.types.service_job_evaluate_on_exit_list.serialize_json(
...
def deserialize_json(data: dict) -> ServiceJobRetryStrategy:
    ...
    if "evaluateOnExit" in data:
        ...
        out["evaluate_on_exit"] = (
            aws_sdk_batch.types.service_job_evaluate_on_exit_list.deserialize_json(
                data["evaluateOnExit"]
            )
        )
    return out
