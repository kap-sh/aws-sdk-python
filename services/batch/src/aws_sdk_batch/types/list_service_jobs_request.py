...
class ListServiceJobsRequest(TypedDict):
    ...
    job_status: NotRequired["aws_sdk_batch.types.service_job_status.ServiceJobStatus"]
...
def serialize_json(value: ListServiceJobsRequest) -> dict:
    ...
    if "job_status" in value:
        ...
        out["jobStatus"] = aws_sdk_batch.types.service_job_status.serialize_json(
            value["job_status"]
        )
...
def deserialize_json(data: dict) -> ListServiceJobsRequest:
    ...
    if "jobStatus" in data:
        ...
        out["job_status"] = aws_sdk_batch.types.service_job_status.deserialize_json(
            data["jobStatus"]
        )
