...
class DescribeComputeEnvironmentsRequest(TypedDict):
    compute_environments: NotRequired["aws_sdk_batch.types.string_list.StringList"]
...
def serialize_json(value: DescribeComputeEnvironmentsRequest) -> dict:
    ...
    if "compute_environments" in value:
        ...
        out["computeEnvironments"] = aws_sdk_batch.types.string_list.serialize_json(
...
def deserialize_json(data: dict) -> DescribeComputeEnvironmentsRequest:
    ...
    if "computeEnvironments" in data:
        ...
        out["compute_environments"] = aws_sdk_batch.types.string_list.deserialize_json(
