...
from aws_sdk_elasticache._services._aws_config import aws_config
...
class ElastiCacheClientConfig(TypedDict, total=False, closed=True):
...
class ElastiCacheClient:
    ...
    def __init__(
        ...
        self._config = ElastiCacheClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[ElastiCacheClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: ElastiCacheClientConfig = config_overrides or {}
    ...
    def add_tags_to_resource(
        ...
        *,
        config_overrides: Optional[ElastiCacheClientConfig] = None,
        ...
        Examples:
            ...
            >>> client.add_tags_to_resource(resource_name='arn:aws:elasticache:us-east-1:1234567890:cluster:my-mem-cluster', tags=[{'Value': '20150202', 'Key': 'APIVersion'}, {'Value': 'ElastiCache', 'Key': 'Service'}])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.add_tags_to_resource_message.AddTagsToResourceMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.tag_list_message.TagListMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.add_tags_to_resource.add_tags_to_resource(
    ...
    def authorize_cache_security_group_ingress(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.authorize_cache_security_group_ingress(cache_security_group_name='my-sec-grp', ec2_security_group_name='my-ec2-sec-grp', ec2_security_group_owner_id='1234567890')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.authorize_cache_security_group_ingress_message.AuthorizeCacheSecurityGroupIngressMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.authorize_cache_security_group_ingress_result.AuthorizeCacheSecurityGroupIngressResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.authorize_cache_security_group_ingress.authorize_cache_security_group_ingress(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_apply_update_action(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.batch_apply_update_action_message.BatchApplyUpdateActionMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.update_action_results_message.UpdateActionResultsMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.batch_apply_update_action.batch_apply_update_action(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_stop_update_action(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.batch_stop_update_action_message.BatchStopUpdateActionMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.update_action_results_message.UpdateActionResultsMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.batch_stop_update_action.batch_stop_update_action(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def complete_migration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.complete_migration_message.CompleteMigrationMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.complete_migration_response.CompleteMigrationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.complete_migration.complete_migration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def copy_serverless_cache_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.copy_serverless_cache_snapshot_request.CopyServerlessCacheSnapshotRequest]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.copy_serverless_cache_snapshot_response.CopyServerlessCacheSnapshotResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.copy_serverless_cache_snapshot.copy_serverless_cache_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def copy_snapshot(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.copy_snapshot(source_snapshot_name='my-snapshot', target_snapshot_name='my-snapshot-copy', target_bucket='')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.copy_snapshot_message.CopySnapshotMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.copy_snapshot_result.CopySnapshotResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.copy_snapshot.copy_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_cache_cluster(
        ...
        *,
        ...
        r"""<p>Creates a cluster. All nodes in the cluster run the same protocol-compliant cache engine software, either Memcached, Valkey or Redis OSS.</p> <p>This operation is not supported for Valkey or Redis OSS (cluster mode enabled) clusters.</p>
        ...
        Examples:
            ...
            >>> client.create_cache_cluster(cache_cluster_id='my-memcached-cluster', az_mode='cross-az', num_cache_nodes=2, cache_node_type='cache.r3.large', engine='memcached', engine_version='1.4.24', cache_subnet_group_name='default', port=11211)
            CreateCacheCluster
            Creates a Redis cluster with 1 node.

            >>> client.create_cache_cluster(cache_cluster_id='my-redis', preferred_availability_zone='us-east-1c', num_cache_nodes=1, cache_node_type='cache.r3.larage', engine='redis', engine_version='3.2.4', cache_subnet_group_name='default', port=6379, snapshot_retention_limit=7, auto_minor_version_upgrade=True)
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.create_cache_cluster_message.CreateCacheClusterMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.create_cache_cluster_result.CreateCacheClusterResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.create_cache_cluster.create_cache_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_cache_parameter_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_cache_parameter_group(cache_parameter_group_name='custom-redis2-8', cache_parameter_group_family='redis2.8', description='Custom Redis 2.8 parameter group.')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.create_cache_parameter_group_message.CreateCacheParameterGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.create_cache_parameter_group_result.CreateCacheParameterGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.create_cache_parameter_group.create_cache_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_cache_security_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_cache_security_group(cache_security_group_name='my-cache-sec-grp', description='Example ElastiCache security group.')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.create_cache_security_group_message.CreateCacheSecurityGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.create_cache_security_group_result.CreateCacheSecurityGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.create_cache_security_group.create_cache_security_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_cache_subnet_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_cache_subnet_group(cache_subnet_group_name='my-sn-grp2', cache_subnet_group_description='Sample subnet group', subnet_ids=['subnet-6f28c982', 'subnet-bcd382f3', 'subnet-845b3e7c0'])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.create_cache_subnet_group_message.CreateCacheSubnetGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.create_cache_subnet_group_result.CreateCacheSubnetGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.create_cache_subnet_group.create_cache_subnet_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.create_global_replication_group_message.CreateGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.create_global_replication_group_result.CreateGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.create_global_replication_group.create_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_replication_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_replication_group(replication_group_id='my-redis-rg', replication_group_description='A Redis replication group.', automatic_failover_enabled=True, num_cache_clusters=3, cache_node_type='cache.m3.medium', engine='redis', engine_version='2.8.24', snapshot_retention_limit=30)
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.create_replication_group.create_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_serverless_cache(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.create_serverless_cache_request.CreateServerlessCacheRequest]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.create_serverless_cache_response.CreateServerlessCacheResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.create_serverless_cache.create_serverless_cache(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_serverless_cache_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.create_serverless_cache_snapshot_request.CreateServerlessCacheSnapshotRequest]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.create_serverless_cache_snapshot_response.CreateServerlessCacheSnapshotResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.create_serverless_cache_snapshot.create_serverless_cache_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_snapshot(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_snapshot(cache_cluster_id='threenoderedis-001', snapshot_name='snapshot-2')
            ...
            >>> client.create_snapshot(cache_cluster_id='onenoderedis', snapshot_name='snapshot-1')
            ...
            >>> client.create_snapshot(replication_group_id='clusteredredis', snapshot_name='snapshot-2x5')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.create_snapshot_message.CreateSnapshotMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.create_snapshot_result.CreateSnapshotResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.create_snapshot.create_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_user(
        ...
        *,
        ...
        r"""<p>For Valkey engine version 7.2 onwards and Redis OSS 6.0 to 7.1: Creates a user. For more information, see <a href=\"http://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Clusters.RBAC.html\">Using Role Based Access Control (RBAC)</a>.</p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.create_user_message.CreateUserMessage]",
        ) -> OperationResponse["aws_sdk_elasticache.types.user.User"]:
            import aws_sdk_elasticache._operations.amazon_elasti_cache_v9.create_user

            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.create_user.create_user(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_user_group(
        ...
        *,
        ...
        r"""<p>For Valkey engine version 7.2 onwards and Redis OSS 6.0 to 7.1: Creates a user group. For more information, see <a href=\"http://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Clusters.RBAC.html\">Using Role Based Access Control (RBAC)</a> </p>
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.create_user_group_message.CreateUserGroupMessage]",
        ) -> OperationResponse["aws_sdk_elasticache.types.user_group.UserGroup"]:
            import aws_sdk_elasticache._operations.amazon_elasti_cache_v9.create_user_group

            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.create_user_group.create_user_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def decrease_node_groups_in_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.decrease_node_groups_in_global_replication_group_message.DecreaseNodeGroupsInGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.decrease_node_groups_in_global_replication_group_result.DecreaseNodeGroupsInGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.decrease_node_groups_in_global_replication_group.decrease_node_groups_in_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def decrease_replica_count(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.decrease_replica_count_message.DecreaseReplicaCountMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.decrease_replica_count_result.DecreaseReplicaCountResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.decrease_replica_count.decrease_replica_count(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_cache_cluster(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_cache_cluster(cache_cluster_id='my-memcached')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.delete_cache_cluster_message.DeleteCacheClusterMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.delete_cache_cluster_result.DeleteCacheClusterResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_cache_cluster.delete_cache_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_cache_parameter_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_cache_parameter_group(cache_parameter_group_name='custom-mem1-4')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.delete_cache_parameter_group_message.DeleteCacheParameterGroupMessage]",
        ) -> OperationResponse[None]:
            import aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_cache_parameter_group

            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_cache_parameter_group.delete_cache_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_cache_security_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_cache_security_group(cache_security_group_name='my-sec-group')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.delete_cache_security_group_message.DeleteCacheSecurityGroupMessage]",
        ) -> OperationResponse[None]:
            import aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_cache_security_group

            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_cache_security_group.delete_cache_security_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_cache_subnet_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_cache_subnet_group(cache_subnet_group_name='my-subnet-group')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.delete_cache_subnet_group_message.DeleteCacheSubnetGroupMessage]",
        ) -> OperationResponse[None]:
            import aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_cache_subnet_group

            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_cache_subnet_group.delete_cache_subnet_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.delete_global_replication_group_message.DeleteGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.delete_global_replication_group_result.DeleteGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_global_replication_group.delete_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_replication_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_replication_group(replication_group_id='my-redis-rg', retain_primary_cluster=False)
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.delete_replication_group_message.DeleteReplicationGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.delete_replication_group_result.DeleteReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_replication_group.delete_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_serverless_cache(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.delete_serverless_cache_request.DeleteServerlessCacheRequest]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.delete_serverless_cache_response.DeleteServerlessCacheResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_serverless_cache.delete_serverless_cache(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_serverless_cache_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.delete_serverless_cache_snapshot_request.DeleteServerlessCacheSnapshotRequest]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.delete_serverless_cache_snapshot_response.DeleteServerlessCacheSnapshotResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_serverless_cache_snapshot.delete_serverless_cache_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_snapshot(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_snapshot(snapshot_name='snapshot-20161212')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.delete_snapshot_message.DeleteSnapshotMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.delete_snapshot_result.DeleteSnapshotResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_snapshot.delete_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_user(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.delete_user_message.DeleteUserMessage]",
        ) -> OperationResponse["aws_sdk_elasticache.types.user.User"]:
            import aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_user

            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_user.delete_user(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_user_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.delete_user_group_message.DeleteUserGroupMessage]",
        ) -> OperationResponse["aws_sdk_elasticache.types.user_group.UserGroup"]:
            import aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_user_group

            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.delete_user_group.delete_user_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_cache_clusters(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_cache_clusters(cache_cluster_id='my-mem-cluster', show_cache_node_info=True)
            DescribeCacheClusters
            Lists the details for up to 50 cache clusters.

            >>> client.describe_cache_clusters(cache_cluster_id='my-mem-cluster')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_cache_clusters_message.DescribeCacheClustersMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.cache_cluster_message.CacheClusterMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_cache_clusters.describe_cache_clusters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_elasticache.types.cache_cluster.CacheCluster]":
        _token = marker
        while True:
            _response = self.describe_cache_clusters(
    ...
    def describe_cache_engine_versions(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_cache_engine_versions(engine='redis', max_records=50, default_only=False)
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_cache_engine_versions_message.DescribeCacheEngineVersionsMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.cache_engine_version_message.CacheEngineVersionMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_cache_engine_versions.describe_cache_engine_versions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_cache_engine_versions(
        ...
        *,
        ...
        marker: Optional["aws_sdk_elasticache.types.string.String"] = None,
        default_only: Optional["aws_sdk_elasticache.types.boolean.Boolean"] = None,
    ) -> "Iterator[aws_sdk_elasticache.types.cache_engine_version.CacheEngineVersion]":
        _token = marker
        while True:
            _response = self.describe_cache_engine_versions(
                config_overrides=config_overrides,
                engine=engine,
    ...
    def describe_cache_parameter_groups(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_cache_parameter_groups(cache_parameter_group_name='custom-mem1-4')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_cache_parameter_groups_message.DescribeCacheParameterGroupsMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.cache_parameter_groups_message.CacheParameterGroupsMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_cache_parameter_groups.describe_cache_parameter_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_cache_parameter_groups(
        ...
        *,
        ...
        "Iterator[aws_sdk_elasticache.types.cache_parameter_group.CacheParameterGroup]"
    ):
        _token = marker
        while True:
            _response = self.describe_cache_parameter_groups(
                config_overrides=config_overrides,
    ...
    def describe_cache_parameters(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_cache_parameters(cache_parameter_group_name='custom-redis2-8', source='user', max_records=100)
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_cache_parameters_message.DescribeCacheParametersMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.cache_parameter_group_details.CacheParameterGroupDetails"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_cache_parameters.describe_cache_parameters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_cache_parameters(
        ...
        *,
        ...
        marker: Optional["aws_sdk_elasticache.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_elasticache.types.parameter.Parameter]":
        _token = marker
        while True:
            _response = self.describe_cache_parameters(
                cache_parameter_group_name,
                config_overrides=config_overrides,
                source=source,
                max_records=max_records,
    ...
    def describe_cache_security_groups(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_cache_security_groups(cache_security_group_name='my-sec-group')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_cache_security_groups_message.DescribeCacheSecurityGroupsMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.cache_security_group_message.CacheSecurityGroupMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_cache_security_groups.describe_cache_security_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_cache_security_groups(
        ...
        *,
        ...
        marker: Optional["aws_sdk_elasticache.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_elasticache.types.cache_security_group.CacheSecurityGroup]":
        _token = marker
        while True:
            _response = self.describe_cache_security_groups(
                config_overrides=config_overrides,
    ...
    def describe_cache_subnet_groups(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_cache_subnet_groups(max_records=25)
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_cache_subnet_groups_message.DescribeCacheSubnetGroupsMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.cache_subnet_group_message.CacheSubnetGroupMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_cache_subnet_groups.describe_cache_subnet_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_cache_subnet_groups(
        ...
        *,
        ...
        marker: Optional["aws_sdk_elasticache.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_elasticache.types.cache_subnet_group.CacheSubnetGroup]":
        _token = marker
        while True:
            _response = self.describe_cache_subnet_groups(
                config_overrides=config_overrides,
    ...
    def describe_engine_default_parameters(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_engine_default_parameters(cache_parameter_group_family='redis2.8', max_records=25)
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_engine_default_parameters_message.DescribeEngineDefaultParametersMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.describe_engine_default_parameters_result.DescribeEngineDefaultParametersResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_engine_default_parameters.describe_engine_default_parameters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_events(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_events(source_type='cache-cluster', duration=360)
            DescribeEvents
            Describes all the replication-group events from 3:00P to 5:00P on November 11, 2016.

            >>> client.describe_events(start_time='2016-12-22T15:00:00.000Z')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_events_message.DescribeEventsMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.events_message.EventsMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_events.describe_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_events(
        ...
        *,
        ...
        marker: Optional["aws_sdk_elasticache.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_elasticache.types.event.Event]":
        _token = marker
        while True:
    ...
    def describe_global_replication_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_global_replication_groups_message.DescribeGlobalReplicationGroupsMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.describe_global_replication_groups_result.DescribeGlobalReplicationGroupsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_global_replication_groups.describe_global_replication_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_elasticache.types.global_replication_group.GlobalReplicationGroup]":
        _token = marker
        while True:
            _response = self.describe_global_replication_groups(
                config_overrides=config_overrides,
    ...
    def describe_replication_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_replication_groups_message.DescribeReplicationGroupsMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.replication_group_message.ReplicationGroupMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_replication_groups.describe_replication_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_replication_groups(
        ...
        *,
        ...
        marker: Optional["aws_sdk_elasticache.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_elasticache.types.replication_group.ReplicationGroup]":
        _token = marker
        while True:
            _response = self.describe_replication_groups(
                config_overrides=config_overrides,
    ...
    def describe_reserved_cache_nodes(
        ...
        *,
        ...
        r"""<p>Returns information about reserved cache nodes for this account, or about a specified reserved cache node.</p>
        ...
        Examples:
            ...
            >>> client.describe_reserved_cache_nodes(max_records=25)
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_reserved_cache_nodes_message.DescribeReservedCacheNodesMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.reserved_cache_node_message.ReservedCacheNodeMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_reserved_cache_nodes.describe_reserved_cache_nodes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_reserved_cache_nodes(
        ...
        *,
        ...
        marker: Optional["aws_sdk_elasticache.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_elasticache.types.reserved_cache_node.ReservedCacheNode]":
        _token = marker
        while True:
            _response = self.describe_reserved_cache_nodes(
                config_overrides=config_overrides,
    ...
    def describe_reserved_cache_nodes_offerings(
        ...
        *,
        ...
        r"""<p>Lists available reserved cache node offerings.</p>
        ...
        Examples:
            ...
            >>> client.describe_reserved_cache_nodes_offerings(reserved_cache_nodes_offering_id='', cache_node_type='cache.r3.large', duration='3', offering_type='Light Utilization', max_records=25)
            DescribeReseredCacheNodeOfferings
            Lists available reserved cache node offerings.

            >>> client.describe_reserved_cache_nodes_offerings(max_records=20)
            DescribeReseredCacheNodeOfferings
            Lists available reserved cache node offerings.

            >>> client.describe_reserved_cache_nodes_offerings(reserved_cache_nodes_offering_id='438012d3-4052-4cc7-b2e3-8d3372e0e706', cache_node_type='', duration='', product_description='', offering_type='', max_records=25, marker='')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_reserved_cache_nodes_offerings_message.DescribeReservedCacheNodesOfferingsMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.reserved_cache_nodes_offering_message.ReservedCacheNodesOfferingMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_reserved_cache_nodes_offerings.describe_reserved_cache_nodes_offerings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_reserved_cache_nodes_offerings(
        ...
        *,
        ...
        marker: Optional["aws_sdk_elasticache.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_elasticache.types.reserved_cache_nodes_offering.ReservedCacheNodesOffering]":
        _token = marker
        while True:
            _response = self.describe_reserved_cache_nodes_offerings(
                config_overrides=config_overrides,
                reserved_cache_nodes_offering_id=reserved_cache_nodes_offering_id,
                cache_node_type=cache_node_type,
                duration=duration,
    ...
    def describe_serverless_caches(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_serverless_caches_request.DescribeServerlessCachesRequest]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.describe_serverless_caches_response.DescribeServerlessCachesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_serverless_caches.describe_serverless_caches(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_serverless_caches(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_elasticache.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_elasticache.types.serverless_cache.ServerlessCache]":
        _token = next_token
        while True:
            _response = self.describe_serverless_caches(
                config_overrides=config_overrides,
    ...
    def describe_serverless_cache_snapshots(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_serverless_cache_snapshots_request.DescribeServerlessCacheSnapshotsRequest]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.describe_serverless_cache_snapshots_response.DescribeServerlessCacheSnapshotsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_serverless_cache_snapshots.describe_serverless_cache_snapshots(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_elasticache.types.serverless_cache_snapshot.ServerlessCacheSnapshot]":
        _token = next_token
        while True:
            _response = self.describe_serverless_cache_snapshots(
                config_overrides=config_overrides,
                serverless_cache_name=serverless_cache_name,
    ...
    def describe_service_updates(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_service_updates_message.DescribeServiceUpdatesMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.service_updates_message.ServiceUpdatesMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_service_updates.describe_service_updates(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_service_updates(
        ...
        *,
        ...
        marker: Optional["aws_sdk_elasticache.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_elasticache.types.service_update.ServiceUpdate]":
        _token = marker
        while True:
    ...
    def describe_snapshots(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_snapshots(snapshot_name='snapshot-20161212')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_snapshots_message.DescribeSnapshotsMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.describe_snapshots_list_message.DescribeSnapshotsListMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_snapshots.describe_snapshots(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_elasticache.types.snapshot.Snapshot]":
        _token = marker
        while True:
    ...
    def describe_update_actions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_update_actions_message.DescribeUpdateActionsMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.update_actions_message.UpdateActionsMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_update_actions.describe_update_actions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_update_actions(
        ...
        *,
        ...
        marker: Optional["aws_sdk_elasticache.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_elasticache.types.update_action.UpdateAction]":
        _token = marker
        while True:
            _response = self.describe_update_actions(
                config_overrides=config_overrides,
                service_update_name=service_update_name,
    ...
    def describe_user_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_user_groups_message.DescribeUserGroupsMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.describe_user_groups_result.DescribeUserGroupsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_user_groups.describe_user_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_user_groups(
        ...
        *,
        ...
        marker: Optional["aws_sdk_elasticache.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_elasticache.types.user_group.UserGroup]":
        _token = marker
        while True:
            _response = self.describe_user_groups(
                config_overrides=config_overrides,
    ...
    def describe_users(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.describe_users_message.DescribeUsersMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.describe_users_result.DescribeUsersResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.describe_users.describe_users(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_users(
        ...
        *,
        ...
        marker: Optional["aws_sdk_elasticache.types.string.String"] = None,
    ) -> "Iterator[aws_sdk_elasticache.types.user.User]":
        _token = marker
        while True:
    ...
    def disassociate_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.disassociate_global_replication_group_message.DisassociateGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.disassociate_global_replication_group_result.DisassociateGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.disassociate_global_replication_group.disassociate_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def export_serverless_cache_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.export_serverless_cache_snapshot_request.ExportServerlessCacheSnapshotRequest]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.export_serverless_cache_snapshot_response.ExportServerlessCacheSnapshotResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.export_serverless_cache_snapshot.export_serverless_cache_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def failover_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.failover_global_replication_group_message.FailoverGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.failover_global_replication_group_result.FailoverGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.failover_global_replication_group.failover_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def increase_node_groups_in_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.increase_node_groups_in_global_replication_group_message.IncreaseNodeGroupsInGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.increase_node_groups_in_global_replication_group_result.IncreaseNodeGroupsInGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.increase_node_groups_in_global_replication_group.increase_node_groups_in_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def increase_replica_count(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.increase_replica_count_message.IncreaseReplicaCountMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.increase_replica_count_result.IncreaseReplicaCountResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.increase_replica_count.increase_replica_count(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_allowed_node_type_modifications(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_allowed_node_type_modifications(cache_cluster_id='mycluster')
            ListAllowedNodeTypeModifications
            Lists all available node types that you can scale your Redis cluster's or replication group's current node type up to.

            >>> client.list_allowed_node_type_modifications(replication_group_id='myreplgroup')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.list_allowed_node_type_modifications_message.ListAllowedNodeTypeModificationsMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.allowed_node_type_modifications_message.AllowedNodeTypeModificationsMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.list_allowed_node_type_modifications.list_allowed_node_type_modifications(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_tags_for_resource(resource_name='arn:aws:elasticache:us-west-2:<my-account-id>:cluster:mycluster')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.list_tags_for_resource_message.ListTagsForResourceMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.tag_list_message.TagListMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_cache_cluster(
        ...
        *,
        ...
        r"""<p>Modifies the settings for a cluster. You can use this operation to change one or more cluster configuration parameters by specifying the parameters and the new values.</p>
        ...
        Examples:
            ...
            >>> client.modify_cache_cluster(cache_cluster_id='redis-cluster', apply_immediately=True, snapshot_retention_limit=14)
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.modify_cache_cluster_message.ModifyCacheClusterMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.modify_cache_cluster_result.ModifyCacheClusterResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.modify_cache_cluster.modify_cache_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_cache_parameter_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.modify_cache_parameter_group(cache_parameter_group_name='custom-mem1-4', parameter_name_values=[{'ParameterName': 'binding_protocol', 'ParameterValue': 'ascii'}, {'ParameterName': 'chunk_size', 'ParameterValue': '96'}])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.modify_cache_parameter_group_message.ModifyCacheParameterGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.cache_parameter_group_name_message.CacheParameterGroupNameMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.modify_cache_parameter_group.modify_cache_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_cache_subnet_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.modify_cache_subnet_group(cache_subnet_group_name='my-sn-grp', subnet_ids=['subnet-bcde2345'])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.modify_cache_subnet_group_message.ModifyCacheSubnetGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.modify_cache_subnet_group_result.ModifyCacheSubnetGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.modify_cache_subnet_group.modify_cache_subnet_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.modify_global_replication_group_message.ModifyGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.modify_global_replication_group_result.ModifyGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.modify_global_replication_group.modify_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_replication_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.modify_replication_group(replication_group_id='my-redis-rg', replication_group_description='Modified replication group', snapshotting_cluster_id='my-redis-rg-001', apply_immediately=True, snapshot_retention_limit=30)
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.modify_replication_group_message.ModifyReplicationGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.modify_replication_group_result.ModifyReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.modify_replication_group.modify_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_replication_group_shard_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.modify_replication_group_shard_configuration_message.ModifyReplicationGroupShardConfigurationMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.modify_replication_group_shard_configuration_result.ModifyReplicationGroupShardConfigurationResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.modify_replication_group_shard_configuration.modify_replication_group_shard_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_serverless_cache(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.modify_serverless_cache_request.ModifyServerlessCacheRequest]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.modify_serverless_cache_response.ModifyServerlessCacheResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.modify_serverless_cache.modify_serverless_cache(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_user(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.modify_user_message.ModifyUserMessage]",
        ) -> OperationResponse["aws_sdk_elasticache.types.user.User"]:
            import aws_sdk_elasticache._operations.amazon_elasti_cache_v9.modify_user

            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.modify_user.modify_user(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_user_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.modify_user_group_message.ModifyUserGroupMessage]",
        ) -> OperationResponse["aws_sdk_elasticache.types.user_group.UserGroup"]:
            import aws_sdk_elasticache._operations.amazon_elasti_cache_v9.modify_user_group

            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.modify_user_group.modify_user_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def purchase_reserved_cache_nodes_offering(
        ...
        *,
        ...
        r"""<p>Allows you to purchase a reserved cache node offering. Reserved nodes are not eligible for cancellation and are non-refundable. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/reserved-nodes.html\">Managing Costs with Reserved Nodes</a>.</p>
        ...
        Examples:
            ...
            >>> client.purchase_reserved_cache_nodes_offering(reserved_cache_nodes_offering_id='1ef01f5b-94ff-433f-a530-61a56bfc8e7a')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.purchase_reserved_cache_nodes_offering_message.PurchaseReservedCacheNodesOfferingMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.purchase_reserved_cache_nodes_offering_result.PurchaseReservedCacheNodesOfferingResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.purchase_reserved_cache_nodes_offering.purchase_reserved_cache_nodes_offering(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def rebalance_slots_in_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.rebalance_slots_in_global_replication_group_message.RebalanceSlotsInGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.rebalance_slots_in_global_replication_group_result.RebalanceSlotsInGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.rebalance_slots_in_global_replication_group.rebalance_slots_in_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def reboot_cache_cluster(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.reboot_cache_cluster(cache_cluster_id='custom-mem1-4  ', cache_node_ids_to_reboot=['0001', '0002'])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.reboot_cache_cluster_message.RebootCacheClusterMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.reboot_cache_cluster_result.RebootCacheClusterResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.reboot_cache_cluster.reboot_cache_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_tags_from_resource(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.remove_tags_from_resource(resource_name='arn:aws:elasticache:us-east-1:1234567890:cluster:my-mem-cluster', tag_keys=['A', 'C', 'E'])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.remove_tags_from_resource_message.RemoveTagsFromResourceMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.tag_list_message.TagListMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.remove_tags_from_resource.remove_tags_from_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def reset_cache_parameter_group(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.reset_cache_parameter_group(cache_parameter_group_name='custom-mem1-4', reset_all_parameters=True)
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.reset_cache_parameter_group_message.ResetCacheParameterGroupMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.cache_parameter_group_name_message.CacheParameterGroupNameMessage"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.reset_cache_parameter_group.reset_cache_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def revoke_cache_security_group_ingress(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.revoke_cache_security_group_ingress(cache_security_group_name='my-sec-grp', ec2_security_group_name='my-ec2-sec-grp', ec2_security_group_owner_id='1234567890')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.revoke_cache_security_group_ingress_message.RevokeCacheSecurityGroupIngressMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.revoke_cache_security_group_ingress_result.RevokeCacheSecurityGroupIngressResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.revoke_cache_security_group_ingress.revoke_cache_security_group_ingress(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_migration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.start_migration_message.StartMigrationMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.start_migration_response.StartMigrationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.start_migration.start_migration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def test_failover(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.test_failover_message.TestFailoverMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.test_failover_result.TestFailoverResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.test_failover.test_failover(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def test_migration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_elasticache.types.test_migration_message.TestMigrationMessage]",
        ) -> OperationResponse[
            "aws_sdk_elasticache.types.test_migration_response.TestMigrationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_elasticache._operations.amazon_elasti_cache_v9.test_migration.test_migration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
