...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.cache_cluster_message.CacheClusterMessage = (
        aws_sdk_elasticache.types.cache_cluster_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_cache_clusters_message.DescribeCacheClustersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_cache_clusters(
    ...
    aws_sdk_elasticache.types.cache_cluster_message.CacheClusterMessage, zapros.Response
]:
