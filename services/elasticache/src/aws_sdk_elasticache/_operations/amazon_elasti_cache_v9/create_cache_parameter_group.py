...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CacheParameterGroupAlreadyExistsFault":
            import aws_sdk_elasticache.errors.cache_parameter_group_already_exists_fault

            raise aws_sdk_elasticache.errors.cache_parameter_group_already_exists_fault.CacheParameterGroupAlreadyExistsFault.from_query(
                root
            )
        case "CacheParameterGroupQuotaExceededFault":
            import aws_sdk_elasticache.errors.cache_parameter_group_quota_exceeded_fault

            raise aws_sdk_elasticache.errors.cache_parameter_group_quota_exceeded_fault.CacheParameterGroupQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.create_cache_parameter_group_result.CreateCacheParameterGroupResult = aws_sdk_elasticache.types.create_cache_parameter_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.create_cache_parameter_group_message.CreateCacheParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.create_cache_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
