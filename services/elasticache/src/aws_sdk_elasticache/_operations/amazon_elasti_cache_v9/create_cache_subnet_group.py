...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.create_cache_subnet_group_message.CreateCacheSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.create_cache_subnet_group_message.serialize_query(
        input_, pairs, ""
    )
