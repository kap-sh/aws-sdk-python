...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.batch_stop_update_action_message.BatchStopUpdateActionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.batch_stop_update_action_message.serialize_query(
        input_, pairs, ""
    )
