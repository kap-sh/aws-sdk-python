...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.increase_node_groups_in_global_replication_group_result.IncreaseNodeGroupsInGlobalReplicationGroupResult = aws_sdk_elasticache.types.increase_node_groups_in_global_replication_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.increase_node_groups_in_global_replication_group_message.IncreaseNodeGroupsInGlobalReplicationGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
