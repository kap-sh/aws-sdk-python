"""Generated from Smithy shape ``com.amazonaws.elasticache#CreateSnapshot``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SnapshotFeatureNotSupportedFault":
            import aws_sdk_elasticache.errors.snapshot_feature_not_supported_fault

            raise aws_sdk_elasticache.errors.snapshot_feature_not_supported_fault.SnapshotFeatureNotSupportedFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateSnapshotResult")
    out: aws_sdk_elasticache.types.create_snapshot_result.CreateSnapshotResult = (
        aws_sdk_elasticache.types.create_snapshot_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.create_snapshot_message.CreateSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateSnapshot"))
    pairs.append(("Version", "2015-02-02"))
    import aws_sdk_elasticache.types.create_snapshot_message

    aws_sdk_elasticache.types.create_snapshot_message.serialize_query(input_, pairs, "")
