...
def build_request(
    ...
    input: aws_sdk_elasticache.types.create_snapshot_message.CreateSnapshotMessage,
) -> zapros.Request:
    ...
    aws_sdk_elasticache.types.create_snapshot_message.serialize_query(input, pairs, "")
