...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.modify_replication_group_result.ModifyReplicationGroupResult = aws_sdk_elasticache.types.modify_replication_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.modify_replication_group_message.ModifyReplicationGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.modify_replication_group_message.serialize_query(
        input_, pairs, ""
    )
