...
def build_request(
    ...
    input: aws_sdk_elasticache.types.describe_users_message.DescribeUsersMessage,
) -> zapros.Request:
    ...
    aws_sdk_elasticache.types.describe_users_message.serialize_query(input, pairs, "")
