...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.cache_subnet_group_message.CacheSubnetGroupMessage = aws_sdk_elasticache.types.cache_subnet_group_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_cache_subnet_groups_message.DescribeCacheSubnetGroupsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.describe_cache_subnet_groups_message.serialize_query(
        input_, pairs, ""
    )
