...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.describe_global_replication_groups_result.DescribeGlobalReplicationGroupsResult = aws_sdk_elasticache.types.describe_global_replication_groups_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_global_replication_groups_message.DescribeGlobalReplicationGroupsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.describe_global_replication_groups_message.serialize_query(
        input_, pairs, ""
    )
