...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.delete_serverless_cache_response.DeleteServerlessCacheResponse = aws_sdk_elasticache.types.delete_serverless_cache_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.delete_serverless_cache_request.DeleteServerlessCacheRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.delete_serverless_cache_request.serialize_query(
        input_, pairs, ""
    )
