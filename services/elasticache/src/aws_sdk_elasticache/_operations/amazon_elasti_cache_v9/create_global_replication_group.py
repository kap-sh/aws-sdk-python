...
import aws_sdk_elasticache.errors.global_replication_group_already_exists_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "GlobalReplicationGroupAlreadyExistsFault":
            raise aws_sdk_elasticache.errors.global_replication_group_already_exists_fault.GlobalReplicationGroupAlreadyExistsFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.create_global_replication_group_result.CreateGlobalReplicationGroupResult = aws_sdk_elasticache.types.create_global_replication_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.create_global_replication_group_message.CreateGlobalReplicationGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.create_global_replication_group_message.serialize_query(
        input_, pairs, ""
    )
