...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.modify_global_replication_group_result.ModifyGlobalReplicationGroupResult = aws_sdk_elasticache.types.modify_global_replication_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.modify_global_replication_group_message.ModifyGlobalReplicationGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.modify_global_replication_group_message.serialize_query(
        input_, pairs, ""
    )
