...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.decrease_node_groups_in_global_replication_group_result.DecreaseNodeGroupsInGlobalReplicationGroupResult = aws_sdk_elasticache.types.decrease_node_groups_in_global_replication_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.decrease_node_groups_in_global_replication_group_message.DecreaseNodeGroupsInGlobalReplicationGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.decrease_node_groups_in_global_replication_group_message.serialize_query(
        input_, pairs, ""
    )
