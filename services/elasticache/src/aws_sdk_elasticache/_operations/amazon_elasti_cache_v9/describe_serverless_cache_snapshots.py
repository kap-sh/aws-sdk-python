"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeServerlessCacheSnapshots``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeServerlessCacheSnapshotsResult")
    out: aws_sdk_elasticache.types.describe_serverless_cache_snapshots_response.DescribeServerlessCacheSnapshotsResponse = aws_sdk_elasticache.types.describe_serverless_cache_snapshots_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_serverless_cache_snapshots_request.DescribeServerlessCacheSnapshotsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeServerlessCacheSnapshots"))
    pairs.append(("Version", "2015-02-02"))
    import aws_sdk_elasticache.types.describe_serverless_cache_snapshots_request

    aws_sdk_elasticache.types.describe_serverless_cache_snapshots_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_serverless_cache_snapshots(
