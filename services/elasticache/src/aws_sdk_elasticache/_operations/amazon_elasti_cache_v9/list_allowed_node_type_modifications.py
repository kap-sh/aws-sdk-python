"""Generated from Smithy shape ``com.amazonaws.elasticache#ListAllowedNodeTypeModifications``."""
...
import aws_sdk_elasticache.types.node_type_list
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListAllowedNodeTypeModificationsResult")
    out: aws_sdk_elasticache.types.allowed_node_type_modifications_message.AllowedNodeTypeModificationsMessage = aws_sdk_elasticache.types.allowed_node_type_modifications_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.list_allowed_node_type_modifications_message.ListAllowedNodeTypeModificationsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_allowed_node_type_modifications(
