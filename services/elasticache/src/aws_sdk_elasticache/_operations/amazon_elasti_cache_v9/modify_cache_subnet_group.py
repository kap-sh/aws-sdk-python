"""Generated from Smithy shape ``com.amazonaws.elasticache#ModifyCacheSubnetGroup``."""
...
import aws_sdk_elasticache.errors.subnet_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubnetInUse":
            raise aws_sdk_elasticache.errors.subnet_in_use.SubnetInUse.from_query(root)
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyCacheSubnetGroupResult")
    out: aws_sdk_elasticache.types.modify_cache_subnet_group_result.ModifyCacheSubnetGroupResult = aws_sdk_elasticache.types.modify_cache_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.modify_cache_subnet_group_message.ModifyCacheSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyCacheSubnetGroup"))
    pairs.append(("Version", "2015-02-02"))
    import aws_sdk_elasticache.types.modify_cache_subnet_group_message

    aws_sdk_elasticache.types.modify_cache_subnet_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_cache_subnet_group(
