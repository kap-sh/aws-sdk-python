...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.delete_replication_group_result.DeleteReplicationGroupResult = aws_sdk_elasticache.types.delete_replication_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.delete_replication_group_message.DeleteReplicationGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.delete_replication_group_message.serialize_query(
        input_, pairs, ""
    )
