...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ReplicationGroupNotUnderMigrationFault":
            import aws_sdk_elasticache.errors.replication_group_not_under_migration_fault

            raise aws_sdk_elasticache.errors.replication_group_not_under_migration_fault.ReplicationGroupNotUnderMigrationFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.complete_migration_response.CompleteMigrationResponse = aws_sdk_elasticache.types.complete_migration_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.complete_migration_message.CompleteMigrationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.complete_migration_message.serialize_query(
        input_, pairs, ""
    )
