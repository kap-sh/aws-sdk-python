"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeReservedCacheNodes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeReservedCacheNodesResult")
    out: aws_sdk_elasticache.types.reserved_cache_node_message.ReservedCacheNodeMessage = aws_sdk_elasticache.types.reserved_cache_node_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_reserved_cache_nodes_message.DescribeReservedCacheNodesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeReservedCacheNodes"))
    pairs.append(("Version", "2015-02-02"))
    aws_sdk_elasticache.types.describe_reserved_cache_nodes_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_reserved_cache_nodes(
