"""Generated from Smithy shape ``com.amazonaws.elasticache#RevokeCacheSecurityGroupIngress``."""
...
import aws_sdk_elasticache.errors.authorization_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AuthorizationNotFoundFault":
            raise aws_sdk_elasticache.errors.authorization_not_found_fault.AuthorizationNotFoundFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("RevokeCacheSecurityGroupIngressResult")
    out: aws_sdk_elasticache.types.revoke_cache_security_group_ingress_result.RevokeCacheSecurityGroupIngressResult = aws_sdk_elasticache.types.revoke_cache_security_group_ingress_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.revoke_cache_security_group_ingress_message.RevokeCacheSecurityGroupIngressMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RevokeCacheSecurityGroupIngress"))
    pairs.append(("Version", "2015-02-02"))
    aws_sdk_elasticache.types.revoke_cache_security_group_ingress_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_revoke_cache_security_group_ingress(
