"""Generated from Smithy shape ``com.amazonaws.elasticache#DeleteCacheSecurityGroup``."""
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.delete_cache_security_group_message.DeleteCacheSecurityGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteCacheSecurityGroup"))
    pairs.append(("Version", "2015-02-02"))
    aws_sdk_elasticache.types.delete_cache_security_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_cache_security_group(
