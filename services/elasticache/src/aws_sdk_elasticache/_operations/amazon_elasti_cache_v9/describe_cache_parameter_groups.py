...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.cache_parameter_groups_message.CacheParameterGroupsMessage = aws_sdk_elasticache.types.cache_parameter_groups_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_cache_parameter_groups_message.DescribeCacheParameterGroupsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.describe_cache_parameter_groups_message.serialize_query(
        input_, pairs, ""
    )
