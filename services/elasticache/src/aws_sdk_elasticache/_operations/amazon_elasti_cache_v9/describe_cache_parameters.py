...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_cache_parameters_message.DescribeCacheParametersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.describe_cache_parameters_message.serialize_query(
        input_, pairs, ""
    )
