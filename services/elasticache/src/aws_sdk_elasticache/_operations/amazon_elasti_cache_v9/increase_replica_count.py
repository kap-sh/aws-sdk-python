...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.increase_replica_count_result.IncreaseReplicaCountResult = aws_sdk_elasticache.types.increase_replica_count_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.increase_replica_count_message.IncreaseReplicaCountMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.increase_replica_count_message.serialize_query(
        input_, pairs, ""
    )
