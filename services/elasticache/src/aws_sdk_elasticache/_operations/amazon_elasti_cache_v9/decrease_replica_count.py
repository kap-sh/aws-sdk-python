...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.decrease_replica_count_message.DecreaseReplicaCountMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.decrease_replica_count_message.serialize_query(
        input_, pairs, ""
    )
