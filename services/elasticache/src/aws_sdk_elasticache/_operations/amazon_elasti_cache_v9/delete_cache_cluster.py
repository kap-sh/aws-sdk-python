...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.delete_cache_cluster_result.DeleteCacheClusterResult = aws_sdk_elasticache.types.delete_cache_cluster_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.delete_cache_cluster_message.DeleteCacheClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.delete_cache_cluster_message.serialize_query(
        input_, pairs, ""
    )
