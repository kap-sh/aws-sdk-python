"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeCacheEngineVersions``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeCacheEngineVersionsResult")
    out: aws_sdk_elasticache.types.cache_engine_version_message.CacheEngineVersionMessage = aws_sdk_elasticache.types.cache_engine_version_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_cache_engine_versions_message.DescribeCacheEngineVersionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_cache_engine_versions(
