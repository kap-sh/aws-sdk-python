...
def build_request(
    ...
    input: aws_sdk_elasticache.types.delete_user_message.DeleteUserMessage,
) -> zapros.Request:
    ...
    aws_sdk_elasticache.types.delete_user_message.serialize_query(input, pairs, "")
...
def delete_user(
    ...
    input: aws_sdk_elasticache.types.delete_user_message.DeleteUserMessage,
) -> tuple[aws_sdk_elasticache.types.user.User, zapros.Response]:
