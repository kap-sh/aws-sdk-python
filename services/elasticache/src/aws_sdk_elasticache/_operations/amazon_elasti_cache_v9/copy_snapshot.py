...
def build_request(
    ...
    input: aws_sdk_elasticache.types.copy_snapshot_message.CopySnapshotMessage,
) -> zapros.Request:
    ...
    aws_sdk_elasticache.types.copy_snapshot_message.serialize_query(input, pairs, "")
...
def copy_snapshot(
    ...
    aws_sdk_elasticache.types.copy_snapshot_result.CopySnapshotResult, zapros.Response
]:
