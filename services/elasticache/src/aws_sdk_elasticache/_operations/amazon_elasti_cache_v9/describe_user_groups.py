...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.describe_user_groups_result.DescribeUserGroupsResult = aws_sdk_elasticache.types.describe_user_groups_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_user_groups_message.DescribeUserGroupsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.describe_user_groups_message.serialize_query(
        input_, pairs, ""
    )
