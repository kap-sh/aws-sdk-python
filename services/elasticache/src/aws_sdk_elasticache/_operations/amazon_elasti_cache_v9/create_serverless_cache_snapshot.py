...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.create_serverless_cache_snapshot_response.CreateServerlessCacheSnapshotResponse = aws_sdk_elasticache.types.create_serverless_cache_snapshot_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.create_serverless_cache_snapshot_request.CreateServerlessCacheSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.create_serverless_cache_snapshot_request.serialize_query(
        input_, pairs, ""
    )
