...
def build_request(
    ...
    input: aws_sdk_elasticache.types.start_migration_message.StartMigrationMessage,
) -> zapros.Request:
    ...
    aws_sdk_elasticache.types.start_migration_message.serialize_query(input, pairs, "")
