...
import aws_sdk_elasticache.errors.replication_group_already_under_migration_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ReplicationGroupAlreadyUnderMigrationFault":
            raise aws_sdk_elasticache.errors.replication_group_already_under_migration_fault.ReplicationGroupAlreadyUnderMigrationFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.start_migration_response.StartMigrationResponse = (
        aws_sdk_elasticache.types.start_migration_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.start_migration_message.StartMigrationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.start_migration_message.serialize_query(input_, pairs, "")
