...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CacheSubnetGroupInUse":
            import aws_sdk_elasticache.errors.cache_subnet_group_in_use

            raise aws_sdk_elasticache.errors.cache_subnet_group_in_use.CacheSubnetGroupInUse.from_query(
                root
            )
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.delete_cache_subnet_group_message.DeleteCacheSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.delete_cache_subnet_group_message.serialize_query(
        input_, pairs, ""
    )
