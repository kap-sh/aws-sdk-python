...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_serverless_caches_request.DescribeServerlessCachesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.describe_serverless_caches_request.serialize_query(
        input_, pairs, ""
    )
