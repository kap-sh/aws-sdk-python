...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.delete_serverless_cache_snapshot_request.DeleteServerlessCacheSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.delete_serverless_cache_snapshot_request.serialize_query(
        input_, pairs, ""
    )
