"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeReservedCacheNodesOfferings``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeReservedCacheNodesOfferingsResult")
    out: aws_sdk_elasticache.types.reserved_cache_nodes_offering_message.ReservedCacheNodesOfferingMessage = aws_sdk_elasticache.types.reserved_cache_nodes_offering_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_reserved_cache_nodes_offerings_message.DescribeReservedCacheNodesOfferingsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeReservedCacheNodesOfferings"))
    pairs.append(("Version", "2015-02-02"))
    import aws_sdk_elasticache.types.describe_reserved_cache_nodes_offerings_message

    aws_sdk_elasticache.types.describe_reserved_cache_nodes_offerings_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_reserved_cache_nodes_offerings(
