...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.modify_cache_cluster_message.ModifyCacheClusterMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.modify_cache_cluster_message.serialize_query(
        input_, pairs, ""
    )
