"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeCacheSecurityGroups``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeCacheSecurityGroupsResult")
    out: aws_sdk_elasticache.types.cache_security_group_message.CacheSecurityGroupMessage = aws_sdk_elasticache.types.cache_security_group_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_cache_security_groups_message.DescribeCacheSecurityGroupsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeCacheSecurityGroups"))
    pairs.append(("Version", "2015-02-02"))
    import aws_sdk_elasticache.types.describe_cache_security_groups_message

    aws_sdk_elasticache.types.describe_cache_security_groups_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_cache_security_groups(
