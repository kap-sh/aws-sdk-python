"""Generated from Smithy shape ``com.amazonaws.elasticache#ModifyReplicationGroupShardConfiguration``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyReplicationGroupShardConfigurationResult")
    out: aws_sdk_elasticache.types.modify_replication_group_shard_configuration_result.ModifyReplicationGroupShardConfigurationResult = aws_sdk_elasticache.types.modify_replication_group_shard_configuration_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.modify_replication_group_shard_configuration_message.ModifyReplicationGroupShardConfigurationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyReplicationGroupShardConfiguration"))
    pairs.append(("Version", "2015-02-02"))
    import aws_sdk_elasticache.types.modify_replication_group_shard_configuration_message

    aws_sdk_elasticache.types.modify_replication_group_shard_configuration_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_replication_group_shard_configuration(
