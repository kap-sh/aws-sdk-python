...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.test_migration_response.TestMigrationResponse = (
        aws_sdk_elasticache.types.test_migration_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.test_migration_message.TestMigrationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.test_migration_message.serialize_query(input_, pairs, "")
