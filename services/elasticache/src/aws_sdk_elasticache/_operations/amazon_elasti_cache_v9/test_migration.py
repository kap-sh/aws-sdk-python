...
def build_request(
    ...
    input: aws_sdk_elasticache.types.test_migration_message.TestMigrationMessage,
) -> zapros.Request:
    ...
    aws_sdk_elasticache.types.test_migration_message.serialize_query(input, pairs, "")
