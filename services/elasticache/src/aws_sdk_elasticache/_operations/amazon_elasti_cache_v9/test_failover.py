...
def build_request(
    ...
    input: aws_sdk_elasticache.types.test_failover_message.TestFailoverMessage,
) -> zapros.Request:
    ...
    aws_sdk_elasticache.types.test_failover_message.serialize_query(input, pairs, "")
...
def test_failover(
    ...
    aws_sdk_elasticache.types.test_failover_result.TestFailoverResult, zapros.Response
]:
