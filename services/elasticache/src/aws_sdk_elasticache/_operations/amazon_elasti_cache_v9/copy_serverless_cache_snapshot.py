"""Generated from Smithy shape ``com.amazonaws.elasticache#CopyServerlessCacheSnapshot``."""
...
import aws_sdk_elasticache.errors.serverless_cache_snapshot_already_exists_fault
import aws_sdk_elasticache.errors.serverless_cache_snapshot_not_found_fault
import aws_sdk_elasticache.errors.serverless_cache_snapshot_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServerlessCacheSnapshotAlreadyExistsFault":
            raise aws_sdk_elasticache.errors.serverless_cache_snapshot_already_exists_fault.ServerlessCacheSnapshotAlreadyExistsFault.from_query(
                root
            )
        ...
        case "ServerlessCacheSnapshotQuotaExceededFault":
            raise aws_sdk_elasticache.errors.serverless_cache_snapshot_quota_exceeded_fault.ServerlessCacheSnapshotQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CopyServerlessCacheSnapshotResult")
    out: aws_sdk_elasticache.types.copy_serverless_cache_snapshot_response.CopyServerlessCacheSnapshotResponse = aws_sdk_elasticache.types.copy_serverless_cache_snapshot_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.copy_serverless_cache_snapshot_request.CopyServerlessCacheSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CopyServerlessCacheSnapshot"))
    pairs.append(("Version", "2015-02-02"))
    aws_sdk_elasticache.types.copy_serverless_cache_snapshot_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_copy_serverless_cache_snapshot(
