"""Generated from Smithy shape ``com.amazonaws.elasticache#AuthorizeCacheSecurityGroupIngress``."""
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.authorize_cache_security_group_ingress_message.AuthorizeCacheSecurityGroupIngressMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AuthorizeCacheSecurityGroupIngress"))
    pairs.append(("Version", "2015-02-02"))
    aws_sdk_elasticache.types.authorize_cache_security_group_ingress_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_authorize_cache_security_group_ingress(
