...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_engine_default_parameters_message.DescribeEngineDefaultParametersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.describe_engine_default_parameters_message.serialize_query(
        input_, pairs, ""
    )
