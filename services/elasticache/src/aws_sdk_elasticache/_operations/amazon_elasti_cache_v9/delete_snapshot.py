...
def build_request(
    ...
    input: aws_sdk_elasticache.types.delete_snapshot_message.DeleteSnapshotMessage,
) -> zapros.Request:
    ...
    aws_sdk_elasticache.types.delete_snapshot_message.serialize_query(input, pairs, "")
