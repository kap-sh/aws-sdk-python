"""Generated from Smithy shape ``com.amazonaws.elasticache#DeleteSnapshot``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteSnapshotResult")
    out: aws_sdk_elasticache.types.delete_snapshot_result.DeleteSnapshotResult = (
        aws_sdk_elasticache.types.delete_snapshot_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.delete_snapshot_message.DeleteSnapshotMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteSnapshot"))
    pairs.append(("Version", "2015-02-02"))
    import aws_sdk_elasticache.types.delete_snapshot_message

    aws_sdk_elasticache.types.delete_snapshot_message.serialize_query(input_, pairs, "")
