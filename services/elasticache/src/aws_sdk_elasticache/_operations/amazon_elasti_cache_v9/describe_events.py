...
def build_request(
    ...
    input: aws_sdk_elasticache.types.describe_events_message.DescribeEventsMessage,
) -> zapros.Request:
    ...
    aws_sdk_elasticache.types.describe_events_message.serialize_query(input, pairs, "")
