"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeUpdateActions``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeUpdateActionsResult")
    out: aws_sdk_elasticache.types.update_actions_message.UpdateActionsMessage = (
        aws_sdk_elasticache.types.update_actions_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_update_actions_message.DescribeUpdateActionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeUpdateActions"))
    pairs.append(("Version", "2015-02-02"))
    aws_sdk_elasticache.types.describe_update_actions_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_update_actions(
