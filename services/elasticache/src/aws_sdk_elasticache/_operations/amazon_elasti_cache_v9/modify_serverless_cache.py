...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.modify_serverless_cache_response.ModifyServerlessCacheResponse = aws_sdk_elasticache.types.modify_serverless_cache_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.modify_serverless_cache_request.ModifyServerlessCacheRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.modify_serverless_cache_request.serialize_query(
        input_, pairs, ""
    )
