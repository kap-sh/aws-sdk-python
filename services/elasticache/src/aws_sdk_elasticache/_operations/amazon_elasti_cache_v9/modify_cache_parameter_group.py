...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidCacheParameterGroupStateFault":
            import aws_sdk_elasticache.errors.invalid_cache_parameter_group_state_fault

            raise aws_sdk_elasticache.errors.invalid_cache_parameter_group_state_fault.InvalidCacheParameterGroupStateFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.cache_parameter_group_name_message.CacheParameterGroupNameMessage = aws_sdk_elasticache.types.cache_parameter_group_name_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.modify_cache_parameter_group_message.ModifyCacheParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.modify_cache_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
