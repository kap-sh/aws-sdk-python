...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.export_serverless_cache_snapshot_response.ExportServerlessCacheSnapshotResponse = aws_sdk_elasticache.types.export_serverless_cache_snapshot_response.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.export_serverless_cache_snapshot_request.ExportServerlessCacheSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elasticache.types.export_serverless_cache_snapshot_request.serialize_query(
        input_, pairs, ""
    )
