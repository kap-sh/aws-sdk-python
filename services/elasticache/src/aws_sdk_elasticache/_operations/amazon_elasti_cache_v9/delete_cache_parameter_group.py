"""Generated from Smithy shape ``com.amazonaws.elasticache#DeleteCacheParameterGroup``."""
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.delete_cache_parameter_group_message.DeleteCacheParameterGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_cache_parameter_group(
