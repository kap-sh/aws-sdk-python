"""Generated from Smithy shape ``com.amazonaws.elasticache#BatchApplyUpdateAction``."""
...
import aws_sdk_elasticache.errors.service_update_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceUpdateNotFoundFault":
            raise aws_sdk_elasticache.errors.service_update_not_found_fault.ServiceUpdateNotFoundFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("BatchApplyUpdateActionResult")
    out: aws_sdk_elasticache.types.update_action_results_message.UpdateActionResultsMessage = aws_sdk_elasticache.types.update_action_results_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.batch_apply_update_action_message.BatchApplyUpdateActionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "BatchApplyUpdateAction"))
    pairs.append(("Version", "2015-02-02"))
    aws_sdk_elasticache.types.batch_apply_update_action_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_batch_apply_update_action(
