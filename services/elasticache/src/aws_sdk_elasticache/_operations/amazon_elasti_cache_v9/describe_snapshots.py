"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeSnapshots``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeSnapshotsResult")
    out: aws_sdk_elasticache.types.describe_snapshots_list_message.DescribeSnapshotsListMessage = aws_sdk_elasticache.types.describe_snapshots_list_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_snapshots_message.DescribeSnapshotsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
