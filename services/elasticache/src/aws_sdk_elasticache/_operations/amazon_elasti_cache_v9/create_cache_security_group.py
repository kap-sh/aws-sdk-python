...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CacheSecurityGroupAlreadyExistsFault":
            import aws_sdk_elasticache.errors.cache_security_group_already_exists_fault

            raise aws_sdk_elasticache.errors.cache_security_group_already_exists_fault.CacheSecurityGroupAlreadyExistsFault.from_query(
                root
            )
        case "CacheSecurityGroupQuotaExceededFault":
            import aws_sdk_elasticache.errors.cache_security_group_quota_exceeded_fault

            raise aws_sdk_elasticache.errors.cache_security_group_quota_exceeded_fault.CacheSecurityGroupQuotaExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_elasticache.types.create_cache_security_group_result.CreateCacheSecurityGroupResult = aws_sdk_elasticache.types.create_cache_security_group_result.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.create_cache_security_group_message.CreateCacheSecurityGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
