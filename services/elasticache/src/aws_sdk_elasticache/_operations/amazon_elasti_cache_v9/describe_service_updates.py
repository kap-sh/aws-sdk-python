"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeServiceUpdates``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeServiceUpdatesResult")
    out: aws_sdk_elasticache.types.service_updates_message.ServiceUpdatesMessage = (
        aws_sdk_elasticache.types.service_updates_message.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elasticache.types.describe_service_updates_message.DescribeServiceUpdatesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeServiceUpdates"))
    pairs.append(("Version", "2015-02-02"))
    aws_sdk_elasticache.types.describe_service_updates_message.serialize_query(
        input_, pairs, ""
    )
