...
class AllowedNodeTypeModificationsMessage(TypedDict):
    scale_up_modifications: NotRequired[
        "aws_sdk_elasticache.types.node_type_list.NodeTypeList"
    ]
...
def serialize_query(
    ...
    if "scale_up_modifications" in value:
        ...
        aws_sdk_elasticache.types.node_type_list.serialize_query(
...
def deserialize_query(el: Element) -> AllowedNodeTypeModificationsMessage:
    ...
    if child_scale_up_modifications is not None:
        ...
        out["scale_up_modifications"] = (
            aws_sdk_elasticache.types.node_type_list.deserialize_query(
