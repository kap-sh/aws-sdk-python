...
if TYPE_CHECKING:
    import aws_sdk_elasticache.types.log_delivery_configuration_request

LogDeliveryConfigurationRequestList: TypeAlias = list[
    "aws_sdk_elasticache.types.log_delivery_configuration_request.LogDeliveryConfigurationRequest"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elasticache.types.log_delivery_configuration_request.serialize_query(
...
def deserialize_query(el: Element) -> LogDeliveryConfigurationRequestList:
    ...
    for child in el.findall("LogDeliveryConfigurationRequest"):
        out.append(
            aws_sdk_elasticache.types.log_delivery_configuration_request.deserialize_query(
                child
            )
        )
    return out
