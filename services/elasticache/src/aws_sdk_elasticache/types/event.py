"""Generated from Smithy shape ``com.amazonaws.elasticache#Event``."""
...
class Event(TypedDict, closed=True):
    ...
    date: NotRequired["aws_sdk_elasticache.types.t_stamp.TStamp"]
...
def deserialize_query(el: Element) -> Event:
    ...
    if child_date is not None:
        ...
        out["date"] = aws_sdk_elasticache.types.t_stamp.deserialize_query(child_date)
    return out
