...
class DecreaseNodeGroupsInGlobalReplicationGroupMessage(TypedDict):
...
def serialize_query(
    ...
    if "global_node_groups_to_remove" in value:
        ...
        aws_sdk_elasticache.types.global_node_group_id_list.serialize_query(
...
def deserialize_query(el: Element) -> DecreaseNodeGroupsInGlobalReplicationGroupMessage:
    ...
    if child_global_node_groups_to_remove is not None:
        ...
        out["global_node_groups_to_remove"] = (
            aws_sdk_elasticache.types.global_node_group_id_list.deserialize_query(
