...
if TYPE_CHECKING:
    ...
    import aws_sdk_elasticache.types.node_snapshot_list
...
class Snapshot(TypedDict):
    ...
    snapshot_status: NotRequired["aws_sdk_elasticache.types.string.String"]
    ...
    snapshot_source: NotRequired["aws_sdk_elasticache.types.string.String"]
    ...
    node_snapshots: NotRequired[
        "aws_sdk_elasticache.types.node_snapshot_list.NodeSnapshotList"
    ]
    ...
    """<p>The durability setting of the cluster when the snapshot was taken. When restoring from this snapshot, the cluster uses this durability setting unless overridden in the restore request. For more information, see <a href=\"http://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Durability.html\">Durability</a>.</p>"""
...
def serialize_query(value: Snapshot, pairs: list[tuple[str, str]], prefix: str) -> None:
    ...
    if "node_snapshots" in value:
        ...
        aws_sdk_elasticache.types.node_snapshot_list.serialize_query(
...
def deserialize_query(el: Element) -> Snapshot:
    ...
    if child_node_snapshots is not None:
        ...
        out["node_snapshots"] = (
            aws_sdk_elasticache.types.node_snapshot_list.deserialize_query(
