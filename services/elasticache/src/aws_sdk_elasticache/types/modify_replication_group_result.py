"""Generated from Smithy shape ``com.amazonaws.elasticache#ModifyReplicationGroupResult``."""
...
class ModifyReplicationGroupResult(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ModifyReplicationGroupResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ModifyReplicationGroupResult:
    out: ModifyReplicationGroupResult = {}  # type: ignore[typeddict-item]
