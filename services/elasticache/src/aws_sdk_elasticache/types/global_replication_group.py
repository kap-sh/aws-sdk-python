...
if TYPE_CHECKING:
    ...
    import aws_sdk_elasticache.types.global_node_group_list
    import aws_sdk_elasticache.types.global_replication_group_member_list
    import aws_sdk_elasticache.types.string


class GlobalReplicationGroup(TypedDict):
    ...
    members: NotRequired[
        "aws_sdk_elasticache.types.global_replication_group_member_list.GlobalReplicationGroupMemberList"
    ]
    ...
    global_node_groups: NotRequired[
        "aws_sdk_elasticache.types.global_node_group_list.GlobalNodeGroupList"
    ]
...
def serialize_query(
    ...
    if "members" in value:
        ...
        aws_sdk_elasticache.types.global_replication_group_member_list.serialize_query(
    ...
    if "global_node_groups" in value:
        ...
        aws_sdk_elasticache.types.global_node_group_list.serialize_query(
...
def deserialize_query(el: Element) -> GlobalReplicationGroup:
    ...
    if child_members is not None:
        ...
        out["members"] = (
            aws_sdk_elasticache.types.global_replication_group_member_list.deserialize_query(
                child_members
            )
        )
    ...
    if child_global_node_groups is not None:
        ...
        out["global_node_groups"] = (
            aws_sdk_elasticache.types.global_node_group_list.deserialize_query(
