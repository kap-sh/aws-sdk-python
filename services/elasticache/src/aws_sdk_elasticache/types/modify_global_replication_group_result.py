"""Generated from Smithy shape ``com.amazonaws.elasticache#ModifyGlobalReplicationGroupResult``."""
...
class ModifyGlobalReplicationGroupResult(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ModifyGlobalReplicationGroupResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ModifyGlobalReplicationGroupResult:
    out: ModifyGlobalReplicationGroupResult = {}  # type: ignore[typeddict-item]
