...
if TYPE_CHECKING:
    import aws_sdk_elasticache.types.cache_node_update_status_list
    import aws_sdk_elasticache.types.node_group_update_status_list
...
class UpdateAction(TypedDict):
    ...
    update_action_available_date: NotRequired[
        "aws_sdk_elasticache.types.t_stamp.TStamp"
    ]
    ...
    nodes_updated: NotRequired["aws_sdk_elasticache.types.string.String"]
    ...
    sla_met: NotRequired["aws_sdk_elasticache.types.sla_met.SlaMet"]
    ...
    node_group_update_status: NotRequired[
        "aws_sdk_elasticache.types.node_group_update_status_list.NodeGroupUpdateStatusList"
    ]
    """<p>The status of the service update on the node group</p>"""
    cache_node_update_status: NotRequired[
        "aws_sdk_elasticache.types.cache_node_update_status_list.CacheNodeUpdateStatusList"
    ]
...
def serialize_query(
    ...
    if "sla_met" in value:
        ...
        aws_sdk_elasticache.types.sla_met.serialize_query(
            value["sla_met"], pairs, f"{prefix}.SlaMet"
        )
    if "node_group_update_status" in value:
        import aws_sdk_elasticache.types.node_group_update_status_list

        aws_sdk_elasticache.types.node_group_update_status_list.serialize_query(
            value["node_group_update_status"], pairs, f"{prefix}.NodeGroupUpdateStatus"
        )
    if "cache_node_update_status" in value:
        import aws_sdk_elasticache.types.cache_node_update_status_list

        aws_sdk_elasticache.types.cache_node_update_status_list.serialize_query(
...
def deserialize_query(el: Element) -> UpdateAction:
    ...
    if child_sla_met is not None:
        ...
        out["sla_met"] = aws_sdk_elasticache.types.sla_met.deserialize_query(
            child_sla_met
        )
    ...
    if child_node_group_update_status is not None:
        ...
        out["node_group_update_status"] = (
            aws_sdk_elasticache.types.node_group_update_status_list.deserialize_query(
    ...
    if child_cache_node_update_status is not None:
        ...
        out["cache_node_update_status"] = (
            aws_sdk_elasticache.types.cache_node_update_status_list.deserialize_query(
