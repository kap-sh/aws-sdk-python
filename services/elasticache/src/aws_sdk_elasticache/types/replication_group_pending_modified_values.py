...
if TYPE_CHECKING:
    import aws_sdk_elasticache.types.auth_token_update_status
    import aws_sdk_elasticache.types.boolean_optional
    import aws_sdk_elasticache.types.cluster_mode
    import aws_sdk_elasticache.types.pending_automatic_failover_status
    import aws_sdk_elasticache.types.pending_log_delivery_configuration_list
    import aws_sdk_elasticache.types.resharding_status
...
class ReplicationGroupPendingModifiedValues(TypedDict, closed=True):
    ...
    automatic_failover_status: NotRequired[
        "aws_sdk_elasticache.types.pending_automatic_failover_status.PendingAutomaticFailoverStatus"
    ]
    """<p>Indicates the status of automatic failover for this Valkey or Redis OSS replication group.</p>"""
    resharding: NotRequired[
        "aws_sdk_elasticache.types.resharding_status.ReshardingStatus"
    ]
    """<p>The status of an online resharding operation.</p>"""
    auth_token_status: NotRequired[
        "aws_sdk_elasticache.types.auth_token_update_status.AuthTokenUpdateStatus"
    ]
    """<p>The auth token status</p>"""
    user_groups: NotRequired[
        "aws_sdk_elasticache.types.user_groups_update_status.UserGroupsUpdateStatus"
    ]
    """<p>The user group being modified.</p>"""
    log_delivery_configurations: NotRequired[
        "aws_sdk_elasticache.types.pending_log_delivery_configuration_list.PendingLogDeliveryConfigurationList"
    ]
...
def serialize_query(
    ...
    if "automatic_failover_status" in value:
        ...
        aws_sdk_elasticache.types.pending_automatic_failover_status.serialize_query(
    ...
    if "resharding" in value:
        ...
        aws_sdk_elasticache.types.resharding_status.serialize_query(
            value["resharding"], pairs, f"{prefix}.Resharding"
        )
    if "auth_token_status" in value:
        import aws_sdk_elasticache.types.auth_token_update_status

        aws_sdk_elasticache.types.auth_token_update_status.serialize_query(
            value["auth_token_status"], pairs, f"{prefix}.AuthTokenStatus"
        )
    if "user_groups" in value:
        import aws_sdk_elasticache.types.user_groups_update_status

        aws_sdk_elasticache.types.user_groups_update_status.serialize_query(
            value["user_groups"], pairs, f"{prefix}.UserGroups"
        )
    if "log_delivery_configurations" in value:
        import aws_sdk_elasticache.types.pending_log_delivery_configuration_list

        aws_sdk_elasticache.types.pending_log_delivery_configuration_list.serialize_query(
...
def deserialize_query(el: Element) -> ReplicationGroupPendingModifiedValues:
    ...
    if child_automatic_failover_status is not None:
        ...
        out["automatic_failover_status"] = (
            aws_sdk_elasticache.types.pending_automatic_failover_status.deserialize_query(
    ...
    if child_resharding is not None:
        ...
        out["resharding"] = (
            aws_sdk_elasticache.types.resharding_status.deserialize_query(
                child_resharding
            )
        )
    ...
    if child_auth_token_status is not None:
        ...
        out["auth_token_status"] = (
            aws_sdk_elasticache.types.auth_token_update_status.deserialize_query(
    ...
    if child_user_groups is not None:
        ...
        out["user_groups"] = (
            aws_sdk_elasticache.types.user_groups_update_status.deserialize_query(
                child_user_groups
            )
        )
    ...
    if child_log_delivery_configurations is not None:
        ...
        out["log_delivery_configurations"] = (
            aws_sdk_elasticache.types.pending_log_delivery_configuration_list.deserialize_query(
