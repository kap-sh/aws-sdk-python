...
class DescribeReservedCacheNodesMessage(TypedDict, closed=True):
    ...
    duration: NotRequired["aws_sdk_elasticache.types.string.String"]
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DescribeReservedCacheNodesMessage, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DescribeReservedCacheNodesMessage:
    out: DescribeReservedCacheNodesMessage = {}  # type: ignore[typeddict-item]
