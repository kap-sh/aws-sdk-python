...
# --- awsQuery ser/de ---
def serialize_query(
    value: DescribeCacheParametersMessage, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DescribeCacheParametersMessage:
    out: DescribeCacheParametersMessage = {}  # type: ignore[typeddict-item]
