...
if TYPE_CHECKING:
    ...
    import aws_sdk_elasticache.types.cache_node_type_specific_value_list
    import aws_sdk_elasticache.types.change_type
    import aws_sdk_elasticache.types.string


class CacheNodeTypeSpecificParameter(TypedDict):
    ...
    data_type: NotRequired["aws_sdk_elasticache.types.string.String"]
    """<p>The valid data type for the parameter.</p>"""
    allowed_values: NotRequired["aws_sdk_elasticache.types.string.String"]
    """<p>The valid range of values for the parameter.</p>"""
    is_modifiable: NotRequired["aws_sdk_elasticache.types.boolean.Boolean"]
    ...
    cache_node_type_specific_values: NotRequired[
        "aws_sdk_elasticache.types.cache_node_type_specific_value_list.CacheNodeTypeSpecificValueList"
    ]
...
def serialize_query(
    ...
    if "cache_node_type_specific_values" in value:
        ...
        aws_sdk_elasticache.types.cache_node_type_specific_value_list.serialize_query(
            value["cache_node_type_specific_values"],
            pairs,
            f"{prefix}.CacheNodeTypeSpecificValues",
        )
    if "change_type" in value:
        import aws_sdk_elasticache.types.change_type

        aws_sdk_elasticache.types.change_type.serialize_query(
            value["change_type"], pairs, f"{prefix}.ChangeType"
        )
...
def deserialize_query(el: Element) -> CacheNodeTypeSpecificParameter:
    ...
    if child_cache_node_type_specific_values is not None:
        ...
        out["cache_node_type_specific_values"] = (
            aws_sdk_elasticache.types.cache_node_type_specific_value_list.deserialize_query(
    ...
    if child_change_type is not None:
        ...
        out["change_type"] = aws_sdk_elasticache.types.change_type.deserialize_query(
            child_change_type
        )
    return out
