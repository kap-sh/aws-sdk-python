"""Generated from Smithy shape ``com.amazonaws.elasticache#DisassociateGlobalReplicationGroupResult``."""
...
class DisassociateGlobalReplicationGroupResult(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DisassociateGlobalReplicationGroupResult,
...
def deserialize_query(el: Element) -> DisassociateGlobalReplicationGroupResult:
    out: DisassociateGlobalReplicationGroupResult = {}  # type: ignore[typeddict-item]
