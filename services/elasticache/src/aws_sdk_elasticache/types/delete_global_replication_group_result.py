"""Generated from Smithy shape ``com.amazonaws.elasticache#DeleteGlobalReplicationGroupResult``."""
...
class DeleteGlobalReplicationGroupResult(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DeleteGlobalReplicationGroupResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DeleteGlobalReplicationGroupResult:
    out: DeleteGlobalReplicationGroupResult = {}  # type: ignore[typeddict-item]
