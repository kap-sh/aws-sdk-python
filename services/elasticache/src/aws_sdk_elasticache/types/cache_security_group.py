...
if TYPE_CHECKING:
    import aws_sdk_elasticache.types.ec2_security_group_list
    import aws_sdk_elasticache.types.string


class CacheSecurityGroup(TypedDict):
    owner_id: NotRequired["aws_sdk_elasticache.types.string.String"]
    ...
    ec2_security_groups: NotRequired[
        "aws_sdk_elasticache.types.ec2_security_group_list.EC2SecurityGroupList"
    ]
...
def serialize_query(
    ...
    if "ec2_security_groups" in value:
        ...
        aws_sdk_elasticache.types.ec2_security_group_list.serialize_query(
...
def deserialize_query(el: Element) -> CacheSecurityGroup:
    ...
    if child_ec2_security_groups is not None:
        ...
        out["ec2_security_groups"] = (
            aws_sdk_elasticache.types.ec2_security_group_list.deserialize_query(
