...
class CreateCacheClusterMessage(TypedDict):
    ...
    outpost_mode: NotRequired["aws_sdk_elasticache.types.outpost_mode.OutpostMode"]
...
def serialize_query(
    ...
    if "outpost_mode" in value:
        ...
        aws_sdk_elasticache.types.outpost_mode.serialize_query(
...
def deserialize_query(el: Element) -> CreateCacheClusterMessage:
    ...
    if child_outpost_mode is not None:
        ...
        out["outpost_mode"] = aws_sdk_elasticache.types.outpost_mode.deserialize_query(
            child_outpost_mode
        )
