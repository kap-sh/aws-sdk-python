...
if TYPE_CHECKING:
    import aws_sdk_elasticache.types.regional_configuration

RegionalConfigurationList: TypeAlias = list[
    "aws_sdk_elasticache.types.regional_configuration.RegionalConfiguration"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elasticache.types.regional_configuration.serialize_query(
...
def deserialize_query(el: Element) -> RegionalConfigurationList:
    ...
    for child in el.findall("RegionalConfiguration"):
        out.append(
            aws_sdk_elasticache.types.regional_configuration.deserialize_query(child)
        )
    return out
