...
ParametersList: TypeAlias = list["aws_sdk_elasticache.types.parameter.Parameter"]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elasticache.types.parameter.serialize_query(
...
def deserialize_query(el: Element) -> ParametersList:
    ...
    for child in el.findall("Parameter"):
        out.append(aws_sdk_elasticache.types.parameter.deserialize_query(child))
    return out
