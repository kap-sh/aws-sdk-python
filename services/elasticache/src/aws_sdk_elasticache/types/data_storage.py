...
if TYPE_CHECKING:
    import aws_sdk_elasticache.types.data_storage_unit
    import aws_sdk_elasticache.types.integer_optional


class DataStorage(TypedDict, closed=True):
    maximum: NotRequired["aws_sdk_elasticache.types.integer_optional.IntegerOptional"]
    """<p>The upper limit for data storage the cache is set to use.</p>"""
    minimum: NotRequired["aws_sdk_elasticache.types.integer_optional.IntegerOptional"]
    """<p>The lower limit for data storage the cache is set to use.</p>"""
    unit: NotRequired["aws_sdk_elasticache.types.data_storage_unit.DataStorageUnit"]
...
def serialize_query(
    ...
    if "unit" in value:
        ...
        aws_sdk_elasticache.types.data_storage_unit.serialize_query(
...
def deserialize_query(el: Element) -> DataStorage:
    ...
    if child_unit is not None:
        ...
        out["unit"] = aws_sdk_elasticache.types.data_storage_unit.deserialize_query(
            child_unit
        )
    return out
