...
if TYPE_CHECKING:
    ...
    import aws_sdk_elasticache.types.log_delivery_configuration_status
...
class LogDeliveryConfiguration(TypedDict):
    ...
    status: NotRequired[
        "aws_sdk_elasticache.types.log_delivery_configuration_status.LogDeliveryConfigurationStatus"
    ]
    ...
    message: NotRequired["aws_sdk_elasticache.types.string.String"]
...
def serialize_query(
    ...
    if "status" in value:
        ...
        aws_sdk_elasticache.types.log_delivery_configuration_status.serialize_query(
...
def deserialize_query(el: Element) -> LogDeliveryConfiguration:
    ...
    if child_status is not None:
        ...
        out["status"] = (
            aws_sdk_elasticache.types.log_delivery_configuration_status.deserialize_query(
                child_status
            )
        )
