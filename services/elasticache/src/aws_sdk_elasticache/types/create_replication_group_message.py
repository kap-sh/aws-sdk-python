...
def serialize_query(
    ...
    if "node_group_configuration" in value:
        ...
        aws_sdk_elasticache.types.node_group_configuration_list.serialize_query(
    ...
    if "user_group_ids" in value:
        ...
        aws_sdk_elasticache.types.user_group_id_list_input.serialize_query(
...
def deserialize_query(el: Element) -> CreateReplicationGroupMessage:
    ...
    if child_node_group_configuration is not None:
        ...
        out["node_group_configuration"] = (
            aws_sdk_elasticache.types.node_group_configuration_list.deserialize_query(
    ...
    if child_user_group_ids is not None:
        ...
        out["user_group_ids"] = (
            aws_sdk_elasticache.types.user_group_id_list_input.deserialize_query(
