...
class UnprocessedUpdateAction(TypedDict):
    ...
    error_type: NotRequired["aws_sdk_elasticache.types.string.String"]
    """<p>The error type for requests that are not processed</p>"""
    error_message: NotRequired["aws_sdk_elasticache.types.string.String"]
