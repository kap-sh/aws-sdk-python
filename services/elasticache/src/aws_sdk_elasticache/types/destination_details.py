...
if TYPE_CHECKING:
    import aws_sdk_elasticache.types.cloud_watch_logs_destination_details
...
class DestinationDetails(TypedDict, closed=True):
    ...
    kinesis_firehose_details: NotRequired[
        "aws_sdk_elasticache.types.kinesis_firehose_destination_details.KinesisFirehoseDestinationDetails"
    ]
...
def serialize_query(
    ...
    if "cloud_watch_logs_details" in value:
        ...
        aws_sdk_elasticache.types.cloud_watch_logs_destination_details.serialize_query(
            value["cloud_watch_logs_details"], pairs, f"{prefix}.CloudWatchLogsDetails"
        )
    if "kinesis_firehose_details" in value:
        import aws_sdk_elasticache.types.kinesis_firehose_destination_details

        aws_sdk_elasticache.types.kinesis_firehose_destination_details.serialize_query(
...
def deserialize_query(el: Element) -> DestinationDetails:
    ...
    if child_cloud_watch_logs_details is not None:
        ...
        out["cloud_watch_logs_details"] = (
            aws_sdk_elasticache.types.cloud_watch_logs_destination_details.deserialize_query(
    ...
    if child_kinesis_firehose_details is not None:
        ...
        out["kinesis_firehose_details"] = (
            aws_sdk_elasticache.types.kinesis_firehose_destination_details.deserialize_query(
