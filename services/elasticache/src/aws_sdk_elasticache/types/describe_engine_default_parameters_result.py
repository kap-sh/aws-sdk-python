...
class DescribeEngineDefaultParametersResult(TypedDict):
    engine_defaults: NotRequired[
        "aws_sdk_elasticache.types.engine_defaults.EngineDefaults"
    ]
...
def serialize_query(
    ...
    if "engine_defaults" in value:
        ...
        aws_sdk_elasticache.types.engine_defaults.serialize_query(
...
def deserialize_query(el: Element) -> DescribeEngineDefaultParametersResult:
    ...
    if child_engine_defaults is not None:
        ...
        out["engine_defaults"] = (
            aws_sdk_elasticache.types.engine_defaults.deserialize_query(
