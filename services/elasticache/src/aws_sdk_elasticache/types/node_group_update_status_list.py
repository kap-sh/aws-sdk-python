...
if TYPE_CHECKING:
    import aws_sdk_elasticache.types.node_group_update_status

NodeGroupUpdateStatusList: TypeAlias = list[
    "aws_sdk_elasticache.types.node_group_update_status.NodeGroupUpdateStatus"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elasticache.types.node_group_update_status.serialize_query(
...
def deserialize_query(el: Element) -> NodeGroupUpdateStatusList:
    ...
    for child in el.findall("NodeGroupUpdateStatus"):
        out.append(
            aws_sdk_elasticache.types.node_group_update_status.deserialize_query(child)
        )
    return out
