...
class TagListMessage(TypedDict):
    tag_list: NotRequired["aws_sdk_elasticache.types.tag_list.TagList"]
...
def deserialize_query(el: Element) -> TagListMessage:
    ...
    if child_tag_list is not None:
        ...
        out["tag_list"] = aws_sdk_elasticache.types.tag_list.deserialize_query(
            child_tag_list
        )
    return out
