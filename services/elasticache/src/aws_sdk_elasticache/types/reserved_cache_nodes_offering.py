"""Generated from Smithy shape ``com.amazonaws.elasticache#ReservedCacheNodesOffering``."""
...
class ReservedCacheNodesOffering(TypedDict, closed=True):
...
def deserialize_query(el: Element) -> ReservedCacheNodesOffering:
    out: ReservedCacheNodesOffering = {}  # type: ignore[typeddict-item]
