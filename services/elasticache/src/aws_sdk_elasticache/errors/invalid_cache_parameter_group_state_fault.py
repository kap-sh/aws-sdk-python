"""Generated from Smithy shape ``com.amazonaws.elasticache#InvalidCacheParameterGroupStateFault``."""
...
class InvalidCacheParameterGroupStateFault_(TypedDict, closed=True):
    message: NotRequired["aws_sdk_elasticache.types.exception_message.ExceptionMessage"]


# --- awsQuery ser/de ---
def serialize_query(
    value: InvalidCacheParameterGroupStateFault_,
...
def deserialize_query(el: Element) -> InvalidCacheParameterGroupStateFault_:
    out: InvalidCacheParameterGroupStateFault_ = {}  # type: ignore[typeddict-item]
...
class InvalidCacheParameterGroupStateFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticache#InvalidCacheParameterGroupStateFault``."""
