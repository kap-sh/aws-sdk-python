"""Generated from Smithy shape ``com.amazonaws.elasticache#CacheSubnetGroupAlreadyExistsFault``."""
...
class CacheSubnetGroupAlreadyExistsFault_(TypedDict, closed=True):
    message: NotRequired["aws_sdk_elasticache.types.exception_message.ExceptionMessage"]


# --- awsQuery ser/de ---
def serialize_query(
    value: CacheSubnetGroupAlreadyExistsFault_,
...
def deserialize_query(el: Element) -> CacheSubnetGroupAlreadyExistsFault_:
    out: CacheSubnetGroupAlreadyExistsFault_ = {}  # type: ignore[typeddict-item]
...
class CacheSubnetGroupAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticache#CacheSubnetGroupAlreadyExistsFault``."""
