...
class ElastiCacheError(Exception):
    """Base class for all ElastiCache service errors."""


class ServiceError(ElastiCacheError):
...
class SerializationError(ElastiCacheError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ElastiCacheError):
...
class WaiterFailedError(ElastiCacheError):
...
class WaiterTimeoutError(ElastiCacheError):
