...
def handle_response(
    ...
    out: capo_elasticache.types.cache_engine_version_message.CacheEngineVersionMessage = capo_elasticache.types.cache_engine_version_message.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.describe_cache_engine_versions_message.serialize_query(
        input_, pairs, ""
    )
