"""Generated from Smithy shape ``com.amazonaws.elasticache#CreateCacheParameterGroup``."""
...
import capo_elasticache.errors.cache_parameter_group_already_exists_fault
import capo_elasticache.errors.cache_parameter_group_quota_exceeded_fault
import capo_elasticache.errors.invalid_cache_parameter_group_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CacheParameterGroupAlreadyExistsFault":
            raise capo_elasticache.errors.cache_parameter_group_already_exists_fault.CacheParameterGroupAlreadyExistsFault.from_query(
                root
            )
        case "CacheParameterGroupQuotaExceededFault":
            raise capo_elasticache.errors.cache_parameter_group_quota_exceeded_fault.CacheParameterGroupQuotaExceededFault.from_query(
                root
            )
        case "InvalidCacheParameterGroupStateFault":
            raise capo_elasticache.errors.invalid_cache_parameter_group_state_fault.InvalidCacheParameterGroupStateFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateCacheParameterGroupResult")
    out: capo_elasticache.types.create_cache_parameter_group_result.CreateCacheParameterGroupResult = capo_elasticache.types.create_cache_parameter_group_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateCacheParameterGroup"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.create_cache_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_cache_parameter_group(
