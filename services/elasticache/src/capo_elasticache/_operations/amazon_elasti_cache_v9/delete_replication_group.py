"""Generated from Smithy shape ``com.amazonaws.elasticache#DeleteReplicationGroup``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteReplicationGroupResult")
    out: capo_elasticache.types.delete_replication_group_result.DeleteReplicationGroupResult = capo_elasticache.types.delete_replication_group_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteReplicationGroup"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.delete_replication_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_replication_group(
