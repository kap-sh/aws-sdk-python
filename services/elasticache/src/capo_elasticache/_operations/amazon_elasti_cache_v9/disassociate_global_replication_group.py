"""Generated from Smithy shape ``com.amazonaws.elasticache#DisassociateGlobalReplicationGroup``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DisassociateGlobalReplicationGroupResult")
    out: capo_elasticache.types.disassociate_global_replication_group_result.DisassociateGlobalReplicationGroupResult = capo_elasticache.types.disassociate_global_replication_group_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisassociateGlobalReplicationGroup"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.disassociate_global_replication_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_disassociate_global_replication_group(
