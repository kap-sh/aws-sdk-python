"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeServerlessCaches``."""
...
def handle_response(
    ...
    out: capo_elasticache.types.describe_serverless_caches_response.DescribeServerlessCachesResponse = capo_elasticache.types.describe_serverless_caches_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeServerlessCaches"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.describe_serverless_caches_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_serverless_caches(
