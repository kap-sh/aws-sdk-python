"""Generated from Smithy shape ``com.amazonaws.elasticache#ModifyGlobalReplicationGroup``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyGlobalReplicationGroupResult")
    out: capo_elasticache.types.modify_global_replication_group_result.ModifyGlobalReplicationGroupResult = capo_elasticache.types.modify_global_replication_group_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyGlobalReplicationGroup"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.modify_global_replication_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_global_replication_group(
