...
import capo_elasticache.errors.reserved_cache_node_already_exists_fault
import capo_elasticache.errors.reserved_cache_node_quota_exceeded_fault
import capo_elasticache.errors.reserved_cache_nodes_offering_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ReservedCacheNodeAlreadyExistsFault":
            raise capo_elasticache.errors.reserved_cache_node_already_exists_fault.ReservedCacheNodeAlreadyExistsFault.from_query(
                root
            )
        case "ReservedCacheNodeQuotaExceededFault":
            raise capo_elasticache.errors.reserved_cache_node_quota_exceeded_fault.ReservedCacheNodeQuotaExceededFault.from_query(
                root
            )
        case "ReservedCacheNodesOfferingNotFoundFault":
            raise capo_elasticache.errors.reserved_cache_nodes_offering_not_found_fault.ReservedCacheNodesOfferingNotFoundFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_elasticache.types.purchase_reserved_cache_nodes_offering_result.PurchaseReservedCacheNodesOfferingResult = capo_elasticache.types.purchase_reserved_cache_nodes_offering_result.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.purchase_reserved_cache_nodes_offering_message.serialize_query(
        input_, pairs, ""
    )
