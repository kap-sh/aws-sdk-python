"""Generated from Smithy shape ``com.amazonaws.elasticache#ModifyUser``."""
...
def handle_response(response: zapros.Response) -> capo_elasticache.types.user.User:
    root = fromstring(response.read())
    result = root.find("ModifyUserResult")
...
def build_request(
    ...
    pairs.append(("Action", "ModifyUser"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.modify_user_message.serialize_query(input_, pairs, "")
