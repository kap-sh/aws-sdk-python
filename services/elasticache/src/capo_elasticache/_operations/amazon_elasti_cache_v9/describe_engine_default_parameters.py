"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeEngineDefaultParameters``."""
...
def handle_response(
    ...
    out: capo_elasticache.types.describe_engine_default_parameters_result.DescribeEngineDefaultParametersResult = capo_elasticache.types.describe_engine_default_parameters_result.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.describe_engine_default_parameters_message.serialize_query(
        input_, pairs, ""
    )
