"""Generated from Smithy shape ``com.amazonaws.elasticache#DeleteCacheCluster``."""
...
import capo_elasticache.errors.snapshot_feature_not_supported_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SnapshotFeatureNotSupportedFault":
            raise capo_elasticache.errors.snapshot_feature_not_supported_fault.SnapshotFeatureNotSupportedFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteCacheClusterResult")
    out: capo_elasticache.types.delete_cache_cluster_result.DeleteCacheClusterResult = (
        capo_elasticache.types.delete_cache_cluster_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteCacheCluster"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.delete_cache_cluster_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_cache_cluster(
