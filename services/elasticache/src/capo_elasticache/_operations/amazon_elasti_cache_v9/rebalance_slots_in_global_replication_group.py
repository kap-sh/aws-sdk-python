"""Generated from Smithy shape ``com.amazonaws.elasticache#RebalanceSlotsInGlobalReplicationGroup``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("RebalanceSlotsInGlobalReplicationGroupResult")
    out: capo_elasticache.types.rebalance_slots_in_global_replication_group_result.RebalanceSlotsInGlobalReplicationGroupResult = capo_elasticache.types.rebalance_slots_in_global_replication_group_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "RebalanceSlotsInGlobalReplicationGroup"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.rebalance_slots_in_global_replication_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_rebalance_slots_in_global_replication_group(
