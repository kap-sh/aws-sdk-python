"""Generated from Smithy shape ``com.amazonaws.elasticache#ExportServerlessCacheSnapshot``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ExportServerlessCacheSnapshotResult")
    out: capo_elasticache.types.export_serverless_cache_snapshot_response.ExportServerlessCacheSnapshotResponse = capo_elasticache.types.export_serverless_cache_snapshot_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ExportServerlessCacheSnapshot"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.export_serverless_cache_snapshot_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_export_serverless_cache_snapshot(
