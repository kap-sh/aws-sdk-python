"""Generated from Smithy shape ``com.amazonaws.elasticache#StartMigration``."""
...
import capo_elasticache.errors.replication_group_already_under_migration_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ReplicationGroupAlreadyUnderMigrationFault":
            raise capo_elasticache.errors.replication_group_already_under_migration_fault.ReplicationGroupAlreadyUnderMigrationFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("StartMigrationResult")
    out: capo_elasticache.types.start_migration_response.StartMigrationResponse = (
        capo_elasticache.types.start_migration_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "StartMigration"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.start_migration_message.serialize_query(input_, pairs, "")
