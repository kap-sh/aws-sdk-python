"""Generated from Smithy shape ``com.amazonaws.elasticache#IncreaseNodeGroupsInGlobalReplicationGroup``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("IncreaseNodeGroupsInGlobalReplicationGroupResult")
    out: capo_elasticache.types.increase_node_groups_in_global_replication_group_result.IncreaseNodeGroupsInGlobalReplicationGroupResult = capo_elasticache.types.increase_node_groups_in_global_replication_group_result.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.increase_node_groups_in_global_replication_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_increase_node_groups_in_global_replication_group(
