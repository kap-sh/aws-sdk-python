"""Generated from Smithy shape ``com.amazonaws.elasticache#CreateServerlessCache``."""
...
import capo_elasticache.errors.serverless_cache_already_exists_fault
import capo_elasticache.errors.serverless_cache_not_found_fault
import capo_elasticache.errors.serverless_cache_quota_for_customer_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServerlessCacheAlreadyExistsFault":
            raise capo_elasticache.errors.serverless_cache_already_exists_fault.ServerlessCacheAlreadyExistsFault.from_query(
                root
            )
        ...
        case "ServerlessCacheQuotaForCustomerExceededFault":
            raise capo_elasticache.errors.serverless_cache_quota_for_customer_exceeded_fault.ServerlessCacheQuotaForCustomerExceededFault.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_elasticache.types.create_serverless_cache_response.CreateServerlessCacheResponse = capo_elasticache.types.create_serverless_cache_response.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.create_serverless_cache_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_serverless_cache(
