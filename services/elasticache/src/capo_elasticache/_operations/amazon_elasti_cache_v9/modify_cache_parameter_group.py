"""Generated from Smithy shape ``com.amazonaws.elasticache#ModifyCacheParameterGroup``."""
...
import capo_elasticache.errors.invalid_global_replication_group_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidGlobalReplicationGroupStateFault":
            raise capo_elasticache.errors.invalid_global_replication_group_state_fault.InvalidGlobalReplicationGroupStateFault.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyCacheParameterGroupResult")
    out: capo_elasticache.types.cache_parameter_group_name_message.CacheParameterGroupNameMessage = capo_elasticache.types.cache_parameter_group_name_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyCacheParameterGroup"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.modify_cache_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_cache_parameter_group(
