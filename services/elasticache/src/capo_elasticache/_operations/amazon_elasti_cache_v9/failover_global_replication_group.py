"""Generated from Smithy shape ``com.amazonaws.elasticache#FailoverGlobalReplicationGroup``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("FailoverGlobalReplicationGroupResult")
    out: capo_elasticache.types.failover_global_replication_group_result.FailoverGlobalReplicationGroupResult = capo_elasticache.types.failover_global_replication_group_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "FailoverGlobalReplicationGroup"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.failover_global_replication_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_failover_global_replication_group(
