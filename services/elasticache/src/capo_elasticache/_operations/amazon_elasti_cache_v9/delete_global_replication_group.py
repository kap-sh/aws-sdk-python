"""Generated from Smithy shape ``com.amazonaws.elasticache#DeleteGlobalReplicationGroup``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteGlobalReplicationGroupResult")
    out: capo_elasticache.types.delete_global_replication_group_result.DeleteGlobalReplicationGroupResult = capo_elasticache.types.delete_global_replication_group_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteGlobalReplicationGroup"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.delete_global_replication_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_global_replication_group(
