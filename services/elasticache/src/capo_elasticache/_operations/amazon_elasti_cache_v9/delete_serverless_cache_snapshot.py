"""Generated from Smithy shape ``com.amazonaws.elasticache#DeleteServerlessCacheSnapshot``."""
...
def handle_response(
    ...
    out: capo_elasticache.types.delete_serverless_cache_snapshot_response.DeleteServerlessCacheSnapshotResponse = capo_elasticache.types.delete_serverless_cache_snapshot_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteServerlessCacheSnapshot"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.delete_serverless_cache_snapshot_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_serverless_cache_snapshot(
