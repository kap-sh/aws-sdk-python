"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeCacheParameterGroups``."""
...
import capo_elasticache.types.cache_parameter_group_list
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeCacheParameterGroupsResult")
    out: capo_elasticache.types.cache_parameter_groups_message.CacheParameterGroupsMessage = capo_elasticache.types.cache_parameter_groups_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeCacheParameterGroups"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.describe_cache_parameter_groups_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_cache_parameter_groups(
