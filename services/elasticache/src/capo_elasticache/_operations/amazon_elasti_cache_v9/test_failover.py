"""Generated from Smithy shape ``com.amazonaws.elasticache#TestFailover``."""
...
import capo_elasticache.errors.api_call_rate_for_customer_exceeded_fault
import capo_elasticache.errors.invalid_cache_cluster_state_fault
import capo_elasticache.errors.invalid_kms_key_fault
...
import capo_elasticache.errors.node_group_not_found_fault
import capo_elasticache.errors.replication_group_not_found_fault
import capo_elasticache.errors.test_failover_not_available_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "APICallRateForCustomerExceededFault":
            raise capo_elasticache.errors.api_call_rate_for_customer_exceeded_fault.APICallRateForCustomerExceededFault.from_query(
                root
            )
        case "InvalidCacheClusterStateFault":
            raise capo_elasticache.errors.invalid_cache_cluster_state_fault.InvalidCacheClusterStateFault.from_query(
                root
            )
        case "InvalidKMSKeyFault":
            raise capo_elasticache.errors.invalid_kms_key_fault.InvalidKMSKeyFault.from_query(
                root
            )
        ...
        case "NodeGroupNotFoundFault":
            raise capo_elasticache.errors.node_group_not_found_fault.NodeGroupNotFoundFault.from_query(
                root
            )
        ...
        case "TestFailoverNotAvailableFault":
            raise capo_elasticache.errors.test_failover_not_available_fault.TestFailoverNotAvailableFault.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_elasticache.types.test_failover_result.TestFailoverResult = (
        capo_elasticache.types.test_failover_result.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.test_failover_message.serialize_query(input_, pairs, "")
...
def test_failover(
    ...
    capo_elasticache.types.test_failover_result.TestFailoverResult, zapros.Response
]:
