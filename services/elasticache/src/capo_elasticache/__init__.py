...
from ._services.async_elasti_cache import (
    AsyncElastiCacheClient as AsyncElastiCacheClient,
)
from ._services.elasti_cache import ElastiCacheClient as ElastiCacheClient
