"""Generated from Smithy shape ``com.amazonaws.elasticache#InvalidVPCNetworkStateFault``."""
...
class InvalidVPCNetworkStateFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticache#InvalidVPCNetworkStateFault``."""
