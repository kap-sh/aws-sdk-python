"""Generated from Smithy shape ``com.amazonaws.elasticache#InvalidARNFault``."""
...
# --- awsQuery ser/de ---
def serialize_query(
    value: InvalidARNFault_, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> InvalidARNFault_:
...
class InvalidARNFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticache#InvalidARNFault``."""
    ...
    @classmethod
    def from_query(cls, el: Element) -> "InvalidARNFault":
