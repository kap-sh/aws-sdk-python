"""Generated from Smithy shape ``com.amazonaws.elasticache#APICallRateForCustomerExceededFault``."""
...
# --- awsQuery ser/de ---
def serialize_query(
    value: APICallRateForCustomerExceededFault_,
...
def deserialize_query(el: Element) -> APICallRateForCustomerExceededFault_:
...
class APICallRateForCustomerExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticache#APICallRateForCustomerExceededFault``."""
