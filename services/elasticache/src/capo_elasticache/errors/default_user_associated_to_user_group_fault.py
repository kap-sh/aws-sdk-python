"""Generated from Smithy shape ``com.amazonaws.elasticache#DefaultUserAssociatedToUserGroupFault``."""
...
class DefaultUserAssociatedToUserGroupFault_(TypedDict, closed=True):
    message: NotRequired["capo_elasticache.types.exception_message.ExceptionMessage"]


# --- awsQuery ser/de ---
def serialize_query(
    value: DefaultUserAssociatedToUserGroupFault_,
...
def deserialize_query(el: Element) -> DefaultUserAssociatedToUserGroupFault_:
    out: DefaultUserAssociatedToUserGroupFault_ = {}  # type: ignore[typeddict-item]
...
class DefaultUserAssociatedToUserGroupFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticache#DefaultUserAssociatedToUserGroupFault``."""
