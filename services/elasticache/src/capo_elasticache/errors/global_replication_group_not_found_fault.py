"""Generated from Smithy shape ``com.amazonaws.elasticache#GlobalReplicationGroupNotFoundFault``."""
...
class GlobalReplicationGroupNotFoundFault_(TypedDict, closed=True):
    message: NotRequired["capo_elasticache.types.exception_message.ExceptionMessage"]


# --- awsQuery ser/de ---
def serialize_query(
    value: GlobalReplicationGroupNotFoundFault_,
...
def deserialize_query(el: Element) -> GlobalReplicationGroupNotFoundFault_:
    out: GlobalReplicationGroupNotFoundFault_ = {}  # type: ignore[typeddict-item]
...
class GlobalReplicationGroupNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticache#GlobalReplicationGroupNotFoundFault``."""
