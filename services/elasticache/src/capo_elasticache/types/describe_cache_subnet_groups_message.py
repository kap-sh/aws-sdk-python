"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeCacheSubnetGroupsMessage``."""
...
class DescribeCacheSubnetGroupsMessage(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DescribeCacheSubnetGroupsMessage, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DescribeCacheSubnetGroupsMessage:
    out: DescribeCacheSubnetGroupsMessage = {}  # type: ignore[typeddict-item]
