...
CacheClusterList: TypeAlias = list["capo_elasticache.types.cache_cluster.CacheCluster"]
...
def deserialize_query(el: Element) -> CacheClusterList:
    ...
    for child in el.findall("CacheCluster"):
        out.append(capo_elasticache.types.cache_cluster.deserialize_query(child))
    return out
