"""Generated from Smithy shape ``com.amazonaws.elasticache#DecreaseNodeGroupsInGlobalReplicationGroupResult``."""
...
class DecreaseNodeGroupsInGlobalReplicationGroupResult(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DecreaseNodeGroupsInGlobalReplicationGroupResult,
...
def deserialize_query(el: Element) -> DecreaseNodeGroupsInGlobalReplicationGroupResult:
    out: DecreaseNodeGroupsInGlobalReplicationGroupResult = {}  # type: ignore[typeddict-item]
