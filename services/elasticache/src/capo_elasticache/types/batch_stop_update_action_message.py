"""Generated from Smithy shape ``com.amazonaws.elasticache#BatchStopUpdateActionMessage``."""
...
class BatchStopUpdateActionMessage(TypedDict, closed=True):
...
def deserialize_query(el: Element) -> BatchStopUpdateActionMessage:
    out: BatchStopUpdateActionMessage = {}  # type: ignore[typeddict-item]
