"""Generated from Smithy shape ``com.amazonaws.elasticache#DecreaseReplicaCountResult``."""
...
class DecreaseReplicaCountResult(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DecreaseReplicaCountResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DecreaseReplicaCountResult:
    out: DecreaseReplicaCountResult = {}  # type: ignore[typeddict-item]
