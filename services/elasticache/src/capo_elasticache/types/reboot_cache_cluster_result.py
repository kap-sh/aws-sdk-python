"""Generated from Smithy shape ``com.amazonaws.elasticache#RebootCacheClusterResult``."""
...
class RebootCacheClusterResult(TypedDict, closed=True):
    cache_cluster: NotRequired["capo_elasticache.types.cache_cluster.CacheCluster"]


# --- awsQuery ser/de ---
def serialize_query(
    value: RebootCacheClusterResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> RebootCacheClusterResult:
    out: RebootCacheClusterResult = {}  # type: ignore[typeddict-item]
