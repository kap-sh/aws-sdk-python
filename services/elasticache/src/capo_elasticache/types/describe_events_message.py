...
class DescribeEventsMessage(TypedDict, closed=True):
    source_identifier: NotRequired["capo_elasticache.types.string.String"]
    ...
    source_type: NotRequired["capo_elasticache.types.source_type.SourceType"]
    ...
    end_time: NotRequired["capo_elasticache.types.t_stamp.TStamp"]
    ...
    duration: NotRequired["capo_elasticache.types.integer_optional.IntegerOptional"]
...
def serialize_query(
    ...
    if "source_type" in value:
        ...
        capo_elasticache.types.source_type.serialize_query(
...
def deserialize_query(el: Element) -> DescribeEventsMessage:
    ...
    if child_source_type is not None:
        ...
        out["source_type"] = capo_elasticache.types.source_type.deserialize_query(
            child_source_type
        )
    ...
    if child_end_time is not None:
        ...
        out["end_time"] = capo_elasticache.types.t_stamp.deserialize_query(
            child_end_time
        )
