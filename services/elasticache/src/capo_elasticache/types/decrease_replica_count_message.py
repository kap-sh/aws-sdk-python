...
def serialize_query(
    ...
    if "replicas_to_remove" in value:
        ...
        capo_elasticache.types.remove_replicas_list.serialize_query(
            value["replicas_to_remove"], pairs, f"{key_prefix}ReplicasToRemove"
        )
...
def deserialize_query(el: Element) -> DecreaseReplicaCountMessage:
    ...
    if child_replicas_to_remove is not None:
        ...
        out["replicas_to_remove"] = (
            capo_elasticache.types.remove_replicas_list.deserialize_query(
