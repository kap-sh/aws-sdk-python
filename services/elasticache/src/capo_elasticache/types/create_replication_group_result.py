"""Generated from Smithy shape ``com.amazonaws.elasticache#CreateReplicationGroupResult``."""
...
class CreateReplicationGroupResult(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: CreateReplicationGroupResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> CreateReplicationGroupResult:
    out: CreateReplicationGroupResult = {}  # type: ignore[typeddict-item]
