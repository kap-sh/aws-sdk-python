"""Generated from Smithy shape ``com.amazonaws.elasticache#ModifyCacheSubnetGroupResult``."""
...
class ModifyCacheSubnetGroupResult(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ModifyCacheSubnetGroupResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ModifyCacheSubnetGroupResult:
    out: ModifyCacheSubnetGroupResult = {}  # type: ignore[typeddict-item]
