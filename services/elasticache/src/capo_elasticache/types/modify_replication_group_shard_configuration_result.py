"""Generated from Smithy shape ``com.amazonaws.elasticache#ModifyReplicationGroupShardConfigurationResult``."""
...
class ModifyReplicationGroupShardConfigurationResult(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ModifyReplicationGroupShardConfigurationResult,
...
def deserialize_query(el: Element) -> ModifyReplicationGroupShardConfigurationResult:
    out: ModifyReplicationGroupShardConfigurationResult = {}  # type: ignore[typeddict-item]
