"""Generated from Smithy shape ``com.amazonaws.elasticache#CreateGlobalReplicationGroupResult``."""
...
class CreateGlobalReplicationGroupResult(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: CreateGlobalReplicationGroupResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> CreateGlobalReplicationGroupResult:
    out: CreateGlobalReplicationGroupResult = {}  # type: ignore[typeddict-item]
