...
class CacheSubnetGroupMessage(TypedDict, closed=True):
    marker: NotRequired["capo_elasticache.types.string.String"]
    """<p>Provides an identifier to allow retrieval of paginated results.</p>"""
    cache_subnet_groups: NotRequired[
        "capo_elasticache.types.cache_subnet_groups.CacheSubnetGroups"
    ]
...
def serialize_query(
    ...
    if "cache_subnet_groups" in value:
        ...
        capo_elasticache.types.cache_subnet_groups.serialize_query(
            value["cache_subnet_groups"], pairs, f"{key_prefix}CacheSubnetGroups"
        )
...
def deserialize_query(el: Element) -> CacheSubnetGroupMessage:
    ...
    if child_cache_subnet_groups is not None:
        ...
        out["cache_subnet_groups"] = (
            capo_elasticache.types.cache_subnet_groups.deserialize_query(
