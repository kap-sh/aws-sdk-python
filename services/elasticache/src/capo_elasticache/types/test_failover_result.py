"""Generated from Smithy shape ``com.amazonaws.elasticache#TestFailoverResult``."""
...
class TestFailoverResult(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: TestFailoverResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> TestFailoverResult:
    out: TestFailoverResult = {}  # type: ignore[typeddict-item]
