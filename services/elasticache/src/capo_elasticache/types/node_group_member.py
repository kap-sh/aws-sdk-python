...
class NodeGroupMember(TypedDict, closed=True):
    ...
    read_endpoint: NotRequired["capo_elasticache.types.endpoint.Endpoint"]
    ...
    current_role: NotRequired["capo_elasticache.types.string.String"]
...
def deserialize_query(el: Element) -> NodeGroupMember:
    ...
    if child_read_endpoint is not None:
        ...
        out["read_endpoint"] = capo_elasticache.types.endpoint.deserialize_query(
            child_read_endpoint
        )
