"""Generated from Smithy shape ``com.amazonaws.elasticache#ModifyCacheClusterResult``."""
...
class ModifyCacheClusterResult(TypedDict, closed=True):
...
def deserialize_query(el: Element) -> ModifyCacheClusterResult:
    out: ModifyCacheClusterResult = {}  # type: ignore[typeddict-item]
