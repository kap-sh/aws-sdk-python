"""Generated from Smithy shape ``com.amazonaws.elasticache#TestMigrationResponse``."""
...
class TestMigrationResponse(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: TestMigrationResponse, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> TestMigrationResponse:
    out: TestMigrationResponse = {}  # type: ignore[typeddict-item]
