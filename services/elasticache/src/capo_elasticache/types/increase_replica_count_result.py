"""Generated from Smithy shape ``com.amazonaws.elasticache#IncreaseReplicaCountResult``."""
...
class IncreaseReplicaCountResult(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: IncreaseReplicaCountResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> IncreaseReplicaCountResult:
    out: IncreaseReplicaCountResult = {}  # type: ignore[typeddict-item]
