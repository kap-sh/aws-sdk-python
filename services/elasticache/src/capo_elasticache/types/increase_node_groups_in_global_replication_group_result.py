"""Generated from Smithy shape ``com.amazonaws.elasticache#IncreaseNodeGroupsInGlobalReplicationGroupResult``."""
...
class IncreaseNodeGroupsInGlobalReplicationGroupResult(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: IncreaseNodeGroupsInGlobalReplicationGroupResult,
...
def deserialize_query(el: Element) -> IncreaseNodeGroupsInGlobalReplicationGroupResult:
    out: IncreaseNodeGroupsInGlobalReplicationGroupResult = {}  # type: ignore[typeddict-item]
