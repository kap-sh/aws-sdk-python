...
class DescribeUsersMessage(TypedDict, closed=True):
    ...
    filters: NotRequired["capo_elasticache.types.filter_list.FilterList"]
...
def deserialize_query(el: Element) -> DescribeUsersMessage:
    ...
    if child_filters is not None:
        ...
        out["filters"] = capo_elasticache.types.filter_list.deserialize_query(
            child_filters
        )
