...
class CacheParameterGroupsMessage(TypedDict, closed=True):
    ...
    cache_parameter_groups: NotRequired[
        "capo_elasticache.types.cache_parameter_group_list.CacheParameterGroupList"
    ]
...
def serialize_query(
    ...
    if "cache_parameter_groups" in value:
        ...
        capo_elasticache.types.cache_parameter_group_list.serialize_query(
            value["cache_parameter_groups"], pairs, f"{key_prefix}CacheParameterGroups"
        )
...
def deserialize_query(el: Element) -> CacheParameterGroupsMessage:
    ...
    if child_cache_parameter_groups is not None:
        ...
        out["cache_parameter_groups"] = (
            capo_elasticache.types.cache_parameter_group_list.deserialize_query(
