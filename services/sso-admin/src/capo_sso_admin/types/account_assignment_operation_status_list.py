...
AccountAssignmentOperationStatusList: TypeAlias = list[
    "capo_sso_admin.types.account_assignment_operation_status_metadata.AccountAssignmentOperationStatusMetadata"
]
...
def serialize_aws_json_1_1(value: AccountAssignmentOperationStatusList) -> list:
    ...
    for item in value:
        out.append(
            capo_sso_admin.types.account_assignment_operation_status_metadata.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> AccountAssignmentOperationStatusList:
    ...
    for item in data:
        out.append(
            capo_sso_admin.types.account_assignment_operation_status_metadata.deserialize_aws_json_1_1(
                item
            )
        )
    return out
