"""Generated from Smithy shape ``com.amazonaws.ssoadmin#PermissionSetProvisioningStatusMetadata``."""
...
class PermissionSetProvisioningStatusMetadata(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: PermissionSetProvisioningStatusMetadata) -> dict:
    out: dict = {}
    if "status" in value:
        import capo_sso_admin.types.status_values
