"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListAccountAssignmentDeletionStatusResponse``."""
...
class ListAccountAssignmentDeletionStatusResponse(TypedDict, closed=True):
    account_assignments_deletion_status: NotRequired[
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListAccountAssignmentDeletionStatusResponse) -> dict:
    out: dict = {}
    if "account_assignments_deletion_status" in value:
        import capo_sso_admin.types.account_assignment_operation_status_list

        out["AccountAssignmentsDeletionStatus"] = (
            capo_sso_admin.types.account_assignment_operation_status_list.serialize_aws_json_1_1(
                value["account_assignments_deletion_status"]
            )
        )
