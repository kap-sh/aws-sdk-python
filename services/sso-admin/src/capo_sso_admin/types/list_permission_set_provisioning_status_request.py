"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListPermissionSetProvisioningStatusRequest``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListPermissionSetProvisioningStatusRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListPermissionSetProvisioningStatusRequest:
    out: ListPermissionSetProvisioningStatusRequest = {}  # type: ignore[typeddict-item]
    if "InstanceArn" in data:
        out["instance_arn"] = data["InstanceArn"]
    else:
        raise DeserializationError(
            "ListPermissionSetProvisioningStatusRequest.instance_arn required"
        )
