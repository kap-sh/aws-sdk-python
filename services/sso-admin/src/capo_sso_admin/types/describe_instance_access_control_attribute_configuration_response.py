...
if TYPE_CHECKING:
    ...
    import capo_sso_admin.types.instance_access_control_attribute_configuration_status_reason
...
class DescribeInstanceAccessControlAttributeConfigurationResponse(
    ...
    status: NotRequired[
        "capo_sso_admin.types.instance_access_control_attribute_configuration_status.InstanceAccessControlAttributeConfigurationStatus"
    ]
    """<p>The status of the attribute configuration process.</p>"""
    status_reason: NotRequired[
        "capo_sso_admin.types.instance_access_control_attribute_configuration_status_reason.InstanceAccessControlAttributeConfigurationStatusReason"
    ]
    ...
    instance_access_control_attribute_configuration: NotRequired[
        "capo_sso_admin.types.instance_access_control_attribute_configuration.InstanceAccessControlAttributeConfiguration"
    ]
...
def serialize_aws_json_1_1(
    ...
    if "status" in value:
        ...
        out["Status"] = (
            capo_sso_admin.types.instance_access_control_attribute_configuration_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
...
def deserialize_aws_json_1_1(
    ...
    if "Status" in data:
        ...
        out["status"] = (
            capo_sso_admin.types.instance_access_control_attribute_configuration_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
