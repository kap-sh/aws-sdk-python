...
if TYPE_CHECKING:
    import capo_sso_admin.types.account_assignment_list_for_principal
    import capo_sso_admin.types.token


class ListAccountAssignmentsForPrincipalResponse(TypedDict, closed=True):
    account_assignments: NotRequired[
        "capo_sso_admin.types.account_assignment_list_for_principal.AccountAssignmentListForPrincipal"
    ]
...
def serialize_aws_json_1_1(value: ListAccountAssignmentsForPrincipalResponse) -> dict:
    ...
    if "account_assignments" in value:
        ...
        out["AccountAssignments"] = (
            capo_sso_admin.types.account_assignment_list_for_principal.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListAccountAssignmentsForPrincipalResponse:
    ...
    if "AccountAssignments" in data:
        ...
        out["account_assignments"] = (
            capo_sso_admin.types.account_assignment_list_for_principal.deserialize_aws_json_1_1(
