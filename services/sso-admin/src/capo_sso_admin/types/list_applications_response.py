...
if TYPE_CHECKING:
    import capo_sso_admin.types.application_list
    import capo_sso_admin.types.token


class ListApplicationsResponse(TypedDict, closed=True):
    applications: NotRequired["capo_sso_admin.types.application_list.ApplicationList"]
...
def serialize_aws_json_1_1(value: ListApplicationsResponse) -> dict:
    ...
    if "applications" in value:
        ...
        out["Applications"] = (
            capo_sso_admin.types.application_list.serialize_aws_json_1_1(
                value["applications"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListApplicationsResponse:
    ...
    if "Applications" in data:
        ...
        out["applications"] = (
            capo_sso_admin.types.application_list.deserialize_aws_json_1_1(
                data["Applications"]
            )
        )
