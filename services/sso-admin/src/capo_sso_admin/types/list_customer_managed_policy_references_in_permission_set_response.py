...
class ListCustomerManagedPolicyReferencesInPermissionSetResponse(
    ...
    customer_managed_policy_references: NotRequired[
        "capo_sso_admin.types.customer_managed_policy_reference_list.CustomerManagedPolicyReferenceList"
    ]
...
def serialize_aws_json_1_1(
    ...
    if "customer_managed_policy_references" in value:
        ...
        out["CustomerManagedPolicyReferences"] = (
            capo_sso_admin.types.customer_managed_policy_reference_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "CustomerManagedPolicyReferences" in data:
        ...
        out["customer_managed_policy_references"] = (
            capo_sso_admin.types.customer_managed_policy_reference_list.deserialize_aws_json_1_1(
