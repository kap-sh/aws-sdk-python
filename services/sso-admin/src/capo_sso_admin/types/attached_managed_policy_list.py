...
AttachedManagedPolicyList: TypeAlias = list[
    "capo_sso_admin.types.attached_managed_policy.AttachedManagedPolicy"
]
...
def serialize_aws_json_1_1(value: AttachedManagedPolicyList) -> list:
    ...
    for item in value:
        out.append(
            capo_sso_admin.types.attached_managed_policy.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> AttachedManagedPolicyList:
    ...
    for item in data:
        out.append(
            capo_sso_admin.types.attached_managed_policy.deserialize_aws_json_1_1(item)
        )
    return out
