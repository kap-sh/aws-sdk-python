...
AccountAssignmentList: TypeAlias = list[
    "capo_sso_admin.types.account_assignment.AccountAssignment"
]
...
def serialize_aws_json_1_1(value: AccountAssignmentList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_sso_admin.types.account_assignment.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> AccountAssignmentList:
    ...
    for item in data:
        out.append(
            capo_sso_admin.types.account_assignment.deserialize_aws_json_1_1(item)
        )
    return out
