...
def handle_response(
    ...
    out: capo_sso_admin.types.list_permission_sets_response.ListPermissionSetsResponse = capo_sso_admin.types.list_permission_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_permission_sets_request.serialize_aws_json_1_1(input_)
    ).encode()
