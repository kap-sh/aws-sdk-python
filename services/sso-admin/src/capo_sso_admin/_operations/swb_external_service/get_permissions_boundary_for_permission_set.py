"""Generated from Smithy shape ``com.amazonaws.ssoadmin#GetPermissionsBoundaryForPermissionSet``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.get_permissions_boundary_for_permission_set_response.GetPermissionsBoundaryForPermissionSetResponse = capo_sso_admin.types.get_permissions_boundary_for_permission_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.get_permissions_boundary_for_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_permissions_boundary_for_permission_set(
