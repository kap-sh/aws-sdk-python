"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DescribePermissionSet``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.describe_permission_set_response.DescribePermissionSetResponse = capo_sso_admin.types.describe_permission_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.DescribePermissionSet"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.describe_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_permission_set(
