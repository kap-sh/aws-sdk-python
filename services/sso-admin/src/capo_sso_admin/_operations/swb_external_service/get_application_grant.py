"""Generated from Smithy shape ``com.amazonaws.ssoadmin#GetApplicationGrant``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.get_application_grant_response.GetApplicationGrantResponse = capo_sso_admin.types.get_application_grant_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.GetApplicationGrant"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.get_application_grant_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_application_grant(
