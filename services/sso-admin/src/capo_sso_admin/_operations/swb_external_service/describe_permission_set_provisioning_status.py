...
def handle_response(
    ...
    out: capo_sso_admin.types.describe_permission_set_provisioning_status_response.DescribePermissionSetProvisioningStatusResponse = capo_sso_admin.types.describe_permission_set_provisioning_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.describe_permission_set_provisioning_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
