"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListInstances``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.list_instances_response.ListInstancesResponse = (
        capo_sso_admin.types.list_instances_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ListInstances"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_instances_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_instances(
    ...
    capo_sso_admin.types.list_instances_response.ListInstancesResponse, zapros.Response
]:
