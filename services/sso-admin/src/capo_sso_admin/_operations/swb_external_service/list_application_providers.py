...
import capo_sso_admin.types.application_provider_list
...
def handle_response(
    ...
    out: capo_sso_admin.types.list_application_providers_response.ListApplicationProvidersResponse = capo_sso_admin.types.list_application_providers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_application_providers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
