...
def handle_response(
    ...
    out: capo_sso_admin.types.provision_permission_set_response.ProvisionPermissionSetResponse = capo_sso_admin.types.provision_permission_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.provision_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
