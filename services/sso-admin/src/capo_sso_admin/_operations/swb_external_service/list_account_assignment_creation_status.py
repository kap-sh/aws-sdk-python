"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListAccountAssignmentCreationStatus``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.list_account_assignment_creation_status_response.ListAccountAssignmentCreationStatusResponse = capo_sso_admin.types.list_account_assignment_creation_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ListAccountAssignmentCreationStatus"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_account_assignment_creation_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_account_assignment_creation_status(
