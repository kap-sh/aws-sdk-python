"""Generated from Smithy shape ``com.amazonaws.ssoadmin#GetInlinePolicyForPermissionSet``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.get_inline_policy_for_permission_set_response.GetInlinePolicyForPermissionSetResponse = capo_sso_admin.types.get_inline_policy_for_permission_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.GetInlinePolicyForPermissionSet"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.get_inline_policy_for_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_inline_policy_for_permission_set(
