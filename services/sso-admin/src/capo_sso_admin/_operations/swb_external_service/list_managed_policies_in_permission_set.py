...
def handle_response(
    ...
    out: capo_sso_admin.types.list_managed_policies_in_permission_set_response.ListManagedPoliciesInPermissionSetResponse = capo_sso_admin.types.list_managed_policies_in_permission_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_managed_policies_in_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
