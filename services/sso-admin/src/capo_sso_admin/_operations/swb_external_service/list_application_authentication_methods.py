"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListApplicationAuthenticationMethods``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.list_application_authentication_methods_response.ListApplicationAuthenticationMethodsResponse = capo_sso_admin.types.list_application_authentication_methods_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ListApplicationAuthenticationMethods"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_application_authentication_methods_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_application_authentication_methods(
