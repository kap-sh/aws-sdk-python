...
def handle_response(
    ...
    out: capo_sso_admin.types.update_application_response.UpdateApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.update_application_request.serialize_aws_json_1_1(input_)
    ).encode()
