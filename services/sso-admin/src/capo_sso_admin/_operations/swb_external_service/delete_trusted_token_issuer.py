"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DeleteTrustedTokenIssuer``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.delete_trusted_token_issuer_response.DeleteTrustedTokenIssuerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.DeleteTrustedTokenIssuer"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.delete_trusted_token_issuer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_trusted_token_issuer(
