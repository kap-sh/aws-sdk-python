"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DescribeApplicationProvider``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.describe_application_provider_response.DescribeApplicationProviderResponse = capo_sso_admin.types.describe_application_provider_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.DescribeApplicationProvider"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.describe_application_provider_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_application_provider(
