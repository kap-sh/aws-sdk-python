"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListAccountAssignmentDeletionStatus``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.list_account_assignment_deletion_status_response.ListAccountAssignmentDeletionStatusResponse = capo_sso_admin.types.list_account_assignment_deletion_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ListAccountAssignmentDeletionStatus"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_account_assignment_deletion_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_account_assignment_deletion_status(
