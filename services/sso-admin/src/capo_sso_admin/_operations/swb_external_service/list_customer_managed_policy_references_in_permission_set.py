"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListCustomerManagedPolicyReferencesInPermissionSet``."""
...
import capo_sso_admin.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise capo_sso_admin.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_sso_admin.types.list_customer_managed_policy_references_in_permission_set_response.ListCustomerManagedPolicyReferencesInPermissionSetResponse = capo_sso_admin.types.list_customer_managed_policy_references_in_permission_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_customer_managed_policy_references_in_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_customer_managed_policy_references_in_permission_set(
