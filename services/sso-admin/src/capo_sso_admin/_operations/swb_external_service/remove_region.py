...
def handle_response(
    ...
    out: capo_sso_admin.types.remove_region_response.RemoveRegionResponse = (
        capo_sso_admin.types.remove_region_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.remove_region_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def remove_region(
    ...
    capo_sso_admin.types.remove_region_response.RemoveRegionResponse, zapros.Response
]:
