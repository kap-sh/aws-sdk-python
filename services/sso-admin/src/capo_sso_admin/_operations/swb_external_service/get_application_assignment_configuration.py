...
def handle_response(
    ...
    out: capo_sso_admin.types.get_application_assignment_configuration_response.GetApplicationAssignmentConfigurationResponse = capo_sso_admin.types.get_application_assignment_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.get_application_assignment_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
