...
if TYPE_CHECKING:
    import aws_sdk_sso_admin.types.access_control_attribute_value_source

AccessControlAttributeValueSourceList: TypeAlias = list[
    "aws_sdk_sso_admin.types.access_control_attribute_value_source.AccessControlAttributeValueSource"
]
