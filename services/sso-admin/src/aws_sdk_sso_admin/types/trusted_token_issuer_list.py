...
TrustedTokenIssuerList: TypeAlias = list[
    "aws_sdk_sso_admin.types.trusted_token_issuer_metadata.TrustedTokenIssuerMetadata"
]
...
def serialize_aws_json_1_1(value: TrustedTokenIssuerList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sso_admin.types.trusted_token_issuer_metadata.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> TrustedTokenIssuerList:
    ...
    for item in data:
        out.append(
            aws_sdk_sso_admin.types.trusted_token_issuer_metadata.deserialize_aws_json_1_1(
                item
            )
        )
    return out
