...
def serialize_aws_json_1_1(value: ListAccountAssignmentsForPrincipalRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["Filter"] = (
            aws_sdk_sso_admin.types.list_account_assignments_filter.serialize_aws_json_1_1(
                value["filter"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListAccountAssignmentsForPrincipalRequest:
    ...
    if "Filter" in data:
        ...
        out["filter"] = (
            aws_sdk_sso_admin.types.list_account_assignments_filter.deserialize_aws_json_1_1(
                data["Filter"]
            )
        )
