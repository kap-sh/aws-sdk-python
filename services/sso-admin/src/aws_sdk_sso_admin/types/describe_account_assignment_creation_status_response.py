"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DescribeAccountAssignmentCreationStatusResponse``."""
...
class DescribeAccountAssignmentCreationStatusResponse(TypedDict, closed=True):
...
def serialize_aws_json_1_1(
    value: DescribeAccountAssignmentCreationStatusResponse,
) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(
    ...
    out: DescribeAccountAssignmentCreationStatusResponse = {}  # type: ignore[typeddict-item]
