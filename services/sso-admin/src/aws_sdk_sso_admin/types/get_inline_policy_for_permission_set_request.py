"""Generated from Smithy shape ``com.amazonaws.ssoadmin#GetInlinePolicyForPermissionSetRequest``."""
...
class GetInlinePolicyForPermissionSetRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetInlinePolicyForPermissionSetRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> GetInlinePolicyForPermissionSetRequest:
    out: GetInlinePolicyForPermissionSetRequest = {}  # type: ignore[typeddict-item]
    if "InstanceArn" in data:
        out["instance_arn"] = data["InstanceArn"]
    else:
        raise DeserializationError(
            "GetInlinePolicyForPermissionSetRequest.instance_arn required"
        )
    if "PermissionSetArn" in data:
        out["permission_set_arn"] = data["PermissionSetArn"]
    else:
        raise DeserializationError(
            "GetInlinePolicyForPermissionSetRequest.permission_set_arn required"
        )
    return out
