...
if TYPE_CHECKING:
    import aws_sdk_sso_admin.types.application_assignment_list_for_principal
    import aws_sdk_sso_admin.types.token


class ListApplicationAssignmentsForPrincipalResponse(TypedDict):
    application_assignments: NotRequired[
        "aws_sdk_sso_admin.types.application_assignment_list_for_principal.ApplicationAssignmentListForPrincipal"
    ]
...
def serialize_aws_json_1_1(
    ...
    if "application_assignments" in value:
        ...
        out["ApplicationAssignments"] = (
            aws_sdk_sso_admin.types.application_assignment_list_for_principal.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "ApplicationAssignments" in data:
        ...
        out["application_assignments"] = (
            aws_sdk_sso_admin.types.application_assignment_list_for_principal.deserialize_aws_json_1_1(
