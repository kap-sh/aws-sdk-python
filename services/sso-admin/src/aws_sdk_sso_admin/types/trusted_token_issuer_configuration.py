...
if TYPE_CHECKING:
    import aws_sdk_sso_admin.types.oidc_jwt_configuration


class _TrustedTokenIssuerConfiguration_OidcJwtConfiguration(TypedDict):
    OidcJwtConfiguration: (
        "aws_sdk_sso_admin.types.oidc_jwt_configuration.OidcJwtConfiguration"
    )
...
def serialize_aws_json_1_1(value: TrustedTokenIssuerConfiguration) -> dict:
    if "OidcJwtConfiguration" in value:
        ...
        return {
            "OidcJwtConfiguration": aws_sdk_sso_admin.types.oidc_jwt_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TrustedTokenIssuerConfiguration:
    if "OidcJwtConfiguration" in data:
        ...
        return {
            "OidcJwtConfiguration": aws_sdk_sso_admin.types.oidc_jwt_configuration.deserialize_aws_json_1_1(
