...
class ListApplicationAssignmentsForPrincipalRequest(TypedDict):
...
def serialize_aws_json_1_1(
    ...
    if "filter" in value:
        ...
        out["Filter"] = (
            aws_sdk_sso_admin.types.list_application_assignments_filter.serialize_aws_json_1_1(
                value["filter"]
            )
        )
...
def deserialize_aws_json_1_1(
    ...
    if "Filter" in data:
        ...
        out["filter"] = (
            aws_sdk_sso_admin.types.list_application_assignments_filter.deserialize_aws_json_1_1(
                data["Filter"]
            )
        )
