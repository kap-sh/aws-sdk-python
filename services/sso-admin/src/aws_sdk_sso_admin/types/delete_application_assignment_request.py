"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DeleteApplicationAssignmentRequest``."""
...
class DeleteApplicationAssignmentRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteApplicationAssignmentRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeleteApplicationAssignmentRequest:
    out: DeleteApplicationAssignmentRequest = {}  # type: ignore[typeddict-item]
    if "ApplicationArn" in data:
        out["application_arn"] = data["ApplicationArn"]
    else:
        raise DeserializationError(
            "DeleteApplicationAssignmentRequest.application_arn required"
        )
    if "PrincipalId" in data:
        out["principal_id"] = data["PrincipalId"]
    else:
        raise DeserializationError(
            "DeleteApplicationAssignmentRequest.principal_id required"
        )
    if "PrincipalType" in data:
        ...
        raise DeserializationError(
            "DeleteApplicationAssignmentRequest.principal_type required"
        )
    return out
