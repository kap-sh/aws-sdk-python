...
if TYPE_CHECKING:
    import aws_sdk_sso_admin.types.access_control_attribute

AccessControlAttributeList: TypeAlias = list[
    "aws_sdk_sso_admin.types.access_control_attribute.AccessControlAttribute"
]
...
def serialize_aws_json_1_1(value: AccessControlAttributeList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_sso_admin.types.access_control_attribute.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> AccessControlAttributeList:
    ...
    for item in data:
        out.append(
            aws_sdk_sso_admin.types.access_control_attribute.deserialize_aws_json_1_1(
                item
            )
        )
    return out
