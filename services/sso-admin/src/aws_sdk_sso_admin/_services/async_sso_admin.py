...
from aws_sdk_sso_admin._services._aws_config import aaws_config
...
class AsyncSSOAdminClientConfig(TypedDict, total=False):
...
class AsyncSSOAdminClient:
    ...
    async def add_region(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.add_region_request.AddRegionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.add_region_response.AddRegionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.add_region.async_add_region(
    ...
    async def attach_customer_managed_policy_reference_to_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.attach_customer_managed_policy_reference_to_permission_set_request.AttachCustomerManagedPolicyReferenceToPermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.attach_customer_managed_policy_reference_to_permission_set_response.AttachCustomerManagedPolicyReferenceToPermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.attach_customer_managed_policy_reference_to_permission_set.async_attach_customer_managed_policy_reference_to_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def attach_managed_policy_to_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.attach_managed_policy_to_permission_set_request.AttachManagedPolicyToPermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.attach_managed_policy_to_permission_set_response.AttachManagedPolicyToPermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.attach_managed_policy_to_permission_set.async_attach_managed_policy_to_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_account_assignment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.create_account_assignment_request.CreateAccountAssignmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.create_account_assignment_response.CreateAccountAssignmentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.create_account_assignment.async_create_account_assignment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.create_application_request.CreateApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.create_application_response.CreateApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.create_application.async_create_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_application_assignment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.create_application_assignment_request.CreateApplicationAssignmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.create_application_assignment_response.CreateApplicationAssignmentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.create_application_assignment.async_create_application_assignment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.create_instance_request.CreateInstanceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.create_instance_response.CreateInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.create_instance.async_create_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_instance_access_control_attribute_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.create_instance_access_control_attribute_configuration_request.CreateInstanceAccessControlAttributeConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.create_instance_access_control_attribute_configuration_response.CreateInstanceAccessControlAttributeConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.create_instance_access_control_attribute_configuration.async_create_instance_access_control_attribute_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.create_permission_set_request.CreatePermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.create_permission_set_response.CreatePermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.create_permission_set.async_create_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_trusted_token_issuer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.create_trusted_token_issuer_request.CreateTrustedTokenIssuerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.create_trusted_token_issuer_response.CreateTrustedTokenIssuerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.create_trusted_token_issuer.async_create_trusted_token_issuer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_account_assignment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.delete_account_assignment_request.DeleteAccountAssignmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.delete_account_assignment_response.DeleteAccountAssignmentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.delete_account_assignment.async_delete_account_assignment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.delete_application_request.DeleteApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.delete_application_response.DeleteApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.delete_application.async_delete_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_application_assignment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.delete_application_assignment_request.DeleteApplicationAssignmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.delete_application_assignment_response.DeleteApplicationAssignmentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.delete_application_assignment.async_delete_application_assignment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_inline_policy_from_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.delete_inline_policy_from_permission_set_request.DeleteInlinePolicyFromPermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.delete_inline_policy_from_permission_set_response.DeleteInlinePolicyFromPermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.delete_inline_policy_from_permission_set.async_delete_inline_policy_from_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.delete_instance_request.DeleteInstanceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.delete_instance_response.DeleteInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.delete_instance.async_delete_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_instance_access_control_attribute_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.delete_instance_access_control_attribute_configuration_request.DeleteInstanceAccessControlAttributeConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.delete_instance_access_control_attribute_configuration_response.DeleteInstanceAccessControlAttributeConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.delete_instance_access_control_attribute_configuration.async_delete_instance_access_control_attribute_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_permissions_boundary_from_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.delete_permissions_boundary_from_permission_set_request.DeletePermissionsBoundaryFromPermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.delete_permissions_boundary_from_permission_set_response.DeletePermissionsBoundaryFromPermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.delete_permissions_boundary_from_permission_set.async_delete_permissions_boundary_from_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.delete_permission_set_request.DeletePermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.delete_permission_set_response.DeletePermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.delete_permission_set.async_delete_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_trusted_token_issuer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.delete_trusted_token_issuer_request.DeleteTrustedTokenIssuerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.delete_trusted_token_issuer_response.DeleteTrustedTokenIssuerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.delete_trusted_token_issuer.async_delete_trusted_token_issuer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_assignment_creation_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.describe_account_assignment_creation_status_request.DescribeAccountAssignmentCreationStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.describe_account_assignment_creation_status_response.DescribeAccountAssignmentCreationStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.describe_account_assignment_creation_status.async_describe_account_assignment_creation_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_assignment_deletion_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.describe_account_assignment_deletion_status_request.DescribeAccountAssignmentDeletionStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.describe_account_assignment_deletion_status_response.DescribeAccountAssignmentDeletionStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.describe_account_assignment_deletion_status.async_describe_account_assignment_deletion_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.describe_application_request.DescribeApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.describe_application_response.DescribeApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.describe_application.async_describe_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_application_assignment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.describe_application_assignment_request.DescribeApplicationAssignmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.describe_application_assignment_response.DescribeApplicationAssignmentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.describe_application_assignment.async_describe_application_assignment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_application_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.describe_application_provider_request.DescribeApplicationProviderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.describe_application_provider_response.DescribeApplicationProviderResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.describe_application_provider.async_describe_application_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.describe_instance_request.DescribeInstanceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.describe_instance_response.DescribeInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.describe_instance.async_describe_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_instance_access_control_attribute_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.describe_instance_access_control_attribute_configuration_request.DescribeInstanceAccessControlAttributeConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.describe_instance_access_control_attribute_configuration_response.DescribeInstanceAccessControlAttributeConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.describe_instance_access_control_attribute_configuration.async_describe_instance_access_control_attribute_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.describe_permission_set_request.DescribePermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.describe_permission_set_response.DescribePermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.describe_permission_set.async_describe_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_permission_set_provisioning_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.describe_permission_set_provisioning_status_request.DescribePermissionSetProvisioningStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.describe_permission_set_provisioning_status_response.DescribePermissionSetProvisioningStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.describe_permission_set_provisioning_status.async_describe_permission_set_provisioning_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_region(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.describe_region_request.DescribeRegionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.describe_region_response.DescribeRegionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.describe_region.async_describe_region(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_trusted_token_issuer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.describe_trusted_token_issuer_request.DescribeTrustedTokenIssuerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.describe_trusted_token_issuer_response.DescribeTrustedTokenIssuerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.describe_trusted_token_issuer.async_describe_trusted_token_issuer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detach_customer_managed_policy_reference_from_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.detach_customer_managed_policy_reference_from_permission_set_request.DetachCustomerManagedPolicyReferenceFromPermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.detach_customer_managed_policy_reference_from_permission_set_response.DetachCustomerManagedPolicyReferenceFromPermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.detach_customer_managed_policy_reference_from_permission_set.async_detach_customer_managed_policy_reference_from_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detach_managed_policy_from_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.detach_managed_policy_from_permission_set_request.DetachManagedPolicyFromPermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.detach_managed_policy_from_permission_set_response.DetachManagedPolicyFromPermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.detach_managed_policy_from_permission_set.async_detach_managed_policy_from_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_application_assignment_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.get_application_assignment_configuration_request.GetApplicationAssignmentConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.get_application_assignment_configuration_response.GetApplicationAssignmentConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.get_application_assignment_configuration.async_get_application_assignment_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_application_session_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.get_application_session_configuration_request.GetApplicationSessionConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.get_application_session_configuration_response.GetApplicationSessionConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.get_application_session_configuration.async_get_application_session_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_inline_policy_for_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.get_inline_policy_for_permission_set_request.GetInlinePolicyForPermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.get_inline_policy_for_permission_set_response.GetInlinePolicyForPermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.get_inline_policy_for_permission_set.async_get_inline_policy_for_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_permissions_boundary_for_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.get_permissions_boundary_for_permission_set_request.GetPermissionsBoundaryForPermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.get_permissions_boundary_for_permission_set_response.GetPermissionsBoundaryForPermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.get_permissions_boundary_for_permission_set.async_get_permissions_boundary_for_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_account_assignment_creation_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_account_assignment_creation_status_request.ListAccountAssignmentCreationStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_account_assignment_creation_status_response.ListAccountAssignmentCreationStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_account_assignment_creation_status.async_list_account_assignment_creation_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.account_assignment_operation_status_metadata.AccountAssignmentOperationStatusMetadata]":
        _token = next_token
        while True:
    ...
    async def list_account_assignment_deletion_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_account_assignment_deletion_status_request.ListAccountAssignmentDeletionStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_account_assignment_deletion_status_response.ListAccountAssignmentDeletionStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_account_assignment_deletion_status.async_list_account_assignment_deletion_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_account_assignments(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_account_assignments_request.ListAccountAssignmentsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_account_assignments_response.ListAccountAssignmentsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_account_assignments.async_list_account_assignments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_account_assignments(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_sso_admin.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_sso_admin.types.token.Token"] = None,
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.account_assignment.AccountAssignment]":
        _token = next_token
        while True:
    ...
    async def list_account_assignments_for_principal(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_account_assignments_for_principal_request.ListAccountAssignmentsForPrincipalRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_account_assignments_for_principal_response.ListAccountAssignmentsForPrincipalResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_account_assignments_for_principal.async_list_account_assignments_for_principal(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_account_assignments_for_principal(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_sso_admin.types.token.Token"] = None,
        max_results: Optional["aws_sdk_sso_admin.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.account_assignment_for_principal.AccountAssignmentForPrincipal]":
        _token = next_token
        while True:
    ...
    async def list_accounts_for_provisioned_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_accounts_for_provisioned_permission_set_request.ListAccountsForProvisionedPermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_accounts_for_provisioned_permission_set_response.ListAccountsForProvisionedPermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_accounts_for_provisioned_permission_set.async_list_accounts_for_provisioned_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_accounts_for_provisioned_permission_set(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_sso_admin.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_sso_admin.types.token.Token"] = None,
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.account_id.AccountId]":
        _token = next_token
        while True:
    ...
    async def list_application_assignments(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_application_assignments_request.ListApplicationAssignmentsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_application_assignments_response.ListApplicationAssignmentsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_application_assignments.async_list_application_assignments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_application_assignments(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_sso_admin.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_sso_admin.types.token.Token"] = None,
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.application_assignment.ApplicationAssignment]":
        _token = next_token
        while True:
    ...
    async def list_application_assignments_for_principal(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_application_assignments_for_principal_request.ListApplicationAssignmentsForPrincipalRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_application_assignments_for_principal_response.ListApplicationAssignmentsForPrincipalResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_application_assignments_for_principal.async_list_application_assignments_for_principal(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_application_assignments_for_principal(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_sso_admin.types.token.Token"] = None,
        max_results: Optional["aws_sdk_sso_admin.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.application_assignment_for_principal.ApplicationAssignmentForPrincipal]":
        _token = next_token
        while True:
    ...
    async def list_application_providers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_application_providers_request.ListApplicationProvidersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_application_providers_response.ListApplicationProvidersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_application_providers.async_list_application_providers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_application_providers(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_sso_admin.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_sso_admin.types.token.Token"] = None,
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.application_provider.ApplicationProvider]":
        _token = next_token
        while True:
    ...
    async def list_applications(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_applications_request.ListApplicationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_applications_response.ListApplicationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_applications.async_list_applications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.application.Application]":
        _token = next_token
        while True:
    ...
    async def list_customer_managed_policy_references_in_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_customer_managed_policy_references_in_permission_set_request.ListCustomerManagedPolicyReferencesInPermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_customer_managed_policy_references_in_permission_set_response.ListCustomerManagedPolicyReferencesInPermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_customer_managed_policy_references_in_permission_set.async_list_customer_managed_policy_references_in_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_customer_managed_policy_references_in_permission_set(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_sso_admin.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_sso_admin.types.token.Token"] = None,
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.customer_managed_policy_reference.CustomerManagedPolicyReference]":
        _token = next_token
        while True:
            _response = (
    ...
    async def list_instances(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_instances_request.ListInstancesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_instances_response.ListInstancesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_instances.async_list_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_instances(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_sso_admin.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_sso_admin.types.token.Token"] = None,
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.instance_metadata.InstanceMetadata]":
        _token = next_token
        while True:
    ...
    async def list_managed_policies_in_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_managed_policies_in_permission_set_request.ListManagedPoliciesInPermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_managed_policies_in_permission_set_response.ListManagedPoliciesInPermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_managed_policies_in_permission_set.async_list_managed_policies_in_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_managed_policies_in_permission_set(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_sso_admin.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_sso_admin.types.token.Token"] = None,
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.attached_managed_policy.AttachedManagedPolicy]":
        _token = next_token
        while True:
    ...
    async def list_permission_set_provisioning_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_permission_set_provisioning_status_request.ListPermissionSetProvisioningStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_permission_set_provisioning_status_response.ListPermissionSetProvisioningStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_permission_set_provisioning_status.async_list_permission_set_provisioning_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.permission_set_provisioning_status_metadata.PermissionSetProvisioningStatusMetadata]":
        _token = next_token
        while True:
    ...
    async def list_permission_sets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_permission_sets_request.ListPermissionSetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_permission_sets_response.ListPermissionSetsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_permission_sets.async_list_permission_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_permission_sets(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_sso_admin.types.token.Token"] = None,
        max_results: Optional["aws_sdk_sso_admin.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.permission_set_arn.PermissionSetArn]":
        _token = next_token
        while True:
    ...
    async def list_permission_sets_provisioned_to_account(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_permission_sets_provisioned_to_account_request.ListPermissionSetsProvisionedToAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_permission_sets_provisioned_to_account_response.ListPermissionSetsProvisionedToAccountResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_permission_sets_provisioned_to_account.async_list_permission_sets_provisioned_to_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_regions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_regions_request.ListRegionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_regions_response.ListRegionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_regions.async_list_regions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_regions(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_sso_admin.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_sso_admin.types.token.Token"] = None,
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.region_metadata.RegionMetadata]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_tags_for_resource(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_sso_admin.types.token.Token"] = None,
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    async def list_trusted_token_issuers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.list_trusted_token_issuers_request.ListTrustedTokenIssuersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.list_trusted_token_issuers_response.ListTrustedTokenIssuersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.list_trusted_token_issuers.async_list_trusted_token_issuers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_trusted_token_issuers(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_sso_admin.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_sso_admin.types.token.Token"] = None,
    ) -> "AsyncIterator[aws_sdk_sso_admin.types.trusted_token_issuer_metadata.TrustedTokenIssuerMetadata]":
        _token = next_token
        while True:
    ...
    async def provision_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.provision_permission_set_request.ProvisionPermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.provision_permission_set_response.ProvisionPermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.provision_permission_set.async_provision_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_application_assignment_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.put_application_assignment_configuration_request.PutApplicationAssignmentConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.put_application_assignment_configuration_response.PutApplicationAssignmentConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.put_application_assignment_configuration.async_put_application_assignment_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_application_session_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.put_application_session_configuration_request.PutApplicationSessionConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.put_application_session_configuration_response.PutApplicationSessionConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.put_application_session_configuration.async_put_application_session_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_inline_policy_to_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.put_inline_policy_to_permission_set_request.PutInlinePolicyToPermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.put_inline_policy_to_permission_set_response.PutInlinePolicyToPermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.put_inline_policy_to_permission_set.async_put_inline_policy_to_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_permissions_boundary_to_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.put_permissions_boundary_to_permission_set_request.PutPermissionsBoundaryToPermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.put_permissions_boundary_to_permission_set_response.PutPermissionsBoundaryToPermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.put_permissions_boundary_to_permission_set.async_put_permissions_boundary_to_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_region(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.remove_region_request.RemoveRegionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.remove_region_response.RemoveRegionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.remove_region.async_remove_region(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.update_application_request.UpdateApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.update_application_response.UpdateApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.update_application.async_update_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.update_instance_request.UpdateInstanceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.update_instance_response.UpdateInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.update_instance.async_update_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_instance_access_control_attribute_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.update_instance_access_control_attribute_configuration_request.UpdateInstanceAccessControlAttributeConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.update_instance_access_control_attribute_configuration_response.UpdateInstanceAccessControlAttributeConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.update_instance_access_control_attribute_configuration.async_update_instance_access_control_attribute_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_permission_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.update_permission_set_request.UpdatePermissionSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.update_permission_set_response.UpdatePermissionSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.update_permission_set.async_update_permission_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_trusted_token_issuer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sso_admin.types.update_trusted_token_issuer_request.UpdateTrustedTokenIssuerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sso_admin.types.update_trusted_token_issuer_response.UpdateTrustedTokenIssuerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sso_admin._operations.swb_external_service.update_trusted_token_issuer.async_update_trusted_token_issuer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
