...
class SSOAdminError(Exception):
    """Base class for all SSOAdmin service errors."""


class ServiceError(SSOAdminError):
...
class SerializationError(SSOAdminError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SSOAdminError):
...
class WaiterFailedError(SSOAdminError):
...
class WaiterTimeoutError(SSOAdminError):
