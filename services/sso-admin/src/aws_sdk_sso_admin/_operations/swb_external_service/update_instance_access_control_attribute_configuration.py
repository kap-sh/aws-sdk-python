"""Generated from Smithy shape ``com.amazonaws.ssoadmin#UpdateInstanceAccessControlAttributeConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.update_instance_access_control_attribute_configuration_response.UpdateInstanceAccessControlAttributeConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.update_instance_access_control_attribute_configuration_request.UpdateInstanceAccessControlAttributeConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_instance_access_control_attribute_configuration(
