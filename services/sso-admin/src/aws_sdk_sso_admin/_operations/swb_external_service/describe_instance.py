...
def build_request(
    ...
    input: aws_sdk_sso_admin.types.describe_instance_request.DescribeInstanceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.describe_instance_request.serialize_aws_json_1_1(input)
    ).encode()
