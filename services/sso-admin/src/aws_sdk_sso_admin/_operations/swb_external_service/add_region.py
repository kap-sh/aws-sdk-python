"""Generated from Smithy shape ``com.amazonaws.ssoadmin#AddRegion``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.add_region_response.AddRegionResponse = (
        aws_sdk_sso_admin.types.add_region_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.add_region_request.AddRegionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.AddRegion"
    import aws_sdk_sso_admin.types.add_region_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.add_region_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def add_region(
    ...
    aws_sdk_sso_admin.types.add_region_response.AddRegionResponse, zapros.Response
]:
