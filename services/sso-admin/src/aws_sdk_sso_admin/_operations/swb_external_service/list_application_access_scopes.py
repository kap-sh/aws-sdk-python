...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.list_application_access_scopes_response.ListApplicationAccessScopesResponse = aws_sdk_sso_admin.types.list_application_access_scopes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.list_application_access_scopes_request.ListApplicationAccessScopesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.list_application_access_scopes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
