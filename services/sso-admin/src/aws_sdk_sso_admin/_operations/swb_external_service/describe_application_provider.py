...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.describe_application_provider_response.DescribeApplicationProviderResponse = aws_sdk_sso_admin.types.describe_application_provider_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.describe_application_provider_request.DescribeApplicationProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.describe_application_provider_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
