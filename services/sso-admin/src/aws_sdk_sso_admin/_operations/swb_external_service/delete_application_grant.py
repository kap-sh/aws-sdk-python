"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DeleteApplicationGrant``."""
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.delete_application_grant_request.DeleteApplicationGrantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.DeleteApplicationGrant"
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.delete_application_grant_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_application_grant(
