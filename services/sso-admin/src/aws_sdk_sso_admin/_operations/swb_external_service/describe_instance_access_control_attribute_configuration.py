...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.describe_instance_access_control_attribute_configuration_response.DescribeInstanceAccessControlAttributeConfigurationResponse = aws_sdk_sso_admin.types.describe_instance_access_control_attribute_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.describe_instance_access_control_attribute_configuration_request.DescribeInstanceAccessControlAttributeConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.describe_instance_access_control_attribute_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
