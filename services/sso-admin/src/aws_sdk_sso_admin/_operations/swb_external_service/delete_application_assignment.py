"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DeleteApplicationAssignment``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.delete_application_assignment_response.DeleteApplicationAssignmentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.delete_application_assignment_request.DeleteApplicationAssignmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.DeleteApplicationAssignment"
    import aws_sdk_sso_admin.types.delete_application_assignment_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.delete_application_assignment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_application_assignment(
