...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.get_permissions_boundary_for_permission_set_response.GetPermissionsBoundaryForPermissionSetResponse = aws_sdk_sso_admin.types.get_permissions_boundary_for_permission_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.get_permissions_boundary_for_permission_set_request.GetPermissionsBoundaryForPermissionSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
