...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.list_customer_managed_policy_references_in_permission_set_response.ListCustomerManagedPolicyReferencesInPermissionSetResponse = aws_sdk_sso_admin.types.list_customer_managed_policy_references_in_permission_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.list_customer_managed_policy_references_in_permission_set_request.ListCustomerManagedPolicyReferencesInPermissionSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.list_customer_managed_policy_references_in_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
