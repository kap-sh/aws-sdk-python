"""Generated from Smithy shape ``com.amazonaws.ssoadmin#GetApplicationAssignmentConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.get_application_assignment_configuration_response.GetApplicationAssignmentConfigurationResponse = aws_sdk_sso_admin.types.get_application_assignment_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.get_application_assignment_configuration_request.GetApplicationAssignmentConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.GetApplicationAssignmentConfiguration"
    import aws_sdk_sso_admin.types.get_application_assignment_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.get_application_assignment_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_application_assignment_configuration(
