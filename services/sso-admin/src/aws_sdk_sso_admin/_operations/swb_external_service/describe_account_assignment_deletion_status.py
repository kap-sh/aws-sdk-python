"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DescribeAccountAssignmentDeletionStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.describe_account_assignment_deletion_status_response.DescribeAccountAssignmentDeletionStatusResponse = aws_sdk_sso_admin.types.describe_account_assignment_deletion_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.describe_account_assignment_deletion_status_request.DescribeAccountAssignmentDeletionStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.describe_account_assignment_deletion_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_account_assignment_deletion_status(
