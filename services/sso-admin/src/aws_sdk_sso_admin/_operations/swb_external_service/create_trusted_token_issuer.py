"""Generated from Smithy shape ``com.amazonaws.ssoadmin#CreateTrustedTokenIssuer``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.create_trusted_token_issuer_response.CreateTrustedTokenIssuerResponse = aws_sdk_sso_admin.types.create_trusted_token_issuer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.create_trusted_token_issuer_request.CreateTrustedTokenIssuerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.CreateTrustedTokenIssuer"
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.create_trusted_token_issuer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_trusted_token_issuer(
