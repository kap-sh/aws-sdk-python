...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.create_application_assignment_response.CreateApplicationAssignmentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.create_application_assignment_request.CreateApplicationAssignmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.create_application_assignment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
