"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DeleteApplicationAuthenticationMethod``."""
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.delete_application_authentication_method_request.DeleteApplicationAuthenticationMethodRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.DeleteApplicationAuthenticationMethod"
    import aws_sdk_sso_admin.types.delete_application_authentication_method_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.delete_application_authentication_method_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_application_authentication_method(
