...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.put_application_session_configuration_response.PutApplicationSessionConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.put_application_session_configuration_request.PutApplicationSessionConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.put_application_session_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
