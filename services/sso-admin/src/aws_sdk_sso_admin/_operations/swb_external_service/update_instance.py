"""Generated from Smithy shape ``com.amazonaws.ssoadmin#UpdateInstance``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.update_instance_response.UpdateInstanceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.update_instance_request.UpdateInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.UpdateInstance"
    import aws_sdk_sso_admin.types.update_instance_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.update_instance_request.serialize_aws_json_1_1(input_)
    ).encode()
