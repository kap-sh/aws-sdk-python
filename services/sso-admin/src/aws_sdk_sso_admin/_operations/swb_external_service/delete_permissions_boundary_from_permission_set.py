"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DeletePermissionsBoundaryFromPermissionSet``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.delete_permissions_boundary_from_permission_set_response.DeletePermissionsBoundaryFromPermissionSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.delete_permissions_boundary_from_permission_set_request.DeletePermissionsBoundaryFromPermissionSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.delete_permissions_boundary_from_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_permissions_boundary_from_permission_set(
