...
def build_request(
    ...
    input: aws_sdk_sso_admin.types.describe_region_request.DescribeRegionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.describe_region_request.serialize_aws_json_1_1(input)
    ).encode()
