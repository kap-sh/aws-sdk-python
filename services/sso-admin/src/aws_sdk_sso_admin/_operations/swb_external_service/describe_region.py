...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.describe_region_response.DescribeRegionResponse = (
        aws_sdk_sso_admin.types.describe_region_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.describe_region_request.DescribeRegionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.describe_region_request.serialize_aws_json_1_1(input_)
    ).encode()
