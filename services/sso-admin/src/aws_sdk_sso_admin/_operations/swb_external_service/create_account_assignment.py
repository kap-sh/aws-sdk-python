"""Generated from Smithy shape ``com.amazonaws.ssoadmin#CreateAccountAssignment``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.create_account_assignment_response.CreateAccountAssignmentResponse = aws_sdk_sso_admin.types.create_account_assignment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.create_account_assignment_request.CreateAccountAssignmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.CreateAccountAssignment"
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.create_account_assignment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_account_assignment(
