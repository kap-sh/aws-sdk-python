"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DescribePermissionSetProvisioningStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.describe_permission_set_provisioning_status_response.DescribePermissionSetProvisioningStatusResponse = aws_sdk_sso_admin.types.describe_permission_set_provisioning_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.describe_permission_set_provisioning_status_request.DescribePermissionSetProvisioningStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_permission_set_provisioning_status(
