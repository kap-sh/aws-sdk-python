...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.list_application_authentication_methods_response.ListApplicationAuthenticationMethodsResponse = aws_sdk_sso_admin.types.list_application_authentication_methods_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.list_application_authentication_methods_request.ListApplicationAuthenticationMethodsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.list_application_authentication_methods_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
