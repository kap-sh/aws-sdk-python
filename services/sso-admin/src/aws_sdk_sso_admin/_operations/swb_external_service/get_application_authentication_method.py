"""Generated from Smithy shape ``com.amazonaws.ssoadmin#GetApplicationAuthenticationMethod``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.get_application_authentication_method_response.GetApplicationAuthenticationMethodResponse = aws_sdk_sso_admin.types.get_application_authentication_method_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.get_application_authentication_method_request.GetApplicationAuthenticationMethodRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.GetApplicationAuthenticationMethod"
    import aws_sdk_sso_admin.types.get_application_authentication_method_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.get_application_authentication_method_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_application_authentication_method(
