...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.list_account_assignments_response.ListAccountAssignmentsResponse = aws_sdk_sso_admin.types.list_account_assignments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.list_account_assignments_request.ListAccountAssignmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.list_account_assignments_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
