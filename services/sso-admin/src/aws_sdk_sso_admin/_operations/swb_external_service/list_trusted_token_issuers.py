...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.list_trusted_token_issuers_response.ListTrustedTokenIssuersResponse = aws_sdk_sso_admin.types.list_trusted_token_issuers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.list_trusted_token_issuers_request.ListTrustedTokenIssuersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.list_trusted_token_issuers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
