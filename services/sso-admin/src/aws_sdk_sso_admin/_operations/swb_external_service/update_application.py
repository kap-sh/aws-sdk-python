"""Generated from Smithy shape ``com.amazonaws.ssoadmin#UpdateApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.update_application_response.UpdateApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_sso_admin.types.update_application_request.UpdateApplicationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.update_application_request.serialize_aws_json_1_1(input)
    ).encode()
