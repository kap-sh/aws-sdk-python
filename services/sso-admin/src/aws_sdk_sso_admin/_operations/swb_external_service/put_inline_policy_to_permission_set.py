...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.put_inline_policy_to_permission_set_response.PutInlinePolicyToPermissionSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.put_inline_policy_to_permission_set_request.PutInlinePolicyToPermissionSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.put_inline_policy_to_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
