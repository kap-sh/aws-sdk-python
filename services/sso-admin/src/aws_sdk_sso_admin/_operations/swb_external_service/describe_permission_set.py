...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.describe_permission_set_response.DescribePermissionSetResponse = aws_sdk_sso_admin.types.describe_permission_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.describe_permission_set_request.DescribePermissionSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.describe_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
