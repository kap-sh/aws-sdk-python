"""Generated from Smithy shape ``com.amazonaws.ssoadmin#GetApplicationAccessScope``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.get_application_access_scope_response.GetApplicationAccessScopeResponse = aws_sdk_sso_admin.types.get_application_access_scope_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.get_application_access_scope_request.GetApplicationAccessScopeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_application_access_scope(
