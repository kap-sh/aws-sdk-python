"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DeleteInstance``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.delete_instance_response.DeleteInstanceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.delete_instance_request.DeleteInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.DeleteInstance"
    import aws_sdk_sso_admin.types.delete_instance_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.delete_instance_request.serialize_aws_json_1_1(input_)
    ).encode()
