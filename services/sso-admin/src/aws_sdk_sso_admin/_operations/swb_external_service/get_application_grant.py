...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.get_application_grant_response.GetApplicationGrantResponse = aws_sdk_sso_admin.types.get_application_grant_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.get_application_grant_request.GetApplicationGrantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.get_application_grant_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
