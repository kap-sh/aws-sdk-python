...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.list_application_assignments_for_principal_response.ListApplicationAssignmentsForPrincipalResponse = aws_sdk_sso_admin.types.list_application_assignments_for_principal_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.list_application_assignments_for_principal_request.ListApplicationAssignmentsForPrincipalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
