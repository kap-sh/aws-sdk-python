...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.create_permission_set_response.CreatePermissionSetResponse = aws_sdk_sso_admin.types.create_permission_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.create_permission_set_request.CreatePermissionSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.create_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
