"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DeletePermissionSet``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.delete_permission_set_response.DeletePermissionSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.delete_permission_set_request.DeletePermissionSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.DeletePermissionSet"
    import aws_sdk_sso_admin.types.delete_permission_set_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.delete_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_permission_set(
