...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.list_regions_response.ListRegionsResponse = (
        aws_sdk_sso_admin.types.list_regions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.list_regions_request.ListRegionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.list_regions_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_regions(
    ...
    aws_sdk_sso_admin.types.list_regions_response.ListRegionsResponse, zapros.Response
]:
