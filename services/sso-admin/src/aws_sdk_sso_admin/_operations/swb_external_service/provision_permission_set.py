"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ProvisionPermissionSet``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.provision_permission_set_response.ProvisionPermissionSetResponse = aws_sdk_sso_admin.types.provision_permission_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.provision_permission_set_request.ProvisionPermissionSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ProvisionPermissionSet"
    import aws_sdk_sso_admin.types.provision_permission_set_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.provision_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_provision_permission_set(
