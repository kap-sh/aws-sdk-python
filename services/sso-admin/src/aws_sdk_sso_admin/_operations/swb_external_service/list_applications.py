...
def build_request(
    ...
    input: aws_sdk_sso_admin.types.list_applications_request.ListApplicationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.list_applications_request.serialize_aws_json_1_1(input)
    ).encode()
