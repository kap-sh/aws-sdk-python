...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.list_applications_response.ListApplicationsResponse = (
        aws_sdk_sso_admin.types.list_applications_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.list_applications_request.ListApplicationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.list_applications_request.serialize_aws_json_1_1(input_)
    ).encode()
