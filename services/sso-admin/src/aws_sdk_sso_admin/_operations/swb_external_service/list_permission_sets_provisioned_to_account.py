...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.list_permission_sets_provisioned_to_account_response.ListPermissionSetsProvisionedToAccountResponse = aws_sdk_sso_admin.types.list_permission_sets_provisioned_to_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.list_permission_sets_provisioned_to_account_request.ListPermissionSetsProvisionedToAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
