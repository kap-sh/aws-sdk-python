...
def build_request(
    ...
    input: aws_sdk_sso_admin.types.create_instance_request.CreateInstanceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.create_instance_request.serialize_aws_json_1_1(input)
    ).encode()
