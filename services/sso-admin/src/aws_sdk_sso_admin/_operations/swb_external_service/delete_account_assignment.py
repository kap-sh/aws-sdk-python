"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DeleteAccountAssignment``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.delete_account_assignment_response.DeleteAccountAssignmentResponse = aws_sdk_sso_admin.types.delete_account_assignment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.delete_account_assignment_request.DeleteAccountAssignmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.DeleteAccountAssignment"
    import aws_sdk_sso_admin.types.delete_account_assignment_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.delete_account_assignment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_account_assignment(
