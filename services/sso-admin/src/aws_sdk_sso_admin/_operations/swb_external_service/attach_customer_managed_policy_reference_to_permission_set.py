...
def build_request(
    ...
    input: aws_sdk_sso_admin.types.attach_customer_managed_policy_reference_to_permission_set_request.AttachCustomerManagedPolicyReferenceToPermissionSetRequest,
) -> zapros.Request:
