...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.attach_customer_managed_policy_reference_to_permission_set_response.AttachCustomerManagedPolicyReferenceToPermissionSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.attach_customer_managed_policy_reference_to_permission_set_request.AttachCustomerManagedPolicyReferenceToPermissionSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
