...
def build_request(
    ...
    input: aws_sdk_sso_admin.types.detach_customer_managed_policy_reference_from_permission_set_request.DetachCustomerManagedPolicyReferenceFromPermissionSetRequest,
) -> zapros.Request:
