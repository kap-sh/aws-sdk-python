...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.detach_customer_managed_policy_reference_from_permission_set_response.DetachCustomerManagedPolicyReferenceFromPermissionSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.detach_customer_managed_policy_reference_from_permission_set_request.DetachCustomerManagedPolicyReferenceFromPermissionSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.detach_customer_managed_policy_reference_from_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
