"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DeleteInstanceAccessControlAttributeConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.delete_instance_access_control_attribute_configuration_response.DeleteInstanceAccessControlAttributeConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.delete_instance_access_control_attribute_configuration_request.DeleteInstanceAccessControlAttributeConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_instance_access_control_attribute_configuration(
