"""Generated from Smithy shape ``com.amazonaws.ssoadmin#AttachManagedPolicyToPermissionSet``."""
...
import aws_sdk_sso_admin.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_sso_admin.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.attach_managed_policy_to_permission_set_response.AttachManagedPolicyToPermissionSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def get_signer(
...
) -> aws_sdk_sso_admin._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_sso_admin._auth._sigv4.build_sigv4_auth_scheme(
                "sso", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_sso_admin._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.attach_managed_policy_to_permission_set_request.AttachManagedPolicyToPermissionSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.AttachManagedPolicyToPermissionSet"
    import aws_sdk_sso_admin.types.attach_managed_policy_to_permission_set_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.attach_managed_policy_to_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_attach_managed_policy_to_permission_set(
