"""Generated from Smithy shape ``com.amazonaws.ssoadmin#PutPermissionsBoundaryToPermissionSet``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.put_permissions_boundary_to_permission_set_response.PutPermissionsBoundaryToPermissionSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.put_permissions_boundary_to_permission_set_request.PutPermissionsBoundaryToPermissionSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.PutPermissionsBoundaryToPermissionSet"
    import aws_sdk_sso_admin.types.put_permissions_boundary_to_permission_set_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.put_permissions_boundary_to_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_permissions_boundary_to_permission_set(
