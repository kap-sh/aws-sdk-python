"""Generated from Smithy shape ``com.amazonaws.ssoadmin#PutApplicationAccessScope``."""
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.put_application_access_scope_request.PutApplicationAccessScopeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.PutApplicationAccessScope"
    import aws_sdk_sso_admin.types.put_application_access_scope_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.put_application_access_scope_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_application_access_scope(
