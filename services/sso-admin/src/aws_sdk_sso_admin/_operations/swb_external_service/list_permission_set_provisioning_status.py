"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListPermissionSetProvisioningStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.list_permission_set_provisioning_status_response.ListPermissionSetProvisioningStatusResponse = aws_sdk_sso_admin.types.list_permission_set_provisioning_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.list_permission_set_provisioning_status_request.ListPermissionSetProvisioningStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ListPermissionSetProvisioningStatus"
    import aws_sdk_sso_admin.types.list_permission_set_provisioning_status_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.list_permission_set_provisioning_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_permission_set_provisioning_status(
