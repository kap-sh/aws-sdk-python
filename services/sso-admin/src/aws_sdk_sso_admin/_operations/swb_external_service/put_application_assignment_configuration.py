"""Generated from Smithy shape ``com.amazonaws.ssoadmin#PutApplicationAssignmentConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.put_application_assignment_configuration_response.PutApplicationAssignmentConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.put_application_assignment_configuration_request.PutApplicationAssignmentConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.PutApplicationAssignmentConfiguration"
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.put_application_assignment_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_application_assignment_configuration(
