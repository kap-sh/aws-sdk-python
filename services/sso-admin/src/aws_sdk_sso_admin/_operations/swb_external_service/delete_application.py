"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DeleteApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.delete_application_response.DeleteApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_sso_admin.types.delete_application_request.DeleteApplicationRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "SWBExternalService.DeleteApplication"
    import aws_sdk_sso_admin.types.delete_application_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.delete_application_request.serialize_aws_json_1_1(input)
    ).encode()
