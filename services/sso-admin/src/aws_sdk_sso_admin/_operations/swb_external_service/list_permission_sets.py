"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListPermissionSets``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.list_permission_sets_response.ListPermissionSetsResponse = aws_sdk_sso_admin.types.list_permission_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.list_permission_sets_request.ListPermissionSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ListPermissionSets"
    import aws_sdk_sso_admin.types.list_permission_sets_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.list_permission_sets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_permission_sets(
