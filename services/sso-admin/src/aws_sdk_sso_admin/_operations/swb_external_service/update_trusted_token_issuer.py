...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.update_trusted_token_issuer_response.UpdateTrustedTokenIssuerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.update_trusted_token_issuer_request.UpdateTrustedTokenIssuerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.update_trusted_token_issuer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
