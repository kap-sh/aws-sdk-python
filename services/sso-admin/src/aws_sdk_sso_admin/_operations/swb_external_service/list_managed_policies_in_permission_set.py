"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListManagedPoliciesInPermissionSet``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.list_managed_policies_in_permission_set_response.ListManagedPoliciesInPermissionSetResponse = aws_sdk_sso_admin.types.list_managed_policies_in_permission_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.list_managed_policies_in_permission_set_request.ListManagedPoliciesInPermissionSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ListManagedPoliciesInPermissionSet"
    import aws_sdk_sso_admin.types.list_managed_policies_in_permission_set_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.list_managed_policies_in_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_managed_policies_in_permission_set(
