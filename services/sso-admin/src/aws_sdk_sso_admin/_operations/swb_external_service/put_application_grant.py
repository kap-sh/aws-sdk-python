"""Generated from Smithy shape ``com.amazonaws.ssoadmin#PutApplicationGrant``."""
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.put_application_grant_request.PutApplicationGrantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.PutApplicationGrant"
    import aws_sdk_sso_admin.types.put_application_grant_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.put_application_grant_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_application_grant(
