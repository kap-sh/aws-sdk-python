"""Generated from Smithy shape ``com.amazonaws.ssoadmin#RemoveRegion``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.remove_region_response.RemoveRegionResponse = (
        aws_sdk_sso_admin.types.remove_region_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.remove_region_request.RemoveRegionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.RemoveRegion"
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.remove_region_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def remove_region(
    ...
    aws_sdk_sso_admin.types.remove_region_response.RemoveRegionResponse, zapros.Response
]:
