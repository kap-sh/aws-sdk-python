"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListAccountsForProvisionedPermissionSet``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.list_accounts_for_provisioned_permission_set_response.ListAccountsForProvisionedPermissionSetResponse = aws_sdk_sso_admin.types.list_accounts_for_provisioned_permission_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.list_accounts_for_provisioned_permission_set_request.ListAccountsForProvisionedPermissionSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.list_accounts_for_provisioned_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_accounts_for_provisioned_permission_set(
