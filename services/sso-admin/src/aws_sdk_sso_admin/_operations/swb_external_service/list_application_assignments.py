...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.list_application_assignments_response.ListApplicationAssignmentsResponse = aws_sdk_sso_admin.types.list_application_assignments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.list_application_assignments_request.ListApplicationAssignmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.list_application_assignments_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
