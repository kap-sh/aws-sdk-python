"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DescribeApplicationAssignment``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.describe_application_assignment_response.DescribeApplicationAssignmentResponse = aws_sdk_sso_admin.types.describe_application_assignment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.describe_application_assignment_request.DescribeApplicationAssignmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.DescribeApplicationAssignment"
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.describe_application_assignment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_application_assignment(
