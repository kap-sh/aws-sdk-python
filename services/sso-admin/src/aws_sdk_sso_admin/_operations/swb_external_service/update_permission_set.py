"""Generated from Smithy shape ``com.amazonaws.ssoadmin#UpdatePermissionSet``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.update_permission_set_response.UpdatePermissionSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.update_permission_set_request.UpdatePermissionSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.UpdatePermissionSet"
    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.update_permission_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_permission_set(
