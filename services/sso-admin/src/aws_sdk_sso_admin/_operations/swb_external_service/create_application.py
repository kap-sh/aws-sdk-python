"""Generated from Smithy shape ``com.amazonaws.ssoadmin#CreateApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.create_application_response.CreateApplicationResponse = aws_sdk_sso_admin.types.create_application_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_sso_admin.types.create_application_request.CreateApplicationRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "SWBExternalService.CreateApplication"
    import aws_sdk_sso_admin.types.create_application_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.create_application_request.serialize_aws_json_1_1(input)
    ).encode()
