"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListApplicationProviders``."""
...
def handle_response(
    ...
    out: aws_sdk_sso_admin.types.list_application_providers_response.ListApplicationProvidersResponse = aws_sdk_sso_admin.types.list_application_providers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_sso_admin.types.list_application_providers_request.ListApplicationProvidersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ListApplicationProviders"
    import aws_sdk_sso_admin.types.list_application_providers_request

    body: bytes | None = json.dumps(
        aws_sdk_sso_admin.types.list_application_providers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_application_providers(
