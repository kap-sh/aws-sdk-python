"""Generated from Smithy shape ``com.amazonaws.directoryservice#DescribeTrusts``."""
...
import capo_directory_service.types.trusts
...
def handle_response(
    ...
    out: capo_directory_service.types.describe_trusts_result.DescribeTrustsResult = (
        capo_directory_service.types.describe_trusts_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.describe_trusts_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_trusts(
