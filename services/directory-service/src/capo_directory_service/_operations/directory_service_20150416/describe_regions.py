"""Generated from Smithy shape ``com.amazonaws.directoryservice#DescribeRegions``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.describe_regions_result.DescribeRegionsResult = (
        capo_directory_service.types.describe_regions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.DescribeRegions"
    body: bytes | None = json.dumps(
        capo_directory_service.types.describe_regions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
