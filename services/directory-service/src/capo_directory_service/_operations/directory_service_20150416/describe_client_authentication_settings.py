"""Generated from Smithy shape ``com.amazonaws.directoryservice#DescribeClientAuthenticationSettings``."""
...
import capo_directory_service.types.client_authentication_settings_info
...
def handle_response(
    ...
    out: capo_directory_service.types.describe_client_authentication_settings_result.DescribeClientAuthenticationSettingsResult = capo_directory_service.types.describe_client_authentication_settings_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.describe_client_authentication_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_client_authentication_settings(
