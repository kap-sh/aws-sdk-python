...
import capo_directory_service.errors.certificate_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CertificateInUseException":
            raise capo_directory_service.errors.certificate_in_use_exception.CertificateInUseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.deregister_certificate_result.DeregisterCertificateResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.deregister_certificate_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
