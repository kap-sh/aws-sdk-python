"""Generated from Smithy shape ``com.amazonaws.directoryservice#UpdateTrust``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.update_trust_result.UpdateTrustResult = (
        capo_directory_service.types.update_trust_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.update_trust_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_trust(
    ...
    capo_directory_service.types.update_trust_result.UpdateTrustResult, zapros.Response
]:
