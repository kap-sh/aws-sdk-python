"""Generated from Smithy shape ``com.amazonaws.directoryservice#DeleteLogSubscription``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.delete_log_subscription_result.DeleteLogSubscriptionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.delete_log_subscription_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_log_subscription(
