"""Generated from Smithy shape ``com.amazonaws.directoryservice#GetDirectoryLimits``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.get_directory_limits_result.GetDirectoryLimitsResult = capo_directory_service.types.get_directory_limits_result.deserialize_aws_json_1_1(
...
async def async_get_directory_limits(
