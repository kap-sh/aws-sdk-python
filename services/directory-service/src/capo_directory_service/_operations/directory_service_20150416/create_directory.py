"""Generated from Smithy shape ``com.amazonaws.directoryservice#CreateDirectory``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.create_directory_result.CreateDirectoryResult = (
        capo_directory_service.types.create_directory_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.create_directory_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_directory(
