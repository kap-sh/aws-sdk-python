"""Generated from Smithy shape ``com.amazonaws.directoryservice#CancelSchemaExtension``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.cancel_schema_extension_result.CancelSchemaExtensionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.cancel_schema_extension_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_cancel_schema_extension(
