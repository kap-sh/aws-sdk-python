"""Generated from Smithy shape ``com.amazonaws.directoryservice#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.list_tags_for_resource_result.ListTagsForResourceResult = capo_directory_service.types.list_tags_for_resource_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.list_tags_for_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
