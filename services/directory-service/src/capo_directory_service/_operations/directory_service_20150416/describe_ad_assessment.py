"""Generated from Smithy shape ``com.amazonaws.directoryservice#DescribeADAssessment``."""
...
import capo_directory_service.types.assessment
import capo_directory_service.types.assessment_reports
...
def handle_response(
    ...
    out: capo_directory_service.types.describe_ad_assessment_result.DescribeADAssessmentResult = capo_directory_service.types.describe_ad_assessment_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.DescribeADAssessment"
    body: bytes | None = json.dumps(
        capo_directory_service.types.describe_ad_assessment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_ad_assessment(
