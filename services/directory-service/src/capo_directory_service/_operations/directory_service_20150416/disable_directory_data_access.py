"""Generated from Smithy shape ``com.amazonaws.directoryservice#DisableDirectoryDataAccess``."""
...
import capo_directory_service.errors.directory_in_desired_state_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DirectoryInDesiredStateException":
            raise capo_directory_service.errors.directory_in_desired_state_exception.DirectoryInDesiredStateException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.disable_directory_data_access_result.DisableDirectoryDataAccessResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.DisableDirectoryDataAccess"
    body: bytes | None = json.dumps(
        capo_directory_service.types.disable_directory_data_access_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disable_directory_data_access(
