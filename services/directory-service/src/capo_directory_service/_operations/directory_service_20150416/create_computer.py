"""Generated from Smithy shape ``com.amazonaws.directoryservice#CreateComputer``."""
...
import capo_directory_service.errors.authentication_failed_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AuthenticationFailedException":
            raise capo_directory_service.errors.authentication_failed_exception.AuthenticationFailedException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.create_computer_result.CreateComputerResult = (
        capo_directory_service.types.create_computer_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.create_computer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_computer(
