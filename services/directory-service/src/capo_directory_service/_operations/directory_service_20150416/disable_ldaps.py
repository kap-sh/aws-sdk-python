"""Generated from Smithy shape ``com.amazonaws.directoryservice#DisableLDAPS``."""
...
import capo_directory_service.errors.invalid_ldaps_status_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidLDAPSStatusException":
            raise capo_directory_service.errors.invalid_ldaps_status_exception.InvalidLDAPSStatusException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.disable_ldaps_result.DisableLDAPSResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.disable_ldaps_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
