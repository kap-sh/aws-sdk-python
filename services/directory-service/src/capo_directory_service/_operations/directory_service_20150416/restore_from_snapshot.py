"""Generated from Smithy shape ``com.amazonaws.directoryservice#RestoreFromSnapshot``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.restore_from_snapshot_result.RestoreFromSnapshotResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.restore_from_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
