"""Generated from Smithy shape ``com.amazonaws.directoryservice#CreateLogSubscription``."""
...
import capo_directory_service.errors.insufficient_permissions_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InsufficientPermissionsException":
            raise capo_directory_service.errors.insufficient_permissions_exception.InsufficientPermissionsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.create_log_subscription_result.CreateLogSubscriptionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.create_log_subscription_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_log_subscription(
