"""Generated from Smithy shape ``com.amazonaws.directoryservice#AcceptSharedDirectory``."""
...
import capo_directory_service.errors.directory_already_shared_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DirectoryAlreadySharedException":
            raise capo_directory_service.errors.directory_already_shared_exception.DirectoryAlreadySharedException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.accept_shared_directory_result.AcceptSharedDirectoryResult = capo_directory_service.types.accept_shared_directory_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.accept_shared_directory_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_accept_shared_directory(
