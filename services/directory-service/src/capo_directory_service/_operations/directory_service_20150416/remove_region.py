"""Generated from Smithy shape ``com.amazonaws.directoryservice#RemoveRegion``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.remove_region_result.RemoveRegionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.RemoveRegion"
    body: bytes | None = json.dumps(
        capo_directory_service.types.remove_region_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
