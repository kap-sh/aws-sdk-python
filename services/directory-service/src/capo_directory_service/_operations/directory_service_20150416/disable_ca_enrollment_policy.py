"""Generated from Smithy shape ``com.amazonaws.directoryservice#DisableCAEnrollmentPolicy``."""
...
import capo_directory_service.errors.disable_already_in_progress_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DisableAlreadyInProgressException":
            raise capo_directory_service.errors.disable_already_in_progress_exception.DisableAlreadyInProgressException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.disable_ca_enrollment_policy_result.DisableCAEnrollmentPolicyResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.DisableCAEnrollmentPolicy"
    body: bytes | None = json.dumps(
        capo_directory_service.types.disable_ca_enrollment_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disable_ca_enrollment_policy(
