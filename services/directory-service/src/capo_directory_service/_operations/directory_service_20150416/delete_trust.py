"""Generated from Smithy shape ``com.amazonaws.directoryservice#DeleteTrust``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.delete_trust_result.DeleteTrustResult = (
        capo_directory_service.types.delete_trust_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.delete_trust_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_trust(
    ...
    capo_directory_service.types.delete_trust_result.DeleteTrustResult, zapros.Response
]:
