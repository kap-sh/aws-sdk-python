"""Generated from Smithy shape ``com.amazonaws.directoryservice#DescribeDirectories``."""
...
import capo_directory_service.types.directory_descriptions
...
def handle_response(
    ...
    out: capo_directory_service.types.describe_directories_result.DescribeDirectoriesResult = capo_directory_service.types.describe_directories_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.describe_directories_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_directories(
