"""Generated from Smithy shape ``com.amazonaws.directoryservice#AddRegion``."""
...
import capo_directory_service.errors.directory_already_in_region_exception
import capo_directory_service.errors.directory_does_not_exist_exception
import capo_directory_service.errors.directory_unavailable_exception
import capo_directory_service.errors.entity_does_not_exist_exception
import capo_directory_service.errors.invalid_parameter_exception
import capo_directory_service.errors.region_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DirectoryAlreadyInRegionException":
            raise capo_directory_service.errors.directory_already_in_region_exception.DirectoryAlreadyInRegionException.from_aws_json_1_1(
                data
            )
        ...
        case "DirectoryUnavailableException":
            raise capo_directory_service.errors.directory_unavailable_exception.DirectoryUnavailableException.from_aws_json_1_1(
                data
            )
        case "EntityDoesNotExistException":
            raise capo_directory_service.errors.entity_does_not_exist_exception.EntityDoesNotExistException.from_aws_json_1_1(
                data
            )
        ...
        case "RegionLimitExceededException":
            raise capo_directory_service.errors.region_limit_exceeded_exception.RegionLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.add_region_result.AddRegionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.AddRegion"
    body: bytes | None = json.dumps(
        capo_directory_service.types.add_region_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def add_region(
    ...
    capo_directory_service.types.add_region_result.AddRegionResult, zapros.Response
]:
