"""Generated from Smithy shape ``com.amazonaws.directoryservice#UpdateConditionalForwarder``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.update_conditional_forwarder_result.UpdateConditionalForwarderResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.update_conditional_forwarder_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_conditional_forwarder(
