"""Generated from Smithy shape ``com.amazonaws.directoryservice#DisableRadius``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.disable_radius_result.DisableRadiusResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.disable_radius_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disable_radius(
