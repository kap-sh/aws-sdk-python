"""Generated from Smithy shape ``com.amazonaws.directoryservice#CreateHybridAD``."""
...
import capo_directory_service.errors.ad_assessment_limit_exceeded_exception
import capo_directory_service.errors.client_exception
import capo_directory_service.errors.directory_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ADAssessmentLimitExceededException":
            raise capo_directory_service.errors.ad_assessment_limit_exceeded_exception.ADAssessmentLimitExceededException.from_aws_json_1_1(
                data
            )
        ...
        case "DirectoryLimitExceededException":
            raise capo_directory_service.errors.directory_limit_exceeded_exception.DirectoryLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.create_hybrid_ad_result.CreateHybridADResult = (
        capo_directory_service.types.create_hybrid_ad_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.CreateHybridAD"
    body: bytes | None = json.dumps(
        capo_directory_service.types.create_hybrid_ad_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_hybrid_ad(
