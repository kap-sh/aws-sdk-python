"""Generated from Smithy shape ``com.amazonaws.directoryservice#DescribeDirectoryDataAccess``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.describe_directory_data_access_result.DescribeDirectoryDataAccessResult = capo_directory_service.types.describe_directory_data_access_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.DescribeDirectoryDataAccess"
    body: bytes | None = json.dumps(
        capo_directory_service.types.describe_directory_data_access_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_directory_data_access(
