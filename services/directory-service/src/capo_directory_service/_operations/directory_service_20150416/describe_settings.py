"""Generated from Smithy shape ``com.amazonaws.directoryservice#DescribeSettings``."""
...
import capo_directory_service.types.setting_entries
...
def handle_response(
    ...
    out: capo_directory_service.types.describe_settings_result.DescribeSettingsResult = capo_directory_service.types.describe_settings_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.DescribeSettings"
    body: bytes | None = json.dumps(
        capo_directory_service.types.describe_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_settings(
