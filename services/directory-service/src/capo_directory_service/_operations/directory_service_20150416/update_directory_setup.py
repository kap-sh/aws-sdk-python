...
import capo_directory_service.errors.snapshot_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SnapshotLimitExceededException":
            raise capo_directory_service.errors.snapshot_limit_exceeded_exception.SnapshotLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.update_directory_setup_result.UpdateDirectorySetupResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.update_directory_setup_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
