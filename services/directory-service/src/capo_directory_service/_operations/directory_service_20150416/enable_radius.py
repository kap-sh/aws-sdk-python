"""Generated from Smithy shape ``com.amazonaws.directoryservice#EnableRadius``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.enable_radius_result.EnableRadiusResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.enable_radius_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
