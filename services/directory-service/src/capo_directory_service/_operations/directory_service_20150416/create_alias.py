"""Generated from Smithy shape ``com.amazonaws.directoryservice#CreateAlias``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.create_alias_result.CreateAliasResult = (
        capo_directory_service.types.create_alias_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.create_alias_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_alias(
    ...
    capo_directory_service.types.create_alias_result.CreateAliasResult, zapros.Response
]:
