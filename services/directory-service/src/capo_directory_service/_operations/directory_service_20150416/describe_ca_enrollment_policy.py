"""Generated from Smithy shape ``com.amazonaws.directoryservice#DescribeCAEnrollmentPolicy``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.describe_ca_enrollment_policy_result.DescribeCAEnrollmentPolicyResult = capo_directory_service.types.describe_ca_enrollment_policy_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.DescribeCAEnrollmentPolicy"
    body: bytes | None = json.dumps(
        capo_directory_service.types.describe_ca_enrollment_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_ca_enrollment_policy(
