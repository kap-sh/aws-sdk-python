"""Generated from Smithy shape ``com.amazonaws.directoryservice#ListADAssessments``."""
...
import capo_directory_service.types.assessments
...
def handle_response(
    ...
    out: capo_directory_service.types.list_ad_assessments_result.ListADAssessmentsResult = capo_directory_service.types.list_ad_assessments_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.ListADAssessments"
    body: bytes | None = json.dumps(
        capo_directory_service.types.list_ad_assessments_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_ad_assessments(
