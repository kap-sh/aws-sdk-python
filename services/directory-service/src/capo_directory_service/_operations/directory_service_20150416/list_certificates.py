"""Generated from Smithy shape ``com.amazonaws.directoryservice#ListCertificates``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.list_certificates_result.ListCertificatesResult = capo_directory_service.types.list_certificates_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.list_certificates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
