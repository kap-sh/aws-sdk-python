"""Generated from Smithy shape ``com.amazonaws.directoryservice#DescribeConditionalForwarders``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.describe_conditional_forwarders_result.DescribeConditionalForwardersResult = capo_directory_service.types.describe_conditional_forwarders_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.describe_conditional_forwarders_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_conditional_forwarders(
