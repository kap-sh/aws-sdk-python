"""Generated from Smithy shape ``com.amazonaws.directoryservice#ListSchemaExtensions``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.list_schema_extensions_result.ListSchemaExtensionsResult = capo_directory_service.types.list_schema_extensions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.list_schema_extensions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_schema_extensions(
