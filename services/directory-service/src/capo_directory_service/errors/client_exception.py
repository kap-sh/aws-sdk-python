"""Generated from Smithy shape ``com.amazonaws.directoryservice#ClientException``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ClientException_) -> dict:
    out: dict = {}
    if "message" in value:
...
def deserialize_aws_json_1_1(data: dict) -> ClientException_:
...
class ClientException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.directoryservice#ClientException``."""
