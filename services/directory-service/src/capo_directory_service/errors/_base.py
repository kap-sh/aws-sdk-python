...
class DirectoryServiceError(Exception):
    """Base class for all DirectoryService service errors."""


class ServiceError(DirectoryServiceError):
...
class SerializationError(DirectoryServiceError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DirectoryServiceError):
...
class WaiterFailedError(DirectoryServiceError):
...
class WaiterTimeoutError(DirectoryServiceError):
