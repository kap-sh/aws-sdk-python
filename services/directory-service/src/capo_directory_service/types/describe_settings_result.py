...
class DescribeSettingsResult(TypedDict, closed=True):
    ...
    setting_entries: NotRequired[
        "capo_directory_service.types.setting_entries.SettingEntries"
    ]
...
def serialize_aws_json_1_1(value: DescribeSettingsResult) -> dict:
    ...
    if "setting_entries" in value:
        ...
        out["SettingEntries"] = (
            capo_directory_service.types.setting_entries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeSettingsResult:
    ...
    if "SettingEntries" in data:
        ...
        out["setting_entries"] = (
            capo_directory_service.types.setting_entries.deserialize_aws_json_1_1(
                data["SettingEntries"]
            )
        )
