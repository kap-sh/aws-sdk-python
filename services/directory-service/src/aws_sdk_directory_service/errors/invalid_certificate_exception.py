"""Generated from Smithy shape ``com.amazonaws.directoryservice#InvalidCertificateException``."""
...
class InvalidCertificateException_(TypedDict, closed=True):
    message: NotRequired[
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: InvalidCertificateException_) -> dict:
    out: dict = {}
    if "message" in value:
...
class InvalidCertificateException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.directoryservice#InvalidCertificateException``."""
