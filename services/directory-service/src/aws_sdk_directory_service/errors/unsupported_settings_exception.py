...
class UnsupportedSettingsException_(TypedDict):
    message: NotRequired[
...
class UnsupportedSettingsException(ServiceError):
    ...
    def __init__(self, data: UnsupportedSettingsException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "UnsupportedSettingsException":
