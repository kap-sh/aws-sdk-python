"""Generated from Smithy shape ``com.amazonaws.directoryservice#InvalidNextTokenException``."""
...
class InvalidNextTokenException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.directoryservice#InvalidNextTokenException``."""
