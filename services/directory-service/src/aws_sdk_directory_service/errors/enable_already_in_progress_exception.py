...
class EnableAlreadyInProgressException_(TypedDict):
    message: NotRequired[
...
class EnableAlreadyInProgressException(ServiceError):
    ...
    def __init__(self, data: EnableAlreadyInProgressException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "EnableAlreadyInProgressException":
