...
from ._services.async_directory_service import (
    AsyncDirectoryServiceClient as AsyncDirectoryServiceClient,
)
from ._services.directory_service import (
    DirectoryServiceClient as DirectoryServiceClient,
)
