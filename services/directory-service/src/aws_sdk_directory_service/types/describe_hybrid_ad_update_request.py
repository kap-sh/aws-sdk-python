...
class DescribeHybridADUpdateRequest(TypedDict):
...
def serialize_aws_json_1_1(value: DescribeHybridADUpdateRequest) -> dict:
    ...
    if "update_type" in value:
        ...
        out["UpdateType"] = (
            aws_sdk_directory_service.types.hybrid_update_type.serialize_aws_json_1_1(
                value["update_type"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeHybridADUpdateRequest:
    ...
    if "UpdateType" in data:
        ...
        out["update_type"] = (
            aws_sdk_directory_service.types.hybrid_update_type.deserialize_aws_json_1_1(
                data["UpdateType"]
            )
        )
