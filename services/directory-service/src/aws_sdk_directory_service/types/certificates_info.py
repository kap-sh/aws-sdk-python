...
CertificatesInfo: TypeAlias = list[
    "aws_sdk_directory_service.types.certificate_info.CertificateInfo"
]
...
def serialize_aws_json_1_1(value: CertificatesInfo) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_directory_service.types.certificate_info.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> CertificatesInfo:
    ...
    for item in data:
        out.append(
            aws_sdk_directory_service.types.certificate_info.deserialize_aws_json_1_1(
                item
            )
        )
    return out
