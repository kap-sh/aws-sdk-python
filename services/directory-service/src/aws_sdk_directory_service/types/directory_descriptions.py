...
DirectoryDescriptions: TypeAlias = list[
    "aws_sdk_directory_service.types.directory_description.DirectoryDescription"
]
...
def serialize_aws_json_1_1(value: DirectoryDescriptions) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_directory_service.types.directory_description.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> DirectoryDescriptions:
    ...
    for item in data:
        out.append(
            aws_sdk_directory_service.types.directory_description.deserialize_aws_json_1_1(
                item
            )
        )
    return out
