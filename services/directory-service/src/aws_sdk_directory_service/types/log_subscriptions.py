...
LogSubscriptions: TypeAlias = list[
    "aws_sdk_directory_service.types.log_subscription.LogSubscription"
]
...
def serialize_aws_json_1_1(value: LogSubscriptions) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_directory_service.types.log_subscription.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> LogSubscriptions:
    ...
    for item in data:
        out.append(
            aws_sdk_directory_service.types.log_subscription.deserialize_aws_json_1_1(
                item
            )
        )
    return out
