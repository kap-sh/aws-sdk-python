...
class RemoveIpRoutesRequest(TypedDict):
    ...
    cidr_ipv6s: NotRequired["aws_sdk_directory_service.types.cidr_ipv6s.CidrIpv6s"]
...
def serialize_aws_json_1_1(value: RemoveIpRoutesRequest) -> dict:
    ...
    out["CidrIps"] = aws_sdk_directory_service.types.cidr_ips.serialize_aws_json_1_1(
        value.get("cidr_ips", [])
    )
    if "cidr_ipv6s" in value:
        ...
        out["CidrIpv6s"] = (
            aws_sdk_directory_service.types.cidr_ipv6s.serialize_aws_json_1_1(
                value["cidr_ipv6s"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> RemoveIpRoutesRequest:
    ...
    if "CidrIps" in data:
        ...
        out["cidr_ips"] = (
            aws_sdk_directory_service.types.cidr_ips.deserialize_aws_json_1_1(
                data["CidrIps"]
            )
        )
    else:
    ...
    if "CidrIpv6s" in data:
        ...
        out["cidr_ipv6s"] = (
            aws_sdk_directory_service.types.cidr_ipv6s.deserialize_aws_json_1_1(
                data["CidrIpv6s"]
            )
        )
    return out
