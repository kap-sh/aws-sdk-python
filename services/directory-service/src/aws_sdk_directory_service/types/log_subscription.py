...
if TYPE_CHECKING:
    ...
    import aws_sdk_directory_service.types.subscription_created_date_time


class LogSubscription(TypedDict):
    ...
    log_group_name: NotRequired[
        "aws_sdk_directory_service.types.log_group_name.LogGroupName"
    ]
    """<p>The name of the log group.</p>"""
    subscription_created_date_time: NotRequired[
        "aws_sdk_directory_service.types.subscription_created_date_time.SubscriptionCreatedDateTime"
    ]
...
def serialize_aws_json_1_1(value: LogSubscription) -> dict:
    ...
    if "subscription_created_date_time" in value:
        ...
        out["SubscriptionCreatedDateTime"] = (
            aws_sdk_directory_service.types.subscription_created_date_time.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> LogSubscription:
    ...
    if "SubscriptionCreatedDateTime" in data:
        ...
        out["subscription_created_date_time"] = (
            aws_sdk_directory_service.types.subscription_created_date_time.deserialize_aws_json_1_1(
