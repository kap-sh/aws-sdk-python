...
if TYPE_CHECKING:
    import aws_sdk_directory_service.types.added_date_time
    ...
    import aws_sdk_directory_service.types.ip_route_status_msg
    import aws_sdk_directory_service.types.ip_route_status_reason


class IpRouteInfo(TypedDict):
    ...
    ip_route_status_msg: NotRequired[
        "aws_sdk_directory_service.types.ip_route_status_msg.IpRouteStatusMsg"
    ]
    """<p>The status of the IP address block.</p>"""
    added_date_time: NotRequired[
        "aws_sdk_directory_service.types.added_date_time.AddedDateTime"
    ]
    """<p>The date and time the address block was added to the directory.</p>"""
    ip_route_status_reason: NotRequired[
        "aws_sdk_directory_service.types.ip_route_status_reason.IpRouteStatusReason"
    ]
...
def serialize_aws_json_1_1(value: IpRouteInfo) -> dict:
    ...
    if "ip_route_status_msg" in value:
        ...
        out["IpRouteStatusMsg"] = (
            aws_sdk_directory_service.types.ip_route_status_msg.serialize_aws_json_1_1(
    ...
    if "added_date_time" in value:
        ...
        out["AddedDateTime"] = (
            aws_sdk_directory_service.types.added_date_time.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> IpRouteInfo:
    ...
    if "IpRouteStatusMsg" in data:
        ...
        out["ip_route_status_msg"] = (
            aws_sdk_directory_service.types.ip_route_status_msg.deserialize_aws_json_1_1(
    ...
    if "AddedDateTime" in data:
        ...
        out["added_date_time"] = (
            aws_sdk_directory_service.types.added_date_time.deserialize_aws_json_1_1(
                data["AddedDateTime"]
            )
        )
