...
if TYPE_CHECKING:
    import aws_sdk_directory_service.types.access_url
    ...
    import aws_sdk_directory_service.types.directory_connect_settings_description
    ...
    import aws_sdk_directory_service.types.directory_type
    ...
    import aws_sdk_directory_service.types.hybrid_settings_description
    ...
    import aws_sdk_directory_service.types.owner_directory_description
    import aws_sdk_directory_service.types.radius_settings
    import aws_sdk_directory_service.types.radius_status
    import aws_sdk_directory_service.types.regions_info
    import aws_sdk_directory_service.types.share_method
    import aws_sdk_directory_service.types.share_status
    import aws_sdk_directory_service.types.sso_enabled
    import aws_sdk_directory_service.types.stage_reason


class DirectoryDescription(TypedDict):
    directory_id: NotRequired[
        "aws_sdk_directory_service.types.directory_id.DirectoryId"
    ]
    """<p>The directory identifier.</p>"""
    name: NotRequired["aws_sdk_directory_service.types.directory_name.DirectoryName"]
    ...
    size: NotRequired["aws_sdk_directory_service.types.directory_size.DirectorySize"]
    ...
    access_url: NotRequired["aws_sdk_directory_service.types.access_url.AccessUrl"]
    ...
    stage: NotRequired["aws_sdk_directory_service.types.directory_stage.DirectoryStage"]
    ...
    type: NotRequired["aws_sdk_directory_service.types.directory_type.DirectoryType"]
    ...
    connect_settings: NotRequired[
        "aws_sdk_directory_service.types.directory_connect_settings_description.DirectoryConnectSettingsDescription"
    ]
    ...
    stage_reason: NotRequired[
        "aws_sdk_directory_service.types.stage_reason.StageReason"
    ]
    """<p>Additional information about the directory stage.</p>"""
    sso_enabled: "aws_sdk_directory_service.types.sso_enabled.SsoEnabled"
    ...
    owner_directory_description: NotRequired[
        "aws_sdk_directory_service.types.owner_directory_description.OwnerDirectoryDescription"
    ]
    """<p>Describes the Managed Microsoft AD directory in the directory owner account.</p>"""
    regions_info: NotRequired[
        "aws_sdk_directory_service.types.regions_info.RegionsInfo"
    ]
    ...
    hybrid_settings: NotRequired[
        "aws_sdk_directory_service.types.hybrid_settings_description.HybridSettingsDescription"
    ]
...
def serialize_aws_json_1_1(value: DirectoryDescription) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = (
            aws_sdk_directory_service.types.directory_type.serialize_aws_json_1_1(
                value["type"]
            )
        )
    ...
    if "connect_settings" in value:
        ...
        out["ConnectSettings"] = (
            aws_sdk_directory_service.types.directory_connect_settings_description.serialize_aws_json_1_1(
    ...
    if "owner_directory_description" in value:
        ...
        out["OwnerDirectoryDescription"] = (
            aws_sdk_directory_service.types.owner_directory_description.serialize_aws_json_1_1(
    ...
    if "regions_info" in value:
        ...
        out["RegionsInfo"] = (
            aws_sdk_directory_service.types.regions_info.serialize_aws_json_1_1(
                value["regions_info"]
            )
        )
    ...
    if "hybrid_settings" in value:
        ...
        out["HybridSettings"] = (
            aws_sdk_directory_service.types.hybrid_settings_description.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DirectoryDescription:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_directory_service.types.directory_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    ...
    if "ConnectSettings" in data:
        ...
        out["connect_settings"] = (
            aws_sdk_directory_service.types.directory_connect_settings_description.deserialize_aws_json_1_1(
    ...
    if "OwnerDirectoryDescription" in data:
        ...
        out["owner_directory_description"] = (
            aws_sdk_directory_service.types.owner_directory_description.deserialize_aws_json_1_1(
    ...
    if "RegionsInfo" in data:
        ...
        out["regions_info"] = (
            aws_sdk_directory_service.types.regions_info.deserialize_aws_json_1_1(
                data["RegionsInfo"]
            )
        )
    ...
    if "HybridSettings" in data:
        ...
        out["hybrid_settings"] = (
            aws_sdk_directory_service.types.hybrid_settings_description.deserialize_aws_json_1_1(
                data["HybridSettings"]
            )
        )
