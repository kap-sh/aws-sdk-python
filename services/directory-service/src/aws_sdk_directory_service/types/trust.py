...
if TYPE_CHECKING:
    ...
    import aws_sdk_directory_service.types.trust_state
    import aws_sdk_directory_service.types.trust_state_reason
...
class Trust(TypedDict, closed=True):
    ...
    trust_direction: NotRequired[
        "aws_sdk_directory_service.types.trust_direction.TrustDirection"
    ]
    """<p>The trust relationship direction.</p>"""
    trust_state: NotRequired["aws_sdk_directory_service.types.trust_state.TrustState"]
    ...
    trust_state_reason: NotRequired[
        "aws_sdk_directory_service.types.trust_state_reason.TrustStateReason"
    ]
...
def serialize_aws_json_1_1(value: Trust) -> dict:
    ...
    if "trust_state" in value:
        ...
        out["TrustState"] = (
            aws_sdk_directory_service.types.trust_state.serialize_aws_json_1_1(
                value["trust_state"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> Trust:
    ...
    if "TrustState" in data:
        ...
        out["trust_state"] = (
            aws_sdk_directory_service.types.trust_state.deserialize_aws_json_1_1(
                data["TrustState"]
            )
        )
