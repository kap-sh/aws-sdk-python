"""Generated from Smithy shape ``com.amazonaws.directoryservice#RegisterEventTopic``."""
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.register_event_topic_result.RegisterEventTopicResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.register_event_topic_request.RegisterEventTopicRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.register_event_topic_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_register_event_topic(
