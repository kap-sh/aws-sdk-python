"""Generated from Smithy shape ``com.amazonaws.directoryservice#DeleteADAssessment``."""
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.delete_ad_assessment_result.DeleteADAssessmentResult = aws_sdk_directory_service.types.delete_ad_assessment_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.delete_ad_assessment_request.DeleteADAssessmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.DeleteADAssessment"
    import aws_sdk_directory_service.types.delete_ad_assessment_request

    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.delete_ad_assessment_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_ad_assessment(
