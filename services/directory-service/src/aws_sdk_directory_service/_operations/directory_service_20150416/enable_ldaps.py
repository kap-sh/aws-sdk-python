...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.enable_ldaps_result.EnableLDAPSResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.enable_ldaps_request.EnableLDAPSRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.enable_ldaps_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
