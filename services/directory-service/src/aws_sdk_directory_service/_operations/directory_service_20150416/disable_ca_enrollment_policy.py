...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DisableAlreadyInProgressException":
            import aws_sdk_directory_service.errors.disable_already_in_progress_exception

            raise aws_sdk_directory_service.errors.disable_already_in_progress_exception.DisableAlreadyInProgressException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.disable_ca_enrollment_policy_result.DisableCAEnrollmentPolicyResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.disable_ca_enrollment_policy_request.DisableCAEnrollmentPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.disable_ca_enrollment_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
