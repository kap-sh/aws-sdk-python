...
import aws_sdk_directory_service.errors.directory_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DirectoryLimitExceededException":
            raise aws_sdk_directory_service.errors.directory_limit_exceeded_exception.DirectoryLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.create_microsoft_ad_result.CreateMicrosoftADResult = aws_sdk_directory_service.types.create_microsoft_ad_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.create_microsoft_ad_request.CreateMicrosoftADRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.create_microsoft_ad_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
