...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IpRouteLimitExceededException":
            import aws_sdk_directory_service.errors.ip_route_limit_exceeded_exception

            raise aws_sdk_directory_service.errors.ip_route_limit_exceeded_exception.IpRouteLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.add_ip_routes_result.AddIpRoutesResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.add_ip_routes_request.AddIpRoutesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.add_ip_routes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
