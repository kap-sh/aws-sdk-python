...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.describe_trusts_result.DescribeTrustsResult = (
        aws_sdk_directory_service.types.describe_trusts_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.describe_trusts_request.DescribeTrustsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.describe_trusts_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
