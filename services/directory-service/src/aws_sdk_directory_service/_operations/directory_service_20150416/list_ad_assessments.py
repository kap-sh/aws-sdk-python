...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.list_ad_assessments_result.ListADAssessmentsResult = aws_sdk_directory_service.types.list_ad_assessments_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.list_ad_assessments_request.ListADAssessmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.list_ad_assessments_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
