...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.create_computer_result.CreateComputerResult = (
        aws_sdk_directory_service.types.create_computer_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.create_computer_request.CreateComputerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.create_computer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
