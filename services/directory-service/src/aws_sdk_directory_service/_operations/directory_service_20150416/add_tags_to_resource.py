...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TagLimitExceededException":
            import aws_sdk_directory_service.errors.tag_limit_exceeded_exception

            raise aws_sdk_directory_service.errors.tag_limit_exceeded_exception.TagLimitExceededException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.add_tags_to_resource_result.AddTagsToResourceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.add_tags_to_resource_request.AddTagsToResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.add_tags_to_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
