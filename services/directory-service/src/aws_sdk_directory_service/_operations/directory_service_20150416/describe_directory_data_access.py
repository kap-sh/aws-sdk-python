...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.describe_directory_data_access_result.DescribeDirectoryDataAccessResult = aws_sdk_directory_service.types.describe_directory_data_access_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.describe_directory_data_access_request.DescribeDirectoryDataAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.describe_directory_data_access_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
