...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DirectoryAlreadyInRegionException":
            import aws_sdk_directory_service.errors.directory_already_in_region_exception

            raise aws_sdk_directory_service.errors.directory_already_in_region_exception.DirectoryAlreadyInRegionException.from_aws_json_1_1(
                data
            )
        ...
        case "RegionLimitExceededException":
            import aws_sdk_directory_service.errors.region_limit_exceeded_exception

            raise aws_sdk_directory_service.errors.region_limit_exceeded_exception.RegionLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.add_region_result.AddRegionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_directory_service.types.add_region_request.AddRegionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.add_region_request.serialize_aws_json_1_1(input)
    ).encode()
...
def add_region(
    ...
    aws_sdk_directory_service.types.add_region_result.AddRegionResult, zapros.Response
]:
