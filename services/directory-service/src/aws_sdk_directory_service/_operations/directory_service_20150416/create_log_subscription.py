...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.create_log_subscription_result.CreateLogSubscriptionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.create_log_subscription_request.CreateLogSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.create_log_subscription_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
