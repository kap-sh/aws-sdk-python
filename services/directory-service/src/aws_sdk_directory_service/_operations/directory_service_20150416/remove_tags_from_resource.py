...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.remove_tags_from_resource_result.RemoveTagsFromResourceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.remove_tags_from_resource_request.RemoveTagsFromResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.remove_tags_from_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
