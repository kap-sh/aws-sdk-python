"""Generated from Smithy shape ``com.amazonaws.directoryservice#DisableClientAuthentication``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidClientAuthStatusException":
            import aws_sdk_directory_service.errors.invalid_client_auth_status_exception

            raise aws_sdk_directory_service.errors.invalid_client_auth_status_exception.InvalidClientAuthStatusException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.disable_client_authentication_result.DisableClientAuthenticationResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.disable_client_authentication_request.DisableClientAuthenticationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.DisableClientAuthentication"
    import aws_sdk_directory_service.types.disable_client_authentication_request

    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.disable_client_authentication_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disable_client_authentication(
