...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.create_alias_result.CreateAliasResult = (
        aws_sdk_directory_service.types.create_alias_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.create_alias_request.CreateAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.create_alias_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
