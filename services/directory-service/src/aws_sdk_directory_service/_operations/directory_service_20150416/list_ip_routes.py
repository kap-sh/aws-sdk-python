...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.list_ip_routes_result.ListIpRoutesResult = (
        aws_sdk_directory_service.types.list_ip_routes_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.list_ip_routes_request.ListIpRoutesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.list_ip_routes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
