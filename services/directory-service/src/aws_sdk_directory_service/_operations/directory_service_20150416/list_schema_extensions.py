...
import aws_sdk_directory_service.types.schema_extensions_info
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.list_schema_extensions_result.ListSchemaExtensionsResult = aws_sdk_directory_service.types.list_schema_extensions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.list_schema_extensions_request.ListSchemaExtensionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.list_schema_extensions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
