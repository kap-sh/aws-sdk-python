...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidLDAPSStatusException":
            import aws_sdk_directory_service.errors.invalid_ldaps_status_exception

            raise aws_sdk_directory_service.errors.invalid_ldaps_status_exception.InvalidLDAPSStatusException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.disable_ldaps_result.DisableLDAPSResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.disable_ldaps_request.DisableLDAPSRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.disable_ldaps_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
