...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.list_certificates_result.ListCertificatesResult = aws_sdk_directory_service.types.list_certificates_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.list_certificates_request.ListCertificatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.list_certificates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
