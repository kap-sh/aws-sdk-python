...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DomainControllerLimitExceededException":
            import aws_sdk_directory_service.errors.domain_controller_limit_exceeded_exception

            raise aws_sdk_directory_service.errors.domain_controller_limit_exceeded_exception.DomainControllerLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.update_number_of_domain_controllers_result.UpdateNumberOfDomainControllersResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.update_number_of_domain_controllers_request.UpdateNumberOfDomainControllersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
