...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.describe_conditional_forwarders_result.DescribeConditionalForwardersResult = aws_sdk_directory_service.types.describe_conditional_forwarders_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.describe_conditional_forwarders_request.DescribeConditionalForwardersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.describe_conditional_forwarders_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
