...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.create_hybrid_ad_result.CreateHybridADResult = aws_sdk_directory_service.types.create_hybrid_ad_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.create_hybrid_ad_request.CreateHybridADRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.create_hybrid_ad_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
