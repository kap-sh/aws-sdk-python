"""Generated from Smithy shape ``com.amazonaws.directoryservice#UpdateSettings``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IncompatibleSettingsException":
            import aws_sdk_directory_service.errors.incompatible_settings_exception

            raise aws_sdk_directory_service.errors.incompatible_settings_exception.IncompatibleSettingsException.from_aws_json_1_1(
                data
            )
        ...
        case "UnsupportedSettingsException":
            import aws_sdk_directory_service.errors.unsupported_settings_exception

            raise aws_sdk_directory_service.errors.unsupported_settings_exception.UnsupportedSettingsException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.update_settings_result.UpdateSettingsResult = (
        aws_sdk_directory_service.types.update_settings_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.update_settings_request.UpdateSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.UpdateSettings"
    import aws_sdk_directory_service.types.update_settings_request

    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.update_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
