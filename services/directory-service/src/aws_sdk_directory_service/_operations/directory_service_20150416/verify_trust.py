...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.verify_trust_result.VerifyTrustResult = (
        aws_sdk_directory_service.types.verify_trust_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.verify_trust_request.VerifyTrustRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.verify_trust_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
