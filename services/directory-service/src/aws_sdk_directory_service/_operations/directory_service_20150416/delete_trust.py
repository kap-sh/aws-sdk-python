...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.delete_trust_result.DeleteTrustResult = (
        aws_sdk_directory_service.types.delete_trust_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.delete_trust_request.DeleteTrustRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.delete_trust_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
