...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.describe_ca_enrollment_policy_result.DescribeCAEnrollmentPolicyResult = aws_sdk_directory_service.types.describe_ca_enrollment_policy_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.describe_ca_enrollment_policy_request.DescribeCAEnrollmentPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.describe_ca_enrollment_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
