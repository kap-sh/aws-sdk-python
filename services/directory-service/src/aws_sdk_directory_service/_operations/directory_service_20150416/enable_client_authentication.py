...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoAvailableCertificateException":
            import aws_sdk_directory_service.errors.no_available_certificate_exception

            raise aws_sdk_directory_service.errors.no_available_certificate_exception.NoAvailableCertificateException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.enable_client_authentication_result.EnableClientAuthenticationResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.enable_client_authentication_request.EnableClientAuthenticationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.enable_client_authentication_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
