...
import aws_sdk_directory_service.errors.invalid_password_exception
...
import aws_sdk_directory_service.errors.user_does_not_exist_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPasswordException":
            raise aws_sdk_directory_service.errors.invalid_password_exception.InvalidPasswordException.from_aws_json_1_1(
                data
            )
        ...
        case "UserDoesNotExistException":
            raise aws_sdk_directory_service.errors.user_does_not_exist_exception.UserDoesNotExistException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.reset_user_password_result.ResetUserPasswordResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.reset_user_password_request.ResetUserPasswordRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.reset_user_password_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
