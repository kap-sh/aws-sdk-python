"""Generated from Smithy shape ``com.amazonaws.directoryservice#DescribeLDAPSSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.describe_ldaps_settings_result.DescribeLDAPSSettingsResult = aws_sdk_directory_service.types.describe_ldaps_settings_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.describe_ldaps_settings_request.DescribeLDAPSSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.describe_ldaps_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_ldaps_settings(
