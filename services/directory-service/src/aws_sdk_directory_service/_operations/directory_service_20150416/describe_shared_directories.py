"""Generated from Smithy shape ``com.amazonaws.directoryservice#DescribeSharedDirectories``."""
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.describe_shared_directories_result.DescribeSharedDirectoriesResult = aws_sdk_directory_service.types.describe_shared_directories_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.describe_shared_directories_request.DescribeSharedDirectoriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.describe_shared_directories_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_shared_directories(
