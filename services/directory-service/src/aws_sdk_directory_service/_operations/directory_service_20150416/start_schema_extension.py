"""Generated from Smithy shape ``com.amazonaws.directoryservice#StartSchemaExtension``."""
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.start_schema_extension_result.StartSchemaExtensionResult = aws_sdk_directory_service.types.start_schema_extension_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.start_schema_extension_request.StartSchemaExtensionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.start_schema_extension_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_schema_extension(
