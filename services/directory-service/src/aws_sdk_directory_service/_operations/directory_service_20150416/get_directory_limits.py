...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.get_directory_limits_result.GetDirectoryLimitsResult = aws_sdk_directory_service.types.get_directory_limits_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.get_directory_limits_request.GetDirectoryLimitsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
