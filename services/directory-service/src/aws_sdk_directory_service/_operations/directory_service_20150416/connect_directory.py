...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.connect_directory_result.ConnectDirectoryResult = aws_sdk_directory_service.types.connect_directory_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.connect_directory_request.ConnectDirectoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.connect_directory_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
