...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.restore_from_snapshot_result.RestoreFromSnapshotResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.restore_from_snapshot_request.RestoreFromSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.restore_from_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
