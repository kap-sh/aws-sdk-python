...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.remove_region_result.RemoveRegionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.remove_region_request.RemoveRegionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.remove_region_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
