...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.disable_sso_result.DisableSsoResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.disable_sso_request.DisableSsoRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.disable_sso_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
def disable_sso(
    ...
    aws_sdk_directory_service.types.disable_sso_result.DisableSsoResult, zapros.Response
]:
