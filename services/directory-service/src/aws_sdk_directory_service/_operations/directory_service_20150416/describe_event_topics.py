"""Generated from Smithy shape ``com.amazonaws.directoryservice#DescribeEventTopics``."""
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.describe_event_topics_result.DescribeEventTopicsResult = aws_sdk_directory_service.types.describe_event_topics_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.describe_event_topics_request.DescribeEventTopicsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.describe_event_topics_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_event_topics(
