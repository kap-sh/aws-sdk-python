"""Generated from Smithy shape ``com.amazonaws.directoryservice#DeleteDirectory``."""
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.delete_directory_result.DeleteDirectoryResult = aws_sdk_directory_service.types.delete_directory_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.delete_directory_request.DeleteDirectoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.delete_directory_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
