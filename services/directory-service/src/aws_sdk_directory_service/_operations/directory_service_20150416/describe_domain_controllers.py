...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.describe_domain_controllers_result.DescribeDomainControllersResult = aws_sdk_directory_service.types.describe_domain_controllers_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.describe_domain_controllers_request.DescribeDomainControllersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.describe_domain_controllers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
