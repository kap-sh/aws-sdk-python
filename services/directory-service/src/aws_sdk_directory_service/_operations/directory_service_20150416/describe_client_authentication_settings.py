...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.describe_client_authentication_settings_result.DescribeClientAuthenticationSettingsResult = aws_sdk_directory_service.types.describe_client_authentication_settings_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.describe_client_authentication_settings_request.DescribeClientAuthenticationSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.describe_client_authentication_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
