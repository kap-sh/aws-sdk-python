"""Generated from Smithy shape ``com.amazonaws.directoryservice#DescribeHybridADUpdate``."""
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.describe_hybrid_ad_update_result.DescribeHybridADUpdateResult = aws_sdk_directory_service.types.describe_hybrid_ad_update_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.describe_hybrid_ad_update_request.DescribeHybridADUpdateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.DescribeHybridADUpdate"
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.describe_hybrid_ad_update_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_hybrid_ad_update(
