"""Generated from Smithy shape ``com.amazonaws.directoryservice#EnableCAEnrollmentPolicy``."""
...
import aws_sdk_directory_service.errors.enable_already_in_progress_exception
import aws_sdk_directory_service.errors.entity_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EnableAlreadyInProgressException":
            raise aws_sdk_directory_service.errors.enable_already_in_progress_exception.EnableAlreadyInProgressException.from_aws_json_1_1(
                data
            )
        case "EntityAlreadyExistsException":
            raise aws_sdk_directory_service.errors.entity_already_exists_exception.EntityAlreadyExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.enable_ca_enrollment_policy_result.EnableCAEnrollmentPolicyResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.enable_ca_enrollment_policy_request.EnableCAEnrollmentPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.EnableCAEnrollmentPolicy"
    import aws_sdk_directory_service.types.enable_ca_enrollment_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.enable_ca_enrollment_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_enable_ca_enrollment_policy(
