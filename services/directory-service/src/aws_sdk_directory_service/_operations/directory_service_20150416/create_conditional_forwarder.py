"""Generated from Smithy shape ``com.amazonaws.directoryservice#CreateConditionalForwarder``."""
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.create_conditional_forwarder_result.CreateConditionalForwarderResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.create_conditional_forwarder_request.CreateConditionalForwarderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.create_conditional_forwarder_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_conditional_forwarder(
