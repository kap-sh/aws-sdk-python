"""Generated from Smithy shape ``com.amazonaws.directoryservice#EnableSso``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AuthenticationFailedException":
            import aws_sdk_directory_service.errors.authentication_failed_exception

            raise aws_sdk_directory_service.errors.authentication_failed_exception.AuthenticationFailedException.from_aws_json_1_1(
                data
            )
        ...
        case "InsufficientPermissionsException":
            import aws_sdk_directory_service.errors.insufficient_permissions_exception

            raise aws_sdk_directory_service.errors.insufficient_permissions_exception.InsufficientPermissionsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.enable_sso_result.EnableSsoResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_directory_service.types.enable_sso_request.EnableSsoRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.enable_sso_request.serialize_aws_json_1_1(input)
    ).encode()
...
def enable_sso(
    ...
    aws_sdk_directory_service.types.enable_sso_result.EnableSsoResult, zapros.Response
]:
