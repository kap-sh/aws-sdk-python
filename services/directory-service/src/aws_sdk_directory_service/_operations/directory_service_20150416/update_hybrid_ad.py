"""Generated from Smithy shape ``com.amazonaws.directoryservice#UpdateHybridAD``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ADAssessmentLimitExceededException":
            import aws_sdk_directory_service.errors.ad_assessment_limit_exceeded_exception

            raise aws_sdk_directory_service.errors.ad_assessment_limit_exceeded_exception.ADAssessmentLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.update_hybrid_ad_result.UpdateHybridADResult = aws_sdk_directory_service.types.update_hybrid_ad_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.update_hybrid_ad_request.UpdateHybridADRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.UpdateHybridAD"
    import aws_sdk_directory_service.types.update_hybrid_ad_request

    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.update_hybrid_ad_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_hybrid_ad(
