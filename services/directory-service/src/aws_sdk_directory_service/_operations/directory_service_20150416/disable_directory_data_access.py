...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.disable_directory_data_access_result.DisableDirectoryDataAccessResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.disable_directory_data_access_request.DisableDirectoryDataAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.disable_directory_data_access_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
