...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.describe_regions_result.DescribeRegionsResult = aws_sdk_directory_service.types.describe_regions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.describe_regions_request.DescribeRegionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.describe_regions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
