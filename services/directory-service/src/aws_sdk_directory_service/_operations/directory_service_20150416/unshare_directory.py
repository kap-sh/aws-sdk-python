...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DirectoryNotSharedException":
            import aws_sdk_directory_service.errors.directory_not_shared_exception

            raise aws_sdk_directory_service.errors.directory_not_shared_exception.DirectoryNotSharedException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_directory_service.types.unshare_directory_result.UnshareDirectoryResult = aws_sdk_directory_service.types.unshare_directory_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_directory_service.types.unshare_directory_request.UnshareDirectoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_directory_service.types.unshare_directory_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
