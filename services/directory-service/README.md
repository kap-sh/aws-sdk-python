...
```
pip install aws-sdk-directory-service
```

## Usage

```python
from aws_sdk_directory_service import AsyncDirectoryServiceClient
...
```python
from aws_sdk_directory_service import AsyncDirectoryServiceClient
from aws_sdk_directory_service.error import ClientException
