...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.list_groups_output.ListGroupsOutput = (
        aws_sdk_resource_groups.types.list_groups_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.list_groups_input.ListGroupsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.list_groups_input.serialize_json(input_)
    ).encode()
...
def list_groups(
    ...
    aws_sdk_resource_groups.types.list_groups_output.ListGroupsOutput, zapros.Response
]:
