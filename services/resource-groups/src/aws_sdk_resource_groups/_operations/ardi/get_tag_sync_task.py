...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.get_tag_sync_task_output.GetTagSyncTaskOutput = (
        aws_sdk_resource_groups.types.get_tag_sync_task_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.get_tag_sync_task_input.GetTagSyncTaskInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.get_tag_sync_task_input.serialize_json(input_)
    ).encode()
