"""Generated from Smithy shape ``com.amazonaws.resourcegroups#GetAccountSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.get_account_settings_output.GetAccountSettingsOutput = aws_sdk_resource_groups.types.get_account_settings_output.deserialize_json(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/get-account-settings"
    params: dict[str, str] = {}
