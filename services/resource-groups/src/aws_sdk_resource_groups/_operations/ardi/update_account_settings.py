"""Generated from Smithy shape ``com.amazonaws.resourcegroups#UpdateAccountSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.update_account_settings_output.UpdateAccountSettingsOutput = aws_sdk_resource_groups.types.update_account_settings_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.update_account_settings_input.UpdateAccountSettingsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/update-account-settings"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resource_groups.types.update_account_settings_input

    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.update_account_settings_input.serialize_json(
            input_
        )
    ).encode()
