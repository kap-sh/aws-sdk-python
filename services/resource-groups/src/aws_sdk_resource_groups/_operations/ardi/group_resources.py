...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.group_resources_output.GroupResourcesOutput = (
        aws_sdk_resource_groups.types.group_resources_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.group_resources_input.GroupResourcesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.group_resources_input.serialize_json(input_)
    ).encode()
