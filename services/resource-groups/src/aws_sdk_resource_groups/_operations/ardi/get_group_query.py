...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.get_group_query_output.GetGroupQueryOutput = (
        aws_sdk_resource_groups.types.get_group_query_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_resource_groups.types.get_group_query_input.GetGroupQueryInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.get_group_query_input.serialize_json(input)
    ).encode()
