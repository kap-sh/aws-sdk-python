...
def build_request(
    ...
    input: aws_sdk_resource_groups.types.update_group_query_input.UpdateGroupQueryInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.update_group_query_input.serialize_json(input)
    ).encode()
