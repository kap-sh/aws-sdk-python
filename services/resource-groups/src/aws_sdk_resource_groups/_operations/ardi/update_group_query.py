...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.update_group_query_output.UpdateGroupQueryOutput = aws_sdk_resource_groups.types.update_group_query_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.update_group_query_input.UpdateGroupQueryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.update_group_query_input.serialize_json(input_)
    ).encode()
