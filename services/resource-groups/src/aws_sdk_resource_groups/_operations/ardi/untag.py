"""Generated from Smithy shape ``com.amazonaws.resourcegroups#Untag``."""
...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.untag_output.UntagOutput = (
        aws_sdk_resource_groups.types.untag_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.untag_input.UntagInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.untag_input.serialize_json(input_)
    ).encode()
...
def untag(
    ...
    input_: aws_sdk_resource_groups.types.untag_input.UntagInput,
) -> tuple[aws_sdk_resource_groups.types.untag_output.UntagOutput, zapros.Response]:
