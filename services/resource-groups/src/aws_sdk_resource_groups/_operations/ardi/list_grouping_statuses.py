...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.list_grouping_statuses_input.ListGroupingStatusesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.list_grouping_statuses_input.serialize_json(
            input_
        )
    ).encode()
