...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.list_grouping_statuses_output.ListGroupingStatusesOutput = aws_sdk_resource_groups.types.list_grouping_statuses_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_resource_groups.types.list_grouping_statuses_input.ListGroupingStatusesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.list_grouping_statuses_input.serialize_json(input)
    ).encode()
