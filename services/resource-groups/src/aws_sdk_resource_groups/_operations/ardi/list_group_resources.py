...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.list_group_resources_output.ListGroupResourcesOutput = aws_sdk_resource_groups.types.list_group_resources_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_resource_groups.types.list_group_resources_input.ListGroupResourcesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.list_group_resources_input.serialize_json(input)
    ).encode()
