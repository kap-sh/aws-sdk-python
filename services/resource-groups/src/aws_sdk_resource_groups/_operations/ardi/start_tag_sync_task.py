...
def build_request(
    ...
    input: aws_sdk_resource_groups.types.start_tag_sync_task_input.StartTagSyncTaskInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.start_tag_sync_task_input.serialize_json(input)
    ).encode()
