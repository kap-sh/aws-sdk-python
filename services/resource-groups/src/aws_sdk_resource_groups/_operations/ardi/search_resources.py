"""Generated from Smithy shape ``com.amazonaws.resourcegroups#SearchResources``."""
...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.search_resources_output.SearchResourcesOutput = (
        aws_sdk_resource_groups.types.search_resources_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.search_resources_input.SearchResourcesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/resources/search"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resource_groups.types.search_resources_input

    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.search_resources_input.serialize_json(input_)
    ).encode()
...
async def async_search_resources(
