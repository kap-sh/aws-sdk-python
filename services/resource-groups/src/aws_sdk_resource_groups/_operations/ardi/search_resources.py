...
def build_request(
    ...
    input: aws_sdk_resource_groups.types.search_resources_input.SearchResourcesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.search_resources_input.serialize_json(input)
    ).encode()
