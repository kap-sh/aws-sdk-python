...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.put_group_configuration_output.PutGroupConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.put_group_configuration_input.PutGroupConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
