...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.get_tags_output.GetTagsOutput = (
        aws_sdk_resource_groups.types.get_tags_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.get_tags_input.GetTagsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_tags(
    ...
    aws_sdk_resource_groups.types.get_tags_output.GetTagsOutput, zapros.Response
]:
