"""Generated from Smithy shape ``com.amazonaws.resourcegroups#UpdateGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.update_group_output.UpdateGroupOutput = (
        aws_sdk_resource_groups.types.update_group_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.update_group_input.UpdateGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/update-group"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resource_groups.types.update_group_input

    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.update_group_input.serialize_json(input_)
    ).encode()
...
def update_group(
    ...
    aws_sdk_resource_groups.types.update_group_output.UpdateGroupOutput, zapros.Response
]:
