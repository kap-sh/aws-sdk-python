...
import aws_sdk_resource_groups.errors.not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NotFoundException":
            raise aws_sdk_resource_groups.errors.not_found_exception.NotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.get_group_configuration_output.GetGroupConfigurationOutput = aws_sdk_resource_groups.types.get_group_configuration_output.deserialize_json(
...
def get_signer(
...
) -> aws_sdk_resource_groups._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_resource_groups._auth._sigv4.build_sigv4_auth_scheme(
                "resource-groups", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_resource_groups._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.get_group_configuration_input.GetGroupConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.get_group_configuration_input.serialize_json(
            input_
        )
    ).encode()
