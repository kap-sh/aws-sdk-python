...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.cancel_tag_sync_task_input.CancelTagSyncTaskInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.cancel_tag_sync_task_input.serialize_json(input_)
    ).encode()
