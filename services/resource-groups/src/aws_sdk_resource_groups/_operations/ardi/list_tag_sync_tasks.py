...
def build_request(
    ...
    input: aws_sdk_resource_groups.types.list_tag_sync_tasks_input.ListTagSyncTasksInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.list_tag_sync_tasks_input.serialize_json(input)
    ).encode()
