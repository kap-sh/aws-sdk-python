"""Generated from Smithy shape ``com.amazonaws.resourcegroups#ListTagSyncTasks``."""
...
import aws_sdk_resource_groups.types.tag_sync_task_list
...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.list_tag_sync_tasks_output.ListTagSyncTasksOutput = aws_sdk_resource_groups.types.list_tag_sync_tasks_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.list_tag_sync_tasks_input.ListTagSyncTasksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-tag-sync-tasks"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_resource_groups.types.list_tag_sync_tasks_input

    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.list_tag_sync_tasks_input.serialize_json(input_)
    ).encode()
...
async def async_list_tag_sync_tasks(
