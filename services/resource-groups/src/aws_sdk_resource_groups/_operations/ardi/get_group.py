...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.get_group_output.GetGroupOutput = (
        aws_sdk_resource_groups.types.get_group_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.get_group_input.GetGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.get_group_input.serialize_json(input_)
    ).encode()
...
def get_group(
    ...
    aws_sdk_resource_groups.types.get_group_output.GetGroupOutput, zapros.Response
]:
