...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.create_group_output.CreateGroupOutput = (
        aws_sdk_resource_groups.types.create_group_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.create_group_input.CreateGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.create_group_input.serialize_json(input_)
    ).encode()
...
def create_group(
    ...
    aws_sdk_resource_groups.types.create_group_output.CreateGroupOutput, zapros.Response
]:
