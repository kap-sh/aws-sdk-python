...
def handle_response(
    ...
    out: aws_sdk_resource_groups.types.delete_group_output.DeleteGroupOutput = (
        aws_sdk_resource_groups.types.delete_group_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_resource_groups.types.delete_group_input.DeleteGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.delete_group_input.serialize_json(input_)
    ).encode()
...
def delete_group(
    ...
    aws_sdk_resource_groups.types.delete_group_output.DeleteGroupOutput, zapros.Response
]:
