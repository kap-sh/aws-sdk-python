...
def build_request(
    ...
    input: aws_sdk_resource_groups.types.ungroup_resources_input.UngroupResourcesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_resource_groups.types.ungroup_resources_input.serialize_json(input)
    ).encode()
