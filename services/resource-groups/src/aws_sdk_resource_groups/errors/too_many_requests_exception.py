"""Generated from Smithy shape ``com.amazonaws.resourcegroups#TooManyRequestsException``."""
...
class TooManyRequestsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.resourcegroups#TooManyRequestsException``."""
