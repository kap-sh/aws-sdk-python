...
if TYPE_CHECKING:
    ...
    import aws_sdk_resource_groups.types.resource_status


class ListGroupResourcesItem(TypedDict):
    identifier: NotRequired[
        "aws_sdk_resource_groups.types.resource_identifier.ResourceIdentifier"
    ]
    status: NotRequired["aws_sdk_resource_groups.types.resource_status.ResourceStatus"]
...
def serialize_json(value: ListGroupResourcesItem) -> dict:
    ...
    if "identifier" in value:
        ...
        out["Identifier"] = (
            aws_sdk_resource_groups.types.resource_identifier.serialize_json(
                value["identifier"]
            )
        )
    if "status" in value:
        ...
        out["Status"] = aws_sdk_resource_groups.types.resource_status.serialize_json(
            value["status"]
        )
    return out
...
def deserialize_json(data: dict) -> ListGroupResourcesItem:
    ...
    if "Identifier" in data:
        ...
        out["identifier"] = (
            aws_sdk_resource_groups.types.resource_identifier.deserialize_json(
                data["Identifier"]
            )
        )
    if "Status" in data:
        ...
        out["status"] = aws_sdk_resource_groups.types.resource_status.deserialize_json(
            data["Status"]
        )
    return out
