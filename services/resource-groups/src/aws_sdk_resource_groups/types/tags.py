"""Generated from Smithy shape ``com.amazonaws.resourcegroups#Tags``."""
...
Tags: TypeAlias = dict[
    "aws_sdk_resource_groups.types.tag_key.TagKey",
    "aws_sdk_resource_groups.types.tag_value.TagValue",
]
