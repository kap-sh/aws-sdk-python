...
if TYPE_CHECKING:
    import aws_sdk_resource_groups.types.resource_filter_name
...
def serialize_json(value: ResourceFilter) -> dict:
    ...
    out["Name"] = aws_sdk_resource_groups.types.resource_filter_name.serialize_json(
        value["name"]
    )
    import aws_sdk_resource_groups.types.resource_filter_values

    out["Values"] = aws_sdk_resource_groups.types.resource_filter_values.serialize_json(
        value["values"]
    )
    return out
...
def deserialize_json(data: dict) -> ResourceFilter:
    ...
    if "Name" in data:
        ...
        out["name"] = (
            aws_sdk_resource_groups.types.resource_filter_name.deserialize_json(
                data["Name"]
            )
        )
    else:
    ...
    if "Values" in data:
        ...
        out["values"] = (
            aws_sdk_resource_groups.types.resource_filter_values.deserialize_json(
                data["Values"]
            )
        )
    else:
