...
class ListTagSyncTasksOutput(TypedDict):
    tag_sync_tasks: NotRequired[
        "aws_sdk_resource_groups.types.tag_sync_task_list.TagSyncTaskList"
    ]
...
def serialize_json(value: ListTagSyncTasksOutput) -> dict:
    ...
    if "tag_sync_tasks" in value:
        ...
        out["TagSyncTasks"] = (
            aws_sdk_resource_groups.types.tag_sync_task_list.serialize_json(
...
def deserialize_json(data: dict) -> ListTagSyncTasksOutput:
    ...
    if "TagSyncTasks" in data:
        ...
        out["tag_sync_tasks"] = (
            aws_sdk_resource_groups.types.tag_sync_task_list.deserialize_json(
                data["TagSyncTasks"]
            )
        )
