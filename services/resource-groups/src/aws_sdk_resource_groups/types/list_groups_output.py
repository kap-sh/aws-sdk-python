...
if TYPE_CHECKING:
    import aws_sdk_resource_groups.types.group_identifier_list
    import aws_sdk_resource_groups.types.group_list
    import aws_sdk_resource_groups.types.next_token


class ListGroupsOutput(TypedDict):
    group_identifiers: NotRequired[
        "aws_sdk_resource_groups.types.group_identifier_list.GroupIdentifierList"
    ]
    ...
    groups: NotRequired["aws_sdk_resource_groups.types.group_list.GroupList"]
...
def serialize_json(value: ListGroupsOutput) -> dict:
    ...
    if "group_identifiers" in value:
        ...
        out["GroupIdentifiers"] = (
            aws_sdk_resource_groups.types.group_identifier_list.serialize_json(
    ...
    if "groups" in value:
        ...
        out["Groups"] = aws_sdk_resource_groups.types.group_list.serialize_json(
            value["groups"]
        )
...
def deserialize_json(data: dict) -> ListGroupsOutput:
    ...
    if "GroupIdentifiers" in data:
        ...
        out["group_identifiers"] = (
            aws_sdk_resource_groups.types.group_identifier_list.deserialize_json(
    ...
    if "Groups" in data:
        ...
        out["groups"] = aws_sdk_resource_groups.types.group_list.deserialize_json(
            data["Groups"]
        )
