...
if TYPE_CHECKING:
    import capo_resource_groups.types.group_configuration_parameter_value

GroupConfigurationParameterValueList: TypeAlias = list[
    "capo_resource_groups.types.group_configuration_parameter_value.GroupConfigurationParameterValue"
]
