...
from ._services.async_resource_groups import (
    AsyncResourceGroupsClient as AsyncResourceGroupsClient,
)
from ._services.resource_groups import ResourceGroupsClient as ResourceGroupsClient
