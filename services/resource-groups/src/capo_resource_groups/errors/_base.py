...
class ResourceGroupsError(Exception):
    """Base class for all ResourceGroups service errors."""


class ServiceError(ResourceGroupsError):
...
class SerializationError(ResourceGroupsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ResourceGroupsError):
...
class WaiterFailedError(ResourceGroupsError):
...
class WaiterTimeoutError(ResourceGroupsError):
