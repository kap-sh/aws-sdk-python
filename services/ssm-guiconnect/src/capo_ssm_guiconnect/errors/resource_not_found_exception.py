"""Generated from Smithy shape ``com.amazonaws.ssmguiconnect#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ssmguiconnect#ResourceNotFoundException``."""
