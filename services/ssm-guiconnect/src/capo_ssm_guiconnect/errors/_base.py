...
class SSMGuiConnectError(Exception):
    """Base class for all SSMGuiConnect service errors."""


class ServiceError(SSMGuiConnectError):
...
class SerializationError(SSMGuiConnectError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SSMGuiConnectError):
...
class WaiterFailedError(SSMGuiConnectError):
...
class WaiterTimeoutError(SSMGuiConnectError):
