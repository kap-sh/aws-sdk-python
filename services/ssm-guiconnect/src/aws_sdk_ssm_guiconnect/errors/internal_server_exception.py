"""Generated from Smithy shape ``com.amazonaws.ssmguiconnect#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ssmguiconnect#InternalServerException``."""
