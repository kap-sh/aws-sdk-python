...
if TYPE_CHECKING:
    import aws_sdk_ssm_guiconnect.types.recording_destinations


class ConnectionRecordingPreferences(TypedDict):
    recording_destinations: (
        "aws_sdk_ssm_guiconnect.types.recording_destinations.RecordingDestinations"
    )
...
def serialize_json(value: ConnectionRecordingPreferences) -> dict:
    ...
    out["RecordingDestinations"] = (
        aws_sdk_ssm_guiconnect.types.recording_destinations.serialize_json(
...
def deserialize_json(data: dict) -> ConnectionRecordingPreferences:
    ...
    if "RecordingDestinations" in data:
        ...
        out["recording_destinations"] = (
            aws_sdk_ssm_guiconnect.types.recording_destinations.deserialize_json(
