...
if TYPE_CHECKING:
    import aws_sdk_ssm_guiconnect.types.account_id
    import aws_sdk_ssm_guiconnect.types.bucket_name


class S3Bucket(TypedDict):
    bucket_owner: "aws_sdk_ssm_guiconnect.types.account_id.AccountId"
    """<p>The Amazon Web Services account number that owns the S3 bucket.</p>"""
    bucket_name: "aws_sdk_ssm_guiconnect.types.bucket_name.BucketName"
