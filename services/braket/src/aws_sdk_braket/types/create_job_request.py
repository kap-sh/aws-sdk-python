...
class CreateJobRequest(TypedDict):
    ...
    input_data_config: NotRequired["aws_sdk_braket.types.input_config_list.InputConfigList"]
    ...
    checkpoint_config: NotRequired["aws_sdk_braket.types.job_checkpoint_config.JobCheckpointConfig"]
    ...
    stopping_condition: NotRequired["aws_sdk_braket.types.job_stopping_condition.JobStoppingCondition"]
    ...
    hyper_parameters: NotRequired["aws_sdk_braket.types.hyper_parameters.HyperParameters"]
...
def serialize_json(value: CreateJobRequest) -> dict:
    ...
    import aws_sdk_braket.types.algorithm_specification
    out["algorithmSpecification"] = aws_sdk_braket.types.algorithm_specification.serialize_json(value["algorithm_specification"])
    if "input_data_config" in value:
        import aws_sdk_braket.types.input_config_list
        out["inputDataConfig"] = aws_sdk_braket.types.input_config_list.serialize_json(value["input_data_config"])
    import aws_sdk_braket.types.job_output_data_config
    out["outputDataConfig"] = aws_sdk_braket.types.job_output_data_config.serialize_json(value["output_data_config"])
    if "checkpoint_config" in value:
        import aws_sdk_braket.types.job_checkpoint_config
        out["checkpointConfig"] = aws_sdk_braket.types.job_checkpoint_config.serialize_json(value["checkpoint_config"])
    out["jobName"] = value["job_name"]
    out["roleArn"] = value["role_arn"]
    if "stopping_condition" in value:
        import aws_sdk_braket.types.job_stopping_condition
        out["stoppingCondition"] = aws_sdk_braket.types.job_stopping_condition.serialize_json(value["stopping_condition"])
    import aws_sdk_braket.types.instance_config
    out["instanceConfig"] = aws_sdk_braket.types.instance_config.serialize_json(value["instance_config"])
    if "hyper_parameters" in value:
        import aws_sdk_braket.types.hyper_parameters
        out["hyperParameters"] = aws_sdk_braket.types.hyper_parameters.serialize_json(value["hyper_parameters"])
    import aws_sdk_braket.types.device_config
    out["deviceConfig"] = aws_sdk_braket.types.device_config.serialize_json(value["device_config"])
    if "tags" in value:
        import aws_sdk_braket.types.tags_map
...
def deserialize_json(data: dict) -> CreateJobRequest:
    ...
    if "algorithmSpecification" in data:
        import aws_sdk_braket.types.algorithm_specification
        out["algorithm_specification"] = aws_sdk_braket.types.algorithm_specification.deserialize_json(data["algorithmSpecification"])
    else:
        raise DeserializationError("CreateJobRequest.algorithm_specification required")
    if "inputDataConfig" in data:
        import aws_sdk_braket.types.input_config_list
        out["input_data_config"] = aws_sdk_braket.types.input_config_list.deserialize_json(data["inputDataConfig"])
    if "outputDataConfig" in data:
        import aws_sdk_braket.types.job_output_data_config
        out["output_data_config"] = aws_sdk_braket.types.job_output_data_config.deserialize_json(data["outputDataConfig"])
    else:
        raise DeserializationError("CreateJobRequest.output_data_config required")
    if "checkpointConfig" in data:
        import aws_sdk_braket.types.job_checkpoint_config
        out["checkpoint_config"] = aws_sdk_braket.types.job_checkpoint_config.deserialize_json(data["checkpointConfig"])
    if "jobName" in data:
    ...
    if "stoppingCondition" in data:
        import aws_sdk_braket.types.job_stopping_condition
        out["stopping_condition"] = aws_sdk_braket.types.job_stopping_condition.deserialize_json(data["stoppingCondition"])
    if "instanceConfig" in data:
        import aws_sdk_braket.types.instance_config
        out["instance_config"] = aws_sdk_braket.types.instance_config.deserialize_json(data["instanceConfig"])
    else:
        raise DeserializationError("CreateJobRequest.instance_config required")
    if "hyperParameters" in data:
        import aws_sdk_braket.types.hyper_parameters
        out["hyper_parameters"] = aws_sdk_braket.types.hyper_parameters.deserialize_json(data["hyperParameters"])
    if "deviceConfig" in data:
        import aws_sdk_braket.types.device_config
        out["device_config"] = aws_sdk_braket.types.device_config.deserialize_json(data["deviceConfig"])
    else:
