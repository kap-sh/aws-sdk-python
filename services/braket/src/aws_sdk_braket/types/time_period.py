...
def serialize_json(value: TimePeriod) -> dict:
    ...
    out["startAt"] = aws_sdk_braket.types._prelude.timestamp.serialize_json(
        value["start_at"]
    )
    import aws_sdk_braket.types._prelude.timestamp

    out["endAt"] = aws_sdk_braket.types._prelude.timestamp.serialize_json(
        value["end_at"]
    )
    return out
...
def deserialize_json(data: dict) -> TimePeriod:
    ...
    if "startAt" in data:
        ...
        out["start_at"] = aws_sdk_braket.types._prelude.timestamp.deserialize_json(
            data["startAt"]
        )
    else:
    ...
    if "endAt" in data:
        ...
        out["end_at"] = aws_sdk_braket.types._prelude.timestamp.deserialize_json(
            data["endAt"]
        )
    else:
