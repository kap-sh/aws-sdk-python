...
class SearchJobsResponse(TypedDict):
    jobs: "aws_sdk_braket.types.job_summary_list.JobSummaryList"
...
def serialize_json(value: SearchJobsResponse) -> dict:
    ...
    out["jobs"] = aws_sdk_braket.types.job_summary_list.serialize_json(value["jobs"])
...
def deserialize_json(data: dict) -> SearchJobsResponse:
    ...
    if "jobs" in data:
        ...
        out["jobs"] = aws_sdk_braket.types.job_summary_list.deserialize_json(
            data["jobs"]
        )
    else:
