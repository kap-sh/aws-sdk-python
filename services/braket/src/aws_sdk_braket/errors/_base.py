...
class BraketError(Exception):
    """Base class for all Braket service errors."""

class ServiceError(BraketError):
...
class SerializationError(BraketError):
    """Raised when a value cannot be serialized."""

class DeserializationError(BraketError):
...
class WaiterFailedError(BraketError):
...
class WaiterTimeoutError(BraketError):
