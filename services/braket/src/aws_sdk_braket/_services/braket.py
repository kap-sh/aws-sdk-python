...
from aws_sdk_braket._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
...
class BraketClient:
    ...
    def list_tags_for_resource(self, resource_arn: str, *, config_overrides: Optional[BraketClientConfig] = None) -> "aws_sdk_braket.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_braket.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> OperationResponse["aws_sdk_braket.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_braket._operations.braket.list_tags_for_resource
            output, http_response = aws_sdk_braket._operations.braket.list_tags_for_resource.list_tags_for_resource(req.options, req.input)
    ...
    def tag_resource(self, resource_arn: str, tags: "aws_sdk_braket.types.tags_map.TagsMap", *, config_overrides: Optional[BraketClientConfig] = None) -> "aws_sdk_braket.types.tag_resource_response.TagResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_braket.types.tag_resource_request.TagResourceRequest]') -> OperationResponse["aws_sdk_braket.types.tag_resource_response.TagResourceResponse"]:
            import aws_sdk_braket._operations.braket.tag_resource
            output, http_response = aws_sdk_braket._operations.braket.tag_resource.tag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def untag_resource(self, resource_arn: str, tag_keys: "aws_sdk_braket.types.tag_keys.TagKeys", *, config_overrides: Optional[BraketClientConfig] = None) -> "aws_sdk_braket.types.untag_resource_response.UntagResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_braket.types.untag_resource_request.UntagResourceRequest]') -> OperationResponse["aws_sdk_braket.types.untag_resource_response.UntagResourceResponse"]:
            import aws_sdk_braket._operations.braket.untag_resource
            output, http_response = aws_sdk_braket._operations.braket.untag_resource.untag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
