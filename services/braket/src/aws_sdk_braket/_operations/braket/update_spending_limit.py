...
def build_request(
    ...
    input_: aws_sdk_braket.types.update_spending_limit_request.UpdateSpendingLimitRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_braket.types.update_spending_limit_request.serialize_json(input_)
    ).encode()
