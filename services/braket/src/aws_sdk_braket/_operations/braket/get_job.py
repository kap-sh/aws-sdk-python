"""Generated from Smithy shape ``com.amazonaws.braket#GetJob``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_braket.types.get_job_response.GetJobResponse:
    import aws_sdk_braket.types.get_job_response
    out: aws_sdk_braket.types.get_job_response.GetJobResponse = aws_sdk_braket.types.get_job_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_braket.types.get_job_request.GetJobRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/job/{jobArn}"
    url = url.replace("{jobArn}", quote(str(input["job_arn"]), safe=""))
    params: dict[str, str] = {}
    if "additional_attribute_names" in input:
        params["additionalAttributeNames"] = str(input["additional_attribute_names"])
...
def get_job(options: OperationOptions, input: aws_sdk_braket.types.get_job_request.GetJobRequest) -> tuple[aws_sdk_braket.types.get_job_response.GetJobResponse, zapros.Response]:
...
async def async_get_job(options: AsyncOperationOptions, input: aws_sdk_braket.types.get_job_request.GetJobRequest) -> tuple[aws_sdk_braket.types.get_job_response.GetJobResponse, zapros.Response]:
