...
def handle_response(
    ...
    out: aws_sdk_braket.types.get_job_response.GetJobResponse = (
        aws_sdk_braket.types.get_job_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_braket.types.get_job_request.GetJobRequest,
) -> zapros.Request:
...
def get_job(
    options: OperationOptions, input: aws_sdk_braket.types.get_job_request.GetJobRequest
) -> tuple[aws_sdk_braket.types.get_job_response.GetJobResponse, zapros.Response]:
