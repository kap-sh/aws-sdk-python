...
def build_request(
    ...
    input_: aws_sdk_braket.types.get_job_request.GetJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "additional_attribute_names" in input_:
        params["additionalAttributeNames"] = str(input_["additional_attribute_names"])
