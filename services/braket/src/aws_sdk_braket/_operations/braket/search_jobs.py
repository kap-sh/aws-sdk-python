...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_braket.types.search_jobs_response.SearchJobsResponse:
    import aws_sdk_braket.types.search_jobs_response
    out: aws_sdk_braket.types.search_jobs_response.SearchJobsResponse = aws_sdk_braket.types.search_jobs_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_braket.types.search_jobs_request.SearchJobsRequest) -> zapros.Request:
    ...
    import aws_sdk_braket.types.search_jobs_request
    body: bytes | None = json.dumps(aws_sdk_braket.types.search_jobs_request.serialize_json(input)).encode()
...
def search_jobs(options: OperationOptions, input: aws_sdk_braket.types.search_jobs_request.SearchJobsRequest) -> tuple[aws_sdk_braket.types.search_jobs_response.SearchJobsResponse, zapros.Response]:
...
async def async_search_jobs(options: AsyncOperationOptions, input: aws_sdk_braket.types.search_jobs_request.SearchJobsRequest) -> tuple[aws_sdk_braket.types.search_jobs_response.SearchJobsResponse, zapros.Response]:
