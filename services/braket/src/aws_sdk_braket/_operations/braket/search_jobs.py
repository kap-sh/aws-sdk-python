...
import aws_sdk_braket.types.job_summary_list
...
def handle_response(
    ...
    out: aws_sdk_braket.types.search_jobs_response.SearchJobsResponse = (
        aws_sdk_braket.types.search_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_braket.types.search_jobs_request.SearchJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_braket.types.search_jobs_request.serialize_json(input_)
    ).encode()
...
def search_jobs(
    ...
    aws_sdk_braket.types.search_jobs_response.SearchJobsResponse, zapros.Response
]:
