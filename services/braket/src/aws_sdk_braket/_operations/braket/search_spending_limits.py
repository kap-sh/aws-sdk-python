...
def build_request(
    ...
    input: aws_sdk_braket.types.search_spending_limits_request.SearchSpendingLimitsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_braket.types.search_spending_limits_request.serialize_json(input)
    ).encode()
