"""Generated from Smithy shape ``com.amazonaws.braket#SearchSpendingLimits``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_braket.types.search_spending_limits_response.SearchSpendingLimitsResponse:
    import aws_sdk_braket.types.search_spending_limits_response
    out: aws_sdk_braket.types.search_spending_limits_response.SearchSpendingLimitsResponse = aws_sdk_braket.types.search_spending_limits_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_braket.types.search_spending_limits_request.SearchSpendingLimitsRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/spending-limits"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_braket.types.search_spending_limits_request
    body: bytes | None = json.dumps(aws_sdk_braket.types.search_spending_limits_request.serialize_json(input)).encode()
...
def search_spending_limits(options: OperationOptions, input: aws_sdk_braket.types.search_spending_limits_request.SearchSpendingLimitsRequest) -> tuple[aws_sdk_braket.types.search_spending_limits_response.SearchSpendingLimitsResponse, zapros.Response]:
...
async def async_search_spending_limits(options: AsyncOperationOptions, input: aws_sdk_braket.types.search_spending_limits_request.SearchSpendingLimitsRequest) -> tuple[aws_sdk_braket.types.search_spending_limits_response.SearchSpendingLimitsResponse, zapros.Response]:
