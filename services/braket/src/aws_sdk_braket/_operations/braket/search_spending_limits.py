...
def handle_response(
    ...
    out: aws_sdk_braket.types.search_spending_limits_response.SearchSpendingLimitsResponse = aws_sdk_braket.types.search_spending_limits_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_braket.types.search_spending_limits_request.SearchSpendingLimitsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_braket.types.search_spending_limits_request.serialize_json(input_)
    ).encode()
...
async def async_search_spending_limits(
