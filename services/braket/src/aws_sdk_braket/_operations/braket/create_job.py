"""Generated from Smithy shape ``com.amazonaws.braket#CreateJob``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_braket.errors.conflict_exception
            raise aws_sdk_braket.errors.conflict_exception.ConflictException.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_braket.types.create_job_response.CreateJobResponse:
    import aws_sdk_braket.types.create_job_response
    out: aws_sdk_braket.types.create_job_response.CreateJobResponse = aws_sdk_braket.types.create_job_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_braket.types.create_job_request.CreateJobRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/job"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_braket.types.create_job_request
    body: bytes | None = json.dumps(aws_sdk_braket.types.create_job_request.serialize_json(input)).encode()
...
def create_job(options: OperationOptions, input: aws_sdk_braket.types.create_job_request.CreateJobRequest) -> tuple[aws_sdk_braket.types.create_job_response.CreateJobResponse, zapros.Response]:
...
async def async_create_job(options: AsyncOperationOptions, input: aws_sdk_braket.types.create_job_request.CreateJobRequest) -> tuple[aws_sdk_braket.types.create_job_response.CreateJobResponse, zapros.Response]:
