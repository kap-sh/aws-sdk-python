...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            ...
            raise aws_sdk_braket.errors.conflict_exception.ConflictException.from_json(
                data
            )
        case "DeviceOfflineException":
            import aws_sdk_braket.errors.device_offline_exception

            raise aws_sdk_braket.errors.device_offline_exception.DeviceOfflineException.from_json(
                data
            )
        case "DeviceRetiredException":
            import aws_sdk_braket.errors.device_retired_exception

            raise aws_sdk_braket.errors.device_retired_exception.DeviceRetiredException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            ...
            raise aws_sdk_braket.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_braket.types.create_job_response.CreateJobResponse = (
        aws_sdk_braket.types.create_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_braket.types.create_job_request.CreateJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_braket.types.create_job_request.serialize_json(input_)
    ).encode()
...
def create_job(
    ...
    input_: aws_sdk_braket.types.create_job_request.CreateJobRequest,
) -> tuple[aws_sdk_braket.types.create_job_response.CreateJobResponse, zapros.Response]:
