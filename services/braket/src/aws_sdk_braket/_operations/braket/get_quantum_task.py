...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_braket.types.get_quantum_task_response.GetQuantumTaskResponse:
    import aws_sdk_braket.types.get_quantum_task_response
    out: aws_sdk_braket.types.get_quantum_task_response.GetQuantumTaskResponse = aws_sdk_braket.types.get_quantum_task_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_braket.types.get_quantum_task_request.GetQuantumTaskRequest) -> zapros.Request:
...
def get_quantum_task(options: OperationOptions, input: aws_sdk_braket.types.get_quantum_task_request.GetQuantumTaskRequest) -> tuple[aws_sdk_braket.types.get_quantum_task_response.GetQuantumTaskResponse, zapros.Response]:
...
async def async_get_quantum_task(options: AsyncOperationOptions, input: aws_sdk_braket.types.get_quantum_task_request.GetQuantumTaskRequest) -> tuple[aws_sdk_braket.types.get_quantum_task_response.GetQuantumTaskResponse, zapros.Response]:
