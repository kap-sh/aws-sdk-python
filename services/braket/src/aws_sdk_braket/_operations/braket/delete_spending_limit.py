"""Generated from Smithy shape ``com.amazonaws.braket#DeleteSpendingLimit``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_braket.types.delete_spending_limit_response.DeleteSpendingLimitResponse:
    out: aws_sdk_braket.types.delete_spending_limit_response.DeleteSpendingLimitResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_braket.types.delete_spending_limit_request.DeleteSpendingLimitRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/spending-limit/{spendingLimitArn}/delete"
...
def delete_spending_limit(options: OperationOptions, input: aws_sdk_braket.types.delete_spending_limit_request.DeleteSpendingLimitRequest) -> tuple[aws_sdk_braket.types.delete_spending_limit_response.DeleteSpendingLimitResponse, zapros.Response]:
...
async def async_delete_spending_limit(options: AsyncOperationOptions, input: aws_sdk_braket.types.delete_spending_limit_request.DeleteSpendingLimitRequest) -> tuple[aws_sdk_braket.types.delete_spending_limit_response.DeleteSpendingLimitResponse, zapros.Response]:
