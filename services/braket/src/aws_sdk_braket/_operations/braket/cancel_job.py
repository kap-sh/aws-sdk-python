"""Generated from Smithy shape ``com.amazonaws.braket#CancelJob``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_braket.types.cancel_job_response.CancelJobResponse:
    import aws_sdk_braket.types.cancel_job_response
    out: aws_sdk_braket.types.cancel_job_response.CancelJobResponse = aws_sdk_braket.types.cancel_job_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_braket.types.cancel_job_request.CancelJobRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/job/{jobArn}/cancel"
    url = url.replace("{jobArn}", quote(str(input["job_arn"]), safe=""))
    params: dict[str, str] = {}
...
def cancel_job(options: OperationOptions, input: aws_sdk_braket.types.cancel_job_request.CancelJobRequest) -> tuple[aws_sdk_braket.types.cancel_job_response.CancelJobResponse, zapros.Response]:
...
async def async_cancel_job(options: AsyncOperationOptions, input: aws_sdk_braket.types.cancel_job_request.CancelJobRequest) -> tuple[aws_sdk_braket.types.cancel_job_response.CancelJobResponse, zapros.Response]:
