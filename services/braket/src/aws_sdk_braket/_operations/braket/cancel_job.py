...
def handle_response(
    ...
    out: aws_sdk_braket.types.cancel_job_response.CancelJobResponse = (
        aws_sdk_braket.types.cancel_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_braket.types.cancel_job_request.CancelJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def cancel_job(
    ...
    input_: aws_sdk_braket.types.cancel_job_request.CancelJobRequest,
) -> tuple[aws_sdk_braket.types.cancel_job_response.CancelJobResponse, zapros.Response]:
