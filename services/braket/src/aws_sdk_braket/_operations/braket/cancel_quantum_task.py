...
def handle_response(
    ...
    out: aws_sdk_braket.types.cancel_quantum_task_response.CancelQuantumTaskResponse = (
        aws_sdk_braket.types.cancel_quantum_task_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_braket.types.cancel_quantum_task_request.CancelQuantumTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{quantumTaskArn}", quote(str(input_["quantum_task_arn"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_braket.types.cancel_quantum_task_request.serialize_json(input_)
    ).encode()
...
async def async_cancel_quantum_task(
