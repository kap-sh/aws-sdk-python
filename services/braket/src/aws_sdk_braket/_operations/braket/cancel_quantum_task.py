...
def build_request(
    ...
    input: aws_sdk_braket.types.cancel_quantum_task_request.CancelQuantumTaskRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{quantumTaskArn}", quote(str(input["quantum_task_arn"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_braket.types.cancel_quantum_task_request.serialize_json(input)
    ).encode()
