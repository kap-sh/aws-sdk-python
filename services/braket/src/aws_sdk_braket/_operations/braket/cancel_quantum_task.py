"""Generated from Smithy shape ``com.amazonaws.braket#CancelQuantumTask``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_braket.types.cancel_quantum_task_response.CancelQuantumTaskResponse:
    import aws_sdk_braket.types.cancel_quantum_task_response
    out: aws_sdk_braket.types.cancel_quantum_task_response.CancelQuantumTaskResponse = aws_sdk_braket.types.cancel_quantum_task_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_braket.types.cancel_quantum_task_request.CancelQuantumTaskRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/quantum-task/{quantumTaskArn}/cancel"
    url = url.replace("{quantumTaskArn}", quote(str(input["quantum_task_arn"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_braket.types.cancel_quantum_task_request
    body: bytes | None = json.dumps(aws_sdk_braket.types.cancel_quantum_task_request.serialize_json(input)).encode()
...
def cancel_quantum_task(options: OperationOptions, input: aws_sdk_braket.types.cancel_quantum_task_request.CancelQuantumTaskRequest) -> tuple[aws_sdk_braket.types.cancel_quantum_task_response.CancelQuantumTaskResponse, zapros.Response]:
...
async def async_cancel_quantum_task(options: AsyncOperationOptions, input: aws_sdk_braket.types.cancel_quantum_task_request.CancelQuantumTaskRequest) -> tuple[aws_sdk_braket.types.cancel_quantum_task_response.CancelQuantumTaskResponse, zapros.Response]:
