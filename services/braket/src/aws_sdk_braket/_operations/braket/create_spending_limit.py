...
def handle_response(
    ...
    out: aws_sdk_braket.types.create_spending_limit_response.CreateSpendingLimitResponse = aws_sdk_braket.types.create_spending_limit_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_braket.types.create_spending_limit_request.CreateSpendingLimitRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_braket.types.create_spending_limit_request.serialize_json(input_)
    ).encode()
...
async def async_create_spending_limit(
