"""Generated from Smithy shape ``com.amazonaws.braket#CreateSpendingLimit``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_braket.types.create_spending_limit_response.CreateSpendingLimitResponse:
    import aws_sdk_braket.types.create_spending_limit_response
    out: aws_sdk_braket.types.create_spending_limit_response.CreateSpendingLimitResponse = aws_sdk_braket.types.create_spending_limit_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_braket.types.create_spending_limit_request.CreateSpendingLimitRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/spending-limit"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_braket.types.create_spending_limit_request
    body: bytes | None = json.dumps(aws_sdk_braket.types.create_spending_limit_request.serialize_json(input)).encode()
...
def create_spending_limit(options: OperationOptions, input: aws_sdk_braket.types.create_spending_limit_request.CreateSpendingLimitRequest) -> tuple[aws_sdk_braket.types.create_spending_limit_response.CreateSpendingLimitResponse, zapros.Response]:
...
async def async_create_spending_limit(options: AsyncOperationOptions, input: aws_sdk_braket.types.create_spending_limit_request.CreateSpendingLimitRequest) -> tuple[aws_sdk_braket.types.create_spending_limit_response.CreateSpendingLimitResponse, zapros.Response]:
