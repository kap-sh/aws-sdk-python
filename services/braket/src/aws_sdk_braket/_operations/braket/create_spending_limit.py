...
def build_request(
    ...
    input: aws_sdk_braket.types.create_spending_limit_request.CreateSpendingLimitRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_braket.types.create_spending_limit_request.serialize_json(input)
    ).encode()
