...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_braket.types.search_quantum_tasks_response.SearchQuantumTasksResponse:
    import aws_sdk_braket.types.search_quantum_tasks_response
    out: aws_sdk_braket.types.search_quantum_tasks_response.SearchQuantumTasksResponse = aws_sdk_braket.types.search_quantum_tasks_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_braket.types.search_quantum_tasks_request.SearchQuantumTasksRequest) -> zapros.Request:
    ...
    import aws_sdk_braket.types.search_quantum_tasks_request
    body: bytes | None = json.dumps(aws_sdk_braket.types.search_quantum_tasks_request.serialize_json(input)).encode()
...
def search_quantum_tasks(options: OperationOptions, input: aws_sdk_braket.types.search_quantum_tasks_request.SearchQuantumTasksRequest) -> tuple[aws_sdk_braket.types.search_quantum_tasks_response.SearchQuantumTasksResponse, zapros.Response]:
...
async def async_search_quantum_tasks(options: AsyncOperationOptions, input: aws_sdk_braket.types.search_quantum_tasks_request.SearchQuantumTasksRequest) -> tuple[aws_sdk_braket.types.search_quantum_tasks_response.SearchQuantumTasksResponse, zapros.Response]:
