...
def build_request(
    ...
    input: aws_sdk_braket.types.search_quantum_tasks_request.SearchQuantumTasksRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_braket.types.search_quantum_tasks_request.serialize_json(input)
    ).encode()
