...
def handle_response(
    ...
    out: aws_sdk_braket.types.search_quantum_tasks_response.SearchQuantumTasksResponse = aws_sdk_braket.types.search_quantum_tasks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_braket.types.search_quantum_tasks_request.SearchQuantumTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_braket.types.search_quantum_tasks_request.serialize_json(input_)
    ).encode()
