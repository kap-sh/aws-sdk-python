"""Generated from Smithy shape ``com.amazonaws.braket#SearchDevices``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_braket.types.search_devices_response.SearchDevicesResponse:
    import aws_sdk_braket.types.search_devices_response
    out: aws_sdk_braket.types.search_devices_response.SearchDevicesResponse = aws_sdk_braket.types.search_devices_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_braket.types.search_devices_request.SearchDevicesRequest) -> zapros.Request:
    ...
    import aws_sdk_braket.types.search_devices_request
    body: bytes | None = json.dumps(aws_sdk_braket.types.search_devices_request.serialize_json(input)).encode()
...
def search_devices(options: OperationOptions, input: aws_sdk_braket.types.search_devices_request.SearchDevicesRequest) -> tuple[aws_sdk_braket.types.search_devices_response.SearchDevicesResponse, zapros.Response]:
...
async def async_search_devices(options: AsyncOperationOptions, input: aws_sdk_braket.types.search_devices_request.SearchDevicesRequest) -> tuple[aws_sdk_braket.types.search_devices_response.SearchDevicesResponse, zapros.Response]:
