...
def build_request(
    ...
    input_: aws_sdk_braket.types.search_devices_request.SearchDevicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_braket.types.search_devices_request.serialize_json(input_)
    ).encode()
...
def search_devices(
    ...
    aws_sdk_braket.types.search_devices_response.SearchDevicesResponse, zapros.Response
]:
