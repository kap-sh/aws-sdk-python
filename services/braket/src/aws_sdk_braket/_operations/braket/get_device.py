"""Generated from Smithy shape ``com.amazonaws.braket#GetDevice``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_braket.types.get_device_response.GetDeviceResponse:
    import aws_sdk_braket.types.get_device_response
    out: aws_sdk_braket.types.get_device_response.GetDeviceResponse = aws_sdk_braket.types.get_device_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_braket.types.get_device_request.GetDeviceRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/device/{deviceArn}"
    url = url.replace("{deviceArn}", quote(str(input["device_arn"]), safe=""))
    params: dict[str, str] = {}
...
def get_device(options: OperationOptions, input: aws_sdk_braket.types.get_device_request.GetDeviceRequest) -> tuple[aws_sdk_braket.types.get_device_response.GetDeviceResponse, zapros.Response]:
...
async def async_get_device(options: AsyncOperationOptions, input: aws_sdk_braket.types.get_device_request.GetDeviceRequest) -> tuple[aws_sdk_braket.types.get_device_response.GetDeviceResponse, zapros.Response]:
