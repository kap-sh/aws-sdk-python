...
def handle_response(
    ...
    out: aws_sdk_braket.types.get_device_response.GetDeviceResponse = (
        aws_sdk_braket.types.get_device_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_braket.types.get_device_request.GetDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{deviceArn}", quote(str(input_["device_arn"]), safe=""))
    params: dict[str, str] = {}
...
def get_device(
    ...
    input_: aws_sdk_braket.types.get_device_request.GetDeviceRequest,
) -> tuple[aws_sdk_braket.types.get_device_response.GetDeviceResponse, zapros.Response]:
