...
def handle_response(
    ...
    out: aws_sdk_braket.types.create_quantum_task_response.CreateQuantumTaskResponse = (
        aws_sdk_braket.types.create_quantum_task_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_braket.types.create_quantum_task_request.CreateQuantumTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_braket.types.create_quantum_task_request.serialize_json(input_)
    ).encode()
...
async def async_create_quantum_task(
