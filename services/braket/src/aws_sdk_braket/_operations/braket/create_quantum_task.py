"""Generated from Smithy shape ``com.amazonaws.braket#CreateQuantumTask``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DeviceOfflineException":
            import aws_sdk_braket.errors.device_offline_exception
            raise aws_sdk_braket.errors.device_offline_exception.DeviceOfflineException.from_json(data)
        case "DeviceRetiredException":
            import aws_sdk_braket.errors.device_retired_exception
            raise aws_sdk_braket.errors.device_retired_exception.DeviceRetiredException.from_json(data)
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_braket.errors.service_quota_exceeded_exception
            raise aws_sdk_braket.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_braket.types.create_quantum_task_response.CreateQuantumTaskResponse:
    import aws_sdk_braket.types.create_quantum_task_response
    out: aws_sdk_braket.types.create_quantum_task_response.CreateQuantumTaskResponse = aws_sdk_braket.types.create_quantum_task_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_braket.types.create_quantum_task_request.CreateQuantumTaskRequest) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/quantum-task"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_braket.types.create_quantum_task_request
    body: bytes | None = json.dumps(aws_sdk_braket.types.create_quantum_task_request.serialize_json(input)).encode()
...
def create_quantum_task(options: OperationOptions, input: aws_sdk_braket.types.create_quantum_task_request.CreateQuantumTaskRequest) -> tuple[aws_sdk_braket.types.create_quantum_task_response.CreateQuantumTaskResponse, zapros.Response]:
...
async def async_create_quantum_task(options: AsyncOperationOptions, input: aws_sdk_braket.types.create_quantum_task_request.CreateQuantumTaskRequest) -> tuple[aws_sdk_braket.types.create_quantum_task_response.CreateQuantumTaskResponse, zapros.Response]:
