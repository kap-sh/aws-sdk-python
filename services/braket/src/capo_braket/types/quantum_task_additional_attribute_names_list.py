...
if TYPE_CHECKING:
    import capo_braket.types.quantum_task_additional_attribute_name

QuantumTaskAdditionalAttributeNamesList: TypeAlias = list[
    "capo_braket.types.quantum_task_additional_attribute_name.QuantumTaskAdditionalAttributeName"
]
