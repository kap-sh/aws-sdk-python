...
import capo_braket.errors.conflict_exception
import capo_braket.errors.device_offline_exception
import capo_braket.errors.device_retired_exception
import capo_braket.errors.internal_service_exception
import capo_braket.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_braket.errors.conflict_exception.ConflictException.from_json(
                data
            )
        case "DeviceOfflineException":
            raise capo_braket.errors.device_offline_exception.DeviceOfflineException.from_json(
                data
            )
        case "DeviceRetiredException":
            raise capo_braket.errors.device_retired_exception.DeviceRetiredException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_braket.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_braket.types.create_job_response.CreateJobResponse = (
        capo_braket.types.create_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_braket.types.create_job_request.serialize_json(input_)
    ).encode()
...
def create_job(
    ...
    input_: capo_braket.types.create_job_request.CreateJobRequest,
) -> tuple[capo_braket.types.create_job_response.CreateJobResponse, zapros.Response]:
