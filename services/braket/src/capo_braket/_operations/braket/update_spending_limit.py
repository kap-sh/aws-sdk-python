...
def handle_response(
    ...
    out: capo_braket.types.update_spending_limit_response.UpdateSpendingLimitResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_braket.types.update_spending_limit_request.serialize_json(input_)
    ).encode()
