"""Generated from Smithy shape ``com.amazonaws.braket#SearchJobs``."""
...
def handle_response(
    ...
    out: capo_braket.types.search_jobs_response.SearchJobsResponse = (
        capo_braket.types.search_jobs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_braket.types.search_jobs_request.serialize_json(input_)
    ).encode()
...
def search_jobs(
    ...
    input_: capo_braket.types.search_jobs_request.SearchJobsRequest,
) -> tuple[capo_braket.types.search_jobs_response.SearchJobsResponse, zapros.Response]:
