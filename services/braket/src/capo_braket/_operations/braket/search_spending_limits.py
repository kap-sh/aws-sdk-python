...
def handle_response(
    ...
    out: capo_braket.types.search_spending_limits_response.SearchSpendingLimitsResponse = capo_braket.types.search_spending_limits_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_braket.types.search_spending_limits_request.serialize_json(input_)
    ).encode()
