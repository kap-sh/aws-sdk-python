...
def handle_response(
    ...
    out: capo_braket.types.search_devices_response.SearchDevicesResponse = (
        capo_braket.types.search_devices_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_braket.types.search_devices_request.serialize_json(input_)
    ).encode()
...
def search_devices(
    ...
    capo_braket.types.search_devices_response.SearchDevicesResponse, zapros.Response
]:
...
async def async_search_devices(
