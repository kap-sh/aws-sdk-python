"""Generated from Smithy shape ``com.amazonaws.ivsrealtime#GetIngestConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.get_ingest_configuration_response.GetIngestConfigurationResponse = aws_sdk_ivs_realtime.types.get_ingest_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.get_ingest_configuration_request.GetIngestConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetIngestConfiguration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivs_realtime.types.get_ingest_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.get_ingest_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_ingest_configuration(
