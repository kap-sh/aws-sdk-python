...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.list_participant_replicas_response.ListParticipantReplicasResponse = aws_sdk_ivs_realtime.types.list_participant_replicas_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.list_participant_replicas_request.ListParticipantReplicasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.list_participant_replicas_request.serialize_json(
            input_
        )
    ).encode()
