...
def build_request(
    ...
    input: aws_sdk_ivs_realtime.types.stop_composition_request.StopCompositionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.stop_composition_request.serialize_json(input)
    ).encode()
