...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.stop_composition_response.StopCompositionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.stop_composition_request.StopCompositionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.stop_composition_request.serialize_json(input_)
    ).encode()
