...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.import_public_key_response.ImportPublicKeyResponse = aws_sdk_ivs_realtime.types.import_public_key_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.import_public_key_request.ImportPublicKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.import_public_key_request.serialize_json(input_)
    ).encode()
