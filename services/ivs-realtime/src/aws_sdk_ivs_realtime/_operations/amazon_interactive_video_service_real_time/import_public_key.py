...
def build_request(
    ...
    input: aws_sdk_ivs_realtime.types.import_public_key_request.ImportPublicKeyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.import_public_key_request.serialize_json(input)
    ).encode()
