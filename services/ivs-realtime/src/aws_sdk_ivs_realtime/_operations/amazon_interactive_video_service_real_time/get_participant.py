...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.get_participant_response.GetParticipantResponse = (
        aws_sdk_ivs_realtime.types.get_participant_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.get_participant_request.GetParticipantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.get_participant_request.serialize_json(input_)
    ).encode()
