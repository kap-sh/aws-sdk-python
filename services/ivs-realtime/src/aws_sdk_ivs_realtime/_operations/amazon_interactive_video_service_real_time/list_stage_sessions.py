...
def build_request(
    ...
    input: aws_sdk_ivs_realtime.types.list_stage_sessions_request.ListStageSessionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.list_stage_sessions_request.serialize_json(input)
    ).encode()
