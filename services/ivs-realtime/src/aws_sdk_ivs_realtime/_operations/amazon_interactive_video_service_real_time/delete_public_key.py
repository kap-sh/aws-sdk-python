...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.delete_public_key_response.DeletePublicKeyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.delete_public_key_request.DeletePublicKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.delete_public_key_request.serialize_json(input_)
    ).encode()
