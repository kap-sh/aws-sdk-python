...
def build_request(
    ...
    input: aws_sdk_ivs_realtime.types.delete_public_key_request.DeletePublicKeyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.delete_public_key_request.serialize_json(input)
    ).encode()
