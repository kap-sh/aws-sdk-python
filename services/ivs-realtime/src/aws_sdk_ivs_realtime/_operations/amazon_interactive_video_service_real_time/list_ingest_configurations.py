...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.list_ingest_configurations_response.ListIngestConfigurationsResponse = aws_sdk_ivs_realtime.types.list_ingest_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.list_ingest_configurations_request.ListIngestConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.list_ingest_configurations_request.serialize_json(
            input_
        )
    ).encode()
