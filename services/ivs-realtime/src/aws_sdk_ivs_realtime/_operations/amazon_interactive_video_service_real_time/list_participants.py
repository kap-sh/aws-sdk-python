...
def build_request(
    ...
    input: aws_sdk_ivs_realtime.types.list_participants_request.ListParticipantsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.list_participants_request.serialize_json(input)
    ).encode()
