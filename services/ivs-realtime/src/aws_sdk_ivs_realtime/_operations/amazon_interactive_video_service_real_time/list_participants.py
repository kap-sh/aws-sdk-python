...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.list_participants_response.ListParticipantsResponse = aws_sdk_ivs_realtime.types.list_participants_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.list_participants_request.ListParticipantsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.list_participants_request.serialize_json(input_)
    ).encode()
