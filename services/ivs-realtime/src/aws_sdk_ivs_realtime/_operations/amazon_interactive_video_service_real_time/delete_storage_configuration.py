...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.delete_storage_configuration_response.DeleteStorageConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.delete_storage_configuration_request.DeleteStorageConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.delete_storage_configuration_request.serialize_json(
            input_
        )
    ).encode()
