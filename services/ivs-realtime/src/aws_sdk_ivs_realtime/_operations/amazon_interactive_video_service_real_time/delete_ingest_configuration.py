"""Generated from Smithy shape ``com.amazonaws.ivsrealtime#DeleteIngestConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.delete_ingest_configuration_response.DeleteIngestConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.delete_ingest_configuration_request.DeleteIngestConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_ingest_configuration(
