...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.update_ingest_configuration_response.UpdateIngestConfigurationResponse = aws_sdk_ivs_realtime.types.update_ingest_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.update_ingest_configuration_request.UpdateIngestConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.update_ingest_configuration_request.serialize_json(
            input_
        )
    ).encode()
