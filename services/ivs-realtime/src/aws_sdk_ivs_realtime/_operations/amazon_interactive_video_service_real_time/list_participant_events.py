...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.list_participant_events_response.ListParticipantEventsResponse = aws_sdk_ivs_realtime.types.list_participant_events_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_ivs_realtime.types.list_participant_events_request.ListParticipantEventsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.list_participant_events_request.serialize_json(input)
    ).encode()
