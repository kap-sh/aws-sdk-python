...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.list_participant_events_request.ListParticipantEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.list_participant_events_request.serialize_json(
            input_
        )
    ).encode()
