...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.delete_encoder_configuration_response.DeleteEncoderConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.delete_encoder_configuration_request.DeleteEncoderConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.delete_encoder_configuration_request.serialize_json(
            input_
        )
    ).encode()
