...
def build_request(
    ...
    input: aws_sdk_ivs_realtime.types.list_compositions_request.ListCompositionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.list_compositions_request.serialize_json(input)
    ).encode()
