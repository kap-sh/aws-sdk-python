...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.list_compositions_response.ListCompositionsResponse = aws_sdk_ivs_realtime.types.list_compositions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.list_compositions_request.ListCompositionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.list_compositions_request.serialize_json(input_)
    ).encode()
