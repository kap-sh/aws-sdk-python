...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.list_storage_configurations_response.ListStorageConfigurationsResponse = aws_sdk_ivs_realtime.types.list_storage_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.list_storage_configurations_request.ListStorageConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.list_storage_configurations_request.serialize_json(
            input_
        )
    ).encode()
