...
def build_request(
    ...
    input: aws_sdk_ivs_realtime.types.list_public_keys_request.ListPublicKeysRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.list_public_keys_request.serialize_json(input)
    ).encode()
