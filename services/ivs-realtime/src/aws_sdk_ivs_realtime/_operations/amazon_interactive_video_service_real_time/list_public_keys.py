"""Generated from Smithy shape ``com.amazonaws.ivsrealtime#ListPublicKeys``."""
...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.list_public_keys_response.ListPublicKeysResponse = (
        aws_sdk_ivs_realtime.types.list_public_keys_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.list_public_keys_request.ListPublicKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListPublicKeys"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_ivs_realtime.types.list_public_keys_request

    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.list_public_keys_request.serialize_json(input_)
    ).encode()
