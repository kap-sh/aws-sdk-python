...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.get_stage_response.GetStageResponse = (
        aws_sdk_ivs_realtime.types.get_stage_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.get_stage_request.GetStageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.get_stage_request.serialize_json(input_)
    ).encode()
...
def get_stage(
    ...
    aws_sdk_ivs_realtime.types.get_stage_response.GetStageResponse, zapros.Response
]:
