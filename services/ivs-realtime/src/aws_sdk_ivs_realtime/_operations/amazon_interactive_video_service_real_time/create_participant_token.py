...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.create_participant_token_response.CreateParticipantTokenResponse = aws_sdk_ivs_realtime.types.create_participant_token_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.create_participant_token_request.CreateParticipantTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.create_participant_token_request.serialize_json(
            input_
        )
    ).encode()
