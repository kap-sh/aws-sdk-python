...
def build_request(
    ...
    input: aws_sdk_ivs_realtime.types.get_stage_session_request.GetStageSessionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.get_stage_session_request.serialize_json(input)
    ).encode()
