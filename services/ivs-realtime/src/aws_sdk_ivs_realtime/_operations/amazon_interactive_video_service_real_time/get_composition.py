...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.get_composition_response.GetCompositionResponse = (
        aws_sdk_ivs_realtime.types.get_composition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.get_composition_request.GetCompositionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.get_composition_request.serialize_json(input_)
    ).encode()
