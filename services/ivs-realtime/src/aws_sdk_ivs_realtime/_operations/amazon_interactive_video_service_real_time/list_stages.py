"""Generated from Smithy shape ``com.amazonaws.ivsrealtime#ListStages``."""
...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.list_stages_response.ListStagesResponse = (
        aws_sdk_ivs_realtime.types.list_stages_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_ivs_realtime.types.list_stages_request.ListStagesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.list_stages_request.serialize_json(input)
    ).encode()
...
def list_stages(
    ...
    aws_sdk_ivs_realtime.types.list_stages_response.ListStagesResponse, zapros.Response
]:
