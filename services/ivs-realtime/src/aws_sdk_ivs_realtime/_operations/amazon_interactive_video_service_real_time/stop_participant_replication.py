...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.stop_participant_replication_response.StopParticipantReplicationResponse = {}  # type: ignore[typeddict-item]
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.stop_participant_replication_request.StopParticipantReplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.stop_participant_replication_request.serialize_json(
            input_
        )
    ).encode()
