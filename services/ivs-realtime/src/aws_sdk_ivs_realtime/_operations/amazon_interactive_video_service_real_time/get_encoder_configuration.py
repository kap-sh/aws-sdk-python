...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.get_encoder_configuration_response.GetEncoderConfigurationResponse = aws_sdk_ivs_realtime.types.get_encoder_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.get_encoder_configuration_request.GetEncoderConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.get_encoder_configuration_request.serialize_json(
            input_
        )
    ).encode()
