...
def build_request(
    ...
    input: aws_sdk_ivs_realtime.types.disconnect_participant_request.DisconnectParticipantRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.disconnect_participant_request.serialize_json(input)
    ).encode()
