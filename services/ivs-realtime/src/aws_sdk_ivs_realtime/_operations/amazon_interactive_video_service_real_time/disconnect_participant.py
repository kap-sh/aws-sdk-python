...
def handle_response(
    ...
    out: aws_sdk_ivs_realtime.types.disconnect_participant_response.DisconnectParticipantResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_ivs_realtime.types.disconnect_participant_request.DisconnectParticipantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_ivs_realtime.types.disconnect_participant_request.serialize_json(input_)
    ).encode()
