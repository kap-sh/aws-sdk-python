...
from ._services.async_ivs_real_time import (
    AsyncIVSRealTimeClient as AsyncIVSRealTimeClient,
)
from ._services.ivs_real_time import IVSRealTimeClient as IVSRealTimeClient
