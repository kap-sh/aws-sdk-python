...
if TYPE_CHECKING:
    ...
    import aws_sdk_ivs_realtime.types.video_aspect_ratio
...
class GridConfiguration(TypedDict):
    ...
    video_aspect_ratio: NotRequired[
        "aws_sdk_ivs_realtime.types.video_aspect_ratio.VideoAspectRatio"
    ]
...
def serialize_json(value: GridConfiguration) -> dict:
    ...
    if "video_aspect_ratio" in value:
        ...
        out["videoAspectRatio"] = (
            aws_sdk_ivs_realtime.types.video_aspect_ratio.serialize_json(
...
def deserialize_json(data: dict) -> GridConfiguration:
    ...
    if "videoAspectRatio" in data:
        ...
        out["video_aspect_ratio"] = (
            aws_sdk_ivs_realtime.types.video_aspect_ratio.deserialize_json(
