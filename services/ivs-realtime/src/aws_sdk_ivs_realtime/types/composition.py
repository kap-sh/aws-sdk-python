...
if TYPE_CHECKING:
    ...
    import aws_sdk_ivs_realtime.types.destination_list
...
class Composition(TypedDict):
    ...
    layout: "aws_sdk_ivs_realtime.types.layout_configuration.LayoutConfiguration"
    """<p>Layout object to configure composition parameters.</p>"""
    destinations: "aws_sdk_ivs_realtime.types.destination_list.DestinationList"
...
def serialize_json(value: Composition) -> dict:
    ...
    out["destinations"] = aws_sdk_ivs_realtime.types.destination_list.serialize_json(
        value["destinations"]
    )
    if "tags" in value:
        import aws_sdk_ivs_realtime.types.tags
...
def deserialize_json(data: dict) -> Composition:
    ...
    if "destinations" in data:
        ...
        out["destinations"] = (
            aws_sdk_ivs_realtime.types.destination_list.deserialize_json(
                data["destinations"]
            )
        )
    else:
