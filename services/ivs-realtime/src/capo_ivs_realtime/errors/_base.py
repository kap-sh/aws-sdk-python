...
class IVSRealTimeError(Exception):
    """Base class for all IVSRealTime service errors."""


class ServiceError(IVSRealTimeError):
...
class SerializationError(IVSRealTimeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IVSRealTimeError):
...
class WaiterFailedError(IVSRealTimeError):
...
class WaiterTimeoutError(IVSRealTimeError):
