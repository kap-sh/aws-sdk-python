"""Generated from Smithy shape ``com.amazonaws.ivsrealtime#StageSessionSummary``."""
...
class StageSessionSummary(TypedDict, closed=True):
    session_id: NotRequired["capo_ivs_realtime.types.stage_session_id.StageSessionId"]
...
# --- restJson1 ser/de ---
def serialize_json(value: StageSessionSummary) -> dict:
    out: dict = {}
