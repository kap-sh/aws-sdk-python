...
if TYPE_CHECKING:
    import capo_ivs_realtime.types.composition_thumbnail_configuration

CompositionThumbnailConfigurationList: TypeAlias = list[
    "capo_ivs_realtime.types.composition_thumbnail_configuration.CompositionThumbnailConfiguration"
]
...
def serialize_json(value: CompositionThumbnailConfigurationList) -> list:
    ...
    for item in value:
        out.append(
            capo_ivs_realtime.types.composition_thumbnail_configuration.serialize_json(
                item
            )
        )
    return out
