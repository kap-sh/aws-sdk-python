"""Generated from Smithy shape ``com.amazonaws.ivsrealtime#UntagResource``."""
...
def handle_response(
    ...
    out: capo_ivs_realtime.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
