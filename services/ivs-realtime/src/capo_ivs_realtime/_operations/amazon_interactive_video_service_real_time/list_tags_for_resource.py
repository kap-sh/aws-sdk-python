"""Generated from Smithy shape ``com.amazonaws.ivsrealtime#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_ivs_realtime.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_ivs_realtime.types.list_tags_for_resource_response.deserialize_json(
