...
class Plugin:
    ...
    def list(self, *, config_overrides: Optional[MigrationHubOrchestratorClientConfig] = None, max_results: Optional["aws_sdk_migrationhuborchestrator.types.max_results.MaxResults"] = None, next_token: Optional["aws_sdk_migrationhuborchestrator.types.next_token.NextToken"] = None) -> "aws_sdk_migrationhuborchestrator.types.list_plugins_response.ListPluginsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_migrationhuborchestrator.types.list_plugins_request.ListPluginsRequest]') -> OperationResponse["aws_sdk_migrationhuborchestrator.types.list_plugins_response.ListPluginsResponse"]:
            import aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.list_plugins
            output, http_response = aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.list_plugins.list_plugins(req.options, req.input)
            return OperationResponse(output=output, response=http_response)

        interceptors_, options_ = self._service.operation_options(config_overrides)
        input: aws_sdk_migrationhuborchestrator.types.list_plugins_request.ListPluginsRequest = {}  # type: ignore[typeddict-item]
...
class AsyncPlugin:
    ...
    async def list(self, *, config_overrides: Optional[AsyncMigrationHubOrchestratorClientConfig] = None, max_results: Optional["aws_sdk_migrationhuborchestrator.types.max_results.MaxResults"] = None, next_token: Optional["aws_sdk_migrationhuborchestrator.types.next_token.NextToken"] = None) -> "aws_sdk_migrationhuborchestrator.types.list_plugins_response.ListPluginsResponse":
        ...
        Args:
            ...
            next_token: <p>The pagination token.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_migrationhuborchestrator.types.list_plugins_request.ListPluginsRequest]') -> AsyncOperationResponse["aws_sdk_migrationhuborchestrator.types.list_plugins_response.ListPluginsResponse"]:
            import aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.list_plugins
            output, http_response = await aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.list_plugins.async_list_plugins(req.options, req.input)
