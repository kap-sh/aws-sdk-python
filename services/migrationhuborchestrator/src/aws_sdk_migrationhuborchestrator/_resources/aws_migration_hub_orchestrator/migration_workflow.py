...
class MigrationWorkflow:
    ...
    def create(
        ...
        *,
        ...
        tags: Optional[
            "aws_sdk_migrationhuborchestrator.types.string_map.StringMap"
        ] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhuborchestrator.types.create_migration_workflow_request.CreateMigrationWorkflowRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhuborchestrator.types.create_migration_workflow_response.CreateMigrationWorkflowResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.create_workflow.create_workflow(
        ...
        input_: aws_sdk_migrationhuborchestrator.types.create_migration_workflow_request.CreateMigrationWorkflowRequest = {}  # type: ignore[typeddict-item]
        input_["name"] = name
    ...
    def read(
        ...
        *,
        config_overrides: Optional[MigrationHubOrchestratorClientConfig] = None,
    ) -> "aws_sdk_migrationhuborchestrator.types.get_migration_workflow_response.GetMigrationWorkflowResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhuborchestrator.types.get_migration_workflow_request.GetMigrationWorkflowRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhuborchestrator.types.get_migration_workflow_response.GetMigrationWorkflowResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.get_workflow.get_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_migrationhuborchestrator.types.get_migration_workflow_request.GetMigrationWorkflowRequest = {}  # type: ignore[typeddict-item]
        input_["id"] = id
    ...
    def update(
        ...
        *,
    ...
    ) -> "aws_sdk_migrationhuborchestrator.types.update_migration_workflow_response.UpdateMigrationWorkflowResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhuborchestrator.types.update_migration_workflow_request.UpdateMigrationWorkflowRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhuborchestrator.types.update_migration_workflow_response.UpdateMigrationWorkflowResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.update_workflow.update_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_migrationhuborchestrator.types.update_migration_workflow_request.UpdateMigrationWorkflowRequest = {}  # type: ignore[typeddict-item]
        input_["id"] = id
        if name is not None:
            input_["name"] = name
        if description is not None:
    ...
    def delete(
        ...
        *,
        config_overrides: Optional[MigrationHubOrchestratorClientConfig] = None,
    ) -> "aws_sdk_migrationhuborchestrator.types.delete_migration_workflow_response.DeleteMigrationWorkflowResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhuborchestrator.types.delete_migration_workflow_request.DeleteMigrationWorkflowRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhuborchestrator.types.delete_migration_workflow_response.DeleteMigrationWorkflowResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.delete_workflow.delete_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_migrationhuborchestrator.types.delete_migration_workflow_request.DeleteMigrationWorkflowRequest = {}  # type: ignore[typeddict-item]
        input_["id"] = id
    ...
    def list(
        ...
        *,
        ...
        name: Optional[str] = None,
    ) -> "aws_sdk_migrationhuborchestrator.types.list_migration_workflows_response.ListMigrationWorkflowsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhuborchestrator.types.list_migration_workflows_request.ListMigrationWorkflowsRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhuborchestrator.types.list_migration_workflows_response.ListMigrationWorkflowsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.list_workflows.list_workflows(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_migrationhuborchestrator.types.list_migration_workflows_request.ListMigrationWorkflowsRequest = {}  # type: ignore[typeddict-item]
    ...
    def start_workflow(
        ...
        *,
        config_overrides: Optional[MigrationHubOrchestratorClientConfig] = None,
    ) -> "aws_sdk_migrationhuborchestrator.types.start_migration_workflow_response.StartMigrationWorkflowResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhuborchestrator.types.start_migration_workflow_request.StartMigrationWorkflowRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhuborchestrator.types.start_migration_workflow_response.StartMigrationWorkflowResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.start_workflow.start_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_migrationhuborchestrator.types.start_migration_workflow_request.StartMigrationWorkflowRequest = {}  # type: ignore[typeddict-item]
        input_["id"] = id
    ...
    def stop_workflow(
        ...
        *,
        config_overrides: Optional[MigrationHubOrchestratorClientConfig] = None,
    ) -> "aws_sdk_migrationhuborchestrator.types.stop_migration_workflow_response.StopMigrationWorkflowResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_migrationhuborchestrator.types.stop_migration_workflow_request.StopMigrationWorkflowRequest]",
        ) -> OperationResponse[
            "aws_sdk_migrationhuborchestrator.types.stop_migration_workflow_response.StopMigrationWorkflowResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.stop_workflow.stop_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input_: aws_sdk_migrationhuborchestrator.types.stop_migration_workflow_request.StopMigrationWorkflowRequest = {}  # type: ignore[typeddict-item]
        input_["id"] = id
...
class AsyncMigrationWorkflow:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migrationhuborchestrator.types.create_migration_workflow_request.CreateMigrationWorkflowRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migrationhuborchestrator.types.create_migration_workflow_response.CreateMigrationWorkflowResponse"
        ]:
            import aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.create_workflow
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.create_workflow.async_create_workflow(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migrationhuborchestrator.types.get_migration_workflow_request.GetMigrationWorkflowRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migrationhuborchestrator.types.get_migration_workflow_response.GetMigrationWorkflowResponse"
        ]:
            import aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.get_workflow
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.get_workflow.async_get_workflow(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migrationhuborchestrator.types.update_migration_workflow_request.UpdateMigrationWorkflowRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migrationhuborchestrator.types.update_migration_workflow_response.UpdateMigrationWorkflowResponse"
        ]:
            import aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.update_workflow
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.update_workflow.async_update_workflow(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migrationhuborchestrator.types.delete_migration_workflow_request.DeleteMigrationWorkflowRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migrationhuborchestrator.types.delete_migration_workflow_response.DeleteMigrationWorkflowResponse"
        ]:
            import aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.delete_workflow
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.delete_workflow.async_delete_workflow(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migrationhuborchestrator.types.list_migration_workflows_request.ListMigrationWorkflowsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migrationhuborchestrator.types.list_migration_workflows_response.ListMigrationWorkflowsResponse"
        ]:
            import aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.list_workflows
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.list_workflows.async_list_workflows(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_workflow(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migrationhuborchestrator.types.start_migration_workflow_request.StartMigrationWorkflowRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migrationhuborchestrator.types.start_migration_workflow_response.StartMigrationWorkflowResponse"
        ]:
            import aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.start_workflow
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.start_workflow.async_start_workflow(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_workflow(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_migrationhuborchestrator.types.stop_migration_workflow_request.StopMigrationWorkflowRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_migrationhuborchestrator.types.stop_migration_workflow_response.StopMigrationWorkflowResponse"
        ]:
            import aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.stop_workflow
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.stop_workflow.async_stop_workflow(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
