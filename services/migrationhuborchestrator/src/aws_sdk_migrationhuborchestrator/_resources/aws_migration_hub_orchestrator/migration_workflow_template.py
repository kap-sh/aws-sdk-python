    ...
    def create(
        ...
        *,
        ...
        Raises:
            ...
            aws_sdk_migrationhuborchestrator.errors.conflict_exception.ConflictException: <p>This exception is thrown when an attempt to update or delete a resource would cause an inconsistent state.</p>
