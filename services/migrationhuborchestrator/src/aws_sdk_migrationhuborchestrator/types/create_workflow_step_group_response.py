"""Generated from Smithy shape ``com.amazonaws.migrationhuborchestrator#CreateWorkflowStepGroupResponse``."""
...
class CreateWorkflowStepGroupResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateWorkflowStepGroupResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateWorkflowStepGroupResponse:
    out: CreateWorkflowStepGroupResponse = {}  # type: ignore[typeddict-item]
