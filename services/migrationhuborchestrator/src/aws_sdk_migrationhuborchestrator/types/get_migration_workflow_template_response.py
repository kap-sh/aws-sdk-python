...
if TYPE_CHECKING:
    ...
    import aws_sdk_migrationhuborchestrator.types.template_status
    import aws_sdk_migrationhuborchestrator.types.tools_list


class GetMigrationWorkflowTemplateResponse(TypedDict):
    id: NotRequired["str"]
    ...
    inputs: NotRequired[
        "aws_sdk_migrationhuborchestrator.types.template_input_list.TemplateInputList"
    ]
    ...
    status: NotRequired[
        "aws_sdk_migrationhuborchestrator.types.template_status.TemplateStatus"
    ]
...
def serialize_json(value: GetMigrationWorkflowTemplateResponse) -> dict:
    ...
    if "inputs" in value:
        ...
        out["inputs"] = (
            aws_sdk_migrationhuborchestrator.types.template_input_list.serialize_json(
                value["inputs"]
            )
        )
    if "tools" in value:
...
def deserialize_json(data: dict) -> GetMigrationWorkflowTemplateResponse:
    ...
    if "inputs" in data:
        ...
        out["inputs"] = (
            aws_sdk_migrationhuborchestrator.types.template_input_list.deserialize_json(
                data["inputs"]
            )
        )
    if "tools" in data:
