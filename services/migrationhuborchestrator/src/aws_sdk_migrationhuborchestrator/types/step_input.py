...
def serialize_json(value: StepInput) -> dict:
    if "integerValue" in value:
        ...
        return {
            "listOfStringsValue": aws_sdk_migrationhuborchestrator.types.string_list.serialize_json(
        ...
        return {
            "mapOfStringValue": aws_sdk_migrationhuborchestrator.types.string_map.serialize_json(
...
def deserialize_json(data: dict) -> StepInput:
    if "integerValue" in data:
        ...
        return {
            "listOfStringsValue": aws_sdk_migrationhuborchestrator.types.string_list.deserialize_json(
        ...
        return {
            "mapOfStringValue": aws_sdk_migrationhuborchestrator.types.string_map.deserialize_json(
