...
class MigrationHubOrchestratorError(Exception):
    """Base class for all MigrationHubOrchestrator service errors."""


class ServiceError(MigrationHubOrchestratorError):
...
class SerializationError(MigrationHubOrchestratorError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MigrationHubOrchestratorError):
...
class WaiterFailedError(MigrationHubOrchestratorError):
...
class WaiterTimeoutError(MigrationHubOrchestratorError):
