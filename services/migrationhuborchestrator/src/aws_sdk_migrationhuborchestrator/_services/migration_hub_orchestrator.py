...
from aws_sdk_migrationhuborchestrator._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
...
class MigrationHubOrchestratorClient:
    ...
    def list_tags_for_resource(self, resource_arn: "aws_sdk_migrationhuborchestrator.types.resource_arn.ResourceArn", *, config_overrides: Optional[MigrationHubOrchestratorClientConfig] = None) -> "aws_sdk_migrationhuborchestrator.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        """<p>List the tags added to a resource.</p>

        Args:
            resource_arn: <p>The Amazon Resource Name (ARN) of the resource.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_migrationhuborchestrator.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> OperationResponse["aws_sdk_migrationhuborchestrator.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.list_tags_for_resource
            output, http_response = aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.list_tags_for_resource.list_tags_for_resource(req.options, req.input)
    ...
    def tag_resource(self, resource_arn: "aws_sdk_migrationhuborchestrator.types.resource_arn.ResourceArn", tags: "aws_sdk_migrationhuborchestrator.types.tag_map.TagMap", *, config_overrides: Optional[MigrationHubOrchestratorClientConfig] = None) -> "aws_sdk_migrationhuborchestrator.types.tag_resource_response.TagResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_migrationhuborchestrator.types.tag_resource_request.TagResourceRequest]') -> OperationResponse["aws_sdk_migrationhuborchestrator.types.tag_resource_response.TagResourceResponse"]:
            import aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.tag_resource
            output, http_response = aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.tag_resource.tag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def untag_resource(self, resource_arn: "aws_sdk_migrationhuborchestrator.types.resource_arn.ResourceArn", tag_keys: "aws_sdk_migrationhuborchestrator.types.tag_key_list.TagKeyList", *, config_overrides: Optional[MigrationHubOrchestratorClientConfig] = None) -> "aws_sdk_migrationhuborchestrator.types.untag_resource_response.UntagResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_migrationhuborchestrator.types.untag_resource_request.UntagResourceRequest]') -> OperationResponse["aws_sdk_migrationhuborchestrator.types.untag_resource_response.UntagResourceResponse"]:
            import aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.untag_resource
            output, http_response = aws_sdk_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.untag_resource.untag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
