...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.start_migration_workflow_response.StartMigrationWorkflowResponse = aws_sdk_migrationhuborchestrator.types.start_migration_workflow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.start_migration_workflow_request.StartMigrationWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
