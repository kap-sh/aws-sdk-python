...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.delete_migration_workflow_response.DeleteMigrationWorkflowResponse = aws_sdk_migrationhuborchestrator.types.delete_migration_workflow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.delete_migration_workflow_request.DeleteMigrationWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
