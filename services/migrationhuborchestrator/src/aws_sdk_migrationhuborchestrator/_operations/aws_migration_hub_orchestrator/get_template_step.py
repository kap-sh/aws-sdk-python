...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.get_template_step_response.GetTemplateStepResponse = aws_sdk_migrationhuborchestrator.types.get_template_step_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.get_template_step_request.GetTemplateStepRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
