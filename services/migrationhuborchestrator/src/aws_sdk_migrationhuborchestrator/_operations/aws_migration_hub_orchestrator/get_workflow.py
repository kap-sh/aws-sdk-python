...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.get_migration_workflow_response.GetMigrationWorkflowResponse = aws_sdk_migrationhuborchestrator.types.get_migration_workflow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.get_migration_workflow_request.GetMigrationWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
