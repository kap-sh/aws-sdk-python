...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.stop_migration_workflow_response.StopMigrationWorkflowResponse = aws_sdk_migrationhuborchestrator.types.stop_migration_workflow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.stop_migration_workflow_request.StopMigrationWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
