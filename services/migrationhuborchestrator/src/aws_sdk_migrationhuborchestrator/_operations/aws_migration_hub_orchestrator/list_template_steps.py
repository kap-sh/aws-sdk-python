...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.list_template_steps_response.ListTemplateStepsResponse = aws_sdk_migrationhuborchestrator.types.list_template_steps_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.list_template_steps_request.ListTemplateStepsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_template_steps(
