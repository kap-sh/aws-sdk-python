...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.retry_workflow_step_response.RetryWorkflowStepResponse = aws_sdk_migrationhuborchestrator.types.retry_workflow_step_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.retry_workflow_step_request.RetryWorkflowStepRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
