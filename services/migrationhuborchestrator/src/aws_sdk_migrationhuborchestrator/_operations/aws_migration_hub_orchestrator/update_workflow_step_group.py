...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.update_workflow_step_group_response.UpdateWorkflowStepGroupResponse = aws_sdk_migrationhuborchestrator.types.update_workflow_step_group_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_migrationhuborchestrator.types.update_workflow_step_group_request.UpdateWorkflowStepGroupRequest,
) -> zapros.Request:
...
async def async_update_workflow_step_group(
