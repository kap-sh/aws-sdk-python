...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.get_template_step_group_response.GetTemplateStepGroupResponse = aws_sdk_migrationhuborchestrator.types.get_template_step_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.get_template_step_group_request.GetTemplateStepGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
