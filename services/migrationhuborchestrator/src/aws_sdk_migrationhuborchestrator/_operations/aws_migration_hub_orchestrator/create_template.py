...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_migrationhuborchestrator.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.create_template_response.CreateTemplateResponse = aws_sdk_migrationhuborchestrator.types.create_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.create_template_request.CreateTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_migrationhuborchestrator.types.create_template_request.serialize_json(
            input_
        )
    ).encode()
