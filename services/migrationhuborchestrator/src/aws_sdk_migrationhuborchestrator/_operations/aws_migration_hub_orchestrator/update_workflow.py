...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.update_migration_workflow_response.UpdateMigrationWorkflowResponse = aws_sdk_migrationhuborchestrator.types.update_migration_workflow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.update_migration_workflow_request.UpdateMigrationWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_migrationhuborchestrator.types.update_migration_workflow_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_workflow(
