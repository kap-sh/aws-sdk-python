...
import aws_sdk_migrationhuborchestrator.types.template_input_list
...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.get_migration_workflow_template_response.GetMigrationWorkflowTemplateResponse = aws_sdk_migrationhuborchestrator.types.get_migration_workflow_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.get_migration_workflow_template_request.GetMigrationWorkflowTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
