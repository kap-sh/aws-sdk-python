...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.create_workflow_step_group_response.CreateWorkflowStepGroupResponse = aws_sdk_migrationhuborchestrator.types.create_workflow_step_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.create_workflow_step_group_request.CreateWorkflowStepGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_migrationhuborchestrator.types.create_workflow_step_group_request.serialize_json(
            input_
        )
    ).encode()
