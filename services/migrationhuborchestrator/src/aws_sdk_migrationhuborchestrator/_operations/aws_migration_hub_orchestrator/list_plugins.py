...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.list_plugins_response.ListPluginsResponse = aws_sdk_migrationhuborchestrator.types.list_plugins_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.list_plugins_request.ListPluginsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
