...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.list_workflow_step_groups_response.ListWorkflowStepGroupsResponse = aws_sdk_migrationhuborchestrator.types.list_workflow_step_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.list_workflow_step_groups_request.ListWorkflowStepGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
