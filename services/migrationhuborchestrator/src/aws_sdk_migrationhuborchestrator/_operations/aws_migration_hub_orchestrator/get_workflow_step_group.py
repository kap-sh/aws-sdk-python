...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.get_workflow_step_group_response.GetWorkflowStepGroupResponse = aws_sdk_migrationhuborchestrator.types.get_workflow_step_group_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_migrationhuborchestrator.types.get_workflow_step_group_request.GetWorkflowStepGroupRequest,
) -> zapros.Request:
...
async def async_get_workflow_step_group(
