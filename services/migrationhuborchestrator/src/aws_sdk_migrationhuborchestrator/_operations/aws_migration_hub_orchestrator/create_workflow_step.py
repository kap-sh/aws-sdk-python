...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.create_workflow_step_response.CreateWorkflowStepResponse = aws_sdk_migrationhuborchestrator.types.create_workflow_step_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.create_workflow_step_request.CreateWorkflowStepRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_migrationhuborchestrator.types.create_workflow_step_request.serialize_json(
            input_
        )
    ).encode()
