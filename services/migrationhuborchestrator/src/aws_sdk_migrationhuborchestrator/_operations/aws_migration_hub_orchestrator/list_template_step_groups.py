...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.list_template_step_groups_response.ListTemplateStepGroupsResponse = aws_sdk_migrationhuborchestrator.types.list_template_step_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.list_template_step_groups_request.ListTemplateStepGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
