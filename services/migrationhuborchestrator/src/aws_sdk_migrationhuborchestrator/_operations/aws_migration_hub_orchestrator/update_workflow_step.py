...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.update_workflow_step_request.UpdateWorkflowStepRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_migrationhuborchestrator.types.update_workflow_step_request.serialize_json(
            input_
        )
    ).encode()
