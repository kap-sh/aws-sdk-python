...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.get_workflow_step_response.GetWorkflowStepResponse = aws_sdk_migrationhuborchestrator.types.get_workflow_step_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_migrationhuborchestrator.types.get_workflow_step_request.GetWorkflowStepRequest,
) -> zapros.Request:
...
async def async_get_workflow_step(
