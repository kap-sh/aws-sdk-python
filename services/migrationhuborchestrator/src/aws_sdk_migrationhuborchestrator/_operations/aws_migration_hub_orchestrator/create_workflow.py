...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.create_migration_workflow_response.CreateMigrationWorkflowResponse = aws_sdk_migrationhuborchestrator.types.create_migration_workflow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.create_migration_workflow_request.CreateMigrationWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_migrationhuborchestrator.types.create_migration_workflow_request.serialize_json(
            input_
        )
    ).encode()
