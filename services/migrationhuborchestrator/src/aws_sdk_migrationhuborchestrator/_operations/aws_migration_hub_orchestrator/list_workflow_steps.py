...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.list_workflow_steps_response.ListWorkflowStepsResponse = aws_sdk_migrationhuborchestrator.types.list_workflow_steps_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.list_workflow_steps_request.ListWorkflowStepsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
