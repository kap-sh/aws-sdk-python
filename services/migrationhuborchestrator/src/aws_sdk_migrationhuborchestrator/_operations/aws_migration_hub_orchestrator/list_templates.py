...
def handle_response(
    ...
    out: aws_sdk_migrationhuborchestrator.types.list_migration_workflow_templates_response.ListMigrationWorkflowTemplatesResponse = aws_sdk_migrationhuborchestrator.types.list_migration_workflow_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_migrationhuborchestrator.types.list_migration_workflow_templates_request.ListMigrationWorkflowTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
