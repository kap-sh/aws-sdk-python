...
from capo_migrationhuborchestrator._services._aws_config import aws_config
...
class MigrationHubOrchestratorClient:
    ...
    def __init__(
        ...
        self._config = MigrationHubOrchestratorClientConfig(
            {
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_migrationhuborchestrator.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_migrationhuborchestrator.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.list_tags_for_resource.list_tags_for_resource(
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_migrationhuborchestrator.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_migrationhuborchestrator.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_migrationhuborchestrator.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_migrationhuborchestrator.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_migrationhuborchestrator._operations.aws_migration_hub_orchestrator.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
