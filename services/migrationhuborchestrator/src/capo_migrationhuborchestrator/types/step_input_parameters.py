...
if TYPE_CHECKING:
    ...
    import capo_migrationhuborchestrator.types.step_input_parameters_key

StepInputParameters: TypeAlias = dict[
    "capo_migrationhuborchestrator.types.step_input_parameters_key.StepInputParametersKey",
    "capo_migrationhuborchestrator.types.step_input.StepInput",
]
...
def serialize_json(input_to_serialize: StepInputParameters) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = capo_migrationhuborchestrator.types.step_input.serialize_json(value)
    return out
