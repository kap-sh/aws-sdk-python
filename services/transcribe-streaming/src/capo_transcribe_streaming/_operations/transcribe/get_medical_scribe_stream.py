"""Generated from Smithy shape ``com.amazonaws.transcribestreaming#GetMedicalScribeStream``."""
...
import capo_transcribe_streaming.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise capo_transcribe_streaming.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_transcribe_streaming.types.get_medical_scribe_stream_response.GetMedicalScribeStreamResponse = capo_transcribe_streaming.types.get_medical_scribe_stream_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/medical-scribe-stream/{SessionId}"
...
async def async_get_medical_scribe_stream(
