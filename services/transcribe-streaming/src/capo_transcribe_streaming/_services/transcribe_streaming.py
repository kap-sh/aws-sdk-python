...
from capo_transcribe_streaming._iter import ensure_sync_iterator
from capo_transcribe_streaming._services._aws_config import aws_config
...
class TranscribeStreamingClientConfig(TypedDict, total=False, closed=True):
...
class TranscribeStreamingClient:
    ...
    def __init__(
        ...
        self._config = TranscribeStreamingClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[TranscribeStreamingClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: TranscribeStreamingClientConfig = config_overrides or {}
    ...
    def get_medical_scribe_stream(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transcribe_streaming.types.get_medical_scribe_stream_request.GetMedicalScribeStreamRequest]",
        ) -> OperationResponse[
            "capo_transcribe_streaming.types.get_medical_scribe_stream_response.GetMedicalScribeStreamResponse"
        ]:
            ...
            output, http_response = (
                capo_transcribe_streaming._operations.transcribe.get_medical_scribe_stream.get_medical_scribe_stream(
    ...
    def start_call_analytics_stream_transcription(
        ...
        audio_stream: "Iterator[capo_transcribe_streaming.types.audio_stream._AudioStream] | capo_transcribe_streaming.types.audio_stream._AudioStream",
        *,
        config_overrides: Optional[TranscribeStreamingClientConfig] = None,
    ...
    ) -> "Generator[capo_transcribe_streaming.types.start_call_analytics_stream_transcription_response.StartCallAnalyticsStreamTranscriptionResponse]":
        ...
        def _handler(
            req: "OperationRequest[capo_transcribe_streaming.types.start_call_analytics_stream_transcription_request.StartCallAnalyticsStreamTranscriptionRequest]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                capo_transcribe_streaming._operations.transcribe.start_call_analytics_stream_transcription.start_call_analytics_stream_transcription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_medical_scribe_stream(
        ...
        input_stream: "Iterator[capo_transcribe_streaming.types.medical_scribe_input_stream._MedicalScribeInputStream] | capo_transcribe_streaming.types.medical_scribe_input_stream._MedicalScribeInputStream",
        *,
        config_overrides: Optional[TranscribeStreamingClientConfig] = None,
        session_id: Optional[
            "capo_transcribe_streaming.types.session_id.SessionId"
        ] = None,
    ) -> "Generator[capo_transcribe_streaming.types.start_medical_scribe_stream_response.StartMedicalScribeStreamResponse]":
        ...
        def _handler(
            req: "OperationRequest[capo_transcribe_streaming.types.start_medical_scribe_stream_request.StartMedicalScribeStreamRequest]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                capo_transcribe_streaming._operations.transcribe.start_medical_scribe_stream.start_medical_scribe_stream(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_medical_stream_transcription(
        ...
        *,
    ...
    ) -> "Generator[capo_transcribe_streaming.types.start_medical_stream_transcription_response.StartMedicalStreamTranscriptionResponse]":
        ...
        def _handler(
            req: "OperationRequest[capo_transcribe_streaming.types.start_medical_stream_transcription_request.StartMedicalStreamTranscriptionRequest]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                capo_transcribe_streaming._operations.transcribe.start_medical_stream_transcription.start_medical_stream_transcription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_stream_transcription(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transcribe_streaming.types.start_stream_transcription_request.StartStreamTranscriptionRequest]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                capo_transcribe_streaming._operations.transcribe.start_stream_transcription.start_stream_transcription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
