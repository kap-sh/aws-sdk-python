...
if TYPE_CHECKING:
    import capo_transcribe_streaming.types.integer


class CharacterOffsets(TypedDict, closed=True):
    begin: NotRequired["capo_transcribe_streaming.types.integer.Integer"]
    ...
    end: NotRequired["capo_transcribe_streaming.types.integer.Integer"]
