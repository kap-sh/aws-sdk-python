...
if TYPE_CHECKING:
    ...
    import capo_transcribe_streaming.types.stable
...
class CallAnalyticsItem(TypedDict, closed=True):
    ...
    vocabulary_filter_match: "capo_transcribe_streaming.types.boolean.Boolean"
    ...
    stable: NotRequired["capo_transcribe_streaming.types.stable.Stable"]
