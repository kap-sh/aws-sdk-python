...
def handle_response(
    ...
    _union_deser = aws_sdk_transcribe_streaming.types.call_analytics_transcript_result_stream.deserialize_event_json
    _iter = cast(Any, response.iter_bytes())
    out: aws_sdk_transcribe_streaming.types.start_call_analytics_stream_transcription_response.StartCallAnalyticsStreamTranscriptionResponse = {
    ...
    if "x-amzn-transcribe-media-encoding" in response.headers:
        out["media_encoding"] = (
            aws_sdk_transcribe_streaming.types.media_encoding.deserialize_json(
    ...
    if "x-amzn-transcribe-vocabulary-filter-method" in response.headers:
        out["vocabulary_filter_method"] = (
            aws_sdk_transcribe_streaming.types.vocabulary_filter_method.deserialize_json(
    ...
    if "x-amzn-transcribe-partial-results-stability" in response.headers:
        out["partial_results_stability"] = (
            aws_sdk_transcribe_streaming.types.partial_results_stability.deserialize_json(
    ...
    if "x-amzn-transcribe-content-identification-type" in response.headers:
        out["content_identification_type"] = (
            aws_sdk_transcribe_streaming.types.content_identification_type.deserialize_json(
    ...
    if "x-amzn-transcribe-content-redaction-type" in response.headers:
        out["content_redaction_type"] = (
            aws_sdk_transcribe_streaming.types.content_redaction_type.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_transcribe_streaming.types.start_call_analytics_stream_transcription_request.StartCallAnalyticsStreamTranscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
