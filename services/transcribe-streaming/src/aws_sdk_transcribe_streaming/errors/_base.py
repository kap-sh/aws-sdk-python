...
class TranscribeStreamingError(Exception):
    """Base class for all TranscribeStreaming service errors."""


class ServiceError(TranscribeStreamingError):
...
class SerializationError(TranscribeStreamingError):
    """Raised when a value cannot be serialized."""


class DeserializationError(TranscribeStreamingError):
...
class WaiterFailedError(TranscribeStreamingError):
...
class WaiterTimeoutError(TranscribeStreamingError):
