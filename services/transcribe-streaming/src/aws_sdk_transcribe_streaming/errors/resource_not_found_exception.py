"""Generated from Smithy shape ``com.amazonaws.transcribestreaming#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.transcribestreaming#ResourceNotFoundException``."""
