"""Generated from Smithy shape ``com.amazonaws.transcribestreaming#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.transcribestreaming#ConflictException``."""
