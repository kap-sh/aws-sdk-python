...
from aws_sdk_transcribe_streaming._iter import ensure_sync_iterator
...
class TranscribeStreamingClientConfig(TypedDict, total=False):
...
class TranscribeStreamingClient:
    ...
    def get_medical_scribe_stream(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_transcribe_streaming.types.get_medical_scribe_stream_request.GetMedicalScribeStreamRequest]",
        ) -> OperationResponse[
            "aws_sdk_transcribe_streaming.types.get_medical_scribe_stream_response.GetMedicalScribeStreamResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_transcribe_streaming._operations.transcribe.get_medical_scribe_stream.get_medical_scribe_stream(
    ...
    def start_call_analytics_stream_transcription(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_transcribe_streaming.types.start_call_analytics_stream_transcription_request.StartCallAnalyticsStreamTranscriptionRequest]",
        ) -> OperationResponse[
            "aws_sdk_transcribe_streaming.types.start_call_analytics_stream_transcription_response.StartCallAnalyticsStreamTranscriptionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_transcribe_streaming._operations.transcribe.start_call_analytics_stream_transcription.start_call_analytics_stream_transcription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_medical_scribe_stream(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_transcribe_streaming.types.start_medical_scribe_stream_request.StartMedicalScribeStreamRequest]",
        ) -> OperationResponse[
            "aws_sdk_transcribe_streaming.types.start_medical_scribe_stream_response.StartMedicalScribeStreamResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_transcribe_streaming._operations.transcribe.start_medical_scribe_stream.start_medical_scribe_stream(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_medical_stream_transcription(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_transcribe_streaming.types.start_medical_stream_transcription_request.StartMedicalStreamTranscriptionRequest]",
        ) -> OperationResponse[
            "aws_sdk_transcribe_streaming.types.start_medical_stream_transcription_response.StartMedicalStreamTranscriptionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_transcribe_streaming._operations.transcribe.start_medical_stream_transcription.start_medical_stream_transcription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_stream_transcription(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_transcribe_streaming.types.start_stream_transcription_request.StartStreamTranscriptionRequest]",
        ) -> OperationResponse[
            "aws_sdk_transcribe_streaming.types.start_stream_transcription_response.StartStreamTranscriptionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_transcribe_streaming._operations.transcribe.start_stream_transcription.start_stream_transcription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
