...
class ApplicationCostProfilerError(Exception):
    """Base class for all ApplicationCostProfiler service errors."""


class ServiceError(ApplicationCostProfilerError):
...
class SerializationError(ApplicationCostProfilerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ApplicationCostProfilerError):
...
class WaiterFailedError(ApplicationCostProfilerError):
...
class WaiterTimeoutError(ApplicationCostProfilerError):
