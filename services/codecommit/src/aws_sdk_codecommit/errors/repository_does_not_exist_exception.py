"""Generated from Smithy shape ``com.amazonaws.codecommit#RepositoryDoesNotExistException``."""
...
class RepositoryDoesNotExistException_(TypedDict, closed=True):
    message: NotRequired["aws_sdk_codecommit.types.message.Message"]
    """<p>Any message associated with the exception.</p>"""


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: RepositoryDoesNotExistException_) -> dict:
    out: dict = {}
    if "message" in value:
...
class RepositoryDoesNotExistException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codecommit#RepositoryDoesNotExistException``."""
