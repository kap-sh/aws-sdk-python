...
class ApprovalRuleNameRequiredException_(TypedDict):
...
class ApprovalRuleNameRequiredException(ServiceError):
    ...
    def __init__(self, data: ApprovalRuleNameRequiredException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "ApprovalRuleNameRequiredException":
