...
class CodeCommitError(Exception):
    """Base class for all CodeCommit service errors."""


class ServiceError(CodeCommitError):
...
class SerializationError(CodeCommitError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CodeCommitError):
...
class WaiterFailedError(CodeCommitError):
...
class WaiterTimeoutError(CodeCommitError):
