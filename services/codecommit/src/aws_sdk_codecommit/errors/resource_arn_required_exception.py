"""Generated from Smithy shape ``com.amazonaws.codecommit#ResourceArnRequiredException``."""
...
class ResourceArnRequiredException_(TypedDict):
...
class ResourceArnRequiredException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codecommit#ResourceArnRequiredException``."""
