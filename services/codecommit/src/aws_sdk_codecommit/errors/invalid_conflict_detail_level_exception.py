...
class InvalidConflictDetailLevelException_(TypedDict):
...
class InvalidConflictDetailLevelException(ServiceError):
    ...
    def __init__(self, data: InvalidConflictDetailLevelException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "InvalidConflictDetailLevelException":
