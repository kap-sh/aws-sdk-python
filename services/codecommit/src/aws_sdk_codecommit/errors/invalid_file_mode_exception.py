"""Generated from Smithy shape ``com.amazonaws.codecommit#InvalidFileModeException``."""
...
class InvalidFileModeException_(TypedDict, closed=True):
    message: NotRequired["aws_sdk_codecommit.types.message.Message"]
    """<p>Any message associated with the exception.</p>"""


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: InvalidFileModeException_) -> dict:
    out: dict = {}
    if "message" in value:
...
class InvalidFileModeException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codecommit#InvalidFileModeException``."""
