...
class CreatePullRequestInput(TypedDict):
...
def serialize_aws_json_1_1(value: CreatePullRequestInput) -> dict:
    ...
    out["targets"] = aws_sdk_codecommit.types.target_list.serialize_aws_json_1_1(
        value["targets"]
    )
...
def deserialize_aws_json_1_1(data: dict) -> CreatePullRequestInput:
    ...
    if "targets" in data:
        ...
        out["targets"] = aws_sdk_codecommit.types.target_list.deserialize_aws_json_1_1(
            data["targets"]
        )
    else:
