...
class CreateCommitOutput(TypedDict):
    ...
    files_added: NotRequired["aws_sdk_codecommit.types.files_metadata.FilesMetadata"]
    """<p>The files added as part of the committed file changes.</p>"""
    files_updated: NotRequired["aws_sdk_codecommit.types.files_metadata.FilesMetadata"]
    """<p>The files updated as part of the commited file changes.</p>"""
    files_deleted: NotRequired["aws_sdk_codecommit.types.files_metadata.FilesMetadata"]
...
def serialize_aws_json_1_1(value: CreateCommitOutput) -> dict:
    ...
    if "files_added" in value:
        ...
        out["filesAdded"] = (
            aws_sdk_codecommit.types.files_metadata.serialize_aws_json_1_1(
                value["files_added"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> CreateCommitOutput:
    ...
    if "filesAdded" in data:
        ...
        out["files_added"] = (
            aws_sdk_codecommit.types.files_metadata.deserialize_aws_json_1_1(
                data["filesAdded"]
            )
        )
