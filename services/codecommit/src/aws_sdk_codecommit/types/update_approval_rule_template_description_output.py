...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateApprovalRuleTemplateDescriptionOutput) -> dict:
    out: dict = {}
    import aws_sdk_codecommit.types.approval_rule_template
...
def deserialize_aws_json_1_1(data: dict) -> UpdateApprovalRuleTemplateDescriptionOutput:
    out: UpdateApprovalRuleTemplateDescriptionOutput = {}  # type: ignore[typeddict-item]
    if "approvalRuleTemplate" in data:
        ...
        raise DeserializationError(
            "UpdateApprovalRuleTemplateDescriptionOutput.approval_rule_template required"
        )
    return out
