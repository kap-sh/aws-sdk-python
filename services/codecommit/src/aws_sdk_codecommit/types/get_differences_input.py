...
class GetDifferencesInput(TypedDict):
    ...
    before_path: NotRequired["aws_sdk_codecommit.types.path.Path"]
    ...
    after_path: NotRequired["aws_sdk_codecommit.types.path.Path"]
