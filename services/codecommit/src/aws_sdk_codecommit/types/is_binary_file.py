...
if TYPE_CHECKING:
    import aws_sdk_codecommit.types.capital_boolean


class IsBinaryFile(TypedDict):
    source: NotRequired["aws_sdk_codecommit.types.capital_boolean.CapitalBoolean"]
    """<p>The binary or non-binary status of file in the source of a merge or pull request.</p>"""
    destination: NotRequired["aws_sdk_codecommit.types.capital_boolean.CapitalBoolean"]
    """<p>The binary or non-binary status of a file in the destination of a merge or pull request.</p>"""
    base: NotRequired["aws_sdk_codecommit.types.capital_boolean.CapitalBoolean"]
