...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: MergePullRequestByFastForwardOutput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> MergePullRequestByFastForwardOutput:
    out: MergePullRequestByFastForwardOutput = {}  # type: ignore[typeddict-item]
