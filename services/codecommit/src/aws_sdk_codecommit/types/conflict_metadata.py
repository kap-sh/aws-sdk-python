...
if TYPE_CHECKING:
    ...
    import aws_sdk_codecommit.types.file_sizes
    import aws_sdk_codecommit.types.is_binary_file
    import aws_sdk_codecommit.types.is_content_conflict
    import aws_sdk_codecommit.types.is_file_mode_conflict
    import aws_sdk_codecommit.types.is_object_type_conflict
    import aws_sdk_codecommit.types.merge_operations
    import aws_sdk_codecommit.types.number_of_conflicts
    import aws_sdk_codecommit.types.object_types
...
class ConflictMetadata(TypedDict, closed=True):
    ...
    file_modes: NotRequired["aws_sdk_codecommit.types.file_modes.FileModes"]
    """<p>The file modes of the file in the source, destination, and base of the merge.</p>"""
    object_types: NotRequired["aws_sdk_codecommit.types.object_types.ObjectTypes"]
    """<p>Information about any object type conflicts in a merge operation.</p>"""
    number_of_conflicts: (
        "aws_sdk_codecommit.types.number_of_conflicts.NumberOfConflicts"
    )
    """<p>The number of conflicts, including both hunk conflicts and metadata conflicts.</p>"""
    is_binary_file: NotRequired["aws_sdk_codecommit.types.is_binary_file.IsBinaryFile"]
    ...
    content_conflict: "aws_sdk_codecommit.types.is_content_conflict.IsContentConflict"
    """<p>A boolean value indicating whether there are conflicts in the content of a file.</p>"""
    file_mode_conflict: (
        "aws_sdk_codecommit.types.is_file_mode_conflict.IsFileModeConflict"
    )
    """<p>A boolean value indicating whether there are conflicts in the file mode of a file.</p>"""
    object_type_conflict: (
        "aws_sdk_codecommit.types.is_object_type_conflict.IsObjectTypeConflict"
    )
    ...
    merge_operations: NotRequired[
        "aws_sdk_codecommit.types.merge_operations.MergeOperations"
    ]
...
def serialize_aws_json_1_1(value: ConflictMetadata) -> dict:
    ...
    if "file_sizes" in value:
        ...
        out["fileSizes"] = aws_sdk_codecommit.types.file_sizes.serialize_aws_json_1_1(
            value["file_sizes"]
        )
    if "file_modes" in value:
        import aws_sdk_codecommit.types.file_modes

        out["fileModes"] = aws_sdk_codecommit.types.file_modes.serialize_aws_json_1_1(
            value["file_modes"]
        )
    if "object_types" in value:
        ...
        out["objectTypes"] = (
            aws_sdk_codecommit.types.object_types.serialize_aws_json_1_1(
                value["object_types"]
            )
        )
    ...
    if "is_binary_file" in value:
        ...
        out["isBinaryFile"] = (
            aws_sdk_codecommit.types.is_binary_file.serialize_aws_json_1_1(
    ...
    if "merge_operations" in value:
        ...
        out["mergeOperations"] = (
            aws_sdk_codecommit.types.merge_operations.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ConflictMetadata:
    ...
    if "fileSizes" in data:
        ...
        out["file_sizes"] = (
            aws_sdk_codecommit.types.file_sizes.deserialize_aws_json_1_1(
                data["fileSizes"]
            )
        )
    if "fileModes" in data:
        ...
        out["file_modes"] = (
            aws_sdk_codecommit.types.file_modes.deserialize_aws_json_1_1(
                data["fileModes"]
            )
        )
    if "objectTypes" in data:
        ...
        out["object_types"] = (
            aws_sdk_codecommit.types.object_types.deserialize_aws_json_1_1(
                data["objectTypes"]
            )
        )
    ...
    if "isBinaryFile" in data:
        ...
        out["is_binary_file"] = (
            aws_sdk_codecommit.types.is_binary_file.deserialize_aws_json_1_1(
                data["isBinaryFile"]
            )
        )
    ...
    if "mergeOperations" in data:
        ...
        out["merge_operations"] = (
            aws_sdk_codecommit.types.merge_operations.deserialize_aws_json_1_1(
