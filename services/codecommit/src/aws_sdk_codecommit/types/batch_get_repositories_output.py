...
class BatchGetRepositoriesOutput(TypedDict):
    ...
    repositories_not_found: NotRequired[
        "aws_sdk_codecommit.types.repository_not_found_list.RepositoryNotFoundList"
    ]
    """<p>Returns a list of repository names for which information could not be found.</p>"""
    errors: NotRequired[
        "aws_sdk_codecommit.types.batch_get_repositories_errors_list.BatchGetRepositoriesErrorsList"
    ]
...
def serialize_aws_json_1_1(value: BatchGetRepositoriesOutput) -> dict:
    ...
    if "repositories" in value:
        ...
        out["repositories"] = (
            aws_sdk_codecommit.types.repository_metadata_list.serialize_aws_json_1_1(
                value["repositories"]
            )
        )
    if "repositories_not_found" in value:
        ...
        out["repositoriesNotFound"] = (
            aws_sdk_codecommit.types.repository_not_found_list.serialize_aws_json_1_1(
    ...
    if "errors" in value:
        ...
        out["errors"] = (
            aws_sdk_codecommit.types.batch_get_repositories_errors_list.serialize_aws_json_1_1(
                value["errors"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> BatchGetRepositoriesOutput:
    ...
    if "repositories" in data:
        ...
        out["repositories"] = (
            aws_sdk_codecommit.types.repository_metadata_list.deserialize_aws_json_1_1(
                data["repositories"]
            )
        )
    if "repositoriesNotFound" in data:
        ...
        out["repositories_not_found"] = (
            aws_sdk_codecommit.types.repository_not_found_list.deserialize_aws_json_1_1(
    ...
    if "errors" in data:
        ...
        out["errors"] = (
            aws_sdk_codecommit.types.batch_get_repositories_errors_list.deserialize_aws_json_1_1(
                data["errors"]
            )
        )
    return out
