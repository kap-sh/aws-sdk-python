"""Generated from Smithy shape ``com.amazonaws.codecommit#UntagResourceInput``."""
...
def serialize_aws_json_1_1(value: UntagResourceInput) -> dict:
    ...
    out["tagKeys"] = aws_sdk_codecommit.types.tag_keys_list.serialize_aws_json_1_1(
        value["tag_keys"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UntagResourceInput:
    ...
    if "tagKeys" in data:
        ...
        out["tag_keys"] = (
            aws_sdk_codecommit.types.tag_keys_list.deserialize_aws_json_1_1(
                data["tagKeys"]
            )
        )
    else:
