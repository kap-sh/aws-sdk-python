...
if TYPE_CHECKING:
    import aws_sdk_codecommit.types.batch_get_commits_error

BatchGetCommitsErrorsList: TypeAlias = list[
    "aws_sdk_codecommit.types.batch_get_commits_error.BatchGetCommitsError"
]
...
def serialize_aws_json_1_1(value: BatchGetCommitsErrorsList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_codecommit.types.batch_get_commits_error.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> BatchGetCommitsErrorsList:
    ...
    for item in data:
        out.append(
            aws_sdk_codecommit.types.batch_get_commits_error.deserialize_aws_json_1_1(
                item
            )
        )
    return out
