...
class BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput(TypedDict):
    ...
    errors: "aws_sdk_codecommit.types.batch_disassociate_approval_rule_template_from_repositories_errors_list.BatchDisassociateApprovalRuleTemplateFromRepositoriesErrorsList"
...
def serialize_aws_json_1_1(
    ...
    out["errors"] = (
        aws_sdk_codecommit.types.batch_disassociate_approval_rule_template_from_repositories_errors_list.serialize_aws_json_1_1(
            value["errors"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(
    ...
    if "errors" in data:
        ...
        out["errors"] = (
            aws_sdk_codecommit.types.batch_disassociate_approval_rule_template_from_repositories_errors_list.deserialize_aws_json_1_1(
                data["errors"]
            )
        )
    else:
