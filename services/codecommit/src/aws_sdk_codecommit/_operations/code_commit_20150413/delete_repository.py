...
def build_request(
    ...
    input: aws_sdk_codecommit.types.delete_repository_input.DeleteRepositoryInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.delete_repository_input.serialize_aws_json_1_1(input)
    ).encode()
