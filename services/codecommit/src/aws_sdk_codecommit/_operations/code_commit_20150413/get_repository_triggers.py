"""Generated from Smithy shape ``com.amazonaws.codecommit#GetRepositoryTriggers``."""
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.get_repository_triggers_output.GetRepositoryTriggersOutput = aws_sdk_codecommit.types.get_repository_triggers_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.get_repository_triggers_input.GetRepositoryTriggersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.get_repository_triggers_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_repository_triggers(
