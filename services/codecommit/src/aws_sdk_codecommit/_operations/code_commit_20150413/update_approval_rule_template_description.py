...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.update_approval_rule_template_description_output.UpdateApprovalRuleTemplateDescriptionOutput = aws_sdk_codecommit.types.update_approval_rule_template_description_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.update_approval_rule_template_description_input.UpdateApprovalRuleTemplateDescriptionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
