...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ApprovalStateRequiredException":
            import aws_sdk_codecommit.errors.approval_state_required_exception

            raise aws_sdk_codecommit.errors.approval_state_required_exception.ApprovalStateRequiredException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidApprovalStateException":
            import aws_sdk_codecommit.errors.invalid_approval_state_exception

            raise aws_sdk_codecommit.errors.invalid_approval_state_exception.InvalidApprovalStateException.from_aws_json_1_1(
                data
            )
        ...
        case "MaximumNumberOfApprovalsExceededException":
            import aws_sdk_codecommit.errors.maximum_number_of_approvals_exceeded_exception

            raise aws_sdk_codecommit.errors.maximum_number_of_approvals_exceeded_exception.MaximumNumberOfApprovalsExceededException.from_aws_json_1_1(
                data
            )
        ...
        case "PullRequestCannotBeApprovedByAuthorException":
            import aws_sdk_codecommit.errors.pull_request_cannot_be_approved_by_author_exception

            raise aws_sdk_codecommit.errors.pull_request_cannot_be_approved_by_author_exception.PullRequestCannotBeApprovedByAuthorException.from_aws_json_1_1(
                data
            )
