...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.get_merge_conflicts_input.GetMergeConflictsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.get_merge_conflicts_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
