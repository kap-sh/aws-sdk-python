...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDestinationCommitSpecifierException":
            import aws_sdk_codecommit.errors.invalid_destination_commit_specifier_exception

            raise aws_sdk_codecommit.errors.invalid_destination_commit_specifier_exception.InvalidDestinationCommitSpecifierException.from_aws_json_1_1(
                data
            )
        case "InvalidMaxConflictFilesException":
            import aws_sdk_codecommit.errors.invalid_max_conflict_files_exception

            raise aws_sdk_codecommit.errors.invalid_max_conflict_files_exception.InvalidMaxConflictFilesException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidSourceCommitSpecifierException":
            import aws_sdk_codecommit.errors.invalid_source_commit_specifier_exception

            raise aws_sdk_codecommit.errors.invalid_source_commit_specifier_exception.InvalidSourceCommitSpecifierException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.get_merge_conflicts_output.GetMergeConflictsOutput = (
        aws_sdk_codecommit.types.get_merge_conflicts_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_codecommit.types.get_merge_conflicts_input.GetMergeConflictsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.get_merge_conflicts_input.serialize_aws_json_1_1(input)
    ).encode()
