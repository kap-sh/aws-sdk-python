...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.create_approval_rule_template_input.CreateApprovalRuleTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.create_approval_rule_template_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
