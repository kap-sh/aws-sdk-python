...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ApprovalRuleTemplateInUseException":
            import aws_sdk_codecommit.errors.approval_rule_template_in_use_exception

            raise aws_sdk_codecommit.errors.approval_rule_template_in_use_exception.ApprovalRuleTemplateInUseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.delete_approval_rule_template_output.DeleteApprovalRuleTemplateOutput = aws_sdk_codecommit.types.delete_approval_rule_template_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.delete_approval_rule_template_input.DeleteApprovalRuleTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.delete_approval_rule_template_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
