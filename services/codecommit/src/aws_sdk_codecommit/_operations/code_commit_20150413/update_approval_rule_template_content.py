...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.update_approval_rule_template_content_output.UpdateApprovalRuleTemplateContentOutput = aws_sdk_codecommit.types.update_approval_rule_template_content_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.update_approval_rule_template_content_input.UpdateApprovalRuleTemplateContentInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.update_approval_rule_template_content_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
