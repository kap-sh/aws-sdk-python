"""Generated from Smithy shape ``com.amazonaws.codecommit#OverridePullRequestApprovalRules``."""
...
import aws_sdk_codecommit.errors.invalid_override_status_exception
...
import aws_sdk_codecommit.errors.override_already_set_exception
import aws_sdk_codecommit.errors.override_status_required_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidOverrideStatusException":
            raise aws_sdk_codecommit.errors.invalid_override_status_exception.InvalidOverrideStatusException.from_aws_json_1_1(
                data
            )
        ...
        case "OverrideAlreadySetException":
            raise aws_sdk_codecommit.errors.override_already_set_exception.OverrideAlreadySetException.from_aws_json_1_1(
                data
            )
        case "OverrideStatusRequiredException":
            raise aws_sdk_codecommit.errors.override_status_required_exception.OverrideStatusRequiredException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.override_pull_request_approval_rules_input.OverridePullRequestApprovalRulesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeCommit_20150413.OverridePullRequestApprovalRules"
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.override_pull_request_approval_rules_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_override_pull_request_approval_rules(
