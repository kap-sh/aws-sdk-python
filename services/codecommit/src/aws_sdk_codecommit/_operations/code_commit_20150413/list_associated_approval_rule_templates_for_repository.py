...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.list_associated_approval_rule_templates_for_repository_output.ListAssociatedApprovalRuleTemplatesForRepositoryOutput = aws_sdk_codecommit.types.list_associated_approval_rule_templates_for_repository_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.list_associated_approval_rule_templates_for_repository_input.ListAssociatedApprovalRuleTemplatesForRepositoryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.list_associated_approval_rule_templates_for_repository_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
