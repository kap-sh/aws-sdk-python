...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTagKeysListException":
            import aws_sdk_codecommit.errors.invalid_tag_keys_list_exception

            raise aws_sdk_codecommit.errors.invalid_tag_keys_list_exception.InvalidTagKeysListException.from_aws_json_1_1(
                data
            )
        ...
        case "TagKeysListRequiredException":
            import aws_sdk_codecommit.errors.tag_keys_list_required_exception

            raise aws_sdk_codecommit.errors.tag_keys_list_required_exception.TagKeysListRequiredException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.untag_resource_input.UntagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.untag_resource_input.serialize_aws_json_1_1(input_)
    ).encode()
