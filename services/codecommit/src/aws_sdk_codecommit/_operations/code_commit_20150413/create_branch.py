"""Generated from Smithy shape ``com.amazonaws.codecommit#CreateBranch``."""
...
import aws_sdk_codecommit.errors.branch_name_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BranchNameExistsException":
            raise aws_sdk_codecommit.errors.branch_name_exists_exception.BranchNameExistsException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.create_branch_input.CreateBranchInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.create_branch_input.serialize_aws_json_1_1(input_)
    ).encode()
