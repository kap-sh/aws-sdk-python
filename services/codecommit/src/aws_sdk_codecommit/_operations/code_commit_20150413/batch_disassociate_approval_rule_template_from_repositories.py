...
import aws_sdk_codecommit.types.batch_disassociate_approval_rule_template_from_repositories_errors_list
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.batch_disassociate_approval_rule_template_from_repositories_output.BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput = aws_sdk_codecommit.types.batch_disassociate_approval_rule_template_from_repositories_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.batch_disassociate_approval_rule_template_from_repositories_input.BatchDisassociateApprovalRuleTemplateFromRepositoriesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.batch_disassociate_approval_rule_template_from_repositories_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
