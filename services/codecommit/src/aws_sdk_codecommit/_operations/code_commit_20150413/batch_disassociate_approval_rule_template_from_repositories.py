...
def build_request(
    ...
    input: aws_sdk_codecommit.types.batch_disassociate_approval_rule_template_from_repositories_input.BatchDisassociateApprovalRuleTemplateFromRepositoriesInput,
) -> zapros.Request:
