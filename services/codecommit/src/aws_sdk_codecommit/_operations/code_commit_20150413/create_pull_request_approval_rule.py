...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ApprovalRuleNameAlreadyExistsException":
            import aws_sdk_codecommit.errors.approval_rule_name_already_exists_exception

            raise aws_sdk_codecommit.errors.approval_rule_name_already_exists_exception.ApprovalRuleNameAlreadyExistsException.from_aws_json_1_1(
                data
            )
        ...
        case "NumberOfRulesExceededException":
            import aws_sdk_codecommit.errors.number_of_rules_exceeded_exception

            raise aws_sdk_codecommit.errors.number_of_rules_exceeded_exception.NumberOfRulesExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.create_pull_request_approval_rule_output.CreatePullRequestApprovalRuleOutput = aws_sdk_codecommit.types.create_pull_request_approval_rule_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.create_pull_request_approval_rule_input.CreatePullRequestApprovalRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.create_pull_request_approval_rule_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
