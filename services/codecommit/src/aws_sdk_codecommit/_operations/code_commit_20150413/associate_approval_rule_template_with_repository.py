...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MaximumRuleTemplatesAssociatedWithRepositoryException":
            import aws_sdk_codecommit.errors.maximum_rule_templates_associated_with_repository_exception

            raise aws_sdk_codecommit.errors.maximum_rule_templates_associated_with_repository_exception.MaximumRuleTemplatesAssociatedWithRepositoryException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.associate_approval_rule_template_with_repository_input.AssociateApprovalRuleTemplateWithRepositoryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.associate_approval_rule_template_with_repository_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
