"""Generated from Smithy shape ``com.amazonaws.codecommit#GetPullRequestApprovalStates``."""
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.get_pull_request_approval_states_output.GetPullRequestApprovalStatesOutput = aws_sdk_codecommit.types.get_pull_request_approval_states_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.get_pull_request_approval_states_input.GetPullRequestApprovalStatesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.get_pull_request_approval_states_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_pull_request_approval_states(
