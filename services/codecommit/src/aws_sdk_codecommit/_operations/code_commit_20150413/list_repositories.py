...
def build_request(
    ...
    input: aws_sdk_codecommit.types.list_repositories_input.ListRepositoriesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.list_repositories_input.serialize_aws_json_1_1(input)
    ).encode()
