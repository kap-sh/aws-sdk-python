...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidOrderException":
            import aws_sdk_codecommit.errors.invalid_order_exception

            raise aws_sdk_codecommit.errors.invalid_order_exception.InvalidOrderException.from_aws_json_1_1(
                data
            )
        case "InvalidSortByException":
            import aws_sdk_codecommit.errors.invalid_sort_by_exception

            raise aws_sdk_codecommit.errors.invalid_sort_by_exception.InvalidSortByException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.list_repositories_output.ListRepositoriesOutput = (
        aws_sdk_codecommit.types.list_repositories_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.list_repositories_input.ListRepositoriesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.list_repositories_input.serialize_aws_json_1_1(input_)
    ).encode()
