...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.update_pull_request_title_input.UpdatePullRequestTitleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.update_pull_request_title_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
