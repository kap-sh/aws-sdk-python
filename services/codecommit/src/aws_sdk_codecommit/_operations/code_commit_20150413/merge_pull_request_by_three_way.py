...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.merge_pull_request_by_three_way_output.MergePullRequestByThreeWayOutput = aws_sdk_codecommit.types.merge_pull_request_by_three_way_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.merge_pull_request_by_three_way_input.MergePullRequestByThreeWayInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.merge_pull_request_by_three_way_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
