...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.get_approval_rule_template_output.GetApprovalRuleTemplateOutput = aws_sdk_codecommit.types.get_approval_rule_template_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.get_approval_rule_template_input.GetApprovalRuleTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.get_approval_rule_template_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
