"""Generated from Smithy shape ``com.amazonaws.codecommit#UpdateRepositoryDescription``."""
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.update_repository_description_input.UpdateRepositoryDescriptionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.update_repository_description_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_repository_description(
