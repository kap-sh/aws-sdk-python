"""Generated from Smithy shape ``com.amazonaws.codecommit#GetFolder``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FolderDoesNotExistException":
            import aws_sdk_codecommit.errors.folder_does_not_exist_exception

            raise aws_sdk_codecommit.errors.folder_does_not_exist_exception.FolderDoesNotExistException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.get_folder_output.GetFolderOutput = (
        aws_sdk_codecommit.types.get_folder_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.get_folder_input.GetFolderInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.get_folder_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_folder(
    ...
    input_: aws_sdk_codecommit.types.get_folder_input.GetFolderInput,
) -> tuple[aws_sdk_codecommit.types.get_folder_output.GetFolderOutput, zapros.Response]:
