...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CommitIdDoesNotExistException":
            import aws_sdk_codecommit.errors.commit_id_does_not_exist_exception

            raise aws_sdk_codecommit.errors.commit_id_does_not_exist_exception.CommitIdDoesNotExistException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.get_commit_output.GetCommitOutput = (
        aws_sdk_codecommit.types.get_commit_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.get_commit_input.GetCommitInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.get_commit_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_commit(
    ...
    input_: aws_sdk_codecommit.types.get_commit_input.GetCommitInput,
) -> tuple[aws_sdk_codecommit.types.get_commit_output.GetCommitOutput, zapros.Response]:
