...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPullRequestStatusException":
            import aws_sdk_codecommit.errors.invalid_pull_request_status_exception

            raise aws_sdk_codecommit.errors.invalid_pull_request_status_exception.InvalidPullRequestStatusException.from_aws_json_1_1(
                data
            )
        case "InvalidPullRequestStatusUpdateException":
            import aws_sdk_codecommit.errors.invalid_pull_request_status_update_exception

            raise aws_sdk_codecommit.errors.invalid_pull_request_status_update_exception.InvalidPullRequestStatusUpdateException.from_aws_json_1_1(
                data
            )
        ...
        case "PullRequestStatusRequiredException":
            import aws_sdk_codecommit.errors.pull_request_status_required_exception

            raise aws_sdk_codecommit.errors.pull_request_status_required_exception.PullRequestStatusRequiredException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.update_pull_request_status_output.UpdatePullRequestStatusOutput = aws_sdk_codecommit.types.update_pull_request_status_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.update_pull_request_status_input.UpdatePullRequestStatusInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.update_pull_request_status_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
