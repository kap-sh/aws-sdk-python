...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.get_file_output.GetFileOutput = (
        aws_sdk_codecommit.types.get_file_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_codecommit.types.get_file_input.GetFileInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.get_file_input.serialize_aws_json_1_1(input)
    ).encode()
...
def get_file(
    ...
    input: aws_sdk_codecommit.types.get_file_input.GetFileInput,
) -> tuple[aws_sdk_codecommit.types.get_file_output.GetFileOutput, zapros.Response]:
