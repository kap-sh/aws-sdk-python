...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.get_pull_request_override_state_output.GetPullRequestOverrideStateOutput = aws_sdk_codecommit.types.get_pull_request_override_state_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.get_pull_request_override_state_input.GetPullRequestOverrideStateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.get_pull_request_override_state_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
