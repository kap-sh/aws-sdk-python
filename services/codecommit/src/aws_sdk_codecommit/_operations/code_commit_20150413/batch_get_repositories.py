...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.batch_get_repositories_input.BatchGetRepositoriesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.batch_get_repositories_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
