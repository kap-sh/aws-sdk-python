...
def build_request(
    ...
    input: aws_sdk_codecommit.types.get_merge_options_input.GetMergeOptionsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.get_merge_options_input.serialize_aws_json_1_1(input)
    ).encode()
