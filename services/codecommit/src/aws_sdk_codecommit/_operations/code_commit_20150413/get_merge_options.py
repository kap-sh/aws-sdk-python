"""Generated from Smithy shape ``com.amazonaws.codecommit#GetMergeOptions``."""
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.get_merge_options_output.GetMergeOptionsOutput = (
        aws_sdk_codecommit.types.get_merge_options_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.get_merge_options_input.GetMergeOptionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.get_merge_options_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_merge_options(
