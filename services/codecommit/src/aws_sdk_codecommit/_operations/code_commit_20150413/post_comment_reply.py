...
def build_request(
    ...
    input: aws_sdk_codecommit.types.post_comment_reply_input.PostCommentReplyInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.post_comment_reply_input.serialize_aws_json_1_1(input)
    ).encode()
