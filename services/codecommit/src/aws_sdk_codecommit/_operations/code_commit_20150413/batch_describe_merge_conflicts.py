...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidMaxMergeHunksException":
            import aws_sdk_codecommit.errors.invalid_max_merge_hunks_exception

            raise aws_sdk_codecommit.errors.invalid_max_merge_hunks_exception.InvalidMaxMergeHunksException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.batch_describe_merge_conflicts_output.BatchDescribeMergeConflictsOutput = aws_sdk_codecommit.types.batch_describe_merge_conflicts_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.batch_describe_merge_conflicts_input.BatchDescribeMergeConflictsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
