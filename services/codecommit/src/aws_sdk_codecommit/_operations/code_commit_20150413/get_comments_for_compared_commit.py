...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.get_comments_for_compared_commit_output.GetCommentsForComparedCommitOutput = aws_sdk_codecommit.types.get_comments_for_compared_commit_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.get_comments_for_compared_commit_input.GetCommentsForComparedCommitInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.get_comments_for_compared_commit_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
