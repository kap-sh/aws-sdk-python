"""Generated from Smithy shape ``com.amazonaws.codecommit#DisassociateApprovalRuleTemplateFromRepository``."""
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.disassociate_approval_rule_template_from_repository_input.DisassociateApprovalRuleTemplateFromRepositoryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_disassociate_approval_rule_template_from_repository(
