...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.delete_file_output.DeleteFileOutput = (
        aws_sdk_codecommit.types.delete_file_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.delete_file_input.DeleteFileInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.delete_file_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_file(
    ...
    aws_sdk_codecommit.types.delete_file_output.DeleteFileOutput, zapros.Response
]:
