"""Generated from Smithy shape ``com.amazonaws.codecommit#UpdatePullRequestDescription``."""
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.update_pull_request_description_output.UpdatePullRequestDescriptionOutput = aws_sdk_codecommit.types.update_pull_request_description_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.update_pull_request_description_input.UpdatePullRequestDescriptionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.update_pull_request_description_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_pull_request_description(
