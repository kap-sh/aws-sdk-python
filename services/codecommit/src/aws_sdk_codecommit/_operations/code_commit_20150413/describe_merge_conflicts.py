...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.describe_merge_conflicts_output.DescribeMergeConflictsOutput = aws_sdk_codecommit.types.describe_merge_conflicts_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.describe_merge_conflicts_input.DescribeMergeConflictsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.describe_merge_conflicts_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
