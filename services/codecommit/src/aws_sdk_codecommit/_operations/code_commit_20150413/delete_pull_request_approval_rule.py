...
import aws_sdk_codecommit.errors.cannot_delete_approval_rule_from_template_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CannotDeleteApprovalRuleFromTemplateException":
            raise aws_sdk_codecommit.errors.cannot_delete_approval_rule_from_template_exception.CannotDeleteApprovalRuleFromTemplateException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.delete_pull_request_approval_rule_output.DeletePullRequestApprovalRuleOutput = aws_sdk_codecommit.types.delete_pull_request_approval_rule_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.delete_pull_request_approval_rule_input.DeletePullRequestApprovalRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.delete_pull_request_approval_rule_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
