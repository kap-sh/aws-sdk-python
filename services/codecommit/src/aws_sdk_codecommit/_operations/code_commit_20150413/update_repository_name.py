...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.update_repository_name_input.UpdateRepositoryNameInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.update_repository_name_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
