...
def build_request(
    ...
    input: aws_sdk_codecommit.types.list_pull_requests_input.ListPullRequestsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.list_pull_requests_input.serialize_aws_json_1_1(input)
    ).encode()
