...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AuthorDoesNotExistException":
            import aws_sdk_codecommit.errors.author_does_not_exist_exception

            raise aws_sdk_codecommit.errors.author_does_not_exist_exception.AuthorDoesNotExistException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidAuthorArnException":
            import aws_sdk_codecommit.errors.invalid_author_arn_exception

            raise aws_sdk_codecommit.errors.invalid_author_arn_exception.InvalidAuthorArnException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.list_pull_requests_output.ListPullRequestsOutput = (
        aws_sdk_codecommit.types.list_pull_requests_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.list_pull_requests_input.ListPullRequestsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.list_pull_requests_input.serialize_aws_json_1_1(input_)
    ).encode()
