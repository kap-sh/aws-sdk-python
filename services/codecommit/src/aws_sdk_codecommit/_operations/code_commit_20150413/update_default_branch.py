...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.update_default_branch_input.UpdateDefaultBranchInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.update_default_branch_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
