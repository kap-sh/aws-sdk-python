...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.get_comment_output.GetCommentOutput = (
        aws_sdk_codecommit.types.get_comment_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.get_comment_input.GetCommentInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.get_comment_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_comment(
    ...
    aws_sdk_codecommit.types.get_comment_output.GetCommentOutput, zapros.Response
]:
