"""Generated from Smithy shape ``com.amazonaws.codecommit#PutFile``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FileContentRequiredException":
            import aws_sdk_codecommit.errors.file_content_required_exception

            raise aws_sdk_codecommit.errors.file_content_required_exception.FileContentRequiredException.from_aws_json_1_1(
                data
            )
        ...
        case "SameFileContentException":
            import aws_sdk_codecommit.errors.same_file_content_exception

            raise aws_sdk_codecommit.errors.same_file_content_exception.SameFileContentException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.put_file_output.PutFileOutput = (
        aws_sdk_codecommit.types.put_file_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.put_file_input.PutFileInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.put_file_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_file(
    ...
    input_: aws_sdk_codecommit.types.put_file_input.PutFileInput,
) -> tuple[aws_sdk_codecommit.types.put_file_output.PutFileOutput, zapros.Response]:
