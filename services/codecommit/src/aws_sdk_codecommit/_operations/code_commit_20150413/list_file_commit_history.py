...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.list_file_commit_history_response.ListFileCommitHistoryResponse = aws_sdk_codecommit.types.list_file_commit_history_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.list_file_commit_history_request.ListFileCommitHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
