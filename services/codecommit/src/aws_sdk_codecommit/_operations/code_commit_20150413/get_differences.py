...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.get_differences_output.GetDifferencesOutput = (
        aws_sdk_codecommit.types.get_differences_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.get_differences_input.GetDifferencesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.get_differences_input.serialize_aws_json_1_1(input_)
    ).encode()
