...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DefaultBranchCannotBeDeletedException":
            import aws_sdk_codecommit.errors.default_branch_cannot_be_deleted_exception

            raise aws_sdk_codecommit.errors.default_branch_cannot_be_deleted_exception.DefaultBranchCannotBeDeletedException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.delete_branch_output.DeleteBranchOutput = (
        aws_sdk_codecommit.types.delete_branch_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.delete_branch_input.DeleteBranchInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.delete_branch_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_branch(
    ...
    aws_sdk_codecommit.types.delete_branch_output.DeleteBranchOutput, zapros.Response
]:
