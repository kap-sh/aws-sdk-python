"""Generated from Smithy shape ``com.amazonaws.codecommit#GetRepository``."""
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.get_repository_output.GetRepositoryOutput = (
        aws_sdk_codecommit.types.get_repository_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.get_repository_input.GetRepositoryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.get_repository_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_repository(
    ...
    aws_sdk_codecommit.types.get_repository_output.GetRepositoryOutput, zapros.Response
]:
