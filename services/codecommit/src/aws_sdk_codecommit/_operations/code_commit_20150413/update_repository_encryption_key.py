...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EncryptionKeyRequiredException":
            import aws_sdk_codecommit.errors.encryption_key_required_exception

            raise aws_sdk_codecommit.errors.encryption_key_required_exception.EncryptionKeyRequiredException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.update_repository_encryption_key_output.UpdateRepositoryEncryptionKeyOutput = aws_sdk_codecommit.types.update_repository_encryption_key_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.update_repository_encryption_key_input.UpdateRepositoryEncryptionKeyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.update_repository_encryption_key_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
