...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.list_approval_rule_templates_output.ListApprovalRuleTemplatesOutput = aws_sdk_codecommit.types.list_approval_rule_templates_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.list_approval_rule_templates_input.ListApprovalRuleTemplatesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.list_approval_rule_templates_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
