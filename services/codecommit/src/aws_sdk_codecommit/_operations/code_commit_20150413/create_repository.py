...
def build_request(
    ...
    input: aws_sdk_codecommit.types.create_repository_input.CreateRepositoryInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.create_repository_input.serialize_aws_json_1_1(input)
    ).encode()
