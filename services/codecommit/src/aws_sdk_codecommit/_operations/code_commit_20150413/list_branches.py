...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.list_branches_output.ListBranchesOutput = (
        aws_sdk_codecommit.types.list_branches_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_codecommit.types.list_branches_input.ListBranchesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.list_branches_input.serialize_aws_json_1_1(input)
    ).encode()
...
def list_branches(
    ...
    aws_sdk_codecommit.types.list_branches_output.ListBranchesOutput, zapros.Response
]:
