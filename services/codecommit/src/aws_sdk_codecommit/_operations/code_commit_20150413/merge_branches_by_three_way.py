...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTargetBranchException":
            import aws_sdk_codecommit.errors.invalid_target_branch_exception

            raise aws_sdk_codecommit.errors.invalid_target_branch_exception.InvalidTargetBranchException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.merge_branches_by_three_way_output.MergeBranchesByThreeWayOutput = aws_sdk_codecommit.types.merge_branches_by_three_way_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.merge_branches_by_three_way_input.MergeBranchesByThreeWayInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.merge_branches_by_three_way_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
