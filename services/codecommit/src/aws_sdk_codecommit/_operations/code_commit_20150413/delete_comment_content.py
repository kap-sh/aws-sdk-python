...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.delete_comment_content_output.DeleteCommentContentOutput = aws_sdk_codecommit.types.delete_comment_content_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.delete_comment_content_input.DeleteCommentContentInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.delete_comment_content_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
