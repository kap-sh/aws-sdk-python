...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.list_repositories_for_approval_rule_template_output.ListRepositoriesForApprovalRuleTemplateOutput = aws_sdk_codecommit.types.list_repositories_for_approval_rule_template_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.list_repositories_for_approval_rule_template_input.ListRepositoriesForApprovalRuleTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.list_repositories_for_approval_rule_template_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
