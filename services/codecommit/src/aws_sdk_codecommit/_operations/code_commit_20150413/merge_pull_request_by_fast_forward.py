"""Generated from Smithy shape ``com.amazonaws.codecommit#MergePullRequestByFastForward``."""
...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.merge_pull_request_by_fast_forward_output.MergePullRequestByFastForwardOutput = aws_sdk_codecommit.types.merge_pull_request_by_fast_forward_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.merge_pull_request_by_fast_forward_input.MergePullRequestByFastForwardInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.merge_pull_request_by_fast_forward_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_merge_pull_request_by_fast_forward(
