...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.merge_branches_by_fast_forward_output.MergeBranchesByFastForwardOutput = aws_sdk_codecommit.types.merge_branches_by_fast_forward_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.merge_branches_by_fast_forward_input.MergeBranchesByFastForwardInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codecommit.types.merge_branches_by_fast_forward_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
