...
def handle_response(
    ...
    out: aws_sdk_codecommit.types.batch_associate_approval_rule_template_with_repositories_output.BatchAssociateApprovalRuleTemplateWithRepositoriesOutput = aws_sdk_codecommit.types.batch_associate_approval_rule_template_with_repositories_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codecommit.types.batch_associate_approval_rule_template_with_repositories_input.BatchAssociateApprovalRuleTemplateWithRepositoriesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
