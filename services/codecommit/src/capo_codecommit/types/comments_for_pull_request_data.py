...
if TYPE_CHECKING:
    import capo_codecommit.types.comments_for_pull_request

CommentsForPullRequestData: TypeAlias = list[
    "capo_codecommit.types.comments_for_pull_request.CommentsForPullRequest"
]
...
def serialize_aws_json_1_1(value: CommentsForPullRequestData) -> list:
    ...
    for item in value:
        out.append(
            capo_codecommit.types.comments_for_pull_request.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> CommentsForPullRequestData:
    ...
    for item in data:
        out.append(
            capo_codecommit.types.comments_for_pull_request.deserialize_aws_json_1_1(
                item
            )
        )
    return out
