...
def serialize_aws_json_1_1(value: ConflictResolution) -> dict:
    ...
    if "replace_contents" in value:
        ...
        out["replaceContents"] = (
            capo_codecommit.types.replace_content_entries.serialize_aws_json_1_1(
    ...
    if "delete_files" in value:
        ...
        out["deleteFiles"] = (
            capo_codecommit.types.delete_file_entries.serialize_aws_json_1_1(
                value["delete_files"]
            )
        )
    if "set_file_modes" in value:
        ...
        out["setFileModes"] = (
            capo_codecommit.types.set_file_mode_entries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ConflictResolution:
    ...
    if "replaceContents" in data:
        ...
        out["replace_contents"] = (
            capo_codecommit.types.replace_content_entries.deserialize_aws_json_1_1(
    ...
    if "deleteFiles" in data:
        ...
        out["delete_files"] = (
            capo_codecommit.types.delete_file_entries.deserialize_aws_json_1_1(
                data["deleteFiles"]
            )
        )
    if "setFileModes" in data:
        ...
        out["set_file_modes"] = (
            capo_codecommit.types.set_file_mode_entries.deserialize_aws_json_1_1(
                data["setFileModes"]
            )
        )
    return out
