...
class FileVersion(TypedDict, closed=True):
    commit: NotRequired["capo_codecommit.types.commit.Commit"]
    ...
    path: NotRequired["capo_codecommit.types.path.Path"]
    ...
    revision_children: NotRequired[
        "capo_codecommit.types.revision_children.RevisionChildren"
    ]
...
def serialize_aws_json_1_1(value: FileVersion) -> dict:
    ...
    if "commit" in value:
        ...
        out["commit"] = capo_codecommit.types.commit.serialize_aws_json_1_1(
            value["commit"]
        )
    if "blob_id" in value:
    ...
    if "revision_children" in value:
        ...
        out["revisionChildren"] = (
            capo_codecommit.types.revision_children.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> FileVersion:
    ...
    if "revisionChildren" in data:
        ...
        out["revision_children"] = (
            capo_codecommit.types.revision_children.deserialize_aws_json_1_1(
