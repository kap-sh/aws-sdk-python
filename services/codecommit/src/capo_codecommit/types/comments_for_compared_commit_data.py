...
if TYPE_CHECKING:
    import capo_codecommit.types.comments_for_compared_commit

CommentsForComparedCommitData: TypeAlias = list[
    "capo_codecommit.types.comments_for_compared_commit.CommentsForComparedCommit"
]
...
def serialize_aws_json_1_1(value: CommentsForComparedCommitData) -> list:
    ...
    for item in value:
        out.append(
            capo_codecommit.types.comments_for_compared_commit.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> CommentsForComparedCommitData:
    ...
    for item in data:
        out.append(
            capo_codecommit.types.comments_for_compared_commit.deserialize_aws_json_1_1(
                item
            )
        )
    return out
