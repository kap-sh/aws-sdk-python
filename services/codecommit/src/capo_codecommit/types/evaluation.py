...
if TYPE_CHECKING:
    ...
    import capo_codecommit.types.approved
    import capo_codecommit.types.overridden


class Evaluation(TypedDict, closed=True):
    approved: "capo_codecommit.types.approved.Approved"
    ...
    approval_rules_satisfied: NotRequired[
        "capo_codecommit.types.approval_rules_satisfied_list.ApprovalRulesSatisfiedList"
    ]
    """<p>The names of the approval rules that have had their conditions met.</p>"""
    approval_rules_not_satisfied: NotRequired[
        "capo_codecommit.types.approval_rules_not_satisfied_list.ApprovalRulesNotSatisfiedList"
    ]
...
def serialize_aws_json_1_1(value: Evaluation) -> dict:
    ...
    if "approval_rules_satisfied" in value:
        ...
        out["approvalRulesSatisfied"] = (
            capo_codecommit.types.approval_rules_satisfied_list.serialize_aws_json_1_1(
    ...
    if "approval_rules_not_satisfied" in value:
        ...
        out["approvalRulesNotSatisfied"] = (
            capo_codecommit.types.approval_rules_not_satisfied_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Evaluation:
    ...
    if "approvalRulesSatisfied" in data:
        ...
        out["approval_rules_satisfied"] = (
            capo_codecommit.types.approval_rules_satisfied_list.deserialize_aws_json_1_1(
    ...
    if "approvalRulesNotSatisfied" in data:
        ...
        out["approval_rules_not_satisfied"] = (
            capo_codecommit.types.approval_rules_not_satisfied_list.deserialize_aws_json_1_1(
