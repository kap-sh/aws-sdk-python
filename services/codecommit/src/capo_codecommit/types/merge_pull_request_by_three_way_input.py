"""Generated from Smithy shape ``com.amazonaws.codecommit#MergePullRequestByThreeWayInput``."""
...
class MergePullRequestByThreeWayInput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: MergePullRequestByThreeWayInput) -> dict:
    out: dict = {}
