...
class PullRequestTarget(TypedDict, closed=True):
    ...
    source_reference: NotRequired["capo_codecommit.types.reference_name.ReferenceName"]
    ...
    destination_commit: NotRequired["capo_codecommit.types.commit_id.CommitId"]
    ...
    source_commit: NotRequired["capo_codecommit.types.commit_id.CommitId"]
