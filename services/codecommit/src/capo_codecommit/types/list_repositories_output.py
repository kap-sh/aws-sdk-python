...
class ListRepositoriesOutput(TypedDict, closed=True):
    repositories: NotRequired[
        "capo_codecommit.types.repository_name_id_pair_list.RepositoryNameIdPairList"
    ]
...
def serialize_aws_json_1_1(value: ListRepositoriesOutput) -> dict:
    ...
    if "repositories" in value:
        ...
        out["repositories"] = (
            capo_codecommit.types.repository_name_id_pair_list.serialize_aws_json_1_1(
                value["repositories"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListRepositoriesOutput:
    ...
    if "repositories" in data:
        ...
        out["repositories"] = (
            capo_codecommit.types.repository_name_id_pair_list.deserialize_aws_json_1_1(
                data["repositories"]
            )
        )
