...
class CreatePullRequestApprovalRuleOutput(TypedDict, closed=True):
    approval_rule: "capo_codecommit.types.approval_rule.ApprovalRule"
...
def serialize_aws_json_1_1(value: CreatePullRequestApprovalRuleOutput) -> dict:
    ...
    out["approvalRule"] = capo_codecommit.types.approval_rule.serialize_aws_json_1_1(
        value["approval_rule"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CreatePullRequestApprovalRuleOutput:
    ...
    if "approvalRule" in data:
        ...
        out["approval_rule"] = (
            capo_codecommit.types.approval_rule.deserialize_aws_json_1_1(
                data["approvalRule"]
            )
        )
    else:
