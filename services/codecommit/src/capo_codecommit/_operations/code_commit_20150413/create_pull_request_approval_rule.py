"""Generated from Smithy shape ``com.amazonaws.codecommit#CreatePullRequestApprovalRule``."""
...
import capo_codecommit.errors.approval_rule_name_already_exists_exception
...
import capo_codecommit.errors.number_of_rules_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ApprovalRuleNameAlreadyExistsException":
            raise capo_codecommit.errors.approval_rule_name_already_exists_exception.ApprovalRuleNameAlreadyExistsException.from_aws_json_1_1(
                data
            )
        ...
        case "NumberOfRulesExceededException":
            raise capo_codecommit.errors.number_of_rules_exceeded_exception.NumberOfRulesExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.create_pull_request_approval_rule_output.CreatePullRequestApprovalRuleOutput = capo_codecommit.types.create_pull_request_approval_rule_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.create_pull_request_approval_rule_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_pull_request_approval_rule(
