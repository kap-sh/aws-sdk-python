"""Generated from Smithy shape ``com.amazonaws.codecommit#ListRepositoriesForApprovalRuleTemplate``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.list_repositories_for_approval_rule_template_output.ListRepositoriesForApprovalRuleTemplateOutput = capo_codecommit.types.list_repositories_for_approval_rule_template_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.list_repositories_for_approval_rule_template_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_repositories_for_approval_rule_template(
