"""Generated from Smithy shape ``com.amazonaws.codecommit#DeletePullRequestApprovalRule``."""
...
import capo_codecommit.errors.cannot_delete_approval_rule_from_template_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CannotDeleteApprovalRuleFromTemplateException":
            raise capo_codecommit.errors.cannot_delete_approval_rule_from_template_exception.CannotDeleteApprovalRuleFromTemplateException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.delete_pull_request_approval_rule_output.DeletePullRequestApprovalRuleOutput = capo_codecommit.types.delete_pull_request_approval_rule_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.delete_pull_request_approval_rule_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_pull_request_approval_rule(
