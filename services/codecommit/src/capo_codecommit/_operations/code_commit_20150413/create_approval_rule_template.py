"""Generated from Smithy shape ``com.amazonaws.codecommit#CreateApprovalRuleTemplate``."""
...
import capo_codecommit.errors.approval_rule_template_content_required_exception
import capo_codecommit.errors.approval_rule_template_name_already_exists_exception
import capo_codecommit.errors.approval_rule_template_name_required_exception
import capo_codecommit.errors.invalid_approval_rule_template_content_exception
import capo_codecommit.errors.invalid_approval_rule_template_description_exception
import capo_codecommit.errors.invalid_approval_rule_template_name_exception
import capo_codecommit.errors.number_of_rule_templates_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ApprovalRuleTemplateContentRequiredException":
            raise capo_codecommit.errors.approval_rule_template_content_required_exception.ApprovalRuleTemplateContentRequiredException.from_aws_json_1_1(
                data
            )
        case "ApprovalRuleTemplateNameAlreadyExistsException":
            raise capo_codecommit.errors.approval_rule_template_name_already_exists_exception.ApprovalRuleTemplateNameAlreadyExistsException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidApprovalRuleTemplateContentException":
            raise capo_codecommit.errors.invalid_approval_rule_template_content_exception.InvalidApprovalRuleTemplateContentException.from_aws_json_1_1(
                data
            )
        case "InvalidApprovalRuleTemplateDescriptionException":
            raise capo_codecommit.errors.invalid_approval_rule_template_description_exception.InvalidApprovalRuleTemplateDescriptionException.from_aws_json_1_1(
                data
            )
        ...
        case "NumberOfRuleTemplatesExceededException":
            raise capo_codecommit.errors.number_of_rule_templates_exceeded_exception.NumberOfRuleTemplatesExceededException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_codecommit.types.create_approval_rule_template_output.CreateApprovalRuleTemplateOutput = capo_codecommit.types.create_approval_rule_template_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.create_approval_rule_template_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_approval_rule_template(
