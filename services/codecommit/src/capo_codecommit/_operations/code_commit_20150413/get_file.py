"""Generated from Smithy shape ``com.amazonaws.codecommit#GetFile``."""
...
import capo_codecommit.errors.file_too_large_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FileTooLargeException":
            raise capo_codecommit.errors.file_too_large_exception.FileTooLargeException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.get_file_output.GetFileOutput = (
        capo_codecommit.types.get_file_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_file_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_file(
    options: OperationOptions, input_: capo_codecommit.types.get_file_input.GetFileInput
) -> tuple[capo_codecommit.types.get_file_output.GetFileOutput, zapros.Response]:
