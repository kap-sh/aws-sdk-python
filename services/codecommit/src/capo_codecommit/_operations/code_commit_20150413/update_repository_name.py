"""Generated from Smithy shape ``com.amazonaws.codecommit#UpdateRepositoryName``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.update_repository_name_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_repository_name(
