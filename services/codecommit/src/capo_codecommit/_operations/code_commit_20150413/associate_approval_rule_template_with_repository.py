"""Generated from Smithy shape ``com.amazonaws.codecommit#AssociateApprovalRuleTemplateWithRepository``."""
...
import capo_codecommit.errors.maximum_rule_templates_associated_with_repository_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MaximumRuleTemplatesAssociatedWithRepositoryException":
            raise capo_codecommit.errors.maximum_rule_templates_associated_with_repository_exception.MaximumRuleTemplatesAssociatedWithRepositoryException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.associate_approval_rule_template_with_repository_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_approval_rule_template_with_repository(
