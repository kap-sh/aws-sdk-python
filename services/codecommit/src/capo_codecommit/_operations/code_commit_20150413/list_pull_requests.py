"""Generated from Smithy shape ``com.amazonaws.codecommit#ListPullRequests``."""
...
import capo_codecommit.errors.author_does_not_exist_exception
...
import capo_codecommit.errors.invalid_author_arn_exception
import capo_codecommit.errors.invalid_continuation_token_exception
import capo_codecommit.errors.invalid_max_results_exception
import capo_codecommit.errors.invalid_pull_request_status_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AuthorDoesNotExistException":
            raise capo_codecommit.errors.author_does_not_exist_exception.AuthorDoesNotExistException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidAuthorArnException":
            raise capo_codecommit.errors.invalid_author_arn_exception.InvalidAuthorArnException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidMaxResultsException":
            raise capo_codecommit.errors.invalid_max_results_exception.InvalidMaxResultsException.from_aws_json_1_1(
                data
            )
        case "InvalidPullRequestStatusException":
            raise capo_codecommit.errors.invalid_pull_request_status_exception.InvalidPullRequestStatusException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.list_pull_requests_output.ListPullRequestsOutput = (
        capo_codecommit.types.list_pull_requests_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.list_pull_requests_input.serialize_aws_json_1_1(input_)
    ).encode()
