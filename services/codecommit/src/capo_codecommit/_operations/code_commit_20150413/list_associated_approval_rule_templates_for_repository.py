"""Generated from Smithy shape ``com.amazonaws.codecommit#ListAssociatedApprovalRuleTemplatesForRepository``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.list_associated_approval_rule_templates_for_repository_output.ListAssociatedApprovalRuleTemplatesForRepositoryOutput = capo_codecommit.types.list_associated_approval_rule_templates_for_repository_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.list_associated_approval_rule_templates_for_repository_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_associated_approval_rule_templates_for_repository(
