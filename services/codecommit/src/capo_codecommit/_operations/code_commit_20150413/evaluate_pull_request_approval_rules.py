...
def handle_response(
    ...
    out: capo_codecommit.types.evaluate_pull_request_approval_rules_output.EvaluatePullRequestApprovalRulesOutput = capo_codecommit.types.evaluate_pull_request_approval_rules_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.evaluate_pull_request_approval_rules_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
