...
import capo_codecommit.errors.invalid_reaction_user_arn_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidReactionUserArnException":
            raise capo_codecommit.errors.invalid_reaction_user_arn_exception.InvalidReactionUserArnException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_codecommit.types.get_comment_reactions_output.GetCommentReactionsOutput = capo_codecommit.types.get_comment_reactions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_comment_reactions_input.serialize_aws_json_1_1(input_)
    ).encode()
