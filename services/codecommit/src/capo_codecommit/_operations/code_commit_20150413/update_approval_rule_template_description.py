"""Generated from Smithy shape ``com.amazonaws.codecommit#UpdateApprovalRuleTemplateDescription``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.update_approval_rule_template_description_output.UpdateApprovalRuleTemplateDescriptionOutput = capo_codecommit.types.update_approval_rule_template_description_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.update_approval_rule_template_description_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_approval_rule_template_description(
