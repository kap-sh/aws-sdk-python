"""Generated from Smithy shape ``com.amazonaws.codecommit#MergeBranchesByThreeWay``."""
...
import capo_codecommit.errors.invalid_target_branch_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTargetBranchException":
            raise capo_codecommit.errors.invalid_target_branch_exception.InvalidTargetBranchException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.merge_branches_by_three_way_output.MergeBranchesByThreeWayOutput = capo_codecommit.types.merge_branches_by_three_way_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.merge_branches_by_three_way_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_merge_branches_by_three_way(
