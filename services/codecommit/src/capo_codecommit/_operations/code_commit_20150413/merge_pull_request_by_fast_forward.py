...
def handle_response(
    ...
    out: capo_codecommit.types.merge_pull_request_by_fast_forward_output.MergePullRequestByFastForwardOutput = capo_codecommit.types.merge_pull_request_by_fast_forward_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.merge_pull_request_by_fast_forward_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
