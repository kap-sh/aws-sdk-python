"""Generated from Smithy shape ``com.amazonaws.codecommit#UpdateRepositoryEncryptionKey``."""
...
import capo_codecommit.errors.encryption_key_required_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EncryptionKeyRequiredException":
            raise capo_codecommit.errors.encryption_key_required_exception.EncryptionKeyRequiredException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.update_repository_encryption_key_output.UpdateRepositoryEncryptionKeyOutput = capo_codecommit.types.update_repository_encryption_key_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CodeCommit_20150413.UpdateRepositoryEncryptionKey"
    body: bytes | None = json.dumps(
        capo_codecommit.types.update_repository_encryption_key_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_repository_encryption_key(
