"""Generated from Smithy shape ``com.amazonaws.codecommit#UntagResource``."""
...
import capo_codecommit.errors.invalid_resource_arn_exception
import capo_codecommit.errors.invalid_system_tag_usage_exception
import capo_codecommit.errors.invalid_tag_keys_list_exception
import capo_codecommit.errors.repository_does_not_exist_exception
import capo_codecommit.errors.resource_arn_required_exception
import capo_codecommit.errors.tag_keys_list_required_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResourceArnException":
            raise capo_codecommit.errors.invalid_resource_arn_exception.InvalidResourceArnException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidTagKeysListException":
            raise capo_codecommit.errors.invalid_tag_keys_list_exception.InvalidTagKeysListException.from_aws_json_1_1(
                data
            )
        ...
        case "ResourceArnRequiredException":
            raise capo_codecommit.errors.resource_arn_required_exception.ResourceArnRequiredException.from_aws_json_1_1(
                data
            )
        case "TagKeysListRequiredException":
            raise capo_codecommit.errors.tag_keys_list_required_exception.TagKeysListRequiredException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.untag_resource_input.serialize_aws_json_1_1(input_)
    ).encode()
