...
def handle_response(
    ...
    out: capo_codecommit.types.get_branch_output.GetBranchOutput = (
        capo_codecommit.types.get_branch_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_branch_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_branch(
    ...
    input_: capo_codecommit.types.get_branch_input.GetBranchInput,
) -> tuple[capo_codecommit.types.get_branch_output.GetBranchOutput, zapros.Response]:
