"""Generated from Smithy shape ``com.amazonaws.codecommit#GetPullRequest``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.get_pull_request_output.GetPullRequestOutput = (
        capo_codecommit.types.get_pull_request_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_pull_request_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_pull_request(
    ...
    capo_codecommit.types.get_pull_request_output.GetPullRequestOutput, zapros.Response
]:
