"""Generated from Smithy shape ``com.amazonaws.codecommit#MergeBranchesBySquash``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.merge_branches_by_squash_output.MergeBranchesBySquashOutput = capo_codecommit.types.merge_branches_by_squash_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.merge_branches_by_squash_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_merge_branches_by_squash(
