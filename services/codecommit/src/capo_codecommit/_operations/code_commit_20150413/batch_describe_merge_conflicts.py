"""Generated from Smithy shape ``com.amazonaws.codecommit#BatchDescribeMergeConflicts``."""
...
import capo_codecommit.errors.commit_required_exception
...
import capo_codecommit.errors.invalid_commit_exception
...
import capo_codecommit.errors.invalid_max_conflict_files_exception
import capo_codecommit.errors.invalid_max_merge_hunks_exception
import capo_codecommit.errors.invalid_merge_option_exception
...
import capo_codecommit.errors.merge_option_required_exception
...
import capo_codecommit.types.batch_describe_merge_conflicts_errors
...
import capo_codecommit.types.conflicts
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CommitRequiredException":
            raise capo_codecommit.errors.commit_required_exception.CommitRequiredException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidCommitException":
            raise capo_codecommit.errors.invalid_commit_exception.InvalidCommitException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidMaxConflictFilesException":
            raise capo_codecommit.errors.invalid_max_conflict_files_exception.InvalidMaxConflictFilesException.from_aws_json_1_1(
                data
            )
        case "InvalidMaxMergeHunksException":
            raise capo_codecommit.errors.invalid_max_merge_hunks_exception.InvalidMaxMergeHunksException.from_aws_json_1_1(
                data
            )
        case "InvalidMergeOptionException":
            raise capo_codecommit.errors.invalid_merge_option_exception.InvalidMergeOptionException.from_aws_json_1_1(
                data
            )
        ...
        case "MergeOptionRequiredException":
            raise capo_codecommit.errors.merge_option_required_exception.MergeOptionRequiredException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.batch_describe_merge_conflicts_output.BatchDescribeMergeConflictsOutput = capo_codecommit.types.batch_describe_merge_conflicts_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.batch_describe_merge_conflicts_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_describe_merge_conflicts(
