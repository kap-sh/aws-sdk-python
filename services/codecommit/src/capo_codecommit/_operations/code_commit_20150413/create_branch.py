...
import capo_codecommit.errors.branch_name_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BranchNameExistsException":
            raise capo_codecommit.errors.branch_name_exists_exception.BranchNameExistsException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.create_branch_input.serialize_aws_json_1_1(input_)
    ).encode()
