"""Generated from Smithy shape ``com.amazonaws.codecommit#GetComment``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.get_comment_output.GetCommentOutput = (
        capo_codecommit.types.get_comment_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_comment_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_comment(
    ...
    input_: capo_codecommit.types.get_comment_input.GetCommentInput,
) -> tuple[capo_codecommit.types.get_comment_output.GetCommentOutput, zapros.Response]:
