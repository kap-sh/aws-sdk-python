"""Generated from Smithy shape ``com.amazonaws.codecommit#UpdatePullRequestTitle``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.update_pull_request_title_output.UpdatePullRequestTitleOutput = capo_codecommit.types.update_pull_request_title_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.update_pull_request_title_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_pull_request_title(
