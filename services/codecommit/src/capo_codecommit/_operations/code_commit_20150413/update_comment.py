...
import capo_codecommit.errors.comment_not_created_by_caller_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CommentNotCreatedByCallerException":
            raise capo_codecommit.errors.comment_not_created_by_caller_exception.CommentNotCreatedByCallerException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.update_comment_output.UpdateCommentOutput = (
        capo_codecommit.types.update_comment_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.update_comment_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_comment(
    ...
    capo_codecommit.types.update_comment_output.UpdateCommentOutput, zapros.Response
]:
