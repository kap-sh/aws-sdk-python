"""Generated from Smithy shape ``com.amazonaws.codecommit#DescribeMergeConflicts``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.describe_merge_conflicts_output.DescribeMergeConflictsOutput = capo_codecommit.types.describe_merge_conflicts_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.describe_merge_conflicts_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_merge_conflicts(
