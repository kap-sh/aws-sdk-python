"""Generated from Smithy shape ``com.amazonaws.codecommit#ListFileCommitHistory``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.list_file_commit_history_response.ListFileCommitHistoryResponse = capo_codecommit.types.list_file_commit_history_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.list_file_commit_history_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_file_commit_history(
