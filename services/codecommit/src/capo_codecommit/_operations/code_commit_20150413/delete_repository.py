...
def handle_response(
    ...
    out: capo_codecommit.types.delete_repository_output.DeleteRepositoryOutput = (
        capo_codecommit.types.delete_repository_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.delete_repository_input.serialize_aws_json_1_1(input_)
    ).encode()
