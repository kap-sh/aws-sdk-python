"""Generated from Smithy shape ``com.amazonaws.codecommit#PostCommentForPullRequest``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.post_comment_for_pull_request_output.PostCommentForPullRequestOutput = capo_codecommit.types.post_comment_for_pull_request_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.post_comment_for_pull_request_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_post_comment_for_pull_request(
