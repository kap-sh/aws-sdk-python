"""Generated from Smithy shape ``com.amazonaws.codecommit#PullRequestAlreadyClosedException``."""
...
class PullRequestAlreadyClosedException_(TypedDict, closed=True):
    message: NotRequired["capo_codecommit.types.message.Message"]
    """<p>Any message associated with the exception.</p>"""


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: PullRequestAlreadyClosedException_) -> dict:
    out: dict = {}
    if "message" in value:
...
class PullRequestAlreadyClosedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codecommit#PullRequestAlreadyClosedException``."""
