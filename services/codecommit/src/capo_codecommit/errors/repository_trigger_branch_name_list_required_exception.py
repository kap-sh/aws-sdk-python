"""Generated from Smithy shape ``com.amazonaws.codecommit#RepositoryTriggerBranchNameListRequiredException``."""
...
class RepositoryTriggerBranchNameListRequiredException_(TypedDict, closed=True):
...
def serialize_aws_json_1_1(
    value: RepositoryTriggerBranchNameListRequiredException_,
) -> dict:
    out: dict = {}
    if "message" in value:
...
class RepositoryTriggerBranchNameListRequiredException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codecommit#RepositoryTriggerBranchNameListRequiredException``."""
