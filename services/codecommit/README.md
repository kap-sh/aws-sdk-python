...
```
pip install aws-sdk-codecommit
```

## Usage

```python
from aws_sdk_codecommit import AsyncCodeCommitClient
...
```python
from aws_sdk_codecommit import AsyncCodeCommitClient
from aws_sdk_codecommit.error import ApprovalRuleTemplateDoesNotExistException
