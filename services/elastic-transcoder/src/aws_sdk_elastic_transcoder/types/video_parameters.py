...
if TYPE_CHECKING:
    ...
    import aws_sdk_elastic_transcoder.types.codec_options
    import aws_sdk_elastic_transcoder.types.digits_or_auto
    import aws_sdk_elastic_transcoder.types.fixed_gop
    import aws_sdk_elastic_transcoder.types.frame_rate
    import aws_sdk_elastic_transcoder.types.keyframes_max_dist
    import aws_sdk_elastic_transcoder.types.max_frame_rate
    import aws_sdk_elastic_transcoder.types.padding_policy
    import aws_sdk_elastic_transcoder.types.preset_watermarks
    import aws_sdk_elastic_transcoder.types.resolution
    import aws_sdk_elastic_transcoder.types.sizing_policy
    import aws_sdk_elastic_transcoder.types.video_bit_rate
...
class VideoParameters(TypedDict, closed=True):
    ...
    codec_options: NotRequired[
        "aws_sdk_elastic_transcoder.types.codec_options.CodecOptions"
    ]
    ...
    keyframes_max_dist: NotRequired[
        "aws_sdk_elastic_transcoder.types.keyframes_max_dist.KeyframesMaxDist"
    ]
    ...
    fixed_gop: NotRequired["aws_sdk_elastic_transcoder.types.fixed_gop.FixedGOP"]
    ...
    bit_rate: NotRequired[
        "aws_sdk_elastic_transcoder.types.video_bit_rate.VideoBitRate"
    ]
    ...
    max_frame_rate: NotRequired[
        "aws_sdk_elastic_transcoder.types.max_frame_rate.MaxFrameRate"
    ]
    ...
    watermarks: NotRequired[
        "aws_sdk_elastic_transcoder.types.preset_watermarks.PresetWatermarks"
    ]
...
def serialize_json(value: VideoParameters) -> dict:
    ...
    if "codec_options" in value:
        ...
        out["CodecOptions"] = (
            aws_sdk_elastic_transcoder.types.codec_options.serialize_json(
                value["codec_options"]
            )
        )
    ...
    if "watermarks" in value:
        ...
        out["Watermarks"] = (
            aws_sdk_elastic_transcoder.types.preset_watermarks.serialize_json(
                value["watermarks"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> VideoParameters:
    ...
    if "CodecOptions" in data:
        ...
        out["codec_options"] = (
            aws_sdk_elastic_transcoder.types.codec_options.deserialize_json(
                data["CodecOptions"]
            )
        )
    ...
    if "Watermarks" in data:
        ...
        out["watermarks"] = (
            aws_sdk_elastic_transcoder.types.preset_watermarks.deserialize_json(
                data["Watermarks"]
            )
        )
    return out
