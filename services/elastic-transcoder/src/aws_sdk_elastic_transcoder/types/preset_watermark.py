...
if TYPE_CHECKING:
    ...
    import aws_sdk_elastic_transcoder.types.opacity
    import aws_sdk_elastic_transcoder.types.pixels_or_percent
    import aws_sdk_elastic_transcoder.types.preset_watermark_id
    import aws_sdk_elastic_transcoder.types.target
    import aws_sdk_elastic_transcoder.types.vertical_align
...
class PresetWatermark(TypedDict):
    ...
    max_width: NotRequired[
        "aws_sdk_elastic_transcoder.types.pixels_or_percent.PixelsOrPercent"
    ]
    ...
    sizing_policy: NotRequired[
        "aws_sdk_elastic_transcoder.types.watermark_sizing_policy.WatermarkSizingPolicy"
    ]
    ...
    horizontal_align: NotRequired[
        "aws_sdk_elastic_transcoder.types.horizontal_align.HorizontalAlign"
    ]
    ...
    vertical_align: NotRequired[
        "aws_sdk_elastic_transcoder.types.vertical_align.VerticalAlign"
    ]
    ...
    opacity: NotRequired["aws_sdk_elastic_transcoder.types.opacity.Opacity"]
    ...
    target: NotRequired["aws_sdk_elastic_transcoder.types.target.Target"]
