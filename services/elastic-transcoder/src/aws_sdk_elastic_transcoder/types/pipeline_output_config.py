...
if TYPE_CHECKING:
    ...
    import aws_sdk_elastic_transcoder.types.permissions
...
class PipelineOutputConfig(TypedDict, closed=True):
    ...
    storage_class: NotRequired[
        "aws_sdk_elastic_transcoder.types.storage_class.StorageClass"
    ]
    ...
    permissions: NotRequired["aws_sdk_elastic_transcoder.types.permissions.Permissions"]
...
def serialize_json(value: PipelineOutputConfig) -> dict:
    ...
    if "permissions" in value:
        ...
        out["Permissions"] = (
            aws_sdk_elastic_transcoder.types.permissions.serialize_json(
                value["permissions"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> PipelineOutputConfig:
    ...
    if "Permissions" in data:
        ...
        out["permissions"] = (
            aws_sdk_elastic_transcoder.types.permissions.deserialize_json(
                data["Permissions"]
            )
        )
    return out
