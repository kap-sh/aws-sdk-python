...
from aws_sdk_elastic_transcoder._services._aws_config import aaws_config
...
class AsyncElasticTranscoderClient:
    ...
    async def cancel_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.cancel_job_request.CancelJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.cancel_job_response.CancelJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.cancel_job.async_cancel_job(
    ...
    async def create_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.create_job_request.CreateJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.create_job_response.CreateJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.create_job.async_create_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_pipeline(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.create_pipeline_request.CreatePipelineRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.create_pipeline_response.CreatePipelineResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.create_pipeline.async_create_pipeline(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_preset(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.create_preset_request.CreatePresetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.create_preset_response.CreatePresetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.create_preset.async_create_preset(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_pipeline(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.delete_pipeline_request.DeletePipelineRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.delete_pipeline_response.DeletePipelineResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.delete_pipeline.async_delete_pipeline(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_preset(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.delete_preset_request.DeletePresetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.delete_preset_response.DeletePresetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.delete_preset.async_delete_preset(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_jobs_by_pipeline(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.list_jobs_by_pipeline_request.ListJobsByPipelineRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.list_jobs_by_pipeline_response.ListJobsByPipelineResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.list_jobs_by_pipeline.async_list_jobs_by_pipeline(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_jobs_by_pipeline(
        ...
        *,
        ...
        page_token: Optional["aws_sdk_elastic_transcoder.types.id.Id"] = None,
    ) -> "AsyncIterator[aws_sdk_elastic_transcoder.types.job.Job]":
        _token = page_token
        while True:
    ...
    async def list_jobs_by_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.list_jobs_by_status_request.ListJobsByStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.list_jobs_by_status_response.ListJobsByStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.list_jobs_by_status.async_list_jobs_by_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_pipelines(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.list_pipelines_request.ListPipelinesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.list_pipelines_response.ListPipelinesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.list_pipelines.async_list_pipelines(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_pipelines(
        ...
        *,
        ...
        page_token: Optional["aws_sdk_elastic_transcoder.types.id.Id"] = None,
    ) -> "AsyncIterator[aws_sdk_elastic_transcoder.types.pipeline.Pipeline]":
        _token = page_token
        while True:
    ...
    async def list_presets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.list_presets_request.ListPresetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.list_presets_response.ListPresetsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.list_presets.async_list_presets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_presets(
        ...
        *,
        ...
        page_token: Optional["aws_sdk_elastic_transcoder.types.id.Id"] = None,
    ) -> "AsyncIterator[aws_sdk_elastic_transcoder.types.preset.Preset]":
        _token = page_token
        while True:
    ...
    async def read_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.read_job_request.ReadJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.read_job_response.ReadJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.read_job.async_read_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def read_pipeline(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.read_pipeline_request.ReadPipelineRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.read_pipeline_response.ReadPipelineResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.read_pipeline.async_read_pipeline(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def read_preset(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.read_preset_request.ReadPresetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.read_preset_response.ReadPresetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.read_preset.async_read_preset(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def test_role(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.test_role_request.TestRoleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.test_role_response.TestRoleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.test_role.async_test_role(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_pipeline(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.update_pipeline_request.UpdatePipelineRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.update_pipeline_response.UpdatePipelineResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.update_pipeline.async_update_pipeline(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_pipeline_notifications(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.update_pipeline_notifications_request.UpdatePipelineNotificationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.update_pipeline_notifications_response.UpdatePipelineNotificationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.update_pipeline_notifications.async_update_pipeline_notifications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_pipeline_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_transcoder.types.update_pipeline_status_request.UpdatePipelineStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_transcoder.types.update_pipeline_status_response.UpdatePipelineStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_transcoder._operations.ets_customer_service.update_pipeline_status.async_update_pipeline_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
