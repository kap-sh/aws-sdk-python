"""Generated from Smithy shape ``com.amazonaws.elastictranscoder#ListJobsByPipeline``."""
...
def handle_response(
    ...
    out: capo_elastic_transcoder.types.list_jobs_by_pipeline_response.ListJobsByPipelineResponse = capo_elastic_transcoder.types.list_jobs_by_pipeline_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2012-09-25/jobsByPipeline/{PipelineId}"
    url = url.replace("{PipelineId}", quote(str(input_["pipeline_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_list_jobs_by_pipeline(
