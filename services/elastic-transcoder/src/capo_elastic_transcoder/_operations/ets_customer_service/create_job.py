...
import capo_elastic_transcoder.errors.limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise capo_elastic_transcoder.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_elastic_transcoder.types.create_job_response.CreateJobResponse = (
        capo_elastic_transcoder.types.create_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_elastic_transcoder.types.create_job_request.serialize_json(input_)
    ).encode()
...
def create_job(
    ...
    capo_elastic_transcoder.types.create_job_response.CreateJobResponse, zapros.Response
]:
