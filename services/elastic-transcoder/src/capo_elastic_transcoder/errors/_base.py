...
class ElasticTranscoderError(Exception):
    """Base class for all ElasticTranscoder service errors."""


class ServiceError(ElasticTranscoderError):
...
class SerializationError(ElasticTranscoderError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ElasticTranscoderError):
...
class WaiterFailedError(ElasticTranscoderError):
...
class WaiterTimeoutError(ElasticTranscoderError):
