"""Generated from Smithy shape ``com.amazonaws.elastictranscoder#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elastictranscoder#ValidationException``."""
