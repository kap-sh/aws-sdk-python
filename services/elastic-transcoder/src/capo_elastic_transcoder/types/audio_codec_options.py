...
if TYPE_CHECKING:
    import capo_elastic_transcoder.types.audio_bit_depth
    import capo_elastic_transcoder.types.audio_bit_order
    import capo_elastic_transcoder.types.audio_codec_profile
    import capo_elastic_transcoder.types.audio_signed


class AudioCodecOptions(TypedDict, closed=True):
    profile: NotRequired[
        "capo_elastic_transcoder.types.audio_codec_profile.AudioCodecProfile"
    ]
    ...
    bit_depth: NotRequired[
        "capo_elastic_transcoder.types.audio_bit_depth.AudioBitDepth"
    ]
    ...
    bit_order: NotRequired[
        "capo_elastic_transcoder.types.audio_bit_order.AudioBitOrder"
    ]
    ...
    signed: NotRequired["capo_elastic_transcoder.types.audio_signed.AudioSigned"]
