...
if TYPE_CHECKING:
    import capo_elastic_transcoder.types.aspect_ratio
    import capo_elastic_transcoder.types.codec_options
    import capo_elastic_transcoder.types.digits_or_auto
    import capo_elastic_transcoder.types.fixed_gop
    import capo_elastic_transcoder.types.frame_rate
    import capo_elastic_transcoder.types.keyframes_max_dist
    import capo_elastic_transcoder.types.max_frame_rate
    import capo_elastic_transcoder.types.padding_policy
    import capo_elastic_transcoder.types.preset_watermarks
    import capo_elastic_transcoder.types.resolution
    import capo_elastic_transcoder.types.sizing_policy
    import capo_elastic_transcoder.types.video_bit_rate
    import capo_elastic_transcoder.types.video_codec


class VideoParameters(TypedDict, closed=True):
    codec: NotRequired["capo_elastic_transcoder.types.video_codec.VideoCodec"]
    ...
    codec_options: NotRequired[
        "capo_elastic_transcoder.types.codec_options.CodecOptions"
    ]
    ...
    keyframes_max_dist: NotRequired[
        "capo_elastic_transcoder.types.keyframes_max_dist.KeyframesMaxDist"
    ]
    ...
    fixed_gop: NotRequired["capo_elastic_transcoder.types.fixed_gop.FixedGOP"]
    ...
    max_width: NotRequired["capo_elastic_transcoder.types.digits_or_auto.DigitsOrAuto"]
    ...
    max_height: NotRequired["capo_elastic_transcoder.types.digits_or_auto.DigitsOrAuto"]
    ...
    display_aspect_ratio: NotRequired[
        "capo_elastic_transcoder.types.aspect_ratio.AspectRatio"
    ]
    """<p>The value that Elastic Transcoder adds to the metadata in the output file.</p>"""
    sizing_policy: NotRequired[
        "capo_elastic_transcoder.types.sizing_policy.SizingPolicy"
    ]
    ...
    padding_policy: NotRequired[
        "capo_elastic_transcoder.types.padding_policy.PaddingPolicy"
    ]
    ...
    watermarks: NotRequired[
        "capo_elastic_transcoder.types.preset_watermarks.PresetWatermarks"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: VideoParameters) -> dict:
    out: dict = {}
    if "codec" in value:
    ...
    if "codec_options" in value:
        ...
        out["CodecOptions"] = (
            capo_elastic_transcoder.types.codec_options.serialize_json(
                value["codec_options"]
            )
        )
    if "keyframes_max_dist" in value:
        out["KeyframesMaxDist"] = value["keyframes_max_dist"]
    if "fixed_gop" in value:
        out["FixedGOP"] = value["fixed_gop"]
    if "bit_rate" in value:
        out["BitRate"] = value["bit_rate"]
    if "frame_rate" in value:
        out["FrameRate"] = value["frame_rate"]
    if "max_frame_rate" in value:
        out["MaxFrameRate"] = value["max_frame_rate"]
    ...
    if "display_aspect_ratio" in value:
        out["DisplayAspectRatio"] = value["display_aspect_ratio"]
    ...
    if "watermarks" in value:
        ...
        out["Watermarks"] = (
            capo_elastic_transcoder.types.preset_watermarks.serialize_json(
                value["watermarks"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> VideoParameters:
    ...
    if "CodecOptions" in data:
        ...
        out["codec_options"] = (
            capo_elastic_transcoder.types.codec_options.deserialize_json(
                data["CodecOptions"]
            )
        )
    ...
    if "Watermarks" in data:
        ...
        out["watermarks"] = (
            capo_elastic_transcoder.types.preset_watermarks.deserialize_json(
                data["Watermarks"]
            )
        )
    return out
