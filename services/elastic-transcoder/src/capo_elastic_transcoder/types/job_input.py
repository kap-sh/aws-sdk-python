...
if TYPE_CHECKING:
    ...
    import capo_elastic_transcoder.types.interlaced
    import capo_elastic_transcoder.types.job_container
    import capo_elastic_transcoder.types.long_key
...
class JobInput(TypedDict, closed=True):
    key: NotRequired["capo_elastic_transcoder.types.long_key.LongKey"]
    ...
    interlaced: NotRequired["capo_elastic_transcoder.types.interlaced.Interlaced"]
    ...
    container: NotRequired["capo_elastic_transcoder.types.job_container.JobContainer"]
    ...
    input_captions: NotRequired[
        "capo_elastic_transcoder.types.input_captions.InputCaptions"
    ]
    ...
    detected_properties: NotRequired[
        "capo_elastic_transcoder.types.detected_properties.DetectedProperties"
    ]
...
def serialize_json(value: JobInput) -> dict:
    ...
    if "input_captions" in value:
        ...
        out["InputCaptions"] = (
            capo_elastic_transcoder.types.input_captions.serialize_json(
    ...
    if "detected_properties" in value:
        ...
        out["DetectedProperties"] = (
            capo_elastic_transcoder.types.detected_properties.serialize_json(
...
def deserialize_json(data: dict) -> JobInput:
    ...
    if "InputCaptions" in data:
        ...
        out["input_captions"] = (
            capo_elastic_transcoder.types.input_captions.deserialize_json(
                data["InputCaptions"]
            )
        )
    if "DetectedProperties" in data:
        ...
        out["detected_properties"] = (
            capo_elastic_transcoder.types.detected_properties.deserialize_json(
