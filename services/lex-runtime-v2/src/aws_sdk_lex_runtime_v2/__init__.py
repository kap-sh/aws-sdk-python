...
from ._services.async_lex_runtime_v2 import (
    AsyncLexRuntimeV2Client as AsyncLexRuntimeV2Client,
)
from ._services.lex_runtime_v2 import LexRuntimeV2Client as LexRuntimeV2Client
