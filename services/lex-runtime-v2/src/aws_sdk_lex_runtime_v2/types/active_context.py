...
if TYPE_CHECKING:
    import aws_sdk_lex_runtime_v2.types.active_context_name
    import aws_sdk_lex_runtime_v2.types.active_context_parameters_map
    import aws_sdk_lex_runtime_v2.types.active_context_time_to_live


class ActiveContext(TypedDict, closed=True):
    name: "aws_sdk_lex_runtime_v2.types.active_context_name.ActiveContextName"
    """<p>The name of the context.</p>"""
    time_to_live: "aws_sdk_lex_runtime_v2.types.active_context_time_to_live.ActiveContextTimeToLive"
    ...
    context_attributes: "aws_sdk_lex_runtime_v2.types.active_context_parameters_map.ActiveContextParametersMap"
...
def serialize_json(value: ActiveContext) -> dict:
    ...
    out["timeToLive"] = (
        aws_sdk_lex_runtime_v2.types.active_context_time_to_live.serialize_json(
            value["time_to_live"]
        )
    )
    import aws_sdk_lex_runtime_v2.types.active_context_parameters_map
    ...
    out["contextAttributes"] = (
        aws_sdk_lex_runtime_v2.types.active_context_parameters_map.serialize_json(
...
def deserialize_json(data: dict) -> ActiveContext:
    ...
    if "timeToLive" in data:
        ...
        out["time_to_live"] = (
            aws_sdk_lex_runtime_v2.types.active_context_time_to_live.deserialize_json(
                data["timeToLive"]
            )
        )
    else:
    ...
    if "contextAttributes" in data:
        ...
        out["context_attributes"] = (
            aws_sdk_lex_runtime_v2.types.active_context_parameters_map.deserialize_json(
