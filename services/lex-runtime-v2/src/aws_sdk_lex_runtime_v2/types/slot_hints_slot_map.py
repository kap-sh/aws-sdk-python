...
if TYPE_CHECKING:
    ...
    import aws_sdk_lex_runtime_v2.types.runtime_hint_details

SlotHintsSlotMap: TypeAlias = dict[
    "aws_sdk_lex_runtime_v2.types.name.Name",
    "aws_sdk_lex_runtime_v2.types.runtime_hint_details.RuntimeHintDetails",
]
...
def serialize_json(input_to_serialize: SlotHintsSlotMap) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_lex_runtime_v2.types.runtime_hint_details.serialize_json(
            value
        )
    return out
...
def deserialize_json(data: dict) -> SlotHintsSlotMap:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_lex_runtime_v2.types.runtime_hint_details.deserialize_json(
            value
        )
    return out
