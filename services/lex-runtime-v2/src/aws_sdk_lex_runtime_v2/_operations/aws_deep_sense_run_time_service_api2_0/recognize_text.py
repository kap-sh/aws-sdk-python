...
def handle_response(
    ...
    out: aws_sdk_lex_runtime_v2.types.recognize_text_response.RecognizeTextResponse = (
        aws_sdk_lex_runtime_v2.types.recognize_text_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_runtime_v2.types.recognize_text_request.RecognizeTextRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_runtime_v2.types.recognize_text_request.serialize_json(input_)
    ).encode()
