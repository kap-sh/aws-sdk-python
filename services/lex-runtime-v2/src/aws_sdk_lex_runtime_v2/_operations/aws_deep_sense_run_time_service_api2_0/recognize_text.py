...
def build_request(
    ...
    input: aws_sdk_lex_runtime_v2.types.recognize_text_request.RecognizeTextRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_lex_runtime_v2.types.recognize_text_request.serialize_json(input)
    ).encode()
