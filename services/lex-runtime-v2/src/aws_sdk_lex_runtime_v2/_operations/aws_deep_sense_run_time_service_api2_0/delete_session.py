...
def handle_response(
    ...
    out: aws_sdk_lex_runtime_v2.types.delete_session_response.DeleteSessionResponse = (
        aws_sdk_lex_runtime_v2.types.delete_session_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_lex_runtime_v2.types.delete_session_request.DeleteSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
