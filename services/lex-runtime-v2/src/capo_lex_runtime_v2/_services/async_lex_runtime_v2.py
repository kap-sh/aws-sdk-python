...
class AsyncLexRuntimeV2ClientConfig(TypedDict, total=False, closed=True):
...
class AsyncLexRuntimeV2Client:
    ...
    def __init__(
        ...
        self._config = AsyncLexRuntimeV2ClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncLexRuntimeV2ClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncLexRuntimeV2ClientConfig = config_overrides or {}
    ...
    async def delete_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_lex_runtime_v2.types.delete_session_request.DeleteSessionRequest]",
        ) -> AsyncOperationResponse[
            "capo_lex_runtime_v2.types.delete_session_response.DeleteSessionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_lex_runtime_v2._operations.aws_deep_sense_run_time_service_api2_0.delete_session.async_delete_session(
    ...
    async def get_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_lex_runtime_v2.types.get_session_request.GetSessionRequest]",
        ) -> AsyncOperationResponse[
            "capo_lex_runtime_v2.types.get_session_response.GetSessionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_lex_runtime_v2._operations.aws_deep_sense_run_time_service_api2_0.get_session.async_get_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_session(
        ...
        *,
    ...
    ) -> "AsyncGenerator[capo_lex_runtime_v2.types.put_session_response.PutSessionResponse]":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_lex_runtime_v2.types.put_session_request.PutSessionRequest]",
        ) -> AsyncOperationResponse[
            ...
            (
                output,
                http_response,
            ) = await capo_lex_runtime_v2._operations.aws_deep_sense_run_time_service_api2_0.put_session.async_put_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def recognize_text(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_lex_runtime_v2.types.recognize_text_request.RecognizeTextRequest]",
        ) -> AsyncOperationResponse[
            "capo_lex_runtime_v2.types.recognize_text_response.RecognizeTextResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_lex_runtime_v2._operations.aws_deep_sense_run_time_service_api2_0.recognize_text.async_recognize_text(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def recognize_utterance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_lex_runtime_v2.types.recognize_utterance_request.RecognizeUtteranceRequest]",
        ) -> AsyncOperationResponse[
            ...
            (
                output,
                http_response,
            ) = await capo_lex_runtime_v2._operations.aws_deep_sense_run_time_service_api2_0.recognize_utterance.async_recognize_utterance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_conversation(
        ...
        locale_id: "capo_lex_runtime_v2.types.locale_id.LocaleId",
        session_id: "capo_lex_runtime_v2.types.session_id.SessionId",
        request_event_stream: "AsyncIterator[capo_lex_runtime_v2.types.start_conversation_request_event_stream._StartConversationRequestEventStream] | capo_lex_runtime_v2.types.start_conversation_request_event_stream._StartConversationRequestEventStream",
        *,
        config_overrides: Optional[AsyncLexRuntimeV2ClientConfig] = None,
        conversation_mode: Optional[
            "capo_lex_runtime_v2.types.conversation_mode.ConversationMode"
        ] = None,
    ) -> "AsyncGenerator[capo_lex_runtime_v2.types.start_conversation_response.StartConversationResponse]":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_lex_runtime_v2.types.start_conversation_request.StartConversationRequest]",
        ) -> AsyncOperationResponse[
            ...
            (
                output,
                http_response,
            ) = await capo_lex_runtime_v2._operations.aws_deep_sense_run_time_service_api2_0.start_conversation.async_start_conversation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
