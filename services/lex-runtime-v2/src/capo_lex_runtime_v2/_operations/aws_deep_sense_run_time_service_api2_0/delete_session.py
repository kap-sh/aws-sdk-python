"""Generated from Smithy shape ``com.amazonaws.lexruntimev2#DeleteSession``."""
...
def handle_response(
    ...
    out: capo_lex_runtime_v2.types.delete_session_response.DeleteSessionResponse = (
        capo_lex_runtime_v2.types.delete_session_response.deserialize_json(
