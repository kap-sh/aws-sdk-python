...
class LexRuntimeV2Error(Exception):
    """Base class for all LexRuntimeV2 service errors."""


class ServiceError(LexRuntimeV2Error):
...
class SerializationError(LexRuntimeV2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(LexRuntimeV2Error):
...
class WaiterFailedError(LexRuntimeV2Error):
...
class WaiterTimeoutError(LexRuntimeV2Error):
