...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_sagemakerjobruntime.errors.conflict_exception

            raise aws_sdk_sagemakerjobruntime.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_sagemakerjobruntime.types.update_reward_response.UpdateRewardResponse = {}  # type: ignore[typeddict-item]
    return out
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_sagemakerjobruntime._auth._sigv4.build_sigv4_auth_scheme(
                "sagemaker", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_sagemakerjobruntime._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input: aws_sdk_sagemakerjobruntime.types.update_reward_request.UpdateRewardRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemakerjobruntime.types.update_reward_request.serialize_json(input)
    ).encode()
