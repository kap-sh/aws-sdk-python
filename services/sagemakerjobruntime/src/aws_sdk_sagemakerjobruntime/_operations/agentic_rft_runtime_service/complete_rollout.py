...
def handle_response(
    ...
    out: aws_sdk_sagemakerjobruntime.types.complete_rollout_response.CompleteRolloutResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_sagemakerjobruntime.types.complete_rollout_request.CompleteRolloutRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemakerjobruntime.types.complete_rollout_request.serialize_json(input)
    ).encode()
