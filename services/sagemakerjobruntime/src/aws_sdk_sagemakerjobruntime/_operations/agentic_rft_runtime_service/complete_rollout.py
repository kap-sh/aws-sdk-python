...
def build_request(
    ...
    input_: aws_sdk_sagemakerjobruntime.types.complete_rollout_request.CompleteRolloutRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sagemakerjobruntime.types.complete_rollout_request.serialize_json(
            input_
        )
    ).encode()
