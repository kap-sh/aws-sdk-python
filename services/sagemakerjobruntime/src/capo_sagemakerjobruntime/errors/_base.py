...
class SagemakerJobRuntimeError(Exception):
    """Base class for all SagemakerJobRuntime service errors."""


class ServiceError(SagemakerJobRuntimeError):
...
class SerializationError(SagemakerJobRuntimeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SagemakerJobRuntimeError):
...
class WaiterFailedError(SagemakerJobRuntimeError):
...
class WaiterTimeoutError(SagemakerJobRuntimeError):
