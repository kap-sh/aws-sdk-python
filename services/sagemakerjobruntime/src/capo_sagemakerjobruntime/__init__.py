...
from ._services.async_sagemaker_job_runtime import (
    AsyncSagemakerJobRuntimeClient as AsyncSagemakerJobRuntimeClient,
)
from ._services.sagemaker_job_runtime import (
    SagemakerJobRuntimeClient as SagemakerJobRuntimeClient,
)
