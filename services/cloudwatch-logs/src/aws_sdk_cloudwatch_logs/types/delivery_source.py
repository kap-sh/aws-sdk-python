...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch_logs.types.delivery_source_status
    import aws_sdk_cloudwatch_logs.types.delivery_source_status_reason
    import aws_sdk_cloudwatch_logs.types.log_type
    import aws_sdk_cloudwatch_logs.types.resource_arns
    import aws_sdk_cloudwatch_logs.types.service
    import aws_sdk_cloudwatch_logs.types.tags


class DeliverySource(TypedDict):
    name: NotRequired[
    ...
    resource_arns: NotRequired[
        "aws_sdk_cloudwatch_logs.types.resource_arns.ResourceArns"
    ]
    ...
    status: NotRequired[
        "aws_sdk_cloudwatch_logs.types.delivery_source_status.DeliverySourceStatus"
    ]
    ...
    status_reason: NotRequired[
        "aws_sdk_cloudwatch_logs.types.delivery_source_status_reason.DeliverySourceStatusReason"
    ]
...
def serialize_aws_json_1_1(value: DeliverySource) -> dict:
    ...
    if "resource_arns" in value:
        ...
        out["resourceArns"] = (
            aws_sdk_cloudwatch_logs.types.resource_arns.serialize_aws_json_1_1(
                value["resource_arns"]
            )
        )
    if "service" in value:
    ...
    if "status" in value:
        ...
        out["status"] = (
            aws_sdk_cloudwatch_logs.types.delivery_source_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
    if "status_reason" in value:
        ...
        out["statusReason"] = (
            aws_sdk_cloudwatch_logs.types.delivery_source_status_reason.serialize_aws_json_1_1(
                value["status_reason"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DeliverySource:
    ...
    if "resourceArns" in data:
        ...
        out["resource_arns"] = (
            aws_sdk_cloudwatch_logs.types.resource_arns.deserialize_aws_json_1_1(
                data["resourceArns"]
            )
        )
    if "service" in data:
    ...
    if "status" in data:
        ...
        out["status"] = (
            aws_sdk_cloudwatch_logs.types.delivery_source_status.deserialize_aws_json_1_1(
                data["status"]
            )
        )
    if "statusReason" in data:
        ...
        out["status_reason"] = (
            aws_sdk_cloudwatch_logs.types.delivery_source_status_reason.deserialize_aws_json_1_1(
                data["statusReason"]
            )
        )
    return out
