...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch_logs.types.dynamic_token_position
    import aws_sdk_cloudwatch_logs.types.enumerations
    import aws_sdk_cloudwatch_logs.types.inferred_token_name
    import aws_sdk_cloudwatch_logs.types.token_string


class PatternToken(TypedDict):
    dynamic_token_position: (
        "aws_sdk_cloudwatch_logs.types.dynamic_token_position.DynamicTokenPosition"
    )
    ...
    is_dynamic: NotRequired["aws_sdk_cloudwatch_logs.types.boolean.Boolean"]
    """<p>Specifies whether this is a dynamic token.</p>"""
    token_string: NotRequired["aws_sdk_cloudwatch_logs.types.token_string.TokenString"]
    """<p>The string represented by this token. If this is a dynamic token, the value will be <code><*></code> </p>"""
    enumerations: NotRequired["aws_sdk_cloudwatch_logs.types.enumerations.Enumerations"]
    ...
    inferred_token_name: NotRequired[
        "aws_sdk_cloudwatch_logs.types.inferred_token_name.InferredTokenName"
    ]
...
def serialize_aws_json_1_1(value: PatternToken) -> dict:
    ...
    if "enumerations" in value:
        ...
        out["enumerations"] = (
            aws_sdk_cloudwatch_logs.types.enumerations.serialize_aws_json_1_1(
                value["enumerations"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> PatternToken:
    ...
    if "enumerations" in data:
        ...
        out["enumerations"] = (
            aws_sdk_cloudwatch_logs.types.enumerations.deserialize_aws_json_1_1(
                data["enumerations"]
            )
        )
