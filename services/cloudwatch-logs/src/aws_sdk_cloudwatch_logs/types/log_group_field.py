...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch_logs.types.percentage


class LogGroupField(TypedDict):
    name: NotRequired["aws_sdk_cloudwatch_logs.types.field.Field"]
    """<p>The name of a log field.</p>"""
    percent: "aws_sdk_cloudwatch_logs.types.percentage.Percentage"
