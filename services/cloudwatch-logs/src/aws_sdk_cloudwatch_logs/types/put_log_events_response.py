...
class PutLogEventsResponse(TypedDict):
    ...
    rejected_log_events_info: NotRequired[
        "aws_sdk_cloudwatch_logs.types.rejected_log_events_info.RejectedLogEventsInfo"
    ]
    """<p>The rejected events.</p>"""
    rejected_entity_info: NotRequired[
        "aws_sdk_cloudwatch_logs.types.rejected_entity_info.RejectedEntityInfo"
    ]
...
def serialize_aws_json_1_1(value: PutLogEventsResponse) -> dict:
    ...
    if "rejected_log_events_info" in value:
        ...
        out["rejectedLogEventsInfo"] = (
            aws_sdk_cloudwatch_logs.types.rejected_log_events_info.serialize_aws_json_1_1(
    ...
    if "rejected_entity_info" in value:
        ...
        out["rejectedEntityInfo"] = (
            aws_sdk_cloudwatch_logs.types.rejected_entity_info.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> PutLogEventsResponse:
    ...
    if "rejectedLogEventsInfo" in data:
        ...
        out["rejected_log_events_info"] = (
            aws_sdk_cloudwatch_logs.types.rejected_log_events_info.deserialize_aws_json_1_1(
    ...
    if "rejectedEntityInfo" in data:
        ...
        out["rejected_entity_info"] = (
            aws_sdk_cloudwatch_logs.types.rejected_entity_info.deserialize_aws_json_1_1(
