...
class ListLogGroupsResponse(TypedDict):
    log_groups: NotRequired[
        "aws_sdk_cloudwatch_logs.types.log_group_summaries.LogGroupSummaries"
    ]
...
def serialize_aws_json_1_1(value: ListLogGroupsResponse) -> dict:
    ...
    if "log_groups" in value:
        ...
        out["logGroups"] = (
            aws_sdk_cloudwatch_logs.types.log_group_summaries.serialize_aws_json_1_1(
                value["log_groups"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListLogGroupsResponse:
    ...
    if "logGroups" in data:
        ...
        out["log_groups"] = (
            aws_sdk_cloudwatch_logs.types.log_group_summaries.deserialize_aws_json_1_1(
                data["logGroups"]
            )
        )
