...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch_logs.types.collection_retention_days
...
class OpenSearchResourceConfig(TypedDict):
    ...
    dashboard_viewer_principals: "aws_sdk_cloudwatch_logs.types.dashboard_viewer_principals.DashboardViewerPrincipals"
    ...
    retention_days: "aws_sdk_cloudwatch_logs.types.collection_retention_days.CollectionRetentionDays"
...
def serialize_aws_json_1_1(value: OpenSearchResourceConfig) -> dict:
    ...
    out["dashboardViewerPrincipals"] = (
        aws_sdk_cloudwatch_logs.types.dashboard_viewer_principals.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> OpenSearchResourceConfig:
    ...
    if "dashboardViewerPrincipals" in data:
        ...
        out["dashboard_viewer_principals"] = (
            aws_sdk_cloudwatch_logs.types.dashboard_viewer_principals.deserialize_aws_json_1_1(
