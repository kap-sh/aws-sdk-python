...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch_logs.types.open_search_application
    import aws_sdk_cloudwatch_logs.types.open_search_collection
    import aws_sdk_cloudwatch_logs.types.open_search_data_access_policy
    import aws_sdk_cloudwatch_logs.types.open_search_data_source
    import aws_sdk_cloudwatch_logs.types.open_search_encryption_policy
    import aws_sdk_cloudwatch_logs.types.open_search_lifecycle_policy
    import aws_sdk_cloudwatch_logs.types.open_search_network_policy
    import aws_sdk_cloudwatch_logs.types.open_search_workspace


class OpenSearchIntegrationDetails(TypedDict):
...
def serialize_aws_json_1_1(value: OpenSearchIntegrationDetails) -> dict:
    ...
    if "data_source" in value:
        ...
        out["dataSource"] = (
            aws_sdk_cloudwatch_logs.types.open_search_data_source.serialize_aws_json_1_1(
                value["data_source"]
            )
        )
    if "application" in value:
        ...
        out["application"] = (
            aws_sdk_cloudwatch_logs.types.open_search_application.serialize_aws_json_1_1(
                value["application"]
            )
        )
    if "collection" in value:
        ...
        out["collection"] = (
            aws_sdk_cloudwatch_logs.types.open_search_collection.serialize_aws_json_1_1(
                value["collection"]
            )
        )
    if "workspace" in value:
        ...
        out["workspace"] = (
            aws_sdk_cloudwatch_logs.types.open_search_workspace.serialize_aws_json_1_1(
                value["workspace"]
            )
        )
    if "encryption_policy" in value:
        ...
        out["encryptionPolicy"] = (
            aws_sdk_cloudwatch_logs.types.open_search_encryption_policy.serialize_aws_json_1_1(
    ...
    if "network_policy" in value:
        ...
        out["networkPolicy"] = (
            aws_sdk_cloudwatch_logs.types.open_search_network_policy.serialize_aws_json_1_1(
    ...
    if "access_policy" in value:
        ...
        out["accessPolicy"] = (
            aws_sdk_cloudwatch_logs.types.open_search_data_access_policy.serialize_aws_json_1_1(
                value["access_policy"]
            )
        )
    if "lifecycle_policy" in value:
        ...
        out["lifecyclePolicy"] = (
            aws_sdk_cloudwatch_logs.types.open_search_lifecycle_policy.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> OpenSearchIntegrationDetails:
    ...
    if "dataSource" in data:
        ...
        out["data_source"] = (
            aws_sdk_cloudwatch_logs.types.open_search_data_source.deserialize_aws_json_1_1(
                data["dataSource"]
            )
        )
    if "application" in data:
        ...
        out["application"] = (
            aws_sdk_cloudwatch_logs.types.open_search_application.deserialize_aws_json_1_1(
                data["application"]
            )
        )
    if "collection" in data:
        ...
        out["collection"] = (
            aws_sdk_cloudwatch_logs.types.open_search_collection.deserialize_aws_json_1_1(
                data["collection"]
            )
        )
    if "workspace" in data:
        ...
        out["workspace"] = (
            aws_sdk_cloudwatch_logs.types.open_search_workspace.deserialize_aws_json_1_1(
                data["workspace"]
            )
        )
    if "encryptionPolicy" in data:
        ...
        out["encryption_policy"] = (
            aws_sdk_cloudwatch_logs.types.open_search_encryption_policy.deserialize_aws_json_1_1(
    ...
    if "networkPolicy" in data:
        ...
        out["network_policy"] = (
            aws_sdk_cloudwatch_logs.types.open_search_network_policy.deserialize_aws_json_1_1(
                data["networkPolicy"]
            )
        )
    if "accessPolicy" in data:
        ...
        out["access_policy"] = (
            aws_sdk_cloudwatch_logs.types.open_search_data_access_policy.deserialize_aws_json_1_1(
                data["accessPolicy"]
            )
        )
    if "lifecyclePolicy" in data:
        ...
        out["lifecycle_policy"] = (
            aws_sdk_cloudwatch_logs.types.open_search_lifecycle_policy.deserialize_aws_json_1_1(
