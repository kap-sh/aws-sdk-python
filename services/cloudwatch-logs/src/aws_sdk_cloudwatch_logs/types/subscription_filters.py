...
SubscriptionFilters: TypeAlias = list[
    "aws_sdk_cloudwatch_logs.types.subscription_filter.SubscriptionFilter"
]
...
def serialize_aws_json_1_1(value: SubscriptionFilters) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_cloudwatch_logs.types.subscription_filter.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> SubscriptionFilters:
    ...
    for item in data:
        out.append(
            aws_sdk_cloudwatch_logs.types.subscription_filter.deserialize_aws_json_1_1(
                item
            )
        )
    return out
