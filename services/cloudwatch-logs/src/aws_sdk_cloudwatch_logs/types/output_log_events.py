...
OutputLogEvents: TypeAlias = list[
    "aws_sdk_cloudwatch_logs.types.output_log_event.OutputLogEvent"
]
...
def serialize_aws_json_1_1(value: OutputLogEvents) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_cloudwatch_logs.types.output_log_event.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> OutputLogEvents:
    ...
    for item in data:
        out.append(
            aws_sdk_cloudwatch_logs.types.output_log_event.deserialize_aws_json_1_1(
                item
            )
        )
    return out
