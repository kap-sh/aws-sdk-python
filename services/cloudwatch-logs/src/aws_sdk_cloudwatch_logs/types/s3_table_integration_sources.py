...
S3TableIntegrationSources: TypeAlias = list[
    "aws_sdk_cloudwatch_logs.types.s3_table_integration_source.S3TableIntegrationSource"
]
...
def serialize_aws_json_1_1(value: S3TableIntegrationSources) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_cloudwatch_logs.types.s3_table_integration_source.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> S3TableIntegrationSources:
    ...
    for item in data:
        out.append(
            aws_sdk_cloudwatch_logs.types.s3_table_integration_source.deserialize_aws_json_1_1(
                item
            )
        )
    return out
