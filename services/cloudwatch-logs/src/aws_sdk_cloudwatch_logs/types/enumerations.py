...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch_logs.types.token_value

Enumerations: TypeAlias = dict[
    "aws_sdk_cloudwatch_logs.types.token_string.TokenString",
    "aws_sdk_cloudwatch_logs.types.token_value.TokenValue",
]
