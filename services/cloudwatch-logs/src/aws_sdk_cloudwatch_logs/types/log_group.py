...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch_logs.types.data_protection_status
    import aws_sdk_cloudwatch_logs.types.days
    import aws_sdk_cloudwatch_logs.types.deletion_protection_enabled
    import aws_sdk_cloudwatch_logs.types.filter_count
    import aws_sdk_cloudwatch_logs.types.inherited_properties
...
class LogGroup(TypedDict):
    ...
    retention_in_days: NotRequired["aws_sdk_cloudwatch_logs.types.days.Days"]
    metric_filter_count: NotRequired[
        "aws_sdk_cloudwatch_logs.types.filter_count.FilterCount"
    ]
    ...
    stored_bytes: NotRequired["aws_sdk_cloudwatch_logs.types.stored_bytes.StoredBytes"]
    ...
    data_protection_status: NotRequired[
        "aws_sdk_cloudwatch_logs.types.data_protection_status.DataProtectionStatus"
    ]
    ...
    inherited_properties: NotRequired[
        "aws_sdk_cloudwatch_logs.types.inherited_properties.InheritedProperties"
    ]
...
def serialize_aws_json_1_1(value: LogGroup) -> dict:
    ...
    if "data_protection_status" in value:
        ...
        out["dataProtectionStatus"] = (
            aws_sdk_cloudwatch_logs.types.data_protection_status.serialize_aws_json_1_1(
    ...
    if "inherited_properties" in value:
        ...
        out["inheritedProperties"] = (
            aws_sdk_cloudwatch_logs.types.inherited_properties.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> LogGroup:
    ...
    if "dataProtectionStatus" in data:
        ...
        out["data_protection_status"] = (
            aws_sdk_cloudwatch_logs.types.data_protection_status.deserialize_aws_json_1_1(
    ...
    if "inheritedProperties" in data:
        ...
        out["inherited_properties"] = (
            aws_sdk_cloudwatch_logs.types.inherited_properties.deserialize_aws_json_1_1(
