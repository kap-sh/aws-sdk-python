...
class DescribeIndexPoliciesRequest(TypedDict):
...
def serialize_aws_json_1_1(value: DescribeIndexPoliciesRequest) -> dict:
    ...
    out["logGroupIdentifiers"] = (
        aws_sdk_cloudwatch_logs.types.describe_index_policies_log_group_identifiers.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeIndexPoliciesRequest:
    ...
    if "logGroupIdentifiers" in data:
        ...
        out["log_group_identifiers"] = (
            aws_sdk_cloudwatch_logs.types.describe_index_policies_log_group_identifiers.deserialize_aws_json_1_1(
