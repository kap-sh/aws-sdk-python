...
if TYPE_CHECKING:
    import aws_sdk_cloudwatch_logs.types.query_parameter_default_value
    import aws_sdk_cloudwatch_logs.types.query_parameter_description
...
class QueryParameter(TypedDict):
    ...
    default_value: NotRequired[
        "aws_sdk_cloudwatch_logs.types.query_parameter_default_value.QueryParameterDefaultValue"
    ]
    """<p>The default value to use for this query parameter if no value is supplied at execution time.</p>"""
    description: NotRequired[
        "aws_sdk_cloudwatch_logs.types.query_parameter_description.QueryParameterDescription"
    ]
