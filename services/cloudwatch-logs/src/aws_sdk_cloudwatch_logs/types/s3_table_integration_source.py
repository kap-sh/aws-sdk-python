...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch_logs.types.s3_table_integration_source_status
    import aws_sdk_cloudwatch_logs.types.s3_table_integration_source_status_reason
    import aws_sdk_cloudwatch_logs.types.timestamp


class S3TableIntegrationSource(TypedDict):
    ...
    data_source: NotRequired["aws_sdk_cloudwatch_logs.types.data_source.DataSource"]
    """<p>The data source associated with the S3 Table Integration.</p>"""
    status: NotRequired[
        "aws_sdk_cloudwatch_logs.types.s3_table_integration_source_status.S3TableIntegrationSourceStatus"
    ]
    """<p>The current status of the data source association.</p>"""
    status_reason: NotRequired[
        "aws_sdk_cloudwatch_logs.types.s3_table_integration_source_status_reason.S3TableIntegrationSourceStatusReason"
    ]
    """<p>Additional information about the status of the data source association.</p>"""
    created_time_stamp: NotRequired["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"]
...
def serialize_aws_json_1_1(value: S3TableIntegrationSource) -> dict:
    ...
    if "status" in value:
        ...
        out["status"] = (
            aws_sdk_cloudwatch_logs.types.s3_table_integration_source_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> S3TableIntegrationSource:
    ...
    if "status" in data:
        ...
        out["status"] = (
            aws_sdk_cloudwatch_logs.types.s3_table_integration_source_status.deserialize_aws_json_1_1(
                data["status"]
            )
        )
