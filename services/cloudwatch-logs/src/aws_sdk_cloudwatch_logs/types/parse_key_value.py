...
if TYPE_CHECKING:
    ...
    import aws_sdk_cloudwatch_logs.types.key_prefix
    import aws_sdk_cloudwatch_logs.types.key_value_delimiter
    import aws_sdk_cloudwatch_logs.types.non_match_value
    import aws_sdk_cloudwatch_logs.types.overwrite_if_exists
    import aws_sdk_cloudwatch_logs.types.parser_field_delimiter
...
class ParseKeyValue(TypedDict):
    ...
    field_delimiter: NotRequired[
        "aws_sdk_cloudwatch_logs.types.parser_field_delimiter.ParserFieldDelimiter"
    ]
    ...
    key_value_delimiter: NotRequired[
        "aws_sdk_cloudwatch_logs.types.key_value_delimiter.KeyValueDelimiter"
    ]
    ...
    key_prefix: NotRequired["aws_sdk_cloudwatch_logs.types.key_prefix.KeyPrefix"]
    """<p>If you want to add a prefix to all transformed keys, specify it here.</p>"""
    non_match_value: NotRequired[
        "aws_sdk_cloudwatch_logs.types.non_match_value.NonMatchValue"
    ]
