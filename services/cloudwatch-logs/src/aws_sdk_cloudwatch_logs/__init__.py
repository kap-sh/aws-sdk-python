...
from ._services.async_cloud_watch_logs import (
    AsyncCloudWatchLogsClient as AsyncCloudWatchLogsClient,
)
from ._services.cloud_watch_logs import CloudWatchLogsClient as CloudWatchLogsClient
