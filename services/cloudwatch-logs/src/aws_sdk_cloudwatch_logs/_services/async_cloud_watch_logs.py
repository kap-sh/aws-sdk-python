...
from aws_sdk_cloudwatch_logs._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
from aws_sdk_cloudwatch_logs._async import anysleep
import time
from aws_sdk_cloudwatch_logs.errors import ServiceError, WaiterFailedError, WaiterTimeoutError
import warnings
from aws_sdk_cloudwatch_logs._auth._identity import Credentials
from aws_sdk_cloudwatch_logs._auth._providers import CredentialsProvider, StaticAwsCredentialsProvider
if TYPE_CHECKING:
...
class AsyncCloudWatchLogsClientConfig(TypedDict, total=False):
...
class AsyncCloudWatchLogsClient:
    ...
    def __init__(self, http_handler: AsyncBaseHandler | None = None, operation_interceptors: Iterable[AsyncInterceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, region: str | None = None, use_dual_stack: bool | None = None, use_fips: bool | None = None, endpoint: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = AsyncCloudWatchLogsClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "region": region, "use_dual_stack": use_dual_stack, "use_fips": use_fips, "endpoint": endpoint, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncCloudWatchLogsClientConfig = config_overrides or {}
    ...
    async def associate_kms_key(self, kms_key_id: "aws_sdk_cloudwatch_logs.types.kms_key_id.KmsKeyId", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, resource_identifier: Optional["aws_sdk_cloudwatch_logs.types.resource_identifier.ResourceIdentifier"] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.associate_kms_key_request.AssociateKmsKeyRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.associate_kms_key
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.associate_kms_key.async_associate_kms_key(req.options, req.input)
    ...
    async def associate_source_to_s3_table_integration(self, integration_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", data_source: "aws_sdk_cloudwatch_logs.types.data_source.DataSource", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.associate_source_to_s3_table_integration_response.AssociateSourceToS3TableIntegrationResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.associate_source_to_s3_table_integration_request.AssociateSourceToS3TableIntegrationRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.associate_source_to_s3_table_integration_response.AssociateSourceToS3TableIntegrationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.associate_source_to_s3_table_integration
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.associate_source_to_s3_table_integration.async_associate_source_to_s3_table_integration(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def cancel_export_task(self, task_id: "aws_sdk_cloudwatch_logs.types.export_task_id.ExportTaskId", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.cancel_export_task_request.CancelExportTaskRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.cancel_export_task
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.cancel_export_task.async_cancel_export_task(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def cancel_import_task(self, import_id: "aws_sdk_cloudwatch_logs.types.import_id.ImportId", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.cancel_import_task_response.CancelImportTaskResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.cancel_import_task_request.CancelImportTaskRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.cancel_import_task_response.CancelImportTaskResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.cancel_import_task
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.cancel_import_task.async_cancel_import_task(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def create_delivery(self, delivery_source_name: "aws_sdk_cloudwatch_logs.types.delivery_source_name.DeliverySourceName", delivery_destination_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, record_fields: Optional["aws_sdk_cloudwatch_logs.types.record_fields.RecordFields"] = None, field_delimiter: Optional["aws_sdk_cloudwatch_logs.types.field_delimiter.FieldDelimiter"] = None, s3_delivery_configuration: Optional["aws_sdk_cloudwatch_logs.types.s3_delivery_configuration.S3DeliveryConfiguration"] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None) -> "aws_sdk_cloudwatch_logs.types.create_delivery_response.CreateDeliveryResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.create_delivery_request.CreateDeliveryRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.create_delivery_response.CreateDeliveryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_delivery
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.create_delivery.async_create_delivery(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def create_export_task(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", from: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", to: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", destination: "aws_sdk_cloudwatch_logs.types.export_destination_bucket.ExportDestinationBucket", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, task_name: Optional["aws_sdk_cloudwatch_logs.types.export_task_name.ExportTaskName"] = None, log_stream_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName"] = None, destination_prefix: Optional["aws_sdk_cloudwatch_logs.types.export_destination_prefix.ExportDestinationPrefix"] = None) -> "aws_sdk_cloudwatch_logs.types.create_export_task_response.CreateExportTaskResponse":
        ...
        Args:
            ...
            from: <p>The start time of the range for the request, expressed as the number of milliseconds after <code>Jan 1, 1970 00:00:00 UTC</code>. Events with a timestamp earlier than this time are not exported.</p>
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.create_export_task_request.CreateExportTaskRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.create_export_task_response.CreateExportTaskResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_export_task
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.create_export_task.async_create_export_task(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_import_task(self, import_source_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", import_role_arn: "aws_sdk_cloudwatch_logs.types.role_arn.RoleArn", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, import_filter: Optional["aws_sdk_cloudwatch_logs.types.import_filter.ImportFilter"] = None) -> "aws_sdk_cloudwatch_logs.types.create_import_task_response.CreateImportTaskResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.create_import_task_request.CreateImportTaskRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.create_import_task_response.CreateImportTaskResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_import_task
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.create_import_task.async_create_import_task(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def create_log_anomaly_detector(self, log_group_arn_list: "aws_sdk_cloudwatch_logs.types.log_group_arn_list.LogGroupArnList", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, detector_name: Optional["aws_sdk_cloudwatch_logs.types.detector_name.DetectorName"] = None, evaluation_frequency: Optional["aws_sdk_cloudwatch_logs.types.evaluation_frequency.EvaluationFrequency"] = None, filter_pattern: Optional["aws_sdk_cloudwatch_logs.types.filter_pattern.FilterPattern"] = None, kms_key_id: Optional["aws_sdk_cloudwatch_logs.types.detector_kms_key_arn.DetectorKmsKeyArn"] = None, anomaly_visibility_time: Optional["aws_sdk_cloudwatch_logs.types.anomaly_visibility_time.AnomalyVisibilityTime"] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None) -> "aws_sdk_cloudwatch_logs.types.create_log_anomaly_detector_response.CreateLogAnomalyDetectorResponse":
        ...
        Args:
            ...
            tags: <p>An optional list of key-value pairs to associate with the resource.</p> <p>For more information about tagging, see <a href=\"https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html\">Tagging Amazon Web Services resources</a> </p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.create_log_anomaly_detector_request.CreateLogAnomalyDetectorRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.create_log_anomaly_detector_response.CreateLogAnomalyDetectorResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_log_anomaly_detector
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.create_log_anomaly_detector.async_create_log_anomaly_detector(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def create_log_group(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, kms_key_id: Optional["aws_sdk_cloudwatch_logs.types.kms_key_id.KmsKeyId"] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None, log_group_class: Optional["aws_sdk_cloudwatch_logs.types.log_group_class.LogGroupClass"] = None, deletion_protection_enabled: Optional["aws_sdk_cloudwatch_logs.types.deletion_protection_enabled.DeletionProtectionEnabled"] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.create_log_group_request.CreateLogGroupRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_log_group
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.create_log_group.async_create_log_group(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def create_log_stream(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", log_stream_name: "aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.create_log_stream_request.CreateLogStreamRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_log_stream
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.create_log_stream.async_create_log_stream(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def create_lookup_table(self, lookup_table_name: "aws_sdk_cloudwatch_logs.types.lookup_table_name.LookupTableName", table_body: "aws_sdk_cloudwatch_logs.types.table_body.TableBody", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, description: Optional["aws_sdk_cloudwatch_logs.types.lookup_table_description.LookupTableDescription"] = None, kms_key_id: Optional["aws_sdk_cloudwatch_logs.types.kms_key_id.KmsKeyId"] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None) -> "aws_sdk_cloudwatch_logs.types.create_lookup_table_response.CreateLookupTableResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.create_lookup_table_request.CreateLookupTableRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.create_lookup_table_response.CreateLookupTableResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_lookup_table
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.create_lookup_table.async_create_lookup_table(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def create_scheduled_query(self, name: "aws_sdk_cloudwatch_logs.types.scheduled_query_name.ScheduledQueryName", query_language: "aws_sdk_cloudwatch_logs.types.query_language.QueryLanguage", query_string: "aws_sdk_cloudwatch_logs.types.query_string.QueryString", schedule_expression: "aws_sdk_cloudwatch_logs.types.schedule_expression.ScheduleExpression", execution_role_arn: "aws_sdk_cloudwatch_logs.types.role_arn.RoleArn", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, description: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_description.ScheduledQueryDescription"] = None, log_group_identifiers: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_log_group_identifiers.ScheduledQueryLogGroupIdentifiers"] = None, timezone: Optional["aws_sdk_cloudwatch_logs.types.schedule_timezone.ScheduleTimezone"] = None, start_time_offset: Optional["aws_sdk_cloudwatch_logs.types.start_time_offset.StartTimeOffset"] = None, destination_configuration: Optional["aws_sdk_cloudwatch_logs.types.destination_configuration.DestinationConfiguration"] = None, schedule_start_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, schedule_end_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, state: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_state.ScheduledQueryState"] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None) -> "aws_sdk_cloudwatch_logs.types.create_scheduled_query_response.CreateScheduledQueryResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.create_scheduled_query_request.CreateScheduledQueryRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.create_scheduled_query_response.CreateScheduledQueryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_scheduled_query
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.create_scheduled_query.async_create_scheduled_query(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_account_policy(self, policy_name: "aws_sdk_cloudwatch_logs.types.policy_name.PolicyName", policy_type: "aws_sdk_cloudwatch_logs.types.policy_type.PolicyType", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_account_policy_request.DeleteAccountPolicyRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_account_policy
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_account_policy.async_delete_account_policy(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_data_protection_policy(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_data_protection_policy_request.DeleteDataProtectionPolicyRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_data_protection_policy
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_data_protection_policy.async_delete_data_protection_policy(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_delivery(self, id: "aws_sdk_cloudwatch_logs.types.delivery_id.DeliveryId", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_delivery_request.DeleteDeliveryRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery.async_delete_delivery(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_delivery_destination(self, name: "aws_sdk_cloudwatch_logs.types.delivery_destination_name.DeliveryDestinationName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_delivery_destination_request.DeleteDeliveryDestinationRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery_destination
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery_destination.async_delete_delivery_destination(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_delivery_destination_policy(self, delivery_destination_name: "aws_sdk_cloudwatch_logs.types.delivery_destination_name.DeliveryDestinationName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_delivery_destination_policy_request.DeleteDeliveryDestinationPolicyRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery_destination_policy
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery_destination_policy.async_delete_delivery_destination_policy(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_delivery_source(self, name: "aws_sdk_cloudwatch_logs.types.delivery_source_name.DeliverySourceName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_delivery_source_request.DeleteDeliverySourceRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery_source
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery_source.async_delete_delivery_source(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_destination(self, destination_name: "aws_sdk_cloudwatch_logs.types.destination_name.DestinationName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_destination_request.DeleteDestinationRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_destination
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_destination.async_delete_destination(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_index_policy(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.delete_index_policy_response.DeleteIndexPolicyResponse":
        """<p>Deletes a log-group level field index policy that was applied to a single log group. The indexing of the log events that happened before you delete the policy will still be used for as many as 30 days to improve CloudWatch Logs Insights queries.</p> <p>If the deleted policy included facet configurations, those facets will no longer be available for interactive exploration in the CloudWatch Logs Insights console for this log group. However, facet data is retained for up to 30 days.</p> <p>You can't use this operation to delete an account-level index policy. Instead, use <a href=\"https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_DeleteAccountPolicy.html\">DeleteAccountPolicy</a>.</p> <p>If you delete a log-group level field index policy and there is an account-level field index policy, in a few minutes the log group begins using that account-wide policy to index new incoming log events. This operation only affects log group-level policies, including any facet configurations, and preserves any data source-based account policies that may apply to the log group.</p>
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_index_policy_request.DeleteIndexPolicyRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.delete_index_policy_response.DeleteIndexPolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_index_policy
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_index_policy.async_delete_index_policy(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_integration(self, integration_name: "aws_sdk_cloudwatch_logs.types.integration_name.IntegrationName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, force: Optional["aws_sdk_cloudwatch_logs.types.force.Force"] = None) -> "aws_sdk_cloudwatch_logs.types.delete_integration_response.DeleteIntegrationResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_integration_request.DeleteIntegrationRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.delete_integration_response.DeleteIntegrationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_integration
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_integration.async_delete_integration(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_log_anomaly_detector(self, anomaly_detector_arn: "aws_sdk_cloudwatch_logs.types.anomaly_detector_arn.AnomalyDetectorArn", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_log_anomaly_detector_request.DeleteLogAnomalyDetectorRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_log_anomaly_detector
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_log_anomaly_detector.async_delete_log_anomaly_detector(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_log_group(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        """<p>Deletes the specified log group and permanently deletes all the archived log events associated with the log group.</p>

        Args:
            log_group_name: <p>The name of the log group.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_log_group_request.DeleteLogGroupRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_log_group
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_log_group.async_delete_log_group(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_log_stream(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", log_stream_name: "aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        Args:
            ...
            log_stream_name: <p>The name of the log stream.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_log_stream_request.DeleteLogStreamRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_log_stream
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_log_stream.async_delete_log_stream(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_lookup_table(self, lookup_table_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_lookup_table_request.DeleteLookupTableRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_lookup_table
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_lookup_table.async_delete_lookup_table(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_metric_filter(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", filter_name: "aws_sdk_cloudwatch_logs.types.filter_name.FilterName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_metric_filter_request.DeleteMetricFilterRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_metric_filter
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_metric_filter.async_delete_metric_filter(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_query_definition(self, query_definition_id: "aws_sdk_cloudwatch_logs.types.query_id.QueryId", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.delete_query_definition_response.DeleteQueryDefinitionResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_query_definition_request.DeleteQueryDefinitionRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.delete_query_definition_response.DeleteQueryDefinitionResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_query_definition
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_query_definition.async_delete_query_definition(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_resource_policy(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, policy_name: Optional["aws_sdk_cloudwatch_logs.types.policy_name.PolicyName"] = None, resource_arn: Optional["aws_sdk_cloudwatch_logs.types.arn.Arn"] = None, expected_revision_id: Optional["aws_sdk_cloudwatch_logs.types.expected_revision_id.ExpectedRevisionId"] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_resource_policy_request.DeleteResourcePolicyRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_resource_policy
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_resource_policy.async_delete_resource_policy(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_retention_policy(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        Args:
            log_group_name: <p>The name of the log group.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_retention_policy_request.DeleteRetentionPolicyRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_retention_policy
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_retention_policy.async_delete_retention_policy(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_scheduled_query(self, identifier: "aws_sdk_cloudwatch_logs.types.scheduled_query_identifier.ScheduledQueryIdentifier", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.delete_scheduled_query_response.DeleteScheduledQueryResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_scheduled_query_request.DeleteScheduledQueryRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.delete_scheduled_query_response.DeleteScheduledQueryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_scheduled_query
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_scheduled_query.async_delete_scheduled_query(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_subscription_filter(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", filter_name: "aws_sdk_cloudwatch_logs.types.filter_name.FilterName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_subscription_filter_request.DeleteSubscriptionFilterRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_subscription_filter
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_subscription_filter.async_delete_subscription_filter(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def delete_transformer(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.delete_transformer_request.DeleteTransformerRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_transformer
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_transformer.async_delete_transformer(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def describe_account_policies(self, policy_type: "aws_sdk_cloudwatch_logs.types.policy_type.PolicyType", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, policy_name: Optional["aws_sdk_cloudwatch_logs.types.policy_name.PolicyName"] = None, account_identifiers: Optional["aws_sdk_cloudwatch_logs.types.account_ids.AccountIds"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_account_policies_response.DescribeAccountPoliciesResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_account_policies_request.DescribeAccountPoliciesRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_account_policies_response.DescribeAccountPoliciesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_account_policies
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_account_policies.async_describe_account_policies(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def describe_configuration_templates(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, service: Optional["aws_sdk_cloudwatch_logs.types.service.Service"] = None, log_types: Optional["aws_sdk_cloudwatch_logs.types.log_types.LogTypes"] = None, resource_types: Optional["aws_sdk_cloudwatch_logs.types.resource_types.ResourceTypes"] = None, delivery_destination_types: Optional["aws_sdk_cloudwatch_logs.types.delivery_destination_types.DeliveryDestinationTypes"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_configuration_templates_response.DescribeConfigurationTemplatesResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_configuration_templates_request.DescribeConfigurationTemplatesRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_configuration_templates_response.DescribeConfigurationTemplatesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_configuration_templates
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_configuration_templates.async_describe_configuration_templates(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_describe_configuration_templates(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, service: Optional["aws_sdk_cloudwatch_logs.types.service.Service"] = None, log_types: Optional["aws_sdk_cloudwatch_logs.types.log_types.LogTypes"] = None, resource_types: Optional["aws_sdk_cloudwatch_logs.types.resource_types.ResourceTypes"] = None, delivery_destination_types: Optional["aws_sdk_cloudwatch_logs.types.delivery_destination_types.DeliveryDestinationTypes"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.configuration_template.ConfigurationTemplate]":
        _token = next_token
        while True:
            _response = await self.describe_configuration_templates(
            ...
            if not _token:
                break
    async def describe_deliveries(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_deliveries_response.DescribeDeliveriesResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_deliveries_request.DescribeDeliveriesRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_deliveries_response.DescribeDeliveriesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_deliveries
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_deliveries.async_describe_deliveries(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_describe_deliveries(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.delivery.Delivery]":
        _token = next_token
        while True:
            _response = await self.describe_deliveries(
                config_overrides=config_overrides,
                next_token=_token,
                limit=limit,
            )
            ...
            if not _token:
                break
    async def describe_delivery_destinations(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_delivery_destinations_response.DescribeDeliveryDestinationsResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_delivery_destinations_request.DescribeDeliveryDestinationsRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_delivery_destinations_response.DescribeDeliveryDestinationsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_delivery_destinations
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_delivery_destinations.async_describe_delivery_destinations(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_describe_delivery_destinations(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.delivery_destination.DeliveryDestination]":
        _token = next_token
        while True:
            _response = await self.describe_delivery_destinations(
                config_overrides=config_overrides,
                next_token=_token,
                limit=limit,
            )
            ...
            if not _token:
                break
    async def describe_delivery_sources(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_delivery_sources_response.DescribeDeliverySourcesResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_delivery_sources_request.DescribeDeliverySourcesRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_delivery_sources_response.DescribeDeliverySourcesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_delivery_sources
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_delivery_sources.async_describe_delivery_sources(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_describe_delivery_sources(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.delivery_source.DeliverySource]":
        _token = next_token
        while True:
            _response = await self.describe_delivery_sources(
                config_overrides=config_overrides,
                next_token=_token,
                limit=limit,
            )
            ...
            if not _token:
                break
    async def describe_destinations(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, destination_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.destination_name.DestinationName"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_destinations_response.DescribeDestinationsResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_destinations_request.DescribeDestinationsRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_destinations_response.DescribeDestinationsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_destinations
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_destinations.async_describe_destinations(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_describe_destinations(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, destination_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.destination_name.DestinationName"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.destination.Destination]":
        _token = next_token
        while True:
            _response = await self.describe_destinations(
                config_overrides=config_overrides,
            ...
            if not _token:
                break
    async def describe_export_tasks(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, task_id: Optional["aws_sdk_cloudwatch_logs.types.export_task_id.ExportTaskId"] = None, status_code: Optional["aws_sdk_cloudwatch_logs.types.export_task_status_code.ExportTaskStatusCode"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_export_tasks_response.DescribeExportTasksResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_export_tasks_request.DescribeExportTasksRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_export_tasks_response.DescribeExportTasksResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_export_tasks
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_export_tasks.async_describe_export_tasks(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def describe_field_indexes(self, log_group_identifiers: "aws_sdk_cloudwatch_logs.types.describe_field_indexes_log_group_identifiers.DescribeFieldIndexesLogGroupIdentifiers", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_field_indexes_response.DescribeFieldIndexesResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_field_indexes_request.DescribeFieldIndexesRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_field_indexes_response.DescribeFieldIndexesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_field_indexes
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_field_indexes.async_describe_field_indexes(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def describe_import_task_batches(self, import_id: "aws_sdk_cloudwatch_logs.types.import_id.ImportId", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, batch_import_status: Optional["aws_sdk_cloudwatch_logs.types.import_status_list.ImportStatusList"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_import_task_batches_response.DescribeImportTaskBatchesResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_import_task_batches_request.DescribeImportTaskBatchesRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_import_task_batches_response.DescribeImportTaskBatchesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_import_task_batches
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_import_task_batches.async_describe_import_task_batches(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def describe_import_tasks(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, import_id: Optional["aws_sdk_cloudwatch_logs.types.import_id.ImportId"] = None, import_status: Optional["aws_sdk_cloudwatch_logs.types.import_status.ImportStatus"] = None, import_source_arn: Optional["aws_sdk_cloudwatch_logs.types.arn.Arn"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_import_tasks_response.DescribeImportTasksResponse":
        ...
        Args:
            ...
            next_token: <p>The pagination token for the next set of results.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_import_tasks_request.DescribeImportTasksRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_import_tasks_response.DescribeImportTasksResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_import_tasks
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_import_tasks.async_describe_import_tasks(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_index_policies(self, log_group_identifiers: "aws_sdk_cloudwatch_logs.types.describe_index_policies_log_group_identifiers.DescribeIndexPoliciesLogGroupIdentifiers", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_index_policies_response.DescribeIndexPoliciesResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_index_policies_request.DescribeIndexPoliciesRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_index_policies_response.DescribeIndexPoliciesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_index_policies
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_index_policies.async_describe_index_policies(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def describe_log_groups(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, account_identifiers: Optional["aws_sdk_cloudwatch_logs.types.account_ids.AccountIds"] = None, log_group_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_name_pattern: Optional["aws_sdk_cloudwatch_logs.types.log_group_name_pattern.LogGroupNamePattern"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None, include_linked_accounts: Optional["aws_sdk_cloudwatch_logs.types.include_linked_accounts.IncludeLinkedAccounts"] = None, log_group_class: Optional["aws_sdk_cloudwatch_logs.types.log_group_class.LogGroupClass"] = None, log_group_identifiers: Optional["aws_sdk_cloudwatch_logs.types.describe_log_groups_log_group_identifiers.DescribeLogGroupsLogGroupIdentifiers"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_log_groups_response.DescribeLogGroupsResponse":
        """<p>Returns information about log groups, including data sources that ingest into each log group. You can return all your log groups or filter the results by prefix. The results are ASCII-sorted by log group name.</p> <p>CloudWatch Logs doesn't support IAM policies that control access to the <code>DescribeLogGroups</code> action by using the <code>aws:ResourceTag/<i>key-name</i> </code> condition key. Other CloudWatch Logs actions do support the use of the <code>aws:ResourceTag/<i>key-name</i> </code> condition key to control access. For more information about using tags to control access, see <a href=\"https://docs.aws.amazon.com/IAM/latest/UserGuide/access_tags.html\">Controlling access to Amazon Web Services resources using tags</a>.</p> <p>If you are using CloudWatch cross-account observability, you can use this operation in a monitoring account and view data from the linked source accounts. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Unified-Cross-Account.html\">CloudWatch cross-account observability</a>.</p>
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_log_groups_request.DescribeLogGroupsRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_log_groups_response.DescribeLogGroupsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_log_groups
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_log_groups.async_describe_log_groups(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_describe_log_groups(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, account_identifiers: Optional["aws_sdk_cloudwatch_logs.types.account_ids.AccountIds"] = None, log_group_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_name_pattern: Optional["aws_sdk_cloudwatch_logs.types.log_group_name_pattern.LogGroupNamePattern"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None, include_linked_accounts: Optional["aws_sdk_cloudwatch_logs.types.include_linked_accounts.IncludeLinkedAccounts"] = None, log_group_class: Optional["aws_sdk_cloudwatch_logs.types.log_group_class.LogGroupClass"] = None, log_group_identifiers: Optional["aws_sdk_cloudwatch_logs.types.describe_log_groups_log_group_identifiers.DescribeLogGroupsLogGroupIdentifiers"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.log_group.LogGroup]":
        _token = next_token
        while True:
            _response = await self.describe_log_groups(
                config_overrides=config_overrides,
            ...
            if not _token:
                break
    async def describe_log_streams(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_identifier: Optional["aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier"] = None, log_stream_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName"] = None, order_by: Optional["aws_sdk_cloudwatch_logs.types.order_by.OrderBy"] = None, descending: Optional["aws_sdk_cloudwatch_logs.types.descending.Descending"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_log_streams_response.DescribeLogStreamsResponse":
        ...
        Args:
            ...
            limit: <p>The maximum number of items returned. If you don't specify a value, the default is up to 50 items.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_log_streams_request.DescribeLogStreamsRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_log_streams_response.DescribeLogStreamsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_log_streams
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_log_streams.async_describe_log_streams(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_describe_log_streams(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_identifier: Optional["aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier"] = None, log_stream_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName"] = None, order_by: Optional["aws_sdk_cloudwatch_logs.types.order_by.OrderBy"] = None, descending: Optional["aws_sdk_cloudwatch_logs.types.descending.Descending"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.log_stream.LogStream]":
        _token = next_token
        while True:
            _response = await self.describe_log_streams(
                config_overrides=config_overrides,
            ...
            if not _token:
                break
    async def describe_lookup_tables(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, lookup_table_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.lookup_table_name.LookupTableName"] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.describe_lookup_tables_max_results.DescribeLookupTablesMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_lookup_tables_response.DescribeLookupTablesResponse":
        ...
        Args:
            ...
            next_token: <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_lookup_tables_request.DescribeLookupTablesRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_lookup_tables_response.DescribeLookupTablesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_lookup_tables
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_lookup_tables.async_describe_lookup_tables(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def describe_metric_filters(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, filter_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.filter_name.FilterName"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None, metric_name: Optional["aws_sdk_cloudwatch_logs.types.metric_name.MetricName"] = None, metric_namespace: Optional["aws_sdk_cloudwatch_logs.types.metric_namespace.MetricNamespace"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_metric_filters_response.DescribeMetricFiltersResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_metric_filters_request.DescribeMetricFiltersRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_metric_filters_response.DescribeMetricFiltersResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_metric_filters
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_metric_filters.async_describe_metric_filters(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_describe_metric_filters(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, filter_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.filter_name.FilterName"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None, metric_name: Optional["aws_sdk_cloudwatch_logs.types.metric_name.MetricName"] = None, metric_namespace: Optional["aws_sdk_cloudwatch_logs.types.metric_namespace.MetricNamespace"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.metric_filter.MetricFilter]":
        _token = next_token
        while True:
            _response = await self.describe_metric_filters(
                config_overrides=config_overrides,
                log_group_name=log_group_name,
            ...
            if not _token:
                break
    async def describe_queries(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, status: Optional["aws_sdk_cloudwatch_logs.types.query_status.QueryStatus"] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.describe_queries_max_results.DescribeQueriesMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, query_language: Optional["aws_sdk_cloudwatch_logs.types.query_language.QueryLanguage"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_queries_response.DescribeQueriesResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_queries_request.DescribeQueriesRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_queries_response.DescribeQueriesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_queries
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_queries.async_describe_queries(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def describe_query_definitions(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, query_language: Optional["aws_sdk_cloudwatch_logs.types.query_language.QueryLanguage"] = None, query_definition_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.query_definition_name.QueryDefinitionName"] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.query_list_max_results.QueryListMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_query_definitions_response.DescribeQueryDefinitionsResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_query_definitions_request.DescribeQueryDefinitionsRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_query_definitions_response.DescribeQueryDefinitionsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_query_definitions
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_query_definitions.async_describe_query_definitions(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def describe_resource_policies(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None, resource_arn: Optional["aws_sdk_cloudwatch_logs.types.arn.Arn"] = None, policy_scope: Optional["aws_sdk_cloudwatch_logs.types.policy_scope.PolicyScope"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_resource_policies_response.DescribeResourcePoliciesResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_resource_policies_request.DescribeResourcePoliciesRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_resource_policies_response.DescribeResourcePoliciesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_resource_policies
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_resource_policies.async_describe_resource_policies(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def describe_subscription_filters(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, filter_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.filter_name.FilterName"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_subscription_filters_response.DescribeSubscriptionFiltersResponse":
        ...
        Args:
            ...
            limit: <p>The maximum number of items returned. If you don't specify a value, the default is up to 50 items.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.describe_subscription_filters_request.DescribeSubscriptionFiltersRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.describe_subscription_filters_response.DescribeSubscriptionFiltersResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_subscription_filters
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_subscription_filters.async_describe_subscription_filters(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_describe_subscription_filters(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, filter_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.filter_name.FilterName"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.subscription_filter.SubscriptionFilter]":
        _token = next_token
        while True:
            _response = await self.describe_subscription_filters(
                log_group_name,
                config_overrides=config_overrides,
                filter_name_prefix=filter_name_prefix,
                next_token=_token,
            ...
            if not _token:
                break
    async def disassociate_kms_key(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, resource_identifier: Optional["aws_sdk_cloudwatch_logs.types.resource_identifier.ResourceIdentifier"] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.disassociate_kms_key_request.DisassociateKmsKeyRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.disassociate_kms_key
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.disassociate_kms_key.async_disassociate_kms_key(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def disassociate_source_from_s3_table_integration(self, identifier: "aws_sdk_cloudwatch_logs.types.s3_table_integration_source_identifier.S3TableIntegrationSourceIdentifier", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_response.DisassociateSourceFromS3TableIntegrationResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_request.DisassociateSourceFromS3TableIntegrationRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_response.DisassociateSourceFromS3TableIntegrationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.disassociate_source_from_s3_table_integration
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.disassociate_source_from_s3_table_integration.async_disassociate_source_from_s3_table_integration(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def filter_log_events(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_identifier: Optional["aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier"] = None, log_stream_names: Optional["aws_sdk_cloudwatch_logs.types.input_log_stream_names.InputLogStreamNames"] = None, log_stream_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName"] = None, start_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, end_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, filter_pattern: Optional["aws_sdk_cloudwatch_logs.types.filter_pattern.FilterPattern"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.events_limit.EventsLimit"] = None, interleaved: Optional["aws_sdk_cloudwatch_logs.types.interleaved.Interleaved"] = None, unmask: Optional["aws_sdk_cloudwatch_logs.types.unmask.Unmask"] = None) -> "aws_sdk_cloudwatch_logs.types.filter_log_events_response.FilterLogEventsResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.filter_log_events_request.FilterLogEventsRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.filter_log_events_response.FilterLogEventsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.filter_log_events
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.filter_log_events.async_filter_log_events(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_data_protection_policy(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_data_protection_policy_response.GetDataProtectionPolicyResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_data_protection_policy_request.GetDataProtectionPolicyRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_data_protection_policy_response.GetDataProtectionPolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_data_protection_policy
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_data_protection_policy.async_get_data_protection_policy(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_delivery(self, id: "aws_sdk_cloudwatch_logs.types.delivery_id.DeliveryId", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_delivery_response.GetDeliveryResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_delivery_request.GetDeliveryRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_delivery_response.GetDeliveryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery.async_get_delivery(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_delivery_destination(self, name: "aws_sdk_cloudwatch_logs.types.delivery_destination_name.DeliveryDestinationName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_delivery_destination_response.GetDeliveryDestinationResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_delivery_destination_request.GetDeliveryDestinationRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_delivery_destination_response.GetDeliveryDestinationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery_destination
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery_destination.async_get_delivery_destination(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_delivery_destination_policy(self, delivery_destination_name: "aws_sdk_cloudwatch_logs.types.delivery_destination_name.DeliveryDestinationName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_delivery_destination_policy_response.GetDeliveryDestinationPolicyResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_delivery_destination_policy_request.GetDeliveryDestinationPolicyRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_delivery_destination_policy_response.GetDeliveryDestinationPolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery_destination_policy
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery_destination_policy.async_get_delivery_destination_policy(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_delivery_source(self, name: "aws_sdk_cloudwatch_logs.types.delivery_source_name.DeliverySourceName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_delivery_source_response.GetDeliverySourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_delivery_source_request.GetDeliverySourceRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_delivery_source_response.GetDeliverySourceResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery_source
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery_source.async_get_delivery_source(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_integration(self, integration_name: "aws_sdk_cloudwatch_logs.types.integration_name.IntegrationName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_integration_response.GetIntegrationResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_integration_request.GetIntegrationRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_integration_response.GetIntegrationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_integration
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_integration.async_get_integration(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_log_anomaly_detector(self, anomaly_detector_arn: "aws_sdk_cloudwatch_logs.types.anomaly_detector_arn.AnomalyDetectorArn", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_log_anomaly_detector_response.GetLogAnomalyDetectorResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_log_anomaly_detector_request.GetLogAnomalyDetectorRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_log_anomaly_detector_response.GetLogAnomalyDetectorResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_anomaly_detector
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_anomaly_detector.async_get_log_anomaly_detector(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_log_events(self, log_stream_name: "aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_identifier: Optional["aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier"] = None, start_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, end_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.events_limit.EventsLimit"] = None, start_from_head: Optional["aws_sdk_cloudwatch_logs.types.start_from_head.StartFromHead"] = None, unmask: Optional["aws_sdk_cloudwatch_logs.types.unmask.Unmask"] = None) -> "aws_sdk_cloudwatch_logs.types.get_log_events_response.GetLogEventsResponse":
        """<p>Lists log events from the specified log stream. You can list all of the log events or filter using a time range.</p> <p> <code>GetLogEvents</code> is a paginated operation. Each page returned can contain up to 1 MB of log events or up to 10,000 log events. A returned page might only be partially full, or even empty. For example, if the result of a query would return 15,000 log events, the first page isn't guaranteed to have 10,000 log events even if they all fit into 1 MB.</p> <p>Partially full or empty pages don't necessarily mean that pagination is finished. As long as the <code>nextBackwardToken</code> or <code>nextForwardToken</code> returned is NOT equal to the <code>nextToken</code> that you passed into the API call, there might be more log events available. The token that you use depends on the direction you want to move in along the log stream. The returned tokens are never null.</p> <note> <p>If you set <code>startFromHead</code> to <code>true</code> and you don’t include <code>endTime</code> in your request, you can end up in a situation where the pagination doesn't terminate. This can happen when the new log events are being added to the target log streams faster than they are being read. This situation is a good use case for the CloudWatch Logs <a href=\"https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CloudWatchLogs_LiveTail.html\">Live Tail</a> feature.</p> </note> <p>If you are using CloudWatch cross-account observability, you can use this operation in a monitoring account and view data from the linked source accounts. For more information, see <a href=\"https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Unified-Cross-Account.html\">CloudWatch cross-account observability</a>.</p> <p>You can specify the log group to search by using either <code>logGroupIdentifier</code> or <code>logGroupName</code>. You must include one of these two parameters, but you can't include both. </p> <note> <p>If you are using <a href=\"https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CloudWatch-Logs-Transformation.html\">log transformation</a>, the <code>GetLogEvents</code> operation returns only the original versions of log events, before they were transformed. To view the transformed versions, you must use a <a href=\"https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/AnalyzingLogData.html\">CloudWatch Logs query.</a> </p> </note>
        ...
        Args:
            ...
            unmask: <p>Specify <code>true</code> to display the log event fields with all sensitive data unmasked and visible. The default is <code>false</code>.</p> <p>To use this operation with this parameter, you must be signed into an account with the <code>logs:Unmask</code> permission.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_log_events_request.GetLogEventsRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_log_events_response.GetLogEventsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_events
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_events.async_get_log_events(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_get_log_events(self, log_stream_name: "aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_identifier: Optional["aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier"] = None, start_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, end_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.events_limit.EventsLimit"] = None, start_from_head: Optional["aws_sdk_cloudwatch_logs.types.start_from_head.StartFromHead"] = None, unmask: Optional["aws_sdk_cloudwatch_logs.types.unmask.Unmask"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.output_log_event.OutputLogEvent]":
        _token = next_token
        while True:
            _response = await self.get_log_events(
                log_stream_name,
                config_overrides=config_overrides,
                log_group_name=log_group_name,
                log_group_identifier=log_group_identifier,
            ...
            if not _token:
                break
    async def get_log_fields(self, data_source_name: "aws_sdk_cloudwatch_logs.types.data_source_name.DataSourceName", data_source_type: "aws_sdk_cloudwatch_logs.types.data_source_type.DataSourceType", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_log_fields_response.GetLogFieldsResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_log_fields_request.GetLogFieldsRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_log_fields_response.GetLogFieldsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_fields
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_fields.async_get_log_fields(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_log_group_fields(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, log_group_identifier: Optional["aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier"] = None) -> "aws_sdk_cloudwatch_logs.types.get_log_group_fields_response.GetLogGroupFieldsResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_log_group_fields_request.GetLogGroupFieldsRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_log_group_fields_response.GetLogGroupFieldsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_group_fields
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_group_fields.async_get_log_group_fields(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_log_object(self, log_object_pointer: "aws_sdk_cloudwatch_logs.types.log_object_pointer.LogObjectPointer", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, unmask: Optional["aws_sdk_cloudwatch_logs.types.unmask.Unmask"] = None) -> "aws_sdk_cloudwatch_logs.types.get_log_object_response.GetLogObjectResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_log_object_request.GetLogObjectRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_log_object_response.GetLogObjectResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_object
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_object.async_get_log_object(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_log_record(self, log_record_pointer: "aws_sdk_cloudwatch_logs.types.log_record_pointer.LogRecordPointer", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, unmask: Optional["aws_sdk_cloudwatch_logs.types.unmask.Unmask"] = None) -> "aws_sdk_cloudwatch_logs.types.get_log_record_response.GetLogRecordResponse":
        ...
        Args:
            ...
            unmask: <p>Specify <code>true</code> to display the log event fields with all sensitive data unmasked and visible. The default is <code>false</code>.</p> <p>To use this operation with this parameter, you must be signed into an account with the <code>logs:Unmask</code> permission.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_log_record_request.GetLogRecordRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_log_record_response.GetLogRecordResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_record
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_record.async_get_log_record(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_lookup_table(self, lookup_table_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_lookup_table_response.GetLookupTableResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_lookup_table_request.GetLookupTableRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_lookup_table_response.GetLookupTableResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_lookup_table
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_lookup_table.async_get_lookup_table(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_query_results(self, query_id: "aws_sdk_cloudwatch_logs.types.query_id.QueryId", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.get_query_results_next_token.GetQueryResultsNextToken"] = None, max_items: Optional["aws_sdk_cloudwatch_logs.types.get_query_results_max_items.GetQueryResultsMaxItems"] = None) -> "aws_sdk_cloudwatch_logs.types.get_query_results_response.GetQueryResultsResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_query_results_request.GetQueryResultsRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_query_results_response.GetQueryResultsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_query_results
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_query_results.async_get_query_results(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_scheduled_query(self, identifier: "aws_sdk_cloudwatch_logs.types.scheduled_query_identifier.ScheduledQueryIdentifier", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_scheduled_query_response.GetScheduledQueryResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_scheduled_query_request.GetScheduledQueryRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_scheduled_query_response.GetScheduledQueryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_scheduled_query
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_scheduled_query.async_get_scheduled_query(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_scheduled_query_history(self, identifier: "aws_sdk_cloudwatch_logs.types.scheduled_query_identifier.ScheduledQueryIdentifier", start_time: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", end_time: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, execution_statuses: Optional["aws_sdk_cloudwatch_logs.types.execution_status_list.ExecutionStatusList"] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.get_scheduled_query_history_max_results.GetScheduledQueryHistoryMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.get_scheduled_query_history_response.GetScheduledQueryHistoryResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_scheduled_query_history_request.GetScheduledQueryHistoryRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_scheduled_query_history_response.GetScheduledQueryHistoryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_scheduled_query_history
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_scheduled_query_history.async_get_scheduled_query_history(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_get_scheduled_query_history(self, identifier: "aws_sdk_cloudwatch_logs.types.scheduled_query_identifier.ScheduledQueryIdentifier", start_time: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", end_time: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, execution_statuses: Optional["aws_sdk_cloudwatch_logs.types.execution_status_list.ExecutionStatusList"] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.get_scheduled_query_history_max_results.GetScheduledQueryHistoryMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.trigger_history_record.TriggerHistoryRecord]":
        _token = next_token
        while True:
            _response = await self.get_scheduled_query_history(
                identifier,
                start_time,
                end_time,
                config_overrides=config_overrides,
            ...
            if not _token:
                break
    async def get_transformer(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_transformer_response.GetTransformerResponse":
        """<p>Returns the information about the log transformer associated with this log group.</p> <p>This operation returns data only for transformers created at the log group level. To get information for an account-level transformer, use <a href=\"https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_DescribeAccountPolicies.html\">DescribeAccountPolicies</a>.</p>
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.get_transformer_request.GetTransformerRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.get_transformer_response.GetTransformerResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_transformer
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.get_transformer.async_get_transformer(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def list_aggregate_log_group_summaries(self, group_by: "aws_sdk_cloudwatch_logs.types.list_aggregate_log_group_summaries_group_by.ListAggregateLogGroupSummariesGroupBy", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, account_identifiers: Optional["aws_sdk_cloudwatch_logs.types.account_ids.AccountIds"] = None, include_linked_accounts: Optional["aws_sdk_cloudwatch_logs.types.include_linked_accounts.IncludeLinkedAccounts"] = None, log_group_class: Optional["aws_sdk_cloudwatch_logs.types.log_group_class.LogGroupClass"] = None, log_group_name_pattern: Optional["aws_sdk_cloudwatch_logs.types.log_group_name_regex_pattern.LogGroupNameRegexPattern"] = None, data_sources: Optional["aws_sdk_cloudwatch_logs.types.data_source_filters.DataSourceFilters"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.list_log_groups_request_limit.ListLogGroupsRequestLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.list_aggregate_log_group_summaries_response.ListAggregateLogGroupSummariesResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.list_aggregate_log_group_summaries_request.ListAggregateLogGroupSummariesRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.list_aggregate_log_group_summaries_response.ListAggregateLogGroupSummariesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_aggregate_log_group_summaries
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.list_aggregate_log_group_summaries.async_list_aggregate_log_group_summaries(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_aggregate_log_group_summaries(self, group_by: "aws_sdk_cloudwatch_logs.types.list_aggregate_log_group_summaries_group_by.ListAggregateLogGroupSummariesGroupBy", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, account_identifiers: Optional["aws_sdk_cloudwatch_logs.types.account_ids.AccountIds"] = None, include_linked_accounts: Optional["aws_sdk_cloudwatch_logs.types.include_linked_accounts.IncludeLinkedAccounts"] = None, log_group_class: Optional["aws_sdk_cloudwatch_logs.types.log_group_class.LogGroupClass"] = None, log_group_name_pattern: Optional["aws_sdk_cloudwatch_logs.types.log_group_name_regex_pattern.LogGroupNameRegexPattern"] = None, data_sources: Optional["aws_sdk_cloudwatch_logs.types.data_source_filters.DataSourceFilters"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.list_log_groups_request_limit.ListLogGroupsRequestLimit"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.aggregate_log_group_summary.AggregateLogGroupSummary]":
        _token = next_token
        while True:
            _response = await self.list_aggregate_log_group_summaries(
                group_by,
                config_overrides=config_overrides,
                account_identifiers=account_identifiers,
                include_linked_accounts=include_linked_accounts,
            ...
            if not _token:
                break
    async def list_anomalies(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, anomaly_detector_arn: Optional["aws_sdk_cloudwatch_logs.types.anomaly_detector_arn.AnomalyDetectorArn"] = None, suppression_state: Optional["aws_sdk_cloudwatch_logs.types.suppression_state.SuppressionState"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.list_anomalies_limit.ListAnomaliesLimit"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.list_anomalies_response.ListAnomaliesResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.list_anomalies_request.ListAnomaliesRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.list_anomalies_response.ListAnomaliesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_anomalies
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.list_anomalies.async_list_anomalies(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_anomalies(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, anomaly_detector_arn: Optional["aws_sdk_cloudwatch_logs.types.anomaly_detector_arn.AnomalyDetectorArn"] = None, suppression_state: Optional["aws_sdk_cloudwatch_logs.types.suppression_state.SuppressionState"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.list_anomalies_limit.ListAnomaliesLimit"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.anomaly.Anomaly]":
        _token = next_token
        while True:
            _response = await self.list_anomalies(
                config_overrides=config_overrides,
            ...
            if not _token:
                break
    async def list_integrations(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, integration_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.integration_name_prefix.IntegrationNamePrefix"] = None, integration_type: Optional["aws_sdk_cloudwatch_logs.types.integration_type.IntegrationType"] = None, integration_status: Optional["aws_sdk_cloudwatch_logs.types.integration_status.IntegrationStatus"] = None) -> "aws_sdk_cloudwatch_logs.types.list_integrations_response.ListIntegrationsResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.list_integrations_request.ListIntegrationsRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.list_integrations_response.ListIntegrationsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_integrations
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.list_integrations.async_list_integrations(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def list_log_anomaly_detectors(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, filter_log_group_arn: Optional["aws_sdk_cloudwatch_logs.types.log_group_arn.LogGroupArn"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.list_log_anomaly_detectors_limit.ListLogAnomalyDetectorsLimit"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.list_log_anomaly_detectors_response.ListLogAnomalyDetectorsResponse":
        ...
        Args:
            ...
            limit: <p>The maximum number of items to return. If you don't specify a value, the default maximum value of 50 items is used.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.list_log_anomaly_detectors_request.ListLogAnomalyDetectorsRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.list_log_anomaly_detectors_response.ListLogAnomalyDetectorsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_log_anomaly_detectors
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.list_log_anomaly_detectors.async_list_log_anomaly_detectors(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_log_anomaly_detectors(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, filter_log_group_arn: Optional["aws_sdk_cloudwatch_logs.types.log_group_arn.LogGroupArn"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.list_log_anomaly_detectors_limit.ListLogAnomalyDetectorsLimit"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.anomaly_detector.AnomalyDetector]":
        _token = next_token
        while True:
            _response = await self.list_log_anomaly_detectors(
                config_overrides=config_overrides,
            ...
            if not _token:
                break
    async def list_log_groups(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, log_group_name_pattern: Optional["aws_sdk_cloudwatch_logs.types.log_group_name_regex_pattern.LogGroupNameRegexPattern"] = None, log_group_class: Optional["aws_sdk_cloudwatch_logs.types.log_group_class.LogGroupClass"] = None, include_linked_accounts: Optional["aws_sdk_cloudwatch_logs.types.include_linked_accounts.IncludeLinkedAccounts"] = None, account_identifiers: Optional["aws_sdk_cloudwatch_logs.types.account_ids.AccountIds"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.list_limit.ListLimit"] = None, data_sources: Optional["aws_sdk_cloudwatch_logs.types.data_source_filters.DataSourceFilters"] = None, field_index_names: Optional["aws_sdk_cloudwatch_logs.types.field_index_names.FieldIndexNames"] = None, log_group_tags: Optional["aws_sdk_cloudwatch_logs.types.tag_filters.TagFilters"] = None) -> "aws_sdk_cloudwatch_logs.types.list_log_groups_response.ListLogGroupsResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.list_log_groups_request.ListLogGroupsRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.list_log_groups_response.ListLogGroupsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_log_groups
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.list_log_groups.async_list_log_groups(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_log_groups_for_query(self, query_id: "aws_sdk_cloudwatch_logs.types.query_id.QueryId", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.list_log_groups_for_query_max_results.ListLogGroupsForQueryMaxResults"] = None) -> "aws_sdk_cloudwatch_logs.types.list_log_groups_for_query_response.ListLogGroupsForQueryResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.list_log_groups_for_query_request.ListLogGroupsForQueryRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.list_log_groups_for_query_response.ListLogGroupsForQueryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_log_groups_for_query
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.list_log_groups_for_query.async_list_log_groups_for_query(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_log_groups_for_query(self, query_id: "aws_sdk_cloudwatch_logs.types.query_id.QueryId", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.list_log_groups_for_query_max_results.ListLogGroupsForQueryMaxResults"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier]":
        _token = next_token
        while True:
            _response = await self.list_log_groups_for_query(
                query_id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            ...
            if not _token:
                break
    async def list_scheduled_queries(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.list_scheduled_queries_max_results.ListScheduledQueriesMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, state: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_state.ScheduledQueryState"] = None) -> "aws_sdk_cloudwatch_logs.types.list_scheduled_queries_response.ListScheduledQueriesResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.list_scheduled_queries_request.ListScheduledQueriesRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.list_scheduled_queries_response.ListScheduledQueriesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_scheduled_queries
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.list_scheduled_queries.async_list_scheduled_queries(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_scheduled_queries(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.list_scheduled_queries_max_results.ListScheduledQueriesMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, state: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_state.ScheduledQueryState"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.scheduled_query_summary.ScheduledQuerySummary]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    async def list_sources_for_s3_table_integration(self, integration_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.list_sources_for_s3_table_integration_max_results.ListSourcesForS3TableIntegrationMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.list_sources_for_s3_table_integration_response.ListSourcesForS3TableIntegrationResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.list_sources_for_s3_table_integration_request.ListSourcesForS3TableIntegrationRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.list_sources_for_s3_table_integration_response.ListSourcesForS3TableIntegrationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_sources_for_s3_table_integration
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.list_sources_for_s3_table_integration.async_list_sources_for_s3_table_integration(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_sources_for_s3_table_integration(self, integration_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.list_sources_for_s3_table_integration_max_results.ListSourcesForS3TableIntegrationMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "AsyncIterator[aws_sdk_cloudwatch_logs.types.s3_table_integration_source.S3TableIntegrationSource]":
        _token = next_token
        while True:
            _response = await self.list_sources_for_s3_table_integration(
                integration_arn,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            ...
            if not _token:
                break
    async def list_tags_for_resource(self, resource_arn: "aws_sdk_cloudwatch_logs.types.amazon_resource_name.AmazonResourceName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_tags_for_resource
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.list_tags_for_resource.async_list_tags_for_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def list_tags_log_group(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.list_tags_log_group_response.ListTagsLogGroupResponse":
        ...
        Args:
            log_group_name: <p>The name of the log group.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.list_tags_log_group_request.ListTagsLogGroupRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.list_tags_log_group_response.ListTagsLogGroupResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_tags_log_group
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.list_tags_log_group.async_list_tags_log_group(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_account_policy(self, policy_name: "aws_sdk_cloudwatch_logs.types.policy_name.PolicyName", policy_document: "aws_sdk_cloudwatch_logs.types.account_policy_document.AccountPolicyDocument", policy_type: "aws_sdk_cloudwatch_logs.types.policy_type.PolicyType", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, scope: Optional["aws_sdk_cloudwatch_logs.types.scope.Scope"] = None, selection_criteria: Optional["aws_sdk_cloudwatch_logs.types.selection_criteria.SelectionCriteria"] = None) -> "aws_sdk_cloudwatch_logs.types.put_account_policy_response.PutAccountPolicyResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_account_policy_request.PutAccountPolicyRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.put_account_policy_response.PutAccountPolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_account_policy
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_account_policy.async_put_account_policy(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_bearer_token_authentication(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", bearer_token_authentication_enabled: "aws_sdk_cloudwatch_logs.types.bearer_token_authentication_enabled.BearerTokenAuthenticationEnabled", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        """<p>Enables or disables bearer token authentication for the specified log group. When enabled on a log group, bearer token authentication is enabled on operations until it is explicitly disabled.</p> <p>For information about the parameters that are common to all actions, see <a href=\"https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/CommonParameters.html\">Common Parameters</a>.</p>
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_bearer_token_authentication_request.PutBearerTokenAuthenticationRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_bearer_token_authentication
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_bearer_token_authentication.async_put_bearer_token_authentication(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        input["log_group_identifier"] = log_group_identifier
        input["bearer_token_authentication_enabled"] = bearer_token_authentication_enabled

        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_data_protection_policy(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", policy_document: "aws_sdk_cloudwatch_logs.types.data_protection_policy_document.DataProtectionPolicyDocument", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.put_data_protection_policy_response.PutDataProtectionPolicyResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_data_protection_policy_request.PutDataProtectionPolicyRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.put_data_protection_policy_response.PutDataProtectionPolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_data_protection_policy
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_data_protection_policy.async_put_data_protection_policy(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_delivery_destination(self, name: "aws_sdk_cloudwatch_logs.types.delivery_destination_name.DeliveryDestinationName", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, output_format: Optional["aws_sdk_cloudwatch_logs.types.output_format.OutputFormat"] = None, delivery_destination_configuration: Optional["aws_sdk_cloudwatch_logs.types.delivery_destination_configuration.DeliveryDestinationConfiguration"] = None, delivery_destination_type: Optional["aws_sdk_cloudwatch_logs.types.delivery_destination_type.DeliveryDestinationType"] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None) -> "aws_sdk_cloudwatch_logs.types.put_delivery_destination_response.PutDeliveryDestinationResponse":
        ...
        Args:
            ...
            tags: <p>An optional list of key-value pairs to associate with the resource.</p> <p>For more information about tagging, see <a href=\"https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html\">Tagging Amazon Web Services resources</a> </p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_delivery_destination_request.PutDeliveryDestinationRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.put_delivery_destination_response.PutDeliveryDestinationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_delivery_destination
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_delivery_destination.async_put_delivery_destination(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        if delivery_destination_configuration is not None:
            input["delivery_destination_configuration"] = delivery_destination_configuration
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_delivery_destination_policy(self, delivery_destination_name: "aws_sdk_cloudwatch_logs.types.delivery_destination_name.DeliveryDestinationName", delivery_destination_policy: "aws_sdk_cloudwatch_logs.types.delivery_destination_policy.DeliveryDestinationPolicy", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.put_delivery_destination_policy_response.PutDeliveryDestinationPolicyResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_delivery_destination_policy_request.PutDeliveryDestinationPolicyRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.put_delivery_destination_policy_response.PutDeliveryDestinationPolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_delivery_destination_policy
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_delivery_destination_policy.async_put_delivery_destination_policy(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_delivery_source(self, name: "aws_sdk_cloudwatch_logs.types.delivery_source_name.DeliverySourceName", resource_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", log_type: "aws_sdk_cloudwatch_logs.types.log_type.LogType", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None, delivery_source_configuration: Optional["aws_sdk_cloudwatch_logs.types.delivery_source_configuration.DeliverySourceConfiguration"] = None) -> "aws_sdk_cloudwatch_logs.types.put_delivery_source_response.PutDeliverySourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_delivery_source_request.PutDeliverySourceRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.put_delivery_source_response.PutDeliverySourceResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_delivery_source
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_delivery_source.async_put_delivery_source(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_destination(self, destination_name: "aws_sdk_cloudwatch_logs.types.destination_name.DestinationName", target_arn: "aws_sdk_cloudwatch_logs.types.target_arn.TargetArn", role_arn: "aws_sdk_cloudwatch_logs.types.role_arn.RoleArn", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None) -> "aws_sdk_cloudwatch_logs.types.put_destination_response.PutDestinationResponse":
        ...
        Args:
            ...
            tags: <p>An optional list of key-value pairs to associate with the resource.</p> <p>For more information about tagging, see <a href=\"https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html\">Tagging Amazon Web Services resources</a> </p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_destination_request.PutDestinationRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.put_destination_response.PutDestinationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_destination
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_destination.async_put_destination(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_destination_policy(self, destination_name: "aws_sdk_cloudwatch_logs.types.destination_name.DestinationName", access_policy: "aws_sdk_cloudwatch_logs.types.access_policy.AccessPolicy", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, force_update: Optional["aws_sdk_cloudwatch_logs.types.force_update.ForceUpdate"] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_destination_policy_request.PutDestinationPolicyRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_destination_policy
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_destination_policy.async_put_destination_policy(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_index_policy(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", policy_document: "aws_sdk_cloudwatch_logs.types.policy_document.PolicyDocument", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.put_index_policy_response.PutIndexPolicyResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_index_policy_request.PutIndexPolicyRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.put_index_policy_response.PutIndexPolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_index_policy
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_index_policy.async_put_index_policy(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_integration(self, integration_name: "aws_sdk_cloudwatch_logs.types.integration_name.IntegrationName", resource_config: "aws_sdk_cloudwatch_logs.types.resource_config.ResourceConfig", integration_type: "aws_sdk_cloudwatch_logs.types.integration_type.IntegrationType", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.put_integration_response.PutIntegrationResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_integration_request.PutIntegrationRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.put_integration_response.PutIntegrationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_integration
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_integration.async_put_integration(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_log_events(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", log_stream_name: "aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName", log_events: "aws_sdk_cloudwatch_logs.types.input_log_events.InputLogEvents", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, sequence_token: Optional["aws_sdk_cloudwatch_logs.types.sequence_token.SequenceToken"] = None, entity: Optional["aws_sdk_cloudwatch_logs.types.entity.Entity"] = None) -> "aws_sdk_cloudwatch_logs.types.put_log_events_response.PutLogEventsResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_log_events_request.PutLogEventsRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.put_log_events_response.PutLogEventsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_log_events
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_log_events.async_put_log_events(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_log_group_deletion_protection(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", deletion_protection_enabled: "aws_sdk_cloudwatch_logs.types.deletion_protection_enabled.DeletionProtectionEnabled", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        """<p>Enables or disables deletion protection for the specified log group. When enabled on a log group, deletion protection blocks all deletion operations until it is explicitly disabled.</p> <p>For information about the parameters that are common to all actions, see <a href=\"https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/CommonParameters.html\">Common Parameters</a>.</p>

        Args:
            log_group_identifier: <p>The name or ARN of the log group.</p> <p>Type: String</p> <p>Length Constraints: Minimum length of 1. Maximum length of 512.</p> <p>Pattern: <code>[\.\-_/#A-Za-z0-9]+</code> </p> <p>Required: Yes</p>
            deletion_protection_enabled: <p>Whether to enable deletion protection.</p> <p>Type: Boolean</p> <p>Required: Yes</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_log_group_deletion_protection_request.PutLogGroupDeletionProtectionRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_log_group_deletion_protection
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_log_group_deletion_protection.async_put_log_group_deletion_protection(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_metric_filter(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", filter_name: "aws_sdk_cloudwatch_logs.types.filter_name.FilterName", filter_pattern: "aws_sdk_cloudwatch_logs.types.filter_pattern.FilterPattern", metric_transformations: "aws_sdk_cloudwatch_logs.types.metric_transformations.MetricTransformations", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, apply_on_transformed_logs: Optional["aws_sdk_cloudwatch_logs.types.apply_on_transformed_logs.ApplyOnTransformedLogs"] = None, field_selection_criteria: Optional["aws_sdk_cloudwatch_logs.types.field_selection_criteria.FieldSelectionCriteria"] = None, emit_system_field_dimensions: Optional["aws_sdk_cloudwatch_logs.types.emit_system_fields.EmitSystemFields"] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_metric_filter_request.PutMetricFilterRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_metric_filter
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_metric_filter.async_put_metric_filter(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_query_definition(self, name: "aws_sdk_cloudwatch_logs.types.query_definition_name.QueryDefinitionName", query_string: "aws_sdk_cloudwatch_logs.types.query_definition_string.QueryDefinitionString", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, query_language: Optional["aws_sdk_cloudwatch_logs.types.query_language.QueryLanguage"] = None, query_definition_id: Optional["aws_sdk_cloudwatch_logs.types.query_id.QueryId"] = None, log_group_names: Optional["aws_sdk_cloudwatch_logs.types.log_group_names.LogGroupNames"] = None, client_token: Optional["aws_sdk_cloudwatch_logs.types.client_token.ClientToken"] = None, parameters: Optional["aws_sdk_cloudwatch_logs.types.query_parameter_list.QueryParameterList"] = None) -> "aws_sdk_cloudwatch_logs.types.put_query_definition_response.PutQueryDefinitionResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_query_definition_request.PutQueryDefinitionRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.put_query_definition_response.PutQueryDefinitionResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_query_definition
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_query_definition.async_put_query_definition(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_resource_policy(self, *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, policy_name: Optional["aws_sdk_cloudwatch_logs.types.policy_name.PolicyName"] = None, policy_document: Optional["aws_sdk_cloudwatch_logs.types.policy_document.PolicyDocument"] = None, resource_arn: Optional["aws_sdk_cloudwatch_logs.types.arn.Arn"] = None, expected_revision_id: Optional["aws_sdk_cloudwatch_logs.types.expected_revision_id.ExpectedRevisionId"] = None) -> "aws_sdk_cloudwatch_logs.types.put_resource_policy_response.PutResourcePolicyResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_resource_policy_request.PutResourcePolicyRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.put_resource_policy_response.PutResourcePolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_resource_policy
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_resource_policy.async_put_resource_policy(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_retention_policy(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", retention_in_days: "aws_sdk_cloudwatch_logs.types.days.Days", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        Args:
            log_group_name: <p>The name of the log group.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_retention_policy_request.PutRetentionPolicyRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_retention_policy
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_retention_policy.async_put_retention_policy(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_subscription_filter(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", filter_name: "aws_sdk_cloudwatch_logs.types.filter_name.FilterName", filter_pattern: "aws_sdk_cloudwatch_logs.types.filter_pattern.FilterPattern", destination_arn: "aws_sdk_cloudwatch_logs.types.destination_arn.DestinationArn", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, role_arn: Optional["aws_sdk_cloudwatch_logs.types.role_arn.RoleArn"] = None, distribution: Optional["aws_sdk_cloudwatch_logs.types.distribution.Distribution"] = None, apply_on_transformed_logs: Optional["aws_sdk_cloudwatch_logs.types.apply_on_transformed_logs.ApplyOnTransformedLogs"] = None, field_selection_criteria: Optional["aws_sdk_cloudwatch_logs.types.field_selection_criteria.FieldSelectionCriteria"] = None, emit_system_fields: Optional["aws_sdk_cloudwatch_logs.types.emit_system_fields.EmitSystemFields"] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_subscription_filter_request.PutSubscriptionFilterRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_subscription_filter
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_subscription_filter.async_put_subscription_filter(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def put_transformer(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", transformer_config: "aws_sdk_cloudwatch_logs.types.processors.Processors", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.put_transformer_request.PutTransformerRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_transformer
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.put_transformer.async_put_transformer(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def start_live_tail(self, log_group_identifiers: "aws_sdk_cloudwatch_logs.types.start_live_tail_log_group_identifiers.StartLiveTailLogGroupIdentifiers", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, log_stream_names: Optional["aws_sdk_cloudwatch_logs.types.input_log_stream_names.InputLogStreamNames"] = None, log_stream_name_prefixes: Optional["aws_sdk_cloudwatch_logs.types.input_log_stream_names.InputLogStreamNames"] = None, log_event_filter_pattern: Optional["aws_sdk_cloudwatch_logs.types.filter_pattern.FilterPattern"] = None) -> "aws_sdk_cloudwatch_logs.types.start_live_tail_response.StartLiveTailResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.start_live_tail_request.StartLiveTailRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.start_live_tail_response.StartLiveTailResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.start_live_tail
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.start_live_tail.async_start_live_tail(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_query(self, start_time: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", end_time: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", query_string: "aws_sdk_cloudwatch_logs.types.query_string.QueryString", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, query_language: Optional["aws_sdk_cloudwatch_logs.types.query_language.QueryLanguage"] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_names: Optional["aws_sdk_cloudwatch_logs.types.log_group_names.LogGroupNames"] = None, log_group_identifiers: Optional["aws_sdk_cloudwatch_logs.types.log_group_identifiers.LogGroupIdentifiers"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.events_limit_start_query.EventsLimitStartQuery"] = None) -> "aws_sdk_cloudwatch_logs.types.start_query_response.StartQueryResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.start_query_request.StartQueryRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.start_query_response.StartQueryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.start_query
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.start_query.async_start_query(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def stop_query(self, query_id: "aws_sdk_cloudwatch_logs.types.query_id.QueryId", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.stop_query_response.StopQueryResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.stop_query_request.StopQueryRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.stop_query_response.StopQueryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.stop_query
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.stop_query.async_stop_query(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def tag_log_group(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", tags: "aws_sdk_cloudwatch_logs.types.tags.Tags", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.tag_log_group_request.TagLogGroupRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.tag_log_group
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.tag_log_group.async_tag_log_group(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def tag_resource(self, resource_arn: "aws_sdk_cloudwatch_logs.types.amazon_resource_name.AmazonResourceName", tags: "aws_sdk_cloudwatch_logs.types.tags.Tags", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.tag_resource_request.TagResourceRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.tag_resource
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.tag_resource.async_tag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def test_metric_filter(self, filter_pattern: "aws_sdk_cloudwatch_logs.types.filter_pattern.FilterPattern", log_event_messages: "aws_sdk_cloudwatch_logs.types.test_event_messages.TestEventMessages", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.test_metric_filter_response.TestMetricFilterResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.test_metric_filter_request.TestMetricFilterRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.test_metric_filter_response.TestMetricFilterResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.test_metric_filter
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.test_metric_filter.async_test_metric_filter(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def test_transformer(self, transformer_config: "aws_sdk_cloudwatch_logs.types.processors.Processors", log_event_messages: "aws_sdk_cloudwatch_logs.types.test_event_messages.TestEventMessages", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.test_transformer_response.TestTransformerResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.test_transformer_request.TestTransformerRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.test_transformer_response.TestTransformerResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.test_transformer
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.test_transformer.async_test_transformer(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def untag_log_group(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", tags: "aws_sdk_cloudwatch_logs.types.tag_list.TagList", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.untag_log_group_request.UntagLogGroupRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.untag_log_group
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.untag_log_group.async_untag_log_group(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def untag_resource(self, resource_arn: "aws_sdk_cloudwatch_logs.types.amazon_resource_name.AmazonResourceName", tag_keys: "aws_sdk_cloudwatch_logs.types.tag_key_list.TagKeyList", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.untag_resource_request.UntagResourceRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.untag_resource
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.untag_resource.async_untag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def update_anomaly(self, anomaly_detector_arn: "aws_sdk_cloudwatch_logs.types.anomaly_detector_arn.AnomalyDetectorArn", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, anomaly_id: Optional["aws_sdk_cloudwatch_logs.types.anomaly_id.AnomalyId"] = None, pattern_id: Optional["aws_sdk_cloudwatch_logs.types.pattern_id.PatternId"] = None, suppression_type: Optional["aws_sdk_cloudwatch_logs.types.suppression_type.SuppressionType"] = None, suppression_period: Optional["aws_sdk_cloudwatch_logs.types.suppression_period.SuppressionPeriod"] = None, baseline: Optional["aws_sdk_cloudwatch_logs.types.baseline.Baseline"] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.update_anomaly_request.UpdateAnomalyRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.update_anomaly
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.update_anomaly.async_update_anomaly(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def update_delivery_configuration(self, id: "aws_sdk_cloudwatch_logs.types.delivery_id.DeliveryId", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, record_fields: Optional["aws_sdk_cloudwatch_logs.types.record_fields.RecordFields"] = None, field_delimiter: Optional["aws_sdk_cloudwatch_logs.types.field_delimiter.FieldDelimiter"] = None, s3_delivery_configuration: Optional["aws_sdk_cloudwatch_logs.types.s3_delivery_configuration.S3DeliveryConfiguration"] = None) -> "aws_sdk_cloudwatch_logs.types.update_delivery_configuration_response.UpdateDeliveryConfigurationResponse":
        ...
        Args:
            ...
            s3_delivery_configuration: <p>This structure contains parameters that are valid only when the delivery's delivery destination is an S3 bucket.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.update_delivery_configuration_request.UpdateDeliveryConfigurationRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.update_delivery_configuration_response.UpdateDeliveryConfigurationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.update_delivery_configuration
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.update_delivery_configuration.async_update_delivery_configuration(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def update_log_anomaly_detector(self, anomaly_detector_arn: "aws_sdk_cloudwatch_logs.types.anomaly_detector_arn.AnomalyDetectorArn", enabled: "aws_sdk_cloudwatch_logs.types.boolean.Boolean", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, evaluation_frequency: Optional["aws_sdk_cloudwatch_logs.types.evaluation_frequency.EvaluationFrequency"] = None, filter_pattern: Optional["aws_sdk_cloudwatch_logs.types.filter_pattern.FilterPattern"] = None, anomaly_visibility_time: Optional["aws_sdk_cloudwatch_logs.types.anomaly_visibility_time.AnomalyVisibilityTime"] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.update_log_anomaly_detector_request.UpdateLogAnomalyDetectorRequest]') -> AsyncOperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.update_log_anomaly_detector
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.update_log_anomaly_detector.async_update_log_anomaly_detector(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def update_lookup_table(self, lookup_table_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", table_body: "aws_sdk_cloudwatch_logs.types.table_body.TableBody", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, description: Optional["aws_sdk_cloudwatch_logs.types.lookup_table_description.LookupTableDescription"] = None, kms_key_id: Optional["aws_sdk_cloudwatch_logs.types.kms_key_id.KmsKeyId"] = None) -> "aws_sdk_cloudwatch_logs.types.update_lookup_table_response.UpdateLookupTableResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.update_lookup_table_request.UpdateLookupTableRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.update_lookup_table_response.UpdateLookupTableResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.update_lookup_table
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.update_lookup_table.async_update_lookup_table(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def update_scheduled_query(self, identifier: "aws_sdk_cloudwatch_logs.types.scheduled_query_identifier.ScheduledQueryIdentifier", query_language: "aws_sdk_cloudwatch_logs.types.query_language.QueryLanguage", query_string: "aws_sdk_cloudwatch_logs.types.query_string.QueryString", schedule_expression: "aws_sdk_cloudwatch_logs.types.schedule_expression.ScheduleExpression", execution_role_arn: "aws_sdk_cloudwatch_logs.types.role_arn.RoleArn", *, config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None, description: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_description.ScheduledQueryDescription"] = None, log_group_identifiers: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_log_group_identifiers.ScheduledQueryLogGroupIdentifiers"] = None, timezone: Optional["aws_sdk_cloudwatch_logs.types.schedule_timezone.ScheduleTimezone"] = None, start_time_offset: Optional["aws_sdk_cloudwatch_logs.types.start_time_offset.StartTimeOffset"] = None, destination_configuration: Optional["aws_sdk_cloudwatch_logs.types.destination_configuration.DestinationConfiguration"] = None, schedule_start_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, schedule_end_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, state: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_state.ScheduledQueryState"] = None) -> "aws_sdk_cloudwatch_logs.types.update_scheduled_query_response.UpdateScheduledQueryResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_cloudwatch_logs.types.update_scheduled_query_request.UpdateScheduledQueryRequest]') -> AsyncOperationResponse["aws_sdk_cloudwatch_logs.types.update_scheduled_query_response.UpdateScheduledQueryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.update_scheduled_query
            output, http_response = await aws_sdk_cloudwatch_logs._operations.logs_20140328.update_scheduled_query.async_update_scheduled_query(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
