...
from aws_sdk_cloudwatch_logs._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
...
class CloudWatchLogsClient:
    ...
    def associate_kms_key(self, kms_key_id: "aws_sdk_cloudwatch_logs.types.kms_key_id.KmsKeyId", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, resource_identifier: Optional["aws_sdk_cloudwatch_logs.types.resource_identifier.ResourceIdentifier"] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.associate_kms_key_request.AssociateKmsKeyRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.associate_kms_key
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.associate_kms_key.associate_kms_key(req.options, req.input)
    ...
    def associate_source_to_s3_table_integration(self, integration_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", data_source: "aws_sdk_cloudwatch_logs.types.data_source.DataSource", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.associate_source_to_s3_table_integration_response.AssociateSourceToS3TableIntegrationResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.associate_source_to_s3_table_integration_request.AssociateSourceToS3TableIntegrationRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.associate_source_to_s3_table_integration_response.AssociateSourceToS3TableIntegrationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.associate_source_to_s3_table_integration
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.associate_source_to_s3_table_integration.associate_source_to_s3_table_integration(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def cancel_export_task(self, task_id: "aws_sdk_cloudwatch_logs.types.export_task_id.ExportTaskId", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.cancel_export_task_request.CancelExportTaskRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.cancel_export_task
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.cancel_export_task.cancel_export_task(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def cancel_import_task(self, import_id: "aws_sdk_cloudwatch_logs.types.import_id.ImportId", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.cancel_import_task_response.CancelImportTaskResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.cancel_import_task_request.CancelImportTaskRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.cancel_import_task_response.CancelImportTaskResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.cancel_import_task
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.cancel_import_task.cancel_import_task(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def create_delivery(self, delivery_source_name: "aws_sdk_cloudwatch_logs.types.delivery_source_name.DeliverySourceName", delivery_destination_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, record_fields: Optional["aws_sdk_cloudwatch_logs.types.record_fields.RecordFields"] = None, field_delimiter: Optional["aws_sdk_cloudwatch_logs.types.field_delimiter.FieldDelimiter"] = None, s3_delivery_configuration: Optional["aws_sdk_cloudwatch_logs.types.s3_delivery_configuration.S3DeliveryConfiguration"] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None) -> "aws_sdk_cloudwatch_logs.types.create_delivery_response.CreateDeliveryResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.create_delivery_request.CreateDeliveryRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.create_delivery_response.CreateDeliveryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_delivery
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.create_delivery.create_delivery(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def create_export_task(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", from: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", to: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", destination: "aws_sdk_cloudwatch_logs.types.export_destination_bucket.ExportDestinationBucket", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, task_name: Optional["aws_sdk_cloudwatch_logs.types.export_task_name.ExportTaskName"] = None, log_stream_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName"] = None, destination_prefix: Optional["aws_sdk_cloudwatch_logs.types.export_destination_prefix.ExportDestinationPrefix"] = None) -> "aws_sdk_cloudwatch_logs.types.create_export_task_response.CreateExportTaskResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.create_export_task_request.CreateExportTaskRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.create_export_task_response.CreateExportTaskResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_export_task
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.create_export_task.create_export_task(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def create_import_task(self, import_source_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", import_role_arn: "aws_sdk_cloudwatch_logs.types.role_arn.RoleArn", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, import_filter: Optional["aws_sdk_cloudwatch_logs.types.import_filter.ImportFilter"] = None) -> "aws_sdk_cloudwatch_logs.types.create_import_task_response.CreateImportTaskResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.create_import_task_request.CreateImportTaskRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.create_import_task_response.CreateImportTaskResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_import_task
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.create_import_task.create_import_task(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def create_log_anomaly_detector(self, log_group_arn_list: "aws_sdk_cloudwatch_logs.types.log_group_arn_list.LogGroupArnList", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, detector_name: Optional["aws_sdk_cloudwatch_logs.types.detector_name.DetectorName"] = None, evaluation_frequency: Optional["aws_sdk_cloudwatch_logs.types.evaluation_frequency.EvaluationFrequency"] = None, filter_pattern: Optional["aws_sdk_cloudwatch_logs.types.filter_pattern.FilterPattern"] = None, kms_key_id: Optional["aws_sdk_cloudwatch_logs.types.detector_kms_key_arn.DetectorKmsKeyArn"] = None, anomaly_visibility_time: Optional["aws_sdk_cloudwatch_logs.types.anomaly_visibility_time.AnomalyVisibilityTime"] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None) -> "aws_sdk_cloudwatch_logs.types.create_log_anomaly_detector_response.CreateLogAnomalyDetectorResponse":
        ...
        Args:
            ...
            tags: <p>An optional list of key-value pairs to associate with the resource.</p> <p>For more information about tagging, see <a href=\"https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html\">Tagging Amazon Web Services resources</a> </p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.create_log_anomaly_detector_request.CreateLogAnomalyDetectorRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.create_log_anomaly_detector_response.CreateLogAnomalyDetectorResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_log_anomaly_detector
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.create_log_anomaly_detector.create_log_anomaly_detector(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def create_log_group(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, kms_key_id: Optional["aws_sdk_cloudwatch_logs.types.kms_key_id.KmsKeyId"] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None, log_group_class: Optional["aws_sdk_cloudwatch_logs.types.log_group_class.LogGroupClass"] = None, deletion_protection_enabled: Optional["aws_sdk_cloudwatch_logs.types.deletion_protection_enabled.DeletionProtectionEnabled"] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.create_log_group_request.CreateLogGroupRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_log_group
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.create_log_group.create_log_group(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def create_log_stream(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", log_stream_name: "aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.create_log_stream_request.CreateLogStreamRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_log_stream
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.create_log_stream.create_log_stream(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def create_lookup_table(self, lookup_table_name: "aws_sdk_cloudwatch_logs.types.lookup_table_name.LookupTableName", table_body: "aws_sdk_cloudwatch_logs.types.table_body.TableBody", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, description: Optional["aws_sdk_cloudwatch_logs.types.lookup_table_description.LookupTableDescription"] = None, kms_key_id: Optional["aws_sdk_cloudwatch_logs.types.kms_key_id.KmsKeyId"] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None) -> "aws_sdk_cloudwatch_logs.types.create_lookup_table_response.CreateLookupTableResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.create_lookup_table_request.CreateLookupTableRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.create_lookup_table_response.CreateLookupTableResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_lookup_table
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.create_lookup_table.create_lookup_table(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def create_scheduled_query(self, name: "aws_sdk_cloudwatch_logs.types.scheduled_query_name.ScheduledQueryName", query_language: "aws_sdk_cloudwatch_logs.types.query_language.QueryLanguage", query_string: "aws_sdk_cloudwatch_logs.types.query_string.QueryString", schedule_expression: "aws_sdk_cloudwatch_logs.types.schedule_expression.ScheduleExpression", execution_role_arn: "aws_sdk_cloudwatch_logs.types.role_arn.RoleArn", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, description: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_description.ScheduledQueryDescription"] = None, log_group_identifiers: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_log_group_identifiers.ScheduledQueryLogGroupIdentifiers"] = None, timezone: Optional["aws_sdk_cloudwatch_logs.types.schedule_timezone.ScheduleTimezone"] = None, start_time_offset: Optional["aws_sdk_cloudwatch_logs.types.start_time_offset.StartTimeOffset"] = None, destination_configuration: Optional["aws_sdk_cloudwatch_logs.types.destination_configuration.DestinationConfiguration"] = None, schedule_start_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, schedule_end_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, state: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_state.ScheduledQueryState"] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None) -> "aws_sdk_cloudwatch_logs.types.create_scheduled_query_response.CreateScheduledQueryResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.create_scheduled_query_request.CreateScheduledQueryRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.create_scheduled_query_response.CreateScheduledQueryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.create_scheduled_query
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.create_scheduled_query.create_scheduled_query(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_account_policy(self, policy_name: "aws_sdk_cloudwatch_logs.types.policy_name.PolicyName", policy_type: "aws_sdk_cloudwatch_logs.types.policy_type.PolicyType", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_account_policy_request.DeleteAccountPolicyRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_account_policy
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_account_policy.delete_account_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_data_protection_policy(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_data_protection_policy_request.DeleteDataProtectionPolicyRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_data_protection_policy
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_data_protection_policy.delete_data_protection_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_delivery(self, id: "aws_sdk_cloudwatch_logs.types.delivery_id.DeliveryId", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_delivery_request.DeleteDeliveryRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery.delete_delivery(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_delivery_destination(self, name: "aws_sdk_cloudwatch_logs.types.delivery_destination_name.DeliveryDestinationName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_delivery_destination_request.DeleteDeliveryDestinationRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery_destination
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery_destination.delete_delivery_destination(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_delivery_destination_policy(self, delivery_destination_name: "aws_sdk_cloudwatch_logs.types.delivery_destination_name.DeliveryDestinationName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_delivery_destination_policy_request.DeleteDeliveryDestinationPolicyRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery_destination_policy
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery_destination_policy.delete_delivery_destination_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_delivery_source(self, name: "aws_sdk_cloudwatch_logs.types.delivery_source_name.DeliverySourceName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_delivery_source_request.DeleteDeliverySourceRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery_source
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_delivery_source.delete_delivery_source(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_destination(self, destination_name: "aws_sdk_cloudwatch_logs.types.destination_name.DestinationName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_destination_request.DeleteDestinationRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_destination
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_destination.delete_destination(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_index_policy(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.delete_index_policy_response.DeleteIndexPolicyResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_index_policy_request.DeleteIndexPolicyRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.delete_index_policy_response.DeleteIndexPolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_index_policy
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_index_policy.delete_index_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_integration(self, integration_name: "aws_sdk_cloudwatch_logs.types.integration_name.IntegrationName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, force: Optional["aws_sdk_cloudwatch_logs.types.force.Force"] = None) -> "aws_sdk_cloudwatch_logs.types.delete_integration_response.DeleteIntegrationResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_integration_request.DeleteIntegrationRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.delete_integration_response.DeleteIntegrationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_integration
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_integration.delete_integration(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_log_anomaly_detector(self, anomaly_detector_arn: "aws_sdk_cloudwatch_logs.types.anomaly_detector_arn.AnomalyDetectorArn", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_log_anomaly_detector_request.DeleteLogAnomalyDetectorRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_log_anomaly_detector
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_log_anomaly_detector.delete_log_anomaly_detector(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_log_group(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        """<p>Deletes the specified log group and permanently deletes all the archived log events associated with the log group.</p>

        Args:
            log_group_name: <p>The name of the log group.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_log_group_request.DeleteLogGroupRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_log_group
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_log_group.delete_log_group(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_log_stream(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", log_stream_name: "aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        Args:
            ...
            log_stream_name: <p>The name of the log stream.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_log_stream_request.DeleteLogStreamRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_log_stream
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_log_stream.delete_log_stream(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_lookup_table(self, lookup_table_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_lookup_table_request.DeleteLookupTableRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_lookup_table
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_lookup_table.delete_lookup_table(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_metric_filter(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", filter_name: "aws_sdk_cloudwatch_logs.types.filter_name.FilterName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_metric_filter_request.DeleteMetricFilterRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_metric_filter
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_metric_filter.delete_metric_filter(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_query_definition(self, query_definition_id: "aws_sdk_cloudwatch_logs.types.query_id.QueryId", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.delete_query_definition_response.DeleteQueryDefinitionResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_query_definition_request.DeleteQueryDefinitionRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.delete_query_definition_response.DeleteQueryDefinitionResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_query_definition
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_query_definition.delete_query_definition(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_resource_policy(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, policy_name: Optional["aws_sdk_cloudwatch_logs.types.policy_name.PolicyName"] = None, resource_arn: Optional["aws_sdk_cloudwatch_logs.types.arn.Arn"] = None, expected_revision_id: Optional["aws_sdk_cloudwatch_logs.types.expected_revision_id.ExpectedRevisionId"] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_resource_policy_request.DeleteResourcePolicyRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_resource_policy
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_resource_policy.delete_resource_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_retention_policy(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        Args:
            log_group_name: <p>The name of the log group.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_retention_policy_request.DeleteRetentionPolicyRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_retention_policy
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_retention_policy.delete_retention_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_scheduled_query(self, identifier: "aws_sdk_cloudwatch_logs.types.scheduled_query_identifier.ScheduledQueryIdentifier", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.delete_scheduled_query_response.DeleteScheduledQueryResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_scheduled_query_request.DeleteScheduledQueryRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.delete_scheduled_query_response.DeleteScheduledQueryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_scheduled_query
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_scheduled_query.delete_scheduled_query(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_subscription_filter(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", filter_name: "aws_sdk_cloudwatch_logs.types.filter_name.FilterName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_subscription_filter_request.DeleteSubscriptionFilterRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_subscription_filter
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_subscription_filter.delete_subscription_filter(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def delete_transformer(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.delete_transformer_request.DeleteTransformerRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_transformer
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.delete_transformer.delete_transformer(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def describe_account_policies(self, policy_type: "aws_sdk_cloudwatch_logs.types.policy_type.PolicyType", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, policy_name: Optional["aws_sdk_cloudwatch_logs.types.policy_name.PolicyName"] = None, account_identifiers: Optional["aws_sdk_cloudwatch_logs.types.account_ids.AccountIds"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_account_policies_response.DescribeAccountPoliciesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_account_policies_request.DescribeAccountPoliciesRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_account_policies_response.DescribeAccountPoliciesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_account_policies
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_account_policies.describe_account_policies(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_configuration_templates(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, service: Optional["aws_sdk_cloudwatch_logs.types.service.Service"] = None, log_types: Optional["aws_sdk_cloudwatch_logs.types.log_types.LogTypes"] = None, resource_types: Optional["aws_sdk_cloudwatch_logs.types.resource_types.ResourceTypes"] = None, delivery_destination_types: Optional["aws_sdk_cloudwatch_logs.types.delivery_destination_types.DeliveryDestinationTypes"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_configuration_templates_response.DescribeConfigurationTemplatesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_configuration_templates_request.DescribeConfigurationTemplatesRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_configuration_templates_response.DescribeConfigurationTemplatesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_configuration_templates
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_configuration_templates.describe_configuration_templates(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_describe_configuration_templates(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, service: Optional["aws_sdk_cloudwatch_logs.types.service.Service"] = None, log_types: Optional["aws_sdk_cloudwatch_logs.types.log_types.LogTypes"] = None, resource_types: Optional["aws_sdk_cloudwatch_logs.types.resource_types.ResourceTypes"] = None, delivery_destination_types: Optional["aws_sdk_cloudwatch_logs.types.delivery_destination_types.DeliveryDestinationTypes"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.configuration_template.ConfigurationTemplate]":
        _token = next_token
        while True:
    ...
    def describe_deliveries(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_deliveries_response.DescribeDeliveriesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_deliveries_request.DescribeDeliveriesRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_deliveries_response.DescribeDeliveriesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_deliveries
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_deliveries.describe_deliveries(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_describe_deliveries(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.delivery.Delivery]":
        _token = next_token
        while True:
    ...
    def describe_delivery_destinations(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_delivery_destinations_response.DescribeDeliveryDestinationsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_delivery_destinations_request.DescribeDeliveryDestinationsRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_delivery_destinations_response.DescribeDeliveryDestinationsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_delivery_destinations
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_delivery_destinations.describe_delivery_destinations(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_describe_delivery_destinations(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.delivery_destination.DeliveryDestination]":
        _token = next_token
        while True:
    ...
    def describe_delivery_sources(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_delivery_sources_response.DescribeDeliverySourcesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_delivery_sources_request.DescribeDeliverySourcesRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_delivery_sources_response.DescribeDeliverySourcesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_delivery_sources
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_delivery_sources.describe_delivery_sources(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_describe_delivery_sources(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.delivery_source.DeliverySource]":
        _token = next_token
        while True:
    ...
    def describe_destinations(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, destination_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.destination_name.DestinationName"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_destinations_response.DescribeDestinationsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_destinations_request.DescribeDestinationsRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_destinations_response.DescribeDestinationsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_destinations
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_destinations.describe_destinations(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_destinations(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, destination_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.destination_name.DestinationName"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.destination.Destination]":
        ...
        while True:
            ...
            if not _token:
                break
    def describe_export_tasks(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, task_id: Optional["aws_sdk_cloudwatch_logs.types.export_task_id.ExportTaskId"] = None, status_code: Optional["aws_sdk_cloudwatch_logs.types.export_task_status_code.ExportTaskStatusCode"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_export_tasks_response.DescribeExportTasksResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_export_tasks_request.DescribeExportTasksRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_export_tasks_response.DescribeExportTasksResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_export_tasks
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_export_tasks.describe_export_tasks(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_field_indexes(self, log_group_identifiers: "aws_sdk_cloudwatch_logs.types.describe_field_indexes_log_group_identifiers.DescribeFieldIndexesLogGroupIdentifiers", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_field_indexes_response.DescribeFieldIndexesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_field_indexes_request.DescribeFieldIndexesRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_field_indexes_response.DescribeFieldIndexesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_field_indexes
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_field_indexes.describe_field_indexes(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def describe_import_task_batches(self, import_id: "aws_sdk_cloudwatch_logs.types.import_id.ImportId", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, batch_import_status: Optional["aws_sdk_cloudwatch_logs.types.import_status_list.ImportStatusList"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_import_task_batches_response.DescribeImportTaskBatchesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_import_task_batches_request.DescribeImportTaskBatchesRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_import_task_batches_response.DescribeImportTaskBatchesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_import_task_batches
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_import_task_batches.describe_import_task_batches(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def describe_import_tasks(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, import_id: Optional["aws_sdk_cloudwatch_logs.types.import_id.ImportId"] = None, import_status: Optional["aws_sdk_cloudwatch_logs.types.import_status.ImportStatus"] = None, import_source_arn: Optional["aws_sdk_cloudwatch_logs.types.arn.Arn"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_import_tasks_response.DescribeImportTasksResponse":
        ...
        Args:
            ...
            next_token: <p>The pagination token for the next set of results.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_import_tasks_request.DescribeImportTasksRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_import_tasks_response.DescribeImportTasksResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_import_tasks
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_import_tasks.describe_import_tasks(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def describe_index_policies(self, log_group_identifiers: "aws_sdk_cloudwatch_logs.types.describe_index_policies_log_group_identifiers.DescribeIndexPoliciesLogGroupIdentifiers", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_index_policies_response.DescribeIndexPoliciesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_index_policies_request.DescribeIndexPoliciesRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_index_policies_response.DescribeIndexPoliciesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_index_policies
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_index_policies.describe_index_policies(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_log_groups(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, account_identifiers: Optional["aws_sdk_cloudwatch_logs.types.account_ids.AccountIds"] = None, log_group_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_name_pattern: Optional["aws_sdk_cloudwatch_logs.types.log_group_name_pattern.LogGroupNamePattern"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None, include_linked_accounts: Optional["aws_sdk_cloudwatch_logs.types.include_linked_accounts.IncludeLinkedAccounts"] = None, log_group_class: Optional["aws_sdk_cloudwatch_logs.types.log_group_class.LogGroupClass"] = None, log_group_identifiers: Optional["aws_sdk_cloudwatch_logs.types.describe_log_groups_log_group_identifiers.DescribeLogGroupsLogGroupIdentifiers"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_log_groups_response.DescribeLogGroupsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_log_groups_request.DescribeLogGroupsRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_log_groups_response.DescribeLogGroupsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_log_groups
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_log_groups.describe_log_groups(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_describe_log_groups(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, account_identifiers: Optional["aws_sdk_cloudwatch_logs.types.account_ids.AccountIds"] = None, log_group_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_name_pattern: Optional["aws_sdk_cloudwatch_logs.types.log_group_name_pattern.LogGroupNamePattern"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None, include_linked_accounts: Optional["aws_sdk_cloudwatch_logs.types.include_linked_accounts.IncludeLinkedAccounts"] = None, log_group_class: Optional["aws_sdk_cloudwatch_logs.types.log_group_class.LogGroupClass"] = None, log_group_identifiers: Optional["aws_sdk_cloudwatch_logs.types.describe_log_groups_log_group_identifiers.DescribeLogGroupsLogGroupIdentifiers"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.log_group.LogGroup]":
        _token = next_token
        while True:
    ...
    def describe_log_streams(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_identifier: Optional["aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier"] = None, log_stream_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName"] = None, order_by: Optional["aws_sdk_cloudwatch_logs.types.order_by.OrderBy"] = None, descending: Optional["aws_sdk_cloudwatch_logs.types.descending.Descending"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_log_streams_response.DescribeLogStreamsResponse":
        ...
        Args:
            ...
            limit: <p>The maximum number of items returned. If you don't specify a value, the default is up to 50 items.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_log_streams_request.DescribeLogStreamsRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_log_streams_response.DescribeLogStreamsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_log_streams
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_log_streams.describe_log_streams(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_describe_log_streams(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_identifier: Optional["aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier"] = None, log_stream_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName"] = None, order_by: Optional["aws_sdk_cloudwatch_logs.types.order_by.OrderBy"] = None, descending: Optional["aws_sdk_cloudwatch_logs.types.descending.Descending"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.log_stream.LogStream]":
        _token = next_token
        while True:
    ...
    def describe_lookup_tables(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, lookup_table_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.lookup_table_name.LookupTableName"] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.describe_lookup_tables_max_results.DescribeLookupTablesMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_lookup_tables_response.DescribeLookupTablesResponse":
        ...
        Args:
            ...
            next_token: <p>The token for the next set of items to return. (You received this token from a previous call.)</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_lookup_tables_request.DescribeLookupTablesRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_lookup_tables_response.DescribeLookupTablesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_lookup_tables
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_lookup_tables.describe_lookup_tables(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_metric_filters(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, filter_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.filter_name.FilterName"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None, metric_name: Optional["aws_sdk_cloudwatch_logs.types.metric_name.MetricName"] = None, metric_namespace: Optional["aws_sdk_cloudwatch_logs.types.metric_namespace.MetricNamespace"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_metric_filters_response.DescribeMetricFiltersResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_metric_filters_request.DescribeMetricFiltersRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_metric_filters_response.DescribeMetricFiltersResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_metric_filters
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_metric_filters.describe_metric_filters(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_describe_metric_filters(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, filter_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.filter_name.FilterName"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None, metric_name: Optional["aws_sdk_cloudwatch_logs.types.metric_name.MetricName"] = None, metric_namespace: Optional["aws_sdk_cloudwatch_logs.types.metric_namespace.MetricNamespace"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.metric_filter.MetricFilter]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def describe_queries(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, status: Optional["aws_sdk_cloudwatch_logs.types.query_status.QueryStatus"] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.describe_queries_max_results.DescribeQueriesMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, query_language: Optional["aws_sdk_cloudwatch_logs.types.query_language.QueryLanguage"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_queries_response.DescribeQueriesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_queries_request.DescribeQueriesRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_queries_response.DescribeQueriesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_queries
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_queries.describe_queries(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_query_definitions(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, query_language: Optional["aws_sdk_cloudwatch_logs.types.query_language.QueryLanguage"] = None, query_definition_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.query_definition_name.QueryDefinitionName"] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.query_list_max_results.QueryListMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_query_definitions_response.DescribeQueryDefinitionsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_query_definitions_request.DescribeQueryDefinitionsRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_query_definitions_response.DescribeQueryDefinitionsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_query_definitions
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_query_definitions.describe_query_definitions(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_resource_policies(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None, resource_arn: Optional["aws_sdk_cloudwatch_logs.types.arn.Arn"] = None, policy_scope: Optional["aws_sdk_cloudwatch_logs.types.policy_scope.PolicyScope"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_resource_policies_response.DescribeResourcePoliciesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_resource_policies_request.DescribeResourcePoliciesRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_resource_policies_response.DescribeResourcePoliciesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_resource_policies
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_resource_policies.describe_resource_policies(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def describe_subscription_filters(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, filter_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.filter_name.FilterName"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.describe_subscription_filters_response.DescribeSubscriptionFiltersResponse":
        ...
        Args:
            ...
            limit: <p>The maximum number of items returned. If you don't specify a value, the default is up to 50 items.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.describe_subscription_filters_request.DescribeSubscriptionFiltersRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.describe_subscription_filters_response.DescribeSubscriptionFiltersResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_subscription_filters
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.describe_subscription_filters.describe_subscription_filters(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_describe_subscription_filters(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, filter_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.filter_name.FilterName"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.describe_limit.DescribeLimit"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.subscription_filter.SubscriptionFilter]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def disassociate_kms_key(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, resource_identifier: Optional["aws_sdk_cloudwatch_logs.types.resource_identifier.ResourceIdentifier"] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.disassociate_kms_key_request.DisassociateKmsKeyRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.disassociate_kms_key
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.disassociate_kms_key.disassociate_kms_key(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def disassociate_source_from_s3_table_integration(self, identifier: "aws_sdk_cloudwatch_logs.types.s3_table_integration_source_identifier.S3TableIntegrationSourceIdentifier", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_response.DisassociateSourceFromS3TableIntegrationResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_request.DisassociateSourceFromS3TableIntegrationRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_response.DisassociateSourceFromS3TableIntegrationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.disassociate_source_from_s3_table_integration
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.disassociate_source_from_s3_table_integration.disassociate_source_from_s3_table_integration(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def filter_log_events(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_identifier: Optional["aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier"] = None, log_stream_names: Optional["aws_sdk_cloudwatch_logs.types.input_log_stream_names.InputLogStreamNames"] = None, log_stream_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName"] = None, start_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, end_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, filter_pattern: Optional["aws_sdk_cloudwatch_logs.types.filter_pattern.FilterPattern"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.events_limit.EventsLimit"] = None, interleaved: Optional["aws_sdk_cloudwatch_logs.types.interleaved.Interleaved"] = None, unmask: Optional["aws_sdk_cloudwatch_logs.types.unmask.Unmask"] = None) -> "aws_sdk_cloudwatch_logs.types.filter_log_events_response.FilterLogEventsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.filter_log_events_request.FilterLogEventsRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.filter_log_events_response.FilterLogEventsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.filter_log_events
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.filter_log_events.filter_log_events(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_data_protection_policy(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_data_protection_policy_response.GetDataProtectionPolicyResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_data_protection_policy_request.GetDataProtectionPolicyRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_data_protection_policy_response.GetDataProtectionPolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_data_protection_policy
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_data_protection_policy.get_data_protection_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_delivery(self, id: "aws_sdk_cloudwatch_logs.types.delivery_id.DeliveryId", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_delivery_response.GetDeliveryResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_delivery_request.GetDeliveryRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_delivery_response.GetDeliveryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery.get_delivery(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_delivery_destination(self, name: "aws_sdk_cloudwatch_logs.types.delivery_destination_name.DeliveryDestinationName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_delivery_destination_response.GetDeliveryDestinationResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_delivery_destination_request.GetDeliveryDestinationRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_delivery_destination_response.GetDeliveryDestinationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery_destination
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery_destination.get_delivery_destination(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_delivery_destination_policy(self, delivery_destination_name: "aws_sdk_cloudwatch_logs.types.delivery_destination_name.DeliveryDestinationName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_delivery_destination_policy_response.GetDeliveryDestinationPolicyResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_delivery_destination_policy_request.GetDeliveryDestinationPolicyRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_delivery_destination_policy_response.GetDeliveryDestinationPolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery_destination_policy
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery_destination_policy.get_delivery_destination_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_delivery_source(self, name: "aws_sdk_cloudwatch_logs.types.delivery_source_name.DeliverySourceName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_delivery_source_response.GetDeliverySourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_delivery_source_request.GetDeliverySourceRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_delivery_source_response.GetDeliverySourceResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery_source
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_delivery_source.get_delivery_source(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_integration(self, integration_name: "aws_sdk_cloudwatch_logs.types.integration_name.IntegrationName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_integration_response.GetIntegrationResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_integration_request.GetIntegrationRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_integration_response.GetIntegrationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_integration
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_integration.get_integration(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_log_anomaly_detector(self, anomaly_detector_arn: "aws_sdk_cloudwatch_logs.types.anomaly_detector_arn.AnomalyDetectorArn", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_log_anomaly_detector_response.GetLogAnomalyDetectorResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_log_anomaly_detector_request.GetLogAnomalyDetectorRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_log_anomaly_detector_response.GetLogAnomalyDetectorResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_anomaly_detector
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_anomaly_detector.get_log_anomaly_detector(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def get_log_events(self, log_stream_name: "aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_identifier: Optional["aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier"] = None, start_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, end_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.events_limit.EventsLimit"] = None, start_from_head: Optional["aws_sdk_cloudwatch_logs.types.start_from_head.StartFromHead"] = None, unmask: Optional["aws_sdk_cloudwatch_logs.types.unmask.Unmask"] = None) -> "aws_sdk_cloudwatch_logs.types.get_log_events_response.GetLogEventsResponse":
        ...
        Args:
            ...
            unmask: <p>Specify <code>true</code> to display the log event fields with all sensitive data unmasked and visible. The default is <code>false</code>.</p> <p>To use this operation with this parameter, you must be signed into an account with the <code>logs:Unmask</code> permission.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_log_events_request.GetLogEventsRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_log_events_response.GetLogEventsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_events
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_events.get_log_events(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_get_log_events(self, log_stream_name: "aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_identifier: Optional["aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier"] = None, start_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, end_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.events_limit.EventsLimit"] = None, start_from_head: Optional["aws_sdk_cloudwatch_logs.types.start_from_head.StartFromHead"] = None, unmask: Optional["aws_sdk_cloudwatch_logs.types.unmask.Unmask"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.output_log_event.OutputLogEvent]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def get_log_fields(self, data_source_name: "aws_sdk_cloudwatch_logs.types.data_source_name.DataSourceName", data_source_type: "aws_sdk_cloudwatch_logs.types.data_source_type.DataSourceType", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_log_fields_response.GetLogFieldsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_log_fields_request.GetLogFieldsRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_log_fields_response.GetLogFieldsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_fields
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_fields.get_log_fields(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_log_group_fields(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, log_group_identifier: Optional["aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier"] = None) -> "aws_sdk_cloudwatch_logs.types.get_log_group_fields_response.GetLogGroupFieldsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_log_group_fields_request.GetLogGroupFieldsRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_log_group_fields_response.GetLogGroupFieldsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_group_fields
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_group_fields.get_log_group_fields(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_log_object(self, log_object_pointer: "aws_sdk_cloudwatch_logs.types.log_object_pointer.LogObjectPointer", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, unmask: Optional["aws_sdk_cloudwatch_logs.types.unmask.Unmask"] = None) -> "aws_sdk_cloudwatch_logs.types.get_log_object_response.GetLogObjectResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_log_object_request.GetLogObjectRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_log_object_response.GetLogObjectResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_object
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_object.get_log_object(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_log_record(self, log_record_pointer: "aws_sdk_cloudwatch_logs.types.log_record_pointer.LogRecordPointer", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, unmask: Optional["aws_sdk_cloudwatch_logs.types.unmask.Unmask"] = None) -> "aws_sdk_cloudwatch_logs.types.get_log_record_response.GetLogRecordResponse":
        ...
        Args:
            ...
            unmask: <p>Specify <code>true</code> to display the log event fields with all sensitive data unmasked and visible. The default is <code>false</code>.</p> <p>To use this operation with this parameter, you must be signed into an account with the <code>logs:Unmask</code> permission.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_log_record_request.GetLogRecordRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_log_record_response.GetLogRecordResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_record
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_log_record.get_log_record(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_lookup_table(self, lookup_table_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_lookup_table_response.GetLookupTableResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_lookup_table_request.GetLookupTableRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_lookup_table_response.GetLookupTableResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_lookup_table
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_lookup_table.get_lookup_table(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def get_query_results(self, query_id: "aws_sdk_cloudwatch_logs.types.query_id.QueryId", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.get_query_results_next_token.GetQueryResultsNextToken"] = None, max_items: Optional["aws_sdk_cloudwatch_logs.types.get_query_results_max_items.GetQueryResultsMaxItems"] = None) -> "aws_sdk_cloudwatch_logs.types.get_query_results_response.GetQueryResultsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_query_results_request.GetQueryResultsRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_query_results_response.GetQueryResultsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_query_results
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_query_results.get_query_results(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_scheduled_query(self, identifier: "aws_sdk_cloudwatch_logs.types.scheduled_query_identifier.ScheduledQueryIdentifier", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_scheduled_query_response.GetScheduledQueryResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_scheduled_query_request.GetScheduledQueryRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_scheduled_query_response.GetScheduledQueryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_scheduled_query
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_scheduled_query.get_scheduled_query(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_scheduled_query_history(self, identifier: "aws_sdk_cloudwatch_logs.types.scheduled_query_identifier.ScheduledQueryIdentifier", start_time: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", end_time: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, execution_statuses: Optional["aws_sdk_cloudwatch_logs.types.execution_status_list.ExecutionStatusList"] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.get_scheduled_query_history_max_results.GetScheduledQueryHistoryMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.get_scheduled_query_history_response.GetScheduledQueryHistoryResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_scheduled_query_history_request.GetScheduledQueryHistoryRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_scheduled_query_history_response.GetScheduledQueryHistoryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_scheduled_query_history
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_scheduled_query_history.get_scheduled_query_history(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_get_scheduled_query_history(self, identifier: "aws_sdk_cloudwatch_logs.types.scheduled_query_identifier.ScheduledQueryIdentifier", start_time: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", end_time: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, execution_statuses: Optional["aws_sdk_cloudwatch_logs.types.execution_status_list.ExecutionStatusList"] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.get_scheduled_query_history_max_results.GetScheduledQueryHistoryMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.trigger_history_record.TriggerHistoryRecord]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def get_transformer(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.get_transformer_response.GetTransformerResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.get_transformer_request.GetTransformerRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.get_transformer_response.GetTransformerResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.get_transformer
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.get_transformer.get_transformer(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def list_aggregate_log_group_summaries(self, group_by: "aws_sdk_cloudwatch_logs.types.list_aggregate_log_group_summaries_group_by.ListAggregateLogGroupSummariesGroupBy", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, account_identifiers: Optional["aws_sdk_cloudwatch_logs.types.account_ids.AccountIds"] = None, include_linked_accounts: Optional["aws_sdk_cloudwatch_logs.types.include_linked_accounts.IncludeLinkedAccounts"] = None, log_group_class: Optional["aws_sdk_cloudwatch_logs.types.log_group_class.LogGroupClass"] = None, log_group_name_pattern: Optional["aws_sdk_cloudwatch_logs.types.log_group_name_regex_pattern.LogGroupNameRegexPattern"] = None, data_sources: Optional["aws_sdk_cloudwatch_logs.types.data_source_filters.DataSourceFilters"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.list_log_groups_request_limit.ListLogGroupsRequestLimit"] = None) -> "aws_sdk_cloudwatch_logs.types.list_aggregate_log_group_summaries_response.ListAggregateLogGroupSummariesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.list_aggregate_log_group_summaries_request.ListAggregateLogGroupSummariesRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.list_aggregate_log_group_summaries_response.ListAggregateLogGroupSummariesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_aggregate_log_group_summaries
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.list_aggregate_log_group_summaries.list_aggregate_log_group_summaries(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_aggregate_log_group_summaries(self, group_by: "aws_sdk_cloudwatch_logs.types.list_aggregate_log_group_summaries_group_by.ListAggregateLogGroupSummariesGroupBy", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, account_identifiers: Optional["aws_sdk_cloudwatch_logs.types.account_ids.AccountIds"] = None, include_linked_accounts: Optional["aws_sdk_cloudwatch_logs.types.include_linked_accounts.IncludeLinkedAccounts"] = None, log_group_class: Optional["aws_sdk_cloudwatch_logs.types.log_group_class.LogGroupClass"] = None, log_group_name_pattern: Optional["aws_sdk_cloudwatch_logs.types.log_group_name_regex_pattern.LogGroupNameRegexPattern"] = None, data_sources: Optional["aws_sdk_cloudwatch_logs.types.data_source_filters.DataSourceFilters"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.list_log_groups_request_limit.ListLogGroupsRequestLimit"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.aggregate_log_group_summary.AggregateLogGroupSummary]":
        _token = next_token
        while True:
    ...
    def list_anomalies(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, anomaly_detector_arn: Optional["aws_sdk_cloudwatch_logs.types.anomaly_detector_arn.AnomalyDetectorArn"] = None, suppression_state: Optional["aws_sdk_cloudwatch_logs.types.suppression_state.SuppressionState"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.list_anomalies_limit.ListAnomaliesLimit"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.list_anomalies_response.ListAnomaliesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.list_anomalies_request.ListAnomaliesRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.list_anomalies_response.ListAnomaliesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_anomalies
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.list_anomalies.list_anomalies(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_anomalies(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, anomaly_detector_arn: Optional["aws_sdk_cloudwatch_logs.types.anomaly_detector_arn.AnomalyDetectorArn"] = None, suppression_state: Optional["aws_sdk_cloudwatch_logs.types.suppression_state.SuppressionState"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.list_anomalies_limit.ListAnomaliesLimit"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.anomaly.Anomaly]":
        _token = next_token
        while True:
    ...
    def list_integrations(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, integration_name_prefix: Optional["aws_sdk_cloudwatch_logs.types.integration_name_prefix.IntegrationNamePrefix"] = None, integration_type: Optional["aws_sdk_cloudwatch_logs.types.integration_type.IntegrationType"] = None, integration_status: Optional["aws_sdk_cloudwatch_logs.types.integration_status.IntegrationStatus"] = None) -> "aws_sdk_cloudwatch_logs.types.list_integrations_response.ListIntegrationsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.list_integrations_request.ListIntegrationsRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.list_integrations_response.ListIntegrationsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_integrations
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.list_integrations.list_integrations(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def list_log_anomaly_detectors(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, filter_log_group_arn: Optional["aws_sdk_cloudwatch_logs.types.log_group_arn.LogGroupArn"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.list_log_anomaly_detectors_limit.ListLogAnomalyDetectorsLimit"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.list_log_anomaly_detectors_response.ListLogAnomalyDetectorsResponse":
        ...
        Args:
            ...
            limit: <p>The maximum number of items to return. If you don't specify a value, the default maximum value of 50 items is used.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.list_log_anomaly_detectors_request.ListLogAnomalyDetectorsRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.list_log_anomaly_detectors_response.ListLogAnomalyDetectorsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_log_anomaly_detectors
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.list_log_anomaly_detectors.list_log_anomaly_detectors(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_log_anomaly_detectors(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, filter_log_group_arn: Optional["aws_sdk_cloudwatch_logs.types.log_group_arn.LogGroupArn"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.list_log_anomaly_detectors_limit.ListLogAnomalyDetectorsLimit"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.anomaly_detector.AnomalyDetector]":
        _token = next_token
        while True:
    ...
    def list_log_groups(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, log_group_name_pattern: Optional["aws_sdk_cloudwatch_logs.types.log_group_name_regex_pattern.LogGroupNameRegexPattern"] = None, log_group_class: Optional["aws_sdk_cloudwatch_logs.types.log_group_class.LogGroupClass"] = None, include_linked_accounts: Optional["aws_sdk_cloudwatch_logs.types.include_linked_accounts.IncludeLinkedAccounts"] = None, account_identifiers: Optional["aws_sdk_cloudwatch_logs.types.account_ids.AccountIds"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.list_limit.ListLimit"] = None, data_sources: Optional["aws_sdk_cloudwatch_logs.types.data_source_filters.DataSourceFilters"] = None, field_index_names: Optional["aws_sdk_cloudwatch_logs.types.field_index_names.FieldIndexNames"] = None, log_group_tags: Optional["aws_sdk_cloudwatch_logs.types.tag_filters.TagFilters"] = None) -> "aws_sdk_cloudwatch_logs.types.list_log_groups_response.ListLogGroupsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.list_log_groups_request.ListLogGroupsRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.list_log_groups_response.ListLogGroupsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_log_groups
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.list_log_groups.list_log_groups(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def list_log_groups_for_query(self, query_id: "aws_sdk_cloudwatch_logs.types.query_id.QueryId", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.list_log_groups_for_query_max_results.ListLogGroupsForQueryMaxResults"] = None) -> "aws_sdk_cloudwatch_logs.types.list_log_groups_for_query_response.ListLogGroupsForQueryResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.list_log_groups_for_query_request.ListLogGroupsForQueryRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.list_log_groups_for_query_response.ListLogGroupsForQueryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_log_groups_for_query
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.list_log_groups_for_query.list_log_groups_for_query(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_log_groups_for_query(self, query_id: "aws_sdk_cloudwatch_logs.types.query_id.QueryId", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.list_log_groups_for_query_max_results.ListLogGroupsForQueryMaxResults"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier]":
        ...
        while True:
            ...
            if not _token:
                break
    def list_scheduled_queries(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.list_scheduled_queries_max_results.ListScheduledQueriesMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, state: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_state.ScheduledQueryState"] = None) -> "aws_sdk_cloudwatch_logs.types.list_scheduled_queries_response.ListScheduledQueriesResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.list_scheduled_queries_request.ListScheduledQueriesRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.list_scheduled_queries_response.ListScheduledQueriesResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_scheduled_queries
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.list_scheduled_queries.list_scheduled_queries(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_scheduled_queries(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.list_scheduled_queries_max_results.ListScheduledQueriesMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None, state: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_state.ScheduledQueryState"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.scheduled_query_summary.ScheduledQuerySummary]":
        ...
        while True:
            ...
            if not _token:
                break
    def list_sources_for_s3_table_integration(self, integration_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.list_sources_for_s3_table_integration_max_results.ListSourcesForS3TableIntegrationMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "aws_sdk_cloudwatch_logs.types.list_sources_for_s3_table_integration_response.ListSourcesForS3TableIntegrationResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.list_sources_for_s3_table_integration_request.ListSourcesForS3TableIntegrationRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.list_sources_for_s3_table_integration_response.ListSourcesForS3TableIntegrationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_sources_for_s3_table_integration
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.list_sources_for_s3_table_integration.list_sources_for_s3_table_integration(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_sources_for_s3_table_integration(self, integration_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, max_results: Optional["aws_sdk_cloudwatch_logs.types.list_sources_for_s3_table_integration_max_results.ListSourcesForS3TableIntegrationMaxResults"] = None, next_token: Optional["aws_sdk_cloudwatch_logs.types.next_token.NextToken"] = None) -> "Iterator[aws_sdk_cloudwatch_logs.types.s3_table_integration_source.S3TableIntegrationSource]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def list_tags_for_resource(self, resource_arn: "aws_sdk_cloudwatch_logs.types.amazon_resource_name.AmazonResourceName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_tags_for_resource
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.list_tags_for_resource.list_tags_for_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def list_tags_log_group(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.list_tags_log_group_response.ListTagsLogGroupResponse":
        ...
        Args:
            log_group_name: <p>The name of the log group.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.list_tags_log_group_request.ListTagsLogGroupRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.list_tags_log_group_response.ListTagsLogGroupResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.list_tags_log_group
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.list_tags_log_group.list_tags_log_group(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def put_account_policy(self, policy_name: "aws_sdk_cloudwatch_logs.types.policy_name.PolicyName", policy_document: "aws_sdk_cloudwatch_logs.types.account_policy_document.AccountPolicyDocument", policy_type: "aws_sdk_cloudwatch_logs.types.policy_type.PolicyType", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, scope: Optional["aws_sdk_cloudwatch_logs.types.scope.Scope"] = None, selection_criteria: Optional["aws_sdk_cloudwatch_logs.types.selection_criteria.SelectionCriteria"] = None) -> "aws_sdk_cloudwatch_logs.types.put_account_policy_response.PutAccountPolicyResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_account_policy_request.PutAccountPolicyRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.put_account_policy_response.PutAccountPolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_account_policy
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_account_policy.put_account_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def put_bearer_token_authentication(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", bearer_token_authentication_enabled: "aws_sdk_cloudwatch_logs.types.bearer_token_authentication_enabled.BearerTokenAuthenticationEnabled", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_bearer_token_authentication_request.PutBearerTokenAuthenticationRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_bearer_token_authentication
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_bearer_token_authentication.put_bearer_token_authentication(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def put_data_protection_policy(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", policy_document: "aws_sdk_cloudwatch_logs.types.data_protection_policy_document.DataProtectionPolicyDocument", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.put_data_protection_policy_response.PutDataProtectionPolicyResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_data_protection_policy_request.PutDataProtectionPolicyRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.put_data_protection_policy_response.PutDataProtectionPolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_data_protection_policy
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_data_protection_policy.put_data_protection_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def put_delivery_destination(self, name: "aws_sdk_cloudwatch_logs.types.delivery_destination_name.DeliveryDestinationName", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, output_format: Optional["aws_sdk_cloudwatch_logs.types.output_format.OutputFormat"] = None, delivery_destination_configuration: Optional["aws_sdk_cloudwatch_logs.types.delivery_destination_configuration.DeliveryDestinationConfiguration"] = None, delivery_destination_type: Optional["aws_sdk_cloudwatch_logs.types.delivery_destination_type.DeliveryDestinationType"] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None) -> "aws_sdk_cloudwatch_logs.types.put_delivery_destination_response.PutDeliveryDestinationResponse":
        ...
        Args:
            ...
            tags: <p>An optional list of key-value pairs to associate with the resource.</p> <p>For more information about tagging, see <a href=\"https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html\">Tagging Amazon Web Services resources</a> </p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_delivery_destination_request.PutDeliveryDestinationRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.put_delivery_destination_response.PutDeliveryDestinationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_delivery_destination
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_delivery_destination.put_delivery_destination(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def put_delivery_destination_policy(self, delivery_destination_name: "aws_sdk_cloudwatch_logs.types.delivery_destination_name.DeliveryDestinationName", delivery_destination_policy: "aws_sdk_cloudwatch_logs.types.delivery_destination_policy.DeliveryDestinationPolicy", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.put_delivery_destination_policy_response.PutDeliveryDestinationPolicyResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_delivery_destination_policy_request.PutDeliveryDestinationPolicyRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.put_delivery_destination_policy_response.PutDeliveryDestinationPolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_delivery_destination_policy
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_delivery_destination_policy.put_delivery_destination_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def put_delivery_source(self, name: "aws_sdk_cloudwatch_logs.types.delivery_source_name.DeliverySourceName", resource_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", log_type: "aws_sdk_cloudwatch_logs.types.log_type.LogType", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None, delivery_source_configuration: Optional["aws_sdk_cloudwatch_logs.types.delivery_source_configuration.DeliverySourceConfiguration"] = None) -> "aws_sdk_cloudwatch_logs.types.put_delivery_source_response.PutDeliverySourceResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_delivery_source_request.PutDeliverySourceRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.put_delivery_source_response.PutDeliverySourceResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_delivery_source
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_delivery_source.put_delivery_source(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def put_destination(self, destination_name: "aws_sdk_cloudwatch_logs.types.destination_name.DestinationName", target_arn: "aws_sdk_cloudwatch_logs.types.target_arn.TargetArn", role_arn: "aws_sdk_cloudwatch_logs.types.role_arn.RoleArn", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, tags: Optional["aws_sdk_cloudwatch_logs.types.tags.Tags"] = None) -> "aws_sdk_cloudwatch_logs.types.put_destination_response.PutDestinationResponse":
        ...
        Args:
            ...
            tags: <p>An optional list of key-value pairs to associate with the resource.</p> <p>For more information about tagging, see <a href=\"https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html\">Tagging Amazon Web Services resources</a> </p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_destination_request.PutDestinationRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.put_destination_response.PutDestinationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_destination
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_destination.put_destination(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def put_destination_policy(self, destination_name: "aws_sdk_cloudwatch_logs.types.destination_name.DestinationName", access_policy: "aws_sdk_cloudwatch_logs.types.access_policy.AccessPolicy", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, force_update: Optional["aws_sdk_cloudwatch_logs.types.force_update.ForceUpdate"] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_destination_policy_request.PutDestinationPolicyRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_destination_policy
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_destination_policy.put_destination_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def put_index_policy(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", policy_document: "aws_sdk_cloudwatch_logs.types.policy_document.PolicyDocument", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.put_index_policy_response.PutIndexPolicyResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_index_policy_request.PutIndexPolicyRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.put_index_policy_response.PutIndexPolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_index_policy
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_index_policy.put_index_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def put_integration(self, integration_name: "aws_sdk_cloudwatch_logs.types.integration_name.IntegrationName", resource_config: "aws_sdk_cloudwatch_logs.types.resource_config.ResourceConfig", integration_type: "aws_sdk_cloudwatch_logs.types.integration_type.IntegrationType", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.put_integration_response.PutIntegrationResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_integration_request.PutIntegrationRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.put_integration_response.PutIntegrationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_integration
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_integration.put_integration(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def put_log_events(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", log_stream_name: "aws_sdk_cloudwatch_logs.types.log_stream_name.LogStreamName", log_events: "aws_sdk_cloudwatch_logs.types.input_log_events.InputLogEvents", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, sequence_token: Optional["aws_sdk_cloudwatch_logs.types.sequence_token.SequenceToken"] = None, entity: Optional["aws_sdk_cloudwatch_logs.types.entity.Entity"] = None) -> "aws_sdk_cloudwatch_logs.types.put_log_events_response.PutLogEventsResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_log_events_request.PutLogEventsRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.put_log_events_response.PutLogEventsResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_log_events
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_log_events.put_log_events(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def put_log_group_deletion_protection(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", deletion_protection_enabled: "aws_sdk_cloudwatch_logs.types.deletion_protection_enabled.DeletionProtectionEnabled", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_log_group_deletion_protection_request.PutLogGroupDeletionProtectionRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_log_group_deletion_protection
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_log_group_deletion_protection.put_log_group_deletion_protection(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def put_metric_filter(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", filter_name: "aws_sdk_cloudwatch_logs.types.filter_name.FilterName", filter_pattern: "aws_sdk_cloudwatch_logs.types.filter_pattern.FilterPattern", metric_transformations: "aws_sdk_cloudwatch_logs.types.metric_transformations.MetricTransformations", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, apply_on_transformed_logs: Optional["aws_sdk_cloudwatch_logs.types.apply_on_transformed_logs.ApplyOnTransformedLogs"] = None, field_selection_criteria: Optional["aws_sdk_cloudwatch_logs.types.field_selection_criteria.FieldSelectionCriteria"] = None, emit_system_field_dimensions: Optional["aws_sdk_cloudwatch_logs.types.emit_system_fields.EmitSystemFields"] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_metric_filter_request.PutMetricFilterRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_metric_filter
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_metric_filter.put_metric_filter(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def put_query_definition(self, name: "aws_sdk_cloudwatch_logs.types.query_definition_name.QueryDefinitionName", query_string: "aws_sdk_cloudwatch_logs.types.query_definition_string.QueryDefinitionString", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, query_language: Optional["aws_sdk_cloudwatch_logs.types.query_language.QueryLanguage"] = None, query_definition_id: Optional["aws_sdk_cloudwatch_logs.types.query_id.QueryId"] = None, log_group_names: Optional["aws_sdk_cloudwatch_logs.types.log_group_names.LogGroupNames"] = None, client_token: Optional["aws_sdk_cloudwatch_logs.types.client_token.ClientToken"] = None, parameters: Optional["aws_sdk_cloudwatch_logs.types.query_parameter_list.QueryParameterList"] = None) -> "aws_sdk_cloudwatch_logs.types.put_query_definition_response.PutQueryDefinitionResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_query_definition_request.PutQueryDefinitionRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.put_query_definition_response.PutQueryDefinitionResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_query_definition
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_query_definition.put_query_definition(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def put_resource_policy(self, *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, policy_name: Optional["aws_sdk_cloudwatch_logs.types.policy_name.PolicyName"] = None, policy_document: Optional["aws_sdk_cloudwatch_logs.types.policy_document.PolicyDocument"] = None, resource_arn: Optional["aws_sdk_cloudwatch_logs.types.arn.Arn"] = None, expected_revision_id: Optional["aws_sdk_cloudwatch_logs.types.expected_revision_id.ExpectedRevisionId"] = None) -> "aws_sdk_cloudwatch_logs.types.put_resource_policy_response.PutResourcePolicyResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_resource_policy_request.PutResourcePolicyRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.put_resource_policy_response.PutResourcePolicyResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_resource_policy
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_resource_policy.put_resource_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def put_retention_policy(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", retention_in_days: "aws_sdk_cloudwatch_logs.types.days.Days", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        Args:
            log_group_name: <p>The name of the log group.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_retention_policy_request.PutRetentionPolicyRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_retention_policy
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_retention_policy.put_retention_policy(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def put_subscription_filter(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", filter_name: "aws_sdk_cloudwatch_logs.types.filter_name.FilterName", filter_pattern: "aws_sdk_cloudwatch_logs.types.filter_pattern.FilterPattern", destination_arn: "aws_sdk_cloudwatch_logs.types.destination_arn.DestinationArn", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, role_arn: Optional["aws_sdk_cloudwatch_logs.types.role_arn.RoleArn"] = None, distribution: Optional["aws_sdk_cloudwatch_logs.types.distribution.Distribution"] = None, apply_on_transformed_logs: Optional["aws_sdk_cloudwatch_logs.types.apply_on_transformed_logs.ApplyOnTransformedLogs"] = None, field_selection_criteria: Optional["aws_sdk_cloudwatch_logs.types.field_selection_criteria.FieldSelectionCriteria"] = None, emit_system_fields: Optional["aws_sdk_cloudwatch_logs.types.emit_system_fields.EmitSystemFields"] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_subscription_filter_request.PutSubscriptionFilterRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_subscription_filter
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_subscription_filter.put_subscription_filter(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def put_transformer(self, log_group_identifier: "aws_sdk_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier", transformer_config: "aws_sdk_cloudwatch_logs.types.processors.Processors", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.put_transformer_request.PutTransformerRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.put_transformer
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.put_transformer.put_transformer(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def start_live_tail(self, log_group_identifiers: "aws_sdk_cloudwatch_logs.types.start_live_tail_log_group_identifiers.StartLiveTailLogGroupIdentifiers", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, log_stream_names: Optional["aws_sdk_cloudwatch_logs.types.input_log_stream_names.InputLogStreamNames"] = None, log_stream_name_prefixes: Optional["aws_sdk_cloudwatch_logs.types.input_log_stream_names.InputLogStreamNames"] = None, log_event_filter_pattern: Optional["aws_sdk_cloudwatch_logs.types.filter_pattern.FilterPattern"] = None) -> "aws_sdk_cloudwatch_logs.types.start_live_tail_response.StartLiveTailResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.start_live_tail_request.StartLiveTailRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.start_live_tail_response.StartLiveTailResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.start_live_tail
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.start_live_tail.start_live_tail(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def start_query(self, start_time: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", end_time: "aws_sdk_cloudwatch_logs.types.timestamp.Timestamp", query_string: "aws_sdk_cloudwatch_logs.types.query_string.QueryString", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, query_language: Optional["aws_sdk_cloudwatch_logs.types.query_language.QueryLanguage"] = None, log_group_name: Optional["aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName"] = None, log_group_names: Optional["aws_sdk_cloudwatch_logs.types.log_group_names.LogGroupNames"] = None, log_group_identifiers: Optional["aws_sdk_cloudwatch_logs.types.log_group_identifiers.LogGroupIdentifiers"] = None, limit: Optional["aws_sdk_cloudwatch_logs.types.events_limit_start_query.EventsLimitStartQuery"] = None) -> "aws_sdk_cloudwatch_logs.types.start_query_response.StartQueryResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.start_query_request.StartQueryRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.start_query_response.StartQueryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.start_query
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.start_query.start_query(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def stop_query(self, query_id: "aws_sdk_cloudwatch_logs.types.query_id.QueryId", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.stop_query_response.StopQueryResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.stop_query_request.StopQueryRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.stop_query_response.StopQueryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.stop_query
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.stop_query.stop_query(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def tag_log_group(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", tags: "aws_sdk_cloudwatch_logs.types.tags.Tags", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.tag_log_group_request.TagLogGroupRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.tag_log_group
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.tag_log_group.tag_log_group(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def tag_resource(self, resource_arn: "aws_sdk_cloudwatch_logs.types.amazon_resource_name.AmazonResourceName", tags: "aws_sdk_cloudwatch_logs.types.tags.Tags", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.tag_resource_request.TagResourceRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.tag_resource
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.tag_resource.tag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def test_metric_filter(self, filter_pattern: "aws_sdk_cloudwatch_logs.types.filter_pattern.FilterPattern", log_event_messages: "aws_sdk_cloudwatch_logs.types.test_event_messages.TestEventMessages", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.test_metric_filter_response.TestMetricFilterResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.test_metric_filter_request.TestMetricFilterRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.test_metric_filter_response.TestMetricFilterResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.test_metric_filter
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.test_metric_filter.test_metric_filter(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def test_transformer(self, transformer_config: "aws_sdk_cloudwatch_logs.types.processors.Processors", log_event_messages: "aws_sdk_cloudwatch_logs.types.test_event_messages.TestEventMessages", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> "aws_sdk_cloudwatch_logs.types.test_transformer_response.TestTransformerResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.test_transformer_request.TestTransformerRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.test_transformer_response.TestTransformerResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.test_transformer
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.test_transformer.test_transformer(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def untag_log_group(self, log_group_name: "aws_sdk_cloudwatch_logs.types.log_group_name.LogGroupName", tags: "aws_sdk_cloudwatch_logs.types.tag_list.TagList", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.untag_log_group_request.UntagLogGroupRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.untag_log_group
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.untag_log_group.untag_log_group(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def untag_resource(self, resource_arn: "aws_sdk_cloudwatch_logs.types.amazon_resource_name.AmazonResourceName", tag_keys: "aws_sdk_cloudwatch_logs.types.tag_key_list.TagKeyList", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.untag_resource_request.UntagResourceRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.untag_resource
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.untag_resource.untag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def update_anomaly(self, anomaly_detector_arn: "aws_sdk_cloudwatch_logs.types.anomaly_detector_arn.AnomalyDetectorArn", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, anomaly_id: Optional["aws_sdk_cloudwatch_logs.types.anomaly_id.AnomalyId"] = None, pattern_id: Optional["aws_sdk_cloudwatch_logs.types.pattern_id.PatternId"] = None, suppression_type: Optional["aws_sdk_cloudwatch_logs.types.suppression_type.SuppressionType"] = None, suppression_period: Optional["aws_sdk_cloudwatch_logs.types.suppression_period.SuppressionPeriod"] = None, baseline: Optional["aws_sdk_cloudwatch_logs.types.baseline.Baseline"] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.update_anomaly_request.UpdateAnomalyRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.update_anomaly
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.update_anomaly.update_anomaly(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def update_delivery_configuration(self, id: "aws_sdk_cloudwatch_logs.types.delivery_id.DeliveryId", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, record_fields: Optional["aws_sdk_cloudwatch_logs.types.record_fields.RecordFields"] = None, field_delimiter: Optional["aws_sdk_cloudwatch_logs.types.field_delimiter.FieldDelimiter"] = None, s3_delivery_configuration: Optional["aws_sdk_cloudwatch_logs.types.s3_delivery_configuration.S3DeliveryConfiguration"] = None) -> "aws_sdk_cloudwatch_logs.types.update_delivery_configuration_response.UpdateDeliveryConfigurationResponse":
        ...
        Args:
            ...
            s3_delivery_configuration: <p>This structure contains parameters that are valid only when the delivery's delivery destination is an S3 bucket.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.update_delivery_configuration_request.UpdateDeliveryConfigurationRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.update_delivery_configuration_response.UpdateDeliveryConfigurationResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.update_delivery_configuration
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.update_delivery_configuration.update_delivery_configuration(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def update_log_anomaly_detector(self, anomaly_detector_arn: "aws_sdk_cloudwatch_logs.types.anomaly_detector_arn.AnomalyDetectorArn", enabled: "aws_sdk_cloudwatch_logs.types.boolean.Boolean", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, evaluation_frequency: Optional["aws_sdk_cloudwatch_logs.types.evaluation_frequency.EvaluationFrequency"] = None, filter_pattern: Optional["aws_sdk_cloudwatch_logs.types.filter_pattern.FilterPattern"] = None, anomaly_visibility_time: Optional["aws_sdk_cloudwatch_logs.types.anomaly_visibility_time.AnomalyVisibilityTime"] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.update_log_anomaly_detector_request.UpdateLogAnomalyDetectorRequest]') -> OperationResponse[None]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.update_log_anomaly_detector
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.update_log_anomaly_detector.update_log_anomaly_detector(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def update_lookup_table(self, lookup_table_arn: "aws_sdk_cloudwatch_logs.types.arn.Arn", table_body: "aws_sdk_cloudwatch_logs.types.table_body.TableBody", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, description: Optional["aws_sdk_cloudwatch_logs.types.lookup_table_description.LookupTableDescription"] = None, kms_key_id: Optional["aws_sdk_cloudwatch_logs.types.kms_key_id.KmsKeyId"] = None) -> "aws_sdk_cloudwatch_logs.types.update_lookup_table_response.UpdateLookupTableResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.update_lookup_table_request.UpdateLookupTableRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.update_lookup_table_response.UpdateLookupTableResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.update_lookup_table
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.update_lookup_table.update_lookup_table(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
    ...
    def update_scheduled_query(self, identifier: "aws_sdk_cloudwatch_logs.types.scheduled_query_identifier.ScheduledQueryIdentifier", query_language: "aws_sdk_cloudwatch_logs.types.query_language.QueryLanguage", query_string: "aws_sdk_cloudwatch_logs.types.query_string.QueryString", schedule_expression: "aws_sdk_cloudwatch_logs.types.schedule_expression.ScheduleExpression", execution_role_arn: "aws_sdk_cloudwatch_logs.types.role_arn.RoleArn", *, config_overrides: Optional[CloudWatchLogsClientConfig] = None, description: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_description.ScheduledQueryDescription"] = None, log_group_identifiers: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_log_group_identifiers.ScheduledQueryLogGroupIdentifiers"] = None, timezone: Optional["aws_sdk_cloudwatch_logs.types.schedule_timezone.ScheduleTimezone"] = None, start_time_offset: Optional["aws_sdk_cloudwatch_logs.types.start_time_offset.StartTimeOffset"] = None, destination_configuration: Optional["aws_sdk_cloudwatch_logs.types.destination_configuration.DestinationConfiguration"] = None, schedule_start_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, schedule_end_time: Optional["aws_sdk_cloudwatch_logs.types.timestamp.Timestamp"] = None, state: Optional["aws_sdk_cloudwatch_logs.types.scheduled_query_state.ScheduledQueryState"] = None) -> "aws_sdk_cloudwatch_logs.types.update_scheduled_query_response.UpdateScheduledQueryResponse":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_cloudwatch_logs.types.update_scheduled_query_request.UpdateScheduledQueryRequest]') -> OperationResponse["aws_sdk_cloudwatch_logs.types.update_scheduled_query_response.UpdateScheduledQueryResponse"]:
            import aws_sdk_cloudwatch_logs._operations.logs_20140328.update_scheduled_query
            output, http_response = aws_sdk_cloudwatch_logs._operations.logs_20140328.update_scheduled_query.update_scheduled_query(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
