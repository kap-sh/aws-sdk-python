"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#ServiceUnavailableException``."""
...
class ServiceUnavailableException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudwatchlogs#ServiceUnavailableException``."""
