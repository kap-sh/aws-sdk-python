...
class InvalidSequenceTokenException_(TypedDict):
...
class InvalidSequenceTokenException(ServiceError):
    ...
    def __init__(self, data: InvalidSequenceTokenException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "InvalidSequenceTokenException":
