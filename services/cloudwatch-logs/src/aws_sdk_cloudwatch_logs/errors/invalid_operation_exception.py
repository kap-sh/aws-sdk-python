"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#InvalidOperationException``."""
...
class InvalidOperationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudwatchlogs#InvalidOperationException``."""
