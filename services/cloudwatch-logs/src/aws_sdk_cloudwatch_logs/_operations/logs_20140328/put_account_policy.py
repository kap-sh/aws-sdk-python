...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.put_account_policy_response.PutAccountPolicyResponse = aws_sdk_cloudwatch_logs.types.put_account_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.put_account_policy_request.PutAccountPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.put_account_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
