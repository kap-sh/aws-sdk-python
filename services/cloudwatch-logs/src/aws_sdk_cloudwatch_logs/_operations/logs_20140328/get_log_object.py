...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.get_log_object_response.GetLogObjectResponse = (
        aws_sdk_cloudwatch_logs.types.get_log_object_response.deserialize_aws_json_1_1(
