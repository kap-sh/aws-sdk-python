"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DeleteTransformer``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.delete_transformer_request.DeleteTransformerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DeleteTransformer"
    import aws_sdk_cloudwatch_logs.types.delete_transformer_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.delete_transformer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_transformer(
