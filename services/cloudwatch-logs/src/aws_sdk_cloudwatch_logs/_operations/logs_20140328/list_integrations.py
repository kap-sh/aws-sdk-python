...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.list_integrations_response.ListIntegrationsResponse = aws_sdk_cloudwatch_logs.types.list_integrations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.list_integrations_request.ListIntegrationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.list_integrations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
