"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutRetentionPolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.put_retention_policy_request.PutRetentionPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.put_retention_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
