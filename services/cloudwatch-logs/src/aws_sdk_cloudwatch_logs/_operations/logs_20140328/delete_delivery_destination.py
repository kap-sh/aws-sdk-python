"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DeleteDeliveryDestination``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.delete_delivery_destination_request.DeleteDeliveryDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DeleteDeliveryDestination"
    import aws_sdk_cloudwatch_logs.types.delete_delivery_destination_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.delete_delivery_destination_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_delivery_destination(
