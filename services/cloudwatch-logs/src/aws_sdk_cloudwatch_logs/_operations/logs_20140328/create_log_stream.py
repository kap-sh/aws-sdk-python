"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#CreateLogStream``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceAlreadyExistsException":
            import aws_sdk_cloudwatch_logs.errors.resource_already_exists_exception

            raise aws_sdk_cloudwatch_logs.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.create_log_stream_request.CreateLogStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.create_log_stream_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_log_stream(
