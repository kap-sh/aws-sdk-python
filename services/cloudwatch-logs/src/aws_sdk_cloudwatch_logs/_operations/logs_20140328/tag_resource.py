"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#TagResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            import aws_sdk_cloudwatch_logs.errors.too_many_tags_exception

            raise aws_sdk_cloudwatch_logs.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data
            )
        case _:
...
def build_request(
    ...
    input: aws_sdk_cloudwatch_logs.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "Logs_20140328.TagResource"
    import aws_sdk_cloudwatch_logs.types.tag_resource_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.tag_resource_request.serialize_aws_json_1_1(input)
    ).encode()
