...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.list_log_anomaly_detectors_response.ListLogAnomalyDetectorsResponse = aws_sdk_cloudwatch_logs.types.list_log_anomaly_detectors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.list_log_anomaly_detectors_request.ListLogAnomalyDetectorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.list_log_anomaly_detectors_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
