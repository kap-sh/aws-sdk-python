"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeQueryDefinitions``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.describe_query_definitions_response.DescribeQueryDefinitionsResponse = aws_sdk_cloudwatch_logs.types.describe_query_definitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.describe_query_definitions_request.DescribeQueryDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DescribeQueryDefinitions"
    import aws_sdk_cloudwatch_logs.types.describe_query_definitions_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.describe_query_definitions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_query_definitions(
