"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DeleteSubscriptionFilter``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.delete_subscription_filter_request.DeleteSubscriptionFilterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.delete_subscription_filter_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_subscription_filter(
