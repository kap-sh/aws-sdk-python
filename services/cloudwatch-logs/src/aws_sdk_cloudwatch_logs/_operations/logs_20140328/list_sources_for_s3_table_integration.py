"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#ListSourcesForS3TableIntegration``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.list_sources_for_s3_table_integration_response.ListSourcesForS3TableIntegrationResponse = aws_sdk_cloudwatch_logs.types.list_sources_for_s3_table_integration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.list_sources_for_s3_table_integration_request.ListSourcesForS3TableIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.ListSourcesForS3TableIntegration"
    import aws_sdk_cloudwatch_logs.types.list_sources_for_s3_table_integration_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.list_sources_for_s3_table_integration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_sources_for_s3_table_integration(
