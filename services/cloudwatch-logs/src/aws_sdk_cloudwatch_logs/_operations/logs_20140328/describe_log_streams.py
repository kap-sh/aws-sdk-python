"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeLogStreams``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.describe_log_streams_response.DescribeLogStreamsResponse = aws_sdk_cloudwatch_logs.types.describe_log_streams_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.describe_log_streams_request.DescribeLogStreamsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.describe_log_streams_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_log_streams(
