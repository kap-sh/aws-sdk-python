...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.create_log_anomaly_detector_response.CreateLogAnomalyDetectorResponse = aws_sdk_cloudwatch_logs.types.create_log_anomaly_detector_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.create_log_anomaly_detector_request.CreateLogAnomalyDetectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.create_log_anomaly_detector_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
