"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#GetIntegration``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.get_integration_response.GetIntegrationResponse = aws_sdk_cloudwatch_logs.types.get_integration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.get_integration_request.GetIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.GetIntegration"
    import aws_sdk_cloudwatch_logs.types.get_integration_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.get_integration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
