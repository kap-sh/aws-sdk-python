...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_response.DisassociateSourceFromS3TableIntegrationResponse = aws_sdk_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_request.DisassociateSourceFromS3TableIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
