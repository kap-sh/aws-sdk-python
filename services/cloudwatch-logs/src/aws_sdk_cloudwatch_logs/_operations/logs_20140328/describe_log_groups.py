"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeLogGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.describe_log_groups_response.DescribeLogGroupsResponse = aws_sdk_cloudwatch_logs.types.describe_log_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.describe_log_groups_request.DescribeLogGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.describe_log_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_log_groups(
