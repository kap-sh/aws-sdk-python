"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DeleteDestination``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.delete_destination_request.DeleteDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.delete_destination_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_destination(
