...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.get_delivery_response.GetDeliveryResponse = (
        aws_sdk_cloudwatch_logs.types.get_delivery_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_cloudwatch_logs.types.get_delivery_request.GetDeliveryRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.get_delivery_request.serialize_aws_json_1_1(input)
    ).encode()
