"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutDestinationPolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.put_destination_policy_request.PutDestinationPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.put_destination_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_destination_policy(
