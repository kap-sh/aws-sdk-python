...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.delete_index_policy_response.DeleteIndexPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.delete_index_policy_request.DeleteIndexPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.delete_index_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
