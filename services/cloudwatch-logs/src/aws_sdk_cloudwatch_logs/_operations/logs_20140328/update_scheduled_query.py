"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#UpdateScheduledQuery``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.update_scheduled_query_response.UpdateScheduledQueryResponse = aws_sdk_cloudwatch_logs.types.update_scheduled_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.update_scheduled_query_request.UpdateScheduledQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.UpdateScheduledQuery"
    import aws_sdk_cloudwatch_logs.types.update_scheduled_query_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.update_scheduled_query_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
