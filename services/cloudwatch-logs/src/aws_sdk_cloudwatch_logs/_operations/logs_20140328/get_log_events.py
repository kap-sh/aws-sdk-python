"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#GetLogEvents``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.get_log_events_response.GetLogEventsResponse = (
        aws_sdk_cloudwatch_logs.types.get_log_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.get_log_events_request.GetLogEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.get_log_events_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_log_events(
