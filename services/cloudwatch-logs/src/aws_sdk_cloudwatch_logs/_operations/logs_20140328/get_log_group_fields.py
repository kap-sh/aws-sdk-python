...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.get_log_group_fields_response.GetLogGroupFieldsResponse = aws_sdk_cloudwatch_logs.types.get_log_group_fields_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.get_log_group_fields_request.GetLogGroupFieldsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.get_log_group_fields_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
