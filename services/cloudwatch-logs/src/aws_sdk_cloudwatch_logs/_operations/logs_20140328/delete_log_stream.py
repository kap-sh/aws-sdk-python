...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.delete_log_stream_request.DeleteLogStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.delete_log_stream_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
