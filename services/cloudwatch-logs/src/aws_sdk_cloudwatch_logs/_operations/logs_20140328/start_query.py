...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MalformedQueryException":
            import aws_sdk_cloudwatch_logs.errors.malformed_query_exception

            raise aws_sdk_cloudwatch_logs.errors.malformed_query_exception.MalformedQueryException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.start_query_response.StartQueryResponse = (
        aws_sdk_cloudwatch_logs.types.start_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.start_query_request.StartQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.start_query_request.serialize_aws_json_1_1(input_)
    ).encode()
