...
def build_request(
    ...
    input: aws_sdk_cloudwatch_logs.types.start_query_request.StartQueryRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.start_query_request.serialize_aws_json_1_1(input)
    ).encode()
