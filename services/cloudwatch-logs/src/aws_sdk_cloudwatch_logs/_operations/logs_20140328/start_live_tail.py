...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.start_live_tail_response.StartLiveTailResponse = aws_sdk_cloudwatch_logs.types.start_live_tail_response.deserialize_aws_json_1_1(
