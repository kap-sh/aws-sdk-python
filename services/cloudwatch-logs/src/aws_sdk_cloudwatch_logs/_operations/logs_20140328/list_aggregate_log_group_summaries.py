...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.list_aggregate_log_group_summaries_response.ListAggregateLogGroupSummariesResponse = aws_sdk_cloudwatch_logs.types.list_aggregate_log_group_summaries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.list_aggregate_log_group_summaries_request.ListAggregateLogGroupSummariesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.list_aggregate_log_group_summaries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
