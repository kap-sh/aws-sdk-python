"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DeleteRetentionPolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.delete_retention_policy_request.DeleteRetentionPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.delete_retention_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
