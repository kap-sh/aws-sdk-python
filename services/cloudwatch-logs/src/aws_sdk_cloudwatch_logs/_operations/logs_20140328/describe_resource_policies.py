"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeResourcePolicies``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.describe_resource_policies_response.DescribeResourcePoliciesResponse = aws_sdk_cloudwatch_logs.types.describe_resource_policies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.describe_resource_policies_request.DescribeResourcePoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.describe_resource_policies_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_resource_policies(
