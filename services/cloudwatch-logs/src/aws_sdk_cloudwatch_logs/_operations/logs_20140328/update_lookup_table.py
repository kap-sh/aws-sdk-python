"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#UpdateLookupTable``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.update_lookup_table_response.UpdateLookupTableResponse = aws_sdk_cloudwatch_logs.types.update_lookup_table_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.update_lookup_table_request.UpdateLookupTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.UpdateLookupTable"
    import aws_sdk_cloudwatch_logs.types.update_lookup_table_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.update_lookup_table_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_lookup_table(
