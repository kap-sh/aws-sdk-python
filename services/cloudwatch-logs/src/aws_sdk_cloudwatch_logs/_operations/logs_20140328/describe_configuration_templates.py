"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeConfigurationTemplates``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.describe_configuration_templates_response.DescribeConfigurationTemplatesResponse = aws_sdk_cloudwatch_logs.types.describe_configuration_templates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.describe_configuration_templates_request.DescribeConfigurationTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DescribeConfigurationTemplates"
    import aws_sdk_cloudwatch_logs.types.describe_configuration_templates_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.describe_configuration_templates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_configuration_templates(
