"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeDeliveryDestinations``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.describe_delivery_destinations_response.DescribeDeliveryDestinationsResponse = aws_sdk_cloudwatch_logs.types.describe_delivery_destinations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.describe_delivery_destinations_request.DescribeDeliveryDestinationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DescribeDeliveryDestinations"
    import aws_sdk_cloudwatch_logs.types.describe_delivery_destinations_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.describe_delivery_destinations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_delivery_destinations(
