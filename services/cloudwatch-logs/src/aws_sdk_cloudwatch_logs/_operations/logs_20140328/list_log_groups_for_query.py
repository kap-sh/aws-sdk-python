"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#ListLogGroupsForQuery``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.list_log_groups_for_query_response.ListLogGroupsForQueryResponse = aws_sdk_cloudwatch_logs.types.list_log_groups_for_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.list_log_groups_for_query_request.ListLogGroupsForQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.ListLogGroupsForQuery"
    import aws_sdk_cloudwatch_logs.types.list_log_groups_for_query_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.list_log_groups_for_query_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_log_groups_for_query(
