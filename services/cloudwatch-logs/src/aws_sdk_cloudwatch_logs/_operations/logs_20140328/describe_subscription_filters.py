...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.describe_subscription_filters_response.DescribeSubscriptionFiltersResponse = aws_sdk_cloudwatch_logs.types.describe_subscription_filters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.describe_subscription_filters_request.DescribeSubscriptionFiltersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.describe_subscription_filters_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
