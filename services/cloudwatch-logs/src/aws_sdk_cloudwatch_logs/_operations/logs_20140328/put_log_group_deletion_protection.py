"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutLogGroupDeletionProtection``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.put_log_group_deletion_protection_request.PutLogGroupDeletionProtectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.PutLogGroupDeletionProtection"
    import aws_sdk_cloudwatch_logs.types.put_log_group_deletion_protection_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.put_log_group_deletion_protection_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_log_group_deletion_protection(
