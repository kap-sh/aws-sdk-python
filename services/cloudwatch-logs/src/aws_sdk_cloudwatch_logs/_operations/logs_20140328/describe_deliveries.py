...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.describe_deliveries_response.DescribeDeliveriesResponse = aws_sdk_cloudwatch_logs.types.describe_deliveries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.describe_deliveries_request.DescribeDeliveriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.describe_deliveries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
