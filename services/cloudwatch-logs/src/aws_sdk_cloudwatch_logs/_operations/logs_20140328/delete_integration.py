...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.delete_integration_response.DeleteIntegrationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.delete_integration_request.DeleteIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
