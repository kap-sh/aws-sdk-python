"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#UpdateDeliveryConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.update_delivery_configuration_response.UpdateDeliveryConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.update_delivery_configuration_request.UpdateDeliveryConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.UpdateDeliveryConfiguration"
    import aws_sdk_cloudwatch_logs.types.update_delivery_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.update_delivery_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_delivery_configuration(
