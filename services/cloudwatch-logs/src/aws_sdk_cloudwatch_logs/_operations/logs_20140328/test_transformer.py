"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#TestTransformer``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.test_transformer_response.TestTransformerResponse = aws_sdk_cloudwatch_logs.types.test_transformer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.test_transformer_request.TestTransformerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.TestTransformer"
    import aws_sdk_cloudwatch_logs.types.test_transformer_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.test_transformer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_test_transformer(
