"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#UpdateLogAnomalyDetector``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.update_log_anomaly_detector_request.UpdateLogAnomalyDetectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.UpdateLogAnomalyDetector"
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.update_log_anomaly_detector_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_log_anomaly_detector(
