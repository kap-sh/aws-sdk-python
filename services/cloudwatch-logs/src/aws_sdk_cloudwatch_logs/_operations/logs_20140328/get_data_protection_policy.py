"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#GetDataProtectionPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.get_data_protection_policy_response.GetDataProtectionPolicyResponse = aws_sdk_cloudwatch_logs.types.get_data_protection_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.get_data_protection_policy_request.GetDataProtectionPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.GetDataProtectionPolicy"
    import aws_sdk_cloudwatch_logs.types.get_data_protection_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.get_data_protection_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_data_protection_policy(
