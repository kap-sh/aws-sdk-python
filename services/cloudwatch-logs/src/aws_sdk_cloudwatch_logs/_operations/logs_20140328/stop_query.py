"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#StopQuery``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.stop_query_response.StopQueryResponse = (
        aws_sdk_cloudwatch_logs.types.stop_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.stop_query_request.StopQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.stop_query_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def stop_query(
    ...
    aws_sdk_cloudwatch_logs.types.stop_query_response.StopQueryResponse, zapros.Response
]:
