...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OperationAbortedException":
            import aws_sdk_cloudwatch_logs.errors.operation_aborted_exception

            raise aws_sdk_cloudwatch_logs.errors.operation_aborted_exception.OperationAbortedException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.put_data_protection_policy_response.PutDataProtectionPolicyResponse = aws_sdk_cloudwatch_logs.types.put_data_protection_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.put_data_protection_policy_request.PutDataProtectionPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.put_data_protection_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
