...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.list_tags_log_group_response.ListTagsLogGroupResponse = aws_sdk_cloudwatch_logs.types.list_tags_log_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.list_tags_log_group_request.ListTagsLogGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
