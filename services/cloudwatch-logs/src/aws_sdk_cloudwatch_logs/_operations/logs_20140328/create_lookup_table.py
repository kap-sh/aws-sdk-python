...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.create_lookup_table_response.CreateLookupTableResponse = aws_sdk_cloudwatch_logs.types.create_lookup_table_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.create_lookup_table_request.CreateLookupTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.create_lookup_table_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
