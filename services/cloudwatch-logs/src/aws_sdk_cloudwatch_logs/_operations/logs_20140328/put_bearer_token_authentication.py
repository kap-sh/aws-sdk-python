"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutBearerTokenAuthentication``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.put_bearer_token_authentication_request.PutBearerTokenAuthenticationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.PutBearerTokenAuthentication"
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.put_bearer_token_authentication_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_bearer_token_authentication(
