"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeImportTaskBatches``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.describe_import_task_batches_response.DescribeImportTaskBatchesResponse = aws_sdk_cloudwatch_logs.types.describe_import_task_batches_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.describe_import_task_batches_request.DescribeImportTaskBatchesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DescribeImportTaskBatches"
    import aws_sdk_cloudwatch_logs.types.describe_import_task_batches_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.describe_import_task_batches_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_import_task_batches(
