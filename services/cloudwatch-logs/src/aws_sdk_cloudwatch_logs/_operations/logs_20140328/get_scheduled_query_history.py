"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#GetScheduledQueryHistory``."""
...
from aws_sdk_cloudwatch_logs._rule_engine._endpoint_runtime import apply_label
import jmespath
import zapros
from urllib.parse import quote, urlencode
from aws_sdk_cloudwatch_logs.errors import ServiceError, UnknownServiceError
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InternalServerException":
            import aws_sdk_cloudwatch_logs.errors.internal_server_exception

            raise aws_sdk_cloudwatch_logs.errors.internal_server_exception.InternalServerException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.get_scheduled_query_history_response.GetScheduledQueryHistoryResponse = aws_sdk_cloudwatch_logs.types.get_scheduled_query_history_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.get_scheduled_query_history_request.GetScheduledQueryHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.GetScheduledQueryHistory"
    import aws_sdk_cloudwatch_logs.types.get_scheduled_query_history_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.get_scheduled_query_history_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_scheduled_query_history(
