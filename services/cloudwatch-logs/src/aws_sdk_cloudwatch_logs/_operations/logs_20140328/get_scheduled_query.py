"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#GetScheduledQuery``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.get_scheduled_query_response.GetScheduledQueryResponse = aws_sdk_cloudwatch_logs.types.get_scheduled_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.get_scheduled_query_request.GetScheduledQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.GetScheduledQuery"
    import aws_sdk_cloudwatch_logs.types.get_scheduled_query_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.get_scheduled_query_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_scheduled_query(
