...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.describe_lookup_tables_response.DescribeLookupTablesResponse = aws_sdk_cloudwatch_logs.types.describe_lookup_tables_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.describe_lookup_tables_request.DescribeLookupTablesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.describe_lookup_tables_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
