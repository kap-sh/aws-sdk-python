"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DisassociateKmsKey``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.disassociate_kms_key_request.DisassociateKmsKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.disassociate_kms_key_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disassociate_kms_key(
