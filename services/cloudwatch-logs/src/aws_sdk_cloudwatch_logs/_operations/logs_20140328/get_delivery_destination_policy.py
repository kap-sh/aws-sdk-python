"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#GetDeliveryDestinationPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.get_delivery_destination_policy_response.GetDeliveryDestinationPolicyResponse = aws_sdk_cloudwatch_logs.types.get_delivery_destination_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.get_delivery_destination_policy_request.GetDeliveryDestinationPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.GetDeliveryDestinationPolicy"
    import aws_sdk_cloudwatch_logs.types.get_delivery_destination_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.get_delivery_destination_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_delivery_destination_policy(
