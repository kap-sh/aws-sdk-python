"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#CancelExportTask``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.cancel_export_task_request.CancelExportTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.cancel_export_task_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
