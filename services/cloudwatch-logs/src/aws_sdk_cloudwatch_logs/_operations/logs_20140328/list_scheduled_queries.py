"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#ListScheduledQueries``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.list_scheduled_queries_response.ListScheduledQueriesResponse = aws_sdk_cloudwatch_logs.types.list_scheduled_queries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.list_scheduled_queries_request.ListScheduledQueriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.ListScheduledQueries"
    import aws_sdk_cloudwatch_logs.types.list_scheduled_queries_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.list_scheduled_queries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
