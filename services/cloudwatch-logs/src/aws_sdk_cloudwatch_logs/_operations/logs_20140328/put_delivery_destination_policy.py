"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutDeliveryDestinationPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.put_delivery_destination_policy_response.PutDeliveryDestinationPolicyResponse = aws_sdk_cloudwatch_logs.types.put_delivery_destination_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.put_delivery_destination_policy_request.PutDeliveryDestinationPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.PutDeliveryDestinationPolicy"
    import aws_sdk_cloudwatch_logs.types.put_delivery_destination_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.put_delivery_destination_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_delivery_destination_policy(
