"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DeleteAccountPolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.delete_account_policy_request.DeleteAccountPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DeleteAccountPolicy"
    import aws_sdk_cloudwatch_logs.types.delete_account_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.delete_account_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_account_policy(
