"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutDeliveryDestination``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.put_delivery_destination_response.PutDeliveryDestinationResponse = aws_sdk_cloudwatch_logs.types.put_delivery_destination_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.put_delivery_destination_request.PutDeliveryDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.PutDeliveryDestination"
    import aws_sdk_cloudwatch_logs.types.put_delivery_destination_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.put_delivery_destination_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_delivery_destination(
