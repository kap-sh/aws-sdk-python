"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#GetLogAnomalyDetector``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.get_log_anomaly_detector_response.GetLogAnomalyDetectorResponse = aws_sdk_cloudwatch_logs.types.get_log_anomaly_detector_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.get_log_anomaly_detector_request.GetLogAnomalyDetectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.GetLogAnomalyDetector"
    import aws_sdk_cloudwatch_logs.types.get_log_anomaly_detector_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.get_log_anomaly_detector_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_log_anomaly_detector(
