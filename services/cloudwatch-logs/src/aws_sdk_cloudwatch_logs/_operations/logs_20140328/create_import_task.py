...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.create_import_task_response.CreateImportTaskResponse = aws_sdk_cloudwatch_logs.types.create_import_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.create_import_task_request.CreateImportTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.create_import_task_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
