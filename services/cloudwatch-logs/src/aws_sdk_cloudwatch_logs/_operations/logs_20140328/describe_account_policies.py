"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeAccountPolicies``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.describe_account_policies_response.DescribeAccountPoliciesResponse = aws_sdk_cloudwatch_logs.types.describe_account_policies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.describe_account_policies_request.DescribeAccountPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DescribeAccountPolicies"
    import aws_sdk_cloudwatch_logs.types.describe_account_policies_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.describe_account_policies_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_account_policies(
