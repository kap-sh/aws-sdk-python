...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.describe_queries_response.DescribeQueriesResponse = aws_sdk_cloudwatch_logs.types.describe_queries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.describe_queries_request.DescribeQueriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.describe_queries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
