...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.associate_source_to_s3_table_integration_response.AssociateSourceToS3TableIntegrationResponse = aws_sdk_cloudwatch_logs.types.associate_source_to_s3_table_integration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.associate_source_to_s3_table_integration_request.AssociateSourceToS3TableIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.associate_source_to_s3_table_integration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
