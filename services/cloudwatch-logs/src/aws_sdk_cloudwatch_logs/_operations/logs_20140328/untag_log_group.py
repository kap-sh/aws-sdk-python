"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#UntagLogGroup``."""
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.untag_log_group_request.UntagLogGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.untag_log_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_untag_log_group(
