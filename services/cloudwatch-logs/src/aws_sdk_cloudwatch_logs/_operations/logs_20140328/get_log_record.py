...
def handle_response(
    ...
    out: aws_sdk_cloudwatch_logs.types.get_log_record_response.GetLogRecordResponse = (
        aws_sdk_cloudwatch_logs.types.get_log_record_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudwatch_logs.types.get_log_record_request.GetLogRecordRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudwatch_logs.types.get_log_record_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
