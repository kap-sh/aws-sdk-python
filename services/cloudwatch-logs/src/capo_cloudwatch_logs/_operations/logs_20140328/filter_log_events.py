...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.filter_log_events_response.FilterLogEventsResponse = capo_cloudwatch_logs.types.filter_log_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.filter_log_events_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
