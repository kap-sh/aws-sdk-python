"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#ListAggregateLogGroupSummaries``."""
...
import capo_cloudwatch_logs.types.list_aggregate_log_group_summaries_request
import capo_cloudwatch_logs.types.list_aggregate_log_group_summaries_response
...
) -> capo_cloudwatch_logs.types.list_aggregate_log_group_summaries_response.ListAggregateLogGroupSummariesResponse:
    out: capo_cloudwatch_logs.types.list_aggregate_log_group_summaries_response.ListAggregateLogGroupSummariesResponse = capo_cloudwatch_logs.types.list_aggregate_log_group_summaries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.ListAggregateLogGroupSummaries"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.list_aggregate_log_group_summaries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_aggregate_log_group_summaries(
