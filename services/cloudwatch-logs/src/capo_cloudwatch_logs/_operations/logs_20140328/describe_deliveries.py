"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeDeliveries``."""
...
import capo_cloudwatch_logs.types.describe_deliveries_request
import capo_cloudwatch_logs.types.describe_deliveries_response
...
) -> capo_cloudwatch_logs.types.describe_deliveries_response.DescribeDeliveriesResponse:
    out: capo_cloudwatch_logs.types.describe_deliveries_response.DescribeDeliveriesResponse = capo_cloudwatch_logs.types.describe_deliveries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DescribeDeliveries"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.describe_deliveries_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_deliveries(
