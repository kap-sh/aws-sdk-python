"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#ListTagsLogGroup``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.list_tags_log_group_response.ListTagsLogGroupResponse = capo_cloudwatch_logs.types.list_tags_log_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.list_tags_log_group_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_tags_log_group(
