"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#GetLogRecord``."""
...
import capo_cloudwatch_logs.types.get_log_record_request
import capo_cloudwatch_logs.types.get_log_record_response
import capo_cloudwatch_logs.types.log_record
...
) -> capo_cloudwatch_logs.types.get_log_record_response.GetLogRecordResponse:
    out: capo_cloudwatch_logs.types.get_log_record_response.GetLogRecordResponse = (
        capo_cloudwatch_logs.types.get_log_record_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.get_log_record_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_log_record(
