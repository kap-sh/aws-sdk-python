"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#TestMetricFilter``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.test_metric_filter_response.TestMetricFilterResponse = capo_cloudwatch_logs.types.test_metric_filter_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.test_metric_filter_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_test_metric_filter(
