"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#CreateExportTask``."""
...
import capo_cloudwatch_logs.errors.limit_exceeded_exception
import capo_cloudwatch_logs.errors.operation_aborted_exception
import capo_cloudwatch_logs.errors.resource_already_exists_exception
...
import capo_cloudwatch_logs.types.create_export_task_request
import capo_cloudwatch_logs.types.create_export_task_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise capo_cloudwatch_logs.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data, message
            )
        case "OperationAbortedException":
            raise capo_cloudwatch_logs.errors.operation_aborted_exception.OperationAbortedException.from_aws_json_1_1(
                data, message
            )
        case "ResourceAlreadyExistsException":
            raise capo_cloudwatch_logs.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_aws_json_1_1(
                data, message
            )
...
) -> capo_cloudwatch_logs.types.create_export_task_response.CreateExportTaskResponse:
    out: capo_cloudwatch_logs.types.create_export_task_response.CreateExportTaskResponse = capo_cloudwatch_logs.types.create_export_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.create_export_task_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_export_task(
