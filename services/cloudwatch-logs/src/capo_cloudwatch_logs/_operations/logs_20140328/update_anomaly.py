"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#UpdateAnomaly``."""
...
import capo_cloudwatch_logs.types.update_anomaly_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.UpdateAnomaly"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.update_anomaly_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_anomaly(
