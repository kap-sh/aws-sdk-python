"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DeleteDelivery``."""
...
import capo_cloudwatch_logs.types.delete_delivery_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DeleteDelivery"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.delete_delivery_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
