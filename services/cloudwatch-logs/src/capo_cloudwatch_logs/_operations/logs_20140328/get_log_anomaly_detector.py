...
import capo_cloudwatch_logs.types.get_log_anomaly_detector_request
import capo_cloudwatch_logs.types.get_log_anomaly_detector_response
...
) -> capo_cloudwatch_logs.types.get_log_anomaly_detector_response.GetLogAnomalyDetectorResponse:
    out: capo_cloudwatch_logs.types.get_log_anomaly_detector_response.GetLogAnomalyDetectorResponse = capo_cloudwatch_logs.types.get_log_anomaly_detector_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.get_log_anomaly_detector_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
