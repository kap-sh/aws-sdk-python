"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeDeliverySources``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.describe_delivery_sources_response.DescribeDeliverySourcesResponse = capo_cloudwatch_logs.types.describe_delivery_sources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DescribeDeliverySources"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.describe_delivery_sources_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_delivery_sources(
