...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.list_scheduled_queries_response.ListScheduledQueriesResponse = capo_cloudwatch_logs.types.list_scheduled_queries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.list_scheduled_queries_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
