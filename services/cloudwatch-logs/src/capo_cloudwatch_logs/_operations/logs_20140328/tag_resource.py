...
import capo_cloudwatch_logs.errors.too_many_tags_exception
import capo_cloudwatch_logs.types.tag_resource_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            raise capo_cloudwatch_logs.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data
            )
        case _:
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
