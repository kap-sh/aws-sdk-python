"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#UntagResource``."""
...
import capo_cloudwatch_logs.types.untag_resource_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.UntagResource"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.untag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
