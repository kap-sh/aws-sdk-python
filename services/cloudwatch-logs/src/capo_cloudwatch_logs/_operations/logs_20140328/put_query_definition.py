"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutQueryDefinition``."""
...
import capo_cloudwatch_logs.types.put_query_definition_request
import capo_cloudwatch_logs.types.put_query_definition_response
...
def handle_response(
    ...
    capo_cloudwatch_logs.types.put_query_definition_response.PutQueryDefinitionResponse
):
    out: capo_cloudwatch_logs.types.put_query_definition_response.PutQueryDefinitionResponse = capo_cloudwatch_logs.types.put_query_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.PutQueryDefinition"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.put_query_definition_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_query_definition(
