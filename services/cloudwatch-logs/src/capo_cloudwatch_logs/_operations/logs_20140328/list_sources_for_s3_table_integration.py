...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.list_sources_for_s3_table_integration_response.ListSourcesForS3TableIntegrationResponse = capo_cloudwatch_logs.types.list_sources_for_s3_table_integration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.list_sources_for_s3_table_integration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
