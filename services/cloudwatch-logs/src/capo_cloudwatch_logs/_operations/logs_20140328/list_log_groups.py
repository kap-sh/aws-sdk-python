"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#ListLogGroups``."""
...
import capo_cloudwatch_logs.types.list_log_groups_request
import capo_cloudwatch_logs.types.list_log_groups_response
...
) -> capo_cloudwatch_logs.types.list_log_groups_response.ListLogGroupsResponse:
    out: capo_cloudwatch_logs.types.list_log_groups_response.ListLogGroupsResponse = (
        capo_cloudwatch_logs.types.list_log_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.ListLogGroups"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.list_log_groups_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_log_groups(
