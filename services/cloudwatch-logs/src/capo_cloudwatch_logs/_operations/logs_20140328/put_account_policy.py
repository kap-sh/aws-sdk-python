"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutAccountPolicy``."""
...
import capo_cloudwatch_logs.types.put_account_policy_request
import capo_cloudwatch_logs.types.put_account_policy_response
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.put_account_policy_response.PutAccountPolicyResponse = capo_cloudwatch_logs.types.put_account_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.PutAccountPolicy"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.put_account_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_account_policy(
