"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#GetLogGroupFields``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.get_log_group_fields_response.GetLogGroupFieldsResponse = capo_cloudwatch_logs.types.get_log_group_fields_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.get_log_group_fields_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_log_group_fields(
