...
import capo_cloudwatch_logs.types.get_data_protection_policy_request
import capo_cloudwatch_logs.types.get_data_protection_policy_response
...
) -> capo_cloudwatch_logs.types.get_data_protection_policy_response.GetDataProtectionPolicyResponse:
    out: capo_cloudwatch_logs.types.get_data_protection_policy_response.GetDataProtectionPolicyResponse = capo_cloudwatch_logs.types.get_data_protection_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.get_data_protection_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
