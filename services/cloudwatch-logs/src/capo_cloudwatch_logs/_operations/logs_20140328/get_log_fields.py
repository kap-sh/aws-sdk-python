...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.get_log_fields_response.GetLogFieldsResponse = (
        capo_cloudwatch_logs.types.get_log_fields_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.get_log_fields_request.serialize_aws_json_1_1(input_)
    ).encode()
