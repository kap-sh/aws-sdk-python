...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.get_transformer_response.GetTransformerResponse = (
        capo_cloudwatch_logs.types.get_transformer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.get_transformer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
