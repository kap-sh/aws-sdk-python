"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeFieldIndexes``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.describe_field_indexes_response.DescribeFieldIndexesResponse = capo_cloudwatch_logs.types.describe_field_indexes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DescribeFieldIndexes"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.describe_field_indexes_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_field_indexes(
