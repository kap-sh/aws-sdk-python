"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#ListTagsForResource``."""
...
) -> capo_cloudwatch_logs.types.list_tags_for_resource_response.ListTagsForResourceResponse:
    out: capo_cloudwatch_logs.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_cloudwatch_logs.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.ListTagsForResource"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.list_tags_for_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
