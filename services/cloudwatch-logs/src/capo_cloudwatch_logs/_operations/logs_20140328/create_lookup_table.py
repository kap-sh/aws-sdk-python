"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#CreateLookupTable``."""
...
import capo_cloudwatch_logs.types.create_lookup_table_request
import capo_cloudwatch_logs.types.create_lookup_table_response
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.create_lookup_table_response.CreateLookupTableResponse = capo_cloudwatch_logs.types.create_lookup_table_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.CreateLookupTable"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.create_lookup_table_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_lookup_table(
