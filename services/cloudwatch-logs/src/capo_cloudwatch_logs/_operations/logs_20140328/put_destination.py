"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutDestination``."""
...
import capo_cloudwatch_logs.types.put_destination_request
import capo_cloudwatch_logs.types.put_destination_response
...
) -> capo_cloudwatch_logs.types.put_destination_response.PutDestinationResponse:
    out: capo_cloudwatch_logs.types.put_destination_response.PutDestinationResponse = (
        capo_cloudwatch_logs.types.put_destination_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.put_destination_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_destination(
