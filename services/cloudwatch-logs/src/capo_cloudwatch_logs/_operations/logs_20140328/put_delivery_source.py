"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutDeliverySource``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.put_delivery_source_response.PutDeliverySourceResponse = capo_cloudwatch_logs.types.put_delivery_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.PutDeliverySource"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.put_delivery_source_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_delivery_source(
