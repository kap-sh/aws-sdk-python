...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.list_log_groups_for_query_response.ListLogGroupsForQueryResponse = capo_cloudwatch_logs.types.list_log_groups_for_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.list_log_groups_for_query_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
