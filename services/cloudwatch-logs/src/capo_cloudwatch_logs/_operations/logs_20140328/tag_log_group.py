"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#TagLogGroup``."""
...
import capo_cloudwatch_logs.types.tag_log_group_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.tag_log_group_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
