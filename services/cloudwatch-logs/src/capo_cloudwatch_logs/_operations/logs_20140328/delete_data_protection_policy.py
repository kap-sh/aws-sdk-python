"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DeleteDataProtectionPolicy``."""
...
import capo_cloudwatch_logs.types.delete_data_protection_policy_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DeleteDataProtectionPolicy"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.delete_data_protection_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_data_protection_policy(
