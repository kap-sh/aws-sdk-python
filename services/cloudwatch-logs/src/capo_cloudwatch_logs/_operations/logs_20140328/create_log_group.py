"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#CreateLogGroup``."""
...
import capo_cloudwatch_logs.types.create_log_group_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.create_log_group_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_log_group(
