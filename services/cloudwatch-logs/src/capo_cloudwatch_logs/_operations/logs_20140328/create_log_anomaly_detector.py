"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#CreateLogAnomalyDetector``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.create_log_anomaly_detector_response.CreateLogAnomalyDetectorResponse = capo_cloudwatch_logs.types.create_log_anomaly_detector_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.CreateLogAnomalyDetector"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.create_log_anomaly_detector_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_log_anomaly_detector(
