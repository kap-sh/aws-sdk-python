"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#ListLogAnomalyDetectors``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.list_log_anomaly_detectors_response.ListLogAnomalyDetectorsResponse = capo_cloudwatch_logs.types.list_log_anomaly_detectors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.ListLogAnomalyDetectors"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.list_log_anomaly_detectors_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_log_anomaly_detectors(
