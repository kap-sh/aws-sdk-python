"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#ListAnomalies``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.list_anomalies_response.ListAnomaliesResponse = (
        capo_cloudwatch_logs.types.list_anomalies_response.deserialize_aws_json_1_1(
...
async def async_list_anomalies(
