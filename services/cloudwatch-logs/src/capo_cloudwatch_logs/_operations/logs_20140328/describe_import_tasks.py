"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeImportTasks``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.describe_import_tasks_response.DescribeImportTasksResponse = capo_cloudwatch_logs.types.describe_import_tasks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DescribeImportTasks"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.describe_import_tasks_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
