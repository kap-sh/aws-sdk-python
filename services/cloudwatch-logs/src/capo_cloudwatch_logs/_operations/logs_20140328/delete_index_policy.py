"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DeleteIndexPolicy``."""
...
import capo_cloudwatch_logs.types.delete_index_policy_request
import capo_cloudwatch_logs.types.delete_index_policy_response
...
) -> capo_cloudwatch_logs.types.delete_index_policy_response.DeleteIndexPolicyResponse:
    out: capo_cloudwatch_logs.types.delete_index_policy_response.DeleteIndexPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DeleteIndexPolicy"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.delete_index_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_index_policy(
