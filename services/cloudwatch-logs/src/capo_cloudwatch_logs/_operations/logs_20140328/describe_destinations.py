...
import capo_cloudwatch_logs.types.describe_destinations_request
import capo_cloudwatch_logs.types.describe_destinations_response
...
) -> capo_cloudwatch_logs.types.describe_destinations_response.DescribeDestinationsResponse:
    out: capo_cloudwatch_logs.types.describe_destinations_response.DescribeDestinationsResponse = capo_cloudwatch_logs.types.describe_destinations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.describe_destinations_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
