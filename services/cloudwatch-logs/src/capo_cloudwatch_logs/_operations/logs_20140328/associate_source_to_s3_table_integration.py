"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#AssociateSourceToS3TableIntegration``."""
...
import capo_cloudwatch_logs.types.associate_source_to_s3_table_integration_request
import capo_cloudwatch_logs.types.associate_source_to_s3_table_integration_response
...
) -> capo_cloudwatch_logs.types.associate_source_to_s3_table_integration_response.AssociateSourceToS3TableIntegrationResponse:
    out: capo_cloudwatch_logs.types.associate_source_to_s3_table_integration_response.AssociateSourceToS3TableIntegrationResponse = capo_cloudwatch_logs.types.associate_source_to_s3_table_integration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.AssociateSourceToS3TableIntegration"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.associate_source_to_s3_table_integration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_associate_source_to_s3_table_integration(
