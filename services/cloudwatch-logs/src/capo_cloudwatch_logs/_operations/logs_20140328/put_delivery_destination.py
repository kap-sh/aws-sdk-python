...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.put_delivery_destination_response.PutDeliveryDestinationResponse = capo_cloudwatch_logs.types.put_delivery_destination_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.put_delivery_destination_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
