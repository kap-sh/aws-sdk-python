"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#CreateImportTask``."""
...
import capo_cloudwatch_logs.types.create_import_task_request
import capo_cloudwatch_logs.types.create_import_task_response
...
) -> capo_cloudwatch_logs.types.create_import_task_response.CreateImportTaskResponse:
    out: capo_cloudwatch_logs.types.create_import_task_response.CreateImportTaskResponse = capo_cloudwatch_logs.types.create_import_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.CreateImportTask"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.create_import_task_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
