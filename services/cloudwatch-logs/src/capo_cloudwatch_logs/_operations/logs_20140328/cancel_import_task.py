"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#CancelImportTask``."""
...
import capo_cloudwatch_logs.types.cancel_import_task_request
import capo_cloudwatch_logs.types.cancel_import_task_response
...
) -> capo_cloudwatch_logs.types.cancel_import_task_response.CancelImportTaskResponse:
    out: capo_cloudwatch_logs.types.cancel_import_task_response.CancelImportTaskResponse = capo_cloudwatch_logs.types.cancel_import_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.CancelImportTask"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.cancel_import_task_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_cancel_import_task(
