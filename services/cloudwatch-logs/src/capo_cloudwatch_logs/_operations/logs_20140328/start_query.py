"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#StartQuery``."""
...
import capo_cloudwatch_logs.errors.malformed_query_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MalformedQueryException":
            raise capo_cloudwatch_logs.errors.malformed_query_exception.MalformedQueryException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.start_query_response.StartQueryResponse = (
        capo_cloudwatch_logs.types.start_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.start_query_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_query(
    ...
    capo_cloudwatch_logs.types.start_query_response.StartQueryResponse, zapros.Response
]:
