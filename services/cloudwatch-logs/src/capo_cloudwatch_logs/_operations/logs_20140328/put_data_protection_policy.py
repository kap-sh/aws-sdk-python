"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutDataProtectionPolicy``."""
...
import capo_cloudwatch_logs.types.put_data_protection_policy_request
import capo_cloudwatch_logs.types.put_data_protection_policy_response
...
) -> capo_cloudwatch_logs.types.put_data_protection_policy_response.PutDataProtectionPolicyResponse:
    out: capo_cloudwatch_logs.types.put_data_protection_policy_response.PutDataProtectionPolicyResponse = capo_cloudwatch_logs.types.put_data_protection_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.PutDataProtectionPolicy"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.put_data_protection_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_data_protection_policy(
