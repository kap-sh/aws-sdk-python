...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.describe_import_task_batches_response.DescribeImportTaskBatchesResponse = capo_cloudwatch_logs.types.describe_import_task_batches_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.describe_import_task_batches_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
