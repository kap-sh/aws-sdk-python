"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#AssociateKmsKey``."""
...
import capo_cloudwatch_logs.types.associate_kms_key_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.associate_kms_key_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_kms_key(
