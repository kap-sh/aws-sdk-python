"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutIntegration``."""
...
import capo_cloudwatch_logs.types.put_integration_request
import capo_cloudwatch_logs.types.put_integration_response
...
) -> capo_cloudwatch_logs.types.put_integration_response.PutIntegrationResponse:
    out: capo_cloudwatch_logs.types.put_integration_response.PutIntegrationResponse = (
        capo_cloudwatch_logs.types.put_integration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.PutIntegration"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.put_integration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_integration(
