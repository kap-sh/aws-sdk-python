"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#GetDelivery``."""
...
import capo_cloudwatch_logs.types.get_delivery_request
import capo_cloudwatch_logs.types.get_delivery_response
...
) -> capo_cloudwatch_logs.types.get_delivery_response.GetDeliveryResponse:
    out: capo_cloudwatch_logs.types.get_delivery_response.GetDeliveryResponse = (
        capo_cloudwatch_logs.types.get_delivery_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.GetDelivery"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.get_delivery_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
