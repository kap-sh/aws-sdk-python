"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeExportTasks``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.describe_export_tasks_response.DescribeExportTasksResponse = capo_cloudwatch_logs.types.describe_export_tasks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.describe_export_tasks_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
