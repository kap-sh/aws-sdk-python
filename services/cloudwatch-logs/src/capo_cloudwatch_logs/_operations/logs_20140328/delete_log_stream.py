"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DeleteLogStream``."""
...
import capo_cloudwatch_logs.types.delete_log_stream_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.delete_log_stream_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_log_stream(
