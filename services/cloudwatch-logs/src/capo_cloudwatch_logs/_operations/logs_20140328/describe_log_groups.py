...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.describe_log_groups_response.DescribeLogGroupsResponse = capo_cloudwatch_logs.types.describe_log_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.describe_log_groups_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
