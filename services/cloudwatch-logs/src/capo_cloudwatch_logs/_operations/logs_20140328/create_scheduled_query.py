"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#CreateScheduledQuery``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.create_scheduled_query_response.CreateScheduledQueryResponse = capo_cloudwatch_logs.types.create_scheduled_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.CreateScheduledQuery"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.create_scheduled_query_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
