"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeIndexPolicies``."""
...
import capo_cloudwatch_logs.types.describe_index_policies_request
import capo_cloudwatch_logs.types.describe_index_policies_response
...
) -> capo_cloudwatch_logs.types.describe_index_policies_response.DescribeIndexPoliciesResponse:
    out: capo_cloudwatch_logs.types.describe_index_policies_response.DescribeIndexPoliciesResponse = capo_cloudwatch_logs.types.describe_index_policies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DescribeIndexPolicies"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.describe_index_policies_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_index_policies(
