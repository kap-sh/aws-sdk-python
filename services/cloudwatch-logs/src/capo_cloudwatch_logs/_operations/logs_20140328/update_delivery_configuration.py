...
import capo_cloudwatch_logs.types.update_delivery_configuration_request
import capo_cloudwatch_logs.types.update_delivery_configuration_response
...
) -> capo_cloudwatch_logs.types.update_delivery_configuration_response.UpdateDeliveryConfigurationResponse:
    out: capo_cloudwatch_logs.types.update_delivery_configuration_response.UpdateDeliveryConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.update_delivery_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
