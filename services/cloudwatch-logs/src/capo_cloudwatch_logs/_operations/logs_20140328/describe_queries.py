"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeQueries``."""
...
import capo_cloudwatch_logs.types.describe_queries_request
import capo_cloudwatch_logs.types.describe_queries_response
import capo_cloudwatch_logs.types.query_info_list
...
) -> capo_cloudwatch_logs.types.describe_queries_response.DescribeQueriesResponse:
    out: capo_cloudwatch_logs.types.describe_queries_response.DescribeQueriesResponse = capo_cloudwatch_logs.types.describe_queries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.describe_queries_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_queries(
