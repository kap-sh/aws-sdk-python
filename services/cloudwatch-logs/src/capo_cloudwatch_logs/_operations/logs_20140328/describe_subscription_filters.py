"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DescribeSubscriptionFilters``."""
...
import capo_cloudwatch_logs.types.describe_subscription_filters_request
import capo_cloudwatch_logs.types.describe_subscription_filters_response
...
) -> capo_cloudwatch_logs.types.describe_subscription_filters_response.DescribeSubscriptionFiltersResponse:
    out: capo_cloudwatch_logs.types.describe_subscription_filters_response.DescribeSubscriptionFiltersResponse = capo_cloudwatch_logs.types.describe_subscription_filters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.describe_subscription_filters_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_subscription_filters(
