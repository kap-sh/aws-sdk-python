"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DisassociateSourceFromS3TableIntegration``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_response.DisassociateSourceFromS3TableIntegrationResponse = capo_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DisassociateSourceFromS3TableIntegration"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disassociate_source_from_s3_table_integration(
