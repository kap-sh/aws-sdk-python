"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DeleteLogAnomalyDetector``."""
...
import capo_cloudwatch_logs.types.delete_log_anomaly_detector_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DeleteLogAnomalyDetector"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.delete_log_anomaly_detector_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_log_anomaly_detector(
