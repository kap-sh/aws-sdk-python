"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DeleteIntegration``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.delete_integration_response.DeleteIntegrationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.delete_integration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
