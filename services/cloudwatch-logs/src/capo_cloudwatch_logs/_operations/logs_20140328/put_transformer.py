"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutTransformer``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.PutTransformer"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.put_transformer_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_transformer(
