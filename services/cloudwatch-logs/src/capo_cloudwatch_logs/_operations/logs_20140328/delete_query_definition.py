"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DeleteQueryDefinition``."""
...
import capo_cloudwatch_logs.types.delete_query_definition_request
import capo_cloudwatch_logs.types.delete_query_definition_response
...
) -> capo_cloudwatch_logs.types.delete_query_definition_response.DeleteQueryDefinitionResponse:
    out: capo_cloudwatch_logs.types.delete_query_definition_response.DeleteQueryDefinitionResponse = capo_cloudwatch_logs.types.delete_query_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DeleteQueryDefinition"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.delete_query_definition_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_query_definition(
