"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#DeleteDeliveryDestinationPolicy``."""
...
import capo_cloudwatch_logs.types.delete_delivery_destination_policy_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.DeleteDeliveryDestinationPolicy"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.delete_delivery_destination_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_delivery_destination_policy(
