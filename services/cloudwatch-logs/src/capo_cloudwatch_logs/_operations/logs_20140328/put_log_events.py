"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutLogEvents``."""
...
import capo_cloudwatch_logs.errors.data_already_accepted_exception
import capo_cloudwatch_logs.errors.invalid_parameter_exception
import capo_cloudwatch_logs.errors.invalid_sequence_token_exception
...
import capo_cloudwatch_logs.errors.unrecognized_client_exception
import capo_cloudwatch_logs.types.entity
import capo_cloudwatch_logs.types.input_log_events
import capo_cloudwatch_logs.types.put_log_events_request
import capo_cloudwatch_logs.types.put_log_events_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DataAlreadyAcceptedException":
            raise capo_cloudwatch_logs.errors.data_already_accepted_exception.DataAlreadyAcceptedException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidSequenceTokenException":
            raise capo_cloudwatch_logs.errors.invalid_sequence_token_exception.InvalidSequenceTokenException.from_aws_json_1_1(
                data
            )
        ...
        case "UnrecognizedClientException":
            raise capo_cloudwatch_logs.errors.unrecognized_client_exception.UnrecognizedClientException.from_aws_json_1_1(
                data
            )
        case _:
...
) -> capo_cloudwatch_logs.types.put_log_events_response.PutLogEventsResponse:
    out: capo_cloudwatch_logs.types.put_log_events_response.PutLogEventsResponse = (
        capo_cloudwatch_logs.types.put_log_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.put_log_events_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_put_log_events(
