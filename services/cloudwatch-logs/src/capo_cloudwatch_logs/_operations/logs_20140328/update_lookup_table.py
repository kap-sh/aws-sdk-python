...
import capo_cloudwatch_logs.types.update_lookup_table_request
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.update_lookup_table_response.UpdateLookupTableResponse = capo_cloudwatch_logs.types.update_lookup_table_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.update_lookup_table_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
