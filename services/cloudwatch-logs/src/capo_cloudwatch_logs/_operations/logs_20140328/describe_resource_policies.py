...
import capo_cloudwatch_logs.types.describe_resource_policies_request
import capo_cloudwatch_logs.types.describe_resource_policies_response
...
) -> capo_cloudwatch_logs.types.describe_resource_policies_response.DescribeResourcePoliciesResponse:
    out: capo_cloudwatch_logs.types.describe_resource_policies_response.DescribeResourcePoliciesResponse = capo_cloudwatch_logs.types.describe_resource_policies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.describe_resource_policies_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
