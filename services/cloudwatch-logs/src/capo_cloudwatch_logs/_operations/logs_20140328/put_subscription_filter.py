"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutSubscriptionFilter``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.put_subscription_filter_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_subscription_filter(
