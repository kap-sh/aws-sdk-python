...
) -> capo_cloudwatch_logs.types.update_scheduled_query_response.UpdateScheduledQueryResponse:
    out: capo_cloudwatch_logs.types.update_scheduled_query_response.UpdateScheduledQueryResponse = capo_cloudwatch_logs.types.update_scheduled_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.update_scheduled_query_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
