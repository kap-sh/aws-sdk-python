"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#GetQueryResults``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.get_query_results_response.GetQueryResultsResponse = capo_cloudwatch_logs.types.get_query_results_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.get_query_results_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
