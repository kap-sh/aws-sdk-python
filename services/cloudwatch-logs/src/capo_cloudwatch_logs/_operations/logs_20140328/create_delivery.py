...
import capo_cloudwatch_logs.types.create_delivery_request
import capo_cloudwatch_logs.types.create_delivery_response
...
) -> capo_cloudwatch_logs.types.create_delivery_response.CreateDeliveryResponse:
    out: capo_cloudwatch_logs.types.create_delivery_response.CreateDeliveryResponse = (
        capo_cloudwatch_logs.types.create_delivery_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.create_delivery_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
