"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#GetDeliverySource``."""
...
import capo_cloudwatch_logs.types.get_delivery_source_request
import capo_cloudwatch_logs.types.get_delivery_source_response
...
) -> capo_cloudwatch_logs.types.get_delivery_source_response.GetDeliverySourceResponse:
    out: capo_cloudwatch_logs.types.get_delivery_source_response.GetDeliverySourceResponse = capo_cloudwatch_logs.types.get_delivery_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.GetDeliverySource"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.get_delivery_source_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_delivery_source(
