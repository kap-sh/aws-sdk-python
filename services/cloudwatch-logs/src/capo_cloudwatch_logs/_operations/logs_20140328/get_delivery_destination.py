"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#GetDeliveryDestination``."""
...
import capo_cloudwatch_logs.errors.service_quota_exceeded_exception
...
import capo_cloudwatch_logs.types.get_delivery_destination_request
import capo_cloudwatch_logs.types.get_delivery_destination_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_cloudwatch_logs.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_1(
                data, message
            )
...
) -> capo_cloudwatch_logs.types.get_delivery_destination_response.GetDeliveryDestinationResponse:
    out: capo_cloudwatch_logs.types.get_delivery_destination_response.GetDeliveryDestinationResponse = capo_cloudwatch_logs.types.get_delivery_destination_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.GetDeliveryDestination"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.get_delivery_destination_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_delivery_destination(
