...
def handle_response(
    ...
    out: capo_cloudwatch_logs.types.stop_query_response.StopQueryResponse = (
        capo_cloudwatch_logs.types.stop_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.stop_query_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def stop_query(
    ...
    capo_cloudwatch_logs.types.stop_query_response.StopQueryResponse, zapros.Response
]:
