"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#ListIntegrations``."""
...
import capo_cloudwatch_logs.types.integration_summaries
import capo_cloudwatch_logs.types.integration_type
import capo_cloudwatch_logs.types.list_integrations_request
import capo_cloudwatch_logs.types.list_integrations_response
...
) -> capo_cloudwatch_logs.types.list_integrations_response.ListIntegrationsResponse:
    out: capo_cloudwatch_logs.types.list_integrations_response.ListIntegrationsResponse = capo_cloudwatch_logs.types.list_integrations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Logs_20140328.ListIntegrations"
    body: bytes | None = json.dumps(
        capo_cloudwatch_logs.types.list_integrations_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
