"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#OpenSearchDataAccessPolicy``."""
...
class OpenSearchDataAccessPolicy(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: OpenSearchDataAccessPolicy) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> OpenSearchDataAccessPolicy:
    out: OpenSearchDataAccessPolicy = {}  # type: ignore[typeddict-item]
