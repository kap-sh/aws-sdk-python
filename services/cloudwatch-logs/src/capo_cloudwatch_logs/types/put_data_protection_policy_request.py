"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#PutDataProtectionPolicyRequest``."""
...
class PutDataProtectionPolicyRequest(TypedDict, closed=True):
    ...
    policy_document: "capo_cloudwatch_logs.types.data_protection_policy_document.DataProtectionPolicyDocument"
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: PutDataProtectionPolicyRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> PutDataProtectionPolicyRequest:
    out: PutDataProtectionPolicyRequest = {}  # type: ignore[typeddict-item]
    if data.get("logGroupIdentifier") is not None:
        out["log_group_identifier"] = data["logGroupIdentifier"]
    else:
        raise DeserializationError(
            "PutDataProtectionPolicyRequest.log_group_identifier required"
        )
    if data.get("policyDocument") is not None:
        out["policy_document"] = data["policyDocument"]
    else:
        raise DeserializationError(
            "PutDataProtectionPolicyRequest.policy_document required"
        )
    return out
