...
if TYPE_CHECKING:
    import capo_cloudwatch_logs.types.open_search_data_source_name
    import capo_cloudwatch_logs.types.open_search_resource_status


class OpenSearchDataSource(TypedDict, closed=True):
    data_source_name: NotRequired[
        "capo_cloudwatch_logs.types.open_search_data_source_name.OpenSearchDataSourceName"
    ]
