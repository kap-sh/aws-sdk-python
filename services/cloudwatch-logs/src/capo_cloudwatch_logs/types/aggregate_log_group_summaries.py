...
AggregateLogGroupSummaries: TypeAlias = list[
    "capo_cloudwatch_logs.types.aggregate_log_group_summary.AggregateLogGroupSummary"
]
...
def serialize_aws_json_1_1(value: AggregateLogGroupSummaries) -> list:
    ...
    for item in value:
        out.append(
            capo_cloudwatch_logs.types.aggregate_log_group_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
