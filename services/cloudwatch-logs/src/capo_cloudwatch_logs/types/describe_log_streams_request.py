...
if TYPE_CHECKING:
    import capo_cloudwatch_logs.types.descending
...
class DescribeLogStreamsRequest(TypedDict, closed=True):
    ...
    order_by: NotRequired["capo_cloudwatch_logs.types.order_by.OrderBy"]
    ...
    descending: NotRequired["capo_cloudwatch_logs.types.descending.Descending"]
...
def serialize_aws_json_1_1(value: DescribeLogStreamsRequest) -> dict:
    ...
    if "order_by" in value:
        ...
        out["orderBy"] = capo_cloudwatch_logs.types.order_by.serialize_aws_json_1_1(
            value["order_by"]
        )
