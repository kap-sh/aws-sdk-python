...
if TYPE_CHECKING:
    ...
    import capo_cloudwatch_logs.types.log_stream_searched_completely


class SearchedLogStream(TypedDict, closed=True):
    log_stream_name: NotRequired[
        "capo_cloudwatch_logs.types.log_stream_name.LogStreamName"
    ]
    """<p>The name of the log stream.</p>"""
    searched_completely: NotRequired[
        "capo_cloudwatch_logs.types.log_stream_searched_completely.LogStreamSearchedCompletely"
    ]
