...
class DescribeQueriesResponse(TypedDict, closed=True):
    queries: NotRequired["capo_cloudwatch_logs.types.query_info_list.QueryInfoList"]
...
def serialize_aws_json_1_1(value: DescribeQueriesResponse) -> dict:
    ...
    if "queries" in value:
        ...
        out["queries"] = (
            capo_cloudwatch_logs.types.query_info_list.serialize_aws_json_1_1(
                value["queries"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeQueriesResponse:
    ...
    if "queries" in data:
        ...
        out["queries"] = (
            capo_cloudwatch_logs.types.query_info_list.deserialize_aws_json_1_1(
                data["queries"]
            )
        )
