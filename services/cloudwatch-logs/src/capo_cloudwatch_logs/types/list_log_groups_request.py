...
class ListLogGroupsRequest(TypedDict, closed=True):
    ...
    limit: NotRequired["capo_cloudwatch_logs.types.list_limit.ListLimit"]
    ...
    log_group_tags: NotRequired["capo_cloudwatch_logs.types.tag_filters.TagFilters"]
...
def serialize_aws_json_1_1(value: ListLogGroupsRequest) -> dict:
    ...
    if "field_index_names" in value:
        ...
        out["fieldIndexNames"] = (
            capo_cloudwatch_logs.types.field_index_names.serialize_aws_json_1_1(
    ...
    if "log_group_tags" in value:
        ...
        out["logGroupTags"] = (
            capo_cloudwatch_logs.types.tag_filters.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListLogGroupsRequest:
    ...
    if data.get("fieldIndexNames") is not None:
        ...
        out["field_index_names"] = (
            capo_cloudwatch_logs.types.field_index_names.deserialize_aws_json_1_1(
    ...
    if data.get("logGroupTags") is not None:
        ...
        out["log_group_tags"] = (
            capo_cloudwatch_logs.types.tag_filters.deserialize_aws_json_1_1(
                data["logGroupTags"]
            )
        )
    return out
