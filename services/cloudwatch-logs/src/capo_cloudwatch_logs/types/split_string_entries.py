...
if TYPE_CHECKING:
    import capo_cloudwatch_logs.types.split_string_entry

SplitStringEntries: TypeAlias = list[
    "capo_cloudwatch_logs.types.split_string_entry.SplitStringEntry"
]
...
def serialize_aws_json_1_1(value: SplitStringEntries) -> list:
    ...
    for item in value:
        out.append(
            capo_cloudwatch_logs.types.split_string_entry.serialize_aws_json_1_1(item)
        )
    return out
