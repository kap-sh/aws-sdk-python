...
class IndexPolicy(TypedDict, closed=True):
    ...
    last_update_time: NotRequired["capo_cloudwatch_logs.types.timestamp.Timestamp"]
    ...
    source: NotRequired["capo_cloudwatch_logs.types.index_source.IndexSource"]
...
def serialize_aws_json_1_1(value: IndexPolicy) -> dict:
    ...
    if "source" in value:
        ...
        out["source"] = capo_cloudwatch_logs.types.index_source.serialize_aws_json_1_1(
            value["source"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> IndexPolicy:
    ...
    if data.get("source") is not None:
        ...
        out["source"] = (
            capo_cloudwatch_logs.types.index_source.deserialize_aws_json_1_1(
                data["source"]
            )
        )
    return out
