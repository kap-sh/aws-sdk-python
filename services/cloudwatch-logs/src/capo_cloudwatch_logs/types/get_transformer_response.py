...
class GetTransformerResponse(TypedDict, closed=True):
    ...
    last_modified_time: NotRequired["capo_cloudwatch_logs.types.timestamp.Timestamp"]
    ...
    transformer_config: NotRequired["capo_cloudwatch_logs.types.processors.Processors"]
