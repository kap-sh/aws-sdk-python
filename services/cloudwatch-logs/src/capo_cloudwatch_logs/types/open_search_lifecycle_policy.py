...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: OpenSearchLifecyclePolicy) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> OpenSearchLifecyclePolicy:
    out: OpenSearchLifecyclePolicy = {}  # type: ignore[typeddict-item]
