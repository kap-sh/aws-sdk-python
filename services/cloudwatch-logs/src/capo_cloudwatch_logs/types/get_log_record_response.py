...
class GetLogRecordResponse(TypedDict, closed=True):
    log_record: NotRequired["capo_cloudwatch_logs.types.log_record.LogRecord"]
...
def serialize_aws_json_1_1(value: GetLogRecordResponse) -> dict:
    ...
    if "log_record" in value:
        ...
        out["logRecord"] = capo_cloudwatch_logs.types.log_record.serialize_aws_json_1_1(
            value["log_record"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetLogRecordResponse:
    ...
    if data.get("logRecord") is not None:
        import capo_cloudwatch_logs.types.log_record

        out["log_record"] = (
            capo_cloudwatch_logs.types.log_record.deserialize_aws_json_1_1(
                data["logRecord"]
            )
        )
    return out
