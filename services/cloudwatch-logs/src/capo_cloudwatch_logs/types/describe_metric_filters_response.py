...
if TYPE_CHECKING:
    import capo_cloudwatch_logs.types.metric_filters
...
class DescribeMetricFiltersResponse(TypedDict, closed=True):
    metric_filters: NotRequired[
        "capo_cloudwatch_logs.types.metric_filters.MetricFilters"
    ]
...
def serialize_aws_json_1_1(value: DescribeMetricFiltersResponse) -> dict:
    ...
    if "metric_filters" in value:
        ...
        out["metricFilters"] = (
            capo_cloudwatch_logs.types.metric_filters.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeMetricFiltersResponse:
    ...
    if data.get("metricFilters") is not None:
        ...
        out["metric_filters"] = (
            capo_cloudwatch_logs.types.metric_filters.deserialize_aws_json_1_1(
                data["metricFilters"]
            )
        )
