...
if TYPE_CHECKING:
    import capo_cloudwatch_logs.types.data_type
...
class LogFieldType(TypedDict, closed=True):
    type: NotRequired["capo_cloudwatch_logs.types.data_type.DataType"]
    """<p>The data type of the log field.</p>"""
    element: NotRequired["capo_cloudwatch_logs.types.log_field_type.LogFieldType"]
    """<p>For array or collection types, specifies the element type information.</p>"""
    fields: NotRequired["capo_cloudwatch_logs.types.log_fields_list.LogFieldsList"]
