...
if TYPE_CHECKING:
    import capo_cloudwatch_logs.types.integration_details
...
class GetIntegrationResponse(TypedDict, closed=True):
    ...
    integration_details: NotRequired[
        "capo_cloudwatch_logs.types.integration_details.IntegrationDetails"
    ]
...
def serialize_aws_json_1_1(value: GetIntegrationResponse) -> dict:
    ...
    if "integration_details" in value:
        ...
        out["integrationDetails"] = (
            capo_cloudwatch_logs.types.integration_details.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetIntegrationResponse:
    ...
    if data.get("integrationDetails") is not None:
        import capo_cloudwatch_logs.types.integration_details

        out["integration_details"] = (
            capo_cloudwatch_logs.types.integration_details.deserialize_aws_json_1_1(
