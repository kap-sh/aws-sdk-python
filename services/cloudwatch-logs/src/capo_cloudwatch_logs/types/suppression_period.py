...
class SuppressionPeriod(TypedDict, closed=True):
    ...
    suppression_unit: NotRequired[
        "capo_cloudwatch_logs.types.suppression_unit.SuppressionUnit"
    ]
...
def serialize_aws_json_1_1(value: SuppressionPeriod) -> dict:
    ...
    if "suppression_unit" in value:
        ...
        out["suppressionUnit"] = (
            capo_cloudwatch_logs.types.suppression_unit.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SuppressionPeriod:
    ...
    if data.get("suppressionUnit") is not None:
        ...
        out["suppression_unit"] = (
            capo_cloudwatch_logs.types.suppression_unit.deserialize_aws_json_1_1(
