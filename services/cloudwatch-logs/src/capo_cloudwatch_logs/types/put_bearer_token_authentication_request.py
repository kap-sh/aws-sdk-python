...
class PutBearerTokenAuthenticationRequest(TypedDict, closed=True):
    ...
    bearer_token_authentication_enabled: "capo_cloudwatch_logs.types.bearer_token_authentication_enabled.BearerTokenAuthenticationEnabled"
