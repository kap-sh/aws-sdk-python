...
if TYPE_CHECKING:
    import capo_cloudwatch_logs.types.s3_tables_datasource_name
    import capo_cloudwatch_logs.types.s3_tables_datasource_type


class S3TablesIntegration(TypedDict, closed=True):
    datasource_name: NotRequired[
        "capo_cloudwatch_logs.types.s3_tables_datasource_name.S3TablesDatasourceName"
    ]
    """<p>The name of the S3 Tables datasource.</p>"""
    datasource_type: NotRequired[
        "capo_cloudwatch_logs.types.s3_tables_datasource_type.S3TablesDatasourceType"
    ]
