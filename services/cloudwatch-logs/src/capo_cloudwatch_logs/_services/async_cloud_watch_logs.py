...
from capo_cloudwatch_logs._auth._identity import Credentials
...
from capo_cloudwatch_logs._pagination import resolve_path as _resolve_path
from capo_cloudwatch_logs._services._aws_config import aaws_config
...
if TYPE_CHECKING:
    ...
    import capo_cloudwatch_logs.types.aggregate_log_group_summary
    ...
    import capo_cloudwatch_logs.types.create_log_anomaly_detector_request
    import capo_cloudwatch_logs.types.create_log_anomaly_detector_response
    ...
    import capo_cloudwatch_logs.types.create_scheduled_query_request
    import capo_cloudwatch_logs.types.create_scheduled_query_response
    ...
    import capo_cloudwatch_logs.types.delete_delivery_destination_request
    import capo_cloudwatch_logs.types.delete_delivery_request
    import capo_cloudwatch_logs.types.delete_delivery_source_request
    import capo_cloudwatch_logs.types.delete_destination_request
    ...
    import capo_cloudwatch_logs.types.delete_integration_request
    import capo_cloudwatch_logs.types.delete_integration_response
    import capo_cloudwatch_logs.types.delete_log_anomaly_detector_request
    import capo_cloudwatch_logs.types.delete_log_group_request
    import capo_cloudwatch_logs.types.delete_log_stream_request
    import capo_cloudwatch_logs.types.delete_lookup_table_request
    import capo_cloudwatch_logs.types.delete_metric_filter_request
    ...
    import capo_cloudwatch_logs.types.delete_resource_policy_request
    ...
    import capo_cloudwatch_logs.types.describe_account_policies_request
    import capo_cloudwatch_logs.types.describe_account_policies_response
    import capo_cloudwatch_logs.types.describe_configuration_templates_request
    import capo_cloudwatch_logs.types.describe_configuration_templates_response
    ...
    import capo_cloudwatch_logs.types.describe_delivery_destinations_request
    import capo_cloudwatch_logs.types.describe_delivery_destinations_response
    import capo_cloudwatch_logs.types.describe_delivery_sources_request
    import capo_cloudwatch_logs.types.describe_delivery_sources_response
    ...
    import capo_cloudwatch_logs.types.describe_export_tasks_request
    import capo_cloudwatch_logs.types.describe_export_tasks_response
    ...
    import capo_cloudwatch_logs.types.describe_import_task_batches_request
    import capo_cloudwatch_logs.types.describe_import_task_batches_response
    import capo_cloudwatch_logs.types.describe_import_tasks_request
    import capo_cloudwatch_logs.types.describe_import_tasks_response
    ...
    import capo_cloudwatch_logs.types.describe_log_groups_request
    import capo_cloudwatch_logs.types.describe_log_groups_response
    import capo_cloudwatch_logs.types.describe_log_streams_request
    import capo_cloudwatch_logs.types.describe_log_streams_response
    import capo_cloudwatch_logs.types.describe_lookup_tables_max_results
    import capo_cloudwatch_logs.types.describe_lookup_tables_request
    import capo_cloudwatch_logs.types.describe_lookup_tables_response
    import capo_cloudwatch_logs.types.describe_metric_filters_request
    import capo_cloudwatch_logs.types.describe_metric_filters_response
    import capo_cloudwatch_logs.types.describe_queries_max_results
    import capo_cloudwatch_logs.types.describe_queries_request
    import capo_cloudwatch_logs.types.describe_queries_response
    import capo_cloudwatch_logs.types.describe_query_definitions_request
    import capo_cloudwatch_logs.types.describe_query_definitions_response
    ...
    import capo_cloudwatch_logs.types.detector_kms_key_arn
    import capo_cloudwatch_logs.types.detector_name
    import capo_cloudwatch_logs.types.disassociate_kms_key_request
    import capo_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_request
    ...
    import capo_cloudwatch_logs.types.filter_log_events_request
    import capo_cloudwatch_logs.types.filter_log_events_response
    ...
    import capo_cloudwatch_logs.types.force_update
    ...
    import capo_cloudwatch_logs.types.get_delivery_destination_policy_request
    import capo_cloudwatch_logs.types.get_delivery_destination_policy_response
    ...
    import capo_cloudwatch_logs.types.get_integration_request
    import capo_cloudwatch_logs.types.get_integration_response
    ...
    import capo_cloudwatch_logs.types.get_log_events_request
    import capo_cloudwatch_logs.types.get_log_events_response
    import capo_cloudwatch_logs.types.get_log_fields_request
    import capo_cloudwatch_logs.types.get_log_fields_response
    import capo_cloudwatch_logs.types.get_log_group_fields_request
    import capo_cloudwatch_logs.types.get_log_group_fields_response
    ...
    import capo_cloudwatch_logs.types.get_query_results_request
    import capo_cloudwatch_logs.types.get_query_results_response
    import capo_cloudwatch_logs.types.get_scheduled_query_history_max_results
    import capo_cloudwatch_logs.types.get_scheduled_query_history_request
    ...
    import capo_cloudwatch_logs.types.list_anomalies_request
    import capo_cloudwatch_logs.types.list_anomalies_response
    import capo_cloudwatch_logs.types.list_integrations_request
    import capo_cloudwatch_logs.types.list_integrations_response
    import capo_cloudwatch_logs.types.list_limit
    import capo_cloudwatch_logs.types.list_log_anomaly_detectors_limit
    import capo_cloudwatch_logs.types.list_log_anomaly_detectors_request
    import capo_cloudwatch_logs.types.list_log_anomaly_detectors_response
    import capo_cloudwatch_logs.types.list_log_groups_for_query_max_results
    import capo_cloudwatch_logs.types.list_log_groups_for_query_request
    import capo_cloudwatch_logs.types.list_log_groups_for_query_response
    ...
    import capo_cloudwatch_logs.types.list_tags_log_group_response
    ...
    import capo_cloudwatch_logs.types.log_record_pointer
    ...
    import capo_cloudwatch_logs.types.put_bearer_token_authentication_request
    ...
    import capo_cloudwatch_logs.types.put_delivery_destination_policy_request
    import capo_cloudwatch_logs.types.put_delivery_destination_policy_response
    import capo_cloudwatch_logs.types.put_delivery_destination_request
    import capo_cloudwatch_logs.types.put_delivery_destination_response
    import capo_cloudwatch_logs.types.put_delivery_source_request
    import capo_cloudwatch_logs.types.put_delivery_source_response
    ...
    import capo_cloudwatch_logs.types.put_log_group_deletion_protection_request
    import capo_cloudwatch_logs.types.put_metric_filter_request
    ...
    import capo_cloudwatch_logs.types.start_live_tail_request
    import capo_cloudwatch_logs.types.start_live_tail_response
    import capo_cloudwatch_logs.types.start_query_request
    import capo_cloudwatch_logs.types.start_query_response
    ...
    import capo_cloudwatch_logs.types.test_metric_filter_request
    import capo_cloudwatch_logs.types.test_metric_filter_response
    import capo_cloudwatch_logs.types.test_transformer_request
    import capo_cloudwatch_logs.types.test_transformer_response
    ...
    import capo_cloudwatch_logs.types.update_log_anomaly_detector_request
...
class AsyncCloudWatchLogsClient:
    ...
    async def associate_kms_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.associate_kms_key_request.AssociateKmsKeyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.associate_kms_key

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.associate_kms_key.async_associate_kms_key(
    ...
    async def associate_source_to_s3_table_integration(
        ...
        *,
        ...
        Raises:
            ...
            capo_cloudwatch_logs.errors.validation_exception.ValidationException: <p>One of the parameters for the request is not valid.</p>
            capo_cloudwatch_logs.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.associate_source_to_s3_table_integration_request.AssociateSourceToS3TableIntegrationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.associate_source_to_s3_table_integration_response.AssociateSourceToS3TableIntegrationResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.associate_source_to_s3_table_integration

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.associate_source_to_s3_table_integration.async_associate_source_to_s3_table_integration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_export_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.cancel_export_task_request.CancelExportTaskRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.cancel_export_task

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.cancel_export_task.async_cancel_export_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_import_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.cancel_import_task_request.CancelImportTaskRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.cancel_import_task_response.CancelImportTaskResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.cancel_import_task

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.cancel_import_task.async_cancel_import_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_delivery(
        self,
        delivery_source_name: "capo_cloudwatch_logs.types.delivery_source_name.DeliverySourceName",
        ...
        *,
        ...
        Raises:
            ...
            capo_cloudwatch_logs.errors.resource_not_found_exception.ResourceNotFoundException: <p>The specified resource does not exist.</p>
            capo_cloudwatch_logs.errors.service_quota_exceeded_exception.ServiceQuotaExceededException: <p>This request exceeds a service quota.</p>
            capo_cloudwatch_logs.errors.service_unavailable_exception.ServiceUnavailableException: <p>The service cannot complete the request.</p>
            capo_cloudwatch_logs.errors.throttling_exception.ThrottlingException: <p>The request was throttled because of quota limits.</p>
            capo_cloudwatch_logs.errors.validation_exception.ValidationException: <p>One of the parameters for the request is not valid.</p>
            capo_cloudwatch_logs.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.create_delivery_request.CreateDeliveryRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.create_delivery_response.CreateDeliveryResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.create_delivery

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.create_delivery.async_create_delivery(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_export_task(
        ...
        from_: "capo_cloudwatch_logs.types.timestamp.Timestamp",
        ...
        *,
        ...
        Raises:
            capo_cloudwatch_logs.errors.invalid_parameter_exception.InvalidParameterException: <p>A parameter is specified incorrectly.</p>
            capo_cloudwatch_logs.errors.limit_exceeded_exception.LimitExceededException: <p>You have reached the maximum number of resources that can be created.</p>
            capo_cloudwatch_logs.errors.operation_aborted_exception.OperationAbortedException: <p>Multiple concurrent requests to update the same resource were in conflict.</p>
            capo_cloudwatch_logs.errors.resource_already_exists_exception.ResourceAlreadyExistsException: <p>The specified resource already exists.</p>
            capo_cloudwatch_logs.errors.resource_not_found_exception.ResourceNotFoundException: <p>The specified resource does not exist.</p>
            capo_cloudwatch_logs.errors.service_unavailable_exception.ServiceUnavailableException: <p>The service cannot complete the request.</p>
            capo_cloudwatch_logs.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.create_export_task_request.CreateExportTaskRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.create_export_task_response.CreateExportTaskResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.create_export_task

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.create_export_task.async_create_export_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_import_task(
        ...
        *,
        ...
        import_filter: Optional[
            "capo_cloudwatch_logs.types.import_filter.ImportFilter"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.create_import_task_request.CreateImportTaskRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.create_import_task_response.CreateImportTaskResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.create_import_task

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.create_import_task.async_create_import_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_log_anomaly_detector(
        ...
        *,
        ...
        detector_name: Optional[
            "capo_cloudwatch_logs.types.detector_name.DetectorName"
        ] = None,
        ...
        kms_key_id: Optional[
            "capo_cloudwatch_logs.types.detector_kms_key_arn.DetectorKmsKeyArn"
        ] = None,
        anomaly_visibility_time: Optional[
            "capo_cloudwatch_logs.types.anomaly_visibility_time.AnomalyVisibilityTime"
        ] = None,
        tags: Optional["capo_cloudwatch_logs.types.tags.Tags"] = None,
    ) -> "capo_cloudwatch_logs.types.create_log_anomaly_detector_response.CreateLogAnomalyDetectorResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.create_log_anomaly_detector_request.CreateLogAnomalyDetectorRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.create_log_anomaly_detector_response.CreateLogAnomalyDetectorResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.create_log_anomaly_detector

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.create_log_anomaly_detector.async_create_log_anomaly_detector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_log_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.create_log_group_request.CreateLogGroupRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.create_log_group

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.create_log_group.async_create_log_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_log_stream(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.create_log_stream_request.CreateLogStreamRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.create_log_stream

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.create_log_stream.async_create_log_stream(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_lookup_table(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.create_lookup_table_request.CreateLookupTableRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.create_lookup_table_response.CreateLookupTableResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.create_lookup_table

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.create_lookup_table.async_create_lookup_table(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_scheduled_query(
        ...
        schedule_expression: "capo_cloudwatch_logs.types.schedule_expression.ScheduleExpression",
        ...
        *,
        ...
        schedule_start_time: Optional[
            "capo_cloudwatch_logs.types.timestamp.Timestamp"
        ] = None,
        ...
        tags: Optional["capo_cloudwatch_logs.types.tags.Tags"] = None,
    ) -> "capo_cloudwatch_logs.types.create_scheduled_query_response.CreateScheduledQueryResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.create_scheduled_query_request.CreateScheduledQueryRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.create_scheduled_query_response.CreateScheduledQueryResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.create_scheduled_query

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.create_scheduled_query.async_create_scheduled_query(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_account_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_account_policy_request.DeleteAccountPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_account_policy

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_account_policy.async_delete_account_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_data_protection_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_data_protection_policy_request.DeleteDataProtectionPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_data_protection_policy

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_data_protection_policy.async_delete_data_protection_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_delivery(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_delivery_request.DeleteDeliveryRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_delivery

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_delivery.async_delete_delivery(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_delivery_destination(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_delivery_destination_request.DeleteDeliveryDestinationRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_delivery_destination

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_delivery_destination.async_delete_delivery_destination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_delivery_destination_policy(
        self,
        delivery_destination_name: "capo_cloudwatch_logs.types.delivery_destination_name.DeliveryDestinationName",
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_delivery_destination_policy_request.DeleteDeliveryDestinationPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_delivery_destination_policy

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_delivery_destination_policy.async_delete_delivery_destination_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_delivery_source(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_delivery_source_request.DeleteDeliverySourceRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_delivery_source

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_delivery_source.async_delete_delivery_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_destination(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_destination_request.DeleteDestinationRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_destination

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_destination.async_delete_destination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_index_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_index_policy_request.DeleteIndexPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.delete_index_policy_response.DeleteIndexPolicyResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_index_policy

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_index_policy.async_delete_index_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_integration(
        ...
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
        force: Optional["capo_cloudwatch_logs.types.force.Force"] = None,
    ) -> "capo_cloudwatch_logs.types.delete_integration_response.DeleteIntegrationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_integration_request.DeleteIntegrationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.delete_integration_response.DeleteIntegrationResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_integration

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_integration.async_delete_integration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_log_anomaly_detector(
        self,
        anomaly_detector_arn: "capo_cloudwatch_logs.types.anomaly_detector_arn.AnomalyDetectorArn",
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_log_anomaly_detector_request.DeleteLogAnomalyDetectorRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_log_anomaly_detector

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_log_anomaly_detector.async_delete_log_anomaly_detector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_log_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_log_group_request.DeleteLogGroupRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_log_group

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_log_group.async_delete_log_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_log_stream(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_log_stream_request.DeleteLogStreamRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_log_stream

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_log_stream.async_delete_log_stream(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_lookup_table(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_lookup_table_request.DeleteLookupTableRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_lookup_table

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_lookup_table.async_delete_lookup_table(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_metric_filter(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_metric_filter_request.DeleteMetricFilterRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_metric_filter

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_metric_filter.async_delete_metric_filter(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_query_definition(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_query_definition_request.DeleteQueryDefinitionRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.delete_query_definition_response.DeleteQueryDefinitionResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_query_definition

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_query_definition.async_delete_query_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_resource_policy(
        ...
        *,
        ...
        policy_name: Optional[
            "capo_cloudwatch_logs.types.policy_name.PolicyName"
        ] = None,
        resource_arn: Optional["capo_cloudwatch_logs.types.arn.Arn"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_resource_policy_request.DeleteResourcePolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_resource_policy

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_resource_policy.async_delete_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_retention_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_retention_policy_request.DeleteRetentionPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_retention_policy

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_retention_policy.async_delete_retention_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_scheduled_query(
        self,
        identifier: "capo_cloudwatch_logs.types.scheduled_query_identifier.ScheduledQueryIdentifier",
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_scheduled_query_request.DeleteScheduledQueryRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.delete_scheduled_query_response.DeleteScheduledQueryResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_scheduled_query

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_scheduled_query.async_delete_scheduled_query(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_subscription_filter(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_subscription_filter_request.DeleteSubscriptionFilterRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_subscription_filter

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_subscription_filter.async_delete_subscription_filter(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_transformer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.delete_transformer_request.DeleteTransformerRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.delete_transformer

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.delete_transformer.async_delete_transformer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_policies(
        ...
        *,
    ...
    ) -> "capo_cloudwatch_logs.types.describe_account_policies_response.DescribeAccountPoliciesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_account_policies_request.DescribeAccountPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_account_policies_response.DescribeAccountPoliciesResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_account_policies

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_account_policies.async_describe_account_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_configuration_templates(
        ...
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
        service: Optional["capo_cloudwatch_logs.types.service.Service"] = None,
        log_types: Optional["capo_cloudwatch_logs.types.log_types.LogTypes"] = None,
        ...
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
        limit: Optional[
            "capo_cloudwatch_logs.types.describe_limit.DescribeLimit"
        ] = None,
    ) -> "capo_cloudwatch_logs.types.describe_configuration_templates_response.DescribeConfigurationTemplatesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_configuration_templates_request.DescribeConfigurationTemplatesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_configuration_templates_response.DescribeConfigurationTemplatesResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_configuration_templates

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_configuration_templates.async_describe_configuration_templates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.configuration_template.ConfigurationTemplate]":
        _token = next_token
        while True:
    ...
    async def describe_deliveries(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_deliveries_request.DescribeDeliveriesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_deliveries_response.DescribeDeliveriesResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_deliveries

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_deliveries.async_describe_deliveries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.delivery.Delivery]":
        _token = next_token
        while True:
    ...
    async def describe_delivery_destinations(
        ...
        *,
    ...
    ) -> "capo_cloudwatch_logs.types.describe_delivery_destinations_response.DescribeDeliveryDestinationsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_delivery_destinations_request.DescribeDeliveryDestinationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_delivery_destinations_response.DescribeDeliveryDestinationsResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_delivery_destinations

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_delivery_destinations.async_describe_delivery_destinations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.delivery_destination.DeliveryDestination]":
        _token = next_token
        while True:
    ...
    async def describe_delivery_sources(
        ...
        *,
    ...
    ) -> "capo_cloudwatch_logs.types.describe_delivery_sources_response.DescribeDeliverySourcesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_delivery_sources_request.DescribeDeliverySourcesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_delivery_sources_response.DescribeDeliverySourcesResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_delivery_sources

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_delivery_sources.async_describe_delivery_sources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.delivery_source.DeliverySource]":
        _token = next_token
        while True:
    ...
    async def describe_destinations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_destinations_request.DescribeDestinationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_destinations_response.DescribeDestinationsResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_destinations

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_destinations.async_describe_destinations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.destination.Destination]":
        _token = next_token
        while True:
    ...
    async def describe_export_tasks(
        ...
        *,
    ...
    ) -> "capo_cloudwatch_logs.types.describe_export_tasks_response.DescribeExportTasksResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_export_tasks_request.DescribeExportTasksRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_export_tasks_response.DescribeExportTasksResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_export_tasks

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_export_tasks.async_describe_export_tasks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_field_indexes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_field_indexes_request.DescribeFieldIndexesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_field_indexes_response.DescribeFieldIndexesResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_field_indexes

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_field_indexes.async_describe_field_indexes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_import_task_batches(
        ...
        *,
        ...
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
    ) -> "capo_cloudwatch_logs.types.describe_import_task_batches_response.DescribeImportTaskBatchesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_import_task_batches_request.DescribeImportTaskBatchesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_import_task_batches_response.DescribeImportTaskBatchesResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_import_task_batches

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_import_task_batches.async_describe_import_task_batches(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_import_tasks(
        ...
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
        import_id: Optional["capo_cloudwatch_logs.types.import_id.ImportId"] = None,
        import_status: Optional[
            "capo_cloudwatch_logs.types.import_status.ImportStatus"
        ] = None,
        import_source_arn: Optional["capo_cloudwatch_logs.types.arn.Arn"] = None,
        limit: Optional[
            "capo_cloudwatch_logs.types.describe_limit.DescribeLimit"
        ] = None,
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
    ) -> "capo_cloudwatch_logs.types.describe_import_tasks_response.DescribeImportTasksResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_import_tasks_request.DescribeImportTasksRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_import_tasks_response.DescribeImportTasksResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_import_tasks

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_import_tasks.async_describe_import_tasks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_index_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_index_policies_request.DescribeIndexPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_index_policies_response.DescribeIndexPoliciesResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_index_policies

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_index_policies.async_describe_index_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_log_groups(
        ...
        *,
    ...
    ) -> "capo_cloudwatch_logs.types.describe_log_groups_response.DescribeLogGroupsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_log_groups_request.DescribeLogGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_log_groups_response.DescribeLogGroupsResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_log_groups

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_log_groups.async_describe_log_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.log_group.LogGroup]":
        _token = next_token
        while True:
    ...
    async def describe_log_streams(
        ...
        *,
        ...
        order_by: Optional["capo_cloudwatch_logs.types.order_by.OrderBy"] = None,
        descending: Optional["capo_cloudwatch_logs.types.descending.Descending"] = None,
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
        limit: Optional[
            "capo_cloudwatch_logs.types.describe_limit.DescribeLimit"
        ] = None,
    ) -> "capo_cloudwatch_logs.types.describe_log_streams_response.DescribeLogStreamsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_log_streams_request.DescribeLogStreamsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_log_streams_response.DescribeLogStreamsResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_log_streams

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_log_streams.async_describe_log_streams(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.log_stream.LogStream]":
        _token = next_token
        while True:
    ...
    async def describe_lookup_tables(
        ...
        *,
        ...
        max_results: Optional[
            "capo_cloudwatch_logs.types.describe_lookup_tables_max_results.DescribeLookupTablesMaxResults"
        ] = None,
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
    ) -> "capo_cloudwatch_logs.types.describe_lookup_tables_response.DescribeLookupTablesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_lookup_tables_request.DescribeLookupTablesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_lookup_tables_response.DescribeLookupTablesResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_lookup_tables

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_lookup_tables.async_describe_lookup_tables(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_metric_filters(
        ...
        *,
        ...
        filter_name_prefix: Optional[
            "capo_cloudwatch_logs.types.filter_name.FilterName"
        ] = None,
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
        limit: Optional[
            "capo_cloudwatch_logs.types.describe_limit.DescribeLimit"
        ...
        metric_name: Optional[
            "capo_cloudwatch_logs.types.metric_name.MetricName"
        ] = None,
        metric_namespace: Optional[
            "capo_cloudwatch_logs.types.metric_namespace.MetricNamespace"
        ] = None,
    ) -> "capo_cloudwatch_logs.types.describe_metric_filters_response.DescribeMetricFiltersResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_metric_filters_request.DescribeMetricFiltersRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_metric_filters_response.DescribeMetricFiltersResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_metric_filters

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_metric_filters.async_describe_metric_filters(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.metric_filter.MetricFilter]":
        _token = next_token
        while True:
    ...
    async def describe_queries(
        ...
        *,
        ...
        status: Optional["capo_cloudwatch_logs.types.query_status.QueryStatus"] = None,
        max_results: Optional[
            "capo_cloudwatch_logs.types.describe_queries_max_results.DescribeQueriesMaxResults"
        ] = None,
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_queries_request.DescribeQueriesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_queries_response.DescribeQueriesResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_queries

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_queries.async_describe_queries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_query_definitions(
        ...
        *,
        ...
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
    ) -> "capo_cloudwatch_logs.types.describe_query_definitions_response.DescribeQueryDefinitionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_query_definitions_request.DescribeQueryDefinitionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_query_definitions_response.DescribeQueryDefinitionsResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_query_definitions

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_query_definitions.async_describe_query_definitions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_resource_policies(
        ...
        *,
        ...
        policy_scope: Optional[
            "capo_cloudwatch_logs.types.policy_scope.PolicyScope"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_resource_policies_request.DescribeResourcePoliciesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_resource_policies_response.DescribeResourcePoliciesResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_resource_policies

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_resource_policies.async_describe_resource_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_subscription_filters(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.describe_subscription_filters_request.DescribeSubscriptionFiltersRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.describe_subscription_filters_response.DescribeSubscriptionFiltersResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.describe_subscription_filters

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.describe_subscription_filters.async_describe_subscription_filters(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.subscription_filter.SubscriptionFilter]":
        _token = next_token
        while True:
    ...
    async def disassociate_kms_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.disassociate_kms_key_request.DisassociateKmsKeyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.disassociate_kms_key

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.disassociate_kms_key.async_disassociate_kms_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_source_from_s3_table_integration(
        ...
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
    ) -> "capo_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_response.DisassociateSourceFromS3TableIntegrationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_request.DisassociateSourceFromS3TableIntegrationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.disassociate_source_from_s3_table_integration_response.DisassociateSourceFromS3TableIntegrationResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.disassociate_source_from_s3_table_integration

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.disassociate_source_from_s3_table_integration.async_disassociate_source_from_s3_table_integration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def filter_log_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.filter_log_events_request.FilterLogEventsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.filter_log_events_response.FilterLogEventsResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.filter_log_events

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.filter_log_events.async_filter_log_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_data_protection_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_data_protection_policy_request.GetDataProtectionPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_data_protection_policy_response.GetDataProtectionPolicyResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_data_protection_policy

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_data_protection_policy.async_get_data_protection_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_delivery(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_delivery_request.GetDeliveryRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_delivery_response.GetDeliveryResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_delivery

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_delivery.async_get_delivery(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_delivery_destination(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_delivery_destination_request.GetDeliveryDestinationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_delivery_destination_response.GetDeliveryDestinationResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_delivery_destination

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_delivery_destination.async_get_delivery_destination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_delivery_destination_policy(
        ...
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
    ) -> "capo_cloudwatch_logs.types.get_delivery_destination_policy_response.GetDeliveryDestinationPolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_delivery_destination_policy_request.GetDeliveryDestinationPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_delivery_destination_policy_response.GetDeliveryDestinationPolicyResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_delivery_destination_policy

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_delivery_destination_policy.async_get_delivery_destination_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_delivery_source(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_delivery_source_request.GetDeliverySourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_delivery_source_response.GetDeliverySourceResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_delivery_source

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_delivery_source.async_get_delivery_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_integration(
        ...
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
    ) -> "capo_cloudwatch_logs.types.get_integration_response.GetIntegrationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_integration_request.GetIntegrationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_integration_response.GetIntegrationResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_integration

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_integration.async_get_integration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_log_anomaly_detector(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_log_anomaly_detector_request.GetLogAnomalyDetectorRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_log_anomaly_detector_response.GetLogAnomalyDetectorResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_log_anomaly_detector

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_log_anomaly_detector.async_get_log_anomaly_detector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_log_events(
        ...
        *,
        ...
        unmask: Optional["capo_cloudwatch_logs.types.unmask.Unmask"] = None,
    ) -> "capo_cloudwatch_logs.types.get_log_events_response.GetLogEventsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_log_events_request.GetLogEventsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_log_events_response.GetLogEventsResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_log_events

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_log_events.async_get_log_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_log_events(
        ...
        *,
        ...
        unmask: Optional["capo_cloudwatch_logs.types.unmask.Unmask"] = None,
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.output_log_event.OutputLogEvent]":
        _token = next_token
        while True:
    ...
    async def get_log_fields(
        ...
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
    ) -> "capo_cloudwatch_logs.types.get_log_fields_response.GetLogFieldsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_log_fields_request.GetLogFieldsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_log_fields_response.GetLogFieldsResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_log_fields

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_log_fields.async_get_log_fields(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_log_group_fields(
        ...
        *,
        ...
        time: Optional["capo_cloudwatch_logs.types.timestamp.Timestamp"] = None,
        log_group_identifier: Optional[
            "capo_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier"
        ] = None,
    ) -> "capo_cloudwatch_logs.types.get_log_group_fields_response.GetLogGroupFieldsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_log_group_fields_request.GetLogGroupFieldsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_log_group_fields_response.GetLogGroupFieldsResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_log_group_fields

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_log_group_fields.async_get_log_group_fields(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_log_object(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_log_object_request.GetLogObjectRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_log_object_response.GetLogObjectResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_log_object

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_log_object.async_get_log_object(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_log_record(
        self,
        log_record_pointer: "capo_cloudwatch_logs.types.log_record_pointer.LogRecordPointer",
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
        unmask: Optional["capo_cloudwatch_logs.types.unmask.Unmask"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_log_record_request.GetLogRecordRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_log_record_response.GetLogRecordResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_log_record

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_log_record.async_get_log_record(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_lookup_table(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_lookup_table_request.GetLookupTableRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_lookup_table_response.GetLookupTableResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_lookup_table

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_lookup_table.async_get_lookup_table(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_query_results(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_query_results_request.GetQueryResultsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_query_results_response.GetQueryResultsResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_query_results

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_query_results.async_get_query_results(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_scheduled_query(
        ...
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
    ) -> "capo_cloudwatch_logs.types.get_scheduled_query_response.GetScheduledQueryResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_scheduled_query_request.GetScheduledQueryRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_scheduled_query_response.GetScheduledQueryResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_scheduled_query

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_scheduled_query.async_get_scheduled_query(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_scheduled_query_history(
        ...
        *,
        ...
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
    ) -> "capo_cloudwatch_logs.types.get_scheduled_query_history_response.GetScheduledQueryHistoryResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_scheduled_query_history_request.GetScheduledQueryHistoryRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_scheduled_query_history_response.GetScheduledQueryHistoryResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_scheduled_query_history

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_scheduled_query_history.async_get_scheduled_query_history(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_scheduled_query_history(
        ...
        *,
        ...
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.trigger_history_record.TriggerHistoryRecord]":
        _token = next_token
        while True:
    ...
    async def get_transformer(
        ...
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
    ) -> "capo_cloudwatch_logs.types.get_transformer_response.GetTransformerResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.get_transformer_request.GetTransformerRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.get_transformer_response.GetTransformerResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.get_transformer

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.get_transformer.async_get_transformer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_aggregate_log_group_summaries(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.list_aggregate_log_group_summaries_request.ListAggregateLogGroupSummariesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.list_aggregate_log_group_summaries_response.ListAggregateLogGroupSummariesResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.list_aggregate_log_group_summaries

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.list_aggregate_log_group_summaries.async_list_aggregate_log_group_summaries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.aggregate_log_group_summary.AggregateLogGroupSummary]":
        _token = next_token
        while True:
    ...
    async def list_anomalies(
        ...
        *,
        ...
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
    ) -> "capo_cloudwatch_logs.types.list_anomalies_response.ListAnomaliesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.list_anomalies_request.ListAnomaliesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.list_anomalies_response.ListAnomaliesResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.list_anomalies

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.list_anomalies.async_list_anomalies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_anomalies(
        ...
        *,
        ...
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.anomaly.Anomaly]":
        _token = next_token
        while True:
    ...
    async def list_integrations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.list_integrations_request.ListIntegrationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.list_integrations_response.ListIntegrationsResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.list_integrations

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.list_integrations.async_list_integrations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_log_anomaly_detectors(
        ...
        *,
        ...
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
    ) -> "capo_cloudwatch_logs.types.list_log_anomaly_detectors_response.ListLogAnomalyDetectorsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.list_log_anomaly_detectors_request.ListLogAnomalyDetectorsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.list_log_anomaly_detectors_response.ListLogAnomalyDetectorsResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.list_log_anomaly_detectors

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.list_log_anomaly_detectors.async_list_log_anomaly_detectors(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_log_anomaly_detectors(
        ...
        *,
        ...
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.anomaly_detector.AnomalyDetector]":
        _token = next_token
        while True:
    ...
    async def list_log_groups(
        ...
        *,
        ...
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
        limit: Optional["capo_cloudwatch_logs.types.list_limit.ListLimit"] = None,
        data_sources: Optional[
            "capo_cloudwatch_logs.types.data_source_filters.DataSourceFilters"
        ] = None,
        field_index_names: Optional[
            "capo_cloudwatch_logs.types.field_index_names.FieldIndexNames"
        ] = None,
        log_group_tags: Optional[
            "capo_cloudwatch_logs.types.tag_filters.TagFilters"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.list_log_groups_request.ListLogGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.list_log_groups_response.ListLogGroupsResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.list_log_groups

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.list_log_groups.async_list_log_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_log_groups_for_query(
        ...
        *,
    ...
    ) -> "capo_cloudwatch_logs.types.list_log_groups_for_query_response.ListLogGroupsForQueryResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.list_log_groups_for_query_request.ListLogGroupsForQueryRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.list_log_groups_for_query_response.ListLogGroupsForQueryResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.list_log_groups_for_query

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.list_log_groups_for_query.async_list_log_groups_for_query(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.log_group_identifier.LogGroupIdentifier]":
        _token = next_token
        while True:
    ...
    async def list_scheduled_queries(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.list_scheduled_queries_request.ListScheduledQueriesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.list_scheduled_queries_response.ListScheduledQueriesResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.list_scheduled_queries

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.list_scheduled_queries.async_list_scheduled_queries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_sources_for_s3_table_integration(
        ...
        *,
        ...
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
    ) -> "capo_cloudwatch_logs.types.list_sources_for_s3_table_integration_response.ListSourcesForS3TableIntegrationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.list_sources_for_s3_table_integration_request.ListSourcesForS3TableIntegrationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.list_sources_for_s3_table_integration_response.ListSourcesForS3TableIntegrationResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.list_sources_for_s3_table_integration

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.list_sources_for_s3_table_integration.async_list_sources_for_s3_table_integration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_sources_for_s3_table_integration(
        ...
        *,
        ...
        next_token: Optional["capo_cloudwatch_logs.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_cloudwatch_logs.types.s3_table_integration_source.S3TableIntegrationSource]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.list_tags_for_resource

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_log_group(
        ...
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
    ) -> "capo_cloudwatch_logs.types.list_tags_log_group_response.ListTagsLogGroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.list_tags_log_group_request.ListTagsLogGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.list_tags_log_group_response.ListTagsLogGroupResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.list_tags_log_group

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.list_tags_log_group.async_list_tags_log_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_account_policy(
        self,
        policy_name: "capo_cloudwatch_logs.types.policy_name.PolicyName",
        policy_document: "capo_cloudwatch_logs.types.account_policy_document.AccountPolicyDocument",
        policy_type: "capo_cloudwatch_logs.types.policy_type.PolicyType",
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
        scope: Optional["capo_cloudwatch_logs.types.scope.Scope"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_account_policy_request.PutAccountPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.put_account_policy_response.PutAccountPolicyResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_account_policy

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_account_policy.async_put_account_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_bearer_token_authentication(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_bearer_token_authentication_request.PutBearerTokenAuthenticationRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_bearer_token_authentication

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_bearer_token_authentication.async_put_bearer_token_authentication(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_data_protection_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_data_protection_policy_request.PutDataProtectionPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.put_data_protection_policy_response.PutDataProtectionPolicyResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_data_protection_policy

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_data_protection_policy.async_put_data_protection_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_delivery_destination(
        ...
        *,
        ...
        output_format: Optional[
            "capo_cloudwatch_logs.types.output_format.OutputFormat"
        ] = None,
        ...
        tags: Optional["capo_cloudwatch_logs.types.tags.Tags"] = None,
    ) -> "capo_cloudwatch_logs.types.put_delivery_destination_response.PutDeliveryDestinationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_delivery_destination_request.PutDeliveryDestinationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.put_delivery_destination_response.PutDeliveryDestinationResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_delivery_destination

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_delivery_destination.async_put_delivery_destination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_delivery_destination_policy(
        ...
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
    ) -> "capo_cloudwatch_logs.types.put_delivery_destination_policy_response.PutDeliveryDestinationPolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_delivery_destination_policy_request.PutDeliveryDestinationPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.put_delivery_destination_policy_response.PutDeliveryDestinationPolicyResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_delivery_destination_policy

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_delivery_destination_policy.async_put_delivery_destination_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_delivery_source(
        ...
        *,
    ...
    ) -> "capo_cloudwatch_logs.types.put_delivery_source_response.PutDeliverySourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_delivery_source_request.PutDeliverySourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.put_delivery_source_response.PutDeliverySourceResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_delivery_source

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_delivery_source.async_put_delivery_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_destination(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_destination_request.PutDestinationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.put_destination_response.PutDestinationResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_destination

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_destination.async_put_destination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_destination_policy(
        self,
        destination_name: "capo_cloudwatch_logs.types.destination_name.DestinationName",
        access_policy: "capo_cloudwatch_logs.types.access_policy.AccessPolicy",
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
        force_update: Optional[
            "capo_cloudwatch_logs.types.force_update.ForceUpdate"
        ] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_destination_policy_request.PutDestinationPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_destination_policy

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_destination_policy.async_put_destination_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_index_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_index_policy_request.PutIndexPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.put_index_policy_response.PutIndexPolicyResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_index_policy

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_index_policy.async_put_index_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_integration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_integration_request.PutIntegrationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.put_integration_response.PutIntegrationResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_integration

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_integration.async_put_integration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_log_events(
        ...
        log_group_name: "capo_cloudwatch_logs.types.log_group_name.LogGroupName",
        log_stream_name: "capo_cloudwatch_logs.types.log_stream_name.LogStreamName",
        log_events: "capo_cloudwatch_logs.types.input_log_events.InputLogEvents",
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
        sequence_token: Optional[
            "capo_cloudwatch_logs.types.sequence_token.SequenceToken"
        ] = None,
        entity: Optional["capo_cloudwatch_logs.types.entity.Entity"] = None,
        ...
        Raises:
            capo_cloudwatch_logs.errors.data_already_accepted_exception.DataAlreadyAcceptedException: <p>The event was already logged.</p> <important> <p> <code>PutLogEvents</code> actions are now always accepted and never return <code>DataAlreadyAcceptedException</code> regardless of whether a given batch of log events has already been accepted. </p> </important>
            capo_cloudwatch_logs.errors.invalid_parameter_exception.InvalidParameterException: <p>A parameter is specified incorrectly.</p>
            capo_cloudwatch_logs.errors.invalid_sequence_token_exception.InvalidSequenceTokenException: <p>The sequence token is not valid. You can get the correct sequence token in the <code>expectedSequenceToken</code> field in the <code>InvalidSequenceTokenException</code> message. </p> <important> <p> <code>PutLogEvents</code> actions are now always accepted and never return <code>InvalidSequenceTokenException</code> regardless of receiving an invalid sequence token. </p> </important>
            capo_cloudwatch_logs.errors.resource_not_found_exception.ResourceNotFoundException: <p>The specified resource does not exist.</p>
            capo_cloudwatch_logs.errors.service_unavailable_exception.ServiceUnavailableException: <p>The service cannot complete the request.</p>
            capo_cloudwatch_logs.errors.unrecognized_client_exception.UnrecognizedClientException: <p>The most likely cause is an Amazon Web Services access key ID or secret key that's not valid.</p>
            capo_cloudwatch_logs.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_log_events_request.PutLogEventsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.put_log_events_response.PutLogEventsResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_log_events

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_log_events.async_put_log_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_log_group_deletion_protection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_log_group_deletion_protection_request.PutLogGroupDeletionProtectionRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_log_group_deletion_protection

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_log_group_deletion_protection.async_put_log_group_deletion_protection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_metric_filter(
        ...
        metric_transformations: "capo_cloudwatch_logs.types.metric_transformations.MetricTransformations",
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_metric_filter_request.PutMetricFilterRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_metric_filter

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_metric_filter.async_put_metric_filter(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_query_definition(
        ...
        query_string: "capo_cloudwatch_logs.types.query_definition_string.QueryDefinitionString",
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
        query_language: Optional[
            "capo_cloudwatch_logs.types.query_language.QueryLanguage"
        ...
        query_definition_id: Optional[
            "capo_cloudwatch_logs.types.query_id.QueryId"
        ] = None,
        log_group_names: Optional[
            "capo_cloudwatch_logs.types.log_group_names.LogGroupNames"
        ] = None,
        client_token: Optional[
            "capo_cloudwatch_logs.types.client_token.ClientToken"
        ] = None,
        parameters: Optional[
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_query_definition_request.PutQueryDefinitionRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.put_query_definition_response.PutQueryDefinitionResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_query_definition

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_query_definition.async_put_query_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_resource_policy(
        ...
        *,
    ...
    ) -> "capo_cloudwatch_logs.types.put_resource_policy_response.PutResourcePolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_resource_policy_request.PutResourcePolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.put_resource_policy_response.PutResourcePolicyResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_resource_policy

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_resource_policy.async_put_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_retention_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_retention_policy_request.PutRetentionPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_retention_policy

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_retention_policy.async_put_retention_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_subscription_filter(
        ...
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
        role_arn: Optional["capo_cloudwatch_logs.types.role_arn.RoleArn"] = None,
        distribution: Optional[
            "capo_cloudwatch_logs.types.distribution.Distribution"
        ] = None,
        apply_on_transformed_logs: Optional[
            "capo_cloudwatch_logs.types.apply_on_transformed_logs.ApplyOnTransformedLogs"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_subscription_filter_request.PutSubscriptionFilterRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_subscription_filter

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_subscription_filter.async_put_subscription_filter(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_transformer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.put_transformer_request.PutTransformerRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.put_transformer

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.put_transformer.async_put_transformer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_live_tail(
        ...
        *,
    ...
    ) -> "capo_cloudwatch_logs.types.start_live_tail_response.StartLiveTailResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.start_live_tail_request.StartLiveTailRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.start_live_tail_response.StartLiveTailResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.start_live_tail

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.start_live_tail.async_start_live_tail(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_query(
        ...
        *,
    ...
    ) -> "capo_cloudwatch_logs.types.start_query_response.StartQueryResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.start_query_request.StartQueryRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.start_query_response.StartQueryResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.start_query

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.start_query.async_start_query(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_query(
        ...
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
    ) -> "capo_cloudwatch_logs.types.stop_query_response.StopQueryResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.stop_query_request.StopQueryRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.stop_query_response.StopQueryResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.stop_query

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.stop_query.async_stop_query(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_log_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.tag_log_group_request.TagLogGroupRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.tag_log_group

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.tag_log_group.async_tag_log_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        Raises:
            ...
            capo_cloudwatch_logs.errors.resource_not_found_exception.ResourceNotFoundException: <p>The specified resource does not exist.</p>
            capo_cloudwatch_logs.errors.service_unavailable_exception.ServiceUnavailableException: <p>The service cannot complete the request.</p>
            capo_cloudwatch_logs.errors.too_many_tags_exception.TooManyTagsException: <p>A resource can have no more than 50 tags.</p>
            capo_cloudwatch_logs.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.tag_resource

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def test_metric_filter(
        self,
        filter_pattern: "capo_cloudwatch_logs.types.filter_pattern.FilterPattern",
        log_event_messages: "capo_cloudwatch_logs.types.test_event_messages.TestEventMessages",
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
    ) -> "capo_cloudwatch_logs.types.test_metric_filter_response.TestMetricFilterResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.test_metric_filter_request.TestMetricFilterRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.test_metric_filter_response.TestMetricFilterResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.test_metric_filter

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.test_metric_filter.async_test_metric_filter(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def test_transformer(
        ...
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
    ) -> "capo_cloudwatch_logs.types.test_transformer_response.TestTransformerResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.test_transformer_request.TestTransformerRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.test_transformer_response.TestTransformerResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.test_transformer

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.test_transformer.async_test_transformer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_log_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.untag_log_group_request.UntagLogGroupRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.untag_log_group

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.untag_log_group.async_untag_log_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.untag_resource

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_anomaly(
        ...
        *,
        config_overrides: Optional[AsyncCloudWatchLogsClientConfig] = None,
        anomaly_id: Optional["capo_cloudwatch_logs.types.anomaly_id.AnomalyId"] = None,
        pattern_id: Optional["capo_cloudwatch_logs.types.pattern_id.PatternId"] = None,
        suppression_type: Optional[
            "capo_cloudwatch_logs.types.suppression_type.SuppressionType"
        ] = None,
        suppression_period: Optional[
            "capo_cloudwatch_logs.types.suppression_period.SuppressionPeriod"
        ] = None,
        baseline: Optional["capo_cloudwatch_logs.types.baseline.Baseline"] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.update_anomaly_request.UpdateAnomalyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.update_anomaly

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.update_anomaly.async_update_anomaly(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_delivery_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.update_delivery_configuration_request.UpdateDeliveryConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.update_delivery_configuration_response.UpdateDeliveryConfigurationResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.update_delivery_configuration

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.update_delivery_configuration.async_update_delivery_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_log_anomaly_detector(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.update_log_anomaly_detector_request.UpdateLogAnomalyDetectorRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cloudwatch_logs._operations.logs_20140328.update_log_anomaly_detector

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.update_log_anomaly_detector.async_update_log_anomaly_detector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_lookup_table(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.update_lookup_table_request.UpdateLookupTableRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.update_lookup_table_response.UpdateLookupTableResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.update_lookup_table

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.update_lookup_table.async_update_lookup_table(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_scheduled_query(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudwatch_logs.types.update_scheduled_query_request.UpdateScheduledQueryRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudwatch_logs.types.update_scheduled_query_response.UpdateScheduledQueryResponse"
        ]:
            import capo_cloudwatch_logs._operations.logs_20140328.update_scheduled_query

            (
                output,
                http_response,
            ) = await capo_cloudwatch_logs._operations.logs_20140328.update_scheduled_query.async_update_scheduled_query(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
