...
class CloudWatchLogsError(Exception):
    """Base class for all CloudWatchLogs service errors."""


class ServiceError(CloudWatchLogsError):
...
class SerializationError(CloudWatchLogsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CloudWatchLogsError):
...
class WaiterFailedError(CloudWatchLogsError):
...
class WaiterTimeoutError(CloudWatchLogsError):
