"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudwatchlogs#ResourceNotFoundException``."""
