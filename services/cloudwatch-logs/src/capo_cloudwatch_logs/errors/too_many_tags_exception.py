"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#TooManyTagsException``."""
...
class TooManyTagsException_(TypedDict, closed=True):
    ...
    resource_name: NotRequired[
        "capo_cloudwatch_logs.types.amazon_resource_name.AmazonResourceName"
    ]
...
class TooManyTagsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudwatchlogs#TooManyTagsException``."""
