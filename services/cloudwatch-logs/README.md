...
```
pip install aws-sdk-cloudwatch-logs
```

## Usage

```python
from aws_sdk_cloudwatch_logs import AsyncCloudWatchLogsClient
...
```python
from aws_sdk_cloudwatch_logs import AsyncCloudWatchLogsClient
from aws_sdk_cloudwatch_logs.error import InvalidParameterException
