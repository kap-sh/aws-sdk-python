...
```
pip install aws-sdk-chime-sdk-messaging
```

## Usage

```python
from aws_sdk_chime_sdk_messaging import AsyncChimeSDKMessagingClient
...
```python
from aws_sdk_chime_sdk_messaging import AsyncChimeSDKMessagingClient
from aws_sdk_chime_sdk_messaging.error import BadRequestException
