"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#ListChannelMembershipsForAppInstanceUser``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.list_channel_memberships_for_app_instance_user_response.ListChannelMembershipsForAppInstanceUserResponse = aws_sdk_chime_sdk_messaging.types.list_channel_memberships_for_app_instance_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.list_channel_memberships_for_app_instance_user_request.ListChannelMembershipsForAppInstanceUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/channels?scope=app-instance-user-memberships"
    params: dict[str, str] = {}
...
async def async_list_channel_memberships_for_app_instance_user(
