...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.describe_channel_membership_response.DescribeChannelMembershipResponse = aws_sdk_chime_sdk_messaging.types.describe_channel_membership_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.describe_channel_membership_request.DescribeChannelMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
