...
def build_request(
    ...
    input: aws_sdk_chime_sdk_messaging.types.update_channel_request.UpdateChannelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_messaging.types.update_channel_request.serialize_json(input)
    ).encode()
