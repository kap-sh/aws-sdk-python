"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#UpdateChannel``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.update_channel_response.UpdateChannelResponse = aws_sdk_chime_sdk_messaging.types.update_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.update_channel_request.UpdateChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/channels/{ChannelArn}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_messaging.types.update_channel_request.serialize_json(input_)
    ).encode()
