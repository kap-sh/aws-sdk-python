...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.get_channel_message_status_response.GetChannelMessageStatusResponse = aws_sdk_chime_sdk_messaging.types.get_channel_message_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.get_channel_message_status_request.GetChannelMessageStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
