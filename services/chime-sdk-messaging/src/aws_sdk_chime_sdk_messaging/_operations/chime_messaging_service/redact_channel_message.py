"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#RedactChannelMessage``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.redact_channel_message_response.RedactChannelMessageResponse = aws_sdk_chime_sdk_messaging.types.redact_channel_message_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.redact_channel_message_request.RedactChannelMessageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_redact_channel_message(
