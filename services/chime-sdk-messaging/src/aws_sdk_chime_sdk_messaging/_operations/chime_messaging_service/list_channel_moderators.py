"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#ListChannelModerators``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.list_channel_moderators_response.ListChannelModeratorsResponse = aws_sdk_chime_sdk_messaging.types.list_channel_moderators_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.list_channel_moderators_request.ListChannelModeratorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_channel_moderators(
