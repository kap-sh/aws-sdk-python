...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.list_channels_associated_with_channel_flow_response.ListChannelsAssociatedWithChannelFlowResponse = aws_sdk_chime_sdk_messaging.types.list_channels_associated_with_channel_flow_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_messaging.types.list_channels_associated_with_channel_flow_request.ListChannelsAssociatedWithChannelFlowRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "channel_flow_arn" in input:
        params["channel-flow-arn"] = str(input["channel_flow_arn"])
