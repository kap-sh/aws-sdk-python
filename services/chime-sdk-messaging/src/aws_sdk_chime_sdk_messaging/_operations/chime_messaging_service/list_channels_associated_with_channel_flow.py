...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.list_channels_associated_with_channel_flow_request.ListChannelsAssociatedWithChannelFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "channel_flow_arn" in input_:
        params["channel-flow-arn"] = str(input_["channel_flow_arn"])
