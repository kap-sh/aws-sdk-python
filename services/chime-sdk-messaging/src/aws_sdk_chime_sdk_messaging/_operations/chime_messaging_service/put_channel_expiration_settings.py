...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.put_channel_expiration_settings_response.PutChannelExpirationSettingsResponse = aws_sdk_chime_sdk_messaging.types.put_channel_expiration_settings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.put_channel_expiration_settings_request.PutChannelExpirationSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
