"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#DeleteChannelModerator``."""
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.delete_channel_moderator_request.DeleteChannelModeratorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_channel_moderator(
