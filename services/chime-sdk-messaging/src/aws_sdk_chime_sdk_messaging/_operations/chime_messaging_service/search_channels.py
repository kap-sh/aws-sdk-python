"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#SearchChannels``."""
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.search_channels_request.SearchChannelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/channels?operation=search"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_messaging.types.search_channels_request.serialize_json(input_)
    ).encode()
...
async def async_search_channels(
