...
def build_request(
    ...
    input: aws_sdk_chime_sdk_messaging.types.search_channels_request.SearchChannelsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_messaging.types.search_channels_request.serialize_json(input)
    ).encode()
