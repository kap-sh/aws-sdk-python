...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.create_channel_ban_response.CreateChannelBanResponse = aws_sdk_chime_sdk_messaging.types.create_channel_ban_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.create_channel_ban_request.CreateChannelBanRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_messaging.types.create_channel_ban_request.serialize_json(
            input_
        )
    ).encode()
