"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#UpdateChannelFlow``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.update_channel_flow_response.UpdateChannelFlowResponse = aws_sdk_chime_sdk_messaging.types.update_channel_flow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.update_channel_flow_request.UpdateChannelFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/channel-flows/{ChannelFlowArn}"
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_messaging.types.update_channel_flow_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_channel_flow(
