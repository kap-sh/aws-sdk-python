...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.list_sub_channels_response.ListSubChannelsResponse = aws_sdk_chime_sdk_messaging.types.list_sub_channels_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.list_sub_channels_request.ListSubChannelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
