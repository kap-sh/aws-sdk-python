"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#DescribeChannelModerator``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.describe_channel_moderator_response.DescribeChannelModeratorResponse = aws_sdk_chime_sdk_messaging.types.describe_channel_moderator_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.describe_channel_moderator_request.DescribeChannelModeratorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{ChannelModeratorArn}", quote(str(input_["channel_moderator_arn"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_describe_channel_moderator(
