...
def build_request(
    ...
    input: aws_sdk_chime_sdk_messaging.types.describe_channel_moderator_request.DescribeChannelModeratorRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ChannelModeratorArn}", quote(str(input["channel_moderator_arn"]), safe="")
    )
    params: dict[str, str] = {}
