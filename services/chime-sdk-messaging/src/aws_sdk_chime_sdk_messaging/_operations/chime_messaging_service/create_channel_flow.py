"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#CreateChannelFlow``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.create_channel_flow_response.CreateChannelFlowResponse = aws_sdk_chime_sdk_messaging.types.create_channel_flow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.create_channel_flow_request.CreateChannelFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/channel-flows"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_chime_sdk_messaging.types.create_channel_flow_request

    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_messaging.types.create_channel_flow_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_channel_flow(
