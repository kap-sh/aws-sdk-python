...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.channel_flow_callback_response.ChannelFlowCallbackResponse = aws_sdk_chime_sdk_messaging.types.channel_flow_callback_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.channel_flow_callback_request.ChannelFlowCallbackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_messaging.types.channel_flow_callback_request.serialize_json(
            input_
        )
    ).encode()
