...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.describe_channel_moderated_by_app_instance_user_response.DescribeChannelModeratedByAppInstanceUserResponse = aws_sdk_chime_sdk_messaging.types.describe_channel_moderated_by_app_instance_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.describe_channel_moderated_by_app_instance_user_request.DescribeChannelModeratedByAppInstanceUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
