...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.batch_create_channel_membership_response.BatchCreateChannelMembershipResponse = aws_sdk_chime_sdk_messaging.types.batch_create_channel_membership_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.batch_create_channel_membership_request.BatchCreateChannelMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_messaging.types.batch_create_channel_membership_request.serialize_json(
            input_
        )
    ).encode()
