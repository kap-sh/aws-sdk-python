...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.create_channel_membership_response.CreateChannelMembershipResponse = aws_sdk_chime_sdk_messaging.types.create_channel_membership_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.create_channel_membership_request.CreateChannelMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_messaging.types.create_channel_membership_request.serialize_json(
            input_
        )
    ).encode()
