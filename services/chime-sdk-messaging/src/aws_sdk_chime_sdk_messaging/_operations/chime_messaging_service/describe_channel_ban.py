...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.describe_channel_ban_response.DescribeChannelBanResponse = aws_sdk_chime_sdk_messaging.types.describe_channel_ban_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.describe_channel_ban_request.DescribeChannelBanRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
