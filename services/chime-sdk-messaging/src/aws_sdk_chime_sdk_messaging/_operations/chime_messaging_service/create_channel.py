...
def build_request(
    ...
    input: aws_sdk_chime_sdk_messaging.types.create_channel_request.CreateChannelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_messaging.types.create_channel_request.serialize_json(input)
    ).encode()
