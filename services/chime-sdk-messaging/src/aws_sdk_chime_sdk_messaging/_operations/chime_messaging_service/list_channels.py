...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.list_channels_response.ListChannelsResponse = aws_sdk_chime_sdk_messaging.types.list_channels_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.list_channels_request.ListChannelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "privacy" in input_:
        params["privacy"] = str(input_["privacy"])
