"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#GetMessagingStreamingConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.get_messaging_streaming_configurations_response.GetMessagingStreamingConfigurationsResponse = aws_sdk_chime_sdk_messaging.types.get_messaging_streaming_configurations_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_messaging.types.get_messaging_streaming_configurations_request.GetMessagingStreamingConfigurationsRequest,
) -> zapros.Request:
...
async def async_get_messaging_streaming_configurations(
