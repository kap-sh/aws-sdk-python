...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.associate_channel_flow_request.AssociateChannelFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_messaging.types.associate_channel_flow_request.serialize_json(
            input_
        )
    ).encode()
