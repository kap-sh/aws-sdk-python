...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.describe_channel_flow_response.DescribeChannelFlowResponse = aws_sdk_chime_sdk_messaging.types.describe_channel_flow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.describe_channel_flow_request.DescribeChannelFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
