...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.send_channel_message_response.SendChannelMessageResponse = aws_sdk_chime_sdk_messaging.types.send_channel_message_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.send_channel_message_request.SendChannelMessageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_messaging.types.send_channel_message_request.serialize_json(
            input_
        )
    ).encode()
