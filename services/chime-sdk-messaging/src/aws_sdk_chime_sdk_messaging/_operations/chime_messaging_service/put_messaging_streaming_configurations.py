"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#PutMessagingStreamingConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.put_messaging_streaming_configurations_response.PutMessagingStreamingConfigurationsResponse = aws_sdk_chime_sdk_messaging.types.put_messaging_streaming_configurations_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_messaging.types.put_messaging_streaming_configurations_request.PutMessagingStreamingConfigurationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_messaging.types.put_messaging_streaming_configurations_request.serialize_json(
            input
        )
    ).encode()
...
async def async_put_messaging_streaming_configurations(
