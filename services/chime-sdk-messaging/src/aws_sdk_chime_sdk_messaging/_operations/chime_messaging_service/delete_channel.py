"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#DeleteChannel``."""
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.delete_channel_request.DeleteChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
