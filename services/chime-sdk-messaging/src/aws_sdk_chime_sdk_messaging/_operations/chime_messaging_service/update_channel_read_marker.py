"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#UpdateChannelReadMarker``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.update_channel_read_marker_response.UpdateChannelReadMarkerResponse = aws_sdk_chime_sdk_messaging.types.update_channel_read_marker_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.update_channel_read_marker_request.UpdateChannelReadMarkerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/channels/{ChannelArn}/readMarker"
...
async def async_update_channel_read_marker(
