"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#DeleteMessagingStreamingConfigurations``."""
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_messaging.types.delete_messaging_streaming_configurations_request.DeleteMessagingStreamingConfigurationsRequest,
) -> zapros.Request:
...
async def async_delete_messaging_streaming_configurations(
