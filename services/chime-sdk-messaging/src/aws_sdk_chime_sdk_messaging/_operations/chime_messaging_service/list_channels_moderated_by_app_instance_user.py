"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#ListChannelsModeratedByAppInstanceUser``."""
...
import aws_sdk_chime_sdk_messaging.types.channel_moderated_by_app_instance_user_summary_list
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.list_channels_moderated_by_app_instance_user_response.ListChannelsModeratedByAppInstanceUserResponse = aws_sdk_chime_sdk_messaging.types.list_channels_moderated_by_app_instance_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.list_channels_moderated_by_app_instance_user_request.ListChannelsModeratedByAppInstanceUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_channels_moderated_by_app_instance_user(
