...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.list_channel_memberships_response.ListChannelMembershipsResponse = aws_sdk_chime_sdk_messaging.types.list_channel_memberships_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.list_channel_memberships_request.ListChannelMembershipsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
