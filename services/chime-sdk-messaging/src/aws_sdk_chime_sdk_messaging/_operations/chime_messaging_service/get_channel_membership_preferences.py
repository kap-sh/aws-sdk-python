"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#GetChannelMembershipPreferences``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.get_channel_membership_preferences_response.GetChannelMembershipPreferencesResponse = aws_sdk_chime_sdk_messaging.types.get_channel_membership_preferences_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.get_channel_membership_preferences_request.GetChannelMembershipPreferencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_channel_membership_preferences(
