"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#GetMessagingSessionEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.get_messaging_session_endpoint_response.GetMessagingSessionEndpointResponse = aws_sdk_chime_sdk_messaging.types.get_messaging_session_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.get_messaging_session_endpoint_request.GetMessagingSessionEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/endpoints/messaging-session"
    params: dict[str, str] = {}
    if "network_type" in input_:
        params["network-type"] = str(input_["network_type"])
...
async def async_get_messaging_session_endpoint(
