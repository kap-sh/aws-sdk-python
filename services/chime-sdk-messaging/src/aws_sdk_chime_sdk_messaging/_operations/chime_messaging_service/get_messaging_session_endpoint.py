...
def build_request(
    ...
    input: aws_sdk_chime_sdk_messaging.types.get_messaging_session_endpoint_request.GetMessagingSessionEndpointRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "network_type" in input:
        params["network-type"] = str(input["network_type"])
