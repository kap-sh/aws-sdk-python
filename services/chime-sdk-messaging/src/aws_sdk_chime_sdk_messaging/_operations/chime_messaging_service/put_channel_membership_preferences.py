...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.put_channel_membership_preferences_response.PutChannelMembershipPreferencesResponse = aws_sdk_chime_sdk_messaging.types.put_channel_membership_preferences_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chime_sdk_messaging.types.put_channel_membership_preferences_request.PutChannelMembershipPreferencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chime_sdk_messaging.types.put_channel_membership_preferences_request.serialize_json(
            input_
        )
    ).encode()
