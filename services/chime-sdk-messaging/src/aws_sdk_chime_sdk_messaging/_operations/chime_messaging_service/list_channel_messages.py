...
def handle_response(
    ...
    out: aws_sdk_chime_sdk_messaging.types.list_channel_messages_response.ListChannelMessagesResponse = aws_sdk_chime_sdk_messaging.types.list_channel_messages_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chime_sdk_messaging.types.list_channel_messages_request.ListChannelMessagesRequest,
) -> zapros.Request:
    ...
    if "sort_order" in input:
        params["sort-order"] = str(input["sort_order"])
    if "not_before" in input:
        params["not-before"] = str(input["not_before"])
    if "not_after" in input:
        params["not-after"] = str(input["not_after"])
