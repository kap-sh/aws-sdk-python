...
def build_request(
    ...
    input: aws_sdk_chime_sdk_messaging.types.get_channel_message_request.GetChannelMessageRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "sub_channel_id" in input:
        params["sub-channel-id"] = str(input["sub_channel_id"])
