...
if TYPE_CHECKING:
    import aws_sdk_chime_sdk_messaging.types.expiration_criterion
...
class ExpirationSettings(TypedDict, closed=True):
    ...
    expiration_criterion: (
        "aws_sdk_chime_sdk_messaging.types.expiration_criterion.ExpirationCriterion"
    )
...
def serialize_json(value: ExpirationSettings) -> dict:
    ...
    out["ExpirationCriterion"] = (
        aws_sdk_chime_sdk_messaging.types.expiration_criterion.serialize_json(
...
def deserialize_json(data: dict) -> ExpirationSettings:
    ...
    if "ExpirationCriterion" in data:
        ...
        out["expiration_criterion"] = (
            aws_sdk_chime_sdk_messaging.types.expiration_criterion.deserialize_json(
