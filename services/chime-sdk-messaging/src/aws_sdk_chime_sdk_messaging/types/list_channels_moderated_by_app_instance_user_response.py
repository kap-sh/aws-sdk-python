...
class ListChannelsModeratedByAppInstanceUserResponse(TypedDict):
    channels: NotRequired[
        "aws_sdk_chime_sdk_messaging.types.channel_moderated_by_app_instance_user_summary_list.ChannelModeratedByAppInstanceUserSummaryList"
    ]
...
def serialize_json(value: ListChannelsModeratedByAppInstanceUserResponse) -> dict:
    ...
    if "channels" in value:
        ...
        out["Channels"] = (
            aws_sdk_chime_sdk_messaging.types.channel_moderated_by_app_instance_user_summary_list.serialize_json(
                value["channels"]
            )
        )
...
def deserialize_json(data: dict) -> ListChannelsModeratedByAppInstanceUserResponse:
    ...
    if "Channels" in data:
        ...
        out["channels"] = (
            aws_sdk_chime_sdk_messaging.types.channel_moderated_by_app_instance_user_summary_list.deserialize_json(
                data["Channels"]
            )
        )
