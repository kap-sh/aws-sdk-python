"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#SendChannelMessageResponse``."""
...
class SendChannelMessageResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: SendChannelMessageResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> SendChannelMessageResponse:
    out: SendChannelMessageResponse = {}  # type: ignore[typeddict-item]
