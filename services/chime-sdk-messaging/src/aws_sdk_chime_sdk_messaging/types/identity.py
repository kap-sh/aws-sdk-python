...
if TYPE_CHECKING:
    ...
    import aws_sdk_chime_sdk_messaging.types.resource_name


class Identity(TypedDict, closed=True):
    arn: NotRequired["aws_sdk_chime_sdk_messaging.types.chime_arn.ChimeArn"]
    """<p>The ARN in an Identity.</p>"""
    name: NotRequired["aws_sdk_chime_sdk_messaging.types.resource_name.ResourceName"]
