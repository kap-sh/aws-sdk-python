...
if TYPE_CHECKING:
    import aws_sdk_chime_sdk_messaging.types.channel_membership


class DescribeChannelMembershipResponse(TypedDict):
    channel_membership: NotRequired[
        "aws_sdk_chime_sdk_messaging.types.channel_membership.ChannelMembership"
    ]
...
def serialize_json(value: DescribeChannelMembershipResponse) -> dict:
    ...
    if "channel_membership" in value:
        ...
        out["ChannelMembership"] = (
            aws_sdk_chime_sdk_messaging.types.channel_membership.serialize_json(
...
def deserialize_json(data: dict) -> DescribeChannelMembershipResponse:
    ...
    if "ChannelMembership" in data:
        ...
        out["channel_membership"] = (
            aws_sdk_chime_sdk_messaging.types.channel_membership.deserialize_json(
