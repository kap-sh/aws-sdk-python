...
if TYPE_CHECKING:
    import aws_sdk_chime_sdk_messaging.types.channel_membership_summary_list
    import aws_sdk_chime_sdk_messaging.types.chime_arn
    import aws_sdk_chime_sdk_messaging.types.next_token


class ListChannelMembershipsResponse(TypedDict):
    channel_arn: NotRequired["aws_sdk_chime_sdk_messaging.types.chime_arn.ChimeArn"]
    """<p>The ARN of the channel.</p>"""
    channel_memberships: NotRequired[
        "aws_sdk_chime_sdk_messaging.types.channel_membership_summary_list.ChannelMembershipSummaryList"
    ]
...
def serialize_json(value: ListChannelMembershipsResponse) -> dict:
    ...
    if "channel_memberships" in value:
        ...
        out["ChannelMemberships"] = (
            aws_sdk_chime_sdk_messaging.types.channel_membership_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListChannelMembershipsResponse:
    ...
    if "ChannelMemberships" in data:
        ...
        out["channel_memberships"] = (
            aws_sdk_chime_sdk_messaging.types.channel_membership_summary_list.deserialize_json(
