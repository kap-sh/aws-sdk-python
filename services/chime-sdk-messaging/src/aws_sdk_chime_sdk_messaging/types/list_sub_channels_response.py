...
if TYPE_CHECKING:
    ...
    import aws_sdk_chime_sdk_messaging.types.sub_channel_summary_list


class ListSubChannelsResponse(TypedDict):
    ...
    sub_channels: NotRequired[
        "aws_sdk_chime_sdk_messaging.types.sub_channel_summary_list.SubChannelSummaryList"
    ]
...
def serialize_json(value: ListSubChannelsResponse) -> dict:
    ...
    if "sub_channels" in value:
        ...
        out["SubChannels"] = (
            aws_sdk_chime_sdk_messaging.types.sub_channel_summary_list.serialize_json(
                value["sub_channels"]
            )
        )
...
def deserialize_json(data: dict) -> ListSubChannelsResponse:
    ...
    if "SubChannels" in data:
        ...
        out["sub_channels"] = (
            aws_sdk_chime_sdk_messaging.types.sub_channel_summary_list.deserialize_json(
                data["SubChannels"]
            )
        )
