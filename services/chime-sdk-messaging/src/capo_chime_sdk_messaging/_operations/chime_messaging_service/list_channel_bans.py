...
import capo_chime_sdk_messaging.types.channel_ban_summary_list
...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.list_channel_bans_response.ListChannelBansResponse = capo_chime_sdk_messaging.types.list_channel_bans_response.deserialize_json(
