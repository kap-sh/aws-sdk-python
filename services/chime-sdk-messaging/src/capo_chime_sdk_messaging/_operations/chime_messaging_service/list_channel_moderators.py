...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.list_channel_moderators_response.ListChannelModeratorsResponse = capo_chime_sdk_messaging.types.list_channel_moderators_response.deserialize_json(
