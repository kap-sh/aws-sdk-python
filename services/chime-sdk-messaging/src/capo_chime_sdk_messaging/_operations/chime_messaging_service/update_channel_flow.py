...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.update_channel_flow_response.UpdateChannelFlowResponse = capo_chime_sdk_messaging.types.update_channel_flow_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_messaging.types.update_channel_flow_request.serialize_json(
            input_
        )
    ).encode()
