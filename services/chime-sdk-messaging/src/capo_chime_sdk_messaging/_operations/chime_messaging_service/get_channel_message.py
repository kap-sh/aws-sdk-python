...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.get_channel_message_response.GetChannelMessageResponse = capo_chime_sdk_messaging.types.get_channel_message_response.deserialize_json(
