"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#CreateChannelBan``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.create_channel_ban_response.CreateChannelBanResponse = capo_chime_sdk_messaging.types.create_channel_ban_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/channels/{ChannelArn}/bans"
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_messaging.types.create_channel_ban_request.serialize_json(input_)
    ).encode()
...
async def async_create_channel_ban(
