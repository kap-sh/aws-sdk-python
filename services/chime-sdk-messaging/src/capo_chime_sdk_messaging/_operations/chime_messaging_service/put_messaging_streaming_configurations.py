...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.put_messaging_streaming_configurations_response.PutMessagingStreamingConfigurationsResponse = capo_chime_sdk_messaging.types.put_messaging_streaming_configurations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_messaging.types.put_messaging_streaming_configurations_request.serialize_json(
            input_
        )
    ).encode()
