"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#ListSubChannels``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.list_sub_channels_response.ListSubChannelsResponse = capo_chime_sdk_messaging.types.list_sub_channels_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/channels/{ChannelArn}/subchannels"
...
async def async_list_sub_channels(
