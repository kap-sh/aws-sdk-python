"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#BatchCreateChannelMembership``."""
...
import capo_chime_sdk_messaging.errors.not_found_exception
import capo_chime_sdk_messaging.errors.resource_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NotFoundException":
            raise capo_chime_sdk_messaging.errors.not_found_exception.NotFoundException.from_json(
                data
            )
        case "ResourceLimitExceededException":
            raise capo_chime_sdk_messaging.errors.resource_limit_exceeded_exception.ResourceLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.batch_create_channel_membership_response.BatchCreateChannelMembershipResponse = capo_chime_sdk_messaging.types.batch_create_channel_membership_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_messaging.types.batch_create_channel_membership_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_create_channel_membership(
