"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#SendChannelMessage``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.send_channel_message_response.SendChannelMessageResponse = capo_chime_sdk_messaging.types.send_channel_message_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_messaging.types.send_channel_message_request.serialize_json(
            input_
        )
    ).encode()
