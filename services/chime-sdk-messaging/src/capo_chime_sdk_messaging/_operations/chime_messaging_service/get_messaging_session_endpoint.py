...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.get_messaging_session_endpoint_response.GetMessagingSessionEndpointResponse = capo_chime_sdk_messaging.types.get_messaging_session_endpoint_response.deserialize_json(
