"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#CreateChannelMembership``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.create_channel_membership_response.CreateChannelMembershipResponse = capo_chime_sdk_messaging.types.create_channel_membership_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_messaging.types.create_channel_membership_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_channel_membership(
