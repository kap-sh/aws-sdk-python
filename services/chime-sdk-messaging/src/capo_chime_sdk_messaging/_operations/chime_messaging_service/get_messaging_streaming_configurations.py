...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.get_messaging_streaming_configurations_response.GetMessagingStreamingConfigurationsResponse = capo_chime_sdk_messaging.types.get_messaging_streaming_configurations_response.deserialize_json(
