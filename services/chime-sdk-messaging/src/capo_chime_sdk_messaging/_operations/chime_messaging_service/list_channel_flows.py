...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.list_channel_flows_response.ListChannelFlowsResponse = capo_chime_sdk_messaging.types.list_channel_flows_response.deserialize_json(
