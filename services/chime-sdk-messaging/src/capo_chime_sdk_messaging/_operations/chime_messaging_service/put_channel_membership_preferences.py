"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#PutChannelMembershipPreferences``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.put_channel_membership_preferences_response.PutChannelMembershipPreferencesResponse = capo_chime_sdk_messaging.types.put_channel_membership_preferences_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_messaging.types.put_channel_membership_preferences_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_channel_membership_preferences(
