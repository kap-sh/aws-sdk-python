"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#AssociateChannelFlow``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/channels/{ChannelArn}/channel-flow"
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_messaging.types.associate_channel_flow_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_associate_channel_flow(
