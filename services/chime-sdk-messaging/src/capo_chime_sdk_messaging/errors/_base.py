...
class ChimeSDKMessagingError(Exception):
    """Base class for all ChimeSDKMessaging service errors."""


class ServiceError(ChimeSDKMessagingError):
...
class SerializationError(ChimeSDKMessagingError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ChimeSDKMessagingError):
...
class WaiterFailedError(ChimeSDKMessagingError):
...
class WaiterTimeoutError(ChimeSDKMessagingError):
