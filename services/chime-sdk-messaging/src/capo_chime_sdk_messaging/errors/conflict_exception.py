"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.chimesdkmessaging#ConflictException``."""
