...
if TYPE_CHECKING:
    import capo_marketplace_discovery.types.container_operating_system

ContainerOperatingSystemList: TypeAlias = list[
    "capo_marketplace_discovery.types.container_operating_system.ContainerOperatingSystem"
]
...
def serialize_json(value: ContainerOperatingSystemList) -> list:
    ...
    for item in value:
        out.append(
            capo_marketplace_discovery.types.container_operating_system.serialize_json(
                item
            )
        )
    return out
