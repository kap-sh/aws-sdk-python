...
if TYPE_CHECKING:
    import capo_marketplace_discovery.types.review_source_summary

ReviewSourceSummaryList: TypeAlias = list[
    "capo_marketplace_discovery.types.review_source_summary.ReviewSourceSummary"
]
...
def serialize_json(value: ReviewSourceSummaryList) -> list:
    ...
    for item in value:
        out.append(
            capo_marketplace_discovery.types.review_source_summary.serialize_json(item)
        )
    return out
