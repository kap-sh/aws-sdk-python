...
if TYPE_CHECKING:
    import capo_marketplace_discovery.types.listing_badge

ListingBadgeList: TypeAlias = list[
    "capo_marketplace_discovery.types.listing_badge.ListingBadge"
]
...
def serialize_json(value: ListingBadgeList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_marketplace_discovery.types.listing_badge.serialize_json(item))
    return out
