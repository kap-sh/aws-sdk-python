...
if TYPE_CHECKING:
    import capo_marketplace_discovery.types.data_artifact

DataArtifactList: TypeAlias = list[
    "capo_marketplace_discovery.types.data_artifact.DataArtifact"
]
...
def serialize_json(value: DataArtifactList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_marketplace_discovery.types.data_artifact.serialize_json(item))
    return out
