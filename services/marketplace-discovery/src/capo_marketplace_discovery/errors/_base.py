...
class MarketplaceDiscoveryError(Exception):
    """Base class for all MarketplaceDiscovery service errors."""


class ServiceError(MarketplaceDiscoveryError):
...
class SerializationError(MarketplaceDiscoveryError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MarketplaceDiscoveryError):
...
class WaiterFailedError(MarketplaceDiscoveryError):
...
class WaiterTimeoutError(MarketplaceDiscoveryError):
