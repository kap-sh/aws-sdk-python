...
class EksAddOnFulfillmentOption(TypedDict):
    ...
    operating_systems: NotRequired[
        "aws_sdk_marketplace_discovery.types.eks_add_on_operating_system_list.EksAddOnOperatingSystemList"
    ]
...
def serialize_json(value: EksAddOnFulfillmentOption) -> dict:
    ...
    if "operating_systems" in value:
        ...
        out["operatingSystems"] = (
            aws_sdk_marketplace_discovery.types.eks_add_on_operating_system_list.serialize_json(
...
def deserialize_json(data: dict) -> EksAddOnFulfillmentOption:
    ...
    if "operatingSystems" in data:
        ...
        out["operating_systems"] = (
            aws_sdk_marketplace_discovery.types.eks_add_on_operating_system_list.deserialize_json(
