...
AmazonMachineImageOperatingSystemList: TypeAlias = list[
    "aws_sdk_marketplace_discovery.types.amazon_machine_image_operating_system.AmazonMachineImageOperatingSystem"
]
...
def serialize_json(value: AmazonMachineImageOperatingSystemList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_marketplace_discovery.types.amazon_machine_image_operating_system.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> AmazonMachineImageOperatingSystemList:
    ...
    for item in data:
        out.append(
            aws_sdk_marketplace_discovery.types.amazon_machine_image_operating_system.deserialize_json(
                item
            )
        )
    return out
