...
def serialize_json(value: ConfigurableUpfrontRateCardItem) -> dict:
    ...
    out["selector"] = aws_sdk_marketplace_discovery.types.selector.serialize_json(
        value["selector"]
    )
    import aws_sdk_marketplace_discovery.types.constraints

    out["constraints"] = aws_sdk_marketplace_discovery.types.constraints.serialize_json(
        value["constraints"]
    )
    import aws_sdk_marketplace_discovery.types.rate_card_list
...
def deserialize_json(data: dict) -> ConfigurableUpfrontRateCardItem:
    ...
    if "selector" in data:
        ...
        out["selector"] = aws_sdk_marketplace_discovery.types.selector.deserialize_json(
            data["selector"]
        )
    else:
    ...
    if "constraints" in data:
        ...
        out["constraints"] = (
            aws_sdk_marketplace_discovery.types.constraints.deserialize_json(
                data["constraints"]
            )
        )
    else:
