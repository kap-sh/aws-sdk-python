...
class Ec2ImageBuilderComponentFulfillmentOption(TypedDict):
    ...
    operating_systems: NotRequired["aws_sdk_marketplace_discovery.types.container_operating_system_list.ContainerOperatingSystemList"]
...
def serialize_json(value: Ec2ImageBuilderComponentFulfillmentOption) -> dict:
    ...
    if "operating_systems" in value:
        import aws_sdk_marketplace_discovery.types.container_operating_system_list
        out["operatingSystems"] = aws_sdk_marketplace_discovery.types.container_operating_system_list.serialize_json(value["operating_systems"])
...
def deserialize_json(data: dict) -> Ec2ImageBuilderComponentFulfillmentOption:
    ...
    if "fulfillmentOptionId" in data:
        ...
        raise DeserializationError("Ec2ImageBuilderComponentFulfillmentOption.fulfillment_option_id required")
    if "fulfillmentOptionName" in data:
        out["fulfillment_option_name"] = data["fulfillmentOptionName"]
    else:
        raise DeserializationError("Ec2ImageBuilderComponentFulfillmentOption.fulfillment_option_name required")
    if "fulfillmentOptionType" in data:
        ...
        raise DeserializationError("Ec2ImageBuilderComponentFulfillmentOption.fulfillment_option_type required")
    if "fulfillmentOptionDisplayName" in data:
        out["fulfillment_option_display_name"] = data["fulfillmentOptionDisplayName"]
    else:
        raise DeserializationError("Ec2ImageBuilderComponentFulfillmentOption.fulfillment_option_display_name required")
    ...
    if "operatingSystems" in data:
        import aws_sdk_marketplace_discovery.types.container_operating_system_list
        out["operating_systems"] = aws_sdk_marketplace_discovery.types.container_operating_system_list.deserialize_json(data["operatingSystems"])
