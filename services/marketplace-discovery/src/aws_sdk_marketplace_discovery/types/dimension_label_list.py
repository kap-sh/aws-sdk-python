...
DimensionLabelList: TypeAlias = list[
    "aws_sdk_marketplace_discovery.types.dimension_label.DimensionLabel"
]
...
def serialize_json(value: DimensionLabelList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_marketplace_discovery.types.dimension_label.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> DimensionLabelList:
    ...
    for item in data:
        out.append(
            aws_sdk_marketplace_discovery.types.dimension_label.deserialize_json(item)
        )
    return out
