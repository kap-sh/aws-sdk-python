...
ConfigurableUpfrontRateCardList: TypeAlias = list[
    "aws_sdk_marketplace_discovery.types.configurable_upfront_rate_card_item.ConfigurableUpfrontRateCardItem"
]
...
def serialize_json(value: ConfigurableUpfrontRateCardList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_marketplace_discovery.types.configurable_upfront_rate_card_item.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> ConfigurableUpfrontRateCardList:
    ...
    for item in data:
        out.append(
            aws_sdk_marketplace_discovery.types.configurable_upfront_rate_card_item.deserialize_json(
                item
            )
        )
    return out
