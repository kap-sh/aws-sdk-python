...
class EksAddOnOperatingSystem(TypedDict):
...
def deserialize_json(data: dict) -> EksAddOnOperatingSystem:
    ...
    if "operatingSystemFamilyName" in data:
        ...
        raise DeserializationError("EksAddOnOperatingSystem.operating_system_family_name required")
    if "operatingSystemName" in data:
        out["operating_system_name"] = data["operatingSystemName"]
    else:
        raise DeserializationError("EksAddOnOperatingSystem.operating_system_name required")
    return out