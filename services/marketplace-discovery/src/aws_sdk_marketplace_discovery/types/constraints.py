...
def serialize_json(value: Constraints) -> dict:
    out: dict = {}
    import aws_sdk_marketplace_discovery.types.rate_card_constraint_type
    out["multipleDimensionSelection"] = aws_sdk_marketplace_discovery.types.rate_card_constraint_type.serialize_json(value["multiple_dimension_selection"])
    import aws_sdk_marketplace_discovery.types.rate_card_constraint_type
    out["quantityConfiguration"] = aws_sdk_marketplace_discovery.types.rate_card_constraint_type.serialize_json(value["quantity_configuration"])
    return out
...
def deserialize_json(data: dict) -> Constraints:
    ...
    if "multipleDimensionSelection" in data:
        import aws_sdk_marketplace_discovery.types.rate_card_constraint_type
        out["multiple_dimension_selection"] = aws_sdk_marketplace_discovery.types.rate_card_constraint_type.deserialize_json(data["multipleDimensionSelection"])
    else:
        raise DeserializationError("Constraints.multiple_dimension_selection required")
    if "quantityConfiguration" in data:
        import aws_sdk_marketplace_discovery.types.rate_card_constraint_type
        out["quantity_configuration"] = aws_sdk_marketplace_discovery.types.rate_card_constraint_type.deserialize_json(data["quantityConfiguration"])
    else:
