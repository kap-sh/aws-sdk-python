...
class GetListingOutput(TypedDict):
    ...
    integration_guide: NotRequired["aws_sdk_marketplace_discovery.types.nullable_string.NullableString"]
    ...
    long_description: "aws_sdk_marketplace_discovery.types.non_empty_string.NonEmptyString"
    """<p>A detailed description of what the listing offers, in paragraph format.</p>"""
    pricing_models: "aws_sdk_marketplace_discovery.types.pricing_model_list.PricingModelList"
    """<p>The pricing models for offers associated with this listing, such as usage-based, contract, BYOL, or free.</p>"""
    pricing_units: "aws_sdk_marketplace_discovery.types.pricing_unit_list.PricingUnitList"
    ...
    publisher: "aws_sdk_marketplace_discovery.types.seller_information.SellerInformation"
    ...
    review_summary: NotRequired["aws_sdk_marketplace_discovery.types.review_summary.ReviewSummary"]
    ...
    short_description: "aws_sdk_marketplace_discovery.types.non_empty_string.NonEmptyString"
...
def serialize_json(value: GetListingOutput) -> dict:
    out: dict = {}
    import aws_sdk_marketplace_discovery.types.listing_associated_entity_list
    out["associatedEntities"] = aws_sdk_marketplace_discovery.types.listing_associated_entity_list.serialize_json(value["associated_entities"])
    import aws_sdk_marketplace_discovery.types.listing_badge_list
    out["badges"] = aws_sdk_marketplace_discovery.types.listing_badge_list.serialize_json(value["badges"])
    out["catalog"] = value["catalog"]
    import aws_sdk_marketplace_discovery.types.category_list
    out["categories"] = aws_sdk_marketplace_discovery.types.category_list.serialize_json(value["categories"])
    import aws_sdk_marketplace_discovery.types.fulfillment_option_summary_list
    out["fulfillmentOptionSummaries"] = aws_sdk_marketplace_discovery.types.fulfillment_option_summary_list.serialize_json(value["fulfillment_option_summaries"])
    import aws_sdk_marketplace_discovery.types.highlight_list
    out["highlights"] = aws_sdk_marketplace_discovery.types.highlight_list.serialize_json(value["highlights"])
    ...
    import aws_sdk_marketplace_discovery.types.pricing_model_list
    out["pricingModels"] = aws_sdk_marketplace_discovery.types.pricing_model_list.serialize_json(value["pricing_models"])
    import aws_sdk_marketplace_discovery.types.pricing_unit_list
    out["pricingUnits"] = aws_sdk_marketplace_discovery.types.pricing_unit_list.serialize_json(value["pricing_units"])
    import aws_sdk_marketplace_discovery.types.promotional_media_list
    out["promotionalMedia"] = aws_sdk_marketplace_discovery.types.promotional_media_list.serialize_json(value["promotional_media"])
    import aws_sdk_marketplace_discovery.types.seller_information
    out["publisher"] = aws_sdk_marketplace_discovery.types.seller_information.serialize_json(value["publisher"])
    import aws_sdk_marketplace_discovery.types.resource_list
    out["resources"] = aws_sdk_marketplace_discovery.types.resource_list.serialize_json(value["resources"])
    if "review_summary" in value:
        import aws_sdk_marketplace_discovery.types.review_summary
        out["reviewSummary"] = aws_sdk_marketplace_discovery.types.review_summary.serialize_json(value["review_summary"])
    import aws_sdk_marketplace_discovery.types.seller_engagement_list
    out["sellerEngagements"] = aws_sdk_marketplace_discovery.types.seller_engagement_list.serialize_json(value["seller_engagements"])
    out["shortDescription"] = value["short_description"]
    import aws_sdk_marketplace_discovery.types.use_case_list
    out["useCases"] = aws_sdk_marketplace_discovery.types.use_case_list.serialize_json(value["use_cases"])
    return out
...
def deserialize_json(data: dict) -> GetListingOutput:
    ...
    if "associatedEntities" in data:
        import aws_sdk_marketplace_discovery.types.listing_associated_entity_list
        out["associated_entities"] = aws_sdk_marketplace_discovery.types.listing_associated_entity_list.deserialize_json(data["associatedEntities"])
    else:
        raise DeserializationError("GetListingOutput.associated_entities required")
    if "badges" in data:
        import aws_sdk_marketplace_discovery.types.listing_badge_list
        out["badges"] = aws_sdk_marketplace_discovery.types.listing_badge_list.deserialize_json(data["badges"])
    else:
    ...
    if "categories" in data:
        import aws_sdk_marketplace_discovery.types.category_list
        out["categories"] = aws_sdk_marketplace_discovery.types.category_list.deserialize_json(data["categories"])
    else:
        raise DeserializationError("GetListingOutput.categories required")
    if "fulfillmentOptionSummaries" in data:
        import aws_sdk_marketplace_discovery.types.fulfillment_option_summary_list
        out["fulfillment_option_summaries"] = aws_sdk_marketplace_discovery.types.fulfillment_option_summary_list.deserialize_json(data["fulfillmentOptionSummaries"])
    else:
        raise DeserializationError("GetListingOutput.fulfillment_option_summaries required")
    if "highlights" in data:
        import aws_sdk_marketplace_discovery.types.highlight_list
        out["highlights"] = aws_sdk_marketplace_discovery.types.highlight_list.deserialize_json(data["highlights"])
    else:
    ...
    if "pricingModels" in data:
        import aws_sdk_marketplace_discovery.types.pricing_model_list
        out["pricing_models"] = aws_sdk_marketplace_discovery.types.pricing_model_list.deserialize_json(data["pricingModels"])
    else:
        raise DeserializationError("GetListingOutput.pricing_models required")
    if "pricingUnits" in data:
        import aws_sdk_marketplace_discovery.types.pricing_unit_list
        out["pricing_units"] = aws_sdk_marketplace_discovery.types.pricing_unit_list.deserialize_json(data["pricingUnits"])
    else:
        raise DeserializationError("GetListingOutput.pricing_units required")
    if "promotionalMedia" in data:
        import aws_sdk_marketplace_discovery.types.promotional_media_list
        out["promotional_media"] = aws_sdk_marketplace_discovery.types.promotional_media_list.deserialize_json(data["promotionalMedia"])
    else:
        raise DeserializationError("GetListingOutput.promotional_media required")
    if "publisher" in data:
        import aws_sdk_marketplace_discovery.types.seller_information
        out["publisher"] = aws_sdk_marketplace_discovery.types.seller_information.deserialize_json(data["publisher"])
    else:
        raise DeserializationError("GetListingOutput.publisher required")
    if "resources" in data:
        import aws_sdk_marketplace_discovery.types.resource_list
        out["resources"] = aws_sdk_marketplace_discovery.types.resource_list.deserialize_json(data["resources"])
    else:
        raise DeserializationError("GetListingOutput.resources required")
    if "reviewSummary" in data:
        import aws_sdk_marketplace_discovery.types.review_summary
        out["review_summary"] = aws_sdk_marketplace_discovery.types.review_summary.deserialize_json(data["reviewSummary"])
    if "sellerEngagements" in data:
        import aws_sdk_marketplace_discovery.types.seller_engagement_list
        out["seller_engagements"] = aws_sdk_marketplace_discovery.types.seller_engagement_list.deserialize_json(data["sellerEngagements"])
    else:
    ...
    if "useCases" in data:
        import aws_sdk_marketplace_discovery.types.use_case_list
        out["use_cases"] = aws_sdk_marketplace_discovery.types.use_case_list.deserialize_json(data["useCases"])
    else:
