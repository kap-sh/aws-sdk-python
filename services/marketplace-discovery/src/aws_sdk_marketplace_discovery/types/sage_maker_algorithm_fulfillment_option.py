...
if TYPE_CHECKING:
    ...
    import aws_sdk_marketplace_discovery.types.sage_maker_algorithm_recommendation


class SageMakerAlgorithmFulfillmentOption(TypedDict):
    ...
    recommendation: NotRequired[
        "aws_sdk_marketplace_discovery.types.sage_maker_algorithm_recommendation.SageMakerAlgorithmRecommendation"
    ]
...
def serialize_json(value: SageMakerAlgorithmFulfillmentOption) -> dict:
    ...
    if "recommendation" in value:
        ...
        out["recommendation"] = (
            aws_sdk_marketplace_discovery.types.sage_maker_algorithm_recommendation.serialize_json(
...
def deserialize_json(data: dict) -> SageMakerAlgorithmFulfillmentOption:
    ...
    if "recommendation" in data:
        ...
        out["recommendation"] = (
            aws_sdk_marketplace_discovery.types.sage_maker_algorithm_recommendation.deserialize_json(
                data["recommendation"]
            )
        )
    return out
