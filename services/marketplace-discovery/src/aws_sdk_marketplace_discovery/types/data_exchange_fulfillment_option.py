...
class DataExchangeFulfillmentOption(TypedDict):
    ...
    data_artifacts: NotRequired["aws_sdk_marketplace_discovery.types.data_artifact_list.DataArtifactList"]
...
def serialize_json(value: DataExchangeFulfillmentOption) -> dict:
    ...
    if "data_artifacts" in value:
        import aws_sdk_marketplace_discovery.types.data_artifact_list
        out["dataArtifacts"] = aws_sdk_marketplace_discovery.types.data_artifact_list.serialize_json(value["data_artifacts"])
    return out
...
def deserialize_json(data: dict) -> DataExchangeFulfillmentOption:
    ...
    if "fulfillmentOptionId" in data:
        ...
        raise DeserializationError("DataExchangeFulfillmentOption.fulfillment_option_id required")
    if "fulfillmentOptionType" in data:
        ...
        raise DeserializationError("DataExchangeFulfillmentOption.fulfillment_option_type required")
    if "fulfillmentOptionDisplayName" in data:
        out["fulfillment_option_display_name"] = data["fulfillmentOptionDisplayName"]
    else:
        raise DeserializationError("DataExchangeFulfillmentOption.fulfillment_option_display_name required")
    if "dataArtifacts" in data:
        import aws_sdk_marketplace_discovery.types.data_artifact_list
        out["data_artifacts"] = aws_sdk_marketplace_discovery.types.data_artifact_list.deserialize_json(data["dataArtifacts"])
    return out