...
def deserialize_json(data: dict) -> ContainerFulfillmentOption:
    ...
    if "fulfillmentOptionId" in data:
        ...
        raise DeserializationError("ContainerFulfillmentOption.fulfillment_option_id required")
    if "fulfillmentOptionName" in data:
        out["fulfillment_option_name"] = data["fulfillmentOptionName"]
    else:
        raise DeserializationError("ContainerFulfillmentOption.fulfillment_option_name required")
    if "fulfillmentOptionType" in data:
        ...
        raise DeserializationError("ContainerFulfillmentOption.fulfillment_option_type required")
    if "fulfillmentOptionDisplayName" in data:
        out["fulfillment_option_display_name"] = data["fulfillmentOptionDisplayName"]
    else:
        raise DeserializationError("ContainerFulfillmentOption.fulfillment_option_display_name required")
