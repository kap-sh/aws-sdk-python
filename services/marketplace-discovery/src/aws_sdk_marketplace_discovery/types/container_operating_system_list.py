...
ContainerOperatingSystemList: TypeAlias = list[
    "aws_sdk_marketplace_discovery.types.container_operating_system.ContainerOperatingSystem"
]
...
def serialize_json(value: ContainerOperatingSystemList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_marketplace_discovery.types.container_operating_system.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> ContainerOperatingSystemList:
    ...
    for item in data:
        out.append(
            aws_sdk_marketplace_discovery.types.container_operating_system.deserialize_json(
                item
            )
        )
    return out
