...
class AmazonMachineImageFulfillmentOption(TypedDict, closed=True):
    ...
    recommendation: NotRequired[
        "aws_sdk_marketplace_discovery.types.amazon_machine_image_recommendation.AmazonMachineImageRecommendation"
    ]
...
def serialize_json(value: AmazonMachineImageFulfillmentOption) -> dict:
    ...
    out["operatingSystems"] = (
        aws_sdk_marketplace_discovery.types.amazon_machine_image_operating_system_list.serialize_json(
    ...
    if "recommendation" in value:
        ...
        out["recommendation"] = (
            aws_sdk_marketplace_discovery.types.amazon_machine_image_recommendation.serialize_json(
...
def deserialize_json(data: dict) -> AmazonMachineImageFulfillmentOption:
    ...
    if "operatingSystems" in data:
        ...
        out["operating_systems"] = (
            aws_sdk_marketplace_discovery.types.amazon_machine_image_operating_system_list.deserialize_json(
    ...
    if "recommendation" in data:
        ...
        out["recommendation"] = (
            aws_sdk_marketplace_discovery.types.amazon_machine_image_recommendation.deserialize_json(
                data["recommendation"]
            )
        )
