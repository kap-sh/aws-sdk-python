...
from aws_sdk_marketplace_discovery._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
...
class MarketplaceDiscoveryClient:
    ...
    def __init__(self, http_handler: BaseHandler | None = None, operation_interceptors: Iterable[Interceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, use_fips: bool | None = None, endpoint: str | None = None, region: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = MarketplaceDiscoveryClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "use_fips": use_fips, "endpoint": endpoint, "region": region, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[MarketplaceDiscoveryClientConfig] = None) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
    ...
    def get_listing(self, listing_id: "aws_sdk_marketplace_discovery.types.listing_id.ListingId", *, config_overrides: Optional[MarketplaceDiscoveryClientConfig] = None) -> "aws_sdk_marketplace_discovery.types.get_listing_output.GetListingOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_marketplace_discovery.types.get_listing_input.GetListingInput]') -> OperationResponse["aws_sdk_marketplace_discovery.types.get_listing_output.GetListingOutput"]:
            import aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.get_listing
            output, http_response = aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.get_listing.get_listing(req.options, req.input)
    ...
    def get_offer(self, offer_id: "aws_sdk_marketplace_discovery.types.offer_id.OfferId", *, config_overrides: Optional[MarketplaceDiscoveryClientConfig] = None) -> "aws_sdk_marketplace_discovery.types.get_offer_output.GetOfferOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_marketplace_discovery.types.get_offer_input.GetOfferInput]') -> OperationResponse["aws_sdk_marketplace_discovery.types.get_offer_output.GetOfferOutput"]:
            import aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.get_offer
            output, http_response = aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.get_offer.get_offer(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_offer_set(self, offer_set_id: "aws_sdk_marketplace_discovery.types.offer_set_id.OfferSetId", *, config_overrides: Optional[MarketplaceDiscoveryClientConfig] = None) -> "aws_sdk_marketplace_discovery.types.get_offer_set_output.GetOfferSetOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_marketplace_discovery.types.get_offer_set_input.GetOfferSetInput]') -> OperationResponse["aws_sdk_marketplace_discovery.types.get_offer_set_output.GetOfferSetOutput"]:
            import aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.get_offer_set
            output, http_response = aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.get_offer_set.get_offer_set(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def get_offer_terms(self, offer_id: "aws_sdk_marketplace_discovery.types.offer_id.OfferId", *, config_overrides: Optional[MarketplaceDiscoveryClientConfig] = None, max_results: Optional[int] = None, next_token: Optional["aws_sdk_marketplace_discovery.types.next_token.NextToken"] = None) -> "aws_sdk_marketplace_discovery.types.get_offer_terms_output.GetOfferTermsOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_marketplace_discovery.types.get_offer_terms_input.GetOfferTermsInput]') -> OperationResponse["aws_sdk_marketplace_discovery.types.get_offer_terms_output.GetOfferTermsOutput"]:
            import aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.get_offer_terms
            output, http_response = aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.get_offer_terms.get_offer_terms(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_get_offer_terms(self, offer_id: "aws_sdk_marketplace_discovery.types.offer_id.OfferId", *, config_overrides: Optional[MarketplaceDiscoveryClientConfig] = None, max_results: Optional[int] = None, next_token: Optional["aws_sdk_marketplace_discovery.types.next_token.NextToken"] = None) -> "Iterator[aws_sdk_marketplace_discovery.types.offer_term.OfferTerm]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def get_product(self, product_id: "aws_sdk_marketplace_discovery.types.product_id.ProductId", *, config_overrides: Optional[MarketplaceDiscoveryClientConfig] = None) -> "aws_sdk_marketplace_discovery.types.get_product_output.GetProductOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_marketplace_discovery.types.get_product_input.GetProductInput]') -> OperationResponse["aws_sdk_marketplace_discovery.types.get_product_output.GetProductOutput"]:
            import aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.get_product
            output, http_response = aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.get_product.get_product(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def list_fulfillment_options(self, product_id: "aws_sdk_marketplace_discovery.types.product_id.ProductId", *, config_overrides: Optional[MarketplaceDiscoveryClientConfig] = None, max_results: Optional[int] = None, next_token: Optional["aws_sdk_marketplace_discovery.types.next_token.NextToken"] = None) -> "aws_sdk_marketplace_discovery.types.list_fulfillment_options_output.ListFulfillmentOptionsOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_marketplace_discovery.types.list_fulfillment_options_input.ListFulfillmentOptionsInput]') -> OperationResponse["aws_sdk_marketplace_discovery.types.list_fulfillment_options_output.ListFulfillmentOptionsOutput"]:
            import aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.list_fulfillment_options
            output, http_response = aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.list_fulfillment_options.list_fulfillment_options(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_fulfillment_options(self, product_id: "aws_sdk_marketplace_discovery.types.product_id.ProductId", *, config_overrides: Optional[MarketplaceDiscoveryClientConfig] = None, max_results: Optional[int] = None, next_token: Optional["aws_sdk_marketplace_discovery.types.next_token.NextToken"] = None) -> "Iterator[aws_sdk_marketplace_discovery.types.fulfillment_option.FulfillmentOption]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def list_purchase_options(self, *, config_overrides: Optional[MarketplaceDiscoveryClientConfig] = None, filters: Optional["aws_sdk_marketplace_discovery.types.purchase_option_filter_list.PurchaseOptionFilterList"] = None, max_results: Optional["aws_sdk_marketplace_discovery.types.max_results.MaxResults"] = None, next_token: Optional["aws_sdk_marketplace_discovery.types.next_token.NextToken"] = None) -> "aws_sdk_marketplace_discovery.types.list_purchase_options_output.ListPurchaseOptionsOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_marketplace_discovery.types.list_purchase_options_input.ListPurchaseOptionsInput]') -> OperationResponse["aws_sdk_marketplace_discovery.types.list_purchase_options_output.ListPurchaseOptionsOutput"]:
            import aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.list_purchase_options
            output, http_response = aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.list_purchase_options.list_purchase_options(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_list_purchase_options(self, *, config_overrides: Optional[MarketplaceDiscoveryClientConfig] = None, filters: Optional["aws_sdk_marketplace_discovery.types.purchase_option_filter_list.PurchaseOptionFilterList"] = None, max_results: Optional["aws_sdk_marketplace_discovery.types.max_results.MaxResults"] = None, next_token: Optional["aws_sdk_marketplace_discovery.types.next_token.NextToken"] = None) -> "Iterator[aws_sdk_marketplace_discovery.types.purchase_option_summary.PurchaseOptionSummary]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def search_facets(self, *, config_overrides: Optional[MarketplaceDiscoveryClientConfig] = None, search_text: Optional["aws_sdk_marketplace_discovery.types.search_text.SearchText"] = None, filters: Optional["aws_sdk_marketplace_discovery.types.search_filter_list.SearchFilterList"] = None, facet_types: Optional["aws_sdk_marketplace_discovery.types.facet_type_list.FacetTypeList"] = None, next_token: Optional["aws_sdk_marketplace_discovery.types.next_token.NextToken"] = None) -> "aws_sdk_marketplace_discovery.types.search_facets_output.SearchFacetsOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_marketplace_discovery.types.search_facets_input.SearchFacetsInput]') -> OperationResponse["aws_sdk_marketplace_discovery.types.search_facets_output.SearchFacetsOutput"]:
            import aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.search_facets
            output, http_response = aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.search_facets.search_facets(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_search_facets(self, *, config_overrides: Optional[MarketplaceDiscoveryClientConfig] = None, search_text: Optional["aws_sdk_marketplace_discovery.types.search_text.SearchText"] = None, filters: Optional["aws_sdk_marketplace_discovery.types.search_filter_list.SearchFilterList"] = None, facet_types: Optional["aws_sdk_marketplace_discovery.types.facet_type_list.FacetTypeList"] = None, next_token: Optional["aws_sdk_marketplace_discovery.types.next_token.NextToken"] = None) -> "Iterator[tuple[aws_sdk_marketplace_discovery.types.search_facet_type.SearchFacetType, aws_sdk_marketplace_discovery.types.listing_facet_list.ListingFacetList]]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    def search_listings(self, *, config_overrides: Optional[MarketplaceDiscoveryClientConfig] = None, search_text: Optional["aws_sdk_marketplace_discovery.types.search_text.SearchText"] = None, filters: Optional["aws_sdk_marketplace_discovery.types.search_filter_list.SearchFilterList"] = None, max_results: Optional["aws_sdk_marketplace_discovery.types.max_results.MaxResults"] = None, sort_by: Optional["aws_sdk_marketplace_discovery.types.search_listings_sort_by.SearchListingsSortBy"] = None, sort_order: Optional["aws_sdk_marketplace_discovery.types.search_listings_sort_order.SearchListingsSortOrder"] = None, next_token: Optional["aws_sdk_marketplace_discovery.types.next_token.NextToken"] = None) -> "aws_sdk_marketplace_discovery.types.search_listings_output.SearchListingsOutput":
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_marketplace_discovery.types.search_listings_input.SearchListingsInput]') -> OperationResponse["aws_sdk_marketplace_discovery.types.search_listings_output.SearchListingsOutput"]:
            import aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.search_listings
            output, http_response = aws_sdk_marketplace_discovery._operations.aws_marketplace_discovery.search_listings.search_listings(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def iter_search_listings(self, *, config_overrides: Optional[MarketplaceDiscoveryClientConfig] = None, search_text: Optional["aws_sdk_marketplace_discovery.types.search_text.SearchText"] = None, filters: Optional["aws_sdk_marketplace_discovery.types.search_filter_list.SearchFilterList"] = None, max_results: Optional["aws_sdk_marketplace_discovery.types.max_results.MaxResults"] = None, sort_by: Optional["aws_sdk_marketplace_discovery.types.search_listings_sort_by.SearchListingsSortBy"] = None, sort_order: Optional["aws_sdk_marketplace_discovery.types.search_listings_sort_order.SearchListingsSortOrder"] = None, next_token: Optional["aws_sdk_marketplace_discovery.types.next_token.NextToken"] = None) -> "Iterator[aws_sdk_marketplace_discovery.types.listing_summary.ListingSummary]":
        _token = next_token
        while True:
