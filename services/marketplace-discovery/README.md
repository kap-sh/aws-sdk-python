...
```
pip install aws-sdk-marketplace-discovery
```

## Usage

```python
from aws_sdk_marketplace_discovery import AsyncMarketplaceDiscoveryClient
...
```python
from aws_sdk_marketplace_discovery import AsyncMarketplaceDiscoveryClient
from aws_sdk_marketplace_discovery.error import AccessDeniedException
