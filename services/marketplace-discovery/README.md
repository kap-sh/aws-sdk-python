...
```
pip install capo-marketplace-discovery
```

## Usage

```python
from capo_marketplace_discovery import AsyncMarketplaceDiscoveryClient
...
```python
from capo_marketplace_discovery import AsyncMarketplaceDiscoveryClient
from capo_marketplace_discovery.error import AccessDeniedException
