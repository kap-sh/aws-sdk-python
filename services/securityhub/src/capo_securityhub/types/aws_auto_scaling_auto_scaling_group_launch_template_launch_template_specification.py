"""Generated from Smithy shape ``com.amazonaws.securityhub#AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecification``."""
...
# --- restJson1 ser/de ---
def serialize_json(
    value: AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecification,
) -> dict:
    out: dict = {}
