...
if TYPE_CHECKING:
    import capo_securityhub.types.security_controls
    import capo_securityhub.types.unprocessed_security_controls


class BatchGetSecurityControlsResponse(TypedDict, closed=True):
    security_controls: NotRequired[
        "capo_securityhub.types.security_controls.SecurityControls"
    ]
    ...
    unprocessed_ids: NotRequired[
        "capo_securityhub.types.unprocessed_security_controls.UnprocessedSecurityControls"
    ]
...
def serialize_json(value: BatchGetSecurityControlsResponse) -> dict:
    ...
    if "security_controls" in value:
        ...
        out["SecurityControls"] = (
            capo_securityhub.types.security_controls.serialize_json(
    ...
    if "unprocessed_ids" in value:
        ...
        out["UnprocessedIds"] = (
            capo_securityhub.types.unprocessed_security_controls.serialize_json(
...
def deserialize_json(data: dict) -> BatchGetSecurityControlsResponse:
    ...
    if "SecurityControls" in data:
        ...
        out["security_controls"] = (
            capo_securityhub.types.security_controls.deserialize_json(
    ...
    if "UnprocessedIds" in data:
        ...
        out["unprocessed_ids"] = (
            capo_securityhub.types.unprocessed_security_controls.deserialize_json(
                data["UnprocessedIds"]
            )
        )
    return out
