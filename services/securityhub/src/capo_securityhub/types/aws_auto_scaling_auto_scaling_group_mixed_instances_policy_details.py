...
if TYPE_CHECKING:
    import capo_securityhub.types.aws_auto_scaling_auto_scaling_group_mixed_instances_policy_instances_distribution_details
    import capo_securityhub.types.aws_auto_scaling_auto_scaling_group_mixed_instances_policy_launch_template_details


class AwsAutoScalingAutoScalingGroupMixedInstancesPolicyDetails(TypedDict, closed=True):
    instances_distribution: NotRequired[
        "capo_securityhub.types.aws_auto_scaling_auto_scaling_group_mixed_instances_policy_instances_distribution_details.AwsAutoScalingAutoScalingGroupMixedInstancesPolicyInstancesDistributionDetails"
    ]
    ...
    launch_template: NotRequired[
        "capo_securityhub.types.aws_auto_scaling_auto_scaling_group_mixed_instances_policy_launch_template_details.AwsAutoScalingAutoScalingGroupMixedInstancesPolicyLaunchTemplateDetails"
    ]
...
def serialize_json(
    ...
    if "instances_distribution" in value:
        ...
        out["InstancesDistribution"] = (
            capo_securityhub.types.aws_auto_scaling_auto_scaling_group_mixed_instances_policy_instances_distribution_details.serialize_json(
    ...
    if "launch_template" in value:
        ...
        out["LaunchTemplate"] = (
            capo_securityhub.types.aws_auto_scaling_auto_scaling_group_mixed_instances_policy_launch_template_details.serialize_json(
...
def deserialize_json(
    ...
    if "InstancesDistribution" in data:
        ...
        out["instances_distribution"] = (
            capo_securityhub.types.aws_auto_scaling_auto_scaling_group_mixed_instances_policy_instances_distribution_details.deserialize_json(
    ...
    if "LaunchTemplate" in data:
        ...
        out["launch_template"] = (
            capo_securityhub.types.aws_auto_scaling_auto_scaling_group_mixed_instances_policy_launch_template_details.deserialize_json(
                data["LaunchTemplate"]
            )
        )
    return out
