...
class AwsDynamoDbTableReplica(TypedDict, closed=True):
    global_secondary_indexes: NotRequired[
        "capo_securityhub.types.aws_dynamo_db_table_replica_global_secondary_index_list.AwsDynamoDbTableReplicaGlobalSecondaryIndexList"
    ]
    ...
    provisioned_throughput_override: NotRequired[
        "capo_securityhub.types.aws_dynamo_db_table_provisioned_throughput_override.AwsDynamoDbTableProvisionedThroughputOverride"
    ]
    """<p>Replica-specific configuration for the provisioned throughput.</p>"""
    region_name: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
...
def serialize_json(value: AwsDynamoDbTableReplica) -> dict:
    ...
    if "global_secondary_indexes" in value:
        ...
        out["GlobalSecondaryIndexes"] = (
            capo_securityhub.types.aws_dynamo_db_table_replica_global_secondary_index_list.serialize_json(
    ...
    if "provisioned_throughput_override" in value:
        ...
        out["ProvisionedThroughputOverride"] = (
            capo_securityhub.types.aws_dynamo_db_table_provisioned_throughput_override.serialize_json(
...
def deserialize_json(data: dict) -> AwsDynamoDbTableReplica:
    ...
    if "GlobalSecondaryIndexes" in data:
        ...
        out["global_secondary_indexes"] = (
            capo_securityhub.types.aws_dynamo_db_table_replica_global_secondary_index_list.deserialize_json(
    ...
    if "ProvisionedThroughputOverride" in data:
        ...
        out["provisioned_throughput_override"] = (
            capo_securityhub.types.aws_dynamo_db_table_provisioned_throughput_override.deserialize_json(
