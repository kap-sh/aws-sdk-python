...
class AwsNetworkFirewallRuleGroupDetails(TypedDict, closed=True):
    capacity: NotRequired["capo_securityhub.types.integer.Integer"]
    ...
    rule_group: NotRequired[
        "capo_securityhub.types.rule_group_details.RuleGroupDetails"
    ]
...
def serialize_json(value: AwsNetworkFirewallRuleGroupDetails) -> dict:
    ...
    if "rule_group" in value:
        ...
        out["RuleGroup"] = capo_securityhub.types.rule_group_details.serialize_json(
            value["rule_group"]
        )
