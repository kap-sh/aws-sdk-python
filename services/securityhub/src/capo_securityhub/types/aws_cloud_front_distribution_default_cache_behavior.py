"""Generated from Smithy shape ``com.amazonaws.securityhub#AwsCloudFrontDistributionDefaultCacheBehavior``."""
...
class AwsCloudFrontDistributionDefaultCacheBehavior(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: AwsCloudFrontDistributionDefaultCacheBehavior) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> AwsCloudFrontDistributionDefaultCacheBehavior:
    out: AwsCloudFrontDistributionDefaultCacheBehavior = {}  # type: ignore[typeddict-item]
