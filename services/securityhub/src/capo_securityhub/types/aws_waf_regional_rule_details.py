...
if TYPE_CHECKING:
    import capo_securityhub.types.aws_waf_regional_rule_predicate_list
...
class AwsWafRegionalRuleDetails(TypedDict, closed=True):
    ...
    predicate_list: NotRequired[
        "capo_securityhub.types.aws_waf_regional_rule_predicate_list.AwsWafRegionalRulePredicateList"
    ]
...
def serialize_json(value: AwsWafRegionalRuleDetails) -> dict:
    ...
    if "predicate_list" in value:
        ...
        out["PredicateList"] = (
            capo_securityhub.types.aws_waf_regional_rule_predicate_list.serialize_json(
...
def deserialize_json(data: dict) -> AwsWafRegionalRuleDetails:
    ...
    if "PredicateList" in data:
        ...
        out["predicate_list"] = (
            capo_securityhub.types.aws_waf_regional_rule_predicate_list.deserialize_json(
                data["PredicateList"]
            )
        )
    if "RuleId" in data:
