...
class AwsEc2ClientVpnEndpointDetails(TypedDict, closed=True):
    ...
    dns_server: NotRequired["capo_securityhub.types.string_list.StringList"]
    """<p> Information about the DNS servers to be used for DNS resolution. </p>"""
    split_tunnel: NotRequired["capo_securityhub.types.boolean.Boolean"]
    """<p> Indicates whether split-tunnel is enabled in the Client VPN endpoint. </p>"""
    transport_protocol: NotRequired[
        "capo_securityhub.types.non_empty_string.NonEmptyString"
    ]
    """<p> The transport protocol used by the Client VPN endpoint. </p>"""
    vpn_port: NotRequired["capo_securityhub.types.integer.Integer"]
    ...
    authentication_options: NotRequired[
        "capo_securityhub.types.aws_ec2_client_vpn_endpoint_authentication_options_list.AwsEc2ClientVpnEndpointAuthenticationOptionsList"
    ]
    """<p> Information about the authentication method used by the Client VPN endpoint. </p>"""
    connection_log_options: NotRequired[
        "capo_securityhub.types.aws_ec2_client_vpn_endpoint_connection_log_options_details.AwsEc2ClientVpnEndpointConnectionLogOptionsDetails"
    ]
    """<p> Information about the client connection logging options for the Client VPN endpoint. </p>"""
    security_group_id_set: NotRequired["capo_securityhub.types.string_list.StringList"]
    ...
    client_connect_options: NotRequired[
        "capo_securityhub.types.aws_ec2_client_vpn_endpoint_client_connect_options_details.AwsEc2ClientVpnEndpointClientConnectOptionsDetails"
    ]
    """<p> The options for managing connection authorization for new client connections. </p>"""
    session_timeout_hours: NotRequired["capo_securityhub.types.integer.Integer"]
    """<p> The maximum VPN session duration time in hours. </p>"""
    client_login_banner_options: NotRequired[
        "capo_securityhub.types.aws_ec2_client_vpn_endpoint_client_login_banner_options_details.AwsEc2ClientVpnEndpointClientLoginBannerOptionsDetails"
    ]
...
def serialize_json(value: AwsEc2ClientVpnEndpointDetails) -> dict:
    ...
    if "dns_server" in value:
        ...
        out["DnsServer"] = capo_securityhub.types.string_list.serialize_json(
            value["dns_server"]
        )
    ...
    if "authentication_options" in value:
        ...
        out["AuthenticationOptions"] = (
            capo_securityhub.types.aws_ec2_client_vpn_endpoint_authentication_options_list.serialize_json(
    ...
    if "connection_log_options" in value:
        ...
        out["ConnectionLogOptions"] = (
            capo_securityhub.types.aws_ec2_client_vpn_endpoint_connection_log_options_details.serialize_json(
    ...
    if "security_group_id_set" in value:
        ...
        out["SecurityGroupIdSet"] = capo_securityhub.types.string_list.serialize_json(
    ...
    if "client_connect_options" in value:
        ...
        out["ClientConnectOptions"] = (
            capo_securityhub.types.aws_ec2_client_vpn_endpoint_client_connect_options_details.serialize_json(
    ...
    if "client_login_banner_options" in value:
        ...
        out["ClientLoginBannerOptions"] = (
            capo_securityhub.types.aws_ec2_client_vpn_endpoint_client_login_banner_options_details.serialize_json(
...
def deserialize_json(data: dict) -> AwsEc2ClientVpnEndpointDetails:
    ...
    if "AuthenticationOptions" in data:
        ...
        out["authentication_options"] = (
            capo_securityhub.types.aws_ec2_client_vpn_endpoint_authentication_options_list.deserialize_json(
    ...
    if "ConnectionLogOptions" in data:
        ...
        out["connection_log_options"] = (
            capo_securityhub.types.aws_ec2_client_vpn_endpoint_connection_log_options_details.deserialize_json(
    ...
    if "ClientConnectOptions" in data:
        ...
        out["client_connect_options"] = (
            capo_securityhub.types.aws_ec2_client_vpn_endpoint_client_connect_options_details.deserialize_json(
    ...
    if "ClientLoginBannerOptions" in data:
        ...
        out["client_login_banner_options"] = (
            capo_securityhub.types.aws_ec2_client_vpn_endpoint_client_login_banner_options_details.deserialize_json(
