...
class AwsCodeBuildProjectEnvironmentRegistryCredential(TypedDict, closed=True):
    credential: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
