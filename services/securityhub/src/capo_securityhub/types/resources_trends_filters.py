"""Generated from Smithy shape ``com.amazonaws.securityhub#ResourcesTrendsFilters``."""
...
class ResourcesTrendsFilters(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ResourcesTrendsFilters) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ResourcesTrendsFilters:
    out: ResourcesTrendsFilters = {}  # type: ignore[typeddict-item]
