...
class AwsEksClusterDetails(TypedDict, closed=True):
    ...
    resources_vpc_config: NotRequired[
        "capo_securityhub.types.aws_eks_cluster_resources_vpc_config_details.AwsEksClusterResourcesVpcConfigDetails"
    ]
    ...
    logging: NotRequired[
        "capo_securityhub.types.aws_eks_cluster_logging_details.AwsEksClusterLoggingDetails"
    ]
...
def serialize_json(value: AwsEksClusterDetails) -> dict:
    ...
    if "resources_vpc_config" in value:
        ...
        out["ResourcesVpcConfig"] = (
            capo_securityhub.types.aws_eks_cluster_resources_vpc_config_details.serialize_json(
    ...
    if "logging" in value:
        ...
        out["Logging"] = (
            capo_securityhub.types.aws_eks_cluster_logging_details.serialize_json(
                value["logging"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> AwsEksClusterDetails:
    ...
    if "ResourcesVpcConfig" in data:
        ...
        out["resources_vpc_config"] = (
            capo_securityhub.types.aws_eks_cluster_resources_vpc_config_details.deserialize_json(
    ...
    if "Logging" in data:
        ...
        out["logging"] = (
            capo_securityhub.types.aws_eks_cluster_logging_details.deserialize_json(
                data["Logging"]
            )
        )
    return out
