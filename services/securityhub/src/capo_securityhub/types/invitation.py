...
class Invitation(TypedDict, closed=True):
    ...
    invited_at: NotRequired["capo_securityhub.types.timestamp.Timestamp"]
    """<p>The timestamp of when the invitation was sent.</p>"""
    member_status: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
...
def serialize_json(value: Invitation) -> dict:
    ...
    if "invited_at" in value:
        ...
        out["InvitedAt"] = capo_securityhub.types.timestamp.serialize_json(
            value["invited_at"]
        )
