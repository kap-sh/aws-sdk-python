...
if TYPE_CHECKING:
    import capo_securityhub.types.aws_s3_bucket_notification_configuration_s3_key_filter_rule

AwsS3BucketNotificationConfigurationS3KeyFilterRules: TypeAlias = list[
    "capo_securityhub.types.aws_s3_bucket_notification_configuration_s3_key_filter_rule.AwsS3BucketNotificationConfigurationS3KeyFilterRule"
]
...
def serialize_json(value: AwsS3BucketNotificationConfigurationS3KeyFilterRules) -> list:
    ...
    for item in value:
        out.append(
            capo_securityhub.types.aws_s3_bucket_notification_configuration_s3_key_filter_rule.serialize_json(
                item
            )
        )
    return out
