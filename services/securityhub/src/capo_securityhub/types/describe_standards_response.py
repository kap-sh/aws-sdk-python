...
class DescribeStandardsResponse(TypedDict, closed=True):
    standards: NotRequired["capo_securityhub.types.standards.Standards"]
...
def serialize_json(value: DescribeStandardsResponse) -> dict:
    ...
    if "standards" in value:
        ...
        out["Standards"] = capo_securityhub.types.standards.serialize_json(
            value["standards"]
        )
...
def deserialize_json(data: dict) -> DescribeStandardsResponse:
    ...
    if "Standards" in data:
        ...
        out["standards"] = capo_securityhub.types.standards.deserialize_json(
            data["Standards"]
        )
