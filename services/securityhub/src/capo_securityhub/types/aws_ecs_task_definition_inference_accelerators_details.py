...
class AwsEcsTaskDefinitionInferenceAcceleratorsDetails(TypedDict, closed=True):
    ...
    device_type: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
