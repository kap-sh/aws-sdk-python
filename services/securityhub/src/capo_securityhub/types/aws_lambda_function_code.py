...
class AwsLambdaFunctionCode(TypedDict, closed=True):
    s3_bucket: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>An Amazon S3 bucket in the same Amazon Web Services Region as your function. The bucket can be in a different Amazon Web Services account.</p>"""
    s3_key: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>The Amazon S3 key of the deployment package.</p>"""
    s3_object_version: NotRequired[
        "capo_securityhub.types.non_empty_string.NonEmptyString"
    ]
    """<p>For versioned objects, the version of the deployment package object to use.</p>"""
    zip_file: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
