...
def serialize_json(value: GetResourcesTrendsV2Response) -> dict:
    ...
    if "granularity" in value:
        ...
        out["Granularity"] = capo_securityhub.types.granularity_field.serialize_json(
            value["granularity"]
        )
    if "trends_metrics" in value:
        ...
        out["TrendsMetrics"] = (
            capo_securityhub.types.resources_trends_metrics.serialize_json(
...
def deserialize_json(data: dict) -> GetResourcesTrendsV2Response:
    ...
    if "TrendsMetrics" in data:
        ...
        out["trends_metrics"] = (
            capo_securityhub.types.resources_trends_metrics.deserialize_json(
                data["TrendsMetrics"]
            )
        )
