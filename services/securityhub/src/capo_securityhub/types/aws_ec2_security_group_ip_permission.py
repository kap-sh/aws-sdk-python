...
class AwsEc2SecurityGroupIpPermission(TypedDict, closed=True):
    ip_protocol: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    user_id_group_pairs: NotRequired[
        "capo_securityhub.types.aws_ec2_security_group_user_id_group_pair_list.AwsEc2SecurityGroupUserIdGroupPairList"
    ]
    """<p>The security group and Amazon Web Services account ID pairs.</p>"""
    ip_ranges: NotRequired[
        "capo_securityhub.types.aws_ec2_security_group_ip_range_list.AwsEc2SecurityGroupIpRangeList"
    ]
    """<p>The IPv4 ranges.</p>"""
    ipv6_ranges: NotRequired[
        "capo_securityhub.types.aws_ec2_security_group_ipv6_range_list.AwsEc2SecurityGroupIpv6RangeList"
    ]
    """<p>The IPv6 ranges.</p>"""
    prefix_list_ids: NotRequired[
        "capo_securityhub.types.aws_ec2_security_group_prefix_list_id_list.AwsEc2SecurityGroupPrefixListIdList"
    ]
...
def serialize_json(value: AwsEc2SecurityGroupIpPermission) -> dict:
    ...
    if "user_id_group_pairs" in value:
        ...
        out["UserIdGroupPairs"] = (
            capo_securityhub.types.aws_ec2_security_group_user_id_group_pair_list.serialize_json(
    ...
    if "ip_ranges" in value:
        ...
        out["IpRanges"] = (
            capo_securityhub.types.aws_ec2_security_group_ip_range_list.serialize_json(
                value["ip_ranges"]
            )
        )
    if "ipv6_ranges" in value:
        ...
        out["Ipv6Ranges"] = (
            capo_securityhub.types.aws_ec2_security_group_ipv6_range_list.serialize_json(
                value["ipv6_ranges"]
            )
        )
    if "prefix_list_ids" in value:
        ...
        out["PrefixListIds"] = (
            capo_securityhub.types.aws_ec2_security_group_prefix_list_id_list.serialize_json(
...
def deserialize_json(data: dict) -> AwsEc2SecurityGroupIpPermission:
    ...
    if "UserIdGroupPairs" in data:
        ...
        out["user_id_group_pairs"] = (
            capo_securityhub.types.aws_ec2_security_group_user_id_group_pair_list.deserialize_json(
    ...
    if "IpRanges" in data:
        ...
        out["ip_ranges"] = (
            capo_securityhub.types.aws_ec2_security_group_ip_range_list.deserialize_json(
                data["IpRanges"]
            )
        )
    if "Ipv6Ranges" in data:
        ...
        out["ipv6_ranges"] = (
            capo_securityhub.types.aws_ec2_security_group_ipv6_range_list.deserialize_json(
                data["Ipv6Ranges"]
            )
        )
    if "PrefixListIds" in data:
        ...
        out["prefix_list_ids"] = (
            capo_securityhub.types.aws_ec2_security_group_prefix_list_id_list.deserialize_json(
                data["PrefixListIds"]
            )
        )
    return out
