...
class AwsRdsDbDomainMembership(TypedDict, closed=True):
    ...
    fqdn: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>The fully qualified domain name of the Active Directory domain.</p>"""
    iam_role_name: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
