...
class AwsOpenSearchServiceDomainDetails(TypedDict, closed=True):
    ...
    encryption_at_rest_options: NotRequired[
        "capo_securityhub.types.aws_open_search_service_domain_encryption_at_rest_options_details.AwsOpenSearchServiceDomainEncryptionAtRestOptionsDetails"
    ]
    """<p>Details about the configuration for encryption at rest.</p>"""
    node_to_node_encryption_options: NotRequired[
        "capo_securityhub.types.aws_open_search_service_domain_node_to_node_encryption_options_details.AwsOpenSearchServiceDomainNodeToNodeEncryptionOptionsDetails"
    ]
    """<p>Details about the configuration for node-to-node encryption.</p>"""
    service_software_options: NotRequired[
        "capo_securityhub.types.aws_open_search_service_domain_service_software_options_details.AwsOpenSearchServiceDomainServiceSoftwareOptionsDetails"
    ]
    """<p>Information about the status of a domain relative to the latest service software.</p>"""
    cluster_config: NotRequired[
        "capo_securityhub.types.aws_open_search_service_domain_cluster_config_details.AwsOpenSearchServiceDomainClusterConfigDetails"
    ]
    """<p>Details about the configuration of an OpenSearch cluster.</p>"""
    domain_endpoint_options: NotRequired[
        "capo_securityhub.types.aws_open_search_service_domain_domain_endpoint_options_details.AwsOpenSearchServiceDomainDomainEndpointOptionsDetails"
    ]
    """<p>Additional options for the domain endpoint.</p>"""
    vpc_options: NotRequired[
        "capo_securityhub.types.aws_open_search_service_domain_vpc_options_details.AwsOpenSearchServiceDomainVpcOptionsDetails"
    ]
    ...
    log_publishing_options: NotRequired[
        "capo_securityhub.types.aws_open_search_service_domain_log_publishing_options_details.AwsOpenSearchServiceDomainLogPublishingOptionsDetails"
    ]
    """<p>Configures the CloudWatch Logs to publish for the OpenSearch domain.</p>"""
    domain_endpoints: NotRequired["capo_securityhub.types.field_map.FieldMap"]
    ...
    advanced_security_options: NotRequired[
        "capo_securityhub.types.aws_open_search_service_domain_advanced_security_options_details.AwsOpenSearchServiceDomainAdvancedSecurityOptionsDetails"
    ]
...
def serialize_json(value: AwsOpenSearchServiceDomainDetails) -> dict:
    ...
    if "encryption_at_rest_options" in value:
        ...
        out["EncryptionAtRestOptions"] = (
            capo_securityhub.types.aws_open_search_service_domain_encryption_at_rest_options_details.serialize_json(
    ...
    if "node_to_node_encryption_options" in value:
        ...
        out["NodeToNodeEncryptionOptions"] = (
            capo_securityhub.types.aws_open_search_service_domain_node_to_node_encryption_options_details.serialize_json(
    ...
    if "service_software_options" in value:
        ...
        out["ServiceSoftwareOptions"] = (
            capo_securityhub.types.aws_open_search_service_domain_service_software_options_details.serialize_json(
    ...
    if "cluster_config" in value:
        ...
        out["ClusterConfig"] = (
            capo_securityhub.types.aws_open_search_service_domain_cluster_config_details.serialize_json(
    ...
    if "domain_endpoint_options" in value:
        ...
        out["DomainEndpointOptions"] = (
            capo_securityhub.types.aws_open_search_service_domain_domain_endpoint_options_details.serialize_json(
    ...
    if "vpc_options" in value:
        ...
        out["VpcOptions"] = (
            capo_securityhub.types.aws_open_search_service_domain_vpc_options_details.serialize_json(
                value["vpc_options"]
            )
        )
    if "log_publishing_options" in value:
        ...
        out["LogPublishingOptions"] = (
            capo_securityhub.types.aws_open_search_service_domain_log_publishing_options_details.serialize_json(
    ...
    if "domain_endpoints" in value:
        ...
        out["DomainEndpoints"] = capo_securityhub.types.field_map.serialize_json(
    ...
    if "advanced_security_options" in value:
        ...
        out["AdvancedSecurityOptions"] = (
            capo_securityhub.types.aws_open_search_service_domain_advanced_security_options_details.serialize_json(
...
def deserialize_json(data: dict) -> AwsOpenSearchServiceDomainDetails:
    ...
    if "EncryptionAtRestOptions" in data:
        ...
        out["encryption_at_rest_options"] = (
            capo_securityhub.types.aws_open_search_service_domain_encryption_at_rest_options_details.deserialize_json(
    ...
    if "NodeToNodeEncryptionOptions" in data:
        ...
        out["node_to_node_encryption_options"] = (
            capo_securityhub.types.aws_open_search_service_domain_node_to_node_encryption_options_details.deserialize_json(
    ...
    if "ServiceSoftwareOptions" in data:
        ...
        out["service_software_options"] = (
            capo_securityhub.types.aws_open_search_service_domain_service_software_options_details.deserialize_json(
    ...
    if "ClusterConfig" in data:
        ...
        out["cluster_config"] = (
            capo_securityhub.types.aws_open_search_service_domain_cluster_config_details.deserialize_json(
                data["ClusterConfig"]
            )
        )
    if "DomainEndpointOptions" in data:
        ...
        out["domain_endpoint_options"] = (
            capo_securityhub.types.aws_open_search_service_domain_domain_endpoint_options_details.deserialize_json(
    ...
    if "VpcOptions" in data:
        ...
        out["vpc_options"] = (
            capo_securityhub.types.aws_open_search_service_domain_vpc_options_details.deserialize_json(
                data["VpcOptions"]
            )
        )
    if "LogPublishingOptions" in data:
        ...
        out["log_publishing_options"] = (
            capo_securityhub.types.aws_open_search_service_domain_log_publishing_options_details.deserialize_json(
    ...
    if "AdvancedSecurityOptions" in data:
        ...
        out["advanced_security_options"] = (
            capo_securityhub.types.aws_open_search_service_domain_advanced_security_options_details.deserialize_json(
