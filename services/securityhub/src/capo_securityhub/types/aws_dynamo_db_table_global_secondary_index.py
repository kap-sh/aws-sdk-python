...
class AwsDynamoDbTableGlobalSecondaryIndex(TypedDict, closed=True):
    backfilling: NotRequired["capo_securityhub.types.boolean.Boolean"]
    """<p>Whether the index is currently backfilling.</p>"""
    index_arn: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>The ARN of the index.</p>"""
    index_name: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>The name of the index.</p>"""
    index_size_bytes: NotRequired["capo_securityhub.types.size_bytes.SizeBytes"]
    """<p>The total size in bytes of the index.</p>"""
    index_status: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    projection: NotRequired[
        "capo_securityhub.types.aws_dynamo_db_table_projection.AwsDynamoDbTableProjection"
    ]
...
def serialize_json(value: AwsDynamoDbTableGlobalSecondaryIndex) -> dict:
    ...
    if "projection" in value:
        ...
        out["Projection"] = (
            capo_securityhub.types.aws_dynamo_db_table_projection.serialize_json(
                value["projection"]
            )
        )
...
def deserialize_json(data: dict) -> AwsDynamoDbTableGlobalSecondaryIndex:
    ...
    if "Projection" in data:
        ...
        out["projection"] = (
            capo_securityhub.types.aws_dynamo_db_table_projection.deserialize_json(
                data["Projection"]
            )
        )
