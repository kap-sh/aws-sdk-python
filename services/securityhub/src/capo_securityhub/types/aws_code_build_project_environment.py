...
class AwsCodeBuildProjectEnvironment(TypedDict, closed=True):
    certificate: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>The certificate to use with this build project.</p>"""
    environment_variables: NotRequired[
        "capo_securityhub.types.aws_code_build_project_environment_environment_variables_list.AwsCodeBuildProjectEnvironmentEnvironmentVariablesList"
    ]
    """<p>A set of environment variables to make available to builds for the build project.</p>"""
    privileged_mode: NotRequired["capo_securityhub.types.boolean.Boolean"]
    ...
    registry_credential: NotRequired[
        "capo_securityhub.types.aws_code_build_project_environment_registry_credential.AwsCodeBuildProjectEnvironmentRegistryCredential"
    ]
...
def serialize_json(value: AwsCodeBuildProjectEnvironment) -> dict:
    ...
    if "environment_variables" in value:
        ...
        out["EnvironmentVariables"] = (
            capo_securityhub.types.aws_code_build_project_environment_environment_variables_list.serialize_json(
    ...
    if "registry_credential" in value:
        ...
        out["RegistryCredential"] = (
            capo_securityhub.types.aws_code_build_project_environment_registry_credential.serialize_json(
...
def deserialize_json(data: dict) -> AwsCodeBuildProjectEnvironment:
    ...
    if "EnvironmentVariables" in data:
        ...
        out["environment_variables"] = (
            capo_securityhub.types.aws_code_build_project_environment_environment_variables_list.deserialize_json(
    ...
    if "RegistryCredential" in data:
        ...
        out["registry_credential"] = (
            capo_securityhub.types.aws_code_build_project_environment_registry_credential.deserialize_json(
