...
class AwsAppSyncGraphQlApiUserPoolConfigDetails(TypedDict, closed=True):
    ...
    aws_region: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    user_pool_id: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
