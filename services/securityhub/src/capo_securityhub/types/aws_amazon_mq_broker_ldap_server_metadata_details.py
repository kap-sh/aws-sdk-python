...
class AwsAmazonMqBrokerLdapServerMetadataDetails(TypedDict, closed=True):
    hosts: NotRequired["capo_securityhub.types.string_list.StringList"]
    ...
    role_base: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    role_search_subtree: NotRequired["capo_securityhub.types.boolean.Boolean"]
    ...
    user_base: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    user_search_subtree: NotRequired["capo_securityhub.types.boolean.Boolean"]
...
def serialize_json(value: AwsAmazonMqBrokerLdapServerMetadataDetails) -> dict:
    ...
    if "hosts" in value:
        ...
        out["Hosts"] = capo_securityhub.types.string_list.serialize_json(value["hosts"])
