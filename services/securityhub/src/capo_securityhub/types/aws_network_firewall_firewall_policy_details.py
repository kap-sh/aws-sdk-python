...
class AwsNetworkFirewallFirewallPolicyDetails(TypedDict, closed=True):
    firewall_policy: NotRequired[
        "capo_securityhub.types.firewall_policy_details.FirewallPolicyDetails"
    ]
...
def serialize_json(value: AwsNetworkFirewallFirewallPolicyDetails) -> dict:
    ...
    if "firewall_policy" in value:
        ...
        out["FirewallPolicy"] = (
            capo_securityhub.types.firewall_policy_details.serialize_json(
...
def deserialize_json(data: dict) -> AwsNetworkFirewallFirewallPolicyDetails:
    ...
    if "FirewallPolicy" in data:
        ...
        out["firewall_policy"] = (
            capo_securityhub.types.firewall_policy_details.deserialize_json(
                data["FirewallPolicy"]
            )
        )
