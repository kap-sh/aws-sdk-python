...
class AwsAppSyncGraphQlApiDetails(TypedDict, closed=True):
    ...
    open_id_connect_config: NotRequired[
        "capo_securityhub.types.aws_app_sync_graph_ql_api_open_id_connect_config_details.AwsAppSyncGraphQlApiOpenIdConnectConfigDetails"
    ]
    ...
    lambda_authorizer_config: NotRequired[
        "capo_securityhub.types.aws_app_sync_graph_ql_api_lambda_authorizer_config_details.AwsAppSyncGraphQlApiLambdaAuthorizerConfigDetails"
    ]
    """<p> Specifies the configuration for Lambda function authorization. </p>"""
    xray_enabled: NotRequired["capo_securityhub.types.boolean.Boolean"]
    ...
    user_pool_config: NotRequired[
        "capo_securityhub.types.aws_app_sync_graph_ql_api_user_pool_config_details.AwsAppSyncGraphQlApiUserPoolConfigDetails"
    ]
    ...
    log_config: NotRequired[
        "capo_securityhub.types.aws_app_sync_graph_ql_api_log_config_details.AwsAppSyncGraphQlApiLogConfigDetails"
    ]
    """<p> The Amazon CloudWatch Logs configuration. </p>"""
    additional_authentication_providers: NotRequired[
        "capo_securityhub.types.aws_app_sync_graph_ql_api_additional_authentication_providers_list.AwsAppSyncGraphQlApiAdditionalAuthenticationProvidersList"
    ]
...
def serialize_json(value: AwsAppSyncGraphQlApiDetails) -> dict:
    ...
    if "open_id_connect_config" in value:
        ...
        out["OpenIdConnectConfig"] = (
            capo_securityhub.types.aws_app_sync_graph_ql_api_open_id_connect_config_details.serialize_json(
    ...
    if "lambda_authorizer_config" in value:
        ...
        out["LambdaAuthorizerConfig"] = (
            capo_securityhub.types.aws_app_sync_graph_ql_api_lambda_authorizer_config_details.serialize_json(
    ...
    if "user_pool_config" in value:
        ...
        out["UserPoolConfig"] = (
            capo_securityhub.types.aws_app_sync_graph_ql_api_user_pool_config_details.serialize_json(
    ...
    if "log_config" in value:
        ...
        out["LogConfig"] = (
            capo_securityhub.types.aws_app_sync_graph_ql_api_log_config_details.serialize_json(
                value["log_config"]
            )
        )
    if "additional_authentication_providers" in value:
        ...
        out["AdditionalAuthenticationProviders"] = (
            capo_securityhub.types.aws_app_sync_graph_ql_api_additional_authentication_providers_list.serialize_json(
...
def deserialize_json(data: dict) -> AwsAppSyncGraphQlApiDetails:
    ...
    if "OpenIdConnectConfig" in data:
        ...
        out["open_id_connect_config"] = (
            capo_securityhub.types.aws_app_sync_graph_ql_api_open_id_connect_config_details.deserialize_json(
    ...
    if "LambdaAuthorizerConfig" in data:
        ...
        out["lambda_authorizer_config"] = (
            capo_securityhub.types.aws_app_sync_graph_ql_api_lambda_authorizer_config_details.deserialize_json(
    ...
    if "UserPoolConfig" in data:
        ...
        out["user_pool_config"] = (
            capo_securityhub.types.aws_app_sync_graph_ql_api_user_pool_config_details.deserialize_json(
                data["UserPoolConfig"]
            )
        )
    ...
    if "LogConfig" in data:
        ...
        out["log_config"] = (
            capo_securityhub.types.aws_app_sync_graph_ql_api_log_config_details.deserialize_json(
                data["LogConfig"]
            )
        )
    if "AdditionalAuthenticationProviders" in data:
        ...
        out["additional_authentication_providers"] = (
            capo_securityhub.types.aws_app_sync_graph_ql_api_additional_authentication_providers_list.deserialize_json(
