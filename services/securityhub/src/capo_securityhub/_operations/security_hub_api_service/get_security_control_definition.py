"""Generated from Smithy shape ``com.amazonaws.securityhub#GetSecurityControlDefinition``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.get_security_control_definition_response.GetSecurityControlDefinitionResponse = capo_securityhub.types.get_security_control_definition_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/securityControl/definition"
    params: dict[str, str] = {}
    if "security_control_id" in input_:
        params["SecurityControlId"] = str(input_["security_control_id"])
...
async def async_get_security_control_definition(
