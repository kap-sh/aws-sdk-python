"""Generated from Smithy shape ``com.amazonaws.securityhub#EnableSecurityHub``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.enable_security_hub_response.EnableSecurityHubResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.enable_security_hub_request.serialize_json(input_)
    ).encode()
...
async def async_enable_security_hub(
