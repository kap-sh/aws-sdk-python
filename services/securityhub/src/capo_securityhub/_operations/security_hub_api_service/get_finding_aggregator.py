...
def handle_response(
    ...
    out: capo_securityhub.types.get_finding_aggregator_response.GetFindingAggregatorResponse = capo_securityhub.types.get_finding_aggregator_response.deserialize_json(
