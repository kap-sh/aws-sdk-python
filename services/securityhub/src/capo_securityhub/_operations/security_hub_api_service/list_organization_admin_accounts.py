"""Generated from Smithy shape ``com.amazonaws.securityhub#ListOrganizationAdminAccounts``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.list_organization_admin_accounts_response.ListOrganizationAdminAccountsResponse = capo_securityhub.types.list_organization_admin_accounts_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/organization/admin"
    params: dict[str, str] = {}
    if "max_results" in input_:
        params["MaxResults"] = str(input_["max_results"])
    if "next_token" in input_:
        params["NextToken"] = str(input_["next_token"])
    if "feature" in input_:
        params["Feature"] = str(input_["feature"])
