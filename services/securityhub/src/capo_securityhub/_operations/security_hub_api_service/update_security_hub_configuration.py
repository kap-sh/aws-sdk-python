...
def handle_response(
    ...
    out: capo_securityhub.types.update_security_hub_configuration_response.UpdateSecurityHubConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.update_security_hub_configuration_request.serialize_json(
            input_
        )
    ).encode()
