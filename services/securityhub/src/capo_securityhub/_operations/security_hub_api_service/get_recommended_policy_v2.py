"""Generated from Smithy shape ``com.amazonaws.securityhub#GetRecommendedPolicyV2``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.get_recommended_policy_v2_response.GetRecommendedPolicyV2Response = capo_securityhub.types.get_recommended_policy_v2_response.deserialize_json(
...
async def async_get_recommended_policy_v2(
