...
def handle_response(
    ...
    out: capo_securityhub.types.get_enabled_standards_response.GetEnabledStandardsResponse = capo_securityhub.types.get_enabled_standards_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.get_enabled_standards_request.serialize_json(input_)
    ).encode()
