"""Generated from Smithy shape ``com.amazonaws.securityhub#CreateMembers``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.create_members_response.CreateMembersResponse = (
        capo_securityhub.types.create_members_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.create_members_request.serialize_json(input_)
    ).encode()
