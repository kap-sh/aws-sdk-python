...
def handle_response(
    ...
    out: capo_securityhub.types.disable_organization_admin_account_response.DisableOrganizationAdminAccountResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.disable_organization_admin_account_request.serialize_json(
            input_
        )
    ).encode()
