"""Generated from Smithy shape ``com.amazonaws.securityhub#UpdateOrganizationConfiguration``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.update_organization_configuration_response.UpdateOrganizationConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.update_organization_configuration_request.serialize_json(
            input_
        )
    ).encode()
