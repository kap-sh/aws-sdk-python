...
def handle_response(
    ...
    out: capo_securityhub.types.batch_import_findings_response.BatchImportFindingsResponse = capo_securityhub.types.batch_import_findings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.batch_import_findings_request.serialize_json(input_)
    ).encode()
