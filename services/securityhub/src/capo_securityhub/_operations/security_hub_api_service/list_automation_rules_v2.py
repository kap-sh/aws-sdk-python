...
def handle_response(
    ...
    out: capo_securityhub.types.list_automation_rules_v2_response.ListAutomationRulesV2Response = capo_securityhub.types.list_automation_rules_v2_response.deserialize_json(
