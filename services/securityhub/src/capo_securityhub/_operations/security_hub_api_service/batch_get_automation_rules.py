...
def handle_response(
    ...
    out: capo_securityhub.types.batch_get_automation_rules_response.BatchGetAutomationRulesResponse = capo_securityhub.types.batch_get_automation_rules_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.batch_get_automation_rules_request.serialize_json(input_)
    ).encode()
