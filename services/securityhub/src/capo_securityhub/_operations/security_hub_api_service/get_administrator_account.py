...
def handle_response(
    ...
    out: capo_securityhub.types.get_administrator_account_response.GetAdministratorAccountResponse = capo_securityhub.types.get_administrator_account_response.deserialize_json(
