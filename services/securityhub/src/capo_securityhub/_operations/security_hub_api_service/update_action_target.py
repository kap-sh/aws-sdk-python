...
def handle_response(
    ...
    out: capo_securityhub.types.update_action_target_response.UpdateActionTargetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.update_action_target_request.serialize_json(input_)
    ).encode()
