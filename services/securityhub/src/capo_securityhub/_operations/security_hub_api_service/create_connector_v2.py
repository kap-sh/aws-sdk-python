"""Generated from Smithy shape ``com.amazonaws.securityhub#CreateConnectorV2``."""
...
import capo_securityhub.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_securityhub.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_securityhub.types.create_connector_v2_response.CreateConnectorV2Response = capo_securityhub.types.create_connector_v2_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.create_connector_v2_request.serialize_json(input_)
    ).encode()
...
async def async_create_connector_v2(
