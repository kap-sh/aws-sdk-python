...
def handle_response(
    ...
    out: capo_securityhub.types.create_insight_response.CreateInsightResponse = (
        capo_securityhub.types.create_insight_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.create_insight_request.serialize_json(input_)
    ).encode()
