...
def handle_response(
    ...
    out: capo_securityhub.types.update_configuration_policy_response.UpdateConfigurationPolicyResponse = capo_securityhub.types.update_configuration_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.update_configuration_policy_request.serialize_json(
            input_
        )
    ).encode()
