"""Generated from Smithy shape ``com.amazonaws.securityhub#ListEnabledProductsForImport``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.list_enabled_products_for_import_response.ListEnabledProductsForImportResponse = capo_securityhub.types.list_enabled_products_for_import_response.deserialize_json(
...
async def async_list_enabled_products_for_import(
