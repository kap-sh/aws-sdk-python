...
def handle_response(
    ...
    out: capo_securityhub.types.enable_import_findings_for_product_response.EnableImportFindingsForProductResponse = capo_securityhub.types.enable_import_findings_for_product_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.enable_import_findings_for_product_request.serialize_json(
            input_
        )
    ).encode()
