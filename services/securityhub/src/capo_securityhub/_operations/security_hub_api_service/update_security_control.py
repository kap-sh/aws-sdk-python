...
import capo_securityhub.errors.resource_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise capo_securityhub.errors.resource_in_use_exception.ResourceInUseException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_securityhub.types.update_security_control_response.UpdateSecurityControlResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.update_security_control_request.serialize_json(input_)
    ).encode()
