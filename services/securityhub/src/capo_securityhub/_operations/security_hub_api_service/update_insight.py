"""Generated from Smithy shape ``com.amazonaws.securityhub#UpdateInsight``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.update_insight_response.UpdateInsightResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.update_insight_request.serialize_json(input_)
    ).encode()
