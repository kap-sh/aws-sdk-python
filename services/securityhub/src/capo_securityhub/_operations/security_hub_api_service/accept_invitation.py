...
def handle_response(
    ...
    out: capo_securityhub.types.accept_invitation_response.AcceptInvitationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.accept_invitation_request.serialize_json(input_)
    ).encode()
