"""Generated from Smithy shape ``com.amazonaws.securityhub#GetInsights``."""
...
import capo_securityhub.types.insight_list
...
def handle_response(
    ...
    out: capo_securityhub.types.get_insights_response.GetInsightsResponse = (
        capo_securityhub.types.get_insights_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/insights/get"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_securityhub.types.get_insights_request.serialize_json(input_)
    ).encode()
...
def get_insights(
    ...
    capo_securityhub.types.get_insights_response.GetInsightsResponse, zapros.Response
]:
