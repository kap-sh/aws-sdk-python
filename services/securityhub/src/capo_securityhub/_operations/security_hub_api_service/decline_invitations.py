...
def handle_response(
    ...
    out: capo_securityhub.types.decline_invitations_response.DeclineInvitationsResponse = capo_securityhub.types.decline_invitations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.decline_invitations_request.serialize_json(input_)
    ).encode()
