"""Generated from Smithy shape ``com.amazonaws.securityhub#GetConnectorV2``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.get_connector_v2_response.GetConnectorV2Response = (
        capo_securityhub.types.get_connector_v2_response.deserialize_json(
...
async def async_get_connector_v2(
