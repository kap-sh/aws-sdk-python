"""Generated from Smithy shape ``com.amazonaws.securityhub#DescribeStandards``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.describe_standards_response.DescribeStandardsResponse = capo_securityhub.types.describe_standards_response.deserialize_json(
...
async def async_describe_standards(
