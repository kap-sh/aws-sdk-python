...
def handle_response(
    ...
    out: capo_securityhub.types.batch_enable_standards_response.BatchEnableStandardsResponse = capo_securityhub.types.batch_enable_standards_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.batch_enable_standards_request.serialize_json(input_)
    ).encode()
