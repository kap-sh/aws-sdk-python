...
def handle_response(
    ...
    out: capo_securityhub.types.list_aggregators_v2_response.ListAggregatorsV2Response = capo_securityhub.types.list_aggregators_v2_response.deserialize_json(
