...
def handle_response(
    ...
    out: capo_securityhub.types.list_automation_rules_response.ListAutomationRulesResponse = capo_securityhub.types.list_automation_rules_response.deserialize_json(
