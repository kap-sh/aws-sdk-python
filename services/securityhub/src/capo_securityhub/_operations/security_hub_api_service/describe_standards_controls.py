...
def handle_response(
    ...
    out: capo_securityhub.types.describe_standards_controls_response.DescribeStandardsControlsResponse = capo_securityhub.types.describe_standards_controls_response.deserialize_json(
