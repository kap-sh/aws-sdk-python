"""Generated from Smithy shape ``com.amazonaws.securityhub#GetInsightResults``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.get_insight_results_response.GetInsightResultsResponse = capo_securityhub.types.get_insight_results_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/insights/results/{InsightArn+}"
...
async def async_get_insight_results(
