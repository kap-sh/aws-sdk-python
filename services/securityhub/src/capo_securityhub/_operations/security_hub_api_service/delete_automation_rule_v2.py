"""Generated from Smithy shape ``com.amazonaws.securityhub#DeleteAutomationRuleV2``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.delete_automation_rule_v2_response.DeleteAutomationRuleV2Response = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_automation_rule_v2(
