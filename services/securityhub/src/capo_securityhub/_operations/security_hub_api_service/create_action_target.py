...
def handle_response(
    ...
    out: capo_securityhub.types.create_action_target_response.CreateActionTargetResponse = capo_securityhub.types.create_action_target_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.create_action_target_request.serialize_json(input_)
    ).encode()
