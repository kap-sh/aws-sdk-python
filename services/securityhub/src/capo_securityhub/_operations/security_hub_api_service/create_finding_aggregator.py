"""Generated from Smithy shape ``com.amazonaws.securityhub#CreateFindingAggregator``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.create_finding_aggregator_response.CreateFindingAggregatorResponse = capo_securityhub.types.create_finding_aggregator_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.create_finding_aggregator_request.serialize_json(input_)
    ).encode()
...
async def async_create_finding_aggregator(
