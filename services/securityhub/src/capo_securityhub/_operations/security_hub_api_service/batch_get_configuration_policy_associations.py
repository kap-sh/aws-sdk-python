"""Generated from Smithy shape ``com.amazonaws.securityhub#BatchGetConfigurationPolicyAssociations``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.batch_get_configuration_policy_associations_response.BatchGetConfigurationPolicyAssociationsResponse = capo_securityhub.types.batch_get_configuration_policy_associations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.batch_get_configuration_policy_associations_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_get_configuration_policy_associations(
