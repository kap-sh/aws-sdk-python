"""Generated from Smithy shape ``com.amazonaws.securityhub#GetInvitationsCount``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.get_invitations_count_response.GetInvitationsCountResponse = capo_securityhub.types.get_invitations_count_response.deserialize_json(
