"""Generated from Smithy shape ``com.amazonaws.securityhub#ListInvitations``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.list_invitations_response.ListInvitationsResponse = (
        capo_securityhub.types.list_invitations_response.deserialize_json(
