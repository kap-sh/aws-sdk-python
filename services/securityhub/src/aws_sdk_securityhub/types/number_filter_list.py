...
NumberFilterList: TypeAlias = list[
    "aws_sdk_securityhub.types.number_filter.NumberFilter"
]
...
def serialize_json(value: NumberFilterList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_securityhub.types.number_filter.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> NumberFilterList:
    ...
    for item in data:
        out.append(aws_sdk_securityhub.types.number_filter.deserialize_json(item))
    return out
