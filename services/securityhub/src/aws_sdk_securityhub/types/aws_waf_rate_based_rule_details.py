"""Generated from Smithy shape ``com.amazonaws.securityhub#AwsWafRateBasedRuleDetails``."""
...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_waf_rate_based_rule_match_predicate_list
    import aws_sdk_securityhub.types.long
    import aws_sdk_securityhub.types.non_empty_string


class AwsWafRateBasedRuleDetails(TypedDict, closed=True):
    ...
    match_predicates: NotRequired[
        "aws_sdk_securityhub.types.aws_waf_rate_based_rule_match_predicate_list.AwsWafRateBasedRuleMatchPredicateList"
    ]
    """<p>The predicates to include in the rate-based rule.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: AwsWafRateBasedRuleDetails) -> dict:
    out: dict = {}
    ...
    if "match_predicates" in value:
        ...
        out["MatchPredicates"] = (
            aws_sdk_securityhub.types.aws_waf_rate_based_rule_match_predicate_list.serialize_json(
...
def deserialize_json(data: dict) -> AwsWafRateBasedRuleDetails:
    out: AwsWafRateBasedRuleDetails = {}  # type: ignore[typeddict-item]
    ...
    if "MatchPredicates" in data:
        ...
        out["match_predicates"] = (
            aws_sdk_securityhub.types.aws_waf_rate_based_rule_match_predicate_list.deserialize_json(
