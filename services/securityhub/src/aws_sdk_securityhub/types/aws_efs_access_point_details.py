...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_efs_access_point_posix_user_details
    import aws_sdk_securityhub.types.aws_efs_access_point_root_directory_details
    import aws_sdk_securityhub.types.non_empty_string


class AwsEfsAccessPointDetails(TypedDict):
    ...
    posix_user: NotRequired[
        "aws_sdk_securityhub.types.aws_efs_access_point_posix_user_details.AwsEfsAccessPointPosixUserDetails"
    ]
    ...
    root_directory: NotRequired[
        "aws_sdk_securityhub.types.aws_efs_access_point_root_directory_details.AwsEfsAccessPointRootDirectoryDetails"
    ]
...
def serialize_json(value: AwsEfsAccessPointDetails) -> dict:
    ...
    if "posix_user" in value:
        ...
        out["PosixUser"] = (
            aws_sdk_securityhub.types.aws_efs_access_point_posix_user_details.serialize_json(
                value["posix_user"]
            )
        )
    if "root_directory" in value:
        ...
        out["RootDirectory"] = (
            aws_sdk_securityhub.types.aws_efs_access_point_root_directory_details.serialize_json(
...
def deserialize_json(data: dict) -> AwsEfsAccessPointDetails:
    ...
    if "PosixUser" in data:
        ...
        out["posix_user"] = (
            aws_sdk_securityhub.types.aws_efs_access_point_posix_user_details.deserialize_json(
                data["PosixUser"]
            )
        )
    if "RootDirectory" in data:
        ...
        out["root_directory"] = (
            aws_sdk_securityhub.types.aws_efs_access_point_root_directory_details.deserialize_json(
                data["RootDirectory"]
            )
        )
    return out
