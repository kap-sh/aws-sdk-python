...
class AwsApiGatewayMethodSettings(TypedDict):
    ...
    caching_enabled: NotRequired["aws_sdk_securityhub.types.boolean.Boolean"]
    ...
    cache_ttl_in_seconds: NotRequired["aws_sdk_securityhub.types.integer.Integer"]
    """<p>Specifies the time to live (TTL), in seconds, for cached responses. The higher the TTL, the longer the response is cached.</p>"""
    cache_data_encrypted: NotRequired["aws_sdk_securityhub.types.boolean.Boolean"]
