...
class MapFilter(TypedDict):
    ...
    comparison: NotRequired[
        "aws_sdk_securityhub.types.map_filter_comparison.MapFilterComparison"
    ]
...
def serialize_json(value: MapFilter) -> dict:
    ...
    if "comparison" in value:
        ...
        out["Comparison"] = (
            aws_sdk_securityhub.types.map_filter_comparison.serialize_json(
                value["comparison"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> MapFilter:
    ...
    if "Comparison" in data:
        ...
        out["comparison"] = (
            aws_sdk_securityhub.types.map_filter_comparison.deserialize_json(
                data["Comparison"]
            )
        )
    return out
