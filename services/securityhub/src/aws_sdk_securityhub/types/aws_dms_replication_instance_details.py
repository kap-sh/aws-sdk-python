...
if TYPE_CHECKING:
    ...
    import aws_sdk_securityhub.types.aws_dms_replication_instance_vpc_security_groups_list
...
class AwsDmsReplicationInstanceDetails(TypedDict):
    ...
    replication_subnet_group: NotRequired[
        "aws_sdk_securityhub.types.aws_dms_replication_instance_replication_subnet_group_details.AwsDmsReplicationInstanceReplicationSubnetGroupDetails"
    ]
    """<p> The subnet group for the replication instance.</p>"""
    vpc_security_groups: NotRequired[
        "aws_sdk_securityhub.types.aws_dms_replication_instance_vpc_security_groups_list.AwsDmsReplicationInstanceVpcSecurityGroupsList"
    ]
...
def serialize_json(value: AwsDmsReplicationInstanceDetails) -> dict:
    ...
    if "replication_subnet_group" in value:
        ...
        out["ReplicationSubnetGroup"] = (
            aws_sdk_securityhub.types.aws_dms_replication_instance_replication_subnet_group_details.serialize_json(
    ...
    if "vpc_security_groups" in value:
        ...
        out["VpcSecurityGroups"] = (
            aws_sdk_securityhub.types.aws_dms_replication_instance_vpc_security_groups_list.serialize_json(
...
def deserialize_json(data: dict) -> AwsDmsReplicationInstanceDetails:
    ...
    if "ReplicationSubnetGroup" in data:
        ...
        out["replication_subnet_group"] = (
            aws_sdk_securityhub.types.aws_dms_replication_instance_replication_subnet_group_details.deserialize_json(
    ...
    if "VpcSecurityGroups" in data:
        ...
        out["vpc_security_groups"] = (
            aws_sdk_securityhub.types.aws_dms_replication_instance_vpc_security_groups_list.deserialize_json(
