...
if TYPE_CHECKING:
    ...
    import aws_sdk_securityhub.types.aws_rds_pending_cloud_watch_logs_exports
    import aws_sdk_securityhub.types.boolean
    import aws_sdk_securityhub.types.integer
    import aws_sdk_securityhub.types.non_empty_string


class AwsRdsDbPendingModifiedValues(TypedDict):
    ...
    pending_cloud_watch_logs_exports: NotRequired[
        "aws_sdk_securityhub.types.aws_rds_pending_cloud_watch_logs_exports.AwsRdsPendingCloudWatchLogsExports"
    ]
...
def serialize_json(value: AwsRdsDbPendingModifiedValues) -> dict:
    ...
    if "pending_cloud_watch_logs_exports" in value:
        ...
        out["PendingCloudWatchLogsExports"] = (
            aws_sdk_securityhub.types.aws_rds_pending_cloud_watch_logs_exports.serialize_json(
...
def deserialize_json(data: dict) -> AwsRdsDbPendingModifiedValues:
    ...
    if "PendingCloudWatchLogsExports" in data:
        ...
        out["pending_cloud_watch_logs_exports"] = (
            aws_sdk_securityhub.types.aws_rds_pending_cloud_watch_logs_exports.deserialize_json(
