...
if TYPE_CHECKING:
    ...
    import aws_sdk_securityhub.types.resource_category
    import aws_sdk_securityhub.types.resource_config
    import aws_sdk_securityhub.types.resource_findings_summary_list
    import aws_sdk_securityhub.types.resource_tag_list


class ResourceResult(TypedDict, closed=True):
    resource_guid: NotRequired[
    ...
    resource_category: NotRequired[
        "aws_sdk_securityhub.types.resource_category.ResourceCategory"
    ]
    ...
    findings_summary: NotRequired[
        "aws_sdk_securityhub.types.resource_findings_summary_list.ResourceFindingsSummaryList"
    ]
    """<p>An aggregated view of security findings associated with a resource.</p>"""
    resource_tags: NotRequired[
        "aws_sdk_securityhub.types.resource_tag_list.ResourceTagList"
    ]
    """<p>The key-value pairs associated with a resource.</p>"""
    resource_config: NotRequired[
        "aws_sdk_securityhub.types.resource_config.ResourceConfig"
    ]
...
def serialize_json(value: ResourceResult) -> dict:
    ...
    if "resource_category" in value:
        ...
        out["ResourceCategory"] = (
            aws_sdk_securityhub.types.resource_category.serialize_json(
    ...
    if "findings_summary" in value:
        ...
        out["FindingsSummary"] = (
            aws_sdk_securityhub.types.resource_findings_summary_list.serialize_json(
    ...
    if "resource_tags" in value:
        ...
        out["ResourceTags"] = (
            aws_sdk_securityhub.types.resource_tag_list.serialize_json(
                value["resource_tags"]
            )
        )
...
def deserialize_json(data: dict) -> ResourceResult:
    ...
    if "ResourceCategory" in data:
        ...
        out["resource_category"] = (
            aws_sdk_securityhub.types.resource_category.deserialize_json(
    ...
    if "FindingsSummary" in data:
        ...
        out["findings_summary"] = (
            aws_sdk_securityhub.types.resource_findings_summary_list.deserialize_json(
    ...
    if "ResourceTags" in data:
        ...
        out["resource_tags"] = (
            aws_sdk_securityhub.types.resource_tag_list.deserialize_json(
                data["ResourceTags"]
            )
        )
