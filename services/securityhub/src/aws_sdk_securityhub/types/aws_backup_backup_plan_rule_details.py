...
if TYPE_CHECKING:
    ...
    import aws_sdk_securityhub.types.aws_backup_backup_plan_rule_copy_actions_list
    import aws_sdk_securityhub.types.boolean
    import aws_sdk_securityhub.types.long
    import aws_sdk_securityhub.types.non_empty_string


class AwsBackupBackupPlanRuleDetails(TypedDict):
    ...
    start_window_minutes: NotRequired["aws_sdk_securityhub.types.long.Long"]
    ...
    enable_continuous_backup: NotRequired["aws_sdk_securityhub.types.boolean.Boolean"]
    """<p>Specifies whether Backup creates continuous backups capable of point-in-time restore (PITR). </p>"""
    completion_window_minutes: NotRequired["aws_sdk_securityhub.types.long.Long"]
    ...
    copy_actions: NotRequired[
        "aws_sdk_securityhub.types.aws_backup_backup_plan_rule_copy_actions_list.AwsBackupBackupPlanRuleCopyActionsList"
    ]
...
def serialize_json(value: AwsBackupBackupPlanRuleDetails) -> dict:
    ...
    if "copy_actions" in value:
        ...
        out["CopyActions"] = (
            aws_sdk_securityhub.types.aws_backup_backup_plan_rule_copy_actions_list.serialize_json(
                value["copy_actions"]
            )
        )
...
def deserialize_json(data: dict) -> AwsBackupBackupPlanRuleDetails:
    ...
    if "CopyActions" in data:
        ...
        out["copy_actions"] = (
            aws_sdk_securityhub.types.aws_backup_backup_plan_rule_copy_actions_list.deserialize_json(
                data["CopyActions"]
            )
        )
