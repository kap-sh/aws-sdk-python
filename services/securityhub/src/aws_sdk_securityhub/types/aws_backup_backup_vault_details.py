...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_backup_backup_vault_notifications_details
    import aws_sdk_securityhub.types.non_empty_string


class AwsBackupBackupVaultDetails(TypedDict):
    ...
    notifications: NotRequired[
        "aws_sdk_securityhub.types.aws_backup_backup_vault_notifications_details.AwsBackupBackupVaultNotificationsDetails"
    ]
...
def serialize_json(value: AwsBackupBackupVaultDetails) -> dict:
    ...
    if "notifications" in value:
        ...
        out["Notifications"] = (
            aws_sdk_securityhub.types.aws_backup_backup_vault_notifications_details.serialize_json(
                value["notifications"]
            )
        )
...
def deserialize_json(data: dict) -> AwsBackupBackupVaultDetails:
    ...
    if "Notifications" in data:
        ...
        out["notifications"] = (
            aws_sdk_securityhub.types.aws_backup_backup_vault_notifications_details.deserialize_json(
                data["Notifications"]
            )
        )
