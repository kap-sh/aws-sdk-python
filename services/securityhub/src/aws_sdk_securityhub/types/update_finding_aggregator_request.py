"""Generated from Smithy shape ``com.amazonaws.securityhub#UpdateFindingAggregatorRequest``."""
...
class UpdateFindingAggregatorRequest(TypedDict, closed=True):
    ...
    regions: NotRequired["aws_sdk_securityhub.types.string_list.StringList"]
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateFindingAggregatorRequest) -> dict:
    out: dict = {}
    ...
    if "regions" in value:
        ...
        out["Regions"] = aws_sdk_securityhub.types.string_list.serialize_json(
            value["regions"]
        )
    return out


def deserialize_json(data: dict) -> UpdateFindingAggregatorRequest:
    out: UpdateFindingAggregatorRequest = {}  # type: ignore[typeddict-item]
    ...
    if "Regions" in data:
        ...
        out["regions"] = aws_sdk_securityhub.types.string_list.deserialize_json(
            data["Regions"]
        )
    return out
