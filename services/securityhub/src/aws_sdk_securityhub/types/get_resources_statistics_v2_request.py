...
class GetResourcesStatisticsV2Request(TypedDict):
    group_by_rules: NotRequired[
        "aws_sdk_securityhub.types.resource_group_by_rules.ResourceGroupByRules"
    ]
...
def serialize_json(value: GetResourcesStatisticsV2Request) -> dict:
    ...
    if "group_by_rules" in value:
        ...
        out["GroupByRules"] = (
            aws_sdk_securityhub.types.resource_group_by_rules.serialize_json(
...
def deserialize_json(data: dict) -> GetResourcesStatisticsV2Request:
    ...
    if "GroupByRules" in data:
        ...
        out["group_by_rules"] = (
            aws_sdk_securityhub.types.resource_group_by_rules.deserialize_json(
                data["GroupByRules"]
            )
        )
    if "Scopes" in data:
