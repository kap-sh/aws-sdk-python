...
class AwsCloudFormationStackOutputsDetails(TypedDict):
    description: NotRequired[
        "aws_sdk_securityhub.types.non_empty_string.NonEmptyString"
    ]
    """<p>A user-defined description associated with the output. </p>"""
    output_key: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>The key associated with the output. </p>"""
    output_value: NotRequired[
        "aws_sdk_securityhub.types.non_empty_string.NonEmptyString"
    ]
