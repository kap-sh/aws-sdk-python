"""Generated from Smithy shape ``com.amazonaws.securityhub#DescribeProductsV2Request``."""
...
class DescribeProductsV2Request(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeProductsV2Request) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> DescribeProductsV2Request:
    out: DescribeProductsV2Request = {}  # type: ignore[typeddict-item]
    return out
