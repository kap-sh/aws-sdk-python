...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_ecs_service_capacity_provider_strategy_list
    import aws_sdk_securityhub.types.aws_ecs_service_deployment_configuration_details
    import aws_sdk_securityhub.types.aws_ecs_service_deployment_controller_details
    import aws_sdk_securityhub.types.aws_ecs_service_load_balancers_list
    import aws_sdk_securityhub.types.aws_ecs_service_network_configuration_details
    import aws_sdk_securityhub.types.aws_ecs_service_placement_constraints_list
    import aws_sdk_securityhub.types.aws_ecs_service_placement_strategies_list
    import aws_sdk_securityhub.types.aws_ecs_service_service_registries_list
    import aws_sdk_securityhub.types.boolean
    import aws_sdk_securityhub.types.integer
    import aws_sdk_securityhub.types.non_empty_string


class AwsEcsServiceDetails(TypedDict):
    capacity_provider_strategy: NotRequired[
        "aws_sdk_securityhub.types.aws_ecs_service_capacity_provider_strategy_list.AwsEcsServiceCapacityProviderStrategyList"
    ]
    """<p>The capacity provider strategy that the service uses.</p>"""
    cluster: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>The ARN of the cluster that hosts the service.</p>"""
    deployment_configuration: NotRequired[
        "aws_sdk_securityhub.types.aws_ecs_service_deployment_configuration_details.AwsEcsServiceDeploymentConfigurationDetails"
    ]
    ...
    deployment_controller: NotRequired[
        "aws_sdk_securityhub.types.aws_ecs_service_deployment_controller_details.AwsEcsServiceDeploymentControllerDetails"
    ]
    """<p>Contains the deployment controller type that the service uses.</p>"""
    desired_count: NotRequired["aws_sdk_securityhub.types.integer.Integer"]
    """<p>The number of instantiations of the task definition to run on the service.</p>"""
    enable_ecs_managed_tags: NotRequired["aws_sdk_securityhub.types.boolean.Boolean"]
    """<p>Whether to enable Amazon ECS managed tags for the tasks in the service.</p>"""
    enable_execute_command: NotRequired["aws_sdk_securityhub.types.boolean.Boolean"]
    ...
    load_balancers: NotRequired[
        "aws_sdk_securityhub.types.aws_ecs_service_load_balancers_list.AwsEcsServiceLoadBalancersList"
    ]
    """<p>Information about the load balancers that the service uses.</p>"""
    name: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>The name of the service.</p>"""
    network_configuration: NotRequired[
        "aws_sdk_securityhub.types.aws_ecs_service_network_configuration_details.AwsEcsServiceNetworkConfigurationDetails"
    ]
    ...
    placement_constraints: NotRequired[
        "aws_sdk_securityhub.types.aws_ecs_service_placement_constraints_list.AwsEcsServicePlacementConstraintsList"
    ]
    """<p>The placement constraints for the tasks in the service.</p>"""
    placement_strategies: NotRequired[
        "aws_sdk_securityhub.types.aws_ecs_service_placement_strategies_list.AwsEcsServicePlacementStrategiesList"
    ]
    ...
    service_registries: NotRequired[
        "aws_sdk_securityhub.types.aws_ecs_service_service_registries_list.AwsEcsServiceServiceRegistriesList"
    ]
...
def serialize_json(value: AwsEcsServiceDetails) -> dict:
    ...
    if "capacity_provider_strategy" in value:
        ...
        out["CapacityProviderStrategy"] = (
            aws_sdk_securityhub.types.aws_ecs_service_capacity_provider_strategy_list.serialize_json(
    ...
    if "deployment_configuration" in value:
        ...
        out["DeploymentConfiguration"] = (
            aws_sdk_securityhub.types.aws_ecs_service_deployment_configuration_details.serialize_json(
    ...
    if "deployment_controller" in value:
        ...
        out["DeploymentController"] = (
            aws_sdk_securityhub.types.aws_ecs_service_deployment_controller_details.serialize_json(
    ...
    if "load_balancers" in value:
        ...
        out["LoadBalancers"] = (
            aws_sdk_securityhub.types.aws_ecs_service_load_balancers_list.serialize_json(
    ...
    if "network_configuration" in value:
        ...
        out["NetworkConfiguration"] = (
            aws_sdk_securityhub.types.aws_ecs_service_network_configuration_details.serialize_json(
    ...
    if "placement_constraints" in value:
        ...
        out["PlacementConstraints"] = (
            aws_sdk_securityhub.types.aws_ecs_service_placement_constraints_list.serialize_json(
    ...
    if "placement_strategies" in value:
        ...
        out["PlacementStrategies"] = (
            aws_sdk_securityhub.types.aws_ecs_service_placement_strategies_list.serialize_json(
    ...
    if "service_registries" in value:
        ...
        out["ServiceRegistries"] = (
            aws_sdk_securityhub.types.aws_ecs_service_service_registries_list.serialize_json(
...
def deserialize_json(data: dict) -> AwsEcsServiceDetails:
    ...
    if "CapacityProviderStrategy" in data:
        ...
        out["capacity_provider_strategy"] = (
            aws_sdk_securityhub.types.aws_ecs_service_capacity_provider_strategy_list.deserialize_json(
    ...
    if "DeploymentConfiguration" in data:
        ...
        out["deployment_configuration"] = (
            aws_sdk_securityhub.types.aws_ecs_service_deployment_configuration_details.deserialize_json(
    ...
    if "DeploymentController" in data:
        ...
        out["deployment_controller"] = (
            aws_sdk_securityhub.types.aws_ecs_service_deployment_controller_details.deserialize_json(
    ...
    if "LoadBalancers" in data:
        ...
        out["load_balancers"] = (
            aws_sdk_securityhub.types.aws_ecs_service_load_balancers_list.deserialize_json(
                data["LoadBalancers"]
            )
        )
    if "Name" in data:
    ...
    if "NetworkConfiguration" in data:
        ...
        out["network_configuration"] = (
            aws_sdk_securityhub.types.aws_ecs_service_network_configuration_details.deserialize_json(
    ...
    if "PlacementConstraints" in data:
        ...
        out["placement_constraints"] = (
            aws_sdk_securityhub.types.aws_ecs_service_placement_constraints_list.deserialize_json(
    ...
    if "PlacementStrategies" in data:
        ...
        out["placement_strategies"] = (
            aws_sdk_securityhub.types.aws_ecs_service_placement_strategies_list.deserialize_json(
    ...
    if "ServiceRegistries" in data:
        ...
        out["service_registries"] = (
            aws_sdk_securityhub.types.aws_ecs_service_service_registries_list.deserialize_json(
