...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_auto_scaling_launch_configuration_block_device_mappings_ebs_details
    import aws_sdk_securityhub.types.boolean
    import aws_sdk_securityhub.types.non_empty_string


class AwsAutoScalingLaunchConfigurationBlockDeviceMappingsDetails(TypedDict):
    ...
    ebs: NotRequired[
        "aws_sdk_securityhub.types.aws_auto_scaling_launch_configuration_block_device_mappings_ebs_details.AwsAutoScalingLaunchConfigurationBlockDeviceMappingsEbsDetails"
    ]
    """<p>Parameters that are used to automatically set up Amazon EBS volumes when an instance is launched.</p>"""
    no_device: NotRequired["aws_sdk_securityhub.types.boolean.Boolean"]
...
def serialize_json(
    ...
    if "ebs" in value:
        ...
        out["Ebs"] = (
            aws_sdk_securityhub.types.aws_auto_scaling_launch_configuration_block_device_mappings_ebs_details.serialize_json(
                value["ebs"]
            )
        )
...
def deserialize_json(
    ...
    if "Ebs" in data:
        ...
        out["ebs"] = (
            aws_sdk_securityhub.types.aws_auto_scaling_launch_configuration_block_device_mappings_ebs_details.deserialize_json(
                data["Ebs"]
            )
        )
    if "NoDevice" in data:
