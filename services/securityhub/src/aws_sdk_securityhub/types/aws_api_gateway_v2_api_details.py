...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_cors_configuration
    import aws_sdk_securityhub.types.non_empty_string


class AwsApiGatewayV2ApiDetails(TypedDict):
    api_endpoint: NotRequired[
    ...
    cors_configuration: NotRequired[
        "aws_sdk_securityhub.types.aws_cors_configuration.AwsCorsConfiguration"
    ]
...
def serialize_json(value: AwsApiGatewayV2ApiDetails) -> dict:
    ...
    if "cors_configuration" in value:
        ...
        out["CorsConfiguration"] = (
            aws_sdk_securityhub.types.aws_cors_configuration.serialize_json(
...
def deserialize_json(data: dict) -> AwsApiGatewayV2ApiDetails:
    ...
    if "CorsConfiguration" in data:
        ...
        out["cors_configuration"] = (
            aws_sdk_securityhub.types.aws_cors_configuration.deserialize_json(
