...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.availability_zones
    import aws_sdk_securityhub.types.aws_elbv2_load_balancer_attributes
    import aws_sdk_securityhub.types.load_balancer_state
    import aws_sdk_securityhub.types.non_empty_string
    import aws_sdk_securityhub.types.security_groups


class AwsElbv2LoadBalancerDetails(TypedDict):
    availability_zones: NotRequired[
        "aws_sdk_securityhub.types.availability_zones.AvailabilityZones"
    ]
    ...
    security_groups: NotRequired[
        "aws_sdk_securityhub.types.security_groups.SecurityGroups"
    ]
    """<p>The IDs of the security groups for the load balancer.</p>"""
    state: NotRequired[
        "aws_sdk_securityhub.types.load_balancer_state.LoadBalancerState"
    ]
    ...
    load_balancer_attributes: NotRequired[
        "aws_sdk_securityhub.types.aws_elbv2_load_balancer_attributes.AwsElbv2LoadBalancerAttributes"
    ]
...
def serialize_json(value: AwsElbv2LoadBalancerDetails) -> dict:
    ...
    if "availability_zones" in value:
        ...
        out["AvailabilityZones"] = (
            aws_sdk_securityhub.types.availability_zones.serialize_json(
    ...
    if "security_groups" in value:
        ...
        out["SecurityGroups"] = (
            aws_sdk_securityhub.types.security_groups.serialize_json(
    ...
    if "state" in value:
        ...
        out["State"] = aws_sdk_securityhub.types.load_balancer_state.serialize_json(
            value["state"]
        )
    if "type" in value:
        out["Type"] = value["type"]
    ...
    if "load_balancer_attributes" in value:
        ...
        out["LoadBalancerAttributes"] = (
            aws_sdk_securityhub.types.aws_elbv2_load_balancer_attributes.serialize_json(
...
def deserialize_json(data: dict) -> AwsElbv2LoadBalancerDetails:
    ...
    if "AvailabilityZones" in data:
        ...
        out["availability_zones"] = (
            aws_sdk_securityhub.types.availability_zones.deserialize_json(
    ...
    if "SecurityGroups" in data:
        ...
        out["security_groups"] = (
            aws_sdk_securityhub.types.security_groups.deserialize_json(
                data["SecurityGroups"]
            )
        )
    if "State" in data:
        ...
        out["state"] = aws_sdk_securityhub.types.load_balancer_state.deserialize_json(
            data["State"]
        )
    if "Type" in data:
        out["type"] = data["Type"]
    ...
    if "LoadBalancerAttributes" in data:
        ...
        out["load_balancer_attributes"] = (
            aws_sdk_securityhub.types.aws_elbv2_load_balancer_attributes.deserialize_json(
