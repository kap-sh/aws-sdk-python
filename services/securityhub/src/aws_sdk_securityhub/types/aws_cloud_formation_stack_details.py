...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_cloud_formation_stack_drift_information_details
    import aws_sdk_securityhub.types.aws_cloud_formation_stack_outputs_list
...
class AwsCloudFormationStackDetails(TypedDict):
    ...
    disable_rollback: NotRequired["aws_sdk_securityhub.types.boolean.Boolean"]
    """<p>Boolean to enable or disable rollback on stack creation failures. </p>"""
    drift_information: NotRequired[
        "aws_sdk_securityhub.types.aws_cloud_formation_stack_drift_information_details.AwsCloudFormationStackDriftInformationDetails"
    ]
    ...
    outputs: NotRequired[
        "aws_sdk_securityhub.types.aws_cloud_formation_stack_outputs_list.AwsCloudFormationStackOutputsList"
    ]
    ...
    stack_id: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>Unique identifier of the stack. </p>"""
    stack_name: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>The name associated with the stack. </p>"""
    stack_status: NotRequired[
        "aws_sdk_securityhub.types.non_empty_string.NonEmptyString"
    ]
    ...
    timeout_in_minutes: NotRequired["aws_sdk_securityhub.types.integer.Integer"]
...
def serialize_json(value: AwsCloudFormationStackDetails) -> dict:
    ...
    if "drift_information" in value:
        ...
        out["DriftInformation"] = (
            aws_sdk_securityhub.types.aws_cloud_formation_stack_drift_information_details.serialize_json(
    ...
    if "outputs" in value:
        ...
        out["Outputs"] = (
            aws_sdk_securityhub.types.aws_cloud_formation_stack_outputs_list.serialize_json(
                value["outputs"]
            )
        )
...
def deserialize_json(data: dict) -> AwsCloudFormationStackDetails:
    ...
    if "DriftInformation" in data:
        ...
        out["drift_information"] = (
            aws_sdk_securityhub.types.aws_cloud_formation_stack_drift_information_details.deserialize_json(
    ...
    if "Outputs" in data:
        ...
        out["outputs"] = (
            aws_sdk_securityhub.types.aws_cloud_formation_stack_outputs_list.deserialize_json(
                data["Outputs"]
            )
        )
    if "RoleArn" in data:
