...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.cidr_block_association_list
    import aws_sdk_securityhub.types.ipv6_cidr_block_association_list
    import aws_sdk_securityhub.types.non_empty_string


class AwsEc2VpcDetails(TypedDict):
    cidr_block_association_set: NotRequired[
        "aws_sdk_securityhub.types.cidr_block_association_list.CidrBlockAssociationList"
    ]
...
def serialize_json(value: AwsEc2VpcDetails) -> dict:
    ...
    if "cidr_block_association_set" in value:
        ...
        out["CidrBlockAssociationSet"] = (
            aws_sdk_securityhub.types.cidr_block_association_list.serialize_json(
...
def deserialize_json(data: dict) -> AwsEc2VpcDetails:
    ...
    if "CidrBlockAssociationSet" in data:
        ...
        out["cidr_block_association_set"] = (
            aws_sdk_securityhub.types.cidr_block_association_list.deserialize_json(
