...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_waf_rule_group_rules_action_details
    import aws_sdk_securityhub.types.integer
    import aws_sdk_securityhub.types.non_empty_string


class AwsWafRuleGroupRulesDetails(TypedDict):
    action: NotRequired[
        "aws_sdk_securityhub.types.aws_waf_rule_group_rules_action_details.AwsWafRuleGroupRulesActionDetails"
    ]
...
def serialize_json(value: AwsWafRuleGroupRulesDetails) -> dict:
    ...
    if "action" in value:
        ...
        out["Action"] = (
            aws_sdk_securityhub.types.aws_waf_rule_group_rules_action_details.serialize_json(
                value["action"]
            )
        )
...
def deserialize_json(data: dict) -> AwsWafRuleGroupRulesDetails:
    ...
    if "Action" in data:
        ...
        out["action"] = (
            aws_sdk_securityhub.types.aws_waf_rule_group_rules_action_details.deserialize_json(
                data["Action"]
            )
        )
    if "Priority" in data:
