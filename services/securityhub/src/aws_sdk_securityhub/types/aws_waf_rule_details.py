...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_waf_rule_predicate_list
    import aws_sdk_securityhub.types.non_empty_string


class AwsWafRuleDetails(TypedDict):
    ...
    predicate_list: NotRequired[
        "aws_sdk_securityhub.types.aws_waf_rule_predicate_list.AwsWafRulePredicateList"
    ]
...
def serialize_json(value: AwsWafRuleDetails) -> dict:
    ...
    if "predicate_list" in value:
        ...
        out["PredicateList"] = (
            aws_sdk_securityhub.types.aws_waf_rule_predicate_list.serialize_json(
...
def deserialize_json(data: dict) -> AwsWafRuleDetails:
    ...
    if "PredicateList" in data:
        ...
        out["predicate_list"] = (
            aws_sdk_securityhub.types.aws_waf_rule_predicate_list.deserialize_json(
                data["PredicateList"]
            )
        )
    if "RuleId" in data:
