...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_backup_recovery_point_calculated_lifecycle_details
    import aws_sdk_securityhub.types.aws_backup_recovery_point_created_by_details
    import aws_sdk_securityhub.types.aws_backup_recovery_point_lifecycle_details
    import aws_sdk_securityhub.types.boolean
    import aws_sdk_securityhub.types.long
    import aws_sdk_securityhub.types.non_empty_string


class AwsBackupRecoveryPointDetails(TypedDict):
    backup_size_in_bytes: NotRequired["aws_sdk_securityhub.types.long.Long"]
    ...
    calculated_lifecycle: NotRequired[
        "aws_sdk_securityhub.types.aws_backup_recovery_point_calculated_lifecycle_details.AwsBackupRecoveryPointCalculatedLifecycleDetails"
    ]
    ...
    created_by: NotRequired[
        "aws_sdk_securityhub.types.aws_backup_recovery_point_created_by_details.AwsBackupRecoveryPointCreatedByDetails"
    ]
    ...
    is_encrypted: NotRequired["aws_sdk_securityhub.types.boolean.Boolean"]
    ...
    lifecycle: NotRequired[
        "aws_sdk_securityhub.types.aws_backup_recovery_point_lifecycle_details.AwsBackupRecoveryPointLifecycleDetails"
    ]
...
def serialize_json(value: AwsBackupRecoveryPointDetails) -> dict:
    ...
    if "calculated_lifecycle" in value:
        ...
        out["CalculatedLifecycle"] = (
            aws_sdk_securityhub.types.aws_backup_recovery_point_calculated_lifecycle_details.serialize_json(
    ...
    if "created_by" in value:
        ...
        out["CreatedBy"] = (
            aws_sdk_securityhub.types.aws_backup_recovery_point_created_by_details.serialize_json(
                value["created_by"]
            )
        )
    ...
    if "lifecycle" in value:
        ...
        out["Lifecycle"] = (
            aws_sdk_securityhub.types.aws_backup_recovery_point_lifecycle_details.serialize_json(
                value["lifecycle"]
            )
        )
...
def deserialize_json(data: dict) -> AwsBackupRecoveryPointDetails:
    ...
    if "CalculatedLifecycle" in data:
        ...
        out["calculated_lifecycle"] = (
            aws_sdk_securityhub.types.aws_backup_recovery_point_calculated_lifecycle_details.deserialize_json(
    ...
    if "CreatedBy" in data:
        ...
        out["created_by"] = (
            aws_sdk_securityhub.types.aws_backup_recovery_point_created_by_details.deserialize_json(
                data["CreatedBy"]
            )
        )
    ...
    if "Lifecycle" in data:
        ...
        out["lifecycle"] = (
            aws_sdk_securityhub.types.aws_backup_recovery_point_lifecycle_details.deserialize_json(
                data["Lifecycle"]
            )
        )
