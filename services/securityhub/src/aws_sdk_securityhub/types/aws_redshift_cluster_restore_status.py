...
class AwsRedshiftClusterRestoreStatus(TypedDict):
    current_restore_rate_in_mega_bytes_per_second: NotRequired[
        "aws_sdk_securityhub.types.double.Double"
    ]
    ...
    elapsed_time_in_seconds: NotRequired["aws_sdk_securityhub.types.long.Long"]
    ...
    estimated_time_to_completion_in_seconds: NotRequired[
        "aws_sdk_securityhub.types.long.Long"
    ]
    ...
    progress_in_mega_bytes: NotRequired["aws_sdk_securityhub.types.long.Long"]
    ...
    snapshot_size_in_mega_bytes: NotRequired["aws_sdk_securityhub.types.long.Long"]
