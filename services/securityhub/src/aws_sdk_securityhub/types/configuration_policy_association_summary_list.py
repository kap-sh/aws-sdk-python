...
ConfigurationPolicyAssociationSummaryList: TypeAlias = list[
    "aws_sdk_securityhub.types.configuration_policy_association_summary.ConfigurationPolicyAssociationSummary"
]
...
def serialize_json(value: ConfigurationPolicyAssociationSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_securityhub.types.configuration_policy_association_summary.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> ConfigurationPolicyAssociationSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_securityhub.types.configuration_policy_association_summary.deserialize_json(
                item
            )
        )
    return out
