...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_events_endpoint_routing_config_failover_config_details


class AwsEventsEndpointRoutingConfigDetails(TypedDict):
    failover_config: NotRequired[
        "aws_sdk_securityhub.types.aws_events_endpoint_routing_config_failover_config_details.AwsEventsEndpointRoutingConfigFailoverConfigDetails"
    ]
...
def serialize_json(value: AwsEventsEndpointRoutingConfigDetails) -> dict:
    ...
    if "failover_config" in value:
        ...
        out["FailoverConfig"] = (
            aws_sdk_securityhub.types.aws_events_endpoint_routing_config_failover_config_details.serialize_json(
...
def deserialize_json(data: dict) -> AwsEventsEndpointRoutingConfigDetails:
    ...
    if "FailoverConfig" in data:
        ...
        out["failover_config"] = (
            aws_sdk_securityhub.types.aws_events_endpoint_routing_config_failover_config_details.deserialize_json(
                data["FailoverConfig"]
            )
        )
    return out
