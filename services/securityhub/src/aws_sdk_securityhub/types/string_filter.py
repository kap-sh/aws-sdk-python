...
def serialize_json(value: StringFilter) -> dict:
    ...
    if "comparison" in value:
        ...
        out["Comparison"] = (
            aws_sdk_securityhub.types.string_filter_comparison.serialize_json(
                value["comparison"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> StringFilter:
    ...
    if "Comparison" in data:
        ...
        out["comparison"] = (
            aws_sdk_securityhub.types.string_filter_comparison.deserialize_json(
                data["Comparison"]
            )
        )
    return out
