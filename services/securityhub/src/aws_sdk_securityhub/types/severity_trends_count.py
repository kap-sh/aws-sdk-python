...
class SeverityTrendsCount(TypedDict):
    unknown: NotRequired[
    ...
    low: NotRequired["aws_sdk_securityhub.types.trends_value_count.TrendsValueCount"]
    """<p>The count of findings with Low severity level at this point in the trend timeline.</p>"""
    medium: NotRequired["aws_sdk_securityhub.types.trends_value_count.TrendsValueCount"]
    """<p>The count of findings with Medium severity level at this point in the trend timeline.</p>"""
    high: NotRequired["aws_sdk_securityhub.types.trends_value_count.TrendsValueCount"]
    ...
    fatal: NotRequired["aws_sdk_securityhub.types.trends_value_count.TrendsValueCount"]
    """<p>The count of findings with Fatal severity level at this point in the trend timeline.</p>"""
    other: NotRequired["aws_sdk_securityhub.types.trends_value_count.TrendsValueCount"]
