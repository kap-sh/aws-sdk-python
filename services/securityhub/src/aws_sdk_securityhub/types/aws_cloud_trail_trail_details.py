...
class AwsCloudTrailTrailDetails(TypedDict):
    ...
    has_custom_event_selectors: NotRequired["aws_sdk_securityhub.types.boolean.Boolean"]
    """<p>Indicates whether the trail has custom event selectors.</p>"""
    home_region: NotRequired[
        "aws_sdk_securityhub.types.non_empty_string.NonEmptyString"
    ]
    ...
    is_multi_region_trail: NotRequired["aws_sdk_securityhub.types.boolean.Boolean"]
    """<p>Indicates whether the trail applies only to the current Region or to all Regions.</p>"""
    is_organization_trail: NotRequired["aws_sdk_securityhub.types.boolean.Boolean"]
    ...
    log_file_validation_enabled: NotRequired[
        "aws_sdk_securityhub.types.boolean.Boolean"
    ]
    ...
    trail_arn: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
