...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.adjustment_list
...
class Cvss(TypedDict):
    ...
    base_score: NotRequired["aws_sdk_securityhub.types.double.Double"]
    """<p>The base CVSS score.</p>"""
    base_vector: NotRequired[
    ...
    adjustments: NotRequired["aws_sdk_securityhub.types.adjustment_list.AdjustmentList"]
...
def serialize_json(value: Cvss) -> dict:
    ...
    if "adjustments" in value:
        ...
        out["Adjustments"] = aws_sdk_securityhub.types.adjustment_list.serialize_json(
            value["adjustments"]
        )
    return out
...
def deserialize_json(data: dict) -> Cvss:
    ...
    if "Adjustments" in data:
        ...
        out["adjustments"] = aws_sdk_securityhub.types.adjustment_list.deserialize_json(
            data["Adjustments"]
        )
    return out
