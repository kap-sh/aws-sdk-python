...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_elasticsearch_domain_domain_endpoint_options
    import aws_sdk_securityhub.types.aws_elasticsearch_domain_elasticsearch_cluster_config_details
    import aws_sdk_securityhub.types.aws_elasticsearch_domain_encryption_at_rest_options
    import aws_sdk_securityhub.types.aws_elasticsearch_domain_log_publishing_options
    import aws_sdk_securityhub.types.aws_elasticsearch_domain_node_to_node_encryption_options
    import aws_sdk_securityhub.types.aws_elasticsearch_domain_service_software_options
    import aws_sdk_securityhub.types.aws_elasticsearch_domain_vpc_options
    import aws_sdk_securityhub.types.field_map
    import aws_sdk_securityhub.types.non_empty_string


class AwsElasticsearchDomainDetails(TypedDict):
    ...
    domain_endpoint_options: NotRequired[
        "aws_sdk_securityhub.types.aws_elasticsearch_domain_domain_endpoint_options.AwsElasticsearchDomainDomainEndpointOptions"
    ]
    """<p>Additional options for the domain endpoint.</p>"""
    domain_id: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    endpoints: NotRequired["aws_sdk_securityhub.types.field_map.FieldMap"]
    ...
    elasticsearch_cluster_config: NotRequired[
        "aws_sdk_securityhub.types.aws_elasticsearch_domain_elasticsearch_cluster_config_details.AwsElasticsearchDomainElasticsearchClusterConfigDetails"
    ]
    """<p>Information about an OpenSearch cluster configuration.</p>"""
    encryption_at_rest_options: NotRequired[
        "aws_sdk_securityhub.types.aws_elasticsearch_domain_encryption_at_rest_options.AwsElasticsearchDomainEncryptionAtRestOptions"
    ]
    """<p>Details about the configuration for encryption at rest.</p>"""
    log_publishing_options: NotRequired[
        "aws_sdk_securityhub.types.aws_elasticsearch_domain_log_publishing_options.AwsElasticsearchDomainLogPublishingOptions"
    ]
    """<p>Configures the CloudWatch Logs to publish for the Elasticsearch domain.</p>"""
    node_to_node_encryption_options: NotRequired[
        "aws_sdk_securityhub.types.aws_elasticsearch_domain_node_to_node_encryption_options.AwsElasticsearchDomainNodeToNodeEncryptionOptions"
    ]
    """<p>Details about the configuration for node-to-node encryption.</p>"""
    service_software_options: NotRequired[
        "aws_sdk_securityhub.types.aws_elasticsearch_domain_service_software_options.AwsElasticsearchDomainServiceSoftwareOptions"
    ]
    """<p>Information about the status of a domain relative to the latest service software.</p>"""
    vpc_options: NotRequired[
        "aws_sdk_securityhub.types.aws_elasticsearch_domain_vpc_options.AwsElasticsearchDomainVPCOptions"
    ]
...
def serialize_json(value: AwsElasticsearchDomainDetails) -> dict:
    ...
    if "domain_endpoint_options" in value:
        ...
        out["DomainEndpointOptions"] = (
            aws_sdk_securityhub.types.aws_elasticsearch_domain_domain_endpoint_options.serialize_json(
    ...
    if "endpoints" in value:
        ...
        out["Endpoints"] = aws_sdk_securityhub.types.field_map.serialize_json(
            value["endpoints"]
        )
    ...
    if "elasticsearch_cluster_config" in value:
        ...
        out["ElasticsearchClusterConfig"] = (
            aws_sdk_securityhub.types.aws_elasticsearch_domain_elasticsearch_cluster_config_details.serialize_json(
    ...
    if "encryption_at_rest_options" in value:
        ...
        out["EncryptionAtRestOptions"] = (
            aws_sdk_securityhub.types.aws_elasticsearch_domain_encryption_at_rest_options.serialize_json(
    ...
    if "log_publishing_options" in value:
        ...
        out["LogPublishingOptions"] = (
            aws_sdk_securityhub.types.aws_elasticsearch_domain_log_publishing_options.serialize_json(
    ...
    if "node_to_node_encryption_options" in value:
        ...
        out["NodeToNodeEncryptionOptions"] = (
            aws_sdk_securityhub.types.aws_elasticsearch_domain_node_to_node_encryption_options.serialize_json(
    ...
    if "service_software_options" in value:
        ...
        out["ServiceSoftwareOptions"] = (
            aws_sdk_securityhub.types.aws_elasticsearch_domain_service_software_options.serialize_json(
    ...
    if "vpc_options" in value:
        ...
        out["VPCOptions"] = (
            aws_sdk_securityhub.types.aws_elasticsearch_domain_vpc_options.serialize_json(
                value["vpc_options"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> AwsElasticsearchDomainDetails:
    ...
    if "DomainEndpointOptions" in data:
        ...
        out["domain_endpoint_options"] = (
            aws_sdk_securityhub.types.aws_elasticsearch_domain_domain_endpoint_options.deserialize_json(
    ...
    if "Endpoints" in data:
        ...
        out["endpoints"] = aws_sdk_securityhub.types.field_map.deserialize_json(
            data["Endpoints"]
        )
    ...
    if "ElasticsearchClusterConfig" in data:
        ...
        out["elasticsearch_cluster_config"] = (
            aws_sdk_securityhub.types.aws_elasticsearch_domain_elasticsearch_cluster_config_details.deserialize_json(
    ...
    if "EncryptionAtRestOptions" in data:
        ...
        out["encryption_at_rest_options"] = (
            aws_sdk_securityhub.types.aws_elasticsearch_domain_encryption_at_rest_options.deserialize_json(
    ...
    if "LogPublishingOptions" in data:
        ...
        out["log_publishing_options"] = (
            aws_sdk_securityhub.types.aws_elasticsearch_domain_log_publishing_options.deserialize_json(
    ...
    if "NodeToNodeEncryptionOptions" in data:
        ...
        out["node_to_node_encryption_options"] = (
            aws_sdk_securityhub.types.aws_elasticsearch_domain_node_to_node_encryption_options.deserialize_json(
    ...
    if "ServiceSoftwareOptions" in data:
        ...
        out["service_software_options"] = (
            aws_sdk_securityhub.types.aws_elasticsearch_domain_service_software_options.deserialize_json(
    ...
    if "VPCOptions" in data:
        ...
        out["vpc_options"] = (
            aws_sdk_securityhub.types.aws_elasticsearch_domain_vpc_options.deserialize_json(
                data["VPCOptions"]
            )
        )
    return out
