...
if TYPE_CHECKING:
    ...
    import aws_sdk_securityhub.types.standards_controls_updatable
    import aws_sdk_securityhub.types.standards_input_parameter_map
    import aws_sdk_securityhub.types.standards_status
    import aws_sdk_securityhub.types.standards_status_reason


class StandardsSubscription(TypedDict):
    ...
    standards_status: NotRequired[
        "aws_sdk_securityhub.types.standards_status.StandardsStatus"
    ]
    ...
    standards_controls_updatable: NotRequired[
        "aws_sdk_securityhub.types.standards_controls_updatable.StandardsControlsUpdatable"
    ]
    ...
    standards_status_reason: NotRequired[
        "aws_sdk_securityhub.types.standards_status_reason.StandardsStatusReason"
    ]
...
def serialize_json(value: StandardsSubscription) -> dict:
    ...
    if "standards_status" in value:
        ...
        out["StandardsStatus"] = (
            aws_sdk_securityhub.types.standards_status.serialize_json(
    ...
    if "standards_controls_updatable" in value:
        ...
        out["StandardsControlsUpdatable"] = (
            aws_sdk_securityhub.types.standards_controls_updatable.serialize_json(
    ...
    if "standards_status_reason" in value:
        ...
        out["StandardsStatusReason"] = (
            aws_sdk_securityhub.types.standards_status_reason.serialize_json(
...
def deserialize_json(data: dict) -> StandardsSubscription:
    ...
    if "StandardsStatus" in data:
        ...
        out["standards_status"] = (
            aws_sdk_securityhub.types.standards_status.deserialize_json(
    ...
    if "StandardsControlsUpdatable" in data:
        ...
        out["standards_controls_updatable"] = (
            aws_sdk_securityhub.types.standards_controls_updatable.deserialize_json(
    ...
    if "StandardsStatusReason" in data:
        ...
        out["standards_status_reason"] = (
            aws_sdk_securityhub.types.standards_status_reason.deserialize_json(
