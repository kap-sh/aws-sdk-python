...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_efs_access_point_root_directory_creation_info_details
    import aws_sdk_securityhub.types.non_empty_string


class AwsEfsAccessPointRootDirectoryDetails(TypedDict):
    creation_info: NotRequired[
        "aws_sdk_securityhub.types.aws_efs_access_point_root_directory_creation_info_details.AwsEfsAccessPointRootDirectoryCreationInfoDetails"
    ]
...
def serialize_json(value: AwsEfsAccessPointRootDirectoryDetails) -> dict:
    ...
    if "creation_info" in value:
        ...
        out["CreationInfo"] = (
            aws_sdk_securityhub.types.aws_efs_access_point_root_directory_creation_info_details.serialize_json(
                value["creation_info"]
            )
        )
    if "path" in value:
...
def deserialize_json(data: dict) -> AwsEfsAccessPointRootDirectoryDetails:
    ...
    if "CreationInfo" in data:
        ...
        out["creation_info"] = (
            aws_sdk_securityhub.types.aws_efs_access_point_root_directory_creation_info_details.deserialize_json(
                data["CreationInfo"]
            )
        )
    if "Path" in data:
