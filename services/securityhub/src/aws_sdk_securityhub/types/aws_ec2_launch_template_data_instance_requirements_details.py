...
if TYPE_CHECKING:
    ...
    import aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_accelerator_total_memory_mi_b_details
    import aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_baseline_ebs_bandwidth_mbps_details
    import aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_memory_gi_b_per_v_cpu_details
    import aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_memory_mi_b_details
    import aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_network_interface_count_details
    import aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_total_local_storage_gb_details
    import aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_v_cpu_count_details
...
class AwsEc2LaunchTemplateDataInstanceRequirementsDetails(TypedDict):
    ...
    accelerator_total_memory_mi_b: NotRequired[
        "aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_accelerator_total_memory_mi_b_details.AwsEc2LaunchTemplateDataInstanceRequirementsAcceleratorTotalMemoryMiBDetails"
    ]
    ...
    bare_metal: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    memory_gi_b_per_v_cpu: NotRequired[
        "aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_memory_gi_b_per_v_cpu_details.AwsEc2LaunchTemplateDataInstanceRequirementsMemoryGiBPerVCpuDetails"
    ]
    """<p> The minimum and maximum amount of memory per vCPU, in GiB. </p>"""
    memory_mi_b: NotRequired[
        "aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_memory_mi_b_details.AwsEc2LaunchTemplateDataInstanceRequirementsMemoryMiBDetails"
    ]
    """<p> The minimum and maximum amount of memory, in MiB. </p>"""
    network_interface_count: NotRequired[
        "aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_network_interface_count_details.AwsEc2LaunchTemplateDataInstanceRequirementsNetworkInterfaceCountDetails"
    ]
    ...
    require_hibernate_support: NotRequired["aws_sdk_securityhub.types.boolean.Boolean"]
    ...
    total_local_storage_gb: NotRequired[
        "aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_total_local_storage_gb_details.AwsEc2LaunchTemplateDataInstanceRequirementsTotalLocalStorageGBDetails"
    ]
    """<p> The minimum and maximum amount of total local storage, in GB. </p>"""
    v_cpu_count: NotRequired[
        "aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_v_cpu_count_details.AwsEc2LaunchTemplateDataInstanceRequirementsVCpuCountDetails"
    ]
...
def serialize_json(value: AwsEc2LaunchTemplateDataInstanceRequirementsDetails) -> dict:
    ...
    if "accelerator_count" in value:
        ...
        out["AcceleratorCount"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_accelerator_count_details.serialize_json(
    ...
    if "accelerator_total_memory_mi_b" in value:
        ...
        out["AcceleratorTotalMemoryMiB"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_accelerator_total_memory_mi_b_details.serialize_json(
    ...
    if "baseline_ebs_bandwidth_mbps" in value:
        ...
        out["BaselineEbsBandwidthMbps"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_baseline_ebs_bandwidth_mbps_details.serialize_json(
    ...
    if "memory_gi_b_per_v_cpu" in value:
        ...
        out["MemoryGiBPerVCpu"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_memory_gi_b_per_v_cpu_details.serialize_json(
    ...
    if "memory_mi_b" in value:
        ...
        out["MemoryMiB"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_memory_mi_b_details.serialize_json(
                value["memory_mi_b"]
            )
        )
    if "network_interface_count" in value:
        ...
        out["NetworkInterfaceCount"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_network_interface_count_details.serialize_json(
    ...
    if "total_local_storage_gb" in value:
        ...
        out["TotalLocalStorageGB"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_total_local_storage_gb_details.serialize_json(
    ...
    if "v_cpu_count" in value:
        ...
        out["VCpuCount"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_v_cpu_count_details.serialize_json(
                value["v_cpu_count"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> AwsEc2LaunchTemplateDataInstanceRequirementsDetails:
    ...
    if "AcceleratorCount" in data:
        ...
        out["accelerator_count"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_accelerator_count_details.deserialize_json(
    ...
    if "AcceleratorTotalMemoryMiB" in data:
        ...
        out["accelerator_total_memory_mi_b"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_accelerator_total_memory_mi_b_details.deserialize_json(
    ...
    if "BaselineEbsBandwidthMbps" in data:
        ...
        out["baseline_ebs_bandwidth_mbps"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_baseline_ebs_bandwidth_mbps_details.deserialize_json(
    ...
    if "MemoryGiBPerVCpu" in data:
        ...
        out["memory_gi_b_per_v_cpu"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_memory_gi_b_per_v_cpu_details.deserialize_json(
    ...
    if "MemoryMiB" in data:
        ...
        out["memory_mi_b"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_memory_mi_b_details.deserialize_json(
                data["MemoryMiB"]
            )
        )
    if "NetworkInterfaceCount" in data:
        ...
        out["network_interface_count"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_network_interface_count_details.deserialize_json(
    ...
    if "TotalLocalStorageGB" in data:
        ...
        out["total_local_storage_gb"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_total_local_storage_gb_details.deserialize_json(
    ...
    if "VCpuCount" in data:
        ...
        out["v_cpu_count"] = (
            aws_sdk_securityhub.types.aws_ec2_launch_template_data_instance_requirements_v_cpu_count_details.deserialize_json(
                data["VCpuCount"]
            )
        )
    return out
