...
StringFilterList: TypeAlias = list[
    "aws_sdk_securityhub.types.string_filter.StringFilter"
]
...
def serialize_json(value: StringFilterList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_securityhub.types.string_filter.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> StringFilterList:
    ...
    for item in data:
        out.append(aws_sdk_securityhub.types.string_filter.deserialize_json(item))
    return out
