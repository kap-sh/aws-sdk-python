...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_cloud_watch_alarm_dimensions_list
...
class AwsCloudWatchAlarmDetails(TypedDict):
    actions_enabled: NotRequired["aws_sdk_securityhub.types.boolean.Boolean"]
    ...
    alarm_arn: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    alarm_name: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    datapoints_to_alarm: NotRequired["aws_sdk_securityhub.types.integer.Integer"]
    """<p>The number of datapoints that must be breaching to trigger the alarm. </p>"""
    dimensions: NotRequired[
        "aws_sdk_securityhub.types.aws_cloud_watch_alarm_dimensions_list.AwsCloudWatchAlarmDimensionsList"
    ]
    ...
    evaluation_periods: NotRequired["aws_sdk_securityhub.types.integer.Integer"]
    ...
    period: NotRequired["aws_sdk_securityhub.types.integer.Integer"]
    """<p>The period, in seconds, over which the statistic is applied. This is required for an alarm based on a metric. </p>"""
    statistic: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    threshold: NotRequired["aws_sdk_securityhub.types.double.Double"]
    ...
    unit: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
...
def serialize_json(value: AwsCloudWatchAlarmDetails) -> dict:
    ...
    if "dimensions" in value:
        ...
        out["Dimensions"] = (
            aws_sdk_securityhub.types.aws_cloud_watch_alarm_dimensions_list.serialize_json(
                value["dimensions"]
            )
        )
...
def deserialize_json(data: dict) -> AwsCloudWatchAlarmDetails:
    ...
    if "Dimensions" in data:
        ...
        out["dimensions"] = (
            aws_sdk_securityhub.types.aws_cloud_watch_alarm_dimensions_list.deserialize_json(
                data["Dimensions"]
            )
        )
