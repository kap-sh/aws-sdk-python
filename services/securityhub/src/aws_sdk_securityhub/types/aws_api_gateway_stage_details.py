...
if TYPE_CHECKING:
    ...
    import aws_sdk_securityhub.types.aws_api_gateway_canary_settings
    import aws_sdk_securityhub.types.aws_api_gateway_method_settings_list
    import aws_sdk_securityhub.types.boolean
    import aws_sdk_securityhub.types.field_map
    import aws_sdk_securityhub.types.non_empty_string


class AwsApiGatewayStageDetails(TypedDict):
    ...
    cache_cluster_enabled: NotRequired["aws_sdk_securityhub.types.boolean.Boolean"]
    ...
    method_settings: NotRequired[
        "aws_sdk_securityhub.types.aws_api_gateway_method_settings_list.AwsApiGatewayMethodSettingsList"
    ]
    ...
    canary_settings: NotRequired[
        "aws_sdk_securityhub.types.aws_api_gateway_canary_settings.AwsApiGatewayCanarySettings"
    ]
    """<p>Information about settings for canary deployment in the stage.</p>"""
    tracing_enabled: NotRequired["aws_sdk_securityhub.types.boolean.Boolean"]
...
def serialize_json(value: AwsApiGatewayStageDetails) -> dict:
    ...
    if "method_settings" in value:
        ...
        out["MethodSettings"] = (
            aws_sdk_securityhub.types.aws_api_gateway_method_settings_list.serialize_json(
    ...
    if "canary_settings" in value:
        ...
        out["CanarySettings"] = (
            aws_sdk_securityhub.types.aws_api_gateway_canary_settings.serialize_json(
...
def deserialize_json(data: dict) -> AwsApiGatewayStageDetails:
    ...
    if "MethodSettings" in data:
        ...
        out["method_settings"] = (
            aws_sdk_securityhub.types.aws_api_gateway_method_settings_list.deserialize_json(
                data["MethodSettings"]
            )
        )
    ...
    if "CanarySettings" in data:
        ...
        out["canary_settings"] = (
            aws_sdk_securityhub.types.aws_api_gateway_canary_settings.deserialize_json(
                data["CanarySettings"]
            )
        )
