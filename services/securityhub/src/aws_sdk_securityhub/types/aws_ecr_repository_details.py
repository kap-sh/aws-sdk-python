...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_ecr_repository_image_scanning_configuration_details
    import aws_sdk_securityhub.types.aws_ecr_repository_lifecycle_policy_details
    import aws_sdk_securityhub.types.non_empty_string


class AwsEcrRepositoryDetails(TypedDict):
    arn: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>The ARN of the repository.</p>"""
    image_scanning_configuration: NotRequired[
        "aws_sdk_securityhub.types.aws_ecr_repository_image_scanning_configuration_details.AwsEcrRepositoryImageScanningConfigurationDetails"
    ]
    ...
    lifecycle_policy: NotRequired[
        "aws_sdk_securityhub.types.aws_ecr_repository_lifecycle_policy_details.AwsEcrRepositoryLifecyclePolicyDetails"
    ]
...
def serialize_json(value: AwsEcrRepositoryDetails) -> dict:
    ...
    if "image_scanning_configuration" in value:
        ...
        out["ImageScanningConfiguration"] = (
            aws_sdk_securityhub.types.aws_ecr_repository_image_scanning_configuration_details.serialize_json(
    ...
    if "lifecycle_policy" in value:
        ...
        out["LifecyclePolicy"] = (
            aws_sdk_securityhub.types.aws_ecr_repository_lifecycle_policy_details.serialize_json(
...
def deserialize_json(data: dict) -> AwsEcrRepositoryDetails:
    ...
    if "ImageScanningConfiguration" in data:
        ...
        out["image_scanning_configuration"] = (
            aws_sdk_securityhub.types.aws_ecr_repository_image_scanning_configuration_details.deserialize_json(
    ...
    if "LifecyclePolicy" in data:
        ...
        out["lifecycle_policy"] = (
            aws_sdk_securityhub.types.aws_ecr_repository_lifecycle_policy_details.deserialize_json(
