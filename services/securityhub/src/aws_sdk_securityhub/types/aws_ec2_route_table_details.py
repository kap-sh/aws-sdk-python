...
if TYPE_CHECKING:
    ...
    import aws_sdk_securityhub.types.propagating_vgw_set_list
...
class AwsEc2RouteTableDetails(TypedDict):
    ...
    propagating_vgw_set: NotRequired[
        "aws_sdk_securityhub.types.propagating_vgw_set_list.PropagatingVgwSetList"
    ]
    ...
    route_set: NotRequired["aws_sdk_securityhub.types.route_set_list.RouteSetList"]
...
def serialize_json(value: AwsEc2RouteTableDetails) -> dict:
    ...
    if "association_set" in value:
        ...
        out["AssociationSet"] = (
            aws_sdk_securityhub.types.association_set_list.serialize_json(
    ...
    if "propagating_vgw_set" in value:
        ...
        out["PropagatingVgwSet"] = (
            aws_sdk_securityhub.types.propagating_vgw_set_list.serialize_json(
    ...
    if "route_set" in value:
        ...
        out["RouteSet"] = aws_sdk_securityhub.types.route_set_list.serialize_json(
            value["route_set"]
        )
    if "vpc_id" in value:
...
def deserialize_json(data: dict) -> AwsEc2RouteTableDetails:
    ...
    if "AssociationSet" in data:
        ...
        out["association_set"] = (
            aws_sdk_securityhub.types.association_set_list.deserialize_json(
                data["AssociationSet"]
            )
        )
    if "OwnerId" in data:
    ...
    if "PropagatingVgwSet" in data:
        ...
        out["propagating_vgw_set"] = (
            aws_sdk_securityhub.types.propagating_vgw_set_list.deserialize_json(
    ...
    if "RouteSet" in data:
        ...
        out["route_set"] = aws_sdk_securityhub.types.route_set_list.deserialize_json(
            data["RouteSet"]
        )
    if "VpcId" in data:
