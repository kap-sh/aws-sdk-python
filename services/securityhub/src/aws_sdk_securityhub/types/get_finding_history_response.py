...
class GetFindingHistoryResponse(TypedDict):
    records: NotRequired[
        "aws_sdk_securityhub.types.finding_history_record_list.FindingHistoryRecordList"
    ]
...
def serialize_json(value: GetFindingHistoryResponse) -> dict:
    ...
    if "records" in value:
        ...
        out["Records"] = (
            aws_sdk_securityhub.types.finding_history_record_list.serialize_json(
                value["records"]
            )
        )
...
def deserialize_json(data: dict) -> GetFindingHistoryResponse:
    ...
    if "Records" in data:
        ...
        out["records"] = (
            aws_sdk_securityhub.types.finding_history_record_list.deserialize_json(
                data["Records"]
            )
        )
