...
if TYPE_CHECKING:
    ...
    import aws_sdk_securityhub.types.network_direction
...
class Network(TypedDict, closed=True):
    direction: NotRequired[
        "aws_sdk_securityhub.types.network_direction.NetworkDirection"
    ]
    ...
    open_port_range: NotRequired["aws_sdk_securityhub.types.port_range.PortRange"]
    """<p>The range of open ports that is present on the network.</p>"""
    source_ip_v4: NotRequired[
        "aws_sdk_securityhub.types.non_empty_string.NonEmptyString"
    ]
    """<p>The source IPv4 address of network-related information about a finding.</p>"""
    source_ip_v6: NotRequired[
        "aws_sdk_securityhub.types.non_empty_string.NonEmptyString"
    ]
    """<p>The source IPv6 address of network-related information about a finding.</p>"""
    source_port: NotRequired["aws_sdk_securityhub.types.integer.Integer"]
    """<p>The source port of network-related information about a finding.</p>"""
    source_domain: NotRequired[
        "aws_sdk_securityhub.types.non_empty_string.NonEmptyString"
    ]
    """<p>The source domain of network-related information about a finding.</p> <p>Length Constraints: Minimum of 1. Maximum of 128.</p>"""
    source_mac: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    destination_port: NotRequired["aws_sdk_securityhub.types.integer.Integer"]
...
def serialize_json(value: Network) -> dict:
    ...
    if "direction" in value:
        ...
        out["Direction"] = aws_sdk_securityhub.types.network_direction.serialize_json(
            value["direction"]
        )
    ...
    if "open_port_range" in value:
        ...
        out["OpenPortRange"] = aws_sdk_securityhub.types.port_range.serialize_json(
...
def deserialize_json(data: dict) -> Network:
    ...
    if "Direction" in data:
        ...
        out["direction"] = aws_sdk_securityhub.types.network_direction.deserialize_json(
            data["Direction"]
        )
    if "Protocol" in data:
    ...
    if "OpenPortRange" in data:
        ...
        out["open_port_range"] = aws_sdk_securityhub.types.port_range.deserialize_json(
            data["OpenPortRange"]
        )
