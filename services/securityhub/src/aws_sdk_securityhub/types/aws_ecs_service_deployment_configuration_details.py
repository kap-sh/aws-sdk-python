...
class AwsEcsServiceDeploymentConfigurationDetails(TypedDict):
    ...
    maximum_percent: NotRequired["aws_sdk_securityhub.types.integer.Integer"]
    ...
    minimum_healthy_percent: NotRequired["aws_sdk_securityhub.types.integer.Integer"]
...
def serialize_json(value: AwsEcsServiceDeploymentConfigurationDetails) -> dict:
    ...
    if "deployment_circuit_breaker" in value:
        ...
        out["DeploymentCircuitBreaker"] = (
            aws_sdk_securityhub.types.aws_ecs_service_deployment_configuration_deployment_circuit_breaker_details.serialize_json(
...
def deserialize_json(data: dict) -> AwsEcsServiceDeploymentConfigurationDetails:
    ...
    if "DeploymentCircuitBreaker" in data:
        ...
        out["deployment_circuit_breaker"] = (
            aws_sdk_securityhub.types.aws_ecs_service_deployment_configuration_deployment_circuit_breaker_details.deserialize_json(
