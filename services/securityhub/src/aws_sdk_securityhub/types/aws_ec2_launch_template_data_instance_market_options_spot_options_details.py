...
class AwsEc2LaunchTemplateDataInstanceMarketOptionsSpotOptionsDetails(TypedDict):
    block_duration_minutes: NotRequired["aws_sdk_securityhub.types.integer.Integer"]
    """<p> Deprecated. </p>"""
    instance_interruption_behavior: NotRequired[
        "aws_sdk_securityhub.types.non_empty_string.NonEmptyString"
    ]
    """<p> The behavior when a Spot Instance is interrupted. </p>"""
    max_price: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
    """<p> The maximum hourly price you're willing to pay for the Spot Instances. </p>"""
    spot_instance_type: NotRequired[
        "aws_sdk_securityhub.types.non_empty_string.NonEmptyString"
    ]
    """<p> The Spot Instance request type. </p>"""
    valid_until: NotRequired[
        "aws_sdk_securityhub.types.non_empty_string.NonEmptyString"
    ]
