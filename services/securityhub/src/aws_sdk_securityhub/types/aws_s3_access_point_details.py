...
if TYPE_CHECKING:
    import aws_sdk_securityhub.types.aws_s3_access_point_vpc_configuration_details
    import aws_sdk_securityhub.types.aws_s3_account_public_access_block_details
    import aws_sdk_securityhub.types.non_empty_string


class AwsS3AccessPointDetails(TypedDict):
    access_point_arn: NotRequired[
        "aws_sdk_securityhub.types.non_empty_string.NonEmptyString"
    ]
    """<p> The Amazon Resource Name (ARN) of the access point. </p>"""
    alias: NotRequired["aws_sdk_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    vpc_configuration: NotRequired[
        "aws_sdk_securityhub.types.aws_s3_access_point_vpc_configuration_details.AwsS3AccessPointVpcConfigurationDetails"
    ]
...
def serialize_json(value: AwsS3AccessPointDetails) -> dict:
    ...
    if "vpc_configuration" in value:
        ...
        out["VpcConfiguration"] = (
            aws_sdk_securityhub.types.aws_s3_access_point_vpc_configuration_details.serialize_json(
...
def deserialize_json(data: dict) -> AwsS3AccessPointDetails:
    ...
    if "VpcConfiguration" in data:
        ...
        out["vpc_configuration"] = (
            aws_sdk_securityhub.types.aws_s3_access_point_vpc_configuration_details.deserialize_json(
