...
if TYPE_CHECKING:
    ...
    import aws_sdk_securityhub.types.resource_severity_breakdown


class ResourceFindingsSummary(TypedDict):
    ...
    total_findings: NotRequired["aws_sdk_securityhub.types.integer.Integer"]
    """<p>The total count of security findings.</p>"""
    severities: NotRequired[
        "aws_sdk_securityhub.types.resource_severity_breakdown.ResourceSeverityBreakdown"
    ]
...
def serialize_json(value: ResourceFindingsSummary) -> dict:
    ...
    if "severities" in value:
        ...
        out["Severities"] = (
            aws_sdk_securityhub.types.resource_severity_breakdown.serialize_json(
                value["severities"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ResourceFindingsSummary:
    ...
    if "Severities" in data:
        ...
        out["severities"] = (
            aws_sdk_securityhub.types.resource_severity_breakdown.deserialize_json(
                data["Severities"]
            )
        )
    return out
