...
class AsyncSecurityHubClientConfig(TypedDict, total=False):
...
class AsyncSecurityHubClient:
    ...
    def __init__(
        ...
        self.config = AsyncSecurityHubClientConfig(
            {
    ...
    async def accept_administrator_invitation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.accept_administrator_invitation_request.AcceptAdministratorInvitationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.accept_administrator_invitation_response.AcceptAdministratorInvitationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.accept_administrator_invitation.async_accept_administrator_invitation(
    ...
    async def accept_invitation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.accept_invitation_request.AcceptInvitationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.accept_invitation_response.AcceptInvitationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.accept_invitation.async_accept_invitation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_delete_automation_rules(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.batch_delete_automation_rules_request.BatchDeleteAutomationRulesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.batch_delete_automation_rules_response.BatchDeleteAutomationRulesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.batch_delete_automation_rules.async_batch_delete_automation_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_disable_standards(
        ...
        *,
        ...
        """<p>Disables the standards specified by the provided <code>StandardsSubscriptionArns</code>.</p> <p>For more information, see <a href=\"https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-standards.html\">Security Standards</a> section of the <i>Security Hub CSPM User Guide</i>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.batch_disable_standards_request.BatchDisableStandardsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.batch_disable_standards_response.BatchDisableStandardsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.batch_disable_standards.async_batch_disable_standards(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_enable_standards(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.batch_enable_standards_request.BatchEnableStandardsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.batch_enable_standards_response.BatchEnableStandardsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.batch_enable_standards.async_batch_enable_standards(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_get_automation_rules(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.batch_get_automation_rules_request.BatchGetAutomationRulesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.batch_get_automation_rules_response.BatchGetAutomationRulesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.batch_get_automation_rules.async_batch_get_automation_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_get_configuration_policy_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.batch_get_configuration_policy_associations_request.BatchGetConfigurationPolicyAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.batch_get_configuration_policy_associations_response.BatchGetConfigurationPolicyAssociationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.batch_get_configuration_policy_associations.async_batch_get_configuration_policy_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_get_security_controls(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.batch_get_security_controls_request.BatchGetSecurityControlsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.batch_get_security_controls_response.BatchGetSecurityControlsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.batch_get_security_controls.async_batch_get_security_controls(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_get_standards_control_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.batch_get_standards_control_associations_request.BatchGetStandardsControlAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.batch_get_standards_control_associations_response.BatchGetStandardsControlAssociationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.batch_get_standards_control_associations.async_batch_get_standards_control_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_import_findings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.batch_import_findings_request.BatchImportFindingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.batch_import_findings_response.BatchImportFindingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.batch_import_findings.async_batch_import_findings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_update_automation_rules(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.batch_update_automation_rules_request.BatchUpdateAutomationRulesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.batch_update_automation_rules_response.BatchUpdateAutomationRulesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.batch_update_automation_rules.async_batch_update_automation_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_update_findings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.batch_update_findings_request.BatchUpdateFindingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.batch_update_findings_response.BatchUpdateFindingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.batch_update_findings.async_batch_update_findings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_update_findings_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.batch_update_findings_v2_request.BatchUpdateFindingsV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.batch_update_findings_v2_response.BatchUpdateFindingsV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.batch_update_findings_v2.async_batch_update_findings_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_update_standards_control_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.batch_update_standards_control_associations_request.BatchUpdateStandardsControlAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.batch_update_standards_control_associations_response.BatchUpdateStandardsControlAssociationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.batch_update_standards_control_associations.async_batch_update_standards_control_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_action_target(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.create_action_target_request.CreateActionTargetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.create_action_target_response.CreateActionTargetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.create_action_target.async_create_action_target(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_aggregator_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.create_aggregator_v2_request.CreateAggregatorV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.create_aggregator_v2_response.CreateAggregatorV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.create_aggregator_v2.async_create_aggregator_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_automation_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.create_automation_rule_request.CreateAutomationRuleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.create_automation_rule_response.CreateAutomationRuleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.create_automation_rule.async_create_automation_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_automation_rule_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.create_automation_rule_v2_request.CreateAutomationRuleV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.create_automation_rule_v2_response.CreateAutomationRuleV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.create_automation_rule_v2.async_create_automation_rule_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_configuration_policy(
        ...
        *,
        ...
        """<p> Creates a configuration policy with the defined configuration. Only the Security Hub CSPM delegated administrator can invoke this operation from the home Region. </p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.create_configuration_policy_request.CreateConfigurationPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.create_configuration_policy_response.CreateConfigurationPolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.create_configuration_policy.async_create_configuration_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_connector_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.create_connector_v2_request.CreateConnectorV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.create_connector_v2_response.CreateConnectorV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.create_connector_v2.async_create_connector_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_finding_aggregator(
        ...
        *,
        ...
        """<note> <p>The <i>aggregation Region</i> is now called the <i>home Region</i>.</p> </note> <p>Used to enable cross-Region aggregation. This operation can be invoked from the home Region only.</p> <p>For information about how cross-Region aggregation works, see <a href=\"https://docs.aws.amazon.com/securityhub/latest/userguide/finding-aggregation.html\">Understanding cross-Region aggregation in Security Hub CSPM</a> in the <i>Security Hub CSPM User Guide</i>. </p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.create_finding_aggregator_request.CreateFindingAggregatorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.create_finding_aggregator_response.CreateFindingAggregatorResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.create_finding_aggregator.async_create_finding_aggregator(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_insight(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.create_insight_request.CreateInsightRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.create_insight_response.CreateInsightResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.create_insight.async_create_insight(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_members(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.create_members_request.CreateMembersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.create_members_response.CreateMembersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.create_members.async_create_members(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_ticket_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.create_ticket_v2_request.CreateTicketV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.create_ticket_v2_response.CreateTicketV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.create_ticket_v2.async_create_ticket_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def decline_invitations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.decline_invitations_request.DeclineInvitationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.decline_invitations_response.DeclineInvitationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.decline_invitations.async_decline_invitations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_action_target(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.delete_action_target_request.DeleteActionTargetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.delete_action_target_response.DeleteActionTargetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.delete_action_target.async_delete_action_target(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_aggregator_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.delete_aggregator_v2_request.DeleteAggregatorV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.delete_aggregator_v2_response.DeleteAggregatorV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.delete_aggregator_v2.async_delete_aggregator_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_automation_rule_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.delete_automation_rule_v2_request.DeleteAutomationRuleV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.delete_automation_rule_v2_response.DeleteAutomationRuleV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.delete_automation_rule_v2.async_delete_automation_rule_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_configuration_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.delete_configuration_policy_request.DeleteConfigurationPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.delete_configuration_policy_response.DeleteConfigurationPolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.delete_configuration_policy.async_delete_configuration_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_connector_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.delete_connector_v2_request.DeleteConnectorV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.delete_connector_v2_response.DeleteConnectorV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.delete_connector_v2.async_delete_connector_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_finding_aggregator(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.delete_finding_aggregator_request.DeleteFindingAggregatorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.delete_finding_aggregator_response.DeleteFindingAggregatorResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.delete_finding_aggregator.async_delete_finding_aggregator(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_insight(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.delete_insight_request.DeleteInsightRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.delete_insight_response.DeleteInsightResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.delete_insight.async_delete_insight(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_invitations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.delete_invitations_request.DeleteInvitationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.delete_invitations_response.DeleteInvitationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.delete_invitations.async_delete_invitations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_members(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.delete_members_request.DeleteMembersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.delete_members_response.DeleteMembersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.delete_members.async_delete_members(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_action_targets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.describe_action_targets_request.DescribeActionTargetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.describe_action_targets_response.DescribeActionTargetsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.describe_action_targets.async_describe_action_targets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.action_target.ActionTarget]":
        _token = next_token
        while True:
    ...
    async def describe_hub(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.describe_hub_request.DescribeHubRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.describe_hub_response.DescribeHubResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.describe_hub.async_describe_hub(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_organization_configuration(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.describe_organization_configuration_request.DescribeOrganizationConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.describe_organization_configuration_response.DescribeOrganizationConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.describe_organization_configuration.async_describe_organization_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_products(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.describe_products_request.DescribeProductsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.describe_products_response.DescribeProductsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.describe_products.async_describe_products(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.product.Product]":
        _token = next_token
        while True:
    ...
    async def describe_products_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.describe_products_v2_request.DescribeProductsV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.describe_products_v2_response.DescribeProductsV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.describe_products_v2.async_describe_products_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.product_v2.ProductV2]":
        _token = next_token
        while True:
    ...
    async def describe_security_hub_v2(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.describe_security_hub_v2_request.DescribeSecurityHubV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.describe_security_hub_v2_response.DescribeSecurityHubV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.describe_security_hub_v2.async_describe_security_hub_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_standards(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.describe_standards_request.DescribeStandardsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.describe_standards_response.DescribeStandardsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.describe_standards.async_describe_standards(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.standard.Standard]":
        _token = next_token
        while True:
    ...
    async def describe_standards_controls(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.describe_standards_controls_request.DescribeStandardsControlsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.describe_standards_controls_response.DescribeStandardsControlsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.describe_standards_controls.async_describe_standards_controls(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.standards_control.StandardsControl]":
        _token = next_token
        while True:
    ...
    async def disable_import_findings_for_product(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.disable_import_findings_for_product_request.DisableImportFindingsForProductRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.disable_import_findings_for_product_response.DisableImportFindingsForProductResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.disable_import_findings_for_product.async_disable_import_findings_for_product(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_organization_admin_account(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.disable_organization_admin_account_request.DisableOrganizationAdminAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.disable_organization_admin_account_response.DisableOrganizationAdminAccountResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.disable_organization_admin_account.async_disable_organization_admin_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_security_hub(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.disable_security_hub_request.DisableSecurityHubRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.disable_security_hub_response.DisableSecurityHubResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.disable_security_hub.async_disable_security_hub(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_security_hub_v2(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.disable_security_hub_v2_request.DisableSecurityHubV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.disable_security_hub_v2_response.DisableSecurityHubV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.disable_security_hub_v2.async_disable_security_hub_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_from_administrator_account(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.disassociate_from_administrator_account_request.DisassociateFromAdministratorAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.disassociate_from_administrator_account_response.DisassociateFromAdministratorAccountResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.disassociate_from_administrator_account.async_disassociate_from_administrator_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_from_master_account(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.disassociate_from_master_account_request.DisassociateFromMasterAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.disassociate_from_master_account_response.DisassociateFromMasterAccountResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.disassociate_from_master_account.async_disassociate_from_master_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_members(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.disassociate_members_request.DisassociateMembersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.disassociate_members_response.DisassociateMembersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.disassociate_members.async_disassociate_members(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_import_findings_for_product(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.enable_import_findings_for_product_request.EnableImportFindingsForProductRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.enable_import_findings_for_product_response.EnableImportFindingsForProductResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.enable_import_findings_for_product.async_enable_import_findings_for_product(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_organization_admin_account(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.enable_organization_admin_account_request.EnableOrganizationAdminAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.enable_organization_admin_account_response.EnableOrganizationAdminAccountResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.enable_organization_admin_account.async_enable_organization_admin_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_security_hub(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.enable_security_hub_request.EnableSecurityHubRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.enable_security_hub_response.EnableSecurityHubResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.enable_security_hub.async_enable_security_hub(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_security_hub_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.enable_security_hub_v2_request.EnableSecurityHubV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.enable_security_hub_v2_response.EnableSecurityHubV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.enable_security_hub_v2.async_enable_security_hub_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_recommended_policy_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.generate_recommended_policy_v2_request.GenerateRecommendedPolicyV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.generate_recommended_policy_v2_response.GenerateRecommendedPolicyV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.generate_recommended_policy_v2.async_generate_recommended_policy_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_administrator_account(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_administrator_account_request.GetAdministratorAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_administrator_account_response.GetAdministratorAccountResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_administrator_account.async_get_administrator_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_aggregator_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_aggregator_v2_request.GetAggregatorV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_aggregator_v2_response.GetAggregatorV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_aggregator_v2.async_get_aggregator_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_automation_rule_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_automation_rule_v2_request.GetAutomationRuleV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_automation_rule_v2_response.GetAutomationRuleV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_automation_rule_v2.async_get_automation_rule_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_configuration_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_configuration_policy_request.GetConfigurationPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_configuration_policy_response.GetConfigurationPolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_configuration_policy.async_get_configuration_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_configuration_policy_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_configuration_policy_association_request.GetConfigurationPolicyAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_configuration_policy_association_response.GetConfigurationPolicyAssociationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_configuration_policy_association.async_get_configuration_policy_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_connector_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_connector_v2_request.GetConnectorV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_connector_v2_response.GetConnectorV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_connector_v2.async_get_connector_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_enabled_standards(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_enabled_standards_request.GetEnabledStandardsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_enabled_standards_response.GetEnabledStandardsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_enabled_standards.async_get_enabled_standards(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.standards_subscription.StandardsSubscription]":
        _token = next_token
        while True:
    ...
    async def get_finding_aggregator(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_finding_aggregator_request.GetFindingAggregatorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_finding_aggregator_response.GetFindingAggregatorResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_finding_aggregator.async_get_finding_aggregator(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_finding_history(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_finding_history_request.GetFindingHistoryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_finding_history_response.GetFindingHistoryResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_finding_history.async_get_finding_history(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.finding_history_record.FindingHistoryRecord]":
        _token = next_token
        while True:
    ...
    async def get_findings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_findings_request.GetFindingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_findings_response.GetFindingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_findings.async_get_findings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.aws_security_finding.AwsSecurityFinding]":
        _token = next_token
        while True:
    ...
    async def get_finding_statistics_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_finding_statistics_v2_request.GetFindingStatisticsV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_finding_statistics_v2_response.GetFindingStatisticsV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_finding_statistics_v2.async_get_finding_statistics_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_findings_trends_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_findings_trends_v2_request.GetFindingsTrendsV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_findings_trends_v2_response.GetFindingsTrendsV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_findings_trends_v2.async_get_findings_trends_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.trends_metrics_result.TrendsMetricsResult]":
        _token = next_token
        while True:
    ...
    async def get_findings_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_findings_v2_request.GetFindingsV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_findings_v2_response.GetFindingsV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_findings_v2.async_get_findings_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.ocsf_finding.OcsfFinding]":
        _token = next_token
        while True:
    ...
    async def get_insight_results(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_insight_results_request.GetInsightResultsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_insight_results_response.GetInsightResultsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_insight_results.async_get_insight_results(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_insights(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_insights_request.GetInsightsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_insights_response.GetInsightsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_insights.async_get_insights(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.insight.Insight]":
        _token = next_token
        while True:
    ...
    async def get_invitations_count(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_invitations_count_request.GetInvitationsCountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_invitations_count_response.GetInvitationsCountResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_invitations_count.async_get_invitations_count(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_master_account(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_master_account_request.GetMasterAccountRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_master_account_response.GetMasterAccountResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_master_account.async_get_master_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_members(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_members_request.GetMembersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_members_response.GetMembersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_members.async_get_members(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_recommended_policy_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_recommended_policy_v2_request.GetRecommendedPolicyV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_recommended_policy_v2_response.GetRecommendedPolicyV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_recommended_policy_v2.async_get_recommended_policy_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.recommendation_step.RecommendationStep]":
        _token = next_token
        while True:
    ...
    async def get_resources_statistics_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_resources_statistics_v2_request.GetResourcesStatisticsV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_resources_statistics_v2_response.GetResourcesStatisticsV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_resources_statistics_v2.async_get_resources_statistics_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resources_trends_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_resources_trends_v2_request.GetResourcesTrendsV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_resources_trends_v2_response.GetResourcesTrendsV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_resources_trends_v2.async_get_resources_trends_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.resources_trends_metrics_result.ResourcesTrendsMetricsResult]":
        _token = next_token
        while True:
    ...
    async def get_resources_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_resources_v2_request.GetResourcesV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_resources_v2_response.GetResourcesV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_resources_v2.async_get_resources_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.resource_result.ResourceResult]":
        _token = next_token
        while True:
    ...
    async def get_security_control_definition(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.get_security_control_definition_request.GetSecurityControlDefinitionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.get_security_control_definition_response.GetSecurityControlDefinitionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.get_security_control_definition.async_get_security_control_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def invite_members(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.invite_members_request.InviteMembersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.invite_members_response.InviteMembersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.invite_members.async_invite_members(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_aggregators_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.list_aggregators_v2_request.ListAggregatorsV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.list_aggregators_v2_response.ListAggregatorsV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.list_aggregators_v2.async_list_aggregators_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.aggregator_v2.AggregatorV2]":
        _token = next_token
        while True:
    ...
    async def list_automation_rules(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.list_automation_rules_request.ListAutomationRulesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.list_automation_rules_response.ListAutomationRulesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.list_automation_rules.async_list_automation_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_automation_rules_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.list_automation_rules_v2_request.ListAutomationRulesV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.list_automation_rules_v2_response.ListAutomationRulesV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.list_automation_rules_v2.async_list_automation_rules_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_configuration_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.list_configuration_policies_request.ListConfigurationPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.list_configuration_policies_response.ListConfigurationPoliciesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.list_configuration_policies.async_list_configuration_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.configuration_policy_summary.ConfigurationPolicySummary]":
        _token = next_token
        while True:
    ...
    async def list_configuration_policy_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.list_configuration_policy_associations_request.ListConfigurationPolicyAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.list_configuration_policy_associations_response.ListConfigurationPolicyAssociationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.list_configuration_policy_associations.async_list_configuration_policy_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.configuration_policy_association_summary.ConfigurationPolicyAssociationSummary]":
        _token = next_token
        while True:
    ...
    async def list_connectors_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.list_connectors_v2_request.ListConnectorsV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.list_connectors_v2_response.ListConnectorsV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.list_connectors_v2.async_list_connectors_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_enabled_products_for_import(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.list_enabled_products_for_import_request.ListEnabledProductsForImportRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.list_enabled_products_for_import_response.ListEnabledProductsForImportResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.list_enabled_products_for_import.async_list_enabled_products_for_import(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.non_empty_string.NonEmptyString]":
        _token = next_token
        while True:
    ...
    async def list_finding_aggregators(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.list_finding_aggregators_request.ListFindingAggregatorsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.list_finding_aggregators_response.ListFindingAggregatorsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.list_finding_aggregators.async_list_finding_aggregators(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_finding_aggregators(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_securityhub.types.finding_aggregator.FindingAggregator]"
    ):
        _token = next_token
        while True:
    ...
    async def list_invitations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.list_invitations_request.ListInvitationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.list_invitations_response.ListInvitationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.list_invitations.async_list_invitations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_invitations(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_securityhub.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_securityhub.types.invitation.Invitation]":
        _token = next_token
        while True:
    ...
    async def list_members(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.list_members_request.ListMembersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.list_members_response.ListMembersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.list_members.async_list_members(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_members(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_securityhub.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_securityhub.types.member.Member]":
        _token = next_token
        while True:
    ...
    async def list_organization_admin_accounts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.list_organization_admin_accounts_request.ListOrganizationAdminAccountsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.list_organization_admin_accounts_response.ListOrganizationAdminAccountsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.list_organization_admin_accounts.async_list_organization_admin_accounts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.admin_account.AdminAccount]":
        _token = next_token
        while True:
    ...
    async def list_security_control_definitions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.list_security_control_definitions_request.ListSecurityControlDefinitionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.list_security_control_definitions_response.ListSecurityControlDefinitionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.list_security_control_definitions.async_list_security_control_definitions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.security_control_definition.SecurityControlDefinition]":
        _token = next_token
        while True:
    ...
    async def list_standards_control_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.list_standards_control_associations_request.ListStandardsControlAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.list_standards_control_associations_response.ListStandardsControlAssociationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.list_standards_control_associations.async_list_standards_control_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_securityhub.types.standards_control_association_summary.StandardsControlAssociationSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_connector_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.register_connector_v2_request.RegisterConnectorV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.register_connector_v2_response.RegisterConnectorV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.register_connector_v2.async_register_connector_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_configuration_policy_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.start_configuration_policy_association_request.StartConfigurationPolicyAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.start_configuration_policy_association_response.StartConfigurationPolicyAssociationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.start_configuration_policy_association.async_start_configuration_policy_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_configuration_policy_disassociation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.start_configuration_policy_disassociation_request.StartConfigurationPolicyDisassociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.start_configuration_policy_disassociation_response.StartConfigurationPolicyDisassociationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.start_configuration_policy_disassociation.async_start_configuration_policy_disassociation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_action_target(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.update_action_target_request.UpdateActionTargetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.update_action_target_response.UpdateActionTargetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.update_action_target.async_update_action_target(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_aggregator_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.update_aggregator_v2_request.UpdateAggregatorV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.update_aggregator_v2_response.UpdateAggregatorV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.update_aggregator_v2.async_update_aggregator_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_automation_rule_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.update_automation_rule_v2_request.UpdateAutomationRuleV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.update_automation_rule_v2_response.UpdateAutomationRuleV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.update_automation_rule_v2.async_update_automation_rule_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_configuration_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.update_configuration_policy_request.UpdateConfigurationPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.update_configuration_policy_response.UpdateConfigurationPolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.update_configuration_policy.async_update_configuration_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_connector_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.update_connector_v2_request.UpdateConnectorV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.update_connector_v2_response.UpdateConnectorV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.update_connector_v2.async_update_connector_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_finding_aggregator(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.update_finding_aggregator_request.UpdateFindingAggregatorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.update_finding_aggregator_response.UpdateFindingAggregatorResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.update_finding_aggregator.async_update_finding_aggregator(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_findings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.update_findings_request.UpdateFindingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.update_findings_response.UpdateFindingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.update_findings.async_update_findings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_insight(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.update_insight_request.UpdateInsightRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.update_insight_response.UpdateInsightResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.update_insight.async_update_insight(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_organization_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.update_organization_configuration_request.UpdateOrganizationConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.update_organization_configuration_response.UpdateOrganizationConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.update_organization_configuration.async_update_organization_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_security_control(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.update_security_control_request.UpdateSecurityControlRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.update_security_control_response.UpdateSecurityControlResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.update_security_control.async_update_security_control(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_security_hub_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.update_security_hub_configuration_request.UpdateSecurityHubConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.update_security_hub_configuration_response.UpdateSecurityHubConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.update_security_hub_configuration.async_update_security_hub_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_standards_control(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_securityhub.types.update_standards_control_request.UpdateStandardsControlRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_securityhub.types.update_standards_control_response.UpdateStandardsControlResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_securityhub._operations.security_hub_api_service.update_standards_control.async_update_standards_control(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
