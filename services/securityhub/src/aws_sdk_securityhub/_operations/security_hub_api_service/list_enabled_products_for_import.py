...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.list_enabled_products_for_import_response.ListEnabledProductsForImportResponse = aws_sdk_securityhub.types.list_enabled_products_for_import_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.list_enabled_products_for_import_request.ListEnabledProductsForImportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
