...
def build_request(
    ...
    input: aws_sdk_securityhub.types.get_finding_history_request.GetFindingHistoryRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.get_finding_history_request.serialize_json(input)
    ).encode()
