...
import aws_sdk_securityhub.types.finding_history_record_list
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_finding_history_response.GetFindingHistoryResponse = aws_sdk_securityhub.types.get_finding_history_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_finding_history_request.GetFindingHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.get_finding_history_request.serialize_json(input_)
    ).encode()
