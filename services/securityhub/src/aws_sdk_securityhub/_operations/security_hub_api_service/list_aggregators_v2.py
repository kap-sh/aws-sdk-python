"""Generated from Smithy shape ``com.amazonaws.securityhub#ListAggregatorsV2``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.list_aggregators_v2_response.ListAggregatorsV2Response = aws_sdk_securityhub.types.list_aggregators_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.list_aggregators_v2_request.ListAggregatorsV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/aggregatorv2/list"
    params: dict[str, str] = {}
...
async def async_list_aggregators_v2(
