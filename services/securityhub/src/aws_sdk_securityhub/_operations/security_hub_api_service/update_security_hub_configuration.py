"""Generated from Smithy shape ``com.amazonaws.securityhub#UpdateSecurityHubConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.update_security_hub_configuration_response.UpdateSecurityHubConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.update_security_hub_configuration_request.UpdateSecurityHubConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityhub.types.update_security_hub_configuration_request

    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.update_security_hub_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_security_hub_configuration(
