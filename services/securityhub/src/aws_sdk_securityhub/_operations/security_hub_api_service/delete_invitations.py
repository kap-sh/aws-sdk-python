...
def build_request(
    ...
    input: aws_sdk_securityhub.types.delete_invitations_request.DeleteInvitationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.delete_invitations_request.serialize_json(input)
    ).encode()
