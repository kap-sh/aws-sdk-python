"""Generated from Smithy shape ``com.amazonaws.securityhub#ListAutomationRules``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.list_automation_rules_response.ListAutomationRulesResponse = aws_sdk_securityhub.types.list_automation_rules_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.list_automation_rules_request.ListAutomationRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/automationrules/list"
    params: dict[str, str] = {}
