...
def build_request(
    ...
    input: aws_sdk_securityhub.types.update_connector_v2_request.UpdateConnectorV2Request,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.update_connector_v2_request.serialize_json(input)
    ).encode()
