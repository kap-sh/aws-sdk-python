...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_configuration_policy_association_response.GetConfigurationPolicyAssociationResponse = aws_sdk_securityhub.types.get_configuration_policy_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_configuration_policy_association_request.GetConfigurationPolicyAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.get_configuration_policy_association_request.serialize_json(
            input_
        )
    ).encode()
