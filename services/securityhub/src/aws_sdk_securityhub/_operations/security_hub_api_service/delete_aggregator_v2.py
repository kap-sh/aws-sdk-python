...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.delete_aggregator_v2_response.DeleteAggregatorV2Response = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_securityhub.types.delete_aggregator_v2_request.DeleteAggregatorV2Request,
) -> zapros.Request:
