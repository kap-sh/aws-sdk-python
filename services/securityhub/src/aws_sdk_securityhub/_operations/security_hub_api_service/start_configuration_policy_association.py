"""Generated from Smithy shape ``com.amazonaws.securityhub#StartConfigurationPolicyAssociation``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.start_configuration_policy_association_response.StartConfigurationPolicyAssociationResponse = aws_sdk_securityhub.types.start_configuration_policy_association_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.start_configuration_policy_association_request.StartConfigurationPolicyAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/configurationPolicyAssociation/associate"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityhub.types.start_configuration_policy_association_request

    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.start_configuration_policy_association_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_configuration_policy_association(
