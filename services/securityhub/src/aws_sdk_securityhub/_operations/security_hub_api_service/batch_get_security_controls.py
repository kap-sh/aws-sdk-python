"""Generated from Smithy shape ``com.amazonaws.securityhub#BatchGetSecurityControls``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.batch_get_security_controls_response.BatchGetSecurityControlsResponse = aws_sdk_securityhub.types.batch_get_security_controls_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.batch_get_security_controls_request.BatchGetSecurityControlsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/securityControls/batchGet"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityhub.types.batch_get_security_controls_request

    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.batch_get_security_controls_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_get_security_controls(
