...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.update_automation_rule_v2_response.UpdateAutomationRuleV2Response = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.update_automation_rule_v2_request.UpdateAutomationRuleV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.update_automation_rule_v2_request.serialize_json(
            input_
        )
    ).encode()
