...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_aggregator_v2_response.GetAggregatorV2Response = aws_sdk_securityhub.types.get_aggregator_v2_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_securityhub.types.get_aggregator_v2_request.GetAggregatorV2Request,
) -> zapros.Request:
