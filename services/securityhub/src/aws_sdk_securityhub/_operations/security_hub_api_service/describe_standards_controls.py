"""Generated from Smithy shape ``com.amazonaws.securityhub#DescribeStandardsControls``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.describe_standards_controls_response.DescribeStandardsControlsResponse = aws_sdk_securityhub.types.describe_standards_controls_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.describe_standards_controls_request.DescribeStandardsControlsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/standards/controls/{StandardsSubscriptionArn+}"
    url = url.replace(
        "{StandardsSubscriptionArn+}",
        quote(str(input_["standards_subscription_arn"]), safe="/"),
    )
    params: dict[str, str] = {}
...
async def async_describe_standards_controls(
