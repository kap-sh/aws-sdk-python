...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.list_configuration_policy_associations_response.ListConfigurationPolicyAssociationsResponse = aws_sdk_securityhub.types.list_configuration_policy_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.list_configuration_policy_associations_request.ListConfigurationPolicyAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.list_configuration_policy_associations_request.serialize_json(
            input_
        )
    ).encode()
