...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.list_organization_admin_accounts_response.ListOrganizationAdminAccountsResponse = aws_sdk_securityhub.types.list_organization_admin_accounts_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_securityhub.types.list_organization_admin_accounts_request.ListOrganizationAdminAccountsRequest,
) -> zapros.Request:
    ...
    if "feature" in input:
        params["Feature"] = str(input["feature"])
