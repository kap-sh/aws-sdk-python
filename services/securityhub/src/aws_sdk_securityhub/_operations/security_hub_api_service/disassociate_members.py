...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.disassociate_members_response.DisassociateMembersResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.disassociate_members_request.DisassociateMembersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.disassociate_members_request.serialize_json(input_)
    ).encode()
