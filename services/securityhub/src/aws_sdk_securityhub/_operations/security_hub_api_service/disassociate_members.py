...
def build_request(
    ...
    input: aws_sdk_securityhub.types.disassociate_members_request.DisassociateMembersRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.disassociate_members_request.serialize_json(input)
    ).encode()
