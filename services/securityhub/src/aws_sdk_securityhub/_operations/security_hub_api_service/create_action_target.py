...
def build_request(
    ...
    input: aws_sdk_securityhub.types.create_action_target_request.CreateActionTargetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.create_action_target_request.serialize_json(input)
    ).encode()
