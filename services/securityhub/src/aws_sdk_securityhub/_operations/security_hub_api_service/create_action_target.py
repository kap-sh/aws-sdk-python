"""Generated from Smithy shape ``com.amazonaws.securityhub#CreateActionTarget``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.create_action_target_response.CreateActionTargetResponse = aws_sdk_securityhub.types.create_action_target_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.create_action_target_request.CreateActionTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/actionTargets"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityhub.types.create_action_target_request

    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.create_action_target_request.serialize_json(input_)
    ).encode()
...
async def async_create_action_target(
