...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.create_aggregator_v2_response.CreateAggregatorV2Response = aws_sdk_securityhub.types.create_aggregator_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.create_aggregator_v2_request.CreateAggregatorV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.create_aggregator_v2_request.serialize_json(input_)
    ).encode()
