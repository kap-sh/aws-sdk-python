...
def build_request(
    ...
    input: aws_sdk_securityhub.types.create_aggregator_v2_request.CreateAggregatorV2Request,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.create_aggregator_v2_request.serialize_json(input)
    ).encode()
