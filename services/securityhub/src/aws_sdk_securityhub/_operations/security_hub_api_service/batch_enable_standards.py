"""Generated from Smithy shape ``com.amazonaws.securityhub#BatchEnableStandards``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.batch_enable_standards_response.BatchEnableStandardsResponse = aws_sdk_securityhub.types.batch_enable_standards_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.batch_enable_standards_request.BatchEnableStandardsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/standards/register"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.batch_enable_standards_request.serialize_json(input_)
    ).encode()
...
async def async_batch_enable_standards(
