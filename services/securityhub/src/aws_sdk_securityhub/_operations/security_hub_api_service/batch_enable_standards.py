...
def build_request(
    ...
    input: aws_sdk_securityhub.types.batch_enable_standards_request.BatchEnableStandardsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.batch_enable_standards_request.serialize_json(input)
    ).encode()
