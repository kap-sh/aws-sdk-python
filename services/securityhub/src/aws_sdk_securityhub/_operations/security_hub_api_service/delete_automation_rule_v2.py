...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.delete_automation_rule_v2_response.DeleteAutomationRuleV2Response = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.delete_automation_rule_v2_request.DeleteAutomationRuleV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
