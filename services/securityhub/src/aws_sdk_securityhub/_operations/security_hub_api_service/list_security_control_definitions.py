...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.list_security_control_definitions_response.ListSecurityControlDefinitionsResponse = aws_sdk_securityhub.types.list_security_control_definitions_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_securityhub.types.list_security_control_definitions_request.ListSecurityControlDefinitionsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "standards_arn" in input:
        params["StandardsArn"] = str(input["standards_arn"])
