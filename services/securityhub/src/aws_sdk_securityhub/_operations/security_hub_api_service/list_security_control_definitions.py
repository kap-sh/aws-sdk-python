...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.list_security_control_definitions_request.ListSecurityControlDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "standards_arn" in input_:
        params["StandardsArn"] = str(input_["standards_arn"])
