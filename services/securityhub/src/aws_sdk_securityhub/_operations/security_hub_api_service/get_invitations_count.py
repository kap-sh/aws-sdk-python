...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_invitations_count_response.GetInvitationsCountResponse = aws_sdk_securityhub.types.get_invitations_count_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_invitations_count_request.GetInvitationsCountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
