...
def build_request(
    ...
    input: aws_sdk_securityhub.types.batch_import_findings_request.BatchImportFindingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.batch_import_findings_request.serialize_json(input)
    ).encode()
