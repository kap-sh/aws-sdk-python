"""Generated from Smithy shape ``com.amazonaws.securityhub#BatchImportFindings``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.batch_import_findings_response.BatchImportFindingsResponse = aws_sdk_securityhub.types.batch_import_findings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.batch_import_findings_request.BatchImportFindingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/findings/import"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityhub.types.batch_import_findings_request

    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.batch_import_findings_request.serialize_json(input_)
    ).encode()
...
async def async_batch_import_findings(
