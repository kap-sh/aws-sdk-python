...
def build_request(
    ...
    input: aws_sdk_securityhub.types.create_automation_rule_request.CreateAutomationRuleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.create_automation_rule_request.serialize_json(input)
    ).encode()
