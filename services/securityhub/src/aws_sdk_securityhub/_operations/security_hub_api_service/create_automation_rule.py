...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.create_automation_rule_response.CreateAutomationRuleResponse = aws_sdk_securityhub.types.create_automation_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.create_automation_rule_request.CreateAutomationRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.create_automation_rule_request.serialize_json(input_)
    ).encode()
