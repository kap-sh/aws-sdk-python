"""Generated from Smithy shape ``com.amazonaws.securityhub#InviteMembers``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.invite_members_response.InviteMembersResponse = (
        aws_sdk_securityhub.types.invite_members_response.deserialize_json(
