...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.create_members_response.CreateMembersResponse = (
        aws_sdk_securityhub.types.create_members_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.create_members_request.CreateMembersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.create_members_request.serialize_json(input_)
    ).encode()
