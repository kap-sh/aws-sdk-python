"""Generated from Smithy shape ``com.amazonaws.securityhub#GenerateRecommendedPolicyV2``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.generate_recommended_policy_v2_response.GenerateRecommendedPolicyV2Response = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.generate_recommended_policy_v2_request.GenerateRecommendedPolicyV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/recommendedPolicyV2/{MetadataUid}"
    url = url.replace("{MetadataUid}", quote(str(input_["metadata_uid"]), safe=""))
    params: dict[str, str] = {}
...
async def async_generate_recommended_policy_v2(
