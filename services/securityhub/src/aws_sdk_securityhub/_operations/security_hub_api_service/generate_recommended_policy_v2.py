...
def build_request(
    ...
    input: aws_sdk_securityhub.types.generate_recommended_policy_v2_request.GenerateRecommendedPolicyV2Request,
) -> zapros.Request:
    ...
    url = url.replace("{MetadataUid}", quote(str(input["metadata_uid"]), safe=""))
    params: dict[str, str] = {}
