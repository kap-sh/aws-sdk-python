"""Generated from Smithy shape ``com.amazonaws.securityhub#DeclineInvitations``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.decline_invitations_response.DeclineInvitationsResponse = aws_sdk_securityhub.types.decline_invitations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.decline_invitations_request.DeclineInvitationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.decline_invitations_request.serialize_json(input_)
    ).encode()
