...
def build_request(
    ...
    input: aws_sdk_securityhub.types.decline_invitations_request.DeclineInvitationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.decline_invitations_request.serialize_json(input)
    ).encode()
