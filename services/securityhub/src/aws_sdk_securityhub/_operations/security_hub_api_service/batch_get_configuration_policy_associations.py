...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.batch_get_configuration_policy_associations_response.BatchGetConfigurationPolicyAssociationsResponse = aws_sdk_securityhub.types.batch_get_configuration_policy_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.batch_get_configuration_policy_associations_request.BatchGetConfigurationPolicyAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
