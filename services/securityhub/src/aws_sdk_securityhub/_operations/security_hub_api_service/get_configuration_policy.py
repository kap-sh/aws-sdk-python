...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_configuration_policy_response.GetConfigurationPolicyResponse = aws_sdk_securityhub.types.get_configuration_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_configuration_policy_request.GetConfigurationPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
