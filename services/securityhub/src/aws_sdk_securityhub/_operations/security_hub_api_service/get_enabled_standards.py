...
def build_request(
    ...
    input: aws_sdk_securityhub.types.get_enabled_standards_request.GetEnabledStandardsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.get_enabled_standards_request.serialize_json(input)
    ).encode()
