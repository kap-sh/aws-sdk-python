"""Generated from Smithy shape ``com.amazonaws.securityhub#GetEnabledStandards``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_enabled_standards_response.GetEnabledStandardsResponse = aws_sdk_securityhub.types.get_enabled_standards_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_enabled_standards_request.GetEnabledStandardsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/standards/get"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityhub.types.get_enabled_standards_request

    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.get_enabled_standards_request.serialize_json(input_)
    ).encode()
...
async def async_get_enabled_standards(
