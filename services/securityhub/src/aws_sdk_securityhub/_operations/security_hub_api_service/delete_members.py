"""Generated from Smithy shape ``com.amazonaws.securityhub#DeleteMembers``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.delete_members_response.DeleteMembersResponse = (
        aws_sdk_securityhub.types.delete_members_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.delete_members_request.DeleteMembersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/members/delete"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityhub.types.delete_members_request

    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.delete_members_request.serialize_json(input_)
    ).encode()
