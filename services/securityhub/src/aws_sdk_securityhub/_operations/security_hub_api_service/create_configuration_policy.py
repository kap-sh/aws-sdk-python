...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.create_configuration_policy_response.CreateConfigurationPolicyResponse = aws_sdk_securityhub.types.create_configuration_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.create_configuration_policy_request.CreateConfigurationPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.create_configuration_policy_request.serialize_json(
            input_
        )
    ).encode()
