...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.describe_hub_response.DescribeHubResponse = (
        aws_sdk_securityhub.types.describe_hub_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.describe_hub_request.DescribeHubRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "hub_arn" in input_:
        params["HubArn"] = str(input_["hub_arn"])
...
def describe_hub(
    ...
    aws_sdk_securityhub.types.describe_hub_response.DescribeHubResponse, zapros.Response
]:
