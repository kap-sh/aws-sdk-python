...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_connector_v2_response.GetConnectorV2Response = (
        aws_sdk_securityhub.types.get_connector_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_connector_v2_request.GetConnectorV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
