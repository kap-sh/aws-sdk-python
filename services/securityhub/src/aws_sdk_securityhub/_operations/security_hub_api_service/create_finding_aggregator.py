...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.create_finding_aggregator_response.CreateFindingAggregatorResponse = aws_sdk_securityhub.types.create_finding_aggregator_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.create_finding_aggregator_request.CreateFindingAggregatorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
