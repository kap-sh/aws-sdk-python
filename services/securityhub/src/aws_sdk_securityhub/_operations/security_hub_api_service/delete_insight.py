...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.delete_insight_response.DeleteInsightResponse = (
        aws_sdk_securityhub.types.delete_insight_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.delete_insight_request.DeleteInsightRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
