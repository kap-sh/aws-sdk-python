...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.start_configuration_policy_disassociation_response.StartConfigurationPolicyDisassociationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.start_configuration_policy_disassociation_request.StartConfigurationPolicyDisassociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.start_configuration_policy_disassociation_request.serialize_json(
            input_
        )
    ).encode()
