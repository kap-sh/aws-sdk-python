"""Generated from Smithy shape ``com.amazonaws.securityhub#DisableSecurityHubV2``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.disable_security_hub_v2_response.DisableSecurityHubV2Response = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.disable_security_hub_v2_request.DisableSecurityHubV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_disable_security_hub_v2(
