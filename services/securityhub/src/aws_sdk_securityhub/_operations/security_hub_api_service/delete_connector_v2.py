"""Generated from Smithy shape ``com.amazonaws.securityhub#DeleteConnectorV2``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.delete_connector_v2_response.DeleteConnectorV2Response = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.delete_connector_v2_request.DeleteConnectorV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_connector_v2(
