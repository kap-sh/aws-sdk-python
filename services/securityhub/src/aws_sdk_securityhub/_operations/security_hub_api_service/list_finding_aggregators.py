...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.list_finding_aggregators_response.ListFindingAggregatorsResponse = aws_sdk_securityhub.types.list_finding_aggregators_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.list_finding_aggregators_request.ListFindingAggregatorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
