...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.disable_security_hub_response.DisableSecurityHubResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.disable_security_hub_request.DisableSecurityHubRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
