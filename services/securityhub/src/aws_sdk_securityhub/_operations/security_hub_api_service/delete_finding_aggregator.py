"""Generated from Smithy shape ``com.amazonaws.securityhub#DeleteFindingAggregator``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.delete_finding_aggregator_response.DeleteFindingAggregatorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_securityhub.types.delete_finding_aggregator_request.DeleteFindingAggregatorRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/findingAggregator/delete/{FindingAggregatorArn+}"
    url = url.replace(
...
async def async_delete_finding_aggregator(
