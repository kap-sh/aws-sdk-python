"""Generated from Smithy shape ``com.amazonaws.securityhub#DescribeOrganizationConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.describe_organization_configuration_response.DescribeOrganizationConfigurationResponse = aws_sdk_securityhub.types.describe_organization_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.describe_organization_configuration_request.DescribeOrganizationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/organization/configuration"
    params: dict[str, str] = {}
