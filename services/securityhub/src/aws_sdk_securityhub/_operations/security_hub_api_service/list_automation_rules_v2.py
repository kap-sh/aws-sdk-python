"""Generated from Smithy shape ``com.amazonaws.securityhub#ListAutomationRulesV2``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.list_automation_rules_v2_response.ListAutomationRulesV2Response = aws_sdk_securityhub.types.list_automation_rules_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.list_automation_rules_v2_request.ListAutomationRulesV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/automationrulesv2/list"
    params: dict[str, str] = {}
...
async def async_list_automation_rules_v2(
