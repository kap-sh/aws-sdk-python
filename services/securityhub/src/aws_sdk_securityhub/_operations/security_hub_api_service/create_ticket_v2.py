"""Generated from Smithy shape ``com.amazonaws.securityhub#CreateTicketV2``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.create_ticket_v2_response.CreateTicketV2Response = (
        aws_sdk_securityhub.types.create_ticket_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.create_ticket_v2_request.CreateTicketV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ticketsv2"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityhub.types.create_ticket_v2_request

    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.create_ticket_v2_request.serialize_json(input_)
    ).encode()
...
async def async_create_ticket_v2(
