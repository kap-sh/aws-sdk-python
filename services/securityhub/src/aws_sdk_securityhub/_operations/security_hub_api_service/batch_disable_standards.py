...
def build_request(
    ...
    input: aws_sdk_securityhub.types.batch_disable_standards_request.BatchDisableStandardsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.batch_disable_standards_request.serialize_json(input)
    ).encode()
