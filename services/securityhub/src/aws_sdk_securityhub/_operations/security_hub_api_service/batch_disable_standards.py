...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.batch_disable_standards_response.BatchDisableStandardsResponse = aws_sdk_securityhub.types.batch_disable_standards_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.batch_disable_standards_request.BatchDisableStandardsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.batch_disable_standards_request.serialize_json(input_)
    ).encode()
