"""Generated from Smithy shape ``com.amazonaws.securityhub#DeleteActionTarget``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.delete_action_target_response.DeleteActionTargetResponse = aws_sdk_securityhub.types.delete_action_target_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.delete_action_target_request.DeleteActionTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_action_target(
