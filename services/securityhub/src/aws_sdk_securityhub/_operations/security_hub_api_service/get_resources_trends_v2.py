...
def build_request(
    ...
    input: aws_sdk_securityhub.types.get_resources_trends_v2_request.GetResourcesTrendsV2Request,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.get_resources_trends_v2_request.serialize_json(input)
    ).encode()
