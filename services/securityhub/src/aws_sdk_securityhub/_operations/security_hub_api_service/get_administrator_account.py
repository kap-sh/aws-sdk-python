"""Generated from Smithy shape ``com.amazonaws.securityhub#GetAdministratorAccount``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_administrator_account_response.GetAdministratorAccountResponse = aws_sdk_securityhub.types.get_administrator_account_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_administrator_account_request.GetAdministratorAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
