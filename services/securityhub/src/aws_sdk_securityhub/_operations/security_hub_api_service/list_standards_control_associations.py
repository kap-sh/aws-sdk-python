...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.list_standards_control_associations_response.ListStandardsControlAssociationsResponse = aws_sdk_securityhub.types.list_standards_control_associations_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_securityhub.types.list_standards_control_associations_request.ListStandardsControlAssociationsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "security_control_id" in input:
        params["SecurityControlId"] = str(input["security_control_id"])
