...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_finding_statistics_v2_response.GetFindingStatisticsV2Response = aws_sdk_securityhub.types.get_finding_statistics_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_finding_statistics_v2_request.GetFindingStatisticsV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.get_finding_statistics_v2_request.serialize_json(
            input_
        )
    ).encode()
