...
def build_request(
    ...
    input: aws_sdk_securityhub.types.describe_action_targets_request.DescribeActionTargetsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.describe_action_targets_request.serialize_json(input)
    ).encode()
