...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.describe_action_targets_response.DescribeActionTargetsResponse = aws_sdk_securityhub.types.describe_action_targets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.describe_action_targets_request.DescribeActionTargetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.describe_action_targets_request.serialize_json(input_)
    ).encode()
