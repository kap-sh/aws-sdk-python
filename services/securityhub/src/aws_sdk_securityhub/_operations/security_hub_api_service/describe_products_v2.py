...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.describe_products_v2_response.DescribeProductsV2Response = aws_sdk_securityhub.types.describe_products_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.describe_products_v2_request.DescribeProductsV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
