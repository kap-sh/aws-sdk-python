...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.create_connector_v2_response.CreateConnectorV2Response = aws_sdk_securityhub.types.create_connector_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.create_connector_v2_request.CreateConnectorV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.create_connector_v2_request.serialize_json(input_)
    ).encode()
