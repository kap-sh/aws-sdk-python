"""Generated from Smithy shape ``com.amazonaws.securityhub#ListConfigurationPolicies``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.list_configuration_policies_response.ListConfigurationPoliciesResponse = aws_sdk_securityhub.types.list_configuration_policies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.list_configuration_policies_request.ListConfigurationPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/configurationPolicy/list"
    params: dict[str, str] = {}
...
async def async_list_configuration_policies(
