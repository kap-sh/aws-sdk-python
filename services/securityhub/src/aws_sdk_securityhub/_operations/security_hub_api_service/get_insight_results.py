...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_insight_results_response.GetInsightResultsResponse = aws_sdk_securityhub.types.get_insight_results_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_insight_results_request.GetInsightResultsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
