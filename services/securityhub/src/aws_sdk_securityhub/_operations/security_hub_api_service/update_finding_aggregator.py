...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.update_finding_aggregator_response.UpdateFindingAggregatorResponse = aws_sdk_securityhub.types.update_finding_aggregator_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.update_finding_aggregator_request.UpdateFindingAggregatorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.update_finding_aggregator_request.serialize_json(
            input_
        )
    ).encode()
