...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.describe_standards_response.DescribeStandardsResponse = aws_sdk_securityhub.types.describe_standards_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.describe_standards_request.DescribeStandardsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
