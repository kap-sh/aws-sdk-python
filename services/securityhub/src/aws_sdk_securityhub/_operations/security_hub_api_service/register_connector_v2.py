"""Generated from Smithy shape ``com.amazonaws.securityhub#RegisterConnectorV2``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.register_connector_v2_response.RegisterConnectorV2Response = aws_sdk_securityhub.types.register_connector_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.register_connector_v2_request.RegisterConnectorV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/connectorsv2/register"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.register_connector_v2_request.serialize_json(input_)
    ).encode()
...
async def async_register_connector_v2(
