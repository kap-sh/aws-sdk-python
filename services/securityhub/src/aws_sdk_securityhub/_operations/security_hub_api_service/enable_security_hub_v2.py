"""Generated from Smithy shape ``com.amazonaws.securityhub#EnableSecurityHubV2``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.enable_security_hub_v2_response.EnableSecurityHubV2Response = aws_sdk_securityhub.types.enable_security_hub_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.enable_security_hub_v2_request.EnableSecurityHubV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/hubv2"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityhub.types.enable_security_hub_v2_request

    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.enable_security_hub_v2_request.serialize_json(input_)
    ).encode()
...
async def async_enable_security_hub_v2(
