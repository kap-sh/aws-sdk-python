...
def build_request(
    ...
    input: aws_sdk_securityhub.types.enable_security_hub_v2_request.EnableSecurityHubV2Request,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.enable_security_hub_v2_request.serialize_json(input)
    ).encode()
