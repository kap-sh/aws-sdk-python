...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.describe_products_response.DescribeProductsResponse = aws_sdk_securityhub.types.describe_products_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_securityhub.types.describe_products_request.DescribeProductsRequest,
) -> zapros.Request:
    ...
    if "product_arn" in input:
        params["ProductArn"] = str(input["product_arn"])
