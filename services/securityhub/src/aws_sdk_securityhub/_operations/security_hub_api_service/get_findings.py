...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_findings_response.GetFindingsResponse = (
        aws_sdk_securityhub.types.get_findings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_findings_request.GetFindingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.get_findings_request.serialize_json(input_)
    ).encode()
...
def get_findings(
    ...
    aws_sdk_securityhub.types.get_findings_response.GetFindingsResponse, zapros.Response
]:
