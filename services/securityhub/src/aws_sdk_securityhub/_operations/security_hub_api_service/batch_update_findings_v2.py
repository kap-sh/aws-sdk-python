...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.batch_update_findings_v2_request.BatchUpdateFindingsV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.batch_update_findings_v2_request.serialize_json(
            input_
        )
    ).encode()
