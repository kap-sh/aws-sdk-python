...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.batch_update_findings_v2_response.BatchUpdateFindingsV2Response = aws_sdk_securityhub.types.batch_update_findings_v2_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_securityhub.types.batch_update_findings_v2_request.BatchUpdateFindingsV2Request,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.batch_update_findings_v2_request.serialize_json(input)
    ).encode()
