"""Generated from Smithy shape ``com.amazonaws.securityhub#GetResourcesStatisticsV2``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_resources_statistics_v2_response.GetResourcesStatisticsV2Response = aws_sdk_securityhub.types.get_resources_statistics_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_resources_statistics_v2_request.GetResourcesStatisticsV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/resourcesv2/statistics"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityhub.types.get_resources_statistics_v2_request

    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.get_resources_statistics_v2_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_resources_statistics_v2(
