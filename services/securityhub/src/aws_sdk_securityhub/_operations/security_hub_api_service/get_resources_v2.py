...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_resources_v2_response.GetResourcesV2Response = (
        aws_sdk_securityhub.types.get_resources_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_resources_v2_request.GetResourcesV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.get_resources_v2_request.serialize_json(input_)
    ).encode()
