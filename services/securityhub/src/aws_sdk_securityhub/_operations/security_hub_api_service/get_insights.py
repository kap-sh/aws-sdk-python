...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_insights_response.GetInsightsResponse = (
        aws_sdk_securityhub.types.get_insights_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_insights_request.GetInsightsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.get_insights_request.serialize_json(input_)
    ).encode()
...
def get_insights(
    ...
    aws_sdk_securityhub.types.get_insights_response.GetInsightsResponse, zapros.Response
]:
