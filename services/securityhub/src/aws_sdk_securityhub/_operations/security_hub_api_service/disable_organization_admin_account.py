"""Generated from Smithy shape ``com.amazonaws.securityhub#DisableOrganizationAdminAccount``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.disable_organization_admin_account_response.DisableOrganizationAdminAccountResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.disable_organization_admin_account_request.DisableOrganizationAdminAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/organization/admin/disable"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityhub.types.disable_organization_admin_account_request

    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.disable_organization_admin_account_request.serialize_json(
            input_
        )
    ).encode()
