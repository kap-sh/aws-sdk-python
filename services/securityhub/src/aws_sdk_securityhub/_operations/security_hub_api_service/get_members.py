...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_members_response.GetMembersResponse = (
        aws_sdk_securityhub.types.get_members_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_members_request.GetMembersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.get_members_request.serialize_json(input_)
    ).encode()
...
def get_members(
    ...
    aws_sdk_securityhub.types.get_members_response.GetMembersResponse, zapros.Response
]:
