...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.list_connectors_v2_response.ListConnectorsV2Response = aws_sdk_securityhub.types.list_connectors_v2_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_securityhub.types.list_connectors_v2_request.ListConnectorsV2Request,
) -> zapros.Request:
    ...
    if "connector_status" in input:
        params["ConnectorStatus"] = str(input["connector_status"])
