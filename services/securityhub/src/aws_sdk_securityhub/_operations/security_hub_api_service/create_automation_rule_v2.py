"""Generated from Smithy shape ``com.amazonaws.securityhub#CreateAutomationRuleV2``."""
...
import aws_sdk_securityhub.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_securityhub.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.create_automation_rule_v2_response.CreateAutomationRuleV2Response = aws_sdk_securityhub.types.create_automation_rule_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.create_automation_rule_v2_request.CreateAutomationRuleV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/automationrulesv2/create"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityhub.types.create_automation_rule_v2_request

    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.create_automation_rule_v2_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_automation_rule_v2(
