...
def build_request(
    ...
    input: aws_sdk_securityhub.types.enable_security_hub_request.EnableSecurityHubRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.enable_security_hub_request.serialize_json(input)
    ).encode()
