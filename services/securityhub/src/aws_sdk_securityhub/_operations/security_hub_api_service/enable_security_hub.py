...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.enable_security_hub_response.EnableSecurityHubResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.enable_security_hub_request.EnableSecurityHubRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.enable_security_hub_request.serialize_json(input_)
    ).encode()
