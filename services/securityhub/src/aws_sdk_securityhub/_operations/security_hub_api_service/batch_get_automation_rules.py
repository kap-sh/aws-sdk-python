"""Generated from Smithy shape ``com.amazonaws.securityhub#BatchGetAutomationRules``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.batch_get_automation_rules_response.BatchGetAutomationRulesResponse = aws_sdk_securityhub.types.batch_get_automation_rules_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.batch_get_automation_rules_request.BatchGetAutomationRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_batch_get_automation_rules(
