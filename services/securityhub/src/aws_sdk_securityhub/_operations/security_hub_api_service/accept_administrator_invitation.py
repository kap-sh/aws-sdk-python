"""Generated from Smithy shape ``com.amazonaws.securityhub#AcceptAdministratorInvitation``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.accept_administrator_invitation_response.AcceptAdministratorInvitationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.accept_administrator_invitation_request.AcceptAdministratorInvitationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/administrator"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.accept_administrator_invitation_request.serialize_json(
            input_
        )
    ).encode()
