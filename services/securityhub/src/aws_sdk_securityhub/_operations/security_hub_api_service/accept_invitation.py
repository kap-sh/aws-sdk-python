...
def build_request(
    ...
    input: aws_sdk_securityhub.types.accept_invitation_request.AcceptInvitationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.accept_invitation_request.serialize_json(input)
    ).encode()
