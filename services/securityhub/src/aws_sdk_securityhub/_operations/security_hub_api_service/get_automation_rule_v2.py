"""Generated from Smithy shape ``com.amazonaws.securityhub#GetAutomationRuleV2``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_automation_rule_v2_response.GetAutomationRuleV2Response = aws_sdk_securityhub.types.get_automation_rule_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_automation_rule_v2_request.GetAutomationRuleV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/automationrulesv2/{Identifier}"
...
async def async_get_automation_rule_v2(
