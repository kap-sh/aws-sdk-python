...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.enable_organization_admin_account_response.EnableOrganizationAdminAccountResponse = aws_sdk_securityhub.types.enable_organization_admin_account_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.enable_organization_admin_account_request.EnableOrganizationAdminAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.enable_organization_admin_account_request.serialize_json(
            input_
        )
    ).encode()
