...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.update_aggregator_v2_response.UpdateAggregatorV2Response = aws_sdk_securityhub.types.update_aggregator_v2_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_securityhub.types.update_aggregator_v2_request.UpdateAggregatorV2Request,
) -> zapros.Request:
    ...
    url = url.replace(
        "{AggregatorV2Arn+}", quote(str(input["aggregator_v2_arn"]), safe="/")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.update_aggregator_v2_request.serialize_json(input)
    ).encode()
