...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.update_aggregator_v2_request.UpdateAggregatorV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.update_aggregator_v2_request.serialize_json(input_)
    ).encode()
