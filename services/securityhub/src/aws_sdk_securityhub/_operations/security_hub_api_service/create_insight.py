"""Generated from Smithy shape ``com.amazonaws.securityhub#CreateInsight``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.create_insight_response.CreateInsightResponse = (
        aws_sdk_securityhub.types.create_insight_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.create_insight_request.CreateInsightRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.create_insight_request.serialize_json(input_)
    ).encode()
...
async def async_create_insight(
