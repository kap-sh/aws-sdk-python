...
def build_request(
    ...
    input: aws_sdk_securityhub.types.disable_import_findings_for_product_request.DisableImportFindingsForProductRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["product_subscription_arn"]), safe="/"),
    )
    params: dict[str, str] = {}
