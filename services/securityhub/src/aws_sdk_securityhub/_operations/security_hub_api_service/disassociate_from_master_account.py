"""Generated from Smithy shape ``com.amazonaws.securityhub#DisassociateFromMasterAccount``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.disassociate_from_master_account_response.DisassociateFromMasterAccountResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.disassociate_from_master_account_request.DisassociateFromMasterAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/master/disassociate"
    params: dict[str, str] = {}
