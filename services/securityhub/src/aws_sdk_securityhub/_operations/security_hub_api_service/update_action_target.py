...
def build_request(
    ...
    input: aws_sdk_securityhub.types.update_action_target_request.UpdateActionTargetRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ActionTargetArn+}", quote(str(input["action_target_arn"]), safe="/")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.update_action_target_request.serialize_json(input)
    ).encode()
