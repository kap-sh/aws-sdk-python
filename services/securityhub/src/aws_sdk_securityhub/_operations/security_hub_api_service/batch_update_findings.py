...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.batch_update_findings_response.BatchUpdateFindingsResponse = aws_sdk_securityhub.types.batch_update_findings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.batch_update_findings_request.BatchUpdateFindingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.batch_update_findings_request.serialize_json(input_)
    ).encode()
