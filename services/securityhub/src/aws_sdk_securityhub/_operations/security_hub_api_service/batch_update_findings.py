...
def build_request(
    ...
    input: aws_sdk_securityhub.types.batch_update_findings_request.BatchUpdateFindingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.batch_update_findings_request.serialize_json(input)
    ).encode()
