"""Generated from Smithy shape ``com.amazonaws.securityhub#EnableImportFindingsForProduct``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.enable_import_findings_for_product_response.EnableImportFindingsForProductResponse = aws_sdk_securityhub.types.enable_import_findings_for_product_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.enable_import_findings_for_product_request.EnableImportFindingsForProductRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/productSubscriptions"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.enable_import_findings_for_product_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_enable_import_findings_for_product(
