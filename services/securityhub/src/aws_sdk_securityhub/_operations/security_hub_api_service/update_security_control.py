...
def build_request(
    ...
    input: aws_sdk_securityhub.types.update_security_control_request.UpdateSecurityControlRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.update_security_control_request.serialize_json(input)
    ).encode()
