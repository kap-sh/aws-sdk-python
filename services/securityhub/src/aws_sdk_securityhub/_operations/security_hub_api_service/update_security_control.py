"""Generated from Smithy shape ``com.amazonaws.securityhub#UpdateSecurityControl``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            import aws_sdk_securityhub.errors.resource_in_use_exception

            raise aws_sdk_securityhub.errors.resource_in_use_exception.ResourceInUseException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.update_security_control_response.UpdateSecurityControlResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.update_security_control_request.UpdateSecurityControlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/securityControl/update"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_securityhub.types.update_security_control_request

    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.update_security_control_request.serialize_json(input_)
    ).encode()
...
async def async_update_security_control(
