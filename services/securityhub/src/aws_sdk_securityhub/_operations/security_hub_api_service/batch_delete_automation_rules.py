...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.batch_delete_automation_rules_response.BatchDeleteAutomationRulesResponse = aws_sdk_securityhub.types.batch_delete_automation_rules_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.batch_delete_automation_rules_request.BatchDeleteAutomationRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.batch_delete_automation_rules_request.serialize_json(
            input_
        )
    ).encode()
