"""Generated from Smithy shape ``com.amazonaws.securityhub#UpdateConfigurationPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.update_configuration_policy_response.UpdateConfigurationPolicyResponse = aws_sdk_securityhub.types.update_configuration_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.update_configuration_policy_request.UpdateConfigurationPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.update_configuration_policy_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_configuration_policy(
