...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_master_account_response.GetMasterAccountResponse = aws_sdk_securityhub.types.get_master_account_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_master_account_request.GetMasterAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
