...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_security_control_definition_response.GetSecurityControlDefinitionResponse = aws_sdk_securityhub.types.get_security_control_definition_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_securityhub.types.get_security_control_definition_request.GetSecurityControlDefinitionRequest,
) -> zapros.Request:
