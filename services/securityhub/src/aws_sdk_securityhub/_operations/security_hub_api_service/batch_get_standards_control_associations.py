"""Generated from Smithy shape ``com.amazonaws.securityhub#BatchGetStandardsControlAssociations``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.batch_get_standards_control_associations_response.BatchGetStandardsControlAssociationsResponse = aws_sdk_securityhub.types.batch_get_standards_control_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.batch_get_standards_control_associations_request.BatchGetStandardsControlAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/associations/batchGet"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.batch_get_standards_control_associations_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_get_standards_control_associations(
