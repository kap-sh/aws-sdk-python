"""Generated from Smithy shape ``com.amazonaws.securityhub#UpdateFindings``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.update_findings_response.UpdateFindingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.update_findings_request.UpdateFindingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.update_findings_request.serialize_json(input_)
    ).encode()
