"""Generated from Smithy shape ``com.amazonaws.securityhub#DescribeSecurityHubV2``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.describe_security_hub_v2_response.DescribeSecurityHubV2Response = aws_sdk_securityhub.types.describe_security_hub_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.describe_security_hub_v2_request.DescribeSecurityHubV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_security_hub_v2(
