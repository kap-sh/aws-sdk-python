"""Generated from Smithy shape ``com.amazonaws.securityhub#BatchUpdateStandardsControlAssociations``."""
...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.batch_update_standards_control_associations_response.BatchUpdateStandardsControlAssociationsResponse = aws_sdk_securityhub.types.batch_update_standards_control_associations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.batch_update_standards_control_associations_request.BatchUpdateStandardsControlAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_securityhub.types.batch_update_standards_control_associations_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_update_standards_control_associations(
