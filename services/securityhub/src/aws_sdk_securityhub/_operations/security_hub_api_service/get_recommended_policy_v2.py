...
def handle_response(
    ...
    out: aws_sdk_securityhub.types.get_recommended_policy_v2_response.GetRecommendedPolicyV2Response = aws_sdk_securityhub.types.get_recommended_policy_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_securityhub.types.get_recommended_policy_v2_request.GetRecommendedPolicyV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
