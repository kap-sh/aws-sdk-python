"""Generated from Smithy shape ``com.amazonaws.securityhub#ResourceInUseException``."""
...
class ResourceInUseException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.securityhub#ResourceInUseException``."""
