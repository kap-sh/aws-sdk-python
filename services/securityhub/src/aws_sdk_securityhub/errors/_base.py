...
class SecurityHubError(Exception):
    """Base class for all SecurityHub service errors."""


class ServiceError(SecurityHubError):
...
class SerializationError(SecurityHubError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SecurityHubError):
...
class WaiterFailedError(SecurityHubError):
...
class WaiterTimeoutError(SecurityHubError):
