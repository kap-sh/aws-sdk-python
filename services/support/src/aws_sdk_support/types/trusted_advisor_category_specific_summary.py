...
if TYPE_CHECKING:
    import aws_sdk_support.types.trusted_advisor_cost_optimizing_summary


class TrustedAdvisorCategorySpecificSummary(TypedDict):
    cost_optimizing: NotRequired[
        "aws_sdk_support.types.trusted_advisor_cost_optimizing_summary.TrustedAdvisorCostOptimizingSummary"
    ]
...
def serialize_aws_json_1_1(value: TrustedAdvisorCategorySpecificSummary) -> dict:
    ...
    if "cost_optimizing" in value:
        ...
        out["costOptimizing"] = (
            aws_sdk_support.types.trusted_advisor_cost_optimizing_summary.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TrustedAdvisorCategorySpecificSummary:
    ...
    if "costOptimizing" in data:
        ...
        out["cost_optimizing"] = (
            aws_sdk_support.types.trusted_advisor_cost_optimizing_summary.deserialize_aws_json_1_1(
                data["costOptimizing"]
            )
        )
    return out
