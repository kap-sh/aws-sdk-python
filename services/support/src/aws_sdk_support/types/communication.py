...
class Communication(TypedDict):
    ...
    body: NotRequired[
        "aws_sdk_support.types.validated_communication_body.ValidatedCommunicationBody"
    ]
...
def serialize_aws_json_1_1(value: Communication) -> dict:
    ...
    if "attachment_set" in value:
        ...
        out["attachmentSet"] = (
            aws_sdk_support.types.attachment_set.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Communication:
    ...
    if "attachmentSet" in data:
        ...
        out["attachment_set"] = (
            aws_sdk_support.types.attachment_set.deserialize_aws_json_1_1(
                data["attachmentSet"]
            )
        )
    return out
