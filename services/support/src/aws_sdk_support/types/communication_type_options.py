...
if TYPE_CHECKING:
    ...
    import aws_sdk_support.types.supported_hours_list
...
class CommunicationTypeOptions(TypedDict, closed=True):
    ...
    supported_hours: NotRequired[
        "aws_sdk_support.types.supported_hours_list.SupportedHoursList"
    ]
    """<p> A JSON-formatted list containing time ranges when support is available. </p>"""
    dates_without_support: NotRequired[
        "aws_sdk_support.types.dates_without_support_list.DatesWithoutSupportList"
    ]
...
def serialize_aws_json_1_1(value: CommunicationTypeOptions) -> dict:
    ...
    if "supported_hours" in value:
        ...
        out["supportedHours"] = (
            aws_sdk_support.types.supported_hours_list.serialize_aws_json_1_1(
    ...
    if "dates_without_support" in value:
        ...
        out["datesWithoutSupport"] = (
            aws_sdk_support.types.dates_without_support_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CommunicationTypeOptions:
    ...
    if "supportedHours" in data:
        ...
        out["supported_hours"] = (
            aws_sdk_support.types.supported_hours_list.deserialize_aws_json_1_1(
                data["supportedHours"]
            )
        )
    if "datesWithoutSupport" in data:
        ...
        out["dates_without_support"] = (
            aws_sdk_support.types.dates_without_support_list.deserialize_aws_json_1_1(
