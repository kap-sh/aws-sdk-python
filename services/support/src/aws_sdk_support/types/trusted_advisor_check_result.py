...
if TYPE_CHECKING:
    ...
    import aws_sdk_support.types.trusted_advisor_resource_detail_list
    import aws_sdk_support.types.trusted_advisor_resources_summary


class TrustedAdvisorCheckResult(TypedDict):
    ...
    flagged_resources: "aws_sdk_support.types.trusted_advisor_resource_detail_list.TrustedAdvisorResourceDetailList"
...
def serialize_aws_json_1_1(value: TrustedAdvisorCheckResult) -> dict:
    ...
    out["flaggedResources"] = (
        aws_sdk_support.types.trusted_advisor_resource_detail_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TrustedAdvisorCheckResult:
    ...
    if "flaggedResources" in data:
        ...
        out["flagged_resources"] = (
            aws_sdk_support.types.trusted_advisor_resource_detail_list.deserialize_aws_json_1_1(
