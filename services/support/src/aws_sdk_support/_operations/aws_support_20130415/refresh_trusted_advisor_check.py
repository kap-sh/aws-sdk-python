...
def handle_response(
    ...
    out: aws_sdk_support.types.refresh_trusted_advisor_check_response.RefreshTrustedAdvisorCheckResponse = aws_sdk_support.types.refresh_trusted_advisor_check_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_support.types.refresh_trusted_advisor_check_request.RefreshTrustedAdvisorCheckRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_support.types.refresh_trusted_advisor_check_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
