...
def handle_response(
    ...
    out: aws_sdk_support.types.describe_cases_response.DescribeCasesResponse = (
        aws_sdk_support.types.describe_cases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_support.types.describe_cases_request.DescribeCasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_support.types.describe_cases_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_cases(
    ...
    aws_sdk_support.types.describe_cases_response.DescribeCasesResponse, zapros.Response
]:
