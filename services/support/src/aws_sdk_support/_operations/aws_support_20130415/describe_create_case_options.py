"""Generated from Smithy shape ``com.amazonaws.support#DescribeCreateCaseOptions``."""
...
def handle_response(
    ...
    out: aws_sdk_support.types.describe_create_case_options_response.DescribeCreateCaseOptionsResponse = aws_sdk_support.types.describe_create_case_options_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_support.types.describe_create_case_options_request.DescribeCreateCaseOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSSupport_20130415.DescribeCreateCaseOptions"
    body: bytes | None = json.dumps(
        aws_sdk_support.types.describe_create_case_options_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_create_case_options(
