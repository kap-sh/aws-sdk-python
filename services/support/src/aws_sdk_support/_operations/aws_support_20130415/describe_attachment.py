...
def build_request(
    ...
    input: aws_sdk_support.types.describe_attachment_request.DescribeAttachmentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_support.types.describe_attachment_request.serialize_aws_json_1_1(input)
    ).encode()
