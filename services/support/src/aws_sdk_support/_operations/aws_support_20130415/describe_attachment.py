"""Generated from Smithy shape ``com.amazonaws.support#DescribeAttachment``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AttachmentIdNotFound":
            import aws_sdk_support.errors.attachment_id_not_found

            raise aws_sdk_support.errors.attachment_id_not_found.AttachmentIdNotFound.from_aws_json_1_1(
                data
            )
        case "DescribeAttachmentLimitExceeded":
            import aws_sdk_support.errors.describe_attachment_limit_exceeded

            raise aws_sdk_support.errors.describe_attachment_limit_exceeded.DescribeAttachmentLimitExceeded.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_support.types.describe_attachment_response.DescribeAttachmentResponse = aws_sdk_support.types.describe_attachment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_support.types.describe_attachment_request.DescribeAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_support.types.describe_attachment_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_attachment(
