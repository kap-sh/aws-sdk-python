...
def handle_response(
    ...
    out: aws_sdk_support.types.describe_trusted_advisor_check_summaries_response.DescribeTrustedAdvisorCheckSummariesResponse = aws_sdk_support.types.describe_trusted_advisor_check_summaries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_support.types.describe_trusted_advisor_check_summaries_request.DescribeTrustedAdvisorCheckSummariesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
