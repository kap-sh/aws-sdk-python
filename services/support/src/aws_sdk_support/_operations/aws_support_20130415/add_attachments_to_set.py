...
import aws_sdk_support.errors.attachment_limit_exceeded
import aws_sdk_support.errors.attachment_set_expired
import aws_sdk_support.errors.attachment_set_id_not_found
import aws_sdk_support.errors.attachment_set_size_limit_exceeded
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AttachmentLimitExceeded":
            raise aws_sdk_support.errors.attachment_limit_exceeded.AttachmentLimitExceeded.from_aws_json_1_1(
                data
            )
        case "AttachmentSetExpired":
            raise aws_sdk_support.errors.attachment_set_expired.AttachmentSetExpired.from_aws_json_1_1(
                data
            )
        case "AttachmentSetIdNotFound":
            raise aws_sdk_support.errors.attachment_set_id_not_found.AttachmentSetIdNotFound.from_aws_json_1_1(
                data
            )
        case "AttachmentSetSizeLimitExceeded":
            raise aws_sdk_support.errors.attachment_set_size_limit_exceeded.AttachmentSetSizeLimitExceeded.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_support.types.add_attachments_to_set_response.AddAttachmentsToSetResponse = aws_sdk_support.types.add_attachments_to_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_support.types.add_attachments_to_set_request.AddAttachmentsToSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_support.types.add_attachments_to_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
