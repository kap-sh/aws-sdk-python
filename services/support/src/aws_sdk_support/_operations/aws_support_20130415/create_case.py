...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CaseCreationLimitExceeded":
            import aws_sdk_support.errors.case_creation_limit_exceeded

            raise aws_sdk_support.errors.case_creation_limit_exceeded.CaseCreationLimitExceeded.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_support.types.create_case_response.CreateCaseResponse = (
        aws_sdk_support.types.create_case_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_support.types.create_case_request.CreateCaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_support.types.create_case_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_case(
    ...
    aws_sdk_support.types.create_case_response.CreateCaseResponse, zapros.Response
]:
