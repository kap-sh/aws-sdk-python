...
def handle_response(
    ...
    out: aws_sdk_support.types.describe_supported_languages_response.DescribeSupportedLanguagesResponse = aws_sdk_support.types.describe_supported_languages_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_support.types.describe_supported_languages_request.DescribeSupportedLanguagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_support.types.describe_supported_languages_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
