...
def handle_response(
    ...
    out: aws_sdk_support.types.describe_trusted_advisor_check_refresh_statuses_response.DescribeTrustedAdvisorCheckRefreshStatusesResponse = aws_sdk_support.types.describe_trusted_advisor_check_refresh_statuses_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_support.types.describe_trusted_advisor_check_refresh_statuses_request.DescribeTrustedAdvisorCheckRefreshStatusesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
