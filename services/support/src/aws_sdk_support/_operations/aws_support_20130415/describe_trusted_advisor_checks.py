"""Generated from Smithy shape ``com.amazonaws.support#DescribeTrustedAdvisorChecks``."""
...
def handle_response(
    ...
    out: aws_sdk_support.types.describe_trusted_advisor_checks_response.DescribeTrustedAdvisorChecksResponse = aws_sdk_support.types.describe_trusted_advisor_checks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_support.types.describe_trusted_advisor_checks_request.DescribeTrustedAdvisorChecksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_support.types.describe_trusted_advisor_checks_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_trusted_advisor_checks(
