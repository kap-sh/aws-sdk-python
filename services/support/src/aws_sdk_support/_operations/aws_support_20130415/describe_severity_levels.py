...
def handle_response(
    ...
    out: aws_sdk_support.types.describe_severity_levels_response.DescribeSeverityLevelsResponse = aws_sdk_support.types.describe_severity_levels_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_support.types.describe_severity_levels_request.DescribeSeverityLevelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_support.types.describe_severity_levels_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
