...
def handle_response(
    ...
    out: aws_sdk_support.types.add_communication_to_case_response.AddCommunicationToCaseResponse = aws_sdk_support.types.add_communication_to_case_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_support.types.add_communication_to_case_request.AddCommunicationToCaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_support.types.add_communication_to_case_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
