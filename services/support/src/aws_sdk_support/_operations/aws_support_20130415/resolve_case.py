...
def build_request(
    ...
    input_: aws_sdk_support.types.resolve_case_request.ResolveCaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_support.types.resolve_case_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def resolve_case(
    ...
    aws_sdk_support.types.resolve_case_response.ResolveCaseResponse, zapros.Response
]:
