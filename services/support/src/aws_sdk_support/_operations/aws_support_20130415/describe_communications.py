...
def handle_response(
    ...
    out: aws_sdk_support.types.describe_communications_response.DescribeCommunicationsResponse = aws_sdk_support.types.describe_communications_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_support.types.describe_communications_request.DescribeCommunicationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_support.types.describe_communications_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
