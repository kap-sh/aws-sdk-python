...
class SupportError(Exception):
    """Base class for all Support service errors."""


class ServiceError(SupportError):
...
class SerializationError(SupportError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SupportError):
...
class WaiterFailedError(SupportError):
...
class WaiterTimeoutError(SupportError):
