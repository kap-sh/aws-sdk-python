...
import capo_support.types.trusted_advisor_check_result
...
def handle_response(
    ...
    out: capo_support.types.describe_trusted_advisor_check_result_response.DescribeTrustedAdvisorCheckResultResponse = capo_support.types.describe_trusted_advisor_check_result_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_support.types.describe_trusted_advisor_check_result_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
