"""Generated from Smithy shape ``com.amazonaws.support#DescribeTrustedAdvisorCheckRefreshStatuses``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ThrottlingException":
            raise capo_support.errors.throttling_exception.ThrottlingException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_support.types.describe_trusted_advisor_check_refresh_statuses_response.DescribeTrustedAdvisorCheckRefreshStatusesResponse = capo_support.types.describe_trusted_advisor_check_refresh_statuses_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_support._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_support.types.describe_trusted_advisor_check_refresh_statuses_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_trusted_advisor_check_refresh_statuses(
