"""Generated from Smithy shape ``com.amazonaws.support#DescribeCommunications``."""
...
def handle_response(
    ...
    out: capo_support.types.describe_communications_response.DescribeCommunicationsResponse = capo_support.types.describe_communications_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_support.types.describe_communications_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_communications(
