"""Generated from Smithy shape ``com.amazonaws.support#AddCommunicationToCase``."""
...
def handle_response(
    ...
    out: capo_support.types.add_communication_to_case_response.AddCommunicationToCaseResponse = capo_support.types.add_communication_to_case_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_support.types.add_communication_to_case_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_add_communication_to_case(
