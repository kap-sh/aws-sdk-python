"""Generated from Smithy shape ``com.amazonaws.support#CreateCase``."""
...
def handle_response(
    ...
    out: capo_support.types.create_case_response.CreateCaseResponse = (
        capo_support.types.create_case_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_support.types.create_case_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_case(
    ...
    input_: capo_support.types.create_case_request.CreateCaseRequest,
) -> tuple[capo_support.types.create_case_response.CreateCaseResponse, zapros.Response]:
