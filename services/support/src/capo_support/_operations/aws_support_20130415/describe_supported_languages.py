"""Generated from Smithy shape ``com.amazonaws.support#DescribeSupportedLanguages``."""
...
def handle_response(
    ...
    out: capo_support.types.describe_supported_languages_response.DescribeSupportedLanguagesResponse = capo_support.types.describe_supported_languages_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSSupport_20130415.DescribeSupportedLanguages"
    body: bytes | None = json.dumps(
        capo_support.types.describe_supported_languages_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_supported_languages(
