...
if TYPE_CHECKING:
    import capo_support.types.severity_level_code
    import capo_support.types.severity_level_name


class SeverityLevel(TypedDict, closed=True):
    code: NotRequired["capo_support.types.severity_level_code.SeverityLevelCode"]
    ...
    name: NotRequired["capo_support.types.severity_level_name.SeverityLevelName"]
