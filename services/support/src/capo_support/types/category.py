...
if TYPE_CHECKING:
    ...
    import capo_support.types.category_name


class Category(TypedDict, closed=True):
    code: NotRequired["capo_support.types.category_code.CategoryCode"]
    """<p>The category code for the support case.</p>"""
    name: NotRequired["capo_support.types.category_name.CategoryName"]
