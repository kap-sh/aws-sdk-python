...
if TYPE_CHECKING:
    import capo_support.types.case_list
    import capo_support.types.next_token


class DescribeCasesResponse(TypedDict, closed=True):
    cases: NotRequired["capo_support.types.case_list.CaseList"]
...
def serialize_aws_json_1_1(value: DescribeCasesResponse) -> dict:
    ...
    if "cases" in value:
        ...
        out["cases"] = capo_support.types.case_list.serialize_aws_json_1_1(
            value["cases"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeCasesResponse:
    ...
    if "cases" in data:
        ...
        out["cases"] = capo_support.types.case_list.deserialize_aws_json_1_1(
            data["cases"]
        )
