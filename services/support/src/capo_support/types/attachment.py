...
class Attachment(TypedDict, closed=True):
    file_name: NotRequired["capo_support.types.file_name.FileName"]
    """<p>The name of the attachment file.</p>"""
    data: NotRequired["capo_support.types.data.Data"]
...
def serialize_aws_json_1_1(value: Attachment) -> dict:
    ...
    if "data" in value:
        ...
        out["data"] = capo_support.types.data.serialize_aws_json_1_1(value["data"])
    return out
