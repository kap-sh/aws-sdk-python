...
if TYPE_CHECKING:
    ...
    import capo_support.types.validated_language_availability


class DescribeCreateCaseOptionsResponse(TypedDict, closed=True):
    language_availability: NotRequired[
        "capo_support.types.validated_language_availability.ValidatedLanguageAvailability"
    ]
    ...
    communication_types: NotRequired[
        "capo_support.types.communication_type_options_list.CommunicationTypeOptionsList"
    ]
...
def serialize_aws_json_1_1(value: DescribeCreateCaseOptionsResponse) -> dict:
    ...
    if "communication_types" in value:
        ...
        out["communicationTypes"] = (
            capo_support.types.communication_type_options_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeCreateCaseOptionsResponse:
    ...
    if "communicationTypes" in data:
        ...
        out["communication_types"] = (
            capo_support.types.communication_type_options_list.deserialize_aws_json_1_1(
