...
```
pip install aws-sdk-kinesis-analytics
```

## Usage

```python
from aws_sdk_kinesis_analytics import AsyncKinesisAnalyticsClient
...
```python
from aws_sdk_kinesis_analytics import AsyncKinesisAnalyticsClient
from aws_sdk_kinesis_analytics.error import ConcurrentModificationException
