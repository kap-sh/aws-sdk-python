"""Generated from Smithy shape ``com.amazonaws.kinesisanalytics#AddApplicationOutput``."""
...
import capo_kinesis_analytics.types.add_application_output_request
import capo_kinesis_analytics.types.add_application_output_response
...
) -> capo_kinesis_analytics.types.add_application_output_response.AddApplicationOutputResponse:
    out: capo_kinesis_analytics.types.add_application_output_response.AddApplicationOutputResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics.types.add_application_output_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
