"""Generated from Smithy shape ``com.amazonaws.kinesisanalytics#TagResource``."""
...
import capo_kinesis_analytics.types.tag_resource_request
import capo_kinesis_analytics.types.tag_resource_response
...
) -> capo_kinesis_analytics.types.tag_resource_response.TagResourceResponse:
    out: capo_kinesis_analytics.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
