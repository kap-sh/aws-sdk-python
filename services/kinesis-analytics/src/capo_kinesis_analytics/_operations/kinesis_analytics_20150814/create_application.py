...
import capo_kinesis_analytics.errors.code_validation_exception
...
import capo_kinesis_analytics.errors.limit_exceeded_exception
import capo_kinesis_analytics.errors.resource_in_use_exception
import capo_kinesis_analytics.errors.too_many_tags_exception
import capo_kinesis_analytics.types.application_summary
import capo_kinesis_analytics.types.cloud_watch_logging_options
import capo_kinesis_analytics.types.create_application_request
import capo_kinesis_analytics.types.create_application_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CodeValidationException":
            raise capo_kinesis_analytics.errors.code_validation_exception.CodeValidationException.from_aws_json_1_1(
                data
            )
        ...
        case "LimitExceededException":
            raise capo_kinesis_analytics.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data
            )
        ...
        case "TooManyTagsException":
            raise capo_kinesis_analytics.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data
            )
        case _:
...
) -> capo_kinesis_analytics.types.create_application_response.CreateApplicationResponse:
    out: capo_kinesis_analytics.types.create_application_response.CreateApplicationResponse = capo_kinesis_analytics.types.create_application_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics.types.create_application_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
