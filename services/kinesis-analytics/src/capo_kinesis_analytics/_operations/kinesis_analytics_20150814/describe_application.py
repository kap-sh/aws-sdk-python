...
import capo_kinesis_analytics.types.application_detail
import capo_kinesis_analytics.types.describe_application_request
import capo_kinesis_analytics.types.describe_application_response
...
) -> capo_kinesis_analytics.types.describe_application_response.DescribeApplicationResponse:
    out: capo_kinesis_analytics.types.describe_application_response.DescribeApplicationResponse = capo_kinesis_analytics.types.describe_application_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics.types.describe_application_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
