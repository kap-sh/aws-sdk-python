...
import capo_kinesis_analytics.errors.invalid_application_configuration_exception
...
import capo_kinesis_analytics.types.start_application_request
import capo_kinesis_analytics.types.start_application_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidApplicationConfigurationException":
            raise capo_kinesis_analytics.errors.invalid_application_configuration_exception.InvalidApplicationConfigurationException.from_aws_json_1_1(
                data
            )
...
) -> capo_kinesis_analytics.types.start_application_response.StartApplicationResponse:
    out: capo_kinesis_analytics.types.start_application_response.StartApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics.types.start_application_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
