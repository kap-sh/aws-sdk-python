"""Generated from Smithy shape ``com.amazonaws.kinesisanalytics#ListApplications``."""
...
import capo_kinesis_analytics.types.list_applications_request
import capo_kinesis_analytics.types.list_applications_response
...
) -> capo_kinesis_analytics.types.list_applications_response.ListApplicationsResponse:
    out: capo_kinesis_analytics.types.list_applications_response.ListApplicationsResponse = capo_kinesis_analytics.types.list_applications_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics.types.list_applications_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
