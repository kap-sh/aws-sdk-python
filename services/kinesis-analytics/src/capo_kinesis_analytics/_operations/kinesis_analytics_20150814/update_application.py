"""Generated from Smithy shape ``com.amazonaws.kinesisanalytics#UpdateApplication``."""
...
import capo_kinesis_analytics.types.update_application_request
import capo_kinesis_analytics.types.update_application_response
...
) -> capo_kinesis_analytics.types.update_application_response.UpdateApplicationResponse:
    out: capo_kinesis_analytics.types.update_application_response.UpdateApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics.types.update_application_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
