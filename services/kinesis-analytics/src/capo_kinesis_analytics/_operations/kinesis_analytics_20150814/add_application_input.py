...
import capo_kinesis_analytics.types.add_application_input_request
import capo_kinesis_analytics.types.add_application_input_response
...
) -> capo_kinesis_analytics.types.add_application_input_response.AddApplicationInputResponse:
    out: capo_kinesis_analytics.types.add_application_input_response.AddApplicationInputResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics.types.add_application_input_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
