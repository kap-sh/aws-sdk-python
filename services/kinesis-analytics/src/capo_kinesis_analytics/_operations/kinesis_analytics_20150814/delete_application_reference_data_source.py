"""Generated from Smithy shape ``com.amazonaws.kinesisanalytics#DeleteApplicationReferenceDataSource``."""
...
import capo_kinesis_analytics.types.delete_application_reference_data_source_request
import capo_kinesis_analytics.types.delete_application_reference_data_source_response
...
) -> capo_kinesis_analytics.types.delete_application_reference_data_source_response.DeleteApplicationReferenceDataSourceResponse:
    out: capo_kinesis_analytics.types.delete_application_reference_data_source_response.DeleteApplicationReferenceDataSourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics.types.delete_application_reference_data_source_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_application_reference_data_source(
