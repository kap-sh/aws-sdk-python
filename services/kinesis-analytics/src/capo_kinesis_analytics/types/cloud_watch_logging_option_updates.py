...
if TYPE_CHECKING:
    import capo_kinesis_analytics.types.cloud_watch_logging_option_update

CloudWatchLoggingOptionUpdates: TypeAlias = list[
    "capo_kinesis_analytics.types.cloud_watch_logging_option_update.CloudWatchLoggingOptionUpdate"
]
...
def serialize_aws_json_1_1(value: CloudWatchLoggingOptionUpdates) -> list:
    ...
    for item in value:
        out.append(
            capo_kinesis_analytics.types.cloud_watch_logging_option_update.serialize_aws_json_1_1(
                item
            )
        )
    return out
