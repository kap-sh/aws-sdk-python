"""Generated from Smithy shape ``com.amazonaws.kinesisanalytics#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisanalytics#LimitExceededException``."""
