...
if TYPE_CHECKING:
    ...
    import aws_sdk_kinesis_analytics.types.kinesis_firehose_output
    import aws_sdk_kinesis_analytics.types.kinesis_streams_output
...
class Output(TypedDict, closed=True):
    ...
    kinesis_streams_output: NotRequired[
        "aws_sdk_kinesis_analytics.types.kinesis_streams_output.KinesisStreamsOutput"
    ]
    """<p>Identifies an Amazon Kinesis stream as the destination.</p>"""
    kinesis_firehose_output: NotRequired[
        "aws_sdk_kinesis_analytics.types.kinesis_firehose_output.KinesisFirehoseOutput"
    ]
    """<p>Identifies an Amazon Kinesis Firehose delivery stream as the destination.</p>"""
    lambda_output: NotRequired[
        "aws_sdk_kinesis_analytics.types.lambda_output.LambdaOutput"
    ]
...
def serialize_aws_json_1_1(value: Output) -> dict:
    ...
    if "kinesis_streams_output" in value:
        ...
        out["KinesisStreamsOutput"] = (
            aws_sdk_kinesis_analytics.types.kinesis_streams_output.serialize_aws_json_1_1(
    ...
    if "kinesis_firehose_output" in value:
        ...
        out["KinesisFirehoseOutput"] = (
            aws_sdk_kinesis_analytics.types.kinesis_firehose_output.serialize_aws_json_1_1(
    ...
    if "lambda_output" in value:
        ...
        out["LambdaOutput"] = (
            aws_sdk_kinesis_analytics.types.lambda_output.serialize_aws_json_1_1(
                value["lambda_output"]
            )
        )
    import aws_sdk_kinesis_analytics.types.destination_schema
...
def deserialize_aws_json_1_1(data: dict) -> Output:
    ...
    if "KinesisStreamsOutput" in data:
        ...
        out["kinesis_streams_output"] = (
            aws_sdk_kinesis_analytics.types.kinesis_streams_output.deserialize_aws_json_1_1(
    ...
    if "KinesisFirehoseOutput" in data:
        ...
        out["kinesis_firehose_output"] = (
            aws_sdk_kinesis_analytics.types.kinesis_firehose_output.deserialize_aws_json_1_1(
    ...
    if "LambdaOutput" in data:
        ...
        out["lambda_output"] = (
            aws_sdk_kinesis_analytics.types.lambda_output.deserialize_aws_json_1_1(
                data["LambdaOutput"]
            )
        )
