...
class S3ReferenceDataSourceUpdate(TypedDict):
    bucket_arn_update: NotRequired[
        "aws_sdk_kinesis_analytics.types.bucket_arn.BucketARN"
    ]
    """<p>Amazon Resource Name (ARN) of the S3 bucket.</p>"""
    file_key_update: NotRequired["aws_sdk_kinesis_analytics.types.file_key.FileKey"]
    """<p>Object key name.</p>"""
    reference_role_arn_update: NotRequired[
        "aws_sdk_kinesis_analytics.types.role_arn.RoleARN"
    ]
