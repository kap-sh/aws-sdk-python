...
if TYPE_CHECKING:
    ...
    import aws_sdk_kinesis_analytics.types.in_app_stream_names
    import aws_sdk_kinesis_analytics.types.input_parallelism
    import aws_sdk_kinesis_analytics.types.input_processing_configuration_description
    import aws_sdk_kinesis_analytics.types.input_starting_position_configuration
    import aws_sdk_kinesis_analytics.types.kinesis_firehose_input_description
    import aws_sdk_kinesis_analytics.types.kinesis_streams_input_description
    import aws_sdk_kinesis_analytics.types.source_schema


class InputDescription(TypedDict):
    input_id: NotRequired["aws_sdk_kinesis_analytics.types.id.Id"]
    ...
    in_app_stream_names: NotRequired[
        "aws_sdk_kinesis_analytics.types.in_app_stream_names.InAppStreamNames"
    ]
    ...
    input_processing_configuration_description: NotRequired[
        "aws_sdk_kinesis_analytics.types.input_processing_configuration_description.InputProcessingConfigurationDescription"
    ]
    """<p>The description of the preprocessor that executes on records in this input before the application's code is run.</p>"""
    kinesis_streams_input_description: NotRequired[
        "aws_sdk_kinesis_analytics.types.kinesis_streams_input_description.KinesisStreamsInputDescription"
    ]
    ...
    kinesis_firehose_input_description: NotRequired[
        "aws_sdk_kinesis_analytics.types.kinesis_firehose_input_description.KinesisFirehoseInputDescription"
    ]
...
def serialize_aws_json_1_1(value: InputDescription) -> dict:
    ...
    if "in_app_stream_names" in value:
        ...
        out["InAppStreamNames"] = (
            aws_sdk_kinesis_analytics.types.in_app_stream_names.serialize_aws_json_1_1(
    ...
    if "input_processing_configuration_description" in value:
        ...
        out["InputProcessingConfigurationDescription"] = (
            aws_sdk_kinesis_analytics.types.input_processing_configuration_description.serialize_aws_json_1_1(
    ...
    if "kinesis_streams_input_description" in value:
        ...
        out["KinesisStreamsInputDescription"] = (
            aws_sdk_kinesis_analytics.types.kinesis_streams_input_description.serialize_aws_json_1_1(
    ...
    if "kinesis_firehose_input_description" in value:
        ...
        out["KinesisFirehoseInputDescription"] = (
            aws_sdk_kinesis_analytics.types.kinesis_firehose_input_description.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InputDescription:
    ...
    if "InAppStreamNames" in data:
        ...
        out["in_app_stream_names"] = (
            aws_sdk_kinesis_analytics.types.in_app_stream_names.deserialize_aws_json_1_1(
    ...
    if "InputProcessingConfigurationDescription" in data:
        ...
        out["input_processing_configuration_description"] = (
            aws_sdk_kinesis_analytics.types.input_processing_configuration_description.deserialize_aws_json_1_1(
    ...
    if "KinesisStreamsInputDescription" in data:
        ...
        out["kinesis_streams_input_description"] = (
            aws_sdk_kinesis_analytics.types.kinesis_streams_input_description.deserialize_aws_json_1_1(
    ...
    if "KinesisFirehoseInputDescription" in data:
        ...
        out["kinesis_firehose_input_description"] = (
            aws_sdk_kinesis_analytics.types.kinesis_firehose_input_description.deserialize_aws_json_1_1(
