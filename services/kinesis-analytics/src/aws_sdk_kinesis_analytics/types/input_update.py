...
if TYPE_CHECKING:
    ...
    import aws_sdk_kinesis_analytics.types.input_parallelism_update
    import aws_sdk_kinesis_analytics.types.input_processing_configuration_update
    import aws_sdk_kinesis_analytics.types.input_schema_update
    import aws_sdk_kinesis_analytics.types.kinesis_firehose_input_update
...
class InputUpdate(TypedDict):
    ...
    input_processing_configuration_update: NotRequired[
        "aws_sdk_kinesis_analytics.types.input_processing_configuration_update.InputProcessingConfigurationUpdate"
    ]
    """<p>Describes updates for an input processing configuration.</p>"""
    kinesis_streams_input_update: NotRequired[
        "aws_sdk_kinesis_analytics.types.kinesis_streams_input_update.KinesisStreamsInputUpdate"
    ]
    ...
    kinesis_firehose_input_update: NotRequired[
        "aws_sdk_kinesis_analytics.types.kinesis_firehose_input_update.KinesisFirehoseInputUpdate"
    ]
    ...
    input_schema_update: NotRequired[
        "aws_sdk_kinesis_analytics.types.input_schema_update.InputSchemaUpdate"
    ]
    ...
    input_parallelism_update: NotRequired[
        "aws_sdk_kinesis_analytics.types.input_parallelism_update.InputParallelismUpdate"
    ]
...
def serialize_aws_json_1_1(value: InputUpdate) -> dict:
    ...
    if "input_processing_configuration_update" in value:
        ...
        out["InputProcessingConfigurationUpdate"] = (
            aws_sdk_kinesis_analytics.types.input_processing_configuration_update.serialize_aws_json_1_1(
    ...
    if "kinesis_streams_input_update" in value:
        ...
        out["KinesisStreamsInputUpdate"] = (
            aws_sdk_kinesis_analytics.types.kinesis_streams_input_update.serialize_aws_json_1_1(
    ...
    if "kinesis_firehose_input_update" in value:
        ...
        out["KinesisFirehoseInputUpdate"] = (
            aws_sdk_kinesis_analytics.types.kinesis_firehose_input_update.serialize_aws_json_1_1(
    ...
    if "input_schema_update" in value:
        ...
        out["InputSchemaUpdate"] = (
            aws_sdk_kinesis_analytics.types.input_schema_update.serialize_aws_json_1_1(
    ...
    if "input_parallelism_update" in value:
        ...
        out["InputParallelismUpdate"] = (
            aws_sdk_kinesis_analytics.types.input_parallelism_update.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InputUpdate:
    ...
    if "InputProcessingConfigurationUpdate" in data:
        ...
        out["input_processing_configuration_update"] = (
            aws_sdk_kinesis_analytics.types.input_processing_configuration_update.deserialize_aws_json_1_1(
    ...
    if "KinesisStreamsInputUpdate" in data:
        ...
        out["kinesis_streams_input_update"] = (
            aws_sdk_kinesis_analytics.types.kinesis_streams_input_update.deserialize_aws_json_1_1(
    ...
    if "KinesisFirehoseInputUpdate" in data:
        ...
        out["kinesis_firehose_input_update"] = (
            aws_sdk_kinesis_analytics.types.kinesis_firehose_input_update.deserialize_aws_json_1_1(
    ...
    if "InputSchemaUpdate" in data:
        ...
        out["input_schema_update"] = (
            aws_sdk_kinesis_analytics.types.input_schema_update.deserialize_aws_json_1_1(
    ...
    if "InputParallelismUpdate" in data:
        ...
        out["input_parallelism_update"] = (
            aws_sdk_kinesis_analytics.types.input_parallelism_update.deserialize_aws_json_1_1(
