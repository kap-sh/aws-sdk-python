"""Generated from Smithy shape ``com.amazonaws.kinesisanalytics#StartApplication``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidApplicationConfigurationException":
            import aws_sdk_kinesis_analytics.errors.invalid_application_configuration_exception

            raise aws_sdk_kinesis_analytics.errors.invalid_application_configuration_exception.InvalidApplicationConfigurationException.from_aws_json_1_1(
                data
            )
        ...
        case "ResourceNotFoundException":
            import aws_sdk_kinesis_analytics.errors.resource_not_found_exception

            raise aws_sdk_kinesis_analytics.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
        case "UnsupportedOperationException":
            import aws_sdk_kinesis_analytics.errors.unsupported_operation_exception

            raise aws_sdk_kinesis_analytics.errors.unsupported_operation_exception.UnsupportedOperationException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics.types.start_application_response.StartApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics.types.start_application_request.StartApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics.types.start_application_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
