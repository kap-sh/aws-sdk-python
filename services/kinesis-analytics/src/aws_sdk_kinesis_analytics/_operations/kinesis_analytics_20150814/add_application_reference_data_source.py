"""Generated from Smithy shape ``com.amazonaws.kinesisanalytics#AddApplicationReferenceDataSource``."""
...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics.types.add_application_reference_data_source_response.AddApplicationReferenceDataSourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics.types.add_application_reference_data_source_request.AddApplicationReferenceDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics.types.add_application_reference_data_source_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_add_application_reference_data_source(
