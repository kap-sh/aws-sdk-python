"""Generated from Smithy shape ``com.amazonaws.kinesisanalytics#AddApplicationInput``."""
...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics.types.add_application_input_response.AddApplicationInputResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics.types.add_application_input_request.AddApplicationInputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics.types.add_application_input_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_add_application_input(
