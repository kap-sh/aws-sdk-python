"""Generated from Smithy shape ``com.amazonaws.kinesisanalytics#DeleteApplicationInputProcessingConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics.types.delete_application_input_processing_configuration_response.DeleteApplicationInputProcessingConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics.types.delete_application_input_processing_configuration_request.DeleteApplicationInputProcessingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
