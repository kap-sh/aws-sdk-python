...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics.types.add_application_input_processing_configuration_response.AddApplicationInputProcessingConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics.types.add_application_input_processing_configuration_request.AddApplicationInputProcessingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
