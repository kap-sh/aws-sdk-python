"""Generated from Smithy shape ``com.amazonaws.kinesisanalytics#DeleteApplicationOutput``."""
...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics.types.delete_application_output_response.DeleteApplicationOutputResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics.types.delete_application_output_request.DeleteApplicationOutputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics.types.delete_application_output_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_application_output(
