...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics.types.add_application_cloud_watch_logging_option_response.AddApplicationCloudWatchLoggingOptionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics.types.add_application_cloud_watch_logging_option_request.AddApplicationCloudWatchLoggingOptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics.types.add_application_cloud_watch_logging_option_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
