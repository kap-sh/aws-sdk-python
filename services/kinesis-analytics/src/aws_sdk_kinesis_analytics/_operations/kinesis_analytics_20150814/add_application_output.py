...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics.types.add_application_output_response.AddApplicationOutputResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics.types.add_application_output_request.AddApplicationOutputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics.types.add_application_output_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
