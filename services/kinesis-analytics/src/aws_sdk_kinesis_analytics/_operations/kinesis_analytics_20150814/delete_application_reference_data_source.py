...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics.types.delete_application_reference_data_source_response.DeleteApplicationReferenceDataSourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics.types.delete_application_reference_data_source_request.DeleteApplicationReferenceDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics.types.delete_application_reference_data_source_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
