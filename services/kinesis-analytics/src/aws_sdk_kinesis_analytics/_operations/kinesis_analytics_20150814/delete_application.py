...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics.types.delete_application_response.DeleteApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics.types.delete_application_request.DeleteApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics.types.delete_application_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
