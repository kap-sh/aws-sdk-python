...
from ._services.async_kinesis_analytics import (
    AsyncKinesisAnalyticsClient as AsyncKinesisAnalyticsClient,
)
from ._services.kinesis_analytics import (
    KinesisAnalyticsClient as KinesisAnalyticsClient,
)
