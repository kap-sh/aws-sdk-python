...
class KinesisAnalyticsError(Exception):
    """Base class for all KinesisAnalytics service errors."""


class ServiceError(KinesisAnalyticsError):
...
class SerializationError(KinesisAnalyticsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(KinesisAnalyticsError):
...
class WaiterFailedError(KinesisAnalyticsError):
...
class WaiterTimeoutError(KinesisAnalyticsError):
