"""Generated from Smithy shape ``com.amazonaws.kinesisanalytics#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisanalytics#ResourceNotFoundException``."""
