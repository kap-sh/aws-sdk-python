"""Generated from Smithy shape ``com.amazonaws.kinesisanalytics#TooManyTagsException``."""
...
class TooManyTagsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisanalytics#TooManyTagsException``."""
