...
from aws_sdk_marketplace_catalog._services._aws_config import aaws_config
...
class AsyncMarketplaceCatalogClientConfig(TypedDict, total=False):
...
class AsyncMarketplaceCatalogClient:
    ...
    async def batch_describe_entities(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_catalog.types.batch_describe_entities_request.BatchDescribeEntitiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_catalog.types.batch_describe_entities_response.BatchDescribeEntitiesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_catalog._operations.awsmp_seymour.batch_describe_entities.async_batch_describe_entities(
    ...
    async def cancel_change_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_catalog.types.cancel_change_set_request.CancelChangeSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_catalog.types.cancel_change_set_response.CancelChangeSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_catalog._operations.awsmp_seymour.cancel_change_set.async_cancel_change_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_catalog.types.delete_resource_policy_request.DeleteResourcePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_catalog.types.delete_resource_policy_response.DeleteResourcePolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_catalog._operations.awsmp_seymour.delete_resource_policy.async_delete_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_change_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_catalog.types.describe_change_set_request.DescribeChangeSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_catalog.types.describe_change_set_response.DescribeChangeSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_catalog._operations.awsmp_seymour.describe_change_set.async_describe_change_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_entity(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_catalog.types.describe_entity_request.DescribeEntityRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_catalog.types.describe_entity_response.DescribeEntityResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_catalog._operations.awsmp_seymour.describe_entity.async_describe_entity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_catalog.types.get_resource_policy_request.GetResourcePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_catalog.types.get_resource_policy_response.GetResourcePolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_catalog._operations.awsmp_seymour.get_resource_policy.async_get_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_change_sets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_catalog.types.list_change_sets_request.ListChangeSetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_catalog.types.list_change_sets_response.ListChangeSetsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_catalog._operations.awsmp_seymour.list_change_sets.async_list_change_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_marketplace_catalog.types.change_set_summary_list_item.ChangeSetSummaryListItem]":
        _token = next_token
        while True:
    ...
    async def list_entities(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_catalog.types.list_entities_request.ListEntitiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_catalog.types.list_entities_response.ListEntitiesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_catalog._operations.awsmp_seymour.list_entities.async_list_entities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_entities(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_marketplace_catalog.types.entity_summary.EntitySummary]"
    ):
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_catalog.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_catalog.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_catalog._operations.awsmp_seymour.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_catalog.types.put_resource_policy_request.PutResourcePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_catalog.types.put_resource_policy_response.PutResourcePolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_catalog._operations.awsmp_seymour.put_resource_policy.async_put_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_change_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_catalog.types.start_change_set_request.StartChangeSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_catalog.types.start_change_set_response.StartChangeSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_catalog._operations.awsmp_seymour.start_change_set.async_start_change_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_catalog.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_catalog.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_catalog._operations.awsmp_seymour.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_catalog.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_catalog.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_catalog._operations.awsmp_seymour.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
