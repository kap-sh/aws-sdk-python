...
if TYPE_CHECKING:
    import aws_sdk_marketplace_catalog.types.data_product_entity_id_string

DataProductEntityIdFilterValueList: TypeAlias = list[
    "aws_sdk_marketplace_catalog.types.data_product_entity_id_string.DataProductEntityIdString"
]
