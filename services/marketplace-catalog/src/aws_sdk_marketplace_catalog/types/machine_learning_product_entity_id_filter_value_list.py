...
if TYPE_CHECKING:
    import aws_sdk_marketplace_catalog.types.machine_learning_product_entity_id_string

MachineLearningProductEntityIdFilterValueList: TypeAlias = list[
    "aws_sdk_marketplace_catalog.types.machine_learning_product_entity_id_string.MachineLearningProductEntityIdString"
]
