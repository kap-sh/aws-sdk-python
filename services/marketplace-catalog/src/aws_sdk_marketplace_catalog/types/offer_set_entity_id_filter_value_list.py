...
if TYPE_CHECKING:
    import aws_sdk_marketplace_catalog.types.offer_set_entity_id_string

OfferSetEntityIdFilterValueList: TypeAlias = list[
    "aws_sdk_marketplace_catalog.types.offer_set_entity_id_string.OfferSetEntityIdString"
]
