"""Generated from Smithy shape ``com.amazonaws.marketplacecatalog#AmiProductLastModifiedDateFilterDateRange``."""
...
class AmiProductLastModifiedDateFilterDateRange(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: AmiProductLastModifiedDateFilterDateRange) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> AmiProductLastModifiedDateFilterDateRange:
    out: AmiProductLastModifiedDateFilterDateRange = {}  # type: ignore[typeddict-item]
