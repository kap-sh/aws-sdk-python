"""Generated from Smithy shape ``com.amazonaws.marketplacecatalog#OfferLastModifiedDateFilterDateRange``."""
...
class OfferLastModifiedDateFilterDateRange(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: OfferLastModifiedDateFilterDateRange) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> OfferLastModifiedDateFilterDateRange:
    out: OfferLastModifiedDateFilterDateRange = {}  # type: ignore[typeddict-item]
