...
if TYPE_CHECKING:
    import aws_sdk_marketplace_catalog.types.offer_set_associated_offer_ids_string

OfferSetAssociatedOfferIdsList: TypeAlias = list[
    "aws_sdk_marketplace_catalog.types.offer_set_associated_offer_ids_string.OfferSetAssociatedOfferIdsString"
]
