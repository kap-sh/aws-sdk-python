"""Generated from Smithy shape ``com.amazonaws.marketplacecatalog#ResaleAuthorizationCreatedDateFilterDateRange``."""
...
class ResaleAuthorizationCreatedDateFilterDateRange(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ResaleAuthorizationCreatedDateFilterDateRange) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ResaleAuthorizationCreatedDateFilterDateRange:
    out: ResaleAuthorizationCreatedDateFilterDateRange = {}  # type: ignore[typeddict-item]
