...
from ._base import (
    MarketplaceCatalogError as MarketplaceCatalogError,
)
from ._base import (
...
from .resource_not_supported_exception import (
    ResourceNotSupportedException as ResourceNotSupportedException,
)
