"""Generated from Smithy shape ``com.amazonaws.marketplacecatalog#DeleteResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_marketplace_catalog.types.delete_resource_policy_response.DeleteResourcePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteResourcePolicy"
    params: dict[str, str] = {}
