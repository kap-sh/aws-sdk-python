"""Generated from Smithy shape ``com.amazonaws.marketplacecatalog#GetResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_marketplace_catalog.types.get_resource_policy_response.GetResourcePolicyResponse = capo_marketplace_catalog.types.get_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/GetResourcePolicy"
    params: dict[str, str] = {}
