...
import capo_marketplace_catalog.errors.resource_not_found_exception
import capo_marketplace_catalog.errors.resource_not_supported_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise capo_marketplace_catalog.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
        case "ResourceNotSupportedException":
            raise capo_marketplace_catalog.errors.resource_not_supported_exception.ResourceNotSupportedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_marketplace_catalog.types.describe_entity_response.DescribeEntityResponse = capo_marketplace_catalog.types.describe_entity_response.deserialize_json(
