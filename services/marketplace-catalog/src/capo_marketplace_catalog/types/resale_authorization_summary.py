...
if TYPE_CHECKING:
    ...
    import capo_marketplace_catalog.types.resale_authorization_offer_extended_status_string
...
class ResaleAuthorizationSummary(TypedDict, closed=True):
    name: NotRequired[
    ...
    manufacturer_legal_name: NotRequired[
        "capo_marketplace_catalog.types.resale_authorization_manufacturer_legal_name_string.ResaleAuthorizationManufacturerLegalNameString"
    ]
    ...
    offer_extended_status: NotRequired[
        "capo_marketplace_catalog.types.resale_authorization_offer_extended_status_string.ResaleAuthorizationOfferExtendedStatusString"
    ]
