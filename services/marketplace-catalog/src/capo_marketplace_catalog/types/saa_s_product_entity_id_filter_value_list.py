...
if TYPE_CHECKING:
    import capo_marketplace_catalog.types.saa_s_product_entity_id_string

SaaSProductEntityIdFilterValueList: TypeAlias = list[
    "capo_marketplace_catalog.types.saa_s_product_entity_id_string.SaaSProductEntityIdString"
]
