"""Generated from Smithy shape ``com.amazonaws.marketplacecatalog#OfferSetLastModifiedDateFilterDateRange``."""
...
class OfferSetLastModifiedDateFilterDateRange(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: OfferSetLastModifiedDateFilterDateRange) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> OfferSetLastModifiedDateFilterDateRange:
    out: OfferSetLastModifiedDateFilterDateRange = {}  # type: ignore[typeddict-item]
