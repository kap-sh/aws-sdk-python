...
if TYPE_CHECKING:
    import capo_marketplace_catalog.types.resale_authorization_entity_id_string

ResaleAuthorizationEntityIdFilterValueList: TypeAlias = list[
    "capo_marketplace_catalog.types.resale_authorization_entity_id_string.ResaleAuthorizationEntityIdString"
]
