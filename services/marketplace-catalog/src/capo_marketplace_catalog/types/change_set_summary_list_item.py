...
if TYPE_CHECKING:
    ...
    import capo_marketplace_catalog.types.resource_id_list
...
class ChangeSetSummaryListItem(TypedDict, closed=True):
    ...
    entity_id_list: NotRequired[
        "capo_marketplace_catalog.types.resource_id_list.ResourceIdList"
    ]
...
def serialize_json(value: ChangeSetSummaryListItem) -> dict:
    ...
    if "entity_id_list" in value:
        ...
        out["EntityIdList"] = (
            capo_marketplace_catalog.types.resource_id_list.serialize_json(
...
def deserialize_json(data: dict) -> ChangeSetSummaryListItem:
    ...
    if "EntityIdList" in data:
        ...
        out["entity_id_list"] = (
            capo_marketplace_catalog.types.resource_id_list.deserialize_json(
                data["EntityIdList"]
            )
        )
