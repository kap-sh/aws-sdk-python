...
class MarketplaceCatalogError(Exception):
    """Base class for all MarketplaceCatalog service errors."""


class ServiceError(MarketplaceCatalogError):
...
class SerializationError(MarketplaceCatalogError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MarketplaceCatalogError):
...
class WaiterFailedError(MarketplaceCatalogError):
...
class WaiterTimeoutError(MarketplaceCatalogError):
