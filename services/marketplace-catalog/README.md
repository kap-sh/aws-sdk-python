...
```
pip install aws-sdk-marketplace-catalog
```

## Usage

```python
from aws_sdk_marketplace_catalog import AsyncMarketplaceCatalogClient
...
```python
from aws_sdk_marketplace_catalog import AsyncMarketplaceCatalogClient
from aws_sdk_marketplace_catalog.error import AccessDeniedException
