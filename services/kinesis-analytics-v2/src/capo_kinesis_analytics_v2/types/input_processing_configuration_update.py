...
if TYPE_CHECKING:
    import capo_kinesis_analytics_v2.types.input_lambda_processor_update


class InputProcessingConfigurationUpdate(TypedDict, closed=True):
    input_lambda_processor_update: "capo_kinesis_analytics_v2.types.input_lambda_processor_update.InputLambdaProcessorUpdate"
...
def serialize_aws_json_1_1(value: InputProcessingConfigurationUpdate) -> dict:
    ...
    out["InputLambdaProcessorUpdate"] = (
        capo_kinesis_analytics_v2.types.input_lambda_processor_update.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InputProcessingConfigurationUpdate:
    ...
    if "InputLambdaProcessorUpdate" in data:
        ...
        out["input_lambda_processor_update"] = (
            capo_kinesis_analytics_v2.types.input_lambda_processor_update.deserialize_aws_json_1_1(
