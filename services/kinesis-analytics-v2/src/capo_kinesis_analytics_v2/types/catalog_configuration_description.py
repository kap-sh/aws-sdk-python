...
class CatalogConfigurationDescription(TypedDict, closed=True):
    glue_data_catalog_configuration_description: "capo_kinesis_analytics_v2.types.glue_data_catalog_configuration_description.GlueDataCatalogConfigurationDescription"
...
def serialize_aws_json_1_1(value: CatalogConfigurationDescription) -> dict:
    ...
    out["GlueDataCatalogConfigurationDescription"] = (
        capo_kinesis_analytics_v2.types.glue_data_catalog_configuration_description.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CatalogConfigurationDescription:
    ...
    if "GlueDataCatalogConfigurationDescription" in data:
        ...
        out["glue_data_catalog_configuration_description"] = (
            capo_kinesis_analytics_v2.types.glue_data_catalog_configuration_description.deserialize_aws_json_1_1(
