...
if TYPE_CHECKING:
    import capo_kinesis_analytics_v2.types.s3_content_location_update
...
class CodeContentUpdate(TypedDict, closed=True):
    ...
    s3_content_location_update: NotRequired[
        "capo_kinesis_analytics_v2.types.s3_content_location_update.S3ContentLocationUpdate"
    ]
...
def serialize_aws_json_1_1(value: CodeContentUpdate) -> dict:
    ...
    if "s3_content_location_update" in value:
        ...
        out["S3ContentLocationUpdate"] = (
            capo_kinesis_analytics_v2.types.s3_content_location_update.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CodeContentUpdate:
    ...
    if "S3ContentLocationUpdate" in data:
        ...
        out["s3_content_location_update"] = (
            capo_kinesis_analytics_v2.types.s3_content_location_update.deserialize_aws_json_1_1(
