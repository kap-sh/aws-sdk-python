...
if TYPE_CHECKING:
    ...
    import capo_kinesis_analytics_v2.types.kinesis_firehose_output_description
    import capo_kinesis_analytics_v2.types.kinesis_streams_output_description
    import capo_kinesis_analytics_v2.types.lambda_output_description


class OutputDescription(TypedDict, closed=True):
    output_id: NotRequired["capo_kinesis_analytics_v2.types.id.Id"]
    ...
    kinesis_streams_output_description: NotRequired[
        "capo_kinesis_analytics_v2.types.kinesis_streams_output_description.KinesisStreamsOutputDescription"
    ]
    ...
    kinesis_firehose_output_description: NotRequired[
        "capo_kinesis_analytics_v2.types.kinesis_firehose_output_description.KinesisFirehoseOutputDescription"
    ]
    ...
    lambda_output_description: NotRequired[
        "capo_kinesis_analytics_v2.types.lambda_output_description.LambdaOutputDescription"
    ]
...
def serialize_aws_json_1_1(value: OutputDescription) -> dict:
    ...
    if "kinesis_streams_output_description" in value:
        ...
        out["KinesisStreamsOutputDescription"] = (
            capo_kinesis_analytics_v2.types.kinesis_streams_output_description.serialize_aws_json_1_1(
    ...
    if "kinesis_firehose_output_description" in value:
        ...
        out["KinesisFirehoseOutputDescription"] = (
            capo_kinesis_analytics_v2.types.kinesis_firehose_output_description.serialize_aws_json_1_1(
    ...
    if "lambda_output_description" in value:
        ...
        out["LambdaOutputDescription"] = (
            capo_kinesis_analytics_v2.types.lambda_output_description.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> OutputDescription:
    ...
    if "KinesisStreamsOutputDescription" in data:
        ...
        out["kinesis_streams_output_description"] = (
            capo_kinesis_analytics_v2.types.kinesis_streams_output_description.deserialize_aws_json_1_1(
    ...
    if "KinesisFirehoseOutputDescription" in data:
        ...
        out["kinesis_firehose_output_description"] = (
            capo_kinesis_analytics_v2.types.kinesis_firehose_output_description.deserialize_aws_json_1_1(
    ...
    if "LambdaOutputDescription" in data:
        ...
        out["lambda_output_description"] = (
            capo_kinesis_analytics_v2.types.lambda_output_description.deserialize_aws_json_1_1(
