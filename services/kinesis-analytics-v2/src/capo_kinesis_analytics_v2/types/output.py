...
if TYPE_CHECKING:
    ...
    import capo_kinesis_analytics_v2.types.kinesis_firehose_output
    import capo_kinesis_analytics_v2.types.kinesis_streams_output
    import capo_kinesis_analytics_v2.types.lambda_output


class Output(TypedDict, closed=True):
    name: "capo_kinesis_analytics_v2.types.in_app_stream_name.InAppStreamName"
    """<p>The name of the in-application stream.</p>"""
    kinesis_streams_output: NotRequired[
        "capo_kinesis_analytics_v2.types.kinesis_streams_output.KinesisStreamsOutput"
    ]
    """<p>Identifies a Kinesis data stream as the destination.</p>"""
    kinesis_firehose_output: NotRequired[
        "capo_kinesis_analytics_v2.types.kinesis_firehose_output.KinesisFirehoseOutput"
    ]
    """<p>Identifies a Kinesis Data Firehose delivery stream as the destination.</p>"""
    lambda_output: NotRequired[
        "capo_kinesis_analytics_v2.types.lambda_output.LambdaOutput"
    ]
...
def serialize_aws_json_1_1(value: Output) -> dict:
    ...
    if "kinesis_streams_output" in value:
        ...
        out["KinesisStreamsOutput"] = (
            capo_kinesis_analytics_v2.types.kinesis_streams_output.serialize_aws_json_1_1(
    ...
    if "kinesis_firehose_output" in value:
        ...
        out["KinesisFirehoseOutput"] = (
            capo_kinesis_analytics_v2.types.kinesis_firehose_output.serialize_aws_json_1_1(
    ...
    if "lambda_output" in value:
        ...
        out["LambdaOutput"] = (
            capo_kinesis_analytics_v2.types.lambda_output.serialize_aws_json_1_1(
                value["lambda_output"]
            )
        )
    import capo_kinesis_analytics_v2.types.destination_schema
...
def deserialize_aws_json_1_1(data: dict) -> Output:
    ...
    if "KinesisStreamsOutput" in data:
        ...
        out["kinesis_streams_output"] = (
            capo_kinesis_analytics_v2.types.kinesis_streams_output.deserialize_aws_json_1_1(
    ...
    if "KinesisFirehoseOutput" in data:
        ...
        out["kinesis_firehose_output"] = (
            capo_kinesis_analytics_v2.types.kinesis_firehose_output.deserialize_aws_json_1_1(
    ...
    if "LambdaOutput" in data:
        ...
        out["lambda_output"] = (
            capo_kinesis_analytics_v2.types.lambda_output.deserialize_aws_json_1_1(
                data["LambdaOutput"]
            )
        )
