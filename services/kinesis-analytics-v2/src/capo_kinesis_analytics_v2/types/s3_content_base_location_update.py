...
if TYPE_CHECKING:
    import capo_kinesis_analytics_v2.types.base_path
    import capo_kinesis_analytics_v2.types.bucket_arn


class S3ContentBaseLocationUpdate(TypedDict, closed=True):
    bucket_arn_update: NotRequired[
        "capo_kinesis_analytics_v2.types.bucket_arn.BucketARN"
    ]
    """<p>The updated Amazon Resource Name (ARN) of the S3 bucket.</p>"""
    base_path_update: NotRequired["capo_kinesis_analytics_v2.types.base_path.BasePath"]
