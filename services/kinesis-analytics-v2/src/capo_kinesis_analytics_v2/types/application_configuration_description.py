...
class ApplicationConfigurationDescription(TypedDict, closed=True):
    sql_application_configuration_description: NotRequired[
        "capo_kinesis_analytics_v2.types.sql_application_configuration_description.SqlApplicationConfigurationDescription"
    ]
    ...
    application_code_configuration_description: NotRequired[
        "capo_kinesis_analytics_v2.types.application_code_configuration_description.ApplicationCodeConfigurationDescription"
    ]
    ...
    run_configuration_description: NotRequired[
        "capo_kinesis_analytics_v2.types.run_configuration_description.RunConfigurationDescription"
    ]
    ...
    flink_application_configuration_description: NotRequired[
        "capo_kinesis_analytics_v2.types.flink_application_configuration_description.FlinkApplicationConfigurationDescription"
    ]
    """<p>The details about a Managed Service for Apache Flink application.</p>"""
    environment_property_descriptions: NotRequired[
        "capo_kinesis_analytics_v2.types.environment_property_descriptions.EnvironmentPropertyDescriptions"
    ]
    ...
    application_snapshot_configuration_description: NotRequired[
        "capo_kinesis_analytics_v2.types.application_snapshot_configuration_description.ApplicationSnapshotConfigurationDescription"
    ]
    ...
    application_system_rollback_configuration_description: NotRequired[
        "capo_kinesis_analytics_v2.types.application_system_rollback_configuration_description.ApplicationSystemRollbackConfigurationDescription"
    ]
    ...
    vpc_configuration_descriptions: NotRequired[
        "capo_kinesis_analytics_v2.types.vpc_configuration_descriptions.VpcConfigurationDescriptions"
    ]
    ...
    zeppelin_application_configuration_description: NotRequired[
        "capo_kinesis_analytics_v2.types.zeppelin_application_configuration_description.ZeppelinApplicationConfigurationDescription"
    ]
...
def serialize_aws_json_1_1(value: ApplicationConfigurationDescription) -> dict:
    ...
    if "sql_application_configuration_description" in value:
        ...
        out["SqlApplicationConfigurationDescription"] = (
            capo_kinesis_analytics_v2.types.sql_application_configuration_description.serialize_aws_json_1_1(
    ...
    if "application_code_configuration_description" in value:
        ...
        out["ApplicationCodeConfigurationDescription"] = (
            capo_kinesis_analytics_v2.types.application_code_configuration_description.serialize_aws_json_1_1(
    ...
    if "run_configuration_description" in value:
        ...
        out["RunConfigurationDescription"] = (
            capo_kinesis_analytics_v2.types.run_configuration_description.serialize_aws_json_1_1(
    ...
    if "flink_application_configuration_description" in value:
        ...
        out["FlinkApplicationConfigurationDescription"] = (
            capo_kinesis_analytics_v2.types.flink_application_configuration_description.serialize_aws_json_1_1(
    ...
    if "environment_property_descriptions" in value:
        ...
        out["EnvironmentPropertyDescriptions"] = (
            capo_kinesis_analytics_v2.types.environment_property_descriptions.serialize_aws_json_1_1(
    ...
    if "application_snapshot_configuration_description" in value:
        ...
        out["ApplicationSnapshotConfigurationDescription"] = (
            capo_kinesis_analytics_v2.types.application_snapshot_configuration_description.serialize_aws_json_1_1(
    ...
    if "application_system_rollback_configuration_description" in value:
        ...
        out["ApplicationSystemRollbackConfigurationDescription"] = (
            capo_kinesis_analytics_v2.types.application_system_rollback_configuration_description.serialize_aws_json_1_1(
    ...
    if "vpc_configuration_descriptions" in value:
        ...
        out["VpcConfigurationDescriptions"] = (
            capo_kinesis_analytics_v2.types.vpc_configuration_descriptions.serialize_aws_json_1_1(
    ...
    if "zeppelin_application_configuration_description" in value:
        ...
        out["ZeppelinApplicationConfigurationDescription"] = (
            capo_kinesis_analytics_v2.types.zeppelin_application_configuration_description.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ApplicationConfigurationDescription:
    ...
    if "SqlApplicationConfigurationDescription" in data:
        ...
        out["sql_application_configuration_description"] = (
            capo_kinesis_analytics_v2.types.sql_application_configuration_description.deserialize_aws_json_1_1(
    ...
    if "ApplicationCodeConfigurationDescription" in data:
        ...
        out["application_code_configuration_description"] = (
            capo_kinesis_analytics_v2.types.application_code_configuration_description.deserialize_aws_json_1_1(
    ...
    if "RunConfigurationDescription" in data:
        ...
        out["run_configuration_description"] = (
            capo_kinesis_analytics_v2.types.run_configuration_description.deserialize_aws_json_1_1(
    ...
    if "FlinkApplicationConfigurationDescription" in data:
        ...
        out["flink_application_configuration_description"] = (
            capo_kinesis_analytics_v2.types.flink_application_configuration_description.deserialize_aws_json_1_1(
    ...
    if "EnvironmentPropertyDescriptions" in data:
        ...
        out["environment_property_descriptions"] = (
            capo_kinesis_analytics_v2.types.environment_property_descriptions.deserialize_aws_json_1_1(
    ...
    if "ApplicationSnapshotConfigurationDescription" in data:
        ...
        out["application_snapshot_configuration_description"] = (
            capo_kinesis_analytics_v2.types.application_snapshot_configuration_description.deserialize_aws_json_1_1(
    ...
    if "ApplicationSystemRollbackConfigurationDescription" in data:
        ...
        out["application_system_rollback_configuration_description"] = (
            capo_kinesis_analytics_v2.types.application_system_rollback_configuration_description.deserialize_aws_json_1_1(
    ...
    if "VpcConfigurationDescriptions" in data:
        ...
        out["vpc_configuration_descriptions"] = (
            capo_kinesis_analytics_v2.types.vpc_configuration_descriptions.deserialize_aws_json_1_1(
    ...
    if "ZeppelinApplicationConfigurationDescription" in data:
        ...
        out["zeppelin_application_configuration_description"] = (
            capo_kinesis_analytics_v2.types.zeppelin_application_configuration_description.deserialize_aws_json_1_1(
