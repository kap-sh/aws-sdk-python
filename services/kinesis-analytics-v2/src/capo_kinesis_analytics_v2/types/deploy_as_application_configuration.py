...
if TYPE_CHECKING:
    import capo_kinesis_analytics_v2.types.s3_content_base_location


class DeployAsApplicationConfiguration(TypedDict, closed=True):
    s3_content_location: (
        "capo_kinesis_analytics_v2.types.s3_content_base_location.S3ContentBaseLocation"
    )
...
def serialize_aws_json_1_1(value: DeployAsApplicationConfiguration) -> dict:
    ...
    out["S3ContentLocation"] = (
        capo_kinesis_analytics_v2.types.s3_content_base_location.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DeployAsApplicationConfiguration:
    ...
    if "S3ContentLocation" in data:
        ...
        out["s3_content_location"] = (
            capo_kinesis_analytics_v2.types.s3_content_base_location.deserialize_aws_json_1_1(
