"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#ListApplicationOperations``."""
...
import capo_kinesis_analytics_v2.types.application_operation_info_list
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.list_application_operations_response.ListApplicationOperationsResponse = capo_kinesis_analytics_v2.types.list_application_operations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KinesisAnalytics_20180523.ListApplicationOperations"
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.list_application_operations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_application_operations(
