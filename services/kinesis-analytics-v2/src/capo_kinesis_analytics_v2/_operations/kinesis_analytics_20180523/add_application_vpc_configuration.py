"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#AddApplicationVpcConfiguration``."""
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.add_application_vpc_configuration_response.AddApplicationVpcConfigurationResponse = capo_kinesis_analytics_v2.types.add_application_vpc_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KinesisAnalytics_20180523.AddApplicationVpcConfiguration"
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.add_application_vpc_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_add_application_vpc_configuration(
