"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#AddApplicationInput``."""
...
import capo_kinesis_analytics_v2.errors.code_validation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CodeValidationException":
            raise capo_kinesis_analytics_v2.errors.code_validation_exception.CodeValidationException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.add_application_input_response.AddApplicationInputResponse = capo_kinesis_analytics_v2.types.add_application_input_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.add_application_input_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
