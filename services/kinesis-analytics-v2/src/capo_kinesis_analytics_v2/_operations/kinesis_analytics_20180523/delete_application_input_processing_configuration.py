"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#DeleteApplicationInputProcessingConfiguration``."""
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.delete_application_input_processing_configuration_response.DeleteApplicationInputProcessingConfigurationResponse = capo_kinesis_analytics_v2.types.delete_application_input_processing_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.delete_application_input_processing_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_application_input_processing_configuration(
