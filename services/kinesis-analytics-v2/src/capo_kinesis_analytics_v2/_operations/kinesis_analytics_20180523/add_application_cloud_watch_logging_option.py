"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#AddApplicationCloudWatchLoggingOption``."""
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.add_application_cloud_watch_logging_option_response.AddApplicationCloudWatchLoggingOptionResponse = capo_kinesis_analytics_v2.types.add_application_cloud_watch_logging_option_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.add_application_cloud_watch_logging_option_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
