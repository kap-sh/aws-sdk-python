"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#DescribeApplicationVersion``."""
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.describe_application_version_response.DescribeApplicationVersionResponse = capo_kinesis_analytics_v2.types.describe_application_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KinesisAnalytics_20180523.DescribeApplicationVersion"
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.describe_application_version_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_application_version(
