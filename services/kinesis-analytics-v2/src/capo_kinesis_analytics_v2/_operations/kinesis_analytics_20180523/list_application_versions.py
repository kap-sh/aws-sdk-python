"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#ListApplicationVersions``."""
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.list_application_versions_response.ListApplicationVersionsResponse = capo_kinesis_analytics_v2.types.list_application_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KinesisAnalytics_20180523.ListApplicationVersions"
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.list_application_versions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
