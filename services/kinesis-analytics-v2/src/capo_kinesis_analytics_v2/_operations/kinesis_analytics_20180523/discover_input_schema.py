"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#DiscoverInputSchema``."""
...
import capo_kinesis_analytics_v2.errors.resource_provisioned_throughput_exceeded_exception
import capo_kinesis_analytics_v2.errors.service_unavailable_exception
import capo_kinesis_analytics_v2.errors.unable_to_detect_schema_exception
import capo_kinesis_analytics_v2.errors.unsupported_operation_exception
...
import capo_kinesis_analytics_v2.types.parsed_input_records
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceProvisionedThroughputExceededException":
            raise capo_kinesis_analytics_v2.errors.resource_provisioned_throughput_exceeded_exception.ResourceProvisionedThroughputExceededException.from_aws_json_1_1(
                data
            )
        case "ServiceUnavailableException":
            raise capo_kinesis_analytics_v2.errors.service_unavailable_exception.ServiceUnavailableException.from_aws_json_1_1(
                data
            )
        case "UnableToDetectSchemaException":
            raise capo_kinesis_analytics_v2.errors.unable_to_detect_schema_exception.UnableToDetectSchemaException.from_aws_json_1_1(
                data
            )
        case "UnsupportedOperationException":
            raise capo_kinesis_analytics_v2.errors.unsupported_operation_exception.UnsupportedOperationException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.discover_input_schema_response.DiscoverInputSchemaResponse = capo_kinesis_analytics_v2.types.discover_input_schema_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.discover_input_schema_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_discover_input_schema(
