"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#DeleteApplicationSnapshot``."""
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.delete_application_snapshot_response.DeleteApplicationSnapshotResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KinesisAnalytics_20180523.DeleteApplicationSnapshot"
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.delete_application_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_application_snapshot(
