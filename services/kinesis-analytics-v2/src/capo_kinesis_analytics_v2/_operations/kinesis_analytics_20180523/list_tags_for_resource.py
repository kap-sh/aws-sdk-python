"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_kinesis_analytics_v2.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.list_tags_for_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
