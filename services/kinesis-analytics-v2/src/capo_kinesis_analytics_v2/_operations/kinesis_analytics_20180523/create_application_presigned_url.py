"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#CreateApplicationPresignedUrl``."""
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.create_application_presigned_url_response.CreateApplicationPresignedUrlResponse = capo_kinesis_analytics_v2.types.create_application_presigned_url_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KinesisAnalytics_20180523.CreateApplicationPresignedUrl"
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.create_application_presigned_url_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_application_presigned_url(
