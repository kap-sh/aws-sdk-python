"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#AddApplicationOutput``."""
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.add_application_output_response.AddApplicationOutputResponse = capo_kinesis_analytics_v2.types.add_application_output_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.add_application_output_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_add_application_output(
