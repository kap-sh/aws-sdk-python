"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#UpdateApplicationMaintenanceConfiguration``."""
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.update_application_maintenance_configuration_response.UpdateApplicationMaintenanceConfigurationResponse = capo_kinesis_analytics_v2.types.update_application_maintenance_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.update_application_maintenance_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_application_maintenance_configuration(
