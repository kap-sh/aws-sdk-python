"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#ResourceInUseException``."""
...
class ResourceInUseException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisanalyticsv2#ResourceInUseException``."""
