"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisanalyticsv2#ResourceNotFoundException``."""
