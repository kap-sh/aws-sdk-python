...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics_v2.types.update_application_maintenance_configuration_response.UpdateApplicationMaintenanceConfigurationResponse = aws_sdk_kinesis_analytics_v2.types.update_application_maintenance_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics_v2.types.update_application_maintenance_configuration_request.UpdateApplicationMaintenanceConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics_v2.types.update_application_maintenance_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
