"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#UntagResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            import aws_sdk_kinesis_analytics_v2.errors.too_many_tags_exception

            raise aws_sdk_kinesis_analytics_v2.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics_v2.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics_v2.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics_v2.types.untag_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
