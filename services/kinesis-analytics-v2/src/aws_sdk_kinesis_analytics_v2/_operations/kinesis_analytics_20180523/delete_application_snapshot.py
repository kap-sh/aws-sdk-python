...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics_v2.types.delete_application_snapshot_response.DeleteApplicationSnapshotResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics_v2.types.delete_application_snapshot_request.DeleteApplicationSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics_v2.types.delete_application_snapshot_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
