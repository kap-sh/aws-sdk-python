...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics_v2.types.add_application_cloud_watch_logging_option_response.AddApplicationCloudWatchLoggingOptionResponse = aws_sdk_kinesis_analytics_v2.types.add_application_cloud_watch_logging_option_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics_v2.types.add_application_cloud_watch_logging_option_request.AddApplicationCloudWatchLoggingOptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
