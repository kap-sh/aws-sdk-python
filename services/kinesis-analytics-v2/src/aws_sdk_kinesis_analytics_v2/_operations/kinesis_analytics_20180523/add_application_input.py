...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CodeValidationException":
            import aws_sdk_kinesis_analytics_v2.errors.code_validation_exception

            raise aws_sdk_kinesis_analytics_v2.errors.code_validation_exception.CodeValidationException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics_v2.types.add_application_input_response.AddApplicationInputResponse = aws_sdk_kinesis_analytics_v2.types.add_application_input_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics_v2.types.add_application_input_request.AddApplicationInputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics_v2.types.add_application_input_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
