"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#DeleteApplicationVpcConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics_v2.types.delete_application_vpc_configuration_response.DeleteApplicationVpcConfigurationResponse = aws_sdk_kinesis_analytics_v2.types.delete_application_vpc_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics_v2.types.delete_application_vpc_configuration_request.DeleteApplicationVpcConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics_v2.types.delete_application_vpc_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_application_vpc_configuration(
