...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics_v2.types.delete_application_output_response.DeleteApplicationOutputResponse = aws_sdk_kinesis_analytics_v2.types.delete_application_output_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics_v2.types.delete_application_output_request.DeleteApplicationOutputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics_v2.types.delete_application_output_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
