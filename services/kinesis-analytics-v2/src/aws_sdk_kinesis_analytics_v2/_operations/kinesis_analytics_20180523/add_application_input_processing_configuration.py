...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics_v2.types.add_application_input_processing_configuration_response.AddApplicationInputProcessingConfigurationResponse = aws_sdk_kinesis_analytics_v2.types.add_application_input_processing_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics_v2.types.add_application_input_processing_configuration_request.AddApplicationInputProcessingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics_v2.types.add_application_input_processing_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
