...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics_v2.types.create_application_presigned_url_response.CreateApplicationPresignedUrlResponse = aws_sdk_kinesis_analytics_v2.types.create_application_presigned_url_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics_v2.types.create_application_presigned_url_request.CreateApplicationPresignedUrlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics_v2.types.create_application_presigned_url_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
