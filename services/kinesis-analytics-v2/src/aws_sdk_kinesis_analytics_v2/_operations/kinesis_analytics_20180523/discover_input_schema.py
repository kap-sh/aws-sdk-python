...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics_v2.types.discover_input_schema_request.DiscoverInputSchemaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics_v2.types.discover_input_schema_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
