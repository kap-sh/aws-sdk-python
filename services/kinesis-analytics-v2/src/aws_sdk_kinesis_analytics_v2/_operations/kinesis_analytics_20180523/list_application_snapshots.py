"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#ListApplicationSnapshots``."""
...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics_v2.types.list_application_snapshots_response.ListApplicationSnapshotsResponse = aws_sdk_kinesis_analytics_v2.types.list_application_snapshots_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics_v2.types.list_application_snapshots_request.ListApplicationSnapshotsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "KinesisAnalytics_20180523.ListApplicationSnapshots"
    import aws_sdk_kinesis_analytics_v2.types.list_application_snapshots_request

    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics_v2.types.list_application_snapshots_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_application_snapshots(
