"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#DeleteApplicationCloudWatchLoggingOption``."""
...
import aws_sdk_kinesis_analytics_v2.errors.invalid_application_configuration_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidApplicationConfigurationException":
            raise aws_sdk_kinesis_analytics_v2.errors.invalid_application_configuration_exception.InvalidApplicationConfigurationException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics_v2.types.delete_application_cloud_watch_logging_option_response.DeleteApplicationCloudWatchLoggingOptionResponse = aws_sdk_kinesis_analytics_v2.types.delete_application_cloud_watch_logging_option_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics_v2.types.delete_application_cloud_watch_logging_option_request.DeleteApplicationCloudWatchLoggingOptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics_v2.types.delete_application_cloud_watch_logging_option_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_application_cloud_watch_logging_option(
