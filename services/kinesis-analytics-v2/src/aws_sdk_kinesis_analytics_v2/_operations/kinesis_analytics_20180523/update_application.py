...
import aws_sdk_kinesis_analytics_v2.errors.limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise aws_sdk_kinesis_analytics_v2.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics_v2.types.update_application_response.UpdateApplicationResponse = aws_sdk_kinesis_analytics_v2.types.update_application_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics_v2.types.update_application_request.UpdateApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_analytics_v2.types.update_application_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
