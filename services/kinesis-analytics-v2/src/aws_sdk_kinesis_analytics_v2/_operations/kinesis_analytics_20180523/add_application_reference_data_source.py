"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#AddApplicationReferenceDataSource``."""
...
def handle_response(
    ...
    out: aws_sdk_kinesis_analytics_v2.types.add_application_reference_data_source_response.AddApplicationReferenceDataSourceResponse = aws_sdk_kinesis_analytics_v2.types.add_application_reference_data_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_analytics_v2.types.add_application_reference_data_source_request.AddApplicationReferenceDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
