...
from ._services.async_kinesis_analytics_v2 import (
    AsyncKinesisAnalyticsV2Client as AsyncKinesisAnalyticsV2Client,
)
from ._services.kinesis_analytics_v2 import (
    KinesisAnalyticsV2Client as KinesisAnalyticsV2Client,
)
