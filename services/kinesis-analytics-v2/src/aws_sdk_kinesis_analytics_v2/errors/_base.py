...
class KinesisAnalyticsV2Error(Exception):
    """Base class for all KinesisAnalyticsV2 service errors."""


class ServiceError(KinesisAnalyticsV2Error):
...
class SerializationError(KinesisAnalyticsV2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(KinesisAnalyticsV2Error):
...
class WaiterFailedError(KinesisAnalyticsV2Error):
...
class WaiterTimeoutError(KinesisAnalyticsV2Error):
