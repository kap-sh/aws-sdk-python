"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#ConcurrentModificationException``."""
...
class ConcurrentModificationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisanalyticsv2#ConcurrentModificationException``."""
