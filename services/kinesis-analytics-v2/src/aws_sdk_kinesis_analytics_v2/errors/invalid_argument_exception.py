"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#InvalidArgumentException``."""
...
class InvalidArgumentException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisanalyticsv2#InvalidArgumentException``."""
