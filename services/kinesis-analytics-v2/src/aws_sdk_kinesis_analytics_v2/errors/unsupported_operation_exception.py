"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#UnsupportedOperationException``."""
...
class UnsupportedOperationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisanalyticsv2#UnsupportedOperationException``."""
