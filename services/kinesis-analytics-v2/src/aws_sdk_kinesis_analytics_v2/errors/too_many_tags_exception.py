"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#TooManyTagsException``."""
...
class TooManyTagsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisanalyticsv2#TooManyTagsException``."""
