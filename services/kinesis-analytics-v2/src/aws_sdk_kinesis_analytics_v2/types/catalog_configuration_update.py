...
if TYPE_CHECKING:
    import aws_sdk_kinesis_analytics_v2.types.glue_data_catalog_configuration_update


class CatalogConfigurationUpdate(TypedDict):
    glue_data_catalog_configuration_update: "aws_sdk_kinesis_analytics_v2.types.glue_data_catalog_configuration_update.GlueDataCatalogConfigurationUpdate"
...
def serialize_aws_json_1_1(value: CatalogConfigurationUpdate) -> dict:
    ...
    out["GlueDataCatalogConfigurationUpdate"] = (
        aws_sdk_kinesis_analytics_v2.types.glue_data_catalog_configuration_update.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CatalogConfigurationUpdate:
    ...
    if "GlueDataCatalogConfigurationUpdate" in data:
        ...
        out["glue_data_catalog_configuration_update"] = (
            aws_sdk_kinesis_analytics_v2.types.glue_data_catalog_configuration_update.deserialize_aws_json_1_1(
