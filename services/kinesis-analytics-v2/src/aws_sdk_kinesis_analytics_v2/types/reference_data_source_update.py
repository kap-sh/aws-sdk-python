"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#ReferenceDataSourceUpdate``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_kinesis_analytics_v2.types.s3_reference_data_source_update
...
class ReferenceDataSourceUpdate(TypedDict):
    ...
    table_name_update: NotRequired[
        "aws_sdk_kinesis_analytics_v2.types.in_app_table_name.InAppTableName"
    ]
    """<p>The in-application table name that is created by this update.</p>"""
    s3_reference_data_source_update: NotRequired[
        "aws_sdk_kinesis_analytics_v2.types.s3_reference_data_source_update.S3ReferenceDataSourceUpdate"
    ]
...
def serialize_aws_json_1_1(value: ReferenceDataSourceUpdate) -> dict:
    ...
    if "s3_reference_data_source_update" in value:
        ...
        out["S3ReferenceDataSourceUpdate"] = (
            aws_sdk_kinesis_analytics_v2.types.s3_reference_data_source_update.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ReferenceDataSourceUpdate:
    ...
    if "S3ReferenceDataSourceUpdate" in data:
        ...
        out["s3_reference_data_source_update"] = (
            aws_sdk_kinesis_analytics_v2.types.s3_reference_data_source_update.deserialize_aws_json_1_1(
