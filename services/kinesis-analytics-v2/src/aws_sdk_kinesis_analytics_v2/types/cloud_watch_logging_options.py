...
CloudWatchLoggingOptions: TypeAlias = list[
    "aws_sdk_kinesis_analytics_v2.types.cloud_watch_logging_option.CloudWatchLoggingOption"
]
...
def serialize_aws_json_1_1(value: CloudWatchLoggingOptions) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_kinesis_analytics_v2.types.cloud_watch_logging_option.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> CloudWatchLoggingOptions:
    ...
    for item in data:
        out.append(
            aws_sdk_kinesis_analytics_v2.types.cloud_watch_logging_option.deserialize_aws_json_1_1(
                item
            )
        )
    return out
