"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#DestinationSchema``."""
...
if TYPE_CHECKING:
    import aws_sdk_kinesis_analytics_v2.types.record_format_type


class DestinationSchema(TypedDict):
    record_format_type: (
        "aws_sdk_kinesis_analytics_v2.types.record_format_type.RecordFormatType"
    )
...
def serialize_aws_json_1_1(value: DestinationSchema) -> dict:
    ...
    out["RecordFormatType"] = (
        aws_sdk_kinesis_analytics_v2.types.record_format_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DestinationSchema:
    ...
    if "RecordFormatType" in data:
        ...
        out["record_format_type"] = (
            aws_sdk_kinesis_analytics_v2.types.record_format_type.deserialize_aws_json_1_1(
