...
if TYPE_CHECKING:
    import aws_sdk_kinesis_analytics_v2.types.catalog_configuration_update
    import aws_sdk_kinesis_analytics_v2.types.custom_artifacts_configuration_list
    import aws_sdk_kinesis_analytics_v2.types.deploy_as_application_configuration_update
    import aws_sdk_kinesis_analytics_v2.types.zeppelin_monitoring_configuration_update


class ZeppelinApplicationConfigurationUpdate(TypedDict):
    monitoring_configuration_update: NotRequired[
        "aws_sdk_kinesis_analytics_v2.types.zeppelin_monitoring_configuration_update.ZeppelinMonitoringConfigurationUpdate"
    ]
    ...
    catalog_configuration_update: NotRequired[
        "aws_sdk_kinesis_analytics_v2.types.catalog_configuration_update.CatalogConfigurationUpdate"
    ]
    ...
    deploy_as_application_configuration_update: NotRequired[
        "aws_sdk_kinesis_analytics_v2.types.deploy_as_application_configuration_update.DeployAsApplicationConfigurationUpdate"
    ]
...
def serialize_aws_json_1_1(value: ZeppelinApplicationConfigurationUpdate) -> dict:
    ...
    if "monitoring_configuration_update" in value:
        ...
        out["MonitoringConfigurationUpdate"] = (
            aws_sdk_kinesis_analytics_v2.types.zeppelin_monitoring_configuration_update.serialize_aws_json_1_1(
    ...
    if "catalog_configuration_update" in value:
        ...
        out["CatalogConfigurationUpdate"] = (
            aws_sdk_kinesis_analytics_v2.types.catalog_configuration_update.serialize_aws_json_1_1(
    ...
    if "deploy_as_application_configuration_update" in value:
        ...
        out["DeployAsApplicationConfigurationUpdate"] = (
            aws_sdk_kinesis_analytics_v2.types.deploy_as_application_configuration_update.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ZeppelinApplicationConfigurationUpdate:
    ...
    if "MonitoringConfigurationUpdate" in data:
        ...
        out["monitoring_configuration_update"] = (
            aws_sdk_kinesis_analytics_v2.types.zeppelin_monitoring_configuration_update.deserialize_aws_json_1_1(
    ...
    if "CatalogConfigurationUpdate" in data:
        ...
        out["catalog_configuration_update"] = (
            aws_sdk_kinesis_analytics_v2.types.catalog_configuration_update.deserialize_aws_json_1_1(
    ...
    if "DeployAsApplicationConfigurationUpdate" in data:
        ...
        out["deploy_as_application_configuration_update"] = (
            aws_sdk_kinesis_analytics_v2.types.deploy_as_application_configuration_update.deserialize_aws_json_1_1(
