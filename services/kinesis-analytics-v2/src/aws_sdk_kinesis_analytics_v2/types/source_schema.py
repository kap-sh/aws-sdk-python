...
class SourceSchema(TypedDict, closed=True):
    record_format: "aws_sdk_kinesis_analytics_v2.types.record_format.RecordFormat"
    """<p>Specifies the format of the records on the streaming source.</p>"""
    record_encoding: NotRequired[
        "aws_sdk_kinesis_analytics_v2.types.record_encoding.RecordEncoding"
    ]
    """<p>Specifies the encoding of the records in the streaming source. For example, UTF-8.</p>"""
    record_columns: "aws_sdk_kinesis_analytics_v2.types.record_columns.RecordColumns"
