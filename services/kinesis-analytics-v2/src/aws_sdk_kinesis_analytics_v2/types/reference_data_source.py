...
if TYPE_CHECKING:
    ...
    import aws_sdk_kinesis_analytics_v2.types.s3_reference_data_source
...
class ReferenceDataSource(TypedDict, closed=True):
    ...
    s3_reference_data_source: NotRequired[
        "aws_sdk_kinesis_analytics_v2.types.s3_reference_data_source.S3ReferenceDataSource"
    ]
    ...
    reference_schema: "aws_sdk_kinesis_analytics_v2.types.source_schema.SourceSchema"
...
def serialize_aws_json_1_1(value: ReferenceDataSource) -> dict:
    ...
    if "s3_reference_data_source" in value:
        ...
        out["S3ReferenceDataSource"] = (
            aws_sdk_kinesis_analytics_v2.types.s3_reference_data_source.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ReferenceDataSource:
    ...
    if "S3ReferenceDataSource" in data:
        ...
        out["s3_reference_data_source"] = (
            aws_sdk_kinesis_analytics_v2.types.s3_reference_data_source.deserialize_aws_json_1_1(
