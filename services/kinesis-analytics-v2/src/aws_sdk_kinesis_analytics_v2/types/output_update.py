...
if TYPE_CHECKING:
    ...
    import aws_sdk_kinesis_analytics_v2.types.kinesis_firehose_output_update
    import aws_sdk_kinesis_analytics_v2.types.kinesis_streams_output_update
    import aws_sdk_kinesis_analytics_v2.types.lambda_output_update
...
class OutputUpdate(TypedDict, closed=True):
    ...
    kinesis_streams_output_update: NotRequired[
        "aws_sdk_kinesis_analytics_v2.types.kinesis_streams_output_update.KinesisStreamsOutputUpdate"
    ]
    """<p>Describes a Kinesis data stream as the destination for the output.</p>"""
    kinesis_firehose_output_update: NotRequired[
        "aws_sdk_kinesis_analytics_v2.types.kinesis_firehose_output_update.KinesisFirehoseOutputUpdate"
    ]
    """<p>Describes a Kinesis Data Firehose delivery stream as the destination for the output.</p>"""
    lambda_output_update: NotRequired[
        "aws_sdk_kinesis_analytics_v2.types.lambda_output_update.LambdaOutputUpdate"
    ]
...
def serialize_aws_json_1_1(value: OutputUpdate) -> dict:
    ...
    if "kinesis_streams_output_update" in value:
        ...
        out["KinesisStreamsOutputUpdate"] = (
            aws_sdk_kinesis_analytics_v2.types.kinesis_streams_output_update.serialize_aws_json_1_1(
    ...
    if "kinesis_firehose_output_update" in value:
        ...
        out["KinesisFirehoseOutputUpdate"] = (
            aws_sdk_kinesis_analytics_v2.types.kinesis_firehose_output_update.serialize_aws_json_1_1(
    ...
    if "lambda_output_update" in value:
        ...
        out["LambdaOutputUpdate"] = (
            aws_sdk_kinesis_analytics_v2.types.lambda_output_update.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> OutputUpdate:
    ...
    if "KinesisStreamsOutputUpdate" in data:
        ...
        out["kinesis_streams_output_update"] = (
            aws_sdk_kinesis_analytics_v2.types.kinesis_streams_output_update.deserialize_aws_json_1_1(
    ...
    if "KinesisFirehoseOutputUpdate" in data:
        ...
        out["kinesis_firehose_output_update"] = (
            aws_sdk_kinesis_analytics_v2.types.kinesis_firehose_output_update.deserialize_aws_json_1_1(
    ...
    if "LambdaOutputUpdate" in data:
        ...
        out["lambda_output_update"] = (
            aws_sdk_kinesis_analytics_v2.types.lambda_output_update.deserialize_aws_json_1_1(
