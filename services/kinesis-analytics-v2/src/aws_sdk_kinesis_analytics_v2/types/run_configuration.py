...
if TYPE_CHECKING:
    ...
    import aws_sdk_kinesis_analytics_v2.types.sql_run_configurations
...
class RunConfiguration(TypedDict, closed=True):
    ...
    sql_run_configurations: NotRequired[
        "aws_sdk_kinesis_analytics_v2.types.sql_run_configurations.SqlRunConfigurations"
    ]
...
def serialize_aws_json_1_1(value: RunConfiguration) -> dict:
    ...
    if "sql_run_configurations" in value:
        ...
        out["SqlRunConfigurations"] = (
            aws_sdk_kinesis_analytics_v2.types.sql_run_configurations.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RunConfiguration:
    ...
    if "SqlRunConfigurations" in data:
        ...
        out["sql_run_configurations"] = (
            aws_sdk_kinesis_analytics_v2.types.sql_run_configurations.deserialize_aws_json_1_1(
