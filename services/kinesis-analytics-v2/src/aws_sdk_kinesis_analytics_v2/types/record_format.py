...
if TYPE_CHECKING:
    import aws_sdk_kinesis_analytics_v2.types.mapping_parameters
...
class RecordFormat(TypedDict, closed=True):
    ...
    mapping_parameters: NotRequired[
        "aws_sdk_kinesis_analytics_v2.types.mapping_parameters.MappingParameters"
    ]
...
def serialize_aws_json_1_1(value: RecordFormat) -> dict:
    ...
    if "mapping_parameters" in value:
        ...
        out["MappingParameters"] = (
            aws_sdk_kinesis_analytics_v2.types.mapping_parameters.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RecordFormat:
    ...
    if "MappingParameters" in data:
        ...
        out["mapping_parameters"] = (
            aws_sdk_kinesis_analytics_v2.types.mapping_parameters.deserialize_aws_json_1_1(
