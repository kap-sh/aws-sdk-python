...
if TYPE_CHECKING:
    ...
    import aws_sdk_kinesis_analytics_v2.types.job_plan_description
    import aws_sdk_kinesis_analytics_v2.types.monitoring_configuration_description
...
class FlinkApplicationConfigurationDescription(TypedDict, closed=True):
    ...
    monitoring_configuration_description: NotRequired[
        "aws_sdk_kinesis_analytics_v2.types.monitoring_configuration_description.MonitoringConfigurationDescription"
    ]
    ...
    parallelism_configuration_description: NotRequired[
        "aws_sdk_kinesis_analytics_v2.types.parallelism_configuration_description.ParallelismConfigurationDescription"
    ]
...
def serialize_aws_json_1_1(value: FlinkApplicationConfigurationDescription) -> dict:
    ...
    if "checkpoint_configuration_description" in value:
        ...
        out["CheckpointConfigurationDescription"] = (
            aws_sdk_kinesis_analytics_v2.types.checkpoint_configuration_description.serialize_aws_json_1_1(
    ...
    if "monitoring_configuration_description" in value:
        ...
        out["MonitoringConfigurationDescription"] = (
            aws_sdk_kinesis_analytics_v2.types.monitoring_configuration_description.serialize_aws_json_1_1(
    ...
    if "parallelism_configuration_description" in value:
        ...
        out["ParallelismConfigurationDescription"] = (
            aws_sdk_kinesis_analytics_v2.types.parallelism_configuration_description.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> FlinkApplicationConfigurationDescription:
    ...
    if "CheckpointConfigurationDescription" in data:
        ...
        out["checkpoint_configuration_description"] = (
            aws_sdk_kinesis_analytics_v2.types.checkpoint_configuration_description.deserialize_aws_json_1_1(
    ...
    if "MonitoringConfigurationDescription" in data:
        ...
        out["monitoring_configuration_description"] = (
            aws_sdk_kinesis_analytics_v2.types.monitoring_configuration_description.deserialize_aws_json_1_1(
    ...
    if "ParallelismConfigurationDescription" in data:
        ...
        out["parallelism_configuration_description"] = (
            aws_sdk_kinesis_analytics_v2.types.parallelism_configuration_description.deserialize_aws_json_1_1(
