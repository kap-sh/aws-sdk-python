...
from aws_sdk_pricing._services._aws_config import aws_config
...
class PricingClientConfig(TypedDict, total=False):
...
class PricingClient:
    ...
    def describe_services(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pricing.types.describe_services_request.DescribeServicesRequest]",
        ) -> OperationResponse[
            "aws_sdk_pricing.types.describe_services_response.DescribeServicesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pricing._operations.aws_price_list_service.describe_services.describe_services(
    ...
    ) -> "Iterator[aws_sdk_pricing.types.service.Service]":
        _token = next_token
        while True:
    ...
    def get_attribute_values(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pricing.types.get_attribute_values_request.GetAttributeValuesRequest]",
        ) -> OperationResponse[
            "aws_sdk_pricing.types.get_attribute_values_response.GetAttributeValuesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pricing._operations.aws_price_list_service.get_attribute_values.get_attribute_values(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_pricing.types.attribute_value.AttributeValue]":
        _token = next_token
        while True:
    ...
    def get_price_list_file_url(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pricing.types.get_price_list_file_url_request.GetPriceListFileUrlRequest]",
        ) -> OperationResponse[
            "aws_sdk_pricing.types.get_price_list_file_url_response.GetPriceListFileUrlResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pricing._operations.aws_price_list_service.get_price_list_file_url.get_price_list_file_url(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_products(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pricing.types.get_products_request.GetProductsRequest]",
        ) -> OperationResponse[
            "aws_sdk_pricing.types.get_products_response.GetProductsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pricing._operations.aws_price_list_service.get_products.get_products(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_pricing.types.synthesized_json_price_list_json_item.SynthesizedJsonPriceListJsonItem]":
        _token = next_token
        while True:
    ...
    def list_price_lists(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pricing.types.list_price_lists_request.ListPriceListsRequest]",
        ) -> OperationResponse[
            "aws_sdk_pricing.types.list_price_lists_response.ListPriceListsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pricing._operations.aws_price_list_service.list_price_lists.list_price_lists(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_price_lists(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_pricing.types.string.String"] = None,
        max_results: Optional["aws_sdk_pricing.types.max_results.MaxResults"] = None,
    ) -> "Iterator[aws_sdk_pricing.types.price_list.PriceList]":
        _token = next_token
        while True:
