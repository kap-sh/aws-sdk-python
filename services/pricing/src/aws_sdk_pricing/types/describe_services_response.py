...
if TYPE_CHECKING:
    ...
    import aws_sdk_pricing.types.service_list
...
def serialize_aws_json_1_1(value: DescribeServicesResponse) -> dict:
    ...
    if "services" in value:
        ...
        out["Services"] = aws_sdk_pricing.types.service_list.serialize_aws_json_1_1(
            value["services"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeServicesResponse:
    ...
    if "Services" in data:
        ...
        out["services"] = aws_sdk_pricing.types.service_list.deserialize_aws_json_1_1(
            data["Services"]
        )
