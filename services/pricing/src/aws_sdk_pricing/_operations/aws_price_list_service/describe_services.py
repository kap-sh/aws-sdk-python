...
def build_request(
    ...
    input: aws_sdk_pricing.types.describe_services_request.DescribeServicesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pricing.types.describe_services_request.serialize_aws_json_1_1(input)
    ).encode()
