...
def handle_response(
    ...
    out: aws_sdk_pricing.types.describe_services_response.DescribeServicesResponse = (
        aws_sdk_pricing.types.describe_services_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_pricing.types.describe_services_request.DescribeServicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pricing.types.describe_services_request.serialize_aws_json_1_1(input_)
    ).encode()
