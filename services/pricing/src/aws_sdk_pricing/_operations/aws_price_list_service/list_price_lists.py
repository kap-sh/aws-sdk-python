...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            import aws_sdk_pricing.errors.resource_not_found_exception

            raise aws_sdk_pricing.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_pricing.types.list_price_lists_response.ListPriceListsResponse = (
        aws_sdk_pricing.types.list_price_lists_response.deserialize_aws_json_1_1(
...
def get_signer(
...
) -> aws_sdk_pricing._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_pricing._auth._sigv4.build_sigv4_auth_scheme(
                "pricing", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_pricing._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_pricing.types.list_price_lists_request.ListPriceListsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pricing.types.list_price_lists_request.serialize_aws_json_1_1(input_)
    ).encode()
