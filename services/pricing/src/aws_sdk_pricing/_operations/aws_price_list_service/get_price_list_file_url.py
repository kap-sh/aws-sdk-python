...
def handle_response(
    ...
    out: aws_sdk_pricing.types.get_price_list_file_url_response.GetPriceListFileUrlResponse = aws_sdk_pricing.types.get_price_list_file_url_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_pricing.types.get_price_list_file_url_request.GetPriceListFileUrlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pricing.types.get_price_list_file_url_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
