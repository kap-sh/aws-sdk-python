...
def build_request(
    ...
    input_: aws_sdk_pricing.types.get_attribute_values_request.GetAttributeValuesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pricing.types.get_attribute_values_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
