...
def handle_response(
    ...
    out: aws_sdk_pricing.types.get_attribute_values_response.GetAttributeValuesResponse = aws_sdk_pricing.types.get_attribute_values_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_pricing.types.get_attribute_values_request.GetAttributeValuesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pricing.types.get_attribute_values_request.serialize_aws_json_1_1(input)
    ).encode()
