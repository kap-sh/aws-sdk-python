...
class PricingError(Exception):
    """Base class for all Pricing service errors."""


class ServiceError(PricingError):
...
class SerializationError(PricingError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PricingError):
...
class WaiterFailedError(PricingError):
...
class WaiterTimeoutError(PricingError):
