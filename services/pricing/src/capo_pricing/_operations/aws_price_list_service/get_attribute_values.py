"""Generated from Smithy shape ``com.amazonaws.pricing#GetAttributeValues``."""
...
def handle_response(
    ...
    out: capo_pricing.types.get_attribute_values_response.GetAttributeValuesResponse = (
        capo_pricing.types.get_attribute_values_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pricing.types.get_attribute_values_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_attribute_values(
