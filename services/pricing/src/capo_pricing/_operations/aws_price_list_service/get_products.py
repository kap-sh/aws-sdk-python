"""Generated from Smithy shape ``com.amazonaws.pricing#GetProducts``."""
...
def handle_response(
    ...
    out: capo_pricing.types.get_products_response.GetProductsResponse = (
        capo_pricing.types.get_products_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pricing.types.get_products_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_products(
    ...
    capo_pricing.types.get_products_response.GetProductsResponse, zapros.Response
]:
