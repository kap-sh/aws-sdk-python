"""Generated from Smithy shape ``com.amazonaws.pricing#GetPriceListFileUrl``."""
...
def handle_response(
    ...
    out: capo_pricing.types.get_price_list_file_url_response.GetPriceListFileUrlResponse = capo_pricing.types.get_price_list_file_url_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSPriceListService.GetPriceListFileUrl"
    body: bytes | None = json.dumps(
        capo_pricing.types.get_price_list_file_url_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_price_list_file_url(
