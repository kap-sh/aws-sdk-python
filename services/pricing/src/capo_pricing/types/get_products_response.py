...
class GetProductsResponse(TypedDict, closed=True):
    ...
    price_list: NotRequired[
        "capo_pricing.types.price_list_json_items.PriceListJsonItems"
    ]
...
def serialize_aws_json_1_1(value: GetProductsResponse) -> dict:
    ...
    if "price_list" in value:
        ...
        out["PriceList"] = (
            capo_pricing.types.price_list_json_items.serialize_aws_json_1_1(
                value["price_list"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetProductsResponse:
    ...
    if "PriceList" in data:
        ...
        out["price_list"] = (
            capo_pricing.types.price_list_json_items.deserialize_aws_json_1_1(
                data["PriceList"]
            )
        )
