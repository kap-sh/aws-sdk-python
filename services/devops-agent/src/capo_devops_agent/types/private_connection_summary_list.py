...
if TYPE_CHECKING:
    import capo_devops_agent.types.private_connection_summary

PrivateConnectionSummaryList: TypeAlias = list[
    "capo_devops_agent.types.private_connection_summary.PrivateConnectionSummary"
]
...
def serialize_json(value: PrivateConnectionSummaryList) -> list:
    ...
    for item in value:
        out.append(
            capo_devops_agent.types.private_connection_summary.serialize_json(item)
        )
    return out
