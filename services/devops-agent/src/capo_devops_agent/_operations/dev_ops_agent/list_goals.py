...
import capo_devops_agent.types.goal_list
...
def handle_response(
    ...
    out: capo_devops_agent.types.list_goals_response.ListGoalsResponse = (
        capo_devops_agent.types.list_goals_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.list_goals_request.serialize_json(input_)
    ).encode()
...
def list_goals(
    ...
    capo_devops_agent.types.list_goals_response.ListGoalsResponse, zapros.Response
]:
