...
def handle_response(
    ...
    out: capo_devops_agent.types.list_chats_response.ListChatsResponse = (
        capo_devops_agent.types.list_chats_response.deserialize_json(
...
def list_chats(
    ...
    capo_devops_agent.types.list_chats_response.ListChatsResponse, zapros.Response
]:
