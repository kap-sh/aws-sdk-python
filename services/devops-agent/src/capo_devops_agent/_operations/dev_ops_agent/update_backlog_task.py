"""Generated from Smithy shape ``com.amazonaws.devopsagent#UpdateBacklogTask``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.update_backlog_task_response.UpdateBacklogTaskResponse = capo_devops_agent.types.update_backlog_task_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.update_backlog_task_request.serialize_json(input_)
    ).encode()
