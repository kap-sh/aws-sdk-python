"""Generated from Smithy shape ``com.amazonaws.devopsagent#UpdateAsset``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.update_asset_response.UpdateAssetResponse = (
        capo_devops_agent.types.update_asset_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.update_asset_request.serialize_json(input_)
    ).encode()
...
def update_asset(
    ...
    capo_devops_agent.types.update_asset_response.UpdateAssetResponse, zapros.Response
]:
