"""Generated from Smithy shape ``com.amazonaws.devopsagent#ListAssetTypes``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.list_asset_types_response.ListAssetTypesResponse = (
        capo_devops_agent.types.list_asset_types_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/asset/types"
    params: dict[str, str] = {}
...
async def async_list_asset_types(
