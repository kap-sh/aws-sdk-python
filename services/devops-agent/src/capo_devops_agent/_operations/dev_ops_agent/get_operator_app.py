"""Generated from Smithy shape ``com.amazonaws.devopsagent#GetOperatorApp``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.get_operator_app_output.GetOperatorAppOutput = (
        capo_devops_agent.types.get_operator_app_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/agentspaces/{agentSpaceId}/operator"
...
async def async_get_operator_app(
