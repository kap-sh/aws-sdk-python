"""Generated from Smithy shape ``com.amazonaws.devopsagent#GetBacklogTask``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.get_backlog_task_response.GetBacklogTaskResponse = (
        capo_devops_agent.types.get_backlog_task_response.deserialize_json(
...
async def async_get_backlog_task(
