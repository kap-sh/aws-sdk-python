...
def handle_response(
    ...
    out: capo_devops_agent.types.associate_service_output.AssociateServiceOutput = (
        capo_devops_agent.types.associate_service_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.associate_service_input.serialize_json(input_)
    ).encode()
