...
def handle_response(
    ...
    out: capo_devops_agent.types.list_private_connections_output.ListPrivateConnectionsOutput = capo_devops_agent.types.list_private_connections_output.deserialize_json(
