...
def handle_response(
    ...
    out: capo_devops_agent.types.get_association_output.GetAssociationOutput = (
        capo_devops_agent.types.get_association_output.deserialize_json(
...
def get_association(
    ...
    capo_devops_agent.types.get_association_output.GetAssociationOutput, zapros.Response
]:
