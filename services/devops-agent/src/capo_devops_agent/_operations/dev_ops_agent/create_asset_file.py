"""Generated from Smithy shape ``com.amazonaws.devopsagent#CreateAssetFile``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.create_asset_file_response.CreateAssetFileResponse = (
        capo_devops_agent.types.create_asset_file_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.create_asset_file_request.serialize_json(input_)
    ).encode()
...
async def async_create_asset_file(
