"""Generated from Smithy shape ``com.amazonaws.devopsagent#UpdateAgentSpace``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.update_agent_space_output.UpdateAgentSpaceOutput = (
        capo_devops_agent.types.update_agent_space_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.update_agent_space_input.serialize_json(input_)
    ).encode()
