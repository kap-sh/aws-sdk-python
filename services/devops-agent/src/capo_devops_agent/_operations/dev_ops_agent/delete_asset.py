"""Generated from Smithy shape ``com.amazonaws.devopsagent#DeleteAsset``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.delete_asset_response.DeleteAssetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_asset(
    ...
    capo_devops_agent.types.delete_asset_response.DeleteAssetResponse, zapros.Response
]:
