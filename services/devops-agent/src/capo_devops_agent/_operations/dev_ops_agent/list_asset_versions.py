...
import capo_devops_agent.types.asset_version_metadata_list
...
def handle_response(
    ...
    out: capo_devops_agent.types.list_asset_versions_response.ListAssetVersionsResponse = capo_devops_agent.types.list_asset_versions_response.deserialize_json(
