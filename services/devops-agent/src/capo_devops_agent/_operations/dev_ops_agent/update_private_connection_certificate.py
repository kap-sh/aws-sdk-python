...
def handle_response(
    ...
    out: capo_devops_agent.types.update_private_connection_certificate_output.UpdatePrivateConnectionCertificateOutput = capo_devops_agent.types.update_private_connection_certificate_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.update_private_connection_certificate_input.serialize_json(
            input_
        )
    ).encode()
