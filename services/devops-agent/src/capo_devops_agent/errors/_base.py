...
class DevOpsAgentError(Exception):
    """Base class for all DevOpsAgent service errors."""


class ServiceError(DevOpsAgentError):
...
class SerializationError(DevOpsAgentError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DevOpsAgentError):
...
class WaiterFailedError(DevOpsAgentError):
...
class WaiterTimeoutError(DevOpsAgentError):
