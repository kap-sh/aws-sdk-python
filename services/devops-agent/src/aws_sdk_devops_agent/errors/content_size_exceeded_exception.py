...
class ContentSizeExceededException_(TypedDict):
    message: "str"
...
class ContentSizeExceededException(ServiceError):
    ...
    def __init__(self, data: ContentSizeExceededException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_json(cls, data: dict) -> "ContentSizeExceededException":
