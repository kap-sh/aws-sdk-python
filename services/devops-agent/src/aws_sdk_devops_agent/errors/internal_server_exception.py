"""Generated from Smithy shape ``com.amazonaws.devopsagent#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.devopsagent#InternalServerException``."""
