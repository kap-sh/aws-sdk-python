...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.list_agent_spaces_output.ListAgentSpacesOutput = (
        aws_sdk_devops_agent.types.list_agent_spaces_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.list_agent_spaces_input.ListAgentSpacesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
