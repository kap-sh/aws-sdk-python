...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.get_backlog_task_response.GetBacklogTaskResponse = (
        aws_sdk_devops_agent.types.get_backlog_task_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.get_backlog_task_request.GetBacklogTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
