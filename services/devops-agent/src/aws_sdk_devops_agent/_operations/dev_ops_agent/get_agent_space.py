"""Generated from Smithy shape ``com.amazonaws.devopsagent#GetAgentSpace``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.get_agent_space_output.GetAgentSpaceOutput = (
        aws_sdk_devops_agent.types.get_agent_space_output.deserialize_json(
