...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.describe_private_connection_output.DescribePrivateConnectionOutput = aws_sdk_devops_agent.types.describe_private_connection_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.describe_private_connection_input.DescribePrivateConnectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
