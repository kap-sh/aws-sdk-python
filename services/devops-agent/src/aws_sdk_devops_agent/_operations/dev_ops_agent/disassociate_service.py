"""Generated from Smithy shape ``com.amazonaws.devopsagent#DisassociateService``."""
...
if TYPE_CHECKING:
    import aws_sdk_devops_agent.types.disassociate_service_input
    import aws_sdk_devops_agent.types.disassociate_service_output
...
) -> aws_sdk_devops_agent.types.disassociate_service_output.DisassociateServiceOutput:
    out: aws_sdk_devops_agent.types.disassociate_service_output.DisassociateServiceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.disassociate_service_input.DisassociateServiceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_disassociate_service(
