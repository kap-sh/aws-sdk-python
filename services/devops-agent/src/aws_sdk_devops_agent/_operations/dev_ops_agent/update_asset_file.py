...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.update_asset_file_request.UpdateAssetFileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.update_asset_file_request.serialize_json(input)
    ).encode()
