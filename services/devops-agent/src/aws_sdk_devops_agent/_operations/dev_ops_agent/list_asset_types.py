...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.list_asset_types_response.ListAssetTypesResponse = (
        aws_sdk_devops_agent.types.list_asset_types_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.list_asset_types_request.ListAssetTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
