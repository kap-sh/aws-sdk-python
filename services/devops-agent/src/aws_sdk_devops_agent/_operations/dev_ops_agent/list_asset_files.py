...
import aws_sdk_devops_agent.types.asset_file_summary_list
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.list_asset_files_response.ListAssetFilesResponse = (
        aws_sdk_devops_agent.types.list_asset_files_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.list_asset_files_request.ListAssetFilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
