"""Generated from Smithy shape ``com.amazonaws.devopsagent#UpdatePrivateConnectionCertificate``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.update_private_connection_certificate_output.UpdatePrivateConnectionCertificateOutput = aws_sdk_devops_agent.types.update_private_connection_certificate_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.update_private_connection_certificate_input.UpdatePrivateConnectionCertificateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/private-connections/{name}/certificate"
...
async def async_update_private_connection_certificate(
