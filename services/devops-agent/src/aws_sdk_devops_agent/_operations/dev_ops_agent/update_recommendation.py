...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.update_recommendation_request.UpdateRecommendationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.update_recommendation_request.serialize_json(input_)
    ).encode()
