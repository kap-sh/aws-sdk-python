...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.update_recommendation_response.UpdateRecommendationResponse = aws_sdk_devops_agent.types.update_recommendation_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.update_recommendation_request.UpdateRecommendationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.update_recommendation_request.serialize_json(input)
    ).encode()
