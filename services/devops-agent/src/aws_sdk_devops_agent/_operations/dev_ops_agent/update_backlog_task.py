...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.update_backlog_task_response.UpdateBacklogTaskResponse = aws_sdk_devops_agent.types.update_backlog_task_response.deserialize_json(
