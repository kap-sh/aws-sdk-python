"""Generated from Smithy shape ``com.amazonaws.devopsagent#UpdateAssociation``."""
...
if TYPE_CHECKING:
    import aws_sdk_devops_agent.types.update_association_input
    import aws_sdk_devops_agent.types.update_association_output
...
) -> aws_sdk_devops_agent.types.update_association_output.UpdateAssociationOutput:
    import aws_sdk_devops_agent.types.update_association_output

    out: aws_sdk_devops_agent.types.update_association_output.UpdateAssociationOutput = aws_sdk_devops_agent.types.update_association_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.update_association_input.UpdateAssociationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.update_association_input.serialize_json(input_)
    ).encode()
