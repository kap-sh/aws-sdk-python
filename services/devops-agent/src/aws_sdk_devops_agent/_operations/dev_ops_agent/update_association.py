...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.update_association_input.UpdateAssociationInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.update_association_input.serialize_json(input)
    ).encode()
