...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.list_recommendations_response.ListRecommendationsResponse = aws_sdk_devops_agent.types.list_recommendations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.list_recommendations_request.ListRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.list_recommendations_request.serialize_json(input_)
    ).encode()
