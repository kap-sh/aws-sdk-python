...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.list_recommendations_request.ListRecommendationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.list_recommendations_request.serialize_json(input)
    ).encode()
