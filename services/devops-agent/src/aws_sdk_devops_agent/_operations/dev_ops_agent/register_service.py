...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.register_service_output.RegisterServiceOutput = (
        aws_sdk_devops_agent.types.register_service_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.register_service_input.RegisterServiceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.register_service_input.serialize_json(input_)
    ).encode()
