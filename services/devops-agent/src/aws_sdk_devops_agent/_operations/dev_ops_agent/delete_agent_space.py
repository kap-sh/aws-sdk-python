...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.delete_agent_space_output.DeleteAgentSpaceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.delete_agent_space_input.DeleteAgentSpaceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
