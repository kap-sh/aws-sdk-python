...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.list_services_output.ListServicesOutput = (
        aws_sdk_devops_agent.types.list_services_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.list_services_input.ListServicesInput,
) -> zapros.Request:
    ...
    if "filter_service_type" in input:
        params["filterServiceType"] = str(input["filter_service_type"])
...
def list_services(
    ...
    aws_sdk_devops_agent.types.list_services_output.ListServicesOutput, zapros.Response
]:
