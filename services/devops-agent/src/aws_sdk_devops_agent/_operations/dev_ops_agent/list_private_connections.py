"""Generated from Smithy shape ``com.amazonaws.devopsagent#ListPrivateConnections``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.list_private_connections_output.ListPrivateConnectionsOutput = aws_sdk_devops_agent.types.list_private_connections_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.list_private_connections_input.ListPrivateConnectionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/private-connections"
    params: dict[str, str] = {}
...
async def async_list_private_connections(
