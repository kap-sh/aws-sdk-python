"""Generated from Smithy shape ``com.amazonaws.devopsagent#ListPendingMessages``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.list_pending_messages_response.ListPendingMessagesResponse = aws_sdk_devops_agent.types.list_pending_messages_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.list_pending_messages_request.ListPendingMessagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/agents/agent-space/{agentSpaceId}/pendingMessages"
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.list_pending_messages_request.serialize_json(input_)
    ).encode()
...
async def async_list_pending_messages(
