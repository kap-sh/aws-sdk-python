...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.list_pending_messages_request.ListPendingMessagesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.list_pending_messages_request.serialize_json(input)
    ).encode()
