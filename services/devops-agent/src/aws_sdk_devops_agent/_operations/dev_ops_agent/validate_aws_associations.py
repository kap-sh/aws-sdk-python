"""Generated from Smithy shape ``com.amazonaws.devopsagent#ValidateAwsAssociations``."""
...
if TYPE_CHECKING:
    import aws_sdk_devops_agent.types.validate_aws_associations_input
    import aws_sdk_devops_agent.types.validate_aws_associations_output
...
) -> aws_sdk_devops_agent.types.validate_aws_associations_output.ValidateAwsAssociationsOutput:
    out: aws_sdk_devops_agent.types.validate_aws_associations_output.ValidateAwsAssociationsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.validate_aws_associations_input.ValidateAwsAssociationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_validate_aws_associations(
