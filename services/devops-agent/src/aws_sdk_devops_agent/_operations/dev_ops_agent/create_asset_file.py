...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.create_asset_file_response.CreateAssetFileResponse = aws_sdk_devops_agent.types.create_asset_file_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.create_asset_file_request.CreateAssetFileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.create_asset_file_request.serialize_json(input_)
    ).encode()
