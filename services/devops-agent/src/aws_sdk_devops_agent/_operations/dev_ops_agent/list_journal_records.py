"""Generated from Smithy shape ``com.amazonaws.devopsagent#ListJournalRecords``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.list_journal_records_response.ListJournalRecordsResponse = aws_sdk_devops_agent.types.list_journal_records_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.list_journal_records_request.ListJournalRecordsRequest,
) -> zapros.Request:
    ...
    url = (
        endpoint.url.rstrip("/") + "/journal/agent-space/{agentSpaceId}/journalRecords"
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.list_journal_records_request.serialize_json(input)
    ).encode()
...
async def async_list_journal_records(
