...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.delete_asset_file_response.DeleteAssetFileResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.delete_asset_file_request.DeleteAssetFileRequest,
) -> zapros.Request:
