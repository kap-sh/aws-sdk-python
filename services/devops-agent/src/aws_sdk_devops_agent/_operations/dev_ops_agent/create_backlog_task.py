...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.create_backlog_task_request.CreateBacklogTaskRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.create_backlog_task_request.serialize_json(input)
    ).encode()
