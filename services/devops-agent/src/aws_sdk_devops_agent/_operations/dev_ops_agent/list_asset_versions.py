"""Generated from Smithy shape ``com.amazonaws.devopsagent#ListAssetVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.list_asset_versions_response.ListAssetVersionsResponse = aws_sdk_devops_agent.types.list_asset_versions_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.list_asset_versions_request.ListAssetVersionsRequest,
) -> zapros.Request:
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/asset/agent-space/{agentSpaceId}/assets/{assetId}/versions"
    )
...
async def async_list_asset_versions(
