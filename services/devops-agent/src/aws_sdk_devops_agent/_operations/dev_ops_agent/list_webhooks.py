"""Generated from Smithy shape ``com.amazonaws.devopsagent#ListWebhooks``."""
...
if TYPE_CHECKING:
    import aws_sdk_devops_agent.types.list_webhooks_input
    import aws_sdk_devops_agent.types.list_webhooks_output
...
) -> aws_sdk_devops_agent.types.list_webhooks_output.ListWebhooksOutput:
    import aws_sdk_devops_agent.types.list_webhooks_output

    out: aws_sdk_devops_agent.types.list_webhooks_output.ListWebhooksOutput = (
        aws_sdk_devops_agent.types.list_webhooks_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.list_webhooks_input.ListWebhooksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_webhooks(
    ...
    aws_sdk_devops_agent.types.list_webhooks_output.ListWebhooksOutput, zapros.Response
]:
