"""Generated from Smithy shape ``com.amazonaws.devopsagent#ListChats``."""
...
import aws_sdk_devops_agent.types.chat_execution_list
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.list_chats_response.ListChatsResponse = (
        aws_sdk_devops_agent.types.list_chats_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.list_chats_request.ListChatsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/agents/agent-space/{agentSpaceId}/chat/list"
...
def list_chats(
    ...
    aws_sdk_devops_agent.types.list_chats_response.ListChatsResponse, zapros.Response
]:
