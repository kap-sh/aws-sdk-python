"""Generated from Smithy shape ``com.amazonaws.devopsagent#DeletePrivateConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.delete_private_connection_output.DeletePrivateConnectionOutput = aws_sdk_devops_agent.types.delete_private_connection_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.delete_private_connection_input.DeletePrivateConnectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/private-connections/{name}"
...
async def async_delete_private_connection(
