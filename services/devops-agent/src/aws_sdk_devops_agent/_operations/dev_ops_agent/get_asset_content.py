"""Generated from Smithy shape ``com.amazonaws.devopsagent#GetAssetContent``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.get_asset_content_response.GetAssetContentResponse = aws_sdk_devops_agent.types.get_asset_content_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.get_asset_content_request.GetAssetContentRequest,
) -> zapros.Request:
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/asset/agent-space/{agentSpaceId}/assets/{assetId}/content"
    )
...
async def async_get_asset_content(
