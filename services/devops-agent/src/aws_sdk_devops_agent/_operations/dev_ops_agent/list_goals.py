"""Generated from Smithy shape ``com.amazonaws.devopsagent#ListGoals``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.list_goals_response.ListGoalsResponse = (
        aws_sdk_devops_agent.types.list_goals_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.list_goals_request.ListGoalsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/backlog/agent-space/{agentSpaceId}/goals/list"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.list_goals_request.serialize_json(input_)
    ).encode()
...
def list_goals(
    ...
    aws_sdk_devops_agent.types.list_goals_response.ListGoalsResponse, zapros.Response
]:
