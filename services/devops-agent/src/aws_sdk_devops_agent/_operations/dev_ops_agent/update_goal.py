...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.update_goal_response.UpdateGoalResponse = (
        aws_sdk_devops_agent.types.update_goal_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.update_goal_request.UpdateGoalRequest,
) -> zapros.Request:
    ...
    url = url.replace("{goalId}", quote(str(input["goal_id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_devops_agent.types.update_goal_request

    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.update_goal_request.serialize_json(input)
    ).encode()
...
def update_goal(
    ...
    aws_sdk_devops_agent.types.update_goal_response.UpdateGoalResponse, zapros.Response
]:
