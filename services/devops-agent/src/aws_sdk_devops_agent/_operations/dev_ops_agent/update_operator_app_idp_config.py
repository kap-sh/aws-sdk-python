"""Generated from Smithy shape ``com.amazonaws.devopsagent#UpdateOperatorAppIdpConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.update_operator_app_idp_config_output.UpdateOperatorAppIdpConfigOutput = aws_sdk_devops_agent.types.update_operator_app_idp_config_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.update_operator_app_idp_config_input.UpdateOperatorAppIdpConfigInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/agentspaces/{agentSpaceId}/operator/idp"
...
async def async_update_operator_app_idp_config(
