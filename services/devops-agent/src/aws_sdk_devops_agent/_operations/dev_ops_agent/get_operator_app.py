...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.get_operator_app_output.GetOperatorAppOutput = (
        aws_sdk_devops_agent.types.get_operator_app_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.get_operator_app_input.GetOperatorAppInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
