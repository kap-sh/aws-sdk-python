...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.disable_operator_app_input.DisableOperatorAppInput,
) -> zapros.Request:
    ...
    if "auth_flow" in input:
        headers["x-amzn-app-auth-flow"] = str(input["auth_flow"])
    body: bytes | None = b""
