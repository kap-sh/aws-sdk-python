...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IdentityCenterServiceException":
            import aws_sdk_devops_agent.errors.identity_center_service_exception

            raise aws_sdk_devops_agent.errors.identity_center_service_exception.IdentityCenterServiceException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.enable_operator_app_output.EnableOperatorAppOutput = aws_sdk_devops_agent.types.enable_operator_app_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.enable_operator_app_input.EnableOperatorAppInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.enable_operator_app_input.serialize_json(input_)
    ).encode()
