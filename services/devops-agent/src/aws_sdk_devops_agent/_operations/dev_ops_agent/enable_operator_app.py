...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.enable_operator_app_input.EnableOperatorAppInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.enable_operator_app_input.serialize_json(input)
    ).encode()
