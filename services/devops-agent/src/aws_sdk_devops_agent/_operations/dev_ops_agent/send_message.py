...
from aws_sdk_devops_agent._protocol.eventstream import (
    MessageDecoder,
...
def handle_response(
    ...
    _union_deser = aws_sdk_devops_agent.types.send_message_events.deserialize_event_json
    _iter = cast(Any, response.iter_bytes())
    out: aws_sdk_devops_agent.types.send_message_response.SendMessageResponse = {
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.send_message_request.SendMessageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.send_message_request.serialize_json(input_)
    ).encode()
