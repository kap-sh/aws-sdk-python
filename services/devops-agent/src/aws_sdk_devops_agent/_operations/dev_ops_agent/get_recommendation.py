...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.get_recommendation_response.GetRecommendationResponse = aws_sdk_devops_agent.types.get_recommendation_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.get_recommendation_request.GetRecommendationRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{recommendationId}", quote(str(input["recommendation_id"]), safe="")
    )
    params: dict[str, str] = {}
    if "recommendation_version" in input:
        params["recommendationVersion"] = str(input["recommendation_version"])
