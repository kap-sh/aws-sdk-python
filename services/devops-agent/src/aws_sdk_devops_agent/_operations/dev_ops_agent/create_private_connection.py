...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.create_private_connection_output.CreatePrivateConnectionOutput = aws_sdk_devops_agent.types.create_private_connection_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.create_private_connection_input.CreatePrivateConnectionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.create_private_connection_input.serialize_json(input)
    ).encode()
