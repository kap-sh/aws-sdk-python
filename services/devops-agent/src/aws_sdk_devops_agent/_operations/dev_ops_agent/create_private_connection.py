...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.create_private_connection_input.CreatePrivateConnectionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.create_private_connection_input.serialize_json(
            input_
        )
    ).encode()
