"""Generated from Smithy shape ``com.amazonaws.devopsagent#GetAssociation``."""
...
import aws_sdk_devops_agent.types.get_association_input
import aws_sdk_devops_agent.types.get_association_output
...
) -> aws_sdk_devops_agent.types.get_association_output.GetAssociationOutput:
    out: aws_sdk_devops_agent.types.get_association_output.GetAssociationOutput = (
        aws_sdk_devops_agent.types.get_association_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.get_association_input.GetAssociationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_association(
