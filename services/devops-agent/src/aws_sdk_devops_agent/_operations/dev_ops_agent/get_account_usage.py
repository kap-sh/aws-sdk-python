"""Generated from Smithy shape ``com.amazonaws.devopsagent#GetAccountUsage``."""
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.get_account_usage_input.GetAccountUsageInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/usage/account"
    params: dict[str, str] = {}
...
async def async_get_account_usage(
