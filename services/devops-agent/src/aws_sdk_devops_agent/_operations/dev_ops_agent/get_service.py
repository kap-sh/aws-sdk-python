...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.get_service_output.GetServiceOutput = (
        aws_sdk_devops_agent.types.get_service_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.get_service_input.GetServiceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_service(
    ...
    aws_sdk_devops_agent.types.get_service_output.GetServiceOutput, zapros.Response
]:
