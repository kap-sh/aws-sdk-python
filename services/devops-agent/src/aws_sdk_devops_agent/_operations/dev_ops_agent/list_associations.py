...
if TYPE_CHECKING:
    import aws_sdk_devops_agent.types.list_associations_input
    import aws_sdk_devops_agent.types.list_associations_output
...
) -> aws_sdk_devops_agent.types.list_associations_output.ListAssociationsOutput:
    import aws_sdk_devops_agent.types.list_associations_output

    out: aws_sdk_devops_agent.types.list_associations_output.ListAssociationsOutput = (
        aws_sdk_devops_agent.types.list_associations_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.list_associations_input.ListAssociationsInput,
) -> zapros.Request:
    ...
    if "filter_service_types" in input:
        params["filterServiceTypes"] = str(input["filter_service_types"])
