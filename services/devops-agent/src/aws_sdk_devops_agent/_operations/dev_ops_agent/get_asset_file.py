"""Generated from Smithy shape ``com.amazonaws.devopsagent#GetAssetFile``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.get_asset_file_response.GetAssetFileResponse = (
        aws_sdk_devops_agent.types.get_asset_file_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.get_asset_file_request.GetAssetFileRequest,
) -> zapros.Request:
...
async def async_get_asset_file(
