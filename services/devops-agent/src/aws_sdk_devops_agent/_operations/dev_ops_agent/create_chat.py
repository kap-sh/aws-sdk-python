"""Generated from Smithy shape ``com.amazonaws.devopsagent#CreateChat``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.create_chat_response.CreateChatResponse = (
        aws_sdk_devops_agent.types.create_chat_response.deserialize_json(
