...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.delete_asset_response.DeleteAssetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.delete_asset_request.DeleteAssetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
