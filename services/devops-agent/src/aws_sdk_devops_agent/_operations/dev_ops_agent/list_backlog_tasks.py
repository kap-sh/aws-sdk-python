"""Generated from Smithy shape ``com.amazonaws.devopsagent#ListBacklogTasks``."""
...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.list_backlog_tasks_response.ListBacklogTasksResponse = aws_sdk_devops_agent.types.list_backlog_tasks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_devops_agent.types.list_backlog_tasks_request.ListBacklogTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/backlog/agent-space/{agentSpaceId}/tasks/list"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.list_backlog_tasks_request.serialize_json(input_)
    ).encode()
...
async def async_list_backlog_tasks(
