...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.list_backlog_tasks_request.ListBacklogTasksRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_devops_agent.types.list_backlog_tasks_request.serialize_json(input)
    ).encode()
