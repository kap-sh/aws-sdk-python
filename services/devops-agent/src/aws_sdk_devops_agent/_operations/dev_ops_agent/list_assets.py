...
def handle_response(
    ...
    out: aws_sdk_devops_agent.types.list_assets_response.ListAssetsResponse = (
        aws_sdk_devops_agent.types.list_assets_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_devops_agent.types.list_assets_request.ListAssetsRequest,
) -> zapros.Request:
    ...
    if "updated_after" in input:
        params["updatedAfter"] = str(input["updated_after"])
    if "updated_before" in input:
        params["updatedBefore"] = str(input["updated_before"])
...
def list_assets(
    ...
    aws_sdk_devops_agent.types.list_assets_response.ListAssetsResponse, zapros.Response
]:
