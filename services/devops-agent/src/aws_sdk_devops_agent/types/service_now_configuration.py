...
class ServiceNowConfiguration(TypedDict, closed=True):
    ...
    auth_scopes: NotRequired[
        "aws_sdk_devops_agent.types.service_now_authentication_scope_list.ServiceNowAuthenticationScopeList"
    ]
...
def serialize_json(value: ServiceNowConfiguration) -> dict:
    ...
    if "auth_scopes" in value:
        ...
        out["authScopes"] = (
            aws_sdk_devops_agent.types.service_now_authentication_scope_list.serialize_json(
                value["auth_scopes"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ServiceNowConfiguration:
    ...
    if "authScopes" in data:
        ...
        out["auth_scopes"] = (
            aws_sdk_devops_agent.types.service_now_authentication_scope_list.deserialize_json(
                data["authScopes"]
            )
        )
    return out
