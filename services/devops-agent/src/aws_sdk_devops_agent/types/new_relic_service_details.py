...
if TYPE_CHECKING:
    import aws_sdk_devops_agent.types.new_relic_service_authorization_config


class NewRelicServiceDetails(TypedDict):
    authorization_config: "aws_sdk_devops_agent.types.new_relic_service_authorization_config.NewRelicServiceAuthorizationConfig"
...
def serialize_json(value: NewRelicServiceDetails) -> dict:
    ...
    out["authorizationConfig"] = (
        aws_sdk_devops_agent.types.new_relic_service_authorization_config.serialize_json(
...
def deserialize_json(data: dict) -> NewRelicServiceDetails:
    ...
    if "authorizationConfig" in data:
        ...
        out["authorization_config"] = (
            aws_sdk_devops_agent.types.new_relic_service_authorization_config.deserialize_json(
