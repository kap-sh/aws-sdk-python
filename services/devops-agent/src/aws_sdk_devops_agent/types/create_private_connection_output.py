"""Generated from Smithy shape ``com.amazonaws.devopsagent#CreatePrivateConnectionOutput``."""
...
class CreatePrivateConnectionOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreatePrivateConnectionOutput) -> dict:
    out: dict = {}
    out["name"] = value["name"]
    import aws_sdk_devops_agent.types.private_connection_type
...
def deserialize_json(data: dict) -> CreatePrivateConnectionOutput:
    out: CreatePrivateConnectionOutput = {}  # type: ignore[typeddict-item]
    if "name" in data:
        out["name"] = data["name"]
    else:
        raise DeserializationError("CreatePrivateConnectionOutput.name required")
    if "type" in data:
        import aws_sdk_devops_agent.types.private_connection_type
        ...
        raise DeserializationError("CreatePrivateConnectionOutput.type required")
    ...
    if "status" in data:
        ...
        raise DeserializationError("CreatePrivateConnectionOutput.status required")
