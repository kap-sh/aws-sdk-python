...
if TYPE_CHECKING:
    ...
    import aws_sdk_devops_agent.types.mcp_server_sig_v4_authorization_config


class MCPServerSigV4ServiceDetails(TypedDict):
    ...
    authorization_config: "aws_sdk_devops_agent.types.mcp_server_sig_v4_authorization_config.MCPServerSigV4AuthorizationConfig"
...
def serialize_json(value: MCPServerSigV4ServiceDetails) -> dict:
    ...
    out["authorizationConfig"] = (
        aws_sdk_devops_agent.types.mcp_server_sig_v4_authorization_config.serialize_json(
...
def deserialize_json(data: dict) -> MCPServerSigV4ServiceDetails:
    ...
    if "authorizationConfig" in data:
        ...
        out["authorization_config"] = (
            aws_sdk_devops_agent.types.mcp_server_sig_v4_authorization_config.deserialize_json(
