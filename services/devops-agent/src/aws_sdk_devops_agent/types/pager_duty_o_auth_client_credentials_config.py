"""Generated from Smithy shape ``com.amazonaws.devopsagent#PagerDutyOAuthClientCredentialsConfig``."""
...
class PagerDutyOAuthClientCredentialsConfig(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: PagerDutyOAuthClientCredentialsConfig) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> PagerDutyOAuthClientCredentialsConfig:
    ...
    if "clientSecret" in data:
        ...
        raise DeserializationError(
            "PagerDutyOAuthClientCredentialsConfig.client_secret required"
        )
    return out
