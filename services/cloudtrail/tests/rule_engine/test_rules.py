...
from aws_sdk_cloudtrail._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_for_region_af_south_1_with_fips_disabled():
    ...
    assert result.url == 'https://cloudtrail.af-south-1.amazonaws.com'
...
def test_for_region_ap_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.ap-east-1.amazonaws.com'
...
def test_for_region_ap_northeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.ap-northeast-1.amazonaws.com'
...
def test_for_region_ap_northeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.ap-northeast-2.amazonaws.com'
...
def test_for_region_ap_northeast_3_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.ap-northeast-3.amazonaws.com'
...
def test_for_region_ap_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.ap-south-1.amazonaws.com'
...
def test_for_region_ap_southeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.ap-southeast-1.amazonaws.com'
...
def test_for_region_ap_southeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.ap-southeast-2.amazonaws.com'
...
def test_for_region_ap_southeast_3_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.ap-southeast-3.amazonaws.com'
...
def test_for_region_ca_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.ca-central-1.amazonaws.com'
...
def test_for_region_eu_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.eu-central-1.amazonaws.com'
...
def test_for_region_eu_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.eu-north-1.amazonaws.com'
...
def test_for_region_eu_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.eu-south-1.amazonaws.com'
...
def test_for_region_eu_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.eu-west-1.amazonaws.com'
...
def test_for_region_eu_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.eu-west-2.amazonaws.com'
...
def test_for_region_eu_west_3_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.eu-west-3.amazonaws.com'
...
def test_for_region_me_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.me-south-1.amazonaws.com'
...
def test_for_region_sa_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.sa-east-1.amazonaws.com'
...
def test_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.us-east-1.amazonaws.com'
...
def test_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail-fips.us-east-1.amazonaws.com'
...
def test_for_region_us_east_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.us-east-2.amazonaws.com'
...
def test_for_region_us_east_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail-fips.us-east-2.amazonaws.com'
...
def test_for_region_us_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.us-west-1.amazonaws.com'
...
def test_for_region_us_west_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail-fips.us-west-1.amazonaws.com'
...
def test_for_region_us_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.us-west-2.amazonaws.com'
...
def test_for_region_us_west_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail-fips.us-west-2.amazonaws.com'

def test_for_region_us_east_1_with_fips_enabled_a():
    """For region us-east-1 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://cloudtrail-fips.us-east-1.api.aws'

def test_for_region_us_east_1_with_fips_disabled_():
    """For region us-east-1 with FIPS disabled and DualStack enabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://cloudtrail.us-east-1.api.aws'
...
def test_for_region_cn_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.cn-north-1.amazonaws.com.cn'
...
def test_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.cn-northwest-1.amazonaws.com.cn'
...
def test_for_region_cn_north_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail-fips.cn-north-1.api.amazonwebservices.com.cn'

def test_for_region_cn_north_1_with_fips_enabled_():
    """For region cn-north-1 with FIPS enabled and DualStack disabled"""
    params = EndpointParams(Region='cn-north-1', UseFIPS=True, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://cloudtrail-fips.cn-north-1.amazonaws.com.cn'

def test_for_region_cn_north_1_with_fips_disabled():
    """For region cn-north-1 with FIPS disabled and DualStack enabled"""
    params = EndpointParams(Region='cn-north-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://cloudtrail.cn-north-1.api.amazonwebservices.com.cn'
...
def test_for_region_us_gov_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.us-gov-east-1.amazonaws.com'
...
def test_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.us-gov-west-1.amazonaws.com'
...
def test_for_region_us_gov_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail-fips.us-gov-east-1.api.aws'

def test_for_region_us_gov_east_1_with_fips_disab():
    """For region us-gov-east-1 with FIPS disabled and DualStack enabled"""
    params = EndpointParams(Region='us-gov-east-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://cloudtrail.us-gov-east-1.api.aws'
...
def test_for_region_us_iso_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.us-iso-east-1.c2s.ic.gov'
...
def test_for_region_us_iso_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.us-iso-west-1.c2s.ic.gov'
...
def test_for_region_us_iso_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail-fips.us-iso-east-1.c2s.ic.gov'
...
def test_for_region_us_isob_east_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail.us-isob-east-1.sc2s.sgov.gov'
...
def test_for_region_us_isob_east_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://cloudtrail-fips.us-isob-east-1.sc2s.sgov.gov'
