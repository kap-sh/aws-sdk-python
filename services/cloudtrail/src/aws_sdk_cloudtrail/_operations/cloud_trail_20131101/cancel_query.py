...
import aws_sdk_cloudtrail.errors.inactive_query_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InactiveQueryException":
            raise aws_sdk_cloudtrail.errors.inactive_query_exception.InactiveQueryException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.cancel_query_response.CancelQueryResponse = (
        aws_sdk_cloudtrail.types.cancel_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.cancel_query_request.CancelQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.cancel_query_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def cancel_query(
    ...
    aws_sdk_cloudtrail.types.cancel_query_response.CancelQueryResponse, zapros.Response
]:
