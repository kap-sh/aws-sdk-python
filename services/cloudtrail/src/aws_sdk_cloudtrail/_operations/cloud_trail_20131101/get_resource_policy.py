...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourcePolicyNotFoundException":
            import aws_sdk_cloudtrail.errors.resource_policy_not_found_exception

            raise aws_sdk_cloudtrail.errors.resource_policy_not_found_exception.ResourcePolicyNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.get_resource_policy_response.GetResourcePolicyResponse = aws_sdk_cloudtrail.types.get_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.get_resource_policy_request.GetResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.get_resource_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
