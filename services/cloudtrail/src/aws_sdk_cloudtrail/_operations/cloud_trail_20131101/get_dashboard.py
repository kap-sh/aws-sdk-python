...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.get_dashboard_response.GetDashboardResponse = (
        aws_sdk_cloudtrail.types.get_dashboard_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.get_dashboard_request.GetDashboardRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.get_dashboard_request.serialize_aws_json_1_1(input_)
    ).encode()
