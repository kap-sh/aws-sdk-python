...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.put_event_configuration_response.PutEventConfigurationResponse = aws_sdk_cloudtrail.types.put_event_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.put_event_configuration_request.PutEventConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.put_event_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
