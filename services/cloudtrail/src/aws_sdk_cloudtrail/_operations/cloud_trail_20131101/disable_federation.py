...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.disable_federation_response.DisableFederationResponse = aws_sdk_cloudtrail.types.disable_federation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.disable_federation_request.DisableFederationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.disable_federation_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
