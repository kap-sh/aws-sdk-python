...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.list_trails_response.ListTrailsResponse = (
        aws_sdk_cloudtrail.types.list_trails_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.list_trails_request.ListTrailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.list_trails_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_trails(
    ...
    aws_sdk_cloudtrail.types.list_trails_response.ListTrailsResponse, zapros.Response
]:
