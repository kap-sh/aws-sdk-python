...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.update_trail_response.UpdateTrailResponse = (
        aws_sdk_cloudtrail.types.update_trail_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.update_trail_request.UpdateTrailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.update_trail_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_trail(
    ...
    aws_sdk_cloudtrail.types.update_trail_response.UpdateTrailResponse, zapros.Response
]:
