...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.restore_event_data_store_response.RestoreEventDataStoreResponse = aws_sdk_cloudtrail.types.restore_event_data_store_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.restore_event_data_store_request.RestoreEventDataStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.restore_event_data_store_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
