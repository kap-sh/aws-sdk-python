"""Generated from Smithy shape ``com.amazonaws.cloudtrail#StartDashboardRefresh``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_cloudtrail.errors.service_quota_exceeded_exception

            raise aws_sdk_cloudtrail.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.start_dashboard_refresh_response.StartDashboardRefreshResponse = aws_sdk_cloudtrail.types.start_dashboard_refresh_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.start_dashboard_refresh_request.StartDashboardRefreshRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.StartDashboardRefresh"
    import aws_sdk_cloudtrail.types.start_dashboard_refresh_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.start_dashboard_refresh_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_dashboard_refresh(
