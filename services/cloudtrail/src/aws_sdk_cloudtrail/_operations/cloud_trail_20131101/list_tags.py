...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.list_tags_response.ListTagsResponse = (
        aws_sdk_cloudtrail.types.list_tags_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.list_tags_request.ListTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.list_tags_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_tags(
    ...
    aws_sdk_cloudtrail.types.list_tags_response.ListTagsResponse, zapros.Response
]:
