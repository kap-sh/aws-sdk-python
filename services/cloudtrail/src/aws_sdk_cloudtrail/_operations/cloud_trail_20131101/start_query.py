...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.start_query_request.StartQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.start_query_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_query(
    ...
    aws_sdk_cloudtrail.types.start_query_response.StartQueryResponse, zapros.Response
]:
