...
def build_request(
    ...
    input: aws_sdk_cloudtrail.types.list_public_keys_request.ListPublicKeysRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.list_public_keys_request.serialize_aws_json_1_1(input)
    ).encode()
