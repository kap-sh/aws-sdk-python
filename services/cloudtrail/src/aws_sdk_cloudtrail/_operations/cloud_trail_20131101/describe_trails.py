...
def build_request(
    ...
    input: aws_sdk_cloudtrail.types.describe_trails_request.DescribeTrailsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.describe_trails_request.serialize_aws_json_1_1(input)
    ).encode()
