...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.describe_trails_request.DescribeTrailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.describe_trails_request.serialize_aws_json_1_1(input_)
    ).encode()
