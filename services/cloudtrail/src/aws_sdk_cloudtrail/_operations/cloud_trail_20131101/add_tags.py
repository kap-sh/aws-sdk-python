...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.add_tags_request.AddTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.add_tags_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def add_tags(
    ...
    input_: aws_sdk_cloudtrail.types.add_tags_request.AddTagsRequest,
) -> tuple[aws_sdk_cloudtrail.types.add_tags_response.AddTagsResponse, zapros.Response]:
