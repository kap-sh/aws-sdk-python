"""Generated from Smithy shape ``com.amazonaws.cloudtrail#UpdateChannel``."""
...
import aws_sdk_cloudtrail.errors.channel_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ChannelAlreadyExistsException":
            raise aws_sdk_cloudtrail.errors.channel_already_exists_exception.ChannelAlreadyExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.update_channel_response.UpdateChannelResponse = (
        aws_sdk_cloudtrail.types.update_channel_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.update_channel_request.UpdateChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.UpdateChannel"
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.update_channel_request.serialize_aws_json_1_1(input_)
    ).encode()
