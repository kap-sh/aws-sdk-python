...
def build_request(
    ...
    input: aws_sdk_cloudtrail.types.update_channel_request.UpdateChannelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.update_channel_request.serialize_aws_json_1_1(input)
    ).encode()
