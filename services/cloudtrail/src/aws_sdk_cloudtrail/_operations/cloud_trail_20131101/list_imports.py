...
import aws_sdk_cloudtrail.types.imports_list
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.list_imports_response.ListImportsResponse = (
        aws_sdk_cloudtrail.types.list_imports_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.list_imports_request.ListImportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.list_imports_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_imports(
    ...
    aws_sdk_cloudtrail.types.list_imports_response.ListImportsResponse, zapros.Response
]:
