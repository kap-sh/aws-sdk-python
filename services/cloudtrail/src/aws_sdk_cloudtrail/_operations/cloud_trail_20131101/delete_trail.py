...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.delete_trail_response.DeleteTrailResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.delete_trail_request.DeleteTrailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.delete_trail_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_trail(
    ...
    aws_sdk_cloudtrail.types.delete_trail_response.DeleteTrailResponse, zapros.Response
]:
