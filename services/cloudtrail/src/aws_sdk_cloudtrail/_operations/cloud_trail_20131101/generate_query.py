...
def build_request(
    ...
    input: aws_sdk_cloudtrail.types.generate_query_request.GenerateQueryRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.generate_query_request.serialize_aws_json_1_1(input)
    ).encode()
