"""Generated from Smithy shape ``com.amazonaws.cloudtrail#GenerateQuery``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "GenerateResponseException":
            import aws_sdk_cloudtrail.errors.generate_response_exception

            raise aws_sdk_cloudtrail.errors.generate_response_exception.GenerateResponseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.generate_query_response.GenerateQueryResponse = (
        aws_sdk_cloudtrail.types.generate_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.generate_query_request.GenerateQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.GenerateQuery"
    import aws_sdk_cloudtrail.types.generate_query_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.generate_query_request.serialize_aws_json_1_1(input_)
    ).encode()
