...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.get_event_data_store_response.GetEventDataStoreResponse = aws_sdk_cloudtrail.types.get_event_data_store_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.get_event_data_store_request.GetEventDataStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.get_event_data_store_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
