"""Generated from Smithy shape ``com.amazonaws.cloudtrail#ListChannels``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.list_channels_response.ListChannelsResponse = (
        aws_sdk_cloudtrail.types.list_channels_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.list_channels_request.ListChannelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.ListChannels"
    import aws_sdk_cloudtrail.types.list_channels_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.list_channels_request.serialize_aws_json_1_1(input_)
    ).encode()
