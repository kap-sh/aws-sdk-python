...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.deregister_organization_delegated_admin_request.DeregisterOrganizationDelegatedAdminRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.deregister_organization_delegated_admin_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
