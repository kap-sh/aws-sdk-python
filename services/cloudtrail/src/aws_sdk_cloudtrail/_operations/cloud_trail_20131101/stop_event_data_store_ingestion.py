...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.stop_event_data_store_ingestion_response.StopEventDataStoreIngestionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.stop_event_data_store_ingestion_request.StopEventDataStoreIngestionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.stop_event_data_store_ingestion_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
