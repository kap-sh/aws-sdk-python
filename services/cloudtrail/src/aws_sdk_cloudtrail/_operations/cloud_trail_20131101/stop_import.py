...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.stop_import_response.StopImportResponse = (
        aws_sdk_cloudtrail.types.stop_import_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.stop_import_request.StopImportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.stop_import_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def stop_import(
    ...
    aws_sdk_cloudtrail.types.stop_import_response.StopImportResponse, zapros.Response
]:
