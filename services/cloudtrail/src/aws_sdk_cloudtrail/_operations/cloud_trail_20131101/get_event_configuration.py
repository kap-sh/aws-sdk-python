"""Generated from Smithy shape ``com.amazonaws.cloudtrail#GetEventConfiguration``."""
...
import aws_sdk_cloudtrail.errors.invalid_event_data_store_category_exception
import aws_sdk_cloudtrail.errors.invalid_event_data_store_status_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidEventDataStoreCategoryException":
            raise aws_sdk_cloudtrail.errors.invalid_event_data_store_category_exception.InvalidEventDataStoreCategoryException.from_aws_json_1_1(
                data
            )
        case "InvalidEventDataStoreStatusException":
            raise aws_sdk_cloudtrail.errors.invalid_event_data_store_status_exception.InvalidEventDataStoreStatusException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.get_event_configuration_response.GetEventConfigurationResponse = aws_sdk_cloudtrail.types.get_event_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.get_event_configuration_request.GetEventConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.GetEventConfiguration"
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.get_event_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_event_configuration(
