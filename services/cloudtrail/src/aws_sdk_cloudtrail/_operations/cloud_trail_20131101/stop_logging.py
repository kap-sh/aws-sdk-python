...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.stop_logging_response.StopLoggingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.stop_logging_request.StopLoggingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.stop_logging_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def stop_logging(
    ...
    aws_sdk_cloudtrail.types.stop_logging_response.StopLoggingResponse, zapros.Response
]:
