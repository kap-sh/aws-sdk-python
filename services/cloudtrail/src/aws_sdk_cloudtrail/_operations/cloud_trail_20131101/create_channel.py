...
import aws_sdk_cloudtrail.errors.channel_max_limit_exceeded_exception
...
import aws_sdk_cloudtrail.errors.invalid_source_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ChannelMaxLimitExceededException":
            raise aws_sdk_cloudtrail.errors.channel_max_limit_exceeded_exception.ChannelMaxLimitExceededException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidSourceException":
            raise aws_sdk_cloudtrail.errors.invalid_source_exception.InvalidSourceException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.create_channel_response.CreateChannelResponse = (
        aws_sdk_cloudtrail.types.create_channel_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.create_channel_request.CreateChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.create_channel_request.serialize_aws_json_1_1(input_)
    ).encode()
