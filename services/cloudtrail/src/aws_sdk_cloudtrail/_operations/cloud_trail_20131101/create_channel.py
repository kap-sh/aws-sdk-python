...
def build_request(
    ...
    input: aws_sdk_cloudtrail.types.create_channel_request.CreateChannelRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.create_channel_request.serialize_aws_json_1_1(input)
    ).encode()
