...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.list_import_failures_response.ListImportFailuresResponse = aws_sdk_cloudtrail.types.list_import_failures_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.list_import_failures_request.ListImportFailuresRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.list_import_failures_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
