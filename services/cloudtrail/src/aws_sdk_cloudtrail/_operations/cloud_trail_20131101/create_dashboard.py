...
def build_request(
    ...
    input: aws_sdk_cloudtrail.types.create_dashboard_request.CreateDashboardRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.create_dashboard_request.serialize_aws_json_1_1(input)
    ).encode()
