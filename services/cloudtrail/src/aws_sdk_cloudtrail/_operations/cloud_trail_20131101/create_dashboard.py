...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.create_dashboard_response.CreateDashboardResponse = (
        aws_sdk_cloudtrail.types.create_dashboard_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.create_dashboard_request.CreateDashboardRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.create_dashboard_request.serialize_aws_json_1_1(input_)
    ).encode()
