...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.describe_query_response.DescribeQueryResponse = (
        aws_sdk_cloudtrail.types.describe_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.describe_query_request.DescribeQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.describe_query_request.serialize_aws_json_1_1(input_)
    ).encode()
