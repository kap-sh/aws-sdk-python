"""Generated from Smithy shape ``com.amazonaws.cloudtrail#PutResourcePolicy``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceARNNotValidException":
            import aws_sdk_cloudtrail.errors.resource_arn_not_valid_exception

            raise aws_sdk_cloudtrail.errors.resource_arn_not_valid_exception.ResourceARNNotValidException.from_aws_json_1_1(
                data
            )
        ...
        case "ResourcePolicyNotValidException":
            import aws_sdk_cloudtrail.errors.resource_policy_not_valid_exception

            raise aws_sdk_cloudtrail.errors.resource_policy_not_valid_exception.ResourcePolicyNotValidException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.put_resource_policy_response.PutResourcePolicyResponse = aws_sdk_cloudtrail.types.put_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.put_resource_policy_request.PutResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.PutResourcePolicy"
    import aws_sdk_cloudtrail.types.put_resource_policy_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.put_resource_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
