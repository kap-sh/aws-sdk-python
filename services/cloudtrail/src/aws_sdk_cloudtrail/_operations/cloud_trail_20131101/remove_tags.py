...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.remove_tags_response.RemoveTagsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.remove_tags_request.RemoveTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.remove_tags_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def remove_tags(
    ...
    aws_sdk_cloudtrail.types.remove_tags_response.RemoveTagsResponse, zapros.Response
]:
