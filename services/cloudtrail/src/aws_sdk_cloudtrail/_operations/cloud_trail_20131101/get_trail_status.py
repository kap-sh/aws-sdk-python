...
def build_request(
    ...
    input: aws_sdk_cloudtrail.types.get_trail_status_request.GetTrailStatusRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.get_trail_status_request.serialize_aws_json_1_1(input)
    ).encode()
