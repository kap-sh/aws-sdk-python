...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.get_trail_status_response.GetTrailStatusResponse = (
        aws_sdk_cloudtrail.types.get_trail_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.get_trail_status_request.GetTrailStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.get_trail_status_request.serialize_aws_json_1_1(input_)
    ).encode()
