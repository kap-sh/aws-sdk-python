...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.search_sample_queries_response.SearchSampleQueriesResponse = aws_sdk_cloudtrail.types.search_sample_queries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.search_sample_queries_request.SearchSampleQueriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.search_sample_queries_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
