"""Generated from Smithy shape ``com.amazonaws.cloudtrail#LookupEvents``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidEventCategoryException":
            import aws_sdk_cloudtrail.errors.invalid_event_category_exception

            raise aws_sdk_cloudtrail.errors.invalid_event_category_exception.InvalidEventCategoryException.from_aws_json_1_1(
                data
            )
        case "InvalidLookupAttributesException":
            import aws_sdk_cloudtrail.errors.invalid_lookup_attributes_exception

            raise aws_sdk_cloudtrail.errors.invalid_lookup_attributes_exception.InvalidLookupAttributesException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.lookup_events_response.LookupEventsResponse = (
        aws_sdk_cloudtrail.types.lookup_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.lookup_events_request.LookupEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.lookup_events_request.serialize_aws_json_1_1(input_)
    ).encode()
