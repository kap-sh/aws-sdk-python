"""Generated from Smithy shape ``com.amazonaws.cloudtrail#PutEventSelectors``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.put_event_selectors_response.PutEventSelectorsResponse = aws_sdk_cloudtrail.types.put_event_selectors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.put_event_selectors_request.PutEventSelectorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.put_event_selectors_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_event_selectors(
