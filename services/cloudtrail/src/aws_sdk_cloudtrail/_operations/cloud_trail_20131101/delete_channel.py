...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.delete_channel_response.DeleteChannelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.delete_channel_request.DeleteChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.delete_channel_request.serialize_aws_json_1_1(input_)
    ).encode()
