...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.start_logging_response.StartLoggingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_cloudtrail.types.start_logging_request.StartLoggingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.start_logging_request.serialize_aws_json_1_1(input)
    ).encode()
