...
def build_request(
    ...
    input: aws_sdk_cloudtrail.types.update_dashboard_request.UpdateDashboardRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.update_dashboard_request.serialize_aws_json_1_1(input)
    ).encode()
