...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.get_event_selectors_response.GetEventSelectorsResponse = aws_sdk_cloudtrail.types.get_event_selectors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.get_event_selectors_request.GetEventSelectorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.get_event_selectors_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
