...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.get_import_response.GetImportResponse = (
        aws_sdk_cloudtrail.types.get_import_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.get_import_request.GetImportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.get_import_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_import(
    ...
    aws_sdk_cloudtrail.types.get_import_response.GetImportResponse, zapros.Response
]:
