"""Generated from Smithy shape ``com.amazonaws.cloudtrail#RegisterOrganizationDelegatedAdmin``."""
...
import aws_sdk_cloudtrail.errors.account_registered_exception
import aws_sdk_cloudtrail.errors.cannot_delegate_management_account_exception
...
import aws_sdk_cloudtrail.errors.delegated_admin_account_limit_exceeded_exception
import aws_sdk_cloudtrail.errors.insufficient_dependency_service_access_permission_exception
import aws_sdk_cloudtrail.errors.insufficient_iam_access_permission_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AccountRegisteredException":
            raise aws_sdk_cloudtrail.errors.account_registered_exception.AccountRegisteredException.from_aws_json_1_1(
                data
            )
        case "CannotDelegateManagementAccountException":
            raise aws_sdk_cloudtrail.errors.cannot_delegate_management_account_exception.CannotDelegateManagementAccountException.from_aws_json_1_1(
                data
            )
        ...
        case "DelegatedAdminAccountLimitExceededException":
            raise aws_sdk_cloudtrail.errors.delegated_admin_account_limit_exceeded_exception.DelegatedAdminAccountLimitExceededException.from_aws_json_1_1(
                data
            )
        ...
        case "InsufficientIAMAccessPermissionException":
            raise aws_sdk_cloudtrail.errors.insufficient_iam_access_permission_exception.InsufficientIAMAccessPermissionException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.register_organization_delegated_admin_response.RegisterOrganizationDelegatedAdminResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.register_organization_delegated_admin_request.RegisterOrganizationDelegatedAdminRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.RegisterOrganizationDelegatedAdmin"
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.register_organization_delegated_admin_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_register_organization_delegated_admin(
