"""Generated from Smithy shape ``com.amazonaws.cloudtrail#UpdateEventDataStore``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.update_event_data_store_response.UpdateEventDataStoreResponse = aws_sdk_cloudtrail.types.update_event_data_store_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.update_event_data_store_request.UpdateEventDataStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.update_event_data_store_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_event_data_store(
