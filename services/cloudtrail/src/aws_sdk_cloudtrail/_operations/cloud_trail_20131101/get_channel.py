"""Generated from Smithy shape ``com.amazonaws.cloudtrail#GetChannel``."""
...
import aws_sdk_cloudtrail.types.ingestion_status
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.get_channel_response.GetChannelResponse = (
        aws_sdk_cloudtrail.types.get_channel_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.get_channel_request.GetChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.GetChannel"
    import aws_sdk_cloudtrail.types.get_channel_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.get_channel_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_channel(
    ...
    aws_sdk_cloudtrail.types.get_channel_response.GetChannelResponse, zapros.Response
]:
