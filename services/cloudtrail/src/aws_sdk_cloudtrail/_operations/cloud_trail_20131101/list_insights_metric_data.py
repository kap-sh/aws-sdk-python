"""Generated from Smithy shape ``com.amazonaws.cloudtrail#ListInsightsMetricData``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.list_insights_metric_data_response.ListInsightsMetricDataResponse = aws_sdk_cloudtrail.types.list_insights_metric_data_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.list_insights_metric_data_request.ListInsightsMetricDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.ListInsightsMetricData"
    import aws_sdk_cloudtrail.types.list_insights_metric_data_request

    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.list_insights_metric_data_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_insights_metric_data(
