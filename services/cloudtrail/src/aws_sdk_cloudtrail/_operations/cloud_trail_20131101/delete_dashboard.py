...
def build_request(
    ...
    input: aws_sdk_cloudtrail.types.delete_dashboard_request.DeleteDashboardRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.delete_dashboard_request.serialize_aws_json_1_1(input)
    ).encode()
