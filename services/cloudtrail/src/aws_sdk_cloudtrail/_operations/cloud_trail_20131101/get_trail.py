"""Generated from Smithy shape ``com.amazonaws.cloudtrail#GetTrail``."""
...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.get_trail_response.GetTrailResponse = (
        aws_sdk_cloudtrail.types.get_trail_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.get_trail_request.GetTrailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.get_trail_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_trail(
    ...
    aws_sdk_cloudtrail.types.get_trail_response.GetTrailResponse, zapros.Response
]:
