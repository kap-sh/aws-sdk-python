...
def handle_response(
    ...
    out: aws_sdk_cloudtrail.types.list_dashboards_response.ListDashboardsResponse = (
        aws_sdk_cloudtrail.types.list_dashboards_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cloudtrail.types.list_dashboards_request.ListDashboardsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.list_dashboards_request.serialize_aws_json_1_1(input_)
    ).encode()
