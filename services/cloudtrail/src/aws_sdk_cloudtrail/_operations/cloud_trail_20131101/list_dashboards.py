...
def build_request(
    ...
    input: aws_sdk_cloudtrail.types.list_dashboards_request.ListDashboardsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudtrail.types.list_dashboards_request.serialize_aws_json_1_1(input)
    ).encode()
