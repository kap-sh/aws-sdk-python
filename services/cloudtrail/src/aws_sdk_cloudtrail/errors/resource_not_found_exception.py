"""Generated from Smithy shape ``com.amazonaws.cloudtrail#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudtrail#ResourceNotFoundException``."""
