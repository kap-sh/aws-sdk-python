...
class InvalidHomeRegionException_(TypedDict):
...
class InvalidHomeRegionException(ServiceError):
    ...
    def __init__(self, data: InvalidHomeRegionException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "InvalidHomeRegionException":
