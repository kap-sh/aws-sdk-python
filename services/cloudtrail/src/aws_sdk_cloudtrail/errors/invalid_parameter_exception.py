"""Generated from Smithy shape ``com.amazonaws.cloudtrail#InvalidParameterException``."""
...
class InvalidParameterException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudtrail#InvalidParameterException``."""
