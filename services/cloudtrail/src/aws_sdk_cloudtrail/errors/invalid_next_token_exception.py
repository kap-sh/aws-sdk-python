"""Generated from Smithy shape ``com.amazonaws.cloudtrail#InvalidNextTokenException``."""
...
class InvalidNextTokenException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudtrail#InvalidNextTokenException``."""
