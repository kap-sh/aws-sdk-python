...
class ChannelExistsForEDSException_(TypedDict):
...
class ChannelExistsForEDSException(ServiceError):
    ...
    def __init__(self, data: ChannelExistsForEDSException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "ChannelExistsForEDSException":
