...
class ListImportsResponse(TypedDict, closed=True):
    imports: NotRequired["aws_sdk_cloudtrail.types.imports_list.ImportsList"]
...
def serialize_aws_json_1_1(value: ListImportsResponse) -> dict:
    ...
    if "imports" in value:
        ...
        out["Imports"] = aws_sdk_cloudtrail.types.imports_list.serialize_aws_json_1_1(
            value["imports"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListImportsResponse:
    ...
    if "Imports" in data:
        ...
        out["imports"] = aws_sdk_cloudtrail.types.imports_list.deserialize_aws_json_1_1(
            data["Imports"]
        )
