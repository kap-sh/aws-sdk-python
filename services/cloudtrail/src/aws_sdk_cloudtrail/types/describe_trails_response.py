...
class DescribeTrailsResponse(TypedDict):
    trail_list: NotRequired["aws_sdk_cloudtrail.types.trail_list.TrailList"]
...
def serialize_aws_json_1_1(value: DescribeTrailsResponse) -> dict:
    ...
    if "trail_list" in value:
        ...
        out["trailList"] = aws_sdk_cloudtrail.types.trail_list.serialize_aws_json_1_1(
            value["trail_list"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DescribeTrailsResponse:
    ...
    if "trailList" in data:
        ...
        out["trail_list"] = (
            aws_sdk_cloudtrail.types.trail_list.deserialize_aws_json_1_1(
                data["trailList"]
            )
        )
    return out
