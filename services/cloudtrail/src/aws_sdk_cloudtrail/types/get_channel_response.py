...
class GetChannelResponse(TypedDict, closed=True):
    ...
    source_config: NotRequired["aws_sdk_cloudtrail.types.source_config.SourceConfig"]
    ...
    ingestion_status: NotRequired[
        "aws_sdk_cloudtrail.types.ingestion_status.IngestionStatus"
    ]
...
def serialize_aws_json_1_1(value: GetChannelResponse) -> dict:
    ...
    if "source_config" in value:
        ...
        out["SourceConfig"] = (
            aws_sdk_cloudtrail.types.source_config.serialize_aws_json_1_1(
                value["source_config"]
            )
        )
    ...
    if "ingestion_status" in value:
        ...
        out["IngestionStatus"] = (
            aws_sdk_cloudtrail.types.ingestion_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetChannelResponse:
    ...
    if "SourceConfig" in data:
        ...
        out["source_config"] = (
            aws_sdk_cloudtrail.types.source_config.deserialize_aws_json_1_1(
                data["SourceConfig"]
            )
        )
    ...
    if "IngestionStatus" in data:
        ...
        out["ingestion_status"] = (
            aws_sdk_cloudtrail.types.ingestion_status.deserialize_aws_json_1_1(
