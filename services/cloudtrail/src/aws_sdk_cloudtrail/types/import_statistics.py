...
class ImportStatistics(TypedDict, closed=True):
    ...
    files_completed: NotRequired["aws_sdk_cloudtrail.types.long.Long"]
    """<p>The number of log files that completed import.</p>"""
    events_completed: NotRequired["aws_sdk_cloudtrail.types.long.Long"]
    """<p> The number of trail events imported into the event data store. </p>"""
    failed_entries: NotRequired["aws_sdk_cloudtrail.types.long.Long"]
