...
class Trail(TypedDict):
    ...
    has_custom_event_selectors: NotRequired["aws_sdk_cloudtrail.types.boolean.Boolean"]
    """<p>Specifies if the trail has custom event selectors.</p>"""
    has_insight_selectors: NotRequired["aws_sdk_cloudtrail.types.boolean.Boolean"]
