...
class GetEventDataStoreResponse(TypedDict):
    ...
    partition_keys: NotRequired[
        "aws_sdk_cloudtrail.types.partition_key_list.PartitionKeyList"
    ]
...
def serialize_aws_json_1_1(value: GetEventDataStoreResponse) -> dict:
    ...
    if "partition_keys" in value:
        ...
        out["PartitionKeys"] = (
            aws_sdk_cloudtrail.types.partition_key_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetEventDataStoreResponse:
    ...
    if "PartitionKeys" in data:
        ...
        out["partition_keys"] = (
            aws_sdk_cloudtrail.types.partition_key_list.deserialize_aws_json_1_1(
                data["PartitionKeys"]
            )
        )
    return out
