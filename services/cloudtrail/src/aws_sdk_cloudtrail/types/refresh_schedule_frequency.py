...
class RefreshScheduleFrequency(TypedDict, closed=True):
    ...
    value: NotRequired[
        "aws_sdk_cloudtrail.types.refresh_schedule_frequency_value.RefreshScheduleFrequencyValue"
    ]
...
def serialize_aws_json_1_1(value: RefreshScheduleFrequency) -> dict:
    ...
    if "unit" in value:
        ...
        out["Unit"] = (
            aws_sdk_cloudtrail.types.refresh_schedule_frequency_unit.serialize_aws_json_1_1(
                value["unit"]
            )
        )
    if "value" in value:
...
def deserialize_aws_json_1_1(data: dict) -> RefreshScheduleFrequency:
    ...
    if "Unit" in data:
        ...
        out["unit"] = (
            aws_sdk_cloudtrail.types.refresh_schedule_frequency_unit.deserialize_aws_json_1_1(
                data["Unit"]
            )
        )
    if "Value" in data:
