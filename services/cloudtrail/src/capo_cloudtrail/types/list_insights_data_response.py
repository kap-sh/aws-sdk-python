...
class ListInsightsDataResponse(TypedDict, closed=True):
    events: NotRequired["capo_cloudtrail.types.events_list.EventsList"]
...
def serialize_aws_json_1_1(value: ListInsightsDataResponse) -> dict:
    ...
    if "events" in value:
        ...
        out["Events"] = capo_cloudtrail.types.events_list.serialize_aws_json_1_1(
            value["events"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListInsightsDataResponse:
    ...
    if "Events" in data:
        ...
        out["events"] = capo_cloudtrail.types.events_list.deserialize_aws_json_1_1(
            data["Events"]
        )
