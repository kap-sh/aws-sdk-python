...
class Event(TypedDict, closed=True):
    event_id: NotRequired["capo_cloudtrail.types.string.String"]
    """<p>The CloudTrail ID of the event returned.</p>"""
    event_name: NotRequired["capo_cloudtrail.types.string.String"]
    """<p>The name of the event returned.</p>"""
    read_only: NotRequired["capo_cloudtrail.types.string.String"]
    """<p>Information about whether the event is a write event or a read event. </p>"""
    access_key_id: NotRequired["capo_cloudtrail.types.string.String"]
    ...
    event_time: NotRequired["capo_cloudtrail.types.date.Date"]
    """<p>The date and time of the event returned.</p>"""
    event_source: NotRequired["capo_cloudtrail.types.string.String"]
    """<p>The Amazon Web Services service to which the request was made.</p>"""
    username: NotRequired["capo_cloudtrail.types.string.String"]
    """<p>A user name or role name of the requester that called the API in the event returned.</p>"""
    resources: NotRequired["capo_cloudtrail.types.resource_list.ResourceList"]
    """<p>A list of resources referenced by the event returned.</p>"""
    cloud_trail_event: NotRequired["capo_cloudtrail.types.string.String"]
...
def serialize_aws_json_1_1(value: Event) -> dict:
    ...
    if "event_time" in value:
        ...
        out["EventTime"] = capo_cloudtrail.types.date.serialize_aws_json_1_1(
            value["event_time"]
        )
    ...
    if "resources" in value:
        ...
        out["Resources"] = capo_cloudtrail.types.resource_list.serialize_aws_json_1_1(
            value["resources"]
        )
