...
class ListEventDataStoresResponse(TypedDict, closed=True):
    event_data_stores: NotRequired[
        "capo_cloudtrail.types.event_data_stores.EventDataStores"
    ]
...
def serialize_aws_json_1_1(value: ListEventDataStoresResponse) -> dict:
    ...
    if "event_data_stores" in value:
        ...
        out["EventDataStores"] = (
            capo_cloudtrail.types.event_data_stores.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListEventDataStoresResponse:
    ...
    if "EventDataStores" in data:
        ...
        out["event_data_stores"] = (
            capo_cloudtrail.types.event_data_stores.deserialize_aws_json_1_1(
