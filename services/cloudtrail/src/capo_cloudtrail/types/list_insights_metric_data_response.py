...
class ListInsightsMetricDataResponse(TypedDict, closed=True):
    ...
    event_source: NotRequired["capo_cloudtrail.types.event_source.EventSource"]
    ...
    event_name: NotRequired["capo_cloudtrail.types.event_name.EventName"]
    """<p>The name of the event, typically the Amazon Web Services API on which unusual levels of activity were recorded.</p>"""
    insight_type: NotRequired["capo_cloudtrail.types.insight_type.InsightType"]
    ...
    error_code: NotRequired["capo_cloudtrail.types.error_code.ErrorCode"]
    ...
    timestamps: NotRequired["capo_cloudtrail.types.timestamps.Timestamps"]
    """<p>List of timestamps at intervals corresponding to the specified time period.</p>"""
    values: NotRequired[
        "capo_cloudtrail.types.insights_metric_values.InsightsMetricValues"
    ]
...
def serialize_aws_json_1_1(value: ListInsightsMetricDataResponse) -> dict:
    ...
    if "insight_type" in value:
        ...
        out["InsightType"] = capo_cloudtrail.types.insight_type.serialize_aws_json_1_1(
            value["insight_type"]
        )
    ...
    if "timestamps" in value:
        ...
        out["Timestamps"] = capo_cloudtrail.types.timestamps.serialize_aws_json_1_1(
            value["timestamps"]
        )
    if "values" in value:
        import capo_cloudtrail.types.insights_metric_values
        ...
        out["Values"] = (
            capo_cloudtrail.types.insights_metric_values.serialize_aws_json_1_1(
                value["values"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListInsightsMetricDataResponse:
    ...
    if "InsightType" in data:
        ...
        out["insight_type"] = (
            capo_cloudtrail.types.insight_type.deserialize_aws_json_1_1(
                data["InsightType"]
            )
        )
    ...
    if "Values" in data:
        ...
        out["values"] = (
            capo_cloudtrail.types.insights_metric_values.deserialize_aws_json_1_1(
                data["Values"]
            )
        )
