"""Generated from Smithy shape ``com.amazonaws.cloudtrail#RestoreEventDataStoreResponse``."""
...
class RestoreEventDataStoreResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: RestoreEventDataStoreResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> RestoreEventDataStoreResponse:
    out: RestoreEventDataStoreResponse = {}  # type: ignore[typeddict-item]
