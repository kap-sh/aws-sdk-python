...
if TYPE_CHECKING:
    ...
    import capo_cloudtrail.types.trails


class ListTrailsResponse(TypedDict, closed=True):
    trails: NotRequired["capo_cloudtrail.types.trails.Trails"]
...
def serialize_aws_json_1_1(value: ListTrailsResponse) -> dict:
    ...
    if "trails" in value:
        ...
        out["Trails"] = capo_cloudtrail.types.trails.serialize_aws_json_1_1(
            value["trails"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListTrailsResponse:
    ...
    if "Trails" in data:
        ...
        out["trails"] = capo_cloudtrail.types.trails.deserialize_aws_json_1_1(
            data["Trails"]
        )
