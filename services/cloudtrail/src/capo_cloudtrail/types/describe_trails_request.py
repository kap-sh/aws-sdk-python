...
class DescribeTrailsRequest(TypedDict, closed=True):
    trail_name_list: NotRequired["capo_cloudtrail.types.trail_name_list.TrailNameList"]
    ...
    include_shadow_trails: NotRequired["capo_cloudtrail.types.boolean.Boolean"]
...
def serialize_aws_json_1_1(value: DescribeTrailsRequest) -> dict:
    ...
    if "trail_name_list" in value:
        ...
        out["trailNameList"] = (
            capo_cloudtrail.types.trail_name_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeTrailsRequest:
    ...
    if "trailNameList" in data:
        ...
        out["trail_name_list"] = (
            capo_cloudtrail.types.trail_name_list.deserialize_aws_json_1_1(
                data["trailNameList"]
            )
        )
