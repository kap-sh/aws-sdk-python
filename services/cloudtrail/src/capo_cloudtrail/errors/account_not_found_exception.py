"""Generated from Smithy shape ``com.amazonaws.cloudtrail#AccountNotFoundException``."""
...
class AccountNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudtrail#AccountNotFoundException``."""
