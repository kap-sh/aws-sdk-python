...
def handle_response(
    ...
    out: capo_cloudtrail.types.list_channels_response.ListChannelsResponse = (
        capo_cloudtrail.types.list_channels_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.list_channels_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_channels(
    ...
    capo_cloudtrail.types.list_channels_response.ListChannelsResponse, zapros.Response
]:
