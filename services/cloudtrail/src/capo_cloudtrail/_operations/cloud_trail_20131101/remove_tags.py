"""Generated from Smithy shape ``com.amazonaws.cloudtrail#RemoveTags``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.remove_tags_response.RemoveTagsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.remove_tags_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def remove_tags(
    ...
    capo_cloudtrail.types.remove_tags_response.RemoveTagsResponse, zapros.Response
]:
