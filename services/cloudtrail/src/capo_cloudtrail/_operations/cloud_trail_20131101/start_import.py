"""Generated from Smithy shape ``com.amazonaws.cloudtrail#StartImport``."""
...
import capo_cloudtrail.errors.account_has_ongoing_import_exception
...
import capo_cloudtrail.errors.import_not_found_exception
...
import capo_cloudtrail.errors.invalid_import_source_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccountHasOngoingImportException":
            raise capo_cloudtrail.errors.account_has_ongoing_import_exception.AccountHasOngoingImportException.from_aws_json_1_1(
                data
            )
        ...
        case "ImportNotFoundException":
            raise capo_cloudtrail.errors.import_not_found_exception.ImportNotFoundException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidImportSourceException":
            raise capo_cloudtrail.errors.invalid_import_source_exception.InvalidImportSourceException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_cloudtrail.types.start_import_response.StartImportResponse = (
        capo_cloudtrail.types.start_import_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.StartImport"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.start_import_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_import(
    ...
    capo_cloudtrail.types.start_import_response.StartImportResponse, zapros.Response
]:
