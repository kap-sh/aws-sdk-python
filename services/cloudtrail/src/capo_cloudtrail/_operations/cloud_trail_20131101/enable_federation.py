...
import capo_cloudtrail.errors.access_denied_exception
import capo_cloudtrail.errors.cloud_trail_access_not_enabled_exception
import capo_cloudtrail.errors.concurrent_modification_exception
import capo_cloudtrail.errors.event_data_store_arn_invalid_exception
import capo_cloudtrail.errors.event_data_store_federation_enabled_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise capo_cloudtrail.errors.access_denied_exception.AccessDeniedException.from_aws_json_1_1(
                data
            )
        ...
        case "ConcurrentModificationException":
            raise capo_cloudtrail.errors.concurrent_modification_exception.ConcurrentModificationException.from_aws_json_1_1(
                data
            )
        ...
        case "EventDataStoreFederationEnabledException":
            raise capo_cloudtrail.errors.event_data_store_federation_enabled_exception.EventDataStoreFederationEnabledException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_cloudtrail.types.enable_federation_response.EnableFederationResponse = (
        capo_cloudtrail.types.enable_federation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.enable_federation_request.serialize_aws_json_1_1(input_)
    ).encode()
