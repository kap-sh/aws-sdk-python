...
def handle_response(
    ...
    out: capo_cloudtrail.types.get_event_configuration_response.GetEventConfigurationResponse = capo_cloudtrail.types.get_event_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.get_event_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
