"""Generated from Smithy shape ``com.amazonaws.cloudtrail#DescribeTrails``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.describe_trails_response.DescribeTrailsResponse = (
        capo_cloudtrail.types.describe_trails_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.describe_trails_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_trails(
