"""Generated from Smithy shape ``com.amazonaws.cloudtrail#ListInsightsData``."""
...
import capo_cloudtrail.types.events_list
...
def handle_response(
    ...
    out: capo_cloudtrail.types.list_insights_data_response.ListInsightsDataResponse = (
        capo_cloudtrail.types.list_insights_data_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.ListInsightsData"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.list_insights_data_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_insights_data(
