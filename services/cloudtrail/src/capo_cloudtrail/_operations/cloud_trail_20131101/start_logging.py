"""Generated from Smithy shape ``com.amazonaws.cloudtrail#StartLogging``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.start_logging_response.StartLoggingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.start_logging_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_logging(
    ...
    capo_cloudtrail.types.start_logging_response.StartLoggingResponse, zapros.Response
]:
