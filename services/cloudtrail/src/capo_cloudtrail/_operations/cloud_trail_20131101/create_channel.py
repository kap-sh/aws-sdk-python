"""Generated from Smithy shape ``com.amazonaws.cloudtrail#CreateChannel``."""
...
import capo_cloudtrail.errors.channel_already_exists_exception
import capo_cloudtrail.errors.channel_max_limit_exceeded_exception
...
import capo_cloudtrail.errors.invalid_source_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ChannelAlreadyExistsException":
            raise capo_cloudtrail.errors.channel_already_exists_exception.ChannelAlreadyExistsException.from_aws_json_1_1(
                data
            )
        case "ChannelMaxLimitExceededException":
            raise capo_cloudtrail.errors.channel_max_limit_exceeded_exception.ChannelMaxLimitExceededException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidSourceException":
            raise capo_cloudtrail.errors.invalid_source_exception.InvalidSourceException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_cloudtrail.types.create_channel_response.CreateChannelResponse = (
        capo_cloudtrail.types.create_channel_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.CreateChannel"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.create_channel_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_channel(
    ...
    capo_cloudtrail.types.create_channel_response.CreateChannelResponse, zapros.Response
]:
