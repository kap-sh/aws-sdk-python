"""Generated from Smithy shape ``com.amazonaws.cloudtrail#DeleteChannel``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.delete_channel_response.DeleteChannelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.DeleteChannel"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.delete_channel_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_channel(
    ...
    capo_cloudtrail.types.delete_channel_response.DeleteChannelResponse, zapros.Response
]:
