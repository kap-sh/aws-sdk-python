...
def handle_response(
    ...
    out: capo_cloudtrail.types.start_dashboard_refresh_response.StartDashboardRefreshResponse = capo_cloudtrail.types.start_dashboard_refresh_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.start_dashboard_refresh_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
