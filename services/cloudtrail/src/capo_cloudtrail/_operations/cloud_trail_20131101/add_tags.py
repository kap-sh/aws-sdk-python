"""Generated from Smithy shape ``com.amazonaws.cloudtrail#AddTags``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.add_tags_response.AddTagsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.add_tags_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def add_tags(
    ...
    input_: capo_cloudtrail.types.add_tags_request.AddTagsRequest,
) -> tuple[capo_cloudtrail.types.add_tags_response.AddTagsResponse, zapros.Response]:
