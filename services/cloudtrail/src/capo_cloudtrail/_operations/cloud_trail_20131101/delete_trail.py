"""Generated from Smithy shape ``com.amazonaws.cloudtrail#DeleteTrail``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.delete_trail_response.DeleteTrailResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.delete_trail_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_trail(
    ...
    capo_cloudtrail.types.delete_trail_response.DeleteTrailResponse, zapros.Response
]:
