"""Generated from Smithy shape ``com.amazonaws.cloudtrail#PutEventConfiguration``."""
...
import capo_cloudtrail.errors.insufficient_iam_access_permission_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InsufficientIAMAccessPermissionException":
            raise capo_cloudtrail.errors.insufficient_iam_access_permission_exception.InsufficientIAMAccessPermissionException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_cloudtrail.types.put_event_configuration_response.PutEventConfigurationResponse = capo_cloudtrail.types.put_event_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.PutEventConfiguration"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.put_event_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_event_configuration(
