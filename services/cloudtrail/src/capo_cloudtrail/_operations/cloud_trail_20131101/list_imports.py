"""Generated from Smithy shape ``com.amazonaws.cloudtrail#ListImports``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.list_imports_response.ListImportsResponse = (
        capo_cloudtrail.types.list_imports_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.ListImports"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.list_imports_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_imports(
    ...
    capo_cloudtrail.types.list_imports_response.ListImportsResponse, zapros.Response
]:
