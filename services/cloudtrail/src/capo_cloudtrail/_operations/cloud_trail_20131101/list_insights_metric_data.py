...
def handle_response(
    ...
    out: capo_cloudtrail.types.list_insights_metric_data_response.ListInsightsMetricDataResponse = capo_cloudtrail.types.list_insights_metric_data_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.list_insights_metric_data_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
