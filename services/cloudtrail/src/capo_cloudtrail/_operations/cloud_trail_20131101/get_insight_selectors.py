"""Generated from Smithy shape ``com.amazonaws.cloudtrail#GetInsightSelectors``."""
...
import capo_cloudtrail.errors.insight_not_enabled_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InsightNotEnabledException":
            raise capo_cloudtrail.errors.insight_not_enabled_exception.InsightNotEnabledException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_cloudtrail.types.get_insight_selectors_response.GetInsightSelectorsResponse = capo_cloudtrail.types.get_insight_selectors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.get_insight_selectors_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_insight_selectors(
