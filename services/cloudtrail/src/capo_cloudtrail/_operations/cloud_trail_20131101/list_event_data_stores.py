...
def handle_response(
    ...
    out: capo_cloudtrail.types.list_event_data_stores_response.ListEventDataStoresResponse = capo_cloudtrail.types.list_event_data_stores_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.list_event_data_stores_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
