"""Generated from Smithy shape ``com.amazonaws.cloudtrail#CancelQuery``."""
...
import capo_cloudtrail.errors.inactive_query_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InactiveQueryException":
            raise capo_cloudtrail.errors.inactive_query_exception.InactiveQueryException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_cloudtrail.types.cancel_query_response.CancelQueryResponse = (
        capo_cloudtrail.types.cancel_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.CancelQuery"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.cancel_query_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def cancel_query(
    ...
    capo_cloudtrail.types.cancel_query_response.CancelQueryResponse, zapros.Response
]:
