"""Generated from Smithy shape ``com.amazonaws.cloudtrail#RestoreEventDataStore``."""
...
import capo_cloudtrail.errors.event_data_store_max_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EventDataStoreMaxLimitExceededException":
            raise capo_cloudtrail.errors.event_data_store_max_limit_exceeded_exception.EventDataStoreMaxLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_cloudtrail.types.restore_event_data_store_response.RestoreEventDataStoreResponse = capo_cloudtrail.types.restore_event_data_store_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.RestoreEventDataStore"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.restore_event_data_store_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_restore_event_data_store(
