"""Generated from Smithy shape ``com.amazonaws.cloudtrail#DisableFederation``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.disable_federation_response.DisableFederationResponse = (
        capo_cloudtrail.types.disable_federation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.DisableFederation"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.disable_federation_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_disable_federation(
