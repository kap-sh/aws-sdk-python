...
import capo_cloudtrail.errors.channel_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ChannelNotFoundException":
            raise capo_cloudtrail.errors.channel_not_found_exception.ChannelNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_cloudtrail.types.update_channel_response.UpdateChannelResponse = (
        capo_cloudtrail.types.update_channel_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.update_channel_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_channel(
    ...
    capo_cloudtrail.types.update_channel_response.UpdateChannelResponse, zapros.Response
]:
