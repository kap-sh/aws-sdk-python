...
import capo_cloudtrail.errors.invalid_insight_selectors_exception
...
def handle_response(
    ...
    out: capo_cloudtrail.types.put_insight_selectors_response.PutInsightSelectorsResponse = capo_cloudtrail.types.put_insight_selectors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.put_insight_selectors_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
