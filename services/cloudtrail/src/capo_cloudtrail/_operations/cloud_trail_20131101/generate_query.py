...
import capo_cloudtrail.errors.generate_response_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "GenerateResponseException":
            raise capo_cloudtrail.errors.generate_response_exception.GenerateResponseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_cloudtrail.types.generate_query_response.GenerateQueryResponse = (
        capo_cloudtrail.types.generate_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.generate_query_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def generate_query(
    ...
    capo_cloudtrail.types.generate_query_response.GenerateQueryResponse, zapros.Response
]:
