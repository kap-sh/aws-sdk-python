"""Generated from Smithy shape ``com.amazonaws.cloudtrail#GetImport``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.get_import_response.GetImportResponse = (
        capo_cloudtrail.types.get_import_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.GetImport"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.get_import_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_import(
    ...
    capo_cloudtrail.types.get_import_response.GetImportResponse, zapros.Response
]:
