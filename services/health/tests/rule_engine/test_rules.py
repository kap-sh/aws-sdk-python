...
def test_for_region_aws_global_with_fips_disabled():
...
def test_for_region_aws_cn_global_with_fips_disab():
...
def test_for_region_us_iso_east_1_with_fips_disab():
    ...
    params = EndpointParams(Region='us-iso-east-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://health.us-iso-east-1.api.aws.ic.gov'

def test_for_region_us_iso_east_1_with_fips_enabl():
    """For region us-iso-east-1 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='us-iso-east-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
...
def test_for_region_us_isob_east_1_with_fips_disa():
    ...
    params = EndpointParams(Region='us-isob-east-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://health.us-isob-east-1.api.aws.scloud'

def test_for_region_us_isob_east_1_with_fips_enab():
    """For region us-isob-east-1 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='us-isob-east-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
...
def test_for_region_us_isof_south_1_with_fips_dis():
    ...
    params = EndpointParams(Region='us-isof-south-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
...
def test_for_region_us_isof_south_1_with_fips_ena():
    ...
    params = EndpointParams(Region='us-isof-south-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
...
def test_for_region_eu_isoe_west_1_with_fips_disa():
    ...
    params = EndpointParams(Region='eu-isoe-west-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
...
def test_for_region_eu_isoe_west_1_with_fips_enab():
    ...
    params = EndpointParams(Region='eu-isoe-west-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
...
def test_for_region_eusc_de_east_1_with_fips_disa():
    ...
    params = EndpointParams(Region='eusc-de-east-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://health.eusc-de-east-1.api.amazonwebservices.eu'
...
def test_for_region_eusc_de_east_1_with_fips_enab():
    ...
    params = EndpointParams(Region='eusc-de-east-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://health-fips.eusc-de-east-1.api.amazonwebservices.eu'
