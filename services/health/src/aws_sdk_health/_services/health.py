...
from aws_sdk_health._services._aws_config import aws_config
...
class HealthClient:
    ...
    def describe_affected_accounts_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_health.types.describe_affected_accounts_for_organization_request.DescribeAffectedAccountsForOrganizationRequest]",
        ) -> OperationResponse[
            "aws_sdk_health.types.describe_affected_accounts_for_organization_response.DescribeAffectedAccountsForOrganizationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_health._operations.aws_health_20160804.describe_affected_accounts_for_organization.describe_affected_accounts_for_organization(
    ...
    def iter_describe_affected_accounts_for_organization(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_health.types.next_token.nextToken"] = None,
        max_results: Optional["aws_sdk_health.types.max_results.maxResults"] = None,
    ) -> "Iterator[aws_sdk_health.types.account_id.accountId]":
        _token = next_token
        while True:
    ...
    def describe_affected_entities(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_health.types.describe_affected_entities_request.DescribeAffectedEntitiesRequest]",
        ) -> OperationResponse[
            "aws_sdk_health.types.describe_affected_entities_response.DescribeAffectedEntitiesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_health._operations.aws_health_20160804.describe_affected_entities.describe_affected_entities(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_health.types.affected_entity.AffectedEntity]":
        _token = next_token
        while True:
    ...
    def describe_affected_entities_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_health.types.describe_affected_entities_for_organization_request.DescribeAffectedEntitiesForOrganizationRequest]",
        ) -> OperationResponse[
            "aws_sdk_health.types.describe_affected_entities_for_organization_response.DescribeAffectedEntitiesForOrganizationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_health._operations.aws_health_20160804.describe_affected_entities_for_organization.describe_affected_entities_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_entity_aggregates(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_health.types.describe_entity_aggregates_request.DescribeEntityAggregatesRequest]",
        ) -> OperationResponse[
            "aws_sdk_health.types.describe_entity_aggregates_response.DescribeEntityAggregatesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_health._operations.aws_health_20160804.describe_entity_aggregates.describe_entity_aggregates(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_entity_aggregates_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_health.types.describe_entity_aggregates_for_organization_request.DescribeEntityAggregatesForOrganizationRequest]",
        ) -> OperationResponse[
            "aws_sdk_health.types.describe_entity_aggregates_for_organization_response.DescribeEntityAggregatesForOrganizationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_health._operations.aws_health_20160804.describe_entity_aggregates_for_organization.describe_entity_aggregates_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_event_aggregates(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_health.types.describe_event_aggregates_request.DescribeEventAggregatesRequest]",
        ) -> OperationResponse[
            "aws_sdk_health.types.describe_event_aggregates_response.DescribeEventAggregatesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_health._operations.aws_health_20160804.describe_event_aggregates.describe_event_aggregates(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_event_aggregates(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_health.types.max_results.maxResults"] = None,
        next_token: Optional["aws_sdk_health.types.next_token.nextToken"] = None,
    ) -> "Iterator[aws_sdk_health.types.event_aggregate.EventAggregate]":
        _token = next_token
        while True:
    ...
    def describe_event_details(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_health.types.describe_event_details_request.DescribeEventDetailsRequest]",
        ) -> OperationResponse[
            "aws_sdk_health.types.describe_event_details_response.DescribeEventDetailsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_health._operations.aws_health_20160804.describe_event_details.describe_event_details(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_event_details_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_health.types.describe_event_details_for_organization_request.DescribeEventDetailsForOrganizationRequest]",
        ) -> OperationResponse[
            "aws_sdk_health.types.describe_event_details_for_organization_response.DescribeEventDetailsForOrganizationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_health._operations.aws_health_20160804.describe_event_details_for_organization.describe_event_details_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_health.types.describe_events_request.DescribeEventsRequest]",
        ) -> OperationResponse[
            "aws_sdk_health.types.describe_events_response.DescribeEventsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_health._operations.aws_health_20160804.describe_events.describe_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_events(
        ...
        *,
        ...
        locale: Optional["aws_sdk_health.types.locale.locale"] = None,
    ) -> "Iterator[aws_sdk_health.types.event.Event]":
        _token = next_token
        while True:
    ...
    def describe_events_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_health.types.describe_events_for_organization_request.DescribeEventsForOrganizationRequest]",
        ) -> OperationResponse[
            "aws_sdk_health.types.describe_events_for_organization_response.DescribeEventsForOrganizationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_health._operations.aws_health_20160804.describe_events_for_organization.describe_events_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_events_for_organization(
        ...
        *,
        ...
        locale: Optional["aws_sdk_health.types.locale.locale"] = None,
    ) -> "Iterator[aws_sdk_health.types.organization_event.OrganizationEvent]":
        _token = next_token
        while True:
    ...
    def describe_event_types(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_health.types.describe_event_types_request.DescribeEventTypesRequest]",
        ) -> OperationResponse[
            "aws_sdk_health.types.describe_event_types_response.DescribeEventTypesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_health._operations.aws_health_20160804.describe_event_types.describe_event_types(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_event_types(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_health.types.next_token.nextToken"] = None,
        max_results: Optional["aws_sdk_health.types.max_results.maxResults"] = None,
    ) -> "Iterator[aws_sdk_health.types.event_type.EventType]":
        _token = next_token
        while True:
    ...
    def describe_health_service_status_for_organization(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_health._operations.aws_health_20160804.describe_health_service_status_for_organization.describe_health_service_status_for_organization(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disable_health_service_access_for_organization(
        ...
        def _handler(req: "OperationRequest[None]") -> OperationResponse[None]:
            ...
            output, http_response = (
                aws_sdk_health._operations.aws_health_20160804.disable_health_service_access_for_organization.disable_health_service_access_for_organization(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def enable_health_service_access_for_organization(
        ...
        def _handler(req: "OperationRequest[None]") -> OperationResponse[None]:
            ...
            output, http_response = (
                aws_sdk_health._operations.aws_health_20160804.enable_health_service_access_for_organization.enable_health_service_access_for_organization(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
