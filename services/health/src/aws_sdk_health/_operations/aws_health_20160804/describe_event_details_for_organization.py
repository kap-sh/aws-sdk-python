...
def handle_response(
    ...
    out: aws_sdk_health.types.describe_event_details_for_organization_response.DescribeEventDetailsForOrganizationResponse = aws_sdk_health.types.describe_event_details_for_organization_response.deserialize_aws_json_1_1(
...
def get_signer(
...
) -> aws_sdk_health._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_health._auth._sigv4.build_sigv4_auth_scheme(
                "health", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_health._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_health.types.describe_event_details_for_organization_request.DescribeEventDetailsForOrganizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_health.types.describe_event_details_for_organization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
