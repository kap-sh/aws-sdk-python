"""Generated from Smithy shape ``com.amazonaws.health#DescribeEventsForOrganization``."""
...
def handle_response(
    ...
    out: aws_sdk_health.types.describe_events_for_organization_response.DescribeEventsForOrganizationResponse = aws_sdk_health.types.describe_events_for_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_health.types.describe_events_for_organization_request.DescribeEventsForOrganizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_health.types.describe_events_for_organization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_events_for_organization(
