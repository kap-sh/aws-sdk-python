"""Generated from Smithy shape ``com.amazonaws.health#DescribeEventAggregates``."""
...
def handle_response(
    ...
    out: aws_sdk_health.types.describe_event_aggregates_response.DescribeEventAggregatesResponse = aws_sdk_health.types.describe_event_aggregates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_health.types.describe_event_aggregates_request.DescribeEventAggregatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_health.types.describe_event_aggregates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_event_aggregates(
