...
def build_request(
    ...
    input_: aws_sdk_health.types.describe_affected_entities_request.DescribeAffectedEntitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_health.types.describe_affected_entities_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
