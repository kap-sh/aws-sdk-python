"""Generated from Smithy shape ``com.amazonaws.health#DescribeEventDetails``."""
...
def handle_response(
    ...
    out: aws_sdk_health.types.describe_event_details_response.DescribeEventDetailsResponse = aws_sdk_health.types.describe_event_details_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_health.types.describe_event_details_request.DescribeEventDetailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_health.types.describe_event_details_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_event_details(
