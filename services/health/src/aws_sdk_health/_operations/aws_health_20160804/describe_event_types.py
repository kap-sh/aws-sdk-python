...
def build_request(
    ...
    input: aws_sdk_health.types.describe_event_types_request.DescribeEventTypesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_health.types.describe_event_types_request.serialize_aws_json_1_1(input)
    ).encode()
