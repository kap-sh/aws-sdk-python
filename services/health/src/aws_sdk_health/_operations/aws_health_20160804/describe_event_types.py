...
def handle_response(
    ...
    out: aws_sdk_health.types.describe_event_types_response.DescribeEventTypesResponse = aws_sdk_health.types.describe_event_types_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_health.types.describe_event_types_request.DescribeEventTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_health.types.describe_event_types_request.serialize_aws_json_1_1(input_)
    ).encode()
