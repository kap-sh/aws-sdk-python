...
def handle_response(
    ...
    out: aws_sdk_health.types.describe_affected_accounts_for_organization_response.DescribeAffectedAccountsForOrganizationResponse = aws_sdk_health.types.describe_affected_accounts_for_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_health.types.describe_affected_accounts_for_organization_request.DescribeAffectedAccountsForOrganizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
