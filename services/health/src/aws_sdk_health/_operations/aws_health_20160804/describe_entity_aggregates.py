"""Generated from Smithy shape ``com.amazonaws.health#DescribeEntityAggregates``."""
...
def handle_response(
    ...
    out: aws_sdk_health.types.describe_entity_aggregates_response.DescribeEntityAggregatesResponse = aws_sdk_health.types.describe_entity_aggregates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_health.types.describe_entity_aggregates_request.DescribeEntityAggregatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_health.types.describe_entity_aggregates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_entity_aggregates(
