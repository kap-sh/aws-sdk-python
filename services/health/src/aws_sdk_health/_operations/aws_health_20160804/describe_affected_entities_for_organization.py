...
def handle_response(
    ...
    out: aws_sdk_health.types.describe_affected_entities_for_organization_response.DescribeAffectedEntitiesForOrganizationResponse = aws_sdk_health.types.describe_affected_entities_for_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_health.types.describe_affected_entities_for_organization_request.DescribeAffectedEntitiesForOrganizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_health.types.describe_affected_entities_for_organization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
