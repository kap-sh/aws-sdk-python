...
class HealthError(Exception):
    """Base class for all Health service errors."""


class ServiceError(HealthError):
...
class SerializationError(HealthError):
    """Raised when a value cannot be serialized."""


class DeserializationError(HealthError):
...
class WaiterFailedError(HealthError):
...
class WaiterTimeoutError(HealthError):
