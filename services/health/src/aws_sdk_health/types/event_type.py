...
class EventType(TypedDict):
    ...
    category: NotRequired["aws_sdk_health.types.event_type_category.eventTypeCategory"]
...
def serialize_aws_json_1_1(value: EventType) -> dict:
    ...
    if "actionability" in value:
        ...
        out["actionability"] = (
            aws_sdk_health.types.event_type_actionability.serialize_aws_json_1_1(
                value["actionability"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> EventType:
    ...
    if "actionability" in data:
        ...
        out["actionability"] = (
            aws_sdk_health.types.event_type_actionability.deserialize_aws_json_1_1(
                data["actionability"]
            )
        )
    if "personas" in data:
