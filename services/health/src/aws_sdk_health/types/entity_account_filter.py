"""Generated from Smithy shape ``com.amazonaws.health#EntityAccountFilter``."""
...
class EntityAccountFilter(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: EntityAccountFilter) -> dict:
    out: dict = {}
