...
def serialize_aws_json_1_1(
    ...
    out["eventArns"] = (
        aws_sdk_health.types.organization_event_arns_list.serialize_aws_json_1_1(
            value["event_arns"]
        )
    )
    if "aws_account_ids" in value:
        ...
        out["awsAccountIds"] = (
            aws_sdk_health.types.organization_account_ids_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "eventArns" in data:
        ...
        out["event_arns"] = (
            aws_sdk_health.types.organization_event_arns_list.deserialize_aws_json_1_1(
                data["eventArns"]
            )
        )
    else:
    ...
    if "awsAccountIds" in data:
        ...
        out["aws_account_ids"] = (
            aws_sdk_health.types.organization_account_ids_list.deserialize_aws_json_1_1(
                data["awsAccountIds"]
            )
        )
    return out
