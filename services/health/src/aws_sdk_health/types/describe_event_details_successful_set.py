...
if TYPE_CHECKING:
    import aws_sdk_health.types.event_details

DescribeEventDetailsSuccessfulSet: TypeAlias = list[
    "aws_sdk_health.types.event_details.EventDetails"
]
...
def serialize_aws_json_1_1(value: DescribeEventDetailsSuccessfulSet) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_health.types.event_details.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> DescribeEventDetailsSuccessfulSet:
    ...
    for item in data:
        out.append(aws_sdk_health.types.event_details.deserialize_aws_json_1_1(item))
    return out
