...
if TYPE_CHECKING:
    import aws_sdk_health.types.organization_event_details

DescribeEventDetailsForOrganizationSuccessfulSet: TypeAlias = list[
    "aws_sdk_health.types.organization_event_details.OrganizationEventDetails"
]
...
def serialize_aws_json_1_1(
    ...
    for item in value:
        out.append(
            aws_sdk_health.types.organization_event_details.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(
    ...
    for item in data:
        out.append(
            aws_sdk_health.types.organization_event_details.deserialize_aws_json_1_1(
                item
            )
        )
    return out
