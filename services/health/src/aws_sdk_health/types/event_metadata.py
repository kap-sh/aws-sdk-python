...
if TYPE_CHECKING:
    import aws_sdk_health.types.metadata_key
    import aws_sdk_health.types.metadata_value

eventMetadata: TypeAlias = dict[
    "aws_sdk_health.types.metadata_key.metadataKey",
    "aws_sdk_health.types.metadata_value.metadataValue",
]
