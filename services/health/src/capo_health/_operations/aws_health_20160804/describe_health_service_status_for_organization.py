"""Generated from Smithy shape ``com.amazonaws.health#DescribeHealthServiceStatusForOrganization``."""
...
def handle_response(
    ...
    out: capo_health.types.describe_health_service_status_for_organization_response.DescribeHealthServiceStatusForOrganizationResponse = capo_health.types.describe_health_service_status_for_organization_response.deserialize_aws_json_1_1(
...
async def async_describe_health_service_status_for_organization(
