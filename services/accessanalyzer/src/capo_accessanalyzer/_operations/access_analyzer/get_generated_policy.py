"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#GetGeneratedPolicy``."""
...
def handle_response(
    ...
    out: capo_accessanalyzer.types.get_generated_policy_response.GetGeneratedPolicyResponse = capo_accessanalyzer.types.get_generated_policy_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "include_resource_placeholders" in input_:
        params["includeResourcePlaceholders"] = str(
            input_["include_resource_placeholders"]
        )
    if "include_service_level_template" in input_:
        params["includeServiceLevelTemplate"] = str(
            input_["include_service_level_template"]
        )
...
async def async_get_generated_policy(
