...
def handle_response(
    ...
    out: capo_accessanalyzer.types.list_access_preview_findings_response.ListAccessPreviewFindingsResponse = capo_accessanalyzer.types.list_access_preview_findings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_accessanalyzer.types.list_access_preview_findings_request.serialize_json(
            input_
        )
    ).encode()
