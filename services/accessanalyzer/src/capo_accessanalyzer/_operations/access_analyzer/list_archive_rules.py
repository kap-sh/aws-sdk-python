"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#ListArchiveRules``."""
...
def handle_response(
    ...
    out: capo_accessanalyzer.types.list_archive_rules_response.ListArchiveRulesResponse = capo_accessanalyzer.types.list_archive_rules_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/analyzer/{analyzerName}/archive-rule"
...
async def async_list_archive_rules(
