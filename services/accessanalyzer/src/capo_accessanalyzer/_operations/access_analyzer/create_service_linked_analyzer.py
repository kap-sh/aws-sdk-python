"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#CreateServiceLinkedAnalyzer``."""
...
import capo_accessanalyzer.errors.conflict_exception
import capo_accessanalyzer.errors.internal_server_exception
import capo_accessanalyzer.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_accessanalyzer.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_accessanalyzer.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_accessanalyzer.types.create_service_linked_analyzer_response.CreateServiceLinkedAnalyzerResponse = capo_accessanalyzer.types.create_service_linked_analyzer_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/service-linked-analyzer"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_accessanalyzer.types.create_service_linked_analyzer_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_service_linked_analyzer(
