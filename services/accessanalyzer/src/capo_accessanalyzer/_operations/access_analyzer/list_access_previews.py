...
def handle_response(
    ...
    out: capo_accessanalyzer.types.list_access_previews_response.ListAccessPreviewsResponse = capo_accessanalyzer.types.list_access_previews_response.deserialize_json(
