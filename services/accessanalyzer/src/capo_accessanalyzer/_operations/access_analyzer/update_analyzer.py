"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#UpdateAnalyzer``."""
...
def handle_response(
    ...
    out: capo_accessanalyzer.types.update_analyzer_response.UpdateAnalyzerResponse = (
        capo_accessanalyzer.types.update_analyzer_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_accessanalyzer.types.update_analyzer_request.serialize_json(input_)
    ).encode()
...
async def async_update_analyzer(
