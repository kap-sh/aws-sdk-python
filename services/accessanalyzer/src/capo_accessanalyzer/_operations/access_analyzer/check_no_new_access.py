"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#CheckNoNewAccess``."""
...
import capo_accessanalyzer.errors.invalid_parameter_exception
import capo_accessanalyzer.errors.throttling_exception
import capo_accessanalyzer.errors.unprocessable_entity_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidParameterException":
            raise capo_accessanalyzer.errors.invalid_parameter_exception.InvalidParameterException.from_json(
                data
            )
        ...
        case "UnprocessableEntityException":
            raise capo_accessanalyzer.errors.unprocessable_entity_exception.UnprocessableEntityException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_accessanalyzer.types.check_no_new_access_response.CheckNoNewAccessResponse = capo_accessanalyzer.types.check_no_new_access_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/policy/check-no-new-access"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_accessanalyzer.types.check_no_new_access_request.serialize_json(input_)
    ).encode()
...
async def async_check_no_new_access(
