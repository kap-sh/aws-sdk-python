"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#ValidatePolicy``."""
...
def handle_response(
    ...
    out: capo_accessanalyzer.types.validate_policy_response.ValidatePolicyResponse = (
        capo_accessanalyzer.types.validate_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/policy/validation"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        capo_accessanalyzer.types.validate_policy_request.serialize_json(input_)
    ).encode()
...
async def async_validate_policy(
