"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#UpdateArchiveRule``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_accessanalyzer.types.update_archive_rule_request.serialize_json(input_)
    ).encode()
...
async def async_update_archive_rule(
