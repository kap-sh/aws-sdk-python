...
class GetAnalyzedResourceResponse(TypedDict, closed=True):
    resource: NotRequired[
        "capo_accessanalyzer.types.analyzed_resource.AnalyzedResource"
    ]
...
def serialize_json(value: GetAnalyzedResourceResponse) -> dict:
    ...
    if "resource" in value:
        ...
        out["resource"] = capo_accessanalyzer.types.analyzed_resource.serialize_json(
            value["resource"]
        )
    return out
