...
if TYPE_CHECKING:
    import capo_accessanalyzer.types.rds_db_snapshot_attributes_map
    import capo_accessanalyzer.types.rds_db_snapshot_kms_key_id


class RdsDbSnapshotConfiguration(TypedDict, closed=True):
    attributes: NotRequired[
        "capo_accessanalyzer.types.rds_db_snapshot_attributes_map.RdsDbSnapshotAttributesMap"
    ]
    ...
    kms_key_id: NotRequired[
        "capo_accessanalyzer.types.rds_db_snapshot_kms_key_id.RdsDbSnapshotKmsKeyId"
    ]
...
def serialize_json(value: RdsDbSnapshotConfiguration) -> dict:
    ...
    if "attributes" in value:
        ...
        out["attributes"] = (
            capo_accessanalyzer.types.rds_db_snapshot_attributes_map.serialize_json(
                value["attributes"]
            )
        )
...
def deserialize_json(data: dict) -> RdsDbSnapshotConfiguration:
    ...
    if "attributes" in data:
        ...
        out["attributes"] = (
            capo_accessanalyzer.types.rds_db_snapshot_attributes_map.deserialize_json(
                data["attributes"]
            )
        )
    if "kmsKeyId" in data:
