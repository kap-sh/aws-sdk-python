...
class GetGeneratedPolicyResponse(TypedDict, closed=True):
    job_details: "capo_accessanalyzer.types.job_details.JobDetails"
    """<p>A <code>GeneratedPolicyDetails</code> object that contains details about the generated policy.</p>"""
    generated_policy_result: (
        "capo_accessanalyzer.types.generated_policy_result.GeneratedPolicyResult"
    )
...
def serialize_json(value: GetGeneratedPolicyResponse) -> dict:
    ...
    out["jobDetails"] = capo_accessanalyzer.types.job_details.serialize_json(
        value["job_details"]
    )
    import capo_accessanalyzer.types.generated_policy_result

    out["generatedPolicyResult"] = (
        capo_accessanalyzer.types.generated_policy_result.serialize_json(
...
def deserialize_json(data: dict) -> GetGeneratedPolicyResponse:
    ...
    if "generatedPolicyResult" in data:
        ...
        out["generated_policy_result"] = (
            capo_accessanalyzer.types.generated_policy_result.deserialize_json(
