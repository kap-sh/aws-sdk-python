...
if TYPE_CHECKING:
    import capo_accessanalyzer.types.finding_summary_v2

FindingsListV2: TypeAlias = list[
    "capo_accessanalyzer.types.finding_summary_v2.FindingSummaryV2"
]
...
def serialize_json(value: FindingsListV2) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_accessanalyzer.types.finding_summary_v2.serialize_json(item))
    return out
