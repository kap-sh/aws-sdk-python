...
class AccessAnalyzerError(Exception):
    """Base class for all AccessAnalyzer service errors."""


class ServiceError(AccessAnalyzerError):
...
class SerializationError(AccessAnalyzerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(AccessAnalyzerError):
...
class WaiterFailedError(AccessAnalyzerError):
...
class WaiterTimeoutError(AccessAnalyzerError):
