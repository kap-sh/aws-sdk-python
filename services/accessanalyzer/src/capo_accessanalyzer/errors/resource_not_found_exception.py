"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.accessanalyzer#ResourceNotFoundException``."""
