...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.get_access_preview_response.GetAccessPreviewResponse = aws_sdk_accessanalyzer.types.get_access_preview_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.get_access_preview_request.GetAccessPreviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
