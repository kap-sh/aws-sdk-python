"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#CreateAccessPreview``."""
...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.create_access_preview_response.CreateAccessPreviewResponse = aws_sdk_accessanalyzer.types.create_access_preview_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_accessanalyzer.types.create_access_preview_request.CreateAccessPreviewRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.create_access_preview_request.serialize_json(input)
    ).encode()
...
async def async_create_access_preview(
