...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.create_access_preview_request.CreateAccessPreviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.create_access_preview_request.serialize_json(
            input_
        )
    ).encode()
