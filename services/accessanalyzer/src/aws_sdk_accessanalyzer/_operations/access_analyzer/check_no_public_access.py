...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.check_no_public_access_response.CheckNoPublicAccessResponse = aws_sdk_accessanalyzer.types.check_no_public_access_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.check_no_public_access_request.CheckNoPublicAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.check_no_public_access_request.serialize_json(
            input_
        )
    ).encode()
