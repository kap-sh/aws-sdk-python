"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#GetFinding``."""
...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.get_finding_response.GetFindingResponse = (
        aws_sdk_accessanalyzer.types.get_finding_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_accessanalyzer.types.get_finding_request.GetFindingRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/finding/{id}"
