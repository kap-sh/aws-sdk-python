...
def build_request(
    ...
    input: aws_sdk_accessanalyzer.types.update_archive_rule_request.UpdateArchiveRuleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.update_archive_rule_request.serialize_json(input)
    ).encode()
