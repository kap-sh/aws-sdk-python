...
import aws_sdk_accessanalyzer.types.update_archive_rule_request
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.update_archive_rule_request.UpdateArchiveRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.update_archive_rule_request.serialize_json(input_)
    ).encode()
