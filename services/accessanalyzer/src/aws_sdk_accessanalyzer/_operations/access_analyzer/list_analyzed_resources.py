...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.list_analyzed_resources_response.ListAnalyzedResourcesResponse = aws_sdk_accessanalyzer.types.list_analyzed_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.list_analyzed_resources_request.ListAnalyzedResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.list_analyzed_resources_request.serialize_json(
            input_
        )
    ).encode()
