"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#StartPolicyGeneration``."""
...
import aws_sdk_accessanalyzer.errors.conflict_exception
import aws_sdk_accessanalyzer.errors.internal_server_exception
import aws_sdk_accessanalyzer.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_accessanalyzer.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_accessanalyzer.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.start_policy_generation_response.StartPolicyGenerationResponse = aws_sdk_accessanalyzer.types.start_policy_generation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.start_policy_generation_request.StartPolicyGenerationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/policy/generation"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.start_policy_generation_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_policy_generation(
