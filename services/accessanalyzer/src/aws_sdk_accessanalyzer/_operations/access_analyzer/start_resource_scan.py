...
def build_request(
    ...
    input: aws_sdk_accessanalyzer.types.start_resource_scan_request.StartResourceScanRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.start_resource_scan_request.serialize_json(input)
    ).encode()
