...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.update_findings_request.UpdateFindingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.update_findings_request.serialize_json(input_)
    ).encode()
