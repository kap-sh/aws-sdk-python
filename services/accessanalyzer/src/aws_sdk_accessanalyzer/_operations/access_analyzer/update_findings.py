...
def build_request(
    ...
    input: aws_sdk_accessanalyzer.types.update_findings_request.UpdateFindingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.update_findings_request.serialize_json(input)
    ).encode()
