...
def build_request(
    ...
    input: aws_sdk_accessanalyzer.types.check_no_new_access_request.CheckNoNewAccessRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.check_no_new_access_request.serialize_json(input)
    ).encode()
