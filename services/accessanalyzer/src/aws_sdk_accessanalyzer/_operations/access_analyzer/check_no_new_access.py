...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.check_no_new_access_response.CheckNoNewAccessResponse = aws_sdk_accessanalyzer.types.check_no_new_access_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.check_no_new_access_request.CheckNoNewAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.check_no_new_access_request.serialize_json(input_)
    ).encode()
