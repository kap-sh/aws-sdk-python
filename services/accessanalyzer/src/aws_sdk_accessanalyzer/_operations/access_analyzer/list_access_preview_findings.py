...
def build_request(
    ...
    input: aws_sdk_accessanalyzer.types.list_access_preview_findings_request.ListAccessPreviewFindingsRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{accessPreviewId}", quote(str(input["access_preview_id"]), safe="")
    )
    params: dict[str, str] = {}
