"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#ListAccessPreviewFindings``."""
...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.list_access_preview_findings_response.ListAccessPreviewFindingsResponse = aws_sdk_accessanalyzer.types.list_access_preview_findings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.list_access_preview_findings_request.ListAccessPreviewFindingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/access-preview/{accessPreviewId}"
    url = url.replace(
        "{accessPreviewId}", quote(str(input_["access_preview_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.list_access_preview_findings_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_access_preview_findings(
