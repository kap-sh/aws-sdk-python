...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.apply_archive_rule_request.ApplyArchiveRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.apply_archive_rule_request.serialize_json(input_)
    ).encode()
