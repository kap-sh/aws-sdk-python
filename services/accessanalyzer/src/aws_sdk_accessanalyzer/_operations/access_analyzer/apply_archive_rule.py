...
def build_request(
    ...
    input: aws_sdk_accessanalyzer.types.apply_archive_rule_request.ApplyArchiveRuleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.apply_archive_rule_request.serialize_json(input)
    ).encode()
