"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#CreateAnalyzer``."""
...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.create_analyzer_response.CreateAnalyzerResponse = aws_sdk_accessanalyzer.types.create_analyzer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.create_analyzer_request.CreateAnalyzerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/analyzer"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_accessanalyzer.types.create_analyzer_request

    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.create_analyzer_request.serialize_json(input_)
    ).encode()
...
async def async_create_analyzer(
