...
def build_request(
    ...
    input: aws_sdk_accessanalyzer.types.create_analyzer_request.CreateAnalyzerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.create_analyzer_request.serialize_json(input)
    ).encode()
