...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.get_generated_policy_response.GetGeneratedPolicyResponse = aws_sdk_accessanalyzer.types.get_generated_policy_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_accessanalyzer.types.get_generated_policy_request.GetGeneratedPolicyRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "include_resource_placeholders" in input:
        params["includeResourcePlaceholders"] = str(
            input["include_resource_placeholders"]
        )
    if "include_service_level_template" in input:
        params["includeServiceLevelTemplate"] = str(
            input["include_service_level_template"]
        )
