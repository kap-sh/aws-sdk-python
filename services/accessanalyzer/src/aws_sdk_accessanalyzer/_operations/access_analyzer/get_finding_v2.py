"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#GetFindingV2``."""
...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.get_finding_v2_response.GetFindingV2Response = (
        aws_sdk_accessanalyzer.types.get_finding_v2_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_accessanalyzer.types.get_finding_v2_request.GetFindingV2Request,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/findingv2/{id}"
    url = url.replace("{id}", quote(str(input["id"]), safe=""))
    params: dict[str, str] = {}
    if "analyzer_arn" in input:
        params["analyzerArn"] = str(input["analyzer_arn"])
...
async def async_get_finding_v2(
