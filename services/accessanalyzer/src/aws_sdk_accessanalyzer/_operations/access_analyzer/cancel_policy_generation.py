"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#CancelPolicyGeneration``."""
...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.cancel_policy_generation_response.CancelPolicyGenerationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.cancel_policy_generation_request.CancelPolicyGenerationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/policy/generation/{jobId}"
...
async def async_cancel_policy_generation(
