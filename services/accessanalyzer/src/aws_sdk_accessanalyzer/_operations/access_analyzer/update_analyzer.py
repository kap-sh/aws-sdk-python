...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.update_analyzer_response.UpdateAnalyzerResponse = aws_sdk_accessanalyzer.types.update_analyzer_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_accessanalyzer.types.update_analyzer_request.UpdateAnalyzerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.update_analyzer_request.serialize_json(input)
    ).encode()
