...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.get_analyzed_resource_response.GetAnalyzedResourceResponse = aws_sdk_accessanalyzer.types.get_analyzed_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.get_analyzed_resource_request.GetAnalyzedResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
