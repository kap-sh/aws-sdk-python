...
if TYPE_CHECKING:
    import aws_sdk_accessanalyzer.types.list_archive_rules_request
    import aws_sdk_accessanalyzer.types.list_archive_rules_response
...
) -> aws_sdk_accessanalyzer.types.list_archive_rules_response.ListArchiveRulesResponse:
    import aws_sdk_accessanalyzer.types.list_archive_rules_response

    out: aws_sdk_accessanalyzer.types.list_archive_rules_response.ListArchiveRulesResponse = aws_sdk_accessanalyzer.types.list_archive_rules_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.list_archive_rules_request.ListArchiveRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
