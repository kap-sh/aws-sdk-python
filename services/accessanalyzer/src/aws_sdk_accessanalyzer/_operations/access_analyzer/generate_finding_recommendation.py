"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#GenerateFindingRecommendation``."""
...
def build_request(
    ...
    input: aws_sdk_accessanalyzer.types.generate_finding_recommendation_request.GenerateFindingRecommendationRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/recommendation/{id}"
...
async def async_generate_finding_recommendation(
