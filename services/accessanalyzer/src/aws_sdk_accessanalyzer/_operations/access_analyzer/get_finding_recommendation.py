...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.get_finding_recommendation_response.GetFindingRecommendationResponse = aws_sdk_accessanalyzer.types.get_finding_recommendation_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.get_finding_recommendation_request.GetFindingRecommendationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
