...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.get_findings_statistics_response.GetFindingsStatisticsResponse = aws_sdk_accessanalyzer.types.get_findings_statistics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.get_findings_statistics_request.GetFindingsStatisticsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.get_findings_statistics_request.serialize_json(
            input_
        )
    ).encode()
