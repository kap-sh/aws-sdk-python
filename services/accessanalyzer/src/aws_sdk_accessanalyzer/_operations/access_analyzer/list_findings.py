"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#ListFindings``."""
...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.list_findings_response.ListFindingsResponse = (
        aws_sdk_accessanalyzer.types.list_findings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.list_findings_request.ListFindingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.list_findings_request.serialize_json(input_)
    ).encode()
