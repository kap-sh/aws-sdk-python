...
import aws_sdk_accessanalyzer.errors.invalid_parameter_exception
import aws_sdk_accessanalyzer.errors.throttling_exception
import aws_sdk_accessanalyzer.errors.unprocessable_entity_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidParameterException":
            raise aws_sdk_accessanalyzer.errors.invalid_parameter_exception.InvalidParameterException.from_json(
                data
            )
        ...
        case "UnprocessableEntityException":
            raise aws_sdk_accessanalyzer.errors.unprocessable_entity_exception.UnprocessableEntityException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.check_access_not_granted_response.CheckAccessNotGrantedResponse = aws_sdk_accessanalyzer.types.check_access_not_granted_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.check_access_not_granted_request.CheckAccessNotGrantedRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.check_access_not_granted_request.serialize_json(
            input_
        )
    ).encode()
