...
def build_request(
    ...
    input: aws_sdk_accessanalyzer.types.validate_policy_request.ValidatePolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.validate_policy_request.serialize_json(input)
    ).encode()
