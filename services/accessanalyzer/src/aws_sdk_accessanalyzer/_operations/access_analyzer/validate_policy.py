...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.validate_policy_response.ValidatePolicyResponse = aws_sdk_accessanalyzer.types.validate_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.validate_policy_request.ValidatePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.validate_policy_request.serialize_json(input_)
    ).encode()
