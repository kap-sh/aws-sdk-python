...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.list_analyzers_response.ListAnalyzersResponse = (
        aws_sdk_accessanalyzer.types.list_analyzers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.list_analyzers_request.ListAnalyzersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
