...
def build_request(
    ...
    input: aws_sdk_accessanalyzer.types.list_policy_generations_request.ListPolicyGenerationsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "principal_arn" in input:
        params["principalArn"] = str(input["principal_arn"])
