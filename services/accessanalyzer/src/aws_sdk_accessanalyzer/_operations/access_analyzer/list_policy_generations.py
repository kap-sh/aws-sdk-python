"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#ListPolicyGenerations``."""
...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.list_policy_generations_response.ListPolicyGenerationsResponse = aws_sdk_accessanalyzer.types.list_policy_generations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.list_policy_generations_request.ListPolicyGenerationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "principal_arn" in input_:
        params["principalArn"] = str(input_["principal_arn"])
...
async def async_list_policy_generations(
