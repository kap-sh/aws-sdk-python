...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.get_analyzer_response.GetAnalyzerResponse = (
        aws_sdk_accessanalyzer.types.get_analyzer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.get_analyzer_request.GetAnalyzerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
