...
def handle_response(
    ...
    out: aws_sdk_accessanalyzer.types.create_service_linked_analyzer_response.CreateServiceLinkedAnalyzerResponse = aws_sdk_accessanalyzer.types.create_service_linked_analyzer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.create_service_linked_analyzer_request.CreateServiceLinkedAnalyzerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_accessanalyzer.types.create_service_linked_analyzer_request.serialize_json(
            input_
        )
    ).encode()
