...
if TYPE_CHECKING:
    import aws_sdk_accessanalyzer.types.get_archive_rule_request
    import aws_sdk_accessanalyzer.types.get_archive_rule_response
...
) -> aws_sdk_accessanalyzer.types.get_archive_rule_response.GetArchiveRuleResponse:
    import aws_sdk_accessanalyzer.types.get_archive_rule_response

    out: aws_sdk_accessanalyzer.types.get_archive_rule_response.GetArchiveRuleResponse = aws_sdk_accessanalyzer.types.get_archive_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_accessanalyzer.types.get_archive_rule_request.GetArchiveRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
