"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.accessanalyzer#ThrottlingException``."""
