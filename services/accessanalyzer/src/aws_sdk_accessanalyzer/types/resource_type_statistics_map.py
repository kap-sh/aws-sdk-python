...
if TYPE_CHECKING:
    ...
    import aws_sdk_accessanalyzer.types.resource_type_details

ResourceTypeStatisticsMap: TypeAlias = dict[
    "aws_sdk_accessanalyzer.types.resource_type.ResourceType",
    "aws_sdk_accessanalyzer.types.resource_type_details.ResourceTypeDetails",
]
...
def serialize_json(input_to_serialize: ResourceTypeStatisticsMap) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_accessanalyzer.types.resource_type_details.serialize_json(
            value
        )
    return out
...
def deserialize_json(data: dict) -> ResourceTypeStatisticsMap:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_accessanalyzer.types.resource_type_details.deserialize_json(
            value
        )
    return out
