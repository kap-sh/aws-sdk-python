...
class RdsDbClusterSnapshotConfiguration(TypedDict):
    ...
    kms_key_id: NotRequired[
        "aws_sdk_accessanalyzer.types.rds_db_cluster_snapshot_kms_key_id.RdsDbClusterSnapshotKmsKeyId"
    ]
...
def serialize_json(value: RdsDbClusterSnapshotConfiguration) -> dict:
    ...
    if "attributes" in value:
        ...
        out["attributes"] = (
            aws_sdk_accessanalyzer.types.rds_db_cluster_snapshot_attributes_map.serialize_json(
                value["attributes"]
            )
        )
...
def deserialize_json(data: dict) -> RdsDbClusterSnapshotConfiguration:
    ...
    if "attributes" in data:
        ...
        out["attributes"] = (
            aws_sdk_accessanalyzer.types.rds_db_cluster_snapshot_attributes_map.deserialize_json(
                data["attributes"]
            )
        )
    if "kmsKeyId" in data:
