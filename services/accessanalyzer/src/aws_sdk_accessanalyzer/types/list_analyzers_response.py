...
if TYPE_CHECKING:
    import aws_sdk_accessanalyzer.types.analyzers_list
    import aws_sdk_accessanalyzer.types.token


class ListAnalyzersResponse(TypedDict):
    analyzers: "aws_sdk_accessanalyzer.types.analyzers_list.AnalyzersList"
...
def serialize_json(value: ListAnalyzersResponse) -> dict:
    ...
    out["analyzers"] = aws_sdk_accessanalyzer.types.analyzers_list.serialize_json(
        value["analyzers"]
    )
...
def deserialize_json(data: dict) -> ListAnalyzersResponse:
    ...
    if "analyzers" in data:
        ...
        out["analyzers"] = aws_sdk_accessanalyzer.types.analyzers_list.deserialize_json(
            data["analyzers"]
        )
    else:
