...
if TYPE_CHECKING:
    import aws_sdk_accessanalyzer.types.issue_code
    import aws_sdk_accessanalyzer.types.learn_more_link
    import aws_sdk_accessanalyzer.types.location_list
...
class ValidatePolicyFinding(TypedDict, closed=True):
    ...
    issue_code: "aws_sdk_accessanalyzer.types.issue_code.IssueCode"
    """<p>The issue code provides an identifier of the issue associated with this finding.</p>"""
    learn_more_link: "aws_sdk_accessanalyzer.types.learn_more_link.LearnMoreLink"
    """<p>A link to additional documentation about the type of finding.</p>"""
    locations: "aws_sdk_accessanalyzer.types.location_list.LocationList"
...
def serialize_json(value: ValidatePolicyFinding) -> dict:
    ...
    out["locations"] = aws_sdk_accessanalyzer.types.location_list.serialize_json(
        value["locations"]
    )
    return out
...
def deserialize_json(data: dict) -> ValidatePolicyFinding:
    ...
    if "locations" in data:
        ...
        out["locations"] = aws_sdk_accessanalyzer.types.location_list.deserialize_json(
            data["locations"]
        )
    else:
