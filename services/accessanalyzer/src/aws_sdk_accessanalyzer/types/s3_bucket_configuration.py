...
if TYPE_CHECKING:
    import aws_sdk_accessanalyzer.types.s3_access_point_configurations_map
    import aws_sdk_accessanalyzer.types.s3_bucket_acl_grant_configurations_list
    import aws_sdk_accessanalyzer.types.s3_bucket_policy
...
class S3BucketConfiguration(TypedDict):
    bucket_policy: NotRequired[
        "aws_sdk_accessanalyzer.types.s3_bucket_policy.S3BucketPolicy"
    ]
    """<p>The proposed bucket policy for the Amazon S3 bucket.</p>"""
    bucket_acl_grants: NotRequired[
        "aws_sdk_accessanalyzer.types.s3_bucket_acl_grant_configurations_list.S3BucketAclGrantConfigurationsList"
    ]
    ...
    access_points: NotRequired[
        "aws_sdk_accessanalyzer.types.s3_access_point_configurations_map.S3AccessPointConfigurationsMap"
    ]
...
def serialize_json(value: S3BucketConfiguration) -> dict:
    ...
    if "bucket_acl_grants" in value:
        ...
        out["bucketAclGrants"] = (
            aws_sdk_accessanalyzer.types.s3_bucket_acl_grant_configurations_list.serialize_json(
    ...
    if "access_points" in value:
        ...
        out["accessPoints"] = (
            aws_sdk_accessanalyzer.types.s3_access_point_configurations_map.serialize_json(
                value["access_points"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> S3BucketConfiguration:
    ...
    if "bucketAclGrants" in data:
        ...
        out["bucket_acl_grants"] = (
            aws_sdk_accessanalyzer.types.s3_bucket_acl_grant_configurations_list.deserialize_json(
    ...
    if "accessPoints" in data:
        ...
        out["access_points"] = (
            aws_sdk_accessanalyzer.types.s3_access_point_configurations_map.deserialize_json(
                data["accessPoints"]
            )
        )
    return out
