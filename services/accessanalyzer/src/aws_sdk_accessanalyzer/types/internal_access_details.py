...
if TYPE_CHECKING:
    ...
    import aws_sdk_accessanalyzer.types.internal_access_type
    import aws_sdk_accessanalyzer.types.principal_map
    import aws_sdk_accessanalyzer.types.principal_type
...
class InternalAccessDetails(TypedDict, closed=True):
    ...
    access_type: NotRequired[
        "aws_sdk_accessanalyzer.types.internal_access_type.InternalAccessType"
    ]
    ...
    principal_type: NotRequired[
        "aws_sdk_accessanalyzer.types.principal_type.PrincipalType"
    ]
    ...
    service_control_policy_restriction: NotRequired[
        "aws_sdk_accessanalyzer.types.service_control_policy_restriction.ServiceControlPolicyRestriction"
    ]
