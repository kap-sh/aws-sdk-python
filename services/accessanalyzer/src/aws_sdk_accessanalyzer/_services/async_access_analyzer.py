...
from aws_sdk_accessanalyzer._services._aws_config import aaws_config
...
class AsyncAccessAnalyzerClientConfig(TypedDict, total=False):
...
class AsyncAccessAnalyzerClient:
    ...
    async def apply_archive_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.apply_archive_rule_request.ApplyArchiveRuleRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.apply_archive_rule.async_apply_archive_rule(
    ...
    async def cancel_policy_generation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.cancel_policy_generation_request.CancelPolicyGenerationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.cancel_policy_generation_response.CancelPolicyGenerationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.cancel_policy_generation.async_cancel_policy_generation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def check_access_not_granted(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.check_access_not_granted_request.CheckAccessNotGrantedRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.check_access_not_granted_response.CheckAccessNotGrantedResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.check_access_not_granted.async_check_access_not_granted(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def check_no_new_access(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.check_no_new_access_request.CheckNoNewAccessRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.check_no_new_access_response.CheckNoNewAccessResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.check_no_new_access.async_check_no_new_access(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def check_no_public_access(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.check_no_public_access_request.CheckNoPublicAccessRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.check_no_public_access_response.CheckNoPublicAccessResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.check_no_public_access.async_check_no_public_access(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_access_preview(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.create_access_preview_request.CreateAccessPreviewRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.create_access_preview_response.CreateAccessPreviewResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.create_access_preview.async_create_access_preview(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_service_linked_analyzer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.create_service_linked_analyzer_request.CreateServiceLinkedAnalyzerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.create_service_linked_analyzer_response.CreateServiceLinkedAnalyzerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.create_service_linked_analyzer.async_create_service_linked_analyzer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_finding_recommendation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.generate_finding_recommendation_request.GenerateFindingRecommendationRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.generate_finding_recommendation.async_generate_finding_recommendation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_access_preview(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.get_access_preview_request.GetAccessPreviewRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.get_access_preview_response.GetAccessPreviewResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.get_access_preview.async_get_access_preview(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_analyzed_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.get_analyzed_resource_request.GetAnalyzedResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.get_analyzed_resource_response.GetAnalyzedResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.get_analyzed_resource.async_get_analyzed_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_finding(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.get_finding_request.GetFindingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.get_finding_response.GetFindingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.get_finding.async_get_finding(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_finding_recommendation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.get_finding_recommendation_request.GetFindingRecommendationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.get_finding_recommendation_response.GetFindingRecommendationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.get_finding_recommendation.async_get_finding_recommendation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_finding_recommendation(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional["aws_sdk_accessanalyzer.types.token.Token"] = None,
    ) -> "AsyncIterator[aws_sdk_accessanalyzer.types.recommended_step.RecommendedStep]":
        _token = next_token
        while True:
    ...
    async def get_findings_statistics(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.get_findings_statistics_request.GetFindingsStatisticsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.get_findings_statistics_response.GetFindingsStatisticsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.get_findings_statistics.async_get_findings_statistics(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_finding_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.get_finding_v2_request.GetFindingV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.get_finding_v2_response.GetFindingV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.get_finding_v2.async_get_finding_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_generated_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.get_generated_policy_request.GetGeneratedPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.get_generated_policy_response.GetGeneratedPolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.get_generated_policy.async_get_generated_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_access_preview_findings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.list_access_preview_findings_request.ListAccessPreviewFindingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.list_access_preview_findings_response.ListAccessPreviewFindingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.list_access_preview_findings.async_list_access_preview_findings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_access_previews(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.list_access_previews_request.ListAccessPreviewsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.list_access_previews_response.ListAccessPreviewsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.list_access_previews.async_list_access_previews(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_analyzed_resources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.list_analyzed_resources_request.ListAnalyzedResourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.list_analyzed_resources_response.ListAnalyzedResourcesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.list_analyzed_resources.async_list_analyzed_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_findings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.list_findings_request.ListFindingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.list_findings_response.ListFindingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.list_findings.async_list_findings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_findings_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.list_findings_v2_request.ListFindingsV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.list_findings_v2_response.ListFindingsV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.list_findings_v2.async_list_findings_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_policy_generations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.list_policy_generations_request.ListPolicyGenerationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.list_policy_generations_response.ListPolicyGenerationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.list_policy_generations.async_list_policy_generations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_policy_generation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.start_policy_generation_request.StartPolicyGenerationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.start_policy_generation_response.StartPolicyGenerationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.start_policy_generation.async_start_policy_generation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_resource_scan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.start_resource_scan_request.StartResourceScanRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.start_resource_scan.async_start_resource_scan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_findings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.update_findings_request.UpdateFindingsRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.update_findings.async_update_findings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def validate_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_accessanalyzer.types.validate_policy_request.ValidatePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_accessanalyzer.types.validate_policy_response.ValidatePolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_accessanalyzer._operations.access_analyzer.validate_policy.async_validate_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
