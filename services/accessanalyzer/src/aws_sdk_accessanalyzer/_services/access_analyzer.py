...
from aws_sdk_accessanalyzer._auth._identity import Credentials
from aws_sdk_accessanalyzer._auth._providers import (
    CredentialsProvider,
...
from aws_sdk_accessanalyzer._resources.access_analyzer.analyzer import Analyzer
from aws_sdk_accessanalyzer._services._aws_config import aws_config
...
if TYPE_CHECKING:
    ...
    import aws_sdk_accessanalyzer.types.apply_archive_rule_request
    import aws_sdk_accessanalyzer.types.cancel_policy_generation_request
    import aws_sdk_accessanalyzer.types.cancel_policy_generation_response
    import aws_sdk_accessanalyzer.types.check_access_not_granted_request
    import aws_sdk_accessanalyzer.types.check_access_not_granted_response
    import aws_sdk_accessanalyzer.types.check_no_new_access_request
    import aws_sdk_accessanalyzer.types.check_no_new_access_response
    import aws_sdk_accessanalyzer.types.check_no_public_access_request
    import aws_sdk_accessanalyzer.types.check_no_public_access_response
    import aws_sdk_accessanalyzer.types.cloud_trail_details
    import aws_sdk_accessanalyzer.types.configurations_map
    import aws_sdk_accessanalyzer.types.create_access_preview_request
    import aws_sdk_accessanalyzer.types.create_access_preview_response
    import aws_sdk_accessanalyzer.types.create_service_linked_analyzer_request
    import aws_sdk_accessanalyzer.types.create_service_linked_analyzer_response
    ...
    import aws_sdk_accessanalyzer.types.generate_finding_recommendation_request
    import aws_sdk_accessanalyzer.types.get_access_preview_request
    import aws_sdk_accessanalyzer.types.get_access_preview_response
    import aws_sdk_accessanalyzer.types.get_analyzed_resource_request
    import aws_sdk_accessanalyzer.types.get_analyzed_resource_response
    import aws_sdk_accessanalyzer.types.get_finding_recommendation_request
    import aws_sdk_accessanalyzer.types.get_finding_recommendation_response
    import aws_sdk_accessanalyzer.types.get_finding_request
    import aws_sdk_accessanalyzer.types.get_finding_response
    import aws_sdk_accessanalyzer.types.get_finding_v2_request
    import aws_sdk_accessanalyzer.types.get_finding_v2_response
    import aws_sdk_accessanalyzer.types.get_findings_statistics_request
    import aws_sdk_accessanalyzer.types.get_findings_statistics_response
    import aws_sdk_accessanalyzer.types.get_generated_policy_request
    import aws_sdk_accessanalyzer.types.get_generated_policy_response
    import aws_sdk_accessanalyzer.types.inline_archive_rules_list
    import aws_sdk_accessanalyzer.types.job_id
    import aws_sdk_accessanalyzer.types.list_access_preview_findings_request
    import aws_sdk_accessanalyzer.types.list_access_preview_findings_response
    ...
    import aws_sdk_accessanalyzer.types.list_analyzed_resources_request
    import aws_sdk_accessanalyzer.types.list_analyzed_resources_response
    import aws_sdk_accessanalyzer.types.list_findings_request
    import aws_sdk_accessanalyzer.types.list_findings_response
    import aws_sdk_accessanalyzer.types.list_findings_v2_request
    import aws_sdk_accessanalyzer.types.list_findings_v2_response
    import aws_sdk_accessanalyzer.types.list_policy_generations_request
    import aws_sdk_accessanalyzer.types.list_policy_generations_response
    import aws_sdk_accessanalyzer.types.list_tags_for_resource_request
    import aws_sdk_accessanalyzer.types.list_tags_for_resource_response
    ...
    import aws_sdk_accessanalyzer.types.policy_generation_details
    ...
    import aws_sdk_accessanalyzer.types.start_policy_generation_request
    import aws_sdk_accessanalyzer.types.start_policy_generation_response
    import aws_sdk_accessanalyzer.types.start_resource_scan_request
    import aws_sdk_accessanalyzer.types.tag_keys
    import aws_sdk_accessanalyzer.types.tag_resource_request
    import aws_sdk_accessanalyzer.types.tag_resource_response
    ...
    import aws_sdk_accessanalyzer.types.untag_resource_request
    import aws_sdk_accessanalyzer.types.untag_resource_response
    import aws_sdk_accessanalyzer.types.update_findings_request
    import aws_sdk_accessanalyzer.types.validate_policy_request
    import aws_sdk_accessanalyzer.types.validate_policy_resource_type
    import aws_sdk_accessanalyzer.types.validate_policy_response


class AccessAnalyzerClientConfig(TypedDict, total=False):
...
class AccessAnalyzerClient:
    ...
    def apply_archive_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.apply_archive_rule_request.ApplyArchiveRuleRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.apply_archive_rule

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.apply_archive_rule.apply_archive_rule(
    ...
    def cancel_policy_generation(
        ...
        *,
        config_overrides: Optional[AccessAnalyzerClientConfig] = None,
    ) -> "aws_sdk_accessanalyzer.types.cancel_policy_generation_response.CancelPolicyGenerationResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.cancel_policy_generation_request.CancelPolicyGenerationRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.cancel_policy_generation_response.CancelPolicyGenerationResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.cancel_policy_generation

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.cancel_policy_generation.cancel_policy_generation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def check_access_not_granted(
        ...
        policy_type: "aws_sdk_accessanalyzer.types.access_check_policy_type.AccessCheckPolicyType",
        *,
        config_overrides: Optional[AccessAnalyzerClientConfig] = None,
    ) -> "aws_sdk_accessanalyzer.types.check_access_not_granted_response.CheckAccessNotGrantedResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.check_access_not_granted_request.CheckAccessNotGrantedRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.check_access_not_granted_response.CheckAccessNotGrantedResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.check_access_not_granted

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.check_access_not_granted.check_access_not_granted(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def check_no_new_access(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.check_no_new_access_request.CheckNoNewAccessRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.check_no_new_access_response.CheckNoNewAccessResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.check_no_new_access

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.check_no_new_access.check_no_new_access(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def check_no_public_access(
        ...
        *,
        config_overrides: Optional[AccessAnalyzerClientConfig] = None,
    ) -> "aws_sdk_accessanalyzer.types.check_no_public_access_response.CheckNoPublicAccessResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.check_no_public_access_request.CheckNoPublicAccessRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.check_no_public_access_response.CheckNoPublicAccessResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.check_no_public_access

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.check_no_public_access.check_no_public_access(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_access_preview(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.create_access_preview_request.CreateAccessPreviewRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.create_access_preview_response.CreateAccessPreviewResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.create_access_preview

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.create_access_preview.create_access_preview(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_service_linked_analyzer(
        ...
        *,
    ...
    ) -> "aws_sdk_accessanalyzer.types.create_service_linked_analyzer_response.CreateServiceLinkedAnalyzerResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.create_service_linked_analyzer_request.CreateServiceLinkedAnalyzerRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.create_service_linked_analyzer_response.CreateServiceLinkedAnalyzerResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.create_service_linked_analyzer

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.create_service_linked_analyzer.create_service_linked_analyzer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def generate_finding_recommendation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.generate_finding_recommendation_request.GenerateFindingRecommendationRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.generate_finding_recommendation

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.generate_finding_recommendation.generate_finding_recommendation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_access_preview(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.get_access_preview_request.GetAccessPreviewRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.get_access_preview_response.GetAccessPreviewResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.get_access_preview

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.get_access_preview.get_access_preview(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_analyzed_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.get_analyzed_resource_request.GetAnalyzedResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.get_analyzed_resource_response.GetAnalyzedResourceResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.get_analyzed_resource

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.get_analyzed_resource.get_analyzed_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_finding(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.get_finding_request.GetFindingRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.get_finding_response.GetFindingResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.get_finding

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.get_finding.get_finding(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_finding_recommendation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.get_finding_recommendation_request.GetFindingRecommendationRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.get_finding_recommendation_response.GetFindingRecommendationResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.get_finding_recommendation

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.get_finding_recommendation.get_finding_recommendation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_get_finding_recommendation(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional["aws_sdk_accessanalyzer.types.token.Token"] = None,
    ) -> "Iterator[aws_sdk_accessanalyzer.types.recommended_step.RecommendedStep]":
        _token = next_token
        while True:
    ...
    def get_findings_statistics(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.get_findings_statistics_request.GetFindingsStatisticsRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.get_findings_statistics_response.GetFindingsStatisticsResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.get_findings_statistics

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.get_findings_statistics.get_findings_statistics(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_finding_v2(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.get_finding_v2_request.GetFindingV2Request]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.get_finding_v2_response.GetFindingV2Response"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.get_finding_v2

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.get_finding_v2.get_finding_v2(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_generated_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.get_generated_policy_request.GetGeneratedPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.get_generated_policy_response.GetGeneratedPolicyResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.get_generated_policy

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.get_generated_policy.get_generated_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_access_preview_findings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.list_access_preview_findings_request.ListAccessPreviewFindingsRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.list_access_preview_findings_response.ListAccessPreviewFindingsResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.list_access_preview_findings

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.list_access_preview_findings.list_access_preview_findings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_access_previews(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.list_access_previews_request.ListAccessPreviewsRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.list_access_previews_response.ListAccessPreviewsResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.list_access_previews

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.list_access_previews.list_access_previews(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_analyzed_resources(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.list_analyzed_resources_request.ListAnalyzedResourcesRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.list_analyzed_resources_response.ListAnalyzedResourcesResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.list_analyzed_resources

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.list_analyzed_resources.list_analyzed_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_findings(
        ...
        *,
        ...
        sort: Optional[
            "aws_sdk_accessanalyzer.types.sort_criteria.SortCriteria"
        ] = None,
        next_token: Optional["aws_sdk_accessanalyzer.types.token.Token"] = None,
        max_results: Optional[int] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.list_findings_request.ListFindingsRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.list_findings_response.ListFindingsResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.list_findings

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.list_findings.list_findings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_findings_v2(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.list_findings_v2_request.ListFindingsV2Request]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.list_findings_v2_response.ListFindingsV2Response"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.list_findings_v2

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.list_findings_v2.list_findings_v2(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_policy_generations(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional["aws_sdk_accessanalyzer.types.token.Token"] = None,
    ) -> "aws_sdk_accessanalyzer.types.list_policy_generations_response.ListPolicyGenerationsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.list_policy_generations_request.ListPolicyGenerationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.list_policy_generations_response.ListPolicyGenerationsResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.list_policy_generations

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.list_policy_generations.list_policy_generations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        config_overrides: Optional[AccessAnalyzerClientConfig] = None,
    ) -> "aws_sdk_accessanalyzer.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.list_tags_for_resource

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_policy_generation(
        self,
        policy_generation_details: "aws_sdk_accessanalyzer.types.policy_generation_details.PolicyGenerationDetails",
        *,
        config_overrides: Optional[AccessAnalyzerClientConfig] = None,
        cloud_trail_details: Optional[
            "aws_sdk_accessanalyzer.types.cloud_trail_details.CloudTrailDetails"
        ] = None,
        client_token: Optional[str] = None,
    ) -> "aws_sdk_accessanalyzer.types.start_policy_generation_response.StartPolicyGenerationResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.start_policy_generation_request.StartPolicyGenerationRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.start_policy_generation_response.StartPolicyGenerationResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.start_policy_generation

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.start_policy_generation.start_policy_generation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_resource_scan(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.start_resource_scan_request.StartResourceScanRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.start_resource_scan

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.start_resource_scan.start_resource_scan(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        config_overrides: Optional[AccessAnalyzerClientConfig] = None,
    ) -> "aws_sdk_accessanalyzer.types.tag_resource_response.TagResourceResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.tag_resource_response.TagResourceResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.tag_resource

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        self,
        resource_arn: str,
        tag_keys: "aws_sdk_accessanalyzer.types.tag_keys.TagKeys",
        *,
        config_overrides: Optional[AccessAnalyzerClientConfig] = None,
    ) -> "aws_sdk_accessanalyzer.types.untag_resource_response.UntagResourceResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.untag_resource_response.UntagResourceResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.untag_resource

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_findings(
        ...
        *,
        config_overrides: Optional[AccessAnalyzerClientConfig] = None,
        ids: Optional[
            "aws_sdk_accessanalyzer.types.finding_id_list.FindingIdList"
        ] = None,
        resource_arn: Optional[
            "aws_sdk_accessanalyzer.types.resource_arn.ResourceArn"
        ] = None,
        client_token: Optional[str] = None,
    ) -> None:
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.update_findings_request.UpdateFindingsRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.update_findings

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.update_findings.update_findings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def validate_policy(
        ...
        *,
        config_overrides: Optional[AccessAnalyzerClientConfig] = None,
        locale: Optional["aws_sdk_accessanalyzer.types.locale.Locale"] = None,
        max_results: Optional[int] = None,
        next_token: Optional["aws_sdk_accessanalyzer.types.token.Token"] = None,
    ...
    ) -> "aws_sdk_accessanalyzer.types.validate_policy_response.ValidatePolicyResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_accessanalyzer.types.validate_policy_request.ValidatePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_accessanalyzer.types.validate_policy_response.ValidatePolicyResponse"
        ]:
            import aws_sdk_accessanalyzer._operations.access_analyzer.validate_policy

            output, http_response = (
                aws_sdk_accessanalyzer._operations.access_analyzer.validate_policy.validate_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
