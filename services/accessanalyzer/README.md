...
```
pip install aws-sdk-accessanalyzer
```

## Usage

```python
from aws_sdk_accessanalyzer import AsyncAccessAnalyzerClient
...
```python
from aws_sdk_accessanalyzer import AsyncAccessAnalyzerClient
from aws_sdk_accessanalyzer.error import AccessDeniedException
