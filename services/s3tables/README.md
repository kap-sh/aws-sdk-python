...
```
pip install aws-sdk-s3tables
```

## Usage

```python
from aws_sdk_s3tables import AsyncS3TablesClient


async def main():
    async with AsyncS3TablesClient() as s3:
...
```python
from aws_sdk_s3tables import AsyncS3TablesClient
from aws_sdk_s3tables.error import BadRequestException
