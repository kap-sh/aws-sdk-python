...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.create_table_bucket_response.CreateTableBucketResponse = aws_sdk_s3tables.types.create_table_bucket_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.create_table_bucket_request.CreateTableBucketRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3tables.types.create_table_bucket_request.serialize_json(input_)
    ).encode()
