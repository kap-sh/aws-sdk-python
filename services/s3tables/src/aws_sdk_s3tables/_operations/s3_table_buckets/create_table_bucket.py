...
def build_request(
    ...
    input: aws_sdk_s3tables.types.create_table_bucket_request.CreateTableBucketRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3tables.types.create_table_bucket_request.serialize_json(input)
    ).encode()
