"""Generated from Smithy shape ``com.amazonaws.s3tables#DeleteTableBucketPolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.delete_table_bucket_policy_request.DeleteTableBucketPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_table_bucket_policy(
