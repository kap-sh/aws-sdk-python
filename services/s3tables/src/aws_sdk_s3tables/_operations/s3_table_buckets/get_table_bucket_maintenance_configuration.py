...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_bucket_maintenance_configuration_response.GetTableBucketMaintenanceConfigurationResponse = aws_sdk_s3tables.types.get_table_bucket_maintenance_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.get_table_bucket_maintenance_configuration_request.GetTableBucketMaintenanceConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
