"""Generated from Smithy shape ``com.amazonaws.s3tables#GetTableStorageClass``."""
...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_storage_class_response.GetTableStorageClassResponse = aws_sdk_s3tables.types.get_table_storage_class_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.get_table_storage_class_request.GetTableStorageClassRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_table_storage_class(
