"""Generated from Smithy shape ``com.amazonaws.s3tables#UpdateTableMetadataLocation``."""
...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.update_table_metadata_location_response.UpdateTableMetadataLocationResponse = aws_sdk_s3tables.types.update_table_metadata_location_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.update_table_metadata_location_request.UpdateTableMetadataLocationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3tables.types.update_table_metadata_location_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_table_metadata_location(
