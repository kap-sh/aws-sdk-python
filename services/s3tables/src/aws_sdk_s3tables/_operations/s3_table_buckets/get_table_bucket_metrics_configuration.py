"""Generated from Smithy shape ``com.amazonaws.s3tables#GetTableBucketMetricsConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_bucket_metrics_configuration_response.GetTableBucketMetricsConfigurationResponse = aws_sdk_s3tables.types.get_table_bucket_metrics_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.get_table_bucket_metrics_configuration_request.GetTableBucketMetricsConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/buckets/{tableBucketARN}/metrics"
    url = url.replace(
...
async def async_get_table_bucket_metrics_configuration(
