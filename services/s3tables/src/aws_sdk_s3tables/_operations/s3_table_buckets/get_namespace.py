...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_namespace_response.GetNamespaceResponse = (
        aws_sdk_s3tables.types.get_namespace_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.get_namespace_request.GetNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_namespace(
    ...
    aws_sdk_s3tables.types.get_namespace_response.GetNamespaceResponse, zapros.Response
]:
