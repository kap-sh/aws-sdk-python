...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.list_tables_response.ListTablesResponse = (
        aws_sdk_s3tables.types.list_tables_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.list_tables_request.ListTablesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_tables(
    ...
    aws_sdk_s3tables.types.list_tables_response.ListTablesResponse, zapros.Response
]:
