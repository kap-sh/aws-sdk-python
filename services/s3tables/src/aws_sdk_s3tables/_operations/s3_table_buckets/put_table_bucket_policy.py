...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.put_table_bucket_policy_request.PutTableBucketPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3tables.types.put_table_bucket_policy_request.serialize_json(input_)
    ).encode()
