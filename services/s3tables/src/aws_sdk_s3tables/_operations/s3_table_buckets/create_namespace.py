"""Generated from Smithy shape ``com.amazonaws.s3tables#CreateNamespace``."""
...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.create_namespace_response.CreateNamespaceResponse = (
        aws_sdk_s3tables.types.create_namespace_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.create_namespace_request.CreateNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3tables.types.create_namespace_request.serialize_json(input_)
    ).encode()
