...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.put_table_replication_response.PutTableReplicationResponse = aws_sdk_s3tables.types.put_table_replication_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.put_table_replication_request.PutTableReplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3tables.types.put_table_replication_request.serialize_json(input_)
    ).encode()
