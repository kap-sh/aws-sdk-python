...
def build_request(
    ...
    input: aws_sdk_s3tables.types.put_table_replication_request.PutTableReplicationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3tables.types.put_table_replication_request.serialize_json(input)
    ).encode()
