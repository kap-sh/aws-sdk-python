"""Generated from Smithy shape ``com.amazonaws.s3tables#GetTableEncryption``."""
...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_encryption_response.GetTableEncryptionResponse = aws_sdk_s3tables.types.get_table_encryption_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.get_table_encryption_request.GetTableEncryptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_table_encryption(
