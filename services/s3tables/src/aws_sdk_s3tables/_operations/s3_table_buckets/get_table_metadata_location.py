...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_metadata_location_response.GetTableMetadataLocationResponse = aws_sdk_s3tables.types.get_table_metadata_location_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.get_table_metadata_location_request.GetTableMetadataLocationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
