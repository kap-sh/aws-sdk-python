"""Generated from Smithy shape ``com.amazonaws.s3tables#DeleteTableReplication``."""
...
def build_request(
    ...
    input: aws_sdk_s3tables.types.delete_table_replication_request.DeleteTableReplicationRequest,
) -> zapros.Request:
    ...
    if "version_token" in input:
        params["versionToken"] = str(input["version_token"])
...
async def async_delete_table_replication(
