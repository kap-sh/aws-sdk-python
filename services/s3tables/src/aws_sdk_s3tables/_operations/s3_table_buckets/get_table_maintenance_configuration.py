"""Generated from Smithy shape ``com.amazonaws.s3tables#GetTableMaintenanceConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_maintenance_configuration_response.GetTableMaintenanceConfigurationResponse = aws_sdk_s3tables.types.get_table_maintenance_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.get_table_maintenance_configuration_request.GetTableMaintenanceConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_table_maintenance_configuration(
