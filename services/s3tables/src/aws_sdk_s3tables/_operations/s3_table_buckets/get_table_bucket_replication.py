...
def build_request(
    ...
    input: aws_sdk_s3tables.types.get_table_bucket_replication_request.GetTableBucketReplicationRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "table_bucket_arn" in input:
        params["tableBucketARN"] = str(input["table_bucket_arn"])
