...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_policy_response.GetTablePolicyResponse = (
        aws_sdk_s3tables.types.get_table_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.get_table_policy_request.GetTablePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
