...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_maintenance_job_status_response.GetTableMaintenanceJobStatusResponse = aws_sdk_s3tables.types.get_table_maintenance_job_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.get_table_maintenance_job_status_request.GetTableMaintenanceJobStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
