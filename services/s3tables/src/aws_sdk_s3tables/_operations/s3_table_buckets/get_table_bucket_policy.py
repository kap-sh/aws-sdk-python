...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_bucket_policy_response.GetTableBucketPolicyResponse = aws_sdk_s3tables.types.get_table_bucket_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.get_table_bucket_policy_request.GetTableBucketPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
