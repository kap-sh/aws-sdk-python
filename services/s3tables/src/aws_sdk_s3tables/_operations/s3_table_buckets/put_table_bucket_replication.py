...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.put_table_bucket_replication_response.PutTableBucketReplicationResponse = aws_sdk_s3tables.types.put_table_bucket_replication_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.put_table_bucket_replication_request.PutTableBucketReplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
