...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.list_namespaces_response.ListNamespacesResponse = (
        aws_sdk_s3tables.types.list_namespaces_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_s3tables.types.list_namespaces_request.ListNamespacesRequest,
) -> zapros.Request:
    ...
    if "max_namespaces" in input:
        params["maxNamespaces"] = str(input["max_namespaces"])
