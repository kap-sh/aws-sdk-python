...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_bucket_storage_class_response.GetTableBucketStorageClassResponse = aws_sdk_s3tables.types.get_table_bucket_storage_class_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.get_table_bucket_storage_class_request.GetTableBucketStorageClassRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
