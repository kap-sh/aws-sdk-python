"""Generated from Smithy shape ``com.amazonaws.s3tables#GetTableReplication``."""
...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_replication_response.GetTableReplicationResponse = aws_sdk_s3tables.types.get_table_replication_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_s3tables.types.get_table_replication_request.GetTableReplicationRequest,
) -> zapros.Request:
...
async def async_get_table_replication(
