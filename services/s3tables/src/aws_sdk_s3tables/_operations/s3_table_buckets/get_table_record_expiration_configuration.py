...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_record_expiration_configuration_response.GetTableRecordExpirationConfigurationResponse = aws_sdk_s3tables.types.get_table_record_expiration_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.get_table_record_expiration_configuration_request.GetTableRecordExpirationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
