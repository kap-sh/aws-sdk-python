...
import aws_sdk_s3tables.types.table_record_expiration_job_metrics
...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_record_expiration_job_status_response.GetTableRecordExpirationJobStatusResponse = aws_sdk_s3tables.types.get_table_record_expiration_job_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.get_table_record_expiration_job_status_request.GetTableRecordExpirationJobStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
