...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.create_table_response.CreateTableResponse = (
        aws_sdk_s3tables.types.create_table_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_s3tables.types.create_table_request.CreateTableRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3tables.types.create_table_request.serialize_json(input)
    ).encode()
...
def create_table(
    ...
    aws_sdk_s3tables.types.create_table_response.CreateTableResponse, zapros.Response
]:
