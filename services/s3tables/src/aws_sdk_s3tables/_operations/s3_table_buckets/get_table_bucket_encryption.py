"""Generated from Smithy shape ``com.amazonaws.s3tables#GetTableBucketEncryption``."""
...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_bucket_encryption_response.GetTableBucketEncryptionResponse = aws_sdk_s3tables.types.get_table_bucket_encryption_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.get_table_bucket_encryption_request.GetTableBucketEncryptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_table_bucket_encryption(
