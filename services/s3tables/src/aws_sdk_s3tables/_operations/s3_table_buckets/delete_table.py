"""Generated from Smithy shape ``com.amazonaws.s3tables#DeleteTable``."""
...
def build_request(
    ...
    input: aws_sdk_s3tables.types.delete_table_request.DeleteTableRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/tables/{tableBucketARN}/{namespace}/{name}"
    url = url.replace(
