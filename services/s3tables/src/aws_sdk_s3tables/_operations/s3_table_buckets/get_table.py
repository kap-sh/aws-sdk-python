"""Generated from Smithy shape ``com.amazonaws.s3tables#GetTable``."""
...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_response.GetTableResponse = (
        aws_sdk_s3tables.types.get_table_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_s3tables.types.get_table_request.GetTableRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/get-table"
    params: dict[str, str] = {}
    ...
    if "table_arn" in input:
        params["tableArn"] = str(input["table_arn"])
...
def get_table(
    ...
    input: aws_sdk_s3tables.types.get_table_request.GetTableRequest,
) -> tuple[aws_sdk_s3tables.types.get_table_response.GetTableResponse, zapros.Response]:
