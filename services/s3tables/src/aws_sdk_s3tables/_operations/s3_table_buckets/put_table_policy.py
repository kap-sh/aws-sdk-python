"""Generated from Smithy shape ``com.amazonaws.s3tables#PutTablePolicy``."""
...
def build_request(
    ...
    input_: aws_sdk_s3tables.types.put_table_policy_request.PutTablePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_s3tables.types.put_table_policy_request.serialize_json(input_)
    ).encode()
...
async def async_put_table_policy(
