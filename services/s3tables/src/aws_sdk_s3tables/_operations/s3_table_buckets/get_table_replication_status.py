...
def handle_response(
    ...
    out: aws_sdk_s3tables.types.get_table_replication_status_response.GetTableReplicationStatusResponse = aws_sdk_s3tables.types.get_table_replication_status_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_s3tables.types.get_table_replication_status_request.GetTableReplicationStatusRequest,
) -> zapros.Request:
