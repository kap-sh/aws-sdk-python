"""Generated from Smithy shape ``com.amazonaws.s3tables#PutTableRecordExpirationConfiguration``."""
...
def build_request(
    ...
    input: aws_sdk_s3tables.types.put_table_record_expiration_configuration_request.PutTableRecordExpirationConfigurationRequest,
) -> zapros.Request:
...
async def async_put_table_record_expiration_configuration(
