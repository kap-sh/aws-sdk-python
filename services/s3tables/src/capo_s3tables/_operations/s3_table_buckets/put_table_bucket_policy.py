"""Generated from Smithy shape ``com.amazonaws.s3tables#PutTableBucketPolicy``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_s3tables.types.put_table_bucket_policy_request.serialize_json(input_)
    ).encode()
...
async def async_put_table_bucket_policy(
