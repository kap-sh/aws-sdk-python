...
def handle_response(
    ...
    out: capo_s3tables.types.get_table_bucket_encryption_response.GetTableBucketEncryptionResponse = capo_s3tables.types.get_table_bucket_encryption_response.deserialize_json(
