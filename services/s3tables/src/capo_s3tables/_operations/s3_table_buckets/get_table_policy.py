"""Generated from Smithy shape ``com.amazonaws.s3tables#GetTablePolicy``."""
...
def handle_response(
    ...
    out: capo_s3tables.types.get_table_policy_response.GetTablePolicyResponse = (
        capo_s3tables.types.get_table_policy_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/tables/{tableBucketARN}/{namespace}/{name}/policy"
    )
    url = url.replace(
...
async def async_get_table_policy(
