"""Generated from Smithy shape ``com.amazonaws.s3tables#GetTableRecordExpirationConfiguration``."""
...
import capo_s3tables.errors.method_not_allowed_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MethodNotAllowedException":
            raise capo_s3tables.errors.method_not_allowed_exception.MethodNotAllowedException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_s3tables.types.get_table_record_expiration_configuration_response.GetTableRecordExpirationConfigurationResponse = capo_s3tables.types.get_table_record_expiration_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/table-record-expiration"
    params: dict[str, str] = {}
...
async def async_get_table_record_expiration_configuration(
