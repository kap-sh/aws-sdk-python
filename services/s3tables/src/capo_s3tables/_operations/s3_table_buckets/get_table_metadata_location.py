"""Generated from Smithy shape ``com.amazonaws.s3tables#GetTableMetadataLocation``."""
...
def handle_response(
    ...
    out: capo_s3tables.types.get_table_metadata_location_response.GetTableMetadataLocationResponse = capo_s3tables.types.get_table_metadata_location_response.deserialize_json(
...
async def async_get_table_metadata_location(
