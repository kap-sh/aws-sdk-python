"""Generated from Smithy shape ``com.amazonaws.s3tables#PutTableReplication``."""
...
def handle_response(
    ...
    out: capo_s3tables.types.put_table_replication_response.PutTableReplicationResponse = capo_s3tables.types.put_table_replication_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/table-replication"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        capo_s3tables.types.put_table_replication_request.serialize_json(input_)
    ).encode()
...
async def async_put_table_replication(
