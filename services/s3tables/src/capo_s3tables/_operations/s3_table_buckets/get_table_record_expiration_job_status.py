"""Generated from Smithy shape ``com.amazonaws.s3tables#GetTableRecordExpirationJobStatus``."""
...
def handle_response(
    ...
    out: capo_s3tables.types.get_table_record_expiration_job_status_response.GetTableRecordExpirationJobStatusResponse = capo_s3tables.types.get_table_record_expiration_job_status_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/table-record-expiration-job-status"
    params: dict[str, str] = {}
...
async def async_get_table_record_expiration_job_status(
