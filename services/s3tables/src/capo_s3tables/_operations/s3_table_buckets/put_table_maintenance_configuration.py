"""Generated from Smithy shape ``com.amazonaws.s3tables#PutTableMaintenanceConfiguration``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_s3tables.types.put_table_maintenance_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_table_maintenance_configuration(
