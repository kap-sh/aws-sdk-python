"""Generated from Smithy shape ``com.amazonaws.s3tables#GetTableReplicationStatus``."""
...
def handle_response(
    ...
    out: capo_s3tables.types.get_table_replication_status_response.GetTableReplicationStatusResponse = capo_s3tables.types.get_table_replication_status_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/replication-status"
    params: dict[str, str] = {}
...
async def async_get_table_replication_status(
