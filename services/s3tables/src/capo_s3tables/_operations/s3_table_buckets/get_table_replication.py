...
def handle_response(
    ...
    out: capo_s3tables.types.get_table_replication_response.GetTableReplicationResponse = capo_s3tables.types.get_table_replication_response.deserialize_json(
