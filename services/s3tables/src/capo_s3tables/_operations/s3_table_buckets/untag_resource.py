"""Generated from Smithy shape ``com.amazonaws.s3tables#UntagResource``."""
...
def handle_response(
    ...
    out: capo_s3tables.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_s3tables.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
