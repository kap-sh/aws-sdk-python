...
def handle_response(
    ...
    out: capo_s3tables.types.get_table_response.GetTableResponse = (
        capo_s3tables.types.get_table_response.deserialize_json(
...
def get_table(
    ...
    input_: capo_s3tables.types.get_table_request.GetTableRequest,
) -> tuple[capo_s3tables.types.get_table_response.GetTableResponse, zapros.Response]:
