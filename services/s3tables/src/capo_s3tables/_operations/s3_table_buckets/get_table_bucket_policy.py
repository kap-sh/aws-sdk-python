"""Generated from Smithy shape ``com.amazonaws.s3tables#GetTableBucketPolicy``."""
...
def handle_response(
    ...
    out: capo_s3tables.types.get_table_bucket_policy_response.GetTableBucketPolicyResponse = capo_s3tables.types.get_table_bucket_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/buckets/{tableBucketARN}/policy"
    url = url.replace(
...
async def async_get_table_bucket_policy(
