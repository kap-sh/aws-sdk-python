...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteTablePolicyRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> DeleteTablePolicyRequest:
    out: DeleteTablePolicyRequest = {}  # type: ignore[typeddict-item]
    return out
