...
if TYPE_CHECKING:
    import capo_s3tables.types.schema_v2_field

SchemaV2FieldList: TypeAlias = list["capo_s3tables.types.schema_v2_field.SchemaV2Field"]
...
def serialize_json(value: SchemaV2FieldList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_s3tables.types.schema_v2_field.serialize_json(item))
    return out
