...
```
pip install aws-sdk-elasticsearch-service
```

## Usage

```python
from aws_sdk_elasticsearch_service import AsyncElasticsearchServiceClient
...
```python
from aws_sdk_elasticsearch_service import AsyncElasticsearchServiceClient
from aws_sdk_elasticsearch_service.error import DisabledOperationException
