...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.upgrade_elasticsearch_domain_response.UpgradeElasticsearchDomainResponse = capo_elasticsearch_service.types.upgrade_elasticsearch_domain_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_elasticsearch_service.types.upgrade_elasticsearch_domain_request.serialize_json(
            input_
        )
    ).encode()
