"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#ListPackagesForDomain``."""
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.list_packages_for_domain_response.ListPackagesForDomainResponse = capo_elasticsearch_service.types.list_packages_for_domain_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/domain/{DomainName}/packages"
...
async def async_list_packages_for_domain(
