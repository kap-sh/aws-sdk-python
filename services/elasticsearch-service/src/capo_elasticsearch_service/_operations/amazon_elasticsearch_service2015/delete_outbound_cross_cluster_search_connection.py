"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#DeleteOutboundCrossClusterSearchConnection``."""
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.delete_outbound_cross_cluster_search_connection_response.DeleteOutboundCrossClusterSearchConnectionResponse = capo_elasticsearch_service.types.delete_outbound_cross_cluster_search_connection_response.deserialize_json(
...
async def async_delete_outbound_cross_cluster_search_connection(
