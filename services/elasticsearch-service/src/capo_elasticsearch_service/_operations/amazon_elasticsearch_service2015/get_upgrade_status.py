"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#GetUpgradeStatus``."""
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.get_upgrade_status_response.GetUpgradeStatusResponse = capo_elasticsearch_service.types.get_upgrade_status_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/es/upgradeDomain/{DomainName}/status"
