"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#CreateOutboundCrossClusterSearchConnection``."""
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.create_outbound_cross_cluster_search_connection_response.CreateOutboundCrossClusterSearchConnectionResponse = capo_elasticsearch_service.types.create_outbound_cross_cluster_search_connection_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_elasticsearch_service.types.create_outbound_cross_cluster_search_connection_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_outbound_cross_cluster_search_connection(
