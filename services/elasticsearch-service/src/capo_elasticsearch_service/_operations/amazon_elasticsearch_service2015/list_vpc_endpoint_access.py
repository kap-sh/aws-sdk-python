...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.list_vpc_endpoint_access_response.ListVpcEndpointAccessResponse = capo_elasticsearch_service.types.list_vpc_endpoint_access_response.deserialize_json(
