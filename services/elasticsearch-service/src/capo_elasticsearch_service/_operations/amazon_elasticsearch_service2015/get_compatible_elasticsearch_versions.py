"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#GetCompatibleElasticsearchVersions``."""
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.get_compatible_elasticsearch_versions_response.GetCompatibleElasticsearchVersionsResponse = capo_elasticsearch_service.types.get_compatible_elasticsearch_versions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/es/compatibleVersions"
    params: dict[str, str] = {}
...
async def async_get_compatible_elasticsearch_versions(
