...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.describe_elasticsearch_domain_config_response.DescribeElasticsearchDomainConfigResponse = capo_elasticsearch_service.types.describe_elasticsearch_domain_config_response.deserialize_json(
