...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.describe_domain_auto_tunes_response.DescribeDomainAutoTunesResponse = capo_elasticsearch_service.types.describe_domain_auto_tunes_response.deserialize_json(
