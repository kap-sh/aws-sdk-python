...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.describe_elasticsearch_instance_type_limits_response.DescribeElasticsearchInstanceTypeLimitsResponse = capo_elasticsearch_service.types.describe_elasticsearch_instance_type_limits_response.deserialize_json(
