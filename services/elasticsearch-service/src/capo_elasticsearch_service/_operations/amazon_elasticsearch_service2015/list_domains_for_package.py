"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#ListDomainsForPackage``."""
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.list_domains_for_package_response.ListDomainsForPackageResponse = capo_elasticsearch_service.types.list_domains_for_package_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/packages/{PackageID}/domains"
