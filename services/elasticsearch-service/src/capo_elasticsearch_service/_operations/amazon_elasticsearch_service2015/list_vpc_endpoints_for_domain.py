...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.list_vpc_endpoints_for_domain_response.ListVpcEndpointsForDomainResponse = capo_elasticsearch_service.types.list_vpc_endpoints_for_domain_response.deserialize_json(
