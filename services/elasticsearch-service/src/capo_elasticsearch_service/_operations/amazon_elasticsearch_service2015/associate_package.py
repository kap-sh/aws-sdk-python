...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.associate_package_response.AssociatePackageResponse = capo_elasticsearch_service.types.associate_package_response.deserialize_json(
