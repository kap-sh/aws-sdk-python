"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#RemoveTags``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/tags-removal"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_elasticsearch_service.types.remove_tags_request.serialize_json(input_)
    ).encode()
