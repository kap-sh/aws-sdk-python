"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#DeletePackage``."""
...
import capo_elasticsearch_service.errors.access_denied_exception
import capo_elasticsearch_service.errors.base_exception
import capo_elasticsearch_service.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise capo_elasticsearch_service.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
        case "BaseException":
        ...
        case "ConflictException":
            raise capo_elasticsearch_service.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.delete_package_response.DeletePackageResponse = capo_elasticsearch_service.types.delete_package_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/packages/{PackageID}"
