"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#DeleteVpcEndpoint``."""
...
import capo_elasticsearch_service.types.vpc_endpoint_summary
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.delete_vpc_endpoint_response.DeleteVpcEndpointResponse = capo_elasticsearch_service.types.delete_vpc_endpoint_response.deserialize_json(
