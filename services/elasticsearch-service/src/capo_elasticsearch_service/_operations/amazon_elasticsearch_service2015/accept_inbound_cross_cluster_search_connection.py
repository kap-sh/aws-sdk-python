...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.accept_inbound_cross_cluster_search_connection_response.AcceptInboundCrossClusterSearchConnectionResponse = capo_elasticsearch_service.types.accept_inbound_cross_cluster_search_connection_response.deserialize_json(
