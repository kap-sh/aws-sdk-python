"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#DescribeReservedElasticsearchInstanceOfferings``."""
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.describe_reserved_elasticsearch_instance_offerings_response.DescribeReservedElasticsearchInstanceOfferingsResponse = capo_elasticsearch_service.types.describe_reserved_elasticsearch_instance_offerings_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/es/reservedInstanceOfferings"
    params: dict[str, str] = {}
    if "reserved_elasticsearch_instance_offering_id" in input_:
        params["offeringId"] = str(
...
async def async_describe_reserved_elasticsearch_instance_offerings(
