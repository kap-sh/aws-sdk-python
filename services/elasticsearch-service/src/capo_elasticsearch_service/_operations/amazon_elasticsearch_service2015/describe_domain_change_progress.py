...
import capo_elasticsearch_service.types.change_progress_status_details
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.describe_domain_change_progress_response.DescribeDomainChangeProgressResponse = capo_elasticsearch_service.types.describe_domain_change_progress_response.deserialize_json(
