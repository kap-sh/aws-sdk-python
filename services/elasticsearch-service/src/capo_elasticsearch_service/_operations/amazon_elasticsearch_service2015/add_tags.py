"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#AddTags``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/tags"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_elasticsearch_service.types.add_tags_request.serialize_json(input_)
    ).encode()
