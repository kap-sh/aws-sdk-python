...
class DescribeReservedElasticsearchInstanceOfferingsResponse(TypedDict, closed=True):
    ...
    reserved_elasticsearch_instance_offerings: NotRequired[
        "capo_elasticsearch_service.types.reserved_elasticsearch_instance_offering_list.ReservedElasticsearchInstanceOfferingList"
    ]
...
def serialize_json(
    ...
    if "reserved_elasticsearch_instance_offerings" in value:
        ...
        out["ReservedElasticsearchInstanceOfferings"] = (
            capo_elasticsearch_service.types.reserved_elasticsearch_instance_offering_list.serialize_json(
...
def deserialize_json(
    ...
    if "ReservedElasticsearchInstanceOfferings" in data:
        ...
        out["reserved_elasticsearch_instance_offerings"] = (
            capo_elasticsearch_service.types.reserved_elasticsearch_instance_offering_list.deserialize_json(
