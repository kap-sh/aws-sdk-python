...
if TYPE_CHECKING:
    import capo_elasticsearch_service.types.s3_bucket_name
    import capo_elasticsearch_service.types.s3_key


class PackageSource(TypedDict, closed=True):
    s3_bucket_name: NotRequired[
        "capo_elasticsearch_service.types.s3_bucket_name.S3BucketName"
    ]
    """<p>Name of the bucket containing the package.</p>"""
    s3_key: NotRequired["capo_elasticsearch_service.types.s3_key.S3Key"]
