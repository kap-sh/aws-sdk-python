...
if TYPE_CHECKING:
    import capo_elasticsearch_service.types.change_progress_stage_name
    import capo_elasticsearch_service.types.change_progress_stage_status
    import capo_elasticsearch_service.types.description
    import capo_elasticsearch_service.types.last_updated


class ChangeProgressStage(TypedDict, closed=True):
    name: NotRequired[
        "capo_elasticsearch_service.types.change_progress_stage_name.ChangeProgressStageName"
    ]
    ...
    description: NotRequired["capo_elasticsearch_service.types.description.Description"]
