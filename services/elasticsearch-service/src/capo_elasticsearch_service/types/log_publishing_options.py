...
LogPublishingOptions: TypeAlias = dict[
    "capo_elasticsearch_service.types.log_type.LogType",
    "capo_elasticsearch_service.types.log_publishing_option.LogPublishingOption",
]
...
def serialize_json(input_to_serialize: LogPublishingOptions) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[capo_elasticsearch_service.types.log_type.serialize_json(key)] = (
            capo_elasticsearch_service.types.log_publishing_option.serialize_json(value)
        )
    return out
