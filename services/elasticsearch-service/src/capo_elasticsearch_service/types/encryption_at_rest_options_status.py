"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#EncryptionAtRestOptionsStatus``."""
...
class EncryptionAtRestOptionsStatus(TypedDict, closed=True):
    options: "capo_elasticsearch_service.types.encryption_at_rest_options.EncryptionAtRestOptions"
