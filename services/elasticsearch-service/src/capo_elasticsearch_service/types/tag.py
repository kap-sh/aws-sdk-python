...
if TYPE_CHECKING:
    import capo_elasticsearch_service.types.tag_key
    import capo_elasticsearch_service.types.tag_value


class Tag(TypedDict, closed=True):
    key: "capo_elasticsearch_service.types.tag_key.TagKey"
    ...
    value: "capo_elasticsearch_service.types.tag_value.TagValue"
