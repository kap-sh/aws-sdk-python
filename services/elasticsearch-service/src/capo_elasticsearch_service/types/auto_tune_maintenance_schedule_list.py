...
if TYPE_CHECKING:
    import capo_elasticsearch_service.types.auto_tune_maintenance_schedule

AutoTuneMaintenanceScheduleList: TypeAlias = list[
    "capo_elasticsearch_service.types.auto_tune_maintenance_schedule.AutoTuneMaintenanceSchedule"
]
...
def serialize_json(value: AutoTuneMaintenanceScheduleList) -> list:
    ...
    for item in value:
        out.append(
            capo_elasticsearch_service.types.auto_tune_maintenance_schedule.serialize_json(
                item
            )
        )
    return out
