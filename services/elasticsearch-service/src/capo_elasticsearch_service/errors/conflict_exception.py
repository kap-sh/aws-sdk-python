"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticsearchservice#ConflictException``."""
