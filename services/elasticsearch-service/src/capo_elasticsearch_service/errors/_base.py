...
class ElasticsearchServiceError(Exception):
    """Base class for all ElasticsearchService service errors."""


class ServiceError(ElasticsearchServiceError):
...
class SerializationError(ElasticsearchServiceError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ElasticsearchServiceError):
...
class WaiterFailedError(ElasticsearchServiceError):
...
class WaiterTimeoutError(ElasticsearchServiceError):
