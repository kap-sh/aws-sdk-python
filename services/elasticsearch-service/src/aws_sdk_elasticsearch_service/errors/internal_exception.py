"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#InternalException``."""
...
class InternalException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticsearchservice#InternalException``."""
