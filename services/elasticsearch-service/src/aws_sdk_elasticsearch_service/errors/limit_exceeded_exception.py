"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticsearchservice#LimitExceededException``."""
