...
if TYPE_CHECKING:
    ...
    import aws_sdk_elasticsearch_service.types.advanced_options_status
    import aws_sdk_elasticsearch_service.types.advanced_security_options_status
    import aws_sdk_elasticsearch_service.types.auto_tune_options_status
    import aws_sdk_elasticsearch_service.types.automated_snapshot_pause_options_status
    import aws_sdk_elasticsearch_service.types.change_progress_details
    import aws_sdk_elasticsearch_service.types.cognito_options_status
    import aws_sdk_elasticsearch_service.types.deployment_strategy_options_status
    import aws_sdk_elasticsearch_service.types.domain_endpoint_options_status
    import aws_sdk_elasticsearch_service.types.ebs_options_status
    import aws_sdk_elasticsearch_service.types.elasticsearch_cluster_config_status
    import aws_sdk_elasticsearch_service.types.elasticsearch_version_status
    import aws_sdk_elasticsearch_service.types.encryption_at_rest_options_status
    import aws_sdk_elasticsearch_service.types.log_publishing_options_status
    import aws_sdk_elasticsearch_service.types.modifying_properties_list
    import aws_sdk_elasticsearch_service.types.node_to_node_encryption_options_status
    import aws_sdk_elasticsearch_service.types.snapshot_options_status
...
class ElasticsearchDomainConfig(TypedDict):
    ...
    elasticsearch_cluster_config: NotRequired[
        "aws_sdk_elasticsearch_service.types.elasticsearch_cluster_config_status.ElasticsearchClusterConfigStatus"
    ]
    """<p>Specifies the <code>ElasticsearchClusterConfig</code> for the Elasticsearch domain.</p>"""
    ebs_options: NotRequired[
        "aws_sdk_elasticsearch_service.types.ebs_options_status.EBSOptionsStatus"
    ]
    """<p>Specifies the <code>EBSOptions</code> for the Elasticsearch domain.</p>"""
    access_policies: NotRequired[
        "aws_sdk_elasticsearch_service.types.access_policies_status.AccessPoliciesStatus"
    ]
    """<p>IAM access policy as a JSON-formatted string.</p>"""
    snapshot_options: NotRequired[
        "aws_sdk_elasticsearch_service.types.snapshot_options_status.SnapshotOptionsStatus"
    ]
    ...
    node_to_node_encryption_options: NotRequired[
        "aws_sdk_elasticsearch_service.types.node_to_node_encryption_options_status.NodeToNodeEncryptionOptionsStatus"
    ]
    ...
    domain_endpoint_options: NotRequired[
        "aws_sdk_elasticsearch_service.types.domain_endpoint_options_status.DomainEndpointOptionsStatus"
    ]
    """<p>Specifies the <code>DomainEndpointOptions</code> for the Elasticsearch domain.</p>"""
    advanced_security_options: NotRequired[
        "aws_sdk_elasticsearch_service.types.advanced_security_options_status.AdvancedSecurityOptionsStatus"
    ]
    """<p>Specifies <code>AdvancedSecurityOptions</code> for the domain. </p>"""
    auto_tune_options: NotRequired[
        "aws_sdk_elasticsearch_service.types.auto_tune_options_status.AutoTuneOptionsStatus"
    ]
    ...
    deployment_strategy_options: NotRequired[
        "aws_sdk_elasticsearch_service.types.deployment_strategy_options_status.DeploymentStrategyOptionsStatus"
    ]
    """<p>Specifies <code>DeploymentStrategyOptions</code> for the domain. </p>"""
    automated_snapshot_pause_options: NotRequired[
        "aws_sdk_elasticsearch_service.types.automated_snapshot_pause_options_status.AutomatedSnapshotPauseOptionsStatus"
    ]
...
def serialize_json(value: ElasticsearchDomainConfig) -> dict:
    ...
    if "elasticsearch_version" in value:
        ...
        out["ElasticsearchVersion"] = (
            aws_sdk_elasticsearch_service.types.elasticsearch_version_status.serialize_json(
    ...
    if "elasticsearch_cluster_config" in value:
        ...
        out["ElasticsearchClusterConfig"] = (
            aws_sdk_elasticsearch_service.types.elasticsearch_cluster_config_status.serialize_json(
    ...
    if "ebs_options" in value:
        ...
        out["EBSOptions"] = (
            aws_sdk_elasticsearch_service.types.ebs_options_status.serialize_json(
                value["ebs_options"]
            )
        )
    if "access_policies" in value:
        ...
        out["AccessPolicies"] = (
            aws_sdk_elasticsearch_service.types.access_policies_status.serialize_json(
    ...
    if "snapshot_options" in value:
        ...
        out["SnapshotOptions"] = (
            aws_sdk_elasticsearch_service.types.snapshot_options_status.serialize_json(
    ...
    if "vpc_options" in value:
        ...
        out["VPCOptions"] = (
            aws_sdk_elasticsearch_service.types.vpc_derived_info_status.serialize_json(
                value["vpc_options"]
            )
        )
    if "cognito_options" in value:
        ...
        out["CognitoOptions"] = (
            aws_sdk_elasticsearch_service.types.cognito_options_status.serialize_json(
    ...
    if "encryption_at_rest_options" in value:
        ...
        out["EncryptionAtRestOptions"] = (
            aws_sdk_elasticsearch_service.types.encryption_at_rest_options_status.serialize_json(
    ...
    if "node_to_node_encryption_options" in value:
        ...
        out["NodeToNodeEncryptionOptions"] = (
            aws_sdk_elasticsearch_service.types.node_to_node_encryption_options_status.serialize_json(
    ...
    if "advanced_options" in value:
        ...
        out["AdvancedOptions"] = (
            aws_sdk_elasticsearch_service.types.advanced_options_status.serialize_json(
    ...
    if "log_publishing_options" in value:
        ...
        out["LogPublishingOptions"] = (
            aws_sdk_elasticsearch_service.types.log_publishing_options_status.serialize_json(
    ...
    if "domain_endpoint_options" in value:
        ...
        out["DomainEndpointOptions"] = (
            aws_sdk_elasticsearch_service.types.domain_endpoint_options_status.serialize_json(
    ...
    if "advanced_security_options" in value:
        ...
        out["AdvancedSecurityOptions"] = (
            aws_sdk_elasticsearch_service.types.advanced_security_options_status.serialize_json(
    ...
    if "auto_tune_options" in value:
        ...
        out["AutoTuneOptions"] = (
            aws_sdk_elasticsearch_service.types.auto_tune_options_status.serialize_json(
    ...
    if "deployment_strategy_options" in value:
        ...
        out["DeploymentStrategyOptions"] = (
            aws_sdk_elasticsearch_service.types.deployment_strategy_options_status.serialize_json(
    ...
    if "automated_snapshot_pause_options" in value:
        ...
        out["AutomatedSnapshotPauseOptions"] = (
            aws_sdk_elasticsearch_service.types.automated_snapshot_pause_options_status.serialize_json(
...
def deserialize_json(data: dict) -> ElasticsearchDomainConfig:
    ...
    if "ElasticsearchVersion" in data:
        ...
        out["elasticsearch_version"] = (
            aws_sdk_elasticsearch_service.types.elasticsearch_version_status.deserialize_json(
    ...
    if "ElasticsearchClusterConfig" in data:
        ...
        out["elasticsearch_cluster_config"] = (
            aws_sdk_elasticsearch_service.types.elasticsearch_cluster_config_status.deserialize_json(
    ...
    if "EBSOptions" in data:
        ...
        out["ebs_options"] = (
            aws_sdk_elasticsearch_service.types.ebs_options_status.deserialize_json(
                data["EBSOptions"]
            )
        )
    if "AccessPolicies" in data:
        ...
        out["access_policies"] = (
            aws_sdk_elasticsearch_service.types.access_policies_status.deserialize_json(
                data["AccessPolicies"]
            )
        )
    if "SnapshotOptions" in data:
        ...
        out["snapshot_options"] = (
            aws_sdk_elasticsearch_service.types.snapshot_options_status.deserialize_json(
    ...
    if "VPCOptions" in data:
        ...
        out["vpc_options"] = (
            aws_sdk_elasticsearch_service.types.vpc_derived_info_status.deserialize_json(
                data["VPCOptions"]
            )
        )
    if "CognitoOptions" in data:
        ...
        out["cognito_options"] = (
            aws_sdk_elasticsearch_service.types.cognito_options_status.deserialize_json(
                data["CognitoOptions"]
            )
        )
    if "EncryptionAtRestOptions" in data:
        ...
        out["encryption_at_rest_options"] = (
            aws_sdk_elasticsearch_service.types.encryption_at_rest_options_status.deserialize_json(
    ...
    if "NodeToNodeEncryptionOptions" in data:
        ...
        out["node_to_node_encryption_options"] = (
            aws_sdk_elasticsearch_service.types.node_to_node_encryption_options_status.deserialize_json(
    ...
    if "AdvancedOptions" in data:
        ...
        out["advanced_options"] = (
            aws_sdk_elasticsearch_service.types.advanced_options_status.deserialize_json(
    ...
    if "LogPublishingOptions" in data:
        ...
        out["log_publishing_options"] = (
            aws_sdk_elasticsearch_service.types.log_publishing_options_status.deserialize_json(
    ...
    if "DomainEndpointOptions" in data:
        ...
        out["domain_endpoint_options"] = (
            aws_sdk_elasticsearch_service.types.domain_endpoint_options_status.deserialize_json(
    ...
    if "AdvancedSecurityOptions" in data:
        ...
        out["advanced_security_options"] = (
            aws_sdk_elasticsearch_service.types.advanced_security_options_status.deserialize_json(
    ...
    if "AutoTuneOptions" in data:
        ...
        out["auto_tune_options"] = (
            aws_sdk_elasticsearch_service.types.auto_tune_options_status.deserialize_json(
    ...
    if "DeploymentStrategyOptions" in data:
        ...
        out["deployment_strategy_options"] = (
            aws_sdk_elasticsearch_service.types.deployment_strategy_options_status.deserialize_json(
    ...
    if "AutomatedSnapshotPauseOptions" in data:
        ...
        out["automated_snapshot_pause_options"] = (
            aws_sdk_elasticsearch_service.types.automated_snapshot_pause_options_status.deserialize_json(
