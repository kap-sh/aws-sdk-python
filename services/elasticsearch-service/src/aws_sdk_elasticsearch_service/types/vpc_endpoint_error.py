...
if TYPE_CHECKING:
    ...
    import aws_sdk_elasticsearch_service.types.vpc_endpoint_error_code
...
class VpcEndpointError(TypedDict, closed=True):
    ...
    error_code: NotRequired[
        "aws_sdk_elasticsearch_service.types.vpc_endpoint_error_code.VpcEndpointErrorCode"
    ]
...
def serialize_json(value: VpcEndpointError) -> dict:
    ...
    if "error_code" in value:
        ...
        out["ErrorCode"] = (
            aws_sdk_elasticsearch_service.types.vpc_endpoint_error_code.serialize_json(
                value["error_code"]
            )
        )
...
def deserialize_json(data: dict) -> VpcEndpointError:
    ...
    if "ErrorCode" in data:
        ...
        out["error_code"] = (
            aws_sdk_elasticsearch_service.types.vpc_endpoint_error_code.deserialize_json(
                data["ErrorCode"]
            )
        )
