...
if TYPE_CHECKING:
    import aws_sdk_elasticsearch_service.types.deployment_type
    import aws_sdk_elasticsearch_service.types.message


class DryRunResults(TypedDict, closed=True):
    deployment_type: NotRequired[
        "aws_sdk_elasticsearch_service.types.deployment_type.DeploymentType"
    ]
    ...
    message: NotRequired["aws_sdk_elasticsearch_service.types.message.Message"]
