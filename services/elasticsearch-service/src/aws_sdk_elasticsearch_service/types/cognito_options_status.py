...
class CognitoOptionsStatus(TypedDict, closed=True):
    options: "aws_sdk_elasticsearch_service.types.cognito_options.CognitoOptions"
...
def serialize_json(value: CognitoOptionsStatus) -> dict:
    ...
    out["Options"] = aws_sdk_elasticsearch_service.types.cognito_options.serialize_json(
        value["options"]
    )
    import aws_sdk_elasticsearch_service.types.option_status
