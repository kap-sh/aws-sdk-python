...
if TYPE_CHECKING:
    ...
    import aws_sdk_elasticsearch_service.types.outbound_cross_cluster_search_connection_status


class CreateOutboundCrossClusterSearchConnectionResponse(TypedDict):
    ...
    connection_status: NotRequired[
        "aws_sdk_elasticsearch_service.types.outbound_cross_cluster_search_connection_status.OutboundCrossClusterSearchConnectionStatus"
    ]
    ...
    cross_cluster_search_connection_id: NotRequired[
        "aws_sdk_elasticsearch_service.types.cross_cluster_search_connection_id.CrossClusterSearchConnectionId"
    ]
...
def serialize_json(value: CreateOutboundCrossClusterSearchConnectionResponse) -> dict:
    ...
    if "connection_status" in value:
        ...
        out["ConnectionStatus"] = (
            aws_sdk_elasticsearch_service.types.outbound_cross_cluster_search_connection_status.serialize_json(
...
def deserialize_json(data: dict) -> CreateOutboundCrossClusterSearchConnectionResponse:
    ...
    if "ConnectionStatus" in data:
        ...
        out["connection_status"] = (
            aws_sdk_elasticsearch_service.types.outbound_cross_cluster_search_connection_status.deserialize_json(
