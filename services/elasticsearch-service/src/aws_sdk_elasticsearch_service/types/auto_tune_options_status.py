...
if TYPE_CHECKING:
    ...
    import aws_sdk_elasticsearch_service.types.auto_tune_status
...
class AutoTuneOptionsStatus(TypedDict):
    ...
    status: NotRequired[
        "aws_sdk_elasticsearch_service.types.auto_tune_status.AutoTuneStatus"
    ]
...
def serialize_json(value: AutoTuneOptionsStatus) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            aws_sdk_elasticsearch_service.types.auto_tune_status.serialize_json(
                value["status"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> AutoTuneOptionsStatus:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_elasticsearch_service.types.auto_tune_status.deserialize_json(
                data["Status"]
            )
        )
    return out
