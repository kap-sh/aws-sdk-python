"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#UpdateVpcEndpointResponse``."""
...
class UpdateVpcEndpointResponse(TypedDict):
    vpc_endpoint: "aws_sdk_elasticsearch_service.types.vpc_endpoint.VpcEndpoint"
...
def serialize_json(value: UpdateVpcEndpointResponse) -> dict:
    ...
    out["VpcEndpoint"] = (
        aws_sdk_elasticsearch_service.types.vpc_endpoint.serialize_json(
            value["vpc_endpoint"]
        )
    )
    return out
...
def deserialize_json(data: dict) -> UpdateVpcEndpointResponse:
    ...
    if "VpcEndpoint" in data:
        ...
        out["vpc_endpoint"] = (
            aws_sdk_elasticsearch_service.types.vpc_endpoint.deserialize_json(
                data["VpcEndpoint"]
            )
        )
    else:
