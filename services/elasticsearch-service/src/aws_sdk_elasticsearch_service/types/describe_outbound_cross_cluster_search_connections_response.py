...
class DescribeOutboundCrossClusterSearchConnectionsResponse(TypedDict):
    cross_cluster_search_connections: NotRequired[
        "aws_sdk_elasticsearch_service.types.outbound_cross_cluster_search_connections.OutboundCrossClusterSearchConnections"
    ]
...
def serialize_json(
    ...
    if "cross_cluster_search_connections" in value:
        ...
        out["CrossClusterSearchConnections"] = (
            aws_sdk_elasticsearch_service.types.outbound_cross_cluster_search_connections.serialize_json(
...
def deserialize_json(
    ...
    if "CrossClusterSearchConnections" in data:
        ...
        out["cross_cluster_search_connections"] = (
            aws_sdk_elasticsearch_service.types.outbound_cross_cluster_search_connections.deserialize_json(
