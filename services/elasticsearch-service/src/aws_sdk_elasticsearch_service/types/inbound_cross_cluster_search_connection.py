...
class InboundCrossClusterSearchConnection(TypedDict):
    ...
    connection_status: NotRequired[
        "aws_sdk_elasticsearch_service.types.inbound_cross_cluster_search_connection_status.InboundCrossClusterSearchConnectionStatus"
    ]
...
def serialize_json(value: InboundCrossClusterSearchConnection) -> dict:
    ...
    if "connection_status" in value:
        ...
        out["ConnectionStatus"] = (
            aws_sdk_elasticsearch_service.types.inbound_cross_cluster_search_connection_status.serialize_json(
...
def deserialize_json(data: dict) -> InboundCrossClusterSearchConnection:
    ...
    if "ConnectionStatus" in data:
        ...
        out["connection_status"] = (
            aws_sdk_elasticsearch_service.types.inbound_cross_cluster_search_connection_status.deserialize_json(
