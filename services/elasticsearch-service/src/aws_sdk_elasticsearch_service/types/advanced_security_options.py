...
if TYPE_CHECKING:
    ...
    import aws_sdk_elasticsearch_service.types.disable_timestamp
    import aws_sdk_elasticsearch_service.types.saml_options_output
...
class AdvancedSecurityOptions(TypedDict, closed=True):
    ...
    saml_options: NotRequired[
        "aws_sdk_elasticsearch_service.types.saml_options_output.SAMLOptionsOutput"
    ]
    """<p>Describes the SAML application configured for a domain.</p>"""
    anonymous_auth_disable_date: NotRequired[
        "aws_sdk_elasticsearch_service.types.disable_timestamp.DisableTimestamp"
    ]
...
def serialize_json(value: AdvancedSecurityOptions) -> dict:
    ...
    if "saml_options" in value:
        ...
        out["SAMLOptions"] = (
            aws_sdk_elasticsearch_service.types.saml_options_output.serialize_json(
                value["saml_options"]
            )
        )
    if "anonymous_auth_disable_date" in value:
        ...
        out["AnonymousAuthDisableDate"] = (
            aws_sdk_elasticsearch_service.types.disable_timestamp.serialize_json(
...
def deserialize_json(data: dict) -> AdvancedSecurityOptions:
    ...
    if "SAMLOptions" in data:
        ...
        out["saml_options"] = (
            aws_sdk_elasticsearch_service.types.saml_options_output.deserialize_json(
                data["SAMLOptions"]
            )
        )
    if "AnonymousAuthDisableDate" in data:
        ...
        out["anonymous_auth_disable_date"] = (
            aws_sdk_elasticsearch_service.types.disable_timestamp.deserialize_json(
