...
if TYPE_CHECKING:
    ...
    import aws_sdk_elasticsearch_service.types.package_status
...
class PackageDetails(TypedDict, closed=True):
    ...
    package_status: NotRequired[
        "aws_sdk_elasticsearch_service.types.package_status.PackageStatus"
    ]
...
def serialize_json(value: PackageDetails) -> dict:
    ...
    if "package_status" in value:
        ...
        out["PackageStatus"] = (
            aws_sdk_elasticsearch_service.types.package_status.serialize_json(
...
def deserialize_json(data: dict) -> PackageDetails:
    ...
    if "PackageStatus" in data:
        ...
        out["package_status"] = (
            aws_sdk_elasticsearch_service.types.package_status.deserialize_json(
                data["PackageStatus"]
            )
        )
