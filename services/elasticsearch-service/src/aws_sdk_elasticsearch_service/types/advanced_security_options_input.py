...
if TYPE_CHECKING:
    ...
    import aws_sdk_elasticsearch_service.types.master_user_options
    import aws_sdk_elasticsearch_service.types.saml_options_input
...
class AdvancedSecurityOptionsInput(TypedDict):
    ...
    master_user_options: NotRequired[
        "aws_sdk_elasticsearch_service.types.master_user_options.MasterUserOptions"
    ]
    """<p>Credentials for the master user: username and password, ARN, or both.</p>"""
    saml_options: NotRequired[
        "aws_sdk_elasticsearch_service.types.saml_options_input.SAMLOptionsInput"
    ]
...
def serialize_json(value: AdvancedSecurityOptionsInput) -> dict:
    ...
    if "master_user_options" in value:
        ...
        out["MasterUserOptions"] = (
            aws_sdk_elasticsearch_service.types.master_user_options.serialize_json(
    ...
    if "saml_options" in value:
        ...
        out["SAMLOptions"] = (
            aws_sdk_elasticsearch_service.types.saml_options_input.serialize_json(
                value["saml_options"]
            )
        )
...
def deserialize_json(data: dict) -> AdvancedSecurityOptionsInput:
    ...
    if "MasterUserOptions" in data:
        ...
        out["master_user_options"] = (
            aws_sdk_elasticsearch_service.types.master_user_options.deserialize_json(
    ...
    if "SAMLOptions" in data:
        ...
        out["saml_options"] = (
            aws_sdk_elasticsearch_service.types.saml_options_input.deserialize_json(
                data["SAMLOptions"]
            )
        )
