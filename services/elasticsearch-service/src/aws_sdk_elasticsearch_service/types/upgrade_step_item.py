...
if TYPE_CHECKING:
    ...
    import aws_sdk_elasticsearch_service.types.issues
...
class UpgradeStepItem(TypedDict, closed=True):
    ...
    issues: NotRequired["aws_sdk_elasticsearch_service.types.issues.Issues"]
    """<p>A list of strings containing detailed information about the errors encountered in a particular step.</p>"""
    progress_percent: NotRequired["aws_sdk_elasticsearch_service.types.double.Double"]
...
def serialize_json(value: UpgradeStepItem) -> dict:
    ...
    if "issues" in value:
        ...
        out["Issues"] = aws_sdk_elasticsearch_service.types.issues.serialize_json(
            value["issues"]
        )
...
def deserialize_json(data: dict) -> UpgradeStepItem:
    ...
    if "Issues" in data:
        ...
        out["issues"] = aws_sdk_elasticsearch_service.types.issues.deserialize_json(
            data["Issues"]
        )
