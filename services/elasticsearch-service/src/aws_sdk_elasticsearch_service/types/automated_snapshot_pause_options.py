...
if TYPE_CHECKING:
    ...
    import aws_sdk_elasticsearch_service.types.pause_state
...
class AutomatedSnapshotPauseOptions(TypedDict):
    ...
    state: NotRequired["aws_sdk_elasticsearch_service.types.pause_state.PauseState"]
...
def serialize_json(value: AutomatedSnapshotPauseOptions) -> dict:
    ...
    if "state" in value:
        ...
        out["State"] = aws_sdk_elasticsearch_service.types.pause_state.serialize_json(
            value["state"]
        )
    return out
...
def deserialize_json(data: dict) -> AutomatedSnapshotPauseOptions:
    ...
    if "State" in data:
        ...
        out["state"] = aws_sdk_elasticsearch_service.types.pause_state.deserialize_json(
            data["State"]
        )
    return out
