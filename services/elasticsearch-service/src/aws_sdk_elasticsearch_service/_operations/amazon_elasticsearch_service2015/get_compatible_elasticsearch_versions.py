...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.get_compatible_elasticsearch_versions_response.GetCompatibleElasticsearchVersionsResponse = aws_sdk_elasticsearch_service.types.get_compatible_elasticsearch_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.get_compatible_elasticsearch_versions_request.GetCompatibleElasticsearchVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
