...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.list_packages_for_domain_response.ListPackagesForDomainResponse = aws_sdk_elasticsearch_service.types.list_packages_for_domain_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.list_packages_for_domain_request.ListPackagesForDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
