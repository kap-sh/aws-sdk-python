...
def build_request(
    ...
    input: aws_sdk_elasticsearch_service.types.describe_elasticsearch_instance_type_limits_request.DescribeElasticsearchInstanceTypeLimitsRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ElasticsearchVersion}", quote(str(input["elasticsearch_version"]), safe="")
    )
    params: dict[str, str] = {}
