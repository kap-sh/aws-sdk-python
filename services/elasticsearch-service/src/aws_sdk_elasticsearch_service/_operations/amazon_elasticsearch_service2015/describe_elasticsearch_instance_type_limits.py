"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#DescribeElasticsearchInstanceTypeLimits``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.describe_elasticsearch_instance_type_limits_response.DescribeElasticsearchInstanceTypeLimitsResponse = aws_sdk_elasticsearch_service.types.describe_elasticsearch_instance_type_limits_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.describe_elasticsearch_instance_type_limits_request.DescribeElasticsearchInstanceTypeLimitsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{ElasticsearchVersion}", quote(str(input_["elasticsearch_version"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_describe_elasticsearch_instance_type_limits(
