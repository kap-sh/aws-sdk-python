...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.list_tags_response.ListTagsResponse = (
        aws_sdk_elasticsearch_service.types.list_tags_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.list_tags_request.ListTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
