...
def build_request(
    ...
    input: aws_sdk_elasticsearch_service.types.describe_domain_change_progress_request.DescribeDomainChangeProgressRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "change_id" in input:
        params["changeid"] = str(input["change_id"])
