"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#ListVpcEndpoints``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.list_vpc_endpoints_response.ListVpcEndpointsResponse = aws_sdk_elasticsearch_service.types.list_vpc_endpoints_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.list_vpc_endpoints_request.ListVpcEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
