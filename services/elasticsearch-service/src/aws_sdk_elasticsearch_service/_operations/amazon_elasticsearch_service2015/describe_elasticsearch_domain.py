"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#DescribeElasticsearchDomain``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.describe_elasticsearch_domain_response.DescribeElasticsearchDomainResponse = aws_sdk_elasticsearch_service.types.describe_elasticsearch_domain_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.describe_elasticsearch_domain_request.DescribeElasticsearchDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/es/domain/{DomainName}"
...
async def async_describe_elasticsearch_domain(
