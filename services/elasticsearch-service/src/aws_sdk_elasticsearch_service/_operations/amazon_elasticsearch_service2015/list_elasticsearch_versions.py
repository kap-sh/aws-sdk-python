"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#ListElasticsearchVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.list_elasticsearch_versions_response.ListElasticsearchVersionsResponse = aws_sdk_elasticsearch_service.types.list_elasticsearch_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.list_elasticsearch_versions_request.ListElasticsearchVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/es/versions"
    params: dict[str, str] = {}
...
async def async_list_elasticsearch_versions(
