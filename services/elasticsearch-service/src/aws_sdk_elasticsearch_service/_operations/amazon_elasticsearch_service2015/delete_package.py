...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.delete_package_response.DeletePackageResponse = aws_sdk_elasticsearch_service.types.delete_package_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.delete_package_request.DeletePackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
