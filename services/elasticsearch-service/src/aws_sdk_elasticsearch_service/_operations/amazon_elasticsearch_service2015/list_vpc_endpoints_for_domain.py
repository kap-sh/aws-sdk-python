"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#ListVpcEndpointsForDomain``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.list_vpc_endpoints_for_domain_response.ListVpcEndpointsForDomainResponse = aws_sdk_elasticsearch_service.types.list_vpc_endpoints_for_domain_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.list_vpc_endpoints_for_domain_request.ListVpcEndpointsForDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/es/domain/{DomainName}/vpcEndpoints"
...
async def async_list_vpc_endpoints_for_domain(
