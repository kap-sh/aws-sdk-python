...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.remove_tags_request.RemoveTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.remove_tags_request.serialize_json(input_)
    ).encode()
