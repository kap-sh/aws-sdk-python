...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.describe_inbound_cross_cluster_search_connections_response.DescribeInboundCrossClusterSearchConnectionsResponse = aws_sdk_elasticsearch_service.types.describe_inbound_cross_cluster_search_connections_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.describe_inbound_cross_cluster_search_connections_request.DescribeInboundCrossClusterSearchConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.describe_inbound_cross_cluster_search_connections_request.serialize_json(
            input_
        )
    ).encode()
