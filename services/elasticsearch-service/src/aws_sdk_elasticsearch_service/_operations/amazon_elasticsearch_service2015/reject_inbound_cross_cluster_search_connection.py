...
def build_request(
    ...
    input: aws_sdk_elasticsearch_service.types.reject_inbound_cross_cluster_search_connection_request.RejectInboundCrossClusterSearchConnectionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["cross_cluster_search_connection_id"]), safe=""),
    )
    params: dict[str, str] = {}
