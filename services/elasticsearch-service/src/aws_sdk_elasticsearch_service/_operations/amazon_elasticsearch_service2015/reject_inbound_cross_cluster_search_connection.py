"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#RejectInboundCrossClusterSearchConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.reject_inbound_cross_cluster_search_connection_response.RejectInboundCrossClusterSearchConnectionResponse = aws_sdk_elasticsearch_service.types.reject_inbound_cross_cluster_search_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.reject_inbound_cross_cluster_search_connection_request.RejectInboundCrossClusterSearchConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["cross_cluster_search_connection_id"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_reject_inbound_cross_cluster_search_connection(
