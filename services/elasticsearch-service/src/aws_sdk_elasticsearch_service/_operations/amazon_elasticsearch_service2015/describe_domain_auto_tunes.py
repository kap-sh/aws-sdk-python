"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#DescribeDomainAutoTunes``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.describe_domain_auto_tunes_response.DescribeDomainAutoTunesResponse = aws_sdk_elasticsearch_service.types.describe_domain_auto_tunes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.describe_domain_auto_tunes_request.DescribeDomainAutoTunesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/es/domain/{DomainName}/autoTunes"
