...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.list_domains_for_package_response.ListDomainsForPackageResponse = aws_sdk_elasticsearch_service.types.list_domains_for_package_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.list_domains_for_package_request.ListDomainsForPackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
