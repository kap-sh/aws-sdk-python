"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#AcceptInboundCrossClusterSearchConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.accept_inbound_cross_cluster_search_connection_response.AcceptInboundCrossClusterSearchConnectionResponse = aws_sdk_elasticsearch_service.types.accept_inbound_cross_cluster_search_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.accept_inbound_cross_cluster_search_connection_request.AcceptInboundCrossClusterSearchConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_accept_inbound_cross_cluster_search_connection(
