"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#DissociatePackage``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            import aws_sdk_elasticsearch_service.errors.access_denied_exception

            raise aws_sdk_elasticsearch_service.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
        case "BaseException":
        ...
        case "ConflictException":
            import aws_sdk_elasticsearch_service.errors.conflict_exception

            raise aws_sdk_elasticsearch_service.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.dissociate_package_response.DissociatePackageResponse = aws_sdk_elasticsearch_service.types.dissociate_package_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.dissociate_package_request.DissociatePackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
