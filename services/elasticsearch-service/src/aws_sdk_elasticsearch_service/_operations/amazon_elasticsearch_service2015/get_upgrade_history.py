"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#GetUpgradeHistory``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.get_upgrade_history_response.GetUpgradeHistoryResponse = aws_sdk_elasticsearch_service.types.get_upgrade_history_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.get_upgrade_history_request.GetUpgradeHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/es/upgradeDomain/{DomainName}/history"
