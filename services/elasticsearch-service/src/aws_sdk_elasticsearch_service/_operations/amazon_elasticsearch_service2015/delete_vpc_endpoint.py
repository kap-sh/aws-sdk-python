...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.delete_vpc_endpoint_response.DeleteVpcEndpointResponse = aws_sdk_elasticsearch_service.types.delete_vpc_endpoint_response.deserialize_json(
