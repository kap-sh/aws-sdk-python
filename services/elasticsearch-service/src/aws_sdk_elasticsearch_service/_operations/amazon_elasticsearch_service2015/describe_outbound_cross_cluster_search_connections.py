...
import aws_sdk_elasticsearch_service.errors.invalid_pagination_token_exception
...
import aws_sdk_elasticsearch_service.types.outbound_cross_cluster_search_connections
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPaginationTokenException":
            raise aws_sdk_elasticsearch_service.errors.invalid_pagination_token_exception.InvalidPaginationTokenException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.describe_outbound_cross_cluster_search_connections_response.DescribeOutboundCrossClusterSearchConnectionsResponse = aws_sdk_elasticsearch_service.types.describe_outbound_cross_cluster_search_connections_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.describe_outbound_cross_cluster_search_connections_request.DescribeOutboundCrossClusterSearchConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.describe_outbound_cross_cluster_search_connections_request.serialize_json(
            input_
        )
    ).encode()
