"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#GetPackageVersionHistory``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.get_package_version_history_response.GetPackageVersionHistoryResponse = aws_sdk_elasticsearch_service.types.get_package_version_history_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.get_package_version_history_request.GetPackageVersionHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/packages/{PackageID}/history"
...
async def async_get_package_version_history(
