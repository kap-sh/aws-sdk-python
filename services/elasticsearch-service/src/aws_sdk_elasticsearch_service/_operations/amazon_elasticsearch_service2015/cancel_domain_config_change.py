"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#CancelDomainConfigChange``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.cancel_domain_config_change_response.CancelDomainConfigChangeResponse = aws_sdk_elasticsearch_service.types.cancel_domain_config_change_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.cancel_domain_config_change_request.CancelDomainConfigChangeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/es/domain/{DomainName}/config/cancel"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.cancel_domain_config_change_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_cancel_domain_config_change(
