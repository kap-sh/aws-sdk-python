...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.cancel_elasticsearch_service_software_update_response.CancelElasticsearchServiceSoftwareUpdateResponse = aws_sdk_elasticsearch_service.types.cancel_elasticsearch_service_software_update_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.cancel_elasticsearch_service_software_update_request.CancelElasticsearchServiceSoftwareUpdateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.cancel_elasticsearch_service_software_update_request.serialize_json(
            input_
        )
    ).encode()
