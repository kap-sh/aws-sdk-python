...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.get_upgrade_status_response.GetUpgradeStatusResponse = aws_sdk_elasticsearch_service.types.get_upgrade_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.get_upgrade_status_request.GetUpgradeStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
