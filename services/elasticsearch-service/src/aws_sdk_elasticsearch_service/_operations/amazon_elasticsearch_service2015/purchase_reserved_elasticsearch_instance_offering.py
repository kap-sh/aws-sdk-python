"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#PurchaseReservedElasticsearchInstanceOffering``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceAlreadyExistsException":
            import aws_sdk_elasticsearch_service.errors.resource_already_exists_exception

            raise aws_sdk_elasticsearch_service.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.purchase_reserved_elasticsearch_instance_offering_response.PurchaseReservedElasticsearchInstanceOfferingResponse = aws_sdk_elasticsearch_service.types.purchase_reserved_elasticsearch_instance_offering_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.purchase_reserved_elasticsearch_instance_offering_request.PurchaseReservedElasticsearchInstanceOfferingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_purchase_reserved_elasticsearch_instance_offering(
