...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.describe_packages_response.DescribePackagesResponse = aws_sdk_elasticsearch_service.types.describe_packages_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.describe_packages_request.DescribePackagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.describe_packages_request.serialize_json(
            input_
        )
    ).encode()
