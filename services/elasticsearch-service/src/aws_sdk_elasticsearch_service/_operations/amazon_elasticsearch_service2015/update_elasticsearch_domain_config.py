...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.update_elasticsearch_domain_config_request.UpdateElasticsearchDomainConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.update_elasticsearch_domain_config_request.serialize_json(
            input_
        )
    ).encode()
