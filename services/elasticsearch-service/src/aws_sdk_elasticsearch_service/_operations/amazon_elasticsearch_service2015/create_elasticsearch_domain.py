...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.create_elasticsearch_domain_response.CreateElasticsearchDomainResponse = aws_sdk_elasticsearch_service.types.create_elasticsearch_domain_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.create_elasticsearch_domain_request.CreateElasticsearchDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.create_elasticsearch_domain_request.serialize_json(
            input_
        )
    ).encode()
