...
def build_request(
    ...
    input: aws_sdk_elasticsearch_service.types.describe_reserved_elasticsearch_instances_request.DescribeReservedElasticsearchInstancesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "reserved_elasticsearch_instance_id" in input:
        params["reservationId"] = str(input["reserved_elasticsearch_instance_id"])
