"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#DescribeReservedElasticsearchInstances``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.describe_reserved_elasticsearch_instances_response.DescribeReservedElasticsearchInstancesResponse = aws_sdk_elasticsearch_service.types.describe_reserved_elasticsearch_instances_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.describe_reserved_elasticsearch_instances_request.DescribeReservedElasticsearchInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/es/reservedInstances"
    params: dict[str, str] = {}
    if "reserved_elasticsearch_instance_id" in input_:
        params["reservationId"] = str(input_["reserved_elasticsearch_instance_id"])
...
async def async_describe_reserved_elasticsearch_instances(
