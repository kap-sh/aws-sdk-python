"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#DescribeElasticsearchDomainConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.describe_elasticsearch_domain_config_response.DescribeElasticsearchDomainConfigResponse = aws_sdk_elasticsearch_service.types.describe_elasticsearch_domain_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.describe_elasticsearch_domain_config_request.DescribeElasticsearchDomainConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_elasticsearch_domain_config(
