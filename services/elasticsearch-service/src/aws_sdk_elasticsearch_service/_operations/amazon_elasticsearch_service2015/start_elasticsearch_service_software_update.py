...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.start_elasticsearch_service_software_update_response.StartElasticsearchServiceSoftwareUpdateResponse = aws_sdk_elasticsearch_service.types.start_elasticsearch_service_software_update_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.start_elasticsearch_service_software_update_request.StartElasticsearchServiceSoftwareUpdateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.start_elasticsearch_service_software_update_request.serialize_json(
            input_
        )
    ).encode()
