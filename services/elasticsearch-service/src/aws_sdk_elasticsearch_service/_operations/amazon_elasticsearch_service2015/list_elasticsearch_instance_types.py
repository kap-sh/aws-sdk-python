...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.list_elasticsearch_instance_types_response.ListElasticsearchInstanceTypesResponse = aws_sdk_elasticsearch_service.types.list_elasticsearch_instance_types_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.list_elasticsearch_instance_types_request.ListElasticsearchInstanceTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
