"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#AssociatePackage``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.associate_package_response.AssociatePackageResponse = aws_sdk_elasticsearch_service.types.associate_package_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.associate_package_request.AssociatePackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
