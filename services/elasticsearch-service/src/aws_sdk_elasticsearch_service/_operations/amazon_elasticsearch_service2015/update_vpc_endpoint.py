...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.update_vpc_endpoint_response.UpdateVpcEndpointResponse = aws_sdk_elasticsearch_service.types.update_vpc_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.update_vpc_endpoint_request.UpdateVpcEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.update_vpc_endpoint_request.serialize_json(
            input_
        )
    ).encode()
