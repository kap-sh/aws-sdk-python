...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.create_package_request.CreatePackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.create_package_request.serialize_json(
            input_
        )
    ).encode()
