...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.create_package_response.CreatePackageResponse = aws_sdk_elasticsearch_service.types.create_package_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_elasticsearch_service.types.create_package_request.CreatePackageRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.create_package_request.serialize_json(input)
    ).encode()
