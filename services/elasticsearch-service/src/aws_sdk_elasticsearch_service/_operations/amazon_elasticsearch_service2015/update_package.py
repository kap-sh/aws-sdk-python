"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#UpdatePackage``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.update_package_response.UpdatePackageResponse = aws_sdk_elasticsearch_service.types.update_package_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_elasticsearch_service.types.update_package_request.UpdatePackageRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/packages/update"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_elasticsearch_service.types.update_package_request

    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.update_package_request.serialize_json(input)
    ).encode()
