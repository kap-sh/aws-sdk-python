...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.update_package_request.UpdatePackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.update_package_request.serialize_json(
            input_
        )
    ).encode()
