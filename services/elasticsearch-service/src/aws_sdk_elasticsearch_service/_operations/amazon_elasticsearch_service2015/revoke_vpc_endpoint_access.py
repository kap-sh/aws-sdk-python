"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#RevokeVpcEndpointAccess``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.revoke_vpc_endpoint_access_response.RevokeVpcEndpointAccessResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.revoke_vpc_endpoint_access_request.RevokeVpcEndpointAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.revoke_vpc_endpoint_access_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_revoke_vpc_endpoint_access(
