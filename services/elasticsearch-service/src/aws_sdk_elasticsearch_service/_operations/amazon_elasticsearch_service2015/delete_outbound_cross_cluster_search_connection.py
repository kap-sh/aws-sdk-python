...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.delete_outbound_cross_cluster_search_connection_response.DeleteOutboundCrossClusterSearchConnectionResponse = aws_sdk_elasticsearch_service.types.delete_outbound_cross_cluster_search_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.delete_outbound_cross_cluster_search_connection_request.DeleteOutboundCrossClusterSearchConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
