...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.describe_elasticsearch_domains_request.DescribeElasticsearchDomainsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.describe_elasticsearch_domains_request.serialize_json(
            input_
        )
    ).encode()
