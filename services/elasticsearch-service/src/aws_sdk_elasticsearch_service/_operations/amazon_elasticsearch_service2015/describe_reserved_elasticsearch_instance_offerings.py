...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.describe_reserved_elasticsearch_instance_offerings_response.DescribeReservedElasticsearchInstanceOfferingsResponse = aws_sdk_elasticsearch_service.types.describe_reserved_elasticsearch_instance_offerings_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_elasticsearch_service.types.describe_reserved_elasticsearch_instance_offerings_request.DescribeReservedElasticsearchInstanceOfferingsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "reserved_elasticsearch_instance_offering_id" in input:
        params["offeringId"] = str(input["reserved_elasticsearch_instance_offering_id"])
