"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#DeleteElasticsearchDomain``."""
...
def handle_response(
    ...
    out: aws_sdk_elasticsearch_service.types.delete_elasticsearch_domain_response.DeleteElasticsearchDomainResponse = aws_sdk_elasticsearch_service.types.delete_elasticsearch_domain_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.delete_elasticsearch_domain_request.DeleteElasticsearchDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_elasticsearch_domain(
