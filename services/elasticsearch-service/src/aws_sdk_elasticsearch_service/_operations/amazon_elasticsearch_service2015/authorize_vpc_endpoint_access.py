...
def build_request(
    ...
    input_: aws_sdk_elasticsearch_service.types.authorize_vpc_endpoint_access_request.AuthorizeVpcEndpointAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_elasticsearch_service.types.authorize_vpc_endpoint_access_request.serialize_json(
            input_
        )
    ).encode()
