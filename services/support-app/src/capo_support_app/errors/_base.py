...
class SupportAppError(Exception):
    """Base class for all SupportApp service errors."""


class ServiceError(SupportAppError):
...
class SerializationError(SupportAppError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SupportAppError):
...
class WaiterFailedError(SupportAppError):
...
class WaiterTimeoutError(SupportAppError):
