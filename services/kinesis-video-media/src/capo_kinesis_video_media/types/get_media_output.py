...
if TYPE_CHECKING:
    import capo_kinesis_video_media.types.content_type
    import capo_kinesis_video_media.types.payload


class GetMediaOutput(TypedDict, closed=True):
    content_type: NotRequired["capo_kinesis_video_media.types.content_type.ContentType"]
    """<p>The content type of the requested media.</p>"""
    payload: "capo_kinesis_video_media.types.payload.Payload"
