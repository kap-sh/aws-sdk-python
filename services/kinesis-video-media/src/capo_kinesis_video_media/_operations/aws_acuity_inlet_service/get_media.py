"""Generated from Smithy shape ``com.amazonaws.kinesisvideomedia#GetMedia``."""
...
import capo_kinesis_video_media.errors.invalid_endpoint_exception
import capo_kinesis_video_media.errors.not_authorized_exception
import capo_kinesis_video_media.errors.resource_not_found_exception
import capo_kinesis_video_media.types.get_media_input
import capo_kinesis_video_media.types.get_media_output
import capo_kinesis_video_media.types.payload
import capo_kinesis_video_media.types.start_selector
from capo_kinesis_video_media._protocol.errors import parse_error_metadata_json
from capo_kinesis_video_media._rule_engine._endpoint_rule_set import (
    EndpointParams,
    resolve,
)
...
from capo_kinesis_video_media.errors import UnknownServiceError
...
def get_media(
    ...
    capo_kinesis_video_media.types.get_media_output.GetMediaOutput, zapros.Response
]:
