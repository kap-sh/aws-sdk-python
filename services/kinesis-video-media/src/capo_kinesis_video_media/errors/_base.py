...
class KinesisVideoMediaError(Exception):
    """Base class for all KinesisVideoMedia service errors."""


class ServiceError(KinesisVideoMediaError):
...
class SerializationError(KinesisVideoMediaError):
    """Raised when a value cannot be serialized."""


class DeserializationError(KinesisVideoMediaError):
...
class WaiterFailedError(KinesisVideoMediaError):
...
class WaiterTimeoutError(KinesisVideoMediaError):
