...
def get_signer(
...
) -> aws_sdk_kinesis_video_media._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_kinesis_video_media._auth._sigv4.build_sigv4_auth_scheme(
                "kinesisvideo", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_kinesis_video_media._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video_media.types.get_media_input.GetMediaInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video_media.types.get_media_input.serialize_json(input_)
    ).encode()
...
def get_media(
    ...
    aws_sdk_kinesis_video_media.types.get_media_output.GetMediaOutput, zapros.Response
]:
