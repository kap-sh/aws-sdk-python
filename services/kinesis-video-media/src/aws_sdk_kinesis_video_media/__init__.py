...
from ._services.async_kinesis_video_media import (
    AsyncKinesisVideoMediaClient as AsyncKinesisVideoMediaClient,
)
from ._services.kinesis_video_media import (
    KinesisVideoMediaClient as KinesisVideoMediaClient,
)
