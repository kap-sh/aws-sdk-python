"""Generated from Smithy shape ``com.amazonaws.kinesisvideomedia#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisvideomedia#ResourceNotFoundException``."""
