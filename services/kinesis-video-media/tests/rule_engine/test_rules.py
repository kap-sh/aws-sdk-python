import pytest
from capo_kinesis_video_media._rule_engine._endpoint_rule_set import EndpointParams, resolve
from capo_kinesis_video_media._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
