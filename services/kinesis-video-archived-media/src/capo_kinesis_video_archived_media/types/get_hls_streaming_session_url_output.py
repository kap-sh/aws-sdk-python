...
if TYPE_CHECKING:
    import capo_kinesis_video_archived_media.types.hls_streaming_session_url


class GetHLSStreamingSessionURLOutput(TypedDict, closed=True):
    hls_streaming_session_url: NotRequired[
        "capo_kinesis_video_archived_media.types.hls_streaming_session_url.HLSStreamingSessionURL"
    ]
