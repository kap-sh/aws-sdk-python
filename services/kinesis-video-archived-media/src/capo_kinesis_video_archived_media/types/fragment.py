...
if TYPE_CHECKING:
    import capo_kinesis_video_archived_media.types.fragment_number_string
    import capo_kinesis_video_archived_media.types.long
    import capo_kinesis_video_archived_media.types.timestamp


class Fragment(TypedDict, closed=True):
    fragment_number: NotRequired[
        "capo_kinesis_video_archived_media.types.fragment_number_string.FragmentNumberString"
    ]
    """<p>The unique identifier of the fragment. This value monotonically increases based on the ingestion order.</p>"""
    fragment_size_in_bytes: "capo_kinesis_video_archived_media.types.long.Long"
    ...
    producer_timestamp: NotRequired[
        "capo_kinesis_video_archived_media.types.timestamp.Timestamp"
    ]
    ...
    fragment_length_in_milliseconds: "capo_kinesis_video_archived_media.types.long.Long"
