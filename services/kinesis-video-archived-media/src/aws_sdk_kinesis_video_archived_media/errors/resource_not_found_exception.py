"""Generated from Smithy shape ``com.amazonaws.kinesisvideoarchivedmedia#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisvideoarchivedmedia#ResourceNotFoundException``."""
