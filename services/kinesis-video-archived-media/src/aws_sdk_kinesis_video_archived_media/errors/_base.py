...
class KinesisVideoArchivedMediaError(Exception):
    """Base class for all KinesisVideoArchivedMedia service errors."""


class ServiceError(KinesisVideoArchivedMediaError):
...
class SerializationError(KinesisVideoArchivedMediaError):
    """Raised when a value cannot be serialized."""


class DeserializationError(KinesisVideoArchivedMediaError):
...
class WaiterFailedError(KinesisVideoArchivedMediaError):
...
class WaiterTimeoutError(KinesisVideoArchivedMediaError):
