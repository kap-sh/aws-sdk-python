...
from ._services.async_kinesis_video_archived_media import (
    AsyncKinesisVideoArchivedMediaClient as AsyncKinesisVideoArchivedMediaClient,
)
from ._services.kinesis_video_archived_media import (
    KinesisVideoArchivedMediaClient as KinesisVideoArchivedMediaClient,
)
