...
def handle_response(
    ...
    out: aws_sdk_kinesis_video_archived_media.types.get_hls_streaming_session_url_output.GetHLSStreamingSessionURLOutput = aws_sdk_kinesis_video_archived_media.types.get_hls_streaming_session_url_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video_archived_media.types.get_hls_streaming_session_url_input.GetHLSStreamingSessionURLInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video_archived_media.types.get_hls_streaming_session_url_input.serialize_json(
            input_
        )
    ).encode()
