...
def build_request(
    ...
    input: aws_sdk_kinesis_video_archived_media.types.get_clip_input.GetClipInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video_archived_media.types.get_clip_input.serialize_json(input)
    ).encode()
