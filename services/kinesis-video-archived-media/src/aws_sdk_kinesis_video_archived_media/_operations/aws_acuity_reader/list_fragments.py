"""Generated from Smithy shape ``com.amazonaws.kinesisvideoarchivedmedia#ListFragments``."""
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video_archived_media.types.list_fragments_input.ListFragmentsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_fragments(
