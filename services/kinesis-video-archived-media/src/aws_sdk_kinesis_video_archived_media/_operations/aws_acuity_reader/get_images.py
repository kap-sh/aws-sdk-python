...
import aws_sdk_kinesis_video_archived_media.types.images
...
def handle_response(
    ...
    out: aws_sdk_kinesis_video_archived_media.types.get_images_output.GetImagesOutput = aws_sdk_kinesis_video_archived_media.types.get_images_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kinesis_video_archived_media.types.get_images_input.GetImagesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis_video_archived_media.types.get_images_input.serialize_json(
            input_
        )
    ).encode()
