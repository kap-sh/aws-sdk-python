...
class DASHFragmentSelector(TypedDict):
    ...
    timestamp_range: NotRequired[
        "aws_sdk_kinesis_video_archived_media.types.dash_timestamp_range.DASHTimestampRange"
    ]
...
def serialize_json(value: DASHFragmentSelector) -> dict:
    ...
    if "fragment_selector_type" in value:
        ...
        out["FragmentSelectorType"] = (
            aws_sdk_kinesis_video_archived_media.types.dash_fragment_selector_type.serialize_json(
    ...
    if "timestamp_range" in value:
        ...
        out["TimestampRange"] = (
            aws_sdk_kinesis_video_archived_media.types.dash_timestamp_range.serialize_json(
...
def deserialize_json(data: dict) -> DASHFragmentSelector:
    ...
    if "FragmentSelectorType" in data:
        ...
        out["fragment_selector_type"] = (
            aws_sdk_kinesis_video_archived_media.types.dash_fragment_selector_type.deserialize_json(
    ...
    if "TimestampRange" in data:
        ...
        out["timestamp_range"] = (
            aws_sdk_kinesis_video_archived_media.types.dash_timestamp_range.deserialize_json(
                data["TimestampRange"]
            )
        )
    return out
