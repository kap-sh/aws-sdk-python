...
class GetImagesOutput(TypedDict):
    images: NotRequired["aws_sdk_kinesis_video_archived_media.types.images.Images"]
...
def serialize_json(value: GetImagesOutput) -> dict:
    ...
    if "images" in value:
        ...
        out["Images"] = (
            aws_sdk_kinesis_video_archived_media.types.images.serialize_json(
                value["images"]
            )
        )
...
def deserialize_json(data: dict) -> GetImagesOutput:
    ...
    if "Images" in data:
        ...
        out["images"] = (
            aws_sdk_kinesis_video_archived_media.types.images.deserialize_json(
                data["Images"]
            )
        )
