...
if TYPE_CHECKING:
    import aws_sdk_kinesis_video_archived_media.types.fragment_selector_type
    import aws_sdk_kinesis_video_archived_media.types.timestamp_range


class FragmentSelector(TypedDict, closed=True):
    fragment_selector_type: "aws_sdk_kinesis_video_archived_media.types.fragment_selector_type.FragmentSelectorType"
    """<p>The origin of the timestamps to use (Server or Producer).</p>"""
    timestamp_range: (
        "aws_sdk_kinesis_video_archived_media.types.timestamp_range.TimestampRange"
    )
...
def serialize_json(value: FragmentSelector) -> dict:
    ...
    out["FragmentSelectorType"] = (
        aws_sdk_kinesis_video_archived_media.types.fragment_selector_type.serialize_json(
    ...
    out["TimestampRange"] = (
        aws_sdk_kinesis_video_archived_media.types.timestamp_range.serialize_json(
...
def deserialize_json(data: dict) -> FragmentSelector:
    ...
    if "FragmentSelectorType" in data:
        ...
        out["fragment_selector_type"] = (
            aws_sdk_kinesis_video_archived_media.types.fragment_selector_type.deserialize_json(
    ...
    if "TimestampRange" in data:
        ...
        out["timestamp_range"] = (
            aws_sdk_kinesis_video_archived_media.types.timestamp_range.deserialize_json(
                data["TimestampRange"]
            )
        )
    else:
