...
class GetHLSStreamingSessionURLInput(TypedDict, closed=True):
    ...
    expires: NotRequired["aws_sdk_kinesis_video_archived_media.types.expires.Expires"]
...
def serialize_json(value: GetHLSStreamingSessionURLInput) -> dict:
    ...
    if "playback_mode" in value:
        ...
        out["PlaybackMode"] = (
            aws_sdk_kinesis_video_archived_media.types.hls_playback_mode.serialize_json(
                value["playback_mode"]
            )
        )
    if "hls_fragment_selector" in value:
        ...
        out["HLSFragmentSelector"] = (
            aws_sdk_kinesis_video_archived_media.types.hls_fragment_selector.serialize_json(
    ...
    if "container_format" in value:
        ...
        out["ContainerFormat"] = (
            aws_sdk_kinesis_video_archived_media.types.container_format.serialize_json(
    ...
    if "discontinuity_mode" in value:
        ...
        out["DiscontinuityMode"] = (
            aws_sdk_kinesis_video_archived_media.types.hls_discontinuity_mode.serialize_json(
    ...
    if "display_fragment_timestamp" in value:
        ...
        out["DisplayFragmentTimestamp"] = (
            aws_sdk_kinesis_video_archived_media.types.hls_display_fragment_timestamp.serialize_json(
...
def deserialize_json(data: dict) -> GetHLSStreamingSessionURLInput:
    ...
    if "PlaybackMode" in data:
        ...
        out["playback_mode"] = (
            aws_sdk_kinesis_video_archived_media.types.hls_playback_mode.deserialize_json(
                data["PlaybackMode"]
            )
        )
    if "HLSFragmentSelector" in data:
        ...
        out["hls_fragment_selector"] = (
            aws_sdk_kinesis_video_archived_media.types.hls_fragment_selector.deserialize_json(
    ...
    if "ContainerFormat" in data:
        ...
        out["container_format"] = (
            aws_sdk_kinesis_video_archived_media.types.container_format.deserialize_json(
    ...
    if "DiscontinuityMode" in data:
        ...
        out["discontinuity_mode"] = (
            aws_sdk_kinesis_video_archived_media.types.hls_discontinuity_mode.deserialize_json(
    ...
    if "DisplayFragmentTimestamp" in data:
        ...
        out["display_fragment_timestamp"] = (
            aws_sdk_kinesis_video_archived_media.types.hls_display_fragment_timestamp.deserialize_json(
