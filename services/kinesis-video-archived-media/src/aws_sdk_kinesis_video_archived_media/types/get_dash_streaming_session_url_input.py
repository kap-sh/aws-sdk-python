...
def serialize_json(value: GetDASHStreamingSessionURLInput) -> dict:
    ...
    if "playback_mode" in value:
        ...
        out["PlaybackMode"] = (
            aws_sdk_kinesis_video_archived_media.types.dash_playback_mode.serialize_json(
                value["playback_mode"]
            )
        )
    if "display_fragment_timestamp" in value:
        ...
        out["DisplayFragmentTimestamp"] = (
            aws_sdk_kinesis_video_archived_media.types.dash_display_fragment_timestamp.serialize_json(
    ...
    if "display_fragment_number" in value:
        ...
        out["DisplayFragmentNumber"] = (
            aws_sdk_kinesis_video_archived_media.types.dash_display_fragment_number.serialize_json(
    ...
    if "dash_fragment_selector" in value:
        ...
        out["DASHFragmentSelector"] = (
            aws_sdk_kinesis_video_archived_media.types.dash_fragment_selector.serialize_json(
...
def deserialize_json(data: dict) -> GetDASHStreamingSessionURLInput:
    ...
    if "PlaybackMode" in data:
        ...
        out["playback_mode"] = (
            aws_sdk_kinesis_video_archived_media.types.dash_playback_mode.deserialize_json(
                data["PlaybackMode"]
            )
        )
    if "DisplayFragmentTimestamp" in data:
        ...
        out["display_fragment_timestamp"] = (
            aws_sdk_kinesis_video_archived_media.types.dash_display_fragment_timestamp.deserialize_json(
    ...
    if "DisplayFragmentNumber" in data:
        ...
        out["display_fragment_number"] = (
            aws_sdk_kinesis_video_archived_media.types.dash_display_fragment_number.deserialize_json(
    ...
    if "DASHFragmentSelector" in data:
        ...
        out["dash_fragment_selector"] = (
            aws_sdk_kinesis_video_archived_media.types.dash_fragment_selector.deserialize_json(
