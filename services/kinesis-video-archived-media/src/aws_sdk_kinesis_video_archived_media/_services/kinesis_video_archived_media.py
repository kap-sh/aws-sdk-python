...
from aws_sdk_kinesis_video_archived_media._services._aws_config import aws_config
...
class KinesisVideoArchivedMediaClient:
    ...
    def get_clip(
        ...
        *,
    ...
    ) -> "Generator[aws_sdk_kinesis_video_archived_media.types.get_clip_output.GetClipOutput]":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kinesis_video_archived_media.types.get_clip_input.GetClipInput]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                aws_sdk_kinesis_video_archived_media._operations.aws_acuity_reader.get_clip.get_clip(
    ...
    def get_dash_streaming_session_url(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kinesis_video_archived_media.types.get_dash_streaming_session_url_input.GetDASHStreamingSessionURLInput]",
        ) -> OperationResponse[
            "aws_sdk_kinesis_video_archived_media.types.get_dash_streaming_session_url_output.GetDASHStreamingSessionURLOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_kinesis_video_archived_media._operations.aws_acuity_reader.get_dash_streaming_session_url.get_dash_streaming_session_url(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_hls_streaming_session_url(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kinesis_video_archived_media.types.get_hls_streaming_session_url_input.GetHLSStreamingSessionURLInput]",
        ) -> OperationResponse[
            "aws_sdk_kinesis_video_archived_media.types.get_hls_streaming_session_url_output.GetHLSStreamingSessionURLOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_kinesis_video_archived_media._operations.aws_acuity_reader.get_hls_streaming_session_url.get_hls_streaming_session_url(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_images(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kinesis_video_archived_media.types.get_images_input.GetImagesInput]",
        ) -> OperationResponse[
            "aws_sdk_kinesis_video_archived_media.types.get_images_output.GetImagesOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_kinesis_video_archived_media._operations.aws_acuity_reader.get_images.get_images(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_kinesis_video_archived_media.types.image.Image]":
        _token = next_token
        while True:
    ...
    def get_media_for_fragment_list(
        ...
        *,
    ...
    ) -> "Generator[aws_sdk_kinesis_video_archived_media.types.get_media_for_fragment_list_output.GetMediaForFragmentListOutput]":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kinesis_video_archived_media.types.get_media_for_fragment_list_input.GetMediaForFragmentListInput]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                aws_sdk_kinesis_video_archived_media._operations.aws_acuity_reader.get_media_for_fragment_list.get_media_for_fragment_list(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_fragments(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_kinesis_video_archived_media.types.list_fragments_input.ListFragmentsInput]",
        ) -> OperationResponse[
            "aws_sdk_kinesis_video_archived_media.types.list_fragments_output.ListFragmentsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_kinesis_video_archived_media._operations.aws_acuity_reader.list_fragments.list_fragments(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_kinesis_video_archived_media.types.fragment.Fragment]":
        _token = next_token
        while True:
