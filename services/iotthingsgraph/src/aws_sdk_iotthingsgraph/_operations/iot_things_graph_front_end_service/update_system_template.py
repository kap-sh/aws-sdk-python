...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.update_system_template_response.UpdateSystemTemplateResponse = aws_sdk_iotthingsgraph.types.update_system_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.update_system_template_request.UpdateSystemTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.update_system_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
