...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.delete_system_instance_response.DeleteSystemInstanceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.delete_system_instance_request.DeleteSystemInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.delete_system_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
