"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#DeleteSystemTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.delete_system_template_response.DeleteSystemTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.delete_system_template_request.DeleteSystemTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.DeleteSystemTemplate"
    import aws_sdk_iotthingsgraph.types.delete_system_template_request

    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.delete_system_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_system_template(
