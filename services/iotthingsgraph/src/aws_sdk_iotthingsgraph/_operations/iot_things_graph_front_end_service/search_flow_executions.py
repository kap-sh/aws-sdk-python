...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.search_flow_executions_response.SearchFlowExecutionsResponse = aws_sdk_iotthingsgraph.types.search_flow_executions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.search_flow_executions_request.SearchFlowExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.search_flow_executions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
