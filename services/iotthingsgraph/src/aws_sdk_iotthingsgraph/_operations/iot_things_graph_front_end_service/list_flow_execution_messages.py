"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#ListFlowExecutionMessages``."""
...
import aws_sdk_iotthingsgraph.types.flow_execution_messages
...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.list_flow_execution_messages_response.ListFlowExecutionMessagesResponse = aws_sdk_iotthingsgraph.types.list_flow_execution_messages_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.list_flow_execution_messages_request.ListFlowExecutionMessagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.ListFlowExecutionMessages"
    import aws_sdk_iotthingsgraph.types.list_flow_execution_messages_request

    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.list_flow_execution_messages_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_flow_execution_messages(
