...
def build_request(
    ...
    input: aws_sdk_iotthingsgraph.types.get_entities_request.GetEntitiesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.get_entities_request.serialize_aws_json_1_1(input)
    ).encode()
