"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#UpdateFlowTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.update_flow_template_response.UpdateFlowTemplateResponse = aws_sdk_iotthingsgraph.types.update_flow_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.update_flow_template_request.UpdateFlowTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.update_flow_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_flow_template(
