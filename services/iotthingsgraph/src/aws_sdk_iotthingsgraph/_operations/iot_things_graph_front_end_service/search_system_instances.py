"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#SearchSystemInstances``."""
...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.search_system_instances_response.SearchSystemInstancesResponse = aws_sdk_iotthingsgraph.types.search_system_instances_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.search_system_instances_request.SearchSystemInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.SearchSystemInstances"
    import aws_sdk_iotthingsgraph.types.search_system_instances_request

    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.search_system_instances_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_search_system_instances(
