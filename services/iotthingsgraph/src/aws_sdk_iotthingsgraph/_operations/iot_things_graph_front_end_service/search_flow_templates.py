"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#SearchFlowTemplates``."""
...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.search_flow_templates_response.SearchFlowTemplatesResponse = aws_sdk_iotthingsgraph.types.search_flow_templates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.search_flow_templates_request.SearchFlowTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.search_flow_templates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_search_flow_templates(
