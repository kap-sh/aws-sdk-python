"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#GetSystemTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.get_system_template_response.GetSystemTemplateResponse = aws_sdk_iotthingsgraph.types.get_system_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.get_system_template_request.GetSystemTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.get_system_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_system_template(
