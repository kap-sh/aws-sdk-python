...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.deprecate_system_template_response.DeprecateSystemTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.deprecate_system_template_request.DeprecateSystemTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.deprecate_system_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
