...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.create_system_instance_response.CreateSystemInstanceResponse = aws_sdk_iotthingsgraph.types.create_system_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.create_system_instance_request.CreateSystemInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.create_system_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
