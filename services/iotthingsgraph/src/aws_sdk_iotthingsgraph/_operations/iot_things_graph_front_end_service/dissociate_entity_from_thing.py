...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.dissociate_entity_from_thing_response.DissociateEntityFromThingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.dissociate_entity_from_thing_request.DissociateEntityFromThingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
