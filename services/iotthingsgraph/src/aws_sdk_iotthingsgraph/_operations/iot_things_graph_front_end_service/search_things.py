...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.search_things_request.SearchThingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.search_things_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
