...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.search_things_response.SearchThingsResponse = (
        aws_sdk_iotthingsgraph.types.search_things_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_iotthingsgraph.types.search_things_request.SearchThingsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.search_things_request.serialize_aws_json_1_1(input)
    ).encode()
