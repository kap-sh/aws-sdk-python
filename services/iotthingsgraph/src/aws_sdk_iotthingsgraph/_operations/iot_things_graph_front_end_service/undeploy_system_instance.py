"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#UndeploySystemInstance``."""
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.undeploy_system_instance_request.UndeploySystemInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.UndeploySystemInstance"
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.undeploy_system_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_undeploy_system_instance(
