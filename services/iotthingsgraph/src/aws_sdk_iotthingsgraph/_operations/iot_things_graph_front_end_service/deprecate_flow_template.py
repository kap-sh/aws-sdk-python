"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#DeprecateFlowTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.deprecate_flow_template_response.DeprecateFlowTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.deprecate_flow_template_request.DeprecateFlowTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.DeprecateFlowTemplate"
    import aws_sdk_iotthingsgraph.types.deprecate_flow_template_request

    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.deprecate_flow_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_deprecate_flow_template(
