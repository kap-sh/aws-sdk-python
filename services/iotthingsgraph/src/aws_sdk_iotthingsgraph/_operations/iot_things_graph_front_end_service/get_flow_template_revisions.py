"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#GetFlowTemplateRevisions``."""
...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.get_flow_template_revisions_response.GetFlowTemplateRevisionsResponse = aws_sdk_iotthingsgraph.types.get_flow_template_revisions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.get_flow_template_revisions_request.GetFlowTemplateRevisionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.GetFlowTemplateRevisions"
    import aws_sdk_iotthingsgraph.types.get_flow_template_revisions_request

    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.get_flow_template_revisions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_flow_template_revisions(
