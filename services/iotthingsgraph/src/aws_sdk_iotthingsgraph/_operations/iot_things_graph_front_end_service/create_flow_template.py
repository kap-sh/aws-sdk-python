"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#CreateFlowTemplate``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            import aws_sdk_iotthingsgraph.errors.limit_exceeded_exception

            raise aws_sdk_iotthingsgraph.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data
            )
        case "ResourceAlreadyExistsException":
            import aws_sdk_iotthingsgraph.errors.resource_already_exists_exception

            raise aws_sdk_iotthingsgraph.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.create_flow_template_response.CreateFlowTemplateResponse = aws_sdk_iotthingsgraph.types.create_flow_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.create_flow_template_request.CreateFlowTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.create_flow_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_flow_template(
