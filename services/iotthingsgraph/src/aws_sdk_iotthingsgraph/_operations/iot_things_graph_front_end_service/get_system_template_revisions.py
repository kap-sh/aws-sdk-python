...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.get_system_template_revisions_response.GetSystemTemplateRevisionsResponse = aws_sdk_iotthingsgraph.types.get_system_template_revisions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.get_system_template_revisions_request.GetSystemTemplateRevisionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.get_system_template_revisions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
