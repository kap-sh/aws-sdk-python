...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.upload_entity_definitions_response.UploadEntityDefinitionsResponse = aws_sdk_iotthingsgraph.types.upload_entity_definitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.upload_entity_definitions_request.UploadEntityDefinitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.upload_entity_definitions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
