"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#SearchEntities``."""
...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.search_entities_response.SearchEntitiesResponse = aws_sdk_iotthingsgraph.types.search_entities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.search_entities_request.SearchEntitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.search_entities_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
