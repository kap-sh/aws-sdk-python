...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.delete_flow_template_response.DeleteFlowTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.delete_flow_template_request.DeleteFlowTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.delete_flow_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
