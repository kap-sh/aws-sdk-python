...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.describe_namespace_response.DescribeNamespaceResponse = aws_sdk_iotthingsgraph.types.describe_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.describe_namespace_request.DescribeNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.describe_namespace_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
