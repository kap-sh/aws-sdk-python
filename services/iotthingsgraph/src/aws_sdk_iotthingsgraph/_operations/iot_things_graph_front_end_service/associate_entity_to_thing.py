"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#AssociateEntityToThing``."""
...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.associate_entity_to_thing_response.AssociateEntityToThingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.associate_entity_to_thing_request.AssociateEntityToThingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.AssociateEntityToThing"
    import aws_sdk_iotthingsgraph.types.associate_entity_to_thing_request

    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.associate_entity_to_thing_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_entity_to_thing(
