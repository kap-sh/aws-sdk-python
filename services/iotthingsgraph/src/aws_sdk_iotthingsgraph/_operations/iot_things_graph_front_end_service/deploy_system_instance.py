...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.deploy_system_instance_response.DeploySystemInstanceResponse = aws_sdk_iotthingsgraph.types.deploy_system_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.deploy_system_instance_request.DeploySystemInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iotthingsgraph.types.deploy_system_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
