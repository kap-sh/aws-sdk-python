"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#DeleteNamespace``."""
...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.delete_namespace_response.DeleteNamespaceResponse = aws_sdk_iotthingsgraph.types.delete_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.delete_namespace_request.DeleteNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
