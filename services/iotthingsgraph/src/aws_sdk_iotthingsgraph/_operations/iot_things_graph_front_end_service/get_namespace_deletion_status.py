...
def handle_response(
    ...
    out: aws_sdk_iotthingsgraph.types.get_namespace_deletion_status_response.GetNamespaceDeletionStatusResponse = aws_sdk_iotthingsgraph.types.get_namespace_deletion_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_iotthingsgraph.types.get_namespace_deletion_status_request.GetNamespaceDeletionStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
