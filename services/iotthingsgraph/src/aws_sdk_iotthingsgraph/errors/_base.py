...
class IoTThingsGraphError(Exception):
    """Base class for all IoTThingsGraph service errors."""


class ServiceError(IoTThingsGraphError):
...
class SerializationError(IoTThingsGraphError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IoTThingsGraphError):
...
class WaiterFailedError(IoTThingsGraphError):
...
class WaiterTimeoutError(IoTThingsGraphError):
