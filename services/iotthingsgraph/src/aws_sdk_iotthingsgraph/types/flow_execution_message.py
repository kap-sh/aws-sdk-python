...
if TYPE_CHECKING:
    ...
    import aws_sdk_iotthingsgraph.types.flow_execution_message_id
    import aws_sdk_iotthingsgraph.types.flow_execution_message_payload
...
class FlowExecutionMessage(TypedDict, closed=True):
    ...
    event_type: NotRequired[
        "aws_sdk_iotthingsgraph.types.flow_execution_event_type.FlowExecutionEventType"
    ]
    """<p>The type of flow event .</p>"""
    timestamp: NotRequired["aws_sdk_iotthingsgraph.types.timestamp.Timestamp"]
    """<p>The date and time when the message was last updated.</p>"""
    payload: NotRequired[
        "aws_sdk_iotthingsgraph.types.flow_execution_message_payload.FlowExecutionMessagePayload"
    ]
...
def serialize_aws_json_1_1(value: FlowExecutionMessage) -> dict:
    ...
    if "event_type" in value:
        ...
        out["eventType"] = (
            aws_sdk_iotthingsgraph.types.flow_execution_event_type.serialize_aws_json_1_1(
                value["event_type"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> FlowExecutionMessage:
    ...
    if "eventType" in data:
        ...
        out["event_type"] = (
            aws_sdk_iotthingsgraph.types.flow_execution_event_type.deserialize_aws_json_1_1(
                data["eventType"]
            )
        )
