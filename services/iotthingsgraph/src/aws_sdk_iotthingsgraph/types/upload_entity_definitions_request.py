...
class UploadEntityDefinitionsRequest(TypedDict):
    ...
    sync_with_public_namespace: "aws_sdk_iotthingsgraph.types.sync_with_public_namespace.SyncWithPublicNamespace"
    ...
    deprecate_existing_entities: "aws_sdk_iotthingsgraph.types.deprecate_existing_entities.DeprecateExistingEntities"
