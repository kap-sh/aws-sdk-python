...
if TYPE_CHECKING:
    ...
    import aws_sdk_iotthingsgraph.types.flow_execution_status
...
class FlowExecutionSummary(TypedDict):
    ...
    status: NotRequired[
        "aws_sdk_iotthingsgraph.types.flow_execution_status.FlowExecutionStatus"
    ]
    """<p>The current status of the flow execution.</p>"""
    system_instance_id: NotRequired["aws_sdk_iotthingsgraph.types.urn.Urn"]
    """<p>The ID of the system instance that contains the flow.</p>"""
    flow_template_id: NotRequired["aws_sdk_iotthingsgraph.types.urn.Urn"]
...
def serialize_aws_json_1_1(value: FlowExecutionSummary) -> dict:
    ...
    if "status" in value:
        ...
        out["status"] = (
            aws_sdk_iotthingsgraph.types.flow_execution_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> FlowExecutionSummary:
    ...
    if "status" in data:
        ...
        out["status"] = (
            aws_sdk_iotthingsgraph.types.flow_execution_status.deserialize_aws_json_1_1(
                data["status"]
            )
        )
