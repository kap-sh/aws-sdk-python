...
if TYPE_CHECKING:
    import aws_sdk_iotthingsgraph.types.enabled
    import aws_sdk_iotthingsgraph.types.role_arn


class MetricsConfiguration(TypedDict, closed=True):
    cloud_metric_enabled: "aws_sdk_iotthingsgraph.types.enabled.Enabled"
    """<p>A Boolean that specifies whether cloud metrics are collected.</p>"""
    metric_rule_role_arn: NotRequired["aws_sdk_iotthingsgraph.types.role_arn.RoleArn"]
