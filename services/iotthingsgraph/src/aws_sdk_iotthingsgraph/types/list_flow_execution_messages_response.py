...
class ListFlowExecutionMessagesResponse(TypedDict):
    messages: NotRequired[
        "aws_sdk_iotthingsgraph.types.flow_execution_messages.FlowExecutionMessages"
    ]
...
def serialize_aws_json_1_1(value: ListFlowExecutionMessagesResponse) -> dict:
    ...
    if "messages" in value:
        ...
        out["messages"] = (
            aws_sdk_iotthingsgraph.types.flow_execution_messages.serialize_aws_json_1_1(
                value["messages"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListFlowExecutionMessagesResponse:
    ...
    if "messages" in data:
        ...
        out["messages"] = (
            aws_sdk_iotthingsgraph.types.flow_execution_messages.deserialize_aws_json_1_1(
                data["messages"]
            )
        )
