...
from capo_iotthingsgraph._services._aws_config import aaws_config
...
class AsyncIoTThingsGraphClient:
    ...
    def __init__(
        ...
        self._config = AsyncIoTThingsGraphClientConfig(
            {
    ...
    def operation_options(
        ...
        overrides: AsyncIoTThingsGraphClientConfig = config_overrides or {}
    ...
    async def associate_entity_to_thing(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.associate_entity_to_thing_request.AssociateEntityToThingRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.associate_entity_to_thing_response.AssociateEntityToThingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.associate_entity_to_thing.async_associate_entity_to_thing(
    ...
    async def create_flow_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.create_flow_template_request.CreateFlowTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.create_flow_template_response.CreateFlowTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.create_flow_template.async_create_flow_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_system_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.create_system_instance_request.CreateSystemInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.create_system_instance_response.CreateSystemInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.create_system_instance.async_create_system_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_system_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.create_system_template_request.CreateSystemTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.create_system_template_response.CreateSystemTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.create_system_template.async_create_system_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_flow_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.delete_flow_template_request.DeleteFlowTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.delete_flow_template_response.DeleteFlowTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.delete_flow_template.async_delete_flow_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_namespace(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.delete_namespace_request.DeleteNamespaceRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.delete_namespace_response.DeleteNamespaceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.delete_namespace.async_delete_namespace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_system_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.delete_system_instance_request.DeleteSystemInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.delete_system_instance_response.DeleteSystemInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.delete_system_instance.async_delete_system_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_system_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.delete_system_template_request.DeleteSystemTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.delete_system_template_response.DeleteSystemTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.delete_system_template.async_delete_system_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deploy_system_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.deploy_system_instance_request.DeploySystemInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.deploy_system_instance_response.DeploySystemInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.deploy_system_instance.async_deploy_system_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deprecate_flow_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.deprecate_flow_template_request.DeprecateFlowTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.deprecate_flow_template_response.DeprecateFlowTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.deprecate_flow_template.async_deprecate_flow_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deprecate_system_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.deprecate_system_template_request.DeprecateSystemTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.deprecate_system_template_response.DeprecateSystemTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.deprecate_system_template.async_deprecate_system_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_namespace(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.describe_namespace_request.DescribeNamespaceRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.describe_namespace_response.DescribeNamespaceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.describe_namespace.async_describe_namespace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def dissociate_entity_from_thing(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.dissociate_entity_from_thing_request.DissociateEntityFromThingRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.dissociate_entity_from_thing_response.DissociateEntityFromThingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.dissociate_entity_from_thing.async_dissociate_entity_from_thing(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_entities(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.get_entities_request.GetEntitiesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.get_entities_response.GetEntitiesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.get_entities.async_get_entities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_flow_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.get_flow_template_request.GetFlowTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.get_flow_template_response.GetFlowTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.get_flow_template.async_get_flow_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_flow_template_revisions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.get_flow_template_revisions_request.GetFlowTemplateRevisionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.get_flow_template_revisions_response.GetFlowTemplateRevisionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.get_flow_template_revisions.async_get_flow_template_revisions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_iotthingsgraph.types.flow_template_summary.FlowTemplateSummary]":
        _token = next_token
        while True:
            _response = await self.get_flow_template_revisions(
                id,
    ...
    async def get_namespace_deletion_status(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.get_namespace_deletion_status_request.GetNamespaceDeletionStatusRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.get_namespace_deletion_status_response.GetNamespaceDeletionStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.get_namespace_deletion_status.async_get_namespace_deletion_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_system_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.get_system_instance_request.GetSystemInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.get_system_instance_response.GetSystemInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.get_system_instance.async_get_system_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_system_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.get_system_template_request.GetSystemTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.get_system_template_response.GetSystemTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.get_system_template.async_get_system_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_system_template_revisions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.get_system_template_revisions_request.GetSystemTemplateRevisionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.get_system_template_revisions_response.GetSystemTemplateRevisionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.get_system_template_revisions.async_get_system_template_revisions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_iotthingsgraph.types.system_template_summary.SystemTemplateSummary]":
        _token = next_token
        while True:
            _response = await self.get_system_template_revisions(
                id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def get_upload_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.get_upload_status_request.GetUploadStatusRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.get_upload_status_response.GetUploadStatusResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.get_upload_status.async_get_upload_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_flow_execution_messages(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.list_flow_execution_messages_request.ListFlowExecutionMessagesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.list_flow_execution_messages_response.ListFlowExecutionMessagesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.list_flow_execution_messages.async_list_flow_execution_messages(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_iotthingsgraph.types.flow_execution_message.FlowExecutionMessage]":
        _token = next_token
        while True:
            _response = await self.list_flow_execution_messages(
                flow_execution_id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_tags_for_resource(
        ...
        *,
        ...
        next_token: Optional["capo_iotthingsgraph.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_iotthingsgraph.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    async def search_entities(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.search_entities_request.SearchEntitiesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.search_entities_response.SearchEntitiesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.search_entities.async_search_entities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_search_entities(
        ...
        *,
        ...
        "AsyncIterator[capo_iotthingsgraph.types.entity_description.EntityDescription]"
    ):
        _token = next_token
        while True:
            _response = await self.search_entities(
                entity_types,
                config_overrides=config_overrides,
                filters=filters,
                next_token=_token,
    ...
    async def search_flow_executions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.search_flow_executions_request.SearchFlowExecutionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.search_flow_executions_response.SearchFlowExecutionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.search_flow_executions.async_search_flow_executions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_iotthingsgraph.types.flow_execution_summary.FlowExecutionSummary]":
        _token = next_token
        while True:
            _response = await self.search_flow_executions(
                system_instance_id,
                config_overrides=config_overrides,
    ...
    async def search_flow_templates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.search_flow_templates_request.SearchFlowTemplatesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.search_flow_templates_response.SearchFlowTemplatesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.search_flow_templates.async_search_flow_templates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_search_flow_templates(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.search_flow_templates(
                config_overrides=config_overrides,
                filters=filters,
                next_token=_token,
                max_results=max_results,
    ...
    async def search_system_instances(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.search_system_instances_request.SearchSystemInstancesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.search_system_instances_response.SearchSystemInstancesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.search_system_instances.async_search_system_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_iotthingsgraph.types.system_instance_summary.SystemInstanceSummary]":
        _token = next_token
        while True:
            _response = await self.search_system_instances(
                config_overrides=config_overrides,
                filters=filters,
                next_token=_token,
                max_results=max_results,
    ...
    async def search_system_templates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.search_system_templates_request.SearchSystemTemplatesRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.search_system_templates_response.SearchSystemTemplatesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.search_system_templates.async_search_system_templates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_search_system_templates(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.search_system_templates(
                config_overrides=config_overrides,
                filters=filters,
                next_token=_token,
                max_results=max_results,
    ...
    async def search_things(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.search_things_request.SearchThingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.search_things_response.SearchThingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.search_things.async_search_things(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_search_things(
        ...
        *,
        ...
        namespace_version: Optional["capo_iotthingsgraph.types.version.Version"] = None,
    ) -> "AsyncIterator[capo_iotthingsgraph.types.thing.Thing]":
        _token = next_token
        while True:
            _response = await self.search_things(
                entity_id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def undeploy_system_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.undeploy_system_instance_request.UndeploySystemInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.undeploy_system_instance_response.UndeploySystemInstanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.undeploy_system_instance.async_undeploy_system_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_flow_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.update_flow_template_request.UpdateFlowTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.update_flow_template_response.UpdateFlowTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.update_flow_template.async_update_flow_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_system_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.update_system_template_request.UpdateSystemTemplateRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.update_system_template_response.UpdateSystemTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.update_system_template.async_update_system_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def upload_entity_definitions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_iotthingsgraph.types.upload_entity_definitions_request.UploadEntityDefinitionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_iotthingsgraph.types.upload_entity_definitions_response.UploadEntityDefinitionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_iotthingsgraph._operations.iot_things_graph_front_end_service.upload_entity_definitions.async_upload_entity_definitions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
