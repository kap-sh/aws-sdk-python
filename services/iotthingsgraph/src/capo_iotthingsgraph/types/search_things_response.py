...
class SearchThingsResponse(TypedDict, closed=True):
    things: NotRequired["capo_iotthingsgraph.types.things.Things"]
...
def serialize_aws_json_1_1(value: SearchThingsResponse) -> dict:
    ...
    if "things" in value:
        ...
        out["things"] = capo_iotthingsgraph.types.things.serialize_aws_json_1_1(
            value["things"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> SearchThingsResponse:
    ...
    if "things" in data:
        ...
        out["things"] = capo_iotthingsgraph.types.things.deserialize_aws_json_1_1(
            data["things"]
        )
