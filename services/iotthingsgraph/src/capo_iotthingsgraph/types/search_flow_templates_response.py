"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#SearchFlowTemplatesResponse``."""
...
class SearchFlowTemplatesResponse(TypedDict, closed=True):
    summaries: NotRequired[
        "capo_iotthingsgraph.types.flow_template_summaries.FlowTemplateSummaries"
    ]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: SearchFlowTemplatesResponse) -> dict:
    out: dict = {}
    if "summaries" in value:
        import capo_iotthingsgraph.types.flow_template_summaries

        out["summaries"] = (
            capo_iotthingsgraph.types.flow_template_summaries.serialize_aws_json_1_1(
                value["summaries"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> SearchFlowTemplatesResponse:
    ...
    if "summaries" in data:
        ...
        out["summaries"] = (
            capo_iotthingsgraph.types.flow_template_summaries.deserialize_aws_json_1_1(
                data["summaries"]
            )
        )
