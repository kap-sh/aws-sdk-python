"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#SearchFlowExecutions``."""
...
import capo_iotthingsgraph.types.flow_execution_summaries
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.search_flow_executions_response.SearchFlowExecutionsResponse = capo_iotthingsgraph.types.search_flow_executions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.SearchFlowExecutions"
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.search_flow_executions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_search_flow_executions(
