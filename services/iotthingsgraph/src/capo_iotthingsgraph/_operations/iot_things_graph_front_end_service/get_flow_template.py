"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#GetFlowTemplate``."""
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.get_flow_template_response.GetFlowTemplateResponse = capo_iotthingsgraph.types.get_flow_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.get_flow_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_flow_template(
