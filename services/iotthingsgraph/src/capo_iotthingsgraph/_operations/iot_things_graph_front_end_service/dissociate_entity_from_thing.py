"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#DissociateEntityFromThing``."""
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.dissociate_entity_from_thing_response.DissociateEntityFromThingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.dissociate_entity_from_thing_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_dissociate_entity_from_thing(
