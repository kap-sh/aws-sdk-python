"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#UpdateSystemTemplate``."""
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.update_system_template_response.UpdateSystemTemplateResponse = capo_iotthingsgraph.types.update_system_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.UpdateSystemTemplate"
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.update_system_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_system_template(
