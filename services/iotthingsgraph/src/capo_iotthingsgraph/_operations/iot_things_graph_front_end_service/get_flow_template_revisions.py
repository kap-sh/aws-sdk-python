...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.get_flow_template_revisions_response.GetFlowTemplateRevisionsResponse = capo_iotthingsgraph.types.get_flow_template_revisions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.get_flow_template_revisions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
