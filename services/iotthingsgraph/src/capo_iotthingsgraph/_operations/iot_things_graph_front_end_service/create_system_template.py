"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#CreateSystemTemplate``."""
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.create_system_template_response.CreateSystemTemplateResponse = capo_iotthingsgraph.types.create_system_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.CreateSystemTemplate"
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.create_system_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_system_template(
