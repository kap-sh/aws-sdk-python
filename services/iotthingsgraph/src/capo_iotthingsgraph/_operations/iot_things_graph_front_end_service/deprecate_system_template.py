"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#DeprecateSystemTemplate``."""
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.deprecate_system_template_response.DeprecateSystemTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.DeprecateSystemTemplate"
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.deprecate_system_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_deprecate_system_template(
