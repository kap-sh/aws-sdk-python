...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.associate_entity_to_thing_response.AssociateEntityToThingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.associate_entity_to_thing_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
