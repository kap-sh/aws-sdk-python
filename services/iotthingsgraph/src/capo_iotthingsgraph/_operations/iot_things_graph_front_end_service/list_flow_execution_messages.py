...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.list_flow_execution_messages_response.ListFlowExecutionMessagesResponse = capo_iotthingsgraph.types.list_flow_execution_messages_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.list_flow_execution_messages_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
