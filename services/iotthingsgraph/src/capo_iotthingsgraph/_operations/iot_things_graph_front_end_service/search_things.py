"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#SearchThings``."""
...
import capo_iotthingsgraph.types.things
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.search_things_response.SearchThingsResponse = (
        capo_iotthingsgraph.types.search_things_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.search_things_request.serialize_aws_json_1_1(input_)
    ).encode()
