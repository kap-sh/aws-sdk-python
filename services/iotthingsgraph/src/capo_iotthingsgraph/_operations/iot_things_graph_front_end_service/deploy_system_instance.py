"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#DeploySystemInstance``."""
...
import capo_iotthingsgraph.errors.resource_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise capo_iotthingsgraph.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.deploy_system_instance_response.DeploySystemInstanceResponse = capo_iotthingsgraph.types.deploy_system_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.DeploySystemInstance"
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.deploy_system_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_deploy_system_instance(
