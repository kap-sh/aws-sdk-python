...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.deprecate_flow_template_response.DeprecateFlowTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.deprecate_flow_template_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
