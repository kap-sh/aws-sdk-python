"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#GetSystemTemplateRevisions``."""
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.get_system_template_revisions_response.GetSystemTemplateRevisionsResponse = capo_iotthingsgraph.types.get_system_template_revisions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.GetSystemTemplateRevisions"
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.get_system_template_revisions_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_system_template_revisions(
