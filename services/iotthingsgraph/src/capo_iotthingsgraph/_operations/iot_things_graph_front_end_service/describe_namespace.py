"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#DescribeNamespace``."""
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.describe_namespace_response.DescribeNamespaceResponse = capo_iotthingsgraph.types.describe_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.describe_namespace_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
