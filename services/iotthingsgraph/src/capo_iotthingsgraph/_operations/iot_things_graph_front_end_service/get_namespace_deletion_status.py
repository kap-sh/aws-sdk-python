"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#GetNamespaceDeletionStatus``."""
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.get_namespace_deletion_status_response.GetNamespaceDeletionStatusResponse = capo_iotthingsgraph.types.get_namespace_deletion_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.GetNamespaceDeletionStatus"
    body: bytes | None = b""
...
async def async_get_namespace_deletion_status(
