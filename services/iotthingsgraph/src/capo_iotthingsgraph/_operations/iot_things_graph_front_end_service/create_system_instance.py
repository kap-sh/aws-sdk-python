"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#CreateSystemInstance``."""
...
import capo_iotthingsgraph.errors.limit_exceeded_exception
import capo_iotthingsgraph.errors.resource_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise capo_iotthingsgraph.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data
            )
        case "ResourceAlreadyExistsException":
            raise capo_iotthingsgraph.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.create_system_instance_response.CreateSystemInstanceResponse = capo_iotthingsgraph.types.create_system_instance_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_iotthingsgraph._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.CreateSystemInstance"
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.create_system_instance_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_system_instance(
