"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotthingsgraph#ThrottlingException``."""
