...
if TYPE_CHECKING:
    import aws_sdk_timestream_query.types.dimension_value_type
    import aws_sdk_timestream_query.types.schema_name


class DimensionMapping(TypedDict, closed=True):
    name: "aws_sdk_timestream_query.types.schema_name.SchemaName"
    """<p>Column name from query result.</p>"""
    dimension_value_type: (
        "aws_sdk_timestream_query.types.dimension_value_type.DimensionValueType"
    )
...
def serialize_aws_json_1_0(value: DimensionMapping) -> dict:
    ...
    out["DimensionValueType"] = (
        aws_sdk_timestream_query.types.dimension_value_type.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DimensionMapping:
    ...
    if "DimensionValueType" in data:
        ...
        out["dimension_value_type"] = (
            aws_sdk_timestream_query.types.dimension_value_type.deserialize_aws_json_1_0(
