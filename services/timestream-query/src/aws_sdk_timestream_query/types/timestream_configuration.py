...
if TYPE_CHECKING:
    import aws_sdk_timestream_query.types.dimension_mapping_list
    import aws_sdk_timestream_query.types.mixed_measure_mapping_list
    import aws_sdk_timestream_query.types.multi_measure_mappings
    import aws_sdk_timestream_query.types.resource_name
    import aws_sdk_timestream_query.types.schema_name


class TimestreamConfiguration(TypedDict):
    database_name: "aws_sdk_timestream_query.types.resource_name.ResourceName"
    """<p>Name of Timestream database to which the query result will be written.</p>"""
    table_name: "aws_sdk_timestream_query.types.resource_name.ResourceName"
    ...
    time_column: "aws_sdk_timestream_query.types.schema_name.SchemaName"
    ...
    dimension_mappings: (
        "aws_sdk_timestream_query.types.dimension_mapping_list.DimensionMappingList"
    )
    ...
    multi_measure_mappings: NotRequired[
        "aws_sdk_timestream_query.types.multi_measure_mappings.MultiMeasureMappings"
    ]
    """<p>Multi-measure mappings.</p>"""
    mixed_measure_mappings: NotRequired[
        "aws_sdk_timestream_query.types.mixed_measure_mapping_list.MixedMeasureMappingList"
    ]
...
def serialize_aws_json_1_0(value: TimestreamConfiguration) -> dict:
    ...
    out["DimensionMappings"] = (
        aws_sdk_timestream_query.types.dimension_mapping_list.serialize_aws_json_1_0(
    ...
    if "multi_measure_mappings" in value:
        ...
        out["MultiMeasureMappings"] = (
            aws_sdk_timestream_query.types.multi_measure_mappings.serialize_aws_json_1_0(
    ...
    if "mixed_measure_mappings" in value:
        ...
        out["MixedMeasureMappings"] = (
            aws_sdk_timestream_query.types.mixed_measure_mapping_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> TimestreamConfiguration:
    ...
    if "DimensionMappings" in data:
        ...
        out["dimension_mappings"] = (
            aws_sdk_timestream_query.types.dimension_mapping_list.deserialize_aws_json_1_0(
    ...
    if "MultiMeasureMappings" in data:
        ...
        out["multi_measure_mappings"] = (
            aws_sdk_timestream_query.types.multi_measure_mappings.deserialize_aws_json_1_0(
    ...
    if "MixedMeasureMappings" in data:
        ...
        out["mixed_measure_mappings"] = (
            aws_sdk_timestream_query.types.mixed_measure_mapping_list.deserialize_aws_json_1_0(
