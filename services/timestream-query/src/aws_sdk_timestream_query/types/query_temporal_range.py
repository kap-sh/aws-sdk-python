...
if TYPE_CHECKING:
    import aws_sdk_timestream_query.types.query_temporal_range_max


class QueryTemporalRange(TypedDict):
    max: NotRequired[
        "aws_sdk_timestream_query.types.query_temporal_range_max.QueryTemporalRangeMax"
    ]
...
def serialize_aws_json_1_0(value: QueryTemporalRange) -> dict:
    ...
    if "max" in value:
        ...
        out["Max"] = (
            aws_sdk_timestream_query.types.query_temporal_range_max.serialize_aws_json_1_0(
                value["max"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> QueryTemporalRange:
    ...
    if "Max" in data:
        ...
        out["max"] = (
            aws_sdk_timestream_query.types.query_temporal_range_max.deserialize_aws_json_1_0(
                data["Max"]
            )
        )
    return out
