...
if TYPE_CHECKING:
    import aws_sdk_timestream_query.types.column_info

ColumnInfoList: TypeAlias = list[
...
def serialize_aws_json_1_0(value: ColumnInfoList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_timestream_query.types.column_info.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ColumnInfoList:
    ...
    for item in data:
        out.append(
            aws_sdk_timestream_query.types.column_info.deserialize_aws_json_1_0(item)
        )
    return out
