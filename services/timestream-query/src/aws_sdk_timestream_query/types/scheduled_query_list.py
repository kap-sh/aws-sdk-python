...
ScheduledQueryList: TypeAlias = list[
    "aws_sdk_timestream_query.types.scheduled_query.ScheduledQuery"
]
...
def serialize_aws_json_1_0(value: ScheduledQueryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_timestream_query.types.scheduled_query.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ScheduledQueryList:
    ...
    for item in data:
        out.append(
            aws_sdk_timestream_query.types.scheduled_query.deserialize_aws_json_1_0(
                item
            )
        )
    return out
