...
if TYPE_CHECKING:
    ...
    import aws_sdk_timestream_query.types.query_spatial_coverage
    import aws_sdk_timestream_query.types.query_temporal_range


class QueryInsightsResponse(TypedDict):
    query_spatial_coverage: NotRequired[
        "aws_sdk_timestream_query.types.query_spatial_coverage.QuerySpatialCoverage"
    ]
    ...
    query_temporal_range: NotRequired[
        "aws_sdk_timestream_query.types.query_temporal_range.QueryTemporalRange"
    ]
    ...
    query_table_count: NotRequired["aws_sdk_timestream_query.types.long.Long"]
    """<p>Indicates the number of tables in the query.</p>"""
    output_rows: NotRequired["aws_sdk_timestream_query.types.long.Long"]
    ...
    output_bytes: NotRequired["aws_sdk_timestream_query.types.long.Long"]
    ...
    unload_partition_count: NotRequired["aws_sdk_timestream_query.types.long.Long"]
    """<p>Indicates the partitions created by the <code>Unload</code> operation.</p>"""
    unload_written_rows: NotRequired["aws_sdk_timestream_query.types.long.Long"]
    """<p>Indicates the rows written by the <code>Unload</code> query.</p>"""
    unload_written_bytes: NotRequired["aws_sdk_timestream_query.types.long.Long"]
...
def serialize_aws_json_1_0(value: QueryInsightsResponse) -> dict:
    ...
    if "query_spatial_coverage" in value:
        ...
        out["QuerySpatialCoverage"] = (
            aws_sdk_timestream_query.types.query_spatial_coverage.serialize_aws_json_1_0(
    ...
    if "query_temporal_range" in value:
        ...
        out["QueryTemporalRange"] = (
            aws_sdk_timestream_query.types.query_temporal_range.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> QueryInsightsResponse:
    ...
    if "QuerySpatialCoverage" in data:
        ...
        out["query_spatial_coverage"] = (
            aws_sdk_timestream_query.types.query_spatial_coverage.deserialize_aws_json_1_0(
    ...
    if "QueryTemporalRange" in data:
        ...
        out["query_temporal_range"] = (
            aws_sdk_timestream_query.types.query_temporal_range.deserialize_aws_json_1_0(
