...
class ExecutionStats(TypedDict):
    ...
    bytes_metered: "aws_sdk_timestream_query.types.long.Long"
    ...
    records_ingested: "aws_sdk_timestream_query.types.long.Long"
    """<p>The number of records ingested for a single scheduled query run. </p>"""
    query_result_rows: "aws_sdk_timestream_query.types.long.Long"
