...
if TYPE_CHECKING:
    ...
    import aws_sdk_timestream_query.types.scalar_type
...
class Type(TypedDict):
    ...
    row_column_info: NotRequired[
        "aws_sdk_timestream_query.types.column_info_list.ColumnInfoList"
    ]
...
def serialize_aws_json_1_0(value: Type) -> dict:
    ...
    if "scalar_type" in value:
        ...
        out["ScalarType"] = (
            aws_sdk_timestream_query.types.scalar_type.serialize_aws_json_1_0(
                value["scalar_type"]
            )
        )
    if "array_column_info" in value:
        ...
        out["ArrayColumnInfo"] = (
            aws_sdk_timestream_query.types.column_info.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> Type:
    ...
    if "ScalarType" in data:
        ...
        out["scalar_type"] = (
            aws_sdk_timestream_query.types.scalar_type.deserialize_aws_json_1_0(
                data["ScalarType"]
            )
        )
    if "ArrayColumnInfo" in data:
        ...
        out["array_column_info"] = (
            aws_sdk_timestream_query.types.column_info.deserialize_aws_json_1_0(
