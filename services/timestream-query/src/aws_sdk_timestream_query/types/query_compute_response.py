...
class QueryComputeResponse(TypedDict):
    ...
    provisioned_capacity: NotRequired[
        "aws_sdk_timestream_query.types.provisioned_capacity_response.ProvisionedCapacityResponse"
    ]
...
def serialize_aws_json_1_0(value: QueryComputeResponse) -> dict:
    ...
    if "provisioned_capacity" in value:
        ...
        out["ProvisionedCapacity"] = (
            aws_sdk_timestream_query.types.provisioned_capacity_response.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> QueryComputeResponse:
    ...
    if "ProvisionedCapacity" in data:
        ...
        out["provisioned_capacity"] = (
            aws_sdk_timestream_query.types.provisioned_capacity_response.deserialize_aws_json_1_0(
