...
if TYPE_CHECKING:
    import aws_sdk_timestream_query.types.query_spatial_coverage_max


class QuerySpatialCoverage(TypedDict):
    max: NotRequired[
        "aws_sdk_timestream_query.types.query_spatial_coverage_max.QuerySpatialCoverageMax"
    ]
...
def serialize_aws_json_1_0(value: QuerySpatialCoverage) -> dict:
    ...
    if "max" in value:
        ...
        out["Max"] = (
            aws_sdk_timestream_query.types.query_spatial_coverage_max.serialize_aws_json_1_0(
                value["max"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> QuerySpatialCoverage:
    ...
    if "Max" in data:
        ...
        out["max"] = (
            aws_sdk_timestream_query.types.query_spatial_coverage_max.deserialize_aws_json_1_0(
                data["Max"]
            )
        )
    return out
