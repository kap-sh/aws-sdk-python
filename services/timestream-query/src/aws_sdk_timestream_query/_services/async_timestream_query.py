...
from aws_sdk_timestream_query._services._aws_config import aaws_config
...
class AsyncTimestreamQueryClientConfig(TypedDict, total=False):
...
class AsyncTimestreamQueryClient:
    ...
    async def cancel_query(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_query.types.cancel_query_request.CancelQueryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_timestream_query.types.cancel_query_response.CancelQueryResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_query._operations.timestream_20181101.cancel_query.async_cancel_query(
    ...
    async def create_scheduled_query(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_query.types.create_scheduled_query_request.CreateScheduledQueryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_timestream_query.types.create_scheduled_query_response.CreateScheduledQueryResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_query._operations.timestream_20181101.create_scheduled_query.async_create_scheduled_query(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_scheduled_query(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_query.types.delete_scheduled_query_request.DeleteScheduledQueryRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_query._operations.timestream_20181101.delete_scheduled_query.async_delete_scheduled_query(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_settings(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_query._operations.timestream_20181101.describe_account_settings.async_describe_account_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_endpoints(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_query._operations.timestream_20181101.describe_endpoints.async_describe_endpoints(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_scheduled_query(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_query.types.describe_scheduled_query_request.DescribeScheduledQueryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_timestream_query.types.describe_scheduled_query_response.DescribeScheduledQueryResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_query._operations.timestream_20181101.describe_scheduled_query.async_describe_scheduled_query(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def execute_scheduled_query(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_query.types.execute_scheduled_query_request.ExecuteScheduledQueryRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_query._operations.timestream_20181101.execute_scheduled_query.async_execute_scheduled_query(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_scheduled_queries(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_query.types.list_scheduled_queries_request.ListScheduledQueriesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_timestream_query.types.list_scheduled_queries_response.ListScheduledQueriesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_query._operations.timestream_20181101.list_scheduled_queries.async_list_scheduled_queries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_timestream_query.types.scheduled_query.ScheduledQuery]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_query.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_timestream_query.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_query._operations.timestream_20181101.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_timestream_query.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    async def prepare_query(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_query.types.prepare_query_request.PrepareQueryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_timestream_query.types.prepare_query_response.PrepareQueryResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_query._operations.timestream_20181101.prepare_query.async_prepare_query(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def query(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_query.types.query_request.QueryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_timestream_query.types.query_response.QueryResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_query._operations.timestream_20181101.query.async_query(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_timestream_query.types.row.Row]":
        _token = next_token
        while True:
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_query.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_timestream_query.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_query._operations.timestream_20181101.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_query.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_timestream_query.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_query._operations.timestream_20181101.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_account_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_query.types.update_account_settings_request.UpdateAccountSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_timestream_query.types.update_account_settings_response.UpdateAccountSettingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_query._operations.timestream_20181101.update_account_settings.async_update_account_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_scheduled_query(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_query.types.update_scheduled_query_request.UpdateScheduledQueryRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_query._operations.timestream_20181101.update_scheduled_query.async_update_scheduled_query(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
