...
from ._services.async_timestream_query import (
    AsyncTimestreamQueryClient as AsyncTimestreamQueryClient,
)
from ._services.timestream_query import TimestreamQueryClient as TimestreamQueryClient
