...
def build_request(
    ...
    input_: aws_sdk_timestream_query.types.execute_scheduled_query_request.ExecuteScheduledQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_timestream_query.types.execute_scheduled_query_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
