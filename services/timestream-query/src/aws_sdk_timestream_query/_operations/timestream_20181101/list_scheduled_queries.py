...
def handle_response(
    ...
    out: aws_sdk_timestream_query.types.list_scheduled_queries_response.ListScheduledQueriesResponse = aws_sdk_timestream_query.types.list_scheduled_queries_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_timestream_query.types.list_scheduled_queries_request.ListScheduledQueriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_timestream_query.types.list_scheduled_queries_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
