"""Generated from Smithy shape ``com.amazonaws.timestreamquery#UpdateScheduledQuery``."""
...
def build_request(
    ...
    input_: aws_sdk_timestream_query.types.update_scheduled_query_request.UpdateScheduledQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Timestream_20181101.UpdateScheduledQuery"
    import aws_sdk_timestream_query.types.update_scheduled_query_request

    body: bytes | None = json.dumps(
        aws_sdk_timestream_query.types.update_scheduled_query_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_scheduled_query(
