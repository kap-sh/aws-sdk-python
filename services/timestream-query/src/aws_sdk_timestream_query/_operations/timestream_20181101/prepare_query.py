...
def handle_response(
    ...
    out: aws_sdk_timestream_query.types.prepare_query_response.PrepareQueryResponse = (
        aws_sdk_timestream_query.types.prepare_query_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_timestream_query.types.prepare_query_request.PrepareQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_timestream_query.types.prepare_query_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
