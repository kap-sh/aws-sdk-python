"""Generated from Smithy shape ``com.amazonaws.timestreamquery#Query``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_timestream_query.errors.conflict_exception

            raise aws_sdk_timestream_query.errors.conflict_exception.ConflictException.from_aws_json_1_0(
                data
            )
        ...
        case "QueryExecutionException":
            import aws_sdk_timestream_query.errors.query_execution_exception

            raise aws_sdk_timestream_query.errors.query_execution_exception.QueryExecutionException.from_aws_json_1_0(
                data
            )
        ...
        case "ValidationException":
            import aws_sdk_timestream_query.errors.validation_exception

            raise aws_sdk_timestream_query.errors.validation_exception.ValidationException.from_aws_json_1_0(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_timestream_query.types.query_response.QueryResponse = (
        aws_sdk_timestream_query.types.query_response.deserialize_aws_json_1_0(
...
def get_signer(
...
) -> aws_sdk_timestream_query._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_timestream_query._auth._sigv4.build_sigv4_auth_scheme(
                "timestream", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_timestream_query._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_timestream_query.types.query_request.QueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Timestream_20181101.Query"
    import aws_sdk_timestream_query.types.query_request

    body: bytes | None = json.dumps(
        aws_sdk_timestream_query.types.query_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def query(
    ...
    aws_sdk_timestream_query.types.query_response.QueryResponse, zapros.Response
]:
