"""Generated from Smithy shape ``com.amazonaws.timestreamquery#UpdateAccountSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_timestream_query.types.update_account_settings_response.UpdateAccountSettingsResponse = aws_sdk_timestream_query.types.update_account_settings_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_timestream_query.types.update_account_settings_request.UpdateAccountSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Timestream_20181101.UpdateAccountSettings"
    import aws_sdk_timestream_query.types.update_account_settings_request

    body: bytes | None = json.dumps(
        aws_sdk_timestream_query.types.update_account_settings_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
