...
def handle_response(
    ...
    out: aws_sdk_timestream_query.types.create_scheduled_query_response.CreateScheduledQueryResponse = aws_sdk_timestream_query.types.create_scheduled_query_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_timestream_query.types.create_scheduled_query_request.CreateScheduledQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_timestream_query.types.create_scheduled_query_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
