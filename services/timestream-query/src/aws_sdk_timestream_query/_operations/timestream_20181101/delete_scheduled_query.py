"""Generated from Smithy shape ``com.amazonaws.timestreamquery#DeleteScheduledQuery``."""
...
def build_request(
    ...
    input_: aws_sdk_timestream_query.types.delete_scheduled_query_request.DeleteScheduledQueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Timestream_20181101.DeleteScheduledQuery"
    import aws_sdk_timestream_query.types.delete_scheduled_query_request

    body: bytes | None = json.dumps(
        aws_sdk_timestream_query.types.delete_scheduled_query_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
