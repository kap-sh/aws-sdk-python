"""Generated from Smithy shape ``com.amazonaws.timestreamquery#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.timestreamquery#InternalServerException``."""
