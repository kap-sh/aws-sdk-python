...
class TimestreamQueryError(Exception):
    """Base class for all TimestreamQuery service errors."""


class ServiceError(TimestreamQueryError):
...
class SerializationError(TimestreamQueryError):
    """Raised when a value cannot be serialized."""


class DeserializationError(TimestreamQueryError):
...
class WaiterFailedError(TimestreamQueryError):
...
class WaiterTimeoutError(TimestreamQueryError):
