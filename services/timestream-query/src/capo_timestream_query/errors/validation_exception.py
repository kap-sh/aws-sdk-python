"""Generated from Smithy shape ``com.amazonaws.timestreamquery#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.timestreamquery#ValidationException``."""
