"""Generated from Smithy shape ``com.amazonaws.timestreamquery#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.timestreamquery#ConflictException``."""
