...
if TYPE_CHECKING:
    ...
    import capo_timestream_query.types.provisioned_capacity_response
...
class QueryComputeResponse(TypedDict, closed=True):
    ...
    provisioned_capacity: NotRequired[
        "capo_timestream_query.types.provisioned_capacity_response.ProvisionedCapacityResponse"
    ]
    """<p>Configuration object that contains settings for provisioned Timestream Compute Units (TCUs) in your account.</p>"""


# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: QueryComputeResponse) -> dict:
    out: dict = {}
    ...
    if "provisioned_capacity" in value:
        ...
        out["ProvisionedCapacity"] = (
            capo_timestream_query.types.provisioned_capacity_response.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> QueryComputeResponse:
    out: QueryComputeResponse = {}  # type: ignore[typeddict-item]
    ...
    if "ProvisionedCapacity" in data:
        ...
        out["provisioned_capacity"] = (
            capo_timestream_query.types.provisioned_capacity_response.deserialize_aws_json_1_0(
