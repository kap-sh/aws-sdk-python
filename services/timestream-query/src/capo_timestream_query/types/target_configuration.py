...
class TargetConfiguration(TypedDict, closed=True):
    timestream_configuration: (
        "capo_timestream_query.types.timestream_configuration.TimestreamConfiguration"
    )
...
def serialize_aws_json_1_0(value: TargetConfiguration) -> dict:
    ...
    out["TimestreamConfiguration"] = (
        capo_timestream_query.types.timestream_configuration.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> TargetConfiguration:
    ...
    if "TimestreamConfiguration" in data:
        ...
        out["timestream_configuration"] = (
            capo_timestream_query.types.timestream_configuration.deserialize_aws_json_1_0(
