...
if TYPE_CHECKING:
    import capo_timestream_query.types.tag_key
    import capo_timestream_query.types.tag_value


class Tag(TypedDict, closed=True):
    key: "capo_timestream_query.types.tag_key.TagKey"
    """<p>The key of the tag. Tag keys are case sensitive. </p>"""
    value: "capo_timestream_query.types.tag_value.TagValue"
