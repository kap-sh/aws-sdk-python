...
import capo_timestream_query.errors.query_execution_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "QueryExecutionException":
            raise capo_timestream_query.errors.query_execution_exception.QueryExecutionException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_timestream_query.types.query_response.QueryResponse = (
        capo_timestream_query.types.query_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_timestream_query.types.query_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def query(
    ...
    input_: capo_timestream_query.types.query_request.QueryRequest,
) -> tuple[capo_timestream_query.types.query_response.QueryResponse, zapros.Response]:
