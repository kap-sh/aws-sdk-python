...
def handle_response(
    ...
    out: capo_timestream_query.types.update_account_settings_response.UpdateAccountSettingsResponse = capo_timestream_query.types.update_account_settings_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_timestream_query.types.update_account_settings_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
