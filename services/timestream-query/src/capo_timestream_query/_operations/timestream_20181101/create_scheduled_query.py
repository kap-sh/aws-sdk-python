"""Generated from Smithy shape ``com.amazonaws.timestreamquery#CreateScheduledQuery``."""
...
import capo_timestream_query.errors.conflict_exception
...
import capo_timestream_query.errors.service_quota_exceeded_exception
import capo_timestream_query.errors.throttling_exception
import capo_timestream_query.errors.validation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_timestream_query.errors.conflict_exception.ConflictException.from_aws_json_1_0(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_timestream_query.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
        ...
        case "ValidationException":
            raise capo_timestream_query.errors.validation_exception.ValidationException.from_aws_json_1_0(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_timestream_query.types.create_scheduled_query_response.CreateScheduledQueryResponse = capo_timestream_query.types.create_scheduled_query_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Timestream_20181101.CreateScheduledQuery"
    body: bytes | None = json.dumps(
        capo_timestream_query.types.create_scheduled_query_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_scheduled_query(
