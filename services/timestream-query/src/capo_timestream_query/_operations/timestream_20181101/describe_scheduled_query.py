"""Generated from Smithy shape ``com.amazonaws.timestreamquery#DescribeScheduledQuery``."""
...
import capo_timestream_query.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise capo_timestream_query.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_timestream_query.types.describe_scheduled_query_response.DescribeScheduledQueryResponse = capo_timestream_query.types.describe_scheduled_query_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Timestream_20181101.DescribeScheduledQuery"
    body: bytes | None = json.dumps(
        capo_timestream_query.types.describe_scheduled_query_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_describe_scheduled_query(
