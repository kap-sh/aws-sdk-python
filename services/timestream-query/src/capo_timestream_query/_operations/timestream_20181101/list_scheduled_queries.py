"""Generated from Smithy shape ``com.amazonaws.timestreamquery#ListScheduledQueries``."""
...
def handle_response(
    ...
    out: capo_timestream_query.types.list_scheduled_queries_response.ListScheduledQueriesResponse = capo_timestream_query.types.list_scheduled_queries_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Timestream_20181101.ListScheduledQueries"
    body: bytes | None = json.dumps(
        capo_timestream_query.types.list_scheduled_queries_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_scheduled_queries(
