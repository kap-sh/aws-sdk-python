...
def resolve(p: EndpointParams) -> Endpoint:  # type: ignore
    ...
    if p.Region is not None:
        ...
        if _locals["PartitionResult"] is not None:
                    ...
                    if True is get_attr(
                        ...
                        if True is get_attr(
                            ...
                            if string_equals(
                                ...
                                return Endpoint(
                                    url=interpolate(
                                        "https://timestream-query-fips.{Region}.api.aws",
                                        p,
                                        _locals,
                                    ),
                                    properties={},
                            ...
                            if string_equals(
                                ...
                                return Endpoint(
                                    url=interpolate(
                                        "https://timestream-query.{Region}.api.aws",
                                        p,
                                        _locals,
                                    ),
                                    properties={},
            ...
            if p.UseDualStack is True:
                if True is get_attr(
                    ...
                    if string_equals(
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://timestream-query.{Region}.api.aws", p, _locals
                            ),
                            properties={},
                            headers={},
                        )
            ...
            return Endpoint(
                url=interpolate(
                    "https://query.timestream.{Region}.{PartitionResult#dnsSuffix}",
                    p,
                    _locals,
                ),
                properties={},
