...
class SecurityLakeError(Exception):
    """Base class for all SecurityLake service errors."""


class ServiceError(SecurityLakeError):
...
class SerializationError(SecurityLakeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SecurityLakeError):
...
class WaiterFailedError(SecurityLakeError):
...
class WaiterTimeoutError(SecurityLakeError):
