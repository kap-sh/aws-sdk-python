"""Generated from Smithy shape ``com.amazonaws.securitylake#GetDataLakeOrganizationConfiguration``."""
...
def handle_response(
    ...
    out: capo_securitylake.types.get_data_lake_organization_configuration_response.GetDataLakeOrganizationConfigurationResponse = capo_securitylake.types.get_data_lake_organization_configuration_response.deserialize_json(
...
async def async_get_data_lake_organization_configuration(
