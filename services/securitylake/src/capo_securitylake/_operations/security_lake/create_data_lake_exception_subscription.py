...
def handle_response(
    ...
    out: capo_securitylake.types.create_data_lake_exception_subscription_response.CreateDataLakeExceptionSubscriptionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securitylake.types.create_data_lake_exception_subscription_request.serialize_json(
            input_
        )
    ).encode()
