...
def handle_response(
    ...
    out: capo_securitylake.types.deregister_data_lake_delegated_administrator_response.DeregisterDataLakeDelegatedAdministratorResponse = {}  # type: ignore[typeddict-item]
    return out
