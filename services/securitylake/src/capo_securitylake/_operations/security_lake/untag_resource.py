"""Generated from Smithy shape ``com.amazonaws.securitylake#UntagResource``."""
...
def handle_response(
    ...
    out: capo_securitylake.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
