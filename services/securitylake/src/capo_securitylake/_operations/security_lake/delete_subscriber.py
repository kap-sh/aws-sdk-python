"""Generated from Smithy shape ``com.amazonaws.securitylake#DeleteSubscriber``."""
...
def handle_response(
    ...
    out: capo_securitylake.types.delete_subscriber_response.DeleteSubscriberResponse = {}  # type: ignore[typeddict-item]
    return out
