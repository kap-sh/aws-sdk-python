...
def handle_response(
    ...
    out: capo_securitylake.types.list_log_sources_response.ListLogSourcesResponse = (
        capo_securitylake.types.list_log_sources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securitylake.types.list_log_sources_request.serialize_json(input_)
    ).encode()
