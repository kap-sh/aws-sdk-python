...
def handle_response(
    ...
    out: capo_securitylake.types.get_data_lake_sources_response.GetDataLakeSourcesResponse = capo_securitylake.types.get_data_lake_sources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securitylake.types.get_data_lake_sources_request.serialize_json(input_)
    ).encode()
