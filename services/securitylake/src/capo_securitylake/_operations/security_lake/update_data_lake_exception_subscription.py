"""Generated from Smithy shape ``com.amazonaws.securitylake#UpdateDataLakeExceptionSubscription``."""
...
def handle_response(
    ...
    out: capo_securitylake.types.update_data_lake_exception_subscription_response.UpdateDataLakeExceptionSubscriptionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securitylake.types.update_data_lake_exception_subscription_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_data_lake_exception_subscription(
