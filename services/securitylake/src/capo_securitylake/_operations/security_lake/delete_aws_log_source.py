...
def handle_response(
    ...
    out: capo_securitylake.types.delete_aws_log_source_response.DeleteAwsLogSourceResponse = capo_securitylake.types.delete_aws_log_source_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securitylake.types.delete_aws_log_source_request.serialize_json(input_)
    ).encode()
