"""Generated from Smithy shape ``com.amazonaws.securitylake#RegisterDataLakeDelegatedAdministrator``."""
...
def handle_response(
    ...
    out: capo_securitylake.types.register_data_lake_delegated_administrator_response.RegisterDataLakeDelegatedAdministratorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securitylake.types.register_data_lake_delegated_administrator_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_register_data_lake_delegated_administrator(
