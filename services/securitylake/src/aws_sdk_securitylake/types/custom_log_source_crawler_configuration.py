...
class CustomLogSourceCrawlerConfiguration(TypedDict):
    role_arn: "aws_sdk_securitylake.types.role_arn.RoleArn"
...
def deserialize_json(data: dict) -> CustomLogSourceCrawlerConfiguration:
    ...
    if "roleArn" in data:
        ...
        raise DeserializationError("CustomLogSourceCrawlerConfiguration.role_arn required")
    return out