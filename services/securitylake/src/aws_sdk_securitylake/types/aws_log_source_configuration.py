...
class AwsLogSourceConfiguration(TypedDict):
    ...
    source_version: "aws_sdk_securitylake.types.aws_log_source_version.AwsLogSourceVersion"
...
def serialize_json(value: AwsLogSourceConfiguration) -> dict:
    ...
    if "accounts" in value:
        import aws_sdk_securitylake.types.account_list
        out["accounts"] = aws_sdk_securitylake.types.account_list.serialize_json(value["accounts"])
    import aws_sdk_securitylake.types.region_list
    out["regions"] = aws_sdk_securitylake.types.region_list.serialize_json(value["regions"])
    import aws_sdk_securitylake.types.aws_log_source_name
...
def deserialize_json(data: dict) -> AwsLogSourceConfiguration:
    ...
    if "accounts" in data:
        import aws_sdk_securitylake.types.account_list
        out["accounts"] = aws_sdk_securitylake.types.account_list.deserialize_json(data["accounts"])
    if "regions" in data:
        import aws_sdk_securitylake.types.region_list
        out["regions"] = aws_sdk_securitylake.types.region_list.deserialize_json(data["regions"])
    else:
