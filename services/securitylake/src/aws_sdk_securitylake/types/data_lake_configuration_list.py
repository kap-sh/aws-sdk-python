...
DataLakeConfigurationList: TypeAlias = list[
    "aws_sdk_securitylake.types.data_lake_configuration.DataLakeConfiguration"
]
...
def serialize_json(value: DataLakeConfigurationList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_securitylake.types.data_lake_configuration.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> DataLakeConfigurationList:
    ...
    for item in data:
        out.append(
            aws_sdk_securitylake.types.data_lake_configuration.deserialize_json(item)
        )
    return out
