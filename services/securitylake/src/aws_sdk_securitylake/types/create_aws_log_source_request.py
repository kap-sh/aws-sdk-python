...
class CreateAwsLogSourceRequest(TypedDict):
...
def serialize_json(value: CreateAwsLogSourceRequest) -> dict:
    out: dict = {}
    import aws_sdk_securitylake.types.aws_log_source_configuration_list
    out["sources"] = aws_sdk_securitylake.types.aws_log_source_configuration_list.serialize_json(value["sources"])
    return out
...
def deserialize_json(data: dict) -> CreateAwsLogSourceRequest:
    ...
    if "sources" in data:
        import aws_sdk_securitylake.types.aws_log_source_configuration_list
        out["sources"] = aws_sdk_securitylake.types.aws_log_source_configuration_list.deserialize_json(data["sources"])
    else:
