...
class CreateCustomLogSourceRequest(TypedDict):
    ...
    event_classes: NotRequired["aws_sdk_securitylake.types.ocsf_event_class_list.OcsfEventClassList"]
...
def serialize_json(value: CreateCustomLogSourceRequest) -> dict:
    ...
    if "event_classes" in value:
        import aws_sdk_securitylake.types.ocsf_event_class_list
        out["eventClasses"] = aws_sdk_securitylake.types.ocsf_event_class_list.serialize_json(value["event_classes"])
    import aws_sdk_securitylake.types.custom_log_source_configuration
    out["configuration"] = aws_sdk_securitylake.types.custom_log_source_configuration.serialize_json(value["configuration"])
    return out
...
def deserialize_json(data: dict) -> CreateCustomLogSourceRequest:
    ...
    if "eventClasses" in data:
        import aws_sdk_securitylake.types.ocsf_event_class_list
        out["event_classes"] = aws_sdk_securitylake.types.ocsf_event_class_list.deserialize_json(data["eventClasses"])
    if "configuration" in data:
        import aws_sdk_securitylake.types.custom_log_source_configuration
        out["configuration"] = aws_sdk_securitylake.types.custom_log_source_configuration.deserialize_json(data["configuration"])
    else:
        raise DeserializationError("CreateCustomLogSourceRequest.configuration required")
    return out