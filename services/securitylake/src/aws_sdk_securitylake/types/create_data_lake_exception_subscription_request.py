...
def deserialize_json(data: dict) -> CreateDataLakeExceptionSubscriptionRequest:
    ...
    if "subscriptionProtocol" in data:
        ...
        raise DeserializationError("CreateDataLakeExceptionSubscriptionRequest.subscription_protocol required")
    if "notificationEndpoint" in data:
        out["notification_endpoint"] = data["notificationEndpoint"]
    else:
        raise DeserializationError("CreateDataLakeExceptionSubscriptionRequest.notification_endpoint required")
