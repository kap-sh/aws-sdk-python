...
def serialize_json(value: CreateSubscriberNotificationRequest) -> dict:
    out: dict = {}
    import aws_sdk_securitylake.types.notification_configuration
    out["configuration"] = aws_sdk_securitylake.types.notification_configuration.serialize_json(value["configuration"])
    return out
...
def deserialize_json(data: dict) -> CreateSubscriberNotificationRequest:
    ...
    if "configuration" in data:
        import aws_sdk_securitylake.types.notification_configuration
        out["configuration"] = aws_sdk_securitylake.types.notification_configuration.deserialize_json(data["configuration"])
    else:
        raise DeserializationError("CreateSubscriberNotificationRequest.configuration required")
    return out