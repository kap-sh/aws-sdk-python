...
class CreateCustomLogSourceResponse(TypedDict):
    source: NotRequired["aws_sdk_securitylake.types.custom_log_source_resource.CustomLogSourceResource"]
...
def serialize_json(value: CreateCustomLogSourceResponse) -> dict:
    ...
    if "source" in value:
        import aws_sdk_securitylake.types.custom_log_source_resource
        out["source"] = aws_sdk_securitylake.types.custom_log_source_resource.serialize_json(value["source"])
    return out
...
def deserialize_json(data: dict) -> CreateCustomLogSourceResponse:
    ...
    if "source" in data:
        import aws_sdk_securitylake.types.custom_log_source_resource
        out["source"] = aws_sdk_securitylake.types.custom_log_source_resource.deserialize_json(data["source"])
    return out