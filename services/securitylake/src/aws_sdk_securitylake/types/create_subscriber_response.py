...
class CreateSubscriberResponse(TypedDict):
    subscriber: NotRequired["aws_sdk_securitylake.types.subscriber_resource.SubscriberResource"]
...
def serialize_json(value: CreateSubscriberResponse) -> dict:
    ...
    if "subscriber" in value:
        import aws_sdk_securitylake.types.subscriber_resource
        out["subscriber"] = aws_sdk_securitylake.types.subscriber_resource.serialize_json(value["subscriber"])
    return out
...
def deserialize_json(data: dict) -> CreateSubscriberResponse:
    ...
    if "subscriber" in data:
        import aws_sdk_securitylake.types.subscriber_resource
        out["subscriber"] = aws_sdk_securitylake.types.subscriber_resource.deserialize_json(data["subscriber"])
    return out