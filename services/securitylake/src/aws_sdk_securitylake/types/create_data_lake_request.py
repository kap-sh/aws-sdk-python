...
class CreateDataLakeRequest(TypedDict):
...
def serialize_json(value: CreateDataLakeRequest) -> dict:
    out: dict = {}
    import aws_sdk_securitylake.types.data_lake_configuration_list
    out["configurations"] = aws_sdk_securitylake.types.data_lake_configuration_list.serialize_json(value["configurations"])
...
def deserialize_json(data: dict) -> CreateDataLakeRequest:
    ...
    if "configurations" in data:
        import aws_sdk_securitylake.types.data_lake_configuration_list
        out["configurations"] = aws_sdk_securitylake.types.data_lake_configuration_list.deserialize_json(data["configurations"])
    else:
    ...
    if "metaStoreManagerRoleArn" in data:
        ...
        raise DeserializationError("CreateDataLakeRequest.meta_store_manager_role_arn required")
    if "tags" in data:
        import aws_sdk_securitylake.types.tag_list
