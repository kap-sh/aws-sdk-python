...
def serialize_json(value: CustomLogSourceConfiguration) -> dict:
    ...
    out["crawlerConfiguration"] = (
        aws_sdk_securitylake.types.custom_log_source_crawler_configuration.serialize_json(
            value["crawler_configuration"]
        )
    )
    import aws_sdk_securitylake.types.aws_identity

    out["providerIdentity"] = aws_sdk_securitylake.types.aws_identity.serialize_json(
...
def deserialize_json(data: dict) -> CustomLogSourceConfiguration:
    ...
    if "crawlerConfiguration" in data:
        ...
        out["crawler_configuration"] = (
            aws_sdk_securitylake.types.custom_log_source_crawler_configuration.deserialize_json(
