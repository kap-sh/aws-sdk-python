...
DataLakeAutoEnableNewAccountConfigurationList: TypeAlias = list[
    "aws_sdk_securitylake.types.data_lake_auto_enable_new_account_configuration.DataLakeAutoEnableNewAccountConfiguration"
]
...
def serialize_json(value: DataLakeAutoEnableNewAccountConfigurationList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_securitylake.types.data_lake_auto_enable_new_account_configuration.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> DataLakeAutoEnableNewAccountConfigurationList:
    ...
    for item in data:
        out.append(
            aws_sdk_securitylake.types.data_lake_auto_enable_new_account_configuration.deserialize_json(
                item
            )
        )
    return out
