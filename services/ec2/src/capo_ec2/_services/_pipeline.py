...
from capo_ec2._async import anysleep
from capo_ec2.errors import ServiceError

if TYPE_CHECKING:
    from capo_ec2._auth._identity import Credentials
    from capo_ec2._auth._providers import IdentityProvider
