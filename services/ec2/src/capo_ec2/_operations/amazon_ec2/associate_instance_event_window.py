...
import capo_ec2.types.associate_instance_event_window_request
import capo_ec2.types.associate_instance_event_window_result
import capo_ec2.types.instance_event_window
import capo_ec2.types.instance_event_window_association_request
...
def handle_response(
    ...
    out: capo_ec2.types.associate_instance_event_window_result.AssociateInstanceEventWindowResult = capo_ec2.types.associate_instance_event_window_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AssociateInstanceEventWindow"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.associate_instance_event_window_request.serialize_ec2_query(
        input_, pairs, ""
    )
