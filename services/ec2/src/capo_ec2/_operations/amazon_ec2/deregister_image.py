...
import capo_ec2.types.deregister_image_request
import capo_ec2.types.deregister_image_result
...
def handle_response(
    ...
    out: capo_ec2.types.deregister_image_result.DeregisterImageResult = (
        capo_ec2.types.deregister_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeregisterImage"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.deregister_image_request.serialize_ec2_query(input_, pairs, "")
...
def deregister_image(
    ...
    capo_ec2.types.deregister_image_result.DeregisterImageResult, zapros.Response
]:
