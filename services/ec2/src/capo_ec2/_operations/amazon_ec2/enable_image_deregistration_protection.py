...
import capo_ec2.types.enable_image_deregistration_protection_request
import capo_ec2.types.enable_image_deregistration_protection_result
...
def handle_response(
    ...
    out: capo_ec2.types.enable_image_deregistration_protection_result.EnableImageDeregistrationProtectionResult = capo_ec2.types.enable_image_deregistration_protection_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "EnableImageDeregistrationProtection"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.enable_image_deregistration_protection_request.serialize_ec2_query(
        input_, pairs, ""
    )
