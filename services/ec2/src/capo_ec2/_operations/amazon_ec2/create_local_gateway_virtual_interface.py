...
import capo_ec2.types.create_local_gateway_virtual_interface_request
import capo_ec2.types.create_local_gateway_virtual_interface_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_local_gateway_virtual_interface_result.CreateLocalGatewayVirtualInterfaceResult = capo_ec2.types.create_local_gateway_virtual_interface_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_local_gateway_virtual_interface_request.serialize_ec2_query(
        input_, pairs, ""
    )
