"""Generated from Smithy shape ``com.amazonaws.ec2#GetActiveVpnTunnelStatus``."""
...
import capo_ec2.types.get_active_vpn_tunnel_status_request
import capo_ec2.types.get_active_vpn_tunnel_status_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_active_vpn_tunnel_status_result.GetActiveVpnTunnelStatusResult = capo_ec2.types.get_active_vpn_tunnel_status_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetActiveVpnTunnelStatus"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_active_vpn_tunnel_status_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_get_active_vpn_tunnel_status(
