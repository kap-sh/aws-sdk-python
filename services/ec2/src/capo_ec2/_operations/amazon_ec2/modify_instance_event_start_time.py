"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyInstanceEventStartTime``."""
...
import capo_ec2.types.modify_instance_event_start_time_request
import capo_ec2.types.modify_instance_event_start_time_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_instance_event_start_time_result.ModifyInstanceEventStartTimeResult = capo_ec2.types.modify_instance_event_start_time_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyInstanceEventStartTime"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_instance_event_start_time_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_instance_event_start_time(
