...
import capo_ec2.types.delete_instance_event_window_request
import capo_ec2.types.delete_instance_event_window_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_instance_event_window_result.DeleteInstanceEventWindowResult = capo_ec2.types.delete_instance_event_window_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteInstanceEventWindow"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_instance_event_window_request.serialize_ec2_query(
        input_, pairs, ""
    )
