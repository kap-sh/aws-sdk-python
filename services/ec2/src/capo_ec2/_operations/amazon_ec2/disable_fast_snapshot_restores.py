...
import capo_ec2.types.disable_fast_snapshot_restores_request
import capo_ec2.types.disable_fast_snapshot_restores_result
...
def handle_response(
    ...
    out: capo_ec2.types.disable_fast_snapshot_restores_result.DisableFastSnapshotRestoresResult = capo_ec2.types.disable_fast_snapshot_restores_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableFastSnapshotRestores"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disable_fast_snapshot_restores_request.serialize_ec2_query(
        input_, pairs, ""
    )
