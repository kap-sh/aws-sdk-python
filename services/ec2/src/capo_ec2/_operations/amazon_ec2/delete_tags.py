"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTags``."""
...
import capo_ec2.types.delete_tags_request
...
def build_request(
    ...
    capo_ec2.types.delete_tags_request.serialize_ec2_query(input_, pairs, "")
