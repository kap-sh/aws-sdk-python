...
import capo_ec2.types.describe_hosts_request
import capo_ec2.types.describe_hosts_result
...
) -> capo_ec2.types.describe_hosts_result.DescribeHostsResult:
    out: capo_ec2.types.describe_hosts_result.DescribeHostsResult = (
        capo_ec2.types.describe_hosts_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeHosts"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_hosts_request.serialize_ec2_query(input_, pairs, "")
...
def describe_hosts(
    ...
    input_: capo_ec2.types.describe_hosts_request.DescribeHostsRequest,
) -> tuple[capo_ec2.types.describe_hosts_result.DescribeHostsResult, zapros.Response]:
