...
import capo_ec2.types.describe_transit_gateway_vpc_attachments_request
import capo_ec2.types.describe_transit_gateway_vpc_attachments_result
...
) -> capo_ec2.types.describe_transit_gateway_vpc_attachments_result.DescribeTransitGatewayVpcAttachmentsResult:
    out: capo_ec2.types.describe_transit_gateway_vpc_attachments_result.DescribeTransitGatewayVpcAttachmentsResult = capo_ec2.types.describe_transit_gateway_vpc_attachments_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeTransitGatewayVpcAttachments"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_transit_gateway_vpc_attachments_request.serialize_ec2_query(
        input_, pairs, ""
    )
