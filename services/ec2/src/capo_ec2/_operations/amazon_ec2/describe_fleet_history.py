...
import capo_ec2.types.describe_fleet_history_request
import capo_ec2.types.describe_fleet_history_result
...
def handle_response(
    ...
    out: capo_ec2.types.describe_fleet_history_result.DescribeFleetHistoryResult = (
        capo_ec2.types.describe_fleet_history_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeFleetHistory"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_fleet_history_request.serialize_ec2_query(input_, pairs, "")
