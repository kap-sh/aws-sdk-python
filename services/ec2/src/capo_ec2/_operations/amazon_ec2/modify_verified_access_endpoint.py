...
import capo_ec2.types.modify_verified_access_endpoint_request
import capo_ec2.types.modify_verified_access_endpoint_result
...
) -> capo_ec2.types.modify_verified_access_endpoint_result.ModifyVerifiedAccessEndpointResult:
    out: capo_ec2.types.modify_verified_access_endpoint_result.ModifyVerifiedAccessEndpointResult = capo_ec2.types.modify_verified_access_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_verified_access_endpoint_request.serialize_ec2_query(
        input_, pairs, ""
    )
