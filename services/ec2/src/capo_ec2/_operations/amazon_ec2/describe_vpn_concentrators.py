...
import capo_ec2.types.describe_vpn_concentrators_request
import capo_ec2.types.describe_vpn_concentrators_result
...
) -> capo_ec2.types.describe_vpn_concentrators_result.DescribeVpnConcentratorsResult:
    out: capo_ec2.types.describe_vpn_concentrators_result.DescribeVpnConcentratorsResult = capo_ec2.types.describe_vpn_concentrators_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_vpn_concentrators_request.serialize_ec2_query(
        input_, pairs, ""
    )
