...
import capo_ec2.types.delete_network_insights_access_scope_request
import capo_ec2.types.delete_network_insights_access_scope_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_network_insights_access_scope_result.DeleteNetworkInsightsAccessScopeResult = capo_ec2.types.delete_network_insights_access_scope_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_network_insights_access_scope_request.serialize_ec2_query(
        input_, pairs, ""
    )
