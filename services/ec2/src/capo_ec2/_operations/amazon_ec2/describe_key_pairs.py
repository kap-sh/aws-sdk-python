...
import capo_ec2.types.describe_key_pairs_request
import capo_ec2.types.describe_key_pairs_result
...
) -> capo_ec2.types.describe_key_pairs_result.DescribeKeyPairsResult:
    out: capo_ec2.types.describe_key_pairs_result.DescribeKeyPairsResult = (
        capo_ec2.types.describe_key_pairs_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_key_pairs_request.serialize_ec2_query(input_, pairs, "")
...
def describe_key_pairs(
    ...
    capo_ec2.types.describe_key_pairs_result.DescribeKeyPairsResult, zapros.Response
]:
