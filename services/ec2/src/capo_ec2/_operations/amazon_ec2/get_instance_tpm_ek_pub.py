...
import capo_ec2.types.get_instance_tpm_ek_pub_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_instance_tpm_ek_pub_result.GetInstanceTpmEkPubResult = (
        capo_ec2.types.get_instance_tpm_ek_pub_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_instance_tpm_ek_pub_request.serialize_ec2_query(
        input_, pairs, ""
    )
