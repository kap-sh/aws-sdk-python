...
import capo_ec2.types.delete_nat_gateway_request
import capo_ec2.types.delete_nat_gateway_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_nat_gateway_result.DeleteNatGatewayResult = (
        capo_ec2.types.delete_nat_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteNatGateway"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_nat_gateway_request.serialize_ec2_query(input_, pairs, "")
...
def delete_nat_gateway(
    ...
    capo_ec2.types.delete_nat_gateway_result.DeleteNatGatewayResult, zapros.Response
]:
