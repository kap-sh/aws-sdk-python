...
import capo_ec2.types.describe_verified_access_endpoints_request
import capo_ec2.types.describe_verified_access_endpoints_result
...
) -> capo_ec2.types.describe_verified_access_endpoints_result.DescribeVerifiedAccessEndpointsResult:
    out: capo_ec2.types.describe_verified_access_endpoints_result.DescribeVerifiedAccessEndpointsResult = capo_ec2.types.describe_verified_access_endpoints_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVerifiedAccessEndpoints"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_verified_access_endpoints_request.serialize_ec2_query(
        input_, pairs, ""
    )
