...
import capo_ec2.types.restore_snapshot_tier_request
import capo_ec2.types.restore_snapshot_tier_result
...
) -> capo_ec2.types.restore_snapshot_tier_result.RestoreSnapshotTierResult:
    out: capo_ec2.types.restore_snapshot_tier_result.RestoreSnapshotTierResult = (
        capo_ec2.types.restore_snapshot_tier_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "RestoreSnapshotTier"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.restore_snapshot_tier_request.serialize_ec2_query(input_, pairs, "")
