...
import capo_ec2.types.accept_capacity_reservation_billing_ownership_request
import capo_ec2.types.accept_capacity_reservation_billing_ownership_result
...
def handle_response(
    ...
    out: capo_ec2.types.accept_capacity_reservation_billing_ownership_result.AcceptCapacityReservationBillingOwnershipResult = capo_ec2.types.accept_capacity_reservation_billing_ownership_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AcceptCapacityReservationBillingOwnership"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.accept_capacity_reservation_billing_ownership_request.serialize_ec2_query(
        input_, pairs, ""
    )
