...
def handle_response(
    ...
    out: capo_ec2.types.enable_allowed_images_settings_result.EnableAllowedImagesSettingsResult = capo_ec2.types.enable_allowed_images_settings_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "EnableAllowedImagesSettings"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.enable_allowed_images_settings_request.serialize_ec2_query(
        input_, pairs, ""
    )
