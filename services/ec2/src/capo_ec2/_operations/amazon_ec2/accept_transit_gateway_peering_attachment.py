"""Generated from Smithy shape ``com.amazonaws.ec2#AcceptTransitGatewayPeeringAttachment``."""
...
import capo_ec2.types.accept_transit_gateway_peering_attachment_request
import capo_ec2.types.accept_transit_gateway_peering_attachment_result
...
def handle_response(
    ...
    out: capo_ec2.types.accept_transit_gateway_peering_attachment_result.AcceptTransitGatewayPeeringAttachmentResult = capo_ec2.types.accept_transit_gateway_peering_attachment_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AcceptTransitGatewayPeeringAttachment"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.accept_transit_gateway_peering_attachment_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_accept_transit_gateway_peering_attachment(
