...
import capo_ec2.types.associate_transit_gateway_multicast_domain_request
import capo_ec2.types.associate_transit_gateway_multicast_domain_result
...
def handle_response(
    ...
    out: capo_ec2.types.associate_transit_gateway_multicast_domain_result.AssociateTransitGatewayMulticastDomainResult = capo_ec2.types.associate_transit_gateway_multicast_domain_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AssociateTransitGatewayMulticastDomain"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.associate_transit_gateway_multicast_domain_request.serialize_ec2_query(
        input_, pairs, ""
    )
