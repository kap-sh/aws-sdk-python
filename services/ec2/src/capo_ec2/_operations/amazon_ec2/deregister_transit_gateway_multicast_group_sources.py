...
import capo_ec2.types.deregister_transit_gateway_multicast_group_sources_request
...
) -> capo_ec2.types.deregister_transit_gateway_multicast_group_sources_result.DeregisterTransitGatewayMulticastGroupSourcesResult:
    out: capo_ec2.types.deregister_transit_gateway_multicast_group_sources_result.DeregisterTransitGatewayMulticastGroupSourcesResult = capo_ec2.types.deregister_transit_gateway_multicast_group_sources_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeregisterTransitGatewayMulticastGroupSources"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.deregister_transit_gateway_multicast_group_sources_request.serialize_ec2_query(
        input_, pairs, ""
    )
