...
import capo_ec2.types.disable_image_request
import capo_ec2.types.disable_image_result
...
def handle_response(
    ...
    out: capo_ec2.types.disable_image_result.DisableImageResult = (
        capo_ec2.types.disable_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableImage"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disable_image_request.serialize_ec2_query(input_, pairs, "")
...
def disable_image(
    ...
    input_: capo_ec2.types.disable_image_request.DisableImageRequest,
) -> tuple[capo_ec2.types.disable_image_result.DisableImageResult, zapros.Response]:
