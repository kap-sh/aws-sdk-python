"""Generated from Smithy shape ``com.amazonaws.ec2#EnableApplicationStatusCheckSuppression``."""
...
def handle_response(
    ...
    out: capo_ec2.types.enable_application_status_check_suppression_result.EnableApplicationStatusCheckSuppressionResult = capo_ec2.types.enable_application_status_check_suppression_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "EnableApplicationStatusCheckSuppression"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.enable_application_status_check_suppression_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_enable_application_status_check_suppression(
