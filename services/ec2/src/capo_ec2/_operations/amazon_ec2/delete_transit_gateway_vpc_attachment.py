...
import capo_ec2.types.delete_transit_gateway_vpc_attachment_request
import capo_ec2.types.delete_transit_gateway_vpc_attachment_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_transit_gateway_vpc_attachment_result.DeleteTransitGatewayVpcAttachmentResult = capo_ec2.types.delete_transit_gateway_vpc_attachment_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_transit_gateway_vpc_attachment_request.serialize_ec2_query(
        input_, pairs, ""
    )
