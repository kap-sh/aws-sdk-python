...
import capo_ec2.types.search_transit_gateway_multicast_groups_request
import capo_ec2.types.search_transit_gateway_multicast_groups_result
...
) -> capo_ec2.types.search_transit_gateway_multicast_groups_result.SearchTransitGatewayMulticastGroupsResult:
    out: capo_ec2.types.search_transit_gateway_multicast_groups_result.SearchTransitGatewayMulticastGroupsResult = capo_ec2.types.search_transit_gateway_multicast_groups_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "SearchTransitGatewayMulticastGroups"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.search_transit_gateway_multicast_groups_request.serialize_ec2_query(
        input_, pairs, ""
    )
