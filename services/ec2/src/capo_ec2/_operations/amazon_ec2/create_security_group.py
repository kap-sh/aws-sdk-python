...
import capo_ec2.types.create_security_group_request
import capo_ec2.types.create_security_group_result
...
) -> capo_ec2.types.create_security_group_result.CreateSecurityGroupResult:
    out: capo_ec2.types.create_security_group_result.CreateSecurityGroupResult = (
        capo_ec2.types.create_security_group_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_security_group_request.serialize_ec2_query(input_, pairs, "")
