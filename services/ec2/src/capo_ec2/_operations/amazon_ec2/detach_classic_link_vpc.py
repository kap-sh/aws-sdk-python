...
def handle_response(
    ...
    out: capo_ec2.types.detach_classic_link_vpc_result.DetachClassicLinkVpcResult = (
        capo_ec2.types.detach_classic_link_vpc_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.detach_classic_link_vpc_request.serialize_ec2_query(
        input_, pairs, ""
    )
