...
import capo_ec2.types.describe_traffic_mirror_filter_rules_request
import capo_ec2.types.describe_traffic_mirror_filter_rules_result
import capo_ec2.types.filter_list
import capo_ec2.types.traffic_mirror_filter_rule_id_list
import capo_ec2.types.traffic_mirror_filter_rule_set
...
) -> capo_ec2.types.describe_traffic_mirror_filter_rules_result.DescribeTrafficMirrorFilterRulesResult:
    out: capo_ec2.types.describe_traffic_mirror_filter_rules_result.DescribeTrafficMirrorFilterRulesResult = capo_ec2.types.describe_traffic_mirror_filter_rules_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeTrafficMirrorFilterRules"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_traffic_mirror_filter_rules_request.serialize_ec2_query(
        input_, pairs, ""
    )
