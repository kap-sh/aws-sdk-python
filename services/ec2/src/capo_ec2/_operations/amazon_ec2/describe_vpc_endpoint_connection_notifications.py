...
import capo_ec2.types.describe_vpc_endpoint_connection_notifications_request
import capo_ec2.types.describe_vpc_endpoint_connection_notifications_result
...
) -> capo_ec2.types.describe_vpc_endpoint_connection_notifications_result.DescribeVpcEndpointConnectionNotificationsResult:
    out: capo_ec2.types.describe_vpc_endpoint_connection_notifications_result.DescribeVpcEndpointConnectionNotificationsResult = capo_ec2.types.describe_vpc_endpoint_connection_notifications_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVpcEndpointConnectionNotifications"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_vpc_endpoint_connection_notifications_request.serialize_ec2_query(
        input_, pairs, ""
    )
