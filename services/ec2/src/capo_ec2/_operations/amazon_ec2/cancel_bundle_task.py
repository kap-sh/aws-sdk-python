...
import capo_ec2.types.cancel_bundle_task_request
import capo_ec2.types.cancel_bundle_task_result
...
def handle_response(
    ...
    out: capo_ec2.types.cancel_bundle_task_result.CancelBundleTaskResult = (
        capo_ec2.types.cancel_bundle_task_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.cancel_bundle_task_request.serialize_ec2_query(input_, pairs, "")
...
def cancel_bundle_task(
    ...
    capo_ec2.types.cancel_bundle_task_result.CancelBundleTaskResult, zapros.Response
]:
