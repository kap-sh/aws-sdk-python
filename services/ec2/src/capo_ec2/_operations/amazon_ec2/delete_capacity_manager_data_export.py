...
def handle_response(
    ...
    out: capo_ec2.types.delete_capacity_manager_data_export_result.DeleteCapacityManagerDataExportResult = capo_ec2.types.delete_capacity_manager_data_export_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_capacity_manager_data_export_request.serialize_ec2_query(
        input_, pairs, ""
    )
