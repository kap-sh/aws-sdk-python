...
import capo_ec2.types.modify_transit_gateway_vpc_attachment_request
import capo_ec2.types.modify_transit_gateway_vpc_attachment_request_options
import capo_ec2.types.modify_transit_gateway_vpc_attachment_result
...
) -> capo_ec2.types.modify_transit_gateway_vpc_attachment_result.ModifyTransitGatewayVpcAttachmentResult:
    out: capo_ec2.types.modify_transit_gateway_vpc_attachment_result.ModifyTransitGatewayVpcAttachmentResult = capo_ec2.types.modify_transit_gateway_vpc_attachment_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyTransitGatewayVpcAttachment"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_transit_gateway_vpc_attachment_request.serialize_ec2_query(
        input_, pairs, ""
    )
