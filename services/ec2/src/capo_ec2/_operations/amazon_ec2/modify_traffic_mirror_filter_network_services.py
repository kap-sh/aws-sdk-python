...
import capo_ec2.types.modify_traffic_mirror_filter_network_services_request
import capo_ec2.types.modify_traffic_mirror_filter_network_services_result
...
) -> capo_ec2.types.modify_traffic_mirror_filter_network_services_result.ModifyTrafficMirrorFilterNetworkServicesResult:
    out: capo_ec2.types.modify_traffic_mirror_filter_network_services_result.ModifyTrafficMirrorFilterNetworkServicesResult = capo_ec2.types.modify_traffic_mirror_filter_network_services_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyTrafficMirrorFilterNetworkServices"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_traffic_mirror_filter_network_services_request.serialize_ec2_query(
        input_, pairs, ""
    )
