...
import capo_ec2.types.reset_fpga_image_attribute_request
import capo_ec2.types.reset_fpga_image_attribute_result
...
) -> capo_ec2.types.reset_fpga_image_attribute_result.ResetFpgaImageAttributeResult:
    out: capo_ec2.types.reset_fpga_image_attribute_result.ResetFpgaImageAttributeResult = capo_ec2.types.reset_fpga_image_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ResetFpgaImageAttribute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.reset_fpga_image_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
