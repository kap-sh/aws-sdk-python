"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeIdentityIdFormat``."""
...
import capo_ec2.types.describe_identity_id_format_request
import capo_ec2.types.describe_identity_id_format_result
...
def handle_response(
    ...
    out: capo_ec2.types.describe_identity_id_format_result.DescribeIdentityIdFormatResult = capo_ec2.types.describe_identity_id_format_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeIdentityIdFormat"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_identity_id_format_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_identity_id_format(
