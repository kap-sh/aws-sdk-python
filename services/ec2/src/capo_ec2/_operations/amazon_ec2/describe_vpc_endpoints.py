"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeVpcEndpoints``."""
...
import capo_ec2.types.describe_vpc_endpoints_request
import capo_ec2.types.describe_vpc_endpoints_result
...
) -> capo_ec2.types.describe_vpc_endpoints_result.DescribeVpcEndpointsResult:
    out: capo_ec2.types.describe_vpc_endpoints_result.DescribeVpcEndpointsResult = (
        capo_ec2.types.describe_vpc_endpoints_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVpcEndpoints"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_vpc_endpoints_request.serialize_ec2_query(input_, pairs, "")
