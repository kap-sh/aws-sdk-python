...
import capo_ec2.types.describe_network_insights_analyses_request
import capo_ec2.types.describe_network_insights_analyses_result
...
) -> capo_ec2.types.describe_network_insights_analyses_result.DescribeNetworkInsightsAnalysesResult:
    out: capo_ec2.types.describe_network_insights_analyses_result.DescribeNetworkInsightsAnalysesResult = capo_ec2.types.describe_network_insights_analyses_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeNetworkInsightsAnalyses"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_network_insights_analyses_request.serialize_ec2_query(
        input_, pairs, ""
    )
