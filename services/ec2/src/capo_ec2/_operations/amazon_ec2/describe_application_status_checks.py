"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeApplicationStatusChecks``."""
...
def handle_response(
    ...
    out: capo_ec2.types.describe_application_status_checks_result.DescribeApplicationStatusChecksResult = capo_ec2.types.describe_application_status_checks_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeApplicationStatusChecks"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_application_status_checks_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_application_status_checks(
