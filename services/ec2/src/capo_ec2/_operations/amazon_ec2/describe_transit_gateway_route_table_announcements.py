...
import capo_ec2.types.describe_transit_gateway_route_table_announcements_request
import capo_ec2.types.describe_transit_gateway_route_table_announcements_result
import capo_ec2.types.filter_list
import capo_ec2.types.transit_gateway_route_table_announcement_id_string_list
...
) -> capo_ec2.types.describe_transit_gateway_route_table_announcements_result.DescribeTransitGatewayRouteTableAnnouncementsResult:
    out: capo_ec2.types.describe_transit_gateway_route_table_announcements_result.DescribeTransitGatewayRouteTableAnnouncementsResult = capo_ec2.types.describe_transit_gateway_route_table_announcements_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_transit_gateway_route_table_announcements_request.serialize_ec2_query(
        input_, pairs, ""
    )
