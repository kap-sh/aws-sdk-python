...
import capo_ec2.types.create_network_insights_path_request
import capo_ec2.types.create_network_insights_path_result
...
) -> capo_ec2.types.create_network_insights_path_result.CreateNetworkInsightsPathResult:
    out: capo_ec2.types.create_network_insights_path_result.CreateNetworkInsightsPathResult = capo_ec2.types.create_network_insights_path_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateNetworkInsightsPath"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_network_insights_path_request.serialize_ec2_query(
        input_, pairs, ""
    )
