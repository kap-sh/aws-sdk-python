...
import capo_ec2.types.delete_vpc_endpoint_service_configurations_request
import capo_ec2.types.delete_vpc_endpoint_service_configurations_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_vpc_endpoint_service_configurations_result.DeleteVpcEndpointServiceConfigurationsResult = capo_ec2.types.delete_vpc_endpoint_service_configurations_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_vpc_endpoint_service_configurations_request.serialize_ec2_query(
        input_, pairs, ""
    )
