...
import capo_ec2.types.create_transit_gateway_metering_policy_entry_request
import capo_ec2.types.create_transit_gateway_metering_policy_entry_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_transit_gateway_metering_policy_entry_result.CreateTransitGatewayMeteringPolicyEntryResult = capo_ec2.types.create_transit_gateway_metering_policy_entry_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_transit_gateway_metering_policy_entry_request.serialize_ec2_query(
        input_, pairs, ""
    )
