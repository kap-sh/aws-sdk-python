...
import capo_ec2.types.describe_export_image_tasks_request
import capo_ec2.types.describe_export_image_tasks_result
import capo_ec2.types.export_image_task_id_list
import capo_ec2.types.export_image_task_list
...
) -> capo_ec2.types.describe_export_image_tasks_result.DescribeExportImageTasksResult:
    out: capo_ec2.types.describe_export_image_tasks_result.DescribeExportImageTasksResult = capo_ec2.types.describe_export_image_tasks_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeExportImageTasks"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_export_image_tasks_request.serialize_ec2_query(
        input_, pairs, ""
    )
