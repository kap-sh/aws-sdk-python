...
import capo_ec2.types.describe_replace_root_volume_tasks_request
import capo_ec2.types.describe_replace_root_volume_tasks_result
...
) -> capo_ec2.types.describe_replace_root_volume_tasks_result.DescribeReplaceRootVolumeTasksResult:
    out: capo_ec2.types.describe_replace_root_volume_tasks_result.DescribeReplaceRootVolumeTasksResult = capo_ec2.types.describe_replace_root_volume_tasks_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeReplaceRootVolumeTasks"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_replace_root_volume_tasks_request.serialize_ec2_query(
        input_, pairs, ""
    )
