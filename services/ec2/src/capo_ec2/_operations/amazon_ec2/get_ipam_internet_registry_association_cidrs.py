"""Generated from Smithy shape ``com.amazonaws.ec2#GetIpamInternetRegistryAssociationCidrs``."""
...
def handle_response(
    ...
    out: capo_ec2.types.get_ipam_internet_registry_association_cidrs_result.GetIpamInternetRegistryAssociationCidrsResult = capo_ec2.types.get_ipam_internet_registry_association_cidrs_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetIpamInternetRegistryAssociationCidrs"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_ipam_internet_registry_association_cidrs_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_get_ipam_internet_registry_association_cidrs(
