"""Generated from Smithy shape ``com.amazonaws.ec2#GetIpamRoutingPolicyRegistrationDeltas``."""
...
def handle_response(
    ...
    out: capo_ec2.types.get_ipam_routing_policy_registration_deltas_result.GetIpamRoutingPolicyRegistrationDeltasResult = capo_ec2.types.get_ipam_routing_policy_registration_deltas_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetIpamRoutingPolicyRegistrationDeltas"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_ipam_routing_policy_registration_deltas_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_get_ipam_routing_policy_registration_deltas(
