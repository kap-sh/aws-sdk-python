...
import capo_ec2.types.describe_principal_id_format_request
import capo_ec2.types.describe_principal_id_format_result
...
) -> capo_ec2.types.describe_principal_id_format_result.DescribePrincipalIdFormatResult:
    out: capo_ec2.types.describe_principal_id_format_result.DescribePrincipalIdFormatResult = capo_ec2.types.describe_principal_id_format_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_principal_id_format_request.serialize_ec2_query(
        input_, pairs, ""
    )
