...
def handle_response(
    ...
    out: capo_ec2.types.delete_ipam_resource_discovery_result.DeleteIpamResourceDiscoveryResult = capo_ec2.types.delete_ipam_resource_discovery_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_ipam_resource_discovery_request.serialize_ec2_query(
        input_, pairs, ""
    )
