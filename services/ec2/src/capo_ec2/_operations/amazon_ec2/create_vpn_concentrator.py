...
import capo_ec2.types.create_vpn_concentrator_request
import capo_ec2.types.create_vpn_concentrator_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_vpn_concentrator_result.CreateVpnConcentratorResult = (
        capo_ec2.types.create_vpn_concentrator_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateVpnConcentrator"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_vpn_concentrator_request.serialize_ec2_query(
        input_, pairs, ""
    )
