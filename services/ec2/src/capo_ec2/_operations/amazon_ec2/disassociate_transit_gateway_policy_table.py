...
import capo_ec2.types.disassociate_transit_gateway_policy_table_request
import capo_ec2.types.disassociate_transit_gateway_policy_table_result
...
def handle_response(
    ...
    out: capo_ec2.types.disassociate_transit_gateway_policy_table_result.DisassociateTransitGatewayPolicyTableResult = capo_ec2.types.disassociate_transit_gateway_policy_table_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisassociateTransitGatewayPolicyTable"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disassociate_transit_gateway_policy_table_request.serialize_ec2_query(
        input_, pairs, ""
    )
