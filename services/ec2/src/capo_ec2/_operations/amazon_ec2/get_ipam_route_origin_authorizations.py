"""Generated from Smithy shape ``com.amazonaws.ec2#GetIpamRouteOriginAuthorizations``."""
...
def handle_response(
    ...
    out: capo_ec2.types.get_ipam_route_origin_authorizations_result.GetIpamRouteOriginAuthorizationsResult = capo_ec2.types.get_ipam_route_origin_authorizations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetIpamRouteOriginAuthorizations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_ipam_route_origin_authorizations_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_get_ipam_route_origin_authorizations(
