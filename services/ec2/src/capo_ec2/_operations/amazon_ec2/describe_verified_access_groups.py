...
import capo_ec2.types.describe_verified_access_groups_request
import capo_ec2.types.describe_verified_access_groups_result
...
) -> capo_ec2.types.describe_verified_access_groups_result.DescribeVerifiedAccessGroupsResult:
    out: capo_ec2.types.describe_verified_access_groups_result.DescribeVerifiedAccessGroupsResult = capo_ec2.types.describe_verified_access_groups_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVerifiedAccessGroups"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_verified_access_groups_request.serialize_ec2_query(
        input_, pairs, ""
    )
