...
import capo_ec2.types.get_transit_gateway_attachment_propagations_request
import capo_ec2.types.get_transit_gateway_attachment_propagations_result
...
) -> capo_ec2.types.get_transit_gateway_attachment_propagations_result.GetTransitGatewayAttachmentPropagationsResult:
    out: capo_ec2.types.get_transit_gateway_attachment_propagations_result.GetTransitGatewayAttachmentPropagationsResult = capo_ec2.types.get_transit_gateway_attachment_propagations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetTransitGatewayAttachmentPropagations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_transit_gateway_attachment_propagations_request.serialize_ec2_query(
        input_, pairs, ""
    )
