...
) -> capo_ec2.types.describe_capacity_reservation_billing_requests_result.DescribeCapacityReservationBillingRequestsResult:
    out: capo_ec2.types.describe_capacity_reservation_billing_requests_result.DescribeCapacityReservationBillingRequestsResult = capo_ec2.types.describe_capacity_reservation_billing_requests_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_capacity_reservation_billing_requests_request.serialize_ec2_query(
        input_, pairs, ""
    )
