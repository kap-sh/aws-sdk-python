"""Generated from Smithy shape ``com.amazonaws.ec2#GetHostReservationPurchasePreview``."""
...
import capo_ec2.types.get_host_reservation_purchase_preview_request
import capo_ec2.types.get_host_reservation_purchase_preview_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_host_reservation_purchase_preview_result.GetHostReservationPurchasePreviewResult = capo_ec2.types.get_host_reservation_purchase_preview_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetHostReservationPurchasePreview"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_host_reservation_purchase_preview_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_get_host_reservation_purchase_preview(
