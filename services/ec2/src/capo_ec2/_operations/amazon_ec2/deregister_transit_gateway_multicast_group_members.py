...
import capo_ec2.types.deregister_transit_gateway_multicast_group_members_request
import capo_ec2.types.deregister_transit_gateway_multicast_group_members_result
...
) -> capo_ec2.types.deregister_transit_gateway_multicast_group_members_result.DeregisterTransitGatewayMulticastGroupMembersResult:
    out: capo_ec2.types.deregister_transit_gateway_multicast_group_members_result.DeregisterTransitGatewayMulticastGroupMembersResult = capo_ec2.types.deregister_transit_gateway_multicast_group_members_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeregisterTransitGatewayMulticastGroupMembers"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.deregister_transit_gateway_multicast_group_members_request.serialize_ec2_query(
        input_, pairs, ""
    )
