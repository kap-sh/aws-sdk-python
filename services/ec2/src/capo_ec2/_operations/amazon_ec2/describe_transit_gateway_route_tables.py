...
import capo_ec2.types.describe_transit_gateway_route_tables_request
import capo_ec2.types.describe_transit_gateway_route_tables_result
...
) -> capo_ec2.types.describe_transit_gateway_route_tables_result.DescribeTransitGatewayRouteTablesResult:
    out: capo_ec2.types.describe_transit_gateway_route_tables_result.DescribeTransitGatewayRouteTablesResult = capo_ec2.types.describe_transit_gateway_route_tables_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeTransitGatewayRouteTables"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_transit_gateway_route_tables_request.serialize_ec2_query(
        input_, pairs, ""
    )
