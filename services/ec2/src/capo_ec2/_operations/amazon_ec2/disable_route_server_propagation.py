"""Generated from Smithy shape ``com.amazonaws.ec2#DisableRouteServerPropagation``."""
...
import capo_ec2.types.disable_route_server_propagation_request
import capo_ec2.types.disable_route_server_propagation_result
...
def handle_response(
    ...
    out: capo_ec2.types.disable_route_server_propagation_result.DisableRouteServerPropagationResult = capo_ec2.types.disable_route_server_propagation_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableRouteServerPropagation"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disable_route_server_propagation_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_disable_route_server_propagation(
