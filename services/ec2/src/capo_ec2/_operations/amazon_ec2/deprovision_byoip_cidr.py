...
import capo_ec2.types.deprovision_byoip_cidr_request
import capo_ec2.types.deprovision_byoip_cidr_result
...
def handle_response(
    ...
    out: capo_ec2.types.deprovision_byoip_cidr_result.DeprovisionByoipCidrResult = (
        capo_ec2.types.deprovision_byoip_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.deprovision_byoip_cidr_request.serialize_ec2_query(input_, pairs, "")
