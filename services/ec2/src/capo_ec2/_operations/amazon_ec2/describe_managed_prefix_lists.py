...
import capo_ec2.types.describe_managed_prefix_lists_request
import capo_ec2.types.describe_managed_prefix_lists_result
...
def handle_response(
    ...
    capo_ec2.types.describe_managed_prefix_lists_result.DescribeManagedPrefixListsResult
):
    out: capo_ec2.types.describe_managed_prefix_lists_result.DescribeManagedPrefixListsResult = capo_ec2.types.describe_managed_prefix_lists_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_managed_prefix_lists_request.serialize_ec2_query(
        input_, pairs, ""
    )
