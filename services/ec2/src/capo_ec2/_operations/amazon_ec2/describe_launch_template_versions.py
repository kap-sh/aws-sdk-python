...
import capo_ec2.types.describe_launch_template_versions_request
import capo_ec2.types.describe_launch_template_versions_result
...
) -> capo_ec2.types.describe_launch_template_versions_result.DescribeLaunchTemplateVersionsResult:
    out: capo_ec2.types.describe_launch_template_versions_result.DescribeLaunchTemplateVersionsResult = capo_ec2.types.describe_launch_template_versions_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeLaunchTemplateVersions"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_launch_template_versions_request.serialize_ec2_query(
        input_, pairs, ""
    )
