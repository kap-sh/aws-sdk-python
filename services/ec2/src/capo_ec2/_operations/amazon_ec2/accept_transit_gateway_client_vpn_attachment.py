"""Generated from Smithy shape ``com.amazonaws.ec2#AcceptTransitGatewayClientVpnAttachment``."""
...
import capo_ec2.types.accept_transit_gateway_client_vpn_attachment_request
import capo_ec2.types.accept_transit_gateway_client_vpn_attachment_result
...
def handle_response(
    ...
    out: capo_ec2.types.accept_transit_gateway_client_vpn_attachment_result.AcceptTransitGatewayClientVpnAttachmentResult = capo_ec2.types.accept_transit_gateway_client_vpn_attachment_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AcceptTransitGatewayClientVpnAttachment"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.accept_transit_gateway_client_vpn_attachment_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_accept_transit_gateway_client_vpn_attachment(
