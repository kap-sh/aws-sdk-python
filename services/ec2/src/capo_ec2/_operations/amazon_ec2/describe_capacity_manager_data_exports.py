...
import capo_ec2.types.describe_capacity_manager_data_exports_request
import capo_ec2.types.describe_capacity_manager_data_exports_result
...
) -> capo_ec2.types.describe_capacity_manager_data_exports_result.DescribeCapacityManagerDataExportsResult:
    out: capo_ec2.types.describe_capacity_manager_data_exports_result.DescribeCapacityManagerDataExportsResult = capo_ec2.types.describe_capacity_manager_data_exports_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeCapacityManagerDataExports"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_capacity_manager_data_exports_request.serialize_ec2_query(
        input_, pairs, ""
    )
