...
import capo_ec2.types.export_client_vpn_client_configuration_request
import capo_ec2.types.export_client_vpn_client_configuration_result
...
def handle_response(
    ...
    out: capo_ec2.types.export_client_vpn_client_configuration_result.ExportClientVpnClientConfigurationResult = capo_ec2.types.export_client_vpn_client_configuration_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.export_client_vpn_client_configuration_request.serialize_ec2_query(
        input_, pairs, ""
    )
