"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyTransitGatewayPolicyTableEntry``."""
...
def handle_response(
    ...
    out: capo_ec2.types.modify_transit_gateway_policy_table_entry_result.ModifyTransitGatewayPolicyTableEntryResult = capo_ec2.types.modify_transit_gateway_policy_table_entry_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyTransitGatewayPolicyTableEntry"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_transit_gateway_policy_table_entry_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_transit_gateway_policy_table_entry(
