...
import capo_ec2.types.modify_verified_access_group_policy_request
import capo_ec2.types.modify_verified_access_group_policy_result
...
) -> capo_ec2.types.modify_verified_access_group_policy_result.ModifyVerifiedAccessGroupPolicyResult:
    out: capo_ec2.types.modify_verified_access_group_policy_result.ModifyVerifiedAccessGroupPolicyResult = capo_ec2.types.modify_verified_access_group_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_verified_access_group_policy_request.serialize_ec2_query(
        input_, pairs, ""
    )
