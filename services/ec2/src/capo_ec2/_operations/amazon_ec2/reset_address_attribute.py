...
import capo_ec2.types.reset_address_attribute_request
import capo_ec2.types.reset_address_attribute_result
...
def handle_response(
    ...
    out: capo_ec2.types.reset_address_attribute_result.ResetAddressAttributeResult = (
        capo_ec2.types.reset_address_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ResetAddressAttribute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.reset_address_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
