"""Generated from Smithy shape ``com.amazonaws.ec2#CreateCarrierGateway``."""
...
import capo_ec2.types.create_carrier_gateway_request
import capo_ec2.types.create_carrier_gateway_result
...
) -> capo_ec2.types.create_carrier_gateway_result.CreateCarrierGatewayResult:
    out: capo_ec2.types.create_carrier_gateway_result.CreateCarrierGatewayResult = (
        capo_ec2.types.create_carrier_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateCarrierGateway"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_carrier_gateway_request.serialize_ec2_query(input_, pairs, "")
...
async def async_create_carrier_gateway(
