"""Generated from Smithy shape ``com.amazonaws.ec2#ModifySubnetAttribute``."""
...
import capo_ec2.types.modify_subnet_attribute_request
...
def build_request(
    ...
    pairs.append(("Action", "ModifySubnetAttribute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_subnet_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_subnet_attribute(
