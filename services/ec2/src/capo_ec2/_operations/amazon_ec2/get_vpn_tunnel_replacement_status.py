...
import capo_ec2.types.get_vpn_tunnel_replacement_status_request
import capo_ec2.types.get_vpn_tunnel_replacement_status_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_vpn_tunnel_replacement_status_result.GetVpnTunnelReplacementStatusResult = capo_ec2.types.get_vpn_tunnel_replacement_status_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetVpnTunnelReplacementStatus"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_vpn_tunnel_replacement_status_request.serialize_ec2_query(
        input_, pairs, ""
    )
