...
import capo_ec2.types.modify_verified_access_endpoint_policy_request
import capo_ec2.types.modify_verified_access_endpoint_policy_result
...
) -> capo_ec2.types.modify_verified_access_endpoint_policy_result.ModifyVerifiedAccessEndpointPolicyResult:
    out: capo_ec2.types.modify_verified_access_endpoint_policy_result.ModifyVerifiedAccessEndpointPolicyResult = capo_ec2.types.modify_verified_access_endpoint_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyVerifiedAccessEndpointPolicy"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_verified_access_endpoint_policy_request.serialize_ec2_query(
        input_, pairs, ""
    )
