...
import capo_ec2.types.describe_local_gateway_route_tables_request
import capo_ec2.types.describe_local_gateway_route_tables_result
import capo_ec2.types.filter_list
import capo_ec2.types.local_gateway_route_table_id_set
import capo_ec2.types.local_gateway_route_table_set
...
) -> capo_ec2.types.describe_local_gateway_route_tables_result.DescribeLocalGatewayRouteTablesResult:
    out: capo_ec2.types.describe_local_gateway_route_tables_result.DescribeLocalGatewayRouteTablesResult = capo_ec2.types.describe_local_gateway_route_tables_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeLocalGatewayRouteTables"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_local_gateway_route_tables_request.serialize_ec2_query(
        input_, pairs, ""
    )
