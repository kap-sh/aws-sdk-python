...
import capo_ec2.types.create_mac_system_integrity_protection_modification_task_request
import capo_ec2.types.create_mac_system_integrity_protection_modification_task_result
...
) -> capo_ec2.types.create_mac_system_integrity_protection_modification_task_result.CreateMacSystemIntegrityProtectionModificationTaskResult:
    out: capo_ec2.types.create_mac_system_integrity_protection_modification_task_result.CreateMacSystemIntegrityProtectionModificationTaskResult = capo_ec2.types.create_mac_system_integrity_protection_modification_task_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_mac_system_integrity_protection_modification_task_request.serialize_ec2_query(
        input_, pairs, ""
    )
