...
import capo_ec2.types.modify_instance_metadata_options_request
import capo_ec2.types.modify_instance_metadata_options_result
...
) -> capo_ec2.types.modify_instance_metadata_options_result.ModifyInstanceMetadataOptionsResult:
    out: capo_ec2.types.modify_instance_metadata_options_result.ModifyInstanceMetadataOptionsResult = capo_ec2.types.modify_instance_metadata_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyInstanceMetadataOptions"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_instance_metadata_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
