...
import capo_ec2.types.create_internet_gateway_request
import capo_ec2.types.create_internet_gateway_result
...
) -> capo_ec2.types.create_internet_gateway_result.CreateInternetGatewayResult:
    out: capo_ec2.types.create_internet_gateway_result.CreateInternetGatewayResult = (
        capo_ec2.types.create_internet_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateInternetGateway"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_internet_gateway_request.serialize_ec2_query(
        input_, pairs, ""
    )
