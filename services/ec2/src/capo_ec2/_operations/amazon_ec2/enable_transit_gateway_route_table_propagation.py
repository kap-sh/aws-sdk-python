...
import capo_ec2.types.enable_transit_gateway_route_table_propagation_request
import capo_ec2.types.enable_transit_gateway_route_table_propagation_result
...
) -> capo_ec2.types.enable_transit_gateway_route_table_propagation_result.EnableTransitGatewayRouteTablePropagationResult:
    out: capo_ec2.types.enable_transit_gateway_route_table_propagation_result.EnableTransitGatewayRouteTablePropagationResult = capo_ec2.types.enable_transit_gateway_route_table_propagation_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.enable_transit_gateway_route_table_propagation_request.serialize_ec2_query(
        input_, pairs, ""
    )
