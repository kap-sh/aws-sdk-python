...
import capo_ec2.types.reset_ebs_default_kms_key_id_request
import capo_ec2.types.reset_ebs_default_kms_key_id_result
...
) -> capo_ec2.types.reset_ebs_default_kms_key_id_result.ResetEbsDefaultKmsKeyIdResult:
    out: capo_ec2.types.reset_ebs_default_kms_key_id_result.ResetEbsDefaultKmsKeyIdResult = capo_ec2.types.reset_ebs_default_kms_key_id_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ResetEbsDefaultKmsKeyId"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.reset_ebs_default_kms_key_id_request.serialize_ec2_query(
        input_, pairs, ""
    )
