"""Generated from Smithy shape ``com.amazonaws.ec2#GetRouteServerAssociations``."""
...
import capo_ec2.types.get_route_server_associations_request
import capo_ec2.types.get_route_server_associations_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_route_server_associations_result.GetRouteServerAssociationsResult = capo_ec2.types.get_route_server_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetRouteServerAssociations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_route_server_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_get_route_server_associations(
