...
import capo_ec2.types.create_launch_template_request
import capo_ec2.types.create_launch_template_result
...
) -> capo_ec2.types.create_launch_template_result.CreateLaunchTemplateResult:
    out: capo_ec2.types.create_launch_template_result.CreateLaunchTemplateResult = (
        capo_ec2.types.create_launch_template_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_launch_template_request.serialize_ec2_query(input_, pairs, "")
