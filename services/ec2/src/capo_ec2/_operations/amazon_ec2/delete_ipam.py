...
import capo_ec2.types.delete_ipam_request
...
def handle_response(
    ...
    out: capo_ec2.types.delete_ipam_result.DeleteIpamResult = (
        capo_ec2.types.delete_ipam_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_ipam_request.serialize_ec2_query(input_, pairs, "")
...
def delete_ipam(
    ...
    input_: capo_ec2.types.delete_ipam_request.DeleteIpamRequest,
) -> tuple[capo_ec2.types.delete_ipam_result.DeleteIpamResult, zapros.Response]:
