"""Generated from Smithy shape ``com.amazonaws.ec2#CreateTransitGateway``."""
...
import capo_ec2.types.create_transit_gateway_request
import capo_ec2.types.create_transit_gateway_result
...
) -> capo_ec2.types.create_transit_gateway_result.CreateTransitGatewayResult:
    out: capo_ec2.types.create_transit_gateway_result.CreateTransitGatewayResult = (
        capo_ec2.types.create_transit_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateTransitGateway"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_transit_gateway_request.serialize_ec2_query(input_, pairs, "")
...
async def async_create_transit_gateway(
