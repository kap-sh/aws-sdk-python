...
import capo_ec2.types.describe_capacity_block_status_request
import capo_ec2.types.describe_capacity_block_status_result
...
) -> capo_ec2.types.describe_capacity_block_status_result.DescribeCapacityBlockStatusResult:
    out: capo_ec2.types.describe_capacity_block_status_result.DescribeCapacityBlockStatusResult = capo_ec2.types.describe_capacity_block_status_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeCapacityBlockStatus"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_capacity_block_status_request.serialize_ec2_query(
        input_, pairs, ""
    )
