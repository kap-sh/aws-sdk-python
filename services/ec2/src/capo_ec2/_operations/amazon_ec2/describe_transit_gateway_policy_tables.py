...
import capo_ec2.types.describe_transit_gateway_policy_tables_request
import capo_ec2.types.describe_transit_gateway_policy_tables_result
...
) -> capo_ec2.types.describe_transit_gateway_policy_tables_result.DescribeTransitGatewayPolicyTablesResult:
    out: capo_ec2.types.describe_transit_gateway_policy_tables_result.DescribeTransitGatewayPolicyTablesResult = capo_ec2.types.describe_transit_gateway_policy_tables_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeTransitGatewayPolicyTables"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_transit_gateway_policy_tables_request.serialize_ec2_query(
        input_, pairs, ""
    )
