...
import capo_ec2.types.create_vpc_endpoint_service_configuration_request
import capo_ec2.types.create_vpc_endpoint_service_configuration_result
...
) -> capo_ec2.types.create_vpc_endpoint_service_configuration_result.CreateVpcEndpointServiceConfigurationResult:
    out: capo_ec2.types.create_vpc_endpoint_service_configuration_result.CreateVpcEndpointServiceConfigurationResult = capo_ec2.types.create_vpc_endpoint_service_configuration_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateVpcEndpointServiceConfiguration"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_vpc_endpoint_service_configuration_request.serialize_ec2_query(
        input_, pairs, ""
    )
