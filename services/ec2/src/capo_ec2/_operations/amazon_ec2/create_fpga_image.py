...
import capo_ec2.types.create_fpga_image_request
import capo_ec2.types.create_fpga_image_result
...
) -> capo_ec2.types.create_fpga_image_result.CreateFpgaImageResult:
    out: capo_ec2.types.create_fpga_image_result.CreateFpgaImageResult = (
        capo_ec2.types.create_fpga_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_fpga_image_request.serialize_ec2_query(input_, pairs, "")
...
def create_fpga_image(
    ...
    capo_ec2.types.create_fpga_image_result.CreateFpgaImageResult, zapros.Response
]:
