"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeNetworkInterfaceAttribute``."""
...
import capo_ec2.types.describe_network_interface_attribute_request
import capo_ec2.types.describe_network_interface_attribute_result
...
) -> capo_ec2.types.describe_network_interface_attribute_result.DescribeNetworkInterfaceAttributeResult:
    out: capo_ec2.types.describe_network_interface_attribute_result.DescribeNetworkInterfaceAttributeResult = capo_ec2.types.describe_network_interface_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeNetworkInterfaceAttribute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_network_interface_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_network_interface_attribute(
