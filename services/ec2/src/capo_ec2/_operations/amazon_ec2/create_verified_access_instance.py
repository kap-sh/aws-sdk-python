...
import capo_ec2.types.create_verified_access_instance_request
import capo_ec2.types.create_verified_access_instance_result
...
) -> capo_ec2.types.create_verified_access_instance_result.CreateVerifiedAccessInstanceResult:
    out: capo_ec2.types.create_verified_access_instance_result.CreateVerifiedAccessInstanceResult = capo_ec2.types.create_verified_access_instance_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateVerifiedAccessInstance"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_verified_access_instance_request.serialize_ec2_query(
        input_, pairs, ""
    )
