...
def handle_response(
    ...
    out: capo_ec2.types.associate_capacity_reservation_billing_owner_result.AssociateCapacityReservationBillingOwnerResult = capo_ec2.types.associate_capacity_reservation_billing_owner_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AssociateCapacityReservationBillingOwner"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.associate_capacity_reservation_billing_owner_request.serialize_ec2_query(
        input_, pairs, ""
    )
