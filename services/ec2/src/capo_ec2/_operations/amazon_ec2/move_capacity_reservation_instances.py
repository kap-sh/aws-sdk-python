...
import capo_ec2.types.move_capacity_reservation_instances_request
import capo_ec2.types.move_capacity_reservation_instances_result
...
def handle_response(
    ...
    out: capo_ec2.types.move_capacity_reservation_instances_result.MoveCapacityReservationInstancesResult = capo_ec2.types.move_capacity_reservation_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.move_capacity_reservation_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
