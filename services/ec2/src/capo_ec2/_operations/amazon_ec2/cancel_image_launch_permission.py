...
import capo_ec2.types.cancel_image_launch_permission_request
import capo_ec2.types.cancel_image_launch_permission_result
...
def handle_response(
    ...
    out: capo_ec2.types.cancel_image_launch_permission_result.CancelImageLaunchPermissionResult = capo_ec2.types.cancel_image_launch_permission_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CancelImageLaunchPermission"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.cancel_image_launch_permission_request.serialize_ec2_query(
        input_, pairs, ""
    )
