...
import capo_ec2.types.describe_prefix_lists_request
import capo_ec2.types.describe_prefix_lists_result
import capo_ec2.types.filter_list
import capo_ec2.types.prefix_list_resource_id_string_list
...
) -> capo_ec2.types.describe_prefix_lists_result.DescribePrefixListsResult:
    out: capo_ec2.types.describe_prefix_lists_result.DescribePrefixListsResult = (
        capo_ec2.types.describe_prefix_lists_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribePrefixLists"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_prefix_lists_request.serialize_ec2_query(input_, pairs, "")
