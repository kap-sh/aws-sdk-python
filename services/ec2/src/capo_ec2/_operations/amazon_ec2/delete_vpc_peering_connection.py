...
import capo_ec2.types.delete_vpc_peering_connection_request
import capo_ec2.types.delete_vpc_peering_connection_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_vpc_peering_connection_result.DeleteVpcPeeringConnectionResult = capo_ec2.types.delete_vpc_peering_connection_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_vpc_peering_connection_request.serialize_ec2_query(
        input_, pairs, ""
    )
