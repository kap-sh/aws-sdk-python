...
import capo_ec2.types.describe_spot_fleet_request_history_request
import capo_ec2.types.describe_spot_fleet_request_history_response
...
) -> capo_ec2.types.describe_spot_fleet_request_history_response.DescribeSpotFleetRequestHistoryResponse:
    out: capo_ec2.types.describe_spot_fleet_request_history_response.DescribeSpotFleetRequestHistoryResponse = capo_ec2.types.describe_spot_fleet_request_history_response.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_spot_fleet_request_history_request.serialize_ec2_query(
        input_, pairs, ""
    )
