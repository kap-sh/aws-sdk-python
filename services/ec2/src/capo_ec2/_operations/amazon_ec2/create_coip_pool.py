...
import capo_ec2.types.create_coip_pool_request
import capo_ec2.types.create_coip_pool_result
...
) -> capo_ec2.types.create_coip_pool_result.CreateCoipPoolResult:
    out: capo_ec2.types.create_coip_pool_result.CreateCoipPoolResult = (
        capo_ec2.types.create_coip_pool_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateCoipPool"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_coip_pool_request.serialize_ec2_query(input_, pairs, "")
...
def create_coip_pool(
    ...
    capo_ec2.types.create_coip_pool_result.CreateCoipPoolResult, zapros.Response
]:
