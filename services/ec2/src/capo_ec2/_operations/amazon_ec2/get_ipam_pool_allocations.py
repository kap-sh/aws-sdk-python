...
import capo_ec2.types.get_ipam_pool_allocations_request
import capo_ec2.types.get_ipam_pool_allocations_result
...
) -> capo_ec2.types.get_ipam_pool_allocations_result.GetIpamPoolAllocationsResult:
    out: capo_ec2.types.get_ipam_pool_allocations_result.GetIpamPoolAllocationsResult = capo_ec2.types.get_ipam_pool_allocations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetIpamPoolAllocations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_ipam_pool_allocations_request.serialize_ec2_query(
        input_, pairs, ""
    )
