...
) -> capo_ec2.types.create_ipam_scope_result.CreateIpamScopeResult:
    out: capo_ec2.types.create_ipam_scope_result.CreateIpamScopeResult = (
        capo_ec2.types.create_ipam_scope_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateIpamScope"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_ipam_scope_request.serialize_ec2_query(input_, pairs, "")
...
def create_ipam_scope(
    ...
    capo_ec2.types.create_ipam_scope_result.CreateIpamScopeResult, zapros.Response
]:
