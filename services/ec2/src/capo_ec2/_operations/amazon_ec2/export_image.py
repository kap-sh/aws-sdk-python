...
import capo_ec2.types.export_image_request
import capo_ec2.types.export_image_result
...
) -> capo_ec2.types.export_image_result.ExportImageResult:
    out: capo_ec2.types.export_image_result.ExportImageResult = (
        capo_ec2.types.export_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.export_image_request.serialize_ec2_query(input_, pairs, "")
...
def export_image(
    ...
    input_: capo_ec2.types.export_image_request.ExportImageRequest,
) -> tuple[capo_ec2.types.export_image_result.ExportImageResult, zapros.Response]:
