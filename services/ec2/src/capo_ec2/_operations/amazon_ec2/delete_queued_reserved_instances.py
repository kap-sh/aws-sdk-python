...
import capo_ec2.types.delete_queued_reserved_instances_request
import capo_ec2.types.delete_queued_reserved_instances_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_queued_reserved_instances_result.DeleteQueuedReservedInstancesResult = capo_ec2.types.delete_queued_reserved_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_queued_reserved_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
