...
import capo_ec2.types.describe_volumes_modifications_request
import capo_ec2.types.describe_volumes_modifications_result
...
def handle_response(
    ...
    out: capo_ec2.types.describe_volumes_modifications_result.DescribeVolumesModificationsResult = capo_ec2.types.describe_volumes_modifications_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVolumesModifications"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_volumes_modifications_request.serialize_ec2_query(
        input_, pairs, ""
    )
