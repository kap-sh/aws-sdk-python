...
import capo_ec2.types.describe_instances_request
import capo_ec2.types.describe_instances_result
...
) -> capo_ec2.types.describe_instances_result.DescribeInstancesResult:
    out: capo_ec2.types.describe_instances_result.DescribeInstancesResult = (
        capo_ec2.types.describe_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_instances_request.serialize_ec2_query(input_, pairs, "")
...
def describe_instances(
    ...
    capo_ec2.types.describe_instances_result.DescribeInstancesResult, zapros.Response
]:
