...
import capo_ec2.types.describe_export_tasks_request
import capo_ec2.types.describe_export_tasks_result
...
) -> capo_ec2.types.describe_export_tasks_result.DescribeExportTasksResult:
    out: capo_ec2.types.describe_export_tasks_result.DescribeExportTasksResult = (
        capo_ec2.types.describe_export_tasks_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_export_tasks_request.serialize_ec2_query(input_, pairs, "")
