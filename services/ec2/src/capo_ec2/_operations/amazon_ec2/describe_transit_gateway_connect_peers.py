...
import capo_ec2.types.describe_transit_gateway_connect_peers_request
import capo_ec2.types.describe_transit_gateway_connect_peers_result
...
) -> capo_ec2.types.describe_transit_gateway_connect_peers_result.DescribeTransitGatewayConnectPeersResult:
    out: capo_ec2.types.describe_transit_gateway_connect_peers_result.DescribeTransitGatewayConnectPeersResult = capo_ec2.types.describe_transit_gateway_connect_peers_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_transit_gateway_connect_peers_request.serialize_ec2_query(
        input_, pairs, ""
    )
