...
import capo_ec2.types.get_ipam_policy_organization_targets_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_ipam_policy_organization_targets_result.GetIpamPolicyOrganizationTargetsResult = capo_ec2.types.get_ipam_policy_organization_targets_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetIpamPolicyOrganizationTargets"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_ipam_policy_organization_targets_request.serialize_ec2_query(
        input_, pairs, ""
    )
