...
) -> capo_ec2.types.describe_address_transfers_result.DescribeAddressTransfersResult:
    out: capo_ec2.types.describe_address_transfers_result.DescribeAddressTransfersResult = capo_ec2.types.describe_address_transfers_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_address_transfers_request.serialize_ec2_query(
        input_, pairs, ""
    )
