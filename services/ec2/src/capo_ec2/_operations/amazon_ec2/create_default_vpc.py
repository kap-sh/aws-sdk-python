...
import capo_ec2.types.create_default_vpc_request
import capo_ec2.types.create_default_vpc_result
...
) -> capo_ec2.types.create_default_vpc_result.CreateDefaultVpcResult:
    out: capo_ec2.types.create_default_vpc_result.CreateDefaultVpcResult = (
        capo_ec2.types.create_default_vpc_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_default_vpc_request.serialize_ec2_query(input_, pairs, "")
...
def create_default_vpc(
    ...
    capo_ec2.types.create_default_vpc_result.CreateDefaultVpcResult, zapros.Response
]:
