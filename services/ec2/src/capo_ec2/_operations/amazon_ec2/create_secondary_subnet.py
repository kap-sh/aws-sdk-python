...
import capo_ec2.types.create_secondary_subnet_request
import capo_ec2.types.create_secondary_subnet_result
...
) -> capo_ec2.types.create_secondary_subnet_result.CreateSecondarySubnetResult:
    out: capo_ec2.types.create_secondary_subnet_result.CreateSecondarySubnetResult = (
        capo_ec2.types.create_secondary_subnet_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateSecondarySubnet"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_secondary_subnet_request.serialize_ec2_query(
        input_, pairs, ""
    )
