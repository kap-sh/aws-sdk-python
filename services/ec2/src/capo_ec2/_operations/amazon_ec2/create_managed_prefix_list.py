...
import capo_ec2.types.create_managed_prefix_list_request
import capo_ec2.types.create_managed_prefix_list_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_managed_prefix_list_result.CreateManagedPrefixListResult = capo_ec2.types.create_managed_prefix_list_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateManagedPrefixList"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_managed_prefix_list_request.serialize_ec2_query(
        input_, pairs, ""
    )
