"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeMacHosts``."""
...
import capo_ec2.types.describe_mac_hosts_request
import capo_ec2.types.describe_mac_hosts_result
...
) -> capo_ec2.types.describe_mac_hosts_result.DescribeMacHostsResult:
    out: capo_ec2.types.describe_mac_hosts_result.DescribeMacHostsResult = (
        capo_ec2.types.describe_mac_hosts_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeMacHosts"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_mac_hosts_request.serialize_ec2_query(input_, pairs, "")
...
def describe_mac_hosts(
    ...
    capo_ec2.types.describe_mac_hosts_result.DescribeMacHostsResult, zapros.Response
]:
...
async def async_describe_mac_hosts(
