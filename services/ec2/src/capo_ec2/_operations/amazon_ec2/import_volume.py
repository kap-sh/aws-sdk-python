...
def handle_response(
    ...
    out: capo_ec2.types.import_volume_result.ImportVolumeResult = (
        capo_ec2.types.import_volume_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.import_volume_request.serialize_ec2_query(input_, pairs, "")
...
def import_volume(
    ...
    input_: capo_ec2.types.import_volume_request.ImportVolumeRequest,
) -> tuple[capo_ec2.types.import_volume_result.ImportVolumeResult, zapros.Response]:
