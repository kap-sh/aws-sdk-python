"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteKeyPair``."""
...
import capo_ec2.types.delete_key_pair_result
...
) -> capo_ec2.types.delete_key_pair_result.DeleteKeyPairResult:
    out: capo_ec2.types.delete_key_pair_result.DeleteKeyPairResult = (
        capo_ec2.types.delete_key_pair_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteKeyPair"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_key_pair_request.serialize_ec2_query(input_, pairs, "")
...
def delete_key_pair(
    ...
    input_: capo_ec2.types.delete_key_pair_request.DeleteKeyPairRequest,
) -> tuple[capo_ec2.types.delete_key_pair_result.DeleteKeyPairResult, zapros.Response]:
...
async def async_delete_key_pair(
