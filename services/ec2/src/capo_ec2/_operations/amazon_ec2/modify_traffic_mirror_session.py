...
import capo_ec2.types.modify_traffic_mirror_session_request
import capo_ec2.types.modify_traffic_mirror_session_result
...
def handle_response(
    ...
    capo_ec2.types.modify_traffic_mirror_session_result.ModifyTrafficMirrorSessionResult
):
    out: capo_ec2.types.modify_traffic_mirror_session_result.ModifyTrafficMirrorSessionResult = capo_ec2.types.modify_traffic_mirror_session_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyTrafficMirrorSession"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_traffic_mirror_session_request.serialize_ec2_query(
        input_, pairs, ""
    )
