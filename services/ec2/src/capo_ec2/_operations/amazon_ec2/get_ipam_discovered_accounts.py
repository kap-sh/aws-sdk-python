...
import capo_ec2.types.get_ipam_discovered_accounts_request
import capo_ec2.types.get_ipam_discovered_accounts_result
...
) -> capo_ec2.types.get_ipam_discovered_accounts_result.GetIpamDiscoveredAccountsResult:
    out: capo_ec2.types.get_ipam_discovered_accounts_result.GetIpamDiscoveredAccountsResult = capo_ec2.types.get_ipam_discovered_accounts_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetIpamDiscoveredAccounts"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_ipam_discovered_accounts_request.serialize_ec2_query(
        input_, pairs, ""
    )
