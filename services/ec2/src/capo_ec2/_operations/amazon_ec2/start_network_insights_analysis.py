"""Generated from Smithy shape ``com.amazonaws.ec2#StartNetworkInsightsAnalysis``."""
...
import capo_ec2.types.start_network_insights_analysis_request
import capo_ec2.types.start_network_insights_analysis_result
...
def handle_response(
    ...
    out: capo_ec2.types.start_network_insights_analysis_result.StartNetworkInsightsAnalysisResult = capo_ec2.types.start_network_insights_analysis_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "StartNetworkInsightsAnalysis"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.start_network_insights_analysis_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_start_network_insights_analysis(
