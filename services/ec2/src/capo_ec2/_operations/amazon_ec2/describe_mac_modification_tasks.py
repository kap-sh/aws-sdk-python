...
import capo_ec2.types.describe_mac_modification_tasks_request
import capo_ec2.types.describe_mac_modification_tasks_result
...
) -> capo_ec2.types.describe_mac_modification_tasks_result.DescribeMacModificationTasksResult:
    out: capo_ec2.types.describe_mac_modification_tasks_result.DescribeMacModificationTasksResult = capo_ec2.types.describe_mac_modification_tasks_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeMacModificationTasks"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_mac_modification_tasks_request.serialize_ec2_query(
        input_, pairs, ""
    )
