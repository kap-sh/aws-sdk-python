...
def handle_response(
    ...
    out: capo_ec2.types.enable_instance_sql_ha_standby_detections_result.EnableInstanceSqlHaStandbyDetectionsResult = capo_ec2.types.enable_instance_sql_ha_standby_detections_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.enable_instance_sql_ha_standby_detections_request.serialize_ec2_query(
        input_, pairs, ""
    )
