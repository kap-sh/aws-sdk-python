...
import capo_ec2.types.describe_security_group_vpc_associations_request
import capo_ec2.types.describe_security_group_vpc_associations_result
...
) -> capo_ec2.types.describe_security_group_vpc_associations_result.DescribeSecurityGroupVpcAssociationsResult:
    out: capo_ec2.types.describe_security_group_vpc_associations_result.DescribeSecurityGroupVpcAssociationsResult = capo_ec2.types.describe_security_group_vpc_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_security_group_vpc_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
