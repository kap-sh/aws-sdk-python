...
import capo_ec2.types.create_network_insights_access_scope_request
import capo_ec2.types.create_network_insights_access_scope_result
...
) -> capo_ec2.types.create_network_insights_access_scope_result.CreateNetworkInsightsAccessScopeResult:
    out: capo_ec2.types.create_network_insights_access_scope_result.CreateNetworkInsightsAccessScopeResult = capo_ec2.types.create_network_insights_access_scope_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_network_insights_access_scope_request.serialize_ec2_query(
        input_, pairs, ""
    )
