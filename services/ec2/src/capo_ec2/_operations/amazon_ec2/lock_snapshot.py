...
import capo_ec2.types.lock_snapshot_request
import capo_ec2.types.lock_snapshot_result
...
) -> capo_ec2.types.lock_snapshot_result.LockSnapshotResult:
    out: capo_ec2.types.lock_snapshot_result.LockSnapshotResult = (
        capo_ec2.types.lock_snapshot_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "LockSnapshot"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.lock_snapshot_request.serialize_ec2_query(input_, pairs, "")
...
def lock_snapshot(
    ...
    input_: capo_ec2.types.lock_snapshot_request.LockSnapshotRequest,
) -> tuple[capo_ec2.types.lock_snapshot_result.LockSnapshotResult, zapros.Response]:
