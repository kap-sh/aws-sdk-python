...
import capo_ec2.types.describe_nat_gateways_request
import capo_ec2.types.describe_nat_gateways_result
...
) -> capo_ec2.types.describe_nat_gateways_result.DescribeNatGatewaysResult:
    out: capo_ec2.types.describe_nat_gateways_result.DescribeNatGatewaysResult = (
        capo_ec2.types.describe_nat_gateways_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeNatGateways"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_nat_gateways_request.serialize_ec2_query(input_, pairs, "")
