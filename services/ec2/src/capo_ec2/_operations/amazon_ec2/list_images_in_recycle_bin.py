...
import capo_ec2.types.list_images_in_recycle_bin_request
import capo_ec2.types.list_images_in_recycle_bin_result
...
) -> capo_ec2.types.list_images_in_recycle_bin_result.ListImagesInRecycleBinResult:
    out: capo_ec2.types.list_images_in_recycle_bin_result.ListImagesInRecycleBinResult = capo_ec2.types.list_images_in_recycle_bin_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListImagesInRecycleBin"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.list_images_in_recycle_bin_request.serialize_ec2_query(
        input_, pairs, ""
    )
