...
import capo_ec2.types.copy_snapshot_request
import capo_ec2.types.copy_snapshot_result
...
) -> capo_ec2.types.copy_snapshot_result.CopySnapshotResult:
    out: capo_ec2.types.copy_snapshot_result.CopySnapshotResult = (
        capo_ec2.types.copy_snapshot_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.copy_snapshot_request.serialize_ec2_query(input_, pairs, "")
...
def copy_snapshot(
    ...
    input_: capo_ec2.types.copy_snapshot_request.CopySnapshotRequest,
) -> tuple[capo_ec2.types.copy_snapshot_result.CopySnapshotResult, zapros.Response]:
