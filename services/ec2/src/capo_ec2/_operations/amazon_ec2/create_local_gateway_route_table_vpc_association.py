...
import capo_ec2.types.create_local_gateway_route_table_vpc_association_request
import capo_ec2.types.create_local_gateway_route_table_vpc_association_result
...
) -> capo_ec2.types.create_local_gateway_route_table_vpc_association_result.CreateLocalGatewayRouteTableVpcAssociationResult:
    out: capo_ec2.types.create_local_gateway_route_table_vpc_association_result.CreateLocalGatewayRouteTableVpcAssociationResult = capo_ec2.types.create_local_gateway_route_table_vpc_association_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateLocalGatewayRouteTableVpcAssociation"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_local_gateway_route_table_vpc_association_request.serialize_ec2_query(
        input_, pairs, ""
    )
