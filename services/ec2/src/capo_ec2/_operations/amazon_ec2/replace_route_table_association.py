"""Generated from Smithy shape ``com.amazonaws.ec2#ReplaceRouteTableAssociation``."""
...
import capo_ec2.types.replace_route_table_association_request
import capo_ec2.types.replace_route_table_association_result
...
def handle_response(
    ...
    out: capo_ec2.types.replace_route_table_association_result.ReplaceRouteTableAssociationResult = capo_ec2.types.replace_route_table_association_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.replace_route_table_association_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_replace_route_table_association(
