...
import capo_ec2.types.enable_image_deprecation_request
import capo_ec2.types.enable_image_deprecation_result
...
def handle_response(
    ...
    out: capo_ec2.types.enable_image_deprecation_result.EnableImageDeprecationResult = (
        capo_ec2.types.enable_image_deprecation_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.enable_image_deprecation_request.serialize_ec2_query(
        input_, pairs, ""
    )
