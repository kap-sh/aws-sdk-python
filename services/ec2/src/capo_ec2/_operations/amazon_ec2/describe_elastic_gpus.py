"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeElasticGpus``."""
...
import capo_ec2.types.describe_elastic_gpus_request
import capo_ec2.types.describe_elastic_gpus_result
...
) -> capo_ec2.types.describe_elastic_gpus_result.DescribeElasticGpusResult:
    out: capo_ec2.types.describe_elastic_gpus_result.DescribeElasticGpusResult = (
        capo_ec2.types.describe_elastic_gpus_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeElasticGpus"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_elastic_gpus_request.serialize_ec2_query(input_, pairs, "")
...
async def async_describe_elastic_gpus(
