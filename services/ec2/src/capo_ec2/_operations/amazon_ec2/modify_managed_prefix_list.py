...
import capo_ec2.types.modify_managed_prefix_list_request
import capo_ec2.types.modify_managed_prefix_list_result
...
) -> capo_ec2.types.modify_managed_prefix_list_result.ModifyManagedPrefixListResult:
    out: capo_ec2.types.modify_managed_prefix_list_result.ModifyManagedPrefixListResult = capo_ec2.types.modify_managed_prefix_list_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyManagedPrefixList"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_managed_prefix_list_request.serialize_ec2_query(
        input_, pairs, ""
    )
