...
import capo_ec2.types.import_instance_request
import capo_ec2.types.import_instance_result
...
def handle_response(
    ...
    out: capo_ec2.types.import_instance_result.ImportInstanceResult = (
        capo_ec2.types.import_instance_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.import_instance_request.serialize_ec2_query(input_, pairs, "")
...
def import_instance(
    ...
    input_: capo_ec2.types.import_instance_request.ImportInstanceRequest,
) -> tuple[capo_ec2.types.import_instance_result.ImportInstanceResult, zapros.Response]:
