"""Generated from Smithy shape ``com.amazonaws.ec2#GetIpamRouteProtectionFindings``."""
...
def handle_response(
    ...
    out: capo_ec2.types.get_ipam_route_protection_findings_result.GetIpamRouteProtectionFindingsResult = capo_ec2.types.get_ipam_route_protection_findings_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetIpamRouteProtectionFindings"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_ipam_route_protection_findings_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_get_ipam_route_protection_findings(
