"""Generated from Smithy shape ``com.amazonaws.ec2#RegisterImage``."""
...
import capo_ec2.types.register_image_request
import capo_ec2.types.register_image_result
...
) -> capo_ec2.types.register_image_result.RegisterImageResult:
    out: capo_ec2.types.register_image_result.RegisterImageResult = (
        capo_ec2.types.register_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "RegisterImage"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.register_image_request.serialize_ec2_query(input_, pairs, "")
...
def register_image(
    ...
    input_: capo_ec2.types.register_image_request.RegisterImageRequest,
) -> tuple[capo_ec2.types.register_image_result.RegisterImageResult, zapros.Response]:
...
async def async_register_image(
