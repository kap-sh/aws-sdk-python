...
) -> capo_ec2.types.modify_transit_gateway_metering_policy_result.ModifyTransitGatewayMeteringPolicyResult:
    out: capo_ec2.types.modify_transit_gateway_metering_policy_result.ModifyTransitGatewayMeteringPolicyResult = capo_ec2.types.modify_transit_gateway_metering_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_transit_gateway_metering_policy_request.serialize_ec2_query(
        input_, pairs, ""
    )
