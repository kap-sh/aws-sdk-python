...
import capo_ec2.types.stop_instances_request
import capo_ec2.types.stop_instances_result
...
) -> capo_ec2.types.stop_instances_result.StopInstancesResult:
    out: capo_ec2.types.stop_instances_result.StopInstancesResult = (
        capo_ec2.types.stop_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "StopInstances"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.stop_instances_request.serialize_ec2_query(input_, pairs, "")
...
def stop_instances(
    ...
    input_: capo_ec2.types.stop_instances_request.StopInstancesRequest,
) -> tuple[capo_ec2.types.stop_instances_result.StopInstancesResult, zapros.Response]:
