...
import capo_ec2.types.get_transit_gateway_policy_table_associations_request
import capo_ec2.types.get_transit_gateway_policy_table_associations_result
...
) -> capo_ec2.types.get_transit_gateway_policy_table_associations_result.GetTransitGatewayPolicyTableAssociationsResult:
    out: capo_ec2.types.get_transit_gateway_policy_table_associations_result.GetTransitGatewayPolicyTableAssociationsResult = capo_ec2.types.get_transit_gateway_policy_table_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetTransitGatewayPolicyTableAssociations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_transit_gateway_policy_table_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
