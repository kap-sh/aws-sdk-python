...
import capo_ec2.types.start_vpc_endpoint_service_private_dns_verification_request
import capo_ec2.types.start_vpc_endpoint_service_private_dns_verification_result
...
def handle_response(
    ...
    out: capo_ec2.types.start_vpc_endpoint_service_private_dns_verification_result.StartVpcEndpointServicePrivateDnsVerificationResult = capo_ec2.types.start_vpc_endpoint_service_private_dns_verification_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "StartVpcEndpointServicePrivateDnsVerification"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.start_vpc_endpoint_service_private_dns_verification_request.serialize_ec2_query(
        input_, pairs, ""
    )
