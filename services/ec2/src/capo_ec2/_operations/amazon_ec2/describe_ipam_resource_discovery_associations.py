...
import capo_ec2.types.describe_ipam_resource_discovery_associations_request
import capo_ec2.types.describe_ipam_resource_discovery_associations_result
...
) -> capo_ec2.types.describe_ipam_resource_discovery_associations_result.DescribeIpamResourceDiscoveryAssociationsResult:
    out: capo_ec2.types.describe_ipam_resource_discovery_associations_result.DescribeIpamResourceDiscoveryAssociationsResult = capo_ec2.types.describe_ipam_resource_discovery_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeIpamResourceDiscoveryAssociations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_ipam_resource_discovery_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
