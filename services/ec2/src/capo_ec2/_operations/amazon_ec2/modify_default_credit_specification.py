...
import capo_ec2.types.modify_default_credit_specification_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_default_credit_specification_result.ModifyDefaultCreditSpecificationResult = capo_ec2.types.modify_default_credit_specification_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_default_credit_specification_request.serialize_ec2_query(
        input_, pairs, ""
    )
