...
import capo_ec2.types.assign_private_ip_addresses_request
import capo_ec2.types.assign_private_ip_addresses_result
...
) -> capo_ec2.types.assign_private_ip_addresses_result.AssignPrivateIpAddressesResult:
    out: capo_ec2.types.assign_private_ip_addresses_result.AssignPrivateIpAddressesResult = capo_ec2.types.assign_private_ip_addresses_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AssignPrivateIpAddresses"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.assign_private_ip_addresses_request.serialize_ec2_query(
        input_, pairs, ""
    )
