...
) -> capo_ec2.types.get_ipam_policy_allocation_rules_result.GetIpamPolicyAllocationRulesResult:
    out: capo_ec2.types.get_ipam_policy_allocation_rules_result.GetIpamPolicyAllocationRulesResult = capo_ec2.types.get_ipam_policy_allocation_rules_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetIpamPolicyAllocationRules"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_ipam_policy_allocation_rules_request.serialize_ec2_query(
        input_, pairs, ""
    )
