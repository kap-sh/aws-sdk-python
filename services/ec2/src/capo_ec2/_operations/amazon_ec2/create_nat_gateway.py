"""Generated from Smithy shape ``com.amazonaws.ec2#CreateNatGateway``."""
...
import capo_ec2.types.create_nat_gateway_request
import capo_ec2.types.create_nat_gateway_result
...
) -> capo_ec2.types.create_nat_gateway_result.CreateNatGatewayResult:
    out: capo_ec2.types.create_nat_gateway_result.CreateNatGatewayResult = (
        capo_ec2.types.create_nat_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateNatGateway"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_nat_gateway_request.serialize_ec2_query(input_, pairs, "")
...
def create_nat_gateway(
    ...
    capo_ec2.types.create_nat_gateway_result.CreateNatGatewayResult, zapros.Response
]:
...
async def async_create_nat_gateway(
