...
import capo_ec2.types.terminate_client_vpn_connections_request
import capo_ec2.types.terminate_client_vpn_connections_result
...
) -> capo_ec2.types.terminate_client_vpn_connections_result.TerminateClientVpnConnectionsResult:
    out: capo_ec2.types.terminate_client_vpn_connections_result.TerminateClientVpnConnectionsResult = capo_ec2.types.terminate_client_vpn_connections_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "TerminateClientVpnConnections"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.terminate_client_vpn_connections_request.serialize_ec2_query(
        input_, pairs, ""
    )
