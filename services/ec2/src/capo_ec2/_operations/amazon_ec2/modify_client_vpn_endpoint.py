...
def handle_response(
    ...
    out: capo_ec2.types.modify_client_vpn_endpoint_result.ModifyClientVpnEndpointResult = capo_ec2.types.modify_client_vpn_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyClientVpnEndpoint"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_client_vpn_endpoint_request.serialize_ec2_query(
        input_, pairs, ""
    )
