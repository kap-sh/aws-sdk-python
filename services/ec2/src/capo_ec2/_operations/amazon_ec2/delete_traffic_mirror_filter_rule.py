...
import capo_ec2.types.delete_traffic_mirror_filter_rule_request
import capo_ec2.types.delete_traffic_mirror_filter_rule_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_traffic_mirror_filter_rule_result.DeleteTrafficMirrorFilterRuleResult = capo_ec2.types.delete_traffic_mirror_filter_rule_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteTrafficMirrorFilterRule"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_traffic_mirror_filter_rule_request.serialize_ec2_query(
        input_, pairs, ""
    )
