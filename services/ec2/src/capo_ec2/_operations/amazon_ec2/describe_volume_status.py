"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeVolumeStatus``."""
...
import capo_ec2.types.describe_volume_status_request
import capo_ec2.types.describe_volume_status_result
...
) -> capo_ec2.types.describe_volume_status_result.DescribeVolumeStatusResult:
    out: capo_ec2.types.describe_volume_status_result.DescribeVolumeStatusResult = (
        capo_ec2.types.describe_volume_status_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVolumeStatus"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_volume_status_request.serialize_ec2_query(input_, pairs, "")
...
async def async_describe_volume_status(
