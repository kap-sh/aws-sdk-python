...
import capo_ec2.types.create_vpn_connection_request
import capo_ec2.types.create_vpn_connection_result
...
) -> capo_ec2.types.create_vpn_connection_result.CreateVpnConnectionResult:
    out: capo_ec2.types.create_vpn_connection_result.CreateVpnConnectionResult = (
        capo_ec2.types.create_vpn_connection_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateVpnConnection"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_vpn_connection_request.serialize_ec2_query(input_, pairs, "")
