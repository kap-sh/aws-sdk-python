...
import capo_ec2.types.describe_network_insights_paths_request
import capo_ec2.types.describe_network_insights_paths_result
import capo_ec2.types.filter_list
import capo_ec2.types.network_insights_path_id_list
import capo_ec2.types.network_insights_path_list
...
) -> capo_ec2.types.describe_network_insights_paths_result.DescribeNetworkInsightsPathsResult:
    out: capo_ec2.types.describe_network_insights_paths_result.DescribeNetworkInsightsPathsResult = capo_ec2.types.describe_network_insights_paths_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeNetworkInsightsPaths"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_network_insights_paths_request.serialize_ec2_query(
        input_, pairs, ""
    )
