...
import capo_ec2.types.create_ipam_pool_result
...
) -> capo_ec2.types.create_ipam_pool_result.CreateIpamPoolResult:
    out: capo_ec2.types.create_ipam_pool_result.CreateIpamPoolResult = (
        capo_ec2.types.create_ipam_pool_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_ipam_pool_request.serialize_ec2_query(input_, pairs, "")
...
def create_ipam_pool(
    ...
    capo_ec2.types.create_ipam_pool_result.CreateIpamPoolResult, zapros.Response
]:
