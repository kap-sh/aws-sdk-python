...
import capo_ec2.types.associate_client_vpn_target_network_result
...
) -> capo_ec2.types.associate_client_vpn_target_network_result.AssociateClientVpnTargetNetworkResult:
    out: capo_ec2.types.associate_client_vpn_target_network_result.AssociateClientVpnTargetNetworkResult = capo_ec2.types.associate_client_vpn_target_network_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AssociateClientVpnTargetNetwork"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.associate_client_vpn_target_network_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_associate_client_vpn_target_network(
