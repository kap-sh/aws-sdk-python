...
import capo_ec2.types.provision_ipam_pool_cidr_result
...
) -> capo_ec2.types.provision_ipam_pool_cidr_result.ProvisionIpamPoolCidrResult:
    out: capo_ec2.types.provision_ipam_pool_cidr_result.ProvisionIpamPoolCidrResult = (
        capo_ec2.types.provision_ipam_pool_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ProvisionIpamPoolCidr"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.provision_ipam_pool_cidr_request.serialize_ec2_query(
        input_, pairs, ""
    )
