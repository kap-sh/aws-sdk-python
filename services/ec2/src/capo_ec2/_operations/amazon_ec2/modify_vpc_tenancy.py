...
import capo_ec2.types.modify_vpc_tenancy_request
import capo_ec2.types.modify_vpc_tenancy_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_vpc_tenancy_result.ModifyVpcTenancyResult = (
        capo_ec2.types.modify_vpc_tenancy_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyVpcTenancy"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_vpc_tenancy_request.serialize_ec2_query(input_, pairs, "")
...
def modify_vpc_tenancy(
    ...
    capo_ec2.types.modify_vpc_tenancy_result.ModifyVpcTenancyResult, zapros.Response
]:
