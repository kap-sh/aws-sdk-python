...
import capo_ec2.types.get_flow_logs_integration_template_request
import capo_ec2.types.get_flow_logs_integration_template_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_flow_logs_integration_template_result.GetFlowLogsIntegrationTemplateResult = capo_ec2.types.get_flow_logs_integration_template_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetFlowLogsIntegrationTemplate"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_flow_logs_integration_template_request.serialize_ec2_query(
        input_, pairs, ""
    )
