...
def handle_response(
    ...
    out: capo_ec2.types.create_client_vpn_endpoint_result.CreateClientVpnEndpointResult = capo_ec2.types.create_client_vpn_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_client_vpn_endpoint_request.serialize_ec2_query(
        input_, pairs, ""
    )
