"""Generated from Smithy shape ``com.amazonaws.ec2#DisableApplicationStatusCheckSuppression``."""
...
def handle_response(
    ...
    out: capo_ec2.types.disable_application_status_check_suppression_result.DisableApplicationStatusCheckSuppressionResult = capo_ec2.types.disable_application_status_check_suppression_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableApplicationStatusCheckSuppression"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disable_application_status_check_suppression_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_disable_application_status_check_suppression(
