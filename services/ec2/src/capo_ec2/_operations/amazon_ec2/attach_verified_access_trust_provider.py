...
import capo_ec2.types.attach_verified_access_trust_provider_request
import capo_ec2.types.attach_verified_access_trust_provider_result
...
def handle_response(
    ...
    out: capo_ec2.types.attach_verified_access_trust_provider_result.AttachVerifiedAccessTrustProviderResult = capo_ec2.types.attach_verified_access_trust_provider_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AttachVerifiedAccessTrustProvider"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.attach_verified_access_trust_provider_request.serialize_ec2_query(
        input_, pairs, ""
    )
