...
import capo_ec2.types.delete_vpn_gateway_request
...
def build_request(
    ...
    pairs.append(("Action", "DeleteVpnGateway"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_vpn_gateway_request.serialize_ec2_query(input_, pairs, "")
