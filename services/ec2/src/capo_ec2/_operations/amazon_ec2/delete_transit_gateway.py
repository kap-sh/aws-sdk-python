...
import capo_ec2.types.delete_transit_gateway_request
import capo_ec2.types.delete_transit_gateway_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_transit_gateway_result.DeleteTransitGatewayResult = (
        capo_ec2.types.delete_transit_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_transit_gateway_request.serialize_ec2_query(input_, pairs, "")
