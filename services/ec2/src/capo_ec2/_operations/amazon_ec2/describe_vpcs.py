...
import capo_ec2.types.describe_vpcs_request
import capo_ec2.types.describe_vpcs_result
...
) -> capo_ec2.types.describe_vpcs_result.DescribeVpcsResult:
    out: capo_ec2.types.describe_vpcs_result.DescribeVpcsResult = (
        capo_ec2.types.describe_vpcs_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_vpcs_request.serialize_ec2_query(input_, pairs, "")
...
def describe_vpcs(
    ...
    input_: capo_ec2.types.describe_vpcs_request.DescribeVpcsRequest,
) -> tuple[capo_ec2.types.describe_vpcs_result.DescribeVpcsResult, zapros.Response]:
