"""Generated from Smithy shape ``com.amazonaws.ec2#CreateCapacityReservationCancellationQuote``."""
...
def handle_response(
    ...
    out: capo_ec2.types.create_capacity_reservation_cancellation_quote_result.CreateCapacityReservationCancellationQuoteResult = capo_ec2.types.create_capacity_reservation_cancellation_quote_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateCapacityReservationCancellationQuote"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_capacity_reservation_cancellation_quote_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_create_capacity_reservation_cancellation_quote(
