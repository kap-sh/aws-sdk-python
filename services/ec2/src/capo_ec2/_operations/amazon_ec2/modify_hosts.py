...
import capo_ec2.types.modify_hosts_request
import capo_ec2.types.modify_hosts_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_hosts_result.ModifyHostsResult = (
        capo_ec2.types.modify_hosts_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyHosts"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_hosts_request.serialize_ec2_query(input_, pairs, "")
...
def modify_hosts(
    ...
    input_: capo_ec2.types.modify_hosts_request.ModifyHostsRequest,
) -> tuple[capo_ec2.types.modify_hosts_result.ModifyHostsResult, zapros.Response]:
