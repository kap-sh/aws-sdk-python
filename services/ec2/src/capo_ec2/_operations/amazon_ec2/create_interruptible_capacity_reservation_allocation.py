...
import capo_ec2.types.create_interruptible_capacity_reservation_allocation_request
...
def handle_response(
    ...
    out: capo_ec2.types.create_interruptible_capacity_reservation_allocation_result.CreateInterruptibleCapacityReservationAllocationResult = capo_ec2.types.create_interruptible_capacity_reservation_allocation_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_interruptible_capacity_reservation_allocation_request.serialize_ec2_query(
        input_, pairs, ""
    )
