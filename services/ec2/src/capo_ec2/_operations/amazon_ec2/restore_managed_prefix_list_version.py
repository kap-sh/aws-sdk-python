...
import capo_ec2.types.restore_managed_prefix_list_version_request
import capo_ec2.types.restore_managed_prefix_list_version_result
...
def handle_response(
    ...
    out: capo_ec2.types.restore_managed_prefix_list_version_result.RestoreManagedPrefixListVersionResult = capo_ec2.types.restore_managed_prefix_list_version_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.restore_managed_prefix_list_version_request.serialize_ec2_query(
        input_, pairs, ""
    )
