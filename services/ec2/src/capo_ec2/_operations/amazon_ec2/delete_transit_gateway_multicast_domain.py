...
import capo_ec2.types.delete_transit_gateway_multicast_domain_request
...
def handle_response(
    ...
    out: capo_ec2.types.delete_transit_gateway_multicast_domain_result.DeleteTransitGatewayMulticastDomainResult = capo_ec2.types.delete_transit_gateway_multicast_domain_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_transit_gateway_multicast_domain_request.serialize_ec2_query(
        input_, pairs, ""
    )
