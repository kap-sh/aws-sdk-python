...
import capo_ec2.types.describe_local_gateway_route_table_vpc_associations_request
import capo_ec2.types.describe_local_gateway_route_table_vpc_associations_result
...
) -> capo_ec2.types.describe_local_gateway_route_table_vpc_associations_result.DescribeLocalGatewayRouteTableVpcAssociationsResult:
    out: capo_ec2.types.describe_local_gateway_route_table_vpc_associations_result.DescribeLocalGatewayRouteTableVpcAssociationsResult = capo_ec2.types.describe_local_gateway_route_table_vpc_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeLocalGatewayRouteTableVpcAssociations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_local_gateway_route_table_vpc_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
