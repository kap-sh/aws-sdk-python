...
def handle_response(
    ...
    out: capo_ec2.types.create_ipam_policy_result.CreateIpamPolicyResult = (
        capo_ec2.types.create_ipam_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_ipam_policy_request.serialize_ec2_query(input_, pairs, "")
...
def create_ipam_policy(
    ...
    capo_ec2.types.create_ipam_policy_result.CreateIpamPolicyResult, zapros.Response
]:
