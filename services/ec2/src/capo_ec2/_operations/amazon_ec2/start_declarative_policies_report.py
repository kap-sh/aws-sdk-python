...
import capo_ec2.types.start_declarative_policies_report_request
import capo_ec2.types.start_declarative_policies_report_result
...
) -> capo_ec2.types.start_declarative_policies_report_result.StartDeclarativePoliciesReportResult:
    out: capo_ec2.types.start_declarative_policies_report_result.StartDeclarativePoliciesReportResult = capo_ec2.types.start_declarative_policies_report_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.start_declarative_policies_report_request.serialize_ec2_query(
        input_, pairs, ""
    )
