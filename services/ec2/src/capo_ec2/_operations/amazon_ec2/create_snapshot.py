...
import capo_ec2.types.create_snapshot_request
...
def handle_response(response: zapros.Response) -> capo_ec2.types.snapshot.Snapshot:
    out: capo_ec2.types.snapshot.Snapshot = (
        capo_ec2.types.snapshot.deserialize_ec2_query(fromstring(response.read()))
    )
    return out
...
) -> capo_ec2.types.snapshot.Snapshot:
    out: capo_ec2.types.snapshot.Snapshot = (
        capo_ec2.types.snapshot.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_snapshot_request.serialize_ec2_query(input_, pairs, "")
...
def create_snapshot(
    ...
    input_: capo_ec2.types.create_snapshot_request.CreateSnapshotRequest,
) -> tuple[capo_ec2.types.snapshot.Snapshot, zapros.Response]:
