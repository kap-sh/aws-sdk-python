"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeFlowLogs``."""
...
import capo_ec2.types.describe_flow_logs_request
import capo_ec2.types.describe_flow_logs_result
...
) -> capo_ec2.types.describe_flow_logs_result.DescribeFlowLogsResult:
    out: capo_ec2.types.describe_flow_logs_result.DescribeFlowLogsResult = (
        capo_ec2.types.describe_flow_logs_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeFlowLogs"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_flow_logs_request.serialize_ec2_query(input_, pairs, "")
...
def describe_flow_logs(
    ...
    capo_ec2.types.describe_flow_logs_result.DescribeFlowLogsResult, zapros.Response
]:
...
async def async_describe_flow_logs(
