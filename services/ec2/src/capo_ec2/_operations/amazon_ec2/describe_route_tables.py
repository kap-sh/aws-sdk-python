"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeRouteTables``."""
...
import capo_ec2.types.describe_route_tables_request
import capo_ec2.types.describe_route_tables_result
import capo_ec2.types.filter_list
import capo_ec2.types.route_table_id_string_list
import capo_ec2.types.route_table_list
...
) -> capo_ec2.types.describe_route_tables_result.DescribeRouteTablesResult:
    out: capo_ec2.types.describe_route_tables_result.DescribeRouteTablesResult = (
        capo_ec2.types.describe_route_tables_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeRouteTables"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_route_tables_request.serialize_ec2_query(input_, pairs, "")
...
async def async_describe_route_tables(
