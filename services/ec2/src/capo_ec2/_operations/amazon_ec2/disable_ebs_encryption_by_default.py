...
import capo_ec2.types.disable_ebs_encryption_by_default_request
import capo_ec2.types.disable_ebs_encryption_by_default_result
...
) -> capo_ec2.types.disable_ebs_encryption_by_default_result.DisableEbsEncryptionByDefaultResult:
    out: capo_ec2.types.disable_ebs_encryption_by_default_result.DisableEbsEncryptionByDefaultResult = capo_ec2.types.disable_ebs_encryption_by_default_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableEbsEncryptionByDefault"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disable_ebs_encryption_by_default_request.serialize_ec2_query(
        input_, pairs, ""
    )
