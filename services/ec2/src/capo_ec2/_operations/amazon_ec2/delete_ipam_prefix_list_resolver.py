...
import capo_ec2.types.delete_ipam_prefix_list_resolver_request
import capo_ec2.types.delete_ipam_prefix_list_resolver_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_ipam_prefix_list_resolver_result.DeleteIpamPrefixListResolverResult = capo_ec2.types.delete_ipam_prefix_list_resolver_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteIpamPrefixListResolver"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_ipam_prefix_list_resolver_request.serialize_ec2_query(
        input_, pairs, ""
    )
