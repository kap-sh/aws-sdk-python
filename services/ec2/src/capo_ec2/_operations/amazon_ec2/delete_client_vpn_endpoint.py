...
def handle_response(
    ...
    out: capo_ec2.types.delete_client_vpn_endpoint_result.DeleteClientVpnEndpointResult = capo_ec2.types.delete_client_vpn_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_client_vpn_endpoint_request.serialize_ec2_query(
        input_, pairs, ""
    )
