...
import capo_ec2.types.describe_traffic_mirror_filters_request
import capo_ec2.types.describe_traffic_mirror_filters_result
import capo_ec2.types.filter_list
import capo_ec2.types.traffic_mirror_filter_id_list
...
) -> capo_ec2.types.describe_traffic_mirror_filters_result.DescribeTrafficMirrorFiltersResult:
    out: capo_ec2.types.describe_traffic_mirror_filters_result.DescribeTrafficMirrorFiltersResult = capo_ec2.types.describe_traffic_mirror_filters_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeTrafficMirrorFilters"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_traffic_mirror_filters_request.serialize_ec2_query(
        input_, pairs, ""
    )
