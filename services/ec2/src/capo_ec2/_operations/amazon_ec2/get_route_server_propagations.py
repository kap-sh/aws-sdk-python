...
import capo_ec2.types.get_route_server_propagations_request
import capo_ec2.types.get_route_server_propagations_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_route_server_propagations_result.GetRouteServerPropagationsResult = capo_ec2.types.get_route_server_propagations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetRouteServerPropagations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_route_server_propagations_request.serialize_ec2_query(
        input_, pairs, ""
    )
