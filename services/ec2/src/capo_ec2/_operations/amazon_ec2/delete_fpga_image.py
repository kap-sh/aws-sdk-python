...
import capo_ec2.types.delete_fpga_image_request
import capo_ec2.types.delete_fpga_image_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_fpga_image_result.DeleteFpgaImageResult = (
        capo_ec2.types.delete_fpga_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_fpga_image_request.serialize_ec2_query(input_, pairs, "")
...
def delete_fpga_image(
    ...
    capo_ec2.types.delete_fpga_image_result.DeleteFpgaImageResult, zapros.Response
]:
