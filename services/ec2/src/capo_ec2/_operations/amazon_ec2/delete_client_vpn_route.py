...
import capo_ec2.types.delete_client_vpn_route_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_client_vpn_route_result.DeleteClientVpnRouteResult = (
        capo_ec2.types.delete_client_vpn_route_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteClientVpnRoute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_client_vpn_route_request.serialize_ec2_query(
        input_, pairs, ""
    )
