...
import capo_ec2.types.get_managed_prefix_list_entries_request
import capo_ec2.types.get_managed_prefix_list_entries_result
...
) -> capo_ec2.types.get_managed_prefix_list_entries_result.GetManagedPrefixListEntriesResult:
    out: capo_ec2.types.get_managed_prefix_list_entries_result.GetManagedPrefixListEntriesResult = capo_ec2.types.get_managed_prefix_list_entries_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetManagedPrefixListEntries"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_managed_prefix_list_entries_request.serialize_ec2_query(
        input_, pairs, ""
    )
