...
import capo_ec2.types.get_enabled_ipam_policy_request
import capo_ec2.types.get_enabled_ipam_policy_result
...
) -> capo_ec2.types.get_enabled_ipam_policy_result.GetEnabledIpamPolicyResult:
    out: capo_ec2.types.get_enabled_ipam_policy_result.GetEnabledIpamPolicyResult = (
        capo_ec2.types.get_enabled_ipam_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetEnabledIpamPolicy"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_enabled_ipam_policy_request.serialize_ec2_query(
        input_, pairs, ""
    )
