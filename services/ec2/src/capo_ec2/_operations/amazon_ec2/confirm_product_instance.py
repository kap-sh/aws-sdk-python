...
import capo_ec2.types.confirm_product_instance_request
import capo_ec2.types.confirm_product_instance_result
...
def handle_response(
    ...
    out: capo_ec2.types.confirm_product_instance_result.ConfirmProductInstanceResult = (
        capo_ec2.types.confirm_product_instance_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.confirm_product_instance_request.serialize_ec2_query(
        input_, pairs, ""
    )
