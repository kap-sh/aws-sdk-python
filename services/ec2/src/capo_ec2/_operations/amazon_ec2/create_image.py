"""Generated from Smithy shape ``com.amazonaws.ec2#CreateImage``."""
...
def handle_response(
    ...
    out: capo_ec2.types.create_image_result.CreateImageResult = (
        capo_ec2.types.create_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateImage"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_image_request.serialize_ec2_query(input_, pairs, "")
...
def create_image(
    ...
    input_: capo_ec2.types.create_image_request.CreateImageRequest,
) -> tuple[capo_ec2.types.create_image_result.CreateImageResult, zapros.Response]:
