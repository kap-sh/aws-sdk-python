...
import capo_ec2.types.describe_vpc_block_public_access_options_request
import capo_ec2.types.describe_vpc_block_public_access_options_result
...
) -> capo_ec2.types.describe_vpc_block_public_access_options_result.DescribeVpcBlockPublicAccessOptionsResult:
    out: capo_ec2.types.describe_vpc_block_public_access_options_result.DescribeVpcBlockPublicAccessOptionsResult = capo_ec2.types.describe_vpc_block_public_access_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVpcBlockPublicAccessOptions"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_vpc_block_public_access_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
