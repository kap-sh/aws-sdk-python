"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyIpamPrefixListResolver``."""
...
import capo_ec2.types.modify_ipam_prefix_list_resolver_request
import capo_ec2.types.modify_ipam_prefix_list_resolver_result
...
) -> capo_ec2.types.modify_ipam_prefix_list_resolver_result.ModifyIpamPrefixListResolverResult:
    out: capo_ec2.types.modify_ipam_prefix_list_resolver_result.ModifyIpamPrefixListResolverResult = capo_ec2.types.modify_ipam_prefix_list_resolver_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyIpamPrefixListResolver"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_ipam_prefix_list_resolver_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_ipam_prefix_list_resolver(
