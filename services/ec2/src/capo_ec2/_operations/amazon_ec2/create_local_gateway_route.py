...
import capo_ec2.types.create_local_gateway_route_request
import capo_ec2.types.create_local_gateway_route_result
...
) -> capo_ec2.types.create_local_gateway_route_result.CreateLocalGatewayRouteResult:
    out: capo_ec2.types.create_local_gateway_route_result.CreateLocalGatewayRouteResult = capo_ec2.types.create_local_gateway_route_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateLocalGatewayRoute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_local_gateway_route_request.serialize_ec2_query(
        input_, pairs, ""
    )
