"""Generated from Smithy shape ``com.amazonaws.ec2#ListVolumesInRecycleBin``."""
...
import capo_ec2.types.list_volumes_in_recycle_bin_request
import capo_ec2.types.list_volumes_in_recycle_bin_result
...
) -> capo_ec2.types.list_volumes_in_recycle_bin_result.ListVolumesInRecycleBinResult:
    out: capo_ec2.types.list_volumes_in_recycle_bin_result.ListVolumesInRecycleBinResult = capo_ec2.types.list_volumes_in_recycle_bin_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListVolumesInRecycleBin"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.list_volumes_in_recycle_bin_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_list_volumes_in_recycle_bin(
