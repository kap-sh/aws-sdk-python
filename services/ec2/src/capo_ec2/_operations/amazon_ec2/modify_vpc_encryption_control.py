...
import capo_ec2.types.modify_vpc_encryption_control_request
...
def handle_response(
    ...
    capo_ec2.types.modify_vpc_encryption_control_result.ModifyVpcEncryptionControlResult
):
    out: capo_ec2.types.modify_vpc_encryption_control_result.ModifyVpcEncryptionControlResult = capo_ec2.types.modify_vpc_encryption_control_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_vpc_encryption_control_request.serialize_ec2_query(
        input_, pairs, ""
    )
