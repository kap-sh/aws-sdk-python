...
import capo_ec2.types.describe_vpc_endpoint_services_request
import capo_ec2.types.describe_vpc_endpoint_services_result
...
) -> capo_ec2.types.describe_vpc_endpoint_services_result.DescribeVpcEndpointServicesResult:
    out: capo_ec2.types.describe_vpc_endpoint_services_result.DescribeVpcEndpointServicesResult = capo_ec2.types.describe_vpc_endpoint_services_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_vpc_endpoint_services_request.serialize_ec2_query(
        input_, pairs, ""
    )
