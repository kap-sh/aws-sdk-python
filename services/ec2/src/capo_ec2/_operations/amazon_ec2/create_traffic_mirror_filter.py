...
import capo_ec2.types.create_traffic_mirror_filter_request
import capo_ec2.types.create_traffic_mirror_filter_result
...
) -> capo_ec2.types.create_traffic_mirror_filter_result.CreateTrafficMirrorFilterResult:
    out: capo_ec2.types.create_traffic_mirror_filter_result.CreateTrafficMirrorFilterResult = capo_ec2.types.create_traffic_mirror_filter_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateTrafficMirrorFilter"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_traffic_mirror_filter_request.serialize_ec2_query(
        input_, pairs, ""
    )
