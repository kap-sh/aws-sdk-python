...
import capo_ec2.types.get_managed_prefix_list_associations_request
import capo_ec2.types.get_managed_prefix_list_associations_result
...
) -> capo_ec2.types.get_managed_prefix_list_associations_result.GetManagedPrefixListAssociationsResult:
    out: capo_ec2.types.get_managed_prefix_list_associations_result.GetManagedPrefixListAssociationsResult = capo_ec2.types.get_managed_prefix_list_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetManagedPrefixListAssociations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_managed_prefix_list_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
