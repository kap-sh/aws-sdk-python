...
import capo_ec2.types.delete_fleets_request
import capo_ec2.types.delete_fleets_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_fleets_result.DeleteFleetsResult = (
        capo_ec2.types.delete_fleets_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_fleets_request.serialize_ec2_query(input_, pairs, "")
...
def delete_fleets(
    ...
    input_: capo_ec2.types.delete_fleets_request.DeleteFleetsRequest,
) -> tuple[capo_ec2.types.delete_fleets_result.DeleteFleetsResult, zapros.Response]:
