...
import capo_ec2.types.delete_launch_template_request
import capo_ec2.types.delete_launch_template_result
...
) -> capo_ec2.types.delete_launch_template_result.DeleteLaunchTemplateResult:
    out: capo_ec2.types.delete_launch_template_result.DeleteLaunchTemplateResult = (
        capo_ec2.types.delete_launch_template_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteLaunchTemplate"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_launch_template_request.serialize_ec2_query(input_, pairs, "")
