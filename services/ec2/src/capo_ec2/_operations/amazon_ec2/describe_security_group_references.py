...
import capo_ec2.types.describe_security_group_references_request
import capo_ec2.types.describe_security_group_references_result
...
def handle_response(
    ...
    out: capo_ec2.types.describe_security_group_references_result.DescribeSecurityGroupReferencesResult = capo_ec2.types.describe_security_group_references_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_security_group_references_request.serialize_ec2_query(
        input_, pairs, ""
    )
