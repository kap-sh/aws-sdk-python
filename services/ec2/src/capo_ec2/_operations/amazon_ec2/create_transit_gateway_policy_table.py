"""Generated from Smithy shape ``com.amazonaws.ec2#CreateTransitGatewayPolicyTable``."""
...
) -> capo_ec2.types.create_transit_gateway_policy_table_result.CreateTransitGatewayPolicyTableResult:
    out: capo_ec2.types.create_transit_gateway_policy_table_result.CreateTransitGatewayPolicyTableResult = capo_ec2.types.create_transit_gateway_policy_table_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateTransitGatewayPolicyTable"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_transit_gateway_policy_table_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_create_transit_gateway_policy_table(
