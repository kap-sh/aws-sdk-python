...
import capo_ec2.types.delete_transit_gateway_route_table_announcement_request
import capo_ec2.types.delete_transit_gateway_route_table_announcement_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_transit_gateway_route_table_announcement_result.DeleteTransitGatewayRouteTableAnnouncementResult = capo_ec2.types.delete_transit_gateway_route_table_announcement_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_transit_gateway_route_table_announcement_request.serialize_ec2_query(
        input_, pairs, ""
    )
