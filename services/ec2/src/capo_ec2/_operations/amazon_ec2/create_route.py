...
import capo_ec2.types.create_route_request
import capo_ec2.types.create_route_result
...
) -> capo_ec2.types.create_route_result.CreateRouteResult:
    out: capo_ec2.types.create_route_result.CreateRouteResult = (
        capo_ec2.types.create_route_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_route_request.serialize_ec2_query(input_, pairs, "")
...
def create_route(
    ...
    input_: capo_ec2.types.create_route_request.CreateRouteRequest,
) -> tuple[capo_ec2.types.create_route_result.CreateRouteResult, zapros.Response]:
