...
import capo_ec2.types.import_key_pair_request
import capo_ec2.types.import_key_pair_result
...
def handle_response(
    ...
    out: capo_ec2.types.import_key_pair_result.ImportKeyPairResult = (
        capo_ec2.types.import_key_pair_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ImportKeyPair"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.import_key_pair_request.serialize_ec2_query(input_, pairs, "")
...
def import_key_pair(
    ...
    input_: capo_ec2.types.import_key_pair_request.ImportKeyPairRequest,
) -> tuple[capo_ec2.types.import_key_pair_result.ImportKeyPairResult, zapros.Response]:
