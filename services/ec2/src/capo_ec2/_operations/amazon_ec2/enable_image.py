...
import capo_ec2.types.enable_image_request
...
def handle_response(
    ...
    out: capo_ec2.types.enable_image_result.EnableImageResult = (
        capo_ec2.types.enable_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.enable_image_request.serialize_ec2_query(input_, pairs, "")
...
def enable_image(
    ...
    input_: capo_ec2.types.enable_image_request.EnableImageRequest,
) -> tuple[capo_ec2.types.enable_image_result.EnableImageResult, zapros.Response]:
