...
import capo_ec2.types.accept_vpc_endpoint_connections_request
import capo_ec2.types.accept_vpc_endpoint_connections_result
...
def handle_response(
    ...
    out: capo_ec2.types.accept_vpc_endpoint_connections_result.AcceptVpcEndpointConnectionsResult = capo_ec2.types.accept_vpc_endpoint_connections_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.accept_vpc_endpoint_connections_request.serialize_ec2_query(
        input_, pairs, ""
    )
