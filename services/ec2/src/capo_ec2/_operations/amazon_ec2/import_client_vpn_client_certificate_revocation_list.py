...
def handle_response(
    ...
    out: capo_ec2.types.import_client_vpn_client_certificate_revocation_list_result.ImportClientVpnClientCertificateRevocationListResult = capo_ec2.types.import_client_vpn_client_certificate_revocation_list_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.import_client_vpn_client_certificate_revocation_list_request.serialize_ec2_query(
        input_, pairs, ""
    )
