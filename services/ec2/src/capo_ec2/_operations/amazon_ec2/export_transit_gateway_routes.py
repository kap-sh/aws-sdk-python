...
import capo_ec2.types.export_transit_gateway_routes_request
import capo_ec2.types.export_transit_gateway_routes_result
...
def handle_response(
    ...
    out: capo_ec2.types.export_transit_gateway_routes_result.ExportTransitGatewayRoutesResult = capo_ec2.types.export_transit_gateway_routes_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.export_transit_gateway_routes_request.serialize_ec2_query(
        input_, pairs, ""
    )
