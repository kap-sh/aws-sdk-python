...
import capo_ec2.types.create_public_ipv4_pool_request
import capo_ec2.types.create_public_ipv4_pool_result
...
) -> capo_ec2.types.create_public_ipv4_pool_result.CreatePublicIpv4PoolResult:
    out: capo_ec2.types.create_public_ipv4_pool_result.CreatePublicIpv4PoolResult = (
        capo_ec2.types.create_public_ipv4_pool_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreatePublicIpv4Pool"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_public_ipv4_pool_request.serialize_ec2_query(
        input_, pairs, ""
    )
