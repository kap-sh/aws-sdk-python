...
import capo_ec2.types.monitor_instances_request
import capo_ec2.types.monitor_instances_result
...
def handle_response(
    ...
    out: capo_ec2.types.monitor_instances_result.MonitorInstancesResult = (
        capo_ec2.types.monitor_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.monitor_instances_request.serialize_ec2_query(input_, pairs, "")
...
def monitor_instances(
    ...
    capo_ec2.types.monitor_instances_result.MonitorInstancesResult, zapros.Response
]:
