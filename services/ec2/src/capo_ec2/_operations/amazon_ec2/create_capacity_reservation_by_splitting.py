...
) -> capo_ec2.types.create_capacity_reservation_by_splitting_result.CreateCapacityReservationBySplittingResult:
    out: capo_ec2.types.create_capacity_reservation_by_splitting_result.CreateCapacityReservationBySplittingResult = capo_ec2.types.create_capacity_reservation_by_splitting_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateCapacityReservationBySplitting"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_capacity_reservation_by_splitting_request.serialize_ec2_query(
        input_, pairs, ""
    )
