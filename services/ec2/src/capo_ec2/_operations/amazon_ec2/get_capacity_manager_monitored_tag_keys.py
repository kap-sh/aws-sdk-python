...
import capo_ec2.types.get_capacity_manager_monitored_tag_keys_request
import capo_ec2.types.get_capacity_manager_monitored_tag_keys_result
...
) -> capo_ec2.types.get_capacity_manager_monitored_tag_keys_result.GetCapacityManagerMonitoredTagKeysResult:
    out: capo_ec2.types.get_capacity_manager_monitored_tag_keys_result.GetCapacityManagerMonitoredTagKeysResult = capo_ec2.types.get_capacity_manager_monitored_tag_keys_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetCapacityManagerMonitoredTagKeys"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_capacity_manager_monitored_tag_keys_request.serialize_ec2_query(
        input_, pairs, ""
    )
