...
import capo_ec2.types.associate_trunk_interface_request
import capo_ec2.types.associate_trunk_interface_result
...
) -> capo_ec2.types.associate_trunk_interface_result.AssociateTrunkInterfaceResult:
    out: capo_ec2.types.associate_trunk_interface_result.AssociateTrunkInterfaceResult = capo_ec2.types.associate_trunk_interface_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AssociateTrunkInterface"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.associate_trunk_interface_request.serialize_ec2_query(
        input_, pairs, ""
    )
