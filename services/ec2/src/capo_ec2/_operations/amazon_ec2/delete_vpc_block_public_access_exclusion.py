...
import capo_ec2.types.delete_vpc_block_public_access_exclusion_request
import capo_ec2.types.delete_vpc_block_public_access_exclusion_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_vpc_block_public_access_exclusion_result.DeleteVpcBlockPublicAccessExclusionResult = capo_ec2.types.delete_vpc_block_public_access_exclusion_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteVpcBlockPublicAccessExclusion"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_vpc_block_public_access_exclusion_request.serialize_ec2_query(
        input_, pairs, ""
    )
