...
import capo_ec2.types.reject_transit_gateway_client_vpn_attachment_request
import capo_ec2.types.reject_transit_gateway_client_vpn_attachment_result
...
def handle_response(
    ...
    out: capo_ec2.types.reject_transit_gateway_client_vpn_attachment_result.RejectTransitGatewayClientVpnAttachmentResult = capo_ec2.types.reject_transit_gateway_client_vpn_attachment_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "RejectTransitGatewayClientVpnAttachment"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.reject_transit_gateway_client_vpn_attachment_request.serialize_ec2_query(
        input_, pairs, ""
    )
