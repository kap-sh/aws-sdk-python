...
import capo_ec2.types.deregister_instance_event_notification_attributes_request
import capo_ec2.types.deregister_instance_event_notification_attributes_result
...
def handle_response(
    ...
    out: capo_ec2.types.deregister_instance_event_notification_attributes_result.DeregisterInstanceEventNotificationAttributesResult = capo_ec2.types.deregister_instance_event_notification_attributes_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeregisterInstanceEventNotificationAttributes"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.deregister_instance_event_notification_attributes_request.serialize_ec2_query(
        input_, pairs, ""
    )
