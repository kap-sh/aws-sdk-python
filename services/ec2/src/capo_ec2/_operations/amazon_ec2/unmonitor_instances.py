...
import capo_ec2.types.unmonitor_instances_request
import capo_ec2.types.unmonitor_instances_result
...
def handle_response(
    ...
    out: capo_ec2.types.unmonitor_instances_result.UnmonitorInstancesResult = (
        capo_ec2.types.unmonitor_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "UnmonitorInstances"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.unmonitor_instances_request.serialize_ec2_query(input_, pairs, "")
...
def unmonitor_instances(
    ...
    capo_ec2.types.unmonitor_instances_result.UnmonitorInstancesResult, zapros.Response
]:
