...
import capo_ec2.types.create_instance_export_task_request
import capo_ec2.types.create_instance_export_task_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_instance_export_task_result.CreateInstanceExportTaskResult = capo_ec2.types.create_instance_export_task_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_instance_export_task_request.serialize_ec2_query(
        input_, pairs, ""
    )
