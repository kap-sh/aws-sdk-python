"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyAccountVpcEncryptionControl``."""
...
def handle_response(
    ...
    out: capo_ec2.types.modify_account_vpc_encryption_control_result.ModifyAccountVpcEncryptionControlResult = capo_ec2.types.modify_account_vpc_encryption_control_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyAccountVpcEncryptionControl"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_account_vpc_encryption_control_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_account_vpc_encryption_control(
