...
import capo_ec2.types.create_transit_gateway_connect_request
import capo_ec2.types.create_transit_gateway_connect_request_options
import capo_ec2.types.create_transit_gateway_connect_result
...
) -> capo_ec2.types.create_transit_gateway_connect_result.CreateTransitGatewayConnectResult:
    out: capo_ec2.types.create_transit_gateway_connect_result.CreateTransitGatewayConnectResult = capo_ec2.types.create_transit_gateway_connect_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateTransitGatewayConnect"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_transit_gateway_connect_request.serialize_ec2_query(
        input_, pairs, ""
    )
