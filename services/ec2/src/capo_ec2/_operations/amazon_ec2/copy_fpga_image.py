...
import capo_ec2.types.copy_fpga_image_request
import capo_ec2.types.copy_fpga_image_result
...
def handle_response(
    ...
    out: capo_ec2.types.copy_fpga_image_result.CopyFpgaImageResult = (
        capo_ec2.types.copy_fpga_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.copy_fpga_image_request.serialize_ec2_query(input_, pairs, "")
...
def copy_fpga_image(
    ...
    input_: capo_ec2.types.copy_fpga_image_request.CopyFpgaImageRequest,
) -> tuple[capo_ec2.types.copy_fpga_image_result.CopyFpgaImageResult, zapros.Response]:
