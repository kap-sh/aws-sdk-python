"""Generated from Smithy shape ``com.amazonaws.ec2#DisableCapacityManager``."""
...
import capo_ec2.types.disable_capacity_manager_result
...
) -> capo_ec2.types.disable_capacity_manager_result.DisableCapacityManagerResult:
    out: capo_ec2.types.disable_capacity_manager_result.DisableCapacityManagerResult = (
        capo_ec2.types.disable_capacity_manager_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableCapacityManager"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disable_capacity_manager_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_disable_capacity_manager(
