...
import capo_ec2.types.export_client_vpn_client_certificate_revocation_list_request
import capo_ec2.types.export_client_vpn_client_certificate_revocation_list_result
...
def handle_response(
    ...
    out: capo_ec2.types.export_client_vpn_client_certificate_revocation_list_result.ExportClientVpnClientCertificateRevocationListResult = capo_ec2.types.export_client_vpn_client_certificate_revocation_list_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ExportClientVpnClientCertificateRevocationList"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.export_client_vpn_client_certificate_revocation_list_request.serialize_ec2_query(
        input_, pairs, ""
    )
