...
import capo_ec2.types.purchase_host_reservation_request
import capo_ec2.types.purchase_host_reservation_result
...
) -> capo_ec2.types.purchase_host_reservation_result.PurchaseHostReservationResult:
    out: capo_ec2.types.purchase_host_reservation_result.PurchaseHostReservationResult = capo_ec2.types.purchase_host_reservation_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "PurchaseHostReservation"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.purchase_host_reservation_request.serialize_ec2_query(
        input_, pairs, ""
    )
