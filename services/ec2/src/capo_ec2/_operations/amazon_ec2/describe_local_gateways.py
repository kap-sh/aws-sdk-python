...
import capo_ec2.types.describe_local_gateways_request
import capo_ec2.types.describe_local_gateways_result
...
) -> capo_ec2.types.describe_local_gateways_result.DescribeLocalGatewaysResult:
    out: capo_ec2.types.describe_local_gateways_result.DescribeLocalGatewaysResult = (
        capo_ec2.types.describe_local_gateways_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_local_gateways_request.serialize_ec2_query(
        input_, pairs, ""
    )
