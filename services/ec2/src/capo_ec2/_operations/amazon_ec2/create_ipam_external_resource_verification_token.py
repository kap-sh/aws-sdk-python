...
) -> capo_ec2.types.create_ipam_external_resource_verification_token_result.CreateIpamExternalResourceVerificationTokenResult:
    out: capo_ec2.types.create_ipam_external_resource_verification_token_result.CreateIpamExternalResourceVerificationTokenResult = capo_ec2.types.create_ipam_external_resource_verification_token_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateIpamExternalResourceVerificationToken"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_ipam_external_resource_verification_token_request.serialize_ec2_query(
        input_, pairs, ""
    )
