...
) -> capo_ec2.types.describe_declarative_policies_reports_result.DescribeDeclarativePoliciesReportsResult:
    out: capo_ec2.types.describe_declarative_policies_reports_result.DescribeDeclarativePoliciesReportsResult = capo_ec2.types.describe_declarative_policies_reports_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_declarative_policies_reports_request.serialize_ec2_query(
        input_, pairs, ""
    )
