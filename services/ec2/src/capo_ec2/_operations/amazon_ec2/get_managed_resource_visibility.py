...
import capo_ec2.types.get_managed_resource_visibility_request
import capo_ec2.types.get_managed_resource_visibility_result
...
) -> capo_ec2.types.get_managed_resource_visibility_result.GetManagedResourceVisibilityResult:
    out: capo_ec2.types.get_managed_resource_visibility_result.GetManagedResourceVisibilityResult = capo_ec2.types.get_managed_resource_visibility_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetManagedResourceVisibility"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_managed_resource_visibility_request.serialize_ec2_query(
        input_, pairs, ""
    )
