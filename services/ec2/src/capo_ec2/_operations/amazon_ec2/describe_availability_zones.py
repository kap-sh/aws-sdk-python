...
) -> capo_ec2.types.describe_availability_zones_result.DescribeAvailabilityZonesResult:
    out: capo_ec2.types.describe_availability_zones_result.DescribeAvailabilityZonesResult = capo_ec2.types.describe_availability_zones_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_availability_zones_request.serialize_ec2_query(
        input_, pairs, ""
    )
