...
import capo_ec2.types.describe_instance_sql_ha_history_states_request
import capo_ec2.types.describe_instance_sql_ha_history_states_result
...
) -> capo_ec2.types.describe_instance_sql_ha_history_states_result.DescribeInstanceSqlHaHistoryStatesResult:
    out: capo_ec2.types.describe_instance_sql_ha_history_states_result.DescribeInstanceSqlHaHistoryStatesResult = capo_ec2.types.describe_instance_sql_ha_history_states_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeInstanceSqlHaHistoryStates"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_instance_sql_ha_history_states_request.serialize_ec2_query(
        input_, pairs, ""
    )
