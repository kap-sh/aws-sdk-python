...
import capo_ec2.types.cancel_conversion_request
...
def build_request(
    ...
    pairs.append(("Action", "CancelConversionTask"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.cancel_conversion_request.serialize_ec2_query(input_, pairs, "")
