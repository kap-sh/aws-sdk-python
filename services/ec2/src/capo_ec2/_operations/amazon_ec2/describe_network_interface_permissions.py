...
import capo_ec2.types.describe_network_interface_permissions_request
import capo_ec2.types.describe_network_interface_permissions_result
...
) -> capo_ec2.types.describe_network_interface_permissions_result.DescribeNetworkInterfacePermissionsResult:
    out: capo_ec2.types.describe_network_interface_permissions_result.DescribeNetworkInterfacePermissionsResult = capo_ec2.types.describe_network_interface_permissions_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_network_interface_permissions_request.serialize_ec2_query(
        input_, pairs, ""
    )
