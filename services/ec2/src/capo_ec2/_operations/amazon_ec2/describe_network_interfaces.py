...
import capo_ec2.types.describe_network_interfaces_request
import capo_ec2.types.describe_network_interfaces_result
...
) -> capo_ec2.types.describe_network_interfaces_result.DescribeNetworkInterfacesResult:
    out: capo_ec2.types.describe_network_interfaces_result.DescribeNetworkInterfacesResult = capo_ec2.types.describe_network_interfaces_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_network_interfaces_request.serialize_ec2_query(
        input_, pairs, ""
    )
