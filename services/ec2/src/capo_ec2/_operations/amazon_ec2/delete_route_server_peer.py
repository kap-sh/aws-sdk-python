...
import capo_ec2.types.delete_route_server_peer_request
import capo_ec2.types.delete_route_server_peer_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_route_server_peer_result.DeleteRouteServerPeerResult = (
        capo_ec2.types.delete_route_server_peer_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteRouteServerPeer"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_route_server_peer_request.serialize_ec2_query(
        input_, pairs, ""
    )
