...
def handle_response(
    ...
    out: capo_ec2.types.modify_availability_zone_group_result.ModifyAvailabilityZoneGroupResult = capo_ec2.types.modify_availability_zone_group_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyAvailabilityZoneGroup"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_availability_zone_group_request.serialize_ec2_query(
        input_, pairs, ""
    )
