...
import capo_ec2.types.register_transit_gateway_multicast_group_members_request
import capo_ec2.types.register_transit_gateway_multicast_group_members_result
import capo_ec2.types.transit_gateway_multicast_registered_group_members
...
def handle_response(
    ...
    out: capo_ec2.types.register_transit_gateway_multicast_group_members_result.RegisterTransitGatewayMulticastGroupMembersResult = capo_ec2.types.register_transit_gateway_multicast_group_members_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "RegisterTransitGatewayMulticastGroupMembers"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.register_transit_gateway_multicast_group_members_request.serialize_ec2_query(
        input_, pairs, ""
    )
