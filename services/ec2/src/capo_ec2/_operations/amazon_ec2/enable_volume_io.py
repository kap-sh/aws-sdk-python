...
import capo_ec2.types.enable_volume_io_request
...
def build_request(
    ...
    pairs.append(("Action", "EnableVolumeIO"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.enable_volume_io_request.serialize_ec2_query(input_, pairs, "")
