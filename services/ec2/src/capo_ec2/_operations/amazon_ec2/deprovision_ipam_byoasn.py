...
import capo_ec2.types.deprovision_ipam_byoasn_request
import capo_ec2.types.deprovision_ipam_byoasn_result
...
def handle_response(
    ...
    out: capo_ec2.types.deprovision_ipam_byoasn_result.DeprovisionIpamByoasnResult = (
        capo_ec2.types.deprovision_ipam_byoasn_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeprovisionIpamByoasn"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.deprovision_ipam_byoasn_request.serialize_ec2_query(
        input_, pairs, ""
    )
