"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyIpamRoutingPolicyRegistration``."""
...
def handle_response(
    ...
    out: capo_ec2.types.modify_ipam_routing_policy_registration_result.ModifyIpamRoutingPolicyRegistrationResult = capo_ec2.types.modify_ipam_routing_policy_registration_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyIpamRoutingPolicyRegistration"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_ipam_routing_policy_registration_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_ipam_routing_policy_registration(
