"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteIpamInternetRegistryAssociation``."""
...
def handle_response(
    ...
    out: capo_ec2.types.delete_ipam_internet_registry_association_result.DeleteIpamInternetRegistryAssociationResult = capo_ec2.types.delete_ipam_internet_registry_association_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteIpamInternetRegistryAssociation"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_ipam_internet_registry_association_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_ipam_internet_registry_association(
