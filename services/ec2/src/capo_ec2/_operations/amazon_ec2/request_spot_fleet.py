...
import capo_ec2.types.request_spot_fleet_request
import capo_ec2.types.request_spot_fleet_response
...
def handle_response(
    ...
    out: capo_ec2.types.request_spot_fleet_response.RequestSpotFleetResponse = (
        capo_ec2.types.request_spot_fleet_response.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "RequestSpotFleet"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.request_spot_fleet_request.serialize_ec2_query(input_, pairs, "")
...
def request_spot_fleet(
    ...
    capo_ec2.types.request_spot_fleet_response.RequestSpotFleetResponse, zapros.Response
]:
