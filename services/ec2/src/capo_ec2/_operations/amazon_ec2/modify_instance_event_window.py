...
import capo_ec2.types.modify_instance_event_window_request
import capo_ec2.types.modify_instance_event_window_result
...
) -> capo_ec2.types.modify_instance_event_window_result.ModifyInstanceEventWindowResult:
    out: capo_ec2.types.modify_instance_event_window_result.ModifyInstanceEventWindowResult = capo_ec2.types.modify_instance_event_window_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyInstanceEventWindow"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_instance_event_window_request.serialize_ec2_query(
        input_, pairs, ""
    )
