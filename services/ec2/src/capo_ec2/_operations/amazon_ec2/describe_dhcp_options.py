...
) -> capo_ec2.types.describe_dhcp_options_result.DescribeDhcpOptionsResult:
    out: capo_ec2.types.describe_dhcp_options_result.DescribeDhcpOptionsResult = (
        capo_ec2.types.describe_dhcp_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeDhcpOptions"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_dhcp_options_request.serialize_ec2_query(input_, pairs, "")
