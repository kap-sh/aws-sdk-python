...
def handle_response(
    ...
    out: capo_ec2.types.get_capacity_reservation_usage_result.GetCapacityReservationUsageResult = capo_ec2.types.get_capacity_reservation_usage_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetCapacityReservationUsage"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_capacity_reservation_usage_request.serialize_ec2_query(
        input_, pairs, ""
    )
