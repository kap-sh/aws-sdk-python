...
import capo_ec2.types.describe_vpc_encryption_controls_request
import capo_ec2.types.describe_vpc_encryption_controls_result
...
) -> capo_ec2.types.describe_vpc_encryption_controls_result.DescribeVpcEncryptionControlsResult:
    out: capo_ec2.types.describe_vpc_encryption_controls_result.DescribeVpcEncryptionControlsResult = capo_ec2.types.describe_vpc_encryption_controls_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_vpc_encryption_controls_request.serialize_ec2_query(
        input_, pairs, ""
    )
