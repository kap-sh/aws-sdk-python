...
import capo_ec2.types.disable_transit_gateway_route_table_propagation_request
import capo_ec2.types.disable_transit_gateway_route_table_propagation_result
...
) -> capo_ec2.types.disable_transit_gateway_route_table_propagation_result.DisableTransitGatewayRouteTablePropagationResult:
    out: capo_ec2.types.disable_transit_gateway_route_table_propagation_result.DisableTransitGatewayRouteTablePropagationResult = capo_ec2.types.disable_transit_gateway_route_table_propagation_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableTransitGatewayRouteTablePropagation"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disable_transit_gateway_route_table_propagation_request.serialize_ec2_query(
        input_, pairs, ""
    )
