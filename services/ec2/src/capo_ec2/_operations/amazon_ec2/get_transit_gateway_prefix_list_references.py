...
import capo_ec2.types.get_transit_gateway_prefix_list_references_request
import capo_ec2.types.get_transit_gateway_prefix_list_references_result
...
) -> capo_ec2.types.get_transit_gateway_prefix_list_references_result.GetTransitGatewayPrefixListReferencesResult:
    out: capo_ec2.types.get_transit_gateway_prefix_list_references_result.GetTransitGatewayPrefixListReferencesResult = capo_ec2.types.get_transit_gateway_prefix_list_references_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_transit_gateway_prefix_list_references_request.serialize_ec2_query(
        input_, pairs, ""
    )
