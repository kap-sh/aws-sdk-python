...
import capo_ec2.types.get_groups_for_capacity_reservation_request
import capo_ec2.types.get_groups_for_capacity_reservation_result
...
) -> capo_ec2.types.get_groups_for_capacity_reservation_result.GetGroupsForCapacityReservationResult:
    out: capo_ec2.types.get_groups_for_capacity_reservation_result.GetGroupsForCapacityReservationResult = capo_ec2.types.get_groups_for_capacity_reservation_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetGroupsForCapacityReservation"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_groups_for_capacity_reservation_request.serialize_ec2_query(
        input_, pairs, ""
    )
