...
import capo_ec2.types.modify_transit_gateway_result
...
) -> capo_ec2.types.modify_transit_gateway_result.ModifyTransitGatewayResult:
    out: capo_ec2.types.modify_transit_gateway_result.ModifyTransitGatewayResult = (
        capo_ec2.types.modify_transit_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_transit_gateway_request.serialize_ec2_query(input_, pairs, "")
