...
import capo_ec2.types.describe_iam_instance_profile_associations_request
import capo_ec2.types.describe_iam_instance_profile_associations_result
...
) -> capo_ec2.types.describe_iam_instance_profile_associations_result.DescribeIamInstanceProfileAssociationsResult:
    out: capo_ec2.types.describe_iam_instance_profile_associations_result.DescribeIamInstanceProfileAssociationsResult = capo_ec2.types.describe_iam_instance_profile_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeIamInstanceProfileAssociations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_iam_instance_profile_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
