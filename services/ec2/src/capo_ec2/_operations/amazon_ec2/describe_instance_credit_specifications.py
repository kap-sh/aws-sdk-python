...
import capo_ec2.types.describe_instance_credit_specifications_request
import capo_ec2.types.describe_instance_credit_specifications_result
...
def handle_response(
    ...
    out: capo_ec2.types.describe_instance_credit_specifications_result.DescribeInstanceCreditSpecificationsResult = capo_ec2.types.describe_instance_credit_specifications_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeInstanceCreditSpecifications"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_instance_credit_specifications_request.serialize_ec2_query(
        input_, pairs, ""
    )
