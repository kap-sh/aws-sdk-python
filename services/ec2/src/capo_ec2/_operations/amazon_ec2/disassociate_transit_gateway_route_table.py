...
import capo_ec2.types.disassociate_transit_gateway_route_table_request
import capo_ec2.types.disassociate_transit_gateway_route_table_result
...
def handle_response(
    ...
    out: capo_ec2.types.disassociate_transit_gateway_route_table_result.DisassociateTransitGatewayRouteTableResult = capo_ec2.types.disassociate_transit_gateway_route_table_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.disassociate_transit_gateway_route_table_request.serialize_ec2_query(
        input_, pairs, ""
    )
