"""Generated from Smithy shape ``com.amazonaws.ec2#CreateSubnet``."""
...
import capo_ec2.types.create_subnet_request
import capo_ec2.types.create_subnet_result
...
) -> capo_ec2.types.create_subnet_result.CreateSubnetResult:
    out: capo_ec2.types.create_subnet_result.CreateSubnetResult = (
        capo_ec2.types.create_subnet_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateSubnet"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_subnet_request.serialize_ec2_query(input_, pairs, "")
...
def create_subnet(
    ...
    input_: capo_ec2.types.create_subnet_request.CreateSubnetRequest,
) -> tuple[capo_ec2.types.create_subnet_result.CreateSubnetResult, zapros.Response]:
