...
import capo_ec2.types.get_default_credit_specification_request
import capo_ec2.types.get_default_credit_specification_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_default_credit_specification_result.GetDefaultCreditSpecificationResult = capo_ec2.types.get_default_credit_specification_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetDefaultCreditSpecification"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_default_credit_specification_request.serialize_ec2_query(
        input_, pairs, ""
    )
