...
import capo_ec2.types.modify_instance_capacity_reservation_attributes_request
import capo_ec2.types.modify_instance_capacity_reservation_attributes_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_instance_capacity_reservation_attributes_result.ModifyInstanceCapacityReservationAttributesResult = capo_ec2.types.modify_instance_capacity_reservation_attributes_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyInstanceCapacityReservationAttributes"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_instance_capacity_reservation_attributes_request.serialize_ec2_query(
        input_, pairs, ""
    )
