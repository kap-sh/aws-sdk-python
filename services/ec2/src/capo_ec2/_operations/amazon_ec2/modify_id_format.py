...
import capo_ec2.types.modify_id_format_request
...
def build_request(
    ...
    pairs.append(("Action", "ModifyIdFormat"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_id_format_request.serialize_ec2_query(input_, pairs, "")
