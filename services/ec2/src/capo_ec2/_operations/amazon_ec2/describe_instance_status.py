...
import capo_ec2.types.describe_instance_status_request
import capo_ec2.types.describe_instance_status_result
...
def handle_response(
    ...
    out: capo_ec2.types.describe_instance_status_result.DescribeInstanceStatusResult = (
        capo_ec2.types.describe_instance_status_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_instance_status_request.serialize_ec2_query(
        input_, pairs, ""
    )
