...
import capo_ec2.types.describe_secondary_subnets_request
import capo_ec2.types.describe_secondary_subnets_result
...
) -> capo_ec2.types.describe_secondary_subnets_result.DescribeSecondarySubnetsResult:
    out: capo_ec2.types.describe_secondary_subnets_result.DescribeSecondarySubnetsResult = capo_ec2.types.describe_secondary_subnets_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeSecondarySubnets"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_secondary_subnets_request.serialize_ec2_query(
        input_, pairs, ""
    )
