...
import capo_ec2.types.enable_ipam_policy_result
...
def handle_response(
    ...
    out: capo_ec2.types.enable_ipam_policy_result.EnableIpamPolicyResult = (
        capo_ec2.types.enable_ipam_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "EnableIpamPolicy"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.enable_ipam_policy_request.serialize_ec2_query(input_, pairs, "")
...
def enable_ipam_policy(
    ...
    capo_ec2.types.enable_ipam_policy_result.EnableIpamPolicyResult, zapros.Response
]:
