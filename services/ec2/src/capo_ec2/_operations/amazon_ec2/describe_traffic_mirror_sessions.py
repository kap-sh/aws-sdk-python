...
import capo_ec2.types.describe_traffic_mirror_sessions_request
import capo_ec2.types.describe_traffic_mirror_sessions_result
...
) -> capo_ec2.types.describe_traffic_mirror_sessions_result.DescribeTrafficMirrorSessionsResult:
    out: capo_ec2.types.describe_traffic_mirror_sessions_result.DescribeTrafficMirrorSessionsResult = capo_ec2.types.describe_traffic_mirror_sessions_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_traffic_mirror_sessions_request.serialize_ec2_query(
        input_, pairs, ""
    )
