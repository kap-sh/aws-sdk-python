...
import capo_ec2.types.describe_coip_pools_request
import capo_ec2.types.describe_coip_pools_result
...
) -> capo_ec2.types.describe_coip_pools_result.DescribeCoipPoolsResult:
    out: capo_ec2.types.describe_coip_pools_result.DescribeCoipPoolsResult = (
        capo_ec2.types.describe_coip_pools_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeCoipPools"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_coip_pools_request.serialize_ec2_query(input_, pairs, "")
...
def describe_coip_pools(
    ...
    capo_ec2.types.describe_coip_pools_result.DescribeCoipPoolsResult, zapros.Response
]:
