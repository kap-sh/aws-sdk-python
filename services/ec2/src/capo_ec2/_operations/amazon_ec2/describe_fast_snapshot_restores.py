"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeFastSnapshotRestores``."""
...
import capo_ec2.types.describe_fast_snapshot_restores_request
import capo_ec2.types.describe_fast_snapshot_restores_result
...
) -> capo_ec2.types.describe_fast_snapshot_restores_result.DescribeFastSnapshotRestoresResult:
    out: capo_ec2.types.describe_fast_snapshot_restores_result.DescribeFastSnapshotRestoresResult = capo_ec2.types.describe_fast_snapshot_restores_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeFastSnapshotRestores"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_fast_snapshot_restores_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_fast_snapshot_restores(
