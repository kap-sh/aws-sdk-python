...
import capo_ec2.types.disable_fast_launch_request
import capo_ec2.types.disable_fast_launch_result
...
def handle_response(
    ...
    out: capo_ec2.types.disable_fast_launch_result.DisableFastLaunchResult = (
        capo_ec2.types.disable_fast_launch_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableFastLaunch"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disable_fast_launch_request.serialize_ec2_query(input_, pairs, "")
...
def disable_fast_launch(
    ...
    capo_ec2.types.disable_fast_launch_result.DisableFastLaunchResult, zapros.Response
]:
