...
import capo_ec2.types.reboot_instances_request
...
def build_request(
    ...
    pairs.append(("Action", "RebootInstances"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.reboot_instances_request.serialize_ec2_query(input_, pairs, "")
