...
import capo_ec2.types.describe_byoip_cidrs_request
import capo_ec2.types.describe_byoip_cidrs_result
...
def handle_response(
    ...
    out: capo_ec2.types.describe_byoip_cidrs_result.DescribeByoipCidrsResult = (
        capo_ec2.types.describe_byoip_cidrs_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeByoipCidrs"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_byoip_cidrs_request.serialize_ec2_query(input_, pairs, "")
...
def describe_byoip_cidrs(
    ...
    capo_ec2.types.describe_byoip_cidrs_result.DescribeByoipCidrsResult, zapros.Response
]:
