...
def handle_response(
    ...
    out: capo_ec2.types.attach_network_interface_result.AttachNetworkInterfaceResult = (
        capo_ec2.types.attach_network_interface_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.attach_network_interface_request.serialize_ec2_query(
        input_, pairs, ""
    )
