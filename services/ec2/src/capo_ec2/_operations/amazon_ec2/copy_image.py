...
import capo_ec2.types.copy_image_request
import capo_ec2.types.copy_image_result
...
) -> capo_ec2.types.copy_image_result.CopyImageResult:
    out: capo_ec2.types.copy_image_result.CopyImageResult = (
        capo_ec2.types.copy_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CopyImage"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.copy_image_request.serialize_ec2_query(input_, pairs, "")
...
def copy_image(
    ...
    input_: capo_ec2.types.copy_image_request.CopyImageRequest,
) -> tuple[capo_ec2.types.copy_image_result.CopyImageResult, zapros.Response]:
