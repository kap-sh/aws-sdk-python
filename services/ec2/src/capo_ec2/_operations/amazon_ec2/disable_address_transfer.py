...
import capo_ec2.types.disable_address_transfer_request
...
def handle_response(
    ...
    out: capo_ec2.types.disable_address_transfer_result.DisableAddressTransferResult = (
        capo_ec2.types.disable_address_transfer_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableAddressTransfer"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disable_address_transfer_request.serialize_ec2_query(
        input_, pairs, ""
    )
