...
) -> capo_ec2.types.enable_fast_launch_result.EnableFastLaunchResult:
    out: capo_ec2.types.enable_fast_launch_result.EnableFastLaunchResult = (
        capo_ec2.types.enable_fast_launch_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "EnableFastLaunch"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.enable_fast_launch_request.serialize_ec2_query(input_, pairs, "")
...
def enable_fast_launch(
    ...
    capo_ec2.types.enable_fast_launch_result.EnableFastLaunchResult, zapros.Response
]:
