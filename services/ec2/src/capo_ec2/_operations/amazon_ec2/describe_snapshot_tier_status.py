...
import capo_ec2.types.describe_snapshot_tier_status_request
import capo_ec2.types.describe_snapshot_tier_status_result
...
def handle_response(
    ...
    capo_ec2.types.describe_snapshot_tier_status_result.DescribeSnapshotTierStatusResult
):
    out: capo_ec2.types.describe_snapshot_tier_status_result.DescribeSnapshotTierStatusResult = capo_ec2.types.describe_snapshot_tier_status_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_snapshot_tier_status_request.serialize_ec2_query(
        input_, pairs, ""
    )
