...
import capo_ec2.types.revoke_security_group_egress_request
import capo_ec2.types.revoke_security_group_egress_result
...
) -> capo_ec2.types.revoke_security_group_egress_result.RevokeSecurityGroupEgressResult:
    out: capo_ec2.types.revoke_security_group_egress_result.RevokeSecurityGroupEgressResult = capo_ec2.types.revoke_security_group_egress_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.revoke_security_group_egress_request.serialize_ec2_query(
        input_, pairs, ""
    )
