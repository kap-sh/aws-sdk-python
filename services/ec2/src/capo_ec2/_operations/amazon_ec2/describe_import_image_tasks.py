...
import capo_ec2.types.describe_import_image_tasks_request
import capo_ec2.types.describe_import_image_tasks_result
...
def handle_response(
    ...
    out: capo_ec2.types.describe_import_image_tasks_result.DescribeImportImageTasksResult = capo_ec2.types.describe_import_image_tasks_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_import_image_tasks_request.serialize_ec2_query(
        input_, pairs, ""
    )
