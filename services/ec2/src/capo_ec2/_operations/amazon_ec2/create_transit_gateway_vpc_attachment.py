"""Generated from Smithy shape ``com.amazonaws.ec2#CreateTransitGatewayVpcAttachment``."""
...
import capo_ec2.types.create_transit_gateway_vpc_attachment_request
import capo_ec2.types.create_transit_gateway_vpc_attachment_request_options
import capo_ec2.types.create_transit_gateway_vpc_attachment_result
...
) -> capo_ec2.types.create_transit_gateway_vpc_attachment_result.CreateTransitGatewayVpcAttachmentResult:
    out: capo_ec2.types.create_transit_gateway_vpc_attachment_result.CreateTransitGatewayVpcAttachmentResult = capo_ec2.types.create_transit_gateway_vpc_attachment_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateTransitGatewayVpcAttachment"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_transit_gateway_vpc_attachment_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_create_transit_gateway_vpc_attachment(
