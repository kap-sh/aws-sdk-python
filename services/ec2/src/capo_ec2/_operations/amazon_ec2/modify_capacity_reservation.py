...
def handle_response(
    ...
    out: capo_ec2.types.modify_capacity_reservation_result.ModifyCapacityReservationResult = capo_ec2.types.modify_capacity_reservation_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_capacity_reservation_request.serialize_ec2_query(
        input_, pairs, ""
    )
