...
def handle_response(
    ...
    out: capo_ec2.types.get_launch_template_data_result.GetLaunchTemplateDataResult = (
        capo_ec2.types.get_launch_template_data_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_launch_template_data_request.serialize_ec2_query(
        input_, pairs, ""
    )
