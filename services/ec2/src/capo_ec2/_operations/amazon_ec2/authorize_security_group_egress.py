...
import capo_ec2.types.authorize_security_group_egress_request
import capo_ec2.types.authorize_security_group_egress_result
...
) -> capo_ec2.types.authorize_security_group_egress_result.AuthorizeSecurityGroupEgressResult:
    out: capo_ec2.types.authorize_security_group_egress_result.AuthorizeSecurityGroupEgressResult = capo_ec2.types.authorize_security_group_egress_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AuthorizeSecurityGroupEgress"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.authorize_security_group_egress_request.serialize_ec2_query(
        input_, pairs, ""
    )
