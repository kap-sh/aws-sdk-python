...
import capo_ec2.types.delete_transit_gateway_metering_policy_request
import capo_ec2.types.delete_transit_gateway_metering_policy_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_transit_gateway_metering_policy_result.DeleteTransitGatewayMeteringPolicyResult = capo_ec2.types.delete_transit_gateway_metering_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_transit_gateway_metering_policy_request.serialize_ec2_query(
        input_, pairs, ""
    )
