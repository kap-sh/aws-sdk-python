...
import capo_ec2.types.disassociate_client_vpn_target_network_result
...
def handle_response(
    ...
    out: capo_ec2.types.disassociate_client_vpn_target_network_result.DisassociateClientVpnTargetNetworkResult = capo_ec2.types.disassociate_client_vpn_target_network_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.disassociate_client_vpn_target_network_request.serialize_ec2_query(
        input_, pairs, ""
    )
