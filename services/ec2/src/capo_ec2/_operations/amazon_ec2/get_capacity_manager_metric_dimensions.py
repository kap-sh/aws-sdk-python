...
import capo_ec2.types.get_capacity_manager_metric_dimensions_request
import capo_ec2.types.get_capacity_manager_metric_dimensions_result
...
) -> capo_ec2.types.get_capacity_manager_metric_dimensions_result.GetCapacityManagerMetricDimensionsResult:
    out: capo_ec2.types.get_capacity_manager_metric_dimensions_result.GetCapacityManagerMetricDimensionsResult = capo_ec2.types.get_capacity_manager_metric_dimensions_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetCapacityManagerMetricDimensions"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_capacity_manager_metric_dimensions_request.serialize_ec2_query(
        input_, pairs, ""
    )
