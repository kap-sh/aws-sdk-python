...
import capo_ec2.types.create_verified_access_endpoint_request
import capo_ec2.types.create_verified_access_endpoint_result
...
) -> capo_ec2.types.create_verified_access_endpoint_result.CreateVerifiedAccessEndpointResult:
    out: capo_ec2.types.create_verified_access_endpoint_result.CreateVerifiedAccessEndpointResult = capo_ec2.types.create_verified_access_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateVerifiedAccessEndpoint"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_verified_access_endpoint_request.serialize_ec2_query(
        input_, pairs, ""
    )
