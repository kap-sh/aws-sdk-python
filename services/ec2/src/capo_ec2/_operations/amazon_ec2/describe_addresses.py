"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeAddresses``."""
...
import capo_ec2.types.describe_addresses_request
...
) -> capo_ec2.types.describe_addresses_result.DescribeAddressesResult:
    out: capo_ec2.types.describe_addresses_result.DescribeAddressesResult = (
        capo_ec2.types.describe_addresses_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeAddresses"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_addresses_request.serialize_ec2_query(input_, pairs, "")
...
def describe_addresses(
    ...
    capo_ec2.types.describe_addresses_result.DescribeAddressesResult, zapros.Response
]:
...
async def async_describe_addresses(
