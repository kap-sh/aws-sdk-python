"""Generated from Smithy shape ``com.amazonaws.ec2#CancelSpotFleetRequests``."""
...
import capo_ec2.types.cancel_spot_fleet_requests_request
import capo_ec2.types.cancel_spot_fleet_requests_response
...
def handle_response(
    ...
    out: capo_ec2.types.cancel_spot_fleet_requests_response.CancelSpotFleetRequestsResponse = capo_ec2.types.cancel_spot_fleet_requests_response.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CancelSpotFleetRequests"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.cancel_spot_fleet_requests_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_cancel_spot_fleet_requests(
