"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeRouteServerEndpoints``."""
...
import capo_ec2.types.describe_route_server_endpoints_request
import capo_ec2.types.describe_route_server_endpoints_result
...
) -> capo_ec2.types.describe_route_server_endpoints_result.DescribeRouteServerEndpointsResult:
    out: capo_ec2.types.describe_route_server_endpoints_result.DescribeRouteServerEndpointsResult = capo_ec2.types.describe_route_server_endpoints_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeRouteServerEndpoints"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_route_server_endpoints_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_route_server_endpoints(
