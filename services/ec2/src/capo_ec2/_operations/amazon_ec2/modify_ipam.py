...
import capo_ec2.types.modify_ipam_request
...
) -> capo_ec2.types.modify_ipam_result.ModifyIpamResult:
    out: capo_ec2.types.modify_ipam_result.ModifyIpamResult = (
        capo_ec2.types.modify_ipam_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyIpam"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_ipam_request.serialize_ec2_query(input_, pairs, "")
