...
import capo_ec2.types.describe_classic_link_instances_request
import capo_ec2.types.describe_classic_link_instances_result
...
) -> capo_ec2.types.describe_classic_link_instances_result.DescribeClassicLinkInstancesResult:
    out: capo_ec2.types.describe_classic_link_instances_result.DescribeClassicLinkInstancesResult = capo_ec2.types.describe_classic_link_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeClassicLinkInstances"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_classic_link_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
