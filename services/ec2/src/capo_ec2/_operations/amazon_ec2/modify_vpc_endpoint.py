...
) -> capo_ec2.types.modify_vpc_endpoint_result.ModifyVpcEndpointResult:
    out: capo_ec2.types.modify_vpc_endpoint_result.ModifyVpcEndpointResult = (
        capo_ec2.types.modify_vpc_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyVpcEndpoint"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_vpc_endpoint_request.serialize_ec2_query(input_, pairs, "")
...
def modify_vpc_endpoint(
    ...
    capo_ec2.types.modify_vpc_endpoint_result.ModifyVpcEndpointResult, zapros.Response
]:
