...
import capo_ec2.types.describe_vpc_endpoint_associations_request
import capo_ec2.types.describe_vpc_endpoint_associations_result
...
) -> capo_ec2.types.describe_vpc_endpoint_associations_result.DescribeVpcEndpointAssociationsResult:
    out: capo_ec2.types.describe_vpc_endpoint_associations_result.DescribeVpcEndpointAssociationsResult = capo_ec2.types.describe_vpc_endpoint_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVpcEndpointAssociations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_vpc_endpoint_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
