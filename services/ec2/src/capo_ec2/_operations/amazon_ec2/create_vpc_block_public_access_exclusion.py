...
import capo_ec2.types.create_vpc_block_public_access_exclusion_request
import capo_ec2.types.create_vpc_block_public_access_exclusion_result
...
) -> capo_ec2.types.create_vpc_block_public_access_exclusion_result.CreateVpcBlockPublicAccessExclusionResult:
    out: capo_ec2.types.create_vpc_block_public_access_exclusion_result.CreateVpcBlockPublicAccessExclusionResult = capo_ec2.types.create_vpc_block_public_access_exclusion_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_vpc_block_public_access_exclusion_request.serialize_ec2_query(
        input_, pairs, ""
    )
