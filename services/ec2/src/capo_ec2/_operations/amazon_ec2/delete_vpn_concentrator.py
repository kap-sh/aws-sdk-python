...
import capo_ec2.types.delete_vpn_concentrator_request
import capo_ec2.types.delete_vpn_concentrator_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_vpn_concentrator_result.DeleteVpnConcentratorResult = (
        capo_ec2.types.delete_vpn_concentrator_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_vpn_concentrator_request.serialize_ec2_query(
        input_, pairs, ""
    )
