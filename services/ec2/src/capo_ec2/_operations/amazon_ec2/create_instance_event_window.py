...
import capo_ec2.types.create_instance_event_window_request
import capo_ec2.types.create_instance_event_window_result
...
) -> capo_ec2.types.create_instance_event_window_result.CreateInstanceEventWindowResult:
    out: capo_ec2.types.create_instance_event_window_result.CreateInstanceEventWindowResult = capo_ec2.types.create_instance_event_window_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_instance_event_window_request.serialize_ec2_query(
        input_, pairs, ""
    )
