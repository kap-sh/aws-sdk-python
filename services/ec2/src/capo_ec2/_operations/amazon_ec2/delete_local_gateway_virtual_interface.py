...
import capo_ec2.types.delete_local_gateway_virtual_interface_request
import capo_ec2.types.delete_local_gateway_virtual_interface_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_local_gateway_virtual_interface_result.DeleteLocalGatewayVirtualInterfaceResult = capo_ec2.types.delete_local_gateway_virtual_interface_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteLocalGatewayVirtualInterface"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_local_gateway_virtual_interface_request.serialize_ec2_query(
        input_, pairs, ""
    )
