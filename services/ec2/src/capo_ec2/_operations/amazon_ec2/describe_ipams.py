...
import capo_ec2.types.describe_ipams_request
import capo_ec2.types.describe_ipams_result
...
) -> capo_ec2.types.describe_ipams_result.DescribeIpamsResult:
    out: capo_ec2.types.describe_ipams_result.DescribeIpamsResult = (
        capo_ec2.types.describe_ipams_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_ipams_request.serialize_ec2_query(input_, pairs, "")
...
def describe_ipams(
    ...
    input_: capo_ec2.types.describe_ipams_request.DescribeIpamsRequest,
) -> tuple[capo_ec2.types.describe_ipams_result.DescribeIpamsResult, zapros.Response]:
