...
import capo_ec2.types.cancel_spot_instance_requests_request
import capo_ec2.types.cancel_spot_instance_requests_result
...
def handle_response(
    ...
    out: capo_ec2.types.cancel_spot_instance_requests_result.CancelSpotInstanceRequestsResult = capo_ec2.types.cancel_spot_instance_requests_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CancelSpotInstanceRequests"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.cancel_spot_instance_requests_request.serialize_ec2_query(
        input_, pairs, ""
    )
