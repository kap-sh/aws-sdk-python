"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeSnapshotAttribute``."""
...
import capo_ec2.types.describe_snapshot_attribute_request
import capo_ec2.types.describe_snapshot_attribute_result
...
def handle_response(
    ...
    out: capo_ec2.types.describe_snapshot_attribute_result.DescribeSnapshotAttributeResult = capo_ec2.types.describe_snapshot_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeSnapshotAttribute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_snapshot_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_snapshot_attribute(
