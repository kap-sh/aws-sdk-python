...
import capo_ec2.types.describe_reserved_instances_request
import capo_ec2.types.describe_reserved_instances_result
...
) -> capo_ec2.types.describe_reserved_instances_result.DescribeReservedInstancesResult:
    out: capo_ec2.types.describe_reserved_instances_result.DescribeReservedInstancesResult = capo_ec2.types.describe_reserved_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_reserved_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
