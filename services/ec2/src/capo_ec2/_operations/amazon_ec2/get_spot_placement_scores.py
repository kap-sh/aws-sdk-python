...
import capo_ec2.types.get_spot_placement_scores_request
import capo_ec2.types.get_spot_placement_scores_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_spot_placement_scores_result.GetSpotPlacementScoresResult = capo_ec2.types.get_spot_placement_scores_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_spot_placement_scores_request.serialize_ec2_query(
        input_, pairs, ""
    )
