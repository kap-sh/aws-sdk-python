...
import capo_ec2.types.get_network_insights_access_scope_analysis_findings_request
import capo_ec2.types.get_network_insights_access_scope_analysis_findings_result
...
) -> capo_ec2.types.get_network_insights_access_scope_analysis_findings_result.GetNetworkInsightsAccessScopeAnalysisFindingsResult:
    out: capo_ec2.types.get_network_insights_access_scope_analysis_findings_result.GetNetworkInsightsAccessScopeAnalysisFindingsResult = capo_ec2.types.get_network_insights_access_scope_analysis_findings_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetNetworkInsightsAccessScopeAnalysisFindings"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_network_insights_access_scope_analysis_findings_request.serialize_ec2_query(
        input_, pairs, ""
    )
