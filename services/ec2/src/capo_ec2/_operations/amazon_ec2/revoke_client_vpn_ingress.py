...
import capo_ec2.types.revoke_client_vpn_ingress_request
import capo_ec2.types.revoke_client_vpn_ingress_result
...
) -> capo_ec2.types.revoke_client_vpn_ingress_result.RevokeClientVpnIngressResult:
    out: capo_ec2.types.revoke_client_vpn_ingress_result.RevokeClientVpnIngressResult = capo_ec2.types.revoke_client_vpn_ingress_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "RevokeClientVpnIngress"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.revoke_client_vpn_ingress_request.serialize_ec2_query(
        input_, pairs, ""
    )
