...
import capo_ec2.types.delete_vpc_encryption_control_request
import capo_ec2.types.delete_vpc_encryption_control_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_vpc_encryption_control_result.DeleteVpcEncryptionControlResult = capo_ec2.types.delete_vpc_encryption_control_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_vpc_encryption_control_request.serialize_ec2_query(
        input_, pairs, ""
    )
