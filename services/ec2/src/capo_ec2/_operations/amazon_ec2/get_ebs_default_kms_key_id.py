...
import capo_ec2.types.get_ebs_default_kms_key_id_request
import capo_ec2.types.get_ebs_default_kms_key_id_result
...
) -> capo_ec2.types.get_ebs_default_kms_key_id_result.GetEbsDefaultKmsKeyIdResult:
    out: capo_ec2.types.get_ebs_default_kms_key_id_result.GetEbsDefaultKmsKeyIdResult = capo_ec2.types.get_ebs_default_kms_key_id_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_ebs_default_kms_key_id_request.serialize_ec2_query(
        input_, pairs, ""
    )
