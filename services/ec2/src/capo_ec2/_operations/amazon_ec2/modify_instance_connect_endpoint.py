...
import capo_ec2.types.modify_instance_connect_endpoint_request
import capo_ec2.types.modify_instance_connect_endpoint_result
...
) -> capo_ec2.types.modify_instance_connect_endpoint_result.ModifyInstanceConnectEndpointResult:
    out: capo_ec2.types.modify_instance_connect_endpoint_result.ModifyInstanceConnectEndpointResult = capo_ec2.types.modify_instance_connect_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyInstanceConnectEndpoint"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_instance_connect_endpoint_request.serialize_ec2_query(
        input_, pairs, ""
    )
