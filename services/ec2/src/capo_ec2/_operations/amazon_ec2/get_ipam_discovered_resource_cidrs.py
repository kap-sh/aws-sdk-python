...
) -> capo_ec2.types.get_ipam_discovered_resource_cidrs_result.GetIpamDiscoveredResourceCidrsResult:
    out: capo_ec2.types.get_ipam_discovered_resource_cidrs_result.GetIpamDiscoveredResourceCidrsResult = capo_ec2.types.get_ipam_discovered_resource_cidrs_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetIpamDiscoveredResourceCidrs"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_ipam_discovered_resource_cidrs_request.serialize_ec2_query(
        input_, pairs, ""
    )
