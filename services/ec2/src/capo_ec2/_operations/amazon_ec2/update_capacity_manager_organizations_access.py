...
import capo_ec2.types.update_capacity_manager_organizations_access_request
import capo_ec2.types.update_capacity_manager_organizations_access_result
...
def handle_response(
    ...
    out: capo_ec2.types.update_capacity_manager_organizations_access_result.UpdateCapacityManagerOrganizationsAccessResult = capo_ec2.types.update_capacity_manager_organizations_access_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "UpdateCapacityManagerOrganizationsAccess"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.update_capacity_manager_organizations_access_request.serialize_ec2_query(
        input_, pairs, ""
    )
