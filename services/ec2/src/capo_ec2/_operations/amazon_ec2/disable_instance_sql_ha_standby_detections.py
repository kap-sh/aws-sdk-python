...
import capo_ec2.types.disable_instance_sql_ha_standby_detections_request
import capo_ec2.types.disable_instance_sql_ha_standby_detections_result
...
def handle_response(
    ...
    out: capo_ec2.types.disable_instance_sql_ha_standby_detections_result.DisableInstanceSqlHaStandbyDetectionsResult = capo_ec2.types.disable_instance_sql_ha_standby_detections_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableInstanceSqlHaStandbyDetections"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disable_instance_sql_ha_standby_detections_request.serialize_ec2_query(
        input_, pairs, ""
    )
