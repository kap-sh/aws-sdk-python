...
import capo_ec2.types.associate_subnet_cidr_block_request
import capo_ec2.types.associate_subnet_cidr_block_result
...
def handle_response(
    ...
    out: capo_ec2.types.associate_subnet_cidr_block_result.AssociateSubnetCidrBlockResult = capo_ec2.types.associate_subnet_cidr_block_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.associate_subnet_cidr_block_request.serialize_ec2_query(
        input_, pairs, ""
    )
