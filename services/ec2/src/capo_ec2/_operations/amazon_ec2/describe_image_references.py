"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeImageReferences``."""
...
import capo_ec2.types.describe_image_references_request
import capo_ec2.types.describe_image_references_result
...
) -> capo_ec2.types.describe_image_references_result.DescribeImageReferencesResult:
    out: capo_ec2.types.describe_image_references_result.DescribeImageReferencesResult = capo_ec2.types.describe_image_references_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeImageReferences"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_image_references_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_image_references(
