...
import capo_ec2.types.describe_vpc_classic_link_request
import capo_ec2.types.describe_vpc_classic_link_result
...
) -> capo_ec2.types.describe_vpc_classic_link_result.DescribeVpcClassicLinkResult:
    out: capo_ec2.types.describe_vpc_classic_link_result.DescribeVpcClassicLinkResult = capo_ec2.types.describe_vpc_classic_link_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_vpc_classic_link_request.serialize_ec2_query(
        input_, pairs, ""
    )
