...
import capo_ec2.types.describe_image_usage_report_entries_request
import capo_ec2.types.describe_image_usage_report_entries_result
...
) -> capo_ec2.types.describe_image_usage_report_entries_result.DescribeImageUsageReportEntriesResult:
    out: capo_ec2.types.describe_image_usage_report_entries_result.DescribeImageUsageReportEntriesResult = capo_ec2.types.describe_image_usage_report_entries_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_image_usage_report_entries_request.serialize_ec2_query(
        input_, pairs, ""
    )
