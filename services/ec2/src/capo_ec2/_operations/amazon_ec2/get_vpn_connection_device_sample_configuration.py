...
import capo_ec2.types.get_vpn_connection_device_sample_configuration_request
import capo_ec2.types.get_vpn_connection_device_sample_configuration_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_vpn_connection_device_sample_configuration_result.GetVpnConnectionDeviceSampleConfigurationResult = capo_ec2.types.get_vpn_connection_device_sample_configuration_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetVpnConnectionDeviceSampleConfiguration"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_vpn_connection_device_sample_configuration_request.serialize_ec2_query(
        input_, pairs, ""
    )
