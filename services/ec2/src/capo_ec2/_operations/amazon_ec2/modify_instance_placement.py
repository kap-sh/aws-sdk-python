...
import capo_ec2.types.modify_instance_placement_request
import capo_ec2.types.modify_instance_placement_result
...
) -> capo_ec2.types.modify_instance_placement_result.ModifyInstancePlacementResult:
    out: capo_ec2.types.modify_instance_placement_result.ModifyInstancePlacementResult = capo_ec2.types.modify_instance_placement_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyInstancePlacement"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_instance_placement_request.serialize_ec2_query(
        input_, pairs, ""
    )
