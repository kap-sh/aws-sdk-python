...
import capo_ec2.types.get_ipam_discovered_public_addresses_request
...
) -> capo_ec2.types.get_ipam_discovered_public_addresses_result.GetIpamDiscoveredPublicAddressesResult:
    out: capo_ec2.types.get_ipam_discovered_public_addresses_result.GetIpamDiscoveredPublicAddressesResult = capo_ec2.types.get_ipam_discovered_public_addresses_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_ipam_discovered_public_addresses_request.serialize_ec2_query(
        input_, pairs, ""
    )
