...
import capo_ec2.types.deprovision_ipam_pool_cidr_request
import capo_ec2.types.deprovision_ipam_pool_cidr_result
...
def handle_response(
    ...
    out: capo_ec2.types.deprovision_ipam_pool_cidr_result.DeprovisionIpamPoolCidrResult = capo_ec2.types.deprovision_ipam_pool_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeprovisionIpamPoolCidr"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.deprovision_ipam_pool_cidr_request.serialize_ec2_query(
        input_, pairs, ""
    )
