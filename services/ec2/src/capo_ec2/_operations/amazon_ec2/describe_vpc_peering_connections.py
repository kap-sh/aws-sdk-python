...
import capo_ec2.types.describe_vpc_peering_connections_request
import capo_ec2.types.describe_vpc_peering_connections_result
...
) -> capo_ec2.types.describe_vpc_peering_connections_result.DescribeVpcPeeringConnectionsResult:
    out: capo_ec2.types.describe_vpc_peering_connections_result.DescribeVpcPeeringConnectionsResult = capo_ec2.types.describe_vpc_peering_connections_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVpcPeeringConnections"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_vpc_peering_connections_request.serialize_ec2_query(
        input_, pairs, ""
    )
