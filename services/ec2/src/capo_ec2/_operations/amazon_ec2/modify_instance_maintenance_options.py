"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyInstanceMaintenanceOptions``."""
...
import capo_ec2.types.modify_instance_maintenance_options_request
import capo_ec2.types.modify_instance_maintenance_options_result
...
) -> capo_ec2.types.modify_instance_maintenance_options_result.ModifyInstanceMaintenanceOptionsResult:
    out: capo_ec2.types.modify_instance_maintenance_options_result.ModifyInstanceMaintenanceOptionsResult = capo_ec2.types.modify_instance_maintenance_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyInstanceMaintenanceOptions"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_instance_maintenance_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_instance_maintenance_options(
