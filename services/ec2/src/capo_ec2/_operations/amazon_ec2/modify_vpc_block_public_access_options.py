...
import capo_ec2.types.modify_vpc_block_public_access_options_request
import capo_ec2.types.modify_vpc_block_public_access_options_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_vpc_block_public_access_options_result.ModifyVpcBlockPublicAccessOptionsResult = capo_ec2.types.modify_vpc_block_public_access_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyVpcBlockPublicAccessOptions"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_vpc_block_public_access_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
