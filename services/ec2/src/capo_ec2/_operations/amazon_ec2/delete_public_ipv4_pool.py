...
import capo_ec2.types.delete_public_ipv4_pool_request
import capo_ec2.types.delete_public_ipv4_pool_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_public_ipv4_pool_result.DeletePublicIpv4PoolResult = (
        capo_ec2.types.delete_public_ipv4_pool_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_public_ipv4_pool_request.serialize_ec2_query(
        input_, pairs, ""
    )
