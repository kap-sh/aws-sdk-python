...
import capo_ec2.types.describe_ipam_pools_request
import capo_ec2.types.describe_ipam_pools_result
...
) -> capo_ec2.types.describe_ipam_pools_result.DescribeIpamPoolsResult:
    out: capo_ec2.types.describe_ipam_pools_result.DescribeIpamPoolsResult = (
        capo_ec2.types.describe_ipam_pools_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_ipam_pools_request.serialize_ec2_query(input_, pairs, "")
...
def describe_ipam_pools(
    ...
    capo_ec2.types.describe_ipam_pools_result.DescribeIpamPoolsResult, zapros.Response
]:
