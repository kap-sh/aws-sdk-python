...
import capo_ec2.types.request_spot_instances_request
import capo_ec2.types.request_spot_instances_result
...
) -> capo_ec2.types.request_spot_instances_result.RequestSpotInstancesResult:
    out: capo_ec2.types.request_spot_instances_result.RequestSpotInstancesResult = (
        capo_ec2.types.request_spot_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "RequestSpotInstances"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.request_spot_instances_request.serialize_ec2_query(input_, pairs, "")
