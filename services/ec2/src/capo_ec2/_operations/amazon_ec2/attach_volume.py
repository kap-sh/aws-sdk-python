...
import capo_ec2.types.attach_volume_request
...
def handle_response(
    ...
    out: capo_ec2.types.volume_attachment.VolumeAttachment = (
        capo_ec2.types.volume_attachment.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.attach_volume_request.serialize_ec2_query(input_, pairs, "")
...
def attach_volume(
    ...
    input_: capo_ec2.types.attach_volume_request.AttachVolumeRequest,
) -> tuple[capo_ec2.types.volume_attachment.VolumeAttachment, zapros.Response]:
