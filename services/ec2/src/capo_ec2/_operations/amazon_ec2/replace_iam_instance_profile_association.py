...
import capo_ec2.types.replace_iam_instance_profile_association_request
...
def handle_response(
    ...
    out: capo_ec2.types.replace_iam_instance_profile_association_result.ReplaceIamInstanceProfileAssociationResult = capo_ec2.types.replace_iam_instance_profile_association_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ReplaceIamInstanceProfileAssociation"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.replace_iam_instance_profile_association_request.serialize_ec2_query(
        input_, pairs, ""
    )
