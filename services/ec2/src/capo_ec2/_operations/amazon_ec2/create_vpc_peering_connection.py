...
import capo_ec2.types.create_vpc_peering_connection_request
import capo_ec2.types.create_vpc_peering_connection_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_vpc_peering_connection_result.CreateVpcPeeringConnectionResult = capo_ec2.types.create_vpc_peering_connection_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateVpcPeeringConnection"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_vpc_peering_connection_request.serialize_ec2_query(
        input_, pairs, ""
    )
