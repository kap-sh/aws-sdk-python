...
import capo_ec2.types.reject_vpc_endpoint_connections_request
import capo_ec2.types.reject_vpc_endpoint_connections_result
...
def handle_response(
    ...
    out: capo_ec2.types.reject_vpc_endpoint_connections_result.RejectVpcEndpointConnectionsResult = capo_ec2.types.reject_vpc_endpoint_connections_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "RejectVpcEndpointConnections"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.reject_vpc_endpoint_connections_request.serialize_ec2_query(
        input_, pairs, ""
    )
