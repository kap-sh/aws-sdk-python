...
import capo_ec2.types.describe_spot_fleet_instances_request
import capo_ec2.types.describe_spot_fleet_instances_response
...
) -> capo_ec2.types.describe_spot_fleet_instances_response.DescribeSpotFleetInstancesResponse:
    out: capo_ec2.types.describe_spot_fleet_instances_response.DescribeSpotFleetInstancesResponse = capo_ec2.types.describe_spot_fleet_instances_response.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeSpotFleetInstances"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_spot_fleet_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
