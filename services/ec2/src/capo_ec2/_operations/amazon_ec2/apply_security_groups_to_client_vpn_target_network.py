...
def handle_response(
    ...
    out: capo_ec2.types.apply_security_groups_to_client_vpn_target_network_result.ApplySecurityGroupsToClientVpnTargetNetworkResult = capo_ec2.types.apply_security_groups_to_client_vpn_target_network_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.apply_security_groups_to_client_vpn_target_network_request.serialize_ec2_query(
        input_, pairs, ""
    )
