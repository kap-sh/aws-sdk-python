...
import capo_ec2.types.modify_local_gateway_route_request
import capo_ec2.types.modify_local_gateway_route_result
...
) -> capo_ec2.types.modify_local_gateway_route_result.ModifyLocalGatewayRouteResult:
    out: capo_ec2.types.modify_local_gateway_route_result.ModifyLocalGatewayRouteResult = capo_ec2.types.modify_local_gateway_route_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyLocalGatewayRoute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_local_gateway_route_request.serialize_ec2_query(
        input_, pairs, ""
    )
