...
import capo_ec2.types.restore_image_from_recycle_bin_request
import capo_ec2.types.restore_image_from_recycle_bin_result
...
def handle_response(
    ...
    out: capo_ec2.types.restore_image_from_recycle_bin_result.RestoreImageFromRecycleBinResult = capo_ec2.types.restore_image_from_recycle_bin_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.restore_image_from_recycle_bin_request.serialize_ec2_query(
        input_, pairs, ""
    )
