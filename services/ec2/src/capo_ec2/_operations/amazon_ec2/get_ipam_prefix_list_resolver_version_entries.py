...
import capo_ec2.types.get_ipam_prefix_list_resolver_version_entries_request
import capo_ec2.types.get_ipam_prefix_list_resolver_version_entries_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_ipam_prefix_list_resolver_version_entries_result.GetIpamPrefixListResolverVersionEntriesResult = capo_ec2.types.get_ipam_prefix_list_resolver_version_entries_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_ipam_prefix_list_resolver_version_entries_request.serialize_ec2_query(
        input_, pairs, ""
    )
