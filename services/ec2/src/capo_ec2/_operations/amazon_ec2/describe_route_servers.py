"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeRouteServers``."""
...
import capo_ec2.types.describe_route_servers_request
import capo_ec2.types.describe_route_servers_result
import capo_ec2.types.filter_list
import capo_ec2.types.route_server_ids_list
...
) -> capo_ec2.types.describe_route_servers_result.DescribeRouteServersResult:
    out: capo_ec2.types.describe_route_servers_result.DescribeRouteServersResult = (
        capo_ec2.types.describe_route_servers_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeRouteServers"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_route_servers_request.serialize_ec2_query(input_, pairs, "")
...
async def async_describe_route_servers(
