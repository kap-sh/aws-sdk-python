...
import capo_ec2.types.create_route_server_endpoint_request
import capo_ec2.types.create_route_server_endpoint_result
...
) -> capo_ec2.types.create_route_server_endpoint_result.CreateRouteServerEndpointResult:
    out: capo_ec2.types.create_route_server_endpoint_result.CreateRouteServerEndpointResult = capo_ec2.types.create_route_server_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateRouteServerEndpoint"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_route_server_endpoint_request.serialize_ec2_query(
        input_, pairs, ""
    )
