...
import capo_ec2.types.modify_private_dns_name_options_request
import capo_ec2.types.modify_private_dns_name_options_result
...
) -> capo_ec2.types.modify_private_dns_name_options_result.ModifyPrivateDnsNameOptionsResult:
    out: capo_ec2.types.modify_private_dns_name_options_result.ModifyPrivateDnsNameOptionsResult = capo_ec2.types.modify_private_dns_name_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_private_dns_name_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
