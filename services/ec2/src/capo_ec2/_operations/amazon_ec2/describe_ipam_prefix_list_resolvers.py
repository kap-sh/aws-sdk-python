...
import capo_ec2.types.describe_ipam_prefix_list_resolvers_request
import capo_ec2.types.describe_ipam_prefix_list_resolvers_result
...
) -> capo_ec2.types.describe_ipam_prefix_list_resolvers_result.DescribeIpamPrefixListResolversResult:
    out: capo_ec2.types.describe_ipam_prefix_list_resolvers_result.DescribeIpamPrefixListResolversResult = capo_ec2.types.describe_ipam_prefix_list_resolvers_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeIpamPrefixListResolvers"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_ipam_prefix_list_resolvers_request.serialize_ec2_query(
        input_, pairs, ""
    )
