...
import capo_ec2.types.create_transit_gateway_route_table_request
import capo_ec2.types.create_transit_gateway_route_table_result
...
) -> capo_ec2.types.create_transit_gateway_route_table_result.CreateTransitGatewayRouteTableResult:
    out: capo_ec2.types.create_transit_gateway_route_table_result.CreateTransitGatewayRouteTableResult = capo_ec2.types.create_transit_gateway_route_table_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateTransitGatewayRouteTable"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_transit_gateway_route_table_request.serialize_ec2_query(
        input_, pairs, ""
    )
