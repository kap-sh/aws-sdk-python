"""Generated from Smithy shape ``com.amazonaws.ec2#DeprovisionPublicIpv4PoolCidr``."""
...
import capo_ec2.types.deprovision_public_ipv4_pool_cidr_request
import capo_ec2.types.deprovision_public_ipv4_pool_cidr_result
...
def handle_response(
    ...
    out: capo_ec2.types.deprovision_public_ipv4_pool_cidr_result.DeprovisionPublicIpv4PoolCidrResult = capo_ec2.types.deprovision_public_ipv4_pool_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeprovisionPublicIpv4PoolCidr"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.deprovision_public_ipv4_pool_cidr_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_deprovision_public_ipv4_pool_cidr(
