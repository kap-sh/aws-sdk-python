"""Generated from Smithy shape ``com.amazonaws.ec2#GetCapacityManagerMetricData``."""
...
import capo_ec2.types.get_capacity_manager_metric_data_request
import capo_ec2.types.get_capacity_manager_metric_data_result
...
) -> capo_ec2.types.get_capacity_manager_metric_data_result.GetCapacityManagerMetricDataResult:
    out: capo_ec2.types.get_capacity_manager_metric_data_result.GetCapacityManagerMetricDataResult = capo_ec2.types.get_capacity_manager_metric_data_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetCapacityManagerMetricData"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_capacity_manager_metric_data_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_get_capacity_manager_metric_data(
