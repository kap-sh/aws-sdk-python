...
import capo_ec2.types.create_traffic_mirror_target_request
import capo_ec2.types.create_traffic_mirror_target_result
...
) -> capo_ec2.types.create_traffic_mirror_target_result.CreateTrafficMirrorTargetResult:
    out: capo_ec2.types.create_traffic_mirror_target_result.CreateTrafficMirrorTargetResult = capo_ec2.types.create_traffic_mirror_target_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateTrafficMirrorTarget"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_traffic_mirror_target_request.serialize_ec2_query(
        input_, pairs, ""
    )
