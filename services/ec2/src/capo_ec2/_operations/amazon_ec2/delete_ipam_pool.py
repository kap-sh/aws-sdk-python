"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteIpamPool``."""
...
import capo_ec2.types.delete_ipam_pool_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_ipam_pool_result.DeleteIpamPoolResult = (
        capo_ec2.types.delete_ipam_pool_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteIpamPool"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_ipam_pool_request.serialize_ec2_query(input_, pairs, "")
...
def delete_ipam_pool(
    ...
    capo_ec2.types.delete_ipam_pool_result.DeleteIpamPoolResult, zapros.Response
]:
...
async def async_delete_ipam_pool(
