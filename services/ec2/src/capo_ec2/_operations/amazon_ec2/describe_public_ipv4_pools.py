...
import capo_ec2.types.describe_public_ipv4_pools_request
import capo_ec2.types.describe_public_ipv4_pools_result
...
) -> capo_ec2.types.describe_public_ipv4_pools_result.DescribePublicIpv4PoolsResult:
    out: capo_ec2.types.describe_public_ipv4_pools_result.DescribePublicIpv4PoolsResult = capo_ec2.types.describe_public_ipv4_pools_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribePublicIpv4Pools"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_public_ipv4_pools_request.serialize_ec2_query(
        input_, pairs, ""
    )
