...
import capo_ec2.types.get_subnet_cidr_reservations_request
import capo_ec2.types.get_subnet_cidr_reservations_result
...
) -> capo_ec2.types.get_subnet_cidr_reservations_result.GetSubnetCidrReservationsResult:
    out: capo_ec2.types.get_subnet_cidr_reservations_result.GetSubnetCidrReservationsResult = capo_ec2.types.get_subnet_cidr_reservations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetSubnetCidrReservations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_subnet_cidr_reservations_request.serialize_ec2_query(
        input_, pairs, ""
    )
