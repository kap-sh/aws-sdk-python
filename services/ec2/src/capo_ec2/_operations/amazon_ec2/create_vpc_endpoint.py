...
import capo_ec2.types.create_vpc_endpoint_request
import capo_ec2.types.create_vpc_endpoint_result
...
) -> capo_ec2.types.create_vpc_endpoint_result.CreateVpcEndpointResult:
    out: capo_ec2.types.create_vpc_endpoint_result.CreateVpcEndpointResult = (
        capo_ec2.types.create_vpc_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_vpc_endpoint_request.serialize_ec2_query(input_, pairs, "")
...
def create_vpc_endpoint(
    ...
    capo_ec2.types.create_vpc_endpoint_result.CreateVpcEndpointResult, zapros.Response
]:
