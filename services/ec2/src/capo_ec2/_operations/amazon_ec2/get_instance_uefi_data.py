...
import capo_ec2.types.get_instance_uefi_data_request
import capo_ec2.types.get_instance_uefi_data_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_instance_uefi_data_result.GetInstanceUefiDataResult = (
        capo_ec2.types.get_instance_uefi_data_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetInstanceUefiData"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_instance_uefi_data_request.serialize_ec2_query(input_, pairs, "")
