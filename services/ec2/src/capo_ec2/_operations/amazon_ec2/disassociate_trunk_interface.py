...
import capo_ec2.types.disassociate_trunk_interface_request
import capo_ec2.types.disassociate_trunk_interface_result
...
def handle_response(
    ...
    out: capo_ec2.types.disassociate_trunk_interface_result.DisassociateTrunkInterfaceResult = capo_ec2.types.disassociate_trunk_interface_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisassociateTrunkInterface"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disassociate_trunk_interface_request.serialize_ec2_query(
        input_, pairs, ""
    )
