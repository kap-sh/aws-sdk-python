...
import capo_ec2.types.describe_outpost_lags_request
import capo_ec2.types.describe_outpost_lags_result
...
) -> capo_ec2.types.describe_outpost_lags_result.DescribeOutpostLagsResult:
    out: capo_ec2.types.describe_outpost_lags_result.DescribeOutpostLagsResult = (
        capo_ec2.types.describe_outpost_lags_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_outpost_lags_request.serialize_ec2_query(input_, pairs, "")
