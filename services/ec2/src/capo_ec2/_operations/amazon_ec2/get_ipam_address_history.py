...
import capo_ec2.types.get_ipam_address_history_request
import capo_ec2.types.get_ipam_address_history_result
...
) -> capo_ec2.types.get_ipam_address_history_result.GetIpamAddressHistoryResult:
    out: capo_ec2.types.get_ipam_address_history_result.GetIpamAddressHistoryResult = (
        capo_ec2.types.get_ipam_address_history_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetIpamAddressHistory"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_ipam_address_history_request.serialize_ec2_query(
        input_, pairs, ""
    )
