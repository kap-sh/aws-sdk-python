"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyApplicationStatusCheck``."""
...
def handle_response(
    ...
    out: capo_ec2.types.modify_application_status_check_result.ModifyApplicationStatusCheckResult = capo_ec2.types.modify_application_status_check_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyApplicationStatusCheck"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_application_status_check_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_application_status_check(
