...
import capo_ec2.types.create_local_gateway_virtual_interface_group_request
import capo_ec2.types.create_local_gateway_virtual_interface_group_result
...
) -> capo_ec2.types.create_local_gateway_virtual_interface_group_result.CreateLocalGatewayVirtualInterfaceGroupResult:
    out: capo_ec2.types.create_local_gateway_virtual_interface_group_result.CreateLocalGatewayVirtualInterfaceGroupResult = capo_ec2.types.create_local_gateway_virtual_interface_group_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateLocalGatewayVirtualInterfaceGroup"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_local_gateway_virtual_interface_group_request.serialize_ec2_query(
        input_, pairs, ""
    )
