...
import capo_ec2.types.describe_service_link_virtual_interfaces_request
import capo_ec2.types.describe_service_link_virtual_interfaces_result
...
) -> capo_ec2.types.describe_service_link_virtual_interfaces_result.DescribeServiceLinkVirtualInterfacesResult:
    out: capo_ec2.types.describe_service_link_virtual_interfaces_result.DescribeServiceLinkVirtualInterfacesResult = capo_ec2.types.describe_service_link_virtual_interfaces_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeServiceLinkVirtualInterfaces"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_service_link_virtual_interfaces_request.serialize_ec2_query(
        input_, pairs, ""
    )
