...
import capo_ec2.types.get_ipam_prefix_list_resolver_versions_request
...
) -> capo_ec2.types.get_ipam_prefix_list_resolver_versions_result.GetIpamPrefixListResolverVersionsResult:
    out: capo_ec2.types.get_ipam_prefix_list_resolver_versions_result.GetIpamPrefixListResolverVersionsResult = capo_ec2.types.get_ipam_prefix_list_resolver_versions_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_ipam_prefix_list_resolver_versions_request.serialize_ec2_query(
        input_, pairs, ""
    )
