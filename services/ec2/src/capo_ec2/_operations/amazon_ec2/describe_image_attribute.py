"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeImageAttribute``."""
...
import capo_ec2.types.describe_image_attribute_request
import capo_ec2.types.image_attribute
...
def handle_response(
    ...
    out: capo_ec2.types.image_attribute.ImageAttribute = (
        capo_ec2.types.image_attribute.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeImageAttribute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_image_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
def describe_image_attribute(
    ...
    input_: capo_ec2.types.describe_image_attribute_request.DescribeImageAttributeRequest,
) -> tuple[capo_ec2.types.image_attribute.ImageAttribute, zapros.Response]:
...
async def async_describe_image_attribute(
