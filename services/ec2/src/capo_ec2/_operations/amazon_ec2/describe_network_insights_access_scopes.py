...
import capo_ec2.types.describe_network_insights_access_scopes_request
import capo_ec2.types.describe_network_insights_access_scopes_result
...
) -> capo_ec2.types.describe_network_insights_access_scopes_result.DescribeNetworkInsightsAccessScopesResult:
    out: capo_ec2.types.describe_network_insights_access_scopes_result.DescribeNetworkInsightsAccessScopesResult = capo_ec2.types.describe_network_insights_access_scopes_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeNetworkInsightsAccessScopes"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_network_insights_access_scopes_request.serialize_ec2_query(
        input_, pairs, ""
    )
