...
import capo_ec2.types.import_image_request
import capo_ec2.types.import_image_result
...
) -> capo_ec2.types.import_image_result.ImportImageResult:
    out: capo_ec2.types.import_image_result.ImportImageResult = (
        capo_ec2.types.import_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.import_image_request.serialize_ec2_query(input_, pairs, "")
...
def import_image(
    ...
    input_: capo_ec2.types.import_image_request.ImportImageRequest,
) -> tuple[capo_ec2.types.import_image_result.ImportImageResult, zapros.Response]:
