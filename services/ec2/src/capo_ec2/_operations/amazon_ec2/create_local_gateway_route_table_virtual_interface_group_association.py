...
import capo_ec2.types.create_local_gateway_route_table_virtual_interface_group_association_request
import capo_ec2.types.create_local_gateway_route_table_virtual_interface_group_association_result
...
) -> capo_ec2.types.create_local_gateway_route_table_virtual_interface_group_association_result.CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult:
    out: capo_ec2.types.create_local_gateway_route_table_virtual_interface_group_association_result.CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult = capo_ec2.types.create_local_gateway_route_table_virtual_interface_group_association_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_local_gateway_route_table_virtual_interface_group_association_request.serialize_ec2_query(
        input_, pairs, ""
    )
