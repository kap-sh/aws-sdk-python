...
import capo_ec2.types.describe_instance_topology_request
import capo_ec2.types.describe_instance_topology_result
...
) -> capo_ec2.types.describe_instance_topology_result.DescribeInstanceTopologyResult:
    out: capo_ec2.types.describe_instance_topology_result.DescribeInstanceTopologyResult = capo_ec2.types.describe_instance_topology_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_instance_topology_request.serialize_ec2_query(
        input_, pairs, ""
    )
