"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeLockedSnapshots``."""
...
import capo_ec2.types.describe_locked_snapshots_request
import capo_ec2.types.describe_locked_snapshots_result
...
def handle_response(
    ...
    out: capo_ec2.types.describe_locked_snapshots_result.DescribeLockedSnapshotsResult = capo_ec2.types.describe_locked_snapshots_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeLockedSnapshots"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_locked_snapshots_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_locked_snapshots(
