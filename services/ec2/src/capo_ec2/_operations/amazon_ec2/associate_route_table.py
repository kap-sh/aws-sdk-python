...
import capo_ec2.types.associate_route_table_request
import capo_ec2.types.associate_route_table_result
...
def handle_response(
    ...
    out: capo_ec2.types.associate_route_table_result.AssociateRouteTableResult = (
        capo_ec2.types.associate_route_table_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AssociateRouteTable"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.associate_route_table_request.serialize_ec2_query(input_, pairs, "")
