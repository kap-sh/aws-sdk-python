...
import capo_ec2.types.create_ipam_request
...
) -> capo_ec2.types.create_ipam_result.CreateIpamResult:
    out: capo_ec2.types.create_ipam_result.CreateIpamResult = (
        capo_ec2.types.create_ipam_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateIpam"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_ipam_request.serialize_ec2_query(input_, pairs, "")
...
def create_ipam(
    ...
    input_: capo_ec2.types.create_ipam_request.CreateIpamRequest,
) -> tuple[capo_ec2.types.create_ipam_result.CreateIpamResult, zapros.Response]:
