...
def handle_response(
    ...
    out: capo_ec2.types.delete_carrier_gateway_result.DeleteCarrierGatewayResult = (
        capo_ec2.types.delete_carrier_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_carrier_gateway_request.serialize_ec2_query(input_, pairs, "")
