...
import capo_ec2.types.replace_vpn_tunnel_request
import capo_ec2.types.replace_vpn_tunnel_result
...
def handle_response(
    ...
    out: capo_ec2.types.replace_vpn_tunnel_result.ReplaceVpnTunnelResult = (
        capo_ec2.types.replace_vpn_tunnel_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.replace_vpn_tunnel_request.serialize_ec2_query(input_, pairs, "")
...
def replace_vpn_tunnel(
    ...
    capo_ec2.types.replace_vpn_tunnel_result.ReplaceVpnTunnelResult, zapros.Response
]:
