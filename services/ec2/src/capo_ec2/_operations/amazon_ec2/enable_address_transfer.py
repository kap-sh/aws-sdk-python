...
import capo_ec2.types.enable_address_transfer_request
...
def handle_response(
    ...
    out: capo_ec2.types.enable_address_transfer_result.EnableAddressTransferResult = (
        capo_ec2.types.enable_address_transfer_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "EnableAddressTransfer"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.enable_address_transfer_request.serialize_ec2_query(
        input_, pairs, ""
    )
