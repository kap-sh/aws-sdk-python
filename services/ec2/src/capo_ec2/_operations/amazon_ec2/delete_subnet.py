"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteSubnet``."""
...
import capo_ec2.types.delete_subnet_request
...
def build_request(
    ...
    pairs.append(("Action", "DeleteSubnet"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_subnet_request.serialize_ec2_query(input_, pairs, "")
