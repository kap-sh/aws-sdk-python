...
import capo_ec2.types.delete_verified_access_trust_provider_request
import capo_ec2.types.delete_verified_access_trust_provider_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_verified_access_trust_provider_result.DeleteVerifiedAccessTrustProviderResult = capo_ec2.types.delete_verified_access_trust_provider_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_verified_access_trust_provider_request.serialize_ec2_query(
        input_, pairs, ""
    )
