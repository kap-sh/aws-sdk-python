...
import capo_ec2.types.release_hosts_request
import capo_ec2.types.release_hosts_result
...
def handle_response(
    ...
    out: capo_ec2.types.release_hosts_result.ReleaseHostsResult = (
        capo_ec2.types.release_hosts_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ReleaseHosts"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.release_hosts_request.serialize_ec2_query(input_, pairs, "")
...
def release_hosts(
    ...
    input_: capo_ec2.types.release_hosts_request.ReleaseHostsRequest,
) -> tuple[capo_ec2.types.release_hosts_result.ReleaseHostsResult, zapros.Response]:
