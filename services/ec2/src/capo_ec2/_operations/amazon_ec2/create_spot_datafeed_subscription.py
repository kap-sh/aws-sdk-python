...
import capo_ec2.types.create_spot_datafeed_subscription_request
import capo_ec2.types.create_spot_datafeed_subscription_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_spot_datafeed_subscription_result.CreateSpotDatafeedSubscriptionResult = capo_ec2.types.create_spot_datafeed_subscription_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_spot_datafeed_subscription_request.serialize_ec2_query(
        input_, pairs, ""
    )
