"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteVpnConnectionRoute``."""
...
import capo_ec2.types.delete_vpn_connection_route_request
...
def build_request(
    ...
    pairs.append(("Action", "DeleteVpnConnectionRoute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_vpn_connection_route_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_vpn_connection_route(
