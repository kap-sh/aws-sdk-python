...
import capo_ec2.types.disassociate_instance_event_window_request
import capo_ec2.types.disassociate_instance_event_window_result
...
def handle_response(
    ...
    out: capo_ec2.types.disassociate_instance_event_window_result.DisassociateInstanceEventWindowResult = capo_ec2.types.disassociate_instance_event_window_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.disassociate_instance_event_window_request.serialize_ec2_query(
        input_, pairs, ""
    )
