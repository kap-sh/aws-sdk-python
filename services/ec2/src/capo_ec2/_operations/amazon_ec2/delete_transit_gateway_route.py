...
import capo_ec2.types.delete_transit_gateway_route_request
import capo_ec2.types.delete_transit_gateway_route_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_transit_gateway_route_result.DeleteTransitGatewayRouteResult = capo_ec2.types.delete_transit_gateway_route_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_transit_gateway_route_request.serialize_ec2_query(
        input_, pairs, ""
    )
