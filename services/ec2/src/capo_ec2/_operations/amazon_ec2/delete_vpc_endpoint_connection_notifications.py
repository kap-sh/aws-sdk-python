...
import capo_ec2.types.delete_vpc_endpoint_connection_notifications_request
import capo_ec2.types.delete_vpc_endpoint_connection_notifications_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_vpc_endpoint_connection_notifications_result.DeleteVpcEndpointConnectionNotificationsResult = capo_ec2.types.delete_vpc_endpoint_connection_notifications_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_vpc_endpoint_connection_notifications_request.serialize_ec2_query(
        input_, pairs, ""
    )
