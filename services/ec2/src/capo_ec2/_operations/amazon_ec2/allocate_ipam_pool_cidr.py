...
import capo_ec2.types.allocate_ipam_pool_cidr_request
import capo_ec2.types.allocate_ipam_pool_cidr_result
...
) -> capo_ec2.types.allocate_ipam_pool_cidr_result.AllocateIpamPoolCidrResult:
    out: capo_ec2.types.allocate_ipam_pool_cidr_result.AllocateIpamPoolCidrResult = (
        capo_ec2.types.allocate_ipam_pool_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AllocateIpamPoolCidr"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.allocate_ipam_pool_cidr_request.serialize_ec2_query(
        input_, pairs, ""
    )
