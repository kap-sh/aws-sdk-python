...
import capo_ec2.types.describe_image_usage_reports_request
import capo_ec2.types.describe_image_usage_reports_result
...
) -> capo_ec2.types.describe_image_usage_reports_result.DescribeImageUsageReportsResult:
    out: capo_ec2.types.describe_image_usage_reports_result.DescribeImageUsageReportsResult = capo_ec2.types.describe_image_usage_reports_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeImageUsageReports"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_image_usage_reports_request.serialize_ec2_query(
        input_, pairs, ""
    )
