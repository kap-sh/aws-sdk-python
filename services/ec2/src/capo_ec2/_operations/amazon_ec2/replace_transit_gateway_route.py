...
import capo_ec2.types.replace_transit_gateway_route_request
import capo_ec2.types.replace_transit_gateway_route_result
...
def handle_response(
    ...
    capo_ec2.types.replace_transit_gateway_route_result.ReplaceTransitGatewayRouteResult
):
    out: capo_ec2.types.replace_transit_gateway_route_result.ReplaceTransitGatewayRouteResult = capo_ec2.types.replace_transit_gateway_route_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.replace_transit_gateway_route_request.serialize_ec2_query(
        input_, pairs, ""
    )
