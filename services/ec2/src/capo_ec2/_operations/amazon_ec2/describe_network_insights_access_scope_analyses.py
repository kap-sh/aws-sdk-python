...
import capo_ec2.types.describe_network_insights_access_scope_analyses_request
import capo_ec2.types.describe_network_insights_access_scope_analyses_result
...
) -> capo_ec2.types.describe_network_insights_access_scope_analyses_result.DescribeNetworkInsightsAccessScopeAnalysesResult:
    out: capo_ec2.types.describe_network_insights_access_scope_analyses_result.DescribeNetworkInsightsAccessScopeAnalysesResult = capo_ec2.types.describe_network_insights_access_scope_analyses_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_network_insights_access_scope_analyses_request.serialize_ec2_query(
        input_, pairs, ""
    )
