...
import capo_ec2.types.delete_network_insights_analysis_request
import capo_ec2.types.delete_network_insights_analysis_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_network_insights_analysis_result.DeleteNetworkInsightsAnalysisResult = capo_ec2.types.delete_network_insights_analysis_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_network_insights_analysis_request.serialize_ec2_query(
        input_, pairs, ""
    )
