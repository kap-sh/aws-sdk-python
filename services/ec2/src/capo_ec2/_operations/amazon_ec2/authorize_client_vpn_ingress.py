...
import capo_ec2.types.authorize_client_vpn_ingress_request
import capo_ec2.types.authorize_client_vpn_ingress_result
...
) -> capo_ec2.types.authorize_client_vpn_ingress_result.AuthorizeClientVpnIngressResult:
    out: capo_ec2.types.authorize_client_vpn_ingress_result.AuthorizeClientVpnIngressResult = capo_ec2.types.authorize_client_vpn_ingress_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.authorize_client_vpn_ingress_request.serialize_ec2_query(
        input_, pairs, ""
    )
