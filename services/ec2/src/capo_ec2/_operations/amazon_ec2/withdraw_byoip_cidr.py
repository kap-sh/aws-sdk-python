...
def handle_response(
    ...
    out: capo_ec2.types.withdraw_byoip_cidr_result.WithdrawByoipCidrResult = (
        capo_ec2.types.withdraw_byoip_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "WithdrawByoipCidr"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.withdraw_byoip_cidr_request.serialize_ec2_query(input_, pairs, "")
...
def withdraw_byoip_cidr(
    ...
    capo_ec2.types.withdraw_byoip_cidr_result.WithdrawByoipCidrResult, zapros.Response
]:
