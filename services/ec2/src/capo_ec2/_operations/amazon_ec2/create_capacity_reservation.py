"""Generated from Smithy shape ``com.amazonaws.ec2#CreateCapacityReservation``."""
...
import capo_ec2.types.create_capacity_reservation_result
...
) -> capo_ec2.types.create_capacity_reservation_result.CreateCapacityReservationResult:
    out: capo_ec2.types.create_capacity_reservation_result.CreateCapacityReservationResult = capo_ec2.types.create_capacity_reservation_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateCapacityReservation"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_capacity_reservation_request.serialize_ec2_query(
        input_, pairs, ""
    )
