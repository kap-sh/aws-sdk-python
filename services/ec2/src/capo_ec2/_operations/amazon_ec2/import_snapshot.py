...
import capo_ec2.types.import_snapshot_request
import capo_ec2.types.import_snapshot_result
...
) -> capo_ec2.types.import_snapshot_result.ImportSnapshotResult:
    out: capo_ec2.types.import_snapshot_result.ImportSnapshotResult = (
        capo_ec2.types.import_snapshot_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ImportSnapshot"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.import_snapshot_request.serialize_ec2_query(input_, pairs, "")
...
def import_snapshot(
    ...
    input_: capo_ec2.types.import_snapshot_request.ImportSnapshotRequest,
) -> tuple[capo_ec2.types.import_snapshot_result.ImportSnapshotResult, zapros.Response]:
