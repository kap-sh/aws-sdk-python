"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeCapacityReservations``."""
...
import capo_ec2.types.describe_capacity_reservations_request
import capo_ec2.types.describe_capacity_reservations_result
...
) -> capo_ec2.types.describe_capacity_reservations_result.DescribeCapacityReservationsResult:
    out: capo_ec2.types.describe_capacity_reservations_result.DescribeCapacityReservationsResult = capo_ec2.types.describe_capacity_reservations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeCapacityReservations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_capacity_reservations_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_capacity_reservations(
