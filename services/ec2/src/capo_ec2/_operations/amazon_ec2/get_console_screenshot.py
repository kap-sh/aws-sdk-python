...
import capo_ec2.types.get_console_screenshot_request
import capo_ec2.types.get_console_screenshot_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_console_screenshot_result.GetConsoleScreenshotResult = (
        capo_ec2.types.get_console_screenshot_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_console_screenshot_request.serialize_ec2_query(input_, pairs, "")
