...
) -> capo_ec2.types.create_capacity_manager_data_export_result.CreateCapacityManagerDataExportResult:
    out: capo_ec2.types.create_capacity_manager_data_export_result.CreateCapacityManagerDataExportResult = capo_ec2.types.create_capacity_manager_data_export_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateCapacityManagerDataExport"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_capacity_manager_data_export_request.serialize_ec2_query(
        input_, pairs, ""
    )
