...
import capo_ec2.types.describe_fpga_images_request
import capo_ec2.types.describe_fpga_images_result
...
) -> capo_ec2.types.describe_fpga_images_result.DescribeFpgaImagesResult:
    out: capo_ec2.types.describe_fpga_images_result.DescribeFpgaImagesResult = (
        capo_ec2.types.describe_fpga_images_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_fpga_images_request.serialize_ec2_query(input_, pairs, "")
...
def describe_fpga_images(
    ...
    capo_ec2.types.describe_fpga_images_result.DescribeFpgaImagesResult, zapros.Response
]:
