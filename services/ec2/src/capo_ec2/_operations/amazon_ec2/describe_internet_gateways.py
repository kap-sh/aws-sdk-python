"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeInternetGateways``."""
...
import capo_ec2.types.describe_internet_gateways_request
import capo_ec2.types.describe_internet_gateways_result
...
) -> capo_ec2.types.describe_internet_gateways_result.DescribeInternetGatewaysResult:
    out: capo_ec2.types.describe_internet_gateways_result.DescribeInternetGatewaysResult = capo_ec2.types.describe_internet_gateways_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeInternetGateways"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_internet_gateways_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_internet_gateways(
