...
def handle_response(
    ...
    capo_ec2.types.revoke_security_group_ingress_result.RevokeSecurityGroupIngressResult
):
    out: capo_ec2.types.revoke_security_group_ingress_result.RevokeSecurityGroupIngressResult = capo_ec2.types.revoke_security_group_ingress_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.revoke_security_group_ingress_request.serialize_ec2_query(
        input_, pairs, ""
    )
