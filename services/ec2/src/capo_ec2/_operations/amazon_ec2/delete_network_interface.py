...
import capo_ec2.types.delete_network_interface_request
...
def build_request(
    ...
    pairs.append(("Action", "DeleteNetworkInterface"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_network_interface_request.serialize_ec2_query(
        input_, pairs, ""
    )
