...
import capo_ec2.types.get_console_output_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_console_output_result.GetConsoleOutputResult = (
        capo_ec2.types.get_console_output_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetConsoleOutput"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_console_output_request.serialize_ec2_query(input_, pairs, "")
...
def get_console_output(
    ...
    capo_ec2.types.get_console_output_result.GetConsoleOutputResult, zapros.Response
]:
