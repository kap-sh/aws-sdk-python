"""Generated from Smithy shape ``com.amazonaws.ec2#GetInstanceMetadataDefaults``."""
...
import capo_ec2.types.get_instance_metadata_defaults_request
import capo_ec2.types.get_instance_metadata_defaults_result
...
) -> capo_ec2.types.get_instance_metadata_defaults_result.GetInstanceMetadataDefaultsResult:
    out: capo_ec2.types.get_instance_metadata_defaults_result.GetInstanceMetadataDefaultsResult = capo_ec2.types.get_instance_metadata_defaults_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetInstanceMetadataDefaults"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_instance_metadata_defaults_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_get_instance_metadata_defaults(
