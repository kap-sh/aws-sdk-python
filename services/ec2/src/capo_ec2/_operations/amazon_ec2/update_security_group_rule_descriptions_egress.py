...
import capo_ec2.types.update_security_group_rule_descriptions_egress_request
import capo_ec2.types.update_security_group_rule_descriptions_egress_result
...
) -> capo_ec2.types.update_security_group_rule_descriptions_egress_result.UpdateSecurityGroupRuleDescriptionsEgressResult:
    out: capo_ec2.types.update_security_group_rule_descriptions_egress_result.UpdateSecurityGroupRuleDescriptionsEgressResult = capo_ec2.types.update_security_group_rule_descriptions_egress_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.update_security_group_rule_descriptions_egress_request.serialize_ec2_query(
        input_, pairs, ""
    )
