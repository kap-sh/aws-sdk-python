...
import capo_ec2.types.modify_vpc_endpoint_service_permissions_request
import capo_ec2.types.modify_vpc_endpoint_service_permissions_result
...
) -> capo_ec2.types.modify_vpc_endpoint_service_permissions_result.ModifyVpcEndpointServicePermissionsResult:
    out: capo_ec2.types.modify_vpc_endpoint_service_permissions_result.ModifyVpcEndpointServicePermissionsResult = capo_ec2.types.modify_vpc_endpoint_service_permissions_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_vpc_endpoint_service_permissions_request.serialize_ec2_query(
        input_, pairs, ""
    )
