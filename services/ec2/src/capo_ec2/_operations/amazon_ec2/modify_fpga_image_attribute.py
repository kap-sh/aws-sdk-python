...
import capo_ec2.types.modify_fpga_image_attribute_request
import capo_ec2.types.modify_fpga_image_attribute_result
...
) -> capo_ec2.types.modify_fpga_image_attribute_result.ModifyFpgaImageAttributeResult:
    out: capo_ec2.types.modify_fpga_image_attribute_result.ModifyFpgaImageAttributeResult = capo_ec2.types.modify_fpga_image_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyFpgaImageAttribute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_fpga_image_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
