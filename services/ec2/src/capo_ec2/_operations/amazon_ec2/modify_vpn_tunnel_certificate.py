...
import capo_ec2.types.modify_vpn_tunnel_certificate_request
import capo_ec2.types.modify_vpn_tunnel_certificate_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_vpn_tunnel_certificate_result.ModifyVpnTunnelCertificateResult = capo_ec2.types.modify_vpn_tunnel_certificate_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyVpnTunnelCertificate"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_vpn_tunnel_certificate_request.serialize_ec2_query(
        input_, pairs, ""
    )
