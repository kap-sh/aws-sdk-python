...
import capo_ec2.types.describe_store_image_tasks_request
import capo_ec2.types.describe_store_image_tasks_result
import capo_ec2.types.filter_list
import capo_ec2.types.image_id_list
import capo_ec2.types.store_image_task_result_set
...
) -> capo_ec2.types.describe_store_image_tasks_result.DescribeStoreImageTasksResult:
    out: capo_ec2.types.describe_store_image_tasks_result.DescribeStoreImageTasksResult = capo_ec2.types.describe_store_image_tasks_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeStoreImageTasks"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_store_image_tasks_request.serialize_ec2_query(
        input_, pairs, ""
    )
