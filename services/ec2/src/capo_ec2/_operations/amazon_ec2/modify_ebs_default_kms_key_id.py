...
import capo_ec2.types.modify_ebs_default_kms_key_id_request
import capo_ec2.types.modify_ebs_default_kms_key_id_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_ebs_default_kms_key_id_result.ModifyEbsDefaultKmsKeyIdResult = capo_ec2.types.modify_ebs_default_kms_key_id_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyEbsDefaultKmsKeyId"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_ebs_default_kms_key_id_request.serialize_ec2_query(
        input_, pairs, ""
    )
