"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTransitGatewayConnect``."""
...
import capo_ec2.types.delete_transit_gateway_connect_request
import capo_ec2.types.delete_transit_gateway_connect_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_transit_gateway_connect_result.DeleteTransitGatewayConnectResult = capo_ec2.types.delete_transit_gateway_connect_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteTransitGatewayConnect"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_transit_gateway_connect_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_transit_gateway_connect(
