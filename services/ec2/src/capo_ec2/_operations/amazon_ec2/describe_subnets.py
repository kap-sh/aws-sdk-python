...
import capo_ec2.types.describe_subnets_request
import capo_ec2.types.describe_subnets_result
...
) -> capo_ec2.types.describe_subnets_result.DescribeSubnetsResult:
    out: capo_ec2.types.describe_subnets_result.DescribeSubnetsResult = (
        capo_ec2.types.describe_subnets_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_subnets_request.serialize_ec2_query(input_, pairs, "")
...
def describe_subnets(
    ...
    capo_ec2.types.describe_subnets_result.DescribeSubnetsResult, zapros.Response
]:
