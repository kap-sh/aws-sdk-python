...
import capo_ec2.types.cancel_declarative_policies_report_request
import capo_ec2.types.cancel_declarative_policies_report_result
...
def handle_response(
    ...
    out: capo_ec2.types.cancel_declarative_policies_report_result.CancelDeclarativePoliciesReportResult = capo_ec2.types.cancel_declarative_policies_report_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CancelDeclarativePoliciesReport"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.cancel_declarative_policies_report_request.serialize_ec2_query(
        input_, pairs, ""
    )
