"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTransitGatewayPolicyTableEntry``."""
...
def handle_response(
    ...
    out: capo_ec2.types.delete_transit_gateway_policy_table_entry_result.DeleteTransitGatewayPolicyTableEntryResult = capo_ec2.types.delete_transit_gateway_policy_table_entry_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteTransitGatewayPolicyTableEntry"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_transit_gateway_policy_table_entry_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_transit_gateway_policy_table_entry(
