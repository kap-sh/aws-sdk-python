...
import capo_ec2.types.accept_address_transfer_request
import capo_ec2.types.accept_address_transfer_result
...
) -> capo_ec2.types.accept_address_transfer_result.AcceptAddressTransferResult:
    out: capo_ec2.types.accept_address_transfer_result.AcceptAddressTransferResult = (
        capo_ec2.types.accept_address_transfer_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AcceptAddressTransfer"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.accept_address_transfer_request.serialize_ec2_query(
        input_, pairs, ""
    )
