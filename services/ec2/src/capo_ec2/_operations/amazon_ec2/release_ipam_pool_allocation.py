...
import capo_ec2.types.release_ipam_pool_allocation_request
import capo_ec2.types.release_ipam_pool_allocation_result
...
def handle_response(
    ...
    out: capo_ec2.types.release_ipam_pool_allocation_result.ReleaseIpamPoolAllocationResult = capo_ec2.types.release_ipam_pool_allocation_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.release_ipam_pool_allocation_request.serialize_ec2_query(
        input_, pairs, ""
    )
