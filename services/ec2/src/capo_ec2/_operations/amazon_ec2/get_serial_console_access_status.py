...
import capo_ec2.types.get_serial_console_access_status_request
import capo_ec2.types.get_serial_console_access_status_result
...
) -> capo_ec2.types.get_serial_console_access_status_result.GetSerialConsoleAccessStatusResult:
    out: capo_ec2.types.get_serial_console_access_status_result.GetSerialConsoleAccessStatusResult = capo_ec2.types.get_serial_console_access_status_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetSerialConsoleAccessStatus"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_serial_console_access_status_request.serialize_ec2_query(
        input_, pairs, ""
    )
