...
import capo_ec2.types.describe_host_reservations_request
import capo_ec2.types.describe_host_reservations_result
import capo_ec2.types.filter_list
import capo_ec2.types.host_reservation_id_set
import capo_ec2.types.host_reservation_set
...
) -> capo_ec2.types.describe_host_reservations_result.DescribeHostReservationsResult:
    out: capo_ec2.types.describe_host_reservations_result.DescribeHostReservationsResult = capo_ec2.types.describe_host_reservations_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_host_reservations_request.serialize_ec2_query(
        input_, pairs, ""
    )
