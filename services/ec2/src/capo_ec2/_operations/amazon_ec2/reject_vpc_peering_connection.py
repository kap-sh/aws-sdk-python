...
import capo_ec2.types.reject_vpc_peering_connection_request
import capo_ec2.types.reject_vpc_peering_connection_result
...
def handle_response(
    ...
    out: capo_ec2.types.reject_vpc_peering_connection_result.RejectVpcPeeringConnectionResult = capo_ec2.types.reject_vpc_peering_connection_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.reject_vpc_peering_connection_request.serialize_ec2_query(
        input_, pairs, ""
    )
