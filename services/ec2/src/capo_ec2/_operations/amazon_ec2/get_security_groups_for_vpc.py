...
import capo_ec2.types.get_security_groups_for_vpc_request
import capo_ec2.types.get_security_groups_for_vpc_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_security_groups_for_vpc_result.GetSecurityGroupsForVpcResult = capo_ec2.types.get_security_groups_for_vpc_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetSecurityGroupsForVpc"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_security_groups_for_vpc_request.serialize_ec2_query(
        input_, pairs, ""
    )
