"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteRouteServerEndpoint``."""
...
import capo_ec2.types.delete_route_server_endpoint_request
import capo_ec2.types.delete_route_server_endpoint_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_route_server_endpoint_result.DeleteRouteServerEndpointResult = capo_ec2.types.delete_route_server_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteRouteServerEndpoint"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_route_server_endpoint_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_route_server_endpoint(
