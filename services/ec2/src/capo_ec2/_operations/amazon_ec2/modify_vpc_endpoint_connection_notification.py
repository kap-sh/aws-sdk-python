...
) -> capo_ec2.types.modify_vpc_endpoint_connection_notification_result.ModifyVpcEndpointConnectionNotificationResult:
    out: capo_ec2.types.modify_vpc_endpoint_connection_notification_result.ModifyVpcEndpointConnectionNotificationResult = capo_ec2.types.modify_vpc_endpoint_connection_notification_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_vpc_endpoint_connection_notification_request.serialize_ec2_query(
        input_, pairs, ""
    )
