...
import capo_ec2.types.describe_secondary_networks_request
import capo_ec2.types.describe_secondary_networks_result
...
) -> capo_ec2.types.describe_secondary_networks_result.DescribeSecondaryNetworksResult:
    out: capo_ec2.types.describe_secondary_networks_result.DescribeSecondaryNetworksResult = capo_ec2.types.describe_secondary_networks_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeSecondaryNetworks"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_secondary_networks_request.serialize_ec2_query(
        input_, pairs, ""
    )
