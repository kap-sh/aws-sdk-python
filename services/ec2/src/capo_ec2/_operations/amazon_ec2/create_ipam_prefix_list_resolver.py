...
import capo_ec2.types.create_ipam_prefix_list_resolver_request
import capo_ec2.types.create_ipam_prefix_list_resolver_result
...
) -> capo_ec2.types.create_ipam_prefix_list_resolver_result.CreateIpamPrefixListResolverResult:
    out: capo_ec2.types.create_ipam_prefix_list_resolver_result.CreateIpamPrefixListResolverResult = capo_ec2.types.create_ipam_prefix_list_resolver_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateIpamPrefixListResolver"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_ipam_prefix_list_resolver_request.serialize_ec2_query(
        input_, pairs, ""
    )
