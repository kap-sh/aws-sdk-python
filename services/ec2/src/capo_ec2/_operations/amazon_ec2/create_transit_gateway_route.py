...
import capo_ec2.types.create_transit_gateway_route_request
import capo_ec2.types.create_transit_gateway_route_result
...
) -> capo_ec2.types.create_transit_gateway_route_result.CreateTransitGatewayRouteResult:
    out: capo_ec2.types.create_transit_gateway_route_result.CreateTransitGatewayRouteResult = capo_ec2.types.create_transit_gateway_route_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateTransitGatewayRoute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_transit_gateway_route_request.serialize_ec2_query(
        input_, pairs, ""
    )
