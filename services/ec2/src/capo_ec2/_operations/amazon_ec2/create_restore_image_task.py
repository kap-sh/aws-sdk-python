...
import capo_ec2.types.create_restore_image_task_request
import capo_ec2.types.create_restore_image_task_result
...
) -> capo_ec2.types.create_restore_image_task_result.CreateRestoreImageTaskResult:
    out: capo_ec2.types.create_restore_image_task_result.CreateRestoreImageTaskResult = capo_ec2.types.create_restore_image_task_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateRestoreImageTask"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_restore_image_task_request.serialize_ec2_query(
        input_, pairs, ""
    )
