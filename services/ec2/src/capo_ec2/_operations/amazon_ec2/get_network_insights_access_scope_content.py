...
import capo_ec2.types.get_network_insights_access_scope_content_request
import capo_ec2.types.get_network_insights_access_scope_content_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_network_insights_access_scope_content_result.GetNetworkInsightsAccessScopeContentResult = capo_ec2.types.get_network_insights_access_scope_content_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetNetworkInsightsAccessScopeContent"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_network_insights_access_scope_content_request.serialize_ec2_query(
        input_, pairs, ""
    )
