...
import capo_ec2.types.describe_route_server_peers_request
import capo_ec2.types.describe_route_server_peers_result
...
) -> capo_ec2.types.describe_route_server_peers_result.DescribeRouteServerPeersResult:
    out: capo_ec2.types.describe_route_server_peers_result.DescribeRouteServerPeersResult = capo_ec2.types.describe_route_server_peers_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_route_server_peers_request.serialize_ec2_query(
        input_, pairs, ""
    )
