...
import capo_ec2.types.create_flow_logs_request
import capo_ec2.types.create_flow_logs_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_flow_logs_result.CreateFlowLogsResult = (
        capo_ec2.types.create_flow_logs_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateFlowLogs"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_flow_logs_request.serialize_ec2_query(input_, pairs, "")
...
def create_flow_logs(
    ...
    capo_ec2.types.create_flow_logs_result.CreateFlowLogsResult, zapros.Response
]:
