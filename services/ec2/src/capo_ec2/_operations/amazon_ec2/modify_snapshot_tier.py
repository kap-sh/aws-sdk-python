...
import capo_ec2.types.modify_snapshot_tier_request
import capo_ec2.types.modify_snapshot_tier_result
...
) -> capo_ec2.types.modify_snapshot_tier_result.ModifySnapshotTierResult:
    out: capo_ec2.types.modify_snapshot_tier_result.ModifySnapshotTierResult = (
        capo_ec2.types.modify_snapshot_tier_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_snapshot_tier_request.serialize_ec2_query(input_, pairs, "")
...
def modify_snapshot_tier(
    ...
    capo_ec2.types.modify_snapshot_tier_result.ModifySnapshotTierResult, zapros.Response
]:
