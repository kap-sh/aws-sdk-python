...
) -> capo_ec2.types.describe_aggregate_id_format_result.DescribeAggregateIdFormatResult:
    out: capo_ec2.types.describe_aggregate_id_format_result.DescribeAggregateIdFormatResult = capo_ec2.types.describe_aggregate_id_format_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_aggregate_id_format_request.serialize_ec2_query(
        input_, pairs, ""
    )
