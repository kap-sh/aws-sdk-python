...
import capo_ec2.types.delete_egress_only_internet_gateway_request
import capo_ec2.types.delete_egress_only_internet_gateway_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_egress_only_internet_gateway_result.DeleteEgressOnlyInternetGatewayResult = capo_ec2.types.delete_egress_only_internet_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_egress_only_internet_gateway_request.serialize_ec2_query(
        input_, pairs, ""
    )
