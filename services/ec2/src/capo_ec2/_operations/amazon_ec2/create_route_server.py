...
import capo_ec2.types.create_route_server_request
import capo_ec2.types.create_route_server_result
...
) -> capo_ec2.types.create_route_server_result.CreateRouteServerResult:
    out: capo_ec2.types.create_route_server_result.CreateRouteServerResult = (
        capo_ec2.types.create_route_server_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateRouteServer"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_route_server_request.serialize_ec2_query(input_, pairs, "")
...
def create_route_server(
    ...
    capo_ec2.types.create_route_server_result.CreateRouteServerResult, zapros.Response
]:
