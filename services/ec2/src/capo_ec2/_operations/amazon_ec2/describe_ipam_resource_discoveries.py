...
import capo_ec2.types.describe_ipam_resource_discoveries_request
import capo_ec2.types.describe_ipam_resource_discoveries_result
...
) -> capo_ec2.types.describe_ipam_resource_discoveries_result.DescribeIpamResourceDiscoveriesResult:
    out: capo_ec2.types.describe_ipam_resource_discoveries_result.DescribeIpamResourceDiscoveriesResult = capo_ec2.types.describe_ipam_resource_discoveries_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeIpamResourceDiscoveries"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_ipam_resource_discoveries_request.serialize_ec2_query(
        input_, pairs, ""
    )
