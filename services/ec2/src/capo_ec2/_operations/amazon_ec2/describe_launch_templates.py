...
import capo_ec2.types.describe_launch_templates_request
import capo_ec2.types.describe_launch_templates_result
...
) -> capo_ec2.types.describe_launch_templates_result.DescribeLaunchTemplatesResult:
    out: capo_ec2.types.describe_launch_templates_result.DescribeLaunchTemplatesResult = capo_ec2.types.describe_launch_templates_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeLaunchTemplates"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_launch_templates_request.serialize_ec2_query(
        input_, pairs, ""
    )
