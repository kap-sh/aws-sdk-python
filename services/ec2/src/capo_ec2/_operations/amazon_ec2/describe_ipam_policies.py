"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeIpamPolicies``."""
...
) -> capo_ec2.types.describe_ipam_policies_result.DescribeIpamPoliciesResult:
    out: capo_ec2.types.describe_ipam_policies_result.DescribeIpamPoliciesResult = (
        capo_ec2.types.describe_ipam_policies_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeIpamPolicies"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_ipam_policies_request.serialize_ec2_query(input_, pairs, "")
...
async def async_describe_ipam_policies(
