...
def handle_response(
    ...
    out: capo_ec2.types.delete_ipam_external_resource_verification_token_result.DeleteIpamExternalResourceVerificationTokenResult = capo_ec2.types.delete_ipam_external_resource_verification_token_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_ipam_external_resource_verification_token_request.serialize_ec2_query(
        input_, pairs, ""
    )
