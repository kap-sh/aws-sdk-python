...
import capo_ec2.types.start_instances_request
import capo_ec2.types.start_instances_result
...
def handle_response(
    ...
    out: capo_ec2.types.start_instances_result.StartInstancesResult = (
        capo_ec2.types.start_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.start_instances_request.serialize_ec2_query(input_, pairs, "")
...
def start_instances(
    ...
    input_: capo_ec2.types.start_instances_request.StartInstancesRequest,
) -> tuple[capo_ec2.types.start_instances_result.StartInstancesResult, zapros.Response]:
