...
import capo_ec2.types.get_verified_access_group_policy_request
import capo_ec2.types.get_verified_access_group_policy_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_verified_access_group_policy_result.GetVerifiedAccessGroupPolicyResult = capo_ec2.types.get_verified_access_group_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_verified_access_group_policy_request.serialize_ec2_query(
        input_, pairs, ""
    )
