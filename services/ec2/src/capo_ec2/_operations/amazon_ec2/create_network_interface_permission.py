...
import capo_ec2.types.create_network_interface_permission_request
import capo_ec2.types.create_network_interface_permission_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_network_interface_permission_result.CreateNetworkInterfacePermissionResult = capo_ec2.types.create_network_interface_permission_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateNetworkInterfacePermission"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_network_interface_permission_request.serialize_ec2_query(
        input_, pairs, ""
    )
