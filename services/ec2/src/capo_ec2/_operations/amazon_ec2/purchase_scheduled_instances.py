"""Generated from Smithy shape ``com.amazonaws.ec2#PurchaseScheduledInstances``."""
...
import capo_ec2.types.purchase_scheduled_instances_request
import capo_ec2.types.purchase_scheduled_instances_result
...
def handle_response(
    ...
    out: capo_ec2.types.purchase_scheduled_instances_result.PurchaseScheduledInstancesResult = capo_ec2.types.purchase_scheduled_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "PurchaseScheduledInstances"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.purchase_scheduled_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_purchase_scheduled_instances(
