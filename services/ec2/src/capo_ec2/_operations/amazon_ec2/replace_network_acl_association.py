...
def handle_response(
    ...
    out: capo_ec2.types.replace_network_acl_association_result.ReplaceNetworkAclAssociationResult = capo_ec2.types.replace_network_acl_association_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.replace_network_acl_association_request.serialize_ec2_query(
        input_, pairs, ""
    )
