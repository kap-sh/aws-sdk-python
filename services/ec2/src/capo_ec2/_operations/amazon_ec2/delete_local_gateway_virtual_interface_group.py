...
import capo_ec2.types.delete_local_gateway_virtual_interface_group_request
import capo_ec2.types.delete_local_gateway_virtual_interface_group_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_local_gateway_virtual_interface_group_result.DeleteLocalGatewayVirtualInterfaceGroupResult = capo_ec2.types.delete_local_gateway_virtual_interface_group_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_local_gateway_virtual_interface_group_request.serialize_ec2_query(
        input_, pairs, ""
    )
