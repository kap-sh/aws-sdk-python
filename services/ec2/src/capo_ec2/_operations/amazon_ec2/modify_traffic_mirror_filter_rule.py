...
import capo_ec2.types.modify_traffic_mirror_filter_rule_request
import capo_ec2.types.modify_traffic_mirror_filter_rule_result
...
) -> capo_ec2.types.modify_traffic_mirror_filter_rule_result.ModifyTrafficMirrorFilterRuleResult:
    out: capo_ec2.types.modify_traffic_mirror_filter_rule_result.ModifyTrafficMirrorFilterRuleResult = capo_ec2.types.modify_traffic_mirror_filter_rule_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyTrafficMirrorFilterRule"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_traffic_mirror_filter_rule_request.serialize_ec2_query(
        input_, pairs, ""
    )
