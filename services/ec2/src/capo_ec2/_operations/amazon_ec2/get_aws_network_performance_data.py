...
import capo_ec2.types.get_aws_network_performance_data_request
import capo_ec2.types.get_aws_network_performance_data_result
...
) -> capo_ec2.types.get_aws_network_performance_data_result.GetAwsNetworkPerformanceDataResult:
    out: capo_ec2.types.get_aws_network_performance_data_result.GetAwsNetworkPerformanceDataResult = capo_ec2.types.get_aws_network_performance_data_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetAwsNetworkPerformanceData"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_aws_network_performance_data_request.serialize_ec2_query(
        input_, pairs, ""
    )
