"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyVpcEndpointServiceConfiguration``."""
...
import capo_ec2.types.modify_vpc_endpoint_service_configuration_result
...
) -> capo_ec2.types.modify_vpc_endpoint_service_configuration_result.ModifyVpcEndpointServiceConfigurationResult:
    out: capo_ec2.types.modify_vpc_endpoint_service_configuration_result.ModifyVpcEndpointServiceConfigurationResult = capo_ec2.types.modify_vpc_endpoint_service_configuration_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyVpcEndpointServiceConfiguration"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_vpc_endpoint_service_configuration_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_vpc_endpoint_service_configuration(
