...
import capo_ec2.types.provision_ipam_byoasn_request
import capo_ec2.types.provision_ipam_byoasn_result
...
def handle_response(
    ...
    out: capo_ec2.types.provision_ipam_byoasn_result.ProvisionIpamByoasnResult = (
        capo_ec2.types.provision_ipam_byoasn_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.provision_ipam_byoasn_request.serialize_ec2_query(input_, pairs, "")
