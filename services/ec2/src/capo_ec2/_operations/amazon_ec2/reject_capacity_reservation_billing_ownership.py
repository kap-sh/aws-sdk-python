...
import capo_ec2.types.reject_capacity_reservation_billing_ownership_request
import capo_ec2.types.reject_capacity_reservation_billing_ownership_result
...
def handle_response(
    ...
    out: capo_ec2.types.reject_capacity_reservation_billing_ownership_result.RejectCapacityReservationBillingOwnershipResult = capo_ec2.types.reject_capacity_reservation_billing_ownership_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "RejectCapacityReservationBillingOwnership"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.reject_capacity_reservation_billing_ownership_request.serialize_ec2_query(
        input_, pairs, ""
    )
