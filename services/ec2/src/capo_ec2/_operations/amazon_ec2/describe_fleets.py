...
import capo_ec2.types.describe_fleets_request
import capo_ec2.types.describe_fleets_result
...
) -> capo_ec2.types.describe_fleets_result.DescribeFleetsResult:
    out: capo_ec2.types.describe_fleets_result.DescribeFleetsResult = (
        capo_ec2.types.describe_fleets_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_fleets_request.serialize_ec2_query(input_, pairs, "")
...
def describe_fleets(
    ...
    input_: capo_ec2.types.describe_fleets_request.DescribeFleetsRequest,
) -> tuple[capo_ec2.types.describe_fleets_result.DescribeFleetsResult, zapros.Response]:
