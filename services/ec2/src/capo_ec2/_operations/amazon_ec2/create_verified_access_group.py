...
import capo_ec2.types.create_verified_access_group_request
import capo_ec2.types.create_verified_access_group_result
...
) -> capo_ec2.types.create_verified_access_group_result.CreateVerifiedAccessGroupResult:
    out: capo_ec2.types.create_verified_access_group_result.CreateVerifiedAccessGroupResult = capo_ec2.types.create_verified_access_group_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_verified_access_group_request.serialize_ec2_query(
        input_, pairs, ""
    )
