...
import capo_ec2.types.describe_instance_connect_endpoints_request
import capo_ec2.types.describe_instance_connect_endpoints_result
...
) -> capo_ec2.types.describe_instance_connect_endpoints_result.DescribeInstanceConnectEndpointsResult:
    out: capo_ec2.types.describe_instance_connect_endpoints_result.DescribeInstanceConnectEndpointsResult = capo_ec2.types.describe_instance_connect_endpoints_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeInstanceConnectEndpoints"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_instance_connect_endpoints_request.serialize_ec2_query(
        input_, pairs, ""
    )
