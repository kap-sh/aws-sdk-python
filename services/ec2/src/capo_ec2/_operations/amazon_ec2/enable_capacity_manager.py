...
import capo_ec2.types.enable_capacity_manager_result
...
) -> capo_ec2.types.enable_capacity_manager_result.EnableCapacityManagerResult:
    out: capo_ec2.types.enable_capacity_manager_result.EnableCapacityManagerResult = (
        capo_ec2.types.enable_capacity_manager_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "EnableCapacityManager"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.enable_capacity_manager_request.serialize_ec2_query(
        input_, pairs, ""
    )
