...
import capo_ec2.types.delete_instance_connect_endpoint_request
import capo_ec2.types.delete_instance_connect_endpoint_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_instance_connect_endpoint_result.DeleteInstanceConnectEndpointResult = capo_ec2.types.delete_instance_connect_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_instance_connect_endpoint_request.serialize_ec2_query(
        input_, pairs, ""
    )
