...
import capo_ec2.types.describe_security_group_rules_request
import capo_ec2.types.describe_security_group_rules_result
...
def handle_response(
    ...
    capo_ec2.types.describe_security_group_rules_result.DescribeSecurityGroupRulesResult
):
    out: capo_ec2.types.describe_security_group_rules_result.DescribeSecurityGroupRulesResult = capo_ec2.types.describe_security_group_rules_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_security_group_rules_request.serialize_ec2_query(
        input_, pairs, ""
    )
