...
import capo_ec2.types.provision_public_ipv4_pool_cidr_request
import capo_ec2.types.provision_public_ipv4_pool_cidr_result
...
def handle_response(
    ...
    out: capo_ec2.types.provision_public_ipv4_pool_cidr_result.ProvisionPublicIpv4PoolCidrResult = capo_ec2.types.provision_public_ipv4_pool_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ProvisionPublicIpv4PoolCidr"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.provision_public_ipv4_pool_cidr_request.serialize_ec2_query(
        input_, pairs, ""
    )
