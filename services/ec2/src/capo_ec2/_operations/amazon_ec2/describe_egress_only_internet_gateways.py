...
import capo_ec2.types.describe_egress_only_internet_gateways_request
import capo_ec2.types.describe_egress_only_internet_gateways_result
...
) -> capo_ec2.types.describe_egress_only_internet_gateways_result.DescribeEgressOnlyInternetGatewaysResult:
    out: capo_ec2.types.describe_egress_only_internet_gateways_result.DescribeEgressOnlyInternetGatewaysResult = capo_ec2.types.describe_egress_only_internet_gateways_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeEgressOnlyInternetGateways"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_egress_only_internet_gateways_request.serialize_ec2_query(
        input_, pairs, ""
    )
