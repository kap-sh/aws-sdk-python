...
import capo_ec2.types.get_transit_gateway_policy_table_entries_request
import capo_ec2.types.get_transit_gateway_policy_table_entries_result
...
) -> capo_ec2.types.get_transit_gateway_policy_table_entries_result.GetTransitGatewayPolicyTableEntriesResult:
    out: capo_ec2.types.get_transit_gateway_policy_table_entries_result.GetTransitGatewayPolicyTableEntriesResult = capo_ec2.types.get_transit_gateway_policy_table_entries_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetTransitGatewayPolicyTableEntries"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_transit_gateway_policy_table_entries_request.serialize_ec2_query(
        input_, pairs, ""
    )
