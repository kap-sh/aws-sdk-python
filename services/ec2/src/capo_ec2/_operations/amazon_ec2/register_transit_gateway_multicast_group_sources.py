...
import capo_ec2.types.register_transit_gateway_multicast_group_sources_request
import capo_ec2.types.register_transit_gateway_multicast_group_sources_result
...
def handle_response(
    ...
    out: capo_ec2.types.register_transit_gateway_multicast_group_sources_result.RegisterTransitGatewayMulticastGroupSourcesResult = capo_ec2.types.register_transit_gateway_multicast_group_sources_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "RegisterTransitGatewayMulticastGroupSources"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.register_transit_gateway_multicast_group_sources_request.serialize_ec2_query(
        input_, pairs, ""
    )
