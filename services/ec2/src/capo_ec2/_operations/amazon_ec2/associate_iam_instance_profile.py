...
def handle_response(
    ...
    out: capo_ec2.types.associate_iam_instance_profile_result.AssociateIamInstanceProfileResult = capo_ec2.types.associate_iam_instance_profile_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AssociateIamInstanceProfile"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.associate_iam_instance_profile_request.serialize_ec2_query(
        input_, pairs, ""
    )
