...
import capo_ec2.types.disassociate_iam_instance_profile_request
import capo_ec2.types.disassociate_iam_instance_profile_result
...
def handle_response(
    ...
    out: capo_ec2.types.disassociate_iam_instance_profile_result.DisassociateIamInstanceProfileResult = capo_ec2.types.disassociate_iam_instance_profile_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisassociateIamInstanceProfile"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disassociate_iam_instance_profile_request.serialize_ec2_query(
        input_, pairs, ""
    )
