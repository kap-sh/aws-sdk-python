...
import capo_ec2.types.get_declarative_policies_report_summary_request
import capo_ec2.types.get_declarative_policies_report_summary_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_declarative_policies_report_summary_result.GetDeclarativePoliciesReportSummaryResult = capo_ec2.types.get_declarative_policies_report_summary_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_declarative_policies_report_summary_request.serialize_ec2_query(
        input_, pairs, ""
    )
