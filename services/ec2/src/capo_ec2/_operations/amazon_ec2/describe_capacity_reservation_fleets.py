"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeCapacityReservationFleets``."""
...
) -> capo_ec2.types.describe_capacity_reservation_fleets_result.DescribeCapacityReservationFleetsResult:
    out: capo_ec2.types.describe_capacity_reservation_fleets_result.DescribeCapacityReservationFleetsResult = capo_ec2.types.describe_capacity_reservation_fleets_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeCapacityReservationFleets"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_capacity_reservation_fleets_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_capacity_reservation_fleets(
