...
import capo_ec2.types.assign_private_nat_gateway_address_request
...
) -> capo_ec2.types.assign_private_nat_gateway_address_result.AssignPrivateNatGatewayAddressResult:
    out: capo_ec2.types.assign_private_nat_gateway_address_result.AssignPrivateNatGatewayAddressResult = capo_ec2.types.assign_private_nat_gateway_address_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.assign_private_nat_gateway_address_request.serialize_ec2_query(
        input_, pairs, ""
    )
