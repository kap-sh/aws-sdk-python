...
import capo_ec2.types.search_local_gateway_routes_request
import capo_ec2.types.search_local_gateway_routes_result
...
) -> capo_ec2.types.search_local_gateway_routes_result.SearchLocalGatewayRoutesResult:
    out: capo_ec2.types.search_local_gateway_routes_result.SearchLocalGatewayRoutesResult = capo_ec2.types.search_local_gateway_routes_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.search_local_gateway_routes_request.serialize_ec2_query(
        input_, pairs, ""
    )
