...
import capo_ec2.types.export_verified_access_instance_client_configuration_request
import capo_ec2.types.export_verified_access_instance_client_configuration_result
...
def handle_response(
    ...
    out: capo_ec2.types.export_verified_access_instance_client_configuration_result.ExportVerifiedAccessInstanceClientConfigurationResult = capo_ec2.types.export_verified_access_instance_client_configuration_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.export_verified_access_instance_client_configuration_request.serialize_ec2_query(
        input_, pairs, ""
    )
