...
import capo_ec2.types.describe_aws_network_performance_metric_subscriptions_result
...
) -> capo_ec2.types.describe_aws_network_performance_metric_subscriptions_result.DescribeAwsNetworkPerformanceMetricSubscriptionsResult:
    out: capo_ec2.types.describe_aws_network_performance_metric_subscriptions_result.DescribeAwsNetworkPerformanceMetricSubscriptionsResult = capo_ec2.types.describe_aws_network_performance_metric_subscriptions_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeAwsNetworkPerformanceMetricSubscriptions"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_aws_network_performance_metric_subscriptions_request.serialize_ec2_query(
        input_, pairs, ""
    )
