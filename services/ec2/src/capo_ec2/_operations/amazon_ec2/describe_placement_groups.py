...
import capo_ec2.types.describe_placement_groups_request
import capo_ec2.types.describe_placement_groups_result
...
) -> capo_ec2.types.describe_placement_groups_result.DescribePlacementGroupsResult:
    out: capo_ec2.types.describe_placement_groups_result.DescribePlacementGroupsResult = capo_ec2.types.describe_placement_groups_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_placement_groups_request.serialize_ec2_query(
        input_, pairs, ""
    )
