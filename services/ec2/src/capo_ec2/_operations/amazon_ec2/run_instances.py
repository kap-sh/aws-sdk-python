...
import capo_ec2.types.run_instances_request
...
) -> capo_ec2.types.reservation.Reservation:
    out: capo_ec2.types.reservation.Reservation = (
        capo_ec2.types.reservation.deserialize_ec2_query(fromstring(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_ec2.types.reservation.Reservation = (
        capo_ec2.types.reservation.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "RunInstances"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.run_instances_request.serialize_ec2_query(input_, pairs, "")
...
def run_instances(
    ...
    input_: capo_ec2.types.run_instances_request.RunInstancesRequest,
) -> tuple[capo_ec2.types.reservation.Reservation, zapros.Response]:
