...
import capo_ec2.types.create_client_vpn_route_request
import capo_ec2.types.create_client_vpn_route_result
...
) -> capo_ec2.types.create_client_vpn_route_result.CreateClientVpnRouteResult:
    out: capo_ec2.types.create_client_vpn_route_result.CreateClientVpnRouteResult = (
        capo_ec2.types.create_client_vpn_route_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_client_vpn_route_request.serialize_ec2_query(
        input_, pairs, ""
    )
