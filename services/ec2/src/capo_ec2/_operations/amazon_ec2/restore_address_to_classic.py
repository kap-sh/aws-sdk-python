...
import capo_ec2.types.restore_address_to_classic_request
import capo_ec2.types.restore_address_to_classic_result
...
def handle_response(
    ...
    out: capo_ec2.types.restore_address_to_classic_result.RestoreAddressToClassicResult = capo_ec2.types.restore_address_to_classic_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.restore_address_to_classic_request.serialize_ec2_query(
        input_, pairs, ""
    )
