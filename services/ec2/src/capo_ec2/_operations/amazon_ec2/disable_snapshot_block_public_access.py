...
import capo_ec2.types.disable_snapshot_block_public_access_request
import capo_ec2.types.disable_snapshot_block_public_access_result
...
) -> capo_ec2.types.disable_snapshot_block_public_access_result.DisableSnapshotBlockPublicAccessResult:
    out: capo_ec2.types.disable_snapshot_block_public_access_result.DisableSnapshotBlockPublicAccessResult = capo_ec2.types.disable_snapshot_block_public_access_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.disable_snapshot_block_public_access_request.serialize_ec2_query(
        input_, pairs, ""
    )
