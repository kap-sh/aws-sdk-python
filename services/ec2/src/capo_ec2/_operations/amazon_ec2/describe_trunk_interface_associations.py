...
import capo_ec2.types.describe_trunk_interface_associations_request
import capo_ec2.types.describe_trunk_interface_associations_result
...
) -> capo_ec2.types.describe_trunk_interface_associations_result.DescribeTrunkInterfaceAssociationsResult:
    out: capo_ec2.types.describe_trunk_interface_associations_result.DescribeTrunkInterfaceAssociationsResult = capo_ec2.types.describe_trunk_interface_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeTrunkInterfaceAssociations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_trunk_interface_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
