...
import capo_ec2.types.create_secondary_network_request
import capo_ec2.types.create_secondary_network_result
...
) -> capo_ec2.types.create_secondary_network_result.CreateSecondaryNetworkResult:
    out: capo_ec2.types.create_secondary_network_result.CreateSecondaryNetworkResult = (
        capo_ec2.types.create_secondary_network_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_secondary_network_request.serialize_ec2_query(
        input_, pairs, ""
    )
