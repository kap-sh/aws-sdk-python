...
import capo_ec2.types.describe_instance_sql_ha_states_request
import capo_ec2.types.describe_instance_sql_ha_states_result
...
def handle_response(
    ...
    out: capo_ec2.types.describe_instance_sql_ha_states_result.DescribeInstanceSqlHaStatesResult = capo_ec2.types.describe_instance_sql_ha_states_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_instance_sql_ha_states_request.serialize_ec2_query(
        input_, pairs, ""
    )
