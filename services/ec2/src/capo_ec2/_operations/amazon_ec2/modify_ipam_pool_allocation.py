"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyIpamPoolAllocation``."""
...
import capo_ec2.types.modify_ipam_pool_allocation_request
import capo_ec2.types.modify_ipam_pool_allocation_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_ipam_pool_allocation_result.ModifyIpamPoolAllocationResult = capo_ec2.types.modify_ipam_pool_allocation_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyIpamPoolAllocation"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_ipam_pool_allocation_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_ipam_pool_allocation(
