...
import capo_ec2.types.unassign_private_nat_gateway_address_request
import capo_ec2.types.unassign_private_nat_gateway_address_result
...
) -> capo_ec2.types.unassign_private_nat_gateway_address_result.UnassignPrivateNatGatewayAddressResult:
    out: capo_ec2.types.unassign_private_nat_gateway_address_result.UnassignPrivateNatGatewayAddressResult = capo_ec2.types.unassign_private_nat_gateway_address_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "UnassignPrivateNatGatewayAddress"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.unassign_private_nat_gateway_address_request.serialize_ec2_query(
        input_, pairs, ""
    )
