...
def handle_response(
    ...
    out: capo_ec2.types.disable_vpc_classic_link_result.DisableVpcClassicLinkResult = (
        capo_ec2.types.disable_vpc_classic_link_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableVpcClassicLink"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disable_vpc_classic_link_request.serialize_ec2_query(
        input_, pairs, ""
    )
