...
import capo_ec2.types.describe_transit_gateways_request
import capo_ec2.types.describe_transit_gateways_result
...
) -> capo_ec2.types.describe_transit_gateways_result.DescribeTransitGatewaysResult:
    out: capo_ec2.types.describe_transit_gateways_result.DescribeTransitGatewaysResult = capo_ec2.types.describe_transit_gateways_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_transit_gateways_request.serialize_ec2_query(
        input_, pairs, ""
    )
