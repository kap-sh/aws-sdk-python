...
def handle_response(
    ...
    out: capo_ec2.types.start_network_insights_access_scope_analysis_result.StartNetworkInsightsAccessScopeAnalysisResult = capo_ec2.types.start_network_insights_access_scope_analysis_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.start_network_insights_access_scope_analysis_request.serialize_ec2_query(
        input_, pairs, ""
    )
