"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyVerifiedAccessTrustProvider``."""
...
import capo_ec2.types.modify_verified_access_trust_provider_request
import capo_ec2.types.modify_verified_access_trust_provider_result
...
) -> capo_ec2.types.modify_verified_access_trust_provider_result.ModifyVerifiedAccessTrustProviderResult:
    out: capo_ec2.types.modify_verified_access_trust_provider_result.ModifyVerifiedAccessTrustProviderResult = capo_ec2.types.modify_verified_access_trust_provider_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_verified_access_trust_provider_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_verified_access_trust_provider(
