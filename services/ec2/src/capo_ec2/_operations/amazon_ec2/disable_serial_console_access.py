...
import capo_ec2.types.disable_serial_console_access_request
import capo_ec2.types.disable_serial_console_access_result
...
def handle_response(
    ...
    capo_ec2.types.disable_serial_console_access_result.DisableSerialConsoleAccessResult
):
    out: capo_ec2.types.disable_serial_console_access_result.DisableSerialConsoleAccessResult = capo_ec2.types.disable_serial_console_access_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableSerialConsoleAccess"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disable_serial_console_access_request.serialize_ec2_query(
        input_, pairs, ""
    )
