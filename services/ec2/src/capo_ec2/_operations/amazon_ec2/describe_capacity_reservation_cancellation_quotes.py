"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeCapacityReservationCancellationQuotes``."""
...
def handle_response(
    ...
    out: capo_ec2.types.describe_capacity_reservation_cancellation_quotes_result.DescribeCapacityReservationCancellationQuotesResult = capo_ec2.types.describe_capacity_reservation_cancellation_quotes_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeCapacityReservationCancellationQuotes"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_capacity_reservation_cancellation_quotes_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_capacity_reservation_cancellation_quotes(
