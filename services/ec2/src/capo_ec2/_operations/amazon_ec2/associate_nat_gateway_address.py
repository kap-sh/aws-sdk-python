"""Generated from Smithy shape ``com.amazonaws.ec2#AssociateNatGatewayAddress``."""
...
import capo_ec2.types.associate_nat_gateway_address_request
import capo_ec2.types.associate_nat_gateway_address_result
...
def handle_response(
    ...
    capo_ec2.types.associate_nat_gateway_address_result.AssociateNatGatewayAddressResult
):
    out: capo_ec2.types.associate_nat_gateway_address_result.AssociateNatGatewayAddressResult = capo_ec2.types.associate_nat_gateway_address_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AssociateNatGatewayAddress"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.associate_nat_gateway_address_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_associate_nat_gateway_address(
