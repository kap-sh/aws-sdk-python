...
import capo_ec2.types.describe_addresses_attribute_request
import capo_ec2.types.describe_addresses_attribute_result
...
def handle_response(
    ...
    capo_ec2.types.describe_addresses_attribute_result.DescribeAddressesAttributeResult
):
    out: capo_ec2.types.describe_addresses_attribute_result.DescribeAddressesAttributeResult = capo_ec2.types.describe_addresses_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_addresses_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
