...
import capo_ec2.types.create_transit_gateway_route_table_announcement_request
import capo_ec2.types.create_transit_gateway_route_table_announcement_result
...
) -> capo_ec2.types.create_transit_gateway_route_table_announcement_result.CreateTransitGatewayRouteTableAnnouncementResult:
    out: capo_ec2.types.create_transit_gateway_route_table_announcement_result.CreateTransitGatewayRouteTableAnnouncementResult = capo_ec2.types.create_transit_gateway_route_table_announcement_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateTransitGatewayRouteTableAnnouncement"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_transit_gateway_route_table_announcement_request.serialize_ec2_query(
        input_, pairs, ""
    )
