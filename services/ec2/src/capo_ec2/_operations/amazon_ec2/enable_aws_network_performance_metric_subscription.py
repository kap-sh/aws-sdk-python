...
) -> capo_ec2.types.enable_aws_network_performance_metric_subscription_result.EnableAwsNetworkPerformanceMetricSubscriptionResult:
    out: capo_ec2.types.enable_aws_network_performance_metric_subscription_result.EnableAwsNetworkPerformanceMetricSubscriptionResult = capo_ec2.types.enable_aws_network_performance_metric_subscription_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "EnableAwsNetworkPerformanceMetricSubscription"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.enable_aws_network_performance_metric_subscription_request.serialize_ec2_query(
        input_, pairs, ""
    )
