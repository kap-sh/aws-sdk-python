...
import capo_ec2.types.create_ipam_prefix_list_resolver_target_request
import capo_ec2.types.create_ipam_prefix_list_resolver_target_result
...
) -> capo_ec2.types.create_ipam_prefix_list_resolver_target_result.CreateIpamPrefixListResolverTargetResult:
    out: capo_ec2.types.create_ipam_prefix_list_resolver_target_result.CreateIpamPrefixListResolverTargetResult = capo_ec2.types.create_ipam_prefix_list_resolver_target_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateIpamPrefixListResolverTarget"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_ipam_prefix_list_resolver_target_request.serialize_ec2_query(
        input_, pairs, ""
    )
