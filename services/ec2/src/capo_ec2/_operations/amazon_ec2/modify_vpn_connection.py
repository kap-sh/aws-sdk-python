"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyVpnConnection``."""
...
import capo_ec2.types.modify_vpn_connection_request
import capo_ec2.types.modify_vpn_connection_result
...
) -> capo_ec2.types.modify_vpn_connection_result.ModifyVpnConnectionResult:
    out: capo_ec2.types.modify_vpn_connection_result.ModifyVpnConnectionResult = (
        capo_ec2.types.modify_vpn_connection_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyVpnConnection"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_vpn_connection_request.serialize_ec2_query(input_, pairs, "")
...
async def async_modify_vpn_connection(
