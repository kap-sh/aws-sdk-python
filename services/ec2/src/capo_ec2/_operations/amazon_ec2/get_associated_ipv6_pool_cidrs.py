...
import capo_ec2.types.get_associated_ipv6_pool_cidrs_request
import capo_ec2.types.get_associated_ipv6_pool_cidrs_result
...
) -> capo_ec2.types.get_associated_ipv6_pool_cidrs_result.GetAssociatedIpv6PoolCidrsResult:
    out: capo_ec2.types.get_associated_ipv6_pool_cidrs_result.GetAssociatedIpv6PoolCidrsResult = capo_ec2.types.get_associated_ipv6_pool_cidrs_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetAssociatedIpv6PoolCidrs"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_associated_ipv6_pool_cidrs_request.serialize_ec2_query(
        input_, pairs, ""
    )
