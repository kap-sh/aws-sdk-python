...
def handle_response(
    ...
    out: capo_ec2.types.disassociate_capacity_reservation_billing_owner_result.DisassociateCapacityReservationBillingOwnerResult = capo_ec2.types.disassociate_capacity_reservation_billing_owner_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.disassociate_capacity_reservation_billing_owner_request.serialize_ec2_query(
        input_, pairs, ""
    )
