...
import capo_ec2.types.create_replace_root_volume_task_request
import capo_ec2.types.create_replace_root_volume_task_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_replace_root_volume_task_result.CreateReplaceRootVolumeTaskResult = capo_ec2.types.create_replace_root_volume_task_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_replace_root_volume_task_request.serialize_ec2_query(
        input_, pairs, ""
    )
