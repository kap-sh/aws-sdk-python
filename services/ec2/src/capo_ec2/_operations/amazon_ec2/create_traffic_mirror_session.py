...
import capo_ec2.types.create_traffic_mirror_session_request
import capo_ec2.types.create_traffic_mirror_session_result
...
def handle_response(
    ...
    capo_ec2.types.create_traffic_mirror_session_result.CreateTrafficMirrorSessionResult
):
    out: capo_ec2.types.create_traffic_mirror_session_result.CreateTrafficMirrorSessionResult = capo_ec2.types.create_traffic_mirror_session_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_traffic_mirror_session_request.serialize_ec2_query(
        input_, pairs, ""
    )
