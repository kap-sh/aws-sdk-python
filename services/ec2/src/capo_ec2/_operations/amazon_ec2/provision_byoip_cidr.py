...
import capo_ec2.types.provision_byoip_cidr_request
import capo_ec2.types.provision_byoip_cidr_result
...
def handle_response(
    ...
    out: capo_ec2.types.provision_byoip_cidr_result.ProvisionByoipCidrResult = (
        capo_ec2.types.provision_byoip_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ProvisionByoipCidr"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.provision_byoip_cidr_request.serialize_ec2_query(input_, pairs, "")
...
def provision_byoip_cidr(
    ...
    capo_ec2.types.provision_byoip_cidr_result.ProvisionByoipCidrResult, zapros.Response
]:
