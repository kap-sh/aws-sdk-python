...
import capo_ec2.types.describe_client_vpn_authorization_rules_request
import capo_ec2.types.describe_client_vpn_authorization_rules_result
...
) -> capo_ec2.types.describe_client_vpn_authorization_rules_result.DescribeClientVpnAuthorizationRulesResult:
    out: capo_ec2.types.describe_client_vpn_authorization_rules_result.DescribeClientVpnAuthorizationRulesResult = capo_ec2.types.describe_client_vpn_authorization_rules_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeClientVpnAuthorizationRules"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_client_vpn_authorization_rules_request.serialize_ec2_query(
        input_, pairs, ""
    )
