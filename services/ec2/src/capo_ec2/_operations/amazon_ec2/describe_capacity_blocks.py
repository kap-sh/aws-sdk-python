...
import capo_ec2.types.describe_capacity_blocks_request
import capo_ec2.types.describe_capacity_blocks_result
...
) -> capo_ec2.types.describe_capacity_blocks_result.DescribeCapacityBlocksResult:
    out: capo_ec2.types.describe_capacity_blocks_result.DescribeCapacityBlocksResult = (
        capo_ec2.types.describe_capacity_blocks_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeCapacityBlocks"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_capacity_blocks_request.serialize_ec2_query(
        input_, pairs, ""
    )
