...
import capo_ec2.types.describe_scheduled_instance_availability_request
import capo_ec2.types.describe_scheduled_instance_availability_result
...
def handle_response(
    ...
    out: capo_ec2.types.describe_scheduled_instance_availability_result.DescribeScheduledInstanceAvailabilityResult = capo_ec2.types.describe_scheduled_instance_availability_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_scheduled_instance_availability_request.serialize_ec2_query(
        input_, pairs, ""
    )
