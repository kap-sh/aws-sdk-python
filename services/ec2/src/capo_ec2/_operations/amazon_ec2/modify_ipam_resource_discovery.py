...
) -> capo_ec2.types.modify_ipam_resource_discovery_result.ModifyIpamResourceDiscoveryResult:
    out: capo_ec2.types.modify_ipam_resource_discovery_result.ModifyIpamResourceDiscoveryResult = capo_ec2.types.modify_ipam_resource_discovery_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyIpamResourceDiscovery"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_ipam_resource_discovery_request.serialize_ec2_query(
        input_, pairs, ""
    )
