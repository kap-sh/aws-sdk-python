...
import capo_ec2.types.associate_ipam_resource_discovery_request
import capo_ec2.types.associate_ipam_resource_discovery_result
...
) -> capo_ec2.types.associate_ipam_resource_discovery_result.AssociateIpamResourceDiscoveryResult:
    out: capo_ec2.types.associate_ipam_resource_discovery_result.AssociateIpamResourceDiscoveryResult = capo_ec2.types.associate_ipam_resource_discovery_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.associate_ipam_resource_discovery_request.serialize_ec2_query(
        input_, pairs, ""
    )
