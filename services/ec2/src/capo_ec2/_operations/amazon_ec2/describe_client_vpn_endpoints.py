...
import capo_ec2.types.describe_client_vpn_endpoints_request
import capo_ec2.types.describe_client_vpn_endpoints_result
...
def handle_response(
    ...
    capo_ec2.types.describe_client_vpn_endpoints_result.DescribeClientVpnEndpointsResult
):
    out: capo_ec2.types.describe_client_vpn_endpoints_result.DescribeClientVpnEndpointsResult = capo_ec2.types.describe_client_vpn_endpoints_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeClientVpnEndpoints"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_client_vpn_endpoints_request.serialize_ec2_query(
        input_, pairs, ""
    )
