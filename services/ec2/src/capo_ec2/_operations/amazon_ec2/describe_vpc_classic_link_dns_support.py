"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeVpcClassicLinkDnsSupport``."""
...
import capo_ec2.types.describe_vpc_classic_link_dns_support_request
import capo_ec2.types.describe_vpc_classic_link_dns_support_result
...
) -> capo_ec2.types.describe_vpc_classic_link_dns_support_result.DescribeVpcClassicLinkDnsSupportResult:
    out: capo_ec2.types.describe_vpc_classic_link_dns_support_result.DescribeVpcClassicLinkDnsSupportResult = capo_ec2.types.describe_vpc_classic_link_dns_support_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVpcClassicLinkDnsSupport"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_vpc_classic_link_dns_support_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_vpc_classic_link_dns_support(
