...
import capo_ec2.types.unlock_snapshot_request
import capo_ec2.types.unlock_snapshot_result
...
def handle_response(
    ...
    out: capo_ec2.types.unlock_snapshot_result.UnlockSnapshotResult = (
        capo_ec2.types.unlock_snapshot_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "UnlockSnapshot"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.unlock_snapshot_request.serialize_ec2_query(input_, pairs, "")
...
def unlock_snapshot(
    ...
    input_: capo_ec2.types.unlock_snapshot_request.UnlockSnapshotRequest,
) -> tuple[capo_ec2.types.unlock_snapshot_result.UnlockSnapshotResult, zapros.Response]:
