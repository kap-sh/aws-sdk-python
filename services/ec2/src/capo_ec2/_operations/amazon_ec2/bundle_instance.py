"""Generated from Smithy shape ``com.amazonaws.ec2#BundleInstance``."""
...
import capo_ec2.types.bundle_instance_request
import capo_ec2.types.bundle_instance_result
...
def handle_response(
    ...
    out: capo_ec2.types.bundle_instance_result.BundleInstanceResult = (
        capo_ec2.types.bundle_instance_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "BundleInstance"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.bundle_instance_request.serialize_ec2_query(input_, pairs, "")
...
def bundle_instance(
    ...
    input_: capo_ec2.types.bundle_instance_request.BundleInstanceRequest,
) -> tuple[capo_ec2.types.bundle_instance_result.BundleInstanceResult, zapros.Response]:
...
async def async_bundle_instance(
