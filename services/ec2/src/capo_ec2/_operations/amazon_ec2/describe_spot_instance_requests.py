...
import capo_ec2.types.describe_spot_instance_requests_request
import capo_ec2.types.describe_spot_instance_requests_result
...
) -> capo_ec2.types.describe_spot_instance_requests_result.DescribeSpotInstanceRequestsResult:
    out: capo_ec2.types.describe_spot_instance_requests_result.DescribeSpotInstanceRequestsResult = capo_ec2.types.describe_spot_instance_requests_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_spot_instance_requests_request.serialize_ec2_query(
        input_, pairs, ""
    )
