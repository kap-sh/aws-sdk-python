"""Generated from Smithy shape ``com.amazonaws.ec2#GetImageAncestry``."""
...
import capo_ec2.types.get_image_ancestry_request
import capo_ec2.types.get_image_ancestry_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_image_ancestry_result.GetImageAncestryResult = (
        capo_ec2.types.get_image_ancestry_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetImageAncestry"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_image_ancestry_request.serialize_ec2_query(input_, pairs, "")
...
def get_image_ancestry(
    ...
    capo_ec2.types.get_image_ancestry_result.GetImageAncestryResult, zapros.Response
]:
...
async def async_get_image_ancestry(
