...
import capo_ec2.types.describe_host_reservation_offerings_request
import capo_ec2.types.describe_host_reservation_offerings_result
...
) -> capo_ec2.types.describe_host_reservation_offerings_result.DescribeHostReservationOfferingsResult:
    out: capo_ec2.types.describe_host_reservation_offerings_result.DescribeHostReservationOfferingsResult = capo_ec2.types.describe_host_reservation_offerings_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeHostReservationOfferings"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_host_reservation_offerings_request.serialize_ec2_query(
        input_, pairs, ""
    )
