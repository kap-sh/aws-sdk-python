"""Generated from Smithy shape ``com.amazonaws.ec2#DetachImageWatermark``."""
...
def handle_response(
    ...
    out: capo_ec2.types.detach_image_watermark_result.DetachImageWatermarkResult = (
        capo_ec2.types.detach_image_watermark_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DetachImageWatermark"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.detach_image_watermark_request.serialize_ec2_query(input_, pairs, "")
...
async def async_detach_image_watermark(
