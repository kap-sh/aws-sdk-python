...
import capo_ec2.types.create_vpc_endpoint_connection_notification_request
import capo_ec2.types.create_vpc_endpoint_connection_notification_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_vpc_endpoint_connection_notification_result.CreateVpcEndpointConnectionNotificationResult = capo_ec2.types.create_vpc_endpoint_connection_notification_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateVpcEndpointConnectionNotification"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_vpc_endpoint_connection_notification_request.serialize_ec2_query(
        input_, pairs, ""
    )
