...
import capo_ec2.types.delete_subnet_cidr_reservation_request
import capo_ec2.types.delete_subnet_cidr_reservation_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_subnet_cidr_reservation_result.DeleteSubnetCidrReservationResult = capo_ec2.types.delete_subnet_cidr_reservation_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteSubnetCidrReservation"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_subnet_cidr_reservation_request.serialize_ec2_query(
        input_, pairs, ""
    )
