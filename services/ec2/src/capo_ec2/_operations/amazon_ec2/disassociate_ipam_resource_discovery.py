"""Generated from Smithy shape ``com.amazonaws.ec2#DisassociateIpamResourceDiscovery``."""
...
import capo_ec2.types.disassociate_ipam_resource_discovery_request
import capo_ec2.types.disassociate_ipam_resource_discovery_result
...
def handle_response(
    ...
    out: capo_ec2.types.disassociate_ipam_resource_discovery_result.DisassociateIpamResourceDiscoveryResult = capo_ec2.types.disassociate_ipam_resource_discovery_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisassociateIpamResourceDiscovery"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disassociate_ipam_resource_discovery_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_disassociate_ipam_resource_discovery(
