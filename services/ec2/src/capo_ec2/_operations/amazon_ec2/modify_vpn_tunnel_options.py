...
import capo_ec2.types.modify_vpn_tunnel_options_request
import capo_ec2.types.modify_vpn_tunnel_options_result
...
) -> capo_ec2.types.modify_vpn_tunnel_options_result.ModifyVpnTunnelOptionsResult:
    out: capo_ec2.types.modify_vpn_tunnel_options_result.ModifyVpnTunnelOptionsResult = capo_ec2.types.modify_vpn_tunnel_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_vpn_tunnel_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
