"""Generated from Smithy shape ``com.amazonaws.ec2#GetIpamDiscoveredRoutes``."""
...
def handle_response(
    ...
    out: capo_ec2.types.get_ipam_discovered_routes_result.GetIpamDiscoveredRoutesResult = capo_ec2.types.get_ipam_discovered_routes_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetIpamDiscoveredRoutes"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_ipam_discovered_routes_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_get_ipam_discovered_routes(
