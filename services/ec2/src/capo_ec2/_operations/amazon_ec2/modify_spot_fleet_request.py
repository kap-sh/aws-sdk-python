"""Generated from Smithy shape ``com.amazonaws.ec2#ModifySpotFleetRequest``."""
...
import capo_ec2.types.modify_spot_fleet_request_request
import capo_ec2.types.modify_spot_fleet_request_response
...
) -> capo_ec2.types.modify_spot_fleet_request_response.ModifySpotFleetRequestResponse:
    out: capo_ec2.types.modify_spot_fleet_request_response.ModifySpotFleetRequestResponse = capo_ec2.types.modify_spot_fleet_request_response.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifySpotFleetRequest"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_spot_fleet_request_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_spot_fleet_request(
