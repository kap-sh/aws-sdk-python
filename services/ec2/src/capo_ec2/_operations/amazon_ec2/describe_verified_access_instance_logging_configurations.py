...
import capo_ec2.types.describe_verified_access_instance_logging_configurations_request
import capo_ec2.types.describe_verified_access_instance_logging_configurations_result
...
) -> capo_ec2.types.describe_verified_access_instance_logging_configurations_result.DescribeVerifiedAccessInstanceLoggingConfigurationsResult:
    out: capo_ec2.types.describe_verified_access_instance_logging_configurations_result.DescribeVerifiedAccessInstanceLoggingConfigurationsResult = capo_ec2.types.describe_verified_access_instance_logging_configurations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVerifiedAccessInstanceLoggingConfigurations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_verified_access_instance_logging_configurations_request.serialize_ec2_query(
        input_, pairs, ""
    )
