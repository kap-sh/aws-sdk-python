...
import capo_ec2.types.create_route_server_peer_request
import capo_ec2.types.create_route_server_peer_result
...
) -> capo_ec2.types.create_route_server_peer_result.CreateRouteServerPeerResult:
    out: capo_ec2.types.create_route_server_peer_result.CreateRouteServerPeerResult = (
        capo_ec2.types.create_route_server_peer_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateRouteServerPeer"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_route_server_peer_request.serialize_ec2_query(
        input_, pairs, ""
    )
