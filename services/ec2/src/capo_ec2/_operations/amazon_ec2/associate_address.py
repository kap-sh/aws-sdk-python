...
) -> capo_ec2.types.associate_address_result.AssociateAddressResult:
    out: capo_ec2.types.associate_address_result.AssociateAddressResult = (
        capo_ec2.types.associate_address_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AssociateAddress"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.associate_address_request.serialize_ec2_query(input_, pairs, "")
...
def associate_address(
    ...
    capo_ec2.types.associate_address_result.AssociateAddressResult, zapros.Response
]:
