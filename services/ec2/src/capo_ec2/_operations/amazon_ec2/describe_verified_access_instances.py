...
import capo_ec2.types.describe_verified_access_instances_request
import capo_ec2.types.describe_verified_access_instances_result
...
) -> capo_ec2.types.describe_verified_access_instances_result.DescribeVerifiedAccessInstancesResult:
    out: capo_ec2.types.describe_verified_access_instances_result.DescribeVerifiedAccessInstancesResult = capo_ec2.types.describe_verified_access_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVerifiedAccessInstances"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_verified_access_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
