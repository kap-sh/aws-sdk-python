...
import capo_ec2.types.search_transit_gateway_routes_request
import capo_ec2.types.search_transit_gateway_routes_result
...
def handle_response(
    ...
    capo_ec2.types.search_transit_gateway_routes_result.SearchTransitGatewayRoutesResult
):
    out: capo_ec2.types.search_transit_gateway_routes_result.SearchTransitGatewayRoutesResult = capo_ec2.types.search_transit_gateway_routes_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "SearchTransitGatewayRoutes"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.search_transit_gateway_routes_request.serialize_ec2_query(
        input_, pairs, ""
    )
