"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeTransitGatewayAttachments``."""
...
import capo_ec2.types.describe_transit_gateway_attachments_request
import capo_ec2.types.describe_transit_gateway_attachments_result
...
) -> capo_ec2.types.describe_transit_gateway_attachments_result.DescribeTransitGatewayAttachmentsResult:
    out: capo_ec2.types.describe_transit_gateway_attachments_result.DescribeTransitGatewayAttachmentsResult = capo_ec2.types.describe_transit_gateway_attachments_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeTransitGatewayAttachments"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_transit_gateway_attachments_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_transit_gateway_attachments(
