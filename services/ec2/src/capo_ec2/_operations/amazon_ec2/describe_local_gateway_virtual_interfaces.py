...
import capo_ec2.types.describe_local_gateway_virtual_interfaces_request
import capo_ec2.types.describe_local_gateway_virtual_interfaces_result
...
) -> capo_ec2.types.describe_local_gateway_virtual_interfaces_result.DescribeLocalGatewayVirtualInterfacesResult:
    out: capo_ec2.types.describe_local_gateway_virtual_interfaces_result.DescribeLocalGatewayVirtualInterfacesResult = capo_ec2.types.describe_local_gateway_virtual_interfaces_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeLocalGatewayVirtualInterfaces"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_local_gateway_virtual_interfaces_request.serialize_ec2_query(
        input_, pairs, ""
    )
