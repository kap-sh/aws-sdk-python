...
import capo_ec2.types.disassociate_subnet_cidr_block_request
import capo_ec2.types.disassociate_subnet_cidr_block_result
...
def handle_response(
    ...
    out: capo_ec2.types.disassociate_subnet_cidr_block_result.DisassociateSubnetCidrBlockResult = capo_ec2.types.disassociate_subnet_cidr_block_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisassociateSubnetCidrBlock"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disassociate_subnet_cidr_block_request.serialize_ec2_query(
        input_, pairs, ""
    )
