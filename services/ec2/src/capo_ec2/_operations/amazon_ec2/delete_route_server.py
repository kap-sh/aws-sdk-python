...
import capo_ec2.types.delete_route_server_request
import capo_ec2.types.delete_route_server_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_route_server_result.DeleteRouteServerResult = (
        capo_ec2.types.delete_route_server_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteRouteServer"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_route_server_request.serialize_ec2_query(input_, pairs, "")
...
def delete_route_server(
    ...
    capo_ec2.types.delete_route_server_result.DeleteRouteServerResult, zapros.Response
]:
