...
import capo_ec2.types.enable_vpc_classic_link_dns_support_request
import capo_ec2.types.enable_vpc_classic_link_dns_support_result
...
) -> capo_ec2.types.enable_vpc_classic_link_dns_support_result.EnableVpcClassicLinkDnsSupportResult:
    out: capo_ec2.types.enable_vpc_classic_link_dns_support_result.EnableVpcClassicLinkDnsSupportResult = capo_ec2.types.enable_vpc_classic_link_dns_support_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "EnableVpcClassicLinkDnsSupport"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.enable_vpc_classic_link_dns_support_request.serialize_ec2_query(
        input_, pairs, ""
    )
