"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeVpcBlockPublicAccessExclusions``."""
...
import capo_ec2.types.describe_vpc_block_public_access_exclusions_request
import capo_ec2.types.describe_vpc_block_public_access_exclusions_result
...
) -> capo_ec2.types.describe_vpc_block_public_access_exclusions_result.DescribeVpcBlockPublicAccessExclusionsResult:
    out: capo_ec2.types.describe_vpc_block_public_access_exclusions_result.DescribeVpcBlockPublicAccessExclusionsResult = capo_ec2.types.describe_vpc_block_public_access_exclusions_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVpcBlockPublicAccessExclusions"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_vpc_block_public_access_exclusions_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_vpc_block_public_access_exclusions(
