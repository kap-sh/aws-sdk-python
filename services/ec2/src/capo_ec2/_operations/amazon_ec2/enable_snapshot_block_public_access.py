...
import capo_ec2.types.enable_snapshot_block_public_access_request
import capo_ec2.types.enable_snapshot_block_public_access_result
...
def handle_response(
    ...
    out: capo_ec2.types.enable_snapshot_block_public_access_result.EnableSnapshotBlockPublicAccessResult = capo_ec2.types.enable_snapshot_block_public_access_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "EnableSnapshotBlockPublicAccess"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.enable_snapshot_block_public_access_request.serialize_ec2_query(
        input_, pairs, ""
    )
