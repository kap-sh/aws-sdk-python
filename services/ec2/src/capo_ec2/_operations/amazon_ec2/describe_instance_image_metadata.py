...
import capo_ec2.types.describe_instance_image_metadata_request
import capo_ec2.types.describe_instance_image_metadata_result
...
) -> capo_ec2.types.describe_instance_image_metadata_result.DescribeInstanceImageMetadataResult:
    out: capo_ec2.types.describe_instance_image_metadata_result.DescribeInstanceImageMetadataResult = capo_ec2.types.describe_instance_image_metadata_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeInstanceImageMetadata"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_instance_image_metadata_request.serialize_ec2_query(
        input_, pairs, ""
    )
