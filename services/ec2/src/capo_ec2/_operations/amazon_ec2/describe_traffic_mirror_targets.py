...
import capo_ec2.types.describe_traffic_mirror_targets_request
import capo_ec2.types.describe_traffic_mirror_targets_result
...
) -> capo_ec2.types.describe_traffic_mirror_targets_result.DescribeTrafficMirrorTargetsResult:
    out: capo_ec2.types.describe_traffic_mirror_targets_result.DescribeTrafficMirrorTargetsResult = capo_ec2.types.describe_traffic_mirror_targets_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeTrafficMirrorTargets"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_traffic_mirror_targets_request.serialize_ec2_query(
        input_, pairs, ""
    )
