...
import capo_ec2.types.modify_instance_credit_specification_request
import capo_ec2.types.modify_instance_credit_specification_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_instance_credit_specification_result.ModifyInstanceCreditSpecificationResult = capo_ec2.types.modify_instance_credit_specification_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_instance_credit_specification_request.serialize_ec2_query(
        input_, pairs, ""
    )
