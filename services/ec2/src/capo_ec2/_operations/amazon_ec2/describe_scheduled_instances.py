"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeScheduledInstances``."""
...
import capo_ec2.types.describe_scheduled_instances_request
import capo_ec2.types.describe_scheduled_instances_result
...
def handle_response(
    ...
    capo_ec2.types.describe_scheduled_instances_result.DescribeScheduledInstancesResult
):
    out: capo_ec2.types.describe_scheduled_instances_result.DescribeScheduledInstancesResult = capo_ec2.types.describe_scheduled_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeScheduledInstances"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_scheduled_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_scheduled_instances(
