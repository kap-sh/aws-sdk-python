...
import capo_ec2.types.create_network_interface_request
import capo_ec2.types.create_network_interface_result
...
) -> capo_ec2.types.create_network_interface_result.CreateNetworkInterfaceResult:
    out: capo_ec2.types.create_network_interface_result.CreateNetworkInterfaceResult = (
        capo_ec2.types.create_network_interface_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateNetworkInterface"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_network_interface_request.serialize_ec2_query(
        input_, pairs, ""
    )
