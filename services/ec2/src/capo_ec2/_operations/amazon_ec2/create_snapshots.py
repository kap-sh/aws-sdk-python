...
import capo_ec2.types.create_snapshots_request
import capo_ec2.types.create_snapshots_result
...
) -> capo_ec2.types.create_snapshots_result.CreateSnapshotsResult:
    out: capo_ec2.types.create_snapshots_result.CreateSnapshotsResult = (
        capo_ec2.types.create_snapshots_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateSnapshots"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_snapshots_request.serialize_ec2_query(input_, pairs, "")
...
def create_snapshots(
    ...
    capo_ec2.types.create_snapshots_result.CreateSnapshotsResult, zapros.Response
]:
