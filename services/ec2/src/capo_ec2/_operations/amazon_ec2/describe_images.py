"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeImages``."""
...
import capo_ec2.types.describe_images_request
import capo_ec2.types.describe_images_result
...
) -> capo_ec2.types.describe_images_result.DescribeImagesResult:
    out: capo_ec2.types.describe_images_result.DescribeImagesResult = (
        capo_ec2.types.describe_images_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeImages"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_images_request.serialize_ec2_query(input_, pairs, "")
...
def describe_images(
    ...
    input_: capo_ec2.types.describe_images_request.DescribeImagesRequest,
) -> tuple[capo_ec2.types.describe_images_result.DescribeImagesResult, zapros.Response]:
