...
import capo_ec2.types.create_transit_gateway_connect_peer_request
import capo_ec2.types.create_transit_gateway_connect_peer_result
...
) -> capo_ec2.types.create_transit_gateway_connect_peer_result.CreateTransitGatewayConnectPeerResult:
    out: capo_ec2.types.create_transit_gateway_connect_peer_result.CreateTransitGatewayConnectPeerResult = capo_ec2.types.create_transit_gateway_connect_peer_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateTransitGatewayConnectPeer"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_transit_gateway_connect_peer_request.serialize_ec2_query(
        input_, pairs, ""
    )
