...
def handle_response(
    ...
    out: capo_ec2.types.modify_address_attribute_result.ModifyAddressAttributeResult = (
        capo_ec2.types.modify_address_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyAddressAttribute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_address_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
