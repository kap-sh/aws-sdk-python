"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyCapacityReservationFleet``."""
...
import capo_ec2.types.modify_capacity_reservation_fleet_request
...
) -> capo_ec2.types.modify_capacity_reservation_fleet_result.ModifyCapacityReservationFleetResult:
    out: capo_ec2.types.modify_capacity_reservation_fleet_result.ModifyCapacityReservationFleetResult = capo_ec2.types.modify_capacity_reservation_fleet_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyCapacityReservationFleet"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_capacity_reservation_fleet_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_capacity_reservation_fleet(
