...
import capo_ec2.types.update_interruptible_capacity_reservation_allocation_request
import capo_ec2.types.update_interruptible_capacity_reservation_allocation_result
...
def handle_response(
    ...
    out: capo_ec2.types.update_interruptible_capacity_reservation_allocation_result.UpdateInterruptibleCapacityReservationAllocationResult = capo_ec2.types.update_interruptible_capacity_reservation_allocation_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.update_interruptible_capacity_reservation_allocation_request.serialize_ec2_query(
        input_, pairs, ""
    )
