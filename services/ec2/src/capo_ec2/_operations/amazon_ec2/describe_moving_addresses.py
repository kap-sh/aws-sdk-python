...
import capo_ec2.types.describe_moving_addresses_request
import capo_ec2.types.describe_moving_addresses_result
...
) -> capo_ec2.types.describe_moving_addresses_result.DescribeMovingAddressesResult:
    out: capo_ec2.types.describe_moving_addresses_result.DescribeMovingAddressesResult = capo_ec2.types.describe_moving_addresses_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeMovingAddresses"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_moving_addresses_request.serialize_ec2_query(
        input_, pairs, ""
    )
