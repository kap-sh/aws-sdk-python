"""Generated from Smithy shape ``com.amazonaws.ec2#BatchModifyIpamRoutingPolicyRegistrations``."""
...
def handle_response(
    ...
    out: capo_ec2.types.batch_modify_ipam_routing_policy_registrations_result.BatchModifyIpamRoutingPolicyRegistrationsResult = capo_ec2.types.batch_modify_ipam_routing_policy_registrations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "BatchModifyIpamRoutingPolicyRegistrations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.batch_modify_ipam_routing_policy_registrations_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_batch_modify_ipam_routing_policy_registrations(
