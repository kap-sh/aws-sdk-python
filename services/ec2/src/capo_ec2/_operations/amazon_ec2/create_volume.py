...
import capo_ec2.types.create_volume_request
...
def handle_response(response: zapros.Response) -> capo_ec2.types.volume.Volume:
    out: capo_ec2.types.volume.Volume = capo_ec2.types.volume.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_volume_request.serialize_ec2_query(input_, pairs, "")
...
def create_volume(
    ...
    input_: capo_ec2.types.create_volume_request.CreateVolumeRequest,
) -> tuple[capo_ec2.types.volume.Volume, zapros.Response]:
