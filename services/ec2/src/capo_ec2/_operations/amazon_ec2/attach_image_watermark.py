"""Generated from Smithy shape ``com.amazonaws.ec2#AttachImageWatermark``."""
...
def handle_response(
    ...
    out: capo_ec2.types.attach_image_watermark_result.AttachImageWatermarkResult = (
        capo_ec2.types.attach_image_watermark_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AttachImageWatermark"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.attach_image_watermark_request.serialize_ec2_query(input_, pairs, "")
...
async def async_attach_image_watermark(
