...
import capo_ec2.types.delete_managed_prefix_list_request
import capo_ec2.types.delete_managed_prefix_list_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_managed_prefix_list_result.DeleteManagedPrefixListResult = capo_ec2.types.delete_managed_prefix_list_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteManagedPrefixList"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_managed_prefix_list_request.serialize_ec2_query(
        input_, pairs, ""
    )
