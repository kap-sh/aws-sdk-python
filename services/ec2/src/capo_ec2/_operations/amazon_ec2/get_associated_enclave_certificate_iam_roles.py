...
import capo_ec2.types.get_associated_enclave_certificate_iam_roles_request
import capo_ec2.types.get_associated_enclave_certificate_iam_roles_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_associated_enclave_certificate_iam_roles_result.GetAssociatedEnclaveCertificateIamRolesResult = capo_ec2.types.get_associated_enclave_certificate_iam_roles_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_associated_enclave_certificate_iam_roles_request.serialize_ec2_query(
        input_, pairs, ""
    )
