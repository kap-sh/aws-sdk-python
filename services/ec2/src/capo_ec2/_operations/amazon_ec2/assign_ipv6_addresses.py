...
) -> capo_ec2.types.assign_ipv6_addresses_result.AssignIpv6AddressesResult:
    out: capo_ec2.types.assign_ipv6_addresses_result.AssignIpv6AddressesResult = (
        capo_ec2.types.assign_ipv6_addresses_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.assign_ipv6_addresses_request.serialize_ec2_query(input_, pairs, "")
