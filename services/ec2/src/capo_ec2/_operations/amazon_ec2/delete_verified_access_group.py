"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteVerifiedAccessGroup``."""
...
import capo_ec2.types.delete_verified_access_group_request
import capo_ec2.types.delete_verified_access_group_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_verified_access_group_result.DeleteVerifiedAccessGroupResult = capo_ec2.types.delete_verified_access_group_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteVerifiedAccessGroup"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_verified_access_group_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_verified_access_group(
