...
import capo_ec2.types.disable_image_deregistration_protection_request
import capo_ec2.types.disable_image_deregistration_protection_result
...
def handle_response(
    ...
    out: capo_ec2.types.disable_image_deregistration_protection_result.DisableImageDeregistrationProtectionResult = capo_ec2.types.disable_image_deregistration_protection_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.disable_image_deregistration_protection_request.serialize_ec2_query(
        input_, pairs, ""
    )
