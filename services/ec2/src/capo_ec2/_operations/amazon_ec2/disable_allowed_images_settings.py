...
) -> capo_ec2.types.disable_allowed_images_settings_result.DisableAllowedImagesSettingsResult:
    out: capo_ec2.types.disable_allowed_images_settings_result.DisableAllowedImagesSettingsResult = capo_ec2.types.disable_allowed_images_settings_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableAllowedImagesSettings"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disable_allowed_images_settings_request.serialize_ec2_query(
        input_, pairs, ""
    )
