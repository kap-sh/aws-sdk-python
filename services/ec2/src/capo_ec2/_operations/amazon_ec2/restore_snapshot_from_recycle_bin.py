...
import capo_ec2.types.restore_snapshot_from_recycle_bin_request
import capo_ec2.types.restore_snapshot_from_recycle_bin_result
...
def handle_response(
    ...
    out: capo_ec2.types.restore_snapshot_from_recycle_bin_result.RestoreSnapshotFromRecycleBinResult = capo_ec2.types.restore_snapshot_from_recycle_bin_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "RestoreSnapshotFromRecycleBin"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.restore_snapshot_from_recycle_bin_request.serialize_ec2_query(
        input_, pairs, ""
    )
