...
import capo_ec2.types.modify_route_server_request
import capo_ec2.types.modify_route_server_result
...
) -> capo_ec2.types.modify_route_server_result.ModifyRouteServerResult:
    out: capo_ec2.types.modify_route_server_result.ModifyRouteServerResult = (
        capo_ec2.types.modify_route_server_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyRouteServer"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_route_server_request.serialize_ec2_query(input_, pairs, "")
...
def modify_route_server(
    ...
    capo_ec2.types.modify_route_server_result.ModifyRouteServerResult, zapros.Response
]:
