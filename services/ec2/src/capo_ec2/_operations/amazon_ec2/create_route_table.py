"""Generated from Smithy shape ``com.amazonaws.ec2#CreateRouteTable``."""
...
import capo_ec2.types.create_route_table_request
import capo_ec2.types.create_route_table_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_route_table_result.CreateRouteTableResult = (
        capo_ec2.types.create_route_table_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateRouteTable"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_route_table_request.serialize_ec2_query(input_, pairs, "")
...
def create_route_table(
    ...
    capo_ec2.types.create_route_table_result.CreateRouteTableResult, zapros.Response
]:
...
async def async_create_route_table(
