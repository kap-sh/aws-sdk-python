...
import capo_ec2.types.get_reserved_instances_exchange_quote_request
import capo_ec2.types.get_reserved_instances_exchange_quote_result
...
) -> capo_ec2.types.get_reserved_instances_exchange_quote_result.GetReservedInstancesExchangeQuoteResult:
    out: capo_ec2.types.get_reserved_instances_exchange_quote_result.GetReservedInstancesExchangeQuoteResult = capo_ec2.types.get_reserved_instances_exchange_quote_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_reserved_instances_exchange_quote_request.serialize_ec2_query(
        input_, pairs, ""
    )
