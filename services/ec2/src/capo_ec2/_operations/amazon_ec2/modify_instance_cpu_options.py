...
import capo_ec2.types.modify_instance_cpu_options_request
import capo_ec2.types.modify_instance_cpu_options_result
...
) -> capo_ec2.types.modify_instance_cpu_options_result.ModifyInstanceCpuOptionsResult:
    out: capo_ec2.types.modify_instance_cpu_options_result.ModifyInstanceCpuOptionsResult = capo_ec2.types.modify_instance_cpu_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_instance_cpu_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
