...
import capo_ec2.types.describe_capacity_block_extension_history_request
import capo_ec2.types.describe_capacity_block_extension_history_result
...
) -> capo_ec2.types.describe_capacity_block_extension_history_result.DescribeCapacityBlockExtensionHistoryResult:
    out: capo_ec2.types.describe_capacity_block_extension_history_result.DescribeCapacityBlockExtensionHistoryResult = capo_ec2.types.describe_capacity_block_extension_history_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeCapacityBlockExtensionHistory"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_capacity_block_extension_history_request.serialize_ec2_query(
        input_, pairs, ""
    )
