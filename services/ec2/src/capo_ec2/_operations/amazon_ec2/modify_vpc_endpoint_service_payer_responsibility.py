...
import capo_ec2.types.modify_vpc_endpoint_service_payer_responsibility_request
import capo_ec2.types.modify_vpc_endpoint_service_payer_responsibility_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_vpc_endpoint_service_payer_responsibility_result.ModifyVpcEndpointServicePayerResponsibilityResult = capo_ec2.types.modify_vpc_endpoint_service_payer_responsibility_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyVpcEndpointServicePayerResponsibility"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_vpc_endpoint_service_payer_responsibility_request.serialize_ec2_query(
        input_, pairs, ""
    )
