...
import capo_ec2.types.describe_transit_gateway_metering_policies_request
import capo_ec2.types.describe_transit_gateway_metering_policies_result
import capo_ec2.types.filter_list
import capo_ec2.types.transit_gateway_metering_policy_id_string_list
...
) -> capo_ec2.types.describe_transit_gateway_metering_policies_result.DescribeTransitGatewayMeteringPoliciesResult:
    out: capo_ec2.types.describe_transit_gateway_metering_policies_result.DescribeTransitGatewayMeteringPoliciesResult = capo_ec2.types.describe_transit_gateway_metering_policies_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_transit_gateway_metering_policies_request.serialize_ec2_query(
        input_, pairs, ""
    )
