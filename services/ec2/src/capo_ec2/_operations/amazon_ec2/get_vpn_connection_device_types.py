...
import capo_ec2.types.get_vpn_connection_device_types_request
import capo_ec2.types.get_vpn_connection_device_types_result
...
) -> capo_ec2.types.get_vpn_connection_device_types_result.GetVpnConnectionDeviceTypesResult:
    out: capo_ec2.types.get_vpn_connection_device_types_result.GetVpnConnectionDeviceTypesResult = capo_ec2.types.get_vpn_connection_device_types_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_vpn_connection_device_types_request.serialize_ec2_query(
        input_, pairs, ""
    )
