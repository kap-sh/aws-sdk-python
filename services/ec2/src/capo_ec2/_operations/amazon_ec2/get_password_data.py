...
import capo_ec2.types.get_password_data_request
import capo_ec2.types.get_password_data_result
...
def handle_response(
    ...
    out: capo_ec2.types.get_password_data_result.GetPasswordDataResult = (
        capo_ec2.types.get_password_data_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetPasswordData"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_password_data_request.serialize_ec2_query(input_, pairs, "")
...
def get_password_data(
    ...
    capo_ec2.types.get_password_data_result.GetPasswordDataResult, zapros.Response
]:
