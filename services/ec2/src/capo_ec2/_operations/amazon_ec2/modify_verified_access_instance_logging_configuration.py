...
import capo_ec2.types.modify_verified_access_instance_logging_configuration_request
import capo_ec2.types.modify_verified_access_instance_logging_configuration_result
import capo_ec2.types.verified_access_instance_logging_configuration
import capo_ec2.types.verified_access_log_options
...
def handle_response(
    ...
    out: capo_ec2.types.modify_verified_access_instance_logging_configuration_result.ModifyVerifiedAccessInstanceLoggingConfigurationResult = capo_ec2.types.modify_verified_access_instance_logging_configuration_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyVerifiedAccessInstanceLoggingConfiguration"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_verified_access_instance_logging_configuration_request.serialize_ec2_query(
        input_, pairs, ""
    )
