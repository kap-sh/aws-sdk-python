...
def handle_response(
    ...
    out: capo_ec2.types.delete_transit_gateway_policy_table_result.DeleteTransitGatewayPolicyTableResult = capo_ec2.types.delete_transit_gateway_policy_table_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_transit_gateway_policy_table_request.serialize_ec2_query(
        input_, pairs, ""
    )
