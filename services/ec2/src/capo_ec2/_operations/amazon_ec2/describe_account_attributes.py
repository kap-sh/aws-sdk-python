...
) -> capo_ec2.types.describe_account_attributes_result.DescribeAccountAttributesResult:
    out: capo_ec2.types.describe_account_attributes_result.DescribeAccountAttributesResult = capo_ec2.types.describe_account_attributes_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_account_attributes_request.serialize_ec2_query(
        input_, pairs, ""
    )
