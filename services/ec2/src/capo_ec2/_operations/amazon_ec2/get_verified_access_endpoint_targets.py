...
) -> capo_ec2.types.get_verified_access_endpoint_targets_result.GetVerifiedAccessEndpointTargetsResult:
    out: capo_ec2.types.get_verified_access_endpoint_targets_result.GetVerifiedAccessEndpointTargetsResult = capo_ec2.types.get_verified_access_endpoint_targets_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetVerifiedAccessEndpointTargets"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_verified_access_endpoint_targets_request.serialize_ec2_query(
        input_, pairs, ""
    )
