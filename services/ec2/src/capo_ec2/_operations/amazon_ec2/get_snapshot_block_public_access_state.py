"""Generated from Smithy shape ``com.amazonaws.ec2#GetSnapshotBlockPublicAccessState``."""
...
import capo_ec2.types.get_snapshot_block_public_access_state_request
import capo_ec2.types.get_snapshot_block_public_access_state_result
...
) -> capo_ec2.types.get_snapshot_block_public_access_state_result.GetSnapshotBlockPublicAccessStateResult:
    out: capo_ec2.types.get_snapshot_block_public_access_state_result.GetSnapshotBlockPublicAccessStateResult = capo_ec2.types.get_snapshot_block_public_access_state_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_snapshot_block_public_access_state_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_get_snapshot_block_public_access_state(
