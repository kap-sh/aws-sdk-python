...
import capo_ec2.types.create_dhcp_options_request
import capo_ec2.types.create_dhcp_options_result
...
) -> capo_ec2.types.create_dhcp_options_result.CreateDhcpOptionsResult:
    out: capo_ec2.types.create_dhcp_options_result.CreateDhcpOptionsResult = (
        capo_ec2.types.create_dhcp_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateDhcpOptions"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_dhcp_options_request.serialize_ec2_query(input_, pairs, "")
...
def create_dhcp_options(
    ...
    capo_ec2.types.create_dhcp_options_result.CreateDhcpOptionsResult, zapros.Response
]:
