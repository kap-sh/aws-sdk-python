...
) -> capo_ec2.types.modify_transit_gateway_prefix_list_reference_result.ModifyTransitGatewayPrefixListReferenceResult:
    out: capo_ec2.types.modify_transit_gateway_prefix_list_reference_result.ModifyTransitGatewayPrefixListReferenceResult = capo_ec2.types.modify_transit_gateway_prefix_list_reference_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_transit_gateway_prefix_list_reference_request.serialize_ec2_query(
        input_, pairs, ""
    )
