"""Generated from Smithy shape ``com.amazonaws.ec2#CreateReservedInstancesListing``."""
...
import capo_ec2.types.create_reserved_instances_listing_request
import capo_ec2.types.create_reserved_instances_listing_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_reserved_instances_listing_result.CreateReservedInstancesListingResult = capo_ec2.types.create_reserved_instances_listing_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateReservedInstancesListing"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_reserved_instances_listing_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_create_reserved_instances_listing(
