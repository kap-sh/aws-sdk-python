"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeIpamInternetRegistryAssociations``."""
...
def handle_response(
    ...
    out: capo_ec2.types.describe_ipam_internet_registry_associations_result.DescribeIpamInternetRegistryAssociationsResult = capo_ec2.types.describe_ipam_internet_registry_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeIpamInternetRegistryAssociations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_ipam_internet_registry_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_ipam_internet_registry_associations(
