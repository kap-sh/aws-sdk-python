...
import capo_ec2.types.move_address_to_vpc_request
import capo_ec2.types.move_address_to_vpc_result
...
def handle_response(
    ...
    out: capo_ec2.types.move_address_to_vpc_result.MoveAddressToVpcResult = (
        capo_ec2.types.move_address_to_vpc_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "MoveAddressToVpc"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.move_address_to_vpc_request.serialize_ec2_query(input_, pairs, "")
...
def move_address_to_vpc(
    ...
    capo_ec2.types.move_address_to_vpc_result.MoveAddressToVpcResult, zapros.Response
]:
