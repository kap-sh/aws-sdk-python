...
import capo_ec2.types.get_ipam_prefix_list_resolver_rules_request
import capo_ec2.types.get_ipam_prefix_list_resolver_rules_result
...
) -> capo_ec2.types.get_ipam_prefix_list_resolver_rules_result.GetIpamPrefixListResolverRulesResult:
    out: capo_ec2.types.get_ipam_prefix_list_resolver_rules_result.GetIpamPrefixListResolverRulesResult = capo_ec2.types.get_ipam_prefix_list_resolver_rules_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetIpamPrefixListResolverRules"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_ipam_prefix_list_resolver_rules_request.serialize_ec2_query(
        input_, pairs, ""
    )
