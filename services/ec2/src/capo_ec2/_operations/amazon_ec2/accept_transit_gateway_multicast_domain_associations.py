...
import capo_ec2.types.accept_transit_gateway_multicast_domain_associations_request
import capo_ec2.types.accept_transit_gateway_multicast_domain_associations_result
...
) -> capo_ec2.types.accept_transit_gateway_multicast_domain_associations_result.AcceptTransitGatewayMulticastDomainAssociationsResult:
    out: capo_ec2.types.accept_transit_gateway_multicast_domain_associations_result.AcceptTransitGatewayMulticastDomainAssociationsResult = capo_ec2.types.accept_transit_gateway_multicast_domain_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AcceptTransitGatewayMulticastDomainAssociations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.accept_transit_gateway_multicast_domain_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
