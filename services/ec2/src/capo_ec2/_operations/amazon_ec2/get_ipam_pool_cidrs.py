...
import capo_ec2.types.get_ipam_pool_cidrs_request
import capo_ec2.types.get_ipam_pool_cidrs_result
...
) -> capo_ec2.types.get_ipam_pool_cidrs_result.GetIpamPoolCidrsResult:
    out: capo_ec2.types.get_ipam_pool_cidrs_result.GetIpamPoolCidrsResult = (
        capo_ec2.types.get_ipam_pool_cidrs_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_ipam_pool_cidrs_request.serialize_ec2_query(input_, pairs, "")
...
def get_ipam_pool_cidrs(
    ...
    capo_ec2.types.get_ipam_pool_cidrs_result.GetIpamPoolCidrsResult, zapros.Response
]:
