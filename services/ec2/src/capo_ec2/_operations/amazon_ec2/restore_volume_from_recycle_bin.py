...
import capo_ec2.types.restore_volume_from_recycle_bin_request
import capo_ec2.types.restore_volume_from_recycle_bin_result
...
def handle_response(
    ...
    out: capo_ec2.types.restore_volume_from_recycle_bin_result.RestoreVolumeFromRecycleBinResult = capo_ec2.types.restore_volume_from_recycle_bin_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "RestoreVolumeFromRecycleBin"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.restore_volume_from_recycle_bin_request.serialize_ec2_query(
        input_, pairs, ""
    )
