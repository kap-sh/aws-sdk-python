...
import capo_ec2.types.delete_local_gateway_route_table_request
import capo_ec2.types.delete_local_gateway_route_table_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_local_gateway_route_table_result.DeleteLocalGatewayRouteTableResult = capo_ec2.types.delete_local_gateway_route_table_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteLocalGatewayRouteTable"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_local_gateway_route_table_request.serialize_ec2_query(
        input_, pairs, ""
    )
