...
import capo_ec2.types.describe_local_gateway_route_table_virtual_interface_group_associations_request
import capo_ec2.types.describe_local_gateway_route_table_virtual_interface_group_associations_result
...
) -> capo_ec2.types.describe_local_gateway_route_table_virtual_interface_group_associations_result.DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsResult:
    out: capo_ec2.types.describe_local_gateway_route_table_virtual_interface_group_associations_result.DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsResult = capo_ec2.types.describe_local_gateway_route_table_virtual_interface_group_associations_result.deserialize_ec2_query(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_ec2._auth._sigv4.build_sigv4_auth_scheme("ec2", options.region)
        )
...
def build_request(
    ...
    capo_ec2.types.describe_local_gateway_route_table_virtual_interface_group_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
