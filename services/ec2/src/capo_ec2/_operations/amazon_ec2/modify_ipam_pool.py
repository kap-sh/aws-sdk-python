...
import capo_ec2.types.modify_ipam_pool_request
import capo_ec2.types.modify_ipam_pool_result
...
) -> capo_ec2.types.modify_ipam_pool_result.ModifyIpamPoolResult:
    out: capo_ec2.types.modify_ipam_pool_result.ModifyIpamPoolResult = (
        capo_ec2.types.modify_ipam_pool_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyIpamPool"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_ipam_pool_request.serialize_ec2_query(input_, pairs, "")
...
def modify_ipam_pool(
    ...
    capo_ec2.types.modify_ipam_pool_result.ModifyIpamPoolResult, zapros.Response
]:
