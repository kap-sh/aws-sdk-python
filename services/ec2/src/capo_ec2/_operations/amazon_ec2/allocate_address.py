...
) -> capo_ec2.types.allocate_address_result.AllocateAddressResult:
    out: capo_ec2.types.allocate_address_result.AllocateAddressResult = (
        capo_ec2.types.allocate_address_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AllocateAddress"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.allocate_address_request.serialize_ec2_query(input_, pairs, "")
...
def allocate_address(
    ...
    capo_ec2.types.allocate_address_result.AllocateAddressResult, zapros.Response
]:
