...
import capo_ec2.types.unassign_ipv6_addresses_request
import capo_ec2.types.unassign_ipv6_addresses_result
...
) -> capo_ec2.types.unassign_ipv6_addresses_result.UnassignIpv6AddressesResult:
    out: capo_ec2.types.unassign_ipv6_addresses_result.UnassignIpv6AddressesResult = (
        capo_ec2.types.unassign_ipv6_addresses_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.unassign_ipv6_addresses_request.serialize_ec2_query(
        input_, pairs, ""
    )
