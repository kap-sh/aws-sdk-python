...
import capo_ec2.types.describe_instance_event_notification_attributes_request
import capo_ec2.types.describe_instance_event_notification_attributes_result
...
) -> capo_ec2.types.describe_instance_event_notification_attributes_result.DescribeInstanceEventNotificationAttributesResult:
    out: capo_ec2.types.describe_instance_event_notification_attributes_result.DescribeInstanceEventNotificationAttributesResult = capo_ec2.types.describe_instance_event_notification_attributes_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_instance_event_notification_attributes_request.serialize_ec2_query(
        input_, pairs, ""
    )
