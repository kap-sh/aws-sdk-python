...
import capo_ec2.types.describe_fast_launch_images_request
import capo_ec2.types.describe_fast_launch_images_result
...
) -> capo_ec2.types.describe_fast_launch_images_result.DescribeFastLaunchImagesResult:
    out: capo_ec2.types.describe_fast_launch_images_result.DescribeFastLaunchImagesResult = capo_ec2.types.describe_fast_launch_images_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeFastLaunchImages"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_fast_launch_images_request.serialize_ec2_query(
        input_, pairs, ""
    )
