"""Generated from Smithy shape ``com.amazonaws.ec2#PurchaseReservedInstancesOffering``."""
...
import capo_ec2.types.purchase_reserved_instances_offering_request
import capo_ec2.types.purchase_reserved_instances_offering_result
...
) -> capo_ec2.types.purchase_reserved_instances_offering_result.PurchaseReservedInstancesOfferingResult:
    out: capo_ec2.types.purchase_reserved_instances_offering_result.PurchaseReservedInstancesOfferingResult = capo_ec2.types.purchase_reserved_instances_offering_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "PurchaseReservedInstancesOffering"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.purchase_reserved_instances_offering_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_purchase_reserved_instances_offering(
