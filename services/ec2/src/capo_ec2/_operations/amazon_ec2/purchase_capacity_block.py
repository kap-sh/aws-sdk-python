"""Generated from Smithy shape ``com.amazonaws.ec2#PurchaseCapacityBlock``."""
...
import capo_ec2.types.purchase_capacity_block_request
import capo_ec2.types.purchase_capacity_block_result
...
def handle_response(
    ...
    out: capo_ec2.types.purchase_capacity_block_result.PurchaseCapacityBlockResult = (
        capo_ec2.types.purchase_capacity_block_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "PurchaseCapacityBlock"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.purchase_capacity_block_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_purchase_capacity_block(
