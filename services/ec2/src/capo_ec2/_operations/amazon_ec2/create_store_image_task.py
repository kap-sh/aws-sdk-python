...
import capo_ec2.types.create_store_image_task_request
import capo_ec2.types.create_store_image_task_result
...
) -> capo_ec2.types.create_store_image_task_result.CreateStoreImageTaskResult:
    out: capo_ec2.types.create_store_image_task_result.CreateStoreImageTaskResult = (
        capo_ec2.types.create_store_image_task_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateStoreImageTask"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_store_image_task_request.serialize_ec2_query(
        input_, pairs, ""
    )
