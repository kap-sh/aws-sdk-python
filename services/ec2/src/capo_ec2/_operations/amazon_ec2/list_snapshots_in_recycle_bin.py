...
import capo_ec2.types.list_snapshots_in_recycle_bin_request
import capo_ec2.types.list_snapshots_in_recycle_bin_result
...
def handle_response(
    ...
    capo_ec2.types.list_snapshots_in_recycle_bin_result.ListSnapshotsInRecycleBinResult
):
    out: capo_ec2.types.list_snapshots_in_recycle_bin_result.ListSnapshotsInRecycleBinResult = capo_ec2.types.list_snapshots_in_recycle_bin_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.list_snapshots_in_recycle_bin_request.serialize_ec2_query(
        input_, pairs, ""
    )
