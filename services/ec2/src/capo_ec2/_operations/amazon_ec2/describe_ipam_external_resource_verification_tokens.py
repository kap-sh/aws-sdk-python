...
) -> capo_ec2.types.describe_ipam_external_resource_verification_tokens_result.DescribeIpamExternalResourceVerificationTokensResult:
    out: capo_ec2.types.describe_ipam_external_resource_verification_tokens_result.DescribeIpamExternalResourceVerificationTokensResult = capo_ec2.types.describe_ipam_external_resource_verification_tokens_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_ipam_external_resource_verification_tokens_request.serialize_ec2_query(
        input_, pairs, ""
    )
