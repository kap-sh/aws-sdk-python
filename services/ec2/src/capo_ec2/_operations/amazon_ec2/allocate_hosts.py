...
) -> capo_ec2.types.allocate_hosts_result.AllocateHostsResult:
    out: capo_ec2.types.allocate_hosts_result.AllocateHostsResult = (
        capo_ec2.types.allocate_hosts_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.allocate_hosts_request.serialize_ec2_query(input_, pairs, "")
...
def allocate_hosts(
    ...
    input_: capo_ec2.types.allocate_hosts_request.AllocateHostsRequest,
) -> tuple[capo_ec2.types.allocate_hosts_result.AllocateHostsResult, zapros.Response]:
