...
import capo_ec2.types.disassociate_security_group_vpc_request
import capo_ec2.types.disassociate_security_group_vpc_result
...
def handle_response(
    ...
    out: capo_ec2.types.disassociate_security_group_vpc_result.DisassociateSecurityGroupVpcResult = capo_ec2.types.disassociate_security_group_vpc_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.disassociate_security_group_vpc_request.serialize_ec2_query(
        input_, pairs, ""
    )
