...
import capo_ec2.types.modify_security_group_rules_request
import capo_ec2.types.modify_security_group_rules_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_security_group_rules_result.ModifySecurityGroupRulesResult = capo_ec2.types.modify_security_group_rules_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifySecurityGroupRules"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_security_group_rules_request.serialize_ec2_query(
        input_, pairs, ""
    )
