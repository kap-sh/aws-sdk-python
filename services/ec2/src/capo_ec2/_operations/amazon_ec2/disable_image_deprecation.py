...
import capo_ec2.types.disable_image_deprecation_request
import capo_ec2.types.disable_image_deprecation_result
...
def handle_response(
    ...
    out: capo_ec2.types.disable_image_deprecation_result.DisableImageDeprecationResult = capo_ec2.types.disable_image_deprecation_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableImageDeprecation"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disable_image_deprecation_request.serialize_ec2_query(
        input_, pairs, ""
    )
