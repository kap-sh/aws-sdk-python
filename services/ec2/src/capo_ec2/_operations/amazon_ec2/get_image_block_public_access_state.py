...
import capo_ec2.types.get_image_block_public_access_state_request
import capo_ec2.types.get_image_block_public_access_state_result
...
) -> capo_ec2.types.get_image_block_public_access_state_result.GetImageBlockPublicAccessStateResult:
    out: capo_ec2.types.get_image_block_public_access_state_result.GetImageBlockPublicAccessStateResult = capo_ec2.types.get_image_block_public_access_state_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetImageBlockPublicAccessState"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_image_block_public_access_state_request.serialize_ec2_query(
        input_, pairs, ""
    )
