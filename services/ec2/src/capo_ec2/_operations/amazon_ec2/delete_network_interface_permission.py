"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteNetworkInterfacePermission``."""
...
import capo_ec2.types.delete_network_interface_permission_request
import capo_ec2.types.delete_network_interface_permission_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_network_interface_permission_result.DeleteNetworkInterfacePermissionResult = capo_ec2.types.delete_network_interface_permission_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteNetworkInterfacePermission"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_network_interface_permission_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_network_interface_permission(
