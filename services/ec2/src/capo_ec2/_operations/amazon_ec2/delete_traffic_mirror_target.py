...
import capo_ec2.types.delete_traffic_mirror_target_request
import capo_ec2.types.delete_traffic_mirror_target_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_traffic_mirror_target_result.DeleteTrafficMirrorTargetResult = capo_ec2.types.delete_traffic_mirror_target_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_traffic_mirror_target_request.serialize_ec2_query(
        input_, pairs, ""
    )
