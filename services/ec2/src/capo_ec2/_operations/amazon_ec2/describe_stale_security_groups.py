...
import capo_ec2.types.describe_stale_security_groups_request
import capo_ec2.types.describe_stale_security_groups_result
...
def handle_response(
    ...
    out: capo_ec2.types.describe_stale_security_groups_result.DescribeStaleSecurityGroupsResult = capo_ec2.types.describe_stale_security_groups_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_stale_security_groups_request.serialize_ec2_query(
        input_, pairs, ""
    )
