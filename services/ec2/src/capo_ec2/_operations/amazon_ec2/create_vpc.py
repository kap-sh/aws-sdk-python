...
import capo_ec2.types.create_vpc_request
import capo_ec2.types.create_vpc_result
...
) -> capo_ec2.types.create_vpc_result.CreateVpcResult:
    out: capo_ec2.types.create_vpc_result.CreateVpcResult = (
        capo_ec2.types.create_vpc_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateVpc"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_vpc_request.serialize_ec2_query(input_, pairs, "")
...
def create_vpc(
    ...
    input_: capo_ec2.types.create_vpc_request.CreateVpcRequest,
) -> tuple[capo_ec2.types.create_vpc_result.CreateVpcResult, zapros.Response]:
