...
import capo_ec2.types.capacity_block_offering_set
import capo_ec2.types.describe_capacity_block_offerings_request
import capo_ec2.types.describe_capacity_block_offerings_result
...
) -> capo_ec2.types.describe_capacity_block_offerings_result.DescribeCapacityBlockOfferingsResult:
    out: capo_ec2.types.describe_capacity_block_offerings_result.DescribeCapacityBlockOfferingsResult = capo_ec2.types.describe_capacity_block_offerings_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeCapacityBlockOfferings"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_capacity_block_offerings_request.serialize_ec2_query(
        input_, pairs, ""
    )
