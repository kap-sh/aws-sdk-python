"""Generated from Smithy shape ``com.amazonaws.ec2#CreateImageUsageReport``."""
...
import capo_ec2.types.create_image_usage_report_request
import capo_ec2.types.create_image_usage_report_result
...
) -> capo_ec2.types.create_image_usage_report_result.CreateImageUsageReportResult:
    out: capo_ec2.types.create_image_usage_report_result.CreateImageUsageReportResult = capo_ec2.types.create_image_usage_report_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_image_usage_report_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_create_image_usage_report(
