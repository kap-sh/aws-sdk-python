"""Generated from Smithy shape ``com.amazonaws.ec2#ReportInstanceStatus``."""
...
import capo_ec2.types.report_instance_status_request
...
def build_request(
    ...
    pairs.append(("Action", "ReportInstanceStatus"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.report_instance_status_request.serialize_ec2_query(input_, pairs, "")
...
async def async_report_instance_status(
