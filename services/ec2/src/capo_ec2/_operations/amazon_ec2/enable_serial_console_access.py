...
import capo_ec2.types.enable_serial_console_access_request
import capo_ec2.types.enable_serial_console_access_result
...
) -> capo_ec2.types.enable_serial_console_access_result.EnableSerialConsoleAccessResult:
    out: capo_ec2.types.enable_serial_console_access_result.EnableSerialConsoleAccessResult = capo_ec2.types.enable_serial_console_access_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "EnableSerialConsoleAccess"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.enable_serial_console_access_request.serialize_ec2_query(
        input_, pairs, ""
    )
