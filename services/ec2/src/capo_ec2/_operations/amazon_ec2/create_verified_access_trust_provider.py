"""Generated from Smithy shape ``com.amazonaws.ec2#CreateVerifiedAccessTrustProvider``."""
...
import capo_ec2.types.create_verified_access_trust_provider_request
import capo_ec2.types.create_verified_access_trust_provider_result
...
) -> capo_ec2.types.create_verified_access_trust_provider_result.CreateVerifiedAccessTrustProviderResult:
    out: capo_ec2.types.create_verified_access_trust_provider_result.CreateVerifiedAccessTrustProviderResult = capo_ec2.types.create_verified_access_trust_provider_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateVerifiedAccessTrustProvider"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_verified_access_trust_provider_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_create_verified_access_trust_provider(
