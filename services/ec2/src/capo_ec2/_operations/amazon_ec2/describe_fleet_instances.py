...
import capo_ec2.types.describe_fleet_instances_request
import capo_ec2.types.describe_fleet_instances_result
...
def handle_response(
    ...
    out: capo_ec2.types.describe_fleet_instances_result.DescribeFleetInstancesResult = (
        capo_ec2.types.describe_fleet_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeFleetInstances"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_fleet_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
