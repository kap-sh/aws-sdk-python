...
import capo_ec2.types.describe_snapshots_request
import capo_ec2.types.describe_snapshots_result
...
) -> capo_ec2.types.describe_snapshots_result.DescribeSnapshotsResult:
    out: capo_ec2.types.describe_snapshots_result.DescribeSnapshotsResult = (
        capo_ec2.types.describe_snapshots_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_snapshots_request.serialize_ec2_query(input_, pairs, "")
...
def describe_snapshots(
    ...
    capo_ec2.types.describe_snapshots_result.DescribeSnapshotsResult, zapros.Response
]:
