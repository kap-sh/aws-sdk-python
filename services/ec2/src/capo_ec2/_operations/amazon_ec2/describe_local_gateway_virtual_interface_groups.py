...
import capo_ec2.types.describe_local_gateway_virtual_interface_groups_request
import capo_ec2.types.describe_local_gateway_virtual_interface_groups_result
...
) -> capo_ec2.types.describe_local_gateway_virtual_interface_groups_result.DescribeLocalGatewayVirtualInterfaceGroupsResult:
    out: capo_ec2.types.describe_local_gateway_virtual_interface_groups_result.DescribeLocalGatewayVirtualInterfaceGroupsResult = capo_ec2.types.describe_local_gateway_virtual_interface_groups_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeLocalGatewayVirtualInterfaceGroups"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_local_gateway_virtual_interface_groups_request.serialize_ec2_query(
        input_, pairs, ""
    )
