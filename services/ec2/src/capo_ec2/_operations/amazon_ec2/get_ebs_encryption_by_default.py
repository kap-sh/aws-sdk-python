...
import capo_ec2.types.get_ebs_encryption_by_default_request
import capo_ec2.types.get_ebs_encryption_by_default_result
...
def handle_response(
    ...
    capo_ec2.types.get_ebs_encryption_by_default_result.GetEbsEncryptionByDefaultResult
):
    out: capo_ec2.types.get_ebs_encryption_by_default_result.GetEbsEncryptionByDefaultResult = capo_ec2.types.get_ebs_encryption_by_default_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetEbsEncryptionByDefault"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_ebs_encryption_by_default_request.serialize_ec2_query(
        input_, pairs, ""
    )
