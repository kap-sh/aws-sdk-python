"""Generated from Smithy shape ``com.amazonaws.ec2#ResetImageAttribute``."""
...
import capo_ec2.types.reset_image_attribute_request
...
def build_request(
    ...
    pairs.append(("Action", "ResetImageAttribute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.reset_image_attribute_request.serialize_ec2_query(input_, pairs, "")
...
async def async_reset_image_attribute(
