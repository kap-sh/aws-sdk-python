...
import capo_ec2.types.describe_reserved_instances_offerings_request
import capo_ec2.types.describe_reserved_instances_offerings_result
...
) -> capo_ec2.types.describe_reserved_instances_offerings_result.DescribeReservedInstancesOfferingsResult:
    out: capo_ec2.types.describe_reserved_instances_offerings_result.DescribeReservedInstancesOfferingsResult = capo_ec2.types.describe_reserved_instances_offerings_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_reserved_instances_offerings_request.serialize_ec2_query(
        input_, pairs, ""
    )
