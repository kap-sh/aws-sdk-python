...
def handle_response(
    ...
    out: capo_ec2.types.enable_ipam_organization_admin_account_result.EnableIpamOrganizationAdminAccountResult = capo_ec2.types.enable_ipam_organization_admin_account_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.enable_ipam_organization_admin_account_request.serialize_ec2_query(
        input_, pairs, ""
    )
