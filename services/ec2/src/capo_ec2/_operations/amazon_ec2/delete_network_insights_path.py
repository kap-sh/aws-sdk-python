...
import capo_ec2.types.delete_network_insights_path_request
import capo_ec2.types.delete_network_insights_path_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_network_insights_path_result.DeleteNetworkInsightsPathResult = capo_ec2.types.delete_network_insights_path_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_network_insights_path_request.serialize_ec2_query(
        input_, pairs, ""
    )
