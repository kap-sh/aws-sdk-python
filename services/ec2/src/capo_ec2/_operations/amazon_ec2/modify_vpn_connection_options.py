...
import capo_ec2.types.modify_vpn_connection_options_request
import capo_ec2.types.modify_vpn_connection_options_result
...
def handle_response(
    ...
    capo_ec2.types.modify_vpn_connection_options_result.ModifyVpnConnectionOptionsResult
):
    out: capo_ec2.types.modify_vpn_connection_options_result.ModifyVpnConnectionOptionsResult = capo_ec2.types.modify_vpn_connection_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyVpnConnectionOptions"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_vpn_connection_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
