...
) -> capo_ec2.types.create_transit_gateway_peering_attachment_result.CreateTransitGatewayPeeringAttachmentResult:
    out: capo_ec2.types.create_transit_gateway_peering_attachment_result.CreateTransitGatewayPeeringAttachmentResult = capo_ec2.types.create_transit_gateway_peering_attachment_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_transit_gateway_peering_attachment_request.serialize_ec2_query(
        input_, pairs, ""
    )
