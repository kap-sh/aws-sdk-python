...
) -> capo_ec2.types.create_capacity_reservation_fleet_result.CreateCapacityReservationFleetResult:
    out: capo_ec2.types.create_capacity_reservation_fleet_result.CreateCapacityReservationFleetResult = capo_ec2.types.create_capacity_reservation_fleet_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_capacity_reservation_fleet_request.serialize_ec2_query(
        input_, pairs, ""
    )
