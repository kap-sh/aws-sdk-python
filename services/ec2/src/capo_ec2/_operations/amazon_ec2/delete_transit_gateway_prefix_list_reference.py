...
import capo_ec2.types.delete_transit_gateway_prefix_list_reference_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_transit_gateway_prefix_list_reference_result.DeleteTransitGatewayPrefixListReferenceResult = capo_ec2.types.delete_transit_gateway_prefix_list_reference_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_transit_gateway_prefix_list_reference_request.serialize_ec2_query(
        input_, pairs, ""
    )
