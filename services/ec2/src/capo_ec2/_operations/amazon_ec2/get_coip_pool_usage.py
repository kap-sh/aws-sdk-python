...
) -> capo_ec2.types.get_coip_pool_usage_result.GetCoipPoolUsageResult:
    out: capo_ec2.types.get_coip_pool_usage_result.GetCoipPoolUsageResult = (
        capo_ec2.types.get_coip_pool_usage_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetCoipPoolUsage"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_coip_pool_usage_request.serialize_ec2_query(input_, pairs, "")
...
def get_coip_pool_usage(
    ...
    capo_ec2.types.get_coip_pool_usage_result.GetCoipPoolUsageResult, zapros.Response
]:
