"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeInstanceTypeOfferings``."""
...
import capo_ec2.types.describe_instance_type_offerings_request
import capo_ec2.types.describe_instance_type_offerings_result
...
) -> capo_ec2.types.describe_instance_type_offerings_result.DescribeInstanceTypeOfferingsResult:
    out: capo_ec2.types.describe_instance_type_offerings_result.DescribeInstanceTypeOfferingsResult = capo_ec2.types.describe_instance_type_offerings_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeInstanceTypeOfferings"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_instance_type_offerings_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_instance_type_offerings(
