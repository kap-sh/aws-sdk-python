"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeApplicationStatusCheckAssociations``."""
...
def handle_response(
    ...
    out: capo_ec2.types.describe_application_status_check_associations_result.DescribeApplicationStatusCheckAssociationsResult = capo_ec2.types.describe_application_status_check_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeApplicationStatusCheckAssociations"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_application_status_check_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_application_status_check_associations(
