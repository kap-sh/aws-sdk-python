...
import capo_ec2.types.attach_vpn_gateway_request
import capo_ec2.types.attach_vpn_gateway_result
...
def handle_response(
    ...
    out: capo_ec2.types.attach_vpn_gateway_result.AttachVpnGatewayResult = (
        capo_ec2.types.attach_vpn_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AttachVpnGateway"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.attach_vpn_gateway_request.serialize_ec2_query(input_, pairs, "")
...
def attach_vpn_gateway(
    ...
    capo_ec2.types.attach_vpn_gateway_result.AttachVpnGatewayResult, zapros.Response
]:
