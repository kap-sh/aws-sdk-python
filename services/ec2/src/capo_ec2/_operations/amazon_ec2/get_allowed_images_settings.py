...
import capo_ec2.types.get_allowed_images_settings_request
import capo_ec2.types.get_allowed_images_settings_result
...
) -> capo_ec2.types.get_allowed_images_settings_result.GetAllowedImagesSettingsResult:
    out: capo_ec2.types.get_allowed_images_settings_result.GetAllowedImagesSettingsResult = capo_ec2.types.get_allowed_images_settings_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.get_allowed_images_settings_request.serialize_ec2_query(
        input_, pairs, ""
    )
