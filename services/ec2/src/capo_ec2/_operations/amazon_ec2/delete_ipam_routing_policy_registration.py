"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteIpamRoutingPolicyRegistration``."""
...
def handle_response(
    ...
    out: capo_ec2.types.delete_ipam_routing_policy_registration_result.DeleteIpamRoutingPolicyRegistrationResult = capo_ec2.types.delete_ipam_routing_policy_registration_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteIpamRoutingPolicyRegistration"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_ipam_routing_policy_registration_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_ipam_routing_policy_registration(
