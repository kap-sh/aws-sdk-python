"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteVpcEndpoints``."""
...
import capo_ec2.types.delete_vpc_endpoints_request
import capo_ec2.types.delete_vpc_endpoints_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_vpc_endpoints_result.DeleteVpcEndpointsResult = (
        capo_ec2.types.delete_vpc_endpoints_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteVpcEndpoints"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_vpc_endpoints_request.serialize_ec2_query(input_, pairs, "")
...
def delete_vpc_endpoints(
    ...
    capo_ec2.types.delete_vpc_endpoints_result.DeleteVpcEndpointsResult, zapros.Response
]:
...
async def async_delete_vpc_endpoints(
