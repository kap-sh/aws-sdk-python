...
import capo_ec2.types.describe_security_groups_request
import capo_ec2.types.describe_security_groups_result
...
) -> capo_ec2.types.describe_security_groups_result.DescribeSecurityGroupsResult:
    out: capo_ec2.types.describe_security_groups_result.DescribeSecurityGroupsResult = (
        capo_ec2.types.describe_security_groups_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeSecurityGroups"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_security_groups_request.serialize_ec2_query(
        input_, pairs, ""
    )
