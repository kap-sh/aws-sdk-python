"""Generated from Smithy shape ``com.amazonaws.ec2#GetIpamResourceCidrs``."""
...
) -> capo_ec2.types.get_ipam_resource_cidrs_result.GetIpamResourceCidrsResult:
    out: capo_ec2.types.get_ipam_resource_cidrs_result.GetIpamResourceCidrsResult = (
        capo_ec2.types.get_ipam_resource_cidrs_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetIpamResourceCidrs"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_ipam_resource_cidrs_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_get_ipam_resource_cidrs(
