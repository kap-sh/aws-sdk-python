...
import capo_ec2.types.create_transit_gateway_metering_policy_request
import capo_ec2.types.create_transit_gateway_metering_policy_result
...
) -> capo_ec2.types.create_transit_gateway_metering_policy_result.CreateTransitGatewayMeteringPolicyResult:
    out: capo_ec2.types.create_transit_gateway_metering_policy_result.CreateTransitGatewayMeteringPolicyResult = capo_ec2.types.create_transit_gateway_metering_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateTransitGatewayMeteringPolicy"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_transit_gateway_metering_policy_request.serialize_ec2_query(
        input_, pairs, ""
    )
