...
import capo_ec2.types.describe_volume_attribute_request
import capo_ec2.types.describe_volume_attribute_result
import capo_ec2.types.product_code_list
import capo_ec2.types.volume_attribute_name
...
def handle_response(
    ...
    out: capo_ec2.types.describe_volume_attribute_result.DescribeVolumeAttributeResult = capo_ec2.types.describe_volume_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVolumeAttribute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_volume_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
