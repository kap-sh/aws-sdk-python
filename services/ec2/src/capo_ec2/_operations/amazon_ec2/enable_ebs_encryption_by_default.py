...
import capo_ec2.types.enable_ebs_encryption_by_default_request
import capo_ec2.types.enable_ebs_encryption_by_default_result
...
) -> capo_ec2.types.enable_ebs_encryption_by_default_result.EnableEbsEncryptionByDefaultResult:
    out: capo_ec2.types.enable_ebs_encryption_by_default_result.EnableEbsEncryptionByDefaultResult = capo_ec2.types.enable_ebs_encryption_by_default_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "EnableEbsEncryptionByDefault"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.enable_ebs_encryption_by_default_request.serialize_ec2_query(
        input_, pairs, ""
    )
