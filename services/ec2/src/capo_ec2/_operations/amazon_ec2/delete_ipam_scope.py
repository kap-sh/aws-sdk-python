...
def handle_response(
    ...
    out: capo_ec2.types.delete_ipam_scope_result.DeleteIpamScopeResult = (
        capo_ec2.types.delete_ipam_scope_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_ipam_scope_request.serialize_ec2_query(input_, pairs, "")
...
def delete_ipam_scope(
    ...
    capo_ec2.types.delete_ipam_scope_result.DeleteIpamScopeResult, zapros.Response
]:
