...
import capo_ec2.types.modify_managed_resource_visibility_request
import capo_ec2.types.modify_managed_resource_visibility_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_managed_resource_visibility_result.ModifyManagedResourceVisibilityResult = capo_ec2.types.modify_managed_resource_visibility_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyManagedResourceVisibility"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_managed_resource_visibility_request.serialize_ec2_query(
        input_, pairs, ""
    )
