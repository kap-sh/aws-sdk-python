...
import capo_ec2.types.delete_coip_cidr_request
import capo_ec2.types.delete_coip_cidr_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_coip_cidr_result.DeleteCoipCidrResult = (
        capo_ec2.types.delete_coip_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.delete_coip_cidr_request.serialize_ec2_query(input_, pairs, "")
...
def delete_coip_cidr(
    ...
    capo_ec2.types.delete_coip_cidr_result.DeleteCoipCidrResult, zapros.Response
]:
