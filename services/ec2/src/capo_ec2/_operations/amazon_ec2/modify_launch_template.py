"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyLaunchTemplate``."""
...
import capo_ec2.types.modify_launch_template_result
...
) -> capo_ec2.types.modify_launch_template_result.ModifyLaunchTemplateResult:
    out: capo_ec2.types.modify_launch_template_result.ModifyLaunchTemplateResult = (
        capo_ec2.types.modify_launch_template_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyLaunchTemplate"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_launch_template_request.serialize_ec2_query(input_, pairs, "")
...
async def async_modify_launch_template(
