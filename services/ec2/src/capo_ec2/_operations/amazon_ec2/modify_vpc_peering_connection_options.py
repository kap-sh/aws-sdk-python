...
import capo_ec2.types.modify_vpc_peering_connection_options_request
import capo_ec2.types.modify_vpc_peering_connection_options_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_vpc_peering_connection_options_result.ModifyVpcPeeringConnectionOptionsResult = capo_ec2.types.modify_vpc_peering_connection_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyVpcPeeringConnectionOptions"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_vpc_peering_connection_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
