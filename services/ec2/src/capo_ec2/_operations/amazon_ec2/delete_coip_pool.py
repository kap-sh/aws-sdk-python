...
import capo_ec2.types.delete_coip_pool_request
import capo_ec2.types.delete_coip_pool_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_coip_pool_result.DeleteCoipPoolResult = (
        capo_ec2.types.delete_coip_pool_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteCoipPool"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_coip_pool_request.serialize_ec2_query(input_, pairs, "")
...
def delete_coip_pool(
    ...
    capo_ec2.types.delete_coip_pool_result.DeleteCoipPoolResult, zapros.Response
]:
