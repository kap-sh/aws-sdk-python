...
import capo_ec2.types.modify_fleet_request
import capo_ec2.types.modify_fleet_result
...
) -> capo_ec2.types.modify_fleet_result.ModifyFleetResult:
    out: capo_ec2.types.modify_fleet_result.ModifyFleetResult = (
        capo_ec2.types.modify_fleet_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_fleet_request.serialize_ec2_query(input_, pairs, "")
...
def modify_fleet(
    ...
    input_: capo_ec2.types.modify_fleet_request.ModifyFleetRequest,
) -> tuple[capo_ec2.types.modify_fleet_result.ModifyFleetResult, zapros.Response]:
