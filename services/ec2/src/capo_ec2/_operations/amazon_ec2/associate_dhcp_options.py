...
import capo_ec2.types.associate_dhcp_options_request
...
def build_request(
    ...
    pairs.append(("Action", "AssociateDhcpOptions"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.associate_dhcp_options_request.serialize_ec2_query(input_, pairs, "")
