...
def handle_response(
    ...
    out: capo_ec2.types.replace_image_criteria_in_allowed_images_settings_result.ReplaceImageCriteriaInAllowedImagesSettingsResult = capo_ec2.types.replace_image_criteria_in_allowed_images_settings_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.replace_image_criteria_in_allowed_images_settings_request.serialize_ec2_query(
        input_, pairs, ""
    )
