...
import capo_ec2.types.associate_enclave_certificate_iam_role_request
import capo_ec2.types.associate_enclave_certificate_iam_role_result
...
def handle_response(
    ...
    out: capo_ec2.types.associate_enclave_certificate_iam_role_result.AssociateEnclaveCertificateIamRoleResult = capo_ec2.types.associate_enclave_certificate_iam_role_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AssociateEnclaveCertificateIamRole"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.associate_enclave_certificate_iam_role_request.serialize_ec2_query(
        input_, pairs, ""
    )
