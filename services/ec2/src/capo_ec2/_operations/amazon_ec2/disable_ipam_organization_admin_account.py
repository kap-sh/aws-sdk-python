...
import capo_ec2.types.disable_ipam_organization_admin_account_request
import capo_ec2.types.disable_ipam_organization_admin_account_result
...
def handle_response(
    ...
    out: capo_ec2.types.disable_ipam_organization_admin_account_result.DisableIpamOrganizationAdminAccountResult = capo_ec2.types.disable_ipam_organization_admin_account_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DisableIpamOrganizationAdminAccount"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.disable_ipam_organization_admin_account_request.serialize_ec2_query(
        input_, pairs, ""
    )
