...
import capo_ec2.types.cancel_capacity_reservation_fleets_request
import capo_ec2.types.cancel_capacity_reservation_fleets_result
...
def handle_response(
    ...
    out: capo_ec2.types.cancel_capacity_reservation_fleets_result.CancelCapacityReservationFleetsResult = capo_ec2.types.cancel_capacity_reservation_fleets_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.cancel_capacity_reservation_fleets_request.serialize_ec2_query(
        input_, pairs, ""
    )
