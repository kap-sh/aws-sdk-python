...
import capo_ec2.types.create_delegate_mac_volume_ownership_task_request
import capo_ec2.types.create_delegate_mac_volume_ownership_task_result
...
) -> capo_ec2.types.create_delegate_mac_volume_ownership_task_result.CreateDelegateMacVolumeOwnershipTaskResult:
    out: capo_ec2.types.create_delegate_mac_volume_ownership_task_result.CreateDelegateMacVolumeOwnershipTaskResult = capo_ec2.types.create_delegate_mac_volume_ownership_task_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateDelegateMacVolumeOwnershipTask"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_delegate_mac_volume_ownership_task_request.serialize_ec2_query(
        input_, pairs, ""
    )
