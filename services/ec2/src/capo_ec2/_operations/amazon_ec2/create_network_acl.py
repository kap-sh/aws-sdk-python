...
import capo_ec2.types.create_network_acl_request
import capo_ec2.types.create_network_acl_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_network_acl_result.CreateNetworkAclResult = (
        capo_ec2.types.create_network_acl_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateNetworkAcl"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_network_acl_request.serialize_ec2_query(input_, pairs, "")
...
def create_network_acl(
    ...
    capo_ec2.types.create_network_acl_result.CreateNetworkAclResult, zapros.Response
]:
