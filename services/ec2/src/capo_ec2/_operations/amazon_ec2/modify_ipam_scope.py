...
) -> capo_ec2.types.modify_ipam_scope_result.ModifyIpamScopeResult:
    out: capo_ec2.types.modify_ipam_scope_result.ModifyIpamScopeResult = (
        capo_ec2.types.modify_ipam_scope_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_ipam_scope_request.serialize_ec2_query(input_, pairs, "")
...
def modify_ipam_scope(
    ...
    capo_ec2.types.modify_ipam_scope_result.ModifyIpamScopeResult, zapros.Response
]:
