"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeFpgaImageAttribute``."""
...
import capo_ec2.types.describe_fpga_image_attribute_request
import capo_ec2.types.describe_fpga_image_attribute_result
...
def handle_response(
    ...
    out: capo_ec2.types.describe_fpga_image_attribute_result.DescribeFpgaImageAttributeResult = capo_ec2.types.describe_fpga_image_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_fpga_image_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_fpga_image_attribute(
