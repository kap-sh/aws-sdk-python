...
import capo_ec2.types.create_transit_gateway_prefix_list_reference_result
...
) -> capo_ec2.types.create_transit_gateway_prefix_list_reference_result.CreateTransitGatewayPrefixListReferenceResult:
    out: capo_ec2.types.create_transit_gateway_prefix_list_reference_result.CreateTransitGatewayPrefixListReferenceResult = capo_ec2.types.create_transit_gateway_prefix_list_reference_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateTransitGatewayPrefixListReference"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_transit_gateway_prefix_list_reference_request.serialize_ec2_query(
        input_, pairs, ""
    )
