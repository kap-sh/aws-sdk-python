"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteApplicationStatusCheck``."""
...
def handle_response(
    ...
    out: capo_ec2.types.delete_application_status_check_result.DeleteApplicationStatusCheckResult = capo_ec2.types.delete_application_status_check_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteApplicationStatusCheck"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_application_status_check_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_application_status_check(
