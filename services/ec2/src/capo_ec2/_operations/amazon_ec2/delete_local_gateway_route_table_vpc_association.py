"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteLocalGatewayRouteTableVpcAssociation``."""
...
import capo_ec2.types.delete_local_gateway_route_table_vpc_association_request
import capo_ec2.types.delete_local_gateway_route_table_vpc_association_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_local_gateway_route_table_vpc_association_result.DeleteLocalGatewayRouteTableVpcAssociationResult = capo_ec2.types.delete_local_gateway_route_table_vpc_association_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteLocalGatewayRouteTableVpcAssociation"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_local_gateway_route_table_vpc_association_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_local_gateway_route_table_vpc_association(
