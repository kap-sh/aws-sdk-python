"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeSpotPriceHistory``."""
...
import capo_ec2.types.describe_spot_price_history_request
import capo_ec2.types.describe_spot_price_history_result
...
) -> capo_ec2.types.describe_spot_price_history_result.DescribeSpotPriceHistoryResult:
    out: capo_ec2.types.describe_spot_price_history_result.DescribeSpotPriceHistoryResult = capo_ec2.types.describe_spot_price_history_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeSpotPriceHistory"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_spot_price_history_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_spot_price_history(
