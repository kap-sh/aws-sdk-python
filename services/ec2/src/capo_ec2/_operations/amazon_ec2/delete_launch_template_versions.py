...
import capo_ec2.types.delete_launch_template_versions_request
...
import capo_ec2.types.delete_launch_template_versions_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_launch_template_versions_result.DeleteLaunchTemplateVersionsResult = capo_ec2.types.delete_launch_template_versions_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteLaunchTemplateVersions"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_launch_template_versions_request.serialize_ec2_query(
        input_, pairs, ""
    )
