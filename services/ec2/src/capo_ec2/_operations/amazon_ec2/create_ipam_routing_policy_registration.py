"""Generated from Smithy shape ``com.amazonaws.ec2#CreateIpamRoutingPolicyRegistration``."""
...
def handle_response(
    ...
    out: capo_ec2.types.create_ipam_routing_policy_registration_result.CreateIpamRoutingPolicyRegistrationResult = capo_ec2.types.create_ipam_routing_policy_registration_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateIpamRoutingPolicyRegistration"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_ipam_routing_policy_registration_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_create_ipam_routing_policy_registration(
