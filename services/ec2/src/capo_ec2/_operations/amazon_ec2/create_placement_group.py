...
import capo_ec2.types.create_placement_group_request
import capo_ec2.types.create_placement_group_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_placement_group_result.CreatePlacementGroupResult = (
        capo_ec2.types.create_placement_group_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreatePlacementGroup"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_placement_group_request.serialize_ec2_query(input_, pairs, "")
