...
import capo_ec2.types.create_subnet_cidr_reservation_request
import capo_ec2.types.create_subnet_cidr_reservation_result
...
) -> capo_ec2.types.create_subnet_cidr_reservation_result.CreateSubnetCidrReservationResult:
    out: capo_ec2.types.create_subnet_cidr_reservation_result.CreateSubnetCidrReservationResult = capo_ec2.types.create_subnet_cidr_reservation_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateSubnetCidrReservation"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_subnet_cidr_reservation_request.serialize_ec2_query(
        input_, pairs, ""
    )
