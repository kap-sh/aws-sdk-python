...
import capo_ec2.types.purchase_capacity_block_extension_request
import capo_ec2.types.purchase_capacity_block_extension_result
...
def handle_response(
    ...
    out: capo_ec2.types.purchase_capacity_block_extension_result.PurchaseCapacityBlockExtensionResult = capo_ec2.types.purchase_capacity_block_extension_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "PurchaseCapacityBlockExtension"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.purchase_capacity_block_extension_request.serialize_ec2_query(
        input_, pairs, ""
    )
