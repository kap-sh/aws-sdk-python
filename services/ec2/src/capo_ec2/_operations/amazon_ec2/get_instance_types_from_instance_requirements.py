...
import capo_ec2.types.get_instance_types_from_instance_requirements_request
import capo_ec2.types.get_instance_types_from_instance_requirements_result
...
) -> capo_ec2.types.get_instance_types_from_instance_requirements_result.GetInstanceTypesFromInstanceRequirementsResult:
    out: capo_ec2.types.get_instance_types_from_instance_requirements_result.GetInstanceTypesFromInstanceRequirementsResult = capo_ec2.types.get_instance_types_from_instance_requirements_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetInstanceTypesFromInstanceRequirements"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_instance_types_from_instance_requirements_request.serialize_ec2_query(
        input_, pairs, ""
    )
