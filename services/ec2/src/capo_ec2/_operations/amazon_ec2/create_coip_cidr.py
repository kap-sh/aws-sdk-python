...
import capo_ec2.types.create_coip_cidr_request
import capo_ec2.types.create_coip_cidr_result
...
def handle_response(
    ...
    out: capo_ec2.types.create_coip_cidr_result.CreateCoipCidrResult = (
        capo_ec2.types.create_coip_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.create_coip_cidr_request.serialize_ec2_query(input_, pairs, "")
...
def create_coip_cidr(
    ...
    capo_ec2.types.create_coip_cidr_result.CreateCoipCidrResult, zapros.Response
]:
