...
import capo_ec2.types.describe_volumes_request
import capo_ec2.types.describe_volumes_result
...
) -> capo_ec2.types.describe_volumes_result.DescribeVolumesResult:
    out: capo_ec2.types.describe_volumes_result.DescribeVolumesResult = (
        capo_ec2.types.describe_volumes_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVolumes"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_volumes_request.serialize_ec2_query(input_, pairs, "")
...
def describe_volumes(
    ...
    capo_ec2.types.describe_volumes_result.DescribeVolumesResult, zapros.Response
]:
