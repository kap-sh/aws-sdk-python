...
import capo_ec2.types.create_vpn_gateway_request
...
) -> capo_ec2.types.create_vpn_gateway_result.CreateVpnGatewayResult:
    out: capo_ec2.types.create_vpn_gateway_result.CreateVpnGatewayResult = (
        capo_ec2.types.create_vpn_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateVpnGateway"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_vpn_gateway_request.serialize_ec2_query(input_, pairs, "")
...
def create_vpn_gateway(
    ...
    capo_ec2.types.create_vpn_gateway_result.CreateVpnGatewayResult, zapros.Response
]:
