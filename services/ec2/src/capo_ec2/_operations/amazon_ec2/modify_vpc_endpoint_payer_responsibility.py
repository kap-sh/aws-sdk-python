"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyVpcEndpointPayerResponsibility``."""
...
def handle_response(
    ...
    out: capo_ec2.types.modify_vpc_endpoint_payer_responsibility_result.ModifyVpcEndpointPayerResponsibilityResult = capo_ec2.types.modify_vpc_endpoint_payer_responsibility_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyVpcEndpointPayerResponsibility"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_vpc_endpoint_payer_responsibility_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_vpc_endpoint_payer_responsibility(
