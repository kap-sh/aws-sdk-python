...
import capo_ec2.types.get_vpc_resources_blocking_encryption_enforcement_request
import capo_ec2.types.get_vpc_resources_blocking_encryption_enforcement_result
...
) -> capo_ec2.types.get_vpc_resources_blocking_encryption_enforcement_result.GetVpcResourcesBlockingEncryptionEnforcementResult:
    out: capo_ec2.types.get_vpc_resources_blocking_encryption_enforcement_result.GetVpcResourcesBlockingEncryptionEnforcementResult = capo_ec2.types.get_vpc_resources_blocking_encryption_enforcement_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetVpcResourcesBlockingEncryptionEnforcement"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.get_vpc_resources_blocking_encryption_enforcement_request.serialize_ec2_query(
        input_, pairs, ""
    )
