...
import capo_ec2.types.move_byoip_cidr_to_ipam_request
import capo_ec2.types.move_byoip_cidr_to_ipam_result
...
def handle_response(
    ...
    out: capo_ec2.types.move_byoip_cidr_to_ipam_result.MoveByoipCidrToIpamResult = (
        capo_ec2.types.move_byoip_cidr_to_ipam_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "MoveByoipCidrToIpam"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.move_byoip_cidr_to_ipam_request.serialize_ec2_query(
        input_, pairs, ""
    )
