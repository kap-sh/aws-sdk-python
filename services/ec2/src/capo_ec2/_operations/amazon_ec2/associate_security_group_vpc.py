...
import capo_ec2.types.associate_security_group_vpc_request
import capo_ec2.types.associate_security_group_vpc_result
...
def handle_response(
    ...
    out: capo_ec2.types.associate_security_group_vpc_result.AssociateSecurityGroupVpcResult = capo_ec2.types.associate_security_group_vpc_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AssociateSecurityGroupVpc"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.associate_security_group_vpc_request.serialize_ec2_query(
        input_, pairs, ""
    )
