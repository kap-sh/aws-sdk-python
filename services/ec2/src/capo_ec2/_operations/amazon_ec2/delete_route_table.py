"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteRouteTable``."""
...
import capo_ec2.types.delete_route_table_request
...
def build_request(
    ...
    pairs.append(("Action", "DeleteRouteTable"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_route_table_request.serialize_ec2_query(input_, pairs, "")
...
async def async_delete_route_table(
