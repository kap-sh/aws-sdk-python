"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeIpamByoasn``."""
...
import capo_ec2.types.describe_ipam_byoasn_request
...
) -> capo_ec2.types.describe_ipam_byoasn_result.DescribeIpamByoasnResult:
    out: capo_ec2.types.describe_ipam_byoasn_result.DescribeIpamByoasnResult = (
        capo_ec2.types.describe_ipam_byoasn_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeIpamByoasn"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_ipam_byoasn_request.serialize_ec2_query(input_, pairs, "")
...
def describe_ipam_byoasn(
    ...
    capo_ec2.types.describe_ipam_byoasn_result.DescribeIpamByoasnResult, zapros.Response
]:
...
async def async_describe_ipam_byoasn(
