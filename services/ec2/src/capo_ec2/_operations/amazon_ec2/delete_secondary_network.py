...
import capo_ec2.types.delete_secondary_network_request
import capo_ec2.types.delete_secondary_network_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_secondary_network_result.DeleteSecondaryNetworkResult = (
        capo_ec2.types.delete_secondary_network_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteSecondaryNetwork"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_secondary_network_request.serialize_ec2_query(
        input_, pairs, ""
    )
