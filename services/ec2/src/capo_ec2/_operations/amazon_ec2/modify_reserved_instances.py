"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyReservedInstances``."""
...
import capo_ec2.types.modify_reserved_instances_request
import capo_ec2.types.modify_reserved_instances_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_reserved_instances_result.ModifyReservedInstancesResult = capo_ec2.types.modify_reserved_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyReservedInstances"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_reserved_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_reserved_instances(
