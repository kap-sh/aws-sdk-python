...
import capo_ec2.types.modify_ipam_prefix_list_resolver_target_request
import capo_ec2.types.modify_ipam_prefix_list_resolver_target_result
...
) -> capo_ec2.types.modify_ipam_prefix_list_resolver_target_result.ModifyIpamPrefixListResolverTargetResult:
    out: capo_ec2.types.modify_ipam_prefix_list_resolver_target_result.ModifyIpamPrefixListResolverTargetResult = capo_ec2.types.modify_ipam_prefix_list_resolver_target_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyIpamPrefixListResolverTarget"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_ipam_prefix_list_resolver_target_request.serialize_ec2_query(
        input_, pairs, ""
    )
