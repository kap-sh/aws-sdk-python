...
import capo_ec2.types.copy_volumes_request
...
def handle_response(
    ...
    out: capo_ec2.types.copy_volumes_result.CopyVolumesResult = (
        capo_ec2.types.copy_volumes_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CopyVolumes"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.copy_volumes_request.serialize_ec2_query(input_, pairs, "")
...
def copy_volumes(
    ...
    input_: capo_ec2.types.copy_volumes_request.CopyVolumesRequest,
) -> tuple[capo_ec2.types.copy_volumes_result.CopyVolumesResult, zapros.Response]:
