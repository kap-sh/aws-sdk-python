...
import capo_ec2.types.modify_instance_network_performance_request
import capo_ec2.types.modify_instance_network_performance_result
...
def handle_response(
    ...
    out: capo_ec2.types.modify_instance_network_performance_result.ModifyInstanceNetworkPerformanceResult = capo_ec2.types.modify_instance_network_performance_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.modify_instance_network_performance_request.serialize_ec2_query(
        input_, pairs, ""
    )
