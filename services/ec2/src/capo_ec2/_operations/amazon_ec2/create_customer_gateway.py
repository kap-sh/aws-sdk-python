...
import capo_ec2.types.create_customer_gateway_request
import capo_ec2.types.create_customer_gateway_result
...
) -> capo_ec2.types.create_customer_gateway_result.CreateCustomerGatewayResult:
    out: capo_ec2.types.create_customer_gateway_result.CreateCustomerGatewayResult = (
        capo_ec2.types.create_customer_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateCustomerGateway"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_customer_gateway_request.serialize_ec2_query(
        input_, pairs, ""
    )
