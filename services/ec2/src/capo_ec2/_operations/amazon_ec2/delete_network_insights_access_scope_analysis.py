"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteNetworkInsightsAccessScopeAnalysis``."""
...
import capo_ec2.types.delete_network_insights_access_scope_analysis_request
import capo_ec2.types.delete_network_insights_access_scope_analysis_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_network_insights_access_scope_analysis_result.DeleteNetworkInsightsAccessScopeAnalysisResult = capo_ec2.types.delete_network_insights_access_scope_analysis_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteNetworkInsightsAccessScopeAnalysis"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_network_insights_access_scope_analysis_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_network_insights_access_scope_analysis(
