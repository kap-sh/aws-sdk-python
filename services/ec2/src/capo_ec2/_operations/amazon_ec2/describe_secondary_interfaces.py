...
import capo_ec2.types.describe_secondary_interfaces_request
import capo_ec2.types.describe_secondary_interfaces_result
import capo_ec2.types.filter_list
import capo_ec2.types.secondary_interface_id_list
...
) -> capo_ec2.types.describe_secondary_interfaces_result.DescribeSecondaryInterfacesResult:
    out: capo_ec2.types.describe_secondary_interfaces_result.DescribeSecondaryInterfacesResult = capo_ec2.types.describe_secondary_interfaces_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeSecondaryInterfaces"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_secondary_interfaces_request.serialize_ec2_query(
        input_, pairs, ""
    )
