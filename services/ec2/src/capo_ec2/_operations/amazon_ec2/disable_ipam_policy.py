...
import capo_ec2.types.disable_ipam_policy_request
import capo_ec2.types.disable_ipam_policy_result
...
def handle_response(
    ...
    out: capo_ec2.types.disable_ipam_policy_result.DisableIpamPolicyResult = (
        capo_ec2.types.disable_ipam_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.disable_ipam_policy_request.serialize_ec2_query(input_, pairs, "")
...
def disable_ipam_policy(
    ...
    capo_ec2.types.disable_ipam_policy_result.DisableIpamPolicyResult, zapros.Response
]:
