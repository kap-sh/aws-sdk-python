...
) -> capo_ec2.types.associate_vpc_cidr_block_result.AssociateVpcCidrBlockResult:
    out: capo_ec2.types.associate_vpc_cidr_block_result.AssociateVpcCidrBlockResult = (
        capo_ec2.types.associate_vpc_cidr_block_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AssociateVpcCidrBlock"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.associate_vpc_cidr_block_request.serialize_ec2_query(
        input_, pairs, ""
    )
