...
) -> capo_ec2.types.advertise_byoip_cidr_result.AdvertiseByoipCidrResult:
    out: capo_ec2.types.advertise_byoip_cidr_result.AdvertiseByoipCidrResult = (
        capo_ec2.types.advertise_byoip_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AdvertiseByoipCidr"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.advertise_byoip_cidr_request.serialize_ec2_query(input_, pairs, "")
...
def advertise_byoip_cidr(
    ...
    capo_ec2.types.advertise_byoip_cidr_result.AdvertiseByoipCidrResult, zapros.Response
]:
