...
import capo_ec2.types.describe_instance_attribute_request
...
def handle_response(
    ...
    out: capo_ec2.types.instance_attribute.InstanceAttribute = (
        capo_ec2.types.instance_attribute.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeInstanceAttribute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_instance_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
def describe_instance_attribute(
    ...
    input_: capo_ec2.types.describe_instance_attribute_request.DescribeInstanceAttributeRequest,
) -> tuple[capo_ec2.types.instance_attribute.InstanceAttribute, zapros.Response]:
