...
import capo_ec2.types.describe_instance_types_request
import capo_ec2.types.describe_instance_types_result
...
) -> capo_ec2.types.describe_instance_types_result.DescribeInstanceTypesResult:
    out: capo_ec2.types.describe_instance_types_result.DescribeInstanceTypesResult = (
        capo_ec2.types.describe_instance_types_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_instance_types_request.serialize_ec2_query(
        input_, pairs, ""
    )
