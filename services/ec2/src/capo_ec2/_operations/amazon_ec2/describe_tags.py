...
import capo_ec2.types.describe_tags_request
import capo_ec2.types.describe_tags_result
...
) -> capo_ec2.types.describe_tags_result.DescribeTagsResult:
    out: capo_ec2.types.describe_tags_result.DescribeTagsResult = (
        capo_ec2.types.describe_tags_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_tags_request.serialize_ec2_query(input_, pairs, "")
...
def describe_tags(
    ...
    input_: capo_ec2.types.describe_tags_request.DescribeTagsRequest,
) -> tuple[capo_ec2.types.describe_tags_result.DescribeTagsResult, zapros.Response]:
