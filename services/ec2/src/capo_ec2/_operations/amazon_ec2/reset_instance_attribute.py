...
import capo_ec2.types.reset_instance_attribute_request
...
def build_request(
    ...
    pairs.append(("Action", "ResetInstanceAttribute"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.reset_instance_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
