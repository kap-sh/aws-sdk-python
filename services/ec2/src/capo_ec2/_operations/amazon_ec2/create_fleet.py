...
import capo_ec2.types.create_fleet_request
import capo_ec2.types.create_fleet_result
...
) -> capo_ec2.types.create_fleet_result.CreateFleetResult:
    out: capo_ec2.types.create_fleet_result.CreateFleetResult = (
        capo_ec2.types.create_fleet_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateFleet"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.create_fleet_request.serialize_ec2_query(input_, pairs, "")
...
def create_fleet(
    ...
    input_: capo_ec2.types.create_fleet_request.CreateFleetRequest,
) -> tuple[capo_ec2.types.create_fleet_result.CreateFleetResult, zapros.Response]:
