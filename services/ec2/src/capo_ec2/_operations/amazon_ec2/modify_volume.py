...
import capo_ec2.types.modify_volume_request
import capo_ec2.types.modify_volume_result
...
) -> capo_ec2.types.modify_volume_result.ModifyVolumeResult:
    out: capo_ec2.types.modify_volume_result.ModifyVolumeResult = (
        capo_ec2.types.modify_volume_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyVolume"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_volume_request.serialize_ec2_query(input_, pairs, "")
...
def modify_volume(
    ...
    input_: capo_ec2.types.modify_volume_request.ModifyVolumeRequest,
) -> tuple[capo_ec2.types.modify_volume_result.ModifyVolumeResult, zapros.Response]:
