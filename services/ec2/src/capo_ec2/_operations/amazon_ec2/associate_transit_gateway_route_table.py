"""Generated from Smithy shape ``com.amazonaws.ec2#AssociateTransitGatewayRouteTable``."""
...
import capo_ec2.types.associate_transit_gateway_route_table_request
import capo_ec2.types.associate_transit_gateway_route_table_result
...
def handle_response(
    ...
    out: capo_ec2.types.associate_transit_gateway_route_table_result.AssociateTransitGatewayRouteTableResult = capo_ec2.types.associate_transit_gateway_route_table_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "AssociateTransitGatewayRouteTable"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.associate_transit_gateway_route_table_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_associate_transit_gateway_route_table(
