"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeVpnConnections``."""
...
import capo_ec2.types.describe_vpn_connections_request
import capo_ec2.types.describe_vpn_connections_result
...
) -> capo_ec2.types.describe_vpn_connections_result.DescribeVpnConnectionsResult:
    out: capo_ec2.types.describe_vpn_connections_result.DescribeVpnConnectionsResult = (
        capo_ec2.types.describe_vpn_connections_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeVpnConnections"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_vpn_connections_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_vpn_connections(
