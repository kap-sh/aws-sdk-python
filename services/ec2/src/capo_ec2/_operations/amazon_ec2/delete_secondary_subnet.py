...
import capo_ec2.types.delete_secondary_subnet_request
import capo_ec2.types.delete_secondary_subnet_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_secondary_subnet_result.DeleteSecondarySubnetResult = (
        capo_ec2.types.delete_secondary_subnet_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteSecondarySubnet"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_secondary_subnet_request.serialize_ec2_query(
        input_, pairs, ""
    )
