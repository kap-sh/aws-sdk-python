...
import capo_ec2.types.delete_traffic_mirror_filter_request
import capo_ec2.types.delete_traffic_mirror_filter_result
...
def handle_response(
    ...
    out: capo_ec2.types.delete_traffic_mirror_filter_result.DeleteTrafficMirrorFilterResult = capo_ec2.types.delete_traffic_mirror_filter_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteTrafficMirrorFilter"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.delete_traffic_mirror_filter_request.serialize_ec2_query(
        input_, pairs, ""
    )
