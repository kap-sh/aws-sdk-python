"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeImportSnapshotTasks``."""
...
import capo_ec2.types.describe_import_snapshot_tasks_request
import capo_ec2.types.describe_import_snapshot_tasks_result
...
) -> capo_ec2.types.describe_import_snapshot_tasks_result.DescribeImportSnapshotTasksResult:
    out: capo_ec2.types.describe_import_snapshot_tasks_result.DescribeImportSnapshotTasksResult = capo_ec2.types.describe_import_snapshot_tasks_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeImportSnapshotTasks"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_import_snapshot_tasks_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_import_snapshot_tasks(
