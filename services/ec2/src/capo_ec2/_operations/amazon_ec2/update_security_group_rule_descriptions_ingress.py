...
import capo_ec2.types.update_security_group_rule_descriptions_ingress_request
import capo_ec2.types.update_security_group_rule_descriptions_ingress_result
...
) -> capo_ec2.types.update_security_group_rule_descriptions_ingress_result.UpdateSecurityGroupRuleDescriptionsIngressResult:
    out: capo_ec2.types.update_security_group_rule_descriptions_ingress_result.UpdateSecurityGroupRuleDescriptionsIngressResult = capo_ec2.types.update_security_group_rule_descriptions_ingress_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "UpdateSecurityGroupRuleDescriptionsIngress"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.update_security_group_rule_descriptions_ingress_request.serialize_ec2_query(
        input_, pairs, ""
    )
