...
import capo_ec2.types.modify_ipam_policy_allocation_rules_request
import capo_ec2.types.modify_ipam_policy_allocation_rules_result
...
) -> capo_ec2.types.modify_ipam_policy_allocation_rules_result.ModifyIpamPolicyAllocationRulesResult:
    out: capo_ec2.types.modify_ipam_policy_allocation_rules_result.ModifyIpamPolicyAllocationRulesResult = capo_ec2.types.modify_ipam_policy_allocation_rules_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyIpamPolicyAllocationRules"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_ipam_policy_allocation_rules_request.serialize_ec2_query(
        input_, pairs, ""
    )
