"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeSpotFleetRequests``."""
...
import capo_ec2.types.describe_spot_fleet_requests_request
import capo_ec2.types.describe_spot_fleet_requests_response
...
) -> capo_ec2.types.describe_spot_fleet_requests_response.DescribeSpotFleetRequestsResponse:
    out: capo_ec2.types.describe_spot_fleet_requests_response.DescribeSpotFleetRequestsResponse = capo_ec2.types.describe_spot_fleet_requests_response.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeSpotFleetRequests"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.describe_spot_fleet_requests_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_spot_fleet_requests(
