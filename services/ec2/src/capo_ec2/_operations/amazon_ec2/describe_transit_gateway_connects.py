...
import capo_ec2.types.describe_transit_gateway_connects_request
import capo_ec2.types.describe_transit_gateway_connects_result
...
) -> capo_ec2.types.describe_transit_gateway_connects_result.DescribeTransitGatewayConnectsResult:
    out: capo_ec2.types.describe_transit_gateway_connects_result.DescribeTransitGatewayConnectsResult = capo_ec2.types.describe_transit_gateway_connects_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.describe_transit_gateway_connects_request.serialize_ec2_query(
        input_, pairs, ""
    )
