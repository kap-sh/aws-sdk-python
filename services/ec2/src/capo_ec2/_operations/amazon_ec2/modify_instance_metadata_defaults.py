...
import capo_ec2.types.modify_instance_metadata_defaults_request
import capo_ec2.types.modify_instance_metadata_defaults_result
...
) -> capo_ec2.types.modify_instance_metadata_defaults_result.ModifyInstanceMetadataDefaultsResult:
    out: capo_ec2.types.modify_instance_metadata_defaults_result.ModifyInstanceMetadataDefaultsResult = capo_ec2.types.modify_instance_metadata_defaults_result.deserialize_ec2_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyInstanceMetadataDefaults"))
    pairs.append(("Version", "2016-11-15"))
    capo_ec2.types.modify_instance_metadata_defaults_request.serialize_ec2_query(
        input_, pairs, ""
    )
