...
import capo_ec2.types.reject_transit_gateway_multicast_domain_associations_request
import capo_ec2.types.reject_transit_gateway_multicast_domain_associations_result
...
) -> capo_ec2.types.reject_transit_gateway_multicast_domain_associations_result.RejectTransitGatewayMulticastDomainAssociationsResult:
    out: capo_ec2.types.reject_transit_gateway_multicast_domain_associations_result.RejectTransitGatewayMulticastDomainAssociationsResult = capo_ec2.types.reject_transit_gateway_multicast_domain_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    capo_ec2.types.reject_transit_gateway_multicast_domain_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
