"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyApplicationStatusCheckRequest``."""
...
class ModifyApplicationStatusCheckRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ModifyApplicationStatusCheckRequest,
...
def deserialize_ec2_query(el: Element) -> ModifyApplicationStatusCheckRequest:
    out: ModifyApplicationStatusCheckRequest = {}  # type: ignore[typeddict-item]
