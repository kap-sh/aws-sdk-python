"""Generated from Smithy shape ``com.amazonaws.ec2#IpamResourceTag``."""
...
class IpamResourceTag(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: IpamResourceTag, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> IpamResourceTag:
    out: IpamResourceTag = {}  # type: ignore[typeddict-item]
