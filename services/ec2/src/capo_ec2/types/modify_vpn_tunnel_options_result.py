...
class ModifyVpnTunnelOptionsResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ModifyVpnTunnelOptionsResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> ModifyVpnTunnelOptionsResult:
    out: ModifyVpnTunnelOptionsResult = {}  # type: ignore[typeddict-item]
