"""Generated from Smithy shape ``com.amazonaws.ec2#IdFormatList``."""
...
IdFormatList: TypeAlias = list["capo_ec2.types.id_format.IdFormat"]


# --- ec2Query ser/de ---
def serialize_ec2_query(
    value: IdFormatList, pairs: list[tuple[str, str]], prefix: str
) -> None:
