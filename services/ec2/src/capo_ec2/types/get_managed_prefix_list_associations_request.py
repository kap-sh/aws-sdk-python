...
class GetManagedPrefixListAssociationsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetManagedPrefixListAssociationsRequest,
...
def deserialize_ec2_query(el: Element) -> GetManagedPrefixListAssociationsRequest:
    out: GetManagedPrefixListAssociationsRequest = {}  # type: ignore[typeddict-item]
