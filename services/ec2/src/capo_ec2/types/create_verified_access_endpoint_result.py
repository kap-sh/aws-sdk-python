"""Generated from Smithy shape ``com.amazonaws.ec2#CreateVerifiedAccessEndpointResult``."""
...
class CreateVerifiedAccessEndpointResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CreateVerifiedAccessEndpointResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
