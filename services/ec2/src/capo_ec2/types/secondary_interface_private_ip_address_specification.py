"""Generated from Smithy shape ``com.amazonaws.ec2#SecondaryInterfacePrivateIpAddressSpecification``."""
...
class SecondaryInterfacePrivateIpAddressSpecification(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: SecondaryInterfacePrivateIpAddressSpecification,
...
def deserialize_ec2_query(
    ...
    out: SecondaryInterfacePrivateIpAddressSpecification = {}  # type: ignore[typeddict-item]
