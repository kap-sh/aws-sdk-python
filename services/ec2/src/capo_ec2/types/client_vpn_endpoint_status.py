...
if TYPE_CHECKING:
    import capo_ec2.types.client_vpn_endpoint_status_code
    import capo_ec2.types.string


class ClientVpnEndpointStatus(TypedDict, closed=True):
    code: NotRequired[
        "capo_ec2.types.client_vpn_endpoint_status_code.ClientVpnEndpointStatusCode"
    ]
...
def serialize_ec2_query(
    ...
    if "code" in value:
        ...
        capo_ec2.types.client_vpn_endpoint_status_code.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> ClientVpnEndpointStatus:
    ...
    if child_code is not None:
        ...
        out["code"] = (
            capo_ec2.types.client_vpn_endpoint_status_code.deserialize_ec2_query(
                child_code
            )
        )
