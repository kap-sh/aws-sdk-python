...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.get_vpc_resources_blocking_encryption_enforcement_max_results
    import capo_ec2.types.string
    import capo_ec2.types.vpc_id


class GetVpcResourcesBlockingEncryptionEnforcementRequest(TypedDict, closed=True):
