"""Generated from Smithy shape ``com.amazonaws.ec2#GetIpamRouteOriginAuthorizationsRequest``."""
...
class GetIpamRouteOriginAuthorizationsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetIpamRouteOriginAuthorizationsRequest,
...
def deserialize_ec2_query(el: Element) -> GetIpamRouteOriginAuthorizationsRequest:
    out: GetIpamRouteOriginAuthorizationsRequest = {}  # type: ignore[typeddict-item]
