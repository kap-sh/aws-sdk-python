...
class TransitGatewayPrefixListReference(TypedDict, closed=True):
    ...
    prefix_list_owner_id: NotRequired["capo_ec2.types.string.String"]
    """<p>The ID of the prefix list owner.</p>"""
    state: NotRequired[
        "capo_ec2.types.transit_gateway_prefix_list_reference_state.TransitGatewayPrefixListReferenceState"
    ]
    ...
    transit_gateway_attachment: NotRequired[
        "capo_ec2.types.transit_gateway_prefix_list_attachment.TransitGatewayPrefixListAttachment"
    ]
...
def deserialize_ec2_query(el: Element) -> TransitGatewayPrefixListReference:
    ...
    if child_state is not None:
        ...
        out["state"] = (
            capo_ec2.types.transit_gateway_prefix_list_reference_state.deserialize_ec2_query(
                child_state
            )
        )
    ...
    if child_transit_gateway_attachment is not None:
        ...
        out["transit_gateway_attachment"] = (
            capo_ec2.types.transit_gateway_prefix_list_attachment.deserialize_ec2_query(
