...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.prefix_list_max_results
    import capo_ec2.types.value_string_list


class DescribeManagedPrefixListsRequest(TypedDict, closed=True):
    ...
    prefix_list_ids: NotRequired["capo_ec2.types.value_string_list.ValueStringList"]
    """<p>One or more prefix list IDs.</p>"""


# --- ec2Query ser/de ---
def serialize_ec2_query(
    value: DescribeManagedPrefixListsRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DescribeManagedPrefixListsRequest:
    out: DescribeManagedPrefixListsRequest = {}  # type: ignore[typeddict-item]
    ...
    child_prefix_list_ids = el.find("PrefixListId")
