"""Generated from Smithy shape ``com.amazonaws.ec2#IpamPoolSourceResourceRequest``."""
...
class IpamPoolSourceResourceRequest(TypedDict, closed=True):
    resource_id: NotRequired["capo_ec2.types.string.String"]
    """<p>The source resource ID.</p>"""
    resource_type: NotRequired[
        "capo_ec2.types.ipam_pool_source_resource_type.IpamPoolSourceResourceType"
    ]
...
def serialize_ec2_query(
    value: IpamPoolSourceResourceRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
    ...
    if "resource_type" in value:
        ...
        capo_ec2.types.ipam_pool_source_resource_type.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> IpamPoolSourceResourceRequest:
    out: IpamPoolSourceResourceRequest = {}  # type: ignore[typeddict-item]
    ...
    if child_resource_type is not None:
        ...
        out["resource_type"] = (
            capo_ec2.types.ipam_pool_source_resource_type.deserialize_ec2_query(
                child_resource_type
            )
        )
