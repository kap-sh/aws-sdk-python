...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.restore_snapshot_tier_request_temporary_restore_days
    import capo_ec2.types.snapshot_id


class RestoreSnapshotTierRequest(TypedDict, closed=True):
    ...
    permanent_restore: NotRequired["capo_ec2.types.boolean.Boolean"]
