...
InstanceEventWindowTimeRangeRequestSet: TypeAlias = list[
    "capo_ec2.types.instance_event_window_time_range_request.InstanceEventWindowTimeRangeRequest"
]
...
def serialize_ec2_query(
    ...
    for n, item in enumerate(value, 1):
        ...
        capo_ec2.types.instance_event_window_time_range_request.serialize_ec2_query(
