...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.service_link_max_results
    import capo_ec2.types.service_link_virtual_interface_id_set
    import capo_ec2.types.string


class DescribeServiceLinkVirtualInterfacesRequest(TypedDict, closed=True):
    ...
    max_results: NotRequired[
        "capo_ec2.types.service_link_max_results.ServiceLinkMaxResults"
    ]
...
def serialize_ec2_query(
    ...
    if "service_link_virtual_interface_ids" in value:
        ...
        capo_ec2.types.service_link_virtual_interface_id_set.serialize_ec2_query(
            ...
            pairs,
            f"{key_prefix}ServiceLinkVirtualInterfaceIds",
        )
    if "filters" in value:
        import capo_ec2.types.filter_list
