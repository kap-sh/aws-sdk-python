...
VerifiedAccessTrustProviderCondensedList: TypeAlias = list[
    "capo_ec2.types.verified_access_trust_provider_condensed.VerifiedAccessTrustProviderCondensed"
]
...
def serialize_ec2_query(
    ...
    for n, item in enumerate(value, 1):
        ...
        capo_ec2.types.verified_access_trust_provider_condensed.serialize_ec2_query(
