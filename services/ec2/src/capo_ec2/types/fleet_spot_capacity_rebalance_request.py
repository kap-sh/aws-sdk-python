...
class FleetSpotCapacityRebalanceRequest(TypedDict, closed=True):
    replacement_strategy: NotRequired[
        "capo_ec2.types.fleet_replacement_strategy.FleetReplacementStrategy"
    ]
...
def serialize_ec2_query(
    ...
    if "replacement_strategy" in value:
        ...
        capo_ec2.types.fleet_replacement_strategy.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> FleetSpotCapacityRebalanceRequest:
    ...
    if child_replacement_strategy is not None:
        ...
        out["replacement_strategy"] = (
            capo_ec2.types.fleet_replacement_strategy.deserialize_ec2_query(
