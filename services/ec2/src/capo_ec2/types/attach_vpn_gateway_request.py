"""Generated from Smithy shape ``com.amazonaws.ec2#AttachVpnGatewayRequest``."""
...
class AttachVpnGatewayRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AttachVpnGatewayRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> AttachVpnGatewayRequest:
    out: AttachVpnGatewayRequest = {}  # type: ignore[typeddict-item]
