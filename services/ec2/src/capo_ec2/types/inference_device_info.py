...
if TYPE_CHECKING:
    import capo_ec2.types.inference_device_count
    import capo_ec2.types.inference_device_manufacturer_name
    import capo_ec2.types.inference_device_memory_info
    import capo_ec2.types.inference_device_name


class InferenceDeviceInfo(TypedDict, closed=True):
    count: NotRequired["capo_ec2.types.inference_device_count.InferenceDeviceCount"]
    """<p>The number of Inference accelerators for the instance type.</p>"""
    name: NotRequired["capo_ec2.types.inference_device_name.InferenceDeviceName"]
    """<p>The name of the Inference accelerator.</p>"""
    manufacturer: NotRequired[
        "capo_ec2.types.inference_device_manufacturer_name.InferenceDeviceManufacturerName"
    ]
    """<p>The manufacturer of the Inference accelerator.</p>"""
    memory_info: NotRequired[
        "capo_ec2.types.inference_device_memory_info.InferenceDeviceMemoryInfo"
    ]
...
def serialize_ec2_query(
    ...
    if "memory_info" in value:
        ...
        capo_ec2.types.inference_device_memory_info.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> InferenceDeviceInfo:
    ...
    if child_memory_info is not None:
        ...
        out["memory_info"] = (
            capo_ec2.types.inference_device_memory_info.deserialize_ec2_query(
                child_memory_info
            )
        )
    return out
