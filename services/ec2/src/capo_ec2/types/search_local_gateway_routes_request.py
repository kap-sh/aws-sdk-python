...
class SearchLocalGatewayRoutesRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: SearchLocalGatewayRoutesRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> SearchLocalGatewayRoutesRequest:
    out: SearchLocalGatewayRoutesRequest = {}  # type: ignore[typeddict-item]
