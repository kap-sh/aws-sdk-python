...
class IpamScope(TypedDict, closed=True):
    ...
    pool_count: NotRequired["capo_ec2.types.integer.Integer"]
    """<p>The number of pools in the scope.</p>"""
    state: NotRequired["capo_ec2.types.ipam_scope_state.IpamScopeState"]
    ...
    external_authority_configuration: NotRequired[
        "capo_ec2.types.ipam_scope_external_authority_configuration.IpamScopeExternalAuthorityConfiguration"
    ]
...
def deserialize_ec2_query(el: Element) -> IpamScope:
    ...
    if child_external_authority_configuration is not None:
        ...
        out["external_authority_configuration"] = (
            capo_ec2.types.ipam_scope_external_authority_configuration.deserialize_ec2_query(
