...
if TYPE_CHECKING:
    import capo_ec2.types.snapshot_recycle_bin_info_list
    import capo_ec2.types.string


class ListSnapshotsInRecycleBinResult(TypedDict, closed=True):
    snapshots: NotRequired[
        "capo_ec2.types.snapshot_recycle_bin_info_list.SnapshotRecycleBinInfoList"
    ]
...
def serialize_ec2_query(
    ...
    if "snapshots" in value:
        ...
        capo_ec2.types.snapshot_recycle_bin_info_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> ListSnapshotsInRecycleBinResult:
    ...
    if el.find("snapshotSet") is not None:
        ...
        out["snapshots"] = (
            capo_ec2.types.snapshot_recycle_bin_info_list.deserialize_ec2_query(
                el, "snapshotSet"
            )
        )
