...
class TransitGatewayAssociation(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: TransitGatewayAssociation, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> TransitGatewayAssociation:
    out: TransitGatewayAssociation = {}  # type: ignore[typeddict-item]
