"""Generated from Smithy shape ``com.amazonaws.ec2#SecondaryNetworkIpv4CidrBlockAssociation``."""
...
if TYPE_CHECKING:
    import capo_ec2.types.secondary_network_cidr_association_id
    import capo_ec2.types.secondary_network_cidr_block_association_state
    import capo_ec2.types.string


class SecondaryNetworkIpv4CidrBlockAssociation(TypedDict, closed=True):
    association_id: NotRequired[
        "capo_ec2.types.secondary_network_cidr_association_id.SecondaryNetworkCidrAssociationId"
    ]
    """<p>The association ID for the IPv4 CIDR block.</p>"""
    cidr_block: NotRequired["capo_ec2.types.string.String"]
    """<p>The IPv4 CIDR block.</p>"""
    state: NotRequired[
        "capo_ec2.types.secondary_network_cidr_block_association_state.SecondaryNetworkCidrBlockAssociationState"
    ]
...
def serialize_ec2_query(
    ...
    if "state" in value:
        ...
        capo_ec2.types.secondary_network_cidr_block_association_state.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> SecondaryNetworkIpv4CidrBlockAssociation:
    ...
    if child_state is not None:
        ...
        out["state"] = (
            capo_ec2.types.secondary_network_cidr_block_association_state.deserialize_ec2_query(
                child_state
            )
        )
