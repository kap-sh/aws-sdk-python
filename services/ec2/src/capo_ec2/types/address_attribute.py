...
class AddressAttribute(TypedDict, closed=True):
    public_ip: NotRequired["capo_ec2.types.public_ip_address.PublicIpAddress"]
    """<p>The public IP address.</p>"""
    allocation_id: NotRequired["capo_ec2.types.allocation_id.AllocationId"]
    """<p>[EC2-VPC] The allocation ID.</p>"""
    ptr_record: NotRequired["capo_ec2.types.string.String"]
    """<p>The pointer (PTR) record for the IP address.</p>"""
    ptr_record_update: NotRequired["capo_ec2.types.ptr_update_status.PtrUpdateStatus"]
...
def deserialize_ec2_query(el: Element) -> AddressAttribute:
    ...
    if child_ptr_record_update is not None:
        ...
        out["ptr_record_update"] = (
            capo_ec2.types.ptr_update_status.deserialize_ec2_query(
