"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteNetworkAclRequest``."""
...
class DeleteNetworkAclRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteNetworkAclRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DeleteNetworkAclRequest:
    out: DeleteNetworkAclRequest = {}  # type: ignore[typeddict-item]
