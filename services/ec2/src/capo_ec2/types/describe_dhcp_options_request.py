...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.describe_dhcp_options_max_results
...
class DescribeDhcpOptionsRequest(TypedDict, closed=True):
    dhcp_options_ids: NotRequired[
        "capo_ec2.types.dhcp_options_id_string_list.DhcpOptionsIdStringList"
    ]
    """<p>The IDs of DHCP option sets.</p>"""
    next_token: NotRequired["capo_ec2.types.string.String"]
    """<p>The token returned from a previous paginated request. Pagination continues from the end of the items returned by the previous request.</p>"""
    max_results: NotRequired[
        "capo_ec2.types.describe_dhcp_options_max_results.DescribeDhcpOptionsMaxResults"
    ]
...
def serialize_ec2_query(
    ...
    if "dhcp_options_ids" in value:
        ...
        capo_ec2.types.dhcp_options_id_string_list.serialize_ec2_query(
            value["dhcp_options_ids"], pairs, f"{key_prefix}DhcpOptionsIds"
        )
