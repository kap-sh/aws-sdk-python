...
def serialize_ec2_query(
    value: SendDiagnosticInterruptRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> SendDiagnosticInterruptRequest:
    out: SendDiagnosticInterruptRequest = {}  # type: ignore[typeddict-item]
