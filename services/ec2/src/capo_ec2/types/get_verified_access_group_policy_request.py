...
class GetVerifiedAccessGroupPolicyRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetVerifiedAccessGroupPolicyRequest,
...
def deserialize_ec2_query(el: Element) -> GetVerifiedAccessGroupPolicyRequest:
    out: GetVerifiedAccessGroupPolicyRequest = {}  # type: ignore[typeddict-item]
