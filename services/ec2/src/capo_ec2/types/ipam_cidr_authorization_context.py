...
class IpamCidrAuthorizationContext(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: IpamCidrAuthorizationContext, pairs: list[tuple[str, str]], prefix: str
) -> None:
    if "message" in value:
...
def deserialize_ec2_query(el: Element) -> IpamCidrAuthorizationContext:
    out: IpamCidrAuthorizationContext = {}  # type: ignore[typeddict-item]
