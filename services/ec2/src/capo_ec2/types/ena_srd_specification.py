...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.ena_srd_udp_specification


class EnaSrdSpecification(TypedDict, closed=True):
    ena_srd_enabled: NotRequired["capo_ec2.types.boolean.Boolean"]
    """<p>Indicates whether ENA Express is enabled for the network interface.</p>"""
    ena_srd_udp_specification: NotRequired[
        "capo_ec2.types.ena_srd_udp_specification.EnaSrdUdpSpecification"
    ]
...
def serialize_ec2_query(
    ...
    if "ena_srd_udp_specification" in value:
        ...
        capo_ec2.types.ena_srd_udp_specification.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> EnaSrdSpecification:
    ...
    if child_ena_srd_udp_specification is not None:
        ...
        out["ena_srd_udp_specification"] = (
            capo_ec2.types.ena_srd_udp_specification.deserialize_ec2_query(
