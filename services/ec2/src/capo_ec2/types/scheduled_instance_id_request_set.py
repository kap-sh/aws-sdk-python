...
if TYPE_CHECKING:
    import capo_ec2.types.scheduled_instance_id
...
def deserialize_ec2_query(el: Element) -> ScheduledInstanceIdRequestSet:
    out: ScheduledInstanceIdRequestSet = []
    for child in el.findall("ScheduledInstanceId"):
