"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeIpamInternetRegistryAssociationsRequest``."""
...
class DescribeIpamInternetRegistryAssociationsRequest(TypedDict, closed=True):
    dry_run: NotRequired["capo_ec2.types.boolean.Boolean"]
    """<p>Checks whether you have the required permissions for the operation, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p>"""
    ipam_internet_registry_association_ids: NotRequired[
...
def serialize_ec2_query(
    value: DescribeIpamInternetRegistryAssociationsRequest,
    ...
    if "ipam_internet_registry_association_ids" in value:
        import capo_ec2.types.value_string_list

        capo_ec2.types.value_string_list.serialize_ec2_query(
            value["ipam_internet_registry_association_ids"],
            pairs,
...
def deserialize_ec2_query(
    ...
    out: DescribeIpamInternetRegistryAssociationsRequest = {}  # type: ignore[typeddict-item]
    child_dry_run = el.find("DryRun")
    if child_dry_run is not None:
        out["dry_run"] = (child_dry_run.text or "").lower() == "true"
    child_ipam_internet_registry_association_ids = el.find(
        "IpamInternetRegistryAssociationId"
    )
    if child_ipam_internet_registry_association_ids is not None:
        import capo_ec2.types.value_string_list

        out["ipam_internet_registry_association_ids"] = (
            capo_ec2.types.value_string_list.deserialize_ec2_query(
                child_ipam_internet_registry_association_ids
            )
        )
