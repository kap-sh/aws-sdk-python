...
def deserialize_ec2_query(el: Element) -> AnalysisComponentList:
    import capo_ec2.types.analysis_component

    out: AnalysisComponentList = []
    for child in el.findall("item"):
        out.append(capo_ec2.types.analysis_component.deserialize_ec2_query(child))
    return out


def deserialize_ec2_query_flat(parent: Element, tag: str) -> AnalysisComponentList:
    import capo_ec2.types.analysis_component
