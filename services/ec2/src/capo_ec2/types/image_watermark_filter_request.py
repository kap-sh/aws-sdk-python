"""Generated from Smithy shape ``com.amazonaws.ec2#ImageWatermarkFilterRequest``."""
...
class ImageWatermarkFilterRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ImageWatermarkFilterRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> ImageWatermarkFilterRequest:
    out: ImageWatermarkFilterRequest = {}  # type: ignore[typeddict-item]
