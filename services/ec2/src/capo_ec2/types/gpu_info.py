...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.total_gpu_memory


class GpuInfo(TypedDict, closed=True):
    gpus: NotRequired["capo_ec2.types.gpu_device_info_list.GpuDeviceInfoList"]
    """<p>Describes the GPU accelerators for the instance type.</p>"""
    total_gpu_memory_in_mi_b: NotRequired[
        "capo_ec2.types.total_gpu_memory.totalGpuMemory"
    ]
