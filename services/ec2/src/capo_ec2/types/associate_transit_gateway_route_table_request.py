"""Generated from Smithy shape ``com.amazonaws.ec2#AssociateTransitGatewayRouteTableRequest``."""
...
class AssociateTransitGatewayRouteTableRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AssociateTransitGatewayRouteTableRequest,
...
def deserialize_ec2_query(el: Element) -> AssociateTransitGatewayRouteTableRequest:
    out: AssociateTransitGatewayRouteTableRequest = {}  # type: ignore[typeddict-item]
