"""Generated from Smithy shape ``com.amazonaws.ec2#AttachVerifiedAccessTrustProviderRequest``."""
...
class AttachVerifiedAccessTrustProviderRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AttachVerifiedAccessTrustProviderRequest,
...
def deserialize_ec2_query(el: Element) -> AttachVerifiedAccessTrustProviderRequest:
    out: AttachVerifiedAccessTrustProviderRequest = {}  # type: ignore[typeddict-item]
