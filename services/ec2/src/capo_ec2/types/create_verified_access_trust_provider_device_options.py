...
class CreateVerifiedAccessTrustProviderDeviceOptions(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CreateVerifiedAccessTrustProviderDeviceOptions,
...
def deserialize_ec2_query(
    ...
    out: CreateVerifiedAccessTrustProviderDeviceOptions = {}  # type: ignore[typeddict-item]
