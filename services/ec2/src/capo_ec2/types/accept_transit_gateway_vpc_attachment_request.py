"""Generated from Smithy shape ``com.amazonaws.ec2#AcceptTransitGatewayVpcAttachmentRequest``."""
...
class AcceptTransitGatewayVpcAttachmentRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AcceptTransitGatewayVpcAttachmentRequest,
...
def deserialize_ec2_query(el: Element) -> AcceptTransitGatewayVpcAttachmentRequest:
    out: AcceptTransitGatewayVpcAttachmentRequest = {}  # type: ignore[typeddict-item]
