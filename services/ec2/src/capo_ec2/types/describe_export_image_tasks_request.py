...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.describe_export_image_tasks_max_results
...
class DescribeExportImageTasksRequest(TypedDict, closed=True):
    ...
    export_image_task_ids: NotRequired[
        "capo_ec2.types.export_image_task_id_list.ExportImageTaskIdList"
    ]
    """<p>The IDs of the export image tasks.</p>"""
    max_results: NotRequired[
        "capo_ec2.types.describe_export_image_tasks_max_results.DescribeExportImageTasksMaxResults"
    ]
