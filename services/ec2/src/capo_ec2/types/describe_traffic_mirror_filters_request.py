...
class DescribeTrafficMirrorFiltersRequest(TypedDict, closed=True):
    traffic_mirror_filter_ids: NotRequired[
        "capo_ec2.types.traffic_mirror_filter_id_list.TrafficMirrorFilterIdList"
    ]
...
def serialize_ec2_query(
    ...
    if "traffic_mirror_filter_ids" in value:
        ...
        capo_ec2.types.traffic_mirror_filter_id_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DescribeTrafficMirrorFiltersRequest:
    ...
    child_traffic_mirror_filter_ids = el.find("TrafficMirrorFilterId")
    if child_traffic_mirror_filter_ids is not None:
        import capo_ec2.types.traffic_mirror_filter_id_list

        out["traffic_mirror_filter_ids"] = (
            capo_ec2.types.traffic_mirror_filter_id_list.deserialize_ec2_query(
                child_traffic_mirror_filter_ids
            )
        )
