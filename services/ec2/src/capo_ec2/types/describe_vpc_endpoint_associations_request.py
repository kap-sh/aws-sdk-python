...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.max_results2
    import capo_ec2.types.string
    import capo_ec2.types.vpc_endpoint_id_list


class DescribeVpcEndpointAssociationsRequest(TypedDict, closed=True):
    ...
    max_results: NotRequired["capo_ec2.types.max_results2.MaxResults2"]
