...
def deserialize_ec2_query(el: Element) -> VpnGatewayIdStringList:
    out: VpnGatewayIdStringList = []
    for child in el.findall("VpnGatewayId"):
        out.append(str(child.text or ""))
    return out


def deserialize_ec2_query_flat(parent: Element, tag: str) -> VpnGatewayIdStringList:
    out: VpnGatewayIdStringList = []
