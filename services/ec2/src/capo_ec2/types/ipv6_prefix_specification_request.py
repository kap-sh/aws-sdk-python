"""Generated from Smithy shape ``com.amazonaws.ec2#Ipv6PrefixSpecificationRequest``."""
...
def serialize_ec2_query(
    value: Ipv6PrefixSpecificationRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
    if "ipv6_prefix" in value:
        pairs.append((f"{prefix}.Ipv6Prefix", str(value["ipv6_prefix"])))


def deserialize_ec2_query(el: Element) -> Ipv6PrefixSpecificationRequest:
