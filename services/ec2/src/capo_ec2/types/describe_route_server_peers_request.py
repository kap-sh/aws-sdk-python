...
class DescribeRouteServerPeersRequest(TypedDict, closed=True):
    route_server_peer_ids: NotRequired[
        "capo_ec2.types.route_server_peer_ids_list.RouteServerPeerIdsList"
    ]
...
def serialize_ec2_query(
    ...
    if "route_server_peer_ids" in value:
        ...
        capo_ec2.types.route_server_peer_ids_list.serialize_ec2_query(
            value["route_server_peer_ids"], pairs, f"{key_prefix}RouteServerPeerIds"
        )
