...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.service_link_virtual_interface_id
...
class ServiceLinkVirtualInterface(TypedDict, closed=True):
    service_link_virtual_interface_id: NotRequired[
        "capo_ec2.types.service_link_virtual_interface_id.ServiceLinkVirtualInterfaceId"
    ]
    ...
    outpost_id: NotRequired["capo_ec2.types.string.String"]
    ...
    peer_bgp_asn: NotRequired["capo_ec2.types.long.Long"]
    ...
    configuration_state: NotRequired[
        "capo_ec2.types.service_link_virtual_interface_configuration_state.ServiceLinkVirtualInterfaceConfigurationState"
    ]
...
def deserialize_ec2_query(el: Element) -> ServiceLinkVirtualInterface:
    ...
    if child_configuration_state is not None:
        ...
        out["configuration_state"] = (
            capo_ec2.types.service_link_virtual_interface_configuration_state.deserialize_ec2_query(
