...
def serialize_ec2_query(
    ...
    if "local_gateway_route_table_vpc_association_ids" in value:
        ...
        capo_ec2.types.local_gateway_route_table_vpc_association_id_set.serialize_ec2_query(
            ...
            pairs,
            f"{key_prefix}LocalGatewayRouteTableVpcAssociationIds",
        )
    if "filters" in value:
        import capo_ec2.types.filter_list
...
def deserialize_ec2_query(
    ...
    if el.find("LocalGatewayRouteTableVpcAssociationIds") is not None:
        import capo_ec2.types.local_gateway_route_table_vpc_association_id_set
        ...
        out["local_gateway_route_table_vpc_association_ids"] = (
            capo_ec2.types.local_gateway_route_table_vpc_association_id_set.deserialize_ec2_query(
                el, "LocalGatewayRouteTableVpcAssociationIds"
            )
        )
