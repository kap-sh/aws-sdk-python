"""Generated from Smithy shape ``com.amazonaws.ec2#GetVerifiedAccessEndpointPolicyRequest``."""
...
class GetVerifiedAccessEndpointPolicyRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetVerifiedAccessEndpointPolicyRequest,
...
def deserialize_ec2_query(el: Element) -> GetVerifiedAccessEndpointPolicyRequest:
    out: GetVerifiedAccessEndpointPolicyRequest = {}  # type: ignore[typeddict-item]
