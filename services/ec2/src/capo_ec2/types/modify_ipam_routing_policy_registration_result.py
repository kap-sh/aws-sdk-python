"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyIpamRoutingPolicyRegistrationResult``."""
...
class ModifyIpamRoutingPolicyRegistrationResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ModifyIpamRoutingPolicyRegistrationResult,
...
def deserialize_ec2_query(el: Element) -> ModifyIpamRoutingPolicyRegistrationResult:
    out: ModifyIpamRoutingPolicyRegistrationResult = {}  # type: ignore[typeddict-item]
