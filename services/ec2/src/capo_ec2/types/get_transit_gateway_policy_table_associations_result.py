...
class GetTransitGatewayPolicyTableAssociationsResult(TypedDict, closed=True):
    associations: NotRequired[
        "capo_ec2.types.transit_gateway_policy_table_association_list.TransitGatewayPolicyTableAssociationList"
    ]
...
def serialize_ec2_query(
    ...
    if "associations" in value:
        ...
        capo_ec2.types.transit_gateway_policy_table_association_list.serialize_ec2_query(
