...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.subnet_cidr_reservation_id


class DeleteSubnetCidrReservationRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteSubnetCidrReservationRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DeleteSubnetCidrReservationRequest:
    out: DeleteSubnetCidrReservationRequest = {}  # type: ignore[typeddict-item]
