...
class DeleteVerifiedAccessEndpointResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteVerifiedAccessEndpointResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DeleteVerifiedAccessEndpointResult:
    out: DeleteVerifiedAccessEndpointResult = {}  # type: ignore[typeddict-item]
