...
class UpdateCapacityManagerMonitoredTagKeysRequest(TypedDict, closed=True):
    activate_tag_keys: NotRequired["capo_ec2.types.value_string_list.ValueStringList"]
    ...
    deactivate_tag_keys: NotRequired["capo_ec2.types.value_string_list.ValueStringList"]
