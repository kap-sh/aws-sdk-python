"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTransitGatewayPeeringAttachmentRequest``."""
...
class DeleteTransitGatewayPeeringAttachmentRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteTransitGatewayPeeringAttachmentRequest,
...
def deserialize_ec2_query(el: Element) -> DeleteTransitGatewayPeeringAttachmentRequest:
    out: DeleteTransitGatewayPeeringAttachmentRequest = {}  # type: ignore[typeddict-item]
