...
def serialize_ec2_query(
    value: EnableVpcClassicLinkDnsSupportResult,
...
def deserialize_ec2_query(el: Element) -> EnableVpcClassicLinkDnsSupportResult:
    out: EnableVpcClassicLinkDnsSupportResult = {}  # type: ignore[typeddict-item]
