...
class MemoryMiB(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: MemoryMiB, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> MemoryMiB:
    out: MemoryMiB = {}  # type: ignore[typeddict-item]
