...
class DeleteClientVpnRouteResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteClientVpnRouteResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DeleteClientVpnRouteResult:
    out: DeleteClientVpnRouteResult = {}  # type: ignore[typeddict-item]
