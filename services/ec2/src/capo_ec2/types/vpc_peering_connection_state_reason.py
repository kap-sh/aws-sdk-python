...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.vpc_peering_connection_state_reason_code


class VpcPeeringConnectionStateReason(TypedDict, closed=True):
    code: NotRequired[
        "capo_ec2.types.vpc_peering_connection_state_reason_code.VpcPeeringConnectionStateReasonCode"
    ]
...
def serialize_ec2_query(
    ...
    if "code" in value:
        ...
        capo_ec2.types.vpc_peering_connection_state_reason_code.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> VpcPeeringConnectionStateReason:
    ...
    if child_code is not None:
        ...
        out["code"] = (
            capo_ec2.types.vpc_peering_connection_state_reason_code.deserialize_ec2_query(
                child_code
            )
        )
