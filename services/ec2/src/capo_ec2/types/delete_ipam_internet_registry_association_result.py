"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteIpamInternetRegistryAssociationResult``."""
...
class DeleteIpamInternetRegistryAssociationResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteIpamInternetRegistryAssociationResult,
...
def deserialize_ec2_query(el: Element) -> DeleteIpamInternetRegistryAssociationResult:
    out: DeleteIpamInternetRegistryAssociationResult = {}  # type: ignore[typeddict-item]
