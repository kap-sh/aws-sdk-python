...
class AssociateTransitGatewayPolicyTableRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AssociateTransitGatewayPolicyTableRequest,
...
def deserialize_ec2_query(el: Element) -> AssociateTransitGatewayPolicyTableRequest:
    out: AssociateTransitGatewayPolicyTableRequest = {}  # type: ignore[typeddict-item]
