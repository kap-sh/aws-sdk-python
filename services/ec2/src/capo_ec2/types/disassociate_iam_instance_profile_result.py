...
class DisassociateIamInstanceProfileResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DisassociateIamInstanceProfileResult,
...
def deserialize_ec2_query(el: Element) -> DisassociateIamInstanceProfileResult:
    out: DisassociateIamInstanceProfileResult = {}  # type: ignore[typeddict-item]
