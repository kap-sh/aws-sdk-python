"""Generated from Smithy shape ``com.amazonaws.ec2#GetIpamRoutingPolicyRegistrationsRequest``."""
...
class GetIpamRoutingPolicyRegistrationsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetIpamRoutingPolicyRegistrationsRequest,
...
def deserialize_ec2_query(el: Element) -> GetIpamRoutingPolicyRegistrationsRequest:
    out: GetIpamRoutingPolicyRegistrationsRequest = {}  # type: ignore[typeddict-item]
