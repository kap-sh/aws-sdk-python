"""Generated from Smithy shape ``com.amazonaws.ec2#RejectCapacityReservationBillingOwnershipResult``."""
...
RejectCapacityReservationBillingOwnershipResult = TypedDict(
...
def serialize_ec2_query(
    value: RejectCapacityReservationBillingOwnershipResult,
