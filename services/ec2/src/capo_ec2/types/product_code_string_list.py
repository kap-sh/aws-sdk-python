...
def deserialize_ec2_query(el: Element) -> ProductCodeStringList:
    out: ProductCodeStringList = []
    for child in el.findall("ProductCode"):
        out.append(str(child.text or ""))
    return out


def deserialize_ec2_query_flat(parent: Element, tag: str) -> ProductCodeStringList:
    out: ProductCodeStringList = []
