"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTransitGatewayClientVpnAttachmentRequest``."""
...
class DeleteTransitGatewayClientVpnAttachmentRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteTransitGatewayClientVpnAttachmentRequest,
...
def deserialize_ec2_query(
    ...
    out: DeleteTransitGatewayClientVpnAttachmentRequest = {}  # type: ignore[typeddict-item]
