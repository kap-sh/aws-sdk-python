...
SecondaryInterfacePrivateIpAddressSpecificationList: TypeAlias = list[
    "capo_ec2.types.secondary_interface_private_ip_address_specification.SecondaryInterfacePrivateIpAddressSpecification"
]


# --- ec2Query ser/de ---
def serialize_ec2_query(
    value: SecondaryInterfacePrivateIpAddressSpecificationList,
    ...
    for n, item in enumerate(value, 1):
        ...
        capo_ec2.types.secondary_interface_private_ip_address_specification.serialize_ec2_query(
