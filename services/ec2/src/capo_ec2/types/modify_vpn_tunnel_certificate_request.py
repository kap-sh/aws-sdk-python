...
class ModifyVpnTunnelCertificateRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ModifyVpnTunnelCertificateRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> ModifyVpnTunnelCertificateRequest:
    out: ModifyVpnTunnelCertificateRequest = {}  # type: ignore[typeddict-item]
