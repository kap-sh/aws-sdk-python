...
class DetachClassicLinkVpcRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DetachClassicLinkVpcRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DetachClassicLinkVpcRequest:
    out: DetachClassicLinkVpcRequest = {}  # type: ignore[typeddict-item]
