...
if TYPE_CHECKING:
    import capo_ec2.types.accelerator_count_request
    import capo_ec2.types.accelerator_manufacturer_set
    import capo_ec2.types.accelerator_name_set
    import capo_ec2.types.accelerator_total_memory_mi_b_request
    ...
    import capo_ec2.types.baseline_ebs_bandwidth_mbps_request
    import capo_ec2.types.baseline_performance_factors_request
    ...
    import capo_ec2.types.memory_gi_b_per_v_cpu_request
    import capo_ec2.types.memory_mi_b_request
    import capo_ec2.types.network_bandwidth_gbps_request
    import capo_ec2.types.network_interface_count_request
    import capo_ec2.types.total_local_storage_gb_request
    import capo_ec2.types.v_cpu_count_range_request
...
class InstanceRequirementsRequest(TypedDict, closed=True):
    ...
    memory_mi_b: NotRequired["capo_ec2.types.memory_mi_b_request.MemoryMiBRequest"]
    ...
    memory_gi_b_per_v_cpu: NotRequired[
        "capo_ec2.types.memory_gi_b_per_v_cpu_request.MemoryGiBPerVCpuRequest"
    ]
    ...
    network_interface_count: NotRequired[
        "capo_ec2.types.network_interface_count_request.NetworkInterfaceCountRequest"
    ]
    ...
    total_local_storage_gb: NotRequired[
        "capo_ec2.types.total_local_storage_gb_request.TotalLocalStorageGBRequest"
    ]
    ...
    baseline_ebs_bandwidth_mbps: NotRequired[
        "capo_ec2.types.baseline_ebs_bandwidth_mbps_request.BaselineEbsBandwidthMbpsRequest"
    ]
    ...
    accelerator_count: NotRequired[
        "capo_ec2.types.accelerator_count_request.AcceleratorCountRequest"
    ]
    ...
    accelerator_total_memory_mi_b: NotRequired[
        "capo_ec2.types.accelerator_total_memory_mi_b_request.AcceleratorTotalMemoryMiBRequest"
    ]
    ...
    network_bandwidth_gbps: NotRequired[
        "capo_ec2.types.network_bandwidth_gbps_request.NetworkBandwidthGbpsRequest"
    ]
    ...
    baseline_performance_factors: NotRequired[
        "capo_ec2.types.baseline_performance_factors_request.BaselinePerformanceFactorsRequest"
    ]
...
def serialize_ec2_query(
    ...
    if "v_cpu_count" in value:
        ...
        capo_ec2.types.v_cpu_count_range_request.serialize_ec2_query(
            value["v_cpu_count"], pairs, f"{key_prefix}VCpuCount"
        )
    if "memory_mi_b" in value:
        import capo_ec2.types.memory_mi_b_request

        capo_ec2.types.memory_mi_b_request.serialize_ec2_query(
    ...
    if "cpu_manufacturers" in value:
        ...
        capo_ec2.types.cpu_manufacturer_set.serialize_ec2_query(
            value["cpu_manufacturers"], pairs, f"{key_prefix}CpuManufacturer"
        )
    if "memory_gi_b_per_v_cpu" in value:
        import capo_ec2.types.memory_gi_b_per_v_cpu_request

        capo_ec2.types.memory_gi_b_per_v_cpu_request.serialize_ec2_query(
    ...
    if "excluded_instance_types" in value:
        ...
        capo_ec2.types.excluded_instance_type_set.serialize_ec2_query(
            value["excluded_instance_types"], pairs, f"{key_prefix}ExcludedInstanceType"
        )
    if "instance_generations" in value:
        import capo_ec2.types.instance_generation_set

        capo_ec2.types.instance_generation_set.serialize_ec2_query(
            value["instance_generations"], pairs, f"{key_prefix}InstanceGeneration"
        )
    ...
    if "network_interface_count" in value:
        ...
        capo_ec2.types.network_interface_count_request.serialize_ec2_query(
    ...
    if "local_storage_types" in value:
        ...
        capo_ec2.types.local_storage_type_set.serialize_ec2_query(
            value["local_storage_types"], pairs, f"{key_prefix}LocalStorageType"
        )
    if "total_local_storage_gb" in value:
        import capo_ec2.types.total_local_storage_gb_request

        capo_ec2.types.total_local_storage_gb_request.serialize_ec2_query(
            value["total_local_storage_gb"], pairs, f"{key_prefix}TotalLocalStorageGB"
        )
    if "baseline_ebs_bandwidth_mbps" in value:
        import capo_ec2.types.baseline_ebs_bandwidth_mbps_request

        capo_ec2.types.baseline_ebs_bandwidth_mbps_request.serialize_ec2_query(
    ...
    if "accelerator_types" in value:
        ...
        capo_ec2.types.accelerator_type_set.serialize_ec2_query(
            value["accelerator_types"], pairs, f"{key_prefix}AcceleratorType"
        )
    if "accelerator_count" in value:
        import capo_ec2.types.accelerator_count_request

        capo_ec2.types.accelerator_count_request.serialize_ec2_query(
    ...
    if "accelerator_manufacturers" in value:
        ...
        capo_ec2.types.accelerator_manufacturer_set.serialize_ec2_query(
            ...
            pairs,
            f"{key_prefix}AcceleratorManufacturer",
        )
    if "accelerator_names" in value:
        import capo_ec2.types.accelerator_name_set

        capo_ec2.types.accelerator_name_set.serialize_ec2_query(
            value["accelerator_names"], pairs, f"{key_prefix}AcceleratorName"
        )
    if "accelerator_total_memory_mi_b" in value:
        import capo_ec2.types.accelerator_total_memory_mi_b_request

        capo_ec2.types.accelerator_total_memory_mi_b_request.serialize_ec2_query(
    ...
    if "network_bandwidth_gbps" in value:
        ...
        capo_ec2.types.network_bandwidth_gbps_request.serialize_ec2_query(
    ...
    if "allowed_instance_types" in value:
        ...
        capo_ec2.types.allowed_instance_type_set.serialize_ec2_query(
            value["allowed_instance_types"], pairs, f"{key_prefix}AllowedInstanceType"
        )
    ...
    if "baseline_performance_factors" in value:
        ...
        capo_ec2.types.baseline_performance_factors_request.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> InstanceRequirementsRequest:
    ...
    if child_v_cpu_count is not None:
        ...
        out["v_cpu_count"] = (
            capo_ec2.types.v_cpu_count_range_request.deserialize_ec2_query(
                child_v_cpu_count
            )
        )
    ...
    if child_memory_gi_b_per_v_cpu is not None:
        ...
        out["memory_gi_b_per_v_cpu"] = (
            capo_ec2.types.memory_gi_b_per_v_cpu_request.deserialize_ec2_query(
    ...
    if child_network_interface_count is not None:
        ...
        out["network_interface_count"] = (
            capo_ec2.types.network_interface_count_request.deserialize_ec2_query(
    ...
    if child_total_local_storage_gb is not None:
        ...
        out["total_local_storage_gb"] = (
            capo_ec2.types.total_local_storage_gb_request.deserialize_ec2_query(
    ...
    if child_baseline_ebs_bandwidth_mbps is not None:
        ...
        out["baseline_ebs_bandwidth_mbps"] = (
            capo_ec2.types.baseline_ebs_bandwidth_mbps_request.deserialize_ec2_query(
    ...
    if child_accelerator_count is not None:
        ...
        out["accelerator_count"] = (
            capo_ec2.types.accelerator_count_request.deserialize_ec2_query(
    ...
    if child_accelerator_total_memory_mi_b is not None:
        ...
        out["accelerator_total_memory_mi_b"] = (
            capo_ec2.types.accelerator_total_memory_mi_b_request.deserialize_ec2_query(
    ...
    if child_network_bandwidth_gbps is not None:
        ...
        out["network_bandwidth_gbps"] = (
            capo_ec2.types.network_bandwidth_gbps_request.deserialize_ec2_query(
    ...
    if child_baseline_performance_factors is not None:
        ...
        out["baseline_performance_factors"] = (
            capo_ec2.types.baseline_performance_factors_request.deserialize_ec2_query(
