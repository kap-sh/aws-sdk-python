"""Generated from Smithy shape ``com.amazonaws.ec2#GetTransitGatewayAttachmentPropagationsRequest``."""
...
class GetTransitGatewayAttachmentPropagationsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetTransitGatewayAttachmentPropagationsRequest,
...
def deserialize_ec2_query(
    ...
    out: GetTransitGatewayAttachmentPropagationsRequest = {}  # type: ignore[typeddict-item]
