...
class DescribeVpcAttributeRequest(TypedDict, closed=True):
    attribute: NotRequired["capo_ec2.types.vpc_attribute_name.VpcAttributeName"]
...
def serialize_ec2_query(
    ...
    if "attribute" in value:
        ...
        capo_ec2.types.vpc_attribute_name.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DescribeVpcAttributeRequest:
    ...
    if child_attribute is not None:
        ...
        out["attribute"] = capo_ec2.types.vpc_attribute_name.deserialize_ec2_query(
            child_attribute
        )
