...
def serialize_ec2_query(
    value: DisassociateEnclaveCertificateIamRoleResult,
...
def deserialize_ec2_query(el: Element) -> DisassociateEnclaveCertificateIamRoleResult:
    out: DisassociateEnclaveCertificateIamRoleResult = {}  # type: ignore[typeddict-item]
