...
class CreateVerifiedAccessInstanceResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CreateVerifiedAccessInstanceResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> CreateVerifiedAccessInstanceResult:
    out: CreateVerifiedAccessInstanceResult = {}  # type: ignore[typeddict-item]
