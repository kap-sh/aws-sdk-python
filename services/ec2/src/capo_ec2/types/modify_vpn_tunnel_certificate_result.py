"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyVpnTunnelCertificateResult``."""
...
class ModifyVpnTunnelCertificateResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ModifyVpnTunnelCertificateResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> ModifyVpnTunnelCertificateResult:
    out: ModifyVpnTunnelCertificateResult = {}  # type: ignore[typeddict-item]
