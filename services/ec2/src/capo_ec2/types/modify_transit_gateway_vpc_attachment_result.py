...
class ModifyTransitGatewayVpcAttachmentResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ModifyTransitGatewayVpcAttachmentResult,
...
def deserialize_ec2_query(el: Element) -> ModifyTransitGatewayVpcAttachmentResult:
    out: ModifyTransitGatewayVpcAttachmentResult = {}  # type: ignore[typeddict-item]
