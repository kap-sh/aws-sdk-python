...
if TYPE_CHECKING:
    import capo_ec2.types.enable_fast_snapshot_restore_state_error_set
...
class EnableFastSnapshotRestoreErrorItem(TypedDict, closed=True):
    ...
    fast_snapshot_restore_state_errors: NotRequired[
        "capo_ec2.types.enable_fast_snapshot_restore_state_error_set.EnableFastSnapshotRestoreStateErrorSet"
    ]
    """<p>The errors.</p>"""
...
def serialize_ec2_query(
    ...
    if "fast_snapshot_restore_state_errors" in value:
        ...
        capo_ec2.types.enable_fast_snapshot_restore_state_error_set.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> EnableFastSnapshotRestoreErrorItem:
    ...
    if el.find("fastSnapshotRestoreStateErrorSet") is not None:
        ...
        out["fast_snapshot_restore_state_errors"] = (
            capo_ec2.types.enable_fast_snapshot_restore_state_error_set.deserialize_ec2_query(
