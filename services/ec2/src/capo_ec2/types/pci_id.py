...
class PciId(TypedDict, closed=True):
    device_id: NotRequired["capo_ec2.types.string.String"]
    """<p>The ID of the device.</p>"""
    vendor_id: NotRequired["capo_ec2.types.string.String"]
    """<p>The ID of the vendor.</p>"""
    subsystem_id: NotRequired["capo_ec2.types.string.String"]
    """<p>The ID of the subsystem.</p>"""
    subsystem_vendor_id: NotRequired["capo_ec2.types.string.String"]
