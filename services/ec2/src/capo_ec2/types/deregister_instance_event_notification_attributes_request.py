...
class DeregisterInstanceEventNotificationAttributesRequest(TypedDict, closed=True):
...
def deserialize_ec2_query(
    ...
    if child_instance_tag_attribute is not None:
        ...
        out["instance_tag_attribute"] = (
            capo_ec2.types.deregister_instance_tag_attribute_request.deserialize_ec2_query(
