"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeNetworkInterfacesRequest``."""
...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.describe_network_interfaces_max_results
    import capo_ec2.types.filter_list
    import capo_ec2.types.network_interface_id_list
    import capo_ec2.types.string


class DescribeNetworkInterfacesRequest(TypedDict, closed=True):
    next_token: NotRequired["capo_ec2.types.string.String"]
    """<p>The token returned from a previous paginated request. Pagination continues from the end of the items returned by the previous request.</p>"""
    max_results: NotRequired[
        "capo_ec2.types.describe_network_interfaces_max_results.DescribeNetworkInterfacesMaxResults"
    ]
...
def deserialize_ec2_query(el: Element) -> DescribeNetworkInterfacesRequest:
    out: DescribeNetworkInterfacesRequest = {}  # type: ignore[typeddict-item]
