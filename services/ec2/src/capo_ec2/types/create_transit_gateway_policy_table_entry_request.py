"""Generated from Smithy shape ``com.amazonaws.ec2#CreateTransitGatewayPolicyTableEntryRequest``."""
...
class CreateTransitGatewayPolicyTableEntryRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CreateTransitGatewayPolicyTableEntryRequest,
...
def deserialize_ec2_query(el: Element) -> CreateTransitGatewayPolicyTableEntryRequest:
    out: CreateTransitGatewayPolicyTableEntryRequest = {}  # type: ignore[typeddict-item]
