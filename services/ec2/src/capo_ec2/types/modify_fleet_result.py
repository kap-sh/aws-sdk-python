...
def serialize_ec2_query(
    value: ModifyFleetResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> ModifyFleetResult:
    out: ModifyFleetResult = {}  # type: ignore[typeddict-item]
