...
class PublicIpv4Pool(TypedDict, closed=True):
    ...
    pool_address_ranges: NotRequired[
        "capo_ec2.types.public_ipv4_pool_range_set.PublicIpv4PoolRangeSet"
    ]
    """<p>The address ranges.</p>"""
    total_address_count: NotRequired["capo_ec2.types.integer.Integer"]
    """<p>The total number of addresses.</p>"""
    total_available_address_count: NotRequired["capo_ec2.types.integer.Integer"]
