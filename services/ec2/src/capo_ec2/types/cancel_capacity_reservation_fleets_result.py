...
class CancelCapacityReservationFleetsResult(TypedDict, closed=True):
    successful_fleet_cancellations: NotRequired[
        "capo_ec2.types.capacity_reservation_fleet_cancellation_state_set.CapacityReservationFleetCancellationStateSet"
    ]
    ...
    failed_fleet_cancellations: NotRequired[
        "capo_ec2.types.failed_capacity_reservation_fleet_cancellation_result_set.FailedCapacityReservationFleetCancellationResultSet"
    ]
