...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.declarative_policies_report_id


class GetDeclarativePoliciesReportSummaryRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetDeclarativePoliciesReportSummaryRequest,
...
def deserialize_ec2_query(el: Element) -> GetDeclarativePoliciesReportSummaryRequest:
    out: GetDeclarativePoliciesReportSummaryRequest = {}  # type: ignore[typeddict-item]
