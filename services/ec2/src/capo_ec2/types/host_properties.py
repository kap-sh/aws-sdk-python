...
class HostProperties(TypedDict, closed=True):
    cores: NotRequired["capo_ec2.types.integer.Integer"]
    ...
    sockets: NotRequired["capo_ec2.types.integer.Integer"]
    """<p>The number of sockets on the Dedicated Host.</p>"""
    total_v_cpus: NotRequired["capo_ec2.types.integer.Integer"]
