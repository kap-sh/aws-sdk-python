"""Generated from Smithy shape ``com.amazonaws.ec2#CreateTransitGatewayPolicyTableEntryResult``."""
...
class CreateTransitGatewayPolicyTableEntryResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CreateTransitGatewayPolicyTableEntryResult,
...
def deserialize_ec2_query(el: Element) -> CreateTransitGatewayPolicyTableEntryResult:
    out: CreateTransitGatewayPolicyTableEntryResult = {}  # type: ignore[typeddict-item]
