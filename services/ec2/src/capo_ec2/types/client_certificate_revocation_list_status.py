...
class ClientCertificateRevocationListStatus(TypedDict, closed=True):
    code: NotRequired[
        "capo_ec2.types.client_certificate_revocation_list_status_code.ClientCertificateRevocationListStatusCode"
    ]
...
def serialize_ec2_query(
    ...
    if "code" in value:
        ...
        capo_ec2.types.client_certificate_revocation_list_status_code.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> ClientCertificateRevocationListStatus:
    ...
    if child_code is not None:
        ...
        out["code"] = (
            capo_ec2.types.client_certificate_revocation_list_status_code.deserialize_ec2_query(
                child_code
            )
        )
