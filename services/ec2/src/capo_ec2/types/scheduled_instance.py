...
class ScheduledInstance(TypedDict, closed=True):
    ...
    next_slot_start_time: NotRequired["capo_ec2.types.date_time.DateTime"]
    """<p>The time for the next schedule to start.</p>"""
    platform: NotRequired["capo_ec2.types.string.String"]
    """<p>The platform (<code>Linux/UNIX</code> or <code>Windows</code>).</p>"""
    previous_slot_end_time: NotRequired["capo_ec2.types.date_time.DateTime"]
    ...
    scheduled_instance_id: NotRequired["capo_ec2.types.string.String"]
    """<p>The Scheduled Instance ID.</p>"""
    slot_duration_in_hours: NotRequired["capo_ec2.types.integer.Integer"]
    """<p>The number of hours in the schedule.</p>"""
    term_end_date: NotRequired["capo_ec2.types.date_time.DateTime"]
    """<p>The end date for the Scheduled Instance.</p>"""
    term_start_date: NotRequired["capo_ec2.types.date_time.DateTime"]
...
def deserialize_ec2_query(el: Element) -> ScheduledInstance:
    ...
    if child_next_slot_start_time is not None:
        ...
        out["next_slot_start_time"] = capo_ec2.types.date_time.deserialize_ec2_query(
    ...
    if child_previous_slot_end_time is not None:
        ...
        out["previous_slot_end_time"] = capo_ec2.types.date_time.deserialize_ec2_query(
    ...
    if child_term_end_date is not None:
        ...
        out["term_end_date"] = capo_ec2.types.date_time.deserialize_ec2_query(
            child_term_end_date
        )
    ...
    if child_term_start_date is not None:
        ...
        out["term_start_date"] = capo_ec2.types.date_time.deserialize_ec2_query(
