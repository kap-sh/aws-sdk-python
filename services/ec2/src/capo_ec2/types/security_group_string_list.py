...
def deserialize_ec2_query(el: Element) -> SecurityGroupStringList:
    out: SecurityGroupStringList = []
    for child in el.findall("SecurityGroup"):
        out.append(str(child.text or ""))
    return out


def deserialize_ec2_query_flat(parent: Element, tag: str) -> SecurityGroupStringList:
    out: SecurityGroupStringList = []
