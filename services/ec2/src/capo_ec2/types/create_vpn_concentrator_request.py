...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.vpn_concentrator_type


class CreateVpnConcentratorRequest(TypedDict, closed=True):
    type: NotRequired["capo_ec2.types.vpn_concentrator_type.VpnConcentratorType"]
...
def serialize_ec2_query(
    ...
    if "type" in value:
        ...
        capo_ec2.types.vpn_concentrator_type.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> CreateVpnConcentratorRequest:
    ...
    if child_type is not None:
        ...
        out["type"] = capo_ec2.types.vpn_concentrator_type.deserialize_ec2_query(
            child_type
        )
