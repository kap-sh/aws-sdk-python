"""Generated from Smithy shape ``com.amazonaws.ec2#CreateIpamInternetRegistryAssociationResult``."""
...
class CreateIpamInternetRegistryAssociationResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CreateIpamInternetRegistryAssociationResult,
...
def deserialize_ec2_query(el: Element) -> CreateIpamInternetRegistryAssociationResult:
    out: CreateIpamInternetRegistryAssociationResult = {}  # type: ignore[typeddict-item]
