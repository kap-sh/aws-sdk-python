...
class ModifyTransitGatewayResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ModifyTransitGatewayResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> ModifyTransitGatewayResult:
    out: ModifyTransitGatewayResult = {}  # type: ignore[typeddict-item]
