...
class ProvisionByoipCidrResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ProvisionByoipCidrResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> ProvisionByoipCidrResult:
    out: ProvisionByoipCidrResult = {}  # type: ignore[typeddict-item]
