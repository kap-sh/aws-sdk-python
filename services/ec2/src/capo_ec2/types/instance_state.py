...
class InstanceState(TypedDict, closed=True):
    code: NotRequired["capo_ec2.types.integer.Integer"]
    ...
    name: NotRequired["capo_ec2.types.instance_state_name.InstanceStateName"]
...
def deserialize_ec2_query(el: Element) -> InstanceState:
    ...
    if child_name is not None:
        ...
        out["name"] = capo_ec2.types.instance_state_name.deserialize_ec2_query(
            child_name
        )
    return out
