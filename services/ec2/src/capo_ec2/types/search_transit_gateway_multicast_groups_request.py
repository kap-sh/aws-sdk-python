...
class SearchTransitGatewayMulticastGroupsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: SearchTransitGatewayMulticastGroupsRequest,
...
def deserialize_ec2_query(el: Element) -> SearchTransitGatewayMulticastGroupsRequest:
    out: SearchTransitGatewayMulticastGroupsRequest = {}  # type: ignore[typeddict-item]
