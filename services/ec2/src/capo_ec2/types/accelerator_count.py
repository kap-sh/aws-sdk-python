...
class AcceleratorCount(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AcceleratorCount, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> AcceleratorCount:
    out: AcceleratorCount = {}  # type: ignore[typeddict-item]
