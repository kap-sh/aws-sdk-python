...
class ReplaceRouteRequest(TypedDict, closed=True):
    ...
    local_target: NotRequired["capo_ec2.types.boolean.Boolean"]
    ...
    gateway_id: NotRequired["capo_ec2.types.route_gateway_id.RouteGatewayId"]
...
def serialize_ec2_query(
    ...
    if "local_target" in value:
        pairs.append(
            (f"{key_prefix}LocalTarget", "true" if value["local_target"] else "false")
        )
