...
class VpcEndpointAssociation(TypedDict, closed=True):
    ...
    service_network_name: NotRequired["capo_ec2.types.string.String"]
    """<p>The name of the service network.</p>"""
    associated_resource_accessibility: NotRequired["capo_ec2.types.string.String"]
    ...
    dns_entry: NotRequired["capo_ec2.types.dns_entry.DnsEntry"]
    """<p>The DNS entry of the VPC endpoint association.</p>"""
    private_dns_entry: NotRequired["capo_ec2.types.dns_entry.DnsEntry"]
    """<p>The private DNS entry of the VPC endpoint association.</p>"""
    associated_resource_arn: NotRequired["capo_ec2.types.string.String"]
    """<p>The Amazon Resource Name (ARN) of the associated resource.</p>"""
    resource_configuration_group_arn: NotRequired["capo_ec2.types.string.String"]
