...
class TransitGatewayMulticastGroup(TypedDict, closed=True):
    ...
    """<p>The ID of the transit gateway attachment.</p>"""
    group_member: NotRequired["capo_ec2.types.boolean.Boolean"]
    """<p>Indicates that the resource is a transit gateway multicast group member.</p>"""
    group_source: NotRequired["capo_ec2.types.boolean.Boolean"]
    """<p>Indicates that the resource is a transit gateway multicast group member.</p>"""
    member_type: NotRequired["capo_ec2.types.membership_type.MembershipType"]
    """<p>The member type (for example, <code>static</code>).</p>"""
    source_type: NotRequired["capo_ec2.types.membership_type.MembershipType"]
    """<p>The source type.</p>"""
...
def deserialize_ec2_query(el: Element) -> TransitGatewayMulticastGroup:
    ...
    if child_source_type is not None:
        ...
        out["source_type"] = capo_ec2.types.membership_type.deserialize_ec2_query(
            child_source_type
        )
    return out
