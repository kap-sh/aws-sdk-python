"""Generated from Smithy shape ``com.amazonaws.ec2#TransitGatewayRequestPolicyRule``."""
...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.transit_gateway_request_policy_rule_meta_data


class TransitGatewayRequestPolicyRule(TypedDict, closed=True):
    ...
    meta_data: NotRequired[
        "capo_ec2.types.transit_gateway_request_policy_rule_meta_data.TransitGatewayRequestPolicyRuleMetaData"
    ]
...
def serialize_ec2_query(
    value: TransitGatewayRequestPolicyRule, pairs: list[tuple[str, str]], prefix: str
) -> None:
    ...
    if "meta_data" in value:
        ...
        capo_ec2.types.transit_gateway_request_policy_rule_meta_data.serialize_ec2_query(
            value["meta_data"], pairs, f"{key_prefix}MetaData"
        )


def deserialize_ec2_query(el: Element) -> TransitGatewayRequestPolicyRule:
    out: TransitGatewayRequestPolicyRule = {}  # type: ignore[typeddict-item]
    ...
    if child_meta_data is not None:
        ...
        out["meta_data"] = (
            capo_ec2.types.transit_gateway_request_policy_rule_meta_data.deserialize_ec2_query(
                child_meta_data
            )
        )
    return out
