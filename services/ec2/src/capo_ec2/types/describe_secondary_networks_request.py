"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeSecondaryNetworksRequest``."""
...
def serialize_ec2_query(
    ...
    if "secondary_network_ids" in value:
        ...
        capo_ec2.types.secondary_network_id_list.serialize_ec2_query(
            value["secondary_network_ids"], pairs, f"{key_prefix}SecondaryNetworkId"
        )


def deserialize_ec2_query(el: Element) -> DescribeSecondaryNetworksRequest:
    out: DescribeSecondaryNetworksRequest = {}  # type: ignore[typeddict-item]
    ...
    child_secondary_network_ids = el.find("SecondaryNetworkId")
    if child_secondary_network_ids is not None:
        import capo_ec2.types.secondary_network_id_list

        out["secondary_network_ids"] = (
            capo_ec2.types.secondary_network_id_list.deserialize_ec2_query(
                child_secondary_network_ids
            )
        )
    return out
