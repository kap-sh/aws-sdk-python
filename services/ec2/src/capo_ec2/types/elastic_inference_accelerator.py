...
if TYPE_CHECKING:
    import capo_ec2.types.elastic_inference_accelerator_count
    import capo_ec2.types.string


class ElasticInferenceAccelerator(TypedDict, closed=True):
    ...
    count: NotRequired[
        "capo_ec2.types.elastic_inference_accelerator_count.ElasticInferenceAcceleratorCount"
    ]
