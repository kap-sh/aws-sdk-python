...
class DescribeTransitGatewayRouteTableAnnouncementsResult(TypedDict, closed=True):
    transit_gateway_route_table_announcements: NotRequired[
        "capo_ec2.types.transit_gateway_route_table_announcement_list.TransitGatewayRouteTableAnnouncementList"
    ]
...
def serialize_ec2_query(
    ...
    if "transit_gateway_route_table_announcements" in value:
        ...
        capo_ec2.types.transit_gateway_route_table_announcement_list.serialize_ec2_query(
            value["transit_gateway_route_table_announcements"],
            pairs,
            f"{key_prefix}TransitGatewayRouteTableAnnouncements",
        )
