...
class ImportImageLicenseConfigurationRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ImportImageLicenseConfigurationRequest,
...
def deserialize_ec2_query(el: Element) -> ImportImageLicenseConfigurationRequest:
    out: ImportImageLicenseConfigurationRequest = {}  # type: ignore[typeddict-item]
