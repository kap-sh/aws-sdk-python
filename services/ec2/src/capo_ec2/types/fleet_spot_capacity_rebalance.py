"""Generated from Smithy shape ``com.amazonaws.ec2#FleetSpotCapacityRebalance``."""
...
class FleetSpotCapacityRebalance(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: FleetSpotCapacityRebalance, pairs: list[tuple[str, str]], prefix: str
) -> None:
