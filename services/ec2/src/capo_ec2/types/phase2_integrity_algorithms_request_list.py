...
Phase2IntegrityAlgorithmsRequestList: TypeAlias = list[
    "capo_ec2.types.phase2_integrity_algorithms_request_list_value.Phase2IntegrityAlgorithmsRequestListValue"
]
...
def serialize_ec2_query(
    ...
    for n, item in enumerate(value, 1):
        ...
        capo_ec2.types.phase2_integrity_algorithms_request_list_value.serialize_ec2_query(
