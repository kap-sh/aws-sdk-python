...
def serialize_ec2_query(
    value: CancelCapacityReservationResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> CancelCapacityReservationResult:
    out: CancelCapacityReservationResult = {}  # type: ignore[typeddict-item]
