"""Generated from Smithy shape ``com.amazonaws.ec2#GetIpamInternetRegistryAssociationCidrsRequest``."""
...
class GetIpamInternetRegistryAssociationCidrsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetIpamInternetRegistryAssociationCidrsRequest,
...
def deserialize_ec2_query(
    ...
    out: GetIpamInternetRegistryAssociationCidrsRequest = {}  # type: ignore[typeddict-item]
