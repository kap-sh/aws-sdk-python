...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.transit_gateway_id_string_list
...
class DescribeTransitGatewaysRequest(TypedDict, closed=True):
    transit_gateway_ids: NotRequired[
        "capo_ec2.types.transit_gateway_id_string_list.TransitGatewayIdStringList"
    ]
...
def serialize_ec2_query(
    ...
    if "transit_gateway_ids" in value:
        ...
        capo_ec2.types.transit_gateway_id_string_list.serialize_ec2_query(
            value["transit_gateway_ids"], pairs, f"{key_prefix}TransitGatewayIds"
        )
    if "filters" in value:
        import capo_ec2.types.filter_list
...
def deserialize_ec2_query(el: Element) -> DescribeTransitGatewaysRequest:
    ...
    child_transit_gateway_ids = el.find("TransitGatewayIds")
    if child_transit_gateway_ids is not None:
        import capo_ec2.types.transit_gateway_id_string_list

        out["transit_gateway_ids"] = (
            capo_ec2.types.transit_gateway_id_string_list.deserialize_ec2_query(
                child_transit_gateway_ids
            )
        )
