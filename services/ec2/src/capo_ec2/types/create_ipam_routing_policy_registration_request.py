"""Generated from Smithy shape ``com.amazonaws.ec2#CreateIpamRoutingPolicyRegistrationRequest``."""
...
class CreateIpamRoutingPolicyRegistrationRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CreateIpamRoutingPolicyRegistrationRequest,
...
def deserialize_ec2_query(el: Element) -> CreateIpamRoutingPolicyRegistrationRequest:
    out: CreateIpamRoutingPolicyRegistrationRequest = {}  # type: ignore[typeddict-item]
