...
class VerifiedAccessLogS3DestinationOptions(TypedDict, closed=True):
    enabled: NotRequired["capo_ec2.types.boolean.Boolean"]
    """<p>Indicates whether logging is enabled.</p>"""
    bucket_name: NotRequired["capo_ec2.types.string.String"]
    """<p>The bucket name.</p>"""
    prefix: NotRequired["capo_ec2.types.string.String"]
    """<p>The bucket prefix.</p>"""
    bucket_owner: NotRequired["capo_ec2.types.string.String"]
