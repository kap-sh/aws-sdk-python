"""Generated from Smithy shape ``com.amazonaws.ec2#RejectTransitGatewayVpcAttachmentRequest``."""
...
class RejectTransitGatewayVpcAttachmentRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: RejectTransitGatewayVpcAttachmentRequest,
...
def deserialize_ec2_query(el: Element) -> RejectTransitGatewayVpcAttachmentRequest:
    out: RejectTransitGatewayVpcAttachmentRequest = {}  # type: ignore[typeddict-item]
