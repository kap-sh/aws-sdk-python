"""Generated from Smithy shape ``com.amazonaws.ec2#TagFieldSpecificationRequest``."""
...
class TagFieldSpecificationRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: TagFieldSpecificationRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
    ...
    if "tag_keys" in value:
        ...
        capo_ec2.types.tag_key_list.serialize_ec2_query(
            value["tag_keys"], pairs, f"{key_prefix}TagKey"
        )


def deserialize_ec2_query(el: Element) -> TagFieldSpecificationRequest:
    out: TagFieldSpecificationRequest = {}  # type: ignore[typeddict-item]
