...
class DescribeLocalGatewayRouteTablesRequest(TypedDict, closed=True):
    local_gateway_route_table_ids: NotRequired[
        "capo_ec2.types.local_gateway_route_table_id_set.LocalGatewayRouteTableIdSet"
    ]
...
def serialize_ec2_query(
    ...
    if "local_gateway_route_table_ids" in value:
        ...
        capo_ec2.types.local_gateway_route_table_id_set.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DescribeLocalGatewayRouteTablesRequest:
    ...
    child_local_gateway_route_table_ids = el.find("LocalGatewayRouteTableId")
    if child_local_gateway_route_table_ids is not None:
        import capo_ec2.types.local_gateway_route_table_id_set

        out["local_gateway_route_table_ids"] = (
            capo_ec2.types.local_gateway_route_table_id_set.deserialize_ec2_query(
                child_local_gateway_route_table_ids
            )
        )
