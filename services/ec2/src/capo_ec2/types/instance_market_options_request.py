...
class InstanceMarketOptionsRequest(TypedDict, closed=True):
    ...
    """<p>The market type.</p>"""
    spot_options: NotRequired["capo_ec2.types.spot_market_options.SpotMarketOptions"]
...
def deserialize_ec2_query(el: Element) -> InstanceMarketOptionsRequest:
    ...
    if child_spot_options is not None:
        ...
        out["spot_options"] = capo_ec2.types.spot_market_options.deserialize_ec2_query(
            child_spot_options
        )
    return out
