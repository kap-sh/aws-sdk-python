...
class CreateTransitGatewayPolicyTableResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    ...
    if "transit_gateway_policy_table" in value:
        ...
        capo_ec2.types.transit_gateway_policy_table.serialize_ec2_query(
            ...
            pairs,
            f"{key_prefix}TransitGatewayPolicyTable",
        )
...
def deserialize_ec2_query(el: Element) -> CreateTransitGatewayPolicyTableResult:
    ...
    if child_transit_gateway_policy_table is not None:
        ...
        out["transit_gateway_policy_table"] = (
            capo_ec2.types.transit_gateway_policy_table.deserialize_ec2_query(
