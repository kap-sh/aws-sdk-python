...
class AssociateInstanceEventWindowResult(TypedDict, closed=True):
...
def deserialize_ec2_query(el: Element) -> AssociateInstanceEventWindowResult:
    out: AssociateInstanceEventWindowResult = {}  # type: ignore[typeddict-item]
