...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.capacity_block_extension_status
...
class CapacityBlockExtension(TypedDict, closed=True):
    ...
    capacity_block_extension_status: NotRequired[
        "capo_ec2.types.capacity_block_extension_status.CapacityBlockExtensionStatus"
    ]
...
def serialize_ec2_query(
    ...
    if "capacity_block_extension_status" in value:
        ...
        capo_ec2.types.capacity_block_extension_status.serialize_ec2_query(
            value["capacity_block_extension_status"],
            pairs,
            f"{key_prefix}CapacityBlockExtensionStatus",
        )
    if "capacity_block_extension_purchase_date" in value:
        ...
        capo_ec2.types.millisecond_date_time.serialize_ec2_query(
            ...
            pairs,
            f"{key_prefix}CapacityBlockExtensionPurchaseDate",
        )
...
def deserialize_ec2_query(el: Element) -> CapacityBlockExtension:
    ...
    if child_capacity_block_extension_status is not None:
        ...
        out["capacity_block_extension_status"] = (
            capo_ec2.types.capacity_block_extension_status.deserialize_ec2_query(
