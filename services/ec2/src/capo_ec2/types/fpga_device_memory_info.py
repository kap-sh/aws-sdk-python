...
if TYPE_CHECKING:
    import capo_ec2.types.fpga_device_memory_size


class FpgaDeviceMemoryInfo(TypedDict, closed=True):
    size_in_mi_b: NotRequired[
        "capo_ec2.types.fpga_device_memory_size.FpgaDeviceMemorySize"
    ]
