...
class DescribePublicIpv4PoolsRequest(TypedDict, closed=True):
    pool_ids: NotRequired[
        "capo_ec2.types.public_ipv4_pool_id_string_list.PublicIpv4PoolIdStringList"
    ]
    """<p>The IDs of the address pools.</p>"""
    next_token: NotRequired["capo_ec2.types.next_token.NextToken"]
    """<p>The token for the next page of results.</p>"""
    max_results: NotRequired["capo_ec2.types.pool_max_results.PoolMaxResults"]
