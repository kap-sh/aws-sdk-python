...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.get_capacity_manager_monitored_tag_keys_request_max_results
    import capo_ec2.types.string


class GetCapacityManagerMonitoredTagKeysRequest(TypedDict, closed=True):
    max_results: NotRequired[
        "capo_ec2.types.get_capacity_manager_monitored_tag_keys_request_max_results.GetCapacityManagerMonitoredTagKeysRequestMaxResults"
    ]
