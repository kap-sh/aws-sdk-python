"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteManagedPrefixListRequest``."""
...
class DeleteManagedPrefixListRequest(TypedDict, closed=True):
...
def deserialize_ec2_query(el: Element) -> DeleteManagedPrefixListRequest:
    out: DeleteManagedPrefixListRequest = {}  # type: ignore[typeddict-item]
