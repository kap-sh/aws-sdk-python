...
class AcceptTransitGatewayMulticastDomainAssociationsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AcceptTransitGatewayMulticastDomainAssociationsRequest,
...
def deserialize_ec2_query(
    ...
    out: AcceptTransitGatewayMulticastDomainAssociationsRequest = {}  # type: ignore[typeddict-item]
