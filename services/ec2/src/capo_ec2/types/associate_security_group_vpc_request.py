...
class AssociateSecurityGroupVpcRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AssociateSecurityGroupVpcRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> AssociateSecurityGroupVpcRequest:
    out: AssociateSecurityGroupVpcRequest = {}  # type: ignore[typeddict-item]
