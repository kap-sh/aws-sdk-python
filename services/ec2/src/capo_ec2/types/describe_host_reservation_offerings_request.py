...
if TYPE_CHECKING:
    import capo_ec2.types.describe_host_reservations_max_results
...
class DescribeHostReservationOfferingsRequest(TypedDict, closed=True):
    ...
    max_duration: NotRequired["capo_ec2.types.integer.Integer"]
    ...
    max_results: NotRequired[
        "capo_ec2.types.describe_host_reservations_max_results.DescribeHostReservationsMaxResults"
    ]
    """<p>The maximum number of results to return for the request in a single page. The remaining results can be seen by sending another request with the returned <code>nextToken</code> value. This value can be between 5 and 500. If <code>maxResults</code> is given a larger value than 500, you receive an error.</p>"""
    min_duration: NotRequired["capo_ec2.types.integer.Integer"]
