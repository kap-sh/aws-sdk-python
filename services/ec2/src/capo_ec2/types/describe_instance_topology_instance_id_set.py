...
DescribeInstanceTopologyInstanceIdSet: TypeAlias = list[
    "capo_ec2.types.instance_id.InstanceId"
]


# --- ec2Query ser/de ---
def serialize_ec2_query(
    value: DescribeInstanceTopologyInstanceIdSet,
...
def deserialize_ec2_query(el: Element) -> DescribeInstanceTopologyInstanceIdSet:
    out: DescribeInstanceTopologyInstanceIdSet = []
