"""Generated from Smithy shape ``com.amazonaws.ec2#CreateSpotDatafeedSubscriptionResult``."""
...
class CreateSpotDatafeedSubscriptionResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CreateSpotDatafeedSubscriptionResult,
...
def deserialize_ec2_query(el: Element) -> CreateSpotDatafeedSubscriptionResult:
    out: CreateSpotDatafeedSubscriptionResult = {}  # type: ignore[typeddict-item]
