...
if TYPE_CHECKING:
    import capo_ec2.types.neuron_device_core_count
    import capo_ec2.types.neuron_device_core_version


class NeuronDeviceCoreInfo(TypedDict, closed=True):
    count: NotRequired["capo_ec2.types.neuron_device_core_count.NeuronDeviceCoreCount"]
    """<p>The number of cores available to the neuron accelerator.</p>"""
    version: NotRequired[
        "capo_ec2.types.neuron_device_core_version.NeuronDeviceCoreVersion"
    ]
