...
if TYPE_CHECKING:
    import capo_ec2.types.fleet_ebs_block_device_request
    import capo_ec2.types.string


class FleetBlockDeviceMappingRequest(TypedDict, closed=True):
    ...
    ebs: NotRequired[
        "capo_ec2.types.fleet_ebs_block_device_request.FleetEbsBlockDeviceRequest"
    ]
...
def serialize_ec2_query(
    value: FleetBlockDeviceMappingRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
    ...
    if "ebs" in value:
        ...
        capo_ec2.types.fleet_ebs_block_device_request.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> FleetBlockDeviceMappingRequest:
    out: FleetBlockDeviceMappingRequest = {}  # type: ignore[typeddict-item]
    ...
    if child_ebs is not None:
        ...
        out["ebs"] = (
            capo_ec2.types.fleet_ebs_block_device_request.deserialize_ec2_query(
                child_ebs
            )
        )
