...
class DeleteTransitGatewayConnectPeerRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteTransitGatewayConnectPeerRequest,
...
def deserialize_ec2_query(el: Element) -> DeleteTransitGatewayConnectPeerRequest:
    out: DeleteTransitGatewayConnectPeerRequest = {}  # type: ignore[typeddict-item]
