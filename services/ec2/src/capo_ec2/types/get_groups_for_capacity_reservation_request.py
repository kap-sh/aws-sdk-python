...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.get_groups_for_capacity_reservation_request_max_results
    import capo_ec2.types.string


class GetGroupsForCapacityReservationRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetGroupsForCapacityReservationRequest,
...
def deserialize_ec2_query(el: Element) -> GetGroupsForCapacityReservationRequest:
    out: GetGroupsForCapacityReservationRequest = {}  # type: ignore[typeddict-item]
