"""Generated from Smithy shape ``com.amazonaws.ec2#DisableApplicationStatusCheckSuppressionResult``."""
...
class DisableApplicationStatusCheckSuppressionResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DisableApplicationStatusCheckSuppressionResult,
...
def deserialize_ec2_query(
    ...
    out: DisableApplicationStatusCheckSuppressionResult = {}  # type: ignore[typeddict-item]
