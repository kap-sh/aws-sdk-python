...
if TYPE_CHECKING:
    import capo_ec2.types.launch_template_ebs_block_device
...
class LaunchTemplateBlockDeviceMapping(TypedDict, closed=True):
    ...
    ebs: NotRequired[
        "capo_ec2.types.launch_template_ebs_block_device.LaunchTemplateEbsBlockDevice"
    ]
...
def serialize_ec2_query(
    ...
    if "ebs" in value:
        ...
        capo_ec2.types.launch_template_ebs_block_device.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> LaunchTemplateBlockDeviceMapping:
    ...
    if child_ebs is not None:
        ...
        out["ebs"] = (
            capo_ec2.types.launch_template_ebs_block_device.deserialize_ec2_query(
                child_ebs
            )
        )
