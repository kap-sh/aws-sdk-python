...
class DescribeVerifiedAccessInstanceLoggingConfigurationsResult(TypedDict, closed=True):
    logging_configurations: NotRequired[
        "capo_ec2.types.verified_access_instance_logging_configuration_list.VerifiedAccessInstanceLoggingConfigurationList"
    ]
...
def serialize_ec2_query(
    value: DescribeVerifiedAccessInstanceLoggingConfigurationsResult,
    ...
    if "logging_configurations" in value:
        ...
        capo_ec2.types.verified_access_instance_logging_configuration_list.serialize_ec2_query(
            value["logging_configurations"], pairs, f"{prefix}.LoggingConfigurationSet"
        )
