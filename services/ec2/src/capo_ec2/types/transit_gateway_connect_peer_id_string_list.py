...
def serialize_ec2_query(
    value: TransitGatewayConnectPeerIdStringList,
...
def deserialize_ec2_query(el: Element) -> TransitGatewayConnectPeerIdStringList:
    out: TransitGatewayConnectPeerIdStringList = []
