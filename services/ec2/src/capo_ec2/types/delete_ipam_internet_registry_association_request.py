"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteIpamInternetRegistryAssociationRequest``."""
...
class DeleteIpamInternetRegistryAssociationRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteIpamInternetRegistryAssociationRequest,
...
def deserialize_ec2_query(el: Element) -> DeleteIpamInternetRegistryAssociationRequest:
    out: DeleteIpamInternetRegistryAssociationRequest = {}  # type: ignore[typeddict-item]
