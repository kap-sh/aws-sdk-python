...
InstanceTypeList: TypeAlias = list["capo_ec2.types.instance_type.InstanceType"]
...
def deserialize_ec2_query(el: Element) -> InstanceTypeList:
    import capo_ec2.types.instance_type
...
def deserialize_ec2_query_flat(parent: Element, tag: str) -> InstanceTypeList:
    import capo_ec2.types.instance_type
