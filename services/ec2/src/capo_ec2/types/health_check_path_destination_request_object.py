"""Generated from Smithy shape ``com.amazonaws.ec2#HealthCheckPathDestinationRequestObject``."""
...
class HealthCheckPathDestinationRequestObject(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: HealthCheckPathDestinationRequestObject,
...
def deserialize_ec2_query(el: Element) -> HealthCheckPathDestinationRequestObject:
    out: HealthCheckPathDestinationRequestObject = {}  # type: ignore[typeddict-item]
