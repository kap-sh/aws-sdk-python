"""Generated from Smithy shape ``com.amazonaws.ec2#DisassociateApplicationStatusCheckResult``."""
...
class DisassociateApplicationStatusCheckResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DisassociateApplicationStatusCheckResult,
...
def deserialize_ec2_query(el: Element) -> DisassociateApplicationStatusCheckResult:
    out: DisassociateApplicationStatusCheckResult = {}  # type: ignore[typeddict-item]
