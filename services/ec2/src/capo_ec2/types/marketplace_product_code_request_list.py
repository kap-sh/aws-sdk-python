...
if TYPE_CHECKING:
    import capo_ec2.types.marketplace_product_code_request

MarketplaceProductCodeRequestList: TypeAlias = list[
    "capo_ec2.types.marketplace_product_code_request.MarketplaceProductCodeRequest"
]
...
def deserialize_ec2_query(el: Element) -> MarketplaceProductCodeRequestList:
