...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.request_filter_port_range
...
class PathRequestFilter(TypedDict, closed=True):
    ...
    source_port_range: NotRequired[
        "capo_ec2.types.request_filter_port_range.RequestFilterPortRange"
    ]
...
def serialize_ec2_query(
    ...
    if "source_port_range" in value:
        ...
        capo_ec2.types.request_filter_port_range.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> PathRequestFilter:
    ...
    if child_source_port_range is not None:
        ...
        out["source_port_range"] = (
            capo_ec2.types.request_filter_port_range.deserialize_ec2_query(
