"""Generated from Smithy shape ``com.amazonaws.ec2#AcceptTransitGatewayClientVpnAttachmentRequest``."""
...
class AcceptTransitGatewayClientVpnAttachmentRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AcceptTransitGatewayClientVpnAttachmentRequest,
...
def deserialize_ec2_query(
    ...
    out: AcceptTransitGatewayClientVpnAttachmentRequest = {}  # type: ignore[typeddict-item]
