"""Generated from Smithy shape ``com.amazonaws.ec2#DeregisterTransitGatewayMulticastGroupMembersRequest``."""
...
class DeregisterTransitGatewayMulticastGroupMembersRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeregisterTransitGatewayMulticastGroupMembersRequest,
...
def deserialize_ec2_query(
    ...
    out: DeregisterTransitGatewayMulticastGroupMembersRequest = {}  # type: ignore[typeddict-item]
