"""Generated from Smithy shape ``com.amazonaws.ec2#HostCpuOptions``."""
...
class HostCpuOptions(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: HostCpuOptions, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> HostCpuOptions:
    out: HostCpuOptions = {}  # type: ignore[typeddict-item]
