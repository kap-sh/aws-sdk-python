"""Generated from Smithy shape ``com.amazonaws.ec2#BatchModifyIpamRoutingPolicyRegistrationsResult``."""
...
class BatchModifyIpamRoutingPolicyRegistrationsResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: BatchModifyIpamRoutingPolicyRegistrationsResult,
...
def deserialize_ec2_query(
    ...
    out: BatchModifyIpamRoutingPolicyRegistrationsResult = {}  # type: ignore[typeddict-item]
