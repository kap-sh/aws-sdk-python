...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.eip_allocation_public_ip
    import capo_ec2.types.instance_id
    import capo_ec2.types.network_interface_id
    import capo_ec2.types.string


class AssociateAddressRequest(TypedDict, closed=True):
    ...
    public_ip: NotRequired[
        "capo_ec2.types.eip_allocation_public_ip.EipAllocationPublicIp"
    ]
    """<p>Deprecated.</p>"""
    ...
    allow_reassociation: NotRequired["capo_ec2.types.boolean.Boolean"]
