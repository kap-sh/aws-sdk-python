...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.capacity_reservation_options_request
...
class OnDemandOptionsRequest(TypedDict, closed=True):
    ...
    capacity_reservation_options: NotRequired[
        "capo_ec2.types.capacity_reservation_options_request.CapacityReservationOptionsRequest"
    ]
...
def serialize_ec2_query(
    ...
    if "capacity_reservation_options" in value:
        ...
        capo_ec2.types.capacity_reservation_options_request.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> OnDemandOptionsRequest:
    ...
    if child_capacity_reservation_options is not None:
        ...
        out["capacity_reservation_options"] = (
            capo_ec2.types.capacity_reservation_options_request.deserialize_ec2_query(
