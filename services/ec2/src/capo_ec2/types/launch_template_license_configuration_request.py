...
class LaunchTemplateLicenseConfigurationRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: LaunchTemplateLicenseConfigurationRequest,
...
def deserialize_ec2_query(el: Element) -> LaunchTemplateLicenseConfigurationRequest:
    out: LaunchTemplateLicenseConfigurationRequest = {}  # type: ignore[typeddict-item]
