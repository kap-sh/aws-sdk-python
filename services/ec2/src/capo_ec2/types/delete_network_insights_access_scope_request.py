"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteNetworkInsightsAccessScopeRequest``."""
...
class DeleteNetworkInsightsAccessScopeRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteNetworkInsightsAccessScopeRequest,
...
def deserialize_ec2_query(el: Element) -> DeleteNetworkInsightsAccessScopeRequest:
    out: DeleteNetworkInsightsAccessScopeRequest = {}  # type: ignore[typeddict-item]
