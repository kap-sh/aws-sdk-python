"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyLaunchTemplateRequest``."""
...
class ModifyLaunchTemplateRequest(TypedDict, closed=True):
    ...
    default_version: NotRequired["capo_ec2.types.string.String"]
