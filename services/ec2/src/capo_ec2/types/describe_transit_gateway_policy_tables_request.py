...
class DescribeTransitGatewayPolicyTablesRequest(TypedDict, closed=True):
    transit_gateway_policy_table_ids: NotRequired[
        "capo_ec2.types.transit_gateway_policy_table_id_string_list.TransitGatewayPolicyTableIdStringList"
    ]
...
def serialize_ec2_query(
    ...
    if "transit_gateway_policy_table_ids" in value:
        ...
        capo_ec2.types.transit_gateway_policy_table_id_string_list.serialize_ec2_query(
            value["transit_gateway_policy_table_ids"],
            pairs,
            f"{key_prefix}TransitGatewayPolicyTableIds",
        )
    if "filters" in value:
        import capo_ec2.types.filter_list
...
def deserialize_ec2_query(el: Element) -> DescribeTransitGatewayPolicyTablesRequest:
    ...
    child_transit_gateway_policy_table_ids = el.find("TransitGatewayPolicyTableIds")
    if child_transit_gateway_policy_table_ids is not None:
        import capo_ec2.types.transit_gateway_policy_table_id_string_list

        out["transit_gateway_policy_table_ids"] = (
            capo_ec2.types.transit_gateway_policy_table_id_string_list.deserialize_ec2_query(
                child_transit_gateway_policy_table_ids
            )
        )
