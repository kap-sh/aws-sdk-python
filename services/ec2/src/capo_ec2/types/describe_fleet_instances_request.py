"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeFleetInstancesRequest``."""
...
class DescribeFleetInstancesRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DescribeFleetInstancesRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DescribeFleetInstancesRequest:
    out: DescribeFleetInstancesRequest = {}  # type: ignore[typeddict-item]
