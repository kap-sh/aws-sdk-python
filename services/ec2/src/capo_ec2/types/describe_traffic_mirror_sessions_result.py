...
class DescribeTrafficMirrorSessionsResult(TypedDict, closed=True):
    traffic_mirror_sessions: NotRequired[
        "capo_ec2.types.traffic_mirror_session_set.TrafficMirrorSessionSet"
    ]
...
def serialize_ec2_query(
    ...
    if "traffic_mirror_sessions" in value:
        ...
        capo_ec2.types.traffic_mirror_session_set.serialize_ec2_query(
            value["traffic_mirror_sessions"],
            pairs,
            f"{key_prefix}TrafficMirrorSessionSet",
        )
