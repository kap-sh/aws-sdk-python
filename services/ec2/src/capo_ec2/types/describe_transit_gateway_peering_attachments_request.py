...
class DescribeTransitGatewayPeeringAttachmentsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DescribeTransitGatewayPeeringAttachmentsRequest,
...
def deserialize_ec2_query(
    ...
    out: DescribeTransitGatewayPeeringAttachmentsRequest = {}  # type: ignore[typeddict-item]
    child_transit_gateway_attachment_ids = el.find("TransitGatewayAttachmentIds")
    if child_transit_gateway_attachment_ids is not None:
        import capo_ec2.types.transit_gateway_attachment_id_string_list

        out["transit_gateway_attachment_ids"] = (
            capo_ec2.types.transit_gateway_attachment_id_string_list.deserialize_ec2_query(
                child_transit_gateway_attachment_ids
            )
        )
