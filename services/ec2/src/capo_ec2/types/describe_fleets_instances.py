...
class DescribeFleetsInstances(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DescribeFleetsInstances, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DescribeFleetsInstances:
    out: DescribeFleetsInstances = {}  # type: ignore[typeddict-item]
