...
class DisableRouteServerPropagationRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DisableRouteServerPropagationRequest,
...
def deserialize_ec2_query(el: Element) -> DisableRouteServerPropagationRequest:
    out: DisableRouteServerPropagationRequest = {}  # type: ignore[typeddict-item]
