...
class RequestIpamResourceTag(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: RequestIpamResourceTag, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> RequestIpamResourceTag:
    out: RequestIpamResourceTag = {}  # type: ignore[typeddict-item]
