...
DeleteLaunchTemplateVersionsResponseErrorSet: TypeAlias = list[
    "capo_ec2.types.delete_launch_template_versions_response_error_item.DeleteLaunchTemplateVersionsResponseErrorItem"
]
...
def serialize_ec2_query(
    ...
    for n, item in enumerate(value, 1):
        ...
        capo_ec2.types.delete_launch_template_versions_response_error_item.serialize_ec2_query(
