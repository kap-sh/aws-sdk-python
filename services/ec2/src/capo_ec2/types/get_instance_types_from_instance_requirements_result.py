...
class GetInstanceTypesFromInstanceRequirementsResult(TypedDict, closed=True):
    instance_types: NotRequired[
        "capo_ec2.types.instance_type_info_from_instance_requirements_set.InstanceTypeInfoFromInstanceRequirementsSet"
    ]
...
def serialize_ec2_query(
    ...
    if "instance_types" in value:
        ...
        capo_ec2.types.instance_type_info_from_instance_requirements_set.serialize_ec2_query(
