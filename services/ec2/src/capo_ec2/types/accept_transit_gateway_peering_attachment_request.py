"""Generated from Smithy shape ``com.amazonaws.ec2#AcceptTransitGatewayPeeringAttachmentRequest``."""
...
class AcceptTransitGatewayPeeringAttachmentRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AcceptTransitGatewayPeeringAttachmentRequest,
...
def deserialize_ec2_query(el: Element) -> AcceptTransitGatewayPeeringAttachmentRequest:
    out: AcceptTransitGatewayPeeringAttachmentRequest = {}  # type: ignore[typeddict-item]
