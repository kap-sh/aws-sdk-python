...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.outpost_lag_max_results
    import capo_ec2.types.string


class DescribeOutpostLagsRequest(TypedDict, closed=True):
    outpost_lag_ids: NotRequired["capo_ec2.types.outpost_lag_id_set.OutpostLagIdSet"]
    ...
    max_results: NotRequired[
        "capo_ec2.types.outpost_lag_max_results.OutpostLagMaxResults"
    ]
...
def serialize_ec2_query(
    ...
    if "outpost_lag_ids" in value:
        ...
        capo_ec2.types.outpost_lag_id_set.serialize_ec2_query(
            value["outpost_lag_ids"], pairs, f"{key_prefix}OutpostLagIds"
        )
    if "filters" in value:
        import capo_ec2.types.filter_list
...
def deserialize_ec2_query(el: Element) -> DescribeOutpostLagsRequest:
    ...
    if el.find("OutpostLagIds") is not None:
        ...
        out["outpost_lag_ids"] = (
            capo_ec2.types.outpost_lag_id_set.deserialize_ec2_query(el, "OutpostLagIds")
        )
