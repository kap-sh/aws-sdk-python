"""Generated from Smithy shape ``com.amazonaws.ec2#AssociateTransitGatewayMulticastDomainRequest``."""
...
class AssociateTransitGatewayMulticastDomainRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AssociateTransitGatewayMulticastDomainRequest,
...
def deserialize_ec2_query(el: Element) -> AssociateTransitGatewayMulticastDomainRequest:
    out: AssociateTransitGatewayMulticastDomainRequest = {}  # type: ignore[typeddict-item]
