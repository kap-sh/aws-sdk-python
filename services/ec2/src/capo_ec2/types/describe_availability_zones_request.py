...
class DescribeAvailabilityZonesRequest(TypedDict, closed=True):
    zone_names: NotRequired["capo_ec2.types.zone_name_string_list.ZoneNameStringList"]
    """<p>The names of the Availability Zones, Local Zones, and Wavelength Zones.</p>"""
    zone_ids: NotRequired["capo_ec2.types.zone_id_string_list.ZoneIdStringList"]
