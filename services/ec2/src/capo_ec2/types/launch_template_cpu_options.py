"""Generated from Smithy shape ``com.amazonaws.ec2#LaunchTemplateCpuOptions``."""
...
class LaunchTemplateCpuOptions(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: LaunchTemplateCpuOptions, pairs: list[tuple[str, str]], prefix: str
) -> None:
