...
class NetworkInsightsPath(TypedDict, closed=True):
    ...
    network_insights_path_arn: NotRequired["capo_ec2.types.resource_arn.ResourceArn"]
    ...
    source_arn: NotRequired["capo_ec2.types.resource_arn.ResourceArn"]
    """<p>The Amazon Resource Name (ARN) of the source.</p>"""
    destination_arn: NotRequired["capo_ec2.types.resource_arn.ResourceArn"]
    ...
    """<p>The protocol.</p>"""
    destination_port: NotRequired["capo_ec2.types.integer.Integer"]
    """<p>The destination port.</p>"""
    tags: NotRequired["capo_ec2.types.tag_list.TagList"]
    """<p>The tags associated with the path.</p>"""
    filter_at_source: NotRequired["capo_ec2.types.path_filter.PathFilter"]
    """<p>Scopes the analysis to network paths that match specific filters at the source.</p>"""
    filter_at_destination: NotRequired["capo_ec2.types.path_filter.PathFilter"]
...
def deserialize_ec2_query(el: Element) -> NetworkInsightsPath:
    ...
    if child_filter_at_destination is not None:
        ...
        out["filter_at_destination"] = capo_ec2.types.path_filter.deserialize_ec2_query(
