...
DedicatedHostIdList: TypeAlias = list[
    "capo_ec2.types.dedicated_host_id.DedicatedHostId"
]
...
def deserialize_ec2_query(el: Element) -> DedicatedHostIdList:
...
def deserialize_ec2_query_flat(parent: Element, tag: str) -> DedicatedHostIdList:
    out: DedicatedHostIdList = []
