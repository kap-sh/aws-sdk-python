"""Generated from Smithy shape ``com.amazonaws.ec2#RejectTransitGatewayClientVpnAttachmentRequest``."""
...
class RejectTransitGatewayClientVpnAttachmentRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: RejectTransitGatewayClientVpnAttachmentRequest,
...
def deserialize_ec2_query(
    ...
    out: RejectTransitGatewayClientVpnAttachmentRequest = {}  # type: ignore[typeddict-item]
