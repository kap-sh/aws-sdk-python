...
class TransitGatewayMeteringPolicy(TypedDict, closed=True):
    ...
    state: NotRequired[
        "capo_ec2.types.transit_gateway_metering_policy_state.TransitGatewayMeteringPolicyState"
    ]
...
def deserialize_ec2_query(el: Element) -> TransitGatewayMeteringPolicy:
    ...
    if child_state is not None:
        ...
        out["state"] = (
            capo_ec2.types.transit_gateway_metering_policy_state.deserialize_ec2_query(
                child_state
            )
        )
