...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.describe_verified_access_instance_logging_configurations_max_results
...
class DescribeVerifiedAccessInstanceLoggingConfigurationsRequest(
    ...
    max_results: NotRequired[
        "capo_ec2.types.describe_verified_access_instance_logging_configurations_max_results.DescribeVerifiedAccessInstanceLoggingConfigurationsMaxResults"
    ]
...
def serialize_ec2_query(
    value: DescribeVerifiedAccessInstanceLoggingConfigurationsRequest,
