...
class CreateStoreImageTaskRequest(TypedDict, closed=True):
    ...
    s3_object_tags: NotRequired["capo_ec2.types.s3_object_tag_list.S3ObjectTagList"]
...
def serialize_ec2_query(
    ...
    if "s3_object_tags" in value:
        ...
        capo_ec2.types.s3_object_tag_list.serialize_ec2_query(
            value["s3_object_tags"], pairs, f"{key_prefix}S3ObjectTags"
        )
    if "dry_run" in value:
