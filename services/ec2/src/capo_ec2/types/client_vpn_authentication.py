...
class ClientVpnAuthentication(TypedDict, closed=True):
    type: NotRequired[
        "capo_ec2.types.client_vpn_authentication_type.ClientVpnAuthenticationType"
    ]
    """<p>The authentication type used.</p>"""
    active_directory: NotRequired[
        "capo_ec2.types.directory_service_authentication.DirectoryServiceAuthentication"
    ]
    """<p>Information about the Active Directory, if applicable.</p>"""
    mutual_authentication: NotRequired[
        "capo_ec2.types.certificate_authentication.CertificateAuthentication"
    ]
    """<p>Information about the authentication certificates, if applicable.</p>"""
    federated_authentication: NotRequired[
        "capo_ec2.types.federated_authentication.FederatedAuthentication"
    ]
...
def deserialize_ec2_query(el: Element) -> ClientVpnAuthentication:
    ...
    if child_active_directory is not None:
        ...
        out["active_directory"] = (
            capo_ec2.types.directory_service_authentication.deserialize_ec2_query(
    ...
    if child_mutual_authentication is not None:
        ...
        out["mutual_authentication"] = (
            capo_ec2.types.certificate_authentication.deserialize_ec2_query(
    ...
    if child_federated_authentication is not None:
        ...
        out["federated_authentication"] = (
            capo_ec2.types.federated_authentication.deserialize_ec2_query(
