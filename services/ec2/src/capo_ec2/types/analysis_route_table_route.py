...
class AnalysisRouteTableRoute(TypedDict, closed=True):
    ...
    carrier_gateway_id: NotRequired["capo_ec2.types.string.String"]
    """<p>The ID of a carrier gateway.</p>"""
    core_network_arn: NotRequired["capo_ec2.types.resource_arn.ResourceArn"]
