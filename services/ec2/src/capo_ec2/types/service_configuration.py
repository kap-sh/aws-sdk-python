...
class ServiceConfiguration(TypedDict, closed=True):
    ...
    service_state: NotRequired["capo_ec2.types.service_state.ServiceState"]
    ...
    private_dns_name_configuration: NotRequired[
        "capo_ec2.types.private_dns_name_configuration.PrivateDnsNameConfiguration"
    ]
    ...
    supported_regions: NotRequired[
        "capo_ec2.types.supported_region_set.SupportedRegionSet"
    ]
    """<p>The supported Regions.</p>"""
    remote_access_enabled: NotRequired["capo_ec2.types.boolean.Boolean"]
...
def deserialize_ec2_query(el: Element) -> ServiceConfiguration:
    ...
    if child_private_dns_name_configuration is not None:
        ...
        out["private_dns_name_configuration"] = (
            capo_ec2.types.private_dns_name_configuration.deserialize_ec2_query(
