...
class OperatorResponse(TypedDict, closed=True):
    managed: NotRequired["capo_ec2.types.boolean.Boolean"]
    ...
    hidden_by_default: NotRequired["capo_ec2.types.boolean.Boolean"]
