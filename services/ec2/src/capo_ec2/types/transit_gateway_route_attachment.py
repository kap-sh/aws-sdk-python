"""Generated from Smithy shape ``com.amazonaws.ec2#TransitGatewayRouteAttachment``."""
...
class TransitGatewayRouteAttachment(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: TransitGatewayRouteAttachment, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> TransitGatewayRouteAttachment:
    out: TransitGatewayRouteAttachment = {}  # type: ignore[typeddict-item]
