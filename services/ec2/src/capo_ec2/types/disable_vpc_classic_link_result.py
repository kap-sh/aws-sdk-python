...
def serialize_ec2_query(
    value: DisableVpcClassicLinkResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DisableVpcClassicLinkResult:
    out: DisableVpcClassicLinkResult = {}  # type: ignore[typeddict-item]
