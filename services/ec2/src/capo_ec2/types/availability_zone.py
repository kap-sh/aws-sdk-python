...
class AvailabilityZone(TypedDict, closed=True):
    opt_in_status: NotRequired[
        "capo_ec2.types.availability_zone_opt_in_status.AvailabilityZoneOptInStatus"
    ]
    ...
    messages: NotRequired[
        "capo_ec2.types.availability_zone_message_list.AvailabilityZoneMessageList"
    ]
    ...
    zone_name: NotRequired["capo_ec2.types.string.String"]
    ...
    parent_zone_name: NotRequired["capo_ec2.types.string.String"]
    ...
    sub_geography: NotRequired[
        "capo_ec2.types.availability_zone_sub_geography_list.AvailabilityZoneSubGeographyList"
    ]
    """<p>The sub-geography information for the Availability Zone or Local Zone. The sub-geography is returned as a list.</p>"""
    state: NotRequired["capo_ec2.types.availability_zone_state.AvailabilityZoneState"]
...
def deserialize_ec2_query(el: Element) -> AvailabilityZone:
    ...
    if child_opt_in_status is not None:
        ...
        out["opt_in_status"] = (
            capo_ec2.types.availability_zone_opt_in_status.deserialize_ec2_query(
                child_opt_in_status
            )
        )
    ...
    if child_state is not None:
        ...
        out["state"] = capo_ec2.types.availability_zone_state.deserialize_ec2_query(
            child_state
        )
    return out
