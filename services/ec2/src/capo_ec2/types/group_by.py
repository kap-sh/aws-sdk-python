...
# --- ec2Query ser/de ---
def to_ec2_query_text(value: GroupBy) -> str:
    return value


def from_ec2_query_text(text: str) -> GroupBy:
    return cast(GroupBy, text)


def serialize_ec2_query(
    value: GroupBy, pairs: list[tuple[str, str]], prefix: str
) -> None:
    pairs.append((prefix, to_ec2_query_text(value)))


def deserialize_ec2_query(el: Element) -> GroupBy:
