...
class EnableFastLaunchRequest(TypedDict, closed=True):
    ...
    launch_template: NotRequired[
        "capo_ec2.types.fast_launch_launch_template_specification_request.FastLaunchLaunchTemplateSpecificationRequest"
    ]
...
def deserialize_ec2_query(el: Element) -> EnableFastLaunchRequest:
    ...
    if child_snapshot_configuration is not None:
        ...
        out["snapshot_configuration"] = (
            capo_ec2.types.fast_launch_snapshot_configuration_request.deserialize_ec2_query(
    ...
    if child_launch_template is not None:
        ...
        out["launch_template"] = (
            capo_ec2.types.fast_launch_launch_template_specification_request.deserialize_ec2_query(
