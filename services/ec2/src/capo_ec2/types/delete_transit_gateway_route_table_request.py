"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTransitGatewayRouteTableRequest``."""
...
class DeleteTransitGatewayRouteTableRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteTransitGatewayRouteTableRequest,
...
def deserialize_ec2_query(el: Element) -> DeleteTransitGatewayRouteTableRequest:
    out: DeleteTransitGatewayRouteTableRequest = {}  # type: ignore[typeddict-item]
