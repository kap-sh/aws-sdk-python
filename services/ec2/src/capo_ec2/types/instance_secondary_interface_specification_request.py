...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.instance_secondary_interface_private_ip_address_list_request
    import capo_ec2.types.integer
    import capo_ec2.types.secondary_interface_type
    import capo_ec2.types.secondary_subnet_id


class InstanceSecondaryInterfaceSpecificationRequest(TypedDict, closed=True):
    ...
    private_ip_addresses: NotRequired[
        "capo_ec2.types.instance_secondary_interface_private_ip_address_list_request.InstanceSecondaryInterfacePrivateIpAddressListRequest"
    ]
...
def serialize_ec2_query(
    value: InstanceSecondaryInterfaceSpecificationRequest,
    ...
    if "private_ip_addresses" in value:
        ...
        capo_ec2.types.instance_secondary_interface_private_ip_address_list_request.serialize_ec2_query(
...
def deserialize_ec2_query(
    ...
    out: InstanceSecondaryInterfaceSpecificationRequest = {}  # type: ignore[typeddict-item]
    ...
    if el.find("PrivateIpAddresses") is not None:
        ...
        out["private_ip_addresses"] = (
            capo_ec2.types.instance_secondary_interface_private_ip_address_list_request.deserialize_ec2_query(
