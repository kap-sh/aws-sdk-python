...
class RegisterTransitGatewayMulticastGroupMembersResult(TypedDict, closed=True):
    registered_multicast_group_members: NotRequired[
        "capo_ec2.types.transit_gateway_multicast_registered_group_members.TransitGatewayMulticastRegisteredGroupMembers"
    ]
...
def serialize_ec2_query(
    ...
    if "registered_multicast_group_members" in value:
        ...
        capo_ec2.types.transit_gateway_multicast_registered_group_members.serialize_ec2_query(
            value["registered_multicast_group_members"],
            pairs,
            f"{key_prefix}RegisteredMulticastGroupMembers",
        )
...
def deserialize_ec2_query(
    ...
    if child_registered_multicast_group_members is not None:
        ...
        out["registered_multicast_group_members"] = (
            capo_ec2.types.transit_gateway_multicast_registered_group_members.deserialize_ec2_query(
