...
if TYPE_CHECKING:
    import capo_ec2.types.fleet_launch_template_overrides_list
...
class FleetLaunchTemplateConfig(TypedDict, closed=True):
    ...
    overrides: NotRequired[
        "capo_ec2.types.fleet_launch_template_overrides_list.FleetLaunchTemplateOverridesList"
    ]
...
def serialize_ec2_query(
    ...
    if "overrides" in value:
        ...
        capo_ec2.types.fleet_launch_template_overrides_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> FleetLaunchTemplateConfig:
    ...
    if el.find("overrides") is not None:
        ...
        out["overrides"] = (
            capo_ec2.types.fleet_launch_template_overrides_list.deserialize_ec2_query(
                el, "overrides"
            )
        )
    return out
