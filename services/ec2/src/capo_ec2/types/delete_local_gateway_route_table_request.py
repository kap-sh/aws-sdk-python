"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteLocalGatewayRouteTableRequest``."""
...
class DeleteLocalGatewayRouteTableRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteLocalGatewayRouteTableRequest,
...
def deserialize_ec2_query(el: Element) -> DeleteLocalGatewayRouteTableRequest:
    out: DeleteLocalGatewayRouteTableRequest = {}  # type: ignore[typeddict-item]
