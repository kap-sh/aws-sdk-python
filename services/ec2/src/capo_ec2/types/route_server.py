...
class RouteServer(TypedDict, closed=True):
    ...
    state: NotRequired["capo_ec2.types.route_server_state.RouteServerState"]
    ...
    persist_routes_state: NotRequired[
        "capo_ec2.types.route_server_persist_routes_state.RouteServerPersistRoutesState"
    ]
    ...
    sns_topic_arn: NotRequired["capo_ec2.types.string.String"]
...
def deserialize_ec2_query(el: Element) -> RouteServer:
    ...
    if child_persist_routes_state is not None:
        ...
        out["persist_routes_state"] = (
            capo_ec2.types.route_server_persist_routes_state.deserialize_ec2_query(
