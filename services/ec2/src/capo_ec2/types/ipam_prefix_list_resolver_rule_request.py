...
class IpamPrefixListResolverRuleRequest(TypedDict, closed=True):
    ...
    conditions: NotRequired[
        "capo_ec2.types.ipam_prefix_list_resolver_rule_condition_request_set.IpamPrefixListResolverRuleConditionRequestSet"
    ]
...
def serialize_ec2_query(
    ...
    if "conditions" in value:
        ...
        capo_ec2.types.ipam_prefix_list_resolver_rule_condition_request_set.serialize_ec2_query(
            value["conditions"], pairs, f"{key_prefix}Condition"
        )
