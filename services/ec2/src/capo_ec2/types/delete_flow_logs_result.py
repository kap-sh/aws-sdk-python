...
class DeleteFlowLogsResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteFlowLogsResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DeleteFlowLogsResult:
    out: DeleteFlowLogsResult = {}  # type: ignore[typeddict-item]
