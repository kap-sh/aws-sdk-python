...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.launch_template_ena_srd_udp_specification


class LaunchTemplateEnaSrdSpecification(TypedDict, closed=True):
    ena_srd_enabled: NotRequired["capo_ec2.types.boolean.Boolean"]
    """<p>Indicates whether ENA Express is enabled for the network interface.</p>"""
    ena_srd_udp_specification: NotRequired[
        "capo_ec2.types.launch_template_ena_srd_udp_specification.LaunchTemplateEnaSrdUdpSpecification"
    ]
...
def serialize_ec2_query(
    value: LaunchTemplateEnaSrdSpecification, pairs: list[tuple[str, str]], prefix: str
) -> None:
    ...
    if "ena_srd_udp_specification" in value:
        ...
        capo_ec2.types.launch_template_ena_srd_udp_specification.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> LaunchTemplateEnaSrdSpecification:
    out: LaunchTemplateEnaSrdSpecification = {}  # type: ignore[typeddict-item]
    ...
    if child_ena_srd_udp_specification is not None:
        ...
        out["ena_srd_udp_specification"] = (
            capo_ec2.types.launch_template_ena_srd_udp_specification.deserialize_ec2_query(
