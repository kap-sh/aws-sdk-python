...
if TYPE_CHECKING:
    import capo_ec2.types.launch_template_ebs_block_device_request
    import capo_ec2.types.string


class LaunchTemplateBlockDeviceMappingRequest(TypedDict, closed=True):
    ...
    ebs: NotRequired[
        "capo_ec2.types.launch_template_ebs_block_device_request.LaunchTemplateEbsBlockDeviceRequest"
    ]
...
def serialize_ec2_query(
    ...
    if "ebs" in value:
        ...
        capo_ec2.types.launch_template_ebs_block_device_request.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> LaunchTemplateBlockDeviceMappingRequest:
    ...
    if child_ebs is not None:
        ...
        out["ebs"] = (
            capo_ec2.types.launch_template_ebs_block_device_request.deserialize_ec2_query(
                child_ebs
            )
        )
