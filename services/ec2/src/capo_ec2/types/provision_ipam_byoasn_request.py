...
class ProvisionIpamByoasnRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    ...
    if "asn_authorization_context" in value:
        ...
        capo_ec2.types.asn_authorization_context.serialize_ec2_query(
            value["asn_authorization_context"],
            pairs,
            f"{key_prefix}AsnAuthorizationContext",
        )
...
def deserialize_ec2_query(el: Element) -> ProvisionIpamByoasnRequest:
    ...
    if child_asn_authorization_context is not None:
        ...
        out["asn_authorization_context"] = (
            capo_ec2.types.asn_authorization_context.deserialize_ec2_query(
