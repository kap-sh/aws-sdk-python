"""Generated from Smithy shape ``com.amazonaws.ec2#AddIpamOrganizationalUnitExclusion``."""
...
class AddIpamOrganizationalUnitExclusion(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AddIpamOrganizationalUnitExclusion, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> AddIpamOrganizationalUnitExclusion:
    out: AddIpamOrganizationalUnitExclusion = {}  # type: ignore[typeddict-item]
