"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteCarrierGatewayRequest``."""
...
class DeleteCarrierGatewayRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteCarrierGatewayRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DeleteCarrierGatewayRequest:
    out: DeleteCarrierGatewayRequest = {}  # type: ignore[typeddict-item]
