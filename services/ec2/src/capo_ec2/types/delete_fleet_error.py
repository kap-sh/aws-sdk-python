...
if TYPE_CHECKING:
    import capo_ec2.types.delete_fleet_error_code
    import capo_ec2.types.string


class DeleteFleetError(TypedDict, closed=True):
    code: NotRequired["capo_ec2.types.delete_fleet_error_code.DeleteFleetErrorCode"]
    """<p>The error code.</p>"""
...
def serialize_ec2_query(
    ...
    if "code" in value:
        ...
        capo_ec2.types.delete_fleet_error_code.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DeleteFleetError:
    ...
    if child_code is not None:
        ...
        out["code"] = capo_ec2.types.delete_fleet_error_code.deserialize_ec2_query(
            child_code
        )
