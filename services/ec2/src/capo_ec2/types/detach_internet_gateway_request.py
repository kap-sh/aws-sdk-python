"""Generated from Smithy shape ``com.amazonaws.ec2#DetachInternetGatewayRequest``."""
...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.internet_gateway_id
    import capo_ec2.types.vpc_id


class DetachInternetGatewayRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DetachInternetGatewayRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DetachInternetGatewayRequest:
    out: DetachInternetGatewayRequest = {}  # type: ignore[typeddict-item]
