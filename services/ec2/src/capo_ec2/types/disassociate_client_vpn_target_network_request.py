...
class DisassociateClientVpnTargetNetworkRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DisassociateClientVpnTargetNetworkRequest,
...
def deserialize_ec2_query(el: Element) -> DisassociateClientVpnTargetNetworkRequest:
    out: DisassociateClientVpnTargetNetworkRequest = {}  # type: ignore[typeddict-item]
