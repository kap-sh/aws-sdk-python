...
class VerifiedAccessEndpoint(TypedDict, closed=True):
    ...
    verified_access_endpoint_id: NotRequired["capo_ec2.types.string.String"]
    ...
    domain_certificate_arn: NotRequired["capo_ec2.types.string.String"]
    """<p>The ARN of a public TLS/SSL certificate imported into or created with ACM.</p>"""
    endpoint_domain: NotRequired["capo_ec2.types.string.String"]
    """<p>A DNS name that is generated for the endpoint.</p>"""
    device_validation_domain: NotRequired["capo_ec2.types.string.String"]
    ...
    network_interface_options: NotRequired[
        "capo_ec2.types.verified_access_endpoint_eni_options.VerifiedAccessEndpointEniOptions"
    ]
    """<p>The options for network-interface type endpoint.</p>"""
    status: NotRequired[
        "capo_ec2.types.verified_access_endpoint_status.VerifiedAccessEndpointStatus"
    ]
    ...
    rds_options: NotRequired[
        "capo_ec2.types.verified_access_endpoint_rds_options.VerifiedAccessEndpointRdsOptions"
    ]
    """<p>The options for an RDS endpoint.</p>"""
    cidr_options: NotRequired[
        "capo_ec2.types.verified_access_endpoint_cidr_options.VerifiedAccessEndpointCidrOptions"
    ]
...
def deserialize_ec2_query(el: Element) -> VerifiedAccessEndpoint:
    ...
    if child_load_balancer_options is not None:
        ...
        out["load_balancer_options"] = (
            capo_ec2.types.verified_access_endpoint_load_balancer_options.deserialize_ec2_query(
    ...
    if child_network_interface_options is not None:
        ...
        out["network_interface_options"] = (
            capo_ec2.types.verified_access_endpoint_eni_options.deserialize_ec2_query(
    ...
    if child_status is not None:
        ...
        out["status"] = (
            capo_ec2.types.verified_access_endpoint_status.deserialize_ec2_query(
                child_status
            )
        )
    ...
    if child_rds_options is not None:
        ...
        out["rds_options"] = (
            capo_ec2.types.verified_access_endpoint_rds_options.deserialize_ec2_query(
                child_rds_options
            )
        )
    ...
    if child_cidr_options is not None:
        ...
        out["cidr_options"] = (
            capo_ec2.types.verified_access_endpoint_cidr_options.deserialize_ec2_query(
                child_cidr_options
            )
        )
    return out
