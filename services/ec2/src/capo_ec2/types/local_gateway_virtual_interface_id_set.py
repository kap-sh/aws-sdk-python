...
def serialize_ec2_query(
    value: LocalGatewayVirtualInterfaceIdSet, pairs: list[tuple[str, str]], prefix: str
) -> None:
    if not value:
        return
...
def deserialize_ec2_query(el: Element) -> LocalGatewayVirtualInterfaceIdSet:
    out: LocalGatewayVirtualInterfaceIdSet = []
