"""Generated from Smithy shape ``com.amazonaws.ec2#EnableSerialConsoleAccessResult``."""
...
class EnableSerialConsoleAccessResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: EnableSerialConsoleAccessResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
