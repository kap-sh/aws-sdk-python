...
class DeleteTransitGatewayPeeringAttachmentResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteTransitGatewayPeeringAttachmentResult,
...
def deserialize_ec2_query(el: Element) -> DeleteTransitGatewayPeeringAttachmentResult:
    out: DeleteTransitGatewayPeeringAttachmentResult = {}  # type: ignore[typeddict-item]
