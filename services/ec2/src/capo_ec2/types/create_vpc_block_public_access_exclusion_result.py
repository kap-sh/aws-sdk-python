...
class CreateVpcBlockPublicAccessExclusionResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CreateVpcBlockPublicAccessExclusionResult,
    ...
    if "vpc_block_public_access_exclusion" in value:
        ...
        capo_ec2.types.vpc_block_public_access_exclusion.serialize_ec2_query(
            ...
            pairs,
            f"{key_prefix}VpcBlockPublicAccessExclusion",
        )


def deserialize_ec2_query(el: Element) -> CreateVpcBlockPublicAccessExclusionResult:
    out: CreateVpcBlockPublicAccessExclusionResult = {}  # type: ignore[typeddict-item]
