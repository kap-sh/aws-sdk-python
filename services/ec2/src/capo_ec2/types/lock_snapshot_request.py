...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.cool_off_period_request_hours
    import capo_ec2.types.lock_mode
    import capo_ec2.types.millisecond_date_time
    import capo_ec2.types.retention_period_request_days
    import capo_ec2.types.snapshot_id


class LockSnapshotRequest(TypedDict, closed=True):
    ...
    lock_mode: NotRequired["capo_ec2.types.lock_mode.LockMode"]
    ...
    lock_duration: NotRequired[
        "capo_ec2.types.retention_period_request_days.RetentionPeriodRequestDays"
    ]
...
def deserialize_ec2_query(el: Element) -> LockSnapshotRequest:
    ...
    if child_lock_mode is not None:
        ...
        out["lock_mode"] = capo_ec2.types.lock_mode.deserialize_ec2_query(
            child_lock_mode
        )
