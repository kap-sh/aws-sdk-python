"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteApplicationStatusCheckResult``."""
...
class DeleteApplicationStatusCheckResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteApplicationStatusCheckResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DeleteApplicationStatusCheckResult:
    out: DeleteApplicationStatusCheckResult = {}  # type: ignore[typeddict-item]
