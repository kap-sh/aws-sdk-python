"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyAccountVpcEncryptionControlResult``."""
...
class ModifyAccountVpcEncryptionControlResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ModifyAccountVpcEncryptionControlResult,
...
def deserialize_ec2_query(el: Element) -> ModifyAccountVpcEncryptionControlResult:
    out: ModifyAccountVpcEncryptionControlResult = {}  # type: ignore[typeddict-item]
