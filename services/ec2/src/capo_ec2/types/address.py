...
class Address(TypedDict, closed=True):
    ...
    network_interface_owner_id: NotRequired["capo_ec2.types.string.String"]
    ...
    service_managed: NotRequired["capo_ec2.types.service_managed.ServiceManaged"]
...
def deserialize_ec2_query(el: Element) -> Address:
    ...
    if child_service_managed is not None:
        ...
        out["service_managed"] = capo_ec2.types.service_managed.deserialize_ec2_query(
