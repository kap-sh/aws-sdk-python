...
class AvailableCapacity(TypedDict, closed=True):
    available_instance_capacity: NotRequired[
        "capo_ec2.types.available_instance_capacity_list.AvailableInstanceCapacityList"
    ]
    ...
    available_v_cpus: NotRequired["capo_ec2.types.integer.Integer"]
