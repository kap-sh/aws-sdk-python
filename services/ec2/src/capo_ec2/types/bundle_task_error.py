...
class BundleTaskError(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: BundleTaskError, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> BundleTaskError:
    out: BundleTaskError = {}  # type: ignore[typeddict-item]
