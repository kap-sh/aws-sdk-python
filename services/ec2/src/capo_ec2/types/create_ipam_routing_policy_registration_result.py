"""Generated from Smithy shape ``com.amazonaws.ec2#CreateIpamRoutingPolicyRegistrationResult``."""
...
class CreateIpamRoutingPolicyRegistrationResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CreateIpamRoutingPolicyRegistrationResult,
...
def deserialize_ec2_query(el: Element) -> CreateIpamRoutingPolicyRegistrationResult:
    out: CreateIpamRoutingPolicyRegistrationResult = {}  # type: ignore[typeddict-item]
