"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteIpamPrefixListResolverRequest``."""
...
class DeleteIpamPrefixListResolverRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteIpamPrefixListResolverRequest,
...
def deserialize_ec2_query(el: Element) -> DeleteIpamPrefixListResolverRequest:
    out: DeleteIpamPrefixListResolverRequest = {}  # type: ignore[typeddict-item]
