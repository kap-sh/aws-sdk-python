...
class DisassociateInstanceEventWindowRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DisassociateInstanceEventWindowRequest,
...
def deserialize_ec2_query(el: Element) -> DisassociateInstanceEventWindowRequest:
    out: DisassociateInstanceEventWindowRequest = {}  # type: ignore[typeddict-item]
    ...
    if child_association_target is not None:
        ...
        out["association_target"] = (
            capo_ec2.types.instance_event_window_disassociation_request.deserialize_ec2_query(
