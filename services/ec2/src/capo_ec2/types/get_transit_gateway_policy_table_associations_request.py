"""Generated from Smithy shape ``com.amazonaws.ec2#GetTransitGatewayPolicyTableAssociationsRequest``."""
...
class GetTransitGatewayPolicyTableAssociationsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetTransitGatewayPolicyTableAssociationsRequest,
...
def deserialize_ec2_query(
    ...
    out: GetTransitGatewayPolicyTableAssociationsRequest = {}  # type: ignore[typeddict-item]
