"""Generated from Smithy shape ``com.amazonaws.ec2#GetIpamRouteProtectionFindingsRequest``."""
...
class GetIpamRouteProtectionFindingsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetIpamRouteProtectionFindingsRequest,
...
def deserialize_ec2_query(el: Element) -> GetIpamRouteProtectionFindingsRequest:
    out: GetIpamRouteProtectionFindingsRequest = {}  # type: ignore[typeddict-item]
