"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteVpcPeeringConnectionRequest``."""
...
class DeleteVpcPeeringConnectionRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteVpcPeeringConnectionRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
    if "dry_run" in value:
...
def deserialize_ec2_query(el: Element) -> DeleteVpcPeeringConnectionRequest:
    out: DeleteVpcPeeringConnectionRequest = {}  # type: ignore[typeddict-item]
