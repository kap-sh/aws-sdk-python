...
class CancelImageLaunchPermissionRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CancelImageLaunchPermissionRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> CancelImageLaunchPermissionRequest:
    out: CancelImageLaunchPermissionRequest = {}  # type: ignore[typeddict-item]
