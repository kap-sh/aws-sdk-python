...
class Ipv4PrefixSpecificationResponse(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: Ipv4PrefixSpecificationResponse, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> Ipv4PrefixSpecificationResponse:
    out: Ipv4PrefixSpecificationResponse = {}  # type: ignore[typeddict-item]
