...
def serialize_ec2_query(
    value: DescribeInstanceTopologyGroupNameSet,
...
def deserialize_ec2_query(el: Element) -> DescribeInstanceTopologyGroupNameSet:
    out: DescribeInstanceTopologyGroupNameSet = []
