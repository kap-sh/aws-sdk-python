...
class ModifyTransitGatewayVpcAttachmentRequest(TypedDict, closed=True):
    ...
    options: NotRequired[
        "capo_ec2.types.modify_transit_gateway_vpc_attachment_request_options.ModifyTransitGatewayVpcAttachmentRequestOptions"
    ]
...
def deserialize_ec2_query(el: Element) -> ModifyTransitGatewayVpcAttachmentRequest:
    ...
    if child_options is not None:
        ...
        out["options"] = (
            capo_ec2.types.modify_transit_gateway_vpc_attachment_request_options.deserialize_ec2_query(
                child_options
            )
        )
