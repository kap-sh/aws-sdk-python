...
class Vpc(TypedDict, closed=True):
    ...
    ipv6_cidr_block_association_set: NotRequired[
        "capo_ec2.types.vpc_ipv6_cidr_block_association_set.VpcIpv6CidrBlockAssociationSet"
    ]
    """<p>Information about the IPv6 CIDR blocks associated with the VPC.</p>"""
    cidr_block_association_set: NotRequired[
        "capo_ec2.types.vpc_cidr_block_association_set.VpcCidrBlockAssociationSet"
    ]
    ...
    state: NotRequired["capo_ec2.types.vpc_state.VpcState"]
...
def deserialize_ec2_query(el: Element) -> Vpc:
    ...
    child_cidr_block_association_set = el.find("cidrBlockAssociationSet")
    if child_cidr_block_association_set is not None:
        import capo_ec2.types.vpc_cidr_block_association_set

        out["cidr_block_association_set"] = (
            capo_ec2.types.vpc_cidr_block_association_set.deserialize_ec2_query(
                child_cidr_block_association_set
            )
        )
