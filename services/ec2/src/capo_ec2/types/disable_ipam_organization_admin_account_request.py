"""Generated from Smithy shape ``com.amazonaws.ec2#DisableIpamOrganizationAdminAccountRequest``."""
...
class DisableIpamOrganizationAdminAccountRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DisableIpamOrganizationAdminAccountRequest,
...
def deserialize_ec2_query(el: Element) -> DisableIpamOrganizationAdminAccountRequest:
    out: DisableIpamOrganizationAdminAccountRequest = {}  # type: ignore[typeddict-item]
