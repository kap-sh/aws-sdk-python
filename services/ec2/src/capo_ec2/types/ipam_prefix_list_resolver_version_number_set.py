...
IpamPrefixListResolverVersionNumberSet: TypeAlias = list["capo_ec2.types.long.Long"]
...
def deserialize_ec2_query(el: Element) -> IpamPrefixListResolverVersionNumberSet:
