...
class ModifyTransitGatewayPrefixListReferenceResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ModifyTransitGatewayPrefixListReferenceResult,
...
def deserialize_ec2_query(el: Element) -> ModifyTransitGatewayPrefixListReferenceResult:
    out: ModifyTransitGatewayPrefixListReferenceResult = {}  # type: ignore[typeddict-item]
