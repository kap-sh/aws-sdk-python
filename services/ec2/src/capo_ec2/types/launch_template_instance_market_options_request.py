...
if TYPE_CHECKING:
    import capo_ec2.types.launch_template_spot_market_options_request
    import capo_ec2.types.market_type


class LaunchTemplateInstanceMarketOptionsRequest(TypedDict, closed=True):
    market_type: NotRequired["capo_ec2.types.market_type.MarketType"]
    """<p>The market type.</p>"""
    spot_options: NotRequired[
        "capo_ec2.types.launch_template_spot_market_options_request.LaunchTemplateSpotMarketOptionsRequest"
    ]
...
def serialize_ec2_query(
    ...
    if "spot_options" in value:
        ...
        capo_ec2.types.launch_template_spot_market_options_request.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> LaunchTemplateInstanceMarketOptionsRequest:
    ...
    if child_spot_options is not None:
        ...
        out["spot_options"] = (
            capo_ec2.types.launch_template_spot_market_options_request.deserialize_ec2_query(
                child_spot_options
            )
        )
    return out
