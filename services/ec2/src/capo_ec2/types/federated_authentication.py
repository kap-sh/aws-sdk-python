...
class FederatedAuthentication(TypedDict, closed=True):
    saml_provider_arn: NotRequired["capo_ec2.types.string.String"]
    """<p>The Amazon Resource Name (ARN) of the IAM SAML identity provider.</p>"""
    self_service_saml_provider_arn: NotRequired["capo_ec2.types.string.String"]
