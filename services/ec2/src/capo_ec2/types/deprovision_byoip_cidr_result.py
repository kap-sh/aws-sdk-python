"""Generated from Smithy shape ``com.amazonaws.ec2#DeprovisionByoipCidrResult``."""
...
class DeprovisionByoipCidrResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeprovisionByoipCidrResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DeprovisionByoipCidrResult:
    out: DeprovisionByoipCidrResult = {}  # type: ignore[typeddict-item]
