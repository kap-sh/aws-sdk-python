...
class GetManagedPrefixListEntriesRequest(TypedDict, closed=True):
    ...
    target_version: NotRequired["capo_ec2.types.long.Long"]
...
def serialize_ec2_query(
    ...
    if "target_version" in value:
        pairs.append((f"{key_prefix}TargetVersion", str(value["target_version"])))
