...
class CreateVpcEncryptionControlRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CreateVpcEncryptionControlRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> CreateVpcEncryptionControlRequest:
    out: CreateVpcEncryptionControlRequest = {}  # type: ignore[typeddict-item]
