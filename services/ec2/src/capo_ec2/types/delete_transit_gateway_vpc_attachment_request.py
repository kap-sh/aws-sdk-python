"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTransitGatewayVpcAttachmentRequest``."""
...
class DeleteTransitGatewayVpcAttachmentRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteTransitGatewayVpcAttachmentRequest,
...
def deserialize_ec2_query(el: Element) -> DeleteTransitGatewayVpcAttachmentRequest:
    out: DeleteTransitGatewayVpcAttachmentRequest = {}  # type: ignore[typeddict-item]
