"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTransitGatewayRouteRequest``."""
...
class DeleteTransitGatewayRouteRequest(TypedDict, closed=True):
...
def deserialize_ec2_query(el: Element) -> DeleteTransitGatewayRouteRequest:
    out: DeleteTransitGatewayRouteRequest = {}  # type: ignore[typeddict-item]
