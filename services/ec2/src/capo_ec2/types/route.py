...
class Route(TypedDict, closed=True):
    ...
    destination_ipv6_cidr_block: NotRequired["capo_ec2.types.string.String"]
    """<p>The IPv6 CIDR block used for the destination match.</p>"""
    destination_prefix_list_id: NotRequired["capo_ec2.types.string.String"]
    """<p>The prefix of the Amazon Web Services service.</p>"""
    egress_only_internet_gateway_id: NotRequired["capo_ec2.types.string.String"]
    ...
    origin: NotRequired["capo_ec2.types.route_origin.RouteOrigin"]
    ...
    state: NotRequired["capo_ec2.types.route_state.RouteState"]
    ...
    core_network_arn: NotRequired["capo_ec2.types.core_network_arn.CoreNetworkArn"]
    """<p>The Amazon Resource Name (ARN) of the core network.</p>"""
    odb_network_arn: NotRequired["capo_ec2.types.odb_network_arn.OdbNetworkArn"]
...
def deserialize_ec2_query(el: Element) -> Route:
    ...
    if child_origin is not None:
        ...
        out["origin"] = capo_ec2.types.route_origin.deserialize_ec2_query(child_origin)
    child_state = el.find("State")
    if child_state is not None:
        import capo_ec2.types.route_state

        out["state"] = capo_ec2.types.route_state.deserialize_ec2_query(child_state)
