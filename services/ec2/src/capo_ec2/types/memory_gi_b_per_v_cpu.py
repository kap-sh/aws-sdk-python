...
class MemoryGiBPerVCpu(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: MemoryGiBPerVCpu, pairs: list[tuple[str, str]], prefix: str
) -> None:
    if "min" in value:
...
def deserialize_ec2_query(el: Element) -> MemoryGiBPerVCpu:
    out: MemoryGiBPerVCpu = {}  # type: ignore[typeddict-item]
