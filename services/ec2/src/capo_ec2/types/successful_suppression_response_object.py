"""Generated from Smithy shape ``com.amazonaws.ec2#SuccessfulSuppressionResponseObject``."""
...
class SuccessfulSuppressionResponseObject(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: SuccessfulSuppressionResponseObject,
...
def deserialize_ec2_query(el: Element) -> SuccessfulSuppressionResponseObject:
    out: SuccessfulSuppressionResponseObject = {}  # type: ignore[typeddict-item]
