...
if TYPE_CHECKING:
    ...
    import capo_ec2.types.dit_max_results
...
class DescribeInstanceTypesRequest(TypedDict, closed=True):
    dry_run: NotRequired["capo_ec2.types.boolean.Boolean"]
    """<p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p>"""
    instance_types: NotRequired[
        "capo_ec2.types.request_instance_type_list.RequestInstanceTypeList"
    ]
    ...
    max_results: NotRequired["capo_ec2.types.dit_max_results.DITMaxResults"]
    ...
    include_unsupported_in_region: NotRequired[
        "capo_ec2.types.include_unsupported_in_region.IncludeUnsupportedInRegion"
    ]
...
def serialize_ec2_query(
    ...
    if "include_unsupported_in_region" in value:
        pairs.append(
            (
                f"{key_prefix}IncludeUnsupportedInRegion",
