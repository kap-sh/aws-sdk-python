"""Generated from Smithy shape ``com.amazonaws.ec2#AssociateCapacityReservationBillingOwnerRequest``."""
...
class AssociateCapacityReservationBillingOwnerRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AssociateCapacityReservationBillingOwnerRequest,
...
def deserialize_ec2_query(
    ...
    out: AssociateCapacityReservationBillingOwnerRequest = {}  # type: ignore[typeddict-item]
