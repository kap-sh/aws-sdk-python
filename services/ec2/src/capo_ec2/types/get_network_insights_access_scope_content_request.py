...
class GetNetworkInsightsAccessScopeContentRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetNetworkInsightsAccessScopeContentRequest,
...
def deserialize_ec2_query(el: Element) -> GetNetworkInsightsAccessScopeContentRequest:
    out: GetNetworkInsightsAccessScopeContentRequest = {}  # type: ignore[typeddict-item]
