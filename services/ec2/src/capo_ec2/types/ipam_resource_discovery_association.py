...
class IpamResourceDiscoveryAssociation(TypedDict, closed=True):
    ...
    ipam_resource_discovery_association_arn: NotRequired["capo_ec2.types.string.String"]
    ...
    resource_discovery_status: NotRequired[
        "capo_ec2.types.ipam_associated_resource_discovery_status.IpamAssociatedResourceDiscoveryStatus"
    ]
    ...
    state: NotRequired[
        "capo_ec2.types.ipam_resource_discovery_association_state.IpamResourceDiscoveryAssociationState"
    ]
...
def deserialize_ec2_query(el: Element) -> IpamResourceDiscoveryAssociation:
    ...
    if child_resource_discovery_status is not None:
        ...
        out["resource_discovery_status"] = (
            capo_ec2.types.ipam_associated_resource_discovery_status.deserialize_ec2_query(
    ...
    if child_state is not None:
        ...
        out["state"] = (
            capo_ec2.types.ipam_resource_discovery_association_state.deserialize_ec2_query(
                child_state
            )
        )
