"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTransitGatewayPolicyTableEntryResult``."""
...
class DeleteTransitGatewayPolicyTableEntryResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteTransitGatewayPolicyTableEntryResult,
...
def deserialize_ec2_query(el: Element) -> DeleteTransitGatewayPolicyTableEntryResult:
    out: DeleteTransitGatewayPolicyTableEntryResult = {}  # type: ignore[typeddict-item]
