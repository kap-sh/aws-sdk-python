...
def serialize_ec2_query(
    ...
    if "ipv6_cidr_block_set" in value:
        ...
        aws_sdk_ec2.types.ipv6_cidr_block_set.serialize_ec2_query(
            value["ipv6_cidr_block_set"], pairs, f"{prefix}.Ipv6CidrBlockSet"
        )
    if "cidr_block_set" in value:
        import aws_sdk_ec2.types.cidr_block_set

        aws_sdk_ec2.types.cidr_block_set.serialize_ec2_query(
    ...
    if "peering_options" in value:
        ...
        aws_sdk_ec2.types.vpc_peering_connection_options_description.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> VpcPeeringConnectionVpcInfo:
    ...
    if el.find("Ipv6CidrBlockSet") is not None:
        ...
        out["ipv6_cidr_block_set"] = (
            aws_sdk_ec2.types.ipv6_cidr_block_set.deserialize_ec2_query(
                el, "Ipv6CidrBlockSet"
            )
        )
    if el.find("CidrBlockSet") is not None:
        ...
        out["cidr_block_set"] = aws_sdk_ec2.types.cidr_block_set.deserialize_ec2_query(
            el, "CidrBlockSet"
        )
    ...
    if child_peering_options is not None:
        ...
        out["peering_options"] = (
            aws_sdk_ec2.types.vpc_peering_connection_options_description.deserialize_ec2_query(
