"""Generated from Smithy shape ``com.amazonaws.ec2#DefaultInstanceMetadataEndpointState``."""
...
def serialize_ec2_query(
    value: DefaultInstanceMetadataEndpointState,
...
def deserialize_ec2_query(el: Element) -> DefaultInstanceMetadataEndpointState:
