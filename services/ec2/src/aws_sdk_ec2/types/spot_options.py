"""Generated from Smithy shape ``com.amazonaws.ec2#SpotOptions``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_ec2.types.fleet_spot_maintenance_strategies
...
class SpotOptions(TypedDict, closed=True):
    ...
    maintenance_strategies: NotRequired[
        "aws_sdk_ec2.types.fleet_spot_maintenance_strategies.FleetSpotMaintenanceStrategies"
    ]
...
def serialize_ec2_query(
    ...
    if "maintenance_strategies" in value:
        ...
        aws_sdk_ec2.types.fleet_spot_maintenance_strategies.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> SpotOptions:
    ...
    if child_maintenance_strategies is not None:
        ...
        out["maintenance_strategies"] = (
            aws_sdk_ec2.types.fleet_spot_maintenance_strategies.deserialize_ec2_query(
