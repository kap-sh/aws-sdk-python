...
def serialize_ec2_query(
    ...
    if "local_gateway_virtual_interface_group_ids" in value:
        ...
        aws_sdk_ec2.types.local_gateway_virtual_interface_group_id_set.serialize_ec2_query(
            value["local_gateway_virtual_interface_group_ids"],
            pairs,
            f"{prefix}.LocalGatewayVirtualInterfaceGroupIds",
        )
    if "filters" in value:
        import aws_sdk_ec2.types.filter_list
...
def deserialize_ec2_query(
    ...
    if el.find("LocalGatewayVirtualInterfaceGroupIds") is not None:
        ...
        out["local_gateway_virtual_interface_group_ids"] = (
            aws_sdk_ec2.types.local_gateway_virtual_interface_group_id_set.deserialize_ec2_query(
