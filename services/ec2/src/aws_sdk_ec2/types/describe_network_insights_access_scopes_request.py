...
class DescribeNetworkInsightsAccessScopesRequest(TypedDict):
    network_insights_access_scope_ids: NotRequired[
        "aws_sdk_ec2.types.network_insights_access_scope_id_list.NetworkInsightsAccessScopeIdList"
    ]
...
def serialize_ec2_query(
    ...
    if "network_insights_access_scope_ids" in value:
        ...
        aws_sdk_ec2.types.network_insights_access_scope_id_list.serialize_ec2_query(
            value["network_insights_access_scope_ids"],
            pairs,
            f"{prefix}.NetworkInsightsAccessScopeIds",
        )
    if "filters" in value:
        import aws_sdk_ec2.types.filter_list
...
def deserialize_ec2_query(el: Element) -> DescribeNetworkInsightsAccessScopesRequest:
    ...
    if el.find("NetworkInsightsAccessScopeIds") is not None:
        ...
        out["network_insights_access_scope_ids"] = (
            aws_sdk_ec2.types.network_insights_access_scope_id_list.deserialize_ec2_query(
