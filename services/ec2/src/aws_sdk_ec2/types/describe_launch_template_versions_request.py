...
class DescribeLaunchTemplateVersionsRequest(TypedDict):
    ...
    min_version: NotRequired["aws_sdk_ec2.types.string.String"]
    """<p>The version number after which to describe launch template versions.</p>"""
    max_version: NotRequired["aws_sdk_ec2.types.string.String"]
