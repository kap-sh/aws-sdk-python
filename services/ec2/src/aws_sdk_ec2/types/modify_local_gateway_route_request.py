...
class ModifyLocalGatewayRouteRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ModifyLocalGatewayRouteRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> ModifyLocalGatewayRouteRequest:
    out: ModifyLocalGatewayRouteRequest = {}  # type: ignore[typeddict-item]
