"""Generated from Smithy shape ``com.amazonaws.ec2#AttachmentEnaSrdUdpSpecification``."""
...
class AttachmentEnaSrdUdpSpecification(TypedDict, closed=True):
...
def deserialize_ec2_query(el: Element) -> AttachmentEnaSrdUdpSpecification:
    out: AttachmentEnaSrdUdpSpecification = {}  # type: ignore[typeddict-item]
