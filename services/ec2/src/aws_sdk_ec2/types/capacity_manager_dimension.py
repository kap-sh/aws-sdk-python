...
def serialize_ec2_query(
    ...
    if "reservation_type" in value:
        ...
        aws_sdk_ec2.types.reservation_type.serialize_ec2_query(
    ...
    if "reservation_end_date_type" in value:
        ...
        aws_sdk_ec2.types.reservation_end_date_type.serialize_ec2_query(
    ...
    if "tenancy" in value:
        ...
        aws_sdk_ec2.types.capacity_tenancy.serialize_ec2_query(
            value["tenancy"], pairs, f"{prefix}.Tenancy"
        )
    if "reservation_state" in value:
        import aws_sdk_ec2.types.reservation_state

        aws_sdk_ec2.types.reservation_state.serialize_ec2_query(
    ...
    if "tags" in value:
        ...
        aws_sdk_ec2.types.capacity_manager_tag_dimension_set.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> CapacityManagerDimension:
    ...
    if child_reservation_type is not None:
        ...
        out["reservation_type"] = (
            aws_sdk_ec2.types.reservation_type.deserialize_ec2_query(
    ...
    if child_reservation_end_date_type is not None:
        ...
        out["reservation_end_date_type"] = (
            aws_sdk_ec2.types.reservation_end_date_type.deserialize_ec2_query(
    ...
    if child_tenancy is not None:
        ...
        out["tenancy"] = aws_sdk_ec2.types.capacity_tenancy.deserialize_ec2_query(
            child_tenancy
        )
    ...
    if child_reservation_state is not None:
        ...
        out["reservation_state"] = (
            aws_sdk_ec2.types.reservation_state.deserialize_ec2_query(
    ...
    if el.find("TagSet") is not None:
        ...
        out["tags"] = (
            aws_sdk_ec2.types.capacity_manager_tag_dimension_set.deserialize_ec2_query(
                el, "TagSet"
            )
        )
    return out
