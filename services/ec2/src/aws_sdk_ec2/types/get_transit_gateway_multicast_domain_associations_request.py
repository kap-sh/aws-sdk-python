"""Generated from Smithy shape ``com.amazonaws.ec2#GetTransitGatewayMulticastDomainAssociationsRequest``."""
...
class GetTransitGatewayMulticastDomainAssociationsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetTransitGatewayMulticastDomainAssociationsRequest,
...
def deserialize_ec2_query(
    ...
    out: GetTransitGatewayMulticastDomainAssociationsRequest = {}  # type: ignore[typeddict-item]
