...
def serialize_ec2_query(
    ...
    if "local_gateway_route_table_vpc_association_ids" in value:
        ...
        aws_sdk_ec2.types.local_gateway_route_table_vpc_association_id_set.serialize_ec2_query(
...
def deserialize_ec2_query(
    ...
    if el.find("LocalGatewayRouteTableVpcAssociationIds") is not None:
        ...
        out["local_gateway_route_table_vpc_association_ids"] = (
            aws_sdk_ec2.types.local_gateway_route_table_vpc_association_id_set.deserialize_ec2_query(
