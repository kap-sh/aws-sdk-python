"""Generated from Smithy shape ``com.amazonaws.ec2#GetTransitGatewayRouteTablePropagationsRequest``."""
...
class GetTransitGatewayRouteTablePropagationsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetTransitGatewayRouteTablePropagationsRequest,
...
def deserialize_ec2_query(
    ...
    out: GetTransitGatewayRouteTablePropagationsRequest = {}  # type: ignore[typeddict-item]
