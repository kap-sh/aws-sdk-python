...
class LaunchTemplateInstanceMetadataOptionsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: LaunchTemplateInstanceMetadataOptionsRequest,
...
def deserialize_ec2_query(el: Element) -> LaunchTemplateInstanceMetadataOptionsRequest:
    out: LaunchTemplateInstanceMetadataOptionsRequest = {}  # type: ignore[typeddict-item]
