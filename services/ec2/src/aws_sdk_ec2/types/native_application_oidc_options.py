...
class NativeApplicationOidcOptions(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: NativeApplicationOidcOptions, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> NativeApplicationOidcOptions:
    out: NativeApplicationOidcOptions = {}  # type: ignore[typeddict-item]
