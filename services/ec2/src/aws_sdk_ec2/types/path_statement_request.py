...
def serialize_ec2_query(
    ...
    if "packet_header_statement" in value:
        ...
        aws_sdk_ec2.types.packet_header_statement_request.serialize_ec2_query(
            value["packet_header_statement"], pairs, f"{prefix}.PacketHeaderStatement"
        )
    if "resource_statement" in value:
        import aws_sdk_ec2.types.resource_statement_request

        aws_sdk_ec2.types.resource_statement_request.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> PathStatementRequest:
    ...
    if child_packet_header_statement is not None:
        ...
        out["packet_header_statement"] = (
            aws_sdk_ec2.types.packet_header_statement_request.deserialize_ec2_query(
    ...
    if child_resource_statement is not None:
        ...
        out["resource_statement"] = (
            aws_sdk_ec2.types.resource_statement_request.deserialize_ec2_query(
