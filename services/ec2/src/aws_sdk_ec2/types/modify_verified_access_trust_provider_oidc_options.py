...
class ModifyVerifiedAccessTrustProviderOidcOptions(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ModifyVerifiedAccessTrustProviderOidcOptions,
...
def deserialize_ec2_query(el: Element) -> ModifyVerifiedAccessTrustProviderOidcOptions:
    out: ModifyVerifiedAccessTrustProviderOidcOptions = {}  # type: ignore[typeddict-item]
