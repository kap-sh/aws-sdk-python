"""Generated from Smithy shape ``com.amazonaws.ec2#AcceptCapacityReservationBillingOwnershipRequest``."""
...
class AcceptCapacityReservationBillingOwnershipRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AcceptCapacityReservationBillingOwnershipRequest,
...
def deserialize_ec2_query(
    ...
    out: AcceptCapacityReservationBillingOwnershipRequest = {}  # type: ignore[typeddict-item]
