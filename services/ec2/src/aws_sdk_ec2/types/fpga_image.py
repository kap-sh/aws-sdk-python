...
def serialize_ec2_query(
    ...
    if "pci_id" in value:
        ...
        aws_sdk_ec2.types.pci_id.serialize_ec2_query(
            value["pci_id"], pairs, f"{prefix}.PciId"
        )
    if "state" in value:
        import aws_sdk_ec2.types.fpga_image_state

        aws_sdk_ec2.types.fpga_image_state.serialize_ec2_query(
    ...
    if "instance_types" in value:
        ...
        aws_sdk_ec2.types.instance_types_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> FpgaImage:
    ...
    if child_pci_id is not None:
        ...
        out["pci_id"] = aws_sdk_ec2.types.pci_id.deserialize_ec2_query(child_pci_id)
    child_state = el.find("State")
    if child_state is not None:
        import aws_sdk_ec2.types.fpga_image_state

        out["state"] = aws_sdk_ec2.types.fpga_image_state.deserialize_ec2_query(
            child_state
        )
    ...
    if el.find("InstanceTypes") is not None:
        ...
        out["instance_types"] = (
            aws_sdk_ec2.types.instance_types_list.deserialize_ec2_query(
                el, "InstanceTypes"
            )
        )
    return out
