...
def serialize_ec2_query(
    ...
    if "vpcs" in value:
        ...
        aws_sdk_ec2.types.classic_link_dns_support_list.serialize_ec2_query(
            value["vpcs"], pairs, f"{prefix}.Vpcs"
        )
...
def deserialize_ec2_query(el: Element) -> DescribeVpcClassicLinkDnsSupportResult:
    ...
    if el.find("Vpcs") is not None:
        ...
        out["vpcs"] = (
            aws_sdk_ec2.types.classic_link_dns_support_list.deserialize_ec2_query(
                el, "Vpcs"
            )
        )
    return out
