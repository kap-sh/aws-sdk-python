...
class SubnetCidrBlockState(TypedDict, closed=True):
    state: NotRequired[
...
def serialize_ec2_query(
    ...
    if "state" in value:
        ...
        aws_sdk_ec2.types.subnet_cidr_block_state_code.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> SubnetCidrBlockState:
    ...
    if child_state is not None:
        ...
        out["state"] = (
            aws_sdk_ec2.types.subnet_cidr_block_state_code.deserialize_ec2_query(
                child_state
            )
        )
