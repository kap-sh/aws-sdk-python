...
class DescribeRouteServerPeersRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DescribeRouteServerPeersRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
    if "route_server_peer_ids" in value:
        import aws_sdk_ec2.types.route_server_peer_ids_list

        aws_sdk_ec2.types.route_server_peer_ids_list.serialize_ec2_query(
            value["route_server_peer_ids"], pairs, f"{prefix}.RouteServerPeerIds"
        )
...
def deserialize_ec2_query(el: Element) -> DescribeRouteServerPeersRequest:
    ...
    if el.find("RouteServerPeerIds") is not None:
        import aws_sdk_ec2.types.route_server_peer_ids_list

        out["route_server_peer_ids"] = (
            aws_sdk_ec2.types.route_server_peer_ids_list.deserialize_ec2_query(
                el, "RouteServerPeerIds"
            )
        )
