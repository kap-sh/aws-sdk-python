...
def serialize_ec2_query(
    ...
    if "meta_data" in value:
        ...
        aws_sdk_ec2.types.transit_gateway_policy_rule_meta_data.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> TransitGatewayPolicyRule:
    ...
    if child_meta_data is not None:
        ...
        out["meta_data"] = (
            aws_sdk_ec2.types.transit_gateway_policy_rule_meta_data.deserialize_ec2_query(
                child_meta_data
            )
        )
    return out
