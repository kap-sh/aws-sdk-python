...
def serialize_ec2_query(
    value: CancelDeclarativePoliciesReportResult,
...
def deserialize_ec2_query(el: Element) -> CancelDeclarativePoliciesReportResult:
    out: CancelDeclarativePoliciesReportResult = {}  # type: ignore[typeddict-item]
