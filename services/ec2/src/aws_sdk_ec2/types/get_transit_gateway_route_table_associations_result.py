...
def serialize_ec2_query(
    ...
    if "associations" in value:
        ...
        aws_sdk_ec2.types.transit_gateway_route_table_association_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> GetTransitGatewayRouteTableAssociationsResult:
    ...
    if el.find("Associations") is not None:
        ...
        out["associations"] = (
            aws_sdk_ec2.types.transit_gateway_route_table_association_list.deserialize_ec2_query(
                el, "Associations"
            )
        )
