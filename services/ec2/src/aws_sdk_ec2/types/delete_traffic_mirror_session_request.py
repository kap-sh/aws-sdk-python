"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTrafficMirrorSessionRequest``."""
...
class DeleteTrafficMirrorSessionRequest(TypedDict, closed=True):
...
def deserialize_ec2_query(el: Element) -> DeleteTrafficMirrorSessionRequest:
    out: DeleteTrafficMirrorSessionRequest = {}  # type: ignore[typeddict-item]
