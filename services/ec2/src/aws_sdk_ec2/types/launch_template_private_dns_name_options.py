...
class LaunchTemplatePrivateDnsNameOptions(TypedDict, closed=True):
...
def deserialize_ec2_query(el: Element) -> LaunchTemplatePrivateDnsNameOptions:
    out: LaunchTemplatePrivateDnsNameOptions = {}  # type: ignore[typeddict-item]
