...
class CreateTransitGatewayRouteRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CreateTransitGatewayRouteRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> CreateTransitGatewayRouteRequest:
    out: CreateTransitGatewayRouteRequest = {}  # type: ignore[typeddict-item]
