...
def serialize_ec2_query(
    ...
    if "classic_load_balancer_listener" in value:
        ...
        aws_sdk_ec2.types.analysis_load_balancer_listener.serialize_ec2_query(
    ...
    if "load_balancer_target" in value:
        ...
        aws_sdk_ec2.types.analysis_load_balancer_target.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> Explanation:
    ...
    if child_acl is not None:
        ...
        out["acl"] = aws_sdk_ec2.types.analysis_component.deserialize_ec2_query(
            child_acl
        )
    ...
    if el.find("AddressSet") is not None:
        ...
        out["addresses"] = aws_sdk_ec2.types.ip_address_list.deserialize_ec2_query(
            el, "AddressSet"
        )
    ...
    if child_destination is not None:
        ...
        out["destination"] = aws_sdk_ec2.types.analysis_component.deserialize_ec2_query(
            child_destination
        )
    ...
    if child_classic_load_balancer_listener is not None:
        ...
        out["classic_load_balancer_listener"] = (
            aws_sdk_ec2.types.analysis_load_balancer_listener.deserialize_ec2_query(
    ...
    if child_load_balancer_target is not None:
        ...
        out["load_balancer_target"] = (
            aws_sdk_ec2.types.analysis_load_balancer_target.deserialize_ec2_query(
    ...
    if child_nat_gateway is not None:
        ...
        out["nat_gateway"] = aws_sdk_ec2.types.analysis_component.deserialize_ec2_query(
            child_nat_gateway
        )
    ...
    if el.find("PortRangeSet") is not None:
        ...
        out["port_ranges"] = aws_sdk_ec2.types.port_range_list.deserialize_ec2_query(
            el, "PortRangeSet"
        )
    ...
    if child_prefix_list is not None:
        ...
        out["prefix_list"] = aws_sdk_ec2.types.analysis_component.deserialize_ec2_query(
            child_prefix_list
        )
    if el.find("ProtocolSet") is not None:
        import aws_sdk_ec2.types.string_list

        out["protocols"] = aws_sdk_ec2.types.string_list.deserialize_ec2_query(
            el, "ProtocolSet"
        )
    ...
    if child_route_table is not None:
        ...
        out["route_table"] = aws_sdk_ec2.types.analysis_component.deserialize_ec2_query(
            child_route_table
        )
    ...
    if child_vpn_gateway is not None:
        ...
        out["vpn_gateway"] = aws_sdk_ec2.types.analysis_component.deserialize_ec2_query(
            child_vpn_gateway
        )
