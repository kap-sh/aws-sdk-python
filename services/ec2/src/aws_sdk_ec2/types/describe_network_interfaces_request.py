...
class DescribeNetworkInterfacesRequest(TypedDict):
    ...
    network_interface_ids: NotRequired[
        "aws_sdk_ec2.types.network_interface_id_list.NetworkInterfaceIdList"
    ]
...
def serialize_ec2_query(
    ...
    if "network_interface_ids" in value:
        ...
        aws_sdk_ec2.types.network_interface_id_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DescribeNetworkInterfacesRequest:
    ...
    if el.find("NetworkInterfaceIds") is not None:
        ...
        out["network_interface_ids"] = (
            aws_sdk_ec2.types.network_interface_id_list.deserialize_ec2_query(
