...
def serialize_ec2_query(
    ...
    if "local_gateway_route_table_virtual_interface_group_association_ids" in value:
        ...
        aws_sdk_ec2.types.local_gateway_route_table_virtual_interface_group_association_id_set.serialize_ec2_query(
            value["local_gateway_route_table_virtual_interface_group_association_ids"],
            pairs,
            f"{prefix}.LocalGatewayRouteTableVirtualInterfaceGroupAssociationIds",
        )
    if "filters" in value:
        import aws_sdk_ec2.types.filter_list
...
def deserialize_ec2_query(
    ...
    if el.find("LocalGatewayRouteTableVirtualInterfaceGroupAssociationIds") is not None:
        import aws_sdk_ec2.types.local_gateway_route_table_virtual_interface_group_association_id_set

        out["local_gateway_route_table_virtual_interface_group_association_ids"] = (
            aws_sdk_ec2.types.local_gateway_route_table_virtual_interface_group_association_id_set.deserialize_ec2_query(
                el, "LocalGatewayRouteTableVirtualInterfaceGroupAssociationIds"
            )
        )
