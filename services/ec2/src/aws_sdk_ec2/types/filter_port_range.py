"""Generated from Smithy shape ``com.amazonaws.ec2#FilterPortRange``."""
...
class FilterPortRange(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: FilterPortRange, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> FilterPortRange:
    out: FilterPortRange = {}  # type: ignore[typeddict-item]
