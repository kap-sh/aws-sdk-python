...
class InstanceRequirementsRequest(TypedDict):
    ...
    memory_mi_b: NotRequired["aws_sdk_ec2.types.memory_mi_b_request.MemoryMiBRequest"]
    ...
    memory_gi_b_per_v_cpu: NotRequired[
        "aws_sdk_ec2.types.memory_gi_b_per_v_cpu_request.MemoryGiBPerVCpuRequest"
    ]
    ...
    network_interface_count: NotRequired[
        "aws_sdk_ec2.types.network_interface_count_request.NetworkInterfaceCountRequest"
    ]
    ...
    total_local_storage_gb: NotRequired[
        "aws_sdk_ec2.types.total_local_storage_gb_request.TotalLocalStorageGBRequest"
    ]
    ...
    baseline_ebs_bandwidth_mbps: NotRequired[
        "aws_sdk_ec2.types.baseline_ebs_bandwidth_mbps_request.BaselineEbsBandwidthMbpsRequest"
    ]
    ...
    accelerator_count: NotRequired[
        "aws_sdk_ec2.types.accelerator_count_request.AcceleratorCountRequest"
    ]
    ...
    accelerator_total_memory_mi_b: NotRequired[
        "aws_sdk_ec2.types.accelerator_total_memory_mi_b_request.AcceleratorTotalMemoryMiBRequest"
    ]
    ...
    network_bandwidth_gbps: NotRequired[
        "aws_sdk_ec2.types.network_bandwidth_gbps_request.NetworkBandwidthGbpsRequest"
    ]
    r"""<p>The minimum and maximum amount of baseline network bandwidth, in gigabits per second (Gbps). For more information, see <a href=\"https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-network-bandwidth.html\">Amazon EC2 instance network bandwidth</a> in the <i>Amazon EC2 User Guide</i>.</p> <p>Default: No minimum or maximum limits</p>"""
    ...
    baseline_performance_factors: NotRequired[
        "aws_sdk_ec2.types.baseline_performance_factors_request.BaselinePerformanceFactorsRequest"
    ]
