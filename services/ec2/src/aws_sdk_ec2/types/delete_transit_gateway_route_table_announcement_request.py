...
class DeleteTransitGatewayRouteTableAnnouncementRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteTransitGatewayRouteTableAnnouncementRequest,
...
def deserialize_ec2_query(
    ...
    out: DeleteTransitGatewayRouteTableAnnouncementRequest = {}  # type: ignore[typeddict-item]
