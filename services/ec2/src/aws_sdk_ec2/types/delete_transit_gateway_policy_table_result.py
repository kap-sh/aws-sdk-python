...
class DeleteTransitGatewayPolicyTableResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteTransitGatewayPolicyTableResult,
...
def deserialize_ec2_query(el: Element) -> DeleteTransitGatewayPolicyTableResult:
    out: DeleteTransitGatewayPolicyTableResult = {}  # type: ignore[typeddict-item]
