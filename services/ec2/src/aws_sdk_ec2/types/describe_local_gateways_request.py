...
class DescribeLocalGatewaysRequest(TypedDict):
    local_gateway_ids: NotRequired[
        "aws_sdk_ec2.types.local_gateway_id_set.LocalGatewayIdSet"
    ]
...
def serialize_ec2_query(
    ...
    if "local_gateway_ids" in value:
        ...
        aws_sdk_ec2.types.local_gateway_id_set.serialize_ec2_query(
            value["local_gateway_ids"], pairs, f"{prefix}.LocalGatewayIds"
        )
    if "filters" in value:
        import aws_sdk_ec2.types.filter_list
...
def deserialize_ec2_query(el: Element) -> DescribeLocalGatewaysRequest:
    ...
    if el.find("LocalGatewayIds") is not None:
        import aws_sdk_ec2.types.local_gateway_id_set

        out["local_gateway_ids"] = (
            aws_sdk_ec2.types.local_gateway_id_set.deserialize_ec2_query(
                el, "LocalGatewayIds"
            )
        )
