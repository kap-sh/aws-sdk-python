...
class GetCapacityReservationUsageRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetCapacityReservationUsageRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> GetCapacityReservationUsageRequest:
    out: GetCapacityReservationUsageRequest = {}  # type: ignore[typeddict-item]
