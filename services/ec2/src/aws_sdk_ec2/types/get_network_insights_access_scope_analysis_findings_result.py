...
def serialize_ec2_query(
    ...
    if "analysis_findings" in value:
        ...
        aws_sdk_ec2.types.access_scope_analysis_finding_list.serialize_ec2_query(
...
def deserialize_ec2_query(
    ...
    if child_analysis_status is not None:
        ...
        out["analysis_status"] = (
            aws_sdk_ec2.types.analysis_status.deserialize_ec2_query(
    ...
    if el.find("AnalysisFindingSet") is not None:
        ...
        out["analysis_findings"] = (
            aws_sdk_ec2.types.access_scope_analysis_finding_list.deserialize_ec2_query(
