...
def serialize_ec2_query(
    ...
    if "mac_modification_task_ids" in value:
        ...
        aws_sdk_ec2.types.mac_modification_task_id_list.serialize_ec2_query(
            value["mac_modification_task_ids"],
            pairs,
            f"{prefix}.MacModificationTaskIds",
        )
...
def deserialize_ec2_query(el: Element) -> DescribeMacModificationTasksRequest:
    ...
    if el.find("MacModificationTaskIds") is not None:
        ...
        out["mac_modification_task_ids"] = (
            aws_sdk_ec2.types.mac_modification_task_id_list.deserialize_ec2_query(
