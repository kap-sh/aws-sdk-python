...
def serialize_ec2_query(
    ...
    if "modification_state" in value:
        ...
        aws_sdk_ec2.types.volume_modification_state.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> VolumeModification:
    ...
    if child_modification_state is not None:
        ...
        out["modification_state"] = (
            aws_sdk_ec2.types.volume_modification_state.deserialize_ec2_query(
    ...
    if child_target_volume_type is not None:
        ...
        out["target_volume_type"] = aws_sdk_ec2.types.volume_type.deserialize_ec2_query(
    ...
    if child_original_volume_type is not None:
        ...
        out["original_volume_type"] = (
            aws_sdk_ec2.types.volume_type.deserialize_ec2_query(
