...
def serialize_ec2_query(
    ...
    if "code" in value:
        ...
        aws_sdk_ec2.types.delete_queued_reserved_instances_error_code.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DeleteQueuedReservedInstancesError:
    ...
    if child_code is not None:
        ...
        out["code"] = (
            aws_sdk_ec2.types.delete_queued_reserved_instances_error_code.deserialize_ec2_query(
                child_code
            )
        )
