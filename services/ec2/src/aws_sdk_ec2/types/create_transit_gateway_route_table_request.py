"""Generated from Smithy shape ``com.amazonaws.ec2#CreateTransitGatewayRouteTableRequest``."""
...
class CreateTransitGatewayRouteTableRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CreateTransitGatewayRouteTableRequest,
...
def deserialize_ec2_query(el: Element) -> CreateTransitGatewayRouteTableRequest:
    out: CreateTransitGatewayRouteTableRequest = {}  # type: ignore[typeddict-item]
