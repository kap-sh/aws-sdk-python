...
class DescribeImportImageTasksRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DescribeImportImageTasksRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
    if "dry_run" in value:
    ...
    if "import_task_ids" in value:
        ...
        aws_sdk_ec2.types.import_task_id_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DescribeImportImageTasksRequest:
    out: DescribeImportImageTasksRequest = {}  # type: ignore[typeddict-item]
    ...
    if el.find("ImportTaskIds") is not None:
        ...
        out["import_task_ids"] = (
            aws_sdk_ec2.types.import_task_id_list.deserialize_ec2_query(
                el, "ImportTaskIds"
            )
        )
