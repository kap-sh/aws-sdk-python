...
def serialize_ec2_query(
    ...
    if "block_device_mappings" in value:
        ...
        aws_sdk_ec2.types.instance_block_device_mapping_specification_list.serialize_ec2_query(
    ...
    if "user_data" in value:
        ...
        aws_sdk_ec2.types.blob_attribute_value.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> ModifyInstanceAttributeRequest:
    ...
    if el.find("BlockDeviceMapping") is not None:
        ...
        out["block_device_mappings"] = (
            aws_sdk_ec2.types.instance_block_device_mapping_specification_list.deserialize_ec2_query(
    ...
    if child_kernel is not None:
        ...
        out["kernel"] = aws_sdk_ec2.types.attribute_value.deserialize_ec2_query(
            child_kernel
        )
    ...
    if child_ramdisk is not None:
        ...
        out["ramdisk"] = aws_sdk_ec2.types.attribute_value.deserialize_ec2_query(
            child_ramdisk
        )
    ...
    if child_user_data is not None:
        ...
        out["user_data"] = aws_sdk_ec2.types.blob_attribute_value.deserialize_ec2_query(
            child_user_data
        )
