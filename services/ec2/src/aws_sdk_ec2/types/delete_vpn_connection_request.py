"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteVpnConnectionRequest``."""
...
class DeleteVpnConnectionRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteVpnConnectionRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DeleteVpnConnectionRequest:
    out: DeleteVpnConnectionRequest = {}  # type: ignore[typeddict-item]
