...
VpnConcentratorList: TypeAlias = list[
    "aws_sdk_ec2.types.vpn_concentrator.VpnConcentrator"
]
...
def deserialize_ec2_query(parent: Element, tag: str) -> VpnConcentratorList:
    ...
    for child in parent.findall(tag):
        out.append(aws_sdk_ec2.types.vpn_concentrator.deserialize_ec2_query(child))
    return out
