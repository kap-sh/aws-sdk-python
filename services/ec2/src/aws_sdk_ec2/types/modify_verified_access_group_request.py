"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyVerifiedAccessGroupRequest``."""
...
class ModifyVerifiedAccessGroupRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ModifyVerifiedAccessGroupRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> ModifyVerifiedAccessGroupRequest:
    out: ModifyVerifiedAccessGroupRequest = {}  # type: ignore[typeddict-item]
