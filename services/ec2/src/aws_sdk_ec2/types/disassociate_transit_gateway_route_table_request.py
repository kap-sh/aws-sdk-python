"""Generated from Smithy shape ``com.amazonaws.ec2#DisassociateTransitGatewayRouteTableRequest``."""
...
class DisassociateTransitGatewayRouteTableRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DisassociateTransitGatewayRouteTableRequest,
...
def deserialize_ec2_query(el: Element) -> DisassociateTransitGatewayRouteTableRequest:
    out: DisassociateTransitGatewayRouteTableRequest = {}  # type: ignore[typeddict-item]
