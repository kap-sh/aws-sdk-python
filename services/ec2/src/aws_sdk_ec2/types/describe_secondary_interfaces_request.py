...
class DescribeSecondaryInterfacesRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DescribeSecondaryInterfacesRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
    if "dry_run" in value:
    ...
    if "secondary_interface_ids" in value:
        import aws_sdk_ec2.types.secondary_interface_id_list

        aws_sdk_ec2.types.secondary_interface_id_list.serialize_ec2_query(
            value["secondary_interface_ids"], pairs, f"{prefix}.SecondaryInterfaceIds"
        )


def deserialize_ec2_query(el: Element) -> DescribeSecondaryInterfacesRequest:
    out: DescribeSecondaryInterfacesRequest = {}  # type: ignore[typeddict-item]
    ...
    if el.find("SecondaryInterfaceIds") is not None:
        import aws_sdk_ec2.types.secondary_interface_id_list

        out["secondary_interface_ids"] = (
            aws_sdk_ec2.types.secondary_interface_id_list.deserialize_ec2_query(
                el, "SecondaryInterfaceIds"
            )
        )
    return out
