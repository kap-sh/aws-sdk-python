"""Generated from Smithy shape ``com.amazonaws.ec2#ConnectionTrackingConfiguration``."""
...
class ConnectionTrackingConfiguration(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ConnectionTrackingConfiguration, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> ConnectionTrackingConfiguration:
    out: ConnectionTrackingConfiguration = {}  # type: ignore[typeddict-item]
