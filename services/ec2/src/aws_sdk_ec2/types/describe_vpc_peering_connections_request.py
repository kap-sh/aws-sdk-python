"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeVpcPeeringConnectionsRequest``."""
...
class DescribeVpcPeeringConnectionsRequest(TypedDict, closed=True):
    next_token: NotRequired["aws_sdk_ec2.types.string.String"]
    """<p>The token returned from a previous paginated request. Pagination continues from the end of the items returned by the previous request.</p>"""
    max_results: NotRequired[
        "aws_sdk_ec2.types.describe_vpc_peering_connections_max_results.DescribeVpcPeeringConnectionsMaxResults"
    ]
...
def serialize_ec2_query(
    ...
    if "vpc_peering_connection_ids" in value:
        import aws_sdk_ec2.types.vpc_peering_connection_id_list

        aws_sdk_ec2.types.vpc_peering_connection_id_list.serialize_ec2_query(
            value["vpc_peering_connection_ids"],
            pairs,
            f"{prefix}.VpcPeeringConnectionIds",
        )
    if "filters" in value:
        import aws_sdk_ec2.types.filter_list
...
def deserialize_ec2_query(el: Element) -> DescribeVpcPeeringConnectionsRequest:
    out: DescribeVpcPeeringConnectionsRequest = {}  # type: ignore[typeddict-item]
    ...
    if el.find("VpcPeeringConnectionIds") is not None:
        ...
        out["vpc_peering_connection_ids"] = (
            aws_sdk_ec2.types.vpc_peering_connection_id_list.deserialize_ec2_query(
