...
class DescribeClientVpnRoutesRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DescribeClientVpnRoutesRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DescribeClientVpnRoutesRequest:
    out: DescribeClientVpnRoutesRequest = {}  # type: ignore[typeddict-item]
