...
def serialize_ec2_query(
    ...
    if "key_type" in value:
        ...
        aws_sdk_ec2.types.ek_pub_key_type.serialize_ec2_query(
            value["key_type"], pairs, f"{prefix}.KeyType"
        )
    if "key_format" in value:
        import aws_sdk_ec2.types.ek_pub_key_format

        aws_sdk_ec2.types.ek_pub_key_format.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> GetInstanceTpmEkPubResult:
    ...
    if child_key_type is not None:
        ...
        out["key_type"] = aws_sdk_ec2.types.ek_pub_key_type.deserialize_ec2_query(
            child_key_type
        )
    ...
    if child_key_format is not None:
        ...
        out["key_format"] = aws_sdk_ec2.types.ek_pub_key_format.deserialize_ec2_query(
            child_key_format
        )
