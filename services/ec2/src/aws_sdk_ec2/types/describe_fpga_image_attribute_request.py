...
class DescribeFpgaImageAttributeRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DescribeFpgaImageAttributeRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
    if "dry_run" in value:
...
def deserialize_ec2_query(el: Element) -> DescribeFpgaImageAttributeRequest:
    out: DescribeFpgaImageAttributeRequest = {}  # type: ignore[typeddict-item]
