...
class DescribeSecondaryNetworksRequest(TypedDict):
    ...
    max_results: NotRequired[
        "aws_sdk_ec2.types.describe_secondary_networks_max_results.DescribeSecondaryNetworksMaxResults"
    ]
    """<p>The maximum number of results to return with a single call. To retrieve the remaining results, make another call with the returned <code>nextToken</code> value.</p>"""
    next_token: NotRequired["aws_sdk_ec2.types.string.String"]
    """<p>The token for the next page of results.</p>"""
    secondary_network_ids: NotRequired[
        "aws_sdk_ec2.types.secondary_network_id_list.SecondaryNetworkIdList"
    ]
...
def serialize_ec2_query(
    ...
    if "secondary_network_ids" in value:
        ...
        aws_sdk_ec2.types.secondary_network_id_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DescribeSecondaryNetworksRequest:
    ...
    if el.find("SecondaryNetworkIds") is not None:
        ...
        out["secondary_network_ids"] = (
            aws_sdk_ec2.types.secondary_network_id_list.deserialize_ec2_query(
