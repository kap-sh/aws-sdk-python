...
class DescribeDhcpOptionsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DescribeDhcpOptionsRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
    if "dhcp_options_ids" in value:
        import aws_sdk_ec2.types.dhcp_options_id_string_list

        aws_sdk_ec2.types.dhcp_options_id_string_list.serialize_ec2_query(
            value["dhcp_options_ids"], pairs, f"{prefix}.DhcpOptionsIds"
        )
...
def deserialize_ec2_query(el: Element) -> DescribeDhcpOptionsRequest:
    ...
    if el.find("DhcpOptionsIds") is not None:
        import aws_sdk_ec2.types.dhcp_options_id_string_list

        out["dhcp_options_ids"] = (
            aws_sdk_ec2.types.dhcp_options_id_string_list.deserialize_ec2_query(
                el, "DhcpOptionsIds"
            )
        )
