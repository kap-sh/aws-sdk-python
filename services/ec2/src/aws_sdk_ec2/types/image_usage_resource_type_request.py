...
def serialize_ec2_query(
    ...
    if "resource_type_options" in value:
        ...
        aws_sdk_ec2.types.image_usage_resource_type_option_request_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> ImageUsageResourceTypeRequest:
    ...
    if el.find("ResourceTypeOptions") is not None:
        ...
        out["resource_type_options"] = (
            aws_sdk_ec2.types.image_usage_resource_type_option_request_list.deserialize_ec2_query(
