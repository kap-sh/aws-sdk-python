...
class DescribeTransitGatewayAttachmentsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DescribeTransitGatewayAttachmentsRequest,
...
def deserialize_ec2_query(el: Element) -> DescribeTransitGatewayAttachmentsRequest:
    out: DescribeTransitGatewayAttachmentsRequest = {}  # type: ignore[typeddict-item]
