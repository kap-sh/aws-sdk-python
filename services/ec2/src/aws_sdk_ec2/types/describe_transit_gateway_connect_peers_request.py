...
def serialize_ec2_query(
    ...
    if "transit_gateway_connect_peer_ids" in value:
        ...
        aws_sdk_ec2.types.transit_gateway_connect_peer_id_string_list.serialize_ec2_query(
            value["transit_gateway_connect_peer_ids"],
            pairs,
            f"{prefix}.TransitGatewayConnectPeerIds",
        )
    if "filters" in value:
        import aws_sdk_ec2.types.filter_list
...
def deserialize_ec2_query(el: Element) -> DescribeTransitGatewayConnectPeersRequest:
    ...
    if el.find("TransitGatewayConnectPeerIds") is not None:
        ...
        out["transit_gateway_connect_peer_ids"] = (
            aws_sdk_ec2.types.transit_gateway_connect_peer_id_string_list.deserialize_ec2_query(
