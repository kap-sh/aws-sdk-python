...
def serialize_ec2_query(
    ...
    if "association_target" in value:
        ...
        aws_sdk_ec2.types.instance_event_window_disassociation_request.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DisassociateInstanceEventWindowRequest:
    ...
    if child_association_target is not None:
        ...
        out["association_target"] = (
            aws_sdk_ec2.types.instance_event_window_disassociation_request.deserialize_ec2_query(
