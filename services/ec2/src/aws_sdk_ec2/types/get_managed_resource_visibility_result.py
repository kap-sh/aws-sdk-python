...
class GetManagedResourceVisibilityResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: GetManagedResourceVisibilityResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> GetManagedResourceVisibilityResult:
    out: GetManagedResourceVisibilityResult = {}  # type: ignore[typeddict-item]
