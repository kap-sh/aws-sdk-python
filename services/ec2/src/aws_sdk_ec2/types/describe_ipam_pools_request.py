...
class DescribeIpamPoolsRequest(TypedDict):
    ...
    ipam_pool_ids: NotRequired["aws_sdk_ec2.types.value_string_list.ValueStringList"]
...
def serialize_ec2_query(
    ...
    if "ipam_pool_ids" in value:
        ...
        aws_sdk_ec2.types.value_string_list.serialize_ec2_query(
            value["ipam_pool_ids"], pairs, f"{prefix}.IpamPoolIds"
        )
...
def deserialize_ec2_query(el: Element) -> DescribeIpamPoolsRequest:
    ...
    if el.find("IpamPoolIds") is not None:
        ...
        out["ipam_pool_ids"] = (
            aws_sdk_ec2.types.value_string_list.deserialize_ec2_query(el, "IpamPoolIds")
        )
    return out
