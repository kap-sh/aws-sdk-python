...
def serialize_ec2_query(
    ...
    if "data_queries" in value:
        ...
        aws_sdk_ec2.types.data_queries.serialize_ec2_query(
            value["data_queries"], pairs, f"{prefix}.DataQueries"
        )
...
def deserialize_ec2_query(el: Element) -> GetAwsNetworkPerformanceDataRequest:
    ...
    if el.find("DataQueries") is not None:
        ...
        out["data_queries"] = aws_sdk_ec2.types.data_queries.deserialize_ec2_query(
            el, "DataQueries"
        )
