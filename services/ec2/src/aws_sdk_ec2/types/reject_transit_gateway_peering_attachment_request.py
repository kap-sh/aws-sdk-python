"""Generated from Smithy shape ``com.amazonaws.ec2#RejectTransitGatewayPeeringAttachmentRequest``."""
...
class RejectTransitGatewayPeeringAttachmentRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: RejectTransitGatewayPeeringAttachmentRequest,
...
def deserialize_ec2_query(el: Element) -> RejectTransitGatewayPeeringAttachmentRequest:
    out: RejectTransitGatewayPeeringAttachmentRequest = {}  # type: ignore[typeddict-item]
