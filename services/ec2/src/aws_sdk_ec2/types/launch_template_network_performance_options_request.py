...
class LaunchTemplateNetworkPerformanceOptionsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: LaunchTemplateNetworkPerformanceOptionsRequest,
...
def deserialize_ec2_query(
    ...
    out: LaunchTemplateNetworkPerformanceOptionsRequest = {}  # type: ignore[typeddict-item]
