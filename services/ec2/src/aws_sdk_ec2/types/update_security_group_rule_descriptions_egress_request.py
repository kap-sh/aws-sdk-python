...
class UpdateSecurityGroupRuleDescriptionsEgressRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: UpdateSecurityGroupRuleDescriptionsEgressRequest,
...
def deserialize_ec2_query(
    ...
    out: UpdateSecurityGroupRuleDescriptionsEgressRequest = {}  # type: ignore[typeddict-item]
