...
def serialize_ec2_query(
    ...
    if "launch_template_specification" in value:
        ...
        aws_sdk_ec2.types.fleet_launch_template_specification_request.serialize_ec2_query(
    ...
    if "overrides" in value:
        ...
        aws_sdk_ec2.types.fleet_launch_template_overrides_list_request.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> FleetLaunchTemplateConfigRequest:
    ...
    if child_launch_template_specification is not None:
        ...
        out["launch_template_specification"] = (
            aws_sdk_ec2.types.fleet_launch_template_specification_request.deserialize_ec2_query(
    ...
    if el.find("Overrides") is not None:
        ...
        out["overrides"] = (
            aws_sdk_ec2.types.fleet_launch_template_overrides_list_request.deserialize_ec2_query(
                el, "Overrides"
            )
        )
    return out
