"""Generated from Smithy shape ``com.amazonaws.ec2#LaunchTemplatePrivateDnsNameOptionsRequest``."""
...
class LaunchTemplatePrivateDnsNameOptionsRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: LaunchTemplatePrivateDnsNameOptionsRequest,
...
def deserialize_ec2_query(el: Element) -> LaunchTemplatePrivateDnsNameOptionsRequest:
    out: LaunchTemplatePrivateDnsNameOptionsRequest = {}  # type: ignore[typeddict-item]
