...
def serialize_ec2_query(
    ...
    for n, item in enumerate(value, 1):
        ...
        aws_sdk_ec2.types.ipam_prefix_list_resolver_rule_request.serialize_ec2_query(
...
def deserialize_ec2_query(
    ...
    for child in parent.findall(tag):
        out.append(
            aws_sdk_ec2.types.ipam_prefix_list_resolver_rule_request.deserialize_ec2_query(
                child
            )
        )
    return out
