"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteVerifiedAccessTrustProviderRequest``."""
...
class DeleteVerifiedAccessTrustProviderRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteVerifiedAccessTrustProviderRequest,
...
def deserialize_ec2_query(el: Element) -> DeleteVerifiedAccessTrustProviderRequest:
    out: DeleteVerifiedAccessTrustProviderRequest = {}  # type: ignore[typeddict-item]
