"""Generated from Smithy shape ``com.amazonaws.ec2#ExportClientVpnClientConfigurationRequest``."""
...
class ExportClientVpnClientConfigurationRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ExportClientVpnClientConfigurationRequest,
...
def deserialize_ec2_query(el: Element) -> ExportClientVpnClientConfigurationRequest:
    out: ExportClientVpnClientConfigurationRequest = {}  # type: ignore[typeddict-item]
