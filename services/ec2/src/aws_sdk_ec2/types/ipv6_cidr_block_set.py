...
def serialize_ec2_query(
    ...
    for n, item in enumerate(value, 1):
        ...
        aws_sdk_ec2.types.ipv6_cidr_block.serialize_ec2_query(
            item, pairs, f"{prefix}.{n}"
        )


def deserialize_ec2_query(parent: Element, tag: str) -> Ipv6CidrBlockSet:
    import aws_sdk_ec2.types.ipv6_cidr_block

    out: Ipv6CidrBlockSet = []
    for child in parent.findall(tag):
        out.append(aws_sdk_ec2.types.ipv6_cidr_block.deserialize_ec2_query(child))
    return out
