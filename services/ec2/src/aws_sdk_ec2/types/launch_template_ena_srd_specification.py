...
def serialize_ec2_query(
    ...
    if "ena_srd_udp_specification" in value:
        ...
        aws_sdk_ec2.types.launch_template_ena_srd_udp_specification.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> LaunchTemplateEnaSrdSpecification:
    ...
    if child_ena_srd_udp_specification is not None:
        ...
        out["ena_srd_udp_specification"] = (
            aws_sdk_ec2.types.launch_template_ena_srd_udp_specification.deserialize_ec2_query(
