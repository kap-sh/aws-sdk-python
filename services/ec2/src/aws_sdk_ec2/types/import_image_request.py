...
def serialize_ec2_query(
    ...
    if "disk_containers" in value:
        ...
        aws_sdk_ec2.types.image_disk_container_list.serialize_ec2_query(
    ...
    if "license_specifications" in value:
        ...
        aws_sdk_ec2.types.import_image_license_specification_list_request.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> ImportImageRequest:
    ...
    if el.find("DiskContainers") is not None:
        ...
        out["disk_containers"] = (
            aws_sdk_ec2.types.image_disk_container_list.deserialize_ec2_query(
                el, "DiskContainers"
            )
        )
    ...
    if el.find("LicenseSpecifications") is not None:
        ...
        out["license_specifications"] = (
            aws_sdk_ec2.types.import_image_license_specification_list_request.deserialize_ec2_query(
