...
class RejectTransitGatewayMulticastDomainAssociationsResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: RejectTransitGatewayMulticastDomainAssociationsResult,
...
def deserialize_ec2_query(
    ...
    out: RejectTransitGatewayMulticastDomainAssociationsResult = {}  # type: ignore[typeddict-item]
