...
class IpamPrefixListResolverRuleCondition(TypedDict):
    ...
    resource_tag: NotRequired["aws_sdk_ec2.types.ipam_resource_tag.IpamResourceTag"]
...
def deserialize_ec2_query(el: Element) -> IpamPrefixListResolverRuleCondition:
    ...
    if child_resource_tag is not None:
        ...
        out["resource_tag"] = aws_sdk_ec2.types.ipam_resource_tag.deserialize_ec2_query(
            child_resource_tag
        )
