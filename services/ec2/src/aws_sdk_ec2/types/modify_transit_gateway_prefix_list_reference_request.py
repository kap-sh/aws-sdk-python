"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyTransitGatewayPrefixListReferenceRequest``."""
...
class ModifyTransitGatewayPrefixListReferenceRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ModifyTransitGatewayPrefixListReferenceRequest,
...
def deserialize_ec2_query(
    ...
    out: ModifyTransitGatewayPrefixListReferenceRequest = {}  # type: ignore[typeddict-item]
