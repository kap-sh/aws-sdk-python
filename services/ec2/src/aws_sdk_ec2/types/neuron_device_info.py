...
def serialize_ec2_query(
    ...
    if "core_info" in value:
        ...
        aws_sdk_ec2.types.neuron_device_core_info.serialize_ec2_query(
            value["core_info"], pairs, f"{prefix}.CoreInfo"
        )
    if "memory_info" in value:
        import aws_sdk_ec2.types.neuron_device_memory_info

        aws_sdk_ec2.types.neuron_device_memory_info.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> NeuronDeviceInfo:
    ...
    if child_core_info is not None:
        ...
        out["core_info"] = (
            aws_sdk_ec2.types.neuron_device_core_info.deserialize_ec2_query(
                child_core_info
            )
        )
    ...
    if child_memory_info is not None:
        ...
        out["memory_info"] = (
            aws_sdk_ec2.types.neuron_device_memory_info.deserialize_ec2_query(
                child_memory_info
            )
        )
    return out
