"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTransitGatewayMulticastDomainRequest``."""
...
class DeleteTransitGatewayMulticastDomainRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteTransitGatewayMulticastDomainRequest,
...
def deserialize_ec2_query(el: Element) -> DeleteTransitGatewayMulticastDomainRequest:
    out: DeleteTransitGatewayMulticastDomainRequest = {}  # type: ignore[typeddict-item]
