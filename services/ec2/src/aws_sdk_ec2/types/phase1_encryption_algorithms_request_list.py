...
def serialize_ec2_query(
    ...
    for n, item in enumerate(value, 1):
        ...
        aws_sdk_ec2.types.phase1_encryption_algorithms_request_list_value.serialize_ec2_query(
...
def deserialize_ec2_query(
    ...
    for child in parent.findall(tag):
        out.append(
            aws_sdk_ec2.types.phase1_encryption_algorithms_request_list_value.deserialize_ec2_query(
                child
            )
        )
    return out
