...
def serialize_ec2_query(
    ...
    if "private_ip_addresses" in value:
        ...
        aws_sdk_ec2.types.instance_secondary_interface_private_ip_address_list_request.serialize_ec2_query(
...
def deserialize_ec2_query(
    ...
    if el.find("PrivateIpAddresses") is not None:
        ...
        out["private_ip_addresses"] = (
            aws_sdk_ec2.types.instance_secondary_interface_private_ip_address_list_request.deserialize_ec2_query(
