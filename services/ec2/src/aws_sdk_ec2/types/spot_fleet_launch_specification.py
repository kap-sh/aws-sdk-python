...
def serialize_ec2_query(
    ...
    if "monitoring" in value:
        ...
        aws_sdk_ec2.types.spot_fleet_monitoring.serialize_ec2_query(
    ...
    if "tag_specifications" in value:
        ...
        aws_sdk_ec2.types.spot_fleet_tag_specification_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> SpotFleetLaunchSpecification:
    ...
    if child_monitoring is not None:
        ...
        out["monitoring"] = (
            aws_sdk_ec2.types.spot_fleet_monitoring.deserialize_ec2_query(
                child_monitoring
            )
        )
    ...
    if el.find("TagSpecificationSet") is not None:
        ...
        out["tag_specifications"] = (
            aws_sdk_ec2.types.spot_fleet_tag_specification_list.deserialize_ec2_query(
