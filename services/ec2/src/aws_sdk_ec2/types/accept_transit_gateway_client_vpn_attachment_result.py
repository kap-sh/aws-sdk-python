...
class AcceptTransitGatewayClientVpnAttachmentResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AcceptTransitGatewayClientVpnAttachmentResult,
...
def deserialize_ec2_query(el: Element) -> AcceptTransitGatewayClientVpnAttachmentResult:
    out: AcceptTransitGatewayClientVpnAttachmentResult = {}  # type: ignore[typeddict-item]
