...
class EnableFastSnapshotRestoreStateError(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: EnableFastSnapshotRestoreStateError,
...
def deserialize_ec2_query(el: Element) -> EnableFastSnapshotRestoreStateError:
    out: EnableFastSnapshotRestoreStateError = {}  # type: ignore[typeddict-item]
