...
def serialize_ec2_query(
    ...
    if "exclusion_ids" in value:
        ...
        aws_sdk_ec2.types.vpc_block_public_access_exclusion_id_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DescribeVpcBlockPublicAccessExclusionsRequest:
    ...
    if el.find("ExclusionIds") is not None:
        ...
        out["exclusion_ids"] = (
            aws_sdk_ec2.types.vpc_block_public_access_exclusion_id_list.deserialize_ec2_query(
                el, "ExclusionIds"
            )
        )
