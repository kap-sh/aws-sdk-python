...
class DescribeFastSnapshotRestoreSuccessItem(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DescribeFastSnapshotRestoreSuccessItem,
...
def deserialize_ec2_query(el: Element) -> DescribeFastSnapshotRestoreSuccessItem:
    out: DescribeFastSnapshotRestoreSuccessItem = {}  # type: ignore[typeddict-item]
