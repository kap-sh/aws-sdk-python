...
class InstanceNetworkPerformanceOptions(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: InstanceNetworkPerformanceOptions, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> InstanceNetworkPerformanceOptions:
    out: InstanceNetworkPerformanceOptions = {}  # type: ignore[typeddict-item]
