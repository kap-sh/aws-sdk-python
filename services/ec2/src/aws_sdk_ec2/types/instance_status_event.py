...
def serialize_ec2_query(
    ...
    if "code" in value:
        ...
        aws_sdk_ec2.types.event_code.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> InstanceStatusEvent:
    ...
    if child_code is not None:
        ...
        out["code"] = aws_sdk_ec2.types.event_code.deserialize_ec2_query(child_code)
    ...
    if child_not_after is not None:
        ...
        out["not_after"] = aws_sdk_ec2.types.date_time.deserialize_ec2_query(
            child_not_after
        )
    ...
    if child_not_before_deadline is not None:
        ...
        out["not_before_deadline"] = aws_sdk_ec2.types.date_time.deserialize_ec2_query(
