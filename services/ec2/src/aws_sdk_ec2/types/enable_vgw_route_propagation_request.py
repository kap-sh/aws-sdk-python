...
def serialize_ec2_query(
    value: EnableVgwRoutePropagationRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> EnableVgwRoutePropagationRequest:
    out: EnableVgwRoutePropagationRequest = {}  # type: ignore[typeddict-item]
