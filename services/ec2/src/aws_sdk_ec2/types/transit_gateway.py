...
def serialize_ec2_query(
    ...
    if "state" in value:
        ...
        aws_sdk_ec2.types.transit_gateway_state.serialize_ec2_query(
    ...
    if "options" in value:
        ...
        aws_sdk_ec2.types.transit_gateway_options.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> TransitGateway:
    ...
    if child_state is not None:
        ...
        out["state"] = aws_sdk_ec2.types.transit_gateway_state.deserialize_ec2_query(
            child_state
        )
    ...
    if child_options is not None:
        ...
        out["options"] = (
            aws_sdk_ec2.types.transit_gateway_options.deserialize_ec2_query(
                child_options
            )
        )
