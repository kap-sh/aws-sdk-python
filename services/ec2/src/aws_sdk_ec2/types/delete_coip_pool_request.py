...
class DeleteCoipPoolRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteCoipPoolRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DeleteCoipPoolRequest:
    out: DeleteCoipPoolRequest = {}  # type: ignore[typeddict-item]
