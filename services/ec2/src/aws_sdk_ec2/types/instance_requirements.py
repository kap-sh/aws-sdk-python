...
def serialize_ec2_query(
    ...
    if "v_cpu_count" in value:
        ...
        aws_sdk_ec2.types.v_cpu_count_range.serialize_ec2_query(
            value["v_cpu_count"], pairs, f"{prefix}.VCpuCount"
        )
    if "memory_mi_b" in value:
        import aws_sdk_ec2.types.memory_mi_b

        aws_sdk_ec2.types.memory_mi_b.serialize_ec2_query(
    ...
    if "memory_gi_b_per_v_cpu" in value:
        ...
        aws_sdk_ec2.types.memory_gi_b_per_v_cpu.serialize_ec2_query(
    ...
    if "network_interface_count" in value:
        ...
        aws_sdk_ec2.types.network_interface_count.serialize_ec2_query(
    ...
    if "total_local_storage_gb" in value:
        ...
        aws_sdk_ec2.types.total_local_storage_gb.serialize_ec2_query(
            value["total_local_storage_gb"], pairs, f"{prefix}.TotalLocalStorageGB"
        )
    if "baseline_ebs_bandwidth_mbps" in value:
        import aws_sdk_ec2.types.baseline_ebs_bandwidth_mbps

        aws_sdk_ec2.types.baseline_ebs_bandwidth_mbps.serialize_ec2_query(
    ...
    if "accelerator_count" in value:
        ...
        aws_sdk_ec2.types.accelerator_count.serialize_ec2_query(
    ...
    if "accelerator_total_memory_mi_b" in value:
        ...
        aws_sdk_ec2.types.accelerator_total_memory_mi_b.serialize_ec2_query(
    ...
    if "network_bandwidth_gbps" in value:
        ...
        aws_sdk_ec2.types.network_bandwidth_gbps.serialize_ec2_query(
    ...
    if "baseline_performance_factors" in value:
        ...
        aws_sdk_ec2.types.baseline_performance_factors.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> InstanceRequirements:
    ...
    if child_v_cpu_count is not None:
        ...
        out["v_cpu_count"] = aws_sdk_ec2.types.v_cpu_count_range.deserialize_ec2_query(
            child_v_cpu_count
        )
    ...
    if child_memory_mi_b is not None:
        ...
        out["memory_mi_b"] = aws_sdk_ec2.types.memory_mi_b.deserialize_ec2_query(
            child_memory_mi_b
        )
    ...
    if child_memory_gi_b_per_v_cpu is not None:
        ...
        out["memory_gi_b_per_v_cpu"] = (
            aws_sdk_ec2.types.memory_gi_b_per_v_cpu.deserialize_ec2_query(
    ...
    if child_network_interface_count is not None:
        ...
        out["network_interface_count"] = (
            aws_sdk_ec2.types.network_interface_count.deserialize_ec2_query(
    ...
    if child_total_local_storage_gb is not None:
        ...
        out["total_local_storage_gb"] = (
            aws_sdk_ec2.types.total_local_storage_gb.deserialize_ec2_query(
    ...
    if child_baseline_ebs_bandwidth_mbps is not None:
        ...
        out["baseline_ebs_bandwidth_mbps"] = (
            aws_sdk_ec2.types.baseline_ebs_bandwidth_mbps.deserialize_ec2_query(
    ...
    if child_accelerator_count is not None:
        ...
        out["accelerator_count"] = (
            aws_sdk_ec2.types.accelerator_count.deserialize_ec2_query(
    ...
    if child_accelerator_total_memory_mi_b is not None:
        ...
        out["accelerator_total_memory_mi_b"] = (
            aws_sdk_ec2.types.accelerator_total_memory_mi_b.deserialize_ec2_query(
    ...
    if child_network_bandwidth_gbps is not None:
        ...
        out["network_bandwidth_gbps"] = (
            aws_sdk_ec2.types.network_bandwidth_gbps.deserialize_ec2_query(
    ...
    if child_baseline_performance_factors is not None:
        ...
        out["baseline_performance_factors"] = (
            aws_sdk_ec2.types.baseline_performance_factors.deserialize_ec2_query(
