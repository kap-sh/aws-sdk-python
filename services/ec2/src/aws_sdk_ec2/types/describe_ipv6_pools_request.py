...
class DescribeIpv6PoolsRequest(TypedDict):
    pool_ids: NotRequired["aws_sdk_ec2.types.ipv6_pool_id_list.Ipv6PoolIdList"]
    """<p>The IDs of the IPv6 address pools.</p>"""
    next_token: NotRequired["aws_sdk_ec2.types.next_token.NextToken"]
    """<p>The token for the next page of results.</p>"""
    max_results: NotRequired[
        "aws_sdk_ec2.types.ipv6_pool_max_results.Ipv6PoolMaxResults"
    ]
...
def serialize_ec2_query(
    ...
    if "pool_ids" in value:
        ...
        aws_sdk_ec2.types.ipv6_pool_id_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DescribeIpv6PoolsRequest:
    ...
    if el.find("PoolIds") is not None:
        ...
        out["pool_ids"] = aws_sdk_ec2.types.ipv6_pool_id_list.deserialize_ec2_query(
            el, "PoolIds"
        )
