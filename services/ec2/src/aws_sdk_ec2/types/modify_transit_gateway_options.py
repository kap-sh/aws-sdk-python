...
def serialize_ec2_query(
    ...
    if "add_transit_gateway_cidr_blocks" in value:
        ...
        aws_sdk_ec2.types.transit_gateway_cidr_block_string_list.serialize_ec2_query(
            ...
            pairs,
            f"{prefix}.AddTransitGatewayCidrBlocks",
        )
    if "remove_transit_gateway_cidr_blocks" in value:
        ...
        aws_sdk_ec2.types.transit_gateway_cidr_block_string_list.serialize_ec2_query(
            ...
            pairs,
            f"{prefix}.RemoveTransitGatewayCidrBlocks",
        )
    ...
    if "encryption_support" in value:
        ...
        aws_sdk_ec2.types.encryption_support_option_value.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> ModifyTransitGatewayOptions:
    ...
    if child_encryption_support is not None:
        ...
        out["encryption_support"] = (
            aws_sdk_ec2.types.encryption_support_option_value.deserialize_ec2_query(
