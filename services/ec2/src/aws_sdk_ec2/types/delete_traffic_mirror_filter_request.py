"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTrafficMirrorFilterRequest``."""
...
class DeleteTrafficMirrorFilterRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteTrafficMirrorFilterRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DeleteTrafficMirrorFilterRequest:
    out: DeleteTrafficMirrorFilterRequest = {}  # type: ignore[typeddict-item]
