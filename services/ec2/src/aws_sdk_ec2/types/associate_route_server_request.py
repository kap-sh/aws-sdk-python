"""Generated from Smithy shape ``com.amazonaws.ec2#AssociateRouteServerRequest``."""
...
class AssociateRouteServerRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: AssociateRouteServerRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> AssociateRouteServerRequest:
    out: AssociateRouteServerRequest = {}  # type: ignore[typeddict-item]
