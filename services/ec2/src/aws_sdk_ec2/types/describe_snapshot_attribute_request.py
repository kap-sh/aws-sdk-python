"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeSnapshotAttributeRequest``."""
...
class DescribeSnapshotAttributeRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DescribeSnapshotAttributeRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DescribeSnapshotAttributeRequest:
    out: DescribeSnapshotAttributeRequest = {}  # type: ignore[typeddict-item]
