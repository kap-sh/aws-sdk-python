...
def serialize_ec2_query(
    ...
    if "state" in value:
        ...
        aws_sdk_ec2.types.vpc_block_public_access_state.serialize_ec2_query(
            value["state"], pairs, f"{prefix}.State"
        )
    if "internet_gateway_block_mode" in value:
        import aws_sdk_ec2.types.internet_gateway_block_mode

        aws_sdk_ec2.types.internet_gateway_block_mode.serialize_ec2_query(
    ...
    if "exclusions_allowed" in value:
        ...
        aws_sdk_ec2.types.vpc_block_public_access_exclusions_allowed.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> VpcBlockPublicAccessOptions:
    ...
    if child_state is not None:
        ...
        out["state"] = (
            aws_sdk_ec2.types.vpc_block_public_access_state.deserialize_ec2_query(
                child_state
            )
        )
    ...
    if child_internet_gateway_block_mode is not None:
        ...
        out["internet_gateway_block_mode"] = (
            aws_sdk_ec2.types.internet_gateway_block_mode.deserialize_ec2_query(
    ...
    if child_exclusions_allowed is not None:
        ...
        out["exclusions_allowed"] = (
            aws_sdk_ec2.types.vpc_block_public_access_exclusions_allowed.deserialize_ec2_query(
