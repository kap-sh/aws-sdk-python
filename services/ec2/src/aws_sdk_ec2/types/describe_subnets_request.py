...
class DescribeSubnetsRequest(TypedDict):
    ...
    subnet_ids: NotRequired[
        "aws_sdk_ec2.types.subnet_id_string_list.SubnetIdStringList"
    ]
    """<p>The IDs of the subnets.</p> <p>Default: Describes all your subnets.</p>"""
    next_token: NotRequired["aws_sdk_ec2.types.string.String"]
    """<p>The token returned from a previous paginated request. Pagination continues from the end of the items returned by the previous request.</p>"""
    max_results: NotRequired[
        "aws_sdk_ec2.types.describe_subnets_max_results.DescribeSubnetsMaxResults"
    ]
...
def serialize_ec2_query(
    ...
    if "subnet_ids" in value:
        ...
        aws_sdk_ec2.types.subnet_id_string_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DescribeSubnetsRequest:
    ...
    if el.find("SubnetIds") is not None:
        ...
        out["subnet_ids"] = (
            aws_sdk_ec2.types.subnet_id_string_list.deserialize_ec2_query(
                el, "SubnetIds"
            )
        )
