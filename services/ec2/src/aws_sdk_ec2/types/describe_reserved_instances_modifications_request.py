...
def serialize_ec2_query(
    ...
    if "reserved_instances_modification_ids" in value:
        ...
        aws_sdk_ec2.types.reserved_instances_modification_id_string_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DescribeReservedInstancesModificationsRequest:
    ...
    if el.find("ReservedInstancesModificationIds") is not None:
        ...
        out["reserved_instances_modification_ids"] = (
            aws_sdk_ec2.types.reserved_instances_modification_id_string_list.deserialize_ec2_query(
