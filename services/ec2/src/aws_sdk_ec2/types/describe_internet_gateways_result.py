...
class DescribeInternetGatewaysResult(TypedDict):
    internet_gateways: NotRequired[
        "aws_sdk_ec2.types.internet_gateway_list.InternetGatewayList"
    ]
...
def serialize_ec2_query(
    ...
    if "internet_gateways" in value:
        ...
        aws_sdk_ec2.types.internet_gateway_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DescribeInternetGatewaysResult:
    ...
    if el.find("InternetGatewaySet") is not None:
        ...
        out["internet_gateways"] = (
            aws_sdk_ec2.types.internet_gateway_list.deserialize_ec2_query(
