...
def serialize_ec2_query(
    value: EnableRouteServerPropagationRequest,
...
def deserialize_ec2_query(el: Element) -> EnableRouteServerPropagationRequest:
    out: EnableRouteServerPropagationRequest = {}  # type: ignore[typeddict-item]
