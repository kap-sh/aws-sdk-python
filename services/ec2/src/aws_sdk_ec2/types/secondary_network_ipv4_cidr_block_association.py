...
class SecondaryNetworkIpv4CidrBlockAssociation(TypedDict, closed=True):
    association_id: NotRequired[
        "aws_sdk_ec2.types.secondary_network_cidr_association_id.SecondaryNetworkCidrAssociationId"
    ]
    """<p>The association ID for the IPv4 CIDR block.</p>"""
    cidr_block: NotRequired["aws_sdk_ec2.types.string.String"]
    """<p>The IPv4 CIDR block.</p>"""
    state: NotRequired[
        "aws_sdk_ec2.types.secondary_network_cidr_block_association_state.SecondaryNetworkCidrBlockAssociationState"
    ]
