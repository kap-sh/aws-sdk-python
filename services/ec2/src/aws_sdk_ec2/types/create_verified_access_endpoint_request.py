...
def serialize_ec2_query(
    ...
    if "endpoint_domain_prefix" in value:
        pairs.append(
            (f"{prefix}.EndpointDomainPrefix", str(value["endpoint_domain_prefix"]))
        )
    ...
    if "load_balancer_options" in value:
        ...
        aws_sdk_ec2.types.create_verified_access_endpoint_load_balancer_options.serialize_ec2_query(
            value["load_balancer_options"], pairs, f"{prefix}.LoadBalancerOptions"
        )
    if "network_interface_options" in value:
        import aws_sdk_ec2.types.create_verified_access_endpoint_eni_options

        aws_sdk_ec2.types.create_verified_access_endpoint_eni_options.serialize_ec2_query(
    ...
    if "rds_options" in value:
        ...
        aws_sdk_ec2.types.create_verified_access_endpoint_rds_options.serialize_ec2_query(
            value["rds_options"], pairs, f"{prefix}.RdsOptions"
        )
    if "cidr_options" in value:
        import aws_sdk_ec2.types.create_verified_access_endpoint_cidr_options

        aws_sdk_ec2.types.create_verified_access_endpoint_cidr_options.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> CreateVerifiedAccessEndpointRequest:
    ...
    if child_load_balancer_options is not None:
        ...
        out["load_balancer_options"] = (
            aws_sdk_ec2.types.create_verified_access_endpoint_load_balancer_options.deserialize_ec2_query(
    ...
    if child_network_interface_options is not None:
        ...
        out["network_interface_options"] = (
            aws_sdk_ec2.types.create_verified_access_endpoint_eni_options.deserialize_ec2_query(
    ...
    if child_rds_options is not None:
        ...
        out["rds_options"] = (
            aws_sdk_ec2.types.create_verified_access_endpoint_rds_options.deserialize_ec2_query(
                child_rds_options
            )
        )
    ...
    if child_cidr_options is not None:
        ...
        out["cidr_options"] = (
            aws_sdk_ec2.types.create_verified_access_endpoint_cidr_options.deserialize_ec2_query(
                child_cidr_options
            )
        )
    return out
