"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTransitGatewayRequest``."""
...
class DeleteTransitGatewayRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteTransitGatewayRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DeleteTransitGatewayRequest:
    out: DeleteTransitGatewayRequest = {}  # type: ignore[typeddict-item]
