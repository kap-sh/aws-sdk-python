...
def serialize_ec2_query(
    ...
    if "supported_usage_classes" in value:
        ...
        aws_sdk_ec2.types.usage_class_type_list.serialize_ec2_query(
            value["supported_usage_classes"], pairs, f"{prefix}.SupportedUsageClasses"
        )
    if "supported_root_device_types" in value:
        import aws_sdk_ec2.types.root_device_type_list

        aws_sdk_ec2.types.root_device_type_list.serialize_ec2_query(
    ...
    if "supported_virtualization_types" in value:
        ...
        aws_sdk_ec2.types.virtualization_type_list.serialize_ec2_query(
    ...
    if "hypervisor" in value:
        ...
        aws_sdk_ec2.types.instance_type_hypervisor.serialize_ec2_query(
            value["hypervisor"], pairs, f"{prefix}.Hypervisor"
        )
    if "processor_info" in value:
        import aws_sdk_ec2.types.processor_info

        aws_sdk_ec2.types.processor_info.serialize_ec2_query(
            value["processor_info"], pairs, f"{prefix}.ProcessorInfo"
        )
    if "v_cpu_info" in value:
        import aws_sdk_ec2.types.v_cpu_info

        aws_sdk_ec2.types.v_cpu_info.serialize_ec2_query(
            value["v_cpu_info"], pairs, f"{prefix}.VCpuInfo"
        )
    if "memory_info" in value:
        import aws_sdk_ec2.types.memory_info

        aws_sdk_ec2.types.memory_info.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> InstanceTypeInfo:
    ...
    if el.find("SupportedUsageClasses") is not None:
        ...
        out["supported_usage_classes"] = (
            aws_sdk_ec2.types.usage_class_type_list.deserialize_ec2_query(
    ...
    if el.find("SupportedRootDeviceTypes") is not None:
        ...
        out["supported_root_device_types"] = (
            aws_sdk_ec2.types.root_device_type_list.deserialize_ec2_query(
    ...
    if el.find("SupportedVirtualizationTypes") is not None:
        ...
        out["supported_virtualization_types"] = (
            aws_sdk_ec2.types.virtualization_type_list.deserialize_ec2_query(
    ...
    if child_hypervisor is not None:
        ...
        out["hypervisor"] = (
            aws_sdk_ec2.types.instance_type_hypervisor.deserialize_ec2_query(
                child_hypervisor
            )
        )
    ...
    if child_processor_info is not None:
        ...
        out["processor_info"] = aws_sdk_ec2.types.processor_info.deserialize_ec2_query(
    ...
    if child_v_cpu_info is not None:
        ...
        out["v_cpu_info"] = aws_sdk_ec2.types.v_cpu_info.deserialize_ec2_query(
            child_v_cpu_info
        )
    ...
    if child_memory_info is not None:
        ...
        out["memory_info"] = aws_sdk_ec2.types.memory_info.deserialize_ec2_query(
            child_memory_info
        )
    ...
    if child_instance_storage_info is not None:
        ...
        out["instance_storage_info"] = (
            aws_sdk_ec2.types.instance_storage_info.deserialize_ec2_query(
    ...
    if child_ebs_info is not None:
        ...
        out["ebs_info"] = aws_sdk_ec2.types.ebs_info.deserialize_ec2_query(
            child_ebs_info
        )
    ...
    if child_network_info is not None:
        ...
        out["network_info"] = aws_sdk_ec2.types.network_info.deserialize_ec2_query(
            child_network_info
        )
    ...
    if child_gpu_info is not None:
        ...
        out["gpu_info"] = aws_sdk_ec2.types.gpu_info.deserialize_ec2_query(
            child_gpu_info
        )
    ...
    if child_fpga_info is not None:
        ...
        out["fpga_info"] = aws_sdk_ec2.types.fpga_info.deserialize_ec2_query(
            child_fpga_info
        )
    ...
    if child_placement_group_info is not None:
        ...
        out["placement_group_info"] = (
            aws_sdk_ec2.types.placement_group_info.deserialize_ec2_query(
    ...
    if child_inference_accelerator_info is not None:
        ...
        out["inference_accelerator_info"] = (
            aws_sdk_ec2.types.inference_accelerator_info.deserialize_ec2_query(
    ...
    if el.find("SupportedBootModes") is not None:
        ...
        out["supported_boot_modes"] = (
            aws_sdk_ec2.types.boot_mode_type_list.deserialize_ec2_query(
    ...
    if child_nitro_enclaves_support is not None:
        ...
        out["nitro_enclaves_support"] = (
            aws_sdk_ec2.types.nitro_enclaves_support.deserialize_ec2_query(
    ...
    if child_nitro_tpm_support is not None:
        ...
        out["nitro_tpm_support"] = (
            aws_sdk_ec2.types.nitro_tpm_support.deserialize_ec2_query(
    ...
    if child_nitro_tpm_info is not None:
        ...
        out["nitro_tpm_info"] = aws_sdk_ec2.types.nitro_tpm_info.deserialize_ec2_query(
    ...
    if child_media_accelerator_info is not None:
        ...
        out["media_accelerator_info"] = (
            aws_sdk_ec2.types.media_accelerator_info.deserialize_ec2_query(
    ...
    if child_neuron_info is not None:
        ...
        out["neuron_info"] = aws_sdk_ec2.types.neuron_info.deserialize_ec2_query(
            child_neuron_info
        )
    ...
    if child_phc_support is not None:
        ...
        out["phc_support"] = aws_sdk_ec2.types.phc_support.deserialize_ec2_query(
            child_phc_support
        )
    ...
    if child_reboot_migration_support is not None:
        ...
        out["reboot_migration_support"] = (
            aws_sdk_ec2.types.reboot_migration_support.deserialize_ec2_query(
