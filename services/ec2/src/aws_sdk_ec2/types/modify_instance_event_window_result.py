"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyInstanceEventWindowResult``."""
...
class ModifyInstanceEventWindowResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: ModifyInstanceEventWindowResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
