"""Generated from Smithy shape ``com.amazonaws.ec2#MonitorInstancesRequest``."""
...
class MonitorInstancesRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: MonitorInstancesRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> MonitorInstancesRequest:
    out: MonitorInstancesRequest = {}  # type: ignore[typeddict-item]
