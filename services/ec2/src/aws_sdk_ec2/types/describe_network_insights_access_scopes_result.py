...
class DescribeNetworkInsightsAccessScopesResult(TypedDict):
    network_insights_access_scopes: NotRequired[
        "aws_sdk_ec2.types.network_insights_access_scope_list.NetworkInsightsAccessScopeList"
    ]
...
def serialize_ec2_query(
    ...
    if "network_insights_access_scopes" in value:
        ...
        aws_sdk_ec2.types.network_insights_access_scope_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DescribeNetworkInsightsAccessScopesResult:
    ...
    if el.find("NetworkInsightsAccessScopeSet") is not None:
        ...
        out["network_insights_access_scopes"] = (
            aws_sdk_ec2.types.network_insights_access_scope_list.deserialize_ec2_query(
