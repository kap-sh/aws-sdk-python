...
class LaunchTemplateInstanceSecondaryInterfaceSpecification(TypedDict):
    ...
    private_ip_addresses: NotRequired[
        "aws_sdk_ec2.types.secondary_interface_private_ip_address_specification_list.SecondaryInterfacePrivateIpAddressSpecificationList"
    ]
