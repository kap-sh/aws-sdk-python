...
DataResponses: TypeAlias = list["aws_sdk_ec2.types.data_response.DataResponse"]
...
def serialize_ec2_query(
    ...
    for n, item in enumerate(value, 1):
        ...
        aws_sdk_ec2.types.data_response.serialize_ec2_query(
...
def deserialize_ec2_query(parent: Element, tag: str) -> DataResponses:
    ...
    for child in parent.findall(tag):
        out.append(aws_sdk_ec2.types.data_response.deserialize_ec2_query(child))
    return out
