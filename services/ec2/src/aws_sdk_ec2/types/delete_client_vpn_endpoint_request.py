...
class DeleteClientVpnEndpointRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteClientVpnEndpointRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_ec2_query(el: Element) -> DeleteClientVpnEndpointRequest:
    out: DeleteClientVpnEndpointRequest = {}  # type: ignore[typeddict-item]
