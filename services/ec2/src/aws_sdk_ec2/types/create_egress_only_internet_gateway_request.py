"""Generated from Smithy shape ``com.amazonaws.ec2#CreateEgressOnlyInternetGatewayRequest``."""
...
class CreateEgressOnlyInternetGatewayRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CreateEgressOnlyInternetGatewayRequest,
...
def deserialize_ec2_query(el: Element) -> CreateEgressOnlyInternetGatewayRequest:
    out: CreateEgressOnlyInternetGatewayRequest = {}  # type: ignore[typeddict-item]
