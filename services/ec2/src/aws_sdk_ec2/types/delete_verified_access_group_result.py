"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteVerifiedAccessGroupResult``."""
...
class DeleteVerifiedAccessGroupResult(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: DeleteVerifiedAccessGroupResult, pairs: list[tuple[str, str]], prefix: str
) -> None:
