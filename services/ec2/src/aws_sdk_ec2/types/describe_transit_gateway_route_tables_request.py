...
def serialize_ec2_query(
    ...
    if "transit_gateway_route_table_ids" in value:
        ...
        aws_sdk_ec2.types.transit_gateway_route_table_id_string_list.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> DescribeTransitGatewayRouteTablesRequest:
    ...
    if el.find("TransitGatewayRouteTableIds") is not None:
        ...
        out["transit_gateway_route_table_ids"] = (
            aws_sdk_ec2.types.transit_gateway_route_table_id_string_list.deserialize_ec2_query(
