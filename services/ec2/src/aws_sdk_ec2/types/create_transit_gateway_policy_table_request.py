"""Generated from Smithy shape ``com.amazonaws.ec2#CreateTransitGatewayPolicyTableRequest``."""
...
class CreateTransitGatewayPolicyTableRequest(TypedDict, closed=True):
...
def serialize_ec2_query(
    value: CreateTransitGatewayPolicyTableRequest,
...
def deserialize_ec2_query(el: Element) -> CreateTransitGatewayPolicyTableRequest:
    out: CreateTransitGatewayPolicyTableRequest = {}  # type: ignore[typeddict-item]
