"""Generated from Smithy shape ``com.amazonaws.ec2#OnDemandOptionsRequest``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_ec2.types.capacity_reservation_options_request
    import aws_sdk_ec2.types.fleet_on_demand_allocation_strategy
    import aws_sdk_ec2.types.integer
    import aws_sdk_ec2.types.string


class OnDemandOptionsRequest(TypedDict, closed=True):
    ...
    capacity_reservation_options: NotRequired[
        "aws_sdk_ec2.types.capacity_reservation_options_request.CapacityReservationOptionsRequest"
    ]
...
def serialize_ec2_query(
    value: OnDemandOptionsRequest, pairs: list[tuple[str, str]], prefix: str
) -> None:
    ...
    if "capacity_reservation_options" in value:
        ...
        aws_sdk_ec2.types.capacity_reservation_options_request.serialize_ec2_query(
...
def deserialize_ec2_query(el: Element) -> OnDemandOptionsRequest:
    out: OnDemandOptionsRequest = {}  # type: ignore[typeddict-item]
    ...
    if child_capacity_reservation_options is not None:
        ...
        out["capacity_reservation_options"] = (
            aws_sdk_ec2.types.capacity_reservation_options_request.deserialize_ec2_query(
