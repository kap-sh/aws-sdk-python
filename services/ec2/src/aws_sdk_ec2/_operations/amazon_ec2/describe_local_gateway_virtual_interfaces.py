...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_local_gateway_virtual_interfaces_result.DescribeLocalGatewayVirtualInterfacesResult = aws_sdk_ec2.types.describe_local_gateway_virtual_interfaces_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_local_gateway_virtual_interfaces_request.DescribeLocalGatewayVirtualInterfacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_local_gateway_virtual_interfaces_request.serialize_ec2_query(
        input_, pairs, ""
    )
