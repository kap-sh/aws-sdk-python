...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_transit_gateway_metering_policy_result.CreateTransitGatewayMeteringPolicyResult = aws_sdk_ec2.types.create_transit_gateway_metering_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_transit_gateway_metering_policy_request.CreateTransitGatewayMeteringPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_transit_gateway_metering_policy_request.serialize_ec2_query(
        input_, pairs, ""
    )
