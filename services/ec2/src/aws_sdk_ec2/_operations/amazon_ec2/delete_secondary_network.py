...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_secondary_network_result.DeleteSecondaryNetworkResult = aws_sdk_ec2.types.delete_secondary_network_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_secondary_network_request.DeleteSecondaryNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_secondary_network_request.serialize_ec2_query(
        input_, pairs, ""
    )
