"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeStaleSecurityGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_stale_security_groups_result.DescribeStaleSecurityGroupsResult = aws_sdk_ec2.types.describe_stale_security_groups_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_stale_security_groups_request.DescribeStaleSecurityGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeStaleSecurityGroups"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_stale_security_groups_request

    aws_sdk_ec2.types.describe_stale_security_groups_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_stale_security_groups(
