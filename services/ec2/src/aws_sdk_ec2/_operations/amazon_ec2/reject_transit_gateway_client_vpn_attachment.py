...
def handle_response(
    ...
    out: aws_sdk_ec2.types.reject_transit_gateway_client_vpn_attachment_result.RejectTransitGatewayClientVpnAttachmentResult = aws_sdk_ec2.types.reject_transit_gateway_client_vpn_attachment_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.reject_transit_gateway_client_vpn_attachment_request.RejectTransitGatewayClientVpnAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.reject_transit_gateway_client_vpn_attachment_request.serialize_ec2_query(
        input_, pairs, ""
    )
