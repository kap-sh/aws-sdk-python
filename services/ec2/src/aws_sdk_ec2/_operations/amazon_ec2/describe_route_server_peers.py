...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_route_server_peers_result.DescribeRouteServerPeersResult = aws_sdk_ec2.types.describe_route_server_peers_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_route_server_peers_request.DescribeRouteServerPeersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
