...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disable_address_transfer_result.DisableAddressTransferResult = aws_sdk_ec2.types.disable_address_transfer_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disable_address_transfer_request.DisableAddressTransferRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disable_address_transfer_request.serialize_ec2_query(
        input_, pairs, ""
    )
