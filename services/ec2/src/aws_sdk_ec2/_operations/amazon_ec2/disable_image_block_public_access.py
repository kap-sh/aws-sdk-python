...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disable_image_block_public_access_result.DisableImageBlockPublicAccessResult = aws_sdk_ec2.types.disable_image_block_public_access_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disable_image_block_public_access_request.DisableImageBlockPublicAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disable_image_block_public_access_request.serialize_ec2_query(
        input_, pairs, ""
    )
