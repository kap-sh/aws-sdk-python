...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_hosts_result.ModifyHostsResult = (
        aws_sdk_ec2.types.modify_hosts_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_hosts_request.ModifyHostsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_hosts_request.serialize_ec2_query(input_, pairs, "")
