"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyVpnTunnelOptions``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_vpn_tunnel_options_result.ModifyVpnTunnelOptionsResult = aws_sdk_ec2.types.modify_vpn_tunnel_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_vpn_tunnel_options_request.ModifyVpnTunnelOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyVpnTunnelOptions"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.modify_vpn_tunnel_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_vpn_tunnel_options(
