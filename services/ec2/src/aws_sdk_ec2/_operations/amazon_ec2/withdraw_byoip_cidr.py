...
def handle_response(
    ...
    out: aws_sdk_ec2.types.withdraw_byoip_cidr_result.WithdrawByoipCidrResult = (
        aws_sdk_ec2.types.withdraw_byoip_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.withdraw_byoip_cidr_request.WithdrawByoipCidrRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.withdraw_byoip_cidr_request.serialize_ec2_query(input_, pairs, "")
