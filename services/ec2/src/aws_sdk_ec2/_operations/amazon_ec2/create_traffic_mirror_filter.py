...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_traffic_mirror_filter_result.CreateTrafficMirrorFilterResult = aws_sdk_ec2.types.create_traffic_mirror_filter_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_traffic_mirror_filter_request.CreateTrafficMirrorFilterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_traffic_mirror_filter_request.serialize_ec2_query(
        input_, pairs, ""
    )
