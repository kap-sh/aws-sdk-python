...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_vpc_endpoint_service_configuration_result.CreateVpcEndpointServiceConfigurationResult = aws_sdk_ec2.types.create_vpc_endpoint_service_configuration_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_vpc_endpoint_service_configuration_request.CreateVpcEndpointServiceConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_vpc_endpoint_service_configuration_request.serialize_ec2_query(
        input_, pairs, ""
    )
