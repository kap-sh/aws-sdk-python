...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_outpost_lags_result.DescribeOutpostLagsResult = (
        aws_sdk_ec2.types.describe_outpost_lags_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_outpost_lags_request.DescribeOutpostLagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeOutpostLags"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_outpost_lags_request

    aws_sdk_ec2.types.describe_outpost_lags_request.serialize_ec2_query(
        input_, pairs, ""
    )
