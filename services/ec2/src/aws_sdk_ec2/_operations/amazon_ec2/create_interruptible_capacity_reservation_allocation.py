...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_interruptible_capacity_reservation_allocation_result.CreateInterruptibleCapacityReservationAllocationResult = aws_sdk_ec2.types.create_interruptible_capacity_reservation_allocation_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_interruptible_capacity_reservation_allocation_request.CreateInterruptibleCapacityReservationAllocationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateInterruptibleCapacityReservationAllocation"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_interruptible_capacity_reservation_allocation_request

    aws_sdk_ec2.types.create_interruptible_capacity_reservation_allocation_request.serialize_ec2_query(
        input_, pairs, ""
    )
