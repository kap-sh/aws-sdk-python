...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_image_usage_report_result.CreateImageUsageReportResult = aws_sdk_ec2.types.create_image_usage_report_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_image_usage_report_request.CreateImageUsageReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
