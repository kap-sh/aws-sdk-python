"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeReservedInstances``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_reserved_instances_result.DescribeReservedInstancesResult = aws_sdk_ec2.types.describe_reserved_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_reserved_instances_request.DescribeReservedInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeReservedInstances"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_reserved_instances_request

    aws_sdk_ec2.types.describe_reserved_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_reserved_instances(
