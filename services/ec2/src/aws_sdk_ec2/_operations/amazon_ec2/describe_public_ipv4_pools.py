...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_public_ipv4_pools_result.DescribePublicIpv4PoolsResult = aws_sdk_ec2.types.describe_public_ipv4_pools_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_public_ipv4_pools_request.DescribePublicIpv4PoolsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_public_ipv4_pools_request.serialize_ec2_query(
        input_, pairs, ""
    )
