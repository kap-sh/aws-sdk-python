"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTrafficMirrorTarget``."""
...
) -> aws_sdk_ec2.types.delete_traffic_mirror_target_result.DeleteTrafficMirrorTargetResult:
    out: aws_sdk_ec2.types.delete_traffic_mirror_target_result.DeleteTrafficMirrorTargetResult = aws_sdk_ec2.types.delete_traffic_mirror_target_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_traffic_mirror_target_request.DeleteTrafficMirrorTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteTrafficMirrorTarget"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.delete_traffic_mirror_target_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_traffic_mirror_target(
