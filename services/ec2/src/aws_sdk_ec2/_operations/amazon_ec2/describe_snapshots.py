...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_snapshots_result.DescribeSnapshotsResult = (
        aws_sdk_ec2.types.describe_snapshots_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_snapshots_request.DescribeSnapshotsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_snapshots_request.serialize_ec2_query(input_, pairs, "")
