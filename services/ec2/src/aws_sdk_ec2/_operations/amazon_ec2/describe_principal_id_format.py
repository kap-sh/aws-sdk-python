...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_principal_id_format_result.DescribePrincipalIdFormatResult = aws_sdk_ec2.types.describe_principal_id_format_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_principal_id_format_request.DescribePrincipalIdFormatRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribePrincipalIdFormat"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.describe_principal_id_format_request.serialize_ec2_query(
        input_, pairs, ""
    )
