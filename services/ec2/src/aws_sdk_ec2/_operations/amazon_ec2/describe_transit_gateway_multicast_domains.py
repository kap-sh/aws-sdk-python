...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_transit_gateway_multicast_domains_result.DescribeTransitGatewayMulticastDomainsResult = aws_sdk_ec2.types.describe_transit_gateway_multicast_domains_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_transit_gateway_multicast_domains_request.DescribeTransitGatewayMulticastDomainsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_transit_gateway_multicast_domains_request.serialize_ec2_query(
        input_, pairs, ""
    )
