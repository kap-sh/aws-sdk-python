...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_carrier_gateway_result.DeleteCarrierGatewayResult = (
        aws_sdk_ec2.types.delete_carrier_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_carrier_gateway_request.DeleteCarrierGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteCarrierGateway"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_carrier_gateway_request

    aws_sdk_ec2.types.delete_carrier_gateway_request.serialize_ec2_query(
        input_, pairs, ""
    )
