...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_snapshot_tier_result.ModifySnapshotTierResult = (
        aws_sdk_ec2.types.modify_snapshot_tier_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_snapshot_tier_request.ModifySnapshotTierRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifySnapshotTier"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.modify_snapshot_tier_request

    aws_sdk_ec2.types.modify_snapshot_tier_request.serialize_ec2_query(
        input_, pairs, ""
    )
