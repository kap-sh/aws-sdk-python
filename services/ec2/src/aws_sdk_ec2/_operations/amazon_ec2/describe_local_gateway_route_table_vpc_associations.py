...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_local_gateway_route_table_vpc_associations_result.DescribeLocalGatewayRouteTableVpcAssociationsResult = aws_sdk_ec2.types.describe_local_gateway_route_table_vpc_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_local_gateway_route_table_vpc_associations_request.DescribeLocalGatewayRouteTableVpcAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_local_gateway_route_table_vpc_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
