...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_vpc_encryption_control_result.DeleteVpcEncryptionControlResult = aws_sdk_ec2.types.delete_vpc_encryption_control_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_vpc_encryption_control_request.DeleteVpcEncryptionControlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteVpcEncryptionControl"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_vpc_encryption_control_request

    aws_sdk_ec2.types.delete_vpc_encryption_control_request.serialize_ec2_query(
        input_, pairs, ""
    )
