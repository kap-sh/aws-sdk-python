...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_local_gateway_virtual_interface_group_result.CreateLocalGatewayVirtualInterfaceGroupResult = aws_sdk_ec2.types.create_local_gateway_virtual_interface_group_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_local_gateway_virtual_interface_group_request.CreateLocalGatewayVirtualInterfaceGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_local_gateway_virtual_interface_group_request.serialize_ec2_query(
        input_, pairs, ""
    )
