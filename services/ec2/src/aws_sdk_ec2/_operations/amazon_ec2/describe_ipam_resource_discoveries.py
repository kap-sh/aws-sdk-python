...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_ipam_resource_discoveries_result.DescribeIpamResourceDiscoveriesResult = aws_sdk_ec2.types.describe_ipam_resource_discoveries_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_ipam_resource_discoveries_request.DescribeIpamResourceDiscoveriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_ipam_resource_discoveries_request.serialize_ec2_query(
        input_, pairs, ""
    )
