...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_enabled_ipam_policy_result.GetEnabledIpamPolicyResult = (
        aws_sdk_ec2.types.get_enabled_ipam_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_enabled_ipam_policy_request.GetEnabledIpamPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_enabled_ipam_policy_request.serialize_ec2_query(
        input_, pairs, ""
    )
