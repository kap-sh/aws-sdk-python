...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_instance_connect_endpoints_result.DescribeInstanceConnectEndpointsResult = aws_sdk_ec2.types.describe_instance_connect_endpoints_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_instance_connect_endpoints_request.DescribeInstanceConnectEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_instance_connect_endpoints_request.serialize_ec2_query(
        input_, pairs, ""
    )
