...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_network_acl_result.CreateNetworkAclResult = (
        aws_sdk_ec2.types.create_network_acl_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_network_acl_request.CreateNetworkAclRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_network_acl_request.serialize_ec2_query(input_, pairs, "")
