"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteIpam``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_ipam_result.DeleteIpamResult = (
        aws_sdk_ec2.types.delete_ipam_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_ipam_request.DeleteIpamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteIpam"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.delete_ipam_request.serialize_ec2_query(input_, pairs, "")
...
def delete_ipam(
    ...
    input_: aws_sdk_ec2.types.delete_ipam_request.DeleteIpamRequest,
) -> tuple[aws_sdk_ec2.types.delete_ipam_result.DeleteIpamResult, zapros.Response]:
