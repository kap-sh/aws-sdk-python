...
def handle_response(response: zapros.Response) -> aws_sdk_ec2.types.snapshot.Snapshot:
    out: aws_sdk_ec2.types.snapshot.Snapshot = (
        aws_sdk_ec2.types.snapshot.deserialize_ec2_query(fromstring(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_ec2.types.snapshot.Snapshot = (
        aws_sdk_ec2.types.snapshot.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_snapshot_request.CreateSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_snapshot_request.serialize_ec2_query(input_, pairs, "")
