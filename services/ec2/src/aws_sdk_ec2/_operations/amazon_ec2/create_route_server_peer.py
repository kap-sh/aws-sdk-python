...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_route_server_peer_result.CreateRouteServerPeerResult = aws_sdk_ec2.types.create_route_server_peer_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_route_server_peer_request.CreateRouteServerPeerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_route_server_peer_request.serialize_ec2_query(
        input_, pairs, ""
    )
