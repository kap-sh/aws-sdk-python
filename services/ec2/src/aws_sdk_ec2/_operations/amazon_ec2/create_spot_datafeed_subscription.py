...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_spot_datafeed_subscription_result.CreateSpotDatafeedSubscriptionResult = aws_sdk_ec2.types.create_spot_datafeed_subscription_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_spot_datafeed_subscription_request.CreateSpotDatafeedSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateSpotDatafeedSubscription"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_spot_datafeed_subscription_request

    aws_sdk_ec2.types.create_spot_datafeed_subscription_request.serialize_ec2_query(
        input_, pairs, ""
    )
