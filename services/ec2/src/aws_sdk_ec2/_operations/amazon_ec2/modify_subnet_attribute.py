...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_subnet_attribute_request.ModifySubnetAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_subnet_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
