...
) -> aws_sdk_ec2.types.get_coip_pool_usage_result.GetCoipPoolUsageResult:
    out: aws_sdk_ec2.types.get_coip_pool_usage_result.GetCoipPoolUsageResult = (
        aws_sdk_ec2.types.get_coip_pool_usage_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_coip_pool_usage_request.GetCoipPoolUsageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_coip_pool_usage_request.serialize_ec2_query(input_, pairs, "")
