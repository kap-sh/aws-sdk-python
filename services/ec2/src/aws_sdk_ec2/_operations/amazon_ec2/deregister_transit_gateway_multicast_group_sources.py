...
def handle_response(
    ...
    out: aws_sdk_ec2.types.deregister_transit_gateway_multicast_group_sources_result.DeregisterTransitGatewayMulticastGroupSourcesResult = aws_sdk_ec2.types.deregister_transit_gateway_multicast_group_sources_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.deregister_transit_gateway_multicast_group_sources_request.DeregisterTransitGatewayMulticastGroupSourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.deregister_transit_gateway_multicast_group_sources_request.serialize_ec2_query(
        input_, pairs, ""
    )
