...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_transit_gateway_route_table_associations_result.GetTransitGatewayRouteTableAssociationsResult = aws_sdk_ec2.types.get_transit_gateway_route_table_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_transit_gateway_route_table_associations_request.GetTransitGatewayRouteTableAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetTransitGatewayRouteTableAssociations"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.get_transit_gateway_route_table_associations_request

    aws_sdk_ec2.types.get_transit_gateway_route_table_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
