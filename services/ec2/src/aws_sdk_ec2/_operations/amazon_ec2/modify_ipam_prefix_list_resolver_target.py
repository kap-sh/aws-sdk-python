...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_ipam_prefix_list_resolver_target_result.ModifyIpamPrefixListResolverTargetResult = aws_sdk_ec2.types.modify_ipam_prefix_list_resolver_target_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_ipam_prefix_list_resolver_target_request.ModifyIpamPrefixListResolverTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_ipam_prefix_list_resolver_target_request.serialize_ec2_query(
        input_, pairs, ""
    )
