...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_vpc_endpoint_connection_notification_result.CreateVpcEndpointConnectionNotificationResult = aws_sdk_ec2.types.create_vpc_endpoint_connection_notification_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_vpc_endpoint_connection_notification_request.CreateVpcEndpointConnectionNotificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_vpc_endpoint_connection_notification_request.serialize_ec2_query(
        input_, pairs, ""
    )
