...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_network_interface_permissions_result.DescribeNetworkInterfacePermissionsResult = aws_sdk_ec2.types.describe_network_interface_permissions_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_network_interface_permissions_request.DescribeNetworkInterfacePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeNetworkInterfacePermissions"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_network_interface_permissions_request

    aws_sdk_ec2.types.describe_network_interface_permissions_request.serialize_ec2_query(
        input_, pairs, ""
    )
