...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_serial_console_access_status_result.GetSerialConsoleAccessStatusResult = aws_sdk_ec2.types.get_serial_console_access_status_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_serial_console_access_status_request.GetSerialConsoleAccessStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_serial_console_access_status_request.serialize_ec2_query(
        input_, pairs, ""
    )
