...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_vpn_gateway_request.DeleteVpnGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_vpn_gateway_request.serialize_ec2_query(input_, pairs, "")
