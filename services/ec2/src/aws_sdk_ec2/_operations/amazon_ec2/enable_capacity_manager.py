...
def handle_response(
    ...
    out: aws_sdk_ec2.types.enable_capacity_manager_result.EnableCapacityManagerResult = aws_sdk_ec2.types.enable_capacity_manager_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_capacity_manager_request.EnableCapacityManagerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.enable_capacity_manager_request.serialize_ec2_query(
        input_, pairs, ""
    )
