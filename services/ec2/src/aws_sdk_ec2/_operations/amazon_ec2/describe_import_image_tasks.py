"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeImportImageTasks``."""
...
def handle_response(
    ...
    aws_sdk_ec2.types.describe_import_image_tasks_result.DescribeImportImageTasksResult
):
    import aws_sdk_ec2.types.describe_import_image_tasks_result

    out: aws_sdk_ec2.types.describe_import_image_tasks_result.DescribeImportImageTasksResult = aws_sdk_ec2.types.describe_import_image_tasks_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_import_image_tasks_request.DescribeImportImageTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeImportImageTasks"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_import_image_tasks_request

    aws_sdk_ec2.types.describe_import_image_tasks_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_import_image_tasks(
