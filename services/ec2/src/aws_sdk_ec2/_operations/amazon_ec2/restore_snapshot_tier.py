...
def handle_response(
    ...
    out: aws_sdk_ec2.types.restore_snapshot_tier_result.RestoreSnapshotTierResult = (
        aws_sdk_ec2.types.restore_snapshot_tier_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.restore_snapshot_tier_request.RestoreSnapshotTierRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.restore_snapshot_tier_request.serialize_ec2_query(
        input_, pairs, ""
    )
