...
def handle_response(
    ...
    out: aws_sdk_ec2.types.copy_fpga_image_result.CopyFpgaImageResult = (
        aws_sdk_ec2.types.copy_fpga_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.copy_fpga_image_request.CopyFpgaImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CopyFpgaImage"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.copy_fpga_image_request

    aws_sdk_ec2.types.copy_fpga_image_request.serialize_ec2_query(input_, pairs, "")
