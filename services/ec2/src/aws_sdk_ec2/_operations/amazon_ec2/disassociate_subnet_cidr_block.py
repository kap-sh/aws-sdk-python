...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disassociate_subnet_cidr_block_result.DisassociateSubnetCidrBlockResult = aws_sdk_ec2.types.disassociate_subnet_cidr_block_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disassociate_subnet_cidr_block_request.DisassociateSubnetCidrBlockRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disassociate_subnet_cidr_block_request.serialize_ec2_query(
        input_, pairs, ""
    )
