...
def handle_response(
    ...
    out: aws_sdk_ec2.types.update_security_group_rule_descriptions_ingress_result.UpdateSecurityGroupRuleDescriptionsIngressResult = aws_sdk_ec2.types.update_security_group_rule_descriptions_ingress_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.update_security_group_rule_descriptions_ingress_request.UpdateSecurityGroupRuleDescriptionsIngressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.update_security_group_rule_descriptions_ingress_request.serialize_ec2_query(
        input_, pairs, ""
    )
