...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_public_ipv4_pool_result.CreatePublicIpv4PoolResult = (
        aws_sdk_ec2.types.create_public_ipv4_pool_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_public_ipv4_pool_request.CreatePublicIpv4PoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_public_ipv4_pool_request.serialize_ec2_query(
        input_, pairs, ""
    )
