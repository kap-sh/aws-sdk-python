...
def handle_response(
    ...
    out: aws_sdk_ec2.types.import_volume_result.ImportVolumeResult = (
        aws_sdk_ec2.types.import_volume_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.import_volume_request.ImportVolumeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ImportVolume"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.import_volume_request

    aws_sdk_ec2.types.import_volume_request.serialize_ec2_query(input_, pairs, "")
