...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_instance_event_windows_result.DescribeInstanceEventWindowsResult = aws_sdk_ec2.types.describe_instance_event_windows_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_instance_event_windows_request.DescribeInstanceEventWindowsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_instance_event_windows_request.serialize_ec2_query(
        input_, pairs, ""
    )
