"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyIdentityIdFormat``."""
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_identity_id_format_request.ModifyIdentityIdFormatRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyIdentityIdFormat"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.modify_identity_id_format_request

    aws_sdk_ec2.types.modify_identity_id_format_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_identity_id_format(
