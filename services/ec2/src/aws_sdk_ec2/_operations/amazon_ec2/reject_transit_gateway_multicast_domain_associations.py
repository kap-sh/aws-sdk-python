...
def handle_response(
    ...
    out: aws_sdk_ec2.types.reject_transit_gateway_multicast_domain_associations_result.RejectTransitGatewayMulticastDomainAssociationsResult = aws_sdk_ec2.types.reject_transit_gateway_multicast_domain_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.reject_transit_gateway_multicast_domain_associations_request.RejectTransitGatewayMulticastDomainAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RejectTransitGatewayMulticastDomainAssociations"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.reject_transit_gateway_multicast_domain_associations_request

    aws_sdk_ec2.types.reject_transit_gateway_multicast_domain_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
