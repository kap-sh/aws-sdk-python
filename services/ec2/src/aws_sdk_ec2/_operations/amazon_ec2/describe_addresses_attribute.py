...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_addresses_attribute_result.DescribeAddressesAttributeResult = aws_sdk_ec2.types.describe_addresses_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_addresses_attribute_request.DescribeAddressesAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeAddressesAttribute"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.describe_addresses_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
