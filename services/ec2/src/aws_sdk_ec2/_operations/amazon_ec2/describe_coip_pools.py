...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_coip_pools_result.DescribeCoipPoolsResult = (
        aws_sdk_ec2.types.describe_coip_pools_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_coip_pools_request.DescribeCoipPoolsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_coip_pools_request.serialize_ec2_query(input_, pairs, "")
