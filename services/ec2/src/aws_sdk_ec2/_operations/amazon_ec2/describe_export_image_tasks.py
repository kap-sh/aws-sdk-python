...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_export_image_tasks_result.DescribeExportImageTasksResult = aws_sdk_ec2.types.describe_export_image_tasks_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_export_image_tasks_request.DescribeExportImageTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_export_image_tasks_request.serialize_ec2_query(
        input_, pairs, ""
    )
