...
def build_request(
    ...
    input: aws_sdk_ec2.types.describe_mac_hosts_request.DescribeMacHostsRequest,
) -> zapros.Request:
    ...
    aws_sdk_ec2.types.describe_mac_hosts_request.serialize_ec2_query(input, pairs, "")
