...
) -> aws_sdk_ec2.types.describe_mac_hosts_result.DescribeMacHostsResult:
    import aws_sdk_ec2.types.describe_mac_hosts_result

    out: aws_sdk_ec2.types.describe_mac_hosts_result.DescribeMacHostsResult = (
        aws_sdk_ec2.types.describe_mac_hosts_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_mac_hosts_request.DescribeMacHostsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_mac_hosts_request.serialize_ec2_query(input_, pairs, "")
...
def describe_mac_hosts(
    ...
    aws_sdk_ec2.types.describe_mac_hosts_result.DescribeMacHostsResult, zapros.Response
]:
