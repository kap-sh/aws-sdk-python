...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_dhcp_options_result.DescribeDhcpOptionsResult = (
        aws_sdk_ec2.types.describe_dhcp_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_dhcp_options_request.DescribeDhcpOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_dhcp_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
