...
def handle_response(
    ...
    out: aws_sdk_ec2.types.update_capacity_manager_organizations_access_result.UpdateCapacityManagerOrganizationsAccessResult = aws_sdk_ec2.types.update_capacity_manager_organizations_access_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.update_capacity_manager_organizations_access_request.UpdateCapacityManagerOrganizationsAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.update_capacity_manager_organizations_access_request.serialize_ec2_query(
        input_, pairs, ""
    )
