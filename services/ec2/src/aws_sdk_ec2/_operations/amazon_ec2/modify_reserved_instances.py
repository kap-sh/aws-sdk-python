...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_reserved_instances_result.ModifyReservedInstancesResult = aws_sdk_ec2.types.modify_reserved_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_reserved_instances_request.ModifyReservedInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_reserved_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
