...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_image_block_public_access_state_result.GetImageBlockPublicAccessStateResult = aws_sdk_ec2.types.get_image_block_public_access_state_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_image_block_public_access_state_request.GetImageBlockPublicAccessStateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_image_block_public_access_state_request.serialize_ec2_query(
        input_, pairs, ""
    )
