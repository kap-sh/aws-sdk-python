...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_ipam_external_resource_verification_tokens_result.DescribeIpamExternalResourceVerificationTokensResult = aws_sdk_ec2.types.describe_ipam_external_resource_verification_tokens_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_ipam_external_resource_verification_tokens_request.DescribeIpamExternalResourceVerificationTokensRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeIpamExternalResourceVerificationTokens"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_ipam_external_resource_verification_tokens_request

    aws_sdk_ec2.types.describe_ipam_external_resource_verification_tokens_request.serialize_ec2_query(
        input_, pairs, ""
    )
