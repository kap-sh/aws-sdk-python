...
) -> aws_sdk_ec2.types.delete_transit_gateway_connect_result.DeleteTransitGatewayConnectResult:
    out: aws_sdk_ec2.types.delete_transit_gateway_connect_result.DeleteTransitGatewayConnectResult = aws_sdk_ec2.types.delete_transit_gateway_connect_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_transit_gateway_connect_request.DeleteTransitGatewayConnectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_transit_gateway_connect_request.serialize_ec2_query(
        input_, pairs, ""
    )
