...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_instance_types_result.DescribeInstanceTypesResult = aws_sdk_ec2.types.describe_instance_types_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_instance_types_request.DescribeInstanceTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeInstanceTypes"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_instance_types_request

    aws_sdk_ec2.types.describe_instance_types_request.serialize_ec2_query(
        input_, pairs, ""
    )
