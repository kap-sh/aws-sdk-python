...
) -> aws_sdk_ec2.types.delete_coip_cidr_result.DeleteCoipCidrResult:
    out: aws_sdk_ec2.types.delete_coip_cidr_result.DeleteCoipCidrResult = (
        aws_sdk_ec2.types.delete_coip_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_coip_cidr_request.DeleteCoipCidrRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteCoipCidr"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.delete_coip_cidr_request.serialize_ec2_query(input_, pairs, "")
