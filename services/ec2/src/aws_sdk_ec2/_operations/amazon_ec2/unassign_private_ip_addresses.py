...
def build_request(
    ...
    input_: aws_sdk_ec2.types.unassign_private_ip_addresses_request.UnassignPrivateIpAddressesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UnassignPrivateIpAddresses"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.unassign_private_ip_addresses_request.serialize_ec2_query(
        input_, pairs, ""
    )
