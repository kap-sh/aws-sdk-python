...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_instance_connect_endpoint_result.DeleteInstanceConnectEndpointResult = aws_sdk_ec2.types.delete_instance_connect_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_instance_connect_endpoint_request.DeleteInstanceConnectEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
