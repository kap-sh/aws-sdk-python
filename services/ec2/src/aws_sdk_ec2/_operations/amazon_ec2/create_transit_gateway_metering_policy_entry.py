"""Generated from Smithy shape ``com.amazonaws.ec2#CreateTransitGatewayMeteringPolicyEntry``."""
...
) -> aws_sdk_ec2.types.create_transit_gateway_metering_policy_entry_result.CreateTransitGatewayMeteringPolicyEntryResult:
    out: aws_sdk_ec2.types.create_transit_gateway_metering_policy_entry_result.CreateTransitGatewayMeteringPolicyEntryResult = aws_sdk_ec2.types.create_transit_gateway_metering_policy_entry_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_transit_gateway_metering_policy_entry_request.CreateTransitGatewayMeteringPolicyEntryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateTransitGatewayMeteringPolicyEntry"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_transit_gateway_metering_policy_entry_request

    aws_sdk_ec2.types.create_transit_gateway_metering_policy_entry_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_create_transit_gateway_metering_policy_entry(
