...
def handle_response(
    ...
    out: aws_sdk_ec2.types.deprovision_ipam_byoasn_result.DeprovisionIpamByoasnResult = aws_sdk_ec2.types.deprovision_ipam_byoasn_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.deprovision_ipam_byoasn_request.DeprovisionIpamByoasnRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.deprovision_ipam_byoasn_request.serialize_ec2_query(
        input_, pairs, ""
    )
