...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_capacity_reservation_billing_requests_result.DescribeCapacityReservationBillingRequestsResult = aws_sdk_ec2.types.describe_capacity_reservation_billing_requests_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_capacity_reservation_billing_requests_request.DescribeCapacityReservationBillingRequestsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeCapacityReservationBillingRequests"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.describe_capacity_reservation_billing_requests_request.serialize_ec2_query(
        input_, pairs, ""
    )
