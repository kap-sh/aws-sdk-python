...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_vpn_connection_device_sample_configuration_result.GetVpnConnectionDeviceSampleConfigurationResult = aws_sdk_ec2.types.get_vpn_connection_device_sample_configuration_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_vpn_connection_device_sample_configuration_request.GetVpnConnectionDeviceSampleConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_vpn_connection_device_sample_configuration_request.serialize_ec2_query(
        input_, pairs, ""
    )
