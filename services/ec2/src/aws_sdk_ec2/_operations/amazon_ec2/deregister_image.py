...
def handle_response(
    ...
    out: aws_sdk_ec2.types.deregister_image_result.DeregisterImageResult = (
        aws_sdk_ec2.types.deregister_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.deregister_image_request.DeregisterImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.deregister_image_request.serialize_ec2_query(input_, pairs, "")
