...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_network_interfaces_result.DescribeNetworkInterfacesResult = aws_sdk_ec2.types.describe_network_interfaces_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_network_interfaces_request.DescribeNetworkInterfacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeNetworkInterfaces"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_network_interfaces_request

    aws_sdk_ec2.types.describe_network_interfaces_request.serialize_ec2_query(
        input_, pairs, ""
    )
