...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_reserved_instances_listing_result.CreateReservedInstancesListingResult = aws_sdk_ec2.types.create_reserved_instances_listing_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_reserved_instances_listing_request.CreateReservedInstancesListingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_reserved_instances_listing_request.serialize_ec2_query(
        input_, pairs, ""
    )
