...
def handle_response(
    ...
    out: aws_sdk_ec2.types.start_network_insights_access_scope_analysis_result.StartNetworkInsightsAccessScopeAnalysisResult = aws_sdk_ec2.types.start_network_insights_access_scope_analysis_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.start_network_insights_access_scope_analysis_request.StartNetworkInsightsAccessScopeAnalysisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "StartNetworkInsightsAccessScopeAnalysis"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.start_network_insights_access_scope_analysis_request

    aws_sdk_ec2.types.start_network_insights_access_scope_analysis_request.serialize_ec2_query(
        input_, pairs, ""
    )
