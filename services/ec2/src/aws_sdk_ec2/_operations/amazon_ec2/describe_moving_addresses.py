...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_moving_addresses_result.DescribeMovingAddressesResult = aws_sdk_ec2.types.describe_moving_addresses_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_moving_addresses_request.DescribeMovingAddressesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_moving_addresses_request.serialize_ec2_query(
        input_, pairs, ""
    )
