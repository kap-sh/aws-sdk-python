...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_security_groups_for_vpc_result.GetSecurityGroupsForVpcResult = aws_sdk_ec2.types.get_security_groups_for_vpc_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_security_groups_for_vpc_request.GetSecurityGroupsForVpcRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_security_groups_for_vpc_request.serialize_ec2_query(
        input_, pairs, ""
    )
