"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteEgressOnlyInternetGateway``."""
...
) -> aws_sdk_ec2.types.delete_egress_only_internet_gateway_result.DeleteEgressOnlyInternetGatewayResult:
    out: aws_sdk_ec2.types.delete_egress_only_internet_gateway_result.DeleteEgressOnlyInternetGatewayResult = aws_sdk_ec2.types.delete_egress_only_internet_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_egress_only_internet_gateway_request.DeleteEgressOnlyInternetGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_egress_only_internet_gateway(
