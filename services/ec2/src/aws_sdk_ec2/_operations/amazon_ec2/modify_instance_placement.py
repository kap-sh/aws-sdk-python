...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_instance_placement_result.ModifyInstancePlacementResult = aws_sdk_ec2.types.modify_instance_placement_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_instance_placement_request.ModifyInstancePlacementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_instance_placement_request.serialize_ec2_query(
        input_, pairs, ""
    )
