...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_transit_gateway_connect_peer_result.CreateTransitGatewayConnectPeerResult = aws_sdk_ec2.types.create_transit_gateway_connect_peer_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_transit_gateway_connect_peer_request.CreateTransitGatewayConnectPeerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_transit_gateway_connect_peer_request.serialize_ec2_query(
        input_, pairs, ""
    )
