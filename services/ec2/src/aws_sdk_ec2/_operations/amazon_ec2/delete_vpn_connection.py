...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_vpn_connection_request.DeleteVpnConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteVpnConnection"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_vpn_connection_request

    aws_sdk_ec2.types.delete_vpn_connection_request.serialize_ec2_query(
        input_, pairs, ""
    )
