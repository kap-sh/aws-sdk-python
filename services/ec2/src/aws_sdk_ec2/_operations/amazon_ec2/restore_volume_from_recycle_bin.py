...
def handle_response(
    ...
    out: aws_sdk_ec2.types.restore_volume_from_recycle_bin_result.RestoreVolumeFromRecycleBinResult = aws_sdk_ec2.types.restore_volume_from_recycle_bin_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.restore_volume_from_recycle_bin_request.RestoreVolumeFromRecycleBinRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.restore_volume_from_recycle_bin_request.serialize_ec2_query(
        input_, pairs, ""
    )
