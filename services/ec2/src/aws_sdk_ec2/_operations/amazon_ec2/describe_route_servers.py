...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_route_servers_result.DescribeRouteServersResult = (
        aws_sdk_ec2.types.describe_route_servers_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_route_servers_request.DescribeRouteServersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_route_servers_request.serialize_ec2_query(
        input_, pairs, ""
    )
