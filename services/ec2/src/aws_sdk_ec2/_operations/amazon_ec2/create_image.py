...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_image_result.CreateImageResult = (
        aws_sdk_ec2.types.create_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_image_request.CreateImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_image_request.serialize_ec2_query(input_, pairs, "")
...
def create_image(
    ...
    input_: aws_sdk_ec2.types.create_image_request.CreateImageRequest,
) -> tuple[aws_sdk_ec2.types.create_image_result.CreateImageResult, zapros.Response]:
