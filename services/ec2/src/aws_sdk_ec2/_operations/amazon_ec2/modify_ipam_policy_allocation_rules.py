...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_ipam_policy_allocation_rules_result.ModifyIpamPolicyAllocationRulesResult = aws_sdk_ec2.types.modify_ipam_policy_allocation_rules_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_ipam_policy_allocation_rules_request.ModifyIpamPolicyAllocationRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_ipam_policy_allocation_rules_request.serialize_ec2_query(
        input_, pairs, ""
    )
