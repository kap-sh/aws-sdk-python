...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_subnets_result.DescribeSubnetsResult = (
        aws_sdk_ec2.types.describe_subnets_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_subnets_request.DescribeSubnetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeSubnets"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_subnets_request

    aws_sdk_ec2.types.describe_subnets_request.serialize_ec2_query(input_, pairs, "")
