...
def build_request(
    ...
    input: aws_sdk_ec2.types.cancel_import_task_request.CancelImportTaskRequest,
) -> zapros.Request:
    ...
    aws_sdk_ec2.types.cancel_import_task_request.serialize_ec2_query(input, pairs, "")
