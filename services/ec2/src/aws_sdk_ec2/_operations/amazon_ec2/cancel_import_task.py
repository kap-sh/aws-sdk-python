...
def handle_response(
    ...
    out: aws_sdk_ec2.types.cancel_import_task_result.CancelImportTaskResult = (
        aws_sdk_ec2.types.cancel_import_task_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.cancel_import_task_request.CancelImportTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.cancel_import_task_request.serialize_ec2_query(input_, pairs, "")
...
def cancel_import_task(
    ...
    aws_sdk_ec2.types.cancel_import_task_result.CancelImportTaskResult, zapros.Response
]:
