...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_ipam_external_resource_verification_token_result.CreateIpamExternalResourceVerificationTokenResult = aws_sdk_ec2.types.create_ipam_external_resource_verification_token_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_ipam_external_resource_verification_token_request.CreateIpamExternalResourceVerificationTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_ipam_external_resource_verification_token_request.serialize_ec2_query(
        input_, pairs, ""
    )
