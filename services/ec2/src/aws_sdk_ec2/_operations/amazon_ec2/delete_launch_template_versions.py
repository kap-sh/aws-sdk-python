...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_launch_template_versions_result.DeleteLaunchTemplateVersionsResult = aws_sdk_ec2.types.delete_launch_template_versions_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_launch_template_versions_request.DeleteLaunchTemplateVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_launch_template_versions_request.serialize_ec2_query(
        input_, pairs, ""
    )
