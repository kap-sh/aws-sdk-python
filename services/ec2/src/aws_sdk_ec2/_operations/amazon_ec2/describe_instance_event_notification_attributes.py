...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_instance_event_notification_attributes_result.DescribeInstanceEventNotificationAttributesResult = aws_sdk_ec2.types.describe_instance_event_notification_attributes_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_instance_event_notification_attributes_request.DescribeInstanceEventNotificationAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeInstanceEventNotificationAttributes"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_instance_event_notification_attributes_request

    aws_sdk_ec2.types.describe_instance_event_notification_attributes_request.serialize_ec2_query(
        input_, pairs, ""
    )
