...
) -> aws_sdk_ec2.types.lock_snapshot_result.LockSnapshotResult:
    out: aws_sdk_ec2.types.lock_snapshot_result.LockSnapshotResult = (
        aws_sdk_ec2.types.lock_snapshot_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.lock_snapshot_request.LockSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.lock_snapshot_request.serialize_ec2_query(input_, pairs, "")
