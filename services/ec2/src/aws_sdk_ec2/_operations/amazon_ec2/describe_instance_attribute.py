...
) -> aws_sdk_ec2.types.instance_attribute.InstanceAttribute:
    import aws_sdk_ec2.types.instance_attribute

    out: aws_sdk_ec2.types.instance_attribute.InstanceAttribute = (
        aws_sdk_ec2.types.instance_attribute.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_instance_attribute_request.DescribeInstanceAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_instance_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
