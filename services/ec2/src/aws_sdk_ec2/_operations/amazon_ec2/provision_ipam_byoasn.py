...
def handle_response(
    ...
    out: aws_sdk_ec2.types.provision_ipam_byoasn_result.ProvisionIpamByoasnResult = (
        aws_sdk_ec2.types.provision_ipam_byoasn_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.provision_ipam_byoasn_request.ProvisionIpamByoasnRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
