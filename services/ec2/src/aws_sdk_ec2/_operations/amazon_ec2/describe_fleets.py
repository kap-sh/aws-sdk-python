...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_fleets_result.DescribeFleetsResult = (
        aws_sdk_ec2.types.describe_fleets_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_fleets_request.DescribeFleetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeFleets"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_fleets_request

    aws_sdk_ec2.types.describe_fleets_request.serialize_ec2_query(input_, pairs, "")
