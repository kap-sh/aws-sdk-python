...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_flow_logs_result.CreateFlowLogsResult = (
        aws_sdk_ec2.types.create_flow_logs_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_flow_logs_request.CreateFlowLogsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_flow_logs_request.serialize_ec2_query(input_, pairs, "")
