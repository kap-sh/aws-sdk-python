...
def handle_response(
    ...
    out: aws_sdk_ec2.types.advertise_byoip_cidr_result.AdvertiseByoipCidrResult = (
        aws_sdk_ec2.types.advertise_byoip_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.advertise_byoip_cidr_request.AdvertiseByoipCidrRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.advertise_byoip_cidr_request.serialize_ec2_query(
        input_, pairs, ""
    )
