...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_instance_capacity_reservation_attributes_result.ModifyInstanceCapacityReservationAttributesResult = aws_sdk_ec2.types.modify_instance_capacity_reservation_attributes_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_instance_capacity_reservation_attributes_request.ModifyInstanceCapacityReservationAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_instance_capacity_reservation_attributes_request.serialize_ec2_query(
        input_, pairs, ""
    )
