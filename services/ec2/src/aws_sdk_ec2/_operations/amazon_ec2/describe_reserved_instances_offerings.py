...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_reserved_instances_offerings_result.DescribeReservedInstancesOfferingsResult = aws_sdk_ec2.types.describe_reserved_instances_offerings_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_reserved_instances_offerings_request.DescribeReservedInstancesOfferingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeReservedInstancesOfferings"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_reserved_instances_offerings_request

    aws_sdk_ec2.types.describe_reserved_instances_offerings_request.serialize_ec2_query(
        input_, pairs, ""
    )
