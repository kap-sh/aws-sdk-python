...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_local_gateway_virtual_interface_result.DeleteLocalGatewayVirtualInterfaceResult = aws_sdk_ec2.types.delete_local_gateway_virtual_interface_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_local_gateway_virtual_interface_request.DeleteLocalGatewayVirtualInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_local_gateway_virtual_interface_request.serialize_ec2_query(
        input_, pairs, ""
    )
