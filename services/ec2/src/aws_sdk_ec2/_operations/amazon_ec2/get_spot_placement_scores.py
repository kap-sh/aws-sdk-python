...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_spot_placement_scores_result.GetSpotPlacementScoresResult = aws_sdk_ec2.types.get_spot_placement_scores_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_spot_placement_scores_request.GetSpotPlacementScoresRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetSpotPlacementScores"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.get_spot_placement_scores_request.serialize_ec2_query(
        input_, pairs, ""
    )
