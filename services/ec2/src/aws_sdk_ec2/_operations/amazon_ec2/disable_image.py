...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disable_image_result.DisableImageResult = (
        aws_sdk_ec2.types.disable_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disable_image_request.DisableImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disable_image_request.serialize_ec2_query(input_, pairs, "")
