...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disassociate_security_group_vpc_result.DisassociateSecurityGroupVpcResult = aws_sdk_ec2.types.disassociate_security_group_vpc_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disassociate_security_group_vpc_request.DisassociateSecurityGroupVpcRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DisassociateSecurityGroupVpc"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.disassociate_security_group_vpc_request

    aws_sdk_ec2.types.disassociate_security_group_vpc_request.serialize_ec2_query(
        input_, pairs, ""
    )
