"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTransitGatewayPolicyTable``."""
...
) -> aws_sdk_ec2.types.delete_transit_gateway_policy_table_result.DeleteTransitGatewayPolicyTableResult:
    out: aws_sdk_ec2.types.delete_transit_gateway_policy_table_result.DeleteTransitGatewayPolicyTableResult = aws_sdk_ec2.types.delete_transit_gateway_policy_table_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_transit_gateway_policy_table_request.DeleteTransitGatewayPolicyTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteTransitGatewayPolicyTable"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.delete_transit_gateway_policy_table_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_transit_gateway_policy_table(
