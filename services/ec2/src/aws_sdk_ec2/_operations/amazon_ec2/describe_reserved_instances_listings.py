...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_reserved_instances_listings_result.DescribeReservedInstancesListingsResult = aws_sdk_ec2.types.describe_reserved_instances_listings_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_reserved_instances_listings_request.DescribeReservedInstancesListingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_reserved_instances_listings_request.serialize_ec2_query(
        input_, pairs, ""
    )
