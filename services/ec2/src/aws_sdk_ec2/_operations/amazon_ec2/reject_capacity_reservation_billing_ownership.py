...
def handle_response(
    ...
    out: aws_sdk_ec2.types.reject_capacity_reservation_billing_ownership_result.RejectCapacityReservationBillingOwnershipResult = aws_sdk_ec2.types.reject_capacity_reservation_billing_ownership_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.reject_capacity_reservation_billing_ownership_request.RejectCapacityReservationBillingOwnershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.reject_capacity_reservation_billing_ownership_request.serialize_ec2_query(
        input_, pairs, ""
    )
