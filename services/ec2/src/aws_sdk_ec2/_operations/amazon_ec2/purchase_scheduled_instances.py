...
def handle_response(
    ...
    out: aws_sdk_ec2.types.purchase_scheduled_instances_result.PurchaseScheduledInstancesResult = aws_sdk_ec2.types.purchase_scheduled_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.purchase_scheduled_instances_request.PurchaseScheduledInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.purchase_scheduled_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
