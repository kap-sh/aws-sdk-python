...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_instance_event_window_result.CreateInstanceEventWindowResult = aws_sdk_ec2.types.create_instance_event_window_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_instance_event_window_request.CreateInstanceEventWindowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateInstanceEventWindow"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_instance_event_window_request

    aws_sdk_ec2.types.create_instance_event_window_request.serialize_ec2_query(
        input_, pairs, ""
    )
