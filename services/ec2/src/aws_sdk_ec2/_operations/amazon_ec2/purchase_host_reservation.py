...
def handle_response(
    ...
    out: aws_sdk_ec2.types.purchase_host_reservation_result.PurchaseHostReservationResult = aws_sdk_ec2.types.purchase_host_reservation_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.purchase_host_reservation_request.PurchaseHostReservationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.purchase_host_reservation_request.serialize_ec2_query(
        input_, pairs, ""
    )
