...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_vpc_resources_blocking_encryption_enforcement_result.GetVpcResourcesBlockingEncryptionEnforcementResult = aws_sdk_ec2.types.get_vpc_resources_blocking_encryption_enforcement_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_vpc_resources_blocking_encryption_enforcement_request.GetVpcResourcesBlockingEncryptionEnforcementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_vpc_resources_blocking_encryption_enforcement_request.serialize_ec2_query(
        input_, pairs, ""
    )
