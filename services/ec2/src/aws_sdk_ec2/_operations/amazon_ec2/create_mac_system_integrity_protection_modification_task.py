...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_mac_system_integrity_protection_modification_task_result.CreateMacSystemIntegrityProtectionModificationTaskResult = aws_sdk_ec2.types.create_mac_system_integrity_protection_modification_task_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_mac_system_integrity_protection_modification_task_request.CreateMacSystemIntegrityProtectionModificationTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateMacSystemIntegrityProtectionModificationTask"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_mac_system_integrity_protection_modification_task_request

    aws_sdk_ec2.types.create_mac_system_integrity_protection_modification_task_request.serialize_ec2_query(
        input_, pairs, ""
    )
