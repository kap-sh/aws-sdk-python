...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_default_credit_specification_result.GetDefaultCreditSpecificationResult = aws_sdk_ec2.types.get_default_credit_specification_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_default_credit_specification_request.GetDefaultCreditSpecificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_default_credit_specification_request.serialize_ec2_query(
        input_, pairs, ""
    )
