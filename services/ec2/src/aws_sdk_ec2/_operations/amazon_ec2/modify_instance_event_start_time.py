...
) -> aws_sdk_ec2.types.modify_instance_event_start_time_result.ModifyInstanceEventStartTimeResult:
    out: aws_sdk_ec2.types.modify_instance_event_start_time_result.ModifyInstanceEventStartTimeResult = aws_sdk_ec2.types.modify_instance_event_start_time_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_instance_event_start_time_request.ModifyInstanceEventStartTimeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_instance_event_start_time_request.serialize_ec2_query(
        input_, pairs, ""
    )
