...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_route_result.CreateRouteResult = (
        aws_sdk_ec2.types.create_route_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_route_request.CreateRouteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateRoute"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.create_route_request.serialize_ec2_query(input_, pairs, "")
