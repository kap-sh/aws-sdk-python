...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_local_gateway_virtual_interface_result.CreateLocalGatewayVirtualInterfaceResult = aws_sdk_ec2.types.create_local_gateway_virtual_interface_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_local_gateway_virtual_interface_request.CreateLocalGatewayVirtualInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateLocalGatewayVirtualInterface"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.create_local_gateway_virtual_interface_request.serialize_ec2_query(
        input_, pairs, ""
    )
