...
def handle_response(
    ...
    out: aws_sdk_ec2.types.purchase_reserved_instances_offering_result.PurchaseReservedInstancesOfferingResult = aws_sdk_ec2.types.purchase_reserved_instances_offering_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.purchase_reserved_instances_offering_request.PurchaseReservedInstancesOfferingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.purchase_reserved_instances_offering_request.serialize_ec2_query(
        input_, pairs, ""
    )
