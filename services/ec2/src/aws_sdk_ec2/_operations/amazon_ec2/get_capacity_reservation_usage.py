...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_capacity_reservation_usage_result.GetCapacityReservationUsageResult = aws_sdk_ec2.types.get_capacity_reservation_usage_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_capacity_reservation_usage_request.GetCapacityReservationUsageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_capacity_reservation_usage_request.serialize_ec2_query(
        input_, pairs, ""
    )
