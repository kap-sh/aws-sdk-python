...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_traffic_mirror_session_result.CreateTrafficMirrorSessionResult = aws_sdk_ec2.types.create_traffic_mirror_session_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_traffic_mirror_session_request.CreateTrafficMirrorSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
