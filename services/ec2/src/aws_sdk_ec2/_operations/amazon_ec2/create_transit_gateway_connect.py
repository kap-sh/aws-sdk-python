...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_transit_gateway_connect_result.CreateTransitGatewayConnectResult = aws_sdk_ec2.types.create_transit_gateway_connect_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_transit_gateway_connect_request.CreateTransitGatewayConnectRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_transit_gateway_connect_request.serialize_ec2_query(
        input_, pairs, ""
    )
