...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_nat_gateways_result.DescribeNatGatewaysResult = (
        aws_sdk_ec2.types.describe_nat_gateways_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_nat_gateways_request.DescribeNatGatewaysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_nat_gateways_request.serialize_ec2_query(
        input_, pairs, ""
    )
