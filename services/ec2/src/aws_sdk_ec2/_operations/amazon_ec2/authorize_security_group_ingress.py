...
def handle_response(
    ...
    out: aws_sdk_ec2.types.authorize_security_group_ingress_result.AuthorizeSecurityGroupIngressResult = aws_sdk_ec2.types.authorize_security_group_ingress_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.authorize_security_group_ingress_request.AuthorizeSecurityGroupIngressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.authorize_security_group_ingress_request.serialize_ec2_query(
        input_, pairs, ""
    )
