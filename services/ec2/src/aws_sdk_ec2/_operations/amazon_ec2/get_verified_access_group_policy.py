...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_verified_access_group_policy_result.GetVerifiedAccessGroupPolicyResult = aws_sdk_ec2.types.get_verified_access_group_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_verified_access_group_policy_request.GetVerifiedAccessGroupPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetVerifiedAccessGroupPolicy"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.get_verified_access_group_policy_request

    aws_sdk_ec2.types.get_verified_access_group_policy_request.serialize_ec2_query(
        input_, pairs, ""
    )
