...
def handle_response(
    ...
    out: aws_sdk_ec2.types.cancel_capacity_reservation_fleets_result.CancelCapacityReservationFleetsResult = aws_sdk_ec2.types.cancel_capacity_reservation_fleets_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.cancel_capacity_reservation_fleets_request.CancelCapacityReservationFleetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CancelCapacityReservationFleets"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.cancel_capacity_reservation_fleets_request

    aws_sdk_ec2.types.cancel_capacity_reservation_fleets_request.serialize_ec2_query(
        input_, pairs, ""
    )
