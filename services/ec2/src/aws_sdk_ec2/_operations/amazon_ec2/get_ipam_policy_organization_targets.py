...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_ipam_policy_organization_targets_result.GetIpamPolicyOrganizationTargetsResult = aws_sdk_ec2.types.get_ipam_policy_organization_targets_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_ipam_policy_organization_targets_request.GetIpamPolicyOrganizationTargetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_ipam_policy_organization_targets_request.serialize_ec2_query(
        input_, pairs, ""
    )
