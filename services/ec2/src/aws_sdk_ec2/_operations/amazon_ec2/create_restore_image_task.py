...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_restore_image_task_result.CreateRestoreImageTaskResult = aws_sdk_ec2.types.create_restore_image_task_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_restore_image_task_request.CreateRestoreImageTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_restore_image_task_request.serialize_ec2_query(
        input_, pairs, ""
    )
