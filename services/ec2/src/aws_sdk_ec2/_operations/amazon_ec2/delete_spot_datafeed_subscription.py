...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_spot_datafeed_subscription_request.DeleteSpotDatafeedSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteSpotDatafeedSubscription"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_spot_datafeed_subscription_request

    aws_sdk_ec2.types.delete_spot_datafeed_subscription_request.serialize_ec2_query(
        input_, pairs, ""
    )
