...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_placement_group_result.CreatePlacementGroupResult = (
        aws_sdk_ec2.types.create_placement_group_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_placement_group_request.CreatePlacementGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_placement_group_request.serialize_ec2_query(
        input_, pairs, ""
    )
