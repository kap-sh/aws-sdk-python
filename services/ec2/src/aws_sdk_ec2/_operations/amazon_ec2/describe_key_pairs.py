...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_key_pairs_result.DescribeKeyPairsResult = (
        aws_sdk_ec2.types.describe_key_pairs_result.deserialize_ec2_query(
...
def build_request(
    ...
    aws_sdk_ec2.types.describe_key_pairs_request.serialize_ec2_query(input, pairs, "")
