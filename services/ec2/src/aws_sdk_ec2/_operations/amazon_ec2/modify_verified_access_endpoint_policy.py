...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_verified_access_endpoint_policy_result.ModifyVerifiedAccessEndpointPolicyResult = aws_sdk_ec2.types.modify_verified_access_endpoint_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_verified_access_endpoint_policy_request.ModifyVerifiedAccessEndpointPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_verified_access_endpoint_policy_request.serialize_ec2_query(
        input_, pairs, ""
    )
