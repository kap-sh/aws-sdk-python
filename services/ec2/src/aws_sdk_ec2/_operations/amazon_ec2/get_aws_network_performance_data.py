...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_aws_network_performance_data_result.GetAwsNetworkPerformanceDataResult = aws_sdk_ec2.types.get_aws_network_performance_data_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_aws_network_performance_data_request.GetAwsNetworkPerformanceDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_aws_network_performance_data_request.serialize_ec2_query(
        input_, pairs, ""
    )
