...
def handle_response(
    ...
    out: aws_sdk_ec2.types.release_ipam_pool_allocation_result.ReleaseIpamPoolAllocationResult = aws_sdk_ec2.types.release_ipam_pool_allocation_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.release_ipam_pool_allocation_request.ReleaseIpamPoolAllocationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ReleaseIpamPoolAllocation"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.release_ipam_pool_allocation_request

    aws_sdk_ec2.types.release_ipam_pool_allocation_request.serialize_ec2_query(
        input_, pairs, ""
    )
