...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_prefix_lists_result.DescribePrefixListsResult = (
        aws_sdk_ec2.types.describe_prefix_lists_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_prefix_lists_request.DescribePrefixListsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_prefix_lists_request.serialize_ec2_query(
        input_, pairs, ""
    )
