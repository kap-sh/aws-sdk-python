...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_instance_credit_specification_result.ModifyInstanceCreditSpecificationResult = aws_sdk_ec2.types.modify_instance_credit_specification_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_instance_credit_specification_request.ModifyInstanceCreditSpecificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyInstanceCreditSpecification"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.modify_instance_credit_specification_request

    aws_sdk_ec2.types.modify_instance_credit_specification_request.serialize_ec2_query(
        input_, pairs, ""
    )
