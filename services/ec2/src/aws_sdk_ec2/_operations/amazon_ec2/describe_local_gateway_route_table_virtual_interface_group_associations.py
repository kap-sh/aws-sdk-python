...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_local_gateway_route_table_virtual_interface_group_associations_result.DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsResult = aws_sdk_ec2.types.describe_local_gateway_route_table_virtual_interface_group_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_local_gateway_route_table_virtual_interface_group_associations_request.DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_local_gateway_route_table_virtual_interface_group_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
