...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_bundle_tasks_result.DescribeBundleTasksResult = (
        aws_sdk_ec2.types.describe_bundle_tasks_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_bundle_tasks_request.DescribeBundleTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_bundle_tasks_request.serialize_ec2_query(
        input_, pairs, ""
    )
