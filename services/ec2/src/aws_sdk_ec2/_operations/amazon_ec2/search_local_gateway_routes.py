...
def handle_response(
    ...
    out: aws_sdk_ec2.types.search_local_gateway_routes_result.SearchLocalGatewayRoutesResult = aws_sdk_ec2.types.search_local_gateway_routes_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.search_local_gateway_routes_request.SearchLocalGatewayRoutesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
