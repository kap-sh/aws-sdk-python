...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_secondary_subnet_result.CreateSecondarySubnetResult = aws_sdk_ec2.types.create_secondary_subnet_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_secondary_subnet_request.CreateSecondarySubnetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_secondary_subnet_request.serialize_ec2_query(
        input_, pairs, ""
    )
