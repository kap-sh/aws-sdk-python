...
) -> aws_sdk_ec2.types.describe_addresses_result.DescribeAddressesResult:
    out: aws_sdk_ec2.types.describe_addresses_result.DescribeAddressesResult = (
        aws_sdk_ec2.types.describe_addresses_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_addresses_request.DescribeAddressesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_addresses_request.serialize_ec2_query(input_, pairs, "")
...
def describe_addresses(
    ...
    aws_sdk_ec2.types.describe_addresses_result.DescribeAddressesResult, zapros.Response
]:
