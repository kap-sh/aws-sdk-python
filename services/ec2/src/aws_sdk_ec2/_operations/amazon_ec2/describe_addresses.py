...
def build_request(
    ...
    input: aws_sdk_ec2.types.describe_addresses_request.DescribeAddressesRequest,
) -> zapros.Request:
    ...
    aws_sdk_ec2.types.describe_addresses_request.serialize_ec2_query(input, pairs, "")
