...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_address_transfers_result.DescribeAddressTransfersResult = aws_sdk_ec2.types.describe_address_transfers_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_address_transfers_request.DescribeAddressTransfersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeAddressTransfers"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_address_transfers_request

    aws_sdk_ec2.types.describe_address_transfers_request.serialize_ec2_query(
        input_, pairs, ""
    )
