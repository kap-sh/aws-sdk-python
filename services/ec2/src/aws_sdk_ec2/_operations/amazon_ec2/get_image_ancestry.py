...
def build_request(
    ...
    input: aws_sdk_ec2.types.get_image_ancestry_request.GetImageAncestryRequest,
) -> zapros.Request:
    ...
    aws_sdk_ec2.types.get_image_ancestry_request.serialize_ec2_query(input, pairs, "")
