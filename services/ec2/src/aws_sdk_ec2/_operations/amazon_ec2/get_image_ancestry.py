...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_image_ancestry_result.GetImageAncestryResult = (
        aws_sdk_ec2.types.get_image_ancestry_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_image_ancestry_request.GetImageAncestryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_image_ancestry_request.serialize_ec2_query(input_, pairs, "")
...
def get_image_ancestry(
    ...
    aws_sdk_ec2.types.get_image_ancestry_result.GetImageAncestryResult, zapros.Response
]:
