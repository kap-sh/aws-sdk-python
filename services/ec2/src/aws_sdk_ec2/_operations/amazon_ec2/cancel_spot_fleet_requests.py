...
def handle_response(
    ...
    out: aws_sdk_ec2.types.cancel_spot_fleet_requests_response.CancelSpotFleetRequestsResponse = aws_sdk_ec2.types.cancel_spot_fleet_requests_response.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.cancel_spot_fleet_requests_request.CancelSpotFleetRequestsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.cancel_spot_fleet_requests_request.serialize_ec2_query(
        input_, pairs, ""
    )
