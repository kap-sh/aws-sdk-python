...
) -> aws_sdk_ec2.types.describe_ipam_policies_result.DescribeIpamPoliciesResult:
    import aws_sdk_ec2.types.describe_ipam_policies_result

    out: aws_sdk_ec2.types.describe_ipam_policies_result.DescribeIpamPoliciesResult = (
        aws_sdk_ec2.types.describe_ipam_policies_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_ipam_policies_request.DescribeIpamPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_ipam_policies_request.serialize_ec2_query(
        input_, pairs, ""
    )
