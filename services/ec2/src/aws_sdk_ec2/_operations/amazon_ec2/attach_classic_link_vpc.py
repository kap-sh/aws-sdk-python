"""Generated from Smithy shape ``com.amazonaws.ec2#AttachClassicLinkVpc``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.attach_classic_link_vpc_result.AttachClassicLinkVpcResult = (
        aws_sdk_ec2.types.attach_classic_link_vpc_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.attach_classic_link_vpc_request.AttachClassicLinkVpcRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AttachClassicLinkVpc"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.attach_classic_link_vpc_request

    aws_sdk_ec2.types.attach_classic_link_vpc_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_attach_classic_link_vpc(
