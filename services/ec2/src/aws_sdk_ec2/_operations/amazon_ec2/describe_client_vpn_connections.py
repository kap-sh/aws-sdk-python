...
) -> aws_sdk_ec2.types.describe_client_vpn_connections_result.DescribeClientVpnConnectionsResult:
    out: aws_sdk_ec2.types.describe_client_vpn_connections_result.DescribeClientVpnConnectionsResult = aws_sdk_ec2.types.describe_client_vpn_connections_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_client_vpn_connections_request.DescribeClientVpnConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_client_vpn_connections_request.serialize_ec2_query(
        input_, pairs, ""
    )
