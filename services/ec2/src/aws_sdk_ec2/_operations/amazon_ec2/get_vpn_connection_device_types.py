"""Generated from Smithy shape ``com.amazonaws.ec2#GetVpnConnectionDeviceTypes``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_vpn_connection_device_types_result.GetVpnConnectionDeviceTypesResult = aws_sdk_ec2.types.get_vpn_connection_device_types_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_vpn_connection_device_types_request.GetVpnConnectionDeviceTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetVpnConnectionDeviceTypes"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.get_vpn_connection_device_types_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_get_vpn_connection_device_types(
