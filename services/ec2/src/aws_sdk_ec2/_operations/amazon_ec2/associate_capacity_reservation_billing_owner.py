...
def handle_response(
    ...
    out: aws_sdk_ec2.types.associate_capacity_reservation_billing_owner_result.AssociateCapacityReservationBillingOwnerResult = aws_sdk_ec2.types.associate_capacity_reservation_billing_owner_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.associate_capacity_reservation_billing_owner_request.AssociateCapacityReservationBillingOwnerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.associate_capacity_reservation_billing_owner_request.serialize_ec2_query(
        input_, pairs, ""
    )
