...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_vpc_block_public_access_exclusion_result.DeleteVpcBlockPublicAccessExclusionResult = aws_sdk_ec2.types.delete_vpc_block_public_access_exclusion_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_vpc_block_public_access_exclusion_request.DeleteVpcBlockPublicAccessExclusionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_vpc_block_public_access_exclusion_request.serialize_ec2_query(
        input_, pairs, ""
    )
