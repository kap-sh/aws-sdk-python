...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_network_insights_path_result.CreateNetworkInsightsPathResult = aws_sdk_ec2.types.create_network_insights_path_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_network_insights_path_request.CreateNetworkInsightsPathRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_network_insights_path_request.serialize_ec2_query(
        input_, pairs, ""
    )
