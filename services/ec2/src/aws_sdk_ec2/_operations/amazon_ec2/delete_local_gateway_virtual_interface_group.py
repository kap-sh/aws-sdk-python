...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_local_gateway_virtual_interface_group_result.DeleteLocalGatewayVirtualInterfaceGroupResult = aws_sdk_ec2.types.delete_local_gateway_virtual_interface_group_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_local_gateway_virtual_interface_group_request.DeleteLocalGatewayVirtualInterfaceGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteLocalGatewayVirtualInterfaceGroup"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.delete_local_gateway_virtual_interface_group_request.serialize_ec2_query(
        input_, pairs, ""
    )
