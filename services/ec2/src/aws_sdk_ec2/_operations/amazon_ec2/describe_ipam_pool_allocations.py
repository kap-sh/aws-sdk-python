...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_ipam_pool_allocations_result.DescribeIpamPoolAllocationsResult = aws_sdk_ec2.types.describe_ipam_pool_allocations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_ipam_pool_allocations_request.DescribeIpamPoolAllocationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_ipam_pool_allocations_request.serialize_ec2_query(
        input_, pairs, ""
    )
