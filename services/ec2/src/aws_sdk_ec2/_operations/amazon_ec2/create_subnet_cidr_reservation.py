...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_subnet_cidr_reservation_result.CreateSubnetCidrReservationResult = aws_sdk_ec2.types.create_subnet_cidr_reservation_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_subnet_cidr_reservation_request.CreateSubnetCidrReservationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_subnet_cidr_reservation_request.serialize_ec2_query(
        input_, pairs, ""
    )
