...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_network_insights_access_scope_result.CreateNetworkInsightsAccessScopeResult = aws_sdk_ec2.types.create_network_insights_access_scope_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_network_insights_access_scope_request.CreateNetworkInsightsAccessScopeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
