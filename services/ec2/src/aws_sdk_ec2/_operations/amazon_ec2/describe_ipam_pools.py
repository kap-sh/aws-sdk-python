...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_ipam_pools_result.DescribeIpamPoolsResult = (
        aws_sdk_ec2.types.describe_ipam_pools_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_ipam_pools_request.DescribeIpamPoolsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeIpamPools"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_ipam_pools_request

    aws_sdk_ec2.types.describe_ipam_pools_request.serialize_ec2_query(input_, pairs, "")
