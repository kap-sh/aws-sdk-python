...
def build_request(
    ...
    input_: aws_sdk_ec2.types.release_address_request.ReleaseAddressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ReleaseAddress"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.release_address_request

    aws_sdk_ec2.types.release_address_request.serialize_ec2_query(input_, pairs, "")
