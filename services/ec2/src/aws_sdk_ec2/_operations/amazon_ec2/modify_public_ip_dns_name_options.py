...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_public_ip_dns_name_options_result.ModifyPublicIpDnsNameOptionsResult = aws_sdk_ec2.types.modify_public_ip_dns_name_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_public_ip_dns_name_options_request.ModifyPublicIpDnsNameOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_public_ip_dns_name_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
