...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_verified_access_instance_logging_configurations_result.DescribeVerifiedAccessInstanceLoggingConfigurationsResult = aws_sdk_ec2.types.describe_verified_access_instance_logging_configurations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_verified_access_instance_logging_configurations_request.DescribeVerifiedAccessInstanceLoggingConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_verified_access_instance_logging_configurations_request.serialize_ec2_query(
        input_, pairs, ""
    )
