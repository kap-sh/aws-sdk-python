...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_customer_gateway_request.DeleteCustomerGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_customer_gateway_request.serialize_ec2_query(
        input_, pairs, ""
    )
