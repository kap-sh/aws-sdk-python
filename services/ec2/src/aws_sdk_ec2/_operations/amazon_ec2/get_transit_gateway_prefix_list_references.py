...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_transit_gateway_prefix_list_references_result.GetTransitGatewayPrefixListReferencesResult = aws_sdk_ec2.types.get_transit_gateway_prefix_list_references_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_transit_gateway_prefix_list_references_request.GetTransitGatewayPrefixListReferencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetTransitGatewayPrefixListReferences"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.get_transit_gateway_prefix_list_references_request.serialize_ec2_query(
        input_, pairs, ""
    )
