"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTransitGatewayRoute``."""
...
) -> aws_sdk_ec2.types.delete_transit_gateway_route_result.DeleteTransitGatewayRouteResult:
    import aws_sdk_ec2.types.delete_transit_gateway_route_result

    out: aws_sdk_ec2.types.delete_transit_gateway_route_result.DeleteTransitGatewayRouteResult = aws_sdk_ec2.types.delete_transit_gateway_route_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_transit_gateway_route_request.DeleteTransitGatewayRouteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteTransitGatewayRoute"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_transit_gateway_route_request

    aws_sdk_ec2.types.delete_transit_gateway_route_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_transit_gateway_route(
