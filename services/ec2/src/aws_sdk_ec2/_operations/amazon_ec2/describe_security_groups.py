...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_security_groups_result.DescribeSecurityGroupsResult = aws_sdk_ec2.types.describe_security_groups_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_security_groups_request.DescribeSecurityGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_security_groups_request.serialize_ec2_query(
        input_, pairs, ""
    )
