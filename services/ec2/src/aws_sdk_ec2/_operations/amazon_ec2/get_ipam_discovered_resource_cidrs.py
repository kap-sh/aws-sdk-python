...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_ipam_discovered_resource_cidrs_result.GetIpamDiscoveredResourceCidrsResult = aws_sdk_ec2.types.get_ipam_discovered_resource_cidrs_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_ipam_discovered_resource_cidrs_request.GetIpamDiscoveredResourceCidrsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_ipam_discovered_resource_cidrs_request.serialize_ec2_query(
        input_, pairs, ""
    )
