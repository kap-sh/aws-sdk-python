...
def handle_response(
    ...
    out: aws_sdk_ec2.types.list_snapshots_in_recycle_bin_result.ListSnapshotsInRecycleBinResult = aws_sdk_ec2.types.list_snapshots_in_recycle_bin_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.list_snapshots_in_recycle_bin_request.ListSnapshotsInRecycleBinRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ListSnapshotsInRecycleBin"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.list_snapshots_in_recycle_bin_request

    aws_sdk_ec2.types.list_snapshots_in_recycle_bin_request.serialize_ec2_query(
        input_, pairs, ""
    )
