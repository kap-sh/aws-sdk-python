...
def handle_response(
    ...
    out: aws_sdk_ec2.types.restore_managed_prefix_list_version_result.RestoreManagedPrefixListVersionResult = aws_sdk_ec2.types.restore_managed_prefix_list_version_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.restore_managed_prefix_list_version_request.RestoreManagedPrefixListVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RestoreManagedPrefixListVersion"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.restore_managed_prefix_list_version_request

    aws_sdk_ec2.types.restore_managed_prefix_list_version_request.serialize_ec2_query(
        input_, pairs, ""
    )
