...
def handle_response(
    ...
    out: aws_sdk_ec2.types.replace_route_table_association_result.ReplaceRouteTableAssociationResult = aws_sdk_ec2.types.replace_route_table_association_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.replace_route_table_association_request.ReplaceRouteTableAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
