...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_transit_gateways_result.DescribeTransitGatewaysResult = aws_sdk_ec2.types.describe_transit_gateways_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_transit_gateways_request.DescribeTransitGatewaysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeTransitGateways"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_transit_gateways_request

    aws_sdk_ec2.types.describe_transit_gateways_request.serialize_ec2_query(
        input_, pairs, ""
    )
