...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_network_interface_result.CreateNetworkInterfaceResult = aws_sdk_ec2.types.create_network_interface_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_network_interface_request.CreateNetworkInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_network_interface_request.serialize_ec2_query(
        input_, pairs, ""
    )
