...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disassociate_address_request.DisassociateAddressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DisassociateAddress"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.disassociate_address_request.serialize_ec2_query(
        input_, pairs, ""
    )
