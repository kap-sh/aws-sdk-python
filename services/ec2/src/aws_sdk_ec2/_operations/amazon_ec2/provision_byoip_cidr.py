...
def handle_response(
    ...
    out: aws_sdk_ec2.types.provision_byoip_cidr_result.ProvisionByoipCidrResult = (
        aws_sdk_ec2.types.provision_byoip_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.provision_byoip_cidr_request.ProvisionByoipCidrRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.provision_byoip_cidr_request.serialize_ec2_query(
        input_, pairs, ""
    )
