...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_launch_template_version_result.CreateLaunchTemplateVersionResult = aws_sdk_ec2.types.create_launch_template_version_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_launch_template_version_request.CreateLaunchTemplateVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateLaunchTemplateVersion"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_launch_template_version_request

    aws_sdk_ec2.types.create_launch_template_version_request.serialize_ec2_query(
        input_, pairs, ""
    )
