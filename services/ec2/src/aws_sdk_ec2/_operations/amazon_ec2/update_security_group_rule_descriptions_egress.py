...
def handle_response(
    ...
    out: aws_sdk_ec2.types.update_security_group_rule_descriptions_egress_result.UpdateSecurityGroupRuleDescriptionsEgressResult = aws_sdk_ec2.types.update_security_group_rule_descriptions_egress_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.update_security_group_rule_descriptions_egress_request.UpdateSecurityGroupRuleDescriptionsEgressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UpdateSecurityGroupRuleDescriptionsEgress"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.update_security_group_rule_descriptions_egress_request.serialize_ec2_query(
        input_, pairs, ""
    )
