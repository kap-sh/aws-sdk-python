...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_instance_type_offerings_result.DescribeInstanceTypeOfferingsResult = aws_sdk_ec2.types.describe_instance_type_offerings_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_instance_type_offerings_request.DescribeInstanceTypeOfferingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_instance_type_offerings_request.serialize_ec2_query(
        input_, pairs, ""
    )
