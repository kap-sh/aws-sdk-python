...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_ipam_resource_discovery_result.CreateIpamResourceDiscoveryResult = aws_sdk_ec2.types.create_ipam_resource_discovery_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_ipam_resource_discovery_request.CreateIpamResourceDiscoveryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateIpamResourceDiscovery"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_ipam_resource_discovery_request

    aws_sdk_ec2.types.create_ipam_resource_discovery_request.serialize_ec2_query(
        input_, pairs, ""
    )
