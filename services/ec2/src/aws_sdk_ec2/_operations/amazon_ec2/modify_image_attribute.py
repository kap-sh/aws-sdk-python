"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyImageAttribute``."""
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_image_attribute_request.ModifyImageAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyImageAttribute"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.modify_image_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_image_attribute(
