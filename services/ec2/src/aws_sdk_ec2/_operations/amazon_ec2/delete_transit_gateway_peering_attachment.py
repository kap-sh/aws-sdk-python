...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_transit_gateway_peering_attachment_result.DeleteTransitGatewayPeeringAttachmentResult = aws_sdk_ec2.types.delete_transit_gateway_peering_attachment_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_transit_gateway_peering_attachment_request.DeleteTransitGatewayPeeringAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteTransitGatewayPeeringAttachment"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.delete_transit_gateway_peering_attachment_request.serialize_ec2_query(
        input_, pairs, ""
    )
