...
def build_request(
    ...
    input_: aws_sdk_ec2.types.replace_route_request.ReplaceRouteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ReplaceRoute"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.replace_route_request

    aws_sdk_ec2.types.replace_route_request.serialize_ec2_query(input_, pairs, "")
