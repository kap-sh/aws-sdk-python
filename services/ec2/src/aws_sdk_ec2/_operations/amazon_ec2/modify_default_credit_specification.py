"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyDefaultCreditSpecification``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_default_credit_specification_result.ModifyDefaultCreditSpecificationResult = aws_sdk_ec2.types.modify_default_credit_specification_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_default_credit_specification_request.ModifyDefaultCreditSpecificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyDefaultCreditSpecification"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.modify_default_credit_specification_request

    aws_sdk_ec2.types.modify_default_credit_specification_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_default_credit_specification(
