...
def handle_response(
    ...
    out: aws_sdk_ec2.types.list_volumes_in_recycle_bin_result.ListVolumesInRecycleBinResult = aws_sdk_ec2.types.list_volumes_in_recycle_bin_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.list_volumes_in_recycle_bin_request.ListVolumesInRecycleBinRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.list_volumes_in_recycle_bin_request.serialize_ec2_query(
        input_, pairs, ""
    )
