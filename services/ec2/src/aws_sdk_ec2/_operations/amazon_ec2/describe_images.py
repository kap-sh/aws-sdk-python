...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_images_result.DescribeImagesResult = (
        aws_sdk_ec2.types.describe_images_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_images_request.DescribeImagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_images_request.serialize_ec2_query(input_, pairs, "")
...
def describe_images(
    ...
    aws_sdk_ec2.types.describe_images_result.DescribeImagesResult, zapros.Response
]:
