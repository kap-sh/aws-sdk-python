...
) -> aws_sdk_ec2.types.describe_transit_gateway_peering_attachments_result.DescribeTransitGatewayPeeringAttachmentsResult:
    out: aws_sdk_ec2.types.describe_transit_gateway_peering_attachments_result.DescribeTransitGatewayPeeringAttachmentsResult = aws_sdk_ec2.types.describe_transit_gateway_peering_attachments_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_transit_gateway_peering_attachments_request.DescribeTransitGatewayPeeringAttachmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_transit_gateway_peering_attachments_request.serialize_ec2_query(
        input_, pairs, ""
    )
