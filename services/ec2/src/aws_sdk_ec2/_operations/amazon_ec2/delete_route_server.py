...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_route_server_result.DeleteRouteServerResult = (
        aws_sdk_ec2.types.delete_route_server_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_route_server_request.DeleteRouteServerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_route_server_request.serialize_ec2_query(input_, pairs, "")
