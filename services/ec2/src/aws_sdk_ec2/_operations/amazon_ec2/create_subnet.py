...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_subnet_result.CreateSubnetResult = (
        aws_sdk_ec2.types.create_subnet_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_subnet_request.CreateSubnetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_subnet_request.serialize_ec2_query(input_, pairs, "")
...
def create_subnet(
    ...
    input_: aws_sdk_ec2.types.create_subnet_request.CreateSubnetRequest,
) -> tuple[aws_sdk_ec2.types.create_subnet_result.CreateSubnetResult, zapros.Response]:
