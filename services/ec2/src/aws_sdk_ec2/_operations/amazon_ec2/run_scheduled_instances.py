...
def handle_response(
    ...
    out: aws_sdk_ec2.types.run_scheduled_instances_result.RunScheduledInstancesResult = aws_sdk_ec2.types.run_scheduled_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.run_scheduled_instances_request.RunScheduledInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.run_scheduled_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
