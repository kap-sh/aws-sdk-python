...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_transit_gateway_route_table_result.CreateTransitGatewayRouteTableResult = aws_sdk_ec2.types.create_transit_gateway_route_table_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_transit_gateway_route_table_request.CreateTransitGatewayRouteTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_transit_gateway_route_table_request.serialize_ec2_query(
        input_, pairs, ""
    )
