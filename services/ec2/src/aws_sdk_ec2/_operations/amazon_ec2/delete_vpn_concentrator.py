"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteVpnConcentrator``."""
...
) -> aws_sdk_ec2.types.delete_vpn_concentrator_result.DeleteVpnConcentratorResult:
    import aws_sdk_ec2.types.delete_vpn_concentrator_result

    out: aws_sdk_ec2.types.delete_vpn_concentrator_result.DeleteVpnConcentratorResult = aws_sdk_ec2.types.delete_vpn_concentrator_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_vpn_concentrator_request.DeleteVpnConcentratorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteVpnConcentrator"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_vpn_concentrator_request

    aws_sdk_ec2.types.delete_vpn_concentrator_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_vpn_concentrator(
