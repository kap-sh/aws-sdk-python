...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_verified_access_group_result.CreateVerifiedAccessGroupResult = aws_sdk_ec2.types.create_verified_access_group_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_verified_access_group_request.CreateVerifiedAccessGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateVerifiedAccessGroup"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.create_verified_access_group_request.serialize_ec2_query(
        input_, pairs, ""
    )
