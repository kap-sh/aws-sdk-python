...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_vpn_tunnel_replacement_status_result.GetVpnTunnelReplacementStatusResult = aws_sdk_ec2.types.get_vpn_tunnel_replacement_status_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_vpn_tunnel_replacement_status_request.GetVpnTunnelReplacementStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_vpn_tunnel_replacement_status_request.serialize_ec2_query(
        input_, pairs, ""
    )
