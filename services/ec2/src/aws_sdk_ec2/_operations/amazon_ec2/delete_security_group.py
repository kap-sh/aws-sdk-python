...
) -> aws_sdk_ec2.types.delete_security_group_result.DeleteSecurityGroupResult:
    out: aws_sdk_ec2.types.delete_security_group_result.DeleteSecurityGroupResult = (
        aws_sdk_ec2.types.delete_security_group_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_security_group_request.DeleteSecurityGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_security_group_request.serialize_ec2_query(
        input_, pairs, ""
    )
