...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_coip_cidr_result.CreateCoipCidrResult = (
        aws_sdk_ec2.types.create_coip_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_coip_cidr_request.CreateCoipCidrRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateCoipCidr"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.create_coip_cidr_request.serialize_ec2_query(input_, pairs, "")
