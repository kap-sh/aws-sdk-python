...
def handle_response(
    ...
    out: aws_sdk_ec2.types.restore_image_from_recycle_bin_result.RestoreImageFromRecycleBinResult = aws_sdk_ec2.types.restore_image_from_recycle_bin_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.restore_image_from_recycle_bin_request.RestoreImageFromRecycleBinRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RestoreImageFromRecycleBin"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.restore_image_from_recycle_bin_request

    aws_sdk_ec2.types.restore_image_from_recycle_bin_request.serialize_ec2_query(
        input_, pairs, ""
    )
