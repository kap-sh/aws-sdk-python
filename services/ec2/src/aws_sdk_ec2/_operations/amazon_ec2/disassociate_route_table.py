"""Generated from Smithy shape ``com.amazonaws.ec2#DisassociateRouteTable``."""
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disassociate_route_table_request.DisassociateRouteTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DisassociateRouteTable"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.disassociate_route_table_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_disassociate_route_table(
