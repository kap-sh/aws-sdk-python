"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyFleet``."""
...
) -> aws_sdk_ec2.types.modify_fleet_result.ModifyFleetResult:
    out: aws_sdk_ec2.types.modify_fleet_result.ModifyFleetResult = (
        aws_sdk_ec2.types.modify_fleet_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_fleet_request.ModifyFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyFleet"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.modify_fleet_request.serialize_ec2_query(input_, pairs, "")
...
def modify_fleet(
    ...
    input_: aws_sdk_ec2.types.modify_fleet_request.ModifyFleetRequest,
) -> tuple[aws_sdk_ec2.types.modify_fleet_result.ModifyFleetResult, zapros.Response]:
