...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_tags_result.DescribeTagsResult = (
        aws_sdk_ec2.types.describe_tags_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_tags_request.DescribeTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_tags_request.serialize_ec2_query(input_, pairs, "")
