"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyNetworkInterfaceAttribute``."""
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_network_interface_attribute_request.ModifyNetworkInterfaceAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyNetworkInterfaceAttribute"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.modify_network_interface_attribute_request

    aws_sdk_ec2.types.modify_network_interface_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_network_interface_attribute(
