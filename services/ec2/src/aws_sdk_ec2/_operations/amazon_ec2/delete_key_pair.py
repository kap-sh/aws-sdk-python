...
) -> aws_sdk_ec2.types.delete_key_pair_result.DeleteKeyPairResult:
    out: aws_sdk_ec2.types.delete_key_pair_result.DeleteKeyPairResult = (
        aws_sdk_ec2.types.delete_key_pair_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_key_pair_request.DeleteKeyPairRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_key_pair_request.serialize_ec2_query(input_, pairs, "")
...
def delete_key_pair(
    ...
    aws_sdk_ec2.types.delete_key_pair_result.DeleteKeyPairResult, zapros.Response
]:
