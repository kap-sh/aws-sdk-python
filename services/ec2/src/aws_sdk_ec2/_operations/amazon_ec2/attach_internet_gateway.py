...
def build_request(
    ...
    input_: aws_sdk_ec2.types.attach_internet_gateway_request.AttachInternetGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AttachInternetGateway"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.attach_internet_gateway_request.serialize_ec2_query(
        input_, pairs, ""
    )
