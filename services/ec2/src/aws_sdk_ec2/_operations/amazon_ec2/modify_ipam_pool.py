...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_ipam_pool_result.ModifyIpamPoolResult = (
        aws_sdk_ec2.types.modify_ipam_pool_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_ipam_pool_request.ModifyIpamPoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_ipam_pool_request.serialize_ec2_query(input_, pairs, "")
