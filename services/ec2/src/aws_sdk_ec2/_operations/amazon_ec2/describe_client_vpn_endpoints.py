...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_client_vpn_endpoints_result.DescribeClientVpnEndpointsResult = aws_sdk_ec2.types.describe_client_vpn_endpoints_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_client_vpn_endpoints_request.DescribeClientVpnEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_client_vpn_endpoints_request.serialize_ec2_query(
        input_, pairs, ""
    )
