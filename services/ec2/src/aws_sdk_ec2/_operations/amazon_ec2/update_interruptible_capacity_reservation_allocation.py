...
def handle_response(
    ...
    out: aws_sdk_ec2.types.update_interruptible_capacity_reservation_allocation_result.UpdateInterruptibleCapacityReservationAllocationResult = aws_sdk_ec2.types.update_interruptible_capacity_reservation_allocation_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.update_interruptible_capacity_reservation_allocation_request.UpdateInterruptibleCapacityReservationAllocationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UpdateInterruptibleCapacityReservationAllocation"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.update_interruptible_capacity_reservation_allocation_request

    aws_sdk_ec2.types.update_interruptible_capacity_reservation_allocation_request.serialize_ec2_query(
        input_, pairs, ""
    )
