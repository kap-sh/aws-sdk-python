...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_transit_gateway_client_vpn_attachment_result.DeleteTransitGatewayClientVpnAttachmentResult = aws_sdk_ec2.types.delete_transit_gateway_client_vpn_attachment_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_transit_gateway_client_vpn_attachment_request.DeleteTransitGatewayClientVpnAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteTransitGatewayClientVpnAttachment"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_transit_gateway_client_vpn_attachment_request

    aws_sdk_ec2.types.delete_transit_gateway_client_vpn_attachment_request.serialize_ec2_query(
        input_, pairs, ""
    )
