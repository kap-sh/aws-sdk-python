...
def handle_response(
    ...
    out: aws_sdk_ec2.types.associate_transit_gateway_multicast_domain_result.AssociateTransitGatewayMulticastDomainResult = aws_sdk_ec2.types.associate_transit_gateway_multicast_domain_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.associate_transit_gateway_multicast_domain_request.AssociateTransitGatewayMulticastDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.associate_transit_gateway_multicast_domain_request.serialize_ec2_query(
        input_, pairs, ""
    )
