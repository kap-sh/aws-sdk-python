...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_vpc_endpoint_associations_result.DescribeVpcEndpointAssociationsResult = aws_sdk_ec2.types.describe_vpc_endpoint_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_vpc_endpoint_associations_request.DescribeVpcEndpointAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_vpc_endpoint_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
