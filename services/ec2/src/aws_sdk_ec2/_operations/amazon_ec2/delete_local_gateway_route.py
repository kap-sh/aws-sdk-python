...
) -> aws_sdk_ec2.types.delete_local_gateway_route_result.DeleteLocalGatewayRouteResult:
    out: aws_sdk_ec2.types.delete_local_gateway_route_result.DeleteLocalGatewayRouteResult = aws_sdk_ec2.types.delete_local_gateway_route_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_local_gateway_route_request.DeleteLocalGatewayRouteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_local_gateway_route_request.serialize_ec2_query(
        input_, pairs, ""
    )
