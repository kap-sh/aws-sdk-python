...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_vpc_endpoint_connection_notifications_result.DeleteVpcEndpointConnectionNotificationsResult = aws_sdk_ec2.types.delete_vpc_endpoint_connection_notifications_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_vpc_endpoint_connection_notifications_request.DeleteVpcEndpointConnectionNotificationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteVpcEndpointConnectionNotifications"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_vpc_endpoint_connection_notifications_request

    aws_sdk_ec2.types.delete_vpc_endpoint_connection_notifications_request.serialize_ec2_query(
        input_, pairs, ""
    )
