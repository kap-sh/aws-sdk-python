...
def handle_response(
    ...
    out: aws_sdk_ec2.types.authorize_client_vpn_ingress_result.AuthorizeClientVpnIngressResult = aws_sdk_ec2.types.authorize_client_vpn_ingress_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.authorize_client_vpn_ingress_request.AuthorizeClientVpnIngressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
