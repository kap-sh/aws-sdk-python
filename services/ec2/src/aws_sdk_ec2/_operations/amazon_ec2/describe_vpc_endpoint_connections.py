...
) -> aws_sdk_ec2.types.describe_vpc_endpoint_connections_result.DescribeVpcEndpointConnectionsResult:
    out: aws_sdk_ec2.types.describe_vpc_endpoint_connections_result.DescribeVpcEndpointConnectionsResult = aws_sdk_ec2.types.describe_vpc_endpoint_connections_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_vpc_endpoint_connections_request.DescribeVpcEndpointConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_vpc_endpoint_connections_request.serialize_ec2_query(
        input_, pairs, ""
    )
