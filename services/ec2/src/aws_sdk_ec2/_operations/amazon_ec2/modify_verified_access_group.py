...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_verified_access_group_result.ModifyVerifiedAccessGroupResult = aws_sdk_ec2.types.modify_verified_access_group_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_verified_access_group_request.ModifyVerifiedAccessGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_verified_access_group_request.serialize_ec2_query(
        input_, pairs, ""
    )
