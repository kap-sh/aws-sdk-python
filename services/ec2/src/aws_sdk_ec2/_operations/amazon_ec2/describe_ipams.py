...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_ipams_result.DescribeIpamsResult = (
        aws_sdk_ec2.types.describe_ipams_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_ipams_request.DescribeIpamsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeIpams"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_ipams_request

    aws_sdk_ec2.types.describe_ipams_request.serialize_ec2_query(input_, pairs, "")
