"""Generated from Smithy shape ``com.amazonaws.ec2#CreateReplaceRootVolumeTask``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_replace_root_volume_task_result.CreateReplaceRootVolumeTaskResult = aws_sdk_ec2.types.create_replace_root_volume_task_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_replace_root_volume_task_request.CreateReplaceRootVolumeTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateReplaceRootVolumeTask"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_replace_root_volume_task_request

    aws_sdk_ec2.types.create_replace_root_volume_task_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_create_replace_root_volume_task(
