...
def handle_response(
    ...
    out: aws_sdk_ec2.types.assign_private_nat_gateway_address_result.AssignPrivateNatGatewayAddressResult = aws_sdk_ec2.types.assign_private_nat_gateway_address_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.assign_private_nat_gateway_address_request.AssignPrivateNatGatewayAddressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AssignPrivateNatGatewayAddress"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.assign_private_nat_gateway_address_request

    aws_sdk_ec2.types.assign_private_nat_gateway_address_request.serialize_ec2_query(
        input_, pairs, ""
    )
