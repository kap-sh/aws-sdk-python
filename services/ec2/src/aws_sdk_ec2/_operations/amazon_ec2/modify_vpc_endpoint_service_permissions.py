...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_vpc_endpoint_service_permissions_result.ModifyVpcEndpointServicePermissionsResult = aws_sdk_ec2.types.modify_vpc_endpoint_service_permissions_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_vpc_endpoint_service_permissions_request.ModifyVpcEndpointServicePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyVpcEndpointServicePermissions"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.modify_vpc_endpoint_service_permissions_request

    aws_sdk_ec2.types.modify_vpc_endpoint_service_permissions_request.serialize_ec2_query(
        input_, pairs, ""
    )
