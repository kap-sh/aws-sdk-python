...
) -> aws_sdk_ec2.types.delete_flow_logs_result.DeleteFlowLogsResult:
    import aws_sdk_ec2.types.delete_flow_logs_result

    out: aws_sdk_ec2.types.delete_flow_logs_result.DeleteFlowLogsResult = (
        aws_sdk_ec2.types.delete_flow_logs_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_flow_logs_request.DeleteFlowLogsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_flow_logs_request.serialize_ec2_query(input_, pairs, "")
