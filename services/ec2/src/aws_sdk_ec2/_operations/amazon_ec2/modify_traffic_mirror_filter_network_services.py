...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_traffic_mirror_filter_network_services_result.ModifyTrafficMirrorFilterNetworkServicesResult = aws_sdk_ec2.types.modify_traffic_mirror_filter_network_services_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_traffic_mirror_filter_network_services_request.ModifyTrafficMirrorFilterNetworkServicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_traffic_mirror_filter_network_services_request.serialize_ec2_query(
        input_, pairs, ""
    )
