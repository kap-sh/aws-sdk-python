...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_managed_prefix_lists_result.DescribeManagedPrefixListsResult = aws_sdk_ec2.types.describe_managed_prefix_lists_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_managed_prefix_lists_request.DescribeManagedPrefixListsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeManagedPrefixLists"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_managed_prefix_lists_request

    aws_sdk_ec2.types.describe_managed_prefix_lists_request.serialize_ec2_query(
        input_, pairs, ""
    )
