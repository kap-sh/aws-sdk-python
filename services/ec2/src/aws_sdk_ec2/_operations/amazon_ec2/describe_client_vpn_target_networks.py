...
) -> aws_sdk_ec2.types.describe_client_vpn_target_networks_result.DescribeClientVpnTargetNetworksResult:
    out: aws_sdk_ec2.types.describe_client_vpn_target_networks_result.DescribeClientVpnTargetNetworksResult = aws_sdk_ec2.types.describe_client_vpn_target_networks_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_client_vpn_target_networks_request.DescribeClientVpnTargetNetworksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_client_vpn_target_networks_request.serialize_ec2_query(
        input_, pairs, ""
    )
