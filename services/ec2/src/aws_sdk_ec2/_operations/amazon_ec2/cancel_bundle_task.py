...
def handle_response(
    ...
    out: aws_sdk_ec2.types.cancel_bundle_task_result.CancelBundleTaskResult = (
        aws_sdk_ec2.types.cancel_bundle_task_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.cancel_bundle_task_request.CancelBundleTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CancelBundleTask"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.cancel_bundle_task_request

    aws_sdk_ec2.types.cancel_bundle_task_request.serialize_ec2_query(input_, pairs, "")
