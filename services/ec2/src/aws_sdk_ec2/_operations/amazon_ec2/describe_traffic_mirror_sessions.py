...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_traffic_mirror_sessions_result.DescribeTrafficMirrorSessionsResult = aws_sdk_ec2.types.describe_traffic_mirror_sessions_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_traffic_mirror_sessions_request.DescribeTrafficMirrorSessionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeTrafficMirrorSessions"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.describe_traffic_mirror_sessions_request.serialize_ec2_query(
        input_, pairs, ""
    )
