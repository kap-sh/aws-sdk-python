...
) -> aws_sdk_ec2.types.create_transit_gateway_result.CreateTransitGatewayResult:
    import aws_sdk_ec2.types.create_transit_gateway_result

    out: aws_sdk_ec2.types.create_transit_gateway_result.CreateTransitGatewayResult = (
        aws_sdk_ec2.types.create_transit_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_transit_gateway_request.CreateTransitGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_transit_gateway_request.serialize_ec2_query(
        input_, pairs, ""
    )
