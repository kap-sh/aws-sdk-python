...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_managed_prefix_list_result.ModifyManagedPrefixListResult = aws_sdk_ec2.types.modify_managed_prefix_list_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_managed_prefix_list_request.ModifyManagedPrefixListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_managed_prefix_list_request.serialize_ec2_query(
        input_, pairs, ""
    )
