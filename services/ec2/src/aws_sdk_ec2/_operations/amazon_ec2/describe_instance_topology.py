...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_instance_topology_result.DescribeInstanceTopologyResult = aws_sdk_ec2.types.describe_instance_topology_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_instance_topology_request.DescribeInstanceTopologyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeInstanceTopology"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.describe_instance_topology_request.serialize_ec2_query(
        input_, pairs, ""
    )
