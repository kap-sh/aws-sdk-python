...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_vpn_connection_route_request.DeleteVpnConnectionRouteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_vpn_connection_route_request.serialize_ec2_query(
        input_, pairs, ""
    )
