"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyInstanceAttribute``."""
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_instance_attribute_request.ModifyInstanceAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyInstanceAttribute"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.modify_instance_attribute_request

    aws_sdk_ec2.types.modify_instance_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_instance_attribute(
