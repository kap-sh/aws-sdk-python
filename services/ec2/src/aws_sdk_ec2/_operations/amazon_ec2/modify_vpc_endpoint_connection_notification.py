...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_vpc_endpoint_connection_notification_result.ModifyVpcEndpointConnectionNotificationResult = aws_sdk_ec2.types.modify_vpc_endpoint_connection_notification_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_vpc_endpoint_connection_notification_request.ModifyVpcEndpointConnectionNotificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
