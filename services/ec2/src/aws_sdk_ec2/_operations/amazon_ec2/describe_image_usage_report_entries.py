...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_image_usage_report_entries_result.DescribeImageUsageReportEntriesResult = aws_sdk_ec2.types.describe_image_usage_report_entries_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_image_usage_report_entries_request.DescribeImageUsageReportEntriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeImageUsageReportEntries"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_image_usage_report_entries_request

    aws_sdk_ec2.types.describe_image_usage_report_entries_request.serialize_ec2_query(
        input_, pairs, ""
    )
