"""Generated from Smithy shape ``com.amazonaws.ec2#GetInstanceTpmEkPub``."""
...
) -> aws_sdk_ec2.types.get_instance_tpm_ek_pub_result.GetInstanceTpmEkPubResult:
    out: aws_sdk_ec2.types.get_instance_tpm_ek_pub_result.GetInstanceTpmEkPubResult = (
        aws_sdk_ec2.types.get_instance_tpm_ek_pub_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_instance_tpm_ek_pub_request.GetInstanceTpmEkPubRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetInstanceTpmEkPub"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.get_instance_tpm_ek_pub_request

    aws_sdk_ec2.types.get_instance_tpm_ek_pub_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_get_instance_tpm_ek_pub(
