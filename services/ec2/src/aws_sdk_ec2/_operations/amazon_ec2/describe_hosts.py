...
) -> aws_sdk_ec2.types.describe_hosts_result.DescribeHostsResult:
    out: aws_sdk_ec2.types.describe_hosts_result.DescribeHostsResult = (
        aws_sdk_ec2.types.describe_hosts_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_hosts_request.DescribeHostsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_hosts_request.serialize_ec2_query(input_, pairs, "")
