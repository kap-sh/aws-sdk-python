...
) -> aws_sdk_ec2.types.describe_scheduled_instances_result.DescribeScheduledInstancesResult:
    import aws_sdk_ec2.types.describe_scheduled_instances_result

    out: aws_sdk_ec2.types.describe_scheduled_instances_result.DescribeScheduledInstancesResult = aws_sdk_ec2.types.describe_scheduled_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_scheduled_instances_request.DescribeScheduledInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_scheduled_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
