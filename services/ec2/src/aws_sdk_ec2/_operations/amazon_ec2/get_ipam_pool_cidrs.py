...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_ipam_pool_cidrs_result.GetIpamPoolCidrsResult = (
        aws_sdk_ec2.types.get_ipam_pool_cidrs_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_ipam_pool_cidrs_request.GetIpamPoolCidrsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetIpamPoolCidrs"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.get_ipam_pool_cidrs_request

    aws_sdk_ec2.types.get_ipam_pool_cidrs_request.serialize_ec2_query(input_, pairs, "")
