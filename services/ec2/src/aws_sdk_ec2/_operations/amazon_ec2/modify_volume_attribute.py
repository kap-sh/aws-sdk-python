...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_volume_attribute_request.ModifyVolumeAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyVolumeAttribute"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.modify_volume_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
