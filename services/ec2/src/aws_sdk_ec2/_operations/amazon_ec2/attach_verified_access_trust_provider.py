...
def handle_response(
    ...
    out: aws_sdk_ec2.types.attach_verified_access_trust_provider_result.AttachVerifiedAccessTrustProviderResult = aws_sdk_ec2.types.attach_verified_access_trust_provider_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.attach_verified_access_trust_provider_request.AttachVerifiedAccessTrustProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.attach_verified_access_trust_provider_request.serialize_ec2_query(
        input_, pairs, ""
    )
