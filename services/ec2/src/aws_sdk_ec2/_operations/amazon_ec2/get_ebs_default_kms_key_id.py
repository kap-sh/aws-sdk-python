...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_ebs_default_kms_key_id_result.GetEbsDefaultKmsKeyIdResult = aws_sdk_ec2.types.get_ebs_default_kms_key_id_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_ebs_default_kms_key_id_request.GetEbsDefaultKmsKeyIdRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetEbsDefaultKmsKeyId"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.get_ebs_default_kms_key_id_request

    aws_sdk_ec2.types.get_ebs_default_kms_key_id_request.serialize_ec2_query(
        input_, pairs, ""
    )
