...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_fleet_history_result.DescribeFleetHistoryResult = (
        aws_sdk_ec2.types.describe_fleet_history_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_fleet_history_request.DescribeFleetHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_fleet_history_request.serialize_ec2_query(
        input_, pairs, ""
    )
