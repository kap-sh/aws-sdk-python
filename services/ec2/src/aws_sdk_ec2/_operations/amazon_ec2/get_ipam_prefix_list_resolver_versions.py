...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_ipam_prefix_list_resolver_versions_result.GetIpamPrefixListResolverVersionsResult = aws_sdk_ec2.types.get_ipam_prefix_list_resolver_versions_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_ipam_prefix_list_resolver_versions_request.GetIpamPrefixListResolverVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetIpamPrefixListResolverVersions"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.get_ipam_prefix_list_resolver_versions_request

    aws_sdk_ec2.types.get_ipam_prefix_list_resolver_versions_request.serialize_ec2_query(
        input_, pairs, ""
    )
