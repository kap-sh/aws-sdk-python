...
def build_request(
    ...
    input_: aws_sdk_ec2.types.detach_volume_request.DetachVolumeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DetachVolume"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.detach_volume_request

    aws_sdk_ec2.types.detach_volume_request.serialize_ec2_query(input_, pairs, "")
