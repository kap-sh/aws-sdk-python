...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disassociate_capacity_reservation_billing_owner_result.DisassociateCapacityReservationBillingOwnerResult = aws_sdk_ec2.types.disassociate_capacity_reservation_billing_owner_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disassociate_capacity_reservation_billing_owner_request.DisassociateCapacityReservationBillingOwnerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DisassociateCapacityReservationBillingOwner"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.disassociate_capacity_reservation_billing_owner_request

    aws_sdk_ec2.types.disassociate_capacity_reservation_billing_owner_request.serialize_ec2_query(
        input_, pairs, ""
    )
