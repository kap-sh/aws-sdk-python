...
def handle_response(
    ...
    out: aws_sdk_ec2.types.enable_allowed_images_settings_result.EnableAllowedImagesSettingsResult = aws_sdk_ec2.types.enable_allowed_images_settings_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_allowed_images_settings_request.EnableAllowedImagesSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.enable_allowed_images_settings_request.serialize_ec2_query(
        input_, pairs, ""
    )
