...
def handle_response(
    ...
    out: aws_sdk_ec2.types.enable_route_server_propagation_result.EnableRouteServerPropagationResult = aws_sdk_ec2.types.enable_route_server_propagation_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_route_server_propagation_request.EnableRouteServerPropagationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.enable_route_server_propagation_request.serialize_ec2_query(
        input_, pairs, ""
    )
