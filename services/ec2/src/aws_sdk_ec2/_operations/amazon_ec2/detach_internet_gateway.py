...
def build_request(
    ...
    input_: aws_sdk_ec2.types.detach_internet_gateway_request.DetachInternetGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DetachInternetGateway"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.detach_internet_gateway_request

    aws_sdk_ec2.types.detach_internet_gateway_request.serialize_ec2_query(
        input_, pairs, ""
    )
