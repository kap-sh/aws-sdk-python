...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_launch_template_result.CreateLaunchTemplateResult = (
        aws_sdk_ec2.types.create_launch_template_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_launch_template_request.CreateLaunchTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
