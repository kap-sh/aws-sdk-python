...
) -> aws_sdk_ec2.types.describe_id_format_result.DescribeIdFormatResult:
    out: aws_sdk_ec2.types.describe_id_format_result.DescribeIdFormatResult = (
        aws_sdk_ec2.types.describe_id_format_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_id_format_request.DescribeIdFormatRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_id_format_request.serialize_ec2_query(input_, pairs, "")
...
def describe_id_format(
    ...
    aws_sdk_ec2.types.describe_id_format_result.DescribeIdFormatResult, zapros.Response
]:
