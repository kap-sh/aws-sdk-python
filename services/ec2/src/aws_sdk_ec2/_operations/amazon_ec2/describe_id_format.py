...
def build_request(
    ...
    input: aws_sdk_ec2.types.describe_id_format_request.DescribeIdFormatRequest,
) -> zapros.Request:
    ...
    aws_sdk_ec2.types.describe_id_format_request.serialize_ec2_query(input, pairs, "")
