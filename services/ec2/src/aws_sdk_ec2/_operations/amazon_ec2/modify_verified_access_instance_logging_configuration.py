...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_verified_access_instance_logging_configuration_result.ModifyVerifiedAccessInstanceLoggingConfigurationResult = aws_sdk_ec2.types.modify_verified_access_instance_logging_configuration_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_verified_access_instance_logging_configuration_request.ModifyVerifiedAccessInstanceLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_verified_access_instance_logging_configuration_request.serialize_ec2_query(
        input_, pairs, ""
    )
