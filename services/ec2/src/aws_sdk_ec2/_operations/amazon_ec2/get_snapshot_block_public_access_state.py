...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_snapshot_block_public_access_state_result.GetSnapshotBlockPublicAccessStateResult = aws_sdk_ec2.types.get_snapshot_block_public_access_state_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_snapshot_block_public_access_state_request.GetSnapshotBlockPublicAccessStateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
