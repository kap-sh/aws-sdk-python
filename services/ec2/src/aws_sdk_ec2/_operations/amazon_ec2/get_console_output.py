...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_console_output_result.GetConsoleOutputResult = (
        aws_sdk_ec2.types.get_console_output_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_console_output_request.GetConsoleOutputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_console_output_request.serialize_ec2_query(input_, pairs, "")
