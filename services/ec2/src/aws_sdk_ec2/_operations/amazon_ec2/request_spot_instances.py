...
def build_request(
    ...
    input_: aws_sdk_ec2.types.request_spot_instances_request.RequestSpotInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.request_spot_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
