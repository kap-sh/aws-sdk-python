"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTransitGatewayMeteringPolicy``."""
...
) -> aws_sdk_ec2.types.delete_transit_gateway_metering_policy_result.DeleteTransitGatewayMeteringPolicyResult:
    out: aws_sdk_ec2.types.delete_transit_gateway_metering_policy_result.DeleteTransitGatewayMeteringPolicyResult = aws_sdk_ec2.types.delete_transit_gateway_metering_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_transit_gateway_metering_policy_request.DeleteTransitGatewayMeteringPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteTransitGatewayMeteringPolicy"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_transit_gateway_metering_policy_request

    aws_sdk_ec2.types.delete_transit_gateway_metering_policy_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_transit_gateway_metering_policy(
