"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyTransitGatewayMeteringPolicy``."""
...
) -> aws_sdk_ec2.types.modify_transit_gateway_metering_policy_result.ModifyTransitGatewayMeteringPolicyResult:
    out: aws_sdk_ec2.types.modify_transit_gateway_metering_policy_result.ModifyTransitGatewayMeteringPolicyResult = aws_sdk_ec2.types.modify_transit_gateway_metering_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_transit_gateway_metering_policy_request.ModifyTransitGatewayMeteringPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyTransitGatewayMeteringPolicy"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.modify_transit_gateway_metering_policy_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_transit_gateway_metering_policy(
