...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disassociate_client_vpn_target_network_result.DisassociateClientVpnTargetNetworkResult = aws_sdk_ec2.types.disassociate_client_vpn_target_network_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disassociate_client_vpn_target_network_request.DisassociateClientVpnTargetNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DisassociateClientVpnTargetNetwork"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.disassociate_client_vpn_target_network_request

    aws_sdk_ec2.types.disassociate_client_vpn_target_network_request.serialize_ec2_query(
        input_, pairs, ""
    )
