...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_vpc_peering_connections_result.DescribeVpcPeeringConnectionsResult = aws_sdk_ec2.types.describe_vpc_peering_connections_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_vpc_peering_connections_request.DescribeVpcPeeringConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_vpc_peering_connections_request.serialize_ec2_query(
        input_, pairs, ""
    )
