...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_ipam_address_history_result.GetIpamAddressHistoryResult = aws_sdk_ec2.types.get_ipam_address_history_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_ipam_address_history_request.GetIpamAddressHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_ipam_address_history_request.serialize_ec2_query(
        input_, pairs, ""
    )
