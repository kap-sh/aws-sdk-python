...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_declarative_policies_report_summary_result.GetDeclarativePoliciesReportSummaryResult = aws_sdk_ec2.types.get_declarative_policies_report_summary_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_declarative_policies_report_summary_request.GetDeclarativePoliciesReportSummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
