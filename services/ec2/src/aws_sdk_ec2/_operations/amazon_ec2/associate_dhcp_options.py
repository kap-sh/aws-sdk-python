...
def build_request(
    ...
    input_: aws_sdk_ec2.types.associate_dhcp_options_request.AssociateDhcpOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.associate_dhcp_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
