...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_capacity_blocks_result.DescribeCapacityBlocksResult = aws_sdk_ec2.types.describe_capacity_blocks_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_capacity_blocks_request.DescribeCapacityBlocksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_capacity_blocks_request.serialize_ec2_query(
        input_, pairs, ""
    )
