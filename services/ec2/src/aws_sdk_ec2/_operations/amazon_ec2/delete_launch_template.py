...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_launch_template_result.DeleteLaunchTemplateResult = (
        aws_sdk_ec2.types.delete_launch_template_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_launch_template_request.DeleteLaunchTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_launch_template_request.serialize_ec2_query(
        input_, pairs, ""
    )
