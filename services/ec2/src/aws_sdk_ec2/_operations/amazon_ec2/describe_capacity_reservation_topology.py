...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_capacity_reservation_topology_result.DescribeCapacityReservationTopologyResult = aws_sdk_ec2.types.describe_capacity_reservation_topology_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_capacity_reservation_topology_request.DescribeCapacityReservationTopologyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_capacity_reservation_topology_request.serialize_ec2_query(
        input_, pairs, ""
    )
