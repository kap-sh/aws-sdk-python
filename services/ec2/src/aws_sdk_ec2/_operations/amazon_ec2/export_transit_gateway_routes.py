...
def handle_response(
    ...
    out: aws_sdk_ec2.types.export_transit_gateway_routes_result.ExportTransitGatewayRoutesResult = aws_sdk_ec2.types.export_transit_gateway_routes_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.export_transit_gateway_routes_request.ExportTransitGatewayRoutesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ExportTransitGatewayRoutes"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.export_transit_gateway_routes_request.serialize_ec2_query(
        input_, pairs, ""
    )
