...
def handle_response(
    ...
    out: aws_sdk_ec2.types.export_client_vpn_client_configuration_result.ExportClientVpnClientConfigurationResult = aws_sdk_ec2.types.export_client_vpn_client_configuration_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.export_client_vpn_client_configuration_request.ExportClientVpnClientConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ExportClientVpnClientConfiguration"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.export_client_vpn_client_configuration_request

    aws_sdk_ec2.types.export_client_vpn_client_configuration_request.serialize_ec2_query(
        input_, pairs, ""
    )
