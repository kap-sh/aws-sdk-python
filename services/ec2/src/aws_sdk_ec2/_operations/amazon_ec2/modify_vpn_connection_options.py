...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_vpn_connection_options_result.ModifyVpnConnectionOptionsResult = aws_sdk_ec2.types.modify_vpn_connection_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_vpn_connection_options_request.ModifyVpnConnectionOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_vpn_connection_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
