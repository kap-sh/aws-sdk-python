...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_network_insights_analysis_result.DeleteNetworkInsightsAnalysisResult = aws_sdk_ec2.types.delete_network_insights_analysis_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_network_insights_analysis_request.DeleteNetworkInsightsAnalysisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteNetworkInsightsAnalysis"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_network_insights_analysis_request

    aws_sdk_ec2.types.delete_network_insights_analysis_request.serialize_ec2_query(
        input_, pairs, ""
    )
