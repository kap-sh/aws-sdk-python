...
def handle_response(
    ...
    out: aws_sdk_ec2.types.import_instance_result.ImportInstanceResult = (
        aws_sdk_ec2.types.import_instance_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.import_instance_request.ImportInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ImportInstance"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.import_instance_request

    aws_sdk_ec2.types.import_instance_request.serialize_ec2_query(input_, pairs, "")
