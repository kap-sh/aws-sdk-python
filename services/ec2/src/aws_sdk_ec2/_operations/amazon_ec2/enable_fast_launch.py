...
) -> aws_sdk_ec2.types.enable_fast_launch_result.EnableFastLaunchResult:
    import aws_sdk_ec2.types.enable_fast_launch_result

    out: aws_sdk_ec2.types.enable_fast_launch_result.EnableFastLaunchResult = (
        aws_sdk_ec2.types.enable_fast_launch_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_fast_launch_request.EnableFastLaunchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.enable_fast_launch_request.serialize_ec2_query(input_, pairs, "")
