"""Generated from Smithy shape ``com.amazonaws.ec2#RevokeSecurityGroupEgress``."""
...
) -> aws_sdk_ec2.types.revoke_security_group_egress_result.RevokeSecurityGroupEgressResult:
    out: aws_sdk_ec2.types.revoke_security_group_egress_result.RevokeSecurityGroupEgressResult = aws_sdk_ec2.types.revoke_security_group_egress_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.revoke_security_group_egress_request.RevokeSecurityGroupEgressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RevokeSecurityGroupEgress"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.revoke_security_group_egress_request

    aws_sdk_ec2.types.revoke_security_group_egress_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_revoke_security_group_egress(
