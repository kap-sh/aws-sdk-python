...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_security_group_result.CreateSecurityGroupResult = (
        aws_sdk_ec2.types.create_security_group_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_security_group_request.CreateSecurityGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateSecurityGroup"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_security_group_request

    aws_sdk_ec2.types.create_security_group_request.serialize_ec2_query(
        input_, pairs, ""
    )
