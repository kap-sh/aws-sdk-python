...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_dhcp_options_result.CreateDhcpOptionsResult = (
        aws_sdk_ec2.types.create_dhcp_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_dhcp_options_request.CreateDhcpOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_dhcp_options_request.serialize_ec2_query(input_, pairs, "")
