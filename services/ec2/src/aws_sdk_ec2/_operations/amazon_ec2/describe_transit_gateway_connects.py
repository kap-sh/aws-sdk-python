...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_transit_gateway_connects_result.DescribeTransitGatewayConnectsResult = aws_sdk_ec2.types.describe_transit_gateway_connects_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_transit_gateway_connects_request.DescribeTransitGatewayConnectsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeTransitGatewayConnects"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_transit_gateway_connects_request

    aws_sdk_ec2.types.describe_transit_gateway_connects_request.serialize_ec2_query(
        input_, pairs, ""
    )
