"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyVpcAttribute``."""
...
def build_request(
    ...
    input: aws_sdk_ec2.types.modify_vpc_attribute_request.ModifyVpcAttributeRequest,
) -> zapros.Request:
    ...
    pairs.append(("Action", "ModifyVpcAttribute"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.modify_vpc_attribute_request

    aws_sdk_ec2.types.modify_vpc_attribute_request.serialize_ec2_query(input, pairs, "")
...
async def async_modify_vpc_attribute(
