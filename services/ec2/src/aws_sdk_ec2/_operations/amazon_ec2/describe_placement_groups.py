...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_placement_groups_result.DescribePlacementGroupsResult = aws_sdk_ec2.types.describe_placement_groups_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_placement_groups_request.DescribePlacementGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribePlacementGroups"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_placement_groups_request

    aws_sdk_ec2.types.describe_placement_groups_request.serialize_ec2_query(
        input_, pairs, ""
    )
