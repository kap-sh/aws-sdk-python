...
def handle_response(
    ...
    out: aws_sdk_ec2.types.search_transit_gateway_routes_result.SearchTransitGatewayRoutesResult = aws_sdk_ec2.types.search_transit_gateway_routes_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.search_transit_gateway_routes_request.SearchTransitGatewayRoutesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.search_transit_gateway_routes_request.serialize_ec2_query(
        input_, pairs, ""
    )
