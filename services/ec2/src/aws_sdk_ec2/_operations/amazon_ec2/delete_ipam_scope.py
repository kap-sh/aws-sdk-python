...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_ipam_scope_result.DeleteIpamScopeResult = (
        aws_sdk_ec2.types.delete_ipam_scope_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_ipam_scope_request.DeleteIpamScopeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteIpamScope"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_ipam_scope_request

    aws_sdk_ec2.types.delete_ipam_scope_request.serialize_ec2_query(input_, pairs, "")
