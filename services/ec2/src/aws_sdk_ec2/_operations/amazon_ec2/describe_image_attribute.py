...
) -> aws_sdk_ec2.types.image_attribute.ImageAttribute:
    out: aws_sdk_ec2.types.image_attribute.ImageAttribute = (
        aws_sdk_ec2.types.image_attribute.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_image_attribute_request.DescribeImageAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_image_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
def describe_image_attribute(
    ...
    input_: aws_sdk_ec2.types.describe_image_attribute_request.DescribeImageAttributeRequest,
) -> tuple[aws_sdk_ec2.types.image_attribute.ImageAttribute, zapros.Response]:
