...
def handle_response(
    ...
    out: aws_sdk_ec2.types.move_byoip_cidr_to_ipam_result.MoveByoipCidrToIpamResult = (
        aws_sdk_ec2.types.move_byoip_cidr_to_ipam_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.move_byoip_cidr_to_ipam_request.MoveByoipCidrToIpamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.move_byoip_cidr_to_ipam_request.serialize_ec2_query(
        input_, pairs, ""
    )
