"""Generated from Smithy shape ``com.amazonaws.ec2#ResetNetworkInterfaceAttribute``."""
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.reset_network_interface_attribute_request.ResetNetworkInterfaceAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ResetNetworkInterfaceAttribute"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.reset_network_interface_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_reset_network_interface_attribute(
