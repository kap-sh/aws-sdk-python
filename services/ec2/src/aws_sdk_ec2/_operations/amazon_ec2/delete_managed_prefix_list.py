...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_managed_prefix_list_result.DeleteManagedPrefixListResult = aws_sdk_ec2.types.delete_managed_prefix_list_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_managed_prefix_list_request.DeleteManagedPrefixListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_managed_prefix_list_request.serialize_ec2_query(
        input_, pairs, ""
    )
