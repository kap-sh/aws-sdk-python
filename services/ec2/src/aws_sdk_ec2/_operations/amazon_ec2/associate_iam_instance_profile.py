...
def handle_response(
    ...
    out: aws_sdk_ec2.types.associate_iam_instance_profile_result.AssociateIamInstanceProfileResult = aws_sdk_ec2.types.associate_iam_instance_profile_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.associate_iam_instance_profile_request.AssociateIamInstanceProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.associate_iam_instance_profile_request.serialize_ec2_query(
        input_, pairs, ""
    )
