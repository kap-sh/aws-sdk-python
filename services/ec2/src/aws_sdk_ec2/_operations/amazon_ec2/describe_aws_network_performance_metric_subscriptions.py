...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_aws_network_performance_metric_subscriptions_result.DescribeAwsNetworkPerformanceMetricSubscriptionsResult = aws_sdk_ec2.types.describe_aws_network_performance_metric_subscriptions_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_aws_network_performance_metric_subscriptions_request.DescribeAwsNetworkPerformanceMetricSubscriptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_aws_network_performance_metric_subscriptions_request.serialize_ec2_query(
        input_, pairs, ""
    )
