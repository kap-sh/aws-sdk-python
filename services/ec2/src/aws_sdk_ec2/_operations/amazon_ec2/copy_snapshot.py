...
def handle_response(
    ...
    out: aws_sdk_ec2.types.copy_snapshot_result.CopySnapshotResult = (
        aws_sdk_ec2.types.copy_snapshot_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.copy_snapshot_request.CopySnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.copy_snapshot_request.serialize_ec2_query(input_, pairs, "")
