...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_transit_gateway_policy_table_associations_result.GetTransitGatewayPolicyTableAssociationsResult = aws_sdk_ec2.types.get_transit_gateway_policy_table_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_transit_gateway_policy_table_associations_request.GetTransitGatewayPolicyTableAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_transit_gateway_policy_table_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
