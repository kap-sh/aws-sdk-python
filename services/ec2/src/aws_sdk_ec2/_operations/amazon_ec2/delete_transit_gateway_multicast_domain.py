"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTransitGatewayMulticastDomain``."""
...
) -> aws_sdk_ec2.types.delete_transit_gateway_multicast_domain_result.DeleteTransitGatewayMulticastDomainResult:
    out: aws_sdk_ec2.types.delete_transit_gateway_multicast_domain_result.DeleteTransitGatewayMulticastDomainResult = aws_sdk_ec2.types.delete_transit_gateway_multicast_domain_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_transit_gateway_multicast_domain_request.DeleteTransitGatewayMulticastDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteTransitGatewayMulticastDomain"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.delete_transit_gateway_multicast_domain_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_transit_gateway_multicast_domain(
