...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_verified_access_trust_provider_result.DeleteVerifiedAccessTrustProviderResult = aws_sdk_ec2.types.delete_verified_access_trust_provider_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_verified_access_trust_provider_request.DeleteVerifiedAccessTrustProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteVerifiedAccessTrustProvider"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_verified_access_trust_provider_request

    aws_sdk_ec2.types.delete_verified_access_trust_provider_request.serialize_ec2_query(
        input_, pairs, ""
    )
