...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_network_acl_entry_request.DeleteNetworkAclEntryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteNetworkAclEntry"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_network_acl_entry_request

    aws_sdk_ec2.types.delete_network_acl_entry_request.serialize_ec2_query(
        input_, pairs, ""
    )
