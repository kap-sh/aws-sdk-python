...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_capacity_manager_metric_dimensions_result.GetCapacityManagerMetricDimensionsResult = aws_sdk_ec2.types.get_capacity_manager_metric_dimensions_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_capacity_manager_metric_dimensions_request.GetCapacityManagerMetricDimensionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_capacity_manager_metric_dimensions_request.serialize_ec2_query(
        input_, pairs, ""
    )
