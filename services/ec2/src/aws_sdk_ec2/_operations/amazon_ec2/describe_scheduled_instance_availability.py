...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_scheduled_instance_availability_result.DescribeScheduledInstanceAvailabilityResult = aws_sdk_ec2.types.describe_scheduled_instance_availability_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_scheduled_instance_availability_request.DescribeScheduledInstanceAvailabilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeScheduledInstanceAvailability"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_scheduled_instance_availability_request

    aws_sdk_ec2.types.describe_scheduled_instance_availability_request.serialize_ec2_query(
        input_, pairs, ""
    )
