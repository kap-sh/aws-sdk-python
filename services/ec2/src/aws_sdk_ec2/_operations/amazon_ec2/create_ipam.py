...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_ipam_result.CreateIpamResult = (
        aws_sdk_ec2.types.create_ipam_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_ipam_request.CreateIpamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_ipam_request.serialize_ec2_query(input_, pairs, "")
