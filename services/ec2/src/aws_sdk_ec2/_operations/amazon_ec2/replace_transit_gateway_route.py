...
def handle_response(
    ...
    out: aws_sdk_ec2.types.replace_transit_gateway_route_result.ReplaceTransitGatewayRouteResult = aws_sdk_ec2.types.replace_transit_gateway_route_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.replace_transit_gateway_route_request.ReplaceTransitGatewayRouteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
