...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_transit_gateway_connect_peers_result.DescribeTransitGatewayConnectPeersResult = aws_sdk_ec2.types.describe_transit_gateway_connect_peers_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_transit_gateway_connect_peers_request.DescribeTransitGatewayConnectPeersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeTransitGatewayConnectPeers"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_transit_gateway_connect_peers_request

    aws_sdk_ec2.types.describe_transit_gateway_connect_peers_request.serialize_ec2_query(
        input_, pairs, ""
    )
