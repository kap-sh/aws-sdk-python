...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_instance_credit_specifications_result.DescribeInstanceCreditSpecificationsResult = aws_sdk_ec2.types.describe_instance_credit_specifications_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_instance_credit_specifications_request.DescribeInstanceCreditSpecificationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_instance_credit_specifications_request.serialize_ec2_query(
        input_, pairs, ""
    )
