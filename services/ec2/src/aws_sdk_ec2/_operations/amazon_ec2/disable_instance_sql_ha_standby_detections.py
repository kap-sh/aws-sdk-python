...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disable_instance_sql_ha_standby_detections_result.DisableInstanceSqlHaStandbyDetectionsResult = aws_sdk_ec2.types.disable_instance_sql_ha_standby_detections_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disable_instance_sql_ha_standby_detections_request.DisableInstanceSqlHaStandbyDetectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disable_instance_sql_ha_standby_detections_request.serialize_ec2_query(
        input_, pairs, ""
    )
