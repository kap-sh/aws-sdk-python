"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeAvailabilityZones``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_availability_zones_result.DescribeAvailabilityZonesResult = aws_sdk_ec2.types.describe_availability_zones_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_availability_zones_request.DescribeAvailabilityZonesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeAvailabilityZones"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.describe_availability_zones_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_availability_zones(
