...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_vpc_request.DeleteVpcRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteVpc"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_vpc_request

    aws_sdk_ec2.types.delete_vpc_request.serialize_ec2_query(input_, pairs, "")
