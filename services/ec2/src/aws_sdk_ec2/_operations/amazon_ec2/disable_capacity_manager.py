...
) -> aws_sdk_ec2.types.disable_capacity_manager_result.DisableCapacityManagerResult:
    import aws_sdk_ec2.types.disable_capacity_manager_result

    out: aws_sdk_ec2.types.disable_capacity_manager_result.DisableCapacityManagerResult = aws_sdk_ec2.types.disable_capacity_manager_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disable_capacity_manager_request.DisableCapacityManagerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disable_capacity_manager_request.serialize_ec2_query(
        input_, pairs, ""
    )
