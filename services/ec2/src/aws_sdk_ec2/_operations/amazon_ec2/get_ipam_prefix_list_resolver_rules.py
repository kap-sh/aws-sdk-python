...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_ipam_prefix_list_resolver_rules_result.GetIpamPrefixListResolverRulesResult = aws_sdk_ec2.types.get_ipam_prefix_list_resolver_rules_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_ipam_prefix_list_resolver_rules_request.GetIpamPrefixListResolverRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_ipam_prefix_list_resolver_rules_request.serialize_ec2_query(
        input_, pairs, ""
    )
