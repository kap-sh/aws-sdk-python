...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_host_reservations_result.DescribeHostReservationsResult = aws_sdk_ec2.types.describe_host_reservations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_host_reservations_request.DescribeHostReservationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeHostReservations"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.describe_host_reservations_request.serialize_ec2_query(
        input_, pairs, ""
    )
