...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_vpc_tenancy_result.ModifyVpcTenancyResult = (
        aws_sdk_ec2.types.modify_vpc_tenancy_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_vpc_tenancy_request.ModifyVpcTenancyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_vpc_tenancy_request.serialize_ec2_query(input_, pairs, "")
