...
def handle_response(
    ...
    out: aws_sdk_ec2.types.deprovision_byoip_cidr_result.DeprovisionByoipCidrResult = (
        aws_sdk_ec2.types.deprovision_byoip_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.deprovision_byoip_cidr_request.DeprovisionByoipCidrRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeprovisionByoipCidr"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.deprovision_byoip_cidr_request

    aws_sdk_ec2.types.deprovision_byoip_cidr_request.serialize_ec2_query(
        input_, pairs, ""
    )
