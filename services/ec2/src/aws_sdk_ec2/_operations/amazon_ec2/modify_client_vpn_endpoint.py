...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_client_vpn_endpoint_request.ModifyClientVpnEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_client_vpn_endpoint_request.serialize_ec2_query(
        input_, pairs, ""
    )
