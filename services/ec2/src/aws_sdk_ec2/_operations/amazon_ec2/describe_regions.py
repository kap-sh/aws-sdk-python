...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_regions_result.DescribeRegionsResult = (
        aws_sdk_ec2.types.describe_regions_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_regions_request.DescribeRegionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_regions_request.serialize_ec2_query(input_, pairs, "")
...
def describe_regions(
    ...
    aws_sdk_ec2.types.describe_regions_result.DescribeRegionsResult, zapros.Response
]:
