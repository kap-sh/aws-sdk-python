...
def handle_response(
    ...
    out: aws_sdk_ec2.types.accept_address_transfer_result.AcceptAddressTransferResult = aws_sdk_ec2.types.accept_address_transfer_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.accept_address_transfer_request.AcceptAddressTransferRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.accept_address_transfer_request.serialize_ec2_query(
        input_, pairs, ""
    )
