"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeSnapshotTierStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_snapshot_tier_status_result.DescribeSnapshotTierStatusResult = aws_sdk_ec2.types.describe_snapshot_tier_status_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_snapshot_tier_status_request.DescribeSnapshotTierStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeSnapshotTierStatus"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_snapshot_tier_status_request

    aws_sdk_ec2.types.describe_snapshot_tier_status_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_snapshot_tier_status(
