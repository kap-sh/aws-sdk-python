...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_traffic_mirror_filter_rules_result.DescribeTrafficMirrorFilterRulesResult = aws_sdk_ec2.types.describe_traffic_mirror_filter_rules_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_traffic_mirror_filter_rules_request.DescribeTrafficMirrorFilterRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_traffic_mirror_filter_rules_request.serialize_ec2_query(
        input_, pairs, ""
    )
