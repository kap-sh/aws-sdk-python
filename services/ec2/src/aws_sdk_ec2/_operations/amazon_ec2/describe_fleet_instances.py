...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_fleet_instances_result.DescribeFleetInstancesResult = aws_sdk_ec2.types.describe_fleet_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_fleet_instances_request.DescribeFleetInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_fleet_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
