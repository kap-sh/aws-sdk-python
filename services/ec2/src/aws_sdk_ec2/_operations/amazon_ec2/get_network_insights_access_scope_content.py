...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_network_insights_access_scope_content_result.GetNetworkInsightsAccessScopeContentResult = aws_sdk_ec2.types.get_network_insights_access_scope_content_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_network_insights_access_scope_content_request.GetNetworkInsightsAccessScopeContentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_network_insights_access_scope_content_request.serialize_ec2_query(
        input_, pairs, ""
    )
