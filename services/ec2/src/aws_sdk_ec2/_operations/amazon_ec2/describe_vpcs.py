...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_vpcs_result.DescribeVpcsResult = (
        aws_sdk_ec2.types.describe_vpcs_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_vpcs_request.DescribeVpcsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeVpcs"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_vpcs_request

    aws_sdk_ec2.types.describe_vpcs_request.serialize_ec2_query(input_, pairs, "")
