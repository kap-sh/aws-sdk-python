...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_managed_prefix_list_associations_result.GetManagedPrefixListAssociationsResult = aws_sdk_ec2.types.get_managed_prefix_list_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_managed_prefix_list_associations_request.GetManagedPrefixListAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_managed_prefix_list_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
