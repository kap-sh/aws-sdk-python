...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_network_acls_result.DescribeNetworkAclsResult = (
        aws_sdk_ec2.types.describe_network_acls_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_network_acls_request.DescribeNetworkAclsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_network_acls_request.serialize_ec2_query(
        input_, pairs, ""
    )
