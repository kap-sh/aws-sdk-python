...
def handle_response(
    ...
    out: aws_sdk_ec2.types.associate_ipam_byoasn_result.AssociateIpamByoasnResult = (
        aws_sdk_ec2.types.associate_ipam_byoasn_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.associate_ipam_byoasn_request.AssociateIpamByoasnRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.associate_ipam_byoasn_request.serialize_ec2_query(
        input_, pairs, ""
    )
