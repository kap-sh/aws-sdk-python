...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_ipam_pool_result.DeleteIpamPoolResult = (
        aws_sdk_ec2.types.delete_ipam_pool_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_ipam_pool_request.DeleteIpamPoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_ipam_pool_request.serialize_ec2_query(input_, pairs, "")
...
def delete_ipam_pool(
    ...
    aws_sdk_ec2.types.delete_ipam_pool_result.DeleteIpamPoolResult, zapros.Response
]:
