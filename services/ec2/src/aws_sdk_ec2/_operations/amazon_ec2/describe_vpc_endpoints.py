...
) -> aws_sdk_ec2.types.describe_vpc_endpoints_result.DescribeVpcEndpointsResult:
    import aws_sdk_ec2.types.describe_vpc_endpoints_result

    out: aws_sdk_ec2.types.describe_vpc_endpoints_result.DescribeVpcEndpointsResult = (
        aws_sdk_ec2.types.describe_vpc_endpoints_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_vpc_endpoints_request.DescribeVpcEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_vpc_endpoints_request.serialize_ec2_query(
        input_, pairs, ""
    )
