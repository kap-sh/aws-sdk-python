...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_image_usage_report_result.DeleteImageUsageReportResult = aws_sdk_ec2.types.delete_image_usage_report_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_image_usage_report_request.DeleteImageUsageReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_image_usage_report_request.serialize_ec2_query(
        input_, pairs, ""
    )
