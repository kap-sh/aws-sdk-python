...
) -> aws_sdk_ec2.types.replace_vpn_tunnel_result.ReplaceVpnTunnelResult:
    import aws_sdk_ec2.types.replace_vpn_tunnel_result

    out: aws_sdk_ec2.types.replace_vpn_tunnel_result.ReplaceVpnTunnelResult = (
        aws_sdk_ec2.types.replace_vpn_tunnel_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.replace_vpn_tunnel_request.ReplaceVpnTunnelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ReplaceVpnTunnel"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.replace_vpn_tunnel_request

    aws_sdk_ec2.types.replace_vpn_tunnel_request.serialize_ec2_query(input_, pairs, "")
