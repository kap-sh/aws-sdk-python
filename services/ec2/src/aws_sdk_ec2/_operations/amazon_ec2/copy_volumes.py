...
def handle_response(
    ...
    out: aws_sdk_ec2.types.copy_volumes_result.CopyVolumesResult = (
        aws_sdk_ec2.types.copy_volumes_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.copy_volumes_request.CopyVolumesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.copy_volumes_request.serialize_ec2_query(input_, pairs, "")
