...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_fleets_result.DeleteFleetsResult = (
        aws_sdk_ec2.types.delete_fleets_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_fleets_request.DeleteFleetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteFleets"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_fleets_request

    aws_sdk_ec2.types.delete_fleets_request.serialize_ec2_query(input_, pairs, "")
