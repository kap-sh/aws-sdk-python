...
def handle_response(
    ...
    out: aws_sdk_ec2.types.enable_address_transfer_result.EnableAddressTransferResult = aws_sdk_ec2.types.enable_address_transfer_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_address_transfer_request.EnableAddressTransferRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.enable_address_transfer_request.serialize_ec2_query(
        input_, pairs, ""
    )
