...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_vpc_endpoint_connection_notifications_result.DescribeVpcEndpointConnectionNotificationsResult = aws_sdk_ec2.types.describe_vpc_endpoint_connection_notifications_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_vpc_endpoint_connection_notifications_request.DescribeVpcEndpointConnectionNotificationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_vpc_endpoint_connection_notifications_request.serialize_ec2_query(
        input_, pairs, ""
    )
