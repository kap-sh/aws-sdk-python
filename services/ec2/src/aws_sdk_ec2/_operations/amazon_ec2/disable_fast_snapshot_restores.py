...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disable_fast_snapshot_restores_result.DisableFastSnapshotRestoresResult = aws_sdk_ec2.types.disable_fast_snapshot_restores_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disable_fast_snapshot_restores_request.DisableFastSnapshotRestoresRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disable_fast_snapshot_restores_request.serialize_ec2_query(
        input_, pairs, ""
    )
