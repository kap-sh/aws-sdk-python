...
def handle_response(
    ...
    out: aws_sdk_ec2.types.associate_instance_event_window_result.AssociateInstanceEventWindowResult = aws_sdk_ec2.types.associate_instance_event_window_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.associate_instance_event_window_request.AssociateInstanceEventWindowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.associate_instance_event_window_request.serialize_ec2_query(
        input_, pairs, ""
    )
