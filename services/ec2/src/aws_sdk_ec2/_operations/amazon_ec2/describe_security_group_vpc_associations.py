...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_security_group_vpc_associations_result.DescribeSecurityGroupVpcAssociationsResult = aws_sdk_ec2.types.describe_security_group_vpc_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_security_group_vpc_associations_request.DescribeSecurityGroupVpcAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeSecurityGroupVpcAssociations"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_security_group_vpc_associations_request

    aws_sdk_ec2.types.describe_security_group_vpc_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
