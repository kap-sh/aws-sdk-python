...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_fast_launch_images_result.DescribeFastLaunchImagesResult = aws_sdk_ec2.types.describe_fast_launch_images_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_fast_launch_images_request.DescribeFastLaunchImagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_fast_launch_images_request.serialize_ec2_query(
        input_, pairs, ""
    )
