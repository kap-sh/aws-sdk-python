...
) -> aws_sdk_ec2.types.delete_transit_gateway_connect_peer_result.DeleteTransitGatewayConnectPeerResult:
    out: aws_sdk_ec2.types.delete_transit_gateway_connect_peer_result.DeleteTransitGatewayConnectPeerResult = aws_sdk_ec2.types.delete_transit_gateway_connect_peer_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_transit_gateway_connect_peer_request.DeleteTransitGatewayConnectPeerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_transit_gateway_connect_peer_request.serialize_ec2_query(
        input_, pairs, ""
    )
