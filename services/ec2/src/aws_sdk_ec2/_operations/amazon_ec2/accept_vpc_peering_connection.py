...
def handle_response(
    ...
    out: aws_sdk_ec2.types.accept_vpc_peering_connection_result.AcceptVpcPeeringConnectionResult = aws_sdk_ec2.types.accept_vpc_peering_connection_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.accept_vpc_peering_connection_request.AcceptVpcPeeringConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.accept_vpc_peering_connection_request.serialize_ec2_query(
        input_, pairs, ""
    )
