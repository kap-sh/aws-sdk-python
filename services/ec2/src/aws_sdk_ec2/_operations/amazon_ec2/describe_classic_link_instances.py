...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_classic_link_instances_result.DescribeClassicLinkInstancesResult = aws_sdk_ec2.types.describe_classic_link_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_classic_link_instances_request.DescribeClassicLinkInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_classic_link_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
