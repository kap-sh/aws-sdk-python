...
def handle_response(
    ...
    out: aws_sdk_ec2.types.purchase_capacity_block_extension_result.PurchaseCapacityBlockExtensionResult = aws_sdk_ec2.types.purchase_capacity_block_extension_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.purchase_capacity_block_extension_request.PurchaseCapacityBlockExtensionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.purchase_capacity_block_extension_request.serialize_ec2_query(
        input_, pairs, ""
    )
