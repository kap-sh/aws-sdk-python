...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_capacity_reservation_fleet_result.CreateCapacityReservationFleetResult = aws_sdk_ec2.types.create_capacity_reservation_fleet_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_capacity_reservation_fleet_request.CreateCapacityReservationFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateCapacityReservationFleet"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_capacity_reservation_fleet_request

    aws_sdk_ec2.types.create_capacity_reservation_fleet_request.serialize_ec2_query(
        input_, pairs, ""
    )
