...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_spot_datafeed_subscription_result.DescribeSpotDatafeedSubscriptionResult = aws_sdk_ec2.types.describe_spot_datafeed_subscription_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_spot_datafeed_subscription_request.DescribeSpotDatafeedSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_spot_datafeed_subscription_request.serialize_ec2_query(
        input_, pairs, ""
    )
