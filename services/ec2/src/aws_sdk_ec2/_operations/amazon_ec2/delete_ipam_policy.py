"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteIpamPolicy``."""
...
) -> aws_sdk_ec2.types.delete_ipam_policy_result.DeleteIpamPolicyResult:
    import aws_sdk_ec2.types.delete_ipam_policy_result

    out: aws_sdk_ec2.types.delete_ipam_policy_result.DeleteIpamPolicyResult = (
        aws_sdk_ec2.types.delete_ipam_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_ipam_policy_request.DeleteIpamPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteIpamPolicy"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_ipam_policy_request

    aws_sdk_ec2.types.delete_ipam_policy_request.serialize_ec2_query(input_, pairs, "")
...
def delete_ipam_policy(
    ...
    aws_sdk_ec2.types.delete_ipam_policy_result.DeleteIpamPolicyResult, zapros.Response
]:
...
async def async_delete_ipam_policy(
