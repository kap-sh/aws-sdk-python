...
def build_request(
    ...
    input: aws_sdk_ec2.types.delete_ipam_policy_request.DeleteIpamPolicyRequest,
) -> zapros.Request:
    ...
    aws_sdk_ec2.types.delete_ipam_policy_request.serialize_ec2_query(input, pairs, "")
