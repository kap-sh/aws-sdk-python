...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_traffic_mirror_session_result.DeleteTrafficMirrorSessionResult = aws_sdk_ec2.types.delete_traffic_mirror_session_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_traffic_mirror_session_request.DeleteTrafficMirrorSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_traffic_mirror_session_request.serialize_ec2_query(
        input_, pairs, ""
    )
