...
def handle_response(
    ...
    out: aws_sdk_ec2.types.replace_network_acl_association_result.ReplaceNetworkAclAssociationResult = aws_sdk_ec2.types.replace_network_acl_association_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.replace_network_acl_association_request.ReplaceNetworkAclAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ReplaceNetworkAclAssociation"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.replace_network_acl_association_request

    aws_sdk_ec2.types.replace_network_acl_association_request.serialize_ec2_query(
        input_, pairs, ""
    )
