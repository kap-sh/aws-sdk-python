...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_route_server_associations_result.GetRouteServerAssociationsResult = aws_sdk_ec2.types.get_route_server_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_route_server_associations_request.GetRouteServerAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_route_server_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
