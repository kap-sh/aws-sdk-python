...
) -> aws_sdk_ec2.types.purchase_capacity_block_result.PurchaseCapacityBlockResult:
    import aws_sdk_ec2.types.purchase_capacity_block_result

    out: aws_sdk_ec2.types.purchase_capacity_block_result.PurchaseCapacityBlockResult = aws_sdk_ec2.types.purchase_capacity_block_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.purchase_capacity_block_request.PurchaseCapacityBlockRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.purchase_capacity_block_request.serialize_ec2_query(
        input_, pairs, ""
    )
