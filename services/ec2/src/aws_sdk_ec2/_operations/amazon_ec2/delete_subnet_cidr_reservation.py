...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_subnet_cidr_reservation_result.DeleteSubnetCidrReservationResult = aws_sdk_ec2.types.delete_subnet_cidr_reservation_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_subnet_cidr_reservation_request.DeleteSubnetCidrReservationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_subnet_cidr_reservation_request.serialize_ec2_query(
        input_, pairs, ""
    )
