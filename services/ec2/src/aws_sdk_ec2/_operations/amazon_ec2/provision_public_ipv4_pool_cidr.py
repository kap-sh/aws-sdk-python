...
def handle_response(
    ...
    out: aws_sdk_ec2.types.provision_public_ipv4_pool_cidr_result.ProvisionPublicIpv4PoolCidrResult = aws_sdk_ec2.types.provision_public_ipv4_pool_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.provision_public_ipv4_pool_cidr_request.ProvisionPublicIpv4PoolCidrRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.provision_public_ipv4_pool_cidr_request.serialize_ec2_query(
        input_, pairs, ""
    )
