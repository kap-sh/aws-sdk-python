...
def handle_response(
    ...
    out: aws_sdk_ec2.types.reset_fpga_image_attribute_result.ResetFpgaImageAttributeResult = aws_sdk_ec2.types.reset_fpga_image_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.reset_fpga_image_attribute_request.ResetFpgaImageAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.reset_fpga_image_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
