...
def handle_response(
    ...
    out: aws_sdk_ec2.types.apply_security_groups_to_client_vpn_target_network_result.ApplySecurityGroupsToClientVpnTargetNetworkResult = aws_sdk_ec2.types.apply_security_groups_to_client_vpn_target_network_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.apply_security_groups_to_client_vpn_target_network_request.ApplySecurityGroupsToClientVpnTargetNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ApplySecurityGroupsToClientVpnTargetNetwork"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.apply_security_groups_to_client_vpn_target_network_request.serialize_ec2_query(
        input_, pairs, ""
    )
