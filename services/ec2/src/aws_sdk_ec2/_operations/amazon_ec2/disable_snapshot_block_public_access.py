"""Generated from Smithy shape ``com.amazonaws.ec2#DisableSnapshotBlockPublicAccess``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disable_snapshot_block_public_access_result.DisableSnapshotBlockPublicAccessResult = aws_sdk_ec2.types.disable_snapshot_block_public_access_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disable_snapshot_block_public_access_request.DisableSnapshotBlockPublicAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DisableSnapshotBlockPublicAccess"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.disable_snapshot_block_public_access_request

    aws_sdk_ec2.types.disable_snapshot_block_public_access_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_disable_snapshot_block_public_access(
