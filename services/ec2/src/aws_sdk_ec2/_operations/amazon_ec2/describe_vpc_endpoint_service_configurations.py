...
) -> aws_sdk_ec2.types.describe_vpc_endpoint_service_configurations_result.DescribeVpcEndpointServiceConfigurationsResult:
    out: aws_sdk_ec2.types.describe_vpc_endpoint_service_configurations_result.DescribeVpcEndpointServiceConfigurationsResult = aws_sdk_ec2.types.describe_vpc_endpoint_service_configurations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_vpc_endpoint_service_configurations_request.DescribeVpcEndpointServiceConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_vpc_endpoint_service_configurations_request.serialize_ec2_query(
        input_, pairs, ""
    )
