...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_transit_gateway_peering_attachment_result.CreateTransitGatewayPeeringAttachmentResult = aws_sdk_ec2.types.create_transit_gateway_peering_attachment_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_transit_gateway_peering_attachment_request.CreateTransitGatewayPeeringAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateTransitGatewayPeeringAttachment"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_transit_gateway_peering_attachment_request

    aws_sdk_ec2.types.create_transit_gateway_peering_attachment_request.serialize_ec2_query(
        input_, pairs, ""
    )
