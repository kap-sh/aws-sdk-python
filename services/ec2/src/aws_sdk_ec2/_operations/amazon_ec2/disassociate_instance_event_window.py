...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disassociate_instance_event_window_result.DisassociateInstanceEventWindowResult = aws_sdk_ec2.types.disassociate_instance_event_window_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disassociate_instance_event_window_request.DisassociateInstanceEventWindowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
