...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_route_server_routing_database_result.GetRouteServerRoutingDatabaseResult = aws_sdk_ec2.types.get_route_server_routing_database_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_route_server_routing_database_request.GetRouteServerRoutingDatabaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_route_server_routing_database_request.serialize_ec2_query(
        input_, pairs, ""
    )
