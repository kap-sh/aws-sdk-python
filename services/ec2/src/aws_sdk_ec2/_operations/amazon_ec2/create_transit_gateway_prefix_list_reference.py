...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_transit_gateway_prefix_list_reference_result.CreateTransitGatewayPrefixListReferenceResult = aws_sdk_ec2.types.create_transit_gateway_prefix_list_reference_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_transit_gateway_prefix_list_reference_request.CreateTransitGatewayPrefixListReferenceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_transit_gateway_prefix_list_reference_request.serialize_ec2_query(
        input_, pairs, ""
    )
