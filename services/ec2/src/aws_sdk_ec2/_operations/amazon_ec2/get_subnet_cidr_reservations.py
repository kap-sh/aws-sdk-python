...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_subnet_cidr_reservations_result.GetSubnetCidrReservationsResult = aws_sdk_ec2.types.get_subnet_cidr_reservations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_subnet_cidr_reservations_request.GetSubnetCidrReservationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_subnet_cidr_reservations_request.serialize_ec2_query(
        input_, pairs, ""
    )
