...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_spot_fleet_instances_response.DescribeSpotFleetInstancesResponse = aws_sdk_ec2.types.describe_spot_fleet_instances_response.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_spot_fleet_instances_request.DescribeSpotFleetInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_spot_fleet_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
