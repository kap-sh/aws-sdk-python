"""Generated from Smithy shape ``com.amazonaws.ec2#EnableVgwRoutePropagation``."""
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_vgw_route_propagation_request.EnableVgwRoutePropagationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "EnableVgwRoutePropagation"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.enable_vgw_route_propagation_request

    aws_sdk_ec2.types.enable_vgw_route_propagation_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_enable_vgw_route_propagation(
