"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeAggregateIdFormat``."""
...
) -> aws_sdk_ec2.types.describe_aggregate_id_format_result.DescribeAggregateIdFormatResult:
    import aws_sdk_ec2.types.describe_aggregate_id_format_result

    out: aws_sdk_ec2.types.describe_aggregate_id_format_result.DescribeAggregateIdFormatResult = aws_sdk_ec2.types.describe_aggregate_id_format_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_aggregate_id_format_request.DescribeAggregateIdFormatRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeAggregateIdFormat"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_aggregate_id_format_request

    aws_sdk_ec2.types.describe_aggregate_id_format_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_aggregate_id_format(
