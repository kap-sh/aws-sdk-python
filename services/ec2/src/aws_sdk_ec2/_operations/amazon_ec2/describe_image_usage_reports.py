...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_image_usage_reports_result.DescribeImageUsageReportsResult = aws_sdk_ec2.types.describe_image_usage_reports_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_image_usage_reports_request.DescribeImageUsageReportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_image_usage_reports_request.serialize_ec2_query(
        input_, pairs, ""
    )
