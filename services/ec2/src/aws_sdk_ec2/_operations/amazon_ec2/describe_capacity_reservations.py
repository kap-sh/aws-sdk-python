...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_capacity_reservations_result.DescribeCapacityReservationsResult = aws_sdk_ec2.types.describe_capacity_reservations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_capacity_reservations_request.DescribeCapacityReservationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_capacity_reservations_request.serialize_ec2_query(
        input_, pairs, ""
    )
