"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteQueuedReservedInstances``."""
...
) -> aws_sdk_ec2.types.delete_queued_reserved_instances_result.DeleteQueuedReservedInstancesResult:
    out: aws_sdk_ec2.types.delete_queued_reserved_instances_result.DeleteQueuedReservedInstancesResult = aws_sdk_ec2.types.delete_queued_reserved_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_queued_reserved_instances_request.DeleteQueuedReservedInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteQueuedReservedInstances"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_queued_reserved_instances_request

    aws_sdk_ec2.types.delete_queued_reserved_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_queued_reserved_instances(
