...
def handle_response(
    ...
    out: aws_sdk_ec2.types.deprovision_ipam_pool_cidr_result.DeprovisionIpamPoolCidrResult = aws_sdk_ec2.types.deprovision_ipam_pool_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.deprovision_ipam_pool_cidr_request.DeprovisionIpamPoolCidrRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.deprovision_ipam_pool_cidr_request.serialize_ec2_query(
        input_, pairs, ""
    )
