...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_volume_result.ModifyVolumeResult = (
        aws_sdk_ec2.types.modify_volume_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_volume_request.ModifyVolumeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_volume_request.serialize_ec2_query(input_, pairs, "")
