...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disable_image_deregistration_protection_result.DisableImageDeregistrationProtectionResult = aws_sdk_ec2.types.disable_image_deregistration_protection_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disable_image_deregistration_protection_request.DisableImageDeregistrationProtectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DisableImageDeregistrationProtection"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.disable_image_deregistration_protection_request

    aws_sdk_ec2.types.disable_image_deregistration_protection_request.serialize_ec2_query(
        input_, pairs, ""
    )
