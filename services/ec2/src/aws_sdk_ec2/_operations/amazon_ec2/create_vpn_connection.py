...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_vpn_connection_result.CreateVpnConnectionResult = (
        aws_sdk_ec2.types.create_vpn_connection_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_vpn_connection_request.CreateVpnConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_vpn_connection_request.serialize_ec2_query(
        input_, pairs, ""
    )
