...
) -> aws_sdk_ec2.types.get_capacity_manager_metric_data_result.GetCapacityManagerMetricDataResult:
    import aws_sdk_ec2.types.get_capacity_manager_metric_data_result

    out: aws_sdk_ec2.types.get_capacity_manager_metric_data_result.GetCapacityManagerMetricDataResult = aws_sdk_ec2.types.get_capacity_manager_metric_data_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_capacity_manager_metric_data_request.GetCapacityManagerMetricDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_capacity_manager_metric_data_request.serialize_ec2_query(
        input_, pairs, ""
    )
