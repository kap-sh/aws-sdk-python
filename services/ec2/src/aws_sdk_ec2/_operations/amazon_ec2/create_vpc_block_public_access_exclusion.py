...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_vpc_block_public_access_exclusion_result.CreateVpcBlockPublicAccessExclusionResult = aws_sdk_ec2.types.create_vpc_block_public_access_exclusion_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_vpc_block_public_access_exclusion_request.CreateVpcBlockPublicAccessExclusionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
