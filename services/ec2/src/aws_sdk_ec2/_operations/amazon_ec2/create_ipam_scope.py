...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_ipam_scope_result.CreateIpamScopeResult = (
        aws_sdk_ec2.types.create_ipam_scope_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_ipam_scope_request.CreateIpamScopeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_ipam_scope_request.serialize_ec2_query(input_, pairs, "")
