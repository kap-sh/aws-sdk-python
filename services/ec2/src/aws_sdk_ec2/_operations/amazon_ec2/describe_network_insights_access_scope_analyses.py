...
import aws_sdk_ec2.types.network_insights_access_scope_analysis_list
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_network_insights_access_scope_analyses_result.DescribeNetworkInsightsAccessScopeAnalysesResult = aws_sdk_ec2.types.describe_network_insights_access_scope_analyses_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_network_insights_access_scope_analyses_request.DescribeNetworkInsightsAccessScopeAnalysesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeNetworkInsightsAccessScopeAnalyses"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_network_insights_access_scope_analyses_request

    aws_sdk_ec2.types.describe_network_insights_access_scope_analyses_request.serialize_ec2_query(
        input_, pairs, ""
    )
