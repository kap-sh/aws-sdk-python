...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_verified_access_endpoint_result.ModifyVerifiedAccessEndpointResult = aws_sdk_ec2.types.modify_verified_access_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_verified_access_endpoint_request.ModifyVerifiedAccessEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyVerifiedAccessEndpoint"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.modify_verified_access_endpoint_request

    aws_sdk_ec2.types.modify_verified_access_endpoint_request.serialize_ec2_query(
        input_, pairs, ""
    )
