...
import aws_sdk_ec2.types.network_insights_access_scope_list
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_network_insights_access_scopes_result.DescribeNetworkInsightsAccessScopesResult = aws_sdk_ec2.types.describe_network_insights_access_scopes_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_network_insights_access_scopes_request.DescribeNetworkInsightsAccessScopesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_network_insights_access_scopes_request.serialize_ec2_query(
        input_, pairs, ""
    )
