...
def handle_response(
    ...
    out: aws_sdk_ec2.types.register_instance_event_notification_attributes_result.RegisterInstanceEventNotificationAttributesResult = aws_sdk_ec2.types.register_instance_event_notification_attributes_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.register_instance_event_notification_attributes_request.RegisterInstanceEventNotificationAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.register_instance_event_notification_attributes_request.serialize_ec2_query(
        input_, pairs, ""
    )
