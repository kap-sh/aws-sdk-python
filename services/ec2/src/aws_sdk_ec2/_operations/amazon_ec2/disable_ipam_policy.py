...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disable_ipam_policy_result.DisableIpamPolicyResult = (
        aws_sdk_ec2.types.disable_ipam_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disable_ipam_policy_request.DisableIpamPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DisableIpamPolicy"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.disable_ipam_policy_request.serialize_ec2_query(input_, pairs, "")
