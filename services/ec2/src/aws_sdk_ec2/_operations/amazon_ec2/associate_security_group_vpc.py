...
def handle_response(
    ...
    out: aws_sdk_ec2.types.associate_security_group_vpc_result.AssociateSecurityGroupVpcResult = aws_sdk_ec2.types.associate_security_group_vpc_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.associate_security_group_vpc_request.AssociateSecurityGroupVpcRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.associate_security_group_vpc_request.serialize_ec2_query(
        input_, pairs, ""
    )
