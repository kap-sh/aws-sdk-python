"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeSpotInstanceRequests``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_spot_instance_requests_result.DescribeSpotInstanceRequestsResult = aws_sdk_ec2.types.describe_spot_instance_requests_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_spot_instance_requests_request.DescribeSpotInstanceRequestsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeSpotInstanceRequests"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_spot_instance_requests_request

    aws_sdk_ec2.types.describe_spot_instance_requests_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_spot_instance_requests(
