...
) -> aws_sdk_ec2.types.release_hosts_result.ReleaseHostsResult:
    out: aws_sdk_ec2.types.release_hosts_result.ReleaseHostsResult = (
        aws_sdk_ec2.types.release_hosts_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.release_hosts_request.ReleaseHostsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.release_hosts_request.serialize_ec2_query(input_, pairs, "")
