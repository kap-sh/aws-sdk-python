...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_client_vpn_route_result.DeleteClientVpnRouteResult = (
        aws_sdk_ec2.types.delete_client_vpn_route_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_client_vpn_route_request.DeleteClientVpnRouteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_client_vpn_route_request.serialize_ec2_query(
        input_, pairs, ""
    )
