...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_transit_gateway_vpc_attachment_result.ModifyTransitGatewayVpcAttachmentResult = aws_sdk_ec2.types.modify_transit_gateway_vpc_attachment_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_transit_gateway_vpc_attachment_request.ModifyTransitGatewayVpcAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_transit_gateway_vpc_attachment_request.serialize_ec2_query(
        input_, pairs, ""
    )
