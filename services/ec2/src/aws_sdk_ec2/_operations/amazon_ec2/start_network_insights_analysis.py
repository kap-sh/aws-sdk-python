...
def handle_response(
    ...
    out: aws_sdk_ec2.types.start_network_insights_analysis_result.StartNetworkInsightsAnalysisResult = aws_sdk_ec2.types.start_network_insights_analysis_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.start_network_insights_analysis_request.StartNetworkInsightsAnalysisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.start_network_insights_analysis_request.serialize_ec2_query(
        input_, pairs, ""
    )
