...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_ipam_pool_result.CreateIpamPoolResult = (
        aws_sdk_ec2.types.create_ipam_pool_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_ipam_pool_request.CreateIpamPoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateIpamPool"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_ipam_pool_request

    aws_sdk_ec2.types.create_ipam_pool_request.serialize_ec2_query(input_, pairs, "")
