...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_ipam_prefix_list_resolver_result.CreateIpamPrefixListResolverResult = aws_sdk_ec2.types.create_ipam_prefix_list_resolver_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_ipam_prefix_list_resolver_request.CreateIpamPrefixListResolverRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_ipam_prefix_list_resolver_request.serialize_ec2_query(
        input_, pairs, ""
    )
