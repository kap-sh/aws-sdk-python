...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_managed_resource_visibility_result.ModifyManagedResourceVisibilityResult = aws_sdk_ec2.types.modify_managed_resource_visibility_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_managed_resource_visibility_request.ModifyManagedResourceVisibilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_managed_resource_visibility_request.serialize_ec2_query(
        input_, pairs, ""
    )
