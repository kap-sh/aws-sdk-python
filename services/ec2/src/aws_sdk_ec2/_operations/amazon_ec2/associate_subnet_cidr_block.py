"""Generated from Smithy shape ``com.amazonaws.ec2#AssociateSubnetCidrBlock``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.associate_subnet_cidr_block_result.AssociateSubnetCidrBlockResult = aws_sdk_ec2.types.associate_subnet_cidr_block_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.associate_subnet_cidr_block_request.AssociateSubnetCidrBlockRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AssociateSubnetCidrBlock"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.associate_subnet_cidr_block_request

    aws_sdk_ec2.types.associate_subnet_cidr_block_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_associate_subnet_cidr_block(
