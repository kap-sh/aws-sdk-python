...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_vpc_encryption_controls_result.DescribeVpcEncryptionControlsResult = aws_sdk_ec2.types.describe_vpc_encryption_controls_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_vpc_encryption_controls_request.DescribeVpcEncryptionControlsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeVpcEncryptionControls"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.describe_vpc_encryption_controls_request.serialize_ec2_query(
        input_, pairs, ""
    )
