...
def handle_response(
    ...
    out: aws_sdk_ec2.types.unassign_private_nat_gateway_address_result.UnassignPrivateNatGatewayAddressResult = aws_sdk_ec2.types.unassign_private_nat_gateway_address_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.unassign_private_nat_gateway_address_request.UnassignPrivateNatGatewayAddressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.unassign_private_nat_gateway_address_request.serialize_ec2_query(
        input_, pairs, ""
    )
