...
def build_request(
    ...
    input_: aws_sdk_ec2.types.reset_instance_attribute_request.ResetInstanceAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.reset_instance_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
