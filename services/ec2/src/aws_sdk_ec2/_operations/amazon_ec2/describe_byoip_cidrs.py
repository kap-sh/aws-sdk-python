...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_byoip_cidrs_result.DescribeByoipCidrsResult = (
        aws_sdk_ec2.types.describe_byoip_cidrs_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_byoip_cidrs_request.DescribeByoipCidrsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_byoip_cidrs_request.serialize_ec2_query(
        input_, pairs, ""
    )
