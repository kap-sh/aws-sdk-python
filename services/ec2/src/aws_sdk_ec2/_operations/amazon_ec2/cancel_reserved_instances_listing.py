...
def handle_response(
    ...
    out: aws_sdk_ec2.types.cancel_reserved_instances_listing_result.CancelReservedInstancesListingResult = aws_sdk_ec2.types.cancel_reserved_instances_listing_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.cancel_reserved_instances_listing_request.CancelReservedInstancesListingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.cancel_reserved_instances_listing_request.serialize_ec2_query(
        input_, pairs, ""
    )
