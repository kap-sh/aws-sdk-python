...
def handle_response(
    ...
    out: aws_sdk_ec2.types.replace_image_criteria_in_allowed_images_settings_result.ReplaceImageCriteriaInAllowedImagesSettingsResult = aws_sdk_ec2.types.replace_image_criteria_in_allowed_images_settings_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.replace_image_criteria_in_allowed_images_settings_request.ReplaceImageCriteriaInAllowedImagesSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ReplaceImageCriteriaInAllowedImagesSettings"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.replace_image_criteria_in_allowed_images_settings_request

    aws_sdk_ec2.types.replace_image_criteria_in_allowed_images_settings_request.serialize_ec2_query(
        input_, pairs, ""
    )
