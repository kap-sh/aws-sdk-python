...
def handle_response(
    ...
    out: aws_sdk_ec2.types.attach_network_interface_result.AttachNetworkInterfaceResult = aws_sdk_ec2.types.attach_network_interface_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.attach_network_interface_request.AttachNetworkInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AttachNetworkInterface"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.attach_network_interface_request

    aws_sdk_ec2.types.attach_network_interface_request.serialize_ec2_query(
        input_, pairs, ""
    )
