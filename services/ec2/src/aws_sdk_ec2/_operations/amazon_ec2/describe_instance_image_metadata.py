...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_instance_image_metadata_result.DescribeInstanceImageMetadataResult = aws_sdk_ec2.types.describe_instance_image_metadata_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_instance_image_metadata_request.DescribeInstanceImageMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_instance_image_metadata_request.serialize_ec2_query(
        input_, pairs, ""
    )
