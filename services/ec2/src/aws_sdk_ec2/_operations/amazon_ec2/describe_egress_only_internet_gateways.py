...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_egress_only_internet_gateways_result.DescribeEgressOnlyInternetGatewaysResult = aws_sdk_ec2.types.describe_egress_only_internet_gateways_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_egress_only_internet_gateways_request.DescribeEgressOnlyInternetGatewaysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_egress_only_internet_gateways_request.serialize_ec2_query(
        input_, pairs, ""
    )
