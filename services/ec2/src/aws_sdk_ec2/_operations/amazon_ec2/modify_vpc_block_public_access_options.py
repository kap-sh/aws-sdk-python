...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_vpc_block_public_access_options_result.ModifyVpcBlockPublicAccessOptionsResult = aws_sdk_ec2.types.modify_vpc_block_public_access_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_vpc_block_public_access_options_request.ModifyVpcBlockPublicAccessOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_vpc_block_public_access_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
