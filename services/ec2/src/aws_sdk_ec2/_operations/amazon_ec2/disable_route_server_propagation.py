...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disable_route_server_propagation_result.DisableRouteServerPropagationResult = aws_sdk_ec2.types.disable_route_server_propagation_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disable_route_server_propagation_request.DisableRouteServerPropagationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disable_route_server_propagation_request.serialize_ec2_query(
        input_, pairs, ""
    )
