...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_verified_access_trust_provider_result.ModifyVerifiedAccessTrustProviderResult = aws_sdk_ec2.types.modify_verified_access_trust_provider_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_verified_access_trust_provider_request.ModifyVerifiedAccessTrustProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
