...
def handle_response(
    ...
    out: aws_sdk_ec2.types.deregister_transit_gateway_multicast_group_members_result.DeregisterTransitGatewayMulticastGroupMembersResult = aws_sdk_ec2.types.deregister_transit_gateway_multicast_group_members_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.deregister_transit_gateway_multicast_group_members_request.DeregisterTransitGatewayMulticastGroupMembersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.deregister_transit_gateway_multicast_group_members_request.serialize_ec2_query(
        input_, pairs, ""
    )
