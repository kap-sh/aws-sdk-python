...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_ipam_policy_allocation_rules_result.GetIpamPolicyAllocationRulesResult = aws_sdk_ec2.types.get_ipam_policy_allocation_rules_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_ipam_policy_allocation_rules_request.GetIpamPolicyAllocationRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_ipam_policy_allocation_rules_request.serialize_ec2_query(
        input_, pairs, ""
    )
