...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_flow_logs_result.DescribeFlowLogsResult = (
        aws_sdk_ec2.types.describe_flow_logs_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_flow_logs_request.DescribeFlowLogsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_flow_logs_request.serialize_ec2_query(input_, pairs, "")
...
def describe_flow_logs(
    ...
    aws_sdk_ec2.types.describe_flow_logs_result.DescribeFlowLogsResult, zapros.Response
]:
