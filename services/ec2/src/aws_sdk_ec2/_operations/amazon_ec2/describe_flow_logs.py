...
def build_request(
    ...
    input: aws_sdk_ec2.types.describe_flow_logs_request.DescribeFlowLogsRequest,
) -> zapros.Request:
    ...
    aws_sdk_ec2.types.describe_flow_logs_request.serialize_ec2_query(input, pairs, "")
