...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_ipam_byoasn_result.DescribeIpamByoasnResult = (
        aws_sdk_ec2.types.describe_ipam_byoasn_result.deserialize_ec2_query(
...
def build_request(
    ...
    input: aws_sdk_ec2.types.describe_ipam_byoasn_request.DescribeIpamByoasnRequest,
) -> zapros.Request:
    ...
    aws_sdk_ec2.types.describe_ipam_byoasn_request.serialize_ec2_query(input, pairs, "")
