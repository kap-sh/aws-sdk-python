...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_ipam_result.ModifyIpamResult = (
        aws_sdk_ec2.types.modify_ipam_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_ipam_request.ModifyIpamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_ipam_request.serialize_ec2_query(input_, pairs, "")
