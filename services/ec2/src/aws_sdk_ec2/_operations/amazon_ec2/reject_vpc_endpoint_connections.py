...
def handle_response(
    ...
    out: aws_sdk_ec2.types.reject_vpc_endpoint_connections_result.RejectVpcEndpointConnectionsResult = aws_sdk_ec2.types.reject_vpc_endpoint_connections_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.reject_vpc_endpoint_connections_request.RejectVpcEndpointConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.reject_vpc_endpoint_connections_request.serialize_ec2_query(
        input_, pairs, ""
    )
