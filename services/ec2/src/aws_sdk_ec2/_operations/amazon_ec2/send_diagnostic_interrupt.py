...
def build_request(
    ...
    input_: aws_sdk_ec2.types.send_diagnostic_interrupt_request.SendDiagnosticInterruptRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "SendDiagnosticInterrupt"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.send_diagnostic_interrupt_request

    aws_sdk_ec2.types.send_diagnostic_interrupt_request.serialize_ec2_query(
        input_, pairs, ""
    )
