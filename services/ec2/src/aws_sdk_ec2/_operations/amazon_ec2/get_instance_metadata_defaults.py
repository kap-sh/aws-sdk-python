...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_instance_metadata_defaults_result.GetInstanceMetadataDefaultsResult = aws_sdk_ec2.types.get_instance_metadata_defaults_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_instance_metadata_defaults_request.GetInstanceMetadataDefaultsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_instance_metadata_defaults_request.serialize_ec2_query(
        input_, pairs, ""
    )
