...
def handle_response(
    ...
    out: aws_sdk_ec2.types.associate_transit_gateway_policy_table_result.AssociateTransitGatewayPolicyTableResult = aws_sdk_ec2.types.associate_transit_gateway_policy_table_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.associate_transit_gateway_policy_table_request.AssociateTransitGatewayPolicyTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.associate_transit_gateway_policy_table_request.serialize_ec2_query(
        input_, pairs, ""
    )
