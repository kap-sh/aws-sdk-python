...
) -> aws_sdk_ec2.types.delete_coip_pool_result.DeleteCoipPoolResult:
    import aws_sdk_ec2.types.delete_coip_pool_result

    out: aws_sdk_ec2.types.delete_coip_pool_result.DeleteCoipPoolResult = (
        aws_sdk_ec2.types.delete_coip_pool_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_coip_pool_request.DeleteCoipPoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_coip_pool_request.serialize_ec2_query(input_, pairs, "")
