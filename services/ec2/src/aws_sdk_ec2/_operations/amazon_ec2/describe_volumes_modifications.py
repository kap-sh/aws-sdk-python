...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_volumes_modifications_result.DescribeVolumesModificationsResult = aws_sdk_ec2.types.describe_volumes_modifications_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_volumes_modifications_request.DescribeVolumesModificationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_volumes_modifications_request.serialize_ec2_query(
        input_, pairs, ""
    )
