...
def handle_response(response: zapros.Response) -> aws_sdk_ec2.types.volume.Volume:
    out: aws_sdk_ec2.types.volume.Volume = (
        aws_sdk_ec2.types.volume.deserialize_ec2_query(fromstring(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: aws_sdk_ec2.types.volume.Volume = (
        aws_sdk_ec2.types.volume.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_volume_request.CreateVolumeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateVolume"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.create_volume_request.serialize_ec2_query(input_, pairs, "")
