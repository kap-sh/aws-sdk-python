...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_transit_gateway_metering_policy_entries_result.GetTransitGatewayMeteringPolicyEntriesResult = aws_sdk_ec2.types.get_transit_gateway_metering_policy_entries_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_transit_gateway_metering_policy_entries_request.GetTransitGatewayMeteringPolicyEntriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_transit_gateway_metering_policy_entries_request.serialize_ec2_query(
        input_, pairs, ""
    )
