...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_ipam_external_resource_verification_token_result.DeleteIpamExternalResourceVerificationTokenResult = aws_sdk_ec2.types.delete_ipam_external_resource_verification_token_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_ipam_external_resource_verification_token_request.DeleteIpamExternalResourceVerificationTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteIpamExternalResourceVerificationToken"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.delete_ipam_external_resource_verification_token_request.serialize_ec2_query(
        input_, pairs, ""
    )
