...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_launch_templates_result.DescribeLaunchTemplatesResult = aws_sdk_ec2.types.describe_launch_templates_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_launch_templates_request.DescribeLaunchTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_launch_templates_request.serialize_ec2_query(
        input_, pairs, ""
    )
