...
def handle_response(
    ...
    out: aws_sdk_ec2.types.enable_aws_network_performance_metric_subscription_result.EnableAwsNetworkPerformanceMetricSubscriptionResult = aws_sdk_ec2.types.enable_aws_network_performance_metric_subscription_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_aws_network_performance_metric_subscription_request.EnableAwsNetworkPerformanceMetricSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.enable_aws_network_performance_metric_subscription_request.serialize_ec2_query(
        input_, pairs, ""
    )
