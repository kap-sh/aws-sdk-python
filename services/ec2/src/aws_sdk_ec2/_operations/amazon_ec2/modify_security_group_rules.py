...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_security_group_rules_result.ModifySecurityGroupRulesResult = aws_sdk_ec2.types.modify_security_group_rules_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_security_group_rules_request.ModifySecurityGroupRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_security_group_rules_request.serialize_ec2_query(
        input_, pairs, ""
    )
