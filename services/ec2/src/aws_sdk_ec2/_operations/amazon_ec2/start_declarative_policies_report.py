...
def handle_response(
    ...
    out: aws_sdk_ec2.types.start_declarative_policies_report_result.StartDeclarativePoliciesReportResult = aws_sdk_ec2.types.start_declarative_policies_report_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.start_declarative_policies_report_request.StartDeclarativePoliciesReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "StartDeclarativePoliciesReport"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.start_declarative_policies_report_request

    aws_sdk_ec2.types.start_declarative_policies_report_request.serialize_ec2_query(
        input_, pairs, ""
    )
