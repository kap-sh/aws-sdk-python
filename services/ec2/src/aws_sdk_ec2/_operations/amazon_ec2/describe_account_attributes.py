...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_account_attributes_result.DescribeAccountAttributesResult = aws_sdk_ec2.types.describe_account_attributes_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_account_attributes_request.DescribeAccountAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_account_attributes_request.serialize_ec2_query(
        input_, pairs, ""
    )
