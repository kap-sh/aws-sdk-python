...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_fleet_result.CreateFleetResult = (
        aws_sdk_ec2.types.create_fleet_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_fleet_request.CreateFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_fleet_request.serialize_ec2_query(input_, pairs, "")
