...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_vpn_connections_result.DescribeVpnConnectionsResult = aws_sdk_ec2.types.describe_vpn_connections_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_vpn_connections_request.DescribeVpnConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_vpn_connections_request.serialize_ec2_query(
        input_, pairs, ""
    )
