"""Generated from Smithy shape ``com.amazonaws.ec2#EnableImageDeprecation``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.enable_image_deprecation_result.EnableImageDeprecationResult = aws_sdk_ec2.types.enable_image_deprecation_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_image_deprecation_request.EnableImageDeprecationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "EnableImageDeprecation"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.enable_image_deprecation_request

    aws_sdk_ec2.types.enable_image_deprecation_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_enable_image_deprecation(
