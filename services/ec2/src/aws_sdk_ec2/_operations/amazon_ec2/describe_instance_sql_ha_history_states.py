...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_instance_sql_ha_history_states_result.DescribeInstanceSqlHaHistoryStatesResult = aws_sdk_ec2.types.describe_instance_sql_ha_history_states_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_instance_sql_ha_history_states_request.DescribeInstanceSqlHaHistoryStatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_instance_sql_ha_history_states_request.serialize_ec2_query(
        input_, pairs, ""
    )
