...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_vpc_attribute_result.DescribeVpcAttributeResult = (
        aws_sdk_ec2.types.describe_vpc_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_vpc_attribute_request.DescribeVpcAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_vpc_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
