...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_vpc_peering_connection_result.CreateVpcPeeringConnectionResult = aws_sdk_ec2.types.create_vpc_peering_connection_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_vpc_peering_connection_request.CreateVpcPeeringConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_vpc_peering_connection_request.serialize_ec2_query(
        input_, pairs, ""
    )
