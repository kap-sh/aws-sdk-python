...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_local_gateway_route_tables_result.DescribeLocalGatewayRouteTablesResult = aws_sdk_ec2.types.describe_local_gateway_route_tables_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_local_gateway_route_tables_request.DescribeLocalGatewayRouteTablesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_local_gateway_route_tables_request.serialize_ec2_query(
        input_, pairs, ""
    )
