...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_secondary_networks_result.DescribeSecondaryNetworksResult = aws_sdk_ec2.types.describe_secondary_networks_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_secondary_networks_request.DescribeSecondaryNetworksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_secondary_networks_request.serialize_ec2_query(
        input_, pairs, ""
    )
