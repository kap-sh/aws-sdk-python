...
) -> aws_sdk_ec2.types.describe_client_vpn_routes_result.DescribeClientVpnRoutesResult:
    import aws_sdk_ec2.types.describe_client_vpn_routes_result

    out: aws_sdk_ec2.types.describe_client_vpn_routes_result.DescribeClientVpnRoutesResult = aws_sdk_ec2.types.describe_client_vpn_routes_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_client_vpn_routes_request.DescribeClientVpnRoutesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_client_vpn_routes_request.serialize_ec2_query(
        input_, pairs, ""
    )
