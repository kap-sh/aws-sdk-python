...
def handle_response(
    ...
    out: aws_sdk_ec2.types.cancel_image_launch_permission_result.CancelImageLaunchPermissionResult = aws_sdk_ec2.types.cancel_image_launch_permission_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.cancel_image_launch_permission_request.CancelImageLaunchPermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.cancel_image_launch_permission_request.serialize_ec2_query(
        input_, pairs, ""
    )
