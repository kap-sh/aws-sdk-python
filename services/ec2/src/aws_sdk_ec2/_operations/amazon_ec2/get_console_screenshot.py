...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_console_screenshot_result.GetConsoleScreenshotResult = (
        aws_sdk_ec2.types.get_console_screenshot_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_console_screenshot_request.GetConsoleScreenshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
