...
def handle_response(
    ...
    out: aws_sdk_ec2.types.revoke_security_group_ingress_result.RevokeSecurityGroupIngressResult = aws_sdk_ec2.types.revoke_security_group_ingress_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.revoke_security_group_ingress_request.RevokeSecurityGroupIngressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RevokeSecurityGroupIngress"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.revoke_security_group_ingress_request

    aws_sdk_ec2.types.revoke_security_group_ingress_request.serialize_ec2_query(
        input_, pairs, ""
    )
