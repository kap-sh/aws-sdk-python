...
def handle_response(
    ...
    out: aws_sdk_ec2.types.allocate_ipam_pool_cidr_result.AllocateIpamPoolCidrResult = (
        aws_sdk_ec2.types.allocate_ipam_pool_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.allocate_ipam_pool_cidr_request.AllocateIpamPoolCidrRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.allocate_ipam_pool_cidr_request.serialize_ec2_query(
        input_, pairs, ""
    )
