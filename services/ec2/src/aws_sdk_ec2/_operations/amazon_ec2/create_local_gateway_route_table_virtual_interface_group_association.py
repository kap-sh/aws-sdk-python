...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_local_gateway_route_table_virtual_interface_group_association_result.CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult = aws_sdk_ec2.types.create_local_gateway_route_table_virtual_interface_group_association_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_local_gateway_route_table_virtual_interface_group_association_request.CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
