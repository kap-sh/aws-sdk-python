...
def handle_response(
    ...
    out: aws_sdk_ec2.types.associate_trunk_interface_result.AssociateTrunkInterfaceResult = aws_sdk_ec2.types.associate_trunk_interface_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.associate_trunk_interface_request.AssociateTrunkInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.associate_trunk_interface_request.serialize_ec2_query(
        input_, pairs, ""
    )
