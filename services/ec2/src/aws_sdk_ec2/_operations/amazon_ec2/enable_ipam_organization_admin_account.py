...
def handle_response(
    ...
    out: aws_sdk_ec2.types.enable_ipam_organization_admin_account_result.EnableIpamOrganizationAdminAccountResult = aws_sdk_ec2.types.enable_ipam_organization_admin_account_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_ipam_organization_admin_account_request.EnableIpamOrganizationAdminAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "EnableIpamOrganizationAdminAccount"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.enable_ipam_organization_admin_account_request

    aws_sdk_ec2.types.enable_ipam_organization_admin_account_request.serialize_ec2_query(
        input_, pairs, ""
    )
