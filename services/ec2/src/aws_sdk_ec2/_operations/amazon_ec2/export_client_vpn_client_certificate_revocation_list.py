...
def handle_response(
    ...
    out: aws_sdk_ec2.types.export_client_vpn_client_certificate_revocation_list_result.ExportClientVpnClientCertificateRevocationListResult = aws_sdk_ec2.types.export_client_vpn_client_certificate_revocation_list_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.export_client_vpn_client_certificate_revocation_list_request.ExportClientVpnClientCertificateRevocationListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.export_client_vpn_client_certificate_revocation_list_request.serialize_ec2_query(
        input_, pairs, ""
    )
