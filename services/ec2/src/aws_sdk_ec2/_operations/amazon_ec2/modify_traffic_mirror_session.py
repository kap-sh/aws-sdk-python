...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_traffic_mirror_session_result.ModifyTrafficMirrorSessionResult = aws_sdk_ec2.types.modify_traffic_mirror_session_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_traffic_mirror_session_request.ModifyTrafficMirrorSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_traffic_mirror_session_request.serialize_ec2_query(
        input_, pairs, ""
    )
