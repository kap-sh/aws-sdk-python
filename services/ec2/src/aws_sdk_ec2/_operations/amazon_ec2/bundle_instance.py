...
def handle_response(
    ...
    out: aws_sdk_ec2.types.bundle_instance_result.BundleInstanceResult = (
        aws_sdk_ec2.types.bundle_instance_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.bundle_instance_request.BundleInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.bundle_instance_request.serialize_ec2_query(input_, pairs, "")
...
def bundle_instance(
    ...
    aws_sdk_ec2.types.bundle_instance_result.BundleInstanceResult, zapros.Response
]:
