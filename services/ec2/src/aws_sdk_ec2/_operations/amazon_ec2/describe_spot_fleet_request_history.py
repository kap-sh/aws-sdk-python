...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_spot_fleet_request_history_response.DescribeSpotFleetRequestHistoryResponse = aws_sdk_ec2.types.describe_spot_fleet_request_history_response.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_spot_fleet_request_history_request.DescribeSpotFleetRequestHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeSpotFleetRequestHistory"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.describe_spot_fleet_request_history_request.serialize_ec2_query(
        input_, pairs, ""
    )
