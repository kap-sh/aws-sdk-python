...
) -> aws_sdk_ec2.types.describe_ipv6_pools_result.DescribeIpv6PoolsResult:
    out: aws_sdk_ec2.types.describe_ipv6_pools_result.DescribeIpv6PoolsResult = (
        aws_sdk_ec2.types.describe_ipv6_pools_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_ipv6_pools_request.DescribeIpv6PoolsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_ipv6_pools_request.serialize_ec2_query(input_, pairs, "")
