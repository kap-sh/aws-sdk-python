...
def build_request(
    ...
    input: aws_sdk_ec2.types.describe_ipv6_pools_request.DescribeIpv6PoolsRequest,
) -> zapros.Request:
    ...
    aws_sdk_ec2.types.describe_ipv6_pools_request.serialize_ec2_query(input, pairs, "")
