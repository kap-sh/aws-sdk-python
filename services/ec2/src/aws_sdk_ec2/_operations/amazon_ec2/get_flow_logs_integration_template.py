...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_flow_logs_integration_template_result.GetFlowLogsIntegrationTemplateResult = aws_sdk_ec2.types.get_flow_logs_integration_template_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_flow_logs_integration_template_request.GetFlowLogsIntegrationTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_flow_logs_integration_template_request.serialize_ec2_query(
        input_, pairs, ""
    )
