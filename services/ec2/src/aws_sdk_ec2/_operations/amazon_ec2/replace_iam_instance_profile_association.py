...
def handle_response(
    ...
    out: aws_sdk_ec2.types.replace_iam_instance_profile_association_result.ReplaceIamInstanceProfileAssociationResult = aws_sdk_ec2.types.replace_iam_instance_profile_association_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.replace_iam_instance_profile_association_request.ReplaceIamInstanceProfileAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.replace_iam_instance_profile_association_request.serialize_ec2_query(
        input_, pairs, ""
    )
