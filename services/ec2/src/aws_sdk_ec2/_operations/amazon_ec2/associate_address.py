...
def handle_response(
    ...
    out: aws_sdk_ec2.types.associate_address_result.AssociateAddressResult = (
        aws_sdk_ec2.types.associate_address_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.associate_address_request.AssociateAddressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.associate_address_request.serialize_ec2_query(input_, pairs, "")
