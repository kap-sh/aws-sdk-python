...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disable_ipam_organization_admin_account_result.DisableIpamOrganizationAdminAccountResult = aws_sdk_ec2.types.disable_ipam_organization_admin_account_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disable_ipam_organization_admin_account_request.DisableIpamOrganizationAdminAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disable_ipam_organization_admin_account_request.serialize_ec2_query(
        input_, pairs, ""
    )
