...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_carrier_gateway_result.CreateCarrierGatewayResult = (
        aws_sdk_ec2.types.create_carrier_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_carrier_gateway_request.CreateCarrierGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_carrier_gateway_request.serialize_ec2_query(
        input_, pairs, ""
    )
