...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disassociate_iam_instance_profile_result.DisassociateIamInstanceProfileResult = aws_sdk_ec2.types.disassociate_iam_instance_profile_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disassociate_iam_instance_profile_request.DisassociateIamInstanceProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disassociate_iam_instance_profile_request.serialize_ec2_query(
        input_, pairs, ""
    )
