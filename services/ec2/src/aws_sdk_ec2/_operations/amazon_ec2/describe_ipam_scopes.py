...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_ipam_scopes_result.DescribeIpamScopesResult = (
        aws_sdk_ec2.types.describe_ipam_scopes_result.deserialize_ec2_query(
...
def build_request(
    ...
    input: aws_sdk_ec2.types.describe_ipam_scopes_request.DescribeIpamScopesRequest,
) -> zapros.Request:
    ...
    aws_sdk_ec2.types.describe_ipam_scopes_request.serialize_ec2_query(input, pairs, "")
