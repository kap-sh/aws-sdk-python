...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_ipam_resource_discovery_result.ModifyIpamResourceDiscoveryResult = aws_sdk_ec2.types.modify_ipam_resource_discovery_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_ipam_resource_discovery_request.ModifyIpamResourceDiscoveryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_ipam_resource_discovery_request.serialize_ec2_query(
        input_, pairs, ""
    )
