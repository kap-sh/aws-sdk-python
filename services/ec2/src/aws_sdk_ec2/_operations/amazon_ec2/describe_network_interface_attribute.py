...
) -> aws_sdk_ec2.types.describe_network_interface_attribute_result.DescribeNetworkInterfaceAttributeResult:
    out: aws_sdk_ec2.types.describe_network_interface_attribute_result.DescribeNetworkInterfaceAttributeResult = aws_sdk_ec2.types.describe_network_interface_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_network_interface_attribute_request.DescribeNetworkInterfaceAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_network_interface_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
