...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_route_server_endpoint_result.DeleteRouteServerEndpointResult = aws_sdk_ec2.types.delete_route_server_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_route_server_endpoint_request.DeleteRouteServerEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_route_server_endpoint_request.serialize_ec2_query(
        input_, pairs, ""
    )
