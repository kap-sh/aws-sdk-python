...
def build_request(
    ...
    input_: aws_sdk_ec2.types.allocate_hosts_request.AllocateHostsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AllocateHosts"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.allocate_hosts_request

    aws_sdk_ec2.types.allocate_hosts_request.serialize_ec2_query(input_, pairs, "")
