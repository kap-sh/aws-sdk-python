...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_capacity_manager_data_export_result.CreateCapacityManagerDataExportResult = aws_sdk_ec2.types.create_capacity_manager_data_export_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_capacity_manager_data_export_request.CreateCapacityManagerDataExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_capacity_manager_data_export_request.serialize_ec2_query(
        input_, pairs, ""
    )
