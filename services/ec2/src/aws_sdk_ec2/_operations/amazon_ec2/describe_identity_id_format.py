...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_identity_id_format_result.DescribeIdentityIdFormatResult = aws_sdk_ec2.types.describe_identity_id_format_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_identity_id_format_request.DescribeIdentityIdFormatRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_identity_id_format_request.serialize_ec2_query(
        input_, pairs, ""
    )
