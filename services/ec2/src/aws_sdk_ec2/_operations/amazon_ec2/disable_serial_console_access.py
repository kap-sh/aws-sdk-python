...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disable_serial_console_access_result.DisableSerialConsoleAccessResult = aws_sdk_ec2.types.disable_serial_console_access_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disable_serial_console_access_request.DisableSerialConsoleAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disable_serial_console_access_request.serialize_ec2_query(
        input_, pairs, ""
    )
