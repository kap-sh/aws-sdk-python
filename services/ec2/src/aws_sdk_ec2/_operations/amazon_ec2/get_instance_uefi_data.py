...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_instance_uefi_data_result.GetInstanceUefiDataResult = (
        aws_sdk_ec2.types.get_instance_uefi_data_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_instance_uefi_data_request.GetInstanceUefiDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_instance_uefi_data_request.serialize_ec2_query(
        input_, pairs, ""
    )
