...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_volume_request.DeleteVolumeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteVolume"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.delete_volume_request.serialize_ec2_query(input_, pairs, "")
