...
) -> aws_sdk_ec2.types.describe_import_snapshot_tasks_result.DescribeImportSnapshotTasksResult:
    import aws_sdk_ec2.types.describe_import_snapshot_tasks_result

    out: aws_sdk_ec2.types.describe_import_snapshot_tasks_result.DescribeImportSnapshotTasksResult = aws_sdk_ec2.types.describe_import_snapshot_tasks_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_import_snapshot_tasks_request.DescribeImportSnapshotTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_import_snapshot_tasks_request.serialize_ec2_query(
        input_, pairs, ""
    )
