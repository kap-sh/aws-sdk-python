...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_network_interface_request.DeleteNetworkInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_network_interface_request.serialize_ec2_query(
        input_, pairs, ""
    )
