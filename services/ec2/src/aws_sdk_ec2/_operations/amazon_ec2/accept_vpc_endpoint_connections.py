...
def handle_response(
    ...
    out: aws_sdk_ec2.types.accept_vpc_endpoint_connections_result.AcceptVpcEndpointConnectionsResult = aws_sdk_ec2.types.accept_vpc_endpoint_connections_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.accept_vpc_endpoint_connections_request.AcceptVpcEndpointConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AcceptVpcEndpointConnections"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.accept_vpc_endpoint_connections_request.serialize_ec2_query(
        input_, pairs, ""
    )
