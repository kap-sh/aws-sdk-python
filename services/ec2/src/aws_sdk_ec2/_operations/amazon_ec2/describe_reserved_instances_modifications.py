...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_reserved_instances_modifications_result.DescribeReservedInstancesModificationsResult = aws_sdk_ec2.types.describe_reserved_instances_modifications_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_reserved_instances_modifications_request.DescribeReservedInstancesModificationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_reserved_instances_modifications_request.serialize_ec2_query(
        input_, pairs, ""
    )
