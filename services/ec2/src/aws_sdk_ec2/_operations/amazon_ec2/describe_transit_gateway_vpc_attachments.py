...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_transit_gateway_vpc_attachments_result.DescribeTransitGatewayVpcAttachmentsResult = aws_sdk_ec2.types.describe_transit_gateway_vpc_attachments_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_transit_gateway_vpc_attachments_request.DescribeTransitGatewayVpcAttachmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_transit_gateway_vpc_attachments_request.serialize_ec2_query(
        input_, pairs, ""
    )
