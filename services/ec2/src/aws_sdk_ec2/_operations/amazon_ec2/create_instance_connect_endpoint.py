...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_instance_connect_endpoint_result.CreateInstanceConnectEndpointResult = aws_sdk_ec2.types.create_instance_connect_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_instance_connect_endpoint_request.CreateInstanceConnectEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_instance_connect_endpoint_request.serialize_ec2_query(
        input_, pairs, ""
    )
