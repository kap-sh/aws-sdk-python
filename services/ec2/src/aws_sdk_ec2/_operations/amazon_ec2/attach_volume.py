"""Generated from Smithy shape ``com.amazonaws.ec2#AttachVolume``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.volume_attachment.VolumeAttachment = (
        aws_sdk_ec2.types.volume_attachment.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.attach_volume_request.AttachVolumeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AttachVolume"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.attach_volume_request

    aws_sdk_ec2.types.attach_volume_request.serialize_ec2_query(input_, pairs, "")
