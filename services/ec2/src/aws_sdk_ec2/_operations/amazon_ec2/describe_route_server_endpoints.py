...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_route_server_endpoints_result.DescribeRouteServerEndpointsResult = aws_sdk_ec2.types.describe_route_server_endpoints_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_route_server_endpoints_request.DescribeRouteServerEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_route_server_endpoints_request.serialize_ec2_query(
        input_, pairs, ""
    )
