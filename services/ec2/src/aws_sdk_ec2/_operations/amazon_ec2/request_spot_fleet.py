...
def handle_response(
    ...
    out: aws_sdk_ec2.types.request_spot_fleet_response.RequestSpotFleetResponse = (
        aws_sdk_ec2.types.request_spot_fleet_response.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.request_spot_fleet_request.RequestSpotFleetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.request_spot_fleet_request.serialize_ec2_query(input_, pairs, "")
