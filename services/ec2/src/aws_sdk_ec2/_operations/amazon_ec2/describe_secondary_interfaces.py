...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_secondary_interfaces_result.DescribeSecondaryInterfacesResult = aws_sdk_ec2.types.describe_secondary_interfaces_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_secondary_interfaces_request.DescribeSecondaryInterfacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_secondary_interfaces_request.serialize_ec2_query(
        input_, pairs, ""
    )
