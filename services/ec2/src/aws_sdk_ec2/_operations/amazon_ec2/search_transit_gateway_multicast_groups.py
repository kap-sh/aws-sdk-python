...
def handle_response(
    ...
    out: aws_sdk_ec2.types.search_transit_gateway_multicast_groups_result.SearchTransitGatewayMulticastGroupsResult = aws_sdk_ec2.types.search_transit_gateway_multicast_groups_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.search_transit_gateway_multicast_groups_request.SearchTransitGatewayMulticastGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.search_transit_gateway_multicast_groups_request.serialize_ec2_query(
        input_, pairs, ""
    )
