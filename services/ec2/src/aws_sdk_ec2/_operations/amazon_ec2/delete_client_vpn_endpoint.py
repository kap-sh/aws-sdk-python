...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_client_vpn_endpoint_result.DeleteClientVpnEndpointResult = aws_sdk_ec2.types.delete_client_vpn_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_client_vpn_endpoint_request.DeleteClientVpnEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteClientVpnEndpoint"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.delete_client_vpn_endpoint_request.serialize_ec2_query(
        input_, pairs, ""
    )
