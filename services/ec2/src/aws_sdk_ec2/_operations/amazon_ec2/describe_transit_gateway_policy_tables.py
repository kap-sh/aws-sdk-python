...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_transit_gateway_policy_tables_result.DescribeTransitGatewayPolicyTablesResult = aws_sdk_ec2.types.describe_transit_gateway_policy_tables_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_transit_gateway_policy_tables_request.DescribeTransitGatewayPolicyTablesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_transit_gateway_policy_tables_request.serialize_ec2_query(
        input_, pairs, ""
    )
