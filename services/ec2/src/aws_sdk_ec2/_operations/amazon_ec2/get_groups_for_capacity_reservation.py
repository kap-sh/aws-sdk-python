...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_groups_for_capacity_reservation_result.GetGroupsForCapacityReservationResult = aws_sdk_ec2.types.get_groups_for_capacity_reservation_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_groups_for_capacity_reservation_request.GetGroupsForCapacityReservationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_groups_for_capacity_reservation_request.serialize_ec2_query(
        input_, pairs, ""
    )
