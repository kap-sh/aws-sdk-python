...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_default_subnet_result.CreateDefaultSubnetResult = (
        aws_sdk_ec2.types.create_default_subnet_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_default_subnet_request.CreateDefaultSubnetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_default_subnet_request.serialize_ec2_query(
        input_, pairs, ""
    )
