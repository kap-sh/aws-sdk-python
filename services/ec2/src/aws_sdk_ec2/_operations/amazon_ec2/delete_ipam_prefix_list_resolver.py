...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_ipam_prefix_list_resolver_result.DeleteIpamPrefixListResolverResult = aws_sdk_ec2.types.delete_ipam_prefix_list_resolver_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_ipam_prefix_list_resolver_request.DeleteIpamPrefixListResolverRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_ipam_prefix_list_resolver_request.serialize_ec2_query(
        input_, pairs, ""
    )
