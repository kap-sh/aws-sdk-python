"""Generated from Smithy shape ``com.amazonaws.ec2#GetAllowedImagesSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_allowed_images_settings_result.GetAllowedImagesSettingsResult = aws_sdk_ec2.types.get_allowed_images_settings_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_allowed_images_settings_request.GetAllowedImagesSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetAllowedImagesSettings"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.get_allowed_images_settings_request

    aws_sdk_ec2.types.get_allowed_images_settings_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_get_allowed_images_settings(
