...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_volume_attribute_result.DescribeVolumeAttributeResult = aws_sdk_ec2.types.describe_volume_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_volume_attribute_request.DescribeVolumeAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_volume_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
