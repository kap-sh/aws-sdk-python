...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_managed_prefix_list_entries_result.GetManagedPrefixListEntriesResult = aws_sdk_ec2.types.get_managed_prefix_list_entries_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_managed_prefix_list_entries_request.GetManagedPrefixListEntriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_managed_prefix_list_entries_request.serialize_ec2_query(
        input_, pairs, ""
    )
