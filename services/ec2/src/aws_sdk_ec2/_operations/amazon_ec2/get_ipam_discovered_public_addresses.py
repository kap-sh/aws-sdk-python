...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_ipam_discovered_public_addresses_result.GetIpamDiscoveredPublicAddressesResult = aws_sdk_ec2.types.get_ipam_discovered_public_addresses_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_ipam_discovered_public_addresses_request.GetIpamDiscoveredPublicAddressesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetIpamDiscoveredPublicAddresses"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.get_ipam_discovered_public_addresses_request

    aws_sdk_ec2.types.get_ipam_discovered_public_addresses_request.serialize_ec2_query(
        input_, pairs, ""
    )
