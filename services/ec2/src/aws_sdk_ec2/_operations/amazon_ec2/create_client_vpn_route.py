...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_client_vpn_route_result.CreateClientVpnRouteResult = (
        aws_sdk_ec2.types.create_client_vpn_route_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_client_vpn_route_request.CreateClientVpnRouteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
