...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_delegate_mac_volume_ownership_task_result.CreateDelegateMacVolumeOwnershipTaskResult = aws_sdk_ec2.types.create_delegate_mac_volume_ownership_task_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_delegate_mac_volume_ownership_task_request.CreateDelegateMacVolumeOwnershipTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_delegate_mac_volume_ownership_task_request.serialize_ec2_query(
        input_, pairs, ""
    )
