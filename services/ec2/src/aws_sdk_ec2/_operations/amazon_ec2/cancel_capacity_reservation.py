...
def handle_response(
    ...
    out: aws_sdk_ec2.types.cancel_capacity_reservation_result.CancelCapacityReservationResult = aws_sdk_ec2.types.cancel_capacity_reservation_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.cancel_capacity_reservation_request.CancelCapacityReservationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.cancel_capacity_reservation_request.serialize_ec2_query(
        input_, pairs, ""
    )
