"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteTransitGatewayVpcAttachment``."""
...
) -> aws_sdk_ec2.types.delete_transit_gateway_vpc_attachment_result.DeleteTransitGatewayVpcAttachmentResult:
    out: aws_sdk_ec2.types.delete_transit_gateway_vpc_attachment_result.DeleteTransitGatewayVpcAttachmentResult = aws_sdk_ec2.types.delete_transit_gateway_vpc_attachment_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_transit_gateway_vpc_attachment_request.DeleteTransitGatewayVpcAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteTransitGatewayVpcAttachment"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.delete_transit_gateway_vpc_attachment_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_transit_gateway_vpc_attachment(
