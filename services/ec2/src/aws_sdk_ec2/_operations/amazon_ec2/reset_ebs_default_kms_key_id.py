...
def handle_response(
    ...
    out: aws_sdk_ec2.types.reset_ebs_default_kms_key_id_result.ResetEbsDefaultKmsKeyIdResult = aws_sdk_ec2.types.reset_ebs_default_kms_key_id_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.reset_ebs_default_kms_key_id_request.ResetEbsDefaultKmsKeyIdRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.reset_ebs_default_kms_key_id_request.serialize_ec2_query(
        input_, pairs, ""
    )
