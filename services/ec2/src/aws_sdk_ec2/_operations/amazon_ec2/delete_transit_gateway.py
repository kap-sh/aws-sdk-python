...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_transit_gateway_result.DeleteTransitGatewayResult = (
        aws_sdk_ec2.types.delete_transit_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_transit_gateway_request.DeleteTransitGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteTransitGateway"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.delete_transit_gateway_request.serialize_ec2_query(
        input_, pairs, ""
    )
