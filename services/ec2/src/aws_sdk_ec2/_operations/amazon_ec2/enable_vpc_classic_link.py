...
def handle_response(
    ...
    out: aws_sdk_ec2.types.enable_vpc_classic_link_result.EnableVpcClassicLinkResult = (
        aws_sdk_ec2.types.enable_vpc_classic_link_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_vpc_classic_link_request.EnableVpcClassicLinkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.enable_vpc_classic_link_request.serialize_ec2_query(
        input_, pairs, ""
    )
