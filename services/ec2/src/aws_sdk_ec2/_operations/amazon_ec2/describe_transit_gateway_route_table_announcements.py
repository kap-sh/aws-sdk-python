...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_transit_gateway_route_table_announcements_result.DescribeTransitGatewayRouteTableAnnouncementsResult = aws_sdk_ec2.types.describe_transit_gateway_route_table_announcements_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_transit_gateway_route_table_announcements_request.DescribeTransitGatewayRouteTableAnnouncementsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
