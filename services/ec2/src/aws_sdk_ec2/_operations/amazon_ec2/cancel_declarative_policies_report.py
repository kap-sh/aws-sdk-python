...
def handle_response(
    ...
    out: aws_sdk_ec2.types.cancel_declarative_policies_report_result.CancelDeclarativePoliciesReportResult = aws_sdk_ec2.types.cancel_declarative_policies_report_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.cancel_declarative_policies_report_request.CancelDeclarativePoliciesReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.cancel_declarative_policies_report_request.serialize_ec2_query(
        input_, pairs, ""
    )
