...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_verified_access_endpoint_targets_result.GetVerifiedAccessEndpointTargetsResult = aws_sdk_ec2.types.get_verified_access_endpoint_targets_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_verified_access_endpoint_targets_request.GetVerifiedAccessEndpointTargetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_verified_access_endpoint_targets_request.serialize_ec2_query(
        input_, pairs, ""
    )
