...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_public_ipv4_pool_result.DeletePublicIpv4PoolResult = (
        aws_sdk_ec2.types.delete_public_ipv4_pool_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_public_ipv4_pool_request.DeletePublicIpv4PoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeletePublicIpv4Pool"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.delete_public_ipv4_pool_request.serialize_ec2_query(
        input_, pairs, ""
    )
