...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disassociate_ipam_byoasn_result.DisassociateIpamByoasnResult = aws_sdk_ec2.types.disassociate_ipam_byoasn_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disassociate_ipam_byoasn_request.DisassociateIpamByoasnRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DisassociateIpamByoasn"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.disassociate_ipam_byoasn_request

    aws_sdk_ec2.types.disassociate_ipam_byoasn_request.serialize_ec2_query(
        input_, pairs, ""
    )
