...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_vpn_connection_result.ModifyVpnConnectionResult = (
        aws_sdk_ec2.types.modify_vpn_connection_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_vpn_connection_request.ModifyVpnConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_vpn_connection_request.serialize_ec2_query(
        input_, pairs, ""
    )
