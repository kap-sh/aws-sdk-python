...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_trunk_interface_associations_result.DescribeTrunkInterfaceAssociationsResult = aws_sdk_ec2.types.describe_trunk_interface_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_trunk_interface_associations_request.DescribeTrunkInterfaceAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_trunk_interface_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
