...
def handle_response(
    ...
    out: aws_sdk_ec2.types.accept_transit_gateway_peering_attachment_result.AcceptTransitGatewayPeeringAttachmentResult = aws_sdk_ec2.types.accept_transit_gateway_peering_attachment_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.accept_transit_gateway_peering_attachment_request.AcceptTransitGatewayPeeringAttachmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.accept_transit_gateway_peering_attachment_request.serialize_ec2_query(
        input_, pairs, ""
    )
