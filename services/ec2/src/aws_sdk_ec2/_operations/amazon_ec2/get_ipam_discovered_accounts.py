...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_ipam_discovered_accounts_result.GetIpamDiscoveredAccountsResult = aws_sdk_ec2.types.get_ipam_discovered_accounts_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_ipam_discovered_accounts_request.GetIpamDiscoveredAccountsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_ipam_discovered_accounts_request.serialize_ec2_query(
        input_, pairs, ""
    )
