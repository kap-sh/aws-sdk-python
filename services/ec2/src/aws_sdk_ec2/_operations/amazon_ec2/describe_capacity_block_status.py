...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_capacity_block_status_result.DescribeCapacityBlockStatusResult = aws_sdk_ec2.types.describe_capacity_block_status_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_capacity_block_status_request.DescribeCapacityBlockStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_capacity_block_status_request.serialize_ec2_query(
        input_, pairs, ""
    )
