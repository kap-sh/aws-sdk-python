...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_vpc_endpoint_result.ModifyVpcEndpointResult = (
        aws_sdk_ec2.types.modify_vpc_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_vpc_endpoint_request.ModifyVpcEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_vpc_endpoint_request.serialize_ec2_query(input_, pairs, "")
