...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_instance_network_performance_result.ModifyInstanceNetworkPerformanceResult = aws_sdk_ec2.types.modify_instance_network_performance_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_instance_network_performance_request.ModifyInstanceNetworkPerformanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyInstanceNetworkPerformanceOptions"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.modify_instance_network_performance_request

    aws_sdk_ec2.types.modify_instance_network_performance_request.serialize_ec2_query(
        input_, pairs, ""
    )
