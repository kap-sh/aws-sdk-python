...
def handle_response(
    ...
    out: aws_sdk_ec2.types.unassign_ipv6_addresses_result.UnassignIpv6AddressesResult = aws_sdk_ec2.types.unassign_ipv6_addresses_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.unassign_ipv6_addresses_request.UnassignIpv6AddressesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "UnassignIpv6Addresses"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.unassign_ipv6_addresses_request.serialize_ec2_query(
        input_, pairs, ""
    )
