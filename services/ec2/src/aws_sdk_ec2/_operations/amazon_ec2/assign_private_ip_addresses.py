...
def handle_response(
    ...
    out: aws_sdk_ec2.types.assign_private_ip_addresses_result.AssignPrivateIpAddressesResult = aws_sdk_ec2.types.assign_private_ip_addresses_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.assign_private_ip_addresses_request.AssignPrivateIpAddressesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.assign_private_ip_addresses_request.serialize_ec2_query(
        input_, pairs, ""
    )
