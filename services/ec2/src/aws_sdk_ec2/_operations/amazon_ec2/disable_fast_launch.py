...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disable_fast_launch_result.DisableFastLaunchResult = (
        aws_sdk_ec2.types.disable_fast_launch_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disable_fast_launch_request.DisableFastLaunchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disable_fast_launch_request.serialize_ec2_query(input_, pairs, "")
