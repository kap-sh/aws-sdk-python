...
) -> aws_sdk_ec2.types.delete_fpga_image_result.DeleteFpgaImageResult:
    out: aws_sdk_ec2.types.delete_fpga_image_result.DeleteFpgaImageResult = (
        aws_sdk_ec2.types.delete_fpga_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_fpga_image_request.DeleteFpgaImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteFpgaImage"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.delete_fpga_image_request.serialize_ec2_query(input_, pairs, "")
