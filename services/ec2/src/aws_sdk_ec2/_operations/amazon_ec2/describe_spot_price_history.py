...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_spot_price_history_result.DescribeSpotPriceHistoryResult = aws_sdk_ec2.types.describe_spot_price_history_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_spot_price_history_request.DescribeSpotPriceHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_spot_price_history_request.serialize_ec2_query(
        input_, pairs, ""
    )
