"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeDeclarativePoliciesReports``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_declarative_policies_reports_result.DescribeDeclarativePoliciesReportsResult = aws_sdk_ec2.types.describe_declarative_policies_reports_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_declarative_policies_reports_request.DescribeDeclarativePoliciesReportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeDeclarativePoliciesReports"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_declarative_policies_reports_request

    aws_sdk_ec2.types.describe_declarative_policies_reports_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_declarative_policies_reports(
