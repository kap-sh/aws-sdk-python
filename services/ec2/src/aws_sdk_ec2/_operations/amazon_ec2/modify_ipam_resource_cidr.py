...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_ipam_resource_cidr_result.ModifyIpamResourceCidrResult = aws_sdk_ec2.types.modify_ipam_resource_cidr_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_ipam_resource_cidr_request.ModifyIpamResourceCidrRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_ipam_resource_cidr_request.serialize_ec2_query(
        input_, pairs, ""
    )
