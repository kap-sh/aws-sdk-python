...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_instance_cpu_options_result.ModifyInstanceCpuOptionsResult = aws_sdk_ec2.types.modify_instance_cpu_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_instance_cpu_options_request.ModifyInstanceCpuOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyInstanceCpuOptions"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.modify_instance_cpu_options_request

    aws_sdk_ec2.types.modify_instance_cpu_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
