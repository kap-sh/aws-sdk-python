...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_route_server_propagations_result.GetRouteServerPropagationsResult = aws_sdk_ec2.types.get_route_server_propagations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_route_server_propagations_request.GetRouteServerPropagationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_route_server_propagations_request.serialize_ec2_query(
        input_, pairs, ""
    )
