...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_snapshot_attribute_result.DescribeSnapshotAttributeResult = aws_sdk_ec2.types.describe_snapshot_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_snapshot_attribute_request.DescribeSnapshotAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_snapshot_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
