...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_traffic_mirror_filters_result.DescribeTrafficMirrorFiltersResult = aws_sdk_ec2.types.describe_traffic_mirror_filters_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_traffic_mirror_filters_request.DescribeTrafficMirrorFiltersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_traffic_mirror_filters_request.serialize_ec2_query(
        input_, pairs, ""
    )
