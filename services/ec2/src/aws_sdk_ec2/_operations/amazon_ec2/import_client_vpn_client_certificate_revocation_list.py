...
def handle_response(
    ...
    out: aws_sdk_ec2.types.import_client_vpn_client_certificate_revocation_list_result.ImportClientVpnClientCertificateRevocationListResult = aws_sdk_ec2.types.import_client_vpn_client_certificate_revocation_list_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.import_client_vpn_client_certificate_revocation_list_request.ImportClientVpnClientCertificateRevocationListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ImportClientVpnClientCertificateRevocationList"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.import_client_vpn_client_certificate_revocation_list_request.serialize_ec2_query(
        input_, pairs, ""
    )
