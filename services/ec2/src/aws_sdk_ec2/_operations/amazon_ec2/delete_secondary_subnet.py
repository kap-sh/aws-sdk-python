...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_secondary_subnet_result.DeleteSecondarySubnetResult = aws_sdk_ec2.types.delete_secondary_subnet_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_secondary_subnet_request.DeleteSecondarySubnetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_secondary_subnet_request.serialize_ec2_query(
        input_, pairs, ""
    )
