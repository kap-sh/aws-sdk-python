...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_instance_event_window_result.ModifyInstanceEventWindowResult = aws_sdk_ec2.types.modify_instance_event_window_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_instance_event_window_request.ModifyInstanceEventWindowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_instance_event_window_request.serialize_ec2_query(
        input_, pairs, ""
    )
