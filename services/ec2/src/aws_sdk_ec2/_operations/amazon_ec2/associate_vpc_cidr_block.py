...
def handle_response(
    ...
    out: aws_sdk_ec2.types.associate_vpc_cidr_block_result.AssociateVpcCidrBlockResult = aws_sdk_ec2.types.associate_vpc_cidr_block_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.associate_vpc_cidr_block_request.AssociateVpcCidrBlockRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.associate_vpc_cidr_block_request.serialize_ec2_query(
        input_, pairs, ""
    )
