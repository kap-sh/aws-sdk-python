...
def handle_response(
    ...
    out: aws_sdk_ec2.types.enable_instance_sql_ha_standby_detections_result.EnableInstanceSqlHaStandbyDetectionsResult = aws_sdk_ec2.types.enable_instance_sql_ha_standby_detections_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_instance_sql_ha_standby_detections_request.EnableInstanceSqlHaStandbyDetectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "EnableInstanceSqlHaStandbyDetections"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.enable_instance_sql_ha_standby_detections_request

    aws_sdk_ec2.types.enable_instance_sql_ha_standby_detections_request.serialize_ec2_query(
        input_, pairs, ""
    )
