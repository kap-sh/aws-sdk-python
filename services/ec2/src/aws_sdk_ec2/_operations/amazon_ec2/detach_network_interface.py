...
def build_request(
    ...
    input_: aws_sdk_ec2.types.detach_network_interface_request.DetachNetworkInterfaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DetachNetworkInterface"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.detach_network_interface_request

    aws_sdk_ec2.types.detach_network_interface_request.serialize_ec2_query(
        input_, pairs, ""
    )
