...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_snapshot_attribute_request.ModifySnapshotAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifySnapshotAttribute"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.modify_snapshot_attribute_request

    aws_sdk_ec2.types.modify_snapshot_attribute_request.serialize_ec2_query(
        input_, pairs, ""
    )
