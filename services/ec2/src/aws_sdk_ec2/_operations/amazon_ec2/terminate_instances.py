...
def build_request(
    ...
    input: aws_sdk_ec2.types.terminate_instances_request.TerminateInstancesRequest,
) -> zapros.Request:
    ...
    aws_sdk_ec2.types.terminate_instances_request.serialize_ec2_query(input, pairs, "")
