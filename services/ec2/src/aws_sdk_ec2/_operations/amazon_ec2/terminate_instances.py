...
def handle_response(
    ...
    out: aws_sdk_ec2.types.terminate_instances_result.TerminateInstancesResult = (
        aws_sdk_ec2.types.terminate_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.terminate_instances_request.TerminateInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.terminate_instances_request.serialize_ec2_query(input_, pairs, "")
