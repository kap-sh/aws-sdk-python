...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_capacity_reservation_fleets_result.DescribeCapacityReservationFleetsResult = aws_sdk_ec2.types.describe_capacity_reservation_fleets_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_capacity_reservation_fleets_request.DescribeCapacityReservationFleetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_capacity_reservation_fleets_request.serialize_ec2_query(
        input_, pairs, ""
    )
