"""Generated from Smithy shape ``com.amazonaws.ec2#ModifyTransitGateway``."""
...
) -> aws_sdk_ec2.types.modify_transit_gateway_result.ModifyTransitGatewayResult:
    out: aws_sdk_ec2.types.modify_transit_gateway_result.ModifyTransitGatewayResult = (
        aws_sdk_ec2.types.modify_transit_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_transit_gateway_request.ModifyTransitGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyTransitGateway"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.modify_transit_gateway_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_modify_transit_gateway(
