...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_availability_zone_group_result.ModifyAvailabilityZoneGroupResult = aws_sdk_ec2.types.modify_availability_zone_group_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_availability_zone_group_request.ModifyAvailabilityZoneGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_availability_zone_group_request.serialize_ec2_query(
        input_, pairs, ""
    )
