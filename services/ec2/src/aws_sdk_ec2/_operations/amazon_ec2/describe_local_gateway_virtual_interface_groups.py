...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_local_gateway_virtual_interface_groups_result.DescribeLocalGatewayVirtualInterfaceGroupsResult = aws_sdk_ec2.types.describe_local_gateway_virtual_interface_groups_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_local_gateway_virtual_interface_groups_request.DescribeLocalGatewayVirtualInterfaceGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_local_gateway_virtual_interface_groups_request.serialize_ec2_query(
        input_, pairs, ""
    )
