...
def handle_response(
    ...
    out: aws_sdk_ec2.types.reject_vpc_peering_connection_result.RejectVpcPeeringConnectionResult = aws_sdk_ec2.types.reject_vpc_peering_connection_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.reject_vpc_peering_connection_request.RejectVpcPeeringConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RejectVpcPeeringConnection"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.reject_vpc_peering_connection_request

    aws_sdk_ec2.types.reject_vpc_peering_connection_request.serialize_ec2_query(
        input_, pairs, ""
    )
