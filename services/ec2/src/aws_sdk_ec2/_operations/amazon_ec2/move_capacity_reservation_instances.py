...
def handle_response(
    ...
    out: aws_sdk_ec2.types.move_capacity_reservation_instances_result.MoveCapacityReservationInstancesResult = aws_sdk_ec2.types.move_capacity_reservation_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.move_capacity_reservation_instances_request.MoveCapacityReservationInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "MoveCapacityReservationInstances"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.move_capacity_reservation_instances_request

    aws_sdk_ec2.types.move_capacity_reservation_instances_request.serialize_ec2_query(
        input_, pairs, ""
    )
