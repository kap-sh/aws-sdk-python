...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_network_insights_analyses_result.DescribeNetworkInsightsAnalysesResult = aws_sdk_ec2.types.describe_network_insights_analyses_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_network_insights_analyses_request.DescribeNetworkInsightsAnalysesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_network_insights_analyses_request.serialize_ec2_query(
        input_, pairs, ""
    )
