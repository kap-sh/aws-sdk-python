...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_nat_gateway_result.CreateNatGatewayResult = (
        aws_sdk_ec2.types.create_nat_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_nat_gateway_request.CreateNatGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_nat_gateway_request.serialize_ec2_query(input_, pairs, "")
...
def create_nat_gateway(
    ...
    aws_sdk_ec2.types.create_nat_gateway_result.CreateNatGatewayResult, zapros.Response
]:
