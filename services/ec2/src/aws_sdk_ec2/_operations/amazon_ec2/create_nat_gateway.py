...
def build_request(
    ...
    input: aws_sdk_ec2.types.create_nat_gateway_request.CreateNatGatewayRequest,
) -> zapros.Request:
    ...
    aws_sdk_ec2.types.create_nat_gateway_request.serialize_ec2_query(input, pairs, "")
