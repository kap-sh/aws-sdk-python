...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_verified_access_endpoint_result.CreateVerifiedAccessEndpointResult = aws_sdk_ec2.types.create_verified_access_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_verified_access_endpoint_request.CreateVerifiedAccessEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_verified_access_endpoint_request.serialize_ec2_query(
        input_, pairs, ""
    )
