...
) -> aws_sdk_ec2.types.describe_elastic_gpus_result.DescribeElasticGpusResult:
    import aws_sdk_ec2.types.describe_elastic_gpus_result

    out: aws_sdk_ec2.types.describe_elastic_gpus_result.DescribeElasticGpusResult = (
        aws_sdk_ec2.types.describe_elastic_gpus_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_elastic_gpus_request.DescribeElasticGpusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_elastic_gpus_request.serialize_ec2_query(
        input_, pairs, ""
    )
