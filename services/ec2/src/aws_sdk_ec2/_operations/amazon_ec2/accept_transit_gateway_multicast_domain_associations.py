...
def handle_response(
    ...
    out: aws_sdk_ec2.types.accept_transit_gateway_multicast_domain_associations_result.AcceptTransitGatewayMulticastDomainAssociationsResult = aws_sdk_ec2.types.accept_transit_gateway_multicast_domain_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.accept_transit_gateway_multicast_domain_associations_request.AcceptTransitGatewayMulticastDomainAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.accept_transit_gateway_multicast_domain_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
