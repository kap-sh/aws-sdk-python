...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_transit_gateway_route_table_announcement_result.CreateTransitGatewayRouteTableAnnouncementResult = aws_sdk_ec2.types.create_transit_gateway_route_table_announcement_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_transit_gateway_route_table_announcement_request.CreateTransitGatewayRouteTableAnnouncementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_transit_gateway_route_table_announcement_request.serialize_ec2_query(
        input_, pairs, ""
    )
