...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_ipam_prefix_list_resolver_targets_result.DescribeIpamPrefixListResolverTargetsResult = aws_sdk_ec2.types.describe_ipam_prefix_list_resolver_targets_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_ipam_prefix_list_resolver_targets_request.DescribeIpamPrefixListResolverTargetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_ipam_prefix_list_resolver_targets_request.serialize_ec2_query(
        input_, pairs, ""
    )
