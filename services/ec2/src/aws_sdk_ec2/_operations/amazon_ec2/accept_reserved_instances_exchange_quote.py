...
def handle_response(
    ...
    out: aws_sdk_ec2.types.accept_reserved_instances_exchange_quote_result.AcceptReservedInstancesExchangeQuoteResult = aws_sdk_ec2.types.accept_reserved_instances_exchange_quote_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.accept_reserved_instances_exchange_quote_request.AcceptReservedInstancesExchangeQuoteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
