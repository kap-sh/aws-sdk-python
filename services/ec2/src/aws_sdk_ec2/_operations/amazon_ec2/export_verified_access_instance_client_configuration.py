...
def handle_response(
    ...
    out: aws_sdk_ec2.types.export_verified_access_instance_client_configuration_result.ExportVerifiedAccessInstanceClientConfigurationResult = aws_sdk_ec2.types.export_verified_access_instance_client_configuration_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.export_verified_access_instance_client_configuration_request.ExportVerifiedAccessInstanceClientConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
