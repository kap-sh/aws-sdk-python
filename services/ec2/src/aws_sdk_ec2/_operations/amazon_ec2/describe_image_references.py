...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_image_references_result.DescribeImageReferencesResult = aws_sdk_ec2.types.describe_image_references_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_image_references_request.DescribeImageReferencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_image_references_request.serialize_ec2_query(
        input_, pairs, ""
    )
