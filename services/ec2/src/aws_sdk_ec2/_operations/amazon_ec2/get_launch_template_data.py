...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_launch_template_data_result.GetLaunchTemplateDataResult = aws_sdk_ec2.types.get_launch_template_data_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_launch_template_data_request.GetLaunchTemplateDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetLaunchTemplateData"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.get_launch_template_data_request

    aws_sdk_ec2.types.get_launch_template_data_request.serialize_ec2_query(
        input_, pairs, ""
    )
