...
) -> aws_sdk_ec2.types.describe_fpga_image_attribute_result.DescribeFpgaImageAttributeResult:
    import aws_sdk_ec2.types.describe_fpga_image_attribute_result

    out: aws_sdk_ec2.types.describe_fpga_image_attribute_result.DescribeFpgaImageAttributeResult = aws_sdk_ec2.types.describe_fpga_image_attribute_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_fpga_image_attribute_request.DescribeFpgaImageAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
