"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteIpamResourceDiscovery``."""
...
) -> aws_sdk_ec2.types.delete_ipam_resource_discovery_result.DeleteIpamResourceDiscoveryResult:
    import aws_sdk_ec2.types.delete_ipam_resource_discovery_result

    out: aws_sdk_ec2.types.delete_ipam_resource_discovery_result.DeleteIpamResourceDiscoveryResult = aws_sdk_ec2.types.delete_ipam_resource_discovery_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_ipam_resource_discovery_request.DeleteIpamResourceDiscoveryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteIpamResourceDiscovery"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_ipam_resource_discovery_request

    aws_sdk_ec2.types.delete_ipam_resource_discovery_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_ipam_resource_discovery(
