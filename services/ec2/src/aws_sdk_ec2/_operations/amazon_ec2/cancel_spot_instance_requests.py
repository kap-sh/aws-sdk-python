...
def handle_response(
    ...
    out: aws_sdk_ec2.types.cancel_spot_instance_requests_result.CancelSpotInstanceRequestsResult = aws_sdk_ec2.types.cancel_spot_instance_requests_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.cancel_spot_instance_requests_request.CancelSpotInstanceRequestsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.cancel_spot_instance_requests_request.serialize_ec2_query(
        input_, pairs, ""
    )
