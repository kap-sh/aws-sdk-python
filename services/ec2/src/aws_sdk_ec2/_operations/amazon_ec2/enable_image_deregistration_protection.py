...
def handle_response(
    ...
    out: aws_sdk_ec2.types.enable_image_deregistration_protection_result.EnableImageDeregistrationProtectionResult = aws_sdk_ec2.types.enable_image_deregistration_protection_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_image_deregistration_protection_request.EnableImageDeregistrationProtectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.enable_image_deregistration_protection_request.serialize_ec2_query(
        input_, pairs, ""
    )
