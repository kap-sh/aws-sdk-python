"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeVpnConcentrators``."""
...
) -> aws_sdk_ec2.types.describe_vpn_concentrators_result.DescribeVpnConcentratorsResult:
    out: aws_sdk_ec2.types.describe_vpn_concentrators_result.DescribeVpnConcentratorsResult = aws_sdk_ec2.types.describe_vpn_concentrators_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_vpn_concentrators_request.DescribeVpnConcentratorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeVpnConcentrators"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_vpn_concentrators_request

    aws_sdk_ec2.types.describe_vpn_concentrators_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_vpn_concentrators(
