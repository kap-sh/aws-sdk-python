...
def handle_response(
    ...
    out: aws_sdk_ec2.types.enable_transit_gateway_route_table_propagation_result.EnableTransitGatewayRouteTablePropagationResult = aws_sdk_ec2.types.enable_transit_gateway_route_table_propagation_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_transit_gateway_route_table_propagation_request.EnableTransitGatewayRouteTablePropagationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "EnableTransitGatewayRouteTablePropagation"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.enable_transit_gateway_route_table_propagation_request.serialize_ec2_query(
        input_, pairs, ""
    )
