...
def handle_response(
    ...
    out: aws_sdk_ec2.types.import_key_pair_result.ImportKeyPairResult = (
        aws_sdk_ec2.types.import_key_pair_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.import_key_pair_request.ImportKeyPairRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.import_key_pair_request.serialize_ec2_query(input_, pairs, "")
