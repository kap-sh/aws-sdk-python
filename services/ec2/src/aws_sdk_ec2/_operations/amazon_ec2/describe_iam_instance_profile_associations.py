...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_iam_instance_profile_associations_result.DescribeIamInstanceProfileAssociationsResult = aws_sdk_ec2.types.describe_iam_instance_profile_associations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_iam_instance_profile_associations_request.DescribeIamInstanceProfileAssociationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_iam_instance_profile_associations_request.serialize_ec2_query(
        input_, pairs, ""
    )
