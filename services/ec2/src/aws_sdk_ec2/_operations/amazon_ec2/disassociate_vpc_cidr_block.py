...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disassociate_vpc_cidr_block_result.DisassociateVpcCidrBlockResult = aws_sdk_ec2.types.disassociate_vpc_cidr_block_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disassociate_vpc_cidr_block_request.DisassociateVpcCidrBlockRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disassociate_vpc_cidr_block_request.serialize_ec2_query(
        input_, pairs, ""
    )
