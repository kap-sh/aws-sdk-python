...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_vpn_gateways_result.DescribeVpnGatewaysResult = (
        aws_sdk_ec2.types.describe_vpn_gateways_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_vpn_gateways_request.DescribeVpnGatewaysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_vpn_gateways_request.serialize_ec2_query(
        input_, pairs, ""
    )
