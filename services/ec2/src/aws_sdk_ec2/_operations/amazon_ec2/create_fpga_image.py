"""Generated from Smithy shape ``com.amazonaws.ec2#CreateFpgaImage``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_fpga_image_result.CreateFpgaImageResult = (
        aws_sdk_ec2.types.create_fpga_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_fpga_image_request.CreateFpgaImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateFpgaImage"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_fpga_image_request

    aws_sdk_ec2.types.create_fpga_image_request.serialize_ec2_query(input_, pairs, "")
...
def create_fpga_image(
    ...
    aws_sdk_ec2.types.create_fpga_image_result.CreateFpgaImageResult, zapros.Response
]:
...
async def async_create_fpga_image(
