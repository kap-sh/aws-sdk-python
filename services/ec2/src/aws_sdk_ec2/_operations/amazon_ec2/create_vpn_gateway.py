...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_vpn_gateway_result.CreateVpnGatewayResult = (
        aws_sdk_ec2.types.create_vpn_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_vpn_gateway_request.CreateVpnGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_vpn_gateway_request.serialize_ec2_query(input_, pairs, "")
