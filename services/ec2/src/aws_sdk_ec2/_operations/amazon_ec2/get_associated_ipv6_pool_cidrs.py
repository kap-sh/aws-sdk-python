...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_associated_ipv6_pool_cidrs_result.GetAssociatedIpv6PoolCidrsResult = aws_sdk_ec2.types.get_associated_ipv6_pool_cidrs_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_associated_ipv6_pool_cidrs_request.GetAssociatedIpv6PoolCidrsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_associated_ipv6_pool_cidrs_request.serialize_ec2_query(
        input_, pairs, ""
    )
