...
def build_request(
    ...
    input_: aws_sdk_ec2.types.import_image_request.ImportImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ImportImage"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.import_image_request

    aws_sdk_ec2.types.import_image_request.serialize_ec2_query(input_, pairs, "")
