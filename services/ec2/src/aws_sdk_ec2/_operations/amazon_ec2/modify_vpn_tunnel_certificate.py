...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_vpn_tunnel_certificate_result.ModifyVpnTunnelCertificateResult = aws_sdk_ec2.types.modify_vpn_tunnel_certificate_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_vpn_tunnel_certificate_request.ModifyVpnTunnelCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_vpn_tunnel_certificate_request.serialize_ec2_query(
        input_, pairs, ""
    )
