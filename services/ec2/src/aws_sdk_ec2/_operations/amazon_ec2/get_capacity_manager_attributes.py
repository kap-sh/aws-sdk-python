...
) -> aws_sdk_ec2.types.get_capacity_manager_attributes_result.GetCapacityManagerAttributesResult:
    import aws_sdk_ec2.types.get_capacity_manager_attributes_result

    out: aws_sdk_ec2.types.get_capacity_manager_attributes_result.GetCapacityManagerAttributesResult = aws_sdk_ec2.types.get_capacity_manager_attributes_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_capacity_manager_attributes_request.GetCapacityManagerAttributesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_capacity_manager_attributes_request.serialize_ec2_query(
        input_, pairs, ""
    )
