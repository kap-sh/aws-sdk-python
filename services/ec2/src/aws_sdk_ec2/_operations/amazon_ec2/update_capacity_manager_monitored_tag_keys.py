...
def handle_response(
    ...
    out: aws_sdk_ec2.types.update_capacity_manager_monitored_tag_keys_result.UpdateCapacityManagerMonitoredTagKeysResult = aws_sdk_ec2.types.update_capacity_manager_monitored_tag_keys_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.update_capacity_manager_monitored_tag_keys_request.UpdateCapacityManagerMonitoredTagKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.update_capacity_manager_monitored_tag_keys_request.serialize_ec2_query(
        input_, pairs, ""
    )
