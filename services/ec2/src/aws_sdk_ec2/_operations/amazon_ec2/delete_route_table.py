...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_route_table_request.DeleteRouteTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_route_table_request.serialize_ec2_query(input_, pairs, "")
