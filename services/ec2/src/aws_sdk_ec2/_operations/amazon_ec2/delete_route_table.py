...
def build_request(
    ...
    input: aws_sdk_ec2.types.delete_route_table_request.DeleteRouteTableRequest,
) -> zapros.Request:
    ...
    aws_sdk_ec2.types.delete_route_table_request.serialize_ec2_query(input, pairs, "")
