...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_capacity_manager_data_exports_result.DescribeCapacityManagerDataExportsResult = aws_sdk_ec2.types.describe_capacity_manager_data_exports_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_capacity_manager_data_exports_request.DescribeCapacityManagerDataExportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_capacity_manager_data_exports_request.serialize_ec2_query(
        input_, pairs, ""
    )
