...
def handle_response(
    ...
    out: aws_sdk_ec2.types.enable_fast_snapshot_restores_result.EnableFastSnapshotRestoresResult = aws_sdk_ec2.types.enable_fast_snapshot_restores_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_fast_snapshot_restores_request.EnableFastSnapshotRestoresRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.enable_fast_snapshot_restores_request.serialize_ec2_query(
        input_, pairs, ""
    )
