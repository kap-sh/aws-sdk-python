...
) -> aws_sdk_ec2.types.get_host_reservation_purchase_preview_result.GetHostReservationPurchasePreviewResult:
    out: aws_sdk_ec2.types.get_host_reservation_purchase_preview_result.GetHostReservationPurchasePreviewResult = aws_sdk_ec2.types.get_host_reservation_purchase_preview_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_host_reservation_purchase_preview_request.GetHostReservationPurchasePreviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_host_reservation_purchase_preview_request.serialize_ec2_query(
        input_, pairs, ""
    )
