...
def handle_response(
    ...
    out: aws_sdk_ec2.types.revoke_client_vpn_ingress_result.RevokeClientVpnIngressResult = aws_sdk_ec2.types.revoke_client_vpn_ingress_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.revoke_client_vpn_ingress_request.RevokeClientVpnIngressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.revoke_client_vpn_ingress_request.serialize_ec2_query(
        input_, pairs, ""
    )
