...
def handle_response(
    ...
    out: aws_sdk_ec2.types.monitor_instances_result.MonitorInstancesResult = (
        aws_sdk_ec2.types.monitor_instances_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.monitor_instances_request.MonitorInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "MonitorInstances"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.monitor_instances_request

    aws_sdk_ec2.types.monitor_instances_request.serialize_ec2_query(input_, pairs, "")
