...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_reserved_instances_exchange_quote_result.GetReservedInstancesExchangeQuoteResult = aws_sdk_ec2.types.get_reserved_instances_exchange_quote_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_reserved_instances_exchange_quote_request.GetReservedInstancesExchangeQuoteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetReservedInstancesExchangeQuote"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.get_reserved_instances_exchange_quote_request

    aws_sdk_ec2.types.get_reserved_instances_exchange_quote_request.serialize_ec2_query(
        input_, pairs, ""
    )
