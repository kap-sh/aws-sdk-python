...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_vpc_classic_link_dns_support_result.DescribeVpcClassicLinkDnsSupportResult = aws_sdk_ec2.types.describe_vpc_classic_link_dns_support_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_vpc_classic_link_dns_support_request.DescribeVpcClassicLinkDnsSupportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_vpc_classic_link_dns_support_request.serialize_ec2_query(
        input_, pairs, ""
    )
