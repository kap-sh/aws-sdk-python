...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disable_image_deprecation_result.DisableImageDeprecationResult = aws_sdk_ec2.types.disable_image_deprecation_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disable_image_deprecation_request.DisableImageDeprecationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disable_image_deprecation_request.serialize_ec2_query(
        input_, pairs, ""
    )
