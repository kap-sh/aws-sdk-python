...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_secondary_network_result.CreateSecondaryNetworkResult = aws_sdk_ec2.types.create_secondary_network_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_secondary_network_request.CreateSecondaryNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateSecondaryNetwork"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_secondary_network_request

    aws_sdk_ec2.types.create_secondary_network_request.serialize_ec2_query(
        input_, pairs, ""
    )
