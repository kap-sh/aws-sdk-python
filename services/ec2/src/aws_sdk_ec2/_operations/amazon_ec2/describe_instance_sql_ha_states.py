"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeInstanceSqlHaStates``."""
...
) -> aws_sdk_ec2.types.describe_instance_sql_ha_states_result.DescribeInstanceSqlHaStatesResult:
    out: aws_sdk_ec2.types.describe_instance_sql_ha_states_result.DescribeInstanceSqlHaStatesResult = aws_sdk_ec2.types.describe_instance_sql_ha_states_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_instance_sql_ha_states_request.DescribeInstanceSqlHaStatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeInstanceSqlHaStates"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_instance_sql_ha_states_request

    aws_sdk_ec2.types.describe_instance_sql_ha_states_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_instance_sql_ha_states(
