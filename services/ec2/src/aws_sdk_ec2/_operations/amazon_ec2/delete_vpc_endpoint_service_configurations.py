...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_vpc_endpoint_service_configurations_result.DeleteVpcEndpointServiceConfigurationsResult = aws_sdk_ec2.types.delete_vpc_endpoint_service_configurations_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_vpc_endpoint_service_configurations_request.DeleteVpcEndpointServiceConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteVpcEndpointServiceConfigurations"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_vpc_endpoint_service_configurations_request

    aws_sdk_ec2.types.delete_vpc_endpoint_service_configurations_request.serialize_ec2_query(
        input_, pairs, ""
    )
