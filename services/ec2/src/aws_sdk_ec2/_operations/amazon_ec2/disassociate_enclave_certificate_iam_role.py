...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disassociate_enclave_certificate_iam_role_result.DisassociateEnclaveCertificateIamRoleResult = aws_sdk_ec2.types.disassociate_enclave_certificate_iam_role_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disassociate_enclave_certificate_iam_role_request.DisassociateEnclaveCertificateIamRoleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disassociate_enclave_certificate_iam_role_request.serialize_ec2_query(
        input_, pairs, ""
    )
