...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_network_insights_path_result.DeleteNetworkInsightsPathResult = aws_sdk_ec2.types.delete_network_insights_path_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_network_insights_path_request.DeleteNetworkInsightsPathRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteNetworkInsightsPath"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.delete_network_insights_path_request.serialize_ec2_query(
        input_, pairs, ""
    )
