...
def handle_response(
    ...
    out: aws_sdk_ec2.types.detach_classic_link_vpc_result.DetachClassicLinkVpcResult = (
        aws_sdk_ec2.types.detach_classic_link_vpc_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.detach_classic_link_vpc_request.DetachClassicLinkVpcRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DetachClassicLinkVpc"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.detach_classic_link_vpc_request

    aws_sdk_ec2.types.detach_classic_link_vpc_request.serialize_ec2_query(
        input_, pairs, ""
    )
