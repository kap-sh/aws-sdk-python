"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeLocalGateways``."""
...
) -> aws_sdk_ec2.types.describe_local_gateways_result.DescribeLocalGatewaysResult:
    import aws_sdk_ec2.types.describe_local_gateways_result

    out: aws_sdk_ec2.types.describe_local_gateways_result.DescribeLocalGatewaysResult = aws_sdk_ec2.types.describe_local_gateways_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_local_gateways_request.DescribeLocalGatewaysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeLocalGateways"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_local_gateways_request

    aws_sdk_ec2.types.describe_local_gateways_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_local_gateways(
