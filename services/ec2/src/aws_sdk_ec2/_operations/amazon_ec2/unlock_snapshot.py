...
) -> aws_sdk_ec2.types.unlock_snapshot_result.UnlockSnapshotResult:
    import aws_sdk_ec2.types.unlock_snapshot_result

    out: aws_sdk_ec2.types.unlock_snapshot_result.UnlockSnapshotResult = (
        aws_sdk_ec2.types.unlock_snapshot_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.unlock_snapshot_request.UnlockSnapshotRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.unlock_snapshot_request.serialize_ec2_query(input_, pairs, "")
