...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_default_vpc_result.CreateDefaultVpcResult = (
        aws_sdk_ec2.types.create_default_vpc_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_default_vpc_request.CreateDefaultVpcRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateDefaultVpc"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_default_vpc_request

    aws_sdk_ec2.types.create_default_vpc_request.serialize_ec2_query(input_, pairs, "")
