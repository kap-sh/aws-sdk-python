...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_capacity_manager_data_export_result.DeleteCapacityManagerDataExportResult = aws_sdk_ec2.types.delete_capacity_manager_data_export_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_capacity_manager_data_export_request.DeleteCapacityManagerDataExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteCapacityManagerDataExport"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_capacity_manager_data_export_request

    aws_sdk_ec2.types.delete_capacity_manager_data_export_request.serialize_ec2_query(
        input_, pairs, ""
    )
