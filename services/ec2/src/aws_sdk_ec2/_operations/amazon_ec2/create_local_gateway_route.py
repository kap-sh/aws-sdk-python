...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_local_gateway_route_result.CreateLocalGatewayRouteResult = aws_sdk_ec2.types.create_local_gateway_route_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_local_gateway_route_request.CreateLocalGatewayRouteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_local_gateway_route_request.serialize_ec2_query(
        input_, pairs, ""
    )
