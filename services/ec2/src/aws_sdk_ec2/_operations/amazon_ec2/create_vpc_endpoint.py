...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_vpc_endpoint_result.CreateVpcEndpointResult = (
        aws_sdk_ec2.types.create_vpc_endpoint_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_vpc_endpoint_request.CreateVpcEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateVpcEndpoint"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_vpc_endpoint_request

    aws_sdk_ec2.types.create_vpc_endpoint_request.serialize_ec2_query(input_, pairs, "")
