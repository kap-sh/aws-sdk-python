...
def handle_response(
    ...
    out: aws_sdk_ec2.types.associate_client_vpn_target_network_result.AssociateClientVpnTargetNetworkResult = aws_sdk_ec2.types.associate_client_vpn_target_network_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.associate_client_vpn_target_network_request.AssociateClientVpnTargetNetworkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.associate_client_vpn_target_network_request.serialize_ec2_query(
        input_, pairs, ""
    )
