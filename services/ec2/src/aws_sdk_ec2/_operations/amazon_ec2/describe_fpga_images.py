"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeFpgaImages``."""
...
) -> aws_sdk_ec2.types.describe_fpga_images_result.DescribeFpgaImagesResult:
    import aws_sdk_ec2.types.describe_fpga_images_result

    out: aws_sdk_ec2.types.describe_fpga_images_result.DescribeFpgaImagesResult = (
        aws_sdk_ec2.types.describe_fpga_images_result.deserialize_ec2_query(
...
def build_request(
    ...
    input: aws_sdk_ec2.types.describe_fpga_images_request.DescribeFpgaImagesRequest,
) -> zapros.Request:
    ...
    pairs.append(("Action", "DescribeFpgaImages"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_fpga_images_request

    aws_sdk_ec2.types.describe_fpga_images_request.serialize_ec2_query(input, pairs, "")
...
async def async_describe_fpga_images(
