...
) -> aws_sdk_ec2.types.modify_ipam_scope_result.ModifyIpamScopeResult:
    import aws_sdk_ec2.types.modify_ipam_scope_result

    out: aws_sdk_ec2.types.modify_ipam_scope_result.ModifyIpamScopeResult = (
        aws_sdk_ec2.types.modify_ipam_scope_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_ipam_scope_request.ModifyIpamScopeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyIpamScope"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.modify_ipam_scope_request

    aws_sdk_ec2.types.modify_ipam_scope_request.serialize_ec2_query(input_, pairs, "")
