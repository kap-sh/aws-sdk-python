...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_vpc_encryption_control_result.CreateVpcEncryptionControlResult = aws_sdk_ec2.types.create_vpc_encryption_control_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_vpc_encryption_control_request.CreateVpcEncryptionControlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
