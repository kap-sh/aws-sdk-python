"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeVpcClassicLink``."""
...
) -> aws_sdk_ec2.types.describe_vpc_classic_link_result.DescribeVpcClassicLinkResult:
    out: aws_sdk_ec2.types.describe_vpc_classic_link_result.DescribeVpcClassicLinkResult = aws_sdk_ec2.types.describe_vpc_classic_link_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_vpc_classic_link_request.DescribeVpcClassicLinkRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeVpcClassicLink"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_vpc_classic_link_request

    aws_sdk_ec2.types.describe_vpc_classic_link_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_vpc_classic_link(
