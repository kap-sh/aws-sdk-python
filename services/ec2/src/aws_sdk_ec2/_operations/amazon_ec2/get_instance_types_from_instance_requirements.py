...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_instance_types_from_instance_requirements_result.GetInstanceTypesFromInstanceRequirementsResult = aws_sdk_ec2.types.get_instance_types_from_instance_requirements_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_instance_types_from_instance_requirements_request.GetInstanceTypesFromInstanceRequirementsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_instance_types_from_instance_requirements_request.serialize_ec2_query(
        input_, pairs, ""
    )
