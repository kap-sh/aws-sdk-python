...
def handle_response(
    ...
    out: aws_sdk_ec2.types.create_capacity_reservation_by_splitting_result.CreateCapacityReservationBySplittingResult = aws_sdk_ec2.types.create_capacity_reservation_by_splitting_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_capacity_reservation_by_splitting_request.CreateCapacityReservationBySplittingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.create_capacity_reservation_by_splitting_request.serialize_ec2_query(
        input_, pairs, ""
    )
