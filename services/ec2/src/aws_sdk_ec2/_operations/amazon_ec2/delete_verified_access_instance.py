"""Generated from Smithy shape ``com.amazonaws.ec2#DeleteVerifiedAccessInstance``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_verified_access_instance_result.DeleteVerifiedAccessInstanceResult = aws_sdk_ec2.types.delete_verified_access_instance_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_verified_access_instance_request.DeleteVerifiedAccessInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteVerifiedAccessInstance"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_verified_access_instance_request

    aws_sdk_ec2.types.delete_verified_access_instance_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_delete_verified_access_instance(
