...
def build_request(
    ...
    input_: aws_sdk_ec2.types.cancel_conversion_request.CancelConversionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.cancel_conversion_request.serialize_ec2_query(input_, pairs, "")
