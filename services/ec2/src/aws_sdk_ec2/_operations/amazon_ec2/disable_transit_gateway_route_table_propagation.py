...
def handle_response(
    ...
    out: aws_sdk_ec2.types.disable_transit_gateway_route_table_propagation_result.DisableTransitGatewayRouteTablePropagationResult = aws_sdk_ec2.types.disable_transit_gateway_route_table_propagation_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.disable_transit_gateway_route_table_propagation_request.DisableTransitGatewayRouteTablePropagationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.disable_transit_gateway_route_table_propagation_request.serialize_ec2_query(
        input_, pairs, ""
    )
