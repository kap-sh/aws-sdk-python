...
def handle_response(
    ...
    out: aws_sdk_ec2.types.enable_ipam_policy_result.EnableIpamPolicyResult = (
        aws_sdk_ec2.types.enable_ipam_policy_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_ipam_policy_request.EnableIpamPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.enable_ipam_policy_request.serialize_ec2_query(input_, pairs, "")
