"""Generated from Smithy shape ``com.amazonaws.ec2#DescribeInstanceStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_instance_status_result.DescribeInstanceStatusResult = aws_sdk_ec2.types.describe_instance_status_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_instance_status_request.DescribeInstanceStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeInstanceStatus"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.describe_instance_status_request

    aws_sdk_ec2.types.describe_instance_status_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_describe_instance_status(
