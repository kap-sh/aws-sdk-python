...
) -> aws_sdk_ec2.types.move_address_to_vpc_result.MoveAddressToVpcResult:
    out: aws_sdk_ec2.types.move_address_to_vpc_result.MoveAddressToVpcResult = (
        aws_sdk_ec2.types.move_address_to_vpc_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.move_address_to_vpc_request.MoveAddressToVpcRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.move_address_to_vpc_request.serialize_ec2_query(input_, pairs, "")
