"""Generated from Smithy shape ``com.amazonaws.ec2#AssignIpv6Addresses``."""
...
def handle_response(
    ...
    out: aws_sdk_ec2.types.assign_ipv6_addresses_result.AssignIpv6AddressesResult = (
        aws_sdk_ec2.types.assign_ipv6_addresses_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.assign_ipv6_addresses_request.AssignIpv6AddressesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AssignIpv6Addresses"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.assign_ipv6_addresses_request

    aws_sdk_ec2.types.assign_ipv6_addresses_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_assign_ipv6_addresses(
