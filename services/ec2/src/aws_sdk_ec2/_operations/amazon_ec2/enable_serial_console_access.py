...
def handle_response(
    ...
    out: aws_sdk_ec2.types.enable_serial_console_access_result.EnableSerialConsoleAccessResult = aws_sdk_ec2.types.enable_serial_console_access_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.enable_serial_console_access_request.EnableSerialConsoleAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.enable_serial_console_access_request.serialize_ec2_query(
        input_, pairs, ""
    )
