...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_ipam_prefix_list_resolvers_result.DescribeIpamPrefixListResolversResult = aws_sdk_ec2.types.describe_ipam_prefix_list_resolvers_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_ipam_prefix_list_resolvers_request.DescribeIpamPrefixListResolversRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_ipam_prefix_list_resolvers_request.serialize_ec2_query(
        input_, pairs, ""
    )
