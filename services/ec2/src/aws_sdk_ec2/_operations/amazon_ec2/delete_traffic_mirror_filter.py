...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_traffic_mirror_filter_result.DeleteTrafficMirrorFilterResult = aws_sdk_ec2.types.delete_traffic_mirror_filter_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_traffic_mirror_filter_request.DeleteTrafficMirrorFilterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_traffic_mirror_filter_request.serialize_ec2_query(
        input_, pairs, ""
    )
