...
def handle_response(
    ...
    out: aws_sdk_ec2.types.restore_address_to_classic_result.RestoreAddressToClassicResult = aws_sdk_ec2.types.restore_address_to_classic_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.restore_address_to_classic_request.RestoreAddressToClassicRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "RestoreAddressToClassic"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.restore_address_to_classic_request

    aws_sdk_ec2.types.restore_address_to_classic_request.serialize_ec2_query(
        input_, pairs, ""
    )
