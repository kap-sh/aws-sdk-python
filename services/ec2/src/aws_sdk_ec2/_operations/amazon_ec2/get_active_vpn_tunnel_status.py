...
def handle_response(
    ...
    aws_sdk_ec2.types.get_active_vpn_tunnel_status_result.GetActiveVpnTunnelStatusResult
):
    out: aws_sdk_ec2.types.get_active_vpn_tunnel_status_result.GetActiveVpnTunnelStatusResult = aws_sdk_ec2.types.get_active_vpn_tunnel_status_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_active_vpn_tunnel_status_request.GetActiveVpnTunnelStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_active_vpn_tunnel_status_request.serialize_ec2_query(
        input_, pairs, ""
    )
