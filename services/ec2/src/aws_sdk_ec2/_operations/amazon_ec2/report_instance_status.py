...
def build_request(
    ...
    input_: aws_sdk_ec2.types.report_instance_status_request.ReportInstanceStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.report_instance_status_request.serialize_ec2_query(
        input_, pairs, ""
    )
