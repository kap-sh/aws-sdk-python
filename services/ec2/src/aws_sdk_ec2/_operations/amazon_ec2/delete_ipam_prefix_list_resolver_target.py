...
def handle_response(
    ...
    out: aws_sdk_ec2.types.delete_ipam_prefix_list_resolver_target_result.DeleteIpamPrefixListResolverTargetResult = aws_sdk_ec2.types.delete_ipam_prefix_list_resolver_target_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_ipam_prefix_list_resolver_target_request.DeleteIpamPrefixListResolverTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteIpamPrefixListResolverTarget"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.delete_ipam_prefix_list_resolver_target_request

    aws_sdk_ec2.types.delete_ipam_prefix_list_resolver_target_request.serialize_ec2_query(
        input_, pairs, ""
    )
