...
def handle_response(
    ...
    aws_sdk_ec2.types.modify_spot_fleet_request_response.ModifySpotFleetRequestResponse
):
    import aws_sdk_ec2.types.modify_spot_fleet_request_response

    out: aws_sdk_ec2.types.modify_spot_fleet_request_response.ModifySpotFleetRequestResponse = aws_sdk_ec2.types.modify_spot_fleet_request_response.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_spot_fleet_request_request.ModifySpotFleetRequestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_spot_fleet_request_request.serialize_ec2_query(
        input_, pairs, ""
    )
