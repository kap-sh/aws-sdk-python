...
def handle_response(
    ...
    out: aws_sdk_ec2.types.register_image_result.RegisterImageResult = (
        aws_sdk_ec2.types.register_image_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.register_image_request.RegisterImageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.register_image_request.serialize_ec2_query(input_, pairs, "")
...
def register_image(
    ...
    aws_sdk_ec2.types.register_image_result.RegisterImageResult, zapros.Response
]:
