...
def handle_response(
    ...
    out: aws_sdk_ec2.types.start_vpc_endpoint_service_private_dns_verification_result.StartVpcEndpointServicePrivateDnsVerificationResult = aws_sdk_ec2.types.start_vpc_endpoint_service_private_dns_verification_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.start_vpc_endpoint_service_private_dns_verification_request.StartVpcEndpointServicePrivateDnsVerificationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.start_vpc_endpoint_service_private_dns_verification_request.serialize_ec2_query(
        input_, pairs, ""
    )
