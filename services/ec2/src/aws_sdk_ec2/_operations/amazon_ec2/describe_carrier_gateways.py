...
) -> aws_sdk_ec2.types.describe_carrier_gateways_result.DescribeCarrierGatewaysResult:
    out: aws_sdk_ec2.types.describe_carrier_gateways_result.DescribeCarrierGatewaysResult = aws_sdk_ec2.types.describe_carrier_gateways_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_carrier_gateways_request.DescribeCarrierGatewaysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.describe_carrier_gateways_request.serialize_ec2_query(
        input_, pairs, ""
    )
