...
def handle_response(
    ...
    out: aws_sdk_ec2.types.get_ebs_encryption_by_default_result.GetEbsEncryptionByDefaultResult = aws_sdk_ec2.types.get_ebs_encryption_by_default_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.get_ebs_encryption_by_default_request.GetEbsEncryptionByDefaultRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.get_ebs_encryption_by_default_request.serialize_ec2_query(
        input_, pairs, ""
    )
