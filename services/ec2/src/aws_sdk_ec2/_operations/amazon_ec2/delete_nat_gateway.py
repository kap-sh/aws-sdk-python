...
) -> aws_sdk_ec2.types.delete_nat_gateway_result.DeleteNatGatewayResult:
    out: aws_sdk_ec2.types.delete_nat_gateway_result.DeleteNatGatewayResult = (
        aws_sdk_ec2.types.delete_nat_gateway_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.delete_nat_gateway_request.DeleteNatGatewayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.delete_nat_gateway_request.serialize_ec2_query(input_, pairs, "")
