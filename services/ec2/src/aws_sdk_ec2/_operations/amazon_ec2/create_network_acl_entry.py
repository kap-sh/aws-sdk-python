"""Generated from Smithy shape ``com.amazonaws.ec2#CreateNetworkAclEntry``."""
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.create_network_acl_entry_request.CreateNetworkAclEntryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "CreateNetworkAclEntry"))
    pairs.append(("Version", "2016-11-15"))
    import aws_sdk_ec2.types.create_network_acl_entry_request

    aws_sdk_ec2.types.create_network_acl_entry_request.serialize_ec2_query(
        input_, pairs, ""
    )
...
async def async_create_network_acl_entry(
