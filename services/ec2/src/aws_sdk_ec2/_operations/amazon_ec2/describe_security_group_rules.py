...
def handle_response(
    ...
    out: aws_sdk_ec2.types.describe_security_group_rules_result.DescribeSecurityGroupRulesResult = aws_sdk_ec2.types.describe_security_group_rules_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.describe_security_group_rules_request.DescribeSecurityGroupRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeSecurityGroupRules"))
    pairs.append(("Version", "2016-11-15"))
    aws_sdk_ec2.types.describe_security_group_rules_request.serialize_ec2_query(
        input_, pairs, ""
    )
