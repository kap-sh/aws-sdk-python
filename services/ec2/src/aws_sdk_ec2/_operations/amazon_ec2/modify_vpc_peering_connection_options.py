...
def handle_response(
    ...
    out: aws_sdk_ec2.types.modify_vpc_peering_connection_options_result.ModifyVpcPeeringConnectionOptionsResult = aws_sdk_ec2.types.modify_vpc_peering_connection_options_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_vpc_peering_connection_options_request.ModifyVpcPeeringConnectionOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_vpc_peering_connection_options_request.serialize_ec2_query(
        input_, pairs, ""
    )
