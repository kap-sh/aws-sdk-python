...
) -> aws_sdk_ec2.types.modify_ipam_prefix_list_resolver_result.ModifyIpamPrefixListResolverResult:
    import aws_sdk_ec2.types.modify_ipam_prefix_list_resolver_result

    out: aws_sdk_ec2.types.modify_ipam_prefix_list_resolver_result.ModifyIpamPrefixListResolverResult = aws_sdk_ec2.types.modify_ipam_prefix_list_resolver_result.deserialize_ec2_query(
...
def build_request(
    ...
    input_: aws_sdk_ec2.types.modify_ipam_prefix_list_resolver_request.ModifyIpamPrefixListResolverRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_ec2.types.modify_ipam_prefix_list_resolver_request.serialize_ec2_query(
        input_, pairs, ""
    )
