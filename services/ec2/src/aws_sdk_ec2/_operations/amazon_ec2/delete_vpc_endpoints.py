...
) -> aws_sdk_ec2.types.delete_vpc_endpoints_result.DeleteVpcEndpointsResult:
    import aws_sdk_ec2.types.delete_vpc_endpoints_result

    out: aws_sdk_ec2.types.delete_vpc_endpoints_result.DeleteVpcEndpointsResult = (
        aws_sdk_ec2.types.delete_vpc_endpoints_result.deserialize_ec2_query(
...
def build_request(
    ...
    input: aws_sdk_ec2.types.delete_vpc_endpoints_request.DeleteVpcEndpointsRequest,
) -> zapros.Request:
    ...
    aws_sdk_ec2.types.delete_vpc_endpoints_request.serialize_ec2_query(input, pairs, "")
