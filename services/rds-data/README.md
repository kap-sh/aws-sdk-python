...
```
pip install aws-sdk-rds-data
```

## Usage

```python
from aws_sdk_rds_data import AsyncRDSDataClient


async def main():
    async with AsyncRDSDataClient() as s3:
...
```python
from aws_sdk_rds_data import AsyncRDSDataClient
from aws_sdk_rds_data.error import AccessDeniedException
