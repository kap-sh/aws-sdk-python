...
class RDSDataError(Exception):
    """Base class for all RDSData service errors."""


class ServiceError(RDSDataError):
...
class SerializationError(RDSDataError):
    """Raised when a value cannot be serialized."""


class DeserializationError(RDSDataError):
...
class WaiterFailedError(RDSDataError):
...
class WaiterTimeoutError(RDSDataError):
