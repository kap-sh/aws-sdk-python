...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnsupportedResultException":
            import aws_sdk_rds_data.errors.unsupported_result_exception

            raise aws_sdk_rds_data.errors.unsupported_result_exception.UnsupportedResultException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_rds_data.types.execute_statement_response.ExecuteStatementResponse = (
        aws_sdk_rds_data.types.execute_statement_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rds_data.types.execute_statement_request.ExecuteStatementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rds_data.types.execute_statement_request.serialize_json(input_)
    ).encode()
