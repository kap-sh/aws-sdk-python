...
def build_request(
    ...
    input: aws_sdk_rds_data.types.batch_execute_statement_request.BatchExecuteStatementRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rds_data.types.batch_execute_statement_request.serialize_json(input)
    ).encode()
