...
def build_request(
    ...
    input: aws_sdk_rds_data.types.rollback_transaction_request.RollbackTransactionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rds_data.types.rollback_transaction_request.serialize_json(input)
    ).encode()
