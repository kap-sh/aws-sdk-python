...
def handle_response(
    ...
    out: aws_sdk_rds_data.types.execute_sql_response.ExecuteSqlResponse = (
        aws_sdk_rds_data.types.execute_sql_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_rds_data.types.execute_sql_request.ExecuteSqlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rds_data.types.execute_sql_request.serialize_json(input_)
    ).encode()
...
def execute_sql(
    ...
    aws_sdk_rds_data.types.execute_sql_response.ExecuteSqlResponse, zapros.Response
]:
