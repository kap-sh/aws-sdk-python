...
def build_request(
    ...
    input: aws_sdk_rds_data.types.commit_transaction_request.CommitTransactionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_rds_data.types.commit_transaction_request.serialize_json(input)
    ).encode()
