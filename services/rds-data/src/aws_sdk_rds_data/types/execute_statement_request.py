...
class ExecuteStatementRequest(TypedDict):
    ...
    include_result_metadata: "aws_sdk_rds_data.types.boolean.Boolean"
    """<p>A value that indicates whether to include metadata in the results.</p>"""
    continue_after_timeout: "aws_sdk_rds_data.types.boolean.Boolean"
...
def serialize_json(value: ExecuteStatementRequest) -> dict:
    ...
    if "parameters" in value:
        ...
        out["parameters"] = aws_sdk_rds_data.types.sql_parameters_list.serialize_json(
            value["parameters"]
        )
    ...
    if "result_set_options" in value:
        ...
        out["resultSetOptions"] = (
            aws_sdk_rds_data.types.result_set_options.serialize_json(
    ...
    if "format_records_as" in value:
        ...
        out["formatRecordsAs"] = (
            aws_sdk_rds_data.types.records_format_type.serialize_json(
...
def deserialize_json(data: dict) -> ExecuteStatementRequest:
    ...
    if "parameters" in data:
        ...
        out["parameters"] = aws_sdk_rds_data.types.sql_parameters_list.deserialize_json(
            data["parameters"]
        )
    ...
    if "resultSetOptions" in data:
        ...
        out["result_set_options"] = (
            aws_sdk_rds_data.types.result_set_options.deserialize_json(
    ...
    if "formatRecordsAs" in data:
        ...
        out["format_records_as"] = (
            aws_sdk_rds_data.types.records_format_type.deserialize_json(
