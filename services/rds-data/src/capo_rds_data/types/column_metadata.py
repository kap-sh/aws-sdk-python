...
if TYPE_CHECKING:
    ...
    import capo_rds_data.types.integer
    import capo_rds_data.types.string


class ColumnMetadata(TypedDict, closed=True):
    name: NotRequired["capo_rds_data.types.string.String"]
    """<p>The name of the column.</p>"""
    type: "capo_rds_data.types.integer.Integer"
    """<p>The type of the column.</p>"""
    type_name: NotRequired["capo_rds_data.types.string.String"]
    """<p>The database-specific data type of the column.</p>"""
    label: NotRequired["capo_rds_data.types.string.String"]
    """<p>The label for the column.</p>"""
    schema_name: NotRequired["capo_rds_data.types.string.String"]
    """<p>The name of the schema that owns the table that includes the column.</p>"""
    table_name: NotRequired["capo_rds_data.types.string.String"]
    """<p>The name of the table that includes the column.</p>"""
    is_auto_increment: "capo_rds_data.types.boolean.Boolean"
    """<p>A value that indicates whether the column increments automatically.</p>"""
    is_signed: "capo_rds_data.types.boolean.Boolean"
    """<p>A value that indicates whether an integer column is signed.</p>"""
    is_currency: "capo_rds_data.types.boolean.Boolean"
    """<p>A value that indicates whether the column contains currency values.</p>"""
    is_case_sensitive: "capo_rds_data.types.boolean.Boolean"
    """<p>A value that indicates whether the column is case-sensitive.</p>"""
    nullable: "capo_rds_data.types.integer.Integer"
    """<p>A value that indicates whether the column is nullable.</p>"""
    precision: "capo_rds_data.types.integer.Integer"
    """<p>The precision value of a decimal number column.</p>"""
    scale: "capo_rds_data.types.integer.Integer"
    """<p>The scale value of a decimal number column.</p>"""
    array_base_column_type: "capo_rds_data.types.integer.Integer"
    """<p>The type of the column.</p>"""
