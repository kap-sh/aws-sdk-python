...
from capo_rds_data._services._aws_config import aws_config
...
class RDSDataClient:
    ...
    def batch_execute_statement(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rds_data.types.batch_execute_statement_request.BatchExecuteStatementRequest]",
        ) -> OperationResponse[
            "capo_rds_data.types.batch_execute_statement_response.BatchExecuteStatementResponse"
        ]:
            ...
            output, http_response = (
                capo_rds_data._operations.rds_data_service.batch_execute_statement.batch_execute_statement(
    ...
    def begin_transaction(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rds_data.types.begin_transaction_request.BeginTransactionRequest]",
        ) -> OperationResponse[
            "capo_rds_data.types.begin_transaction_response.BeginTransactionResponse"
        ]:
            ...
            output, http_response = (
                capo_rds_data._operations.rds_data_service.begin_transaction.begin_transaction(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def commit_transaction(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rds_data.types.commit_transaction_request.CommitTransactionRequest]",
        ) -> OperationResponse[
            "capo_rds_data.types.commit_transaction_response.CommitTransactionResponse"
        ]:
            ...
            output, http_response = (
                capo_rds_data._operations.rds_data_service.commit_transaction.commit_transaction(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def execute_sql(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rds_data.types.execute_sql_request.ExecuteSqlRequest]",
        ) -> OperationResponse[
            "capo_rds_data.types.execute_sql_response.ExecuteSqlResponse"
        ]:
            ...
            output, http_response = (
                capo_rds_data._operations.rds_data_service.execute_sql.execute_sql(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def execute_statement(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rds_data.types.execute_statement_request.ExecuteStatementRequest]",
        ) -> OperationResponse[
            "capo_rds_data.types.execute_statement_response.ExecuteStatementResponse"
        ]:
            ...
            output, http_response = (
                capo_rds_data._operations.rds_data_service.execute_statement.execute_statement(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def rollback_transaction(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_rds_data.types.rollback_transaction_request.RollbackTransactionRequest]",
        ) -> OperationResponse[
            "capo_rds_data.types.rollback_transaction_response.RollbackTransactionResponse"
        ]:
            ...
            output, http_response = (
                capo_rds_data._operations.rds_data_service.rollback_transaction.rollback_transaction(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
