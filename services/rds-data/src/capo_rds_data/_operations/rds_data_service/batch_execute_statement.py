"""Generated from Smithy shape ``com.amazonaws.rdsdata#BatchExecuteStatement``."""
...
def handle_response(
    ...
    out: capo_rds_data.types.batch_execute_statement_response.BatchExecuteStatementResponse = capo_rds_data.types.batch_execute_statement_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rds_data.types.batch_execute_statement_request.serialize_json(input_)
    ).encode()
