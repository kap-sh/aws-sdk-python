...
def handle_response(
    ...
    out: capo_rds_data.types.begin_transaction_response.BeginTransactionResponse = (
        capo_rds_data.types.begin_transaction_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rds_data.types.begin_transaction_request.serialize_json(input_)
    ).encode()
