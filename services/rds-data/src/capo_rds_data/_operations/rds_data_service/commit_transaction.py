...
import capo_rds_data.errors.not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NotFoundException":
            raise capo_rds_data.errors.not_found_exception.NotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_rds_data.types.commit_transaction_response.CommitTransactionResponse = (
        capo_rds_data.types.commit_transaction_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rds_data.types.commit_transaction_request.serialize_json(input_)
    ).encode()
