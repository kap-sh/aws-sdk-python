...
```
pip install aws-sdk-mediapackagev2
```

## Usage

```python
from aws_sdk_mediapackagev2 import AsyncMediaPackageV2Client


async def main():
    async with AsyncMediaPackageV2Client() as s3:
...
```python
from aws_sdk_mediapackagev2 import AsyncMediaPackageV2Client
from aws_sdk_mediapackagev2.error import ValidationException
