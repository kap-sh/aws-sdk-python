...
class DashUtcTiming(TypedDict, closed=True):
    timing_mode: NotRequired[
        "capo_mediapackagev2.types.dash_utc_timing_mode.DashUtcTimingMode"
    ]
...
def serialize_json(value: DashUtcTiming) -> dict:
    ...
    if "timing_mode" in value:
        ...
        out["TimingMode"] = (
            capo_mediapackagev2.types.dash_utc_timing_mode.serialize_json(
                value["timing_mode"]
            )
        )
...
def deserialize_json(data: dict) -> DashUtcTiming:
    ...
    if "TimingMode" in data:
        ...
        out["timing_mode"] = (
            capo_mediapackagev2.types.dash_utc_timing_mode.deserialize_json(
                data["TimingMode"]
            )
        )
