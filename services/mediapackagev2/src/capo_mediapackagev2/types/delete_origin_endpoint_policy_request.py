"""Generated from Smithy shape ``com.amazonaws.mediapackagev2#DeleteOriginEndpointPolicyRequest``."""
...
class DeleteOriginEndpointPolicyRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteOriginEndpointPolicyRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> DeleteOriginEndpointPolicyRequest:
    out: DeleteOriginEndpointPolicyRequest = {}  # type: ignore[typeddict-item]
    return out
