...
class Encryption(TypedDict, closed=True):
    ...
    encryption_method: "capo_mediapackagev2.types.encryption_method.EncryptionMethod"
    ...
    speke_key_provider: "capo_mediapackagev2.types.speke_key_provider.SpekeKeyProvider"
...
def serialize_json(value: Encryption) -> dict:
    ...
    out["EncryptionMethod"] = (
        capo_mediapackagev2.types.encryption_method.serialize_json(
    ...
    out["SpekeKeyProvider"] = (
        capo_mediapackagev2.types.speke_key_provider.serialize_json(
...
def deserialize_json(data: dict) -> Encryption:
    ...
    if "EncryptionMethod" in data:
        ...
        out["encryption_method"] = (
            capo_mediapackagev2.types.encryption_method.deserialize_json(
    ...
    if "SpekeKeyProvider" in data:
        ...
        out["speke_key_provider"] = (
            capo_mediapackagev2.types.speke_key_provider.deserialize_json(
