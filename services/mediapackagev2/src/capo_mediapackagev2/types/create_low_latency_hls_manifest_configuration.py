"""Generated from Smithy shape ``com.amazonaws.mediapackagev2#CreateLowLatencyHlsManifestConfiguration``."""
...
class CreateLowLatencyHlsManifestConfiguration(TypedDict, closed=True):
    ...
    child_manifest_name: NotRequired[
        "capo_mediapackagev2.types.manifest_name.ManifestName"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateLowLatencyHlsManifestConfiguration) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateLowLatencyHlsManifestConfiguration:
    out: CreateLowLatencyHlsManifestConfiguration = {}  # type: ignore[typeddict-item]
    if "ManifestName" in data:
        out["manifest_name"] = data["ManifestName"]
    else:
        raise DeserializationError(
            "CreateLowLatencyHlsManifestConfiguration.manifest_name required"
        )
