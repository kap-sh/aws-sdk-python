...
class MediaPackageV2Error(Exception):
    """Base class for all MediaPackageV2 service errors."""


class ServiceError(MediaPackageV2Error):
...
class SerializationError(MediaPackageV2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(MediaPackageV2Error):
...
class WaiterFailedError(MediaPackageV2Error):
...
class WaiterTimeoutError(MediaPackageV2Error):
