...
def handle_response(
    ...
    out: capo_mediapackagev2.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_mediapackagev2.types.list_tags_for_resource_response.deserialize_json(
