...
def handle_response(
    ...
    out: capo_mediapackagev2.types.get_origin_endpoint_policy_response.GetOriginEndpointPolicyResponse = capo_mediapackagev2.types.get_origin_endpoint_policy_response.deserialize_json(
