...
import capo_mediapackagev2.errors.access_denied_exception
import capo_mediapackagev2.errors.conflict_exception
import capo_mediapackagev2.errors.internal_server_exception
import capo_mediapackagev2.errors.resource_not_found_exception
import capo_mediapackagev2.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise capo_mediapackagev2.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
        case "ConflictException":
            raise capo_mediapackagev2.errors.conflict_exception.ConflictException.from_json(
                data
            )
        case "InternalServerException":
            raise capo_mediapackagev2.errors.internal_server_exception.InternalServerException.from_json(
                data
            )
        case "ResourceNotFoundException":
            raise capo_mediapackagev2.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
        case "ServiceQuotaExceededException":
            raise capo_mediapackagev2.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
        case "ThrottlingException":
            raise capo_mediapackagev2.errors.throttling_exception.ThrottlingException.from_json(
                data
            )
        case "ValidationException":
            raise capo_mediapackagev2.errors.validation_exception.ValidationException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_mediapackagev2.types.update_origin_endpoint_response.UpdateOriginEndpointResponse = capo_mediapackagev2.types.update_origin_endpoint_response.deserialize_json(
...
def get_signer(
...
) -> capo_mediapackagev2._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_mediapackagev2._auth._sigv4.build_sigv4_auth_scheme(
                "mediapackagev2", options.region
            )
        )
        if sigv4_config is not None:
            return capo_mediapackagev2._auth._signers.SigV4Signer(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediapackagev2.types.update_origin_endpoint_request.serialize_json(input_)
    ).encode()
