...
def handle_response(
    ...
    out: capo_mediapackagev2.types.update_channel_response.UpdateChannelResponse = (
        capo_mediapackagev2.types.update_channel_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediapackagev2.types.update_channel_request.serialize_json(input_)
    ).encode()
