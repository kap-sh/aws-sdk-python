"""Generated from Smithy shape ``com.amazonaws.mediapackagev2#ListHarvestJobs``."""
...
import capo_mediapackagev2.types.harvest_jobs_list
...
def handle_response(
    ...
    out: capo_mediapackagev2.types.list_harvest_jobs_response.ListHarvestJobsResponse = capo_mediapackagev2.types.list_harvest_jobs_response.deserialize_json(
