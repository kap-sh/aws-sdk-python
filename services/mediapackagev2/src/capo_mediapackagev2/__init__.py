...
from ._services.async_media_package_v2 import (
    AsyncMediaPackageV2Client as AsyncMediaPackageV2Client,
)
from ._services.media_package_v2 import MediaPackageV2Client as MediaPackageV2Client
