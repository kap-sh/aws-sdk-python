...
if TYPE_CHECKING:
    import aws_sdk_mediapackagev2.types.resource_type_not_found


class ResourceNotFoundException_(TypedDict, closed=True):
    message: NotRequired["str"]
    resource_type_not_found: NotRequired[
        "aws_sdk_mediapackagev2.types.resource_type_not_found.ResourceTypeNotFound"
    ]
...
def serialize_json(value: ResourceNotFoundException_) -> dict:
    ...
    if "resource_type_not_found" in value:
        ...
        out["ResourceTypeNotFound"] = (
            aws_sdk_mediapackagev2.types.resource_type_not_found.serialize_json(
...
def deserialize_json(data: dict) -> ResourceNotFoundException_:
    ...
    if "ResourceTypeNotFound" in data:
        ...
        out["resource_type_not_found"] = (
            aws_sdk_mediapackagev2.types.resource_type_not_found.deserialize_json(
