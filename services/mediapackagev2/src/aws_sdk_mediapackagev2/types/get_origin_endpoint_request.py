"""Generated from Smithy shape ``com.amazonaws.mediapackagev2#GetOriginEndpointRequest``."""
...
class GetOriginEndpointRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetOriginEndpointRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> GetOriginEndpointRequest:
    out: GetOriginEndpointRequest = {}  # type: ignore[typeddict-item]
    return out
