"""Generated from Smithy shape ``com.amazonaws.mediapackagev2#OriginEndpointListConfiguration``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediapackagev2.types.list_dash_manifests
    import aws_sdk_mediapackagev2.types.list_hls_manifests
    import aws_sdk_mediapackagev2.types.list_low_latency_hls_manifests
    import aws_sdk_mediapackagev2.types.list_mss_manifests
...
class OriginEndpointListConfiguration(TypedDict, closed=True):
    arn: "str"
    ...
    hls_manifests: NotRequired[
        "aws_sdk_mediapackagev2.types.list_hls_manifests.ListHlsManifests"
    ]
    """<p>An HTTP live streaming (HLS) manifest configuration.</p>"""
    low_latency_hls_manifests: NotRequired[
        "aws_sdk_mediapackagev2.types.list_low_latency_hls_manifests.ListLowLatencyHlsManifests"
    ]
    """<p>A low-latency HLS manifest configuration.</p>"""
    dash_manifests: NotRequired[
        "aws_sdk_mediapackagev2.types.list_dash_manifests.ListDashManifests"
    ]
    """<p>A DASH manifest configuration.</p>"""
    mss_manifests: NotRequired[
        "aws_sdk_mediapackagev2.types.list_mss_manifests.ListMssManifests"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: OriginEndpointListConfiguration) -> dict:
    out: dict = {}
    out["Arn"] = value["arn"]
    ...
    if "hls_manifests" in value:
        ...
        out["HlsManifests"] = (
            aws_sdk_mediapackagev2.types.list_hls_manifests.serialize_json(
                value["hls_manifests"]
            )
        )
    if "low_latency_hls_manifests" in value:
        ...
        out["LowLatencyHlsManifests"] = (
            aws_sdk_mediapackagev2.types.list_low_latency_hls_manifests.serialize_json(
    ...
    if "dash_manifests" in value:
        ...
        out["DashManifests"] = (
            aws_sdk_mediapackagev2.types.list_dash_manifests.serialize_json(
    ...
    if "mss_manifests" in value:
        ...
        out["MssManifests"] = (
            aws_sdk_mediapackagev2.types.list_mss_manifests.serialize_json(
                value["mss_manifests"]
            )
        )
...
def deserialize_json(data: dict) -> OriginEndpointListConfiguration:
    out: OriginEndpointListConfiguration = {}  # type: ignore[typeddict-item]
    if "Arn" in data:
        out["arn"] = data["Arn"]
    else:
        raise DeserializationError("OriginEndpointListConfiguration.arn required")
    if "ChannelGroupName" in data:
        out["channel_group_name"] = data["ChannelGroupName"]
    else:
        raise DeserializationError(
            "OriginEndpointListConfiguration.channel_group_name required"
        )
    if "ChannelName" in data:
        out["channel_name"] = data["ChannelName"]
    else:
        raise DeserializationError(
            "OriginEndpointListConfiguration.channel_name required"
        )
    if "OriginEndpointName" in data:
        out["origin_endpoint_name"] = data["OriginEndpointName"]
    else:
        raise DeserializationError(
            "OriginEndpointListConfiguration.origin_endpoint_name required"
        )
    if "ContainerType" in data:
        ...
        raise DeserializationError(
            "OriginEndpointListConfiguration.container_type required"
        )
    ...
    if "HlsManifests" in data:
        ...
        out["hls_manifests"] = (
            aws_sdk_mediapackagev2.types.list_hls_manifests.deserialize_json(
                data["HlsManifests"]
            )
        )
    if "LowLatencyHlsManifests" in data:
        ...
        out["low_latency_hls_manifests"] = (
            aws_sdk_mediapackagev2.types.list_low_latency_hls_manifests.deserialize_json(
    ...
    if "DashManifests" in data:
        ...
        out["dash_manifests"] = (
            aws_sdk_mediapackagev2.types.list_dash_manifests.deserialize_json(
                data["DashManifests"]
            )
        )
    if "MssManifests" in data:
        ...
        out["mss_manifests"] = (
            aws_sdk_mediapackagev2.types.list_mss_manifests.deserialize_json(
                data["MssManifests"]
            )
        )
