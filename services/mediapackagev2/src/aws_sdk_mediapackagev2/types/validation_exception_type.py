"""Generated from Smithy shape ``com.amazonaws.mediapackagev2#ValidationExceptionType``."""
...
def serialize_json(value: ValidationExceptionType) -> str:
    return value


def deserialize_json(data: str) -> ValidationExceptionType:
