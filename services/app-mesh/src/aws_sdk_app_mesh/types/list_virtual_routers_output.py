...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.virtual_router_list


class ListVirtualRoutersOutput(TypedDict):
    virtual_routers: "aws_sdk_app_mesh.types.virtual_router_list.VirtualRouterList"
...
def serialize_json(value: ListVirtualRoutersOutput) -> dict:
    ...
    out["virtualRouters"] = aws_sdk_app_mesh.types.virtual_router_list.serialize_json(
...
def deserialize_json(data: dict) -> ListVirtualRoutersOutput:
    ...
    if "virtualRouters" in data:
        ...
        out["virtual_routers"] = (
            aws_sdk_app_mesh.types.virtual_router_list.deserialize_json(
                data["virtualRouters"]
            )
        )
    else:
