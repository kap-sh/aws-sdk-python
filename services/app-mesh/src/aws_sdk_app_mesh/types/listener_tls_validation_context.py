"""Generated from Smithy shape ``com.amazonaws.appmesh#ListenerTlsValidationContext``."""
...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.listener_tls_validation_context_trust
    import aws_sdk_app_mesh.types.subject_alternative_names


class ListenerTlsValidationContext(TypedDict, closed=True):
    trust: "aws_sdk_app_mesh.types.listener_tls_validation_context_trust.ListenerTlsValidationContextTrust"
...
# --- restJson1 ser/de ---
def serialize_json(value: ListenerTlsValidationContext) -> dict:
    out: dict = {}
    import aws_sdk_app_mesh.types.listener_tls_validation_context_trust

    out["trust"] = (
        aws_sdk_app_mesh.types.listener_tls_validation_context_trust.serialize_json(
            value["trust"]
        )
    )
...
def deserialize_json(data: dict) -> ListenerTlsValidationContext:
    ...
    if "trust" in data:
        ...
        out["trust"] = (
            aws_sdk_app_mesh.types.listener_tls_validation_context_trust.deserialize_json(
                data["trust"]
            )
        )
    else:
