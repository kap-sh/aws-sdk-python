...
class ClientPolicyTls(TypedDict):
    ...
    certificate: NotRequired[
        "aws_sdk_app_mesh.types.client_tls_certificate.ClientTlsCertificate"
    ]
...
def serialize_json(value: ClientPolicyTls) -> dict:
    ...
    if "certificate" in value:
        ...
        out["certificate"] = (
            aws_sdk_app_mesh.types.client_tls_certificate.serialize_json(
                value["certificate"]
            )
        )
    import aws_sdk_app_mesh.types.tls_validation_context

    out["validation"] = aws_sdk_app_mesh.types.tls_validation_context.serialize_json(
        value["validation"]
    )
    return out
...
def deserialize_json(data: dict) -> ClientPolicyTls:
    ...
    if "certificate" in data:
        ...
        out["certificate"] = (
            aws_sdk_app_mesh.types.client_tls_certificate.deserialize_json(
                data["certificate"]
            )
        )
    if "validation" in data:
        ...
        out["validation"] = (
            aws_sdk_app_mesh.types.tls_validation_context.deserialize_json(
                data["validation"]
            )
        )
    else:
