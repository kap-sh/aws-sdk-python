...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.virtual_node_grpc_connection_pool
    import aws_sdk_app_mesh.types.virtual_node_http2_connection_pool
    import aws_sdk_app_mesh.types.virtual_node_http_connection_pool
...
def serialize_json(value: VirtualNodeConnectionPool) -> dict:
    if "tcp" in value:
        ...
        return {
            "tcp": aws_sdk_app_mesh.types.virtual_node_tcp_connection_pool.serialize_json(
                value["tcp"]
            )
        }
    elif "http" in value:
        ...
        return {
            "http": aws_sdk_app_mesh.types.virtual_node_http_connection_pool.serialize_json(
                value["http"]
            )
        }
    elif "http2" in value:
        ...
        return {
            "http2": aws_sdk_app_mesh.types.virtual_node_http2_connection_pool.serialize_json(
                value["http2"]
            )
        }
    elif "grpc" in value:
        ...
        return {
            "grpc": aws_sdk_app_mesh.types.virtual_node_grpc_connection_pool.serialize_json(
                value["grpc"]
            )
        }
    else:
...
def deserialize_json(data: dict) -> VirtualNodeConnectionPool:
    if "tcp" in data:
        ...
        return {
            "tcp": aws_sdk_app_mesh.types.virtual_node_tcp_connection_pool.deserialize_json(
                data["tcp"]
            )
        }
    elif "http" in data:
        ...
        return {
            "http": aws_sdk_app_mesh.types.virtual_node_http_connection_pool.deserialize_json(
                data["http"]
            )
        }
    elif "http2" in data:
        ...
        return {
            "http2": aws_sdk_app_mesh.types.virtual_node_http2_connection_pool.deserialize_json(
                data["http2"]
            )
        }
    elif "grpc" in data:
        ...
        return {
            "grpc": aws_sdk_app_mesh.types.virtual_node_grpc_connection_pool.deserialize_json(
                data["grpc"]
            )
        }
    else:
