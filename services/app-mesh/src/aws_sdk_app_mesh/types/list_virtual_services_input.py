"""Generated from Smithy shape ``com.amazonaws.appmesh#ListVirtualServicesInput``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_app_mesh.types.list_virtual_services_limit
    import aws_sdk_app_mesh.types.resource_name


class ListVirtualServicesInput(TypedDict, closed=True):
    ...
    limit: NotRequired[
        "aws_sdk_app_mesh.types.list_virtual_services_limit.ListVirtualServicesLimit"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: ListVirtualServicesInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListVirtualServicesInput:
    out: ListVirtualServicesInput = {}  # type: ignore[typeddict-item]
    return out
