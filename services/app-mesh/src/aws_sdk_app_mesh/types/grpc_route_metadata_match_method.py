...
class _GrpcRouteMetadataMatchMethod_exact(TypedDict):
    exact: "aws_sdk_app_mesh.types.header_match.HeaderMatch"


class _GrpcRouteMetadataMatchMethod_regex(TypedDict):
    regex: "aws_sdk_app_mesh.types.header_match.HeaderMatch"


class _GrpcRouteMetadataMatchMethod_range(TypedDict):
    range: "aws_sdk_app_mesh.types.match_range.MatchRange"


class _GrpcRouteMetadataMatchMethod_prefix(TypedDict):
    prefix: "aws_sdk_app_mesh.types.header_match.HeaderMatch"


class _GrpcRouteMetadataMatchMethod_suffix(TypedDict):
