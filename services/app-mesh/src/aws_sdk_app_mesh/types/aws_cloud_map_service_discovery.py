...
class AwsCloudMapServiceDiscovery(TypedDict, closed=True):
    ...
    attributes: NotRequired[
        "aws_sdk_app_mesh.types.aws_cloud_map_instance_attributes.AwsCloudMapInstanceAttributes"
    ]
...
def serialize_json(value: AwsCloudMapServiceDiscovery) -> dict:
    ...
    if "attributes" in value:
        ...
        out["attributes"] = (
            aws_sdk_app_mesh.types.aws_cloud_map_instance_attributes.serialize_json(
                value["attributes"]
            )
        )
...
def deserialize_json(data: dict) -> AwsCloudMapServiceDiscovery:
    ...
    if "attributes" in data:
        ...
        out["attributes"] = (
            aws_sdk_app_mesh.types.aws_cloud_map_instance_attributes.deserialize_json(
                data["attributes"]
            )
        )
