...
if TYPE_CHECKING:
    ...
    import aws_sdk_app_mesh.types.list_gateway_routes_limit
    import aws_sdk_app_mesh.types.resource_name


class ListGatewayRoutesInput(TypedDict):
    ...
    limit: NotRequired[
        "aws_sdk_app_mesh.types.list_gateway_routes_limit.ListGatewayRoutesLimit"
    ]
