"""Generated from Smithy shape ``com.amazonaws.appmesh#DeleteVirtualRouterInput``."""
...
class DeleteVirtualRouterInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteVirtualRouterInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> DeleteVirtualRouterInput:
    out: DeleteVirtualRouterInput = {}  # type: ignore[typeddict-item]
    return out
