...
if TYPE_CHECKING:
    ...
    import aws_sdk_app_mesh.types.grpc_retry_policy_events
...
class GrpcRetryPolicy(TypedDict):
    ...
    grpc_retry_events: NotRequired[
        "aws_sdk_app_mesh.types.grpc_retry_policy_events.GrpcRetryPolicyEvents"
    ]
...
def serialize_json(value: GrpcRetryPolicy) -> dict:
    ...
    if "grpc_retry_events" in value:
        ...
        out["grpcRetryEvents"] = (
            aws_sdk_app_mesh.types.grpc_retry_policy_events.serialize_json(
...
def deserialize_json(data: dict) -> GrpcRetryPolicy:
    ...
    if "grpcRetryEvents" in data:
        ...
        out["grpc_retry_events"] = (
            aws_sdk_app_mesh.types.grpc_retry_policy_events.deserialize_json(
