...
if TYPE_CHECKING:
    ...
    import aws_sdk_app_mesh.types.list_routes_limit
    import aws_sdk_app_mesh.types.resource_name


class ListRoutesInput(TypedDict):
    ...
    limit: NotRequired["aws_sdk_app_mesh.types.list_routes_limit.ListRoutesLimit"]
