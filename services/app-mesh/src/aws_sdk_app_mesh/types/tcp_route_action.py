"""Generated from Smithy shape ``com.amazonaws.appmesh#TcpRouteAction``."""
...
class TcpRouteAction(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: TcpRouteAction) -> dict:
    out: dict = {}
    import aws_sdk_app_mesh.types.weighted_targets
...
def deserialize_json(data: dict) -> TcpRouteAction:
    ...
    if "weightedTargets" in data:
        ...
        raise DeserializationError("TcpRouteAction.weighted_targets required")
    return out
