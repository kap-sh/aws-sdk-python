...
class AppMeshError(Exception):
    """Base class for all AppMesh service errors."""

class ServiceError(AppMeshError):
...
class SerializationError(AppMeshError):
    """Raised when a value cannot be serialized."""

class DeserializationError(AppMeshError):
...
class WaiterFailedError(AppMeshError):
...
class WaiterTimeoutError(AppMeshError):
