...
from aws_sdk_app_mesh._resources.app_mesh.mesh import Mesh
from aws_sdk_app_mesh._services._aws_config import aws_config
...
class AppMeshClient:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_app_mesh.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_app_mesh.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_app_mesh._operations.app_mesh.list_tags_for_resource.list_tags_for_resource(
    ...
    def iter_list_tags_for_resource(
        ...
        *,
        ...
        next_token: Optional[str] = None,
        limit: Optional["aws_sdk_app_mesh.types.tags_limit.TagsLimit"] = None,
    ) -> "Iterator[aws_sdk_app_mesh.types.tag_ref.TagRef]":
        _token = next_token
        while True:
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_app_mesh.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_app_mesh.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_app_mesh._operations.app_mesh.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_app_mesh.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_app_mesh.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_app_mesh._operations.app_mesh.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
