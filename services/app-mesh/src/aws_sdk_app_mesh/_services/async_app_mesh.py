...
from aws_sdk_app_mesh._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
...
class AsyncAppMeshClient:
    ...
    def __init__(self, http_handler: AsyncBaseHandler | None = None, operation_interceptors: Iterable[AsyncInterceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, region: str | None = None, use_dual_stack: bool | None = None, use_fips: bool | None = None, endpoint: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = AsyncAppMeshClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "region": region, "use_dual_stack": use_dual_stack, "use_fips": use_fips, "endpoint": endpoint, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[AsyncAppMeshClientConfig] = None) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
    ...
    async def list_tags_for_resource(self, resource_arn: "aws_sdk_app_mesh.types.arn.Arn", *, config_overrides: Optional[AsyncAppMeshClientConfig] = None, next_token: Optional[str] = None, limit: Optional["aws_sdk_app_mesh.types.tags_limit.TagsLimit"] = None) -> "aws_sdk_app_mesh.types.list_tags_for_resource_output.ListTagsForResourceOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_app_mesh.types.list_tags_for_resource_input.ListTagsForResourceInput]') -> AsyncOperationResponse["aws_sdk_app_mesh.types.list_tags_for_resource_output.ListTagsForResourceOutput"]:
            import aws_sdk_app_mesh._operations.app_mesh.list_tags_for_resource
            output, http_response = await aws_sdk_app_mesh._operations.app_mesh.list_tags_for_resource.async_list_tags_for_resource(req.options, req.input)
    ...
    async def iter_list_tags_for_resource(self, resource_arn: "aws_sdk_app_mesh.types.arn.Arn", *, config_overrides: Optional[AsyncAppMeshClientConfig] = None, next_token: Optional[str] = None, limit: Optional["aws_sdk_app_mesh.types.tags_limit.TagsLimit"] = None) -> "AsyncIterator[aws_sdk_app_mesh.types.tag_ref.TagRef]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    async def tag_resource(self, resource_arn: "aws_sdk_app_mesh.types.arn.Arn", tags: "aws_sdk_app_mesh.types.tag_list.TagList", *, config_overrides: Optional[AsyncAppMeshClientConfig] = None) -> "aws_sdk_app_mesh.types.tag_resource_output.TagResourceOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_app_mesh.types.tag_resource_input.TagResourceInput]') -> AsyncOperationResponse["aws_sdk_app_mesh.types.tag_resource_output.TagResourceOutput"]:
            import aws_sdk_app_mesh._operations.app_mesh.tag_resource
            output, http_response = await aws_sdk_app_mesh._operations.app_mesh.tag_resource.async_tag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def untag_resource(self, resource_arn: "aws_sdk_app_mesh.types.arn.Arn", tag_keys: "aws_sdk_app_mesh.types.tag_key_list.TagKeyList", *, config_overrides: Optional[AsyncAppMeshClientConfig] = None) -> "aws_sdk_app_mesh.types.untag_resource_output.UntagResourceOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_app_mesh.types.untag_resource_input.UntagResourceInput]') -> AsyncOperationResponse["aws_sdk_app_mesh.types.untag_resource_output.UntagResourceOutput"]:
            import aws_sdk_app_mesh._operations.app_mesh.untag_resource
            output, http_response = await aws_sdk_app_mesh._operations.app_mesh.untag_resource.async_untag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
