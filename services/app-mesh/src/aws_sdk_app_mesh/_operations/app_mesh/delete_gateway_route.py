...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.delete_gateway_route_output.DeleteGatewayRouteOutput:
    import aws_sdk_app_mesh.types.gateway_route_data
    out: aws_sdk_app_mesh.types.delete_gateway_route_output.DeleteGatewayRouteOutput = {"gateway_route": aws_sdk_app_mesh.types.gateway_route_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.delete_gateway_route_input.DeleteGatewayRouteInput) -> zapros.Request:
...
def delete_gateway_route(options: OperationOptions, input: aws_sdk_app_mesh.types.delete_gateway_route_input.DeleteGatewayRouteInput) -> tuple[aws_sdk_app_mesh.types.delete_gateway_route_output.DeleteGatewayRouteOutput, zapros.Response]:
...
async def async_delete_gateway_route(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.delete_gateway_route_input.DeleteGatewayRouteInput) -> tuple[aws_sdk_app_mesh.types.delete_gateway_route_output.DeleteGatewayRouteOutput, zapros.Response]:
