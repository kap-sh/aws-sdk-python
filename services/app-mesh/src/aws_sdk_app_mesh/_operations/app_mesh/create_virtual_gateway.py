...
) -> aws_sdk_app_mesh.types.create_virtual_gateway_output.CreateVirtualGatewayOutput:
    import aws_sdk_app_mesh.types.virtual_gateway_data

    out: aws_sdk_app_mesh.types.create_virtual_gateway_output.CreateVirtualGatewayOutput = {
        "virtual_gateway": aws_sdk_app_mesh.types.virtual_gateway_data.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.create_virtual_gateway_input.CreateVirtualGatewayInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.create_virtual_gateway_input.serialize_json(input_)
    ).encode()
...
async def async_create_virtual_gateway(
