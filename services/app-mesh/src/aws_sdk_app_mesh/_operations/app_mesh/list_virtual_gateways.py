...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.list_virtual_gateways_input
    import aws_sdk_app_mesh.types.list_virtual_gateways_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.list_virtual_gateways_output.ListVirtualGatewaysOutput:
    import aws_sdk_app_mesh.types.list_virtual_gateways_output
    out: aws_sdk_app_mesh.types.list_virtual_gateways_output.ListVirtualGatewaysOutput = aws_sdk_app_mesh.types.list_virtual_gateways_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.list_virtual_gateways_input.ListVirtualGatewaysInput) -> zapros.Request:
...
def list_virtual_gateways(options: OperationOptions, input: aws_sdk_app_mesh.types.list_virtual_gateways_input.ListVirtualGatewaysInput) -> tuple[aws_sdk_app_mesh.types.list_virtual_gateways_output.ListVirtualGatewaysOutput, zapros.Response]:
...
async def async_list_virtual_gateways(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.list_virtual_gateways_input.ListVirtualGatewaysInput) -> tuple[aws_sdk_app_mesh.types.list_virtual_gateways_output.ListVirtualGatewaysOutput, zapros.Response]:
