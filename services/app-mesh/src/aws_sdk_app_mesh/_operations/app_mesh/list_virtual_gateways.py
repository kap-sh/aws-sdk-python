...
) -> aws_sdk_app_mesh.types.list_virtual_gateways_output.ListVirtualGatewaysOutput:
    import aws_sdk_app_mesh.types.list_virtual_gateways_output

    out: aws_sdk_app_mesh.types.list_virtual_gateways_output.ListVirtualGatewaysOutput = aws_sdk_app_mesh.types.list_virtual_gateways_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.list_virtual_gateways_input.ListVirtualGatewaysInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
