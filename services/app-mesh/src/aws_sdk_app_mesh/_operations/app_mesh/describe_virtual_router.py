"""Generated from Smithy shape ``com.amazonaws.appmesh#DescribeVirtualRouter``."""
...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.describe_virtual_router_input
    import aws_sdk_app_mesh.types.describe_virtual_router_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.describe_virtual_router_output.DescribeVirtualRouterOutput:
    import aws_sdk_app_mesh.types.virtual_router_data
    out: aws_sdk_app_mesh.types.describe_virtual_router_output.DescribeVirtualRouterOutput = {"virtual_router": aws_sdk_app_mesh.types.virtual_router_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.describe_virtual_router_input.DescribeVirtualRouterInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v20190125/meshes/{meshName}/virtualRouters/{virtualRouterName}"
...
def describe_virtual_router(options: OperationOptions, input: aws_sdk_app_mesh.types.describe_virtual_router_input.DescribeVirtualRouterInput) -> tuple[aws_sdk_app_mesh.types.describe_virtual_router_output.DescribeVirtualRouterOutput, zapros.Response]:
...
async def async_describe_virtual_router(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.describe_virtual_router_input.DescribeVirtualRouterInput) -> tuple[aws_sdk_app_mesh.types.describe_virtual_router_output.DescribeVirtualRouterOutput, zapros.Response]:
