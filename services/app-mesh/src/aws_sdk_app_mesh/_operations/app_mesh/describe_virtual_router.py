...
) -> aws_sdk_app_mesh.types.describe_virtual_router_output.DescribeVirtualRouterOutput:
    import aws_sdk_app_mesh.types.virtual_router_data

    out: aws_sdk_app_mesh.types.describe_virtual_router_output.DescribeVirtualRouterOutput = {
        "virtual_router": aws_sdk_app_mesh.types.virtual_router_data.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.describe_virtual_router_input.DescribeVirtualRouterInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_virtual_router(
