...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.describe_virtual_gateway_input
    import aws_sdk_app_mesh.types.describe_virtual_gateway_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.describe_virtual_gateway_output.DescribeVirtualGatewayOutput:
    import aws_sdk_app_mesh.types.virtual_gateway_data
    out: aws_sdk_app_mesh.types.describe_virtual_gateway_output.DescribeVirtualGatewayOutput = {"virtual_gateway": aws_sdk_app_mesh.types.virtual_gateway_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.describe_virtual_gateway_input.DescribeVirtualGatewayInput) -> zapros.Request:
...
def describe_virtual_gateway(options: OperationOptions, input: aws_sdk_app_mesh.types.describe_virtual_gateway_input.DescribeVirtualGatewayInput) -> tuple[aws_sdk_app_mesh.types.describe_virtual_gateway_output.DescribeVirtualGatewayOutput, zapros.Response]:
...
async def async_describe_virtual_gateway(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.describe_virtual_gateway_input.DescribeVirtualGatewayInput) -> tuple[aws_sdk_app_mesh.types.describe_virtual_gateway_output.DescribeVirtualGatewayOutput, zapros.Response]:
