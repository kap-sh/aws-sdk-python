...
def handle_response(
    ...
    aws_sdk_app_mesh.types.describe_virtual_gateway_output.DescribeVirtualGatewayOutput
):
    import aws_sdk_app_mesh.types.virtual_gateway_data

    out: aws_sdk_app_mesh.types.describe_virtual_gateway_output.DescribeVirtualGatewayOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.describe_virtual_gateway_input.DescribeVirtualGatewayInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
