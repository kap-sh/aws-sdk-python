...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.list_gateway_routes_input
    import aws_sdk_app_mesh.types.list_gateway_routes_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.list_gateway_routes_output.ListGatewayRoutesOutput:
    import aws_sdk_app_mesh.types.list_gateway_routes_output
    out: aws_sdk_app_mesh.types.list_gateway_routes_output.ListGatewayRoutesOutput = aws_sdk_app_mesh.types.list_gateway_routes_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.list_gateway_routes_input.ListGatewayRoutesInput) -> zapros.Request:
...
def list_gateway_routes(options: OperationOptions, input: aws_sdk_app_mesh.types.list_gateway_routes_input.ListGatewayRoutesInput) -> tuple[aws_sdk_app_mesh.types.list_gateway_routes_output.ListGatewayRoutesOutput, zapros.Response]:
...
async def async_list_gateway_routes(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.list_gateway_routes_input.ListGatewayRoutesInput) -> tuple[aws_sdk_app_mesh.types.list_gateway_routes_output.ListGatewayRoutesOutput, zapros.Response]:
