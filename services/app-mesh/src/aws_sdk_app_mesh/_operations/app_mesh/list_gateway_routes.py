...
) -> aws_sdk_app_mesh.types.list_gateway_routes_output.ListGatewayRoutesOutput:
    out: aws_sdk_app_mesh.types.list_gateway_routes_output.ListGatewayRoutesOutput = (
        aws_sdk_app_mesh.types.list_gateway_routes_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.list_gateway_routes_input.ListGatewayRoutesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
