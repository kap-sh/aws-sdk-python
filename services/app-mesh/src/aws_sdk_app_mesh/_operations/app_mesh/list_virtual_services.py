...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.list_virtual_services_output.ListVirtualServicesOutput:
    import aws_sdk_app_mesh.types.list_virtual_services_output
    out: aws_sdk_app_mesh.types.list_virtual_services_output.ListVirtualServicesOutput = aws_sdk_app_mesh.types.list_virtual_services_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.list_virtual_services_input.ListVirtualServicesInput) -> zapros.Request:
...
def list_virtual_services(options: OperationOptions, input: aws_sdk_app_mesh.types.list_virtual_services_input.ListVirtualServicesInput) -> tuple[aws_sdk_app_mesh.types.list_virtual_services_output.ListVirtualServicesOutput, zapros.Response]:
...
async def async_list_virtual_services(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.list_virtual_services_input.ListVirtualServicesInput) -> tuple[aws_sdk_app_mesh.types.list_virtual_services_output.ListVirtualServicesOutput, zapros.Response]:
