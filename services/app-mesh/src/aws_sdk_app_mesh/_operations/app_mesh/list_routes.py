...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.list_routes_output.ListRoutesOutput:
    import aws_sdk_app_mesh.types.list_routes_output
    out: aws_sdk_app_mesh.types.list_routes_output.ListRoutesOutput = aws_sdk_app_mesh.types.list_routes_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.list_routes_input.ListRoutesInput) -> zapros.Request:
...
def list_routes(options: OperationOptions, input: aws_sdk_app_mesh.types.list_routes_input.ListRoutesInput) -> tuple[aws_sdk_app_mesh.types.list_routes_output.ListRoutesOutput, zapros.Response]:
...
async def async_list_routes(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.list_routes_input.ListRoutesInput) -> tuple[aws_sdk_app_mesh.types.list_routes_output.ListRoutesOutput, zapros.Response]:
