...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.update_virtual_gateway_input
    import aws_sdk_app_mesh.types.update_virtual_gateway_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.update_virtual_gateway_output.UpdateVirtualGatewayOutput:
    import aws_sdk_app_mesh.types.virtual_gateway_data
    out: aws_sdk_app_mesh.types.update_virtual_gateway_output.UpdateVirtualGatewayOutput = {"virtual_gateway": aws_sdk_app_mesh.types.virtual_gateway_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.update_virtual_gateway_input.UpdateVirtualGatewayInput) -> zapros.Request:
    ...
    import aws_sdk_app_mesh.types.update_virtual_gateway_input
    body: bytes | None = json.dumps(aws_sdk_app_mesh.types.update_virtual_gateway_input.serialize_json(input)).encode()
...
def update_virtual_gateway(options: OperationOptions, input: aws_sdk_app_mesh.types.update_virtual_gateway_input.UpdateVirtualGatewayInput) -> tuple[aws_sdk_app_mesh.types.update_virtual_gateway_output.UpdateVirtualGatewayOutput, zapros.Response]:
...
async def async_update_virtual_gateway(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.update_virtual_gateway_input.UpdateVirtualGatewayInput) -> tuple[aws_sdk_app_mesh.types.update_virtual_gateway_output.UpdateVirtualGatewayOutput, zapros.Response]:
