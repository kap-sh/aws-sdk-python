...
) -> aws_sdk_app_mesh.types.update_virtual_gateway_output.UpdateVirtualGatewayOutput:
    import aws_sdk_app_mesh.types.virtual_gateway_data

    out: aws_sdk_app_mesh.types.update_virtual_gateway_output.UpdateVirtualGatewayOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.update_virtual_gateway_input.UpdateVirtualGatewayInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.update_virtual_gateway_input.serialize_json(input_)
    ).encode()
