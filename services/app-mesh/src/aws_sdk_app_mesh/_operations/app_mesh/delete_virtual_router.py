...
) -> aws_sdk_app_mesh.types.delete_virtual_router_output.DeleteVirtualRouterOutput:
    import aws_sdk_app_mesh.types.virtual_router_data

    out: aws_sdk_app_mesh.types.delete_virtual_router_output.DeleteVirtualRouterOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.delete_virtual_router_input.DeleteVirtualRouterInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
