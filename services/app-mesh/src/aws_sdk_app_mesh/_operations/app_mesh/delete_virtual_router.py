...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.delete_virtual_router_input
    import aws_sdk_app_mesh.types.delete_virtual_router_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.delete_virtual_router_output.DeleteVirtualRouterOutput:
    import aws_sdk_app_mesh.types.virtual_router_data
    out: aws_sdk_app_mesh.types.delete_virtual_router_output.DeleteVirtualRouterOutput = {"virtual_router": aws_sdk_app_mesh.types.virtual_router_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.delete_virtual_router_input.DeleteVirtualRouterInput) -> zapros.Request:
...
def delete_virtual_router(options: OperationOptions, input: aws_sdk_app_mesh.types.delete_virtual_router_input.DeleteVirtualRouterInput) -> tuple[aws_sdk_app_mesh.types.delete_virtual_router_output.DeleteVirtualRouterOutput, zapros.Response]:
...
async def async_delete_virtual_router(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.delete_virtual_router_input.DeleteVirtualRouterInput) -> tuple[aws_sdk_app_mesh.types.delete_virtual_router_output.DeleteVirtualRouterOutput, zapros.Response]:
