...
) -> aws_sdk_app_mesh.types.delete_virtual_service_output.DeleteVirtualServiceOutput:
    import aws_sdk_app_mesh.types.virtual_service_data

    out: aws_sdk_app_mesh.types.delete_virtual_service_output.DeleteVirtualServiceOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.delete_virtual_service_input.DeleteVirtualServiceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
