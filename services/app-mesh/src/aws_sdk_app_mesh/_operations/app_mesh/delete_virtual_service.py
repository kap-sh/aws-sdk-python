...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.delete_virtual_service_input
    import aws_sdk_app_mesh.types.delete_virtual_service_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.delete_virtual_service_output.DeleteVirtualServiceOutput:
    import aws_sdk_app_mesh.types.virtual_service_data
    out: aws_sdk_app_mesh.types.delete_virtual_service_output.DeleteVirtualServiceOutput = {"virtual_service": aws_sdk_app_mesh.types.virtual_service_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.delete_virtual_service_input.DeleteVirtualServiceInput) -> zapros.Request:
...
def delete_virtual_service(options: OperationOptions, input: aws_sdk_app_mesh.types.delete_virtual_service_input.DeleteVirtualServiceInput) -> tuple[aws_sdk_app_mesh.types.delete_virtual_service_output.DeleteVirtualServiceOutput, zapros.Response]:
...
async def async_delete_virtual_service(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.delete_virtual_service_input.DeleteVirtualServiceInput) -> tuple[aws_sdk_app_mesh.types.delete_virtual_service_output.DeleteVirtualServiceOutput, zapros.Response]:
