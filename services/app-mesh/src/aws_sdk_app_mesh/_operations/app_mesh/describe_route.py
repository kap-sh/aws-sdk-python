...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.describe_route_input
    import aws_sdk_app_mesh.types.describe_route_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.describe_route_output.DescribeRouteOutput:
    import aws_sdk_app_mesh.types.route_data
    out: aws_sdk_app_mesh.types.describe_route_output.DescribeRouteOutput = {"route": aws_sdk_app_mesh.types.route_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.describe_route_input.DescribeRouteInput) -> zapros.Request:
...
def describe_route(options: OperationOptions, input: aws_sdk_app_mesh.types.describe_route_input.DescribeRouteInput) -> tuple[aws_sdk_app_mesh.types.describe_route_output.DescribeRouteOutput, zapros.Response]:
...
async def async_describe_route(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.describe_route_input.DescribeRouteInput) -> tuple[aws_sdk_app_mesh.types.describe_route_output.DescribeRouteOutput, zapros.Response]:
