...
) -> aws_sdk_app_mesh.types.describe_route_output.DescribeRouteOutput:
    import aws_sdk_app_mesh.types.route_data

    out: aws_sdk_app_mesh.types.describe_route_output.DescribeRouteOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.describe_route_input.DescribeRouteInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_route(
    ...
    aws_sdk_app_mesh.types.describe_route_output.DescribeRouteOutput, zapros.Response
]:
