...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.update_route_input
    import aws_sdk_app_mesh.types.update_route_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.update_route_output.UpdateRouteOutput:
    import aws_sdk_app_mesh.types.route_data
    out: aws_sdk_app_mesh.types.update_route_output.UpdateRouteOutput = {"route": aws_sdk_app_mesh.types.route_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.update_route_input.UpdateRouteInput) -> zapros.Request:
    ...
    import aws_sdk_app_mesh.types.update_route_input
    body: bytes | None = json.dumps(aws_sdk_app_mesh.types.update_route_input.serialize_json(input)).encode()
...
def update_route(options: OperationOptions, input: aws_sdk_app_mesh.types.update_route_input.UpdateRouteInput) -> tuple[aws_sdk_app_mesh.types.update_route_output.UpdateRouteOutput, zapros.Response]:
...
async def async_update_route(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.update_route_input.UpdateRouteInput) -> tuple[aws_sdk_app_mesh.types.update_route_output.UpdateRouteOutput, zapros.Response]:
