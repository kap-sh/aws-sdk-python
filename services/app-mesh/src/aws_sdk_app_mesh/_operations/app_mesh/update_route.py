...
) -> aws_sdk_app_mesh.types.update_route_output.UpdateRouteOutput:
    import aws_sdk_app_mesh.types.route_data

    out: aws_sdk_app_mesh.types.update_route_output.UpdateRouteOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.update_route_input.UpdateRouteInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.update_route_input.serialize_json(input_)
    ).encode()
...
def update_route(
    ...
    aws_sdk_app_mesh.types.update_route_output.UpdateRouteOutput, zapros.Response
]:
