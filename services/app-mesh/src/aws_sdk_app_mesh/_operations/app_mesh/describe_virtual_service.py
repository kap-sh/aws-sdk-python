...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.describe_virtual_service_output.DescribeVirtualServiceOutput:
    import aws_sdk_app_mesh.types.virtual_service_data
    out: aws_sdk_app_mesh.types.describe_virtual_service_output.DescribeVirtualServiceOutput = {"virtual_service": aws_sdk_app_mesh.types.virtual_service_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.describe_virtual_service_input.DescribeVirtualServiceInput) -> zapros.Request:
...
def describe_virtual_service(options: OperationOptions, input: aws_sdk_app_mesh.types.describe_virtual_service_input.DescribeVirtualServiceInput) -> tuple[aws_sdk_app_mesh.types.describe_virtual_service_output.DescribeVirtualServiceOutput, zapros.Response]:
...
async def async_describe_virtual_service(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.describe_virtual_service_input.DescribeVirtualServiceInput) -> tuple[aws_sdk_app_mesh.types.describe_virtual_service_output.DescribeVirtualServiceOutput, zapros.Response]:
