...
if TYPE_CHECKING:
    ...
    import aws_sdk_app_mesh.types.update_virtual_router_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.update_virtual_router_output.UpdateVirtualRouterOutput:
    import aws_sdk_app_mesh.types.virtual_router_data
    out: aws_sdk_app_mesh.types.update_virtual_router_output.UpdateVirtualRouterOutput = {"virtual_router": aws_sdk_app_mesh.types.virtual_router_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.update_virtual_router_input.UpdateVirtualRouterInput) -> zapros.Request:
    ...
    import aws_sdk_app_mesh.types.update_virtual_router_input
    body: bytes | None = json.dumps(aws_sdk_app_mesh.types.update_virtual_router_input.serialize_json(input)).encode()
...
def update_virtual_router(options: OperationOptions, input: aws_sdk_app_mesh.types.update_virtual_router_input.UpdateVirtualRouterInput) -> tuple[aws_sdk_app_mesh.types.update_virtual_router_output.UpdateVirtualRouterOutput, zapros.Response]:
...
async def async_update_virtual_router(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.update_virtual_router_input.UpdateVirtualRouterInput) -> tuple[aws_sdk_app_mesh.types.update_virtual_router_output.UpdateVirtualRouterOutput, zapros.Response]:
