...
) -> aws_sdk_app_mesh.types.update_virtual_router_output.UpdateVirtualRouterOutput:
    import aws_sdk_app_mesh.types.virtual_router_data

    out: aws_sdk_app_mesh.types.update_virtual_router_output.UpdateVirtualRouterOutput = {
...
def build_request(
    ...
    input: aws_sdk_app_mesh.types.update_virtual_router_input.UpdateVirtualRouterInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.update_virtual_router_input.serialize_json(input)
    ).encode()
