...
) -> aws_sdk_app_mesh.types.update_gateway_route_output.UpdateGatewayRouteOutput:
    import aws_sdk_app_mesh.types.gateway_route_data

    out: aws_sdk_app_mesh.types.update_gateway_route_output.UpdateGatewayRouteOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.update_gateway_route_input.UpdateGatewayRouteInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.update_gateway_route_input.serialize_json(input_)
    ).encode()
