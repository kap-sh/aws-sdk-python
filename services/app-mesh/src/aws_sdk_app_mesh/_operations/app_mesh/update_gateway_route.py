...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.update_gateway_route_input
    import aws_sdk_app_mesh.types.update_gateway_route_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.update_gateway_route_output.UpdateGatewayRouteOutput:
    import aws_sdk_app_mesh.types.gateway_route_data
    out: aws_sdk_app_mesh.types.update_gateway_route_output.UpdateGatewayRouteOutput = {"gateway_route": aws_sdk_app_mesh.types.gateway_route_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.update_gateway_route_input.UpdateGatewayRouteInput) -> zapros.Request:
    ...
    import aws_sdk_app_mesh.types.update_gateway_route_input
    body: bytes | None = json.dumps(aws_sdk_app_mesh.types.update_gateway_route_input.serialize_json(input)).encode()
...
def update_gateway_route(options: OperationOptions, input: aws_sdk_app_mesh.types.update_gateway_route_input.UpdateGatewayRouteInput) -> tuple[aws_sdk_app_mesh.types.update_gateway_route_output.UpdateGatewayRouteOutput, zapros.Response]:
...
async def async_update_gateway_route(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.update_gateway_route_input.UpdateGatewayRouteInput) -> tuple[aws_sdk_app_mesh.types.update_gateway_route_output.UpdateGatewayRouteOutput, zapros.Response]:
