"""Generated from Smithy shape ``com.amazonaws.appmesh#DescribeGatewayRoute``."""
...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.describe_gateway_route_input
    import aws_sdk_app_mesh.types.describe_gateway_route_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.describe_gateway_route_output.DescribeGatewayRouteOutput:
    import aws_sdk_app_mesh.types.gateway_route_data
    out: aws_sdk_app_mesh.types.describe_gateway_route_output.DescribeGatewayRouteOutput = {"gateway_route": aws_sdk_app_mesh.types.gateway_route_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.describe_gateway_route_input.DescribeGatewayRouteInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v20190125/meshes/{meshName}/virtualGateway/{virtualGatewayName}/gatewayRoutes/{gatewayRouteName}"
    url = url.replace("{gatewayRouteName}", quote(str(input["gateway_route_name"]), safe=""))
    url = url.replace("{meshName}", quote(str(input["mesh_name"]), safe=""))
    url = url.replace("{virtualGatewayName}", quote(str(input["virtual_gateway_name"]), safe=""))
    params: dict[str, str] = {}
...
def describe_gateway_route(options: OperationOptions, input: aws_sdk_app_mesh.types.describe_gateway_route_input.DescribeGatewayRouteInput) -> tuple[aws_sdk_app_mesh.types.describe_gateway_route_output.DescribeGatewayRouteOutput, zapros.Response]:
...
async def async_describe_gateway_route(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.describe_gateway_route_input.DescribeGatewayRouteInput) -> tuple[aws_sdk_app_mesh.types.describe_gateway_route_output.DescribeGatewayRouteOutput, zapros.Response]:
