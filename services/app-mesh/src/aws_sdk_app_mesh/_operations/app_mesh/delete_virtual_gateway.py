...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.delete_virtual_gateway_input
    import aws_sdk_app_mesh.types.delete_virtual_gateway_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.delete_virtual_gateway_output.DeleteVirtualGatewayOutput:
    import aws_sdk_app_mesh.types.virtual_gateway_data
    out: aws_sdk_app_mesh.types.delete_virtual_gateway_output.DeleteVirtualGatewayOutput = {"virtual_gateway": aws_sdk_app_mesh.types.virtual_gateway_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.delete_virtual_gateway_input.DeleteVirtualGatewayInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v20190125/meshes/{meshName}/virtualGateways/{virtualGatewayName}"
...
def delete_virtual_gateway(options: OperationOptions, input: aws_sdk_app_mesh.types.delete_virtual_gateway_input.DeleteVirtualGatewayInput) -> tuple[aws_sdk_app_mesh.types.delete_virtual_gateway_output.DeleteVirtualGatewayOutput, zapros.Response]:
...
async def async_delete_virtual_gateway(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.delete_virtual_gateway_input.DeleteVirtualGatewayInput) -> tuple[aws_sdk_app_mesh.types.delete_virtual_gateway_output.DeleteVirtualGatewayOutput, zapros.Response]:
