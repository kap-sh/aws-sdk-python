...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.untag_resource_input.UntagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.untag_resource_input.serialize_json(input_)
    ).encode()
...
def untag_resource(
    ...
    aws_sdk_app_mesh.types.untag_resource_output.UntagResourceOutput, zapros.Response
]:
