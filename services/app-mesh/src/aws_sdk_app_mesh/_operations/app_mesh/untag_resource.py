...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.untag_resource_output.UntagResourceOutput:
    out: aws_sdk_app_mesh.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.untag_resource_input.UntagResourceInput) -> zapros.Request:
    ...
    import aws_sdk_app_mesh.types.untag_resource_input
    body: bytes | None = json.dumps(aws_sdk_app_mesh.types.untag_resource_input.serialize_json(input)).encode()
...
def untag_resource(options: OperationOptions, input: aws_sdk_app_mesh.types.untag_resource_input.UntagResourceInput) -> tuple[aws_sdk_app_mesh.types.untag_resource_output.UntagResourceOutput, zapros.Response]:
...
async def async_untag_resource(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.untag_resource_input.UntagResourceInput) -> tuple[aws_sdk_app_mesh.types.untag_resource_output.UntagResourceOutput, zapros.Response]:
