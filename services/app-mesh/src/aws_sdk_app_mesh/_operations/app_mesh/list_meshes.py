...
def handle_response(
    ...
    out: aws_sdk_app_mesh.types.list_meshes_output.ListMeshesOutput = (
        aws_sdk_app_mesh.types.list_meshes_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.list_meshes_input.ListMeshesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_meshes(
    ...
    input_: aws_sdk_app_mesh.types.list_meshes_input.ListMeshesInput,
) -> tuple[aws_sdk_app_mesh.types.list_meshes_output.ListMeshesOutput, zapros.Response]:
