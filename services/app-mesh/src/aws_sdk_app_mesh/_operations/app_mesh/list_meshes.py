...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.list_meshes_output.ListMeshesOutput:
    import aws_sdk_app_mesh.types.list_meshes_output
    out: aws_sdk_app_mesh.types.list_meshes_output.ListMeshesOutput = aws_sdk_app_mesh.types.list_meshes_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.list_meshes_input.ListMeshesInput) -> zapros.Request:
...
def list_meshes(options: OperationOptions, input: aws_sdk_app_mesh.types.list_meshes_input.ListMeshesInput) -> tuple[aws_sdk_app_mesh.types.list_meshes_output.ListMeshesOutput, zapros.Response]:
...
async def async_list_meshes(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.list_meshes_input.ListMeshesInput) -> tuple[aws_sdk_app_mesh.types.list_meshes_output.ListMeshesOutput, zapros.Response]:
