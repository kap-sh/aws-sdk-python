"""Generated from Smithy shape ``com.amazonaws.appmesh#CreateRoute``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_app_mesh.types.create_route_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.create_route_output.CreateRouteOutput:
    import aws_sdk_app_mesh.types.route_data
    out: aws_sdk_app_mesh.types.create_route_output.CreateRouteOutput = {"route": aws_sdk_app_mesh.types.route_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.create_route_input.CreateRouteInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v20190125/meshes/{meshName}/virtualRouter/{virtualRouterName}/routes"
    ...
    import aws_sdk_app_mesh.types.create_route_input
    body: bytes | None = json.dumps(aws_sdk_app_mesh.types.create_route_input.serialize_json(input)).encode()
...
def create_route(options: OperationOptions, input: aws_sdk_app_mesh.types.create_route_input.CreateRouteInput) -> tuple[aws_sdk_app_mesh.types.create_route_output.CreateRouteOutput, zapros.Response]:
...
async def async_create_route(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.create_route_input.CreateRouteInput) -> tuple[aws_sdk_app_mesh.types.create_route_output.CreateRouteOutput, zapros.Response]:
