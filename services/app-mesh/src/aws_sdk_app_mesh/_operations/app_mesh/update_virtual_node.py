...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.update_virtual_node_input
    import aws_sdk_app_mesh.types.update_virtual_node_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.update_virtual_node_output.UpdateVirtualNodeOutput:
    import aws_sdk_app_mesh.types.virtual_node_data
    out: aws_sdk_app_mesh.types.update_virtual_node_output.UpdateVirtualNodeOutput = {"virtual_node": aws_sdk_app_mesh.types.virtual_node_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.update_virtual_node_input.UpdateVirtualNodeInput) -> zapros.Request:
    ...
    import aws_sdk_app_mesh.types.update_virtual_node_input
    body: bytes | None = json.dumps(aws_sdk_app_mesh.types.update_virtual_node_input.serialize_json(input)).encode()
...
def update_virtual_node(options: OperationOptions, input: aws_sdk_app_mesh.types.update_virtual_node_input.UpdateVirtualNodeInput) -> tuple[aws_sdk_app_mesh.types.update_virtual_node_output.UpdateVirtualNodeOutput, zapros.Response]:
...
async def async_update_virtual_node(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.update_virtual_node_input.UpdateVirtualNodeInput) -> tuple[aws_sdk_app_mesh.types.update_virtual_node_output.UpdateVirtualNodeOutput, zapros.Response]:
