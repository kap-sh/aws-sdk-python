...
) -> aws_sdk_app_mesh.types.update_virtual_node_output.UpdateVirtualNodeOutput:
    out: aws_sdk_app_mesh.types.update_virtual_node_output.UpdateVirtualNodeOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.update_virtual_node_input.UpdateVirtualNodeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.update_virtual_node_input.serialize_json(input_)
    ).encode()
