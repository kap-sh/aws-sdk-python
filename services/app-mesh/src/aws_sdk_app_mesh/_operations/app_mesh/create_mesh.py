...
def handle_response(
    ...
    out: aws_sdk_app_mesh.types.create_mesh_output.CreateMeshOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.create_mesh_input.CreateMeshInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.create_mesh_input.serialize_json(input_)
    ).encode()
...
def create_mesh(
    ...
    input_: aws_sdk_app_mesh.types.create_mesh_input.CreateMeshInput,
) -> tuple[aws_sdk_app_mesh.types.create_mesh_output.CreateMeshOutput, zapros.Response]:
