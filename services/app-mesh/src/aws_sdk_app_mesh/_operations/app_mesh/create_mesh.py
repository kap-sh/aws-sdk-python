...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.create_mesh_output.CreateMeshOutput:
    import aws_sdk_app_mesh.types.mesh_data
    out: aws_sdk_app_mesh.types.create_mesh_output.CreateMeshOutput = {"mesh": aws_sdk_app_mesh.types.mesh_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.create_mesh_input.CreateMeshInput) -> zapros.Request:
    ...
    import aws_sdk_app_mesh.types.create_mesh_input
    body: bytes | None = json.dumps(aws_sdk_app_mesh.types.create_mesh_input.serialize_json(input)).encode()
...
def create_mesh(options: OperationOptions, input: aws_sdk_app_mesh.types.create_mesh_input.CreateMeshInput) -> tuple[aws_sdk_app_mesh.types.create_mesh_output.CreateMeshOutput, zapros.Response]:
...
async def async_create_mesh(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.create_mesh_input.CreateMeshInput) -> tuple[aws_sdk_app_mesh.types.create_mesh_output.CreateMeshOutput, zapros.Response]:
