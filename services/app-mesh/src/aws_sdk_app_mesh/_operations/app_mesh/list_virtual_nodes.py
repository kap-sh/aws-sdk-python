...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.list_virtual_nodes_input
    import aws_sdk_app_mesh.types.list_virtual_nodes_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.list_virtual_nodes_output.ListVirtualNodesOutput:
    import aws_sdk_app_mesh.types.list_virtual_nodes_output
    out: aws_sdk_app_mesh.types.list_virtual_nodes_output.ListVirtualNodesOutput = aws_sdk_app_mesh.types.list_virtual_nodes_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.list_virtual_nodes_input.ListVirtualNodesInput) -> zapros.Request:
...
def list_virtual_nodes(options: OperationOptions, input: aws_sdk_app_mesh.types.list_virtual_nodes_input.ListVirtualNodesInput) -> tuple[aws_sdk_app_mesh.types.list_virtual_nodes_output.ListVirtualNodesOutput, zapros.Response]:
...
async def async_list_virtual_nodes(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.list_virtual_nodes_input.ListVirtualNodesInput) -> tuple[aws_sdk_app_mesh.types.list_virtual_nodes_output.ListVirtualNodesOutput, zapros.Response]:
