...
) -> aws_sdk_app_mesh.types.list_virtual_nodes_output.ListVirtualNodesOutput:
    import aws_sdk_app_mesh.types.list_virtual_nodes_output

    out: aws_sdk_app_mesh.types.list_virtual_nodes_output.ListVirtualNodesOutput = (
        aws_sdk_app_mesh.types.list_virtual_nodes_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.list_virtual_nodes_input.ListVirtualNodesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
