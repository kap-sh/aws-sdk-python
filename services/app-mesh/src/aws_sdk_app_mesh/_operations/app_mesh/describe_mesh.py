...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.describe_mesh_output.DescribeMeshOutput:
    import aws_sdk_app_mesh.types.mesh_data
    out: aws_sdk_app_mesh.types.describe_mesh_output.DescribeMeshOutput = {"mesh": aws_sdk_app_mesh.types.mesh_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.describe_mesh_input.DescribeMeshInput) -> zapros.Request:
...
def describe_mesh(options: OperationOptions, input: aws_sdk_app_mesh.types.describe_mesh_input.DescribeMeshInput) -> tuple[aws_sdk_app_mesh.types.describe_mesh_output.DescribeMeshOutput, zapros.Response]:
...
async def async_describe_mesh(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.describe_mesh_input.DescribeMeshInput) -> tuple[aws_sdk_app_mesh.types.describe_mesh_output.DescribeMeshOutput, zapros.Response]:
