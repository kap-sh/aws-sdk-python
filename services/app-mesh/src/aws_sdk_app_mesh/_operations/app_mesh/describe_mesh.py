...
def handle_response(
    ...
    out: aws_sdk_app_mesh.types.describe_mesh_output.DescribeMeshOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.describe_mesh_input.DescribeMeshInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_mesh(
    ...
    aws_sdk_app_mesh.types.describe_mesh_output.DescribeMeshOutput, zapros.Response
]:
