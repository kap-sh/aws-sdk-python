...
def handle_response(
    ...
    out: aws_sdk_app_mesh.types.update_mesh_output.UpdateMeshOutput = {
        "mesh": aws_sdk_app_mesh.types.mesh_data.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.update_mesh_input.UpdateMeshInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.update_mesh_input.serialize_json(input_)
    ).encode()
...
def update_mesh(
    ...
    input_: aws_sdk_app_mesh.types.update_mesh_input.UpdateMeshInput,
) -> tuple[aws_sdk_app_mesh.types.update_mesh_output.UpdateMeshOutput, zapros.Response]:
