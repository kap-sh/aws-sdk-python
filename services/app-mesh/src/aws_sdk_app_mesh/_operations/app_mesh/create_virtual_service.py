...
) -> aws_sdk_app_mesh.types.create_virtual_service_output.CreateVirtualServiceOutput:
    import aws_sdk_app_mesh.types.virtual_service_data

    out: aws_sdk_app_mesh.types.create_virtual_service_output.CreateVirtualServiceOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.create_virtual_service_input.CreateVirtualServiceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.create_virtual_service_input.serialize_json(input_)
    ).encode()
