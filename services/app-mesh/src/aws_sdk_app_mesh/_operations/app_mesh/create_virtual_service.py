...
def build_request(
    ...
    input: aws_sdk_app_mesh.types.create_virtual_service_input.CreateVirtualServiceInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.create_virtual_service_input.serialize_json(input)
    ).encode()
