...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.create_virtual_service_input
    import aws_sdk_app_mesh.types.create_virtual_service_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.create_virtual_service_output.CreateVirtualServiceOutput:
    import aws_sdk_app_mesh.types.virtual_service_data
    out: aws_sdk_app_mesh.types.create_virtual_service_output.CreateVirtualServiceOutput = {"virtual_service": aws_sdk_app_mesh.types.virtual_service_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.create_virtual_service_input.CreateVirtualServiceInput) -> zapros.Request:
    ...
    import aws_sdk_app_mesh.types.create_virtual_service_input
    body: bytes | None = json.dumps(aws_sdk_app_mesh.types.create_virtual_service_input.serialize_json(input)).encode()
...
def create_virtual_service(options: OperationOptions, input: aws_sdk_app_mesh.types.create_virtual_service_input.CreateVirtualServiceInput) -> tuple[aws_sdk_app_mesh.types.create_virtual_service_output.CreateVirtualServiceOutput, zapros.Response]:
...
async def async_create_virtual_service(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.create_virtual_service_input.CreateVirtualServiceInput) -> tuple[aws_sdk_app_mesh.types.create_virtual_service_output.CreateVirtualServiceOutput, zapros.Response]:
