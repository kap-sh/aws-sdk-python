...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.update_virtual_service_input.UpdateVirtualServiceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.update_virtual_service_input.serialize_json(input_)
    ).encode()
