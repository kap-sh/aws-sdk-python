...
) -> aws_sdk_app_mesh.types.update_virtual_service_output.UpdateVirtualServiceOutput:
    import aws_sdk_app_mesh.types.virtual_service_data

    out: aws_sdk_app_mesh.types.update_virtual_service_output.UpdateVirtualServiceOutput = {
...
def build_request(
    ...
    input: aws_sdk_app_mesh.types.update_virtual_service_input.UpdateVirtualServiceInput,
) -> zapros.Request:
    ...
    url = url.replace(
        "{virtualServiceName}", quote(str(input["virtual_service_name"]), safe="")
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.update_virtual_service_input.serialize_json(input)
    ).encode()
