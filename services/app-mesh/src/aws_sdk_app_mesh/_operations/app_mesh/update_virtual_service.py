...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.update_virtual_service_input
    import aws_sdk_app_mesh.types.update_virtual_service_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.update_virtual_service_output.UpdateVirtualServiceOutput:
    import aws_sdk_app_mesh.types.virtual_service_data
    out: aws_sdk_app_mesh.types.update_virtual_service_output.UpdateVirtualServiceOutput = {"virtual_service": aws_sdk_app_mesh.types.virtual_service_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.update_virtual_service_input.UpdateVirtualServiceInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v20190125/meshes/{meshName}/virtualServices/{virtualServiceName}"
    url = url.replace("{virtualServiceName}", quote(str(input["virtual_service_name"]), safe=""))
    ...
    import aws_sdk_app_mesh.types.update_virtual_service_input
    body: bytes | None = json.dumps(aws_sdk_app_mesh.types.update_virtual_service_input.serialize_json(input)).encode()
...
def update_virtual_service(options: OperationOptions, input: aws_sdk_app_mesh.types.update_virtual_service_input.UpdateVirtualServiceInput) -> tuple[aws_sdk_app_mesh.types.update_virtual_service_output.UpdateVirtualServiceOutput, zapros.Response]:
...
async def async_update_virtual_service(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.update_virtual_service_input.UpdateVirtualServiceInput) -> tuple[aws_sdk_app_mesh.types.update_virtual_service_output.UpdateVirtualServiceOutput, zapros.Response]:
