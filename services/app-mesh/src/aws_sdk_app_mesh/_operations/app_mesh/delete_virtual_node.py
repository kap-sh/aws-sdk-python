...
) -> aws_sdk_app_mesh.types.delete_virtual_node_output.DeleteVirtualNodeOutput:
    import aws_sdk_app_mesh.types.virtual_node_data

    out: aws_sdk_app_mesh.types.delete_virtual_node_output.DeleteVirtualNodeOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.delete_virtual_node_input.DeleteVirtualNodeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
