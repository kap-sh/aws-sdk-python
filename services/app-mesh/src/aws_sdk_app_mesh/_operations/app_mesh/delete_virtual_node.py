...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.delete_virtual_node_input
    import aws_sdk_app_mesh.types.delete_virtual_node_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.delete_virtual_node_output.DeleteVirtualNodeOutput:
    import aws_sdk_app_mesh.types.virtual_node_data
    out: aws_sdk_app_mesh.types.delete_virtual_node_output.DeleteVirtualNodeOutput = {"virtual_node": aws_sdk_app_mesh.types.virtual_node_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.delete_virtual_node_input.DeleteVirtualNodeInput) -> zapros.Request:
...
def delete_virtual_node(options: OperationOptions, input: aws_sdk_app_mesh.types.delete_virtual_node_input.DeleteVirtualNodeInput) -> tuple[aws_sdk_app_mesh.types.delete_virtual_node_output.DeleteVirtualNodeOutput, zapros.Response]:
...
async def async_delete_virtual_node(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.delete_virtual_node_input.DeleteVirtualNodeInput) -> tuple[aws_sdk_app_mesh.types.delete_virtual_node_output.DeleteVirtualNodeOutput, zapros.Response]:
