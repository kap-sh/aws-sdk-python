...
) -> aws_sdk_app_mesh.types.list_virtual_routers_output.ListVirtualRoutersOutput:
    import aws_sdk_app_mesh.types.list_virtual_routers_output

    out: aws_sdk_app_mesh.types.list_virtual_routers_output.ListVirtualRoutersOutput = (
        aws_sdk_app_mesh.types.list_virtual_routers_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.list_virtual_routers_input.ListVirtualRoutersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
