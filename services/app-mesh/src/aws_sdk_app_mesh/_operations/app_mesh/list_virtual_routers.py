...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.list_virtual_routers_input
    import aws_sdk_app_mesh.types.list_virtual_routers_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.list_virtual_routers_output.ListVirtualRoutersOutput:
    import aws_sdk_app_mesh.types.list_virtual_routers_output
    out: aws_sdk_app_mesh.types.list_virtual_routers_output.ListVirtualRoutersOutput = aws_sdk_app_mesh.types.list_virtual_routers_output.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.list_virtual_routers_input.ListVirtualRoutersInput) -> zapros.Request:
...
def list_virtual_routers(options: OperationOptions, input: aws_sdk_app_mesh.types.list_virtual_routers_input.ListVirtualRoutersInput) -> tuple[aws_sdk_app_mesh.types.list_virtual_routers_output.ListVirtualRoutersOutput, zapros.Response]:
...
async def async_list_virtual_routers(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.list_virtual_routers_input.ListVirtualRoutersInput) -> tuple[aws_sdk_app_mesh.types.list_virtual_routers_output.ListVirtualRoutersOutput, zapros.Response]:
