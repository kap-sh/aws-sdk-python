...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            ...
            raise aws_sdk_app_mesh.errors.too_many_tags_exception.TooManyTagsException.from_json(data)
        case _:
            raise UnknownServiceError(code=code, message=message, response=response)

def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.tag_resource_output.TagResourceOutput:
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.tag_resource_input.TagResourceInput) -> zapros.Request:
    ...
    import aws_sdk_app_mesh.types.tag_resource_input
    body: bytes | None = json.dumps(aws_sdk_app_mesh.types.tag_resource_input.serialize_json(input)).encode()
...
def tag_resource(options: OperationOptions, input: aws_sdk_app_mesh.types.tag_resource_input.TagResourceInput) -> tuple[aws_sdk_app_mesh.types.tag_resource_output.TagResourceOutput, zapros.Response]:
...
async def async_tag_resource(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.tag_resource_input.TagResourceInput) -> tuple[aws_sdk_app_mesh.types.tag_resource_output.TagResourceOutput, zapros.Response]:
