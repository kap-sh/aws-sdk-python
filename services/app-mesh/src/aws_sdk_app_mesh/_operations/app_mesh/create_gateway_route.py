...
) -> aws_sdk_app_mesh.types.create_gateway_route_output.CreateGatewayRouteOutput:
    import aws_sdk_app_mesh.types.gateway_route_data

    out: aws_sdk_app_mesh.types.create_gateway_route_output.CreateGatewayRouteOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.create_gateway_route_input.CreateGatewayRouteInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.create_gateway_route_input.serialize_json(input_)
    ).encode()
...
async def async_create_gateway_route(
