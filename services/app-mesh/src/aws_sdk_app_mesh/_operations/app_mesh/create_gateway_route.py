"""Generated from Smithy shape ``com.amazonaws.appmesh#CreateGatewayRoute``."""
...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.create_gateway_route_input
    import aws_sdk_app_mesh.types.create_gateway_route_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.create_gateway_route_output.CreateGatewayRouteOutput:
    import aws_sdk_app_mesh.types.gateway_route_data
    out: aws_sdk_app_mesh.types.create_gateway_route_output.CreateGatewayRouteOutput = {"gateway_route": aws_sdk_app_mesh.types.gateway_route_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.create_gateway_route_input.CreateGatewayRouteInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v20190125/meshes/{meshName}/virtualGateway/{virtualGatewayName}/gatewayRoutes"
    ...
    import aws_sdk_app_mesh.types.create_gateway_route_input
    body: bytes | None = json.dumps(aws_sdk_app_mesh.types.create_gateway_route_input.serialize_json(input)).encode()
...
def create_gateway_route(options: OperationOptions, input: aws_sdk_app_mesh.types.create_gateway_route_input.CreateGatewayRouteInput) -> tuple[aws_sdk_app_mesh.types.create_gateway_route_output.CreateGatewayRouteOutput, zapros.Response]:
...
async def async_create_gateway_route(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.create_gateway_route_input.CreateGatewayRouteInput) -> tuple[aws_sdk_app_mesh.types.create_gateway_route_output.CreateGatewayRouteOutput, zapros.Response]:
