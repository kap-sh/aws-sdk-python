...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.create_virtual_router_input
    import aws_sdk_app_mesh.types.create_virtual_router_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.create_virtual_router_output.CreateVirtualRouterOutput:
    import aws_sdk_app_mesh.types.virtual_router_data
    out: aws_sdk_app_mesh.types.create_virtual_router_output.CreateVirtualRouterOutput = {"virtual_router": aws_sdk_app_mesh.types.virtual_router_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.create_virtual_router_input.CreateVirtualRouterInput) -> zapros.Request:
    ...
    import aws_sdk_app_mesh.types.create_virtual_router_input
    body: bytes | None = json.dumps(aws_sdk_app_mesh.types.create_virtual_router_input.serialize_json(input)).encode()
...
def create_virtual_router(options: OperationOptions, input: aws_sdk_app_mesh.types.create_virtual_router_input.CreateVirtualRouterInput) -> tuple[aws_sdk_app_mesh.types.create_virtual_router_output.CreateVirtualRouterOutput, zapros.Response]:
...
async def async_create_virtual_router(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.create_virtual_router_input.CreateVirtualRouterInput) -> tuple[aws_sdk_app_mesh.types.create_virtual_router_output.CreateVirtualRouterOutput, zapros.Response]:
