...
def build_request(
    ...
    input: aws_sdk_app_mesh.types.create_virtual_router_input.CreateVirtualRouterInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.create_virtual_router_input.serialize_json(input)
    ).encode()
