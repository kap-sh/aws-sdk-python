...
) -> aws_sdk_app_mesh.types.create_virtual_router_output.CreateVirtualRouterOutput:
    out: aws_sdk_app_mesh.types.create_virtual_router_output.CreateVirtualRouterOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.create_virtual_router_input.CreateVirtualRouterInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_app_mesh.types.create_virtual_router_input.serialize_json(input_)
    ).encode()
