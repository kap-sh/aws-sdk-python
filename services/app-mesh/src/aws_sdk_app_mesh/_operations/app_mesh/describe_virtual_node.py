...
) -> aws_sdk_app_mesh.types.describe_virtual_node_output.DescribeVirtualNodeOutput:
    import aws_sdk_app_mesh.types.virtual_node_data

    out: aws_sdk_app_mesh.types.describe_virtual_node_output.DescribeVirtualNodeOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.describe_virtual_node_input.DescribeVirtualNodeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_virtual_node(
