"""Generated from Smithy shape ``com.amazonaws.appmesh#DescribeVirtualNode``."""
...
if TYPE_CHECKING:
    import aws_sdk_app_mesh.types.describe_virtual_node_input
    import aws_sdk_app_mesh.types.describe_virtual_node_output
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.describe_virtual_node_output.DescribeVirtualNodeOutput:
    import aws_sdk_app_mesh.types.virtual_node_data
    out: aws_sdk_app_mesh.types.describe_virtual_node_output.DescribeVirtualNodeOutput = {"virtual_node": aws_sdk_app_mesh.types.virtual_node_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.describe_virtual_node_input.DescribeVirtualNodeInput) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v20190125/meshes/{meshName}/virtualNodes/{virtualNodeName}"
    url = url.replace("{virtualNodeName}", quote(str(input["virtual_node_name"]), safe=""))
...
def describe_virtual_node(options: OperationOptions, input: aws_sdk_app_mesh.types.describe_virtual_node_input.DescribeVirtualNodeInput) -> tuple[aws_sdk_app_mesh.types.describe_virtual_node_output.DescribeVirtualNodeOutput, zapros.Response]:
...
async def async_describe_virtual_node(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.describe_virtual_node_input.DescribeVirtualNodeInput) -> tuple[aws_sdk_app_mesh.types.describe_virtual_node_output.DescribeVirtualNodeOutput, zapros.Response]:
