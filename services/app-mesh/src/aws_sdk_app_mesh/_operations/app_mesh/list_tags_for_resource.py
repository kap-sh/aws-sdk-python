...
def handle_response(
    ...
    out: aws_sdk_app_mesh.types.list_tags_for_resource_output.ListTagsForResourceOutput = aws_sdk_app_mesh.types.list_tags_for_resource_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.list_tags_for_resource_input.ListTagsForResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
