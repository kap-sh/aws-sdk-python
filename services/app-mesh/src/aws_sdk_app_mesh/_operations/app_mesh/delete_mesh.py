...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_app_mesh.types.delete_mesh_output.DeleteMeshOutput:
    import aws_sdk_app_mesh.types.mesh_data
    out: aws_sdk_app_mesh.types.delete_mesh_output.DeleteMeshOutput = {"mesh": aws_sdk_app_mesh.types.mesh_data.deserialize_json(json.loads(response.read()))}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_app_mesh.types.delete_mesh_input.DeleteMeshInput) -> zapros.Request:
...
def delete_mesh(options: OperationOptions, input: aws_sdk_app_mesh.types.delete_mesh_input.DeleteMeshInput) -> tuple[aws_sdk_app_mesh.types.delete_mesh_output.DeleteMeshOutput, zapros.Response]:
...
async def async_delete_mesh(options: AsyncOperationOptions, input: aws_sdk_app_mesh.types.delete_mesh_input.DeleteMeshInput) -> tuple[aws_sdk_app_mesh.types.delete_mesh_output.DeleteMeshOutput, zapros.Response]:
