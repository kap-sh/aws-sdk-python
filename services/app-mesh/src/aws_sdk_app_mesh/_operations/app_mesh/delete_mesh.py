...
def handle_response(
    ...
    out: aws_sdk_app_mesh.types.delete_mesh_output.DeleteMeshOutput = {
...
def build_request(
    ...
    input_: aws_sdk_app_mesh.types.delete_mesh_input.DeleteMeshInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_mesh(
    ...
    input_: aws_sdk_app_mesh.types.delete_mesh_input.DeleteMeshInput,
) -> tuple[aws_sdk_app_mesh.types.delete_mesh_output.DeleteMeshOutput, zapros.Response]:
