...
if TYPE_CHECKING:
    import capo_app_mesh.types.virtual_router_status_code


class VirtualRouterStatus(TypedDict, closed=True):
    status: "capo_app_mesh.types.virtual_router_status_code.VirtualRouterStatusCode"
