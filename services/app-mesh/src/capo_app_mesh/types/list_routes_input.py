"""Generated from Smithy shape ``com.amazonaws.appmesh#ListRoutesInput``."""
...
class ListRoutesInput(TypedDict, closed=True):
    ...
    limit: NotRequired["capo_app_mesh.types.list_routes_limit.ListRoutesLimit"]
...
# --- restJson1 ser/de ---
def serialize_json(value: ListRoutesInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListRoutesInput:
    out: ListRoutesInput = {}  # type: ignore[typeddict-item]
    return out
