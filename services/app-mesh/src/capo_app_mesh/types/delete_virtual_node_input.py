"""Generated from Smithy shape ``com.amazonaws.appmesh#DeleteVirtualNodeInput``."""
...
class DeleteVirtualNodeInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteVirtualNodeInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> DeleteVirtualNodeInput:
    out: DeleteVirtualNodeInput = {}  # type: ignore[typeddict-item]
    return out
