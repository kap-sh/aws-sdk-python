...
class CloudTrailDataError(Exception):
    """Base class for all CloudTrailData service errors."""


class ServiceError(CloudTrailDataError):
...
class SerializationError(CloudTrailDataError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CloudTrailDataError):
...
class WaiterFailedError(CloudTrailDataError):
...
class WaiterTimeoutError(CloudTrailDataError):
