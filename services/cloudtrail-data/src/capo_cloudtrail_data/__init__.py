...
from ._services.async_cloud_trail_data import (
    AsyncCloudTrailDataClient as AsyncCloudTrailDataClient,
)
from ._services.cloud_trail_data import CloudTrailDataClient as CloudTrailDataClient
