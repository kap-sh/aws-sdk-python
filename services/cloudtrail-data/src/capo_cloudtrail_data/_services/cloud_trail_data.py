...
from capo_cloudtrail_data._services._aws_config import aws_config
...
class CloudTrailDataClientConfig(TypedDict, total=False, closed=True):
...
class CloudTrailDataClient:
    ...
    def __init__(
        ...
        self._config = CloudTrailDataClientConfig(
            {
    ...
    def put_audit_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudtrail_data.types.put_audit_events_request.PutAuditEventsRequest]",
        ) -> OperationResponse[
            "capo_cloudtrail_data.types.put_audit_events_response.PutAuditEventsResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudtrail_data._operations.cloud_trail_data_service.put_audit_events.put_audit_events(
