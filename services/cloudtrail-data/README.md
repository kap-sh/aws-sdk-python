...
```
pip install aws-sdk-cloudtrail-data
```

## Usage

```python
from aws_sdk_cloudtrail_data import AsyncCloudTrailDataClient
...
```python
from aws_sdk_cloudtrail_data import AsyncCloudTrailDataClient
from aws_sdk_cloudtrail_data.error import ChannelInsufficientPermission
