...
def test_1_control_plane_operation_in_us_east_1__aw():
...
def test_2_control_plane_operation_in_cn_north_1__a():
...
def test_3_data_plane_operation_in_us_east_1():
...
def test_4_data_plane_operation_in_us_east_1__iscon():
...
def test_5_data_plane_operation_in_cn_north_1():
...
def test_6_data_plane_operation_in_us_gov_west_1():
...
def test_7_fips_endpoint_in_us_gov_west_1__global_e():
...
def test_8_fips_endpoint_in_us_gov_east_1__regional():
...
def test_9_fips_endpoint_in_us_east_1():
...
def test_10_dualstack_falls_through_to_default_sdk_e():
...
def test_11_dualstack_falls_through_to_default_sdk_e():
...
def test_12_dualstack_falls_through_to_default_sdk_e():
...
def test_13_custom_sdk_endpoint_override():
    ...
    params = EndpointParams(
        Region='us-east-1',
        Endpoint='https://custom.signin.example.com',
        UseFIPS=False,
        UseDualStack=False,
    )
...
def test_14_iso_partition__us_iso_east_1_():
...
def test_15_iso_b_partition__us_isob_east_1_():
