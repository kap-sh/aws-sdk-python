...
class PutResourcePermissionStatementInput(TypedDict, closed=True):
    ...
    console_source_vpce: NotRequired["aws_sdk_signin.types.source_vpce.SourceVpce"]
    """Console VPC endpoint identifier"""
    vpc_source_ip: NotRequired["aws_sdk_signin.types.vpc_source_ip.VpcSourceIp"]
    """Source IP address within VPC"""
    source_ip: NotRequired["aws_sdk_signin.types.source_ip.SourceIp"]
    """Source IP address"""
    requested_region: NotRequired[
