...
from aws_sdk_signin._async import anysleep
from aws_sdk_signin._auth._providers import CredentialsProvider
from aws_sdk_signin.errors import ServiceError
...
class OperationOptions:
    ...
    is_control_plane: bool | None = None
