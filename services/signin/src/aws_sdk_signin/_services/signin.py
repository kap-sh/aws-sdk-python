...
from aws_sdk_signin._services._aws_config import aws_config
...
class SigninClientConfig(TypedDict, total=False):
...
class SigninClient:
    ...
    def create_o_auth2_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_signin.types.create_o_auth2_token_request.CreateOAuth2TokenRequest]",
        ) -> OperationResponse[
            "aws_sdk_signin.types.create_o_auth2_token_response.CreateOAuth2TokenResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_signin._operations.signin.create_o_auth2_token.create_o_auth2_token(
    ...
    def delete_console_authorization_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_signin.types.delete_console_authorization_configuration_input.DeleteConsoleAuthorizationConfigurationInput]",
        ) -> OperationResponse[
            "aws_sdk_signin.types.delete_console_authorization_configuration_output.DeleteConsoleAuthorizationConfigurationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_signin._operations.signin.delete_console_authorization_configuration.delete_console_authorization_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_resource_permission_statement(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_signin.types.delete_resource_permission_statement_input.DeleteResourcePermissionStatementInput]",
        ) -> OperationResponse[
            "aws_sdk_signin.types.delete_resource_permission_statement_output.DeleteResourcePermissionStatementOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_signin._operations.signin.delete_resource_permission_statement.delete_resource_permission_statement(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_console_authorization_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_signin.types.get_console_authorization_configuration_input.GetConsoleAuthorizationConfigurationInput]",
        ) -> OperationResponse[
            "aws_sdk_signin.types.get_console_authorization_configuration_output.GetConsoleAuthorizationConfigurationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_signin._operations.signin.get_console_authorization_configuration.get_console_authorization_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_policy(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_signin.types.get_resource_policy_input.GetResourcePolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_signin.types.get_resource_policy_output.GetResourcePolicyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_signin._operations.signin.get_resource_policy.get_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_resource_permission_statements(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_signin.types.list_resource_permission_statements_input.ListResourcePermissionStatementsInput]",
        ) -> OperationResponse[
            "aws_sdk_signin.types.list_resource_permission_statements_output.ListResourcePermissionStatementsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_signin._operations.signin.list_resource_permission_statements.list_resource_permission_statements(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_resource_permission_statements(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_signin.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_signin.types.permission_statement_summary.PermissionStatementSummary]":
        _token = next_token
        while True:
    ...
    def put_console_authorization_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_signin.types.put_console_authorization_configuration_input.PutConsoleAuthorizationConfigurationInput]",
        ) -> OperationResponse[
            "aws_sdk_signin.types.put_console_authorization_configuration_output.PutConsoleAuthorizationConfigurationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_signin._operations.signin.put_console_authorization_configuration.put_console_authorization_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_resource_permission_statement(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_signin.types.put_resource_permission_statement_input.PutResourcePermissionStatementInput]",
        ) -> OperationResponse[
            "aws_sdk_signin.types.put_resource_permission_statement_output.PutResourcePermissionStatementOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_signin._operations.signin.put_resource_permission_statement.put_resource_permission_statement(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
