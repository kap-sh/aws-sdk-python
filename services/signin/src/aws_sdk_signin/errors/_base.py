...
class SigninError(Exception):
    """Base class for all Signin service errors."""


class ServiceError(SigninError):
...
class SerializationError(SigninError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SigninError):
...
class WaiterFailedError(SigninError):
...
class WaiterTimeoutError(SigninError):
