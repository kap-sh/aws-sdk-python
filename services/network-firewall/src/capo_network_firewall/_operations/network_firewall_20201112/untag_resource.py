...
def handle_response(
    ...
    out: capo_network_firewall.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.untag_resource_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
