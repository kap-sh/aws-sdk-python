...
import capo_network_firewall.errors.insufficient_capacity_exception
import capo_network_firewall.errors.internal_server_error
import capo_network_firewall.errors.invalid_operation_exception
import capo_network_firewall.errors.invalid_request_exception
import capo_network_firewall.errors.limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InsufficientCapacityException":
            raise capo_network_firewall.errors.insufficient_capacity_exception.InsufficientCapacityException.from_aws_json_1_0(
                data
            )
        ...
        case "InvalidOperationException":
            raise capo_network_firewall.errors.invalid_operation_exception.InvalidOperationException.from_aws_json_1_0(
                data
            )
        ...
        case "LimitExceededException":
            raise capo_network_firewall.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_network_firewall.types.create_vpc_endpoint_association_response.CreateVpcEndpointAssociationResponse = capo_network_firewall.types.create_vpc_endpoint_association_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.create_vpc_endpoint_association_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
