"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DeleteProxy``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.delete_proxy_response.DeleteProxyResponse = (
        capo_network_firewall.types.delete_proxy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.DeleteProxy"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.delete_proxy_request.serialize_aws_json_1_0(input_)
    ).encode()
