"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DescribeProxy``."""
...
import capo_network_firewall.types.describe_proxy_resource
...
def handle_response(
    ...
    out: capo_network_firewall.types.describe_proxy_response.DescribeProxyResponse = (
        capo_network_firewall.types.describe_proxy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.DescribeProxy"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.describe_proxy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_describe_proxy(
