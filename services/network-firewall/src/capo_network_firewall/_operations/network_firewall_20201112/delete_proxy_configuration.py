"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DeleteProxyConfiguration``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.delete_proxy_configuration_response.DeleteProxyConfigurationResponse = capo_network_firewall.types.delete_proxy_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.DeleteProxyConfiguration"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.delete_proxy_configuration_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_proxy_configuration(
