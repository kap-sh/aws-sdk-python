"""Generated from Smithy shape ``com.amazonaws.networkfirewall#CreateProxyConfiguration``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.create_proxy_configuration_response.CreateProxyConfigurationResponse = capo_network_firewall.types.create_proxy_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.CreateProxyConfiguration"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.create_proxy_configuration_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_proxy_configuration(
