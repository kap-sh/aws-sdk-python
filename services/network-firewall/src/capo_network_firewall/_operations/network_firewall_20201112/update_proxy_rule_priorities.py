"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UpdateProxyRulePriorities``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.update_proxy_rule_priorities_response.UpdateProxyRulePrioritiesResponse = capo_network_firewall.types.update_proxy_rule_priorities_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.UpdateProxyRulePriorities"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.update_proxy_rule_priorities_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_proxy_rule_priorities(
