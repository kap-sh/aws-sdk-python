"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UpdateProxy``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.update_proxy_response.UpdateProxyResponse = (
        capo_network_firewall.types.update_proxy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.UpdateProxy"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.update_proxy_request.serialize_aws_json_1_0(input_)
    ).encode()
