...
def handle_response(
    ...
    out: capo_network_firewall.types.update_firewall_policy_change_protection_response.UpdateFirewallPolicyChangeProtectionResponse = capo_network_firewall.types.update_firewall_policy_change_protection_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.update_firewall_policy_change_protection_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
