...
def handle_response(
    ...
    out: capo_network_firewall.types.start_analysis_report_response.StartAnalysisReportResponse = capo_network_firewall.types.start_analysis_report_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.start_analysis_report_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
