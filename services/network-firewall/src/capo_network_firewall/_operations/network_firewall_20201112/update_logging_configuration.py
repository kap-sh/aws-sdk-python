...
import capo_network_firewall.errors.log_destination_permission_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LogDestinationPermissionException":
            raise capo_network_firewall.errors.log_destination_permission_exception.LogDestinationPermissionException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_network_firewall.types.update_logging_configuration_response.UpdateLoggingConfigurationResponse = capo_network_firewall.types.update_logging_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.update_logging_configuration_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
