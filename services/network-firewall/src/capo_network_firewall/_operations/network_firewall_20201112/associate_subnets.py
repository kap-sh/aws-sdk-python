"""Generated from Smithy shape ``com.amazonaws.networkfirewall#AssociateSubnets``."""
...
import capo_network_firewall.errors.invalid_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTokenException":
            raise capo_network_firewall.errors.invalid_token_exception.InvalidTokenException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_network_firewall.types.associate_subnets_response.AssociateSubnetsResponse = capo_network_firewall.types.associate_subnets_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.AssociateSubnets"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.associate_subnets_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_associate_subnets(
