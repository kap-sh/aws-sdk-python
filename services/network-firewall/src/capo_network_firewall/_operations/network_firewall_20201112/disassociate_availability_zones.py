"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DisassociateAvailabilityZones``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.disassociate_availability_zones_response.DisassociateAvailabilityZonesResponse = capo_network_firewall.types.disassociate_availability_zones_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.DisassociateAvailabilityZones"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.disassociate_availability_zones_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_disassociate_availability_zones(
