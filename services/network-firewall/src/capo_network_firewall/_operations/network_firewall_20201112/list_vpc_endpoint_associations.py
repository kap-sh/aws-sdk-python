...
def handle_response(
    ...
    out: capo_network_firewall.types.list_vpc_endpoint_associations_response.ListVpcEndpointAssociationsResponse = capo_network_firewall.types.list_vpc_endpoint_associations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.list_vpc_endpoint_associations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
