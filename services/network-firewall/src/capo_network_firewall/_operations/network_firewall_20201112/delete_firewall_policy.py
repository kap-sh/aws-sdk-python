...
import capo_network_firewall.errors.unsupported_operation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnsupportedOperationException":
            raise capo_network_firewall.errors.unsupported_operation_exception.UnsupportedOperationException.from_aws_json_1_0(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_network_firewall.types.delete_firewall_policy_response.DeleteFirewallPolicyResponse = capo_network_firewall.types.delete_firewall_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.delete_firewall_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
