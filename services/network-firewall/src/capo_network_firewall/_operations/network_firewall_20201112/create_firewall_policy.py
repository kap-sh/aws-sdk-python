...
def handle_response(
    ...
    out: capo_network_firewall.types.create_firewall_policy_response.CreateFirewallPolicyResponse = capo_network_firewall.types.create_firewall_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.create_firewall_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
