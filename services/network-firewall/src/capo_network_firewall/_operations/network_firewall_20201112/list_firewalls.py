...
import capo_network_firewall.types.firewalls
...
def handle_response(
    ...
    out: capo_network_firewall.types.list_firewalls_response.ListFirewallsResponse = (
        capo_network_firewall.types.list_firewalls_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.list_firewalls_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
