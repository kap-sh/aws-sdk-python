...
def handle_response(
    ...
    out: capo_network_firewall.types.update_proxy_configuration_response.UpdateProxyConfigurationResponse = capo_network_firewall.types.update_proxy_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.update_proxy_configuration_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
