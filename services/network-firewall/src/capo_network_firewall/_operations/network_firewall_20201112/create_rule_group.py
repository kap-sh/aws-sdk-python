...
def handle_response(
    ...
    out: capo_network_firewall.types.create_rule_group_response.CreateRuleGroupResponse = capo_network_firewall.types.create_rule_group_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.create_rule_group_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
