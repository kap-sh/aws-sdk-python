"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UpdateFirewallPolicy``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.update_firewall_policy_response.UpdateFirewallPolicyResponse = capo_network_firewall.types.update_firewall_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.UpdateFirewallPolicy"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.update_firewall_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_firewall_policy(
