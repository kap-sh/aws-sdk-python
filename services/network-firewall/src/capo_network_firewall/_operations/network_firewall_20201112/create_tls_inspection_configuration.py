"""Generated from Smithy shape ``com.amazonaws.networkfirewall#CreateTLSInspectionConfiguration``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.create_tls_inspection_configuration_response.CreateTLSInspectionConfigurationResponse = capo_network_firewall.types.create_tls_inspection_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.create_tls_inspection_configuration_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_tls_inspection_configuration(
