"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DeleteFirewall``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.delete_firewall_response.DeleteFirewallResponse = (
        capo_network_firewall.types.delete_firewall_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.DeleteFirewall"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.delete_firewall_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_firewall(
