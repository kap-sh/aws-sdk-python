"""Generated from Smithy shape ``com.amazonaws.networkfirewall#ListTLSInspectionConfigurations``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.list_tls_inspection_configurations_response.ListTLSInspectionConfigurationsResponse = capo_network_firewall.types.list_tls_inspection_configurations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.ListTLSInspectionConfigurations"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.list_tls_inspection_configurations_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_tls_inspection_configurations(
