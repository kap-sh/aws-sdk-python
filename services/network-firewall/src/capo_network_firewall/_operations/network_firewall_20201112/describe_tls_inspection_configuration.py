"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DescribeTLSInspectionConfiguration``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.describe_tls_inspection_configuration_response.DescribeTLSInspectionConfigurationResponse = capo_network_firewall.types.describe_tls_inspection_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.describe_tls_inspection_configuration_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_describe_tls_inspection_configuration(
