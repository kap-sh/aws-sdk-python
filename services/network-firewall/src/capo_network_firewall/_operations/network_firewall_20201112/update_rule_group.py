"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UpdateRuleGroup``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.update_rule_group_response.UpdateRuleGroupResponse = capo_network_firewall.types.update_rule_group_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.UpdateRuleGroup"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.update_rule_group_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
