...
def handle_response(
    ...
    out: capo_network_firewall.types.reject_network_firewall_transit_gateway_attachment_response.RejectNetworkFirewallTransitGatewayAttachmentResponse = capo_network_firewall.types.reject_network_firewall_transit_gateway_attachment_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.reject_network_firewall_transit_gateway_attachment_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
