"""Generated from Smithy shape ``com.amazonaws.networkfirewall#PutResourcePolicy``."""
...
import capo_network_firewall.errors.invalid_resource_policy_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResourcePolicyException":
            raise capo_network_firewall.errors.invalid_resource_policy_exception.InvalidResourcePolicyException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_network_firewall.types.put_resource_policy_response.PutResourcePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.PutResourcePolicy"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.put_resource_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
