...
def handle_response(
    ...
    out: capo_network_firewall.types.get_analysis_report_results_response.GetAnalysisReportResultsResponse = capo_network_firewall.types.get_analysis_report_results_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.get_analysis_report_results_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
