"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UpdateAvailabilityZoneChangeProtection``."""
...
import capo_network_firewall.errors.resource_owner_check_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceOwnerCheckException":
            raise capo_network_firewall.errors.resource_owner_check_exception.ResourceOwnerCheckException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_network_firewall.types.update_availability_zone_change_protection_response.UpdateAvailabilityZoneChangeProtectionResponse = capo_network_firewall.types.update_availability_zone_change_protection_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.update_availability_zone_change_protection_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_update_availability_zone_change_protection(
