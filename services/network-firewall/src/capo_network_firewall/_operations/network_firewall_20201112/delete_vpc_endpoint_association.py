...
def handle_response(
    ...
    out: capo_network_firewall.types.delete_vpc_endpoint_association_response.DeleteVpcEndpointAssociationResponse = capo_network_firewall.types.delete_vpc_endpoint_association_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.delete_vpc_endpoint_association_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
