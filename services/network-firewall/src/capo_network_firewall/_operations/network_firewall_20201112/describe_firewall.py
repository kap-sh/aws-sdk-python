"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DescribeFirewall``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.describe_firewall_response.DescribeFirewallResponse = capo_network_firewall.types.describe_firewall_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.DescribeFirewall"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.describe_firewall_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_describe_firewall(
