"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DescribeProxyRuleGroup``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.describe_proxy_rule_group_response.DescribeProxyRuleGroupResponse = capo_network_firewall.types.describe_proxy_rule_group_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.DescribeProxyRuleGroup"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.describe_proxy_rule_group_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_describe_proxy_rule_group(
