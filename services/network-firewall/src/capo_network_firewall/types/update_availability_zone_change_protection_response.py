"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UpdateAvailabilityZoneChangeProtectionResponse``."""
...
class UpdateAvailabilityZoneChangeProtectionResponse(TypedDict, closed=True):
...
def serialize_aws_json_1_0(
    value: UpdateAvailabilityZoneChangeProtectionResponse,
) -> dict:
    out: dict = {}
