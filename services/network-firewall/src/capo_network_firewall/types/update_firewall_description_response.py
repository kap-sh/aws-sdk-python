"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UpdateFirewallDescriptionResponse``."""
...
class UpdateFirewallDescriptionResponse(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: UpdateFirewallDescriptionResponse) -> dict:
    out: dict = {}
