...
def deserialize_aws_json_1_0(
    ...
    if "TransitGatewayAttachmentStatus" in data:
        ...
        raise DeserializationError(
            "DeleteNetworkFirewallTransitGatewayAttachmentResponse.transit_gateway_attachment_status required"
        )
    return out
