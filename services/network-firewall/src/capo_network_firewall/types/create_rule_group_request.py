...
def serialize_aws_json_1_0(value: CreateRuleGroupRequest) -> dict:
    ...
    out["Type"] = capo_network_firewall.types.rule_group_type.serialize_aws_json_1_0(
        value["type"]
    )
