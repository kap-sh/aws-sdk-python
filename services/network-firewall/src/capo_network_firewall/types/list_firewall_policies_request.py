"""Generated from Smithy shape ``com.amazonaws.networkfirewall#ListFirewallPoliciesRequest``."""
...
class ListFirewallPoliciesRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListFirewallPoliciesRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> ListFirewallPoliciesRequest:
    out: ListFirewallPoliciesRequest = {}  # type: ignore[typeddict-item]
