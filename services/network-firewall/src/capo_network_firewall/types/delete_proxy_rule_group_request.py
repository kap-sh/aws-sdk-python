"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DeleteProxyRuleGroupRequest``."""
...
class DeleteProxyRuleGroupRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DeleteProxyRuleGroupRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> DeleteProxyRuleGroupRequest:
    out: DeleteProxyRuleGroupRequest = {}  # type: ignore[typeddict-item]
