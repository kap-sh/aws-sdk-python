"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UpdateFirewallPolicyChangeProtectionResponse``."""
...
class UpdateFirewallPolicyChangeProtectionResponse(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: UpdateFirewallPolicyChangeProtectionResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(
    ...
    out: UpdateFirewallPolicyChangeProtectionResponse = {}  # type: ignore[typeddict-item]
