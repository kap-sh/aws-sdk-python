"""Generated from Smithy shape ``com.amazonaws.networkfirewall#ListProxyRuleGroupsRequest``."""
...
class ListProxyRuleGroupsRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListProxyRuleGroupsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> ListProxyRuleGroupsRequest:
    out: ListProxyRuleGroupsRequest = {}  # type: ignore[typeddict-item]
