...
from ._services.async_network_firewall import (
    AsyncNetworkFirewallClient as AsyncNetworkFirewallClient,
)
from ._services.network_firewall import NetworkFirewallClient as NetworkFirewallClient
