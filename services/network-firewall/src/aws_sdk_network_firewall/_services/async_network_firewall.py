...
from aws_sdk_network_firewall._auth._zapros_handler import AuthMiddleware
from aws_sdk_network_firewall._pagination import resolve_path as _resolve_path
...
if TYPE_CHECKING:
    ...
    import aws_sdk_network_firewall.types.associate_subnets_request
    import aws_sdk_network_firewall.types.associate_subnets_response
    import aws_sdk_network_firewall.types.attach_rule_groups_to_proxy_configuration_request
    import aws_sdk_network_firewall.types.attach_rule_groups_to_proxy_configuration_response
    ...
    import aws_sdk_network_firewall.types.create_proxy_configuration_request
    import aws_sdk_network_firewall.types.create_proxy_configuration_response
    import aws_sdk_network_firewall.types.create_proxy_request
    import aws_sdk_network_firewall.types.create_proxy_response
    import aws_sdk_network_firewall.types.create_proxy_rule_group_request
    import aws_sdk_network_firewall.types.create_proxy_rule_group_response
    ...
    import aws_sdk_network_firewall.types.create_tls_inspection_configuration_response
    ...
    import aws_sdk_network_firewall.types.delete_firewall_request
    import aws_sdk_network_firewall.types.delete_firewall_response
    import aws_sdk_network_firewall.types.delete_network_firewall_transit_gateway_attachment_request
    import aws_sdk_network_firewall.types.delete_network_firewall_transit_gateway_attachment_response
    import aws_sdk_network_firewall.types.delete_proxy_configuration_request
    import aws_sdk_network_firewall.types.delete_proxy_configuration_response
    import aws_sdk_network_firewall.types.delete_proxy_request
    import aws_sdk_network_firewall.types.delete_proxy_response
    ...
    import aws_sdk_network_firewall.types.delete_resource_policy_request
    import aws_sdk_network_firewall.types.delete_resource_policy_response
    ...
    import aws_sdk_network_firewall.types.delete_tls_inspection_configuration_request
    import aws_sdk_network_firewall.types.delete_tls_inspection_configuration_response
    ...
    import aws_sdk_network_firewall.types.describe_firewall_metadata_request
    import aws_sdk_network_firewall.types.describe_firewall_metadata_response
    ...
    import aws_sdk_network_firewall.types.describe_firewall_request
    import aws_sdk_network_firewall.types.describe_firewall_response
    import aws_sdk_network_firewall.types.describe_flow_operation_request
    import aws_sdk_network_firewall.types.describe_flow_operation_response
    ...
    import aws_sdk_network_firewall.types.describe_proxy_request
    import aws_sdk_network_firewall.types.describe_proxy_response
    import aws_sdk_network_firewall.types.describe_proxy_rule_group_request
    import aws_sdk_network_firewall.types.describe_proxy_rule_group_response
    import aws_sdk_network_firewall.types.describe_proxy_rule_request
    import aws_sdk_network_firewall.types.describe_proxy_rule_response
    import aws_sdk_network_firewall.types.describe_resource_policy_request
    import aws_sdk_network_firewall.types.describe_resource_policy_response
    ...
    import aws_sdk_network_firewall.types.describe_rule_group_request
    import aws_sdk_network_firewall.types.describe_rule_group_response
    ...
    import aws_sdk_network_firewall.types.describe_tls_inspection_configuration_request
    import aws_sdk_network_firewall.types.describe_tls_inspection_configuration_response
    import aws_sdk_network_firewall.types.describe_vpc_endpoint_association_request
    import aws_sdk_network_firewall.types.describe_vpc_endpoint_association_response
    ...
    import aws_sdk_network_firewall.types.disassociate_availability_zones_request
    import aws_sdk_network_firewall.types.disassociate_availability_zones_response
    ...
    import aws_sdk_network_firewall.types.list_flow_operation_results_request
    import aws_sdk_network_firewall.types.list_flow_operation_results_response
    ...
    import aws_sdk_network_firewall.types.list_proxies_request
    import aws_sdk_network_firewall.types.list_proxies_response
    import aws_sdk_network_firewall.types.list_proxy_configurations_request
    import aws_sdk_network_firewall.types.list_proxy_configurations_response
    import aws_sdk_network_firewall.types.list_proxy_rule_groups_request
    import aws_sdk_network_firewall.types.list_proxy_rule_groups_response
    import aws_sdk_network_firewall.types.list_rule_groups_request
    import aws_sdk_network_firewall.types.list_rule_groups_response
    ...
    import aws_sdk_network_firewall.types.list_tls_inspection_configurations_request
    import aws_sdk_network_firewall.types.list_tls_inspection_configurations_response
    ...
    import aws_sdk_network_firewall.types.put_resource_policy_request
    import aws_sdk_network_firewall.types.put_resource_policy_response
    ...
    import aws_sdk_network_firewall.types.tags_pagination_max_results
    ...
    import aws_sdk_network_firewall.types.update_availability_zone_change_protection_response
    ...
    import aws_sdk_network_firewall.types.update_firewall_policy_request
    import aws_sdk_network_firewall.types.update_firewall_policy_response
    ...
    import aws_sdk_network_firewall.types.update_proxy_request
    import aws_sdk_network_firewall.types.update_proxy_response
    import aws_sdk_network_firewall.types.update_proxy_rule_group_priorities_request
    import aws_sdk_network_firewall.types.update_proxy_rule_group_priorities_response
    import aws_sdk_network_firewall.types.update_proxy_rule_priorities_request
    import aws_sdk_network_firewall.types.update_proxy_rule_priorities_response
    import aws_sdk_network_firewall.types.update_proxy_rule_request
    import aws_sdk_network_firewall.types.update_proxy_rule_response
    import aws_sdk_network_firewall.types.update_rule_group_request
    import aws_sdk_network_firewall.types.update_rule_group_response
    import aws_sdk_network_firewall.types.update_subnet_change_protection_request
    import aws_sdk_network_firewall.types.update_subnet_change_protection_response
...
class AsyncNetworkFirewallClientConfig(TypedDict, total=False):
...
class AsyncNetworkFirewallClient:
    ...
    def __init__(
        ...
        self.config = AsyncNetworkFirewallClientConfig(
            {
    ...
    async def accept_network_firewall_transit_gateway_attachment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.accept_network_firewall_transit_gateway_attachment_request.AcceptNetworkFirewallTransitGatewayAttachmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.accept_network_firewall_transit_gateway_attachment_response.AcceptNetworkFirewallTransitGatewayAttachmentResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.accept_network_firewall_transit_gateway_attachment

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.accept_network_firewall_transit_gateway_attachment.async_accept_network_firewall_transit_gateway_attachment(
    ...
    async def associate_availability_zones(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.associate_availability_zones_request.AssociateAvailabilityZonesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.associate_availability_zones_response.AssociateAvailabilityZonesResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.associate_availability_zones

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.associate_availability_zones.async_associate_availability_zones(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def associate_firewall_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.associate_firewall_policy_request.AssociateFirewallPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.associate_firewall_policy_response.AssociateFirewallPolicyResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.associate_firewall_policy

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.associate_firewall_policy.async_associate_firewall_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def associate_subnets(
        self,
        subnet_mappings: "aws_sdk_network_firewall.types.subnet_mappings.SubnetMappings",
        *,
        config_overrides: Optional[AsyncNetworkFirewallClientConfig] = None,
        update_token: Optional[
            "aws_sdk_network_firewall.types.update_token.UpdateToken"
    ...
    ) -> "aws_sdk_network_firewall.types.associate_subnets_response.AssociateSubnetsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.associate_subnets_request.AssociateSubnetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.associate_subnets_response.AssociateSubnetsResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.associate_subnets

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.associate_subnets.async_associate_subnets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def attach_rule_groups_to_proxy_configuration(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.attach_rule_groups_to_proxy_configuration_response.AttachRuleGroupsToProxyConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.attach_rule_groups_to_proxy_configuration_request.AttachRuleGroupsToProxyConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.attach_rule_groups_to_proxy_configuration_response.AttachRuleGroupsToProxyConfigurationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.attach_rule_groups_to_proxy_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.attach_rule_groups_to_proxy_configuration.async_attach_rule_groups_to_proxy_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_firewall(
        ...
        *,
        config_overrides: Optional[AsyncNetworkFirewallClientConfig] = None,
        vpc_id: Optional["aws_sdk_network_firewall.types.vpc_id.VpcId"] = None,
        ...
        description: Optional[
            "aws_sdk_network_firewall.types.description.Description"
        ] = None,
        tags: Optional["aws_sdk_network_firewall.types.tag_list.TagList"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.create_firewall_request.CreateFirewallRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.create_firewall_response.CreateFirewallResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.create_firewall

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.create_firewall.async_create_firewall(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_firewall_policy(
        ...
        *,
        ...
        tags: Optional["aws_sdk_network_firewall.types.tag_list.TagList"] = None,
        dry_run: Optional["aws_sdk_network_firewall.types.boolean.Boolean"] = None,
        encryption_configuration: Optional[
            "aws_sdk_network_firewall.types.encryption_configuration.EncryptionConfiguration"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.create_firewall_policy_request.CreateFirewallPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.create_firewall_policy_response.CreateFirewallPolicyResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.create_firewall_policy

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.create_firewall_policy.async_create_firewall_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_proxy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.create_proxy_request.CreateProxyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.create_proxy_response.CreateProxyResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.create_proxy

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.create_proxy.async_create_proxy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_proxy_configuration(
        self,
        proxy_configuration_name: "aws_sdk_network_firewall.types.resource_name.ResourceName",
        ...
        *,
        ...
        tags: Optional["aws_sdk_network_firewall.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_network_firewall.types.create_proxy_configuration_response.CreateProxyConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.create_proxy_configuration_request.CreateProxyConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.create_proxy_configuration_response.CreateProxyConfigurationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.create_proxy_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.create_proxy_configuration.async_create_proxy_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_proxy_rule_group(
        ...
        *,
        ...
        tags: Optional["aws_sdk_network_firewall.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_network_firewall.types.create_proxy_rule_group_response.CreateProxyRuleGroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.create_proxy_rule_group_request.CreateProxyRuleGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.create_proxy_rule_group_response.CreateProxyRuleGroupResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.create_proxy_rule_group

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.create_proxy_rule_group.async_create_proxy_rule_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_proxy_rules(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.create_proxy_rules_request.CreateProxyRulesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.create_proxy_rules_response.CreateProxyRulesResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.create_proxy_rules

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.create_proxy_rules.async_create_proxy_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_rule_group(
        ...
        *,
        config_overrides: Optional[AsyncNetworkFirewallClientConfig] = None,
        rule_group: Optional[
            "aws_sdk_network_firewall.types.rule_group.RuleGroup"
        ] = None,
        rules: Optional[
            "aws_sdk_network_firewall.types.rules_string.RulesString"
        ] = None,
        description: Optional[
            "aws_sdk_network_firewall.types.description.Description"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.create_rule_group_request.CreateRuleGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.create_rule_group_response.CreateRuleGroupResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.create_rule_group

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.create_rule_group.async_create_rule_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_tls_inspection_configuration(
        self,
        tls_inspection_configuration_name: "aws_sdk_network_firewall.types.resource_name.ResourceName",
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.create_tls_inspection_configuration_response.CreateTLSInspectionConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.create_tls_inspection_configuration_request.CreateTLSInspectionConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.create_tls_inspection_configuration_response.CreateTLSInspectionConfigurationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.create_tls_inspection_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.create_tls_inspection_configuration.async_create_tls_inspection_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_vpc_endpoint_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.create_vpc_endpoint_association_request.CreateVpcEndpointAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.create_vpc_endpoint_association_response.CreateVpcEndpointAssociationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.create_vpc_endpoint_association

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.create_vpc_endpoint_association.async_create_vpc_endpoint_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_firewall(
        ...
        *,
        ...
        "aws_sdk_network_firewall.types.delete_firewall_response.DeleteFirewallResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.delete_firewall_request.DeleteFirewallRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.delete_firewall_response.DeleteFirewallResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.delete_firewall

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.delete_firewall.async_delete_firewall(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_firewall_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.delete_firewall_policy_request.DeleteFirewallPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.delete_firewall_policy_response.DeleteFirewallPolicyResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.delete_firewall_policy

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.delete_firewall_policy.async_delete_firewall_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_network_firewall_transit_gateway_attachment(
        ...
        *,
        config_overrides: Optional[AsyncNetworkFirewallClientConfig] = None,
    ) -> "aws_sdk_network_firewall.types.delete_network_firewall_transit_gateway_attachment_response.DeleteNetworkFirewallTransitGatewayAttachmentResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.delete_network_firewall_transit_gateway_attachment_request.DeleteNetworkFirewallTransitGatewayAttachmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.delete_network_firewall_transit_gateway_attachment_response.DeleteNetworkFirewallTransitGatewayAttachmentResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.delete_network_firewall_transit_gateway_attachment

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.delete_network_firewall_transit_gateway_attachment.async_delete_network_firewall_transit_gateway_attachment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_proxy(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.delete_proxy_response.DeleteProxyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.delete_proxy_request.DeleteProxyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.delete_proxy_response.DeleteProxyResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.delete_proxy

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.delete_proxy.async_delete_proxy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_proxy_configuration(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.delete_proxy_configuration_response.DeleteProxyConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.delete_proxy_configuration_request.DeleteProxyConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.delete_proxy_configuration_response.DeleteProxyConfigurationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.delete_proxy_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.delete_proxy_configuration.async_delete_proxy_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_proxy_rule_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.delete_proxy_rule_group_request.DeleteProxyRuleGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.delete_proxy_rule_group_response.DeleteProxyRuleGroupResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.delete_proxy_rule_group

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.delete_proxy_rule_group.async_delete_proxy_rule_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_proxy_rules(
        self,
        rules: "aws_sdk_network_firewall.types.resource_name_list.ResourceNameList",
        *,
        config_overrides: Optional[AsyncNetworkFirewallClientConfig] = None,
        proxy_rule_group_arn: Optional[
            "aws_sdk_network_firewall.types.resource_arn.ResourceArn"
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.delete_proxy_rules_request.DeleteProxyRulesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.delete_proxy_rules_response.DeleteProxyRulesResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.delete_proxy_rules

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.delete_proxy_rules.async_delete_proxy_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_resource_policy(
        ...
        *,
        config_overrides: Optional[AsyncNetworkFirewallClientConfig] = None,
    ) -> "aws_sdk_network_firewall.types.delete_resource_policy_response.DeleteResourcePolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.delete_resource_policy_request.DeleteResourcePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.delete_resource_policy_response.DeleteResourcePolicyResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.delete_resource_policy

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.delete_resource_policy.async_delete_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_rule_group(
        ...
        *,
        ...
        type: Optional[
            "aws_sdk_network_firewall.types.rule_group_type.RuleGroupType"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.delete_rule_group_request.DeleteRuleGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.delete_rule_group_response.DeleteRuleGroupResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.delete_rule_group

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.delete_rule_group.async_delete_rule_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_tls_inspection_configuration(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.delete_tls_inspection_configuration_response.DeleteTLSInspectionConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.delete_tls_inspection_configuration_request.DeleteTLSInspectionConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.delete_tls_inspection_configuration_response.DeleteTLSInspectionConfigurationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.delete_tls_inspection_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.delete_tls_inspection_configuration.async_delete_tls_inspection_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_vpc_endpoint_association(
        self,
        vpc_endpoint_association_arn: "aws_sdk_network_firewall.types.resource_arn.ResourceArn",
        *,
        config_overrides: Optional[AsyncNetworkFirewallClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.delete_vpc_endpoint_association_request.DeleteVpcEndpointAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.delete_vpc_endpoint_association_response.DeleteVpcEndpointAssociationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.delete_vpc_endpoint_association

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.delete_vpc_endpoint_association.async_delete_vpc_endpoint_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_firewall(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.describe_firewall_response.DescribeFirewallResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.describe_firewall_request.DescribeFirewallRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.describe_firewall_response.DescribeFirewallResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.describe_firewall

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.describe_firewall.async_describe_firewall(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_firewall_metadata(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.describe_firewall_metadata_response.DescribeFirewallMetadataResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.describe_firewall_metadata_request.DescribeFirewallMetadataRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.describe_firewall_metadata_response.DescribeFirewallMetadataResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.describe_firewall_metadata

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.describe_firewall_metadata.async_describe_firewall_metadata(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_firewall_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.describe_firewall_policy_request.DescribeFirewallPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.describe_firewall_policy_response.DescribeFirewallPolicyResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.describe_firewall_policy

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.describe_firewall_policy.async_describe_firewall_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_flow_operation(
        self,
        firewall_arn: "aws_sdk_network_firewall.types.resource_arn.ResourceArn",
        flow_operation_id: "aws_sdk_network_firewall.types.flow_operation_id.FlowOperationId",
        *,
        config_overrides: Optional[AsyncNetworkFirewallClientConfig] = None,
    ...
    ) -> "aws_sdk_network_firewall.types.describe_flow_operation_response.DescribeFlowOperationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.describe_flow_operation_request.DescribeFlowOperationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.describe_flow_operation_response.DescribeFlowOperationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.describe_flow_operation

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.describe_flow_operation.async_describe_flow_operation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_logging_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.describe_logging_configuration_request.DescribeLoggingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.describe_logging_configuration_response.DescribeLoggingConfigurationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.describe_logging_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.describe_logging_configuration.async_describe_logging_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_proxy(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.describe_proxy_response.DescribeProxyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.describe_proxy_request.DescribeProxyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.describe_proxy_response.DescribeProxyResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.describe_proxy

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.describe_proxy.async_describe_proxy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_proxy_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.describe_proxy_configuration_request.DescribeProxyConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.describe_proxy_configuration_response.DescribeProxyConfigurationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.describe_proxy_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.describe_proxy_configuration.async_describe_proxy_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_proxy_rule(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.describe_proxy_rule_response.DescribeProxyRuleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.describe_proxy_rule_request.DescribeProxyRuleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.describe_proxy_rule_response.DescribeProxyRuleResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.describe_proxy_rule

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.describe_proxy_rule.async_describe_proxy_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_proxy_rule_group(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.describe_proxy_rule_group_response.DescribeProxyRuleGroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.describe_proxy_rule_group_request.DescribeProxyRuleGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.describe_proxy_rule_group_response.DescribeProxyRuleGroupResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.describe_proxy_rule_group

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.describe_proxy_rule_group.async_describe_proxy_rule_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_resource_policy(
        ...
        *,
        config_overrides: Optional[AsyncNetworkFirewallClientConfig] = None,
    ) -> "aws_sdk_network_firewall.types.describe_resource_policy_response.DescribeResourcePolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.describe_resource_policy_request.DescribeResourcePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.describe_resource_policy_response.DescribeResourcePolicyResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.describe_resource_policy

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.describe_resource_policy.async_describe_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_rule_group(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.describe_rule_group_response.DescribeRuleGroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.describe_rule_group_request.DescribeRuleGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.describe_rule_group_response.DescribeRuleGroupResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.describe_rule_group

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.describe_rule_group.async_describe_rule_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_rule_group_metadata(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.describe_rule_group_metadata_request.DescribeRuleGroupMetadataRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.describe_rule_group_metadata_response.DescribeRuleGroupMetadataResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.describe_rule_group_metadata

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.describe_rule_group_metadata.async_describe_rule_group_metadata(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_rule_group_summary(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.describe_rule_group_summary_request.DescribeRuleGroupSummaryRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.describe_rule_group_summary_response.DescribeRuleGroupSummaryResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.describe_rule_group_summary

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.describe_rule_group_summary.async_describe_rule_group_summary(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_tls_inspection_configuration(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.describe_tls_inspection_configuration_response.DescribeTLSInspectionConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.describe_tls_inspection_configuration_request.DescribeTLSInspectionConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.describe_tls_inspection_configuration_response.DescribeTLSInspectionConfigurationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.describe_tls_inspection_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.describe_tls_inspection_configuration.async_describe_tls_inspection_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_vpc_endpoint_association(
        ...
        *,
        config_overrides: Optional[AsyncNetworkFirewallClientConfig] = None,
    ) -> "aws_sdk_network_firewall.types.describe_vpc_endpoint_association_response.DescribeVpcEndpointAssociationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.describe_vpc_endpoint_association_request.DescribeVpcEndpointAssociationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.describe_vpc_endpoint_association_response.DescribeVpcEndpointAssociationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.describe_vpc_endpoint_association

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.describe_vpc_endpoint_association.async_describe_vpc_endpoint_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detach_rule_groups_from_proxy_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.detach_rule_groups_from_proxy_configuration_request.DetachRuleGroupsFromProxyConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.detach_rule_groups_from_proxy_configuration_response.DetachRuleGroupsFromProxyConfigurationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.detach_rule_groups_from_proxy_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.detach_rule_groups_from_proxy_configuration.async_detach_rule_groups_from_proxy_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_availability_zones(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.disassociate_availability_zones_response.DisassociateAvailabilityZonesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.disassociate_availability_zones_request.DisassociateAvailabilityZonesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.disassociate_availability_zones_response.DisassociateAvailabilityZonesResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.disassociate_availability_zones

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.disassociate_availability_zones.async_disassociate_availability_zones(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_subnets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.disassociate_subnets_request.DisassociateSubnetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.disassociate_subnets_response.DisassociateSubnetsResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.disassociate_subnets

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.disassociate_subnets.async_disassociate_subnets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_analysis_report_results(
        self,
        analysis_report_id: "aws_sdk_network_firewall.types.analysis_report_id.AnalysisReportId",
        *,
        config_overrides: Optional[AsyncNetworkFirewallClientConfig] = None,
        firewall_name: Optional[
            "aws_sdk_network_firewall.types.resource_name.ResourceName"
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.get_analysis_report_results_request.GetAnalysisReportResultsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.get_analysis_report_results_response.GetAnalysisReportResultsResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.get_analysis_report_results

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.get_analysis_report_results.async_get_analysis_report_results(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_network_firewall.types.analysis_type_report_result.AnalysisTypeReportResult]":
        _token = next_token
        while True:
    ...
    async def list_analysis_reports(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.list_analysis_reports_request.ListAnalysisReportsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.list_analysis_reports_response.ListAnalysisReportsResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.list_analysis_reports

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.list_analysis_reports.async_list_analysis_reports(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_network_firewall.types.analysis_report.AnalysisReport]":
        _token = next_token
        while True:
    ...
    async def list_firewall_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.list_firewall_policies_request.ListFirewallPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.list_firewall_policies_response.ListFirewallPoliciesResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.list_firewall_policies

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.list_firewall_policies.async_list_firewall_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_network_firewall.types.firewall_policy_metadata.FirewallPolicyMetadata]":
        _token = next_token
        while True:
    ...
    async def list_firewalls(
        ...
        *,
        ...
        vpc_ids: Optional["aws_sdk_network_firewall.types.vpc_ids.VpcIds"] = None,
        max_results: Optional[
            "aws_sdk_network_firewall.types.pagination_max_results.PaginationMaxResults"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.list_firewalls_request.ListFirewallsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.list_firewalls_response.ListFirewallsResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.list_firewalls

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.list_firewalls.async_list_firewalls(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_network_firewall.types.firewall_metadata.FirewallMetadata]":
        _token = next_token
        while True:
    ...
    async def list_flow_operation_results(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.list_flow_operation_results_response.ListFlowOperationResultsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.list_flow_operation_results_request.ListFlowOperationResultsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.list_flow_operation_results_response.ListFlowOperationResultsResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.list_flow_operation_results

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.list_flow_operation_results.async_list_flow_operation_results(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_network_firewall.types.flow.Flow]":
        _token = next_token
        while True:
    ...
    async def list_flow_operations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.list_flow_operations_request.ListFlowOperationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.list_flow_operations_response.ListFlowOperationsResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.list_flow_operations

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.list_flow_operations.async_list_flow_operations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_network_firewall.types.flow_operation_metadata.FlowOperationMetadata]":
        _token = next_token
        while True:
    ...
    async def list_proxies(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.list_proxies_response.ListProxiesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.list_proxies_request.ListProxiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.list_proxies_response.ListProxiesResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.list_proxies

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.list_proxies.async_list_proxies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_network_firewall.types.proxy_metadata.ProxyMetadata]":
        _token = next_token
        while True:
    ...
    async def list_proxy_configurations(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.list_proxy_configurations_response.ListProxyConfigurationsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.list_proxy_configurations_request.ListProxyConfigurationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.list_proxy_configurations_response.ListProxyConfigurationsResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.list_proxy_configurations

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.list_proxy_configurations.async_list_proxy_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_network_firewall.types.proxy_configuration_metadata.ProxyConfigurationMetadata]":
        _token = next_token
        while True:
    ...
    async def list_proxy_rule_groups(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.list_proxy_rule_groups_response.ListProxyRuleGroupsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.list_proxy_rule_groups_request.ListProxyRuleGroupsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.list_proxy_rule_groups_response.ListProxyRuleGroupsResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.list_proxy_rule_groups

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.list_proxy_rule_groups.async_list_proxy_rule_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_network_firewall.types.proxy_rule_group_metadata.ProxyRuleGroupMetadata]":
        _token = next_token
        while True:
    ...
    async def list_rule_groups(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.list_rule_groups_response.ListRuleGroupsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.list_rule_groups_request.ListRuleGroupsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.list_rule_groups_response.ListRuleGroupsResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.list_rule_groups

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.list_rule_groups.async_list_rule_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_network_firewall.types.rule_group_metadata.RuleGroupMetadata]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        max_results: Optional[
            "aws_sdk_network_firewall.types.tags_pagination_max_results.TagsPaginationMaxResults"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.list_tags_for_resource

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_network_firewall.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    async def list_tls_inspection_configurations(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.list_tls_inspection_configurations_response.ListTLSInspectionConfigurationsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.list_tls_inspection_configurations_request.ListTLSInspectionConfigurationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.list_tls_inspection_configurations_response.ListTLSInspectionConfigurationsResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.list_tls_inspection_configurations

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.list_tls_inspection_configurations.async_list_tls_inspection_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_network_firewall.types.tls_inspection_configuration_metadata.TLSInspectionConfigurationMetadata]":
        _token = next_token
        while True:
    ...
    async def list_vpc_endpoint_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.list_vpc_endpoint_associations_request.ListVpcEndpointAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.list_vpc_endpoint_associations_response.ListVpcEndpointAssociationsResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.list_vpc_endpoint_associations

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.list_vpc_endpoint_associations.async_list_vpc_endpoint_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_network_firewall.types.vpc_endpoint_association_metadata.VpcEndpointAssociationMetadata]":
        _token = next_token
        while True:
    ...
    async def put_resource_policy(
        ...
        *,
        config_overrides: Optional[AsyncNetworkFirewallClientConfig] = None,
    ) -> "aws_sdk_network_firewall.types.put_resource_policy_response.PutResourcePolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.put_resource_policy_request.PutResourcePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.put_resource_policy_response.PutResourcePolicyResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.put_resource_policy

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.put_resource_policy.async_put_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reject_network_firewall_transit_gateway_attachment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.reject_network_firewall_transit_gateway_attachment_request.RejectNetworkFirewallTransitGatewayAttachmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.reject_network_firewall_transit_gateway_attachment_response.RejectNetworkFirewallTransitGatewayAttachmentResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.reject_network_firewall_transit_gateway_attachment

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.reject_network_firewall_transit_gateway_attachment.async_reject_network_firewall_transit_gateway_attachment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_analysis_report(
        self,
        analysis_type: "aws_sdk_network_firewall.types.enabled_analysis_type.EnabledAnalysisType",
        *,
        config_overrides: Optional[AsyncNetworkFirewallClientConfig] = None,
        firewall_name: Optional[
            "aws_sdk_network_firewall.types.resource_name.ResourceName"
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.start_analysis_report_request.StartAnalysisReportRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.start_analysis_report_response.StartAnalysisReportResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.start_analysis_report

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.start_analysis_report.async_start_analysis_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_flow_capture(
        ...
        *,
        ...
        minimum_flow_age_in_seconds: Optional[
            "aws_sdk_network_firewall.types.age.Age"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.start_flow_capture_request.StartFlowCaptureRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.start_flow_capture_response.StartFlowCaptureResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.start_flow_capture

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.start_flow_capture.async_start_flow_capture(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_flow_flush(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.start_flow_flush_request.StartFlowFlushRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.start_flow_flush_response.StartFlowFlushResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.start_flow_flush

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.start_flow_flush.async_start_flow_flush(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.tag_resource_response.TagResourceResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.tag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.untag_resource_response.UntagResourceResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.untag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_availability_zone_change_protection(
        self,
        availability_zone_change_protection: "aws_sdk_network_firewall.types.boolean.Boolean",
        *,
        config_overrides: Optional[AsyncNetworkFirewallClientConfig] = None,
        update_token: Optional[
            "aws_sdk_network_firewall.types.update_token.UpdateToken"
    ...
    ) -> "aws_sdk_network_firewall.types.update_availability_zone_change_protection_response.UpdateAvailabilityZoneChangeProtectionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_availability_zone_change_protection_request.UpdateAvailabilityZoneChangeProtectionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_availability_zone_change_protection_response.UpdateAvailabilityZoneChangeProtectionResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_availability_zone_change_protection

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_availability_zone_change_protection.async_update_availability_zone_change_protection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_firewall_analysis_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_firewall_analysis_settings_request.UpdateFirewallAnalysisSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_firewall_analysis_settings_response.UpdateFirewallAnalysisSettingsResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_firewall_analysis_settings

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_firewall_analysis_settings.async_update_firewall_analysis_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_firewall_delete_protection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_firewall_delete_protection_request.UpdateFirewallDeleteProtectionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_firewall_delete_protection_response.UpdateFirewallDeleteProtectionResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_firewall_delete_protection

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_firewall_delete_protection.async_update_firewall_delete_protection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_firewall_description(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_firewall_description_request.UpdateFirewallDescriptionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_firewall_description_response.UpdateFirewallDescriptionResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_firewall_description

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_firewall_description.async_update_firewall_description(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_firewall_encryption_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_firewall_encryption_configuration_request.UpdateFirewallEncryptionConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_firewall_encryption_configuration_response.UpdateFirewallEncryptionConfigurationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_firewall_encryption_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_firewall_encryption_configuration.async_update_firewall_encryption_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_firewall_policy(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.update_firewall_policy_response.UpdateFirewallPolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_firewall_policy_request.UpdateFirewallPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_firewall_policy_response.UpdateFirewallPolicyResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_firewall_policy

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_firewall_policy.async_update_firewall_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_firewall_policy_change_protection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_firewall_policy_change_protection_request.UpdateFirewallPolicyChangeProtectionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_firewall_policy_change_protection_response.UpdateFirewallPolicyChangeProtectionResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_firewall_policy_change_protection

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_firewall_policy_change_protection.async_update_firewall_policy_change_protection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_logging_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_logging_configuration_request.UpdateLoggingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_logging_configuration_response.UpdateLoggingConfigurationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_logging_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_logging_configuration.async_update_logging_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_proxy(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.update_proxy_response.UpdateProxyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_proxy_request.UpdateProxyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_proxy_response.UpdateProxyResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_proxy

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_proxy.async_update_proxy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_proxy_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_proxy_configuration_request.UpdateProxyConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_proxy_configuration_response.UpdateProxyConfigurationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_proxy_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_proxy_configuration.async_update_proxy_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_proxy_rule(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.update_proxy_rule_response.UpdateProxyRuleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_proxy_rule_request.UpdateProxyRuleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_proxy_rule_response.UpdateProxyRuleResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_proxy_rule

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_proxy_rule.async_update_proxy_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_proxy_rule_group_priorities(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.update_proxy_rule_group_priorities_response.UpdateProxyRuleGroupPrioritiesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_proxy_rule_group_priorities_request.UpdateProxyRuleGroupPrioritiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_proxy_rule_group_priorities_response.UpdateProxyRuleGroupPrioritiesResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_proxy_rule_group_priorities

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_proxy_rule_group_priorities.async_update_proxy_rule_group_priorities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_proxy_rule_priorities(
        self,
        rule_group_request_phase: "aws_sdk_network_firewall.types.rule_group_request_phase.RuleGroupRequestPhase",
        rules: "aws_sdk_network_firewall.types.proxy_rule_priority_list.ProxyRulePriorityList",
        update_token: "aws_sdk_network_firewall.types.update_token.UpdateToken",
        *,
        config_overrides: Optional[AsyncNetworkFirewallClientConfig] = None,
        proxy_rule_group_name: Optional[
    ...
    ) -> "aws_sdk_network_firewall.types.update_proxy_rule_priorities_response.UpdateProxyRulePrioritiesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_proxy_rule_priorities_request.UpdateProxyRulePrioritiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_proxy_rule_priorities_response.UpdateProxyRulePrioritiesResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_proxy_rule_priorities

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_proxy_rule_priorities.async_update_proxy_rule_priorities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_rule_group(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.update_rule_group_response.UpdateRuleGroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_rule_group_request.UpdateRuleGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_rule_group_response.UpdateRuleGroupResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_rule_group

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_rule_group.async_update_rule_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_subnet_change_protection(
        ...
        *,
    ...
    ) -> "aws_sdk_network_firewall.types.update_subnet_change_protection_response.UpdateSubnetChangeProtectionResponse":
        """<p></p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_subnet_change_protection_request.UpdateSubnetChangeProtectionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_subnet_change_protection_response.UpdateSubnetChangeProtectionResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_subnet_change_protection

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_subnet_change_protection.async_update_subnet_change_protection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_tls_inspection_configuration(
        ...
        *,
        ...
        """<p>Updates the TLS inspection configuration settings for the specified TLS inspection configuration. You use a TLS inspection configuration by referencing it in one or more firewall policies. When you modify a TLS inspection configuration, you modify all firewall policies that use the TLS inspection configuration. </p> <p>To update a TLS inspection configuration, first call <a>DescribeTLSInspectionConfiguration</a> to retrieve the current <a>TLSInspectionConfiguration</a> object, update the object as needed, and then provide the updated object to this call. </p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_network_firewall.types.update_tls_inspection_configuration_request.UpdateTLSInspectionConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_network_firewall.types.update_tls_inspection_configuration_response.UpdateTLSInspectionConfigurationResponse"
        ]:
            import aws_sdk_network_firewall._operations.network_firewall_20201112.update_tls_inspection_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_network_firewall._operations.network_firewall_20201112.update_tls_inspection_configuration.async_update_tls_inspection_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
