"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UpdateProxyConfigurationResponse``."""
...
class UpdateProxyConfigurationResponse(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: UpdateProxyConfigurationResponse) -> dict:
    out: dict = {}
    if "proxy_configuration" in value:
        import aws_sdk_network_firewall.types.proxy_configuration

        out["ProxyConfiguration"] = (
            aws_sdk_network_firewall.types.proxy_configuration.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> UpdateProxyConfigurationResponse:
    out: UpdateProxyConfigurationResponse = {}  # type: ignore[typeddict-item]
    if "ProxyConfiguration" in data:
        import aws_sdk_network_firewall.types.proxy_configuration

        out["proxy_configuration"] = (
            aws_sdk_network_firewall.types.proxy_configuration.deserialize_aws_json_1_0(
