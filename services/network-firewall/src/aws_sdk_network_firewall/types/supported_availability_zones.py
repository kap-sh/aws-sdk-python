...
if TYPE_CHECKING:
    ...
    import aws_sdk_network_firewall.types.availability_zone_metadata

SupportedAvailabilityZones: TypeAlias = dict[
    "aws_sdk_network_firewall.types.availability_zone.AvailabilityZone",
    "aws_sdk_network_firewall.types.availability_zone_metadata.AvailabilityZoneMetadata",
]
...
def serialize_aws_json_1_0(input_to_serialize: SupportedAvailabilityZones) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = (
            aws_sdk_network_firewall.types.availability_zone_metadata.serialize_aws_json_1_0(
                value
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> SupportedAvailabilityZones:
    ...
    for key, value in data.items():
        ...
        out[key] = (
            aws_sdk_network_firewall.types.availability_zone_metadata.deserialize_aws_json_1_0(
                value
            )
        )
    return out
