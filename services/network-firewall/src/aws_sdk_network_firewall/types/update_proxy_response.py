...
class UpdateProxyResponse(TypedDict):
    proxy: NotRequired["aws_sdk_network_firewall.types.proxy.Proxy"]
...
def serialize_aws_json_1_0(value: UpdateProxyResponse) -> dict:
    ...
    if "proxy" in value:
        ...
        out["Proxy"] = aws_sdk_network_firewall.types.proxy.serialize_aws_json_1_0(
            value["proxy"]
        )
...
def deserialize_aws_json_1_0(data: dict) -> UpdateProxyResponse:
    ...
    if "Proxy" in data:
        ...
        out["proxy"] = aws_sdk_network_firewall.types.proxy.deserialize_aws_json_1_0(
            data["Proxy"]
        )
