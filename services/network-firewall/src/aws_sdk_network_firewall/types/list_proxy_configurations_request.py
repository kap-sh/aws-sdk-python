"""Generated from Smithy shape ``com.amazonaws.networkfirewall#ListProxyConfigurationsRequest``."""
...
class ListProxyConfigurationsRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListProxyConfigurationsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> ListProxyConfigurationsRequest:
    out: ListProxyConfigurationsRequest = {}  # type: ignore[typeddict-item]
