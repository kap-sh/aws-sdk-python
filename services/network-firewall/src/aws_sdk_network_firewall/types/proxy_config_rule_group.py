...
if TYPE_CHECKING:
    import aws_sdk_network_firewall.types.proxy_config_rule_group_priority
    import aws_sdk_network_firewall.types.proxy_config_rule_group_type
    import aws_sdk_network_firewall.types.resource_arn
    import aws_sdk_network_firewall.types.resource_name


class ProxyConfigRuleGroup(TypedDict):
    ...
    type: NotRequired[
        "aws_sdk_network_firewall.types.proxy_config_rule_group_type.ProxyConfigRuleGroupType"
    ]
    """<p>Proxy rule group type. </p>"""
    priority: NotRequired[
        "aws_sdk_network_firewall.types.proxy_config_rule_group_priority.ProxyConfigRuleGroupPriority"
    ]
