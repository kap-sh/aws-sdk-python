"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UpdateProxyRuleGroupPrioritiesRequest``."""
...
if TYPE_CHECKING:
    import aws_sdk_network_firewall.types.proxy_rule_group_priority_list
    import aws_sdk_network_firewall.types.resource_arn
    import aws_sdk_network_firewall.types.resource_name
    import aws_sdk_network_firewall.types.update_token


class UpdateProxyRuleGroupPrioritiesRequest(TypedDict, closed=True):
    ...
    rule_groups: "aws_sdk_network_firewall.types.proxy_rule_group_priority_list.ProxyRuleGroupPriorityList"
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: UpdateProxyRuleGroupPrioritiesRequest) -> dict:
    out: dict = {}
    ...
    out["RuleGroups"] = (
        aws_sdk_network_firewall.types.proxy_rule_group_priority_list.serialize_aws_json_1_0(
            value["rule_groups"]
        )
    )
...
def deserialize_aws_json_1_0(data: dict) -> UpdateProxyRuleGroupPrioritiesRequest:
    out: UpdateProxyRuleGroupPrioritiesRequest = {}  # type: ignore[typeddict-item]
    ...
    if "RuleGroups" in data:
        ...
        out["rule_groups"] = (
            aws_sdk_network_firewall.types.proxy_rule_group_priority_list.deserialize_aws_json_1_0(
                data["RuleGroups"]
            )
        )
    else:
        raise DeserializationError(
            "UpdateProxyRuleGroupPrioritiesRequest.rule_groups required"
        )
    if "UpdateToken" in data:
        out["update_token"] = data["UpdateToken"]
    else:
        raise DeserializationError(
            "UpdateProxyRuleGroupPrioritiesRequest.update_token required"
        )
    return out
