...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DescribeProxyConfigurationResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> DescribeProxyConfigurationResponse:
    out: DescribeProxyConfigurationResponse = {}  # type: ignore[typeddict-item]
