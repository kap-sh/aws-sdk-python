"""Generated from Smithy shape ``com.amazonaws.networkfirewall#AssociateAvailabilityZonesResponse``."""
...
class AssociateAvailabilityZonesResponse(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: AssociateAvailabilityZonesResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> AssociateAvailabilityZonesResponse:
    out: AssociateAvailabilityZonesResponse = {}  # type: ignore[typeddict-item]
