...
if TYPE_CHECKING:
    ...
    import aws_sdk_network_firewall.types.domain
    import aws_sdk_network_firewall.types.first_accessed
    import aws_sdk_network_firewall.types.hits
    import aws_sdk_network_firewall.types.last_accessed
...
def serialize_aws_json_1_0(value: AnalysisTypeReportResult) -> dict:
    ...
    if "first_accessed" in value:
        ...
        out["FirstAccessed"] = (
            aws_sdk_network_firewall.types.first_accessed.serialize_aws_json_1_0(
    ...
    if "last_accessed" in value:
        ...
        out["LastAccessed"] = (
            aws_sdk_network_firewall.types.last_accessed.serialize_aws_json_1_0(
                value["last_accessed"]
            )
        )
    if "domain" in value:
    ...
    if "hits" in value:
        ...
        out["Hits"] = aws_sdk_network_firewall.types.hits.serialize_aws_json_1_0(
            value["hits"]
        )
    if "unique_sources" in value:
        ...
        out["UniqueSources"] = (
            aws_sdk_network_firewall.types.unique_sources.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> AnalysisTypeReportResult:
    ...
    if "FirstAccessed" in data:
        ...
        out["first_accessed"] = (
            aws_sdk_network_firewall.types.first_accessed.deserialize_aws_json_1_0(
                data["FirstAccessed"]
            )
        )
    if "LastAccessed" in data:
        ...
        out["last_accessed"] = (
            aws_sdk_network_firewall.types.last_accessed.deserialize_aws_json_1_0(
                data["LastAccessed"]
            )
        )
    if "Domain" in data:
    ...
    if "Hits" in data:
        ...
        out["hits"] = aws_sdk_network_firewall.types.hits.deserialize_aws_json_1_0(
            data["Hits"]
        )
    if "UniqueSources" in data:
        ...
        out["unique_sources"] = (
            aws_sdk_network_firewall.types.unique_sources.deserialize_aws_json_1_0(
                data["UniqueSources"]
            )
        )
    return out
