"""Generated from Smithy shape ``com.amazonaws.networkfirewall#FirewallPolicyMetadata``."""
...
class FirewallPolicyMetadata(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: FirewallPolicyMetadata) -> dict:
    out: dict = {}
    if "name" in value:
        out["Name"] = value["name"]
    if "arn" in value:
