...
if TYPE_CHECKING:
    import aws_sdk_network_firewall.types.analysis_result_list
...
class RuleGroupResponse(TypedDict):
    ...
    rule_group_id: "aws_sdk_network_firewall.types.resource_id.ResourceId"
    ...
    analysis_results: NotRequired[
        "aws_sdk_network_firewall.types.analysis_result_list.AnalysisResultList"
    ]
...
def serialize_aws_json_1_0(value: RuleGroupResponse) -> dict:
    ...
    if "analysis_results" in value:
        ...
        out["AnalysisResults"] = (
            aws_sdk_network_firewall.types.analysis_result_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> RuleGroupResponse:
    ...
    if "AnalysisResults" in data:
        ...
        out["analysis_results"] = (
            aws_sdk_network_firewall.types.analysis_result_list.deserialize_aws_json_1_0(
