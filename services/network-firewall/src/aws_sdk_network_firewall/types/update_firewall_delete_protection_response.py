"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UpdateFirewallDeleteProtectionResponse``."""
...
class UpdateFirewallDeleteProtectionResponse(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: UpdateFirewallDeleteProtectionResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> UpdateFirewallDeleteProtectionResponse:
    out: UpdateFirewallDeleteProtectionResponse = {}  # type: ignore[typeddict-item]
