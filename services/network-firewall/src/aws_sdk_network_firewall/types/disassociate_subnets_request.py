...
class DisassociateSubnetsRequest(TypedDict):
    ...
    subnet_ids: "aws_sdk_network_firewall.types.az_subnets.AzSubnets"
...
def serialize_aws_json_1_0(value: DisassociateSubnetsRequest) -> dict:
    ...
    out["SubnetIds"] = aws_sdk_network_firewall.types.az_subnets.serialize_aws_json_1_0(
        value["subnet_ids"]
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> DisassociateSubnetsRequest:
    ...
    if "SubnetIds" in data:
        ...
        out["subnet_ids"] = (
            aws_sdk_network_firewall.types.az_subnets.deserialize_aws_json_1_0(
                data["SubnetIds"]
            )
        )
    else:
