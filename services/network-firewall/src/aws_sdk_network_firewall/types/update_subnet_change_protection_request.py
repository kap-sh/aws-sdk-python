"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UpdateSubnetChangeProtectionRequest``."""
...
class UpdateSubnetChangeProtectionRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: UpdateSubnetChangeProtectionRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> UpdateSubnetChangeProtectionRequest:
    out: UpdateSubnetChangeProtectionRequest = {}  # type: ignore[typeddict-item]
