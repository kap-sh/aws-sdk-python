...
if TYPE_CHECKING:
    ...
    import aws_sdk_network_firewall.types.identified_type
    import aws_sdk_network_firewall.types.rule_id_list


class AnalysisResult(TypedDict, closed=True):
    identified_rule_ids: NotRequired[
        "aws_sdk_network_firewall.types.rule_id_list.RuleIdList"
    ]
    """<p>The priority number of the stateless rules identified in the analysis.</p>"""
    identified_type: NotRequired[
        "aws_sdk_network_firewall.types.identified_type.IdentifiedType"
    ]
...
def serialize_aws_json_1_0(value: AnalysisResult) -> dict:
    ...
    if "identified_rule_ids" in value:
        ...
        out["IdentifiedRuleIds"] = (
            aws_sdk_network_firewall.types.rule_id_list.serialize_aws_json_1_0(
    ...
    if "identified_type" in value:
        ...
        out["IdentifiedType"] = (
            aws_sdk_network_firewall.types.identified_type.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> AnalysisResult:
    ...
    if "IdentifiedRuleIds" in data:
        ...
        out["identified_rule_ids"] = (
            aws_sdk_network_firewall.types.rule_id_list.deserialize_aws_json_1_0(
    ...
    if "IdentifiedType" in data:
        ...
        out["identified_type"] = (
            aws_sdk_network_firewall.types.identified_type.deserialize_aws_json_1_0(
                data["IdentifiedType"]
            )
        )
