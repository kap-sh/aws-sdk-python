"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UpdateFirewallDescriptionRequest``."""
...
class UpdateFirewallDescriptionRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: UpdateFirewallDescriptionRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> UpdateFirewallDescriptionRequest:
    out: UpdateFirewallDescriptionRequest = {}  # type: ignore[typeddict-item]
