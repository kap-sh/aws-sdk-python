...
if TYPE_CHECKING:
    import aws_sdk_network_firewall.types.proxy_rule_group_priority_result_priority
    import aws_sdk_network_firewall.types.resource_name


class ProxyRuleGroupPriorityResult(TypedDict):
    ...
    priority: NotRequired[
        "aws_sdk_network_firewall.types.proxy_rule_group_priority_result_priority.ProxyRuleGroupPriorityResultPriority"
    ]
