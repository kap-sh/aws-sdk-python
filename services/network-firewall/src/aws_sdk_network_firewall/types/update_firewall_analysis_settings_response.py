"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UpdateFirewallAnalysisSettingsResponse``."""
...
class UpdateFirewallAnalysisSettingsResponse(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: UpdateFirewallAnalysisSettingsResponse) -> dict:
    out: dict = {}
