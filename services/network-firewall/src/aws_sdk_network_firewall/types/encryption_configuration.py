...
if TYPE_CHECKING:
    import aws_sdk_network_firewall.types.encryption_type
...
def serialize_aws_json_1_0(value: EncryptionConfiguration) -> dict:
    ...
    out["Type"] = aws_sdk_network_firewall.types.encryption_type.serialize_aws_json_1_0(
        value["type"]
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> EncryptionConfiguration:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_network_firewall.types.encryption_type.deserialize_aws_json_1_0(
                data["Type"]
            )
        )
    else:
