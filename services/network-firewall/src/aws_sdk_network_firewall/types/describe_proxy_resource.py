...
if TYPE_CHECKING:
    ...
    import aws_sdk_network_firewall.types.private_dns_name
    ...
    import aws_sdk_network_firewall.types.vpc_endpoint_service_name


class DescribeProxyResource(TypedDict):
    ...
    vpc_endpoint_service_name: NotRequired[
        "aws_sdk_network_firewall.types.vpc_endpoint_service_name.VpcEndpointServiceName"
    ]
    """<p>The service endpoint created in the VPC. </p>"""
    private_dns_name: NotRequired[
        "aws_sdk_network_firewall.types.private_dns_name.PrivateDNSName"
    ]
