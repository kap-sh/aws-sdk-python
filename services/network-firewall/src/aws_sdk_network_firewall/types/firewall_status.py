...
if TYPE_CHECKING:
    import aws_sdk_network_firewall.types.capacity_usage_summary
    import aws_sdk_network_firewall.types.configuration_sync_state
    import aws_sdk_network_firewall.types.firewall_status_value
    import aws_sdk_network_firewall.types.sync_states
...
class FirewallStatus(TypedDict, closed=True):
    ...
    configuration_sync_state_summary: (
        "aws_sdk_network_firewall.types.configuration_sync_state.ConfigurationSyncState"
    )
    ...
    sync_states: NotRequired["aws_sdk_network_firewall.types.sync_states.SyncStates"]
    ...
    capacity_usage_summary: NotRequired[
        "aws_sdk_network_firewall.types.capacity_usage_summary.CapacityUsageSummary"
    ]
    ...
    transit_gateway_attachment_sync_state: NotRequired[
        "aws_sdk_network_firewall.types.transit_gateway_attachment_sync_state.TransitGatewayAttachmentSyncState"
    ]
...
def serialize_aws_json_1_0(value: FirewallStatus) -> dict:
    ...
    out["ConfigurationSyncStateSummary"] = (
        aws_sdk_network_firewall.types.configuration_sync_state.serialize_aws_json_1_0(
    ...
    if "sync_states" in value:
        ...
        out["SyncStates"] = (
            aws_sdk_network_firewall.types.sync_states.serialize_aws_json_1_0(
                value["sync_states"]
            )
        )
    if "capacity_usage_summary" in value:
        ...
        out["CapacityUsageSummary"] = (
            aws_sdk_network_firewall.types.capacity_usage_summary.serialize_aws_json_1_0(
    ...
    if "transit_gateway_attachment_sync_state" in value:
        ...
        out["TransitGatewayAttachmentSyncState"] = (
            aws_sdk_network_firewall.types.transit_gateway_attachment_sync_state.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> FirewallStatus:
    ...
    if "ConfigurationSyncStateSummary" in data:
        ...
        out["configuration_sync_state_summary"] = (
            aws_sdk_network_firewall.types.configuration_sync_state.deserialize_aws_json_1_0(
    ...
    if "SyncStates" in data:
        ...
        out["sync_states"] = (
            aws_sdk_network_firewall.types.sync_states.deserialize_aws_json_1_0(
                data["SyncStates"]
            )
        )
    if "CapacityUsageSummary" in data:
        ...
        out["capacity_usage_summary"] = (
            aws_sdk_network_firewall.types.capacity_usage_summary.deserialize_aws_json_1_0(
    ...
    if "TransitGatewayAttachmentSyncState" in data:
        ...
        out["transit_gateway_attachment_sync_state"] = (
            aws_sdk_network_firewall.types.transit_gateway_attachment_sync_state.deserialize_aws_json_1_0(
