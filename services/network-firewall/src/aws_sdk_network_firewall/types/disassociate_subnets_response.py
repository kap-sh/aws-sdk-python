"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DisassociateSubnetsResponse``."""
...
class DisassociateSubnetsResponse(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DisassociateSubnetsResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> DisassociateSubnetsResponse:
    out: DisassociateSubnetsResponse = {}  # type: ignore[typeddict-item]
