...
if TYPE_CHECKING:
    ...
    import aws_sdk_network_firewall.types.enable_tls_session_holding
    import aws_sdk_network_firewall.types.policy_variables
    import aws_sdk_network_firewall.types.resource_arn
    import aws_sdk_network_firewall.types.stateful_actions
    import aws_sdk_network_firewall.types.stateful_engine_options
    import aws_sdk_network_firewall.types.stateful_rule_group_references
...
class FirewallPolicy(TypedDict):
    ...
    stateful_rule_group_references: NotRequired[
        "aws_sdk_network_firewall.types.stateful_rule_group_references.StatefulRuleGroupReferences"
    ]
    ...
    stateful_default_actions: NotRequired[
        "aws_sdk_network_firewall.types.stateful_actions.StatefulActions"
    ]
    ...
    stateful_engine_options: NotRequired[
        "aws_sdk_network_firewall.types.stateful_engine_options.StatefulEngineOptions"
    ]
    ...
    policy_variables: NotRequired[
        "aws_sdk_network_firewall.types.policy_variables.PolicyVariables"
    ]
    ...
    enable_tls_session_holding: NotRequired[
        "aws_sdk_network_firewall.types.enable_tls_session_holding.EnableTLSSessionHolding"
    ]
...
def serialize_aws_json_1_0(value: FirewallPolicy) -> dict:
    ...
    if "stateless_rule_group_references" in value:
        ...
        out["StatelessRuleGroupReferences"] = (
            aws_sdk_network_firewall.types.stateless_rule_group_references.serialize_aws_json_1_0(
    ...
    if "stateful_rule_group_references" in value:
        ...
        out["StatefulRuleGroupReferences"] = (
            aws_sdk_network_firewall.types.stateful_rule_group_references.serialize_aws_json_1_0(
    ...
    if "stateful_default_actions" in value:
        ...
        out["StatefulDefaultActions"] = (
            aws_sdk_network_firewall.types.stateful_actions.serialize_aws_json_1_0(
    ...
    if "stateful_engine_options" in value:
        ...
        out["StatefulEngineOptions"] = (
            aws_sdk_network_firewall.types.stateful_engine_options.serialize_aws_json_1_0(
    ...
    if "policy_variables" in value:
        ...
        out["PolicyVariables"] = (
            aws_sdk_network_firewall.types.policy_variables.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> FirewallPolicy:
    ...
    if "StatelessRuleGroupReferences" in data:
        ...
        out["stateless_rule_group_references"] = (
            aws_sdk_network_firewall.types.stateless_rule_group_references.deserialize_aws_json_1_0(
    ...
    if "StatefulRuleGroupReferences" in data:
        ...
        out["stateful_rule_group_references"] = (
            aws_sdk_network_firewall.types.stateful_rule_group_references.deserialize_aws_json_1_0(
    ...
    if "StatefulDefaultActions" in data:
        ...
        out["stateful_default_actions"] = (
            aws_sdk_network_firewall.types.stateful_actions.deserialize_aws_json_1_0(
    ...
    if "StatefulEngineOptions" in data:
        ...
        out["stateful_engine_options"] = (
            aws_sdk_network_firewall.types.stateful_engine_options.deserialize_aws_json_1_0(
    ...
    if "PolicyVariables" in data:
        ...
        out["policy_variables"] = (
            aws_sdk_network_firewall.types.policy_variables.deserialize_aws_json_1_0(
