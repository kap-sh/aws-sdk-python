...
if TYPE_CHECKING:
    import aws_sdk_network_firewall.types.attachment_id
    import aws_sdk_network_firewall.types.transit_gateway_attachment_status
    import aws_sdk_network_firewall.types.transit_gateway_attachment_sync_state_message


class TransitGatewayAttachmentSyncState(TypedDict):
    attachment_id: NotRequired[
        "aws_sdk_network_firewall.types.attachment_id.AttachmentId"
    ]
    """<p>The unique identifier of the transit gateway attachment.</p>"""
    transit_gateway_attachment_status: NotRequired[
        "aws_sdk_network_firewall.types.transit_gateway_attachment_status.TransitGatewayAttachmentStatus"
    ]
