...
class DescribeFlowOperationResponse(TypedDict):
    ...
    flow_operation: NotRequired[
        "aws_sdk_network_firewall.types.flow_operation.FlowOperation"
    ]
...
def serialize_aws_json_1_0(value: DescribeFlowOperationResponse) -> dict:
    ...
    if "flow_operation" in value:
        ...
        out["FlowOperation"] = (
            aws_sdk_network_firewall.types.flow_operation.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DescribeFlowOperationResponse:
    ...
    if "FlowOperation" in data:
        ...
        out["flow_operation"] = (
            aws_sdk_network_firewall.types.flow_operation.deserialize_aws_json_1_0(
                data["FlowOperation"]
            )
        )
    return out
