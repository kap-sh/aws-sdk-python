"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DetachRuleGroupsFromProxyConfigurationResponse``."""
...
class DetachRuleGroupsFromProxyConfigurationResponse(TypedDict, closed=True):
...
def serialize_aws_json_1_0(
    value: DetachRuleGroupsFromProxyConfigurationResponse,
) -> dict:
    out: dict = {}
