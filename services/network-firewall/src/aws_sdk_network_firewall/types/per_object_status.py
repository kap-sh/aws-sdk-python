...
def serialize_aws_json_1_0(value: PerObjectStatus) -> dict:
    ...
    if "sync_status" in value:
        ...
        out["SyncStatus"] = (
            aws_sdk_network_firewall.types.per_object_sync_status.serialize_aws_json_1_0(
                value["sync_status"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> PerObjectStatus:
    ...
    if "SyncStatus" in data:
        ...
        out["sync_status"] = (
            aws_sdk_network_firewall.types.per_object_sync_status.deserialize_aws_json_1_0(
                data["SyncStatus"]
            )
        )
