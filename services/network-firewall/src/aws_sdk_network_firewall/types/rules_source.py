...
if TYPE_CHECKING:
    ...
    import aws_sdk_network_firewall.types.stateful_rules
...
class RulesSource(TypedDict):
    ...
    rules_source_list: NotRequired[
        "aws_sdk_network_firewall.types.rules_source_list.RulesSourceList"
    ]
...
def serialize_aws_json_1_0(value: RulesSource) -> dict:
    ...
    if "rules_source_list" in value:
        ...
        out["RulesSourceList"] = (
            aws_sdk_network_firewall.types.rules_source_list.serialize_aws_json_1_0(
    ...
    if "stateful_rules" in value:
        ...
        out["StatefulRules"] = (
            aws_sdk_network_firewall.types.stateful_rules.serialize_aws_json_1_0(
    ...
    if "stateless_rules_and_custom_actions" in value:
        ...
        out["StatelessRulesAndCustomActions"] = (
            aws_sdk_network_firewall.types.stateless_rules_and_custom_actions.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> RulesSource:
    ...
    if "RulesSourceList" in data:
        ...
        out["rules_source_list"] = (
            aws_sdk_network_firewall.types.rules_source_list.deserialize_aws_json_1_0(
    ...
    if "StatefulRules" in data:
        ...
        out["stateful_rules"] = (
            aws_sdk_network_firewall.types.stateful_rules.deserialize_aws_json_1_0(
                data["StatefulRules"]
            )
        )
    if "StatelessRulesAndCustomActions" in data:
        ...
        out["stateless_rules_and_custom_actions"] = (
            aws_sdk_network_firewall.types.stateless_rules_and_custom_actions.deserialize_aws_json_1_0(
