"""Generated from Smithy shape ``com.amazonaws.networkfirewall#ListProxiesRequest``."""
...
class ListProxiesRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListProxiesRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> ListProxiesRequest:
    out: ListProxiesRequest = {}  # type: ignore[typeddict-item]
