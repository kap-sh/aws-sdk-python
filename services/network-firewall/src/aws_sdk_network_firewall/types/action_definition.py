...
if TYPE_CHECKING:
    import aws_sdk_network_firewall.types.publish_metric_action


class ActionDefinition(TypedDict, closed=True):
    publish_metric_action: NotRequired[
        "aws_sdk_network_firewall.types.publish_metric_action.PublishMetricAction"
    ]
...
def serialize_aws_json_1_0(value: ActionDefinition) -> dict:
    ...
    if "publish_metric_action" in value:
        ...
        out["PublishMetricAction"] = (
            aws_sdk_network_firewall.types.publish_metric_action.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ActionDefinition:
    ...
    if "PublishMetricAction" in data:
        ...
        out["publish_metric_action"] = (
            aws_sdk_network_firewall.types.publish_metric_action.deserialize_aws_json_1_0(
