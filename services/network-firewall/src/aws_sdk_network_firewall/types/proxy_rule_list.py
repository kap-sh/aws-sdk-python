...
ProxyRuleList: TypeAlias = list["aws_sdk_network_firewall.types.proxy_rule.ProxyRule"]
...
def serialize_aws_json_1_0(value: ProxyRuleList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_network_firewall.types.proxy_rule.serialize_aws_json_1_0(item)
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> ProxyRuleList:
    ...
    for item in data:
        out.append(
            aws_sdk_network_firewall.types.proxy_rule.deserialize_aws_json_1_0(item)
        )
    return out
