...
if TYPE_CHECKING:
    ...
    import aws_sdk_network_firewall.types.sync_state

SyncStates: TypeAlias = dict[
    "aws_sdk_network_firewall.types.availability_zone.AvailabilityZone",
    "aws_sdk_network_firewall.types.sync_state.SyncState",
]
...
def serialize_aws_json_1_0(input_to_serialize: SyncStates) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_network_firewall.types.sync_state.serialize_aws_json_1_0(
            value
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> SyncStates:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_network_firewall.types.sync_state.deserialize_aws_json_1_0(
            value
        )
    return out
