...
class NetworkFirewallError(Exception):
    """Base class for all NetworkFirewall service errors."""


class ServiceError(NetworkFirewallError):
...
class SerializationError(NetworkFirewallError):
    """Raised when a value cannot be serialized."""


class DeserializationError(NetworkFirewallError):
...
class WaiterFailedError(NetworkFirewallError):
...
class WaiterTimeoutError(NetworkFirewallError):
