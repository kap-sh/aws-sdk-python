"""Generated from Smithy shape ``com.amazonaws.networkfirewall#InternalServerError``."""
...
class InternalServerError(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.networkfirewall#InternalServerError``."""
