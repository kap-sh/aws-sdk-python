"""Generated from Smithy shape ``com.amazonaws.osis#InvalidPaginationTokenException``."""
...
class InvalidPaginationTokenException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.osis#InvalidPaginationTokenException``."""
