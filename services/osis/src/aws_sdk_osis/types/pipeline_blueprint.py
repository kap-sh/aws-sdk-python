...
class PipelineBlueprint(TypedDict):
    blueprint_name: NotRequired["aws_sdk_osis.types.string.String"]
    """<p>The name of the blueprint.</p>"""
    pipeline_configuration_body: NotRequired["aws_sdk_osis.types.string.String"]
    """<p>The YAML configuration of the blueprint.</p>"""
    display_name: NotRequired["aws_sdk_osis.types.string.String"]
    """<p>The display name of the blueprint.</p>"""
    display_description: NotRequired["aws_sdk_osis.types.string.String"]
    """<p>A description of the blueprint.</p>"""
    service: NotRequired["aws_sdk_osis.types.string.String"]
    """<p>The name of the service that the blueprint is associated with.</p>"""
    use_case: NotRequired["aws_sdk_osis.types.string.String"]
