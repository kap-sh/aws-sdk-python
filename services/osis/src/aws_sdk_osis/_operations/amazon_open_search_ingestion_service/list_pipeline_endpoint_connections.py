"""Generated from Smithy shape ``com.amazonaws.osis#ListPipelineEndpointConnections``."""
...
def handle_response(
    ...
    out: aws_sdk_osis.types.list_pipeline_endpoint_connections_response.ListPipelineEndpointConnectionsResponse = aws_sdk_osis.types.list_pipeline_endpoint_connections_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_osis.types.list_pipeline_endpoint_connections_request.ListPipelineEndpointConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2022-01-01/osis/listPipelineEndpointConnections"
    params: dict[str, str] = {}
...
async def async_list_pipeline_endpoint_connections(
