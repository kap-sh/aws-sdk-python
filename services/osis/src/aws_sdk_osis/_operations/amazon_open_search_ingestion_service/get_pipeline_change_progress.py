...
def handle_response(
    ...
    out: aws_sdk_osis.types.get_pipeline_change_progress_response.GetPipelineChangeProgressResponse = aws_sdk_osis.types.get_pipeline_change_progress_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_osis.types.get_pipeline_change_progress_request.GetPipelineChangeProgressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
