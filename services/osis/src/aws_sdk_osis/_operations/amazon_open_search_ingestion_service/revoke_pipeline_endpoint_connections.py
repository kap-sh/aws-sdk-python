...
def handle_response(
    ...
    out: aws_sdk_osis.types.revoke_pipeline_endpoint_connections_response.RevokePipelineEndpointConnectionsResponse = aws_sdk_osis.types.revoke_pipeline_endpoint_connections_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_osis.types.revoke_pipeline_endpoint_connections_request.RevokePipelineEndpointConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_osis.types.revoke_pipeline_endpoint_connections_request.serialize_json(
            input_
        )
    ).encode()
