"""Generated from Smithy shape ``com.amazonaws.osis#DeletePipeline``."""
...
def handle_response(
    ...
    out: aws_sdk_osis.types.delete_pipeline_response.DeletePipelineResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_osis.types.delete_pipeline_request.DeletePipelineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2022-01-01/osis/deletePipeline/{PipelineName}"
...
def delete_pipeline(
    ...
    aws_sdk_osis.types.delete_pipeline_response.DeletePipelineResponse, zapros.Response
]:
