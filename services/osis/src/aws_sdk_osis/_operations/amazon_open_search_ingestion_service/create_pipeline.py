"""Generated from Smithy shape ``com.amazonaws.osis#CreatePipeline``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceAlreadyExistsException":
            import aws_sdk_osis.errors.resource_already_exists_exception

            raise aws_sdk_osis.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_json(
                data
            )
        case "ResourceNotFoundException":
            import aws_sdk_osis.errors.resource_not_found_exception

            raise aws_sdk_osis.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_osis.types.create_pipeline_response.CreatePipelineResponse = (
        aws_sdk_osis.types.create_pipeline_response.deserialize_json(
...
def get_signer(
...
) -> aws_sdk_osis._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_osis._auth._sigv4.build_sigv4_auth_scheme("osis", options.region)
        )
        if sigv4_config is not None:
            return aws_sdk_osis._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_osis.types.create_pipeline_request.CreatePipelineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2022-01-01/osis/createPipeline"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_osis.types.create_pipeline_request

    body: bytes | None = json.dumps(
        aws_sdk_osis.types.create_pipeline_request.serialize_json(input_)
    ).encode()
...
def create_pipeline(
    ...
    aws_sdk_osis.types.create_pipeline_response.CreatePipelineResponse, zapros.Response
]:
