...
def build_request(
    ...
    input: aws_sdk_osis.types.create_pipeline_endpoint_request.CreatePipelineEndpointRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_osis.types.create_pipeline_endpoint_request.serialize_json(input)
    ).encode()
