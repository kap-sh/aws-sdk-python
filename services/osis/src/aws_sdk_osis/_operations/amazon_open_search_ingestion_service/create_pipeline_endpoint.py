"""Generated from Smithy shape ``com.amazonaws.osis#CreatePipelineEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_osis.types.create_pipeline_endpoint_response.CreatePipelineEndpointResponse = aws_sdk_osis.types.create_pipeline_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_osis.types.create_pipeline_endpoint_request.CreatePipelineEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2022-01-01/osis/createPipelineEndpoint"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_osis.types.create_pipeline_endpoint_request

    body: bytes | None = json.dumps(
        aws_sdk_osis.types.create_pipeline_endpoint_request.serialize_json(input_)
    ).encode()
...
async def async_create_pipeline_endpoint(
