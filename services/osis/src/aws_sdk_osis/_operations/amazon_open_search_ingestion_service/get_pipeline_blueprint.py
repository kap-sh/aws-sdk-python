...
def handle_response(
    ...
    out: aws_sdk_osis.types.get_pipeline_blueprint_response.GetPipelineBlueprintResponse = aws_sdk_osis.types.get_pipeline_blueprint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_osis.types.get_pipeline_blueprint_request.GetPipelineBlueprintRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{BlueprintName}", quote(str(input_["blueprint_name"]), safe=""))
    params: dict[str, str] = {}
    if "format" in input_:
