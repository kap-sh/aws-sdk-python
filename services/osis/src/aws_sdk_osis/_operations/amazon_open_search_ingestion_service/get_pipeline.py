...
def handle_response(
    ...
    out: aws_sdk_osis.types.get_pipeline_response.GetPipelineResponse = (
        aws_sdk_osis.types.get_pipeline_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_osis.types.get_pipeline_request.GetPipelineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_pipeline(
    ...
    aws_sdk_osis.types.get_pipeline_response.GetPipelineResponse, zapros.Response
]:
