...
def handle_response(
    ...
    out: aws_sdk_osis.types.list_pipelines_response.ListPipelinesResponse = (
        aws_sdk_osis.types.list_pipelines_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_osis.types.list_pipelines_request.ListPipelinesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_pipelines(
    ...
    aws_sdk_osis.types.list_pipelines_response.ListPipelinesResponse, zapros.Response
]:
