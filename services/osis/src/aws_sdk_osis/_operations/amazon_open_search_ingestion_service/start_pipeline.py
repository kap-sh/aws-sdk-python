"""Generated from Smithy shape ``com.amazonaws.osis#StartPipeline``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_osis.errors.conflict_exception

            raise aws_sdk_osis.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_osis.types.start_pipeline_response.StartPipelineResponse = (
        aws_sdk_osis.types.start_pipeline_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_osis.types.start_pipeline_request.StartPipelineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2022-01-01/osis/startPipeline/{PipelineName}"
    url = url.replace("{PipelineName}", quote(str(input_["pipeline_name"]), safe=""))
    params: dict[str, str] = {}
...
def start_pipeline(
    ...
    aws_sdk_osis.types.start_pipeline_response.StartPipelineResponse, zapros.Response
]:
...
async def async_start_pipeline(
