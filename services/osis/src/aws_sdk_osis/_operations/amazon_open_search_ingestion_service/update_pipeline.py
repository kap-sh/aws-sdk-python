...
def handle_response(
    ...
    out: aws_sdk_osis.types.update_pipeline_response.UpdatePipelineResponse = (
        aws_sdk_osis.types.update_pipeline_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_osis.types.update_pipeline_request.UpdatePipelineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_osis.types.update_pipeline_request.serialize_json(input_)
    ).encode()
...
def update_pipeline(
    ...
    aws_sdk_osis.types.update_pipeline_response.UpdatePipelineResponse, zapros.Response
]:
