"""Generated from Smithy shape ``com.amazonaws.osis#DeletePipelineEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_osis.types.delete_pipeline_endpoint_response.DeletePipelineEndpointResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_osis.types.delete_pipeline_endpoint_request.DeletePipelineEndpointRequest,
) -> zapros.Request:
...
async def async_delete_pipeline_endpoint(
