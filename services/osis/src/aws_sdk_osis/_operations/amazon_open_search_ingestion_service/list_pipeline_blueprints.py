...
import aws_sdk_osis.errors.invalid_pagination_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPaginationTokenException":
            raise aws_sdk_osis.errors.invalid_pagination_token_exception.InvalidPaginationTokenException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_osis.types.list_pipeline_blueprints_response.ListPipelineBlueprintsResponse = aws_sdk_osis.types.list_pipeline_blueprints_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_osis.types.list_pipeline_blueprints_request.ListPipelineBlueprintsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
