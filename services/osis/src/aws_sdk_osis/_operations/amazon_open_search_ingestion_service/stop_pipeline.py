...
def handle_response(
    ...
    out: aws_sdk_osis.types.stop_pipeline_response.StopPipelineResponse = (
        aws_sdk_osis.types.stop_pipeline_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_osis.types.stop_pipeline_request.StopPipelineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def stop_pipeline(
    ...
    aws_sdk_osis.types.stop_pipeline_response.StopPipelineResponse, zapros.Response
]:
