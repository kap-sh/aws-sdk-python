"""Generated from Smithy shape ``com.amazonaws.osis#GetResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_osis.types.get_resource_policy_response.GetResourcePolicyResponse = (
        aws_sdk_osis.types.get_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_osis.types.get_resource_policy_request.GetResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2022-01-01/osis/resourcePolicy/{ResourceArn}"
