"""Generated from Smithy shape ``com.amazonaws.osis#ValidatePipeline``."""
...
def handle_response(
    ...
    out: aws_sdk_osis.types.validate_pipeline_response.ValidatePipelineResponse = (
        aws_sdk_osis.types.validate_pipeline_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_osis.types.validate_pipeline_request.ValidatePipelineRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2022-01-01/osis/validatePipeline"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_osis.types.validate_pipeline_request

    body: bytes | None = json.dumps(
        aws_sdk_osis.types.validate_pipeline_request.serialize_json(input_)
    ).encode()
...
async def async_validate_pipeline(
