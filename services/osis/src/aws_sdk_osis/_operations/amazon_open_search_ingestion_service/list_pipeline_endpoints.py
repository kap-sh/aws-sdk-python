"""Generated from Smithy shape ``com.amazonaws.osis#ListPipelineEndpoints``."""
...
def build_request(
    ...
    input_: aws_sdk_osis.types.list_pipeline_endpoints_request.ListPipelineEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2022-01-01/osis/listPipelineEndpoints"
    params: dict[str, str] = {}
...
async def async_list_pipeline_endpoints(
