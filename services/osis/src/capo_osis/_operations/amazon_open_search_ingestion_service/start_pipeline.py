...
import capo_osis.errors.conflict_exception
import capo_osis.errors.disabled_operation_exception
import capo_osis.errors.internal_exception
import capo_osis.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_osis.errors.conflict_exception.ConflictException.from_json(data)
        ...
        case "ResourceNotFoundException":
            raise capo_osis.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_osis.types.start_pipeline_response.StartPipelineResponse = (
        capo_osis.types.start_pipeline_response.deserialize_json(
...
def start_pipeline(
    ...
    capo_osis.types.start_pipeline_response.StartPipelineResponse, zapros.Response
]:
