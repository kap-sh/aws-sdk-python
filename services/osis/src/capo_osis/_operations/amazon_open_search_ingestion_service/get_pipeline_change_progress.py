"""Generated from Smithy shape ``com.amazonaws.osis#GetPipelineChangeProgress``."""
...
def handle_response(
    ...
    out: capo_osis.types.get_pipeline_change_progress_response.GetPipelineChangeProgressResponse = capo_osis.types.get_pipeline_change_progress_response.deserialize_json(
...
async def async_get_pipeline_change_progress(
