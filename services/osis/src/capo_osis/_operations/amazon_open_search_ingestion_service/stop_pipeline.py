"""Generated from Smithy shape ``com.amazonaws.osis#StopPipeline``."""
...
def handle_response(
    ...
    out: capo_osis.types.stop_pipeline_response.StopPipelineResponse = (
        capo_osis.types.stop_pipeline_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2022-01-01/osis/stopPipeline/{PipelineName}"
...
def stop_pipeline(
    ...
    capo_osis.types.stop_pipeline_response.StopPipelineResponse, zapros.Response
]:
