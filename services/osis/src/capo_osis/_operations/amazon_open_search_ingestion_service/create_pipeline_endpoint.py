...
import capo_osis.errors.limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise capo_osis.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_osis.types.create_pipeline_endpoint_response.CreatePipelineEndpointResponse = capo_osis.types.create_pipeline_endpoint_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_osis.types.create_pipeline_endpoint_request.serialize_json(input_)
    ).encode()
