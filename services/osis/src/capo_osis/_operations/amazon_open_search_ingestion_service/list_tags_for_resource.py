"""Generated from Smithy shape ``com.amazonaws.osis#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_osis.types.list_tags_for_resource_response.ListTagsForResourceResponse = (
        capo_osis.types.list_tags_for_resource_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2022-01-01/osis/listTagsForResource"
    params: dict[str, str] = {}
    if "arn" in input_:
