"""Generated from Smithy shape ``com.amazonaws.osis#PutResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_osis.types.put_resource_policy_response.PutResourcePolicyResponse = (
        capo_osis.types.put_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_osis.types.put_resource_policy_request.serialize_json(input_)
    ).encode()
