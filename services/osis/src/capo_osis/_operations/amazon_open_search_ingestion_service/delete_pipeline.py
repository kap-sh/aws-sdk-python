...
def handle_response(
    ...
    out: capo_osis.types.delete_pipeline_response.DeletePipelineResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_pipeline(
    ...
    capo_osis.types.delete_pipeline_response.DeletePipelineResponse, zapros.Response
]:
