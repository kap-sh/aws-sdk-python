"""Generated from Smithy shape ``com.amazonaws.opensearch#NodeToNodeEncryptionOptionsStatus``."""
...
class NodeToNodeEncryptionOptionsStatus(TypedDict, closed=True):
    options: "capo_opensearch.types.node_to_node_encryption_options.NodeToNodeEncryptionOptions"
