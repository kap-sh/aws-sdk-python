...
if TYPE_CHECKING:
    ...
    import capo_opensearch.types.off_peak_window


class OffPeakWindowOptions(TypedDict, closed=True):
    ...
    off_peak_window: NotRequired["capo_opensearch.types.off_peak_window.OffPeakWindow"]
...
def serialize_json(value: OffPeakWindowOptions) -> dict:
    ...
    if "off_peak_window" in value:
        ...
        out["OffPeakWindow"] = capo_opensearch.types.off_peak_window.serialize_json(
...
def deserialize_json(data: dict) -> OffPeakWindowOptions:
    ...
    if "OffPeakWindow" in data:
        ...
        out["off_peak_window"] = capo_opensearch.types.off_peak_window.deserialize_json(
            data["OffPeakWindow"]
        )
    return out
