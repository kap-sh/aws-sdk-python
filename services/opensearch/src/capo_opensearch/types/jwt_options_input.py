...
if TYPE_CHECKING:
    ...
    import capo_opensearch.types.roles_key
    import capo_opensearch.types.string
    import capo_opensearch.types.subject_key
...
class JWTOptionsInput(TypedDict, closed=True):
    ...
    subject_key: NotRequired["capo_opensearch.types.subject_key.SubjectKey"]
    """<p>Element of the JWT assertion to use for the user name.</p>"""
    roles_key: NotRequired["capo_opensearch.types.roles_key.RolesKey"]
