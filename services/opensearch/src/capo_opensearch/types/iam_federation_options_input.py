...
if TYPE_CHECKING:
    ...
    import capo_opensearch.types.iam_federation_roles_key
    import capo_opensearch.types.iam_federation_subject_key
...
class IAMFederationOptionsInput(TypedDict, closed=True):
    ...
    subject_key: NotRequired[
        "capo_opensearch.types.iam_federation_subject_key.IAMFederationSubjectKey"
    ]
    """<p>The key in the SAML assertion that contains the user's subject identifier.</p>"""
    roles_key: NotRequired[
        "capo_opensearch.types.iam_federation_roles_key.IAMFederationRolesKey"
    ]
