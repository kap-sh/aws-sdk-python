...
if TYPE_CHECKING:
    ...
    import capo_opensearch.types.identity_center_application_arn
    import capo_opensearch.types.identity_center_instance_arn
    import capo_opensearch.types.identity_store_id
...
class IdentityCenterOptions(TypedDict, closed=True):
    enabled_api_access: NotRequired["capo_opensearch.types.boolean.Boolean"]
    """<p>Indicates whether IAM Identity Center is enabled for the application.</p>"""
    identity_center_instance_arn: NotRequired[
        "capo_opensearch.types.identity_center_instance_arn.IdentityCenterInstanceARN"
    ]
    """<p>The Amazon Resource Name (ARN) of the IAM Identity Center instance.</p>"""
    identity_center_instance_region: NotRequired["capo_opensearch.types.region.Region"]
    """<p>The Region of the IAM Identity Center instance.</p>"""
    subject_key: NotRequired[
        "capo_opensearch.types.subject_key_id_c_option.SubjectKeyIdCOption"
    ]
    ...
    roles_key: NotRequired[
        "capo_opensearch.types.roles_key_id_c_option.RolesKeyIdCOption"
    ]
    ...
    identity_center_application_arn: NotRequired[
        "capo_opensearch.types.identity_center_application_arn.IdentityCenterApplicationARN"
    ]
    ...
    identity_store_id: NotRequired[
        "capo_opensearch.types.identity_store_id.IdentityStoreId"
    ]
...
def serialize_json(value: IdentityCenterOptions) -> dict:
    ...
    if "subject_key" in value:
        ...
        out["SubjectKey"] = (
            capo_opensearch.types.subject_key_id_c_option.serialize_json(
                value["subject_key"]
            )
        )
    if "roles_key" in value:
        ...
        out["RolesKey"] = capo_opensearch.types.roles_key_id_c_option.serialize_json(
            value["roles_key"]
        )
...
def deserialize_json(data: dict) -> IdentityCenterOptions:
    ...
    if "SubjectKey" in data:
        ...
        out["subject_key"] = (
            capo_opensearch.types.subject_key_id_c_option.deserialize_json(
                data["SubjectKey"]
            )
        )
    if "RolesKey" in data:
