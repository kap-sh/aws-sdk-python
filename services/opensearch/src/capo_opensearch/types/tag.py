...
if TYPE_CHECKING:
    import capo_opensearch.types.tag_key
    import capo_opensearch.types.tag_value


class Tag(TypedDict, closed=True):
    key: "capo_opensearch.types.tag_key.TagKey"
    """<p>The tag key. Tag keys must be unique for the domain to which they are attached.</p>"""
    value: "capo_opensearch.types.tag_value.TagValue"
