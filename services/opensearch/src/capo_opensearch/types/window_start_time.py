...
if TYPE_CHECKING:
    import capo_opensearch.types.start_time_hours
    import capo_opensearch.types.start_time_minutes


class WindowStartTime(TypedDict, closed=True):
    hours: "capo_opensearch.types.start_time_hours.StartTimeHours"
    ...
    minutes: "capo_opensearch.types.start_time_minutes.StartTimeMinutes"
