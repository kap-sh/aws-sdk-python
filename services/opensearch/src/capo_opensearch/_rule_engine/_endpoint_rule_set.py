        ...
        if _locals["PartitionResult"] is not None:
                ...
                if p.UseDualStack is True:
                    if True is get_attr(
                        ...
                        if True is get_attr(
                            ...
                            return Endpoint(
                                url=interpolate(
                                    "https://es-fips.{Region}.{PartitionResult#dualStackDnsSuffix}",
                                    p,
                                    _locals,
                                ),
                                properties={},
            ...
            if p.UseFIPS is True:
                if (
                    ...
                    return Endpoint(
                        url=interpolate(
                            "https://es-fips.{Region}.{PartitionResult#dnsSuffix}",
                            p,
                            _locals,
                        ),
                        properties={},
            ...
            if p.UseDualStack is True:
                if True is get_attr(
                    ...
                    if string_equals(
                        ...
                        return Endpoint(
                            url=interpolate("https://aos.{Region}.api.aws", p, _locals),
                            properties={},
                            headers={},
                        )
                    if string_equals(
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://aos.{Region}.api.amazonwebservices.com.cn",
                                p,
                                _locals,
                            ),
                            properties={},
                    ...
                    return Endpoint(
                        url=interpolate(
                            "https://es.{Region}.{PartitionResult#dualStackDnsSuffix}",
                            p,
                            _locals,
                        ),
                        properties={},
            ...
            return Endpoint(
                url=interpolate(
                    "https://es.{Region}.{PartitionResult#dnsSuffix}", p, _locals
                ),
                properties={},
                headers={},
            )
