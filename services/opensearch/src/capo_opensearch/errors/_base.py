...
class OpenSearchError(Exception):
    """Base class for all OpenSearch service errors."""


class ServiceError(OpenSearchError):
...
class SerializationError(OpenSearchError):
    """Raised when a value cannot be serialized."""


class DeserializationError(OpenSearchError):
...
class WaiterFailedError(OpenSearchError):
...
class WaiterTimeoutError(OpenSearchError):
