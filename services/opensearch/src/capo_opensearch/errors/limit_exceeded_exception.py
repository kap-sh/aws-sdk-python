"""Generated from Smithy shape ``com.amazonaws.opensearch#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.opensearch#LimitExceededException``."""
