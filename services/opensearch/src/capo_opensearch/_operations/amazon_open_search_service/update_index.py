"""Generated from Smithy shape ``com.amazonaws.opensearch#UpdateIndex``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.update_index_response.UpdateIndexResponse = (
        capo_opensearch.types.update_index_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.update_index_request.serialize_json(input_)
    ).encode()
...
def update_index(
    ...
    capo_opensearch.types.update_index_response.UpdateIndexResponse, zapros.Response
]:
