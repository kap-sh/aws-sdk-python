"""Generated from Smithy shape ``com.amazonaws.opensearch#DeleteVpcEndpoint``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.delete_vpc_endpoint_response.DeleteVpcEndpointResponse = capo_opensearch.types.delete_vpc_endpoint_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/2021-01-01/opensearch/vpcEndpoints/{VpcEndpointId}"
    )
