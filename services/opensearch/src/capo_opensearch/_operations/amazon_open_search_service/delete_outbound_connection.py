"""Generated from Smithy shape ``com.amazonaws.opensearch#DeleteOutboundConnection``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.delete_outbound_connection_response.DeleteOutboundConnectionResponse = capo_opensearch.types.delete_outbound_connection_response.deserialize_json(
...
async def async_delete_outbound_connection(
