...
def handle_response(
    ...
    out: capo_opensearch.types.rollback_service_software_update_response.RollbackServiceSoftwareUpdateResponse = capo_opensearch.types.rollback_service_software_update_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.rollback_service_software_update_request.serialize_json(
            input_
        )
    ).encode()
