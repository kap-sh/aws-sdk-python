...
def handle_response(
    ...
    out: capo_opensearch.types.describe_packages_response.DescribePackagesResponse = (
        capo_opensearch.types.describe_packages_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.describe_packages_request.serialize_json(input_)
    ).encode()
