"""Generated from Smithy shape ``com.amazonaws.opensearch#CancelDomainConfigChange``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.cancel_domain_config_change_response.CancelDomainConfigChangeResponse = capo_opensearch.types.cancel_domain_config_change_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.cancel_domain_config_change_request.serialize_json(input_)
    ).encode()
