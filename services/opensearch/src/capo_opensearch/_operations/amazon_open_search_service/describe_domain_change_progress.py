"""Generated from Smithy shape ``com.amazonaws.opensearch#DescribeDomainChangeProgress``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.describe_domain_change_progress_response.DescribeDomainChangeProgressResponse = capo_opensearch.types.describe_domain_change_progress_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/2021-01-01/opensearch/domain/{DomainName}/progress"
    )
