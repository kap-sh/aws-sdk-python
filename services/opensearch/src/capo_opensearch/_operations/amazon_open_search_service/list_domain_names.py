"""Generated from Smithy shape ``com.amazonaws.opensearch#ListDomainNames``."""
...
import capo_opensearch.types.domain_info_list
...
def handle_response(
    ...
    out: capo_opensearch.types.list_domain_names_response.ListDomainNamesResponse = (
        capo_opensearch.types.list_domain_names_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/domain"
    params: dict[str, str] = {}
