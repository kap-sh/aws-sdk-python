"""Generated from Smithy shape ``com.amazonaws.opensearch#ListInstanceTypeDetails``."""
...
import capo_opensearch.errors.base_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BaseException":
            raise capo_opensearch.errors.base_exception.BaseException.from_json(data)
...
def handle_response(
    ...
    out: capo_opensearch.types.list_instance_type_details_response.ListInstanceTypeDetailsResponse = capo_opensearch.types.list_instance_type_details_response.deserialize_json(
...
def build_request(
    ...
    if "retrieve_a_zs" in input_:
        params["retrieveAZs"] = str(input_["retrieve_a_zs"])
    if "instance_type" in input_:
        params["instanceType"] = str(input_["instance_type"])
...
async def async_list_instance_type_details(
