...
def handle_response(
    ...
    out: capo_opensearch.types.create_vpc_endpoint_response.CreateVpcEndpointResponse = capo_opensearch.types.create_vpc_endpoint_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.create_vpc_endpoint_request.serialize_json(input_)
    ).encode()
