...
def handle_response(
    ...
    out: capo_opensearch.types.get_compatible_versions_response.GetCompatibleVersionsResponse = capo_opensearch.types.get_compatible_versions_response.deserialize_json(
