...
def handle_response(
    ...
    out: capo_opensearch.types.describe_domain_auto_tunes_response.DescribeDomainAutoTunesResponse = capo_opensearch.types.describe_domain_auto_tunes_response.deserialize_json(
