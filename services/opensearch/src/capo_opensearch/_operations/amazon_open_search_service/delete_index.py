...
def handle_response(
    ...
    out: capo_opensearch.types.delete_index_response.DeleteIndexResponse = (
        capo_opensearch.types.delete_index_response.deserialize_json(
...
def delete_index(
    ...
    capo_opensearch.types.delete_index_response.DeleteIndexResponse, zapros.Response
]:
