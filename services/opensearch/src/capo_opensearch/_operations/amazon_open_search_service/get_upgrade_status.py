"""Generated from Smithy shape ``com.amazonaws.opensearch#GetUpgradeStatus``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.get_upgrade_status_response.GetUpgradeStatusResponse = (
        capo_opensearch.types.get_upgrade_status_response.deserialize_json(
...
async def async_get_upgrade_status(
