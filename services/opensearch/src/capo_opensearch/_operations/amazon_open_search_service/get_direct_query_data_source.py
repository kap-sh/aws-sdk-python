...
def handle_response(
    ...
    out: capo_opensearch.types.get_direct_query_data_source_response.GetDirectQueryDataSourceResponse = capo_opensearch.types.get_direct_query_data_source_response.deserialize_json(
