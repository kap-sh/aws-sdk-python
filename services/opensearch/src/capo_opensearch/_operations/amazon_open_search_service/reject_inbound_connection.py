"""Generated from Smithy shape ``com.amazonaws.opensearch#RejectInboundConnection``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.reject_inbound_connection_response.RejectInboundConnectionResponse = capo_opensearch.types.reject_inbound_connection_response.deserialize_json(
...
async def async_reject_inbound_connection(
