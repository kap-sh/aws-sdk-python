...
def handle_response(
    ...
    out: capo_opensearch.types.describe_dry_run_progress_response.DescribeDryRunProgressResponse = capo_opensearch.types.describe_dry_run_progress_response.deserialize_json(
