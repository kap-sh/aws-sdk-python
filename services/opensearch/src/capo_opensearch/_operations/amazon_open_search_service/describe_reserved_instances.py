"""Generated from Smithy shape ``com.amazonaws.opensearch#DescribeReservedInstances``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.describe_reserved_instances_response.DescribeReservedInstancesResponse = capo_opensearch.types.describe_reserved_instances_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/opensearch/reservedInstances"
    params: dict[str, str] = {}
    if "reserved_instance_id" in input_:
        params["reservationId"] = str(input_["reserved_instance_id"])
