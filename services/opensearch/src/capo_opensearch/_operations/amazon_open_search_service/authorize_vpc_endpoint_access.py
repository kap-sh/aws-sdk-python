"""Generated from Smithy shape ``com.amazonaws.opensearch#AuthorizeVpcEndpointAccess``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.authorize_vpc_endpoint_access_response.AuthorizeVpcEndpointAccessResponse = capo_opensearch.types.authorize_vpc_endpoint_access_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.authorize_vpc_endpoint_access_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_authorize_vpc_endpoint_access(
