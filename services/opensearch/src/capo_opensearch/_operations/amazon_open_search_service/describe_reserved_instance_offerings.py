"""Generated from Smithy shape ``com.amazonaws.opensearch#DescribeReservedInstanceOfferings``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.describe_reserved_instance_offerings_response.DescribeReservedInstanceOfferingsResponse = capo_opensearch.types.describe_reserved_instance_offerings_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/opensearch/reservedInstanceOfferings"
    params: dict[str, str] = {}
    if "reserved_instance_offering_id" in input_:
        params["offeringId"] = str(input_["reserved_instance_offering_id"])
...
async def async_describe_reserved_instance_offerings(
