"""Generated from Smithy shape ``com.amazonaws.opensearch#GetPackageVersionHistory``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.get_package_version_history_response.GetPackageVersionHistoryResponse = capo_opensearch.types.get_package_version_history_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/packages/{PackageID}/history"
