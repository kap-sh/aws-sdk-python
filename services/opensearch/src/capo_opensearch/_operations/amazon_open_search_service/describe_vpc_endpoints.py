"""Generated from Smithy shape ``com.amazonaws.opensearch#DescribeVpcEndpoints``."""
...
import capo_opensearch.types.vpc_endpoint_error_list
import capo_opensearch.types.vpc_endpoint_id_list
import capo_opensearch.types.vpc_endpoints
...
def handle_response(
    ...
    out: capo_opensearch.types.describe_vpc_endpoints_response.DescribeVpcEndpointsResponse = capo_opensearch.types.describe_vpc_endpoints_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/opensearch/vpcEndpoints/describe"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_opensearch.types.describe_vpc_endpoints_request.serialize_json(input_)
    ).encode()
...
async def async_describe_vpc_endpoints(
