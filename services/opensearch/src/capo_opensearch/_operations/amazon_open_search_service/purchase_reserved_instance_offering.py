"""Generated from Smithy shape ``com.amazonaws.opensearch#PurchaseReservedInstanceOffering``."""
...
import capo_opensearch.errors.resource_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise capo_opensearch.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data
            )
        case "ResourceAlreadyExistsException":
            raise capo_opensearch.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_opensearch.types.purchase_reserved_instance_offering_response.PurchaseReservedInstanceOfferingResponse = capo_opensearch.types.purchase_reserved_instance_offering_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.purchase_reserved_instance_offering_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_purchase_reserved_instance_offering(
