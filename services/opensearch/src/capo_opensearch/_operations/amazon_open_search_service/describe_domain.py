"""Generated from Smithy shape ``com.amazonaws.opensearch#DescribeDomain``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.describe_domain_response.DescribeDomainResponse = (
        capo_opensearch.types.describe_domain_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/opensearch/domain/{DomainName}"
