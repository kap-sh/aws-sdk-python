...
def handle_response(
    ...
    out: capo_opensearch.types.get_default_application_setting_response.GetDefaultApplicationSettingResponse = capo_opensearch.types.get_default_application_setting_response.deserialize_json(
