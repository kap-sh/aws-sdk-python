"""Generated from Smithy shape ``com.amazonaws.opensearch#AcceptInboundConnection``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.accept_inbound_connection_response.AcceptInboundConnectionResponse = capo_opensearch.types.accept_inbound_connection_response.deserialize_json(
...
async def async_accept_inbound_connection(
