...
def handle_response(
    ...
    out: capo_opensearch.types.describe_domain_config_response.DescribeDomainConfigResponse = capo_opensearch.types.describe_domain_config_response.deserialize_json(
