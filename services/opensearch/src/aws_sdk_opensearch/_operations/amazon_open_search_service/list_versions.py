...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.list_versions_response.ListVersionsResponse = (
        aws_sdk_opensearch.types.list_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.list_versions_request.ListVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
