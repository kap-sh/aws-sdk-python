...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.list_tags_response.ListTagsResponse = (
        aws_sdk_opensearch.types.list_tags_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.list_tags_request.ListTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_tags(
    ...
    aws_sdk_opensearch.types.list_tags_response.ListTagsResponse, zapros.Response
]:
