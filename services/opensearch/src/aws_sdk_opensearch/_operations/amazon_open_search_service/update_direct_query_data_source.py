"""Generated from Smithy shape ``com.amazonaws.opensearch#UpdateDirectQueryDataSource``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.update_direct_query_data_source_response.UpdateDirectQueryDataSourceResponse = aws_sdk_opensearch.types.update_direct_query_data_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.update_direct_query_data_source_request.UpdateDirectQueryDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{DataSourceName}", quote(str(input_["data_source_name"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.update_direct_query_data_source_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_direct_query_data_source(
