...
def build_request(
    ...
    input: aws_sdk_opensearch.types.update_direct_query_data_source_request.UpdateDirectQueryDataSourceRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{DataSourceName}", quote(str(input["data_source_name"]), safe="")
    )
    params: dict[str, str] = {}
