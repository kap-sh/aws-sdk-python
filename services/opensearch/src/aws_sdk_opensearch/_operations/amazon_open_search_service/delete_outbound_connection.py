...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.delete_outbound_connection_response.DeleteOutboundConnectionResponse = aws_sdk_opensearch.types.delete_outbound_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.delete_outbound_connection_request.DeleteOutboundConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
