...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.list_vpc_endpoint_access_response.ListVpcEndpointAccessResponse = aws_sdk_opensearch.types.list_vpc_endpoint_access_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.list_vpc_endpoint_access_request.ListVpcEndpointAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
