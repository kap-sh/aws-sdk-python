...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.accept_inbound_connection_response.AcceptInboundConnectionResponse = aws_sdk_opensearch.types.accept_inbound_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.accept_inbound_connection_request.AcceptInboundConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
