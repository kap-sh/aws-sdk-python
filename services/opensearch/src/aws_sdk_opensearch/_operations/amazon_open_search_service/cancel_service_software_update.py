"""Generated from Smithy shape ``com.amazonaws.opensearch#CancelServiceSoftwareUpdate``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.cancel_service_software_update_response.CancelServiceSoftwareUpdateResponse = aws_sdk_opensearch.types.cancel_service_software_update_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.cancel_service_software_update_request.CancelServiceSoftwareUpdateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/2021-01-01/opensearch/serviceSoftwareUpdate/cancel"
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.cancel_service_software_update_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_cancel_service_software_update(
