...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.deregister_capability_response.DeregisterCapabilityResponse = aws_sdk_opensearch.types.deregister_capability_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_opensearch.types.deregister_capability_request.DeregisterCapabilityRequest,
) -> zapros.Request:
