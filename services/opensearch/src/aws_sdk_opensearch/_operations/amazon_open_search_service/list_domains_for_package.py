"""Generated from Smithy shape ``com.amazonaws.opensearch#ListDomainsForPackage``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.list_domains_for_package_response.ListDomainsForPackageResponse = aws_sdk_opensearch.types.list_domains_for_package_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.list_domains_for_package_request.ListDomainsForPackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/packages/{PackageID}/domains"
...
async def async_list_domains_for_package(
