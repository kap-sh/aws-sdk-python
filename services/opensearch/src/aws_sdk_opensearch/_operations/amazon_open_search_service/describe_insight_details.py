...
def build_request(
    ...
    input: aws_sdk_opensearch.types.describe_insight_details_request.DescribeInsightDetailsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.describe_insight_details_request.serialize_json(input)
    ).encode()
