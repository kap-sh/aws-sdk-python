"""Generated from Smithy shape ``com.amazonaws.opensearch#DescribeInsightDetails``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.describe_insight_details_response.DescribeInsightDetailsResponse = aws_sdk_opensearch.types.describe_insight_details_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.describe_insight_details_request.DescribeInsightDetailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/opensearch/insight-details"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_opensearch.types.describe_insight_details_request

    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.describe_insight_details_request.serialize_json(input_)
    ).encode()
...
async def async_describe_insight_details(
