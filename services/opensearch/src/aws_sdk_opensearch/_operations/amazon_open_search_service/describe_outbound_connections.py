...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.describe_outbound_connections_response.DescribeOutboundConnectionsResponse = aws_sdk_opensearch.types.describe_outbound_connections_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.describe_outbound_connections_request.DescribeOutboundConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.describe_outbound_connections_request.serialize_json(
            input_
        )
    ).encode()
