...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.list_instance_type_details_response.ListInstanceTypeDetailsResponse = aws_sdk_opensearch.types.list_instance_type_details_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_opensearch.types.list_instance_type_details_request.ListInstanceTypeDetailsRequest,
) -> zapros.Request:
    ...
    if "retrieve_a_zs" in input:
        params["retrieveAZs"] = str(input["retrieve_a_zs"])
    if "instance_type" in input:
        params["instanceType"] = str(input["instance_type"])
