"""Generated from Smithy shape ``com.amazonaws.opensearch#UpdateDataSource``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.update_data_source_response.UpdateDataSourceResponse = aws_sdk_opensearch.types.update_data_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.update_data_source_request.UpdateDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.update_data_source_request.serialize_json(input_)
    ).encode()
