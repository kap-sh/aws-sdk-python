...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.delete_inbound_connection_response.DeleteInboundConnectionResponse = aws_sdk_opensearch.types.delete_inbound_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.delete_inbound_connection_request.DeleteInboundConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
