...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.describe_domain_response.DescribeDomainResponse = (
        aws_sdk_opensearch.types.describe_domain_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.describe_domain_request.DescribeDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
