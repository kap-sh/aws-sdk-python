...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.delete_vpc_endpoint_response.DeleteVpcEndpointResponse = aws_sdk_opensearch.types.delete_vpc_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.delete_vpc_endpoint_request.DeleteVpcEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
