"""Generated from Smithy shape ``com.amazonaws.opensearch#ListDataSources``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.list_data_sources_response.ListDataSourcesResponse = (
        aws_sdk_opensearch.types.list_data_sources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.list_data_sources_request.ListDataSourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
