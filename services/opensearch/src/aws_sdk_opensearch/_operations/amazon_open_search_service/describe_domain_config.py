"""Generated from Smithy shape ``com.amazonaws.opensearch#DescribeDomainConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.describe_domain_config_response.DescribeDomainConfigResponse = aws_sdk_opensearch.types.describe_domain_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.describe_domain_config_request.DescribeDomainConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/opensearch/domain/{DomainName}/config"
...
async def async_describe_domain_config(
