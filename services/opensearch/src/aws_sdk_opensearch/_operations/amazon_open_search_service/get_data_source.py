"""Generated from Smithy shape ``com.amazonaws.opensearch#GetDataSource``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.get_data_source_response.GetDataSourceResponse = (
        aws_sdk_opensearch.types.get_data_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.get_data_source_request.GetDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
