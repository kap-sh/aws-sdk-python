...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.get_index_response.GetIndexResponse = (
        aws_sdk_opensearch.types.get_index_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_opensearch.types.get_index_request.GetIndexRequest,
) -> zapros.Request:
...
def get_index(
    ...
    aws_sdk_opensearch.types.get_index_response.GetIndexResponse, zapros.Response
]:
