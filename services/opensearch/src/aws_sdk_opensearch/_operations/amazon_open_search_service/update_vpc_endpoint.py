...
def build_request(
    ...
    input: aws_sdk_opensearch.types.update_vpc_endpoint_request.UpdateVpcEndpointRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.update_vpc_endpoint_request.serialize_json(input)
    ).encode()
