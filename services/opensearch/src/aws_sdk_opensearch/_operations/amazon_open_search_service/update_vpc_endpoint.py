"""Generated from Smithy shape ``com.amazonaws.opensearch#UpdateVpcEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.update_vpc_endpoint_response.UpdateVpcEndpointResponse = aws_sdk_opensearch.types.update_vpc_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.update_vpc_endpoint_request.UpdateVpcEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/opensearch/vpcEndpoints/update"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_opensearch.types.update_vpc_endpoint_request

    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.update_vpc_endpoint_request.serialize_json(input_)
    ).encode()
...
async def async_update_vpc_endpoint(
