...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.delete_data_source_response.DeleteDataSourceResponse = aws_sdk_opensearch.types.delete_data_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.delete_data_source_request.DeleteDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
