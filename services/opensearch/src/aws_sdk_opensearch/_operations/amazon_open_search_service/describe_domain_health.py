"""Generated from Smithy shape ``com.amazonaws.opensearch#DescribeDomainHealth``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.describe_domain_health_response.DescribeDomainHealthResponse = aws_sdk_opensearch.types.describe_domain_health_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.describe_domain_health_request.DescribeDomainHealthRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/opensearch/domain/{DomainName}/health"
...
async def async_describe_domain_health(
