...
def build_request(
    ...
    input: aws_sdk_opensearch.types.dissociate_packages_request.DissociatePackagesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.dissociate_packages_request.serialize_json(input)
    ).encode()
