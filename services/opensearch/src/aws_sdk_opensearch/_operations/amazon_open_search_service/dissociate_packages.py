...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.dissociate_packages_response.DissociatePackagesResponse = aws_sdk_opensearch.types.dissociate_packages_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.dissociate_packages_request.DissociatePackagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.dissociate_packages_request.serialize_json(input_)
    ).encode()
