"""Generated from Smithy shape ``com.amazonaws.opensearch#RemoveTags``."""
...
def build_request(
    ...
    input: aws_sdk_opensearch.types.remove_tags_request.RemoveTagsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.remove_tags_request.serialize_json(input)
    ).encode()
