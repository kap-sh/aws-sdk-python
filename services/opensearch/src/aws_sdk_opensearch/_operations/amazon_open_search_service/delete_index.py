"""Generated from Smithy shape ``com.amazonaws.opensearch#DeleteIndex``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.delete_index_response.DeleteIndexResponse = (
        aws_sdk_opensearch.types.delete_index_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_opensearch.types.delete_index_request.DeleteIndexRequest,
) -> zapros.Request:
    ...
    url = url.replace("{IndexName}", quote(str(input["index_name"]), safe=""))
    params: dict[str, str] = {}
...
def delete_index(
    ...
    aws_sdk_opensearch.types.delete_index_response.DeleteIndexResponse, zapros.Response
]:
