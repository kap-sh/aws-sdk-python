...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.add_direct_query_data_source_response.AddDirectQueryDataSourceResponse = aws_sdk_opensearch.types.add_direct_query_data_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.add_direct_query_data_source_request.AddDirectQueryDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.add_direct_query_data_source_request.serialize_json(
            input_
        )
    ).encode()
