...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.delete_domain_response.DeleteDomainResponse = (
        aws_sdk_opensearch.types.delete_domain_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.delete_domain_request.DeleteDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
