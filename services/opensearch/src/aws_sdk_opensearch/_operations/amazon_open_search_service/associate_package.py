...
def build_request(
    ...
    input: aws_sdk_opensearch.types.associate_package_request.AssociatePackageRequest,
) -> zapros.Request:
    ...
    url = url.replace("{PackageID}", quote(str(input["package_id"]), safe=""))
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.associate_package_request.serialize_json(input)
    ).encode()
