"""Generated from Smithy shape ``com.amazonaws.opensearch#AssociatePackage``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.associate_package_response.AssociatePackageResponse = aws_sdk_opensearch.types.associate_package_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.associate_package_request.AssociatePackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{PackageID}", quote(str(input_["package_id"]), safe=""))
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.associate_package_request.serialize_json(input_)
    ).encode()
...
async def async_associate_package(
