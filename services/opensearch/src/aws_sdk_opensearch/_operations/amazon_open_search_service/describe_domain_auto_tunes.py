"""Generated from Smithy shape ``com.amazonaws.opensearch#DescribeDomainAutoTunes``."""
...
import aws_sdk_opensearch.types.auto_tune_list
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.describe_domain_auto_tunes_response.DescribeDomainAutoTunesResponse = aws_sdk_opensearch.types.describe_domain_auto_tunes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.describe_domain_auto_tunes_request.DescribeDomainAutoTunesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_domain_auto_tunes(
