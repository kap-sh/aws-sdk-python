...
def build_request(
    ...
    input: aws_sdk_opensearch.types.describe_packages_request.DescribePackagesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.describe_packages_request.serialize_json(input)
    ).encode()
