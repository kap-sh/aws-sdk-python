...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.describe_domain_nodes_response.DescribeDomainNodesResponse = aws_sdk_opensearch.types.describe_domain_nodes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.describe_domain_nodes_request.DescribeDomainNodesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
