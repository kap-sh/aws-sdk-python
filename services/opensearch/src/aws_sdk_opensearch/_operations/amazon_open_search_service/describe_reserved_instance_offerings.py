...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.describe_reserved_instance_offerings_response.DescribeReservedInstanceOfferingsResponse = aws_sdk_opensearch.types.describe_reserved_instance_offerings_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_opensearch.types.describe_reserved_instance_offerings_request.DescribeReservedInstanceOfferingsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "reserved_instance_offering_id" in input:
        params["offeringId"] = str(input["reserved_instance_offering_id"])
