"""Generated from Smithy shape ``com.amazonaws.opensearch#GetDefaultApplicationSetting``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.get_default_application_setting_response.GetDefaultApplicationSettingResponse = aws_sdk_opensearch.types.get_default_application_setting_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.get_default_application_setting_request.GetDefaultApplicationSettingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_default_application_setting(
