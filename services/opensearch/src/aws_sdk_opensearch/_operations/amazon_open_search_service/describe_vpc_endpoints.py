...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.describe_vpc_endpoints_response.DescribeVpcEndpointsResponse = aws_sdk_opensearch.types.describe_vpc_endpoints_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.describe_vpc_endpoints_request.DescribeVpcEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.describe_vpc_endpoints_request.serialize_json(input_)
    ).encode()
