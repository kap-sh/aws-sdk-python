...
def build_request(
    ...
    input: aws_sdk_opensearch.types.describe_vpc_endpoints_request.DescribeVpcEndpointsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.describe_vpc_endpoints_request.serialize_json(input)
    ).encode()
