...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.update_index_response.UpdateIndexResponse = (
        aws_sdk_opensearch.types.update_index_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.update_index_request.UpdateIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.update_index_request.serialize_json(input_)
    ).encode()
...
def update_index(
    ...
    aws_sdk_opensearch.types.update_index_response.UpdateIndexResponse, zapros.Response
]:
