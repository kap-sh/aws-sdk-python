"""Generated from Smithy shape ``com.amazonaws.opensearch#GetCompatibleVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.get_compatible_versions_response.GetCompatibleVersionsResponse = aws_sdk_opensearch.types.get_compatible_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.get_compatible_versions_request.GetCompatibleVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/opensearch/compatibleVersions"
    params: dict[str, str] = {}
...
async def async_get_compatible_versions(
