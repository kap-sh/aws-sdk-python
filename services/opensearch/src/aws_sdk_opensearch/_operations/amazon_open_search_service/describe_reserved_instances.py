...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.describe_reserved_instances_response.DescribeReservedInstancesResponse = aws_sdk_opensearch.types.describe_reserved_instances_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_opensearch.types.describe_reserved_instances_request.DescribeReservedInstancesRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "reserved_instance_id" in input:
        params["reservationId"] = str(input["reserved_instance_id"])
