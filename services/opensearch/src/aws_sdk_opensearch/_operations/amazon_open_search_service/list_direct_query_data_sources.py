"""Generated from Smithy shape ``com.amazonaws.opensearch#ListDirectQueryDataSources``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.list_direct_query_data_sources_response.ListDirectQueryDataSourcesResponse = aws_sdk_opensearch.types.list_direct_query_data_sources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.list_direct_query_data_sources_request.ListDirectQueryDataSourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/opensearch/directQueryDataSource"
    params: dict[str, str] = {}
...
async def async_list_direct_query_data_sources(
