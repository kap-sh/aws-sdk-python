"""Generated from Smithy shape ``com.amazonaws.opensearch#CreateVpcEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.create_vpc_endpoint_response.CreateVpcEndpointResponse = aws_sdk_opensearch.types.create_vpc_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.create_vpc_endpoint_request.CreateVpcEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.create_vpc_endpoint_request.serialize_json(input_)
    ).encode()
