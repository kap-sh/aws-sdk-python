...
def build_request(
    ...
    input: aws_sdk_opensearch.types.create_vpc_endpoint_request.CreateVpcEndpointRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.create_vpc_endpoint_request.serialize_json(input)
    ).encode()
