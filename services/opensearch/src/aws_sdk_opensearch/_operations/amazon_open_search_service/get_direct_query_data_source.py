"""Generated from Smithy shape ``com.amazonaws.opensearch#GetDirectQueryDataSource``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.get_direct_query_data_source_response.GetDirectQueryDataSourceResponse = aws_sdk_opensearch.types.get_direct_query_data_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.get_direct_query_data_source_request.GetDirectQueryDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_direct_query_data_source(
