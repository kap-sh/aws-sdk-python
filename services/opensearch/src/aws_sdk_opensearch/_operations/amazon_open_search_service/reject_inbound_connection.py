...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.reject_inbound_connection_response.RejectInboundConnectionResponse = aws_sdk_opensearch.types.reject_inbound_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.reject_inbound_connection_request.RejectInboundConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
