...
import aws_sdk_opensearch.errors.service_quota_exceeded_exception
import aws_sdk_opensearch.errors.validation_exception
import aws_sdk_opensearch.types.capability_base_request_config
import aws_sdk_opensearch.types.capability_base_response_config
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise aws_sdk_opensearch.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.register_capability_response.RegisterCapabilityResponse = aws_sdk_opensearch.types.register_capability_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.register_capability_request.RegisterCapabilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.register_capability_request.serialize_json(input_)
    ).encode()
