...
def build_request(
    ...
    input: aws_sdk_opensearch.types.register_capability_request.RegisterCapabilityRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.register_capability_request.serialize_json(input)
    ).encode()
