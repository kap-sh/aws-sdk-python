"""Generated from Smithy shape ``com.amazonaws.opensearch#GetUpgradeHistory``."""
...
import aws_sdk_opensearch.types.upgrade_history_list
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.get_upgrade_history_response.GetUpgradeHistoryResponse = aws_sdk_opensearch.types.get_upgrade_history_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.get_upgrade_history_request.GetUpgradeHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_upgrade_history(
