...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.revoke_vpc_endpoint_access_response.RevokeVpcEndpointAccessResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.revoke_vpc_endpoint_access_request.RevokeVpcEndpointAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
