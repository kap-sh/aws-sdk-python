...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.update_package_response.UpdatePackageResponse = (
        aws_sdk_opensearch.types.update_package_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.update_package_request.UpdatePackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.update_package_request.serialize_json(input_)
    ).encode()
