"""Generated from Smithy shape ``com.amazonaws.opensearch#CreateOutboundConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.create_outbound_connection_response.CreateOutboundConnectionResponse = aws_sdk_opensearch.types.create_outbound_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.create_outbound_connection_request.CreateOutboundConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/opensearch/cc/outboundConnection"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_opensearch.types.create_outbound_connection_request

    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.create_outbound_connection_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_outbound_connection(
