...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.get_package_version_history_response.GetPackageVersionHistoryResponse = aws_sdk_opensearch.types.get_package_version_history_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.get_package_version_history_request.GetPackageVersionHistoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
