"""Generated from Smithy shape ``com.amazonaws.opensearch#GetDomainMaintenanceStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.get_domain_maintenance_status_response.GetDomainMaintenanceStatusResponse = aws_sdk_opensearch.types.get_domain_maintenance_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.get_domain_maintenance_status_request.GetDomainMaintenanceStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "maintenance_id" in input_:
        params["maintenanceId"] = str(input_["maintenance_id"])
...
async def async_get_domain_maintenance_status(
