...
def build_request(
    ...
    input: aws_sdk_opensearch.types.get_domain_maintenance_status_request.GetDomainMaintenanceStatusRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "maintenance_id" in input:
        params["maintenanceId"] = str(input["maintenance_id"])
