...
def build_request(
    ...
    input: aws_sdk_opensearch.types.update_scheduled_action_request.UpdateScheduledActionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.update_scheduled_action_request.serialize_json(input)
    ).encode()
