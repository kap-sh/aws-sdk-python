"""Generated from Smithy shape ``com.amazonaws.opensearch#UpdateScheduledAction``."""
...
import aws_sdk_opensearch.errors.conflict_exception
...
import aws_sdk_opensearch.errors.slot_not_available_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_opensearch.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "SlotNotAvailableException":
            raise aws_sdk_opensearch.errors.slot_not_available_exception.SlotNotAvailableException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.update_scheduled_action_response.UpdateScheduledActionResponse = aws_sdk_opensearch.types.update_scheduled_action_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.update_scheduled_action_request.UpdateScheduledActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.update_scheduled_action_request.serialize_json(input_)
    ).encode()
...
async def async_update_scheduled_action(
