"""Generated from Smithy shape ``com.amazonaws.opensearch#RollbackServiceSoftwareUpdate``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.rollback_service_software_update_response.RollbackServiceSoftwareUpdateResponse = aws_sdk_opensearch.types.rollback_service_software_update_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.rollback_service_software_update_request.RollbackServiceSoftwareUpdateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.rollback_service_software_update_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_rollback_service_software_update(
