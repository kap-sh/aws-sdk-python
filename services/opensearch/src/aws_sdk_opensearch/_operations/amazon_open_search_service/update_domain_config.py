...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.update_domain_config_response.UpdateDomainConfigResponse = aws_sdk_opensearch.types.update_domain_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.update_domain_config_request.UpdateDomainConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.update_domain_config_request.serialize_json(input_)
    ).encode()
