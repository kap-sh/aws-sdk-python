...
def build_request(
    ...
    input: aws_sdk_opensearch.types.update_domain_config_request.UpdateDomainConfigRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.update_domain_config_request.serialize_json(input)
    ).encode()
