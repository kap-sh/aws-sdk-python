...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.update_package_scope_response.UpdatePackageScopeResponse = aws_sdk_opensearch.types.update_package_scope_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.update_package_scope_request.UpdatePackageScopeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.update_package_scope_request.serialize_json(input_)
    ).encode()
