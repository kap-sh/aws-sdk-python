...
def build_request(
    ...
    input: aws_sdk_opensearch.types.update_package_scope_request.UpdatePackageScopeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.update_package_scope_request.serialize_json(input)
    ).encode()
