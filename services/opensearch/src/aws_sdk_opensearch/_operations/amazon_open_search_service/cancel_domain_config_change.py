...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.cancel_domain_config_change_response.CancelDomainConfigChangeResponse = aws_sdk_opensearch.types.cancel_domain_config_change_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.cancel_domain_config_change_request.CancelDomainConfigChangeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.cancel_domain_config_change_request.serialize_json(
            input_
        )
    ).encode()
