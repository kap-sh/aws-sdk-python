"""Generated from Smithy shape ``com.amazonaws.opensearch#DeletePackage``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.delete_package_response.DeletePackageResponse = (
        aws_sdk_opensearch.types.delete_package_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.delete_package_request.DeletePackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/packages/{PackageID}"
