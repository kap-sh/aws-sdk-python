...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.list_domain_maintenances_response.ListDomainMaintenancesResponse = aws_sdk_opensearch.types.list_domain_maintenances_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.list_domain_maintenances_request.ListDomainMaintenancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "action" in input_:
        params["action"] = str(input_["action"])
    if "status" in input_:
