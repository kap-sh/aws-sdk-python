...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.list_vpc_endpoints_for_domain_response.ListVpcEndpointsForDomainResponse = aws_sdk_opensearch.types.list_vpc_endpoints_for_domain_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.list_vpc_endpoints_for_domain_request.ListVpcEndpointsForDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
