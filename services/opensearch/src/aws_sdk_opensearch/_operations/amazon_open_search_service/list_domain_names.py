...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.list_domain_names_response.ListDomainNamesResponse = (
        aws_sdk_opensearch.types.list_domain_names_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.list_domain_names_request.ListDomainNamesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
