"""Generated from Smithy shape ``com.amazonaws.opensearch#DescribeInstanceTypeLimits``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.describe_instance_type_limits_response.DescribeInstanceTypeLimitsResponse = aws_sdk_opensearch.types.describe_instance_type_limits_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.describe_instance_type_limits_request.DescribeInstanceTypeLimitsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{InstanceType}", quote(str(input_["instance_type"]), safe=""))
    url = url.replace("{EngineVersion}", quote(str(input_["engine_version"]), safe=""))
    params: dict[str, str] = {}
    if "domain_name" in input_:
        params["domainName"] = str(input_["domain_name"])
...
async def async_describe_instance_type_limits(
