"""Generated from Smithy shape ``com.amazonaws.opensearch#ListScheduledActions``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.list_scheduled_actions_response.ListScheduledActionsResponse = aws_sdk_opensearch.types.list_scheduled_actions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.list_scheduled_actions_request.ListScheduledActionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_scheduled_actions(
