...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.get_capability_response.GetCapabilityResponse = (
        aws_sdk_opensearch.types.get_capability_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.get_capability_request.GetCapabilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
