"""Generated from Smithy shape ``com.amazonaws.opensearch#AssociatePackages``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.associate_packages_response.AssociatePackagesResponse = aws_sdk_opensearch.types.associate_packages_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_opensearch.types.associate_packages_request.AssociatePackagesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.associate_packages_request.serialize_json(input)
    ).encode()
...
async def async_associate_packages(
