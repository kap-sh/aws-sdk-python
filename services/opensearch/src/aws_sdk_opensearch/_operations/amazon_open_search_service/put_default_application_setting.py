"""Generated from Smithy shape ``com.amazonaws.opensearch#PutDefaultApplicationSetting``."""
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.put_default_application_setting_response.PutDefaultApplicationSettingResponse = aws_sdk_opensearch.types.put_default_application_setting_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.put_default_application_setting_request.PutDefaultApplicationSettingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/opensearch/defaultApplicationSetting"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.put_default_application_setting_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_default_application_setting(
