"""Generated from Smithy shape ``com.amazonaws.opensearch#CreateIndex``."""
...
import aws_sdk_opensearch.errors.access_denied_exception
import aws_sdk_opensearch.errors.dependency_failure_exception
...
import aws_sdk_opensearch.errors.resource_not_found_exception
import aws_sdk_opensearch.errors.throttling_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise aws_sdk_opensearch.errors.access_denied_exception.AccessDeniedException.from_json(
                data
            )
        case "DependencyFailureException":
            raise aws_sdk_opensearch.errors.dependency_failure_exception.DependencyFailureException.from_json(
                data
            )
        ...
        case "ResourceNotFoundException":
            raise aws_sdk_opensearch.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
        case "ThrottlingException":
            raise aws_sdk_opensearch.errors.throttling_exception.ThrottlingException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.create_index_response.CreateIndexResponse = (
        aws_sdk_opensearch.types.create_index_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.create_index_request.CreateIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/opensearch/domain/{DomainName}/index"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.create_index_request.serialize_json(input_)
    ).encode()
...
def create_index(
    ...
    aws_sdk_opensearch.types.create_index_response.CreateIndexResponse, zapros.Response
]:
