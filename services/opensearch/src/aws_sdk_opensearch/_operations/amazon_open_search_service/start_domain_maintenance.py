...
def build_request(
    ...
    input: aws_sdk_opensearch.types.start_domain_maintenance_request.StartDomainMaintenanceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.start_domain_maintenance_request.serialize_json(input)
    ).encode()
