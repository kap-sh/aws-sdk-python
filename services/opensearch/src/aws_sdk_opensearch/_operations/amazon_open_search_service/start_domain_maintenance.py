...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.start_domain_maintenance_response.StartDomainMaintenanceResponse = aws_sdk_opensearch.types.start_domain_maintenance_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.start_domain_maintenance_request.StartDomainMaintenanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.start_domain_maintenance_request.serialize_json(input_)
    ).encode()
