...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.describe_domain_change_progress_response.DescribeDomainChangeProgressResponse = aws_sdk_opensearch.types.describe_domain_change_progress_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.describe_domain_change_progress_request.DescribeDomainChangeProgressRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
