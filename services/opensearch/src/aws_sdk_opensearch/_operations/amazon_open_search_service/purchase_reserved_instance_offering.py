...
def handle_response(
    ...
    out: aws_sdk_opensearch.types.purchase_reserved_instance_offering_response.PurchaseReservedInstanceOfferingResponse = aws_sdk_opensearch.types.purchase_reserved_instance_offering_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_opensearch.types.purchase_reserved_instance_offering_request.PurchaseReservedInstanceOfferingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_opensearch.types.purchase_reserved_instance_offering_request.serialize_json(
            input_
        )
    ).encode()
