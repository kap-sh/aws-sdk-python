...
def build_request(
    ...
    input: aws_sdk_opensearch.types.describe_dry_run_progress_request.DescribeDryRunProgressRequest,
) -> zapros.Request:
    ...
    if "load_dry_run_config" in input:
        params["loadDryRunConfig"] = str(input["load_dry_run_config"])
