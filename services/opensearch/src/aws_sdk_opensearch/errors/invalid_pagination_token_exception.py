"""Generated from Smithy shape ``com.amazonaws.opensearch#InvalidPaginationTokenException``."""
...
class InvalidPaginationTokenException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.opensearch#InvalidPaginationTokenException``."""
