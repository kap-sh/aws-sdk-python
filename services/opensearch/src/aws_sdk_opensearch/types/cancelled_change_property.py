"""Generated from Smithy shape ``com.amazonaws.opensearch#CancelledChangeProperty``."""
...
class CancelledChangeProperty(TypedDict, closed=True):
    property_name: NotRequired["aws_sdk_opensearch.types.string.String"]
    """<p>The name of the property whose change was cancelled.</p>"""
    cancelled_value: NotRequired["aws_sdk_opensearch.types.string.String"]
    ...
    active_value: NotRequired["aws_sdk_opensearch.types.string.String"]
