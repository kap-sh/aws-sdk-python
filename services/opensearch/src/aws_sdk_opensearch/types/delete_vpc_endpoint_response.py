...
if TYPE_CHECKING:
    import aws_sdk_opensearch.types.vpc_endpoint_summary


class DeleteVpcEndpointResponse(TypedDict):
    vpc_endpoint_summary: (
        "aws_sdk_opensearch.types.vpc_endpoint_summary.VpcEndpointSummary"
    )
...
def serialize_json(value: DeleteVpcEndpointResponse) -> dict:
    ...
    out["VpcEndpointSummary"] = (
        aws_sdk_opensearch.types.vpc_endpoint_summary.serialize_json(
...
def deserialize_json(data: dict) -> DeleteVpcEndpointResponse:
    ...
    if "VpcEndpointSummary" in data:
        ...
        out["vpc_endpoint_summary"] = (
            aws_sdk_opensearch.types.vpc_endpoint_summary.deserialize_json(
