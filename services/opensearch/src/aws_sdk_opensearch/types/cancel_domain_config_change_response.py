...
class CancelDomainConfigChangeResponse(TypedDict):
    ...
    cancelled_change_properties: NotRequired[
        "aws_sdk_opensearch.types.cancelled_change_property_list.CancelledChangePropertyList"
    ]
...
def serialize_json(value: CancelDomainConfigChangeResponse) -> dict:
    ...
    if "cancelled_change_ids" in value:
        ...
        out["CancelledChangeIds"] = aws_sdk_opensearch.types.guid_list.serialize_json(
    ...
    if "cancelled_change_properties" in value:
        ...
        out["CancelledChangeProperties"] = (
            aws_sdk_opensearch.types.cancelled_change_property_list.serialize_json(
...
def deserialize_json(data: dict) -> CancelDomainConfigChangeResponse:
    ...
    if "CancelledChangeIds" in data:
        ...
        out["cancelled_change_ids"] = (
            aws_sdk_opensearch.types.guid_list.deserialize_json(
    ...
    if "CancelledChangeProperties" in data:
        ...
        out["cancelled_change_properties"] = (
            aws_sdk_opensearch.types.cancelled_change_property_list.deserialize_json(
