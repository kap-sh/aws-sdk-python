...
class VPCDerivedInfo(TypedDict, closed=True):
    vpc_id: NotRequired["aws_sdk_opensearch.types.string.String"]
    ...
    availability_zones: NotRequired["aws_sdk_opensearch.types.string_list.StringList"]
...
def serialize_json(value: VPCDerivedInfo) -> dict:
    ...
    if "availability_zones" in value:
        ...
        out["AvailabilityZones"] = aws_sdk_opensearch.types.string_list.serialize_json(
