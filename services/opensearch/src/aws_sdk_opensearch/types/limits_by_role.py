...
def serialize_json(input_to_serialize: LimitsByRole) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_opensearch.types.limits.serialize_json(value)
    return out
...
def deserialize_json(data: dict) -> LimitsByRole:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_opensearch.types.limits.deserialize_json(value)
    return out
