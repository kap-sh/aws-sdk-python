...
if TYPE_CHECKING:
    import aws_sdk_opensearch.types.change_progress_stage_name
    import aws_sdk_opensearch.types.change_progress_stage_status
    import aws_sdk_opensearch.types.description
    import aws_sdk_opensearch.types.last_updated


class ChangeProgressStage(TypedDict):
    name: NotRequired[
        "aws_sdk_opensearch.types.change_progress_stage_name.ChangeProgressStageName"
    ]
    """<p>The name of the stage.</p>"""
    status: NotRequired[
        "aws_sdk_opensearch.types.change_progress_stage_status.ChangeProgressStageStatus"
    ]
    """<p>The status of the stage.</p>"""
    description: NotRequired["aws_sdk_opensearch.types.description.Description"]
