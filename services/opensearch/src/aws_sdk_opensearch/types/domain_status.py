...
if TYPE_CHECKING:
    ...
    import aws_sdk_opensearch.types.auto_tune_options_output
    ...
    import aws_sdk_opensearch.types.domain_id
    import aws_sdk_opensearch.types.domain_name
    import aws_sdk_opensearch.types.domain_processing_status_type
    import aws_sdk_opensearch.types.ebs_options
    import aws_sdk_opensearch.types.encryption_at_rest_options
    import aws_sdk_opensearch.types.endpoints_map
    import aws_sdk_opensearch.types.hosted_zone_id
    ...
    import aws_sdk_opensearch.types.service_url
...
class DomainStatus(TypedDict):
    domain_id: "aws_sdk_opensearch.types.domain_id.DomainId"
    ...
    endpoint: NotRequired["aws_sdk_opensearch.types.service_url.ServiceUrl"]
    """<p>Domain-specific endpoint used to submit index, search, and data upload requests to the domain.</p>"""
    endpoint_v2: NotRequired["aws_sdk_opensearch.types.service_url.ServiceUrl"]
    ...
    endpoints: NotRequired["aws_sdk_opensearch.types.endpoints_map.EndpointsMap"]
    ...
    domain_endpoint_v2_hosted_zone_id: NotRequired[
        "aws_sdk_opensearch.types.hosted_zone_id.HostedZoneId"
    ]
    """<p>The dual stack hosted zone ID for the domain. </p>"""
    processing: NotRequired["aws_sdk_opensearch.types.boolean.Boolean"]
    ...
    upgrade_processing: NotRequired["aws_sdk_opensearch.types.boolean.Boolean"]
    ...
    cluster_config: "aws_sdk_opensearch.types.cluster_config.ClusterConfig"
    ...
    vpc_options: NotRequired["aws_sdk_opensearch.types.vpc_derived_info.VPCDerivedInfo"]
    ...
    identity_center_options: NotRequired[
        "aws_sdk_opensearch.types.identity_center_options.IdentityCenterOptions"
    ]
    """<p>Configuration options for controlling IAM Identity Center integration within a domain.</p>"""
    auto_tune_options: NotRequired[
        "aws_sdk_opensearch.types.auto_tune_options_output.AutoTuneOptionsOutput"
    ]
    ...
    domain_processing_status: NotRequired[
        "aws_sdk_opensearch.types.domain_processing_status_type.DomainProcessingStatusType"
    ]
    ...
    automated_snapshot_pause_options: NotRequired[
        "aws_sdk_opensearch.types.automated_snapshot_pause_options.AutomatedSnapshotPauseOptions"
    ]
...
def serialize_json(value: DomainStatus) -> dict:
    ...
    if "endpoints" in value:
        ...
        out["Endpoints"] = aws_sdk_opensearch.types.endpoints_map.serialize_json(
            value["endpoints"]
        )
    ...
    if "vpc_options" in value:
        ...
        out["VPCOptions"] = aws_sdk_opensearch.types.vpc_derived_info.serialize_json(
            value["vpc_options"]
        )
    ...
    if "advanced_security_options" in value:
        ...
        out["AdvancedSecurityOptions"] = (
            aws_sdk_opensearch.types.advanced_security_options.serialize_json(
    ...
    if "identity_center_options" in value:
        ...
        out["IdentityCenterOptions"] = (
            aws_sdk_opensearch.types.identity_center_options.serialize_json(
    ...
    if "auto_tune_options" in value:
        ...
        out["AutoTuneOptions"] = (
            aws_sdk_opensearch.types.auto_tune_options_output.serialize_json(
    ...
    if "domain_processing_status" in value:
        ...
        out["DomainProcessingStatus"] = (
            aws_sdk_opensearch.types.domain_processing_status_type.serialize_json(
    ...
    if "aiml_options" in value:
        ...
        out["AIMLOptions"] = (
            aws_sdk_opensearch.types.aiml_options_output.serialize_json(
                value["aiml_options"]
            )
        )
...
def deserialize_json(data: dict) -> DomainStatus:
    ...
    if "Endpoints" in data:
        ...
        out["endpoints"] = aws_sdk_opensearch.types.endpoints_map.deserialize_json(
            data["Endpoints"]
        )
    ...
    if "VPCOptions" in data:
        ...
        out["vpc_options"] = aws_sdk_opensearch.types.vpc_derived_info.deserialize_json(
            data["VPCOptions"]
        )
    ...
    if "AutoTuneOptions" in data:
        ...
        out["auto_tune_options"] = (
            aws_sdk_opensearch.types.auto_tune_options_output.deserialize_json(
    ...
    if "DomainProcessingStatus" in data:
        ...
        out["domain_processing_status"] = (
            aws_sdk_opensearch.types.domain_processing_status_type.deserialize_json(
    ...
    if "AIMLOptions" in data:
        ...
        out["aiml_options"] = (
            aws_sdk_opensearch.types.aiml_options_output.deserialize_json(
                data["AIMLOptions"]
            )
        )
