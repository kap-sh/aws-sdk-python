...
class DescribeDomainAutoTunesResponse(TypedDict, closed=True):
    auto_tunes: NotRequired["aws_sdk_opensearch.types.auto_tune_list.AutoTuneList"]
...
def serialize_json(value: DescribeDomainAutoTunesResponse) -> dict:
    ...
    if "auto_tunes" in value:
        ...
        out["AutoTunes"] = aws_sdk_opensearch.types.auto_tune_list.serialize_json(
            value["auto_tunes"]
        )
...
def deserialize_json(data: dict) -> DescribeDomainAutoTunesResponse:
    ...
    if "AutoTunes" in data:
        ...
        out["auto_tunes"] = aws_sdk_opensearch.types.auto_tune_list.deserialize_json(
            data["AutoTunes"]
        )
