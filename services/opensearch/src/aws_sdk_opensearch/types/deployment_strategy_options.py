...
if TYPE_CHECKING:
    import aws_sdk_opensearch.types.deployment_strategy


class DeploymentStrategyOptions(TypedDict):
    deployment_strategy: (
        "aws_sdk_opensearch.types.deployment_strategy.DeploymentStrategy"
    )
...
def serialize_json(value: DeploymentStrategyOptions) -> dict:
    ...
    out["DeploymentStrategy"] = (
        aws_sdk_opensearch.types.deployment_strategy.serialize_json(
...
def deserialize_json(data: dict) -> DeploymentStrategyOptions:
    ...
    if "DeploymentStrategy" in data:
        ...
        out["deployment_strategy"] = (
            aws_sdk_opensearch.types.deployment_strategy.deserialize_json(
