...
class DomainEndpointOptionsStatus(TypedDict):
    options: "aws_sdk_opensearch.types.domain_endpoint_options.DomainEndpointOptions"
...
def serialize_json(value: DomainEndpointOptionsStatus) -> dict:
    ...
    out["Options"] = aws_sdk_opensearch.types.domain_endpoint_options.serialize_json(
        value["options"]
    )
    import aws_sdk_opensearch.types.option_status
