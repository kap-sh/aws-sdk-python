...
class UpgradeDomainResponse(TypedDict):
    ...
    target_version: NotRequired["aws_sdk_opensearch.types.version_string.VersionString"]
    """<p>OpenSearch or Elasticsearch version that the domain was upgraded to.</p>"""
    perform_check_only: NotRequired["aws_sdk_opensearch.types.boolean.Boolean"]
