...
if TYPE_CHECKING:
    ...
    import aws_sdk_opensearch.types.issues
...
class UpgradeStepItem(TypedDict, closed=True):
    ...
    upgrade_step_status: NotRequired[
        "aws_sdk_opensearch.types.upgrade_status.UpgradeStatus"
    ]
    ...
    issues: NotRequired["aws_sdk_opensearch.types.issues.Issues"]
    """<p>A list of strings containing detailed information about the errors encountered in a particular step.</p>"""
    progress_percent: NotRequired["aws_sdk_opensearch.types.double.Double"]
...
def serialize_json(value: UpgradeStepItem) -> dict:
    ...
    if "upgrade_step" in value:
        ...
        out["UpgradeStep"] = aws_sdk_opensearch.types.upgrade_step.serialize_json(
            value["upgrade_step"]
        )
    if "upgrade_step_status" in value:
        ...
        out["UpgradeStepStatus"] = (
            aws_sdk_opensearch.types.upgrade_status.serialize_json(
    ...
    if "issues" in value:
        ...
        out["Issues"] = aws_sdk_opensearch.types.issues.serialize_json(value["issues"])
...
def deserialize_json(data: dict) -> UpgradeStepItem:
    ...
    if "UpgradeStep" in data:
        ...
        out["upgrade_step"] = aws_sdk_opensearch.types.upgrade_step.deserialize_json(
            data["UpgradeStep"]
        )
    ...
    if "Issues" in data:
        ...
        out["issues"] = aws_sdk_opensearch.types.issues.deserialize_json(data["Issues"])
