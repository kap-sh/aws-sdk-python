...
if TYPE_CHECKING:
    import aws_sdk_opensearch.types.window_start_time


class OffPeakWindow(TypedDict):
    window_start_time: NotRequired[
        "aws_sdk_opensearch.types.window_start_time.WindowStartTime"
    ]
...
def serialize_json(value: OffPeakWindow) -> dict:
    ...
    if "window_start_time" in value:
        ...
        out["WindowStartTime"] = (
            aws_sdk_opensearch.types.window_start_time.serialize_json(
...
def deserialize_json(data: dict) -> OffPeakWindow:
    ...
    if "WindowStartTime" in data:
        ...
        out["window_start_time"] = (
            aws_sdk_opensearch.types.window_start_time.deserialize_json(
