...
if TYPE_CHECKING:
    import aws_sdk_opensearch.types.property_value_type
    import aws_sdk_opensearch.types.string


class ModifyingProperties(TypedDict, closed=True):
    name: NotRequired["aws_sdk_opensearch.types.string.String"]
    ...
    pending_value: NotRequired["aws_sdk_opensearch.types.string.String"]
...
def serialize_json(value: ModifyingProperties) -> dict:
    ...
    if "value_type" in value:
        ...
        out["ValueType"] = aws_sdk_opensearch.types.property_value_type.serialize_json(
            value["value_type"]
        )
    return out
...
def deserialize_json(data: dict) -> ModifyingProperties:
    ...
    if "ValueType" in data:
        ...
        out["value_type"] = (
            aws_sdk_opensearch.types.property_value_type.deserialize_json(
                data["ValueType"]
            )
        )
    return out
