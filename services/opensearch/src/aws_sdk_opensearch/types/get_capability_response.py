...
if TYPE_CHECKING:
    ...
    import aws_sdk_opensearch.types.capability_extended_response_config
    import aws_sdk_opensearch.types.capability_failures
...
class GetCapabilityResponse(TypedDict, closed=True):
    capability_name: NotRequired[
        "aws_sdk_opensearch.types.capability_name.CapabilityName"
    ]
    """<p>The name of the capability.</p>"""
    application_id: NotRequired["aws_sdk_opensearch.types.application_id.ApplicationId"]
    ...
    capability_config: NotRequired[
        "aws_sdk_opensearch.types.capability_extended_response_config.CapabilityExtendedResponseConfig"
    ]
    ...
    failures: NotRequired[
        "aws_sdk_opensearch.types.capability_failures.CapabilityFailures"
    ]
...
def serialize_json(value: GetCapabilityResponse) -> dict:
    ...
    if "capability_config" in value:
        ...
        out["capabilityConfig"] = (
            aws_sdk_opensearch.types.capability_extended_response_config.serialize_json(
    ...
    if "failures" in value:
        ...
        out["failures"] = aws_sdk_opensearch.types.capability_failures.serialize_json(
            value["failures"]
        )
    return out
...
def deserialize_json(data: dict) -> GetCapabilityResponse:
    ...
    if "capabilityConfig" in data:
        ...
        out["capability_config"] = (
            aws_sdk_opensearch.types.capability_extended_response_config.deserialize_json(
    ...
    if "failures" in data:
        ...
        out["failures"] = aws_sdk_opensearch.types.capability_failures.deserialize_json(
            data["failures"]
        )
    return out
