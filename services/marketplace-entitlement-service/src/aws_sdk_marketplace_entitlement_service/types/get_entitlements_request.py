...
def serialize_aws_json_1_1(value: GetEntitlementsRequest) -> dict:
    ...
    if "filter" in value:
        ...
        out["Filter"] = (
            aws_sdk_marketplace_entitlement_service.types.get_entitlement_filters.serialize_aws_json_1_1(
                value["filter"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetEntitlementsRequest:
    ...
    if "Filter" in data:
        ...
        out["filter"] = (
            aws_sdk_marketplace_entitlement_service.types.get_entitlement_filters.deserialize_aws_json_1_1(
                data["Filter"]
            )
        )
