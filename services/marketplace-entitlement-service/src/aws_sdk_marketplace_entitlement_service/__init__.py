...
from ._services.async_marketplace_entitlement_service import (
    AsyncMarketplaceEntitlementServiceClient as AsyncMarketplaceEntitlementServiceClient,
)
from ._services.marketplace_entitlement_service import (
    MarketplaceEntitlementServiceClient as MarketplaceEntitlementServiceClient,
)
