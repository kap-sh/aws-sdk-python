...
from aws_sdk_marketplace_entitlement_service._rule_engine._endpoint_rule_set import (
    EndpointParams,
    resolve,
)
...
from aws_sdk_marketplace_entitlement_service.errors import (
    UnknownServiceError,
)
...
def get_signer(
...
) -> aws_sdk_marketplace_entitlement_service._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_marketplace_entitlement_service._auth._sigv4.build_sigv4_auth_scheme(
                "aws-marketplace", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_marketplace_entitlement_service._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_marketplace_entitlement_service.types.get_entitlements_request.GetEntitlementsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
