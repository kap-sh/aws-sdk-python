...
from aws_sdk_marketplace_entitlement_service._async import anysleep
from aws_sdk_marketplace_entitlement_service._auth._providers import CredentialsProvider
