...
class MarketplaceEntitlementServiceClient:
    ...
    def __init__(
        ...
        self.config = MarketplaceEntitlementServiceClientConfig(
            {
    ...
    def get_entitlements(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_marketplace_entitlement_service.types.get_entitlements_request.GetEntitlementsRequest]",
        ) -> OperationResponse[
            "aws_sdk_marketplace_entitlement_service.types.get_entitlements_result.GetEntitlementsResult"
        ]:
            ...
            output, http_response = (
                aws_sdk_marketplace_entitlement_service._operations.awsmp_entitlement_service.get_entitlements.get_entitlements(
