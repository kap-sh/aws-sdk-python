...
class MarketplaceEntitlementServiceError(Exception):
    """Base class for all MarketplaceEntitlementService service errors."""


class ServiceError(MarketplaceEntitlementServiceError):
...
class SerializationError(MarketplaceEntitlementServiceError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MarketplaceEntitlementServiceError):
...
class WaiterFailedError(MarketplaceEntitlementServiceError):
...
class WaiterTimeoutError(MarketplaceEntitlementServiceError):
