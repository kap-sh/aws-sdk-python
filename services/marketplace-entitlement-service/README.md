...
```
pip install aws-sdk-marketplace-entitlement-service
```

## Usage

```python
from aws_sdk_marketplace_entitlement_service import AsyncMarketplaceEntitlementServiceClient
...
```python
from aws_sdk_marketplace_entitlement_service import AsyncMarketplaceEntitlementServiceClient
from aws_sdk_marketplace_entitlement_service.error import InternalServiceErrorException
