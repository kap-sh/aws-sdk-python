"""Generated from Smithy shape ``com.amazonaws.pinpointsmsvoicev2#ProtectConfigurationFilter``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint_sms_voice_v2.types.protect_configuration_filter_name


class ProtectConfigurationFilter(TypedDict, closed=True):
    name: "aws_sdk_pinpoint_sms_voice_v2.types.protect_configuration_filter_name.ProtectConfigurationFilterName"
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ProtectConfigurationFilter) -> dict:
    out: dict = {}
    out["Name"] = value["name"]
    import aws_sdk_pinpoint_sms_voice_v2.types.filter_value_list
...
def deserialize_aws_json_1_0(data: dict) -> ProtectConfigurationFilter:
    ...
    if "Values" in data:
        ...
        raise DeserializationError("ProtectConfigurationFilter.values required")
    return out
