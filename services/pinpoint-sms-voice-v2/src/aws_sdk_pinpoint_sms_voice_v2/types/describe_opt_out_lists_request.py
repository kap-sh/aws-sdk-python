...
class DescribeOptOutListsRequest(TypedDict):
...
def serialize_aws_json_1_0(value: DescribeOptOutListsRequest) -> dict:
    ...
    if "opt_out_list_names" in value:
        ...
        out["OptOutListNames"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.opt_out_list_name_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DescribeOptOutListsRequest:
    ...
    if "OptOutListNames" in data:
        ...
        out["opt_out_list_names"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.opt_out_list_name_list.deserialize_aws_json_1_0(
