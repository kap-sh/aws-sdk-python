"""Generated from Smithy shape ``com.amazonaws.pinpointsmsvoicev2#DeleteConfigurationSetRequest``."""
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DeleteConfigurationSetRequest) -> dict:
    out: dict = {}
    out["ConfigurationSetName"] = value["configuration_set_name"]
    return out


def deserialize_aws_json_1_0(data: dict) -> DeleteConfigurationSetRequest:
