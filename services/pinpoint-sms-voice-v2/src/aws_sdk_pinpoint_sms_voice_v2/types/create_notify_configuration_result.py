"""Generated from Smithy shape ``com.amazonaws.pinpointsmsvoicev2#CreateNotifyConfigurationResult``."""
...
class CreateNotifyConfigurationResult(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: CreateNotifyConfigurationResult) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> CreateNotifyConfigurationResult:
    ...
    if "CreatedTimestamp" in data:
        ...
        raise DeserializationError(
            "CreateNotifyConfigurationResult.created_timestamp required"
        )
    return out
