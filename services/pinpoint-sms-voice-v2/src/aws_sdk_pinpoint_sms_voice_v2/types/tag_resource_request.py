...
def serialize_aws_json_1_0(value: TagResourceRequest) -> dict:
    ...
    out["Tags"] = (
        aws_sdk_pinpoint_sms_voice_v2.types.non_empty_tag_list.serialize_aws_json_1_0(
            value["tags"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> TagResourceRequest:
    ...
    if "Tags" in data:
        ...
        out["tags"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.non_empty_tag_list.deserialize_aws_json_1_0(
                data["Tags"]
            )
        )
    else:
