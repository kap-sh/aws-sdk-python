...
class AssociateProtectConfigurationRequest(TypedDict):
...
def deserialize_aws_json_1_0(data: dict) -> AssociateProtectConfigurationRequest:
    ...
    if "ProtectConfigurationId" in data:
        ...
        raise DeserializationError("AssociateProtectConfigurationRequest.protect_configuration_id required")
    if "ConfigurationSetName" in data:
        out["configuration_set_name"] = data["ConfigurationSetName"]
    else:
        raise DeserializationError("AssociateProtectConfigurationRequest.configuration_set_name required")
    return out