...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint_sms_voice_v2.types.rcs_agent_filter_name


class RcsAgentFilter(TypedDict):
    name: "aws_sdk_pinpoint_sms_voice_v2.types.rcs_agent_filter_name.RcsAgentFilterName"
