...
class DescribeRegistrationAttachmentsRequest(TypedDict):
...
def serialize_aws_json_1_0(value: DescribeRegistrationAttachmentsRequest) -> dict:
    ...
    if "registration_attachment_ids" in value:
        ...
        out["RegistrationAttachmentIds"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.registration_attachment_id_list.serialize_aws_json_1_0(
    ...
    if "filters" in value:
        ...
        out["Filters"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.registration_attachment_filter_list.serialize_aws_json_1_0(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> DescribeRegistrationAttachmentsRequest:
    ...
    if "RegistrationAttachmentIds" in data:
        ...
        out["registration_attachment_ids"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.registration_attachment_id_list.deserialize_aws_json_1_0(
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.registration_attachment_filter_list.deserialize_aws_json_1_0(
                data["Filters"]
            )
        )
