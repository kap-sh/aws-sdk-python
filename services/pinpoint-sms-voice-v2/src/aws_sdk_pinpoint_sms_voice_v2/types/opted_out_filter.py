...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint_sms_voice_v2.types.opted_out_filter_name


class OptedOutFilter(TypedDict):
    name: "aws_sdk_pinpoint_sms_voice_v2.types.opted_out_filter_name.OptedOutFilterName"
