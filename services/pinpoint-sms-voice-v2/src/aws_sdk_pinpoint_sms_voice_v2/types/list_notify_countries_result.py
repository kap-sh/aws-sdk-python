...
class ListNotifyCountriesResult(TypedDict):
    notify_countries: NotRequired[
        "aws_sdk_pinpoint_sms_voice_v2.types.notify_country_information_list.NotifyCountryInformationList"
    ]
...
def serialize_aws_json_1_0(value: ListNotifyCountriesResult) -> dict:
    ...
    if "notify_countries" in value:
        ...
        out["NotifyCountries"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.notify_country_information_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListNotifyCountriesResult:
    ...
    if "NotifyCountries" in data:
        ...
        out["notify_countries"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.notify_country_information_list.deserialize_aws_json_1_0(
