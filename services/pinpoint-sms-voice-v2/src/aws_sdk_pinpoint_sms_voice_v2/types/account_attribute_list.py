...
AccountAttributeList: TypeAlias = list[
    "aws_sdk_pinpoint_sms_voice_v2.types.account_attribute.AccountAttribute"
]
...
def serialize_aws_json_1_0(value: AccountAttributeList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_pinpoint_sms_voice_v2.types.account_attribute.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> AccountAttributeList:
    ...
    for item in data:
        out.append(
            aws_sdk_pinpoint_sms_voice_v2.types.account_attribute.deserialize_aws_json_1_0(
                item
            )
        )
    return out
