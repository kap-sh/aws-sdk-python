...
CarrierStatusInformationList: TypeAlias = list[
    "aws_sdk_pinpoint_sms_voice_v2.types.carrier_status_information.CarrierStatusInformation"
]
...
def serialize_aws_json_1_0(value: CarrierStatusInformationList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_pinpoint_sms_voice_v2.types.carrier_status_information.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> CarrierStatusInformationList:
    ...
    for item in data:
        out.append(
            aws_sdk_pinpoint_sms_voice_v2.types.carrier_status_information.deserialize_aws_json_1_0(
                item
            )
        )
    return out
