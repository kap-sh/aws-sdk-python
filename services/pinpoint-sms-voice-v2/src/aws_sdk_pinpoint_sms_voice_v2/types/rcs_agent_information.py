...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint_sms_voice_v2.types.testing_agent_information
    import aws_sdk_pinpoint_sms_voice_v2.types.two_way_channel_arn


class RcsAgentInformation(TypedDict):
    rcs_agent_arn: "str"
    ...
    testing_agent: NotRequired[
        "aws_sdk_pinpoint_sms_voice_v2.types.testing_agent_information.TestingAgentInformation"
    ]
...
def serialize_aws_json_1_0(value: RcsAgentInformation) -> dict:
    ...
    if "testing_agent" in value:
        ...
        out["TestingAgent"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.testing_agent_information.serialize_aws_json_1_0(
                value["testing_agent"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> RcsAgentInformation:
    ...
    if "TestingAgent" in data:
        ...
        out["testing_agent"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.testing_agent_information.deserialize_aws_json_1_0(
                data["TestingAgent"]
            )
        )
    return out
