...
if TYPE_CHECKING:
    import aws_sdk_pinpoint_sms_voice_v2.types.string_list


class SelectValidation(TypedDict):
    min_choices: "int"
    """<p>The minimum number of choices for the select.</p>"""
    max_choices: "int"
    """<p>The maximum number of choices for the select.</p>"""
    options: "aws_sdk_pinpoint_sms_voice_v2.types.string_list.StringList"
...
def serialize_aws_json_1_0(value: SelectValidation) -> dict:
    ...
    out["Options"] = (
        aws_sdk_pinpoint_sms_voice_v2.types.string_list.serialize_aws_json_1_0(
            value["options"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> SelectValidation:
    ...
    if "Options" in data:
        ...
        out["options"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.string_list.deserialize_aws_json_1_0(
                data["Options"]
            )
        )
    else:
