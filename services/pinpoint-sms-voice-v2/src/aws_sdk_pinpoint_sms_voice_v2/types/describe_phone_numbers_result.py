...
def serialize_aws_json_1_0(value: DescribePhoneNumbersResult) -> dict:
    ...
    if "phone_numbers" in value:
        ...
        out["PhoneNumbers"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.phone_number_information_list.serialize_aws_json_1_0(
                value["phone_numbers"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> DescribePhoneNumbersResult:
    ...
    if "PhoneNumbers" in data:
        ...
        out["phone_numbers"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.phone_number_information_list.deserialize_aws_json_1_0(
                data["PhoneNumbers"]
            )
        )
