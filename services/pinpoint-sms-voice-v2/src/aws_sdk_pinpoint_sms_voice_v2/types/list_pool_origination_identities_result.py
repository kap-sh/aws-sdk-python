...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint_sms_voice_v2.types.origination_identity_metadata_list


class ListPoolOriginationIdentitiesResult(TypedDict):
    ...
    origination_identities: NotRequired[
        "aws_sdk_pinpoint_sms_voice_v2.types.origination_identity_metadata_list.OriginationIdentityMetadataList"
    ]
...
def serialize_aws_json_1_0(value: ListPoolOriginationIdentitiesResult) -> dict:
    ...
    if "origination_identities" in value:
        ...
        out["OriginationIdentities"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.origination_identity_metadata_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListPoolOriginationIdentitiesResult:
    ...
    if "OriginationIdentities" in data:
        ...
        out["origination_identities"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.origination_identity_metadata_list.deserialize_aws_json_1_0(
