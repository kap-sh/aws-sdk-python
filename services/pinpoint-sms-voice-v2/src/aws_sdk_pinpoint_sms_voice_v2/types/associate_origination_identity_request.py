...
class AssociateOriginationIdentityRequest(TypedDict):
    ...
    client_token: NotRequired["aws_sdk_pinpoint_sms_voice_v2.types.client_token.ClientToken"]
...
def deserialize_aws_json_1_0(data: dict) -> AssociateOriginationIdentityRequest:
    ...
    if "PoolId" in data:
        ...
        raise DeserializationError("AssociateOriginationIdentityRequest.pool_id required")
    if "OriginationIdentity" in data:
        out["origination_identity"] = data["OriginationIdentity"]
    else:
        raise DeserializationError("AssociateOriginationIdentityRequest.origination_identity required")
