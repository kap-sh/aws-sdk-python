"""Generated from Smithy shape ``com.amazonaws.pinpointsmsvoicev2#SenderIdFilter``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint_sms_voice_v2.types.sender_id_filter_name


class SenderIdFilter(TypedDict, closed=True):
    name: "aws_sdk_pinpoint_sms_voice_v2.types.sender_id_filter_name.SenderIdFilterName"
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: SenderIdFilter) -> dict:
    out: dict = {}
    out["Name"] = value["name"]
    import aws_sdk_pinpoint_sms_voice_v2.types.filter_value_list
...
def deserialize_aws_json_1_0(data: dict) -> SenderIdFilter:
    ...
    if "Values" in data:
        ...
        raise DeserializationError("SenderIdFilter.values required")
    return out
