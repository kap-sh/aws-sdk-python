...
if TYPE_CHECKING:
    import aws_sdk_pinpoint_sms_voice_v2.types.template_variable_name
    import aws_sdk_pinpoint_sms_voice_v2.types.template_variable_value

TemplateVariableSubstitutionMap: TypeAlias = dict[
    "aws_sdk_pinpoint_sms_voice_v2.types.template_variable_name.TemplateVariableName",
    "aws_sdk_pinpoint_sms_voice_v2.types.template_variable_value.TemplateVariableValue",
]
