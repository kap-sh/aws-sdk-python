...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint_sms_voice_v2.types.opted_out_number_information_list


class DescribeOptedOutNumbersResult(TypedDict):
    ...
    opted_out_numbers: NotRequired[
        "aws_sdk_pinpoint_sms_voice_v2.types.opted_out_number_information_list.OptedOutNumberInformationList"
    ]
...
def serialize_aws_json_1_0(value: DescribeOptedOutNumbersResult) -> dict:
    ...
    if "opted_out_numbers" in value:
        ...
        out["OptedOutNumbers"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.opted_out_number_information_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DescribeOptedOutNumbersResult:
    ...
    if "OptedOutNumbers" in data:
        ...
        out["opted_out_numbers"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.opted_out_number_information_list.deserialize_aws_json_1_0(
