...
class DescribeRcsAgentCountryLaunchStatusResult(TypedDict):
    rcs_agent_id: "str"
    ...
    country_launch_status: NotRequired[
        "aws_sdk_pinpoint_sms_voice_v2.types.country_launch_status_information_list.CountryLaunchStatusInformationList"
    ]
...
def serialize_aws_json_1_0(value: DescribeRcsAgentCountryLaunchStatusResult) -> dict:
    ...
    if "country_launch_status" in value:
        ...
        out["CountryLaunchStatus"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.country_launch_status_information_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DescribeRcsAgentCountryLaunchStatusResult:
    ...
    if "CountryLaunchStatus" in data:
        ...
        out["country_launch_status"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.country_launch_status_information_list.deserialize_aws_json_1_0(
