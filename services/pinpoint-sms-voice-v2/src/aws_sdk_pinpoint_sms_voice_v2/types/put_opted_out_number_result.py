...
class PutOptedOutNumberResult(TypedDict):
    ...
    r"""<p>The time that the phone number was added to the OptOutList, in <a href=\"https://www.epochconverter.com/\">UNIX epoch time</a> format.</p>"""
