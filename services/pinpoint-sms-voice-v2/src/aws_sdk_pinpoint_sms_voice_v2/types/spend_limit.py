...
if TYPE_CHECKING:
    import aws_sdk_pinpoint_sms_voice_v2.types.spend_limit_name


class SpendLimit(TypedDict):
    name: "aws_sdk_pinpoint_sms_voice_v2.types.spend_limit_name.SpendLimitName"
