"""Generated from Smithy shape ``com.amazonaws.pinpointsmsvoicev2#DescribeRegistrationFieldDefinitionsResult``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint_sms_voice_v2.types.registration_field_definition_list
    import aws_sdk_pinpoint_sms_voice_v2.types.registration_type


class DescribeRegistrationFieldDefinitionsResult(TypedDict, closed=True):
    registration_type: (
    ...
    registration_field_definitions: "aws_sdk_pinpoint_sms_voice_v2.types.registration_field_definition_list.RegistrationFieldDefinitionList"
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DescribeRegistrationFieldDefinitionsResult) -> dict:
    out: dict = {}
    out["RegistrationType"] = value["registration_type"]
    import aws_sdk_pinpoint_sms_voice_v2.types.registration_field_definition_list

    out["RegistrationFieldDefinitions"] = (
        aws_sdk_pinpoint_sms_voice_v2.types.registration_field_definition_list.serialize_aws_json_1_0(
            value["registration_field_definitions"]
        )
    )
...
def deserialize_aws_json_1_0(data: dict) -> DescribeRegistrationFieldDefinitionsResult:
    ...
    if "RegistrationFieldDefinitions" in data:
        ...
        out["registration_field_definitions"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.registration_field_definition_list.deserialize_aws_json_1_0(
                data["RegistrationFieldDefinitions"]
            )
        )
    else:
        raise DeserializationError(
