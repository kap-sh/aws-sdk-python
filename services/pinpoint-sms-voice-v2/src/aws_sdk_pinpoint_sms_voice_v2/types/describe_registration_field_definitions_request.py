...
class DescribeRegistrationFieldDefinitionsRequest(TypedDict):
    registration_type: (
...
def serialize_aws_json_1_0(value: DescribeRegistrationFieldDefinitionsRequest) -> dict:
    ...
    if "field_paths" in value:
        ...
        out["FieldPaths"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.field_path_list.serialize_aws_json_1_0(
                value["field_paths"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> DescribeRegistrationFieldDefinitionsRequest:
    ...
    if "FieldPaths" in data:
        ...
        out["field_paths"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.field_path_list.deserialize_aws_json_1_0(
                data["FieldPaths"]
            )
        )
