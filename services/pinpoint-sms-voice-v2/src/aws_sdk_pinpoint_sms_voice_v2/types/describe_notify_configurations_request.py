"""Generated from Smithy shape ``com.amazonaws.pinpointsmsvoicev2#DescribeNotifyConfigurationsRequest``."""
...
class DescribeNotifyConfigurationsRequest(TypedDict, closed=True):
    notify_configuration_ids: NotRequired[
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DescribeNotifyConfigurationsRequest) -> dict:
    out: dict = {}
    if "notify_configuration_ids" in value:
        import aws_sdk_pinpoint_sms_voice_v2.types.notify_configuration_id_list

        out["NotifyConfigurationIds"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.notify_configuration_id_list.serialize_aws_json_1_0(
                value["notify_configuration_ids"]
            )
        )
    if "filters" in value:
        import aws_sdk_pinpoint_sms_voice_v2.types.notify_configuration_filter_list
        ...
        out["Filters"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.notify_configuration_filter_list.serialize_aws_json_1_0(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> DescribeNotifyConfigurationsRequest:
    ...
    if "NotifyConfigurationIds" in data:
        ...
        out["notify_configuration_ids"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.notify_configuration_id_list.deserialize_aws_json_1_0(
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.notify_configuration_filter_list.deserialize_aws_json_1_0(
                data["Filters"]
            )
        )
