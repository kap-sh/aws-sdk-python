...
class DescribeNotifyTemplatesRequest(TypedDict):
...
def serialize_aws_json_1_0(value: DescribeNotifyTemplatesRequest) -> dict:
    ...
    if "template_ids" in value:
        ...
        out["TemplateIds"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.notify_template_id_list.serialize_aws_json_1_0(
                value["template_ids"]
            )
        )
    if "filters" in value:
        ...
        out["Filters"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.notify_template_filter_list.serialize_aws_json_1_0(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> DescribeNotifyTemplatesRequest:
    ...
    if "TemplateIds" in data:
        ...
        out["template_ids"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.notify_template_id_list.deserialize_aws_json_1_0(
                data["TemplateIds"]
            )
        )
    if "Filters" in data:
        ...
        out["filters"] = (
            aws_sdk_pinpoint_sms_voice_v2.types.notify_template_filter_list.deserialize_aws_json_1_0(
                data["Filters"]
            )
        )
