...
if TYPE_CHECKING:
    ...
    import aws_sdk_pinpoint_sms_voice_v2.types.number_type
...
class PhoneNumberInformation(TypedDict):
    ...
    phone_number: "aws_sdk_pinpoint_sms_voice_v2.types.phone_number.PhoneNumber"
    """<p>The phone number in E.164 format.</p>"""
    status: "aws_sdk_pinpoint_sms_voice_v2.types.number_status.NumberStatus"
    ...
    number_type: "aws_sdk_pinpoint_sms_voice_v2.types.number_type.NumberType"
