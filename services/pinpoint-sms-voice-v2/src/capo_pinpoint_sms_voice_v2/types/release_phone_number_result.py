...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ReleasePhoneNumberResult) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> ReleasePhoneNumberResult:
    out: ReleasePhoneNumberResult = {}  # type: ignore[typeddict-item]
