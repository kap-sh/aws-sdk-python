...
if TYPE_CHECKING:
    ...
    import capo_pinpoint_sms_voice_v2.types.pool_origination_identities_filter_name


class PoolOriginationIdentitiesFilter(TypedDict, closed=True):
    name: "capo_pinpoint_sms_voice_v2.types.pool_origination_identities_filter_name.PoolOriginationIdentitiesFilterName"
