...
if TYPE_CHECKING:
    ...
    import capo_pinpoint_sms_voice_v2.types.protect_configuration_filter_name


class ProtectConfigurationFilter(TypedDict, closed=True):
    name: "capo_pinpoint_sms_voice_v2.types.protect_configuration_filter_name.ProtectConfigurationFilterName"
