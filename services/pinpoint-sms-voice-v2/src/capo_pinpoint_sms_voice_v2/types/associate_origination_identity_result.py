...
class AssociateOriginationIdentityResult(TypedDict, closed=True):
...
def deserialize_aws_json_1_0(data: dict) -> AssociateOriginationIdentityResult:
    out: AssociateOriginationIdentityResult = {}  # type: ignore[typeddict-item]
    if "PoolArn" in data:
