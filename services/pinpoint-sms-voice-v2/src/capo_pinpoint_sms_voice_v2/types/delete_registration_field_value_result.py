"""Generated from Smithy shape ``com.amazonaws.pinpointsmsvoicev2#DeleteRegistrationFieldValueResult``."""
...
class DeleteRegistrationFieldValueResult(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DeleteRegistrationFieldValueResult) -> dict:
    out: dict = {}
