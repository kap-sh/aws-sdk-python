...
if TYPE_CHECKING:
    ...
    import capo_pinpoint_sms_voice_v2.types.sender_id_information_list


class DescribeSenderIdsResult(TypedDict, closed=True):
    sender_ids: NotRequired[
        "capo_pinpoint_sms_voice_v2.types.sender_id_information_list.SenderIdInformationList"
    ]
...
def serialize_aws_json_1_0(value: DescribeSenderIdsResult) -> dict:
    ...
    if "sender_ids" in value:
        ...
        out["SenderIds"] = (
            capo_pinpoint_sms_voice_v2.types.sender_id_information_list.serialize_aws_json_1_0(
                value["sender_ids"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> DescribeSenderIdsResult:
    ...
    if "SenderIds" in data:
        ...
        out["sender_ids"] = (
            capo_pinpoint_sms_voice_v2.types.sender_id_information_list.deserialize_aws_json_1_0(
                data["SenderIds"]
            )
        )
