...
if TYPE_CHECKING:
    import capo_pinpoint_sms_voice_v2.types.protect_configuration_rule_set_number_override_filter_item

ListProtectConfigurationRuleSetNumberOverrideFilter: TypeAlias = list[
    "capo_pinpoint_sms_voice_v2.types.protect_configuration_rule_set_number_override_filter_item.ProtectConfigurationRuleSetNumberOverrideFilterItem"
]
...
def serialize_aws_json_1_0(
    ...
    for item in value:
        out.append(
            capo_pinpoint_sms_voice_v2.types.protect_configuration_rule_set_number_override_filter_item.serialize_aws_json_1_0(
                item
            )
        )
    return out
