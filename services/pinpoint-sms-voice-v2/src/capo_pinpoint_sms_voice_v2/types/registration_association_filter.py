...
if TYPE_CHECKING:
    ...
    import capo_pinpoint_sms_voice_v2.types.registration_association_filter_name


class RegistrationAssociationFilter(TypedDict, closed=True):
    name: "capo_pinpoint_sms_voice_v2.types.registration_association_filter_name.RegistrationAssociationFilterName"
