...
class DescribePoolsResult(TypedDict, closed=True):
    pools: NotRequired[
        "capo_pinpoint_sms_voice_v2.types.pool_information_list.PoolInformationList"
    ]
...
def serialize_aws_json_1_0(value: DescribePoolsResult) -> dict:
    ...
    if "pools" in value:
        ...
        out["Pools"] = (
            capo_pinpoint_sms_voice_v2.types.pool_information_list.serialize_aws_json_1_0(
                value["pools"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> DescribePoolsResult:
    ...
    if "Pools" in data:
        ...
        out["pools"] = (
            capo_pinpoint_sms_voice_v2.types.pool_information_list.deserialize_aws_json_1_0(
                data["Pools"]
            )
        )
