...
if TYPE_CHECKING:
    ...
    import capo_pinpoint_sms_voice_v2.types.opt_out_list_information_list


class DescribeOptOutListsResult(TypedDict, closed=True):
    opt_out_lists: NotRequired[
        "capo_pinpoint_sms_voice_v2.types.opt_out_list_information_list.OptOutListInformationList"
    ]
...
def serialize_aws_json_1_0(value: DescribeOptOutListsResult) -> dict:
    ...
    if "opt_out_lists" in value:
        ...
        out["OptOutLists"] = (
            capo_pinpoint_sms_voice_v2.types.opt_out_list_information_list.serialize_aws_json_1_0(
                value["opt_out_lists"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> DescribeOptOutListsResult:
    ...
    if "OptOutLists" in data:
        ...
        out["opt_out_lists"] = (
            capo_pinpoint_sms_voice_v2.types.opt_out_list_information_list.deserialize_aws_json_1_0(
                data["OptOutLists"]
            )
        )
