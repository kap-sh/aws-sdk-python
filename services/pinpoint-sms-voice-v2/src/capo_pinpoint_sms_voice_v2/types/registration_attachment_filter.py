...
if TYPE_CHECKING:
    ...
    import capo_pinpoint_sms_voice_v2.types.registration_attachment_filter_name


class RegistrationAttachmentFilter(TypedDict, closed=True):
    name: "capo_pinpoint_sms_voice_v2.types.registration_attachment_filter_name.RegistrationAttachmentFilterName"
