...
class DescribeRcsAgentsRequest(TypedDict, closed=True):
...
def serialize_aws_json_1_0(value: DescribeRcsAgentsRequest) -> dict:
    ...
    if "rcs_agent_ids" in value:
        ...
        out["RcsAgentIds"] = (
            capo_pinpoint_sms_voice_v2.types.rcs_agent_id_list.serialize_aws_json_1_0(
                value["rcs_agent_ids"]
            )
        )
    if "owner" in value:
    ...
    if "filters" in value:
        ...
        out["Filters"] = (
            capo_pinpoint_sms_voice_v2.types.rcs_agent_filter_list.serialize_aws_json_1_0(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> DescribeRcsAgentsRequest:
    ...
    if "RcsAgentIds" in data:
        ...
        out["rcs_agent_ids"] = (
            capo_pinpoint_sms_voice_v2.types.rcs_agent_id_list.deserialize_aws_json_1_0(
                data["RcsAgentIds"]
            )
        )
    if "Owner" in data:
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            capo_pinpoint_sms_voice_v2.types.rcs_agent_filter_list.deserialize_aws_json_1_0(
                data["Filters"]
            )
        )
