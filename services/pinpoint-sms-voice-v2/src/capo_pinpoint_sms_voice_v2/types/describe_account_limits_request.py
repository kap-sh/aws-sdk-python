...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DescribeAccountLimitsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> DescribeAccountLimitsRequest:
    out: DescribeAccountLimitsRequest = {}  # type: ignore[typeddict-item]
