"""Generated from Smithy shape ``com.amazonaws.pinpointsmsvoicev2#UpdateSenderIdResult``."""
...
class UpdateSenderIdResult(TypedDict, closed=True):
    sender_id_arn: "str"
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: UpdateSenderIdResult) -> dict:
    out: dict = {}
