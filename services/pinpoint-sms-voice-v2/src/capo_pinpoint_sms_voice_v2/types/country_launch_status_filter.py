...
if TYPE_CHECKING:
    import capo_pinpoint_sms_voice_v2.types.country_launch_status_filter_name
    import capo_pinpoint_sms_voice_v2.types.filter_value_list


class CountryLaunchStatusFilter(TypedDict, closed=True):
    name: "capo_pinpoint_sms_voice_v2.types.country_launch_status_filter_name.CountryLaunchStatusFilterName"
