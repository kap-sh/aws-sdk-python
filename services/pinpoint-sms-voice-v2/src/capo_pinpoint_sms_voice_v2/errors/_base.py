...
class PinpointSMSVoiceV2Error(Exception):
    """Base class for all PinpointSMSVoiceV2 service errors."""


class ServiceError(PinpointSMSVoiceV2Error):
...
class SerializationError(PinpointSMSVoiceV2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(PinpointSMSVoiceV2Error):
...
class WaiterFailedError(PinpointSMSVoiceV2Error):
...
class WaiterTimeoutError(PinpointSMSVoiceV2Error):
