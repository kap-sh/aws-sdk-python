...
if TYPE_CHECKING:
    import capo_pinpoint_sms_voice_v2.types.access_denied_exception_reason


class AccessDeniedException_(TypedDict, closed=True):
    message: NotRequired["str"]
    reason: NotRequired[
        "capo_pinpoint_sms_voice_v2.types.access_denied_exception_reason.AccessDeniedExceptionReason"
    ]
