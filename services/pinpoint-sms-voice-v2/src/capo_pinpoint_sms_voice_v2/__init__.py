...
from ._services.async_pinpoint_sms_voice_v2 import (
    AsyncPinpointSMSVoiceV2Client as AsyncPinpointSMSVoiceV2Client,
)
from ._services.pinpoint_sms_voice_v2 import (
    PinpointSMSVoiceV2Client as PinpointSMSVoiceV2Client,
)
