import pytest
from capo_pinpoint_sms_voice_v2._rule_engine._endpoint_rule_set import EndpointParams, resolve
from capo_pinpoint_sms_voice_v2._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
