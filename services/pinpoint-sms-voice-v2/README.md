...
```
pip install aws-sdk-pinpoint-sms-voice-v2
```

## Usage

```python
from aws_sdk_pinpoint_sms_voice_v2 import AsyncPinpointSMSVoiceV2Client
...
```python
from aws_sdk_pinpoint_sms_voice_v2 import AsyncPinpointSMSVoiceV2Client
from aws_sdk_pinpoint_sms_voice_v2.error import AccessDeniedException
