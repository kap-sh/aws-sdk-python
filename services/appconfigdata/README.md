...
```
pip install aws-sdk-appconfigdata
```

## Usage

```python
from aws_sdk_appconfigdata import AsyncAppConfigDataClient
...
```python
from aws_sdk_appconfigdata import AsyncAppConfigDataClient
from aws_sdk_appconfigdata.error import BadRequestException
