...
if TYPE_CHECKING:
    ...
    from aws_sdk_appconfigdata._services.app_config_data import (
        AppConfigDataClient,
        AppConfigDataClientConfig,
    )
    from aws_sdk_appconfigdata._services.async_app_config_data import (
...
class ConfigurationSession:
    ...
    def create(
        ...
        *,
    ...
    ) -> "aws_sdk_appconfigdata.types.start_configuration_session_response.StartConfigurationSessionResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_appconfigdata.types.start_configuration_session_request.StartConfigurationSessionRequest]",
        ) -> OperationResponse[
            "aws_sdk_appconfigdata.types.start_configuration_session_response.StartConfigurationSessionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_appconfigdata._operations.app_config_data.start_configuration_session.start_configuration_session(
        ...
        input: aws_sdk_appconfigdata.types.start_configuration_session_request.StartConfigurationSessionRequest = {}  # type: ignore[typeddict-item]
        input["application_identifier"] = application_identifier
        input["environment_identifier"] = environment_identifier
        input["configuration_profile_identifier"] = configuration_profile_identifier
        if required_minimum_poll_interval_in_seconds is not None:
            input["required_minimum_poll_interval_in_seconds"] = (
...
class AsyncConfigurationSession:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_appconfigdata.types.start_configuration_session_request.StartConfigurationSessionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_appconfigdata.types.start_configuration_session_response.StartConfigurationSessionResponse"
        ]:
            import aws_sdk_appconfigdata._operations.app_config_data.start_configuration_session
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_appconfigdata._operations.app_config_data.start_configuration_session.async_start_configuration_session(
                req.options, req.input
            )
