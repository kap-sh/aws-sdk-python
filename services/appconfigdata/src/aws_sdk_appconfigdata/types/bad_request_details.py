...
class _BadRequestDetails_InvalidParameters(TypedDict):
    InvalidParameters: "aws_sdk_appconfigdata.types.invalid_parameter_map.InvalidParameterMap"
...
def serialize_json(value: BadRequestDetails) -> dict:
    if "InvalidParameters" in value:
        import aws_sdk_appconfigdata.types.invalid_parameter_map
        return {"InvalidParameters": aws_sdk_appconfigdata.types.invalid_parameter_map.serialize_json(value["InvalidParameters"])}
    else:
...
def deserialize_json(data: dict) -> BadRequestDetails:
    if "InvalidParameters" in data:
        import aws_sdk_appconfigdata.types.invalid_parameter_map
        return {"InvalidParameters": aws_sdk_appconfigdata.types.invalid_parameter_map.deserialize_json(data["InvalidParameters"])}
    else:
