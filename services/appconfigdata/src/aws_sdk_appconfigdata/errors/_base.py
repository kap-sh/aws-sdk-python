...
class AppConfigDataError(Exception):
    """Base class for all AppConfigData service errors."""

class ServiceError(AppConfigDataError):
...
class SerializationError(AppConfigDataError):
    """Raised when a value cannot be serialized."""

class DeserializationError(AppConfigDataError):
...
class WaiterFailedError(AppConfigDataError):
...
class WaiterTimeoutError(AppConfigDataError):
