...
from aws_sdk_appconfigdata._auth._signers import SigV4Signer
from aws_sdk_appconfigdata._auth._sigv4 import presign_sigv4
import datetime
from collections.abc import AsyncIterator
from collections.abc import AsyncGenerator
from contextlib import asynccontextmanager
from aws_sdk_appconfigdata._pagination import resolve_path as _resolve_path
...
from aws_sdk_appconfigdata._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
from aws_sdk_appconfigdata._async import anysleep
import time
from aws_sdk_appconfigdata.errors import ServiceError, WaiterFailedError, WaiterTimeoutError
import warnings
...
from aws_sdk_appconfigdata._auth._providers import CredentialsProvider, StaticAwsCredentialsProvider
from aws_sdk_appconfigdata._auth._providers import BearerTokenProvider, StaticBearerTokenProvider
from aws_sdk_appconfigdata._auth._providers import BasicCredentialsProvider, StaticBasicCredentialsProvider
from aws_sdk_appconfigdata._auth._providers import ApiKeyProvider, StaticApiKeyProvider
from aws_sdk_appconfigdata._resources.app_config_data.configuration_session import AsyncConfigurationSession
if TYPE_CHECKING:
...
class AsyncAppConfigDataClient:
    ...
    def __init__(self, http_handler: AsyncBaseHandler | None = None, operation_interceptors: Iterable[AsyncInterceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, region: str | None = None, use_dual_stack: bool | None = None, use_fips: bool | None = None, endpoint: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = AsyncAppConfigDataClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "region": region, "use_dual_stack": use_dual_stack, "use_fips": use_fips, "endpoint": endpoint, "credentials_provider": credentials_provider})
        # resources
        self.configuration_session = AsyncConfigurationSession(self)
    def operation_options(self, config_overrides: Optional[AsyncAppConfigDataClientConfig] = None) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
    ...
    async def get_latest_configuration(self, configuration_token: "aws_sdk_appconfigdata.types.token.Token", *, config_overrides: Optional[AsyncAppConfigDataClientConfig] = None) -> "aws_sdk_appconfigdata.types.get_latest_configuration_response.GetLatestConfigurationResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_appconfigdata.types.get_latest_configuration_request.GetLatestConfigurationRequest]') -> AsyncOperationResponse["aws_sdk_appconfigdata.types.get_latest_configuration_response.GetLatestConfigurationResponse"]:
            import aws_sdk_appconfigdata._operations.app_config_data.get_latest_configuration
            output, http_response = await aws_sdk_appconfigdata._operations.app_config_data.get_latest_configuration.async_get_latest_configuration(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_appconfigdata.types.get_latest_configuration_request.GetLatestConfigurationRequest = {}  # type: ignore[typeddict-item]
