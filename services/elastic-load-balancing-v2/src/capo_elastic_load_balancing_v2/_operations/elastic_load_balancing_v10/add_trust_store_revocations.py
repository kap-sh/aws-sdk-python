...
import capo_elastic_load_balancing_v2.errors.invalid_revocation_content_exception
import capo_elastic_load_balancing_v2.errors.revocation_content_not_found_exception
import capo_elastic_load_balancing_v2.errors.too_many_trust_store_revocation_entries_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidRevocationContentException":
            raise capo_elastic_load_balancing_v2.errors.invalid_revocation_content_exception.InvalidRevocationContentException.from_query(
                root
            )
        case "RevocationContentNotFoundException":
            raise capo_elastic_load_balancing_v2.errors.revocation_content_not_found_exception.RevocationContentNotFoundException.from_query(
                root
            )
        case "TooManyTrustStoreRevocationEntriesException":
            raise capo_elastic_load_balancing_v2.errors.too_many_trust_store_revocation_entries_exception.TooManyTrustStoreRevocationEntriesException.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.add_trust_store_revocations_output.AddTrustStoreRevocationsOutput = capo_elastic_load_balancing_v2.types.add_trust_store_revocations_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.add_trust_store_revocations_input.serialize_query(
        input_, pairs, ""
    )
