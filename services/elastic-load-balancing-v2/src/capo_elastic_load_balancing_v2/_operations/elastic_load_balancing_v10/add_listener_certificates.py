"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#AddListenerCertificates``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("AddListenerCertificatesResult")
    out: capo_elastic_load_balancing_v2.types.add_listener_certificates_output.AddListenerCertificatesOutput = capo_elastic_load_balancing_v2.types.add_listener_certificates_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "AddListenerCertificates"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.add_listener_certificates_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_add_listener_certificates(
