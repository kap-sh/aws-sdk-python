"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#ModifyLoadBalancerAttributes``."""
...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.modify_load_balancer_attributes_output.ModifyLoadBalancerAttributesOutput = capo_elastic_load_balancing_v2.types.modify_load_balancer_attributes_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.modify_load_balancer_attributes_input.serialize_query(
        input_, pairs, ""
    )
