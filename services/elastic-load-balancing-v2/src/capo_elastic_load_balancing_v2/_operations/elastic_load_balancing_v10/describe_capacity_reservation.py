"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DescribeCapacityReservation``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeCapacityReservationResult")
    out: capo_elastic_load_balancing_v2.types.describe_capacity_reservation_output.DescribeCapacityReservationOutput = capo_elastic_load_balancing_v2.types.describe_capacity_reservation_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeCapacityReservation"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.describe_capacity_reservation_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_capacity_reservation(
