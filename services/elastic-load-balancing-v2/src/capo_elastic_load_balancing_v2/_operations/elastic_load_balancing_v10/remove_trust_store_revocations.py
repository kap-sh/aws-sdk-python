"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#RemoveTrustStoreRevocations``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("RemoveTrustStoreRevocationsResult")
    out: capo_elastic_load_balancing_v2.types.remove_trust_store_revocations_output.RemoveTrustStoreRevocationsOutput = capo_elastic_load_balancing_v2.types.remove_trust_store_revocations_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "RemoveTrustStoreRevocations"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.remove_trust_store_revocations_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_remove_trust_store_revocations(
