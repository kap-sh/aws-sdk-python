"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DescribeListeners``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeListenersResult")
    out: capo_elastic_load_balancing_v2.types.describe_listeners_output.DescribeListenersOutput = capo_elastic_load_balancing_v2.types.describe_listeners_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeListeners"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.describe_listeners_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_listeners(
