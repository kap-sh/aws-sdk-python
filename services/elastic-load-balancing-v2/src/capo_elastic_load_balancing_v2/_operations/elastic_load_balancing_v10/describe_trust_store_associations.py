"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DescribeTrustStoreAssociations``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeTrustStoreAssociationsResult")
    out: capo_elastic_load_balancing_v2.types.describe_trust_store_associations_output.DescribeTrustStoreAssociationsOutput = capo_elastic_load_balancing_v2.types.describe_trust_store_associations_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeTrustStoreAssociations"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.describe_trust_store_associations_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_trust_store_associations(
