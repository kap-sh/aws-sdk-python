"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DeleteRule``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteRuleResult")
    out: capo_elastic_load_balancing_v2.types.delete_rule_output.DeleteRuleOutput = (
        capo_elastic_load_balancing_v2.types.delete_rule_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteRule"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.delete_rule_input.serialize_query(
        input_, pairs, ""
    )
