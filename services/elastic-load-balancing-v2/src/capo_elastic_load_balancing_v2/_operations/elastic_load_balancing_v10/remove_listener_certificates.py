"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#RemoveListenerCertificates``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("RemoveListenerCertificatesResult")
    out: capo_elastic_load_balancing_v2.types.remove_listener_certificates_output.RemoveListenerCertificatesOutput = capo_elastic_load_balancing_v2.types.remove_listener_certificates_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "RemoveListenerCertificates"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.remove_listener_certificates_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_remove_listener_certificates(
