...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.get_trust_store_ca_certificates_bundle_output.GetTrustStoreCaCertificatesBundleOutput = capo_elastic_load_balancing_v2.types.get_trust_store_ca_certificates_bundle_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.get_trust_store_ca_certificates_bundle_input.serialize_query(
        input_, pairs, ""
    )
