...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.register_targets_output.RegisterTargetsOutput = capo_elastic_load_balancing_v2.types.register_targets_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.register_targets_input.serialize_query(
        input_, pairs, ""
    )
