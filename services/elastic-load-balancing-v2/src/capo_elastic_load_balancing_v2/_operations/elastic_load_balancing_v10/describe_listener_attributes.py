"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DescribeListenerAttributes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeListenerAttributesResult")
    out: capo_elastic_load_balancing_v2.types.describe_listener_attributes_output.DescribeListenerAttributesOutput = capo_elastic_load_balancing_v2.types.describe_listener_attributes_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeListenerAttributes"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.describe_listener_attributes_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_listener_attributes(
