"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DescribeTargetHealth``."""
...
import capo_elastic_load_balancing_v2.errors.health_unavailable_exception
import capo_elastic_load_balancing_v2.errors.invalid_target_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "HealthUnavailableException":
            raise capo_elastic_load_balancing_v2.errors.health_unavailable_exception.HealthUnavailableException.from_query(
                root
            )
        case "InvalidTargetException":
            raise capo_elastic_load_balancing_v2.errors.invalid_target_exception.InvalidTargetException.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.describe_target_health_output.DescribeTargetHealthOutput = capo_elastic_load_balancing_v2.types.describe_target_health_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeTargetHealth"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.describe_target_health_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_target_health(
