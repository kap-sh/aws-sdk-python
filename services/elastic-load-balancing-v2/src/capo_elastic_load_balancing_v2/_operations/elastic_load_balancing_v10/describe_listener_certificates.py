"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DescribeListenerCertificates``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeListenerCertificatesResult")
    out: capo_elastic_load_balancing_v2.types.describe_listener_certificates_output.DescribeListenerCertificatesOutput = capo_elastic_load_balancing_v2.types.describe_listener_certificates_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeListenerCertificates"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.describe_listener_certificates_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_listener_certificates(
