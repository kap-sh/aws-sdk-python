...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.describe_load_balancer_attributes_output.DescribeLoadBalancerAttributesOutput = capo_elastic_load_balancing_v2.types.describe_load_balancer_attributes_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.describe_load_balancer_attributes_input.serialize_query(
        input_, pairs, ""
    )
