"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DescribeLoadBalancers``."""
...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.describe_load_balancers_output.DescribeLoadBalancersOutput = capo_elastic_load_balancing_v2.types.describe_load_balancers_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.describe_load_balancers_input.serialize_query(
        input_, pairs, ""
    )
