"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DeleteTargetGroup``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteTargetGroupResult")
    out: capo_elastic_load_balancing_v2.types.delete_target_group_output.DeleteTargetGroupOutput = capo_elastic_load_balancing_v2.types.delete_target_group_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteTargetGroup"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.delete_target_group_input.serialize_query(
        input_, pairs, ""
    )
