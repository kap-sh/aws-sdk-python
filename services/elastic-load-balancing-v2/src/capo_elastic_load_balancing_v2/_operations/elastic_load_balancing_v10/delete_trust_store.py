...
import capo_elastic_load_balancing_v2.errors.trust_store_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "TrustStoreInUseException":
            raise capo_elastic_load_balancing_v2.errors.trust_store_in_use_exception.TrustStoreInUseException.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.delete_trust_store_output.DeleteTrustStoreOutput = capo_elastic_load_balancing_v2.types.delete_trust_store_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.delete_trust_store_input.serialize_query(
        input_, pairs, ""
    )
