...
import capo_elastic_load_balancing_v2.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ResourceNotFoundException":
            raise capo_elastic_load_balancing_v2.errors.resource_not_found_exception.ResourceNotFoundException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.get_resource_policy_output.GetResourcePolicyOutput = capo_elastic_load_balancing_v2.types.get_resource_policy_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.get_resource_policy_input.serialize_query(
        input_, pairs, ""
    )
