"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#GetTrustStoreRevocationContent``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetTrustStoreRevocationContentResult")
    out: capo_elastic_load_balancing_v2.types.get_trust_store_revocation_content_output.GetTrustStoreRevocationContentOutput = capo_elastic_load_balancing_v2.types.get_trust_store_revocation_content_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetTrustStoreRevocationContent"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.get_trust_store_revocation_content_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_trust_store_revocation_content(
