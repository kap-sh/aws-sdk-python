"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#RemoveTags``."""
...
import capo_elastic_load_balancing_v2.errors.listener_not_found_exception
import capo_elastic_load_balancing_v2.errors.load_balancer_not_found_exception
import capo_elastic_load_balancing_v2.errors.rule_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ListenerNotFoundException":
            raise capo_elastic_load_balancing_v2.errors.listener_not_found_exception.ListenerNotFoundException.from_query(
                root
            )
        ...
        case "RuleNotFoundException":
            raise capo_elastic_load_balancing_v2.errors.rule_not_found_exception.RuleNotFoundException.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("RemoveTagsResult")
    out: capo_elastic_load_balancing_v2.types.remove_tags_output.RemoveTagsOutput = (
        capo_elastic_load_balancing_v2.types.remove_tags_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "RemoveTags"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.remove_tags_input.serialize_query(
        input_, pairs, ""
    )
