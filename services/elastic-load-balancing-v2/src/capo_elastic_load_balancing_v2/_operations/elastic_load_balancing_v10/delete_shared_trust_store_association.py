...
import capo_elastic_load_balancing_v2.errors.delete_association_same_account_exception
import capo_elastic_load_balancing_v2.errors.trust_store_association_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DeleteAssociationSameAccountException":
            raise capo_elastic_load_balancing_v2.errors.delete_association_same_account_exception.DeleteAssociationSameAccountException.from_query(
                root
            )
        case "TrustStoreAssociationNotFoundException":
            raise capo_elastic_load_balancing_v2.errors.trust_store_association_not_found_exception.TrustStoreAssociationNotFoundException.from_query(
                root
            )
...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.delete_shared_trust_store_association_output.DeleteSharedTrustStoreAssociationOutput = capo_elastic_load_balancing_v2.types.delete_shared_trust_store_association_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.delete_shared_trust_store_association_input.serialize_query(
        input_, pairs, ""
    )
