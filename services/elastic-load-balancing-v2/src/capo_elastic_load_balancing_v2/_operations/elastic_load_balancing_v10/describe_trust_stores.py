"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DescribeTrustStores``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeTrustStoresResult")
    out: capo_elastic_load_balancing_v2.types.describe_trust_stores_output.DescribeTrustStoresOutput = capo_elastic_load_balancing_v2.types.describe_trust_stores_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeTrustStores"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.describe_trust_stores_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_trust_stores(
