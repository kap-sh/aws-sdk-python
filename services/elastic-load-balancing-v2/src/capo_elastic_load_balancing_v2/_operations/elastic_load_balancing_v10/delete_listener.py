"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DeleteListener``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteListenerResult")
    out: capo_elastic_load_balancing_v2.types.delete_listener_output.DeleteListenerOutput = capo_elastic_load_balancing_v2.types.delete_listener_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.delete_listener_input.serialize_query(
        input_, pairs, ""
    )
