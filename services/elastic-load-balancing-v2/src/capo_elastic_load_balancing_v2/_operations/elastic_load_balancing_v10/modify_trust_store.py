...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.modify_trust_store_output.ModifyTrustStoreOutput = capo_elastic_load_balancing_v2.types.modify_trust_store_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.modify_trust_store_input.serialize_query(
        input_, pairs, ""
    )
