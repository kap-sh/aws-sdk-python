...
if TYPE_CHECKING:
    ...
    import capo_elastic_load_balancing_v2.types.quic_server_id
    import capo_elastic_load_balancing_v2.types.target_id
    import capo_elastic_load_balancing_v2.types.zone_name


class TargetDescription(TypedDict, closed=True):
    id: NotRequired["capo_elastic_load_balancing_v2.types.target_id.TargetId"]
    ...
    quic_server_id: NotRequired[
        "capo_elastic_load_balancing_v2.types.quic_server_id.QuicServerId"
    ]
