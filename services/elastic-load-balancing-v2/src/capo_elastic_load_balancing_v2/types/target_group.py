...
class TargetGroup(TypedDict, closed=True):
    ...
    vpc_id: NotRequired["capo_elastic_load_balancing_v2.types.vpc_id.VpcId"]
    ...
    health_check_path: NotRequired["capo_elastic_load_balancing_v2.types.path.Path"]
    """<p>The destination for health checks on the targets.</p>"""
    matcher: NotRequired["capo_elastic_load_balancing_v2.types.matcher.Matcher"]
...
def serialize_query(
    ...
    if "load_balancer_arns" in value:
        ...
        capo_elastic_load_balancing_v2.types.load_balancer_arns.serialize_query(
            value["load_balancer_arns"], pairs, f"{key_prefix}LoadBalancerArns"
        )
...
def deserialize_query(el: Element) -> TargetGroup:
    ...
    if child_matcher is not None:
        ...
        out["matcher"] = capo_elastic_load_balancing_v2.types.matcher.deserialize_query(
            child_matcher
        )
    ...
    if child_load_balancer_arns is not None:
        ...
        out["load_balancer_arns"] = (
            capo_elastic_load_balancing_v2.types.load_balancer_arns.deserialize_query(
    ...
    if child_target_type is not None:
        ...
        out["target_type"] = (
            capo_elastic_load_balancing_v2.types.target_type_enum.deserialize_query(
                child_target_type
            )
        )
    ...
    if child_ip_address_type is not None:
        ...
        out["ip_address_type"] = (
            capo_elastic_load_balancing_v2.types.target_group_ip_address_type_enum.deserialize_query(
