...
if TYPE_CHECKING:
    import capo_elastic_load_balancing_v2.types.action_order
...
class Action(TypedDict, closed=True):
    type: NotRequired[
        "capo_elastic_load_balancing_v2.types.action_type_enum.ActionTypeEnum"
    ]
    ...
    authenticate_oidc_config: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_oidc_action_config.AuthenticateOidcActionConfig"
    ]
    ...
    authenticate_cognito_config: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_cognito_action_config.AuthenticateCognitoActionConfig"
    ]
    ...
    order: NotRequired["capo_elastic_load_balancing_v2.types.action_order.ActionOrder"]
    ...
    redirect_config: NotRequired[
        "capo_elastic_load_balancing_v2.types.redirect_action_config.RedirectActionConfig"
    ]
    ...
    fixed_response_config: NotRequired[
        "capo_elastic_load_balancing_v2.types.fixed_response_action_config.FixedResponseActionConfig"
    ]
    ...
    forward_config: NotRequired[
        "capo_elastic_load_balancing_v2.types.forward_action_config.ForwardActionConfig"
    ]
    ...
    jwt_validation_config: NotRequired[
        "capo_elastic_load_balancing_v2.types.jwt_validation_action_config.JwtValidationActionConfig"
    ]
...
def deserialize_query(el: Element) -> Action:
    ...
    if child_type is not None:
        ...
        out["type"] = (
            capo_elastic_load_balancing_v2.types.action_type_enum.deserialize_query(
                child_type
            )
        )
    ...
    if child_authenticate_oidc_config is not None:
        ...
        out["authenticate_oidc_config"] = (
            capo_elastic_load_balancing_v2.types.authenticate_oidc_action_config.deserialize_query(
    ...
    if child_authenticate_cognito_config is not None:
        ...
        out["authenticate_cognito_config"] = (
            capo_elastic_load_balancing_v2.types.authenticate_cognito_action_config.deserialize_query(
    ...
    if child_redirect_config is not None:
        ...
        out["redirect_config"] = (
            capo_elastic_load_balancing_v2.types.redirect_action_config.deserialize_query(
    ...
    if child_fixed_response_config is not None:
        ...
        out["fixed_response_config"] = (
            capo_elastic_load_balancing_v2.types.fixed_response_action_config.deserialize_query(
    ...
    if child_forward_config is not None:
        ...
        out["forward_config"] = (
            capo_elastic_load_balancing_v2.types.forward_action_config.deserialize_query(
    ...
    if child_jwt_validation_config is not None:
        ...
        out["jwt_validation_config"] = (
            capo_elastic_load_balancing_v2.types.jwt_validation_action_config.deserialize_query(
