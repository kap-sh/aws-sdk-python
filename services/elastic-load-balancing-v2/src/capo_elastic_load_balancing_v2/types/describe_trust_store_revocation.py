"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DescribeTrustStoreRevocation``."""
...
class DescribeTrustStoreRevocation(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: DescribeTrustStoreRevocation, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> DescribeTrustStoreRevocation:
    out: DescribeTrustStoreRevocation = {}  # type: ignore[typeddict-item]
