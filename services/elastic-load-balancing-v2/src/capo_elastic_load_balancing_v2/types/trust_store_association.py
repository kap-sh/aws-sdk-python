...
if TYPE_CHECKING:
    import capo_elastic_load_balancing_v2.types.trust_store_association_resource_arn


class TrustStoreAssociation(TypedDict, closed=True):
    resource_arn: NotRequired[
        "capo_elastic_load_balancing_v2.types.trust_store_association_resource_arn.TrustStoreAssociationResourceArn"
    ]
