...
if TYPE_CHECKING:
    import capo_elastic_load_balancing_v2.types.cipher_name
    import capo_elastic_load_balancing_v2.types.cipher_priority


class Cipher(TypedDict, closed=True):
    name: NotRequired["capo_elastic_load_balancing_v2.types.cipher_name.CipherName"]
    """<p>The name of the cipher.</p>"""
    priority: NotRequired[
        "capo_elastic_load_balancing_v2.types.cipher_priority.CipherPriority"
    ]
