...
TargetGroups: TypeAlias = list[
    "capo_elastic_load_balancing_v2.types.target_group.TargetGroup"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        capo_elastic_load_balancing_v2.types.target_group.serialize_query(
...
def deserialize_query(el: Element) -> TargetGroups:
    ...
    for child in el.findall("member"):
        out.append(
            capo_elastic_load_balancing_v2.types.target_group.deserialize_query(child)
        )
    return out
