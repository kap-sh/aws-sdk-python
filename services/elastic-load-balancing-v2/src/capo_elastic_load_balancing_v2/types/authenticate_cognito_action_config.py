...
if TYPE_CHECKING:
    ...
    import capo_elastic_load_balancing_v2.types.authenticate_cognito_action_scope
    import capo_elastic_load_balancing_v2.types.authenticate_cognito_action_session_cookie_name
    import capo_elastic_load_balancing_v2.types.authenticate_cognito_action_session_timeout
    import capo_elastic_load_balancing_v2.types.authenticate_cognito_action_user_pool_arn
    import capo_elastic_load_balancing_v2.types.authenticate_cognito_action_user_pool_client_id
    import capo_elastic_load_balancing_v2.types.authenticate_cognito_action_user_pool_domain


class AuthenticateCognitoActionConfig(TypedDict, closed=True):
    user_pool_arn: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_cognito_action_user_pool_arn.AuthenticateCognitoActionUserPoolArn"
    ]
    """<p>The Amazon Resource Name (ARN) of the Amazon Cognito user pool.</p>"""
    user_pool_client_id: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_cognito_action_user_pool_client_id.AuthenticateCognitoActionUserPoolClientId"
    ]
    """<p>The ID of the Amazon Cognito user pool client.</p>"""
    user_pool_domain: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_cognito_action_user_pool_domain.AuthenticateCognitoActionUserPoolDomain"
    ]
    """<p>The domain prefix or fully-qualified domain name of the Amazon Cognito user pool.</p>"""
    session_cookie_name: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_cognito_action_session_cookie_name.AuthenticateCognitoActionSessionCookieName"
    ]
    """<p>The name of the cookie used to maintain session information. The default is AWSELBAuthSessionCookie.</p>"""
    scope: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_cognito_action_scope.AuthenticateCognitoActionScope"
    ]
    ...
    session_timeout: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_cognito_action_session_timeout.AuthenticateCognitoActionSessionTimeout"
    ]
    ...
    authentication_request_extra_params: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_cognito_action_authentication_request_extra_params.AuthenticateCognitoActionAuthenticationRequestExtraParams"
    ]
    ...
    on_unauthenticated_request: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_cognito_action_conditional_behavior_enum.AuthenticateCognitoActionConditionalBehaviorEnum"
    ]
...
def deserialize_query(el: Element) -> AuthenticateCognitoActionConfig:
    ...
    if child_authentication_request_extra_params is not None:
        ...
        out["authentication_request_extra_params"] = (
            capo_elastic_load_balancing_v2.types.authenticate_cognito_action_authentication_request_extra_params.deserialize_query(
    ...
    if child_on_unauthenticated_request is not None:
        ...
        out["on_unauthenticated_request"] = (
            capo_elastic_load_balancing_v2.types.authenticate_cognito_action_conditional_behavior_enum.deserialize_query(
