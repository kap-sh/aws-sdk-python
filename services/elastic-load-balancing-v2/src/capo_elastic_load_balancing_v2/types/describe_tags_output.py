...
class DescribeTagsOutput(TypedDict, closed=True):
    tag_descriptions: NotRequired[
        "capo_elastic_load_balancing_v2.types.tag_descriptions.TagDescriptions"
    ]
...
def serialize_query(
    ...
    if "tag_descriptions" in value:
        ...
        capo_elastic_load_balancing_v2.types.tag_descriptions.serialize_query(
...
def deserialize_query(el: Element) -> DescribeTagsOutput:
    ...
    if child_tag_descriptions is not None:
        ...
        out["tag_descriptions"] = (
            capo_elastic_load_balancing_v2.types.tag_descriptions.deserialize_query(
