...
if TYPE_CHECKING:
    ...
    import capo_elastic_load_balancing_v2.types.authenticate_oidc_action_authorization_endpoint
    import capo_elastic_load_balancing_v2.types.authenticate_oidc_action_client_id
    import capo_elastic_load_balancing_v2.types.authenticate_oidc_action_client_secret
    import capo_elastic_load_balancing_v2.types.authenticate_oidc_action_conditional_behavior_enum
    import capo_elastic_load_balancing_v2.types.authenticate_oidc_action_issuer
    import capo_elastic_load_balancing_v2.types.authenticate_oidc_action_scope
    import capo_elastic_load_balancing_v2.types.authenticate_oidc_action_session_cookie_name
    import capo_elastic_load_balancing_v2.types.authenticate_oidc_action_session_timeout
    import capo_elastic_load_balancing_v2.types.authenticate_oidc_action_token_endpoint
    import capo_elastic_load_balancing_v2.types.authenticate_oidc_action_use_existing_client_secret
    import capo_elastic_load_balancing_v2.types.authenticate_oidc_action_user_info_endpoint


class AuthenticateOidcActionConfig(TypedDict, closed=True):
    issuer: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_oidc_action_issuer.AuthenticateOidcActionIssuer"
    ]
    ...
    authorization_endpoint: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_oidc_action_authorization_endpoint.AuthenticateOidcActionAuthorizationEndpoint"
    ]
    ...
    token_endpoint: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_oidc_action_token_endpoint.AuthenticateOidcActionTokenEndpoint"
    ]
    ...
    user_info_endpoint: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_oidc_action_user_info_endpoint.AuthenticateOidcActionUserInfoEndpoint"
    ]
    ...
    client_id: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_oidc_action_client_id.AuthenticateOidcActionClientId"
    ]
    """<p>The OAuth 2.0 client identifier.</p>"""
    client_secret: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_oidc_action_client_secret.AuthenticateOidcActionClientSecret"
    ]
    ...
    session_cookie_name: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_oidc_action_session_cookie_name.AuthenticateOidcActionSessionCookieName"
    ]
    """<p>The name of the cookie used to maintain session information. The default is AWSELBAuthSessionCookie.</p>"""
    scope: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_oidc_action_scope.AuthenticateOidcActionScope"
    ]
    ...
    session_timeout: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_oidc_action_session_timeout.AuthenticateOidcActionSessionTimeout"
    ]
    ...
    authentication_request_extra_params: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_oidc_action_authentication_request_extra_params.AuthenticateOidcActionAuthenticationRequestExtraParams"
    ]
    ...
    on_unauthenticated_request: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_oidc_action_conditional_behavior_enum.AuthenticateOidcActionConditionalBehaviorEnum"
    ]
    ...
    use_existing_client_secret: NotRequired[
        "capo_elastic_load_balancing_v2.types.authenticate_oidc_action_use_existing_client_secret.AuthenticateOidcActionUseExistingClientSecret"
    ]
...
def deserialize_query(el: Element) -> AuthenticateOidcActionConfig:
    ...
    if child_authentication_request_extra_params is not None:
        ...
        out["authentication_request_extra_params"] = (
            capo_elastic_load_balancing_v2.types.authenticate_oidc_action_authentication_request_extra_params.deserialize_query(
    ...
    if child_on_unauthenticated_request is not None:
        ...
        out["on_unauthenticated_request"] = (
            capo_elastic_load_balancing_v2.types.authenticate_oidc_action_conditional_behavior_enum.deserialize_query(
