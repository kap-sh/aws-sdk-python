"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#ModifyCapacityReservationOutput``."""
...
class ModifyCapacityReservationOutput(TypedDict, closed=True):
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ModifyCapacityReservationOutput, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ModifyCapacityReservationOutput:
    out: ModifyCapacityReservationOutput = {}  # type: ignore[typeddict-item]
