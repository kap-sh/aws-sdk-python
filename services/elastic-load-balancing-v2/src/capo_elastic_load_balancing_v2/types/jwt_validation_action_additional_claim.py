...
if TYPE_CHECKING:
    ...
    import capo_elastic_load_balancing_v2.types.jwt_validation_action_additional_claim_name
...
class JwtValidationActionAdditionalClaim(TypedDict, closed=True):
    format: NotRequired[
        "capo_elastic_load_balancing_v2.types.jwt_validation_action_additional_claim_format_enum.JwtValidationActionAdditionalClaimFormatEnum"
    ]
    """<p>The format of the claim value.</p>"""
    name: NotRequired[
        "capo_elastic_load_balancing_v2.types.jwt_validation_action_additional_claim_name.JwtValidationActionAdditionalClaimName"
    ]
    ...
    values: NotRequired[
        "capo_elastic_load_balancing_v2.types.jwt_validation_action_additional_claim_values.JwtValidationActionAdditionalClaimValues"
    ]
...
def deserialize_query(el: Element) -> JwtValidationActionAdditionalClaim:
    ...
    if child_format is not None:
        ...
        out["format"] = (
            capo_elastic_load_balancing_v2.types.jwt_validation_action_additional_claim_format_enum.deserialize_query(
                child_format
            )
        )
    ...
    if child_values is not None:
        ...
        out["values"] = (
            capo_elastic_load_balancing_v2.types.jwt_validation_action_additional_claim_values.deserialize_query(
                child_values
            )
        )
    return out
