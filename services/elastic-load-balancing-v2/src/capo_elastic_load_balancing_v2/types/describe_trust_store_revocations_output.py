...
class DescribeTrustStoreRevocationsOutput(TypedDict, closed=True):
    trust_store_revocations: NotRequired[
        "capo_elastic_load_balancing_v2.types.describe_trust_store_revocation_response.DescribeTrustStoreRevocationResponse"
    ]
...
def serialize_query(
    ...
    if "trust_store_revocations" in value:
        ...
        capo_elastic_load_balancing_v2.types.describe_trust_store_revocation_response.serialize_query(
...
def deserialize_query(el: Element) -> DescribeTrustStoreRevocationsOutput:
    ...
    if child_trust_store_revocations is not None:
        ...
        out["trust_store_revocations"] = (
            capo_elastic_load_balancing_v2.types.describe_trust_store_revocation_response.deserialize_query(
