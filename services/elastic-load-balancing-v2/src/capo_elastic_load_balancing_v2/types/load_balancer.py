...
if TYPE_CHECKING:
    ...
    import capo_elastic_load_balancing_v2.types.canonical_hosted_zone_id
    ...
    import capo_elastic_load_balancing_v2.types.dns_name
    import capo_elastic_load_balancing_v2.types.enable_prefix_for_ipv6_source_nat_enum
    import capo_elastic_load_balancing_v2.types.enforce_security_group_inbound_rules_on_private_link_traffic
...
class LoadBalancer(TypedDict, closed=True):
    ...
    dns_name: NotRequired["capo_elastic_load_balancing_v2.types.dns_name.DNSName"]
    """<p>The public DNS name of the load balancer.</p>"""
    canonical_hosted_zone_id: NotRequired[
        "capo_elastic_load_balancing_v2.types.canonical_hosted_zone_id.CanonicalHostedZoneId"
    ]
    """<p>The ID of the Amazon Route 53 hosted zone associated with the load balancer.</p>"""
    created_time: NotRequired[
        "capo_elastic_load_balancing_v2.types.created_time.CreatedTime"
    ]
    ...
    state: NotRequired[
        "capo_elastic_load_balancing_v2.types.load_balancer_state.LoadBalancerState"
    ]
    ...
    enforce_security_group_inbound_rules_on_private_link_traffic: NotRequired[
        "capo_elastic_load_balancing_v2.types.enforce_security_group_inbound_rules_on_private_link_traffic.EnforceSecurityGroupInboundRulesOnPrivateLinkTraffic"
    ]
...
def deserialize_query(el: Element) -> LoadBalancer:
    ...
    if child_created_time is not None:
        ...
        out["created_time"] = (
            capo_elastic_load_balancing_v2.types.created_time.deserialize_query(
                child_created_time
            )
        )
    ...
    if child_state is not None:
        ...
        out["state"] = (
            capo_elastic_load_balancing_v2.types.load_balancer_state.deserialize_query(
                child_state
            )
        )
