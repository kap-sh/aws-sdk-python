...
class AdministrativeOverride(TypedDict, closed=True):
    state: NotRequired[
        "capo_elastic_load_balancing_v2.types.target_administrative_override_state_enum.TargetAdministrativeOverrideStateEnum"
    ]
    """<p>The state of the override.</p>"""
    reason: NotRequired[
        "capo_elastic_load_balancing_v2.types.target_administrative_override_reason_enum.TargetAdministrativeOverrideReasonEnum"
    ]
...
def deserialize_query(el: Element) -> AdministrativeOverride:
    ...
    if child_state is not None:
        ...
        out["state"] = (
            capo_elastic_load_balancing_v2.types.target_administrative_override_state_enum.deserialize_query(
                child_state
            )
        )
    ...
    if child_reason is not None:
        ...
        out["reason"] = (
            capo_elastic_load_balancing_v2.types.target_administrative_override_reason_enum.deserialize_query(
                child_reason
            )
        )
