...
class RuleTransform(TypedDict, closed=True):
    type: NotRequired[
        "capo_elastic_load_balancing_v2.types.transform_type_enum.TransformTypeEnum"
    ]
    ...
    host_header_rewrite_config: NotRequired[
        "capo_elastic_load_balancing_v2.types.host_header_rewrite_config.HostHeaderRewriteConfig"
    ]
    ...
    url_rewrite_config: NotRequired[
        "capo_elastic_load_balancing_v2.types.url_rewrite_config.UrlRewriteConfig"
    ]
...
def deserialize_query(el: Element) -> RuleTransform:
    ...
    if child_type is not None:
        ...
        out["type"] = (
            capo_elastic_load_balancing_v2.types.transform_type_enum.deserialize_query(
                child_type
            )
        )
    ...
    if child_host_header_rewrite_config is not None:
        ...
        out["host_header_rewrite_config"] = (
            capo_elastic_load_balancing_v2.types.host_header_rewrite_config.deserialize_query(
    ...
    if child_url_rewrite_config is not None:
        ...
        out["url_rewrite_config"] = (
            capo_elastic_load_balancing_v2.types.url_rewrite_config.deserialize_query(
