"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DuplicateTagKeysException``."""
...
class DuplicateTagKeysException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticloadbalancingv2#DuplicateTagKeysException``."""
