"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#TooManyRegistrationsForTargetIdException``."""
...
class TooManyRegistrationsForTargetIdException_(TypedDict, closed=True):
    message: NotRequired[
...
# --- awsQuery ser/de ---
def serialize_query(
    value: TooManyRegistrationsForTargetIdException_,
...
def deserialize_query(el: Element) -> TooManyRegistrationsForTargetIdException_:
    out: TooManyRegistrationsForTargetIdException_ = {}  # type: ignore[typeddict-item]
...
class TooManyRegistrationsForTargetIdException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticloadbalancingv2#TooManyRegistrationsForTargetIdException``."""
