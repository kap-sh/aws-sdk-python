...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.describe_trust_stores_output.DescribeTrustStoresOutput = aws_sdk_elastic_load_balancing_v2.types.describe_trust_stores_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.describe_trust_stores_input.DescribeTrustStoresInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.describe_trust_stores_input.serialize_query(
        input_, pairs, ""
    )
