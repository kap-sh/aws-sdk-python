...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.remove_trust_store_revocations_output.RemoveTrustStoreRevocationsOutput = aws_sdk_elastic_load_balancing_v2.types.remove_trust_store_revocations_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.remove_trust_store_revocations_input.RemoveTrustStoreRevocationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.remove_trust_store_revocations_input.serialize_query(
        input_, pairs, ""
    )
