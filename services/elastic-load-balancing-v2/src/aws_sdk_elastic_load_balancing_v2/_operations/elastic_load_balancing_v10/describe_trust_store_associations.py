...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.describe_trust_store_associations_output.DescribeTrustStoreAssociationsOutput = aws_sdk_elastic_load_balancing_v2.types.describe_trust_store_associations_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.describe_trust_store_associations_input.DescribeTrustStoreAssociationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.describe_trust_store_associations_input.serialize_query(
        input_, pairs, ""
    )
