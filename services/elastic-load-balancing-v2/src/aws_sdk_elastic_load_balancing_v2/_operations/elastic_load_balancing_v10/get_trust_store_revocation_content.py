...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "RevocationIdNotFoundException":
            import aws_sdk_elastic_load_balancing_v2.errors.revocation_id_not_found_exception

            raise aws_sdk_elastic_load_balancing_v2.errors.revocation_id_not_found_exception.RevocationIdNotFoundException.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.get_trust_store_revocation_content_output.GetTrustStoreRevocationContentOutput = aws_sdk_elastic_load_balancing_v2.types.get_trust_store_revocation_content_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.get_trust_store_revocation_content_input.GetTrustStoreRevocationContentInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.get_trust_store_revocation_content_input.serialize_query(
        input_, pairs, ""
    )
