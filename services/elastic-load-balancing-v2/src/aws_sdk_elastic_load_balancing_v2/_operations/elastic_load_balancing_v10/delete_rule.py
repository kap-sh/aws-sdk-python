...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.delete_rule_output.DeleteRuleOutput = (
        aws_sdk_elastic_load_balancing_v2.types.delete_rule_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.delete_rule_input.DeleteRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.delete_rule_input.serialize_query(
        input_, pairs, ""
    )
