"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#ModifyTargetGroup``."""
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.modify_target_group_input.ModifyTargetGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyTargetGroup"))
    pairs.append(("Version", "2015-12-01"))
    import aws_sdk_elastic_load_balancing_v2.types.modify_target_group_input

    aws_sdk_elastic_load_balancing_v2.types.modify_target_group_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_target_group(
