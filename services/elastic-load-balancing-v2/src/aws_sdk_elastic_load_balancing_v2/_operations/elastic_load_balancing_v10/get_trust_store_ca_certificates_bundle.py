"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#GetTrustStoreCaCertificatesBundle``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetTrustStoreCaCertificatesBundleResult")
    out: aws_sdk_elastic_load_balancing_v2.types.get_trust_store_ca_certificates_bundle_output.GetTrustStoreCaCertificatesBundleOutput = aws_sdk_elastic_load_balancing_v2.types.get_trust_store_ca_certificates_bundle_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.get_trust_store_ca_certificates_bundle_input.GetTrustStoreCaCertificatesBundleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "GetTrustStoreCaCertificatesBundle"))
    pairs.append(("Version", "2015-12-01"))
    aws_sdk_elastic_load_balancing_v2.types.get_trust_store_ca_certificates_bundle_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_trust_store_ca_certificates_bundle(
