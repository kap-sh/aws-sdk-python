...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyRulesException":
            import aws_sdk_elastic_load_balancing_v2.errors.too_many_rules_exception

            raise aws_sdk_elastic_load_balancing_v2.errors.too_many_rules_exception.TooManyRulesException.from_query(
                root
            )
...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.create_rule_output.CreateRuleOutput = (
        aws_sdk_elastic_load_balancing_v2.types.create_rule_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.create_rule_input.CreateRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.create_rule_input.serialize_query(
        input_, pairs, ""
    )
