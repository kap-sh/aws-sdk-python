...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.set_subnets_output.SetSubnetsOutput = (
        aws_sdk_elastic_load_balancing_v2.types.set_subnets_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.set_subnets_input.SetSubnetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.set_subnets_input.serialize_query(
        input_, pairs, ""
    )
