"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#SetSecurityGroups``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("SetSecurityGroupsResult")
    out: aws_sdk_elastic_load_balancing_v2.types.set_security_groups_output.SetSecurityGroupsOutput = aws_sdk_elastic_load_balancing_v2.types.set_security_groups_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.set_security_groups_input.SetSecurityGroupsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "SetSecurityGroups"))
    pairs.append(("Version", "2015-12-01"))
    import aws_sdk_elastic_load_balancing_v2.types.set_security_groups_input

    aws_sdk_elastic_load_balancing_v2.types.set_security_groups_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_set_security_groups(
