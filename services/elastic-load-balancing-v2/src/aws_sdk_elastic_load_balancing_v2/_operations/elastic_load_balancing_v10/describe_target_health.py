...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.describe_target_health_input.DescribeTargetHealthInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.describe_target_health_input.serialize_query(
        input_, pairs, ""
    )
