...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.deregister_targets_output.DeregisterTargetsOutput = aws_sdk_elastic_load_balancing_v2.types.deregister_targets_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.deregister_targets_input.DeregisterTargetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
