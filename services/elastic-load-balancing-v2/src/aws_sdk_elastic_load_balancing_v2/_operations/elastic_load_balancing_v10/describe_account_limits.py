"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DescribeAccountLimits``."""
...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.describe_account_limits_output.DescribeAccountLimitsOutput = aws_sdk_elastic_load_balancing_v2.types.describe_account_limits_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.describe_account_limits_input.DescribeAccountLimitsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
