...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.describe_load_balancers_output.DescribeLoadBalancersOutput = aws_sdk_elastic_load_balancing_v2.types.describe_load_balancers_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.describe_load_balancers_input.DescribeLoadBalancersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.describe_load_balancers_input.serialize_query(
        input_, pairs, ""
    )
