...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.describe_listener_attributes_output.DescribeListenerAttributesOutput = aws_sdk_elastic_load_balancing_v2.types.describe_listener_attributes_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.describe_listener_attributes_input.DescribeListenerAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.describe_listener_attributes_input.serialize_query(
        input_, pairs, ""
    )
