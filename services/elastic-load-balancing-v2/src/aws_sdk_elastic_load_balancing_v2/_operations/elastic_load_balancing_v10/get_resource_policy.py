"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#GetResourcePolicy``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ResourceNotFoundException":
            import aws_sdk_elastic_load_balancing_v2.errors.resource_not_found_exception

            raise aws_sdk_elastic_load_balancing_v2.errors.resource_not_found_exception.ResourceNotFoundException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.get_resource_policy_output.GetResourcePolicyOutput = aws_sdk_elastic_load_balancing_v2.types.get_resource_policy_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.get_resource_policy_input.GetResourcePolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
