...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.add_listener_certificates_output.AddListenerCertificatesOutput = aws_sdk_elastic_load_balancing_v2.types.add_listener_certificates_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.add_listener_certificates_input.AddListenerCertificatesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.add_listener_certificates_input.serialize_query(
        input_, pairs, ""
    )
