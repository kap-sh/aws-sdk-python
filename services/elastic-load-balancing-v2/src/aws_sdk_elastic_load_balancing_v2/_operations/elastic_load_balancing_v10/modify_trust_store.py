"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#ModifyTrustStore``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyTrustStoreResult")
    out: aws_sdk_elastic_load_balancing_v2.types.modify_trust_store_output.ModifyTrustStoreOutput = aws_sdk_elastic_load_balancing_v2.types.modify_trust_store_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.modify_trust_store_input.ModifyTrustStoreInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyTrustStore"))
    pairs.append(("Version", "2015-12-01"))
    import aws_sdk_elastic_load_balancing_v2.types.modify_trust_store_input

    aws_sdk_elastic_load_balancing_v2.types.modify_trust_store_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_trust_store(
