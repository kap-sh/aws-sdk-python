...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.delete_target_group_output.DeleteTargetGroupOutput = aws_sdk_elastic_load_balancing_v2.types.delete_target_group_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.delete_target_group_input.DeleteTargetGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.delete_target_group_input.serialize_query(
        input_, pairs, ""
    )
