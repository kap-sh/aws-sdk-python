"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DescribeTargetGroups``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeTargetGroupsResult")
    out: aws_sdk_elastic_load_balancing_v2.types.describe_target_groups_output.DescribeTargetGroupsOutput = aws_sdk_elastic_load_balancing_v2.types.describe_target_groups_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.describe_target_groups_input.DescribeTargetGroupsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeTargetGroups"))
    pairs.append(("Version", "2015-12-01"))
    import aws_sdk_elastic_load_balancing_v2.types.describe_target_groups_input

    aws_sdk_elastic_load_balancing_v2.types.describe_target_groups_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_target_groups(
