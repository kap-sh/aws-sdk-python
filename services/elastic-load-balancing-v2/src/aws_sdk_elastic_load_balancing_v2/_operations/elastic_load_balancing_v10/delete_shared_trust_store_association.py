"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DeleteSharedTrustStoreAssociation``."""
...
import aws_sdk_elastic_load_balancing_v2.errors.delete_association_same_account_exception
import aws_sdk_elastic_load_balancing_v2.errors.trust_store_association_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DeleteAssociationSameAccountException":
            raise aws_sdk_elastic_load_balancing_v2.errors.delete_association_same_account_exception.DeleteAssociationSameAccountException.from_query(
                root
            )
        case "TrustStoreAssociationNotFoundException":
            raise aws_sdk_elastic_load_balancing_v2.errors.trust_store_association_not_found_exception.TrustStoreAssociationNotFoundException.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteSharedTrustStoreAssociationResult")
    out: aws_sdk_elastic_load_balancing_v2.types.delete_shared_trust_store_association_output.DeleteSharedTrustStoreAssociationOutput = aws_sdk_elastic_load_balancing_v2.types.delete_shared_trust_store_association_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.delete_shared_trust_store_association_input.DeleteSharedTrustStoreAssociationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_shared_trust_store_association(
