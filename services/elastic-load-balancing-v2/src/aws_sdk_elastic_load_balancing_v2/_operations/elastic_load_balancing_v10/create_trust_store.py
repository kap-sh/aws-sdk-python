...
import aws_sdk_elastic_load_balancing_v2.errors.ca_certificates_bundle_not_found_exception
import aws_sdk_elastic_load_balancing_v2.errors.duplicate_tag_keys_exception
import aws_sdk_elastic_load_balancing_v2.errors.duplicate_trust_store_name_exception
import aws_sdk_elastic_load_balancing_v2.errors.invalid_ca_certificates_bundle_exception
import aws_sdk_elastic_load_balancing_v2.errors.too_many_tags_exception
import aws_sdk_elastic_load_balancing_v2.errors.too_many_trust_stores_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CaCertificatesBundleNotFoundException":
            raise aws_sdk_elastic_load_balancing_v2.errors.ca_certificates_bundle_not_found_exception.CaCertificatesBundleNotFoundException.from_query(
                root
            )
        ...
        case "DuplicateTrustStoreNameException":
            raise aws_sdk_elastic_load_balancing_v2.errors.duplicate_trust_store_name_exception.DuplicateTrustStoreNameException.from_query(
                root
            )
        case "InvalidCaCertificatesBundleException":
            raise aws_sdk_elastic_load_balancing_v2.errors.invalid_ca_certificates_bundle_exception.InvalidCaCertificatesBundleException.from_query(
                root
            )
        ...
        case "TooManyTrustStoresException":
            raise aws_sdk_elastic_load_balancing_v2.errors.too_many_trust_stores_exception.TooManyTrustStoresException.from_query(
                root
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.create_trust_store_output.CreateTrustStoreOutput = aws_sdk_elastic_load_balancing_v2.types.create_trust_store_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.create_trust_store_input.CreateTrustStoreInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.create_trust_store_input.serialize_query(
        input_, pairs, ""
    )
