...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.describe_capacity_reservation_output.DescribeCapacityReservationOutput = aws_sdk_elastic_load_balancing_v2.types.describe_capacity_reservation_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.describe_capacity_reservation_input.DescribeCapacityReservationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.describe_capacity_reservation_input.serialize_query(
        input_, pairs, ""
    )
