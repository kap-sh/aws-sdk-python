...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.describe_trust_store_revocations_output.DescribeTrustStoreRevocationsOutput = aws_sdk_elastic_load_balancing_v2.types.describe_trust_store_revocations_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.describe_trust_store_revocations_input.DescribeTrustStoreRevocationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.describe_trust_store_revocations_input.serialize_query(
        input_, pairs, ""
    )
