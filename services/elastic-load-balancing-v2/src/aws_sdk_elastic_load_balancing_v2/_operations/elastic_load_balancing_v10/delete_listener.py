...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.delete_listener_output.DeleteListenerOutput = aws_sdk_elastic_load_balancing_v2.types.delete_listener_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.delete_listener_input.DeleteListenerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
