...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.describe_ssl_policies_output.DescribeSSLPoliciesOutput = aws_sdk_elastic_load_balancing_v2.types.describe_ssl_policies_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.describe_ssl_policies_input.DescribeSSLPoliciesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.describe_ssl_policies_input.serialize_query(
        input_, pairs, ""
    )
