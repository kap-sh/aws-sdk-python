...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.set_ip_address_type_output.SetIpAddressTypeOutput = aws_sdk_elastic_load_balancing_v2.types.set_ip_address_type_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.set_ip_address_type_input.SetIpAddressTypeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.set_ip_address_type_input.serialize_query(
        input_, pairs, ""
    )
