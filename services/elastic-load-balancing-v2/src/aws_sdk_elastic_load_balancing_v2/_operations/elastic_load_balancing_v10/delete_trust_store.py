"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DeleteTrustStore``."""
...
import aws_sdk_elastic_load_balancing_v2.errors.trust_store_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "TrustStoreInUseException":
            raise aws_sdk_elastic_load_balancing_v2.errors.trust_store_in_use_exception.TrustStoreInUseException.from_query(
                root
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteTrustStoreResult")
    out: aws_sdk_elastic_load_balancing_v2.types.delete_trust_store_output.DeleteTrustStoreOutput = aws_sdk_elastic_load_balancing_v2.types.delete_trust_store_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.delete_trust_store_input.DeleteTrustStoreInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DeleteTrustStore"))
    pairs.append(("Version", "2015-12-01"))
    aws_sdk_elastic_load_balancing_v2.types.delete_trust_store_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_trust_store(
