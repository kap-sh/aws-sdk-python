...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.modify_listener_output.ModifyListenerOutput = aws_sdk_elastic_load_balancing_v2.types.modify_listener_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.modify_listener_input.ModifyListenerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.modify_listener_input.serialize_query(
        input_, pairs, ""
    )
