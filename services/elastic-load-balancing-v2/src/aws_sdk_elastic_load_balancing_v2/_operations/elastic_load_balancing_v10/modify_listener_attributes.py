"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#ModifyListenerAttributes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyListenerAttributesResult")
    out: aws_sdk_elastic_load_balancing_v2.types.modify_listener_attributes_output.ModifyListenerAttributesOutput = aws_sdk_elastic_load_balancing_v2.types.modify_listener_attributes_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.modify_listener_attributes_input.ModifyListenerAttributesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyListenerAttributes"))
    pairs.append(("Version", "2015-12-01"))
    import aws_sdk_elastic_load_balancing_v2.types.modify_listener_attributes_input

    aws_sdk_elastic_load_balancing_v2.types.modify_listener_attributes_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_listener_attributes(
