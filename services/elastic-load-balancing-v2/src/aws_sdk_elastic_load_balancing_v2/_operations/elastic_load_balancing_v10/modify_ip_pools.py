...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.modify_ip_pools_output.ModifyIpPoolsOutput = aws_sdk_elastic_load_balancing_v2.types.modify_ip_pools_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.modify_ip_pools_input.ModifyIpPoolsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.modify_ip_pools_input.serialize_query(
        input_, pairs, ""
    )
