"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#ModifyRule``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyRuleResult")
    out: aws_sdk_elastic_load_balancing_v2.types.modify_rule_output.ModifyRuleOutput = (
        aws_sdk_elastic_load_balancing_v2.types.modify_rule_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.modify_rule_input.ModifyRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "ModifyRule"))
    pairs.append(("Version", "2015-12-01"))
    import aws_sdk_elastic_load_balancing_v2.types.modify_rule_input

    aws_sdk_elastic_load_balancing_v2.types.modify_rule_input.serialize_query(
        input_, pairs, ""
    )
