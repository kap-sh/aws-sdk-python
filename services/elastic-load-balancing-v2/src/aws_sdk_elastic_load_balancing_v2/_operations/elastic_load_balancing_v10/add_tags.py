"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#AddTags``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("AddTagsResult")
    out: aws_sdk_elastic_load_balancing_v2.types.add_tags_output.AddTagsOutput = (
        aws_sdk_elastic_load_balancing_v2.types.add_tags_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.add_tags_input.AddTagsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "AddTags"))
    pairs.append(("Version", "2015-12-01"))
    import aws_sdk_elastic_load_balancing_v2.types.add_tags_input

    aws_sdk_elastic_load_balancing_v2.types.add_tags_input.serialize_query(
        input_, pairs, ""
    )
