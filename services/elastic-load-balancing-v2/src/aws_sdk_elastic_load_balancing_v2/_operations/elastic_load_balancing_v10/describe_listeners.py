...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.describe_listeners_output.DescribeListenersOutput = aws_sdk_elastic_load_balancing_v2.types.describe_listeners_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.describe_listeners_input.DescribeListenersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.describe_listeners_input.serialize_query(
        input_, pairs, ""
    )
