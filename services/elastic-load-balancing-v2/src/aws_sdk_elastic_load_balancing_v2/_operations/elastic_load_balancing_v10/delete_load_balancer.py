...
def handle_response(
    ...
    out: aws_sdk_elastic_load_balancing_v2.types.delete_load_balancer_output.DeleteLoadBalancerOutput = aws_sdk_elastic_load_balancing_v2.types.delete_load_balancer_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.delete_load_balancer_input.DeleteLoadBalancerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    aws_sdk_elastic_load_balancing_v2.types.delete_load_balancer_input.serialize_query(
        input_, pairs, ""
    )
