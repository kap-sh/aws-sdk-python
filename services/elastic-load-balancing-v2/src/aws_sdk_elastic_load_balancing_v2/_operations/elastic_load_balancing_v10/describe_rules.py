"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DescribeRules``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeRulesResult")
    out: aws_sdk_elastic_load_balancing_v2.types.describe_rules_output.DescribeRulesOutput = aws_sdk_elastic_load_balancing_v2.types.describe_rules_output.deserialize_query(
...
def build_request(
    ...
    input_: aws_sdk_elastic_load_balancing_v2.types.describe_rules_input.DescribeRulesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    pairs.append(("Action", "DescribeRules"))
    pairs.append(("Version", "2015-12-01"))
    import aws_sdk_elastic_load_balancing_v2.types.describe_rules_input

    aws_sdk_elastic_load_balancing_v2.types.describe_rules_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_rules(
