...
class ElasticLoadBalancingv2Error(Exception):
    """Base class for all ElasticLoadBalancingv2 service errors."""


class ServiceError(ElasticLoadBalancingv2Error):
...
class SerializationError(ElasticLoadBalancingv2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(ElasticLoadBalancingv2Error):
...
class WaiterFailedError(ElasticLoadBalancingv2Error):
...
class WaiterTimeoutError(ElasticLoadBalancingv2Error):
