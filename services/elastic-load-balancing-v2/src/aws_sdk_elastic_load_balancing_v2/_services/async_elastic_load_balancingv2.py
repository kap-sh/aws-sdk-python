...
from aws_sdk_elastic_load_balancing_v2._async import anysleep
...
class AsyncElasticLoadBalancingv2ClientConfig(TypedDict, total=False):
...
class AsyncElasticLoadBalancingv2Client:
    ...
    def __init__(
        ...
        self.config = AsyncElasticLoadBalancingv2ClientConfig(
            {
    ...
    async def add_listener_certificates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.add_listener_certificates_input.AddListenerCertificatesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.add_listener_certificates_output.AddListenerCertificatesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.add_listener_certificates.async_add_listener_certificates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.add_listener_certificates_input.AddListenerCertificatesInput = {}  # type: ignore[typeddict-item]
    ...
    async def add_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.add_tags_input.AddTagsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.add_tags_output.AddTagsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.add_tags.async_add_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.add_tags_input.AddTagsInput = {}  # type: ignore[typeddict-item]
    ...
    async def add_trust_store_revocations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.add_trust_store_revocations_input.AddTrustStoreRevocationsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.add_trust_store_revocations_output.AddTrustStoreRevocationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.add_trust_store_revocations.async_add_trust_store_revocations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.add_trust_store_revocations_input.AddTrustStoreRevocationsInput = {}  # type: ignore[typeddict-item]
        input["trust_store_arn"] = trust_store_arn
        if revocation_contents is not None:
            input["revocation_contents"] = revocation_contents
    ...
    async def create_listener(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.create_listener_input.CreateListenerInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.create_listener_output.CreateListenerOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.create_listener.async_create_listener(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.create_listener_input.CreateListenerInput = {}  # type: ignore[typeddict-item]
        input["load_balancer_arn"] = load_balancer_arn
        if protocol is not None:
            input["protocol"] = protocol
        if port is not None:
            input["port"] = port
        if ssl_policy is not None:
            input["ssl_policy"] = ssl_policy
        if certificates is not None:
            input["certificates"] = certificates
        input["default_actions"] = default_actions
        if alpn_policy is not None:
            input["alpn_policy"] = alpn_policy
        if tags is not None:
            input["tags"] = tags
        if mutual_authentication is not None:
            input["mutual_authentication"] = mutual_authentication
    ...
    async def create_load_balancer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.create_load_balancer_input.CreateLoadBalancerInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.create_load_balancer_output.CreateLoadBalancerOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.create_load_balancer.async_create_load_balancer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.create_load_balancer_input.CreateLoadBalancerInput = {}  # type: ignore[typeddict-item]
        input["name"] = name
        ...
        if enable_prefix_for_ipv6_source_nat is not None:
            input["enable_prefix_for_ipv6_source_nat"] = (
                enable_prefix_for_ipv6_source_nat
            )
        if ipam_pools is not None:
            input["ipam_pools"] = ipam_pools
    ...
    async def create_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.create_rule_input.CreateRuleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.create_rule_output.CreateRuleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.create_rule.async_create_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.create_rule_input.CreateRuleInput = {}  # type: ignore[typeddict-item]
        input["listener_arn"] = listener_arn
    ...
    async def create_target_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.create_target_group_input.CreateTargetGroupInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.create_target_group_output.CreateTargetGroupOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.create_target_group.async_create_target_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.create_target_group_input.CreateTargetGroupInput = {}  # type: ignore[typeddict-item]
        input["name"] = name
        if protocol is not None:
            input["protocol"] = protocol
        ...
        if health_check_enabled is not None:
            input["health_check_enabled"] = health_check_enabled
        ...
        if health_check_timeout_seconds is not None:
            input["health_check_timeout_seconds"] = health_check_timeout_seconds
        if healthy_threshold_count is not None:
            input["healthy_threshold_count"] = healthy_threshold_count
        if unhealthy_threshold_count is not None:
            input["unhealthy_threshold_count"] = unhealthy_threshold_count
        ...
        if target_control_port is not None:
            input["target_control_port"] = target_control_port
    ...
    async def create_trust_store(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.create_trust_store_input.CreateTrustStoreInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.create_trust_store_output.CreateTrustStoreOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.create_trust_store.async_create_trust_store(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.create_trust_store_input.CreateTrustStoreInput = {}  # type: ignore[typeddict-item]
        input["name"] = name
        input["ca_certificates_bundle_s3_bucket"] = ca_certificates_bundle_s3_bucket
        input["ca_certificates_bundle_s3_key"] = ca_certificates_bundle_s3_key
        if ca_certificates_bundle_s3_object_version is not None:
            input["ca_certificates_bundle_s3_object_version"] = (
    ...
    async def delete_listener(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.delete_listener_input.DeleteListenerInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.delete_listener_output.DeleteListenerOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.delete_listener.async_delete_listener(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.delete_listener_input.DeleteListenerInput = {}  # type: ignore[typeddict-item]
        input["listener_arn"] = listener_arn
    ...
    async def delete_load_balancer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.delete_load_balancer_input.DeleteLoadBalancerInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.delete_load_balancer_output.DeleteLoadBalancerOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.delete_load_balancer.async_delete_load_balancer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.delete_load_balancer_input.DeleteLoadBalancerInput = {}  # type: ignore[typeddict-item]
        input["load_balancer_arn"] = load_balancer_arn
    ...
    async def delete_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.delete_rule_input.DeleteRuleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.delete_rule_output.DeleteRuleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.delete_rule.async_delete_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.delete_rule_input.DeleteRuleInput = {}  # type: ignore[typeddict-item]
    ...
    async def delete_shared_trust_store_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.delete_shared_trust_store_association_input.DeleteSharedTrustStoreAssociationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.delete_shared_trust_store_association_output.DeleteSharedTrustStoreAssociationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.delete_shared_trust_store_association.async_delete_shared_trust_store_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.delete_shared_trust_store_association_input.DeleteSharedTrustStoreAssociationInput = {}  # type: ignore[typeddict-item]
        input["trust_store_arn"] = trust_store_arn
    ...
    async def delete_target_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.delete_target_group_input.DeleteTargetGroupInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.delete_target_group_output.DeleteTargetGroupOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.delete_target_group.async_delete_target_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.delete_target_group_input.DeleteTargetGroupInput = {}  # type: ignore[typeddict-item]
        input["target_group_arn"] = target_group_arn
    ...
    async def delete_trust_store(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.delete_trust_store_input.DeleteTrustStoreInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.delete_trust_store_output.DeleteTrustStoreOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.delete_trust_store.async_delete_trust_store(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.delete_trust_store_input.DeleteTrustStoreInput = {}  # type: ignore[typeddict-item]
        input["trust_store_arn"] = trust_store_arn
    ...
    async def deregister_targets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.deregister_targets_input.DeregisterTargetsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.deregister_targets_output.DeregisterTargetsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.deregister_targets.async_deregister_targets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.deregister_targets_input.DeregisterTargetsInput = {}  # type: ignore[typeddict-item]
        input["target_group_arn"] = target_group_arn
    ...
    async def describe_account_limits(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_account_limits_input.DescribeAccountLimitsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_account_limits_output.DescribeAccountLimitsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_account_limits.async_describe_account_limits(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_account_limits_input.DescribeAccountLimitsInput = {}  # type: ignore[typeddict-item]
    ...
    ) -> "AsyncIterator[aws_sdk_elastic_load_balancing_v2.types.limit.Limit]":
        _token = marker
        while True:
    ...
    async def describe_capacity_reservation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_capacity_reservation_input.DescribeCapacityReservationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_capacity_reservation_output.DescribeCapacityReservationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_capacity_reservation.async_describe_capacity_reservation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_capacity_reservation_input.DescribeCapacityReservationInput = {}  # type: ignore[typeddict-item]
        input["load_balancer_arn"] = load_balancer_arn
    ...
    async def describe_listener_attributes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_listener_attributes_input.DescribeListenerAttributesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_listener_attributes_output.DescribeListenerAttributesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_listener_attributes.async_describe_listener_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_listener_attributes_input.DescribeListenerAttributesInput = {}  # type: ignore[typeddict-item]
        input["listener_arn"] = listener_arn
    ...
    async def describe_listener_certificates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_listener_certificates_input.DescribeListenerCertificatesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_listener_certificates_output.DescribeListenerCertificatesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_listener_certificates.async_describe_listener_certificates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_listener_certificates_input.DescribeListenerCertificatesInput = {}  # type: ignore[typeddict-item]
        input["listener_arn"] = listener_arn
        if marker is not None:
            input["marker"] = marker
        if page_size is not None:
    ...
    async def iter_describe_listener_certificates(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_elastic_load_balancing_v2.types.certificate.Certificate]"
    ):
        _token = marker
        while True:
    ...
    async def describe_listeners(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_listeners_input.DescribeListenersInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_listeners_output.DescribeListenersOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_listeners.async_describe_listeners(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_listeners_input.DescribeListenersInput = {}  # type: ignore[typeddict-item]
        if load_balancer_arn is not None:
            input["load_balancer_arn"] = load_balancer_arn
        if listener_arns is not None:
            input["listener_arns"] = listener_arns
        if marker is not None:
            input["marker"] = marker
        if page_size is not None:
            input["page_size"] = page_size
    ...
    ) -> "AsyncIterator[aws_sdk_elastic_load_balancing_v2.types.listener.Listener]":
        _token = marker
        while True:
    ...
    async def describe_load_balancer_attributes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_load_balancer_attributes_input.DescribeLoadBalancerAttributesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_load_balancer_attributes_output.DescribeLoadBalancerAttributesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_load_balancer_attributes.async_describe_load_balancer_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_load_balancer_attributes_input.DescribeLoadBalancerAttributesInput = {}  # type: ignore[typeddict-item]
        input["load_balancer_arn"] = load_balancer_arn
    ...
    async def describe_load_balancers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_load_balancers_input.DescribeLoadBalancersInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_load_balancers_output.DescribeLoadBalancersOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_load_balancers.async_describe_load_balancers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_load_balancers_input.DescribeLoadBalancersInput = {}  # type: ignore[typeddict-item]
        if load_balancer_arns is not None:
            input["load_balancer_arns"] = load_balancer_arns
    ...
    ) -> "AsyncIterator[aws_sdk_elastic_load_balancing_v2.types.load_balancer.LoadBalancer]":
        _token = marker
        while True:
    ...
    async def describe_rules(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_rules_input.DescribeRulesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_rules_output.DescribeRulesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_rules.async_describe_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_rules_input.DescribeRulesInput = {}  # type: ignore[typeddict-item]
        if listener_arn is not None:
            input["listener_arn"] = listener_arn
        if rule_arns is not None:
            input["rule_arns"] = rule_arns
        if marker is not None:
            input["marker"] = marker
        if page_size is not None:
            input["page_size"] = page_size
    ...
    ) -> "AsyncIterator[aws_sdk_elastic_load_balancing_v2.types.rule.Rule]":
        _token = marker
        while True:
    ...
    async def describe_ssl_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_ssl_policies_input.DescribeSSLPoliciesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_ssl_policies_output.DescribeSSLPoliciesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_ssl_policies.async_describe_ssl_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_ssl_policies_input.DescribeSSLPoliciesInput = {}  # type: ignore[typeddict-item]
        if names is not None:
            input["names"] = names
        if marker is not None:
            input["marker"] = marker
        ...
        if load_balancer_type is not None:
            input["load_balancer_type"] = load_balancer_type
    ...
    async def describe_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_tags_input.DescribeTagsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_tags_output.DescribeTagsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_tags.async_describe_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_tags_input.DescribeTagsInput = {}  # type: ignore[typeddict-item]
        input["resource_arns"] = resource_arns
    ...
    async def describe_target_group_attributes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_target_group_attributes_input.DescribeTargetGroupAttributesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_target_group_attributes_output.DescribeTargetGroupAttributesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_target_group_attributes.async_describe_target_group_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_target_group_attributes_input.DescribeTargetGroupAttributesInput = {}  # type: ignore[typeddict-item]
        input["target_group_arn"] = target_group_arn
    ...
    async def describe_target_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_target_groups_input.DescribeTargetGroupsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_target_groups_output.DescribeTargetGroupsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_target_groups.async_describe_target_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_target_groups_input.DescribeTargetGroupsInput = {}  # type: ignore[typeddict-item]
        if load_balancer_arn is not None:
            input["load_balancer_arn"] = load_balancer_arn
        if target_group_arns is not None:
            input["target_group_arns"] = target_group_arns
        if names is not None:
            input["names"] = names
        if marker is not None:
            input["marker"] = marker
    ...
    ) -> "AsyncIterator[aws_sdk_elastic_load_balancing_v2.types.target_group.TargetGroup]":
        _token = marker
        while True:
    ...
    async def describe_target_health(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_target_health_input.DescribeTargetHealthInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_target_health_output.DescribeTargetHealthOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_target_health.async_describe_target_health(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_target_health_input.DescribeTargetHealthInput = {}  # type: ignore[typeddict-item]
        input["target_group_arn"] = target_group_arn
    ...
    async def describe_trust_store_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_trust_store_associations_input.DescribeTrustStoreAssociationsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_trust_store_associations_output.DescribeTrustStoreAssociationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_trust_store_associations.async_describe_trust_store_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_trust_store_associations_input.DescribeTrustStoreAssociationsInput = {}  # type: ignore[typeddict-item]
        input["trust_store_arn"] = trust_store_arn
        if marker is not None:
            input["marker"] = marker
        if page_size is not None:
    ...
    ) -> "AsyncIterator[aws_sdk_elastic_load_balancing_v2.types.trust_store_association.TrustStoreAssociation]":
        _token = marker
        while True:
    ...
    async def describe_trust_store_revocations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_trust_store_revocations_input.DescribeTrustStoreRevocationsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_trust_store_revocations_output.DescribeTrustStoreRevocationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_trust_store_revocations.async_describe_trust_store_revocations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_trust_store_revocations_input.DescribeTrustStoreRevocationsInput = {}  # type: ignore[typeddict-item]
        input["trust_store_arn"] = trust_store_arn
        if revocation_ids is not None:
            input["revocation_ids"] = revocation_ids
        if marker is not None:
            input["marker"] = marker
        if page_size is not None:
            input["page_size"] = page_size
    ...
    ) -> "AsyncIterator[aws_sdk_elastic_load_balancing_v2.types.describe_trust_store_revocation.DescribeTrustStoreRevocation]":
        _token = marker
        while True:
    ...
    async def describe_trust_stores(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.describe_trust_stores_input.DescribeTrustStoresInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.describe_trust_stores_output.DescribeTrustStoresOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_trust_stores.async_describe_trust_stores(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.describe_trust_stores_input.DescribeTrustStoresInput = {}  # type: ignore[typeddict-item]
        if trust_store_arns is not None:
            input["trust_store_arns"] = trust_store_arns
        if names is not None:
            input["names"] = names
        if marker is not None:
            input["marker"] = marker
    ...
    async def iter_describe_trust_stores(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_elastic_load_balancing_v2.types.trust_store.TrustStore]"
    ):
        _token = marker
        while True:
    ...
    async def get_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.get_resource_policy_input.GetResourcePolicyInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.get_resource_policy_output.GetResourcePolicyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.get_resource_policy.async_get_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.get_resource_policy_input.GetResourcePolicyInput = {}  # type: ignore[typeddict-item]
        input["resource_arn"] = resource_arn
    ...
    async def get_trust_store_ca_certificates_bundle(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.get_trust_store_ca_certificates_bundle_input.GetTrustStoreCaCertificatesBundleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.get_trust_store_ca_certificates_bundle_output.GetTrustStoreCaCertificatesBundleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.get_trust_store_ca_certificates_bundle.async_get_trust_store_ca_certificates_bundle(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.get_trust_store_ca_certificates_bundle_input.GetTrustStoreCaCertificatesBundleInput = {}  # type: ignore[typeddict-item]
        input["trust_store_arn"] = trust_store_arn
    ...
    async def get_trust_store_revocation_content(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.get_trust_store_revocation_content_input.GetTrustStoreRevocationContentInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.get_trust_store_revocation_content_output.GetTrustStoreRevocationContentOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.get_trust_store_revocation_content.async_get_trust_store_revocation_content(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.get_trust_store_revocation_content_input.GetTrustStoreRevocationContentInput = {}  # type: ignore[typeddict-item]
        input["trust_store_arn"] = trust_store_arn
        input["revocation_id"] = revocation_id
    ...
    async def modify_capacity_reservation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.modify_capacity_reservation_input.ModifyCapacityReservationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.modify_capacity_reservation_output.ModifyCapacityReservationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_capacity_reservation.async_modify_capacity_reservation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.modify_capacity_reservation_input.ModifyCapacityReservationInput = {}  # type: ignore[typeddict-item]
        input["load_balancer_arn"] = load_balancer_arn
        if minimum_load_balancer_capacity is not None:
            input["minimum_load_balancer_capacity"] = minimum_load_balancer_capacity
        if reset_capacity_reservation is not None:
            input["reset_capacity_reservation"] = reset_capacity_reservation
    ...
    async def modify_ip_pools(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.modify_ip_pools_input.ModifyIpPoolsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.modify_ip_pools_output.ModifyIpPoolsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_ip_pools.async_modify_ip_pools(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.modify_ip_pools_input.ModifyIpPoolsInput = {}  # type: ignore[typeddict-item]
        input["load_balancer_arn"] = load_balancer_arn
        if ipam_pools is not None:
            input["ipam_pools"] = ipam_pools
        if remove_ipam_pools is not None:
            input["remove_ipam_pools"] = remove_ipam_pools
    ...
    async def modify_listener(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.modify_listener_input.ModifyListenerInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.modify_listener_output.ModifyListenerOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_listener.async_modify_listener(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.modify_listener_input.ModifyListenerInput = {}  # type: ignore[typeddict-item]
        input["listener_arn"] = listener_arn
        if port is not None:
            input["port"] = port
        if protocol is not None:
    ...
    async def modify_listener_attributes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.modify_listener_attributes_input.ModifyListenerAttributesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.modify_listener_attributes_output.ModifyListenerAttributesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_listener_attributes.async_modify_listener_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.modify_listener_attributes_input.ModifyListenerAttributesInput = {}  # type: ignore[typeddict-item]
        input["listener_arn"] = listener_arn
    ...
    async def modify_load_balancer_attributes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.modify_load_balancer_attributes_input.ModifyLoadBalancerAttributesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.modify_load_balancer_attributes_output.ModifyLoadBalancerAttributesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_load_balancer_attributes.async_modify_load_balancer_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.modify_load_balancer_attributes_input.ModifyLoadBalancerAttributesInput = {}  # type: ignore[typeddict-item]
        input["load_balancer_arn"] = load_balancer_arn
        input["attributes"] = attributes
    ...
    async def modify_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.modify_rule_input.ModifyRuleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.modify_rule_output.ModifyRuleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_rule.async_modify_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.modify_rule_input.ModifyRuleInput = {}  # type: ignore[typeddict-item]
        input["rule_arn"] = rule_arn
        ...
        if reset_transforms is not None:
            input["reset_transforms"] = reset_transforms
    ...
    async def modify_target_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.modify_target_group_input.ModifyTargetGroupInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.modify_target_group_output.ModifyTargetGroupOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_target_group.async_modify_target_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.modify_target_group_input.ModifyTargetGroupInput = {}  # type: ignore[typeddict-item]
        input["target_group_arn"] = target_group_arn
        if health_check_protocol is not None:
            input["health_check_protocol"] = health_check_protocol
        if health_check_port is not None:
    ...
    async def modify_target_group_attributes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.modify_target_group_attributes_input.ModifyTargetGroupAttributesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.modify_target_group_attributes_output.ModifyTargetGroupAttributesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_target_group_attributes.async_modify_target_group_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.modify_target_group_attributes_input.ModifyTargetGroupAttributesInput = {}  # type: ignore[typeddict-item]
        input["target_group_arn"] = target_group_arn
        input["attributes"] = attributes
    ...
    async def modify_trust_store(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.modify_trust_store_input.ModifyTrustStoreInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.modify_trust_store_output.ModifyTrustStoreOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_trust_store.async_modify_trust_store(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.modify_trust_store_input.ModifyTrustStoreInput = {}  # type: ignore[typeddict-item]
        input["trust_store_arn"] = trust_store_arn
        input["ca_certificates_bundle_s3_bucket"] = ca_certificates_bundle_s3_bucket
        input["ca_certificates_bundle_s3_key"] = ca_certificates_bundle_s3_key
        if ca_certificates_bundle_s3_object_version is not None:
    ...
    async def register_targets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.register_targets_input.RegisterTargetsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.register_targets_output.RegisterTargetsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.register_targets.async_register_targets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.register_targets_input.RegisterTargetsInput = {}  # type: ignore[typeddict-item]
        input["target_group_arn"] = target_group_arn
        input["targets"] = targets
    ...
    async def remove_listener_certificates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.remove_listener_certificates_input.RemoveListenerCertificatesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.remove_listener_certificates_output.RemoveListenerCertificatesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.remove_listener_certificates.async_remove_listener_certificates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.remove_listener_certificates_input.RemoveListenerCertificatesInput = {}  # type: ignore[typeddict-item]
        input["listener_arn"] = listener_arn
        input["certificates"] = certificates
    ...
    async def remove_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.remove_tags_input.RemoveTagsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.remove_tags_output.RemoveTagsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.remove_tags.async_remove_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.remove_tags_input.RemoveTagsInput = {}  # type: ignore[typeddict-item]
        input["resource_arns"] = resource_arns
    ...
    async def remove_trust_store_revocations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.remove_trust_store_revocations_input.RemoveTrustStoreRevocationsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.remove_trust_store_revocations_output.RemoveTrustStoreRevocationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.remove_trust_store_revocations.async_remove_trust_store_revocations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.remove_trust_store_revocations_input.RemoveTrustStoreRevocationsInput = {}  # type: ignore[typeddict-item]
        input["trust_store_arn"] = trust_store_arn
        input["revocation_ids"] = revocation_ids
    ...
    async def set_ip_address_type(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.set_ip_address_type_input.SetIpAddressTypeInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.set_ip_address_type_output.SetIpAddressTypeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.set_ip_address_type.async_set_ip_address_type(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.set_ip_address_type_input.SetIpAddressTypeInput = {}  # type: ignore[typeddict-item]
        input["load_balancer_arn"] = load_balancer_arn
        input["ip_address_type"] = ip_address_type
    ...
    async def set_rule_priorities(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.set_rule_priorities_input.SetRulePrioritiesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.set_rule_priorities_output.SetRulePrioritiesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.set_rule_priorities.async_set_rule_priorities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.set_rule_priorities_input.SetRulePrioritiesInput = {}  # type: ignore[typeddict-item]
        input["rule_priorities"] = rule_priorities
    ...
    async def set_security_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.set_security_groups_input.SetSecurityGroupsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.set_security_groups_output.SetSecurityGroupsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.set_security_groups.async_set_security_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.set_security_groups_input.SetSecurityGroupsInput = {}  # type: ignore[typeddict-item]
        input["load_balancer_arn"] = load_balancer_arn
        input["security_groups"] = security_groups
    ...
    async def set_subnets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_elastic_load_balancing_v2.types.set_subnets_input.SetSubnetsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_elastic_load_balancing_v2.types.set_subnets_output.SetSubnetsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.set_subnets.async_set_subnets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_elastic_load_balancing_v2.types.set_subnets_input.SetSubnetsInput = {}  # type: ignore[typeddict-item]
        input["load_balancer_arn"] = load_balancer_arn
        if subnets is not None:
            input["subnets"] = subnets
        if subnet_mappings is not None:
