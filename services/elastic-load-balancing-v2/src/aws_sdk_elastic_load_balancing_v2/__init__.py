...
from ._services.async_elastic_load_balancingv2 import (
    AsyncElasticLoadBalancingv2Client as AsyncElasticLoadBalancingv2Client,
)
from ._services.elastic_load_balancingv2 import (
    ElasticLoadBalancingv2Client as ElasticLoadBalancingv2Client,
)
