...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.listener_attribute_key
    import aws_sdk_elastic_load_balancing_v2.types.listener_attribute_value


class ListenerAttribute(TypedDict):
    key: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.listener_attribute_key.ListenerAttributeKey"
    ]
    ...
    value: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.listener_attribute_value.ListenerAttributeValue"
    ]
