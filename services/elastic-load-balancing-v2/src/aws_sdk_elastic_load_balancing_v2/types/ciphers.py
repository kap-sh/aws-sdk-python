...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.cipher

Ciphers: TypeAlias = list["aws_sdk_elastic_load_balancing_v2.types.cipher.Cipher"]
...
def serialize_query(value: Ciphers, pairs: list[tuple[str, str]], prefix: str) -> None:
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elastic_load_balancing_v2.types.cipher.serialize_query(
...
def deserialize_query(el: Element) -> Ciphers:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_elastic_load_balancing_v2.types.cipher.deserialize_query(child)
        )
    return out
