...
class RevocationContent(TypedDict):
    s3_bucket: NotRequired["aws_sdk_elastic_load_balancing_v2.types.s3_bucket.S3Bucket"]
    """<p>The Amazon S3 bucket for the revocation file.</p>"""
    s3_key: NotRequired["aws_sdk_elastic_load_balancing_v2.types.s3_key.S3Key"]
