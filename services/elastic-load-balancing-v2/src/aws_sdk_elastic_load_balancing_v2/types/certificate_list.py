...
CertificateList: TypeAlias = list[
    "aws_sdk_elastic_load_balancing_v2.types.certificate.Certificate"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elastic_load_balancing_v2.types.certificate.serialize_query(
...
def deserialize_query(el: Element) -> CertificateList:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_elastic_load_balancing_v2.types.certificate.deserialize_query(child)
        )
    return out
