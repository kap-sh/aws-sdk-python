...
class DescribeTrustStoresInput(TypedDict):
...
def serialize_query(
    ...
    if "trust_store_arns" in value:
        ...
        aws_sdk_elastic_load_balancing_v2.types.trust_store_arns.serialize_query(
            value["trust_store_arns"], pairs, f"{prefix}.TrustStoreArns"
        )
    if "names" in value:
        import aws_sdk_elastic_load_balancing_v2.types.trust_store_names

        aws_sdk_elastic_load_balancing_v2.types.trust_store_names.serialize_query(
...
def deserialize_query(el: Element) -> DescribeTrustStoresInput:
    ...
    if child_trust_store_arns is not None:
        ...
        out["trust_store_arns"] = (
            aws_sdk_elastic_load_balancing_v2.types.trust_store_arns.deserialize_query(
    ...
    if child_names is not None:
        ...
        out["names"] = (
            aws_sdk_elastic_load_balancing_v2.types.trust_store_names.deserialize_query(
                child_names
            )
        )
