...
if TYPE_CHECKING:
    ...
    import aws_sdk_elastic_load_balancing_v2.types.target_health_reason_enum
    import aws_sdk_elastic_load_balancing_v2.types.target_health_state_enum


class TargetHealth(TypedDict, closed=True):
    state: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.target_health_state_enum.TargetHealthStateEnum"
    ]
    """<p>The state of the target.</p>"""
    reason: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.target_health_reason_enum.TargetHealthReasonEnum"
    ]
...
def serialize_query(
    ...
    if "state" in value:
        ...
        aws_sdk_elastic_load_balancing_v2.types.target_health_state_enum.serialize_query(
            value["state"], pairs, f"{prefix}.State"
        )
    if "reason" in value:
        import aws_sdk_elastic_load_balancing_v2.types.target_health_reason_enum

        aws_sdk_elastic_load_balancing_v2.types.target_health_reason_enum.serialize_query(
...
def deserialize_query(el: Element) -> TargetHealth:
    ...
    if child_state is not None:
        ...
        out["state"] = (
            aws_sdk_elastic_load_balancing_v2.types.target_health_state_enum.deserialize_query(
                child_state
            )
        )
    ...
    if child_reason is not None:
        ...
        out["reason"] = (
            aws_sdk_elastic_load_balancing_v2.types.target_health_reason_enum.deserialize_query(
                child_reason
            )
        )
