...
class DescribeSSLPoliciesInput(TypedDict):
    names: NotRequired[
...
def serialize_query(
    ...
    if "names" in value:
        ...
        aws_sdk_elastic_load_balancing_v2.types.ssl_policy_names.serialize_query(
...
def deserialize_query(el: Element) -> DescribeSSLPoliciesInput:
    ...
    if child_names is not None:
        ...
        out["names"] = (
            aws_sdk_elastic_load_balancing_v2.types.ssl_policy_names.deserialize_query(
                child_names
            )
        )
