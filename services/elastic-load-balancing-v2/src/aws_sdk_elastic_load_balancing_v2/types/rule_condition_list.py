...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.rule_condition

RuleConditionList: TypeAlias = list[
    "aws_sdk_elastic_load_balancing_v2.types.rule_condition.RuleCondition"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elastic_load_balancing_v2.types.rule_condition.serialize_query(
...
def deserialize_query(el: Element) -> RuleConditionList:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_elastic_load_balancing_v2.types.rule_condition.deserialize_query(
                child
            )
        )
    return out
