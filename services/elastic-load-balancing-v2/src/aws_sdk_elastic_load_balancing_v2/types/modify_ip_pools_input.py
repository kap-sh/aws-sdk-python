...
class ModifyIpPoolsInput(TypedDict):
...
def serialize_query(
    ...
    if "remove_ipam_pools" in value:
        ...
        aws_sdk_elastic_load_balancing_v2.types.remove_ipam_pools.serialize_query(
...
def deserialize_query(el: Element) -> ModifyIpPoolsInput:
    ...
    if child_remove_ipam_pools is not None:
        ...
        out["remove_ipam_pools"] = (
            aws_sdk_elastic_load_balancing_v2.types.remove_ipam_pools.deserialize_query(
