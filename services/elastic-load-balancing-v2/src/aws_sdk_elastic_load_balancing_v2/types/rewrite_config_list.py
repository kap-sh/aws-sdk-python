...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.rewrite_config

RewriteConfigList: TypeAlias = list[
    "aws_sdk_elastic_load_balancing_v2.types.rewrite_config.RewriteConfig"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elastic_load_balancing_v2.types.rewrite_config.serialize_query(
...
def deserialize_query(el: Element) -> RewriteConfigList:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_elastic_load_balancing_v2.types.rewrite_config.deserialize_query(
                child
            )
        )
    return out
