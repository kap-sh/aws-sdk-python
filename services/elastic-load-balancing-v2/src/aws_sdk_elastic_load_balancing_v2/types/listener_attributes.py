...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.listener_attribute

ListenerAttributes: TypeAlias = list[
    "aws_sdk_elastic_load_balancing_v2.types.listener_attribute.ListenerAttribute"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elastic_load_balancing_v2.types.listener_attribute.serialize_query(
...
def deserialize_query(el: Element) -> ListenerAttributes:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_elastic_load_balancing_v2.types.listener_attribute.deserialize_query(
                child
            )
        )
    return out
