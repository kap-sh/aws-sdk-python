...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.authenticate_cognito_action_authentication_request_param_name
    import aws_sdk_elastic_load_balancing_v2.types.authenticate_cognito_action_authentication_request_param_value

AuthenticateCognitoActionAuthenticationRequestExtraParams: TypeAlias = dict[
    "aws_sdk_elastic_load_balancing_v2.types.authenticate_cognito_action_authentication_request_param_name.AuthenticateCognitoActionAuthenticationRequestParamName",
    "aws_sdk_elastic_load_balancing_v2.types.authenticate_cognito_action_authentication_request_param_value.AuthenticateCognitoActionAuthenticationRequestParamValue",
]
