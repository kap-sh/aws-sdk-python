...
if TYPE_CHECKING:
    ...
    import aws_sdk_elastic_load_balancing_v2.types.is_default
    ...
    import aws_sdk_elastic_load_balancing_v2.types.string


class Rule(TypedDict, closed=True):
    rule_arn: NotRequired["aws_sdk_elastic_load_balancing_v2.types.rule_arn.RuleArn"]
    """<p>The Amazon Resource Name (ARN) of the rule.</p>"""
    priority: NotRequired["aws_sdk_elastic_load_balancing_v2.types.string.String"]
    """<p>The priority.</p>"""
    ...
    is_default: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.is_default.IsDefault"
    ]
