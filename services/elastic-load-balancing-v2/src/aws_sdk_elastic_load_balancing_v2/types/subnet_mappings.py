...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.subnet_mapping

SubnetMappings: TypeAlias = list[
    "aws_sdk_elastic_load_balancing_v2.types.subnet_mapping.SubnetMapping"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elastic_load_balancing_v2.types.subnet_mapping.serialize_query(
...
def deserialize_query(el: Element) -> SubnetMappings:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_elastic_load_balancing_v2.types.subnet_mapping.deserialize_query(
                child
            )
        )
    return out
