...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.redirect_action_host
    import aws_sdk_elastic_load_balancing_v2.types.redirect_action_path
    import aws_sdk_elastic_load_balancing_v2.types.redirect_action_port
    import aws_sdk_elastic_load_balancing_v2.types.redirect_action_protocol
    import aws_sdk_elastic_load_balancing_v2.types.redirect_action_query
...
class RedirectActionConfig(TypedDict):
    ...
    port: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.redirect_action_port.RedirectActionPort"
    ]
    """<p>The port. You can specify a value from 1 to 65535 or #{port}.</p>"""
    host: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.redirect_action_host.RedirectActionHost"
    ]
...
def serialize_query(
    ...
    if "status_code" in value:
        ...
        aws_sdk_elastic_load_balancing_v2.types.redirect_action_status_code_enum.serialize_query(
...
def deserialize_query(el: Element) -> RedirectActionConfig:
    ...
    if child_status_code is not None:
        ...
        out["status_code"] = (
            aws_sdk_elastic_load_balancing_v2.types.redirect_action_status_code_enum.deserialize_query(
                child_status_code
            )
        )
    return out
