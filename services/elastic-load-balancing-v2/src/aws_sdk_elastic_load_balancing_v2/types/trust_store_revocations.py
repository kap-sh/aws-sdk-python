...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.trust_store_revocation

TrustStoreRevocations: TypeAlias = list[
    "aws_sdk_elastic_load_balancing_v2.types.trust_store_revocation.TrustStoreRevocation"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elastic_load_balancing_v2.types.trust_store_revocation.serialize_query(
...
def deserialize_query(el: Element) -> TrustStoreRevocations:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_elastic_load_balancing_v2.types.trust_store_revocation.deserialize_query(
                child
            )
        )
    return out
