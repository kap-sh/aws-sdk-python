...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.authenticate_oidc_action_authentication_request_param_name
    import aws_sdk_elastic_load_balancing_v2.types.authenticate_oidc_action_authentication_request_param_value

AuthenticateOidcActionAuthenticationRequestExtraParams: TypeAlias = dict[
    "aws_sdk_elastic_load_balancing_v2.types.authenticate_oidc_action_authentication_request_param_name.AuthenticateOidcActionAuthenticationRequestParamName",
    "aws_sdk_elastic_load_balancing_v2.types.authenticate_oidc_action_authentication_request_param_value.AuthenticateOidcActionAuthenticationRequestParamValue",
]
