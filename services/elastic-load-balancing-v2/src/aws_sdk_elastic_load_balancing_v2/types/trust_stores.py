...
TrustStores: TypeAlias = list[
    "aws_sdk_elastic_load_balancing_v2.types.trust_store.TrustStore"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        aws_sdk_elastic_load_balancing_v2.types.trust_store.serialize_query(
...
def deserialize_query(el: Element) -> TrustStores:
    ...
    for child in el.findall("member"):
        out.append(
            aws_sdk_elastic_load_balancing_v2.types.trust_store.deserialize_query(child)
        )
    return out
