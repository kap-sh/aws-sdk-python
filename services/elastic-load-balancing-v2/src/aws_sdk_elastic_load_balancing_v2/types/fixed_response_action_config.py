...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.fixed_response_action_content_type
    import aws_sdk_elastic_load_balancing_v2.types.fixed_response_action_message
    import aws_sdk_elastic_load_balancing_v2.types.fixed_response_action_status_code


class FixedResponseActionConfig(TypedDict):
    message_body: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.fixed_response_action_message.FixedResponseActionMessage"
    ]
    """<p>The message.</p>"""
    status_code: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.fixed_response_action_status_code.FixedResponseActionStatusCode"
    ]
    """<p>The HTTP response code (2XX, 4XX, or 5XX).</p>"""
    content_type: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.fixed_response_action_content_type.FixedResponseActionContentType"
    ]
