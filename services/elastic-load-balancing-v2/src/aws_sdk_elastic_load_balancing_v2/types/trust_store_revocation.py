...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.number_of_revoked_entries
    import aws_sdk_elastic_load_balancing_v2.types.revocation_id
    import aws_sdk_elastic_load_balancing_v2.types.revocation_type
    import aws_sdk_elastic_load_balancing_v2.types.trust_store_arn


class TrustStoreRevocation(TypedDict):
    ...
    revocation_type: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.revocation_type.RevocationType"
    ]
    """<p>The type of revocation file.</p>"""
    number_of_revoked_entries: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.number_of_revoked_entries.NumberOfRevokedEntries"
    ]
...
def serialize_query(
    ...
    if "revocation_type" in value:
        ...
        aws_sdk_elastic_load_balancing_v2.types.revocation_type.serialize_query(
...
def deserialize_query(el: Element) -> TrustStoreRevocation:
    ...
    if child_revocation_type is not None:
        ...
        out["revocation_type"] = (
            aws_sdk_elastic_load_balancing_v2.types.revocation_type.deserialize_query(
