...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.condition_field_name
    import aws_sdk_elastic_load_balancing_v2.types.host_header_condition_config
    import aws_sdk_elastic_load_balancing_v2.types.http_header_condition_config
    import aws_sdk_elastic_load_balancing_v2.types.http_request_method_condition_config
    import aws_sdk_elastic_load_balancing_v2.types.list_of_string
    import aws_sdk_elastic_load_balancing_v2.types.path_pattern_condition_config
    import aws_sdk_elastic_load_balancing_v2.types.query_string_condition_config
    import aws_sdk_elastic_load_balancing_v2.types.source_ip_condition_config


class RuleCondition(TypedDict):
    field: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.condition_field_name.ConditionFieldName"
    ]
    ...
    host_header_config: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.host_header_condition_config.HostHeaderConditionConfig"
    ]
    ...
    path_pattern_config: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.path_pattern_condition_config.PathPatternConditionConfig"
    ]
    ...
    http_header_config: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.http_header_condition_config.HttpHeaderConditionConfig"
    ]
    ...
    query_string_config: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.query_string_condition_config.QueryStringConditionConfig"
    ]
    ...
    http_request_method_config: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.http_request_method_condition_config.HttpRequestMethodConditionConfig"
    ]
    ...
    source_ip_config: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.source_ip_condition_config.SourceIpConditionConfig"
    ]
...
def serialize_query(
    ...
    if "host_header_config" in value:
        ...
        aws_sdk_elastic_load_balancing_v2.types.host_header_condition_config.serialize_query(
            value["host_header_config"], pairs, f"{prefix}.HostHeaderConfig"
        )
    if "path_pattern_config" in value:
        import aws_sdk_elastic_load_balancing_v2.types.path_pattern_condition_config

        aws_sdk_elastic_load_balancing_v2.types.path_pattern_condition_config.serialize_query(
            value["path_pattern_config"], pairs, f"{prefix}.PathPatternConfig"
        )
    if "http_header_config" in value:
        import aws_sdk_elastic_load_balancing_v2.types.http_header_condition_config

        aws_sdk_elastic_load_balancing_v2.types.http_header_condition_config.serialize_query(
            value["http_header_config"], pairs, f"{prefix}.HttpHeaderConfig"
        )
    if "query_string_config" in value:
        import aws_sdk_elastic_load_balancing_v2.types.query_string_condition_config

        aws_sdk_elastic_load_balancing_v2.types.query_string_condition_config.serialize_query(
            value["query_string_config"], pairs, f"{prefix}.QueryStringConfig"
        )
    if "http_request_method_config" in value:
        import aws_sdk_elastic_load_balancing_v2.types.http_request_method_condition_config

        aws_sdk_elastic_load_balancing_v2.types.http_request_method_condition_config.serialize_query(
    ...
    if "source_ip_config" in value:
        ...
        aws_sdk_elastic_load_balancing_v2.types.source_ip_condition_config.serialize_query(
...
def deserialize_query(el: Element) -> RuleCondition:
    ...
    if child_host_header_config is not None:
        ...
        out["host_header_config"] = (
            aws_sdk_elastic_load_balancing_v2.types.host_header_condition_config.deserialize_query(
    ...
    if child_path_pattern_config is not None:
        ...
        out["path_pattern_config"] = (
            aws_sdk_elastic_load_balancing_v2.types.path_pattern_condition_config.deserialize_query(
    ...
    if child_http_header_config is not None:
        ...
        out["http_header_config"] = (
            aws_sdk_elastic_load_balancing_v2.types.http_header_condition_config.deserialize_query(
    ...
    if child_query_string_config is not None:
        ...
        out["query_string_config"] = (
            aws_sdk_elastic_load_balancing_v2.types.query_string_condition_config.deserialize_query(
    ...
    if child_http_request_method_config is not None:
        ...
        out["http_request_method_config"] = (
            aws_sdk_elastic_load_balancing_v2.types.http_request_method_condition_config.deserialize_query(
    ...
    if child_source_ip_config is not None:
        ...
        out["source_ip_config"] = (
            aws_sdk_elastic_load_balancing_v2.types.source_ip_condition_config.deserialize_query(
