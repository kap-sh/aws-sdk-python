...
class RemoveTrustStoreRevocationsInput(TypedDict):
...
def serialize_query(
    ...
    if "revocation_ids" in value:
        ...
        aws_sdk_elastic_load_balancing_v2.types.revocation_ids.serialize_query(
...
def deserialize_query(el: Element) -> RemoveTrustStoreRevocationsInput:
    ...
    if child_revocation_ids is not None:
        ...
        out["revocation_ids"] = (
            aws_sdk_elastic_load_balancing_v2.types.revocation_ids.deserialize_query(
