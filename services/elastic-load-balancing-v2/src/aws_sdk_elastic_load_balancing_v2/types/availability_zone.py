...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.load_balancer_addresses
    import aws_sdk_elastic_load_balancing_v2.types.outpost_id
    import aws_sdk_elastic_load_balancing_v2.types.source_nat_ipv6_prefixes
...
class AvailabilityZone(TypedDict, closed=True):
    zone_name: NotRequired["aws_sdk_elastic_load_balancing_v2.types.zone_name.ZoneName"]
    ...
    outpost_id: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.outpost_id.OutpostId"
    ]
    """<p>[Application Load Balancers on Outposts] The ID of the Outpost.</p>"""
    load_balancer_addresses: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.load_balancer_addresses.LoadBalancerAddresses"
    ]
    ...
    source_nat_ipv6_prefixes: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.source_nat_ipv6_prefixes.SourceNatIpv6Prefixes"
    ]
...
def serialize_query(
    ...
    if "load_balancer_addresses" in value:
        ...
        aws_sdk_elastic_load_balancing_v2.types.load_balancer_addresses.serialize_query(
            value["load_balancer_addresses"], pairs, f"{prefix}.LoadBalancerAddresses"
        )
    if "source_nat_ipv6_prefixes" in value:
        import aws_sdk_elastic_load_balancing_v2.types.source_nat_ipv6_prefixes

        aws_sdk_elastic_load_balancing_v2.types.source_nat_ipv6_prefixes.serialize_query(
...
def deserialize_query(el: Element) -> AvailabilityZone:
    ...
    if child_load_balancer_addresses is not None:
        ...
        out["load_balancer_addresses"] = (
            aws_sdk_elastic_load_balancing_v2.types.load_balancer_addresses.deserialize_query(
    ...
    if child_source_nat_ipv6_prefixes is not None:
        ...
        out["source_nat_ipv6_prefixes"] = (
            aws_sdk_elastic_load_balancing_v2.types.source_nat_ipv6_prefixes.deserialize_query(
