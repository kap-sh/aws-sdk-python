...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.capacity_units


class MinimumLoadBalancerCapacity(TypedDict):
    capacity_units: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.capacity_units.CapacityUnits"
    ]
