...
if TYPE_CHECKING:
    ...
    import aws_sdk_elastic_load_balancing_v2.types.ip_address
    import aws_sdk_elastic_load_balancing_v2.types.private_i_pv4_address


class LoadBalancerAddress(TypedDict):
    ip_address: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.ip_address.IpAddress"
    ]
