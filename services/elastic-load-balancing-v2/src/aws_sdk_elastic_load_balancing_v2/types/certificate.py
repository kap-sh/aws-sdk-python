...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.certificate_arn
    import aws_sdk_elastic_load_balancing_v2.types.default


class Certificate(TypedDict, closed=True):
    certificate_arn: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.certificate_arn.CertificateArn"
    ]
    """<p>The Amazon Resource Name (ARN) of the certificate.</p>"""
    is_default: NotRequired["aws_sdk_elastic_load_balancing_v2.types.default.Default"]
