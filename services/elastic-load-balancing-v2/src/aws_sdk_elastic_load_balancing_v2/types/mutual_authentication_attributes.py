...
if TYPE_CHECKING:
    import aws_sdk_elastic_load_balancing_v2.types.advertise_trust_store_ca_names_enum
    import aws_sdk_elastic_load_balancing_v2.types.ignore_client_certificate_expiry
    import aws_sdk_elastic_load_balancing_v2.types.mode
...
class MutualAuthenticationAttributes(TypedDict):
    ...
    ignore_client_certificate_expiry: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.ignore_client_certificate_expiry.IgnoreClientCertificateExpiry"
    ]
    """<p>Indicates whether expired client certificates are ignored.</p>"""
    trust_store_association_status: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.trust_store_association_status_enum.TrustStoreAssociationStatusEnum"
    ]
    """<p>Indicates a shared trust stores association status.</p>"""
    advertise_trust_store_ca_names: NotRequired[
        "aws_sdk_elastic_load_balancing_v2.types.advertise_trust_store_ca_names_enum.AdvertiseTrustStoreCaNamesEnum"
    ]
...
def serialize_query(
    ...
    if "trust_store_association_status" in value:
        ...
        aws_sdk_elastic_load_balancing_v2.types.trust_store_association_status_enum.serialize_query(
    ...
    if "advertise_trust_store_ca_names" in value:
        ...
        aws_sdk_elastic_load_balancing_v2.types.advertise_trust_store_ca_names_enum.serialize_query(
...
def deserialize_query(el: Element) -> MutualAuthenticationAttributes:
    ...
    if child_trust_store_association_status is not None:
        ...
        out["trust_store_association_status"] = (
            aws_sdk_elastic_load_balancing_v2.types.trust_store_association_status_enum.deserialize_query(
    ...
    if child_advertise_trust_store_ca_names is not None:
        ...
        out["advertise_trust_store_ca_names"] = (
            aws_sdk_elastic_load_balancing_v2.types.advertise_trust_store_ca_names_enum.deserialize_query(
