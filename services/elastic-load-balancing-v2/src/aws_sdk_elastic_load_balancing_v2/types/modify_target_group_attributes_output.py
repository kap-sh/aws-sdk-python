"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#ModifyTargetGroupAttributesOutput``."""
...
class ModifyTargetGroupAttributesOutput(TypedDict, closed=True):
...
def deserialize_query(el: Element) -> ModifyTargetGroupAttributesOutput:
    out: ModifyTargetGroupAttributesOutput = {}  # type: ignore[typeddict-item]
