...
class UpdateCustomLineItemChargeDetails(TypedDict, closed=True):
    flat: NotRequired[
        "capo_billingconductor.types.update_custom_line_item_flat_charge_details.UpdateCustomLineItemFlatChargeDetails"
    ]
    ...
    percentage: NotRequired[
        "capo_billingconductor.types.update_custom_line_item_percentage_charge_details.UpdateCustomLineItemPercentageChargeDetails"
    ]
...
def serialize_json(value: UpdateCustomLineItemChargeDetails) -> dict:
    ...
    if "flat" in value:
        ...
        out["Flat"] = (
            capo_billingconductor.types.update_custom_line_item_flat_charge_details.serialize_json(
                value["flat"]
            )
        )
    if "percentage" in value:
        ...
        out["Percentage"] = (
            capo_billingconductor.types.update_custom_line_item_percentage_charge_details.serialize_json(
                value["percentage"]
            )
        )
...
def deserialize_json(data: dict) -> UpdateCustomLineItemChargeDetails:
    ...
    if "Flat" in data:
        ...
        out["flat"] = (
            capo_billingconductor.types.update_custom_line_item_flat_charge_details.deserialize_json(
                data["Flat"]
            )
        )
    if "Percentage" in data:
        ...
        out["percentage"] = (
            capo_billingconductor.types.update_custom_line_item_percentage_charge_details.deserialize_json(
                data["Percentage"]
            )
        )
