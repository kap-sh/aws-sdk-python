...
class billingconductorError(Exception):
    """Base class for all billingconductor service errors."""


class ServiceError(billingconductorError):
...
class SerializationError(billingconductorError):
    """Raised when a value cannot be serialized."""


class DeserializationError(billingconductorError):
...
class WaiterFailedError(billingconductorError):
...
class WaiterTimeoutError(billingconductorError):
