...
import capo_billingconductor.types.custom_line_item_list
...
def handle_response(
    ...
    out: capo_billingconductor.types.list_custom_line_items_output.ListCustomLineItemsOutput = capo_billingconductor.types.list_custom_line_items_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.list_custom_line_items_input.serialize_json(input_)
    ).encode()
