...
import capo_billingconductor.errors.service_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceLimitExceededException":
            raise capo_billingconductor.errors.service_limit_exceeded_exception.ServiceLimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_billingconductor.types.batch_associate_resources_to_custom_line_item_output.BatchAssociateResourcesToCustomLineItemOutput = capo_billingconductor.types.batch_associate_resources_to_custom_line_item_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.batch_associate_resources_to_custom_line_item_input.serialize_json(
            input_
        )
    ).encode()
