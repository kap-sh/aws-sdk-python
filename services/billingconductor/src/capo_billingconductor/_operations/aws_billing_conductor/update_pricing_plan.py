...
def handle_response(
    ...
    out: capo_billingconductor.types.update_pricing_plan_output.UpdatePricingPlanOutput = capo_billingconductor.types.update_pricing_plan_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.update_pricing_plan_input.serialize_json(input_)
    ).encode()
