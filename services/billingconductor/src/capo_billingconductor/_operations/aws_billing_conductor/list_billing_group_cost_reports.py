"""Generated from Smithy shape ``com.amazonaws.billingconductor#ListBillingGroupCostReports``."""
...
def handle_response(
    ...
    out: capo_billingconductor.types.list_billing_group_cost_reports_output.ListBillingGroupCostReportsOutput = capo_billingconductor.types.list_billing_group_cost_reports_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.list_billing_group_cost_reports_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_billing_group_cost_reports(
