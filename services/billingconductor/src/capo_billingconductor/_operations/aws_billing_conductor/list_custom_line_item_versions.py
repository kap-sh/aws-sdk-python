...
def handle_response(
    ...
    out: capo_billingconductor.types.list_custom_line_item_versions_output.ListCustomLineItemVersionsOutput = capo_billingconductor.types.list_custom_line_item_versions_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.list_custom_line_item_versions_input.serialize_json(
            input_
        )
    ).encode()
