...
def handle_response(
    ...
    out: capo_billingconductor.types.list_pricing_plans_output.ListPricingPlansOutput = capo_billingconductor.types.list_pricing_plans_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.list_pricing_plans_input.serialize_json(input_)
    ).encode()
