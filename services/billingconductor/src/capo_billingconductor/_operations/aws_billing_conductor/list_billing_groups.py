...
def handle_response(
    ...
    out: capo_billingconductor.types.list_billing_groups_output.ListBillingGroupsOutput = capo_billingconductor.types.list_billing_groups_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.list_billing_groups_input.serialize_json(input_)
    ).encode()
