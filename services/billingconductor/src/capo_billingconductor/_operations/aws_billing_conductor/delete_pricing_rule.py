...
def handle_response(
    ...
    out: capo_billingconductor.types.delete_pricing_rule_output.DeletePricingRuleOutput = capo_billingconductor.types.delete_pricing_rule_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.delete_pricing_rule_input.serialize_json(input_)
    ).encode()
