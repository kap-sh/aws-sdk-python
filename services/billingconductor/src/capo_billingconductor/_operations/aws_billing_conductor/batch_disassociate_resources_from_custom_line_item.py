"""Generated from Smithy shape ``com.amazonaws.billingconductor#BatchDisassociateResourcesFromCustomLineItem``."""
...
import capo_billingconductor.types.disassociate_resources_response_list
...
def handle_response(
    ...
    out: capo_billingconductor.types.batch_disassociate_resources_from_custom_line_item_output.BatchDisassociateResourcesFromCustomLineItemOutput = capo_billingconductor.types.batch_disassociate_resources_from_custom_line_item_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.batch_disassociate_resources_from_custom_line_item_input.serialize_json(
            input_
        )
    ).encode()
