"""Generated from Smithy shape ``com.amazonaws.billingconductor#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_billingconductor.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_billingconductor.types.list_tags_for_resource_response.deserialize_json(
