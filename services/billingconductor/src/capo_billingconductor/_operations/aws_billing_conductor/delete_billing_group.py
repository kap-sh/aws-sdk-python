...
def handle_response(
    ...
    out: capo_billingconductor.types.delete_billing_group_output.DeleteBillingGroupOutput = capo_billingconductor.types.delete_billing_group_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.delete_billing_group_input.serialize_json(input_)
    ).encode()
