"""Generated from Smithy shape ``com.amazonaws.billingconductor#DeleteBillingGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.delete_billing_group_output.DeleteBillingGroupOutput = aws_sdk_billingconductor.types.delete_billing_group_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_billingconductor.types.delete_billing_group_input.DeleteBillingGroupInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.delete_billing_group_input.serialize_json(input)
    ).encode()
...
async def async_delete_billing_group(
