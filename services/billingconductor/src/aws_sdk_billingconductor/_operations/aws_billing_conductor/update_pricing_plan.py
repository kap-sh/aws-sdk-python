...
def build_request(
    ...
    input: aws_sdk_billingconductor.types.update_pricing_plan_input.UpdatePricingPlanInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.update_pricing_plan_input.serialize_json(input)
    ).encode()
