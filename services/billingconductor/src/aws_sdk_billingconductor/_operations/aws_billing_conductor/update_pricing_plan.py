"""Generated from Smithy shape ``com.amazonaws.billingconductor#UpdatePricingPlan``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.update_pricing_plan_output.UpdatePricingPlanOutput = aws_sdk_billingconductor.types.update_pricing_plan_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.update_pricing_plan_input.UpdatePricingPlanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/update-pricing-plan"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_billingconductor.types.update_pricing_plan_input

    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.update_pricing_plan_input.serialize_json(input_)
    ).encode()
...
async def async_update_pricing_plan(
