...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.disassociate_accounts_output.DisassociateAccountsOutput = aws_sdk_billingconductor.types.disassociate_accounts_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_billingconductor.types.disassociate_accounts_input.DisassociateAccountsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.disassociate_accounts_input.serialize_json(input)
    ).encode()
