...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.disassociate_accounts_input.DisassociateAccountsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.disassociate_accounts_input.serialize_json(
            input_
        )
    ).encode()
