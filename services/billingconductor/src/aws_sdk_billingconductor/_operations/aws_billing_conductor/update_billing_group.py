...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.update_billing_group_output.UpdateBillingGroupOutput = aws_sdk_billingconductor.types.update_billing_group_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.update_billing_group_input.UpdateBillingGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.update_billing_group_input.serialize_json(input_)
    ).encode()
