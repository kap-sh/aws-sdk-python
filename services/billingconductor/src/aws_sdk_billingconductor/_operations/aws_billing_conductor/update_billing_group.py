...
def build_request(
    ...
    input: aws_sdk_billingconductor.types.update_billing_group_input.UpdateBillingGroupInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.update_billing_group_input.serialize_json(input)
    ).encode()
