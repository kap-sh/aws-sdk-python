"""Generated from Smithy shape ``com.amazonaws.billingconductor#ListBillingGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.list_billing_groups_output.ListBillingGroupsOutput = aws_sdk_billingconductor.types.list_billing_groups_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.list_billing_groups_input.ListBillingGroupsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-billing-groups"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_billingconductor.types.list_billing_groups_input

    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.list_billing_groups_input.serialize_json(input_)
    ).encode()
...
async def async_list_billing_groups(
