...
def build_request(
    ...
    input: aws_sdk_billingconductor.types.list_billing_groups_input.ListBillingGroupsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.list_billing_groups_input.serialize_json(input)
    ).encode()
