...
def build_request(
    ...
    input: aws_sdk_billingconductor.types.list_pricing_plans_input.ListPricingPlansInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.list_pricing_plans_input.serialize_json(input)
    ).encode()
