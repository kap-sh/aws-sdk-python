"""Generated from Smithy shape ``com.amazonaws.billingconductor#ListPricingPlans``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.list_pricing_plans_output.ListPricingPlansOutput = aws_sdk_billingconductor.types.list_pricing_plans_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.list_pricing_plans_input.ListPricingPlansInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-pricing-plans"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_billingconductor.types.list_pricing_plans_input

    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.list_pricing_plans_input.serialize_json(input_)
    ).encode()
...
async def async_list_pricing_plans(
