...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.batch_disassociate_resources_from_custom_line_item_output.BatchDisassociateResourcesFromCustomLineItemOutput = aws_sdk_billingconductor.types.batch_disassociate_resources_from_custom_line_item_output.deserialize_json(
