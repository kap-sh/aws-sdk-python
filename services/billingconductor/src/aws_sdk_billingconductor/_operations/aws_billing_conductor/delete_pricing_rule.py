"""Generated from Smithy shape ``com.amazonaws.billingconductor#DeletePricingRule``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.delete_pricing_rule_output.DeletePricingRuleOutput = aws_sdk_billingconductor.types.delete_pricing_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.delete_pricing_rule_input.DeletePricingRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/delete-pricing-rule"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_billingconductor.types.delete_pricing_rule_input

    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.delete_pricing_rule_input.serialize_json(input_)
    ).encode()
...
async def async_delete_pricing_rule(
