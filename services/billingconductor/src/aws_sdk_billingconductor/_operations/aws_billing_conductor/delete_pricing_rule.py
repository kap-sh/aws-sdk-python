...
def build_request(
    ...
    input: aws_sdk_billingconductor.types.delete_pricing_rule_input.DeletePricingRuleInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.delete_pricing_rule_input.serialize_json(input)
    ).encode()
