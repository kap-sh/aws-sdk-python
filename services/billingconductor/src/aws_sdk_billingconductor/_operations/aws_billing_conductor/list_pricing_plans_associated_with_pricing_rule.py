"""Generated from Smithy shape ``com.amazonaws.billingconductor#ListPricingPlansAssociatedWithPricingRule``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.list_pricing_plans_associated_with_pricing_rule_output.ListPricingPlansAssociatedWithPricingRuleOutput = aws_sdk_billingconductor.types.list_pricing_plans_associated_with_pricing_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.list_pricing_plans_associated_with_pricing_rule_input.ListPricingPlansAssociatedWithPricingRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_pricing_plans_associated_with_pricing_rule(
