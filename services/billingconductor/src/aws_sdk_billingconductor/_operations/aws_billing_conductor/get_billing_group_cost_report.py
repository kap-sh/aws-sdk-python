"""Generated from Smithy shape ``com.amazonaws.billingconductor#GetBillingGroupCostReport``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.get_billing_group_cost_report_output.GetBillingGroupCostReportOutput = aws_sdk_billingconductor.types.get_billing_group_cost_report_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.get_billing_group_cost_report_input.GetBillingGroupCostReportInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/get-billing-group-cost-report"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_billingconductor.types.get_billing_group_cost_report_input

    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.get_billing_group_cost_report_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_get_billing_group_cost_report(
