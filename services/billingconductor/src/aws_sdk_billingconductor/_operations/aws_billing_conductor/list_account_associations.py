"""Generated from Smithy shape ``com.amazonaws.billingconductor#ListAccountAssociations``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.list_account_associations_output.ListAccountAssociationsOutput = aws_sdk_billingconductor.types.list_account_associations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.list_account_associations_input.ListAccountAssociationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-account-associations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.list_account_associations_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_account_associations(
