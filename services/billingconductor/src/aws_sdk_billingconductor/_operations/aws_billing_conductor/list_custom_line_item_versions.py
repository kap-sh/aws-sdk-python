"""Generated from Smithy shape ``com.amazonaws.billingconductor#ListCustomLineItemVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.list_custom_line_item_versions_output.ListCustomLineItemVersionsOutput = aws_sdk_billingconductor.types.list_custom_line_item_versions_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.list_custom_line_item_versions_input.ListCustomLineItemVersionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-custom-line-item-versions"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_billingconductor.types.list_custom_line_item_versions_input

    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.list_custom_line_item_versions_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_custom_line_item_versions(
