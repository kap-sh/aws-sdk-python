"""Generated from Smithy shape ``com.amazonaws.billingconductor#ListResourcesAssociatedToCustomLineItem``."""
...
import aws_sdk_billingconductor.types.list_resources_associated_to_custom_line_item_response_list
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.list_resources_associated_to_custom_line_item_output.ListResourcesAssociatedToCustomLineItemOutput = aws_sdk_billingconductor.types.list_resources_associated_to_custom_line_item_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.list_resources_associated_to_custom_line_item_input.ListResourcesAssociatedToCustomLineItemInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-resources-associated-to-custom-line-item"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.list_resources_associated_to_custom_line_item_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_resources_associated_to_custom_line_item(
