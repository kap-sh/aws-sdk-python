...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.associate_accounts_output.AssociateAccountsOutput = aws_sdk_billingconductor.types.associate_accounts_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.associate_accounts_input.AssociateAccountsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.associate_accounts_input.serialize_json(input_)
    ).encode()
