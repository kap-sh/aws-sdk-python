...
def build_request(
    ...
    input: aws_sdk_billingconductor.types.associate_accounts_input.AssociateAccountsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.associate_accounts_input.serialize_json(input)
    ).encode()
