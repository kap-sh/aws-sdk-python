...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.delete_custom_line_item_output.DeleteCustomLineItemOutput = aws_sdk_billingconductor.types.delete_custom_line_item_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.delete_custom_line_item_input.DeleteCustomLineItemInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.delete_custom_line_item_input.serialize_json(
            input_
        )
    ).encode()
