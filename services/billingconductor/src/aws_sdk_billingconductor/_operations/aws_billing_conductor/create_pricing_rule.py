...
def build_request(
    ...
    input: aws_sdk_billingconductor.types.create_pricing_rule_input.CreatePricingRuleInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.create_pricing_rule_input.serialize_json(input)
    ).encode()
