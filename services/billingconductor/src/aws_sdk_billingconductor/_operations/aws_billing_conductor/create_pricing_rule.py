...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.create_pricing_rule_output.CreatePricingRuleOutput = aws_sdk_billingconductor.types.create_pricing_rule_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.create_pricing_rule_input.CreatePricingRuleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.create_pricing_rule_input.serialize_json(input_)
    ).encode()
