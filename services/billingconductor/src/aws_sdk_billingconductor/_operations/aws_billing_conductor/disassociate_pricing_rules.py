"""Generated from Smithy shape ``com.amazonaws.billingconductor#DisassociatePricingRules``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.disassociate_pricing_rules_output.DisassociatePricingRulesOutput = aws_sdk_billingconductor.types.disassociate_pricing_rules_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.disassociate_pricing_rules_input.DisassociatePricingRulesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/disassociate-pricing-rules"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_billingconductor.types.disassociate_pricing_rules_input

    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.disassociate_pricing_rules_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_disassociate_pricing_rules(
