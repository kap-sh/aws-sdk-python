"""Generated from Smithy shape ``com.amazonaws.billingconductor#CreatePricingPlan``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.create_pricing_plan_output.CreatePricingPlanOutput = aws_sdk_billingconductor.types.create_pricing_plan_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.create_pricing_plan_input.CreatePricingPlanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/create-pricing-plan"
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.create_pricing_plan_input.serialize_json(input_)
    ).encode()
...
async def async_create_pricing_plan(
