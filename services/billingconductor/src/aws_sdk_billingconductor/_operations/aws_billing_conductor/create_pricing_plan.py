...
def build_request(
    ...
    input: aws_sdk_billingconductor.types.create_pricing_plan_input.CreatePricingPlanInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.create_pricing_plan_input.serialize_json(input)
    ).encode()
