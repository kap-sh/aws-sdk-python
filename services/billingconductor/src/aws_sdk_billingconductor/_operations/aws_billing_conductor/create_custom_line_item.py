...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.create_custom_line_item_output.CreateCustomLineItemOutput = aws_sdk_billingconductor.types.create_custom_line_item_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.create_custom_line_item_input.CreateCustomLineItemInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.create_custom_line_item_input.serialize_json(
            input_
        )
    ).encode()
