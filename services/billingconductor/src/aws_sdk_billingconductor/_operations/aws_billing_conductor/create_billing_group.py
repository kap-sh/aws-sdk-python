...
def build_request(
    ...
    input: aws_sdk_billingconductor.types.create_billing_group_input.CreateBillingGroupInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.create_billing_group_input.serialize_json(input)
    ).encode()
