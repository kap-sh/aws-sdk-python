"""Generated from Smithy shape ``com.amazonaws.billingconductor#CreateBillingGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.create_billing_group_output.CreateBillingGroupOutput = aws_sdk_billingconductor.types.create_billing_group_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.create_billing_group_input.CreateBillingGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/create-billing-group"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    if "client_token" in input_:
        headers["X-Amzn-Client-Token"] = str(input_["client_token"])
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.create_billing_group_input.serialize_json(input_)
    ).encode()
...
async def async_create_billing_group(
