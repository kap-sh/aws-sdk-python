...
def build_request(
    ...
    input: aws_sdk_billingconductor.types.list_pricing_rules_input.ListPricingRulesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.list_pricing_rules_input.serialize_json(input)
    ).encode()
