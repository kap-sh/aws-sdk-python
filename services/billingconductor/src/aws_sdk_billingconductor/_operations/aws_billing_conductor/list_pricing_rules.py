"""Generated from Smithy shape ``com.amazonaws.billingconductor#ListPricingRules``."""
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.list_pricing_rules_input.ListPricingRulesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-pricing-rules"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_billingconductor.types.list_pricing_rules_input

    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.list_pricing_rules_input.serialize_json(input_)
    ).encode()
...
async def async_list_pricing_rules(
