...
def build_request(
    ...
    input: aws_sdk_billingconductor.types.update_pricing_rule_input.UpdatePricingRuleInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.update_pricing_rule_input.serialize_json(input)
    ).encode()
