...
def build_request(
    ...
    input: aws_sdk_billingconductor.types.delete_pricing_plan_input.DeletePricingPlanInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.delete_pricing_plan_input.serialize_json(input)
    ).encode()
