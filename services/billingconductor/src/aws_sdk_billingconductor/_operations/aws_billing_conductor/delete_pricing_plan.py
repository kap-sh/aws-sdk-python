"""Generated from Smithy shape ``com.amazonaws.billingconductor#DeletePricingPlan``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.delete_pricing_plan_output.DeletePricingPlanOutput = aws_sdk_billingconductor.types.delete_pricing_plan_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.delete_pricing_plan_input.DeletePricingPlanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/delete-pricing-plan"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.delete_pricing_plan_input.serialize_json(input_)
    ).encode()
...
async def async_delete_pricing_plan(
