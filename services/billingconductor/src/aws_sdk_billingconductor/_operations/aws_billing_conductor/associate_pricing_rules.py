...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.associate_pricing_rules_output.AssociatePricingRulesOutput = aws_sdk_billingconductor.types.associate_pricing_rules_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.associate_pricing_rules_input.AssociatePricingRulesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.associate_pricing_rules_input.serialize_json(
            input_
        )
    ).encode()
