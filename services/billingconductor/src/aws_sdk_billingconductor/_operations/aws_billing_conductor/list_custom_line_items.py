"""Generated from Smithy shape ``com.amazonaws.billingconductor#ListCustomLineItems``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.list_custom_line_items_output.ListCustomLineItemsOutput = aws_sdk_billingconductor.types.list_custom_line_items_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.list_custom_line_items_input.ListCustomLineItemsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_custom_line_items(
