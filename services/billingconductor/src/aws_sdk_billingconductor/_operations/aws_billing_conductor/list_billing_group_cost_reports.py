...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.list_billing_group_cost_reports_output.ListBillingGroupCostReportsOutput = aws_sdk_billingconductor.types.list_billing_group_cost_reports_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.list_billing_group_cost_reports_input.ListBillingGroupCostReportsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
