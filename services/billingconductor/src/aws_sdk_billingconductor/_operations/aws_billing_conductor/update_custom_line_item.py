"""Generated from Smithy shape ``com.amazonaws.billingconductor#UpdateCustomLineItem``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.update_custom_line_item_output.UpdateCustomLineItemOutput = aws_sdk_billingconductor.types.update_custom_line_item_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.update_custom_line_item_input.UpdateCustomLineItemInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/update-custom-line-item"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_billingconductor.types.update_custom_line_item_input

    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.update_custom_line_item_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_custom_line_item(
