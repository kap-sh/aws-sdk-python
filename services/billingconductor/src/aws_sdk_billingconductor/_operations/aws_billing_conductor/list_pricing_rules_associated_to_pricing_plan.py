"""Generated from Smithy shape ``com.amazonaws.billingconductor#ListPricingRulesAssociatedToPricingPlan``."""
...
def handle_response(
    ...
    out: aws_sdk_billingconductor.types.list_pricing_rules_associated_to_pricing_plan_output.ListPricingRulesAssociatedToPricingPlanOutput = aws_sdk_billingconductor.types.list_pricing_rules_associated_to_pricing_plan_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_billingconductor.types.list_pricing_rules_associated_to_pricing_plan_input.ListPricingRulesAssociatedToPricingPlanInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/list-pricing-rules-associated-to-pricing-plan"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_billingconductor.types.list_pricing_rules_associated_to_pricing_plan_input

    body: bytes | None = json.dumps(
        aws_sdk_billingconductor.types.list_pricing_rules_associated_to_pricing_plan_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_pricing_rules_associated_to_pricing_plan(
