...
if TYPE_CHECKING:
    import aws_sdk_billingconductor.types.conflict_exception_reason
...
class ConflictException_(TypedDict):
    ...
    reason: NotRequired[
        "aws_sdk_billingconductor.types.conflict_exception_reason.ConflictExceptionReason"
    ]
...
def serialize_json(value: ConflictException_) -> dict:
    ...
    if "reason" in value:
        ...
        out["Reason"] = (
            aws_sdk_billingconductor.types.conflict_exception_reason.serialize_json(
                value["reason"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ConflictException_:
    ...
    if "Reason" in data:
        ...
        out["reason"] = (
            aws_sdk_billingconductor.types.conflict_exception_reason.deserialize_json(
                data["Reason"]
            )
        )
    return out
