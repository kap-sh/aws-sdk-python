...
class ServiceLimitExceededException_(TypedDict):
    ...
    resource_id: NotRequired["aws_sdk_billingconductor.types.string.String"]
    """<p>Identifier of the resource affected. </p>"""
    resource_type: NotRequired["aws_sdk_billingconductor.types.string.String"]
    """<p>Type of the resource affected. </p>"""
    limit_code: "aws_sdk_billingconductor.types.string.String"
    """<p>The unique code identifier of the service limit that is being exceeded. </p>"""
    service_code: "aws_sdk_billingconductor.types.string.String"
