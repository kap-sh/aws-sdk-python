...
if TYPE_CHECKING:
    ...
    import aws_sdk_billingconductor.types.validation_exception_field_list
...
class ValidationException_(TypedDict, closed=True):
    ...
    fields: NotRequired[
        "aws_sdk_billingconductor.types.validation_exception_field_list.ValidationExceptionFieldList"
    ]
...
def serialize_json(value: ValidationException_) -> dict:
    ...
    if "reason" in value:
        ...
        out["Reason"] = (
            aws_sdk_billingconductor.types.validation_exception_reason.serialize_json(
                value["reason"]
            )
        )
    if "fields" in value:
        ...
        out["Fields"] = (
            aws_sdk_billingconductor.types.validation_exception_field_list.serialize_json(
                value["fields"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ValidationException_:
    ...
    if "Reason" in data:
        ...
        out["reason"] = (
            aws_sdk_billingconductor.types.validation_exception_reason.deserialize_json(
                data["Reason"]
            )
        )
    if "Fields" in data:
        ...
        out["fields"] = (
            aws_sdk_billingconductor.types.validation_exception_field_list.deserialize_json(
                data["Fields"]
            )
        )
    return out
