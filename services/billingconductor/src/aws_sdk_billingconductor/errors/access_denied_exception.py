"""Generated from Smithy shape ``com.amazonaws.billingconductor#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.billingconductor#AccessDeniedException``."""
