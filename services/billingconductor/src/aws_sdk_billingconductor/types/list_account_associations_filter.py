...
if TYPE_CHECKING:
    ...
    import aws_sdk_billingconductor.types.account_id_filter_list
    import aws_sdk_billingconductor.types.association


class ListAccountAssociationsFilter(TypedDict):
    association: NotRequired["aws_sdk_billingconductor.types.association.Association"]
    ...
    account_ids: NotRequired[
        "aws_sdk_billingconductor.types.account_id_filter_list.AccountIdFilterList"
    ]
...
def serialize_json(value: ListAccountAssociationsFilter) -> dict:
    ...
    if "account_ids" in value:
        ...
        out["AccountIds"] = (
            aws_sdk_billingconductor.types.account_id_filter_list.serialize_json(
                value["account_ids"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ListAccountAssociationsFilter:
    ...
    if "AccountIds" in data:
        ...
        out["account_ids"] = (
            aws_sdk_billingconductor.types.account_id_filter_list.deserialize_json(
                data["AccountIds"]
            )
        )
    return out
