...
class ListResourcesAssociatedToCustomLineItemOutput(TypedDict):
    arn: NotRequired[
    ...
    associated_resources: NotRequired[
        "aws_sdk_billingconductor.types.list_resources_associated_to_custom_line_item_response_list.ListResourcesAssociatedToCustomLineItemResponseList"
    ]
...
def serialize_json(value: ListResourcesAssociatedToCustomLineItemOutput) -> dict:
    ...
    if "associated_resources" in value:
        ...
        out["AssociatedResources"] = (
            aws_sdk_billingconductor.types.list_resources_associated_to_custom_line_item_response_list.serialize_json(
...
def deserialize_json(data: dict) -> ListResourcesAssociatedToCustomLineItemOutput:
    ...
    if "AssociatedResources" in data:
        ...
        out["associated_resources"] = (
            aws_sdk_billingconductor.types.list_resources_associated_to_custom_line_item_response_list.deserialize_json(
