...
PricingRuleList: TypeAlias = list[
    "aws_sdk_billingconductor.types.pricing_rule_list_element.PricingRuleListElement"
]
...
def serialize_json(value: PricingRuleList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_billingconductor.types.pricing_rule_list_element.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> PricingRuleList:
    ...
    for item in data:
        out.append(
            aws_sdk_billingconductor.types.pricing_rule_list_element.deserialize_json(
                item
            )
        )
    return out
