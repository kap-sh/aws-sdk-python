...
class CreateCustomLineItemInput(TypedDict):
...
def serialize_json(value: CreateCustomLineItemInput) -> dict:
    ...
    out["ChargeDetails"] = (
        aws_sdk_billingconductor.types.custom_line_item_charge_details.serialize_json(
...
def deserialize_json(data: dict) -> CreateCustomLineItemInput:
    ...
    if "ChargeDetails" in data:
        ...
        out["charge_details"] = (
            aws_sdk_billingconductor.types.custom_line_item_charge_details.deserialize_json(
                data["ChargeDetails"]
            )
        )
    else:
