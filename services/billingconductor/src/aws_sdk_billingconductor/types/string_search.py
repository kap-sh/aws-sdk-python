...
if TYPE_CHECKING:
    import aws_sdk_billingconductor.types.search_option
    import aws_sdk_billingconductor.types.search_value


class StringSearch(TypedDict, closed=True):
    search_option: "aws_sdk_billingconductor.types.search_option.SearchOption"
    """<p> The search option to be applied when performing the string search. </p>"""
    search_value: "aws_sdk_billingconductor.types.search_value.SearchValue"
...
def serialize_json(value: StringSearch) -> dict:
    ...
    out["SearchOption"] = aws_sdk_billingconductor.types.search_option.serialize_json(
        value["search_option"]
    )
...
def deserialize_json(data: dict) -> StringSearch:
    ...
    if "SearchOption" in data:
        ...
        out["search_option"] = (
            aws_sdk_billingconductor.types.search_option.deserialize_json(
                data["SearchOption"]
            )
        )
    else:
