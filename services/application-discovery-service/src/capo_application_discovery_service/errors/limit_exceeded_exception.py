"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.applicationdiscoveryservice#LimitExceededException``."""
