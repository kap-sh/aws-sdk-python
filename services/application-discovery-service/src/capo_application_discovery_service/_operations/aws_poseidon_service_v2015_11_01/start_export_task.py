...
def handle_response(
    ...
    out: capo_application_discovery_service.types.start_export_task_response.StartExportTaskResponse = capo_application_discovery_service.types.start_export_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.start_export_task_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
