...
import capo_application_discovery_service.types.configurations
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.list_configurations_response.ListConfigurationsResponse = capo_application_discovery_service.types.list_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.list_configurations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
