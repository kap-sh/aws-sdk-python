"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#StartBatchDeleteConfigurationTask``."""
...
import capo_application_discovery_service.errors.limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise capo_application_discovery_service.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.start_batch_delete_configuration_task_response.StartBatchDeleteConfigurationTaskResponse = capo_application_discovery_service.types.start_batch_delete_configuration_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.start_batch_delete_configuration_task_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_batch_delete_configuration_task(
