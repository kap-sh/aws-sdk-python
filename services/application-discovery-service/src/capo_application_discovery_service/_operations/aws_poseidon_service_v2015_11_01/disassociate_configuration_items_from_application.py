"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#DisassociateConfigurationItemsFromApplication``."""
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.disassociate_configuration_items_from_application_response.DisassociateConfigurationItemsFromApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.disassociate_configuration_items_from_application_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disassociate_configuration_items_from_application(
