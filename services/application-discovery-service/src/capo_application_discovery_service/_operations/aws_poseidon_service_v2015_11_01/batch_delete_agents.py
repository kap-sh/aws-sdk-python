"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#BatchDeleteAgents``."""
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.batch_delete_agents_response.BatchDeleteAgentsResponse = capo_application_discovery_service.types.batch_delete_agents_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSPoseidonService_V2015_11_01.BatchDeleteAgents"
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.batch_delete_agents_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_delete_agents(
