"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#CreateTags``."""
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.create_tags_response.CreateTagsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.create_tags_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
