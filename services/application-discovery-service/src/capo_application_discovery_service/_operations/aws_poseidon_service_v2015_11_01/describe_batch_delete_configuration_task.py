"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#DescribeBatchDeleteConfigurationTask``."""
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.describe_batch_delete_configuration_task_response.DescribeBatchDeleteConfigurationTaskResponse = capo_application_discovery_service.types.describe_batch_delete_configuration_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.describe_batch_delete_configuration_task_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_batch_delete_configuration_task(
