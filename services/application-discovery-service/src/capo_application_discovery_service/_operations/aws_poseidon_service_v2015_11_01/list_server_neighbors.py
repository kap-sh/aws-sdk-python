"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#ListServerNeighbors``."""
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.list_server_neighbors_response.ListServerNeighborsResponse = capo_application_discovery_service.types.list_server_neighbors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSPoseidonService_V2015_11_01.ListServerNeighbors"
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.list_server_neighbors_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_server_neighbors(
