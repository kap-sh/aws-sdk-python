"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#ExportConfigurations``."""
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.export_configurations_response.ExportConfigurationsResponse = capo_application_discovery_service.types.export_configurations_response.deserialize_aws_json_1_1(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSPoseidonService_V2015_11_01.ExportConfigurations"
    body: bytes | None = b""
...
async def async_export_configurations(
