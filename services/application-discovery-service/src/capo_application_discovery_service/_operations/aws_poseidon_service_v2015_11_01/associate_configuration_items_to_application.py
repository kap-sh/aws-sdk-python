"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#AssociateConfigurationItemsToApplication``."""
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.associate_configuration_items_to_application_response.AssociateConfigurationItemsToApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.associate_configuration_items_to_application_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_configuration_items_to_application(
