"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#StartDataCollectionByAgentIds``."""
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.start_data_collection_by_agent_ids_response.StartDataCollectionByAgentIdsResponse = capo_application_discovery_service.types.start_data_collection_by_agent_ids_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.start_data_collection_by_agent_ids_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_data_collection_by_agent_ids(
