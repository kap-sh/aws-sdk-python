"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#DescribeConfigurations``."""
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.describe_configurations_response.DescribeConfigurationsResponse = capo_application_discovery_service.types.describe_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSPoseidonService_V2015_11_01.DescribeConfigurations"
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.describe_configurations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_configurations(
