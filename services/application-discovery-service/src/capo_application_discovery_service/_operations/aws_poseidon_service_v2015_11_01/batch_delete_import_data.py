"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#BatchDeleteImportData``."""
...
import capo_application_discovery_service.types.batch_delete_import_data_error_list
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.batch_delete_import_data_response.BatchDeleteImportDataResponse = capo_application_discovery_service.types.batch_delete_import_data_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSPoseidonService_V2015_11_01.BatchDeleteImportData"
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.batch_delete_import_data_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
