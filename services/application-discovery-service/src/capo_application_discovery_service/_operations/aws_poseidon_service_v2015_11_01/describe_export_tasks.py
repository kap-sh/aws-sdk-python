"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#DescribeExportTasks``."""
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.describe_export_tasks_response.DescribeExportTasksResponse = capo_application_discovery_service.types.describe_export_tasks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSPoseidonService_V2015_11_01.DescribeExportTasks"
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.describe_export_tasks_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
