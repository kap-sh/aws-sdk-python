"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#DescribeTags``."""
...
import capo_application_discovery_service.types.configuration_tag_set
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.describe_tags_response.DescribeTagsResponse = capo_application_discovery_service.types.describe_tags_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.describe_tags_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
