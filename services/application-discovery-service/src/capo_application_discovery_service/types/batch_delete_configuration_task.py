...
class BatchDeleteConfigurationTask(TypedDict, closed=True):
    ...
    status: NotRequired[
        "capo_application_discovery_service.types.batch_delete_configuration_task_status.BatchDeleteConfigurationTaskStatus"
    ]
    ...
    configuration_type: NotRequired[
        "capo_application_discovery_service.types.deletion_configuration_item_type.DeletionConfigurationItemType"
    ]
    ...
    failed_configurations: NotRequired[
        "capo_application_discovery_service.types.failed_configuration_list.FailedConfigurationList"
    ]
    ...
    deletion_warnings: NotRequired[
        "capo_application_discovery_service.types.deletion_warnings_list.DeletionWarningsList"
    ]
...
def serialize_aws_json_1_1(value: BatchDeleteConfigurationTask) -> dict:
    ...
    if "status" in value:
        ...
        out["status"] = (
            capo_application_discovery_service.types.batch_delete_configuration_task_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
    ...
    if "configuration_type" in value:
        ...
        out["configurationType"] = (
            capo_application_discovery_service.types.deletion_configuration_item_type.serialize_aws_json_1_1(
    ...
    if "failed_configurations" in value:
        ...
        out["failedConfigurations"] = (
            capo_application_discovery_service.types.failed_configuration_list.serialize_aws_json_1_1(
    ...
    if "deletion_warnings" in value:
        ...
        out["deletionWarnings"] = (
            capo_application_discovery_service.types.deletion_warnings_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> BatchDeleteConfigurationTask:
    ...
    if "status" in data:
        ...
        out["status"] = (
            capo_application_discovery_service.types.batch_delete_configuration_task_status.deserialize_aws_json_1_1(
                data["status"]
            )
        )
    ...
    if "configurationType" in data:
        ...
        out["configuration_type"] = (
            capo_application_discovery_service.types.deletion_configuration_item_type.deserialize_aws_json_1_1(
    ...
    if "failedConfigurations" in data:
        ...
        out["failed_configurations"] = (
            capo_application_discovery_service.types.failed_configuration_list.deserialize_aws_json_1_1(
    ...
    if "deletionWarnings" in data:
        ...
        out["deletion_warnings"] = (
            capo_application_discovery_service.types.deletion_warnings_list.deserialize_aws_json_1_1(
