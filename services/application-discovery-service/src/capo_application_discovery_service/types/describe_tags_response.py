...
class DescribeTagsResponse(TypedDict, closed=True):
    tags: NotRequired[
        "capo_application_discovery_service.types.configuration_tag_set.ConfigurationTagSet"
    ]
...
def serialize_aws_json_1_1(value: DescribeTagsResponse) -> dict:
    ...
    if "tags" in value:
        ...
        out["tags"] = (
            capo_application_discovery_service.types.configuration_tag_set.serialize_aws_json_1_1(
                value["tags"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeTagsResponse:
    ...
    if "tags" in data:
        ...
        out["tags"] = (
            capo_application_discovery_service.types.configuration_tag_set.deserialize_aws_json_1_1(
                data["tags"]
            )
        )
