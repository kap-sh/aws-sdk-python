...
class GetDiscoverySummaryResponse(TypedDict, closed=True):
    servers: "capo_application_discovery_service.types.long.Long"
    """<p>The number of servers discovered.</p>"""
    applications: "capo_application_discovery_service.types.long.Long"
    """<p>The number of applications discovered.</p>"""
    servers_mapped_to_applications: "capo_application_discovery_service.types.long.Long"
    """<p>The number of servers mapped to applications.</p>"""
    servers_mappedto_tags: "capo_application_discovery_service.types.long.Long"
    """<p>The number of servers mapped to tags.</p>"""
    agent_summary: NotRequired[
        "capo_application_discovery_service.types.customer_agent_info.CustomerAgentInfo"
    ]
    """<p>Details about discovered agents, including agent status and health.</p>"""
    connector_summary: NotRequired[
        "capo_application_discovery_service.types.customer_connector_info.CustomerConnectorInfo"
    ]
    """<p>Details about discovered connectors, including connector status and health.</p>"""
    me_collector_summary: NotRequired[
        "capo_application_discovery_service.types.customer_me_collector_info.CustomerMeCollectorInfo"
    ]
    ...
    agentless_collector_summary: NotRequired[
        "capo_application_discovery_service.types.customer_agentless_collector_info.CustomerAgentlessCollectorInfo"
    ]
...
def serialize_aws_json_1_1(value: GetDiscoverySummaryResponse) -> dict:
    ...
    if "agent_summary" in value:
        ...
        out["agentSummary"] = (
            capo_application_discovery_service.types.customer_agent_info.serialize_aws_json_1_1(
                value["agent_summary"]
            )
        )
    if "connector_summary" in value:
        ...
        out["connectorSummary"] = (
            capo_application_discovery_service.types.customer_connector_info.serialize_aws_json_1_1(
    ...
    if "me_collector_summary" in value:
        ...
        out["meCollectorSummary"] = (
            capo_application_discovery_service.types.customer_me_collector_info.serialize_aws_json_1_1(
    ...
    if "agentless_collector_summary" in value:
        ...
        out["agentlessCollectorSummary"] = (
            capo_application_discovery_service.types.customer_agentless_collector_info.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetDiscoverySummaryResponse:
    ...
    if "agentSummary" in data:
        ...
        out["agent_summary"] = (
            capo_application_discovery_service.types.customer_agent_info.deserialize_aws_json_1_1(
                data["agentSummary"]
            )
        )
    if "connectorSummary" in data:
        ...
        out["connector_summary"] = (
            capo_application_discovery_service.types.customer_connector_info.deserialize_aws_json_1_1(
    ...
    if "meCollectorSummary" in data:
        ...
        out["me_collector_summary"] = (
            capo_application_discovery_service.types.customer_me_collector_info.deserialize_aws_json_1_1(
    ...
    if "agentlessCollectorSummary" in data:
        ...
        out["agentless_collector_summary"] = (
            capo_application_discovery_service.types.customer_agentless_collector_info.deserialize_aws_json_1_1(
