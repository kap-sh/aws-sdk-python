...
class DescribeExportTasksResponse(TypedDict, closed=True):
    exports_info: NotRequired[
        "capo_application_discovery_service.types.exports_info.ExportsInfo"
    ]
...
def serialize_aws_json_1_1(value: DescribeExportTasksResponse) -> dict:
    ...
    if "exports_info" in value:
        ...
        out["exportsInfo"] = (
            capo_application_discovery_service.types.exports_info.serialize_aws_json_1_1(
                value["exports_info"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeExportTasksResponse:
    ...
    if "exportsInfo" in data:
        ...
        out["exports_info"] = (
            capo_application_discovery_service.types.exports_info.deserialize_aws_json_1_1(
                data["exportsInfo"]
            )
        )
