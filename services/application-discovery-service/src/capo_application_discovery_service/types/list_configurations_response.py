...
class ListConfigurationsResponse(TypedDict, closed=True):
    configurations: NotRequired[
        "capo_application_discovery_service.types.configurations.Configurations"
    ]
...
def serialize_aws_json_1_1(value: ListConfigurationsResponse) -> dict:
    ...
    if "configurations" in value:
        ...
        out["configurations"] = (
            capo_application_discovery_service.types.configurations.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListConfigurationsResponse:
    ...
    if "configurations" in data:
        ...
        out["configurations"] = (
            capo_application_discovery_service.types.configurations.deserialize_aws_json_1_1(
                data["configurations"]
            )
        )
