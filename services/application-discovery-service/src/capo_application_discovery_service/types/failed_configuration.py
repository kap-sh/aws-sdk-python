...
if TYPE_CHECKING:
    ...
    import capo_application_discovery_service.types.error_message
    import capo_application_discovery_service.types.error_status_code


class FailedConfiguration(TypedDict, closed=True):
    ...
    error_status_code: (
        "capo_application_discovery_service.types.error_status_code.ErrorStatusCode"
    )
    """<p> The integer error code associated with the error message. </p>"""
    error_message: NotRequired[
        "capo_application_discovery_service.types.error_message.ErrorMessage"
    ]
