...
class CustomerAgentInfo(TypedDict):
    ...
    black_listed_agents: "aws_sdk_application_discovery_service.types.integer.Integer"
    """<p>Number of blacklisted discovery agents.</p>"""
    shutdown_agents: "aws_sdk_application_discovery_service.types.integer.Integer"
    """<p>Number of discovery agents with status SHUTDOWN.</p>"""
    unhealthy_agents: "aws_sdk_application_discovery_service.types.integer.Integer"
    """<p>Number of unhealthy discovery agents.</p>"""
    total_agents: "aws_sdk_application_discovery_service.types.integer.Integer"
    """<p>Total number of discovery agents.</p>"""
    unknown_agents: "aws_sdk_application_discovery_service.types.integer.Integer"
