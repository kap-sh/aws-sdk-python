...
class ConfigurationTag(TypedDict):
    configuration_type: NotRequired[
        "aws_sdk_application_discovery_service.types.configuration_item_type.ConfigurationItemType"
    ]
    ...
    key: NotRequired["aws_sdk_application_discovery_service.types.tag_key.TagKey"]
    """<p>A type of tag on which to filter. For example, <i>serverType</i>.</p>"""
    value: NotRequired["aws_sdk_application_discovery_service.types.tag_value.TagValue"]
