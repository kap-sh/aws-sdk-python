...
if TYPE_CHECKING:
    ...
    import aws_sdk_application_discovery_service.types.file_classification
    import aws_sdk_application_discovery_service.types.import_status
    ...
    import aws_sdk_application_discovery_service.types.s3_presigned_url
...
class ImportTask(TypedDict, closed=True):
    ...
    name: NotRequired[
        "aws_sdk_application_discovery_service.types.import_task_name.ImportTaskName"
    ]
    ...
    import_url: NotRequired[
        "aws_sdk_application_discovery_service.types.import_url.ImportURL"
    ]
    """<p>The URL for your import file that you've uploaded to Amazon S3.</p>"""
    status: NotRequired[
        "aws_sdk_application_discovery_service.types.import_status.ImportStatus"
    ]
    ...
    file_classification: NotRequired[
        "aws_sdk_application_discovery_service.types.file_classification.FileClassification"
    ]
    """<p>The type of file detected by the import task.</p>"""
    server_import_success: "aws_sdk_application_discovery_service.types.integer.Integer"
    """<p>The total number of server records in the import file that were successfully imported.</p>"""
    server_import_failure: "aws_sdk_application_discovery_service.types.integer.Integer"
    ...
    errors_and_failed_entries_zip: NotRequired[
        "aws_sdk_application_discovery_service.types.s3_presigned_url.S3PresignedUrl"
    ]
...
def serialize_aws_json_1_1(value: ImportTask) -> dict:
    ...
    if "status" in value:
        ...
        out["status"] = (
            aws_sdk_application_discovery_service.types.import_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
    ...
    if "file_classification" in value:
        ...
        out["fileClassification"] = (
            aws_sdk_application_discovery_service.types.file_classification.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ImportTask:
    ...
    if "status" in data:
        ...
        out["status"] = (
            aws_sdk_application_discovery_service.types.import_status.deserialize_aws_json_1_1(
                data["status"]
            )
        )
    ...
    if "fileClassification" in data:
        ...
        out["file_classification"] = (
            aws_sdk_application_discovery_service.types.file_classification.deserialize_aws_json_1_1(
