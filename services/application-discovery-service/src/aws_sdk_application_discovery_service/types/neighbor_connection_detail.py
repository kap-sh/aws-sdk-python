...
if TYPE_CHECKING:
    import aws_sdk_application_discovery_service.types.boxed_integer
...
class NeighborConnectionDetail(TypedDict):
    source_server_id: (
    ...
    destination_port: NotRequired[
        "aws_sdk_application_discovery_service.types.boxed_integer.BoxedInteger"
    ]
    ...
    connections_count: "aws_sdk_application_discovery_service.types.long.Long"
