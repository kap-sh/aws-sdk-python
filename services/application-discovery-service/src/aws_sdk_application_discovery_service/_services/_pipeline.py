...
from aws_sdk_application_discovery_service._async import anysleep
from aws_sdk_application_discovery_service._auth._providers import CredentialsProvider
