...
from aws_sdk_application_discovery_service._auth._identity import (
    Credentials,
    Identity,
)
from aws_sdk_application_discovery_service._services._aws_config import _load_profile
