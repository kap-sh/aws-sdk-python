"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#DescribeAgents``."""
...
def handle_response(
    ...
    out: aws_sdk_application_discovery_service.types.describe_agents_response.DescribeAgentsResponse = aws_sdk_application_discovery_service.types.describe_agents_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_application_discovery_service.types.describe_agents_request.DescribeAgentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_discovery_service.types.describe_agents_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_agents(
