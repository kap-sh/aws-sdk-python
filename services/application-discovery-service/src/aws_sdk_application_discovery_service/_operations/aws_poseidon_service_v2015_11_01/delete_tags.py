...
def handle_response(
    ...
    out: aws_sdk_application_discovery_service.types.delete_tags_response.DeleteTagsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_application_discovery_service.types.delete_tags_request.DeleteTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_discovery_service.types.delete_tags_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
