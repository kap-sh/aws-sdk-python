...
def build_request(
    ...
    input: aws_sdk_application_discovery_service.types.associate_configuration_items_to_application_request.AssociateConfigurationItemsToApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
