...
def handle_response(
    ...
    out: aws_sdk_application_discovery_service.types.export_configurations_response.ExportConfigurationsResponse = aws_sdk_application_discovery_service.types.export_configurations_response.deserialize_aws_json_1_1(
