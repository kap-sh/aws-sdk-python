"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#DescribeExportConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_application_discovery_service.types.describe_export_configurations_response.DescribeExportConfigurationsResponse = aws_sdk_application_discovery_service.types.describe_export_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_application_discovery_service.types.describe_export_configurations_request.DescribeExportConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_export_configurations(
