...
def handle_response(
    ...
    out: aws_sdk_application_discovery_service.types.describe_import_tasks_response.DescribeImportTasksResponse = aws_sdk_application_discovery_service.types.describe_import_tasks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_application_discovery_service.types.describe_import_tasks_request.DescribeImportTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_discovery_service.types.describe_import_tasks_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
