...
def handle_response(
    ...
    out: aws_sdk_application_discovery_service.types.disassociate_configuration_items_from_application_response.DisassociateConfigurationItemsFromApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_application_discovery_service.types.disassociate_configuration_items_from_application_request.DisassociateConfigurationItemsFromApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
