...
def handle_response(
    ...
    out: aws_sdk_application_discovery_service.types.start_data_collection_by_agent_ids_response.StartDataCollectionByAgentIdsResponse = aws_sdk_application_discovery_service.types.start_data_collection_by_agent_ids_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_application_discovery_service.types.start_data_collection_by_agent_ids_request.StartDataCollectionByAgentIdsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
