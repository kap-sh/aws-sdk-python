"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#StartContinuousExport``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictErrorException":
            import aws_sdk_application_discovery_service.errors.conflict_error_exception

            raise aws_sdk_application_discovery_service.errors.conflict_error_exception.ConflictErrorException.from_aws_json_1_1(
                data
            )
        ...
        case "OperationNotPermittedException":
            import aws_sdk_application_discovery_service.errors.operation_not_permitted_exception

            raise aws_sdk_application_discovery_service.errors.operation_not_permitted_exception.OperationNotPermittedException.from_aws_json_1_1(
                data
            )
        case "ResourceInUseException":
            import aws_sdk_application_discovery_service.errors.resource_in_use_exception

            raise aws_sdk_application_discovery_service.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_application_discovery_service.types.start_continuous_export_response.StartContinuousExportResponse = aws_sdk_application_discovery_service.types.start_continuous_export_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_application_discovery_service.types.start_continuous_export_request.StartContinuousExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSPoseidonService_V2015_11_01.StartContinuousExport"
    body: bytes | None = b""
...
async def async_start_continuous_export(
