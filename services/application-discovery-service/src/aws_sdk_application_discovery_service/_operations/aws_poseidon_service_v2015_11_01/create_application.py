"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#CreateApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_application_discovery_service.types.create_application_response.CreateApplicationResponse = aws_sdk_application_discovery_service.types.create_application_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_application_discovery_service.types.create_application_request.CreateApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_discovery_service.types.create_application_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
