"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#DeleteApplications``."""
...
def handle_response(
    ...
    out: aws_sdk_application_discovery_service.types.delete_applications_response.DeleteApplicationsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_application_discovery_service.types.delete_applications_request.DeleteApplicationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_discovery_service.types.delete_applications_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_applications(
