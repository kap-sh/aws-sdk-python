"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#StopContinuousExport``."""
...
def handle_response(
    ...
    out: aws_sdk_application_discovery_service.types.stop_continuous_export_response.StopContinuousExportResponse = aws_sdk_application_discovery_service.types.stop_continuous_export_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_application_discovery_service.types.stop_continuous_export_request.StopContinuousExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSPoseidonService_V2015_11_01.StopContinuousExport"
    import aws_sdk_application_discovery_service.types.stop_continuous_export_request

    body: bytes | None = json.dumps(
        aws_sdk_application_discovery_service.types.stop_continuous_export_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_continuous_export(
