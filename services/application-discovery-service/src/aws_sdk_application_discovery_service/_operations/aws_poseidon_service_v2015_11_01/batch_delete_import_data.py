...
def handle_response(
    ...
    out: aws_sdk_application_discovery_service.types.batch_delete_import_data_response.BatchDeleteImportDataResponse = aws_sdk_application_discovery_service.types.batch_delete_import_data_response.deserialize_aws_json_1_1(
