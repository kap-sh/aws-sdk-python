...
def handle_response(
    ...
    out: aws_sdk_application_discovery_service.types.start_import_task_response.StartImportTaskResponse = aws_sdk_application_discovery_service.types.start_import_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_application_discovery_service.types.start_import_task_request.StartImportTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_discovery_service.types.start_import_task_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
