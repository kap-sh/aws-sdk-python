...
def handle_response(
    ...
    out: aws_sdk_application_discovery_service.types.stop_data_collection_by_agent_ids_response.StopDataCollectionByAgentIdsResponse = aws_sdk_application_discovery_service.types.stop_data_collection_by_agent_ids_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_application_discovery_service.types.stop_data_collection_by_agent_ids_request.StopDataCollectionByAgentIdsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_application_discovery_service.types.stop_data_collection_by_agent_ids_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
