...
class ApplicationDiscoveryServiceError(Exception):
    """Base class for all ApplicationDiscoveryService service errors."""


class ServiceError(ApplicationDiscoveryServiceError):
...
class SerializationError(ApplicationDiscoveryServiceError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ApplicationDiscoveryServiceError):
...
class WaiterFailedError(ApplicationDiscoveryServiceError):
...
class WaiterTimeoutError(ApplicationDiscoveryServiceError):
