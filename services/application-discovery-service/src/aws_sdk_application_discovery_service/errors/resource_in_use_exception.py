"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#ResourceInUseException``."""
...
class ResourceInUseException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.applicationdiscoveryservice#ResourceInUseException``."""
