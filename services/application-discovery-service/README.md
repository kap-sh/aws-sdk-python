...
```
pip install aws-sdk-application-discovery-service
```

## Usage

```python
from aws_sdk_application_discovery_service import AsyncApplicationDiscoveryServiceClient
...
```python
from aws_sdk_application_discovery_service import AsyncApplicationDiscoveryServiceClient
from aws_sdk_application_discovery_service.error import AuthorizationErrorException
