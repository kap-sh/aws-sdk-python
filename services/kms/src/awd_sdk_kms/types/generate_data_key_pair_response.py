...
class GenerateDataKeyPairResponse(TypedDict):
    ...
    private_key_plaintext: NotRequired["awd_sdk_kms.types.plaintext_type.PlaintextType"]
    ...
    key_pair_spec: NotRequired["awd_sdk_kms.types.data_key_pair_spec.DataKeyPairSpec"]
