...
class GetKeyRotationStatusResponse(TypedDict):
    key_rotation_enabled: "awd_sdk_kms.types.boolean_type.BooleanType"
    ...
    next_rotation_date: NotRequired["awd_sdk_kms.types.date_type.DateType"]
    """<p>The next date that KMS will automatically rotate the key material.</p>"""
    on_demand_rotation_start_date: NotRequired["awd_sdk_kms.types.date_type.DateType"]
