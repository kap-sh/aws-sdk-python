...
if TYPE_CHECKING:
    ...
    import awd_sdk_kms.types.multi_region_key_list
    import awd_sdk_kms.types.multi_region_key_type


class MultiRegionConfiguration(TypedDict):
    multi_region_key_type: NotRequired[
        "awd_sdk_kms.types.multi_region_key_type.MultiRegionKeyType"
    ]
    """<p>Indicates whether the KMS key is a <code>PRIMARY</code> or <code>REPLICA</code> key.</p>"""
    primary_key: NotRequired["awd_sdk_kms.types.multi_region_key.MultiRegionKey"]
    ...
    replica_keys: NotRequired[
        "awd_sdk_kms.types.multi_region_key_list.MultiRegionKeyList"
    ]
