...
if TYPE_CHECKING:
    ...
    import awd_sdk_kms.types.import_state
    import awd_sdk_kms.types.key_id_type
    import awd_sdk_kms.types.key_material_description_type
    import awd_sdk_kms.types.key_material_state
    import awd_sdk_kms.types.rotation_type
...
class RotationsListEntry(TypedDict):
    ...
    import_state: NotRequired["awd_sdk_kms.types.import_state.ImportState"]
    ...
    key_material_state: NotRequired[
        "awd_sdk_kms.types.key_material_state.KeyMaterialState"
    ]
    ...
    rotation_date: NotRequired["awd_sdk_kms.types.date_type.DateType"]
    ...
    rotation_type: NotRequired["awd_sdk_kms.types.rotation_type.RotationType"]
