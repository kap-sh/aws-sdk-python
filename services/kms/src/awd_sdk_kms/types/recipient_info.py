...
if TYPE_CHECKING:
    import awd_sdk_kms.types.attestation_document_type
    import awd_sdk_kms.types.key_encryption_mechanism


class RecipientInfo(TypedDict):
    key_encryption_algorithm: NotRequired[
        "awd_sdk_kms.types.key_encryption_mechanism.KeyEncryptionMechanism"
    ]
    ...
    attestation_document: NotRequired[
        "awd_sdk_kms.types.attestation_document_type.AttestationDocumentType"
    ]
