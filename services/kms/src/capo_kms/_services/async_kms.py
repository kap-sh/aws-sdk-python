...
from capo_kms._auth._identity import Credentials
from capo_kms._auth._providers import (
    CredentialsProvider,
    IdentityProvider,
    StaticAwsCredentialsProvider,
    default_aws_credentials_chain,
)
from capo_kms._auth._zapros_handler import AuthMiddleware
from capo_kms._pagination import resolve_path as _resolve_path
from capo_kms._services._aws_config import aaws_config
from capo_kms._services._pipeline import (
    AsyncInterceptor,
...
if TYPE_CHECKING:
    import capo_kms.types.account_id_type
    ...
    import capo_kms.types.cancel_key_deletion_request
    import capo_kms.types.cancel_key_deletion_response
    import capo_kms.types.ciphertext_type
    import capo_kms.types.cloud_hsm_cluster_id_type
    import capo_kms.types.connect_custom_key_store_request
    import capo_kms.types.connect_custom_key_store_response
    import capo_kms.types.create_alias_request
    import capo_kms.types.create_custom_key_store_request
    import capo_kms.types.create_custom_key_store_response
    import capo_kms.types.create_grant_request
    import capo_kms.types.create_grant_response
    import capo_kms.types.create_key_request
    import capo_kms.types.create_key_response
    ...
    import capo_kms.types.decrypt_request
    import capo_kms.types.decrypt_response
    import capo_kms.types.delete_alias_request
    import capo_kms.types.delete_custom_key_store_request
    import capo_kms.types.delete_custom_key_store_response
    import capo_kms.types.delete_imported_key_material_request
    import capo_kms.types.delete_imported_key_material_response
    import capo_kms.types.derive_shared_secret_request
    import capo_kms.types.derive_shared_secret_response
    import capo_kms.types.describe_custom_key_stores_request
    import capo_kms.types.describe_custom_key_stores_response
    import capo_kms.types.describe_key_request
    import capo_kms.types.describe_key_response
    import capo_kms.types.description_type
    import capo_kms.types.disable_key_request
    import capo_kms.types.disable_key_rotation_request
    import capo_kms.types.disconnect_custom_key_store_request
    import capo_kms.types.disconnect_custom_key_store_response
    import capo_kms.types.dry_run_modifier_list
    import capo_kms.types.enable_key_request
    import capo_kms.types.enable_key_rotation_request
    import capo_kms.types.encrypt_request
    import capo_kms.types.encrypt_response
    ...
    import capo_kms.types.generate_data_key_pair_request
    import capo_kms.types.generate_data_key_pair_response
    import capo_kms.types.generate_data_key_pair_without_plaintext_request
    import capo_kms.types.generate_data_key_pair_without_plaintext_response
    import capo_kms.types.generate_data_key_request
    import capo_kms.types.generate_data_key_response
    import capo_kms.types.generate_data_key_without_plaintext_request
    import capo_kms.types.generate_data_key_without_plaintext_response
    import capo_kms.types.generate_mac_request
    import capo_kms.types.generate_mac_response
    import capo_kms.types.generate_random_request
    import capo_kms.types.generate_random_response
    import capo_kms.types.get_key_last_usage_request
    import capo_kms.types.get_key_last_usage_response
    import capo_kms.types.get_key_policy_request
    import capo_kms.types.get_key_policy_response
    import capo_kms.types.get_key_rotation_status_request
    import capo_kms.types.get_key_rotation_status_response
    import capo_kms.types.get_parameters_for_import_request
    import capo_kms.types.get_parameters_for_import_response
    import capo_kms.types.get_public_key_request
    import capo_kms.types.get_public_key_response
    ...
    import capo_kms.types.import_key_material_request
    import capo_kms.types.import_key_material_response
    ...
    import capo_kms.types.key_store_password_type
    import capo_kms.types.key_usage_type
    import capo_kms.types.limit_type
    import capo_kms.types.list_aliases_request
    import capo_kms.types.list_aliases_response
    import capo_kms.types.list_grants_request
    import capo_kms.types.list_grants_response
    import capo_kms.types.list_key_policies_request
    import capo_kms.types.list_key_policies_response
    import capo_kms.types.list_key_rotations_request
    import capo_kms.types.list_key_rotations_response
    import capo_kms.types.list_keys_request
    import capo_kms.types.list_keys_response
    import capo_kms.types.list_resource_tags_request
    import capo_kms.types.list_resource_tags_response
    import capo_kms.types.list_retirable_grants_request
    ...
    import capo_kms.types.re_encrypt_request
    import capo_kms.types.re_encrypt_response
    import capo_kms.types.recipient_info
    import capo_kms.types.region_type
    import capo_kms.types.replicate_key_request
    import capo_kms.types.replicate_key_response
    import capo_kms.types.retire_grant_request
    import capo_kms.types.revoke_grant_request
    import capo_kms.types.rotate_key_on_demand_request
    import capo_kms.types.rotate_key_on_demand_response
    import capo_kms.types.rotation_period_in_days_type
    import capo_kms.types.rotations_list_entry
    import capo_kms.types.schedule_key_deletion_request
    import capo_kms.types.schedule_key_deletion_response
    import capo_kms.types.service_principal_type
    import capo_kms.types.sign_request
    import capo_kms.types.sign_response
    import capo_kms.types.signing_algorithm_spec
    import capo_kms.types.tag
    import capo_kms.types.tag_key_list
    import capo_kms.types.tag_list
    import capo_kms.types.tag_resource_request
    import capo_kms.types.trust_anchor_certificate_type
    import capo_kms.types.untag_resource_request
    import capo_kms.types.update_alias_request
    import capo_kms.types.update_custom_key_store_request
    import capo_kms.types.update_custom_key_store_response
    import capo_kms.types.update_key_description_request
    import capo_kms.types.update_primary_region_request
    import capo_kms.types.verify_mac_request
    import capo_kms.types.verify_mac_response
    import capo_kms.types.verify_request
    import capo_kms.types.verify_response
    ...
    import capo_kms.types.xks_proxy_uri_endpoint_type
    import capo_kms.types.xks_proxy_uri_path_type
    import capo_kms.types.xks_proxy_vpc_endpoint_service_name_type


class AsyncKMSClientConfig(TypedDict, total=False, closed=True):
...
class AsyncKMSClient:
    ...
    def __init__(
        ...
        self._config = AsyncKMSClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncKMSClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncKMSClientConfig = config_overrides or {}
    ...
    async def cancel_key_deletion(
        ...
        *,
        ...
        Raises:
            capo_kms.errors.dependency_timeout_exception.DependencyTimeoutException: <p>The system timed out while trying to fulfill the request. You can retry the request.</p>
            capo_kms.errors.invalid_arn_exception.InvalidArnException: <p>The request was rejected because a specified ARN, or an ARN in a key policy, is not valid.</p>
            capo_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            capo_kms.errors.kms_invalid_state_exception.KMSInvalidStateException: <p>The request was rejected because the state of the specified resource is not valid for this request.</p> <p>This exceptions means one of the following:</p> <ul> <li> <p>The key state of the KMS key is not compatible with the operation. </p> <p>To find the key state, use the <a>DescribeKey</a> operation. For more information about which key states are compatible with each KMS operation, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html\">Key states of KMS keys</a> in the <i> <i>Key Management Service Developer Guide</i> </i>.</p> </li> <li> <p>For cryptographic operations on KMS keys in custom key stores, this exception represents a general failure with many possible causes. To identify the cause, see the error message that accompanies the exception.</p> </li> </ul>
            capo_kms.errors.not_found_exception.NotFoundException: <p>The request was rejected because the specified entity or resource could not be found.</p>
            capo_kms.errors.UnknownServiceError: The service returned an error code this client does not model.

        Examples:
            To cancel deletion of a KMS key
            The following example cancels deletion of the specified KMS key.

            >>> await client.cancel_key_deletion(key_id='1234abcd-12ab-34cd-56ef-1234567890ab')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.cancel_key_deletion_request.CancelKeyDeletionRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.cancel_key_deletion_response.CancelKeyDeletionResponse"
        ]:
            import capo_kms._operations.trent_service.cancel_key_deletion

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.cancel_key_deletion.async_cancel_key_deletion(
    ...
    async def connect_custom_key_store(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.connect_custom_key_store(custom_key_store_id='cks-1234567890abcdef0')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.connect_custom_key_store_request.ConnectCustomKeyStoreRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.connect_custom_key_store_response.ConnectCustomKeyStoreResponse"
        ]:
            import capo_kms._operations.trent_service.connect_custom_key_store

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.connect_custom_key_store.async_connect_custom_key_store(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_alias(
        ...
        *,
        ...
        Raises:
            capo_kms.errors.already_exists_exception.AlreadyExistsException: <p>The request was rejected because it attempted to create a resource that already exists.</p>
            capo_kms.errors.dependency_timeout_exception.DependencyTimeoutException: <p>The system timed out while trying to fulfill the request. You can retry the request.</p>
            capo_kms.errors.invalid_alias_name_exception.InvalidAliasNameException: <p>The request was rejected because the specified alias name is not valid.</p>
            capo_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            capo_kms.errors.kms_invalid_state_exception.KMSInvalidStateException: <p>The request was rejected because the state of the specified resource is not valid for this request.</p> <p>This exceptions means one of the following:</p> <ul> <li> <p>The key state of the KMS key is not compatible with the operation. </p> <p>To find the key state, use the <a>DescribeKey</a> operation. For more information about which key states are compatible with each KMS operation, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html\">Key states of KMS keys</a> in the <i> <i>Key Management Service Developer Guide</i> </i>.</p> </li> <li> <p>For cryptographic operations on KMS keys in custom key stores, this exception represents a general failure with many possible causes. To identify the cause, see the error message that accompanies the exception.</p> </li> </ul>
            capo_kms.errors.limit_exceeded_exception.LimitExceededException: <p>The request was rejected because a length constraint or quota was exceeded. For more information, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/limits.html\">Quotas</a> in the <i>Key Management Service Developer Guide</i>.</p>
            capo_kms.errors.not_found_exception.NotFoundException: <p>The request was rejected because the specified entity or resource could not be found.</p>
            capo_kms.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        Examples:
            ...
            >>> await client.create_alias(alias_name='alias/ExampleAlias', target_key_id='1234abcd-12ab-34cd-56ef-1234567890ab')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.create_alias_request.CreateAliasRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_kms._operations.trent_service.create_alias

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.create_alias.async_create_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_custom_key_store(
        self,
        custom_key_store_name: "capo_kms.types.custom_key_store_name_type.CustomKeyStoreNameType",
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        ...
        key_store_password: Optional[
            "capo_kms.types.key_store_password_type.KeyStorePasswordType"
        ] = None,
        custom_key_store_type: Optional[
            "capo_kms.types.custom_key_store_type.CustomKeyStoreType"
        ] = None,
        xks_proxy_uri_endpoint: Optional[
            "capo_kms.types.xks_proxy_uri_endpoint_type.XksProxyUriEndpointType"
        ] = None,
        xks_proxy_uri_path: Optional[
            "capo_kms.types.xks_proxy_uri_path_type.XksProxyUriPathType"
        ] = None,
        xks_proxy_vpc_endpoint_service_name: Optional[
            "capo_kms.types.xks_proxy_vpc_endpoint_service_name_type.XksProxyVpcEndpointServiceNameType"
        ] = None,
        xks_proxy_vpc_endpoint_service_owner: Optional[
            "capo_kms.types.account_id_type.AccountIdType"
        ] = None,
        xks_proxy_authentication_credential: Optional[
            "capo_kms.types.xks_proxy_authentication_credential_type.XksProxyAuthenticationCredentialType"
        ] = None,
        xks_proxy_connectivity: Optional[
            "capo_kms.types.xks_proxy_connectivity_type.XksProxyConnectivityType"
        ] = None,
    ) -> "capo_kms.types.create_custom_key_store_response.CreateCustomKeyStoreResponse":
        ...
        Examples:
            ...
            >>> await client.create_custom_key_store(custom_key_store_name='ExampleKeyStore', cloud_hsm_cluster_id='cluster-234abcdefABC', trust_anchor_certificate='<certificate-goes-here>', key_store_password='kmsPswd')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.create_custom_key_store_request.CreateCustomKeyStoreRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.create_custom_key_store_response.CreateCustomKeyStoreResponse"
        ]:
            import capo_kms._operations.trent_service.create_custom_key_store

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.create_custom_key_store.async_create_custom_key_store(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_grant(
        ...
        *,
        ...
        grantee_principal: Optional[
            "capo_kms.types.principal_id_type.PrincipalIdType"
        ] = None,
        retiring_principal: Optional[
            "capo_kms.types.principal_id_type.PrincipalIdType"
        ] = None,
        constraints: Optional[
            "capo_kms.types.grant_constraints.GrantConstraints"
        ] = None,
        grant_tokens: Optional["capo_kms.types.grant_token_list.GrantTokenList"] = None,
        name: Optional["capo_kms.types.grant_name_type.GrantNameType"] = None,
        dry_run: Optional[
        ...
        Raises:
            capo_kms.errors.dependency_timeout_exception.DependencyTimeoutException: <p>The system timed out while trying to fulfill the request. You can retry the request.</p>
            capo_kms.errors.disabled_exception.DisabledException: <p>The request was rejected because the specified KMS key is not enabled.</p>
            capo_kms.errors.dry_run_operation_exception.DryRunOperationException: <p> The request was rejected because the DryRun parameter was specified. </p>
            capo_kms.errors.invalid_arn_exception.InvalidArnException: <p>The request was rejected because a specified ARN, or an ARN in a key policy, is not valid.</p>
            capo_kms.errors.invalid_grant_token_exception.InvalidGrantTokenException: <p>The request was rejected because the specified grant token is not valid.</p>
            capo_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            capo_kms.errors.kms_invalid_state_exception.KMSInvalidStateException: <p>The request was rejected because the state of the specified resource is not valid for this request.</p> <p>This exceptions means one of the following:</p> <ul> <li> <p>The key state of the KMS key is not compatible with the operation. </p> <p>To find the key state, use the <a>DescribeKey</a> operation. For more information about which key states are compatible with each KMS operation, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html\">Key states of KMS keys</a> in the <i> <i>Key Management Service Developer Guide</i> </i>.</p> </li> <li> <p>For cryptographic operations on KMS keys in custom key stores, this exception represents a general failure with many possible causes. To identify the cause, see the error message that accompanies the exception.</p> </li> </ul>
            capo_kms.errors.limit_exceeded_exception.LimitExceededException: <p>The request was rejected because a length constraint or quota was exceeded. For more information, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/limits.html\">Quotas</a> in the <i>Key Management Service Developer Guide</i>.</p>
            capo_kms.errors.not_found_exception.NotFoundException: <p>The request was rejected because the specified entity or resource could not be found.</p>
        ...
        Examples:
            ...
            >>> await client.create_grant(key_id='arn:aws:kms:us-east-2:444455556666:key/1234abcd-12ab-34cd-56ef-1234567890ab', grantee_principal='arn:aws:iam::111122223333:role/ExampleRole', operations=['Encrypt', 'Decrypt'])
            ...
            >>> await client.create_grant(key_id='arn:aws:kms:us-east-2:444455556666:key/1234abcd-12ab-34cd-56ef-1234567890ab', grantee_service_principal='service-name.amazonaws.com', retiring_service_principal='service-name.amazonaws.com', operations=['Encrypt', 'Decrypt', 'GenerateDataKey', 'DescribeKey'], constraints={'SourceArn': 'arn:aws:dynamodb:us-east-2:444455556666:table/ExampleTable'})
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.create_grant_request.CreateGrantRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.create_grant_response.CreateGrantResponse"
        ]:
            import capo_kms._operations.trent_service.create_grant

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.create_grant.async_create_grant(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_key(
        ...
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        policy: Optional["capo_kms.types.policy_type.PolicyType"] = None,
        description: Optional["capo_kms.types.description_type.DescriptionType"] = None,
        key_usage: Optional["capo_kms.types.key_usage_type.KeyUsageType"] = None,
        customer_master_key_spec: Optional[
            "capo_kms.types.customer_master_key_spec.CustomerMasterKeySpec"
        ] = None,
        key_spec: Optional["capo_kms.types.key_spec.KeySpec"] = None,
        origin: Optional["capo_kms.types.origin_type.OriginType"] = None,
        ...
        bypass_policy_lockout_safety_check: Optional[
            "capo_kms.types.boolean_type.BooleanType"
        ] = None,
        tags: Optional["capo_kms.types.tag_list.TagList"] = None,
        multi_region: Optional[
            "capo_kms.types.nullable_boolean_type.NullableBooleanType"
        ] = None,
        xks_key_id: Optional["capo_kms.types.xks_key_id_type.XksKeyIdType"] = None,
    ) -> "capo_kms.types.create_key_response.CreateKeyResponse":
        ...
        Raises:
            ...
            capo_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            capo_kms.errors.limit_exceeded_exception.LimitExceededException: <p>The request was rejected because a length constraint or quota was exceeded. For more information, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/limits.html\">Quotas</a> in the <i>Key Management Service Developer Guide</i>.</p>
            capo_kms.errors.malformed_policy_document_exception.MalformedPolicyDocumentException: <p>The request was rejected because the specified policy is not syntactically or semantically correct.</p>
            capo_kms.errors.tag_exception.TagException: <p>The request was rejected because one or more tags are not valid.</p>
            capo_kms.errors.unsupported_operation_exception.UnsupportedOperationException: <p>The request was rejected because a specified parameter is not supported or a specified resource is not valid for this operation.</p>
            capo_kms.errors.xks_key_already_in_use_exception.XksKeyAlreadyInUseException: <p>The request was rejected because the (<code>XksKeyId</code>) is already associated with another KMS key in this external key store. Each KMS key in an external key store must be associated with a different external key.</p>
            capo_kms.errors.xks_key_invalid_configuration_exception.XksKeyInvalidConfigurationException: <p>The request was rejected because the external key specified by the <code>XksKeyId</code> parameter did not meet the configuration requirements for an external key store.</p> <p>The external key must be an AES-256 symmetric key that is enabled and performs encryption and decryption.</p>
            capo_kms.errors.xks_key_not_found_exception.XksKeyNotFoundException: <p>The request was rejected because the external key store proxy could not find the external key. This exception is thrown when the value of the <code>XksKeyId</code> parameter doesn't identify a key in the external key manager associated with the external key proxy.</p> <p>Verify that the <code>XksKeyId</code> represents an existing key in the external key manager. Use the key identifier that the external key store proxy uses to identify the key. For details, see the documentation provided with your external key store proxy or key manager.</p>
            capo_kms.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.create_key_request.CreateKeyRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.create_key_response.CreateKeyResponse"
        ]:
            import capo_kms._operations.trent_service.create_key

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.create_key.async_create_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def decrypt(
        ...
        *,
        ...
        grant_tokens: Optional["capo_kms.types.grant_token_list.GrantTokenList"] = None,
        key_id: Optional["capo_kms.types.key_id_type.KeyIdType"] = None,
        encryption_algorithm: Optional[
            "capo_kms.types.encryption_algorithm_spec.EncryptionAlgorithmSpec"
        ] = None,
        recipient: Optional["capo_kms.types.recipient_info.RecipientInfo"] = None,
        dry_run: Optional[
            "capo_kms.types.nullable_boolean_type.NullableBooleanType"
        ] = None,
    ...
    ) -> "capo_kms.types.decrypt_response.DecryptResponse":
        ...
        Examples:
            ...
            >>> await client.decrypt(ciphertext_blob='<binary data>', key_id='0987dcba-09fe-87dc-65ba-ab0987654321', encryption_algorithm='RSAES_OAEP_SHA_256')
            ...
            >>> await client.decrypt(ciphertext_blob='<binary data>', key_id='arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.decrypt_request.DecryptRequest]",
        ) -> AsyncOperationResponse["capo_kms.types.decrypt_response.DecryptResponse"]:
            import capo_kms._operations.trent_service.decrypt

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.decrypt.async_decrypt(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_alias(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_alias(alias_name='alias/ExampleAlias')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.delete_alias_request.DeleteAliasRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_kms._operations.trent_service.delete_alias

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.delete_alias.async_delete_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_custom_key_store(
        ...
        *,
        ...
        Raises:
            capo_kms.errors.custom_key_store_has_cm_ks_exception.CustomKeyStoreHasCMKsException: <p>The request was rejected because the custom key store contains KMS keys. After verifying that you do not need to use the KMS keys, use the <a>ScheduleKeyDeletion</a> operation to delete the KMS keys. After they are deleted, you can delete the custom key store.</p>
            capo_kms.errors.custom_key_store_invalid_state_exception.CustomKeyStoreInvalidStateException: <p>The request was rejected because of the <code>ConnectionState</code> of the custom key store. To get the <code>ConnectionState</code> of a custom key store, use the <a>DescribeCustomKeyStores</a> operation.</p> <p>This exception is thrown under the following conditions:</p> <ul> <li> <p>You requested the <a>ConnectCustomKeyStore</a> operation on a custom key store with a <code>ConnectionState</code> of <code>DISCONNECTING</code> or <code>FAILED</code>. This operation is valid for all other <code>ConnectionState</code> values. To reconnect a custom key store in a <code>FAILED</code> state, disconnect it (<a>DisconnectCustomKeyStore</a>), then connect it (<code>ConnectCustomKeyStore</code>).</p> </li> <li> <p>You requested the <a>CreateKey</a> operation in a custom key store that is not connected. This operations is valid only when the custom key store <code>ConnectionState</code> is <code>CONNECTED</code>.</p> </li> <li> <p>You requested the <a>DisconnectCustomKeyStore</a> operation on a custom key store with a <code>ConnectionState</code> of <code>DISCONNECTING</code> or <code>DISCONNECTED</code>. This operation is valid for all other <code>ConnectionState</code> values.</p> </li> <li> <p>You requested the <a>UpdateCustomKeyStore</a> or <a>DeleteCustomKeyStore</a> operation on a custom key store that is not disconnected. <code>UpdateCustomKeyStore</code> can be called on a custom key store in the <code>CONNECTED</code> state only to update <code>NewCustomKeyStoreName</code>. For all other properties, the custom key store <code>ConnectionState</code> must be <code>DISCONNECTED</code>.</p> </li> <li> <p>You requested the <a>GenerateRandom</a> operation in an CloudHSM key store that is not connected. This operation is valid only when the CloudHSM key store <code>ConnectionState</code> is <code>CONNECTED</code>. </p> </li> </ul>
            capo_kms.errors.custom_key_store_not_found_exception.CustomKeyStoreNotFoundException: <p>The request was rejected because KMS cannot find a custom key store with the specified key store name or ID.</p>
            capo_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            capo_kms.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        Examples:
            ...
            >>> await client.delete_custom_key_store(custom_key_store_id='cks-1234567890abcdef0')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.delete_custom_key_store_request.DeleteCustomKeyStoreRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.delete_custom_key_store_response.DeleteCustomKeyStoreResponse"
        ]:
            import capo_kms._operations.trent_service.delete_custom_key_store

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.delete_custom_key_store.async_delete_custom_key_store(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_imported_key_material(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_imported_key_material(key_id='1234abcd-12ab-34cd-56ef-1234567890ab', key_material_id='0b7fd7ddbac6eef27907413567cad8c810e2883dc8a7534067a82ee1142fc1e6')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.delete_imported_key_material_request.DeleteImportedKeyMaterialRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.delete_imported_key_material_response.DeleteImportedKeyMaterialResponse"
        ]:
            import capo_kms._operations.trent_service.delete_imported_key_material

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.delete_imported_key_material.async_delete_imported_key_material(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def derive_shared_secret(
        self,
        key_id: "capo_kms.types.key_id_type.KeyIdType",
        key_agreement_algorithm: "capo_kms.types.key_agreement_algorithm_spec.KeyAgreementAlgorithmSpec",
        public_key: "capo_kms.types.public_key_type.PublicKeyType",
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        grant_tokens: Optional["capo_kms.types.grant_token_list.GrantTokenList"] = None,
        dry_run: Optional[
        ...
        Examples:
            ...
            >>> await client.derive_shared_secret(key_id='1234abcd-12ab-34cd-56ef-1234567890ab', key_agreement_algorithm='ECDH', public_key='MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAvH3Yj0wbkLEpUl95Cv1cJVjsVNSjwGq3tCLnzXfhVwVvmzGN8pYj3U8nKwgouaHbBWNJYjP5VutbbkKS4Kv4GojwZBJyHN17kmxo8yTjRmjR15SKIQ8cqRA2uaERMLnpztIXdZp232PQPbWGxDyXYJ0aJ5EFSag')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.derive_shared_secret_request.DeriveSharedSecretRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.derive_shared_secret_response.DeriveSharedSecretResponse"
        ]:
            import capo_kms._operations.trent_service.derive_shared_secret

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.derive_shared_secret.async_derive_shared_secret(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_custom_key_stores(
        ...
        *,
        ...
        Raises:
            capo_kms.errors.custom_key_store_not_found_exception.CustomKeyStoreNotFoundException: <p>The request was rejected because KMS cannot find a custom key store with the specified key store name or ID.</p>
            capo_kms.errors.invalid_marker_exception.InvalidMarkerException: <p>The request was rejected because the marker that specifies where pagination should next begin is not valid.</p>
            capo_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            capo_kms.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        Examples:
            ...
            >>> await client.describe_custom_key_stores()
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.describe_custom_key_stores_request.DescribeCustomKeyStoresRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.describe_custom_key_stores_response.DescribeCustomKeyStoresResponse"
        ]:
            import capo_kms._operations.trent_service.describe_custom_key_stores

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.describe_custom_key_stores.async_describe_custom_key_stores(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_custom_key_stores(
        ...
        *,
        ...
        limit: Optional["capo_kms.types.limit_type.LimitType"] = None,
        marker: Optional["capo_kms.types.marker_type.MarkerType"] = None,
    ) -> "AsyncIterator[capo_kms.types.custom_key_stores_list_entry.CustomKeyStoresListEntry]":
        _token = marker
        while True:
            _response = await self.describe_custom_key_stores(
    ...
    async def describe_key(
        ...
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        grant_tokens: Optional["capo_kms.types.grant_token_list.GrantTokenList"] = None,
    ) -> "capo_kms.types.describe_key_response.DescribeKeyResponse":
        ...
        Examples:
            ...
            >>> await client.describe_key(key_id='arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab')
            ...
            >>> await client.describe_key(key_id='arn:aws:kms:ap-northeast-1:111122223333:key/mrk-1234abcd12ab34cd56ef1234567890ab')
            ...
            >>> await client.describe_key(key_id='1234abcd-12ab-34cd-56ef-1234567890ab')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.describe_key_request.DescribeKeyRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.describe_key_response.DescribeKeyResponse"
        ]:
            import capo_kms._operations.trent_service.describe_key

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.describe_key.async_describe_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_key(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.disable_key(key_id='1234abcd-12ab-34cd-56ef-1234567890ab')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.disable_key_request.DisableKeyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_kms._operations.trent_service.disable_key

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.disable_key.async_disable_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_key_rotation(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.disable_key_rotation(key_id='1234abcd-12ab-34cd-56ef-1234567890ab')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.disable_key_rotation_request.DisableKeyRotationRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_kms._operations.trent_service.disable_key_rotation

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.disable_key_rotation.async_disable_key_rotation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disconnect_custom_key_store(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.disconnect_custom_key_store(custom_key_store_id='cks-1234567890abcdef0')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.disconnect_custom_key_store_request.DisconnectCustomKeyStoreRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.disconnect_custom_key_store_response.DisconnectCustomKeyStoreResponse"
        ]:
            import capo_kms._operations.trent_service.disconnect_custom_key_store

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.disconnect_custom_key_store.async_disconnect_custom_key_store(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_key(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.enable_key(key_id='1234abcd-12ab-34cd-56ef-1234567890ab')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.enable_key_request.EnableKeyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_kms._operations.trent_service.enable_key

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.enable_key.async_enable_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_key_rotation(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.enable_key_rotation(key_id='1234abcd-12ab-34cd-56ef-1234567890ab', rotation_period_in_days=365)
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.enable_key_rotation_request.EnableKeyRotationRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_kms._operations.trent_service.enable_key_rotation

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.enable_key_rotation.async_enable_key_rotation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def encrypt(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.encrypt(key_id='1234abcd-12ab-34cd-56ef-1234567890ab', plaintext='<binary data>')
            ...
            >>> await client.encrypt(key_id='0987dcba-09fe-87dc-65ba-ab0987654321', plaintext='<binary data>', encryption_algorithm='RSAES_OAEP_SHA_256')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.encrypt_request.EncryptRequest]",
        ) -> AsyncOperationResponse["capo_kms.types.encrypt_response.EncryptResponse"]:
            import capo_kms._operations.trent_service.encrypt

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.encrypt.async_encrypt(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_data_key(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.generate_data_key(key_id='alias/ExampleAlias', key_spec='AES_256')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.generate_data_key_request.GenerateDataKeyRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.generate_data_key_response.GenerateDataKeyResponse"
        ]:
            import capo_kms._operations.trent_service.generate_data_key

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.generate_data_key.async_generate_data_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_data_key_pair(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.generate_data_key_pair(key_id='arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab', key_pair_spec='RSA_3072')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.generate_data_key_pair_request.GenerateDataKeyPairRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.generate_data_key_pair_response.GenerateDataKeyPairResponse"
        ]:
            import capo_kms._operations.trent_service.generate_data_key_pair

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.generate_data_key_pair.async_generate_data_key_pair(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_data_key_pair_without_plaintext(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.generate_data_key_pair_without_plaintext(key_id='arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab', key_pair_spec='ECC_NIST_P521')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.generate_data_key_pair_without_plaintext_request.GenerateDataKeyPairWithoutPlaintextRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.generate_data_key_pair_without_plaintext_response.GenerateDataKeyPairWithoutPlaintextResponse"
        ]:
            import capo_kms._operations.trent_service.generate_data_key_pair_without_plaintext

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.generate_data_key_pair_without_plaintext.async_generate_data_key_pair_without_plaintext(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_data_key_without_plaintext(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.generate_data_key_without_plaintext(key_id='alias/ExampleAlias', key_spec='AES_256')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.generate_data_key_without_plaintext_request.GenerateDataKeyWithoutPlaintextRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.generate_data_key_without_plaintext_response.GenerateDataKeyWithoutPlaintextResponse"
        ]:
            import capo_kms._operations.trent_service.generate_data_key_without_plaintext

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.generate_data_key_without_plaintext.async_generate_data_key_without_plaintext(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_mac(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.generate_mac(message='Hello World', key_id='1234abcd-12ab-34cd-56ef-1234567890ab', mac_algorithm='HMAC_SHA_384')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.generate_mac_request.GenerateMacRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.generate_mac_response.GenerateMacResponse"
        ]:
            import capo_kms._operations.trent_service.generate_mac

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.generate_mac.async_generate_mac(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_random(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.generate_random(number_of_bytes=32)
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.generate_random_request.GenerateRandomRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.generate_random_response.GenerateRandomResponse"
        ]:
            import capo_kms._operations.trent_service.generate_random

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.generate_random.async_generate_random(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_key_last_usage(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_key_last_usage(key_id='1234abcd-12ab-34cd-56ef-1234567890ab')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.get_key_last_usage_request.GetKeyLastUsageRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.get_key_last_usage_response.GetKeyLastUsageResponse"
        ]:
            import capo_kms._operations.trent_service.get_key_last_usage

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.get_key_last_usage.async_get_key_last_usage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_key_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_key_policy(key_id='1234abcd-12ab-34cd-56ef-1234567890ab', policy_name='default')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.get_key_policy_request.GetKeyPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.get_key_policy_response.GetKeyPolicyResponse"
        ]:
            import capo_kms._operations.trent_service.get_key_policy

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.get_key_policy.async_get_key_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_key_rotation_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.get_key_rotation_status_request.GetKeyRotationStatusRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.get_key_rotation_status_response.GetKeyRotationStatusResponse"
        ]:
            import capo_kms._operations.trent_service.get_key_rotation_status

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.get_key_rotation_status.async_get_key_rotation_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_parameters_for_import(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.get_parameters_for_import_request.GetParametersForImportRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.get_parameters_for_import_response.GetParametersForImportResponse"
        ]:
            import capo_kms._operations.trent_service.get_parameters_for_import

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.get_parameters_for_import.async_get_parameters_for_import(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_public_key(
        ...
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        grant_tokens: Optional["capo_kms.types.grant_token_list.GrantTokenList"] = None,
    ) -> "capo_kms.types.get_public_key_response.GetPublicKeyResponse":
        ...
        Examples:
            ...
            >>> await client.get_public_key(key_id='arn:aws:kms:us-west-2:111122223333:key/0987dcba-09fe-87dc-65ba-ab0987654321')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.get_public_key_request.GetPublicKeyRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.get_public_key_response.GetPublicKeyResponse"
        ]:
            import capo_kms._operations.trent_service.get_public_key

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.get_public_key.async_get_public_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def import_key_material(
        self,
        key_id: "capo_kms.types.key_id_type.KeyIdType",
        import_token: "capo_kms.types.ciphertext_type.CiphertextType",
        encrypted_key_material: "capo_kms.types.ciphertext_type.CiphertextType",
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        valid_to: Optional["capo_kms.types.date_type.DateType"] = None,
        expiration_model: Optional[
            "capo_kms.types.expiration_model_type.ExpirationModelType"
        ] = None,
        import_type: Optional["capo_kms.types.import_type.ImportType"] = None,
        ...
        Raises:
            capo_kms.errors.dependency_timeout_exception.DependencyTimeoutException: <p>The system timed out while trying to fulfill the request. You can retry the request.</p>
            capo_kms.errors.expired_import_token_exception.ExpiredImportTokenException: <p>The request was rejected because the specified import token is expired. Use <a>GetParametersForImport</a> to get a new import token and public key, use the new public key to encrypt the key material, and then try the request again.</p>
            capo_kms.errors.incorrect_key_material_exception.IncorrectKeyMaterialException: <p>The request was rejected because the key material in the request is, expired, invalid, or does not meet expectations. For example, it is not the same key material that was previously imported or KMS expected new key material but the key material being imported is already associated with the KMS key.</p>
            capo_kms.errors.invalid_arn_exception.InvalidArnException: <p>The request was rejected because a specified ARN, or an ARN in a key policy, is not valid.</p>
            capo_kms.errors.invalid_ciphertext_exception.InvalidCiphertextException: <p>From the <a>Decrypt</a> or <a>ReEncrypt</a> operation, the request was rejected because the specified ciphertext, or additional authenticated data incorporated into the ciphertext, such as the encryption context, is corrupted, missing, or otherwise invalid.</p> <p>From the <a>ImportKeyMaterial</a> operation, the request was rejected because KMS could not decrypt the encrypted (wrapped) key material. </p>
            capo_kms.errors.invalid_import_token_exception.InvalidImportTokenException: <p>The request was rejected because the provided import token is invalid or is associated with a different KMS key.</p>
            capo_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            capo_kms.errors.kms_invalid_state_exception.KMSInvalidStateException: <p>The request was rejected because the state of the specified resource is not valid for this request.</p> <p>This exceptions means one of the following:</p> <ul> <li> <p>The key state of the KMS key is not compatible with the operation. </p> <p>To find the key state, use the <a>DescribeKey</a> operation. For more information about which key states are compatible with each KMS operation, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html\">Key states of KMS keys</a> in the <i> <i>Key Management Service Developer Guide</i> </i>.</p> </li> <li> <p>For cryptographic operations on KMS keys in custom key stores, this exception represents a general failure with many possible causes. To identify the cause, see the error message that accompanies the exception.</p> </li> </ul>
            capo_kms.errors.not_found_exception.NotFoundException: <p>The request was rejected because the specified entity or resource could not be found.</p>
            capo_kms.errors.unsupported_operation_exception.UnsupportedOperationException: <p>The request was rejected because a specified parameter is not supported or a specified resource is not valid for this operation.</p>
        ...
        Examples:
            ...
            >>> await client.import_key_material(key_id='1234abcd-12ab-34cd-56ef-1234567890ab', import_token='<binary data>', encrypted_key_material='<binary data>', expiration_model='KEY_MATERIAL_DOES_NOT_EXPIRE')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.import_key_material_request.ImportKeyMaterialRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.import_key_material_response.ImportKeyMaterialResponse"
        ]:
            import capo_kms._operations.trent_service.import_key_material

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.import_key_material.async_import_key_material(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_aliases(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.list_aliases_request.ListAliasesRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.list_aliases_response.ListAliasesResponse"
        ]:
            import capo_kms._operations.trent_service.list_aliases

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.list_aliases.async_list_aliases(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_aliases(
        ...
        *,
        ...
        limit: Optional["capo_kms.types.limit_type.LimitType"] = None,
        marker: Optional["capo_kms.types.marker_type.MarkerType"] = None,
    ) -> "AsyncIterator[capo_kms.types.alias_list_entry.AliasListEntry]":
        _token = marker
        while True:
    ...
    async def list_grants(
        ...
        *,
        ...
        limit: Optional["capo_kms.types.limit_type.LimitType"] = None,
        marker: Optional["capo_kms.types.marker_type.MarkerType"] = None,
        grant_id: Optional["capo_kms.types.grant_id_type.GrantIdType"] = None,
        grantee_principal: Optional[
            "capo_kms.types.principal_id_type.PrincipalIdType"
        ] = None,
        grantee_service_principal: Optional[
        ...
        Raises:
            capo_kms.errors.dependency_timeout_exception.DependencyTimeoutException: <p>The system timed out while trying to fulfill the request. You can retry the request.</p>
            capo_kms.errors.invalid_arn_exception.InvalidArnException: <p>The request was rejected because a specified ARN, or an ARN in a key policy, is not valid.</p>
            capo_kms.errors.invalid_grant_id_exception.InvalidGrantIdException: <p>The request was rejected because the specified <code>GrantId</code> is not valid.</p>
            capo_kms.errors.invalid_marker_exception.InvalidMarkerException: <p>The request was rejected because the marker that specifies where pagination should next begin is not valid.</p>
            capo_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            capo_kms.errors.kms_invalid_state_exception.KMSInvalidStateException: <p>The request was rejected because the state of the specified resource is not valid for this request.</p> <p>This exceptions means one of the following:</p> <ul> <li> <p>The key state of the KMS key is not compatible with the operation. </p> <p>To find the key state, use the <a>DescribeKey</a> operation. For more information about which key states are compatible with each KMS operation, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html\">Key states of KMS keys</a> in the <i> <i>Key Management Service Developer Guide</i> </i>.</p> </li> <li> <p>For cryptographic operations on KMS keys in custom key stores, this exception represents a general failure with many possible causes. To identify the cause, see the error message that accompanies the exception.</p> </li> </ul>
            capo_kms.errors.not_found_exception.NotFoundException: <p>The request was rejected because the specified entity or resource could not be found.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.list_grants_request.ListGrantsRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.list_grants_response.ListGrantsResponse"
        ]:
            import capo_kms._operations.trent_service.list_grants

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.list_grants.async_list_grants(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_kms.types.grant_list_entry.GrantListEntry]":
        _token = marker
        while True:
            _response = await self.list_grants(
                key_id,
                config_overrides=config_overrides,
                limit=limit,
                marker=_token,
    ...
    async def list_key_policies(
        ...
        *,
        ...
        limit: Optional["capo_kms.types.limit_type.LimitType"] = None,
        marker: Optional["capo_kms.types.marker_type.MarkerType"] = None,
    ) -> "capo_kms.types.list_key_policies_response.ListKeyPoliciesResponse":
        r"""<p>Gets the names of the key policies that are attached to a KMS key. This operation is designed to get policy names that you can use in a <a>GetKeyPolicy</a> operation. However, the only valid policy name is <code>default</code>. </p> <p> <b>Cross-account use</b>: No. You cannot perform this operation on a KMS key in a different Amazon Web Services account.</p> <p> <b>Required permissions</b>: <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/kms-api-permissions-reference.html\">kms:ListKeyPolicies</a> (key policy)</p> <p> <b>Related operations:</b> </p> <ul> <li> <p> <a>GetKeyPolicy</a> </p> </li> <li> <p> <a href=\"https://docs.aws.amazon.com/kms/latest/APIReference/API_PutKeyPolicy.html\">PutKeyPolicy</a> </p> </li> </ul> <p> <b>Eventual consistency</b>: The KMS API follows an eventual consistency model. For more information, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/accessing-kms.html#programming-eventual-consistency\">KMS eventual consistency</a>.</p>
        ...
        Examples:
            ...
            >>> await client.list_key_policies(key_id='1234abcd-12ab-34cd-56ef-1234567890ab')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.list_key_policies_request.ListKeyPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.list_key_policies_response.ListKeyPoliciesResponse"
        ]:
            import capo_kms._operations.trent_service.list_key_policies

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.list_key_policies.async_list_key_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_key_policies(
        ...
        *,
        ...
        limit: Optional["capo_kms.types.limit_type.LimitType"] = None,
        marker: Optional["capo_kms.types.marker_type.MarkerType"] = None,
    ) -> "AsyncIterator[capo_kms.types.policy_name_type.PolicyNameType]":
        _token = marker
        while True:
            _response = await self.list_key_policies(
                key_id,
                config_overrides=config_overrides,
                limit=limit,
                marker=_token,
    ...
    async def list_key_rotations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.list_key_rotations_request.ListKeyRotationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.list_key_rotations_response.ListKeyRotationsResponse"
        ]:
            import capo_kms._operations.trent_service.list_key_rotations

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.list_key_rotations.async_list_key_rotations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_key_rotations(
        ...
        *,
        ...
        limit: Optional["capo_kms.types.limit_type.LimitType"] = None,
        marker: Optional["capo_kms.types.marker_type.MarkerType"] = None,
    ) -> "AsyncIterator[capo_kms.types.rotations_list_entry.RotationsListEntry]":
        _token = marker
        while True:
            _response = await self.list_key_rotations(
                key_id,
                config_overrides=config_overrides,
    ...
    async def list_keys(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.list_keys_request.ListKeysRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.list_keys_response.ListKeysResponse"
        ]:
            import capo_kms._operations.trent_service.list_keys

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.list_keys.async_list_keys(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_keys(
        ...
        *,
        ...
        limit: Optional["capo_kms.types.limit_type.LimitType"] = None,
        marker: Optional["capo_kms.types.marker_type.MarkerType"] = None,
    ) -> "AsyncIterator[capo_kms.types.key_list_entry.KeyListEntry]":
        _token = marker
        while True:
    ...
    async def list_resource_tags(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_resource_tags(key_id='1234abcd-12ab-34cd-56ef-1234567890ab')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.list_resource_tags_request.ListResourceTagsRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.list_resource_tags_response.ListResourceTagsResponse"
        ]:
            import capo_kms._operations.trent_service.list_resource_tags

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.list_resource_tags.async_list_resource_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_resource_tags(
        ...
        *,
        ...
        limit: Optional["capo_kms.types.limit_type.LimitType"] = None,
        marker: Optional["capo_kms.types.marker_type.MarkerType"] = None,
    ) -> "AsyncIterator[capo_kms.types.tag.Tag]":
        _token = marker
        while True:
            _response = await self.list_resource_tags(
                key_id,
                config_overrides=config_overrides,
                limit=limit,
                marker=_token,
    ...
    async def list_retirable_grants(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.list_retirable_grants_request.ListRetirableGrantsRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.list_grants_response.ListGrantsResponse"
        ]:
            import capo_kms._operations.trent_service.list_retirable_grants

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.list_retirable_grants.async_list_retirable_grants(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_retirable_grants(
        ...
        *,
        ...
        _token = marker
        while True:
            _response = await self.list_retirable_grants(
                config_overrides=config_overrides,
                limit=limit,
                marker=_token,
    ...
    async def put_key_policy(
        self,
        key_id: "capo_kms.types.key_id_type.KeyIdType",
        policy: "capo_kms.types.policy_type.PolicyType",
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        policy_name: Optional["capo_kms.types.policy_name_type.PolicyNameType"] = None,
        bypass_policy_lockout_safety_check: Optional[
        ...
        Examples:
            ...
            >>> await client.put_key_policy(key_id='1234abcd-12ab-34cd-56ef-1234567890ab', policy_name='default', policy='{\n    "Version": "2012-10-17",\n    "Id": "custom-policy-2016-12-07",\n    "Statement": [\n        {\n            "Sid": "Enable IAM User Permissions",\n            "Effect": "Allow",\n            "Principal": {\n                "AWS": "arn:aws:iam::111122223333:root"\n            },\n            "Action": "kms:*",\n            "Resource": "*"\n        },\n        {\n            "Sid": "Allow access for Key Administrators",\n            "Effect": "Allow",\n            "Principal": {\n                "AWS": [\n                    "arn:aws:iam::111122223333:user/ExampleAdminUser",\n                    "arn:aws:iam::111122223333:role/ExampleAdminRole"\n                ]\n            },\n            "Action": [\n                "kms:Create*",\n                "kms:Describe*",\n                "kms:Enable*",\n                "kms:List*",\n                "kms:Put*",\n                "kms:Update*",\n                "kms:Revoke*",\n                "kms:Disable*",\n                "kms:Get*",\n                "kms:Delete*",\n                "kms:ScheduleKeyDeletion",\n                "kms:CancelKeyDeletion"\n            ],\n            "Resource": "*"\n        },\n        {\n            "Sid": "Allow use of the key",\n            "Effect": "Allow",\n            "Principal": {\n                "AWS": "arn:aws:iam::111122223333:role/ExamplePowerUserRole"\n            },\n            "Action": [\n                "kms:Encrypt",\n                "kms:Decrypt",\n                "kms:ReEncrypt*",\n                "kms:GenerateDataKey*",\n                "kms:DescribeKey"\n            ],\n            "Resource": "*"\n        },\n        {\n            "Sid": "Allow attachment of persistent resources",\n            "Effect": "Allow",\n            "Principal": {\n                "AWS": "arn:aws:iam::111122223333:role/ExamplePowerUserRole"\n            },\n            "Action": [\n                "kms:CreateGrant",\n                "kms:ListGrants",\n                "kms:RevokeGrant"\n            ],\n            "Resource": "*",\n            "Condition": {\n                "Bool": {\n                    "kms:GrantIsForAWSResource": "true"\n                }\n            }\n        }\n    ]\n}\n')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.put_key_policy_request.PutKeyPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_kms._operations.trent_service.put_key_policy

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.put_key_policy.async_put_key_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def re_encrypt(
        ...
        *,
        ...
        source_key_id: Optional["capo_kms.types.key_id_type.KeyIdType"] = None,
    ...
    ) -> "capo_kms.types.re_encrypt_response.ReEncryptResponse":
        ...
        Examples:
            ...
            >>> await client.re_encrypt(ciphertext_blob='<binary data>', destination_key_id='0987dcba-09fe-87dc-65ba-ab0987654321')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.re_encrypt_request.ReEncryptRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.re_encrypt_response.ReEncryptResponse"
        ]:
            import capo_kms._operations.trent_service.re_encrypt

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.re_encrypt.async_re_encrypt(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def replicate_key(
        self,
        key_id: "capo_kms.types.key_id_type.KeyIdType",
        replica_region: "capo_kms.types.region_type.RegionType",
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        policy: Optional["capo_kms.types.policy_type.PolicyType"] = None,
        bypass_policy_lockout_safety_check: Optional[
        ...
        Examples:
            ...
            >>> await client.replicate_key(key_id='arn:aws:kms:us-east-1:111122223333:key/mrk-1234abcd12ab34cd56ef1234567890ab', replica_region='us-west-2')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.replicate_key_request.ReplicateKeyRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.replicate_key_response.ReplicateKeyResponse"
        ]:
            import capo_kms._operations.trent_service.replicate_key

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.replicate_key.async_replicate_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def retire_grant(
        ...
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        grant_token: Optional["capo_kms.types.grant_token_type.GrantTokenType"] = None,
        key_id: Optional["capo_kms.types.key_id_type.KeyIdType"] = None,
        grant_id: Optional["capo_kms.types.grant_id_type.GrantIdType"] = None,
        dry_run: Optional[
            "capo_kms.types.nullable_boolean_type.NullableBooleanType"
        ...
        Examples:
            ...
            >>> await client.retire_grant(key_id='arn:aws:kms:us-east-2:444455556666:key/1234abcd-12ab-34cd-56ef-1234567890ab', grant_id='0c237476b39f8bc44e45212e08498fbe3151305030726c0590dd8d3e9f3d6a60')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.retire_grant_request.RetireGrantRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_kms._operations.trent_service.retire_grant

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.retire_grant.async_retire_grant(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def revoke_grant(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.revoke_grant(key_id='1234abcd-12ab-34cd-56ef-1234567890ab', grant_id='0c237476b39f8bc44e45212e08498fbe3151305030726c0590dd8d3e9f3d6a60')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.revoke_grant_request.RevokeGrantRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_kms._operations.trent_service.revoke_grant

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.revoke_grant.async_revoke_grant(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def rotate_key_on_demand(
        ...
        *,
        ...
        Raises:
            capo_kms.errors.conflict_exception.ConflictException: <p>The request was rejected because an automatic rotation of this key is currently in progress or scheduled to begin within the next 20 minutes. </p>
            capo_kms.errors.dependency_timeout_exception.DependencyTimeoutException: <p>The system timed out while trying to fulfill the request. You can retry the request.</p>
            capo_kms.errors.disabled_exception.DisabledException: <p>The request was rejected because the specified KMS key is not enabled.</p>
            capo_kms.errors.invalid_arn_exception.InvalidArnException: <p>The request was rejected because a specified ARN, or an ARN in a key policy, is not valid.</p>
            capo_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
        ...
        Examples:
            ...
            >>> await client.rotate_key_on_demand(key_id='1234abcd-12ab-34cd-56ef-1234567890ab')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.rotate_key_on_demand_request.RotateKeyOnDemandRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.rotate_key_on_demand_response.RotateKeyOnDemandResponse"
        ]:
            import capo_kms._operations.trent_service.rotate_key_on_demand

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.rotate_key_on_demand.async_rotate_key_on_demand(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def schedule_key_deletion(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.schedule_key_deletion_request.ScheduleKeyDeletionRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.schedule_key_deletion_response.ScheduleKeyDeletionResponse"
        ]:
            import capo_kms._operations.trent_service.schedule_key_deletion

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.schedule_key_deletion.async_schedule_key_deletion(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def sign(
        ...
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        message_type: Optional["capo_kms.types.message_type.MessageType"] = None,
        grant_tokens: Optional["capo_kms.types.grant_token_list.GrantTokenList"] = None,
        dry_run: Optional[
            "capo_kms.types.nullable_boolean_type.NullableBooleanType"
        ] = None,
    ) -> "capo_kms.types.sign_response.SignResponse":
        ...
        Examples:
            ...
            >>> await client.sign(key_id='alias/RSA_signing_key', message='<message digest to be signed>', message_type='DIGEST', signing_algorithm='RSASSA_PKCS1_V1_5_SHA_256')
            ...
            >>> await client.sign(key_id='alias/ECC_signing_key', message='<message to be signed>', message_type='RAW', signing_algorithm='ECDSA_SHA_384')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.sign_request.SignRequest]",
        ) -> AsyncOperationResponse["capo_kms.types.sign_response.SignResponse"]:
            import capo_kms._operations.trent_service.sign

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.sign.async_sign(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.tag_resource(key_id='1234abcd-12ab-34cd-56ef-1234567890ab', tags=[{'TagKey': 'Purpose', 'TagValue': 'Test'}])
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_kms._operations.trent_service.tag_resource

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.untag_resource(key_id='1234abcd-12ab-34cd-56ef-1234567890ab', tag_keys=['Purpose', 'CostCenter'])
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_kms._operations.trent_service.untag_resource

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_alias(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_alias(alias_name='alias/ExampleAlias', target_key_id='1234abcd-12ab-34cd-56ef-1234567890ab')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.update_alias_request.UpdateAliasRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_kms._operations.trent_service.update_alias

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.update_alias.async_update_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_custom_key_store(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_custom_key_store(custom_key_store_id='cks-1234567890abcdef0', new_custom_key_store_name='DevelopmentKeys')
            ...
            >>> await client.update_custom_key_store(custom_key_store_id='cks-1234567890abcdef0', key_store_password='ExamplePassword')
            ...
            >>> await client.update_custom_key_store(custom_key_store_id='cks-1234567890abcdef0', xks_proxy_connectivity='VPC_ENDPOINT_SERVICE', xks_proxy_uri_endpoint='https://myproxy-private.xks.example.com', xks_proxy_vpc_endpoint_service_name='com.amazonaws.vpce.us-east-1.vpce-svc-example')
            To edit the proxy URI path of an external key store.
            This example updates the proxy URI path for an external key store

            >>> await client.update_custom_key_store(custom_key_store_id='cks-1234567890abcdef0', xks_proxy_uri_path='/new-path/kms/xks/v1')
            ...
            >>> await client.update_custom_key_store(custom_key_store_id='cks-1234567890abcdef0', cloud_hsm_cluster_id='cluster-234abcdefABC')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.update_custom_key_store_request.UpdateCustomKeyStoreRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.update_custom_key_store_response.UpdateCustomKeyStoreResponse"
        ]:
            import capo_kms._operations.trent_service.update_custom_key_store

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.update_custom_key_store.async_update_custom_key_store(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_key_description(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_key_description(key_id='1234abcd-12ab-34cd-56ef-1234567890ab', description='Example description that indicates the intended use of this KMS key.')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.update_key_description_request.UpdateKeyDescriptionRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_kms._operations.trent_service.update_key_description

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.update_key_description.async_update_key_description(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_primary_region(
        ...
        *,
        ...
        This operation does not return any output. To verify that primary key is changed, use the DescribeKey operation.
                    ...
                    >>> await client.update_primary_region(key_id='arn:aws:kms:us-west-1:111122223333:key/mrk-1234abcd12ab34cd56ef1234567890ab', primary_region='eu-central-1')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.update_primary_region_request.UpdatePrimaryRegionRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_kms._operations.trent_service.update_primary_region

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.update_primary_region.async_update_primary_region(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def verify(
        ...
        *,
        ...
        Raises:
            ...
            capo_kms.errors.key_unavailable_exception.KeyUnavailableException: <p>The request was rejected because the specified KMS key was not available. You can retry the request.</p>
            capo_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            capo_kms.errors.kms_invalid_signature_exception.KMSInvalidSignatureException: <p>The request was rejected because the signature verification failed. Signature verification fails when it cannot confirm that signature was produced by signing the specified message with the specified KMS key and signing algorithm.</p>
            capo_kms.errors.kms_invalid_state_exception.KMSInvalidStateException: <p>The request was rejected because the state of the specified resource is not valid for this request.</p> <p>This exceptions means one of the following:</p> <ul> <li> <p>The key state of the KMS key is not compatible with the operation. </p> <p>To find the key state, use the <a>DescribeKey</a> operation. For more information about which key states are compatible with each KMS operation, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html\">Key states of KMS keys</a> in the <i> <i>Key Management Service Developer Guide</i> </i>.</p> </li> <li> <p>For cryptographic operations on KMS keys in custom key stores, this exception represents a general failure with many possible causes. To identify the cause, see the error message that accompanies the exception.</p> </li> </ul>
            capo_kms.errors.not_found_exception.NotFoundException: <p>The request was rejected because the specified entity or resource could not be found.</p>
            capo_kms.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        Examples:
            ...
            >>> await client.verify(key_id='alias/ECC_signing_key', message='<message to be verified>', message_type='RAW', signature='<binary data>', signing_algorithm='ECDSA_SHA_384')
            ...
            >>> await client.verify(key_id='arn:aws:kms:us-east-2:111122223333:key/0987dcba-09fe-87dc-65ba-ab0987654321', message='<message digest to be verified>', message_type='DIGEST', signature='<binary data>', signing_algorithm='RSASSA_PSS_SHA_512')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.verify_request.VerifyRequest]",
        ) -> AsyncOperationResponse["capo_kms.types.verify_response.VerifyResponse"]:
            import capo_kms._operations.trent_service.verify

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.verify.async_verify(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def verify_mac(
        ...
        *,
        ...
        Raises:
            ...
            capo_kms.errors.key_unavailable_exception.KeyUnavailableException: <p>The request was rejected because the specified KMS key was not available. You can retry the request.</p>
            capo_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            capo_kms.errors.kms_invalid_mac_exception.KMSInvalidMacException: <p>The request was rejected because the HMAC verification failed. HMAC verification fails when the HMAC computed by using the specified message, HMAC KMS key, and MAC algorithm does not match the HMAC specified in the request.</p>
            capo_kms.errors.kms_invalid_state_exception.KMSInvalidStateException: <p>The request was rejected because the state of the specified resource is not valid for this request.</p> <p>This exceptions means one of the following:</p> <ul> <li> <p>The key state of the KMS key is not compatible with the operation. </p> <p>To find the key state, use the <a>DescribeKey</a> operation. For more information about which key states are compatible with each KMS operation, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html\">Key states of KMS keys</a> in the <i> <i>Key Management Service Developer Guide</i> </i>.</p> </li> <li> <p>For cryptographic operations on KMS keys in custom key stores, this exception represents a general failure with many possible causes. To identify the cause, see the error message that accompanies the exception.</p> </li> </ul>
            capo_kms.errors.not_found_exception.NotFoundException: <p>The request was rejected because the specified entity or resource could not be found.</p>
            capo_kms.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        Examples:
            ...
            >>> await client.verify_mac(message='Hello World', key_id='1234abcd-12ab-34cd-56ef-1234567890ab', mac_algorithm='HMAC_SHA_384', mac='<HMAC_TAG>')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_kms.types.verify_mac_request.VerifyMacRequest]",
        ) -> AsyncOperationResponse[
            "capo_kms.types.verify_mac_response.VerifyMacResponse"
        ]:
            import capo_kms._operations.trent_service.verify_mac

            (
                output,
                http_response,
            ) = await capo_kms._operations.trent_service.verify_mac.async_verify_mac(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
