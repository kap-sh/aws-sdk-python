...
def handle_response(
    ...
    out: capo_kms.types.generate_mac_response.GenerateMacResponse = (
        capo_kms.types.generate_mac_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "TrentService.GenerateMac"
    body: bytes | None = json.dumps(
        capo_kms.types.generate_mac_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def generate_mac(
    ...
    input_: capo_kms.types.generate_mac_request.GenerateMacRequest,
) -> tuple[capo_kms.types.generate_mac_response.GenerateMacResponse, zapros.Response]:
