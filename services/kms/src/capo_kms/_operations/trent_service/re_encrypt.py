...
def handle_response(
    ...
    out: capo_kms.types.re_encrypt_response.ReEncryptResponse = (
        capo_kms.types.re_encrypt_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.re_encrypt_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def re_encrypt(
    ...
    input_: capo_kms.types.re_encrypt_request.ReEncryptRequest,
) -> tuple[capo_kms.types.re_encrypt_response.ReEncryptResponse, zapros.Response]:
