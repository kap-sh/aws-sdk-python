...
import capo_kms.errors.kms_invalid_signature_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "KMSInvalidSignatureException":
            raise capo_kms.errors.kms_invalid_signature_exception.KMSInvalidSignatureException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_kms.types.verify_response.VerifyResponse = (
        capo_kms.types.verify_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.verify_request.serialize_aws_json_1_1(input_), allow_nan=False
    ).encode()
...
def verify(
    options: OperationOptions, input_: capo_kms.types.verify_request.VerifyRequest
) -> tuple[capo_kms.types.verify_response.VerifyResponse, zapros.Response]:
...
async def async_verify(
    options: AsyncOperationOptions, input_: capo_kms.types.verify_request.VerifyRequest
) -> tuple[capo_kms.types.verify_response.VerifyResponse, zapros.Response]:
