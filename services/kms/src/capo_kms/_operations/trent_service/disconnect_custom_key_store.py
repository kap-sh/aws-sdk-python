...
def handle_response(
    ...
    out: capo_kms.types.disconnect_custom_key_store_response.DisconnectCustomKeyStoreResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.disconnect_custom_key_store_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
