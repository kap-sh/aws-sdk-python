...
def handle_response(
    ...
    out: capo_kms.types.create_grant_response.CreateGrantResponse = (
        capo_kms.types.create_grant_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.create_grant_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_grant(
    ...
    input_: capo_kms.types.create_grant_request.CreateGrantRequest,
) -> tuple[capo_kms.types.create_grant_response.CreateGrantResponse, zapros.Response]:
