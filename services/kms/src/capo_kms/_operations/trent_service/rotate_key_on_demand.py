...
import capo_kms.errors.conflict_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictException":
            raise capo_kms.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_kms.types.rotate_key_on_demand_response.RotateKeyOnDemandResponse = (
        capo_kms.types.rotate_key_on_demand_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.rotate_key_on_demand_request.serialize_aws_json_1_1(input_)
    ).encode()
