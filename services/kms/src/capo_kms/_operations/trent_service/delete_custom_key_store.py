...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CustomKeyStoreHasCMKsException":
            raise capo_kms.errors.custom_key_store_has_cm_ks_exception.CustomKeyStoreHasCMKsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_kms.types.delete_custom_key_store_response.DeleteCustomKeyStoreResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.delete_custom_key_store_request.serialize_aws_json_1_1(input_)
    ).encode()
