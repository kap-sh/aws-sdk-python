...
def handle_response(
    ...
    out: capo_kms.types.get_key_policy_response.GetKeyPolicyResponse = (
        capo_kms.types.get_key_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.get_key_policy_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_key_policy(
    ...
    capo_kms.types.get_key_policy_response.GetKeyPolicyResponse, zapros.Response
]:
