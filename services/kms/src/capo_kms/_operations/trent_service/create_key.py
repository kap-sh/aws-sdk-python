...
import capo_kms.errors.xks_key_already_in_use_exception
import capo_kms.errors.xks_key_invalid_configuration_exception
import capo_kms.errors.xks_key_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "XksKeyAlreadyInUseException":
            raise capo_kms.errors.xks_key_already_in_use_exception.XksKeyAlreadyInUseException.from_aws_json_1_1(
                data, message
            )
        case "XksKeyInvalidConfigurationException":
            raise capo_kms.errors.xks_key_invalid_configuration_exception.XksKeyInvalidConfigurationException.from_aws_json_1_1(
                data, message
            )
        case "XksKeyNotFoundException":
            raise capo_kms.errors.xks_key_not_found_exception.XksKeyNotFoundException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_kms.types.create_key_response.CreateKeyResponse = (
        capo_kms.types.create_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.create_key_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_key(
    ...
    input_: capo_kms.types.create_key_request.CreateKeyRequest,
) -> tuple[capo_kms.types.create_key_response.CreateKeyResponse, zapros.Response]:
