"""Generated from Smithy shape ``com.amazonaws.kms#ListGrants``."""
...
import capo_kms.errors.invalid_grant_id_exception
import capo_kms.errors.invalid_marker_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidGrantIdException":
            raise capo_kms.errors.invalid_grant_id_exception.InvalidGrantIdException.from_aws_json_1_1(
                data, message
            )
        case "InvalidMarkerException":
            raise capo_kms.errors.invalid_marker_exception.InvalidMarkerException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_kms.types.list_grants_response.ListGrantsResponse = (
        capo_kms.types.list_grants_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.list_grants_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_grants(
    ...
    input_: capo_kms.types.list_grants_request.ListGrantsRequest,
) -> tuple[capo_kms.types.list_grants_response.ListGrantsResponse, zapros.Response]:
