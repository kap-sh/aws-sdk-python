...
def handle_response(
    ...
    out: capo_kms.types.get_key_last_usage_response.GetKeyLastUsageResponse = (
        capo_kms.types.get_key_last_usage_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.get_key_last_usage_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_key_last_usage(
    ...
    capo_kms.types.get_key_last_usage_response.GetKeyLastUsageResponse, zapros.Response
]:
