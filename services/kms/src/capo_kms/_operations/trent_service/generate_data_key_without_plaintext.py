...
def handle_response(
    ...
    out: capo_kms.types.generate_data_key_without_plaintext_response.GenerateDataKeyWithoutPlaintextResponse = capo_kms.types.generate_data_key_without_plaintext_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.generate_data_key_without_plaintext_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
