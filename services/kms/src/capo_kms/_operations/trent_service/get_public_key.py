...
def handle_response(
    ...
    out: capo_kms.types.get_public_key_response.GetPublicKeyResponse = (
        capo_kms.types.get_public_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.get_public_key_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_public_key(
    ...
    capo_kms.types.get_public_key_response.GetPublicKeyResponse, zapros.Response
]:
