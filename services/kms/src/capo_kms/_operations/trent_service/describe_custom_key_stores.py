...
def handle_response(
    ...
    out: capo_kms.types.describe_custom_key_stores_response.DescribeCustomKeyStoresResponse = capo_kms.types.describe_custom_key_stores_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.describe_custom_key_stores_request.serialize_aws_json_1_1(input_)
    ).encode()
