...
def handle_response(
    ...
    out: capo_kms.types.derive_shared_secret_response.DeriveSharedSecretResponse = (
        capo_kms.types.derive_shared_secret_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.derive_shared_secret_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
