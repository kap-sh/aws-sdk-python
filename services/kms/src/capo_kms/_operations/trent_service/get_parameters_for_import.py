...
def handle_response(
    ...
    out: capo_kms.types.get_parameters_for_import_response.GetParametersForImportResponse = capo_kms.types.get_parameters_for_import_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.get_parameters_for_import_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
