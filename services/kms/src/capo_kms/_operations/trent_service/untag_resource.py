...
import capo_kms.errors.tag_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TagException":
            raise capo_kms.errors.tag_exception.TagException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.untag_resource_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
