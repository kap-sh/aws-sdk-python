...
def handle_response(
    ...
    out: capo_kms.types.list_aliases_response.ListAliasesResponse = (
        capo_kms.types.list_aliases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.list_aliases_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_aliases(
    ...
    input_: capo_kms.types.list_aliases_request.ListAliasesRequest,
) -> tuple[capo_kms.types.list_aliases_response.ListAliasesResponse, zapros.Response]:
