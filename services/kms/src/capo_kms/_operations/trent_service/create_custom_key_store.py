...
import capo_kms.errors.cloud_hsm_cluster_in_use_exception
...
import capo_kms.errors.incorrect_trust_anchor_exception
...
def handle_response(
    ...
    out: capo_kms.types.create_custom_key_store_response.CreateCustomKeyStoreResponse = capo_kms.types.create_custom_key_store_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.create_custom_key_store_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
