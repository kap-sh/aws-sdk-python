...
def handle_response(
    ...
    out: capo_kms.types.describe_key_response.DescribeKeyResponse = (
        capo_kms.types.describe_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.describe_key_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_key(
    ...
    input_: capo_kms.types.describe_key_request.DescribeKeyRequest,
) -> tuple[capo_kms.types.describe_key_response.DescribeKeyResponse, zapros.Response]:
