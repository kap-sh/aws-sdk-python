...
def handle_response(
    ...
    out: capo_kms.types.replicate_key_response.ReplicateKeyResponse = (
        capo_kms.types.replicate_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "TrentService.ReplicateKey"
    body: bytes | None = json.dumps(
        capo_kms.types.replicate_key_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
