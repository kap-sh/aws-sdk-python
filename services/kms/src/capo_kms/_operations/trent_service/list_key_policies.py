...
def handle_response(
    ...
    out: capo_kms.types.list_key_policies_response.ListKeyPoliciesResponse = (
        capo_kms.types.list_key_policies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.list_key_policies_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_key_policies(
    ...
    capo_kms.types.list_key_policies_response.ListKeyPoliciesResponse, zapros.Response
]:
