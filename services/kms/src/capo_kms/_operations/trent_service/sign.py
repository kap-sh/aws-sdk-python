...
def handle_response(
    ...
    out: capo_kms.types.sign_response.SignResponse = (
        capo_kms.types.sign_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.sign_request.serialize_aws_json_1_1(input_), allow_nan=False
    ).encode()
...
def sign(
    options: OperationOptions, input_: capo_kms.types.sign_request.SignRequest
) -> tuple[capo_kms.types.sign_response.SignResponse, zapros.Response]:
...
async def async_sign(
    options: AsyncOperationOptions, input_: capo_kms.types.sign_request.SignRequest
) -> tuple[capo_kms.types.sign_response.SignResponse, zapros.Response]:
