...
def handle_response(
    ...
    out: capo_kms.types.list_key_rotations_response.ListKeyRotationsResponse = (
        capo_kms.types.list_key_rotations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "TrentService.ListKeyRotations"
    body: bytes | None = json.dumps(
        capo_kms.types.list_key_rotations_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_key_rotations(
    ...
    capo_kms.types.list_key_rotations_response.ListKeyRotationsResponse, zapros.Response
]:
