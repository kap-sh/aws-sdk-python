...
def handle_response(
    ...
    out: capo_kms.types.delete_imported_key_material_response.DeleteImportedKeyMaterialResponse = capo_kms.types.delete_imported_key_material_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.delete_imported_key_material_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
