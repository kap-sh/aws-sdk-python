...
def handle_response(
    ...
    out: capo_kms.types.encrypt_response.EncryptResponse = (
        capo_kms.types.encrypt_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.encrypt_request.serialize_aws_json_1_1(input_), allow_nan=False
    ).encode()
...
def encrypt(
    options: OperationOptions, input_: capo_kms.types.encrypt_request.EncryptRequest
) -> tuple[capo_kms.types.encrypt_response.EncryptResponse, zapros.Response]:
