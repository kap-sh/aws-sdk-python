...
def handle_response(
    ...
    out: capo_kms.types.schedule_key_deletion_response.ScheduleKeyDeletionResponse = (
        capo_kms.types.schedule_key_deletion_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.schedule_key_deletion_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
