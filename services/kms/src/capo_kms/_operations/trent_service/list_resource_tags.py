...
def handle_response(
    ...
    out: capo_kms.types.list_resource_tags_response.ListResourceTagsResponse = (
        capo_kms.types.list_resource_tags_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.list_resource_tags_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_resource_tags(
    ...
    capo_kms.types.list_resource_tags_response.ListResourceTagsResponse, zapros.Response
]:
