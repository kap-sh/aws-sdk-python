...
def handle_response(
    ...
    out: capo_kms.types.generate_random_response.GenerateRandomResponse = (
        capo_kms.types.generate_random_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kms.types.generate_random_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def generate_random(
    ...
    capo_kms.types.generate_random_response.GenerateRandomResponse, zapros.Response
]:
