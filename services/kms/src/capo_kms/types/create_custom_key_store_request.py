...
class CreateCustomKeyStoreRequest(TypedDict, closed=True):
    ...
    r"""<p>Identifies the CloudHSM cluster for an CloudHSM key store. This parameter is required for custom key stores with <code>CustomKeyStoreType</code> of <code>AWS_CLOUDHSM</code>.</p> <p>Enter the cluster ID of any active CloudHSM cluster that is not already associated with a custom key store. To find the cluster ID, use the <a href=\"https://docs.aws.amazon.com/cloudhsm/latest/APIReference/API_DescribeClusters.html\">DescribeClusters</a> operation.</p>"""
    trust_anchor_certificate: NotRequired[
        "capo_kms.types.trust_anchor_certificate_type.TrustAnchorCertificateType"
    ]
    r"""<p>Specifies the certificate for an CloudHSM key store. This parameter is required for custom key stores with a <code>CustomKeyStoreType</code> of <code>AWS_CLOUDHSM</code>.</p> <p>Enter the content of the trust anchor certificate for the CloudHSM cluster. This is the content of the <code>customerCA.crt</code> file that you created when you <a href=\"https://docs.aws.amazon.com/cloudhsm/latest/userguide/initialize-cluster.html\">initialized the cluster</a>.</p>"""
    key_store_password: NotRequired[
        "capo_kms.types.key_store_password_type.KeyStorePasswordType"
    ]
    r"""<p>Specifies the <code>kmsuser</code> password for an CloudHSM key store. This parameter is required for custom key stores with a <code>CustomKeyStoreType</code> of <code>AWS_CLOUDHSM</code>.</p> <p>Enter the password of the <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/keystore-cloudhsm.html#concept-kmsuser\"> <code>kmsuser</code> crypto user (CU) account</a> in the specified CloudHSM cluster. KMS logs into the cluster as this user to manage key material on your behalf.</p> <p>The password must be a string of 7 to 32 characters. Its value is case sensitive.</p> <p>This parameter tells KMS the <code>kmsuser</code> account password; it does not change the password in the CloudHSM cluster.</p>"""
...
def serialize_aws_json_1_1(value: CreateCustomKeyStoreRequest) -> dict:
    ...
    if "xks_proxy_authentication_credential" in value:
        ...
        out["XksProxyAuthenticationCredential"] = (
            capo_kms.types.xks_proxy_authentication_credential_type.serialize_aws_json_1_1(
    ...
    if "xks_proxy_connectivity" in value:
        ...
        out["XksProxyConnectivity"] = (
            capo_kms.types.xks_proxy_connectivity_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CreateCustomKeyStoreRequest:
    ...
    if "XksProxyAuthenticationCredential" in data:
        ...
        out["xks_proxy_authentication_credential"] = (
            capo_kms.types.xks_proxy_authentication_credential_type.deserialize_aws_json_1_1(
    ...
    if "XksProxyConnectivity" in data:
        ...
        out["xks_proxy_connectivity"] = (
            capo_kms.types.xks_proxy_connectivity_type.deserialize_aws_json_1_1(
