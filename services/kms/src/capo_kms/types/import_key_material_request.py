"""Generated from Smithy shape ``com.amazonaws.kms#ImportKeyMaterialRequest``."""
...
def serialize_aws_json_1_1(value: ImportKeyMaterialRequest) -> dict:
    ...
    out["EncryptedKeyMaterial"] = capo_kms.types.ciphertext_type.serialize_aws_json_1_1(
    ...
    if "import_type" in value:
        ...
        out["ImportType"] = capo_kms.types.import_type.serialize_aws_json_1_1(
            value["import_type"]
        )
