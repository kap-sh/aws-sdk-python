...
if TYPE_CHECKING:
    import capo_kms.types.dry_run_modifier_type

DryRunModifierList: TypeAlias = list[
    "capo_kms.types.dry_run_modifier_type.DryRunModifierType"
]
...
def serialize_aws_json_1_1(value: DryRunModifierList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_kms.types.dry_run_modifier_type.serialize_aws_json_1_1(item))
    return out
