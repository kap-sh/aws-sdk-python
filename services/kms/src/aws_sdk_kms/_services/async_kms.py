...
from aws_sdk_kms._auth._zapros_handler import AuthMiddleware
from aws_sdk_kms._pagination import resolve_path as _resolve_path
from aws_sdk_kms._services._aws_config import aaws_config
from aws_sdk_kms._services._pipeline import (
    AsyncInterceptor,
...
if TYPE_CHECKING:
    ...
    import aws_sdk_kms.types.delete_imported_key_material_request
    import aws_sdk_kms.types.delete_imported_key_material_response
    ...
    import aws_sdk_kms.types.disable_key_request
    ...
    import aws_sdk_kms.types.get_parameters_for_import_request
    import aws_sdk_kms.types.get_parameters_for_import_response
    ...
    import aws_sdk_kms.types.list_aliases_request
    import aws_sdk_kms.types.list_aliases_response
    import aws_sdk_kms.types.list_grants_request
    ...
    import aws_sdk_kms.types.list_keys_request
    import aws_sdk_kms.types.list_keys_response
    import aws_sdk_kms.types.list_resource_tags_request
    import aws_sdk_kms.types.list_resource_tags_response
    ...
    import aws_sdk_kms.types.re_encrypt_request
    import aws_sdk_kms.types.re_encrypt_response
    ...
    import aws_sdk_kms.types.tag_key_list
...
class AsyncKMSClient:
    ...
    async def cancel_key_deletion(
        ...
        *,
        ...
        Raises:
            aws_sdk_kms.errors.dependency_timeout_exception.DependencyTimeoutException: <p>The system timed out while trying to fulfill the request. You can retry the request.</p>
            aws_sdk_kms.errors.invalid_arn_exception.InvalidArnException: <p>The request was rejected because a specified ARN, or an ARN in a key policy, is not valid.</p>
            aws_sdk_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            aws_sdk_kms.errors.kms_invalid_state_exception.KMSInvalidStateException: <p>The request was rejected because the state of the specified resource is not valid for this request.</p> <p>This exceptions means one of the following:</p> <ul> <li> <p>The key state of the KMS key is not compatible with the operation. </p> <p>To find the key state, use the <a>DescribeKey</a> operation. For more information about which key states are compatible with each KMS operation, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html\">Key states of KMS keys</a> in the <i> <i>Key Management Service Developer Guide</i> </i>.</p> </li> <li> <p>For cryptographic operations on KMS keys in custom key stores, this exception represents a general failure with many possible causes. To identify the cause, see the error message that accompanies the exception.</p> </li> </ul>
            aws_sdk_kms.errors.not_found_exception.NotFoundException: <p>The request was rejected because the specified entity or resource could not be found.</p>
            aws_sdk_kms.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.cancel_key_deletion_request.CancelKeyDeletionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.cancel_key_deletion_response.CancelKeyDeletionResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.cancel_key_deletion

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.cancel_key_deletion.async_cancel_key_deletion(
    ...
    async def connect_custom_key_store(
        self,
        custom_key_store_id: "aws_sdk_kms.types.custom_key_store_id_type.CustomKeyStoreIdType",
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.connect_custom_key_store_request.ConnectCustomKeyStoreRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.connect_custom_key_store_response.ConnectCustomKeyStoreResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.connect_custom_key_store

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.connect_custom_key_store.async_connect_custom_key_store(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_alias(
        ...
        *,
        ...
        Raises:
            aws_sdk_kms.errors.already_exists_exception.AlreadyExistsException: <p>The request was rejected because it attempted to create a resource that already exists.</p>
            aws_sdk_kms.errors.dependency_timeout_exception.DependencyTimeoutException: <p>The system timed out while trying to fulfill the request. You can retry the request.</p>
            aws_sdk_kms.errors.invalid_alias_name_exception.InvalidAliasNameException: <p>The request was rejected because the specified alias name is not valid.</p>
            aws_sdk_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            aws_sdk_kms.errors.kms_invalid_state_exception.KMSInvalidStateException: <p>The request was rejected because the state of the specified resource is not valid for this request.</p> <p>This exceptions means one of the following:</p> <ul> <li> <p>The key state of the KMS key is not compatible with the operation. </p> <p>To find the key state, use the <a>DescribeKey</a> operation. For more information about which key states are compatible with each KMS operation, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html\">Key states of KMS keys</a> in the <i> <i>Key Management Service Developer Guide</i> </i>.</p> </li> <li> <p>For cryptographic operations on KMS keys in custom key stores, this exception represents a general failure with many possible causes. To identify the cause, see the error message that accompanies the exception.</p> </li> </ul>
            aws_sdk_kms.errors.limit_exceeded_exception.LimitExceededException: <p>The request was rejected because a length constraint or quota was exceeded. For more information, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/limits.html\">Quotas</a> in the <i>Key Management Service Developer Guide</i>.</p>
            aws_sdk_kms.errors.not_found_exception.NotFoundException: <p>The request was rejected because the specified entity or resource could not be found.</p>
            aws_sdk_kms.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.create_alias_request.CreateAliasRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_kms._operations.trent_service.create_alias

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.create_alias.async_create_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_custom_key_store(
        self,
        custom_key_store_name: "aws_sdk_kms.types.custom_key_store_name_type.CustomKeyStoreNameType",
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.create_custom_key_store_request.CreateCustomKeyStoreRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.create_custom_key_store_response.CreateCustomKeyStoreResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.create_custom_key_store

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.create_custom_key_store.async_create_custom_key_store(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_grant(
        self,
        key_id: "aws_sdk_kms.types.key_id_type.KeyIdType",
        operations: "aws_sdk_kms.types.grant_operation_list.GrantOperationList",
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        ...
        constraints: Optional[
            "aws_sdk_kms.types.grant_constraints.GrantConstraints"
        ] = None,
        grant_tokens: Optional[
            "aws_sdk_kms.types.grant_token_list.GrantTokenList"
        ] = None,
        name: Optional["aws_sdk_kms.types.grant_name_type.GrantNameType"] = None,
        dry_run: Optional[
    ...
    ) -> "aws_sdk_kms.types.create_grant_response.CreateGrantResponse":
        ...
        Raises:
            aws_sdk_kms.errors.dependency_timeout_exception.DependencyTimeoutException: <p>The system timed out while trying to fulfill the request. You can retry the request.</p>
            aws_sdk_kms.errors.disabled_exception.DisabledException: <p>The request was rejected because the specified KMS key is not enabled.</p>
            aws_sdk_kms.errors.dry_run_operation_exception.DryRunOperationException: <p> The request was rejected because the DryRun parameter was specified. </p>
            aws_sdk_kms.errors.invalid_arn_exception.InvalidArnException: <p>The request was rejected because a specified ARN, or an ARN in a key policy, is not valid.</p>
            aws_sdk_kms.errors.invalid_grant_token_exception.InvalidGrantTokenException: <p>The request was rejected because the specified grant token is not valid.</p>
            aws_sdk_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            aws_sdk_kms.errors.kms_invalid_state_exception.KMSInvalidStateException: <p>The request was rejected because the state of the specified resource is not valid for this request.</p> <p>This exceptions means one of the following:</p> <ul> <li> <p>The key state of the KMS key is not compatible with the operation. </p> <p>To find the key state, use the <a>DescribeKey</a> operation. For more information about which key states are compatible with each KMS operation, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html\">Key states of KMS keys</a> in the <i> <i>Key Management Service Developer Guide</i> </i>.</p> </li> <li> <p>For cryptographic operations on KMS keys in custom key stores, this exception represents a general failure with many possible causes. To identify the cause, see the error message that accompanies the exception.</p> </li> </ul>
            aws_sdk_kms.errors.limit_exceeded_exception.LimitExceededException: <p>The request was rejected because a length constraint or quota was exceeded. For more information, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/limits.html\">Quotas</a> in the <i>Key Management Service Developer Guide</i>.</p>
            aws_sdk_kms.errors.not_found_exception.NotFoundException: <p>The request was rejected because the specified entity or resource could not be found.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.create_grant_request.CreateGrantRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.create_grant_response.CreateGrantResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.create_grant

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.create_grant.async_create_grant(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_key(
        ...
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        policy: Optional["aws_sdk_kms.types.policy_type.PolicyType"] = None,
        description: Optional[
            "aws_sdk_kms.types.description_type.DescriptionType"
        ] = None,
        key_usage: Optional["aws_sdk_kms.types.key_usage_type.KeyUsageType"] = None,
        customer_master_key_spec: Optional[
            "aws_sdk_kms.types.customer_master_key_spec.CustomerMasterKeySpec"
        ] = None,
        key_spec: Optional["aws_sdk_kms.types.key_spec.KeySpec"] = None,
        origin: Optional["aws_sdk_kms.types.origin_type.OriginType"] = None,
        ...
        bypass_policy_lockout_safety_check: Optional[
            "aws_sdk_kms.types.boolean_type.BooleanType"
        ] = None,
        tags: Optional["aws_sdk_kms.types.tag_list.TagList"] = None,
        multi_region: Optional[
            "aws_sdk_kms.types.nullable_boolean_type.NullableBooleanType"
        ] = None,
        xks_key_id: Optional["aws_sdk_kms.types.xks_key_id_type.XksKeyIdType"] = None,
        ...
        Raises:
            ...
            aws_sdk_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            aws_sdk_kms.errors.limit_exceeded_exception.LimitExceededException: <p>The request was rejected because a length constraint or quota was exceeded. For more information, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/limits.html\">Quotas</a> in the <i>Key Management Service Developer Guide</i>.</p>
            aws_sdk_kms.errors.malformed_policy_document_exception.MalformedPolicyDocumentException: <p>The request was rejected because the specified policy is not syntactically or semantically correct.</p>
            aws_sdk_kms.errors.tag_exception.TagException: <p>The request was rejected because one or more tags are not valid.</p>
            aws_sdk_kms.errors.unsupported_operation_exception.UnsupportedOperationException: <p>The request was rejected because a specified parameter is not supported or a specified resource is not valid for this operation.</p>
            aws_sdk_kms.errors.xks_key_already_in_use_exception.XksKeyAlreadyInUseException: <p>The request was rejected because the (<code>XksKeyId</code>) is already associated with another KMS key in this external key store. Each KMS key in an external key store must be associated with a different external key.</p>
            aws_sdk_kms.errors.xks_key_invalid_configuration_exception.XksKeyInvalidConfigurationException: <p>The request was rejected because the external key specified by the <code>XksKeyId</code> parameter did not meet the configuration requirements for an external key store.</p> <p>The external key must be an AES-256 symmetric key that is enabled and performs encryption and decryption.</p>
            aws_sdk_kms.errors.xks_key_not_found_exception.XksKeyNotFoundException: <p>The request was rejected because the external key store proxy could not find the external key. This exception is thrown when the value of the <code>XksKeyId</code> parameter doesn't identify a key in the external key manager associated with the external key proxy.</p> <p>Verify that the <code>XksKeyId</code> represents an existing key in the external key manager. Use the key identifier that the external key store proxy uses to identify the key. For details, see the documentation provided with your external key store proxy or key manager.</p>
            aws_sdk_kms.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.create_key_request.CreateKeyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.create_key_response.CreateKeyResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.create_key

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.create_key.async_create_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def decrypt(
        ...
        *,
        ...
        key_id: Optional["aws_sdk_kms.types.key_id_type.KeyIdType"] = None,
        encryption_algorithm: Optional[
            "aws_sdk_kms.types.encryption_algorithm_spec.EncryptionAlgorithmSpec"
        ] = None,
        recipient: Optional["aws_sdk_kms.types.recipient_info.RecipientInfo"] = None,
        dry_run: Optional[
            "aws_sdk_kms.types.nullable_boolean_type.NullableBooleanType"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.decrypt_request.DecryptRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.decrypt_response.DecryptResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.decrypt

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.decrypt.async_decrypt(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_alias(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.delete_alias_request.DeleteAliasRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_kms._operations.trent_service.delete_alias

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.delete_alias.async_delete_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_custom_key_store(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.delete_custom_key_store_request.DeleteCustomKeyStoreRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.delete_custom_key_store_response.DeleteCustomKeyStoreResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.delete_custom_key_store

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.delete_custom_key_store.async_delete_custom_key_store(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_imported_key_material(
        ...
        *,
    ...
    ) -> "aws_sdk_kms.types.delete_imported_key_material_response.DeleteImportedKeyMaterialResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.delete_imported_key_material_request.DeleteImportedKeyMaterialRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.delete_imported_key_material_response.DeleteImportedKeyMaterialResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.delete_imported_key_material

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.delete_imported_key_material.async_delete_imported_key_material(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def derive_shared_secret(
        self,
        key_id: "aws_sdk_kms.types.key_id_type.KeyIdType",
        key_agreement_algorithm: "aws_sdk_kms.types.key_agreement_algorithm_spec.KeyAgreementAlgorithmSpec",
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.derive_shared_secret_request.DeriveSharedSecretRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.derive_shared_secret_response.DeriveSharedSecretResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.derive_shared_secret

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.derive_shared_secret.async_derive_shared_secret(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_custom_key_stores(
        ...
        *,
        ...
        limit: Optional["aws_sdk_kms.types.limit_type.LimitType"] = None,
        marker: Optional["aws_sdk_kms.types.marker_type.MarkerType"] = None,
        ...
        Raises:
            aws_sdk_kms.errors.custom_key_store_not_found_exception.CustomKeyStoreNotFoundException: <p>The request was rejected because KMS cannot find a custom key store with the specified key store name or ID.</p>
            aws_sdk_kms.errors.invalid_marker_exception.InvalidMarkerException: <p>The request was rejected because the marker that specifies where pagination should next begin is not valid.</p>
            aws_sdk_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            aws_sdk_kms.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.describe_custom_key_stores_request.DescribeCustomKeyStoresRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.describe_custom_key_stores_response.DescribeCustomKeyStoresResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.describe_custom_key_stores

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.describe_custom_key_stores.async_describe_custom_key_stores(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_custom_key_stores(
        ...
        *,
        ...
        limit: Optional["aws_sdk_kms.types.limit_type.LimitType"] = None,
        marker: Optional["aws_sdk_kms.types.marker_type.MarkerType"] = None,
    ) -> "AsyncIterator[aws_sdk_kms.types.custom_key_stores_list_entry.CustomKeyStoresListEntry]":
        _token = marker
        while True:
    ...
    async def describe_key(
        ...
        *,
    ...
    ) -> "aws_sdk_kms.types.describe_key_response.DescribeKeyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.describe_key_request.DescribeKeyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.describe_key_response.DescribeKeyResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.describe_key

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.describe_key.async_describe_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.disable_key_request.DisableKeyRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_kms._operations.trent_service.disable_key

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.disable_key.async_disable_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_key_rotation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.disable_key_rotation_request.DisableKeyRotationRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_kms._operations.trent_service.disable_key_rotation

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.disable_key_rotation.async_disable_key_rotation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disconnect_custom_key_store(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.disconnect_custom_key_store_request.DisconnectCustomKeyStoreRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.disconnect_custom_key_store_response.DisconnectCustomKeyStoreResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.disconnect_custom_key_store

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.disconnect_custom_key_store.async_disconnect_custom_key_store(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.enable_key_request.EnableKeyRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_kms._operations.trent_service.enable_key

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.enable_key.async_enable_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_key_rotation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.enable_key_rotation_request.EnableKeyRotationRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_kms._operations.trent_service.enable_key_rotation

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.enable_key_rotation.async_enable_key_rotation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def encrypt(
        ...
        *,
    ...
    ) -> "aws_sdk_kms.types.encrypt_response.EncryptResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.encrypt_request.EncryptRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.encrypt_response.EncryptResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.encrypt

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.encrypt.async_encrypt(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_data_key(
        ...
        *,
        ...
        key_spec: Optional["aws_sdk_kms.types.data_key_spec.DataKeySpec"] = None,
        grant_tokens: Optional[
            "aws_sdk_kms.types.grant_token_list.GrantTokenList"
        ] = None,
        recipient: Optional["aws_sdk_kms.types.recipient_info.RecipientInfo"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.generate_data_key_request.GenerateDataKeyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.generate_data_key_response.GenerateDataKeyResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.generate_data_key

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.generate_data_key.async_generate_data_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_data_key_pair(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.generate_data_key_pair_request.GenerateDataKeyPairRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.generate_data_key_pair_response.GenerateDataKeyPairResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.generate_data_key_pair

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.generate_data_key_pair.async_generate_data_key_pair(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_data_key_pair_without_plaintext(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.generate_data_key_pair_without_plaintext_request.GenerateDataKeyPairWithoutPlaintextRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.generate_data_key_pair_without_plaintext_response.GenerateDataKeyPairWithoutPlaintextResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.generate_data_key_pair_without_plaintext

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.generate_data_key_pair_without_plaintext.async_generate_data_key_pair_without_plaintext(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_data_key_without_plaintext(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.generate_data_key_without_plaintext_request.GenerateDataKeyWithoutPlaintextRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.generate_data_key_without_plaintext_response.GenerateDataKeyWithoutPlaintextResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.generate_data_key_without_plaintext

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.generate_data_key_without_plaintext.async_generate_data_key_without_plaintext(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_mac(
        ...
        *,
    ...
    ) -> "aws_sdk_kms.types.generate_mac_response.GenerateMacResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.generate_mac_request.GenerateMacRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.generate_mac_response.GenerateMacResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.generate_mac

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.generate_mac.async_generate_mac(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_random(
        ...
        *,
        ...
        recipient: Optional["aws_sdk_kms.types.recipient_info.RecipientInfo"] = None,
    ) -> "aws_sdk_kms.types.generate_random_response.GenerateRandomResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.generate_random_request.GenerateRandomRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.generate_random_response.GenerateRandomResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.generate_random

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.generate_random.async_generate_random(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_key_last_usage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.get_key_last_usage_request.GetKeyLastUsageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.get_key_last_usage_response.GetKeyLastUsageResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.get_key_last_usage

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.get_key_last_usage.async_get_key_last_usage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_key_policy(
        ...
        *,
        ...
        policy_name: Optional[
            "aws_sdk_kms.types.policy_name_type.PolicyNameType"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.get_key_policy_request.GetKeyPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.get_key_policy_response.GetKeyPolicyResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.get_key_policy

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.get_key_policy.async_get_key_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_key_rotation_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.get_key_rotation_status_request.GetKeyRotationStatusRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.get_key_rotation_status_response.GetKeyRotationStatusResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.get_key_rotation_status

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.get_key_rotation_status.async_get_key_rotation_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_parameters_for_import(
        self,
        key_id: "aws_sdk_kms.types.key_id_type.KeyIdType",
        wrapping_algorithm: "aws_sdk_kms.types.algorithm_spec.AlgorithmSpec",
        wrapping_key_spec: "aws_sdk_kms.types.wrapping_key_spec.WrappingKeySpec",
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
    ) -> "aws_sdk_kms.types.get_parameters_for_import_response.GetParametersForImportResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.get_parameters_for_import_request.GetParametersForImportRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.get_parameters_for_import_response.GetParametersForImportResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.get_parameters_for_import

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.get_parameters_for_import.async_get_parameters_for_import(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_public_key(
        ...
        *,
    ...
    ) -> "aws_sdk_kms.types.get_public_key_response.GetPublicKeyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.get_public_key_request.GetPublicKeyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.get_public_key_response.GetPublicKeyResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.get_public_key

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.get_public_key.async_get_public_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def import_key_material(
        self,
        key_id: "aws_sdk_kms.types.key_id_type.KeyIdType",
        import_token: "aws_sdk_kms.types.ciphertext_type.CiphertextType",
        encrypted_key_material: "aws_sdk_kms.types.ciphertext_type.CiphertextType",
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        valid_to: Optional["aws_sdk_kms.types.date_type.DateType"] = None,
        expiration_model: Optional[
            "aws_sdk_kms.types.expiration_model_type.ExpirationModelType"
        ] = None,
        import_type: Optional["aws_sdk_kms.types.import_type.ImportType"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.import_key_material_request.ImportKeyMaterialRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.import_key_material_response.ImportKeyMaterialResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.import_key_material

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.import_key_material.async_import_key_material(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_aliases(
        ...
        *,
        ...
        limit: Optional["aws_sdk_kms.types.limit_type.LimitType"] = None,
        marker: Optional["aws_sdk_kms.types.marker_type.MarkerType"] = None,
    ) -> "aws_sdk_kms.types.list_aliases_response.ListAliasesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.list_aliases_request.ListAliasesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.list_aliases_response.ListAliasesResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.list_aliases

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.list_aliases.async_list_aliases(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_aliases(
        ...
        *,
        ...
        limit: Optional["aws_sdk_kms.types.limit_type.LimitType"] = None,
        marker: Optional["aws_sdk_kms.types.marker_type.MarkerType"] = None,
    ) -> "AsyncIterator[aws_sdk_kms.types.alias_list_entry.AliasListEntry]":
        _token = marker
        while True:
    ...
    async def list_grants(
        ...
        *,
        ...
        limit: Optional["aws_sdk_kms.types.limit_type.LimitType"] = None,
        marker: Optional["aws_sdk_kms.types.marker_type.MarkerType"] = None,
        grant_id: Optional["aws_sdk_kms.types.grant_id_type.GrantIdType"] = None,
        grantee_principal: Optional[
            "aws_sdk_kms.types.principal_id_type.PrincipalIdType"
        ] = None,
        grantee_service_principal: Optional[
    ...
    ) -> "aws_sdk_kms.types.list_grants_response.ListGrantsResponse":
        ...
        Raises:
            aws_sdk_kms.errors.dependency_timeout_exception.DependencyTimeoutException: <p>The system timed out while trying to fulfill the request. You can retry the request.</p>
            aws_sdk_kms.errors.invalid_arn_exception.InvalidArnException: <p>The request was rejected because a specified ARN, or an ARN in a key policy, is not valid.</p>
            aws_sdk_kms.errors.invalid_grant_id_exception.InvalidGrantIdException: <p>The request was rejected because the specified <code>GrantId</code> is not valid.</p>
            aws_sdk_kms.errors.invalid_marker_exception.InvalidMarkerException: <p>The request was rejected because the marker that specifies where pagination should next begin is not valid.</p>
            aws_sdk_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            aws_sdk_kms.errors.kms_invalid_state_exception.KMSInvalidStateException: <p>The request was rejected because the state of the specified resource is not valid for this request.</p> <p>This exceptions means one of the following:</p> <ul> <li> <p>The key state of the KMS key is not compatible with the operation. </p> <p>To find the key state, use the <a>DescribeKey</a> operation. For more information about which key states are compatible with each KMS operation, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html\">Key states of KMS keys</a> in the <i> <i>Key Management Service Developer Guide</i> </i>.</p> </li> <li> <p>For cryptographic operations on KMS keys in custom key stores, this exception represents a general failure with many possible causes. To identify the cause, see the error message that accompanies the exception.</p> </li> </ul>
            aws_sdk_kms.errors.not_found_exception.NotFoundException: <p>The request was rejected because the specified entity or resource could not be found.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.list_grants_request.ListGrantsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.list_grants_response.ListGrantsResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.list_grants

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.list_grants.async_list_grants(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_kms.types.grant_list_entry.GrantListEntry]":
        _token = marker
        while True:
    ...
    async def list_key_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.list_key_policies_request.ListKeyPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.list_key_policies_response.ListKeyPoliciesResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.list_key_policies

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.list_key_policies.async_list_key_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_key_policies(
        ...
        *,
        ...
        limit: Optional["aws_sdk_kms.types.limit_type.LimitType"] = None,
        marker: Optional["aws_sdk_kms.types.marker_type.MarkerType"] = None,
    ) -> "AsyncIterator[aws_sdk_kms.types.policy_name_type.PolicyNameType]":
        _token = marker
        while True:
    ...
    async def list_key_rotations(
        ...
        *,
        ...
        include_key_material: Optional[
            "aws_sdk_kms.types.include_key_material.IncludeKeyMaterial"
        ] = None,
        limit: Optional["aws_sdk_kms.types.limit_type.LimitType"] = None,
        marker: Optional["aws_sdk_kms.types.marker_type.MarkerType"] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.list_key_rotations_request.ListKeyRotationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.list_key_rotations_response.ListKeyRotationsResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.list_key_rotations

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.list_key_rotations.async_list_key_rotations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_key_rotations(
        ...
        *,
        ...
        limit: Optional["aws_sdk_kms.types.limit_type.LimitType"] = None,
        marker: Optional["aws_sdk_kms.types.marker_type.MarkerType"] = None,
    ) -> "AsyncIterator[aws_sdk_kms.types.rotations_list_entry.RotationsListEntry]":
        _token = marker
        while True:
    ...
    async def list_keys(
        ...
        *,
        ...
        limit: Optional["aws_sdk_kms.types.limit_type.LimitType"] = None,
        marker: Optional["aws_sdk_kms.types.marker_type.MarkerType"] = None,
    ) -> "aws_sdk_kms.types.list_keys_response.ListKeysResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.list_keys_request.ListKeysRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.list_keys_response.ListKeysResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.list_keys

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.list_keys.async_list_keys(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_keys(
        ...
        *,
        ...
        limit: Optional["aws_sdk_kms.types.limit_type.LimitType"] = None,
        marker: Optional["aws_sdk_kms.types.marker_type.MarkerType"] = None,
    ) -> "AsyncIterator[aws_sdk_kms.types.key_list_entry.KeyListEntry]":
        _token = marker
        while True:
    ...
    async def list_resource_tags(
        ...
        *,
        ...
        limit: Optional["aws_sdk_kms.types.limit_type.LimitType"] = None,
        marker: Optional["aws_sdk_kms.types.marker_type.MarkerType"] = None,
    ) -> "aws_sdk_kms.types.list_resource_tags_response.ListResourceTagsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.list_resource_tags_request.ListResourceTagsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.list_resource_tags_response.ListResourceTagsResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.list_resource_tags

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.list_resource_tags.async_list_resource_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_resource_tags(
        ...
        *,
        ...
        limit: Optional["aws_sdk_kms.types.limit_type.LimitType"] = None,
        marker: Optional["aws_sdk_kms.types.marker_type.MarkerType"] = None,
    ) -> "AsyncIterator[aws_sdk_kms.types.tag.Tag]":
        _token = marker
        while True:
    ...
    async def list_retirable_grants(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.list_retirable_grants_request.ListRetirableGrantsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.list_grants_response.ListGrantsResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.list_retirable_grants

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.list_retirable_grants.async_list_retirable_grants(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_key_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.put_key_policy_request.PutKeyPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_kms._operations.trent_service.put_key_policy

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.put_key_policy.async_put_key_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def re_encrypt(
        ...
        *,
        ...
        source_key_id: Optional["aws_sdk_kms.types.key_id_type.KeyIdType"] = None,
    ...
    ) -> "aws_sdk_kms.types.re_encrypt_response.ReEncryptResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.re_encrypt_request.ReEncryptRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.re_encrypt_response.ReEncryptResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.re_encrypt

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.re_encrypt.async_re_encrypt(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def replicate_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.replicate_key_request.ReplicateKeyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.replicate_key_response.ReplicateKeyResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.replicate_key

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.replicate_key.async_replicate_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def retire_grant(
        ...
        *,
        ...
        grant_token: Optional[
            "aws_sdk_kms.types.grant_token_type.GrantTokenType"
        ] = None,
        key_id: Optional["aws_sdk_kms.types.key_id_type.KeyIdType"] = None,
        grant_id: Optional["aws_sdk_kms.types.grant_id_type.GrantIdType"] = None,
        dry_run: Optional[
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.retire_grant_request.RetireGrantRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_kms._operations.trent_service.retire_grant

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.retire_grant.async_retire_grant(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def revoke_grant(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.revoke_grant_request.RevokeGrantRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_kms._operations.trent_service.revoke_grant

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.revoke_grant.async_revoke_grant(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def rotate_key_on_demand(
        ...
        *,
        ...
        Raises:
            aws_sdk_kms.errors.conflict_exception.ConflictException: <p>The request was rejected because an automatic rotation of this key is currently in progress or scheduled to begin within the next 20 minutes. </p>
            aws_sdk_kms.errors.dependency_timeout_exception.DependencyTimeoutException: <p>The system timed out while trying to fulfill the request. You can retry the request.</p>
            aws_sdk_kms.errors.disabled_exception.DisabledException: <p>The request was rejected because the specified KMS key is not enabled.</p>
            aws_sdk_kms.errors.invalid_arn_exception.InvalidArnException: <p>The request was rejected because a specified ARN, or an ARN in a key policy, is not valid.</p>
            aws_sdk_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.rotate_key_on_demand_request.RotateKeyOnDemandRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.rotate_key_on_demand_response.RotateKeyOnDemandResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.rotate_key_on_demand

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.rotate_key_on_demand.async_rotate_key_on_demand(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def schedule_key_deletion(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.schedule_key_deletion_request.ScheduleKeyDeletionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.schedule_key_deletion_response.ScheduleKeyDeletionResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.schedule_key_deletion

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.schedule_key_deletion.async_schedule_key_deletion(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def sign(
        ...
        key_id: "aws_sdk_kms.types.key_id_type.KeyIdType",
        message: "aws_sdk_kms.types.plaintext_type.PlaintextType",
        signing_algorithm: "aws_sdk_kms.types.signing_algorithm_spec.SigningAlgorithmSpec",
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        message_type: Optional["aws_sdk_kms.types.message_type.MessageType"] = None,
        grant_tokens: Optional[
            "aws_sdk_kms.types.grant_token_list.GrantTokenList"
        ] = None,
        dry_run: Optional[
    ...
    ) -> "aws_sdk_kms.types.sign_response.SignResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.sign_request.SignRequest]",
        ) -> AsyncOperationResponse["aws_sdk_kms.types.sign_response.SignResponse"]:
            import aws_sdk_kms._operations.trent_service.sign

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.sign.async_sign(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        self,
        key_id: "aws_sdk_kms.types.key_id_type.KeyIdType",
        tags: "aws_sdk_kms.types.tag_list.TagList",
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_kms._operations.trent_service.tag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        self,
        key_id: "aws_sdk_kms.types.key_id_type.KeyIdType",
        tag_keys: "aws_sdk_kms.types.tag_key_list.TagKeyList",
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_kms._operations.trent_service.untag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_alias(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.update_alias_request.UpdateAliasRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_kms._operations.trent_service.update_alias

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.update_alias.async_update_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_custom_key_store(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.update_custom_key_store_request.UpdateCustomKeyStoreRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.update_custom_key_store_response.UpdateCustomKeyStoreResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.update_custom_key_store

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.update_custom_key_store.async_update_custom_key_store(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_key_description(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.update_key_description_request.UpdateKeyDescriptionRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_kms._operations.trent_service.update_key_description

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.update_key_description.async_update_key_description(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_primary_region(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.update_primary_region_request.UpdatePrimaryRegionRequest]",
        ) -> AsyncOperationResponse[None]:
            import aws_sdk_kms._operations.trent_service.update_primary_region

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.update_primary_region.async_update_primary_region(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def verify(
        ...
        key_id: "aws_sdk_kms.types.key_id_type.KeyIdType",
        message: "aws_sdk_kms.types.plaintext_type.PlaintextType",
        signature: "aws_sdk_kms.types.ciphertext_type.CiphertextType",
        signing_algorithm: "aws_sdk_kms.types.signing_algorithm_spec.SigningAlgorithmSpec",
        *,
        config_overrides: Optional[AsyncKMSClientConfig] = None,
        message_type: Optional["aws_sdk_kms.types.message_type.MessageType"] = None,
    ...
    ) -> "aws_sdk_kms.types.verify_response.VerifyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.verify_request.VerifyRequest]",
        ) -> AsyncOperationResponse["aws_sdk_kms.types.verify_response.VerifyResponse"]:
            import aws_sdk_kms._operations.trent_service.verify

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.verify.async_verify(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def verify_mac(
        ...
        *,
    ...
    ) -> "aws_sdk_kms.types.verify_mac_response.VerifyMacResponse":
        ...
        Raises:
            ...
            aws_sdk_kms.errors.key_unavailable_exception.KeyUnavailableException: <p>The request was rejected because the specified KMS key was not available. You can retry the request.</p>
            aws_sdk_kms.errors.kms_internal_exception.KMSInternalException: <p>The request was rejected because an internal exception occurred. The request can be retried.</p>
            aws_sdk_kms.errors.kms_invalid_mac_exception.KMSInvalidMacException: <p>The request was rejected because the HMAC verification failed. HMAC verification fails when the HMAC computed by using the specified message, HMAC KMS key, and MAC algorithm does not match the HMAC specified in the request.</p>
            aws_sdk_kms.errors.kms_invalid_state_exception.KMSInvalidStateException: <p>The request was rejected because the state of the specified resource is not valid for this request.</p> <p>This exceptions means one of the following:</p> <ul> <li> <p>The key state of the KMS key is not compatible with the operation. </p> <p>To find the key state, use the <a>DescribeKey</a> operation. For more information about which key states are compatible with each KMS operation, see <a href=\"https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html\">Key states of KMS keys</a> in the <i> <i>Key Management Service Developer Guide</i> </i>.</p> </li> <li> <p>For cryptographic operations on KMS keys in custom key stores, this exception represents a general failure with many possible causes. To identify the cause, see the error message that accompanies the exception.</p> </li> </ul>
            aws_sdk_kms.errors.not_found_exception.NotFoundException: <p>The request was rejected because the specified entity or resource could not be found.</p>
            aws_sdk_kms.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_kms.types.verify_mac_request.VerifyMacRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_kms.types.verify_mac_response.VerifyMacResponse"
        ]:
            import aws_sdk_kms._operations.trent_service.verify_mac

            (
                output,
                http_response,
            ) = await aws_sdk_kms._operations.trent_service.verify_mac.async_verify_mac(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
