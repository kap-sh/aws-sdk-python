...
class CustomKeyStoresListEntry(TypedDict):
    ...
    connection_state: NotRequired[
        "aws_sdk_kms.types.connection_state_type.ConnectionStateType"
    ]
    ...
    connection_error_code: NotRequired[
        "aws_sdk_kms.types.connection_error_code_type.ConnectionErrorCodeType"
    ]
