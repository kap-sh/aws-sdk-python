...
class KMSError(Exception):
    """Base class for all KMS service errors."""


class ServiceError(KMSError):
...
class SerializationError(KMSError):
    """Raised when a value cannot be serialized."""


class DeserializationError(KMSError):
...
class WaiterFailedError(KMSError):
...
class WaiterTimeoutError(KMSError):
