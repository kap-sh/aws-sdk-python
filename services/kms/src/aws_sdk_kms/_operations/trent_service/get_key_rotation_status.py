...
def handle_response(
    ...
    out: aws_sdk_kms.types.get_key_rotation_status_response.GetKeyRotationStatusResponse = aws_sdk_kms.types.get_key_rotation_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.get_key_rotation_status_request.GetKeyRotationStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.get_key_rotation_status_request.serialize_aws_json_1_1(input_)
    ).encode()
