...
def handle_response(
    ...
    out: aws_sdk_kms.types.get_parameters_for_import_response.GetParametersForImportResponse = aws_sdk_kms.types.get_parameters_for_import_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.get_parameters_for_import_request.GetParametersForImportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.get_parameters_for_import_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
