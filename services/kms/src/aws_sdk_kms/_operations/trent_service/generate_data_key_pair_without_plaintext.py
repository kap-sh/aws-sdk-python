...
def handle_response(
    ...
    out: aws_sdk_kms.types.generate_data_key_pair_without_plaintext_response.GenerateDataKeyPairWithoutPlaintextResponse = aws_sdk_kms.types.generate_data_key_pair_without_plaintext_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.generate_data_key_pair_without_plaintext_request.GenerateDataKeyPairWithoutPlaintextRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.generate_data_key_pair_without_plaintext_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
