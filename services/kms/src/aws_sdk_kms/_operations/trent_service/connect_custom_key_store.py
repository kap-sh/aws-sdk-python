...
def build_request(
    ...
    input_: aws_sdk_kms.types.connect_custom_key_store_request.ConnectCustomKeyStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.connect_custom_key_store_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
