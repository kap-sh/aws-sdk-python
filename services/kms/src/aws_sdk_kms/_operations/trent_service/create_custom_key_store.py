...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CloudHsmClusterInUseException":
            import aws_sdk_kms.errors.cloud_hsm_cluster_in_use_exception

            raise aws_sdk_kms.errors.cloud_hsm_cluster_in_use_exception.CloudHsmClusterInUseException.from_aws_json_1_1(
                data
            )
        ...
        case "IncorrectTrustAnchorException":
            import aws_sdk_kms.errors.incorrect_trust_anchor_exception

            raise aws_sdk_kms.errors.incorrect_trust_anchor_exception.IncorrectTrustAnchorException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kms.types.create_custom_key_store_response.CreateCustomKeyStoreResponse = aws_sdk_kms.types.create_custom_key_store_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.create_custom_key_store_request.CreateCustomKeyStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.create_custom_key_store_request.serialize_aws_json_1_1(input_)
    ).encode()
