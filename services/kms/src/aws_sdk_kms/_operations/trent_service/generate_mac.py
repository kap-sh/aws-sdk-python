...
def handle_response(
    ...
    out: aws_sdk_kms.types.generate_mac_response.GenerateMacResponse = (
        aws_sdk_kms.types.generate_mac_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.generate_mac_request.GenerateMacRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.generate_mac_request.serialize_aws_json_1_1(input_)
    ).encode()
