...
def handle_response(
    ...
    out: aws_sdk_kms.types.create_grant_response.CreateGrantResponse = (
        aws_sdk_kms.types.create_grant_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.create_grant_request.CreateGrantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.create_grant_request.serialize_aws_json_1_1(input_)
    ).encode()
