...
def handle_response(
    ...
    out: aws_sdk_kms.types.delete_imported_key_material_response.DeleteImportedKeyMaterialResponse = aws_sdk_kms.types.delete_imported_key_material_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.delete_imported_key_material_request.DeleteImportedKeyMaterialRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.delete_imported_key_material_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
