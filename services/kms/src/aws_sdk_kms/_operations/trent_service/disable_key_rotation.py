...
def build_request(
    ...
    input_: aws_sdk_kms.types.disable_key_rotation_request.DisableKeyRotationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.disable_key_rotation_request.serialize_aws_json_1_1(input_)
    ).encode()
