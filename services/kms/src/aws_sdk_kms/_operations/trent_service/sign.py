...
def handle_response(
    ...
    out: aws_sdk_kms.types.sign_response.SignResponse = (
        aws_sdk_kms.types.sign_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.sign_request.SignRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.sign_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def sign(
    options: OperationOptions, input_: aws_sdk_kms.types.sign_request.SignRequest
...
async def async_sign(
    options: AsyncOperationOptions, input_: aws_sdk_kms.types.sign_request.SignRequest
) -> tuple[aws_sdk_kms.types.sign_response.SignResponse, zapros.Response]:
