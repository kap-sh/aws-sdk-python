...
def build_request(
    ...
    input_: aws_sdk_kms.types.update_key_description_request.UpdateKeyDescriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.update_key_description_request.serialize_aws_json_1_1(input_)
    ).encode()
