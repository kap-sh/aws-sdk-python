...
import aws_sdk_kms.errors.custom_key_store_has_cm_ks_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CustomKeyStoreHasCMKsException":
            raise aws_sdk_kms.errors.custom_key_store_has_cm_ks_exception.CustomKeyStoreHasCMKsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kms.types.delete_custom_key_store_response.DeleteCustomKeyStoreResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kms.types.delete_custom_key_store_request.DeleteCustomKeyStoreRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.delete_custom_key_store_request.serialize_aws_json_1_1(input_)
    ).encode()
