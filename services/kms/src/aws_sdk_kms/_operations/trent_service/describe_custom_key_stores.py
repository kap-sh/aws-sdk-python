...
def handle_response(
    ...
    out: aws_sdk_kms.types.describe_custom_key_stores_response.DescribeCustomKeyStoresResponse = aws_sdk_kms.types.describe_custom_key_stores_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.describe_custom_key_stores_request.DescribeCustomKeyStoresRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.describe_custom_key_stores_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
