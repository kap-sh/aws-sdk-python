...
def handle_response(
    ...
    out: aws_sdk_kms.types.generate_random_response.GenerateRandomResponse = (
        aws_sdk_kms.types.generate_random_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.generate_random_request.GenerateRandomRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.generate_random_request.serialize_aws_json_1_1(input_)
    ).encode()
