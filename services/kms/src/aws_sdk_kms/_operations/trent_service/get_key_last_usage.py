...
def handle_response(
    ...
    out: aws_sdk_kms.types.get_key_last_usage_response.GetKeyLastUsageResponse = (
        aws_sdk_kms.types.get_key_last_usage_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.get_key_last_usage_request.GetKeyLastUsageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "TrentService.GetKeyLastUsage"
    import aws_sdk_kms.types.get_key_last_usage_request

    body: bytes | None = json.dumps(
        aws_sdk_kms.types.get_key_last_usage_request.serialize_aws_json_1_1(input_)
    ).encode()
