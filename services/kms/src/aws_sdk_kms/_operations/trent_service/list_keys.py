...
def handle_response(
    ...
    out: aws_sdk_kms.types.list_keys_response.ListKeysResponse = (
        aws_sdk_kms.types.list_keys_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.list_keys_request.ListKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.list_keys_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_keys(
    ...
    input_: aws_sdk_kms.types.list_keys_request.ListKeysRequest,
) -> tuple[aws_sdk_kms.types.list_keys_response.ListKeysResponse, zapros.Response]:
