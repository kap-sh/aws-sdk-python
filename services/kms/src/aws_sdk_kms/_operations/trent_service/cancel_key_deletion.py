...
def handle_response(
    ...
    out: aws_sdk_kms.types.cancel_key_deletion_response.CancelKeyDeletionResponse = (
        aws_sdk_kms.types.cancel_key_deletion_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.cancel_key_deletion_request.CancelKeyDeletionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.cancel_key_deletion_request.serialize_aws_json_1_1(input_)
    ).encode()
