...
def handle_response(
    ...
    out: aws_sdk_kms.types.list_grants_response.ListGrantsResponse = (
        aws_sdk_kms.types.list_grants_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.list_retirable_grants_request.ListRetirableGrantsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.list_retirable_grants_request.serialize_aws_json_1_1(input_)
    ).encode()
