...
def handle_response(
    ...
    out: aws_sdk_kms.types.derive_shared_secret_response.DeriveSharedSecretResponse = (
        aws_sdk_kms.types.derive_shared_secret_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.derive_shared_secret_request.DeriveSharedSecretRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "TrentService.DeriveSharedSecret"
    import aws_sdk_kms.types.derive_shared_secret_request

    body: bytes | None = json.dumps(
        aws_sdk_kms.types.derive_shared_secret_request.serialize_aws_json_1_1(input_)
    ).encode()
