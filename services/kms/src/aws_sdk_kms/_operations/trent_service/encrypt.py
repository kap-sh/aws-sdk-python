...
def handle_response(
    ...
    out: aws_sdk_kms.types.encrypt_response.EncryptResponse = (
        aws_sdk_kms.types.encrypt_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.encrypt_request.EncryptRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.encrypt_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def encrypt(
    options: OperationOptions, input_: aws_sdk_kms.types.encrypt_request.EncryptRequest
