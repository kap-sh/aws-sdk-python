...
import aws_sdk_kms.errors.invalid_alias_name_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidAliasNameException":
            raise aws_sdk_kms.errors.invalid_alias_name_exception.InvalidAliasNameException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_kms.types.create_alias_request.CreateAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.create_alias_request.serialize_aws_json_1_1(input_)
    ).encode()
