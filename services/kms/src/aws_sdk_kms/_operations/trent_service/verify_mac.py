...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "KMSInvalidMacException":
            import aws_sdk_kms.errors.kms_invalid_mac_exception

            raise aws_sdk_kms.errors.kms_invalid_mac_exception.KMSInvalidMacException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kms.types.verify_mac_response.VerifyMacResponse = (
        aws_sdk_kms.types.verify_mac_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.verify_mac_request.VerifyMacRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.verify_mac_request.serialize_aws_json_1_1(input_)
    ).encode()
