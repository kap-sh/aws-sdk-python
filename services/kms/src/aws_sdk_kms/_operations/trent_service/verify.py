...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "KMSInvalidSignatureException":
            import aws_sdk_kms.errors.kms_invalid_signature_exception

            raise aws_sdk_kms.errors.kms_invalid_signature_exception.KMSInvalidSignatureException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kms.types.verify_response.VerifyResponse = (
        aws_sdk_kms.types.verify_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.verify_request.VerifyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.verify_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def verify(
    options: OperationOptions, input_: aws_sdk_kms.types.verify_request.VerifyRequest
