...
import aws_sdk_kms.types.policy_name_list
...
def handle_response(
    ...
    out: aws_sdk_kms.types.list_key_policies_response.ListKeyPoliciesResponse = (
        aws_sdk_kms.types.list_key_policies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.list_key_policies_request.ListKeyPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.list_key_policies_request.serialize_aws_json_1_1(input_)
    ).encode()
