...
def handle_response(
    ...
    out: aws_sdk_kms.types.re_encrypt_response.ReEncryptResponse = (
        aws_sdk_kms.types.re_encrypt_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kms.types.re_encrypt_request.ReEncryptRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kms.types.re_encrypt_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def re_encrypt(
    ...
    input_: aws_sdk_kms.types.re_encrypt_request.ReEncryptRequest,
) -> tuple[aws_sdk_kms.types.re_encrypt_response.ReEncryptResponse, zapros.Response]:
