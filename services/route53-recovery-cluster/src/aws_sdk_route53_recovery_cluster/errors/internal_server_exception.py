"""Generated from Smithy shape ``com.amazonaws.route53recoverycluster#InternalServerException``."""
...
if TYPE_CHECKING:
    import aws_sdk_route53_recovery_cluster.types.retry_after_seconds
...
class InternalServerException_(TypedDict, closed=True):
    ...
    retry_after_seconds: (
        "aws_sdk_route53_recovery_cluster.types.retry_after_seconds.RetryAfterSeconds"
    )
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.route53recoverycluster#InternalServerException``."""
