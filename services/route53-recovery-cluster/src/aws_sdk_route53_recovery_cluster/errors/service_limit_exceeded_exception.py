...
class ServiceLimitExceededException_(TypedDict, closed=True):
    ...
    resource_id: NotRequired["aws_sdk_route53_recovery_cluster.types.string.String"]
    """<p>The resource identifier of the limit that was exceeded.</p>"""
    resource_type: NotRequired["aws_sdk_route53_recovery_cluster.types.string.String"]
    """<p>The resource type of the limit that was exceeded.</p>"""
    limit_code: "aws_sdk_route53_recovery_cluster.types.string.String"
    """<p>The code of the limit that was exceeded.</p>"""
    service_code: "aws_sdk_route53_recovery_cluster.types.string.String"
