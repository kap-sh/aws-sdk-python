...
class Route53RecoveryClusterError(Exception):
    """Base class for all Route53RecoveryCluster service errors."""


class ServiceError(Route53RecoveryClusterError):
...
class SerializationError(Route53RecoveryClusterError):
    """Raised when a value cannot be serialized."""


class DeserializationError(Route53RecoveryClusterError):
...
class WaiterFailedError(Route53RecoveryClusterError):
...
class WaiterTimeoutError(Route53RecoveryClusterError):
