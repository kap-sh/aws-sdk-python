...
RoutingControls: TypeAlias = list[
    "aws_sdk_route53_recovery_cluster.types.routing_control.RoutingControl"
]
...
def serialize_aws_json_1_0(value: RoutingControls) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_route53_recovery_cluster.types.routing_control.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> RoutingControls:
    ...
    for item in data:
        out.append(
            aws_sdk_route53_recovery_cluster.types.routing_control.deserialize_aws_json_1_0(
                item
            )
        )
    return out
