...
class Route53RecoveryClusterClientConfig(TypedDict, total=False):
...
class Route53RecoveryClusterClient:
    ...
    def get_routing_control_state(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_cluster.types.get_routing_control_state_request.GetRoutingControlStateRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_cluster.types.get_routing_control_state_response.GetRoutingControlStateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_cluster._operations.toggle_customer_api.get_routing_control_state.get_routing_control_state(
    ...
    def list_routing_controls(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_cluster.types.list_routing_controls_request.ListRoutingControlsRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_cluster.types.list_routing_controls_response.ListRoutingControlsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_cluster._operations.toggle_customer_api.list_routing_controls.list_routing_controls(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_route53_recovery_cluster.types.routing_control.RoutingControl]":
        _token = next_token
        while True:
    ...
    def update_routing_control_state(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_cluster.types.update_routing_control_state_request.UpdateRoutingControlStateRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_cluster.types.update_routing_control_state_response.UpdateRoutingControlStateResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_cluster._operations.toggle_customer_api.update_routing_control_state.update_routing_control_state(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_routing_control_states(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_cluster.types.update_routing_control_states_request.UpdateRoutingControlStatesRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_cluster.types.update_routing_control_states_response.UpdateRoutingControlStatesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_cluster._operations.toggle_customer_api.update_routing_control_states.update_routing_control_states(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
