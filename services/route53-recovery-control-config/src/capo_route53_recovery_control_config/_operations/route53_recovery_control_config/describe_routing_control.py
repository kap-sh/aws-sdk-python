...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.describe_routing_control_response.DescribeRoutingControlResponse = capo_route53_recovery_control_config.types.describe_routing_control_response.deserialize_json(
