...
import capo_route53_recovery_control_config.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_route53_recovery_control_config.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.create_routing_control_response.CreateRoutingControlResponse = capo_route53_recovery_control_config.types.create_routing_control_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53_recovery_control_config.types.create_routing_control_request.serialize_json(
            input_
        )
    ).encode()
