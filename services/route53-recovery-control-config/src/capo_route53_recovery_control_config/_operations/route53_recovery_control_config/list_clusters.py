"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#ListClusters``."""
...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.list_clusters_response.ListClustersResponse = capo_route53_recovery_control_config.types.list_clusters_response.deserialize_json(
