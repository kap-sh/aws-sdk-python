...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.create_safety_rule_response.CreateSafetyRuleResponse = capo_route53_recovery_control_config.types.create_safety_rule_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53_recovery_control_config.types.create_safety_rule_request.serialize_json(
            input_
        )
    ).encode()
