...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.describe_safety_rule_response.DescribeSafetyRuleResponse = capo_route53_recovery_control_config.types.describe_safety_rule_response.deserialize_json(
