...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_route53_recovery_control_config.types.list_tags_for_resource_response.deserialize_json(
