"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#DescribeCluster``."""
...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.describe_cluster_response.DescribeClusterResponse = capo_route53_recovery_control_config.types.describe_cluster_response.deserialize_json(
