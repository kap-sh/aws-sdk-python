"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#DescribeSafetyRuleResponse``."""
...
class DescribeSafetyRuleResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeSafetyRuleResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DescribeSafetyRuleResponse:
    out: DescribeSafetyRuleResponse = {}  # type: ignore[typeddict-item]
