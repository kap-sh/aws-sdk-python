"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#AssertionRuleUpdate``."""
...
class AssertionRuleUpdate(TypedDict, closed=True):
    name: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: AssertionRuleUpdate) -> dict:
    out: dict = {}
    if "name" in value:
        out["Name"] = value["name"]
