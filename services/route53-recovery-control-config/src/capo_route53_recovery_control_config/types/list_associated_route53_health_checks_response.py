...
class ListAssociatedRoute53HealthChecksResponse(TypedDict, closed=True):
    health_check_ids: NotRequired[
        "capo_route53_recovery_control_config.types.__list_of__string_max36_pattern_s.__listOf__stringMax36PatternS"
    ]
...
def serialize_json(value: ListAssociatedRoute53HealthChecksResponse) -> dict:
    ...
    if "health_check_ids" in value:
        ...
        out["HealthCheckIds"] = (
            capo_route53_recovery_control_config.types.__list_of__string_max36_pattern_s.serialize_json(
...
def deserialize_json(data: dict) -> ListAssociatedRoute53HealthChecksResponse:
    ...
    if "HealthCheckIds" in data:
        ...
        out["health_check_ids"] = (
            capo_route53_recovery_control_config.types.__list_of__string_max36_pattern_s.deserialize_json(
                data["HealthCheckIds"]
            )
        )
