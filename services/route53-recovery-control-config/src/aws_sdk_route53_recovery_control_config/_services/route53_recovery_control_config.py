...
class Route53RecoveryControlConfigClient:
    ...
    def __init__(
        ...
        self.config = Route53RecoveryControlConfigClientConfig(
            {
    ...
    def create_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.create_cluster_request.CreateClusterRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.create_cluster_response.CreateClusterResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.create_cluster.create_cluster(
    ...
    def create_control_panel(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.create_control_panel_request.CreateControlPanelRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.create_control_panel_response.CreateControlPanelResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.create_control_panel.create_control_panel(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_routing_control(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.create_routing_control_request.CreateRoutingControlRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.create_routing_control_response.CreateRoutingControlResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.create_routing_control.create_routing_control(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_safety_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.create_safety_rule_request.CreateSafetyRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.create_safety_rule_response.CreateSafetyRuleResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.create_safety_rule.create_safety_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.delete_cluster_request.DeleteClusterRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.delete_cluster_response.DeleteClusterResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.delete_cluster.delete_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_control_panel(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.delete_control_panel_request.DeleteControlPanelRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.delete_control_panel_response.DeleteControlPanelResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.delete_control_panel.delete_control_panel(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_routing_control(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.delete_routing_control_request.DeleteRoutingControlRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.delete_routing_control_response.DeleteRoutingControlResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.delete_routing_control.delete_routing_control(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_safety_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.delete_safety_rule_request.DeleteSafetyRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.delete_safety_rule_response.DeleteSafetyRuleResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.delete_safety_rule.delete_safety_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.describe_cluster_request.DescribeClusterRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.describe_cluster_response.DescribeClusterResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.describe_cluster.describe_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_control_panel(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.describe_control_panel_request.DescribeControlPanelRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.describe_control_panel_response.DescribeControlPanelResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.describe_control_panel.describe_control_panel(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_routing_control(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.describe_routing_control_request.DescribeRoutingControlRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.describe_routing_control_response.DescribeRoutingControlResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.describe_routing_control.describe_routing_control(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_safety_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.describe_safety_rule_request.DescribeSafetyRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.describe_safety_rule_response.DescribeSafetyRuleResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.describe_safety_rule.describe_safety_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.get_resource_policy_request.GetResourcePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.get_resource_policy_response.GetResourcePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.get_resource_policy.get_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_associated_route53_health_checks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.list_associated_route53_health_checks_request.ListAssociatedRoute53HealthChecksRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.list_associated_route53_health_checks_response.ListAssociatedRoute53HealthChecksResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.list_associated_route53_health_checks.list_associated_route53_health_checks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_route53_recovery_control_config.types.__string_max36_pattern_s.__stringMax36PatternS]":
        _token = next_token
        while True:
    ...
    def list_clusters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.list_clusters_request.ListClustersRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.list_clusters_response.ListClustersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.list_clusters.list_clusters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_route53_recovery_control_config.types.cluster.Cluster]":
        _token = next_token
        while True:
    ...
    def list_control_panels(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.list_control_panels_request.ListControlPanelsRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.list_control_panels_response.ListControlPanelsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.list_control_panels.list_control_panels(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_route53_recovery_control_config.types.control_panel.ControlPanel]":
        _token = next_token
        while True:
    ...
    def list_routing_controls(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.list_routing_controls_request.ListRoutingControlsRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.list_routing_controls_response.ListRoutingControlsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.list_routing_controls.list_routing_controls(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_route53_recovery_control_config.types.routing_control.RoutingControl]":
        _token = next_token
        while True:
    ...
    def list_safety_rules(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.list_safety_rules_request.ListSafetyRulesRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.list_safety_rules_response.ListSafetyRulesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.list_safety_rules.list_safety_rules(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_route53_recovery_control_config.types.rule.Rule]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.update_cluster_request.UpdateClusterRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.update_cluster_response.UpdateClusterResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.update_cluster.update_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_control_panel(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.update_control_panel_request.UpdateControlPanelRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.update_control_panel_response.UpdateControlPanelResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.update_control_panel.update_control_panel(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_routing_control(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.update_routing_control_request.UpdateRoutingControlRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.update_routing_control_response.UpdateRoutingControlResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.update_routing_control.update_routing_control(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_safety_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_route53_recovery_control_config.types.update_safety_rule_request.UpdateSafetyRuleRequest]",
        ) -> OperationResponse[
            "aws_sdk_route53_recovery_control_config.types.update_safety_rule_response.UpdateSafetyRuleResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_route53_recovery_control_config._operations.route53_recovery_control_config.update_safety_rule.update_safety_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
