"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#DeleteCluster``."""
...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_control_config.types.delete_cluster_response.DeleteClusterResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_control_config.types.delete_cluster_request.DeleteClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
