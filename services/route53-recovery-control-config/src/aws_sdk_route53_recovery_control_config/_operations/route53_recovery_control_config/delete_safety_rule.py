"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#DeleteSafetyRule``."""
...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_control_config.types.delete_safety_rule_response.DeleteSafetyRuleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_control_config.types.delete_safety_rule_request.DeleteSafetyRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_safety_rule(
