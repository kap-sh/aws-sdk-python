...
import aws_sdk_route53_recovery_control_config.types.__list_of_control_panel
...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_control_config.types.list_control_panels_response.ListControlPanelsResponse = aws_sdk_route53_recovery_control_config.types.list_control_panels_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_control_config.types.list_control_panels_request.ListControlPanelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
