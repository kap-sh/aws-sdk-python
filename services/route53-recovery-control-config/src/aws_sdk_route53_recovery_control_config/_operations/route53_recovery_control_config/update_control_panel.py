...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_control_config.types.update_control_panel_response.UpdateControlPanelResponse = aws_sdk_route53_recovery_control_config.types.update_control_panel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_control_config.types.update_control_panel_request.UpdateControlPanelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53_recovery_control_config.types.update_control_panel_request.serialize_json(
            input_
        )
    ).encode()
