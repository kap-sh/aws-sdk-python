"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#DeleteRoutingControl``."""
...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_control_config.types.delete_routing_control_response.DeleteRoutingControlResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_route53_recovery_control_config.types.delete_routing_control_request.DeleteRoutingControlRequest,
) -> zapros.Request:
...
async def async_delete_routing_control(
