...
def build_request(
    ...
    input: aws_sdk_route53_recovery_control_config.types.describe_safety_rule_request.DescribeSafetyRuleRequest,
) -> zapros.Request:
    ...
    url = url.replace("{SafetyRuleArn}", quote(str(input["safety_rule_arn"]), safe=""))
    params: dict[str, str] = {}
