"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#ListAssociatedRoute53HealthChecks``."""
...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_control_config.types.list_associated_route53_health_checks_response.ListAssociatedRoute53HealthChecksResponse = aws_sdk_route53_recovery_control_config.types.list_associated_route53_health_checks_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_route53_recovery_control_config.types.list_associated_route53_health_checks_request.ListAssociatedRoute53HealthChecksRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{RoutingControlArn}", quote(str(input["routing_control_arn"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_list_associated_route53_health_checks(
