...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_control_config.types.describe_cluster_response.DescribeClusterResponse = aws_sdk_route53_recovery_control_config.types.describe_cluster_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_control_config.types.describe_cluster_request.DescribeClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
