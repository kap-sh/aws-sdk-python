"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#GetResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_control_config.types.get_resource_policy_response.GetResourcePolicyResponse = aws_sdk_route53_recovery_control_config.types.get_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_control_config.types.get_resource_policy_request.GetResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
