...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_control_config.types.create_cluster_response.CreateClusterResponse = aws_sdk_route53_recovery_control_config.types.create_cluster_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_control_config.types.create_cluster_request.CreateClusterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53_recovery_control_config.types.create_cluster_request.serialize_json(
            input_
        )
    ).encode()
