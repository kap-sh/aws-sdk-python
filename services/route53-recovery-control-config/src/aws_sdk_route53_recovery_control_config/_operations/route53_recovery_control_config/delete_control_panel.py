"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#DeleteControlPanel``."""
...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_control_config.types.delete_control_panel_response.DeleteControlPanelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_control_config.types.delete_control_panel_request.DeleteControlPanelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_control_panel(
