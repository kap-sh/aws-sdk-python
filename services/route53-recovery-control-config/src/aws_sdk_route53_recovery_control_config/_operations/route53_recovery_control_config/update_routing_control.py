"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#UpdateRoutingControl``."""
...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_control_config.types.update_routing_control_response.UpdateRoutingControlResponse = aws_sdk_route53_recovery_control_config.types.update_routing_control_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_control_config.types.update_routing_control_request.UpdateRoutingControlRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53_recovery_control_config.types.update_routing_control_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_routing_control(
