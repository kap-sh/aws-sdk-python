"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#DescribeControlPanel``."""
...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_control_config.types.describe_control_panel_response.DescribeControlPanelResponse = aws_sdk_route53_recovery_control_config.types.describe_control_panel_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_control_config.types.describe_control_panel_request.DescribeControlPanelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/controlpanel/{ControlPanelArn}"
    url = url.replace(
...
async def async_describe_control_panel(
