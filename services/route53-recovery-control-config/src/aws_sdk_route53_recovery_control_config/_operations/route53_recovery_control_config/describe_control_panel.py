...
def build_request(
    ...
    input: aws_sdk_route53_recovery_control_config.types.describe_control_panel_request.DescribeControlPanelRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ControlPanelArn}", quote(str(input["control_panel_arn"]), safe="")
    )
    params: dict[str, str] = {}
