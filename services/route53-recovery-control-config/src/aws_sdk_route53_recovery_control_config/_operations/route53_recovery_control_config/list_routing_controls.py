...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_control_config.types.list_routing_controls_response.ListRoutingControlsResponse = aws_sdk_route53_recovery_control_config.types.list_routing_controls_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_control_config.types.list_routing_controls_request.ListRoutingControlsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
