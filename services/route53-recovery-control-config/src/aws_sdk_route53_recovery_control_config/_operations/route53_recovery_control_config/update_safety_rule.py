...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_control_config.types.update_safety_rule_response.UpdateSafetyRuleResponse = aws_sdk_route53_recovery_control_config.types.update_safety_rule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_control_config.types.update_safety_rule_request.UpdateSafetyRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53_recovery_control_config.types.update_safety_rule_request.serialize_json(
            input_
        )
    ).encode()
