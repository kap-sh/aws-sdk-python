...
def serialize_json(value: CreateSafetyRuleRequest) -> dict:
    ...
    if "assertion_rule" in value:
        ...
        out["AssertionRule"] = (
            aws_sdk_route53_recovery_control_config.types.new_assertion_rule.serialize_json(
    ...
    if "gating_rule" in value:
        ...
        out["GatingRule"] = (
            aws_sdk_route53_recovery_control_config.types.new_gating_rule.serialize_json(
                value["gating_rule"]
            )
        )
    if "tags" in value:
...
def deserialize_json(data: dict) -> CreateSafetyRuleRequest:
    ...
    if "AssertionRule" in data:
        ...
        out["assertion_rule"] = (
            aws_sdk_route53_recovery_control_config.types.new_assertion_rule.deserialize_json(
                data["AssertionRule"]
            )
        )
    ...
    if "GatingRule" in data:
        ...
        out["gating_rule"] = (
            aws_sdk_route53_recovery_control_config.types.new_gating_rule.deserialize_json(
                data["GatingRule"]
            )
        )
    if "Tags" in data:
