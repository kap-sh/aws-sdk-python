...
if TYPE_CHECKING:
    ...
    import aws_sdk_route53_recovery_control_config.types.__string_min0_max256_pattern_s

__mapOf__stringMin0Max256PatternS: TypeAlias = dict[
    "aws_sdk_route53_recovery_control_config.types.__string.__string",
    "aws_sdk_route53_recovery_control_config.types.__string_min0_max256_pattern_s.__stringMin0Max256PatternS",
]
