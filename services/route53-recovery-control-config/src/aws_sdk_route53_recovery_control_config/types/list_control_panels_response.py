...
class ListControlPanelsResponse(TypedDict):
    control_panels: NotRequired[
        "aws_sdk_route53_recovery_control_config.types.__list_of_control_panel.__listOfControlPanel"
    ]
...
def serialize_json(value: ListControlPanelsResponse) -> dict:
    ...
    if "control_panels" in value:
        ...
        out["ControlPanels"] = (
            aws_sdk_route53_recovery_control_config.types.__list_of_control_panel.serialize_json(
...
def deserialize_json(data: dict) -> ListControlPanelsResponse:
    ...
    if "ControlPanels" in data:
        ...
        out["control_panels"] = (
            aws_sdk_route53_recovery_control_config.types.__list_of_control_panel.deserialize_json(
                data["ControlPanels"]
            )
        )
