...
from ._services.async_route53_recovery_control_config import (
    AsyncRoute53RecoveryControlConfigClient as AsyncRoute53RecoveryControlConfigClient,
)
from ._services.route53_recovery_control_config import (
    Route53RecoveryControlConfigClient as Route53RecoveryControlConfigClient,
)
