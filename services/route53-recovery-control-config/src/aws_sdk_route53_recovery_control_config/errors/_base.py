...
class Route53RecoveryControlConfigError(Exception):
    """Base class for all Route53RecoveryControlConfig service errors."""


class ServiceError(Route53RecoveryControlConfigError):
...
class SerializationError(Route53RecoveryControlConfigError):
    """Raised when a value cannot be serialized."""


class DeserializationError(Route53RecoveryControlConfigError):
...
class WaiterFailedError(Route53RecoveryControlConfigError):
...
class WaiterTimeoutError(Route53RecoveryControlConfigError):
