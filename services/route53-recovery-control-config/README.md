...
```
pip install aws-sdk-route53-recovery-control-config
```

## Usage

```python
from aws_sdk_route53_recovery_control_config import AsyncRoute53RecoveryControlConfigClient
...
```python
from aws_sdk_route53_recovery_control_config import AsyncRoute53RecoveryControlConfigClient
from aws_sdk_route53_recovery_control_config.error import AccessDeniedException
