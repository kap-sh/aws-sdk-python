...
def handle_response(
    ...
    out: aws_sdk_sso.types.list_accounts_response.ListAccountsResponse = (
        aws_sdk_sso.types.list_accounts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_sso.types.list_accounts_request.ListAccountsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_accounts(
    ...
    aws_sdk_sso.types.list_accounts_response.ListAccountsResponse, zapros.Response
]:
