"""Generated from Smithy shape ``com.amazonaws.sso#Logout``."""
...
def build_request(
    ...
    input_: aws_sdk_sso.types.logout_request.LogoutRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def logout(
    options: OperationOptions, input_: aws_sdk_sso.types.logout_request.LogoutRequest
