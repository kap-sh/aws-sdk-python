...
class SSOError(Exception):
    """Base class for all SSO service errors."""


class ServiceError(SSOError):
...
class SerializationError(SSOError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SSOError):
...
class WaiterFailedError(SSOError):
...
class WaiterTimeoutError(SSOError):
