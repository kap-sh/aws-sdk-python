...
from aws_sdk_sso._services._aws_config import aws_config
...
class SSOClientConfig(TypedDict, total=False):
...
class SSOClient:
    ...
    def get_role_credentials(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sso.types.get_role_credentials_request.GetRoleCredentialsRequest]",
        ) -> OperationResponse[
            "aws_sdk_sso.types.get_role_credentials_response.GetRoleCredentialsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sso._operations.swb_portal_service.get_role_credentials.get_role_credentials(
    ...
    def list_account_roles(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sso.types.list_account_roles_request.ListAccountRolesRequest]",
        ) -> OperationResponse[
            "aws_sdk_sso.types.list_account_roles_response.ListAccountRolesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sso._operations.swb_portal_service.list_account_roles.list_account_roles(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_account_roles(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_sso.types.next_token_type.NextTokenType"] = None,
        max_results: Optional["aws_sdk_sso.types.max_result_type.MaxResultType"] = None,
    ) -> "Iterator[aws_sdk_sso.types.role_info.RoleInfo]":
        _token = next_token
        while True:
    ...
    def list_accounts(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sso.types.list_accounts_request.ListAccountsRequest]",
        ) -> OperationResponse[
            "aws_sdk_sso.types.list_accounts_response.ListAccountsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_sso._operations.swb_portal_service.list_accounts.list_accounts(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_accounts(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_sso.types.next_token_type.NextTokenType"] = None,
        max_results: Optional["aws_sdk_sso.types.max_result_type.MaxResultType"] = None,
    ) -> "Iterator[aws_sdk_sso.types.account_info.AccountInfo]":
        _token = next_token
        while True:
    ...
    def logout(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_sso.types.logout_request.LogoutRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_sso._operations.swb_portal_service.logout

            output, http_response = (
                aws_sdk_sso._operations.swb_portal_service.logout.logout(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
