...
def logout(
    options: OperationOptions, input_: capo_sso.types.logout_request.LogoutRequest
...
async def async_logout(
    options: AsyncOperationOptions, input_: capo_sso.types.logout_request.LogoutRequest
) -> tuple[None, zapros.Response]:
