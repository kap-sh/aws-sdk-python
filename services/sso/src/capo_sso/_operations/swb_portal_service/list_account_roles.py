"""Generated from Smithy shape ``com.amazonaws.sso#ListAccountRoles``."""
...
def handle_response(
    ...
    out: capo_sso.types.list_account_roles_response.ListAccountRolesResponse = (
        capo_sso.types.list_account_roles_response.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_sso._auth._sigv4.build_sigv4_auth_scheme(
                "awsssoportal", options.region, endpoint_scheme
            )
...
def build_request(
    ...
    if "max_results" in input_:
        params.append(("max_result", str(input_["max_results"])))
...
def list_account_roles(
    ...
    capo_sso.types.list_account_roles_response.ListAccountRolesResponse, zapros.Response
]:
