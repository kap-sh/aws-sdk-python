...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.get_linked_whats_app_business_account_output.GetLinkedWhatsAppBusinessAccountOutput = aws_sdk_socialmessaging.types.get_linked_whats_app_business_account_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.get_linked_whats_app_business_account_input.GetLinkedWhatsAppBusinessAccountInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
