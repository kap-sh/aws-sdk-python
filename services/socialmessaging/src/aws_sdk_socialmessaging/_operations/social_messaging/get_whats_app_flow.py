"""Generated from Smithy shape ``com.amazonaws.socialmessaging#GetWhatsAppFlow``."""
...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.get_whats_app_flow_output.GetWhatsAppFlowOutput = aws_sdk_socialmessaging.types.get_whats_app_flow_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.get_whats_app_flow_input.GetWhatsAppFlowInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/whatsapp/flow"
    params: dict[str, str] = {}
    if "id" in input_:
...
async def async_get_whats_app_flow(
