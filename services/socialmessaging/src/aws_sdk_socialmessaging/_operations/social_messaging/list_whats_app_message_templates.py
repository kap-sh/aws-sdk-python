...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.list_whats_app_message_templates_output.ListWhatsAppMessageTemplatesOutput = aws_sdk_socialmessaging.types.list_whats_app_message_templates_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.list_whats_app_message_templates_input.ListWhatsAppMessageTemplatesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
