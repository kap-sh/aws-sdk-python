...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.get_whats_app_message_media_output.GetWhatsAppMessageMediaOutput = aws_sdk_socialmessaging.types.get_whats_app_message_media_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.get_whats_app_message_media_input.GetWhatsAppMessageMediaInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_socialmessaging.types.get_whats_app_message_media_input.serialize_json(
            input_
        )
    ).encode()
