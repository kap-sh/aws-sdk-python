"""Generated from Smithy shape ``com.amazonaws.socialmessaging#TagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.tag_resource_output.TagResourceOutput = (
        aws_sdk_socialmessaging.types.tag_resource_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.tag_resource_input.TagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/tags/tag-resource"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_socialmessaging.types.tag_resource_input

    body: bytes | None = json.dumps(
        aws_sdk_socialmessaging.types.tag_resource_input.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    aws_sdk_socialmessaging.types.tag_resource_output.TagResourceOutput, zapros.Response
]:
