"""Generated from Smithy shape ``com.amazonaws.socialmessaging#UpdateWhatsAppFlowAssets``."""
...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.update_whats_app_flow_assets_output.UpdateWhatsAppFlowAssetsOutput = aws_sdk_socialmessaging.types.update_whats_app_flow_assets_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.update_whats_app_flow_assets_input.UpdateWhatsAppFlowAssetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/whatsapp/flow/assets/update"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_socialmessaging.types.update_whats_app_flow_assets_input

    body: bytes | None = json.dumps(
        aws_sdk_socialmessaging.types.update_whats_app_flow_assets_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_whats_app_flow_assets(
