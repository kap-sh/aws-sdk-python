...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.get_whats_app_message_template_output.GetWhatsAppMessageTemplateOutput = aws_sdk_socialmessaging.types.get_whats_app_message_template_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_socialmessaging.types.get_whats_app_message_template_input.GetWhatsAppMessageTemplateInput,
) -> zapros.Request:
    ...
    if "template_language_code" in input:
        params["templateLanguageCode"] = str(input["template_language_code"])
