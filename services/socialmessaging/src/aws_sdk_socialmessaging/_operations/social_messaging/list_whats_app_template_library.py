...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.list_whats_app_template_library_output.ListWhatsAppTemplateLibraryOutput = aws_sdk_socialmessaging.types.list_whats_app_template_library_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.list_whats_app_template_library_input.ListWhatsAppTemplateLibraryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
