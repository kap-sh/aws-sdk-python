...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.list_linked_whats_app_business_accounts_output.ListLinkedWhatsAppBusinessAccountsOutput = aws_sdk_socialmessaging.types.list_linked_whats_app_business_accounts_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.list_linked_whats_app_business_accounts_input.ListLinkedWhatsAppBusinessAccountsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
