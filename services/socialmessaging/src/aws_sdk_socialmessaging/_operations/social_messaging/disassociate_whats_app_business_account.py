"""Generated from Smithy shape ``com.amazonaws.socialmessaging#DisassociateWhatsAppBusinessAccount``."""
...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.disassociate_whats_app_business_account_output.DisassociateWhatsAppBusinessAccountOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.disassociate_whats_app_business_account_input.DisassociateWhatsAppBusinessAccountInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/whatsapp/waba/disassociate"
    params: dict[str, str] = {}
    if "id" in input_:
...
async def async_disassociate_whats_app_business_account(
