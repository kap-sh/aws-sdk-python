...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.delete_whats_app_flow_output.DeleteWhatsAppFlowOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.delete_whats_app_flow_input.DeleteWhatsAppFlowInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
