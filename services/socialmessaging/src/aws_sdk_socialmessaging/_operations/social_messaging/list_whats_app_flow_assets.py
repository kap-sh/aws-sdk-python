...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.list_whats_app_flow_assets_output.ListWhatsAppFlowAssetsOutput = aws_sdk_socialmessaging.types.list_whats_app_flow_assets_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.list_whats_app_flow_assets_input.ListWhatsAppFlowAssetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
