...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.get_whats_app_flow_preview_output.GetWhatsAppFlowPreviewOutput = aws_sdk_socialmessaging.types.get_whats_app_flow_preview_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_socialmessaging.types.get_whats_app_flow_preview_input.GetWhatsAppFlowPreviewInput,
) -> zapros.Request:
    ...
    if "invalidate" in input:
        params["invalidate"] = str(input["invalidate"])
