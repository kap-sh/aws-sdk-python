...
def build_request(
    ...
    input: aws_sdk_socialmessaging.types.delete_whats_app_message_media_input.DeleteWhatsAppMessageMediaInput,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "media_id" in input:
        params["mediaId"] = str(input["media_id"])
    if "origination_phone_number_id" in input:
        params["originationPhoneNumberId"] = str(input["origination_phone_number_id"])
