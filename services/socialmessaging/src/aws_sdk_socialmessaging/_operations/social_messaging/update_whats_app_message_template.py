"""Generated from Smithy shape ``com.amazonaws.socialmessaging#UpdateWhatsAppMessageTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.update_whats_app_message_template_output.UpdateWhatsAppMessageTemplateOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.update_whats_app_message_template_input.UpdateWhatsAppMessageTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_socialmessaging.types.update_whats_app_message_template_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_whats_app_message_template(
