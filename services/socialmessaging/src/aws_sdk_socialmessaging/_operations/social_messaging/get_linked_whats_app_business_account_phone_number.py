...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.get_linked_whats_app_business_account_phone_number_output.GetLinkedWhatsAppBusinessAccountPhoneNumberOutput = aws_sdk_socialmessaging.types.get_linked_whats_app_business_account_phone_number_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.get_linked_whats_app_business_account_phone_number_input.GetLinkedWhatsAppBusinessAccountPhoneNumberInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
