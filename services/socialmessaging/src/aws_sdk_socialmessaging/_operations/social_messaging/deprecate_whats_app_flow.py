...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.deprecate_whats_app_flow_output.DeprecateWhatsAppFlowOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.deprecate_whats_app_flow_input.DeprecateWhatsAppFlowInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_socialmessaging.types.deprecate_whats_app_flow_input.serialize_json(
            input_
        )
    ).encode()
