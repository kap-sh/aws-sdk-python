"""Generated from Smithy shape ``com.amazonaws.socialmessaging#ListWhatsAppFlows``."""
...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.list_whats_app_flows_output.ListWhatsAppFlowsOutput = aws_sdk_socialmessaging.types.list_whats_app_flows_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.list_whats_app_flows_input.ListWhatsAppFlowsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/whatsapp/flow/list"
    params: dict[str, str] = {}
    if "id" in input_:
...
async def async_list_whats_app_flows(
