"""Generated from Smithy shape ``com.amazonaws.socialmessaging#ListTagsForResource``."""
...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.list_tags_for_resource_output.ListTagsForResourceOutput = aws_sdk_socialmessaging.types.list_tags_for_resource_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.list_tags_for_resource_input.ListTagsForResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/tags/list"
    params: dict[str, str] = {}
