...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.create_whats_app_message_template_media_output.CreateWhatsAppMessageTemplateMediaOutput = aws_sdk_socialmessaging.types.create_whats_app_message_template_media_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.create_whats_app_message_template_media_input.CreateWhatsAppMessageTemplateMediaInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
