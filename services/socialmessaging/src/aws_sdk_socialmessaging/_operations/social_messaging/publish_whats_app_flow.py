...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.publish_whats_app_flow_input.PublishWhatsAppFlowInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_socialmessaging.types.publish_whats_app_flow_input.serialize_json(
            input_
        )
    ).encode()
