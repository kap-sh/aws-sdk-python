...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            import aws_sdk_socialmessaging.errors.limit_exceeded_exception

            raise aws_sdk_socialmessaging.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.associate_whats_app_business_account_output.AssociateWhatsAppBusinessAccountOutput = aws_sdk_socialmessaging.types.associate_whats_app_business_account_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.associate_whats_app_business_account_input.AssociateWhatsAppBusinessAccountInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_socialmessaging.types.associate_whats_app_business_account_input.serialize_json(
            input_
        )
    ).encode()
