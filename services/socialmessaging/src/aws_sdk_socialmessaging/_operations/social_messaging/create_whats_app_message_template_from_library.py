...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.create_whats_app_message_template_from_library_output.CreateWhatsAppMessageTemplateFromLibraryOutput = aws_sdk_socialmessaging.types.create_whats_app_message_template_from_library_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.create_whats_app_message_template_from_library_input.CreateWhatsAppMessageTemplateFromLibraryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_socialmessaging.types.create_whats_app_message_template_from_library_input.serialize_json(
            input_
        )
    ).encode()
