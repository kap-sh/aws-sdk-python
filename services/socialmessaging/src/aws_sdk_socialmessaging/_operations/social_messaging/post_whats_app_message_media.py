"""Generated from Smithy shape ``com.amazonaws.socialmessaging#PostWhatsAppMessageMedia``."""
...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.post_whats_app_message_media_output.PostWhatsAppMessageMediaOutput = aws_sdk_socialmessaging.types.post_whats_app_message_media_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.post_whats_app_message_media_input.PostWhatsAppMessageMediaInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_socialmessaging.types.post_whats_app_message_media_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_post_whats_app_message_media(
