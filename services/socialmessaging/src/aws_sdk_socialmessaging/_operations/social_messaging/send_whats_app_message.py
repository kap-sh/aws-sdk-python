...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.send_whats_app_message_input.SendWhatsAppMessageInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_socialmessaging.types.send_whats_app_message_input.serialize_json(
            input_
        )
    ).encode()
