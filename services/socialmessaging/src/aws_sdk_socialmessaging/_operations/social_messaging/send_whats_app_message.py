"""Generated from Smithy shape ``com.amazonaws.socialmessaging#SendWhatsAppMessage``."""
...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.send_whats_app_message_output.SendWhatsAppMessageOutput = aws_sdk_socialmessaging.types.send_whats_app_message_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_socialmessaging.types.send_whats_app_message_input.SendWhatsAppMessageInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/whatsapp/send"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_socialmessaging.types.send_whats_app_message_input

    body: bytes | None = json.dumps(
        aws_sdk_socialmessaging.types.send_whats_app_message_input.serialize_json(input)
    ).encode()
...
async def async_send_whats_app_message(
