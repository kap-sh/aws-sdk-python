...
def build_request(
    ...
    input: aws_sdk_socialmessaging.types.create_whats_app_flow_input.CreateWhatsAppFlowInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_socialmessaging.types.create_whats_app_flow_input.serialize_json(input)
    ).encode()
