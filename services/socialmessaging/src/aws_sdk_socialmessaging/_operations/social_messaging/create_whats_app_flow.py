...
def handle_response(
    ...
    out: aws_sdk_socialmessaging.types.create_whats_app_flow_output.CreateWhatsAppFlowOutput = aws_sdk_socialmessaging.types.create_whats_app_flow_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_socialmessaging.types.create_whats_app_flow_input.CreateWhatsAppFlowInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_socialmessaging.types.create_whats_app_flow_input.serialize_json(input_)
    ).encode()
