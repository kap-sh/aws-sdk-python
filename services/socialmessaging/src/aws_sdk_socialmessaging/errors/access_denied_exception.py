"""Generated from Smithy shape ``com.amazonaws.socialmessaging#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.socialmessaging#AccessDeniedException``."""
