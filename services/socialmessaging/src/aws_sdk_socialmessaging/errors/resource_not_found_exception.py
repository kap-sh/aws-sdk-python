"""Generated from Smithy shape ``com.amazonaws.socialmessaging#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.socialmessaging#ResourceNotFoundException``."""
