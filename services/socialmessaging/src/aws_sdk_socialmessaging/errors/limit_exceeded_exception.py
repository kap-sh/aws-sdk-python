"""Generated from Smithy shape ``com.amazonaws.socialmessaging#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.socialmessaging#LimitExceededException``."""
