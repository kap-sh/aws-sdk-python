...
class CreateWhatsAppFlowInput(TypedDict):
    ...
    clone_flow_id: NotRequired["aws_sdk_socialmessaging.types.meta_flow_id.MetaFlowId"]
...
def serialize_json(value: CreateWhatsAppFlowInput) -> dict:
    ...
    if "flow_json" in value:
        ...
        out["flowJson"] = (
            aws_sdk_socialmessaging.types.meta_flow_json_blob.serialize_json(
                value["flow_json"]
            )
        )
    if "publish" in value:
