...
if TYPE_CHECKING:
    ...
    import aws_sdk_socialmessaging.types.whats_app_phone_number_summary_list


class LinkedWhatsAppBusinessAccount(TypedDict):
    ...
    phone_numbers: "aws_sdk_socialmessaging.types.whats_app_phone_number_summary_list.WhatsAppPhoneNumberSummaryList"
...
def serialize_json(value: LinkedWhatsAppBusinessAccount) -> dict:
    ...
    out["phoneNumbers"] = (
        aws_sdk_socialmessaging.types.whats_app_phone_number_summary_list.serialize_json(
            value["phone_numbers"]
        )
    )
    return out
...
def deserialize_json(data: dict) -> LinkedWhatsAppBusinessAccount:
    ...
    if "phoneNumbers" in data:
        ...
        out["phone_numbers"] = (
            aws_sdk_socialmessaging.types.whats_app_phone_number_summary_list.deserialize_json(
                data["phoneNumbers"]
            )
        )
    else:
