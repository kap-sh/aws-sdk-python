...
if TYPE_CHECKING:
    import aws_sdk_socialmessaging.types.linked_whats_app_business_account_id_meta_data
...
LinkedAccountWithIncompleteSetup: TypeAlias = dict[
    ...
    "aws_sdk_socialmessaging.types.linked_whats_app_business_account_id_meta_data.LinkedWhatsAppBusinessAccountIdMetaData",
]
...
def serialize_json(input_to_serialize: LinkedAccountWithIncompleteSetup) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = (
            aws_sdk_socialmessaging.types.linked_whats_app_business_account_id_meta_data.serialize_json(
                value
            )
        )
    return out
...
def deserialize_json(data: dict) -> LinkedAccountWithIncompleteSetup:
    ...
    for key, value in data.items():
        ...
        out[key] = (
            aws_sdk_socialmessaging.types.linked_whats_app_business_account_id_meta_data.deserialize_json(
                value
            )
        )
    return out
