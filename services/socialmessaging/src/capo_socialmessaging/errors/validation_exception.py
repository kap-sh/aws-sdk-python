"""Generated from Smithy shape ``com.amazonaws.socialmessaging#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.socialmessaging#ValidationException``."""
