...
class SocialMessagingError(Exception):
    """Base class for all SocialMessaging service errors."""


class ServiceError(SocialMessagingError):
...
class SerializationError(SocialMessagingError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SocialMessagingError):
...
class WaiterFailedError(SocialMessagingError):
...
class WaiterTimeoutError(SocialMessagingError):
