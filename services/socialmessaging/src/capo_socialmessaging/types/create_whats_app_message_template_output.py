"""Generated from Smithy shape ``com.amazonaws.socialmessaging#CreateWhatsAppMessageTemplateOutput``."""
...
class CreateWhatsAppMessageTemplateOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateWhatsAppMessageTemplateOutput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateWhatsAppMessageTemplateOutput:
    out: CreateWhatsAppMessageTemplateOutput = {}  # type: ignore[typeddict-item]
