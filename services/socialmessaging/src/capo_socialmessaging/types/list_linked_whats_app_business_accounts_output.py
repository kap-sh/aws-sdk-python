...
if TYPE_CHECKING:
    import capo_socialmessaging.types.linked_whats_app_business_account_summary_list
    import capo_socialmessaging.types.next_token


class ListLinkedWhatsAppBusinessAccountsOutput(TypedDict, closed=True):
    linked_accounts: NotRequired[
        "capo_socialmessaging.types.linked_whats_app_business_account_summary_list.LinkedWhatsAppBusinessAccountSummaryList"
    ]
...
def serialize_json(value: ListLinkedWhatsAppBusinessAccountsOutput) -> dict:
    ...
    if "linked_accounts" in value:
        ...
        out["linkedAccounts"] = (
            capo_socialmessaging.types.linked_whats_app_business_account_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListLinkedWhatsAppBusinessAccountsOutput:
    ...
    if "linkedAccounts" in data:
        ...
        out["linked_accounts"] = (
            capo_socialmessaging.types.linked_whats_app_business_account_summary_list.deserialize_json(
                data["linkedAccounts"]
            )
        )
