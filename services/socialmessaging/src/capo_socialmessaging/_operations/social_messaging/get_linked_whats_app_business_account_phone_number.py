"""Generated from Smithy shape ``com.amazonaws.socialmessaging#GetLinkedWhatsAppBusinessAccountPhoneNumber``."""
...
def handle_response(
    ...
    out: capo_socialmessaging.types.get_linked_whats_app_business_account_phone_number_output.GetLinkedWhatsAppBusinessAccountPhoneNumberOutput = capo_socialmessaging.types.get_linked_whats_app_business_account_phone_number_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/whatsapp/waba/phone/details"
    params: dict[str, str] = {}
    if "id" in input_:
...
async def async_get_linked_whats_app_business_account_phone_number(
