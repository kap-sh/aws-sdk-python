...
import capo_socialmessaging.types.meta_flow_summary_list
...
def handle_response(
    ...
    out: capo_socialmessaging.types.list_whats_app_flows_output.ListWhatsAppFlowsOutput = capo_socialmessaging.types.list_whats_app_flows_output.deserialize_json(
