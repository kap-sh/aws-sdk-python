...
def handle_response(
    ...
    out: capo_socialmessaging.types.tag_resource_output.TagResourceOutput = (
        capo_socialmessaging.types.tag_resource_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_socialmessaging.types.tag_resource_input.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_socialmessaging.types.tag_resource_output.TagResourceOutput, zapros.Response
]:
