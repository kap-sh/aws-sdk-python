...
def handle_response(
    ...
    out: capo_socialmessaging.types.put_whats_app_business_account_event_destinations_output.PutWhatsAppBusinessAccountEventDestinationsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_socialmessaging.types.put_whats_app_business_account_event_destinations_input.serialize_json(
            input_
        )
    ).encode()
