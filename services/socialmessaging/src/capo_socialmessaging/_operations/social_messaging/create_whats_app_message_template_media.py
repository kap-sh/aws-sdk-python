"""Generated from Smithy shape ``com.amazonaws.socialmessaging#CreateWhatsAppMessageTemplateMedia``."""
...
def handle_response(
    ...
    out: capo_socialmessaging.types.create_whats_app_message_template_media_output.CreateWhatsAppMessageTemplateMediaOutput = capo_socialmessaging.types.create_whats_app_message_template_media_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_socialmessaging.types.create_whats_app_message_template_media_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_whats_app_message_template_media(
