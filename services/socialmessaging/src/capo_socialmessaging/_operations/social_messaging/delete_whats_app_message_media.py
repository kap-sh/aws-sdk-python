...
def handle_response(
    ...
    out: capo_socialmessaging.types.delete_whats_app_message_media_output.DeleteWhatsAppMessageMediaOutput = capo_socialmessaging.types.delete_whats_app_message_media_output.deserialize_json(
