...
def handle_response(
    ...
    out: capo_socialmessaging.types.update_whats_app_flow_assets_output.UpdateWhatsAppFlowAssetsOutput = capo_socialmessaging.types.update_whats_app_flow_assets_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_socialmessaging.types.update_whats_app_flow_assets_input.serialize_json(
            input_
        )
    ).encode()
