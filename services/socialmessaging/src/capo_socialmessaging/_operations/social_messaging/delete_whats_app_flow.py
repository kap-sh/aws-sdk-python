"""Generated from Smithy shape ``com.amazonaws.socialmessaging#DeleteWhatsAppFlow``."""
...
def handle_response(
    ...
    out: capo_socialmessaging.types.delete_whats_app_flow_output.DeleteWhatsAppFlowOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_whats_app_flow(
