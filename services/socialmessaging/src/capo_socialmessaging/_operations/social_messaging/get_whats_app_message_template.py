"""Generated from Smithy shape ``com.amazonaws.socialmessaging#GetWhatsAppMessageTemplate``."""
...
def handle_response(
    ...
    out: capo_socialmessaging.types.get_whats_app_message_template_output.GetWhatsAppMessageTemplateOutput = capo_socialmessaging.types.get_whats_app_message_template_output.deserialize_json(
...
def build_request(
    ...
    if "template_language_code" in input_:
        params["templateLanguageCode"] = str(input_["template_language_code"])
...
async def async_get_whats_app_message_template(
