...
def handle_response(
    ...
    out: capo_socialmessaging.types.send_whats_app_message_output.SendWhatsAppMessageOutput = capo_socialmessaging.types.send_whats_app_message_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_socialmessaging.types.send_whats_app_message_input.serialize_json(input_)
    ).encode()
