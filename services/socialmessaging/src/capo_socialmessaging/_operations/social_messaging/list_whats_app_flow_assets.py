"""Generated from Smithy shape ``com.amazonaws.socialmessaging#ListWhatsAppFlowAssets``."""
...
def handle_response(
    ...
    out: capo_socialmessaging.types.list_whats_app_flow_assets_output.ListWhatsAppFlowAssetsOutput = capo_socialmessaging.types.list_whats_app_flow_assets_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/whatsapp/flow/assets"
    params: dict[str, str] = {}
    if "id" in input_:
...
async def async_list_whats_app_flow_assets(
