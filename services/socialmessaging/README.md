...
```
pip install aws-sdk-socialmessaging
```

## Usage

```python
from aws_sdk_socialmessaging import AsyncSocialMessagingClient
...
```python
from aws_sdk_socialmessaging import AsyncSocialMessagingClient
from aws_sdk_socialmessaging.error import AccessDeniedException
