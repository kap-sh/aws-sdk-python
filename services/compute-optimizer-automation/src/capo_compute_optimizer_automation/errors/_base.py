...
class ComputeOptimizerAutomationError(Exception):
    """Base class for all ComputeOptimizerAutomation service errors."""


class ServiceError(ComputeOptimizerAutomationError):
...
class SerializationError(ComputeOptimizerAutomationError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ComputeOptimizerAutomationError):
...
class WaiterFailedError(ComputeOptimizerAutomationError):
...
class WaiterTimeoutError(ComputeOptimizerAutomationError):
