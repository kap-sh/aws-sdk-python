"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#ListAutomationEventSteps``."""
...
import capo_compute_optimizer_automation.types.automation_event_steps
...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.list_automation_event_steps_response.ListAutomationEventStepsResponse = capo_compute_optimizer_automation.types.list_automation_event_steps_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.list_automation_event_steps_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_automation_event_steps(
