"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#RollbackAutomationEvent``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.rollback_automation_event_response.RollbackAutomationEventResponse = capo_compute_optimizer_automation.types.rollback_automation_event_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.rollback_automation_event_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_rollback_automation_event(
