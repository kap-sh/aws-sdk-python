"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#ListAutomationEvents``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.list_automation_events_response.ListAutomationEventsResponse = capo_compute_optimizer_automation.types.list_automation_events_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerAutomationService.ListAutomationEvents"
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.list_automation_events_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_automation_events(
