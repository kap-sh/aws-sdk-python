"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#ListAccounts``."""
...
import capo_compute_optimizer_automation.errors.not_management_account_exception
...
import capo_compute_optimizer_automation.types.account_info_list
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NotManagementAccountException":
            raise capo_compute_optimizer_automation.errors.not_management_account_exception.NotManagementAccountException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.list_accounts_response.ListAccountsResponse = capo_compute_optimizer_automation.types.list_accounts_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerAutomationService.ListAccounts"
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.list_accounts_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
