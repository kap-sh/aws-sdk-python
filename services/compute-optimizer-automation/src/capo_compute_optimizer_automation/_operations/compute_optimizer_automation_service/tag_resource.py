"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#TagResource``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerAutomationService.TagResource"
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.tag_resource_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
