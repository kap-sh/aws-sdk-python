"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#CreateAutomationRule``."""
...
import capo_compute_optimizer_automation.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_compute_optimizer_automation.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.create_automation_rule_response.CreateAutomationRuleResponse = capo_compute_optimizer_automation.types.create_automation_rule_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerAutomationService.CreateAutomationRule"
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.create_automation_rule_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
