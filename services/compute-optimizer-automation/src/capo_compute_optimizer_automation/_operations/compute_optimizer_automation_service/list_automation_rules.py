"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#ListAutomationRules``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.list_automation_rules_response.ListAutomationRulesResponse = capo_compute_optimizer_automation.types.list_automation_rules_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerAutomationService.ListAutomationRules"
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.list_automation_rules_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_automation_rules(
