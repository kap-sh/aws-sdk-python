"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#GetAutomationEvent``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.get_automation_event_response.GetAutomationEventResponse = capo_compute_optimizer_automation.types.get_automation_event_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerAutomationService.GetAutomationEvent"
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.get_automation_event_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_automation_event(
