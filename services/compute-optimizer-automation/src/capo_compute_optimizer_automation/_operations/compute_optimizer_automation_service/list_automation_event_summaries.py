"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#ListAutomationEventSummaries``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.list_automation_event_summaries_response.ListAutomationEventSummariesResponse = capo_compute_optimizer_automation.types.list_automation_event_summaries_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.list_automation_event_summaries_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_automation_event_summaries(
