"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#StartAutomationEvent``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.start_automation_event_response.StartAutomationEventResponse = capo_compute_optimizer_automation.types.start_automation_event_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.start_automation_event_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_start_automation_event(
