...
AutomationEventSummaryList: TypeAlias = list[
    "capo_compute_optimizer_automation.types.automation_event_summary.AutomationEventSummary"
]
...
def serialize_aws_json_1_0(value: AutomationEventSummaryList) -> list:
    ...
    for item in value:
        out.append(
            capo_compute_optimizer_automation.types.automation_event_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> AutomationEventSummaryList:
    ...
    for item in data:
        out.append(
            capo_compute_optimizer_automation.types.automation_event_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
