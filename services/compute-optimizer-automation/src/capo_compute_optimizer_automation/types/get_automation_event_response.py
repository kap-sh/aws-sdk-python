"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#GetAutomationEventResponse``."""
...
class GetAutomationEventResponse(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: GetAutomationEventResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> GetAutomationEventResponse:
    out: GetAutomationEventResponse = {}  # type: ignore[typeddict-item]
    if "eventId" in data:
