"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.computeoptimizerautomation#ResourceNotFoundException``."""
