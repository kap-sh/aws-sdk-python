"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#IdempotentParameterMismatchException``."""
...
class IdempotentParameterMismatchException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.computeoptimizerautomation#IdempotentParameterMismatchException``."""
