...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer_automation.types.get_automation_rule_request.GetAutomationRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer_automation.types.get_automation_rule_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
