"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#ListTagsForResource``."""
...
from aws_sdk_compute_optimizer_automation._rule_engine._endpoint_rule_set import (
    EndpointParams,
    resolve,
)
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer_automation.types.list_tags_for_resource_response.ListTagsForResourceResponse = aws_sdk_compute_optimizer_automation.types.list_tags_for_resource_response.deserialize_aws_json_1_0(
...
def get_signer(
...
) -> aws_sdk_compute_optimizer_automation._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_compute_optimizer_automation._auth._sigv4.build_sigv4_auth_scheme(
                "aco-automation", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_compute_optimizer_automation._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer_automation.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerAutomationService.ListTagsForResource"
    import aws_sdk_compute_optimizer_automation.types.list_tags_for_resource_request

    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer_automation.types.list_tags_for_resource_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
