"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#UpdateEnrollmentConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer_automation.types.update_enrollment_configuration_response.UpdateEnrollmentConfigurationResponse = aws_sdk_compute_optimizer_automation.types.update_enrollment_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer_automation.types.update_enrollment_configuration_request.UpdateEnrollmentConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_enrollment_configuration(
