...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer_automation.types.rollback_automation_event_response.RollbackAutomationEventResponse = aws_sdk_compute_optimizer_automation.types.rollback_automation_event_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer_automation.types.rollback_automation_event_request.RollbackAutomationEventRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
