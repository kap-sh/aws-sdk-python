"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#GetEnrollmentConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer_automation.types.get_enrollment_configuration_response.GetEnrollmentConfigurationResponse = aws_sdk_compute_optimizer_automation.types.get_enrollment_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer_automation.types.get_enrollment_configuration_request.GetEnrollmentConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_enrollment_configuration(
