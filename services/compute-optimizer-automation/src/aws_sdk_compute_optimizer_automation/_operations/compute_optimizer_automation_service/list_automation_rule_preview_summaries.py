...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer_automation.types.list_automation_rule_preview_summaries_response.ListAutomationRulePreviewSummariesResponse = aws_sdk_compute_optimizer_automation.types.list_automation_rule_preview_summaries_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer_automation.types.list_automation_rule_preview_summaries_request.ListAutomationRulePreviewSummariesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer_automation.types.list_automation_rule_preview_summaries_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
