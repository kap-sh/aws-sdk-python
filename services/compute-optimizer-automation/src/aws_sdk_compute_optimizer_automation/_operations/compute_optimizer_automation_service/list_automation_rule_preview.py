...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer_automation.types.list_automation_rule_preview_response.ListAutomationRulePreviewResponse = aws_sdk_compute_optimizer_automation.types.list_automation_rule_preview_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer_automation.types.list_automation_rule_preview_request.ListAutomationRulePreviewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
