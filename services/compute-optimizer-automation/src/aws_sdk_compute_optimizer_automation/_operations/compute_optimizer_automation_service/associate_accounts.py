"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#AssociateAccounts``."""
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer_automation.types.associate_accounts_request.AssociateAccountsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
