"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#UpdateAutomationRule``."""
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer_automation.types.update_automation_rule_response.UpdateAutomationRuleResponse = aws_sdk_compute_optimizer_automation.types.update_automation_rule_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer_automation.types.update_automation_rule_request.UpdateAutomationRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_automation_rule(
