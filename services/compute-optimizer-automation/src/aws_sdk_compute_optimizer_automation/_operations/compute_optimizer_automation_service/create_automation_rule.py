...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_compute_optimizer_automation.errors.service_quota_exceeded_exception

            raise aws_sdk_compute_optimizer_automation.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer_automation.types.create_automation_rule_response.CreateAutomationRuleResponse = aws_sdk_compute_optimizer_automation.types.create_automation_rule_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer_automation.types.create_automation_rule_request.CreateAutomationRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer_automation.types.create_automation_rule_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
