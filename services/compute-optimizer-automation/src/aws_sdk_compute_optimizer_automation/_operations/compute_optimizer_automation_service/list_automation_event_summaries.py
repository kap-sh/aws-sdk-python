...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer_automation.types.list_automation_event_summaries_response.ListAutomationEventSummariesResponse = aws_sdk_compute_optimizer_automation.types.list_automation_event_summaries_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer_automation.types.list_automation_event_summaries_request.ListAutomationEventSummariesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
