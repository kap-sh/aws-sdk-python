...
def handle_response(
    ...
    out: aws_sdk_compute_optimizer_automation.types.list_automation_rules_response.ListAutomationRulesResponse = aws_sdk_compute_optimizer_automation.types.list_automation_rules_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_compute_optimizer_automation.types.list_automation_rules_request.ListAutomationRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_compute_optimizer_automation.types.list_automation_rules_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
