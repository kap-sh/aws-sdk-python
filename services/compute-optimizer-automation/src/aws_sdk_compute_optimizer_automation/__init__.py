...
from ._services.async_compute_optimizer_automation import (
    AsyncComputeOptimizerAutomationClient as AsyncComputeOptimizerAutomationClient,
)
from ._services.compute_optimizer_automation import (
    ComputeOptimizerAutomationClient as ComputeOptimizerAutomationClient,
)
