...
if TYPE_CHECKING:
    ...
    import aws_sdk_compute_optimizer_automation.types.string_criteria_value
    import aws_sdk_compute_optimizer_automation.types.string_criteria_values


class ResourceTagsCriteriaCondition(TypedDict):
    ...
    key: NotRequired[
        "aws_sdk_compute_optimizer_automation.types.string_criteria_value.StringCriteriaValue"
    ]
