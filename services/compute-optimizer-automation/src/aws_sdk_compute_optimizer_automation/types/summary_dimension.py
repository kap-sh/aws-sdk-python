...
if TYPE_CHECKING:
    import aws_sdk_compute_optimizer_automation.types.summary_dimension_key


class SummaryDimension(TypedDict):
    key: "aws_sdk_compute_optimizer_automation.types.summary_dimension_key.SummaryDimensionKey"
