...
if TYPE_CHECKING:
    import aws_sdk_compute_optimizer_automation.types.automation_event_summary_list
    import aws_sdk_compute_optimizer_automation.types.next_token


class ListAutomationEventSummariesResponse(TypedDict):
    automation_event_summaries: NotRequired[
        "aws_sdk_compute_optimizer_automation.types.automation_event_summary_list.AutomationEventSummaryList"
    ]
...
def serialize_aws_json_1_0(value: ListAutomationEventSummariesResponse) -> dict:
    ...
    if "automation_event_summaries" in value:
        ...
        out["automationEventSummaries"] = (
            aws_sdk_compute_optimizer_automation.types.automation_event_summary_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListAutomationEventSummariesResponse:
    ...
    if "automationEventSummaries" in data:
        ...
        out["automation_event_summaries"] = (
            aws_sdk_compute_optimizer_automation.types.automation_event_summary_list.deserialize_aws_json_1_0(
