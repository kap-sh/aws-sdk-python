...
AutomationEvents: TypeAlias = list[
    "aws_sdk_compute_optimizer_automation.types.automation_event.AutomationEvent"
]
...
def serialize_aws_json_1_0(value: AutomationEvents) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_compute_optimizer_automation.types.automation_event.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> AutomationEvents:
    ...
    for item in data:
        out.append(
            aws_sdk_compute_optimizer_automation.types.automation_event.deserialize_aws_json_1_0(
                item
            )
        )
    return out
