...
def serialize_aws_json_1_0(value: ListAutomationRulesRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            aws_sdk_compute_optimizer_automation.types.filter_list.serialize_aws_json_1_0(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListAutomationRulesRequest:
    ...
    if "filters" in data:
        ...
        out["filters"] = (
            aws_sdk_compute_optimizer_automation.types.filter_list.deserialize_aws_json_1_0(
                data["filters"]
            )
        )
