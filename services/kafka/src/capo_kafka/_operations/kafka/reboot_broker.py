...
def handle_response(
    ...
    out: capo_kafka.types.reboot_broker_response.RebootBrokerResponse = (
        capo_kafka.types.reboot_broker_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kafka.types.reboot_broker_request.serialize_json(input_)
    ).encode()
...
def reboot_broker(
    ...
    capo_kafka.types.reboot_broker_response.RebootBrokerResponse, zapros.Response
]:
