"""Generated from Smithy shape ``com.amazonaws.kafka#UpdateConfiguration``."""
...
def handle_response(
    ...
    out: capo_kafka.types.update_configuration_response.UpdateConfigurationResponse = (
        capo_kafka.types.update_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kafka.types.update_configuration_request.serialize_json(input_)
    ).encode()
