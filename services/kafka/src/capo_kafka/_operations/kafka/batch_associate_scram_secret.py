"""Generated from Smithy shape ``com.amazonaws.kafka#BatchAssociateScramSecret``."""
...
def handle_response(
    ...
    out: capo_kafka.types.batch_associate_scram_secret_response.BatchAssociateScramSecretResponse = capo_kafka.types.batch_associate_scram_secret_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kafka.types.batch_associate_scram_secret_request.serialize_json(input_)
    ).encode()
...
async def async_batch_associate_scram_secret(
