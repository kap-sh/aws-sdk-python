...
def handle_response(
    ...
    out: capo_kafka.types.list_configuration_revisions_response.ListConfigurationRevisionsResponse = capo_kafka.types.list_configuration_revisions_response.deserialize_json(
