...
def handle_response(
    ...
    out: capo_kafka.types.put_cluster_policy_response.PutClusterPolicyResponse = (
        capo_kafka.types.put_cluster_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kafka.types.put_cluster_policy_request.serialize_json(input_)
    ).encode()
