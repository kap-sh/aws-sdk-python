"""Generated from Smithy shape ``com.amazonaws.kafka#ListScramSecrets``."""
...
def handle_response(
    ...
    out: capo_kafka.types.list_scram_secrets_response.ListScramSecretsResponse = (
        capo_kafka.types.list_scram_secrets_response.deserialize_json(
...
async def async_list_scram_secrets(
