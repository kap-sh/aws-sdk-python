...
def handle_response(
    ...
    out: capo_kafka.types.update_topic_response.UpdateTopicResponse = (
        capo_kafka.types.update_topic_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kafka.types.update_topic_request.serialize_json(input_)
    ).encode()
...
def update_topic(
    ...
    input_: capo_kafka.types.update_topic_request.UpdateTopicRequest,
) -> tuple[capo_kafka.types.update_topic_response.UpdateTopicResponse, zapros.Response]:
