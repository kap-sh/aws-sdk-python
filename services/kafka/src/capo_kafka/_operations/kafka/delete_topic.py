...
def handle_response(
    ...
    out: capo_kafka.types.delete_topic_response.DeleteTopicResponse = (
        capo_kafka.types.delete_topic_response.deserialize_json(
...
def delete_topic(
    ...
    input_: capo_kafka.types.delete_topic_request.DeleteTopicRequest,
) -> tuple[capo_kafka.types.delete_topic_response.DeleteTopicResponse, zapros.Response]:
