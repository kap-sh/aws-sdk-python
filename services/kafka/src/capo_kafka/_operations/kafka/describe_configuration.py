"""Generated from Smithy shape ``com.amazonaws.kafka#DescribeConfiguration``."""
...
def handle_response(
    ...
    out: capo_kafka.types.describe_configuration_response.DescribeConfigurationResponse = capo_kafka.types.describe_configuration_response.deserialize_json(
