"""Generated from Smithy shape ``com.amazonaws.kafka#CreateConfiguration``."""
...
def handle_response(
    ...
    out: capo_kafka.types.create_configuration_response.CreateConfigurationResponse = (
        capo_kafka.types.create_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kafka.types.create_configuration_request.serialize_json(input_)
    ).encode()
