"""Generated from Smithy shape ``com.amazonaws.kafka#BatchDisassociateScramSecret``."""
...
def handle_response(
    ...
    out: capo_kafka.types.batch_disassociate_scram_secret_response.BatchDisassociateScramSecretResponse = capo_kafka.types.batch_disassociate_scram_secret_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kafka.types.batch_disassociate_scram_secret_request.serialize_json(input_)
    ).encode()
