"""Generated from Smithy shape ``com.amazonaws.kafka#GetBootstrapBrokers``."""
...
def handle_response(
    ...
    out: capo_kafka.types.get_bootstrap_brokers_response.GetBootstrapBrokersResponse = (
        capo_kafka.types.get_bootstrap_brokers_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/clusters/{ClusterArn}/bootstrap-brokers"
...
async def async_get_bootstrap_brokers(
