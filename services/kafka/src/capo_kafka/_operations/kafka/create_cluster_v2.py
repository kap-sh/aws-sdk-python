...
def handle_response(
    ...
    out: capo_kafka.types.create_cluster_v2_response.CreateClusterV2Response = (
        capo_kafka.types.create_cluster_v2_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kafka.types.create_cluster_v2_request.serialize_json(input_)
    ).encode()
...
def create_cluster_v2(
    ...
    capo_kafka.types.create_cluster_v2_response.CreateClusterV2Response, zapros.Response
]:
