"""Generated from Smithy shape ``com.amazonaws.kafka#ListVpcConnections``."""
...
def handle_response(
    ...
    out: capo_kafka.types.list_vpc_connections_response.ListVpcConnectionsResponse = (
        capo_kafka.types.list_vpc_connections_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/vpc-connections"
    params: dict[str, str] = {}
