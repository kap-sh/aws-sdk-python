...
def handle_response(
    ...
    out: capo_kafka.types.update_storage_response.UpdateStorageResponse = (
        capo_kafka.types.update_storage_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kafka.types.update_storage_request.serialize_json(input_)
    ).encode()
...
def update_storage(
    ...
    capo_kafka.types.update_storage_response.UpdateStorageResponse, zapros.Response
]:
