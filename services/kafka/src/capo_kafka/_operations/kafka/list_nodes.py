"""Generated from Smithy shape ``com.amazonaws.kafka#ListNodes``."""
...
def handle_response(
    ...
    out: capo_kafka.types.list_nodes_response.ListNodesResponse = (
        capo_kafka.types.list_nodes_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/clusters/{ClusterArn}/nodes"
...
def list_nodes(
    ...
    input_: capo_kafka.types.list_nodes_request.ListNodesRequest,
) -> tuple[capo_kafka.types.list_nodes_response.ListNodesResponse, zapros.Response]:
