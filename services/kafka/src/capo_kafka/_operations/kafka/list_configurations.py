"""Generated from Smithy shape ``com.amazonaws.kafka#ListConfigurations``."""
...
import capo_kafka.types.__list_of_configuration
...
def handle_response(
    ...
    out: capo_kafka.types.list_configurations_response.ListConfigurationsResponse = (
        capo_kafka.types.list_configurations_response.deserialize_json(
