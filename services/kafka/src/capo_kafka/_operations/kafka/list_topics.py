...
def handle_response(
    ...
    out: capo_kafka.types.list_topics_response.ListTopicsResponse = (
        capo_kafka.types.list_topics_response.deserialize_json(
...
def list_topics(
    ...
    input_: capo_kafka.types.list_topics_request.ListTopicsRequest,
) -> tuple[capo_kafka.types.list_topics_response.ListTopicsResponse, zapros.Response]:
