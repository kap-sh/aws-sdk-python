...
def handle_response(
    ...
    out: capo_kafka.types.update_broker_count_response.UpdateBrokerCountResponse = (
        capo_kafka.types.update_broker_count_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kafka.types.update_broker_count_request.serialize_json(input_)
    ).encode()
