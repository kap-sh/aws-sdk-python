"""Generated from Smithy shape ``com.amazonaws.kafka#ListClusterOperations``."""
...
import capo_kafka.types.__list_of_cluster_operation_info
...
def handle_response(
    ...
    out: capo_kafka.types.list_cluster_operations_response.ListClusterOperationsResponse = capo_kafka.types.list_cluster_operations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/clusters/{ClusterArn}/operations"
...
async def async_list_cluster_operations(
