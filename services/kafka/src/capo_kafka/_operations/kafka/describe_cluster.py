"""Generated from Smithy shape ``com.amazonaws.kafka#DescribeCluster``."""
...
def handle_response(
    ...
    out: capo_kafka.types.describe_cluster_response.DescribeClusterResponse = (
        capo_kafka.types.describe_cluster_response.deserialize_json(
...
def describe_cluster(
    ...
    capo_kafka.types.describe_cluster_response.DescribeClusterResponse, zapros.Response
]:
