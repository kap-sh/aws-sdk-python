...
def handle_response(
    ...
    out: capo_kafka.types.describe_cluster_operation_v2_response.DescribeClusterOperationV2Response = capo_kafka.types.describe_cluster_operation_v2_response.deserialize_json(
