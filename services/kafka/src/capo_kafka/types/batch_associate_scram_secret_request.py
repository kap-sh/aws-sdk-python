"""Generated from Smithy shape ``com.amazonaws.kafka#BatchAssociateScramSecretRequest``."""
...
class BatchAssociateScramSecretRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: BatchAssociateScramSecretRequest) -> dict:
    out: dict = {}
