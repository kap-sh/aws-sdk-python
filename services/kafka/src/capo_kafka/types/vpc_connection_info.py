"""Generated from Smithy shape ``com.amazonaws.kafka#VpcConnectionInfo``."""
...
class VpcConnectionInfo(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: VpcConnectionInfo) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> VpcConnectionInfo:
    out: VpcConnectionInfo = {}  # type: ignore[typeddict-item]
