"""Generated from Smithy shape ``com.amazonaws.kafka#__listOfConfigurationRevision``."""
...
def serialize_json(value: __listOfConfigurationRevision) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_kafka.types.configuration_revision.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> __listOfConfigurationRevision:
    ...
    for item in data:
        out.append(aws_sdk_kafka.types.configuration_revision.deserialize_json(item))
    return out
