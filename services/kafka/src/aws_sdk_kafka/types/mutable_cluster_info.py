...
if TYPE_CHECKING:
    ...
    import aws_sdk_kafka.types.broker_count_update_info
...
class MutableClusterInfo(TypedDict):
    ...
    broker_count_update_info: NotRequired[
        "aws_sdk_kafka.types.broker_count_update_info.BrokerCountUpdateInfo"
    ]
...
def serialize_json(value: MutableClusterInfo) -> dict:
    ...
    if "broker_count_update_info" in value:
        ...
        out["brokerCountUpdateInfo"] = (
            aws_sdk_kafka.types.broker_count_update_info.serialize_json(
...
def deserialize_json(data: dict) -> MutableClusterInfo:
    ...
    if "brokerCountUpdateInfo" in data:
        ...
        out["broker_count_update_info"] = (
            aws_sdk_kafka.types.broker_count_update_info.deserialize_json(
