"""Generated from Smithy shape ``com.amazonaws.kafka#UpdateStorageResponse``."""
...
class UpdateStorageResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateStorageResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateStorageResponse:
    out: UpdateStorageResponse = {}  # type: ignore[typeddict-item]
