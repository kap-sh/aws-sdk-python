"""Generated from Smithy shape ``com.amazonaws.kafka#UpdateMonitoringResponse``."""
...
class UpdateMonitoringResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateMonitoringResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateMonitoringResponse:
    out: UpdateMonitoringResponse = {}  # type: ignore[typeddict-item]
