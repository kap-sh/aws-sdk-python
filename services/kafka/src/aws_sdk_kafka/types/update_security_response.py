"""Generated from Smithy shape ``com.amazonaws.kafka#UpdateSecurityResponse``."""
...
class UpdateSecurityResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateSecurityResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateSecurityResponse:
    out: UpdateSecurityResponse = {}  # type: ignore[typeddict-item]
