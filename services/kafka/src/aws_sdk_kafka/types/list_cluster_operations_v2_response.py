...
if TYPE_CHECKING:
    import aws_sdk_kafka.types.__list_of_cluster_operation_v2_summary
    import aws_sdk_kafka.types.__string


class ListClusterOperationsV2Response(TypedDict):
    cluster_operation_info_list: NotRequired[
        "aws_sdk_kafka.types.__list_of_cluster_operation_v2_summary.__listOfClusterOperationV2Summary"
    ]
...
def serialize_json(value: ListClusterOperationsV2Response) -> dict:
    ...
    if "cluster_operation_info_list" in value:
        ...
        out["clusterOperationInfoList"] = (
            aws_sdk_kafka.types.__list_of_cluster_operation_v2_summary.serialize_json(
...
def deserialize_json(data: dict) -> ListClusterOperationsV2Response:
    ...
    if "clusterOperationInfoList" in data:
        ...
        out["cluster_operation_info_list"] = (
            aws_sdk_kafka.types.__list_of_cluster_operation_v2_summary.deserialize_json(
