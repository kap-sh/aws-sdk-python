"""Generated from Smithy shape ``com.amazonaws.kafka#DescribeReplicator``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.describe_replicator_response.DescribeReplicatorResponse = (
        aws_sdk_kafka.types.describe_replicator_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_kafka.types.describe_replicator_request.DescribeReplicatorRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/replication/v1/replicators/{ReplicatorArn}"
...
async def async_describe_replicator(
