...
def handle_response(
    ...
    out: aws_sdk_kafka.types.list_cluster_operations_response.ListClusterOperationsResponse = aws_sdk_kafka.types.list_cluster_operations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.list_cluster_operations_request.ListClusterOperationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
