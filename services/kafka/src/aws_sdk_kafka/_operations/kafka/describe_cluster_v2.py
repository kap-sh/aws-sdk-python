"""Generated from Smithy shape ``com.amazonaws.kafka#DescribeClusterV2``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.describe_cluster_v2_response.DescribeClusterV2Response = (
        aws_sdk_kafka.types.describe_cluster_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.describe_cluster_v2_request.DescribeClusterV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/api/v2/clusters/{ClusterArn}"
...
async def async_describe_cluster_v2(
