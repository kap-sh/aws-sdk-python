"""Generated from Smithy shape ``com.amazonaws.kafka#RebootBroker``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.reboot_broker_response.RebootBrokerResponse = (
        aws_sdk_kafka.types.reboot_broker_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.reboot_broker_request.RebootBrokerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/clusters/{ClusterArn}/reboot-broker"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.reboot_broker_request.serialize_json(input_)
    ).encode()
...
def reboot_broker(
    ...
    aws_sdk_kafka.types.reboot_broker_response.RebootBrokerResponse, zapros.Response
]:
