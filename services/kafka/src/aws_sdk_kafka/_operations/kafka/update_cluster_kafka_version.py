"""Generated from Smithy shape ``com.amazonaws.kafka#UpdateClusterKafkaVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.update_cluster_kafka_version_response.UpdateClusterKafkaVersionResponse = aws_sdk_kafka.types.update_cluster_kafka_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.update_cluster_kafka_version_request.UpdateClusterKafkaVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/clusters/{ClusterArn}/version"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.update_cluster_kafka_version_request.serialize_json(input_)
    ).encode()
...
async def async_update_cluster_kafka_version(
