...
def build_request(
    ...
    input: aws_sdk_kafka.types.update_cluster_kafka_version_request.UpdateClusterKafkaVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.update_cluster_kafka_version_request.serialize_json(input)
    ).encode()
