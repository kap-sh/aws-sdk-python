...
def handle_response(
    ...
    out: aws_sdk_kafka.types.update_rebalancing_response.UpdateRebalancingResponse = (
        aws_sdk_kafka.types.update_rebalancing_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.update_rebalancing_request.UpdateRebalancingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.update_rebalancing_request.serialize_json(input_)
    ).encode()
