...
def handle_response(
    ...
    out: aws_sdk_kafka.types.update_connectivity_response.UpdateConnectivityResponse = (
        aws_sdk_kafka.types.update_connectivity_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.update_connectivity_request.UpdateConnectivityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.update_connectivity_request.serialize_json(input_)
    ).encode()
