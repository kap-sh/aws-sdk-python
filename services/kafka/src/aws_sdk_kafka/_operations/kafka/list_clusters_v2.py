...
def build_request(
    ...
    input: aws_sdk_kafka.types.list_clusters_v2_request.ListClustersV2Request,
) -> zapros.Request:
    ...
    if "cluster_type_filter" in input:
        params["clusterTypeFilter"] = str(input["cluster_type_filter"])
