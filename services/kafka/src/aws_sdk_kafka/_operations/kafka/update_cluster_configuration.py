...
def handle_response(
    ...
    out: aws_sdk_kafka.types.update_cluster_configuration_response.UpdateClusterConfigurationResponse = aws_sdk_kafka.types.update_cluster_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.update_cluster_configuration_request.UpdateClusterConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.update_cluster_configuration_request.serialize_json(input_)
    ).encode()
