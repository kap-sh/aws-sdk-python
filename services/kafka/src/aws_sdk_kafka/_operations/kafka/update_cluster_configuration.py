...
def build_request(
    ...
    input: aws_sdk_kafka.types.update_cluster_configuration_request.UpdateClusterConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.update_cluster_configuration_request.serialize_json(input)
    ).encode()
