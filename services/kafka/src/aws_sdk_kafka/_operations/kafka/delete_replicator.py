"""Generated from Smithy shape ``com.amazonaws.kafka#DeleteReplicator``."""
...
def build_request(
    ...
    input: aws_sdk_kafka.types.delete_replicator_request.DeleteReplicatorRequest,
) -> zapros.Request:
...
async def async_delete_replicator(
