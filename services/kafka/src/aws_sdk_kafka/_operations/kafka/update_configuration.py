...
def build_request(
    ...
    input: aws_sdk_kafka.types.update_configuration_request.UpdateConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.update_configuration_request.serialize_json(input)
    ).encode()
