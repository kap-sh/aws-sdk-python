...
def handle_response(
    ...
    out: aws_sdk_kafka.types.list_scram_secrets_response.ListScramSecretsResponse = (
        aws_sdk_kafka.types.list_scram_secrets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.list_scram_secrets_request.ListScramSecretsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
