"""Generated from Smithy shape ``com.amazonaws.kafka#DeleteCluster``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.delete_cluster_response.DeleteClusterResponse = (
        aws_sdk_kafka.types.delete_cluster_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_kafka.types.delete_cluster_request.DeleteClusterRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "current_version" in input:
        params["currentVersion"] = str(input["current_version"])
...
def delete_cluster(
    ...
    aws_sdk_kafka.types.delete_cluster_response.DeleteClusterResponse, zapros.Response
]:
