"""Generated from Smithy shape ``com.amazonaws.kafka#DescribeTopicPartitions``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.describe_topic_partitions_response.DescribeTopicPartitionsResponse = aws_sdk_kafka.types.describe_topic_partitions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.describe_topic_partitions_request.DescribeTopicPartitionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_topic_partitions(
