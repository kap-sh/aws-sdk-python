...
def handle_response(
    ...
    out: aws_sdk_kafka.types.get_bootstrap_brokers_response.GetBootstrapBrokersResponse = aws_sdk_kafka.types.get_bootstrap_brokers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.get_bootstrap_brokers_request.GetBootstrapBrokersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
