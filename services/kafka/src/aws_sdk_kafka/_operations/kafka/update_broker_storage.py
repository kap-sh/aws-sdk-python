...
def build_request(
    ...
    input: aws_sdk_kafka.types.update_broker_storage_request.UpdateBrokerStorageRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.update_broker_storage_request.serialize_json(input)
    ).encode()
