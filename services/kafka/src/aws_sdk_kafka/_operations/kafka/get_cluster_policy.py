...
def handle_response(
    ...
    out: aws_sdk_kafka.types.get_cluster_policy_response.GetClusterPolicyResponse = (
        aws_sdk_kafka.types.get_cluster_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.get_cluster_policy_request.GetClusterPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
