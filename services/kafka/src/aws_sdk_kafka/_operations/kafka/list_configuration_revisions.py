"""Generated from Smithy shape ``com.amazonaws.kafka#ListConfigurationRevisions``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.list_configuration_revisions_response.ListConfigurationRevisionsResponse = aws_sdk_kafka.types.list_configuration_revisions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.list_configuration_revisions_request.ListConfigurationRevisionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/configurations/{Arn}/revisions"
