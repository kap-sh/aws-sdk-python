...
def handle_response(
    ...
    out: aws_sdk_kafka.types.batch_disassociate_scram_secret_response.BatchDisassociateScramSecretResponse = aws_sdk_kafka.types.batch_disassociate_scram_secret_response.deserialize_json(
