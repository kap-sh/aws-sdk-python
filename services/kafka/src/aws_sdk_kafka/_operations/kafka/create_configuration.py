...
def build_request(
    ...
    input: aws_sdk_kafka.types.create_configuration_request.CreateConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.create_configuration_request.serialize_json(input)
    ).encode()
