...
def handle_response(
    ...
    out: aws_sdk_kafka.types.create_configuration_response.CreateConfigurationResponse = aws_sdk_kafka.types.create_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.create_configuration_request.CreateConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.create_configuration_request.serialize_json(input_)
    ).encode()
