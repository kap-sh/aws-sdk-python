...
def handle_response(
    ...
    out: aws_sdk_kafka.types.create_replicator_response.CreateReplicatorResponse = (
        aws_sdk_kafka.types.create_replicator_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.create_replicator_request.CreateReplicatorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.create_replicator_request.serialize_json(input_)
    ).encode()
