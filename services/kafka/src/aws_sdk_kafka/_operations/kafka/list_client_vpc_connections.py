"""Generated from Smithy shape ``com.amazonaws.kafka#ListClientVpcConnections``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.list_client_vpc_connections_response.ListClientVpcConnectionsResponse = aws_sdk_kafka.types.list_client_vpc_connections_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.list_client_vpc_connections_request.ListClientVpcConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/clusters/{ClusterArn}/client-vpc-connections"
...
async def async_list_client_vpc_connections(
