...
def handle_response(
    ...
    out: aws_sdk_kafka.types.list_cluster_operations_v2_response.ListClusterOperationsV2Response = aws_sdk_kafka.types.list_cluster_operations_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.list_cluster_operations_v2_request.ListClusterOperationsV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
