...
def handle_response(
    ...
    out: aws_sdk_kafka.types.list_vpc_connections_response.ListVpcConnectionsResponse = aws_sdk_kafka.types.list_vpc_connections_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.list_vpc_connections_request.ListVpcConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
