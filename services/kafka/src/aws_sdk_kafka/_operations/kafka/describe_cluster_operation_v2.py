...
def build_request(
    ...
    input: aws_sdk_kafka.types.describe_cluster_operation_v2_request.DescribeClusterOperationV2Request,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ClusterOperationArn}", quote(str(input["cluster_operation_arn"]), safe="")
    )
    params: dict[str, str] = {}
