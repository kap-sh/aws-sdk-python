...
def handle_response(
    ...
    out: aws_sdk_kafka.types.list_nodes_response.ListNodesResponse = (
        aws_sdk_kafka.types.list_nodes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.list_nodes_request.ListNodesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_nodes(
    ...
    input_: aws_sdk_kafka.types.list_nodes_request.ListNodesRequest,
) -> tuple[aws_sdk_kafka.types.list_nodes_response.ListNodesResponse, zapros.Response]:
