"""Generated from Smithy shape ``com.amazonaws.kafka#DeleteConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.delete_configuration_response.DeleteConfigurationResponse = aws_sdk_kafka.types.delete_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.delete_configuration_request.DeleteConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/configurations/{Arn}"
