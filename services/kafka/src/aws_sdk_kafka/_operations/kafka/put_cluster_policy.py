"""Generated from Smithy shape ``com.amazonaws.kafka#PutClusterPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.put_cluster_policy_response.PutClusterPolicyResponse = (
        aws_sdk_kafka.types.put_cluster_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.put_cluster_policy_request.PutClusterPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.put_cluster_policy_request.serialize_json(input_)
    ).encode()
