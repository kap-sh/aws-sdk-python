"""Generated from Smithy shape ``com.amazonaws.kafka#DeleteClusterPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.delete_cluster_policy_response.DeleteClusterPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.delete_cluster_policy_request.DeleteClusterPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
