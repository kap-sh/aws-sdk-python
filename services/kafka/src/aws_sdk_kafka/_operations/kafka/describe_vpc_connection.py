"""Generated from Smithy shape ``com.amazonaws.kafka#DescribeVpcConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.describe_vpc_connection_response.DescribeVpcConnectionResponse = aws_sdk_kafka.types.describe_vpc_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.describe_vpc_connection_request.DescribeVpcConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/vpc-connection/{Arn}"
