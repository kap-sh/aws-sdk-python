...
def handle_response(
    ...
    out: aws_sdk_kafka.types.list_replicators_response.ListReplicatorsResponse = (
        aws_sdk_kafka.types.list_replicators_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_kafka.types.list_replicators_request.ListReplicatorsRequest,
) -> zapros.Request:
    ...
    if "replicator_name_filter" in input:
        params["replicatorNameFilter"] = str(input["replicator_name_filter"])
