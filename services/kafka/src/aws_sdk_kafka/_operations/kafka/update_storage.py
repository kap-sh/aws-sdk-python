"""Generated from Smithy shape ``com.amazonaws.kafka#UpdateStorage``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.update_storage_response.UpdateStorageResponse = (
        aws_sdk_kafka.types.update_storage_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.update_storage_request.UpdateStorageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/clusters/{ClusterArn}/storage"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.update_storage_request.serialize_json(input_)
    ).encode()
...
def update_storage(
    ...
    aws_sdk_kafka.types.update_storage_response.UpdateStorageResponse, zapros.Response
]:
...
async def async_update_storage(
