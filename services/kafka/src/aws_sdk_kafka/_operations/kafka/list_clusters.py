...
def handle_response(
    ...
    out: aws_sdk_kafka.types.list_clusters_response.ListClustersResponse = (
        aws_sdk_kafka.types.list_clusters_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_kafka.types.list_clusters_request.ListClustersRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "cluster_name_filter" in input:
        params["clusterNameFilter"] = str(input["cluster_name_filter"])
...
def list_clusters(
    ...
    aws_sdk_kafka.types.list_clusters_response.ListClustersResponse, zapros.Response
]:
