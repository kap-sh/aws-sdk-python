...
def handle_response(
    ...
    out: aws_sdk_kafka.types.list_kafka_versions_response.ListKafkaVersionsResponse = (
        aws_sdk_kafka.types.list_kafka_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.list_kafka_versions_request.ListKafkaVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
