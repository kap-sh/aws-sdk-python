...
import aws_sdk_kafka.errors.topic_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TopicExistsException":
            raise aws_sdk_kafka.errors.topic_exists_exception.TopicExistsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.create_topic_response.CreateTopicResponse = (
        aws_sdk_kafka.types.create_topic_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.create_topic_request.CreateTopicRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.create_topic_request.serialize_json(input_)
    ).encode()
...
def create_topic(
    ...
    aws_sdk_kafka.types.create_topic_response.CreateTopicResponse, zapros.Response
]:
