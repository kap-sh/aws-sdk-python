"""Generated from Smithy shape ``com.amazonaws.kafka#CreateVpcConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.create_vpc_connection_response.CreateVpcConnectionResponse = aws_sdk_kafka.types.create_vpc_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.create_vpc_connection_request.CreateVpcConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/vpc-connection"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_kafka.types.create_vpc_connection_request

    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.create_vpc_connection_request.serialize_json(input_)
    ).encode()
...
async def async_create_vpc_connection(
