...
def build_request(
    ...
    input: aws_sdk_kafka.types.create_vpc_connection_request.CreateVpcConnectionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.create_vpc_connection_request.serialize_json(input)
    ).encode()
