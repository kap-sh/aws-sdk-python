"""Generated from Smithy shape ``com.amazonaws.kafka#ListTopics``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.list_topics_response.ListTopicsResponse = (
        aws_sdk_kafka.types.list_topics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.list_topics_request.ListTopicsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "topic_name_filter" in input_:
        params["topicNameFilter"] = str(input_["topic_name_filter"])
...
def list_topics(
    ...
    aws_sdk_kafka.types.list_topics_response.ListTopicsResponse, zapros.Response
]:
