...
def handle_response(
    ...
    out: aws_sdk_kafka.types.update_security_response.UpdateSecurityResponse = (
        aws_sdk_kafka.types.update_security_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.update_security_request.UpdateSecurityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.update_security_request.serialize_json(input_)
    ).encode()
...
def update_security(
    ...
    aws_sdk_kafka.types.update_security_response.UpdateSecurityResponse, zapros.Response
]:
