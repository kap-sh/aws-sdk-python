"""Generated from Smithy shape ``com.amazonaws.kafka#UpdateReplicationInfo``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.update_replication_info_response.UpdateReplicationInfoResponse = aws_sdk_kafka.types.update_replication_info_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_kafka.types.update_replication_info_request.UpdateReplicationInfoRequest,
) -> zapros.Request:
    ...
    url = url.replace("{ReplicatorArn}", quote(str(input["replicator_arn"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_kafka.types.update_replication_info_request

    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.update_replication_info_request.serialize_json(input)
    ).encode()
...
async def async_update_replication_info(
