...
def handle_response(
    ...
    out: aws_sdk_kafka.types.update_monitoring_response.UpdateMonitoringResponse = (
        aws_sdk_kafka.types.update_monitoring_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.update_monitoring_request.UpdateMonitoringRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.update_monitoring_request.serialize_json(input_)
    ).encode()
