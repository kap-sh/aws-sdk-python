...
def build_request(
    ...
    input: aws_sdk_kafka.types.reject_client_vpc_connection_request.RejectClientVpcConnectionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.reject_client_vpc_connection_request.serialize_json(input)
    ).encode()
