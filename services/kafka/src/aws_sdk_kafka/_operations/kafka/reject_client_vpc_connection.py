...
def handle_response(
    ...
    out: aws_sdk_kafka.types.reject_client_vpc_connection_response.RejectClientVpcConnectionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.reject_client_vpc_connection_request.RejectClientVpcConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.reject_client_vpc_connection_request.serialize_json(input_)
    ).encode()
