"""Generated from Smithy shape ``com.amazonaws.kafka#GetCompatibleKafkaVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_kafka.types.get_compatible_kafka_versions_response.GetCompatibleKafkaVersionsResponse = aws_sdk_kafka.types.get_compatible_kafka_versions_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_kafka.types.get_compatible_kafka_versions_request.GetCompatibleKafkaVersionsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/v1/compatible-kafka-versions"
    params: dict[str, str] = {}
...
async def async_get_compatible_kafka_versions(
