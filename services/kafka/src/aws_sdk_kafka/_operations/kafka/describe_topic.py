...
def handle_response(
    ...
    out: aws_sdk_kafka.types.describe_topic_response.DescribeTopicResponse = (
        aws_sdk_kafka.types.describe_topic_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.describe_topic_request.DescribeTopicRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_topic(
    ...
    aws_sdk_kafka.types.describe_topic_response.DescribeTopicResponse, zapros.Response
]:
