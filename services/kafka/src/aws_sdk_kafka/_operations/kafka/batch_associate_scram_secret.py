...
def handle_response(
    ...
    out: aws_sdk_kafka.types.batch_associate_scram_secret_response.BatchAssociateScramSecretResponse = aws_sdk_kafka.types.batch_associate_scram_secret_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.batch_associate_scram_secret_request.BatchAssociateScramSecretRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.batch_associate_scram_secret_request.serialize_json(input_)
    ).encode()
