...
def build_request(
    ...
    input: aws_sdk_kafka.types.batch_associate_scram_secret_request.BatchAssociateScramSecretRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kafka.types.batch_associate_scram_secret_request.serialize_json(input)
    ).encode()
