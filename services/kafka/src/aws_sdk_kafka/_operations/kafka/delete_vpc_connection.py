...
def handle_response(
    ...
    out: aws_sdk_kafka.types.delete_vpc_connection_response.DeleteVpcConnectionResponse = aws_sdk_kafka.types.delete_vpc_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_kafka.types.delete_vpc_connection_request.DeleteVpcConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
