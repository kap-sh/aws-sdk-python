...
if TYPE_CHECKING:
    import capo_transfer.types.as2_transport

As2Transports: TypeAlias = list["capo_transfer.types.as2_transport.As2Transport"]
...
def serialize_aws_json_1_1(value: As2Transports) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_transfer.types.as2_transport.serialize_aws_json_1_1(item))
    return out
