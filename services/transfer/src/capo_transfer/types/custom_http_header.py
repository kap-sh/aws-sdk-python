...
if TYPE_CHECKING:
    import capo_transfer.types.custom_http_header_key_type
    import capo_transfer.types.custom_http_header_value_type


class CustomHttpHeader(TypedDict, closed=True):
    key: NotRequired[
        "capo_transfer.types.custom_http_header_key_type.CustomHttpHeaderKeyType"
    ]
    """<p>The name of the custom HTTP header.</p>"""
    value: NotRequired[
        "capo_transfer.types.custom_http_header_value_type.CustomHttpHeaderValueType"
    ]
