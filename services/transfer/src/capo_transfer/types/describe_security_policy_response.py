...
class DescribeSecurityPolicyResponse(TypedDict, closed=True):
    security_policy: (
        "capo_transfer.types.described_security_policy.DescribedSecurityPolicy"
    )
...
def serialize_aws_json_1_1(value: DescribeSecurityPolicyResponse) -> dict:
    ...
    out["SecurityPolicy"] = (
        capo_transfer.types.described_security_policy.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeSecurityPolicyResponse:
    ...
    if "SecurityPolicy" in data:
        ...
        out["security_policy"] = (
            capo_transfer.types.described_security_policy.deserialize_aws_json_1_1(
                data["SecurityPolicy"]
            )
        )
    else:
