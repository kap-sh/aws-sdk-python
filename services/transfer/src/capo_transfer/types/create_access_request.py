"""Generated from Smithy shape ``com.amazonaws.transfer#CreateAccessRequest``."""
...
class CreateAccessRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateAccessRequest) -> dict:
    out: dict = {}
