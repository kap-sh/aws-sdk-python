...
class SftpConnectorConfig(TypedDict, closed=True):
    user_secret_id: NotRequired["capo_transfer.types.secret_id.SecretId"]
    ...
    trusted_host_keys: NotRequired[
        "capo_transfer.types.sftp_connector_trusted_host_key_list.SftpConnectorTrustedHostKeyList"
    ]
...
def serialize_aws_json_1_1(value: SftpConnectorConfig) -> dict:
    ...
    if "trusted_host_keys" in value:
        ...
        out["TrustedHostKeys"] = (
            capo_transfer.types.sftp_connector_trusted_host_key_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SftpConnectorConfig:
    ...
    if "TrustedHostKeys" in data:
        ...
        out["trusted_host_keys"] = (
            capo_transfer.types.sftp_connector_trusted_host_key_list.deserialize_aws_json_1_1(
