...
class WorkflowStep(TypedDict, closed=True):
    type: NotRequired["capo_transfer.types.workflow_step_type.WorkflowStepType"]
    ...
    copy_step_details: NotRequired[
        "capo_transfer.types.copy_step_details.CopyStepDetails"
    ]
    ...
    custom_step_details: NotRequired[
        "capo_transfer.types.custom_step_details.CustomStepDetails"
    ]
    ...
    delete_step_details: NotRequired[
        "capo_transfer.types.delete_step_details.DeleteStepDetails"
    ]
    """<p>Details for a step that deletes the file.</p>"""
    tag_step_details: NotRequired["capo_transfer.types.tag_step_details.TagStepDetails"]
    ...
    decrypt_step_details: NotRequired[
        "capo_transfer.types.decrypt_step_details.DecryptStepDetails"
    ]
...
def serialize_aws_json_1_1(value: WorkflowStep) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = capo_transfer.types.workflow_step_type.serialize_aws_json_1_1(
            value["type"]
        )
    if "copy_step_details" in value:
        ...
        out["CopyStepDetails"] = (
            capo_transfer.types.copy_step_details.serialize_aws_json_1_1(
    ...
    if "custom_step_details" in value:
        ...
        out["CustomStepDetails"] = (
            capo_transfer.types.custom_step_details.serialize_aws_json_1_1(
    ...
    if "delete_step_details" in value:
        ...
        out["DeleteStepDetails"] = (
            capo_transfer.types.delete_step_details.serialize_aws_json_1_1(
    ...
    if "tag_step_details" in value:
        ...
        out["TagStepDetails"] = (
            capo_transfer.types.tag_step_details.serialize_aws_json_1_1(
    ...
    if "decrypt_step_details" in value:
        ...
        out["DecryptStepDetails"] = (
            capo_transfer.types.decrypt_step_details.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> WorkflowStep:
    ...
    if "CopyStepDetails" in data:
        ...
        out["copy_step_details"] = (
            capo_transfer.types.copy_step_details.deserialize_aws_json_1_1(
    ...
    if "CustomStepDetails" in data:
        ...
        out["custom_step_details"] = (
            capo_transfer.types.custom_step_details.deserialize_aws_json_1_1(
    ...
    if "DeleteStepDetails" in data:
        ...
        out["delete_step_details"] = (
            capo_transfer.types.delete_step_details.deserialize_aws_json_1_1(
    ...
    if "TagStepDetails" in data:
        ...
        out["tag_step_details"] = (
            capo_transfer.types.tag_step_details.deserialize_aws_json_1_1(
                data["TagStepDetails"]
            )
        )
    if "DecryptStepDetails" in data:
        ...
        out["decrypt_step_details"] = (
            capo_transfer.types.decrypt_step_details.deserialize_aws_json_1_1(
