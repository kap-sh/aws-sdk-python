...
from capo_transfer._resources.transfer_service.profile_resource import ProfileResource
from capo_transfer._resources.transfer_service.server_resource import ServerResource
from capo_transfer._resources.transfer_service.user_resource import UserResource
from capo_transfer._resources.transfer_service.web_app_customization_resource import (
    WebAppCustomizationResource,
)
from capo_transfer._resources.transfer_service.web_app_resource import WebAppResource
from capo_transfer._resources.transfer_service.workflow_resource import WorkflowResource
from capo_transfer._services._aws_config import aws_config
...
class TransferClient:
    ...
    def __init__(
        ...
        self._config = TransferClientConfig(
            {
        ...
        # resources
        self.agreement_resource = AgreementResource(self)
        self.certificate_resource = CertificateResource(self)
        self.connector_resource = ConnectorResource(self)
        self.profile_resource = ProfileResource(self)
        self.server_resource = ServerResource(self)
        self.user_resource = UserResource(self)
        self.web_app_customization_resource = WebAppCustomizationResource(self)
        self.web_app_resource = WebAppResource(self)
        self.workflow_resource = WorkflowResource(self)

    def operation_options(
        self, config_overrides: Optional[TransferClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: TransferClientConfig = config_overrides or {}
    ...
    def create_access(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.create_access_request.CreateAccessRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.create_access_response.CreateAccessResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.create_access.create_access(
    ...
    def delete_access(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.delete_access_request.DeleteAccessRequest]",
        ) -> OperationResponse[None]:
            import capo_transfer._operations.transfer_service.delete_access

            output, http_response = (
                capo_transfer._operations.transfer_service.delete_access.delete_access(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_host_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.delete_host_key_request.DeleteHostKeyRequest]",
        ) -> OperationResponse[None]:
            import capo_transfer._operations.transfer_service.delete_host_key

            output, http_response = (
                capo_transfer._operations.transfer_service.delete_host_key.delete_host_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_ssh_public_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.delete_ssh_public_key_request.DeleteSshPublicKeyRequest]",
        ) -> OperationResponse[None]:
            import capo_transfer._operations.transfer_service.delete_ssh_public_key

            output, http_response = (
                capo_transfer._operations.transfer_service.delete_ssh_public_key.delete_ssh_public_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_access(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.describe_access_request.DescribeAccessRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.describe_access_response.DescribeAccessResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.describe_access.describe_access(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_execution(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.describe_execution_request.DescribeExecutionRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.describe_execution_response.DescribeExecutionResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.describe_execution.describe_execution(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_host_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.describe_host_key_request.DescribeHostKeyRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.describe_host_key_response.DescribeHostKeyResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.describe_host_key.describe_host_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_security_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.describe_security_policy_request.DescribeSecurityPolicyRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.describe_security_policy_response.DescribeSecurityPolicyResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.describe_security_policy.describe_security_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def import_host_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.import_host_key_request.ImportHostKeyRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.import_host_key_response.ImportHostKeyResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.import_host_key.import_host_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def import_ssh_public_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.import_ssh_public_key_request.ImportSshPublicKeyRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.import_ssh_public_key_response.ImportSshPublicKeyResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.import_ssh_public_key.import_ssh_public_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_accesses(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.list_accesses_request.ListAccessesRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.list_accesses_response.ListAccessesResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.list_accesses.list_accesses(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_accesses(
        ...
        *,
        ...
        max_results: Optional["capo_transfer.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_transfer.types.next_token.NextToken"] = None,
    ) -> "Iterator[capo_transfer.types.listed_access.ListedAccess]":
        _token = next_token
        while True:
            _response = self.list_accesses(
                server_id,
    ...
    def list_executions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.list_executions_request.ListExecutionsRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.list_executions_response.ListExecutionsResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.list_executions.list_executions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_executions(
        ...
        *,
        ...
        max_results: Optional["capo_transfer.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_transfer.types.next_token.NextToken"] = None,
    ) -> "Iterator[capo_transfer.types.listed_execution.ListedExecution]":
        _token = next_token
        while True:
    ...
    def list_file_transfer_results(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.list_file_transfer_results_request.ListFileTransferResultsRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.list_file_transfer_results_response.ListFileTransferResultsResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.list_file_transfer_results.list_file_transfer_results(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_file_transfer_results(
        ...
        *,
        ...
        next_token: Optional["capo_transfer.types.next_token.NextToken"] = None,
        max_results: Optional["capo_transfer.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_transfer.types.connector_file_transfer_result.ConnectorFileTransferResult]":
        _token = next_token
        while True:
            _response = self.list_file_transfer_results(
                connector_id,
                transfer_id,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    def list_host_keys(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.list_host_keys_request.ListHostKeysRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.list_host_keys_response.ListHostKeysResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.list_host_keys.list_host_keys(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_security_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.list_security_policies_request.ListSecurityPoliciesRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.list_security_policies_response.ListSecurityPoliciesResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.list_security_policies.list_security_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_security_policies(
        ...
        *,
        ...
        max_results: Optional["capo_transfer.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_transfer.types.next_token.NextToken"] = None,
    ) -> "Iterator[capo_transfer.types.security_policy_name.SecurityPolicyName]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_tags_for_resource(
        ...
        *,
        ...
        max_results: Optional["capo_transfer.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_transfer.types.next_token.NextToken"] = None,
    ) -> "Iterator[capo_transfer.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    def send_workflow_step_state(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.send_workflow_step_state_request.SendWorkflowStepStateRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.send_workflow_step_state_response.SendWorkflowStepStateResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.send_workflow_step_state.send_workflow_step_state(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_directory_listing(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.start_directory_listing_request.StartDirectoryListingRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.start_directory_listing_response.StartDirectoryListingResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.start_directory_listing.start_directory_listing(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_file_transfer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.start_file_transfer_request.StartFileTransferRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.start_file_transfer_response.StartFileTransferResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.start_file_transfer.start_file_transfer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_remote_delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.start_remote_delete_request.StartRemoteDeleteRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.start_remote_delete_response.StartRemoteDeleteResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.start_remote_delete.start_remote_delete(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_remote_move(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.start_remote_move_request.StartRemoteMoveRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.start_remote_move_response.StartRemoteMoveResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.start_remote_move.start_remote_move(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_server(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.start_server_request.StartServerRequest]",
        ) -> OperationResponse[None]:
            import capo_transfer._operations.transfer_service.start_server

            output, http_response = (
                capo_transfer._operations.transfer_service.start_server.start_server(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_server(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.stop_server_request.StopServerRequest]",
        ) -> OperationResponse[None]:
            import capo_transfer._operations.transfer_service.stop_server

            output, http_response = (
                capo_transfer._operations.transfer_service.stop_server.stop_server(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[None]:
            import capo_transfer._operations.transfer_service.tag_resource

            output, http_response = (
                capo_transfer._operations.transfer_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def test_connection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.test_connection_request.TestConnectionRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.test_connection_response.TestConnectionResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.test_connection.test_connection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def test_identity_provider(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.test_identity_provider_request.TestIdentityProviderRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.test_identity_provider_response.TestIdentityProviderResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.test_identity_provider.test_identity_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[None]:
            import capo_transfer._operations.transfer_service.untag_resource

            output, http_response = (
                capo_transfer._operations.transfer_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_access(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.update_access_request.UpdateAccessRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.update_access_response.UpdateAccessResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.update_access.update_access(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_host_key(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_transfer.types.update_host_key_request.UpdateHostKeyRequest]",
        ) -> OperationResponse[
            "capo_transfer.types.update_host_key_response.UpdateHostKeyResponse"
        ]:
            ...
            output, http_response = (
                capo_transfer._operations.transfer_service.update_host_key.update_host_key(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
