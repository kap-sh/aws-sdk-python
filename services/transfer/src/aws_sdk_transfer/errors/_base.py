...
class TransferError(Exception):
    """Base class for all Transfer service errors."""
...
class SerializationError(TransferError):
    """Raised when a value cannot be serialized."""


class DeserializationError(TransferError):
...
class WaiterFailedError(TransferError):
...
class WaiterTimeoutError(TransferError):
