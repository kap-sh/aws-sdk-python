...
if TYPE_CHECKING:
    ...
    import aws_sdk_transfer.types.connector_egress_type
    import aws_sdk_transfer.types.connector_error_message
    import aws_sdk_transfer.types.connector_id
    import aws_sdk_transfer.types.connector_security_policy_name
    import aws_sdk_transfer.types.connector_status
    import aws_sdk_transfer.types.connectors_ip_address_type
    import aws_sdk_transfer.types.described_connector_egress_config
    import aws_sdk_transfer.types.role
    import aws_sdk_transfer.types.service_managed_egress_ip_addresses
...
class DescribedConnector(TypedDict):
    ...
    service_managed_egress_ip_addresses: NotRequired[
        "aws_sdk_transfer.types.service_managed_egress_ip_addresses.ServiceManagedEgressIpAddresses"
    ]
    ...
    egress_config: NotRequired[
        "aws_sdk_transfer.types.described_connector_egress_config.DescribedConnectorEgressConfig"
    ]
    ...
    egress_type: "aws_sdk_transfer.types.connector_egress_type.ConnectorEgressType"
    ...
    error_message: NotRequired[
        "aws_sdk_transfer.types.connector_error_message.ConnectorErrorMessage"
    ]
    ...
    status: "aws_sdk_transfer.types.connector_status.ConnectorStatus"
...
def serialize_aws_json_1_1(value: DescribedConnector) -> dict:
    ...
    if "service_managed_egress_ip_addresses" in value:
        ...
        out["ServiceManagedEgressIpAddresses"] = (
            aws_sdk_transfer.types.service_managed_egress_ip_addresses.serialize_aws_json_1_1(
    ...
    if "egress_config" in value:
        ...
        out["EgressConfig"] = (
            aws_sdk_transfer.types.described_connector_egress_config.serialize_aws_json_1_1(
                value["egress_config"]
            )
        )
    import aws_sdk_transfer.types.connector_egress_type
    ...
    out["EgressType"] = (
        aws_sdk_transfer.types.connector_egress_type.serialize_aws_json_1_1(
    ...
    out["Status"] = aws_sdk_transfer.types.connector_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribedConnector:
    ...
    if "ServiceManagedEgressIpAddresses" in data:
        ...
        out["service_managed_egress_ip_addresses"] = (
            aws_sdk_transfer.types.service_managed_egress_ip_addresses.deserialize_aws_json_1_1(
    ...
    if "EgressConfig" in data:
        ...
        out["egress_config"] = (
            aws_sdk_transfer.types.described_connector_egress_config.deserialize_aws_json_1_1(
                data["EgressConfig"]
            )
        )
    if "EgressType" in data:
        ...
        out["egress_type"] = (
            aws_sdk_transfer.types.connector_egress_type.deserialize_aws_json_1_1(
                data["EgressType"]
            )
        )
    else:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_transfer.types.connector_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
    else:
