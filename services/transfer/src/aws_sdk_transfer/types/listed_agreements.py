...
ListedAgreements: TypeAlias = list[
    "aws_sdk_transfer.types.listed_agreement.ListedAgreement"
]
...
def serialize_aws_json_1_1(value: ListedAgreements) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_transfer.types.listed_agreement.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> ListedAgreements:
    ...
    for item in data:
        out.append(
            aws_sdk_transfer.types.listed_agreement.deserialize_aws_json_1_1(item)
        )
    return out
