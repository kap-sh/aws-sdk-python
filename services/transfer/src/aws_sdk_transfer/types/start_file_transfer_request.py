...
class StartFileTransferRequest(TypedDict):
    connector_id: "aws_sdk_transfer.types.connector_id.ConnectorId"
    """<p>The unique identifier for the connector.</p>"""
    send_file_paths: NotRequired["aws_sdk_transfer.types.file_paths.FilePaths"]
    ...
    retrieve_file_paths: NotRequired["aws_sdk_transfer.types.file_paths.FilePaths"]
    ...
    local_directory_path: NotRequired["aws_sdk_transfer.types.file_path.FilePath"]
    ...
    remote_directory_path: NotRequired["aws_sdk_transfer.types.file_path.FilePath"]
...
def serialize_aws_json_1_1(value: StartFileTransferRequest) -> dict:
    ...
    if "send_file_paths" in value:
        ...
        out["SendFilePaths"] = aws_sdk_transfer.types.file_paths.serialize_aws_json_1_1(
    ...
    if "retrieve_file_paths" in value:
        ...
        out["RetrieveFilePaths"] = (
            aws_sdk_transfer.types.file_paths.serialize_aws_json_1_1(
    ...
    if "custom_http_headers" in value:
        ...
        out["CustomHttpHeaders"] = (
            aws_sdk_transfer.types.custom_http_headers.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> StartFileTransferRequest:
    ...
    if "SendFilePaths" in data:
        ...
        out["send_file_paths"] = (
            aws_sdk_transfer.types.file_paths.deserialize_aws_json_1_1(
                data["SendFilePaths"]
            )
        )
    ...
    if "CustomHttpHeaders" in data:
        ...
        out["custom_http_headers"] = (
            aws_sdk_transfer.types.custom_http_headers.deserialize_aws_json_1_1(
