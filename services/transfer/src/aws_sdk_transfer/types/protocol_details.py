...
if TYPE_CHECKING:
    import aws_sdk_transfer.types.as2_transports
    import aws_sdk_transfer.types.passive_ip
    import aws_sdk_transfer.types.set_stat_option
    import aws_sdk_transfer.types.tls_session_resumption_mode


class ProtocolDetails(TypedDict):
    passive_ip: NotRequired["aws_sdk_transfer.types.passive_ip.PassiveIp"]
    ...
    tls_session_resumption_mode: NotRequired[
        "aws_sdk_transfer.types.tls_session_resumption_mode.TlsSessionResumptionMode"
    ]
    ...
    set_stat_option: NotRequired["aws_sdk_transfer.types.set_stat_option.SetStatOption"]
    ...
    as2_transports: NotRequired["aws_sdk_transfer.types.as2_transports.As2Transports"]
...
def serialize_aws_json_1_1(value: ProtocolDetails) -> dict:
    ...
    if "tls_session_resumption_mode" in value:
        ...
        out["TlsSessionResumptionMode"] = (
            aws_sdk_transfer.types.tls_session_resumption_mode.serialize_aws_json_1_1(
    ...
    if "set_stat_option" in value:
        ...
        out["SetStatOption"] = (
            aws_sdk_transfer.types.set_stat_option.serialize_aws_json_1_1(
    ...
    if "as2_transports" in value:
        ...
        out["As2Transports"] = (
            aws_sdk_transfer.types.as2_transports.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ProtocolDetails:
    ...
    if "TlsSessionResumptionMode" in data:
        ...
        out["tls_session_resumption_mode"] = (
            aws_sdk_transfer.types.tls_session_resumption_mode.deserialize_aws_json_1_1(
    ...
    if "SetStatOption" in data:
        ...
        out["set_stat_option"] = (
            aws_sdk_transfer.types.set_stat_option.deserialize_aws_json_1_1(
                data["SetStatOption"]
            )
        )
    if "As2Transports" in data:
        ...
        out["as2_transports"] = (
            aws_sdk_transfer.types.as2_transports.deserialize_aws_json_1_1(
                data["As2Transports"]
            )
        )
    return out
