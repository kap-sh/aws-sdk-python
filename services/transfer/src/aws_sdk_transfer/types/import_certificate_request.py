...
class ImportCertificateRequest(TypedDict, closed=True):
    ...
    private_key: NotRequired["aws_sdk_transfer.types.private_key_type.PrivateKeyType"]
...
def serialize_aws_json_1_1(value: ImportCertificateRequest) -> dict:
    ...
    out["Usage"] = aws_sdk_transfer.types.certificate_usage_type.serialize_aws_json_1_1(
        value["usage"]
    )
