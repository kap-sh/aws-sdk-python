"""Generated from Smithy shape ``com.amazonaws.transfer#UpdateServerRequest``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateServerRequest) -> dict:
    out: dict = {}
