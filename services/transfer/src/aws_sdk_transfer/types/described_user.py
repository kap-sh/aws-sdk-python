...
if TYPE_CHECKING:
    ...
    import aws_sdk_transfer.types.ssh_public_keys
    import aws_sdk_transfer.types.tags
    import aws_sdk_transfer.types.user_name


class DescribedUser(TypedDict):
    ...
    ssh_public_keys: NotRequired["aws_sdk_transfer.types.ssh_public_keys.SshPublicKeys"]
...
def serialize_aws_json_1_1(value: DescribedUser) -> dict:
    ...
    if "ssh_public_keys" in value:
        ...
        out["SshPublicKeys"] = (
            aws_sdk_transfer.types.ssh_public_keys.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribedUser:
    ...
    if "SshPublicKeys" in data:
        ...
        out["ssh_public_keys"] = (
            aws_sdk_transfer.types.ssh_public_keys.deserialize_aws_json_1_1(
                data["SshPublicKeys"]
            )
        )
    if "Tags" in data:
