...
if TYPE_CHECKING:
    import aws_sdk_transfer.types.update_web_app_identity_center_config


class _UpdateWebAppIdentityProviderDetails_IdentityCenterConfig(TypedDict):
    IdentityCenterConfig: "aws_sdk_transfer.types.update_web_app_identity_center_config.UpdateWebAppIdentityCenterConfig"
...
def serialize_aws_json_1_1(value: UpdateWebAppIdentityProviderDetails) -> dict:
    if "IdentityCenterConfig" in value:
        ...
        return {
            "IdentityCenterConfig": aws_sdk_transfer.types.update_web_app_identity_center_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UpdateWebAppIdentityProviderDetails:
    if "IdentityCenterConfig" in data:
        ...
        return {
            "IdentityCenterConfig": aws_sdk_transfer.types.update_web_app_identity_center_config.deserialize_aws_json_1_1(
