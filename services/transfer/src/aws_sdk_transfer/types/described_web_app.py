...
if TYPE_CHECKING:
    ...
    import aws_sdk_transfer.types.described_web_app_endpoint_details
    import aws_sdk_transfer.types.described_web_app_identity_provider_details
    import aws_sdk_transfer.types.tags
    import aws_sdk_transfer.types.web_app_access_endpoint
    import aws_sdk_transfer.types.web_app_endpoint
    import aws_sdk_transfer.types.web_app_endpoint_policy
    import aws_sdk_transfer.types.web_app_endpoint_type
    import aws_sdk_transfer.types.web_app_id
    import aws_sdk_transfer.types.web_app_units


class DescribedWebApp(TypedDict):
    ...
    described_identity_provider_details: NotRequired[
        "aws_sdk_transfer.types.described_web_app_identity_provider_details.DescribedWebAppIdentityProviderDetails"
    ]
    ...
    web_app_endpoint: NotRequired[
        "aws_sdk_transfer.types.web_app_endpoint.WebAppEndpoint"
    ]
    ...
    endpoint_type: NotRequired[
        "aws_sdk_transfer.types.web_app_endpoint_type.WebAppEndpointType"
    ]
    ...
    described_endpoint_details: NotRequired[
        "aws_sdk_transfer.types.described_web_app_endpoint_details.DescribedWebAppEndpointDetails"
    ]
...
def serialize_aws_json_1_1(value: DescribedWebApp) -> dict:
    ...
    if "described_identity_provider_details" in value:
        ...
        out["DescribedIdentityProviderDetails"] = (
            aws_sdk_transfer.types.described_web_app_identity_provider_details.serialize_aws_json_1_1(
    ...
    if "endpoint_type" in value:
        ...
        out["EndpointType"] = (
            aws_sdk_transfer.types.web_app_endpoint_type.serialize_aws_json_1_1(
                value["endpoint_type"]
            )
        )
    if "described_endpoint_details" in value:
        ...
        out["DescribedEndpointDetails"] = (
            aws_sdk_transfer.types.described_web_app_endpoint_details.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribedWebApp:
    ...
    if "DescribedIdentityProviderDetails" in data:
        ...
        out["described_identity_provider_details"] = (
            aws_sdk_transfer.types.described_web_app_identity_provider_details.deserialize_aws_json_1_1(
    ...
    if "EndpointType" in data:
        ...
        out["endpoint_type"] = (
            aws_sdk_transfer.types.web_app_endpoint_type.deserialize_aws_json_1_1(
                data["EndpointType"]
            )
        )
    if "DescribedEndpointDetails" in data:
        ...
        out["described_endpoint_details"] = (
            aws_sdk_transfer.types.described_web_app_endpoint_details.deserialize_aws_json_1_1(
