...
if TYPE_CHECKING:
    ...
    import aws_sdk_transfer.types.s3_input_file_location


class InputFileLocation(TypedDict):
    s3_file_location: NotRequired[
        "aws_sdk_transfer.types.s3_input_file_location.S3InputFileLocation"
    ]
...
def serialize_aws_json_1_1(value: InputFileLocation) -> dict:
    ...
    if "s3_file_location" in value:
        ...
        out["S3FileLocation"] = (
            aws_sdk_transfer.types.s3_input_file_location.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InputFileLocation:
    ...
    if "S3FileLocation" in data:
        ...
        out["s3_file_location"] = (
            aws_sdk_transfer.types.s3_input_file_location.deserialize_aws_json_1_1(
                data["S3FileLocation"]
            )
        )
