...
class DescribeCertificateResponse(TypedDict, closed=True):
    certificate: "aws_sdk_transfer.types.described_certificate.DescribedCertificate"
...
def serialize_aws_json_1_1(value: DescribeCertificateResponse) -> dict:
    ...
    out["Certificate"] = (
        aws_sdk_transfer.types.described_certificate.serialize_aws_json_1_1(
            value["certificate"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DescribeCertificateResponse:
    ...
    if "Certificate" in data:
        ...
        out["certificate"] = (
            aws_sdk_transfer.types.described_certificate.deserialize_aws_json_1_1(
                data["Certificate"]
            )
        )
    else:
