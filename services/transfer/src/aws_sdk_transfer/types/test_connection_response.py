...
if TYPE_CHECKING:
    ...
    import aws_sdk_transfer.types.sftp_connector_connection_details
    import aws_sdk_transfer.types.status
...
class TestConnectionResponse(TypedDict, closed=True):
    ...
    status: NotRequired["aws_sdk_transfer.types.status.Status"]
    """<p>Returns <code>OK</code> for successful test, or <code>ERROR</code> if the test fails.</p>"""
    status_message: NotRequired["aws_sdk_transfer.types.message.Message"]
    ...
    sftp_connection_details: NotRequired[
        "aws_sdk_transfer.types.sftp_connector_connection_details.SftpConnectorConnectionDetails"
    ]
...
def serialize_aws_json_1_1(value: TestConnectionResponse) -> dict:
    ...
    if "sftp_connection_details" in value:
        ...
        out["SftpConnectionDetails"] = (
            aws_sdk_transfer.types.sftp_connector_connection_details.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TestConnectionResponse:
    ...
    if "SftpConnectionDetails" in data:
        ...
        out["sftp_connection_details"] = (
            aws_sdk_transfer.types.sftp_connector_connection_details.deserialize_aws_json_1_1(
