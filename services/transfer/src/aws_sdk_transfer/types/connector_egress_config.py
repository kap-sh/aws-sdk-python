...
def serialize_aws_json_1_1(value: ConnectorEgressConfig) -> dict:
    if "VpcLattice" in value:
        ...
        return {
            "VpcLattice": aws_sdk_transfer.types.connector_vpc_lattice_egress_config.serialize_aws_json_1_1(
                value["VpcLattice"]
            )
        }
    else:
...
def deserialize_aws_json_1_1(data: dict) -> ConnectorEgressConfig:
    if "VpcLattice" in data:
        ...
        return {
            "VpcLattice": aws_sdk_transfer.types.connector_vpc_lattice_egress_config.deserialize_aws_json_1_1(
                data["VpcLattice"]
            )
        }
    else:
