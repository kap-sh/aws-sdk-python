...
class CustomDirectoriesType(TypedDict, closed=True):
    ...
    payload_files_directory: "aws_sdk_transfer.types.home_directory.HomeDirectory"
    """<p>Specifies a location to store the payload for AS2 message files.</p>"""
    status_files_directory: "aws_sdk_transfer.types.home_directory.HomeDirectory"
    """<p>Specifies a location to store AS2 status messages.</p>"""
    temporary_files_directory: "aws_sdk_transfer.types.home_directory.HomeDirectory"
