...
if TYPE_CHECKING:
    import aws_sdk_transfer.types.execution_error_message
    import aws_sdk_transfer.types.execution_error_type


class ExecutionError(TypedDict):
    type: "aws_sdk_transfer.types.execution_error_type.ExecutionErrorType"
    ...
    message: "aws_sdk_transfer.types.execution_error_message.ExecutionErrorMessage"
...
def serialize_aws_json_1_1(value: ExecutionError) -> dict:
    ...
    out["Type"] = aws_sdk_transfer.types.execution_error_type.serialize_aws_json_1_1(
        value["type"]
    )
...
def deserialize_aws_json_1_1(data: dict) -> ExecutionError:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_transfer.types.execution_error_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    else:
