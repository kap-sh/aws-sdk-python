...
class TestIdentityProviderRequest(TypedDict, closed=True):
    ...
    source_ip: NotRequired["aws_sdk_transfer.types.source_ip.SourceIp"]
    ...
    user_password: NotRequired["aws_sdk_transfer.types.user_password.UserPassword"]
...
def serialize_aws_json_1_1(value: TestIdentityProviderRequest) -> dict:
    ...
    if "server_protocol" in value:
        ...
        out["ServerProtocol"] = aws_sdk_transfer.types.protocol.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TestIdentityProviderRequest:
    ...
    if "ServerProtocol" in data:
        ...
        out["server_protocol"] = (
            aws_sdk_transfer.types.protocol.deserialize_aws_json_1_1(
                data["ServerProtocol"]
            )
        )
    if "SourceIp" in data:
