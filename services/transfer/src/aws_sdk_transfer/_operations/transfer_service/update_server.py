"""Generated from Smithy shape ``com.amazonaws.transfer#UpdateServer``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise aws_sdk_transfer.errors.access_denied_exception.AccessDeniedException.from_aws_json_1_1(
                data
            )
        case "ConflictException":
            raise aws_sdk_transfer.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
        ...
        case "ResourceExistsException":
            raise aws_sdk_transfer.errors.resource_exists_exception.ResourceExistsException.from_aws_json_1_1(
                data
            )
        ...
        case "ThrottlingException":
            raise aws_sdk_transfer.errors.throttling_exception.ThrottlingException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_transfer.types.update_server_response.UpdateServerResponse = (
        aws_sdk_transfer.types.update_server_response.deserialize_aws_json_1_1(
...
def get_signer(
...
) -> aws_sdk_transfer._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_transfer._auth._sigv4.build_sigv4_auth_scheme(
                "transfer", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_transfer._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.update_server_request.UpdateServerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.update_server_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_server(
    ...
    aws_sdk_transfer.types.update_server_response.UpdateServerResponse, zapros.Response
]:
