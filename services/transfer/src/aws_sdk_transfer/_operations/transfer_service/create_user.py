...
def handle_response(
    ...
    out: aws_sdk_transfer.types.create_user_response.CreateUserResponse = (
        aws_sdk_transfer.types.create_user_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.create_user_request.CreateUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.create_user_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_user(
    ...
    aws_sdk_transfer.types.create_user_response.CreateUserResponse, zapros.Response
]:
