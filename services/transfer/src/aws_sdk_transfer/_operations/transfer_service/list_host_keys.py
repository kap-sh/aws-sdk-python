...
def handle_response(
    ...
    out: aws_sdk_transfer.types.list_host_keys_response.ListHostKeysResponse = (
        aws_sdk_transfer.types.list_host_keys_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.list_host_keys_request.ListHostKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.list_host_keys_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_host_keys(
    ...
    aws_sdk_transfer.types.list_host_keys_response.ListHostKeysResponse, zapros.Response
]:
