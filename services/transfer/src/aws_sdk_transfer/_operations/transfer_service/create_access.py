...
def handle_response(
    ...
    out: aws_sdk_transfer.types.create_access_response.CreateAccessResponse = (
        aws_sdk_transfer.types.create_access_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.create_access_request.CreateAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.create_access_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_access(
    ...
    aws_sdk_transfer.types.create_access_response.CreateAccessResponse, zapros.Response
]:
