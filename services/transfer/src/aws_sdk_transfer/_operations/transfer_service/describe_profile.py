...
def build_request(
    ...
    input: aws_sdk_transfer.types.describe_profile_request.DescribeProfileRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.describe_profile_request.serialize_aws_json_1_1(input)
    ).encode()
