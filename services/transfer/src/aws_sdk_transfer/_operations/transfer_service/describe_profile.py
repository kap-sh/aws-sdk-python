"""Generated from Smithy shape ``com.amazonaws.transfer#DescribeProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_transfer.types.describe_profile_response.DescribeProfileResponse = (
        aws_sdk_transfer.types.describe_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.describe_profile_request.DescribeProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "TransferService.DescribeProfile"
    import aws_sdk_transfer.types.describe_profile_request

    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.describe_profile_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_profile(
