...
def handle_response(
    ...
    out: aws_sdk_transfer.types.start_remote_move_response.StartRemoteMoveResponse = (
        aws_sdk_transfer.types.start_remote_move_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_transfer.types.start_remote_move_request.StartRemoteMoveRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.start_remote_move_request.serialize_aws_json_1_1(input)
    ).encode()
