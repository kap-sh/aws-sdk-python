"""Generated from Smithy shape ``com.amazonaws.transfer#DeleteAgreement``."""
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.delete_agreement_request.DeleteAgreementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "TransferService.DeleteAgreement"
    import aws_sdk_transfer.types.delete_agreement_request

    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.delete_agreement_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_agreement(
