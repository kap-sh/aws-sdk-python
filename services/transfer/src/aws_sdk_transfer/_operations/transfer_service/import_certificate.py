...
def handle_response(
    ...
    out: aws_sdk_transfer.types.import_certificate_response.ImportCertificateResponse = aws_sdk_transfer.types.import_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.import_certificate_request.ImportCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.import_certificate_request.serialize_aws_json_1_1(input_)
    ).encode()
