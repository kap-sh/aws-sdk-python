...
def handle_response(
    ...
    out: aws_sdk_transfer.types.create_server_response.CreateServerResponse = (
        aws_sdk_transfer.types.create_server_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.create_server_request.CreateServerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.create_server_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_server(
    ...
    aws_sdk_transfer.types.create_server_response.CreateServerResponse, zapros.Response
]:
