"""Generated from Smithy shape ``com.amazonaws.transfer#StartDirectoryListing``."""
...
def handle_response(
    ...
    out: aws_sdk_transfer.types.start_directory_listing_response.StartDirectoryListingResponse = aws_sdk_transfer.types.start_directory_listing_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.start_directory_listing_request.StartDirectoryListingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_start_directory_listing(
