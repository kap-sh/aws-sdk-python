...
def handle_response(
    ...
    out: aws_sdk_transfer.types.describe_web_app_customization_response.DescribeWebAppCustomizationResponse = aws_sdk_transfer.types.describe_web_app_customization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.describe_web_app_customization_request.DescribeWebAppCustomizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.describe_web_app_customization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
