...
def handle_response(
    ...
    out: aws_sdk_transfer.types.describe_agreement_response.DescribeAgreementResponse = aws_sdk_transfer.types.describe_agreement_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.describe_agreement_request.DescribeAgreementRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.describe_agreement_request.serialize_aws_json_1_1(input_)
    ).encode()
