...
def build_request(
    ...
    input: aws_sdk_transfer.types.describe_agreement_request.DescribeAgreementRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.describe_agreement_request.serialize_aws_json_1_1(input)
    ).encode()
