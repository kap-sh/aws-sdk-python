...
def handle_response(
    ...
    out: aws_sdk_transfer.types.list_profiles_response.ListProfilesResponse = (
        aws_sdk_transfer.types.list_profiles_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.list_profiles_request.ListProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.list_profiles_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_profiles(
    ...
    aws_sdk_transfer.types.list_profiles_response.ListProfilesResponse, zapros.Response
]:
