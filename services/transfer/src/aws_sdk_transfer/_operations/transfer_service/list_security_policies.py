...
def handle_response(
    ...
    out: aws_sdk_transfer.types.list_security_policies_response.ListSecurityPoliciesResponse = aws_sdk_transfer.types.list_security_policies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.list_security_policies_request.ListSecurityPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.list_security_policies_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
