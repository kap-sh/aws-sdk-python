"""Generated from Smithy shape ``com.amazonaws.transfer#StopServer``."""
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.stop_server_request.StopServerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.stop_server_request.serialize_aws_json_1_1(input_)
    ).encode()
