...
def handle_response(
    ...
    out: aws_sdk_transfer.types.describe_server_response.DescribeServerResponse = (
        aws_sdk_transfer.types.describe_server_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.describe_server_request.DescribeServerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.describe_server_request.serialize_aws_json_1_1(input_)
    ).encode()
