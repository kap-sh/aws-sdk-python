...
def build_request(
    ...
    input_: aws_sdk_transfer.types.delete_workflow_request.DeleteWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.delete_workflow_request.serialize_aws_json_1_1(input_)
    ).encode()
