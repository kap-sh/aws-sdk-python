"""Generated from Smithy shape ``com.amazonaws.transfer#ImportSshPublicKey``."""
...
def handle_response(
    ...
    out: aws_sdk_transfer.types.import_ssh_public_key_response.ImportSshPublicKeyResponse = aws_sdk_transfer.types.import_ssh_public_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.import_ssh_public_key_request.ImportSshPublicKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.import_ssh_public_key_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_import_ssh_public_key(
