...
def handle_response(
    ...
    out: aws_sdk_transfer.types.import_host_key_response.ImportHostKeyResponse = (
        aws_sdk_transfer.types.import_host_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.import_host_key_request.ImportHostKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.import_host_key_request.serialize_aws_json_1_1(input_)
    ).encode()
