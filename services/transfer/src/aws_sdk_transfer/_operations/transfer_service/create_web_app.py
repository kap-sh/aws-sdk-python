...
def handle_response(
    ...
    out: aws_sdk_transfer.types.create_web_app_response.CreateWebAppResponse = (
        aws_sdk_transfer.types.create_web_app_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.create_web_app_request.CreateWebAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.create_web_app_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_web_app(
    ...
    aws_sdk_transfer.types.create_web_app_response.CreateWebAppResponse, zapros.Response
]:
