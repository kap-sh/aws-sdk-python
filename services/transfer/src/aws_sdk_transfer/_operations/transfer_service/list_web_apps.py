...
def handle_response(
    ...
    out: aws_sdk_transfer.types.list_web_apps_response.ListWebAppsResponse = (
        aws_sdk_transfer.types.list_web_apps_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.list_web_apps_request.ListWebAppsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.list_web_apps_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_web_apps(
    ...
    aws_sdk_transfer.types.list_web_apps_response.ListWebAppsResponse, zapros.Response
]:
