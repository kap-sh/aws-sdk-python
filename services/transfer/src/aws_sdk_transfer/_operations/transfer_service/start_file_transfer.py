...
def handle_response(
    ...
    out: aws_sdk_transfer.types.start_file_transfer_response.StartFileTransferResponse = aws_sdk_transfer.types.start_file_transfer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_transfer.types.start_file_transfer_request.StartFileTransferRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.start_file_transfer_request.serialize_aws_json_1_1(input)
    ).encode()
