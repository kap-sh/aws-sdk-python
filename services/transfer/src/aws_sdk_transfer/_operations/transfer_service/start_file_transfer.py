...
def build_request(
    ...
    input_: aws_sdk_transfer.types.start_file_transfer_request.StartFileTransferRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.start_file_transfer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
