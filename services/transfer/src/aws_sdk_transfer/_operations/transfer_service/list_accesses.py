...
def build_request(
    ...
    input_: aws_sdk_transfer.types.list_accesses_request.ListAccessesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.list_accesses_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_accesses(
    ...
    aws_sdk_transfer.types.list_accesses_response.ListAccessesResponse, zapros.Response
]:
