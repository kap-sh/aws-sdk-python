"""Generated from Smithy shape ``com.amazonaws.transfer#DescribeCertificate``."""
...
import aws_sdk_transfer.types.described_certificate
...
def handle_response(
    ...
    out: aws_sdk_transfer.types.describe_certificate_response.DescribeCertificateResponse = aws_sdk_transfer.types.describe_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.describe_certificate_request.DescribeCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "TransferService.DescribeCertificate"
    import aws_sdk_transfer.types.describe_certificate_request

    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.describe_certificate_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
