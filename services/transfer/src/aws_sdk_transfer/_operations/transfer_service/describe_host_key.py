...
def handle_response(
    ...
    out: aws_sdk_transfer.types.describe_host_key_response.DescribeHostKeyResponse = (
        aws_sdk_transfer.types.describe_host_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.describe_host_key_request.DescribeHostKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.describe_host_key_request.serialize_aws_json_1_1(input_)
    ).encode()
