...
def build_request(
    ...
    input: aws_sdk_transfer.types.delete_certificate_request.DeleteCertificateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.delete_certificate_request.serialize_aws_json_1_1(input)
    ).encode()
