"""Generated from Smithy shape ``com.amazonaws.transfer#ListAgreements``."""
...
def handle_response(
    ...
    out: aws_sdk_transfer.types.list_agreements_response.ListAgreementsResponse = (
        aws_sdk_transfer.types.list_agreements_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.list_agreements_request.ListAgreementsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "TransferService.ListAgreements"
    import aws_sdk_transfer.types.list_agreements_request

    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.list_agreements_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_agreements(
