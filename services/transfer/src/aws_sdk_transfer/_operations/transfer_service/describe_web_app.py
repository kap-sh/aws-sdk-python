"""Generated from Smithy shape ``com.amazonaws.transfer#DescribeWebApp``."""
...
def handle_response(
    ...
    out: aws_sdk_transfer.types.describe_web_app_response.DescribeWebAppResponse = (
        aws_sdk_transfer.types.describe_web_app_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.describe_web_app_request.DescribeWebAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/describeWebApp"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "TransferService.DescribeWebApp"
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.describe_web_app_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_web_app(
