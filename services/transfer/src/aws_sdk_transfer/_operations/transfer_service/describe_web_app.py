...
def build_request(
    ...
    input: aws_sdk_transfer.types.describe_web_app_request.DescribeWebAppRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.describe_web_app_request.serialize_aws_json_1_1(input)
    ).encode()
