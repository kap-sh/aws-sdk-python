...
def build_request(
    ...
    input: aws_sdk_transfer.types.list_certificates_request.ListCertificatesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.list_certificates_request.serialize_aws_json_1_1(input)
    ).encode()
