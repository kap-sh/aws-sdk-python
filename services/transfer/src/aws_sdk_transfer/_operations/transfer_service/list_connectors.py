...
def handle_response(
    ...
    out: aws_sdk_transfer.types.list_connectors_response.ListConnectorsResponse = (
        aws_sdk_transfer.types.list_connectors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.list_connectors_request.ListConnectorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.list_connectors_request.serialize_aws_json_1_1(input_)
    ).encode()
