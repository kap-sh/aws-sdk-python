"""Generated from Smithy shape ``com.amazonaws.transfer#DeleteProfile``."""
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.delete_profile_request.DeleteProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "TransferService.DeleteProfile"
    import aws_sdk_transfer.types.delete_profile_request

    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.delete_profile_request.serialize_aws_json_1_1(input_)
    ).encode()
