...
def handle_response(
    ...
    out: aws_sdk_transfer.types.update_profile_response.UpdateProfileResponse = (
        aws_sdk_transfer.types.update_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.update_profile_request.UpdateProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.update_profile_request.serialize_aws_json_1_1(input_)
    ).encode()
