...
def handle_response(
    ...
    out: aws_sdk_transfer.types.update_connector_response.UpdateConnectorResponse = (
        aws_sdk_transfer.types.update_connector_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.update_connector_request.UpdateConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.update_connector_request.serialize_aws_json_1_1(input_)
    ).encode()
