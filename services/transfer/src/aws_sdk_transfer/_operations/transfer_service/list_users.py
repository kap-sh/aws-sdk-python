...
def handle_response(
    ...
    out: aws_sdk_transfer.types.list_users_response.ListUsersResponse = (
        aws_sdk_transfer.types.list_users_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.list_users_request.ListUsersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.list_users_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_users(
    ...
    aws_sdk_transfer.types.list_users_response.ListUsersResponse, zapros.Response
]:
