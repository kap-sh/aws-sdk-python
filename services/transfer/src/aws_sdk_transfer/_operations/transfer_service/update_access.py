...
def handle_response(
    ...
    out: aws_sdk_transfer.types.update_access_response.UpdateAccessResponse = (
        aws_sdk_transfer.types.update_access_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.update_access_request.UpdateAccessRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.update_access_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_access(
    ...
    aws_sdk_transfer.types.update_access_response.UpdateAccessResponse, zapros.Response
]:
