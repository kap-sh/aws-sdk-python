...
def build_request(
    ...
    input_: aws_sdk_transfer.types.delete_host_key_request.DeleteHostKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.delete_host_key_request.serialize_aws_json_1_1(input_)
    ).encode()
