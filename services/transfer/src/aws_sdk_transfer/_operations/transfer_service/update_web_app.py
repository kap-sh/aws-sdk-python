...
def handle_response(
    ...
    out: aws_sdk_transfer.types.update_web_app_response.UpdateWebAppResponse = (
        aws_sdk_transfer.types.update_web_app_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.update_web_app_request.UpdateWebAppRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.update_web_app_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_web_app(
    ...
    aws_sdk_transfer.types.update_web_app_response.UpdateWebAppResponse, zapros.Response
]:
