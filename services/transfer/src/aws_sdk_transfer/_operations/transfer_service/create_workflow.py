...
def handle_response(
    ...
    out: aws_sdk_transfer.types.create_workflow_response.CreateWorkflowResponse = (
        aws_sdk_transfer.types.create_workflow_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.create_workflow_request.CreateWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.create_workflow_request.serialize_aws_json_1_1(input_)
    ).encode()
