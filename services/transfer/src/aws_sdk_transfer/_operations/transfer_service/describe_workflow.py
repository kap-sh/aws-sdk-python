"""Generated from Smithy shape ``com.amazonaws.transfer#DescribeWorkflow``."""
...
def handle_response(
    ...
    out: aws_sdk_transfer.types.describe_workflow_response.DescribeWorkflowResponse = (
        aws_sdk_transfer.types.describe_workflow_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.describe_workflow_request.DescribeWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "TransferService.DescribeWorkflow"
    import aws_sdk_transfer.types.describe_workflow_request

    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.describe_workflow_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_workflow(
