"""Generated from Smithy shape ``com.amazonaws.transfer#DeleteSshPublicKey``."""
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.delete_ssh_public_key_request.DeleteSshPublicKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.delete_ssh_public_key_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
