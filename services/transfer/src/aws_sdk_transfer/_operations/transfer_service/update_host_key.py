"""Generated from Smithy shape ``com.amazonaws.transfer#UpdateHostKey``."""
...
def handle_response(
    ...
    out: aws_sdk_transfer.types.update_host_key_response.UpdateHostKeyResponse = (
        aws_sdk_transfer.types.update_host_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.update_host_key_request.UpdateHostKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "TransferService.UpdateHostKey"
    import aws_sdk_transfer.types.update_host_key_request

    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.update_host_key_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_host_key(
