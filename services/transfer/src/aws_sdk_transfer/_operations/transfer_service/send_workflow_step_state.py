"""Generated from Smithy shape ``com.amazonaws.transfer#SendWorkflowStepState``."""
...
def handle_response(
    ...
    out: aws_sdk_transfer.types.send_workflow_step_state_response.SendWorkflowStepStateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.send_workflow_step_state_request.SendWorkflowStepStateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "TransferService.SendWorkflowStepState"
    import aws_sdk_transfer.types.send_workflow_step_state_request

    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.send_workflow_step_state_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_send_workflow_step_state(
