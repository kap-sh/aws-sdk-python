"""Generated from Smithy shape ``com.amazonaws.transfer#ListFileTransferResults``."""
...
import aws_sdk_transfer.types.connector_file_transfer_results
...
def handle_response(
    ...
    out: aws_sdk_transfer.types.list_file_transfer_results_response.ListFileTransferResultsResponse = aws_sdk_transfer.types.list_file_transfer_results_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.list_file_transfer_results_request.ListFileTransferResultsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/listFileTransferResults"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "TransferService.ListFileTransferResults"
    import aws_sdk_transfer.types.list_file_transfer_results_request

    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.list_file_transfer_results_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_file_transfer_results(
