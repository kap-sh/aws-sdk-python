"""Generated from Smithy shape ``com.amazonaws.transfer#DeleteConnector``."""
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.delete_connector_request.DeleteConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "TransferService.DeleteConnector"
    import aws_sdk_transfer.types.delete_connector_request

    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.delete_connector_request.serialize_aws_json_1_1(input_)
    ).encode()
