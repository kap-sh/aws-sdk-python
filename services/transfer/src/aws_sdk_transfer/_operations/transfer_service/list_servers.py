...
def handle_response(
    ...
    out: aws_sdk_transfer.types.list_servers_response.ListServersResponse = (
        aws_sdk_transfer.types.list_servers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.list_servers_request.ListServersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.list_servers_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_servers(
    ...
    aws_sdk_transfer.types.list_servers_response.ListServersResponse, zapros.Response
]:
