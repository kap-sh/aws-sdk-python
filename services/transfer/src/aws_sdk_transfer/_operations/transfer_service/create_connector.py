...
def build_request(
    ...
    input: aws_sdk_transfer.types.create_connector_request.CreateConnectorRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.create_connector_request.serialize_aws_json_1_1(input)
    ).encode()
