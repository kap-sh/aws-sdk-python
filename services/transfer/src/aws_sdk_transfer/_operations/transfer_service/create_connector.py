"""Generated from Smithy shape ``com.amazonaws.transfer#CreateConnector``."""
...
def handle_response(
    ...
    out: aws_sdk_transfer.types.create_connector_response.CreateConnectorResponse = (
        aws_sdk_transfer.types.create_connector_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transfer.types.create_connector_request.CreateConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "TransferService.CreateConnector"
    import aws_sdk_transfer.types.create_connector_request

    body: bytes | None = json.dumps(
        aws_sdk_transfer.types.create_connector_request.serialize_aws_json_1_1(input_)
    ).encode()
