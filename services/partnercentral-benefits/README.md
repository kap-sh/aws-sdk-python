...
```
pip install aws-sdk-partnercentral-benefits
```

## Usage

```python
from aws_sdk_partnercentral_benefits import AsyncPartnerCentralBenefitsClient
...
```python
from aws_sdk_partnercentral_benefits import AsyncPartnerCentralBenefitsClient
from aws_sdk_partnercentral_benefits.error import AccessDeniedException
