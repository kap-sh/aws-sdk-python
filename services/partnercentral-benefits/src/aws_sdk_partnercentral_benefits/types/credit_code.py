...
class CreditCode(TypedDict, closed=True):
    ...
    value: "aws_sdk_partnercentral_benefits.types.monetary_value.MonetaryValue"
    ...
    status: "aws_sdk_partnercentral_benefits.types.benefit_allocation_status.BenefitAllocationStatus"
    """<p>The current status of the credit code (e.g., active, redeemed, expired).</p>"""
    issued_at: "aws_sdk_partnercentral_benefits.types.timestamp.Timestamp"
    """<p>The timestamp when the credit code was issued.</p>"""
    expires_at: "aws_sdk_partnercentral_benefits.types.timestamp.Timestamp"
