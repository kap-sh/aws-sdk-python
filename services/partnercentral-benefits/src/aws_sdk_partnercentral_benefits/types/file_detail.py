...
if TYPE_CHECKING:
    import aws_sdk_partnercentral_benefits.types.file_type
...
class FileDetail(TypedDict, closed=True):
    ...
    file_type: NotRequired["aws_sdk_partnercentral_benefits.types.file_type.FileType"]
...
def serialize_aws_json_1_0(value: FileDetail) -> dict:
    ...
    if "file_type" in value:
        ...
        out["FileType"] = (
            aws_sdk_partnercentral_benefits.types.file_type.serialize_aws_json_1_0(
                value["file_type"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> FileDetail:
    ...
    if "FileType" in data:
        ...
        out["file_type"] = (
            aws_sdk_partnercentral_benefits.types.file_type.deserialize_aws_json_1_0(
                data["FileType"]
            )
        )
