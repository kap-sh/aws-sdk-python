...
if TYPE_CHECKING:
    ...
    import aws_sdk_partnercentral_benefits.types.fulfillment_details
...
class GetBenefitAllocationOutput(TypedDict):
    ...
    arn: NotRequired[
        "aws_sdk_partnercentral_benefits.types.benefit_allocation_arn.BenefitAllocationArn"
    ]
    ...
    fulfillment_detail: NotRequired[
        "aws_sdk_partnercentral_benefits.types.fulfillment_details.FulfillmentDetails"
    ]
    ...
    starts_at: NotRequired["aws_sdk_partnercentral_benefits.types.timestamp.Timestamp"]
...
def serialize_aws_json_1_0(value: GetBenefitAllocationOutput) -> dict:
    ...
    if "fulfillment_detail" in value:
        ...
        out["FulfillmentDetail"] = (
            aws_sdk_partnercentral_benefits.types.fulfillment_details.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> GetBenefitAllocationOutput:
    ...
    if "FulfillmentDetail" in data:
        ...
        out["fulfillment_detail"] = (
            aws_sdk_partnercentral_benefits.types.fulfillment_details.deserialize_aws_json_1_0(
