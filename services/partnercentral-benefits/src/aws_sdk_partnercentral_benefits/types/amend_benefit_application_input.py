...
class AmendBenefitApplicationInput(TypedDict):
...
def serialize_aws_json_1_0(value: AmendBenefitApplicationInput) -> dict:
    ...
    out["Amendments"] = (
        aws_sdk_partnercentral_benefits.types.amendment_list.serialize_aws_json_1_0(
            value["amendments"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> AmendBenefitApplicationInput:
    ...
    if "Amendments" in data:
        ...
        out["amendments"] = (
            aws_sdk_partnercentral_benefits.types.amendment_list.deserialize_aws_json_1_0(
                data["Amendments"]
            )
        )
    else:
