...
if TYPE_CHECKING:
    ...
    import aws_sdk_partnercentral_benefits.types.file_details
    import aws_sdk_partnercentral_benefits.types.fulfillment_types
    import aws_sdk_partnercentral_benefits.types.programs
    import aws_sdk_partnercentral_benefits.types.status_reason_code
    import aws_sdk_partnercentral_benefits.types.status_reason_codes
    import aws_sdk_partnercentral_benefits.types.timestamp


class GetBenefitApplicationOutput(TypedDict):
    id: NotRequired[
    ...
    arn: NotRequired["aws_sdk_partnercentral_benefits.types.arn.Arn"]
    ...
    status_reason_code: NotRequired[
        "aws_sdk_partnercentral_benefits.types.status_reason_code.StatusReasonCode"
    ]
    """<p>A standardized code representing the reason for the current status.</p>"""
    status_reason_codes: NotRequired[
        "aws_sdk_partnercentral_benefits.types.status_reason_codes.StatusReasonCodes"
    ]
    ...
    file_details: NotRequired[
        "aws_sdk_partnercentral_benefits.types.file_details.FileDetails"
    ]
...
def serialize_aws_json_1_0(value: GetBenefitApplicationOutput) -> dict:
    ...
    if "status_reason_codes" in value:
        ...
        out["StatusReasonCodes"] = (
            aws_sdk_partnercentral_benefits.types.status_reason_codes.serialize_aws_json_1_0(
    ...
    if "file_details" in value:
        ...
        out["FileDetails"] = (
            aws_sdk_partnercentral_benefits.types.file_details.serialize_aws_json_1_0(
                value["file_details"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> GetBenefitApplicationOutput:
    ...
    if "StatusReasonCodes" in data:
        ...
        out["status_reason_codes"] = (
            aws_sdk_partnercentral_benefits.types.status_reason_codes.deserialize_aws_json_1_0(
    ...
    if "FileDetails" in data:
        ...
        out["file_details"] = (
            aws_sdk_partnercentral_benefits.types.file_details.deserialize_aws_json_1_0(
                data["FileDetails"]
            )
        )
    return out
