"""Generated from Smithy shape ``com.amazonaws.partnercentralbenefits#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.partnercentralbenefits#InternalServerException``."""
