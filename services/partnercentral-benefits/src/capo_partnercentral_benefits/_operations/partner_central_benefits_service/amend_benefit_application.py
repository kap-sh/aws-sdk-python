...
def handle_response(
    ...
    out: capo_partnercentral_benefits.types.amend_benefit_application_output.AmendBenefitApplicationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_benefits.types.amend_benefit_application_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
