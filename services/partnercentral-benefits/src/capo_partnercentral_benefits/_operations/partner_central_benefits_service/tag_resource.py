...
def handle_response(
    ...
    out: capo_partnercentral_benefits.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_benefits.types.tag_resource_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
