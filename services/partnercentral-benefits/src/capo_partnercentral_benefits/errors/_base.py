...
class PartnerCentralBenefitsError(Exception):
    """Base class for all PartnerCentralBenefits service errors."""


class ServiceError(PartnerCentralBenefitsError):
...
class SerializationError(PartnerCentralBenefitsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PartnerCentralBenefitsError):
...
class WaiterFailedError(PartnerCentralBenefitsError):
...
class WaiterTimeoutError(PartnerCentralBenefitsError):
