...
class ListBenefitsOutput(TypedDict, closed=True):
    benefit_summaries: NotRequired[
        "capo_partnercentral_benefits.types.benefit_summaries.BenefitSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListBenefitsOutput) -> dict:
    ...
    if "benefit_summaries" in value:
        ...
        out["BenefitSummaries"] = (
            capo_partnercentral_benefits.types.benefit_summaries.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListBenefitsOutput:
    ...
    if "BenefitSummaries" in data:
        ...
        out["benefit_summaries"] = (
            capo_partnercentral_benefits.types.benefit_summaries.deserialize_aws_json_1_0(
