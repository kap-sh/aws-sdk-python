...
class ListBenefitAllocationsOutput(TypedDict, closed=True):
    benefit_allocation_summaries: NotRequired[
        "capo_partnercentral_benefits.types.benefit_allocation_summaries.BenefitAllocationSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListBenefitAllocationsOutput) -> dict:
    ...
    if "benefit_allocation_summaries" in value:
        ...
        out["BenefitAllocationSummaries"] = (
            capo_partnercentral_benefits.types.benefit_allocation_summaries.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListBenefitAllocationsOutput:
    ...
    if "BenefitAllocationSummaries" in data:
        ...
        out["benefit_allocation_summaries"] = (
            capo_partnercentral_benefits.types.benefit_allocation_summaries.deserialize_aws_json_1_0(
