"""Generated from Smithy shape ``com.amazonaws.codebuild#StartBuild``."""
...
def handle_response(
    ...
    out: capo_codebuild.types.start_build_output.StartBuildOutput = (
        capo_codebuild.types.start_build_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codebuild.types.start_build_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_build(
    ...
    input_: capo_codebuild.types.start_build_input.StartBuildInput,
) -> tuple[capo_codebuild.types.start_build_output.StartBuildOutput, zapros.Response]:
