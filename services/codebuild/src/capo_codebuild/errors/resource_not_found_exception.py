"""Generated from Smithy shape ``com.amazonaws.codebuild#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codebuild#ResourceNotFoundException``."""
