...
import aws_sdk_codebuild.types.builds
...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.batch_get_builds_output.BatchGetBuildsOutput = (
        aws_sdk_codebuild.types.batch_get_builds_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.batch_get_builds_input.BatchGetBuildsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.batch_get_builds_input.serialize_aws_json_1_1(input_)
    ).encode()
