"""Generated from Smithy shape ``com.amazonaws.codebuild#DeleteProject``."""
...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.delete_project_output.DeleteProjectOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.delete_project_input.DeleteProjectInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.delete_project_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_project(
    ...
    aws_sdk_codebuild.types.delete_project_output.DeleteProjectOutput, zapros.Response
]:
