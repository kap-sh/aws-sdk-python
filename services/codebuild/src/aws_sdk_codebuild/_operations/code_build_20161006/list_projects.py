...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.list_projects_output.ListProjectsOutput = (
        aws_sdk_codebuild.types.list_projects_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.list_projects_input.ListProjectsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.list_projects_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_projects(
    ...
    aws_sdk_codebuild.types.list_projects_output.ListProjectsOutput, zapros.Response
]:
