...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.batch_get_build_batches_output.BatchGetBuildBatchesOutput = aws_sdk_codebuild.types.batch_get_build_batches_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.batch_get_build_batches_input.BatchGetBuildBatchesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
