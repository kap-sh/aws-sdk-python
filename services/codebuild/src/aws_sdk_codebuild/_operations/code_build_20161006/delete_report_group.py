"""Generated from Smithy shape ``com.amazonaws.codebuild#DeleteReportGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.delete_report_group_output.DeleteReportGroupOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.delete_report_group_input.DeleteReportGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.delete_report_group_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_report_group(
