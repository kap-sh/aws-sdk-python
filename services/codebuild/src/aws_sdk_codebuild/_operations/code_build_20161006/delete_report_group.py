...
def build_request(
    ...
    input: aws_sdk_codebuild.types.delete_report_group_input.DeleteReportGroupInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.delete_report_group_input.serialize_aws_json_1_1(input)
    ).encode()
