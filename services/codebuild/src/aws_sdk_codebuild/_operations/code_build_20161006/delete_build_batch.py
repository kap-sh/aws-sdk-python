...
def build_request(
    ...
    input: aws_sdk_codebuild.types.delete_build_batch_input.DeleteBuildBatchInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.delete_build_batch_input.serialize_aws_json_1_1(input)
    ).encode()
