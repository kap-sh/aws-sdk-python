...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.delete_build_batch_output.DeleteBuildBatchOutput = (
        aws_sdk_codebuild.types.delete_build_batch_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.delete_build_batch_input.DeleteBuildBatchInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.delete_build_batch_input.serialize_aws_json_1_1(input_)
    ).encode()
