...
def build_request(
    ...
    input: aws_sdk_codebuild.types.batch_delete_builds_input.BatchDeleteBuildsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.batch_delete_builds_input.serialize_aws_json_1_1(input)
    ).encode()
