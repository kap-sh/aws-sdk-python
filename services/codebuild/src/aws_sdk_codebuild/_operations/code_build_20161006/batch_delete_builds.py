"""Generated from Smithy shape ``com.amazonaws.codebuild#BatchDeleteBuilds``."""
...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.batch_delete_builds_output.BatchDeleteBuildsOutput = (
        aws_sdk_codebuild.types.batch_delete_builds_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.batch_delete_builds_input.BatchDeleteBuildsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.batch_delete_builds_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_batch_delete_builds(
