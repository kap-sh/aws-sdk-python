...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.start_build_output.StartBuildOutput = (
        aws_sdk_codebuild.types.start_build_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.start_build_input.StartBuildInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.start_build_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_build(
    ...
    aws_sdk_codebuild.types.start_build_output.StartBuildOutput, zapros.Response
]:
