...
def build_request(
    ...
    input: aws_sdk_codebuild.types.put_resource_policy_input.PutResourcePolicyInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.put_resource_policy_input.serialize_aws_json_1_1(input)
    ).encode()
