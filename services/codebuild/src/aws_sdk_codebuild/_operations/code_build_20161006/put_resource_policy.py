"""Generated from Smithy shape ``com.amazonaws.codebuild#PutResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.put_resource_policy_output.PutResourcePolicyOutput = (
        aws_sdk_codebuild.types.put_resource_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.put_resource_policy_input.PutResourcePolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.put_resource_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
