...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.batch_get_reports_output.BatchGetReportsOutput = (
        aws_sdk_codebuild.types.batch_get_reports_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.batch_get_reports_input.BatchGetReportsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.batch_get_reports_input.serialize_aws_json_1_1(input_)
    ).encode()
