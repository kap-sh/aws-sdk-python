...
def build_request(
    ...
    input: aws_sdk_codebuild.types.batch_get_reports_input.BatchGetReportsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.batch_get_reports_input.serialize_aws_json_1_1(input)
    ).encode()
