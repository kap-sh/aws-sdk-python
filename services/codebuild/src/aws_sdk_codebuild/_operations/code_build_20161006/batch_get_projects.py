...
def build_request(
    ...
    input: aws_sdk_codebuild.types.batch_get_projects_input.BatchGetProjectsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.batch_get_projects_input.serialize_aws_json_1_1(input)
    ).encode()
