...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.batch_get_projects_output.BatchGetProjectsOutput = (
        aws_sdk_codebuild.types.batch_get_projects_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.batch_get_projects_input.BatchGetProjectsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.batch_get_projects_input.serialize_aws_json_1_1(input_)
    ).encode()
