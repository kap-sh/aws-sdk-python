"""Generated from Smithy shape ``com.amazonaws.codebuild#BatchGetCommandExecutions``."""
...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.batch_get_command_executions_output.BatchGetCommandExecutionsOutput = aws_sdk_codebuild.types.batch_get_command_executions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.batch_get_command_executions_input.BatchGetCommandExecutionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeBuild_20161006.BatchGetCommandExecutions"
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.batch_get_command_executions_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_get_command_executions(
