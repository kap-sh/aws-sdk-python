...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.import_source_credentials_output.ImportSourceCredentialsOutput = aws_sdk_codebuild.types.import_source_credentials_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.import_source_credentials_input.ImportSourceCredentialsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
