...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.update_fleet_output.UpdateFleetOutput = (
        aws_sdk_codebuild.types.update_fleet_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.update_fleet_input.UpdateFleetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.update_fleet_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_fleet(
    ...
    aws_sdk_codebuild.types.update_fleet_output.UpdateFleetOutput, zapros.Response
]:
