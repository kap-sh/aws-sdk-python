...
def build_request(
    ...
    input: aws_sdk_codebuild.types.describe_test_cases_input.DescribeTestCasesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.describe_test_cases_input.serialize_aws_json_1_1(input)
    ).encode()
