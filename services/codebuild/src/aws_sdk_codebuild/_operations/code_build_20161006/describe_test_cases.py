...
import aws_sdk_codebuild.types.test_cases
...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.describe_test_cases_output.DescribeTestCasesOutput = (
        aws_sdk_codebuild.types.describe_test_cases_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.describe_test_cases_input.DescribeTestCasesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.describe_test_cases_input.serialize_aws_json_1_1(input_)
    ).encode()
