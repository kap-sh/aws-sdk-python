...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.start_build_batch_output.StartBuildBatchOutput = (
        aws_sdk_codebuild.types.start_build_batch_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.start_build_batch_input.StartBuildBatchInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.start_build_batch_input.serialize_aws_json_1_1(input_)
    ).encode()
