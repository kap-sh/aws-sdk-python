"""Generated from Smithy shape ``com.amazonaws.codebuild#ListBuildBatches``."""
...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.list_build_batches_output.ListBuildBatchesOutput = (
        aws_sdk_codebuild.types.list_build_batches_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.list_build_batches_input.ListBuildBatchesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeBuild_20161006.ListBuildBatches"
    import aws_sdk_codebuild.types.list_build_batches_input

    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.list_build_batches_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_build_batches(
