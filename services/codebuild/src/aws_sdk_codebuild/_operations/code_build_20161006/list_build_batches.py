...
def build_request(
    ...
    input: aws_sdk_codebuild.types.list_build_batches_input.ListBuildBatchesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.list_build_batches_input.serialize_aws_json_1_1(input)
    ).encode()
