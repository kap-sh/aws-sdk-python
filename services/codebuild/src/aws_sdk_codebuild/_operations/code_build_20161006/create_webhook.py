...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OAuthProviderException":
            import aws_sdk_codebuild.errors.o_auth_provider_exception

            raise aws_sdk_codebuild.errors.o_auth_provider_exception.OAuthProviderException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.create_webhook_output.CreateWebhookOutput = (
        aws_sdk_codebuild.types.create_webhook_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.create_webhook_input.CreateWebhookInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.create_webhook_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_webhook(
    ...
    aws_sdk_codebuild.types.create_webhook_output.CreateWebhookOutput, zapros.Response
]:
