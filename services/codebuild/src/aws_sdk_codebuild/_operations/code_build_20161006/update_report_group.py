...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.update_report_group_output.UpdateReportGroupOutput = (
        aws_sdk_codebuild.types.update_report_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_codebuild.types.update_report_group_input.UpdateReportGroupInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.update_report_group_input.serialize_aws_json_1_1(input)
    ).encode()
