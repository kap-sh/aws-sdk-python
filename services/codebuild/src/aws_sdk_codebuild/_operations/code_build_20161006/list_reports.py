"""Generated from Smithy shape ``com.amazonaws.codebuild#ListReports``."""
...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.list_reports_output.ListReportsOutput = (
        aws_sdk_codebuild.types.list_reports_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.list_reports_input.ListReportsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.list_reports_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_reports(
    ...
    aws_sdk_codebuild.types.list_reports_output.ListReportsOutput, zapros.Response
]:
