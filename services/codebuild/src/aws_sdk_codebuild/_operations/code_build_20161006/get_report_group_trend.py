...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.get_report_group_trend_output.GetReportGroupTrendOutput = aws_sdk_codebuild.types.get_report_group_trend_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.get_report_group_trend_input.GetReportGroupTrendInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.get_report_group_trend_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
