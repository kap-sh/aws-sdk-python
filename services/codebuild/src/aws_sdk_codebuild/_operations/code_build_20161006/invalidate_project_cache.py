...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.invalidate_project_cache_output.InvalidateProjectCacheOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.invalidate_project_cache_input.InvalidateProjectCacheInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.invalidate_project_cache_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
