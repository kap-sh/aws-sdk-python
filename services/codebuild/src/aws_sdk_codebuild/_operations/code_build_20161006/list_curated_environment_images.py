...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.list_curated_environment_images_output.ListCuratedEnvironmentImagesOutput = aws_sdk_codebuild.types.list_curated_environment_images_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.list_curated_environment_images_input.ListCuratedEnvironmentImagesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
