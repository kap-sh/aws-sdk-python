"""Generated from Smithy shape ``com.amazonaws.codebuild#BatchGetFleets``."""
...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.batch_get_fleets_output.BatchGetFleetsOutput = (
        aws_sdk_codebuild.types.batch_get_fleets_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.batch_get_fleets_input.BatchGetFleetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeBuild_20161006.BatchGetFleets"
    import aws_sdk_codebuild.types.batch_get_fleets_input

    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.batch_get_fleets_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_batch_get_fleets(
