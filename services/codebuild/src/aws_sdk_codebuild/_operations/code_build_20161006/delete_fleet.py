"""Generated from Smithy shape ``com.amazonaws.codebuild#DeleteFleet``."""
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.delete_fleet_input.DeleteFleetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeBuild_20161006.DeleteFleet"
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.delete_fleet_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_fleet(
    ...
    aws_sdk_codebuild.types.delete_fleet_output.DeleteFleetOutput, zapros.Response
]:
