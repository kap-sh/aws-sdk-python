...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.delete_report_output.DeleteReportOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.delete_report_input.DeleteReportInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.delete_report_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_report(
    ...
    aws_sdk_codebuild.types.delete_report_output.DeleteReportOutput, zapros.Response
]:
