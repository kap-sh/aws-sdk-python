...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.describe_code_coverages_output.DescribeCodeCoveragesOutput = aws_sdk_codebuild.types.describe_code_coverages_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.describe_code_coverages_input.DescribeCodeCoveragesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.describe_code_coverages_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
