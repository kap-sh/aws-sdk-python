...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.update_project_output.UpdateProjectOutput = (
        aws_sdk_codebuild.types.update_project_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.update_project_input.UpdateProjectInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.update_project_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_project(
    ...
    aws_sdk_codebuild.types.update_project_output.UpdateProjectOutput, zapros.Response
]:
