...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.retry_build_output.RetryBuildOutput = (
        aws_sdk_codebuild.types.retry_build_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.retry_build_input.RetryBuildInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.retry_build_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def retry_build(
    ...
    aws_sdk_codebuild.types.retry_build_output.RetryBuildOutput, zapros.Response
]:
