...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.batch_get_sandboxes_output.BatchGetSandboxesOutput = (
        aws_sdk_codebuild.types.batch_get_sandboxes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.batch_get_sandboxes_input.BatchGetSandboxesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.batch_get_sandboxes_input.serialize_aws_json_1_1(input_)
    ).encode()
