...
def build_request(
    ...
    input: aws_sdk_codebuild.types.batch_get_sandboxes_input.BatchGetSandboxesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.batch_get_sandboxes_input.serialize_aws_json_1_1(input)
    ).encode()
