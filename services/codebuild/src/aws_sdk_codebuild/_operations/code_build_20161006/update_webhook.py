...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.update_webhook_output.UpdateWebhookOutput = (
        aws_sdk_codebuild.types.update_webhook_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.update_webhook_input.UpdateWebhookInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.update_webhook_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_webhook(
    ...
    aws_sdk_codebuild.types.update_webhook_output.UpdateWebhookOutput, zapros.Response
]:
