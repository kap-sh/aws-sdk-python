...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.list_sandboxes_output.ListSandboxesOutput = (
        aws_sdk_codebuild.types.list_sandboxes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.list_sandboxes_input.ListSandboxesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.list_sandboxes_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_sandboxes(
    ...
    aws_sdk_codebuild.types.list_sandboxes_output.ListSandboxesOutput, zapros.Response
]:
