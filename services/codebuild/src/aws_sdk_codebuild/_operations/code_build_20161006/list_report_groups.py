...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.list_report_groups_input.ListReportGroupsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.list_report_groups_input.serialize_aws_json_1_1(input_)
    ).encode()
