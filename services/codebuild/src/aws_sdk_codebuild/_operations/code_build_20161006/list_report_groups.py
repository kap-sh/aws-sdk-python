...
def build_request(
    ...
    input: aws_sdk_codebuild.types.list_report_groups_input.ListReportGroupsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.list_report_groups_input.serialize_aws_json_1_1(input)
    ).encode()
