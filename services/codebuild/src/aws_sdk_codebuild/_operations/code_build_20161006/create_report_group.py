...
def build_request(
    ...
    input: aws_sdk_codebuild.types.create_report_group_input.CreateReportGroupInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.create_report_group_input.serialize_aws_json_1_1(input)
    ).encode()
