...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.create_report_group_output.CreateReportGroupOutput = (
        aws_sdk_codebuild.types.create_report_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.create_report_group_input.CreateReportGroupInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.create_report_group_input.serialize_aws_json_1_1(input_)
    ).encode()
