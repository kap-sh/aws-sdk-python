...
def build_request(
    ...
    input: aws_sdk_codebuild.types.get_resource_policy_input.GetResourcePolicyInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.get_resource_policy_input.serialize_aws_json_1_1(input)
    ).encode()
