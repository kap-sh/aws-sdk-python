...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.list_source_credentials_output.ListSourceCredentialsOutput = aws_sdk_codebuild.types.list_source_credentials_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.list_source_credentials_input.ListSourceCredentialsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
