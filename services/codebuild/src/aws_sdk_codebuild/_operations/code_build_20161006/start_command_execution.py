"""Generated from Smithy shape ``com.amazonaws.codebuild#StartCommandExecution``."""
...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.start_command_execution_output.StartCommandExecutionOutput = aws_sdk_codebuild.types.start_command_execution_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.start_command_execution_input.StartCommandExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "CodeBuild_20161006.StartCommandExecution"
    import aws_sdk_codebuild.types.start_command_execution_input

    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.start_command_execution_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
