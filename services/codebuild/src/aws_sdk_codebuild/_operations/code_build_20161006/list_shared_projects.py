...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.list_shared_projects_input.ListSharedProjectsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.list_shared_projects_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
