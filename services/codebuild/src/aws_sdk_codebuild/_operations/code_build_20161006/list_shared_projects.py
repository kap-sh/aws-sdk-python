...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.list_shared_projects_output.ListSharedProjectsOutput = aws_sdk_codebuild.types.list_shared_projects_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_codebuild.types.list_shared_projects_input.ListSharedProjectsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.list_shared_projects_input.serialize_aws_json_1_1(input)
    ).encode()
