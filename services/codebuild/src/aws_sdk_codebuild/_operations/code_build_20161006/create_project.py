"""Generated from Smithy shape ``com.amazonaws.codebuild#CreateProject``."""
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.create_project_input.CreateProjectInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.create_project_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_project(
    ...
    aws_sdk_codebuild.types.create_project_output.CreateProjectOutput, zapros.Response
]:
