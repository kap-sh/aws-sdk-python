"""Generated from Smithy shape ``com.amazonaws.codebuild#DeleteResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.delete_resource_policy_output.DeleteResourcePolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.delete_resource_policy_input.DeleteResourcePolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.delete_resource_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
