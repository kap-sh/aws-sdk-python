"""Generated from Smithy shape ``com.amazonaws.codebuild#ListSharedReportGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_codebuild.types.list_shared_report_groups_output.ListSharedReportGroupsOutput = aws_sdk_codebuild.types.list_shared_report_groups_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_codebuild.types.list_shared_report_groups_input.ListSharedReportGroupsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_codebuild.types.list_shared_report_groups_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_shared_report_groups(
