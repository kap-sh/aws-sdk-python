...
class RetryBuildBatchInput(TypedDict):
...
def serialize_aws_json_1_1(value: RetryBuildBatchInput) -> dict:
    ...
    if "retry_type" in value:
        ...
        out["retryType"] = (
            aws_sdk_codebuild.types.retry_build_batch_type.serialize_aws_json_1_1(
                value["retry_type"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> RetryBuildBatchInput:
    ...
    if "retryType" in data:
        ...
        out["retry_type"] = (
            aws_sdk_codebuild.types.retry_build_batch_type.deserialize_aws_json_1_1(
                data["retryType"]
            )
        )
    return out
