...
if TYPE_CHECKING:
    import aws_sdk_codebuild.types.cache_type
    import aws_sdk_codebuild.types.project_cache_modes
    import aws_sdk_codebuild.types.string


class ProjectCache(TypedDict):
    type: "aws_sdk_codebuild.types.cache_type.CacheType"
    ...
    modes: NotRequired["aws_sdk_codebuild.types.project_cache_modes.ProjectCacheModes"]
    ...
    cache_namespace: NotRequired["aws_sdk_codebuild.types.string.String"]
...
def serialize_aws_json_1_1(value: ProjectCache) -> dict:
    ...
    out["type"] = aws_sdk_codebuild.types.cache_type.serialize_aws_json_1_1(
        value["type"]
    )
    ...
    if "modes" in value:
        ...
        out["modes"] = (
            aws_sdk_codebuild.types.project_cache_modes.serialize_aws_json_1_1(
                value["modes"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ProjectCache:
    ...
    if "type" in data:
        ...
        out["type"] = aws_sdk_codebuild.types.cache_type.deserialize_aws_json_1_1(
            data["type"]
        )
    else:
    ...
    if "modes" in data:
        ...
        out["modes"] = (
            aws_sdk_codebuild.types.project_cache_modes.deserialize_aws_json_1_1(
                data["modes"]
            )
        )
