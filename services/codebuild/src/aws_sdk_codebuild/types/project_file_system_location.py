...
class ProjectFileSystemLocation(TypedDict, closed=True):
    ...
    mount_point: NotRequired["aws_sdk_codebuild.types.string.String"]
...
def serialize_aws_json_1_1(value: ProjectFileSystemLocation) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = aws_sdk_codebuild.types.file_system_type.serialize_aws_json_1_1(
            value["type"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ProjectFileSystemLocation:
    ...
    if "type" in data:
        ...
        out["type"] = aws_sdk_codebuild.types.file_system_type.deserialize_aws_json_1_1(
            data["type"]
        )
    if "location" in data:
