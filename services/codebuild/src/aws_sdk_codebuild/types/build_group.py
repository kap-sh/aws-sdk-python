...
if TYPE_CHECKING:
    ...
    import aws_sdk_codebuild.types.build_summaries
    import aws_sdk_codebuild.types.build_summary
    import aws_sdk_codebuild.types.identifiers
...
class BuildGroup(TypedDict, closed=True):
    ...
    ignore_failure: "aws_sdk_codebuild.types.boolean.Boolean"
    """<p>Specifies if failures in this build group can be ignored.</p>"""
    current_build_summary: NotRequired[
        "aws_sdk_codebuild.types.build_summary.BuildSummary"
    ]
    ...
    prior_build_summary_list: NotRequired[
        "aws_sdk_codebuild.types.build_summaries.BuildSummaries"
    ]
...
def serialize_aws_json_1_1(value: BuildGroup) -> dict:
    ...
    if "depends_on" in value:
        ...
        out["dependsOn"] = aws_sdk_codebuild.types.identifiers.serialize_aws_json_1_1(
            value["depends_on"]
        )
    ...
    if "current_build_summary" in value:
        ...
        out["currentBuildSummary"] = (
            aws_sdk_codebuild.types.build_summary.serialize_aws_json_1_1(
    ...
    if "prior_build_summary_list" in value:
        ...
        out["priorBuildSummaryList"] = (
            aws_sdk_codebuild.types.build_summaries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> BuildGroup:
    ...
    if "dependsOn" in data:
        ...
        out["depends_on"] = (
            aws_sdk_codebuild.types.identifiers.deserialize_aws_json_1_1(
                data["dependsOn"]
            )
        )
    ...
    if "currentBuildSummary" in data:
        ...
        out["current_build_summary"] = (
            aws_sdk_codebuild.types.build_summary.deserialize_aws_json_1_1(
    ...
    if "priorBuildSummaryList" in data:
        ...
        out["prior_build_summary_list"] = (
            aws_sdk_codebuild.types.build_summaries.deserialize_aws_json_1_1(
