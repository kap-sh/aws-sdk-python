...
if TYPE_CHECKING:
    import aws_sdk_codebuild.types.build_batch_phase_type
...
class BuildBatchPhase(TypedDict):
    phase_type: NotRequired[
        "aws_sdk_codebuild.types.build_batch_phase_type.BuildBatchPhaseType"
    ]
...
def serialize_aws_json_1_1(value: BuildBatchPhase) -> dict:
    ...
    if "phase_type" in value:
        ...
        out["phaseType"] = (
            aws_sdk_codebuild.types.build_batch_phase_type.serialize_aws_json_1_1(
                value["phase_type"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> BuildBatchPhase:
    ...
    if "phaseType" in data:
        ...
        out["phase_type"] = (
            aws_sdk_codebuild.types.build_batch_phase_type.deserialize_aws_json_1_1(
                data["phaseType"]
            )
        )
