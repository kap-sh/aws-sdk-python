...
class ListFleetsInput(TypedDict):
    ...
    sort_by: NotRequired["aws_sdk_codebuild.types.fleet_sort_by_type.FleetSortByType"]
...
def serialize_aws_json_1_1(value: ListFleetsInput) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["sortBy"] = (
            aws_sdk_codebuild.types.fleet_sort_by_type.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListFleetsInput:
    ...
    if "sortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_codebuild.types.fleet_sort_by_type.deserialize_aws_json_1_1(
                data["sortBy"]
            )
        )
    return out
