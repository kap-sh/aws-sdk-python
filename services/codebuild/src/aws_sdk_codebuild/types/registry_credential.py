...
if TYPE_CHECKING:
    import aws_sdk_codebuild.types.credential_provider_type
...
class RegistryCredential(TypedDict):
    ...
    credential_provider: (
        "aws_sdk_codebuild.types.credential_provider_type.CredentialProviderType"
    )
...
def serialize_aws_json_1_1(value: RegistryCredential) -> dict:
    ...
    out["credentialProvider"] = (
        aws_sdk_codebuild.types.credential_provider_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RegistryCredential:
    ...
    if "credentialProvider" in data:
        ...
        out["credential_provider"] = (
            aws_sdk_codebuild.types.credential_provider_type.deserialize_aws_json_1_1(
