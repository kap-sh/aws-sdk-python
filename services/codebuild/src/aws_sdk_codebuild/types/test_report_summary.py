...
if TYPE_CHECKING:
    import aws_sdk_codebuild.types.report_status_counts
...
class TestReportSummary(TypedDict, closed=True):
    ...
    duration_in_nano_seconds: "aws_sdk_codebuild.types.wrapper_long.WrapperLong"
...
def serialize_aws_json_1_1(value: TestReportSummary) -> dict:
    ...
    out["statusCounts"] = (
        aws_sdk_codebuild.types.report_status_counts.serialize_aws_json_1_1(
            value["status_counts"]
        )
    )
...
def deserialize_aws_json_1_1(data: dict) -> TestReportSummary:
    ...
    if "statusCounts" in data:
        ...
        out["status_counts"] = (
            aws_sdk_codebuild.types.report_status_counts.deserialize_aws_json_1_1(
                data["statusCounts"]
            )
        )
    else:
