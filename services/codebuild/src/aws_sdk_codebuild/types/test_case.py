...
class TestCase(TypedDict):
    ...
    prefix: NotRequired["aws_sdk_codebuild.types.string.String"]
    ...
    duration_in_nano_seconds: NotRequired[
        "aws_sdk_codebuild.types.wrapper_long.WrapperLong"
    ]
    ...
    test_suite_name: NotRequired["aws_sdk_codebuild.types.string.String"]
