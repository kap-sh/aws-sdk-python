...
class ListProjectsInput(TypedDict, closed=True):
    ...
    next_token: NotRequired["aws_sdk_codebuild.types.non_empty_string.NonEmptyString"]
...
def serialize_aws_json_1_1(value: ListProjectsInput) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["sortBy"] = (
            aws_sdk_codebuild.types.project_sort_by_type.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListProjectsInput:
    ...
    if "sortBy" in data:
        ...
        out["sort_by"] = (
            aws_sdk_codebuild.types.project_sort_by_type.deserialize_aws_json_1_1(
                data["sortBy"]
            )
        )
