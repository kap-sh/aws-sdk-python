...
class ReportExportConfig(TypedDict, closed=True):
    ...
    s3_destination: NotRequired[
        "aws_sdk_codebuild.types.s3_report_export_config.S3ReportExportConfig"
    ]
...
def serialize_aws_json_1_1(value: ReportExportConfig) -> dict:
    ...
    if "export_config_type" in value:
        ...
        out["exportConfigType"] = (
            aws_sdk_codebuild.types.report_export_config_type.serialize_aws_json_1_1(
    ...
    if "s3_destination" in value:
        ...
        out["s3Destination"] = (
            aws_sdk_codebuild.types.s3_report_export_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ReportExportConfig:
    ...
    if "exportConfigType" in data:
        ...
        out["export_config_type"] = (
            aws_sdk_codebuild.types.report_export_config_type.deserialize_aws_json_1_1(
    ...
    if "s3Destination" in data:
        ...
        out["s3_destination"] = (
            aws_sdk_codebuild.types.s3_report_export_config.deserialize_aws_json_1_1(
                data["s3Destination"]
            )
        )
    return out
