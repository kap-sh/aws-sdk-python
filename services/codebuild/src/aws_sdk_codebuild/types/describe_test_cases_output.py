...
class DescribeTestCasesOutput(TypedDict):
    ...
    test_cases: NotRequired["aws_sdk_codebuild.types.test_cases.TestCases"]
...
def serialize_aws_json_1_1(value: DescribeTestCasesOutput) -> dict:
    ...
    if "test_cases" in value:
        ...
        out["testCases"] = aws_sdk_codebuild.types.test_cases.serialize_aws_json_1_1(
            value["test_cases"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DescribeTestCasesOutput:
    ...
    if "testCases" in data:
        ...
        out["test_cases"] = aws_sdk_codebuild.types.test_cases.deserialize_aws_json_1_1(
            data["testCases"]
        )
    return out
