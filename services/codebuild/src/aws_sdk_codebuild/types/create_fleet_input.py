...
def serialize_aws_json_1_1(value: CreateFleetInput) -> dict:
    ...
    if "scaling_configuration" in value:
        ...
        out["scalingConfiguration"] = (
            aws_sdk_codebuild.types.scaling_configuration_input.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CreateFleetInput:
    ...
    if "scalingConfiguration" in data:
        ...
        out["scaling_configuration"] = (
            aws_sdk_codebuild.types.scaling_configuration_input.deserialize_aws_json_1_1(
