...
if TYPE_CHECKING:
    ...
    import aws_sdk_codebuild.types.resolved_secondary_artifacts
...
class BuildSummary(TypedDict):
    ...
    requested_on: NotRequired["aws_sdk_codebuild.types.timestamp.Timestamp"]
    ...
    secondary_artifacts: NotRequired[
        "aws_sdk_codebuild.types.resolved_secondary_artifacts.ResolvedSecondaryArtifacts"
    ]
...
def serialize_aws_json_1_1(value: BuildSummary) -> dict:
    ...
    if "requested_on" in value:
        ...
        out["requestedOn"] = aws_sdk_codebuild.types.timestamp.serialize_aws_json_1_1(
            value["requested_on"]
        )
    ...
    if "primary_artifact" in value:
        ...
        out["primaryArtifact"] = (
            aws_sdk_codebuild.types.resolved_artifact.serialize_aws_json_1_1(
    ...
    if "secondary_artifacts" in value:
        ...
        out["secondaryArtifacts"] = (
            aws_sdk_codebuild.types.resolved_secondary_artifacts.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> BuildSummary:
    ...
    if "primaryArtifact" in data:
        ...
        out["primary_artifact"] = (
            aws_sdk_codebuild.types.resolved_artifact.deserialize_aws_json_1_1(
    ...
    if "secondaryArtifacts" in data:
        ...
        out["secondary_artifacts"] = (
            aws_sdk_codebuild.types.resolved_secondary_artifacts.deserialize_aws_json_1_1(
