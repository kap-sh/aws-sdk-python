...
def serialize_aws_json_1_1(value: BatchGetReportsOutput) -> dict:
    ...
    if "reports" in value:
        ...
        out["reports"] = aws_sdk_codebuild.types.reports.serialize_aws_json_1_1(
            value["reports"]
        )
    if "reports_not_found" in value:
        ...
        out["reportsNotFound"] = (
            aws_sdk_codebuild.types.report_arns.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> BatchGetReportsOutput:
    ...
    if "reports" in data:
        ...
        out["reports"] = aws_sdk_codebuild.types.reports.deserialize_aws_json_1_1(
            data["reports"]
        )
