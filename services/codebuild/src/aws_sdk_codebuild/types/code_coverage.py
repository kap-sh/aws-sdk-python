...
class CodeCoverage(TypedDict):
    ...
    file_path: NotRequired["aws_sdk_codebuild.types.non_empty_string.NonEmptyString"]
    ...
    lines_covered: NotRequired[
        "aws_sdk_codebuild.types.non_negative_int.NonNegativeInt"
    ]
    """<p>The number of lines that are covered by your tests.</p>"""
    lines_missed: NotRequired["aws_sdk_codebuild.types.non_negative_int.NonNegativeInt"]
