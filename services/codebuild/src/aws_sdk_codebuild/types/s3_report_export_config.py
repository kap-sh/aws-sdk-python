...
if TYPE_CHECKING:
    ...
    import aws_sdk_codebuild.types.report_packaging_type
...
class S3ReportExportConfig(TypedDict, closed=True):
    ...
    packaging: NotRequired[
        "aws_sdk_codebuild.types.report_packaging_type.ReportPackagingType"
    ]
...
def serialize_aws_json_1_1(value: S3ReportExportConfig) -> dict:
    ...
    if "packaging" in value:
        ...
        out["packaging"] = (
            aws_sdk_codebuild.types.report_packaging_type.serialize_aws_json_1_1(
                value["packaging"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> S3ReportExportConfig:
    ...
    if "packaging" in data:
        ...
        out["packaging"] = (
            aws_sdk_codebuild.types.report_packaging_type.deserialize_aws_json_1_1(
                data["packaging"]
            )
        )
