...
class AccountLimitExceededException_(TypedDict):
...
class AccountLimitExceededException(ServiceError):
    ...
    def __init__(self, data: AccountLimitExceededException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "AccountLimitExceededException":
