...
class CodeBuildError(Exception):
    """Base class for all CodeBuild service errors."""


class ServiceError(CodeBuildError):
...
class SerializationError(CodeBuildError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CodeBuildError):
...
class WaiterFailedError(CodeBuildError):
...
class WaiterTimeoutError(CodeBuildError):
