...
from ._services.async_serverless_application_repository import (
    AsyncServerlessApplicationRepositoryClient as AsyncServerlessApplicationRepositoryClient,
)
from ._services.serverless_application_repository import (
    ServerlessApplicationRepositoryClient as ServerlessApplicationRepositoryClient,
)
