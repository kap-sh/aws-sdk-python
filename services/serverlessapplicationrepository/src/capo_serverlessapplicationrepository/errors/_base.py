...
class ServerlessApplicationRepositoryError(Exception):
    """Base class for all ServerlessApplicationRepository service errors."""


class ServiceError(ServerlessApplicationRepositoryError):
...
class SerializationError(ServerlessApplicationRepositoryError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ServerlessApplicationRepositoryError):
...
class WaiterFailedError(ServerlessApplicationRepositoryError):
...
class WaiterTimeoutError(ServerlessApplicationRepositoryError):
