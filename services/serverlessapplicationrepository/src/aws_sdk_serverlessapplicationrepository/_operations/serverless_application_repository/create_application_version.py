...
def build_request(
    ...
    input: aws_sdk_serverlessapplicationrepository.types.create_application_version_request.CreateApplicationVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{SemanticVersion}", quote(str(input["semantic_version"]), safe="")
    )
    params: dict[str, str] = {}
