...
def handle_response(
    ...
    out: aws_sdk_serverlessapplicationrepository.types.get_application_policy_response.GetApplicationPolicyResponse = aws_sdk_serverlessapplicationrepository.types.get_application_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_serverlessapplicationrepository.types.get_application_policy_request.GetApplicationPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
