"""Generated from Smithy shape ``com.amazonaws.serverlessapplicationrepository#CreateCloudFormationChangeSet``."""
...
def handle_response(
    ...
    out: aws_sdk_serverlessapplicationrepository.types.create_cloud_formation_change_set_response.CreateCloudFormationChangeSetResponse = aws_sdk_serverlessapplicationrepository.types.create_cloud_formation_change_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_serverlessapplicationrepository.types.create_cloud_formation_change_set_request.CreateCloudFormationChangeSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/applications/{ApplicationId}/changesets"
...
async def async_create_cloud_formation_change_set(
