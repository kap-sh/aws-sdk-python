...
def handle_response(
    ...
    out: aws_sdk_serverlessapplicationrepository.types.list_application_dependencies_response.ListApplicationDependenciesResponse = aws_sdk_serverlessapplicationrepository.types.list_application_dependencies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_serverlessapplicationrepository.types.list_application_dependencies_request.ListApplicationDependenciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
