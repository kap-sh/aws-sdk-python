...
def build_request(
    ...
    input: aws_sdk_serverlessapplicationrepository.types.list_application_dependencies_request.ListApplicationDependenciesRequest,
) -> zapros.Request:
    ...
    if "semantic_version" in input:
        params["semanticVersion"] = str(input["semantic_version"])
