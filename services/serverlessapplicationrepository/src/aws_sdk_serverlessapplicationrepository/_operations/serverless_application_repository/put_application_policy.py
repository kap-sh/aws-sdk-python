...
def handle_response(
    ...
    out: aws_sdk_serverlessapplicationrepository.types.put_application_policy_response.PutApplicationPolicyResponse = aws_sdk_serverlessapplicationrepository.types.put_application_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_serverlessapplicationrepository.types.put_application_policy_request.PutApplicationPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_serverlessapplicationrepository.types.put_application_policy_request.serialize_json(
            input_
        )
    ).encode()
