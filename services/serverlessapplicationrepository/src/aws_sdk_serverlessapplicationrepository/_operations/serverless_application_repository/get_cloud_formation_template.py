...
def handle_response(
    ...
    out: aws_sdk_serverlessapplicationrepository.types.get_cloud_formation_template_response.GetCloudFormationTemplateResponse = aws_sdk_serverlessapplicationrepository.types.get_cloud_formation_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_serverlessapplicationrepository.types.get_cloud_formation_template_request.GetCloudFormationTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
