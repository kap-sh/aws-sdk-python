"""Generated from Smithy shape ``com.amazonaws.serverlessapplicationrepository#ListApplicationVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_serverlessapplicationrepository.types.list_application_versions_response.ListApplicationVersionsResponse = aws_sdk_serverlessapplicationrepository.types.list_application_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_serverlessapplicationrepository.types.list_application_versions_request.ListApplicationVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/applications/{ApplicationId}/versions"
...
async def async_list_application_versions(
