"""Generated from Smithy shape ``com.amazonaws.serverlessapplicationrepository#CreateApplicationVersionResponse``."""
...
class CreateApplicationVersionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateApplicationVersionResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateApplicationVersionResponse:
    out: CreateApplicationVersionResponse = {}  # type: ignore[typeddict-item]
