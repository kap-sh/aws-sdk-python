import pytest
from capo_simpledbv2._rule_engine._endpoint_rule_set import EndpointParams, resolve
from capo_simpledbv2._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb.amazonaws.com'
...
def test_for_region_cn_northwest_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb-fips.cn-northwest-1.api.amazonwebservices.com.cn'
...
def test_for_region_cn_northwest_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb-fips.cn-northwest-1.amazonaws.com.cn'
...
def test_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb.cn-northwest-1.api.amazonwebservices.com.cn'
...
def test_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb.cn-northwest-1.amazonaws.com.cn'
...
def test_for_region_eusc_de_east_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb-fips.eusc-de-east-1.amazonaws.eu'
...
def test_for_region_eusc_de_east_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb.eusc-de-east-1.amazonaws.eu'
...
def test_for_region_us_iso_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb-fips.us-iso-east-1.c2s.ic.gov'
...
def test_for_region_us_iso_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb.us-iso-east-1.c2s.ic.gov'
...
def test_for_region_us_isob_east_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb-fips.us-isob-east-1.sc2s.sgov.gov'
...
def test_for_region_us_isob_east_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb.us-isob-east-1.sc2s.sgov.gov'
...
def test_for_region_eu_isoe_west_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb-fips.eu-isoe-west-1.cloud.adc-e.uk'
...
def test_for_region_eu_isoe_west_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb.eu-isoe-west-1.cloud.adc-e.uk'
...
def test_for_region_us_isof_south_1_with_fips_ena():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb-fips.us-isof-south-1.csp.hci.ic.gov'
...
def test_for_region_us_isof_south_1_with_fips_dis():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb.us-isof-south-1.csp.hci.ic.gov'
...
def test_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb-fips.us-gov-west-1.api.aws'
...
def test_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb-fips.us-gov-west-1.amazonaws.com'
...
def test_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb.us-gov-west-1.api.aws'
...
def test_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://sdb.us-gov-west-1.amazonaws.com'
