...
def build_request(
    ...
    input: aws_sdk_simpledbv2.types.start_domain_export_request.StartDomainExportRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_simpledbv2.types.start_domain_export_request.serialize_json(input)
    ).encode()
