...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidNextTokenException":
            import aws_sdk_simpledbv2.errors.invalid_next_token_exception

            raise aws_sdk_simpledbv2.errors.invalid_next_token_exception.InvalidNextTokenException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_simpledbv2.types.list_exports_response.ListExportsResponse = (
        aws_sdk_simpledbv2.types.list_exports_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_simpledbv2.types.list_exports_request.ListExportsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_simpledbv2.types.list_exports_request.serialize_json(input)
    ).encode()
...
def list_exports(
    ...
    aws_sdk_simpledbv2.types.list_exports_response.ListExportsResponse, zapros.Response
]:
