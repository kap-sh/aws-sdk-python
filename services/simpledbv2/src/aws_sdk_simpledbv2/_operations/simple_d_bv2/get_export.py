...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NoSuchExportException":
            import aws_sdk_simpledbv2.errors.no_such_export_exception

            raise aws_sdk_simpledbv2.errors.no_such_export_exception.NoSuchExportException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_simpledbv2.types.get_export_response.GetExportResponse = (
        aws_sdk_simpledbv2.types.get_export_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_simpledbv2.types.get_export_request.GetExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_simpledbv2.types.get_export_request.serialize_json(input_)
    ).encode()
...
def get_export(
    ...
    aws_sdk_simpledbv2.types.get_export_response.GetExportResponse, zapros.Response
]:
