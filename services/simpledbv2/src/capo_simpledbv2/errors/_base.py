...
class SimpleDBv2Error(Exception):
    """Base class for all SimpleDBv2 service errors."""


class ServiceError(SimpleDBv2Error):
...
class SerializationError(SimpleDBv2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(SimpleDBv2Error):
...
class WaiterFailedError(SimpleDBv2Error):
...
class WaiterTimeoutError(SimpleDBv2Error):
