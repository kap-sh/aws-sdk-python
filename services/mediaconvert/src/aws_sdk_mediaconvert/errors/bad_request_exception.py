"""Generated from Smithy shape ``com.amazonaws.mediaconvert#BadRequestException``."""
...
class BadRequestException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.mediaconvert#BadRequestException``."""
