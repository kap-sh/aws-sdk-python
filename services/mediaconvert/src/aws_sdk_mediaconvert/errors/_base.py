...
class MediaConvertError(Exception):
    """Base class for all MediaConvert service errors."""


class ServiceError(MediaConvertError):
...
class SerializationError(MediaConvertError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MediaConvertError):
...
class WaiterFailedError(MediaConvertError):
...
class WaiterTimeoutError(MediaConvertError):
