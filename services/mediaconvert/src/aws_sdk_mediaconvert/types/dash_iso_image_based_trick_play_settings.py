...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__integer_min1_max4096
    import aws_sdk_mediaconvert.types.__integer_min8_max4096
    import aws_sdk_mediaconvert.types.dash_iso_interval_cadence


class DashIsoImageBasedTrickPlaySettings(TypedDict, closed=True):
    interval_cadence: NotRequired[
        "aws_sdk_mediaconvert.types.dash_iso_interval_cadence.DashIsoIntervalCadence"
    ]
    ...
    thumbnail_height: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min1_max4096.__integerMin1Max4096"
    ]
...
def serialize_json(value: DashIsoImageBasedTrickPlaySettings) -> dict:
    ...
    if "interval_cadence" in value:
        ...
        out["intervalCadence"] = (
            aws_sdk_mediaconvert.types.dash_iso_interval_cadence.serialize_json(
...
def deserialize_json(data: dict) -> DashIsoImageBasedTrickPlaySettings:
    ...
    if "intervalCadence" in data:
        ...
        out["interval_cadence"] = (
            aws_sdk_mediaconvert.types.dash_iso_interval_cadence.deserialize_json(
