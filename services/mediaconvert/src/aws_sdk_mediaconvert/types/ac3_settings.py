...
if TYPE_CHECKING:
    import aws_sdk_mediaconvert.types.__integer_min1_max31
    import aws_sdk_mediaconvert.types.__integer_min48000_max48000
    import aws_sdk_mediaconvert.types.__integer_min64000_max640000
    import aws_sdk_mediaconvert.types.ac3_bitstream_mode
    import aws_sdk_mediaconvert.types.ac3_coding_mode
    import aws_sdk_mediaconvert.types.ac3_dynamic_range_compression_line
    import aws_sdk_mediaconvert.types.ac3_dynamic_range_compression_profile
    import aws_sdk_mediaconvert.types.ac3_dynamic_range_compression_rf
    import aws_sdk_mediaconvert.types.ac3_lfe_filter
    import aws_sdk_mediaconvert.types.ac3_metadata_control


class Ac3Settings(TypedDict):
    bitrate: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min64000_max640000.__integerMin64000Max640000"
    ]
    ...
    bitstream_mode: NotRequired[
        "aws_sdk_mediaconvert.types.ac3_bitstream_mode.Ac3BitstreamMode"
    ]
    """Specify the bitstream mode for the AC-3 stream that the encoder emits. For more information about the AC3 bitstream mode, see ATSC A/52-2012 (Annex E)."""
    coding_mode: NotRequired["aws_sdk_mediaconvert.types.ac3_coding_mode.Ac3CodingMode"]
    """Dolby Digital coding mode. Determines number of channels."""
    dialnorm: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min1_max31.__integerMin1Max31"
    ]
    """Sets the dialnorm for the output. If blank and input audio is Dolby Digital, dialnorm will be passed through."""
    dynamic_range_compression_line: NotRequired[
        "aws_sdk_mediaconvert.types.ac3_dynamic_range_compression_line.Ac3DynamicRangeCompressionLine"
    ]
    ...
    dynamic_range_compression_profile: NotRequired[
        "aws_sdk_mediaconvert.types.ac3_dynamic_range_compression_profile.Ac3DynamicRangeCompressionProfile"
    ]
    ...
    dynamic_range_compression_rf: NotRequired[
        "aws_sdk_mediaconvert.types.ac3_dynamic_range_compression_rf.Ac3DynamicRangeCompressionRf"
    ]
    ...
    lfe_filter: NotRequired["aws_sdk_mediaconvert.types.ac3_lfe_filter.Ac3LfeFilter"]
    """Applies a 120Hz lowpass filter to the LFE channel prior to encoding. Only valid with 3_2_LFE coding mode."""
    metadata_control: NotRequired[
        "aws_sdk_mediaconvert.types.ac3_metadata_control.Ac3MetadataControl"
    ]
...
def serialize_json(value: Ac3Settings) -> dict:
    ...
    if "bitstream_mode" in value:
        ...
        out["bitstreamMode"] = (
            aws_sdk_mediaconvert.types.ac3_bitstream_mode.serialize_json(
    ...
    if "coding_mode" in value:
        ...
        out["codingMode"] = aws_sdk_mediaconvert.types.ac3_coding_mode.serialize_json(
            value["coding_mode"]
        )
    ...
    if "dynamic_range_compression_line" in value:
        ...
        out["dynamicRangeCompressionLine"] = (
            aws_sdk_mediaconvert.types.ac3_dynamic_range_compression_line.serialize_json(
    ...
    if "dynamic_range_compression_profile" in value:
        ...
        out["dynamicRangeCompressionProfile"] = (
            aws_sdk_mediaconvert.types.ac3_dynamic_range_compression_profile.serialize_json(
    ...
    if "dynamic_range_compression_rf" in value:
        ...
        out["dynamicRangeCompressionRf"] = (
            aws_sdk_mediaconvert.types.ac3_dynamic_range_compression_rf.serialize_json(
    ...
    if "lfe_filter" in value:
        ...
        out["lfeFilter"] = aws_sdk_mediaconvert.types.ac3_lfe_filter.serialize_json(
            value["lfe_filter"]
        )
    if "metadata_control" in value:
        ...
        out["metadataControl"] = (
            aws_sdk_mediaconvert.types.ac3_metadata_control.serialize_json(
...
def deserialize_json(data: dict) -> Ac3Settings:
    ...
    if "bitstreamMode" in data:
        ...
        out["bitstream_mode"] = (
            aws_sdk_mediaconvert.types.ac3_bitstream_mode.deserialize_json(
                data["bitstreamMode"]
            )
        )
    if "codingMode" in data:
        ...
        out["coding_mode"] = (
            aws_sdk_mediaconvert.types.ac3_coding_mode.deserialize_json(
                data["codingMode"]
            )
        )
    if "dialnorm" in data:
    ...
    if "dynamicRangeCompressionLine" in data:
        ...
        out["dynamic_range_compression_line"] = (
            aws_sdk_mediaconvert.types.ac3_dynamic_range_compression_line.deserialize_json(
    ...
    if "dynamicRangeCompressionProfile" in data:
        ...
        out["dynamic_range_compression_profile"] = (
            aws_sdk_mediaconvert.types.ac3_dynamic_range_compression_profile.deserialize_json(
    ...
    if "dynamicRangeCompressionRf" in data:
        ...
        out["dynamic_range_compression_rf"] = (
            aws_sdk_mediaconvert.types.ac3_dynamic_range_compression_rf.deserialize_json(
    ...
    if "lfeFilter" in data:
        ...
        out["lfe_filter"] = aws_sdk_mediaconvert.types.ac3_lfe_filter.deserialize_json(
            data["lfeFilter"]
        )
    if "metadataControl" in data:
        ...
        out["metadata_control"] = (
            aws_sdk_mediaconvert.types.ac3_metadata_control.deserialize_json(
