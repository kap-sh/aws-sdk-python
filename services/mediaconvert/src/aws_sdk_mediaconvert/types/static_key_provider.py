...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__string_pattern_a_za_z0932
    import aws_sdk_mediaconvert.types.__string_pattern_dd
    import aws_sdk_mediaconvert.types.__string_pattern_identity_a_za_z26_a_za_z09163


class StaticKeyProvider(TypedDict):
    key_format: NotRequired[
        "aws_sdk_mediaconvert.types.__string_pattern_identity_a_za_z26_a_za_z09163.__stringPatternIdentityAZaZ26AZaZ09163"
    ]
    """Relates to DRM implementation. Sets the value of the KEYFORMAT attribute. Must be 'identity' or a reverse DNS string. May be omitted to indicate an implicit value of 'identity'."""
    key_format_versions: NotRequired[
        "aws_sdk_mediaconvert.types.__string_pattern_dd.__stringPatternDD"
    ]
    """Relates to DRM implementation. Either a single positive integer version value or a slash delimited list of version values (1/2/3)."""
    static_key_value: NotRequired[
        "aws_sdk_mediaconvert.types.__string_pattern_a_za_z0932.__stringPatternAZaZ0932"
    ]
