...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.video_overlay_crop
    import aws_sdk_mediaconvert.types.video_overlay_input
    import aws_sdk_mediaconvert.types.video_overlay_play_back_mode
...
class VideoOverlay(TypedDict, closed=True):
    ...
    input: NotRequired[
        "aws_sdk_mediaconvert.types.video_overlay_input.VideoOverlayInput"
    ]
    ...
    playback: NotRequired[
        "aws_sdk_mediaconvert.types.video_overlay_play_back_mode.VideoOverlayPlayBackMode"
    ]
    ...
    transitions: NotRequired[
        "aws_sdk_mediaconvert.types.__list_of_video_overlay_transition.__listOfVideoOverlayTransition"
    ]
...
def serialize_json(value: VideoOverlay) -> dict:
    ...
    if "crop" in value:
        ...
        out["crop"] = aws_sdk_mediaconvert.types.video_overlay_crop.serialize_json(
            value["crop"]
        )
    ...
    if "initial_position" in value:
        ...
        out["initialPosition"] = (
            aws_sdk_mediaconvert.types.video_overlay_position.serialize_json(
    ...
    if "input" in value:
        ...
        out["input"] = aws_sdk_mediaconvert.types.video_overlay_input.serialize_json(
            value["input"]
        )
    if "playback" in value:
        ...
        out["playback"] = (
            aws_sdk_mediaconvert.types.video_overlay_play_back_mode.serialize_json(
                value["playback"]
            )
        )
    ...
    if "transitions" in value:
        ...
        out["transitions"] = (
            aws_sdk_mediaconvert.types.__list_of_video_overlay_transition.serialize_json(
                value["transitions"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> VideoOverlay:
    ...
    if "crop" in data:
        ...
        out["crop"] = aws_sdk_mediaconvert.types.video_overlay_crop.deserialize_json(
            data["crop"]
        )
    ...
    if "initialPosition" in data:
        ...
        out["initial_position"] = (
            aws_sdk_mediaconvert.types.video_overlay_position.deserialize_json(
    ...
    if "input" in data:
        ...
        out["input"] = aws_sdk_mediaconvert.types.video_overlay_input.deserialize_json(
            data["input"]
        )
    if "playback" in data:
        import aws_sdk_mediaconvert.types.video_overlay_play_back_mode
        ...
        out["playback"] = (
            aws_sdk_mediaconvert.types.video_overlay_play_back_mode.deserialize_json(
                data["playback"]
            )
        )
    ...
    if "transitions" in data:
        ...
        out["transitions"] = (
            aws_sdk_mediaconvert.types.__list_of_video_overlay_transition.deserialize_json(
                data["transitions"]
            )
        )
    return out
