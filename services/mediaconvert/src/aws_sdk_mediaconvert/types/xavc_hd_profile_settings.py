...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__integer_min4_max12
    ...
    import aws_sdk_mediaconvert.types.xavc_hd_profile_bitrate_class
    import aws_sdk_mediaconvert.types.xavc_hd_profile_quality_tuning_level
    import aws_sdk_mediaconvert.types.xavc_hd_profile_telecine
...
class XavcHdProfileSettings(TypedDict, closed=True):
    ...
    interlace_mode: NotRequired[
        "aws_sdk_mediaconvert.types.xavc_interlace_mode.XavcInterlaceMode"
    ]
    ...
    quality_tuning_level: NotRequired[
        "aws_sdk_mediaconvert.types.xavc_hd_profile_quality_tuning_level.XavcHdProfileQualityTuningLevel"
    ]
    """Optional. Use Quality tuning level to choose how you want to trade off encoding speed for output video quality. The default behavior is faster, lower quality, single-pass encoding."""
    slices: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min4_max12.__integerMin4Max12"
    ]
    """Number of slices per picture. Must be less than or equal to the number of macroblock rows for progressive pictures, and less than or equal to half the number of macroblock rows for interlaced pictures."""
    telecine: NotRequired[
        "aws_sdk_mediaconvert.types.xavc_hd_profile_telecine.XavcHdProfileTelecine"
    ]
...
def serialize_json(value: XavcHdProfileSettings) -> dict:
    ...
    if "bitrate_class" in value:
        ...
        out["bitrateClass"] = (
            aws_sdk_mediaconvert.types.xavc_hd_profile_bitrate_class.serialize_json(
                value["bitrate_class"]
            )
        )
    ...
    if "interlace_mode" in value:
        ...
        out["interlaceMode"] = (
            aws_sdk_mediaconvert.types.xavc_interlace_mode.serialize_json(
    ...
    if "quality_tuning_level" in value:
        ...
        out["qualityTuningLevel"] = (
            aws_sdk_mediaconvert.types.xavc_hd_profile_quality_tuning_level.serialize_json(
    ...
    if "telecine" in value:
        ...
        out["telecine"] = (
            aws_sdk_mediaconvert.types.xavc_hd_profile_telecine.serialize_json(
                value["telecine"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> XavcHdProfileSettings:
    ...
    if "bitrateClass" in data:
        ...
        out["bitrate_class"] = (
            aws_sdk_mediaconvert.types.xavc_hd_profile_bitrate_class.deserialize_json(
                data["bitrateClass"]
            )
        )
    ...
    if "interlaceMode" in data:
        ...
        out["interlace_mode"] = (
            aws_sdk_mediaconvert.types.xavc_interlace_mode.deserialize_json(
                data["interlaceMode"]
            )
        )
    if "qualityTuningLevel" in data:
        ...
        out["quality_tuning_level"] = (
            aws_sdk_mediaconvert.types.xavc_hd_profile_quality_tuning_level.deserialize_json(
    ...
    if "telecine" in data:
        ...
        out["telecine"] = (
            aws_sdk_mediaconvert.types.xavc_hd_profile_telecine.deserialize_json(
                data["telecine"]
            )
        )
    return out
