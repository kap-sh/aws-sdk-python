...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__list_of__string_pattern_s3_assetmap_xml
    import aws_sdk_mediaconvert.types.__list_of_input_clipping
    import aws_sdk_mediaconvert.types.__list_of_multi_view_settings
    import aws_sdk_mediaconvert.types.__list_of_video_overlay
    import aws_sdk_mediaconvert.types.__map_of_audio_selector
    import aws_sdk_mediaconvert.types.__map_of_audio_selector_group
    import aws_sdk_mediaconvert.types.__map_of_caption_selector
    import aws_sdk_mediaconvert.types.__map_of_dynamic_audio_selector
    import aws_sdk_mediaconvert.types.__string_max2048_pattern_s3_https
    import aws_sdk_mediaconvert.types.__string_min11_max11_pattern01_d20305_d205_d
    import aws_sdk_mediaconvert.types.__string_min14_pattern_s3_xml_xml_https_xml_xml
    import aws_sdk_mediaconvert.types.advanced_input_filter
    import aws_sdk_mediaconvert.types.advanced_input_filter_settings
    import aws_sdk_mediaconvert.types.image_inserter
    import aws_sdk_mediaconvert.types.input_deblock_filter
    import aws_sdk_mediaconvert.types.input_decryption_settings
    import aws_sdk_mediaconvert.types.input_denoise_filter
    import aws_sdk_mediaconvert.types.input_filter_enable
    import aws_sdk_mediaconvert.types.input_psi_control
    import aws_sdk_mediaconvert.types.input_scan_type
    import aws_sdk_mediaconvert.types.input_tams_settings
    import aws_sdk_mediaconvert.types.input_timecode_source
    import aws_sdk_mediaconvert.types.input_video_generator
...
class Input(TypedDict):
    ...
    advanced_input_filter_settings: NotRequired[
        "aws_sdk_mediaconvert.types.advanced_input_filter_settings.AdvancedInputFilterSettings"
    ]
    """Optional settings for Advanced input filter when you set Advanced input filter to Enabled."""
    audio_selector_groups: NotRequired[
        "aws_sdk_mediaconvert.types.__map_of_audio_selector_group.__mapOfAudioSelectorGroup"
    ]
    ...
    caption_selectors: NotRequired[
        "aws_sdk_mediaconvert.types.__map_of_caption_selector.__mapOfCaptionSelector"
    ]
    ...
    deblock_filter: NotRequired[
        "aws_sdk_mediaconvert.types.input_deblock_filter.InputDeblockFilter"
    ]
    ...
    decryption_settings: NotRequired[
        "aws_sdk_mediaconvert.types.input_decryption_settings.InputDecryptionSettings"
    ]
    """Settings for decrypting any input files that you encrypt before you upload them to Amazon S3. MediaConvert can decrypt files only when you use AWS Key Management Service (KMS) to encrypt the data key that you use to encrypt your content."""
    denoise_filter: NotRequired[
        "aws_sdk_mediaconvert.types.input_denoise_filter.InputDenoiseFilter"
    ]
    ...
    dolby_vision_metadata_xml: NotRequired[
        "aws_sdk_mediaconvert.types.__string_min14_pattern_s3_xml_xml_https_xml_xml.__stringMin14PatternS3XmlXMLHttpsXmlXML"
    ]
    ...
    dynamic_audio_selectors: NotRequired[
        "aws_sdk_mediaconvert.types.__map_of_dynamic_audio_selector.__mapOfDynamicAudioSelector"
    ]
    ...
    file_input: NotRequired[
        "aws_sdk_mediaconvert.types.__string_max2048_pattern_s3_https.__stringMax2048PatternS3Https"
    ]
    ...
    filter_enable: NotRequired[
        "aws_sdk_mediaconvert.types.input_filter_enable.InputFilterEnable"
    ]
    ...
    filter_strength: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min0_max5.__integerMin0Max5"
    ]
    ...
    input_clippings: NotRequired[
        "aws_sdk_mediaconvert.types.__list_of_input_clipping.__listOfInputClipping"
    ]
    ...
    input_scan_type: NotRequired[
        "aws_sdk_mediaconvert.types.input_scan_type.InputScanType"
    ]
    ...
    multi_view_settings: NotRequired[
        "aws_sdk_mediaconvert.types.__list_of_multi_view_settings.__listOfMultiViewSettings"
    ]
    ...
    psi_control: NotRequired[
        "aws_sdk_mediaconvert.types.input_psi_control.InputPsiControl"
    ]
    ...
    video_generator: NotRequired[
        "aws_sdk_mediaconvert.types.input_video_generator.InputVideoGenerator"
    ]
    """When you include Video generator, MediaConvert creates a video input with black frames. Use this setting if you do not have a video input or if you want to add black video frames before, or after, other inputs. You can specify Video generator, or you can specify an Input file, but you cannot specify both. For more information, see https://docs.aws.amazon.com/mediaconvert/latest/ug/video-generator.html"""
    video_overlays: NotRequired[
        "aws_sdk_mediaconvert.types.__list_of_video_overlay.__listOfVideoOverlay"
    ]
    """Contains an array of video overlays."""
    video_selector: NotRequired[
        "aws_sdk_mediaconvert.types.video_selector.VideoSelector"
    ]
...
def serialize_json(value: Input) -> dict:
    ...
    if "advanced_input_filter" in value:
        ...
        out["advancedInputFilter"] = (
            aws_sdk_mediaconvert.types.advanced_input_filter.serialize_json(
    ...
    if "advanced_input_filter_settings" in value:
        ...
        out["advancedInputFilterSettings"] = (
            aws_sdk_mediaconvert.types.advanced_input_filter_settings.serialize_json(
    ...
    if "audio_selector_groups" in value:
        ...
        out["audioSelectorGroups"] = (
            aws_sdk_mediaconvert.types.__map_of_audio_selector_group.serialize_json(
    ...
    if "caption_selectors" in value:
        ...
        out["captionSelectors"] = (
            aws_sdk_mediaconvert.types.__map_of_caption_selector.serialize_json(
    ...
    if "deblock_filter" in value:
        ...
        out["deblockFilter"] = (
            aws_sdk_mediaconvert.types.input_deblock_filter.serialize_json(
    ...
    if "decryption_settings" in value:
        ...
        out["decryptionSettings"] = (
            aws_sdk_mediaconvert.types.input_decryption_settings.serialize_json(
    ...
    if "denoise_filter" in value:
        ...
        out["denoiseFilter"] = (
            aws_sdk_mediaconvert.types.input_denoise_filter.serialize_json(
    ...
    if "dynamic_audio_selectors" in value:
        ...
        out["dynamicAudioSelectors"] = (
            aws_sdk_mediaconvert.types.__map_of_dynamic_audio_selector.serialize_json(
    ...
    if "filter_enable" in value:
        ...
        out["filterEnable"] = (
            aws_sdk_mediaconvert.types.input_filter_enable.serialize_json(
                value["filter_enable"]
            )
        )
    ...
    if "input_clippings" in value:
        ...
        out["inputClippings"] = (
            aws_sdk_mediaconvert.types.__list_of_input_clipping.serialize_json(
    ...
    if "input_scan_type" in value:
        ...
        out["inputScanType"] = (
            aws_sdk_mediaconvert.types.input_scan_type.serialize_json(
    ...
    if "multi_view_settings" in value:
        ...
        out["multiViewSettings"] = (
            aws_sdk_mediaconvert.types.__list_of_multi_view_settings.serialize_json(
    ...
    if "psi_control" in value:
        ...
        out["psiControl"] = aws_sdk_mediaconvert.types.input_psi_control.serialize_json(
            value["psi_control"]
        )
    if "supplemental_imps" in value:
        ...
        out["supplementalImps"] = (
            aws_sdk_mediaconvert.types.__list_of__string_pattern_s3_assetmap_xml.serialize_json(
    ...
    if "tams_settings" in value:
        ...
        out["tamsSettings"] = (
            aws_sdk_mediaconvert.types.input_tams_settings.serialize_json(
                value["tams_settings"]
            )
        )
    ...
    if "video_generator" in value:
        ...
        out["videoGenerator"] = (
            aws_sdk_mediaconvert.types.input_video_generator.serialize_json(
    ...
    if "video_overlays" in value:
        ...
        out["videoOverlays"] = (
            aws_sdk_mediaconvert.types.__list_of_video_overlay.serialize_json(
    ...
    if "video_selector" in value:
        ...
        out["videoSelector"] = aws_sdk_mediaconvert.types.video_selector.serialize_json(
...
def deserialize_json(data: dict) -> Input:
    ...
    if "advancedInputFilter" in data:
        ...
        out["advanced_input_filter"] = (
            aws_sdk_mediaconvert.types.advanced_input_filter.deserialize_json(
    ...
    if "advancedInputFilterSettings" in data:
        ...
        out["advanced_input_filter_settings"] = (
            aws_sdk_mediaconvert.types.advanced_input_filter_settings.deserialize_json(
    ...
    if "audioSelectorGroups" in data:
        ...
        out["audio_selector_groups"] = (
            aws_sdk_mediaconvert.types.__map_of_audio_selector_group.deserialize_json(
    ...
    if "captionSelectors" in data:
        ...
        out["caption_selectors"] = (
            aws_sdk_mediaconvert.types.__map_of_caption_selector.deserialize_json(
    ...
    if "deblockFilter" in data:
        ...
        out["deblock_filter"] = (
            aws_sdk_mediaconvert.types.input_deblock_filter.deserialize_json(
                data["deblockFilter"]
            )
        )
    if "decryptionSettings" in data:
        ...
        out["decryption_settings"] = (
            aws_sdk_mediaconvert.types.input_decryption_settings.deserialize_json(
    ...
    if "denoiseFilter" in data:
        ...
        out["denoise_filter"] = (
            aws_sdk_mediaconvert.types.input_denoise_filter.deserialize_json(
                data["denoiseFilter"]
            )
        )
    ...
    if "dynamicAudioSelectors" in data:
        ...
        out["dynamic_audio_selectors"] = (
            aws_sdk_mediaconvert.types.__map_of_dynamic_audio_selector.deserialize_json(
    ...
    if "filterEnable" in data:
        ...
        out["filter_enable"] = (
            aws_sdk_mediaconvert.types.input_filter_enable.deserialize_json(
                data["filterEnable"]
            )
        )
    ...
    if "inputClippings" in data:
        ...
        out["input_clippings"] = (
            aws_sdk_mediaconvert.types.__list_of_input_clipping.deserialize_json(
                data["inputClippings"]
            )
        )
    if "inputScanType" in data:
        ...
        out["input_scan_type"] = (
            aws_sdk_mediaconvert.types.input_scan_type.deserialize_json(
                data["inputScanType"]
            )
        )
    if "multiViewSettings" in data:
        ...
        out["multi_view_settings"] = (
            aws_sdk_mediaconvert.types.__list_of_multi_view_settings.deserialize_json(
    ...
    if "psiControl" in data:
        ...
        out["psi_control"] = (
            aws_sdk_mediaconvert.types.input_psi_control.deserialize_json(
                data["psiControl"]
            )
        )
    if "supplementalImps" in data:
        ...
        out["supplemental_imps"] = (
            aws_sdk_mediaconvert.types.__list_of__string_pattern_s3_assetmap_xml.deserialize_json(
    ...
    if "tamsSettings" in data:
        ...
        out["tams_settings"] = (
            aws_sdk_mediaconvert.types.input_tams_settings.deserialize_json(
                data["tamsSettings"]
            )
        )
    ...
    if "videoGenerator" in data:
        ...
        out["video_generator"] = (
            aws_sdk_mediaconvert.types.input_video_generator.deserialize_json(
                data["videoGenerator"]
            )
        )
    if "videoOverlays" in data:
        ...
        out["video_overlays"] = (
            aws_sdk_mediaconvert.types.__list_of_video_overlay.deserialize_json(
                data["videoOverlays"]
            )
        )
    if "videoSelector" in data:
        ...
        out["video_selector"] = (
            aws_sdk_mediaconvert.types.video_selector.deserialize_json(
                data["videoSelector"]
            )
        )
    return out
