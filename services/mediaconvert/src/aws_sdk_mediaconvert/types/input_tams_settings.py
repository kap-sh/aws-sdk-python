...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__string_pattern019090190908019090190908
    import aws_sdk_mediaconvert.types.__string_pattern_arn_aws_az09_events_az090912_connection_azaz09_af0936
...
class InputTamsSettings(TypedDict):
    ...
    gap_handling: NotRequired[
        "aws_sdk_mediaconvert.types.tams_gap_handling.TamsGapHandling"
    ]
    ...
    source_id: NotRequired["aws_sdk_mediaconvert.types.__string.__string"]
    ...
    timerange: NotRequired[
        "aws_sdk_mediaconvert.types.__string_pattern019090190908019090190908.__stringPattern019090190908019090190908"
    ]
...
def serialize_json(value: InputTamsSettings) -> dict:
    ...
    if "gap_handling" in value:
        ...
        out["gapHandling"] = (
            aws_sdk_mediaconvert.types.tams_gap_handling.serialize_json(
                value["gap_handling"]
            )
        )
...
def deserialize_json(data: dict) -> InputTamsSettings:
    ...
    if "gapHandling" in data:
        ...
        out["gap_handling"] = (
            aws_sdk_mediaconvert.types.tams_gap_handling.deserialize_json(
                data["gapHandling"]
            )
        )
    if "sourceId" in data:
