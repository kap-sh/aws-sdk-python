"""Generated from Smithy shape ``com.amazonaws.mediaconvert#WebvttAccessibilitySubs``."""
...
WebvttAccessibilitySubs: TypeAlias = Literal[
    "DISABLED",
    "ENABLED",
]
...
def serialize_json(value: WebvttAccessibilitySubs) -> str:
    return value


def deserialize_json(data: str) -> WebvttAccessibilitySubs:
    if data not in _VALUES:
        raise DeserializationError(f"unknown WebvttAccessibilitySubs value: {data!r}")
    return cast(WebvttAccessibilitySubs, data)
