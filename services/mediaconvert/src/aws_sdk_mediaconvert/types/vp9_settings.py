...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__integer_min1000_max480000000
    import aws_sdk_mediaconvert.types.vp9_framerate_control
    import aws_sdk_mediaconvert.types.vp9_framerate_conversion_algorithm
    import aws_sdk_mediaconvert.types.vp9_par_control
    import aws_sdk_mediaconvert.types.vp9_quality_tuning_level
    import aws_sdk_mediaconvert.types.vp9_rate_control_mode


class Vp9Settings(TypedDict):
    bitrate: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min1000_max480000000.__integerMin1000Max480000000"
    ]
    """Target bitrate in bits/second. For example, enter five megabits per second as 5000000."""
    framerate_control: NotRequired[
        "aws_sdk_mediaconvert.types.vp9_framerate_control.Vp9FramerateControl"
    ]
    ...
    framerate_conversion_algorithm: NotRequired[
        "aws_sdk_mediaconvert.types.vp9_framerate_conversion_algorithm.Vp9FramerateConversionAlgorithm"
    ]
    ...
    par_control: NotRequired["aws_sdk_mediaconvert.types.vp9_par_control.Vp9ParControl"]
    ...
    quality_tuning_level: NotRequired[
        "aws_sdk_mediaconvert.types.vp9_quality_tuning_level.Vp9QualityTuningLevel"
    ]
    ...
    rate_control_mode: NotRequired[
        "aws_sdk_mediaconvert.types.vp9_rate_control_mode.Vp9RateControlMode"
    ]
...
def serialize_json(value: Vp9Settings) -> dict:
    ...
    if "framerate_control" in value:
        ...
        out["framerateControl"] = (
            aws_sdk_mediaconvert.types.vp9_framerate_control.serialize_json(
    ...
    if "framerate_conversion_algorithm" in value:
        ...
        out["framerateConversionAlgorithm"] = (
            aws_sdk_mediaconvert.types.vp9_framerate_conversion_algorithm.serialize_json(
    ...
    if "par_control" in value:
        ...
        out["parControl"] = aws_sdk_mediaconvert.types.vp9_par_control.serialize_json(
            value["par_control"]
        )
    ...
    if "quality_tuning_level" in value:
        ...
        out["qualityTuningLevel"] = (
            aws_sdk_mediaconvert.types.vp9_quality_tuning_level.serialize_json(
    ...
    if "rate_control_mode" in value:
        ...
        out["rateControlMode"] = (
            aws_sdk_mediaconvert.types.vp9_rate_control_mode.serialize_json(
...
def deserialize_json(data: dict) -> Vp9Settings:
    ...
    if "framerateControl" in data:
        ...
        out["framerate_control"] = (
            aws_sdk_mediaconvert.types.vp9_framerate_control.deserialize_json(
    ...
    if "framerateConversionAlgorithm" in data:
        ...
        out["framerate_conversion_algorithm"] = (
            aws_sdk_mediaconvert.types.vp9_framerate_conversion_algorithm.deserialize_json(
    ...
    if "parControl" in data:
        ...
        out["par_control"] = (
            aws_sdk_mediaconvert.types.vp9_par_control.deserialize_json(
                data["parControl"]
            )
        )
    ...
    if "qualityTuningLevel" in data:
        ...
        out["quality_tuning_level"] = (
            aws_sdk_mediaconvert.types.vp9_quality_tuning_level.deserialize_json(
    ...
    if "rateControlMode" in data:
        ...
        out["rate_control_mode"] = (
            aws_sdk_mediaconvert.types.vp9_rate_control_mode.deserialize_json(
