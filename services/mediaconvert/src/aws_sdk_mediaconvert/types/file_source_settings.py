...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__string_min14_pattern_s3_scc_scc_ttml_ttml_dfxp_dfxp_stl_stl_srt_srt_xml_xml_smi_smi_vtt_vtt_webvtt_webvtt_https_scc_scc_ttml_ttml_dfxp_dfxp_stl_stl_srt_srt_xml_xml_smi_smi_vtt_vtt_webvtt_webvtt
    import aws_sdk_mediaconvert.types.caption_source_byte_rate_limit
    import aws_sdk_mediaconvert.types.caption_source_convert_paint_on_to_pop_on
    import aws_sdk_mediaconvert.types.caption_source_framerate
    import aws_sdk_mediaconvert.types.caption_source_upconvert_stl_to_teletext
    import aws_sdk_mediaconvert.types.file_source_convert608_to708
...
class FileSourceSettings(TypedDict, closed=True):
    ...
    convert608_to708: NotRequired[
        "aws_sdk_mediaconvert.types.file_source_convert608_to708.FileSourceConvert608To708"
    ]
    ...
    convert_paint_to_pop: NotRequired[
        "aws_sdk_mediaconvert.types.caption_source_convert_paint_on_to_pop_on.CaptionSourceConvertPaintOnToPopOn"
    ]
    ...
    framerate: NotRequired[
        "aws_sdk_mediaconvert.types.caption_source_framerate.CaptionSourceFramerate"
    ]
    ...
    source_file: NotRequired[
        "aws_sdk_mediaconvert.types.__string_min14_pattern_s3_scc_scc_ttml_ttml_dfxp_dfxp_stl_stl_srt_srt_xml_xml_smi_smi_vtt_vtt_webvtt_webvtt_https_scc_scc_ttml_ttml_dfxp_dfxp_stl_stl_srt_srt_xml_xml_smi_smi_vtt_vtt_webvtt_webvtt.__stringMin14PatternS3SccSCCTtmlTTMLDfxpDFXPStlSTLSrtSRTXmlXMLSmiSMIVttVTTWebvttWEBVTTHttpsSccSCCTtmlTTMLDfxpDFXPStlSTLSrtSRTXmlXMLSmiSMIVttVTTWebvttWEBVTT"
    ]
    ...
    time_delta_units: NotRequired[
        "aws_sdk_mediaconvert.types.file_source_time_delta_units.FileSourceTimeDeltaUnits"
    ]
    ...
    upconvert_stl_to_teletext: NotRequired[
        "aws_sdk_mediaconvert.types.caption_source_upconvert_stl_to_teletext.CaptionSourceUpconvertSTLToTeletext"
    ]
...
def serialize_json(value: FileSourceSettings) -> dict:
    ...
    if "byte_rate_limit" in value:
        ...
        out["byteRateLimit"] = (
            aws_sdk_mediaconvert.types.caption_source_byte_rate_limit.serialize_json(
    ...
    if "convert608_to708" in value:
        ...
        out["convert608To708"] = (
            aws_sdk_mediaconvert.types.file_source_convert608_to708.serialize_json(
    ...
    if "convert_paint_to_pop" in value:
        ...
        out["convertPaintToPop"] = (
            aws_sdk_mediaconvert.types.caption_source_convert_paint_on_to_pop_on.serialize_json(
    ...
    if "framerate" in value:
        ...
        out["framerate"] = (
            aws_sdk_mediaconvert.types.caption_source_framerate.serialize_json(
                value["framerate"]
            )
        )
    ...
    if "time_delta_units" in value:
        ...
        out["timeDeltaUnits"] = (
            aws_sdk_mediaconvert.types.file_source_time_delta_units.serialize_json(
    ...
    if "upconvert_stl_to_teletext" in value:
        ...
        out["upconvertSTLToTeletext"] = (
            aws_sdk_mediaconvert.types.caption_source_upconvert_stl_to_teletext.serialize_json(
...
def deserialize_json(data: dict) -> FileSourceSettings:
    ...
    if "byteRateLimit" in data:
        ...
        out["byte_rate_limit"] = (
            aws_sdk_mediaconvert.types.caption_source_byte_rate_limit.deserialize_json(
                data["byteRateLimit"]
            )
        )
    if "convert608To708" in data:
        ...
        out["convert608_to708"] = (
            aws_sdk_mediaconvert.types.file_source_convert608_to708.deserialize_json(
    ...
    if "convertPaintToPop" in data:
        ...
        out["convert_paint_to_pop"] = (
            aws_sdk_mediaconvert.types.caption_source_convert_paint_on_to_pop_on.deserialize_json(
    ...
    if "framerate" in data:
        ...
        out["framerate"] = (
            aws_sdk_mediaconvert.types.caption_source_framerate.deserialize_json(
                data["framerate"]
            )
        )
    ...
    if "timeDeltaUnits" in data:
        ...
        out["time_delta_units"] = (
            aws_sdk_mediaconvert.types.file_source_time_delta_units.deserialize_json(
                data["timeDeltaUnits"]
            )
        )
    if "upconvertSTLToTeletext" in data:
        ...
        out["upconvert_stl_to_teletext"] = (
            aws_sdk_mediaconvert.types.caption_source_upconvert_stl_to_teletext.deserialize_json(
