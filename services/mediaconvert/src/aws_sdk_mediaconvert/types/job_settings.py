...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__list_of_input
...
class JobSettings(TypedDict):
    ...
    inputs: NotRequired["aws_sdk_mediaconvert.types.__list_of_input.__listOfInput"]
...
def serialize_json(value: JobSettings) -> dict:
    ...
    if "inputs" in value:
        ...
        out["inputs"] = aws_sdk_mediaconvert.types.__list_of_input.serialize_json(
            value["inputs"]
        )
...
def deserialize_json(data: dict) -> JobSettings:
    ...
    if "inputs" in data:
        ...
        out["inputs"] = aws_sdk_mediaconvert.types.__list_of_input.deserialize_json(
            data["inputs"]
        )
