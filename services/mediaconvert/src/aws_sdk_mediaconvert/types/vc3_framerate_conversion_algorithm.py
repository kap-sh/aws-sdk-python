"""Generated from Smithy shape ``com.amazonaws.mediaconvert#Vc3FramerateConversionAlgorithm``."""
...
Vc3FramerateConversionAlgorithm: TypeAlias = Literal[
    "DUPLICATE_DROP",
    "INTERPOLATE",
    "FRAMEFORMER",
...
def serialize_json(value: Vc3FramerateConversionAlgorithm) -> str:
    return value


def deserialize_json(data: str) -> Vc3FramerateConversionAlgorithm:
    if data not in _VALUES:
        raise DeserializationError(
            f"unknown Vc3FramerateConversionAlgorithm value: {data!r}"
        )
    return cast(Vc3FramerateConversionAlgorithm, data)
