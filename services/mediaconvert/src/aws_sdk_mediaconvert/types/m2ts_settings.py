...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__integer_min0_max10000
    ...
    import aws_sdk_mediaconvert.types.dvb_nit_settings
    import aws_sdk_mediaconvert.types.dvb_sdt_settings
    import aws_sdk_mediaconvert.types.dvb_tdt_settings
    import aws_sdk_mediaconvert.types.m2ts_audio_buffer_model
    import aws_sdk_mediaconvert.types.m2ts_audio_duration
    import aws_sdk_mediaconvert.types.m2ts_buffer_model
    import aws_sdk_mediaconvert.types.m2ts_data_pts_control
    import aws_sdk_mediaconvert.types.m2ts_ebp_audio_interval
    import aws_sdk_mediaconvert.types.m2ts_ebp_placement
    import aws_sdk_mediaconvert.types.m2ts_es_rate_in_pes
    import aws_sdk_mediaconvert.types.m2ts_force_ts_video_ebp_order
    import aws_sdk_mediaconvert.types.m2ts_klv_metadata
    import aws_sdk_mediaconvert.types.m2ts_nielsen_id3
    import aws_sdk_mediaconvert.types.m2ts_pcr_control
    import aws_sdk_mediaconvert.types.m2ts_prevent_buffer_underflow
    import aws_sdk_mediaconvert.types.m2ts_rate_mode
    import aws_sdk_mediaconvert.types.m2ts_scte35_esam
    import aws_sdk_mediaconvert.types.m2ts_scte35_source
    import aws_sdk_mediaconvert.types.m2ts_segmentation_markers
    import aws_sdk_mediaconvert.types.m2ts_segmentation_style
    import aws_sdk_mediaconvert.types.ts_pts_offset


class M2tsSettings(TypedDict, closed=True):
    audio_buffer_model: NotRequired[
        "aws_sdk_mediaconvert.types.m2ts_audio_buffer_model.M2tsAudioBufferModel"
    ]
    """Selects between the DVB and ATSC buffer models for Dolby Digital audio."""
    audio_duration: NotRequired[
        "aws_sdk_mediaconvert.types.m2ts_audio_duration.M2tsAudioDuration"
    ]
    ...
    buffer_model: NotRequired[
        "aws_sdk_mediaconvert.types.m2ts_buffer_model.M2tsBufferModel"
    ]
    """Controls what buffer model to use for accurate interleaving. If set to MULTIPLEX, use multiplex buffer model. If set to NONE, this can lead to lower latency, but low-memory devices may not be able to play back the stream without interruptions."""
    data_pts_control: NotRequired[
        "aws_sdk_mediaconvert.types.m2ts_data_pts_control.M2tsDataPtsControl"
    ]
    ...
    dvb_nit_settings: NotRequired[
        "aws_sdk_mediaconvert.types.dvb_nit_settings.DvbNitSettings"
    ]
    ...
    dvb_sdt_settings: NotRequired[
        "aws_sdk_mediaconvert.types.dvb_sdt_settings.DvbSdtSettings"
    ]
    ...
    dvb_tdt_settings: NotRequired[
        "aws_sdk_mediaconvert.types.dvb_tdt_settings.DvbTdtSettings"
    ]
    ...
    ebp_audio_interval: NotRequired[
        "aws_sdk_mediaconvert.types.m2ts_ebp_audio_interval.M2tsEbpAudioInterval"
    ]
    """When set to VIDEO_AND_FIXED_INTERVALS, audio EBP markers will be added to partitions 3 and 4. The interval between these additional markers will be fixed, and will be slightly shorter than the video EBP marker interval. When set to VIDEO_INTERVAL, these additional markers will not be inserted. Only applicable when EBP segmentation markers are is selected (segmentationMarkers is EBP or EBP_LEGACY)."""
    ebp_placement: NotRequired[
        "aws_sdk_mediaconvert.types.m2ts_ebp_placement.M2tsEbpPlacement"
    ]
    """Selects which PIDs to place EBP markers on. They can either be placed only on the video PID, or on both the video PID and all audio PIDs. Only applicable when EBP segmentation markers are is selected (segmentationMarkers is EBP or EBP_LEGACY)."""
    es_rate_in_pes: NotRequired[
        "aws_sdk_mediaconvert.types.m2ts_es_rate_in_pes.M2tsEsRateInPes"
    ]
    """Controls whether to include the ES Rate field in the PES header."""
    force_ts_video_ebp_order: NotRequired[
        "aws_sdk_mediaconvert.types.m2ts_force_ts_video_ebp_order.M2tsForceTsVideoEbpOrder"
    ]
    ...
    fragment_time: NotRequired["aws_sdk_mediaconvert.types.__double_min0.__doubleMin0"]
    """The length, in seconds, of each fragment. Only used with EBP markers."""
    klv_metadata: NotRequired[
        "aws_sdk_mediaconvert.types.m2ts_klv_metadata.M2tsKlvMetadata"
    ]
    ...
    pcr_control: NotRequired[
        "aws_sdk_mediaconvert.types.m2ts_pcr_control.M2tsPcrControl"
    ]
    ...
    prevent_buffer_underflow: NotRequired[
        "aws_sdk_mediaconvert.types.m2ts_prevent_buffer_underflow.M2tsPreventBufferUnderflow"
    ]
    ...
    rate_mode: NotRequired["aws_sdk_mediaconvert.types.m2ts_rate_mode.M2tsRateMode"]
    """When set to CBR, inserts null packets into transport stream to fill specified bitrate. When set to VBR, the bitrate setting acts as the maximum bitrate, but the output will not be padded up to that bitrate."""
    scte35_esam: NotRequired[
        "aws_sdk_mediaconvert.types.m2ts_scte35_esam.M2tsScte35Esam"
    ]
    ...
    scte35_source: NotRequired[
        "aws_sdk_mediaconvert.types.m2ts_scte35_source.M2tsScte35Source"
    ]
    ...
    segmentation_markers: NotRequired[
        "aws_sdk_mediaconvert.types.m2ts_segmentation_markers.M2tsSegmentationMarkers"
    ]
...
def serialize_json(value: M2tsSettings) -> dict:
    ...
    if "audio_buffer_model" in value:
        ...
        out["audioBufferModel"] = (
            aws_sdk_mediaconvert.types.m2ts_audio_buffer_model.serialize_json(
    ...
    if "audio_duration" in value:
        ...
        out["audioDuration"] = (
            aws_sdk_mediaconvert.types.m2ts_audio_duration.serialize_json(
    ...
    if "buffer_model" in value:
        ...
        out["bufferModel"] = (
            aws_sdk_mediaconvert.types.m2ts_buffer_model.serialize_json(
                value["buffer_model"]
            )
        )
    if "data_pts_control" in value:
        ...
        out["dataPTSControl"] = (
            aws_sdk_mediaconvert.types.m2ts_data_pts_control.serialize_json(
    ...
    if "dvb_nit_settings" in value:
        ...
        out["dvbNitSettings"] = (
            aws_sdk_mediaconvert.types.dvb_nit_settings.serialize_json(
    ...
    if "dvb_sdt_settings" in value:
        ...
        out["dvbSdtSettings"] = (
            aws_sdk_mediaconvert.types.dvb_sdt_settings.serialize_json(
    ...
    if "dvb_tdt_settings" in value:
        ...
        out["dvbTdtSettings"] = (
            aws_sdk_mediaconvert.types.dvb_tdt_settings.serialize_json(
    ...
    if "ebp_audio_interval" in value:
        ...
        out["ebpAudioInterval"] = (
            aws_sdk_mediaconvert.types.m2ts_ebp_audio_interval.serialize_json(
    ...
    if "ebp_placement" in value:
        ...
        out["ebpPlacement"] = (
            aws_sdk_mediaconvert.types.m2ts_ebp_placement.serialize_json(
                value["ebp_placement"]
            )
        )
    if "es_rate_in_pes" in value:
        ...
        out["esRateInPes"] = (
            aws_sdk_mediaconvert.types.m2ts_es_rate_in_pes.serialize_json(
    ...
    if "force_ts_video_ebp_order" in value:
        ...
        out["forceTsVideoEbpOrder"] = (
            aws_sdk_mediaconvert.types.m2ts_force_ts_video_ebp_order.serialize_json(
    ...
    if "klv_metadata" in value:
        ...
        out["klvMetadata"] = (
            aws_sdk_mediaconvert.types.m2ts_klv_metadata.serialize_json(
                value["klv_metadata"]
            )
        )
    ...
    if "nielsen_id3" in value:
        ...
        out["nielsenId3"] = aws_sdk_mediaconvert.types.m2ts_nielsen_id3.serialize_json(
            value["nielsen_id3"]
        )
    ...
    if "pcr_control" in value:
        ...
        out["pcrControl"] = aws_sdk_mediaconvert.types.m2ts_pcr_control.serialize_json(
            value["pcr_control"]
        )
    if "pcr_pid" in value:
    ...
    if "prevent_buffer_underflow" in value:
        ...
        out["preventBufferUnderflow"] = (
            aws_sdk_mediaconvert.types.m2ts_prevent_buffer_underflow.serialize_json(
    ...
    if "rate_mode" in value:
        ...
        out["rateMode"] = aws_sdk_mediaconvert.types.m2ts_rate_mode.serialize_json(
            value["rate_mode"]
        )
    if "scte35_esam" in value:
        import aws_sdk_mediaconvert.types.m2ts_scte35_esam

        out["scte35Esam"] = aws_sdk_mediaconvert.types.m2ts_scte35_esam.serialize_json(
            value["scte35_esam"]
        )
    ...
    if "scte35_source" in value:
        ...
        out["scte35Source"] = (
            aws_sdk_mediaconvert.types.m2ts_scte35_source.serialize_json(
                value["scte35_source"]
            )
        )
    if "segmentation_markers" in value:
        ...
        out["segmentationMarkers"] = (
            aws_sdk_mediaconvert.types.m2ts_segmentation_markers.serialize_json(
    ...
    if "segmentation_style" in value:
        ...
        out["segmentationStyle"] = (
            aws_sdk_mediaconvert.types.m2ts_segmentation_style.serialize_json(
...
def deserialize_json(data: dict) -> M2tsSettings:
    ...
    if "audioBufferModel" in data:
        ...
        out["audio_buffer_model"] = (
            aws_sdk_mediaconvert.types.m2ts_audio_buffer_model.deserialize_json(
    ...
    if "audioDuration" in data:
        ...
        out["audio_duration"] = (
            aws_sdk_mediaconvert.types.m2ts_audio_duration.deserialize_json(
                data["audioDuration"]
            )
        )
    ...
    if "bufferModel" in data:
        ...
        out["buffer_model"] = (
            aws_sdk_mediaconvert.types.m2ts_buffer_model.deserialize_json(
                data["bufferModel"]
            )
        )
    if "dataPTSControl" in data:
        ...
        out["data_pts_control"] = (
            aws_sdk_mediaconvert.types.m2ts_data_pts_control.deserialize_json(
                data["dataPTSControl"]
            )
        )
    if "dvbNitSettings" in data:
        ...
        out["dvb_nit_settings"] = (
            aws_sdk_mediaconvert.types.dvb_nit_settings.deserialize_json(
                data["dvbNitSettings"]
            )
        )
    if "dvbSdtSettings" in data:
        ...
        out["dvb_sdt_settings"] = (
            aws_sdk_mediaconvert.types.dvb_sdt_settings.deserialize_json(
                data["dvbSdtSettings"]
            )
        )
    ...
    if "dvbTdtSettings" in data:
        ...
        out["dvb_tdt_settings"] = (
            aws_sdk_mediaconvert.types.dvb_tdt_settings.deserialize_json(
                data["dvbTdtSettings"]
            )
        )
    ...
    if "ebpAudioInterval" in data:
        ...
        out["ebp_audio_interval"] = (
            aws_sdk_mediaconvert.types.m2ts_ebp_audio_interval.deserialize_json(
    ...
    if "ebpPlacement" in data:
        ...
        out["ebp_placement"] = (
            aws_sdk_mediaconvert.types.m2ts_ebp_placement.deserialize_json(
                data["ebpPlacement"]
            )
        )
    if "esRateInPes" in data:
        ...
        out["es_rate_in_pes"] = (
            aws_sdk_mediaconvert.types.m2ts_es_rate_in_pes.deserialize_json(
                data["esRateInPes"]
            )
        )
    if "forceTsVideoEbpOrder" in data:
        ...
        out["force_ts_video_ebp_order"] = (
            aws_sdk_mediaconvert.types.m2ts_force_ts_video_ebp_order.deserialize_json(
    ...
    if "klvMetadata" in data:
        ...
        out["klv_metadata"] = (
            aws_sdk_mediaconvert.types.m2ts_klv_metadata.deserialize_json(
                data["klvMetadata"]
            )
        )
    ...
    if "nielsenId3" in data:
        ...
        out["nielsen_id3"] = (
            aws_sdk_mediaconvert.types.m2ts_nielsen_id3.deserialize_json(
                data["nielsenId3"]
            )
        )
    ...
    if "pcrControl" in data:
        ...
        out["pcr_control"] = (
            aws_sdk_mediaconvert.types.m2ts_pcr_control.deserialize_json(
                data["pcrControl"]
            )
        )
    if "pcrPid" in data:
    ...
    if "preventBufferUnderflow" in data:
        ...
        out["prevent_buffer_underflow"] = (
            aws_sdk_mediaconvert.types.m2ts_prevent_buffer_underflow.deserialize_json(
    ...
    if "rateMode" in data:
        ...
        out["rate_mode"] = aws_sdk_mediaconvert.types.m2ts_rate_mode.deserialize_json(
            data["rateMode"]
        )
    if "scte35Esam" in data:
        ...
        out["scte35_esam"] = (
            aws_sdk_mediaconvert.types.m2ts_scte35_esam.deserialize_json(
                data["scte35Esam"]
            )
        )
    ...
    if "scte35Source" in data:
        ...
        out["scte35_source"] = (
            aws_sdk_mediaconvert.types.m2ts_scte35_source.deserialize_json(
                data["scte35Source"]
            )
        )
    if "segmentationMarkers" in data:
        ...
        out["segmentation_markers"] = (
            aws_sdk_mediaconvert.types.m2ts_segmentation_markers.deserialize_json(
    ...
    if "segmentationStyle" in data:
        ...
        out["segmentation_style"] = (
            aws_sdk_mediaconvert.types.m2ts_segmentation_style.deserialize_json(
