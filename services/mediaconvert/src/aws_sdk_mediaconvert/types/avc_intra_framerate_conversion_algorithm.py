"""Generated from Smithy shape ``com.amazonaws.mediaconvert#AvcIntraFramerateConversionAlgorithm``."""
...
AvcIntraFramerateConversionAlgorithm: TypeAlias = Literal[
    "DUPLICATE_DROP",
    "INTERPOLATE",
    "FRAMEFORMER",
...
def serialize_json(value: AvcIntraFramerateConversionAlgorithm) -> str:
    return value


def deserialize_json(data: str) -> AvcIntraFramerateConversionAlgorithm:
    if data not in _VALUES:
        raise DeserializationError(
            f"unknown AvcIntraFramerateConversionAlgorithm value: {data!r}"
        )
    return cast(AvcIntraFramerateConversionAlgorithm, data)
