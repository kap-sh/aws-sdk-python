...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__integer_min0_max96
    ...
    import aws_sdk_mediaconvert.types.__integer_min96_max600
    import aws_sdk_mediaconvert.types.__integer_min_negative2147483648_max2147483647
    import aws_sdk_mediaconvert.types.__string_min6_max8_pattern09a_faf609a_faf2
    import aws_sdk_mediaconvert.types.__string_pattern_s3_ttf_https_ttf
    import aws_sdk_mediaconvert.types.dvb_sub_subtitle_fallback_font
    import aws_sdk_mediaconvert.types.dvb_subtitle_alignment
    import aws_sdk_mediaconvert.types.dvb_subtitle_apply_font_color
    import aws_sdk_mediaconvert.types.dvb_subtitle_background_color
    import aws_sdk_mediaconvert.types.dvb_subtitle_font_color
    import aws_sdk_mediaconvert.types.dvb_subtitle_outline_color
    import aws_sdk_mediaconvert.types.dvb_subtitle_shadow_color
    import aws_sdk_mediaconvert.types.dvb_subtitle_style_passthrough
    import aws_sdk_mediaconvert.types.dvb_subtitle_teletext_spacing
    import aws_sdk_mediaconvert.types.dvb_subtitling_type
    import aws_sdk_mediaconvert.types.dvbdds_handling
...
class DvbSubDestinationSettings(TypedDict):
    ...
    apply_font_color: NotRequired[
        "aws_sdk_mediaconvert.types.dvb_subtitle_apply_font_color.DvbSubtitleApplyFontColor"
    ]
    ...
    background_color: NotRequired[
        "aws_sdk_mediaconvert.types.dvb_subtitle_background_color.DvbSubtitleBackgroundColor"
    ]
    ...
    dds_handling: NotRequired[
        "aws_sdk_mediaconvert.types.dvbdds_handling.DvbddsHandling"
    ]
    ...
    fallback_font: NotRequired[
        "aws_sdk_mediaconvert.types.dvb_sub_subtitle_fallback_font.DvbSubSubtitleFallbackFont"
    ]
    ...
    font_color: NotRequired[
        "aws_sdk_mediaconvert.types.dvb_subtitle_font_color.DvbSubtitleFontColor"
    ]
    ...
    font_file_bold: NotRequired[
        "aws_sdk_mediaconvert.types.__string_pattern_s3_ttf_https_ttf.__stringPatternS3TtfHttpsTtf"
    ]
    ...
    font_resolution: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min96_max600.__integerMin96Max600"
    ]
    """Specify the Font resolution in DPI (dots per inch). Within your job settings, all of your DVB-Sub settings must be identical."""
    font_script: NotRequired["aws_sdk_mediaconvert.types.font_script.FontScript"]
    ...
    font_size: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min0_max96.__integerMin0Max96"
    ]
    ...
    hex_font_color: NotRequired[
        "aws_sdk_mediaconvert.types.__string_min6_max8_pattern09a_faf609a_faf2.__stringMin6Max8Pattern09aFAF609aFAF2"
    ]
    ...
    outline_color: NotRequired[
        "aws_sdk_mediaconvert.types.dvb_subtitle_outline_color.DvbSubtitleOutlineColor"
    ]
    ...
    outline_size: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min0_max10.__integerMin0Max10"
    ]
    ...
    shadow_color: NotRequired[
        "aws_sdk_mediaconvert.types.dvb_subtitle_shadow_color.DvbSubtitleShadowColor"
    ]
    ...
    style_passthrough: NotRequired[
        "aws_sdk_mediaconvert.types.dvb_subtitle_style_passthrough.DvbSubtitleStylePassthrough"
    ]
    ...
    subtitling_type: NotRequired[
        "aws_sdk_mediaconvert.types.dvb_subtitling_type.DvbSubtitlingType"
    ]
    """Specify whether your DVB subtitles are standard or for hearing impaired. Choose hearing impaired if your subtitles include audio descriptions and dialogue. Choose standard if your subtitles include only dialogue."""
    teletext_spacing: NotRequired[
        "aws_sdk_mediaconvert.types.dvb_subtitle_teletext_spacing.DvbSubtitleTeletextSpacing"
    ]
...
def serialize_json(value: DvbSubDestinationSettings) -> dict:
    ...
    if "alignment" in value:
        ...
        out["alignment"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_alignment.serialize_json(
                value["alignment"]
            )
        )
    if "apply_font_color" in value:
        ...
        out["applyFontColor"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_apply_font_color.serialize_json(
    ...
    if "background_color" in value:
        ...
        out["backgroundColor"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_background_color.serialize_json(
    ...
    if "dds_handling" in value:
        ...
        out["ddsHandling"] = aws_sdk_mediaconvert.types.dvbdds_handling.serialize_json(
            value["dds_handling"]
        )
    ...
    if "fallback_font" in value:
        ...
        out["fallbackFont"] = (
            aws_sdk_mediaconvert.types.dvb_sub_subtitle_fallback_font.serialize_json(
                value["fallback_font"]
            )
        )
    if "font_color" in value:
        ...
        out["fontColor"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_font_color.serialize_json(
                value["font_color"]
            )
        )
    ...
    if "font_script" in value:
        ...
        out["fontScript"] = aws_sdk_mediaconvert.types.font_script.serialize_json(
            value["font_script"]
        )
    ...
    if "outline_color" in value:
        ...
        out["outlineColor"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_outline_color.serialize_json(
                value["outline_color"]
            )
        )
    ...
    if "shadow_color" in value:
        ...
        out["shadowColor"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_shadow_color.serialize_json(
                value["shadow_color"]
            )
        )
    ...
    if "style_passthrough" in value:
        ...
        out["stylePassthrough"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_style_passthrough.serialize_json(
    ...
    if "subtitling_type" in value:
        ...
        out["subtitlingType"] = (
            aws_sdk_mediaconvert.types.dvb_subtitling_type.serialize_json(
    ...
    if "teletext_spacing" in value:
        ...
        out["teletextSpacing"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_teletext_spacing.serialize_json(
...
def deserialize_json(data: dict) -> DvbSubDestinationSettings:
    ...
    if "alignment" in data:
        ...
        out["alignment"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_alignment.deserialize_json(
                data["alignment"]
            )
        )
    if "applyFontColor" in data:
        ...
        out["apply_font_color"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_apply_font_color.deserialize_json(
                data["applyFontColor"]
            )
        )
    if "backgroundColor" in data:
        ...
        out["background_color"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_background_color.deserialize_json(
    ...
    if "ddsHandling" in data:
        ...
        out["dds_handling"] = (
            aws_sdk_mediaconvert.types.dvbdds_handling.deserialize_json(
                data["ddsHandling"]
            )
        )
    ...
    if "fallbackFont" in data:
        ...
        out["fallback_font"] = (
            aws_sdk_mediaconvert.types.dvb_sub_subtitle_fallback_font.deserialize_json(
                data["fallbackFont"]
            )
        )
    if "fontColor" in data:
        ...
        out["font_color"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_font_color.deserialize_json(
                data["fontColor"]
            )
        )
    ...
    if "fontScript" in data:
        ...
        out["font_script"] = aws_sdk_mediaconvert.types.font_script.deserialize_json(
            data["fontScript"]
        )
    if "fontSize" in data:
    ...
    if "outlineColor" in data:
        ...
        out["outline_color"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_outline_color.deserialize_json(
                data["outlineColor"]
            )
        )
    ...
    if "shadowColor" in data:
        ...
        out["shadow_color"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_shadow_color.deserialize_json(
                data["shadowColor"]
            )
        )
    ...
    if "stylePassthrough" in data:
        ...
        out["style_passthrough"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_style_passthrough.deserialize_json(
    ...
    if "subtitlingType" in data:
        ...
        out["subtitling_type"] = (
            aws_sdk_mediaconvert.types.dvb_subtitling_type.deserialize_json(
                data["subtitlingType"]
            )
        )
    if "teletextSpacing" in data:
        ...
        out["teletext_spacing"] = (
            aws_sdk_mediaconvert.types.dvb_subtitle_teletext_spacing.deserialize_json(
