...
__listOfEndpoint: TypeAlias = list["aws_sdk_mediaconvert.types.endpoint.Endpoint"]
...
def serialize_json(value: __listOfEndpoint) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_mediaconvert.types.endpoint.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> __listOfEndpoint:
    ...
    for item in data:
        out.append(aws_sdk_mediaconvert.types.endpoint.deserialize_json(item))
    return out
