...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.vp8_framerate_control
    import aws_sdk_mediaconvert.types.vp8_framerate_conversion_algorithm
    import aws_sdk_mediaconvert.types.vp8_par_control
    import aws_sdk_mediaconvert.types.vp8_quality_tuning_level
...
class Vp8Settings(TypedDict):
    ...
    framerate_control: NotRequired[
        "aws_sdk_mediaconvert.types.vp8_framerate_control.Vp8FramerateControl"
    ]
    ...
    framerate_conversion_algorithm: NotRequired[
        "aws_sdk_mediaconvert.types.vp8_framerate_conversion_algorithm.Vp8FramerateConversionAlgorithm"
    ]
    ...
    par_control: NotRequired["aws_sdk_mediaconvert.types.vp8_par_control.Vp8ParControl"]
    ...
    quality_tuning_level: NotRequired[
        "aws_sdk_mediaconvert.types.vp8_quality_tuning_level.Vp8QualityTuningLevel"
    ]
    ...
    rate_control_mode: NotRequired[
        "aws_sdk_mediaconvert.types.vp8_rate_control_mode.Vp8RateControlMode"
    ]
...
def serialize_json(value: Vp8Settings) -> dict:
    ...
    if "framerate_control" in value:
        ...
        out["framerateControl"] = (
            aws_sdk_mediaconvert.types.vp8_framerate_control.serialize_json(
    ...
    if "framerate_conversion_algorithm" in value:
        ...
        out["framerateConversionAlgorithm"] = (
            aws_sdk_mediaconvert.types.vp8_framerate_conversion_algorithm.serialize_json(
    ...
    if "par_control" in value:
        ...
        out["parControl"] = aws_sdk_mediaconvert.types.vp8_par_control.serialize_json(
            value["par_control"]
        )
    ...
    if "quality_tuning_level" in value:
        ...
        out["qualityTuningLevel"] = (
            aws_sdk_mediaconvert.types.vp8_quality_tuning_level.serialize_json(
    ...
    if "rate_control_mode" in value:
        ...
        out["rateControlMode"] = (
            aws_sdk_mediaconvert.types.vp8_rate_control_mode.serialize_json(
...
def deserialize_json(data: dict) -> Vp8Settings:
    ...
    if "framerateControl" in data:
        ...
        out["framerate_control"] = (
            aws_sdk_mediaconvert.types.vp8_framerate_control.deserialize_json(
    ...
    if "framerateConversionAlgorithm" in data:
        ...
        out["framerate_conversion_algorithm"] = (
            aws_sdk_mediaconvert.types.vp8_framerate_conversion_algorithm.deserialize_json(
    ...
    if "parControl" in data:
        ...
        out["par_control"] = (
            aws_sdk_mediaconvert.types.vp8_par_control.deserialize_json(
                data["parControl"]
            )
        )
    ...
    if "qualityTuningLevel" in data:
        ...
        out["quality_tuning_level"] = (
            aws_sdk_mediaconvert.types.vp8_quality_tuning_level.deserialize_json(
    ...
    if "rateControlMode" in data:
        ...
        out["rate_control_mode"] = (
            aws_sdk_mediaconvert.types.vp8_rate_control_mode.deserialize_json(
