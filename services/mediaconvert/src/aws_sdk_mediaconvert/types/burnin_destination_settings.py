...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.burn_in_subtitle_style_passthrough
    import aws_sdk_mediaconvert.types.burnin_subtitle_alignment
    import aws_sdk_mediaconvert.types.burnin_subtitle_apply_font_color
    import aws_sdk_mediaconvert.types.burnin_subtitle_background_color
    import aws_sdk_mediaconvert.types.burnin_subtitle_fallback_font
    import aws_sdk_mediaconvert.types.burnin_subtitle_font_color
    import aws_sdk_mediaconvert.types.burnin_subtitle_outline_color
    import aws_sdk_mediaconvert.types.burnin_subtitle_shadow_color
    import aws_sdk_mediaconvert.types.burnin_subtitle_teletext_spacing
...
class BurninDestinationSettings(TypedDict):
    ...
    apply_font_color: NotRequired[
        "aws_sdk_mediaconvert.types.burnin_subtitle_apply_font_color.BurninSubtitleApplyFontColor"
    ]
    ...
    background_color: NotRequired[
        "aws_sdk_mediaconvert.types.burnin_subtitle_background_color.BurninSubtitleBackgroundColor"
    ]
    ...
    fallback_font: NotRequired[
        "aws_sdk_mediaconvert.types.burnin_subtitle_fallback_font.BurninSubtitleFallbackFont"
    ]
    ...
    font_color: NotRequired[
        "aws_sdk_mediaconvert.types.burnin_subtitle_font_color.BurninSubtitleFontColor"
    ]
    ...
    font_file_bold_italic: NotRequired["aws_sdk_mediaconvert.types.__string.__string"]
    ...
    outline_color: NotRequired[
        "aws_sdk_mediaconvert.types.burnin_subtitle_outline_color.BurninSubtitleOutlineColor"
    ]
    ...
    remove_ruby_reserve_attributes: NotRequired[
        "aws_sdk_mediaconvert.types.remove_ruby_reserve_attributes.RemoveRubyReserveAttributes"
    ]
    ...
    shadow_color: NotRequired[
        "aws_sdk_mediaconvert.types.burnin_subtitle_shadow_color.BurninSubtitleShadowColor"
    ]
    ...
    style_passthrough: NotRequired[
        "aws_sdk_mediaconvert.types.burn_in_subtitle_style_passthrough.BurnInSubtitleStylePassthrough"
    ]
    ...
    teletext_spacing: NotRequired[
        "aws_sdk_mediaconvert.types.burnin_subtitle_teletext_spacing.BurninSubtitleTeletextSpacing"
    ]
...
def serialize_json(value: BurninDestinationSettings) -> dict:
    ...
    if "alignment" in value:
        ...
        out["alignment"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_alignment.serialize_json(
                value["alignment"]
            )
        )
    if "apply_font_color" in value:
        ...
        out["applyFontColor"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_apply_font_color.serialize_json(
    ...
    if "background_color" in value:
        ...
        out["backgroundColor"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_background_color.serialize_json(
    ...
    if "fallback_font" in value:
        ...
        out["fallbackFont"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_fallback_font.serialize_json(
                value["fallback_font"]
            )
        )
    if "font_color" in value:
        ...
        out["fontColor"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_font_color.serialize_json(
                value["font_color"]
            )
        )
    ...
    if "outline_color" in value:
        ...
        out["outlineColor"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_outline_color.serialize_json(
                value["outline_color"]
            )
        )
    ...
    if "remove_ruby_reserve_attributes" in value:
        ...
        out["removeRubyReserveAttributes"] = (
            aws_sdk_mediaconvert.types.remove_ruby_reserve_attributes.serialize_json(
    ...
    if "shadow_color" in value:
        ...
        out["shadowColor"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_shadow_color.serialize_json(
                value["shadow_color"]
            )
        )
    ...
    if "style_passthrough" in value:
        ...
        out["stylePassthrough"] = (
            aws_sdk_mediaconvert.types.burn_in_subtitle_style_passthrough.serialize_json(
    ...
    if "teletext_spacing" in value:
        ...
        out["teletextSpacing"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_teletext_spacing.serialize_json(
...
def deserialize_json(data: dict) -> BurninDestinationSettings:
    ...
    if "alignment" in data:
        ...
        out["alignment"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_alignment.deserialize_json(
                data["alignment"]
            )
        )
    if "applyFontColor" in data:
        ...
        out["apply_font_color"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_apply_font_color.deserialize_json(
                data["applyFontColor"]
            )
        )
    if "backgroundColor" in data:
        ...
        out["background_color"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_background_color.deserialize_json(
    ...
    if "fallbackFont" in data:
        ...
        out["fallback_font"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_fallback_font.deserialize_json(
                data["fallbackFont"]
            )
        )
    if "fontColor" in data:
        ...
        out["font_color"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_font_color.deserialize_json(
                data["fontColor"]
            )
        )
    ...
    if "outlineColor" in data:
        ...
        out["outline_color"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_outline_color.deserialize_json(
                data["outlineColor"]
            )
        )
    ...
    if "removeRubyReserveAttributes" in data:
        ...
        out["remove_ruby_reserve_attributes"] = (
            aws_sdk_mediaconvert.types.remove_ruby_reserve_attributes.deserialize_json(
    ...
    if "shadowColor" in data:
        ...
        out["shadow_color"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_shadow_color.deserialize_json(
                data["shadowColor"]
            )
        )
    ...
    if "stylePassthrough" in data:
        ...
        out["style_passthrough"] = (
            aws_sdk_mediaconvert.types.burn_in_subtitle_style_passthrough.deserialize_json(
    ...
    if "teletextSpacing" in data:
        ...
        out["teletext_spacing"] = (
            aws_sdk_mediaconvert.types.burnin_subtitle_teletext_spacing.deserialize_json(
