...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.cmfc_audio_track_type
    import aws_sdk_mediaconvert.types.cmfc_c2pa_manifest
    import aws_sdk_mediaconvert.types.cmfc_descriptive_video_service_flag
    import aws_sdk_mediaconvert.types.cmfc_i_frame_only_manifest
    import aws_sdk_mediaconvert.types.cmfc_klv_metadata
    import aws_sdk_mediaconvert.types.cmfc_manifest_metadata_signaling
    import aws_sdk_mediaconvert.types.cmfc_scte35_esam
    import aws_sdk_mediaconvert.types.cmfc_scte35_source
    import aws_sdk_mediaconvert.types.cmfc_timed_metadata
...
class CmfcSettings(TypedDict):
    ...
    audio_track_type: NotRequired[
        "aws_sdk_mediaconvert.types.cmfc_audio_track_type.CmfcAudioTrackType"
    ]
    ...
    c2pa_manifest: NotRequired[
        "aws_sdk_mediaconvert.types.cmfc_c2pa_manifest.CmfcC2paManifest"
    ]
    ...
    descriptive_video_service_flag: NotRequired[
        "aws_sdk_mediaconvert.types.cmfc_descriptive_video_service_flag.CmfcDescriptiveVideoServiceFlag"
    ]
    ...
    i_frame_only_manifest: NotRequired[
        "aws_sdk_mediaconvert.types.cmfc_i_frame_only_manifest.CmfcIFrameOnlyManifest"
    ]
    ...
    klv_metadata: NotRequired[
        "aws_sdk_mediaconvert.types.cmfc_klv_metadata.CmfcKlvMetadata"
    ]
    """To include key-length-value metadata in this output: Set KLV metadata insertion to Passthrough. MediaConvert reads KLV metadata present in your input and writes each instance to a separate event message box in the output, according to MISB ST1910.1. To exclude this KLV metadata: Set KLV metadata insertion to None or leave blank."""
    manifest_metadata_signaling: NotRequired[
        "aws_sdk_mediaconvert.types.cmfc_manifest_metadata_signaling.CmfcManifestMetadataSignaling"
    ]
    ...
    scte35_esam: NotRequired[
        "aws_sdk_mediaconvert.types.cmfc_scte35_esam.CmfcScte35Esam"
    ]
    ...
    scte35_source: NotRequired[
        "aws_sdk_mediaconvert.types.cmfc_scte35_source.CmfcScte35Source"
    ]
    ...
    timed_metadata: NotRequired[
        "aws_sdk_mediaconvert.types.cmfc_timed_metadata.CmfcTimedMetadata"
    ]
    ...
    timed_metadata_box_version: NotRequired[
        "aws_sdk_mediaconvert.types.cmfc_timed_metadata_box_version.CmfcTimedMetadataBoxVersion"
    ]
...
def serialize_json(value: CmfcSettings) -> dict:
    ...
    if "audio_track_type" in value:
        ...
        out["audioTrackType"] = (
            aws_sdk_mediaconvert.types.cmfc_audio_track_type.serialize_json(
    ...
    if "c2pa_manifest" in value:
        ...
        out["c2paManifest"] = (
            aws_sdk_mediaconvert.types.cmfc_c2pa_manifest.serialize_json(
                value["c2pa_manifest"]
            )
        )
    ...
    if "descriptive_video_service_flag" in value:
        ...
        out["descriptiveVideoServiceFlag"] = (
            aws_sdk_mediaconvert.types.cmfc_descriptive_video_service_flag.serialize_json(
    ...
    if "i_frame_only_manifest" in value:
        ...
        out["iFrameOnlyManifest"] = (
            aws_sdk_mediaconvert.types.cmfc_i_frame_only_manifest.serialize_json(
    ...
    if "klv_metadata" in value:
        ...
        out["klvMetadata"] = (
            aws_sdk_mediaconvert.types.cmfc_klv_metadata.serialize_json(
                value["klv_metadata"]
            )
        )
    if "manifest_metadata_signaling" in value:
        ...
        out["manifestMetadataSignaling"] = (
            aws_sdk_mediaconvert.types.cmfc_manifest_metadata_signaling.serialize_json(
    ...
    if "scte35_esam" in value:
        ...
        out["scte35Esam"] = aws_sdk_mediaconvert.types.cmfc_scte35_esam.serialize_json(
            value["scte35_esam"]
        )
    if "scte35_source" in value:
        ...
        out["scte35Source"] = (
            aws_sdk_mediaconvert.types.cmfc_scte35_source.serialize_json(
                value["scte35_source"]
            )
        )
    ...
    if "timed_metadata" in value:
        ...
        out["timedMetadata"] = (
            aws_sdk_mediaconvert.types.cmfc_timed_metadata.serialize_json(
    ...
    if "timed_metadata_box_version" in value:
        ...
        out["timedMetadataBoxVersion"] = (
            aws_sdk_mediaconvert.types.cmfc_timed_metadata_box_version.serialize_json(
...
def deserialize_json(data: dict) -> CmfcSettings:
    ...
    if "audioTrackType" in data:
        ...
        out["audio_track_type"] = (
            aws_sdk_mediaconvert.types.cmfc_audio_track_type.deserialize_json(
                data["audioTrackType"]
            )
        )
    if "c2paManifest" in data:
        ...
        out["c2pa_manifest"] = (
            aws_sdk_mediaconvert.types.cmfc_c2pa_manifest.deserialize_json(
                data["c2paManifest"]
            )
        )
    ...
    if "descriptiveVideoServiceFlag" in data:
        ...
        out["descriptive_video_service_flag"] = (
            aws_sdk_mediaconvert.types.cmfc_descriptive_video_service_flag.deserialize_json(
    ...
    if "iFrameOnlyManifest" in data:
        ...
        out["i_frame_only_manifest"] = (
            aws_sdk_mediaconvert.types.cmfc_i_frame_only_manifest.deserialize_json(
    ...
    if "klvMetadata" in data:
        ...
        out["klv_metadata"] = (
            aws_sdk_mediaconvert.types.cmfc_klv_metadata.deserialize_json(
                data["klvMetadata"]
            )
        )
    if "manifestMetadataSignaling" in data:
        ...
        out["manifest_metadata_signaling"] = (
            aws_sdk_mediaconvert.types.cmfc_manifest_metadata_signaling.deserialize_json(
    ...
    if "scte35Esam" in data:
        ...
        out["scte35_esam"] = (
            aws_sdk_mediaconvert.types.cmfc_scte35_esam.deserialize_json(
                data["scte35Esam"]
            )
        )
    if "scte35Source" in data:
        ...
        out["scte35_source"] = (
            aws_sdk_mediaconvert.types.cmfc_scte35_source.deserialize_json(
                data["scte35Source"]
            )
        )
    ...
    if "timedMetadata" in data:
        ...
        out["timed_metadata"] = (
            aws_sdk_mediaconvert.types.cmfc_timed_metadata.deserialize_json(
                data["timedMetadata"]
            )
        )
    if "timedMetadataBoxVersion" in data:
        ...
        out["timed_metadata_box_version"] = (
            aws_sdk_mediaconvert.types.cmfc_timed_metadata_box_version.deserialize_json(
