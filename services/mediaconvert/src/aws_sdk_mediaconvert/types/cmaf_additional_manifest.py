"""Generated from Smithy shape ``com.amazonaws.mediaconvert#CmafAdditionalManifest``."""
...
class CmafAdditionalManifest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CmafAdditionalManifest) -> dict:
    out: dict = {}
