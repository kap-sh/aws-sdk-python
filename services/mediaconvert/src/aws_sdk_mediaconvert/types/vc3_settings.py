...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.vc3_class
    import aws_sdk_mediaconvert.types.vc3_framerate_control
    import aws_sdk_mediaconvert.types.vc3_framerate_conversion_algorithm
    import aws_sdk_mediaconvert.types.vc3_interlace_mode
    import aws_sdk_mediaconvert.types.vc3_scan_type_conversion_mode
    import aws_sdk_mediaconvert.types.vc3_slow_pal
    import aws_sdk_mediaconvert.types.vc3_telecine


class Vc3Settings(TypedDict):
    framerate_control: NotRequired[
        "aws_sdk_mediaconvert.types.vc3_framerate_control.Vc3FramerateControl"
    ]
    ...
    framerate_conversion_algorithm: NotRequired[
        "aws_sdk_mediaconvert.types.vc3_framerate_conversion_algorithm.Vc3FramerateConversionAlgorithm"
    ]
    ...
    interlace_mode: NotRequired[
        "aws_sdk_mediaconvert.types.vc3_interlace_mode.Vc3InterlaceMode"
    ]
    """Optional. Choose the scan line type for this output. If you don't specify a value, MediaConvert will create a progressive output."""
    scan_type_conversion_mode: NotRequired[
        "aws_sdk_mediaconvert.types.vc3_scan_type_conversion_mode.Vc3ScanTypeConversionMode"
    ]
    ...
    slow_pal: NotRequired["aws_sdk_mediaconvert.types.vc3_slow_pal.Vc3SlowPal"]
    """Ignore this setting unless your input frame rate is 23.976 or 24 frames per second (fps). Enable slow PAL to create a 25 fps output by relabeling the video frames and resampling your audio. Note that enabling this setting will slightly reduce the duration of your video. Related settings: You must also set Framerate to 25."""
    telecine: NotRequired["aws_sdk_mediaconvert.types.vc3_telecine.Vc3Telecine"]
    ...
    vc3_class: NotRequired["aws_sdk_mediaconvert.types.vc3_class.Vc3Class"]
...
def serialize_json(value: Vc3Settings) -> dict:
    ...
    if "framerate_control" in value:
        ...
        out["framerateControl"] = (
            aws_sdk_mediaconvert.types.vc3_framerate_control.serialize_json(
    ...
    if "framerate_conversion_algorithm" in value:
        ...
        out["framerateConversionAlgorithm"] = (
            aws_sdk_mediaconvert.types.vc3_framerate_conversion_algorithm.serialize_json(
    ...
    if "interlace_mode" in value:
        ...
        out["interlaceMode"] = (
            aws_sdk_mediaconvert.types.vc3_interlace_mode.serialize_json(
    ...
    if "scan_type_conversion_mode" in value:
        ...
        out["scanTypeConversionMode"] = (
            aws_sdk_mediaconvert.types.vc3_scan_type_conversion_mode.serialize_json(
    ...
    if "slow_pal" in value:
        ...
        out["slowPal"] = aws_sdk_mediaconvert.types.vc3_slow_pal.serialize_json(
            value["slow_pal"]
        )
    if "telecine" in value:
        import aws_sdk_mediaconvert.types.vc3_telecine

        out["telecine"] = aws_sdk_mediaconvert.types.vc3_telecine.serialize_json(
            value["telecine"]
        )
    if "vc3_class" in value:
        import aws_sdk_mediaconvert.types.vc3_class

        out["vc3Class"] = aws_sdk_mediaconvert.types.vc3_class.serialize_json(
            value["vc3_class"]
        )
    return out
...
def deserialize_json(data: dict) -> Vc3Settings:
    ...
    if "framerateControl" in data:
        ...
        out["framerate_control"] = (
            aws_sdk_mediaconvert.types.vc3_framerate_control.deserialize_json(
    ...
    if "framerateConversionAlgorithm" in data:
        ...
        out["framerate_conversion_algorithm"] = (
            aws_sdk_mediaconvert.types.vc3_framerate_conversion_algorithm.deserialize_json(
    ...
    if "interlaceMode" in data:
        ...
        out["interlace_mode"] = (
            aws_sdk_mediaconvert.types.vc3_interlace_mode.deserialize_json(
                data["interlaceMode"]
            )
        )
    if "scanTypeConversionMode" in data:
        ...
        out["scan_type_conversion_mode"] = (
            aws_sdk_mediaconvert.types.vc3_scan_type_conversion_mode.deserialize_json(
    ...
    if "slowPal" in data:
        ...
        out["slow_pal"] = aws_sdk_mediaconvert.types.vc3_slow_pal.deserialize_json(
            data["slowPal"]
        )
    if "telecine" in data:
        import aws_sdk_mediaconvert.types.vc3_telecine

        out["telecine"] = aws_sdk_mediaconvert.types.vc3_telecine.deserialize_json(
            data["telecine"]
        )
    if "vc3Class" in data:
        import aws_sdk_mediaconvert.types.vc3_class

        out["vc3_class"] = aws_sdk_mediaconvert.types.vc3_class.deserialize_json(
            data["vc3Class"]
        )
    return out
