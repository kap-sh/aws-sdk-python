...
if TYPE_CHECKING:
    import aws_sdk_mediaconvert.types.ttml_style_passthrough


class TtmlDestinationSettings(TypedDict):
    style_passthrough: NotRequired[
        "aws_sdk_mediaconvert.types.ttml_style_passthrough.TtmlStylePassthrough"
    ]
...
def serialize_json(value: TtmlDestinationSettings) -> dict:
    ...
    if "style_passthrough" in value:
        ...
        out["stylePassthrough"] = (
            aws_sdk_mediaconvert.types.ttml_style_passthrough.serialize_json(
...
def deserialize_json(data: dict) -> TtmlDestinationSettings:
    ...
    if "stylePassthrough" in data:
        ...
        out["style_passthrough"] = (
            aws_sdk_mediaconvert.types.ttml_style_passthrough.deserialize_json(
