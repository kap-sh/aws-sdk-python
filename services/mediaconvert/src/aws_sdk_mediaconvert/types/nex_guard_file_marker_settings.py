...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__string_min1_max100000
...
class NexGuardFileMarkerSettings(TypedDict, closed=True):
    ...
    payload: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min0_max4194303.__integerMin0Max4194303"
    ]
    ...
    strength: NotRequired[
        "aws_sdk_mediaconvert.types.watermarking_strength.WatermarkingStrength"
    ]
...
def serialize_json(value: NexGuardFileMarkerSettings) -> dict:
    ...
    if "strength" in value:
        ...
        out["strength"] = (
            aws_sdk_mediaconvert.types.watermarking_strength.serialize_json(
                value["strength"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> NexGuardFileMarkerSettings:
    ...
    if "strength" in data:
        ...
        out["strength"] = (
            aws_sdk_mediaconvert.types.watermarking_strength.deserialize_json(
                data["strength"]
            )
        )
    return out
