...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__integer_min0_max9
    import aws_sdk_mediaconvert.types.__integer_min16000_max320000
    import aws_sdk_mediaconvert.types.__integer_min22050_max48000
    import aws_sdk_mediaconvert.types.mp3_rate_control_mode


class Mp3Settings(TypedDict):
    bitrate: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min16000_max320000.__integerMin16000Max320000"
    ]
    ...
    rate_control_mode: NotRequired[
        "aws_sdk_mediaconvert.types.mp3_rate_control_mode.Mp3RateControlMode"
    ]
    ...
    vbr_quality: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min0_max9.__integerMin0Max9"
    ]
...
def serialize_json(value: Mp3Settings) -> dict:
    ...
    if "rate_control_mode" in value:
        ...
        out["rateControlMode"] = (
            aws_sdk_mediaconvert.types.mp3_rate_control_mode.serialize_json(
...
def deserialize_json(data: dict) -> Mp3Settings:
    ...
    if "rateControlMode" in data:
        ...
        out["rate_control_mode"] = (
            aws_sdk_mediaconvert.types.mp3_rate_control_mode.deserialize_json(
