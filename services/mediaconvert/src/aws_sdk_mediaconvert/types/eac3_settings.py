...
if TYPE_CHECKING:
    import aws_sdk_mediaconvert.types.__double_min_negative60_max3
    ...
    import aws_sdk_mediaconvert.types.__integer_min32000_max3024000
    import aws_sdk_mediaconvert.types.__integer_min48000_max48000
    import aws_sdk_mediaconvert.types.eac3_attenuation_control
    import aws_sdk_mediaconvert.types.eac3_bitstream_mode
    import aws_sdk_mediaconvert.types.eac3_coding_mode
    import aws_sdk_mediaconvert.types.eac3_dc_filter
    import aws_sdk_mediaconvert.types.eac3_dynamic_range_compression_line
    import aws_sdk_mediaconvert.types.eac3_dynamic_range_compression_rf
    import aws_sdk_mediaconvert.types.eac3_lfe_control
    import aws_sdk_mediaconvert.types.eac3_lfe_filter
    import aws_sdk_mediaconvert.types.eac3_metadata_control
    import aws_sdk_mediaconvert.types.eac3_passthrough_control
    import aws_sdk_mediaconvert.types.eac3_phase_control
    import aws_sdk_mediaconvert.types.eac3_stereo_downmix
    import aws_sdk_mediaconvert.types.eac3_surround_ex_mode
    import aws_sdk_mediaconvert.types.eac3_surround_mode


class Eac3Settings(TypedDict, closed=True):
    attenuation_control: NotRequired[
        "aws_sdk_mediaconvert.types.eac3_attenuation_control.Eac3AttenuationControl"
    ]
    """If set to ATTENUATE_3_DB, applies a 3 dB attenuation to the surround channels. Only used for 3/2 coding mode."""
    bitrate: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min32000_max3024000.__integerMin32000Max3024000"
    ]
    ...
    bitstream_mode: NotRequired[
        "aws_sdk_mediaconvert.types.eac3_bitstream_mode.Eac3BitstreamMode"
    ]
    """Specify the bitstream mode for the E-AC-3 stream that the encoder emits. For more information about the EAC3 bitstream mode, see ATSC A/52-2012 (Annex E)."""
    coding_mode: NotRequired[
        "aws_sdk_mediaconvert.types.eac3_coding_mode.Eac3CodingMode"
    ]
    """Dolby Digital Plus coding mode. Determines number of channels."""
    dc_filter: NotRequired["aws_sdk_mediaconvert.types.eac3_dc_filter.Eac3DcFilter"]
    ...
    dynamic_range_compression_line: NotRequired[
        "aws_sdk_mediaconvert.types.eac3_dynamic_range_compression_line.Eac3DynamicRangeCompressionLine"
    ]
    ...
    dynamic_range_compression_rf: NotRequired[
        "aws_sdk_mediaconvert.types.eac3_dynamic_range_compression_rf.Eac3DynamicRangeCompressionRf"
    ]
    ...
    lfe_control: NotRequired[
        "aws_sdk_mediaconvert.types.eac3_lfe_control.Eac3LfeControl"
    ]
    """When encoding 3/2 audio, controls whether the LFE channel is enabled"""
    lfe_filter: NotRequired["aws_sdk_mediaconvert.types.eac3_lfe_filter.Eac3LfeFilter"]
    """Applies a 120Hz lowpass filter to the LFE channel prior to encoding. Only valid with 3_2_LFE coding mode."""
    lo_ro_center_mix_level: NotRequired[
        "aws_sdk_mediaconvert.types.__double_min_negative60_max3.__doubleMinNegative60Max3"
    ]
    ...
    metadata_control: NotRequired[
        "aws_sdk_mediaconvert.types.eac3_metadata_control.Eac3MetadataControl"
    ]
    """When set to FOLLOW_INPUT, encoder metadata will be sourced from the DD, DD+, or DolbyE decoder that supplied this audio data. If audio was not supplied from one of these streams, then the static metadata settings will be used."""
    passthrough_control: NotRequired[
        "aws_sdk_mediaconvert.types.eac3_passthrough_control.Eac3PassthroughControl"
    ]
    """When set to WHEN_POSSIBLE, input DD+ audio will be passed through if it is present on the input. this detection is dynamic over the life of the transcode. Inputs that alternate between DD+ and non-DD+ content will have a consistent DD+ output as the system alternates between passthrough and encoding."""
    phase_control: NotRequired[
        "aws_sdk_mediaconvert.types.eac3_phase_control.Eac3PhaseControl"
    ]
    ...
    stereo_downmix: NotRequired[
        "aws_sdk_mediaconvert.types.eac3_stereo_downmix.Eac3StereoDownmix"
    ]
    ...
    surround_ex_mode: NotRequired[
        "aws_sdk_mediaconvert.types.eac3_surround_ex_mode.Eac3SurroundExMode"
    ]
    """When encoding 3/2 audio, sets whether an extra center back surround channel is matrix encoded into the left and right surround channels."""
    surround_mode: NotRequired[
        "aws_sdk_mediaconvert.types.eac3_surround_mode.Eac3SurroundMode"
    ]
...
def serialize_json(value: Eac3Settings) -> dict:
    ...
    if "attenuation_control" in value:
        ...
        out["attenuationControl"] = (
            aws_sdk_mediaconvert.types.eac3_attenuation_control.serialize_json(
    ...
    if "bitstream_mode" in value:
        ...
        out["bitstreamMode"] = (
            aws_sdk_mediaconvert.types.eac3_bitstream_mode.serialize_json(
    ...
    if "coding_mode" in value:
        ...
        out["codingMode"] = aws_sdk_mediaconvert.types.eac3_coding_mode.serialize_json(
            value["coding_mode"]
        )
    if "dc_filter" in value:
        import aws_sdk_mediaconvert.types.eac3_dc_filter

        out["dcFilter"] = aws_sdk_mediaconvert.types.eac3_dc_filter.serialize_json(
            value["dc_filter"]
        )
    ...
    if "dynamic_range_compression_line" in value:
        ...
        out["dynamicRangeCompressionLine"] = (
            aws_sdk_mediaconvert.types.eac3_dynamic_range_compression_line.serialize_json(
    ...
    if "dynamic_range_compression_rf" in value:
        ...
        out["dynamicRangeCompressionRf"] = (
            aws_sdk_mediaconvert.types.eac3_dynamic_range_compression_rf.serialize_json(
    ...
    if "lfe_control" in value:
        ...
        out["lfeControl"] = aws_sdk_mediaconvert.types.eac3_lfe_control.serialize_json(
            value["lfe_control"]
        )
    if "lfe_filter" in value:
        import aws_sdk_mediaconvert.types.eac3_lfe_filter

        out["lfeFilter"] = aws_sdk_mediaconvert.types.eac3_lfe_filter.serialize_json(
            value["lfe_filter"]
        )
    ...
    if "metadata_control" in value:
        ...
        out["metadataControl"] = (
            aws_sdk_mediaconvert.types.eac3_metadata_control.serialize_json(
    ...
    if "passthrough_control" in value:
        ...
        out["passthroughControl"] = (
            aws_sdk_mediaconvert.types.eac3_passthrough_control.serialize_json(
    ...
    if "phase_control" in value:
        ...
        out["phaseControl"] = (
            aws_sdk_mediaconvert.types.eac3_phase_control.serialize_json(
                value["phase_control"]
            )
        )
    ...
    if "stereo_downmix" in value:
        ...
        out["stereoDownmix"] = (
            aws_sdk_mediaconvert.types.eac3_stereo_downmix.serialize_json(
    ...
    if "surround_ex_mode" in value:
        ...
        out["surroundExMode"] = (
            aws_sdk_mediaconvert.types.eac3_surround_ex_mode.serialize_json(
    ...
    if "surround_mode" in value:
        ...
        out["surroundMode"] = (
            aws_sdk_mediaconvert.types.eac3_surround_mode.serialize_json(
                value["surround_mode"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> Eac3Settings:
    ...
    if "attenuationControl" in data:
        ...
        out["attenuation_control"] = (
            aws_sdk_mediaconvert.types.eac3_attenuation_control.deserialize_json(
    ...
    if "bitstreamMode" in data:
        ...
        out["bitstream_mode"] = (
            aws_sdk_mediaconvert.types.eac3_bitstream_mode.deserialize_json(
                data["bitstreamMode"]
            )
        )
    if "codingMode" in data:
        ...
        out["coding_mode"] = (
            aws_sdk_mediaconvert.types.eac3_coding_mode.deserialize_json(
                data["codingMode"]
            )
        )
    if "dcFilter" in data:
        ...
        out["dc_filter"] = aws_sdk_mediaconvert.types.eac3_dc_filter.deserialize_json(
            data["dcFilter"]
        )
    if "dialnorm" in data:
    ...
    if "dynamicRangeCompressionLine" in data:
        ...
        out["dynamic_range_compression_line"] = (
            aws_sdk_mediaconvert.types.eac3_dynamic_range_compression_line.deserialize_json(
    ...
    if "dynamicRangeCompressionRf" in data:
        ...
        out["dynamic_range_compression_rf"] = (
            aws_sdk_mediaconvert.types.eac3_dynamic_range_compression_rf.deserialize_json(
    ...
    if "lfeControl" in data:
        ...
        out["lfe_control"] = (
            aws_sdk_mediaconvert.types.eac3_lfe_control.deserialize_json(
                data["lfeControl"]
            )
        )
    if "lfeFilter" in data:
        ...
        out["lfe_filter"] = aws_sdk_mediaconvert.types.eac3_lfe_filter.deserialize_json(
            data["lfeFilter"]
        )
    ...
    if "metadataControl" in data:
        ...
        out["metadata_control"] = (
            aws_sdk_mediaconvert.types.eac3_metadata_control.deserialize_json(
    ...
    if "passthroughControl" in data:
        ...
        out["passthrough_control"] = (
            aws_sdk_mediaconvert.types.eac3_passthrough_control.deserialize_json(
    ...
    if "phaseControl" in data:
        ...
        out["phase_control"] = (
            aws_sdk_mediaconvert.types.eac3_phase_control.deserialize_json(
                data["phaseControl"]
            )
        )
    ...
    if "stereoDownmix" in data:
        ...
        out["stereo_downmix"] = (
            aws_sdk_mediaconvert.types.eac3_stereo_downmix.deserialize_json(
                data["stereoDownmix"]
            )
        )
    if "surroundExMode" in data:
        ...
        out["surround_ex_mode"] = (
            aws_sdk_mediaconvert.types.eac3_surround_ex_mode.deserialize_json(
                data["surroundExMode"]
            )
        )
    if "surroundMode" in data:
        ...
        out["surround_mode"] = (
            aws_sdk_mediaconvert.types.eac3_surround_mode.deserialize_json(
                data["surroundMode"]
            )
        )
    return out
