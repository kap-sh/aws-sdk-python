...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.prores_chroma_sampling
    import aws_sdk_mediaconvert.types.prores_codec_profile
    import aws_sdk_mediaconvert.types.prores_framerate_control
    import aws_sdk_mediaconvert.types.prores_framerate_conversion_algorithm
    import aws_sdk_mediaconvert.types.prores_interlace_mode
    import aws_sdk_mediaconvert.types.prores_par_control
    import aws_sdk_mediaconvert.types.prores_scan_type_conversion_mode
    import aws_sdk_mediaconvert.types.prores_slow_pal
    import aws_sdk_mediaconvert.types.prores_telecine


class ProresSettings(TypedDict):
    chroma_sampling: NotRequired[
        "aws_sdk_mediaconvert.types.prores_chroma_sampling.ProresChromaSampling"
    ]
    ...
    codec_profile: NotRequired[
        "aws_sdk_mediaconvert.types.prores_codec_profile.ProresCodecProfile"
    ]
    """Use Profile to specify the type of Apple ProRes codec to use for this output."""
    framerate_control: NotRequired[
        "aws_sdk_mediaconvert.types.prores_framerate_control.ProresFramerateControl"
    ]
    ...
    framerate_conversion_algorithm: NotRequired[
        "aws_sdk_mediaconvert.types.prores_framerate_conversion_algorithm.ProresFramerateConversionAlgorithm"
    ]
    ...
    interlace_mode: NotRequired[
        "aws_sdk_mediaconvert.types.prores_interlace_mode.ProresInterlaceMode"
    ]
    ...
    par_control: NotRequired[
        "aws_sdk_mediaconvert.types.prores_par_control.ProresParControl"
    ]
    ...
    scan_type_conversion_mode: NotRequired[
        "aws_sdk_mediaconvert.types.prores_scan_type_conversion_mode.ProresScanTypeConversionMode"
    ]
    ...
    slow_pal: NotRequired["aws_sdk_mediaconvert.types.prores_slow_pal.ProresSlowPal"]
    """Ignore this setting unless your input frame rate is 23.976 or 24 frames per second (fps). Enable slow PAL to create a 25 fps output. When you enable slow PAL, MediaConvert relabels the video frames to 25 fps and resamples your audio to keep it synchronized with the video. Note that enabling this setting will slightly reduce the duration of your video. Required settings: You must also set Framerate to 25."""
    telecine: NotRequired["aws_sdk_mediaconvert.types.prores_telecine.ProresTelecine"]
...
def serialize_json(value: ProresSettings) -> dict:
    ...
    if "chroma_sampling" in value:
        ...
        out["chromaSampling"] = (
            aws_sdk_mediaconvert.types.prores_chroma_sampling.serialize_json(
    ...
    if "codec_profile" in value:
        ...
        out["codecProfile"] = (
            aws_sdk_mediaconvert.types.prores_codec_profile.serialize_json(
                value["codec_profile"]
            )
        )
    if "framerate_control" in value:
        ...
        out["framerateControl"] = (
            aws_sdk_mediaconvert.types.prores_framerate_control.serialize_json(
    ...
    if "framerate_conversion_algorithm" in value:
        ...
        out["framerateConversionAlgorithm"] = (
            aws_sdk_mediaconvert.types.prores_framerate_conversion_algorithm.serialize_json(
    ...
    if "interlace_mode" in value:
        ...
        out["interlaceMode"] = (
            aws_sdk_mediaconvert.types.prores_interlace_mode.serialize_json(
    ...
    if "par_control" in value:
        ...
        out["parControl"] = (
            aws_sdk_mediaconvert.types.prores_par_control.serialize_json(
                value["par_control"]
            )
        )
    ...
    if "scan_type_conversion_mode" in value:
        ...
        out["scanTypeConversionMode"] = (
            aws_sdk_mediaconvert.types.prores_scan_type_conversion_mode.serialize_json(
    ...
    if "slow_pal" in value:
        ...
        out["slowPal"] = aws_sdk_mediaconvert.types.prores_slow_pal.serialize_json(
            value["slow_pal"]
        )
    if "telecine" in value:
        import aws_sdk_mediaconvert.types.prores_telecine

        out["telecine"] = aws_sdk_mediaconvert.types.prores_telecine.serialize_json(
            value["telecine"]
        )
    return out
...
def deserialize_json(data: dict) -> ProresSettings:
    ...
    if "chromaSampling" in data:
        ...
        out["chroma_sampling"] = (
            aws_sdk_mediaconvert.types.prores_chroma_sampling.deserialize_json(
                data["chromaSampling"]
            )
        )
    if "codecProfile" in data:
        ...
        out["codec_profile"] = (
            aws_sdk_mediaconvert.types.prores_codec_profile.deserialize_json(
                data["codecProfile"]
            )
        )
    if "framerateControl" in data:
        ...
        out["framerate_control"] = (
            aws_sdk_mediaconvert.types.prores_framerate_control.deserialize_json(
    ...
    if "framerateConversionAlgorithm" in data:
        ...
        out["framerate_conversion_algorithm"] = (
            aws_sdk_mediaconvert.types.prores_framerate_conversion_algorithm.deserialize_json(
    ...
    if "interlaceMode" in data:
        ...
        out["interlace_mode"] = (
            aws_sdk_mediaconvert.types.prores_interlace_mode.deserialize_json(
                data["interlaceMode"]
            )
        )
    if "parControl" in data:
        ...
        out["par_control"] = (
            aws_sdk_mediaconvert.types.prores_par_control.deserialize_json(
                data["parControl"]
            )
        )
    ...
    if "scanTypeConversionMode" in data:
        ...
        out["scan_type_conversion_mode"] = (
            aws_sdk_mediaconvert.types.prores_scan_type_conversion_mode.deserialize_json(
    ...
    if "slowPal" in data:
        ...
        out["slow_pal"] = aws_sdk_mediaconvert.types.prores_slow_pal.deserialize_json(
            data["slowPal"]
        )
    if "telecine" in data:
        import aws_sdk_mediaconvert.types.prores_telecine

        out["telecine"] = aws_sdk_mediaconvert.types.prores_telecine.deserialize_json(
            data["telecine"]
        )
    return out
