...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__string_min16_max24_pattern_a_za_z0922_a_za_z0916
    import aws_sdk_mediaconvert.types.__string_min24_max512_pattern_a_za_z0902
...
class InputDecryptionSettings(TypedDict):
    ...
    encrypted_decryption_key: NotRequired[
        "aws_sdk_mediaconvert.types.__string_min24_max512_pattern_a_za_z0902.__stringMin24Max512PatternAZaZ0902"
    ]
    """Warning! Don't provide your encryption key in plaintext. Your job settings could be intercepted, making your encrypted content vulnerable. Specify the encrypted version of the data key that you used to encrypt your content. The data key must be encrypted by AWS Key Management Service (KMS). The key can be 128, 192, or 256 bits."""
    initialization_vector: NotRequired[
        "aws_sdk_mediaconvert.types.__string_min16_max24_pattern_a_za_z0922_a_za_z0916.__stringMin16Max24PatternAZaZ0922AZaZ0916"
    ]
    """Specify the initialization vector that you used when you encrypted your content before uploading it to Amazon S3. You can use a 16-byte initialization vector with any encryption mode. Or, you can use a 12-byte initialization vector with GCM or CTR. MediaConvert accepts only initialization vectors that are base64-encoded."""
    kms_key_region: NotRequired[
        "aws_sdk_mediaconvert.types.__string_min9_max19_pattern_az26_east_west_central_north_south_east_west1912.__stringMin9Max19PatternAZ26EastWestCentralNorthSouthEastWest1912"
    ]
...
def serialize_json(value: InputDecryptionSettings) -> dict:
    ...
    if "decryption_mode" in value:
        ...
        out["decryptionMode"] = (
            aws_sdk_mediaconvert.types.decryption_mode.serialize_json(
...
def deserialize_json(data: dict) -> InputDecryptionSettings:
    ...
    if "decryptionMode" in data:
        ...
        out["decryption_mode"] = (
            aws_sdk_mediaconvert.types.decryption_mode.deserialize_json(
                data["decryptionMode"]
            )
        )
