...
if TYPE_CHECKING:
    import aws_sdk_mediaconvert.types.imsc_accessibility_subs
    import aws_sdk_mediaconvert.types.imsc_style_passthrough


class ImscDestinationSettings(TypedDict):
    accessibility: NotRequired[
        "aws_sdk_mediaconvert.types.imsc_accessibility_subs.ImscAccessibilitySubs"
    ]
    ...
    style_passthrough: NotRequired[
        "aws_sdk_mediaconvert.types.imsc_style_passthrough.ImscStylePassthrough"
    ]
...
def serialize_json(value: ImscDestinationSettings) -> dict:
    ...
    if "accessibility" in value:
        ...
        out["accessibility"] = (
            aws_sdk_mediaconvert.types.imsc_accessibility_subs.serialize_json(
                value["accessibility"]
            )
        )
    if "style_passthrough" in value:
        ...
        out["stylePassthrough"] = (
            aws_sdk_mediaconvert.types.imsc_style_passthrough.serialize_json(
...
def deserialize_json(data: dict) -> ImscDestinationSettings:
    ...
    if "accessibility" in data:
        ...
        out["accessibility"] = (
            aws_sdk_mediaconvert.types.imsc_accessibility_subs.deserialize_json(
                data["accessibility"]
            )
        )
    if "stylePassthrough" in data:
        ...
        out["style_passthrough"] = (
            aws_sdk_mediaconvert.types.imsc_style_passthrough.deserialize_json(
