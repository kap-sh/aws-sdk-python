...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__list_of_insertable_image


class ImageInserter(TypedDict):
    insertable_images: NotRequired[
        "aws_sdk_mediaconvert.types.__list_of_insertable_image.__listOfInsertableImage"
    ]
...
def serialize_json(value: ImageInserter) -> dict:
    ...
    if "insertable_images" in value:
        ...
        out["insertableImages"] = (
            aws_sdk_mediaconvert.types.__list_of_insertable_image.serialize_json(
...
def deserialize_json(data: dict) -> ImageInserter:
    ...
    if "insertableImages" in data:
        ...
        out["insertable_images"] = (
            aws_sdk_mediaconvert.types.__list_of_insertable_image.deserialize_json(
