...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.audio_selector

__mapOfAudioSelector: TypeAlias = dict[
    "aws_sdk_mediaconvert.types.__string.__string",
    "aws_sdk_mediaconvert.types.audio_selector.AudioSelector",
]
...
def serialize_json(input_to_serialize: __mapOfAudioSelector) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_mediaconvert.types.audio_selector.serialize_json(value)
    return out
...
def deserialize_json(data: dict) -> __mapOfAudioSelector:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_mediaconvert.types.audio_selector.deserialize_json(value)
    return out
