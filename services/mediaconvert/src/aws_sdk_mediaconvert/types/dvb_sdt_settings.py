...
if TYPE_CHECKING:
    import aws_sdk_mediaconvert.types.__integer_min25_max2000
    import aws_sdk_mediaconvert.types.__string_min1_max256
    import aws_sdk_mediaconvert.types.output_sdt
...
def serialize_json(value: DvbSdtSettings) -> dict:
    ...
    if "output_sdt" in value:
        ...
        out["outputSdt"] = aws_sdk_mediaconvert.types.output_sdt.serialize_json(
            value["output_sdt"]
        )
...
def deserialize_json(data: dict) -> DvbSdtSettings:
    ...
    if "outputSdt" in data:
        ...
        out["output_sdt"] = aws_sdk_mediaconvert.types.output_sdt.deserialize_json(
            data["outputSdt"]
        )
