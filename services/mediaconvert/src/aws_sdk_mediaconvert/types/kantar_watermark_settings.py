...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__string_min1_max50_pattern_azaz09
    import aws_sdk_mediaconvert.types.__string_min1_max2048_pattern_arn_az_secretsmanager_wd12_secret_azaz09
    import aws_sdk_mediaconvert.types.__string_pattern_https_kantarmedia
...
class KantarWatermarkSettings(TypedDict, closed=True):
    ...
    content_reference: NotRequired[
        "aws_sdk_mediaconvert.types.__string_min1_max50_pattern_azaz09.__stringMin1Max50PatternAZAZ09"
    ]
    ...
    file_offset: NotRequired["aws_sdk_mediaconvert.types.__double_min0.__doubleMin0"]
    ...
    kantar_server_url: NotRequired[
        "aws_sdk_mediaconvert.types.__string_pattern_https_kantarmedia.__stringPatternHttpsKantarmedia"
    ]
