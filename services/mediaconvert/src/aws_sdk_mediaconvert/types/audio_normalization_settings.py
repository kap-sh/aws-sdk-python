...
if TYPE_CHECKING:
    import aws_sdk_mediaconvert.types.__double_min_negative8_max0
    import aws_sdk_mediaconvert.types.__double_min_negative59_max0
    import aws_sdk_mediaconvert.types.__integer_min_negative70_max0
    import aws_sdk_mediaconvert.types.audio_normalization_algorithm
    import aws_sdk_mediaconvert.types.audio_normalization_algorithm_control
    import aws_sdk_mediaconvert.types.audio_normalization_loudness_logging
    import aws_sdk_mediaconvert.types.audio_normalization_peak_calculation


class AudioNormalizationSettings(TypedDict):
    algorithm: NotRequired[
        "aws_sdk_mediaconvert.types.audio_normalization_algorithm.AudioNormalizationAlgorithm"
    ]
    ...
    algorithm_control: NotRequired[
        "aws_sdk_mediaconvert.types.audio_normalization_algorithm_control.AudioNormalizationAlgorithmControl"
    ]
    """When enabled the output audio is corrected using the chosen algorithm. If disabled, the audio will be measured but not adjusted."""
    correction_gate_level: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min_negative70_max0.__integerMinNegative70Max0"
    ]
    """Content measuring above this level will be corrected to the target level. Content measuring below this level will not be corrected."""
    loudness_logging: NotRequired[
        "aws_sdk_mediaconvert.types.audio_normalization_loudness_logging.AudioNormalizationLoudnessLogging"
    ]
    """If set to LOG, log each output's audio track loudness to a CSV file."""
    peak_calculation: NotRequired[
        "aws_sdk_mediaconvert.types.audio_normalization_peak_calculation.AudioNormalizationPeakCalculation"
    ]
    """If set to TRUE_PEAK, calculate and log the TruePeak for each output's audio track loudness."""
    target_lkfs: NotRequired[
        "aws_sdk_mediaconvert.types.__double_min_negative59_max0.__doubleMinNegative59Max0"
    ]
    ...
    true_peak_limiter_threshold: NotRequired[
        "aws_sdk_mediaconvert.types.__double_min_negative8_max0.__doubleMinNegative8Max0"
    ]
...
def serialize_json(value: AudioNormalizationSettings) -> dict:
    ...
    if "algorithm" in value:
        ...
        out["algorithm"] = (
            aws_sdk_mediaconvert.types.audio_normalization_algorithm.serialize_json(
                value["algorithm"]
            )
        )
    if "algorithm_control" in value:
        ...
        out["algorithmControl"] = (
            aws_sdk_mediaconvert.types.audio_normalization_algorithm_control.serialize_json(
    ...
    if "loudness_logging" in value:
        ...
        out["loudnessLogging"] = (
            aws_sdk_mediaconvert.types.audio_normalization_loudness_logging.serialize_json(
    ...
    if "peak_calculation" in value:
        ...
        out["peakCalculation"] = (
            aws_sdk_mediaconvert.types.audio_normalization_peak_calculation.serialize_json(
...
def deserialize_json(data: dict) -> AudioNormalizationSettings:
    ...
    if "algorithm" in data:
        ...
        out["algorithm"] = (
            aws_sdk_mediaconvert.types.audio_normalization_algorithm.deserialize_json(
                data["algorithm"]
            )
        )
    if "algorithmControl" in data:
        ...
        out["algorithm_control"] = (
            aws_sdk_mediaconvert.types.audio_normalization_algorithm_control.deserialize_json(
    ...
    if "loudnessLogging" in data:
        ...
        out["loudness_logging"] = (
            aws_sdk_mediaconvert.types.audio_normalization_loudness_logging.deserialize_json(
    ...
    if "peakCalculation" in data:
        ...
        out["peak_calculation"] = (
            aws_sdk_mediaconvert.types.audio_normalization_peak_calculation.deserialize_json(
