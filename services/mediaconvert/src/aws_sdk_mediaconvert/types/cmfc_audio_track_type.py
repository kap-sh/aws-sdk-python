"""Generated from Smithy shape ``com.amazonaws.mediaconvert#CmfcAudioTrackType``."""
...
CmfcAudioTrackType: TypeAlias = Literal[
...
def serialize_json(value: CmfcAudioTrackType) -> str:
    return value


def deserialize_json(data: str) -> CmfcAudioTrackType:
    if data not in _VALUES:
        raise DeserializationError(f"unknown CmfcAudioTrackType value: {data!r}")
    return cast(CmfcAudioTrackType, data)
