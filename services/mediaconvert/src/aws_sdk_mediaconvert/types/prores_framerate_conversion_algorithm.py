"""Generated from Smithy shape ``com.amazonaws.mediaconvert#ProresFramerateConversionAlgorithm``."""
...
ProresFramerateConversionAlgorithm: TypeAlias = Literal[
    "DUPLICATE_DROP",
    "INTERPOLATE",
    "FRAMEFORMER",
...
def serialize_json(value: ProresFramerateConversionAlgorithm) -> str:
    return value


def deserialize_json(data: str) -> ProresFramerateConversionAlgorithm:
    if data not in _VALUES:
        raise DeserializationError(
            f"unknown ProresFramerateConversionAlgorithm value: {data!r}"
        )
    return cast(ProresFramerateConversionAlgorithm, data)
