"""Generated from Smithy shape ``com.amazonaws.mediaconvert#Vp8FramerateConversionAlgorithm``."""
...
Vp8FramerateConversionAlgorithm: TypeAlias = Literal[
    "DUPLICATE_DROP",
    "INTERPOLATE",
    "FRAMEFORMER",
...
def serialize_json(value: Vp8FramerateConversionAlgorithm) -> str:
    return value


def deserialize_json(data: str) -> Vp8FramerateConversionAlgorithm:
    if data not in _VALUES:
        raise DeserializationError(
            f"unknown Vp8FramerateConversionAlgorithm value: {data!r}"
        )
    return cast(Vp8FramerateConversionAlgorithm, data)
