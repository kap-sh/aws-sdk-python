...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.__integer_min0_max47185920
    ...
    import aws_sdk_mediaconvert.types.__integer_min1000_max288000000
    import aws_sdk_mediaconvert.types.__integer_min1000_max300000000
    import aws_sdk_mediaconvert.types.__list_of_frame_metric_type
    import aws_sdk_mediaconvert.types.mpeg2_adaptive_quantization
    import aws_sdk_mediaconvert.types.mpeg2_codec_level
    import aws_sdk_mediaconvert.types.mpeg2_codec_profile
    import aws_sdk_mediaconvert.types.mpeg2_dynamic_sub_gop
    import aws_sdk_mediaconvert.types.mpeg2_framerate_control
    import aws_sdk_mediaconvert.types.mpeg2_framerate_conversion_algorithm
    import aws_sdk_mediaconvert.types.mpeg2_gop_size_units
    import aws_sdk_mediaconvert.types.mpeg2_interlace_mode
    import aws_sdk_mediaconvert.types.mpeg2_intra_dc_precision
    import aws_sdk_mediaconvert.types.mpeg2_par_control
    import aws_sdk_mediaconvert.types.mpeg2_quality_tuning_level
    import aws_sdk_mediaconvert.types.mpeg2_rate_control_mode
    import aws_sdk_mediaconvert.types.mpeg2_scan_type_conversion_mode
    import aws_sdk_mediaconvert.types.mpeg2_scene_change_detect
    import aws_sdk_mediaconvert.types.mpeg2_slow_pal
    import aws_sdk_mediaconvert.types.mpeg2_spatial_adaptive_quantization
    import aws_sdk_mediaconvert.types.mpeg2_syntax
    import aws_sdk_mediaconvert.types.mpeg2_telecine
...
class Mpeg2Settings(TypedDict, closed=True):
    ...
    bitrate: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min1000_max288000000.__integerMin1000Max288000000"
    ]
    """Specify the average bitrate in bits per second. Required for VBR and CBR. For MS Smooth outputs, bitrates must be unique when rounded down to the nearest multiple of 1000."""
    codec_level: NotRequired[
        "aws_sdk_mediaconvert.types.mpeg2_codec_level.Mpeg2CodecLevel"
    ]
    """Use Level to set the MPEG-2 level for the video output."""
    codec_profile: NotRequired[
        "aws_sdk_mediaconvert.types.mpeg2_codec_profile.Mpeg2CodecProfile"
    ]
    """Use Profile to set the MPEG-2 profile for the video output."""
    dynamic_sub_gop: NotRequired[
        "aws_sdk_mediaconvert.types.mpeg2_dynamic_sub_gop.Mpeg2DynamicSubGop"
    ]
    ...
    framerate_control: NotRequired[
        "aws_sdk_mediaconvert.types.mpeg2_framerate_control.Mpeg2FramerateControl"
    ]
    ...
    framerate_conversion_algorithm: NotRequired[
        "aws_sdk_mediaconvert.types.mpeg2_framerate_conversion_algorithm.Mpeg2FramerateConversionAlgorithm"
    ]
    ...
    gop_size_units: NotRequired[
        "aws_sdk_mediaconvert.types.mpeg2_gop_size_units.Mpeg2GopSizeUnits"
    ]
    ...
    hrd_buffer_size: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min0_max47185920.__integerMin0Max47185920"
    ]
    """Size of buffer (HRD buffer model) in bits. For example, enter five megabits as 5000000."""
    interlace_mode: NotRequired[
        "aws_sdk_mediaconvert.types.mpeg2_interlace_mode.Mpeg2InterlaceMode"
    ]
    ...
    intra_dc_precision: NotRequired[
        "aws_sdk_mediaconvert.types.mpeg2_intra_dc_precision.Mpeg2IntraDcPrecision"
    ]
    ...
    max_bitrate: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min1000_max300000000.__integerMin1000Max300000000"
    ]
    ...
    par_control: NotRequired[
        "aws_sdk_mediaconvert.types.mpeg2_par_control.Mpeg2ParControl"
    ]
    ...
    quality_tuning_level: NotRequired[
        "aws_sdk_mediaconvert.types.mpeg2_quality_tuning_level.Mpeg2QualityTuningLevel"
    ]
    """Optional. Use Quality tuning level to choose how you want to trade off encoding speed for output video quality. The default behavior is faster, lower quality, single-pass encoding."""
    rate_control_mode: NotRequired[
        "aws_sdk_mediaconvert.types.mpeg2_rate_control_mode.Mpeg2RateControlMode"
    ]
    ...
    scan_type_conversion_mode: NotRequired[
        "aws_sdk_mediaconvert.types.mpeg2_scan_type_conversion_mode.Mpeg2ScanTypeConversionMode"
    ]
    ...
    scene_change_detect: NotRequired[
        "aws_sdk_mediaconvert.types.mpeg2_scene_change_detect.Mpeg2SceneChangeDetect"
    ]
    """Enable this setting to insert I-frames at scene changes that the service automatically detects. This improves video quality and is enabled by default."""
    slow_pal: NotRequired["aws_sdk_mediaconvert.types.mpeg2_slow_pal.Mpeg2SlowPal"]
    ...
    spatial_adaptive_quantization: NotRequired[
        "aws_sdk_mediaconvert.types.mpeg2_spatial_adaptive_quantization.Mpeg2SpatialAdaptiveQuantization"
    ]
    ...
    syntax: NotRequired["aws_sdk_mediaconvert.types.mpeg2_syntax.Mpeg2Syntax"]
    ...
    telecine: NotRequired["aws_sdk_mediaconvert.types.mpeg2_telecine.Mpeg2Telecine"]
    ...
    temporal_adaptive_quantization: NotRequired[
        "aws_sdk_mediaconvert.types.mpeg2_temporal_adaptive_quantization.Mpeg2TemporalAdaptiveQuantization"
    ]
...
def serialize_json(value: Mpeg2Settings) -> dict:
    ...
    if "adaptive_quantization" in value:
        ...
        out["adaptiveQuantization"] = (
            aws_sdk_mediaconvert.types.mpeg2_adaptive_quantization.serialize_json(
    ...
    if "codec_level" in value:
        ...
        out["codecLevel"] = aws_sdk_mediaconvert.types.mpeg2_codec_level.serialize_json(
            value["codec_level"]
        )
    if "codec_profile" in value:
        ...
        out["codecProfile"] = (
            aws_sdk_mediaconvert.types.mpeg2_codec_profile.serialize_json(
                value["codec_profile"]
            )
        )
    if "dynamic_sub_gop" in value:
        ...
        out["dynamicSubGop"] = (
            aws_sdk_mediaconvert.types.mpeg2_dynamic_sub_gop.serialize_json(
    ...
    if "framerate_control" in value:
        ...
        out["framerateControl"] = (
            aws_sdk_mediaconvert.types.mpeg2_framerate_control.serialize_json(
    ...
    if "framerate_conversion_algorithm" in value:
        ...
        out["framerateConversionAlgorithm"] = (
            aws_sdk_mediaconvert.types.mpeg2_framerate_conversion_algorithm.serialize_json(
    ...
    if "gop_size_units" in value:
        ...
        out["gopSizeUnits"] = (
            aws_sdk_mediaconvert.types.mpeg2_gop_size_units.serialize_json(
    ...
    if "interlace_mode" in value:
        ...
        out["interlaceMode"] = (
            aws_sdk_mediaconvert.types.mpeg2_interlace_mode.serialize_json(
    ...
    if "intra_dc_precision" in value:
        ...
        out["intraDcPrecision"] = (
            aws_sdk_mediaconvert.types.mpeg2_intra_dc_precision.serialize_json(
    ...
    if "par_control" in value:
        ...
        out["parControl"] = aws_sdk_mediaconvert.types.mpeg2_par_control.serialize_json(
            value["par_control"]
        )
    ...
    if "quality_tuning_level" in value:
        ...
        out["qualityTuningLevel"] = (
            aws_sdk_mediaconvert.types.mpeg2_quality_tuning_level.serialize_json(
    ...
    if "rate_control_mode" in value:
        ...
        out["rateControlMode"] = (
            aws_sdk_mediaconvert.types.mpeg2_rate_control_mode.serialize_json(
    ...
    if "scan_type_conversion_mode" in value:
        ...
        out["scanTypeConversionMode"] = (
            aws_sdk_mediaconvert.types.mpeg2_scan_type_conversion_mode.serialize_json(
    ...
    if "scene_change_detect" in value:
        ...
        out["sceneChangeDetect"] = (
            aws_sdk_mediaconvert.types.mpeg2_scene_change_detect.serialize_json(
    ...
    if "slow_pal" in value:
        ...
        out["slowPal"] = aws_sdk_mediaconvert.types.mpeg2_slow_pal.serialize_json(
            value["slow_pal"]
        )
    ...
    if "spatial_adaptive_quantization" in value:
        ...
        out["spatialAdaptiveQuantization"] = (
            aws_sdk_mediaconvert.types.mpeg2_spatial_adaptive_quantization.serialize_json(
    ...
    if "syntax" in value:
        ...
        out["syntax"] = aws_sdk_mediaconvert.types.mpeg2_syntax.serialize_json(
            value["syntax"]
        )
    if "telecine" in value:
        import aws_sdk_mediaconvert.types.mpeg2_telecine

        out["telecine"] = aws_sdk_mediaconvert.types.mpeg2_telecine.serialize_json(
            value["telecine"]
        )
    if "temporal_adaptive_quantization" in value:
        ...
        out["temporalAdaptiveQuantization"] = (
            aws_sdk_mediaconvert.types.mpeg2_temporal_adaptive_quantization.serialize_json(
...
def deserialize_json(data: dict) -> Mpeg2Settings:
    ...
    if "adaptiveQuantization" in data:
        ...
        out["adaptive_quantization"] = (
            aws_sdk_mediaconvert.types.mpeg2_adaptive_quantization.deserialize_json(
    ...
    if "codecLevel" in data:
        ...
        out["codec_level"] = (
            aws_sdk_mediaconvert.types.mpeg2_codec_level.deserialize_json(
                data["codecLevel"]
            )
        )
    if "codecProfile" in data:
        ...
        out["codec_profile"] = (
            aws_sdk_mediaconvert.types.mpeg2_codec_profile.deserialize_json(
                data["codecProfile"]
            )
        )
    if "dynamicSubGop" in data:
        ...
        out["dynamic_sub_gop"] = (
            aws_sdk_mediaconvert.types.mpeg2_dynamic_sub_gop.deserialize_json(
                data["dynamicSubGop"]
            )
        )
    if "framerateControl" in data:
        ...
        out["framerate_control"] = (
            aws_sdk_mediaconvert.types.mpeg2_framerate_control.deserialize_json(
    ...
    if "framerateConversionAlgorithm" in data:
        ...
        out["framerate_conversion_algorithm"] = (
            aws_sdk_mediaconvert.types.mpeg2_framerate_conversion_algorithm.deserialize_json(
    ...
    if "gopSizeUnits" in data:
        ...
        out["gop_size_units"] = (
            aws_sdk_mediaconvert.types.mpeg2_gop_size_units.deserialize_json(
                data["gopSizeUnits"]
            )
        )
    ...
    if "interlaceMode" in data:
        ...
        out["interlace_mode"] = (
            aws_sdk_mediaconvert.types.mpeg2_interlace_mode.deserialize_json(
                data["interlaceMode"]
            )
        )
    if "intraDcPrecision" in data:
        ...
        out["intra_dc_precision"] = (
            aws_sdk_mediaconvert.types.mpeg2_intra_dc_precision.deserialize_json(
    ...
    if "parControl" in data:
        ...
        out["par_control"] = (
            aws_sdk_mediaconvert.types.mpeg2_par_control.deserialize_json(
                data["parControl"]
            )
        )
    ...
    if "qualityTuningLevel" in data:
        ...
        out["quality_tuning_level"] = (
            aws_sdk_mediaconvert.types.mpeg2_quality_tuning_level.deserialize_json(
    ...
    if "rateControlMode" in data:
        ...
        out["rate_control_mode"] = (
            aws_sdk_mediaconvert.types.mpeg2_rate_control_mode.deserialize_json(
    ...
    if "scanTypeConversionMode" in data:
        ...
        out["scan_type_conversion_mode"] = (
            aws_sdk_mediaconvert.types.mpeg2_scan_type_conversion_mode.deserialize_json(
    ...
    if "sceneChangeDetect" in data:
        ...
        out["scene_change_detect"] = (
            aws_sdk_mediaconvert.types.mpeg2_scene_change_detect.deserialize_json(
    ...
    if "slowPal" in data:
        ...
        out["slow_pal"] = aws_sdk_mediaconvert.types.mpeg2_slow_pal.deserialize_json(
            data["slowPal"]
        )
    if "softness" in data:
    ...
    if "spatialAdaptiveQuantization" in data:
        ...
        out["spatial_adaptive_quantization"] = (
            aws_sdk_mediaconvert.types.mpeg2_spatial_adaptive_quantization.deserialize_json(
    ...
    if "syntax" in data:
        ...
        out["syntax"] = aws_sdk_mediaconvert.types.mpeg2_syntax.deserialize_json(
            data["syntax"]
        )
    if "telecine" in data:
        import aws_sdk_mediaconvert.types.mpeg2_telecine

        out["telecine"] = aws_sdk_mediaconvert.types.mpeg2_telecine.deserialize_json(
            data["telecine"]
        )
    if "temporalAdaptiveQuantization" in data:
        ...
        out["temporal_adaptive_quantization"] = (
            aws_sdk_mediaconvert.types.mpeg2_temporal_adaptive_quantization.deserialize_json(
