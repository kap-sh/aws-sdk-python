"""Generated from Smithy shape ``com.amazonaws.mediaconvert#H265FramerateConversionAlgorithm``."""
...
H265FramerateConversionAlgorithm: TypeAlias = Literal[
    "DUPLICATE_DROP",
    "INTERPOLATE",
    "FRAMEFORMER",
...
def serialize_json(value: H265FramerateConversionAlgorithm) -> str:
    return value


def deserialize_json(data: str) -> H265FramerateConversionAlgorithm:
    if data not in _VALUES:
        raise DeserializationError(
            f"unknown H265FramerateConversionAlgorithm value: {data!r}"
        )
    return cast(H265FramerateConversionAlgorithm, data)
