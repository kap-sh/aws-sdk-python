"""Generated from Smithy shape ``com.amazonaws.mediaconvert#Av1FramerateConversionAlgorithm``."""
...
Av1FramerateConversionAlgorithm: TypeAlias = Literal[
    "DUPLICATE_DROP",
    "INTERPOLATE",
    "FRAMEFORMER",
...
def serialize_json(value: Av1FramerateConversionAlgorithm) -> str:
    return value


def deserialize_json(data: str) -> Av1FramerateConversionAlgorithm:
    if data not in _VALUES:
        raise DeserializationError(
            f"unknown Av1FramerateConversionAlgorithm value: {data!r}"
        )
    return cast(Av1FramerateConversionAlgorithm, data)
