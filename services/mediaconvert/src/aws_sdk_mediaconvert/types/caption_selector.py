...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.caption_source_settings
...
class CaptionSelector(TypedDict, closed=True):
    ...
    source_settings: NotRequired[
        "aws_sdk_mediaconvert.types.caption_source_settings.CaptionSourceSettings"
    ]
...
def serialize_json(value: CaptionSelector) -> dict:
    ...
    if "source_settings" in value:
        ...
        out["sourceSettings"] = (
            aws_sdk_mediaconvert.types.caption_source_settings.serialize_json(
...
def deserialize_json(data: dict) -> CaptionSelector:
    ...
    if "sourceSettings" in data:
        ...
        out["source_settings"] = (
            aws_sdk_mediaconvert.types.caption_source_settings.deserialize_json(
                data["sourceSettings"]
            )
        )
    return out
