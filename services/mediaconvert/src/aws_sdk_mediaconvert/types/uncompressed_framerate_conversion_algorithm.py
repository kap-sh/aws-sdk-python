"""Generated from Smithy shape ``com.amazonaws.mediaconvert#UncompressedFramerateConversionAlgorithm``."""
...
UncompressedFramerateConversionAlgorithm: TypeAlias = Literal[
    "DUPLICATE_DROP",
    "INTERPOLATE",
    "FRAMEFORMER",
...
def serialize_json(value: UncompressedFramerateConversionAlgorithm) -> str:
    return value


def deserialize_json(data: str) -> UncompressedFramerateConversionAlgorithm:
    if data not in _VALUES:
        raise DeserializationError(
            f"unknown UncompressedFramerateConversionAlgorithm value: {data!r}"
        )
    return cast(UncompressedFramerateConversionAlgorithm, data)
