"""Generated from Smithy shape ``com.amazonaws.mediaconvert#H264TemporalAdaptiveQuantization``."""
...
H264TemporalAdaptiveQuantization: TypeAlias = Literal[
    "DISABLED",
    "ENABLED",
]
...
def serialize_json(value: H264TemporalAdaptiveQuantization) -> str:
    return value


def deserialize_json(data: str) -> H264TemporalAdaptiveQuantization:
    if data not in _VALUES:
        raise DeserializationError(
            f"unknown H264TemporalAdaptiveQuantization value: {data!r}"
        )
    return cast(H264TemporalAdaptiveQuantization, data)
