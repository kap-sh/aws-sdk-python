...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.mxf_profile
    import aws_sdk_mediaconvert.types.mxf_uncompressed_audio_wrapping
...
class MxfSettings(TypedDict, closed=True):
    ...
    profile: NotRequired["aws_sdk_mediaconvert.types.mxf_profile.MxfProfile"]
    ...
    uncompressed_audio_wrapping: NotRequired[
        "aws_sdk_mediaconvert.types.mxf_uncompressed_audio_wrapping.MxfUncompressedAudioWrapping"
    ]
    ...
    xavc_profile_settings: NotRequired[
        "aws_sdk_mediaconvert.types.mxf_xavc_profile_settings.MxfXavcProfileSettings"
    ]
...
def serialize_json(value: MxfSettings) -> dict:
    ...
    if "afd_signaling" in value:
        ...
        out["afdSignaling"] = (
            aws_sdk_mediaconvert.types.mxf_afd_signaling.serialize_json(
                value["afd_signaling"]
            )
        )
    if "profile" in value:
        ...
        out["profile"] = aws_sdk_mediaconvert.types.mxf_profile.serialize_json(
            value["profile"]
        )
    if "uncompressed_audio_wrapping" in value:
        ...
        out["uncompressedAudioWrapping"] = (
            aws_sdk_mediaconvert.types.mxf_uncompressed_audio_wrapping.serialize_json(
    ...
    if "xavc_profile_settings" in value:
        ...
        out["xavcProfileSettings"] = (
            aws_sdk_mediaconvert.types.mxf_xavc_profile_settings.serialize_json(
...
def deserialize_json(data: dict) -> MxfSettings:
    ...
    if "afdSignaling" in data:
        ...
        out["afd_signaling"] = (
            aws_sdk_mediaconvert.types.mxf_afd_signaling.deserialize_json(
                data["afdSignaling"]
            )
        )
    if "profile" in data:
        ...
        out["profile"] = aws_sdk_mediaconvert.types.mxf_profile.deserialize_json(
            data["profile"]
        )
    if "uncompressedAudioWrapping" in data:
        ...
        out["uncompressed_audio_wrapping"] = (
            aws_sdk_mediaconvert.types.mxf_uncompressed_audio_wrapping.deserialize_json(
    ...
    if "xavcProfileSettings" in data:
        ...
        out["xavc_profile_settings"] = (
            aws_sdk_mediaconvert.types.mxf_xavc_profile_settings.deserialize_json(
