...
if TYPE_CHECKING:
    import aws_sdk_mediaconvert.types.__string_max1000
    ...
    import aws_sdk_mediaconvert.types.mpd_accessibility_caption_hints
    import aws_sdk_mediaconvert.types.mpd_audio_duration
    import aws_sdk_mediaconvert.types.mpd_c2pa_manifest
    import aws_sdk_mediaconvert.types.mpd_caption_container_type
    import aws_sdk_mediaconvert.types.mpd_klv_metadata
    import aws_sdk_mediaconvert.types.mpd_manifest_metadata_signaling
    import aws_sdk_mediaconvert.types.mpd_scte35_esam
    import aws_sdk_mediaconvert.types.mpd_scte35_source
    import aws_sdk_mediaconvert.types.mpd_timed_metadata
    import aws_sdk_mediaconvert.types.mpd_timed_metadata_box_version


class MpdSettings(TypedDict):
    accessibility_caption_hints: NotRequired[
        "aws_sdk_mediaconvert.types.mpd_accessibility_caption_hints.MpdAccessibilityCaptionHints"
    ]
    ...
    audio_duration: NotRequired[
        "aws_sdk_mediaconvert.types.mpd_audio_duration.MpdAudioDuration"
    ]
    ...
    c2pa_manifest: NotRequired[
        "aws_sdk_mediaconvert.types.mpd_c2pa_manifest.MpdC2paManifest"
    ]
    ...
    caption_container_type: NotRequired[
        "aws_sdk_mediaconvert.types.mpd_caption_container_type.MpdCaptionContainerType"
    ]
    ...
    klv_metadata: NotRequired[
        "aws_sdk_mediaconvert.types.mpd_klv_metadata.MpdKlvMetadata"
    ]
    """To include key-length-value metadata in this output: Set KLV metadata insertion to Passthrough. MediaConvert reads KLV metadata present in your input and writes each instance to a separate event message box in the output, according to MISB ST1910.1. To exclude this KLV metadata: Set KLV metadata insertion to None or leave blank."""
    manifest_metadata_signaling: NotRequired[
        "aws_sdk_mediaconvert.types.mpd_manifest_metadata_signaling.MpdManifestMetadataSignaling"
    ]
    ...
    scte35_esam: NotRequired["aws_sdk_mediaconvert.types.mpd_scte35_esam.MpdScte35Esam"]
    ...
    scte35_source: NotRequired[
        "aws_sdk_mediaconvert.types.mpd_scte35_source.MpdScte35Source"
    ]
    ...
    timed_metadata: NotRequired[
        "aws_sdk_mediaconvert.types.mpd_timed_metadata.MpdTimedMetadata"
    ]
    ...
    timed_metadata_box_version: NotRequired[
        "aws_sdk_mediaconvert.types.mpd_timed_metadata_box_version.MpdTimedMetadataBoxVersion"
    ]
    ...
    timed_metadata_scheme_id_uri: NotRequired[
        "aws_sdk_mediaconvert.types.__string_max1000.__stringMax1000"
    ]
...
def serialize_json(value: MpdSettings) -> dict:
    ...
    if "accessibility_caption_hints" in value:
        ...
        out["accessibilityCaptionHints"] = (
            aws_sdk_mediaconvert.types.mpd_accessibility_caption_hints.serialize_json(
    ...
    if "audio_duration" in value:
        ...
        out["audioDuration"] = (
            aws_sdk_mediaconvert.types.mpd_audio_duration.serialize_json(
    ...
    if "c2pa_manifest" in value:
        ...
        out["c2paManifest"] = (
            aws_sdk_mediaconvert.types.mpd_c2pa_manifest.serialize_json(
                value["c2pa_manifest"]
            )
        )
    if "caption_container_type" in value:
        ...
        out["captionContainerType"] = (
            aws_sdk_mediaconvert.types.mpd_caption_container_type.serialize_json(
    ...
    if "klv_metadata" in value:
        ...
        out["klvMetadata"] = aws_sdk_mediaconvert.types.mpd_klv_metadata.serialize_json(
            value["klv_metadata"]
        )
    if "manifest_metadata_signaling" in value:
        ...
        out["manifestMetadataSignaling"] = (
            aws_sdk_mediaconvert.types.mpd_manifest_metadata_signaling.serialize_json(
    ...
    if "scte35_esam" in value:
        ...
        out["scte35Esam"] = aws_sdk_mediaconvert.types.mpd_scte35_esam.serialize_json(
            value["scte35_esam"]
        )
    if "scte35_source" in value:
        ...
        out["scte35Source"] = (
            aws_sdk_mediaconvert.types.mpd_scte35_source.serialize_json(
                value["scte35_source"]
            )
        )
    ...
    if "timed_metadata" in value:
        ...
        out["timedMetadata"] = (
            aws_sdk_mediaconvert.types.mpd_timed_metadata.serialize_json(
    ...
    if "timed_metadata_box_version" in value:
        ...
        out["timedMetadataBoxVersion"] = (
            aws_sdk_mediaconvert.types.mpd_timed_metadata_box_version.serialize_json(
...
def deserialize_json(data: dict) -> MpdSettings:
    ...
    if "accessibilityCaptionHints" in data:
        ...
        out["accessibility_caption_hints"] = (
            aws_sdk_mediaconvert.types.mpd_accessibility_caption_hints.deserialize_json(
    ...
    if "audioDuration" in data:
        ...
        out["audio_duration"] = (
            aws_sdk_mediaconvert.types.mpd_audio_duration.deserialize_json(
                data["audioDuration"]
            )
        )
    if "c2paManifest" in data:
        ...
        out["c2pa_manifest"] = (
            aws_sdk_mediaconvert.types.mpd_c2pa_manifest.deserialize_json(
                data["c2paManifest"]
            )
        )
    if "captionContainerType" in data:
        ...
        out["caption_container_type"] = (
            aws_sdk_mediaconvert.types.mpd_caption_container_type.deserialize_json(
    ...
    if "klvMetadata" in data:
        ...
        out["klv_metadata"] = (
            aws_sdk_mediaconvert.types.mpd_klv_metadata.deserialize_json(
                data["klvMetadata"]
            )
        )
    if "manifestMetadataSignaling" in data:
        ...
        out["manifest_metadata_signaling"] = (
            aws_sdk_mediaconvert.types.mpd_manifest_metadata_signaling.deserialize_json(
    ...
    if "scte35Esam" in data:
        ...
        out["scte35_esam"] = (
            aws_sdk_mediaconvert.types.mpd_scte35_esam.deserialize_json(
                data["scte35Esam"]
            )
        )
    if "scte35Source" in data:
        ...
        out["scte35_source"] = (
            aws_sdk_mediaconvert.types.mpd_scte35_source.deserialize_json(
                data["scte35Source"]
            )
        )
    ...
    if "timedMetadata" in data:
        ...
        out["timed_metadata"] = (
            aws_sdk_mediaconvert.types.mpd_timed_metadata.deserialize_json(
                data["timedMetadata"]
            )
        )
    if "timedMetadataBoxVersion" in data:
        ...
        out["timed_metadata_box_version"] = (
            aws_sdk_mediaconvert.types.mpd_timed_metadata_box_version.deserialize_json(
