"""Generated from Smithy shape ``com.amazonaws.mediaconvert#Mpeg2TemporalAdaptiveQuantization``."""
...
Mpeg2TemporalAdaptiveQuantization: TypeAlias = Literal[
    "DISABLED",
    "ENABLED",
]
...
def serialize_json(value: Mpeg2TemporalAdaptiveQuantization) -> str:
    return value


def deserialize_json(data: str) -> Mpeg2TemporalAdaptiveQuantization:
    if data not in _VALUES:
        raise DeserializationError(
            f"unknown Mpeg2TemporalAdaptiveQuantization value: {data!r}"
        )
    return cast(Mpeg2TemporalAdaptiveQuantization, data)
