"""Generated from Smithy shape ``com.amazonaws.mediaconvert#CmafSegmentLengthControl``."""
...
CmafSegmentLengthControl: TypeAlias = Literal[
    "EXACT",
    "GOP_MULTIPLE",
    "MATCH",
]
...
def serialize_json(value: CmafSegmentLengthControl) -> str:
    return value


def deserialize_json(data: str) -> CmafSegmentLengthControl:
    if data not in _VALUES:
        raise DeserializationError(f"unknown CmafSegmentLengthControl value: {data!r}")
    return cast(CmafSegmentLengthControl, data)
