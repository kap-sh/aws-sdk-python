...
if TYPE_CHECKING:
    import aws_sdk_mediaconvert.types.frame_control
    import aws_sdk_mediaconvert.types.video_selector_mode


class PassthroughSettings(TypedDict, closed=True):
    frame_control: NotRequired["aws_sdk_mediaconvert.types.frame_control.FrameControl"]
    ...
    video_selector_mode: NotRequired[
        "aws_sdk_mediaconvert.types.video_selector_mode.VideoSelectorMode"
    ]
...
def serialize_json(value: PassthroughSettings) -> dict:
    ...
    if "frame_control" in value:
        ...
        out["frameControl"] = aws_sdk_mediaconvert.types.frame_control.serialize_json(
            value["frame_control"]
        )
    if "video_selector_mode" in value:
        ...
        out["videoSelectorMode"] = (
            aws_sdk_mediaconvert.types.video_selector_mode.serialize_json(
...
def deserialize_json(data: dict) -> PassthroughSettings:
    ...
    if "frameControl" in data:
        ...
        out["frame_control"] = (
            aws_sdk_mediaconvert.types.frame_control.deserialize_json(
                data["frameControl"]
            )
        )
    if "videoSelectorMode" in data:
        ...
        out["video_selector_mode"] = (
            aws_sdk_mediaconvert.types.video_selector_mode.deserialize_json(
