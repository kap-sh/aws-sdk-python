...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.audio_selector_group

__mapOfAudioSelectorGroup: TypeAlias = dict[
    "aws_sdk_mediaconvert.types.__string.__string",
    "aws_sdk_mediaconvert.types.audio_selector_group.AudioSelectorGroup",
]
...
def serialize_json(input_to_serialize: __mapOfAudioSelectorGroup) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_mediaconvert.types.audio_selector_group.serialize_json(value)
    return out
...
def deserialize_json(data: dict) -> __mapOfAudioSelectorGroup:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_mediaconvert.types.audio_selector_group.deserialize_json(
            value
        )
    return out
