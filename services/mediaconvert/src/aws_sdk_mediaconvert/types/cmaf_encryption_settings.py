...
if TYPE_CHECKING:
    import aws_sdk_mediaconvert.types.__integer_min1_max9999
    import aws_sdk_mediaconvert.types.__string_min32_max32_pattern09a_faf32
    import aws_sdk_mediaconvert.types.cmaf_encryption_type
    import aws_sdk_mediaconvert.types.cmaf_initialization_vector_in_manifest
    import aws_sdk_mediaconvert.types.cmaf_key_provider_type
    import aws_sdk_mediaconvert.types.speke_key_provider_cmaf
    import aws_sdk_mediaconvert.types.static_key_provider


class CmafEncryptionSettings(TypedDict):
    clear_lead_segments: NotRequired[
        "aws_sdk_mediaconvert.types.__integer_min1_max9999.__integerMin1Max9999"
    ]
    ...
    encryption_method: NotRequired[
        "aws_sdk_mediaconvert.types.cmaf_encryption_type.CmafEncryptionType"
    ]
    ...
    initialization_vector_in_manifest: NotRequired[
        "aws_sdk_mediaconvert.types.cmaf_initialization_vector_in_manifest.CmafInitializationVectorInManifest"
    ]
    """When you use DRM with CMAF outputs, choose whether the service writes the 128-bit encryption initialization vector in the HLS and DASH manifests."""
    speke_key_provider: NotRequired[
        "aws_sdk_mediaconvert.types.speke_key_provider_cmaf.SpekeKeyProviderCmaf"
    ]
    ...
    type: NotRequired[
        "aws_sdk_mediaconvert.types.cmaf_key_provider_type.CmafKeyProviderType"
    ]
...
def serialize_json(value: CmafEncryptionSettings) -> dict:
    ...
    if "encryption_method" in value:
        ...
        out["encryptionMethod"] = (
            aws_sdk_mediaconvert.types.cmaf_encryption_type.serialize_json(
    ...
    if "initialization_vector_in_manifest" in value:
        ...
        out["initializationVectorInManifest"] = (
            aws_sdk_mediaconvert.types.cmaf_initialization_vector_in_manifest.serialize_json(
    ...
    if "speke_key_provider" in value:
        ...
        out["spekeKeyProvider"] = (
            aws_sdk_mediaconvert.types.speke_key_provider_cmaf.serialize_json(
    ...
    if "type" in value:
        ...
        out["type"] = aws_sdk_mediaconvert.types.cmaf_key_provider_type.serialize_json(
            value["type"]
        )
    return out
...
def deserialize_json(data: dict) -> CmafEncryptionSettings:
    ...
    if "encryptionMethod" in data:
        ...
        out["encryption_method"] = (
            aws_sdk_mediaconvert.types.cmaf_encryption_type.deserialize_json(
    ...
    if "initializationVectorInManifest" in data:
        ...
        out["initialization_vector_in_manifest"] = (
            aws_sdk_mediaconvert.types.cmaf_initialization_vector_in_manifest.deserialize_json(
    ...
    if "spekeKeyProvider" in data:
        ...
        out["speke_key_provider"] = (
            aws_sdk_mediaconvert.types.speke_key_provider_cmaf.deserialize_json(
    ...
    if "type" in data:
        ...
        out["type"] = (
            aws_sdk_mediaconvert.types.cmaf_key_provider_type.deserialize_json(
                data["type"]
            )
        )
    return out
