"""Generated from Smithy shape ``com.amazonaws.mediaconvert#CmafImageBasedTrickPlayVariant``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_mediaconvert.types.cmaf_interval_cadence


class CmafImageBasedTrickPlayVariant(TypedDict, closed=True):
    interval_cadence: NotRequired[
        "aws_sdk_mediaconvert.types.cmaf_interval_cadence.CmafIntervalCadence"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: CmafImageBasedTrickPlayVariant) -> dict:
    out: dict = {}
    if "interval_cadence" in value:
        import aws_sdk_mediaconvert.types.cmaf_interval_cadence

        out["intervalCadence"] = (
            aws_sdk_mediaconvert.types.cmaf_interval_cadence.serialize_json(
...
def deserialize_json(data: dict) -> CmafImageBasedTrickPlayVariant:
    ...
    if "intervalCadence" in data:
        ...
        out["interval_cadence"] = (
            aws_sdk_mediaconvert.types.cmaf_interval_cadence.deserialize_json(
