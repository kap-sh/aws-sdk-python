"""Generated from Smithy shape ``com.amazonaws.mediaconvert#CmafImageBasedTrickPlaySettings``."""
...
class CmafImageBasedTrickPlaySettings(TypedDict, closed=True):
    interval_cadence: NotRequired[
        "capo_mediaconvert.types.cmaf_interval_cadence.CmafIntervalCadence"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: CmafImageBasedTrickPlaySettings) -> dict:
    out: dict = {}
    if "interval_cadence" in value:
        import capo_mediaconvert.types.cmaf_interval_cadence

        out["intervalCadence"] = (
            capo_mediaconvert.types.cmaf_interval_cadence.serialize_json(
...
def deserialize_json(data: dict) -> CmafImageBasedTrickPlaySettings:
    out: CmafImageBasedTrickPlaySettings = {}  # type: ignore[typeddict-item]
    if "intervalCadence" in data:
        import capo_mediaconvert.types.cmaf_interval_cadence

        out["interval_cadence"] = (
            capo_mediaconvert.types.cmaf_interval_cadence.deserialize_json(
