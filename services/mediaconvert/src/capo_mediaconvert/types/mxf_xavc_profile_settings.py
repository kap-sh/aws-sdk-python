...
class MxfXavcProfileSettings(TypedDict, closed=True):
    duration_mode: NotRequired[
        "capo_mediaconvert.types.mxf_xavc_duration_mode.MxfXavcDurationMode"
    ]
...
def serialize_json(value: MxfXavcProfileSettings) -> dict:
    ...
    if "duration_mode" in value:
        ...
        out["durationMode"] = (
            capo_mediaconvert.types.mxf_xavc_duration_mode.serialize_json(
                value["duration_mode"]
            )
        )
...
def deserialize_json(data: dict) -> MxfXavcProfileSettings:
    ...
    if "durationMode" in data:
        ...
        out["duration_mode"] = (
            capo_mediaconvert.types.mxf_xavc_duration_mode.deserialize_json(
                data["durationMode"]
            )
        )
