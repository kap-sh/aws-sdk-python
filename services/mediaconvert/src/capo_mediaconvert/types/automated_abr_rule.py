...
class AutomatedAbrRule(TypedDict, closed=True):
    allowed_renditions: NotRequired[
        "capo_mediaconvert.types.__list_of_allowed_rendition_size.__listOfAllowedRenditionSize"
    ]
    ...
    force_include_renditions: NotRequired[
        "capo_mediaconvert.types.__list_of_force_include_rendition_size.__listOfForceIncludeRenditionSize"
    ]
    ...
    min_bottom_rendition_size: NotRequired[
        "capo_mediaconvert.types.min_bottom_rendition_size.MinBottomRenditionSize"
    ]
    ...
    min_top_rendition_size: NotRequired[
        "capo_mediaconvert.types.min_top_rendition_size.MinTopRenditionSize"
    ]
    ...
    type: NotRequired["capo_mediaconvert.types.rule_type.RuleType"]
...
def serialize_json(value: AutomatedAbrRule) -> dict:
    ...
    if "allowed_renditions" in value:
        ...
        out["allowedRenditions"] = (
            capo_mediaconvert.types.__list_of_allowed_rendition_size.serialize_json(
    ...
    if "force_include_renditions" in value:
        ...
        out["forceIncludeRenditions"] = (
            capo_mediaconvert.types.__list_of_force_include_rendition_size.serialize_json(
    ...
    if "min_bottom_rendition_size" in value:
        ...
        out["minBottomRenditionSize"] = (
            capo_mediaconvert.types.min_bottom_rendition_size.serialize_json(
    ...
    if "min_top_rendition_size" in value:
        ...
        out["minTopRenditionSize"] = (
            capo_mediaconvert.types.min_top_rendition_size.serialize_json(
    ...
    if "type" in value:
        ...
        out["type"] = capo_mediaconvert.types.rule_type.serialize_json(value["type"])
    return out
...
def deserialize_json(data: dict) -> AutomatedAbrRule:
    ...
    if "allowedRenditions" in data:
        ...
        out["allowed_renditions"] = (
            capo_mediaconvert.types.__list_of_allowed_rendition_size.deserialize_json(
    ...
    if "forceIncludeRenditions" in data:
        ...
        out["force_include_renditions"] = (
            capo_mediaconvert.types.__list_of_force_include_rendition_size.deserialize_json(
    ...
    if "minBottomRenditionSize" in data:
        ...
        out["min_bottom_rendition_size"] = (
            capo_mediaconvert.types.min_bottom_rendition_size.deserialize_json(
    ...
    if "minTopRenditionSize" in data:
        ...
        out["min_top_rendition_size"] = (
            capo_mediaconvert.types.min_top_rendition_size.deserialize_json(
