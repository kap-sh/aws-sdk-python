...
class HlsEncryptionSettings(TypedDict, closed=True):
    ...
    encryption_method: NotRequired[
        "capo_mediaconvert.types.hls_encryption_type.HlsEncryptionType"
    ]
    """Encrypts the segments with the given encryption scheme. Leave blank to disable. Selecting 'Disabled' in the web interface also disables encryption."""
    initialization_vector_in_manifest: NotRequired[
        "capo_mediaconvert.types.hls_initialization_vector_in_manifest.HlsInitializationVectorInManifest"
    ]
    """The Initialization Vector is a 128-bit number used in conjunction with the key for encrypting blocks. If set to INCLUDE, Initialization Vector is listed in the manifest. Otherwise Initialization Vector is not in the manifest."""
    offline_encrypted: NotRequired[
        "capo_mediaconvert.types.hls_offline_encrypted.HlsOfflineEncrypted"
    ]
    ...
    type: NotRequired[
        "capo_mediaconvert.types.hls_key_provider_type.HlsKeyProviderType"
    ]
...
def serialize_json(value: HlsEncryptionSettings) -> dict:
    ...
    if "encryption_method" in value:
        ...
        out["encryptionMethod"] = (
            capo_mediaconvert.types.hls_encryption_type.serialize_json(
    ...
    if "initialization_vector_in_manifest" in value:
        ...
        out["initializationVectorInManifest"] = (
            capo_mediaconvert.types.hls_initialization_vector_in_manifest.serialize_json(
    ...
    if "offline_encrypted" in value:
        ...
        out["offlineEncrypted"] = (
            capo_mediaconvert.types.hls_offline_encrypted.serialize_json(
    ...
    if "type" in value:
        ...
        out["type"] = capo_mediaconvert.types.hls_key_provider_type.serialize_json(
            value["type"]
        )
    return out
...
def deserialize_json(data: dict) -> HlsEncryptionSettings:
    ...
    if "encryptionMethod" in data:
        ...
        out["encryption_method"] = (
            capo_mediaconvert.types.hls_encryption_type.deserialize_json(
    ...
    if "initializationVectorInManifest" in data:
        ...
        out["initialization_vector_in_manifest"] = (
            capo_mediaconvert.types.hls_initialization_vector_in_manifest.deserialize_json(
    ...
    if "offlineEncrypted" in data:
        ...
        out["offline_encrypted"] = (
            capo_mediaconvert.types.hls_offline_encrypted.deserialize_json(
