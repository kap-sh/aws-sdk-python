"""Generated from Smithy shape ``com.amazonaws.mediaconvert#DashIsoImageBasedTrickPlaySettings``."""
...
if TYPE_CHECKING:
    ...
    import capo_mediaconvert.types.__integer_min1_max512
    import capo_mediaconvert.types.__integer_min1_max2048
    import capo_mediaconvert.types.__integer_min1_max4096
    import capo_mediaconvert.types.__integer_min8_max4096
    import capo_mediaconvert.types.dash_iso_interval_cadence


class DashIsoImageBasedTrickPlaySettings(TypedDict, closed=True):
    interval_cadence: NotRequired[
        "capo_mediaconvert.types.dash_iso_interval_cadence.DashIsoIntervalCadence"
    ]
    ...
    thumbnail_height: NotRequired[
        "capo_mediaconvert.types.__integer_min1_max4096.__integerMin1Max4096"
    ]
    ...
    thumbnail_width: NotRequired[
        "capo_mediaconvert.types.__integer_min8_max4096.__integerMin8Max4096"
    ]
    """Width of each thumbnail within each tile image, in pixels. Default is 312. Must be divisible by 8."""
    tile_height: NotRequired[
        "capo_mediaconvert.types.__integer_min1_max2048.__integerMin1Max2048"
    ]
    """Number of thumbnails in each column of a tile image. Set a value between 1 and 2048."""
    tile_width: NotRequired[
        "capo_mediaconvert.types.__integer_min1_max512.__integerMin1Max512"
    ]
    """Number of thumbnails in each row of a tile image. Set a value between 1 and 512."""


# --- restJson1 ser/de ---
def serialize_json(value: DashIsoImageBasedTrickPlaySettings) -> dict:
    out: dict = {}
    if "interval_cadence" in value:
        import capo_mediaconvert.types.dash_iso_interval_cadence

        out["intervalCadence"] = (
            capo_mediaconvert.types.dash_iso_interval_cadence.serialize_json(
...
def deserialize_json(data: dict) -> DashIsoImageBasedTrickPlaySettings:
    out: DashIsoImageBasedTrickPlaySettings = {}  # type: ignore[typeddict-item]
    if "intervalCadence" in data:
        import capo_mediaconvert.types.dash_iso_interval_cadence

        out["interval_cadence"] = (
            capo_mediaconvert.types.dash_iso_interval_cadence.deserialize_json(
