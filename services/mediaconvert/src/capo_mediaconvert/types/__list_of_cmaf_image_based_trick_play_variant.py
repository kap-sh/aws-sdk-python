...
if TYPE_CHECKING:
    import capo_mediaconvert.types.cmaf_image_based_trick_play_variant

__listOfCmafImageBasedTrickPlayVariant: TypeAlias = list[
    "capo_mediaconvert.types.cmaf_image_based_trick_play_variant.CmafImageBasedTrickPlayVariant"
]
...
def serialize_json(value: __listOfCmafImageBasedTrickPlayVariant) -> list:
    ...
    for item in value:
        out.append(
            capo_mediaconvert.types.cmaf_image_based_trick_play_variant.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> __listOfCmafImageBasedTrickPlayVariant:
    ...
    for item in data:
        out.append(
            capo_mediaconvert.types.cmaf_image_based_trick_play_variant.deserialize_json(
                item
            )
        )
    return out
