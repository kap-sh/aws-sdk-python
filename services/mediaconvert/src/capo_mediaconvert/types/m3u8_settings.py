...
class M3u8Settings(TypedDict, closed=True):
    audio_duration: NotRequired[
        "capo_mediaconvert.types.m3u8_audio_duration.M3u8AudioDuration"
    ]
    ...
    data_pts_control: NotRequired[
        "capo_mediaconvert.types.m3u8_data_pts_control.M3u8DataPtsControl"
    ]
    ...
    nielsen_id3: NotRequired["capo_mediaconvert.types.m3u8_nielsen_id3.M3u8NielsenId3"]
    ...
    pcr_control: NotRequired["capo_mediaconvert.types.m3u8_pcr_control.M3u8PcrControl"]
    ...
    scte35_source: NotRequired[
        "capo_mediaconvert.types.m3u8_scte35_source.M3u8Scte35Source"
    ]
    ...
    timed_metadata: NotRequired["capo_mediaconvert.types.timed_metadata.TimedMetadata"]
...
def serialize_json(value: M3u8Settings) -> dict:
    ...
    if "audio_duration" in value:
        ...
        out["audioDuration"] = (
            capo_mediaconvert.types.m3u8_audio_duration.serialize_json(
    ...
    if "data_pts_control" in value:
        ...
        out["dataPTSControl"] = (
            capo_mediaconvert.types.m3u8_data_pts_control.serialize_json(
    ...
    if "nielsen_id3" in value:
        ...
        out["nielsenId3"] = capo_mediaconvert.types.m3u8_nielsen_id3.serialize_json(
            value["nielsen_id3"]
        )
    ...
    if "pcr_control" in value:
        ...
        out["pcrControl"] = capo_mediaconvert.types.m3u8_pcr_control.serialize_json(
            value["pcr_control"]
        )
    if "pcr_pid" in value:
    ...
    if "scte35_source" in value:
        ...
        out["scte35Source"] = capo_mediaconvert.types.m3u8_scte35_source.serialize_json(
            value["scte35_source"]
        )
    if "timed_metadata" in value:
        import capo_mediaconvert.types.timed_metadata

        out["timedMetadata"] = capo_mediaconvert.types.timed_metadata.serialize_json(
...
def deserialize_json(data: dict) -> M3u8Settings:
    ...
    if "audioDuration" in data:
        ...
        out["audio_duration"] = (
            capo_mediaconvert.types.m3u8_audio_duration.deserialize_json(
                data["audioDuration"]
            )
        )
    ...
    if "dataPTSControl" in data:
        ...
        out["data_pts_control"] = (
            capo_mediaconvert.types.m3u8_data_pts_control.deserialize_json(
                data["dataPTSControl"]
            )
        )
    ...
    if "scte35Source" in data:
        ...
        out["scte35_source"] = (
            capo_mediaconvert.types.m3u8_scte35_source.deserialize_json(
                data["scte35Source"]
            )
        )
