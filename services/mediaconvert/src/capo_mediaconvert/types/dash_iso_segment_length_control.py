"""Generated from Smithy shape ``com.amazonaws.mediaconvert#DashIsoSegmentLengthControl``."""
...
DashIsoSegmentLengthControl: TypeAlias = Literal[
    "EXACT",
    "GOP_MULTIPLE",
    "MATCH",
]
...
# --- restJson1 ser/de ---
def serialize_json(value: DashIsoSegmentLengthControl) -> str:
    return value


def deserialize_json(data: str) -> DashIsoSegmentLengthControl:
    return cast(DashIsoSegmentLengthControl, data)
