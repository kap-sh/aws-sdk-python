"""Generated from Smithy shape ``com.amazonaws.mediaconvert#XavcFramerateConversionAlgorithm``."""
...
XavcFramerateConversionAlgorithm: TypeAlias = Literal[
    "DUPLICATE_DROP",
    "INTERPOLATE",
    "FRAMEFORMER",
...
# --- restJson1 ser/de ---
def serialize_json(value: XavcFramerateConversionAlgorithm) -> str:
    return value


def deserialize_json(data: str) -> XavcFramerateConversionAlgorithm:
    return cast(XavcFramerateConversionAlgorithm, data)
