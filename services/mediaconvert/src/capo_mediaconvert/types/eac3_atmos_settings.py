...
if TYPE_CHECKING:
    import capo_mediaconvert.types.__double_min_negative6_max3
    ...
    import capo_mediaconvert.types.__integer_min384000_max1024000
...
class Eac3AtmosSettings(TypedDict, closed=True):
    bitrate: NotRequired[
        "capo_mediaconvert.types.__integer_min384000_max1024000.__integerMin384000Max1024000"
    ]
    ...
    bitstream_mode: NotRequired[
        "capo_mediaconvert.types.eac3_atmos_bitstream_mode.Eac3AtmosBitstreamMode"
    ]
    """Specify the bitstream mode for the E-AC-3 stream that the encoder emits. For more information about the EAC3 bitstream mode, see ATSC A/52-2012 (Annex E)."""
    coding_mode: NotRequired[
        "capo_mediaconvert.types.eac3_atmos_coding_mode.Eac3AtmosCodingMode"
    ]
    """The coding mode for Dolby Digital Plus JOC (Atmos)."""
    dialogue_intelligence: NotRequired[
        "capo_mediaconvert.types.eac3_atmos_dialogue_intelligence.Eac3AtmosDialogueIntelligence"
    ]
    """Enable Dolby Dialogue Intelligence to adjust loudness based on dialogue analysis."""
    downmix_control: NotRequired[
        "capo_mediaconvert.types.eac3_atmos_downmix_control.Eac3AtmosDownmixControl"
    ]
    ...
    dynamic_range_compression_line: NotRequired[
        "capo_mediaconvert.types.eac3_atmos_dynamic_range_compression_line.Eac3AtmosDynamicRangeCompressionLine"
    ]
    ...
    dynamic_range_compression_rf: NotRequired[
        "capo_mediaconvert.types.eac3_atmos_dynamic_range_compression_rf.Eac3AtmosDynamicRangeCompressionRf"
    ]
    ...
    dynamic_range_control: NotRequired[
        "capo_mediaconvert.types.eac3_atmos_dynamic_range_control.Eac3AtmosDynamicRangeControl"
    ]
    ...
    lo_ro_center_mix_level: NotRequired[
        "capo_mediaconvert.types.__double_min_negative6_max3.__doubleMinNegative6Max3"
    ]
    ...
    metering_mode: NotRequired[
        "capo_mediaconvert.types.eac3_atmos_metering_mode.Eac3AtmosMeteringMode"
    ]
    ...
    stereo_downmix: NotRequired[
        "capo_mediaconvert.types.eac3_atmos_stereo_downmix.Eac3AtmosStereoDownmix"
    ]
    ...
    surround_ex_mode: NotRequired[
        "capo_mediaconvert.types.eac3_atmos_surround_ex_mode.Eac3AtmosSurroundExMode"
    ]
...
def serialize_json(value: Eac3AtmosSettings) -> dict:
    ...
    if "bitstream_mode" in value:
        ...
        out["bitstreamMode"] = (
            capo_mediaconvert.types.eac3_atmos_bitstream_mode.serialize_json(
    ...
    if "coding_mode" in value:
        ...
        out["codingMode"] = (
            capo_mediaconvert.types.eac3_atmos_coding_mode.serialize_json(
                value["coding_mode"]
            )
        )
    if "dialogue_intelligence" in value:
        ...
        out["dialogueIntelligence"] = (
            capo_mediaconvert.types.eac3_atmos_dialogue_intelligence.serialize_json(
    ...
    if "downmix_control" in value:
        ...
        out["downmixControl"] = (
            capo_mediaconvert.types.eac3_atmos_downmix_control.serialize_json(
    ...
    if "dynamic_range_compression_line" in value:
        ...
        out["dynamicRangeCompressionLine"] = (
            capo_mediaconvert.types.eac3_atmos_dynamic_range_compression_line.serialize_json(
    ...
    if "dynamic_range_compression_rf" in value:
        ...
        out["dynamicRangeCompressionRf"] = (
            capo_mediaconvert.types.eac3_atmos_dynamic_range_compression_rf.serialize_json(
    ...
    if "dynamic_range_control" in value:
        ...
        out["dynamicRangeControl"] = (
            capo_mediaconvert.types.eac3_atmos_dynamic_range_control.serialize_json(
    ...
    if "metering_mode" in value:
        ...
        out["meteringMode"] = (
            capo_mediaconvert.types.eac3_atmos_metering_mode.serialize_json(
                value["metering_mode"]
            )
        )
    ...
    if "stereo_downmix" in value:
        ...
        out["stereoDownmix"] = (
            capo_mediaconvert.types.eac3_atmos_stereo_downmix.serialize_json(
    ...
    if "surround_ex_mode" in value:
        ...
        out["surroundExMode"] = (
            capo_mediaconvert.types.eac3_atmos_surround_ex_mode.serialize_json(
...
def deserialize_json(data: dict) -> Eac3AtmosSettings:
    ...
    if "bitstreamMode" in data:
        ...
        out["bitstream_mode"] = (
            capo_mediaconvert.types.eac3_atmos_bitstream_mode.deserialize_json(
                data["bitstreamMode"]
            )
        )
    if "codingMode" in data:
        ...
        out["coding_mode"] = (
            capo_mediaconvert.types.eac3_atmos_coding_mode.deserialize_json(
                data["codingMode"]
            )
        )
    if "dialogueIntelligence" in data:
        ...
        out["dialogue_intelligence"] = (
            capo_mediaconvert.types.eac3_atmos_dialogue_intelligence.deserialize_json(
    ...
    if "downmixControl" in data:
        ...
        out["downmix_control"] = (
            capo_mediaconvert.types.eac3_atmos_downmix_control.deserialize_json(
                data["downmixControl"]
            )
        )
    if "dynamicRangeCompressionLine" in data:
        ...
        out["dynamic_range_compression_line"] = (
            capo_mediaconvert.types.eac3_atmos_dynamic_range_compression_line.deserialize_json(
    ...
    if "dynamicRangeCompressionRf" in data:
        ...
        out["dynamic_range_compression_rf"] = (
            capo_mediaconvert.types.eac3_atmos_dynamic_range_compression_rf.deserialize_json(
    ...
    if "dynamicRangeControl" in data:
        ...
        out["dynamic_range_control"] = (
            capo_mediaconvert.types.eac3_atmos_dynamic_range_control.deserialize_json(
    ...
    if "meteringMode" in data:
        ...
        out["metering_mode"] = (
            capo_mediaconvert.types.eac3_atmos_metering_mode.deserialize_json(
                data["meteringMode"]
            )
        )
    ...
    if "stereoDownmix" in data:
        ...
        out["stereo_downmix"] = (
            capo_mediaconvert.types.eac3_atmos_stereo_downmix.deserialize_json(
                data["stereoDownmix"]
            )
        )
    if "surroundExMode" in data:
        ...
        out["surround_ex_mode"] = (
            capo_mediaconvert.types.eac3_atmos_surround_ex_mode.deserialize_json(
                data["surroundExMode"]
            )
        )
    return out
