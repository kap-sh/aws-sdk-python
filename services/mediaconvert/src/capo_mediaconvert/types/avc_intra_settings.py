...
class AvcIntraSettings(TypedDict, closed=True):
    ...
    avc_intra_uhd_settings: NotRequired[
        "capo_mediaconvert.types.avc_intra_uhd_settings.AvcIntraUhdSettings"
    ]
    ...
    framerate_control: NotRequired[
        "capo_mediaconvert.types.avc_intra_framerate_control.AvcIntraFramerateControl"
    ]
    ...
    framerate_conversion_algorithm: NotRequired[
        "capo_mediaconvert.types.avc_intra_framerate_conversion_algorithm.AvcIntraFramerateConversionAlgorithm"
    ]
    ...
    interlace_mode: NotRequired[
        "capo_mediaconvert.types.avc_intra_interlace_mode.AvcIntraInterlaceMode"
    ]
    ...
    scan_type_conversion_mode: NotRequired[
        "capo_mediaconvert.types.avc_intra_scan_type_conversion_mode.AvcIntraScanTypeConversionMode"
    ]
    ...
    slow_pal: NotRequired["capo_mediaconvert.types.avc_intra_slow_pal.AvcIntraSlowPal"]
    """Ignore this setting unless your input frame rate is 23.976 or 24 frames per second (fps). Enable slow PAL to create a 25 fps output. When you enable slow PAL, MediaConvert relabels the video frames to 25 fps and resamples your audio to keep it synchronized with the video. Note that enabling this setting will slightly reduce the duration of your video. Required settings: You must also set Framerate to 25."""
    telecine: NotRequired["capo_mediaconvert.types.avc_intra_telecine.AvcIntraTelecine"]
...
def serialize_json(value: AvcIntraSettings) -> dict:
    ...
    if "avc_intra_class" in value:
        ...
        out["avcIntraClass"] = capo_mediaconvert.types.avc_intra_class.serialize_json(
    ...
    if "avc_intra_uhd_settings" in value:
        ...
        out["avcIntraUhdSettings"] = (
            capo_mediaconvert.types.avc_intra_uhd_settings.serialize_json(
    ...
    if "framerate_control" in value:
        ...
        out["framerateControl"] = (
            capo_mediaconvert.types.avc_intra_framerate_control.serialize_json(
    ...
    if "framerate_conversion_algorithm" in value:
        ...
        out["framerateConversionAlgorithm"] = (
            capo_mediaconvert.types.avc_intra_framerate_conversion_algorithm.serialize_json(
    ...
    if "interlace_mode" in value:
        ...
        out["interlaceMode"] = (
            capo_mediaconvert.types.avc_intra_interlace_mode.serialize_json(
    ...
    if "scan_type_conversion_mode" in value:
        ...
        out["scanTypeConversionMode"] = (
            capo_mediaconvert.types.avc_intra_scan_type_conversion_mode.serialize_json(
    ...
    if "slow_pal" in value:
        ...
        out["slowPal"] = capo_mediaconvert.types.avc_intra_slow_pal.serialize_json(
            value["slow_pal"]
        )
    if "telecine" in value:
        import capo_mediaconvert.types.avc_intra_telecine

        out["telecine"] = capo_mediaconvert.types.avc_intra_telecine.serialize_json(
            value["telecine"]
        )
    return out
...
def deserialize_json(data: dict) -> AvcIntraSettings:
    ...
    if "avcIntraClass" in data:
        ...
        out["avc_intra_class"] = (
            capo_mediaconvert.types.avc_intra_class.deserialize_json(
                data["avcIntraClass"]
            )
        )
    if "avcIntraUhdSettings" in data:
        ...
        out["avc_intra_uhd_settings"] = (
            capo_mediaconvert.types.avc_intra_uhd_settings.deserialize_json(
    ...
    if "framerateControl" in data:
        ...
        out["framerate_control"] = (
            capo_mediaconvert.types.avc_intra_framerate_control.deserialize_json(
    ...
    if "framerateConversionAlgorithm" in data:
        ...
        out["framerate_conversion_algorithm"] = (
            capo_mediaconvert.types.avc_intra_framerate_conversion_algorithm.deserialize_json(
    ...
    if "interlaceMode" in data:
        ...
        out["interlace_mode"] = (
            capo_mediaconvert.types.avc_intra_interlace_mode.deserialize_json(
                data["interlaceMode"]
            )
        )
    ...
    if "scanTypeConversionMode" in data:
        ...
        out["scan_type_conversion_mode"] = (
            capo_mediaconvert.types.avc_intra_scan_type_conversion_mode.deserialize_json(
