...
if TYPE_CHECKING:
    import capo_mediaconvert.types.__string_min14_pattern_s3_bmp_bmp_png_png_https_bmp_bmp_png_png


class AvailBlanking(TypedDict, closed=True):
    avail_blanking_image: NotRequired[
        "capo_mediaconvert.types.__string_min14_pattern_s3_bmp_bmp_png_png_https_bmp_bmp_png_png.__stringMin14PatternS3BmpBMPPngPNGHttpsBmpBMPPngPNG"
    ]
