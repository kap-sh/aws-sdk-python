...
class AncillarySourceSettings(TypedDict, closed=True):
    convert608_to708: NotRequired[
        "capo_mediaconvert.types.ancillary_convert608_to708.AncillaryConvert608To708"
    ]
    ...
    terminate_captions: NotRequired[
        "capo_mediaconvert.types.ancillary_terminate_captions.AncillaryTerminateCaptions"
    ]
...
def serialize_json(value: AncillarySourceSettings) -> dict:
    ...
    if "convert608_to708" in value:
        ...
        out["convert608To708"] = (
            capo_mediaconvert.types.ancillary_convert608_to708.serialize_json(
    ...
    if "terminate_captions" in value:
        ...
        out["terminateCaptions"] = (
            capo_mediaconvert.types.ancillary_terminate_captions.serialize_json(
...
def deserialize_json(data: dict) -> AncillarySourceSettings:
    ...
    if "convert608To708" in data:
        ...
        out["convert608_to708"] = (
            capo_mediaconvert.types.ancillary_convert608_to708.deserialize_json(
    ...
    if "terminateCaptions" in data:
        ...
        out["terminate_captions"] = (
            capo_mediaconvert.types.ancillary_terminate_captions.deserialize_json(
