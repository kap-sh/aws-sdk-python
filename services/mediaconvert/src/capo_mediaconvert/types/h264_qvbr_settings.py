...
if TYPE_CHECKING:
    import capo_mediaconvert.types.__double_min0_max1
    import capo_mediaconvert.types.__integer_min1_max10
...
class H264QvbrSettings(TypedDict, closed=True):
    ...
    qvbr_quality_level: NotRequired[
        "capo_mediaconvert.types.__integer_min1_max10.__integerMin1Max10"
    ]
    ...
    qvbr_quality_level_fine_tune: NotRequired[
        "capo_mediaconvert.types.__double_min0_max1.__doubleMin0Max1"
    ]
