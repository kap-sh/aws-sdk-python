...
if TYPE_CHECKING:
    ...
    import capo_mediaconvert.types.__integer_min90_max105
    import capo_mediaconvert.types.__integer_min920_max1023
    import capo_mediaconvert.types.__integer_min_negative5_max10


class ClipLimits(TypedDict, closed=True):
    maximum_rgb_tolerance: NotRequired[
        "capo_mediaconvert.types.__integer_min90_max105.__integerMin90Max105"
    ]
    ...
    maximum_yuv: NotRequired[
        "capo_mediaconvert.types.__integer_min920_max1023.__integerMin920Max1023"
    ]
    ...
    minimum_rgb_tolerance: NotRequired[
        "capo_mediaconvert.types.__integer_min_negative5_max10.__integerMinNegative5Max10"
    ]
