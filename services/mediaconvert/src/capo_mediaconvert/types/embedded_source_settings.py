...
if TYPE_CHECKING:
    import capo_mediaconvert.types.__integer_min1_max1
    import capo_mediaconvert.types.__integer_min1_max4
...
class EmbeddedSourceSettings(TypedDict, closed=True):
    convert608_to708: NotRequired[
        "capo_mediaconvert.types.embedded_convert608_to708.EmbeddedConvert608To708"
    ]
    ...
    source608_channel_number: NotRequired[
        "capo_mediaconvert.types.__integer_min1_max4.__integerMin1Max4"
    ]
    """Specifies the 608/708 channel number within the video track from which to extract captions. Unused for passthrough."""
    source608_track_number: NotRequired[
        "capo_mediaconvert.types.__integer_min1_max1.__integerMin1Max1"
    ]
    """Specifies the video track index used for extracting captions. The system only supports one input video track, so this should always be set to '1'."""
    terminate_captions: NotRequired[
        "capo_mediaconvert.types.embedded_terminate_captions.EmbeddedTerminateCaptions"
    ]
...
def serialize_json(value: EmbeddedSourceSettings) -> dict:
    ...
    if "convert608_to708" in value:
        ...
        out["convert608To708"] = (
            capo_mediaconvert.types.embedded_convert608_to708.serialize_json(
    ...
    if "terminate_captions" in value:
        ...
        out["terminateCaptions"] = (
            capo_mediaconvert.types.embedded_terminate_captions.serialize_json(
...
def deserialize_json(data: dict) -> EmbeddedSourceSettings:
    ...
    if "convert608To708" in data:
        ...
        out["convert608_to708"] = (
            capo_mediaconvert.types.embedded_convert608_to708.deserialize_json(
    ...
    if "terminateCaptions" in data:
        ...
        out["terminate_captions"] = (
            capo_mediaconvert.types.embedded_terminate_captions.deserialize_json(
