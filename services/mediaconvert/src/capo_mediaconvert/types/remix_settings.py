...
if TYPE_CHECKING:
    import capo_mediaconvert.types.__integer_min1_max64
...
class RemixSettings(TypedDict, closed=True):
    audio_description_audio_channel: NotRequired[
        "capo_mediaconvert.types.__integer_min1_max64.__integerMin1Max64"
    ]
    ...
    channel_mapping: NotRequired[
        "capo_mediaconvert.types.channel_mapping.ChannelMapping"
    ]
...
def serialize_json(value: RemixSettings) -> dict:
    ...
    if "channel_mapping" in value:
        ...
        out["channelMapping"] = capo_mediaconvert.types.channel_mapping.serialize_json(
...
def deserialize_json(data: dict) -> RemixSettings:
    ...
    if "channelMapping" in data:
        ...
        out["channel_mapping"] = (
            capo_mediaconvert.types.channel_mapping.deserialize_json(
                data["channelMapping"]
            )
        )
