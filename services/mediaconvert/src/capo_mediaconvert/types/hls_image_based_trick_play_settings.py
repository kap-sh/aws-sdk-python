...
if TYPE_CHECKING:
    ...
    import capo_mediaconvert.types.hls_interval_cadence


class HlsImageBasedTrickPlaySettings(TypedDict, closed=True):
    interval_cadence: NotRequired[
        "capo_mediaconvert.types.hls_interval_cadence.HlsIntervalCadence"
    ]
...
def serialize_json(value: HlsImageBasedTrickPlaySettings) -> dict:
    ...
    if "interval_cadence" in value:
        ...
        out["intervalCadence"] = (
            capo_mediaconvert.types.hls_interval_cadence.serialize_json(
...
def deserialize_json(data: dict) -> HlsImageBasedTrickPlaySettings:
    ...
    if "intervalCadence" in data:
        ...
        out["interval_cadence"] = (
            capo_mediaconvert.types.hls_interval_cadence.deserialize_json(
