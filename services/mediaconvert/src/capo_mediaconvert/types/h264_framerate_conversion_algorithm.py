"""Generated from Smithy shape ``com.amazonaws.mediaconvert#H264FramerateConversionAlgorithm``."""
...
H264FramerateConversionAlgorithm: TypeAlias = Literal[
    "DUPLICATE_DROP",
    "INTERPOLATE",
    "FRAMEFORMER",
...
# --- restJson1 ser/de ---
def serialize_json(value: H264FramerateConversionAlgorithm) -> str:
    return value


def deserialize_json(data: str) -> H264FramerateConversionAlgorithm:
    return cast(H264FramerateConversionAlgorithm, data)
