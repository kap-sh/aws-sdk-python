...
if TYPE_CHECKING:
    import capo_mediaconvert.types.id3_insertion

__listOfId3Insertion: TypeAlias = list[
    "capo_mediaconvert.types.id3_insertion.Id3Insertion"
]
...
def serialize_json(value: __listOfId3Insertion) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_mediaconvert.types.id3_insertion.serialize_json(item))
    return out
