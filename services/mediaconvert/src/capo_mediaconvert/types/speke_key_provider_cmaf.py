...
if TYPE_CHECKING:
    ...
    import capo_mediaconvert.types.__string_pattern_arn_aws_us_gov_acm
    import capo_mediaconvert.types.__string_pattern_https_d
    import capo_mediaconvert.types.__string_pattern_w
    import capo_mediaconvert.types.encryption_contract_configuration


class SpekeKeyProviderCmaf(TypedDict, closed=True):
    certificate_arn: NotRequired[
        "capo_mediaconvert.types.__string_pattern_arn_aws_us_gov_acm.__stringPatternArnAwsUsGovAcm"
    ]
    """If you want your key provider to encrypt the content keys that it provides to MediaConvert, set up a certificate with a master key using AWS Certificate Manager. Specify the certificate's Amazon Resource Name (ARN) here."""
    dash_signaled_system_ids: NotRequired[
        "capo_mediaconvert.types.__list_of__string_min36_max36_pattern09a_faf809a_faf409a_faf409a_faf409a_faf12.__listOf__stringMin36Max36Pattern09aFAF809aFAF409aFAF409aFAF409aFAF12"
    ]
    """Specify the DRM system IDs that you want signaled in the DASH manifest that MediaConvert creates as part of this CMAF package. The DASH manifest can currently signal up to three system IDs. For more information, see https://dashif.org/identifiers/content_protection/."""
    encryption_contract_configuration: NotRequired[
        "capo_mediaconvert.types.encryption_contract_configuration.EncryptionContractConfiguration"
    ]
    ...
    resource_id: NotRequired[
        "capo_mediaconvert.types.__string_pattern_w.__stringPatternW"
    ]
    """Specify the resource ID that your SPEKE-compliant key provider uses to identify this content."""
    url: NotRequired[
        "capo_mediaconvert.types.__string_pattern_https_d.__stringPatternHttpsD"
    ]
...
def serialize_json(value: SpekeKeyProviderCmaf) -> dict:
    ...
    if "dash_signaled_system_ids" in value:
        ...
        out["dashSignaledSystemIds"] = (
            capo_mediaconvert.types.__list_of__string_min36_max36_pattern09a_faf809a_faf409a_faf409a_faf409a_faf12.serialize_json(
    ...
    if "encryption_contract_configuration" in value:
        ...
        out["encryptionContractConfiguration"] = (
            capo_mediaconvert.types.encryption_contract_configuration.serialize_json(
...
def deserialize_json(data: dict) -> SpekeKeyProviderCmaf:
    ...
    if "dashSignaledSystemIds" in data:
        ...
        out["dash_signaled_system_ids"] = (
            capo_mediaconvert.types.__list_of__string_min36_max36_pattern09a_faf809a_faf409a_faf409a_faf409a_faf12.deserialize_json(
    ...
    if "encryptionContractConfiguration" in data:
        ...
        out["encryption_contract_configuration"] = (
            capo_mediaconvert.types.encryption_contract_configuration.deserialize_json(
