...
if TYPE_CHECKING:
    import capo_mediaconvert.types.__integer_min0_max65534
    import capo_mediaconvert.types.__string_min1_max20
    import capo_mediaconvert.types.__string_min1_max50
    import capo_mediaconvert.types.__string_pattern0x_a_fa_f0908190908
    import capo_mediaconvert.types.__string_pattern_https
...
class NielsenNonLinearWatermarkSettings(TypedDict, closed=True):
    active_watermark_process: NotRequired[
        "capo_mediaconvert.types.nielsen_active_watermark_process_type.NielsenActiveWatermarkProcessType"
    ]
    ...
    cbet_source_id: NotRequired[
        "capo_mediaconvert.types.__string_pattern0x_a_fa_f0908190908.__stringPattern0xAFaF0908190908"
    ]
    ...
    source_id: NotRequired[
        "capo_mediaconvert.types.__integer_min0_max65534.__integerMin0Max65534"
    ]
    ...
    source_watermark_status: NotRequired[
        "capo_mediaconvert.types.nielsen_source_watermark_status_type.NielsenSourceWatermarkStatusType"
    ]
    ...
    tic_server_url: NotRequired[
        "capo_mediaconvert.types.__string_pattern_https.__stringPatternHttps"
    ]
    ...
    unique_tic_per_audio_track: NotRequired[
        "capo_mediaconvert.types.nielsen_unique_tic_per_audio_track_type.NielsenUniqueTicPerAudioTrackType"
    ]
...
def serialize_json(value: NielsenNonLinearWatermarkSettings) -> dict:
    ...
    if "active_watermark_process" in value:
        ...
        out["activeWatermarkProcess"] = (
            capo_mediaconvert.types.nielsen_active_watermark_process_type.serialize_json(
    ...
    if "source_watermark_status" in value:
        ...
        out["sourceWatermarkStatus"] = (
            capo_mediaconvert.types.nielsen_source_watermark_status_type.serialize_json(
    ...
    if "unique_tic_per_audio_track" in value:
        ...
        out["uniqueTicPerAudioTrack"] = (
            capo_mediaconvert.types.nielsen_unique_tic_per_audio_track_type.serialize_json(
...
def deserialize_json(data: dict) -> NielsenNonLinearWatermarkSettings:
    ...
    if "activeWatermarkProcess" in data:
        ...
        out["active_watermark_process"] = (
            capo_mediaconvert.types.nielsen_active_watermark_process_type.deserialize_json(
    ...
    if "sourceWatermarkStatus" in data:
        ...
        out["source_watermark_status"] = (
            capo_mediaconvert.types.nielsen_source_watermark_status_type.deserialize_json(
    ...
    if "uniqueTicPerAudioTrack" in data:
        ...
        out["unique_tic_per_audio_track"] = (
            capo_mediaconvert.types.nielsen_unique_tic_per_audio_track_type.deserialize_json(
