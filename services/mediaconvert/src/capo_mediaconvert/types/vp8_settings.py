...
class Vp8Settings(TypedDict, closed=True):
    ...
    framerate_control: NotRequired[
        "capo_mediaconvert.types.vp8_framerate_control.Vp8FramerateControl"
    ]
    ...
    framerate_conversion_algorithm: NotRequired[
        "capo_mediaconvert.types.vp8_framerate_conversion_algorithm.Vp8FramerateConversionAlgorithm"
    ]
    ...
    par_control: NotRequired["capo_mediaconvert.types.vp8_par_control.Vp8ParControl"]
    ...
    quality_tuning_level: NotRequired[
        "capo_mediaconvert.types.vp8_quality_tuning_level.Vp8QualityTuningLevel"
    ]
    ...
    rate_control_mode: NotRequired[
        "capo_mediaconvert.types.vp8_rate_control_mode.Vp8RateControlMode"
    ]
    """With the VP8 codec, you can use only the variable bitrate (VBR) rate control mode."""


# --- restJson1 ser/de ---
def serialize_json(value: Vp8Settings) -> dict:
    out: dict = {}
    if "bitrate" in value:
    ...
    if "framerate_control" in value:
        ...
        out["framerateControl"] = (
            capo_mediaconvert.types.vp8_framerate_control.serialize_json(
    ...
    if "framerate_conversion_algorithm" in value:
        ...
        out["framerateConversionAlgorithm"] = (
            capo_mediaconvert.types.vp8_framerate_conversion_algorithm.serialize_json(
    ...
    if "par_control" in value:
        ...
        out["parControl"] = capo_mediaconvert.types.vp8_par_control.serialize_json(
            value["par_control"]
        )
    ...
    if "quality_tuning_level" in value:
        ...
        out["qualityTuningLevel"] = (
            capo_mediaconvert.types.vp8_quality_tuning_level.serialize_json(
    ...
    if "rate_control_mode" in value:
        ...
        out["rateControlMode"] = (
            capo_mediaconvert.types.vp8_rate_control_mode.serialize_json(
...
def deserialize_json(data: dict) -> Vp8Settings:
    ...
    if "framerateControl" in data:
        ...
        out["framerate_control"] = (
            capo_mediaconvert.types.vp8_framerate_control.deserialize_json(
    ...
    if "framerateConversionAlgorithm" in data:
        ...
        out["framerate_conversion_algorithm"] = (
            capo_mediaconvert.types.vp8_framerate_conversion_algorithm.deserialize_json(
    ...
    if "qualityTuningLevel" in data:
        ...
        out["quality_tuning_level"] = (
            capo_mediaconvert.types.vp8_quality_tuning_level.deserialize_json(
    ...
    if "rateControlMode" in data:
        ...
        out["rate_control_mode"] = (
            capo_mediaconvert.types.vp8_rate_control_mode.deserialize_json(
