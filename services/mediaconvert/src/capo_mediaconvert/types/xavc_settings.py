...
class XavcSettings(TypedDict, closed=True):
    adaptive_quantization: NotRequired[
        "capo_mediaconvert.types.xavc_adaptive_quantization.XavcAdaptiveQuantization"
    ]
    ...
    entropy_encoding: NotRequired[
        "capo_mediaconvert.types.xavc_entropy_encoding.XavcEntropyEncoding"
    ]
    ...
    framerate_control: NotRequired[
        "capo_mediaconvert.types.xavc_framerate_control.XavcFramerateControl"
    ]
    ...
    framerate_conversion_algorithm: NotRequired[
        "capo_mediaconvert.types.xavc_framerate_conversion_algorithm.XavcFramerateConversionAlgorithm"
    ]
    ...
    profile: NotRequired["capo_mediaconvert.types.xavc_profile.XavcProfile"]
    """Specify the XAVC profile for this output. For more information, see the Sony documentation at https://www.xavc-info.org/. Note that MediaConvert doesn't support the interlaced video XAVC operating points for XAVC_HD_INTRA_CBG. To create an interlaced XAVC output, choose the profile XAVC_HD."""
    slow_pal: NotRequired["capo_mediaconvert.types.xavc_slow_pal.XavcSlowPal"]
    ...
    spatial_adaptive_quantization: NotRequired[
        "capo_mediaconvert.types.xavc_spatial_adaptive_quantization.XavcSpatialAdaptiveQuantization"
    ]
    ...
    temporal_adaptive_quantization: NotRequired[
        "capo_mediaconvert.types.xavc_temporal_adaptive_quantization.XavcTemporalAdaptiveQuantization"
    ]
    ...
    xavc4k_intra_cbg_profile_settings: NotRequired[
        "capo_mediaconvert.types.xavc4k_intra_cbg_profile_settings.Xavc4kIntraCbgProfileSettings"
    ]
    """Required when you set Profile to the value XAVC_4K_INTRA_CBG."""
    xavc4k_intra_vbr_profile_settings: NotRequired[
        "capo_mediaconvert.types.xavc4k_intra_vbr_profile_settings.Xavc4kIntraVbrProfileSettings"
    ]
    """Required when you set Profile to the value XAVC_4K_INTRA_VBR."""
    xavc4k_profile_settings: NotRequired[
        "capo_mediaconvert.types.xavc4k_profile_settings.Xavc4kProfileSettings"
    ]
    """Required when you set Profile to the value XAVC_4K."""
    xavc_hd_intra_cbg_profile_settings: NotRequired[
        "capo_mediaconvert.types.xavc_hd_intra_cbg_profile_settings.XavcHdIntraCbgProfileSettings"
    ]
    """Required when you set Profile to the value XAVC_HD_INTRA_CBG."""
    xavc_hd_profile_settings: NotRequired[
        "capo_mediaconvert.types.xavc_hd_profile_settings.XavcHdProfileSettings"
    ]
...
def serialize_json(value: XavcSettings) -> dict:
    ...
    if "adaptive_quantization" in value:
        ...
        out["adaptiveQuantization"] = (
            capo_mediaconvert.types.xavc_adaptive_quantization.serialize_json(
    ...
    if "entropy_encoding" in value:
        ...
        out["entropyEncoding"] = (
            capo_mediaconvert.types.xavc_entropy_encoding.serialize_json(
    ...
    if "framerate_control" in value:
        ...
        out["framerateControl"] = (
            capo_mediaconvert.types.xavc_framerate_control.serialize_json(
    ...
    if "framerate_conversion_algorithm" in value:
        ...
        out["framerateConversionAlgorithm"] = (
            capo_mediaconvert.types.xavc_framerate_conversion_algorithm.serialize_json(
    ...
    if "profile" in value:
        ...
        out["profile"] = capo_mediaconvert.types.xavc_profile.serialize_json(
            value["profile"]
        )
    if "slow_pal" in value:
        import capo_mediaconvert.types.xavc_slow_pal

        out["slowPal"] = capo_mediaconvert.types.xavc_slow_pal.serialize_json(
            value["slow_pal"]
        )
    ...
    if "spatial_adaptive_quantization" in value:
        ...
        out["spatialAdaptiveQuantization"] = (
            capo_mediaconvert.types.xavc_spatial_adaptive_quantization.serialize_json(
    ...
    if "temporal_adaptive_quantization" in value:
        ...
        out["temporalAdaptiveQuantization"] = (
            capo_mediaconvert.types.xavc_temporal_adaptive_quantization.serialize_json(
    ...
    if "xavc4k_intra_cbg_profile_settings" in value:
        ...
        out["xavc4kIntraCbgProfileSettings"] = (
            capo_mediaconvert.types.xavc4k_intra_cbg_profile_settings.serialize_json(
    ...
    if "xavc4k_intra_vbr_profile_settings" in value:
        ...
        out["xavc4kIntraVbrProfileSettings"] = (
            capo_mediaconvert.types.xavc4k_intra_vbr_profile_settings.serialize_json(
    ...
    if "xavc4k_profile_settings" in value:
        ...
        out["xavc4kProfileSettings"] = (
            capo_mediaconvert.types.xavc4k_profile_settings.serialize_json(
    ...
    if "xavc_hd_intra_cbg_profile_settings" in value:
        ...
        out["xavcHdIntraCbgProfileSettings"] = (
            capo_mediaconvert.types.xavc_hd_intra_cbg_profile_settings.serialize_json(
    ...
    if "xavc_hd_profile_settings" in value:
        ...
        out["xavcHdProfileSettings"] = (
            capo_mediaconvert.types.xavc_hd_profile_settings.serialize_json(
...
def deserialize_json(data: dict) -> XavcSettings:
    ...
    if "adaptiveQuantization" in data:
        ...
        out["adaptive_quantization"] = (
            capo_mediaconvert.types.xavc_adaptive_quantization.deserialize_json(
    ...
    if "entropyEncoding" in data:
        ...
        out["entropy_encoding"] = (
            capo_mediaconvert.types.xavc_entropy_encoding.deserialize_json(
    ...
    if "framerateControl" in data:
        ...
        out["framerate_control"] = (
            capo_mediaconvert.types.xavc_framerate_control.deserialize_json(
    ...
    if "framerateConversionAlgorithm" in data:
        ...
        out["framerate_conversion_algorithm"] = (
            capo_mediaconvert.types.xavc_framerate_conversion_algorithm.deserialize_json(
    ...
    if "spatialAdaptiveQuantization" in data:
        ...
        out["spatial_adaptive_quantization"] = (
            capo_mediaconvert.types.xavc_spatial_adaptive_quantization.deserialize_json(
    ...
    if "temporalAdaptiveQuantization" in data:
        ...
        out["temporal_adaptive_quantization"] = (
            capo_mediaconvert.types.xavc_temporal_adaptive_quantization.deserialize_json(
    ...
    if "xavc4kIntraCbgProfileSettings" in data:
        ...
        out["xavc4k_intra_cbg_profile_settings"] = (
            capo_mediaconvert.types.xavc4k_intra_cbg_profile_settings.deserialize_json(
    ...
    if "xavc4kIntraVbrProfileSettings" in data:
        ...
        out["xavc4k_intra_vbr_profile_settings"] = (
            capo_mediaconvert.types.xavc4k_intra_vbr_profile_settings.deserialize_json(
    ...
    if "xavc4kProfileSettings" in data:
        ...
        out["xavc4k_profile_settings"] = (
            capo_mediaconvert.types.xavc4k_profile_settings.deserialize_json(
    ...
    if "xavcHdIntraCbgProfileSettings" in data:
        ...
        out["xavc_hd_intra_cbg_profile_settings"] = (
            capo_mediaconvert.types.xavc_hd_intra_cbg_profile_settings.deserialize_json(
    ...
    if "xavcHdProfileSettings" in data:
        ...
        out["xavc_hd_profile_settings"] = (
            capo_mediaconvert.types.xavc_hd_profile_settings.deserialize_json(
