...
if TYPE_CHECKING:
    import capo_mediaconvert.types.__double_min0_max2147483647
    ...
    import capo_mediaconvert.types.__list_of_hls_ad_markers
    import capo_mediaconvert.types.__list_of_hls_additional_manifest
    import capo_mediaconvert.types.__list_of_hls_caption_language_mapping
    import capo_mediaconvert.types.__list_of_hls_image_based_trick_play_variant
    ...
    import capo_mediaconvert.types.hls_audio_only_header
    import capo_mediaconvert.types.hls_caption_language_setting
    import capo_mediaconvert.types.hls_caption_segment_length_control
    import capo_mediaconvert.types.hls_client_cache
    import capo_mediaconvert.types.hls_codec_specification
    import capo_mediaconvert.types.hls_directory_structure
    import capo_mediaconvert.types.hls_encryption_settings
    import capo_mediaconvert.types.hls_image_based_trick_play
    import capo_mediaconvert.types.hls_image_based_trick_play_settings
    import capo_mediaconvert.types.hls_manifest_compression
    import capo_mediaconvert.types.hls_manifest_duration_format
    import capo_mediaconvert.types.hls_output_selection
    import capo_mediaconvert.types.hls_program_date_time
    import capo_mediaconvert.types.hls_progressive_write_hls_manifest
    import capo_mediaconvert.types.hls_segment_control
    import capo_mediaconvert.types.hls_segment_length_control
    import capo_mediaconvert.types.hls_stream_inf_resolution
    import capo_mediaconvert.types.hls_target_duration_compatibility_mode
    import capo_mediaconvert.types.hls_timed_metadata_id3_frame


class HlsGroupSettings(TypedDict, closed=True):
    ad_markers: NotRequired[
        "capo_mediaconvert.types.__list_of_hls_ad_markers.__listOfHlsAdMarkers"
    ]
    """Choose one or more ad marker types to decorate your Apple HLS manifest. This setting does not determine whether SCTE-35 markers appear in the outputs themselves."""
    additional_manifests: NotRequired[
        "capo_mediaconvert.types.__list_of_hls_additional_manifest.__listOfHlsAdditionalManifest"
    ]
    """By default, the service creates one top-level .m3u8 HLS manifest for each HLS output group in your job. This default manifest references every output in the output group. To create additional top-level manifests that reference a subset of the outputs in the output group, specify a list of them here."""
    audio_only_header: NotRequired[
        "capo_mediaconvert.types.hls_audio_only_header.HlsAudioOnlyHeader"
    ]
    ...
    base_url: NotRequired["capo_mediaconvert.types.__string.__string"]
    """A partial URI prefix that will be prepended to each output in the media .m3u8 file. Can be used if base manifest is delivered from a different URL than the main .m3u8 file."""
    caption_language_mappings: NotRequired[
        "capo_mediaconvert.types.__list_of_hls_caption_language_mapping.__listOfHlsCaptionLanguageMapping"
    ]
    """Language to be used on Caption outputs"""
    caption_language_setting: NotRequired[
        "capo_mediaconvert.types.hls_caption_language_setting.HlsCaptionLanguageSetting"
    ]
    ...
    caption_segment_length_control: NotRequired[
        "capo_mediaconvert.types.hls_caption_segment_length_control.HlsCaptionSegmentLengthControl"
    ]
    ...
    client_cache: NotRequired["capo_mediaconvert.types.hls_client_cache.HlsClientCache"]
    ...
    codec_specification: NotRequired[
        "capo_mediaconvert.types.hls_codec_specification.HlsCodecSpecification"
    ]
    ...
    directory_structure: NotRequired[
        "capo_mediaconvert.types.hls_directory_structure.HlsDirectoryStructure"
    ]
    """Indicates whether segments should be placed in subdirectories."""
    encryption: NotRequired[
        "capo_mediaconvert.types.hls_encryption_settings.HlsEncryptionSettings"
    ]
    """DRM settings."""
    image_based_trick_play: NotRequired[
        "capo_mediaconvert.types.hls_image_based_trick_play.HlsImageBasedTrickPlay"
    ]
    ...
    image_based_trick_play_settings: NotRequired[
        "capo_mediaconvert.types.hls_image_based_trick_play_settings.HlsImageBasedTrickPlaySettings"
    ]
    """Tile and thumbnail settings applicable when imageBasedTrickPlay is ADVANCED"""
    image_based_trick_play_variants: NotRequired[
        "capo_mediaconvert.types.__list_of_hls_image_based_trick_play_variant.__listOfHlsImageBasedTrickPlayVariant"
    ]
    ...
    manifest_compression: NotRequired[
        "capo_mediaconvert.types.hls_manifest_compression.HlsManifestCompression"
    ]
    """When set to GZIP, compresses HLS playlist."""
    manifest_duration_format: NotRequired[
        "capo_mediaconvert.types.hls_manifest_duration_format.HlsManifestDurationFormat"
    ]
    ...
    output_selection: NotRequired[
        "capo_mediaconvert.types.hls_output_selection.HlsOutputSelection"
    ]
    """Indicates whether the .m3u8 manifest file should be generated for this HLS output group."""
    program_date_time: NotRequired[
        "capo_mediaconvert.types.hls_program_date_time.HlsProgramDateTime"
    ]
    ...
    progressive_write_hls_manifest: NotRequired[
        "capo_mediaconvert.types.hls_progressive_write_hls_manifest.HlsProgressiveWriteHlsManifest"
    ]
    ...
    segment_control: NotRequired[
        "capo_mediaconvert.types.hls_segment_control.HlsSegmentControl"
    ]
    ...
    segment_length_control: NotRequired[
        "capo_mediaconvert.types.hls_segment_length_control.HlsSegmentLengthControl"
    ]
    ...
    stream_inf_resolution: NotRequired[
        "capo_mediaconvert.types.hls_stream_inf_resolution.HlsStreamInfResolution"
    ]
    """Include or exclude RESOLUTION attribute for video in EXT-X-STREAM-INF tag of variant manifest."""
    target_duration_compatibility_mode: NotRequired[
        "capo_mediaconvert.types.hls_target_duration_compatibility_mode.HlsTargetDurationCompatibilityMode"
    ]
    ...
    timed_metadata_id3_frame: NotRequired[
        "capo_mediaconvert.types.hls_timed_metadata_id3_frame.HlsTimedMetadataId3Frame"
    ]
...
def serialize_json(value: HlsGroupSettings) -> dict:
    ...
    if "ad_markers" in value:
        ...
        out["adMarkers"] = (
            capo_mediaconvert.types.__list_of_hls_ad_markers.serialize_json(
                value["ad_markers"]
            )
        )
    if "additional_manifests" in value:
        ...
        out["additionalManifests"] = (
            capo_mediaconvert.types.__list_of_hls_additional_manifest.serialize_json(
    ...
    if "audio_only_header" in value:
        ...
        out["audioOnlyHeader"] = (
            capo_mediaconvert.types.hls_audio_only_header.serialize_json(
    ...
    if "caption_language_mappings" in value:
        ...
        out["captionLanguageMappings"] = (
            capo_mediaconvert.types.__list_of_hls_caption_language_mapping.serialize_json(
    ...
    if "caption_language_setting" in value:
        ...
        out["captionLanguageSetting"] = (
            capo_mediaconvert.types.hls_caption_language_setting.serialize_json(
    ...
    if "caption_segment_length_control" in value:
        ...
        out["captionSegmentLengthControl"] = (
            capo_mediaconvert.types.hls_caption_segment_length_control.serialize_json(
    ...
    if "client_cache" in value:
        ...
        out["clientCache"] = capo_mediaconvert.types.hls_client_cache.serialize_json(
            value["client_cache"]
        )
    if "codec_specification" in value:
        ...
        out["codecSpecification"] = (
            capo_mediaconvert.types.hls_codec_specification.serialize_json(
    ...
    if "directory_structure" in value:
        ...
        out["directoryStructure"] = (
            capo_mediaconvert.types.hls_directory_structure.serialize_json(
    ...
    if "encryption" in value:
        ...
        out["encryption"] = (
            capo_mediaconvert.types.hls_encryption_settings.serialize_json(
                value["encryption"]
            )
        )
    if "image_based_trick_play" in value:
        ...
        out["imageBasedTrickPlay"] = (
            capo_mediaconvert.types.hls_image_based_trick_play.serialize_json(
    ...
    if "image_based_trick_play_settings" in value:
        ...
        out["imageBasedTrickPlaySettings"] = (
            capo_mediaconvert.types.hls_image_based_trick_play_settings.serialize_json(
    ...
    if "image_based_trick_play_variants" in value:
        ...
        out["imageBasedTrickPlayVariants"] = (
            capo_mediaconvert.types.__list_of_hls_image_based_trick_play_variant.serialize_json(
    ...
    if "manifest_compression" in value:
        ...
        out["manifestCompression"] = (
            capo_mediaconvert.types.hls_manifest_compression.serialize_json(
    ...
    if "manifest_duration_format" in value:
        ...
        out["manifestDurationFormat"] = (
            capo_mediaconvert.types.hls_manifest_duration_format.serialize_json(
    ...
    if "output_selection" in value:
        ...
        out["outputSelection"] = (
            capo_mediaconvert.types.hls_output_selection.serialize_json(
    ...
    if "program_date_time" in value:
        ...
        out["programDateTime"] = (
            capo_mediaconvert.types.hls_program_date_time.serialize_json(
    ...
    if "progressive_write_hls_manifest" in value:
        ...
        out["progressiveWriteHlsManifest"] = (
            capo_mediaconvert.types.hls_progressive_write_hls_manifest.serialize_json(
    ...
    if "segment_control" in value:
        ...
        out["segmentControl"] = (
            capo_mediaconvert.types.hls_segment_control.serialize_json(
    ...
    if "segment_length_control" in value:
        ...
        out["segmentLengthControl"] = (
            capo_mediaconvert.types.hls_segment_length_control.serialize_json(
    ...
    if "stream_inf_resolution" in value:
        ...
        out["streamInfResolution"] = (
            capo_mediaconvert.types.hls_stream_inf_resolution.serialize_json(
    ...
    if "target_duration_compatibility_mode" in value:
        ...
        out["targetDurationCompatibilityMode"] = (
            capo_mediaconvert.types.hls_target_duration_compatibility_mode.serialize_json(
    ...
    if "timed_metadata_id3_frame" in value:
        ...
        out["timedMetadataId3Frame"] = (
            capo_mediaconvert.types.hls_timed_metadata_id3_frame.serialize_json(
...
def deserialize_json(data: dict) -> HlsGroupSettings:
    ...
    if "adMarkers" in data:
        ...
        out["ad_markers"] = (
            capo_mediaconvert.types.__list_of_hls_ad_markers.deserialize_json(
                data["adMarkers"]
            )
        )
    if "additionalManifests" in data:
        ...
        out["additional_manifests"] = (
            capo_mediaconvert.types.__list_of_hls_additional_manifest.deserialize_json(
    ...
    if "audioOnlyHeader" in data:
        ...
        out["audio_only_header"] = (
            capo_mediaconvert.types.hls_audio_only_header.deserialize_json(
    ...
    if "captionLanguageMappings" in data:
        ...
        out["caption_language_mappings"] = (
            capo_mediaconvert.types.__list_of_hls_caption_language_mapping.deserialize_json(
    ...
    if "captionLanguageSetting" in data:
        ...
        out["caption_language_setting"] = (
            capo_mediaconvert.types.hls_caption_language_setting.deserialize_json(
    ...
    if "captionSegmentLengthControl" in data:
        ...
        out["caption_segment_length_control"] = (
            capo_mediaconvert.types.hls_caption_segment_length_control.deserialize_json(
    ...
    if "clientCache" in data:
        ...
        out["client_cache"] = capo_mediaconvert.types.hls_client_cache.deserialize_json(
            data["clientCache"]
        )
    if "codecSpecification" in data:
        ...
        out["codec_specification"] = (
            capo_mediaconvert.types.hls_codec_specification.deserialize_json(
    ...
    if "directoryStructure" in data:
        ...
        out["directory_structure"] = (
            capo_mediaconvert.types.hls_directory_structure.deserialize_json(
    ...
    if "encryption" in data:
        ...
        out["encryption"] = (
            capo_mediaconvert.types.hls_encryption_settings.deserialize_json(
                data["encryption"]
            )
        )
    if "imageBasedTrickPlay" in data:
        ...
        out["image_based_trick_play"] = (
            capo_mediaconvert.types.hls_image_based_trick_play.deserialize_json(
    ...
    if "imageBasedTrickPlaySettings" in data:
        ...
        out["image_based_trick_play_settings"] = (
            capo_mediaconvert.types.hls_image_based_trick_play_settings.deserialize_json(
    ...
    if "imageBasedTrickPlayVariants" in data:
        ...
        out["image_based_trick_play_variants"] = (
            capo_mediaconvert.types.__list_of_hls_image_based_trick_play_variant.deserialize_json(
    ...
    if "manifestCompression" in data:
        ...
        out["manifest_compression"] = (
            capo_mediaconvert.types.hls_manifest_compression.deserialize_json(
    ...
    if "manifestDurationFormat" in data:
        ...
        out["manifest_duration_format"] = (
            capo_mediaconvert.types.hls_manifest_duration_format.deserialize_json(
    ...
    if "outputSelection" in data:
        ...
        out["output_selection"] = (
            capo_mediaconvert.types.hls_output_selection.deserialize_json(
    ...
    if "programDateTime" in data:
        ...
        out["program_date_time"] = (
            capo_mediaconvert.types.hls_program_date_time.deserialize_json(
    ...
    if "progressiveWriteHlsManifest" in data:
        ...
        out["progressive_write_hls_manifest"] = (
            capo_mediaconvert.types.hls_progressive_write_hls_manifest.deserialize_json(
    ...
    if "segmentControl" in data:
        ...
        out["segment_control"] = (
            capo_mediaconvert.types.hls_segment_control.deserialize_json(
                data["segmentControl"]
            )
        )
    ...
    if "segmentLengthControl" in data:
        ...
        out["segment_length_control"] = (
            capo_mediaconvert.types.hls_segment_length_control.deserialize_json(
    ...
    if "streamInfResolution" in data:
        ...
        out["stream_inf_resolution"] = (
            capo_mediaconvert.types.hls_stream_inf_resolution.deserialize_json(
    ...
    if "targetDurationCompatibilityMode" in data:
        ...
        out["target_duration_compatibility_mode"] = (
            capo_mediaconvert.types.hls_target_duration_compatibility_mode.deserialize_json(
    ...
    if "timedMetadataId3Frame" in data:
        ...
        out["timed_metadata_id3_frame"] = (
            capo_mediaconvert.types.hls_timed_metadata_id3_frame.deserialize_json(
