...
if TYPE_CHECKING:
    import capo_mediaconvert.types.preset_speke20_audio
    import capo_mediaconvert.types.preset_speke20_video


class EncryptionContractConfiguration(TypedDict, closed=True):
    speke_audio_preset: NotRequired[
        "capo_mediaconvert.types.preset_speke20_audio.PresetSpeke20Audio"
    ]
    ...
    speke_video_preset: NotRequired[
        "capo_mediaconvert.types.preset_speke20_video.PresetSpeke20Video"
    ]
...
def serialize_json(value: EncryptionContractConfiguration) -> dict:
    ...
    if "speke_audio_preset" in value:
        ...
        out["spekeAudioPreset"] = (
            capo_mediaconvert.types.preset_speke20_audio.serialize_json(
    ...
    if "speke_video_preset" in value:
        ...
        out["spekeVideoPreset"] = (
            capo_mediaconvert.types.preset_speke20_video.serialize_json(
...
def deserialize_json(data: dict) -> EncryptionContractConfiguration:
    ...
    if "spekeAudioPreset" in data:
        ...
        out["speke_audio_preset"] = (
            capo_mediaconvert.types.preset_speke20_audio.deserialize_json(
    ...
    if "spekeVideoPreset" in data:
        ...
        out["speke_video_preset"] = (
            capo_mediaconvert.types.preset_speke20_video.deserialize_json(
