"""Generated from Smithy shape ``com.amazonaws.mediaconvert#DashIsoImageBasedTrickPlayVariant``."""
...
if TYPE_CHECKING:
    ...
    import capo_mediaconvert.types.__integer_min2_max4096
    import capo_mediaconvert.types.__integer_min8_max4096
    import capo_mediaconvert.types.dash_iso_interval_cadence


class DashIsoImageBasedTrickPlayVariant(TypedDict, closed=True):
    ...
    thumbnail_height: NotRequired[
        "capo_mediaconvert.types.__integer_min2_max4096.__integerMin2Max4096"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: DashIsoImageBasedTrickPlayVariant) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DashIsoImageBasedTrickPlayVariant:
    out: DashIsoImageBasedTrickPlayVariant = {}  # type: ignore[typeddict-item]
