...
if TYPE_CHECKING:
    import capo_mediaconvert.types.__integer_min0_max64
    import capo_mediaconvert.types.__integer_min16_max24
    import capo_mediaconvert.types.__integer_min8000_max192000
...
class WavSettings(TypedDict, closed=True):
    ...
    channels: NotRequired[
        "capo_mediaconvert.types.__integer_min0_max64.__integerMin0Max64"
    ]
    ...
    format: NotRequired["capo_mediaconvert.types.wav_format.WavFormat"]
    ...
    sample_rate: NotRequired[
        "capo_mediaconvert.types.__integer_min8000_max192000.__integerMin8000Max192000"
    ]
    """Sample rate in Hz."""
...
def serialize_json(value: WavSettings) -> dict:
    ...
    if "format" in value:
        ...
        out["format"] = capo_mediaconvert.types.wav_format.serialize_json(
            value["format"]
        )
