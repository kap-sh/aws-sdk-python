"""Generated from Smithy shape ``com.amazonaws.mediaconvert#XavcTemporalAdaptiveQuantization``."""
...
XavcTemporalAdaptiveQuantization: TypeAlias = Literal[
    "DISABLED",
    "ENABLED",
]
...
# --- restJson1 ser/de ---
def serialize_json(value: XavcTemporalAdaptiveQuantization) -> str:
    return value


def deserialize_json(data: str) -> XavcTemporalAdaptiveQuantization:
    return cast(XavcTemporalAdaptiveQuantization, data)
