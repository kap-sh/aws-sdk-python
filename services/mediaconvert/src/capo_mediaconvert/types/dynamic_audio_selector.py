...
class DynamicAudioSelector(TypedDict, closed=True):
    ...
    selector_type: NotRequired[
        "capo_mediaconvert.types.dynamic_audio_selector_type.DynamicAudioSelectorType"
    ]
...
def serialize_json(value: DynamicAudioSelector) -> dict:
    ...
    if "selector_type" in value:
        ...
        out["selectorType"] = (
            capo_mediaconvert.types.dynamic_audio_selector_type.serialize_json(
                value["selector_type"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> DynamicAudioSelector:
    ...
    if "selectorType" in data:
        ...
        out["selector_type"] = (
            capo_mediaconvert.types.dynamic_audio_selector_type.deserialize_json(
                data["selectorType"]
            )
        )
    return out
