...
class QuickSightError(Exception):
    """Base class for all QuickSight service errors."""


class ServiceError(QuickSightError):
...
class SerializationError(QuickSightError):
    """Raised when a value cannot be serialized."""


class DeserializationError(QuickSightError):
...
class WaiterFailedError(QuickSightError):
...
class WaiterTimeoutError(QuickSightError):
