...
class CreateFolderMembershipResponse(TypedDict, closed=True):
    status: "capo_quicksight.types.status_code.StatusCode"
    """<p>The HTTP status of the request.</p>"""
    folder_member: NotRequired["capo_quicksight.types.folder_member.FolderMember"]
...
def serialize_json(value: CreateFolderMembershipResponse) -> dict:
    ...
    if "folder_member" in value:
        ...
        out["FolderMember"] = capo_quicksight.types.folder_member.serialize_json(
            value["folder_member"]
        )
