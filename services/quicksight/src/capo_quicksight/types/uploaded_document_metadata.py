...
if TYPE_CHECKING:
    import capo_quicksight.types.uploaded_document_name


class UploadedDocumentMetadata(TypedDict, closed=True):
    name: NotRequired[
        "capo_quicksight.types.uploaded_document_name.UploadedDocumentName"
    ]
