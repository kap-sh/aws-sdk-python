...
class ReferenceLineDynamicDataConfiguration(TypedDict, closed=True):
    ...
    calculation: "capo_quicksight.types.numerical_aggregation_function.NumericalAggregationFunction"
