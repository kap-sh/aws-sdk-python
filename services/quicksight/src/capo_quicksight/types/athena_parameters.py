...
if TYPE_CHECKING:
    ...
    import capo_quicksight.types.work_group


class AthenaParameters(TypedDict, closed=True):
    work_group: NotRequired["capo_quicksight.types.work_group.WorkGroup"]
    """<p>The workgroup that Amazon Athena uses.</p>"""
    role_arn: NotRequired["capo_quicksight.types.role_arn.RoleArn"]
    ...
    consumer_account_role_arn: NotRequired["capo_quicksight.types.role_arn.RoleArn"]
