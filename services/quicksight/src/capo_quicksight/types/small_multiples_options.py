...
if TYPE_CHECKING:
    ...
    import capo_quicksight.types.visible_panel_columns
    import capo_quicksight.types.visible_panel_rows


class SmallMultiplesOptions(TypedDict, closed=True):
    max_visible_rows: NotRequired[
        "capo_quicksight.types.visible_panel_rows.VisiblePanelRows"
    ]
    ...
    max_visible_columns: NotRequired[
        "capo_quicksight.types.visible_panel_columns.VisiblePanelColumns"
    ]
    ...
    panel_configuration: NotRequired[
        "capo_quicksight.types.panel_configuration.PanelConfiguration"
    ]
    """<p>Configures the display options for each small multiples panel.</p>"""
    x_axis: NotRequired[
        "capo_quicksight.types.small_multiples_axis_properties.SmallMultiplesAxisProperties"
    ]
...
def serialize_json(value: SmallMultiplesOptions) -> dict:
    ...
    if "panel_configuration" in value:
        ...
        out["PanelConfiguration"] = (
            capo_quicksight.types.panel_configuration.serialize_json(
    ...
    if "x_axis" in value:
        ...
        out["XAxis"] = (
            capo_quicksight.types.small_multiples_axis_properties.serialize_json(
                value["x_axis"]
            )
        )
    if "y_axis" in value:
...
def deserialize_json(data: dict) -> SmallMultiplesOptions:
    ...
    if "PanelConfiguration" in data:
        ...
        out["panel_configuration"] = (
            capo_quicksight.types.panel_configuration.deserialize_json(
    ...
    if "XAxis" in data:
        ...
        out["x_axis"] = (
            capo_quicksight.types.small_multiples_axis_properties.deserialize_json(
                data["XAxis"]
            )
        )
    if "YAxis" in data:
