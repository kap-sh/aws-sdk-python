"""Generated from Smithy shape ``com.amazonaws.quicksight#KPIVisual``."""
...
class KPIVisual(TypedDict, closed=True):
    visual_id: (
    ...
    chart_configuration: NotRequired[
        "capo_quicksight.types.kpi_configuration.KPIConfiguration"
    ]
    """<p>The configuration of a KPI visual.</p>"""
    conditional_formatting: NotRequired[
        "capo_quicksight.types.kpi_conditional_formatting.KPIConditionalFormatting"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: KPIVisual) -> dict:
    out: dict = {}
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            capo_quicksight.types.kpi_configuration.serialize_json(
    ...
    if "conditional_formatting" in value:
        ...
        out["ConditionalFormatting"] = (
            capo_quicksight.types.kpi_conditional_formatting.serialize_json(
...
def deserialize_json(data: dict) -> KPIVisual:
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            capo_quicksight.types.kpi_configuration.deserialize_json(
    ...
    if "ConditionalFormatting" in data:
        ...
        out["conditional_formatting"] = (
            capo_quicksight.types.kpi_conditional_formatting.deserialize_json(
