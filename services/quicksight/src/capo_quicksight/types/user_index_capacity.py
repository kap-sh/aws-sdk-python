...
if TYPE_CHECKING:
    import capo_quicksight.types.integer_value
    import capo_quicksight.types.long_value


class UserIndexCapacity(TypedDict, closed=True):
    ...
    total_capacity_bytes: NotRequired["capo_quicksight.types.long_value.LongValue"]
    """<p>The total index capacity consumed by the user in bytes.</p>"""
    total_kb_capacity_bytes: NotRequired["capo_quicksight.types.long_value.LongValue"]
    """<p>The total index capacity consumed by the user's knowledge bases in bytes.</p>"""
    total_space_capacity_bytes: NotRequired[
        "capo_quicksight.types.long_value.LongValue"
    ]
    """<p>The total index capacity consumed by the user's spaces in bytes.</p>"""
    kb_count: NotRequired["capo_quicksight.types.integer_value.IntegerValue"]
    """<p>The number of knowledge bases owned by the user.</p>"""
    space_count: NotRequired["capo_quicksight.types.integer_value.IntegerValue"]
