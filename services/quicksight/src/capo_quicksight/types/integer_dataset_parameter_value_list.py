...
if TYPE_CHECKING:
    import capo_quicksight.types.integer_dataset_parameter_default_value

IntegerDatasetParameterValueList: TypeAlias = list[
    "capo_quicksight.types.integer_dataset_parameter_default_value.IntegerDatasetParameterDefaultValue"
]
