...
if TYPE_CHECKING:
    ...
    import capo_quicksight.types.constant_value_string
...
class TopicConstantValue(TypedDict, closed=True):
    ...
    value: NotRequired[
        "capo_quicksight.types.constant_value_string.ConstantValueString"
    ]
    ...
    value_list: NotRequired[
        "capo_quicksight.types.collective_constant_entry_list.CollectiveConstantEntryList"
    ]
...
def serialize_json(value: TopicConstantValue) -> dict:
    ...
    if "value_list" in value:
        ...
        out["ValueList"] = (
            capo_quicksight.types.collective_constant_entry_list.serialize_json(
                value["value_list"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> TopicConstantValue:
    ...
    if "ValueList" in data:
        ...
        out["value_list"] = (
            capo_quicksight.types.collective_constant_entry_list.deserialize_json(
                data["ValueList"]
            )
        )
    return out
