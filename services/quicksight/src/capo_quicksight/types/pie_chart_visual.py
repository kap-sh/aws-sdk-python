...
if TYPE_CHECKING:
    ...
    import capo_quicksight.types.pie_chart_configuration
...
class PieChartVisual(TypedDict, closed=True):
    ...
    chart_configuration: NotRequired[
        "capo_quicksight.types.pie_chart_configuration.PieChartConfiguration"
    ]
...
def serialize_json(value: PieChartVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            capo_quicksight.types.pie_chart_configuration.serialize_json(
...
def deserialize_json(data: dict) -> PieChartVisual:
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            capo_quicksight.types.pie_chart_configuration.deserialize_json(
