...
class TableFieldURLConfiguration(TypedDict, closed=True):
    link_configuration: NotRequired[
        "capo_quicksight.types.table_field_link_configuration.TableFieldLinkConfiguration"
    ]
    """<p>The link configuration of a table field URL.</p>"""
    image_configuration: NotRequired[
        "capo_quicksight.types.table_field_image_configuration.TableFieldImageConfiguration"
    ]
...
def serialize_json(value: TableFieldURLConfiguration) -> dict:
    ...
    if "link_configuration" in value:
        ...
        out["LinkConfiguration"] = (
            capo_quicksight.types.table_field_link_configuration.serialize_json(
    ...
    if "image_configuration" in value:
        ...
        out["ImageConfiguration"] = (
            capo_quicksight.types.table_field_image_configuration.serialize_json(
...
def deserialize_json(data: dict) -> TableFieldURLConfiguration:
    ...
    if "LinkConfiguration" in data:
        ...
        out["link_configuration"] = (
            capo_quicksight.types.table_field_link_configuration.deserialize_json(
    ...
    if "ImageConfiguration" in data:
        ...
        out["image_configuration"] = (
            capo_quicksight.types.table_field_image_configuration.deserialize_json(
