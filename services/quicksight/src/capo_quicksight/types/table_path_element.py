...
if TYPE_CHECKING:
    import capo_quicksight.types.table_path_element_id
    import capo_quicksight.types.table_path_element_name


class TablePathElement(TypedDict, closed=True):
    name: NotRequired[
        "capo_quicksight.types.table_path_element_name.TablePathElementName"
    ]
    """<p>The name of the path element.</p>"""
    id: NotRequired["capo_quicksight.types.table_path_element_id.TablePathElementId"]
