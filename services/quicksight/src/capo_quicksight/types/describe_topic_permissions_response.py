"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeTopicPermissionsResponse``."""
...
class DescribeTopicPermissionsResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeTopicPermissionsResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DescribeTopicPermissionsResponse:
    out: DescribeTopicPermissionsResponse = {}  # type: ignore[typeddict-item]
    if "TopicId" in data:
