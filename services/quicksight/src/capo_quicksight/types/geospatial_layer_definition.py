...
class GeospatialLayerDefinition(TypedDict, closed=True):
    point_layer: NotRequired[
        "capo_quicksight.types.geospatial_point_layer.GeospatialPointLayer"
    ]
    """<p>The definition for a point layer.</p>"""
    line_layer: NotRequired[
        "capo_quicksight.types.geospatial_line_layer.GeospatialLineLayer"
    ]
    """<p>The definition for a line layer.</p>"""
    polygon_layer: NotRequired[
        "capo_quicksight.types.geospatial_polygon_layer.GeospatialPolygonLayer"
    ]
...
def serialize_json(value: GeospatialLayerDefinition) -> dict:
    ...
    if "point_layer" in value:
        ...
        out["PointLayer"] = capo_quicksight.types.geospatial_point_layer.serialize_json(
            value["point_layer"]
        )
    if "line_layer" in value:
        import capo_quicksight.types.geospatial_line_layer

        out["LineLayer"] = capo_quicksight.types.geospatial_line_layer.serialize_json(
            value["line_layer"]
        )
    if "polygon_layer" in value:
        ...
        out["PolygonLayer"] = (
            capo_quicksight.types.geospatial_polygon_layer.serialize_json(
                value["polygon_layer"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> GeospatialLayerDefinition:
    ...
    if "PointLayer" in data:
        ...
        out["point_layer"] = (
            capo_quicksight.types.geospatial_point_layer.deserialize_json(
                data["PointLayer"]
            )
        )
    if "LineLayer" in data:
        ...
        out["line_layer"] = (
            capo_quicksight.types.geospatial_line_layer.deserialize_json(
                data["LineLayer"]
            )
        )
    if "PolygonLayer" in data:
        ...
        out["polygon_layer"] = (
            capo_quicksight.types.geospatial_polygon_layer.deserialize_json(
                data["PolygonLayer"]
            )
        )
    return out
