...
if TYPE_CHECKING:
    import capo_quicksight.types.grid_layout_element

GridLayoutElementList: TypeAlias = list[
    "capo_quicksight.types.grid_layout_element.GridLayoutElement"
]
...
def serialize_json(value: GridLayoutElementList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_quicksight.types.grid_layout_element.serialize_json(item))
    return out
