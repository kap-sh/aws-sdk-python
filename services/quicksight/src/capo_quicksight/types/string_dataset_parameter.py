...
if TYPE_CHECKING:
    ...
    import capo_quicksight.types.string_dataset_parameter_default_values
...
class StringDatasetParameter(TypedDict, closed=True):
    ...
    default_values: NotRequired[
        "capo_quicksight.types.string_dataset_parameter_default_values.StringDatasetParameterDefaultValues"
    ]
...
def serialize_json(value: StringDatasetParameter) -> dict:
    ...
    if "default_values" in value:
        ...
        out["DefaultValues"] = (
            capo_quicksight.types.string_dataset_parameter_default_values.serialize_json(
...
def deserialize_json(data: dict) -> StringDatasetParameter:
    ...
    if "DefaultValues" in data:
        ...
        out["default_values"] = (
            capo_quicksight.types.string_dataset_parameter_default_values.deserialize_json(
                data["DefaultValues"]
            )
        )
    return out
