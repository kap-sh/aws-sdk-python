...
class SnapshotS3DestinationConfiguration(TypedDict, closed=True):
    bucket_configuration: (
        "capo_quicksight.types.s3_bucket_configuration.S3BucketConfiguration"
    )
...
def serialize_json(value: SnapshotS3DestinationConfiguration) -> dict:
    ...
    out["BucketConfiguration"] = (
        capo_quicksight.types.s3_bucket_configuration.serialize_json(
...
def deserialize_json(data: dict) -> SnapshotS3DestinationConfiguration:
    ...
    if "BucketConfiguration" in data:
        ...
        out["bucket_configuration"] = (
            capo_quicksight.types.s3_bucket_configuration.deserialize_json(
