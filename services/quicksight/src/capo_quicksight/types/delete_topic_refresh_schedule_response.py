"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteTopicRefreshScheduleResponse``."""
...
class DeleteTopicRefreshScheduleResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteTopicRefreshScheduleResponse) -> dict:
    out: dict = {}
