"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeThemePermissionsResponse``."""
...
class DescribeThemePermissionsResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeThemePermissionsResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DescribeThemePermissionsResponse:
    out: DescribeThemePermissionsResponse = {}  # type: ignore[typeddict-item]
    if "ThemeId" in data:
