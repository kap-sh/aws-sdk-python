...
if TYPE_CHECKING:
    ...
    import capo_quicksight.types.word_cloud_maximum_string_length
...
class WordCloudOptions(TypedDict, closed=True):
    word_orientation: NotRequired[
        "capo_quicksight.types.word_cloud_word_orientation.WordCloudWordOrientation"
    ]
...
def serialize_json(value: WordCloudOptions) -> dict:
    ...
    if "word_orientation" in value:
        ...
        out["WordOrientation"] = (
            capo_quicksight.types.word_cloud_word_orientation.serialize_json(
    ...
    if "word_scaling" in value:
        ...
        out["WordScaling"] = (
            capo_quicksight.types.word_cloud_word_scaling.serialize_json(
                value["word_scaling"]
            )
        )
    if "cloud_layout" in value:
        ...
        out["CloudLayout"] = (
            capo_quicksight.types.word_cloud_cloud_layout.serialize_json(
                value["cloud_layout"]
            )
        )
    if "word_casing" in value:
        ...
        out["WordCasing"] = capo_quicksight.types.word_cloud_word_casing.serialize_json(
            value["word_casing"]
        )
    if "word_padding" in value:
        ...
        out["WordPadding"] = (
            capo_quicksight.types.word_cloud_word_padding.serialize_json(
                value["word_padding"]
            )
        )
...
def deserialize_json(data: dict) -> WordCloudOptions:
    ...
    if "WordOrientation" in data:
        ...
        out["word_orientation"] = (
            capo_quicksight.types.word_cloud_word_orientation.deserialize_json(
    ...
    if "WordScaling" in data:
        ...
        out["word_scaling"] = (
            capo_quicksight.types.word_cloud_word_scaling.deserialize_json(
                data["WordScaling"]
            )
        )
    if "CloudLayout" in data:
        ...
        out["cloud_layout"] = (
            capo_quicksight.types.word_cloud_cloud_layout.deserialize_json(
                data["CloudLayout"]
            )
        )
    if "WordCasing" in data:
        ...
        out["word_casing"] = (
            capo_quicksight.types.word_cloud_word_casing.deserialize_json(
                data["WordCasing"]
            )
        )
    if "WordPadding" in data:
        ...
        out["word_padding"] = (
            capo_quicksight.types.word_cloud_word_padding.deserialize_json(
                data["WordPadding"]
            )
        )
