...
class NamespaceInfoV2(TypedDict, closed=True):
    ...
    namespace_error: NotRequired["capo_quicksight.types.namespace_error.NamespaceError"]
...
def serialize_json(value: NamespaceInfoV2) -> dict:
    ...
    if "namespace_error" in value:
        ...
        out["NamespaceError"] = capo_quicksight.types.namespace_error.serialize_json(
