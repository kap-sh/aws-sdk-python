...
class RowInfo(TypedDict, closed=True):
    rows_ingested: NotRequired["capo_quicksight.types.long.Long"]
    """<p>The number of rows that were ingested.</p>"""
    rows_dropped: NotRequired["capo_quicksight.types.long.Long"]
    """<p>The number of rows that were not ingested.</p>"""
    total_rows_in_dataset: NotRequired["capo_quicksight.types.long.Long"]
