...
class DescribeAccountSubscriptionResponse(TypedDict, closed=True):
    account_info: NotRequired["capo_quicksight.types.account_info.AccountInfo"]
...
def serialize_json(value: DescribeAccountSubscriptionResponse) -> dict:
    ...
    if "account_info" in value:
        ...
        out["AccountInfo"] = capo_quicksight.types.account_info.serialize_json(
            value["account_info"]
        )
...
def deserialize_json(data: dict) -> DescribeAccountSubscriptionResponse:
    ...
    if "AccountInfo" in data:
        ...
        out["account_info"] = capo_quicksight.types.account_info.deserialize_json(
            data["AccountInfo"]
        )
