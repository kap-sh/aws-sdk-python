"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateTemplateAliasResponse``."""
...
class CreateTemplateAliasResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateTemplateAliasResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateTemplateAliasResponse:
    out: CreateTemplateAliasResponse = {}  # type: ignore[typeddict-item]
