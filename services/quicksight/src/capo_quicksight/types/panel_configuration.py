...
class PanelConfiguration(TypedDict, closed=True):
    title: NotRequired["capo_quicksight.types.panel_title_options.PanelTitleOptions"]
    ...
    border_thickness: NotRequired["capo_quicksight.types.pixel_length.PixelLength"]
    """<p>Sets the line thickness of panel borders.</p>"""
    border_style: NotRequired[
        "capo_quicksight.types.panel_border_style.PanelBorderStyle"
    ]
    ...
    gutter_visibility: NotRequired["capo_quicksight.types.visibility.Visibility"]
    """<p>Determines whether or not negative space between sibling panels is rendered.</p>"""
    gutter_spacing: NotRequired["capo_quicksight.types.pixel_length.PixelLength"]
    """<p>Sets the total amount of negative space to display between sibling panels.</p>"""
    background_visibility: NotRequired["capo_quicksight.types.visibility.Visibility"]
...
def serialize_json(value: PanelConfiguration) -> dict:
    ...
    if "title" in value:
        ...
        out["Title"] = capo_quicksight.types.panel_title_options.serialize_json(
            value["title"]
        )
    ...
    if "border_style" in value:
        ...
        out["BorderStyle"] = capo_quicksight.types.panel_border_style.serialize_json(
            value["border_style"]
        )
    ...
    if "gutter_visibility" in value:
        ...
        out["GutterVisibility"] = capo_quicksight.types.visibility.serialize_json(
    ...
    if "background_visibility" in value:
        ...
        out["BackgroundVisibility"] = capo_quicksight.types.visibility.serialize_json(
