"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeThemeAliasResponse``."""
...
class DescribeThemeAliasResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeThemeAliasResponse) -> dict:
    out: dict = {}
