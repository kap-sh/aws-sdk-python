...
class ListTopicRefreshSchedulesResponse(TypedDict, closed=True):
    ...
    refresh_schedules: NotRequired[
        "capo_quicksight.types.topic_refresh_schedule_summaries.TopicRefreshScheduleSummaries"
    ]
...
def serialize_json(value: ListTopicRefreshSchedulesResponse) -> dict:
    ...
    if "refresh_schedules" in value:
        ...
        out["RefreshSchedules"] = (
            capo_quicksight.types.topic_refresh_schedule_summaries.serialize_json(
...
def deserialize_json(data: dict) -> ListTopicRefreshSchedulesResponse:
    ...
    if "RefreshSchedules" in data:
        ...
        out["refresh_schedules"] = (
            capo_quicksight.types.topic_refresh_schedule_summaries.deserialize_json(
