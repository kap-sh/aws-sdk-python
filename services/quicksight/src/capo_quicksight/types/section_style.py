...
class SectionStyle(TypedDict, closed=True):
    height: NotRequired["capo_quicksight.types.pixel_length.PixelLength"]
    ...
    padding: NotRequired["capo_quicksight.types.spacing.Spacing"]
...
def serialize_json(value: SectionStyle) -> dict:
    ...
    if "padding" in value:
        ...
        out["Padding"] = capo_quicksight.types.spacing.serialize_json(value["padding"])
    return out
