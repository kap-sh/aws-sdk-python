...
class FieldBasedTooltip(TypedDict, closed=True):
    aggregation_visibility: NotRequired["capo_quicksight.types.visibility.Visibility"]
    """<p>The visibility of <code>Show aggregations</code>.</p>"""
    tooltip_title_type: NotRequired[
        "capo_quicksight.types.tooltip_title_type.TooltipTitleType"
    ]
    ...
    tooltip_fields: NotRequired[
        "capo_quicksight.types.tooltip_item_list.TooltipItemList"
    ]
...
def serialize_json(value: FieldBasedTooltip) -> dict:
    ...
    if "aggregation_visibility" in value:
        ...
        out["AggregationVisibility"] = capo_quicksight.types.visibility.serialize_json(
    ...
    if "tooltip_title_type" in value:
        ...
        out["TooltipTitleType"] = (
            capo_quicksight.types.tooltip_title_type.serialize_json(
    ...
    if "tooltip_fields" in value:
        ...
        out["TooltipFields"] = capo_quicksight.types.tooltip_item_list.serialize_json(
...
def deserialize_json(data: dict) -> FieldBasedTooltip:
    ...
    if "TooltipTitleType" in data:
        ...
        out["tooltip_title_type"] = (
            capo_quicksight.types.tooltip_title_type.deserialize_json(
    ...
    if "TooltipFields" in data:
        ...
        out["tooltip_fields"] = (
            capo_quicksight.types.tooltip_item_list.deserialize_json(
                data["TooltipFields"]
            )
        )
    return out
