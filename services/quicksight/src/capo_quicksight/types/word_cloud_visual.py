...
if TYPE_CHECKING:
    ...
    import capo_quicksight.types.word_cloud_chart_configuration
...
class WordCloudVisual(TypedDict, closed=True):
    ...
    chart_configuration: NotRequired[
        "capo_quicksight.types.word_cloud_chart_configuration.WordCloudChartConfiguration"
    ]
...
def serialize_json(value: WordCloudVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            capo_quicksight.types.word_cloud_chart_configuration.serialize_json(
...
def deserialize_json(data: dict) -> WordCloudVisual:
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            capo_quicksight.types.word_cloud_chart_configuration.deserialize_json(
