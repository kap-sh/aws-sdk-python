...
class UpdateAgentPermissionsRequest(TypedDict, closed=True):
    ...
    grant_permissions: NotRequired[
        "capo_quicksight.types.update_agent_permissions_request_grant_permissions_list.UpdateAgentPermissionsRequestGrantPermissionsList"
    ]
    """<p>The resource permissions that you want to grant on the agent.</p>"""
    revoke_permissions: NotRequired[
        "capo_quicksight.types.update_agent_permissions_request_revoke_permissions_list.UpdateAgentPermissionsRequestRevokePermissionsList"
    ]
...
def serialize_json(value: UpdateAgentPermissionsRequest) -> dict:
    ...
    if "grant_permissions" in value:
        ...
        out["GrantPermissions"] = (
            capo_quicksight.types.update_agent_permissions_request_grant_permissions_list.serialize_json(
    ...
    if "revoke_permissions" in value:
        ...
        out["RevokePermissions"] = (
            capo_quicksight.types.update_agent_permissions_request_revoke_permissions_list.serialize_json(
...
def deserialize_json(data: dict) -> UpdateAgentPermissionsRequest:
    ...
    if "GrantPermissions" in data:
        ...
        out["grant_permissions"] = (
            capo_quicksight.types.update_agent_permissions_request_grant_permissions_list.deserialize_json(
    ...
    if "RevokePermissions" in data:
        ...
        out["revoke_permissions"] = (
            capo_quicksight.types.update_agent_permissions_request_revoke_permissions_list.deserialize_json(
