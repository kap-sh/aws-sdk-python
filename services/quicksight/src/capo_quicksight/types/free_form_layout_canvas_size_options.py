...
if TYPE_CHECKING:
    import capo_quicksight.types.free_form_layout_screen_canvas_size_options


class FreeFormLayoutCanvasSizeOptions(TypedDict, closed=True):
    screen_canvas_size_options: NotRequired[
        "capo_quicksight.types.free_form_layout_screen_canvas_size_options.FreeFormLayoutScreenCanvasSizeOptions"
    ]
...
def serialize_json(value: FreeFormLayoutCanvasSizeOptions) -> dict:
    ...
    if "screen_canvas_size_options" in value:
        ...
        out["ScreenCanvasSizeOptions"] = (
            capo_quicksight.types.free_form_layout_screen_canvas_size_options.serialize_json(
...
def deserialize_json(data: dict) -> FreeFormLayoutCanvasSizeOptions:
    ...
    if "ScreenCanvasSizeOptions" in data:
        ...
        out["screen_canvas_size_options"] = (
            capo_quicksight.types.free_form_layout_screen_canvas_size_options.deserialize_json(
