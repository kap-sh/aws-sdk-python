...
if TYPE_CHECKING:
    import capo_quicksight.types.histogram_configuration
...
class HistogramVisual(TypedDict, closed=True):
    visual_id: (
    ...
    chart_configuration: NotRequired[
        "capo_quicksight.types.histogram_configuration.HistogramConfiguration"
    ]
...
def serialize_json(value: HistogramVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            capo_quicksight.types.histogram_configuration.serialize_json(
...
def deserialize_json(data: dict) -> HistogramVisual:
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            capo_quicksight.types.histogram_configuration.deserialize_json(
