...
import capo_quicksight.types.search_spaces_request
...
) -> capo_quicksight.types.search_spaces_response.SearchSpacesResponse:
    out: capo_quicksight.types.search_spaces_response.SearchSpacesResponse = (
        capo_quicksight.types.search_spaces_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.search_spaces_request.serialize_json(input_)
    ).encode()
...
def search_spaces(
    ...
    capo_quicksight.types.search_spaces_response.SearchSpacesResponse, zapros.Response
]:
