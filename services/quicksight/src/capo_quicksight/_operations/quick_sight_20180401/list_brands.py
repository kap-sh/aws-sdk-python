"""Generated from Smithy shape ``com.amazonaws.quicksight#ListBrands``."""
...
import capo_quicksight.errors.internal_server_exception
...
import capo_quicksight.types.list_brands_request
import capo_quicksight.types.list_brands_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InternalServerException":
            raise capo_quicksight.errors.internal_server_exception.InternalServerException.from_json(
                data
            )
...
) -> capo_quicksight.types.list_brands_response.ListBrandsResponse:
    out: capo_quicksight.types.list_brands_response.ListBrandsResponse = (
        capo_quicksight.types.list_brands_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/brands"
...
def list_brands(
    ...
    capo_quicksight.types.list_brands_response.ListBrandsResponse, zapros.Response
]:
