...
) -> capo_quicksight.types.update_topic_permissions_response.UpdateTopicPermissionsResponse:
    out: capo_quicksight.types.update_topic_permissions_response.UpdateTopicPermissionsResponse = capo_quicksight.types.update_topic_permissions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_topic_permissions_request.serialize_json(input_)
    ).encode()
