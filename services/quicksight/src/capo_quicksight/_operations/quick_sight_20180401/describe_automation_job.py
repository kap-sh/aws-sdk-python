"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeAutomationJob``."""
...
import capo_quicksight.types.describe_automation_job_request
import capo_quicksight.types.describe_automation_job_response
...
def handle_response(
    ...
    capo_quicksight.types.describe_automation_job_response.DescribeAutomationJobResponse
):
    out: capo_quicksight.types.describe_automation_job_response.DescribeAutomationJobResponse = capo_quicksight.types.describe_automation_job_response.deserialize_json(
