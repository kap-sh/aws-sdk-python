...
import capo_quicksight.types.list_themes_request
import capo_quicksight.types.list_themes_response
import capo_quicksight.types.theme_summary_list
...
) -> capo_quicksight.types.list_themes_response.ListThemesResponse:
    out: capo_quicksight.types.list_themes_response.ListThemesResponse = (
        capo_quicksight.types.list_themes_response.deserialize_json(
...
def list_themes(
    ...
    capo_quicksight.types.list_themes_response.ListThemesResponse, zapros.Response
]:
