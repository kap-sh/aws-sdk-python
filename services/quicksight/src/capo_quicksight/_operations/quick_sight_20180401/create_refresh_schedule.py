"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateRefreshSchedule``."""
...
import capo_quicksight.types.create_refresh_schedule_request
import capo_quicksight.types.create_refresh_schedule_response
...
def handle_response(
    ...
    capo_quicksight.types.create_refresh_schedule_response.CreateRefreshScheduleResponse
):
    out: capo_quicksight.types.create_refresh_schedule_response.CreateRefreshScheduleResponse = capo_quicksight.types.create_refresh_schedule_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_refresh_schedule_request.serialize_json(input_)
    ).encode()
...
async def async_create_refresh_schedule(
