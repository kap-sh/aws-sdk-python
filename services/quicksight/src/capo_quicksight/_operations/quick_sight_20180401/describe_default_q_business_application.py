...
) -> capo_quicksight.types.describe_default_q_business_application_response.DescribeDefaultQBusinessApplicationResponse:
    out: capo_quicksight.types.describe_default_q_business_application_response.DescribeDefaultQBusinessApplicationResponse = capo_quicksight.types.describe_default_q_business_application_response.deserialize_json(
