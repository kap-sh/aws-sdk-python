"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteActionConnector``."""
...
import capo_quicksight.types.delete_action_connector_request
import capo_quicksight.types.delete_action_connector_response
...
def handle_response(
    ...
    capo_quicksight.types.delete_action_connector_response.DeleteActionConnectorResponse
):
    out: capo_quicksight.types.delete_action_connector_response.DeleteActionConnectorResponse = capo_quicksight.types.delete_action_connector_response.deserialize_json(
...
async def async_delete_action_connector(
