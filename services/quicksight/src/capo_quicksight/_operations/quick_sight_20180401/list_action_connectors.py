"""Generated from Smithy shape ``com.amazonaws.quicksight#ListActionConnectors``."""
...
import capo_quicksight.types.list_action_connectors_response
...
) -> capo_quicksight.types.list_action_connectors_response.ListActionConnectorsResponse:
    out: capo_quicksight.types.list_action_connectors_response.ListActionConnectorsResponse = capo_quicksight.types.list_action_connectors_response.deserialize_json(
