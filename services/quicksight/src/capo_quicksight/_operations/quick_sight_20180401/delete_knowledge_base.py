...
) -> capo_quicksight.types.delete_knowledge_base_response.DeleteKnowledgeBaseResponse:
    out: capo_quicksight.types.delete_knowledge_base_response.DeleteKnowledgeBaseResponse = capo_quicksight.types.delete_knowledge_base_response.deserialize_json(
