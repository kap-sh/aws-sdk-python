"""Generated from Smithy shape ``com.amazonaws.quicksight#ListAssetBundleExportJobs``."""
...
) -> capo_quicksight.types.list_asset_bundle_export_jobs_response.ListAssetBundleExportJobsResponse:
    out: capo_quicksight.types.list_asset_bundle_export_jobs_response.ListAssetBundleExportJobsResponse = capo_quicksight.types.list_asset_bundle_export_jobs_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/asset-bundle-export-jobs"
...
async def async_list_asset_bundle_export_jobs(
