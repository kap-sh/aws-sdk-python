...
import capo_quicksight.types.group_list
import capo_quicksight.types.list_groups_request
import capo_quicksight.types.list_groups_response
...
) -> capo_quicksight.types.list_groups_response.ListGroupsResponse:
    out: capo_quicksight.types.list_groups_response.ListGroupsResponse = (
        capo_quicksight.types.list_groups_response.deserialize_json(
...
def list_groups(
    ...
    capo_quicksight.types.list_groups_response.ListGroupsResponse, zapros.Response
]:
