"""Generated from Smithy shape ``com.amazonaws.quicksight#ListUserGroups``."""
...
) -> capo_quicksight.types.list_user_groups_response.ListUserGroupsResponse:
    out: capo_quicksight.types.list_user_groups_response.ListUserGroupsResponse = (
        capo_quicksight.types.list_user_groups_response.deserialize_json(
...
async def async_list_user_groups(
