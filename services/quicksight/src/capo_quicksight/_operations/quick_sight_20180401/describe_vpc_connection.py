...
def handle_response(
    ...
    capo_quicksight.types.describe_vpc_connection_response.DescribeVPCConnectionResponse
):
    out: capo_quicksight.types.describe_vpc_connection_response.DescribeVPCConnectionResponse = capo_quicksight.types.describe_vpc_connection_response.deserialize_json(
