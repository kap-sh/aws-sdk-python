"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteFlow``."""
...
) -> capo_quicksight.types.delete_flow_response.DeleteFlowResponse:
    out: capo_quicksight.types.delete_flow_response.DeleteFlowResponse = (
        capo_quicksight.types.delete_flow_response.deserialize_json(
...
def delete_flow(
    ...
    capo_quicksight.types.delete_flow_response.DeleteFlowResponse, zapros.Response
]:
