...
) -> capo_quicksight.types.describe_topic_refresh_schedule_response.DescribeTopicRefreshScheduleResponse:
    out: capo_quicksight.types.describe_topic_refresh_schedule_response.DescribeTopicRefreshScheduleResponse = capo_quicksight.types.describe_topic_refresh_schedule_response.deserialize_json(
