"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeTopicPermissions``."""
...
) -> capo_quicksight.types.describe_topic_permissions_response.DescribeTopicPermissionsResponse:
    out: capo_quicksight.types.describe_topic_permissions_response.DescribeTopicPermissionsResponse = capo_quicksight.types.describe_topic_permissions_response.deserialize_json(
...
async def async_describe_topic_permissions(
