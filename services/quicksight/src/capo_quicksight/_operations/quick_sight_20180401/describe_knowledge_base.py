"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeKnowledgeBase``."""
...
def handle_response(
    ...
    capo_quicksight.types.describe_knowledge_base_response.DescribeKnowledgeBaseResponse
):
    out: capo_quicksight.types.describe_knowledge_base_response.DescribeKnowledgeBaseResponse = capo_quicksight.types.describe_knowledge_base_response.deserialize_json(
...
async def async_describe_knowledge_base(
