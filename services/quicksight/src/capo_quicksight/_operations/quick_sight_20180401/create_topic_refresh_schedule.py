"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateTopicRefreshSchedule``."""
...
import capo_quicksight.errors.limit_exceeded_exception
import capo_quicksight.errors.resource_exists_exception
import capo_quicksight.errors.resource_not_found_exception
import capo_quicksight.errors.throttling_exception
import capo_quicksight.types.create_topic_refresh_schedule_request
import capo_quicksight.types.create_topic_refresh_schedule_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise capo_quicksight.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data
            )
...
) -> capo_quicksight.types.create_topic_refresh_schedule_response.CreateTopicRefreshScheduleResponse:
    out: capo_quicksight.types.create_topic_refresh_schedule_response.CreateTopicRefreshScheduleResponse = capo_quicksight.types.create_topic_refresh_schedule_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/topics/{TopicId}/schedules"
    )
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_topic_refresh_schedule_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_topic_refresh_schedule(
