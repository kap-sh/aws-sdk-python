"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateTopicRefreshSchedule``."""
...
) -> capo_quicksight.types.update_topic_refresh_schedule_response.UpdateTopicRefreshScheduleResponse:
    out: capo_quicksight.types.update_topic_refresh_schedule_response.UpdateTopicRefreshScheduleResponse = capo_quicksight.types.update_topic_refresh_schedule_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_topic_refresh_schedule_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_topic_refresh_schedule(
