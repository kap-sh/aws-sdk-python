"""Generated from Smithy shape ``com.amazonaws.quicksight#ListTemplateVersions``."""
...
import capo_quicksight.types.list_template_versions_request
import capo_quicksight.types.list_template_versions_response
...
) -> capo_quicksight.types.list_template_versions_response.ListTemplateVersionsResponse:
    out: capo_quicksight.types.list_template_versions_response.ListTemplateVersionsResponse = capo_quicksight.types.list_template_versions_response.deserialize_json(
