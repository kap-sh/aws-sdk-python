"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteThemeAlias``."""
...
import capo_quicksight.types.delete_theme_alias_request
import capo_quicksight.types.delete_theme_alias_response
...
) -> capo_quicksight.types.delete_theme_alias_response.DeleteThemeAliasResponse:
    out: capo_quicksight.types.delete_theme_alias_response.DeleteThemeAliasResponse = (
        capo_quicksight.types.delete_theme_alias_response.deserialize_json(
...
async def async_delete_theme_alias(
