"""Generated from Smithy shape ``com.amazonaws.quicksight#CancelIngestion``."""
...
import capo_quicksight.types.cancel_ingestion_request
import capo_quicksight.types.cancel_ingestion_response
...
) -> capo_quicksight.types.cancel_ingestion_response.CancelIngestionResponse:
    out: capo_quicksight.types.cancel_ingestion_response.CancelIngestionResponse = (
        capo_quicksight.types.cancel_ingestion_response.deserialize_json(
...
async def async_cancel_ingestion(
