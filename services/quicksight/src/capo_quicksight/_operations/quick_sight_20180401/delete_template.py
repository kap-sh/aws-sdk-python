"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteTemplate``."""
...
import capo_quicksight.types.delete_template_request
import capo_quicksight.types.delete_template_response
...
) -> capo_quicksight.types.delete_template_response.DeleteTemplateResponse:
    out: capo_quicksight.types.delete_template_response.DeleteTemplateResponse = (
        capo_quicksight.types.delete_template_response.deserialize_json(
