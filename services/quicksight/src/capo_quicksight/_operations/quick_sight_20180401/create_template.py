"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateTemplate``."""
...
import capo_quicksight.types.create_template_request
import capo_quicksight.types.create_template_response
...
) -> capo_quicksight.types.create_template_response.CreateTemplateResponse:
    out: capo_quicksight.types.create_template_response.CreateTemplateResponse = (
        capo_quicksight.types.create_template_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/templates/{TemplateId}"
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_template_request.serialize_json(input_)
    ).encode()
