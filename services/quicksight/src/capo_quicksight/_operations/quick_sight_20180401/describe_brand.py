"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeBrand``."""
...
import capo_quicksight.types.describe_brand_request
import capo_quicksight.types.describe_brand_response
...
) -> capo_quicksight.types.describe_brand_response.DescribeBrandResponse:
    out: capo_quicksight.types.describe_brand_response.DescribeBrandResponse = (
        capo_quicksight.types.describe_brand_response.deserialize_json(
...
def describe_brand(
    ...
    capo_quicksight.types.describe_brand_response.DescribeBrandResponse, zapros.Response
]:
