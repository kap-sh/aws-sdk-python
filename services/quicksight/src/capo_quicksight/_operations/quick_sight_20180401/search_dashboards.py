...
) -> capo_quicksight.types.search_dashboards_response.SearchDashboardsResponse:
    out: capo_quicksight.types.search_dashboards_response.SearchDashboardsResponse = (
        capo_quicksight.types.search_dashboards_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.search_dashboards_request.serialize_json(input_)
    ).encode()
