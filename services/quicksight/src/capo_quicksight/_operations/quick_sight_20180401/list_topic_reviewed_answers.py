...
import capo_quicksight.types.list_topic_reviewed_answers_request
import capo_quicksight.types.list_topic_reviewed_answers_response
import capo_quicksight.types.topic_reviewed_answers
...
) -> capo_quicksight.types.list_topic_reviewed_answers_response.ListTopicReviewedAnswersResponse:
    out: capo_quicksight.types.list_topic_reviewed_answers_response.ListTopicReviewedAnswersResponse = capo_quicksight.types.list_topic_reviewed_answers_response.deserialize_json(
