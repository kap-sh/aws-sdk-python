"""Generated from Smithy shape ``com.amazonaws.quicksight#StartDashboardSnapshotJobSchedule``."""
...
import capo_quicksight.types.start_dashboard_snapshot_job_schedule_request
import capo_quicksight.types.start_dashboard_snapshot_job_schedule_response
...
) -> capo_quicksight.types.start_dashboard_snapshot_job_schedule_response.StartDashboardSnapshotJobScheduleResponse:
    out: capo_quicksight.types.start_dashboard_snapshot_job_schedule_response.StartDashboardSnapshotJobScheduleResponse = capo_quicksight.types.start_dashboard_snapshot_job_schedule_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/accounts/{AwsAccountId}/dashboards/{DashboardId}/schedules/{ScheduleId}"
    )
    ...
    url = url.replace("{ScheduleId}", quote(str(input_["schedule_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_start_dashboard_snapshot_job_schedule(
