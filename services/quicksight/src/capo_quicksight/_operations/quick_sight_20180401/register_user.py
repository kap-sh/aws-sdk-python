"""Generated from Smithy shape ``com.amazonaws.quicksight#RegisterUser``."""
...
import capo_quicksight.types.register_user_request
...
) -> capo_quicksight.types.register_user_response.RegisterUserResponse:
    out: capo_quicksight.types.register_user_response.RegisterUserResponse = (
        capo_quicksight.types.register_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.register_user_request.serialize_json(input_)
    ).encode()
...
def register_user(
    ...
    capo_quicksight.types.register_user_response.RegisterUserResponse, zapros.Response
]:
