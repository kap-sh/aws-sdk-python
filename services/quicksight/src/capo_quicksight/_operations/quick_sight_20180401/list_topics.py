"""Generated from Smithy shape ``com.amazonaws.quicksight#ListTopics``."""
...
) -> capo_quicksight.types.list_topics_response.ListTopicsResponse:
    out: capo_quicksight.types.list_topics_response.ListTopicsResponse = (
        capo_quicksight.types.list_topics_response.deserialize_json(
...
def list_topics(
    ...
    capo_quicksight.types.list_topics_response.ListTopicsResponse, zapros.Response
]:
