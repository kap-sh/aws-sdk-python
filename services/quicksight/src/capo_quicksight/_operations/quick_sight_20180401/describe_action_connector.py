"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeActionConnector``."""
...
import capo_quicksight.types.describe_action_connector_request
import capo_quicksight.types.describe_action_connector_response
...
) -> capo_quicksight.types.describe_action_connector_response.DescribeActionConnectorResponse:
    out: capo_quicksight.types.describe_action_connector_response.DescribeActionConnectorResponse = capo_quicksight.types.describe_action_connector_response.deserialize_json(
...
async def async_describe_action_connector(
