...
import capo_quicksight.types.search_flows_input
import capo_quicksight.types.search_flows_output
...
) -> capo_quicksight.types.search_flows_output.SearchFlowsOutput:
    out: capo_quicksight.types.search_flows_output.SearchFlowsOutput = (
        capo_quicksight.types.search_flows_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.search_flows_input.serialize_json(input_)
    ).encode()
...
def search_flows(
    ...
    capo_quicksight.types.search_flows_output.SearchFlowsOutput, zapros.Response
]:
