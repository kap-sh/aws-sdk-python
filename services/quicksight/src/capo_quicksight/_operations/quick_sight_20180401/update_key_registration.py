...
import capo_quicksight.types.update_key_registration_request
...
def handle_response(
    ...
    capo_quicksight.types.update_key_registration_response.UpdateKeyRegistrationResponse
):
    out: capo_quicksight.types.update_key_registration_response.UpdateKeyRegistrationResponse = capo_quicksight.types.update_key_registration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_key_registration_request.serialize_json(input_)
    ).encode()
