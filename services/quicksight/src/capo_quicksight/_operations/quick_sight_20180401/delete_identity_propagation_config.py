"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteIdentityPropagationConfig``."""
...
import capo_quicksight.types.delete_identity_propagation_config_request
...
) -> capo_quicksight.types.delete_identity_propagation_config_response.DeleteIdentityPropagationConfigResponse:
    out: capo_quicksight.types.delete_identity_propagation_config_response.DeleteIdentityPropagationConfigResponse = capo_quicksight.types.delete_identity_propagation_config_response.deserialize_json(
...
async def async_delete_identity_propagation_config(
