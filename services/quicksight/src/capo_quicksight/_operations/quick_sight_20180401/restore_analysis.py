...
) -> capo_quicksight.types.restore_analysis_response.RestoreAnalysisResponse:
    out: capo_quicksight.types.restore_analysis_response.RestoreAnalysisResponse = (
        capo_quicksight.types.restore_analysis_response.deserialize_json(
