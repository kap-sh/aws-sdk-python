"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeTemplate``."""
...
import capo_quicksight.types.describe_template_request
import capo_quicksight.types.describe_template_response
...
) -> capo_quicksight.types.describe_template_response.DescribeTemplateResponse:
    out: capo_quicksight.types.describe_template_response.DescribeTemplateResponse = (
        capo_quicksight.types.describe_template_response.deserialize_json(
...
async def async_describe_template(
