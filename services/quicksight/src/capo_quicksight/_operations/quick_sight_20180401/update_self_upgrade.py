"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateSelfUpgrade``."""
...
import capo_quicksight.types.update_self_upgrade_request
import capo_quicksight.types.update_self_upgrade_response
...
) -> capo_quicksight.types.update_self_upgrade_response.UpdateSelfUpgradeResponse:
    out: capo_quicksight.types.update_self_upgrade_response.UpdateSelfUpgradeResponse = capo_quicksight.types.update_self_upgrade_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/accounts/{AwsAccountId}/namespaces/{Namespace}/update-self-upgrade-request"
    )
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_self_upgrade_request.serialize_json(input_)
    ).encode()
...
async def async_update_self_upgrade(
