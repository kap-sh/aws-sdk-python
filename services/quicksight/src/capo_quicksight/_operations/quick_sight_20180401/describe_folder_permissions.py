"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeFolderPermissions``."""
...
import capo_quicksight.types.describe_folder_permissions_response
...
) -> capo_quicksight.types.describe_folder_permissions_response.DescribeFolderPermissionsResponse:
    out: capo_quicksight.types.describe_folder_permissions_response.DescribeFolderPermissionsResponse = capo_quicksight.types.describe_folder_permissions_response.deserialize_json(
...
async def async_describe_folder_permissions(
