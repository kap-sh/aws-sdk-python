...
import capo_quicksight.types.describe_theme_request
...
) -> capo_quicksight.types.describe_theme_response.DescribeThemeResponse:
    out: capo_quicksight.types.describe_theme_response.DescribeThemeResponse = (
        capo_quicksight.types.describe_theme_response.deserialize_json(
...
def describe_theme(
    ...
    capo_quicksight.types.describe_theme_response.DescribeThemeResponse, zapros.Response
]:
