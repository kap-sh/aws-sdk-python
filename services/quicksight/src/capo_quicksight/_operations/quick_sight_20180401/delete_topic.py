"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteTopic``."""
...
) -> capo_quicksight.types.delete_topic_response.DeleteTopicResponse:
    out: capo_quicksight.types.delete_topic_response.DeleteTopicResponse = (
        capo_quicksight.types.delete_topic_response.deserialize_json(
...
def delete_topic(
    ...
    capo_quicksight.types.delete_topic_response.DeleteTopicResponse, zapros.Response
]:
