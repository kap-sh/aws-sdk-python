"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteFolder``."""
...
import capo_quicksight.types.delete_folder_request
import capo_quicksight.types.delete_folder_response
...
) -> capo_quicksight.types.delete_folder_response.DeleteFolderResponse:
    out: capo_quicksight.types.delete_folder_response.DeleteFolderResponse = (
        capo_quicksight.types.delete_folder_response.deserialize_json(
...
def delete_folder(
    ...
    capo_quicksight.types.delete_folder_response.DeleteFolderResponse, zapros.Response
]:
