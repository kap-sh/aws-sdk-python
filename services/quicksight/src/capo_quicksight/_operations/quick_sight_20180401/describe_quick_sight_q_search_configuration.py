"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeQuickSightQSearchConfiguration``."""
...
import capo_quicksight.types.describe_quick_sight_q_search_configuration_request
import capo_quicksight.types.describe_quick_sight_q_search_configuration_response
...
) -> capo_quicksight.types.describe_quick_sight_q_search_configuration_response.DescribeQuickSightQSearchConfigurationResponse:
    out: capo_quicksight.types.describe_quick_sight_q_search_configuration_response.DescribeQuickSightQSearchConfigurationResponse = capo_quicksight.types.describe_quick_sight_q_search_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/accounts/{AwsAccountId}/quicksight-q-search-configuration"
    )
...
async def async_describe_quick_sight_q_search_configuration(
