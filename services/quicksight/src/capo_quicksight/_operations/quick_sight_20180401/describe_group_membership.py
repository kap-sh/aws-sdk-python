"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeGroupMembership``."""
...
import capo_quicksight.types.describe_group_membership_request
import capo_quicksight.types.describe_group_membership_response
...
) -> capo_quicksight.types.describe_group_membership_response.DescribeGroupMembershipResponse:
    out: capo_quicksight.types.describe_group_membership_response.DescribeGroupMembershipResponse = capo_quicksight.types.describe_group_membership_response.deserialize_json(
