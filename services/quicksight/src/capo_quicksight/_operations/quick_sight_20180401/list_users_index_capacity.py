...
import capo_quicksight.types.list_users_index_capacity_response
...
) -> capo_quicksight.types.list_users_index_capacity_response.ListUsersIndexCapacityResponse:
    out: capo_quicksight.types.list_users_index_capacity_response.ListUsersIndexCapacityResponse = capo_quicksight.types.list_users_index_capacity_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.list_users_index_capacity_request.serialize_json(input_)
    ).encode()
