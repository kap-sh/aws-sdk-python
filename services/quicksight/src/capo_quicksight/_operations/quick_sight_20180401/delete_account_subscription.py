"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteAccountSubscription``."""
...
import capo_quicksight.types.delete_account_subscription_request
import capo_quicksight.types.delete_account_subscription_response
...
) -> capo_quicksight.types.delete_account_subscription_response.DeleteAccountSubscriptionResponse:
    out: capo_quicksight.types.delete_account_subscription_response.DeleteAccountSubscriptionResponse = capo_quicksight.types.delete_account_subscription_response.deserialize_json(
...
async def async_delete_account_subscription(
