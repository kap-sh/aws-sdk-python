"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteDefaultQBusinessApplication``."""
...
) -> capo_quicksight.types.delete_default_q_business_application_response.DeleteDefaultQBusinessApplicationResponse:
    out: capo_quicksight.types.delete_default_q_business_application_response.DeleteDefaultQBusinessApplicationResponse = capo_quicksight.types.delete_default_q_business_application_response.deserialize_json(
...
async def async_delete_default_q_business_application(
