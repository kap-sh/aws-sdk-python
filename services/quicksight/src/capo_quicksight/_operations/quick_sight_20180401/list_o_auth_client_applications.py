"""Generated from Smithy shape ``com.amazonaws.quicksight#ListOAuthClientApplications``."""
...
import capo_quicksight.types.list_o_auth_client_applications_response
import capo_quicksight.types.o_auth_client_application_summary_list
...
) -> capo_quicksight.types.list_o_auth_client_applications_response.ListOAuthClientApplicationsResponse:
    out: capo_quicksight.types.list_o_auth_client_applications_response.ListOAuthClientApplicationsResponse = capo_quicksight.types.list_o_auth_client_applications_response.deserialize_json(
...
async def async_list_o_auth_client_applications(
