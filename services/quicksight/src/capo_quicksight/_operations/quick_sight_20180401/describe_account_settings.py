"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeAccountSettings``."""
...
import capo_quicksight.types.describe_account_settings_request
import capo_quicksight.types.describe_account_settings_response
...
def handle_response(
    ...
    out: capo_quicksight.types.describe_account_settings_response.DescribeAccountSettingsResponse = capo_quicksight.types.describe_account_settings_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/settings"
