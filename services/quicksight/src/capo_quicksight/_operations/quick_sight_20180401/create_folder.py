"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateFolder``."""
...
import capo_quicksight.types.create_folder_request
import capo_quicksight.types.create_folder_response
...
def handle_response(
    ...
    out: capo_quicksight.types.create_folder_response.CreateFolderResponse = (
        capo_quicksight.types.create_folder_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/folders/{FolderId}"
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_folder_request.serialize_json(input_)
    ).encode()
...
def create_folder(
    ...
    capo_quicksight.types.create_folder_response.CreateFolderResponse, zapros.Response
]:
