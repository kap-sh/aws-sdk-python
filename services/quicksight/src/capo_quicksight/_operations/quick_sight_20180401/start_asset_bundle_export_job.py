"""Generated from Smithy shape ``com.amazonaws.quicksight#StartAssetBundleExportJob``."""
...
import capo_quicksight.types.start_asset_bundle_export_job_request
import capo_quicksight.types.start_asset_bundle_export_job_response
...
) -> capo_quicksight.types.start_asset_bundle_export_job_response.StartAssetBundleExportJobResponse:
    out: capo_quicksight.types.start_asset_bundle_export_job_response.StartAssetBundleExportJobResponse = capo_quicksight.types.start_asset_bundle_export_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.start_asset_bundle_export_job_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_asset_bundle_export_job(
