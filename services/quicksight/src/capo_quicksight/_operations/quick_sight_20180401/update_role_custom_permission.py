"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateRoleCustomPermission``."""
...
import capo_quicksight.types.update_role_custom_permission_request
import capo_quicksight.types.update_role_custom_permission_response
...
) -> capo_quicksight.types.update_role_custom_permission_response.UpdateRoleCustomPermissionResponse:
    out: capo_quicksight.types.update_role_custom_permission_response.UpdateRoleCustomPermissionResponse = capo_quicksight.types.update_role_custom_permission_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_role_custom_permission_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_role_custom_permission(
