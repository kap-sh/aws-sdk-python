...
import capo_quicksight.types.update_data_set_permissions_request
import capo_quicksight.types.update_data_set_permissions_response
...
) -> capo_quicksight.types.update_data_set_permissions_response.UpdateDataSetPermissionsResponse:
    out: capo_quicksight.types.update_data_set_permissions_response.UpdateDataSetPermissionsResponse = capo_quicksight.types.update_data_set_permissions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_data_set_permissions_request.serialize_json(input_)
    ).encode()
