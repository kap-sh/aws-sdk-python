...
def handle_response(
    ...
    out: capo_quicksight.types.create_custom_permissions_response.CreateCustomPermissionsResponse = capo_quicksight.types.create_custom_permissions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_custom_permissions_request.serialize_json(input_)
    ).encode()
