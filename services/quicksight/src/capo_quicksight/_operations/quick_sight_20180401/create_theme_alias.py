"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateThemeAlias``."""
...
import capo_quicksight.types.create_theme_alias_request
import capo_quicksight.types.create_theme_alias_response
...
) -> capo_quicksight.types.create_theme_alias_response.CreateThemeAliasResponse:
    out: capo_quicksight.types.create_theme_alias_response.CreateThemeAliasResponse = (
        capo_quicksight.types.create_theme_alias_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_theme_alias_request.serialize_json(input_)
    ).encode()
...
async def async_create_theme_alias(
