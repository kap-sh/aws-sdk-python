"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteFolderMembership``."""
...
import capo_quicksight.types.delete_folder_membership_response
...
) -> capo_quicksight.types.delete_folder_membership_response.DeleteFolderMembershipResponse:
    out: capo_quicksight.types.delete_folder_membership_response.DeleteFolderMembershipResponse = capo_quicksight.types.delete_folder_membership_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{MemberType}", quote(str(input_["member_type"]), safe=""))
    params: dict[str, str] = {}
...
async def async_delete_folder_membership(
