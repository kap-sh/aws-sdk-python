"""Generated from Smithy shape ``com.amazonaws.quicksight#GetSessionEmbedUrl``."""
...
) -> capo_quicksight.types.get_session_embed_url_response.GetSessionEmbedUrlResponse:
    out: capo_quicksight.types.get_session_embed_url_response.GetSessionEmbedUrlResponse = capo_quicksight.types.get_session_embed_url_response.deserialize_json(
