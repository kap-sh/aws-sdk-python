"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeDataSetRefreshProperties``."""
...
import capo_quicksight.types.describe_data_set_refresh_properties_request
import capo_quicksight.types.describe_data_set_refresh_properties_response
...
) -> capo_quicksight.types.describe_data_set_refresh_properties_response.DescribeDataSetRefreshPropertiesResponse:
    out: capo_quicksight.types.describe_data_set_refresh_properties_response.DescribeDataSetRefreshPropertiesResponse = capo_quicksight.types.describe_data_set_refresh_properties_response.deserialize_json(
...
async def async_describe_data_set_refresh_properties(
