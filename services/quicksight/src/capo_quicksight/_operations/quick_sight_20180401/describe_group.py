"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeGroup``."""
...
import capo_quicksight.types.describe_group_request
import capo_quicksight.types.describe_group_response
...
) -> capo_quicksight.types.describe_group_response.DescribeGroupResponse:
    out: capo_quicksight.types.describe_group_response.DescribeGroupResponse = (
        capo_quicksight.types.describe_group_response.deserialize_json(
...
def describe_group(
    ...
    capo_quicksight.types.describe_group_response.DescribeGroupResponse, zapros.Response
]:
