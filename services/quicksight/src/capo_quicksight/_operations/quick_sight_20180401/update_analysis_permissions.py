...
import capo_quicksight.types.update_analysis_permissions_request
...
) -> capo_quicksight.types.update_analysis_permissions_response.UpdateAnalysisPermissionsResponse:
    out: capo_quicksight.types.update_analysis_permissions_response.UpdateAnalysisPermissionsResponse = capo_quicksight.types.update_analysis_permissions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_analysis_permissions_request.serialize_json(input_)
    ).encode()
