...
import capo_quicksight.errors.concurrent_updating_exception
...
import capo_quicksight.types.delete_iam_policy_assignment_request
import capo_quicksight.types.delete_iam_policy_assignment_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConcurrentUpdatingException":
            raise capo_quicksight.errors.concurrent_updating_exception.ConcurrentUpdatingException.from_json(
                data
            )
...
) -> capo_quicksight.types.delete_iam_policy_assignment_response.DeleteIAMPolicyAssignmentResponse:
    out: capo_quicksight.types.delete_iam_policy_assignment_response.DeleteIAMPolicyAssignmentResponse = capo_quicksight.types.delete_iam_policy_assignment_response.deserialize_json(
