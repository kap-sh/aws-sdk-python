...
) -> capo_quicksight.types.update_default_q_business_application_response.UpdateDefaultQBusinessApplicationResponse:
    out: capo_quicksight.types.update_default_q_business_application_response.UpdateDefaultQBusinessApplicationResponse = capo_quicksight.types.update_default_q_business_application_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_default_q_business_application_request.serialize_json(
            input_
        )
    ).encode()
