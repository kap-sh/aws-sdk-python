...
import capo_quicksight.types.describe_data_source_request
...
) -> capo_quicksight.types.describe_data_source_response.DescribeDataSourceResponse:
    out: capo_quicksight.types.describe_data_source_response.DescribeDataSourceResponse = capo_quicksight.types.describe_data_source_response.deserialize_json(
