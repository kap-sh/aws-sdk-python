...
import capo_quicksight.types.list_theme_aliases_request
import capo_quicksight.types.list_theme_aliases_response
import capo_quicksight.types.theme_alias_list
...
) -> capo_quicksight.types.list_theme_aliases_response.ListThemeAliasesResponse:
    out: capo_quicksight.types.list_theme_aliases_response.ListThemeAliasesResponse = (
        capo_quicksight.types.list_theme_aliases_response.deserialize_json(
