"""Generated from Smithy shape ``com.amazonaws.quicksight#SearchAgents``."""
...
import capo_quicksight.types.agent_summary_list
import capo_quicksight.types.search_agents_request
...
) -> capo_quicksight.types.search_agents_response.SearchAgentsResponse:
    out: capo_quicksight.types.search_agents_response.SearchAgentsResponse = (
        capo_quicksight.types.search_agents_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/search/agents"
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.search_agents_request.serialize_json(input_)
    ).encode()
...
def search_agents(
    ...
    capo_quicksight.types.search_agents_response.SearchAgentsResponse, zapros.Response
]:
