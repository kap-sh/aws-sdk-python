"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateIAMPolicyAssignment``."""
...
import capo_quicksight.types.create_iam_policy_assignment_request
...
) -> capo_quicksight.types.create_iam_policy_assignment_response.CreateIAMPolicyAssignmentResponse:
    out: capo_quicksight.types.create_iam_policy_assignment_response.CreateIAMPolicyAssignmentResponse = capo_quicksight.types.create_iam_policy_assignment_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_iam_policy_assignment_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_iam_policy_assignment(
