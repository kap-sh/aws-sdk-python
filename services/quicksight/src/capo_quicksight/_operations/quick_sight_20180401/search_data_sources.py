...
import capo_quicksight.types.data_source_summary_list
import capo_quicksight.types.search_data_sources_request
import capo_quicksight.types.search_data_sources_response
...
) -> capo_quicksight.types.search_data_sources_response.SearchDataSourcesResponse:
    out: capo_quicksight.types.search_data_sources_response.SearchDataSourcesResponse = capo_quicksight.types.search_data_sources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.search_data_sources_request.serialize_json(input_)
    ).encode()
