...
import capo_quicksight.types.describe_knowledge_base_permissions_request
...
) -> capo_quicksight.types.describe_knowledge_base_permissions_response.DescribeKnowledgeBasePermissionsResponse:
    out: capo_quicksight.types.describe_knowledge_base_permissions_response.DescribeKnowledgeBasePermissionsResponse = capo_quicksight.types.describe_knowledge_base_permissions_response.deserialize_json(
