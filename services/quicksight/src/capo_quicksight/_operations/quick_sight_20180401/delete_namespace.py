...
) -> capo_quicksight.types.delete_namespace_response.DeleteNamespaceResponse:
    out: capo_quicksight.types.delete_namespace_response.DeleteNamespaceResponse = (
        capo_quicksight.types.delete_namespace_response.deserialize_json(
