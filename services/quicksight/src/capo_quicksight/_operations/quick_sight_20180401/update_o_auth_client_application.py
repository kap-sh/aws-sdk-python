...
) -> capo_quicksight.types.update_o_auth_client_application_response.UpdateOAuthClientApplicationResponse:
    out: capo_quicksight.types.update_o_auth_client_application_response.UpdateOAuthClientApplicationResponse = capo_quicksight.types.update_o_auth_client_application_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_o_auth_client_application_request.serialize_json(
            input_
        )
    ).encode()
