...
) -> capo_quicksight.types.update_application_with_token_exchange_grant_response.UpdateApplicationWithTokenExchangeGrantResponse:
    out: capo_quicksight.types.update_application_with_token_exchange_grant_response.UpdateApplicationWithTokenExchangeGrantResponse = capo_quicksight.types.update_application_with_token_exchange_grant_response.deserialize_json(
