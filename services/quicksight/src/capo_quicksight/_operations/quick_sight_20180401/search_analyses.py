...
) -> capo_quicksight.types.search_analyses_response.SearchAnalysesResponse:
    out: capo_quicksight.types.search_analyses_response.SearchAnalysesResponse = (
        capo_quicksight.types.search_analyses_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.search_analyses_request.serialize_json(input_)
    ).encode()
