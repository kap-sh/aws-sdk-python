...
import capo_quicksight.types.update_theme_alias_request
import capo_quicksight.types.update_theme_alias_response
...
) -> capo_quicksight.types.update_theme_alias_response.UpdateThemeAliasResponse:
    out: capo_quicksight.types.update_theme_alias_response.UpdateThemeAliasResponse = (
        capo_quicksight.types.update_theme_alias_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_theme_alias_request.serialize_json(input_)
    ).encode()
