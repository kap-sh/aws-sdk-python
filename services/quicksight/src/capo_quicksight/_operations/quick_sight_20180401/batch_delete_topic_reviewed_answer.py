"""Generated from Smithy shape ``com.amazonaws.quicksight#BatchDeleteTopicReviewedAnswer``."""
...
) -> capo_quicksight.types.batch_delete_topic_reviewed_answer_response.BatchDeleteTopicReviewedAnswerResponse:
    out: capo_quicksight.types.batch_delete_topic_reviewed_answer_response.BatchDeleteTopicReviewedAnswerResponse = capo_quicksight.types.batch_delete_topic_reviewed_answer_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.batch_delete_topic_reviewed_answer_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_batch_delete_topic_reviewed_answer(
