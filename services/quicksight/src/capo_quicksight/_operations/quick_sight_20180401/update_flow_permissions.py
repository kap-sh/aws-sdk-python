...
import capo_quicksight.types.update_flow_permissions_output
...
) -> capo_quicksight.types.update_flow_permissions_output.UpdateFlowPermissionsOutput:
    out: capo_quicksight.types.update_flow_permissions_output.UpdateFlowPermissionsOutput = capo_quicksight.types.update_flow_permissions_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_flow_permissions_input.serialize_json(input_)
    ).encode()
