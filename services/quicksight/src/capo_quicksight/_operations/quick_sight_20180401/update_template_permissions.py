"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateTemplatePermissions``."""
...
import capo_quicksight.types.update_template_permissions_request
import capo_quicksight.types.update_template_permissions_response
...
) -> capo_quicksight.types.update_template_permissions_response.UpdateTemplatePermissionsResponse:
    out: capo_quicksight.types.update_template_permissions_response.UpdateTemplatePermissionsResponse = capo_quicksight.types.update_template_permissions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_template_permissions_request.serialize_json(input_)
    ).encode()
...
async def async_update_template_permissions(
