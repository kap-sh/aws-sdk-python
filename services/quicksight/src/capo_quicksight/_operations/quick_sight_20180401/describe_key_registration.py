"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeKeyRegistration``."""
...
import capo_quicksight.types.describe_key_registration_request
import capo_quicksight.types.describe_key_registration_response
...
) -> capo_quicksight.types.describe_key_registration_response.DescribeKeyRegistrationResponse:
    out: capo_quicksight.types.describe_key_registration_response.DescribeKeyRegistrationResponse = capo_quicksight.types.describe_key_registration_response.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    params["default-key-only"] = str(input_.get("default_key_only", False))
...
async def async_describe_key_registration(
