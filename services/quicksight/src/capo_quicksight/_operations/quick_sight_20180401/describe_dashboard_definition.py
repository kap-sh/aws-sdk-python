"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeDashboardDefinition``."""
...
import capo_quicksight.types.describe_dashboard_definition_request
import capo_quicksight.types.describe_dashboard_definition_response
...
) -> capo_quicksight.types.describe_dashboard_definition_response.DescribeDashboardDefinitionResponse:
    out: capo_quicksight.types.describe_dashboard_definition_response.DescribeDashboardDefinitionResponse = capo_quicksight.types.describe_dashboard_definition_response.deserialize_json(
...
async def async_describe_dashboard_definition(
