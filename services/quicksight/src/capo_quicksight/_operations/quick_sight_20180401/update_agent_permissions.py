"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateAgentPermissions``."""
...
import capo_quicksight.types.update_agent_permissions_request
...
import capo_quicksight.types.update_agent_permissions_response
...
) -> capo_quicksight.types.update_agent_permissions_response.UpdateAgentPermissionsResponse:
    out: capo_quicksight.types.update_agent_permissions_response.UpdateAgentPermissionsResponse = capo_quicksight.types.update_agent_permissions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_agent_permissions_request.serialize_json(input_)
    ).encode()
...
async def async_update_agent_permissions(
