"""Generated from Smithy shape ``com.amazonaws.quicksight#ListTemplateAliases``."""
...
import capo_quicksight.types.list_template_aliases_request
import capo_quicksight.types.list_template_aliases_response
import capo_quicksight.types.template_alias_list
...
) -> capo_quicksight.types.list_template_aliases_response.ListTemplateAliasesResponse:
    out: capo_quicksight.types.list_template_aliases_response.ListTemplateAliasesResponse = capo_quicksight.types.list_template_aliases_response.deserialize_json(
...
async def async_list_template_aliases(
