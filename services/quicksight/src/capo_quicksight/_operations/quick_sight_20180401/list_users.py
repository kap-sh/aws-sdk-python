...
import capo_quicksight.types.list_users_request
import capo_quicksight.types.list_users_response
...
) -> capo_quicksight.types.list_users_response.ListUsersResponse:
    out: capo_quicksight.types.list_users_response.ListUsersResponse = (
        capo_quicksight.types.list_users_response.deserialize_json(
...
def list_users(
    ...
    capo_quicksight.types.list_users_response.ListUsersResponse, zapros.Response
]:
