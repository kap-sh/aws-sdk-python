"""Generated from Smithy shape ``com.amazonaws.quicksight#ListTopicRefreshSchedules``."""
...
import capo_quicksight.types.list_topic_refresh_schedules_request
import capo_quicksight.types.list_topic_refresh_schedules_response
...
) -> capo_quicksight.types.list_topic_refresh_schedules_response.ListTopicRefreshSchedulesResponse:
    out: capo_quicksight.types.list_topic_refresh_schedules_response.ListTopicRefreshSchedulesResponse = capo_quicksight.types.list_topic_refresh_schedules_response.deserialize_json(
...
async def async_list_topic_refresh_schedules(
