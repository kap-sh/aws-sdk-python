...
def handle_response(
    ...
    capo_quicksight.types.update_brand_assignment_response.UpdateBrandAssignmentResponse
):
    out: capo_quicksight.types.update_brand_assignment_response.UpdateBrandAssignmentResponse = capo_quicksight.types.update_brand_assignment_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_brand_assignment_request.serialize_json(input_)
    ).encode()
