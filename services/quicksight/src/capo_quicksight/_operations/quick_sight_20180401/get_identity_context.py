...
import capo_quicksight.types.get_identity_context_request
...
) -> capo_quicksight.types.get_identity_context_response.GetIdentityContextResponse:
    out: capo_quicksight.types.get_identity_context_response.GetIdentityContextResponse = capo_quicksight.types.get_identity_context_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.get_identity_context_request.serialize_json(input_)
    ).encode()
