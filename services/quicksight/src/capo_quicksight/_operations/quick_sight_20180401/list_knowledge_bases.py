"""Generated from Smithy shape ``com.amazonaws.quicksight#ListKnowledgeBases``."""
...
) -> capo_quicksight.types.list_knowledge_bases_response.ListKnowledgeBasesResponse:
    out: capo_quicksight.types.list_knowledge_bases_response.ListKnowledgeBasesResponse = capo_quicksight.types.list_knowledge_bases_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/accounts/{AwsAccountId}/knowledge-bases"
