...
import capo_quicksight.types.iam_policy_assignment_summary_list
import capo_quicksight.types.list_iam_policy_assignments_request
import capo_quicksight.types.list_iam_policy_assignments_response
...
) -> capo_quicksight.types.list_iam_policy_assignments_response.ListIAMPolicyAssignmentsResponse:
    out: capo_quicksight.types.list_iam_policy_assignments_response.ListIAMPolicyAssignmentsResponse = capo_quicksight.types.list_iam_policy_assignments_response.deserialize_json(
