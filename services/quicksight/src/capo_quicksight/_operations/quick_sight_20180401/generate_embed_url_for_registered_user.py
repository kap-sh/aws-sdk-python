"""Generated from Smithy shape ``com.amazonaws.quicksight#GenerateEmbedUrlForRegisteredUser``."""
...
import capo_quicksight.errors.quick_sight_user_not_found_exception
...
import capo_quicksight.types.generate_embed_url_for_registered_user_request
import capo_quicksight.types.generate_embed_url_for_registered_user_response
...
) -> capo_quicksight.types.generate_embed_url_for_registered_user_response.GenerateEmbedUrlForRegisteredUserResponse:
    out: capo_quicksight.types.generate_embed_url_for_registered_user_response.GenerateEmbedUrlForRegisteredUserResponse = capo_quicksight.types.generate_embed_url_for_registered_user_response.deserialize_json(
...
async def async_generate_embed_url_for_registered_user(
