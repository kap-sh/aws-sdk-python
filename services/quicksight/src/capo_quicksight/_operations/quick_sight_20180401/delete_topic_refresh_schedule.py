"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteTopicRefreshSchedule``."""
...
import capo_quicksight.types.delete_topic_refresh_schedule_request
...
) -> capo_quicksight.types.delete_topic_refresh_schedule_response.DeleteTopicRefreshScheduleResponse:
    out: capo_quicksight.types.delete_topic_refresh_schedule_response.DeleteTopicRefreshScheduleResponse = capo_quicksight.types.delete_topic_refresh_schedule_response.deserialize_json(
...
async def async_delete_topic_refresh_schedule(
