"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeAnalysisPermissions``."""
...
import capo_quicksight.types.describe_analysis_permissions_request
...
) -> capo_quicksight.types.describe_analysis_permissions_response.DescribeAnalysisPermissionsResponse:
    out: capo_quicksight.types.describe_analysis_permissions_response.DescribeAnalysisPermissionsResponse = capo_quicksight.types.describe_analysis_permissions_response.deserialize_json(
...
async def async_describe_analysis_permissions(
