...
import capo_quicksight.errors.invalid_data_set_parameter_value_exception
...
import capo_quicksight.types.create_data_set_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDataSetParameterValueException":
            raise capo_quicksight.errors.invalid_data_set_parameter_value_exception.InvalidDataSetParameterValueException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_quicksight.types.create_data_set_response.CreateDataSetResponse = (
        capo_quicksight.types.create_data_set_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_data_set_request.serialize_json(input_)
    ).encode()
