...
) -> capo_quicksight.types.describe_user_response.DescribeUserResponse:
    out: capo_quicksight.types.describe_user_response.DescribeUserResponse = (
        capo_quicksight.types.describe_user_response.deserialize_json(
...
def describe_user(
    ...
    capo_quicksight.types.describe_user_response.DescribeUserResponse, zapros.Response
]:
