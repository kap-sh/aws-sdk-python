"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeAgent``."""
...
import capo_quicksight.types.agent
import capo_quicksight.types.describe_agent_request
import capo_quicksight.types.describe_agent_response
...
) -> capo_quicksight.types.describe_agent_response.DescribeAgentResponse:
    out: capo_quicksight.types.describe_agent_response.DescribeAgentResponse = (
        capo_quicksight.types.describe_agent_response.deserialize_json(
...
def describe_agent(
    ...
    capo_quicksight.types.describe_agent_response.DescribeAgentResponse, zapros.Response
]:
...
async def async_describe_agent(
