"""Generated from Smithy shape ``com.amazonaws.quicksight#ListAnalyses``."""
...
) -> capo_quicksight.types.list_analyses_response.ListAnalysesResponse:
    out: capo_quicksight.types.list_analyses_response.ListAnalysesResponse = (
        capo_quicksight.types.list_analyses_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/analyses"
...
def list_analyses(
    ...
    capo_quicksight.types.list_analyses_response.ListAnalysesResponse, zapros.Response
]:
