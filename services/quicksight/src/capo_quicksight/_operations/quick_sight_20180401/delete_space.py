"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteSpace``."""
...
import capo_quicksight.types.delete_space_request
import capo_quicksight.types.delete_space_response
...
) -> capo_quicksight.types.delete_space_response.DeleteSpaceResponse:
    out: capo_quicksight.types.delete_space_response.DeleteSpaceResponse = (
        capo_quicksight.types.delete_space_response.deserialize_json(
...
def delete_space(
    ...
    capo_quicksight.types.delete_space_response.DeleteSpaceResponse, zapros.Response
]:
