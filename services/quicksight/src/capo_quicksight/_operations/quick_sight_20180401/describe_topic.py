"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeTopic``."""
...
) -> capo_quicksight.types.describe_topic_response.DescribeTopicResponse:
    out: capo_quicksight.types.describe_topic_response.DescribeTopicResponse = (
        capo_quicksight.types.describe_topic_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/topics/{TopicId}"
...
def describe_topic(
    ...
    capo_quicksight.types.describe_topic_response.DescribeTopicResponse, zapros.Response
]:
...
async def async_describe_topic(
