"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteDataSetRefreshProperties``."""
...
import capo_quicksight.types.delete_data_set_refresh_properties_request
import capo_quicksight.types.delete_data_set_refresh_properties_response
...
) -> capo_quicksight.types.delete_data_set_refresh_properties_response.DeleteDataSetRefreshPropertiesResponse:
    out: capo_quicksight.types.delete_data_set_refresh_properties_response.DeleteDataSetRefreshPropertiesResponse = capo_quicksight.types.delete_data_set_refresh_properties_response.deserialize_json(
...
async def async_delete_data_set_refresh_properties(
