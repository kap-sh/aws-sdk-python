"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateSPICECapacityConfiguration``."""
...
import capo_quicksight.types.update_spice_capacity_configuration_request
import capo_quicksight.types.update_spice_capacity_configuration_response
...
) -> capo_quicksight.types.update_spice_capacity_configuration_response.UpdateSPICECapacityConfigurationResponse:
    out: capo_quicksight.types.update_spice_capacity_configuration_response.UpdateSPICECapacityConfigurationResponse = capo_quicksight.types.update_spice_capacity_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_spice_capacity_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_spice_capacity_configuration(
