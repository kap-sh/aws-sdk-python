"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateAccountCustomPermission``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_account_custom_permission_response.UpdateAccountCustomPermissionResponse = aws_sdk_quicksight.types.update_account_custom_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_account_custom_permission_request.UpdateAccountCustomPermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/custom-permission"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_account_custom_permission_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_account_custom_permission(
