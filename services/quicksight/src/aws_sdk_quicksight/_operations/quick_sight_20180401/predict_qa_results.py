...
def build_request(
    ...
    input: aws_sdk_quicksight.types.predict_qa_results_request.PredictQAResultsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.predict_qa_results_request.serialize_json(input)
    ).encode()
