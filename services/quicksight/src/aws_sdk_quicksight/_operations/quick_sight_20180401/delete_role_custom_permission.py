...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_role_custom_permission_response.DeleteRoleCustomPermissionResponse = aws_sdk_quicksight.types.delete_role_custom_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_role_custom_permission_request.DeleteRoleCustomPermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
