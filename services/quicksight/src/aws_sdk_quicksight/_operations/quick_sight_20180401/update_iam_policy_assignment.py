...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_iam_policy_assignment_request.UpdateIAMPolicyAssignmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        "{AssignmentName}", quote(str(input_["assignment_name"]), safe="")
    )
