"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateIAMPolicyAssignment``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConcurrentUpdatingException":
            import aws_sdk_quicksight.errors.concurrent_updating_exception

            raise aws_sdk_quicksight.errors.concurrent_updating_exception.ConcurrentUpdatingException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_iam_policy_assignment_response.UpdateIAMPolicyAssignmentResponse = aws_sdk_quicksight.types.update_iam_policy_assignment_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_iam_policy_assignment_request.UpdateIAMPolicyAssignmentRequest,
) -> zapros.Request:
    ...
    url = url.replace("{AssignmentName}", quote(str(input["assignment_name"]), safe=""))
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_iam_policy_assignment_request.serialize_json(
            input
        )
    ).encode()
...
async def async_update_iam_policy_assignment(
