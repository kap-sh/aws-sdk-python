...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_data_set_refresh_properties_response.DescribeDataSetRefreshPropertiesResponse = aws_sdk_quicksight.types.describe_data_set_refresh_properties_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_data_set_refresh_properties_request.DescribeDataSetRefreshPropertiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
