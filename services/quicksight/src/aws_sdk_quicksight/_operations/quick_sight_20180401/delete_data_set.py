"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteDataSet``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_data_set_response.DeleteDataSetResponse = (
        aws_sdk_quicksight.types.delete_data_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_data_set_request.DeleteDataSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
