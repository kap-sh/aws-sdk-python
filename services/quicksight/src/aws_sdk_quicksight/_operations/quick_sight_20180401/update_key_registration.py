"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateKeyRegistration``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_key_registration_response.UpdateKeyRegistrationResponse = aws_sdk_quicksight.types.update_key_registration_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_key_registration_request.UpdateKeyRegistrationRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/key-registration"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_key_registration_request.serialize_json(input)
    ).encode()
...
async def async_update_key_registration(
