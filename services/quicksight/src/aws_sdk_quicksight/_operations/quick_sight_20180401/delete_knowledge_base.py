"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteKnowledgeBase``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_knowledge_base_response.DeleteKnowledgeBaseResponse = aws_sdk_quicksight.types.delete_knowledge_base_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_knowledge_base_request.DeleteKnowledgeBaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
