"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteDashboard``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_dashboard_response.DeleteDashboardResponse = (
        aws_sdk_quicksight.types.delete_dashboard_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.delete_dashboard_request.DeleteDashboardRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/dashboards/{DashboardId}"
