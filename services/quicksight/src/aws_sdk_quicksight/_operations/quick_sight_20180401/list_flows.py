...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_flows_output.ListFlowsOutput = (
        aws_sdk_quicksight.types.list_flows_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_flows_input.ListFlowsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_flows(
    ...
    input_: aws_sdk_quicksight.types.list_flows_input.ListFlowsInput,
) -> tuple[aws_sdk_quicksight.types.list_flows_output.ListFlowsOutput, zapros.Response]:
