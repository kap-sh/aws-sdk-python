...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_action_connector_request.UpdateActionConnectorRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_action_connector_request.serialize_json(input)
    ).encode()
