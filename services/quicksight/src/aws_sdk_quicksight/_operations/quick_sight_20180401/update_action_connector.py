"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateActionConnector``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_action_connector_response.UpdateActionConnectorResponse = aws_sdk_quicksight.types.update_action_connector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_action_connector_request.UpdateActionConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/accounts/{AwsAccountId}/action-connectors/{ActionConnectorId}"
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_action_connector_request.serialize_json(input_)
    ).encode()
...
async def async_update_action_connector(
