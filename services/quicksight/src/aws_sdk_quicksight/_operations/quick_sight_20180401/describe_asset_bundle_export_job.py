"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeAssetBundleExportJob``."""
...
import aws_sdk_quicksight.types.asset_bundle_export_job_error_list
...
import aws_sdk_quicksight.types.asset_bundle_export_job_warning_list
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_asset_bundle_export_job_response.DescribeAssetBundleExportJobResponse = aws_sdk_quicksight.types.describe_asset_bundle_export_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_asset_bundle_export_job_request.DescribeAssetBundleExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["asset_bundle_export_job_id"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_describe_asset_bundle_export_job(
