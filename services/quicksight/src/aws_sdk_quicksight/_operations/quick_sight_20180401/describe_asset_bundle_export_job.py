...
def build_request(
    ...
    input: aws_sdk_quicksight.types.describe_asset_bundle_export_job_request.DescribeAssetBundleExportJobRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["asset_bundle_export_job_id"]), safe=""),
    )
    params: dict[str, str] = {}
