...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_folder_permissions_response.DescribeFolderPermissionsResponse = aws_sdk_quicksight.types.describe_folder_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_folder_permissions_request.DescribeFolderPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
