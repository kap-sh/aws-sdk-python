"""Generated from Smithy shape ``com.amazonaws.quicksight#ListGroupMemberships``."""
...
import aws_sdk_quicksight.errors.invalid_next_token_exception
...
import aws_sdk_quicksight.types.group_member_list
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidNextTokenException":
            raise aws_sdk_quicksight.errors.invalid_next_token_exception.InvalidNextTokenException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_group_memberships_response.ListGroupMembershipsResponse = aws_sdk_quicksight.types.list_group_memberships_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_group_memberships_request.ListGroupMembershipsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{GroupName}", quote(str(input_["group_name"]), safe=""))
