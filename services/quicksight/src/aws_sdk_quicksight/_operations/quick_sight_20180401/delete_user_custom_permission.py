"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteUserCustomPermission``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_user_custom_permission_response.DeleteUserCustomPermissionResponse = aws_sdk_quicksight.types.delete_user_custom_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_user_custom_permission_request.DeleteUserCustomPermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_user_custom_permission(
