...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_analysis_definition_response.DescribeAnalysisDefinitionResponse = aws_sdk_quicksight.types.describe_analysis_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_analysis_definition_request.DescribeAnalysisDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
