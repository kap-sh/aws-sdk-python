...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_brand_assignment_response.DescribeBrandAssignmentResponse = aws_sdk_quicksight.types.describe_brand_assignment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_brand_assignment_request.DescribeBrandAssignmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
