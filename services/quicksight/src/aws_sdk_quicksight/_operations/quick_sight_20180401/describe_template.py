...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_template_response.DescribeTemplateResponse = aws_sdk_quicksight.types.describe_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_template_request.DescribeTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
