...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_space_response.CreateSpaceResponse = (
        aws_sdk_quicksight.types.create_space_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_space_request.CreateSpaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_space_request.serialize_json(input_)
    ).encode()
...
def create_space(
    ...
    aws_sdk_quicksight.types.create_space_response.CreateSpaceResponse, zapros.Response
]:
