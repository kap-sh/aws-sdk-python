...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_data_set_refresh_properties_response.DeleteDataSetRefreshPropertiesResponse = aws_sdk_quicksight.types.delete_data_set_refresh_properties_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_data_set_refresh_properties_request.DeleteDataSetRefreshPropertiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
