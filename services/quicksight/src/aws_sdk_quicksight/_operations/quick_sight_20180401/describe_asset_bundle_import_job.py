"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeAssetBundleImportJob``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_asset_bundle_import_job_response.DescribeAssetBundleImportJobResponse = aws_sdk_quicksight.types.describe_asset_bundle_import_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_asset_bundle_import_job_request.DescribeAssetBundleImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["asset_bundle_import_job_id"]), safe=""),
    )
    params: dict[str, str] = {}
...
async def async_describe_asset_bundle_import_job(
