...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_role_membership_response.CreateRoleMembershipResponse = aws_sdk_quicksight.types.create_role_membership_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_role_membership_request.CreateRoleMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
