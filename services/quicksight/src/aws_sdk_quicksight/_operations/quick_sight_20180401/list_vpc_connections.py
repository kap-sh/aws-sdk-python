"""Generated from Smithy shape ``com.amazonaws.quicksight#ListVPCConnections``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_vpc_connections_response.ListVPCConnectionsResponse = aws_sdk_quicksight.types.list_vpc_connections_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_vpc_connections_request.ListVPCConnectionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/vpc-connections"
...
async def async_list_vpc_connections(
