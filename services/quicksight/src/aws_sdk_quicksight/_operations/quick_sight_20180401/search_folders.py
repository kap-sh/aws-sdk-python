...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.search_folders_response.SearchFoldersResponse = (
        aws_sdk_quicksight.types.search_folders_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.search_folders_request.SearchFoldersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.search_folders_request.serialize_json(input_)
    ).encode()
