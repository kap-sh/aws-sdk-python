"""Generated from Smithy shape ``com.amazonaws.quicksight#GetFlowMetadata``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.get_flow_metadata_output.GetFlowMetadataOutput = (
        aws_sdk_quicksight.types.get_flow_metadata_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.get_flow_metadata_input.GetFlowMetadataInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/flows/{FlowId}/metadata"
...
async def async_get_flow_metadata(
