"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeDataSourcePermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_data_source_permissions_response.DescribeDataSourcePermissionsResponse = aws_sdk_quicksight.types.describe_data_source_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_data_source_permissions_request.DescribeDataSourcePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_data_source_permissions(
