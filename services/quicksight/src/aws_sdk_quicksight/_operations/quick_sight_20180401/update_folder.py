...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_folder_response.UpdateFolderResponse = (
        aws_sdk_quicksight.types.update_folder_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_folder_request.UpdateFolderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_folder_request.serialize_json(input_)
    ).encode()
