"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateAnalysis``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_analysis_response.CreateAnalysisResponse = (
        aws_sdk_quicksight.types.create_analysis_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.create_analysis_request.CreateAnalysisRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_analysis_request.serialize_json(input)
    ).encode()
...
async def async_create_analysis(
