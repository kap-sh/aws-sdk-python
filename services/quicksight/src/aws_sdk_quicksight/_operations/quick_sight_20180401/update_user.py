"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateUser``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_user_response.UpdateUserResponse = (
        aws_sdk_quicksight.types.update_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_user_request.UpdateUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_user_request.serialize_json(input_)
    ).encode()
...
def update_user(
    ...
    aws_sdk_quicksight.types.update_user_response.UpdateUserResponse, zapros.Response
]:
