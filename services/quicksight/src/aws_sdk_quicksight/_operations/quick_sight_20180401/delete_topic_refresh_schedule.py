...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_topic_refresh_schedule_response.DeleteTopicRefreshScheduleResponse = aws_sdk_quicksight.types.delete_topic_refresh_schedule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_topic_refresh_schedule_request.DeleteTopicRefreshScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
