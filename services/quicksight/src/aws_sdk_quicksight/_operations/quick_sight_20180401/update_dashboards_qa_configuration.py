...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_dashboards_qa_configuration_response.UpdateDashboardsQAConfigurationResponse = aws_sdk_quicksight.types.update_dashboards_qa_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_dashboards_qa_configuration_request.UpdateDashboardsQAConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_dashboards_qa_configuration_request.serialize_json(
            input_
        )
    ).encode()
