...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_self_upgrade_request.UpdateSelfUpgradeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_self_upgrade_request.serialize_json(input)
    ).encode()
