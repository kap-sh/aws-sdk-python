...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_self_upgrade_response.UpdateSelfUpgradeResponse = aws_sdk_quicksight.types.update_self_upgrade_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_self_upgrade_request.UpdateSelfUpgradeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_self_upgrade_request.serialize_json(input_)
    ).encode()
