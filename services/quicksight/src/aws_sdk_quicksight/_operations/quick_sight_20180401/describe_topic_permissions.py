...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_topic_permissions_response.DescribeTopicPermissionsResponse = aws_sdk_quicksight.types.describe_topic_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_topic_permissions_request.DescribeTopicPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
