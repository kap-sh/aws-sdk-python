...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_identity_propagation_config_response.DeleteIdentityPropagationConfigResponse = aws_sdk_quicksight.types.delete_identity_propagation_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_identity_propagation_config_request.DeleteIdentityPropagationConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
