...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_template_aliases_response.ListTemplateAliasesResponse = aws_sdk_quicksight.types.list_template_aliases_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_template_aliases_request.ListTemplateAliasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
