"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeUser``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_user_response.DescribeUserResponse = (
        aws_sdk_quicksight.types.describe_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_user_request.DescribeUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
