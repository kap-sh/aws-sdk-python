"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeThemeAlias``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_theme_alias_response.DescribeThemeAliasResponse = aws_sdk_quicksight.types.describe_theme_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_theme_alias_request.DescribeThemeAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_theme_alias(
