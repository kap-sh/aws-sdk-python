...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_account_settings_response.DescribeAccountSettingsResponse = aws_sdk_quicksight.types.describe_account_settings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_account_settings_request.DescribeAccountSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
