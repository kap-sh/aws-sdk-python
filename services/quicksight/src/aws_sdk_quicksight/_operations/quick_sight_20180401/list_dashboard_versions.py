...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_dashboard_versions_response.ListDashboardVersionsResponse = aws_sdk_quicksight.types.list_dashboard_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_dashboard_versions_request.ListDashboardVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
