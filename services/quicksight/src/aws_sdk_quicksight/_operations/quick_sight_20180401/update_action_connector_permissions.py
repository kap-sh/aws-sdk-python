...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_action_connector_permissions_response.UpdateActionConnectorPermissionsResponse = aws_sdk_quicksight.types.update_action_connector_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_action_connector_permissions_request.UpdateActionConnectorPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
