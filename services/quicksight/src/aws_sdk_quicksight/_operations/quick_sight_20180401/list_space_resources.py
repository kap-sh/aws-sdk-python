"""Generated from Smithy shape ``com.amazonaws.quicksight#ListSpaceResources``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_space_resources_response.ListSpaceResourcesResponse = aws_sdk_quicksight.types.list_space_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_space_resources_request.ListSpaceResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/v1/accounts/{AwsAccountId}/spaces/{SpaceId}/resources"
    )
...
async def async_list_space_resources(
