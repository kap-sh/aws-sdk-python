...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_knowledge_base_response.DescribeKnowledgeBaseResponse = aws_sdk_quicksight.types.describe_knowledge_base_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_knowledge_base_request.DescribeKnowledgeBaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
