...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_namespaces_response.ListNamespacesResponse = (
        aws_sdk_quicksight.types.list_namespaces_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_namespaces_request.ListNamespacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
