"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeVPCConnection``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_vpc_connection_response.DescribeVPCConnectionResponse = aws_sdk_quicksight.types.describe_vpc_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_vpc_connection_request.DescribeVPCConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_vpc_connection(
