"""Generated from Smithy shape ``com.amazonaws.quicksight#SearchFlows``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.search_flows_output.SearchFlowsOutput = (
        aws_sdk_quicksight.types.search_flows_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.search_flows_input.SearchFlowsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/flows/searchFlows"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.search_flows_input.serialize_json(input_)
    ).encode()
...
def search_flows(
    ...
    aws_sdk_quicksight.types.search_flows_output.SearchFlowsOutput, zapros.Response
]:
