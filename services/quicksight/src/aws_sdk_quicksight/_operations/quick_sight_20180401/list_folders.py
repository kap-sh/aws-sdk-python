...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_folders_response.ListFoldersResponse = (
        aws_sdk_quicksight.types.list_folders_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_folders_request.ListFoldersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_folders(
    ...
    aws_sdk_quicksight.types.list_folders_response.ListFoldersResponse, zapros.Response
]:
