"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteNamespace``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_namespace_response.DeleteNamespaceResponse = (
        aws_sdk_quicksight.types.delete_namespace_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_namespace_request.DeleteNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
