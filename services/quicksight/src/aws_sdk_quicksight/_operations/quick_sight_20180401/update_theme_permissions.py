"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateThemePermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_theme_permissions_response.UpdateThemePermissionsResponse = aws_sdk_quicksight.types.update_theme_permissions_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_theme_permissions_request.UpdateThemePermissionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_theme_permissions_request.serialize_json(input)
    ).encode()
...
async def async_update_theme_permissions(
