...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_theme_permissions_request.UpdateThemePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_theme_permissions_request.serialize_json(input_)
    ).encode()
