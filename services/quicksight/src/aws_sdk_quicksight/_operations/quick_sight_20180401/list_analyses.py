...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_analyses_response.ListAnalysesResponse = (
        aws_sdk_quicksight.types.list_analyses_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_analyses_request.ListAnalysesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
