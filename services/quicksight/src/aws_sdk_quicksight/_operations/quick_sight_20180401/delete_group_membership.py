"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteGroupMembership``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_group_membership_response.DeleteGroupMembershipResponse = aws_sdk_quicksight.types.delete_group_membership_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_group_membership_request.DeleteGroupMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
