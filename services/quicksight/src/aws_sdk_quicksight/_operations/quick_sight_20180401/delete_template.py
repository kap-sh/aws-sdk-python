...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_template_response.DeleteTemplateResponse = (
        aws_sdk_quicksight.types.delete_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_template_request.DeleteTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
