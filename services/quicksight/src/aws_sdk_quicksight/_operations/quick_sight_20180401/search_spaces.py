"""Generated from Smithy shape ``com.amazonaws.quicksight#SearchSpaces``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.search_spaces_response.SearchSpacesResponse = (
        aws_sdk_quicksight.types.search_spaces_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.search_spaces_request.SearchSpacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/accounts/{AwsAccountId}/search/spaces"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.search_spaces_request.serialize_json(input_)
    ).encode()
