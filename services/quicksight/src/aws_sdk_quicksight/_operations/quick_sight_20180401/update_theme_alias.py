"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateThemeAlias``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_theme_alias_response.UpdateThemeAliasResponse = aws_sdk_quicksight.types.update_theme_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_theme_alias_request.UpdateThemeAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_theme_alias_request.serialize_json(input_)
    ).encode()
...
async def async_update_theme_alias(
