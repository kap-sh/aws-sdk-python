...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_theme_alias_request.UpdateThemeAliasRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_theme_alias_request.serialize_json(input)
    ).encode()
