"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateTheme``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_theme_response.UpdateThemeResponse = (
        aws_sdk_quicksight.types.update_theme_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_theme_request.UpdateThemeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_theme_request.serialize_json(input)
    ).encode()
...
def update_theme(
    ...
    aws_sdk_quicksight.types.update_theme_response.UpdateThemeResponse, zapros.Response
]:
