...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_template_permissions_response.DescribeTemplatePermissionsResponse = aws_sdk_quicksight.types.describe_template_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_template_permissions_request.DescribeTemplatePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
