"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateGroupMembership``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_group_membership_response.CreateGroupMembershipResponse = aws_sdk_quicksight.types.create_group_membership_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_group_membership_request.CreateGroupMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_group_membership(
