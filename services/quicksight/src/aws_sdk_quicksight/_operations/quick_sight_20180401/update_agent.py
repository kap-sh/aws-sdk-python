"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateAgent``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_agent_response.UpdateAgentResponse = (
        aws_sdk_quicksight.types.update_agent_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_agent_request.UpdateAgentRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/agents/{AgentId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_agent_request.serialize_json(input)
    ).encode()
...
def update_agent(
    ...
    aws_sdk_quicksight.types.update_agent_response.UpdateAgentResponse, zapros.Response
]:
