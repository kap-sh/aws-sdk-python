...
def build_request(
    ...
    input: aws_sdk_quicksight.types.list_users_index_capacity_request.ListUsersIndexCapacityRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.list_users_index_capacity_request.serialize_json(input)
    ).encode()
