"""Generated from Smithy shape ``com.amazonaws.quicksight#ListRoleMemberships``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_role_memberships_response.ListRoleMembershipsResponse = aws_sdk_quicksight.types.list_role_memberships_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_role_memberships_request.ListRoleMembershipsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_role_memberships(
