"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateKnowledgeBasePermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_knowledge_base_permissions_response.UpdateKnowledgeBasePermissionsResponse = aws_sdk_quicksight.types.update_knowledge_base_permissions_response.deserialize_json(
