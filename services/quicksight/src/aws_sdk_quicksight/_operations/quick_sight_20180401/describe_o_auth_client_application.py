"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeOAuthClientApplication``."""
...
import aws_sdk_quicksight.types.o_auth_client_application
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_o_auth_client_application_response.DescribeOAuthClientApplicationResponse = aws_sdk_quicksight.types.describe_o_auth_client_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_o_auth_client_application_request.DescribeOAuthClientApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_o_auth_client_application(
