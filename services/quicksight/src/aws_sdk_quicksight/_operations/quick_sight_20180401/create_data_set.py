"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateDataSet``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDataSetParameterValueException":
            import aws_sdk_quicksight.errors.invalid_data_set_parameter_value_exception

            raise aws_sdk_quicksight.errors.invalid_data_set_parameter_value_exception.InvalidDataSetParameterValueException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_data_set_response.CreateDataSetResponse = (
        aws_sdk_quicksight.types.create_data_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_data_set_request.CreateDataSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/data-sets"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_data_set_request.serialize_json(input_)
    ).encode()
...
async def async_create_data_set(
