...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.generate_embed_url_for_anonymous_user_response.GenerateEmbedUrlForAnonymousUserResponse = aws_sdk_quicksight.types.generate_embed_url_for_anonymous_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.generate_embed_url_for_anonymous_user_request.GenerateEmbedUrlForAnonymousUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.generate_embed_url_for_anonymous_user_request.serialize_json(
            input_
        )
    ).encode()
