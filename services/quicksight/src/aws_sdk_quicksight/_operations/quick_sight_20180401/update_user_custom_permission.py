...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_user_custom_permission_request.UpdateUserCustomPermissionRequest,
) -> zapros.Request:
    ...
    url = url.replace("{UserName}", quote(str(input["user_name"]), safe=""))
