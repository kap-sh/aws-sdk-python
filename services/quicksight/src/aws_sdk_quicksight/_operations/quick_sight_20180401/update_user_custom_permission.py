"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateUserCustomPermission``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_user_custom_permission_response.UpdateUserCustomPermissionResponse = aws_sdk_quicksight.types.update_user_custom_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_user_custom_permission_request.UpdateUserCustomPermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/accounts/{AwsAccountId}/namespaces/{Namespace}/users/{UserName}/custom-permission"
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_user_custom_permission_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_user_custom_permission(
