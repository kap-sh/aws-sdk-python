...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_default_q_business_application_response.DeleteDefaultQBusinessApplicationResponse = aws_sdk_quicksight.types.delete_default_q_business_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_default_q_business_application_request.DeleteDefaultQBusinessApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
