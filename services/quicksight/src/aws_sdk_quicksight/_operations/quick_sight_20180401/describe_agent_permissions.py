...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_agent_permissions_response.DescribeAgentPermissionsResponse = aws_sdk_quicksight.types.describe_agent_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_agent_permissions_request.DescribeAgentPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
