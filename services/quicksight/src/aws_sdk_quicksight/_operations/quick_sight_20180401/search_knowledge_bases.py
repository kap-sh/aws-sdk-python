...
def build_request(
    ...
    input: aws_sdk_quicksight.types.search_knowledge_bases_request.SearchKnowledgeBasesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.search_knowledge_bases_request.serialize_json(input)
    ).encode()
