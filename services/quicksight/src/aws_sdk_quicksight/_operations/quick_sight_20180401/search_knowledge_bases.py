...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.search_knowledge_bases_response.SearchKnowledgeBasesResponse = aws_sdk_quicksight.types.search_knowledge_bases_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.search_knowledge_bases_request.SearchKnowledgeBasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.search_knowledge_bases_request.serialize_json(input_)
    ).encode()
