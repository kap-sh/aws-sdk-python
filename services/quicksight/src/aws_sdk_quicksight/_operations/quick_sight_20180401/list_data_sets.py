...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_data_sets_response.ListDataSetsResponse = (
        aws_sdk_quicksight.types.list_data_sets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_data_sets_request.ListDataSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
