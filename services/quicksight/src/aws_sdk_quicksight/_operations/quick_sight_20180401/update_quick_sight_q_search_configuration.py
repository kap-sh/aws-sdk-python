...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_quick_sight_q_search_configuration_response.UpdateQuickSightQSearchConfigurationResponse = aws_sdk_quicksight.types.update_quick_sight_q_search_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_quick_sight_q_search_configuration_request.UpdateQuickSightQSearchConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_quick_sight_q_search_configuration_request.serialize_json(
            input_
        )
    ).encode()
