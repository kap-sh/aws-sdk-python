"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateDashboardPermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_dashboard_permissions_response.UpdateDashboardPermissionsResponse = aws_sdk_quicksight.types.update_dashboard_permissions_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_dashboard_permissions_request.UpdateDashboardPermissionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_dashboard_permissions_request.serialize_json(
            input
        )
    ).encode()
...
async def async_update_dashboard_permissions(
