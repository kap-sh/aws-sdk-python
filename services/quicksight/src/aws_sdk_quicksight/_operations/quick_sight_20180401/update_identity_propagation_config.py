...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_identity_propagation_config_request.UpdateIdentityPropagationConfigRequest,
) -> zapros.Request:
    ...
    url = url.replace("{Service}", quote(str(input["service"]), safe=""))
    params: dict[str, str] = {}
