"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateIdentityPropagationConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_identity_propagation_config_response.UpdateIdentityPropagationConfigResponse = aws_sdk_quicksight.types.update_identity_propagation_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_identity_propagation_config_request.UpdateIdentityPropagationConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{Service}", quote(str(input_["service"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_identity_propagation_config_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_identity_propagation_config(
