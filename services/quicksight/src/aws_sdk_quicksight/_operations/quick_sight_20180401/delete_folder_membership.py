...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_folder_membership_response.DeleteFolderMembershipResponse = aws_sdk_quicksight.types.delete_folder_membership_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.delete_folder_membership_request.DeleteFolderMembershipRequest,
) -> zapros.Request:
    ...
    url = url.replace("{MemberType}", quote(str(input["member_type"]), safe=""))
    params: dict[str, str] = {}
