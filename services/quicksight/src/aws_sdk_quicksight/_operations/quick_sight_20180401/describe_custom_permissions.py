...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_custom_permissions_response.DescribeCustomPermissionsResponse = aws_sdk_quicksight.types.describe_custom_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_custom_permissions_request.DescribeCustomPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
