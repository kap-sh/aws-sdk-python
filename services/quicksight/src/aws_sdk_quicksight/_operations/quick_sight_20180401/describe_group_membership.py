...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_group_membership_response.DescribeGroupMembershipResponse = aws_sdk_quicksight.types.describe_group_membership_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_group_membership_request.DescribeGroupMembershipRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
