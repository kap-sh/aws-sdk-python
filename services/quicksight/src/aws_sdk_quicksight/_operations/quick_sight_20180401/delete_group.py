...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_group_response.DeleteGroupResponse = (
        aws_sdk_quicksight.types.delete_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_group_request.DeleteGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_group(
    ...
    aws_sdk_quicksight.types.delete_group_response.DeleteGroupResponse, zapros.Response
]:
