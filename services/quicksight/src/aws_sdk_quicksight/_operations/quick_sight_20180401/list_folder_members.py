...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_folder_members_response.ListFolderMembersResponse = aws_sdk_quicksight.types.list_folder_members_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_folder_members_request.ListFolderMembersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
