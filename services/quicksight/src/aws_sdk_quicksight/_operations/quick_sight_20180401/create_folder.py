...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_folder_response.CreateFolderResponse = (
        aws_sdk_quicksight.types.create_folder_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_folder_request.CreateFolderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_folder_request.serialize_json(input_)
    ).encode()
