...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_spaces_response.ListSpacesResponse = (
        aws_sdk_quicksight.types.list_spaces_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_spaces_request.ListSpacesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_spaces(
    ...
    aws_sdk_quicksight.types.list_spaces_response.ListSpacesResponse, zapros.Response
]:
