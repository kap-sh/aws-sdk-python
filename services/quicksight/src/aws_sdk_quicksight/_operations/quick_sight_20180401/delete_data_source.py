...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_data_source_response.DeleteDataSourceResponse = aws_sdk_quicksight.types.delete_data_source_response.deserialize_json(
