"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeDashboardsQAConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_dashboards_qa_configuration_response.DescribeDashboardsQAConfigurationResponse = aws_sdk_quicksight.types.describe_dashboards_qa_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_dashboards_qa_configuration_request.DescribeDashboardsQAConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/accounts/{AwsAccountId}/dashboards-qa-configuration"
    )
...
async def async_describe_dashboards_qa_configuration(
