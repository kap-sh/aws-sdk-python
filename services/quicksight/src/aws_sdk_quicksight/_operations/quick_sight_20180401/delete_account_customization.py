"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteAccountCustomization``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_account_customization_response.DeleteAccountCustomizationResponse = aws_sdk_quicksight.types.delete_account_customization_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_account_customization_request.DeleteAccountCustomizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_account_customization(
