...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.start_automation_job_response.StartAutomationJobResponse = aws_sdk_quicksight.types.start_automation_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.start_automation_job_request.StartAutomationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.start_automation_job_request.serialize_json(input_)
    ).encode()
