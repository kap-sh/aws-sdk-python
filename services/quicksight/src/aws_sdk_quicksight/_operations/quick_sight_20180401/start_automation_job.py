...
def build_request(
    ...
    input: aws_sdk_quicksight.types.start_automation_job_request.StartAutomationJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.start_automation_job_request.serialize_json(input)
    ).encode()
