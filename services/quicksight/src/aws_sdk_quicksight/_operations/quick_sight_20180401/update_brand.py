"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateBrand``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_brand_response.UpdateBrandResponse = (
        aws_sdk_quicksight.types.update_brand_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_brand_request.UpdateBrandRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_brand_request.serialize_json(input_)
    ).encode()
...
def update_brand(
    ...
    aws_sdk_quicksight.types.update_brand_response.UpdateBrandResponse, zapros.Response
]:
