...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_brand_response.DeleteBrandResponse = (
        aws_sdk_quicksight.types.delete_brand_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_brand_request.DeleteBrandRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_brand(
    ...
    aws_sdk_quicksight.types.delete_brand_response.DeleteBrandResponse, zapros.Response
]:
