...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_topic_response.DeleteTopicResponse = (
        aws_sdk_quicksight.types.delete_topic_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_topic_request.DeleteTopicRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_topic(
    ...
    aws_sdk_quicksight.types.delete_topic_response.DeleteTopicResponse, zapros.Response
]:
