"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteBrandAssignment``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_brand_assignment_response.DeleteBrandAssignmentResponse = aws_sdk_quicksight.types.delete_brand_assignment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_brand_assignment_request.DeleteBrandAssignmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_brand_assignment(
