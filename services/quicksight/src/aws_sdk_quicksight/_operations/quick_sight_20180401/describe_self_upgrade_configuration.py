"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeSelfUpgradeConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_self_upgrade_configuration_response.DescribeSelfUpgradeConfigurationResponse = aws_sdk_quicksight.types.describe_self_upgrade_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_self_upgrade_configuration_request.DescribeSelfUpgradeConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_self_upgrade_configuration(
