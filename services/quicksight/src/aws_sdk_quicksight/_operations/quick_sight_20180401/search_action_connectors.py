...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.search_action_connectors_request.SearchActionConnectorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.search_action_connectors_request.serialize_json(input_)
    ).encode()
