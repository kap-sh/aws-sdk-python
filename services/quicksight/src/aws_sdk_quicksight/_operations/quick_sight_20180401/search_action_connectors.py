...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.search_action_connectors_response.SearchActionConnectorsResponse = aws_sdk_quicksight.types.search_action_connectors_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.search_action_connectors_request.SearchActionConnectorsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    params["max-results"] = str(input.get("max_results", 0))
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.search_action_connectors_request.serialize_json(input)
    ).encode()
