"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeTheme``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_theme_response.DescribeThemeResponse = (
        aws_sdk_quicksight.types.describe_theme_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.describe_theme_request.DescribeThemeRequest,
) -> zapros.Request:
...
async def async_describe_theme(
