...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_ip_restriction_request.UpdateIpRestrictionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_ip_restriction_request.serialize_json(input)
    ).encode()
