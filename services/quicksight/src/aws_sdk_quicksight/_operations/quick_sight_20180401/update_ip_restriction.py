...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_ip_restriction_response.UpdateIpRestrictionResponse = aws_sdk_quicksight.types.update_ip_restriction_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_ip_restriction_request.UpdateIpRestrictionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_ip_restriction_request.serialize_json(input_)
    ).encode()
