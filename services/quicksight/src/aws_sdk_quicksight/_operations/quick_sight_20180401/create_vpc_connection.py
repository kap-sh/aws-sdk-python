...
def build_request(
    ...
    input: aws_sdk_quicksight.types.create_vpc_connection_request.CreateVPCConnectionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_vpc_connection_request.serialize_json(input)
    ).encode()
