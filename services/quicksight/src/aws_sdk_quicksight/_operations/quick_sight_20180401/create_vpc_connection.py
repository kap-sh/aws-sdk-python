...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_vpc_connection_response.CreateVPCConnectionResponse = aws_sdk_quicksight.types.create_vpc_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_vpc_connection_request.CreateVPCConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_vpc_connection_request.serialize_json(input_)
    ).encode()
