...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_asset_bundle_import_jobs_response.ListAssetBundleImportJobsResponse = aws_sdk_quicksight.types.list_asset_bundle_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_asset_bundle_import_jobs_request.ListAssetBundleImportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
