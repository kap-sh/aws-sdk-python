"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeDataSet``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_data_set_response.DescribeDataSetResponse = (
        aws_sdk_quicksight.types.describe_data_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_data_set_request.DescribeDataSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/data-sets/{DataSetId}"
...
async def async_describe_data_set(
