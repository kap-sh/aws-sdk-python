"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateTheme``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_theme_response.CreateThemeResponse = (
        aws_sdk_quicksight.types.create_theme_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.create_theme_request.CreateThemeRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_theme_request.serialize_json(input)
    ).encode()
...
def create_theme(
    ...
    aws_sdk_quicksight.types.create_theme_response.CreateThemeResponse, zapros.Response
]:
