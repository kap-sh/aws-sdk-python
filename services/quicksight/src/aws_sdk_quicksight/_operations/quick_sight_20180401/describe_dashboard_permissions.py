...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_dashboard_permissions_response.DescribeDashboardPermissionsResponse = aws_sdk_quicksight.types.describe_dashboard_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_dashboard_permissions_request.DescribeDashboardPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
