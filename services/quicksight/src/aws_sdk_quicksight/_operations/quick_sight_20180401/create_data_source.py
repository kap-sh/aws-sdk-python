...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_data_source_response.CreateDataSourceResponse = aws_sdk_quicksight.types.create_data_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_data_source_request.CreateDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_data_source_request.serialize_json(input_)
    ).encode()
