...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_flow_response.DeleteFlowResponse = (
        aws_sdk_quicksight.types.delete_flow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_flow_request.DeleteFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_flow(
    ...
    aws_sdk_quicksight.types.delete_flow_response.DeleteFlowResponse, zapros.Response
]:
