"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeDashboardSnapshotJobResult``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_dashboard_snapshot_job_result_response.DescribeDashboardSnapshotJobResultResponse = aws_sdk_quicksight.types.describe_dashboard_snapshot_job_result_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.describe_dashboard_snapshot_job_result_request.DescribeDashboardSnapshotJobResultRequest,
) -> zapros.Request:
    ...
    url = url.replace("{SnapshotJobId}", quote(str(input["snapshot_job_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_describe_dashboard_snapshot_job_result(
