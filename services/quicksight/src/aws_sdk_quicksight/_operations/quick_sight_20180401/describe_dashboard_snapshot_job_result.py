...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_dashboard_snapshot_job_result_request.DescribeDashboardSnapshotJobResultRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{SnapshotJobId}", quote(str(input_["snapshot_job_id"]), safe=""))
    params: dict[str, str] = {}
