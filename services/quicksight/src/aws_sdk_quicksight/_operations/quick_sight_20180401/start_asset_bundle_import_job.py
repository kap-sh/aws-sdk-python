...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.start_asset_bundle_import_job_response.StartAssetBundleImportJobResponse = aws_sdk_quicksight.types.start_asset_bundle_import_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.start_asset_bundle_import_job_request.StartAssetBundleImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.start_asset_bundle_import_job_request.serialize_json(
            input_
        )
    ).encode()
