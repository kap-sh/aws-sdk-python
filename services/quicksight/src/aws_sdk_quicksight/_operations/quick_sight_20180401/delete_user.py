"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteUser``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_user_response.DeleteUserResponse = (
        aws_sdk_quicksight.types.delete_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_user_request.DeleteUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_user(
    ...
    aws_sdk_quicksight.types.delete_user_response.DeleteUserResponse, zapros.Response
]:
