...
import aws_sdk_quicksight.types.snapshot_user_configuration_redacted
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_dashboard_snapshot_job_response.DescribeDashboardSnapshotJobResponse = aws_sdk_quicksight.types.describe_dashboard_snapshot_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_dashboard_snapshot_job_request.DescribeDashboardSnapshotJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
