...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.start_asset_bundle_export_job_response.StartAssetBundleExportJobResponse = aws_sdk_quicksight.types.start_asset_bundle_export_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.start_asset_bundle_export_job_request.StartAssetBundleExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.start_asset_bundle_export_job_request.serialize_json(
            input_
        )
    ).encode()
