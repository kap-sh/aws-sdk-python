...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_analysis_response.UpdateAnalysisResponse = (
        aws_sdk_quicksight.types.update_analysis_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_analysis_request.UpdateAnalysisRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_analysis_request.serialize_json(input)
    ).encode()
