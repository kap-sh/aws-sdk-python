...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_dashboard_response.DescribeDashboardResponse = aws_sdk_quicksight.types.describe_dashboard_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_dashboard_request.DescribeDashboardRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
