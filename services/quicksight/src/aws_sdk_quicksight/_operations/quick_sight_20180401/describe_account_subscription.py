"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeAccountSubscription``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_account_subscription_response.DescribeAccountSubscriptionResponse = aws_sdk_quicksight.types.describe_account_subscription_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_account_subscription_request.DescribeAccountSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_account_subscription(
