"""Generated from Smithy shape ``com.amazonaws.quicksight#SearchGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.search_groups_response.SearchGroupsResponse = (
        aws_sdk_quicksight.types.search_groups_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.search_groups_request.SearchGroupsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.search_groups_request.serialize_json(input)
    ).encode()
