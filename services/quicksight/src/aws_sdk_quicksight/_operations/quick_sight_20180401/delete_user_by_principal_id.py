"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteUserByPrincipalId``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_user_by_principal_id_response.DeleteUserByPrincipalIdResponse = aws_sdk_quicksight.types.delete_user_by_principal_id_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_user_by_principal_id_request.DeleteUserByPrincipalIdRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_user_by_principal_id(
