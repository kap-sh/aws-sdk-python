...
def build_request(
    ...
    input: aws_sdk_quicksight.types.describe_space_request.DescribeSpaceRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "max_contributors" in input:
        params["maxContributors"] = str(input["max_contributors"])
