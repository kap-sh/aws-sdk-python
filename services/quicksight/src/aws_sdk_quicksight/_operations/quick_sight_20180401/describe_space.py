"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeSpace``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_space_response.DescribeSpaceResponse = (
        aws_sdk_quicksight.types.describe_space_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_space_request.DescribeSpaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "max_contributors" in input_:
        params["maxContributors"] = str(input_["max_contributors"])
...
async def async_describe_space(
