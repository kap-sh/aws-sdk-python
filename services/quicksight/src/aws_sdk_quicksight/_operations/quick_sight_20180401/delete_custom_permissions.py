...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_custom_permissions_response.DeleteCustomPermissionsResponse = aws_sdk_quicksight.types.delete_custom_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_custom_permissions_request.DeleteCustomPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
