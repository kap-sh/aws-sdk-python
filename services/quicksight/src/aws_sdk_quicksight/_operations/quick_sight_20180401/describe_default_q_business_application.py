"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeDefaultQBusinessApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_default_q_business_application_response.DescribeDefaultQBusinessApplicationResponse = aws_sdk_quicksight.types.describe_default_q_business_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_default_q_business_application_request.DescribeDefaultQBusinessApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_default_q_business_application(
