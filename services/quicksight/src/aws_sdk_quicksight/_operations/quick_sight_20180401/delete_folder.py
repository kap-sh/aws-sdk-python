...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_folder_response.DeleteFolderResponse = (
        aws_sdk_quicksight.types.delete_folder_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_folder_request.DeleteFolderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
