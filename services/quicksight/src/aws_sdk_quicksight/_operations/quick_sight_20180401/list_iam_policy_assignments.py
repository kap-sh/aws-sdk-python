...
def build_request(
    ...
    input: aws_sdk_quicksight.types.list_iam_policy_assignments_request.ListIAMPolicyAssignmentsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "assignment_status" in input:
        params["assignment-status"] = str(input["assignment_status"])
