"""Generated from Smithy shape ``com.amazonaws.quicksight#ListIAMPolicyAssignments``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_iam_policy_assignments_response.ListIAMPolicyAssignmentsResponse = aws_sdk_quicksight.types.list_iam_policy_assignments_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_iam_policy_assignments_request.ListIAMPolicyAssignmentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "assignment_status" in input_:
        params["assignment-status"] = str(input_["assignment_status"])
...
async def async_list_iam_policy_assignments(
