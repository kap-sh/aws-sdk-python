...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_agent_permissions_request.UpdateAgentPermissionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_agent_permissions_request.serialize_json(input)
    ).encode()
