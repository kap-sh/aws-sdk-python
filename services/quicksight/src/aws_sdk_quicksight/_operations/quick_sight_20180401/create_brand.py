"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateBrand``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_brand_response.CreateBrandResponse = (
        aws_sdk_quicksight.types.create_brand_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_brand_request.CreateBrandRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_brand_request.serialize_json(input_)
    ).encode()
...
def create_brand(
    ...
    aws_sdk_quicksight.types.create_brand_response.CreateBrandResponse, zapros.Response
]:
