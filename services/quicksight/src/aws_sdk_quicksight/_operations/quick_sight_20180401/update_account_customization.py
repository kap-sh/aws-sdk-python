"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateAccountCustomization``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_account_customization_response.UpdateAccountCustomizationResponse = aws_sdk_quicksight.types.update_account_customization_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_account_customization_request.UpdateAccountCustomizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_account_customization_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_account_customization(
