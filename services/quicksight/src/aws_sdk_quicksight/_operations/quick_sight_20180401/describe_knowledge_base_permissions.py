"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeKnowledgeBasePermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_knowledge_base_permissions_response.DescribeKnowledgeBasePermissionsResponse = aws_sdk_quicksight.types.describe_knowledge_base_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_knowledge_base_permissions_request.DescribeKnowledgeBasePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_knowledge_base_permissions(
