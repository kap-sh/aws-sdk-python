"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateFlowPermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_flow_permissions_output.UpdateFlowPermissionsOutput = aws_sdk_quicksight.types.update_flow_permissions_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_flow_permissions_input.UpdateFlowPermissionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/flows/{FlowId}/permissions"
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_flow_permissions_input.serialize_json(input_)
    ).encode()
...
async def async_update_flow_permissions(
