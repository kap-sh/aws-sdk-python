...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_knowledge_bases_response.ListKnowledgeBasesResponse = aws_sdk_quicksight.types.list_knowledge_bases_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_knowledge_bases_request.ListKnowledgeBasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
