...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.get_session_embed_url_response.GetSessionEmbedUrlResponse = aws_sdk_quicksight.types.get_session_embed_url_response.deserialize_json(
