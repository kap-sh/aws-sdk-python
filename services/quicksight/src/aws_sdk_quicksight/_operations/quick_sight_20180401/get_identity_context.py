...
def build_request(
    ...
    input: aws_sdk_quicksight.types.get_identity_context_request.GetIdentityContextRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.get_identity_context_request.serialize_json(input)
    ).encode()
