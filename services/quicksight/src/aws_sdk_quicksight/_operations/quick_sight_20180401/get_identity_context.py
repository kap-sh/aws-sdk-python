"""Generated from Smithy shape ``com.amazonaws.quicksight#GetIdentityContext``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.get_identity_context_response.GetIdentityContextResponse = aws_sdk_quicksight.types.get_identity_context_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.get_identity_context_request.GetIdentityContextRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/identity-context"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.get_identity_context_request.serialize_json(input_)
    ).encode()
...
async def async_get_identity_context(
