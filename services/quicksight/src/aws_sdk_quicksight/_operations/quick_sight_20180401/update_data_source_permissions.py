...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_data_source_permissions_response.UpdateDataSourcePermissionsResponse = aws_sdk_quicksight.types.update_data_source_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_data_source_permissions_request.UpdateDataSourcePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_data_source_permissions_request.serialize_json(
            input_
        )
    ).encode()
