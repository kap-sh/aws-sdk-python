"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateBrandAssignment``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_brand_assignment_response.UpdateBrandAssignmentResponse = aws_sdk_quicksight.types.update_brand_assignment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_brand_assignment_request.UpdateBrandAssignmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/brandassignments"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_brand_assignment_request.serialize_json(input_)
    ).encode()
...
async def async_update_brand_assignment(
