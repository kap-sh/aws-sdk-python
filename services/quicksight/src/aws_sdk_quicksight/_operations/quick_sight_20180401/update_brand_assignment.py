...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_brand_assignment_request.UpdateBrandAssignmentRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_brand_assignment_request.serialize_json(input)
    ).encode()
