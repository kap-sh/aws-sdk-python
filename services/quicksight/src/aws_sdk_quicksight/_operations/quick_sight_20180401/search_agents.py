...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.search_agents_response.SearchAgentsResponse = (
        aws_sdk_quicksight.types.search_agents_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.search_agents_request.SearchAgentsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.search_agents_request.serialize_json(input)
    ).encode()
