...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_refresh_schedule_response.DescribeRefreshScheduleResponse = aws_sdk_quicksight.types.describe_refresh_schedule_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.describe_refresh_schedule_request.DescribeRefreshScheduleRequest,
) -> zapros.Request:
