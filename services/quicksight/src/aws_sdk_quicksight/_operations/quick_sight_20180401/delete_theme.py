"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteTheme``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_theme_response.DeleteThemeResponse = (
        aws_sdk_quicksight.types.delete_theme_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.delete_theme_request.DeleteThemeRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/themes/{ThemeId}"
...
def delete_theme(
    ...
    aws_sdk_quicksight.types.delete_theme_response.DeleteThemeResponse, zapros.Response
]:
