"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeNamespace``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_namespace_response.DescribeNamespaceResponse = aws_sdk_quicksight.types.describe_namespace_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_namespace_request.DescribeNamespaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/namespaces/{Namespace}"
...
async def async_describe_namespace(
