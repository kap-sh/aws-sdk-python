...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_vpc_connection_response.DeleteVPCConnectionResponse = aws_sdk_quicksight.types.delete_vpc_connection_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_vpc_connection_request.DeleteVPCConnectionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
