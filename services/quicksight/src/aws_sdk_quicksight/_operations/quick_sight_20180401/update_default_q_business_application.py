"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateDefaultQBusinessApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_default_q_business_application_response.UpdateDefaultQBusinessApplicationResponse = aws_sdk_quicksight.types.update_default_q_business_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_default_q_business_application_request.UpdateDefaultQBusinessApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_default_q_business_application(
