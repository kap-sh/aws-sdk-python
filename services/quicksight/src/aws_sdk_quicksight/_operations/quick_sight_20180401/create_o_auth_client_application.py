"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateOAuthClientApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_o_auth_client_application_response.CreateOAuthClientApplicationResponse = aws_sdk_quicksight.types.create_o_auth_client_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_o_auth_client_application_request.CreateOAuthClientApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/oauth-client-applications"
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_o_auth_client_application_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_o_auth_client_application(
