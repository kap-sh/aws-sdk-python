...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_custom_permissions_request.CreateCustomPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_custom_permissions_request.serialize_json(
            input_
        )
    ).encode()
