"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateCustomPermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_custom_permissions_response.CreateCustomPermissionsResponse = aws_sdk_quicksight.types.create_custom_permissions_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.create_custom_permissions_request.CreateCustomPermissionsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/custom-permissions"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_custom_permissions_request.serialize_json(input)
    ).encode()
...
async def async_create_custom_permissions(
