"""Generated from Smithy shape ``com.amazonaws.quicksight#GenerateEmbedUrlForRegisteredUserWithIdentity``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.generate_embed_url_for_registered_user_with_identity_response.GenerateEmbedUrlForRegisteredUserWithIdentityResponse = aws_sdk_quicksight.types.generate_embed_url_for_registered_user_with_identity_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.generate_embed_url_for_registered_user_with_identity_request.GenerateEmbedUrlForRegisteredUserWithIdentityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/accounts/{AwsAccountId}/embed-url/registered-user-with-identity"
    )
...
async def async_generate_embed_url_for_registered_user_with_identity(
