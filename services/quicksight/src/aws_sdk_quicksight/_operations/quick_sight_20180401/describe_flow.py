...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_flow_response.DescribeFlowResponse = (
        aws_sdk_quicksight.types.describe_flow_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.describe_flow_request.DescribeFlowRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "publish_state" in input:
        params["publish-state"] = str(input["publish_state"])
