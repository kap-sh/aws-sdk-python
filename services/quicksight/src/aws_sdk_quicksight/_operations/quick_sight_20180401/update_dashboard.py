...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_dashboard_response.UpdateDashboardResponse = (
        aws_sdk_quicksight.types.update_dashboard_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_dashboard_request.UpdateDashboardRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_dashboard_request.serialize_json(input_)
    ).encode()
