...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_space_resources_response.UpdateSpaceResourcesResponse = aws_sdk_quicksight.types.update_space_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_space_resources_request.UpdateSpaceResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_space_resources_request.serialize_json(input_)
    ).encode()
