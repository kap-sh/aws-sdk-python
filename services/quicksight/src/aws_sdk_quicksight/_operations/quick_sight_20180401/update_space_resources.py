...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_space_resources_request.UpdateSpaceResourcesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_space_resources_request.serialize_json(input)
    ).encode()
