"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeTopicRefreshSchedule``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_topic_refresh_schedule_response.DescribeTopicRefreshScheduleResponse = aws_sdk_quicksight.types.describe_topic_refresh_schedule_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.describe_topic_refresh_schedule_request.DescribeTopicRefreshScheduleRequest,
) -> zapros.Request:
    ...
    url = url.replace("{TopicId}", quote(str(input["topic_id"]), safe=""))
...
async def async_describe_topic_refresh_schedule(
