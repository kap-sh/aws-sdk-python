...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_account_custom_permission_response.DescribeAccountCustomPermissionResponse = aws_sdk_quicksight.types.describe_account_custom_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_account_custom_permission_request.DescribeAccountCustomPermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
