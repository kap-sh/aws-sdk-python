...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_folder_response.DescribeFolderResponse = (
        aws_sdk_quicksight.types.describe_folder_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_folder_request.DescribeFolderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
