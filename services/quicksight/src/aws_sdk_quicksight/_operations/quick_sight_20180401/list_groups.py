"""Generated from Smithy shape ``com.amazonaws.quicksight#ListGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_groups_response.ListGroupsResponse = (
        aws_sdk_quicksight.types.list_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_groups_request.ListGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_groups(
    ...
    aws_sdk_quicksight.types.list_groups_response.ListGroupsResponse, zapros.Response
]:
