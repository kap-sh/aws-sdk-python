"""Generated from Smithy shape ``com.amazonaws.quicksight#ListDashboards``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_dashboards_response.ListDashboardsResponse = (
        aws_sdk_quicksight.types.list_dashboards_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_dashboards_request.ListDashboardsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/dashboards"
...
async def async_list_dashboards(
