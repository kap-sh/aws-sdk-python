...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_topic_response.DescribeTopicResponse = (
        aws_sdk_quicksight.types.describe_topic_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_topic_request.DescribeTopicRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
