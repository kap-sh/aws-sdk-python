...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_agent_request.CreateAgentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_agent_request.serialize_json(input_)
    ).encode()
...
def create_agent(
    ...
    aws_sdk_quicksight.types.create_agent_response.CreateAgentResponse, zapros.Response
]:
