...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_identity_propagation_configs_response.ListIdentityPropagationConfigsResponse = aws_sdk_quicksight.types.list_identity_propagation_configs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_identity_propagation_configs_request.ListIdentityPropagationConfigsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
