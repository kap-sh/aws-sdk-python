"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateDataSetPermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_data_set_permissions_response.UpdateDataSetPermissionsResponse = aws_sdk_quicksight.types.update_data_set_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_data_set_permissions_request.UpdateDataSetPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_data_set_permissions_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_data_set_permissions(
