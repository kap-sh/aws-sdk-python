...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_analysis_response.DescribeAnalysisResponse = aws_sdk_quicksight.types.describe_analysis_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_analysis_request.DescribeAnalysisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
