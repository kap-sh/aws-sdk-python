...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_brand_published_version_response.DescribeBrandPublishedVersionResponse = aws_sdk_quicksight.types.describe_brand_published_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_brand_published_version_request.DescribeBrandPublishedVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
