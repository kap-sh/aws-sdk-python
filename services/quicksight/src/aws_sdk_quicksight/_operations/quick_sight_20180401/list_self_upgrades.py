"""Generated from Smithy shape ``com.amazonaws.quicksight#ListSelfUpgrades``."""
...
import aws_sdk_quicksight.types.self_upgrade_request_detail_list
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_self_upgrades_response.ListSelfUpgradesResponse = aws_sdk_quicksight.types.list_self_upgrades_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_self_upgrades_request.ListSelfUpgradesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/accounts/{AwsAccountId}/namespaces/{Namespace}/self-upgrade-requests"
    )
...
async def async_list_self_upgrades(
