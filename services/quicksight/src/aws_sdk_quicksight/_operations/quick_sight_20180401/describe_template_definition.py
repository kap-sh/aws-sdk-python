"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeTemplateDefinition``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_template_definition_response.DescribeTemplateDefinitionResponse = aws_sdk_quicksight.types.describe_template_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_template_definition_request.DescribeTemplateDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "version_number" in input_:
        params["version-number"] = str(input_["version_number"])
    if "alias_name" in input_:
        params["alias-name"] = str(input_["alias_name"])
...
async def async_describe_template_definition(
