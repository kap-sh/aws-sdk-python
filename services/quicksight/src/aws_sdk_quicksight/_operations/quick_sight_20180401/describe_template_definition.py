...
def build_request(
    ...
    input: aws_sdk_quicksight.types.describe_template_definition_request.DescribeTemplateDefinitionRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "version_number" in input:
        params["version-number"] = str(input["version_number"])
    if "alias_name" in input:
        params["alias-name"] = str(input["alias_name"])
