"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeFolderResolvedPermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_folder_resolved_permissions_response.DescribeFolderResolvedPermissionsResponse = aws_sdk_quicksight.types.describe_folder_resolved_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_folder_resolved_permissions_request.DescribeFolderResolvedPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_folder_resolved_permissions(
