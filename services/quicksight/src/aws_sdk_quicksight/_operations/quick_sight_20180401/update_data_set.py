...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_data_set_response.UpdateDataSetResponse = (
        aws_sdk_quicksight.types.update_data_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_data_set_request.UpdateDataSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_data_set_request.serialize_json(input_)
    ).encode()
