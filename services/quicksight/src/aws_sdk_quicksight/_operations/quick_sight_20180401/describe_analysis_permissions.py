...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_analysis_permissions_response.DescribeAnalysisPermissionsResponse = aws_sdk_quicksight.types.describe_analysis_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_analysis_permissions_request.DescribeAnalysisPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
