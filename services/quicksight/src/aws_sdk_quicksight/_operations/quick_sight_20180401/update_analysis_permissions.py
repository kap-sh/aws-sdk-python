"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateAnalysisPermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_analysis_permissions_response.UpdateAnalysisPermissionsResponse = aws_sdk_quicksight.types.update_analysis_permissions_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_analysis_permissions_request.UpdateAnalysisPermissionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_analysis_permissions_request.serialize_json(
            input
        )
    ).encode()
...
async def async_update_analysis_permissions(
