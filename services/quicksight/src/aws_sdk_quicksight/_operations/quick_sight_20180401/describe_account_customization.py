"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeAccountCustomization``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_account_customization_response.DescribeAccountCustomizationResponse = aws_sdk_quicksight.types.describe_account_customization_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_account_customization_request.DescribeAccountCustomizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params["resolved"] = str(input_.get("resolved", False))
...
async def async_describe_account_customization(
