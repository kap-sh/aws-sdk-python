...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_space_response.DeleteSpaceResponse = (
        aws_sdk_quicksight.types.delete_space_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_space_request.DeleteSpaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_space(
    ...
    aws_sdk_quicksight.types.delete_space_response.DeleteSpaceResponse, zapros.Response
]:
