...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.batch_delete_knowledge_base_response.BatchDeleteKnowledgeBaseResponse = aws_sdk_quicksight.types.batch_delete_knowledge_base_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.batch_delete_knowledge_base_request.BatchDeleteKnowledgeBaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.batch_delete_knowledge_base_request.serialize_json(
            input_
        )
    ).encode()
