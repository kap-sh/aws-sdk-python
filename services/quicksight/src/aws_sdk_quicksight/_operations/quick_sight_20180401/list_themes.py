"""Generated from Smithy shape ``com.amazonaws.quicksight#ListThemes``."""
...
import aws_sdk_quicksight.types.theme_summary_list
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_themes_response.ListThemesResponse = (
        aws_sdk_quicksight.types.list_themes_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_themes_request.ListThemesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/themes"
...
def list_themes(
    ...
    aws_sdk_quicksight.types.list_themes_response.ListThemesResponse, zapros.Response
]:
