...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_account_subscription_response.CreateAccountSubscriptionResponse = aws_sdk_quicksight.types.create_account_subscription_response.deserialize_json(
