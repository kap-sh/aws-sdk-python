...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.batch_delete_topic_reviewed_answer_response.BatchDeleteTopicReviewedAnswerResponse = aws_sdk_quicksight.types.batch_delete_topic_reviewed_answer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.batch_delete_topic_reviewed_answer_request.BatchDeleteTopicReviewedAnswerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.batch_delete_topic_reviewed_answer_request.serialize_json(
            input_
        )
    ).encode()
