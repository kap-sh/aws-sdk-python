...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.tag_resource_response.TagResourceResponse = (
        aws_sdk_quicksight.types.tag_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.tag_resource_request.TagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.tag_resource_request.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    aws_sdk_quicksight.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
