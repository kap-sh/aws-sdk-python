...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_template_versions_response.ListTemplateVersionsResponse = aws_sdk_quicksight.types.list_template_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_template_versions_request.ListTemplateVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
