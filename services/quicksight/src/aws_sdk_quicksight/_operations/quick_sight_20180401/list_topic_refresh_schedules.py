...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_topic_refresh_schedules_response.ListTopicRefreshSchedulesResponse = aws_sdk_quicksight.types.list_topic_refresh_schedules_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_topic_refresh_schedules_request.ListTopicRefreshSchedulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
