...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_group_response.UpdateGroupResponse = (
        aws_sdk_quicksight.types.update_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_group_request.UpdateGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_group_request.serialize_json(input_)
    ).encode()
...
def update_group(
    ...
    aws_sdk_quicksight.types.update_group_response.UpdateGroupResponse, zapros.Response
]:
