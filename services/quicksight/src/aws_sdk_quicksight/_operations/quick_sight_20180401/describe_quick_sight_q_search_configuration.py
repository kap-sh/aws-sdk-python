...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_quick_sight_q_search_configuration_response.DescribeQuickSightQSearchConfigurationResponse = aws_sdk_quicksight.types.describe_quick_sight_q_search_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_quick_sight_q_search_configuration_request.DescribeQuickSightQSearchConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
