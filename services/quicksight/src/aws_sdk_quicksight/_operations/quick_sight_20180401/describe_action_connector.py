...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_action_connector_response.DescribeActionConnectorResponse = aws_sdk_quicksight.types.describe_action_connector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_action_connector_request.DescribeActionConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
