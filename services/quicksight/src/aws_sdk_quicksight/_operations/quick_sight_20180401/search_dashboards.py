...
def build_request(
    ...
    input: aws_sdk_quicksight.types.search_dashboards_request.SearchDashboardsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.search_dashboards_request.serialize_json(input)
    ).encode()
