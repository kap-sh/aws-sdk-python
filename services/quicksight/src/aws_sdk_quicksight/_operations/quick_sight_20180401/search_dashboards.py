"""Generated from Smithy shape ``com.amazonaws.quicksight#SearchDashboards``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.search_dashboards_response.SearchDashboardsResponse = aws_sdk_quicksight.types.search_dashboards_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.search_dashboards_request.SearchDashboardsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/search/dashboards"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.search_dashboards_request.serialize_json(input_)
    ).encode()
...
async def async_search_dashboards(
