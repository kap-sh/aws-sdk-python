...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_asset_bundle_export_jobs_response.ListAssetBundleExportJobsResponse = aws_sdk_quicksight.types.list_asset_bundle_export_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_asset_bundle_export_jobs_request.ListAssetBundleExportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
