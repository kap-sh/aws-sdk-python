"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateSelfUpgradeConfiguration``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidParameterException":
            import aws_sdk_quicksight.errors.invalid_parameter_exception

            raise aws_sdk_quicksight.errors.invalid_parameter_exception.InvalidParameterException.from_json(
                data
            )
        ...
        case "ResourceUnavailableException":
            import aws_sdk_quicksight.errors.resource_unavailable_exception

            raise aws_sdk_quicksight.errors.resource_unavailable_exception.ResourceUnavailableException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_self_upgrade_configuration_response.UpdateSelfUpgradeConfigurationResponse = aws_sdk_quicksight.types.update_self_upgrade_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_self_upgrade_configuration_request.UpdateSelfUpgradeConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/accounts/{AwsAccountId}/namespaces/{Namespace}/self-upgrade-configuration"
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_self_upgrade_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_self_upgrade_configuration(
