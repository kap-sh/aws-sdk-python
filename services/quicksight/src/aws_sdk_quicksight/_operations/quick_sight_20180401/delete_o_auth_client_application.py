"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteOAuthClientApplication``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_o_auth_client_application_response.DeleteOAuthClientApplicationResponse = aws_sdk_quicksight.types.delete_o_auth_client_application_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_o_auth_client_application_request.DeleteOAuthClientApplicationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_o_auth_client_application(
