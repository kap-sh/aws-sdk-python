"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateTemplateAlias``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_template_alias_response.UpdateTemplateAliasResponse = aws_sdk_quicksight.types.update_template_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_template_alias_request.UpdateTemplateAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{AliasName}", quote(str(input_["alias_name"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_quicksight.types.update_template_alias_request

    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_template_alias_request.serialize_json(input_)
    ).encode()
...
async def async_update_template_alias(
