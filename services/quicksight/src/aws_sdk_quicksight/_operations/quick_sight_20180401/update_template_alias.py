...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_template_alias_request.UpdateTemplateAliasRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_template_alias_request.serialize_json(input)
    ).encode()
