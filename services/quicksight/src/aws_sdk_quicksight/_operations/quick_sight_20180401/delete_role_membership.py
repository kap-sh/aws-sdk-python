"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteRoleMembership``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_role_membership_response.DeleteRoleMembershipResponse = aws_sdk_quicksight.types.delete_role_membership_response.deserialize_json(
