...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_key_registration_response.DescribeKeyRegistrationResponse = aws_sdk_quicksight.types.describe_key_registration_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.describe_key_registration_request.DescribeKeyRegistrationRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    params["default-key-only"] = str(input.get("default_key_only", False))
