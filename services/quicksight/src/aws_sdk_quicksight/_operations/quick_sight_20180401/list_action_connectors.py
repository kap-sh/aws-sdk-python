...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_action_connectors_response.ListActionConnectorsResponse = aws_sdk_quicksight.types.list_action_connectors_response.deserialize_json(
