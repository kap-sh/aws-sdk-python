"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeDataSource``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_data_source_response.DescribeDataSourceResponse = aws_sdk_quicksight.types.describe_data_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_data_source_request.DescribeDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_data_source(
