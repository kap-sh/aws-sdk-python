...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_custom_permissions_request.UpdateCustomPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace(
        ...
        quote(str(input_["custom_permissions_name"]), safe=""),
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_custom_permissions_request.serialize_json(
            input_
        )
    ).encode()
