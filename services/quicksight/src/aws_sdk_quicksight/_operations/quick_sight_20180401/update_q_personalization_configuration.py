"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateQPersonalizationConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_q_personalization_configuration_response.UpdateQPersonalizationConfigurationResponse = aws_sdk_quicksight.types.update_q_personalization_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_q_personalization_configuration_request.UpdateQPersonalizationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_q_personalization_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_q_personalization_configuration(
