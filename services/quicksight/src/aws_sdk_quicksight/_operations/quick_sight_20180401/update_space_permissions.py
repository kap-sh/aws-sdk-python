...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_space_permissions_request.UpdateSpacePermissionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_space_permissions_request.serialize_json(input)
    ).encode()
