"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateSpacePermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_space_permissions_response.UpdateSpacePermissionsResponse = aws_sdk_quicksight.types.update_space_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_space_permissions_request.UpdateSpacePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/v1/accounts/{AwsAccountId}/spaces/{SpaceId}/permissions"
    )
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_space_permissions_request.serialize_json(input_)
    ).encode()
...
async def async_update_space_permissions(
