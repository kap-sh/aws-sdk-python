...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_spice_capacity_configuration_response.UpdateSPICECapacityConfigurationResponse = aws_sdk_quicksight.types.update_spice_capacity_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_spice_capacity_configuration_request.UpdateSPICECapacityConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_spice_capacity_configuration_request.serialize_json(
            input_
        )
    ).encode()
