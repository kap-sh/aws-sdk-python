...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_refresh_schedule_response.DeleteRefreshScheduleResponse = aws_sdk_quicksight.types.delete_refresh_schedule_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.delete_refresh_schedule_request.DeleteRefreshScheduleRequest,
) -> zapros.Request:
