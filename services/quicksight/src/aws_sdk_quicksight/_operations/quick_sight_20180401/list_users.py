"""Generated from Smithy shape ``com.amazonaws.quicksight#ListUsers``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_users_response.ListUsersResponse = (
        aws_sdk_quicksight.types.list_users_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_users_request.ListUsersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_users(
    ...
    aws_sdk_quicksight.types.list_users_response.ListUsersResponse, zapros.Response
]:
