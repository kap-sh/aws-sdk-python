"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateSpace``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_space_response.UpdateSpaceResponse = (
        aws_sdk_quicksight.types.update_space_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_space_request.UpdateSpaceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v1/accounts/{AwsAccountId}/spaces/{SpaceId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_space_request.serialize_json(input_)
    ).encode()
...
def update_space(
    ...
    aws_sdk_quicksight.types.update_space_response.UpdateSpaceResponse, zapros.Response
]:
