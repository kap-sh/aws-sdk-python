"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteIAMPolicyAssignment``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_iam_policy_assignment_response.DeleteIAMPolicyAssignmentResponse = aws_sdk_quicksight.types.delete_iam_policy_assignment_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.delete_iam_policy_assignment_request.DeleteIAMPolicyAssignmentRequest,
) -> zapros.Request:
...
async def async_delete_iam_policy_assignment(
