"""Generated from Smithy shape ``com.amazonaws.quicksight#ListCustomPermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_custom_permissions_response.ListCustomPermissionsResponse = aws_sdk_quicksight.types.list_custom_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_custom_permissions_request.ListCustomPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_custom_permissions(
