...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_dashboard_definition_response.DescribeDashboardDefinitionResponse = aws_sdk_quicksight.types.describe_dashboard_definition_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_dashboard_definition_request.DescribeDashboardDefinitionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
