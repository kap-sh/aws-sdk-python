"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteAgent``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_agent_response.DeleteAgentResponse = (
        aws_sdk_quicksight.types.delete_agent_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.delete_agent_request.DeleteAgentRequest,
) -> zapros.Request:
...
def delete_agent(
    ...
    aws_sdk_quicksight.types.delete_agent_response.DeleteAgentResponse, zapros.Response
]:
