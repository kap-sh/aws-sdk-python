...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_refresh_schedule_request.UpdateRefreshScheduleRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_refresh_schedule_request.serialize_json(input)
    ).encode()
