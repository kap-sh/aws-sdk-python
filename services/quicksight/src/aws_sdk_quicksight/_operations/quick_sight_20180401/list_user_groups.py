...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_user_groups_response.ListUserGroupsResponse = (
        aws_sdk_quicksight.types.list_user_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_user_groups_request.ListUserGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
