"""Generated from Smithy shape ``com.amazonaws.quicksight#GetFlowPermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.get_flow_permissions_output.GetFlowPermissionsOutput = aws_sdk_quicksight.types.get_flow_permissions_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.get_flow_permissions_input.GetFlowPermissionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_flow_permissions(
