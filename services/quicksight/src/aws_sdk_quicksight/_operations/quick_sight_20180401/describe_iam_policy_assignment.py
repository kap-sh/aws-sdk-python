"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeIAMPolicyAssignment``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_iam_policy_assignment_response.DescribeIAMPolicyAssignmentResponse = aws_sdk_quicksight.types.describe_iam_policy_assignment_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.describe_iam_policy_assignment_request.DescribeIAMPolicyAssignmentRequest,
) -> zapros.Request:
...
async def async_describe_iam_policy_assignment(
