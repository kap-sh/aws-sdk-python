"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeQPersonalizationConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_q_personalization_configuration_response.DescribeQPersonalizationConfigurationResponse = aws_sdk_quicksight.types.describe_q_personalization_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_q_personalization_configuration_request.DescribeQPersonalizationConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_q_personalization_configuration(
