...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_vpc_connection_request.UpdateVPCConnectionRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{VPCConnectionId}", quote(str(input["vpc_connection_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_vpc_connection_request.serialize_json(input)
    ).encode()
