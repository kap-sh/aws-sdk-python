...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_dashboard_links_request.UpdateDashboardLinksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_dashboard_links_request.serialize_json(input_)
    ).encode()
