"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateDashboardLinks``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_dashboard_links_response.UpdateDashboardLinksResponse = aws_sdk_quicksight.types.update_dashboard_links_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_dashboard_links_request.UpdateDashboardLinksRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_dashboard_links_request.serialize_json(input)
    ).encode()
...
async def async_update_dashboard_links(
