...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_account_custom_permission_response.DeleteAccountCustomPermissionResponse = aws_sdk_quicksight.types.delete_account_custom_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_account_custom_permission_request.DeleteAccountCustomPermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
