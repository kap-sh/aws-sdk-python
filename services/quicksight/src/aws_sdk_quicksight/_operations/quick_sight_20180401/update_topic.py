...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_topic_response.UpdateTopicResponse = (
        aws_sdk_quicksight.types.update_topic_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_topic_request.UpdateTopicRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_topic_request.serialize_json(input_)
    ).encode()
...
def update_topic(
    ...
    aws_sdk_quicksight.types.update_topic_response.UpdateTopicResponse, zapros.Response
]:
