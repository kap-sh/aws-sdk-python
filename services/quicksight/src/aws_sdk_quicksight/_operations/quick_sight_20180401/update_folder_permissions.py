...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_folder_permissions_request.UpdateFolderPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_folder_permissions_request.serialize_json(
            input_
        )
    ).encode()
