...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_folder_permissions_response.UpdateFolderPermissionsResponse = aws_sdk_quicksight.types.update_folder_permissions_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_folder_permissions_request.UpdateFolderPermissionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_folder_permissions_request.serialize_json(input)
    ).encode()
