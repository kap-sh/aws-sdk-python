...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_flow_response.CreateFlowResponse = (
        aws_sdk_quicksight.types.create_flow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_flow_request.CreateFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_flow_request.serialize_json(input_)
    ).encode()
...
def create_flow(
    ...
    aws_sdk_quicksight.types.create_flow_response.CreateFlowResponse, zapros.Response
]:
