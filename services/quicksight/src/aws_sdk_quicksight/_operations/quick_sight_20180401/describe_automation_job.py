...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_automation_job_response.DescribeAutomationJobResponse = aws_sdk_quicksight.types.describe_automation_job_response.deserialize_json(
