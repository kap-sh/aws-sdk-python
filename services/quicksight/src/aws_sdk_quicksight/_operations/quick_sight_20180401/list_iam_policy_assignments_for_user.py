...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_iam_policy_assignments_for_user_response.ListIAMPolicyAssignmentsForUserResponse = aws_sdk_quicksight.types.list_iam_policy_assignments_for_user_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_iam_policy_assignments_for_user_request.ListIAMPolicyAssignmentsForUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
