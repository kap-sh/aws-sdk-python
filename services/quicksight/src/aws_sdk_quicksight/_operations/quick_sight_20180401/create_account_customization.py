"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateAccountCustomization``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_account_customization_response.CreateAccountCustomizationResponse = aws_sdk_quicksight.types.create_account_customization_response.deserialize_json(
