"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateTopicPermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_topic_permissions_response.UpdateTopicPermissionsResponse = aws_sdk_quicksight.types.update_topic_permissions_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_topic_permissions_request.UpdateTopicPermissionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_topic_permissions_request.serialize_json(input)
    ).encode()
...
async def async_update_topic_permissions(
