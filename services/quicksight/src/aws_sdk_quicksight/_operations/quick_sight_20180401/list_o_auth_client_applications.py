...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_o_auth_client_applications_response.ListOAuthClientApplicationsResponse = aws_sdk_quicksight.types.list_o_auth_client_applications_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_o_auth_client_applications_request.ListOAuthClientApplicationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
