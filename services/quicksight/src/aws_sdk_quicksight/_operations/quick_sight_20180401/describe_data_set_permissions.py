...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_data_set_permissions_response.DescribeDataSetPermissionsResponse = aws_sdk_quicksight.types.describe_data_set_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_data_set_permissions_request.DescribeDataSetPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
