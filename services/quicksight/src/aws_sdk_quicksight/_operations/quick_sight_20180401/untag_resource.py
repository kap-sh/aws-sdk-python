"""Generated from Smithy shape ``com.amazonaws.quicksight#UntagResource``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.untag_resource_response.UntagResourceResponse = (
        aws_sdk_quicksight.types.untag_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
