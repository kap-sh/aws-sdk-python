"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeThemePermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_theme_permissions_response.DescribeThemePermissionsResponse = aws_sdk_quicksight.types.describe_theme_permissions_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.describe_theme_permissions_request.DescribeThemePermissionsRequest,
) -> zapros.Request:
...
async def async_describe_theme_permissions(
