...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_flow_response.UpdateFlowResponse = (
        aws_sdk_quicksight.types.update_flow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_flow_request.UpdateFlowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_flow_request.serialize_json(input_)
    ).encode()
...
def update_flow(
    ...
    aws_sdk_quicksight.types.update_flow_response.UpdateFlowResponse, zapros.Response
]:
