"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateActionConnector``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_action_connector_response.CreateActionConnectorResponse = aws_sdk_quicksight.types.create_action_connector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_action_connector_request.CreateActionConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_action_connector_request.serialize_json(input_)
    ).encode()
...
async def async_create_action_connector(
