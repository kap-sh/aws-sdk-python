...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_group_response.DescribeGroupResponse = (
        aws_sdk_quicksight.types.describe_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_group_request.DescribeGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
