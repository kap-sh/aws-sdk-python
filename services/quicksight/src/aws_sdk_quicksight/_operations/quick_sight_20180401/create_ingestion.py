...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_ingestion_response.CreateIngestionResponse = (
        aws_sdk_quicksight.types.create_ingestion_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_ingestion_request.CreateIngestionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_ingestion_request.serialize_json(input_)
    ).encode()
