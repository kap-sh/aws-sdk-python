...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_template_alias_response.DescribeTemplateAliasResponse = aws_sdk_quicksight.types.describe_template_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_template_alias_request.DescribeTemplateAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
