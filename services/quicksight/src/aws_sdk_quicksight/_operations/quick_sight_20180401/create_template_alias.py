...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_template_alias_request.CreateTemplateAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_template_alias_request.serialize_json(input_)
    ).encode()
