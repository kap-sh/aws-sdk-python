...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_folder_membership_response.CreateFolderMembershipResponse = aws_sdk_quicksight.types.create_folder_membership_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.create_folder_membership_request.CreateFolderMembershipRequest,
) -> zapros.Request:
