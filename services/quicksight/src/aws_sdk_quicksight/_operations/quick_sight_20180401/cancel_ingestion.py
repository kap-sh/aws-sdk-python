...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.cancel_ingestion_response.CancelIngestionResponse = (
        aws_sdk_quicksight.types.cancel_ingestion_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.cancel_ingestion_request.CancelIngestionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
