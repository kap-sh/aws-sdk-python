...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.start_dashboard_snapshot_job_schedule_response.StartDashboardSnapshotJobScheduleResponse = aws_sdk_quicksight.types.start_dashboard_snapshot_job_schedule_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.start_dashboard_snapshot_job_schedule_request.StartDashboardSnapshotJobScheduleRequest,
) -> zapros.Request:
    ...
    url = url.replace("{ScheduleId}", quote(str(input["schedule_id"]), safe=""))
    params: dict[str, str] = {}
