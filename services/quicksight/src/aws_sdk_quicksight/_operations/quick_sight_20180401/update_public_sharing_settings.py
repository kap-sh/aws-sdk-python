...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_public_sharing_settings_response.UpdatePublicSharingSettingsResponse = aws_sdk_quicksight.types.update_public_sharing_settings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_public_sharing_settings_request.UpdatePublicSharingSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_public_sharing_settings_request.serialize_json(
            input_
        )
    ).encode()
