"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeIngestion``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_ingestion_response.DescribeIngestionResponse = aws_sdk_quicksight.types.describe_ingestion_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_ingestion_request.DescribeIngestionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{IngestionId}", quote(str(input_["ingestion_id"]), safe=""))
    params: dict[str, str] = {}
...
async def async_describe_ingestion(
