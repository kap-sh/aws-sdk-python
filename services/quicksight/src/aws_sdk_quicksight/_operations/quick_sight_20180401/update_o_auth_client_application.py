...
def build_request(
    ...
    input: aws_sdk_quicksight.types.update_o_auth_client_application_request.UpdateOAuthClientApplicationRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["o_auth_client_application_id"]), safe=""),
    )
    params: dict[str, str] = {}
