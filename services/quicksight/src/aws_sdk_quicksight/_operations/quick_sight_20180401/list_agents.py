"""Generated from Smithy shape ``com.amazonaws.quicksight#ListAgents``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_agents_response.ListAgentsResponse = (
        aws_sdk_quicksight.types.list_agents_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_agents_request.ListAgentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/agents"
...
def list_agents(
    ...
    aws_sdk_quicksight.types.list_agents_response.ListAgentsResponse, zapros.Response
]:
