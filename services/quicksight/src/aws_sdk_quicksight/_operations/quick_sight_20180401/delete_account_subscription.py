...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_account_subscription_response.DeleteAccountSubscriptionResponse = aws_sdk_quicksight.types.delete_account_subscription_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_account_subscription_request.DeleteAccountSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
