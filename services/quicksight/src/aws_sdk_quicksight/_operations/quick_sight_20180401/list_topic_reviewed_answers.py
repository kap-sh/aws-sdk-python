"""Generated from Smithy shape ``com.amazonaws.quicksight#ListTopicReviewedAnswers``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_topic_reviewed_answers_response.ListTopicReviewedAnswersResponse = aws_sdk_quicksight.types.list_topic_reviewed_answers_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.list_topic_reviewed_answers_request.ListTopicReviewedAnswersRequest,
) -> zapros.Request:
...
async def async_list_topic_reviewed_answers(
