...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_dashboard_published_version_response.UpdateDashboardPublishedVersionResponse = aws_sdk_quicksight.types.update_dashboard_published_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_dashboard_published_version_request.UpdateDashboardPublishedVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
