...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_space_permissions_response.DescribeSpacePermissionsResponse = aws_sdk_quicksight.types.describe_space_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_space_permissions_request.DescribeSpacePermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
