...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_brands_response.ListBrandsResponse = (
        aws_sdk_quicksight.types.list_brands_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_brands_request.ListBrandsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_brands(
    ...
    aws_sdk_quicksight.types.list_brands_response.ListBrandsResponse, zapros.Response
]:
