...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.search_topics_response.SearchTopicsResponse = (
        aws_sdk_quicksight.types.search_topics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.search_topics_request.SearchTopicsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.search_topics_request.serialize_json(input_)
    ).encode()
