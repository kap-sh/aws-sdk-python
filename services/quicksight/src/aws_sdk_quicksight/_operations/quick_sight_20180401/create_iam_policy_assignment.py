...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_iam_policy_assignment_response.CreateIAMPolicyAssignmentResponse = aws_sdk_quicksight.types.create_iam_policy_assignment_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_iam_policy_assignment_request.CreateIAMPolicyAssignmentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
