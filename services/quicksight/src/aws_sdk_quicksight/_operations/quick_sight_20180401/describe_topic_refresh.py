...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_topic_refresh_response.DescribeTopicRefreshResponse = aws_sdk_quicksight.types.describe_topic_refresh_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_topic_refresh_request.DescribeTopicRefreshRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{RefreshId}", quote(str(input_["refresh_id"]), safe=""))
    params: dict[str, str] = {}
