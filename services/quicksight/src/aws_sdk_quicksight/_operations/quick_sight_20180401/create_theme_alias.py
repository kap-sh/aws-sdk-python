...
def build_request(
    ...
    input: aws_sdk_quicksight.types.create_theme_alias_request.CreateThemeAliasRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_theme_alias_request.serialize_json(input)
    ).encode()
