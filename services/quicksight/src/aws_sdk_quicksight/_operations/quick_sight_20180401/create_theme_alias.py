...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_theme_alias_response.CreateThemeAliasResponse = aws_sdk_quicksight.types.create_theme_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_theme_alias_request.CreateThemeAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_theme_alias_request.serialize_json(input_)
    ).encode()
