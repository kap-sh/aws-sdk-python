"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeIpRestriction``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_ip_restriction_response.DescribeIpRestrictionResponse = aws_sdk_quicksight.types.describe_ip_restriction_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_ip_restriction_request.DescribeIpRestrictionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_ip_restriction(
