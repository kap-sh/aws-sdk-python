...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_action_connector_response.DeleteActionConnectorResponse = aws_sdk_quicksight.types.delete_action_connector_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_action_connector_request.DeleteActionConnectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
