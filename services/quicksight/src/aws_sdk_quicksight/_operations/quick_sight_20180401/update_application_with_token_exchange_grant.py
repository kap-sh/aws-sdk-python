"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateApplicationWithTokenExchangeGrant``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_application_with_token_exchange_grant_response.UpdateApplicationWithTokenExchangeGrantResponse = aws_sdk_quicksight.types.update_application_with_token_exchange_grant_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_application_with_token_exchange_grant_request.UpdateApplicationWithTokenExchangeGrantRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/accounts/{AwsAccountId}/application-with-token-exchange-grant"
    )
...
async def async_update_application_with_token_exchange_grant(
