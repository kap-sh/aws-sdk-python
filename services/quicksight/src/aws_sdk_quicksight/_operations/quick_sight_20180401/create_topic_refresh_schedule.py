...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.create_topic_refresh_schedule_response.CreateTopicRefreshScheduleResponse = aws_sdk_quicksight.types.create_topic_refresh_schedule_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.create_topic_refresh_schedule_request.CreateTopicRefreshScheduleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.create_topic_refresh_schedule_request.serialize_json(
            input_
        )
    ).encode()
