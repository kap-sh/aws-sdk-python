"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateDataSource``."""
...
import aws_sdk_quicksight.errors.customer_managed_key_unavailable_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CustomerManagedKeyUnavailableException":
            raise aws_sdk_quicksight.errors.customer_managed_key_unavailable_exception.CustomerManagedKeyUnavailableException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_data_source_response.UpdateDataSourceResponse = aws_sdk_quicksight.types.update_data_source_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_data_source_request.UpdateDataSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_data_source_request.serialize_json(input_)
    ).encode()
