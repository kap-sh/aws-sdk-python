...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_agent_response.DescribeAgentResponse = (
        aws_sdk_quicksight.types.describe_agent_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_agent_request.DescribeAgentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
