"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeActionConnectorPermissions``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_action_connector_permissions_response.DescribeActionConnectorPermissionsResponse = aws_sdk_quicksight.types.describe_action_connector_permissions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_action_connector_permissions_request.DescribeActionConnectorPermissionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_action_connector_permissions(
