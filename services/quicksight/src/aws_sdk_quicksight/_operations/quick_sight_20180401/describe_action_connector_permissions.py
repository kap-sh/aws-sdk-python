...
def build_request(
    ...
    input: aws_sdk_quicksight.types.describe_action_connector_permissions_request.DescribeActionConnectorPermissionsRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ActionConnectorId}", quote(str(input["action_connector_id"]), safe="")
    )
    params: dict[str, str] = {}
