"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeRoleCustomPermission``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.describe_role_custom_permission_response.DescribeRoleCustomPermissionResponse = aws_sdk_quicksight.types.describe_role_custom_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.describe_role_custom_permission_request.DescribeRoleCustomPermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_role_custom_permission(
