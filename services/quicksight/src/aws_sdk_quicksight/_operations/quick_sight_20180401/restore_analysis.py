"""Generated from Smithy shape ``com.amazonaws.quicksight#RestoreAnalysis``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.restore_analysis_response.RestoreAnalysisResponse = (
        aws_sdk_quicksight.types.restore_analysis_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_quicksight.types.restore_analysis_request.RestoreAnalysisRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    params["restore-to-folders"] = str(input.get("restore_to_folders", False))
...
async def async_restore_analysis(
