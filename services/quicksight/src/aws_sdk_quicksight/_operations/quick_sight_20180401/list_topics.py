...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_topics_response.ListTopicsResponse = (
        aws_sdk_quicksight.types.list_topics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_topics_request.ListTopicsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_topics(
    ...
    aws_sdk_quicksight.types.list_topics_response.ListTopicsResponse, zapros.Response
]:
