"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteTemplateAlias``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_template_alias_response.DeleteTemplateAliasResponse = aws_sdk_quicksight.types.delete_template_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_template_alias_request.DeleteTemplateAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_template_alias(
