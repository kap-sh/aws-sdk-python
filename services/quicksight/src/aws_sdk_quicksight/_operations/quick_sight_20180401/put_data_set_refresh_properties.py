...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.put_data_set_refresh_properties_response.PutDataSetRefreshPropertiesResponse = aws_sdk_quicksight.types.put_data_set_refresh_properties_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.put_data_set_refresh_properties_request.PutDataSetRefreshPropertiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
