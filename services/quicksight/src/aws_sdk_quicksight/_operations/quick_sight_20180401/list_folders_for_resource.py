"""Generated from Smithy shape ``com.amazonaws.quicksight#ListFoldersForResource``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_folders_for_resource_response.ListFoldersForResourceResponse = aws_sdk_quicksight.types.list_folders_for_resource_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_folders_for_resource_request.ListFoldersForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/accounts/{AwsAccountId}/resource/{ResourceArn}/folders"
    )
...
async def async_list_folders_for_resource(
