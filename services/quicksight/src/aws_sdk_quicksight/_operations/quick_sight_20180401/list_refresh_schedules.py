...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.list_refresh_schedules_response.ListRefreshSchedulesResponse = aws_sdk_quicksight.types.list_refresh_schedules_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.list_refresh_schedules_request.ListRefreshSchedulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
