...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.update_role_custom_permission_response.UpdateRoleCustomPermissionResponse = aws_sdk_quicksight.types.update_role_custom_permission_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.update_role_custom_permission_request.UpdateRoleCustomPermissionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.update_role_custom_permission_request.serialize_json(
            input_
        )
    ).encode()
