...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.delete_theme_alias_response.DeleteThemeAliasResponse = aws_sdk_quicksight.types.delete_theme_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.delete_theme_alias_request.DeleteThemeAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
