...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.generate_embed_url_for_registered_user_request.GenerateEmbedUrlForRegisteredUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.generate_embed_url_for_registered_user_request.serialize_json(
            input_
        )
    ).encode()
