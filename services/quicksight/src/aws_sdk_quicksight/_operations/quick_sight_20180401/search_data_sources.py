"""Generated from Smithy shape ``com.amazonaws.quicksight#SearchDataSources``."""
...
def handle_response(
    ...
    out: aws_sdk_quicksight.types.search_data_sources_response.SearchDataSourcesResponse = aws_sdk_quicksight.types.search_data_sources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_quicksight.types.search_data_sources_request.SearchDataSourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/search/data-sources"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.search_data_sources_request.serialize_json(input_)
    ).encode()
...
async def async_search_data_sources(
