...
def build_request(
    ...
    input: aws_sdk_quicksight.types.search_data_sources_request.SearchDataSourcesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_quicksight.types.search_data_sources_request.serialize_json(input)
    ).encode()
