...
from aws_sdk_quicksight._auth._identity import Credentials
from aws_sdk_quicksight._auth._providers import (
    CredentialsProvider,
    IdentityProvider,
    StaticAwsCredentialsProvider,
    default_aws_credentials_chain,
)
from aws_sdk_quicksight._auth._zapros_handler import AuthMiddleware
from aws_sdk_quicksight._pagination import resolve_path as _resolve_path
from aws_sdk_quicksight._services._aws_config import aaws_config
...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.account_name
    ...
    import aws_sdk_quicksight.types.answer_ids
    ...
    import aws_sdk_quicksight.types.authentication_method_option
    ...
    import aws_sdk_quicksight.types.batch_create_topic_reviewed_answer_request
    import aws_sdk_quicksight.types.batch_create_topic_reviewed_answer_response
    import aws_sdk_quicksight.types.batch_delete_knowledge_base_request
    import aws_sdk_quicksight.types.batch_delete_knowledge_base_request_knowledge_base_ids_list
    import aws_sdk_quicksight.types.batch_delete_knowledge_base_response
    import aws_sdk_quicksight.types.batch_delete_topic_reviewed_answer_request
    import aws_sdk_quicksight.types.batch_delete_topic_reviewed_answer_response
    ...
    import aws_sdk_quicksight.types.cancel_ingestion_request
    import aws_sdk_quicksight.types.cancel_ingestion_response
    ...
    import aws_sdk_quicksight.types.create_account_customization_response
    import aws_sdk_quicksight.types.create_account_subscription_request
    import aws_sdk_quicksight.types.create_account_subscription_response
    import aws_sdk_quicksight.types.create_action_connector_request
    import aws_sdk_quicksight.types.create_action_connector_response
    ...
    import aws_sdk_quicksight.types.create_analysis_request
    import aws_sdk_quicksight.types.create_analysis_response
    import aws_sdk_quicksight.types.create_brand_request
    import aws_sdk_quicksight.types.create_brand_response
    import aws_sdk_quicksight.types.create_custom_permissions_request
    import aws_sdk_quicksight.types.create_custom_permissions_response
    import aws_sdk_quicksight.types.create_dashboard_request
    import aws_sdk_quicksight.types.create_dashboard_response
    import aws_sdk_quicksight.types.create_data_set_request
    import aws_sdk_quicksight.types.create_data_set_response
    import aws_sdk_quicksight.types.create_data_source_request
    import aws_sdk_quicksight.types.create_data_source_response
    import aws_sdk_quicksight.types.create_flow_request
    import aws_sdk_quicksight.types.create_flow_request_client_token_string
    import aws_sdk_quicksight.types.create_flow_response
    import aws_sdk_quicksight.types.create_folder_membership_request
    import aws_sdk_quicksight.types.create_folder_membership_response
    import aws_sdk_quicksight.types.create_folder_request
    import aws_sdk_quicksight.types.create_folder_response
    import aws_sdk_quicksight.types.create_group_membership_request
    import aws_sdk_quicksight.types.create_group_membership_response
    import aws_sdk_quicksight.types.create_group_request
    import aws_sdk_quicksight.types.create_group_response
    import aws_sdk_quicksight.types.create_iam_policy_assignment_request
    import aws_sdk_quicksight.types.create_iam_policy_assignment_response
    import aws_sdk_quicksight.types.create_ingestion_request
    import aws_sdk_quicksight.types.create_ingestion_response
    import aws_sdk_quicksight.types.create_namespace_request
    import aws_sdk_quicksight.types.create_namespace_response
    import aws_sdk_quicksight.types.create_o_auth_client_application_request
    import aws_sdk_quicksight.types.create_o_auth_client_application_response
    import aws_sdk_quicksight.types.create_refresh_schedule_request
    import aws_sdk_quicksight.types.create_refresh_schedule_response
    import aws_sdk_quicksight.types.create_role_membership_request
    import aws_sdk_quicksight.types.create_role_membership_response
    import aws_sdk_quicksight.types.create_space_request
    import aws_sdk_quicksight.types.create_space_response
    ...
    import aws_sdk_quicksight.types.create_template_request
    import aws_sdk_quicksight.types.create_template_response
    import aws_sdk_quicksight.types.create_theme_alias_request
    import aws_sdk_quicksight.types.create_theme_alias_response
    import aws_sdk_quicksight.types.create_theme_request
    import aws_sdk_quicksight.types.create_theme_response
    import aws_sdk_quicksight.types.create_topic_refresh_schedule_request
    import aws_sdk_quicksight.types.create_topic_refresh_schedule_response
    import aws_sdk_quicksight.types.create_topic_request
    import aws_sdk_quicksight.types.create_topic_response
    import aws_sdk_quicksight.types.create_topic_reviewed_answers
    import aws_sdk_quicksight.types.create_vpc_connection_request
    import aws_sdk_quicksight.types.create_vpc_connection_response
    ...
    import aws_sdk_quicksight.types.dashboard_version_summary
    ...
    import aws_sdk_quicksight.types.data_source_search_filter_list
    ...
    import aws_sdk_quicksight.types.delete_account_custom_permission_request
    import aws_sdk_quicksight.types.delete_account_custom_permission_response
    import aws_sdk_quicksight.types.delete_account_customization_request
    import aws_sdk_quicksight.types.delete_account_customization_response
    import aws_sdk_quicksight.types.delete_account_subscription_request
    import aws_sdk_quicksight.types.delete_account_subscription_response
    import aws_sdk_quicksight.types.delete_action_connector_request
    import aws_sdk_quicksight.types.delete_action_connector_response
    import aws_sdk_quicksight.types.delete_agent_request
    import aws_sdk_quicksight.types.delete_agent_response
    import aws_sdk_quicksight.types.delete_analysis_request
    import aws_sdk_quicksight.types.delete_analysis_response
    import aws_sdk_quicksight.types.delete_brand_assignment_request
    import aws_sdk_quicksight.types.delete_brand_assignment_response
    import aws_sdk_quicksight.types.delete_brand_request
    import aws_sdk_quicksight.types.delete_brand_response
    import aws_sdk_quicksight.types.delete_custom_permissions_request
    import aws_sdk_quicksight.types.delete_custom_permissions_response
    import aws_sdk_quicksight.types.delete_dashboard_request
    import aws_sdk_quicksight.types.delete_dashboard_response
    import aws_sdk_quicksight.types.delete_data_set_refresh_properties_request
    import aws_sdk_quicksight.types.delete_data_set_refresh_properties_response
    import aws_sdk_quicksight.types.delete_data_set_request
    import aws_sdk_quicksight.types.delete_data_set_response
    import aws_sdk_quicksight.types.delete_data_source_request
    import aws_sdk_quicksight.types.delete_data_source_response
    import aws_sdk_quicksight.types.delete_default_q_business_application_request
    import aws_sdk_quicksight.types.delete_default_q_business_application_response
    import aws_sdk_quicksight.types.delete_flow_request
    import aws_sdk_quicksight.types.delete_flow_response
    import aws_sdk_quicksight.types.delete_folder_membership_request
    import aws_sdk_quicksight.types.delete_folder_membership_response
    import aws_sdk_quicksight.types.delete_folder_request
    import aws_sdk_quicksight.types.delete_folder_response
    import aws_sdk_quicksight.types.delete_group_membership_request
    import aws_sdk_quicksight.types.delete_group_membership_response
    import aws_sdk_quicksight.types.delete_group_request
    import aws_sdk_quicksight.types.delete_group_response
    import aws_sdk_quicksight.types.delete_iam_policy_assignment_request
    import aws_sdk_quicksight.types.delete_iam_policy_assignment_response
    import aws_sdk_quicksight.types.delete_identity_propagation_config_request
    import aws_sdk_quicksight.types.delete_identity_propagation_config_response
    import aws_sdk_quicksight.types.delete_knowledge_base_request
    import aws_sdk_quicksight.types.delete_knowledge_base_response
    import aws_sdk_quicksight.types.delete_namespace_request
    import aws_sdk_quicksight.types.delete_namespace_response
    import aws_sdk_quicksight.types.delete_o_auth_client_application_request
    import aws_sdk_quicksight.types.delete_o_auth_client_application_response
    import aws_sdk_quicksight.types.delete_refresh_schedule_request
    import aws_sdk_quicksight.types.delete_refresh_schedule_response
    import aws_sdk_quicksight.types.delete_role_custom_permission_request
    import aws_sdk_quicksight.types.delete_role_custom_permission_response
    import aws_sdk_quicksight.types.delete_role_membership_request
    import aws_sdk_quicksight.types.delete_role_membership_response
    import aws_sdk_quicksight.types.delete_space_request
    import aws_sdk_quicksight.types.delete_space_response
    import aws_sdk_quicksight.types.delete_template_alias_request
    import aws_sdk_quicksight.types.delete_template_alias_response
    import aws_sdk_quicksight.types.delete_template_request
    import aws_sdk_quicksight.types.delete_template_response
    import aws_sdk_quicksight.types.delete_theme_alias_request
    import aws_sdk_quicksight.types.delete_theme_alias_response
    import aws_sdk_quicksight.types.delete_theme_request
    import aws_sdk_quicksight.types.delete_theme_response
    import aws_sdk_quicksight.types.delete_topic_refresh_schedule_request
    import aws_sdk_quicksight.types.delete_topic_refresh_schedule_response
    import aws_sdk_quicksight.types.delete_topic_request
    import aws_sdk_quicksight.types.delete_topic_response
    import aws_sdk_quicksight.types.delete_user_by_principal_id_request
    import aws_sdk_quicksight.types.delete_user_by_principal_id_response
    import aws_sdk_quicksight.types.delete_user_custom_permission_request
    import aws_sdk_quicksight.types.delete_user_custom_permission_response
    import aws_sdk_quicksight.types.delete_user_request
    import aws_sdk_quicksight.types.delete_user_response
    import aws_sdk_quicksight.types.delete_vpc_connection_request
    import aws_sdk_quicksight.types.delete_vpc_connection_response
    import aws_sdk_quicksight.types.describe_account_custom_permission_request
    import aws_sdk_quicksight.types.describe_account_custom_permission_response
    import aws_sdk_quicksight.types.describe_account_customization_request
    import aws_sdk_quicksight.types.describe_account_customization_response
    import aws_sdk_quicksight.types.describe_account_settings_request
    import aws_sdk_quicksight.types.describe_account_settings_response
    import aws_sdk_quicksight.types.describe_account_subscription_request
    import aws_sdk_quicksight.types.describe_account_subscription_response
    import aws_sdk_quicksight.types.describe_action_connector_permissions_request
    import aws_sdk_quicksight.types.describe_action_connector_permissions_response
    import aws_sdk_quicksight.types.describe_action_connector_request
    import aws_sdk_quicksight.types.describe_action_connector_response
    import aws_sdk_quicksight.types.describe_agent_permissions_request
    import aws_sdk_quicksight.types.describe_agent_permissions_response
    import aws_sdk_quicksight.types.describe_agent_request
    import aws_sdk_quicksight.types.describe_agent_response
    import aws_sdk_quicksight.types.describe_analysis_definition_request
    import aws_sdk_quicksight.types.describe_analysis_definition_response
    import aws_sdk_quicksight.types.describe_analysis_permissions_request
    import aws_sdk_quicksight.types.describe_analysis_permissions_response
    import aws_sdk_quicksight.types.describe_analysis_request
    import aws_sdk_quicksight.types.describe_analysis_response
    import aws_sdk_quicksight.types.describe_asset_bundle_export_job_request
    import aws_sdk_quicksight.types.describe_asset_bundle_export_job_response
    import aws_sdk_quicksight.types.describe_asset_bundle_import_job_request
    import aws_sdk_quicksight.types.describe_asset_bundle_import_job_response
    import aws_sdk_quicksight.types.describe_automation_job_request
    import aws_sdk_quicksight.types.describe_automation_job_response
    import aws_sdk_quicksight.types.describe_brand_assignment_request
    import aws_sdk_quicksight.types.describe_brand_assignment_response
    import aws_sdk_quicksight.types.describe_brand_published_version_request
    import aws_sdk_quicksight.types.describe_brand_published_version_response
    import aws_sdk_quicksight.types.describe_brand_request
    import aws_sdk_quicksight.types.describe_brand_response
    import aws_sdk_quicksight.types.describe_custom_permissions_request
    import aws_sdk_quicksight.types.describe_custom_permissions_response
    import aws_sdk_quicksight.types.describe_dashboard_definition_request
    import aws_sdk_quicksight.types.describe_dashboard_definition_response
    import aws_sdk_quicksight.types.describe_dashboard_permissions_request
    import aws_sdk_quicksight.types.describe_dashboard_permissions_response
    import aws_sdk_quicksight.types.describe_dashboard_request
    import aws_sdk_quicksight.types.describe_dashboard_response
    import aws_sdk_quicksight.types.describe_dashboard_snapshot_job_request
    import aws_sdk_quicksight.types.describe_dashboard_snapshot_job_response
    import aws_sdk_quicksight.types.describe_dashboard_snapshot_job_result_request
    import aws_sdk_quicksight.types.describe_dashboard_snapshot_job_result_response
    import aws_sdk_quicksight.types.describe_dashboards_qa_configuration_request
    import aws_sdk_quicksight.types.describe_dashboards_qa_configuration_response
    import aws_sdk_quicksight.types.describe_data_set_permissions_request
    import aws_sdk_quicksight.types.describe_data_set_permissions_response
    import aws_sdk_quicksight.types.describe_data_set_refresh_properties_request
    import aws_sdk_quicksight.types.describe_data_set_refresh_properties_response
    import aws_sdk_quicksight.types.describe_data_set_request
    import aws_sdk_quicksight.types.describe_data_set_response
    import aws_sdk_quicksight.types.describe_data_source_permissions_request
    import aws_sdk_quicksight.types.describe_data_source_permissions_response
    import aws_sdk_quicksight.types.describe_data_source_request
    import aws_sdk_quicksight.types.describe_data_source_response
    import aws_sdk_quicksight.types.describe_default_q_business_application_request
    import aws_sdk_quicksight.types.describe_default_q_business_application_response
    import aws_sdk_quicksight.types.describe_flow_request
    import aws_sdk_quicksight.types.describe_flow_response
    import aws_sdk_quicksight.types.describe_folder_permissions_request
    import aws_sdk_quicksight.types.describe_folder_permissions_response
    import aws_sdk_quicksight.types.describe_folder_request
    import aws_sdk_quicksight.types.describe_folder_resolved_permissions_request
    import aws_sdk_quicksight.types.describe_folder_resolved_permissions_response
    import aws_sdk_quicksight.types.describe_folder_response
    import aws_sdk_quicksight.types.describe_group_membership_request
    import aws_sdk_quicksight.types.describe_group_membership_response
    import aws_sdk_quicksight.types.describe_group_request
    import aws_sdk_quicksight.types.describe_group_response
    import aws_sdk_quicksight.types.describe_iam_policy_assignment_request
    import aws_sdk_quicksight.types.describe_iam_policy_assignment_response
    import aws_sdk_quicksight.types.describe_ingestion_request
    import aws_sdk_quicksight.types.describe_ingestion_response
    import aws_sdk_quicksight.types.describe_ip_restriction_request
    import aws_sdk_quicksight.types.describe_ip_restriction_response
    import aws_sdk_quicksight.types.describe_key_registration_request
    import aws_sdk_quicksight.types.describe_key_registration_response
    import aws_sdk_quicksight.types.describe_knowledge_base_permissions_request
    import aws_sdk_quicksight.types.describe_knowledge_base_permissions_response
    import aws_sdk_quicksight.types.describe_knowledge_base_request
    import aws_sdk_quicksight.types.describe_knowledge_base_response
    import aws_sdk_quicksight.types.describe_namespace_request
    import aws_sdk_quicksight.types.describe_namespace_response
    import aws_sdk_quicksight.types.describe_o_auth_client_application_request
    import aws_sdk_quicksight.types.describe_o_auth_client_application_response
    import aws_sdk_quicksight.types.describe_q_personalization_configuration_request
    import aws_sdk_quicksight.types.describe_q_personalization_configuration_response
    import aws_sdk_quicksight.types.describe_quick_sight_q_search_configuration_request
    import aws_sdk_quicksight.types.describe_quick_sight_q_search_configuration_response
    import aws_sdk_quicksight.types.describe_refresh_schedule_request
    import aws_sdk_quicksight.types.describe_refresh_schedule_response
    import aws_sdk_quicksight.types.describe_role_custom_permission_request
    import aws_sdk_quicksight.types.describe_role_custom_permission_response
    import aws_sdk_quicksight.types.describe_self_upgrade_configuration_request
    import aws_sdk_quicksight.types.describe_self_upgrade_configuration_response
    import aws_sdk_quicksight.types.describe_space_permissions_request
    import aws_sdk_quicksight.types.describe_space_permissions_response
    import aws_sdk_quicksight.types.describe_space_request
    import aws_sdk_quicksight.types.describe_space_response
    import aws_sdk_quicksight.types.describe_template_alias_request
    import aws_sdk_quicksight.types.describe_template_alias_response
    import aws_sdk_quicksight.types.describe_template_definition_request
    import aws_sdk_quicksight.types.describe_template_definition_response
    import aws_sdk_quicksight.types.describe_template_permissions_request
    import aws_sdk_quicksight.types.describe_template_permissions_response
    import aws_sdk_quicksight.types.describe_template_request
    import aws_sdk_quicksight.types.describe_template_response
    import aws_sdk_quicksight.types.describe_theme_alias_request
    import aws_sdk_quicksight.types.describe_theme_alias_response
    import aws_sdk_quicksight.types.describe_theme_permissions_request
    import aws_sdk_quicksight.types.describe_theme_permissions_response
    import aws_sdk_quicksight.types.describe_theme_request
    import aws_sdk_quicksight.types.describe_theme_response
    import aws_sdk_quicksight.types.describe_topic_permissions_request
    import aws_sdk_quicksight.types.describe_topic_permissions_response
    import aws_sdk_quicksight.types.describe_topic_refresh_request
    import aws_sdk_quicksight.types.describe_topic_refresh_response
    import aws_sdk_quicksight.types.describe_topic_refresh_schedule_request
    import aws_sdk_quicksight.types.describe_topic_refresh_schedule_response
    import aws_sdk_quicksight.types.describe_topic_request
    import aws_sdk_quicksight.types.describe_topic_response
    import aws_sdk_quicksight.types.describe_user_request
    import aws_sdk_quicksight.types.describe_user_response
    import aws_sdk_quicksight.types.describe_vpc_connection_request
    import aws_sdk_quicksight.types.describe_vpc_connection_response
    ...
    import aws_sdk_quicksight.types.entry_point
    ...
    import aws_sdk_quicksight.types.folder_search_filter_list
    import aws_sdk_quicksight.types.folder_summary
    import aws_sdk_quicksight.types.folder_type
    import aws_sdk_quicksight.types.generate_embed_url_for_anonymous_user_request
    import aws_sdk_quicksight.types.generate_embed_url_for_anonymous_user_response
    ...
    import aws_sdk_quicksight.types.generate_embed_url_for_registered_user_with_identity_response
    import aws_sdk_quicksight.types.get_dashboard_embed_url_request
    import aws_sdk_quicksight.types.get_dashboard_embed_url_response
    import aws_sdk_quicksight.types.get_flow_metadata_input
    import aws_sdk_quicksight.types.get_flow_metadata_output
    import aws_sdk_quicksight.types.get_flow_permissions_input
    import aws_sdk_quicksight.types.get_flow_permissions_output
    import aws_sdk_quicksight.types.get_identity_context_request
    import aws_sdk_quicksight.types.get_identity_context_response
    import aws_sdk_quicksight.types.get_session_embed_url_request
    import aws_sdk_quicksight.types.get_session_embed_url_response
    ...
    import aws_sdk_quicksight.types.group_search_filter_list
    import aws_sdk_quicksight.types.groups_list
    import aws_sdk_quicksight.types.iam_policy_assignment_name
    import aws_sdk_quicksight.types.iam_policy_assignment_summary
    ...
    import aws_sdk_quicksight.types.knowledge_base_summary
    ...
    import aws_sdk_quicksight.types.list_action_connectors_request
    import aws_sdk_quicksight.types.list_action_connectors_response
    import aws_sdk_quicksight.types.list_agents_request
    import aws_sdk_quicksight.types.list_agents_request_max_results_integer
    import aws_sdk_quicksight.types.list_agents_response
    import aws_sdk_quicksight.types.list_analyses_request
    import aws_sdk_quicksight.types.list_analyses_response
    import aws_sdk_quicksight.types.list_asset_bundle_export_jobs_request
    import aws_sdk_quicksight.types.list_asset_bundle_export_jobs_response
    import aws_sdk_quicksight.types.list_asset_bundle_import_jobs_request
    import aws_sdk_quicksight.types.list_asset_bundle_import_jobs_response
    import aws_sdk_quicksight.types.list_brands_request
    import aws_sdk_quicksight.types.list_brands_response
    import aws_sdk_quicksight.types.list_custom_permissions_request
    import aws_sdk_quicksight.types.list_custom_permissions_response
    import aws_sdk_quicksight.types.list_dashboard_versions_request
    import aws_sdk_quicksight.types.list_dashboard_versions_response
    import aws_sdk_quicksight.types.list_dashboards_request
    import aws_sdk_quicksight.types.list_dashboards_response
    import aws_sdk_quicksight.types.list_data_sets_request
    import aws_sdk_quicksight.types.list_data_sets_response
    import aws_sdk_quicksight.types.list_data_sources_request
    import aws_sdk_quicksight.types.list_data_sources_response
    import aws_sdk_quicksight.types.list_flows_input
    import aws_sdk_quicksight.types.list_flows_output
    import aws_sdk_quicksight.types.list_folder_members_request
    import aws_sdk_quicksight.types.list_folder_members_response
    import aws_sdk_quicksight.types.list_folders_for_resource_request
    import aws_sdk_quicksight.types.list_folders_for_resource_response
    import aws_sdk_quicksight.types.list_folders_request
    import aws_sdk_quicksight.types.list_folders_response
    import aws_sdk_quicksight.types.list_group_memberships_request
    import aws_sdk_quicksight.types.list_group_memberships_response
    import aws_sdk_quicksight.types.list_groups_request
    import aws_sdk_quicksight.types.list_groups_response
    import aws_sdk_quicksight.types.list_iam_policy_assignments_for_user_request
    import aws_sdk_quicksight.types.list_iam_policy_assignments_for_user_response
    import aws_sdk_quicksight.types.list_iam_policy_assignments_request
    import aws_sdk_quicksight.types.list_iam_policy_assignments_response
    import aws_sdk_quicksight.types.list_identity_propagation_configs_request
    import aws_sdk_quicksight.types.list_identity_propagation_configs_response
    import aws_sdk_quicksight.types.list_identity_propagation_max_results
    import aws_sdk_quicksight.types.list_ingestions_request
    import aws_sdk_quicksight.types.list_ingestions_response
    import aws_sdk_quicksight.types.list_knowledge_bases_request
    import aws_sdk_quicksight.types.list_knowledge_bases_response
    import aws_sdk_quicksight.types.list_namespaces_request
    import aws_sdk_quicksight.types.list_namespaces_response
    import aws_sdk_quicksight.types.list_o_auth_client_applications_request
    import aws_sdk_quicksight.types.list_o_auth_client_applications_response
    import aws_sdk_quicksight.types.list_refresh_schedules_request
    import aws_sdk_quicksight.types.list_refresh_schedules_response
    import aws_sdk_quicksight.types.list_role_memberships_request
    import aws_sdk_quicksight.types.list_role_memberships_response
    import aws_sdk_quicksight.types.list_self_upgrades_request
    import aws_sdk_quicksight.types.list_self_upgrades_response
    import aws_sdk_quicksight.types.list_space_resources_request
    import aws_sdk_quicksight.types.list_space_resources_response
    import aws_sdk_quicksight.types.list_spaces_request
    import aws_sdk_quicksight.types.list_spaces_response
    import aws_sdk_quicksight.types.list_tags_for_resource_request
    import aws_sdk_quicksight.types.list_tags_for_resource_response
    import aws_sdk_quicksight.types.list_template_aliases_request
    import aws_sdk_quicksight.types.list_template_aliases_response
    import aws_sdk_quicksight.types.list_template_versions_request
    import aws_sdk_quicksight.types.list_template_versions_response
    import aws_sdk_quicksight.types.list_templates_request
    import aws_sdk_quicksight.types.list_templates_response
    import aws_sdk_quicksight.types.list_theme_aliases_request
    import aws_sdk_quicksight.types.list_theme_aliases_response
    import aws_sdk_quicksight.types.list_theme_versions_request
    import aws_sdk_quicksight.types.list_theme_versions_response
    import aws_sdk_quicksight.types.list_themes_request
    import aws_sdk_quicksight.types.list_themes_response
    import aws_sdk_quicksight.types.list_topic_refresh_schedules_request
    import aws_sdk_quicksight.types.list_topic_refresh_schedules_response
    import aws_sdk_quicksight.types.list_topic_reviewed_answers_request
    import aws_sdk_quicksight.types.list_topic_reviewed_answers_response
    import aws_sdk_quicksight.types.list_topics_request
    import aws_sdk_quicksight.types.list_topics_response
    import aws_sdk_quicksight.types.list_user_groups_request
    import aws_sdk_quicksight.types.list_user_groups_response
    import aws_sdk_quicksight.types.list_users_index_capacity_request
    import aws_sdk_quicksight.types.list_users_index_capacity_request_max_results_integer
    import aws_sdk_quicksight.types.list_users_index_capacity_response
    import aws_sdk_quicksight.types.list_users_request
    import aws_sdk_quicksight.types.list_users_response
    import aws_sdk_quicksight.types.list_vpc_connections_request
    import aws_sdk_quicksight.types.list_vpc_connections_response
    ...
    import aws_sdk_quicksight.types.predict_qa_results_request
    import aws_sdk_quicksight.types.predict_qa_results_response
    ...
    import aws_sdk_quicksight.types.put_data_set_refresh_properties_response
    ...
    import aws_sdk_quicksight.types.register_user_response
    ...
    import aws_sdk_quicksight.types.restore_analysis_request
    import aws_sdk_quicksight.types.restore_analysis_response
    ...
    import aws_sdk_quicksight.types.role_session_name
    ...
    import aws_sdk_quicksight.types.search_action_connectors_request
    import aws_sdk_quicksight.types.search_action_connectors_request_max_results_integer
    import aws_sdk_quicksight.types.search_action_connectors_response
    import aws_sdk_quicksight.types.search_agents_request
    import aws_sdk_quicksight.types.search_agents_response
    import aws_sdk_quicksight.types.search_analyses_request
    import aws_sdk_quicksight.types.search_analyses_response
    import aws_sdk_quicksight.types.search_dashboards_request
    import aws_sdk_quicksight.types.search_dashboards_response
    import aws_sdk_quicksight.types.search_data_sets_request
    import aws_sdk_quicksight.types.search_data_sets_response
    import aws_sdk_quicksight.types.search_data_sources_request
    import aws_sdk_quicksight.types.search_data_sources_response
    import aws_sdk_quicksight.types.search_flows_filter_list
    import aws_sdk_quicksight.types.search_flows_input
    import aws_sdk_quicksight.types.search_flows_output
    import aws_sdk_quicksight.types.search_folders_request
    import aws_sdk_quicksight.types.search_folders_response
    import aws_sdk_quicksight.types.search_groups_request
    import aws_sdk_quicksight.types.search_groups_response
    import aws_sdk_quicksight.types.search_knowledge_bases_request
    import aws_sdk_quicksight.types.search_knowledge_bases_response
    import aws_sdk_quicksight.types.search_spaces_request
    import aws_sdk_quicksight.types.search_spaces_response
    import aws_sdk_quicksight.types.search_topics_request
    import aws_sdk_quicksight.types.search_topics_response
    ...
    import aws_sdk_quicksight.types.snapshot_configuration
    import aws_sdk_quicksight.types.snapshot_user_configuration
    ...
    import aws_sdk_quicksight.types.start_asset_bundle_export_job_request
    import aws_sdk_quicksight.types.start_asset_bundle_export_job_response
    import aws_sdk_quicksight.types.start_asset_bundle_import_job_request
    import aws_sdk_quicksight.types.start_asset_bundle_import_job_response
    import aws_sdk_quicksight.types.start_automation_job_request
    import aws_sdk_quicksight.types.start_automation_job_response
    ...
    import aws_sdk_quicksight.types.start_dashboard_snapshot_job_schedule_request
    import aws_sdk_quicksight.types.start_dashboard_snapshot_job_schedule_response
    ...
    import aws_sdk_quicksight.types.tag_resource_request
    import aws_sdk_quicksight.types.tag_resource_response
    ...
    import aws_sdk_quicksight.types.template_summary
    ...
    import aws_sdk_quicksight.types.theme_summary
    ...
    import aws_sdk_quicksight.types.topic_summary
    import aws_sdk_quicksight.types.untag_resource_request
    import aws_sdk_quicksight.types.untag_resource_response
    import aws_sdk_quicksight.types.update_account_custom_permission_request
    import aws_sdk_quicksight.types.update_account_custom_permission_response
    import aws_sdk_quicksight.types.update_account_customization_request
    import aws_sdk_quicksight.types.update_account_customization_response
    import aws_sdk_quicksight.types.update_account_settings_request
    import aws_sdk_quicksight.types.update_account_settings_response
    import aws_sdk_quicksight.types.update_action_connector_permissions_request
    import aws_sdk_quicksight.types.update_action_connector_permissions_response
    import aws_sdk_quicksight.types.update_action_connector_request
    import aws_sdk_quicksight.types.update_action_connector_response
    import aws_sdk_quicksight.types.update_agent_permissions_request
    ...
    import aws_sdk_quicksight.types.update_agent_permissions_response
    import aws_sdk_quicksight.types.update_agent_request
    ...
    import aws_sdk_quicksight.types.update_agent_response
    import aws_sdk_quicksight.types.update_analysis_permissions_request
    import aws_sdk_quicksight.types.update_analysis_permissions_response
    import aws_sdk_quicksight.types.update_analysis_request
    import aws_sdk_quicksight.types.update_analysis_response
    import aws_sdk_quicksight.types.update_application_with_token_exchange_grant_request
    import aws_sdk_quicksight.types.update_application_with_token_exchange_grant_response
    import aws_sdk_quicksight.types.update_brand_assignment_request
    import aws_sdk_quicksight.types.update_brand_assignment_response
    import aws_sdk_quicksight.types.update_brand_published_version_request
    import aws_sdk_quicksight.types.update_brand_published_version_response
    import aws_sdk_quicksight.types.update_brand_request
    import aws_sdk_quicksight.types.update_brand_response
    import aws_sdk_quicksight.types.update_custom_permissions_request
    import aws_sdk_quicksight.types.update_custom_permissions_response
    import aws_sdk_quicksight.types.update_dashboard_links_request
    import aws_sdk_quicksight.types.update_dashboard_links_response
    import aws_sdk_quicksight.types.update_dashboard_permissions_request
    import aws_sdk_quicksight.types.update_dashboard_permissions_response
    import aws_sdk_quicksight.types.update_dashboard_published_version_request
    import aws_sdk_quicksight.types.update_dashboard_published_version_response
    import aws_sdk_quicksight.types.update_dashboard_request
    import aws_sdk_quicksight.types.update_dashboard_response
    import aws_sdk_quicksight.types.update_dashboards_qa_configuration_request
    import aws_sdk_quicksight.types.update_dashboards_qa_configuration_response
    import aws_sdk_quicksight.types.update_data_set_permissions_request
    import aws_sdk_quicksight.types.update_data_set_permissions_response
    import aws_sdk_quicksight.types.update_data_set_request
    import aws_sdk_quicksight.types.update_data_set_response
    import aws_sdk_quicksight.types.update_data_source_permissions_request
    import aws_sdk_quicksight.types.update_data_source_permissions_response
    import aws_sdk_quicksight.types.update_data_source_request
    import aws_sdk_quicksight.types.update_data_source_response
    import aws_sdk_quicksight.types.update_default_q_business_application_request
    import aws_sdk_quicksight.types.update_default_q_business_application_response
    import aws_sdk_quicksight.types.update_flow_permissions_input
    ...
    import aws_sdk_quicksight.types.update_flow_permissions_output
    import aws_sdk_quicksight.types.update_flow_request
    import aws_sdk_quicksight.types.update_flow_request_client_token_string
    import aws_sdk_quicksight.types.update_flow_response
    import aws_sdk_quicksight.types.update_folder_permissions_request
    import aws_sdk_quicksight.types.update_folder_permissions_response
    import aws_sdk_quicksight.types.update_folder_request
    import aws_sdk_quicksight.types.update_folder_response
    import aws_sdk_quicksight.types.update_group_request
    import aws_sdk_quicksight.types.update_group_response
    import aws_sdk_quicksight.types.update_iam_policy_assignment_request
    import aws_sdk_quicksight.types.update_iam_policy_assignment_response
    import aws_sdk_quicksight.types.update_identity_propagation_config_request
    import aws_sdk_quicksight.types.update_identity_propagation_config_response
    import aws_sdk_quicksight.types.update_ip_restriction_request
    import aws_sdk_quicksight.types.update_ip_restriction_response
    import aws_sdk_quicksight.types.update_key_registration_request
    import aws_sdk_quicksight.types.update_key_registration_response
    import aws_sdk_quicksight.types.update_knowledge_base_permissions_request
    import aws_sdk_quicksight.types.update_knowledge_base_permissions_response
    import aws_sdk_quicksight.types.update_link_permission_list
    import aws_sdk_quicksight.types.update_o_auth_client_application_request
    import aws_sdk_quicksight.types.update_o_auth_client_application_response
    import aws_sdk_quicksight.types.update_public_sharing_settings_request
    import aws_sdk_quicksight.types.update_public_sharing_settings_response
    import aws_sdk_quicksight.types.update_q_personalization_configuration_request
    import aws_sdk_quicksight.types.update_q_personalization_configuration_response
    import aws_sdk_quicksight.types.update_quick_sight_q_search_configuration_request
    import aws_sdk_quicksight.types.update_quick_sight_q_search_configuration_response
    import aws_sdk_quicksight.types.update_refresh_schedule_request
    import aws_sdk_quicksight.types.update_refresh_schedule_response
    import aws_sdk_quicksight.types.update_resource_permission_list
    import aws_sdk_quicksight.types.update_role_custom_permission_request
    import aws_sdk_quicksight.types.update_role_custom_permission_response
    import aws_sdk_quicksight.types.update_self_upgrade_configuration_request
    import aws_sdk_quicksight.types.update_self_upgrade_configuration_response
    import aws_sdk_quicksight.types.update_self_upgrade_request
    import aws_sdk_quicksight.types.update_self_upgrade_response
    import aws_sdk_quicksight.types.update_space_permissions_request
    import aws_sdk_quicksight.types.update_space_permissions_response
    import aws_sdk_quicksight.types.update_space_request
    import aws_sdk_quicksight.types.update_space_resources_request
    import aws_sdk_quicksight.types.update_space_resources_response
    import aws_sdk_quicksight.types.update_space_response
    import aws_sdk_quicksight.types.update_spice_capacity_configuration_request
    import aws_sdk_quicksight.types.update_spice_capacity_configuration_response
    import aws_sdk_quicksight.types.update_template_alias_request
    import aws_sdk_quicksight.types.update_template_alias_response
    import aws_sdk_quicksight.types.update_template_permissions_request
    import aws_sdk_quicksight.types.update_template_permissions_response
    import aws_sdk_quicksight.types.update_template_request
    import aws_sdk_quicksight.types.update_template_response
    import aws_sdk_quicksight.types.update_theme_alias_request
    import aws_sdk_quicksight.types.update_theme_alias_response
    import aws_sdk_quicksight.types.update_theme_permissions_request
    import aws_sdk_quicksight.types.update_theme_permissions_response
    import aws_sdk_quicksight.types.update_theme_request
    import aws_sdk_quicksight.types.update_theme_response
    import aws_sdk_quicksight.types.update_topic_permissions_request
    import aws_sdk_quicksight.types.update_topic_permissions_response
    import aws_sdk_quicksight.types.update_topic_refresh_schedule_request
    import aws_sdk_quicksight.types.update_topic_refresh_schedule_response
    import aws_sdk_quicksight.types.update_topic_request
    import aws_sdk_quicksight.types.update_topic_response
    import aws_sdk_quicksight.types.update_user_custom_permission_request
    import aws_sdk_quicksight.types.update_user_custom_permission_response
    import aws_sdk_quicksight.types.update_user_request
    import aws_sdk_quicksight.types.update_user_response
    import aws_sdk_quicksight.types.update_vpc_connection_request
    import aws_sdk_quicksight.types.update_vpc_connection_response
    import aws_sdk_quicksight.types.user
    import aws_sdk_quicksight.types.user_identifier
    import aws_sdk_quicksight.types.user_index_capacity_filters
    import aws_sdk_quicksight.types.user_index_capacity_sort_by
    import aws_sdk_quicksight.types.user_index_capacity_sort_order
...
class AsyncQuickSightClientConfig(TypedDict, total=False):
...
class AsyncQuickSightClient:
    """A client for the ``QuickSight`` service.
    ...
    def __init__(
        ...
        self._config = AsyncQuickSightClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncQuickSightClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncQuickSightClientConfig = config_overrides or {}
    ...
    async def batch_create_topic_reviewed_answer(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.batch_create_topic_reviewed_answer_response.BatchCreateTopicReviewedAnswerResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.batch_create_topic_reviewed_answer_request.BatchCreateTopicReviewedAnswerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.batch_create_topic_reviewed_answer_response.BatchCreateTopicReviewedAnswerResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.batch_create_topic_reviewed_answer

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.batch_create_topic_reviewed_answer.async_batch_create_topic_reviewed_answer(
    ...
    async def batch_delete_knowledge_base(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.batch_delete_knowledge_base_response.BatchDeleteKnowledgeBaseResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.batch_delete_knowledge_base_request.BatchDeleteKnowledgeBaseRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.batch_delete_knowledge_base_response.BatchDeleteKnowledgeBaseResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.batch_delete_knowledge_base

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.batch_delete_knowledge_base.async_batch_delete_knowledge_base(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_delete_topic_reviewed_answer(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        answer_ids: Optional["aws_sdk_quicksight.types.answer_ids.AnswerIds"] = None,
    ) -> "aws_sdk_quicksight.types.batch_delete_topic_reviewed_answer_response.BatchDeleteTopicReviewedAnswerResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.batch_delete_topic_reviewed_answer_request.BatchDeleteTopicReviewedAnswerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.batch_delete_topic_reviewed_answer_response.BatchDeleteTopicReviewedAnswerResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.batch_delete_topic_reviewed_answer

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.batch_delete_topic_reviewed_answer.async_batch_delete_topic_reviewed_answer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_ingestion(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.cancel_ingestion_response.CancelIngestionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.cancel_ingestion_request.CancelIngestionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.cancel_ingestion_response.CancelIngestionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.cancel_ingestion

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.cancel_ingestion.async_cancel_ingestion(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_account_customization(
        self,
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        account_customization: "aws_sdk_quicksight.types.account_customization.AccountCustomization",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        namespace: Optional["aws_sdk_quicksight.types.namespace.Namespace"] = None,
        tags: Optional["aws_sdk_quicksight.types.tag_list.TagList"] = None,
        ...
        Args:
            aws_account_id: <p>The ID for the Amazon Web Services account that you want to customize Quick Sight for.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_account_customization_request.CreateAccountCustomizationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_account_customization_response.CreateAccountCustomizationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_account_customization

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_account_customization.async_create_account_customization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_account_subscription(
        ...
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        account_name: "aws_sdk_quicksight.types.account_name.AccountName",
        notification_email: "aws_sdk_quicksight.types.string.String",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        edition: Optional["aws_sdk_quicksight.types.edition.Edition"] = None,
        active_directory_name: Optional[
            "aws_sdk_quicksight.types.string.String"
        ] = None,
        realm: Optional["aws_sdk_quicksight.types.string.String"] = None,
        directory_id: Optional["aws_sdk_quicksight.types.string.String"] = None,
        admin_group: Optional["aws_sdk_quicksight.types.groups_list.GroupsList"] = None,
        author_group: Optional[
            "aws_sdk_quicksight.types.groups_list.GroupsList"
        ] = None,
        ...
        first_name: Optional["aws_sdk_quicksight.types.string.String"] = None,
        last_name: Optional["aws_sdk_quicksight.types.string.String"] = None,
        email_address: Optional["aws_sdk_quicksight.types.string.String"] = None,
        contact_number: Optional["aws_sdk_quicksight.types.string.String"] = None,
        ...
        Args:
            edition: <p>The edition of Amazon Quick Sight that you want your account to have. Currently, you can choose from <code>ENTERPRISE</code> or <code>ENTERPRISE_AND_Q</code>.</p> <p>If you choose <code>ENTERPRISE_AND_Q</code>, the following parameters are required:</p> <ul> <li> <p> <code>FirstName</code> </p> </li> <li> <p> <code>LastName</code> </p> </li> <li> <p> <code>EmailAddress</code> </p> </li> <li> <p> <code>ContactNumber</code> </p> </li> </ul>
            authentication_method: <p>The method that you want to use to authenticate your Quick Sight account.</p> <p>If you choose <code>ACTIVE_DIRECTORY</code>, provide an <code>ActiveDirectoryName</code> and an <code>AdminGroup</code> associated with your Active Directory.</p> <p>If you choose <code>IAM_IDENTITY_CENTER</code>, provide an <code>AdminGroup</code> associated with your IAM Identity Center account.</p>
            aws_account_id: <p>The Amazon Web Services account ID of the account that you're using to create your Quick Sight account.</p>
            account_name: <p>The name of your Amazon Quick Sight account. This name is unique over all of Amazon Web Services, and it appears only when users sign in. You can't change <code>AccountName</code> value after the Amazon Quick Sight account is created.</p>
            notification_email: <p>The email address that you want Quick Sight to send notifications to regarding your Quick Sight account or Quick Sight subscription.</p>
            active_directory_name: <p>The name of your Active Directory. This field is required if <code>ACTIVE_DIRECTORY</code> is the selected authentication method of the new Quick Sight account.</p>
            realm: <p>The realm of the Active Directory that is associated with your Quick Sight account. This field is required if <code>ACTIVE_DIRECTORY</code> is the selected authentication method of the new Quick Sight account.</p>
            directory_id: <p>The ID of the Active Directory that is associated with your Quick Sight account.</p>
            admin_group: <p>The admin group associated with your Active Directory or IAM Identity Center account. Either this field or the <code>AdminProGroup</code> field is required if <code>ACTIVE_DIRECTORY</code> or <code>IAM_IDENTITY_CENTER</code> is the selected authentication method of the new Quick Sight account.</p> <p>For more information about using IAM Identity Center in Amazon Quick Sight, see <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/sec-identity-management-identity-center.html\">Using IAM Identity Center with Amazon Quick Sight Enterprise Edition</a> in the Amazon Quick Sight User Guide. For more information about using Active Directory in Amazon Quick Sight, see <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/aws-directory-service.html\">Using Active Directory with Amazon Quick Sight Enterprise Edition</a> in the Amazon Quick Sight User Guide.</p>
            author_group: <p>The author group associated with your Active Directory or IAM Identity Center account.</p> <p>For more information about using IAM Identity Center in Amazon Quick Sight, see <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/sec-identity-management-identity-center.html\">Using IAM Identity Center with Amazon Quick Sight Enterprise Edition</a> in the Amazon Quick Sight User Guide. For more information about using Active Directory in Amazon Quick Sight, see <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/aws-directory-service.html\">Using Active Directory with Amazon Quick Sight Enterprise Edition</a> in the Amazon Quick Sight User Guide.</p>
            reader_group: <p>The reader group associated with your Active Directory or IAM Identity Center account.</p> <p>For more information about using IAM Identity Center in Amazon Quick Sight, see <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/sec-identity-management-identity-center.html\">Using IAM Identity Center with Amazon Quick Sight Enterprise Edition</a> in the Amazon Quick Sight User Guide. For more information about using Active Directory in Amazon Quick Sight, see <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/aws-directory-service.html\">Using Active Directory with Amazon Quick Sight Enterprise Edition</a> in the Amazon Quick Sight User Guide.</p>
            admin_pro_group: <p>The admin pro group associated with your Active Directory or IAM Identity Center account. Either this field or the <code>AdminGroup</code> field is required if <code>ACTIVE_DIRECTORY</code> or <code>IAM_IDENTITY_CENTER</code> is the selected authentication method of the new Quick Sight account.</p> <p>For more information about using IAM Identity Center in Amazon Quick Sight, see <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/sec-identity-management-identity-center.html\">Using IAM Identity Center with Amazon Quick Sight Enterprise Edition</a> in the Amazon Quick Sight User Guide. For more information about using Active Directory in Amazon Quick Sight, see <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/aws-directory-service.html\">Using Active Directory with Amazon Quick Sight Enterprise Edition</a> in the Amazon Quick Sight User Guide.</p>
            author_pro_group: <p>The author pro group associated with your Active Directory or IAM Identity Center account.</p> <p>For more information about using IAM Identity Center in Amazon Quick Sight, see <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/sec-identity-management-identity-center.html\">Using IAM Identity Center with Amazon Quick Sight Enterprise Edition</a> in the Amazon Quick Sight User Guide. For more information about using Active Directory in Amazon Quick Sight, see <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/aws-directory-service.html\">Using Active Directory with Amazon Quick Sight Enterprise Edition</a> in the Amazon Quick Sight User Guide.</p>
            reader_pro_group: <p>The reader pro group associated with your Active Directory or IAM Identity Center account.</p> <p>For more information about using IAM Identity Center in Amazon Quick Sight, see <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/sec-identity-management-identity-center.html\">Using IAM Identity Center with Amazon Quick Sight Enterprise Edition</a> in the Amazon Quick Sight User Guide. For more information about using Active Directory in Amazon Quick Sight, see <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/aws-directory-service.html\">Using Active Directory with Amazon Quick Sight Enterprise Edition</a> in the Amazon Quick Sight User Guide.</p>
            first_name: <p>The first name of the author of the Amazon Quick Sight account to use for future communications. This field is required if <code>ENTERPPRISE_AND_Q</code> is the selected edition of the new Amazon Quick Sight account.</p>
            last_name: <p>The last name of the author of the Amazon Quick Sight account to use for future communications. This field is required if <code>ENTERPPRISE_AND_Q</code> is the selected edition of the new Amazon Quick Sight account.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_account_subscription_request.CreateAccountSubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_account_subscription_response.CreateAccountSubscriptionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_account_subscription

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_account_subscription.async_create_account_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_action_connector(
        ...
        *,
        ...
        vpc_connection_arn: Optional["aws_sdk_quicksight.types.arn.Arn"] = None,
        tags: Optional["aws_sdk_quicksight.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_quicksight.types.create_action_connector_response.CreateActionConnectorResponse":
        ...
        Args:
            aws_account_id: <p>The Amazon Web Services account ID associated with the action connector.</p>
            action_connector_id: <p>A unique identifier for the action connector. This ID must be unique within the Amazon Web Services account. The <code>ActionConnectorId</code> must not start with the prefix <code>quicksuite-</code> </p>
            name: <p>A descriptive name for the action connector.</p>
            type: <p>The type of action connector.</p>
            authentication_config: <p>The authentication configuration for connecting to the external service. This includes the authentication type, base URL, and authentication metadata such as client credentials or API keys.</p>
            description: <p>An optional description of the action connector.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_action_connector_request.CreateActionConnectorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_action_connector_response.CreateActionConnectorResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_action_connector

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_action_connector.async_create_action_connector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_agent(
        ...
        *,
        ...
        icon_id: Optional["aws_sdk_quicksight.types.icon_id.IconId"] = None,
        starter_prompts: Optional[
        ...
        Args:
            spaces: <p>The Amazon Resource Names (ARNs) of the spaces to attach to the agent.</p>
            action_connectors: <p>The Amazon Resource Names (ARNs) of the action connectors to attach to the agent.</p>
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the agent.</p>
            agent_id: <p>A unique identifier for the agent.</p>
            name: <p>The name of the agent.</p>
            description: <p>A description of the agent.</p>
            icon_id: <p>The icon identifier for the agent.</p>
            starter_prompts: <p>A list of starter prompts that are displayed to users when they begin interacting with the agent.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_agent_request.CreateAgentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_agent_response.CreateAgentResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_agent

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_agent.async_create_agent(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_analysis(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        parameters: Optional["aws_sdk_quicksight.types.parameters.Parameters"] = None,
        permissions: Optional[
            "aws_sdk_quicksight.types.resource_permission_list.ResourcePermissionList"
        ] = None,
        ...
        theme_arn: Optional["aws_sdk_quicksight.types.arn.Arn"] = None,
        tags: Optional["aws_sdk_quicksight.types.tag_list.TagList"] = None,
        definition: Optional[
        ...
        folder_arns: Optional[
            "aws_sdk_quicksight.types.folder_arn_list.FolderArnList"
        ] = None,
    ) -> "aws_sdk_quicksight.types.create_analysis_response.CreateAnalysisResponse":
        ...
        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account where you are creating an analysis.</p>
            analysis_id: <p>The ID for the analysis that you're creating. This ID displays in the URL of the analysis.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_analysis_request.CreateAnalysisRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_analysis_response.CreateAnalysisResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_analysis

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_analysis.async_create_analysis(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_brand(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        brand_definition: Optional[
            "aws_sdk_quicksight.types.brand_definition.BrandDefinition"
        ] = None,
        tags: Optional["aws_sdk_quicksight.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_quicksight.types.create_brand_response.CreateBrandResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_brand_request.CreateBrandRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_brand_response.CreateBrandResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_brand

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_brand.async_create_brand(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_custom_permissions(
        self,
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        custom_permissions_name: "aws_sdk_quicksight.types.custom_permissions_name.CustomPermissionsName",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        capabilities: Optional[
            "aws_sdk_quicksight.types.capabilities.Capabilities"
        ] = None,
        tags: Optional["aws_sdk_quicksight.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_quicksight.types.create_custom_permissions_response.CreateCustomPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_custom_permissions_request.CreateCustomPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_custom_permissions_response.CreateCustomPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_custom_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_custom_permissions.async_create_custom_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_dashboard(
        ...
        *,
        ...
        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account where you want to create the dashboard.</p>
            ...
            theme_arn: <p>The Amazon Resource Name (ARN) of the theme that is being used for this dashboard. If you add a value for this field, it overrides the value that is used in the source entity. The theme ARN must exist in the same Amazon Web Services account where you create the dashboard.</p>
            definition: <p>The definition of a dashboard.</p> <p>A definition is the data model of all features in a Dashboard, Template, or Analysis.</p> <p>Either a <code>SourceEntity</code> or a <code>Definition</code> must be provided in order for the request to be valid.</p>
            validation_strategy: <p>The option to relax the validation needed to create a dashboard with definition objects. This option skips the validation step for specific errors.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_dashboard_request.CreateDashboardRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_dashboard_response.CreateDashboardResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_dashboard

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_dashboard.async_create_dashboard(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_data_set(
        ...
        *,
        ...
        performance_configuration: Optional[
            "aws_sdk_quicksight.types.performance_configuration.PerformanceConfiguration"
        ] = None,
        use_as: Optional[
            "aws_sdk_quicksight.types.data_set_use_as.DataSetUseAs"
        ] = None,
        data_prep_configuration: Optional[
            "aws_sdk_quicksight.types.data_prep_configuration.DataPrepConfiguration"
        ] = None,
        semantic_model_configuration: Optional[
            "aws_sdk_quicksight.types.semantic_model_configuration.SemanticModelConfiguration"
        ] = None,
    ) -> "aws_sdk_quicksight.types.create_data_set_response.CreateDataSetResponse":
        r"""<p>Creates a dataset. This operation doesn't support datasets that include uploaded files as a source.</p>

        Args:
            aws_account_id: <p>The Amazon Web Services account ID.</p>
            data_set_id: <p>An ID for the dataset that you want to create. This ID is unique per Amazon Web Services Region for each Amazon Web Services account.</p>
            name: <p>The display name for the dataset.</p>
            physical_table_map: <p>Declares the physical tables that are available in the underlying data sources.</p>
            logical_table_map: <p>Configures the combination and transformation of the data from the physical tables. This parameter is used with the legacy data preparation experience.</p>
            import_mode: <p>Indicates whether you want to import the data into SPICE.</p>
            column_groups: <p>Groupings of columns that work together in certain Amazon Quick Sight features. Currently, only geospatial hierarchy is supported.</p>
            field_folders: <p>The folder that contains fields and nested subfolders for your dataset.</p>
            permissions: <p>A list of resource permissions on the dataset.</p>
            row_level_permission_data_set: <p>The row-level security configuration for the data that you want to create. This parameter is used with the legacy data preparation experience.</p>
            row_level_permission_tag_configuration: <p>The configuration of tags on a dataset to set row-level security. Row-level security tags are currently supported for anonymous embedding only. This parameter is used with the legacy data preparation experience.</p>
            column_level_permission_rules: <p>A set of one or more definitions of a <code> <a href=\"https://docs.aws.amazon.com/quicksight/latest/APIReference/API_ColumnLevelPermissionRule.html\">ColumnLevelPermissionRule</a> </code>.</p>
            tags: <p>Contains a map of the key-value pairs for the resource tag or tags assigned to the dataset.</p>
            dataset_parameters: <p>The parameter declarations of the dataset.</p>
            folder_arns: <p>When you create the dataset, Amazon Quick Sight adds the dataset to these folders.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_data_set_request.CreateDataSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_data_set_response.CreateDataSetResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_data_set

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_data_set.async_create_data_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_data_source(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        data_source_parameters: Optional[
        ...
        ssl_properties: Optional[
            "aws_sdk_quicksight.types.ssl_properties.SslProperties"
        ] = None,
        tags: Optional["aws_sdk_quicksight.types.tag_list.TagList"] = None,
        folder_arns: Optional[
            "aws_sdk_quicksight.types.folder_arn_list.FolderArnList"
        ...
        "aws_sdk_quicksight.types.create_data_source_response.CreateDataSourceResponse"
    ):
        """<p>Creates a data source.</p>

        Args:
            aws_account_id: <p>The Amazon Web Services account ID.</p>
            data_source_id: <p>An ID for the data source. This ID is unique per Amazon Web Services Region for each Amazon Web Services account. </p>
            name: <p>A display name for the data source.</p>
            type: <p>The type of the data source. To return a list of all data sources, use <code>ListDataSources</code>.</p> <p>Use <code>AMAZON_ELASTICSEARCH</code> for Amazon OpenSearch Service.</p>
            data_source_parameters: <p>The parameters that Amazon Quick Sight uses to connect to your underlying source.</p>
            credentials: <p>The credentials Amazon Quick Sight that uses to connect to your underlying source. Currently, only credentials based on user name and password are supported.</p>
            permissions: <p>A list of resource permissions on the data source.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_data_source_request.CreateDataSourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_data_source_response.CreateDataSourceResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_data_source

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_data_source.async_create_data_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_flow(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.create_flow_response.CreateFlowResponse":
        """<p>Creates a new flow in the specified Amazon Web Services account. Creates both a DRAFT and PUBLISHED (auto-published) version.</p> <p>This operation is idempotent. Supply a <code>ClientToken</code> to safely retry without creating duplicate resources.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account where you want to create the flow.</p>
            name: <p>The display name for the flow.</p>
            description: <p>The description for the flow.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_flow_request.CreateFlowRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_flow_response.CreateFlowResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_flow

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_flow.async_create_flow(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_folder(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        name: Optional["aws_sdk_quicksight.types.folder_name.FolderName"] = None,
        folder_type: Optional["aws_sdk_quicksight.types.folder_type.FolderType"] = None,
        parent_folder_arn: Optional["aws_sdk_quicksight.types.arn.Arn"] = None,
        permissions: Optional[
            "aws_sdk_quicksight.types.resource_permission_list.ResourcePermissionList"
        ] = None,
        tags: Optional["aws_sdk_quicksight.types.tag_list.TagList"] = None,
        sharing_model: Optional[
            "aws_sdk_quicksight.types.sharing_model.SharingModel"
        ] = None,
    ) -> "aws_sdk_quicksight.types.create_folder_response.CreateFolderResponse":
        """<p>Creates an empty shared folder.</p>

        Args:
            aws_account_id: <p>The ID for the Amazon Web Services account where you want to create the folder.</p>
            folder_id: <p>The ID of the folder.</p>
            name: <p>The name of the folder.</p>
            folder_type: <p>The type of folder. By default, <code>folderType</code> is <code>SHARED</code>.</p>
            parent_folder_arn: <p>The Amazon Resource Name (ARN) for the parent folder.</p> <p> <code>ParentFolderArn</code> can be null. An empty <code>parentFolderArn</code> creates a root-level folder.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_folder_request.CreateFolderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_folder_response.CreateFolderResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_folder

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_folder.async_create_folder(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_folder_membership(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.create_folder_membership_response.CreateFolderMembershipResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_folder_membership_request.CreateFolderMembershipRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_folder_membership_response.CreateFolderMembershipResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_folder_membership

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_folder_membership.async_create_folder_membership(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_group(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.create_group_response.CreateGroupResponse":
        ...
        Args:
            group_name: <p>A name for the group that you want to create.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_group_request.CreateGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_group_response.CreateGroupResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_group

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_group.async_create_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_group_membership(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.create_group_membership_response.CreateGroupMembershipResponse":
        """<p>Adds an Amazon Quick Sight user to an Amazon Quick Sight group. </p>

        Args:
            member_name: <p>The name of the user that you want to add to the group membership.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_group_membership_request.CreateGroupMembershipRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_group_membership_response.CreateGroupMembershipResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_group_membership

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_group_membership.async_create_group_membership(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_iam_policy_assignment(
        self,
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        assignment_name: "aws_sdk_quicksight.types.iam_policy_assignment_name.IAMPolicyAssignmentName",
        assignment_status: "aws_sdk_quicksight.types.assignment_status.AssignmentStatus",
        namespace: "aws_sdk_quicksight.types.namespace.Namespace",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        policy_arn: Optional["aws_sdk_quicksight.types.arn.Arn"] = None,
        identities: Optional[
            "aws_sdk_quicksight.types.identity_map.IdentityMap"
        ] = None,
    ) -> "aws_sdk_quicksight.types.create_iam_policy_assignment_response.CreateIAMPolicyAssignmentResponse":
        ...
        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account where you want to assign an IAM policy to Amazon Quick Sight users or groups.</p>
            assignment_name: <p>The name of the assignment, also called a rule. The name must be unique within the Amazon Web Services account.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_iam_policy_assignment_request.CreateIAMPolicyAssignmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_iam_policy_assignment_response.CreateIAMPolicyAssignmentResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_iam_policy_assignment

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_iam_policy_assignment.async_create_iam_policy_assignment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_ingestion(
        ...
        *,
        ...
        ingestion_type: Optional[
            "aws_sdk_quicksight.types.ingestion_type.IngestionType"
        ] = None,
    ) -> "aws_sdk_quicksight.types.create_ingestion_response.CreateIngestionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_ingestion_request.CreateIngestionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_ingestion_response.CreateIngestionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_ingestion

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_ingestion.async_create_ingestion(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_namespace(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        tags: Optional["aws_sdk_quicksight.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_quicksight.types.create_namespace_response.CreateNamespaceResponse":
        ...
        Args:
            aws_account_id: <p>The ID for the Amazon Web Services account that you want to create the Quick Sight namespace in.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_namespace_request.CreateNamespaceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_namespace_response.CreateNamespaceResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_namespace

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_namespace.async_create_namespace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_o_auth_client_application(
        self,
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        o_auth_client_application_id: "aws_sdk_quicksight.types.o_auth_client_application_id.OAuthClientApplicationId",
        name: "aws_sdk_quicksight.types.resource_name.ResourceName",
        ...
        o_auth_token_endpoint_url: "aws_sdk_quicksight.types.o_auth_token_endpoint_url.OAuthTokenEndpointUrl",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        o_auth_authorization_endpoint_url: Optional[
            "aws_sdk_quicksight.types.o_auth_authorization_endpoint_url.OAuthAuthorizationEndpointUrl"
        ] = None,
        o_auth_scopes: Optional[
        ...
        identity_provider_vpc_connection_properties: Optional[
            "aws_sdk_quicksight.types.vpc_connection_properties.VpcConnectionProperties"
        ] = None,
        tags: Optional["aws_sdk_quicksight.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_quicksight.types.create_o_auth_client_application_response.CreateOAuthClientApplicationResponse":
        """<p>Creates an OAuthClientApplication.</p>

        Args:
            aws_account_id: <p>The Amazon Web Services account ID.</p>
            o_auth_client_application_id: <p>An ID for the OAuthClientApplication that you want to create. This ID is unique per Amazon Web Services Region for each Amazon Web Services account.</p>
            name: <p>The display name for the OAuthClientApplication.</p>
            o_auth_client_authentication_type: <p>The authentication type to use for the OAuthClientApplication. This determines the OAuth 2.0 grant flow that is used when the data source connects to the identity provider. Valid values are <code>TOKEN</code>.</p>
            client_id: <p>The client ID of the OAuth application that is registered with the identity provider.</p>
            client_secret: <p>The client secret of the OAuth application that is registered with the identity provider.</p>
            o_auth_token_endpoint_url: <p>The token endpoint URL of the identity provider that is used to obtain access tokens.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_o_auth_client_application_request.CreateOAuthClientApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_o_auth_client_application_response.CreateOAuthClientApplicationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_o_auth_client_application

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_o_auth_client_application.async_create_o_auth_client_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_refresh_schedule(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.create_refresh_schedule_response.CreateRefreshScheduleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_refresh_schedule_request.CreateRefreshScheduleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_refresh_schedule_response.CreateRefreshScheduleResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_refresh_schedule

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_refresh_schedule.async_create_refresh_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_role_membership(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.create_role_membership_response.CreateRoleMembershipResponse":
        """<p>Use <code>CreateRoleMembership</code> to add an existing Quick Sight group to an existing role.</p>

        Args:
            member_name: <p>The name of the group that you want to add to the role.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_role_membership_request.CreateRoleMembershipRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_role_membership_response.CreateRoleMembershipResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_role_membership

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_role_membership.async_create_role_membership(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_space(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.create_space_response.CreateSpaceResponse":
        """<p>Creates a new Amazon QuickSight space. A space is a collection of resources that can be used to organize and manage QuickSight assets.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_space_request.CreateSpaceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_space_response.CreateSpaceResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_space

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_space.async_create_space(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_template(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        name: Optional["aws_sdk_quicksight.types.template_name.TemplateName"] = None,
        permissions: Optional[
            "aws_sdk_quicksight.types.resource_permission_list.ResourcePermissionList"
        ] = None,
        source_entity: Optional[
    ...
    ) -> "aws_sdk_quicksight.types.create_template_response.CreateTemplateResponse":
        ...
        Args:
            aws_account_id: <p>The ID for the Amazon Web Services account that the group is in. You use the ID for the Amazon Web Services account that contains your Amazon Quick Sight account.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_template_request.CreateTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_template_response.CreateTemplateResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_template

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_template.async_create_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_template_alias(
        ...
        *,
        ...
        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the template that you creating an alias for.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_template_alias_request.CreateTemplateAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_template_alias_response.CreateTemplateAliasResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_template_alias

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_template_alias.async_create_template_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_theme(
        ...
        *,
        ...
        tags: Optional["aws_sdk_quicksight.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_quicksight.types.create_theme_response.CreateThemeResponse":
        ...
        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account where you want to store the new theme. </p>
            theme_id: <p>An ID for the theme that you want to create. The theme ID is unique per Amazon Web Services Region in each Amazon Web Services account.</p>
            name: <p>A display name for the theme.</p>
            base_theme_id: <p>The ID of the theme that a custom theme will inherit from. All themes inherit from one of the starting themes defined by Amazon Quick Sight. For a list of the starting themes, use <code>ListThemes</code> or choose <b>Themes</b> from within an analysis. </p>
            version_description: <p>A description of the first version of the theme that you're creating. Every time <code>UpdateTheme</code> is called, a new version is created. Each version of the theme has a description of the version in the <code>VersionDescription</code> field.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_theme_request.CreateThemeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_theme_response.CreateThemeResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_theme

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_theme.async_create_theme(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_theme_alias(
        ...
        *,
        ...
        "aws_sdk_quicksight.types.create_theme_alias_response.CreateThemeAliasResponse"
    ):
        """<p>Creates a theme alias for a theme.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the theme for the new theme alias.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_theme_alias_request.CreateThemeAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_theme_alias_response.CreateThemeAliasResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_theme_alias

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_theme_alias.async_create_theme_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_topic(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.create_topic_response.CreateTopicResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_topic_request.CreateTopicRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_topic_response.CreateTopicResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_topic

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_topic.async_create_topic(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_topic_refresh_schedule(
        ...
        refresh_schedule: "aws_sdk_quicksight.types.topic_refresh_schedule.TopicRefreshSchedule",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        dataset_name: Optional["aws_sdk_quicksight.types.string.String"] = None,
    ) -> "aws_sdk_quicksight.types.create_topic_refresh_schedule_response.CreateTopicRefreshScheduleResponse":
        """<p>Creates a topic refresh schedule.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the topic you're creating a refresh schedule for.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_topic_refresh_schedule_request.CreateTopicRefreshScheduleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_topic_refresh_schedule_response.CreateTopicRefreshScheduleResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_topic_refresh_schedule

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_topic_refresh_schedule.async_create_topic_refresh_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_vpc_connection(
        ...
        security_group_ids: "aws_sdk_quicksight.types.security_group_id_list.SecurityGroupIdList",
        ...
        *,
        ...
        tags: Optional["aws_sdk_quicksight.types.tag_list.TagList"] = None,
    ) -> "aws_sdk_quicksight.types.create_vpc_connection_response.CreateVPCConnectionResponse":
        """<p>Creates a new VPC connection.</p>

        Args:
            aws_account_id: <p>The Amazon Web Services account ID of the account where you want to create a new VPC connection.</p>
            ...
            name: <p>The display name for the VPC connection.</p>
            subnet_ids: <p>A list of subnet IDs for the VPC connection.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.create_vpc_connection_request.CreateVPCConnectionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.create_vpc_connection_response.CreateVPCConnectionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.create_vpc_connection

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.create_vpc_connection.async_create_vpc_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_account_customization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_account_customization_request.DeleteAccountCustomizationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_account_customization_response.DeleteAccountCustomizationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_account_customization

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_account_customization.async_delete_account_customization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_account_custom_permission(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_account_custom_permission_response.DeleteAccountCustomPermissionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_account_custom_permission_request.DeleteAccountCustomPermissionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_account_custom_permission_response.DeleteAccountCustomPermissionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_account_custom_permission

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_account_custom_permission.async_delete_account_custom_permission(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_account_subscription(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_account_subscription_request.DeleteAccountSubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_account_subscription_response.DeleteAccountSubscriptionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_account_subscription

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_account_subscription.async_delete_account_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_action_connector(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_action_connector_response.DeleteActionConnectorResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_action_connector_request.DeleteActionConnectorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_action_connector_response.DeleteActionConnectorResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_action_connector

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_action_connector.async_delete_action_connector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_agent(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_agent_response.DeleteAgentResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_agent_request.DeleteAgentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_agent_response.DeleteAgentResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_agent

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_agent.async_delete_agent(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_analysis(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_analysis_request.DeleteAnalysisRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_analysis_response.DeleteAnalysisResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_analysis

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_analysis.async_delete_analysis(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_brand(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_brand_response.DeleteBrandResponse":
        """<important> <p>This API permanently deletes the specified Quick Sight brand. When you delete a brand:</p> <ul> <li> <p>The brand and all its associated branding elements are permanently removed</p> </li> <li> <p>Any applications or dashboards using this brand will revert to default styling</p> </li> <li> <p>This action cannot be undone through the API</p> </li> </ul> <p> <b>Before proceeding:</b> Verify that the brand is no longer needed and consider the impact on any applications currently using this brand.</p> </important> <p>Deletes an Quick Sight brand.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_brand_request.DeleteBrandRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_brand_response.DeleteBrandResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_brand

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_brand.async_delete_brand(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_brand_assignment(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_brand_assignment_response.DeleteBrandAssignmentResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_brand_assignment_request.DeleteBrandAssignmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_brand_assignment_response.DeleteBrandAssignmentResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_brand_assignment

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_brand_assignment.async_delete_brand_assignment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_custom_permissions(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_custom_permissions_response.DeleteCustomPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_custom_permissions_request.DeleteCustomPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_custom_permissions_response.DeleteCustomPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_custom_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_custom_permissions.async_delete_custom_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_dashboard(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.delete_dashboard_response.DeleteDashboardResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_dashboard_request.DeleteDashboardRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_dashboard_response.DeleteDashboardResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_dashboard

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_dashboard.async_delete_dashboard(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_data_set(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_data_set_response.DeleteDataSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_data_set_request.DeleteDataSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_data_set_response.DeleteDataSetResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_data_set

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_data_set.async_delete_data_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_data_set_refresh_properties(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_data_set_refresh_properties_response.DeleteDataSetRefreshPropertiesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_data_set_refresh_properties_request.DeleteDataSetRefreshPropertiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_data_set_refresh_properties_response.DeleteDataSetRefreshPropertiesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_data_set_refresh_properties

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_data_set_refresh_properties.async_delete_data_set_refresh_properties(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_data_source(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_data_source_request.DeleteDataSourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_data_source_response.DeleteDataSourceResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_data_source

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_data_source.async_delete_data_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_default_q_business_application(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        namespace: Optional["aws_sdk_quicksight.types.namespace.Namespace"] = None,
    ) -> "aws_sdk_quicksight.types.delete_default_q_business_application_response.DeleteDefaultQBusinessApplicationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_default_q_business_application_request.DeleteDefaultQBusinessApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_default_q_business_application_response.DeleteDefaultQBusinessApplicationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_default_q_business_application

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_default_q_business_application.async_delete_default_q_business_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_flow(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_flow_response.DeleteFlowResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_flow_request.DeleteFlowRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_flow_response.DeleteFlowResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_flow

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_flow.async_delete_flow(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_folder(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_folder_response.DeleteFolderResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_folder_request.DeleteFolderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_folder_response.DeleteFolderResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_folder

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_folder.async_delete_folder(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_folder_membership(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_folder_membership_response.DeleteFolderMembershipResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_folder_membership_request.DeleteFolderMembershipRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_folder_membership_response.DeleteFolderMembershipResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_folder_membership

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_folder_membership.async_delete_folder_membership(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_group(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_group_response.DeleteGroupResponse":
        """<p>Removes a user group from Amazon Quick Sight. </p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_group_request.DeleteGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_group_response.DeleteGroupResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_group

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_group.async_delete_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_group_membership(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_group_membership_response.DeleteGroupMembershipResponse":
        """<p>Removes a user from a group so that the user is no longer a member of the group.</p>

        Args:
            member_name: <p>The name of the user that you want to delete from the group membership.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_group_membership_request.DeleteGroupMembershipRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_group_membership_response.DeleteGroupMembershipResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_group_membership

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_group_membership.async_delete_group_membership(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_iam_policy_assignment(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_iam_policy_assignment_response.DeleteIAMPolicyAssignmentResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_iam_policy_assignment_request.DeleteIAMPolicyAssignmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_iam_policy_assignment_response.DeleteIAMPolicyAssignmentResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_iam_policy_assignment

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_iam_policy_assignment.async_delete_iam_policy_assignment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_identity_propagation_config(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_identity_propagation_config_response.DeleteIdentityPropagationConfigResponse":
        """<p>Deletes all access scopes and authorized targets that are associated with a service from the Quick Sight IAM Identity Center application.</p> <p>This operation is only supported for Quick Sight accounts that use IAM Identity Center.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_identity_propagation_config_request.DeleteIdentityPropagationConfigRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_identity_propagation_config_response.DeleteIdentityPropagationConfigResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_identity_propagation_config

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_identity_propagation_config.async_delete_identity_propagation_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_knowledge_base(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_knowledge_base_response.DeleteKnowledgeBaseResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_knowledge_base_request.DeleteKnowledgeBaseRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_knowledge_base_response.DeleteKnowledgeBaseResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_knowledge_base

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_knowledge_base.async_delete_knowledge_base(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_namespace(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_namespace_response.DeleteNamespaceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_namespace_request.DeleteNamespaceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_namespace_response.DeleteNamespaceResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_namespace

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_namespace.async_delete_namespace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_o_auth_client_application(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_o_auth_client_application_response.DeleteOAuthClientApplicationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_o_auth_client_application_request.DeleteOAuthClientApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_o_auth_client_application_response.DeleteOAuthClientApplicationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_o_auth_client_application

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_o_auth_client_application.async_delete_o_auth_client_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_refresh_schedule(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_refresh_schedule_response.DeleteRefreshScheduleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_refresh_schedule_request.DeleteRefreshScheduleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_refresh_schedule_response.DeleteRefreshScheduleResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_refresh_schedule

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_refresh_schedule.async_delete_refresh_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_role_custom_permission(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_role_custom_permission_response.DeleteRoleCustomPermissionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_role_custom_permission_request.DeleteRoleCustomPermissionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_role_custom_permission_response.DeleteRoleCustomPermissionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_role_custom_permission

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_role_custom_permission.async_delete_role_custom_permission(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_role_membership(
        ...
        *,
        ...
        Args:
            member_name: <p>The name of the group.</p>
            role: <p>The role that you want to remove permissions from.</p>
            aws_account_id: <p>The ID for the Amazon Web Services account that you want to create a group in. The Amazon Web Services account ID that you provide must be the same Amazon Web Services account that contains your Amazon Quick Sight account.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_role_membership_request.DeleteRoleMembershipRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_role_membership_response.DeleteRoleMembershipResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_role_membership

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_role_membership.async_delete_role_membership(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_space(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_space_response.DeleteSpaceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_space_request.DeleteSpaceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_space_response.DeleteSpaceResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_space

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_space.async_delete_space(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_template(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.delete_template_response.DeleteTemplateResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_template_request.DeleteTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_template_response.DeleteTemplateResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_template

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_template.async_delete_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_template_alias(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_template_alias_response.DeleteTemplateAliasResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_template_alias_request.DeleteTemplateAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_template_alias_response.DeleteTemplateAliasResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_template_alias

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_template_alias.async_delete_template_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_theme(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.delete_theme_response.DeleteThemeResponse":
        """<p>Deletes a theme.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_theme_request.DeleteThemeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_theme_response.DeleteThemeResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_theme

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_theme.async_delete_theme(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_theme_alias(
        ...
        *,
        ...
        "aws_sdk_quicksight.types.delete_theme_alias_response.DeleteThemeAliasResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_theme_alias_request.DeleteThemeAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_theme_alias_response.DeleteThemeAliasResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_theme_alias

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_theme_alias.async_delete_theme_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_topic(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_topic_response.DeleteTopicResponse":
        """<p>Deletes a topic.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_topic_request.DeleteTopicRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_topic_response.DeleteTopicResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_topic

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_topic.async_delete_topic(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_topic_refresh_schedule(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_topic_refresh_schedule_response.DeleteTopicRefreshScheduleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_topic_refresh_schedule_request.DeleteTopicRefreshScheduleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_topic_refresh_schedule_response.DeleteTopicRefreshScheduleResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_topic_refresh_schedule

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_topic_refresh_schedule.async_delete_topic_refresh_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_user_response.DeleteUserResponse":
        """<p>Deletes the Amazon Quick Sight user that is associated with the identity of the IAM user or role that's making the call. The IAM user isn't deleted as a result of this call. </p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_user_request.DeleteUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_user_response.DeleteUserResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_user

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_user.async_delete_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user_by_principal_id(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_user_by_principal_id_response.DeleteUserByPrincipalIdResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_user_by_principal_id_request.DeleteUserByPrincipalIdRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_user_by_principal_id_response.DeleteUserByPrincipalIdResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_user_by_principal_id

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_user_by_principal_id.async_delete_user_by_principal_id(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user_custom_permission(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_user_custom_permission_response.DeleteUserCustomPermissionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_user_custom_permission_request.DeleteUserCustomPermissionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_user_custom_permission_response.DeleteUserCustomPermissionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_user_custom_permission

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_user_custom_permission.async_delete_user_custom_permission(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_vpc_connection(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.delete_vpc_connection_response.DeleteVPCConnectionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.delete_vpc_connection_request.DeleteVPCConnectionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.delete_vpc_connection_response.DeleteVPCConnectionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.delete_vpc_connection

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.delete_vpc_connection.async_delete_vpc_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_customization(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        namespace: Optional["aws_sdk_quicksight.types.namespace.Namespace"] = None,
        resolved: Optional["aws_sdk_quicksight.types.boolean.Boolean"] = None,
    ) -> "aws_sdk_quicksight.types.describe_account_customization_response.DescribeAccountCustomizationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_account_customization_request.DescribeAccountCustomizationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_account_customization_response.DescribeAccountCustomizationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_account_customization

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_account_customization.async_describe_account_customization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_custom_permission(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_account_custom_permission_response.DescribeAccountCustomPermissionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_account_custom_permission_request.DescribeAccountCustomPermissionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_account_custom_permission_response.DescribeAccountCustomPermissionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_account_custom_permission

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_account_custom_permission.async_describe_account_custom_permission(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_settings(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_account_settings_response.DescribeAccountSettingsResponse":
        """<p>Describes the settings that were used when your Quick Sight subscription was first created in this Amazon Web Services account.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_account_settings_request.DescribeAccountSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_account_settings_response.DescribeAccountSettingsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_account_settings

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_account_settings.async_describe_account_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_subscription(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_account_subscription_response.DescribeAccountSubscriptionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_account_subscription_request.DescribeAccountSubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_account_subscription_response.DescribeAccountSubscriptionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_account_subscription

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_account_subscription.async_describe_account_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_action_connector(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_action_connector_response.DescribeActionConnectorResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_action_connector_request.DescribeActionConnectorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_action_connector_response.DescribeActionConnectorResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_action_connector

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_action_connector.async_describe_action_connector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_action_connector_permissions(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_action_connector_permissions_response.DescribeActionConnectorPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_action_connector_permissions_request.DescribeActionConnectorPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_action_connector_permissions_response.DescribeActionConnectorPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_action_connector_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_action_connector_permissions.async_describe_action_connector_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_agent(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_agent_response.DescribeAgentResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_agent_request.DescribeAgentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_agent_response.DescribeAgentResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_agent

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_agent.async_describe_agent(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_agent_permissions(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_agent_permissions_response.DescribeAgentPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_agent_permissions_request.DescribeAgentPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_agent_permissions_response.DescribeAgentPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_agent_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_agent_permissions.async_describe_agent_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_analysis(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_analysis_response.DescribeAnalysisResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_analysis_request.DescribeAnalysisRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_analysis_response.DescribeAnalysisResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_analysis

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_analysis.async_describe_analysis(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_analysis_definition(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_analysis_definition_response.DescribeAnalysisDefinitionResponse":
        r"""<p>Provides a detailed description of the definition of an analysis.</p> <note> <p>If you do not need to know details about the content of an Analysis, for instance if you are trying to check the status of a recently created or updated Analysis, use the <a href=\"https://docs.aws.amazon.com/quicksight/latest/APIReference/API_DescribeAnalysis.html\"> <code>DescribeAnalysis</code> </a> instead. </p> </note>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_analysis_definition_request.DescribeAnalysisDefinitionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_analysis_definition_response.DescribeAnalysisDefinitionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_analysis_definition

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_analysis_definition.async_describe_analysis_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_analysis_permissions(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_analysis_permissions_response.DescribeAnalysisPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_analysis_permissions_request.DescribeAnalysisPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_analysis_permissions_response.DescribeAnalysisPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_analysis_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_analysis_permissions.async_describe_analysis_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_asset_bundle_export_job(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_asset_bundle_export_job_response.DescribeAssetBundleExportJobResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_asset_bundle_export_job_request.DescribeAssetBundleExportJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_asset_bundle_export_job_response.DescribeAssetBundleExportJobResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_asset_bundle_export_job

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_asset_bundle_export_job.async_describe_asset_bundle_export_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_asset_bundle_import_job(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_asset_bundle_import_job_response.DescribeAssetBundleImportJobResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_asset_bundle_import_job_request.DescribeAssetBundleImportJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_asset_bundle_import_job_response.DescribeAssetBundleImportJobResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_asset_bundle_import_job

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_asset_bundle_import_job.async_describe_asset_bundle_import_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_automation_job(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        include_input_payload: Optional[
            "aws_sdk_quicksight.types.boolean.Boolean"
        ] = None,
        include_output_payload: Optional[
            "aws_sdk_quicksight.types.boolean.Boolean"
        ] = None,
        ...
        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the automation job.</p>
            automation_group_id: <p>The ID of the automation group that contains the automation.</p>
            automation_id: <p>The ID of the automation that the job belongs to.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_automation_job_request.DescribeAutomationJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_automation_job_response.DescribeAutomationJobResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_automation_job

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_automation_job.async_describe_automation_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_brand(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_brand_request.DescribeBrandRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_brand_response.DescribeBrandResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_brand

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_brand.async_describe_brand(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_brand_assignment(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_brand_assignment_response.DescribeBrandAssignmentResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_brand_assignment_request.DescribeBrandAssignmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_brand_assignment_response.DescribeBrandAssignmentResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_brand_assignment

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_brand_assignment.async_describe_brand_assignment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_brand_published_version(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_brand_published_version_response.DescribeBrandPublishedVersionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_brand_published_version_request.DescribeBrandPublishedVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_brand_published_version_response.DescribeBrandPublishedVersionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_brand_published_version

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_brand_published_version.async_describe_brand_published_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_custom_permissions(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_custom_permissions_response.DescribeCustomPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_custom_permissions_request.DescribeCustomPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_custom_permissions_response.DescribeCustomPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_custom_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_custom_permissions.async_describe_custom_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_dashboard(
        ...
        *,
        ...
        alias_name: Optional["aws_sdk_quicksight.types.alias_name.AliasName"] = None,
    ) -> (
        "aws_sdk_quicksight.types.describe_dashboard_response.DescribeDashboardResponse"
    ):
        """<p>Provides a summary for a dashboard.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the dashboard that you're describing.</p>
            dashboard_id: <p>The ID for the dashboard.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_dashboard_request.DescribeDashboardRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_dashboard_response.DescribeDashboardResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_dashboard

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_dashboard.async_describe_dashboard(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_dashboard_definition(
        ...
        *,
        ...
        alias_name: Optional["aws_sdk_quicksight.types.alias_name.AliasName"] = None,
    ) -> "aws_sdk_quicksight.types.describe_dashboard_definition_response.DescribeDashboardDefinitionResponse":
        r"""<p>Provides a detailed description of the definition of a dashboard.</p> <note> <p>If you do not need to know details about the content of a dashboard, for instance if you are trying to check the status of a recently created or updated dashboard, use the <a href=\"https://docs.aws.amazon.com/quicksight/latest/APIReference/API_DescribeDashboard.html\"> <code>DescribeDashboard</code> </a> instead. </p> </note>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_dashboard_definition_request.DescribeDashboardDefinitionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_dashboard_definition_response.DescribeDashboardDefinitionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_dashboard_definition

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_dashboard_definition.async_describe_dashboard_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_dashboard_permissions(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_dashboard_permissions_response.DescribeDashboardPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_dashboard_permissions_request.DescribeDashboardPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_dashboard_permissions_response.DescribeDashboardPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_dashboard_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_dashboard_permissions.async_describe_dashboard_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_dashboard_snapshot_job(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_dashboard_snapshot_job_response.DescribeDashboardSnapshotJobResponse":
        """<p>Describes an existing snapshot job.</p> <p>Poll job descriptions after a job starts to know the status of the job. For information on available status codes, see <code>JobStatus</code>.</p> <p> <b>Registered user support</b> </p> <p>This API can be called as before to get status of a job started by the same Quick Sight user.</p> <p> <b>Possible error scenarios</b> </p> <p>Request will fail with an Access Denied error in the following scenarios:</p> <ul> <li> <p>The credentials have expired.</p> </li> <li> <p>Job has been started by a different user.</p> </li> <li> <p>Impersonated Quick Sight user doesn't have access to the specified dashboard in the job.</p> </li> </ul>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_dashboard_snapshot_job_request.DescribeDashboardSnapshotJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_dashboard_snapshot_job_response.DescribeDashboardSnapshotJobResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_dashboard_snapshot_job

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_dashboard_snapshot_job.async_describe_dashboard_snapshot_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_dashboard_snapshot_job_result(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_dashboard_snapshot_job_result_response.DescribeDashboardSnapshotJobResultResponse":
        """<p>Describes the result of an existing snapshot job that has finished running.</p> <p>A finished snapshot job will return a <code>COMPLETED</code> or <code>FAILED</code> status when you poll the job with a <code>DescribeDashboardSnapshotJob</code> API call.</p> <p>If the job has not finished running, this operation returns a message that says <code>Dashboard Snapshot Job with id <SnapshotjobId> has not reached a terminal state.</code>.</p> <p> <b>Registered user support</b> </p> <p>This API can be called as before to get the result of a job started by the same Quick Sight user. The result for the user will be returned in <code>RegisteredUsers</code> response attribute. The attribute will contain a list with at most one object in it.</p> <p> <b>Possible error scenarios</b> </p> <p>The request fails with an Access Denied error in the following scenarios:</p> <ul> <li> <p>The credentials have expired.</p> </li> <li> <p>The job was started by a different user.</p> </li> <li> <p>The registered user doesn't have access to the specified dashboard.</p> </li> </ul> <p>The request succeeds but the job fails in the following scenarios:</p> <ul> <li> <p> <code>DASHBOARD_ACCESS_DENIED</code> - The registered user lost access to the dashboard.</p> </li> <li> <p> <code>CAPABILITY_RESTRICTED</code> - The registered user is restricted from exporting data in <b>all</b> selected formats.</p> </li> </ul> <p>The request succeeds but the response contains an error code in the following scenarios:</p> <ul> <li> <p> <code>CAPABILITY_RESTRICTED</code> - The registered user is restricted from exporting data in <b>some</b> selected formats.</p> </li> <li> <p> <code>RLS_CHANGED</code> - Row-level security settings have changed. Re-run the job with current settings.</p> </li> <li> <p> <code>CLS_CHANGED</code> - Column-level security settings have changed. Re-run the job with current settings.</p> </li> <li> <p> <code>DATASET_DELETED</code> - The dataset has been deleted. Verify the dataset exists before re-running the job.</p> </li> </ul>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_dashboard_snapshot_job_result_request.DescribeDashboardSnapshotJobResultRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_dashboard_snapshot_job_result_response.DescribeDashboardSnapshotJobResultResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_dashboard_snapshot_job_result

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_dashboard_snapshot_job_result.async_describe_dashboard_snapshot_job_result(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_dashboards_qa_configuration(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_dashboards_qa_configuration_response.DescribeDashboardsQAConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_dashboards_qa_configuration_request.DescribeDashboardsQAConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_dashboards_qa_configuration_response.DescribeDashboardsQAConfigurationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_dashboards_qa_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_dashboards_qa_configuration.async_describe_dashboards_qa_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_data_set(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_data_set_response.DescribeDataSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_data_set_request.DescribeDataSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_data_set_response.DescribeDataSetResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_data_set

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_data_set.async_describe_data_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_data_set_permissions(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_data_set_permissions_response.DescribeDataSetPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_data_set_permissions_request.DescribeDataSetPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_data_set_permissions_response.DescribeDataSetPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_data_set_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_data_set_permissions.async_describe_data_set_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_data_set_refresh_properties(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_data_set_refresh_properties_response.DescribeDataSetRefreshPropertiesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_data_set_refresh_properties_request.DescribeDataSetRefreshPropertiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_data_set_refresh_properties_response.DescribeDataSetRefreshPropertiesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_data_set_refresh_properties

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_data_set_refresh_properties.async_describe_data_set_refresh_properties(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_data_source(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_data_source_response.DescribeDataSourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_data_source_request.DescribeDataSourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_data_source_response.DescribeDataSourceResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_data_source

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_data_source.async_describe_data_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_data_source_permissions(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_data_source_permissions_response.DescribeDataSourcePermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_data_source_permissions_request.DescribeDataSourcePermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_data_source_permissions_response.DescribeDataSourcePermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_data_source_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_data_source_permissions.async_describe_data_source_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_default_q_business_application(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        namespace: Optional["aws_sdk_quicksight.types.namespace.Namespace"] = None,
    ) -> "aws_sdk_quicksight.types.describe_default_q_business_application_response.DescribeDefaultQBusinessApplicationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_default_q_business_application_request.DescribeDefaultQBusinessApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_default_q_business_application_response.DescribeDefaultQBusinessApplicationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_default_q_business_application

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_default_q_business_application.async_describe_default_q_business_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_flow(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_flow_response.DescribeFlowResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_flow_request.DescribeFlowRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_flow_response.DescribeFlowResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_flow

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_flow.async_describe_flow(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_folder(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_folder_response.DescribeFolderResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_folder_request.DescribeFolderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_folder_response.DescribeFolderResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_folder

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_folder.async_describe_folder(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_folder_permissions(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        namespace: Optional["aws_sdk_quicksight.types.namespace.Namespace"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
    ) -> "aws_sdk_quicksight.types.describe_folder_permissions_response.DescribeFolderPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_folder_permissions_request.DescribeFolderPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_folder_permissions_response.DescribeFolderPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_folder_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_folder_permissions.async_describe_folder_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_folder_permissions(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_quicksight.types.resource_permission.ResourcePermission]"
    ):
        _token = next_token
        while True:
            _response = await self.describe_folder_permissions(
                aws_account_id,
                folder_id,
    ...
    async def describe_folder_resolved_permissions(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
    ) -> "aws_sdk_quicksight.types.describe_folder_resolved_permissions_response.DescribeFolderResolvedPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_folder_resolved_permissions_request.DescribeFolderResolvedPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_folder_resolved_permissions_response.DescribeFolderResolvedPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_folder_resolved_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_folder_resolved_permissions.async_describe_folder_resolved_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_folder_resolved_permissions(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.describe_folder_resolved_permissions(
                aws_account_id,
                folder_id,
                config_overrides=config_overrides,
                namespace=namespace,
    ...
    async def describe_group(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_group_response.DescribeGroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_group_request.DescribeGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_group_response.DescribeGroupResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_group

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_group.async_describe_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_group_membership(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_group_membership_response.DescribeGroupMembershipResponse":
        ...
        Args:
            member_name: <p>The user name of the user that you want to search for.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_group_membership_request.DescribeGroupMembershipRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_group_membership_response.DescribeGroupMembershipResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_group_membership

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_group_membership.async_describe_group_membership(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_iam_policy_assignment(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_iam_policy_assignment_response.DescribeIAMPolicyAssignmentResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_iam_policy_assignment_request.DescribeIAMPolicyAssignmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_iam_policy_assignment_response.DescribeIAMPolicyAssignmentResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_iam_policy_assignment

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_iam_policy_assignment.async_describe_iam_policy_assignment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_ingestion(
        ...
        *,
        ...
        "aws_sdk_quicksight.types.describe_ingestion_response.DescribeIngestionResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_ingestion_request.DescribeIngestionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_ingestion_response.DescribeIngestionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_ingestion

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_ingestion.async_describe_ingestion(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_ip_restriction(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_ip_restriction_response.DescribeIpRestrictionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_ip_restriction_request.DescribeIpRestrictionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_ip_restriction_response.DescribeIpRestrictionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_ip_restriction

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_ip_restriction.async_describe_ip_restriction(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_key_registration(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        default_key_only: Optional["aws_sdk_quicksight.types.boolean.Boolean"] = None,
    ) -> "aws_sdk_quicksight.types.describe_key_registration_response.DescribeKeyRegistrationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_key_registration_request.DescribeKeyRegistrationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_key_registration_response.DescribeKeyRegistrationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_key_registration

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_key_registration.async_describe_key_registration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_knowledge_base(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_knowledge_base_response.DescribeKnowledgeBaseResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_knowledge_base_request.DescribeKnowledgeBaseRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_knowledge_base_response.DescribeKnowledgeBaseResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_knowledge_base

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_knowledge_base.async_describe_knowledge_base(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_knowledge_base_permissions(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_knowledge_base_permissions_response.DescribeKnowledgeBasePermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_knowledge_base_permissions_request.DescribeKnowledgeBasePermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_knowledge_base_permissions_response.DescribeKnowledgeBasePermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_knowledge_base_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_knowledge_base_permissions.async_describe_knowledge_base_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_namespace(
        ...
        *,
        ...
        "aws_sdk_quicksight.types.describe_namespace_response.DescribeNamespaceResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_namespace_request.DescribeNamespaceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_namespace_response.DescribeNamespaceResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_namespace

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_namespace.async_describe_namespace(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_o_auth_client_application(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_o_auth_client_application_response.DescribeOAuthClientApplicationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_o_auth_client_application_request.DescribeOAuthClientApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_o_auth_client_application_response.DescribeOAuthClientApplicationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_o_auth_client_application

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_o_auth_client_application.async_describe_o_auth_client_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_q_personalization_configuration(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_q_personalization_configuration_response.DescribeQPersonalizationConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_q_personalization_configuration_request.DescribeQPersonalizationConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_q_personalization_configuration_response.DescribeQPersonalizationConfigurationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_q_personalization_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_q_personalization_configuration.async_describe_q_personalization_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_quick_sight_q_search_configuration(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_quick_sight_q_search_configuration_response.DescribeQuickSightQSearchConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_quick_sight_q_search_configuration_request.DescribeQuickSightQSearchConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_quick_sight_q_search_configuration_response.DescribeQuickSightQSearchConfigurationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_quick_sight_q_search_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_quick_sight_q_search_configuration.async_describe_quick_sight_q_search_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_refresh_schedule(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_refresh_schedule_response.DescribeRefreshScheduleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_refresh_schedule_request.DescribeRefreshScheduleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_refresh_schedule_response.DescribeRefreshScheduleResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_refresh_schedule

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_refresh_schedule.async_describe_refresh_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_role_custom_permission(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_role_custom_permission_response.DescribeRoleCustomPermissionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_role_custom_permission_request.DescribeRoleCustomPermissionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_role_custom_permission_response.DescribeRoleCustomPermissionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_role_custom_permission

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_role_custom_permission.async_describe_role_custom_permission(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_self_upgrade_configuration(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_self_upgrade_configuration_response.DescribeSelfUpgradeConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_self_upgrade_configuration_request.DescribeSelfUpgradeConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_self_upgrade_configuration_response.DescribeSelfUpgradeConfigurationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_self_upgrade_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_self_upgrade_configuration.async_describe_self_upgrade_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_space(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        max_contributors: Optional[
            "aws_sdk_quicksight.types.max_contributors.MaxContributors"
        ] = None,
    ) -> "aws_sdk_quicksight.types.describe_space_response.DescribeSpaceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_space_request.DescribeSpaceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_space_response.DescribeSpaceResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_space

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_space.async_describe_space(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_space_permissions(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_space_permissions_response.DescribeSpacePermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_space_permissions_request.DescribeSpacePermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_space_permissions_response.DescribeSpacePermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_space_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_space_permissions.async_describe_space_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_template(
        ...
        *,
        ...
        alias_name: Optional["aws_sdk_quicksight.types.alias_name.AliasName"] = None,
    ) -> "aws_sdk_quicksight.types.describe_template_response.DescribeTemplateResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_template_request.DescribeTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_template_response.DescribeTemplateResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_template

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_template.async_describe_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_template_alias(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_template_alias_response.DescribeTemplateAliasResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_template_alias_request.DescribeTemplateAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_template_alias_response.DescribeTemplateAliasResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_template_alias

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_template_alias.async_describe_template_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_template_definition(
        ...
        *,
        ...
        alias_name: Optional["aws_sdk_quicksight.types.alias_name.AliasName"] = None,
    ) -> "aws_sdk_quicksight.types.describe_template_definition_response.DescribeTemplateDefinitionResponse":
        r"""<p>Provides a detailed description of the definition of a template.</p> <note> <p>If you do not need to know details about the content of a template, for instance if you are trying to check the status of a recently created or updated template, use the <a href=\"https://docs.aws.amazon.com/quicksight/latest/APIReference/API_DescribeTemplate.html\"> <code>DescribeTemplate</code> </a> instead. </p> </note>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the template. You must be using the Amazon Web Services account that the template is in.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_template_definition_request.DescribeTemplateDefinitionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_template_definition_response.DescribeTemplateDefinitionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_template_definition

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_template_definition.async_describe_template_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_template_permissions(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_template_permissions_response.DescribeTemplatePermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_template_permissions_request.DescribeTemplatePermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_template_permissions_response.DescribeTemplatePermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_template_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_template_permissions.async_describe_template_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_theme(
        ...
        *,
        ...
        alias_name: Optional["aws_sdk_quicksight.types.alias_name.AliasName"] = None,
    ) -> "aws_sdk_quicksight.types.describe_theme_response.DescribeThemeResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_theme_request.DescribeThemeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_theme_response.DescribeThemeResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_theme

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_theme.async_describe_theme(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_theme_alias(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_theme_alias_response.DescribeThemeAliasResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_theme_alias_request.DescribeThemeAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_theme_alias_response.DescribeThemeAliasResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_theme_alias

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_theme_alias.async_describe_theme_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_theme_permissions(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_theme_permissions_response.DescribeThemePermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_theme_permissions_request.DescribeThemePermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_theme_permissions_response.DescribeThemePermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_theme_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_theme_permissions.async_describe_theme_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_topic(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_topic_response.DescribeTopicResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_topic_request.DescribeTopicRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_topic_response.DescribeTopicResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_topic

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_topic.async_describe_topic(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_topic_permissions(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_topic_permissions_response.DescribeTopicPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_topic_permissions_request.DescribeTopicPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_topic_permissions_response.DescribeTopicPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_topic_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_topic_permissions.async_describe_topic_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_topic_refresh(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_topic_refresh_response.DescribeTopicRefreshResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_topic_refresh_request.DescribeTopicRefreshRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_topic_refresh_response.DescribeTopicRefreshResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_topic_refresh

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_topic_refresh.async_describe_topic_refresh(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_topic_refresh_schedule(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_topic_refresh_schedule_response.DescribeTopicRefreshScheduleResponse":
        """<p>Deletes a topic refresh schedule.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_topic_refresh_schedule_request.DescribeTopicRefreshScheduleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_topic_refresh_schedule_response.DescribeTopicRefreshScheduleResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_topic_refresh_schedule

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_topic_refresh_schedule.async_describe_topic_refresh_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_user(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_user_response.DescribeUserResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_user_request.DescribeUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_user_response.DescribeUserResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_user

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_user.async_describe_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_vpc_connection(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.describe_vpc_connection_response.DescribeVPCConnectionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.describe_vpc_connection_request.DescribeVPCConnectionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.describe_vpc_connection_response.DescribeVPCConnectionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.describe_vpc_connection

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.describe_vpc_connection.async_describe_vpc_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_embed_url_for_anonymous_user(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        session_lifetime_in_minutes: Optional[
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.generate_embed_url_for_anonymous_user_request.GenerateEmbedUrlForAnonymousUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.generate_embed_url_for_anonymous_user_response.GenerateEmbedUrlForAnonymousUserResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.generate_embed_url_for_anonymous_user

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.generate_embed_url_for_anonymous_user.async_generate_embed_url_for_anonymous_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_embed_url_for_registered_user(
        ...
        *,
        ...
        r"""<p>Generates an embed URL that you can use to embed an Amazon Quick experience in your website. This action can be used for any type of user registered in an Amazon Quick account. Before you use this action, make sure that you have configured the relevant Amazon Quick resource and permissions.</p> <p>The following rules apply to the generated URL:</p> <ul> <li> <p>It contains a temporary bearer token. It is valid for 5 minutes after it is generated. Once redeemed within this period, it cannot be re-used again.</p> </li> <li> <p>The URL validity period should not be confused with the actual session lifetime that can be customized using the <code> <a href=\"https://docs.aws.amazon.com/quicksight/latest/APIReference/API_GenerateEmbedUrlForRegisteredUser.html#QS-GenerateEmbedUrlForRegisteredUser-request-SessionLifetimeInMinutes\">SessionLifetimeInMinutes</a> </code> parameter.</p> <p>The resulting user session is valid for 15 minutes (minimum) to 10 hours (maximum). The default session duration is 10 hours.</p> </li> <li> <p>You are charged only when the URL is used or there is interaction with Amazon Quick.</p> </li> </ul> <p>For more information, see <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/embedded-analytics.html\">Embedded Analytics</a> in the <i>Amazon Quick User Guide</i>.</p> <p>For more information about the high-level steps for embedding and for an interactive demo of the ways you can customize embedding, visit the <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/quicksight-dev-portal.html\">Amazon Quick Developer Portal</a>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.generate_embed_url_for_registered_user_request.GenerateEmbedUrlForRegisteredUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.generate_embed_url_for_registered_user_response.GenerateEmbedUrlForRegisteredUserResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.generate_embed_url_for_registered_user

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.generate_embed_url_for_registered_user.async_generate_embed_url_for_registered_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_embed_url_for_registered_user_with_identity(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.generate_embed_url_for_registered_user_with_identity_response.GenerateEmbedUrlForRegisteredUserWithIdentityResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.generate_embed_url_for_registered_user_with_identity_request.GenerateEmbedUrlForRegisteredUserWithIdentityRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.generate_embed_url_for_registered_user_with_identity_response.GenerateEmbedUrlForRegisteredUserWithIdentityResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.generate_embed_url_for_registered_user_with_identity

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.generate_embed_url_for_registered_user_with_identity.async_generate_embed_url_for_registered_user_with_identity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_dashboard_embed_url(
        ...
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        dashboard_id: "aws_sdk_quicksight.types.short_restrictive_resource_id.ShortRestrictiveResourceId",
        identity_type: "aws_sdk_quicksight.types.embedding_identity_type.EmbeddingIdentityType",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        session_lifetime_in_minutes: Optional[
            "aws_sdk_quicksight.types.session_lifetime_in_minutes.SessionLifetimeInMinutes"
        ] = None,
        undo_redo_disabled: Optional["aws_sdk_quicksight.types.boolean.Boolean"] = None,
        reset_disabled: Optional["aws_sdk_quicksight.types.boolean.Boolean"] = None,
        state_persistence_enabled: Optional[
            "aws_sdk_quicksight.types.boolean.Boolean"
        ] = None,
        user_arn: Optional["aws_sdk_quicksight.types.arn.Arn"] = None,
        namespace: Optional["aws_sdk_quicksight.types.namespace.Namespace"] = None,
        additional_dashboard_ids: Optional[
            "aws_sdk_quicksight.types.additional_dashboard_id_list.AdditionalDashboardIdList"
        ] = None,
    ) -> "aws_sdk_quicksight.types.get_dashboard_embed_url_response.GetDashboardEmbedUrlResponse":
        r"""<p>Generates a temporary session URL and authorization code(bearer token) that you can use to embed an Amazon Quick Sight read-only dashboard in your website or application. Before you use this command, make sure that you have configured the dashboards and permissions. </p> <p>Currently, you can use <code>GetDashboardEmbedURL</code> only from the server, not from the user's browser. The following rules apply to the generated URL:</p> <ul> <li> <p>They must be used together.</p> </li> <li> <p>They can be used one time only.</p> </li> <li> <p>They are valid for 5 minutes after you run this command.</p> </li> <li> <p>You are charged only when the URL is used or there is interaction with Quick.</p> </li> <li> <p>The resulting user session is valid for 15 minutes (default) up to 10 hours (maximum). You can use the optional <code>SessionLifetimeInMinutes</code> parameter to customize session duration.</p> </li> </ul> <p>For more information, see <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/embedded-analytics-deprecated.html\">Embedding Analytics Using GetDashboardEmbedUrl</a> in the <i>Amazon Quick User Guide</i>.</p> <p>For more information about the high-level steps for embedding and for an interactive demo of the ways you can customize embedding, visit the <a href=\"https://docs.aws.amazon.com/quicksight/latest/user/quicksight-dev-portal.html\">Amazon Quick Developer Portal</a>.</p>

        Args:
            aws_account_id: <p>The ID for the Amazon Web Services account that contains the dashboard that you're embedding.</p>
            dashboard_id: <p>The ID for the dashboard, also added to the Identity and Access Management (IAM) policy.</p>
            identity_type: <p>The authentication method that the user uses to sign in.</p>
            session_lifetime_in_minutes: <p>How many minutes the session is valid. The session lifetime must be 15-600 minutes.</p>
            undo_redo_disabled: <p>Remove the undo/redo button on the embedded dashboard. The default is FALSE, which enables the undo/redo button.</p>
            reset_disabled: <p>Remove the reset button on the embedded dashboard. The default is FALSE, which enables the reset button.</p>
            state_persistence_enabled: <p>Adds persistence of state for the user session in an embedded dashboard. Persistence applies to the sheet and the parameter settings. These are control settings that the dashboard subscriber (Amazon Quick Sight reader) chooses while viewing the dashboard. If this is set to <code>TRUE</code>, the settings are the same when the subscriber reopens the same dashboard URL. The state is stored in Amazon Quick Sight, not in a browser cookie. If this is set to FALSE, the state of the user session is not persisted. The default is <code>FALSE</code>.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.get_dashboard_embed_url_request.GetDashboardEmbedUrlRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.get_dashboard_embed_url_response.GetDashboardEmbedUrlResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.get_dashboard_embed_url

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.get_dashboard_embed_url.async_get_dashboard_embed_url(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_flow_metadata(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.get_flow_metadata_output.GetFlowMetadataOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.get_flow_metadata_input.GetFlowMetadataInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.get_flow_metadata_output.GetFlowMetadataOutput"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.get_flow_metadata

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.get_flow_metadata.async_get_flow_metadata(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_flow_permissions(
        ...
        *,
        ...
        "aws_sdk_quicksight.types.get_flow_permissions_output.GetFlowPermissionsOutput"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.get_flow_permissions_input.GetFlowPermissionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.get_flow_permissions_output.GetFlowPermissionsOutput"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.get_flow_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.get_flow_permissions.async_get_flow_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_identity_context(
        ...
        *,
        ...
        context_region: Optional["aws_sdk_quicksight.types.region.Region"] = None,
    ) -> "aws_sdk_quicksight.types.get_identity_context_response.GetIdentityContextResponse":
        ...
        Args:
            aws_account_id: <p>The ID for the Amazon Web Services account that the user whose identity context you want to retrieve is in. Currently, you use the ID for the Amazon Web Services account that contains your Quick Sight account.</p>
            user_identifier: <p>The identifier for the user whose identity context you want to retrieve.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.get_identity_context_request.GetIdentityContextRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.get_identity_context_response.GetIdentityContextResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.get_identity_context

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.get_identity_context.async_get_identity_context(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_session_embed_url(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.get_session_embed_url_request.GetSessionEmbedUrlRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.get_session_embed_url_response.GetSessionEmbedUrlResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.get_session_embed_url

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.get_session_embed_url.async_get_session_embed_url(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_action_connectors(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_action_connectors_request.ListActionConnectorsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_action_connectors_response.ListActionConnectorsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_action_connectors

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_action_connectors.async_list_action_connectors(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_action_connectors(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.action_connector_summary.ActionConnectorSummary]":
        _token = next_token
        while True:
            _response = await self.list_action_connectors(
                aws_account_id,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            )
            _page = _resolve_path(_response, ("action_connector_summaries",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_agents(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "aws_sdk_quicksight.types.list_agents_response.ListAgentsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_agents_request.ListAgentsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_agents_response.ListAgentsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_agents

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_agents.async_list_agents(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_analyses(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_analyses_response.ListAnalysesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_analyses_request.ListAnalysesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_analyses_response.ListAnalysesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_analyses

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_analyses.async_list_analyses(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_analyses(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.analysis_summary.AnalysisSummary]":
        _token = next_token
        while True:
            _response = await self.list_analyses(
                aws_account_id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def list_asset_bundle_export_jobs(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_asset_bundle_export_jobs_response.ListAssetBundleExportJobsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_asset_bundle_export_jobs_request.ListAssetBundleExportJobsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_asset_bundle_export_jobs_response.ListAssetBundleExportJobsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_asset_bundle_export_jobs

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_asset_bundle_export_jobs.async_list_asset_bundle_export_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_asset_bundle_export_jobs(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.asset_bundle_export_job_summary.AssetBundleExportJobSummary]":
        _token = next_token
        while True:
            _response = await self.list_asset_bundle_export_jobs(
                aws_account_id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
            _page = _resolve_path(_response, ("asset_bundle_export_job_summary_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_asset_bundle_import_jobs(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_asset_bundle_import_jobs_response.ListAssetBundleImportJobsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_asset_bundle_import_jobs_request.ListAssetBundleImportJobsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_asset_bundle_import_jobs_response.ListAssetBundleImportJobsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_asset_bundle_import_jobs

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_asset_bundle_import_jobs.async_list_asset_bundle_import_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_asset_bundle_import_jobs(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.asset_bundle_import_job_summary.AssetBundleImportJobSummary]":
        _token = next_token
        while True:
            _response = await self.list_asset_bundle_import_jobs(
                aws_account_id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
            _page = _resolve_path(_response, ("asset_bundle_import_job_summary_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_brands(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
    ) -> "aws_sdk_quicksight.types.list_brands_response.ListBrandsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_brands_request.ListBrandsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_brands_response.ListBrandsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_brands

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_brands.async_list_brands(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_brands(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.brand_summary.BrandSummary]":
        _token = next_token
        while True:
            _response = await self.list_brands(
                aws_account_id,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            )
            _page = _resolve_path(_response, ("brands",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_custom_permissions(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
    ) -> "aws_sdk_quicksight.types.list_custom_permissions_response.ListCustomPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_custom_permissions_request.ListCustomPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_custom_permissions_response.ListCustomPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_custom_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_custom_permissions.async_list_custom_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_custom_permissions(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.custom_permissions.CustomPermissions]":
        _token = next_token
        while True:
            _response = await self.list_custom_permissions(
                aws_account_id,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            )
            _page = _resolve_path(_response, ("custom_permissions_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_dashboards(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_dashboards_response.ListDashboardsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_dashboards_request.ListDashboardsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_dashboards_response.ListDashboardsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_dashboards

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_dashboards.async_list_dashboards(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_dashboards(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.dashboard_summary.DashboardSummary]":
        _token = next_token
        while True:
            ...
            _page = _resolve_path(_response, ("dashboard_summary_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_dashboard_versions(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_dashboard_versions_response.ListDashboardVersionsResponse":
        """<p>Lists all the versions of the dashboards in the Amazon Quick Sight subscription.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the dashboard that you're listing versions for.</p>
            dashboard_id: <p>The ID for the dashboard.</p>
            next_token: <p>The token for the next set of results, or null if there are no more results.</p>
            max_results: <p>The maximum number of results to be returned per request.</p>
        """
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_dashboard_versions_request.ListDashboardVersionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_dashboard_versions_response.ListDashboardVersionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_dashboard_versions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_dashboard_versions.async_list_dashboard_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_dashboard_versions(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.dashboard_version_summary.DashboardVersionSummary]":
        _token = next_token
        while True:
            _response = await self.list_dashboard_versions(
                aws_account_id,
                dashboard_id,
                config_overrides=config_overrides,
                next_token=_token,
            ...
            _page = _resolve_path(_response, ("dashboard_version_summary_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_data_sets(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_data_sets_response.ListDataSetsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_data_sets_request.ListDataSetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_data_sets_response.ListDataSetsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_data_sets

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_data_sets.async_list_data_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_data_sets(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.data_set_summary.DataSetSummary]":
        _token = next_token
        while True:
            ...
            _page = _resolve_path(_response, ("data_set_summaries",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_data_sources(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_data_sources_response.ListDataSourcesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_data_sources_request.ListDataSourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_data_sources_response.ListDataSourcesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_data_sources

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_data_sources.async_list_data_sources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_data_sources(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.data_source.DataSource]":
        _token = next_token
        while True:
    ...
    async def list_flows(
        ...
        *,
        ...
        next_token: Optional[str] = None,
        max_results: Optional[
            "aws_sdk_quicksight.types.flow_max_results.FlowMaxResults"
        ] = None,
    ) -> "aws_sdk_quicksight.types.list_flows_output.ListFlowsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_flows_input.ListFlowsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_flows_output.ListFlowsOutput"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_flows

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_flows.async_list_flows(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_quicksight.types.flow_summary.FlowSummary]":
        _token = next_token
        while True:
            ...
            _page = _resolve_path(_response, ("flow_summary_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_folder_members(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_folder_members_response.ListFolderMembersResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_folder_members_request.ListFolderMembersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_folder_members_response.ListFolderMembersResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_folder_members

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_folder_members.async_list_folder_members(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_folder_members(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.member_id_arn_pair.MemberIdArnPair]":
        _token = next_token
        while True:
            _response = await self.list_folder_members(
                aws_account_id,
                folder_id,
                config_overrides=config_overrides,
                next_token=_token,
            ...
            _page = _resolve_path(_response, ("folder_member_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_folders(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_folders_response.ListFoldersResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_folders_request.ListFoldersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_folders_response.ListFoldersResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_folders

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_folders.async_list_folders(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_folders(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.folder_summary.FolderSummary]":
        _token = next_token
        while True:
            _response = await self.list_folders(
                aws_account_id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
            _page = _resolve_path(_response, ("folder_summary_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_folders_for_resource(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_folders_for_resource_response.ListFoldersForResourceResponse":
        """<p>List all folders that a resource is a member of.</p>

        Args:
            aws_account_id: <p>The ID for the Amazon Web Services account that contains the resource.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_folders_for_resource_request.ListFoldersForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_folders_for_resource_response.ListFoldersForResourceResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_folders_for_resource

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_folders_for_resource.async_list_folders_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_folders_for_resource(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.arn.Arn]":
        _token = next_token
        while True:
            _response = await self.list_folders_for_resource(
                aws_account_id,
                resource_arn,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    async def list_group_memberships(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_group_memberships_response.ListGroupMembershipsResponse":
        """<p>Lists member users in a group.</p>

        Args:
            group_name: <p>The name of the group that you want to see a membership list of.</p>
            next_token: <p>A pagination token that can be used in a subsequent request.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_group_memberships_request.ListGroupMembershipsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_group_memberships_response.ListGroupMembershipsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_group_memberships

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_group_memberships.async_list_group_memberships(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_group_memberships(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.group_member.GroupMember]":
        _token = next_token
        while True:
            _response = await self.list_group_memberships(
                group_name,
                aws_account_id,
                namespace,
                config_overrides=config_overrides,
            ...
            _page = _resolve_path(_response, ("group_member_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_groups(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_groups_response.ListGroupsResponse":
        """<p>Lists all user groups in Amazon Quick Sight. </p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_groups_request.ListGroupsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_groups_response.ListGroupsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_groups

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_groups.async_list_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_groups(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.group.Group]":
        _token = next_token
        while True:
            ...
            _page = _resolve_path(_response, ("group_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_iam_policy_assignments(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_iam_policy_assignments_response.ListIAMPolicyAssignmentsResponse":
        """<p>Lists the IAM policy assignments in the current Amazon Quick Sight account.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains these IAM policy assignments.</p>
            assignment_status: <p>The status of the assignments.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_iam_policy_assignments_request.ListIAMPolicyAssignmentsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_iam_policy_assignments_response.ListIAMPolicyAssignmentsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_iam_policy_assignments

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_iam_policy_assignments.async_list_iam_policy_assignments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_iam_policy_assignments(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.iam_policy_assignment_summary.IAMPolicyAssignmentSummary]":
        _token = next_token
        while True:
            _response = await self.list_iam_policy_assignments(
                aws_account_id,
                namespace,
                config_overrides=config_overrides,
            ...
            _page = _resolve_path(_response, ("iam_policy_assignments",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_iam_policy_assignments_for_user(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_iam_policy_assignments_for_user_response.ListIAMPolicyAssignmentsForUserResponse":
        ...
        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the assignments.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_iam_policy_assignments_for_user_request.ListIAMPolicyAssignmentsForUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_iam_policy_assignments_for_user_response.ListIAMPolicyAssignmentsForUserResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_iam_policy_assignments_for_user

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_iam_policy_assignments_for_user.async_list_iam_policy_assignments_for_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_iam_policy_assignments_for_user(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.active_iam_policy_assignment.ActiveIAMPolicyAssignment]":
        _token = next_token
        while True:
            _response = await self.list_iam_policy_assignments_for_user(
                aws_account_id,
                user_name,
                namespace,
                config_overrides=config_overrides,
            ...
            _page = _resolve_path(_response, ("active_assignments",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_identity_propagation_configs(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
    ) -> "aws_sdk_quicksight.types.list_identity_propagation_configs_response.ListIdentityPropagationConfigsResponse":
        """<p>Lists all services and authorized targets that the Quick Sight IAM Identity Center application can access.</p> <p>This operation is only supported for Quick Sight accounts that use IAM Identity Center.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_identity_propagation_configs_request.ListIdentityPropagationConfigsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_identity_propagation_configs_response.ListIdentityPropagationConfigsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_identity_propagation_configs

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_identity_propagation_configs.async_list_identity_propagation_configs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_ingestions(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.list_ingestions_response.ListIngestionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_ingestions_request.ListIngestionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_ingestions_response.ListIngestionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_ingestions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_ingestions.async_list_ingestions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_quicksight.types.ingestion.Ingestion]":
        _token = next_token
        while True:
    ...
    async def list_knowledge_bases(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_quicksight.types.next_token.NextToken"] = None,
    ) -> "aws_sdk_quicksight.types.list_knowledge_bases_response.ListKnowledgeBasesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_knowledge_bases_request.ListKnowledgeBasesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_knowledge_bases_response.ListKnowledgeBasesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_knowledge_bases

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_knowledge_bases.async_list_knowledge_bases(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_knowledge_bases(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_quicksight.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.knowledge_base_summary.KnowledgeBaseSummary]":
        _token = next_token
        while True:
    ...
    async def list_namespaces(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_namespaces_response.ListNamespacesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_namespaces_request.ListNamespacesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_namespaces_response.ListNamespacesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_namespaces

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_namespaces.async_list_namespaces(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_namespaces(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.namespace_info_v2.NamespaceInfoV2]":
        _token = next_token
        while True:
    ...
    async def list_o_auth_client_applications(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_o_auth_client_applications_response.ListOAuthClientApplicationsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_o_auth_client_applications_request.ListOAuthClientApplicationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_o_auth_client_applications_response.ListOAuthClientApplicationsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_o_auth_client_applications

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_o_auth_client_applications.async_list_o_auth_client_applications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_o_auth_client_applications(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.o_auth_client_application_summary.OAuthClientApplicationSummary]":
        _token = next_token
        while True:
            _response = await self.list_o_auth_client_applications(
                aws_account_id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
            _page = _resolve_path(_response, ("o_auth_client_applications",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_refresh_schedules(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.list_refresh_schedules_response.ListRefreshSchedulesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_refresh_schedules_request.ListRefreshSchedulesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_refresh_schedules_response.ListRefreshSchedulesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_refresh_schedules

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_refresh_schedules.async_list_refresh_schedules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_role_memberships(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_role_memberships_response.ListRoleMembershipsResponse":
        """<p>Lists all groups that are associated with a role.</p>

        Args:
            role: <p>The name of the role.</p>
            next_token: <p>A pagination token that can be used in a subsequent request.</p>
            max_results: <p>The maximum number of results to return.</p>
            aws_account_id: <p>The ID for the Amazon Web Services account that you want to create a group in. The Amazon Web Services account ID that you provide must be the same Amazon Web Services account that contains your Amazon Quick Sight account.</p>
            namespace: <p>The namespace that includes the role.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_role_memberships_request.ListRoleMembershipsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_role_memberships_response.ListRoleMembershipsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_role_memberships

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_role_memberships.async_list_role_memberships(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_role_memberships(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.string.String]":
        _token = next_token
        while True:
            _response = await self.list_role_memberships(
                role,
                aws_account_id,
                namespace,
                config_overrides=config_overrides,
            ...
            _page = _resolve_path(_response, ("members_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_self_upgrades(
        ...
        *,
        ...
        "aws_sdk_quicksight.types.list_self_upgrades_response.ListSelfUpgradesResponse"
    ):
        """<p>Lists all self-upgrade requests for a Quick account.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the self-upgrade requests.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_self_upgrades_request.ListSelfUpgradesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_self_upgrades_response.ListSelfUpgradesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_self_upgrades

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_self_upgrades.async_list_self_upgrades(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_space_resources(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.list_space_resources_response.ListSpaceResourcesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_space_resources_request.ListSpaceResourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_space_resources_response.ListSpaceResourcesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_space_resources

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_space_resources.async_list_space_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_spaces(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.list_spaces_response.ListSpacesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_spaces_request.ListSpacesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_spaces_response.ListSpacesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_spaces

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_spaces.async_list_spaces(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_tags_for_resource

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_template_aliases(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_template_aliases_response.ListTemplateAliasesResponse":
        """<p>Lists all the aliases of a template.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the template aliases that you're listing.</p>
            template_id: <p>The ID for the template.</p>
            next_token: <p>The token for the next set of results, or null if there are no more results.</p>
            max_results: <p>The maximum number of results to be returned per request.</p>
        """
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_template_aliases_request.ListTemplateAliasesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_template_aliases_response.ListTemplateAliasesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_template_aliases

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_template_aliases.async_list_template_aliases(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_template_aliases(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.template_alias.TemplateAlias]":
        _token = next_token
        while True:
            _response = await self.list_template_aliases(
                aws_account_id,
                template_id,
                config_overrides=config_overrides,
                next_token=_token,
            ...
            _page = _resolve_path(_response, ("template_alias_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_templates(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_templates_response.ListTemplatesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_templates_request.ListTemplatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_templates_response.ListTemplatesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_templates

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_templates.async_list_templates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_templates(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.template_summary.TemplateSummary]":
        _token = next_token
        while True:
            ...
            _page = _resolve_path(_response, ("template_summary_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_template_versions(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_template_versions_response.ListTemplateVersionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_template_versions_request.ListTemplateVersionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_template_versions_response.ListTemplateVersionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_template_versions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_template_versions.async_list_template_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_template_versions(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.template_version_summary.TemplateVersionSummary]":
        _token = next_token
        while True:
            _response = await self.list_template_versions(
                aws_account_id,
                template_id,
                config_overrides=config_overrides,
                next_token=_token,
            ...
            _page = _resolve_path(_response, ("template_version_summary_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_theme_aliases(
        ...
        *,
        ...
        "aws_sdk_quicksight.types.list_theme_aliases_response.ListThemeAliasesResponse"
    ):
        """<p>Lists all the aliases of a theme.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the theme aliases that you're listing.</p>
            theme_id: <p>The ID for the theme.</p>
            next_token: <p>The token for the next set of results, or null if there are no more results.</p>
            max_results: <p>The maximum number of results to be returned per request.</p>
        """
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_theme_aliases_request.ListThemeAliasesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_theme_aliases_response.ListThemeAliasesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_theme_aliases

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_theme_aliases.async_list_theme_aliases(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_themes(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
        type: Optional["aws_sdk_quicksight.types.theme_type.ThemeType"] = None,
    ) -> "aws_sdk_quicksight.types.list_themes_response.ListThemesResponse":
        """<p>Lists all the themes in the current Amazon Web Services account.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the themes that you're listing.</p>
            next_token: <p>The token for the next set of results, or null if there are no more results.</p>
            max_results: <p>The maximum number of results to be returned per request.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_themes_request.ListThemesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_themes_response.ListThemesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_themes

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_themes.async_list_themes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_themes(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
        type: Optional["aws_sdk_quicksight.types.theme_type.ThemeType"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.theme_summary.ThemeSummary]":
        _token = next_token
        while True:
            ...
            _page = _resolve_path(_response, ("theme_summary_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_theme_versions(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_theme_versions_response.ListThemeVersionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_theme_versions_request.ListThemeVersionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_theme_versions_response.ListThemeVersionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_theme_versions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_theme_versions.async_list_theme_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_theme_versions(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.theme_version_summary.ThemeVersionSummary]":
        _token = next_token
        while True:
            _response = await self.list_theme_versions(
                aws_account_id,
                theme_id,
                config_overrides=config_overrides,
                next_token=_token,
            ...
            _page = _resolve_path(_response, ("theme_version_summary_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_topic_refresh_schedules(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.list_topic_refresh_schedules_response.ListTopicRefreshSchedulesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_topic_refresh_schedules_request.ListTopicRefreshSchedulesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_topic_refresh_schedules_response.ListTopicRefreshSchedulesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_topic_refresh_schedules

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_topic_refresh_schedules.async_list_topic_refresh_schedules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_topic_reviewed_answers(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.list_topic_reviewed_answers_response.ListTopicReviewedAnswersResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_topic_reviewed_answers_request.ListTopicReviewedAnswersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_topic_reviewed_answers_response.ListTopicReviewedAnswersResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_topic_reviewed_answers

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_topic_reviewed_answers.async_list_topic_reviewed_answers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_topics(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_topics_response.ListTopicsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_topics_request.ListTopicsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_topics_response.ListTopicsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_topics

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_topics.async_list_topics(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_user_groups(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_user_groups_response.ListUserGroupsResponse":
        """<p>Lists the Amazon Quick Sight groups that an Amazon Quick Sight user is a member of.</p>

        Args:
            user_name: <p>The Amazon Quick Sight user name that you want to list group memberships for.</p>
            aws_account_id: <p>The Amazon Web Services account ID that the user is in. Currently, you use the ID for the Amazon Web Services account that contains your Amazon Quick Sight account.</p>
            namespace: <p>The namespace. Currently, you should set this to <code>default</code>.</p>
            next_token: <p>A pagination token that can be used in a subsequent request.</p>
            max_results: <p>The maximum number of results to return from this request.</p>
        """
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_user_groups_request.ListUserGroupsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_user_groups_response.ListUserGroupsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_user_groups

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_user_groups.async_list_user_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_user_groups(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.list_user_groups(
                user_name,
                aws_account_id,
                namespace,
                config_overrides=config_overrides,
    ...
    async def list_users(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_users_response.ListUsersResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_users_request.ListUsersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_users_response.ListUsersResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_users

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_users.async_list_users(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_users(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.user.User]":
        _token = next_token
        while True:
            ...
            _page = _resolve_path(_response, ("user_list",))
            for _item in _page or []:
                yield _item
            _token = _resolve_path(_response, ("next_token",))
            if not _token:
    ...
    async def list_users_index_capacity(
        ...
        *,
        ...
        namespace: Optional["aws_sdk_quicksight.types.namespace.Namespace"] = None,
        filters: Optional[
            "aws_sdk_quicksight.types.user_index_capacity_filters.UserIndexCapacityFilters"
        ] = None,
        sort_by: Optional[
            "aws_sdk_quicksight.types.user_index_capacity_sort_by.UserIndexCapacitySortBy"
        ] = None,
        sort_order: Optional[
            "aws_sdk_quicksight.types.user_index_capacity_sort_order.UserIndexCapacitySortOrder"
        ] = None,
        max_results: Optional[
            "aws_sdk_quicksight.types.list_users_index_capacity_request_max_results_integer.ListUsersIndexCapacityRequestMaxResultsInteger"
        ] = None,
        next_token: Optional[str] = None,
    ) -> "aws_sdk_quicksight.types.list_users_index_capacity_response.ListUsersIndexCapacityResponse":
        """<p>Lists per-user index capacity consumption for an account.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the index capacity data.</p>
            namespace: <p>The namespace to scope the user search to. Required when the userNameOrEmail filter is present.</p>
            filters: <p>Filters to apply. Only one filter is supported per request. The userNameOrEmail and totalCapacityBytes filters are mutually exclusive.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_users_index_capacity_request.ListUsersIndexCapacityRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_users_index_capacity_response.ListUsersIndexCapacityResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_users_index_capacity

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_users_index_capacity.async_list_users_index_capacity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_vpc_connections(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.list_vpc_connections_response.ListVPCConnectionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.list_vpc_connections_request.ListVPCConnectionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.list_vpc_connections_response.ListVPCConnectionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.list_vpc_connections

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.list_vpc_connections.async_list_vpc_connections(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def predict_qa_results(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        include_quick_sight_q_index: Optional[
            "aws_sdk_quicksight.types.include_quick_sight_q_index.IncludeQuickSightQIndex"
        ] = None,
        include_generated_answer: Optional[
            "aws_sdk_quicksight.types.include_generated_answer.IncludeGeneratedAnswer"
        ] = None,
        max_topics_to_consider: Optional[
            "aws_sdk_quicksight.types.max_topics_to_consider.MaxTopicsToConsider"
        ] = None,
    ) -> (
        "aws_sdk_quicksight.types.predict_qa_results_response.PredictQAResultsResponse"
    ):
        r"""<p>Predicts existing visuals or generates new visuals to answer a given query.</p> <p>This API uses <a href=\"https://docs.aws.amazon.com/singlesignon/latest/userguide/trustedidentitypropagation.html\">trusted identity propagation</a> to ensure that an end user is authenticated and receives the embed URL that is specific to that user. The IAM Identity Center application that the user has logged into needs to have <a href=\"https://docs.aws.amazon.com/singlesignon/latest/userguide/trustedidentitypropagation-using-customermanagedapps-specify-trusted-apps.html\">trusted Identity Propagation enabled for Quick</a> with the scope value set to <code>quicksight:read</code>. Before you use this action, make sure that you have configured the relevant Quick resource and permissions.</p> <p>We recommend enabling the <code>QSearchStatus</code> API to unlock the full potential of <code>PredictQnA</code>. When <code>QSearchStatus</code> is enabled, it first checks the specified dashboard for any existing visuals that match the question. If no matching visuals are found, <code>PredictQnA</code> uses generative Q&A to provide an answer. To update the <code>QSearchStatus</code>, see <a href=\"https://docs.aws.amazon.com/quicksight/latest/APIReference/API_UpdateQuickSightQSearchConfiguration.html\">UpdateQuickSightQSearchConfiguration</a>.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that the user wants to execute Predict QA results in.</p>
            query_text: <p>The query text to be used to predict QA results.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.predict_qa_results_request.PredictQAResultsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.predict_qa_results_response.PredictQAResultsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.predict_qa_results

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.predict_qa_results.async_predict_qa_results(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_data_set_refresh_properties(
        ...
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        data_set_id: "aws_sdk_quicksight.types.resource_id.ResourceId",
        data_set_refresh_properties: "aws_sdk_quicksight.types.data_set_refresh_properties.DataSetRefreshProperties",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.put_data_set_refresh_properties_response.PutDataSetRefreshPropertiesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.put_data_set_refresh_properties_request.PutDataSetRefreshPropertiesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.put_data_set_refresh_properties_response.PutDataSetRefreshPropertiesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.put_data_set_refresh_properties

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.put_data_set_refresh_properties.async_put_data_set_refresh_properties(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_user(
        ...
        user_role: "aws_sdk_quicksight.types.user_role.UserRole",
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        namespace: "aws_sdk_quicksight.types.namespace.Namespace",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        iam_arn: Optional["aws_sdk_quicksight.types.string.String"] = None,
        session_name: Optional[
            "aws_sdk_quicksight.types.role_session_name.RoleSessionName"
        ] = None,
        user_name: Optional["aws_sdk_quicksight.types.user_name.UserName"] = None,
        custom_permissions_name: Optional[
            "aws_sdk_quicksight.types.role_name.RoleName"
        ] = None,
        external_login_federation_provider_type: Optional[
            "aws_sdk_quicksight.types.string.String"
        ] = None,
        custom_federation_provider_url: Optional[
            "aws_sdk_quicksight.types.string.String"
        ] = None,
        external_login_id: Optional["aws_sdk_quicksight.types.string.String"] = None,
        tags: Optional["aws_sdk_quicksight.types.tag_list.TagList"] = None,
        ...
        Args:
            identity_type: <p>The identity type that your Quick Sight account uses to manage the identity of users.</p>
            email: <p>The email address of the user that you want to register.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.register_user_request.RegisterUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.register_user_response.RegisterUserResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.register_user

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.register_user.async_register_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def restore_analysis(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        restore_to_folders: Optional["aws_sdk_quicksight.types.boolean.Boolean"] = None,
    ) -> "aws_sdk_quicksight.types.restore_analysis_response.RestoreAnalysisResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.restore_analysis_request.RestoreAnalysisRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.restore_analysis_response.RestoreAnalysisResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.restore_analysis

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.restore_analysis.async_restore_analysis(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_action_connectors(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        max_results: Optional[
            "aws_sdk_quicksight.types.search_action_connectors_request_max_results_integer.SearchActionConnectorsRequestMaxResultsInteger"
        ] = None,
        next_token: Optional[str] = None,
    ) -> "aws_sdk_quicksight.types.search_action_connectors_response.SearchActionConnectorsResponse":
        ...
        Args:
            aws_account_id: <p>The Amazon Web Services account ID in which to search for action connectors.</p>
            max_results: <p>The maximum number of action connectors to return in a single response. Valid range is 1 to 100.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.search_action_connectors_request.SearchActionConnectorsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.search_action_connectors_response.SearchActionConnectorsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.search_action_connectors

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.search_action_connectors.async_search_action_connectors(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_search_action_connectors(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.search_action_connectors(
                aws_account_id,
                filters,
                config_overrides=config_overrides,
                max_results=max_results,
    ...
    async def search_agents(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "aws_sdk_quicksight.types.search_agents_response.SearchAgentsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.search_agents_request.SearchAgentsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.search_agents_response.SearchAgentsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.search_agents

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.search_agents.async_search_agents(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_analyses(
        self,
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        filters: "aws_sdk_quicksight.types.analysis_search_filter_list.AnalysisSearchFilterList",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.search_analyses_response.SearchAnalysesResponse":
        ...
        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the analyses that you're searching for.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.search_analyses_request.SearchAnalysesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.search_analyses_response.SearchAnalysesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.search_analyses

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.search_analyses.async_search_analyses(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_search_analyses(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.search_analyses(
                aws_account_id,
                filters,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    async def search_dashboards(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.search_dashboards_response.SearchDashboardsResponse":
        r"""<p>Searches for dashboards that belong to a user. </p> <note> <p>This operation is eventually consistent. The results are best effort and may not reflect very recent updates and changes.</p> </note>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the user whose dashboards you're searching for. </p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.search_dashboards_request.SearchDashboardsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.search_dashboards_response.SearchDashboardsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.search_dashboards

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.search_dashboards.async_search_dashboards(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_search_dashboards(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.search_dashboards(
                aws_account_id,
                filters,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    async def search_data_sets(
        self,
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        filters: "aws_sdk_quicksight.types.data_set_search_filter_list.DataSetSearchFilterList",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.search_data_sets_response.SearchDataSetsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.search_data_sets_request.SearchDataSetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.search_data_sets_response.SearchDataSetsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.search_data_sets

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.search_data_sets.async_search_data_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_search_data_sets(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.search_data_sets(
                aws_account_id,
                filters,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    async def search_data_sources(
        self,
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        filters: "aws_sdk_quicksight.types.data_source_search_filter_list.DataSourceSearchFilterList",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.search_data_sources_response.SearchDataSourcesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.search_data_sources_request.SearchDataSourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.search_data_sources_response.SearchDataSourcesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.search_data_sources

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.search_data_sources.async_search_data_sources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_search_data_sources(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_quicksight.types.data_source_summary.DataSourceSummary]"
    ):
        _token = next_token
        while True:
            _response = await self.search_data_sources(
                aws_account_id,
                filters,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    async def search_flows(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.search_flows_output.SearchFlowsOutput":
        """<p>Search for the flows in an Amazon Web Services account.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account where you are searching for flows from.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.search_flows_input.SearchFlowsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.search_flows_output.SearchFlowsOutput"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.search_flows

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.search_flows.async_search_flows(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_search_flows(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.search_flows(
                aws_account_id,
                filters,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    async def search_folders(
        self,
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        filters: "aws_sdk_quicksight.types.folder_search_filter_list.FolderSearchFilterList",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.search_folders_response.SearchFoldersResponse":
        r"""<p>Searches the subfolders in a folder.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.search_folders_request.SearchFoldersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.search_folders_response.SearchFoldersResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.search_folders

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.search_folders.async_search_folders(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_search_folders(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.search_folders(
                aws_account_id,
                filters,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    async def search_groups(
        ...
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        namespace: "aws_sdk_quicksight.types.namespace.Namespace",
        filters: "aws_sdk_quicksight.types.group_search_filter_list.GroupSearchFilterList",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.search_groups_response.SearchGroupsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.search_groups_request.SearchGroupsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.search_groups_response.SearchGroupsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.search_groups

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.search_groups.async_search_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_knowledge_bases(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.search_knowledge_bases_response.SearchKnowledgeBasesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.search_knowledge_bases_request.SearchKnowledgeBasesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.search_knowledge_bases_response.SearchKnowledgeBasesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.search_knowledge_bases

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.search_knowledge_bases.async_search_knowledge_bases(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_search_knowledge_bases(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.search_knowledge_bases(
                aws_account_id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def search_spaces(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.search_spaces_response.SearchSpacesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.search_spaces_request.SearchSpacesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.search_spaces_response.SearchSpacesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.search_spaces

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.search_spaces.async_search_spaces(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_topics(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_quicksight.types.search_topics_response.SearchTopicsResponse":
        """<p>Searches for any Q topic that exists in an Quick account.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the topic that you want to find.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.search_topics_request.SearchTopicsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.search_topics_response.SearchTopicsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.search_topics

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.search_topics.async_search_topics(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_search_topics(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_quicksight.types.string.String"] = None,
        max_results: Optional["aws_sdk_quicksight.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_quicksight.types.topic_summary.TopicSummary]":
        _token = next_token
        while True:
            _response = await self.search_topics(
                aws_account_id,
                filters,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    async def start_asset_bundle_export_job(
        ...
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        asset_bundle_export_job_id: "aws_sdk_quicksight.types.short_restrictive_resource_id.ShortRestrictiveResourceId",
        resource_arns: "aws_sdk_quicksight.types.asset_bundle_resource_arns.AssetBundleResourceArns",
        export_format: "aws_sdk_quicksight.types.asset_bundle_export_format.AssetBundleExportFormat",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        include_all_dependencies: Optional[
            "aws_sdk_quicksight.types.boolean.Boolean"
        ] = None,
        cloud_formation_override_property_configuration: Optional[
        ...
        include_tags: Optional["aws_sdk_quicksight.types.boolean.Boolean"] = None,
        validation_strategy: Optional[
            "aws_sdk_quicksight.types.asset_bundle_export_job_validation_strategy.AssetBundleExportJobValidationStrategy"
        ] = None,
        include_folder_memberships: Optional[
            "aws_sdk_quicksight.types.boolean.Boolean"
        ] = None,
        include_folder_members: Optional[
            "aws_sdk_quicksight.types.include_folder_members.IncludeFolderMembers"
        ] = None,
    ) -> "aws_sdk_quicksight.types.start_asset_bundle_export_job_response.StartAssetBundleExportJobResponse":
        """<p>Starts an Asset Bundle export job.</p> <p>An Asset Bundle export job exports specified Amazon Quick Sight assets. You can also choose to export any asset dependencies in the same job. Export jobs run asynchronously and can be polled with a <code>DescribeAssetBundleExportJob</code> API call. When a job is successfully completed, a download URL that contains the exported assets is returned. The URL is valid for 5 minutes and can be refreshed with a <code>DescribeAssetBundleExportJob</code> API call. Each Amazon Quick Sight account can run up to 5 export jobs concurrently.</p> <p>The API caller must have the necessary permissions in their IAM role to access each resource before the resources can be exported.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account to export assets from.</p>
            asset_bundle_export_job_id: <p>The ID of the job. This ID is unique while the job is running. After the job is completed, you can reuse this ID for another job.</p>
            resource_arns: <p>An array of resource ARNs to export. The following resources are supported.</p> <ul> <li> <p> <code>Analysis</code> </p> </li> <li> <p> <code>Dashboard</code> </p> </li> <li> <p> <code>DataSet</code> </p> </li> <li> <p> <code>DataSource</code> </p> </li> <li> <p> <code>RefreshSchedule</code> </p> </li> <li> <p> <code>Theme</code> </p> </li> <li> <p> <code>VPCConnection</code> </p> </li> </ul> <p>The API caller must have the necessary permissions in their IAM role to access each resource before the resources can be exported.</p>
            include_all_dependencies: <p>A Boolean that determines whether all dependencies of each resource ARN are recursively exported with the job. For example, say you provided a Dashboard ARN to the <code>ResourceArns</code> parameter. If you set <code>IncludeAllDependencies</code> to <code>TRUE</code>, any theme, dataset, and data source resource that is a dependency of the dashboard is also exported.</p>
            export_format: <p>The export data format.</p>
            ...
            include_permissions: <p>A Boolean that determines whether all permissions for each resource ARN are exported with the job. If you set <code>IncludePermissions</code> to <code>TRUE</code>, any permissions associated with each resource are exported. </p>
            include_tags: <p> A Boolean that determines whether all tags for each resource ARN are exported with the job. If you set <code>IncludeTags</code> to <code>TRUE</code>, any tags associated with each resource are exported.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.start_asset_bundle_export_job_request.StartAssetBundleExportJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.start_asset_bundle_export_job_response.StartAssetBundleExportJobResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.start_asset_bundle_export_job

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.start_asset_bundle_export_job.async_start_asset_bundle_export_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_asset_bundle_import_job(
        ...
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        asset_bundle_import_job_id: "aws_sdk_quicksight.types.short_restrictive_resource_id.ShortRestrictiveResourceId",
        asset_bundle_import_source: "aws_sdk_quicksight.types.asset_bundle_import_source.AssetBundleImportSource",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ...
    ) -> "aws_sdk_quicksight.types.start_asset_bundle_import_job_response.StartAssetBundleImportJobResponse":
        r"""<p>Starts an Asset Bundle import job.</p> <p>An Asset Bundle import job imports specified Amazon Quick Sight assets into an Amazon Quick Sight account. You can also choose to import a naming prefix and specified configuration overrides. The assets that are contained in the bundle file that you provide are used to create or update a new or existing asset in your Amazon Quick Sight account. Each Amazon Quick Sight account can run up to 5 import jobs concurrently.</p> <p>The API caller must have the necessary <code>\"create\"</code>, <code>\"describe\"</code>, and <code>\"update\"</code> permissions in their IAM role to access each resource type that is contained in the bundle file before the resources can be imported.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account to import assets into. </p>
            asset_bundle_import_job_id: <p>The ID of the job. This ID is unique while the job is running. After the job is completed, you can reuse this ID for another job.</p>
            asset_bundle_import_source: <p>The source of the asset bundle zip file that contains the data that you want to import. The file must be in <code>QUICKSIGHT_JSON</code> format. </p>
            override_parameters: <p>Optional overrides that are applied to the resource configuration before import.</p>
            failure_action: <p>The failure action for the import job.</p> <p>If you choose <code>ROLLBACK</code>, failed import jobs will attempt to undo any asset changes caused by the failed job.</p> <p>If you choose <code>DO_NOTHING</code>, failed import jobs will not attempt to roll back any asset changes caused by the failed job, possibly keeping the Amazon Quick Sight account in an inconsistent state.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.start_asset_bundle_import_job_request.StartAssetBundleImportJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.start_asset_bundle_import_job_response.StartAssetBundleImportJobResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.start_asset_bundle_import_job

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.start_asset_bundle_import_job.async_start_asset_bundle_import_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_automation_job(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.start_automation_job_response.StartAutomationJobResponse":
        """<p>Starts a new job for a specified automation. The job runs the automation with the provided input payload.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the automation.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.start_automation_job_request.StartAutomationJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.start_automation_job_response.StartAutomationJobResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.start_automation_job

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.start_automation_job.async_start_automation_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_dashboard_snapshot_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.start_dashboard_snapshot_job_request.StartDashboardSnapshotJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.start_dashboard_snapshot_job_response.StartDashboardSnapshotJobResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.start_dashboard_snapshot_job

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.start_dashboard_snapshot_job.async_start_dashboard_snapshot_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_dashboard_snapshot_job_schedule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.start_dashboard_snapshot_job_schedule_request.StartDashboardSnapshotJobScheduleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.start_dashboard_snapshot_job_schedule_response.StartDashboardSnapshotJobScheduleResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.start_dashboard_snapshot_job_schedule

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.start_dashboard_snapshot_job_schedule.async_start_dashboard_snapshot_job_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.tag_resource_response.TagResourceResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.tag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.untag_resource_response.UntagResourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.untag_resource_response.UntagResourceResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.untag_resource

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_account_customization(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        namespace: Optional["aws_sdk_quicksight.types.namespace.Namespace"] = None,
    ) -> "aws_sdk_quicksight.types.update_account_customization_response.UpdateAccountCustomizationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_account_customization_request.UpdateAccountCustomizationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_account_customization_response.UpdateAccountCustomizationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_account_customization

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_account_customization.async_update_account_customization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_account_custom_permission(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_account_custom_permission_response.UpdateAccountCustomPermissionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_account_custom_permission_request.UpdateAccountCustomPermissionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_account_custom_permission_response.UpdateAccountCustomPermissionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_account_custom_permission

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_account_custom_permission.async_update_account_custom_permission(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_account_settings(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        notification_email: Optional["aws_sdk_quicksight.types.string.String"] = None,
        termination_protection_enabled: Optional[
            "aws_sdk_quicksight.types.boolean.Boolean"
        ] = None,
    ) -> "aws_sdk_quicksight.types.update_account_settings_response.UpdateAccountSettingsResponse":
        """<p>Updates the Amazon Quick Sight settings in your Amazon Web Services account.</p>

        Args:
            aws_account_id: <p>The ID for the Amazon Web Services account that contains the Quick Sight settings that you want to list.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_account_settings_request.UpdateAccountSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_account_settings_response.UpdateAccountSettingsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_account_settings

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_account_settings.async_update_account_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_action_connector(
        ...
        *,
        ...
        vpc_connection_arn: Optional["aws_sdk_quicksight.types.arn.Arn"] = None,
    ) -> "aws_sdk_quicksight.types.update_action_connector_response.UpdateActionConnectorResponse":
        r"""<p>Updates an existing action connector with new configuration details, authentication settings, or enabled actions. You can modify the connector's name, description, authentication configuration, and which actions are enabled. For more information, <a href=\"https://docs.aws.amazon.com/quicksuite/latest/userguide/quick-action-auth.html\">https://docs.aws.amazon.com/quicksuite/latest/userguide/quick-action-auth.html</a>.</p>

        Args:
            aws_account_id: <p>The Amazon Web Services account ID that contains the action connector to update.</p>
            action_connector_id: <p>The unique identifier of the action connector to update.</p>
            name: <p>The new name for the action connector.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_action_connector_request.UpdateActionConnectorRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_action_connector_response.UpdateActionConnectorResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_action_connector

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_action_connector.async_update_action_connector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_action_connector_permissions(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_action_connector_permissions_response.UpdateActionConnectorPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_action_connector_permissions_request.UpdateActionConnectorPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_action_connector_permissions_response.UpdateActionConnectorPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_action_connector_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_action_connector_permissions.async_update_action_connector_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_agent(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_agent_response.UpdateAgentResponse":
        """<p>Updates an existing agent.</p>

        Args:
            agent_id: <p>The unique identifier for the agent to update.</p>
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the agent.</p>
            name: <p>The name of the agent.</p>
            description: <p>A description of the agent.</p>
            icon_id: <p>The icon identifier for the agent.</p>
            ...
            welcome_message: <p>The welcome message that is displayed when a user starts a conversation with the agent.</p>
            custom_prompt_input: <p>The custom prompt configuration for the agent.</p>
            spaces_to_add: <p>The Amazon Resource Names (ARNs) of the spaces to attach to the agent.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_agent_request.UpdateAgentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_agent_response.UpdateAgentResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_agent

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_agent.async_update_agent(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_agent_permissions(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_agent_permissions_response.UpdateAgentPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_agent_permissions_request.UpdateAgentPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_agent_permissions_response.UpdateAgentPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_agent_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_agent_permissions.async_update_agent_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_analysis(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_analysis_response.UpdateAnalysisResponse":
        """<p>Updates an analysis in Amazon Quick Sight</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the analysis that you're updating.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_analysis_request.UpdateAnalysisRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_analysis_response.UpdateAnalysisResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_analysis

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_analysis.async_update_analysis(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_analysis_permissions(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_analysis_permissions_response.UpdateAnalysisPermissionsResponse":
        """<p>Updates the read and write permissions for an analysis.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the analysis whose permissions you're updating. You must be using the Amazon Web Services account that the analysis is in.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_analysis_permissions_request.UpdateAnalysisPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_analysis_permissions_response.UpdateAnalysisPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_analysis_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_analysis_permissions.async_update_analysis_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_application_with_token_exchange_grant(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_application_with_token_exchange_grant_response.UpdateApplicationWithTokenExchangeGrantResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_application_with_token_exchange_grant_request.UpdateApplicationWithTokenExchangeGrantRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_application_with_token_exchange_grant_response.UpdateApplicationWithTokenExchangeGrantResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_application_with_token_exchange_grant

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_application_with_token_exchange_grant.async_update_application_with_token_exchange_grant(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_brand(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_brand_response.UpdateBrandResponse":
        """<p>Updates a brand.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_brand_request.UpdateBrandRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_brand_response.UpdateBrandResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_brand

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_brand.async_update_brand(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_brand_assignment(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_brand_assignment_response.UpdateBrandAssignmentResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_brand_assignment_request.UpdateBrandAssignmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_brand_assignment_response.UpdateBrandAssignmentResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_brand_assignment

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_brand_assignment.async_update_brand_assignment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_brand_published_version(
        ...
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        brand_id: "aws_sdk_quicksight.types.short_restrictive_resource_id.ShortRestrictiveResourceId",
        version_id: "aws_sdk_quicksight.types.short_restrictive_resource_id.ShortRestrictiveResourceId",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_brand_published_version_response.UpdateBrandPublishedVersionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_brand_published_version_request.UpdateBrandPublishedVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_brand_published_version_response.UpdateBrandPublishedVersionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_brand_published_version

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_brand_published_version.async_update_brand_published_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_custom_permissions(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_custom_permissions_response.UpdateCustomPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_custom_permissions_request.UpdateCustomPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_custom_permissions_response.UpdateCustomPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_custom_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_custom_permissions.async_update_custom_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_dashboard(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_dashboard_response.UpdateDashboardResponse":
        r"""<p>Updates a dashboard in an Amazon Web Services account.</p> <note> <p>Updating a Dashboard creates a new dashboard version but does not immediately publish the new version. You can update the published version of a dashboard by using the <code> <a href=\"https://docs.aws.amazon.com/quicksight/latest/APIReference/API_UpdateDashboardPublishedVersion.html\">UpdateDashboardPublishedVersion</a> </code> API operation.</p> </note>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_dashboard_request.UpdateDashboardRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_dashboard_response.UpdateDashboardResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_dashboard

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_dashboard.async_update_dashboard(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_dashboard_links(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_dashboard_links_response.UpdateDashboardLinksResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_dashboard_links_request.UpdateDashboardLinksRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_dashboard_links_response.UpdateDashboardLinksResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_dashboard_links

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_dashboard_links.async_update_dashboard_links(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_dashboard_permissions(
        ...
        *,
        ...
        grant_link_permissions: Optional[
            "aws_sdk_quicksight.types.update_link_permission_list.UpdateLinkPermissionList"
        ] = None,
        revoke_link_permissions: Optional[
            "aws_sdk_quicksight.types.update_link_permission_list.UpdateLinkPermissionList"
        ] = None,
    ) -> "aws_sdk_quicksight.types.update_dashboard_permissions_response.UpdateDashboardPermissionsResponse":
        """<p>Updates read and write permissions on a dashboard.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the dashboard whose permissions you're updating.</p>
            dashboard_id: <p>The ID for the dashboard.</p>
            grant_permissions: <p>The permissions that you want to grant on this resource.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_dashboard_permissions_request.UpdateDashboardPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_dashboard_permissions_response.UpdateDashboardPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_dashboard_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_dashboard_permissions.async_update_dashboard_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_dashboard_published_version(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_dashboard_published_version_response.UpdateDashboardPublishedVersionResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_dashboard_published_version_request.UpdateDashboardPublishedVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_dashboard_published_version_response.UpdateDashboardPublishedVersionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_dashboard_published_version

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_dashboard_published_version.async_update_dashboard_published_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_dashboards_qa_configuration(
        self,
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        dashboards_qa_status: "aws_sdk_quicksight.types.dashboards_qa_status.DashboardsQAStatus",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_dashboards_qa_configuration_response.UpdateDashboardsQAConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_dashboards_qa_configuration_request.UpdateDashboardsQAConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_dashboards_qa_configuration_response.UpdateDashboardsQAConfigurationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_dashboards_qa_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_dashboards_qa_configuration.async_update_dashboards_qa_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_data_set(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_data_set_response.UpdateDataSetResponse":
        ...
        Args:
            aws_account_id: <p>The Amazon Web Services account ID.</p>
            data_set_id: <p>The ID for the dataset that you want to update. This ID is unique per Amazon Web Services Region for each Amazon Web Services account.</p>
            name: <p>The display name for the dataset.</p>
            physical_table_map: <p>Declares the physical tables that are available in the underlying data sources.</p>
            logical_table_map: <p>Configures the combination and transformation of the data from the physical tables. This parameter is used with the legacy data preparation experience.</p>
            import_mode: <p>Indicates whether you want to import the data into SPICE.</p>
            column_groups: <p>Groupings of columns that work together in certain Amazon Quick Sight features. Currently, only geospatial hierarchy is supported.</p>
            field_folders: <p>The folder that contains fields and nested subfolders for your dataset.</p>
            row_level_permission_data_set: <p>The row-level security configuration for the data you want to create. This parameter is used with the legacy data preparation experience.</p>
            row_level_permission_tag_configuration: <p>The configuration of tags on a dataset to set row-level security. Row-level security tags are currently supported for anonymous embedding only. This parameter is used with the legacy data preparation experience.</p>
            column_level_permission_rules: <p>A set of one or more definitions of a <code> <a href=\"https://docs.aws.amazon.com/quicksight/latest/APIReference/API_ColumnLevelPermissionRule.html\">ColumnLevelPermissionRule</a> </code>.</p>
            dataset_parameters: <p>The parameter declarations of the dataset.</p>
            performance_configuration: <p>The configuration for the performance optimization of the dataset that contains a <code>UniqueKey</code> configuration.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_data_set_request.UpdateDataSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_data_set_response.UpdateDataSetResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_data_set

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_data_set.async_update_data_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_data_set_permissions(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_data_set_permissions_response.UpdateDataSetPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_data_set_permissions_request.UpdateDataSetPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_data_set_permissions_response.UpdateDataSetPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_data_set_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_data_set_permissions.async_update_data_set_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_data_source(
        ...
        *,
        ...
        "aws_sdk_quicksight.types.update_data_source_response.UpdateDataSourceResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_data_source_request.UpdateDataSourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_data_source_response.UpdateDataSourceResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_data_source

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_data_source.async_update_data_source(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_data_source_permissions(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_data_source_permissions_response.UpdateDataSourcePermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_data_source_permissions_request.UpdateDataSourcePermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_data_source_permissions_response.UpdateDataSourcePermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_data_source_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_data_source_permissions.async_update_data_source_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_default_q_business_application(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        namespace: Optional["aws_sdk_quicksight.types.namespace.Namespace"] = None,
    ) -> "aws_sdk_quicksight.types.update_default_q_business_application_response.UpdateDefaultQBusinessApplicationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_default_q_business_application_request.UpdateDefaultQBusinessApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_default_q_business_application_response.UpdateDefaultQBusinessApplicationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_default_q_business_application

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_default_q_business_application.async_update_default_q_business_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_flow(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        name: Optional["aws_sdk_quicksight.types.title_input.TitleInput"] = None,
        description: Optional[
            "aws_sdk_quicksight.types.flow_description_input.FlowDescriptionInput"
        ] = None,
    ...
    ) -> "aws_sdk_quicksight.types.update_flow_response.UpdateFlowResponse":
        ...
        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the flow that you are updating.</p>
            flow_id: <p>The unique identifier of the flow to update.</p>
            name: <p>Updated display name for the flow. Omit to preserve the existing name.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_flow_request.UpdateFlowRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_flow_response.UpdateFlowResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_flow

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_flow.async_update_flow(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_flow_permissions(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_flow_permissions_output.UpdateFlowPermissionsOutput":
        """<p>Updates permissions against principals on a flow.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the flow you are updating permissions against.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_flow_permissions_input.UpdateFlowPermissionsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_flow_permissions_output.UpdateFlowPermissionsOutput"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_flow_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_flow_permissions.async_update_flow_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_folder(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_folder_response.UpdateFolderResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_folder_request.UpdateFolderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_folder_response.UpdateFolderResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_folder

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_folder.async_update_folder(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_folder_permissions(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_folder_permissions_response.UpdateFolderPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_folder_permissions_request.UpdateFolderPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_folder_permissions_response.UpdateFolderPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_folder_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_folder_permissions.async_update_folder_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_group(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_group_response.UpdateGroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_group_request.UpdateGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_group_response.UpdateGroupResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_group

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_group.async_update_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_iam_policy_assignment(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_iam_policy_assignment_response.UpdateIAMPolicyAssignmentResponse":
        ...
        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the IAM policy assignment. </p>
            assignment_name: <p>The name of the assignment, also called a rule. The name must be unique within the Amazon Web Services account.</p>
            namespace: <p>The namespace of the assignment.</p>
            assignment_status: <p>The status of the assignment. Possible values are as follows:</p> <ul> <li> <p> <code>ENABLED</code> - Anything specified in this assignment is used when creating the data source.</p> </li> <li> <p> <code>DISABLED</code> - This assignment isn't used when creating the data source.</p> </li> <li> <p> <code>DRAFT</code> - This assignment is an unfinished draft and isn't used when creating the data source.</p> </li> </ul>
            policy_arn: <p>The ARN for the IAM policy to apply to the Amazon Quick Sight users and groups specified in this assignment.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_iam_policy_assignment_request.UpdateIAMPolicyAssignmentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_iam_policy_assignment_response.UpdateIAMPolicyAssignmentResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_iam_policy_assignment

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_iam_policy_assignment.async_update_iam_policy_assignment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_identity_propagation_config(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_identity_propagation_config_response.UpdateIdentityPropagationConfigResponse":
        """<p>Adds or updates services and authorized targets to configure what the Quick Sight IAM Identity Center application can access.</p> <p>This operation is only supported for Quick Sight accounts using IAM Identity Center</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_identity_propagation_config_request.UpdateIdentityPropagationConfigRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_identity_propagation_config_response.UpdateIdentityPropagationConfigResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_identity_propagation_config

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_identity_propagation_config.async_update_identity_propagation_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_ip_restriction(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_ip_restriction_response.UpdateIpRestrictionResponse":
        ...
        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the IP rules.</p>
            ip_restriction_rule_map: <p>A map that describes the updated IP rules with CIDR ranges and descriptions.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_ip_restriction_request.UpdateIpRestrictionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_ip_restriction_response.UpdateIpRestrictionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_ip_restriction

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_ip_restriction.async_update_ip_restriction(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_key_registration(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_key_registration_response.UpdateKeyRegistrationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_key_registration_request.UpdateKeyRegistrationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_key_registration_response.UpdateKeyRegistrationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_key_registration

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_key_registration.async_update_key_registration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_knowledge_base_permissions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_knowledge_base_permissions_request.UpdateKnowledgeBasePermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_knowledge_base_permissions_response.UpdateKnowledgeBasePermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_knowledge_base_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_knowledge_base_permissions.async_update_knowledge_base_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_o_auth_client_application(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        client_id: Optional[
            "aws_sdk_quicksight.types.o_auth_client_id.OAuthClientId"
        ] = None,
        client_secret: Optional[
            "aws_sdk_quicksight.types.o_auth_client_secret.OAuthClientSecret"
        ] = None,
        o_auth_token_endpoint_url: Optional[
    ...
    ) -> "aws_sdk_quicksight.types.update_o_auth_client_application_response.UpdateOAuthClientApplicationResponse":
        """<p>Updates an OAuthClientApplication.</p>

        Args:
            aws_account_id: <p>The Amazon Web Services account ID.</p>
            o_auth_client_application_id: <p>The ID of the OAuthClientApplication that you want to update.</p>
            name: <p>The display name for the OAuthClientApplication.</p>
            client_id: <p>The client ID of the OAuth application that is registered with the identity provider.</p>
            client_secret: <p>The client secret of the OAuth application that is registered with the identity provider.</p>
            o_auth_token_endpoint_url: <p>The token endpoint URL of the identity provider that is used to obtain access tokens.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_o_auth_client_application_request.UpdateOAuthClientApplicationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_o_auth_client_application_response.UpdateOAuthClientApplicationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_o_auth_client_application

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_o_auth_client_application.async_update_o_auth_client_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_public_sharing_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_public_sharing_settings_request.UpdatePublicSharingSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_public_sharing_settings_response.UpdatePublicSharingSettingsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_public_sharing_settings

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_public_sharing_settings.async_update_public_sharing_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_q_personalization_configuration(
        self,
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        personalization_mode: "aws_sdk_quicksight.types.personalization_mode.PersonalizationMode",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_q_personalization_configuration_response.UpdateQPersonalizationConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_q_personalization_configuration_request.UpdateQPersonalizationConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_q_personalization_configuration_response.UpdateQPersonalizationConfigurationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_q_personalization_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_q_personalization_configuration.async_update_q_personalization_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_quick_sight_q_search_configuration(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_quick_sight_q_search_configuration_response.UpdateQuickSightQSearchConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_quick_sight_q_search_configuration_request.UpdateQuickSightQSearchConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_quick_sight_q_search_configuration_response.UpdateQuickSightQSearchConfigurationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_quick_sight_q_search_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_quick_sight_q_search_configuration.async_update_quick_sight_q_search_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_refresh_schedule(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_refresh_schedule_response.UpdateRefreshScheduleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_refresh_schedule_request.UpdateRefreshScheduleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_refresh_schedule_response.UpdateRefreshScheduleResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_refresh_schedule

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_refresh_schedule.async_update_refresh_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_role_custom_permission(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_role_custom_permission_response.UpdateRoleCustomPermissionResponse":
        """<p>Updates the custom permissions that are associated with a role.</p>

        Args:
            custom_permissions_name: <p>The name of the custom permission that you want to update the role with.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_role_custom_permission_request.UpdateRoleCustomPermissionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_role_custom_permission_response.UpdateRoleCustomPermissionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_role_custom_permission

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_role_custom_permission.async_update_role_custom_permission(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_self_upgrade(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_self_upgrade_response.UpdateSelfUpgradeResponse":
        """<p>Updates a self-upgrade request for a Quick user by approving, denying, or verifying the request.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the self-upgrade request.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_self_upgrade_request.UpdateSelfUpgradeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_self_upgrade_response.UpdateSelfUpgradeResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_self_upgrade

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_self_upgrade.async_update_self_upgrade(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_self_upgrade_configuration(
        ...
        aws_account_id: "aws_sdk_quicksight.types.aws_account_id.AwsAccountId",
        namespace: "aws_sdk_quicksight.types.namespace.Namespace",
        self_upgrade_status: "aws_sdk_quicksight.types.self_upgrade_status.SelfUpgradeStatus",
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_self_upgrade_configuration_response.UpdateSelfUpgradeConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_self_upgrade_configuration_request.UpdateSelfUpgradeConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_self_upgrade_configuration_response.UpdateSelfUpgradeConfigurationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_self_upgrade_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_self_upgrade_configuration.async_update_self_upgrade_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_space(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        name: Optional["aws_sdk_quicksight.types.space_name.SpaceName"] = None,
        description: Optional[
            "aws_sdk_quicksight.types.space_description.SpaceDescription"
        ] = None,
    ) -> "aws_sdk_quicksight.types.update_space_response.UpdateSpaceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_space_request.UpdateSpaceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_space_response.UpdateSpaceResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_space

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_space.async_update_space(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_space_permissions(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_space_permissions_response.UpdateSpacePermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_space_permissions_request.UpdateSpacePermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_space_permissions_response.UpdateSpacePermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_space_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_space_permissions.async_update_space_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_space_resources(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_space_resources_response.UpdateSpaceResourcesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_space_resources_request.UpdateSpaceResourcesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_space_resources_response.UpdateSpaceResourcesResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_space_resources

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_space_resources.async_update_space_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_spice_capacity_configuration(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_spice_capacity_configuration_response.UpdateSPICECapacityConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_spice_capacity_configuration_request.UpdateSPICECapacityConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_spice_capacity_configuration_response.UpdateSPICECapacityConfigurationResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_spice_capacity_configuration

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_spice_capacity_configuration.async_update_spice_capacity_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_template(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_template_response.UpdateTemplateResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_template_request.UpdateTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_template_response.UpdateTemplateResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_template

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_template.async_update_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_template_alias(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_template_alias_response.UpdateTemplateAliasResponse":
        """<p>Updates the template alias of a template.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the template alias that you're updating.</p>
            template_id: <p>The ID for the template.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_template_alias_request.UpdateTemplateAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_template_alias_response.UpdateTemplateAliasResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_template_alias

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_template_alias.async_update_template_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_template_permissions(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_template_permissions_response.UpdateTemplatePermissionsResponse":
        """<p>Updates the resource permissions for a template.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the template.</p>
            template_id: <p>The ID for the template.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_template_permissions_request.UpdateTemplatePermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_template_permissions_response.UpdateTemplatePermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_template_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_template_permissions.async_update_template_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_theme(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
        name: Optional["aws_sdk_quicksight.types.theme_name.ThemeName"] = None,
        version_description: Optional[
            "aws_sdk_quicksight.types.version_description.VersionDescription"
        ] = None,
    ...
    ) -> "aws_sdk_quicksight.types.update_theme_response.UpdateThemeResponse":
        """<p>Updates a theme.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the theme that you're updating.</p>
            theme_id: <p>The ID for the theme.</p>
            name: <p>The name for the theme.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_theme_request.UpdateThemeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_theme_response.UpdateThemeResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_theme

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_theme.async_update_theme(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_theme_alias(
        ...
        *,
        ...
        "aws_sdk_quicksight.types.update_theme_alias_response.UpdateThemeAliasResponse"
    ):
        """<p>Updates an alias of a theme.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the theme alias that you're updating.</p>
            theme_id: <p>The ID for the theme.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_theme_alias_request.UpdateThemeAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_theme_alias_response.UpdateThemeAliasResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_theme_alias

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_theme_alias.async_update_theme_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_theme_permissions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_theme_permissions_request.UpdateThemePermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_theme_permissions_response.UpdateThemePermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_theme_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_theme_permissions.async_update_theme_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_topic(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_topic_response.UpdateTopicResponse":
        """<p>Updates a topic.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_topic_request.UpdateTopicRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_topic_response.UpdateTopicResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_topic

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_topic.async_update_topic(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_topic_permissions(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_topic_permissions_response.UpdateTopicPermissionsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_topic_permissions_request.UpdateTopicPermissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_topic_permissions_response.UpdateTopicPermissionsResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_topic_permissions

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_topic_permissions.async_update_topic_permissions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_topic_refresh_schedule(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_topic_refresh_schedule_response.UpdateTopicRefreshScheduleResponse":
        """<p>Updates a topic refresh schedule.</p>

        Args:
            aws_account_id: <p>The ID of the Amazon Web Services account that contains the topic whose refresh schedule you want to update.</p>
            topic_id: <p>The ID of the topic that you want to modify. This ID is unique per Amazon Web Services Region for each Amazon Web Services account.</p>
            dataset_id: <p>The ID of the dataset.</p>
            refresh_schedule: <p>The definition of a refresh schedule.</p>
        """
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_topic_refresh_schedule_request.UpdateTopicRefreshScheduleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_topic_refresh_schedule_response.UpdateTopicRefreshScheduleResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_topic_refresh_schedule

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_topic_refresh_schedule.async_update_topic_refresh_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_user(
        ...
        *,
        ...
        unapply_custom_permissions: Optional[
            "aws_sdk_quicksight.types.boolean.Boolean"
        ] = None,
        external_login_federation_provider_type: Optional[
            "aws_sdk_quicksight.types.string.String"
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_user_request.UpdateUserRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_user_response.UpdateUserResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_user

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_user.async_update_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_user_custom_permission(
        ...
        *,
        config_overrides: Optional[AsyncQuickSightClientConfig] = None,
    ) -> "aws_sdk_quicksight.types.update_user_custom_permission_response.UpdateUserCustomPermissionResponse":
        """<p>Updates a custom permissions profile for a user.</p>

        Args:
            user_name: <p>The username of the user that you want to update custom permissions for.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_user_custom_permission_request.UpdateUserCustomPermissionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_user_custom_permission_response.UpdateUserCustomPermissionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_user_custom_permission

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_user_custom_permission.async_update_user_custom_permission(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_vpc_connection(
        ...
        *,
    ...
    ) -> "aws_sdk_quicksight.types.update_vpc_connection_response.UpdateVPCConnectionResponse":
        """<p>Updates a VPC connection.</p>

        Args:
            aws_account_id: <p>The Amazon Web Services account ID of the account that contains the VPC connection that you want to update.</p>
            vpc_connection_id: <p>The ID of the VPC connection that you're updating. This ID is a unique identifier for each Amazon Web Services Region in an Amazon Web Services account.</p>
            name: <p>The display name for the VPC connection.</p>
            subnet_ids: <p>A list of subnet IDs for the VPC connection.</p>
            security_group_ids: <p>A list of security group IDs for the VPC connection.</p>
            dns_resolvers: <p>A list of IP addresses of DNS resolver endpoints for the VPC connection.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_quicksight.types.update_vpc_connection_request.UpdateVPCConnectionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_quicksight.types.update_vpc_connection_response.UpdateVPCConnectionResponse"
        ]:
            import aws_sdk_quicksight._operations.quick_sight_20180401.update_vpc_connection

            (
                output,
                http_response,
            ) = await aws_sdk_quicksight._operations.quick_sight_20180401.update_vpc_connection.async_update_vpc_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
