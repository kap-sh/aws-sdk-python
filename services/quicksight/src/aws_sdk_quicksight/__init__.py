...
from ._services.async_quick_sight import AsyncQuickSightClient as AsyncQuickSightClient
from ._services.quick_sight import QuickSightClient as QuickSightClient
