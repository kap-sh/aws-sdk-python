...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.brand_version_status
    import aws_sdk_quicksight.types.error_list
    import aws_sdk_quicksight.types.logo
...
class BrandDetail(TypedDict, closed=True):
    ...
    version_status: NotRequired[
        "aws_sdk_quicksight.types.brand_version_status.BrandVersionStatus"
    ]
    """<p>The status of the version.</p>"""
    errors: NotRequired["aws_sdk_quicksight.types.error_list.ErrorList"]
    """<p>A list of errors that occurred during the most recent brand operation.</p>"""
    logo: NotRequired["aws_sdk_quicksight.types.logo.Logo"]
...
def serialize_json(value: BrandDetail) -> dict:
    ...
    if "version_status" in value:
        ...
        out["VersionStatus"] = (
            aws_sdk_quicksight.types.brand_version_status.serialize_json(
    ...
    if "errors" in value:
        ...
        out["Errors"] = aws_sdk_quicksight.types.error_list.serialize_json(
            value["errors"]
        )
    if "logo" in value:
        import aws_sdk_quicksight.types.logo

        out["Logo"] = aws_sdk_quicksight.types.logo.serialize_json(value["logo"])
    return out
...
def deserialize_json(data: dict) -> BrandDetail:
    ...
    if "VersionStatus" in data:
        ...
        out["version_status"] = (
            aws_sdk_quicksight.types.brand_version_status.deserialize_json(
                data["VersionStatus"]
            )
        )
    if "Errors" in data:
        ...
        out["errors"] = aws_sdk_quicksight.types.error_list.deserialize_json(
            data["Errors"]
        )
    if "Logo" in data:
        import aws_sdk_quicksight.types.logo

        out["logo"] = aws_sdk_quicksight.types.logo.deserialize_json(data["Logo"])
    return out
