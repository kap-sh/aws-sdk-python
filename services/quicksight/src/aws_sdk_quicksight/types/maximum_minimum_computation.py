...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.maximum_minimum_computation_type
    import aws_sdk_quicksight.types.measure_field
    import aws_sdk_quicksight.types.short_restrictive_resource_id
    import aws_sdk_quicksight.types.string


class MaximumMinimumComputation(TypedDict):
    ...
    type: "aws_sdk_quicksight.types.maximum_minimum_computation_type.MaximumMinimumComputationType"
...
def serialize_json(value: MaximumMinimumComputation) -> dict:
    ...
    out["Type"] = (
        aws_sdk_quicksight.types.maximum_minimum_computation_type.serialize_json(
            value["type"]
        )
    )
    return out
...
def deserialize_json(data: dict) -> MaximumMinimumComputation:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_quicksight.types.maximum_minimum_computation_type.deserialize_json(
                data["Type"]
            )
        )
    else:
