...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.dashboard_filter_attribute
    import aws_sdk_quicksight.types.filter_operator
    import aws_sdk_quicksight.types.string


class DashboardSearchFilter(TypedDict):
    ...
    name: NotRequired[
        "aws_sdk_quicksight.types.dashboard_filter_attribute.DashboardFilterAttribute"
    ]
...
def serialize_json(value: DashboardSearchFilter) -> dict:
    ...
    if "name" in value:
        ...
        out["Name"] = (
            aws_sdk_quicksight.types.dashboard_filter_attribute.serialize_json(
                value["name"]
            )
        )
    if "value" in value:
...
def deserialize_json(data: dict) -> DashboardSearchFilter:
    ...
    if "Name" in data:
        ...
        out["name"] = (
            aws_sdk_quicksight.types.dashboard_filter_attribute.deserialize_json(
                data["Name"]
            )
        )
    if "Value" in data:
