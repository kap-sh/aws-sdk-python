...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.percentile_aggregation
    import aws_sdk_quicksight.types.simple_numerical_aggregation_function


class NumericalAggregationFunction(TypedDict):
    simple_numerical_aggregation: NotRequired[
        "aws_sdk_quicksight.types.simple_numerical_aggregation_function.SimpleNumericalAggregationFunction"
    ]
    ...
    percentile_aggregation: NotRequired[
        "aws_sdk_quicksight.types.percentile_aggregation.PercentileAggregation"
    ]
...
def serialize_json(value: NumericalAggregationFunction) -> dict:
    ...
    if "simple_numerical_aggregation" in value:
        ...
        out["SimpleNumericalAggregation"] = (
            aws_sdk_quicksight.types.simple_numerical_aggregation_function.serialize_json(
    ...
    if "percentile_aggregation" in value:
        ...
        out["PercentileAggregation"] = (
            aws_sdk_quicksight.types.percentile_aggregation.serialize_json(
...
def deserialize_json(data: dict) -> NumericalAggregationFunction:
    ...
    if "SimpleNumericalAggregation" in data:
        ...
        out["simple_numerical_aggregation"] = (
            aws_sdk_quicksight.types.simple_numerical_aggregation_function.deserialize_json(
    ...
    if "PercentileAggregation" in data:
        ...
        out["percentile_aggregation"] = (
            aws_sdk_quicksight.types.percentile_aggregation.deserialize_json(
