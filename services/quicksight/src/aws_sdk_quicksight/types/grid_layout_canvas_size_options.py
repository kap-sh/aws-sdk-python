...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.grid_layout_screen_canvas_size_options


class GridLayoutCanvasSizeOptions(TypedDict):
    screen_canvas_size_options: NotRequired[
        "aws_sdk_quicksight.types.grid_layout_screen_canvas_size_options.GridLayoutScreenCanvasSizeOptions"
    ]
...
def serialize_json(value: GridLayoutCanvasSizeOptions) -> dict:
    ...
    if "screen_canvas_size_options" in value:
        ...
        out["ScreenCanvasSizeOptions"] = (
            aws_sdk_quicksight.types.grid_layout_screen_canvas_size_options.serialize_json(
...
def deserialize_json(data: dict) -> GridLayoutCanvasSizeOptions:
    ...
    if "ScreenCanvasSizeOptions" in data:
        ...
        out["screen_canvas_size_options"] = (
            aws_sdk_quicksight.types.grid_layout_screen_canvas_size_options.deserialize_json(
