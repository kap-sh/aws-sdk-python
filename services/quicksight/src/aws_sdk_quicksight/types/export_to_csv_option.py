"""Generated from Smithy shape ``com.amazonaws.quicksight#ExportToCSVOption``."""
...
class ExportToCSVOption(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ExportToCSVOption) -> dict:
    out: dict = {}
