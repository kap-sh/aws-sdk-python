...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.insight_configuration
...
class InsightVisual(TypedDict):
    ...
    insight_configuration: NotRequired[
        "aws_sdk_quicksight.types.insight_configuration.InsightConfiguration"
    ]
...
def serialize_json(value: InsightVisual) -> dict:
    ...
    if "insight_configuration" in value:
        ...
        out["InsightConfiguration"] = (
            aws_sdk_quicksight.types.insight_configuration.serialize_json(
...
def deserialize_json(data: dict) -> InsightVisual:
    ...
    if "InsightConfiguration" in data:
        ...
        out["insight_configuration"] = (
            aws_sdk_quicksight.types.insight_configuration.deserialize_json(
