...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.data_set_name


class AwsIotAnalyticsParameters(TypedDict):
    data_set_name: "aws_sdk_quicksight.types.data_set_name.DataSetName"
    """<p>Dataset name.</p>"""
