"""Generated from Smithy shape ``com.amazonaws.quicksight#ListThemeAliasesRequest``."""
...
class ListThemeAliasesRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListThemeAliasesRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListThemeAliasesRequest:
    out: ListThemeAliasesRequest = {}  # type: ignore[typeddict-item]
    return out
