...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.axis_data_options
    import aws_sdk_quicksight.types.axis_tick_label_options
    import aws_sdk_quicksight.types.pixel_length
    import aws_sdk_quicksight.types.scroll_bar_options
    import aws_sdk_quicksight.types.visibility


class AxisDisplayOptions(TypedDict):
    tick_label_options: NotRequired[
        "aws_sdk_quicksight.types.axis_tick_label_options.AxisTickLabelOptions"
    ]
    """<p>The tick label options of an axis.</p>"""
    axis_line_visibility: NotRequired["aws_sdk_quicksight.types.visibility.Visibility"]
    """<p>Determines whether or not the axis line is visible.</p>"""
    grid_line_visibility: NotRequired["aws_sdk_quicksight.types.visibility.Visibility"]
    """<p>Determines whether or not the grid line is visible.</p>"""
    data_options: NotRequired[
        "aws_sdk_quicksight.types.axis_data_options.AxisDataOptions"
    ]
    """<p>The data options for an axis.</p>"""
    scrollbar_options: NotRequired[
        "aws_sdk_quicksight.types.scroll_bar_options.ScrollBarOptions"
    ]
    """<p>The scroll bar options for an axis.</p>"""
    axis_offset: NotRequired["aws_sdk_quicksight.types.pixel_length.PixelLength"]
...
def serialize_json(value: AxisDisplayOptions) -> dict:
    ...
    if "tick_label_options" in value:
        ...
        out["TickLabelOptions"] = (
            aws_sdk_quicksight.types.axis_tick_label_options.serialize_json(
    ...
    if "axis_line_visibility" in value:
        ...
        out["AxisLineVisibility"] = aws_sdk_quicksight.types.visibility.serialize_json(
            value["axis_line_visibility"]
        )
    if "grid_line_visibility" in value:
        import aws_sdk_quicksight.types.visibility

        out["GridLineVisibility"] = aws_sdk_quicksight.types.visibility.serialize_json(
            value["grid_line_visibility"]
        )
    if "data_options" in value:
        import aws_sdk_quicksight.types.axis_data_options

        out["DataOptions"] = aws_sdk_quicksight.types.axis_data_options.serialize_json(
            value["data_options"]
        )
    if "scrollbar_options" in value:
        ...
        out["ScrollbarOptions"] = (
            aws_sdk_quicksight.types.scroll_bar_options.serialize_json(
...
def deserialize_json(data: dict) -> AxisDisplayOptions:
    ...
    if "TickLabelOptions" in data:
        ...
        out["tick_label_options"] = (
            aws_sdk_quicksight.types.axis_tick_label_options.deserialize_json(
    ...
    if "DataOptions" in data:
        ...
        out["data_options"] = (
            aws_sdk_quicksight.types.axis_data_options.deserialize_json(
                data["DataOptions"]
            )
        )
    if "ScrollbarOptions" in data:
        ...
        out["scrollbar_options"] = (
            aws_sdk_quicksight.types.scroll_bar_options.deserialize_json(
