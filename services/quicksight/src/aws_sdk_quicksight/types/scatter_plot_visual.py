"""Generated from Smithy shape ``com.amazonaws.quicksight#ScatterPlotVisual``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.scatter_plot_configuration
...
class ScatterPlotVisual(TypedDict, closed=True):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.scatter_plot_configuration.ScatterPlotConfiguration"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: ScatterPlotVisual) -> dict:
    out: dict = {}
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.scatter_plot_configuration.serialize_json(
...
def deserialize_json(data: dict) -> ScatterPlotVisual:
    out: ScatterPlotVisual = {}  # type: ignore[typeddict-item]
    if "VisualId" in data:
        out["visual_id"] = data["VisualId"]
    else:
        raise DeserializationError("ScatterPlotVisual.visual_id required")
    if "Title" in data:
        import aws_sdk_quicksight.types.visual_title_label_options
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.scatter_plot_configuration.deserialize_json(
