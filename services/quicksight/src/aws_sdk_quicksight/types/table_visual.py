...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.table_conditional_formatting
    import aws_sdk_quicksight.types.table_configuration
...
class TableVisual(TypedDict):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.table_configuration.TableConfiguration"
    ]
    """<p>The configuration settings of the visual.</p>"""
    conditional_formatting: NotRequired[
        "aws_sdk_quicksight.types.table_conditional_formatting.TableConditionalFormatting"
    ]
...
def serialize_json(value: TableVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.table_configuration.serialize_json(
    ...
    if "conditional_formatting" in value:
        ...
        out["ConditionalFormatting"] = (
            aws_sdk_quicksight.types.table_conditional_formatting.serialize_json(
...
def deserialize_json(data: dict) -> TableVisual:
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.table_configuration.deserialize_json(
    ...
    if "ConditionalFormatting" in data:
        ...
        out["conditional_formatting"] = (
            aws_sdk_quicksight.types.table_conditional_formatting.deserialize_json(
