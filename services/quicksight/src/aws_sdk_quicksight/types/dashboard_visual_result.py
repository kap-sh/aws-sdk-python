...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.visual_subtitle
    import aws_sdk_quicksight.types.visual_title


class DashboardVisualResult(TypedDict):
    dashboard_id: NotRequired[
        "aws_sdk_quicksight.types.short_restrictive_resource_id.ShortRestrictiveResourceId"
    ]
    """<p>The ID of the dashboard.</p>"""
    dashboard_name: NotRequired["aws_sdk_quicksight.types.dashboard_name.DashboardName"]
    """<p>The name of the dashboard.</p>"""
    sheet_id: NotRequired[
        "aws_sdk_quicksight.types.short_restrictive_resource_id.ShortRestrictiveResourceId"
    ]
    """<p>The ID of the sheet.</p>"""
    sheet_name: NotRequired["aws_sdk_quicksight.types.sheet_name.SheetName"]
    """<p>The name of the sheet.</p>"""
    visual_id: NotRequired[
        "aws_sdk_quicksight.types.short_restrictive_resource_id.ShortRestrictiveResourceId"
    ]
    """<p>The ID of the visual.</p>"""
    visual_title: NotRequired["aws_sdk_quicksight.types.visual_title.VisualTitle"]
    """<p>The title of the visual.</p>"""
    visual_subtitle: NotRequired[
        "aws_sdk_quicksight.types.visual_subtitle.VisualSubtitle"
    ]
    """<p>The subtitle of the visual.</p>"""
    dashboard_url: NotRequired["aws_sdk_quicksight.types.qa_url.QAUrl"]
