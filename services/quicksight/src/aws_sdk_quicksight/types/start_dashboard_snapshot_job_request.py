...
class StartDashboardSnapshotJobRequest(TypedDict):
    ...
    snapshot_configuration: (
        "aws_sdk_quicksight.types.snapshot_configuration.SnapshotConfiguration"
    )
...
def serialize_json(value: StartDashboardSnapshotJobRequest) -> dict:
    ...
    if "user_configuration" in value:
        ...
        out["UserConfiguration"] = (
            aws_sdk_quicksight.types.snapshot_user_configuration.serialize_json(
    ...
    out["SnapshotConfiguration"] = (
        aws_sdk_quicksight.types.snapshot_configuration.serialize_json(
...
def deserialize_json(data: dict) -> StartDashboardSnapshotJobRequest:
    ...
    if "UserConfiguration" in data:
        ...
        out["user_configuration"] = (
            aws_sdk_quicksight.types.snapshot_user_configuration.deserialize_json(
    ...
    if "SnapshotConfiguration" in data:
        ...
        out["snapshot_configuration"] = (
            aws_sdk_quicksight.types.snapshot_configuration.deserialize_json(
