...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.default_filter_control_options
...
def serialize_json(value: DefaultFilterControlConfiguration) -> dict:
    ...
    out["ControlOptions"] = (
        aws_sdk_quicksight.types.default_filter_control_options.serialize_json(
...
def deserialize_json(data: dict) -> DefaultFilterControlConfiguration:
    ...
    if "ControlOptions" in data:
        ...
        out["control_options"] = (
            aws_sdk_quicksight.types.default_filter_control_options.deserialize_json(
                data["ControlOptions"]
            )
        )
    else:
