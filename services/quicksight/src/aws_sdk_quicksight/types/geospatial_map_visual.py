...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.geospatial_map_configuration
...
class GeospatialMapVisual(TypedDict):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.geospatial_map_configuration.GeospatialMapConfiguration"
    ]
...
def serialize_json(value: GeospatialMapVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.geospatial_map_configuration.serialize_json(
...
def deserialize_json(data: dict) -> GeospatialMapVisual:
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.geospatial_map_configuration.deserialize_json(
