...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.pivot_table_conditional_formatting
    import aws_sdk_quicksight.types.pivot_table_configuration
...
class PivotTableVisual(TypedDict):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.pivot_table_configuration.PivotTableConfiguration"
    ]
    """<p>The configuration settings of the visual.</p>"""
    conditional_formatting: NotRequired[
        "aws_sdk_quicksight.types.pivot_table_conditional_formatting.PivotTableConditionalFormatting"
    ]
...
def serialize_json(value: PivotTableVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.pivot_table_configuration.serialize_json(
    ...
    if "conditional_formatting" in value:
        ...
        out["ConditionalFormatting"] = (
            aws_sdk_quicksight.types.pivot_table_conditional_formatting.serialize_json(
...
def deserialize_json(data: dict) -> PivotTableVisual:
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.pivot_table_configuration.deserialize_json(
    ...
    if "ConditionalFormatting" in data:
        ...
        out["conditional_formatting"] = (
            aws_sdk_quicksight.types.pivot_table_conditional_formatting.deserialize_json(
