...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.asset_bundle_export_job_folder_property_to_override_list


class AssetBundleExportJobFolderOverrideProperties(TypedDict):
    ...
    properties: "aws_sdk_quicksight.types.asset_bundle_export_job_folder_property_to_override_list.AssetBundleExportJobFolderPropertyToOverrideList"
...
def serialize_json(value: AssetBundleExportJobFolderOverrideProperties) -> dict:
    ...
    out["Properties"] = (
        aws_sdk_quicksight.types.asset_bundle_export_job_folder_property_to_override_list.serialize_json(
            value["properties"]
        )
    )
    return out
...
def deserialize_json(data: dict) -> AssetBundleExportJobFolderOverrideProperties:
    ...
    if "Properties" in data:
        ...
        out["properties"] = (
            aws_sdk_quicksight.types.asset_bundle_export_job_folder_property_to_override_list.deserialize_json(
                data["Properties"]
            )
        )
    else:
