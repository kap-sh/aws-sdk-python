"""Generated from Smithy shape ``com.amazonaws.quicksight#PieChartVisual``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.pie_chart_configuration
...
class PieChartVisual(TypedDict, closed=True):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.pie_chart_configuration.PieChartConfiguration"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: PieChartVisual) -> dict:
    out: dict = {}
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.pie_chart_configuration.serialize_json(
...
def deserialize_json(data: dict) -> PieChartVisual:
    out: PieChartVisual = {}  # type: ignore[typeddict-item]
    if "VisualId" in data:
        out["visual_id"] = data["VisualId"]
    else:
        raise DeserializationError("PieChartVisual.visual_id required")
    if "Title" in data:
        import aws_sdk_quicksight.types.visual_title_label_options
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.pie_chart_configuration.deserialize_json(
