...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.refresh_configuration
    import aws_sdk_quicksight.types.refresh_failure_configuration


class DataSetRefreshProperties(TypedDict):
    refresh_configuration: NotRequired[
        "aws_sdk_quicksight.types.refresh_configuration.RefreshConfiguration"
    ]
    """<p>The refresh configuration for a dataset.</p>"""
    failure_configuration: NotRequired[
        "aws_sdk_quicksight.types.refresh_failure_configuration.RefreshFailureConfiguration"
    ]
...
def serialize_json(value: DataSetRefreshProperties) -> dict:
    ...
    if "refresh_configuration" in value:
        ...
        out["RefreshConfiguration"] = (
            aws_sdk_quicksight.types.refresh_configuration.serialize_json(
    ...
    if "failure_configuration" in value:
        ...
        out["FailureConfiguration"] = (
            aws_sdk_quicksight.types.refresh_failure_configuration.serialize_json(
...
def deserialize_json(data: dict) -> DataSetRefreshProperties:
    ...
    if "RefreshConfiguration" in data:
        ...
        out["refresh_configuration"] = (
            aws_sdk_quicksight.types.refresh_configuration.deserialize_json(
    ...
    if "FailureConfiguration" in data:
        ...
        out["failure_configuration"] = (
            aws_sdk_quicksight.types.refresh_failure_configuration.deserialize_json(
