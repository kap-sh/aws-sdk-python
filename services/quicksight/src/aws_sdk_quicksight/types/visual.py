...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.box_plot_visual
    import aws_sdk_quicksight.types.combo_chart_visual
    import aws_sdk_quicksight.types.custom_content_visual
    import aws_sdk_quicksight.types.empty_visual
    import aws_sdk_quicksight.types.filled_map_visual
    import aws_sdk_quicksight.types.funnel_chart_visual
    import aws_sdk_quicksight.types.gauge_chart_visual
    import aws_sdk_quicksight.types.geospatial_map_visual
    import aws_sdk_quicksight.types.heat_map_visual
    import aws_sdk_quicksight.types.histogram_visual
    import aws_sdk_quicksight.types.insight_visual
    import aws_sdk_quicksight.types.kpi_visual
    import aws_sdk_quicksight.types.layer_map_visual
    import aws_sdk_quicksight.types.line_chart_visual
    import aws_sdk_quicksight.types.pie_chart_visual
    import aws_sdk_quicksight.types.pivot_table_visual
    import aws_sdk_quicksight.types.plugin_visual
    import aws_sdk_quicksight.types.radar_chart_visual
    import aws_sdk_quicksight.types.sankey_diagram_visual
    import aws_sdk_quicksight.types.scatter_plot_visual
    import aws_sdk_quicksight.types.table_visual
    import aws_sdk_quicksight.types.tree_map_visual
    import aws_sdk_quicksight.types.waterfall_visual
...
def serialize_json(value: Visual) -> dict:
    ...
    if "table_visual" in value:
        ...
        out["TableVisual"] = aws_sdk_quicksight.types.table_visual.serialize_json(
            value["table_visual"]
        )
    if "pivot_table_visual" in value:
        ...
        out["PivotTableVisual"] = (
            aws_sdk_quicksight.types.pivot_table_visual.serialize_json(
    ...
    if "bar_chart_visual" in value:
        ...
        out["BarChartVisual"] = (
            aws_sdk_quicksight.types.bar_chart_visual.serialize_json(
    ...
    if "kpi_visual" in value:
        ...
        out["KPIVisual"] = aws_sdk_quicksight.types.kpi_visual.serialize_json(
            value["kpi_visual"]
        )
    if "pie_chart_visual" in value:
        ...
        out["PieChartVisual"] = (
            aws_sdk_quicksight.types.pie_chart_visual.serialize_json(
    ...
    if "gauge_chart_visual" in value:
        ...
        out["GaugeChartVisual"] = (
            aws_sdk_quicksight.types.gauge_chart_visual.serialize_json(
    ...
    if "line_chart_visual" in value:
        ...
        out["LineChartVisual"] = (
            aws_sdk_quicksight.types.line_chart_visual.serialize_json(
    ...
    if "heat_map_visual" in value:
        ...
        out["HeatMapVisual"] = aws_sdk_quicksight.types.heat_map_visual.serialize_json(
            value["heat_map_visual"]
        )
    if "tree_map_visual" in value:
        import aws_sdk_quicksight.types.tree_map_visual

        out["TreeMapVisual"] = aws_sdk_quicksight.types.tree_map_visual.serialize_json(
    ...
    if "geospatial_map_visual" in value:
        ...
        out["GeospatialMapVisual"] = (
            aws_sdk_quicksight.types.geospatial_map_visual.serialize_json(
    ...
    if "filled_map_visual" in value:
        ...
        out["FilledMapVisual"] = (
            aws_sdk_quicksight.types.filled_map_visual.serialize_json(
    ...
    if "layer_map_visual" in value:
        ...
        out["LayerMapVisual"] = (
            aws_sdk_quicksight.types.layer_map_visual.serialize_json(
    ...
    if "funnel_chart_visual" in value:
        ...
        out["FunnelChartVisual"] = (
            aws_sdk_quicksight.types.funnel_chart_visual.serialize_json(
    ...
    if "scatter_plot_visual" in value:
        ...
        out["ScatterPlotVisual"] = (
            aws_sdk_quicksight.types.scatter_plot_visual.serialize_json(
    ...
    if "combo_chart_visual" in value:
        ...
        out["ComboChartVisual"] = (
            aws_sdk_quicksight.types.combo_chart_visual.serialize_json(
    ...
    if "box_plot_visual" in value:
        ...
        out["BoxPlotVisual"] = aws_sdk_quicksight.types.box_plot_visual.serialize_json(
    ...
    if "waterfall_visual" in value:
        ...
        out["WaterfallVisual"] = (
            aws_sdk_quicksight.types.waterfall_visual.serialize_json(
    ...
    if "histogram_visual" in value:
        ...
        out["HistogramVisual"] = (
            aws_sdk_quicksight.types.histogram_visual.serialize_json(
    ...
    if "word_cloud_visual" in value:
        ...
        out["WordCloudVisual"] = (
            aws_sdk_quicksight.types.word_cloud_visual.serialize_json(
    ...
    if "insight_visual" in value:
        ...
        out["InsightVisual"] = aws_sdk_quicksight.types.insight_visual.serialize_json(
    ...
    if "sankey_diagram_visual" in value:
        ...
        out["SankeyDiagramVisual"] = (
            aws_sdk_quicksight.types.sankey_diagram_visual.serialize_json(
    ...
    if "custom_content_visual" in value:
        ...
        out["CustomContentVisual"] = (
            aws_sdk_quicksight.types.custom_content_visual.serialize_json(
    ...
    if "empty_visual" in value:
        ...
        out["EmptyVisual"] = aws_sdk_quicksight.types.empty_visual.serialize_json(
            value["empty_visual"]
        )
    if "radar_chart_visual" in value:
        ...
        out["RadarChartVisual"] = (
            aws_sdk_quicksight.types.radar_chart_visual.serialize_json(
    ...
    if "plugin_visual" in value:
        ...
        out["PluginVisual"] = aws_sdk_quicksight.types.plugin_visual.serialize_json(
            value["plugin_visual"]
        )
    return out
...
def deserialize_json(data: dict) -> Visual:
    ...
    if "TableVisual" in data:
        ...
        out["table_visual"] = aws_sdk_quicksight.types.table_visual.deserialize_json(
            data["TableVisual"]
        )
    if "PivotTableVisual" in data:
        ...
        out["pivot_table_visual"] = (
            aws_sdk_quicksight.types.pivot_table_visual.deserialize_json(
    ...
    if "BarChartVisual" in data:
        ...
        out["bar_chart_visual"] = (
            aws_sdk_quicksight.types.bar_chart_visual.deserialize_json(
                data["BarChartVisual"]
            )
        )
    if "KPIVisual" in data:
        ...
        out["kpi_visual"] = aws_sdk_quicksight.types.kpi_visual.deserialize_json(
            data["KPIVisual"]
        )
    if "PieChartVisual" in data:
        ...
        out["pie_chart_visual"] = (
            aws_sdk_quicksight.types.pie_chart_visual.deserialize_json(
                data["PieChartVisual"]
            )
        )
    if "GaugeChartVisual" in data:
        ...
        out["gauge_chart_visual"] = (
            aws_sdk_quicksight.types.gauge_chart_visual.deserialize_json(
    ...
    if "LineChartVisual" in data:
        ...
        out["line_chart_visual"] = (
            aws_sdk_quicksight.types.line_chart_visual.deserialize_json(
    ...
    if "HeatMapVisual" in data:
        ...
        out["heat_map_visual"] = (
            aws_sdk_quicksight.types.heat_map_visual.deserialize_json(
                data["HeatMapVisual"]
            )
        )
    if "TreeMapVisual" in data:
        ...
        out["tree_map_visual"] = (
            aws_sdk_quicksight.types.tree_map_visual.deserialize_json(
                data["TreeMapVisual"]
            )
        )
    if "GeospatialMapVisual" in data:
        ...
        out["geospatial_map_visual"] = (
            aws_sdk_quicksight.types.geospatial_map_visual.deserialize_json(
    ...
    if "FilledMapVisual" in data:
        ...
        out["filled_map_visual"] = (
            aws_sdk_quicksight.types.filled_map_visual.deserialize_json(
    ...
    if "LayerMapVisual" in data:
        ...
        out["layer_map_visual"] = (
            aws_sdk_quicksight.types.layer_map_visual.deserialize_json(
                data["LayerMapVisual"]
            )
        )
    if "FunnelChartVisual" in data:
        ...
        out["funnel_chart_visual"] = (
            aws_sdk_quicksight.types.funnel_chart_visual.deserialize_json(
    ...
    if "ScatterPlotVisual" in data:
        ...
        out["scatter_plot_visual"] = (
            aws_sdk_quicksight.types.scatter_plot_visual.deserialize_json(
    ...
    if "ComboChartVisual" in data:
        ...
        out["combo_chart_visual"] = (
            aws_sdk_quicksight.types.combo_chart_visual.deserialize_json(
    ...
    if "BoxPlotVisual" in data:
        ...
        out["box_plot_visual"] = (
            aws_sdk_quicksight.types.box_plot_visual.deserialize_json(
                data["BoxPlotVisual"]
            )
        )
    if "WaterfallVisual" in data:
        ...
        out["waterfall_visual"] = (
            aws_sdk_quicksight.types.waterfall_visual.deserialize_json(
    ...
    if "HistogramVisual" in data:
        ...
        out["histogram_visual"] = (
            aws_sdk_quicksight.types.histogram_visual.deserialize_json(
    ...
    if "WordCloudVisual" in data:
        ...
        out["word_cloud_visual"] = (
            aws_sdk_quicksight.types.word_cloud_visual.deserialize_json(
    ...
    if "InsightVisual" in data:
        ...
        out["insight_visual"] = (
            aws_sdk_quicksight.types.insight_visual.deserialize_json(
                data["InsightVisual"]
            )
        )
    if "SankeyDiagramVisual" in data:
        ...
        out["sankey_diagram_visual"] = (
            aws_sdk_quicksight.types.sankey_diagram_visual.deserialize_json(
    ...
    if "CustomContentVisual" in data:
        ...
        out["custom_content_visual"] = (
            aws_sdk_quicksight.types.custom_content_visual.deserialize_json(
    ...
    if "EmptyVisual" in data:
        ...
        out["empty_visual"] = aws_sdk_quicksight.types.empty_visual.deserialize_json(
            data["EmptyVisual"]
        )
    if "RadarChartVisual" in data:
        ...
        out["radar_chart_visual"] = (
            aws_sdk_quicksight.types.radar_chart_visual.deserialize_json(
    ...
    if "PluginVisual" in data:
        ...
        out["plugin_visual"] = aws_sdk_quicksight.types.plugin_visual.deserialize_json(
            data["PluginVisual"]
        )
    return out
