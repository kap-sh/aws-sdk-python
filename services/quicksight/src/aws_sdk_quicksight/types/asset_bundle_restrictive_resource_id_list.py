...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.asset_bundle_restrictive_resource_id

AssetBundleRestrictiveResourceIdList: TypeAlias = list[
    "aws_sdk_quicksight.types.asset_bundle_restrictive_resource_id.AssetBundleRestrictiveResourceId"
]
