...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.sankey_diagram_chart_configuration
...
class SankeyDiagramVisual(TypedDict):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.sankey_diagram_chart_configuration.SankeyDiagramChartConfiguration"
    ]
...
def serialize_json(value: SankeyDiagramVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.sankey_diagram_chart_configuration.serialize_json(
...
def deserialize_json(data: dict) -> SankeyDiagramVisual:
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.sankey_diagram_chart_configuration.deserialize_json(
