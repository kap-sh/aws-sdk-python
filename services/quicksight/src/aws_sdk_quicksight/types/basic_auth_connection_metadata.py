...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.action_password
    import aws_sdk_quicksight.types.action_user_name
    import aws_sdk_quicksight.types.endpoint


class BasicAuthConnectionMetadata(TypedDict):
    ...
    password: "aws_sdk_quicksight.types.action_password.ActionPassword"
