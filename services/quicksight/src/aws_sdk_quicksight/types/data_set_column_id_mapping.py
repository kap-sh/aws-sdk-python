...
class DataSetColumnIdMapping(TypedDict):
    source_column_id: "aws_sdk_quicksight.types.column_id.ColumnId"
    """<p>Source column ID.</p>"""
    target_column_id: "aws_sdk_quicksight.types.column_id.ColumnId"
