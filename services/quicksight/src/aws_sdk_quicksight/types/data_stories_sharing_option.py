"""Generated from Smithy shape ``com.amazonaws.quicksight#DataStoriesSharingOption``."""
...
class DataStoriesSharingOption(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DataStoriesSharingOption) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DataStoriesSharingOption:
    out: DataStoriesSharingOption = {}  # type: ignore[typeddict-item]
