"""Generated from Smithy shape ``com.amazonaws.quicksight#HeatMapVisual``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.heat_map_configuration
...
class HeatMapVisual(TypedDict, closed=True):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.heat_map_configuration.HeatMapConfiguration"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: HeatMapVisual) -> dict:
    out: dict = {}
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.heat_map_configuration.serialize_json(
...
def deserialize_json(data: dict) -> HeatMapVisual:
    out: HeatMapVisual = {}  # type: ignore[typeddict-item]
    if "VisualId" in data:
        out["visual_id"] = data["VisualId"]
    else:
        raise DeserializationError("HeatMapVisual.visual_id required")
    if "Title" in data:
        import aws_sdk_quicksight.types.visual_title_label_options
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.heat_map_configuration.deserialize_json(
