...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.kpi_conditional_formatting
    import aws_sdk_quicksight.types.kpi_configuration
...
class KPIVisual(TypedDict):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.kpi_configuration.KPIConfiguration"
    ]
    """<p>The configuration of a KPI visual.</p>"""
    conditional_formatting: NotRequired[
        "aws_sdk_quicksight.types.kpi_conditional_formatting.KPIConditionalFormatting"
    ]
...
def serialize_json(value: KPIVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.kpi_configuration.serialize_json(
    ...
    if "conditional_formatting" in value:
        ...
        out["ConditionalFormatting"] = (
            aws_sdk_quicksight.types.kpi_conditional_formatting.serialize_json(
...
def deserialize_json(data: dict) -> KPIVisual:
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.kpi_configuration.deserialize_json(
    ...
    if "ConditionalFormatting" in data:
        ...
        out["conditional_formatting"] = (
            aws_sdk_quicksight.types.kpi_conditional_formatting.deserialize_json(
