"""Generated from Smithy shape ``com.amazonaws.quicksight#FilledMapVisual``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.filled_map_conditional_formatting
    import aws_sdk_quicksight.types.filled_map_configuration
    import aws_sdk_quicksight.types.geocode_preference_list
...
class FilledMapVisual(TypedDict, closed=True):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.filled_map_configuration.FilledMapConfiguration"
    ]
    """<p>The configuration settings of the visual.</p>"""
    conditional_formatting: NotRequired[
        "aws_sdk_quicksight.types.filled_map_conditional_formatting.FilledMapConditionalFormatting"
    ]
    ...
    geocoding_preferences: NotRequired[
        "aws_sdk_quicksight.types.geocode_preference_list.GeocodePreferenceList"
    ]
    """<p>The geocoding prefences for filled map visual.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: FilledMapVisual) -> dict:
    out: dict = {}
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.filled_map_configuration.serialize_json(
    ...
    if "conditional_formatting" in value:
        ...
        out["ConditionalFormatting"] = (
            aws_sdk_quicksight.types.filled_map_conditional_formatting.serialize_json(
    ...
    if "geocoding_preferences" in value:
        ...
        out["GeocodingPreferences"] = (
            aws_sdk_quicksight.types.geocode_preference_list.serialize_json(
...
def deserialize_json(data: dict) -> FilledMapVisual:
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.filled_map_configuration.deserialize_json(
    ...
    if "ConditionalFormatting" in data:
        ...
        out["conditional_formatting"] = (
            aws_sdk_quicksight.types.filled_map_conditional_formatting.deserialize_json(
    ...
    if "GeocodingPreferences" in data:
        ...
        out["geocoding_preferences"] = (
            aws_sdk_quicksight.types.geocode_preference_list.deserialize_json(
