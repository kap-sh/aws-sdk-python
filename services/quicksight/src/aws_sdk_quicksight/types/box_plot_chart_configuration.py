...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.box_plot_field_wells
    import aws_sdk_quicksight.types.box_plot_options
    import aws_sdk_quicksight.types.box_plot_sort_configuration
...
class BoxPlotChartConfiguration(TypedDict):
    ...
    sort_configuration: NotRequired[
        "aws_sdk_quicksight.types.box_plot_sort_configuration.BoxPlotSortConfiguration"
    ]
    """<p>The sort configuration of a <code>BoxPlotVisual</code>.</p>"""
    box_plot_options: NotRequired[
        "aws_sdk_quicksight.types.box_plot_options.BoxPlotOptions"
    ]
...
def serialize_json(value: BoxPlotChartConfiguration) -> dict:
    ...
    if "field_wells" in value:
        ...
        out["FieldWells"] = (
            aws_sdk_quicksight.types.box_plot_field_wells.serialize_json(
                value["field_wells"]
            )
        )
    if "sort_configuration" in value:
        ...
        out["SortConfiguration"] = (
            aws_sdk_quicksight.types.box_plot_sort_configuration.serialize_json(
    ...
    if "box_plot_options" in value:
        ...
        out["BoxPlotOptions"] = (
            aws_sdk_quicksight.types.box_plot_options.serialize_json(
...
def deserialize_json(data: dict) -> BoxPlotChartConfiguration:
    ...
    if "FieldWells" in data:
        ...
        out["field_wells"] = (
            aws_sdk_quicksight.types.box_plot_field_wells.deserialize_json(
                data["FieldWells"]
            )
        )
    if "SortConfiguration" in data:
        ...
        out["sort_configuration"] = (
            aws_sdk_quicksight.types.box_plot_sort_configuration.deserialize_json(
    ...
    if "BoxPlotOptions" in data:
        ...
        out["box_plot_options"] = (
            aws_sdk_quicksight.types.box_plot_options.deserialize_json(
                data["BoxPlotOptions"]
            )
        )
