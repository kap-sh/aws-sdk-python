"""Generated from Smithy shape ``com.amazonaws.quicksight#DecimalDatasetParameter``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.decimal_dataset_parameter_default_values


class DecimalDatasetParameter(TypedDict, closed=True):
    ...
    default_values: NotRequired[
        "aws_sdk_quicksight.types.decimal_dataset_parameter_default_values.DecimalDatasetParameterDefaultValues"
    ]
    """<p>A list of default values for a given decimal parameter. This structure only accepts static values.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: DecimalDatasetParameter) -> dict:
    out: dict = {}
    out["Id"] = value["id"]
    out["Name"] = value["name"]
    import aws_sdk_quicksight.types.dataset_parameter_value_type
    ...
    if "default_values" in value:
        ...
        out["DefaultValues"] = (
            aws_sdk_quicksight.types.decimal_dataset_parameter_default_values.serialize_json(
...
def deserialize_json(data: dict) -> DecimalDatasetParameter:
    ...
    if "DefaultValues" in data:
        ...
        out["default_values"] = (
            aws_sdk_quicksight.types.decimal_dataset_parameter_default_values.deserialize_json(
                data["DefaultValues"]
            )
        )
    return out
