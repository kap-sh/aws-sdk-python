...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.combo_chart_configuration
...
class ComboChartVisual(TypedDict):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.combo_chart_configuration.ComboChartConfiguration"
    ]
...
def serialize_json(value: ComboChartVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.combo_chart_configuration.serialize_json(
...
def deserialize_json(data: dict) -> ComboChartVisual:
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.combo_chart_configuration.deserialize_json(
