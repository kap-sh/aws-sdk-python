"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeTemplatePermissionsResponse``."""
...
class DescribeTemplatePermissionsResponse(TypedDict, closed=True):
    template_id: NotRequired[
        "aws_sdk_quicksight.types.short_restrictive_resource_id.ShortRestrictiveResourceId"
    ]
    """<p>The ID for the template.</p>"""
    template_arn: NotRequired["aws_sdk_quicksight.types.arn.Arn"]
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeTemplatePermissionsResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DescribeTemplatePermissionsResponse:
    out: DescribeTemplatePermissionsResponse = {}  # type: ignore[typeddict-item]
