...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.simple_attribute_aggregation_function
    import aws_sdk_quicksight.types.string


class AttributeAggregationFunction(TypedDict):
    simple_attribute_aggregation: NotRequired[
        "aws_sdk_quicksight.types.simple_attribute_aggregation_function.SimpleAttributeAggregationFunction"
    ]
    ...
    value_for_multiple_values: NotRequired["aws_sdk_quicksight.types.string.String"]
...
def serialize_json(value: AttributeAggregationFunction) -> dict:
    ...
    if "simple_attribute_aggregation" in value:
        ...
        out["SimpleAttributeAggregation"] = (
            aws_sdk_quicksight.types.simple_attribute_aggregation_function.serialize_json(
...
def deserialize_json(data: dict) -> AttributeAggregationFunction:
    ...
    if "SimpleAttributeAggregation" in data:
        ...
        out["simple_attribute_aggregation"] = (
            aws_sdk_quicksight.types.simple_attribute_aggregation_function.deserialize_json(
