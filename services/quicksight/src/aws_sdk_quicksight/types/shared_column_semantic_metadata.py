...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.column_name_list
...
class SharedColumnSemanticMetadata(TypedDict, closed=True):
    ...
    column_properties: "aws_sdk_quicksight.types.column_semantic_property_list.ColumnSemanticPropertyList"
...
def serialize_json(value: SharedColumnSemanticMetadata) -> dict:
    ...
    if "column_names" in value:
        ...
        out["ColumnNames"] = aws_sdk_quicksight.types.column_name_list.serialize_json(
            value["column_names"]
        )
    import aws_sdk_quicksight.types.column_semantic_property_list

    out["ColumnProperties"] = (
        aws_sdk_quicksight.types.column_semantic_property_list.serialize_json(
...
def deserialize_json(data: dict) -> SharedColumnSemanticMetadata:
    ...
    if "ColumnNames" in data:
        ...
        out["column_names"] = (
            aws_sdk_quicksight.types.column_name_list.deserialize_json(
                data["ColumnNames"]
            )
        )
    if "ColumnProperties" in data:
        ...
        out["column_properties"] = (
            aws_sdk_quicksight.types.column_semantic_property_list.deserialize_json(
