...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.starburst_product_type


class StarburstParameters(TypedDict):
    ...
    product_type: NotRequired[
        "aws_sdk_quicksight.types.starburst_product_type.StarburstProductType"
    ]
...
def serialize_json(value: StarburstParameters) -> dict:
    ...
    if "product_type" in value:
        ...
        out["ProductType"] = (
            aws_sdk_quicksight.types.starburst_product_type.serialize_json(
                value["product_type"]
            )
        )
...
def deserialize_json(data: dict) -> StarburstParameters:
    ...
    if "ProductType" in data:
        ...
        out["product_type"] = (
            aws_sdk_quicksight.types.starburst_product_type.deserialize_json(
                data["ProductType"]
            )
        )
