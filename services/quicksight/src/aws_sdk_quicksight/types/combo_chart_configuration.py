...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.combo_chart_default_series_settings
    import aws_sdk_quicksight.types.combo_chart_field_wells
    import aws_sdk_quicksight.types.combo_chart_sort_configuration
    import aws_sdk_quicksight.types.combo_series_item_list
...
class ComboChartConfiguration(TypedDict):
    field_wells: NotRequired[
        "aws_sdk_quicksight.types.combo_chart_field_wells.ComboChartFieldWells"
    ]
    """<p>The field wells of the visual.</p>"""
    sort_configuration: NotRequired[
        "aws_sdk_quicksight.types.combo_chart_sort_configuration.ComboChartSortConfiguration"
    ]
    ...
    default_series_settings: NotRequired[
        "aws_sdk_quicksight.types.combo_chart_default_series_settings.ComboChartDefaultSeriesSettings"
    ]
    """<p>The options that determine the default presentation of all series in <code>ComboChartVisual</code>.</p>"""
    series: NotRequired[
        "aws_sdk_quicksight.types.combo_series_item_list.ComboSeriesItemList"
    ]
...
def serialize_json(value: ComboChartConfiguration) -> dict:
    ...
    if "field_wells" in value:
        ...
        out["FieldWells"] = (
            aws_sdk_quicksight.types.combo_chart_field_wells.serialize_json(
                value["field_wells"]
            )
        )
    if "sort_configuration" in value:
        ...
        out["SortConfiguration"] = (
            aws_sdk_quicksight.types.combo_chart_sort_configuration.serialize_json(
    ...
    if "default_series_settings" in value:
        ...
        out["DefaultSeriesSettings"] = (
            aws_sdk_quicksight.types.combo_chart_default_series_settings.serialize_json(
    ...
    if "series" in value:
        ...
        out["Series"] = aws_sdk_quicksight.types.combo_series_item_list.serialize_json(
            value["series"]
        )
    if "legend" in value:
        import aws_sdk_quicksight.types.legend_options
    ...
    if "bar_data_labels" in value:
        ...
        out["BarDataLabels"] = (
            aws_sdk_quicksight.types.data_label_options.serialize_json(
...
def deserialize_json(data: dict) -> ComboChartConfiguration:
    ...
    if "FieldWells" in data:
        ...
        out["field_wells"] = (
            aws_sdk_quicksight.types.combo_chart_field_wells.deserialize_json(
                data["FieldWells"]
            )
        )
    if "SortConfiguration" in data:
        ...
        out["sort_configuration"] = (
            aws_sdk_quicksight.types.combo_chart_sort_configuration.deserialize_json(
    ...
    if "DefaultSeriesSettings" in data:
        ...
        out["default_series_settings"] = (
            aws_sdk_quicksight.types.combo_chart_default_series_settings.deserialize_json(
    ...
    if "Series" in data:
        ...
        out["series"] = (
            aws_sdk_quicksight.types.combo_series_item_list.deserialize_json(
                data["Series"]
            )
        )
    if "Legend" in data:
