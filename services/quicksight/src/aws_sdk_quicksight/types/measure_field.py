...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.categorical_measure_field
    import aws_sdk_quicksight.types.date_measure_field
...
class MeasureField(TypedDict, closed=True):
    ...
    categorical_measure_field: NotRequired[
        "aws_sdk_quicksight.types.categorical_measure_field.CategoricalMeasureField"
    ]
    """<p>The measure type field with categorical type columns.</p>"""
    date_measure_field: NotRequired[
        "aws_sdk_quicksight.types.date_measure_field.DateMeasureField"
    ]
    """<p>The measure type field with date type columns.</p>"""
    calculated_measure_field: NotRequired[
        "aws_sdk_quicksight.types.calculated_measure_field.CalculatedMeasureField"
    ]
...
def serialize_json(value: MeasureField) -> dict:
    ...
    if "numerical_measure_field" in value:
        ...
        out["NumericalMeasureField"] = (
            aws_sdk_quicksight.types.numerical_measure_field.serialize_json(
    ...
    if "categorical_measure_field" in value:
        ...
        out["CategoricalMeasureField"] = (
            aws_sdk_quicksight.types.categorical_measure_field.serialize_json(
    ...
    if "date_measure_field" in value:
        ...
        out["DateMeasureField"] = (
            aws_sdk_quicksight.types.date_measure_field.serialize_json(
    ...
    if "calculated_measure_field" in value:
        ...
        out["CalculatedMeasureField"] = (
            aws_sdk_quicksight.types.calculated_measure_field.serialize_json(
...
def deserialize_json(data: dict) -> MeasureField:
    ...
    if "NumericalMeasureField" in data:
        ...
        out["numerical_measure_field"] = (
            aws_sdk_quicksight.types.numerical_measure_field.deserialize_json(
    ...
    if "CategoricalMeasureField" in data:
        ...
        out["categorical_measure_field"] = (
            aws_sdk_quicksight.types.categorical_measure_field.deserialize_json(
    ...
    if "DateMeasureField" in data:
        ...
        out["date_measure_field"] = (
            aws_sdk_quicksight.types.date_measure_field.deserialize_json(
    ...
    if "CalculatedMeasureField" in data:
        ...
        out["calculated_measure_field"] = (
            aws_sdk_quicksight.types.calculated_measure_field.deserialize_json(
