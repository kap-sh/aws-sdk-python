...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.decal_style_type
    import aws_sdk_quicksight.types.element_value
...
class DecalSettings(TypedDict, closed=True):
    ...
    decal_pattern_type: NotRequired[
        "aws_sdk_quicksight.types.decal_pattern_type.DecalPatternType"
    ]
    ...
    decal_style_type: NotRequired[
        "aws_sdk_quicksight.types.decal_style_type.DecalStyleType"
    ]
...
def serialize_json(value: DecalSettings) -> dict:
    ...
    if "decal_visibility" in value:
        ...
        out["DecalVisibility"] = aws_sdk_quicksight.types.visibility.serialize_json(
    ...
    if "decal_pattern_type" in value:
        ...
        out["DecalPatternType"] = (
            aws_sdk_quicksight.types.decal_pattern_type.serialize_json(
    ...
    if "decal_style_type" in value:
        ...
        out["DecalStyleType"] = (
            aws_sdk_quicksight.types.decal_style_type.serialize_json(
...
def deserialize_json(data: dict) -> DecalSettings:
    ...
    if "DecalVisibility" in data:
        ...
        out["decal_visibility"] = aws_sdk_quicksight.types.visibility.deserialize_json(
    ...
    if "DecalPatternType" in data:
        ...
        out["decal_pattern_type"] = (
            aws_sdk_quicksight.types.decal_pattern_type.deserialize_json(
    ...
    if "DecalStyleType" in data:
        ...
        out["decal_style_type"] = (
            aws_sdk_quicksight.types.decal_style_type.deserialize_json(
                data["DecalStyleType"]
            )
        )
    return out
