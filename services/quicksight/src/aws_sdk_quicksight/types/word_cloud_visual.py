"""Generated from Smithy shape ``com.amazonaws.quicksight#WordCloudVisual``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.word_cloud_chart_configuration


class WordCloudVisual(TypedDict, closed=True):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.word_cloud_chart_configuration.WordCloudChartConfiguration"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: WordCloudVisual) -> dict:
    out: dict = {}
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.word_cloud_chart_configuration.serialize_json(
...
def deserialize_json(data: dict) -> WordCloudVisual:
    out: WordCloudVisual = {}  # type: ignore[typeddict-item]
    if "VisualId" in data:
        out["visual_id"] = data["VisualId"]
    else:
        raise DeserializationError("WordCloudVisual.visual_id required")
    if "Title" in data:
        import aws_sdk_quicksight.types.visual_title_label_options
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.word_cloud_chart_configuration.deserialize_json(
