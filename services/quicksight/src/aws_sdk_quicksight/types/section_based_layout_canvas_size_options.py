...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.section_based_layout_paper_canvas_size_options


class SectionBasedLayoutCanvasSizeOptions(TypedDict):
    paper_canvas_size_options: NotRequired[
        "aws_sdk_quicksight.types.section_based_layout_paper_canvas_size_options.SectionBasedLayoutPaperCanvasSizeOptions"
    ]
...
def serialize_json(value: SectionBasedLayoutCanvasSizeOptions) -> dict:
    ...
    if "paper_canvas_size_options" in value:
        ...
        out["PaperCanvasSizeOptions"] = (
            aws_sdk_quicksight.types.section_based_layout_paper_canvas_size_options.serialize_json(
...
def deserialize_json(data: dict) -> SectionBasedLayoutCanvasSizeOptions:
    ...
    if "PaperCanvasSizeOptions" in data:
        ...
        out["paper_canvas_size_options"] = (
            aws_sdk_quicksight.types.section_based_layout_paper_canvas_size_options.deserialize_json(
