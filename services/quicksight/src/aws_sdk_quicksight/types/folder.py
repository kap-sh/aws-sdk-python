...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.path
...
class Folder(TypedDict):
    ...
    folder_path: NotRequired["aws_sdk_quicksight.types.path.Path"]
...
def serialize_json(value: Folder) -> dict:
    ...
    if "folder_path" in value:
        ...
        out["FolderPath"] = aws_sdk_quicksight.types.path.serialize_json(
            value["folder_path"]
        )
...
def deserialize_json(data: dict) -> Folder:
    ...
    if "FolderPath" in data:
        ...
        out["folder_path"] = aws_sdk_quicksight.types.path.deserialize_json(
            data["FolderPath"]
        )
