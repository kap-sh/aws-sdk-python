...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.anchor_date_configuration
    ...
    import aws_sdk_quicksight.types.relative_date_type
    import aws_sdk_quicksight.types.short_restrictive_resource_id
    import aws_sdk_quicksight.types.time_granularity


class RelativeDatesFilter(TypedDict):
    ...
    anchor_date_configuration: (
        "aws_sdk_quicksight.types.anchor_date_configuration.AnchorDateConfiguration"
    )
    ...
    relative_date_type: "aws_sdk_quicksight.types.relative_date_type.RelativeDateType"
    ...
    relative_date_value: NotRequired["aws_sdk_quicksight.types.integer.Integer"]
...
def serialize_json(value: RelativeDatesFilter) -> dict:
    ...
    out["AnchorDateConfiguration"] = (
        aws_sdk_quicksight.types.anchor_date_configuration.serialize_json(
    ...
    out["RelativeDateType"] = (
        aws_sdk_quicksight.types.relative_date_type.serialize_json(
...
def deserialize_json(data: dict) -> RelativeDatesFilter:
    ...
    if "AnchorDateConfiguration" in data:
        ...
        out["anchor_date_configuration"] = (
            aws_sdk_quicksight.types.anchor_date_configuration.deserialize_json(
    ...
    if "RelativeDateType" in data:
        ...
        out["relative_date_type"] = (
            aws_sdk_quicksight.types.relative_date_type.deserialize_json(
