...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.dashboard_visual_publish_options
    import aws_sdk_quicksight.types.data_point_drill_up_down_option
    import aws_sdk_quicksight.types.data_point_menu_label_option
    import aws_sdk_quicksight.types.data_point_tooltip_option
    import aws_sdk_quicksight.types.data_qa_enabled_option
    import aws_sdk_quicksight.types.data_stories_sharing_option
    import aws_sdk_quicksight.types.executive_summary_option
    import aws_sdk_quicksight.types.export_to_csv_option
    import aws_sdk_quicksight.types.export_with_hidden_fields_option
    import aws_sdk_quicksight.types.quick_suite_actions_option
    import aws_sdk_quicksight.types.sheet_controls_option
    import aws_sdk_quicksight.types.sheet_layout_element_maximization_option
    import aws_sdk_quicksight.types.visual_axis_sort_option
...
class DashboardPublishOptions(TypedDict):
    ...
    export_to_csv_option: NotRequired[
        "aws_sdk_quicksight.types.export_to_csv_option.ExportToCSVOption"
    ]
    """<p>Export to .csv option.</p>"""
    sheet_controls_option: NotRequired[
        "aws_sdk_quicksight.types.sheet_controls_option.SheetControlsOption"
    ]
    """<p>Sheet controls option.</p>"""
    visual_publish_options: NotRequired[
        "aws_sdk_quicksight.types.dashboard_visual_publish_options.DashboardVisualPublishOptions"
    ]
    """<p>The visual publish options of a visual in a dashboard.</p>"""
    sheet_layout_element_maximization_option: NotRequired[
        "aws_sdk_quicksight.types.sheet_layout_element_maximization_option.SheetLayoutElementMaximizationOption"
    ]
    ...
    quick_suite_actions_option: NotRequired[
        "aws_sdk_quicksight.types.quick_suite_actions_option.QuickSuiteActionsOption"
    ]
    """<p>Determines if Actions in Amazon Quick Suite are enabled in a dashboard.</p>"""
    executive_summary_option: NotRequired[
        "aws_sdk_quicksight.types.executive_summary_option.ExecutiveSummaryOption"
    ]
    """<p>Executive summary option.</p>"""
    data_stories_sharing_option: NotRequired[
        "aws_sdk_quicksight.types.data_stories_sharing_option.DataStoriesSharingOption"
    ]
...
def serialize_json(value: DashboardPublishOptions) -> dict:
    ...
    if "ad_hoc_filtering_option" in value:
        ...
        out["AdHocFilteringOption"] = (
            aws_sdk_quicksight.types.ad_hoc_filtering_option.serialize_json(
    ...
    if "export_to_csv_option" in value:
        ...
        out["ExportToCSVOption"] = (
            aws_sdk_quicksight.types.export_to_csv_option.serialize_json(
    ...
    if "sheet_controls_option" in value:
        ...
        out["SheetControlsOption"] = (
            aws_sdk_quicksight.types.sheet_controls_option.serialize_json(
    ...
    if "visual_publish_options" in value:
        ...
        out["VisualPublishOptions"] = (
            aws_sdk_quicksight.types.dashboard_visual_publish_options.serialize_json(
    ...
    if "sheet_layout_element_maximization_option" in value:
        ...
        out["SheetLayoutElementMaximizationOption"] = (
            aws_sdk_quicksight.types.sheet_layout_element_maximization_option.serialize_json(
    ...
    if "visual_axis_sort_option" in value:
        ...
        out["VisualAxisSortOption"] = (
            aws_sdk_quicksight.types.visual_axis_sort_option.serialize_json(
    ...
    if "export_with_hidden_fields_option" in value:
        ...
        out["ExportWithHiddenFieldsOption"] = (
            aws_sdk_quicksight.types.export_with_hidden_fields_option.serialize_json(
    ...
    if "data_point_drill_up_down_option" in value:
        ...
        out["DataPointDrillUpDownOption"] = (
            aws_sdk_quicksight.types.data_point_drill_up_down_option.serialize_json(
    ...
    if "data_point_menu_label_option" in value:
        ...
        out["DataPointMenuLabelOption"] = (
            aws_sdk_quicksight.types.data_point_menu_label_option.serialize_json(
    ...
    if "data_point_tooltip_option" in value:
        ...
        out["DataPointTooltipOption"] = (
            aws_sdk_quicksight.types.data_point_tooltip_option.serialize_json(
    ...
    if "data_qa_enabled_option" in value:
        ...
        out["DataQAEnabledOption"] = (
            aws_sdk_quicksight.types.data_qa_enabled_option.serialize_json(
    ...
    if "quick_suite_actions_option" in value:
        ...
        out["QuickSuiteActionsOption"] = (
            aws_sdk_quicksight.types.quick_suite_actions_option.serialize_json(
    ...
    if "executive_summary_option" in value:
        ...
        out["ExecutiveSummaryOption"] = (
            aws_sdk_quicksight.types.executive_summary_option.serialize_json(
    ...
    if "data_stories_sharing_option" in value:
        ...
        out["DataStoriesSharingOption"] = (
            aws_sdk_quicksight.types.data_stories_sharing_option.serialize_json(
...
def deserialize_json(data: dict) -> DashboardPublishOptions:
    ...
    if "AdHocFilteringOption" in data:
        ...
        out["ad_hoc_filtering_option"] = (
            aws_sdk_quicksight.types.ad_hoc_filtering_option.deserialize_json(
    ...
    if "ExportToCSVOption" in data:
        ...
        out["export_to_csv_option"] = (
            aws_sdk_quicksight.types.export_to_csv_option.deserialize_json(
    ...
    if "SheetControlsOption" in data:
        ...
        out["sheet_controls_option"] = (
            aws_sdk_quicksight.types.sheet_controls_option.deserialize_json(
    ...
    if "VisualPublishOptions" in data:
        ...
        out["visual_publish_options"] = (
            aws_sdk_quicksight.types.dashboard_visual_publish_options.deserialize_json(
    ...
    if "SheetLayoutElementMaximizationOption" in data:
        ...
        out["sheet_layout_element_maximization_option"] = (
            aws_sdk_quicksight.types.sheet_layout_element_maximization_option.deserialize_json(
    ...
    if "VisualAxisSortOption" in data:
        ...
        out["visual_axis_sort_option"] = (
            aws_sdk_quicksight.types.visual_axis_sort_option.deserialize_json(
    ...
    if "ExportWithHiddenFieldsOption" in data:
        ...
        out["export_with_hidden_fields_option"] = (
            aws_sdk_quicksight.types.export_with_hidden_fields_option.deserialize_json(
    ...
    if "DataPointDrillUpDownOption" in data:
        ...
        out["data_point_drill_up_down_option"] = (
            aws_sdk_quicksight.types.data_point_drill_up_down_option.deserialize_json(
    ...
    if "DataPointMenuLabelOption" in data:
        ...
        out["data_point_menu_label_option"] = (
            aws_sdk_quicksight.types.data_point_menu_label_option.deserialize_json(
    ...
    if "DataPointTooltipOption" in data:
        ...
        out["data_point_tooltip_option"] = (
            aws_sdk_quicksight.types.data_point_tooltip_option.deserialize_json(
    ...
    if "DataQAEnabledOption" in data:
        ...
        out["data_qa_enabled_option"] = (
            aws_sdk_quicksight.types.data_qa_enabled_option.deserialize_json(
    ...
    if "QuickSuiteActionsOption" in data:
        ...
        out["quick_suite_actions_option"] = (
            aws_sdk_quicksight.types.quick_suite_actions_option.deserialize_json(
    ...
    if "ExecutiveSummaryOption" in data:
        ...
        out["executive_summary_option"] = (
            aws_sdk_quicksight.types.executive_summary_option.deserialize_json(
    ...
    if "DataStoriesSharingOption" in data:
        ...
        out["data_stories_sharing_option"] = (
            aws_sdk_quicksight.types.data_stories_sharing_option.deserialize_json(
