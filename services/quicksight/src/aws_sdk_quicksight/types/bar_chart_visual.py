...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.bar_chart_configuration
...
class BarChartVisual(TypedDict):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.bar_chart_configuration.BarChartConfiguration"
    ]
...
def serialize_json(value: BarChartVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.bar_chart_configuration.serialize_json(
...
def deserialize_json(data: dict) -> BarChartVisual:
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.bar_chart_configuration.deserialize_json(
