"""Generated from Smithy shape ``com.amazonaws.quicksight#WaterfallVisual``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.waterfall_chart_configuration


class WaterfallVisual(TypedDict, closed=True):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.waterfall_chart_configuration.WaterfallChartConfiguration"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: WaterfallVisual) -> dict:
    out: dict = {}
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.waterfall_chart_configuration.serialize_json(
...
def deserialize_json(data: dict) -> WaterfallVisual:
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.waterfall_chart_configuration.deserialize_json(
