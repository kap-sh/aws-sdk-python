...
class ParameterDropDownControl(TypedDict):
    ...
    selectable_values: NotRequired[
        "aws_sdk_quicksight.types.parameter_selectable_values.ParameterSelectableValues"
    ]
...
def serialize_json(value: ParameterDropDownControl) -> dict:
    ...
    if "selectable_values" in value:
        ...
        out["SelectableValues"] = (
            aws_sdk_quicksight.types.parameter_selectable_values.serialize_json(
...
def deserialize_json(data: dict) -> ParameterDropDownControl:
    ...
    if "SelectableValues" in data:
        ...
        out["selectable_values"] = (
            aws_sdk_quicksight.types.parameter_selectable_values.deserialize_json(
