...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.tree_map_configuration
...
class TreeMapVisual(TypedDict):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.tree_map_configuration.TreeMapConfiguration"
    ]
...
def serialize_json(value: TreeMapVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.tree_map_configuration.serialize_json(
...
def deserialize_json(data: dict) -> TreeMapVisual:
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.tree_map_configuration.deserialize_json(
