...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.asset_bundle_export_job_data_source_property_to_override_list


class AssetBundleExportJobDataSourceOverrideProperties(TypedDict):
    ...
    properties: "aws_sdk_quicksight.types.asset_bundle_export_job_data_source_property_to_override_list.AssetBundleExportJobDataSourcePropertyToOverrideList"
...
def serialize_json(value: AssetBundleExportJobDataSourceOverrideProperties) -> dict:
    ...
    out["Properties"] = (
        aws_sdk_quicksight.types.asset_bundle_export_job_data_source_property_to_override_list.serialize_json(
            value["properties"]
        )
    )
    return out
...
def deserialize_json(data: dict) -> AssetBundleExportJobDataSourceOverrideProperties:
    ...
    if "Properties" in data:
        ...
        out["properties"] = (
            aws_sdk_quicksight.types.asset_bundle_export_job_data_source_property_to_override_list.deserialize_json(
                data["Properties"]
            )
        )
    else:
