...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.list_control_search_options
...
class ListControlDisplayOptions(TypedDict):
    search_options: NotRequired[
        "aws_sdk_quicksight.types.list_control_search_options.ListControlSearchOptions"
    ]
...
def serialize_json(value: ListControlDisplayOptions) -> dict:
    ...
    if "search_options" in value:
        ...
        out["SearchOptions"] = (
            aws_sdk_quicksight.types.list_control_search_options.serialize_json(
...
def deserialize_json(data: dict) -> ListControlDisplayOptions:
    ...
    if "SearchOptions" in data:
        ...
        out["search_options"] = (
            aws_sdk_quicksight.types.list_control_search_options.deserialize_json(
                data["SearchOptions"]
            )
        )
