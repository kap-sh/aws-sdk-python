"""Generated from Smithy shape ``com.amazonaws.quicksight#RadarChartVisual``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.radar_chart_configuration
...
class RadarChartVisual(TypedDict, closed=True):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.radar_chart_configuration.RadarChartConfiguration"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: RadarChartVisual) -> dict:
    out: dict = {}
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.radar_chart_configuration.serialize_json(
...
def deserialize_json(data: dict) -> RadarChartVisual:
    out: RadarChartVisual = {}  # type: ignore[typeddict-item]
    if "VisualId" in data:
        out["visual_id"] = data["VisualId"]
    else:
        raise DeserializationError("RadarChartVisual.visual_id required")
    if "Title" in data:
        import aws_sdk_quicksight.types.visual_title_label_options
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.radar_chart_configuration.deserialize_json(
