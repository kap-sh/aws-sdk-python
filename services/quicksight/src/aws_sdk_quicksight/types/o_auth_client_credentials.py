...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.o_auth_username


class OAuthClientCredentials(TypedDict):
    ...
    username: NotRequired["aws_sdk_quicksight.types.o_auth_username.OAuthUsername"]
