...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.data_set_date_filter_condition
    import aws_sdk_quicksight.types.data_set_numeric_filter_condition
    import aws_sdk_quicksight.types.data_set_string_filter_condition
    import aws_sdk_quicksight.types.expression


class FilterOperation(TypedDict, closed=True):
    condition_expression: NotRequired["aws_sdk_quicksight.types.expression.Expression"]
    ...
    string_filter_condition: NotRequired[
        "aws_sdk_quicksight.types.data_set_string_filter_condition.DataSetStringFilterCondition"
    ]
    """<p>A string-based filter condition within a filter operation.</p>"""
    numeric_filter_condition: NotRequired[
        "aws_sdk_quicksight.types.data_set_numeric_filter_condition.DataSetNumericFilterCondition"
    ]
    """<p>A numeric-based filter condition within a filter operation.</p>"""
    date_filter_condition: NotRequired[
        "aws_sdk_quicksight.types.data_set_date_filter_condition.DataSetDateFilterCondition"
    ]
...
def serialize_json(value: FilterOperation) -> dict:
    ...
    if "string_filter_condition" in value:
        ...
        out["StringFilterCondition"] = (
            aws_sdk_quicksight.types.data_set_string_filter_condition.serialize_json(
    ...
    if "numeric_filter_condition" in value:
        ...
        out["NumericFilterCondition"] = (
            aws_sdk_quicksight.types.data_set_numeric_filter_condition.serialize_json(
    ...
    if "date_filter_condition" in value:
        ...
        out["DateFilterCondition"] = (
            aws_sdk_quicksight.types.data_set_date_filter_condition.serialize_json(
...
def deserialize_json(data: dict) -> FilterOperation:
    ...
    if "StringFilterCondition" in data:
        ...
        out["string_filter_condition"] = (
            aws_sdk_quicksight.types.data_set_string_filter_condition.deserialize_json(
    ...
    if "NumericFilterCondition" in data:
        ...
        out["numeric_filter_condition"] = (
            aws_sdk_quicksight.types.data_set_numeric_filter_condition.deserialize_json(
    ...
    if "DateFilterCondition" in data:
        ...
        out["date_filter_condition"] = (
            aws_sdk_quicksight.types.data_set_date_filter_condition.deserialize_json(
