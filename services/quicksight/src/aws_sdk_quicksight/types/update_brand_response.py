"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateBrandResponse``."""
...
class UpdateBrandResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateBrandResponse) -> dict:
    out: dict = {}
