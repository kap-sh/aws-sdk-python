...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.line_chart_configuration
...
class LineChartVisual(TypedDict):
    ...
    chart_configuration: NotRequired[
        "aws_sdk_quicksight.types.line_chart_configuration.LineChartConfiguration"
    ]
...
def serialize_json(value: LineChartVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            aws_sdk_quicksight.types.line_chart_configuration.serialize_json(
...
def deserialize_json(data: dict) -> LineChartVisual:
    ...
    if "ChartConfiguration" in data:
        ...
        out["chart_configuration"] = (
            aws_sdk_quicksight.types.line_chart_configuration.deserialize_json(
