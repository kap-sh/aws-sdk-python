"""Generated from Smithy shape ``com.amazonaws.quicksight#ListTemplateAliasesRequest``."""
...
class ListTemplateAliasesRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListTemplateAliasesRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListTemplateAliasesRequest:
    out: ListTemplateAliasesRequest = {}  # type: ignore[typeddict-item]
    return out
