...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.cross_dataset_types
    import aws_sdk_quicksight.types.filter_list
    import aws_sdk_quicksight.types.filter_scope_configuration
...
class FilterGroup(TypedDict):
    ...
    scope_configuration: (
        "aws_sdk_quicksight.types.filter_scope_configuration.FilterScopeConfiguration"
    )
    ...
    cross_dataset: "aws_sdk_quicksight.types.cross_dataset_types.CrossDatasetTypes"
...
def serialize_json(value: FilterGroup) -> dict:
    ...
    out["Filters"] = aws_sdk_quicksight.types.filter_list.serialize_json(
        value["filters"]
    )
    import aws_sdk_quicksight.types.filter_scope_configuration

    out["ScopeConfiguration"] = (
        aws_sdk_quicksight.types.filter_scope_configuration.serialize_json(
    ...
    out["CrossDataset"] = aws_sdk_quicksight.types.cross_dataset_types.serialize_json(
        value["cross_dataset"]
    )
    return out
...
def deserialize_json(data: dict) -> FilterGroup:
    ...
    if "Filters" in data:
        ...
        out["filters"] = aws_sdk_quicksight.types.filter_list.deserialize_json(
            data["Filters"]
        )
    else:
    ...
    if "ScopeConfiguration" in data:
        ...
        out["scope_configuration"] = (
            aws_sdk_quicksight.types.filter_scope_configuration.deserialize_json(
    ...
    if "CrossDataset" in data:
        ...
        out["cross_dataset"] = (
            aws_sdk_quicksight.types.cross_dataset_types.deserialize_json(
                data["CrossDataset"]
            )
        )
    else:
