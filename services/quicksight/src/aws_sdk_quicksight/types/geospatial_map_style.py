...
class GeospatialMapStyle(TypedDict):
    ...
    base_map_visibility: NotRequired["aws_sdk_quicksight.types.visibility.Visibility"]
...
def serialize_json(value: GeospatialMapStyle) -> dict:
    ...
    if "base_map_visibility" in value:
        ...
        out["BaseMapVisibility"] = aws_sdk_quicksight.types.visibility.serialize_json(
