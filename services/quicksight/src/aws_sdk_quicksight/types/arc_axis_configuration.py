...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.arc_axis_display_range
    import aws_sdk_quicksight.types.integer


class ArcAxisConfiguration(TypedDict):
    range: NotRequired[
        "aws_sdk_quicksight.types.arc_axis_display_range.ArcAxisDisplayRange"
    ]
    """<p>The arc axis range of a <code>GaugeChartVisual</code>.</p>"""
    reserve_range: "aws_sdk_quicksight.types.integer.Integer"
...
def serialize_json(value: ArcAxisConfiguration) -> dict:
    ...
    if "range" in value:
        ...
        out["Range"] = aws_sdk_quicksight.types.arc_axis_display_range.serialize_json(
            value["range"]
        )
...
def deserialize_json(data: dict) -> ArcAxisConfiguration:
    ...
    if "Range" in data:
        ...
        out["range"] = aws_sdk_quicksight.types.arc_axis_display_range.deserialize_json(
            data["Range"]
        )
