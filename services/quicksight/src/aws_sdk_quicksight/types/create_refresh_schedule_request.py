"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateRefreshScheduleRequest``."""
...
class CreateRefreshScheduleRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateRefreshScheduleRequest) -> dict:
    out: dict = {}
    import aws_sdk_quicksight.types.refresh_schedule
...
def deserialize_json(data: dict) -> CreateRefreshScheduleRequest:
    ...
    if "Schedule" in data:
        ...
        raise DeserializationError("CreateRefreshScheduleRequest.schedule required")
    return out
