...
class DeleteAnalysisResponse(TypedDict):
    ...
    deletion_time: NotRequired["aws_sdk_quicksight.types.timestamp.Timestamp"]
...
def serialize_json(value: DeleteAnalysisResponse) -> dict:
    ...
    if "deletion_time" in value:
        ...
        out["DeletionTime"] = aws_sdk_quicksight.types.timestamp.serialize_json(
            value["deletion_time"]
        )
...
def deserialize_json(data: dict) -> DeleteAnalysisResponse:
    ...
    if "DeletionTime" in data:
        ...
        out["deletion_time"] = aws_sdk_quicksight.types.timestamp.deserialize_json(
            data["DeletionTime"]
        )
