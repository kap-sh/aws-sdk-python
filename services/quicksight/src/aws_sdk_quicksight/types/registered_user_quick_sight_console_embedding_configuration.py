...
class RegisteredUserQuickSightConsoleEmbeddingConfiguration(TypedDict, closed=True):
    ...
    feature_configurations: NotRequired[
        "aws_sdk_quicksight.types.registered_user_console_feature_configurations.RegisteredUserConsoleFeatureConfigurations"
    ]
...
def serialize_json(
    ...
    if "feature_configurations" in value:
        ...
        out["FeatureConfigurations"] = (
            aws_sdk_quicksight.types.registered_user_console_feature_configurations.serialize_json(
...
def deserialize_json(
    ...
    if "FeatureConfigurations" in data:
        ...
        out["feature_configurations"] = (
            aws_sdk_quicksight.types.registered_user_console_feature_configurations.deserialize_json(
