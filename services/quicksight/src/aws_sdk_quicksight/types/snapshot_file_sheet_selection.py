...
if TYPE_CHECKING:
    ...
    import aws_sdk_quicksight.types.snapshot_file_sheet_selection_scope
    import aws_sdk_quicksight.types.snapshot_file_sheet_selection_visual_id_list


class SnapshotFileSheetSelection(TypedDict):
    ...
    selection_scope: "aws_sdk_quicksight.types.snapshot_file_sheet_selection_scope.SnapshotFileSheetSelectionScope"
    ...
    visual_ids: NotRequired[
        "aws_sdk_quicksight.types.snapshot_file_sheet_selection_visual_id_list.SnapshotFileSheetSelectionVisualIdList"
    ]
...
def serialize_json(value: SnapshotFileSheetSelection) -> dict:
    ...
    out["SelectionScope"] = (
        aws_sdk_quicksight.types.snapshot_file_sheet_selection_scope.serialize_json(
    ...
    if "visual_ids" in value:
        ...
        out["VisualIds"] = (
            aws_sdk_quicksight.types.snapshot_file_sheet_selection_visual_id_list.serialize_json(
                value["visual_ids"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> SnapshotFileSheetSelection:
    ...
    if "SelectionScope" in data:
        ...
        out["selection_scope"] = (
            aws_sdk_quicksight.types.snapshot_file_sheet_selection_scope.deserialize_json(
                data["SelectionScope"]
            )
        )
    else:
    ...
    if "VisualIds" in data:
        ...
        out["visual_ids"] = (
            aws_sdk_quicksight.types.snapshot_file_sheet_selection_visual_id_list.deserialize_json(
                data["VisualIds"]
            )
        )
    return out
