...
if TYPE_CHECKING:
    import aws_sdk_quicksight.types.ca_certificates_bundle_s3_uri
    import aws_sdk_quicksight.types.identity_provider_resource_uri
    import aws_sdk_quicksight.types.o_auth_scope
    import aws_sdk_quicksight.types.token_provider_url
...
class OAuthParameters(TypedDict, closed=True):
    ...
    identity_provider_resource_uri: NotRequired[
        "aws_sdk_quicksight.types.identity_provider_resource_uri.IdentityProviderResourceUri"
    ]
    """<p>The resource uri of the identity provider.</p>"""
    identity_provider_ca_certificates_bundle_s3_uri: NotRequired[
        "aws_sdk_quicksight.types.ca_certificates_bundle_s3_uri.CACertificatesBundleS3Uri"
    ]
