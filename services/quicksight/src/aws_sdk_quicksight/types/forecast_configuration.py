...
class ForecastConfiguration(TypedDict, closed=True):
    ...
    scenario: NotRequired["aws_sdk_quicksight.types.forecast_scenario.ForecastScenario"]
...
def serialize_json(value: ForecastConfiguration) -> dict:
    ...
    if "forecast_properties" in value:
        ...
        out["ForecastProperties"] = (
            aws_sdk_quicksight.types.time_based_forecast_properties.serialize_json(
    ...
    if "scenario" in value:
        ...
        out["Scenario"] = aws_sdk_quicksight.types.forecast_scenario.serialize_json(
            value["scenario"]
        )
    return out
...
def deserialize_json(data: dict) -> ForecastConfiguration:
    ...
    if "ForecastProperties" in data:
        ...
        out["forecast_properties"] = (
            aws_sdk_quicksight.types.time_based_forecast_properties.deserialize_json(
    ...
    if "Scenario" in data:
        ...
        out["scenario"] = aws_sdk_quicksight.types.forecast_scenario.deserialize_json(
            data["Scenario"]
        )
    return out
