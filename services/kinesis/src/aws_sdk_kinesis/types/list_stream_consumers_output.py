...
class ListStreamConsumersOutput(TypedDict):
    consumers: NotRequired["aws_sdk_kinesis.types.consumer_list.ConsumerList"]
...
def serialize_aws_json_1_1(value: ListStreamConsumersOutput) -> dict:
    ...
    if "consumers" in value:
        ...
        out["Consumers"] = aws_sdk_kinesis.types.consumer_list.serialize_aws_json_1_1(
            value["consumers"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListStreamConsumersOutput:
    ...
    if "Consumers" in data:
        ...
        out["consumers"] = aws_sdk_kinesis.types.consumer_list.deserialize_aws_json_1_1(
            data["Consumers"]
        )
