...
if TYPE_CHECKING:
    import aws_sdk_kinesis.types.minimum_throughput_billing_commitment_output_status
...
class MinimumThroughputBillingCommitmentOutput(TypedDict, closed=True):
    ...
    ended_at: NotRequired["aws_sdk_kinesis.types.timestamp.Timestamp"]
    """<p>The timestamp when the commitment was ended.</p>"""
    earliest_allowed_end_at: NotRequired["aws_sdk_kinesis.types.timestamp.Timestamp"]
...
def serialize_aws_json_1_1(value: MinimumThroughputBillingCommitmentOutput) -> dict:
    ...
    out["Status"] = (
        aws_sdk_kinesis.types.minimum_throughput_billing_commitment_output_status.serialize_aws_json_1_1(
            value["status"]
        )
    )
    if "started_at" in value:
        ...
        out["StartedAt"] = aws_sdk_kinesis.types.timestamp.serialize_aws_json_1_1(
            value["started_at"]
        )
    if "ended_at" in value:
        import aws_sdk_kinesis.types.timestamp

        out["EndedAt"] = aws_sdk_kinesis.types.timestamp.serialize_aws_json_1_1(
            value["ended_at"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> MinimumThroughputBillingCommitmentOutput:
    ...
    if "Status" in data:
        ...
        out["status"] = (
            aws_sdk_kinesis.types.minimum_throughput_billing_commitment_output_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
    else:
    ...
    if "StartedAt" in data:
        ...
        out["started_at"] = aws_sdk_kinesis.types.timestamp.deserialize_aws_json_1_1(
            data["StartedAt"]
        )
    if "EndedAt" in data:
        import aws_sdk_kinesis.types.timestamp

        out["ended_at"] = aws_sdk_kinesis.types.timestamp.deserialize_aws_json_1_1(
            data["EndedAt"]
        )
