...
class PutRecordsInput(TypedDict):
...
def serialize_aws_json_1_1(value: PutRecordsInput) -> dict:
    ...
    out["Records"] = (
        aws_sdk_kinesis.types.put_records_request_entry_list.serialize_aws_json_1_1(
            value["records"]
        )
    )
...
def deserialize_aws_json_1_1(data: dict) -> PutRecordsInput:
    ...
    if "Records" in data:
        ...
        out["records"] = (
            aws_sdk_kinesis.types.put_records_request_entry_list.deserialize_aws_json_1_1(
                data["Records"]
            )
        )
    else:
