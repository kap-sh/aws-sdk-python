...
if TYPE_CHECKING:
    import aws_sdk_kinesis.types.consumer_count_object
...
class StreamDescriptionSummary(TypedDict):
    ...
    consumer_count: NotRequired[
        "aws_sdk_kinesis.types.consumer_count_object.ConsumerCountObject"
    ]
