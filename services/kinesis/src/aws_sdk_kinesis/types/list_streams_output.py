...
if TYPE_CHECKING:
    ...
    import aws_sdk_kinesis.types.stream_name_list
...
class ListStreamsOutput(TypedDict, closed=True):
    ...
    stream_summaries: NotRequired[
        "aws_sdk_kinesis.types.stream_summary_list.StreamSummaryList"
    ]
    """<p></p>"""
...
def serialize_aws_json_1_1(value: ListStreamsOutput) -> dict:
    ...
    out["StreamNames"] = aws_sdk_kinesis.types.stream_name_list.serialize_aws_json_1_1(
        value["stream_names"]
    )
    ...
    if "stream_summaries" in value:
        ...
        out["StreamSummaries"] = (
            aws_sdk_kinesis.types.stream_summary_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListStreamsOutput:
    ...
    if "StreamNames" in data:
        ...
        out["stream_names"] = (
            aws_sdk_kinesis.types.stream_name_list.deserialize_aws_json_1_1(
                data["StreamNames"]
            )
        )
    else:
    ...
    if "StreamSummaries" in data:
        ...
        out["stream_summaries"] = (
            aws_sdk_kinesis.types.stream_summary_list.deserialize_aws_json_1_1(
