...
class ListShardsInput(TypedDict):
    ...
    shard_filter: NotRequired["aws_sdk_kinesis.types.shard_filter.ShardFilter"]
...
def serialize_aws_json_1_1(value: ListShardsInput) -> dict:
    ...
    if "shard_filter" in value:
        ...
        out["ShardFilter"] = aws_sdk_kinesis.types.shard_filter.serialize_aws_json_1_1(
            value["shard_filter"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListShardsInput:
    ...
    if "ShardFilter" in data:
        ...
        out["shard_filter"] = (
            aws_sdk_kinesis.types.shard_filter.deserialize_aws_json_1_1(
                data["ShardFilter"]
            )
        )
