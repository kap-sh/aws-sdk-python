...
if TYPE_CHECKING:
    import aws_sdk_kinesis.types.shard_filter_type
...
def serialize_aws_json_1_1(value: ShardFilter) -> dict:
    ...
    out["Type"] = aws_sdk_kinesis.types.shard_filter_type.serialize_aws_json_1_1(
        value["type"]
    )
...
def deserialize_aws_json_1_1(data: dict) -> ShardFilter:
    ...
    if "Type" in data:
        ...
        out["type"] = aws_sdk_kinesis.types.shard_filter_type.deserialize_aws_json_1_1(
            data["Type"]
        )
    else:
