"""Generated from Smithy shape ``com.amazonaws.kinesis#IncreaseStreamRetentionPeriod``."""
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.increase_stream_retention_period_input.IncreaseStreamRetentionPeriodInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.increase_stream_retention_period_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_increase_stream_retention_period(
