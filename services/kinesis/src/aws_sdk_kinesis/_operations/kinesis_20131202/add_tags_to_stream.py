"""Generated from Smithy shape ``com.amazonaws.kinesis#AddTagsToStream``."""
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.add_tags_to_stream_input.AddTagsToStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.add_tags_to_stream_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_add_tags_to_stream(
