"""Generated from Smithy shape ``com.amazonaws.kinesis#MergeShards``."""
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.merge_shards_input.MergeShardsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.merge_shards_input.serialize_aws_json_1_1(input_)
    ).encode()
