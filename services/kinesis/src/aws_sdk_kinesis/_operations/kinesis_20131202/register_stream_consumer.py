"""Generated from Smithy shape ``com.amazonaws.kinesis#RegisterStreamConsumer``."""
...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.register_stream_consumer_output.RegisterStreamConsumerOutput = aws_sdk_kinesis.types.register_stream_consumer_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.register_stream_consumer_input.RegisterStreamConsumerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.register_stream_consumer_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_register_stream_consumer(
