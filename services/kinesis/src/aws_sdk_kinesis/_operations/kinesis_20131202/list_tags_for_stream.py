"""Generated from Smithy shape ``com.amazonaws.kinesis#ListTagsForStream``."""
...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.list_tags_for_stream_output.ListTagsForStreamOutput = (
        aws_sdk_kinesis.types.list_tags_for_stream_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.list_tags_for_stream_input.ListTagsForStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.list_tags_for_stream_input.serialize_aws_json_1_1(input_)
    ).encode()
