"""Generated from Smithy shape ``com.amazonaws.kinesis#GetShardIterator``."""
...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.get_shard_iterator_output.GetShardIteratorOutput = (
        aws_sdk_kinesis.types.get_shard_iterator_output.deserialize_aws_json_1_1(
