"""Generated from Smithy shape ``com.amazonaws.kinesis#DeleteStream``."""
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.delete_stream_input.DeleteStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.delete_stream_input.serialize_aws_json_1_1(input_)
    ).encode()
