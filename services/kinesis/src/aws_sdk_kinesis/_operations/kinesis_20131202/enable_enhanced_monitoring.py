"""Generated from Smithy shape ``com.amazonaws.kinesis#EnableEnhancedMonitoring``."""
...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.enhanced_monitoring_output.EnhancedMonitoringOutput = (
        aws_sdk_kinesis.types.enhanced_monitoring_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.enable_enhanced_monitoring_input.EnableEnhancedMonitoringInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.enable_enhanced_monitoring_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_enable_enhanced_monitoring(
