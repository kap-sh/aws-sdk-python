...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.update_stream_warm_throughput_output.UpdateStreamWarmThroughputOutput = aws_sdk_kinesis.types.update_stream_warm_throughput_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.update_stream_warm_throughput_input.UpdateStreamWarmThroughputInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.update_stream_warm_throughput_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
