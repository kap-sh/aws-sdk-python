...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.update_account_settings_output.UpdateAccountSettingsOutput = aws_sdk_kinesis.types.update_account_settings_output.deserialize_aws_json_1_1(
