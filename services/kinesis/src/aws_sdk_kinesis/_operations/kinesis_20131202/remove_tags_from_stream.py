...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.remove_tags_from_stream_input.RemoveTagsFromStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.remove_tags_from_stream_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
