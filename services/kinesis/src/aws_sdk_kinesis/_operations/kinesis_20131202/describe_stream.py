"""Generated from Smithy shape ``com.amazonaws.kinesis#DescribeStream``."""
...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.describe_stream_output.DescribeStreamOutput = (
        aws_sdk_kinesis.types.describe_stream_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.describe_stream_input.DescribeStreamInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.describe_stream_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_stream(
    ...
    aws_sdk_kinesis.types.describe_stream_output.DescribeStreamOutput, zapros.Response
]:
