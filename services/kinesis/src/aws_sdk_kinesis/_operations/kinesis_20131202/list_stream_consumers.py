...
def build_request(
    ...
    input: aws_sdk_kinesis.types.list_stream_consumers_input.ListStreamConsumersInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.list_stream_consumers_input.serialize_aws_json_1_1(input)
    ).encode()
