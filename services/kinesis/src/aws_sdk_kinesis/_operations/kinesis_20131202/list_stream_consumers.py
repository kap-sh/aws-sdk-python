...
import aws_sdk_kinesis.types.consumer_list
...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.list_stream_consumers_output.ListStreamConsumersOutput = aws_sdk_kinesis.types.list_stream_consumers_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.list_stream_consumers_input.ListStreamConsumersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.list_stream_consumers_input.serialize_aws_json_1_1(input_)
    ).encode()
