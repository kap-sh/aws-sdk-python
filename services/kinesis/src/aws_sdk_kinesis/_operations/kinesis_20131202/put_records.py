...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.put_records_output.PutRecordsOutput = (
        aws_sdk_kinesis.types.put_records_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.put_records_input.PutRecordsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.put_records_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_records(
    ...
    input_: aws_sdk_kinesis.types.put_records_input.PutRecordsInput,
) -> tuple[aws_sdk_kinesis.types.put_records_output.PutRecordsOutput, zapros.Response]:
