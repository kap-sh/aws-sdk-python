"""Generated from Smithy shape ``com.amazonaws.kinesis#DescribeStreamSummary``."""
...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.describe_stream_summary_output.DescribeStreamSummaryOutput = aws_sdk_kinesis.types.describe_stream_summary_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.describe_stream_summary_input.DescribeStreamSummaryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.describe_stream_summary_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_stream_summary(
