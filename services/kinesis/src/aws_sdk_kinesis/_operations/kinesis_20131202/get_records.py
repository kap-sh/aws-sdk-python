...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ExpiredIteratorException":
            import aws_sdk_kinesis.errors.expired_iterator_exception

            raise aws_sdk_kinesis.errors.expired_iterator_exception.ExpiredIteratorException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.get_records_output.GetRecordsOutput = (
        aws_sdk_kinesis.types.get_records_output.deserialize_aws_json_1_1(
