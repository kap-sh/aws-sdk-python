...
from aws_sdk_kinesis._protocol.eventstream import (
    MessageDecoder,
    async_read_messages,
    read_messages,
)
...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.subscribe_to_shard_output.SubscribeToShardOutput = {}  # type: ignore[typeddict-item]
    out["event_stream"] = cast(
        Any,
        aws_sdk_kinesis._iter.map_sync_iterator(
            _messages,
            aws_sdk_kinesis.types.subscribe_to_shard_event_stream.deserialize_event_aws_json_1_1,
        ),
    )
    return out
...
async def async_handle_response(
    ...
    out["event_stream"] = cast(
        Any,
        aws_sdk_kinesis._iter.map_async_iterator(
            _messages,
            aws_sdk_kinesis.types.subscribe_to_shard_event_stream.deserialize_event_aws_json_1_1,
        ),
    )
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.subscribe_to_shard_input.SubscribeToShardInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.subscribe_to_shard_input.serialize_aws_json_1_1(input_)
    ).encode()
