...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.subscribe_to_shard_output.SubscribeToShardOutput = (
        aws_sdk_kinesis.types.subscribe_to_shard_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.subscribe_to_shard_input.serialize_aws_json_1_1(input)
    ).encode()
