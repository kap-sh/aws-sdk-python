...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.describe_limits_output.DescribeLimitsOutput = (
        aws_sdk_kinesis.types.describe_limits_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.describe_limits_input.DescribeLimitsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_limits(
    ...
    aws_sdk_kinesis.types.describe_limits_output.DescribeLimitsOutput, zapros.Response
]:
