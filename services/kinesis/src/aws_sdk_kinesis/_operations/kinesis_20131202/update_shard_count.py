...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.update_shard_count_output.UpdateShardCountOutput = (
        aws_sdk_kinesis.types.update_shard_count_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.update_shard_count_input.UpdateShardCountInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.update_shard_count_input.serialize_aws_json_1_1(input_)
    ).encode()
