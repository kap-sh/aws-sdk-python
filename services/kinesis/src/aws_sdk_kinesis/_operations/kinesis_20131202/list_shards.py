"""Generated from Smithy shape ``com.amazonaws.kinesis#ListShards``."""
...
import aws_sdk_kinesis.errors.expired_next_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ExpiredNextTokenException":
            raise aws_sdk_kinesis.errors.expired_next_token_exception.ExpiredNextTokenException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_kinesis.types.list_shards_output.ListShardsOutput = (
        aws_sdk_kinesis.types.list_shards_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_kinesis.types.list_shards_input.ListShardsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_kinesis.types.list_shards_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_shards(
    ...
    input_: aws_sdk_kinesis.types.list_shards_input.ListShardsInput,
) -> tuple[aws_sdk_kinesis.types.list_shards_output.ListShardsOutput, zapros.Response]:
