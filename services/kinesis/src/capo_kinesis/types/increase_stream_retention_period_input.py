"""Generated from Smithy shape ``com.amazonaws.kinesis#IncreaseStreamRetentionPeriodInput``."""
...
class IncreaseStreamRetentionPeriodInput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: IncreaseStreamRetentionPeriodInput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> IncreaseStreamRetentionPeriodInput:
    out: IncreaseStreamRetentionPeriodInput = {}  # type: ignore[typeddict-item]
    ...
    if "RetentionPeriodHours" in data:
        ...
        raise DeserializationError(
            "IncreaseStreamRetentionPeriodInput.retention_period_hours required"
        )
