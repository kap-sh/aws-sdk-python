...
class KinesisError(Exception):
    """Base class for all Kinesis service errors."""


class ServiceError(KinesisError):
...
class SerializationError(KinesisError):
    """Raised when a value cannot be serialized."""


class DeserializationError(KinesisError):
...
class WaiterFailedError(KinesisError):
...
class WaiterTimeoutError(KinesisError):
