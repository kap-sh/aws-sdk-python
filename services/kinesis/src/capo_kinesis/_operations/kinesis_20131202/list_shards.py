...
import capo_kinesis.errors.expired_next_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ExpiredNextTokenException":
            raise capo_kinesis.errors.expired_next_token_exception.ExpiredNextTokenException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_kinesis.types.list_shards_output.ListShardsOutput = (
        capo_kinesis.types.list_shards_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis.types.list_shards_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_shards(
    ...
    input_: capo_kinesis.types.list_shards_input.ListShardsInput,
) -> tuple[capo_kinesis.types.list_shards_output.ListShardsOutput, zapros.Response]:
