...
def handle_response(
    ...
    out: capo_kinesis.types.list_tags_for_stream_output.ListTagsForStreamOutput = (
        capo_kinesis.types.list_tags_for_stream_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis.types.list_tags_for_stream_input.serialize_aws_json_1_1(input_)
    ).encode()
