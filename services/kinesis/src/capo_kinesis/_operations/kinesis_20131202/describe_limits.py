"""Generated from Smithy shape ``com.amazonaws.kinesis#DescribeLimits``."""
...
def handle_response(
    ...
    out: capo_kinesis.types.describe_limits_output.DescribeLimitsOutput = (
        capo_kinesis.types.describe_limits_output.deserialize_aws_json_1_1(
...
def describe_limits(
    ...
    capo_kinesis.types.describe_limits_output.DescribeLimitsOutput, zapros.Response
]:
