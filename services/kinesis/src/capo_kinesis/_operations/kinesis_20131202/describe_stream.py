...
def handle_response(
    ...
    out: capo_kinesis.types.describe_stream_output.DescribeStreamOutput = (
        capo_kinesis.types.describe_stream_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis.types.describe_stream_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_stream(
    ...
    capo_kinesis.types.describe_stream_output.DescribeStreamOutput, zapros.Response
]:
