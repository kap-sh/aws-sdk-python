"""Generated from Smithy shape ``com.amazonaws.kinesis#UpdateAccountSettings``."""
...
def handle_response(
    ...
    out: capo_kinesis.types.update_account_settings_output.UpdateAccountSettingsOutput = capo_kinesis.types.update_account_settings_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Kinesis_20131202.UpdateAccountSettings"
    body: bytes | None = json.dumps(
        capo_kinesis.types.update_account_settings_input.serialize_aws_json_1_1(input_)
    ).encode()
