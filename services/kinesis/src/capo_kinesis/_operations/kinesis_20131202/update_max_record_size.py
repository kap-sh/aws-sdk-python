"""Generated from Smithy shape ``com.amazonaws.kinesis#UpdateMaxRecordSize``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis.types.update_max_record_size_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_update_max_record_size(
