"""Generated from Smithy shape ``com.amazonaws.kinesis#UpdateStreamWarmThroughput``."""
...
import capo_kinesis.errors.validation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ValidationException":
            raise capo_kinesis.errors.validation_exception.ValidationException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_kinesis.types.update_stream_warm_throughput_output.UpdateStreamWarmThroughputOutput = capo_kinesis.types.update_stream_warm_throughput_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Kinesis_20131202.UpdateStreamWarmThroughput"
    body: bytes | None = json.dumps(
        capo_kinesis.types.update_stream_warm_throughput_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_stream_warm_throughput(
