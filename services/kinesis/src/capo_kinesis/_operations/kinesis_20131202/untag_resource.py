"""Generated from Smithy shape ``com.amazonaws.kinesis#UntagResource``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Kinesis_20131202.UntagResource"
    body: bytes | None = json.dumps(
        capo_kinesis.types.untag_resource_input.serialize_aws_json_1_1(input_)
    ).encode()
