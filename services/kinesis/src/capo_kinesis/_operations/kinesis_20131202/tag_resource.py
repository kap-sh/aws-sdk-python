"""Generated from Smithy shape ``com.amazonaws.kinesis#TagResource``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Kinesis_20131202.TagResource"
    body: bytes | None = json.dumps(
        capo_kinesis.types.tag_resource_input.serialize_aws_json_1_1(input_)
    ).encode()
