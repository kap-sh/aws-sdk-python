"""Generated from Smithy shape ``com.amazonaws.kinesis#PutRecords``."""
...
def handle_response(
    ...
    out: capo_kinesis.types.put_records_output.PutRecordsOutput = (
        capo_kinesis.types.put_records_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis.types.put_records_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_records(
    ...
    input_: capo_kinesis.types.put_records_input.PutRecordsInput,
) -> tuple[capo_kinesis.types.put_records_output.PutRecordsOutput, zapros.Response]:
