"""Generated from Smithy shape ``com.amazonaws.kinesis#DeleteResourcePolicy``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Kinesis_20131202.DeleteResourcePolicy"
    body: bytes | None = json.dumps(
        capo_kinesis.types.delete_resource_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
