"""Generated from Smithy shape ``com.amazonaws.kinesis#UpdateStreamMode``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Kinesis_20131202.UpdateStreamMode"
    body: bytes | None = json.dumps(
        capo_kinesis.types.update_stream_mode_input.serialize_aws_json_1_1(input_)
    ).encode()
