"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#StopSNOMEDCTInferenceJob``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.stop_snomedct_inference_job_response.StopSNOMEDCTInferenceJobResponse = aws_sdk_comprehendmedical.types.stop_snomedct_inference_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.stop_snomedct_inference_job_request.StopSNOMEDCTInferenceJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ComprehendMedical_20181030.StopSNOMEDCTInferenceJob"
    import aws_sdk_comprehendmedical.types.stop_snomedct_inference_job_request

    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.stop_snomedct_inference_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_snomedct_inference_job(
