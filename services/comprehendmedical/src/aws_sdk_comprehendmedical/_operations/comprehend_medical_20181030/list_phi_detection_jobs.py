...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.list_phi_detection_jobs_response.ListPHIDetectionJobsResponse = aws_sdk_comprehendmedical.types.list_phi_detection_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.list_phi_detection_jobs_request.ListPHIDetectionJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.list_phi_detection_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
