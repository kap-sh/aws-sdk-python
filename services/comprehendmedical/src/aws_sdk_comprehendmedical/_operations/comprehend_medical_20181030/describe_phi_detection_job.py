"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#DescribePHIDetectionJob``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.describe_phi_detection_job_response.DescribePHIDetectionJobResponse = aws_sdk_comprehendmedical.types.describe_phi_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.describe_phi_detection_job_request.DescribePHIDetectionJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ComprehendMedical_20181030.DescribePHIDetectionJob"
    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.describe_phi_detection_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_phi_detection_job(
