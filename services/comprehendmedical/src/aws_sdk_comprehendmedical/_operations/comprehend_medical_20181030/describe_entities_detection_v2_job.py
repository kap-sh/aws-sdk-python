...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.describe_entities_detection_v2_job_response.DescribeEntitiesDetectionV2JobResponse = aws_sdk_comprehendmedical.types.describe_entities_detection_v2_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.describe_entities_detection_v2_job_request.DescribeEntitiesDetectionV2JobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.describe_entities_detection_v2_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
