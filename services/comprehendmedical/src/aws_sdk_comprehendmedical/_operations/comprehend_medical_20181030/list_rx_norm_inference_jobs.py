"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#ListRxNormInferenceJobs``."""
...
import aws_sdk_comprehendmedical.errors.validation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ValidationException":
            raise aws_sdk_comprehendmedical.errors.validation_exception.ValidationException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.list_rx_norm_inference_jobs_response.ListRxNormInferenceJobsResponse = aws_sdk_comprehendmedical.types.list_rx_norm_inference_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.list_rx_norm_inference_jobs_request.ListRxNormInferenceJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ComprehendMedical_20181030.ListRxNormInferenceJobs"
    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.list_rx_norm_inference_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_rx_norm_inference_jobs(
