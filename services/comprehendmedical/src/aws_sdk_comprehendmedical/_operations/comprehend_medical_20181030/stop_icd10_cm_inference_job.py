...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.stop_icd10_cm_inference_job_response.StopICD10CMInferenceJobResponse = aws_sdk_comprehendmedical.types.stop_icd10_cm_inference_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.stop_icd10_cm_inference_job_request.StopICD10CMInferenceJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.stop_icd10_cm_inference_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
