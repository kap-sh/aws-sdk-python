...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.infer_snomedct_response.InferSNOMEDCTResponse = aws_sdk_comprehendmedical.types.infer_snomedct_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.infer_snomedct_request.InferSNOMEDCTRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.infer_snomedct_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
