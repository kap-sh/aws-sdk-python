...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.infer_rx_norm_response.InferRxNormResponse = (
        aws_sdk_comprehendmedical.types.infer_rx_norm_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.infer_rx_norm_request.InferRxNormRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.infer_rx_norm_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
