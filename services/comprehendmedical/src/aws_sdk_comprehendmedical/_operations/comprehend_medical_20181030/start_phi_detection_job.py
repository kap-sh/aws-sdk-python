"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#StartPHIDetectionJob``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.start_phi_detection_job_response.StartPHIDetectionJobResponse = aws_sdk_comprehendmedical.types.start_phi_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.start_phi_detection_job_request.StartPHIDetectionJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.start_phi_detection_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_phi_detection_job(
