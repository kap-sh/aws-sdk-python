...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.detect_phi_response.DetectPHIResponse = (
        aws_sdk_comprehendmedical.types.detect_phi_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_comprehendmedical.types.detect_phi_request.DetectPHIRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.detect_phi_request.serialize_aws_json_1_1(input)
    ).encode()
