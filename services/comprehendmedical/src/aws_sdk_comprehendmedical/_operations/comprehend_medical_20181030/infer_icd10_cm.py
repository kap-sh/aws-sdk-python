...
import aws_sdk_comprehendmedical.types.icd10_cm_entity_list
...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.infer_icd10_cm_response.InferICD10CMResponse = aws_sdk_comprehendmedical.types.infer_icd10_cm_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.infer_icd10_cm_request.InferICD10CMRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.infer_icd10_cm_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
