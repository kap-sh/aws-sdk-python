...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.list_entities_detection_v2_jobs_response.ListEntitiesDetectionV2JobsResponse = aws_sdk_comprehendmedical.types.list_entities_detection_v2_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.list_entities_detection_v2_jobs_request.ListEntitiesDetectionV2JobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.list_entities_detection_v2_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
