...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.list_snomedct_inference_jobs_response.ListSNOMEDCTInferenceJobsResponse = aws_sdk_comprehendmedical.types.list_snomedct_inference_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.list_snomedct_inference_jobs_request.ListSNOMEDCTInferenceJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.list_snomedct_inference_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
