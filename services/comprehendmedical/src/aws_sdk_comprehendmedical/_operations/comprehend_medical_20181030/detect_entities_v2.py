...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.detect_entities_v2_request.DetectEntitiesV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.detect_entities_v2_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
