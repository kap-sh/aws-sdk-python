...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.stop_rx_norm_inference_job_response.StopRxNormInferenceJobResponse = aws_sdk_comprehendmedical.types.stop_rx_norm_inference_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.stop_rx_norm_inference_job_request.StopRxNormInferenceJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.stop_rx_norm_inference_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
