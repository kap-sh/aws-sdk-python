"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#StopEntitiesDetectionV2Job``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.stop_entities_detection_v2_job_response.StopEntitiesDetectionV2JobResponse = aws_sdk_comprehendmedical.types.stop_entities_detection_v2_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.stop_entities_detection_v2_job_request.StopEntitiesDetectionV2JobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ComprehendMedical_20181030.StopEntitiesDetectionV2Job"
    import aws_sdk_comprehendmedical.types.stop_entities_detection_v2_job_request

    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.stop_entities_detection_v2_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_entities_detection_v2_job(
