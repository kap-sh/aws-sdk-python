"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#DescribeRxNormInferenceJob``."""
...
def handle_response(
    ...
    out: aws_sdk_comprehendmedical.types.describe_rx_norm_inference_job_response.DescribeRxNormInferenceJobResponse = aws_sdk_comprehendmedical.types.describe_rx_norm_inference_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_comprehendmedical.types.describe_rx_norm_inference_job_request.DescribeRxNormInferenceJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ComprehendMedical_20181030.DescribeRxNormInferenceJob"
    import aws_sdk_comprehendmedical.types.describe_rx_norm_inference_job_request

    body: bytes | None = json.dumps(
        aws_sdk_comprehendmedical.types.describe_rx_norm_inference_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_rx_norm_inference_job(
