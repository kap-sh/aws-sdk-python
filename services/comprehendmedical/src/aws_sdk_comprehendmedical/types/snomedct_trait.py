...
if TYPE_CHECKING:
    ...
    import aws_sdk_comprehendmedical.types.snomedct_trait_name


class SNOMEDCTTrait(TypedDict):
    name: NotRequired[
        "aws_sdk_comprehendmedical.types.snomedct_trait_name.SNOMEDCTTraitName"
    ]
...
def serialize_aws_json_1_1(value: SNOMEDCTTrait) -> dict:
    ...
    if "name" in value:
        ...
        out["Name"] = (
            aws_sdk_comprehendmedical.types.snomedct_trait_name.serialize_aws_json_1_1(
                value["name"]
            )
        )
    if "score" in value:
...
def deserialize_aws_json_1_1(data: dict) -> SNOMEDCTTrait:
    ...
    if "Name" in data:
        ...
        out["name"] = (
            aws_sdk_comprehendmedical.types.snomedct_trait_name.deserialize_aws_json_1_1(
                data["Name"]
            )
        )
    if "Score" in data:
