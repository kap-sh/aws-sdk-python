"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#DescribeICD10CMInferenceJobResponse``."""
...
class DescribeICD10CMInferenceJobResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeICD10CMInferenceJobResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DescribeICD10CMInferenceJobResponse:
    out: DescribeICD10CMInferenceJobResponse = {}  # type: ignore[typeddict-item]
