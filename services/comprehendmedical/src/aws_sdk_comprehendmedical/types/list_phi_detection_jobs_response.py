"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#ListPHIDetectionJobsResponse``."""
...
class ListPHIDetectionJobsResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListPHIDetectionJobsResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListPHIDetectionJobsResponse:
    out: ListPHIDetectionJobsResponse = {}  # type: ignore[typeddict-item]
