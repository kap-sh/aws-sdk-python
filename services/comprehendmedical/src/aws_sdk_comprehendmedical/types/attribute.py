...
if TYPE_CHECKING:
    ...
    import aws_sdk_comprehendmedical.types.relationship_type
...
class Attribute(TypedDict, closed=True):
    ...
    relationship_type: NotRequired[
        "aws_sdk_comprehendmedical.types.relationship_type.RelationshipType"
    ]
...
def serialize_aws_json_1_1(value: Attribute) -> dict:
    ...
    if "relationship_type" in value:
        ...
        out["RelationshipType"] = (
            aws_sdk_comprehendmedical.types.relationship_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Attribute:
    ...
    if "RelationshipType" in data:
        ...
        out["relationship_type"] = (
            aws_sdk_comprehendmedical.types.relationship_type.deserialize_aws_json_1_1(
