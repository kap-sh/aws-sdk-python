...
AttributeList: TypeAlias = list["aws_sdk_comprehendmedical.types.attribute.Attribute"]
...
def serialize_aws_json_1_1(value: AttributeList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_comprehendmedical.types.attribute.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> AttributeList:
    ...
    for item in data:
        out.append(
            aws_sdk_comprehendmedical.types.attribute.deserialize_aws_json_1_1(item)
        )
    return out
