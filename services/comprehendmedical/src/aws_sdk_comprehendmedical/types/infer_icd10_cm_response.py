...
def serialize_aws_json_1_1(value: InferICD10CMResponse) -> dict:
    ...
    out["Entities"] = (
        aws_sdk_comprehendmedical.types.icd10_cm_entity_list.serialize_aws_json_1_1(
            value["entities"]
        )
    )
...
def deserialize_aws_json_1_1(data: dict) -> InferICD10CMResponse:
    ...
    if "Entities" in data:
        ...
        out["entities"] = (
            aws_sdk_comprehendmedical.types.icd10_cm_entity_list.deserialize_aws_json_1_1(
                data["Entities"]
            )
        )
    else:
