...
class ComprehendMedicalError(Exception):
    """Base class for all ComprehendMedical service errors."""


class ServiceError(ComprehendMedicalError):
...
class SerializationError(ComprehendMedicalError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ComprehendMedicalError):
...
class WaiterFailedError(ComprehendMedicalError):
...
class WaiterTimeoutError(ComprehendMedicalError):
