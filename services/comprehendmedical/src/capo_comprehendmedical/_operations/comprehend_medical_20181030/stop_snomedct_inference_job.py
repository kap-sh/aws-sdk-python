...
def handle_response(
    ...
    out: capo_comprehendmedical.types.stop_snomedct_inference_job_response.StopSNOMEDCTInferenceJobResponse = capo_comprehendmedical.types.stop_snomedct_inference_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.stop_snomedct_inference_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
