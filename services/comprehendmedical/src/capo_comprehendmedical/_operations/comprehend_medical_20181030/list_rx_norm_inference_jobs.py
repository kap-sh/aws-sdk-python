...
import capo_comprehendmedical.errors.validation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ValidationException":
            raise capo_comprehendmedical.errors.validation_exception.ValidationException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_comprehendmedical.types.list_rx_norm_inference_jobs_response.ListRxNormInferenceJobsResponse = capo_comprehendmedical.types.list_rx_norm_inference_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.list_rx_norm_inference_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
