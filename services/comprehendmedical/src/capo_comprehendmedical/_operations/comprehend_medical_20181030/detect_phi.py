"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#DetectPHI``."""
...
import capo_comprehendmedical.errors.invalid_encoding_exception
import capo_comprehendmedical.errors.invalid_request_exception
import capo_comprehendmedical.errors.service_unavailable_exception
import capo_comprehendmedical.errors.text_size_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidEncodingException":
            raise capo_comprehendmedical.errors.invalid_encoding_exception.InvalidEncodingException.from_aws_json_1_1(
                data
            )
        ...
        case "ServiceUnavailableException":
            raise capo_comprehendmedical.errors.service_unavailable_exception.ServiceUnavailableException.from_aws_json_1_1(
                data
            )
        case "TextSizeLimitExceededException":
            raise capo_comprehendmedical.errors.text_size_limit_exceeded_exception.TextSizeLimitExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_comprehendmedical.types.detect_phi_response.DetectPHIResponse = (
        capo_comprehendmedical.types.detect_phi_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.detect_phi_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def detect_phi(
    ...
    capo_comprehendmedical.types.detect_phi_response.DetectPHIResponse, zapros.Response
]:
