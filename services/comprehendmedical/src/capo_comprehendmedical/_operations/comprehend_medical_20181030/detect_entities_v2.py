"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#DetectEntitiesV2``."""
...
def handle_response(
    ...
    out: capo_comprehendmedical.types.detect_entities_v2_response.DetectEntitiesV2Response = capo_comprehendmedical.types.detect_entities_v2_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.detect_entities_v2_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_detect_entities_v2(
