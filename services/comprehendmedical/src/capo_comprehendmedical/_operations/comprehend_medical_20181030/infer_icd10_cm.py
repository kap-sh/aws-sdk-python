"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#InferICD10CM``."""
...
def handle_response(
    ...
    out: capo_comprehendmedical.types.infer_icd10_cm_response.InferICD10CMResponse = (
        capo_comprehendmedical.types.infer_icd10_cm_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.infer_icd10_cm_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_infer_icd10_cm(
