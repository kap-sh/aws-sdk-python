"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#DetectEntities``."""
...
def handle_response(
    ...
    out: capo_comprehendmedical.types.detect_entities_response.DetectEntitiesResponse = capo_comprehendmedical.types.detect_entities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.detect_entities_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_detect_entities(
