"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#StartICD10CMInferenceJob``."""
...
def handle_response(
    ...
    out: capo_comprehendmedical.types.start_icd10_cm_inference_job_response.StartICD10CMInferenceJobResponse = capo_comprehendmedical.types.start_icd10_cm_inference_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComprehendMedical_20181030.StartICD10CMInferenceJob"
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.start_icd10_cm_inference_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_icd10_cm_inference_job(
