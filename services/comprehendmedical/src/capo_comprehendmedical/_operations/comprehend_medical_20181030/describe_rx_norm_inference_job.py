...
def handle_response(
    ...
    out: capo_comprehendmedical.types.describe_rx_norm_inference_job_response.DescribeRxNormInferenceJobResponse = capo_comprehendmedical.types.describe_rx_norm_inference_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.describe_rx_norm_inference_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
