"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#ListPHIDetectionJobs``."""
...
def handle_response(
    ...
    out: capo_comprehendmedical.types.list_phi_detection_jobs_response.ListPHIDetectionJobsResponse = capo_comprehendmedical.types.list_phi_detection_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.list_phi_detection_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_phi_detection_jobs(
