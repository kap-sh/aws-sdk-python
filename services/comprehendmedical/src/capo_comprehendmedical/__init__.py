...
from ._services.async_comprehend_medical import (
    AsyncComprehendMedicalClient as AsyncComprehendMedicalClient,
)
from ._services.comprehend_medical import (
    ComprehendMedicalClient as ComprehendMedicalClient,
)
