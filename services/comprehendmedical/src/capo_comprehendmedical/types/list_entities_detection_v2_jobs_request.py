"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#ListEntitiesDetectionV2JobsRequest``."""
...
class ListEntitiesDetectionV2JobsRequest(TypedDict, closed=True):
    filter: NotRequired[
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListEntitiesDetectionV2JobsRequest) -> dict:
    out: dict = {}
    if "filter" in value:
        import capo_comprehendmedical.types.comprehend_medical_async_job_filter
