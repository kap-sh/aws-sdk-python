"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#TextSizeLimitExceededException``."""
...
class TextSizeLimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.comprehendmedical#TextSizeLimitExceededException``."""
