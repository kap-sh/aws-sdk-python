...
```
pip install aws-sdk-comprehendmedical
```

## Usage

```python
from aws_sdk_comprehendmedical import AsyncComprehendMedicalClient
...
```python
from aws_sdk_comprehendmedical import AsyncComprehendMedicalClient
from aws_sdk_comprehendmedical.error import InternalServerException
