...
from aws_sdk_marketplace_commerce_analytics._auth._identity import (
    Credentials,
    Identity,
)
from aws_sdk_marketplace_commerce_analytics._services._aws_config import _load_profile
