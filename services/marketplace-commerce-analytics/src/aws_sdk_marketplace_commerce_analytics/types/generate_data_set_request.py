...
class GenerateDataSetRequest(TypedDict):
    data_set_type: (
        "aws_sdk_marketplace_commerce_analytics.types.data_set_type.DataSetType"
    )
...
def serialize_aws_json_1_1(value: GenerateDataSetRequest) -> dict:
    ...
    out["dataSetType"] = (
        aws_sdk_marketplace_commerce_analytics.types.data_set_type.serialize_aws_json_1_1(
            value["data_set_type"]
        )
    )
    import aws_sdk_marketplace_commerce_analytics.types.data_set_publication_date
    ...
    out["dataSetPublicationDate"] = (
        aws_sdk_marketplace_commerce_analytics.types.data_set_publication_date.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GenerateDataSetRequest:
    ...
    if "dataSetType" in data:
        ...
        out["data_set_type"] = (
            aws_sdk_marketplace_commerce_analytics.types.data_set_type.deserialize_aws_json_1_1(
                data["dataSetType"]
            )
        )
    else:
    ...
    if "dataSetPublicationDate" in data:
        ...
        out["data_set_publication_date"] = (
            aws_sdk_marketplace_commerce_analytics.types.data_set_publication_date.deserialize_aws_json_1_1(
