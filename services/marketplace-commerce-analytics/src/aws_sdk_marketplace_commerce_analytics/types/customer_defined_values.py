...
if TYPE_CHECKING:
    import aws_sdk_marketplace_commerce_analytics.types.optional_key
    import aws_sdk_marketplace_commerce_analytics.types.optional_value

CustomerDefinedValues: TypeAlias = dict[
    "aws_sdk_marketplace_commerce_analytics.types.optional_key.OptionalKey",
    "aws_sdk_marketplace_commerce_analytics.types.optional_value.OptionalValue",
]
