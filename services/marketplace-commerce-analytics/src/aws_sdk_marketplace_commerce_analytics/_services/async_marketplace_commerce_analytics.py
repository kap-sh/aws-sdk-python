...
from aws_sdk_marketplace_commerce_analytics._services._aws_config import aaws_config
...
class AsyncMarketplaceCommerceAnalyticsClientConfig(TypedDict, total=False):
...
class AsyncMarketplaceCommerceAnalyticsClient:
    ...
    async def generate_data_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_commerce_analytics.types.generate_data_set_request.GenerateDataSetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_commerce_analytics.types.generate_data_set_result.GenerateDataSetResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_commerce_analytics._operations.marketplace_commerce_analytics20150701.generate_data_set.async_generate_data_set(
    ...
    async def start_support_data_export(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_marketplace_commerce_analytics.types.start_support_data_export_request.StartSupportDataExportRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_marketplace_commerce_analytics.types.start_support_data_export_result.StartSupportDataExportResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_marketplace_commerce_analytics._operations.marketplace_commerce_analytics20150701.start_support_data_export.async_start_support_data_export(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
