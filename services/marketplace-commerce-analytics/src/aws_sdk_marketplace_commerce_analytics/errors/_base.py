...
class MarketplaceCommerceAnalyticsError(Exception):
    """Base class for all MarketplaceCommerceAnalytics service errors."""


class ServiceError(MarketplaceCommerceAnalyticsError):
...
class SerializationError(MarketplaceCommerceAnalyticsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MarketplaceCommerceAnalyticsError):
...
class WaiterFailedError(MarketplaceCommerceAnalyticsError):
...
class WaiterTimeoutError(MarketplaceCommerceAnalyticsError):
