...
def handle_response(
    ...
    out: aws_sdk_marketplace_commerce_analytics.types.start_support_data_export_result.StartSupportDataExportResult = aws_sdk_marketplace_commerce_analytics.types.start_support_data_export_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_marketplace_commerce_analytics.types.start_support_data_export_request.StartSupportDataExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
