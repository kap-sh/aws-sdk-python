...
```
pip install capo-marketplace-commerce-analytics
```

## Usage

```python
from capo_marketplace_commerce_analytics import AsyncMarketplaceCommerceAnalyticsClient
...
```python
from capo_marketplace_commerce_analytics import AsyncMarketplaceCommerceAnalyticsClient
from capo_marketplace_commerce_analytics.error import MarketplaceCommerceAnalyticsException
