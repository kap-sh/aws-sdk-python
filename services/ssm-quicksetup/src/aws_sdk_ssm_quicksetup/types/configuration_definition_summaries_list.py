...
ConfigurationDefinitionSummariesList: TypeAlias = list["aws_sdk_ssm_quicksetup.types.configuration_definition_summary.ConfigurationDefinitionSummary"]
...
def serialize_json(value: ConfigurationDefinitionSummariesList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_ssm_quicksetup.types.configuration_definition_summary.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> ConfigurationDefinitionSummariesList:
    ...
    for item in data:
        out.append(aws_sdk_ssm_quicksetup.types.configuration_definition_summary.deserialize_json(item))
    return out