...
class GetServiceSettingsOutput(TypedDict):
    service_settings: NotRequired[
        "aws_sdk_ssm_quicksetup.types.service_settings.ServiceSettings"
    ]
...
def serialize_json(value: GetServiceSettingsOutput) -> dict:
    ...
    if "service_settings" in value:
        ...
        out["ServiceSettings"] = (
            aws_sdk_ssm_quicksetup.types.service_settings.serialize_json(
...
def deserialize_json(data: dict) -> GetServiceSettingsOutput:
    ...
    if "ServiceSettings" in data:
        ...
        out["service_settings"] = (
            aws_sdk_ssm_quicksetup.types.service_settings.deserialize_json(
