...
ConfigurationDefinitionsList: TypeAlias = list["aws_sdk_ssm_quicksetup.types.configuration_definition.ConfigurationDefinition"]
...
def serialize_json(value: ConfigurationDefinitionsList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_ssm_quicksetup.types.configuration_definition.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> ConfigurationDefinitionsList:
    ...
    for item in data:
        out.append(aws_sdk_ssm_quicksetup.types.configuration_definition.deserialize_json(item))
    return out