...
class SSMQuickSetupError(Exception):
    """Base class for all SSMQuickSetup service errors."""


class ServiceError(SSMQuickSetupError):
...
class SerializationError(SSMQuickSetupError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SSMQuickSetupError):
...
class WaiterFailedError(SSMQuickSetupError):
...
class WaiterTimeoutError(SSMQuickSetupError):
