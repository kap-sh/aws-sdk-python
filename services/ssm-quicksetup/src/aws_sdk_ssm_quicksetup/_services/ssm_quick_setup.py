...
from aws_sdk_ssm_quicksetup._services._aws_config import aws_config
...
class SSMQuickSetupClientConfig(TypedDict, total=False):
...
class SSMQuickSetupClient:
    ...
    def create_configuration_manager(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_quicksetup.types.create_configuration_manager_input.CreateConfigurationManagerInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_quicksetup.types.create_configuration_manager_output.CreateConfigurationManagerOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_quicksetup._operations.quick_setup.create_configuration_manager.create_configuration_manager(
    ...
    def delete_configuration_manager(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_quicksetup.types.delete_configuration_manager_input.DeleteConfigurationManagerInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_ssm_quicksetup._operations.quick_setup.delete_configuration_manager

            output, http_response = (
                aws_sdk_ssm_quicksetup._operations.quick_setup.delete_configuration_manager.delete_configuration_manager(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_quicksetup.types.get_configuration_input.GetConfigurationInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_quicksetup.types.get_configuration_output.GetConfigurationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_quicksetup._operations.quick_setup.get_configuration.get_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_configuration_manager(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_quicksetup.types.get_configuration_manager_input.GetConfigurationManagerInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_quicksetup.types.get_configuration_manager_output.GetConfigurationManagerOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_quicksetup._operations.quick_setup.get_configuration_manager.get_configuration_manager(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_service_settings(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_ssm_quicksetup._operations.quick_setup.get_service_settings.get_service_settings(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_configuration_managers(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_quicksetup.types.list_configuration_managers_input.ListConfigurationManagersInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_quicksetup.types.list_configuration_managers_output.ListConfigurationManagersOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_quicksetup._operations.quick_setup.list_configuration_managers.list_configuration_managers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[aws_sdk_ssm_quicksetup.types.configuration_manager_summary.ConfigurationManagerSummary]":
    ...
    def list_configurations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_quicksetup.types.list_configurations_input.ListConfigurationsInput]",
        ) -> OperationResponse[
            "aws_sdk_ssm_quicksetup.types.list_configurations_output.ListConfigurationsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_quicksetup._operations.quick_setup.list_configurations.list_configurations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_configurations(
        ...
        *,
        ...
        manager_arn: Optional[str] = None,
        configuration_definition_id: Optional[str] = None,
    ) -> "Iterator[aws_sdk_ssm_quicksetup.types.configuration_summary.ConfigurationSummary]":
        _token = starting_token
        while True:
    ...
    def list_quick_setup_types(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_ssm_quicksetup._operations.quick_setup.list_quick_setup_types.list_quick_setup_types(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_quicksetup.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_ssm_quicksetup.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_ssm_quicksetup._operations.quick_setup.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_quicksetup.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_ssm_quicksetup._operations.quick_setup.tag_resource

            output, http_response = (
                aws_sdk_ssm_quicksetup._operations.quick_setup.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_quicksetup.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_ssm_quicksetup._operations.quick_setup.untag_resource

            output, http_response = (
                aws_sdk_ssm_quicksetup._operations.quick_setup.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_configuration_definition(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_quicksetup.types.update_configuration_definition_input.UpdateConfigurationDefinitionInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_ssm_quicksetup._operations.quick_setup.update_configuration_definition

            output, http_response = (
                aws_sdk_ssm_quicksetup._operations.quick_setup.update_configuration_definition.update_configuration_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_configuration_manager(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_quicksetup.types.update_configuration_manager_input.UpdateConfigurationManagerInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_ssm_quicksetup._operations.quick_setup.update_configuration_manager

            output, http_response = (
                aws_sdk_ssm_quicksetup._operations.quick_setup.update_configuration_manager.update_configuration_manager(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_service_settings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_ssm_quicksetup.types.update_service_settings_input.UpdateServiceSettingsInput]",
        ) -> OperationResponse[None]:
            import aws_sdk_ssm_quicksetup._operations.quick_setup.update_service_settings

            output, http_response = (
                aws_sdk_ssm_quicksetup._operations.quick_setup.update_service_settings.update_service_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
