...
def handle_response(
    ...
    out: capo_ssm_quicksetup.types.create_configuration_manager_output.CreateConfigurationManagerOutput = capo_ssm_quicksetup.types.create_configuration_manager_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_quicksetup.types.create_configuration_manager_input.serialize_json(
            input_
        )
    ).encode()
