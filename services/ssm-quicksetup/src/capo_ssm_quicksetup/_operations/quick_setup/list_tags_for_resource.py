"""Generated from Smithy shape ``com.amazonaws.ssmquicksetup#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_ssm_quicksetup.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_ssm_quicksetup.types.list_tags_for_resource_response.deserialize_json(
