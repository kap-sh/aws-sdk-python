"""Generated from Smithy shape ``com.amazonaws.ssmquicksetup#UpdateConfigurationManager``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_quicksetup.types.update_configuration_manager_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_configuration_manager(
