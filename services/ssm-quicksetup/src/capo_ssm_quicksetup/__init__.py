...
from ._services.async_ssm_quick_setup import (
    AsyncSSMQuickSetupClient as AsyncSSMQuickSetupClient,
)
from ._services.ssm_quick_setup import SSMQuickSetupClient as SSMQuickSetupClient
