...
```
pip install aws-sdk-ssm-quicksetup
```

## Usage

```python
from aws_sdk_ssm_quicksetup import AsyncSSMQuickSetupClient
...
```python
from aws_sdk_ssm_quicksetup import AsyncSSMQuickSetupClient
from aws_sdk_ssm_quicksetup.error import AccessDeniedException
