...
from aws_sdk_freetier._auth._signers import SigV4Signer
from aws_sdk_freetier._auth._sigv4 import presign_sigv4
...
from aws_sdk_freetier._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
from aws_sdk_freetier._async import anysleep
import time
from aws_sdk_freetier.errors import ServiceError, WaiterFailedError, WaiterTimeoutError
import warnings
from aws_sdk_freetier._auth._identity import Credentials
from aws_sdk_freetier._auth._providers import CredentialsProvider, StaticAwsCredentialsProvider
if TYPE_CHECKING:
...
class AsyncFreeTierClient:
    ...
    def __init__(self, http_handler: AsyncBaseHandler | None = None, operation_interceptors: Iterable[AsyncInterceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, region: str | None = None, use_fips: bool | None = None, endpoint: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = AsyncFreeTierClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "region": region, "use_fips": use_fips, "endpoint": endpoint, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[AsyncFreeTierClientConfig] = None) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
    ...
    async def get_account_activity(self, activity_id: "aws_sdk_freetier.types.activity_id.ActivityId", *, config_overrides: Optional[AsyncFreeTierClientConfig] = None, language_code: Optional["aws_sdk_freetier.types.language_code.LanguageCode"] = None) -> "aws_sdk_freetier.types.get_account_activity_response.GetAccountActivityResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_freetier.types.get_account_activity_request.GetAccountActivityRequest]') -> AsyncOperationResponse["aws_sdk_freetier.types.get_account_activity_response.GetAccountActivityResponse"]:
            import aws_sdk_freetier._operations.aws_free_tier_service.get_account_activity
            output, http_response = await aws_sdk_freetier._operations.aws_free_tier_service.get_account_activity.async_get_account_activity(req.options, req.input)
    ...
    async def get_account_plan_state(self, *, config_overrides: Optional[AsyncFreeTierClientConfig] = None) -> "aws_sdk_freetier.types.get_account_plan_state_response.GetAccountPlanStateResponse":
        ...
        Examples:
            ...
            >>> await client.get_account_plan_state()
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_freetier.types.get_account_plan_state_request.GetAccountPlanStateRequest]') -> AsyncOperationResponse["aws_sdk_freetier.types.get_account_plan_state_response.GetAccountPlanStateResponse"]:
            import aws_sdk_freetier._operations.aws_free_tier_service.get_account_plan_state
            output, http_response = await aws_sdk_freetier._operations.aws_free_tier_service.get_account_plan_state.async_get_account_plan_state(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def get_free_tier_usage(self, *, config_overrides: Optional[AsyncFreeTierClientConfig] = None, filter: Optional["aws_sdk_freetier.types.expression.Expression"] = None, max_results: Optional["aws_sdk_freetier.types.max_results.MaxResults"] = None, next_token: Optional["aws_sdk_freetier.types.next_page_token.NextPageToken"] = None) -> "aws_sdk_freetier.types.get_free_tier_usage_response.GetFreeTierUsageResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_freetier.types.get_free_tier_usage_request.GetFreeTierUsageRequest]') -> AsyncOperationResponse["aws_sdk_freetier.types.get_free_tier_usage_response.GetFreeTierUsageResponse"]:
            import aws_sdk_freetier._operations.aws_free_tier_service.get_free_tier_usage
            output, http_response = await aws_sdk_freetier._operations.aws_free_tier_service.get_free_tier_usage.async_get_free_tier_usage(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_get_free_tier_usage(self, *, config_overrides: Optional[AsyncFreeTierClientConfig] = None, filter: Optional["aws_sdk_freetier.types.expression.Expression"] = None, max_results: Optional["aws_sdk_freetier.types.max_results.MaxResults"] = None, next_token: Optional["aws_sdk_freetier.types.next_page_token.NextPageToken"] = None) -> "AsyncIterator[aws_sdk_freetier.types.free_tier_usage.FreeTierUsage]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    async def list_account_activities(self, *, config_overrides: Optional[AsyncFreeTierClientConfig] = None, filter_activity_statuses: Optional["aws_sdk_freetier.types.filter_activity_statuses.FilterActivityStatuses"] = None, next_token: Optional["aws_sdk_freetier.types.next_page_token.NextPageToken"] = None, max_results: Optional["aws_sdk_freetier.types.max_results.MaxResults"] = None, language_code: Optional["aws_sdk_freetier.types.language_code.LanguageCode"] = None) -> "aws_sdk_freetier.types.list_account_activities_response.ListAccountActivitiesResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_freetier.types.list_account_activities_request.ListAccountActivitiesRequest]') -> AsyncOperationResponse["aws_sdk_freetier.types.list_account_activities_response.ListAccountActivitiesResponse"]:
            import aws_sdk_freetier._operations.aws_free_tier_service.list_account_activities
            output, http_response = await aws_sdk_freetier._operations.aws_free_tier_service.list_account_activities.async_list_account_activities(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_account_activities(self, *, config_overrides: Optional[AsyncFreeTierClientConfig] = None, filter_activity_statuses: Optional["aws_sdk_freetier.types.filter_activity_statuses.FilterActivityStatuses"] = None, next_token: Optional["aws_sdk_freetier.types.next_page_token.NextPageToken"] = None, max_results: Optional["aws_sdk_freetier.types.max_results.MaxResults"] = None, language_code: Optional["aws_sdk_freetier.types.language_code.LanguageCode"] = None) -> "AsyncIterator[aws_sdk_freetier.types.activity_summary.ActivitySummary]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    async def upgrade_account_plan(self, account_plan_type: "aws_sdk_freetier.types.account_plan_type.AccountPlanType", *, config_overrides: Optional[AsyncFreeTierClientConfig] = None) -> "aws_sdk_freetier.types.upgrade_account_plan_response.UpgradeAccountPlanResponse":
        ...
        Examples:
            ...
            >>> await client.upgrade_account_plan(account_plan_type='PAID')
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_freetier.types.upgrade_account_plan_request.UpgradeAccountPlanRequest]') -> AsyncOperationResponse["aws_sdk_freetier.types.upgrade_account_plan_response.UpgradeAccountPlanResponse"]:
            import aws_sdk_freetier._operations.aws_free_tier_service.upgrade_account_plan
            output, http_response = await aws_sdk_freetier._operations.aws_free_tier_service.upgrade_account_plan.async_upgrade_account_plan(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
