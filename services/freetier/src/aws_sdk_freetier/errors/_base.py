...
class FreeTierError(Exception):
    """Base class for all FreeTier service errors."""

class ServiceError(FreeTierError):
...
class SerializationError(FreeTierError):
    """Raised when a value cannot be serialized."""

class DeserializationError(FreeTierError):
...
class WaiterFailedError(FreeTierError):
...
class WaiterTimeoutError(FreeTierError):
