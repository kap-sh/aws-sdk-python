...
FilterActivityStatuses: TypeAlias = list["aws_sdk_freetier.types.activity_status.ActivityStatus"]
...
def deserialize_aws_json_1_0(data: list) -> FilterActivityStatuses:
    ...
    for item in data:
        out.append(aws_sdk_freetier.types.activity_status.deserialize_aws_json_1_0(item))
    return out