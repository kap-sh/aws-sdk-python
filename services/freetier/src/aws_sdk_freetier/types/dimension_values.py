...
def serialize_aws_json_1_0(value: DimensionValues) -> dict:
    ...
    out["Values"] = aws_sdk_freetier.types.values.serialize_aws_json_1_0(
        value["values"]
    )
    import aws_sdk_freetier.types.match_options

    out["MatchOptions"] = aws_sdk_freetier.types.match_options.serialize_aws_json_1_0(
        value["match_options"]
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> DimensionValues:
    ...
    if "Key" in data:
        ...
        out["key"] = aws_sdk_freetier.types.dimension.deserialize_aws_json_1_0(
            data["Key"]
        )
    else:
    ...
    if "Values" in data:
        ...
        out["values"] = aws_sdk_freetier.types.values.deserialize_aws_json_1_0(
            data["Values"]
        )
    else:
    ...
    if "MatchOptions" in data:
        ...
        out["match_options"] = (
            aws_sdk_freetier.types.match_options.deserialize_aws_json_1_0(
                data["MatchOptions"]
            )
        )
    else:
