...
def serialize_aws_json_1_0(value: GetAccountActivityRequest) -> dict:
    ...
    if "language_code" in value:
        import aws_sdk_freetier.types.language_code
        out["languageCode"] = aws_sdk_freetier.types.language_code.serialize_aws_json_1_0(value["language_code"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> GetAccountActivityRequest:
    ...
    if "languageCode" in data:
        import aws_sdk_freetier.types.language_code
        out["language_code"] = aws_sdk_freetier.types.language_code.deserialize_aws_json_1_0(data["languageCode"])
    return out