...
def serialize_aws_json_1_0(value: ActivitySummary) -> dict:
    ...
    import aws_sdk_freetier.types.activity_reward
    out["reward"] = aws_sdk_freetier.types.activity_reward.serialize_aws_json_1_0(value["reward"])
    import aws_sdk_freetier.types.activity_status
    out["status"] = aws_sdk_freetier.types.activity_status.serialize_aws_json_1_0(value["status"])
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ActivitySummary:
    ...
    if "reward" in data:
        import aws_sdk_freetier.types.activity_reward
        out["reward"] = aws_sdk_freetier.types.activity_reward.deserialize_aws_json_1_0(data["reward"])
    else:
        raise DeserializationError("ActivitySummary.reward required")
    if "status" in data:
        import aws_sdk_freetier.types.activity_status
        out["status"] = aws_sdk_freetier.types.activity_status.deserialize_aws_json_1_0(data["status"])
    else:
