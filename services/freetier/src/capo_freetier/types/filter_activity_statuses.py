...
FilterActivityStatuses: TypeAlias = list[
    "capo_freetier.types.activity_status.ActivityStatus"
]
...
def serialize_aws_json_1_0(value: FilterActivityStatuses) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_freetier.types.activity_status.serialize_aws_json_1_0(item))
    return out
...
def deserialize_aws_json_1_0(data: list) -> FilterActivityStatuses:
    ...
    for item in data:
        out.append(capo_freetier.types.activity_status.deserialize_aws_json_1_0(item))
    return out
