...
def build_request(
    ...
    input_: aws_sdk_chatbot.types.create_slack_channel_configuration_request.CreateSlackChannelConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.create_slack_channel_configuration_request.serialize_json(
            input_
        )
    ).encode()
