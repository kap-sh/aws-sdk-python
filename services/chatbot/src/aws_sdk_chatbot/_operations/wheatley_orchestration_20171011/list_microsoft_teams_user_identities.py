...
import aws_sdk_chatbot.errors.list_microsoft_teams_user_identities_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ListMicrosoftTeamsUserIdentitiesException":
            raise aws_sdk_chatbot.errors.list_microsoft_teams_user_identities_exception.ListMicrosoftTeamsUserIdentitiesException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.list_microsoft_teams_user_identities_result.ListMicrosoftTeamsUserIdentitiesResult = aws_sdk_chatbot.types.list_microsoft_teams_user_identities_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chatbot.types.list_microsoft_teams_user_identities_request.ListMicrosoftTeamsUserIdentitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.list_microsoft_teams_user_identities_request.serialize_json(
            input_
        )
    ).encode()
