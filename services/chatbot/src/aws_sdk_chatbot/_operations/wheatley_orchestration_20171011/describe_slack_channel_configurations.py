...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DescribeSlackChannelConfigurationsException":
            import aws_sdk_chatbot.errors.describe_slack_channel_configurations_exception

            raise aws_sdk_chatbot.errors.describe_slack_channel_configurations_exception.DescribeSlackChannelConfigurationsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.describe_slack_channel_configurations_result.DescribeSlackChannelConfigurationsResult = aws_sdk_chatbot.types.describe_slack_channel_configurations_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chatbot.types.describe_slack_channel_configurations_request.DescribeSlackChannelConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.describe_slack_channel_configurations_request.serialize_json(
            input_
        )
    ).encode()
