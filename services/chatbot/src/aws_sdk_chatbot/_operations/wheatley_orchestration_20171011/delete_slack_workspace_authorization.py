...
import aws_sdk_chatbot.errors.delete_slack_workspace_authorization_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DeleteSlackWorkspaceAuthorizationFault":
            raise aws_sdk_chatbot.errors.delete_slack_workspace_authorization_fault.DeleteSlackWorkspaceAuthorizationFault.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.delete_slack_workspace_authorization_result.DeleteSlackWorkspaceAuthorizationResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_chatbot.types.delete_slack_workspace_authorization_request.DeleteSlackWorkspaceAuthorizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.delete_slack_workspace_authorization_request.serialize_json(
            input_
        )
    ).encode()
