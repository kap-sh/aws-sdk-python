"""Generated from Smithy shape ``com.amazonaws.chatbot#UpdateAccountPreferences``."""
...
import aws_sdk_chatbot.errors.update_account_preferences_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UpdateAccountPreferencesException":
            raise aws_sdk_chatbot.errors.update_account_preferences_exception.UpdateAccountPreferencesException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.update_account_preferences_result.UpdateAccountPreferencesResult = aws_sdk_chatbot.types.update_account_preferences_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chatbot.types.update_account_preferences_request.UpdateAccountPreferencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/update-account-preferences"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.update_account_preferences_request.serialize_json(input_)
    ).encode()
...
async def async_update_account_preferences(
