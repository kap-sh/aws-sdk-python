...
def build_request(
    ...
    input: aws_sdk_chatbot.types.update_account_preferences_request.UpdateAccountPreferencesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.update_account_preferences_request.serialize_json(input)
    ).encode()
