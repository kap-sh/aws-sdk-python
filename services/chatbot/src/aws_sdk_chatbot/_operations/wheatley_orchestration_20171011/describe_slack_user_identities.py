"""Generated from Smithy shape ``com.amazonaws.chatbot#DescribeSlackUserIdentities``."""
...
import aws_sdk_chatbot.errors.describe_slack_user_identities_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DescribeSlackUserIdentitiesException":
            raise aws_sdk_chatbot.errors.describe_slack_user_identities_exception.DescribeSlackUserIdentitiesException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.describe_slack_user_identities_result.DescribeSlackUserIdentitiesResult = aws_sdk_chatbot.types.describe_slack_user_identities_result.deserialize_json(
