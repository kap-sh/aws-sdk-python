...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "GetTeamsChannelConfigurationException":
            import aws_sdk_chatbot.errors.get_teams_channel_configuration_exception

            raise aws_sdk_chatbot.errors.get_teams_channel_configuration_exception.GetTeamsChannelConfigurationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.get_teams_channel_configuration_result.GetTeamsChannelConfigurationResult = aws_sdk_chatbot.types.get_teams_channel_configuration_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chatbot.types.get_teams_channel_configuration_request.GetTeamsChannelConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.get_teams_channel_configuration_request.serialize_json(
            input_
        )
    ).encode()
