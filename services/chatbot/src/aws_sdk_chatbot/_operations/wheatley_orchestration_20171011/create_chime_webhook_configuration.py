...
import aws_sdk_chatbot.errors.create_chime_webhook_configuration_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CreateChimeWebhookConfigurationException":
            raise aws_sdk_chatbot.errors.create_chime_webhook_configuration_exception.CreateChimeWebhookConfigurationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.create_chime_webhook_configuration_result.CreateChimeWebhookConfigurationResult = aws_sdk_chatbot.types.create_chime_webhook_configuration_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chatbot.types.create_chime_webhook_configuration_request.CreateChimeWebhookConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.create_chime_webhook_configuration_request.serialize_json(
            input_
        )
    ).encode()
