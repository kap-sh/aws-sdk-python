...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "GetAccountPreferencesException":
            import aws_sdk_chatbot.errors.get_account_preferences_exception

            raise aws_sdk_chatbot.errors.get_account_preferences_exception.GetAccountPreferencesException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.get_account_preferences_result.GetAccountPreferencesResult = aws_sdk_chatbot.types.get_account_preferences_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chatbot.types.get_account_preferences_request.GetAccountPreferencesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
