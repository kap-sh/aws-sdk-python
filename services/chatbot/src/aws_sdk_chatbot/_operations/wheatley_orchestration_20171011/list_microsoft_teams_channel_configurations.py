...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ListTeamsChannelConfigurationsException":
            import aws_sdk_chatbot.errors.list_teams_channel_configurations_exception

            raise aws_sdk_chatbot.errors.list_teams_channel_configurations_exception.ListTeamsChannelConfigurationsException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.list_teams_channel_configurations_result.ListTeamsChannelConfigurationsResult = aws_sdk_chatbot.types.list_teams_channel_configurations_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chatbot.types.list_teams_channel_configurations_request.ListTeamsChannelConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.list_teams_channel_configurations_request.serialize_json(
            input_
        )
    ).encode()
