...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DescribeSlackWorkspacesException":
            import aws_sdk_chatbot.errors.describe_slack_workspaces_exception

            raise aws_sdk_chatbot.errors.describe_slack_workspaces_exception.DescribeSlackWorkspacesException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.describe_slack_workspaces_result.DescribeSlackWorkspacesResult = aws_sdk_chatbot.types.describe_slack_workspaces_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chatbot.types.describe_slack_workspaces_request.DescribeSlackWorkspacesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.describe_slack_workspaces_request.serialize_json(input)
    ).encode()
