...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ListMicrosoftTeamsConfiguredTeamsException":
            import aws_sdk_chatbot.errors.list_microsoft_teams_configured_teams_exception

            raise aws_sdk_chatbot.errors.list_microsoft_teams_configured_teams_exception.ListMicrosoftTeamsConfiguredTeamsException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.list_microsoft_teams_configured_teams_result.ListMicrosoftTeamsConfiguredTeamsResult = aws_sdk_chatbot.types.list_microsoft_teams_configured_teams_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chatbot.types.list_microsoft_teams_configured_teams_request.ListMicrosoftTeamsConfiguredTeamsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.list_microsoft_teams_configured_teams_request.serialize_json(
            input_
        )
    ).encode()
