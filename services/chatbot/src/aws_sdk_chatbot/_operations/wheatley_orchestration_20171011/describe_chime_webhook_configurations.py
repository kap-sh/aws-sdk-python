...
import aws_sdk_chatbot.errors.describe_chime_webhook_configurations_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DescribeChimeWebhookConfigurationsException":
            raise aws_sdk_chatbot.errors.describe_chime_webhook_configurations_exception.DescribeChimeWebhookConfigurationsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.describe_chime_webhook_configurations_result.DescribeChimeWebhookConfigurationsResult = aws_sdk_chatbot.types.describe_chime_webhook_configurations_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chatbot.types.describe_chime_webhook_configurations_request.DescribeChimeWebhookConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.describe_chime_webhook_configurations_request.serialize_json(
            input_
        )
    ).encode()
