...
def build_request(
    ...
    input_: aws_sdk_chatbot.types.delete_teams_configured_team_request.DeleteTeamsConfiguredTeamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.delete_teams_configured_team_request.serialize_json(
            input_
        )
    ).encode()
