"""Generated from Smithy shape ``com.amazonaws.chatbot#DeleteMicrosoftTeamsConfiguredTeam``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DeleteTeamsConfiguredTeamException":
            import aws_sdk_chatbot.errors.delete_teams_configured_team_exception

            raise aws_sdk_chatbot.errors.delete_teams_configured_team_exception.DeleteTeamsConfiguredTeamException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.delete_teams_configured_team_result.DeleteTeamsConfiguredTeamResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_chatbot.types.delete_teams_configured_team_request.DeleteTeamsConfiguredTeamRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/delete-ms-teams-configured-teams"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_chatbot.types.delete_teams_configured_team_request

    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.delete_teams_configured_team_request.serialize_json(input)
    ).encode()
...
async def async_delete_microsoft_teams_configured_team(
