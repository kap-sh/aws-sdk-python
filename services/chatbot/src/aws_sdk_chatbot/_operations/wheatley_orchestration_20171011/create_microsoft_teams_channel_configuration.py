...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CreateTeamsChannelConfigurationException":
            import aws_sdk_chatbot.errors.create_teams_channel_configuration_exception

            raise aws_sdk_chatbot.errors.create_teams_channel_configuration_exception.CreateTeamsChannelConfigurationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.create_teams_channel_configuration_result.CreateTeamsChannelConfigurationResult = aws_sdk_chatbot.types.create_teams_channel_configuration_result.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_chatbot.types.create_teams_channel_configuration_request.CreateTeamsChannelConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.create_teams_channel_configuration_request.serialize_json(
            input_
        )
    ).encode()
