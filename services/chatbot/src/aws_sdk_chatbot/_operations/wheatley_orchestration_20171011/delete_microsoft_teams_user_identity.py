"""Generated from Smithy shape ``com.amazonaws.chatbot#DeleteMicrosoftTeamsUserIdentity``."""
...
import aws_sdk_chatbot.errors.delete_microsoft_teams_user_identity_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DeleteMicrosoftTeamsUserIdentityException":
            raise aws_sdk_chatbot.errors.delete_microsoft_teams_user_identity_exception.DeleteMicrosoftTeamsUserIdentityException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.delete_microsoft_teams_user_identity_result.DeleteMicrosoftTeamsUserIdentityResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_chatbot.types.delete_microsoft_teams_user_identity_request.DeleteMicrosoftTeamsUserIdentityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_microsoft_teams_user_identity(
