...
def handle_response(
    ...
    out: aws_sdk_chatbot.types.list_associations_result.ListAssociationsResult = (
        aws_sdk_chatbot.types.list_associations_result.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_chatbot.types.list_associations_request.ListAssociationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_chatbot.types.list_associations_request.serialize_json(input)
    ).encode()
