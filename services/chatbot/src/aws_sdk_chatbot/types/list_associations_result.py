...
if TYPE_CHECKING:
    import aws_sdk_chatbot.types.association_list
    import aws_sdk_chatbot.types.string


class ListAssociationsResult(TypedDict):
    associations: "aws_sdk_chatbot.types.association_list.AssociationList"
...
def serialize_json(value: ListAssociationsResult) -> dict:
    ...
    out["Associations"] = aws_sdk_chatbot.types.association_list.serialize_json(
        value["associations"]
    )
...
def deserialize_json(data: dict) -> ListAssociationsResult:
    ...
    if "Associations" in data:
        ...
        out["associations"] = aws_sdk_chatbot.types.association_list.deserialize_json(
            data["Associations"]
        )
    else:
