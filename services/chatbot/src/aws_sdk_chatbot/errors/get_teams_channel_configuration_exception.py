...
class GetTeamsChannelConfigurationException_(TypedDict):
...
class GetTeamsChannelConfigurationException(ServiceError):
    ...
    def __init__(self, data: GetTeamsChannelConfigurationException_):
        super().__init__(
            "server",
    ...
    @classmethod
    def from_json(cls, data: dict) -> "GetTeamsChannelConfigurationException":
