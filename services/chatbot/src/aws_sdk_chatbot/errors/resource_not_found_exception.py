"""Generated from Smithy shape ``com.amazonaws.chatbot#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.chatbot#ResourceNotFoundException``."""
