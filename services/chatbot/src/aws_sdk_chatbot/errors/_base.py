...
class chatbotError(Exception):
    """Base class for all chatbot service errors."""
...
class SerializationError(chatbotError):
    """Raised when a value cannot be serialized."""


class DeserializationError(chatbotError):
...
class WaiterFailedError(chatbotError):
...
class WaiterTimeoutError(chatbotError):
