...
import capo_chatbot.errors.delete_chime_webhook_configuration_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DeleteChimeWebhookConfigurationException":
            raise capo_chatbot.errors.delete_chime_webhook_configuration_exception.DeleteChimeWebhookConfigurationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_chatbot.types.delete_chime_webhook_configuration_result.DeleteChimeWebhookConfigurationResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chatbot.types.delete_chime_webhook_configuration_request.serialize_json(
            input_
        )
    ).encode()
