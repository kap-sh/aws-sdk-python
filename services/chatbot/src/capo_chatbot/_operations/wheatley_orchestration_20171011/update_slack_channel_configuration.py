...
import capo_chatbot.errors.update_slack_channel_configuration_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UpdateSlackChannelConfigurationException":
            raise capo_chatbot.errors.update_slack_channel_configuration_exception.UpdateSlackChannelConfigurationException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_chatbot.types.update_slack_channel_configuration_result.UpdateSlackChannelConfigurationResult = capo_chatbot.types.update_slack_channel_configuration_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chatbot.types.update_slack_channel_configuration_request.serialize_json(
            input_
        )
    ).encode()
