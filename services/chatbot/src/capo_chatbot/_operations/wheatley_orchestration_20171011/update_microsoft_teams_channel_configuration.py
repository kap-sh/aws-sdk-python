"""Generated from Smithy shape ``com.amazonaws.chatbot#UpdateMicrosoftTeamsChannelConfiguration``."""
...
import capo_chatbot.errors.update_teams_channel_configuration_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UpdateTeamsChannelConfigurationException":
            raise capo_chatbot.errors.update_teams_channel_configuration_exception.UpdateTeamsChannelConfigurationException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_chatbot.types.update_teams_channel_configuration_result.UpdateTeamsChannelConfigurationResult = capo_chatbot.types.update_teams_channel_configuration_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/update-ms-teams-channel-configuration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_chatbot.types.update_teams_channel_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_microsoft_teams_channel_configuration(
