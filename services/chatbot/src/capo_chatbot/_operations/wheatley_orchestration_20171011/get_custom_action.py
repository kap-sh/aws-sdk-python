...
def handle_response(
    ...
    out: capo_chatbot.types.get_custom_action_result.GetCustomActionResult = (
        capo_chatbot.types.get_custom_action_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chatbot.types.get_custom_action_request.serialize_json(input_)
    ).encode()
...
def get_custom_action(
    ...
    capo_chatbot.types.get_custom_action_result.GetCustomActionResult, zapros.Response
]:
