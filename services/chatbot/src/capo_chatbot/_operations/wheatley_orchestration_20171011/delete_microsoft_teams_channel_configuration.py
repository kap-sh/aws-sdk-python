...
import capo_chatbot.errors.delete_teams_channel_configuration_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DeleteTeamsChannelConfigurationException":
            raise capo_chatbot.errors.delete_teams_channel_configuration_exception.DeleteTeamsChannelConfigurationException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_chatbot.types.delete_teams_channel_configuration_result.DeleteTeamsChannelConfigurationResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chatbot.types.delete_teams_channel_configuration_request.serialize_json(
            input_
        )
    ).encode()
