"""Generated from Smithy shape ``com.amazonaws.chatbot#UpdateChimeWebhookConfiguration``."""
...
import capo_chatbot.errors.update_chime_webhook_configuration_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UpdateChimeWebhookConfigurationException":
            raise capo_chatbot.errors.update_chime_webhook_configuration_exception.UpdateChimeWebhookConfigurationException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_chatbot.types.update_chime_webhook_configuration_result.UpdateChimeWebhookConfigurationResult = capo_chatbot.types.update_chime_webhook_configuration_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/update-chime-webhook-configuration"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_chatbot.types.update_chime_webhook_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_chime_webhook_configuration(
