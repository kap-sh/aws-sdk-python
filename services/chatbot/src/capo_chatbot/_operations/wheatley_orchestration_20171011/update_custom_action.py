...
def handle_response(
    ...
    out: capo_chatbot.types.update_custom_action_result.UpdateCustomActionResult = (
        capo_chatbot.types.update_custom_action_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chatbot.types.update_custom_action_request.serialize_json(input_)
    ).encode()
