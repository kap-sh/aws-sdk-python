"""Generated from Smithy shape ``com.amazonaws.chatbot#ListMicrosoftTeamsChannelConfigurations``."""
...
import capo_chatbot.errors.list_teams_channel_configurations_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ListTeamsChannelConfigurationsException":
            raise capo_chatbot.errors.list_teams_channel_configurations_exception.ListTeamsChannelConfigurationsException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_chatbot.types.list_teams_channel_configurations_result.ListTeamsChannelConfigurationsResult = capo_chatbot.types.list_teams_channel_configurations_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/list-ms-teams-channel-configurations"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_chatbot.types.list_teams_channel_configurations_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_microsoft_teams_channel_configurations(
