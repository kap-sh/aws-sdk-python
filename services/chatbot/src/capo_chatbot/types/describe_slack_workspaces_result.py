...
if TYPE_CHECKING:
    ...
    import capo_chatbot.types.slack_workspaces_list


class DescribeSlackWorkspacesResult(TypedDict, closed=True):
    slack_workspaces: NotRequired[
        "capo_chatbot.types.slack_workspaces_list.SlackWorkspacesList"
    ]
...
def serialize_json(value: DescribeSlackWorkspacesResult) -> dict:
    ...
    if "slack_workspaces" in value:
        ...
        out["SlackWorkspaces"] = (
            capo_chatbot.types.slack_workspaces_list.serialize_json(
...
def deserialize_json(data: dict) -> DescribeSlackWorkspacesResult:
    ...
    if "SlackWorkspaces" in data:
        ...
        out["slack_workspaces"] = (
            capo_chatbot.types.slack_workspaces_list.deserialize_json(
