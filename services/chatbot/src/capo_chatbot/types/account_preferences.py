"""Generated from Smithy shape ``com.amazonaws.chatbot#AccountPreferences``."""
...
class AccountPreferences(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: AccountPreferences) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> AccountPreferences:
    out: AccountPreferences = {}  # type: ignore[typeddict-item]
