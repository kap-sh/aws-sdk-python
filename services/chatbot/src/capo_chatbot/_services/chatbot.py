...
from capo_chatbot._services._aws_config import aws_config
...
class chatbotClientConfig(TypedDict, total=False, closed=True):
...
class chatbotClient:
    ...
    def operation_options(
        self, config_overrides: Optional[chatbotClientConfig] = None
    ...
    def associate_to_configuration(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.associate_to_configuration(resource='arn:aws:chatbot::1234567890:custom-action/my-custom-action', chat_configuration='arn:aws:chatbot::1234567890:chat-configuration/slack-channel/my-channel')
        """

        def _handler(
            req: "OperationRequest[capo_chatbot.types.associate_to_configuration_request.AssociateToConfigurationRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.associate_to_configuration_result.AssociateToConfigurationResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.associate_to_configuration.associate_to_configuration(
    ...
    def create_chime_webhook_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.create_chime_webhook_configuration_request.CreateChimeWebhookConfigurationRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.create_chime_webhook_configuration_result.CreateChimeWebhookConfigurationResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.create_chime_webhook_configuration.create_chime_webhook_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_microsoft_teams_channel_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.create_teams_channel_configuration_request.CreateTeamsChannelConfigurationRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.create_teams_channel_configuration_result.CreateTeamsChannelConfigurationResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.create_microsoft_teams_channel_configuration.create_microsoft_teams_channel_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_slack_channel_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.create_slack_channel_configuration_request.CreateSlackChannelConfigurationRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.create_slack_channel_configuration_result.CreateSlackChannelConfigurationResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.create_slack_channel_configuration.create_slack_channel_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_chime_webhook_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.delete_chime_webhook_configuration_request.DeleteChimeWebhookConfigurationRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.delete_chime_webhook_configuration_result.DeleteChimeWebhookConfigurationResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.delete_chime_webhook_configuration.delete_chime_webhook_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_microsoft_teams_channel_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.delete_teams_channel_configuration_request.DeleteTeamsChannelConfigurationRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.delete_teams_channel_configuration_result.DeleteTeamsChannelConfigurationResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.delete_microsoft_teams_channel_configuration.delete_microsoft_teams_channel_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_microsoft_teams_configured_team(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.delete_teams_configured_team_request.DeleteTeamsConfiguredTeamRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.delete_teams_configured_team_result.DeleteTeamsConfiguredTeamResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.delete_microsoft_teams_configured_team.delete_microsoft_teams_configured_team(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_microsoft_teams_user_identity(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.delete_microsoft_teams_user_identity_request.DeleteMicrosoftTeamsUserIdentityRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.delete_microsoft_teams_user_identity_result.DeleteMicrosoftTeamsUserIdentityResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.delete_microsoft_teams_user_identity.delete_microsoft_teams_user_identity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_slack_channel_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.delete_slack_channel_configuration_request.DeleteSlackChannelConfigurationRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.delete_slack_channel_configuration_result.DeleteSlackChannelConfigurationResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.delete_slack_channel_configuration.delete_slack_channel_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_slack_user_identity(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.delete_slack_user_identity_request.DeleteSlackUserIdentityRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.delete_slack_user_identity_result.DeleteSlackUserIdentityResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.delete_slack_user_identity.delete_slack_user_identity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_slack_workspace_authorization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.delete_slack_workspace_authorization_request.DeleteSlackWorkspaceAuthorizationRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.delete_slack_workspace_authorization_result.DeleteSlackWorkspaceAuthorizationResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.delete_slack_workspace_authorization.delete_slack_workspace_authorization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_chime_webhook_configurations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.describe_chime_webhook_configurations_request.DescribeChimeWebhookConfigurationsRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.describe_chime_webhook_configurations_result.DescribeChimeWebhookConfigurationsResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.describe_chime_webhook_configurations.describe_chime_webhook_configurations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_chime_webhook_configurations(
        self,
        *,
        config_overrides: Optional[chatbotClientConfig] = None,
        max_results: Optional["capo_chatbot.types.max_results.MaxResults"] = None,
    ...
    ) -> "Iterator[capo_chatbot.types.chime_webhook_configuration.ChimeWebhookConfiguration]":
        _token = next_token
        while True:
            _response = self.describe_chime_webhook_configurations(
    ...
    def describe_slack_channel_configurations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.describe_slack_channel_configurations_request.DescribeSlackChannelConfigurationsRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.describe_slack_channel_configurations_result.DescribeSlackChannelConfigurationsResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.describe_slack_channel_configurations.describe_slack_channel_configurations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_slack_channel_configurations(
        self,
        *,
        config_overrides: Optional[chatbotClientConfig] = None,
        max_results: Optional["capo_chatbot.types.max_results.MaxResults"] = None,
    ...
    ) -> "Iterator[capo_chatbot.types.slack_channel_configuration.SlackChannelConfiguration]":
        _token = next_token
        while True:
            _response = self.describe_slack_channel_configurations(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
                chat_configuration_arn=chat_configuration_arn,
    ...
    def describe_slack_user_identities(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.describe_slack_user_identities_request.DescribeSlackUserIdentitiesRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.describe_slack_user_identities_result.DescribeSlackUserIdentitiesResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.describe_slack_user_identities.describe_slack_user_identities(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_slack_user_identities(
        self,
        *,
        config_overrides: Optional[chatbotClientConfig] = None,
        chat_configuration_arn: Optional[
        ...
        max_results: Optional["capo_chatbot.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_chatbot.types.slack_user_identity.SlackUserIdentity]":
        _token = next_token
        while True:
            _response = self.describe_slack_user_identities(
                config_overrides=config_overrides,
                chat_configuration_arn=chat_configuration_arn,
                next_token=_token,
                max_results=max_results,
    ...
    def describe_slack_workspaces(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.describe_slack_workspaces_request.DescribeSlackWorkspacesRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.describe_slack_workspaces_result.DescribeSlackWorkspacesResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.describe_slack_workspaces.describe_slack_workspaces(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_slack_workspaces(
        self,
        *,
        config_overrides: Optional[chatbotClientConfig] = None,
        max_results: Optional["capo_chatbot.types.max_results.MaxResults"] = None,
    ...
    ) -> "Iterator[capo_chatbot.types.slack_workspace.SlackWorkspace]":
        _token = next_token
        while True:
            _response = self.describe_slack_workspaces(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            )
    ...
    def disassociate_from_configuration(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.disassociate_from_configuration(resource='arn:aws:chatbot::1234567890:custom-action/my-custom-action', chat_configuration='arn:aws:chatbot::1234567890:chat-configuration/slack-channel/my-channel')
        """

        def _handler(
            req: "OperationRequest[capo_chatbot.types.disassociate_from_configuration_request.DisassociateFromConfigurationRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.disassociate_from_configuration_result.DisassociateFromConfigurationResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.disassociate_from_configuration.disassociate_from_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_account_preferences(
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.get_account_preferences_request.GetAccountPreferencesRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.get_account_preferences_result.GetAccountPreferencesResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.get_account_preferences.get_account_preferences(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_microsoft_teams_channel_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.get_teams_channel_configuration_request.GetTeamsChannelConfigurationRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.get_teams_channel_configuration_result.GetTeamsChannelConfigurationResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.get_microsoft_teams_channel_configuration.get_microsoft_teams_channel_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_associations(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_associations(chat_configuration='arn:aws:chatbot::1234567890:chat-configuration/slack-channel/my-channel')
        """

        def _handler(
            req: "OperationRequest[capo_chatbot.types.list_associations_request.ListAssociationsRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.list_associations_result.ListAssociationsResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.list_associations.list_associations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_associations(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional["capo_chatbot.types.string.String"] = None,
    ) -> "Iterator[capo_chatbot.types.association_listing.AssociationListing]":
        _token = next_token
        while True:
    ...
    def list_microsoft_teams_channel_configurations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.list_teams_channel_configurations_request.ListTeamsChannelConfigurationsRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.list_teams_channel_configurations_result.ListTeamsChannelConfigurationsResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.list_microsoft_teams_channel_configurations.list_microsoft_teams_channel_configurations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_microsoft_teams_channel_configurations(
        self,
        *,
        config_overrides: Optional[chatbotClientConfig] = None,
        max_results: Optional["capo_chatbot.types.max_results.MaxResults"] = None,
        ...
        team_id: Optional["capo_chatbot.types.uuid.UUID"] = None,
    ) -> "Iterator[capo_chatbot.types.teams_channel_configuration.TeamsChannelConfiguration]":
        _token = next_token
        while True:
            _response = self.list_microsoft_teams_channel_configurations(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
                team_id=team_id,
    ...
    def list_microsoft_teams_configured_teams(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.list_microsoft_teams_configured_teams_request.ListMicrosoftTeamsConfiguredTeamsRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.list_microsoft_teams_configured_teams_result.ListMicrosoftTeamsConfiguredTeamsResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.list_microsoft_teams_configured_teams.list_microsoft_teams_configured_teams(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_microsoft_teams_configured_teams(
        self,
        *,
        config_overrides: Optional[chatbotClientConfig] = None,
        max_results: Optional["capo_chatbot.types.max_results.MaxResults"] = None,
    ...
    ) -> "Iterator[capo_chatbot.types.configured_team.ConfiguredTeam]":
        _token = next_token
        while True:
            _response = self.list_microsoft_teams_configured_teams(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            )
    ...
    def list_microsoft_teams_user_identities(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.list_microsoft_teams_user_identities_request.ListMicrosoftTeamsUserIdentitiesRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.list_microsoft_teams_user_identities_result.ListMicrosoftTeamsUserIdentitiesResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.list_microsoft_teams_user_identities.list_microsoft_teams_user_identities(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_microsoft_teams_user_identities(
        self,
        *,
        config_overrides: Optional[chatbotClientConfig] = None,
        chat_configuration_arn: Optional[
        ...
        max_results: Optional["capo_chatbot.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_chatbot.types.teams_user_identity.TeamsUserIdentity]":
        _token = next_token
        while True:
            _response = self.list_microsoft_teams_user_identities(
                config_overrides=config_overrides,
                chat_configuration_arn=chat_configuration_arn,
                next_token=_token,
                max_results=max_results,
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_account_preferences(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.update_account_preferences_request.UpdateAccountPreferencesRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.update_account_preferences_result.UpdateAccountPreferencesResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.update_account_preferences.update_account_preferences(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_chime_webhook_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.update_chime_webhook_configuration_request.UpdateChimeWebhookConfigurationRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.update_chime_webhook_configuration_result.UpdateChimeWebhookConfigurationResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.update_chime_webhook_configuration.update_chime_webhook_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_microsoft_teams_channel_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.update_teams_channel_configuration_request.UpdateTeamsChannelConfigurationRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.update_teams_channel_configuration_result.UpdateTeamsChannelConfigurationResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.update_microsoft_teams_channel_configuration.update_microsoft_teams_channel_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_slack_channel_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_chatbot.types.update_slack_channel_configuration_request.UpdateSlackChannelConfigurationRequest]",
        ) -> OperationResponse[
            "capo_chatbot.types.update_slack_channel_configuration_result.UpdateSlackChannelConfigurationResult"
        ]:
            ...
            output, http_response = (
                capo_chatbot._operations.wheatley_orchestration_20171011.update_slack_channel_configuration.update_slack_channel_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
