...
class ConnectCampaignsError(Exception):
    """Base class for all ConnectCampaigns service errors."""


class ServiceError(ConnectCampaignsError):
...
class SerializationError(ConnectCampaignsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ConnectCampaignsError):
...
class WaiterFailedError(ConnectCampaignsError):
...
class WaiterTimeoutError(ConnectCampaignsError):
