...
if TYPE_CHECKING:
    ...
    import capo_connectcampaigns.types.get_campaign_state_batch_failure_code
...
class FailedCampaignStateResponse(TypedDict, closed=True):
    ...
    failure_code: NotRequired[
        "capo_connectcampaigns.types.get_campaign_state_batch_failure_code.GetCampaignStateBatchFailureCode"
    ]
