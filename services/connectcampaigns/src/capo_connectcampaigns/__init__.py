...
from ._services.async_connect_campaigns import (
    AsyncConnectCampaignsClient as AsyncConnectCampaignsClient,
)
from ._services.connect_campaigns import (
    ConnectCampaignsClient as ConnectCampaignsClient,
)
