"""Generated from Smithy shape ``com.amazonaws.connectcampaigns#CampaignFilters``."""
...
if TYPE_CHECKING:
    import aws_sdk_connectcampaigns.types.instance_id_filter


class CampaignFilters(TypedDict):
    instance_id_filter: NotRequired[
        "aws_sdk_connectcampaigns.types.instance_id_filter.InstanceIdFilter"
    ]
...
def serialize_json(value: CampaignFilters) -> dict:
    ...
    if "instance_id_filter" in value:
        ...
        out["instanceIdFilter"] = (
            aws_sdk_connectcampaigns.types.instance_id_filter.serialize_json(
...
def deserialize_json(data: dict) -> CampaignFilters:
    ...
    if "instanceIdFilter" in data:
        ...
        out["instance_id_filter"] = (
            aws_sdk_connectcampaigns.types.instance_id_filter.deserialize_json(
