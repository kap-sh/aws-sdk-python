"""Generated from Smithy shape ``com.amazonaws.connectcampaigns#InstanceIdFilter``."""
...
if TYPE_CHECKING:
    ...
    import aws_sdk_connectcampaigns.types.instance_id_filter_operator


class InstanceIdFilter(TypedDict, closed=True):
    value: "aws_sdk_connectcampaigns.types.instance_id.InstanceId"
    operator: "aws_sdk_connectcampaigns.types.instance_id_filter_operator.InstanceIdFilterOperator"
