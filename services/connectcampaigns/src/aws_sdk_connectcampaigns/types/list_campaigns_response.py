"""Generated from Smithy shape ``com.amazonaws.connectcampaigns#ListCampaignsResponse``."""
...
if TYPE_CHECKING:
    import aws_sdk_connectcampaigns.types.campaign_summary_list
    import aws_sdk_connectcampaigns.types.next_token


class ListCampaignsResponse(TypedDict, closed=True):
    next_token: NotRequired["aws_sdk_connectcampaigns.types.next_token.NextToken"]
    campaign_summary_list: NotRequired[
        "aws_sdk_connectcampaigns.types.campaign_summary_list.CampaignSummaryList"
    ]
...
def serialize_json(value: ListCampaignsResponse) -> dict:
    ...
    if "campaign_summary_list" in value:
        ...
        out["campaignSummaryList"] = (
            aws_sdk_connectcampaigns.types.campaign_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListCampaignsResponse:
    ...
    if "campaignSummaryList" in data:
        ...
        out["campaign_summary_list"] = (
            aws_sdk_connectcampaigns.types.campaign_summary_list.deserialize_json(
