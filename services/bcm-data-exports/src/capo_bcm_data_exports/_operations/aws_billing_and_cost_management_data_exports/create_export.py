...
import capo_bcm_data_exports.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_bcm_data_exports.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_bcm_data_exports.types.create_export_response.CreateExportResponse = (
        capo_bcm_data_exports.types.create_export_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_data_exports.types.create_export_request.serialize_aws_json_1_1(input_)
    ).encode()
