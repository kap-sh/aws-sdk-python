"""Generated from Smithy shape ``com.amazonaws.bcmdataexports#UpdateExport``."""
...
def handle_response(
    ...
    out: capo_bcm_data_exports.types.update_export_response.UpdateExportResponse = (
        capo_bcm_data_exports.types.update_export_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBillingAndCostManagementDataExports.UpdateExport"
    body: bytes | None = json.dumps(
        capo_bcm_data_exports.types.update_export_request.serialize_aws_json_1_1(input_)
    ).encode()
