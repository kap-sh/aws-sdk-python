"""Generated from Smithy shape ``com.amazonaws.bcmdataexports#UntagResource``."""
...
import capo_bcm_data_exports.errors.access_denied_exception
import capo_bcm_data_exports.errors.internal_server_exception
import capo_bcm_data_exports.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise capo_bcm_data_exports.errors.access_denied_exception.AccessDeniedException.from_aws_json_1_1(
                data
            )
        ...
        case "ResourceNotFoundException":
            raise capo_bcm_data_exports.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_bcm_data_exports.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBillingAndCostManagementDataExports.UntagResource"
    body: bytes | None = json.dumps(
        capo_bcm_data_exports.types.untag_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
