...
def handle_response(
    ...
    out: capo_bcm_data_exports.types.get_execution_response.GetExecutionResponse = (
        capo_bcm_data_exports.types.get_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_data_exports.types.get_execution_request.serialize_aws_json_1_1(input_)
    ).encode()
