...
def handle_response(
    ...
    out: aws_sdk_bcm_data_exports.types.delete_export_response.DeleteExportResponse = (
        aws_sdk_bcm_data_exports.types.delete_export_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_bcm_data_exports.types.delete_export_request.DeleteExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_data_exports.types.delete_export_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
