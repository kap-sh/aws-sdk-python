"""Generated from Smithy shape ``com.amazonaws.bcmdataexports#DeleteExport``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bcm_data_exports.types.delete_export_response.DeleteExportResponse:
    import aws_sdk_bcm_data_exports.types.delete_export_response
    out: aws_sdk_bcm_data_exports.types.delete_export_response.DeleteExportResponse = aws_sdk_bcm_data_exports.types.delete_export_response.deserialize_aws_json_1_1(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.delete_export_request.DeleteExportRequest) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSBillingAndCostManagementDataExports.DeleteExport"
    import aws_sdk_bcm_data_exports.types.delete_export_request
    body: bytes | None = json.dumps(aws_sdk_bcm_data_exports.types.delete_export_request.serialize_aws_json_1_1(input)).encode()
...
def delete_export(options: OperationOptions, input: aws_sdk_bcm_data_exports.types.delete_export_request.DeleteExportRequest) -> tuple[aws_sdk_bcm_data_exports.types.delete_export_response.DeleteExportResponse, zapros.Response]:
...
async def async_delete_export(options: AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.delete_export_request.DeleteExportRequest) -> tuple[aws_sdk_bcm_data_exports.types.delete_export_response.DeleteExportResponse, zapros.Response]:
