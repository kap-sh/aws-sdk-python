...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bcm_data_exports.types.list_executions_response.ListExecutionsResponse:
    import aws_sdk_bcm_data_exports.types.list_executions_response
    out: aws_sdk_bcm_data_exports.types.list_executions_response.ListExecutionsResponse = aws_sdk_bcm_data_exports.types.list_executions_response.deserialize_aws_json_1_1(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.list_executions_request.ListExecutionsRequest) -> zapros.Request:
    ...
    import aws_sdk_bcm_data_exports.types.list_executions_request
    body: bytes | None = json.dumps(aws_sdk_bcm_data_exports.types.list_executions_request.serialize_aws_json_1_1(input)).encode()
...
def list_executions(options: OperationOptions, input: aws_sdk_bcm_data_exports.types.list_executions_request.ListExecutionsRequest) -> tuple[aws_sdk_bcm_data_exports.types.list_executions_response.ListExecutionsResponse, zapros.Response]:
...
async def async_list_executions(options: AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.list_executions_request.ListExecutionsRequest) -> tuple[aws_sdk_bcm_data_exports.types.list_executions_response.ListExecutionsResponse, zapros.Response]:
