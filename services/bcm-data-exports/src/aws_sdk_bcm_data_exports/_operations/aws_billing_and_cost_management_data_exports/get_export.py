"""Generated from Smithy shape ``com.amazonaws.bcmdataexports#GetExport``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bcm_data_exports.types.get_export_response.GetExportResponse:
    import aws_sdk_bcm_data_exports.types.get_export_response
    out: aws_sdk_bcm_data_exports.types.get_export_response.GetExportResponse = aws_sdk_bcm_data_exports.types.get_export_response.deserialize_aws_json_1_1(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.get_export_request.GetExportRequest) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSBillingAndCostManagementDataExports.GetExport"
    import aws_sdk_bcm_data_exports.types.get_export_request
    body: bytes | None = json.dumps(aws_sdk_bcm_data_exports.types.get_export_request.serialize_aws_json_1_1(input)).encode()
...
def get_export(options: OperationOptions, input: aws_sdk_bcm_data_exports.types.get_export_request.GetExportRequest) -> tuple[aws_sdk_bcm_data_exports.types.get_export_response.GetExportResponse, zapros.Response]:
...
async def async_get_export(options: AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.get_export_request.GetExportRequest) -> tuple[aws_sdk_bcm_data_exports.types.get_export_response.GetExportResponse, zapros.Response]:
