...
def build_request(
    ...
    input: aws_sdk_bcm_data_exports.types.get_export_request.GetExportRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_data_exports.types.get_export_request.serialize_aws_json_1_1(input)
    ).encode()
