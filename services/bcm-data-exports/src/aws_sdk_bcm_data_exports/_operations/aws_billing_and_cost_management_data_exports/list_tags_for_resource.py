"""Generated from Smithy shape ``com.amazonaws.bcmdataexports#ListTagsForResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            import aws_sdk_bcm_data_exports.errors.resource_not_found_exception
            raise aws_sdk_bcm_data_exports.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(data)
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bcm_data_exports.types.list_tags_for_resource_response.ListTagsForResourceResponse:
    import aws_sdk_bcm_data_exports.types.list_tags_for_resource_response
    out: aws_sdk_bcm_data_exports.types.list_tags_for_resource_response.ListTagsForResourceResponse = aws_sdk_bcm_data_exports.types.list_tags_for_resource_response.deserialize_aws_json_1_1(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.list_tags_for_resource_request.ListTagsForResourceRequest) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSBillingAndCostManagementDataExports.ListTagsForResource"
    import aws_sdk_bcm_data_exports.types.list_tags_for_resource_request
    body: bytes | None = json.dumps(aws_sdk_bcm_data_exports.types.list_tags_for_resource_request.serialize_aws_json_1_1(input)).encode()
...
def list_tags_for_resource(options: OperationOptions, input: aws_sdk_bcm_data_exports.types.list_tags_for_resource_request.ListTagsForResourceRequest) -> tuple[aws_sdk_bcm_data_exports.types.list_tags_for_resource_response.ListTagsForResourceResponse, zapros.Response]:
...
async def async_list_tags_for_resource(options: AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.list_tags_for_resource_request.ListTagsForResourceRequest) -> tuple[aws_sdk_bcm_data_exports.types.list_tags_for_resource_response.ListTagsForResourceResponse, zapros.Response]:
