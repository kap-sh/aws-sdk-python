"""Generated from Smithy shape ``com.amazonaws.bcmdataexports#ListExports``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bcm_data_exports.types.list_exports_response.ListExportsResponse:
    import aws_sdk_bcm_data_exports.types.list_exports_response
    out: aws_sdk_bcm_data_exports.types.list_exports_response.ListExportsResponse = aws_sdk_bcm_data_exports.types.list_exports_response.deserialize_aws_json_1_1(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.list_exports_request.ListExportsRequest) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSBillingAndCostManagementDataExports.ListExports"
    import aws_sdk_bcm_data_exports.types.list_exports_request
    body: bytes | None = json.dumps(aws_sdk_bcm_data_exports.types.list_exports_request.serialize_aws_json_1_1(input)).encode()
...
def list_exports(options: OperationOptions, input: aws_sdk_bcm_data_exports.types.list_exports_request.ListExportsRequest) -> tuple[aws_sdk_bcm_data_exports.types.list_exports_response.ListExportsResponse, zapros.Response]:
...
async def async_list_exports(options: AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.list_exports_request.ListExportsRequest) -> tuple[aws_sdk_bcm_data_exports.types.list_exports_response.ListExportsResponse, zapros.Response]:
