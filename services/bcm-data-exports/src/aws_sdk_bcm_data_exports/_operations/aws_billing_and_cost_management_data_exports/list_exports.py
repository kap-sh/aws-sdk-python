...
import aws_sdk_bcm_data_exports.types.export_reference_list
...
def handle_response(
    ...
    out: aws_sdk_bcm_data_exports.types.list_exports_response.ListExportsResponse = (
        aws_sdk_bcm_data_exports.types.list_exports_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_bcm_data_exports.types.list_exports_request.ListExportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_data_exports.types.list_exports_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
