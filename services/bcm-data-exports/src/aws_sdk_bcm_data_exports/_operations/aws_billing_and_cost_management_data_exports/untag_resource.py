...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bcm_data_exports.types.untag_resource_response.UntagResourceResponse:
    out: aws_sdk_bcm_data_exports.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.untag_resource_request.UntagResourceRequest) -> zapros.Request:
    ...
    import aws_sdk_bcm_data_exports.types.untag_resource_request
    body: bytes | None = json.dumps(aws_sdk_bcm_data_exports.types.untag_resource_request.serialize_aws_json_1_1(input)).encode()
...
def untag_resource(options: OperationOptions, input: aws_sdk_bcm_data_exports.types.untag_resource_request.UntagResourceRequest) -> tuple[aws_sdk_bcm_data_exports.types.untag_resource_response.UntagResourceResponse, zapros.Response]:
...
async def async_untag_resource(options: AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.untag_resource_request.UntagResourceRequest) -> tuple[aws_sdk_bcm_data_exports.types.untag_resource_response.UntagResourceResponse, zapros.Response]:
