...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bcm_data_exports.types.update_export_response.UpdateExportResponse:
    import aws_sdk_bcm_data_exports.types.update_export_response
    out: aws_sdk_bcm_data_exports.types.update_export_response.UpdateExportResponse = aws_sdk_bcm_data_exports.types.update_export_response.deserialize_aws_json_1_1(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.update_export_request.UpdateExportRequest) -> zapros.Request:
    ...
    import aws_sdk_bcm_data_exports.types.update_export_request
    body: bytes | None = json.dumps(aws_sdk_bcm_data_exports.types.update_export_request.serialize_aws_json_1_1(input)).encode()
...
def update_export(options: OperationOptions, input: aws_sdk_bcm_data_exports.types.update_export_request.UpdateExportRequest) -> tuple[aws_sdk_bcm_data_exports.types.update_export_response.UpdateExportResponse, zapros.Response]:
...
async def async_update_export(options: AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.update_export_request.UpdateExportRequest) -> tuple[aws_sdk_bcm_data_exports.types.update_export_response.UpdateExportResponse, zapros.Response]:
