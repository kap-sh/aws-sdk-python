...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            ...
            raise aws_sdk_bcm_data_exports.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_bcm_data_exports.types.get_execution_response.GetExecutionResponse = (
        aws_sdk_bcm_data_exports.types.get_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_bcm_data_exports.types.get_execution_request.GetExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_data_exports.types.get_execution_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
