"""Generated from Smithy shape ``com.amazonaws.bcmdataexports#GetExecution``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bcm_data_exports.types.get_execution_response.GetExecutionResponse:
    import aws_sdk_bcm_data_exports.types.get_execution_response
    out: aws_sdk_bcm_data_exports.types.get_execution_response.GetExecutionResponse = aws_sdk_bcm_data_exports.types.get_execution_response.deserialize_aws_json_1_1(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.get_execution_request.GetExecutionRequest) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSBillingAndCostManagementDataExports.GetExecution"
    import aws_sdk_bcm_data_exports.types.get_execution_request
    body: bytes | None = json.dumps(aws_sdk_bcm_data_exports.types.get_execution_request.serialize_aws_json_1_1(input)).encode()
...
def get_execution(options: OperationOptions, input: aws_sdk_bcm_data_exports.types.get_execution_request.GetExecutionRequest) -> tuple[aws_sdk_bcm_data_exports.types.get_execution_response.GetExecutionResponse, zapros.Response]:
...
async def async_get_execution(options: AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.get_execution_request.GetExecutionRequest) -> tuple[aws_sdk_bcm_data_exports.types.get_execution_response.GetExecutionResponse, zapros.Response]:
