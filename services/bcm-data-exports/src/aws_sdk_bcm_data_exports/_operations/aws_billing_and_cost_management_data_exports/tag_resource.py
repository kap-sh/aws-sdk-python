"""Generated from Smithy shape ``com.amazonaws.bcmdataexports#TagResource``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bcm_data_exports.types.tag_resource_response.TagResourceResponse:
    out: aws_sdk_bcm_data_exports.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.tag_resource_request.TagResourceRequest) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSBillingAndCostManagementDataExports.TagResource"
    import aws_sdk_bcm_data_exports.types.tag_resource_request
    body: bytes | None = json.dumps(aws_sdk_bcm_data_exports.types.tag_resource_request.serialize_aws_json_1_1(input)).encode()
...
def tag_resource(options: OperationOptions, input: aws_sdk_bcm_data_exports.types.tag_resource_request.TagResourceRequest) -> tuple[aws_sdk_bcm_data_exports.types.tag_resource_response.TagResourceResponse, zapros.Response]:
...
async def async_tag_resource(options: AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.tag_resource_request.TagResourceRequest) -> tuple[aws_sdk_bcm_data_exports.types.tag_resource_response.TagResourceResponse, zapros.Response]:
