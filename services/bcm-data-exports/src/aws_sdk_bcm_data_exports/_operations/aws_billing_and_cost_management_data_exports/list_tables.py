...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bcm_data_exports.types.list_tables_response.ListTablesResponse:
    import aws_sdk_bcm_data_exports.types.list_tables_response
    out: aws_sdk_bcm_data_exports.types.list_tables_response.ListTablesResponse = aws_sdk_bcm_data_exports.types.list_tables_response.deserialize_aws_json_1_1(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.list_tables_request.ListTablesRequest) -> zapros.Request:
    ...
    import aws_sdk_bcm_data_exports.types.list_tables_request
    body: bytes | None = json.dumps(aws_sdk_bcm_data_exports.types.list_tables_request.serialize_aws_json_1_1(input)).encode()
...
def list_tables(options: OperationOptions, input: aws_sdk_bcm_data_exports.types.list_tables_request.ListTablesRequest) -> tuple[aws_sdk_bcm_data_exports.types.list_tables_response.ListTablesResponse, zapros.Response]:
...
async def async_list_tables(options: AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.list_tables_request.ListTablesRequest) -> tuple[aws_sdk_bcm_data_exports.types.list_tables_response.ListTablesResponse, zapros.Response]:
