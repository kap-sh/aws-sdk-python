...
def handle_response(
    ...
    out: aws_sdk_bcm_data_exports.types.list_tables_response.ListTablesResponse = (
        aws_sdk_bcm_data_exports.types.list_tables_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_bcm_data_exports.types.list_tables_request.ListTablesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_data_exports.types.list_tables_request.serialize_aws_json_1_1(input)
    ).encode()
