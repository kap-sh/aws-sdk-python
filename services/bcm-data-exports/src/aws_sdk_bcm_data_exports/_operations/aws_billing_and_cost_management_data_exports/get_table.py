...
def handle_response(
    ...
    out: aws_sdk_bcm_data_exports.types.get_table_response.GetTableResponse = (
        aws_sdk_bcm_data_exports.types.get_table_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_bcm_data_exports.types.get_table_request.GetTableRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bcm_data_exports.types.get_table_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_table(
    ...
    aws_sdk_bcm_data_exports.types.get_table_response.GetTableResponse, zapros.Response
]:
