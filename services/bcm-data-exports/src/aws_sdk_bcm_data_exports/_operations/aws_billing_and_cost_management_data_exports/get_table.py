...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_bcm_data_exports.types.get_table_response.GetTableResponse:
    import aws_sdk_bcm_data_exports.types.get_table_response
    out: aws_sdk_bcm_data_exports.types.get_table_response.GetTableResponse = aws_sdk_bcm_data_exports.types.get_table_response.deserialize_aws_json_1_1(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.get_table_request.GetTableRequest) -> zapros.Request:
    ...
    import aws_sdk_bcm_data_exports.types.get_table_request
    body: bytes | None = json.dumps(aws_sdk_bcm_data_exports.types.get_table_request.serialize_aws_json_1_1(input)).encode()
...
def get_table(options: OperationOptions, input: aws_sdk_bcm_data_exports.types.get_table_request.GetTableRequest) -> tuple[aws_sdk_bcm_data_exports.types.get_table_response.GetTableResponse, zapros.Response]:
...
async def async_get_table(options: AsyncOperationOptions, input: aws_sdk_bcm_data_exports.types.get_table_request.GetTableRequest) -> tuple[aws_sdk_bcm_data_exports.types.get_table_response.GetTableResponse, zapros.Response]:
