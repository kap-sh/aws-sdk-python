...
from aws_sdk_bcm_data_exports._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
from aws_sdk_bcm_data_exports._async import anysleep
import time
...
class AsyncBCMDataExportsClientConfig(TypedDict, total=False):
...
class AsyncBCMDataExportsClient:
    ...
    def __init__(self, http_handler: AsyncBaseHandler | None = None, operation_interceptors: Iterable[AsyncInterceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, use_fips: bool | None = None, endpoint: str | None = None, region: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = AsyncBCMDataExportsClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "use_fips": use_fips, "endpoint": endpoint, "region": region, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[AsyncBCMDataExportsClientConfig] = None) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
    ...
    async def get_execution(self, export_arn: "aws_sdk_bcm_data_exports.types.arn.Arn", execution_id: "aws_sdk_bcm_data_exports.types.generic_string.GenericString", *, config_overrides: Optional[AsyncBCMDataExportsClientConfig] = None) -> "aws_sdk_bcm_data_exports.types.get_execution_response.GetExecutionResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bcm_data_exports.types.get_execution_request.GetExecutionRequest]') -> AsyncOperationResponse["aws_sdk_bcm_data_exports.types.get_execution_response.GetExecutionResponse"]:
            import aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.get_execution
            output, http_response = await aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.get_execution.async_get_execution(req.options, req.input)
    ...
    async def get_table(self, table_name: "aws_sdk_bcm_data_exports.types.table_name.TableName", *, config_overrides: Optional[AsyncBCMDataExportsClientConfig] = None, table_properties: Optional["aws_sdk_bcm_data_exports.types.table_properties.TableProperties"] = None) -> "aws_sdk_bcm_data_exports.types.get_table_response.GetTableResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bcm_data_exports.types.get_table_request.GetTableRequest]') -> AsyncOperationResponse["aws_sdk_bcm_data_exports.types.get_table_response.GetTableResponse"]:
            import aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.get_table
            output, http_response = await aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.get_table.async_get_table(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def list_executions(self, export_arn: "aws_sdk_bcm_data_exports.types.arn.Arn", *, config_overrides: Optional[AsyncBCMDataExportsClientConfig] = None, max_results: Optional["aws_sdk_bcm_data_exports.types.max_results.MaxResults"] = None, next_token: Optional["aws_sdk_bcm_data_exports.types.next_page_token.NextPageToken"] = None) -> "aws_sdk_bcm_data_exports.types.list_executions_response.ListExecutionsResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bcm_data_exports.types.list_executions_request.ListExecutionsRequest]') -> AsyncOperationResponse["aws_sdk_bcm_data_exports.types.list_executions_response.ListExecutionsResponse"]:
            import aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.list_executions
            output, http_response = await aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.list_executions.async_list_executions(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_executions(self, export_arn: "aws_sdk_bcm_data_exports.types.arn.Arn", *, config_overrides: Optional[AsyncBCMDataExportsClientConfig] = None, max_results: Optional["aws_sdk_bcm_data_exports.types.max_results.MaxResults"] = None, next_token: Optional["aws_sdk_bcm_data_exports.types.next_page_token.NextPageToken"] = None) -> "AsyncIterator[aws_sdk_bcm_data_exports.types.execution_reference.ExecutionReference]":
        _token = next_token
        while True:
    ...
    async def list_tables(self, *, config_overrides: Optional[AsyncBCMDataExportsClientConfig] = None, next_token: Optional["aws_sdk_bcm_data_exports.types.next_page_token.NextPageToken"] = None, max_results: Optional["aws_sdk_bcm_data_exports.types.max_results.MaxResults"] = None) -> "aws_sdk_bcm_data_exports.types.list_tables_response.ListTablesResponse":
        ...
        Args:
            ...
            max_results: <p>The maximum number of objects that are returned for the request.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bcm_data_exports.types.list_tables_request.ListTablesRequest]') -> AsyncOperationResponse["aws_sdk_bcm_data_exports.types.list_tables_response.ListTablesResponse"]:
            import aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.list_tables
            output, http_response = await aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.list_tables.async_list_tables(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def iter_list_tables(self, *, config_overrides: Optional[AsyncBCMDataExportsClientConfig] = None, next_token: Optional["aws_sdk_bcm_data_exports.types.next_page_token.NextPageToken"] = None, max_results: Optional["aws_sdk_bcm_data_exports.types.max_results.MaxResults"] = None) -> "AsyncIterator[aws_sdk_bcm_data_exports.types.table.Table]":
        _token = next_token
        while True:
            ...
            if not _token:
                break
    async def list_tags_for_resource(self, resource_arn: "aws_sdk_bcm_data_exports.types.arn.Arn", *, config_overrides: Optional[AsyncBCMDataExportsClientConfig] = None, max_results: Optional["aws_sdk_bcm_data_exports.types.max_results.MaxResults"] = None, next_token: Optional["aws_sdk_bcm_data_exports.types.next_page_token.NextPageToken"] = None) -> "aws_sdk_bcm_data_exports.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        Args:
            ...
            next_token: <p>The token to retrieve the next set of results.</p>
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bcm_data_exports.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> AsyncOperationResponse["aws_sdk_bcm_data_exports.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.list_tags_for_resource
            output, http_response = await aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.list_tags_for_resource.async_list_tags_for_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def tag_resource(self, resource_arn: "aws_sdk_bcm_data_exports.types.arn.Arn", resource_tags: "aws_sdk_bcm_data_exports.types.resource_tag_list.ResourceTagList", *, config_overrides: Optional[AsyncBCMDataExportsClientConfig] = None) -> "aws_sdk_bcm_data_exports.types.tag_resource_response.TagResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bcm_data_exports.types.tag_resource_request.TagResourceRequest]') -> AsyncOperationResponse["aws_sdk_bcm_data_exports.types.tag_resource_response.TagResourceResponse"]:
            import aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.tag_resource
            output, http_response = await aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.tag_resource.async_tag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def untag_resource(self, resource_arn: "aws_sdk_bcm_data_exports.types.arn.Arn", resource_tag_keys: "aws_sdk_bcm_data_exports.types.resource_tag_key_list.ResourceTagKeyList", *, config_overrides: Optional[AsyncBCMDataExportsClientConfig] = None) -> "aws_sdk_bcm_data_exports.types.untag_resource_response.UntagResourceResponse":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_bcm_data_exports.types.untag_resource_request.UntagResourceRequest]') -> AsyncOperationResponse["aws_sdk_bcm_data_exports.types.untag_resource_response.UntagResourceResponse"]:
            import aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.untag_resource
            output, http_response = await aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.untag_resource.async_untag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)
