...
from aws_sdk_bcm_data_exports._services._aws_config import aaws_config
...
class AsyncBCMDataExportsClient:
    ...
    async def get_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_data_exports.types.get_execution_request.GetExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_data_exports.types.get_execution_response.GetExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.get_execution.async_get_execution(
    ...
    async def get_table(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_data_exports.types.get_table_request.GetTableRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_data_exports.types.get_table_response.GetTableResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.get_table.async_get_table(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_executions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_data_exports.types.list_executions_request.ListExecutionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_data_exports.types.list_executions_response.ListExecutionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.list_executions.async_list_executions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_bcm_data_exports.types.execution_reference.ExecutionReference]":
        _token = next_token
        while True:
    ...
    async def list_tables(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_data_exports.types.list_tables_request.ListTablesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_data_exports.types.list_tables_response.ListTablesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.list_tables.async_list_tables(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_bcm_data_exports.types.table.Table]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_data_exports.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_data_exports.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_data_exports.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_data_exports.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bcm_data_exports.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bcm_data_exports.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bcm_data_exports._operations.aws_billing_and_cost_management_data_exports.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
