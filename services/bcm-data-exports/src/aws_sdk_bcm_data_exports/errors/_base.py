...
class BCMDataExportsError(Exception):
    """Base class for all BCMDataExports service errors."""

class ServiceError(BCMDataExportsError):
...
class SerializationError(BCMDataExportsError):
    """Raised when a value cannot be serialized."""

class DeserializationError(BCMDataExportsError):
...
class WaiterFailedError(BCMDataExportsError):
...
class WaiterTimeoutError(BCMDataExportsError):
