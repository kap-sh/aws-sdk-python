...
class DataQuery(TypedDict):
    ...
    table_configurations: NotRequired[
        "aws_sdk_bcm_data_exports.types.table_configurations.TableConfigurations"
    ]
...
def serialize_aws_json_1_1(value: DataQuery) -> dict:
    ...
    if "table_configurations" in value:
        ...
        out["TableConfigurations"] = (
            aws_sdk_bcm_data_exports.types.table_configurations.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DataQuery:
    ...
    if "TableConfigurations" in data:
        ...
        out["table_configurations"] = (
            aws_sdk_bcm_data_exports.types.table_configurations.deserialize_aws_json_1_1(
