...
class ListExportsResponse(TypedDict, closed=True):
    exports: NotRequired[
        "aws_sdk_bcm_data_exports.types.export_reference_list.ExportReferenceList"
    ]
...
def serialize_aws_json_1_1(value: ListExportsResponse) -> dict:
    ...
    if "exports" in value:
        ...
        out["Exports"] = (
            aws_sdk_bcm_data_exports.types.export_reference_list.serialize_aws_json_1_1(
                value["exports"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListExportsResponse:
    ...
    if "Exports" in data:
        ...
        out["exports"] = (
            aws_sdk_bcm_data_exports.types.export_reference_list.deserialize_aws_json_1_1(
                data["Exports"]
            )
        )
