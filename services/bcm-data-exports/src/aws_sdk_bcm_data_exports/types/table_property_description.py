...
if TYPE_CHECKING:
    ...
    import aws_sdk_bcm_data_exports.types.generic_string_list


class TablePropertyDescription(TypedDict):
    name: NotRequired["aws_sdk_bcm_data_exports.types.generic_string.GenericString"]
    """<p>The name of the table.</p>"""
    valid_values: NotRequired[
        "aws_sdk_bcm_data_exports.types.generic_string_list.GenericStringList"
    ]
...
def serialize_aws_json_1_1(value: TablePropertyDescription) -> dict:
    ...
    if "valid_values" in value:
        ...
        out["ValidValues"] = (
            aws_sdk_bcm_data_exports.types.generic_string_list.serialize_aws_json_1_1(
                value["valid_values"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> TablePropertyDescription:
    ...
    if "ValidValues" in data:
        ...
        out["valid_values"] = (
            aws_sdk_bcm_data_exports.types.generic_string_list.deserialize_aws_json_1_1(
                data["ValidValues"]
            )
        )
