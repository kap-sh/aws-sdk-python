...
if TYPE_CHECKING:
    ...
    import aws_sdk_bcm_data_exports.types.resource_tag_value


class ResourceTag(TypedDict):
    key: "aws_sdk_bcm_data_exports.types.resource_tag_key.ResourceTagKey"
    """<p>The key that's associated with the tag.</p>"""
    value: "aws_sdk_bcm_data_exports.types.resource_tag_value.ResourceTagValue"
