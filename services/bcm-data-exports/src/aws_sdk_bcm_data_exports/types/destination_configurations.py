...
def serialize_aws_json_1_1(value: DestinationConfigurations) -> dict:
    out: dict = {}
    import aws_sdk_bcm_data_exports.types.s3_destination
    out["S3Destination"] = aws_sdk_bcm_data_exports.types.s3_destination.serialize_aws_json_1_1(value["s3_destination"])
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DestinationConfigurations:
    ...
    if "S3Destination" in data:
        import aws_sdk_bcm_data_exports.types.s3_destination
        out["s3_destination"] = aws_sdk_bcm_data_exports.types.s3_destination.deserialize_aws_json_1_1(data["S3Destination"])
    else:
