...
```
pip install aws-sdk-connectcampaignsv2
```

## Usage

```python
from aws_sdk_connectcampaignsv2 import AsyncConnectCampaignsV2Client
...
```python
from aws_sdk_connectcampaignsv2 import AsyncConnectCampaignsV2Client
from aws_sdk_connectcampaignsv2.error import AccessDeniedException
