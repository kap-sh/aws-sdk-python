"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#UpdateCampaignName``."""
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.update_campaign_name_request.UpdateCampaignNameRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/campaigns/{id}/name"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcampaignsv2.types.update_campaign_name_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_campaign_name(
