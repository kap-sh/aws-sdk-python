"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#UntagResource``."""
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/tags/{arn}"
