...
def handle_response(
    ...
    out: aws_sdk_connectcampaignsv2.types.list_campaigns_response.ListCampaignsResponse = aws_sdk_connectcampaignsv2.types.list_campaigns_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.list_campaigns_request.ListCampaignsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcampaignsv2.types.list_campaigns_request.serialize_json(input_)
    ).encode()
