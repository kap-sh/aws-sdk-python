...
def build_request(
    ...
    input: aws_sdk_connectcampaignsv2.types.list_campaigns_request.ListCampaignsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcampaignsv2.types.list_campaigns_request.serialize_json(input)
    ).encode()
