"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#UpdateCampaignSource``."""
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.update_campaign_source_request.UpdateCampaignSourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/campaigns/{id}/source"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcampaignsv2.types.update_campaign_source_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_campaign_source(
