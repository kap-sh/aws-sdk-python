...
def handle_response(
    ...
    out: aws_sdk_connectcampaignsv2.types.get_campaign_state_response.GetCampaignStateResponse = aws_sdk_connectcampaignsv2.types.get_campaign_state_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.get_campaign_state_request.GetCampaignStateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
