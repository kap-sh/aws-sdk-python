"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#GetConnectInstanceConfig``."""
...
import aws_sdk_connectcampaignsv2.types.instance_config
...
def handle_response(
    ...
    out: aws_sdk_connectcampaignsv2.types.get_connect_instance_config_response.GetConnectInstanceConfigResponse = aws_sdk_connectcampaignsv2.types.get_connect_instance_config_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.get_connect_instance_config_request.GetConnectInstanceConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/connect-instance/{connectInstanceId}/config"
    url = url.replace(
