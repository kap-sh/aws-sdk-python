...
def handle_response(
    ...
    out: aws_sdk_connectcampaignsv2.types.get_instance_onboarding_job_status_response.GetInstanceOnboardingJobStatusResponse = aws_sdk_connectcampaignsv2.types.get_instance_onboarding_job_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.get_instance_onboarding_job_status_request.GetInstanceOnboardingJobStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
