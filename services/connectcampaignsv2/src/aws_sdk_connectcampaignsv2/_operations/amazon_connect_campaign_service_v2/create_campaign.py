...
def build_request(
    ...
    input: aws_sdk_connectcampaignsv2.types.create_campaign_request.CreateCampaignRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcampaignsv2.types.create_campaign_request.serialize_json(input)
    ).encode()
