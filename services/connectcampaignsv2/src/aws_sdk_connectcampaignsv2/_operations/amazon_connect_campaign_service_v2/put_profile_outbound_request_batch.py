...
def handle_response(
    ...
    out: aws_sdk_connectcampaignsv2.types.put_profile_outbound_request_batch_response.PutProfileOutboundRequestBatchResponse = aws_sdk_connectcampaignsv2.types.put_profile_outbound_request_batch_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.put_profile_outbound_request_batch_request.PutProfileOutboundRequestBatchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcampaignsv2.types.put_profile_outbound_request_batch_request.serialize_json(
            input_
        )
    ).encode()
