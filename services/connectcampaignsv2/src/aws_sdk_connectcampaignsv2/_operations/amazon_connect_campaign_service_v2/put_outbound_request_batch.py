"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#PutOutboundRequestBatch``."""
...
import aws_sdk_connectcampaignsv2.errors.conflict_exception
import aws_sdk_connectcampaignsv2.errors.internal_server_exception
import aws_sdk_connectcampaignsv2.errors.invalid_campaign_state_exception
import aws_sdk_connectcampaignsv2.errors.resource_not_found_exception
import aws_sdk_connectcampaignsv2.errors.throttling_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise aws_sdk_connectcampaignsv2.errors.conflict_exception.ConflictException.from_json(
                data
            )
        ...
        case "InvalidCampaignStateException":
            raise aws_sdk_connectcampaignsv2.errors.invalid_campaign_state_exception.InvalidCampaignStateException.from_json(
                data
            )
        ...
        case "ThrottlingException":
            raise aws_sdk_connectcampaignsv2.errors.throttling_exception.ThrottlingException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_connectcampaignsv2.types.put_outbound_request_batch_response.PutOutboundRequestBatchResponse = aws_sdk_connectcampaignsv2.types.put_outbound_request_batch_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.put_outbound_request_batch_request.PutOutboundRequestBatchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/campaigns/{id}/outbound-requests"
    url = url.replace("{id}", quote(str(input_["id"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_connectcampaignsv2.types.put_outbound_request_batch_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_outbound_request_batch(
