"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#UpdateCampaignChannelSubtypeConfig``."""
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.update_campaign_channel_subtype_config_request.UpdateCampaignChannelSubtypeConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_update_campaign_channel_subtype_config(
