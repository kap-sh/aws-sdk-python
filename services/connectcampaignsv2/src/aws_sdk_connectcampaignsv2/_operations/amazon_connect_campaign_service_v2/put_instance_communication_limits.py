"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#PutInstanceCommunicationLimits``."""
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.put_instance_communication_limits_request.PutInstanceCommunicationLimitsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcampaignsv2.types.put_instance_communication_limits_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_put_instance_communication_limits(
