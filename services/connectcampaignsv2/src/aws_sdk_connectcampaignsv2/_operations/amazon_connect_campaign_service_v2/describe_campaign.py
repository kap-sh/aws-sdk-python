"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#DescribeCampaign``."""
...
import aws_sdk_connectcampaignsv2.types.campaign
...
def handle_response(
    ...
    out: aws_sdk_connectcampaignsv2.types.describe_campaign_response.DescribeCampaignResponse = aws_sdk_connectcampaignsv2.types.describe_campaign_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.describe_campaign_request.DescribeCampaignRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
