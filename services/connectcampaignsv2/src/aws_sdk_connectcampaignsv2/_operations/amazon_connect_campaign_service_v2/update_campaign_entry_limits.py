"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#UpdateCampaignEntryLimits``."""
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.update_campaign_entry_limits_request.UpdateCampaignEntryLimitsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/campaigns/{id}/entry-limits"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcampaignsv2.types.update_campaign_entry_limits_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_campaign_entry_limits(
