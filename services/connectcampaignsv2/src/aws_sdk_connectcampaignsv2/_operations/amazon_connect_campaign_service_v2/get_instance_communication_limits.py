"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#GetInstanceCommunicationLimits``."""
...
def handle_response(
    ...
    out: aws_sdk_connectcampaignsv2.types.get_instance_communication_limits_response.GetInstanceCommunicationLimitsResponse = aws_sdk_connectcampaignsv2.types.get_instance_communication_limits_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.get_instance_communication_limits_request.GetInstanceCommunicationLimitsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_instance_communication_limits(
