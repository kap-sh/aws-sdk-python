"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#GetCampaignStateBatch``."""
...
def handle_response(
    ...
    out: aws_sdk_connectcampaignsv2.types.get_campaign_state_batch_response.GetCampaignStateBatchResponse = aws_sdk_connectcampaignsv2.types.get_campaign_state_batch_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.get_campaign_state_batch_request.GetCampaignStateBatchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_campaign_state_batch(
