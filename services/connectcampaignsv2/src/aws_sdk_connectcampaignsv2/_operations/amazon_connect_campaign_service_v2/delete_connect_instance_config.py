...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidStateException":
            import aws_sdk_connectcampaignsv2.errors.invalid_state_exception

            raise aws_sdk_connectcampaignsv2.errors.invalid_state_exception.InvalidStateException.from_json(
                data
            )
...
def build_request(
    ...
    input: aws_sdk_connectcampaignsv2.types.delete_connect_instance_config_request.DeleteConnectInstanceConfigRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "campaign_deletion_policy" in input:
        params["campaignDeletionPolicy"] = str(input["campaign_deletion_policy"])
