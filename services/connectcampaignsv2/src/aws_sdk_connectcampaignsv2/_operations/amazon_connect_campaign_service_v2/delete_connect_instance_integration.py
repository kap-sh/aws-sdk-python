"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#DeleteConnectInstanceIntegration``."""
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.delete_connect_instance_integration_request.DeleteConnectInstanceIntegrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcampaignsv2.types.delete_connect_instance_integration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_delete_connect_instance_integration(
