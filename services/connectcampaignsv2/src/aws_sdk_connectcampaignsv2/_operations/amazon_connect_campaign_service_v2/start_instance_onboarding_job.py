...
def handle_response(
    ...
    out: aws_sdk_connectcampaignsv2.types.start_instance_onboarding_job_response.StartInstanceOnboardingJobResponse = aws_sdk_connectcampaignsv2.types.start_instance_onboarding_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.start_instance_onboarding_job_request.StartInstanceOnboardingJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcampaignsv2.types.start_instance_onboarding_job_request.serialize_json(
            input_
        )
    ).encode()
