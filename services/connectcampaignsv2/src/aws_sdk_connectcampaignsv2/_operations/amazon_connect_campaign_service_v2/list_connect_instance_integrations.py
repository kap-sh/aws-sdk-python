...
def handle_response(
    ...
    out: aws_sdk_connectcampaignsv2.types.list_connect_instance_integrations_response.ListConnectInstanceIntegrationsResponse = aws_sdk_connectcampaignsv2.types.list_connect_instance_integrations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.list_connect_instance_integrations_request.ListConnectInstanceIntegrationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
