...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.update_campaign_flow_association_request.UpdateCampaignFlowAssociationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_connectcampaignsv2.types.update_campaign_flow_association_request.serialize_json(
            input_
        )
    ).encode()
