...
def build_request(
    ...
    input: aws_sdk_connectcampaignsv2.types.delete_campaign_communication_time_request.DeleteCampaignCommunicationTimeRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "config" in input:
        params["config"] = str(input["config"])
