"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#ResumeCampaign``."""
...
def build_request(
    ...
    input_: aws_sdk_connectcampaignsv2.types.resume_campaign_request.ResumeCampaignRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/v2/campaigns/{id}/resume"
...
async def async_resume_campaign(
