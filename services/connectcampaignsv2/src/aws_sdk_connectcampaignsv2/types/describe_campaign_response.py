...
class DescribeCampaignResponse(TypedDict, closed=True):
    campaign: NotRequired["aws_sdk_connectcampaignsv2.types.campaign.Campaign"]
...
def serialize_json(value: DescribeCampaignResponse) -> dict:
    ...
    if "campaign" in value:
        ...
        out["campaign"] = aws_sdk_connectcampaignsv2.types.campaign.serialize_json(
            value["campaign"]
        )
    return out
...
def deserialize_json(data: dict) -> DescribeCampaignResponse:
    ...
    if "campaign" in data:
        ...
        out["campaign"] = aws_sdk_connectcampaignsv2.types.campaign.deserialize_json(
            data["campaign"]
        )
    return out
