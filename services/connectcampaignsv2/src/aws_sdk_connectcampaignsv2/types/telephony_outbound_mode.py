...
if TYPE_CHECKING:
    ...
    import aws_sdk_connectcampaignsv2.types.predictive_config
    import aws_sdk_connectcampaignsv2.types.preview_config
...
def serialize_json(value: TelephonyOutboundMode) -> dict:
    if "progressive" in value:
        ...
        return {
            "progressive": aws_sdk_connectcampaignsv2.types.progressive_config.serialize_json(
                value["progressive"]
            )
        }
        ...
        return {
            "predictive": aws_sdk_connectcampaignsv2.types.predictive_config.serialize_json(
                value["predictive"]
            )
        }
        ...
        return {
            "preview": aws_sdk_connectcampaignsv2.types.preview_config.serialize_json(
                value["preview"]
            )
        }
    else:
...
def deserialize_json(data: dict) -> TelephonyOutboundMode:
    if "progressive" in data:
        ...
        return {
            "progressive": aws_sdk_connectcampaignsv2.types.progressive_config.deserialize_json(
                data["progressive"]
            )
        }
        ...
        return {
            "predictive": aws_sdk_connectcampaignsv2.types.predictive_config.deserialize_json(
                data["predictive"]
            )
        }
        ...
        return {
            "preview": aws_sdk_connectcampaignsv2.types.preview_config.deserialize_json(
                data["preview"]
            )
        }
    else:
