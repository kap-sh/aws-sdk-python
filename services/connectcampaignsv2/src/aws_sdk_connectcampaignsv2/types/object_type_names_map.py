...
if TYPE_CHECKING:
    import aws_sdk_connectcampaignsv2.types.event_type
    import aws_sdk_connectcampaignsv2.types.object_type_name

ObjectTypeNamesMap: TypeAlias = dict[
    "aws_sdk_connectcampaignsv2.types.event_type.EventType",
    "aws_sdk_connectcampaignsv2.types.object_type_name.ObjectTypeName",
]
