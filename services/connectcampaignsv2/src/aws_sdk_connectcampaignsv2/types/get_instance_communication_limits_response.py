...
class GetInstanceCommunicationLimitsResponse(TypedDict):
    communication_limits_config: NotRequired[
        "aws_sdk_connectcampaignsv2.types.instance_communication_limits_config.InstanceCommunicationLimitsConfig"
    ]
