...
if TYPE_CHECKING:
    ...
    import aws_sdk_connectcampaignsv2.types.instance_onboarding_job_failure_code
...
class InstanceOnboardingJobStatus(TypedDict):
    ...
    failure_code: NotRequired[
        "aws_sdk_connectcampaignsv2.types.instance_onboarding_job_failure_code.InstanceOnboardingJobFailureCode"
    ]
