"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.connectcampaignsv2#ConflictException``."""
