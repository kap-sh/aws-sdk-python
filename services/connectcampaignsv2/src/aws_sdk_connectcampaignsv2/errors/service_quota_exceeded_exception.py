"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.connectcampaignsv2#ServiceQuotaExceededException``."""
