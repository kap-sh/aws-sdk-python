...
def handle_response(
    ...
    out: capo_connectcampaignsv2.types.get_connect_instance_config_response.GetConnectInstanceConfigResponse = capo_connectcampaignsv2.types.get_connect_instance_config_response.deserialize_json(
