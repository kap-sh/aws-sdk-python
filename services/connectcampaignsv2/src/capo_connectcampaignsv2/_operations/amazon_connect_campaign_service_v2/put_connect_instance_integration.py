"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#PutConnectInstanceIntegration``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connectcampaignsv2.types.put_connect_instance_integration_request.serialize_json(
            input_
        )
    ).encode()
