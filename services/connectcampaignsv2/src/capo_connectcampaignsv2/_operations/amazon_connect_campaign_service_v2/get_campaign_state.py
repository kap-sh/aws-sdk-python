"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#GetCampaignState``."""
...
def handle_response(
    ...
    out: capo_connectcampaignsv2.types.get_campaign_state_response.GetCampaignStateResponse = capo_connectcampaignsv2.types.get_campaign_state_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/campaigns/{id}/state"
...
async def async_get_campaign_state(
