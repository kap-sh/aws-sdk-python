...
def handle_response(
    ...
    out: capo_connectcampaignsv2.types.get_campaign_state_batch_response.GetCampaignStateBatchResponse = capo_connectcampaignsv2.types.get_campaign_state_batch_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connectcampaignsv2.types.get_campaign_state_batch_request.serialize_json(
            input_
        )
    ).encode()
