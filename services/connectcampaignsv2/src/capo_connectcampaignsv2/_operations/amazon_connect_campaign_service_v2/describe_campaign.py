...
def handle_response(
    ...
    out: capo_connectcampaignsv2.types.describe_campaign_response.DescribeCampaignResponse = capo_connectcampaignsv2.types.describe_campaign_response.deserialize_json(
