"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#UpdateCampaignCommunicationTime``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connectcampaignsv2.types.update_campaign_communication_time_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_campaign_communication_time(
