"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#DeleteConnectInstanceConfig``."""
...
import capo_connectcampaignsv2.errors.invalid_state_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidStateException":
            raise capo_connectcampaignsv2.errors.invalid_state_exception.InvalidStateException.from_json(
                data
            )
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "campaign_deletion_policy" in input_:
        params["campaignDeletionPolicy"] = str(input_["campaign_deletion_policy"])
