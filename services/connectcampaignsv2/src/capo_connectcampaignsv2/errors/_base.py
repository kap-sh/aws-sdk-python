...
class ConnectCampaignsV2Error(Exception):
    """Base class for all ConnectCampaignsV2 service errors."""


class ServiceError(ConnectCampaignsV2Error):
...
class SerializationError(ConnectCampaignsV2Error):
    """Raised when a value cannot be serialized."""


class DeserializationError(ConnectCampaignsV2Error):
...
class WaiterFailedError(ConnectCampaignsV2Error):
...
class WaiterTimeoutError(ConnectCampaignsV2Error):
