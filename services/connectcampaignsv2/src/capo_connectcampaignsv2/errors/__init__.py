...
from ._base import (
    ConnectCampaignsV2Error as ConnectCampaignsV2Error,
)
from ._base import (
...
from .invalid_campaign_state_exception import (
    InvalidCampaignStateException as InvalidCampaignStateException,
)
