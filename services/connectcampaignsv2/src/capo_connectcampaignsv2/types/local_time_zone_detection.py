...
if TYPE_CHECKING:
    import capo_connectcampaignsv2.types.local_time_zone_detection_type

LocalTimeZoneDetection: TypeAlias = list[
    "capo_connectcampaignsv2.types.local_time_zone_detection_type.LocalTimeZoneDetectionType"
]
