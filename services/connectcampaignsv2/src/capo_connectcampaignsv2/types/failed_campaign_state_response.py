...
if TYPE_CHECKING:
    ...
    import capo_connectcampaignsv2.types.get_campaign_state_batch_failure_code


class FailedCampaignStateResponse(TypedDict, closed=True):
    campaign_id: NotRequired["capo_connectcampaignsv2.types.campaign_id.CampaignId"]
    failure_code: NotRequired[
        "capo_connectcampaignsv2.types.get_campaign_state_batch_failure_code.GetCampaignStateBatchFailureCode"
    ]
