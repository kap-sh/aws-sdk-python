"""Generated from Smithy shape ``com.amazonaws.migrationhub#DryRunOperation``."""
...
class DryRunOperation_(TypedDict, closed=True):
...
class DryRunOperation(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.migrationhub#DryRunOperation``."""
