"""Generated from Smithy shape ``com.amazonaws.migrationhub#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.migrationhub#AccessDeniedException``."""
