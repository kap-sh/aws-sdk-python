...
SourceResourceList: TypeAlias = list[
    "aws_sdk_migration_hub.types.source_resource.SourceResource"
]
...
def serialize_aws_json_1_1(value: SourceResourceList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_migration_hub.types.source_resource.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> SourceResourceList:
    ...
    for item in data:
        out.append(
            aws_sdk_migration_hub.types.source_resource.deserialize_aws_json_1_1(item)
        )
    return out
