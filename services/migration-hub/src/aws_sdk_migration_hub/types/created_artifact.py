...
if TYPE_CHECKING:
    import aws_sdk_migration_hub.types.created_artifact_description
    import aws_sdk_migration_hub.types.created_artifact_name


class CreatedArtifact(TypedDict):
    name: "aws_sdk_migration_hub.types.created_artifact_name.CreatedArtifactName"
    """<p>An ARN that uniquely identifies the result of a migration task.</p>"""
    description: NotRequired[
        "aws_sdk_migration_hub.types.created_artifact_description.CreatedArtifactDescription"
    ]
