"""Generated from Smithy shape ``com.amazonaws.migrationhub#ListApplicationStates``."""
...
import capo_migration_hub.types.application_state_list
...
def handle_response(
    ...
    out: capo_migration_hub.types.list_application_states_result.ListApplicationStatesResult = capo_migration_hub.types.list_application_states_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub.types.list_application_states_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_application_states(
