"""Generated from Smithy shape ``com.amazonaws.migrationhub#DescribeMigrationTask``."""
...
def handle_response(
    ...
    out: capo_migration_hub.types.describe_migration_task_result.DescribeMigrationTaskResult = capo_migration_hub.types.describe_migration_task_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub.types.describe_migration_task_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_migration_task(
