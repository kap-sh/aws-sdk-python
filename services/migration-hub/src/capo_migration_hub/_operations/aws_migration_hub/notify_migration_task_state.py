...
def handle_response(
    ...
    out: capo_migration_hub.types.notify_migration_task_state_result.NotifyMigrationTaskStateResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub.types.notify_migration_task_state_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
