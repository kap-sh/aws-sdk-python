"""Generated from Smithy shape ``com.amazonaws.migrationhub#ListDiscoveredResources``."""
...
def handle_response(
    ...
    out: capo_migration_hub.types.list_discovered_resources_result.ListDiscoveredResourcesResult = capo_migration_hub.types.list_discovered_resources_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub.types.list_discovered_resources_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
