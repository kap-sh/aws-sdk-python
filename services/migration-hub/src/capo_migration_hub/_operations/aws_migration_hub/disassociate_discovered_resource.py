"""Generated from Smithy shape ``com.amazonaws.migrationhub#DisassociateDiscoveredResource``."""
...
def handle_response(
    ...
    out: capo_migration_hub.types.disassociate_discovered_resource_result.DisassociateDiscoveredResourceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub.types.disassociate_discovered_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_disassociate_discovered_resource(
