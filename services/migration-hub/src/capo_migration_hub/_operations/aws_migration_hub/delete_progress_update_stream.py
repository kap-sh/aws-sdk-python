...
def handle_response(
    ...
    out: capo_migration_hub.types.delete_progress_update_stream_result.DeleteProgressUpdateStreamResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub.types.delete_progress_update_stream_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
