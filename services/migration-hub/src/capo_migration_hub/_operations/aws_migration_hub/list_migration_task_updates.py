...
def handle_response(
    ...
    out: capo_migration_hub.types.list_migration_task_updates_result.ListMigrationTaskUpdatesResult = capo_migration_hub.types.list_migration_task_updates_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub.types.list_migration_task_updates_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
