...
from capo_migration_hub._services._aws_config import aaws_config
...
class AsyncMigrationHubClientConfig(TypedDict, total=False, closed=True):
...
class AsyncMigrationHubClient:
    ...
    async def associate_created_artifact(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.associate_created_artifact_request.AssociateCreatedArtifactRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.associate_created_artifact_result.AssociateCreatedArtifactResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.associate_created_artifact.async_associate_created_artifact(
    ...
    async def associate_discovered_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.associate_discovered_resource_request.AssociateDiscoveredResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.associate_discovered_resource_result.AssociateDiscoveredResourceResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.associate_discovered_resource.async_associate_discovered_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def associate_source_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.associate_source_resource_request.AssociateSourceResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.associate_source_resource_result.AssociateSourceResourceResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.associate_source_resource.async_associate_source_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_progress_update_stream(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.create_progress_update_stream_request.CreateProgressUpdateStreamRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.create_progress_update_stream_result.CreateProgressUpdateStreamResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.create_progress_update_stream.async_create_progress_update_stream(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_progress_update_stream(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.delete_progress_update_stream_request.DeleteProgressUpdateStreamRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.delete_progress_update_stream_result.DeleteProgressUpdateStreamResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.delete_progress_update_stream.async_delete_progress_update_stream(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_application_state(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.describe_application_state_request.DescribeApplicationStateRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.describe_application_state_result.DescribeApplicationStateResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.describe_application_state.async_describe_application_state(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_migration_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.describe_migration_task_request.DescribeMigrationTaskRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.describe_migration_task_result.DescribeMigrationTaskResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.describe_migration_task.async_describe_migration_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_created_artifact(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.disassociate_created_artifact_request.DisassociateCreatedArtifactRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.disassociate_created_artifact_result.DisassociateCreatedArtifactResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.disassociate_created_artifact.async_disassociate_created_artifact(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_discovered_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.disassociate_discovered_resource_request.DisassociateDiscoveredResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.disassociate_discovered_resource_result.DisassociateDiscoveredResourceResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.disassociate_discovered_resource.async_disassociate_discovered_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_source_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.disassociate_source_resource_request.DisassociateSourceResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.disassociate_source_resource_result.DisassociateSourceResourceResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.disassociate_source_resource.async_disassociate_source_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def import_migration_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.import_migration_task_request.ImportMigrationTaskRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.import_migration_task_result.ImportMigrationTaskResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.import_migration_task.async_import_migration_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_application_states(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.list_application_states_request.ListApplicationStatesRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.list_application_states_result.ListApplicationStatesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.list_application_states.async_list_application_states(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_application_states(
        ...
        *,
        ...
        next_token: Optional["capo_migration_hub.types.token.Token"] = None,
        max_results: Optional["capo_migration_hub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_migration_hub.types.application_state.ApplicationState]":
        _token = next_token
        while True:
    ...
    async def list_created_artifacts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.list_created_artifacts_request.ListCreatedArtifactsRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.list_created_artifacts_result.ListCreatedArtifactsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.list_created_artifacts.async_list_created_artifacts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_migration_hub.types.created_artifact.CreatedArtifact]":
        _token = next_token
        while True:
    ...
    async def list_discovered_resources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.list_discovered_resources_request.ListDiscoveredResourcesRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.list_discovered_resources_result.ListDiscoveredResourcesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.list_discovered_resources.async_list_discovered_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_discovered_resources(
        ...
        *,
        ...
        "AsyncIterator[capo_migration_hub.types.discovered_resource.DiscoveredResource]"
    ):
        _token = next_token
        while True:
    ...
    async def list_migration_tasks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.list_migration_tasks_request.ListMigrationTasksRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.list_migration_tasks_result.ListMigrationTasksResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.list_migration_tasks.async_list_migration_tasks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_migration_hub.types.migration_task_summary.MigrationTaskSummary]":
        _token = next_token
        while True:
    ...
    async def list_migration_task_updates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.list_migration_task_updates_request.ListMigrationTaskUpdatesRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.list_migration_task_updates_result.ListMigrationTaskUpdatesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.list_migration_task_updates.async_list_migration_task_updates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_migration_task_updates(
        ...
        *,
        ...
        next_token: Optional["capo_migration_hub.types.token.Token"] = None,
        max_results: Optional["capo_migration_hub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_migration_hub.types.migration_task_update.MigrationTaskUpdate]":
        _token = next_token
        while True:
    ...
    async def list_progress_update_streams(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.list_progress_update_streams_request.ListProgressUpdateStreamsRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.list_progress_update_streams_result.ListProgressUpdateStreamsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.list_progress_update_streams.async_list_progress_update_streams(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_progress_update_streams(
        ...
        *,
        ...
        next_token: Optional["capo_migration_hub.types.token.Token"] = None,
        max_results: Optional["capo_migration_hub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_migration_hub.types.progress_update_stream_summary.ProgressUpdateStreamSummary]":
        _token = next_token
        while True:
    ...
    async def list_source_resources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.list_source_resources_request.ListSourceResourcesRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.list_source_resources_result.ListSourceResourcesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.list_source_resources.async_list_source_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_migration_hub.types.source_resource.SourceResource]":
        _token = next_token
        while True:
    ...
    async def notify_application_state(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.notify_application_state_request.NotifyApplicationStateRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.notify_application_state_result.NotifyApplicationStateResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.notify_application_state.async_notify_application_state(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def notify_migration_task_state(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.notify_migration_task_state_request.NotifyMigrationTaskStateRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.notify_migration_task_state_result.NotifyMigrationTaskStateResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.notify_migration_task_state.async_notify_migration_task_state(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_resource_attributes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_migration_hub.types.put_resource_attributes_request.PutResourceAttributesRequest]",
        ) -> AsyncOperationResponse[
            "capo_migration_hub.types.put_resource_attributes_result.PutResourceAttributesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_migration_hub._operations.aws_migration_hub.put_resource_attributes.async_put_resource_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
