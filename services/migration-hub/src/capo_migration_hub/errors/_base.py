...
class MigrationHubError(Exception):
    """Base class for all MigrationHub service errors."""


class ServiceError(MigrationHubError):
...
class SerializationError(MigrationHubError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MigrationHubError):
...
class WaiterFailedError(MigrationHubError):
...
class WaiterTimeoutError(MigrationHubError):
