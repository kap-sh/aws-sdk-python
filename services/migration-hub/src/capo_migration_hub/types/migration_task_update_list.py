...
MigrationTaskUpdateList: TypeAlias = list[
    "capo_migration_hub.types.migration_task_update.MigrationTaskUpdate"
]
...
def serialize_aws_json_1_1(value: MigrationTaskUpdateList) -> list:
    ...
    for item in value:
        out.append(
            capo_migration_hub.types.migration_task_update.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> MigrationTaskUpdateList:
    ...
    for item in data:
        out.append(
            capo_migration_hub.types.migration_task_update.deserialize_aws_json_1_1(
                item
            )
        )
    return out
