"""Generated from Smithy shape ``com.amazonaws.wellarchitected#TemplateShareSummary``."""
...
class TemplateShareSummary(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: TemplateShareSummary) -> dict:
    out: dict = {}
