...
if TYPE_CHECKING:
    import capo_wellarchitected.types.account_jira_configuration_output
...
class GetGlobalSettingsOutput(TypedDict, closed=True):
    ...
    jira_configuration: NotRequired[
        "capo_wellarchitected.types.account_jira_configuration_output.AccountJiraConfigurationOutput"
    ]
...
def serialize_json(value: GetGlobalSettingsOutput) -> dict:
    ...
    if "organization_sharing_status" in value:
        ...
        out["OrganizationSharingStatus"] = (
            capo_wellarchitected.types.organization_sharing_status.serialize_json(
    ...
    if "discovery_integration_status" in value:
        ...
        out["DiscoveryIntegrationStatus"] = (
            capo_wellarchitected.types.discovery_integration_status.serialize_json(
    ...
    if "jira_configuration" in value:
        ...
        out["JiraConfiguration"] = (
            capo_wellarchitected.types.account_jira_configuration_output.serialize_json(
...
def deserialize_json(data: dict) -> GetGlobalSettingsOutput:
    ...
    if "OrganizationSharingStatus" in data:
        ...
        out["organization_sharing_status"] = (
            capo_wellarchitected.types.organization_sharing_status.deserialize_json(
    ...
    if "DiscoveryIntegrationStatus" in data:
        ...
        out["discovery_integration_status"] = (
            capo_wellarchitected.types.discovery_integration_status.deserialize_json(
    ...
    if "JiraConfiguration" in data:
        ...
        out["jira_configuration"] = (
            capo_wellarchitected.types.account_jira_configuration_output.deserialize_json(
