...
if TYPE_CHECKING:
    ...
    import capo_wellarchitected.types.profile_questions
...
def serialize_json(value: Profile) -> dict:
    ...
    if "profile_questions" in value:
        ...
        out["ProfileQuestions"] = (
            capo_wellarchitected.types.profile_questions.serialize_json(
...
def deserialize_json(data: dict) -> Profile:
    ...
    if "ProfileQuestions" in data:
        ...
        out["profile_questions"] = (
            capo_wellarchitected.types.profile_questions.deserialize_json(
