"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ListLensReviewImprovementsInput``."""
...
class ListLensReviewImprovementsInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListLensReviewImprovementsInput) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> ListLensReviewImprovementsInput:
    out: ListLensReviewImprovementsInput = {}  # type: ignore[typeddict-item]
    return out
