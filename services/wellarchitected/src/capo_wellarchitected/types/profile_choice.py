"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ProfileChoice``."""
...
class ProfileChoice(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ProfileChoice) -> dict:
    out: dict = {}
