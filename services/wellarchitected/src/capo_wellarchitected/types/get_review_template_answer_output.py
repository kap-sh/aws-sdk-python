"""Generated from Smithy shape ``com.amazonaws.wellarchitected#GetReviewTemplateAnswerOutput``."""
...
class GetReviewTemplateAnswerOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetReviewTemplateAnswerOutput) -> dict:
    out: dict = {}
