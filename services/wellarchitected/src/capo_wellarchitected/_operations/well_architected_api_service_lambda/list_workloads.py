...
def handle_response(
    ...
    out: capo_wellarchitected.types.list_workloads_output.ListWorkloadsOutput = (
        capo_wellarchitected.types.list_workloads_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.list_workloads_input.serialize_json(input_)
    ).encode()
