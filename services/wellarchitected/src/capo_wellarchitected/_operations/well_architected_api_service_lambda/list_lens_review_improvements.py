"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ListLensReviewImprovements``."""
...
def handle_response(
    ...
    out: capo_wellarchitected.types.list_lens_review_improvements_output.ListLensReviewImprovementsOutput = capo_wellarchitected.types.list_lens_review_improvements_output.deserialize_json(
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "pillar_id" in input_:
        params["PillarId"] = str(input_["pillar_id"])
    ...
    if "question_priority" in input_:
        params["QuestionPriority"] = str(input_["question_priority"])
...
async def async_list_lens_review_improvements(
