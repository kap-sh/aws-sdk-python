"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ExportLens``."""
...
def handle_response(
    ...
    out: capo_wellarchitected.types.export_lens_output.ExportLensOutput = (
        capo_wellarchitected.types.export_lens_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/lenses/{LensAlias}/export"
...
def export_lens(
    ...
    capo_wellarchitected.types.export_lens_output.ExportLensOutput, zapros.Response
]:
