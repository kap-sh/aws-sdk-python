"""Generated from Smithy shape ``com.amazonaws.wellarchitected#UpgradeReviewTemplateLensReview``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.upgrade_review_template_lens_review_input.serialize_json(
            input_
        )
    ).encode()
