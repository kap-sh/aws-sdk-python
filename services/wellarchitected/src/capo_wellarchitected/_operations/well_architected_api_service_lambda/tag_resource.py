...
def handle_response(
    ...
    out: capo_wellarchitected.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.tag_resource_input.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_wellarchitected.types.tag_resource_output.TagResourceOutput, zapros.Response
]:
