...
def handle_response(
    ...
    out: capo_wellarchitected.types.list_lenses_output.ListLensesOutput = (
        capo_wellarchitected.types.list_lenses_output.deserialize_json(
...
def list_lenses(
    ...
    capo_wellarchitected.types.list_lenses_output.ListLensesOutput, zapros.Response
]:
