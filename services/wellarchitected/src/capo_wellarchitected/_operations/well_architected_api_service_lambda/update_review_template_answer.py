...
def handle_response(
    ...
    out: capo_wellarchitected.types.update_review_template_answer_output.UpdateReviewTemplateAnswerOutput = capo_wellarchitected.types.update_review_template_answer_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.update_review_template_answer_input.serialize_json(
            input_
        )
    ).encode()
