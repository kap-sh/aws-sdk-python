...
def handle_response(
    ...
    out: capo_wellarchitected.types.update_share_invitation_output.UpdateShareInvitationOutput = capo_wellarchitected.types.update_share_invitation_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.update_share_invitation_input.serialize_json(input_)
    ).encode()
