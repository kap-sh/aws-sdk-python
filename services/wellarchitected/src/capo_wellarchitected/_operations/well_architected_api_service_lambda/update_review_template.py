"""Generated from Smithy shape ``com.amazonaws.wellarchitected#UpdateReviewTemplate``."""
...
def handle_response(
    ...
    out: capo_wellarchitected.types.update_review_template_output.UpdateReviewTemplateOutput = capo_wellarchitected.types.update_review_template_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.update_review_template_input.serialize_json(input_)
    ).encode()
...
async def async_update_review_template(
