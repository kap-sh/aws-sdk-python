...
def handle_response(
    ...
    out: capo_wellarchitected.types.import_lens_output.ImportLensOutput = (
        capo_wellarchitected.types.import_lens_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.import_lens_input.serialize_json(input_)
    ).encode()
...
def import_lens(
    ...
    capo_wellarchitected.types.import_lens_output.ImportLensOutput, zapros.Response
]:
