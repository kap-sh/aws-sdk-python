"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ListProfileShares``."""
...
def handle_response(
    ...
    out: capo_wellarchitected.types.list_profile_shares_output.ListProfileSharesOutput = capo_wellarchitected.types.list_profile_shares_output.deserialize_json(
...
async def async_list_profile_shares(
