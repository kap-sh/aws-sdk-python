...
import capo_wellarchitected.types.lens
...
def handle_response(
    ...
    out: capo_wellarchitected.types.get_lens_output.GetLensOutput = (
        capo_wellarchitected.types.get_lens_output.deserialize_json(
...
def get_lens(
    ...
    input_: capo_wellarchitected.types.get_lens_input.GetLensInput,
) -> tuple[capo_wellarchitected.types.get_lens_output.GetLensOutput, zapros.Response]:
