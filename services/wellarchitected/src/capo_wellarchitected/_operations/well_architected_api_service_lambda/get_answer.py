...
def handle_response(
    ...
    out: capo_wellarchitected.types.get_answer_output.GetAnswerOutput = (
        capo_wellarchitected.types.get_answer_output.deserialize_json(
...
def get_answer(
    ...
    capo_wellarchitected.types.get_answer_output.GetAnswerOutput, zapros.Response
]:
