...
import capo_wellarchitected.types.share_invitation_summaries
...
def handle_response(
    ...
    out: capo_wellarchitected.types.list_share_invitations_output.ListShareInvitationsOutput = capo_wellarchitected.types.list_share_invitations_output.deserialize_json(
