"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ListReviewTemplateAnswers``."""
...
def handle_response(
    ...
    out: capo_wellarchitected.types.list_review_template_answers_output.ListReviewTemplateAnswersOutput = capo_wellarchitected.types.list_review_template_answers_output.deserialize_json(
...
async def async_list_review_template_answers(
