...
def handle_response(
    ...
    out: capo_wellarchitected.types.update_workload_share_output.UpdateWorkloadShareOutput = capo_wellarchitected.types.update_workload_share_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.update_workload_share_input.serialize_json(input_)
    ).encode()
