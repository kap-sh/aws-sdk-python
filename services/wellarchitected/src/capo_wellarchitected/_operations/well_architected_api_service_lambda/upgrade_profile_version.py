"""Generated from Smithy shape ``com.amazonaws.wellarchitected#UpgradeProfileVersion``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.upgrade_profile_version_input.serialize_json(input_)
    ).encode()
...
async def async_upgrade_profile_version(
