...
def handle_response(
    ...
    out: capo_wellarchitected.types.get_profile_output.GetProfileOutput = (
        capo_wellarchitected.types.get_profile_output.deserialize_json(
...
def get_profile(
    ...
    capo_wellarchitected.types.get_profile_output.GetProfileOutput, zapros.Response
]:
