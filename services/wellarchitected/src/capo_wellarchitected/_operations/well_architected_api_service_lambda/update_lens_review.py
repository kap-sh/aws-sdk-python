...
def handle_response(
    ...
    out: capo_wellarchitected.types.update_lens_review_output.UpdateLensReviewOutput = (
        capo_wellarchitected.types.update_lens_review_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.update_lens_review_input.serialize_json(input_)
    ).encode()
