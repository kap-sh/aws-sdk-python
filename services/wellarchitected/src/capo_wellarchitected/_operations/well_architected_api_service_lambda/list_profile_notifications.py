...
def handle_response(
    ...
    out: capo_wellarchitected.types.list_profile_notifications_output.ListProfileNotificationsOutput = capo_wellarchitected.types.list_profile_notifications_output.deserialize_json(
