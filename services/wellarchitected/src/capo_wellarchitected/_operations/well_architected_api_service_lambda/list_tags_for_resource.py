"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_wellarchitected.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_wellarchitected.types.list_tags_for_resource_output.deserialize_json(
