...
def handle_response(
    ...
    out: capo_wellarchitected.types.get_consolidated_report_output.GetConsolidatedReportOutput = capo_wellarchitected.types.get_consolidated_report_output.deserialize_json(
