...
class WellArchitectedError(Exception):
    """Base class for all WellArchitected service errors."""


class ServiceError(WellArchitectedError):
...
class SerializationError(WellArchitectedError):
    """Raised when a value cannot be serialized."""


class DeserializationError(WellArchitectedError):
...
class WaiterFailedError(WellArchitectedError):
...
class WaiterTimeoutError(WellArchitectedError):
