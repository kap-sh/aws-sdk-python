...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_check_summaries_output.ListCheckSummariesOutput = aws_sdk_wellarchitected.types.list_check_summaries_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.list_check_summaries_input.ListCheckSummariesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.list_check_summaries_input.serialize_json(input_)
    ).encode()
