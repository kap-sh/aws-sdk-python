...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.list_check_summaries_input.ListCheckSummariesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.list_check_summaries_input.serialize_json(input)
    ).encode()
