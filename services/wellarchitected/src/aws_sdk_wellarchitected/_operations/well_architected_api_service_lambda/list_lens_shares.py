"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ListLensShares``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_lens_shares_output.ListLensSharesOutput = (
        aws_sdk_wellarchitected.types.list_lens_shares_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.list_lens_shares_input.ListLensSharesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_lens_shares(
