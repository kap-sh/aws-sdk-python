"""Generated from Smithy shape ``com.amazonaws.wellarchitected#GetGlobalSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.get_global_settings_output.GetGlobalSettingsOutput = aws_sdk_wellarchitected.types.get_global_settings_output.deserialize_json(
...
async def async_get_global_settings(
