"""Generated from Smithy shape ``com.amazonaws.wellarchitected#GetWorkload``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.get_workload_output.GetWorkloadOutput = (
        aws_sdk_wellarchitected.types.get_workload_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.get_workload_input.GetWorkloadInput,
) -> zapros.Request:
...
def get_workload(
    ...
    aws_sdk_wellarchitected.types.get_workload_output.GetWorkloadOutput, zapros.Response
]:
