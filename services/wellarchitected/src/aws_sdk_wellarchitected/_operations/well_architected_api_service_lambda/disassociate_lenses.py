...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.disassociate_lenses_input.DisassociateLensesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.disassociate_lenses_input.serialize_json(input)
    ).encode()
