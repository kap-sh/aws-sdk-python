"""Generated from Smithy shape ``com.amazonaws.wellarchitected#DeleteLens``."""
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.delete_lens_input.DeleteLensInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
