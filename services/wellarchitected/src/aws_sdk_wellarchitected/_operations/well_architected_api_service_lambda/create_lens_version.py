...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.create_lens_version_output.CreateLensVersionOutput = aws_sdk_wellarchitected.types.create_lens_version_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.create_lens_version_input.CreateLensVersionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.create_lens_version_input.serialize_json(input_)
    ).encode()
