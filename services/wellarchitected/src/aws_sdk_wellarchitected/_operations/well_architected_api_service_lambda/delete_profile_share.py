"""Generated from Smithy shape ``com.amazonaws.wellarchitected#DeleteProfileShare``."""
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.delete_profile_share_input.DeleteProfileShareInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/profiles/{ProfileArn}/shares/{ShareId}"
    ...
    if "client_request_token" in input_:
        params["ClientRequestToken"] = str(input_["client_request_token"])
...
async def async_delete_profile_share(
