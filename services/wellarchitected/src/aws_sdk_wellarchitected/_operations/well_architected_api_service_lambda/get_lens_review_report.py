"""Generated from Smithy shape ``com.amazonaws.wellarchitected#GetLensReviewReport``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.get_lens_review_report_output.GetLensReviewReportOutput = aws_sdk_wellarchitected.types.get_lens_review_report_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.get_lens_review_report_input.GetLensReviewReportInput,
) -> zapros.Request:
...
async def async_get_lens_review_report(
