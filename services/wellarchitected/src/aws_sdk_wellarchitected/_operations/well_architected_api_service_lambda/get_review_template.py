...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.get_review_template_output.GetReviewTemplateOutput = aws_sdk_wellarchitected.types.get_review_template_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.get_review_template_input.GetReviewTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
