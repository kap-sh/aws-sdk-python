...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.update_share_invitation_input.UpdateShareInvitationInput,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ShareInvitationId}", quote(str(input["share_invitation_id"]), safe="")
    )
    params: dict[str, str] = {}
