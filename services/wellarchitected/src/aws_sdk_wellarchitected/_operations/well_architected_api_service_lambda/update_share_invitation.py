"""Generated from Smithy shape ``com.amazonaws.wellarchitected#UpdateShareInvitation``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.update_share_invitation_output.UpdateShareInvitationOutput = aws_sdk_wellarchitected.types.update_share_invitation_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.update_share_invitation_input.UpdateShareInvitationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/shareInvitations/{ShareInvitationId}"
    url = url.replace(
        "{ShareInvitationId}", quote(str(input_["share_invitation_id"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.update_share_invitation_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_share_invitation(
