...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.update_answer_output.UpdateAnswerOutput = (
        aws_sdk_wellarchitected.types.update_answer_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.update_answer_input.UpdateAnswerInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.update_answer_input.serialize_json(input)
    ).encode()
