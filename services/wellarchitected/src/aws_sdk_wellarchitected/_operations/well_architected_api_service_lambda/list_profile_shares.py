...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_profile_shares_output.ListProfileSharesOutput = aws_sdk_wellarchitected.types.list_profile_shares_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.list_profile_shares_input.ListProfileSharesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
