...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_milestones_output.ListMilestonesOutput = (
        aws_sdk_wellarchitected.types.list_milestones_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.list_milestones_input.ListMilestonesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.list_milestones_input.serialize_json(input_)
    ).encode()
