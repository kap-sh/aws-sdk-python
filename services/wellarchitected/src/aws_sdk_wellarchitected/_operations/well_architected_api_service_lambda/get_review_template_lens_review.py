...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.get_review_template_lens_review_output.GetReviewTemplateLensReviewOutput = aws_sdk_wellarchitected.types.get_review_template_lens_review_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.get_review_template_lens_review_input.GetReviewTemplateLensReviewInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
