...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.export_lens_output.ExportLensOutput = (
        aws_sdk_wellarchitected.types.export_lens_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.export_lens_input.ExportLensInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def export_lens(
    ...
    aws_sdk_wellarchitected.types.export_lens_output.ExportLensOutput, zapros.Response
]:
