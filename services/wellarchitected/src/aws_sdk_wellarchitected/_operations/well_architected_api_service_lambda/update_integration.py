...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.update_integration_input.UpdateIntegrationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.update_integration_input.serialize_json(input_)
    ).encode()
