"""Generated from Smithy shape ``com.amazonaws.wellarchitected#UpdateIntegration``."""
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.update_integration_input.UpdateIntegrationInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workloads/{WorkloadId}/updateIntegration"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.update_integration_input.serialize_json(input)
    ).encode()
