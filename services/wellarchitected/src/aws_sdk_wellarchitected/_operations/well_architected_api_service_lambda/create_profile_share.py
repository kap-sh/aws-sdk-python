...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.create_profile_share_input.CreateProfileShareInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.create_profile_share_input.serialize_json(input)
    ).encode()
