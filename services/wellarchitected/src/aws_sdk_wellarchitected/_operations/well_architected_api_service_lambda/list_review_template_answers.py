...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_review_template_answers_output.ListReviewTemplateAnswersOutput = aws_sdk_wellarchitected.types.list_review_template_answers_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.list_review_template_answers_input.ListReviewTemplateAnswersInput,
) -> zapros.Request:
