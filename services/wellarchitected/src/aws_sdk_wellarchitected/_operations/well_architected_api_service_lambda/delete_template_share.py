"""Generated from Smithy shape ``com.amazonaws.wellarchitected#DeleteTemplateShare``."""
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.delete_template_share_input.DeleteTemplateShareInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/templates/shares/{TemplateArn}/{ShareId}"
...
async def async_delete_template_share(
