...
import aws_sdk_wellarchitected.types.review_templates
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_review_templates_output.ListReviewTemplatesOutput = aws_sdk_wellarchitected.types.list_review_templates_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.list_review_templates_input.ListReviewTemplatesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
