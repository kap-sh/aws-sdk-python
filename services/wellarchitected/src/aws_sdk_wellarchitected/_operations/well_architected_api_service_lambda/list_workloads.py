"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ListWorkloads``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_workloads_output.ListWorkloadsOutput = (
        aws_sdk_wellarchitected.types.list_workloads_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.list_workloads_input.ListWorkloadsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/workloadsSummaries"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_wellarchitected.types.list_workloads_input

    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.list_workloads_input.serialize_json(input_)
    ).encode()
