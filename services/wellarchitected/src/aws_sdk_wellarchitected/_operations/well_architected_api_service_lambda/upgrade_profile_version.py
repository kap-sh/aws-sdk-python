...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.upgrade_profile_version_input.UpgradeProfileVersionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.upgrade_profile_version_input.serialize_json(
            input_
        )
    ).encode()
