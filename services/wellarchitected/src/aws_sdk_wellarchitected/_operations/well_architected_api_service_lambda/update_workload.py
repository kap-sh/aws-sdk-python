"""Generated from Smithy shape ``com.amazonaws.wellarchitected#UpdateWorkload``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.update_workload_output.UpdateWorkloadOutput = (
        aws_sdk_wellarchitected.types.update_workload_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.update_workload_input.UpdateWorkloadInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workloads/{WorkloadId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.update_workload_input.serialize_json(input)
    ).encode()
