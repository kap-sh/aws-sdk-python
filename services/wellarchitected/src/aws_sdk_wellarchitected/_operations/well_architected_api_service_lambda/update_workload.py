...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.update_workload_input.UpdateWorkloadInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.update_workload_input.serialize_json(input_)
    ).encode()
