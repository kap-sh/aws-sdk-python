...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.associate_profiles_input.AssociateProfilesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.associate_profiles_input.serialize_json(input_)
    ).encode()
