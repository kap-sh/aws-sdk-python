"""Generated from Smithy shape ``com.amazonaws.wellarchitected#AssociateProfiles``."""
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.associate_profiles_input.AssociateProfilesInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workloads/{WorkloadId}/associateProfiles"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.associate_profiles_input.serialize_json(input)
    ).encode()
...
async def async_associate_profiles(
