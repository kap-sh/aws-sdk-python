"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ListProfiles``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_profiles_output.ListProfilesOutput = (
        aws_sdk_wellarchitected.types.list_profiles_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.list_profiles_input.ListProfilesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/profileSummaries"
    params: dict[str, str] = {}
    if "profile_name_prefix" in input_:
        params["ProfileNamePrefix"] = str(input_["profile_name_prefix"])
    if "profile_owner_type" in input_:
        params["ProfileOwnerType"] = str(input_["profile_owner_type"])
