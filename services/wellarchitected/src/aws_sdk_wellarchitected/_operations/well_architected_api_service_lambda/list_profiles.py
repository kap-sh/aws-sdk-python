...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.list_profiles_input.ListProfilesInput,
) -> zapros.Request:
    ...
    if "profile_owner_type" in input:
        params["ProfileOwnerType"] = str(input["profile_owner_type"])
