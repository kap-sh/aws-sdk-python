...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.list_lens_reviews_input.ListLensReviewsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "milestone_number" in input_:
        params["MilestoneNumber"] = str(input_["milestone_number"])
