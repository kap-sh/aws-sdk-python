"""Generated from Smithy shape ``com.amazonaws.wellarchitected#UpdateLensReview``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.update_lens_review_output.UpdateLensReviewOutput = aws_sdk_wellarchitected.types.update_lens_review_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.update_lens_review_input.UpdateLensReviewInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workloads/{WorkloadId}/lensReviews/{LensAlias}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.update_lens_review_input.serialize_json(input)
    ).encode()
...
async def async_update_lens_review(
