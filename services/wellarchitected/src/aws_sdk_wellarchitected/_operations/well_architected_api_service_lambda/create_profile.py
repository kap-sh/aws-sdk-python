...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.create_profile_output.CreateProfileOutput = (
        aws_sdk_wellarchitected.types.create_profile_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.create_profile_input.CreateProfileInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.create_profile_input.serialize_json(input_)
    ).encode()
