"""Generated from Smithy shape ``com.amazonaws.wellarchitected#GetMilestone``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.get_milestone_output.GetMilestoneOutput = (
        aws_sdk_wellarchitected.types.get_milestone_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.get_milestone_input.GetMilestoneInput,
) -> zapros.Request:
    ...
    url = url.replace(
        "{MilestoneNumber}", quote(str(input["milestone_number"]), safe="")
    )
    params: dict[str, str] = {}
