"""Generated from Smithy shape ``com.amazonaws.wellarchitected#CreateMilestone``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.create_milestone_output.CreateMilestoneOutput = (
        aws_sdk_wellarchitected.types.create_milestone_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.create_milestone_input.CreateMilestoneInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workloads/{WorkloadId}/milestones"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.create_milestone_input.serialize_json(input)
    ).encode()
