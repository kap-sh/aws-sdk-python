...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.create_milestone_input.CreateMilestoneInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.create_milestone_input.serialize_json(input_)
    ).encode()
