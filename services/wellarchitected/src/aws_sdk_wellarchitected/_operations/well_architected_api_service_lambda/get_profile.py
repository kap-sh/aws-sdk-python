...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.get_profile_input.GetProfileInput,
) -> zapros.Request:
    ...
    url = url.replace("{ProfileArn}", quote(str(input["profile_arn"]), safe=""))
    params: dict[str, str] = {}
    if "profile_version" in input:
        params["ProfileVersion"] = str(input["profile_version"])
