...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.update_workload_share_input.UpdateWorkloadShareInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = url.replace("{ShareId}", quote(str(input_["share_id"]), safe=""))
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.update_workload_share_input.serialize_json(input_)
    ).encode()
