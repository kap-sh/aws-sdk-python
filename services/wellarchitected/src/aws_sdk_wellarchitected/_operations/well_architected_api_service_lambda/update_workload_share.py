"""Generated from Smithy shape ``com.amazonaws.wellarchitected#UpdateWorkloadShare``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.update_workload_share_output.UpdateWorkloadShareOutput = aws_sdk_wellarchitected.types.update_workload_share_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.update_workload_share_input.UpdateWorkloadShareInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workloads/{WorkloadId}/shares/{ShareId}"
    url = url.replace("{ShareId}", quote(str(input["share_id"]), safe=""))
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.update_workload_share_input.serialize_json(input)
    ).encode()
...
async def async_update_workload_share(
