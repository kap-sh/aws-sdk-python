...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_answers_output.ListAnswersOutput = (
        aws_sdk_wellarchitected.types.list_answers_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.list_answers_input.ListAnswersInput,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "pillar_id" in input:
        params["PillarId"] = str(input["pillar_id"])
    ...
    if "question_priority" in input:
        params["QuestionPriority"] = str(input["question_priority"])
...
def list_answers(
    ...
    aws_sdk_wellarchitected.types.list_answers_output.ListAnswersOutput, zapros.Response
]:
