"""Generated from Smithy shape ``com.amazonaws.wellarchitected#DeleteWorkloadShare``."""
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.delete_workload_share_input.DeleteWorkloadShareInput,
) -> zapros.Request:
    ...
    if "client_request_token" in input:
        params["ClientRequestToken"] = str(input["client_request_token"])
...
async def async_delete_workload_share(
