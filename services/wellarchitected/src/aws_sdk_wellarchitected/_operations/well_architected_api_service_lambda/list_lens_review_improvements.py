...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_lens_review_improvements_output.ListLensReviewImprovementsOutput = aws_sdk_wellarchitected.types.list_lens_review_improvements_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.list_lens_review_improvements_input.ListLensReviewImprovementsInput,
) -> zapros.Request:
