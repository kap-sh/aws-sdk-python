"""Generated from Smithy shape ``com.amazonaws.wellarchitected#GetAnswer``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.get_answer_output.GetAnswerOutput = (
        aws_sdk_wellarchitected.types.get_answer_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.get_answer_input.GetAnswerInput,
) -> zapros.Request:
...
def get_answer(
    ...
    aws_sdk_wellarchitected.types.get_answer_output.GetAnswerOutput, zapros.Response
]:
