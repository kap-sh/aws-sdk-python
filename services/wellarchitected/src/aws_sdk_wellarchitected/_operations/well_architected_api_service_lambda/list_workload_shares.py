"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ListWorkloadShares``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_workload_shares_output.ListWorkloadSharesOutput = aws_sdk_wellarchitected.types.list_workload_shares_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.list_workload_shares_input.ListWorkloadSharesInput,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "shared_with_prefix" in input:
        params["SharedWithPrefix"] = str(input["shared_with_prefix"])
...
async def async_list_workload_shares(
