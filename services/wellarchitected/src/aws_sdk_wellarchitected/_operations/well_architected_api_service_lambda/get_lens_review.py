"""Generated from Smithy shape ``com.amazonaws.wellarchitected#GetLensReview``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.get_lens_review_output.GetLensReviewOutput = (
        aws_sdk_wellarchitected.types.get_lens_review_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.get_lens_review_input.GetLensReviewInput,
) -> zapros.Request:
...
async def async_get_lens_review(
