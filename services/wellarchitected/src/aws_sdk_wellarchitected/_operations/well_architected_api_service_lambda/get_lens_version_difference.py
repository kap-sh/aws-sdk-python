...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.get_lens_version_difference_input.GetLensVersionDifferenceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "base_lens_version" in input_:
        params["BaseLensVersion"] = str(input_["base_lens_version"])
    if "target_lens_version" in input_:
        params["TargetLensVersion"] = str(input_["target_lens_version"])
