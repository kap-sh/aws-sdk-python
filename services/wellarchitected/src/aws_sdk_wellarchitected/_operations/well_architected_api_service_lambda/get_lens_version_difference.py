...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.get_lens_version_difference_output.GetLensVersionDifferenceOutput = aws_sdk_wellarchitected.types.get_lens_version_difference_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.get_lens_version_difference_input.GetLensVersionDifferenceInput,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "base_lens_version" in input:
        params["BaseLensVersion"] = str(input["base_lens_version"])
    if "target_lens_version" in input:
        params["TargetLensVersion"] = str(input["target_lens_version"])
