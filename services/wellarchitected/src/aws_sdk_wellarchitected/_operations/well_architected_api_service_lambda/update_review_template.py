...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.update_review_template_output.UpdateReviewTemplateOutput = aws_sdk_wellarchitected.types.update_review_template_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.update_review_template_input.UpdateReviewTemplateInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.update_review_template_input.serialize_json(input)
    ).encode()
