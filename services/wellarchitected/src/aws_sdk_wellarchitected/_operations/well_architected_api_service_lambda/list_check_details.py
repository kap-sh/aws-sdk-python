"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ListCheckDetails``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_check_details_output.ListCheckDetailsOutput = aws_sdk_wellarchitected.types.list_check_details_output.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.list_check_details_input.ListCheckDetailsInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workloads/{WorkloadId}/checks"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.list_check_details_input.serialize_json(input)
    ).encode()
...
async def async_list_check_details(
