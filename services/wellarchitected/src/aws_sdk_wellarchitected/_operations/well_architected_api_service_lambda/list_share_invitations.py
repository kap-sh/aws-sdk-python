"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ListShareInvitations``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_share_invitations_output.ListShareInvitationsOutput = aws_sdk_wellarchitected.types.list_share_invitations_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.list_share_invitations_input.ListShareInvitationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/shareInvitations"
    params: dict[str, str] = {}
    if "workload_name_prefix" in input_:
        params["WorkloadNamePrefix"] = str(input_["workload_name_prefix"])
    if "lens_name_prefix" in input_:
        params["LensNamePrefix"] = str(input_["lens_name_prefix"])
    if "share_resource_type" in input_:
        params["ShareResourceType"] = str(input_["share_resource_type"])
    if "next_token" in input_:
        params["NextToken"] = str(input_["next_token"])
    if "max_results" in input_:
        params["MaxResults"] = str(input_["max_results"])
    if "profile_name_prefix" in input_:
        params["ProfileNamePrefix"] = str(input_["profile_name_prefix"])
    if "template_name_prefix" in input_:
        params["TemplateNamePrefix"] = str(input_["template_name_prefix"])
...
async def async_list_share_invitations(
