...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.list_notifications_input.ListNotificationsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.list_notifications_input.serialize_json(input)
    ).encode()
