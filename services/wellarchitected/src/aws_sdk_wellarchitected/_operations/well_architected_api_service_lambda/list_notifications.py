...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_notifications_output.ListNotificationsOutput = aws_sdk_wellarchitected.types.list_notifications_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.list_notifications_input.ListNotificationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.list_notifications_input.serialize_json(input_)
    ).encode()
