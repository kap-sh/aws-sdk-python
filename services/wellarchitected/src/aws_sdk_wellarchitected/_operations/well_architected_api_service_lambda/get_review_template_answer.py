"""Generated from Smithy shape ``com.amazonaws.wellarchitected#GetReviewTemplateAnswer``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.get_review_template_answer_output.GetReviewTemplateAnswerOutput = aws_sdk_wellarchitected.types.get_review_template_answer_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.get_review_template_answer_input.GetReviewTemplateAnswerInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_review_template_answer(
