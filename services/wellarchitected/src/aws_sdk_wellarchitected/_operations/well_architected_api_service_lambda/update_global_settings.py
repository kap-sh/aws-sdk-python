"""Generated from Smithy shape ``com.amazonaws.wellarchitected#UpdateGlobalSettings``."""
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.update_global_settings_input.UpdateGlobalSettingsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.update_global_settings_input.serialize_json(input)
    ).encode()
...
async def async_update_global_settings(
