...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.disassociate_profiles_input.DisassociateProfilesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.disassociate_profiles_input.serialize_json(input)
    ).encode()
