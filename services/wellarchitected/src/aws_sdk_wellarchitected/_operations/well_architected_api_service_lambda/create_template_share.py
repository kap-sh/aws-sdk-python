...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.create_template_share_input.CreateTemplateShareInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.create_template_share_input.serialize_json(input)
    ).encode()
