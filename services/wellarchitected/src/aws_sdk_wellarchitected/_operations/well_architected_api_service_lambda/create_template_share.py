...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.create_template_share_output.CreateTemplateShareOutput = aws_sdk_wellarchitected.types.create_template_share_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.create_template_share_input.CreateTemplateShareInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.create_template_share_input.serialize_json(input_)
    ).encode()
