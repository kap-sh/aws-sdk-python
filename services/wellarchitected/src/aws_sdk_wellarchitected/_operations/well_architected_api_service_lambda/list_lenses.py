...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.list_lenses_input.ListLensesInput,
) -> zapros.Request:
    ...
    if "lens_type" in input:
        params["LensType"] = str(input["lens_type"])
    if "lens_status" in input:
        params["LensStatus"] = str(input["lens_status"])
    if "lens_name" in input:
        params["LensName"] = str(input["lens_name"])
