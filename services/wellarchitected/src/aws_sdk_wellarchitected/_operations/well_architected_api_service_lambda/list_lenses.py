"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ListLenses``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_lenses_output.ListLensesOutput = (
        aws_sdk_wellarchitected.types.list_lenses_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.list_lenses_input.ListLensesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/lenses"
    params: dict[str, str] = {}
    if "next_token" in input_:
        params["NextToken"] = str(input_["next_token"])
    if "max_results" in input_:
        params["MaxResults"] = str(input_["max_results"])
    if "lens_type" in input_:
        params["LensType"] = str(input_["lens_type"])
    if "lens_status" in input_:
        params["LensStatus"] = str(input_["lens_status"])
    if "lens_name" in input_:
        params["LensName"] = str(input_["lens_name"])
...
def list_lenses(
    ...
    aws_sdk_wellarchitected.types.list_lenses_output.ListLensesOutput, zapros.Response
]:
