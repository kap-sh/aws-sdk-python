"""Generated from Smithy shape ``com.amazonaws.wellarchitected#UpgradeLensReview``."""
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.upgrade_lens_review_input.UpgradeLensReviewInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.upgrade_lens_review_input.serialize_json(input)
    ).encode()
...
async def async_upgrade_lens_review(
