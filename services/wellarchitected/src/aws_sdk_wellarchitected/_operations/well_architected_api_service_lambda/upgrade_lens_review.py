...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.upgrade_lens_review_input.UpgradeLensReviewInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.upgrade_lens_review_input.serialize_json(input_)
    ).encode()
