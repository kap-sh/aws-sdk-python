...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.create_lens_share_input.CreateLensShareInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.create_lens_share_input.serialize_json(input)
    ).encode()
