...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.create_review_template_input.CreateReviewTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.create_review_template_input.serialize_json(
            input_
        )
    ).encode()
