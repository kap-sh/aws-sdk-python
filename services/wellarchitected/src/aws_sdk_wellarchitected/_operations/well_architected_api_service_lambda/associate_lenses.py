...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.associate_lenses_input.AssociateLensesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.associate_lenses_input.serialize_json(input_)
    ).encode()
