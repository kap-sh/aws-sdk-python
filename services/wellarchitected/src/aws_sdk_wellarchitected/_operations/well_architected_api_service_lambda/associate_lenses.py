"""Generated from Smithy shape ``com.amazonaws.wellarchitected#AssociateLenses``."""
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.associate_lenses_input.AssociateLensesInput,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/workloads/{WorkloadId}/associateLenses"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.associate_lenses_input.serialize_json(input)
    ).encode()
...
async def async_associate_lenses(
