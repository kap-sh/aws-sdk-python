"""Generated from Smithy shape ``com.amazonaws.wellarchitected#DeleteWorkload``."""
...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.delete_workload_input.DeleteWorkloadInput,
) -> zapros.Request:
...
async def async_delete_workload(
