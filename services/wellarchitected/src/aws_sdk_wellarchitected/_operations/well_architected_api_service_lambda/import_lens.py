"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ImportLens``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.import_lens_output.ImportLensOutput = (
        aws_sdk_wellarchitected.types.import_lens_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.import_lens_input.ImportLensInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/importLens"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_wellarchitected.types.import_lens_input

    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.import_lens_input.serialize_json(input_)
    ).encode()
...
def import_lens(
    ...
    aws_sdk_wellarchitected.types.import_lens_output.ImportLensOutput, zapros.Response
]:
