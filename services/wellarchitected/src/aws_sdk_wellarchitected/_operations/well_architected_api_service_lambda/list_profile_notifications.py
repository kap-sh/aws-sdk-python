"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ListProfileNotifications``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.list_profile_notifications_output.ListProfileNotificationsOutput = aws_sdk_wellarchitected.types.list_profile_notifications_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.list_profile_notifications_input.ListProfileNotificationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/profileNotifications"
    params: dict[str, str] = {}
    if "workload_id" in input_:
        params["WorkloadId"] = str(input_["workload_id"])
...
async def async_list_profile_notifications(
