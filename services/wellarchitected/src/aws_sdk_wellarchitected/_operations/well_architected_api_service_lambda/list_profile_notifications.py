...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.list_profile_notifications_input.ListProfileNotificationsInput,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "workload_id" in input:
        params["WorkloadId"] = str(input["workload_id"])
