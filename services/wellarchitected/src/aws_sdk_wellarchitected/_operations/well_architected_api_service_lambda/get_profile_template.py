"""Generated from Smithy shape ``com.amazonaws.wellarchitected#GetProfileTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.get_profile_template_output.GetProfileTemplateOutput = aws_sdk_wellarchitected.types.get_profile_template_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.get_profile_template_input.GetProfileTemplateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/profileTemplate"
    params: dict[str, str] = {}
...
async def async_get_profile_template(
