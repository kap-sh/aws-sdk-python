"""Generated from Smithy shape ``com.amazonaws.wellarchitected#DeleteLensShare``."""
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.delete_lens_share_input.DeleteLensShareInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/lenses/{LensAlias}/shares/{ShareId}"
...
async def async_delete_lens_share(
