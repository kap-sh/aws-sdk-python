"""Generated from Smithy shape ``com.amazonaws.wellarchitected#GetConsolidatedReport``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.get_consolidated_report_output.GetConsolidatedReportOutput = aws_sdk_wellarchitected.types.get_consolidated_report_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.get_consolidated_report_input.GetConsolidatedReportInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/consolidatedReport"
    params: dict[str, str] = {}
    if "format" in input_:
        params["Format"] = str(input_["format"])
    if "include_shared_resources" in input_:
        params["IncludeSharedResources"] = str(input_["include_shared_resources"])
...
async def async_get_consolidated_report(
