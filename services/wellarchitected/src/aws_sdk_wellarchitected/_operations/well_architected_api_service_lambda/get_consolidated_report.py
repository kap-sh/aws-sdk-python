...
def build_request(
    ...
    input: aws_sdk_wellarchitected.types.get_consolidated_report_input.GetConsolidatedReportInput,
) -> zapros.Request:
    ...
    if "include_shared_resources" in input:
        params["IncludeSharedResources"] = str(input["include_shared_resources"])
