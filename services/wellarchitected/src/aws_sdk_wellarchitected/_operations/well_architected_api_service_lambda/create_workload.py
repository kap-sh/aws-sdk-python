"""Generated from Smithy shape ``com.amazonaws.wellarchitected#CreateWorkload``."""
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.create_workload_output.CreateWorkloadOutput = (
        aws_sdk_wellarchitected.types.create_workload_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.create_workload_input.CreateWorkloadInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/workloads"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_wellarchitected.types.create_workload_input

    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.create_workload_input.serialize_json(input_)
    ).encode()
...
async def async_create_workload(
