"""Generated from Smithy shape ``com.amazonaws.wellarchitected#UpdateReviewTemplateLensReview``."""
...
import aws_sdk_wellarchitected.types.review_template_lens_review
...
def handle_response(
    ...
    out: aws_sdk_wellarchitected.types.update_review_template_lens_review_output.UpdateReviewTemplateLensReviewOutput = aws_sdk_wellarchitected.types.update_review_template_lens_review_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_wellarchitected.types.update_review_template_lens_review_input.UpdateReviewTemplateLensReviewInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_wellarchitected.types.update_review_template_lens_review_input.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_review_template_lens_review(
