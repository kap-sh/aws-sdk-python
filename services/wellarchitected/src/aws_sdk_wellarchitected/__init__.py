...
from ._services.async_well_architected import (
    AsyncWellArchitectedClient as AsyncWellArchitectedClient,
)
from ._services.well_architected import WellArchitectedClient as WellArchitectedClient
