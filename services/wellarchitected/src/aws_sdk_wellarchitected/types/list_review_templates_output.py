...
class ListReviewTemplatesOutput(TypedDict):
    review_templates: NotRequired[
        "aws_sdk_wellarchitected.types.review_templates.ReviewTemplates"
    ]
...
def serialize_json(value: ListReviewTemplatesOutput) -> dict:
    ...
    if "review_templates" in value:
        ...
        out["ReviewTemplates"] = (
            aws_sdk_wellarchitected.types.review_templates.serialize_json(
...
def deserialize_json(data: dict) -> ListReviewTemplatesOutput:
    ...
    if "ReviewTemplates" in data:
        ...
        out["review_templates"] = (
            aws_sdk_wellarchitected.types.review_templates.deserialize_json(
