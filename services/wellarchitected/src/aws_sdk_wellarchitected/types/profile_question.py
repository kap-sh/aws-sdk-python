...
if TYPE_CHECKING:
    ...
    import aws_sdk_wellarchitected.types.profile_question_choices
...
class ProfileQuestion(TypedDict, closed=True):
    ...
    question_choices: NotRequired[
        "aws_sdk_wellarchitected.types.profile_question_choices.ProfileQuestionChoices"
    ]
    """<p>The question choices.</p>"""
    selected_choice_ids: NotRequired[
        "aws_sdk_wellarchitected.types.selected_choice_ids.SelectedChoiceIds"
    ]
...
def serialize_json(value: ProfileQuestion) -> dict:
    ...
    if "question_choices" in value:
        ...
        out["QuestionChoices"] = (
            aws_sdk_wellarchitected.types.profile_question_choices.serialize_json(
    ...
    if "selected_choice_ids" in value:
        ...
        out["SelectedChoiceIds"] = (
            aws_sdk_wellarchitected.types.selected_choice_ids.serialize_json(
...
def deserialize_json(data: dict) -> ProfileQuestion:
    ...
    if "QuestionChoices" in data:
        ...
        out["question_choices"] = (
            aws_sdk_wellarchitected.types.profile_question_choices.deserialize_json(
    ...
    if "SelectedChoiceIds" in data:
        ...
        out["selected_choice_ids"] = (
            aws_sdk_wellarchitected.types.selected_choice_ids.deserialize_json(
