import pytest
from aws_sdk_wellarchitected._rule_engine._endpoint_rule_set import EndpointParams, resolve
from aws_sdk_wellarchitected._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_1_for_region_ap_east_1_with_fips_disabled_():
    ...
    assert result.url == 'https://wellarchitected.ap-east-1.amazonaws.com'
...
def test_2_for_region_ap_northeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.ap-northeast-1.amazonaws.com'
...
def test_3_for_region_ap_northeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.ap-northeast-2.amazonaws.com'
...
def test_4_for_region_ap_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.ap-south-1.amazonaws.com'
...
def test_5_for_region_ap_southeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.ap-southeast-1.amazonaws.com'
...
def test_6_for_region_ap_southeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.ap-southeast-2.amazonaws.com'
...
def test_7_for_region_ca_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.ca-central-1.amazonaws.com'
...
def test_8_for_region_eu_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.eu-central-1.amazonaws.com'
...
def test_9_for_region_eu_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.eu-north-1.amazonaws.com'
...
def test_10_for_region_eu_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.eu-west-1.amazonaws.com'
...
def test_11_for_region_eu_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.eu-west-2.amazonaws.com'
...
def test_12_for_region_eu_west_3_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.eu-west-3.amazonaws.com'
...
def test_13_for_region_me_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.me-south-1.amazonaws.com'
...
def test_14_for_region_sa_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.sa-east-1.amazonaws.com'
...
def test_16_for_region_us_east_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.us-east-2.amazonaws.com'
...
def test_17_for_region_us_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.us-west-1.amazonaws.com'
...
def test_18_for_region_us_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.us-west-2.amazonaws.com'
...
def test_22_for_region_cn_north_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected-fips.cn-north-1.api.amazonwebservices.com.cn'
...
def test_23_for_region_cn_north_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected-fips.cn-north-1.amazonaws.com.cn'
...
def test_24_for_region_cn_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.cn-north-1.api.amazonwebservices.com.cn'
...
def test_25_for_region_cn_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.cn-north-1.amazonaws.com.cn'
...
def test_26_for_region_us_gov_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected-fips.us-gov-east-1.api.aws'
...
def test_27_for_region_us_gov_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected-fips.us-gov-east-1.amazonaws.com'
...
def test_28_for_region_us_gov_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.us-gov-east-1.api.aws'
...
def test_29_for_region_us_gov_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://wellarchitected.us-gov-east-1.amazonaws.com'
