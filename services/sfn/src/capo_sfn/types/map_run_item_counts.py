"""Generated from Smithy shape ``com.amazonaws.sfn#MapRunItemCounts``."""
...
class MapRunItemCounts(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: MapRunItemCounts) -> dict:
    out: dict = {}
