"""Generated from Smithy shape ``com.amazonaws.sfn#DeleteStateMachineAlias``."""
...
def handle_response(
    ...
    out: capo_sfn.types.delete_state_machine_alias_output.DeleteStateMachineAliasOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSStepFunctions.DeleteStateMachineAlias"
    body: bytes | None = json.dumps(
        capo_sfn.types.delete_state_machine_alias_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_state_machine_alias(
