...
def handle_response(
    ...
    out: capo_sfn.types.update_state_machine_alias_output.UpdateStateMachineAliasOutput = capo_sfn.types.update_state_machine_alias_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.update_state_machine_alias_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
