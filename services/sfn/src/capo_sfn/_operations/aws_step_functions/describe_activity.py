...
def handle_response(
    ...
    out: capo_sfn.types.describe_activity_output.DescribeActivityOutput = (
        capo_sfn.types.describe_activity_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.describe_activity_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def describe_activity(
    ...
    capo_sfn.types.describe_activity_output.DescribeActivityOutput, zapros.Response
]:
