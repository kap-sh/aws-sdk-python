"""Generated from Smithy shape ``com.amazonaws.sfn#CreateStateMachine``."""
...
import capo_sfn.errors.state_machine_already_exists
import capo_sfn.errors.state_machine_deleting
import capo_sfn.errors.state_machine_limit_exceeded
...
def handle_response(
    ...
    out: capo_sfn.types.create_state_machine_output.CreateStateMachineOutput = (
        capo_sfn.types.create_state_machine_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.create_state_machine_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def create_state_machine(
    ...
    capo_sfn.types.create_state_machine_output.CreateStateMachineOutput, zapros.Response
]:
...
async def async_create_state_machine(
