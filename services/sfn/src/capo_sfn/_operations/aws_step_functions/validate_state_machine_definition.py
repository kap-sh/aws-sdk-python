"""Generated from Smithy shape ``com.amazonaws.sfn#ValidateStateMachineDefinition``."""
...
def handle_response(
    ...
    out: capo_sfn.types.validate_state_machine_definition_output.ValidateStateMachineDefinitionOutput = capo_sfn.types.validate_state_machine_definition_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.validate_state_machine_definition_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_validate_state_machine_definition(
