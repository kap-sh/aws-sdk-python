...
def handle_response(
    ...
    out: capo_sfn.types.start_sync_execution_output.StartSyncExecutionOutput = (
        capo_sfn.types.start_sync_execution_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.start_sync_execution_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def start_sync_execution(
    ...
    capo_sfn.types.start_sync_execution_output.StartSyncExecutionOutput, zapros.Response
]:
