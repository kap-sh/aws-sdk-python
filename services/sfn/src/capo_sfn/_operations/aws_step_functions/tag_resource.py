...
def handle_response(
    ...
    out: capo_sfn.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.tag_resource_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def tag_resource(
    ...
    input_: capo_sfn.types.tag_resource_input.TagResourceInput,
) -> tuple[capo_sfn.types.tag_resource_output.TagResourceOutput, zapros.Response]:
