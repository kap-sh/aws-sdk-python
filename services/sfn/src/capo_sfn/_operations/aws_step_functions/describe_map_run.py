"""Generated from Smithy shape ``com.amazonaws.sfn#DescribeMapRun``."""
...
def handle_response(
    ...
    out: capo_sfn.types.describe_map_run_output.DescribeMapRunOutput = (
        capo_sfn.types.describe_map_run_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSStepFunctions.DescribeMapRun"
    body: bytes | None = json.dumps(
        capo_sfn.types.describe_map_run_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def describe_map_run(
    ...
    capo_sfn.types.describe_map_run_output.DescribeMapRunOutput, zapros.Response
]:
...
async def async_describe_map_run(
