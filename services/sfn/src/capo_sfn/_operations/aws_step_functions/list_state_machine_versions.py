...
def handle_response(
    ...
    out: capo_sfn.types.list_state_machine_versions_output.ListStateMachineVersionsOutput = capo_sfn.types.list_state_machine_versions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.list_state_machine_versions_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
