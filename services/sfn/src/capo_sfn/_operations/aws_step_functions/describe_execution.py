...
def handle_response(
    ...
    out: capo_sfn.types.describe_execution_output.DescribeExecutionOutput = (
        capo_sfn.types.describe_execution_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.describe_execution_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def describe_execution(
    ...
    capo_sfn.types.describe_execution_output.DescribeExecutionOutput, zapros.Response
]:
