"""Generated from Smithy shape ``com.amazonaws.sfn#GetActivityTask``."""
...
import capo_sfn.errors.activity_does_not_exist
import capo_sfn.errors.activity_worker_limit_exceeded
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ActivityDoesNotExist":
            raise capo_sfn.errors.activity_does_not_exist.ActivityDoesNotExist.from_aws_json_1_0(
                data, message
            )
        case "ActivityWorkerLimitExceeded":
            raise capo_sfn.errors.activity_worker_limit_exceeded.ActivityWorkerLimitExceeded.from_aws_json_1_0(
                data, message
            )
        case "InvalidArn":
...
def handle_response(
    ...
    out: capo_sfn.types.get_activity_task_output.GetActivityTaskOutput = (
        capo_sfn.types.get_activity_task_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.get_activity_task_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def get_activity_task(
    ...
    capo_sfn.types.get_activity_task_output.GetActivityTaskOutput, zapros.Response
]:
...
async def async_get_activity_task(
