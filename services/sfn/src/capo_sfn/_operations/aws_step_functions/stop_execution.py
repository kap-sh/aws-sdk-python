"""Generated from Smithy shape ``com.amazonaws.sfn#StopExecution``."""
...
def handle_response(
    ...
    out: capo_sfn.types.stop_execution_output.StopExecutionOutput = (
        capo_sfn.types.stop_execution_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.stop_execution_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def stop_execution(
    ...
    input_: capo_sfn.types.stop_execution_input.StopExecutionInput,
) -> tuple[capo_sfn.types.stop_execution_output.StopExecutionOutput, zapros.Response]:
