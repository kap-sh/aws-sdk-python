"""Generated from Smithy shape ``com.amazonaws.sfn#SendTaskFailure``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TaskTimedOut":
            raise capo_sfn.errors.task_timed_out.TaskTimedOut.from_aws_json_1_0(data)
        case _:
...
def handle_response(
    ...
    out: capo_sfn.types.send_task_failure_output.SendTaskFailureOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.send_task_failure_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def send_task_failure(
    ...
    capo_sfn.types.send_task_failure_output.SendTaskFailureOutput, zapros.Response
]:
...
async def async_send_task_failure(
