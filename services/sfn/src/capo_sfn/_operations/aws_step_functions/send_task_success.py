"""Generated from Smithy shape ``com.amazonaws.sfn#SendTaskSuccess``."""
...
import capo_sfn.errors.invalid_output
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidOutput":
            raise capo_sfn.errors.invalid_output.InvalidOutput.from_aws_json_1_0(data)
        case "InvalidToken":
...
def handle_response(
    ...
    out: capo_sfn.types.send_task_success_output.SendTaskSuccessOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.send_task_success_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def send_task_success(
    ...
    capo_sfn.types.send_task_success_output.SendTaskSuccessOutput, zapros.Response
]:
...
async def async_send_task_success(
