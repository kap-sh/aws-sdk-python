...
def handle_response(
    ...
    out: capo_sfn.types.update_map_run_output.UpdateMapRunOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.update_map_run_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def update_map_run(
    ...
    input_: capo_sfn.types.update_map_run_input.UpdateMapRunInput,
) -> tuple[capo_sfn.types.update_map_run_output.UpdateMapRunOutput, zapros.Response]:
