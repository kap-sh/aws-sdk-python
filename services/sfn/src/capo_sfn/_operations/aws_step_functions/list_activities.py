...
def handle_response(
    ...
    out: capo_sfn.types.list_activities_output.ListActivitiesOutput = (
        capo_sfn.types.list_activities_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.list_activities_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_activities(
    ...
    input_: capo_sfn.types.list_activities_input.ListActivitiesInput,
) -> tuple[capo_sfn.types.list_activities_output.ListActivitiesOutput, zapros.Response]:
