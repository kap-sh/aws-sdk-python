...
def handle_response(
    ...
    out: capo_sfn.types.delete_state_machine_version_output.DeleteStateMachineVersionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.delete_state_machine_version_input.serialize_aws_json_1_0(input_)
    ).encode()
