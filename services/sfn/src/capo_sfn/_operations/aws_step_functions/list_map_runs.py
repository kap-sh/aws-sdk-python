"""Generated from Smithy shape ``com.amazonaws.sfn#ListMapRuns``."""
...
def handle_response(
    ...
    out: capo_sfn.types.list_map_runs_output.ListMapRunsOutput = (
        capo_sfn.types.list_map_runs_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSStepFunctions.ListMapRuns"
    body: bytes | None = json.dumps(
        capo_sfn.types.list_map_runs_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_map_runs(
    ...
    input_: capo_sfn.types.list_map_runs_input.ListMapRunsInput,
) -> tuple[capo_sfn.types.list_map_runs_output.ListMapRunsOutput, zapros.Response]:
