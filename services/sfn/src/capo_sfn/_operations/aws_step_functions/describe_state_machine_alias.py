"""Generated from Smithy shape ``com.amazonaws.sfn#DescribeStateMachineAlias``."""
...
def handle_response(
    ...
    out: capo_sfn.types.describe_state_machine_alias_output.DescribeStateMachineAliasOutput = capo_sfn.types.describe_state_machine_alias_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.describe_state_machine_alias_input.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_describe_state_machine_alias(
