...
def handle_response(
    ...
    out: capo_sfn.types.describe_state_machine_output.DescribeStateMachineOutput = (
        capo_sfn.types.describe_state_machine_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.describe_state_machine_input.serialize_aws_json_1_0(input_)
    ).encode()
