"""Generated from Smithy shape ``com.amazonaws.sfn#ListStateMachines``."""
...
import capo_sfn.types.state_machine_list
...
def handle_response(
    ...
    out: capo_sfn.types.list_state_machines_output.ListStateMachinesOutput = (
        capo_sfn.types.list_state_machines_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.list_state_machines_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_state_machines(
    ...
    capo_sfn.types.list_state_machines_output.ListStateMachinesOutput, zapros.Response
]:
...
async def async_list_state_machines(
