...
def handle_response(
    ...
    out: capo_sfn.types.list_state_machine_aliases_output.ListStateMachineAliasesOutput = capo_sfn.types.list_state_machine_aliases_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.list_state_machine_aliases_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
