"""Generated from Smithy shape ``com.amazonaws.sfn#UntagResource``."""
...
def handle_response(
    ...
    out: capo_sfn.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.untag_resource_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def untag_resource(
    ...
    input_: capo_sfn.types.untag_resource_input.UntagResourceInput,
) -> tuple[capo_sfn.types.untag_resource_output.UntagResourceOutput, zapros.Response]:
