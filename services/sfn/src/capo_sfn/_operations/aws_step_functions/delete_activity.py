"""Generated from Smithy shape ``com.amazonaws.sfn#DeleteActivity``."""
...
def handle_response(
    ...
    out: capo_sfn.types.delete_activity_output.DeleteActivityOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.delete_activity_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def delete_activity(
    ...
    input_: capo_sfn.types.delete_activity_input.DeleteActivityInput,
) -> tuple[capo_sfn.types.delete_activity_output.DeleteActivityOutput, zapros.Response]:
...
async def async_delete_activity(
