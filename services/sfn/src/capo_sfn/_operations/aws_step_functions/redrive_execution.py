...
import capo_sfn.errors.execution_not_redrivable
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ExecutionNotRedrivable":
            raise capo_sfn.errors.execution_not_redrivable.ExecutionNotRedrivable.from_aws_json_1_0(
                data, message
            )
        case "InvalidArn":
...
def handle_response(
    ...
    out: capo_sfn.types.redrive_execution_output.RedriveExecutionOutput = (
        capo_sfn.types.redrive_execution_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.redrive_execution_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def redrive_execution(
    ...
    capo_sfn.types.redrive_execution_output.RedriveExecutionOutput, zapros.Response
]:
