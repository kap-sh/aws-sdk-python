...
def handle_response(
    ...
    out: capo_sfn.types.delete_state_machine_output.DeleteStateMachineOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.delete_state_machine_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def delete_state_machine(
    ...
    capo_sfn.types.delete_state_machine_output.DeleteStateMachineOutput, zapros.Response
]:
