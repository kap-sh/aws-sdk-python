...
def handle_response(
    ...
    out: capo_sfn.types.get_execution_history_output.GetExecutionHistoryOutput = (
        capo_sfn.types.get_execution_history_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sfn.types.get_execution_history_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
