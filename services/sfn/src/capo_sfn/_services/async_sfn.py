...
from capo_sfn._services._aws_config import aaws_config
...
class AsyncSFNClient:
    ...
    async def create_activity(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.create_activity_input.CreateActivityInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.create_activity_output.CreateActivityOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.create_activity.async_create_activity(
    ...
    async def create_state_machine(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.create_state_machine_input.CreateStateMachineInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.create_state_machine_output.CreateStateMachineOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.create_state_machine.async_create_state_machine(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_state_machine_alias(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.create_state_machine_alias_input.CreateStateMachineAliasInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.create_state_machine_alias_output.CreateStateMachineAliasOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.create_state_machine_alias.async_create_state_machine_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_activity(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.delete_activity_input.DeleteActivityInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.delete_activity_output.DeleteActivityOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.delete_activity.async_delete_activity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_state_machine(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.delete_state_machine_input.DeleteStateMachineInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.delete_state_machine_output.DeleteStateMachineOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.delete_state_machine.async_delete_state_machine(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_state_machine_alias(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.delete_state_machine_alias_input.DeleteStateMachineAliasInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.delete_state_machine_alias_output.DeleteStateMachineAliasOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.delete_state_machine_alias.async_delete_state_machine_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_state_machine_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.delete_state_machine_version_input.DeleteStateMachineVersionInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.delete_state_machine_version_output.DeleteStateMachineVersionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.delete_state_machine_version.async_delete_state_machine_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_activity(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.describe_activity_input.DescribeActivityInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.describe_activity_output.DescribeActivityOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.describe_activity.async_describe_activity(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.describe_execution_input.DescribeExecutionInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.describe_execution_output.DescribeExecutionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.describe_execution.async_describe_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_map_run(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.describe_map_run_input.DescribeMapRunInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.describe_map_run_output.DescribeMapRunOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.describe_map_run.async_describe_map_run(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_state_machine(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.describe_state_machine_input.DescribeStateMachineInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.describe_state_machine_output.DescribeStateMachineOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.describe_state_machine.async_describe_state_machine(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_state_machine_alias(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.describe_state_machine_alias_input.DescribeStateMachineAliasInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.describe_state_machine_alias_output.DescribeStateMachineAliasOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.describe_state_machine_alias.async_describe_state_machine_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_state_machine_for_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.describe_state_machine_for_execution_input.DescribeStateMachineForExecutionInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.describe_state_machine_for_execution_output.DescribeStateMachineForExecutionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.describe_state_machine_for_execution.async_describe_state_machine_for_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_activity_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.get_activity_task_input.GetActivityTaskInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.get_activity_task_output.GetActivityTaskOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.get_activity_task.async_get_activity_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_execution_history(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.get_execution_history_input.GetExecutionHistoryInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.get_execution_history_output.GetExecutionHistoryOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.get_execution_history.async_get_execution_history(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_sfn.types.history_event.HistoryEvent]":
        _token = next_token
        while True:
    ...
    async def list_activities(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.list_activities_input.ListActivitiesInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.list_activities_output.ListActivitiesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.list_activities.async_list_activities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_activities(
        ...
        *,
        ...
        max_results: Optional["capo_sfn.types.page_size.PageSize"] = None,
        next_token: Optional["capo_sfn.types.page_token.PageToken"] = None,
    ) -> "AsyncIterator[capo_sfn.types.activity_list_item.ActivityListItem]":
        _token = next_token
        while True:
    ...
    async def list_executions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.list_executions_input.ListExecutionsInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.list_executions_output.ListExecutionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.list_executions.async_list_executions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_sfn.types.execution_list_item.ExecutionListItem]":
        _token = next_token
        while True:
    ...
    async def list_map_runs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.list_map_runs_input.ListMapRunsInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.list_map_runs_output.ListMapRunsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.list_map_runs.async_list_map_runs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_map_runs(
        ...
        *,
        ...
        max_results: Optional["capo_sfn.types.page_size.PageSize"] = None,
        next_token: Optional["capo_sfn.types.page_token.PageToken"] = None,
    ) -> "AsyncIterator[capo_sfn.types.map_run_list_item.MapRunListItem]":
        _token = next_token
        while True:
    ...
    async def list_state_machine_aliases(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.list_state_machine_aliases_input.ListStateMachineAliasesInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.list_state_machine_aliases_output.ListStateMachineAliasesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.list_state_machine_aliases.async_list_state_machine_aliases(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_state_machines(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.list_state_machines_input.ListStateMachinesInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.list_state_machines_output.ListStateMachinesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.list_state_machines.async_list_state_machines(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_state_machines(
        ...
        *,
        ...
        max_results: Optional["capo_sfn.types.page_size.PageSize"] = None,
        next_token: Optional["capo_sfn.types.page_token.PageToken"] = None,
    ) -> "AsyncIterator[capo_sfn.types.state_machine_list_item.StateMachineListItem]":
        _token = next_token
        while True:
    ...
    async def list_state_machine_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.list_state_machine_versions_input.ListStateMachineVersionsInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.list_state_machine_versions_output.ListStateMachineVersionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.list_state_machine_versions.async_list_state_machine_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def publish_state_machine_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.publish_state_machine_version_input.PublishStateMachineVersionInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.publish_state_machine_version_output.PublishStateMachineVersionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.publish_state_machine_version.async_publish_state_machine_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def redrive_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.redrive_execution_input.RedriveExecutionInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.redrive_execution_output.RedriveExecutionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.redrive_execution.async_redrive_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def send_task_failure(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.send_task_failure_input.SendTaskFailureInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.send_task_failure_output.SendTaskFailureOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.send_task_failure.async_send_task_failure(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def send_task_heartbeat(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.send_task_heartbeat_input.SendTaskHeartbeatInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.send_task_heartbeat_output.SendTaskHeartbeatOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.send_task_heartbeat.async_send_task_heartbeat(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def send_task_success(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.send_task_success_input.SendTaskSuccessInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.send_task_success_output.SendTaskSuccessOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.send_task_success.async_send_task_success(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.start_execution_input.StartExecutionInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.start_execution_output.StartExecutionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.start_execution.async_start_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_sync_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.start_sync_execution_input.StartSyncExecutionInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.start_sync_execution_output.StartSyncExecutionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.start_sync_execution.async_start_sync_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.stop_execution_input.StopExecutionInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.stop_execution_output.StopExecutionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.stop_execution.async_stop_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.tag_resource_input.TagResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def test_state(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.test_state_input.TestStateInput]",
        ) -> AsyncOperationResponse["capo_sfn.types.test_state_output.TestStateOutput"]:
            import capo_sfn._operations.aws_step_functions.test_state

            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.test_state.async_test_state(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.untag_resource_input.UntagResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_map_run(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.update_map_run_input.UpdateMapRunInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.update_map_run_output.UpdateMapRunOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.update_map_run.async_update_map_run(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_state_machine(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.update_state_machine_input.UpdateStateMachineInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.update_state_machine_output.UpdateStateMachineOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.update_state_machine.async_update_state_machine(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_state_machine_alias(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.update_state_machine_alias_input.UpdateStateMachineAliasInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.update_state_machine_alias_output.UpdateStateMachineAliasOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.update_state_machine_alias.async_update_state_machine_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def validate_state_machine_definition(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sfn.types.validate_state_machine_definition_input.ValidateStateMachineDefinitionInput]",
        ) -> AsyncOperationResponse[
            "capo_sfn.types.validate_state_machine_definition_output.ValidateStateMachineDefinitionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sfn._operations.aws_step_functions.validate_state_machine_definition.async_validate_state_machine_definition(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
