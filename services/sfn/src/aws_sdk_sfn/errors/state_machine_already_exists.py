...
class StateMachineAlreadyExists_(TypedDict):
...
class StateMachineAlreadyExists(ServiceError):
    ...
    def __init__(self, data: StateMachineAlreadyExists_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_0(cls, data: dict) -> "StateMachineAlreadyExists":
