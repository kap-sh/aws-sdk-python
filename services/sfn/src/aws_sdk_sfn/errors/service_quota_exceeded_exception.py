"""Generated from Smithy shape ``com.amazonaws.sfn#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.sfn#ServiceQuotaExceededException``."""
