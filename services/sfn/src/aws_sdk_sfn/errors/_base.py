...
class SFNError(Exception):
    """Base class for all SFN service errors."""


class ServiceError(SFNError):
...
class SerializationError(SFNError):
    """Raised when a value cannot be serialized."""


class DeserializationError(SFNError):
...
class WaiterFailedError(SFNError):
...
class WaiterTimeoutError(SFNError):
