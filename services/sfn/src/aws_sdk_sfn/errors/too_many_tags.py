...
class TooManyTags(ServiceError):
    ...
    def __init__(self, data: TooManyTags_):
        super().__init__(
            "client", is_throttling_error=False, is_retryable=False, code="TooManyTags"
        )
        self.data = data

    @classmethod
    def from_aws_json_1_0(cls, data: dict) -> "TooManyTags":
