...
class StateMachineTypeNotSupported_(TypedDict):
...
class StateMachineTypeNotSupported(ServiceError):
    ...
    def __init__(self, data: StateMachineTypeNotSupported_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_0(cls, data: dict) -> "StateMachineTypeNotSupported":
