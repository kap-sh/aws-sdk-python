...
def handle_response(
    ...
    out: aws_sdk_sfn.types.stop_execution_output.StopExecutionOutput = (
        aws_sdk_sfn.types.stop_execution_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.stop_execution_input.StopExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.stop_execution_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def stop_execution(
    ...
    aws_sdk_sfn.types.stop_execution_output.StopExecutionOutput, zapros.Response
]:
