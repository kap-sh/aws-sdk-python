"""Generated from Smithy shape ``com.amazonaws.sfn#CreateStateMachineAlias``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_sfn.errors.service_quota_exceeded_exception

            raise aws_sdk_sfn.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_sfn.types.create_state_machine_alias_output.CreateStateMachineAliasOutput = aws_sdk_sfn.types.create_state_machine_alias_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_sfn.types.create_state_machine_alias_input.CreateStateMachineAliasInput,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSStepFunctions.CreateStateMachineAlias"
    import aws_sdk_sfn.types.create_state_machine_alias_input

    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.create_state_machine_alias_input.serialize_aws_json_1_0(input)
    ).encode()
...
async def async_create_state_machine_alias(
