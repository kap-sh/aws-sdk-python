...
def build_request(
    ...
    input_: aws_sdk_sfn.types.create_state_machine_alias_input.CreateStateMachineAliasInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.create_state_machine_alias_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
