...
def build_request(
    ...
    input: aws_sdk_sfn.types.describe_state_machine_input.DescribeStateMachineInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.describe_state_machine_input.serialize_aws_json_1_0(input)
    ).encode()
