"""Generated from Smithy shape ``com.amazonaws.sfn#DescribeStateMachine``."""
...
def handle_response(
    ...
    out: aws_sdk_sfn.types.describe_state_machine_output.DescribeStateMachineOutput = (
        aws_sdk_sfn.types.describe_state_machine_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.describe_state_machine_input.DescribeStateMachineInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.describe_state_machine_input.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_describe_state_machine(
