...
def handle_response(
    ...
    out: aws_sdk_sfn.types.publish_state_machine_version_output.PublishStateMachineVersionOutput = aws_sdk_sfn.types.publish_state_machine_version_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.publish_state_machine_version_input.PublishStateMachineVersionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.publish_state_machine_version_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
