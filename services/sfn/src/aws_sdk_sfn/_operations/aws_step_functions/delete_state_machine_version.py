"""Generated from Smithy shape ``com.amazonaws.sfn#DeleteStateMachineVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_sfn.types.delete_state_machine_version_output.DeleteStateMachineVersionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.delete_state_machine_version_input.DeleteStateMachineVersionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSStepFunctions.DeleteStateMachineVersion"
    import aws_sdk_sfn.types.delete_state_machine_version_input

    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.delete_state_machine_version_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_state_machine_version(
