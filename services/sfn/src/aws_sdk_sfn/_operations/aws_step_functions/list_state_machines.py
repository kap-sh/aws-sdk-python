...
def handle_response(
    ...
    out: aws_sdk_sfn.types.list_state_machines_output.ListStateMachinesOutput = (
        aws_sdk_sfn.types.list_state_machines_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.list_state_machines_input.ListStateMachinesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.list_state_machines_input.serialize_aws_json_1_0(input_)
    ).encode()
