"""Generated from Smithy shape ``com.amazonaws.sfn#ListStateMachineAliases``."""
...
def handle_response(
    ...
    out: aws_sdk_sfn.types.list_state_machine_aliases_output.ListStateMachineAliasesOutput = aws_sdk_sfn.types.list_state_machine_aliases_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_sfn.types.list_state_machine_aliases_input.ListStateMachineAliasesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.list_state_machine_aliases_input.serialize_aws_json_1_0(input)
    ).encode()
...
async def async_list_state_machine_aliases(
