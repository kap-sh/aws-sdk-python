"""Generated from Smithy shape ``com.amazonaws.sfn#DeleteStateMachine``."""
...
def handle_response(
    ...
    out: aws_sdk_sfn.types.delete_state_machine_output.DeleteStateMachineOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.delete_state_machine_input.DeleteStateMachineInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.delete_state_machine_input.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_delete_state_machine(
