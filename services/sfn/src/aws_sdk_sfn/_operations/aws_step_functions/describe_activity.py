"""Generated from Smithy shape ``com.amazonaws.sfn#DescribeActivity``."""
...
def handle_response(
    ...
    out: aws_sdk_sfn.types.describe_activity_output.DescribeActivityOutput = (
        aws_sdk_sfn.types.describe_activity_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.describe_activity_input.DescribeActivityInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.describe_activity_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def describe_activity(
    ...
    aws_sdk_sfn.types.describe_activity_output.DescribeActivityOutput, zapros.Response
]:
...
async def async_describe_activity(
