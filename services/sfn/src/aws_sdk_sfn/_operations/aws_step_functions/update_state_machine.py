...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MissingRequiredParameter":
            import aws_sdk_sfn.errors.missing_required_parameter

            raise aws_sdk_sfn.errors.missing_required_parameter.MissingRequiredParameter.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_sfn.types.update_state_machine_output.UpdateStateMachineOutput = (
        aws_sdk_sfn.types.update_state_machine_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.update_state_machine_input.UpdateStateMachineInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.update_state_machine_input.serialize_aws_json_1_0(input_)
    ).encode()
