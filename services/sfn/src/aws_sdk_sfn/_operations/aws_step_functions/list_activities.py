"""Generated from Smithy shape ``com.amazonaws.sfn#ListActivities``."""
...
import aws_sdk_sfn.types.activity_list
...
def handle_response(
    ...
    out: aws_sdk_sfn.types.list_activities_output.ListActivitiesOutput = (
        aws_sdk_sfn.types.list_activities_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.list_activities_input.ListActivitiesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.list_activities_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_activities(
    ...
    aws_sdk_sfn.types.list_activities_output.ListActivitiesOutput, zapros.Response
]:
