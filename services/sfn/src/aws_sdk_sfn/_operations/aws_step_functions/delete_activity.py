...
def handle_response(
    ...
    out: aws_sdk_sfn.types.delete_activity_output.DeleteActivityOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.delete_activity_input.DeleteActivityInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.delete_activity_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def delete_activity(
    ...
    aws_sdk_sfn.types.delete_activity_output.DeleteActivityOutput, zapros.Response
]:
