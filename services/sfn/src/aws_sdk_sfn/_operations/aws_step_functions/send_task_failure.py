...
def handle_response(
    ...
    out: aws_sdk_sfn.types.send_task_failure_output.SendTaskFailureOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_sfn.types.send_task_failure_input.SendTaskFailureInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.send_task_failure_input.serialize_aws_json_1_0(input)
    ).encode()
...
def send_task_failure(
    ...
    aws_sdk_sfn.types.send_task_failure_output.SendTaskFailureOutput, zapros.Response
]:
