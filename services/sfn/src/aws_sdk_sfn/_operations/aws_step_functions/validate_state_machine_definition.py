...
def handle_response(
    ...
    out: aws_sdk_sfn.types.validate_state_machine_definition_output.ValidateStateMachineDefinitionOutput = aws_sdk_sfn.types.validate_state_machine_definition_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.validate_state_machine_definition_input.ValidateStateMachineDefinitionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.validate_state_machine_definition_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
