"""Generated from Smithy shape ``com.amazonaws.sfn#DescribeExecution``."""
...
def handle_response(
    ...
    out: aws_sdk_sfn.types.describe_execution_output.DescribeExecutionOutput = (
        aws_sdk_sfn.types.describe_execution_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.describe_execution_input.DescribeExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.describe_execution_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def describe_execution(
    ...
    aws_sdk_sfn.types.describe_execution_output.DescribeExecutionOutput, zapros.Response
]:
