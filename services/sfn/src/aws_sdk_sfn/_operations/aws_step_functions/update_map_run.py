"""Generated from Smithy shape ``com.amazonaws.sfn#UpdateMapRun``."""
...
def handle_response(
    ...
    out: aws_sdk_sfn.types.update_map_run_output.UpdateMapRunOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.update_map_run_input.UpdateMapRunInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSStepFunctions.UpdateMapRun"
    import aws_sdk_sfn.types.update_map_run_input

    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.update_map_run_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def update_map_run(
    ...
    input_: aws_sdk_sfn.types.update_map_run_input.UpdateMapRunInput,
) -> tuple[aws_sdk_sfn.types.update_map_run_output.UpdateMapRunOutput, zapros.Response]:
...
async def async_update_map_run(
