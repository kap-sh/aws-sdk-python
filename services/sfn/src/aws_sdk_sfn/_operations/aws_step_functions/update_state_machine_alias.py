"""Generated from Smithy shape ``com.amazonaws.sfn#UpdateStateMachineAlias``."""
...
def handle_response(
    ...
    out: aws_sdk_sfn.types.update_state_machine_alias_output.UpdateStateMachineAliasOutput = aws_sdk_sfn.types.update_state_machine_alias_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_sfn.types.update_state_machine_alias_input.UpdateStateMachineAliasInput,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSStepFunctions.UpdateStateMachineAlias"
    import aws_sdk_sfn.types.update_state_machine_alias_input

    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.update_state_machine_alias_input.serialize_aws_json_1_0(input)
    ).encode()
...
async def async_update_state_machine_alias(
