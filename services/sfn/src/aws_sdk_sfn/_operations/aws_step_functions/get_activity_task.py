...
import aws_sdk_sfn.errors.activity_does_not_exist
import aws_sdk_sfn.errors.activity_worker_limit_exceeded
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ActivityDoesNotExist":
            raise aws_sdk_sfn.errors.activity_does_not_exist.ActivityDoesNotExist.from_aws_json_1_0(
                data
            )
        case "ActivityWorkerLimitExceeded":
            raise aws_sdk_sfn.errors.activity_worker_limit_exceeded.ActivityWorkerLimitExceeded.from_aws_json_1_0(
                data
            )
        case "InvalidArn":
...
def handle_response(
    ...
    out: aws_sdk_sfn.types.get_activity_task_output.GetActivityTaskOutput = (
        aws_sdk_sfn.types.get_activity_task_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.get_activity_task_input.GetActivityTaskInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.get_activity_task_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_activity_task(
    ...
    aws_sdk_sfn.types.get_activity_task_output.GetActivityTaskOutput, zapros.Response
]:
