...
def handle_response(
    ...
    out: aws_sdk_sfn.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.untag_resource_input.UntagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.untag_resource_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def untag_resource(
    ...
    aws_sdk_sfn.types.untag_resource_output.UntagResourceOutput, zapros.Response
]:
