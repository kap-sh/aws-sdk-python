...
def build_request(
    ...
    input: aws_sdk_sfn.types.get_execution_history_input.GetExecutionHistoryInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.get_execution_history_input.serialize_aws_json_1_0(input)
    ).encode()
