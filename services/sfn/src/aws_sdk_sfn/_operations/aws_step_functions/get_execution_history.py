"""Generated from Smithy shape ``com.amazonaws.sfn#GetExecutionHistory``."""
...
def handle_response(
    ...
    out: aws_sdk_sfn.types.get_execution_history_output.GetExecutionHistoryOutput = (
        aws_sdk_sfn.types.get_execution_history_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.get_execution_history_input.GetExecutionHistoryInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.get_execution_history_input.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_get_execution_history(
