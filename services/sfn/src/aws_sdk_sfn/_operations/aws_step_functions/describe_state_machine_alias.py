...
def handle_response(
    ...
    out: aws_sdk_sfn.types.describe_state_machine_alias_output.DescribeStateMachineAliasOutput = aws_sdk_sfn.types.describe_state_machine_alias_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.describe_state_machine_alias_input.DescribeStateMachineAliasInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.describe_state_machine_alias_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
