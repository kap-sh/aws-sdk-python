...
def handle_response(
    ...
    out: aws_sdk_sfn.types.list_map_runs_output.ListMapRunsOutput = (
        aws_sdk_sfn.types.list_map_runs_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.list_map_runs_input.ListMapRunsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.list_map_runs_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_map_runs(
    ...
    input_: aws_sdk_sfn.types.list_map_runs_input.ListMapRunsInput,
) -> tuple[aws_sdk_sfn.types.list_map_runs_output.ListMapRunsOutput, zapros.Response]:
