...
def build_request(
    ...
    input_: aws_sdk_sfn.types.send_task_success_input.SendTaskSuccessInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.send_task_success_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def send_task_success(
    ...
    aws_sdk_sfn.types.send_task_success_output.SendTaskSuccessOutput, zapros.Response
]:
