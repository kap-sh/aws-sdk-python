...
def handle_response(
    ...
    out: aws_sdk_sfn.types.delete_state_machine_alias_output.DeleteStateMachineAliasOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_sfn.types.delete_state_machine_alias_input.DeleteStateMachineAliasInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.delete_state_machine_alias_input.serialize_aws_json_1_0(input)
    ).encode()
