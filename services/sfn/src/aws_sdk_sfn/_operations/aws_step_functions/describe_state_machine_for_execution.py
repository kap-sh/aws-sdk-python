"""Generated from Smithy shape ``com.amazonaws.sfn#DescribeStateMachineForExecution``."""
...
def handle_response(
    ...
    out: aws_sdk_sfn.types.describe_state_machine_for_execution_output.DescribeStateMachineForExecutionOutput = aws_sdk_sfn.types.describe_state_machine_for_execution_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.describe_state_machine_for_execution_input.DescribeStateMachineForExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.describe_state_machine_for_execution_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_describe_state_machine_for_execution(
