...
def handle_response(
    ...
    out: aws_sdk_sfn.types.test_state_output.TestStateOutput = (
        aws_sdk_sfn.types.test_state_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.test_state_input.TestStateInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.test_state_input.serialize_aws_json_1_0(input_)
    ).encode()
...
def test_state(
    options: OperationOptions, input_: aws_sdk_sfn.types.test_state_input.TestStateInput
) -> tuple[aws_sdk_sfn.types.test_state_output.TestStateOutput, zapros.Response]:
