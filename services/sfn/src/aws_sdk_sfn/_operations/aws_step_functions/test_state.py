...
def build_request(
    ...
    input: aws_sdk_sfn.types.test_state_input.TestStateInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.test_state_input.serialize_aws_json_1_0(input)
    ).encode()
...
def test_state(
    options: OperationOptions, input: aws_sdk_sfn.types.test_state_input.TestStateInput
