...
def handle_response(
    ...
    out: aws_sdk_sfn.types.send_task_heartbeat_output.SendTaskHeartbeatOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.send_task_heartbeat_input.SendTaskHeartbeatInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.send_task_heartbeat_input.serialize_aws_json_1_0(input_)
    ).encode()
