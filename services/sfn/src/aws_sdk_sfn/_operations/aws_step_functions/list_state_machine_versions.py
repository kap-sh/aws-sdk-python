"""Generated from Smithy shape ``com.amazonaws.sfn#ListStateMachineVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_sfn.types.list_state_machine_versions_output.ListStateMachineVersionsOutput = aws_sdk_sfn.types.list_state_machine_versions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_sfn.types.list_state_machine_versions_input.ListStateMachineVersionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_sfn.types.list_state_machine_versions_input.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_state_machine_versions(
