"""Generated from Smithy shape ``com.amazonaws.sfn#LambdaFunctionStartFailedEventDetails``."""
...
class LambdaFunctionStartFailedEventDetails(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: LambdaFunctionStartFailedEventDetails) -> dict:
    out: dict = {}
    if "error" in value:
