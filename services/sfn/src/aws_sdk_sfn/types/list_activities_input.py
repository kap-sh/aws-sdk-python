...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListActivitiesInput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> ListActivitiesInput:
    out: ListActivitiesInput = {}  # type: ignore[typeddict-item]
