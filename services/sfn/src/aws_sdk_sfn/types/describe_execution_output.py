...
if TYPE_CHECKING:
    ...
    import aws_sdk_sfn.types.execution_redrive_status
...
class DescribeExecutionOutput(TypedDict, closed=True):
    ...
    redrive_status: NotRequired[
        "aws_sdk_sfn.types.execution_redrive_status.ExecutionRedriveStatus"
    ]
    ...
    redrive_status_reason: NotRequired["aws_sdk_sfn.types.sensitive_data.SensitiveData"]
...
def serialize_aws_json_1_0(value: DescribeExecutionOutput) -> dict:
    ...
    if "redrive_status" in value:
        ...
        out["redriveStatus"] = (
            aws_sdk_sfn.types.execution_redrive_status.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DescribeExecutionOutput:
    ...
    if "redriveStatus" in data:
        ...
        out["redrive_status"] = (
            aws_sdk_sfn.types.execution_redrive_status.deserialize_aws_json_1_0(
                data["redriveStatus"]
            )
        )
