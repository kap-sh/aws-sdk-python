...
if TYPE_CHECKING:
    ...
    import aws_sdk_sfn.types.log_destination_list
...
class LoggingConfiguration(TypedDict, closed=True):
    ...
    include_execution_data: (
        "aws_sdk_sfn.types.include_execution_data.IncludeExecutionData"
    )
    """<p>Determines whether execution data is included in your log. When set to <code>false</code>, data is excluded.</p>"""
    destinations: NotRequired[
        "aws_sdk_sfn.types.log_destination_list.LogDestinationList"
    ]
...
def serialize_aws_json_1_0(value: LoggingConfiguration) -> dict:
    ...
    if "level" in value:
        ...
        out["level"] = aws_sdk_sfn.types.log_level.serialize_aws_json_1_0(
            value["level"]
        )
    ...
    if "destinations" in value:
        ...
        out["destinations"] = (
            aws_sdk_sfn.types.log_destination_list.serialize_aws_json_1_0(
                value["destinations"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> LoggingConfiguration:
    ...
    if "level" in data:
        ...
        out["level"] = aws_sdk_sfn.types.log_level.deserialize_aws_json_1_0(
            data["level"]
        )
    ...
    if "destinations" in data:
        ...
        out["destinations"] = (
            aws_sdk_sfn.types.log_destination_list.deserialize_aws_json_1_0(
                data["destinations"]
            )
        )
    return out
