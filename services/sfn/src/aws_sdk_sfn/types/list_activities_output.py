...
class ListActivitiesOutput(TypedDict):
    activities: "aws_sdk_sfn.types.activity_list.ActivityList"
...
def serialize_aws_json_1_0(value: ListActivitiesOutput) -> dict:
    ...
    out["activities"] = aws_sdk_sfn.types.activity_list.serialize_aws_json_1_0(
        value["activities"]
    )
...
def deserialize_aws_json_1_0(data: dict) -> ListActivitiesOutput:
    ...
    if "activities" in data:
        ...
        out["activities"] = aws_sdk_sfn.types.activity_list.deserialize_aws_json_1_0(
            data["activities"]
        )
    else:
