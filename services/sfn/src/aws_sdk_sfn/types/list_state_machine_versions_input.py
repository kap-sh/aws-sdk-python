"""Generated from Smithy shape ``com.amazonaws.sfn#ListStateMachineVersionsInput``."""
...
class ListStateMachineVersionsInput(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListStateMachineVersionsInput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> ListStateMachineVersionsInput:
    out: ListStateMachineVersionsInput = {}  # type: ignore[typeddict-item]
    if "stateMachineArn" in data:
        out["state_machine_arn"] = data["stateMachineArn"]
    else:
        raise DeserializationError(
            "ListStateMachineVersionsInput.state_machine_arn required"
        )
