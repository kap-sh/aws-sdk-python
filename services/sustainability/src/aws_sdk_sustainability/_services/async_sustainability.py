...
from aws_sdk_sustainability._services._aws_config import aaws_config
...
class AsyncSustainabilityClientConfig(TypedDict, total=False):
...
class AsyncSustainabilityClient:
    ...
    async def get_estimated_carbon_emissions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sustainability.types.get_estimated_carbon_emissions_request.GetEstimatedCarbonEmissionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sustainability.types.get_estimated_carbon_emissions_response.GetEstimatedCarbonEmissionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sustainability._operations.aws_sustainability_api_service.get_estimated_carbon_emissions.async_get_estimated_carbon_emissions(
    ...
    ) -> "AsyncIterator[aws_sdk_sustainability.types.estimated_carbon_emissions.EstimatedCarbonEmissions]":
        _token = next_token
        while True:
    ...
    async def get_estimated_carbon_emissions_dimension_values(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_sustainability.types.get_estimated_carbon_emissions_dimension_values_request.GetEstimatedCarbonEmissionsDimensionValuesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_sustainability.types.get_estimated_carbon_emissions_dimension_values_response.GetEstimatedCarbonEmissionsDimensionValuesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_sustainability._operations.aws_sustainability_api_service.get_estimated_carbon_emissions_dimension_values.async_get_estimated_carbon_emissions_dimension_values(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_sustainability.types.dimension_entry.DimensionEntry]":
        _token = next_token
        while True:
