...
class GetEstimatedCarbonEmissionsRequest(TypedDict):
    ...
    group_by: NotRequired["aws_sdk_sustainability.types.dimension_list.DimensionList"]
    ...
    granularity: "aws_sdk_sustainability.types.time_granularity.TimeGranularity"
...
def serialize_json(value: GetEstimatedCarbonEmissionsRequest) -> dict:
    ...
    if "group_by" in value:
        ...
        out["GroupBy"] = aws_sdk_sustainability.types.dimension_list.serialize_json(
            value["group_by"]
        )
    if "filter_by" in value:
        import aws_sdk_sustainability.types.filter_expression

        out["FilterBy"] = aws_sdk_sustainability.types.filter_expression.serialize_json(
            value["filter_by"]
        )
    if "emissions_types" in value:
        ...
        out["EmissionsTypes"] = (
            aws_sdk_sustainability.types.emissions_type_list.serialize_json(
                value["emissions_types"]
            )
        )
    import aws_sdk_sustainability.types.time_granularity

    out["Granularity"] = aws_sdk_sustainability.types.time_granularity.serialize_json(
    ...
    if "granularity_configuration" in value:
        ...
        out["GranularityConfiguration"] = (
            aws_sdk_sustainability.types.granularity_configuration.serialize_json(
...
def deserialize_json(data: dict) -> GetEstimatedCarbonEmissionsRequest:
    ...
    if "GroupBy" in data:
        ...
        out["group_by"] = aws_sdk_sustainability.types.dimension_list.deserialize_json(
            data["GroupBy"]
        )
    if "FilterBy" in data:
        import aws_sdk_sustainability.types.filter_expression
        ...
        out["filter_by"] = (
            aws_sdk_sustainability.types.filter_expression.deserialize_json(
                data["FilterBy"]
            )
        )
    if "EmissionsTypes" in data:
        ...
        out["emissions_types"] = (
            aws_sdk_sustainability.types.emissions_type_list.deserialize_json(
                data["EmissionsTypes"]
            )
        )
    if "Granularity" in data:
        ...
        out["granularity"] = (
            aws_sdk_sustainability.types.time_granularity.deserialize_json(
                data["Granularity"]
            )
        )
    else:
    ...
    if "GranularityConfiguration" in data:
        ...
        out["granularity_configuration"] = (
            aws_sdk_sustainability.types.granularity_configuration.deserialize_json(
