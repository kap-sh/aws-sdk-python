...
class SustainabilityError(Exception):
    """Base class for all Sustainability service errors."""


class ServiceError(SustainabilityError):
...
class DeserializationError(SustainabilityError):
...
class WaiterFailedError(SustainabilityError):
...
class WaiterTimeoutError(SustainabilityError):
