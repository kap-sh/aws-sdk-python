...
from capo_sustainability._services._aws_config import aws_config
...
class SustainabilityClient:
    ...
    def get_estimated_carbon_emissions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sustainability.types.get_estimated_carbon_emissions_request.GetEstimatedCarbonEmissionsRequest]",
        ) -> OperationResponse[
            "capo_sustainability.types.get_estimated_carbon_emissions_response.GetEstimatedCarbonEmissionsResponse"
        ]:
            ...
            output, http_response = (
                capo_sustainability._operations.aws_sustainability_api_service.get_estimated_carbon_emissions.get_estimated_carbon_emissions(
    ...
    def iter_get_estimated_carbon_emissions(
        ...
        *,
        ...
        next_token: Optional["capo_sustainability.types.next_token.NextToken"] = None,
    ) -> "Iterator[capo_sustainability.types.estimated_carbon_emissions.EstimatedCarbonEmissions]":
        _token = next_token
        while True:
    ...
    def get_estimated_carbon_emissions_dimension_values(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_sustainability.types.get_estimated_carbon_emissions_dimension_values_request.GetEstimatedCarbonEmissionsDimensionValuesRequest]",
        ) -> OperationResponse[
            "capo_sustainability.types.get_estimated_carbon_emissions_dimension_values_response.GetEstimatedCarbonEmissionsDimensionValuesResponse"
        ]:
            ...
            output, http_response = (
                capo_sustainability._operations.aws_sustainability_api_service.get_estimated_carbon_emissions_dimension_values.get_estimated_carbon_emissions_dimension_values(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
