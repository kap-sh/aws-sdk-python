...
```
pip install aws-sdk-sustainability
```

## Usage

```python
from aws_sdk_sustainability import AsyncSustainabilityClient
...
```python
from aws_sdk_sustainability import AsyncSustainabilityClient
from aws_sdk_sustainability.error import AccessDeniedException
