...
from aws_sdk_voice_id._services._aws_config import aws_config
...
class VoiceIDClientConfig(TypedDict, total=False):
...
class VoiceIDClient:
    ...
    def associate_fraudster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.associate_fraudster_request.AssociateFraudsterRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.associate_fraudster_response.AssociateFraudsterResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.associate_fraudster.associate_fraudster(
    ...
    def create_watchlist(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.create_watchlist_request.CreateWatchlistRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.create_watchlist_response.CreateWatchlistResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.create_watchlist.create_watchlist(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_fraudster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.delete_fraudster_request.DeleteFraudsterRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_voice_id._operations.voice_id.delete_fraudster

            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.delete_fraudster.delete_fraudster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_speaker(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.delete_speaker_request.DeleteSpeakerRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_voice_id._operations.voice_id.delete_speaker

            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.delete_speaker.delete_speaker(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_watchlist(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.delete_watchlist_request.DeleteWatchlistRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_voice_id._operations.voice_id.delete_watchlist

            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.delete_watchlist.delete_watchlist(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_fraudster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.describe_fraudster_request.DescribeFraudsterRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.describe_fraudster_response.DescribeFraudsterResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.describe_fraudster.describe_fraudster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_fraudster_registration_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.describe_fraudster_registration_job_request.DescribeFraudsterRegistrationJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.describe_fraudster_registration_job_response.DescribeFraudsterRegistrationJobResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.describe_fraudster_registration_job.describe_fraudster_registration_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_speaker(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.describe_speaker_request.DescribeSpeakerRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.describe_speaker_response.DescribeSpeakerResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.describe_speaker.describe_speaker(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_speaker_enrollment_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.describe_speaker_enrollment_job_request.DescribeSpeakerEnrollmentJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.describe_speaker_enrollment_job_response.DescribeSpeakerEnrollmentJobResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.describe_speaker_enrollment_job.describe_speaker_enrollment_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_watchlist(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.describe_watchlist_request.DescribeWatchlistRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.describe_watchlist_response.DescribeWatchlistResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.describe_watchlist.describe_watchlist(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_fraudster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.disassociate_fraudster_request.DisassociateFraudsterRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.disassociate_fraudster_response.DisassociateFraudsterResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.disassociate_fraudster.disassociate_fraudster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def evaluate_session(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.evaluate_session_request.EvaluateSessionRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.evaluate_session_response.EvaluateSessionResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.evaluate_session.evaluate_session(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_fraudster_registration_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.list_fraudster_registration_jobs_request.ListFraudsterRegistrationJobsRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.list_fraudster_registration_jobs_response.ListFraudsterRegistrationJobsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.list_fraudster_registration_jobs.list_fraudster_registration_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_fraudster_registration_jobs(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_voice_id.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_voice_id.types.fraudster_registration_job_summary.FraudsterRegistrationJobSummary]":
        _token = next_token
        while True:
    ...
    def list_fraudsters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.list_fraudsters_request.ListFraudstersRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.list_fraudsters_response.ListFraudstersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.list_fraudsters.list_fraudsters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_fraudsters(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_voice_id.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_voice_id.types.fraudster_summary.FraudsterSummary]":
        _token = next_token
        while True:
    ...
    def list_speaker_enrollment_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.list_speaker_enrollment_jobs_request.ListSpeakerEnrollmentJobsRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.list_speaker_enrollment_jobs_response.ListSpeakerEnrollmentJobsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.list_speaker_enrollment_jobs.list_speaker_enrollment_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_speaker_enrollment_jobs(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_voice_id.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_voice_id.types.speaker_enrollment_job_summary.SpeakerEnrollmentJobSummary]":
        _token = next_token
        while True:
    ...
    def list_speakers(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.list_speakers_request.ListSpeakersRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.list_speakers_response.ListSpeakersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.list_speakers.list_speakers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_speakers(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_voice_id.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_voice_id.types.speaker_summary.SpeakerSummary]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_watchlists(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.list_watchlists_request.ListWatchlistsRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.list_watchlists_response.ListWatchlistsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.list_watchlists.list_watchlists(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_watchlists(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_voice_id.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_voice_id.types.watchlist_summary.WatchlistSummary]":
        _token = next_token
        while True:
    ...
    def opt_out_speaker(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.opt_out_speaker_request.OptOutSpeakerRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.opt_out_speaker_response.OptOutSpeakerResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.opt_out_speaker.opt_out_speaker(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_fraudster_registration_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.start_fraudster_registration_job_request.StartFraudsterRegistrationJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.start_fraudster_registration_job_response.StartFraudsterRegistrationJobResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.start_fraudster_registration_job.start_fraudster_registration_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_speaker_enrollment_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.start_speaker_enrollment_job_request.StartSpeakerEnrollmentJobRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.start_speaker_enrollment_job_response.StartSpeakerEnrollmentJobResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.start_speaker_enrollment_job.start_speaker_enrollment_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_watchlist(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_voice_id.types.update_watchlist_request.UpdateWatchlistRequest]",
        ) -> OperationResponse[
            "aws_sdk_voice_id.types.update_watchlist_response.UpdateWatchlistResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_voice_id._operations.voice_id.update_watchlist.update_watchlist(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
