"""Generated from Smithy shape ``com.amazonaws.voiceid#ListSpeakersRequest``."""
...
class ListSpeakersRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListSpeakersRequest) -> dict:
    out: dict = {}
