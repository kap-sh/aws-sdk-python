...
if TYPE_CHECKING:
    import aws_sdk_voice_id.types.speaker_summaries
    import aws_sdk_voice_id.types.string


class ListSpeakersResponse(TypedDict):
    speaker_summaries: NotRequired[
        "aws_sdk_voice_id.types.speaker_summaries.SpeakerSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListSpeakersResponse) -> dict:
    ...
    if "speaker_summaries" in value:
        ...
        out["SpeakerSummaries"] = (
            aws_sdk_voice_id.types.speaker_summaries.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListSpeakersResponse:
    ...
    if "SpeakerSummaries" in data:
        ...
        out["speaker_summaries"] = (
            aws_sdk_voice_id.types.speaker_summaries.deserialize_aws_json_1_0(
