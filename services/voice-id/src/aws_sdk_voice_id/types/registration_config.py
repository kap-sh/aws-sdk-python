...
if TYPE_CHECKING:
    import aws_sdk_voice_id.types.duplicate_registration_action
    import aws_sdk_voice_id.types.registration_config_watchlist_ids
    import aws_sdk_voice_id.types.score


class RegistrationConfig(TypedDict):
    duplicate_registration_action: NotRequired[
        "aws_sdk_voice_id.types.duplicate_registration_action.DuplicateRegistrationAction"
    ]
    ...
    fraudster_similarity_threshold: NotRequired["aws_sdk_voice_id.types.score.Score"]
    ...
    watchlist_ids: NotRequired[
        "aws_sdk_voice_id.types.registration_config_watchlist_ids.RegistrationConfigWatchlistIds"
    ]
...
def serialize_aws_json_1_0(value: RegistrationConfig) -> dict:
    ...
    if "watchlist_ids" in value:
        ...
        out["WatchlistIds"] = (
            aws_sdk_voice_id.types.registration_config_watchlist_ids.serialize_aws_json_1_0(
                value["watchlist_ids"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> RegistrationConfig:
    ...
    if "WatchlistIds" in data:
        ...
        out["watchlist_ids"] = (
            aws_sdk_voice_id.types.registration_config_watchlist_ids.deserialize_aws_json_1_0(
                data["WatchlistIds"]
            )
        )
    return out
