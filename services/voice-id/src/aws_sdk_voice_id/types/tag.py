...
if TYPE_CHECKING:
    import aws_sdk_voice_id.types.tag_key
    import aws_sdk_voice_id.types.tag_value


class Tag(TypedDict):
    key: "aws_sdk_voice_id.types.tag_key.TagKey"
    ...
    value: "aws_sdk_voice_id.types.tag_value.TagValue"
