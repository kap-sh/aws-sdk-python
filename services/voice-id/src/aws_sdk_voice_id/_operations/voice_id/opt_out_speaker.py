"""Generated from Smithy shape ``com.amazonaws.voiceid#OptOutSpeaker``."""
...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.opt_out_speaker_response.OptOutSpeakerResponse = (
        aws_sdk_voice_id.types.opt_out_speaker_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.opt_out_speaker_request.OptOutSpeakerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "VoiceID.OptOutSpeaker"
    import aws_sdk_voice_id.types.opt_out_speaker_request

    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.opt_out_speaker_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_opt_out_speaker(
