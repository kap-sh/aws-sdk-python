...
def build_request(
    ...
    input: aws_sdk_voice_id.types.delete_fraudster_request.DeleteFraudsterRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.delete_fraudster_request.serialize_aws_json_1_0(input)
    ).encode()
