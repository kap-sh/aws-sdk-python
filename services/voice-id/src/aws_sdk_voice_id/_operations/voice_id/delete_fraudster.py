...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.delete_fraudster_request.DeleteFraudsterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.delete_fraudster_request.serialize_aws_json_1_0(input_)
    ).encode()
