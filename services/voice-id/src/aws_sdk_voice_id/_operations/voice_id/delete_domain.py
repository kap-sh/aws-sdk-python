"""Generated from Smithy shape ``com.amazonaws.voiceid#DeleteDomain``."""
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.delete_domain_request.DeleteDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "VoiceID.DeleteDomain"
    import aws_sdk_voice_id.types.delete_domain_request

    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.delete_domain_request.serialize_aws_json_1_0(input_)
    ).encode()
