...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.list_speaker_enrollment_jobs_response.ListSpeakerEnrollmentJobsResponse = aws_sdk_voice_id.types.list_speaker_enrollment_jobs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.list_speaker_enrollment_jobs_request.ListSpeakerEnrollmentJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.list_speaker_enrollment_jobs_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
