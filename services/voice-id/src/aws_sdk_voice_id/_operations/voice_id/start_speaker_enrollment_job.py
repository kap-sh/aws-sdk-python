...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.start_speaker_enrollment_job_response.StartSpeakerEnrollmentJobResponse = aws_sdk_voice_id.types.start_speaker_enrollment_job_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.start_speaker_enrollment_job_request.StartSpeakerEnrollmentJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.start_speaker_enrollment_job_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
