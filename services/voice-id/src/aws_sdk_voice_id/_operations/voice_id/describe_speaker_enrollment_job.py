...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.describe_speaker_enrollment_job_response.DescribeSpeakerEnrollmentJobResponse = aws_sdk_voice_id.types.describe_speaker_enrollment_job_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.describe_speaker_enrollment_job_request.DescribeSpeakerEnrollmentJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.describe_speaker_enrollment_job_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
