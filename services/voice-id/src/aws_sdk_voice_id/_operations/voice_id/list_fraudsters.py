...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.list_fraudsters_response.ListFraudstersResponse = (
        aws_sdk_voice_id.types.list_fraudsters_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.list_fraudsters_request.ListFraudstersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.list_fraudsters_request.serialize_aws_json_1_0(input_)
    ).encode()
