"""Generated from Smithy shape ``com.amazonaws.voiceid#AssociateFraudster``."""
...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.associate_fraudster_response.AssociateFraudsterResponse = aws_sdk_voice_id.types.associate_fraudster_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_voice_id.types.associate_fraudster_request.AssociateFraudsterRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "VoiceID.AssociateFraudster"
    import aws_sdk_voice_id.types.associate_fraudster_request

    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.associate_fraudster_request.serialize_aws_json_1_0(input)
    ).encode()
...
async def async_associate_fraudster(
