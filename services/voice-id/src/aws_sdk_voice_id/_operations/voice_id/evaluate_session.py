"""Generated from Smithy shape ``com.amazonaws.voiceid#EvaluateSession``."""
...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.evaluate_session_response.EvaluateSessionResponse = (
        aws_sdk_voice_id.types.evaluate_session_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.evaluate_session_request.EvaluateSessionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "VoiceID.EvaluateSession"
    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.evaluate_session_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_evaluate_session(
