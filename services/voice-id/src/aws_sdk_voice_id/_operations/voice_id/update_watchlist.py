"""Generated from Smithy shape ``com.amazonaws.voiceid#UpdateWatchlist``."""
...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.update_watchlist_response.UpdateWatchlistResponse = (
        aws_sdk_voice_id.types.update_watchlist_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.update_watchlist_request.UpdateWatchlistRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "VoiceID.UpdateWatchlist"
    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.update_watchlist_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_update_watchlist(
