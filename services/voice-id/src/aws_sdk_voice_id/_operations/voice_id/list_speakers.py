...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.list_speakers_response.ListSpeakersResponse = (
        aws_sdk_voice_id.types.list_speakers_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.list_speakers_request.ListSpeakersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.list_speakers_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_speakers(
    ...
    aws_sdk_voice_id.types.list_speakers_response.ListSpeakersResponse, zapros.Response
]:
