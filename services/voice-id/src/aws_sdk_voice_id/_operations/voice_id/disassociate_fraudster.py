...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.disassociate_fraudster_response.DisassociateFraudsterResponse = aws_sdk_voice_id.types.disassociate_fraudster_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.disassociate_fraudster_request.DisassociateFraudsterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
