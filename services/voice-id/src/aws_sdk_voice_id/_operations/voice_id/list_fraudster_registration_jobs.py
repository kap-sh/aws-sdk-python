"""Generated from Smithy shape ``com.amazonaws.voiceid#ListFraudsterRegistrationJobs``."""
...
import aws_sdk_voice_id.types.fraudster_registration_job_summaries
...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.list_fraudster_registration_jobs_response.ListFraudsterRegistrationJobsResponse = aws_sdk_voice_id.types.list_fraudster_registration_jobs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.list_fraudster_registration_jobs_request.ListFraudsterRegistrationJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "VoiceID.ListFraudsterRegistrationJobs"
    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.list_fraudster_registration_jobs_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_fraudster_registration_jobs(
