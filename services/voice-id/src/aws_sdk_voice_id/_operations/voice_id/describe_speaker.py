...
def build_request(
    ...
    input: aws_sdk_voice_id.types.describe_speaker_request.DescribeSpeakerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.describe_speaker_request.serialize_aws_json_1_0(input)
    ).encode()
