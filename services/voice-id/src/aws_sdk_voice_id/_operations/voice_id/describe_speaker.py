"""Generated from Smithy shape ``com.amazonaws.voiceid#DescribeSpeaker``."""
...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.describe_speaker_response.DescribeSpeakerResponse = (
        aws_sdk_voice_id.types.describe_speaker_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.describe_speaker_request.DescribeSpeakerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "VoiceID.DescribeSpeaker"
    import aws_sdk_voice_id.types.describe_speaker_request

    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.describe_speaker_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_describe_speaker(
