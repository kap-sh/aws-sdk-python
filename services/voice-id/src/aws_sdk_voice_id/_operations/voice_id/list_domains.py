"""Generated from Smithy shape ``com.amazonaws.voiceid#ListDomains``."""
...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.list_domains_response.ListDomainsResponse = (
        aws_sdk_voice_id.types.list_domains_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.list_domains_request.ListDomainsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "VoiceID.ListDomains"
    import aws_sdk_voice_id.types.list_domains_request

    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.list_domains_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_domains(
    ...
    aws_sdk_voice_id.types.list_domains_response.ListDomainsResponse, zapros.Response
]:
