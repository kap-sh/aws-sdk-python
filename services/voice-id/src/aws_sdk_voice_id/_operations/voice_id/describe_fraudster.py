"""Generated from Smithy shape ``com.amazonaws.voiceid#DescribeFraudster``."""
...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.describe_fraudster_response.DescribeFraudsterResponse = aws_sdk_voice_id.types.describe_fraudster_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.describe_fraudster_request.DescribeFraudsterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "VoiceID.DescribeFraudster"
    import aws_sdk_voice_id.types.describe_fraudster_request

    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.describe_fraudster_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_describe_fraudster(
