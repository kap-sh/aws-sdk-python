"""Generated from Smithy shape ``com.amazonaws.voiceid#StartFraudsterRegistrationJob``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            import aws_sdk_voice_id.errors.service_quota_exceeded_exception

            raise aws_sdk_voice_id.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.start_fraudster_registration_job_response.StartFraudsterRegistrationJobResponse = aws_sdk_voice_id.types.start_fraudster_registration_job_response.deserialize_aws_json_1_0(
...
def get_signer(
...
) -> aws_sdk_voice_id._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_voice_id._auth._sigv4.build_sigv4_auth_scheme(
                "voiceid", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_voice_id._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.start_fraudster_registration_job_request.StartFraudsterRegistrationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "VoiceID.StartFraudsterRegistrationJob"
    import aws_sdk_voice_id.types.start_fraudster_registration_job_request

    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.start_fraudster_registration_job_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_start_fraudster_registration_job(
