"""Generated from Smithy shape ``com.amazonaws.voiceid#ListWatchlists``."""
...
def handle_response(
    ...
    out: aws_sdk_voice_id.types.list_watchlists_response.ListWatchlistsResponse = (
        aws_sdk_voice_id.types.list_watchlists_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_voice_id.types.list_watchlists_request.ListWatchlistsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "VoiceID.ListWatchlists"
    body: bytes | None = json.dumps(
        aws_sdk_voice_id.types.list_watchlists_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_list_watchlists(
