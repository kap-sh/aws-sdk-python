...
if TYPE_CHECKING:
    import capo_voice_id.types.kms_key_id
    import capo_voice_id.types.server_side_encryption_update_status
    import capo_voice_id.types.string


class ServerSideEncryptionUpdateDetails(TypedDict, closed=True):
    old_kms_key_id: NotRequired["capo_voice_id.types.kms_key_id.KmsKeyId"]
    ...
    update_status: NotRequired[
        "capo_voice_id.types.server_side_encryption_update_status.ServerSideEncryptionUpdateStatus"
    ]
