...
if TYPE_CHECKING:
    ...
    import capo_voice_id.types.fraud_detection_decision
    ...
    import capo_voice_id.types.unique_id_large


class FraudDetectionResult(TypedDict, closed=True):
    fraud_detection_result_id: NotRequired[
        "capo_voice_id.types.unique_id_large.UniqueIdLarge"
    ]
    ...
    audio_aggregation_started_at: NotRequired["capo_voice_id.types.timestamp.Timestamp"]
    """<p>A timestamp of when audio aggregation started for this fraud detection result.</p>"""
    audio_aggregation_ended_at: NotRequired["capo_voice_id.types.timestamp.Timestamp"]
    """<p>A timestamp of when audio aggregation ended for this fraud detection result.</p>"""
    configuration: NotRequired[
        "capo_voice_id.types.fraud_detection_configuration.FraudDetectionConfiguration"
    ]
    """<p>The <code>FraudDetectionConfiguration</code> used to generate this fraud detection result.</p>"""
    decision: NotRequired[
        "capo_voice_id.types.fraud_detection_decision.FraudDetectionDecision"
    ]
    ...
    reasons: NotRequired[
        "capo_voice_id.types.fraud_detection_reasons.FraudDetectionReasons"
    ]
    ...
    risk_details: NotRequired["capo_voice_id.types.fraud_risk_details.FraudRiskDetails"]
...
def serialize_aws_json_1_0(value: FraudDetectionResult) -> dict:
    ...
    if "audio_aggregation_started_at" in value:
        ...
        out["AudioAggregationStartedAt"] = (
            capo_voice_id.types.timestamp.serialize_aws_json_1_0(
    ...
    if "configuration" in value:
        ...
        out["Configuration"] = (
            capo_voice_id.types.fraud_detection_configuration.serialize_aws_json_1_0(
                value["configuration"]
            )
        )
    ...
    if "reasons" in value:
        ...
        out["Reasons"] = (
            capo_voice_id.types.fraud_detection_reasons.serialize_aws_json_1_0(
                value["reasons"]
            )
        )
    if "risk_details" in value:
        ...
        out["RiskDetails"] = (
            capo_voice_id.types.fraud_risk_details.serialize_aws_json_1_0(
                value["risk_details"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> FraudDetectionResult:
    ...
    if "Configuration" in data:
        ...
        out["configuration"] = (
            capo_voice_id.types.fraud_detection_configuration.deserialize_aws_json_1_0(
                data["Configuration"]
            )
        )
    if "Decision" in data:
    ...
    if "Reasons" in data:
        ...
        out["reasons"] = (
            capo_voice_id.types.fraud_detection_reasons.deserialize_aws_json_1_0(
                data["Reasons"]
            )
        )
    if "RiskDetails" in data:
        ...
        out["risk_details"] = (
            capo_voice_id.types.fraud_risk_details.deserialize_aws_json_1_0(
                data["RiskDetails"]
            )
        )
    return out
