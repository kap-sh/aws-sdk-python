"""Generated from Smithy shape ``com.amazonaws.voiceid#OptOutSpeakerRequest``."""
...
class OptOutSpeakerRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: OptOutSpeakerRequest) -> dict:
    out: dict = {}
