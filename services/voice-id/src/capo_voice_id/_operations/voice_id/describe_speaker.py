...
def handle_response(
    ...
    out: capo_voice_id.types.describe_speaker_response.DescribeSpeakerResponse = (
        capo_voice_id.types.describe_speaker_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_voice_id.types.describe_speaker_request.serialize_aws_json_1_0(input_)
    ).encode()
