"""Generated from Smithy shape ``com.amazonaws.voiceid#DisassociateFraudster``."""
...
def handle_response(
    ...
    out: capo_voice_id.types.disassociate_fraudster_response.DisassociateFraudsterResponse = capo_voice_id.types.disassociate_fraudster_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_voice_id.types.disassociate_fraudster_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_disassociate_fraudster(
