"""Generated from Smithy shape ``com.amazonaws.voiceid#UpdateDomain``."""
...
def handle_response(
    ...
    out: capo_voice_id.types.update_domain_response.UpdateDomainResponse = (
        capo_voice_id.types.update_domain_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VoiceID.UpdateDomain"
    body: bytes | None = json.dumps(
        capo_voice_id.types.update_domain_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def update_domain(
    ...
    capo_voice_id.types.update_domain_response.UpdateDomainResponse, zapros.Response
]:
