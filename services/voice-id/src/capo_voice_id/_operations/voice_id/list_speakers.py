"""Generated from Smithy shape ``com.amazonaws.voiceid#ListSpeakers``."""
...
def handle_response(
    ...
    out: capo_voice_id.types.list_speakers_response.ListSpeakersResponse = (
        capo_voice_id.types.list_speakers_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VoiceID.ListSpeakers"
    body: bytes | None = json.dumps(
        capo_voice_id.types.list_speakers_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_speakers(
    ...
    capo_voice_id.types.list_speakers_response.ListSpeakersResponse, zapros.Response
]:
