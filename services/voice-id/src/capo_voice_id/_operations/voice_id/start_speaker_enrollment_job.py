"""Generated from Smithy shape ``com.amazonaws.voiceid#StartSpeakerEnrollmentJob``."""
...
def handle_response(
    ...
    out: capo_voice_id.types.start_speaker_enrollment_job_response.StartSpeakerEnrollmentJobResponse = capo_voice_id.types.start_speaker_enrollment_job_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VoiceID.StartSpeakerEnrollmentJob"
    body: bytes | None = json.dumps(
        capo_voice_id.types.start_speaker_enrollment_job_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_start_speaker_enrollment_job(
