...
def handle_response(
    ...
    out: capo_voice_id.types.associate_fraudster_response.AssociateFraudsterResponse = (
        capo_voice_id.types.associate_fraudster_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_voice_id.types.associate_fraudster_request.serialize_aws_json_1_0(input_)
    ).encode()
