"""Generated from Smithy shape ``com.amazonaws.voiceid#ListFraudsters``."""
...
def handle_response(
    ...
    out: capo_voice_id.types.list_fraudsters_response.ListFraudstersResponse = (
        capo_voice_id.types.list_fraudsters_response.deserialize_aws_json_1_0(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_voice_id._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VoiceID.ListFraudsters"
    body: bytes | None = json.dumps(
        capo_voice_id.types.list_fraudsters_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_fraudsters(
    ...
    capo_voice_id.types.list_fraudsters_response.ListFraudstersResponse, zapros.Response
]:
...
async def async_list_fraudsters(
