"""Generated from Smithy shape ``com.amazonaws.voiceid#UntagResource``."""
...
def handle_response(
    ...
    out: capo_voice_id.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VoiceID.UntagResource"
    body: bytes | None = json.dumps(
        capo_voice_id.types.untag_resource_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def untag_resource(
    ...
    capo_voice_id.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
