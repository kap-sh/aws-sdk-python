"""Generated from Smithy shape ``com.amazonaws.voiceid#DescribeWatchlist``."""
...
def handle_response(
    ...
    out: capo_voice_id.types.describe_watchlist_response.DescribeWatchlistResponse = (
        capo_voice_id.types.describe_watchlist_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VoiceID.DescribeWatchlist"
    body: bytes | None = json.dumps(
        capo_voice_id.types.describe_watchlist_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_describe_watchlist(
