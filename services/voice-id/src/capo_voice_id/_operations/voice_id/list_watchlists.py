...
def handle_response(
    ...
    out: capo_voice_id.types.list_watchlists_response.ListWatchlistsResponse = (
        capo_voice_id.types.list_watchlists_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_voice_id.types.list_watchlists_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_watchlists(
    ...
    capo_voice_id.types.list_watchlists_response.ListWatchlistsResponse, zapros.Response
]:
