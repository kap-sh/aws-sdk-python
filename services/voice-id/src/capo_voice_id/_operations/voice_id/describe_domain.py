"""Generated from Smithy shape ``com.amazonaws.voiceid#DescribeDomain``."""
...
def handle_response(
    ...
    out: capo_voice_id.types.describe_domain_response.DescribeDomainResponse = (
        capo_voice_id.types.describe_domain_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VoiceID.DescribeDomain"
    body: bytes | None = json.dumps(
        capo_voice_id.types.describe_domain_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def describe_domain(
    ...
    capo_voice_id.types.describe_domain_response.DescribeDomainResponse, zapros.Response
]:
