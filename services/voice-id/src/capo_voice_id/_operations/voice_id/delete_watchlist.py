"""Generated from Smithy shape ``com.amazonaws.voiceid#DeleteWatchlist``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VoiceID.DeleteWatchlist"
    body: bytes | None = json.dumps(
        capo_voice_id.types.delete_watchlist_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_delete_watchlist(
