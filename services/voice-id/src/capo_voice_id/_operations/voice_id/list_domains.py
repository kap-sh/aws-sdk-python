...
import capo_voice_id.types.domain_summaries
...
def handle_response(
    ...
    out: capo_voice_id.types.list_domains_response.ListDomainsResponse = (
        capo_voice_id.types.list_domains_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_voice_id.types.list_domains_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_domains(
    ...
    capo_voice_id.types.list_domains_response.ListDomainsResponse, zapros.Response
]:
