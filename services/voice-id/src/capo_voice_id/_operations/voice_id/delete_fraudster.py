"""Generated from Smithy shape ``com.amazonaws.voiceid#DeleteFraudster``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VoiceID.DeleteFraudster"
    body: bytes | None = json.dumps(
        capo_voice_id.types.delete_fraudster_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_delete_fraudster(
