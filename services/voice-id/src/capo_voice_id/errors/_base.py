...
class VoiceIDError(Exception):
    """Base class for all VoiceID service errors."""


class ServiceError(VoiceIDError):
...
class SerializationError(VoiceIDError):
    """Raised when a value cannot be serialized."""


class DeserializationError(VoiceIDError):
...
class WaiterFailedError(VoiceIDError):
...
class WaiterTimeoutError(VoiceIDError):
