"""Generated from Smithy shape ``com.amazonaws.organizations#InvalidInputExceptionReason``."""

from typing import Literal, TypeAlias, cast

InvalidInputExceptionReason: TypeAlias = Literal[
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: InvalidInputExceptionReason) -> str:
    return value


def deserialize_aws_json_1_1(data: str) -> InvalidInputExceptionReason:
    return cast(InvalidInputExceptionReason, data)
