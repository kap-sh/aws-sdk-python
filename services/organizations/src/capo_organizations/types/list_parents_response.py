...
if TYPE_CHECKING:
    ...
    import capo_organizations.types.parents


class ListParentsResponse(TypedDict, closed=True):
    parents: NotRequired["capo_organizations.types.parents.Parents"]
...
def serialize_aws_json_1_1(value: ListParentsResponse) -> dict:
    ...
    if "parents" in value:
        ...
        out["Parents"] = capo_organizations.types.parents.serialize_aws_json_1_1(
            value["parents"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListParentsResponse:
    ...
    if "Parents" in data:
        ...
        out["parents"] = capo_organizations.types.parents.deserialize_aws_json_1_1(
            data["Parents"]
        )
