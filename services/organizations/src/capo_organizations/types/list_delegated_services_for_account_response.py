...
if TYPE_CHECKING:
    import capo_organizations.types.delegated_services
    import capo_organizations.types.next_token


class ListDelegatedServicesForAccountResponse(TypedDict, closed=True):
    delegated_services: NotRequired[
        "capo_organizations.types.delegated_services.DelegatedServices"
    ]
...
def serialize_aws_json_1_1(value: ListDelegatedServicesForAccountResponse) -> dict:
    ...
    if "delegated_services" in value:
        ...
        out["DelegatedServices"] = (
            capo_organizations.types.delegated_services.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListDelegatedServicesForAccountResponse:
    ...
    if "DelegatedServices" in data:
        ...
        out["delegated_services"] = (
            capo_organizations.types.delegated_services.deserialize_aws_json_1_1(
