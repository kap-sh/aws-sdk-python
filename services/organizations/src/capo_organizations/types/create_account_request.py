"""Generated from Smithy shape ``com.amazonaws.organizations#CreateAccountRequest``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateAccountRequest) -> dict:
    out: dict = {}
    ...
    if "iam_user_access_to_billing" in value:
        ...
        out["IamUserAccessToBilling"] = (
            capo_organizations.types.iam_user_access_to_billing.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CreateAccountRequest:
    ...
    if "IamUserAccessToBilling" in data:
        ...
        out["iam_user_access_to_billing"] = (
            capo_organizations.types.iam_user_access_to_billing.deserialize_aws_json_1_1(
