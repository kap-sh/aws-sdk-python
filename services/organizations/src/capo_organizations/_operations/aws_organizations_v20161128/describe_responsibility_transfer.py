...
import capo_organizations.types.describe_responsibility_transfer_request
import capo_organizations.types.describe_responsibility_transfer_response
...
) -> capo_organizations.types.describe_responsibility_transfer_response.DescribeResponsibilityTransferResponse:
    out: capo_organizations.types.describe_responsibility_transfer_response.DescribeResponsibilityTransferResponse = capo_organizations.types.describe_responsibility_transfer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.describe_responsibility_transfer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
