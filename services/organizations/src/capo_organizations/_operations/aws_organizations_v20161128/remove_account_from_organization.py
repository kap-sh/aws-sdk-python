"""Generated from Smithy shape ``com.amazonaws.organizations#RemoveAccountFromOrganization``."""
...
import capo_organizations.errors.master_cannot_leave_organization_exception
import capo_organizations.errors.service_exception
import capo_organizations.errors.too_many_requests_exception
import capo_organizations.types.remove_account_from_organization_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MasterCannotLeaveOrganizationException":
            raise capo_organizations.errors.master_cannot_leave_organization_exception.MasterCannotLeaveOrganizationException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSOrganizationsV20161128.RemoveAccountFromOrganization"
    body: bytes | None = json.dumps(
        capo_organizations.types.remove_account_from_organization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_remove_account_from_organization(
