"""Generated from Smithy shape ``com.amazonaws.organizations#CreateAccount``."""
...
import capo_organizations.types.create_account_request
import capo_organizations.types.create_account_response
...
) -> capo_organizations.types.create_account_response.CreateAccountResponse:
    out: capo_organizations.types.create_account_response.CreateAccountResponse = (
        capo_organizations.types.create_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.create_account_request.serialize_aws_json_1_1(input_)
    ).encode()
