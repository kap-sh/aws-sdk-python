"""Generated from Smithy shape ``com.amazonaws.organizations#CloseAccount``."""
...
import capo_organizations.errors.conflict_exception
...
import capo_organizations.types.close_account_request
