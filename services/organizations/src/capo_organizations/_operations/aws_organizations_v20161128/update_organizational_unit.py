"""Generated from Smithy shape ``com.amazonaws.organizations#UpdateOrganizationalUnit``."""
...
import capo_organizations.errors.duplicate_organizational_unit_exception
import capo_organizations.errors.invalid_input_exception
import capo_organizations.errors.organizational_unit_not_found_exception
...
import capo_organizations.types.update_organizational_unit_request
import capo_organizations.types.update_organizational_unit_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DuplicateOrganizationalUnitException":
            raise capo_organizations.errors.duplicate_organizational_unit_exception.DuplicateOrganizationalUnitException.from_aws_json_1_1(
                data
            )
        ...
        case "OrganizationalUnitNotFoundException":
            raise capo_organizations.errors.organizational_unit_not_found_exception.OrganizationalUnitNotFoundException.from_aws_json_1_1(
                data
            )
...
) -> capo_organizations.types.update_organizational_unit_response.UpdateOrganizationalUnitResponse:
    out: capo_organizations.types.update_organizational_unit_response.UpdateOrganizationalUnitResponse = capo_organizations.types.update_organizational_unit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSOrganizationsV20161128.UpdateOrganizationalUnit"
    body: bytes | None = json.dumps(
        capo_organizations.types.update_organizational_unit_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_organizational_unit(
