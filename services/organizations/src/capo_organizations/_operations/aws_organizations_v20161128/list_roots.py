"""Generated from Smithy shape ``com.amazonaws.organizations#ListRoots``."""
...
import capo_organizations.types.list_roots_request
import capo_organizations.types.list_roots_response
import capo_organizations.types.roots
...
) -> capo_organizations.types.list_roots_response.ListRootsResponse:
    out: capo_organizations.types.list_roots_response.ListRootsResponse = (
        capo_organizations.types.list_roots_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_roots_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_roots(
    ...
    capo_organizations.types.list_roots_response.ListRootsResponse, zapros.Response
]:
