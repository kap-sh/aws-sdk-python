"""Generated from Smithy shape ``com.amazonaws.organizations#ListPoliciesForTarget``."""
...
import capo_organizations.types.list_policies_for_target_request
import capo_organizations.types.list_policies_for_target_response
...
) -> capo_organizations.types.list_policies_for_target_response.ListPoliciesForTargetResponse:
    out: capo_organizations.types.list_policies_for_target_response.ListPoliciesForTargetResponse = capo_organizations.types.list_policies_for_target_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_policies_for_target_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_policies_for_target(
