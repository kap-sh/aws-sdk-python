"""Generated from Smithy shape ``com.amazonaws.organizations#ListDelegatedAdministrators``."""
...
import capo_organizations.types.delegated_administrators
import capo_organizations.types.list_delegated_administrators_request
import capo_organizations.types.list_delegated_administrators_response
...
) -> capo_organizations.types.list_delegated_administrators_response.ListDelegatedAdministratorsResponse:
    out: capo_organizations.types.list_delegated_administrators_response.ListDelegatedAdministratorsResponse = capo_organizations.types.list_delegated_administrators_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSOrganizationsV20161128.ListDelegatedAdministrators"
    body: bytes | None = json.dumps(
        capo_organizations.types.list_delegated_administrators_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_delegated_administrators(
