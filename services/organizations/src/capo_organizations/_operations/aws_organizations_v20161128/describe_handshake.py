"""Generated from Smithy shape ``com.amazonaws.organizations#DescribeHandshake``."""
...
import capo_organizations.types.describe_handshake_request
import capo_organizations.types.describe_handshake_response
...
) -> capo_organizations.types.describe_handshake_response.DescribeHandshakeResponse:
    out: capo_organizations.types.describe_handshake_response.DescribeHandshakeResponse = capo_organizations.types.describe_handshake_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.describe_handshake_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_handshake(
