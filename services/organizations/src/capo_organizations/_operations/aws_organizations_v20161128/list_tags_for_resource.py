"""Generated from Smithy shape ``com.amazonaws.organizations#ListTagsForResource``."""
...
import capo_organizations.types.list_tags_for_resource_request
import capo_organizations.types.list_tags_for_resource_response
...
def handle_response(
    ...
    capo_organizations.types.list_tags_for_resource_response.ListTagsForResourceResponse
):
    out: capo_organizations.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_organizations.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_tags_for_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
