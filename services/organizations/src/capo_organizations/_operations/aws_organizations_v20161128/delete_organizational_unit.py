...
import capo_organizations.errors.organizational_unit_not_empty_exception
...
import capo_organizations.types.delete_organizational_unit_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OrganizationalUnitNotEmptyException":
            raise capo_organizations.errors.organizational_unit_not_empty_exception.OrganizationalUnitNotEmptyException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.delete_organizational_unit_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
