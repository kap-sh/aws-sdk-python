"""Generated from Smithy shape ``com.amazonaws.organizations#AttachPolicy``."""
...
import capo_organizations.errors.duplicate_policy_attachment_exception
...
import capo_organizations.errors.policy_not_found_exception
import capo_organizations.errors.policy_type_not_enabled_exception
import capo_organizations.errors.service_exception
import capo_organizations.errors.target_not_found_exception
...
import capo_organizations.types.attach_policy_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DuplicatePolicyAttachmentException":
            raise capo_organizations.errors.duplicate_policy_attachment_exception.DuplicatePolicyAttachmentException.from_aws_json_1_1(
                data
            )
        ...
        case "PolicyNotFoundException":
            raise capo_organizations.errors.policy_not_found_exception.PolicyNotFoundException.from_aws_json_1_1(
                data
            )
        case "PolicyTypeNotEnabledException":
            raise capo_organizations.errors.policy_type_not_enabled_exception.PolicyTypeNotEnabledException.from_aws_json_1_1(
                data
            )
        ...
        case "TargetNotFoundException":
            raise capo_organizations.errors.target_not_found_exception.TargetNotFoundException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.attach_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
