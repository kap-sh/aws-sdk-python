"""Generated from Smithy shape ``com.amazonaws.organizations#EnableAWSServiceAccess``."""
...
import capo_organizations.types.enable_aws_service_access_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.enable_aws_service_access_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_enable_aws_service_access(
