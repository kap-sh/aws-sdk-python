"""Generated from Smithy shape ``com.amazonaws.organizations#ListEffectivePolicyValidationErrors``."""
...
import capo_organizations.errors.effective_policy_not_found_exception
...
import capo_organizations.types.list_effective_policy_validation_errors_request
import capo_organizations.types.list_effective_policy_validation_errors_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EffectivePolicyNotFoundException":
            raise capo_organizations.errors.effective_policy_not_found_exception.EffectivePolicyNotFoundException.from_aws_json_1_1(
                data
            )
...
) -> capo_organizations.types.list_effective_policy_validation_errors_response.ListEffectivePolicyValidationErrorsResponse:
    out: capo_organizations.types.list_effective_policy_validation_errors_response.ListEffectivePolicyValidationErrorsResponse = capo_organizations.types.list_effective_policy_validation_errors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_effective_policy_validation_errors_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_effective_policy_validation_errors(
