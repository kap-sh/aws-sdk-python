"""Generated from Smithy shape ``com.amazonaws.organizations#ListChildren``."""
...
import capo_organizations.errors.parent_not_found_exception
...
import capo_organizations.types.list_children_request
import capo_organizations.types.list_children_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ParentNotFoundException":
            raise capo_organizations.errors.parent_not_found_exception.ParentNotFoundException.from_aws_json_1_1(
                data
            )
...
) -> capo_organizations.types.list_children_response.ListChildrenResponse:
    out: capo_organizations.types.list_children_response.ListChildrenResponse = (
        capo_organizations.types.list_children_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_children_request.serialize_aws_json_1_1(input_)
    ).encode()
