...
import capo_organizations.errors.destination_parent_not_found_exception
import capo_organizations.errors.duplicate_account_exception
import capo_organizations.errors.invalid_input_exception
import capo_organizations.errors.service_exception
import capo_organizations.errors.source_parent_not_found_exception
import capo_organizations.errors.too_many_requests_exception
import capo_organizations.types.move_account_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DestinationParentNotFoundException":
            raise capo_organizations.errors.destination_parent_not_found_exception.DestinationParentNotFoundException.from_aws_json_1_1(
                data
            )
        case "DuplicateAccountException":
            raise capo_organizations.errors.duplicate_account_exception.DuplicateAccountException.from_aws_json_1_1(
                data
            )
        ...
        case "SourceParentNotFoundException":
            raise capo_organizations.errors.source_parent_not_found_exception.SourceParentNotFoundException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.move_account_request.serialize_aws_json_1_1(input_)
    ).encode()
