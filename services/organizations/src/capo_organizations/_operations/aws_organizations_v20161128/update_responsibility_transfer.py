"""Generated from Smithy shape ``com.amazonaws.organizations#UpdateResponsibilityTransfer``."""
...
import capo_organizations.errors.responsibility_transfer_not_found_exception
...
import capo_organizations.types.update_responsibility_transfer_request
import capo_organizations.types.update_responsibility_transfer_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResponsibilityTransferNotFoundException":
            raise capo_organizations.errors.responsibility_transfer_not_found_exception.ResponsibilityTransferNotFoundException.from_aws_json_1_1(
                data
            )
...
) -> capo_organizations.types.update_responsibility_transfer_response.UpdateResponsibilityTransferResponse:
    out: capo_organizations.types.update_responsibility_transfer_response.UpdateResponsibilityTransferResponse = capo_organizations.types.update_responsibility_transfer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSOrganizationsV20161128.UpdateResponsibilityTransfer"
    body: bytes | None = json.dumps(
        capo_organizations.types.update_responsibility_transfer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_responsibility_transfer(
