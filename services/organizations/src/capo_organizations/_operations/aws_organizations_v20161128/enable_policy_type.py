"""Generated from Smithy shape ``com.amazonaws.organizations#EnablePolicyType``."""
...
import capo_organizations.errors.policy_changes_in_progress_exception
import capo_organizations.errors.policy_type_already_enabled_exception
import capo_organizations.errors.policy_type_not_available_for_organization_exception
import capo_organizations.errors.root_not_found_exception
...
import capo_organizations.types.enable_policy_type_request
import capo_organizations.types.enable_policy_type_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PolicyChangesInProgressException":
            raise capo_organizations.errors.policy_changes_in_progress_exception.PolicyChangesInProgressException.from_aws_json_1_1(
                data
            )
        case "PolicyTypeAlreadyEnabledException":
            raise capo_organizations.errors.policy_type_already_enabled_exception.PolicyTypeAlreadyEnabledException.from_aws_json_1_1(
                data
            )
        case "PolicyTypeNotAvailableForOrganizationException":
            raise capo_organizations.errors.policy_type_not_available_for_organization_exception.PolicyTypeNotAvailableForOrganizationException.from_aws_json_1_1(
                data
            )
        case "RootNotFoundException":
            raise capo_organizations.errors.root_not_found_exception.RootNotFoundException.from_aws_json_1_1(
                data
            )
...
) -> capo_organizations.types.enable_policy_type_response.EnablePolicyTypeResponse:
    out: capo_organizations.types.enable_policy_type_response.EnablePolicyTypeResponse = capo_organizations.types.enable_policy_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.enable_policy_type_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_enable_policy_type(
