"""Generated from Smithy shape ``com.amazonaws.organizations#DeclineHandshake``."""
...
import capo_organizations.errors.handshake_already_in_state_exception
import capo_organizations.errors.handshake_not_found_exception
import capo_organizations.errors.invalid_handshake_transition_exception
...
import capo_organizations.types.decline_handshake_request
import capo_organizations.types.decline_handshake_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "HandshakeAlreadyInStateException":
            raise capo_organizations.errors.handshake_already_in_state_exception.HandshakeAlreadyInStateException.from_aws_json_1_1(
                data
            )
        case "HandshakeNotFoundException":
            raise capo_organizations.errors.handshake_not_found_exception.HandshakeNotFoundException.from_aws_json_1_1(
                data
            )
        case "InvalidHandshakeTransitionException":
            raise capo_organizations.errors.invalid_handshake_transition_exception.InvalidHandshakeTransitionException.from_aws_json_1_1(
                data
            )
...
) -> capo_organizations.types.decline_handshake_response.DeclineHandshakeResponse:
    out: capo_organizations.types.decline_handshake_response.DeclineHandshakeResponse = capo_organizations.types.decline_handshake_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.decline_handshake_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_decline_handshake(
