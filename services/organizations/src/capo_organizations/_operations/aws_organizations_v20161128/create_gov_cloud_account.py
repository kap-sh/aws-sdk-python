"""Generated from Smithy shape ``com.amazonaws.organizations#CreateGovCloudAccount``."""
...
import capo_organizations.errors.finalizing_organization_exception
...
import capo_organizations.types.create_gov_cloud_account_request
import capo_organizations.types.create_gov_cloud_account_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FinalizingOrganizationException":
            raise capo_organizations.errors.finalizing_organization_exception.FinalizingOrganizationException.from_aws_json_1_1(
                data
            )
...
) -> capo_organizations.types.create_gov_cloud_account_response.CreateGovCloudAccountResponse:
    out: capo_organizations.types.create_gov_cloud_account_response.CreateGovCloudAccountResponse = capo_organizations.types.create_gov_cloud_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.create_gov_cloud_account_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_gov_cloud_account(
