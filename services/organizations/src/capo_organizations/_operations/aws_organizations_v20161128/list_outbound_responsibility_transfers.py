"""Generated from Smithy shape ``com.amazonaws.organizations#ListOutboundResponsibilityTransfers``."""
...
import capo_organizations.types.list_outbound_responsibility_transfers_request
import capo_organizations.types.list_outbound_responsibility_transfers_response
...
) -> capo_organizations.types.list_outbound_responsibility_transfers_response.ListOutboundResponsibilityTransfersResponse:
    out: capo_organizations.types.list_outbound_responsibility_transfers_response.ListOutboundResponsibilityTransfersResponse = capo_organizations.types.list_outbound_responsibility_transfers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_outbound_responsibility_transfers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_outbound_responsibility_transfers(
