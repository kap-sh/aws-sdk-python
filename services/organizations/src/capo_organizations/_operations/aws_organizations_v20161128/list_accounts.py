"""Generated from Smithy shape ``com.amazonaws.organizations#ListAccounts``."""
...
import capo_organizations.types.list_accounts_request
import capo_organizations.types.list_accounts_response
...
) -> capo_organizations.types.list_accounts_response.ListAccountsResponse:
    out: capo_organizations.types.list_accounts_response.ListAccountsResponse = (
        capo_organizations.types.list_accounts_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_accounts_request.serialize_aws_json_1_1(input_)
    ).encode()
