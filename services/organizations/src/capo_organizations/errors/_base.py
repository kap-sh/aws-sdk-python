...
class OrganizationsError(Exception):
    """Base class for all Organizations service errors."""


class ServiceError(OrganizationsError):
...
class SerializationError(OrganizationsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(OrganizationsError):
...
class WaiterFailedError(OrganizationsError):
...
class WaiterTimeoutError(OrganizationsError):
