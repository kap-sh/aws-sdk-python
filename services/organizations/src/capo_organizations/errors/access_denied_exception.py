"""Generated from Smithy shape ``com.amazonaws.organizations#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.organizations#AccessDeniedException``."""
