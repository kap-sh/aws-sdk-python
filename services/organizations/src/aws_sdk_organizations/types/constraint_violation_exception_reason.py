"""Generated from Smithy shape ``com.amazonaws.organizations#ConstraintViolationExceptionReason``."""

from typing import Literal, TypeAlias, cast

from aws_sdk_organizations.errors import DeserializationError

ConstraintViolationExceptionReason: TypeAlias = Literal[
...
def serialize_aws_json_1_1(value: ConstraintViolationExceptionReason) -> str:
    return value


def deserialize_aws_json_1_1(data: str) -> ConstraintViolationExceptionReason:
    if data not in _VALUES:
        raise DeserializationError(
            f"unknown ConstraintViolationExceptionReason value: {data!r}"
        )
    return cast(ConstraintViolationExceptionReason, data)
