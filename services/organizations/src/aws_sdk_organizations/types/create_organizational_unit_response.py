"""Generated from Smithy shape ``com.amazonaws.organizations#CreateOrganizationalUnitResponse``."""
...
class CreateOrganizationalUnitResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateOrganizationalUnitResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> CreateOrganizationalUnitResponse:
    out: CreateOrganizationalUnitResponse = {}  # type: ignore[typeddict-item]
