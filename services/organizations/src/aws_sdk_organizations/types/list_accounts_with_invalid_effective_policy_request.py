"""Generated from Smithy shape ``com.amazonaws.organizations#ListAccountsWithInvalidEffectivePolicyRequest``."""
...
class ListAccountsWithInvalidEffectivePolicyRequest(TypedDict, closed=True):
...
def serialize_aws_json_1_1(
    value: ListAccountsWithInvalidEffectivePolicyRequest,
) -> dict:
    out: dict = {}
    import aws_sdk_organizations.types.effective_policy_type
