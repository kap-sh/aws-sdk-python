"""Generated from Smithy shape ``com.amazonaws.organizations#ListAWSServiceAccessForOrganizationRequest``."""
...
class ListAWSServiceAccessForOrganizationRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListAWSServiceAccessForOrganizationRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListAWSServiceAccessForOrganizationRequest:
    out: ListAWSServiceAccessForOrganizationRequest = {}  # type: ignore[typeddict-item]
