"""Generated from Smithy shape ``com.amazonaws.organizations#AcceptHandshakeResponse``."""
...
class AcceptHandshakeResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AcceptHandshakeResponse) -> dict:
    out: dict = {}
