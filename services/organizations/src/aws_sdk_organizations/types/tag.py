...
if TYPE_CHECKING:
    import aws_sdk_organizations.types.tag_key
    import aws_sdk_organizations.types.tag_value


class Tag(TypedDict):
    key: "aws_sdk_organizations.types.tag_key.TagKey"
    """<p>The key identifier, or name, of the tag.</p>"""
    value: "aws_sdk_organizations.types.tag_value.TagValue"
