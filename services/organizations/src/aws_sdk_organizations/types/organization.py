...
if TYPE_CHECKING:
    ...
    import aws_sdk_organizations.types.organization_arn
    import aws_sdk_organizations.types.organization_feature_set
    import aws_sdk_organizations.types.organization_id
...
class Organization(TypedDict):
    ...
    available_policy_types: NotRequired[
        "aws_sdk_organizations.types.policy_types.PolicyTypes"
    ]
...
def serialize_aws_json_1_1(value: Organization) -> dict:
    ...
    if "feature_set" in value:
        ...
        out["FeatureSet"] = (
            aws_sdk_organizations.types.organization_feature_set.serialize_aws_json_1_1(
                value["feature_set"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> Organization:
    ...
    if "FeatureSet" in data:
        ...
        out["feature_set"] = (
            aws_sdk_organizations.types.organization_feature_set.deserialize_aws_json_1_1(
                data["FeatureSet"]
            )
        )
