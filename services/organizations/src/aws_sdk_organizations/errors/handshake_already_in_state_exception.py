...
class HandshakeAlreadyInStateException_(TypedDict):
    message: NotRequired[
...
class HandshakeAlreadyInStateException(ServiceError):
    ...
    def __init__(self, data: HandshakeAlreadyInStateException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "HandshakeAlreadyInStateException":
