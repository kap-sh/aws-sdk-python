"""Generated from Smithy shape ``com.amazonaws.organizations#ConcurrentModificationException``."""
...
class ConcurrentModificationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.organizations#ConcurrentModificationException``."""
