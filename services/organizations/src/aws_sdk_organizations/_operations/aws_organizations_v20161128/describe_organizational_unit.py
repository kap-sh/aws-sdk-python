"""Generated from Smithy shape ``com.amazonaws.organizations#DescribeOrganizationalUnit``."""
...
def handle_response(
    ...
    out: aws_sdk_organizations.types.describe_organizational_unit_response.DescribeOrganizationalUnitResponse = aws_sdk_organizations.types.describe_organizational_unit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.describe_organizational_unit_request.DescribeOrganizationalUnitRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSOrganizationsV20161128.DescribeOrganizationalUnit"
    import aws_sdk_organizations.types.describe_organizational_unit_request

    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.describe_organizational_unit_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_organizational_unit(
