...
def handle_response(
    ...
    out: aws_sdk_organizations.types.enable_all_features_response.EnableAllFeaturesResponse = aws_sdk_organizations.types.enable_all_features_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.enable_all_features_request.EnableAllFeaturesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
