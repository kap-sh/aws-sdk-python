...
def handle_response(
    ...
    out: aws_sdk_organizations.types.describe_organization_response.DescribeOrganizationResponse = aws_sdk_organizations.types.describe_organization_response.deserialize_aws_json_1_1(
