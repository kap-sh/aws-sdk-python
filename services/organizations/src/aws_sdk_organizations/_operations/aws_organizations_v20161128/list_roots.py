...
def handle_response(
    ...
    out: aws_sdk_organizations.types.list_roots_response.ListRootsResponse = (
        aws_sdk_organizations.types.list_roots_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.list_roots_request.ListRootsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.list_roots_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_roots(
    ...
    aws_sdk_organizations.types.list_roots_response.ListRootsResponse, zapros.Response
]:
