...
def build_request(
    ...
    input: aws_sdk_organizations.types.update_policy_request.UpdatePolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.update_policy_request.serialize_aws_json_1_1(input)
    ).encode()
