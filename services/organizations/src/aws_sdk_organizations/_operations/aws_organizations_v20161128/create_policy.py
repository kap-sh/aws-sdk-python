...
def build_request(
    ...
    input: aws_sdk_organizations.types.create_policy_request.CreatePolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.create_policy_request.serialize_aws_json_1_1(input)
    ).encode()
