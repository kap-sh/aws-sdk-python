...
def handle_response(
    ...
    out: aws_sdk_organizations.types.update_responsibility_transfer_response.UpdateResponsibilityTransferResponse = aws_sdk_organizations.types.update_responsibility_transfer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.update_responsibility_transfer_request.UpdateResponsibilityTransferRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.update_responsibility_transfer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
