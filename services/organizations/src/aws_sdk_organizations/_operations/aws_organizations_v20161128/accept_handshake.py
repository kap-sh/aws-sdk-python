...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AccessDeniedForDependencyException":
            import aws_sdk_organizations.errors.access_denied_for_dependency_exception

            raise aws_sdk_organizations.errors.access_denied_for_dependency_exception.AccessDeniedForDependencyException.from_aws_json_1_1(
                data
            )
        ...
        case "HandshakeAlreadyInStateException":
            import aws_sdk_organizations.errors.handshake_already_in_state_exception

            raise aws_sdk_organizations.errors.handshake_already_in_state_exception.HandshakeAlreadyInStateException.from_aws_json_1_1(
                data
            )
        case "HandshakeConstraintViolationException":
            import aws_sdk_organizations.errors.handshake_constraint_violation_exception

            raise aws_sdk_organizations.errors.handshake_constraint_violation_exception.HandshakeConstraintViolationException.from_aws_json_1_1(
                data
            )
        ...
        case "InvalidHandshakeTransitionException":
            import aws_sdk_organizations.errors.invalid_handshake_transition_exception

            raise aws_sdk_organizations.errors.invalid_handshake_transition_exception.InvalidHandshakeTransitionException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_organizations.types.accept_handshake_response.AcceptHandshakeResponse = aws_sdk_organizations.types.accept_handshake_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.accept_handshake_request.AcceptHandshakeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.accept_handshake_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
