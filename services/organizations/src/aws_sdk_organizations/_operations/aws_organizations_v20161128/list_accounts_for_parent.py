"""Generated from Smithy shape ``com.amazonaws.organizations#ListAccountsForParent``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ParentNotFoundException":
            import aws_sdk_organizations.errors.parent_not_found_exception

            raise aws_sdk_organizations.errors.parent_not_found_exception.ParentNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_organizations.types.list_accounts_for_parent_response.ListAccountsForParentResponse = aws_sdk_organizations.types.list_accounts_for_parent_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.list_accounts_for_parent_request.ListAccountsForParentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.list_accounts_for_parent_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_accounts_for_parent(
