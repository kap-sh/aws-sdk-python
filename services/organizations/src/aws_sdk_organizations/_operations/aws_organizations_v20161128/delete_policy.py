...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PolicyInUseException":
            import aws_sdk_organizations.errors.policy_in_use_exception

            raise aws_sdk_organizations.errors.policy_in_use_exception.PolicyInUseException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.delete_policy_request.DeletePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.delete_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
