...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OrganizationNotEmptyException":
            import aws_sdk_organizations.errors.organization_not_empty_exception

            raise aws_sdk_organizations.errors.organization_not_empty_exception.OrganizationNotEmptyException.from_aws_json_1_1(
                data
            )
