...
def handle_response(
    ...
    out: aws_sdk_organizations.types.list_create_account_status_response.ListCreateAccountStatusResponse = aws_sdk_organizations.types.list_create_account_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.list_create_account_status_request.ListCreateAccountStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.list_create_account_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
