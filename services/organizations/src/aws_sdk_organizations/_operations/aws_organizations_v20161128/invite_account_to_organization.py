...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AccountOwnerNotVerifiedException":
            import aws_sdk_organizations.errors.account_owner_not_verified_exception

            raise aws_sdk_organizations.errors.account_owner_not_verified_exception.AccountOwnerNotVerifiedException.from_aws_json_1_1(
                data
            )
        ...
        case "DuplicateHandshakeException":
            import aws_sdk_organizations.errors.duplicate_handshake_exception

            raise aws_sdk_organizations.errors.duplicate_handshake_exception.DuplicateHandshakeException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_organizations.types.invite_account_to_organization_response.InviteAccountToOrganizationResponse = aws_sdk_organizations.types.invite_account_to_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.invite_account_to_organization_request.InviteAccountToOrganizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
