...
def handle_response(
    ...
    out: aws_sdk_organizations.types.create_organizational_unit_response.CreateOrganizationalUnitResponse = aws_sdk_organizations.types.create_organizational_unit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.create_organizational_unit_request.CreateOrganizationalUnitRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.create_organizational_unit_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
