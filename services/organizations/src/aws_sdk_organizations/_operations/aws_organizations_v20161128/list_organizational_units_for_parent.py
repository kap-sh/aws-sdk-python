"""Generated from Smithy shape ``com.amazonaws.organizations#ListOrganizationalUnitsForParent``."""
...
def handle_response(
    ...
    out: aws_sdk_organizations.types.list_organizational_units_for_parent_response.ListOrganizationalUnitsForParentResponse = aws_sdk_organizations.types.list_organizational_units_for_parent_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.list_organizational_units_for_parent_request.ListOrganizationalUnitsForParentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_organizational_units_for_parent(
