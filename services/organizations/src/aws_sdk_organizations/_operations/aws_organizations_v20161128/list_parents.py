"""Generated from Smithy shape ``com.amazonaws.organizations#ListParents``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ChildNotFoundException":
            import aws_sdk_organizations.errors.child_not_found_exception

            raise aws_sdk_organizations.errors.child_not_found_exception.ChildNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_organizations.types.list_parents_response.ListParentsResponse = (
        aws_sdk_organizations.types.list_parents_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.list_parents_request.ListParentsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.list_parents_request.serialize_aws_json_1_1(input_)
    ).encode()
