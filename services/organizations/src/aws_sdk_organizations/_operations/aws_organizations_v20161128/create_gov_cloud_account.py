...
import aws_sdk_organizations.errors.finalizing_organization_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FinalizingOrganizationException":
            raise aws_sdk_organizations.errors.finalizing_organization_exception.FinalizingOrganizationException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_organizations.types.create_gov_cloud_account_response.CreateGovCloudAccountResponse = aws_sdk_organizations.types.create_gov_cloud_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.create_gov_cloud_account_request.CreateGovCloudAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.create_gov_cloud_account_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
