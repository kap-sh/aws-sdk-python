...
def handle_response(
    ...
    out: aws_sdk_organizations.types.list_targets_for_policy_response.ListTargetsForPolicyResponse = aws_sdk_organizations.types.list_targets_for_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.list_targets_for_policy_request.ListTargetsForPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.list_targets_for_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
