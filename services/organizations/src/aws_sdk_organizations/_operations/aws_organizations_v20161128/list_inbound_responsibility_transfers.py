...
def handle_response(
    ...
    out: aws_sdk_organizations.types.list_inbound_responsibility_transfers_response.ListInboundResponsibilityTransfersResponse = aws_sdk_organizations.types.list_inbound_responsibility_transfers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.list_inbound_responsibility_transfers_request.ListInboundResponsibilityTransfersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.list_inbound_responsibility_transfers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
