...
def handle_response(
    ...
    out: aws_sdk_organizations.types.list_effective_policy_validation_errors_response.ListEffectivePolicyValidationErrorsResponse = aws_sdk_organizations.types.list_effective_policy_validation_errors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.list_effective_policy_validation_errors_request.ListEffectivePolicyValidationErrorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
