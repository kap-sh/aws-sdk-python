...
def build_request(
    ...
    input: aws_sdk_organizations.types.list_accounts_request.ListAccountsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.list_accounts_request.serialize_aws_json_1_1(input)
    ).encode()
