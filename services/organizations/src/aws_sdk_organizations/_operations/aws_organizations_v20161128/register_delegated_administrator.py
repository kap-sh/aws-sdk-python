...
import aws_sdk_organizations.errors.account_already_registered_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AccountAlreadyRegisteredException":
            raise aws_sdk_organizations.errors.account_already_registered_exception.AccountAlreadyRegisteredException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.register_delegated_administrator_request.RegisterDelegatedAdministratorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
