...
import aws_sdk_organizations.errors.account_not_registered_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AccountNotRegisteredException":
            raise aws_sdk_organizations.errors.account_not_registered_exception.AccountNotRegisteredException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.deregister_delegated_administrator_request.DeregisterDelegatedAdministratorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
