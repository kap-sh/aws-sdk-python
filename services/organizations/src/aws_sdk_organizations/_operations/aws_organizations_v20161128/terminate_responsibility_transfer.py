...
import aws_sdk_organizations.errors.invalid_responsibility_transfer_transition_exception
import aws_sdk_organizations.errors.responsibility_transfer_already_in_status_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResponsibilityTransferTransitionException":
            raise aws_sdk_organizations.errors.invalid_responsibility_transfer_transition_exception.InvalidResponsibilityTransferTransitionException.from_aws_json_1_1(
                data
            )
        case "ResponsibilityTransferAlreadyInStatusException":
            raise aws_sdk_organizations.errors.responsibility_transfer_already_in_status_exception.ResponsibilityTransferAlreadyInStatusException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_organizations.types.terminate_responsibility_transfer_response.TerminateResponsibilityTransferResponse = aws_sdk_organizations.types.terminate_responsibility_transfer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.terminate_responsibility_transfer_request.TerminateResponsibilityTransferRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.terminate_responsibility_transfer_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
