"""Generated from Smithy shape ``com.amazonaws.organizations#MoveAccount``."""
...
import aws_sdk_organizations.errors.destination_parent_not_found_exception
import aws_sdk_organizations.errors.duplicate_account_exception
import aws_sdk_organizations.errors.invalid_input_exception
import aws_sdk_organizations.errors.service_exception
import aws_sdk_organizations.errors.source_parent_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DestinationParentNotFoundException":
            raise aws_sdk_organizations.errors.destination_parent_not_found_exception.DestinationParentNotFoundException.from_aws_json_1_1(
                data
            )
        case "DuplicateAccountException":
            raise aws_sdk_organizations.errors.duplicate_account_exception.DuplicateAccountException.from_aws_json_1_1(
                data
            )
        ...
        case "SourceParentNotFoundException":
            raise aws_sdk_organizations.errors.source_parent_not_found_exception.SourceParentNotFoundException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.move_account_request.MoveAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.move_account_request.serialize_aws_json_1_1(input_)
    ).encode()
