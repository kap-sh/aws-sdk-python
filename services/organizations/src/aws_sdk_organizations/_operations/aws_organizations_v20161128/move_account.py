...
def build_request(
    ...
    input: aws_sdk_organizations.types.move_account_request.MoveAccountRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.move_account_request.serialize_aws_json_1_1(input)
    ).encode()
