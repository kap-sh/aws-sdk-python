...
def handle_response(
    ...
    out: aws_sdk_organizations.types.create_account_response.CreateAccountResponse = (
        aws_sdk_organizations.types.create_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_organizations.types.create_account_request.CreateAccountRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.create_account_request.serialize_aws_json_1_1(input)
    ).encode()
