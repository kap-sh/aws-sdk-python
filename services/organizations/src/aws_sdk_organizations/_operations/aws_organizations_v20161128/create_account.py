...
def build_request(
    ...
    input_: aws_sdk_organizations.types.create_account_request.CreateAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.create_account_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
