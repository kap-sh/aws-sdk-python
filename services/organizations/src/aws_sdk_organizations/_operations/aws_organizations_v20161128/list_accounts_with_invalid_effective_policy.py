"""Generated from Smithy shape ``com.amazonaws.organizations#ListAccountsWithInvalidEffectivePolicy``."""
...
import aws_sdk_organizations.errors.effective_policy_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EffectivePolicyNotFoundException":
            raise aws_sdk_organizations.errors.effective_policy_not_found_exception.EffectivePolicyNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_organizations.types.list_accounts_with_invalid_effective_policy_response.ListAccountsWithInvalidEffectivePolicyResponse = aws_sdk_organizations.types.list_accounts_with_invalid_effective_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.list_accounts_with_invalid_effective_policy_request.ListAccountsWithInvalidEffectivePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_accounts_with_invalid_effective_policy(
