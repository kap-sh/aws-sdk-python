"""Generated from Smithy shape ``com.amazonaws.organizations#ListAWSServiceAccessForOrganization``."""
...
def handle_response(
    ...
    out: aws_sdk_organizations.types.list_aws_service_access_for_organization_response.ListAWSServiceAccessForOrganizationResponse = aws_sdk_organizations.types.list_aws_service_access_for_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.list_aws_service_access_for_organization_request.ListAWSServiceAccessForOrganizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_aws_service_access_for_organization(
