...
def handle_response(
    ...
    out: aws_sdk_organizations.types.cancel_handshake_response.CancelHandshakeResponse = aws_sdk_organizations.types.cancel_handshake_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.cancel_handshake_request.CancelHandshakeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.cancel_handshake_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
