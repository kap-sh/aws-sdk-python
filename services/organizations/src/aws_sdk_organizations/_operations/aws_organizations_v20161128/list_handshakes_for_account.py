...
def handle_response(
    ...
    out: aws_sdk_organizations.types.list_handshakes_for_account_response.ListHandshakesForAccountResponse = aws_sdk_organizations.types.list_handshakes_for_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.list_handshakes_for_account_request.ListHandshakesForAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.list_handshakes_for_account_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
