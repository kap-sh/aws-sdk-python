...
def build_request(
    ...
    input: aws_sdk_organizations.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.untag_resource_request.serialize_aws_json_1_1(input)
    ).encode()
