...
def handle_response(
    ...
    out: aws_sdk_organizations.types.list_outbound_responsibility_transfers_response.ListOutboundResponsibilityTransfersResponse = aws_sdk_organizations.types.list_outbound_responsibility_transfers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.list_outbound_responsibility_transfers_request.ListOutboundResponsibilityTransfersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
