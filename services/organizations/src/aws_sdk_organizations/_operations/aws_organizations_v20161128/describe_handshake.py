...
import aws_sdk_organizations.errors.handshake_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "HandshakeNotFoundException":
            raise aws_sdk_organizations.errors.handshake_not_found_exception.HandshakeNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_organizations.types.describe_handshake_response.DescribeHandshakeResponse = aws_sdk_organizations.types.describe_handshake_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.describe_handshake_request.DescribeHandshakeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.describe_handshake_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
