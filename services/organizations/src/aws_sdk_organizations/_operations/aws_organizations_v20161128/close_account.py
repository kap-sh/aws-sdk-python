...
def build_request(
    ...
    input: aws_sdk_organizations.types.close_account_request.CloseAccountRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.close_account_request.serialize_aws_json_1_1(input)
    ).encode()
