...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AccountAlreadyClosedException":
            import aws_sdk_organizations.errors.account_already_closed_exception

            raise aws_sdk_organizations.errors.account_already_closed_exception.AccountAlreadyClosedException.from_aws_json_1_1(
                data
            )
        ...
        case "ConflictException":
            import aws_sdk_organizations.errors.conflict_exception

            raise aws_sdk_organizations.errors.conflict_exception.ConflictException.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.close_account_request.CloseAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.close_account_request.serialize_aws_json_1_1(input_)
    ).encode()
