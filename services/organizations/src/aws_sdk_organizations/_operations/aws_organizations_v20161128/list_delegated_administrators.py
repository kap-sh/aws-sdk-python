...
def handle_response(
    ...
    out: aws_sdk_organizations.types.list_delegated_administrators_response.ListDelegatedAdministratorsResponse = aws_sdk_organizations.types.list_delegated_administrators_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.list_delegated_administrators_request.ListDelegatedAdministratorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.list_delegated_administrators_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
