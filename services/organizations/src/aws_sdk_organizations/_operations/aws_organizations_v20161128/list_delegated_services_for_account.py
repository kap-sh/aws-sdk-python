...
def handle_response(
    ...
    out: aws_sdk_organizations.types.list_delegated_services_for_account_response.ListDelegatedServicesForAccountResponse = aws_sdk_organizations.types.list_delegated_services_for_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.list_delegated_services_for_account_request.ListDelegatedServicesForAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
