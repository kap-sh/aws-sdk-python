...
def build_request(
    ...
    input: aws_sdk_organizations.types.detach_policy_request.DetachPolicyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.detach_policy_request.serialize_aws_json_1_1(input)
    ).encode()
