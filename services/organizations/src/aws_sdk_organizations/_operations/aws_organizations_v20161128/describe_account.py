...
def handle_response(
    ...
    out: aws_sdk_organizations.types.describe_account_response.DescribeAccountResponse = aws_sdk_organizations.types.describe_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.describe_account_request.DescribeAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.describe_account_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
