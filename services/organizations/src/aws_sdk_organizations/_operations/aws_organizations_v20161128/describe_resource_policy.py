"""Generated from Smithy shape ``com.amazonaws.organizations#DescribeResourcePolicy``."""
...
import aws_sdk_organizations.errors.resource_policy_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourcePolicyNotFoundException":
            raise aws_sdk_organizations.errors.resource_policy_not_found_exception.ResourcePolicyNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_organizations.types.describe_resource_policy_response.DescribeResourcePolicyResponse = aws_sdk_organizations.types.describe_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSOrganizationsV20161128.DescribeResourcePolicy"
    body: bytes | None = b""
