...
import aws_sdk_organizations.errors.already_in_organization_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AlreadyInOrganizationException":
            raise aws_sdk_organizations.errors.already_in_organization_exception.AlreadyInOrganizationException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_organizations.types.create_organization_response.CreateOrganizationResponse = aws_sdk_organizations.types.create_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.create_organization_request.CreateOrganizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.create_organization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
