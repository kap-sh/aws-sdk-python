...
def handle_response(
    ...
    out: aws_sdk_organizations.types.disable_policy_type_response.DisablePolicyTypeResponse = aws_sdk_organizations.types.disable_policy_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.disable_policy_type_request.DisablePolicyTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.disable_policy_type_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
