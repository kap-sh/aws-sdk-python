...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DuplicateOrganizationalUnitException":
            import aws_sdk_organizations.errors.duplicate_organizational_unit_exception

            raise aws_sdk_organizations.errors.duplicate_organizational_unit_exception.DuplicateOrganizationalUnitException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_organizations.types.update_organizational_unit_response.UpdateOrganizationalUnitResponse = aws_sdk_organizations.types.update_organizational_unit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.update_organizational_unit_request.UpdateOrganizationalUnitRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.update_organizational_unit_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
