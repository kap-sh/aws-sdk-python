"""Generated from Smithy shape ``com.amazonaws.organizations#DescribeCreateAccountStatus``."""
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.describe_create_account_status_request.DescribeCreateAccountStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSOrganizationsV20161128.DescribeCreateAccountStatus"
    import aws_sdk_organizations.types.describe_create_account_status_request

    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.describe_create_account_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_create_account_status(
