...
def handle_response(
    ...
    out: aws_sdk_organizations.types.describe_policy_response.DescribePolicyResponse = (
        aws_sdk_organizations.types.describe_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.describe_policy_request.DescribePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.describe_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
