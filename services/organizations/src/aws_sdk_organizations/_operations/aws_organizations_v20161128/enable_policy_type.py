...
import aws_sdk_organizations.errors.policy_type_already_enabled_exception
import aws_sdk_organizations.errors.policy_type_not_available_for_organization_exception
import aws_sdk_organizations.errors.root_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PolicyTypeAlreadyEnabledException":
            raise aws_sdk_organizations.errors.policy_type_already_enabled_exception.PolicyTypeAlreadyEnabledException.from_aws_json_1_1(
                data
            )
        case "PolicyTypeNotAvailableForOrganizationException":
            raise aws_sdk_organizations.errors.policy_type_not_available_for_organization_exception.PolicyTypeNotAvailableForOrganizationException.from_aws_json_1_1(
                data
            )
        case "RootNotFoundException":
            raise aws_sdk_organizations.errors.root_not_found_exception.RootNotFoundException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_organizations.types.enable_policy_type_response.EnablePolicyTypeResponse = aws_sdk_organizations.types.enable_policy_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_organizations.types.enable_policy_type_request.EnablePolicyTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_organizations.types.enable_policy_type_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
