...
from aws_sdk_organizations._services._aws_config import aws_config
...
class OrganizationsClientConfig(TypedDict, total=False):
...
class OrganizationsClient:
    ...
    def __init__(
        ...
        self._config = OrganizationsClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[OrganizationsClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: OrganizationsClientConfig = config_overrides or {}
    ...
    def accept_handshake(
        ...
        *,
        config_overrides: Optional[OrganizationsClientConfig] = None,
    ) -> (
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.accept_handshake_request.AcceptHandshakeRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.accept_handshake_response.AcceptHandshakeResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.accept_handshake.accept_handshake(
    ...
    def attach_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.attach_policy(target_id='333333333333', policy_id='p-examplepolicyid111')
            To attach a policy to an OU
            The following example shows how to attach a service control policy (SCP) to an OU:


            >>> client.attach_policy(target_id='ou-examplerootid111-exampleouid111', policy_id='p-examplepolicyid111')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.attach_policy_request.AttachPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_organizations._operations.aws_organizations_v20161128.attach_policy

            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.attach_policy.attach_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def cancel_handshake(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.cancel_handshake_request.CancelHandshakeRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.cancel_handshake_response.CancelHandshakeResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.cancel_handshake.cancel_handshake(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def close_account(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.close_account_request.CloseAccountRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_organizations._operations.aws_organizations_v20161128.close_account

            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.close_account.close_account(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_account(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_account(email='susan@example.com', account_name='Production Account')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.create_account_request.CreateAccountRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.create_account_response.CreateAccountResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.create_account.create_account(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_gov_cloud_account(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.create_gov_cloud_account_request.CreateGovCloudAccountRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.create_gov_cloud_account_response.CreateGovCloudAccountResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.create_gov_cloud_account.create_gov_cloud_account(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_organization(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_organization(feature_set='CONSOLIDATED_BILLING')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.create_organization_request.CreateOrganizationRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.create_organization_response.CreateOrganizationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.create_organization.create_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_organizational_unit(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_organizational_unit(parent_id='r-examplerootid111', name='AccountingOU')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.create_organizational_unit_request.CreateOrganizationalUnitRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.create_organizational_unit_response.CreateOrganizationalUnitResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.create_organizational_unit.create_organizational_unit(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.create_policy(content='{\\"Version\\":\\"2012-10-17\\",\\"Statement\\":{\\"Effect\\":\\"Allow\\",\\"Action\\":\\"s3:*\\"}}', type='SERVICE_CONTROL_POLICY', description='Enables admins of attached accounts to delegate all S3 permissions', name='AllowAllS3Actions')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.create_policy_request.CreatePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.create_policy_response.CreatePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.create_policy.create_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def decline_handshake(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.decline_handshake(handshake_id='h-examplehandshakeid111')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.decline_handshake_request.DeclineHandshakeRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.decline_handshake_response.DeclineHandshakeResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.decline_handshake.decline_handshake(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_organization(
        ...
        def _handler(req: "OperationRequest[None]") -> OperationResponse[None]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.delete_organization.delete_organization(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_organizational_unit(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_organizational_unit(organizational_unit_id='ou-examplerootid111-exampleouid111')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.delete_organizational_unit_request.DeleteOrganizationalUnitRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_organizations._operations.aws_organizations_v20161128.delete_organizational_unit

            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.delete_organizational_unit.delete_organizational_unit(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_policy(policy_id='p-examplepolicyid111')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.delete_policy_request.DeletePolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_organizations._operations.aws_organizations_v20161128.delete_policy

            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.delete_policy.delete_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_resource_policy(
        ...
        def _handler(req: "OperationRequest[None]") -> OperationResponse[None]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.delete_resource_policy.delete_resource_policy(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deregister_delegated_administrator(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.deregister_delegated_administrator_request.DeregisterDelegatedAdministratorRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_organizations._operations.aws_organizations_v20161128.deregister_delegated_administrator

            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.deregister_delegated_administrator.deregister_delegated_administrator(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_account(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_account(account_id='555555555555')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.describe_account_request.DescribeAccountRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.describe_account_response.DescribeAccountResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.describe_account.describe_account(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_create_account_status(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_create_account_status(create_account_request_id='car-exampleaccountcreationrequestid')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.describe_create_account_status_request.DescribeCreateAccountStatusRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.describe_create_account_status_response.DescribeCreateAccountStatusResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.describe_create_account_status.describe_create_account_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_effective_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.describe_effective_policy_request.DescribeEffectivePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.describe_effective_policy_response.DescribeEffectivePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.describe_effective_policy.describe_effective_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_handshake(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_handshake(handshake_id='h-examplehandshakeid111')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.describe_handshake_request.DescribeHandshakeRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.describe_handshake_response.DescribeHandshakeResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.describe_handshake.describe_handshake(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_organization(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.describe_organization.describe_organization(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_organizational_unit(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_organizational_unit(organizational_unit_id='ou-examplerootid111-exampleouid111')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.describe_organizational_unit_request.DescribeOrganizationalUnitRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.describe_organizational_unit_response.DescribeOrganizationalUnitResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.describe_organizational_unit.describe_organizational_unit(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_policy(policy_id='p-examplepolicyid111')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.describe_policy_request.DescribePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.describe_policy_response.DescribePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.describe_policy.describe_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_resource_policy(
        ...
        def _handler(
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.describe_resource_policy.describe_resource_policy(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_responsibility_transfer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.describe_responsibility_transfer_request.DescribeResponsibilityTransferRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.describe_responsibility_transfer_response.DescribeResponsibilityTransferResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.describe_responsibility_transfer.describe_responsibility_transfer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def detach_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.detach_policy(target_id='ou-examplerootid111-exampleouid111', policy_id='p-examplepolicyid111')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.detach_policy_request.DetachPolicyRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_organizations._operations.aws_organizations_v20161128.detach_policy

            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.detach_policy.detach_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disable_aws_service_access(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.disable_aws_service_access_request.DisableAWSServiceAccessRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_organizations._operations.aws_organizations_v20161128.disable_aws_service_access

            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.disable_aws_service_access.disable_aws_service_access(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disable_policy_type(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.disable_policy_type(root_id='r-examplerootid111', policy_type='SERVICE_CONTROL_POLICY')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.disable_policy_type_request.DisablePolicyTypeRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.disable_policy_type_response.DisablePolicyTypeResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.disable_policy_type.disable_policy_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def enable_all_features(
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.enable_all_features_request.EnableAllFeaturesRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.enable_all_features_response.EnableAllFeaturesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.enable_all_features.enable_all_features(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def enable_aws_service_access(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.enable_aws_service_access_request.EnableAWSServiceAccessRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_organizations._operations.aws_organizations_v20161128.enable_aws_service_access

            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.enable_aws_service_access.enable_aws_service_access(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def enable_policy_type(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.enable_policy_type(root_id='r-examplerootid111', policy_type='SERVICE_CONTROL_POLICY')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.enable_policy_type_request.EnablePolicyTypeRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.enable_policy_type_response.EnablePolicyTypeResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.enable_policy_type.enable_policy_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def invite_account_to_organization(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.invite_account_to_organization(notes="This is a request for Juan's account to join Bill's organization", target={'Type': 'EMAIL', 'Id': 'juan@example.com'})
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.invite_account_to_organization_request.InviteAccountToOrganizationRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.invite_account_to_organization_response.InviteAccountToOrganizationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.invite_account_to_organization.invite_account_to_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def invite_organization_to_transfer_responsibility(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.invite_organization_to_transfer_responsibility_request.InviteOrganizationToTransferResponsibilityRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.invite_organization_to_transfer_responsibility_response.InviteOrganizationToTransferResponsibilityResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.invite_organization_to_transfer_responsibility.invite_organization_to_transfer_responsibility(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def leave_organization(
        ...
        def _handler(req: "OperationRequest[None]") -> OperationResponse[None]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.leave_organization.leave_organization(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_accounts(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_accounts_request.ListAccountsRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_accounts_response.ListAccountsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_accounts.list_accounts(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_accounts_for_parent(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_accounts_for_parent(parent_id='ou-examplerootid111-exampleouid111')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_accounts_for_parent_request.ListAccountsForParentRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_accounts_for_parent_response.ListAccountsForParentResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_accounts_for_parent.list_accounts_for_parent(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_accounts_with_invalid_effective_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_accounts_with_invalid_effective_policy(policy_type='BACKUP_POLICY')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_accounts_with_invalid_effective_policy_request.ListAccountsWithInvalidEffectivePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_accounts_with_invalid_effective_policy_response.ListAccountsWithInvalidEffectivePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_accounts_with_invalid_effective_policy.list_accounts_with_invalid_effective_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_accounts_with_invalid_effective_policy(
        self,
        policy_type: "aws_sdk_organizations.types.effective_policy_type.EffectivePolicyType",
        *,
        config_overrides: Optional[OrganizationsClientConfig] = None,
    ...
    ) -> "Iterator[aws_sdk_organizations.types.account.Account]":
        _token = next_token
        while True:
            _response = self.list_accounts_with_invalid_effective_policy(
                policy_type,
    ...
    def list_aws_service_access_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_aws_service_access_for_organization_request.ListAWSServiceAccessForOrganizationRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_aws_service_access_for_organization_response.ListAWSServiceAccessForOrganizationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_aws_service_access_for_organization.list_aws_service_access_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_children(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_children(child_type='ORGANIZATIONAL_UNIT', parent_id='ou-examplerootid111-exampleouid111')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_children_request.ListChildrenRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_children_response.ListChildrenResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_children.list_children(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_create_account_status(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_create_account_status(states=['IN_PROGRESS'])
            ...
            >>> client.list_create_account_status(states=['SUCCEEDED'])
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_create_account_status_request.ListCreateAccountStatusRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_create_account_status_response.ListCreateAccountStatusResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_create_account_status.list_create_account_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_delegated_administrators(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_delegated_administrators_request.ListDelegatedAdministratorsRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_delegated_administrators_response.ListDelegatedAdministratorsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_delegated_administrators.list_delegated_administrators(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_delegated_administrators(
        self,
        *,
        config_overrides: Optional[OrganizationsClientConfig] = None,
        service_principal: Optional[
    ...
    ) -> "Iterator[aws_sdk_organizations.types.delegated_administrator.DelegatedAdministrator]":
        _token = next_token
        while True:
            _response = self.list_delegated_administrators(
                config_overrides=config_overrides,
    ...
    def list_delegated_services_for_account(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_delegated_services_for_account_request.ListDelegatedServicesForAccountRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_delegated_services_for_account_response.ListDelegatedServicesForAccountResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_delegated_services_for_account.list_delegated_services_for_account(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_delegated_services_for_account(
        self,
        account_id: "aws_sdk_organizations.types.account_id.AccountId",
        *,
        config_overrides: Optional[OrganizationsClientConfig] = None,
    ...
    ) -> "Iterator[aws_sdk_organizations.types.delegated_service.DelegatedService]":
        _token = next_token
        while True:
            _response = self.list_delegated_services_for_account(
                account_id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def list_effective_policy_validation_errors(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_effective_policy_validation_errors_request.ListEffectivePolicyValidationErrorsRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_effective_policy_validation_errors_response.ListEffectivePolicyValidationErrorsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_effective_policy_validation_errors.list_effective_policy_validation_errors(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_effective_policy_validation_errors(
        self,
        account_id: "aws_sdk_organizations.types.account_id.AccountId",
        policy_type: "aws_sdk_organizations.types.effective_policy_type.EffectivePolicyType",
        *,
    ...
    ) -> "Iterator[aws_sdk_organizations.types.effective_policy_validation_error.EffectivePolicyValidationError]":
        _token = next_token
        while True:
            _response = self.list_effective_policy_validation_errors(
                account_id,
                policy_type,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    def list_handshakes_for_account(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_handshakes_for_account_request.ListHandshakesForAccountRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_handshakes_for_account_response.ListHandshakesForAccountResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_handshakes_for_account.list_handshakes_for_account(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_handshakes_for_organization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_handshakes_for_organization_request.ListHandshakesForOrganizationRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_handshakes_for_organization_response.ListHandshakesForOrganizationResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_handshakes_for_organization.list_handshakes_for_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_inbound_responsibility_transfers(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_inbound_responsibility_transfers_request.ListInboundResponsibilityTransfersRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_inbound_responsibility_transfers_response.ListInboundResponsibilityTransfersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_inbound_responsibility_transfers.list_inbound_responsibility_transfers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_organizational_units_for_parent(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_organizational_units_for_parent(parent_id='r-examplerootid111')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_organizational_units_for_parent_request.ListOrganizationalUnitsForParentRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_organizational_units_for_parent_response.ListOrganizationalUnitsForParentResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_organizational_units_for_parent.list_organizational_units_for_parent(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_outbound_responsibility_transfers(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_outbound_responsibility_transfers_request.ListOutboundResponsibilityTransfersRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_outbound_responsibility_transfers_response.ListOutboundResponsibilityTransfersResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_outbound_responsibility_transfers.list_outbound_responsibility_transfers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_parents(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_parents(child_id='444444444444')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_parents_request.ListParentsRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_parents_response.ListParentsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_parents.list_parents(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_policies_request.ListPoliciesRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_policies_response.ListPoliciesResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_policies.list_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_policies_for_target(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_policies_for_target(filter='SERVICE_CONTROL_POLICY', target_id='444444444444')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_policies_for_target_request.ListPoliciesForTargetRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_policies_for_target_response.ListPoliciesForTargetResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_policies_for_target.list_policies_for_target(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_roots(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_roots_request.ListRootsRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_roots_response.ListRootsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_roots.list_roots(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_tags_for_resource(
        ...
        *,
        config_overrides: Optional[OrganizationsClientConfig] = None,
        next_token: Optional["aws_sdk_organizations.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_organizations.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    def list_targets_for_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.list_targets_for_policy(policy_id='p-FullAWSAccess')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.list_targets_for_policy_request.ListTargetsForPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.list_targets_for_policy_response.ListTargetsForPolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.list_targets_for_policy.list_targets_for_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def move_account(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.move_account(account_id='333333333333', source_parent_id='r-examplerootid111', destination_parent_id='ou-examplerootid111-exampleouid111')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.move_account_request.MoveAccountRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_organizations._operations.aws_organizations_v20161128.move_account

            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.move_account.move_account(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.put_resource_policy_request.PutResourcePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.put_resource_policy_response.PutResourcePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.put_resource_policy.put_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_delegated_administrator(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.register_delegated_administrator_request.RegisterDelegatedAdministratorRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_organizations._operations.aws_organizations_v20161128.register_delegated_administrator

            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.register_delegated_administrator.register_delegated_administrator(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_account_from_organization(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.remove_account_from_organization(account_id='333333333333')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.remove_account_from_organization_request.RemoveAccountFromOrganizationRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_organizations._operations.aws_organizations_v20161128.remove_account_from_organization

            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.remove_account_from_organization.remove_account_from_organization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_organizations._operations.aws_organizations_v20161128.tag_resource

            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def terminate_responsibility_transfer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.terminate_responsibility_transfer_request.TerminateResponsibilityTransferRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.terminate_responsibility_transfer_response.TerminateResponsibilityTransferResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.terminate_responsibility_transfer.terminate_responsibility_transfer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[None]:
            import aws_sdk_organizations._operations.aws_organizations_v20161128.untag_resource

            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_organizational_unit(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_organizational_unit(organizational_unit_id='ou-examplerootid111-exampleouid111', name='AccountingOU')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.update_organizational_unit_request.UpdateOrganizationalUnitRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.update_organizational_unit_response.UpdateOrganizationalUnitResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.update_organizational_unit.update_organizational_unit(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_policy(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.update_policy(policy_id='p-examplepolicyid111', content='{ \\"Version\\": \\"2012-10-17\\", \\"Statement\\": {\\"Effect\\": \\"Allow\\", \\"Action\\": \\"s3:*\\", \\"Resource\\": \\"*\\" } }')
            ...
            >>> client.update_policy(policy_id='p-examplepolicyid111', name='Renamed-Policy', description='This description replaces the original.')
        """

        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.update_policy_request.UpdatePolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.update_policy_response.UpdatePolicyResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.update_policy.update_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_responsibility_transfer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_organizations.types.update_responsibility_transfer_request.UpdateResponsibilityTransferRequest]",
        ) -> OperationResponse[
            "aws_sdk_organizations.types.update_responsibility_transfer_response.UpdateResponsibilityTransferResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_organizations._operations.aws_organizations_v20161128.update_responsibility_transfer.update_responsibility_transfer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
