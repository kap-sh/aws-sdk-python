...
class AsyncOrganizationsClient:
    ...
    def __init__(
        ...
        self.config = AsyncOrganizationsClientConfig(
            {
    ...
    async def decline_handshake(
        ...
        *,
        ...
        """<p>Declines a <a>Handshake</a>.</p> <p>Only the account that receives a handshake can call this operation. The sender of the handshake can use <a>CancelHandshake</a> to cancel if the handshake hasn't yet been responded to.</p> <p>You can view canceled handshakes in API responses for 30 days before they are deleted.</p>
    ...
    async def delete_organizational_unit(
        ...
        *,
        ...
        """<p>Deletes an organizational unit (OU) from a root or another OU. You must first remove all accounts and child OUs from the OU that you want to delete.</p> <p>You can only call this operation from the management account.</p>
    ...
    async def delete_policy(
        ...
        *,
        ...
        """<p>Deletes the specified policy from your organization. Before you perform this operation, you must first detach the policy from all organizational units (OUs), roots, and accounts.</p> <p>You can only call this operation from the management account or a member account that is a delegated administrator.</p>
    ...
    async def describe_account(
        ...
        *,
        ...
        """<p>Retrieves Organizations-related information about the specified account.</p> <p>You can only call this operation from the management account or a member account that is a delegated administrator.</p>
    ...
    async def describe_create_account_status(
        ...
        *,
        ...
        """<p>Retrieves the current status of an asynchronous request to create an account.</p> <p>You can only call this operation from the management account or a member account that is a delegated administrator.</p>
    ...
    async def describe_organizational_unit(
        ...
        *,
        ...
        """<p>Retrieves information about an organizational unit (OU).</p> <p>You can only call this operation from the management account or a member account that is a delegated administrator.</p>
    ...
    async def describe_policy(
        ...
        *,
        ...
        """<p>Retrieves information about a policy.</p> <p>You can only call this operation from the management account or a member account that is a delegated administrator.</p>
    ...
    async def invite_organization_to_transfer_responsibility(
        ...
        *,
        ...
        """<p>Sends an invitation to another organization's management account to designate your account with the specified responsibilities for their organization. The invitation is implemented as a <a>Handshake</a> whose details are in the response.</p> <p>You can only call this operation from the management account.</p>
    ...
    async def list_children(
        ...
        *,
        ...
        """<p>Lists all of the organizational units (OUs) or accounts that are contained in the specified parent OU or root. This operation, along with <a>ListParents</a> enables you to traverse the tree structure that makes up this root.</p> <note> <p>When calling List* operations, always check the <code>NextToken</code> response parameter value, even if you receive an empty result set. These operations can occasionally return an empty set of results even when more results are available. Continue making requests until <code>NextToken</code> returns null. A null <code>NextToken</code> value indicates that you have retrieved all available results.</p> </note> <p>You can only call this operation from the management account or a member account that is a delegated administrator.</p>
    ...
    async def list_organizational_units_for_parent(
        ...
        *,
        ...
        """<p>Lists the organizational units (OUs) in a parent organizational unit or root.</p> <note> <p>When calling List* operations, always check the <code>NextToken</code> response parameter value, even if you receive an empty result set. These operations can occasionally return an empty set of results even when more results are available. Continue making requests until <code>NextToken</code> returns null. A null <code>NextToken</code> value indicates that you have retrieved all available results.</p> </note> <p>You can only call this operation from the management account or a member account that is a delegated administrator.</p>
    ...
    async def list_parents(
        ...
        *,
        ...
        """<p>Lists the root or organizational units (OUs) that serve as the immediate parent of the specified child OU or account. This operation, along with <a>ListChildren</a> enables you to traverse the tree structure that makes up this root.</p> <note> <p>When calling List* operations, always check the <code>NextToken</code> response parameter value, even if you receive an empty result set. These operations can occasionally return an empty set of results even when more results are available. Continue making requests until <code>NextToken</code> returns null. A null <code>NextToken</code> value indicates that you have retrieved all available results.</p> </note> <p>You can only call this operation from the management account or a member account that is a delegated administrator.</p> <note> <p>In the current release, a child can have only a single parent.</p> </note>
    ...
    async def move_account(
        ...
        *,
        ...
        """<p>Moves an account from its current source parent root or organizational unit (OU) to the specified destination parent root or OU.</p> <p>You can only call this operation from the management account.</p>
    ...
    async def put_resource_policy(
        ...
        *,
        ...
        """<p>Creates or updates a resource policy.</p> <p>You can only call this operation from the management account..</p>
    ...
    async def update_organizational_unit(
        ...
        *,
        ...
        """<p>Renames the specified organizational unit (OU). The ID and ARN don't change. The child OUs and accounts remain in place, and any attached policies of the OU remain attached.</p> <p>You can only call this operation from the management account.</p>
    ...
    async def update_policy(
        ...
        *,
        ...
        """<p>Updates an existing policy with a new name, description, or content. If you don't supply any parameter, that value remains unchanged. You can't change a policy's type.</p> <p>You can only call this operation from the management account or a member account that is a delegated administrator.</p>
