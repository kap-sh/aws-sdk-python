...
```
pip install aws-sdk-notificationscontacts
```

## Usage

```python
from aws_sdk_notificationscontacts import AsyncNotificationsContactsClient


async def main():
    async with AsyncNotificationsContactsClient() as s3:
...
```python
from aws_sdk_notificationscontacts import AsyncNotificationsContactsClient
from aws_sdk_notificationscontacts.error import AccessDeniedException
