...
from ._services.async_notifications_contacts import (
    AsyncNotificationsContactsClient as AsyncNotificationsContactsClient,
)
from ._services.notifications_contacts import (
    NotificationsContactsClient as NotificationsContactsClient,
)
