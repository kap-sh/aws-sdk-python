...
class NotificationsContactsError(Exception):
    """Base class for all NotificationsContacts service errors."""


class ServiceError(NotificationsContactsError):
...
class SerializationError(NotificationsContactsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(NotificationsContactsError):
...
class WaiterFailedError(NotificationsContactsError):
...
class WaiterTimeoutError(NotificationsContactsError):
