"""Generated from Smithy shape ``com.amazonaws.notificationscontacts#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.notificationscontacts#InternalServerException``."""
