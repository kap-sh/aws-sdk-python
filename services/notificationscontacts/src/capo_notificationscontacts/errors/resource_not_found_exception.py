"""Generated from Smithy shape ``com.amazonaws.notificationscontacts#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.notificationscontacts#ResourceNotFoundException``."""
