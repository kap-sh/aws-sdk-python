"""Generated from Smithy shape ``com.amazonaws.notificationscontacts#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.notificationscontacts#AccessDeniedException``."""
