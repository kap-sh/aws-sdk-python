...
if TYPE_CHECKING:
    ...
    import aws_sdk_arc_zonal_shift.types.list_zonal_shifts_request
    import aws_sdk_arc_zonal_shift.types.list_zonal_shifts_response
    import aws_sdk_arc_zonal_shift.types.max_results
    import aws_sdk_arc_zonal_shift.types.resource_identifier
    import aws_sdk_arc_zonal_shift.types.start_practice_run_request
    import aws_sdk_arc_zonal_shift.types.start_practice_run_response
...
class ZonalShifts:
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_arc_zonal_shift.types.list_zonal_shifts_response.ListZonalShiftsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_arc_zonal_shift.types.list_zonal_shifts_request.ListZonalShiftsRequest]",
        ) -> OperationResponse[
            "aws_sdk_arc_zonal_shift.types.list_zonal_shifts_response.ListZonalShiftsResponse"
        ]:
            import aws_sdk_arc_zonal_shift._operations.perc_data_plane.list_zonal_shifts

            output, http_response = (
                aws_sdk_arc_zonal_shift._operations.perc_data_plane.list_zonal_shifts.list_zonal_shifts(
        ...
        input: aws_sdk_arc_zonal_shift.types.list_zonal_shifts_request.ListZonalShiftsRequest = {}  # type: ignore[typeddict-item]
    ...
    def start_practice_run(
        ...
        *,
        config_overrides: Optional[ARCZonalShiftClientConfig] = None,
    ) -> "aws_sdk_arc_zonal_shift.types.start_practice_run_response.StartPracticeRunResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_arc_zonal_shift.types.start_practice_run_request.StartPracticeRunRequest]",
        ) -> OperationResponse[
            "aws_sdk_arc_zonal_shift.types.start_practice_run_response.StartPracticeRunResponse"
        ]:
            import aws_sdk_arc_zonal_shift._operations.perc_data_plane.start_practice_run

            output, http_response = (
                aws_sdk_arc_zonal_shift._operations.perc_data_plane.start_practice_run.start_practice_run(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input: aws_sdk_arc_zonal_shift.types.start_practice_run_request.StartPracticeRunRequest = {}  # type: ignore[typeddict-item]
        input["resource_identifier"] = resource_identifier
        input["away_from"] = away_from
    ...
    def start_zonal_shift(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_arc_zonal_shift.types.start_zonal_shift_request.StartZonalShiftRequest]",
        ) -> OperationResponse["aws_sdk_arc_zonal_shift.types.zonal_shift.ZonalShift"]:
            import aws_sdk_arc_zonal_shift._operations.perc_data_plane.start_zonal_shift

            output, http_response = (
                aws_sdk_arc_zonal_shift._operations.perc_data_plane.start_zonal_shift.start_zonal_shift(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self._service.operation_options(config_overrides)
        input: aws_sdk_arc_zonal_shift.types.start_zonal_shift_request.StartZonalShiftRequest = {}  # type: ignore[typeddict-item]
        input["resource_identifier"] = resource_identifier
        input["away_from"] = away_from
...
class AsyncZonalShifts:
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_zonal_shift.types.list_zonal_shifts_request.ListZonalShiftsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_zonal_shift.types.list_zonal_shifts_response.ListZonalShiftsResponse"
        ]:
            import aws_sdk_arc_zonal_shift._operations.perc_data_plane.list_zonal_shifts
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_zonal_shift._operations.perc_data_plane.list_zonal_shifts.async_list_zonal_shifts(
                req.options, req.input
            )
    ...
    async def start_practice_run(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_zonal_shift.types.start_practice_run_request.StartPracticeRunRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_zonal_shift.types.start_practice_run_response.StartPracticeRunResponse"
        ]:
            import aws_sdk_arc_zonal_shift._operations.perc_data_plane.start_practice_run
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_zonal_shift._operations.perc_data_plane.start_practice_run.async_start_practice_run(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_zonal_shift(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_arc_zonal_shift.types.start_zonal_shift_request.StartZonalShiftRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_arc_zonal_shift.types.zonal_shift.ZonalShift"
        ]:
            import aws_sdk_arc_zonal_shift._operations.perc_data_plane.start_zonal_shift
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_arc_zonal_shift._operations.perc_data_plane.start_zonal_shift.async_start_zonal_shift(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
