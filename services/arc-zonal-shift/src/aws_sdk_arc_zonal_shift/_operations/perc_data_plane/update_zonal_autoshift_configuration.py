...
def handle_response(
    ...
    out: aws_sdk_arc_zonal_shift.types.update_zonal_autoshift_configuration_response.UpdateZonalAutoshiftConfigurationResponse = aws_sdk_arc_zonal_shift.types.update_zonal_autoshift_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_arc_zonal_shift.types.update_zonal_autoshift_configuration_request.UpdateZonalAutoshiftConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_arc_zonal_shift.types.update_zonal_autoshift_configuration_request.serialize_json(
            input_
        )
    ).encode()
