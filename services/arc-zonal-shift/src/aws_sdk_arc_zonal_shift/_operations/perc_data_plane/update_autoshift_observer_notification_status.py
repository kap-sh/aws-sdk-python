...
def handle_response(
    ...
    out: aws_sdk_arc_zonal_shift.types.update_autoshift_observer_notification_status_response.UpdateAutoshiftObserverNotificationStatusResponse = aws_sdk_arc_zonal_shift.types.update_autoshift_observer_notification_status_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_arc_zonal_shift.types.update_autoshift_observer_notification_status_request.UpdateAutoshiftObserverNotificationStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_arc_zonal_shift.types.update_autoshift_observer_notification_status_request.serialize_json(
            input_
        )
    ).encode()
