...
def handle_response(
    ...
    out: aws_sdk_arc_zonal_shift.types.get_managed_resource_response.GetManagedResourceResponse = aws_sdk_arc_zonal_shift.types.get_managed_resource_response.deserialize_json(
