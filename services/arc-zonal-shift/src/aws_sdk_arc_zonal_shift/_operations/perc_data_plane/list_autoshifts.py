...
def handle_response(
    ...
    out: aws_sdk_arc_zonal_shift.types.list_autoshifts_response.ListAutoshiftsResponse = aws_sdk_arc_zonal_shift.types.list_autoshifts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_arc_zonal_shift.types.list_autoshifts_request.ListAutoshiftsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
