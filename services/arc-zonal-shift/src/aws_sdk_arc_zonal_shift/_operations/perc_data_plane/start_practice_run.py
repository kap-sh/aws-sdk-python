...
def handle_response(
    ...
    out: aws_sdk_arc_zonal_shift.types.start_practice_run_response.StartPracticeRunResponse = aws_sdk_arc_zonal_shift.types.start_practice_run_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_arc_zonal_shift.types.start_practice_run_request.StartPracticeRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_arc_zonal_shift.types.start_practice_run_request.serialize_json(input_)
    ).encode()
