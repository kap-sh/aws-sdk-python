...
def build_request(
    ...
    input: aws_sdk_arc_zonal_shift.types.start_practice_run_request.StartPracticeRunRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_arc_zonal_shift.types.start_practice_run_request.serialize_json(input)
    ).encode()
