...
def handle_response(
    ...
    out: aws_sdk_arc_zonal_shift.types.list_managed_resources_response.ListManagedResourcesResponse = aws_sdk_arc_zonal_shift.types.list_managed_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_arc_zonal_shift.types.list_managed_resources_request.ListManagedResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
