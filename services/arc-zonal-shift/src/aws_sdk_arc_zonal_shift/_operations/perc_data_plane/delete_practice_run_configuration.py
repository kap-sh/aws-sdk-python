"""Generated from Smithy shape ``com.amazonaws.arczonalshift#DeletePracticeRunConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_arc_zonal_shift.types.delete_practice_run_configuration_response.DeletePracticeRunConfigurationResponse = aws_sdk_arc_zonal_shift.types.delete_practice_run_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_arc_zonal_shift.types.delete_practice_run_configuration_request.DeletePracticeRunConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_practice_run_configuration(
