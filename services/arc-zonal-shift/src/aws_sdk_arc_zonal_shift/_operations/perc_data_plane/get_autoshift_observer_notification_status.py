"""Generated from Smithy shape ``com.amazonaws.arczonalshift#GetAutoshiftObserverNotificationStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_arc_zonal_shift.types.get_autoshift_observer_notification_status_response.GetAutoshiftObserverNotificationStatusResponse = aws_sdk_arc_zonal_shift.types.get_autoshift_observer_notification_status_response.deserialize_json(
