...
def handle_response(
    ...
    out: aws_sdk_arc_zonal_shift.types.cancel_practice_run_response.CancelPracticeRunResponse = aws_sdk_arc_zonal_shift.types.cancel_practice_run_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_arc_zonal_shift.types.cancel_practice_run_request.CancelPracticeRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
