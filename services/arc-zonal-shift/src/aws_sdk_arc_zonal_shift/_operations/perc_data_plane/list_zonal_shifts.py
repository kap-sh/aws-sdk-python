...
def handle_response(
    ...
    out: aws_sdk_arc_zonal_shift.types.list_zonal_shifts_response.ListZonalShiftsResponse = aws_sdk_arc_zonal_shift.types.list_zonal_shifts_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_arc_zonal_shift.types.list_zonal_shifts_request.ListZonalShiftsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
