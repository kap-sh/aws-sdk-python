...
def handle_response(
    ...
    out: aws_sdk_arc_zonal_shift.types.create_practice_run_configuration_response.CreatePracticeRunConfigurationResponse = aws_sdk_arc_zonal_shift.types.create_practice_run_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_arc_zonal_shift.types.create_practice_run_configuration_request.CreatePracticeRunConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_arc_zonal_shift.types.create_practice_run_configuration_request.serialize_json(
            input_
        )
    ).encode()
