...
class ARCZonalShiftError(Exception):
    """Base class for all ARCZonalShift service errors."""


class ServiceError(ARCZonalShiftError):
...
class SerializationError(ARCZonalShiftError):
    """Raised when a value cannot be serialized."""


class DeserializationError(ARCZonalShiftError):
...
class WaiterFailedError(ARCZonalShiftError):
...
class WaiterTimeoutError(ARCZonalShiftError):
