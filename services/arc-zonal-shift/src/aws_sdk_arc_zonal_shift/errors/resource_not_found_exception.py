"""Generated from Smithy shape ``com.amazonaws.arczonalshift#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.arczonalshift#ResourceNotFoundException``."""
