...
class GetManagedResourceResponse(TypedDict):
    ...
    applied_weights: "aws_sdk_arc_zonal_shift.types.applied_weights.AppliedWeights"
    ...
    practice_run_configuration: NotRequired[
        "aws_sdk_arc_zonal_shift.types.practice_run_configuration.PracticeRunConfiguration"
    ]
