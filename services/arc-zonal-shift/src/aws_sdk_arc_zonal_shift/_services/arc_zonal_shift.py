...
from aws_sdk_arc_zonal_shift._resources.perc_data_plane.zonal_shifts import ZonalShifts
from aws_sdk_arc_zonal_shift._services._aws_config import aws_config
