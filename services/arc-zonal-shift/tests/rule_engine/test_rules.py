import pytest
from aws_sdk_arc_zonal_shift._rule_engine._endpoint_rule_set import EndpointParams, resolve
from aws_sdk_arc_zonal_shift._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_1_for_region_us_east_1_with_fips_enabled_a():
    ...
    assert result.url == 'https://arc-zonal-shift-fips.us-east-1.api.aws'
...
def test_2_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://arc-zonal-shift-fips.us-east-1.amazonaws.com'
...
def test_3_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://arc-zonal-shift.us-east-1.api.aws'
...
def test_4_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://arc-zonal-shift.us-east-1.amazonaws.com'
...
def test_5_for_region_cn_north_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://arc-zonal-shift-fips.cn-north-1.api.amazonwebservices.com.cn'
...
def test_6_for_region_cn_north_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://arc-zonal-shift-fips.cn-north-1.amazonaws.com.cn'
...
def test_7_for_region_cn_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://arc-zonal-shift.cn-north-1.api.amazonwebservices.com.cn'
...
def test_8_for_region_cn_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://arc-zonal-shift.cn-north-1.amazonaws.com.cn'
...
def test_9_for_region_us_gov_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://arc-zonal-shift-fips.us-gov-east-1.api.aws'
...
def test_10_for_region_us_gov_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://arc-zonal-shift-fips.us-gov-east-1.amazonaws.com'
...
def test_11_for_region_us_gov_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://arc-zonal-shift.us-gov-east-1.api.aws'
...
def test_12_for_region_us_gov_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://arc-zonal-shift.us-gov-east-1.amazonaws.com'
...
def test_13_for_region_us_iso_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://arc-zonal-shift-fips.us-iso-east-1.c2s.ic.gov'
...
def test_14_for_region_us_iso_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://arc-zonal-shift.us-iso-east-1.c2s.ic.gov'
...
def test_15_for_region_us_isob_east_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://arc-zonal-shift-fips.us-isob-east-1.sc2s.sgov.gov'
...
def test_16_for_region_us_isob_east_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://arc-zonal-shift.us-isob-east-1.sc2s.sgov.gov'
