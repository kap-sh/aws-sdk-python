...
def handle_response(
    ...
    out: aws_sdk_billing.types.delete_billing_view_response.DeleteBillingViewResponse = aws_sdk_billing.types.delete_billing_view_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_billing.types.delete_billing_view_request.DeleteBillingViewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billing.types.delete_billing_view_request.serialize_aws_json_1_0(input_)
    ).encode()
