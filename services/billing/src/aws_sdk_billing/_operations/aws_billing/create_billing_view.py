...
def handle_response(
    ...
    out: aws_sdk_billing.types.create_billing_view_response.CreateBillingViewResponse = aws_sdk_billing.types.create_billing_view_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_billing.types.create_billing_view_request.CreateBillingViewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billing.types.create_billing_view_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_create_billing_view(
