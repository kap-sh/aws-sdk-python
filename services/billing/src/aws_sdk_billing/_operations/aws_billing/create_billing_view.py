...
def build_request(
    ...
    input: aws_sdk_billing.types.create_billing_view_request.CreateBillingViewRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billing.types.create_billing_view_request.serialize_aws_json_1_0(input)
    ).encode()
