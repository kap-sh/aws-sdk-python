...
def handle_response(
    ...
    out: aws_sdk_billing.types.disassociate_source_views_response.DisassociateSourceViewsResponse = aws_sdk_billing.types.disassociate_source_views_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_billing.types.disassociate_source_views_request.DisassociateSourceViewsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billing.types.disassociate_source_views_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
