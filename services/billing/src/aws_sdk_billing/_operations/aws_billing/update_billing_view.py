...
def build_request(
    ...
    input: aws_sdk_billing.types.update_billing_view_request.UpdateBillingViewRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billing.types.update_billing_view_request.serialize_aws_json_1_0(input)
    ).encode()
