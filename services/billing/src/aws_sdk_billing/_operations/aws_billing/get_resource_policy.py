...
def handle_response(
    ...
    out: aws_sdk_billing.types.get_resource_policy_response.GetResourcePolicyResponse = aws_sdk_billing.types.get_resource_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_billing.types.get_resource_policy_request.GetResourcePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billing.types.get_resource_policy_request.serialize_aws_json_1_0(input_)
    ).encode()
