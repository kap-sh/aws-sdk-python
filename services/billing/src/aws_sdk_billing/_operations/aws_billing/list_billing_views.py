...
def handle_response(
    ...
    out: aws_sdk_billing.types.list_billing_views_response.ListBillingViewsResponse = (
        aws_sdk_billing.types.list_billing_views_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_billing.types.list_billing_views_request.ListBillingViewsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billing.types.list_billing_views_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_list_billing_views(
