...
def build_request(
    ...
    input: aws_sdk_billing.types.list_billing_views_request.ListBillingViewsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billing.types.list_billing_views_request.serialize_aws_json_1_0(input)
    ).encode()
