...
def handle_response(
    ...
    out: aws_sdk_billing.types.list_source_views_for_billing_view_response.ListSourceViewsForBillingViewResponse = aws_sdk_billing.types.list_source_views_for_billing_view_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_billing.types.list_source_views_for_billing_view_request.ListSourceViewsForBillingViewRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_billing.types.list_source_views_for_billing_view_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_source_views_for_billing_view(
