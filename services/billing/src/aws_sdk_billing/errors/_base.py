...
class ServiceError(BillingError):
...
class SerializationError(BillingError):
    """Raised when a value cannot be serialized."""

class DeserializationError(BillingError):
...
class WaiterFailedError(BillingError):
...
class WaiterTimeoutError(BillingError):
