...
if TYPE_CHECKING:
    import capo_billing.types.resource_tag

ResourceTagList: TypeAlias = list["capo_billing.types.resource_tag.ResourceTag"]
...
def serialize_aws_json_1_0(value: ResourceTagList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_billing.types.resource_tag.serialize_aws_json_1_0(item))
    return out
