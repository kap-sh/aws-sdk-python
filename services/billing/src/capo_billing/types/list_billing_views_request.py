...
class ListBillingViewsRequest(TypedDict, closed=True):
    ...
    arns: NotRequired["capo_billing.types.billing_view_arn_list.BillingViewArnList"]
    ...
    names: NotRequired["capo_billing.types.string_searches.StringSearches"]
...
def serialize_aws_json_1_0(value: ListBillingViewsRequest) -> dict:
    ...
    if "active_time_range" in value:
        ...
        out["activeTimeRange"] = (
            capo_billing.types.active_time_range.serialize_aws_json_1_0(
    ...
    if "arns" in value:
        ...
        out["arns"] = capo_billing.types.billing_view_arn_list.serialize_aws_json_1_0(
            value["arns"]
        )
    if "billing_view_types" in value:
        ...
        out["billingViewTypes"] = (
            capo_billing.types.billing_view_type_list.serialize_aws_json_1_0(
    ...
    if "names" in value:
        ...
        out["names"] = capo_billing.types.string_searches.serialize_aws_json_1_0(
            value["names"]
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListBillingViewsRequest:
    ...
    if "activeTimeRange" in data:
        ...
        out["active_time_range"] = (
            capo_billing.types.active_time_range.deserialize_aws_json_1_0(
    ...
    if "billingViewTypes" in data:
        ...
        out["billing_view_types"] = (
            capo_billing.types.billing_view_type_list.deserialize_aws_json_1_0(
