...
import capo_billing.errors.billing_view_health_status_exception
import capo_billing.errors.conflict_exception
import capo_billing.errors.internal_server_exception
import capo_billing.errors.resource_not_found_exception
import capo_billing.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "BillingViewHealthStatusException":
            raise capo_billing.errors.billing_view_health_status_exception.BillingViewHealthStatusException.from_aws_json_1_0(
                data
            )
        case "ConflictException":
            raise capo_billing.errors.conflict_exception.ConflictException.from_aws_json_1_0(
                data
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_billing.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_0(
                data
            )
...
def handle_response(
    ...
    out: capo_billing.types.update_billing_view_response.UpdateBillingViewResponse = (
        capo_billing.types.update_billing_view_response.deserialize_aws_json_1_0(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or capo_billing._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billing.types.update_billing_view_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_update_billing_view(
