"""Generated from Smithy shape ``com.amazonaws.billing#TagResource``."""
...
def handle_response(
    ...
    out: capo_billing.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBilling.TagResource"
    body: bytes | None = json.dumps(
        capo_billing.types.tag_resource_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def tag_resource(
    ...
    capo_billing.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
