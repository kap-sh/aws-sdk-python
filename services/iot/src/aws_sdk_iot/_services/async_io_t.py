...
from aws_sdk_iot._services._aws_config import aaws_config
...
class AsyncIoTClientConfig(TypedDict, total=False):
...
class AsyncIoTClient:
    ...
    def __init__(
        ...
        self._config = AsyncIoTClientConfig(
            {
    ...
    def operation_options(
        ...
        overrides: AsyncIoTClientConfig = config_overrides or {}
    ...
    async def accept_certificate_transfer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.accept_certificate_transfer_request.AcceptCertificateTransferRequest]",
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.accept_certificate_transfer.async_accept_certificate_transfer(
    ...
    async def add_thing_to_billing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.add_thing_to_billing_group_request.AddThingToBillingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.add_thing_to_billing_group_response.AddThingToBillingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.add_thing_to_billing_group.async_add_thing_to_billing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def add_thing_to_thing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.add_thing_to_thing_group_request.AddThingToThingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.add_thing_to_thing_group_response.AddThingToThingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.add_thing_to_thing_group.async_add_thing_to_thing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def associate_sbom_with_package_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.associate_sbom_with_package_version_request.AssociateSbomWithPackageVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.associate_sbom_with_package_version_response.AssociateSbomWithPackageVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.associate_sbom_with_package_version.async_associate_sbom_with_package_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def associate_targets_with_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.associate_targets_with_job_request.AssociateTargetsWithJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.associate_targets_with_job_response.AssociateTargetsWithJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.associate_targets_with_job.async_associate_targets_with_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def attach_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.attach_policy_request.AttachPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.attach_policy.async_attach_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def attach_principal_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.attach_principal_policy_request.AttachPrincipalPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.attach_principal_policy.async_attach_principal_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def attach_security_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.attach_security_profile_request.AttachSecurityProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.attach_security_profile_response.AttachSecurityProfileResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.attach_security_profile.async_attach_security_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def attach_thing_principal(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.attach_thing_principal_request.AttachThingPrincipalRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.attach_thing_principal_response.AttachThingPrincipalResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.attach_thing_principal.async_attach_thing_principal(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_audit_mitigation_actions_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.cancel_audit_mitigation_actions_task_request.CancelAuditMitigationActionsTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.cancel_audit_mitigation_actions_task_response.CancelAuditMitigationActionsTaskResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.cancel_audit_mitigation_actions_task.async_cancel_audit_mitigation_actions_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_audit_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.cancel_audit_task_request.CancelAuditTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.cancel_audit_task_response.CancelAuditTaskResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.cancel_audit_task.async_cancel_audit_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_certificate_transfer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.cancel_certificate_transfer_request.CancelCertificateTransferRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.cancel_certificate_transfer.async_cancel_certificate_transfer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_detect_mitigation_actions_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.cancel_detect_mitigation_actions_task_request.CancelDetectMitigationActionsTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.cancel_detect_mitigation_actions_task_response.CancelDetectMitigationActionsTaskResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.cancel_detect_mitigation_actions_task.async_cancel_detect_mitigation_actions_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.cancel_job_request.CancelJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.cancel_job_response.CancelJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.cancel_job.async_cancel_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_job_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.cancel_job_execution_request.CancelJobExecutionRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.cancel_job_execution.async_cancel_job_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def clear_default_authorizer(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.clear_default_authorizer.async_clear_default_authorizer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def confirm_topic_rule_destination(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.confirm_topic_rule_destination_request.ConfirmTopicRuleDestinationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.confirm_topic_rule_destination_response.ConfirmTopicRuleDestinationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.confirm_topic_rule_destination.async_confirm_topic_rule_destination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_audit_suppression(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_audit_suppression_request.CreateAuditSuppressionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_audit_suppression_response.CreateAuditSuppressionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_audit_suppression.async_create_audit_suppression(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_authorizer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_authorizer_request.CreateAuthorizerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_authorizer_response.CreateAuthorizerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_authorizer.async_create_authorizer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_billing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_billing_group_request.CreateBillingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_billing_group_response.CreateBillingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_billing_group.async_create_billing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_certificate_from_csr(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_certificate_from_csr_request.CreateCertificateFromCsrRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_certificate_from_csr_response.CreateCertificateFromCsrResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_certificate_from_csr.async_create_certificate_from_csr(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_certificate_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_certificate_provider_request.CreateCertificateProviderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_certificate_provider_response.CreateCertificateProviderResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_certificate_provider.async_create_certificate_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_command(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_command_request.CreateCommandRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_command_response.CreateCommandResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_command.async_create_command(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_custom_metric(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_custom_metric_request.CreateCustomMetricRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_custom_metric_response.CreateCustomMetricResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_custom_metric.async_create_custom_metric(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_dimension(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_dimension_request.CreateDimensionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_dimension_response.CreateDimensionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_dimension.async_create_dimension(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_domain_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_domain_configuration_request.CreateDomainConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_domain_configuration_response.CreateDomainConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_domain_configuration.async_create_domain_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_dynamic_thing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_dynamic_thing_group_request.CreateDynamicThingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_dynamic_thing_group_response.CreateDynamicThingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_dynamic_thing_group.async_create_dynamic_thing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_fleet_metric(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_fleet_metric_request.CreateFleetMetricRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_fleet_metric_response.CreateFleetMetricResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_fleet_metric.async_create_fleet_metric(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_job_request.CreateJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_job_response.CreateJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_job.async_create_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_job_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_job_template_request.CreateJobTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_job_template_response.CreateJobTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_job_template.async_create_job_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_keys_and_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_keys_and_certificate_request.CreateKeysAndCertificateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_keys_and_certificate_response.CreateKeysAndCertificateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_keys_and_certificate.async_create_keys_and_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_mitigation_action(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_mitigation_action_request.CreateMitigationActionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_mitigation_action_response.CreateMitigationActionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_mitigation_action.async_create_mitigation_action(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_ota_update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_ota_update_request.CreateOTAUpdateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_ota_update_response.CreateOTAUpdateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_ota_update.async_create_ota_update(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_package(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_package_request.CreatePackageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_package_response.CreatePackageResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_package.async_create_package(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_package_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_package_version_request.CreatePackageVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_package_version_response.CreatePackageVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_package_version.async_create_package_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_policy_request.CreatePolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_policy_response.CreatePolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_policy.async_create_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_policy_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_policy_version_request.CreatePolicyVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_policy_version_response.CreatePolicyVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_policy_version.async_create_policy_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_provisioning_claim(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_provisioning_claim_request.CreateProvisioningClaimRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_provisioning_claim_response.CreateProvisioningClaimResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_provisioning_claim.async_create_provisioning_claim(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_provisioning_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_provisioning_template_request.CreateProvisioningTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_provisioning_template_response.CreateProvisioningTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_provisioning_template.async_create_provisioning_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_provisioning_template_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_provisioning_template_version_request.CreateProvisioningTemplateVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_provisioning_template_version_response.CreateProvisioningTemplateVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_provisioning_template_version.async_create_provisioning_template_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_role_alias(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_role_alias_request.CreateRoleAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_role_alias_response.CreateRoleAliasResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_role_alias.async_create_role_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_scheduled_audit(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_scheduled_audit_request.CreateScheduledAuditRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_scheduled_audit_response.CreateScheduledAuditResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_scheduled_audit.async_create_scheduled_audit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_security_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_security_profile_request.CreateSecurityProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_security_profile_response.CreateSecurityProfileResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_security_profile.async_create_security_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_stream(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_stream_request.CreateStreamRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_stream_response.CreateStreamResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_stream.async_create_stream(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_thing(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_thing_request.CreateThingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_thing_response.CreateThingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_thing.async_create_thing(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_thing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_thing_group_request.CreateThingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_thing_group_response.CreateThingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_thing_group.async_create_thing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_thing_type(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_thing_type_request.CreateThingTypeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_thing_type_response.CreateThingTypeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_thing_type.async_create_thing_type(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_topic_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_topic_rule_request.CreateTopicRuleRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_topic_rule.async_create_topic_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_topic_rule_destination(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.create_topic_rule_destination_request.CreateTopicRuleDestinationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.create_topic_rule_destination_response.CreateTopicRuleDestinationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.create_topic_rule_destination.async_create_topic_rule_destination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_account_audit_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_account_audit_configuration_request.DeleteAccountAuditConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_account_audit_configuration_response.DeleteAccountAuditConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_account_audit_configuration.async_delete_account_audit_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_audit_suppression.async_delete_audit_suppression(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_authorizer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_authorizer_request.DeleteAuthorizerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_authorizer_response.DeleteAuthorizerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_authorizer.async_delete_authorizer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_billing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_billing_group_request.DeleteBillingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_billing_group_response.DeleteBillingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_billing_group.async_delete_billing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_ca_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_ca_certificate_request.DeleteCACertificateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_ca_certificate_response.DeleteCACertificateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_ca_certificate.async_delete_ca_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_certificate_request.DeleteCertificateRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_certificate.async_delete_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_certificate_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_certificate_provider_request.DeleteCertificateProviderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_certificate_provider_response.DeleteCertificateProviderResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_certificate_provider.async_delete_certificate_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_command(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_command_request.DeleteCommandRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_command_response.DeleteCommandResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_command.async_delete_command(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_command_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_command_execution_request.DeleteCommandExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_command_execution_response.DeleteCommandExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_command_execution.async_delete_command_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_custom_metric(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_custom_metric_request.DeleteCustomMetricRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_custom_metric_response.DeleteCustomMetricResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_custom_metric.async_delete_custom_metric(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_dimension(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_dimension_request.DeleteDimensionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_dimension_response.DeleteDimensionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_dimension.async_delete_dimension(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_domain_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_domain_configuration_request.DeleteDomainConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_domain_configuration_response.DeleteDomainConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_domain_configuration.async_delete_domain_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_dynamic_thing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_dynamic_thing_group_request.DeleteDynamicThingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_dynamic_thing_group_response.DeleteDynamicThingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_dynamic_thing_group.async_delete_dynamic_thing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_fleet_metric(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_fleet_metric_request.DeleteFleetMetricRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_fleet_metric.async_delete_fleet_metric(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_job_request.DeleteJobRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_job.async_delete_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_job_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_job_execution_request.DeleteJobExecutionRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_job_execution.async_delete_job_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_job_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_job_template_request.DeleteJobTemplateRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_job_template.async_delete_job_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_mitigation_action(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_mitigation_action_request.DeleteMitigationActionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_mitigation_action_response.DeleteMitigationActionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_mitigation_action.async_delete_mitigation_action(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_ota_update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_ota_update_request.DeleteOTAUpdateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_ota_update_response.DeleteOTAUpdateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_ota_update.async_delete_ota_update(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_package(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_package_request.DeletePackageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_package_response.DeletePackageResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_package.async_delete_package(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_package_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_package_version_request.DeletePackageVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_package_version_response.DeletePackageVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_package_version.async_delete_package_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_policy_request.DeletePolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_policy.async_delete_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_policy_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_policy_version_request.DeletePolicyVersionRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_policy_version.async_delete_policy_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_provisioning_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_provisioning_template_request.DeleteProvisioningTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_provisioning_template_response.DeleteProvisioningTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_provisioning_template.async_delete_provisioning_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_provisioning_template_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_provisioning_template_version_request.DeleteProvisioningTemplateVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_provisioning_template_version_response.DeleteProvisioningTemplateVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_provisioning_template_version.async_delete_provisioning_template_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_registration_code(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_registration_code.async_delete_registration_code(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_role_alias(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_role_alias_request.DeleteRoleAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_role_alias_response.DeleteRoleAliasResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_role_alias.async_delete_role_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_scheduled_audit(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_scheduled_audit_request.DeleteScheduledAuditRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_scheduled_audit_response.DeleteScheduledAuditResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_scheduled_audit.async_delete_scheduled_audit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_security_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_security_profile_request.DeleteSecurityProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_security_profile_response.DeleteSecurityProfileResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_security_profile.async_delete_security_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_stream(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_stream_request.DeleteStreamRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_stream_response.DeleteStreamResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_stream.async_delete_stream(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_thing(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_thing_request.DeleteThingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_thing_response.DeleteThingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_thing.async_delete_thing(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_thing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_thing_group_request.DeleteThingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_thing_group_response.DeleteThingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_thing_group.async_delete_thing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_thing_type(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_thing_type_request.DeleteThingTypeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_thing_type_response.DeleteThingTypeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_thing_type.async_delete_thing_type(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_topic_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_topic_rule_request.DeleteTopicRuleRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_topic_rule.async_delete_topic_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_topic_rule_destination(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_topic_rule_destination_request.DeleteTopicRuleDestinationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.delete_topic_rule_destination_response.DeleteTopicRuleDestinationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_topic_rule_destination.async_delete_topic_rule_destination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_v2_logging_level(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.delete_v2_logging_level_request.DeleteV2LoggingLevelRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.delete_v2_logging_level.async_delete_v2_logging_level(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deprecate_thing_type(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.deprecate_thing_type_request.DeprecateThingTypeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.deprecate_thing_type_response.DeprecateThingTypeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.deprecate_thing_type.async_deprecate_thing_type(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_account_audit_configuration(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_account_audit_configuration.async_describe_account_audit_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_audit_finding(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_audit_finding_request.DescribeAuditFindingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_audit_finding_response.DescribeAuditFindingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_audit_finding.async_describe_audit_finding(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_audit_mitigation_actions_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_audit_mitigation_actions_task_request.DescribeAuditMitigationActionsTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_audit_mitigation_actions_task_response.DescribeAuditMitigationActionsTaskResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_audit_mitigation_actions_task.async_describe_audit_mitigation_actions_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_audit_suppression.async_describe_audit_suppression(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_audit_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_audit_task_request.DescribeAuditTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_audit_task_response.DescribeAuditTaskResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_audit_task.async_describe_audit_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_authorizer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_authorizer_request.DescribeAuthorizerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_authorizer_response.DescribeAuthorizerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_authorizer.async_describe_authorizer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_billing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_billing_group_request.DescribeBillingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_billing_group_response.DescribeBillingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_billing_group.async_describe_billing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_ca_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_ca_certificate_request.DescribeCACertificateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_ca_certificate_response.DescribeCACertificateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_ca_certificate.async_describe_ca_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_certificate_request.DescribeCertificateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_certificate_response.DescribeCertificateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_certificate.async_describe_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_certificate_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_certificate_provider_request.DescribeCertificateProviderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_certificate_provider_response.DescribeCertificateProviderResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_certificate_provider.async_describe_certificate_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_custom_metric(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_custom_metric_request.DescribeCustomMetricRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_custom_metric_response.DescribeCustomMetricResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_custom_metric.async_describe_custom_metric(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_default_authorizer(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_default_authorizer.async_describe_default_authorizer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_detect_mitigation_actions_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_detect_mitigation_actions_task_request.DescribeDetectMitigationActionsTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_detect_mitigation_actions_task_response.DescribeDetectMitigationActionsTaskResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_detect_mitigation_actions_task.async_describe_detect_mitigation_actions_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_dimension(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_dimension_request.DescribeDimensionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_dimension_response.DescribeDimensionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_dimension.async_describe_dimension(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_domain_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_domain_configuration_request.DescribeDomainConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_domain_configuration_response.DescribeDomainConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_domain_configuration.async_describe_domain_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_encryption_configuration(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_encryption_configuration.async_describe_encryption_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_endpoint(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_endpoint_request.DescribeEndpointRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_endpoint_response.DescribeEndpointResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_endpoint.async_describe_endpoint(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_event_configurations(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_event_configurations.async_describe_event_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_fleet_metric(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_fleet_metric_request.DescribeFleetMetricRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_fleet_metric_response.DescribeFleetMetricResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_fleet_metric.async_describe_fleet_metric(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_index(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_index_request.DescribeIndexRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_index_response.DescribeIndexResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_index.async_describe_index(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_job_request.DescribeJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_job_response.DescribeJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_job.async_describe_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_job_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_job_execution_request.DescribeJobExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_job_execution_response.DescribeJobExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_job_execution.async_describe_job_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_job_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_job_template_request.DescribeJobTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_job_template_response.DescribeJobTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_job_template.async_describe_job_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_managed_job_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_managed_job_template_request.DescribeManagedJobTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_managed_job_template_response.DescribeManagedJobTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_managed_job_template.async_describe_managed_job_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_mitigation_action(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_mitigation_action_request.DescribeMitigationActionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_mitigation_action_response.DescribeMitigationActionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_mitigation_action.async_describe_mitigation_action(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_provisioning_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_provisioning_template_request.DescribeProvisioningTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_provisioning_template_response.DescribeProvisioningTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_provisioning_template.async_describe_provisioning_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_provisioning_template_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_provisioning_template_version_request.DescribeProvisioningTemplateVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_provisioning_template_version_response.DescribeProvisioningTemplateVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_provisioning_template_version.async_describe_provisioning_template_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_role_alias(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_role_alias_request.DescribeRoleAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_role_alias_response.DescribeRoleAliasResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_role_alias.async_describe_role_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_scheduled_audit(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_scheduled_audit_request.DescribeScheduledAuditRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_scheduled_audit_response.DescribeScheduledAuditResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_scheduled_audit.async_describe_scheduled_audit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_security_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_security_profile_request.DescribeSecurityProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_security_profile_response.DescribeSecurityProfileResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_security_profile.async_describe_security_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_stream(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_stream_request.DescribeStreamRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_stream_response.DescribeStreamResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_stream.async_describe_stream(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_thing(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_thing_request.DescribeThingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_thing_response.DescribeThingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_thing.async_describe_thing(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_thing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_thing_group_request.DescribeThingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_thing_group_response.DescribeThingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_thing_group.async_describe_thing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_thing_registration_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_thing_registration_task_request.DescribeThingRegistrationTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_thing_registration_task_response.DescribeThingRegistrationTaskResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_thing_registration_task.async_describe_thing_registration_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_thing_type(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.describe_thing_type_request.DescribeThingTypeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.describe_thing_type_response.DescribeThingTypeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.describe_thing_type.async_describe_thing_type(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detach_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.detach_policy_request.DetachPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.detach_policy.async_detach_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detach_principal_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.detach_principal_policy_request.DetachPrincipalPolicyRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.detach_principal_policy.async_detach_principal_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detach_security_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.detach_security_profile_request.DetachSecurityProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.detach_security_profile_response.DetachSecurityProfileResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.detach_security_profile.async_detach_security_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detach_thing_principal(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.detach_thing_principal_request.DetachThingPrincipalRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.detach_thing_principal_response.DetachThingPrincipalResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.detach_thing_principal.async_detach_thing_principal(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_topic_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.disable_topic_rule_request.DisableTopicRuleRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.disable_topic_rule.async_disable_topic_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_sbom_from_package_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.disassociate_sbom_from_package_version_request.DisassociateSbomFromPackageVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.disassociate_sbom_from_package_version_response.DisassociateSbomFromPackageVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.disassociate_sbom_from_package_version.async_disassociate_sbom_from_package_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_topic_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.enable_topic_rule_request.EnableTopicRuleRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.enable_topic_rule.async_enable_topic_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_behavior_model_training_summaries(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_behavior_model_training_summaries_request.GetBehaviorModelTrainingSummariesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_behavior_model_training_summaries_response.GetBehaviorModelTrainingSummariesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_behavior_model_training_summaries.async_get_behavior_model_training_summaries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_behavior_model_training_summaries(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.behavior_model_training_summary.BehaviorModelTrainingSummary]":
        _token = next_token
        while True:
            _response = await self.get_behavior_model_training_summaries(
    ...
    async def get_buckets_aggregation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_buckets_aggregation_request.GetBucketsAggregationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_buckets_aggregation_response.GetBucketsAggregationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_buckets_aggregation.async_get_buckets_aggregation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_cardinality(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_cardinality_request.GetCardinalityRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_cardinality_response.GetCardinalityResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_cardinality.async_get_cardinality(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_command(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_command_request.GetCommandRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_command_response.GetCommandResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_command.async_get_command(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_command_execution(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_command_execution_request.GetCommandExecutionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_command_execution_response.GetCommandExecutionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_command_execution.async_get_command_execution(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_effective_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_effective_policies_request.GetEffectivePoliciesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_effective_policies_response.GetEffectivePoliciesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_effective_policies.async_get_effective_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_indexing_configuration(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_indexing_configuration.async_get_indexing_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_job_document(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_job_document_request.GetJobDocumentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_job_document_response.GetJobDocumentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_job_document.async_get_job_document(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_logging_options(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_logging_options.async_get_logging_options(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_ota_update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_ota_update_request.GetOTAUpdateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_ota_update_response.GetOTAUpdateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_ota_update.async_get_ota_update(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_package(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_package_request.GetPackageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_package_response.GetPackageResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_package.async_get_package(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_package_configuration(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_package_configuration.async_get_package_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_package_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_package_version_request.GetPackageVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_package_version_response.GetPackageVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_package_version.async_get_package_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_percentiles(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_percentiles_request.GetPercentilesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_percentiles_response.GetPercentilesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_percentiles.async_get_percentiles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_policy_request.GetPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_policy_response.GetPolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_policy.async_get_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_policy_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_policy_version_request.GetPolicyVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_policy_version_response.GetPolicyVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_policy_version.async_get_policy_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_registration_code(
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_registration_code.async_get_registration_code(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_statistics(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_statistics_request.GetStatisticsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_statistics_response.GetStatisticsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_statistics.async_get_statistics(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_thing_connectivity_data(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_thing_connectivity_data_request.GetThingConnectivityDataRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_thing_connectivity_data_response.GetThingConnectivityDataResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_thing_connectivity_data.async_get_thing_connectivity_data(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_topic_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_topic_rule_request.GetTopicRuleRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_topic_rule_response.GetTopicRuleResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_topic_rule.async_get_topic_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_topic_rule_destination(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_topic_rule_destination_request.GetTopicRuleDestinationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_topic_rule_destination_response.GetTopicRuleDestinationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_topic_rule_destination.async_get_topic_rule_destination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_v2_logging_options(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.get_v2_logging_options_request.GetV2LoggingOptionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.get_v2_logging_options_response.GetV2LoggingOptionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.get_v2_logging_options.async_get_v2_logging_options(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_active_violations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_active_violations_request.ListActiveViolationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_active_violations_response.ListActiveViolationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_active_violations.async_list_active_violations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_active_violations(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.active_violation.ActiveViolation]":
        _token = next_token
        while True:
            _response = await self.list_active_violations(
                config_overrides=config_overrides,
    ...
    async def list_attached_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_attached_policies_request.ListAttachedPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_attached_policies_response.ListAttachedPoliciesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_attached_policies.async_list_attached_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_attached_policies(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iot.types.marker.Marker"] = None,
        page_size: Optional["aws_sdk_iot.types.page_size.PageSize"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.policy.Policy]":
        _token = marker
        while True:
            _response = await self.list_attached_policies(
                target,
                config_overrides=config_overrides,
                recursive=recursive,
                marker=_token,
    ...
    async def list_audit_findings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_audit_findings_request.ListAuditFindingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_audit_findings_response.ListAuditFindingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_audit_findings.async_list_audit_findings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.audit_finding.AuditFinding]":
        _token = next_token
        while True:
            _response = await self.list_audit_findings(
                config_overrides=config_overrides,
                task_id=task_id,
    ...
    async def list_audit_mitigation_actions_executions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_audit_mitigation_actions_executions_request.ListAuditMitigationActionsExecutionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_audit_mitigation_actions_executions_response.ListAuditMitigationActionsExecutionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_audit_mitigation_actions_executions.async_list_audit_mitigation_actions_executions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_audit_mitigation_actions_executions(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.audit_mitigation_action_execution_metadata.AuditMitigationActionExecutionMetadata]":
        _token = next_token
        while True:
            _response = await self.list_audit_mitigation_actions_executions(
                task_id,
                finding_id,
                config_overrides=config_overrides,
    ...
    async def list_audit_mitigation_actions_tasks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_audit_mitigation_actions_tasks_request.ListAuditMitigationActionsTasksRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_audit_mitigation_actions_tasks_response.ListAuditMitigationActionsTasksResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_audit_mitigation_actions_tasks.async_list_audit_mitigation_actions_tasks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_audit_mitigation_actions_tasks(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.audit_mitigation_actions_task_metadata.AuditMitigationActionsTaskMetadata]":
        _token = next_token
        while True:
            _response = await self.list_audit_mitigation_actions_tasks(
                start_time,
                end_time,
                config_overrides=config_overrides,
    ...
    async def list_audit_suppressions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_audit_suppressions_request.ListAuditSuppressionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_audit_suppressions_response.ListAuditSuppressionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_audit_suppressions.async_list_audit_suppressions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_audit_suppressions(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.audit_suppression.AuditSuppression]":
        _token = next_token
        while True:
            _response = await self.list_audit_suppressions(
                config_overrides=config_overrides,
                check_name=check_name,
                resource_identifier=resource_identifier,
    ...
    async def list_audit_tasks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_audit_tasks_request.ListAuditTasksRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_audit_tasks_response.ListAuditTasksResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_audit_tasks.async_list_audit_tasks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_audit_tasks(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.audit_task_metadata.AuditTaskMetadata]":
        _token = next_token
        while True:
            _response = await self.list_audit_tasks(
                start_time,
                end_time,
                config_overrides=config_overrides,
                task_type=task_type,
    ...
    async def list_authorizers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_authorizers_request.ListAuthorizersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_authorizers_response.ListAuthorizersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_authorizers.async_list_authorizers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_authorizers(
        ...
        *,
        ...
        status: Optional["aws_sdk_iot.types.authorizer_status.AuthorizerStatus"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.authorizer_summary.AuthorizerSummary]":
        _token = marker
        while True:
            _response = await self.list_authorizers(
                config_overrides=config_overrides,
                page_size=page_size,
                marker=_token,
                ascending_order=ascending_order,
    ...
    async def list_billing_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_billing_groups_request.ListBillingGroupsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_billing_groups_response.ListBillingGroupsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_billing_groups.async_list_billing_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.group_name_and_arn.GroupNameAndArn]":
        _token = next_token
        while True:
    ...
    async def list_ca_certificates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_ca_certificates_request.ListCACertificatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_ca_certificates_response.ListCACertificatesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_ca_certificates.async_list_ca_certificates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_ca_certificates(
        ...
        *,
        ...
        template_name: Optional["aws_sdk_iot.types.template_name.TemplateName"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.ca_certificate.CACertificate]":
        _token = marker
        while True:
            _response = await self.list_ca_certificates(
                config_overrides=config_overrides,
                page_size=page_size,
                marker=_token,
                ascending_order=ascending_order,
    ...
    async def list_certificate_providers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_certificate_providers_request.ListCertificateProvidersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_certificate_providers_response.ListCertificateProvidersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_certificate_providers.async_list_certificate_providers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_certificates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_certificates_request.ListCertificatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_certificates_response.ListCertificatesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_certificates.async_list_certificates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.certificate.Certificate]":
        _token = marker
        while True:
    ...
    async def list_certificates_by_ca(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_certificates_by_ca_request.ListCertificatesByCARequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_certificates_by_ca_response.ListCertificatesByCAResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_certificates_by_ca.async_list_certificates_by_ca(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_certificates_by_ca(
        ...
        *,
        ...
        _token = marker
        while True:
            _response = await self.list_certificates_by_ca(
                ca_certificate_id,
                config_overrides=config_overrides,
                page_size=page_size,
                marker=_token,
    ...
    async def list_command_executions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_command_executions_request.ListCommandExecutionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_command_executions_response.ListCommandExecutionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_command_executions.async_list_command_executions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_command_executions(
        ...
        *,
        ...
        target_arn: Optional["aws_sdk_iot.types.target_arn.TargetArn"] = None,
        command_arn: Optional["aws_sdk_iot.types.command_arn.CommandArn"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.command_execution_summary.CommandExecutionSummary]":
        _token = next_token
        while True:
            _response = await self.list_command_executions(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
                namespace=namespace,
    ...
    async def list_commands(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_commands_request.ListCommandsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_commands_response.ListCommandsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_commands.async_list_commands(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_commands(
        ...
        *,
        ...
        sort_order: Optional["aws_sdk_iot.types.sort_order.SortOrder"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.command_summary.CommandSummary]":
        _token = next_token
        while True:
    ...
    async def list_custom_metrics(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_custom_metrics_request.ListCustomMetricsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_custom_metrics_response.ListCustomMetricsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_custom_metrics.async_list_custom_metrics(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_custom_metrics(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.metric_name.MetricName]":
        _token = next_token
        while True:
            _response = await self.list_custom_metrics(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    async def list_detect_mitigation_actions_executions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_detect_mitigation_actions_executions_request.ListDetectMitigationActionsExecutionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_detect_mitigation_actions_executions_response.ListDetectMitigationActionsExecutionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_detect_mitigation_actions_executions.async_list_detect_mitigation_actions_executions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_detect_mitigation_actions_executions(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.detect_mitigation_action_execution.DetectMitigationActionExecution]":
        _token = next_token
        while True:
            _response = await self.list_detect_mitigation_actions_executions(
                config_overrides=config_overrides,
                task_id=task_id,
    ...
    async def list_detect_mitigation_actions_tasks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_detect_mitigation_actions_tasks_request.ListDetectMitigationActionsTasksRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_detect_mitigation_actions_tasks_response.ListDetectMitigationActionsTasksResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_detect_mitigation_actions_tasks.async_list_detect_mitigation_actions_tasks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_detect_mitigation_actions_tasks(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.detect_mitigation_actions_task_summary.DetectMitigationActionsTaskSummary]":
        _token = next_token
        while True:
            _response = await self.list_detect_mitigation_actions_tasks(
                start_time,
                end_time,
                config_overrides=config_overrides,
                max_results=max_results,
    ...
    async def list_dimensions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_dimensions_request.ListDimensionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_dimensions_response.ListDimensionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_dimensions.async_list_dimensions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_dimensions(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.dimension_name.DimensionName]":
        _token = next_token
        while True:
            _response = await self.list_dimensions(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    async def list_domain_configurations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_domain_configurations_request.ListDomainConfigurationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_domain_configurations_response.ListDomainConfigurationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_domain_configurations.async_list_domain_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_domain_configurations(
        ...
        *,
        ...
        page_size: Optional["aws_sdk_iot.types.page_size.PageSize"] = None,
        service_type: Optional["aws_sdk_iot.types.service_type.ServiceType"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.domain_configuration_summary.DomainConfigurationSummary]":
        _token = marker
        while True:
            _response = await self.list_domain_configurations(
                config_overrides=config_overrides,
                marker=_token,
                page_size=page_size,
    ...
    async def list_fleet_metrics(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_fleet_metrics_request.ListFleetMetricsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_fleet_metrics_response.ListFleetMetricsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_fleet_metrics.async_list_fleet_metrics(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_fleet_metrics(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.fleet_metric_name_and_arn.FleetMetricNameAndArn]":
        _token = next_token
        while True:
            _response = await self.list_fleet_metrics(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    async def list_indices(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_indices_request.ListIndicesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_indices_response.ListIndicesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_indices.async_list_indices(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.index_name.IndexName]":
        _token = next_token
        while True:
    ...
    async def list_job_executions_for_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_job_executions_for_job_request.ListJobExecutionsForJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_job_executions_for_job_response.ListJobExecutionsForJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_job_executions_for_job.async_list_job_executions_for_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_job_executions_for_job(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.job_execution_summary_for_job.JobExecutionSummaryForJob]":
        _token = next_token
        while True:
            _response = await self.list_job_executions_for_job(
                job_id,
                config_overrides=config_overrides,
                status=status,
                max_results=max_results,
    ...
    async def list_job_executions_for_thing(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_job_executions_for_thing_request.ListJobExecutionsForThingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_job_executions_for_thing_response.ListJobExecutionsForThingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_job_executions_for_thing.async_list_job_executions_for_thing(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_job_executions_for_thing(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
        job_id: Optional["aws_sdk_iot.types.job_id.JobId"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.job_execution_summary_for_thing.JobExecutionSummaryForThing]":
        _token = next_token
        while True:
            _response = await self.list_job_executions_for_thing(
                thing_name,
                config_overrides=config_overrides,
                status=status,
    ...
    async def list_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_jobs_request.ListJobsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_jobs_response.ListJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_jobs.async_list_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_jobs(
        ...
        *,
        ...
        namespace_id: Optional["aws_sdk_iot.types.namespace_id.NamespaceId"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.job_summary.JobSummary]":
        _token = next_token
        while True:
    ...
    async def list_job_templates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_job_templates_request.ListJobTemplatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_job_templates_response.ListJobTemplatesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_job_templates.async_list_job_templates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_job_templates(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.job_template_summary.JobTemplateSummary]":
        _token = next_token
        while True:
    ...
    async def list_managed_job_templates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_managed_job_templates_request.ListManagedJobTemplatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_managed_job_templates_response.ListManagedJobTemplatesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_managed_job_templates.async_list_managed_job_templates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_managed_job_templates(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.managed_job_template_summary.ManagedJobTemplateSummary]":
        _token = next_token
        while True:
            _response = await self.list_managed_job_templates(
                config_overrides=config_overrides,
                template_name=template_name,
                max_results=max_results,
                next_token=_token,
    ...
    async def list_metric_values(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_metric_values_request.ListMetricValuesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_metric_values_response.ListMetricValuesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_metric_values.async_list_metric_values(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_metric_values(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.metric_datum.MetricDatum]":
        _token = next_token
        while True:
            _response = await self.list_metric_values(
                thing_name,
                metric_name,
                start_time,
                end_time,
    ...
    async def list_mitigation_actions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_mitigation_actions_request.ListMitigationActionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_mitigation_actions_response.ListMitigationActionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_mitigation_actions.async_list_mitigation_actions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_mitigation_actions(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.mitigation_action_identifier.MitigationActionIdentifier]":
        _token = next_token
        while True:
            _response = await self.list_mitigation_actions(
                config_overrides=config_overrides,
    ...
    async def list_ota_updates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_ota_updates_request.ListOTAUpdatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_ota_updates_response.ListOTAUpdatesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_ota_updates.async_list_ota_updates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.ota_update_summary.OTAUpdateSummary]":
        _token = next_token
        while True:
            _response = await self.list_ota_updates(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    async def list_outgoing_certificates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_outgoing_certificates_request.ListOutgoingCertificatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_outgoing_certificates_response.ListOutgoingCertificatesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_outgoing_certificates.async_list_outgoing_certificates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.outgoing_certificate.OutgoingCertificate]":
        _token = marker
        while True:
            _response = await self.list_outgoing_certificates(
                config_overrides=config_overrides,
                page_size=page_size,
                marker=_token,
                ascending_order=ascending_order,
    ...
    async def list_packages(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_packages_request.ListPackagesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_packages_response.ListPackagesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_packages.async_list_packages(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_packages(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.package_summary.PackageSummary]":
        _token = next_token
        while True:
    ...
    async def list_package_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_package_versions_request.ListPackageVersionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_package_versions_response.ListPackageVersionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_package_versions.async_list_package_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_package_versions(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_iot.types.package_version_summary.PackageVersionSummary]"
    ):
        _token = next_token
        while True:
            _response = await self.list_package_versions(
                package_name,
                config_overrides=config_overrides,
                status=status,
                max_results=max_results,
    ...
    async def list_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_policies_request.ListPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_policies_response.ListPoliciesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_policies.async_list_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_policy_principals(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_policy_principals_request.ListPolicyPrincipalsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_policy_principals_response.ListPolicyPrincipalsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_policy_principals.async_list_policy_principals(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.principal_arn.PrincipalArn]":
        _token = marker
        while True:
            _response = await self.list_policy_principals(
                policy_name,
                config_overrides=config_overrides,
                marker=_token,
                page_size=page_size,
    ...
    async def list_policy_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_policy_versions_request.ListPolicyVersionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_policy_versions_response.ListPolicyVersionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_policy_versions.async_list_policy_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_principal_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_principal_policies_request.ListPrincipalPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_principal_policies_response.ListPrincipalPoliciesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_principal_policies.async_list_principal_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_principal_policies(
        ...
        *,
        ...
        _token = marker
        while True:
            _response = await self.list_principal_policies(
                principal,
                config_overrides=config_overrides,
                marker=_token,
                page_size=page_size,
    ...
    async def list_principal_things(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_principal_things_request.ListPrincipalThingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_principal_things_response.ListPrincipalThingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_principal_things.async_list_principal_things(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.thing_name.ThingName]":
        _token = next_token
        while True:
            _response = await self.list_principal_things(
                principal,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def list_principal_things_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_principal_things_v2_request.ListPrincipalThingsV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_principal_things_v2_response.ListPrincipalThingsV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_principal_things_v2.async_list_principal_things_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.principal_thing_object.PrincipalThingObject]":
        _token = next_token
        while True:
            _response = await self.list_principal_things_v2(
                principal,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def list_provisioning_templates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_provisioning_templates_request.ListProvisioningTemplatesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_provisioning_templates_response.ListProvisioningTemplatesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_provisioning_templates.async_list_provisioning_templates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_provisioning_templates(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.provisioning_template_summary.ProvisioningTemplateSummary]":
        _token = next_token
        while True:
            _response = await self.list_provisioning_templates(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            )
    ...
    async def list_provisioning_template_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_provisioning_template_versions_request.ListProvisioningTemplateVersionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_provisioning_template_versions_response.ListProvisioningTemplateVersionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_provisioning_template_versions.async_list_provisioning_template_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_provisioning_template_versions(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.provisioning_template_version_summary.ProvisioningTemplateVersionSummary]":
        _token = next_token
        while True:
            _response = await self.list_provisioning_template_versions(
                template_name,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    async def list_related_resources_for_audit_finding(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_related_resources_for_audit_finding_request.ListRelatedResourcesForAuditFindingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_related_resources_for_audit_finding_response.ListRelatedResourcesForAuditFindingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_related_resources_for_audit_finding.async_list_related_resources_for_audit_finding(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_related_resources_for_audit_finding(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.related_resource.RelatedResource]":
        _token = next_token
        while True:
            _response = await self.list_related_resources_for_audit_finding(
                finding_id,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def list_role_aliases(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_role_aliases_request.ListRoleAliasesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_role_aliases_response.ListRoleAliasesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_role_aliases.async_list_role_aliases(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.role_alias.RoleAlias]":
        _token = marker
        while True:
            _response = await self.list_role_aliases(
                config_overrides=config_overrides,
                page_size=page_size,
                marker=_token,
                ascending_order=ascending_order,
    ...
    async def list_sbom_validation_results(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_sbom_validation_results_request.ListSbomValidationResultsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_sbom_validation_results_response.ListSbomValidationResultsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_sbom_validation_results.async_list_sbom_validation_results(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_sbom_validation_results(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.sbom_validation_result_summary.SbomValidationResultSummary]":
        _token = next_token
        while True:
            _response = await self.list_sbom_validation_results(
                package_name,
                version_name,
                config_overrides=config_overrides,
    ...
    async def list_scheduled_audits(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_scheduled_audits_request.ListScheduledAuditsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_scheduled_audits_response.ListScheduledAuditsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_scheduled_audits.async_list_scheduled_audits(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_scheduled_audits(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.scheduled_audit_metadata.ScheduledAuditMetadata]":
        _token = next_token
        while True:
            _response = await self.list_scheduled_audits(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    async def list_security_profiles(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_security_profiles_request.ListSecurityProfilesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_security_profiles_response.ListSecurityProfilesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_security_profiles.async_list_security_profiles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_security_profiles(
        ...
        *,
        ...
        metric_name: Optional["aws_sdk_iot.types.metric_name.MetricName"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.security_profile_identifier.SecurityProfileIdentifier]":
        _token = next_token
        while True:
            _response = await self.list_security_profiles(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
                dimension_name=dimension_name,
    ...
    async def list_security_profiles_for_target(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_security_profiles_for_target_request.ListSecurityProfilesForTargetRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_security_profiles_for_target_response.ListSecurityProfilesForTargetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_security_profiles_for_target.async_list_security_profiles_for_target(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_security_profiles_for_target(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
        recursive: Optional["aws_sdk_iot.types.recursive.Recursive"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.security_profile_target_mapping.SecurityProfileTargetMapping]":
        _token = next_token
        while True:
            _response = await self.list_security_profiles_for_target(
    ...
    async def list_streams(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_streams_request.ListStreamsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_streams_response.ListStreamsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_streams.async_list_streams(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.stream_summary.StreamSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_tags_for_resource(
        ...
        *,
        config_overrides: Optional[AsyncIoTClientConfig] = None,
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    async def list_targets_for_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_targets_for_policy_request.ListTargetsForPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_targets_for_policy_response.ListTargetsForPolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_targets_for_policy.async_list_targets_for_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_targets_for_policy(
        ...
        *,
        ...
        marker: Optional["aws_sdk_iot.types.marker.Marker"] = None,
        page_size: Optional["aws_sdk_iot.types.page_size.PageSize"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.policy_target.PolicyTarget]":
        _token = marker
        while True:
    ...
    async def list_targets_for_security_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_targets_for_security_profile_request.ListTargetsForSecurityProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_targets_for_security_profile_response.ListTargetsForSecurityProfileResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_targets_for_security_profile.async_list_targets_for_security_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_targets_for_security_profile(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_iot.types.security_profile_target.SecurityProfileTarget]"
    ):
        _token = next_token
        while True:
            _response = await self.list_targets_for_security_profile(
    ...
    async def list_thing_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_thing_groups_request.ListThingGroupsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_thing_groups_response.ListThingGroupsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_thing_groups.async_list_thing_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_thing_groups(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.list_thing_groups(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def list_thing_groups_for_thing(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_thing_groups_for_thing_request.ListThingGroupsForThingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_thing_groups_for_thing_response.ListThingGroupsForThingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_thing_groups_for_thing.async_list_thing_groups_for_thing(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_thing_groups_for_thing(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.list_thing_groups_for_thing(
                thing_name,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def list_thing_principals(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_thing_principals_request.ListThingPrincipalsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_thing_principals_response.ListThingPrincipalsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_thing_principals.async_list_thing_principals(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_thing_principals(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.list_thing_principals(
                thing_name,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def list_thing_principals_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_thing_principals_v2_request.ListThingPrincipalsV2Request]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_thing_principals_v2_response.ListThingPrincipalsV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_thing_principals_v2.async_list_thing_principals_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.thing_principal_object.ThingPrincipalObject]":
        _token = next_token
        while True:
            _response = await self.list_thing_principals_v2(
                thing_name,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def list_thing_registration_task_reports(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_thing_registration_task_reports_request.ListThingRegistrationTaskReportsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_thing_registration_task_reports_response.ListThingRegistrationTaskReportsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_thing_registration_task_reports.async_list_thing_registration_task_reports(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.s3_file_url.S3FileUrl]":
        _token = next_token
        while True:
            _response = await self.list_thing_registration_task_reports(
                task_id,
                report_type,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    async def list_thing_registration_tasks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_thing_registration_tasks_request.ListThingRegistrationTasksRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_thing_registration_tasks_response.ListThingRegistrationTasksResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_thing_registration_tasks.async_list_thing_registration_tasks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_thing_registration_tasks(
        ...
        *,
        ...
        status: Optional["aws_sdk_iot.types.status.Status"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.task_id.TaskId]":
        _token = next_token
        while True:
            _response = await self.list_thing_registration_tasks(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
                status=status,
    ...
    async def list_things(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_things_request.ListThingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_things_response.ListThingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_things.async_list_things(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.thing_attribute.ThingAttribute]":
        _token = next_token
        while True:
            _response = await self.list_things(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def list_things_in_billing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_things_in_billing_group_request.ListThingsInBillingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_things_in_billing_group_response.ListThingsInBillingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_things_in_billing_group.async_list_things_in_billing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_things_in_billing_group(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.list_things_in_billing_group(
                billing_group_name,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def list_things_in_thing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_things_in_thing_group_request.ListThingsInThingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_things_in_thing_group_response.ListThingsInThingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_things_in_thing_group.async_list_things_in_thing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_things_in_thing_group(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.list_things_in_thing_group(
                thing_group_name,
                config_overrides=config_overrides,
                recursive=recursive,
                next_token=_token,
    ...
    async def list_thing_types(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_thing_types_request.ListThingTypesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_thing_types_response.ListThingTypesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_thing_types.async_list_thing_types(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.thing_type_definition.ThingTypeDefinition]":
        _token = next_token
        while True:
            _response = await self.list_thing_types(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
                thing_type_name=thing_type_name,
    ...
    async def list_topic_rule_destinations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_topic_rule_destinations_request.ListTopicRuleDestinationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_topic_rule_destinations_response.ListTopicRuleDestinationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_topic_rule_destinations.async_list_topic_rule_destinations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_topic_rule_destinations(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.topic_rule_destination_summary.TopicRuleDestinationSummary]":
        _token = next_token
        while True:
            _response = await self.list_topic_rule_destinations(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            )
    ...
    async def list_topic_rules(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_topic_rules_request.ListTopicRulesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_topic_rules_response.ListTopicRulesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_topic_rules.async_list_topic_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_topic_rules(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
        rule_disabled: Optional["aws_sdk_iot.types.is_disabled.IsDisabled"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.topic_rule_list_item.TopicRuleListItem]":
        _token = next_token
        while True:
            _response = await self.list_topic_rules(
                config_overrides=config_overrides,
                topic=topic,
                max_results=max_results,
                next_token=_token,
    ...
    async def list_v2_logging_levels(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_v2_logging_levels_request.ListV2LoggingLevelsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_v2_logging_levels_response.ListV2LoggingLevelsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_v2_logging_levels.async_list_v2_logging_levels(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_iot.types.log_target_configuration.LogTargetConfiguration]":
        _token = next_token
        while True:
            _response = await self.list_v2_logging_levels(
                config_overrides=config_overrides,
    ...
    async def list_violation_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.list_violation_events_request.ListViolationEventsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.list_violation_events_response.ListViolationEventsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.list_violation_events.async_list_violation_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_violation_events(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_iot.types.next_token.NextToken"] = None,
        max_results: Optional["aws_sdk_iot.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[aws_sdk_iot.types.violation_event.ViolationEvent]":
        _token = next_token
        while True:
            _response = await self.list_violation_events(
                start_time,
                end_time,
                config_overrides=config_overrides,
                thing_name=thing_name,
    ...
    async def put_verification_state_on_violation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.put_verification_state_on_violation_request.PutVerificationStateOnViolationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.put_verification_state_on_violation_response.PutVerificationStateOnViolationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.put_verification_state_on_violation.async_put_verification_state_on_violation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_ca_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.register_ca_certificate_request.RegisterCACertificateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.register_ca_certificate_response.RegisterCACertificateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.register_ca_certificate.async_register_ca_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.register_certificate_request.RegisterCertificateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.register_certificate_response.RegisterCertificateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.register_certificate.async_register_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_certificate_without_ca(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.register_certificate_without_ca_request.RegisterCertificateWithoutCARequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.register_certificate_without_ca_response.RegisterCertificateWithoutCAResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.register_certificate_without_ca.async_register_certificate_without_ca(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_thing(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.register_thing_request.RegisterThingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.register_thing_response.RegisterThingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.register_thing.async_register_thing(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reject_certificate_transfer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.reject_certificate_transfer_request.RejectCertificateTransferRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.reject_certificate_transfer.async_reject_certificate_transfer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_thing_from_billing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.remove_thing_from_billing_group_request.RemoveThingFromBillingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.remove_thing_from_billing_group_response.RemoveThingFromBillingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.remove_thing_from_billing_group.async_remove_thing_from_billing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_thing_from_thing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.remove_thing_from_thing_group_request.RemoveThingFromThingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.remove_thing_from_thing_group_response.RemoveThingFromThingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.remove_thing_from_thing_group.async_remove_thing_from_thing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def replace_topic_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.replace_topic_rule_request.ReplaceTopicRuleRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.replace_topic_rule.async_replace_topic_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_index(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.search_index_request.SearchIndexRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.search_index_response.SearchIndexResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.search_index.async_search_index(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_default_authorizer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.set_default_authorizer_request.SetDefaultAuthorizerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.set_default_authorizer_response.SetDefaultAuthorizerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.set_default_authorizer.async_set_default_authorizer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_default_policy_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.set_default_policy_version_request.SetDefaultPolicyVersionRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.set_default_policy_version.async_set_default_policy_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_logging_options(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.set_logging_options_request.SetLoggingOptionsRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.set_logging_options.async_set_logging_options(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_v2_logging_level(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.set_v2_logging_level_request.SetV2LoggingLevelRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.set_v2_logging_level.async_set_v2_logging_level(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_v2_logging_options(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.set_v2_logging_options_request.SetV2LoggingOptionsRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.set_v2_logging_options.async_set_v2_logging_options(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_audit_mitigation_actions_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.start_audit_mitigation_actions_task_request.StartAuditMitigationActionsTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.start_audit_mitigation_actions_task_response.StartAuditMitigationActionsTaskResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.start_audit_mitigation_actions_task.async_start_audit_mitigation_actions_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_detect_mitigation_actions_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.start_detect_mitigation_actions_task_request.StartDetectMitigationActionsTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.start_detect_mitigation_actions_task_response.StartDetectMitigationActionsTaskResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.start_detect_mitigation_actions_task.async_start_detect_mitigation_actions_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_on_demand_audit_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.start_on_demand_audit_task_request.StartOnDemandAuditTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.start_on_demand_audit_task_response.StartOnDemandAuditTaskResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.start_on_demand_audit_task.async_start_on_demand_audit_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_thing_registration_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.start_thing_registration_task_request.StartThingRegistrationTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.start_thing_registration_task_response.StartThingRegistrationTaskResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.start_thing_registration_task.async_start_thing_registration_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_thing_registration_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.stop_thing_registration_task_request.StopThingRegistrationTaskRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.stop_thing_registration_task_response.StopThingRegistrationTaskResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.stop_thing_registration_task.async_stop_thing_registration_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def test_authorization(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.test_authorization_request.TestAuthorizationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.test_authorization_response.TestAuthorizationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.test_authorization.async_test_authorization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def test_invoke_authorizer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.test_invoke_authorizer_request.TestInvokeAuthorizerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.test_invoke_authorizer_response.TestInvokeAuthorizerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.test_invoke_authorizer.async_test_invoke_authorizer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def transfer_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.transfer_certificate_request.TransferCertificateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.transfer_certificate_response.TransferCertificateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.transfer_certificate.async_transfer_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_account_audit_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_account_audit_configuration_request.UpdateAccountAuditConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_account_audit_configuration_response.UpdateAccountAuditConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_account_audit_configuration.async_update_account_audit_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_audit_suppression(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_audit_suppression_request.UpdateAuditSuppressionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_audit_suppression_response.UpdateAuditSuppressionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_audit_suppression.async_update_audit_suppression(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_authorizer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_authorizer_request.UpdateAuthorizerRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_authorizer_response.UpdateAuthorizerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_authorizer.async_update_authorizer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_billing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_billing_group_request.UpdateBillingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_billing_group_response.UpdateBillingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_billing_group.async_update_billing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_ca_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_ca_certificate_request.UpdateCACertificateRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_ca_certificate.async_update_ca_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_certificate_request.UpdateCertificateRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_certificate.async_update_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_certificate_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_certificate_provider_request.UpdateCertificateProviderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_certificate_provider_response.UpdateCertificateProviderResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_certificate_provider.async_update_certificate_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_command(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_command_request.UpdateCommandRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_command_response.UpdateCommandResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_command.async_update_command(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_custom_metric(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_custom_metric_request.UpdateCustomMetricRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_custom_metric_response.UpdateCustomMetricResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_custom_metric.async_update_custom_metric(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_dimension(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_dimension_request.UpdateDimensionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_dimension_response.UpdateDimensionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_dimension.async_update_dimension(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_domain_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_domain_configuration_request.UpdateDomainConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_domain_configuration_response.UpdateDomainConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_domain_configuration.async_update_domain_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_dynamic_thing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_dynamic_thing_group_request.UpdateDynamicThingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_dynamic_thing_group_response.UpdateDynamicThingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_dynamic_thing_group.async_update_dynamic_thing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_encryption_configuration(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_encryption_configuration(encryption_type='CUSTOMER_MANAGED_KMS_KEY', kms_key_arn='arn:aws:iam:us-west-2:111122223333:role/myrole', kms_access_role_arn='arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab')
        """

        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_encryption_configuration_request.UpdateEncryptionConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_encryption_configuration_response.UpdateEncryptionConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_encryption_configuration.async_update_encryption_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_event_configurations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_event_configurations_request.UpdateEventConfigurationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_event_configurations_response.UpdateEventConfigurationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_event_configurations.async_update_event_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_fleet_metric(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_fleet_metric_request.UpdateFleetMetricRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_fleet_metric.async_update_fleet_metric(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_indexing_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_indexing_configuration_request.UpdateIndexingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_indexing_configuration_response.UpdateIndexingConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_indexing_configuration.async_update_indexing_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_job_request.UpdateJobRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_job.async_update_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_mitigation_action(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_mitigation_action_request.UpdateMitigationActionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_mitigation_action_response.UpdateMitigationActionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_mitigation_action.async_update_mitigation_action(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_package(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_package_request.UpdatePackageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_package_response.UpdatePackageResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_package.async_update_package(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_package_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_package_configuration_request.UpdatePackageConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_package_configuration_response.UpdatePackageConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_package_configuration.async_update_package_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_package_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_package_version_request.UpdatePackageVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_package_version_response.UpdatePackageVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_package_version.async_update_package_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_provisioning_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_provisioning_template_request.UpdateProvisioningTemplateRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_provisioning_template_response.UpdateProvisioningTemplateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_provisioning_template.async_update_provisioning_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_role_alias(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_role_alias_request.UpdateRoleAliasRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_role_alias_response.UpdateRoleAliasResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_role_alias.async_update_role_alias(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_scheduled_audit(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_scheduled_audit_request.UpdateScheduledAuditRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_scheduled_audit_response.UpdateScheduledAuditResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_scheduled_audit.async_update_scheduled_audit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_security_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_security_profile_request.UpdateSecurityProfileRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_security_profile_response.UpdateSecurityProfileResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_security_profile.async_update_security_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_stream(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_stream_request.UpdateStreamRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_stream_response.UpdateStreamResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_stream.async_update_stream(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_thing(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_thing_request.UpdateThingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_thing_response.UpdateThingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_thing.async_update_thing(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_thing_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_thing_group_request.UpdateThingGroupRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_thing_group_response.UpdateThingGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_thing_group.async_update_thing_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_thing_groups_for_thing(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_thing_groups_for_thing_request.UpdateThingGroupsForThingRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_thing_groups_for_thing_response.UpdateThingGroupsForThingResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_thing_groups_for_thing.async_update_thing_groups_for_thing(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_thing_type(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_thing_type_request.UpdateThingTypeRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_thing_type_response.UpdateThingTypeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_thing_type.async_update_thing_type(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_topic_rule_destination(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.update_topic_rule_destination_request.UpdateTopicRuleDestinationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.update_topic_rule_destination_response.UpdateTopicRuleDestinationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.update_topic_rule_destination.async_update_topic_rule_destination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def validate_security_profile_behaviors(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_iot.types.validate_security_profile_behaviors_request.ValidateSecurityProfileBehaviorsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_iot.types.validate_security_profile_behaviors_response.ValidateSecurityProfileBehaviorsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_iot._operations.aws_iot_service.validate_security_profile_behaviors.async_validate_security_profile_behaviors(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
