...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot.types.audit_mitigation_actions_task_statistics
...
class DescribeAuditMitigationActionsTaskResponse(TypedDict):
    ...
    task_statistics: NotRequired[
        "aws_sdk_iot.types.audit_mitigation_actions_task_statistics.AuditMitigationActionsTaskStatistics"
    ]
    ...
    target: NotRequired[
        "aws_sdk_iot.types.audit_mitigation_actions_task_target.AuditMitigationActionsTaskTarget"
    ]
...
def serialize_json(value: DescribeAuditMitigationActionsTaskResponse) -> dict:
    ...
    if "task_statistics" in value:
        ...
        out["taskStatistics"] = (
            aws_sdk_iot.types.audit_mitigation_actions_task_statistics.serialize_json(
...
def deserialize_json(data: dict) -> DescribeAuditMitigationActionsTaskResponse:
    ...
    if "taskStatistics" in data:
        ...
        out["task_statistics"] = (
            aws_sdk_iot.types.audit_mitigation_actions_task_statistics.deserialize_json(
                data["taskStatistics"]
            )
        )
    if "target" in data:
