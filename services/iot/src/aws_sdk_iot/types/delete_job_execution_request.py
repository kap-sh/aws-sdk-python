...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteJobExecutionRequest) -> dict:
    out: dict = {}
    return out


def deserialize_json(data: dict) -> DeleteJobExecutionRequest:
    out: DeleteJobExecutionRequest = {}  # type: ignore[typeddict-item]
    return out
