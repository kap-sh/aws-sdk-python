...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot.types.task_statistics_for_audit_check

AuditMitigationActionsTaskStatistics: TypeAlias = dict[
    "aws_sdk_iot.types.audit_check_name.AuditCheckName",
    "aws_sdk_iot.types.task_statistics_for_audit_check.TaskStatisticsForAuditCheck",
]
...
def serialize_json(input_to_serialize: AuditMitigationActionsTaskStatistics) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = aws_sdk_iot.types.task_statistics_for_audit_check.serialize_json(
            value
        )
    return out
...
def deserialize_json(data: dict) -> AuditMitigationActionsTaskStatistics:
    ...
    for key, value in data.items():
        ...
        out[key] = aws_sdk_iot.types.task_statistics_for_audit_check.deserialize_json(
            value
        )
    return out
