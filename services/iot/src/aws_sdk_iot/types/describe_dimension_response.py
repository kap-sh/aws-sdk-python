"""Generated from Smithy shape ``com.amazonaws.iot#DescribeDimensionResponse``."""
...
class DescribeDimensionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeDimensionResponse) -> dict:
    out: dict = {}
    if "name" in value:
        out["name"] = value["name"]
    if "arn" in value:
