...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot.types.location_timestamp
...
def serialize_json(value: LocationAction) -> dict:
    ...
    if "timestamp" in value:
        ...
        out["timestamp"] = aws_sdk_iot.types.location_timestamp.serialize_json(
            value["timestamp"]
        )
...
def deserialize_json(data: dict) -> LocationAction:
    ...
    if "timestamp" in data:
        ...
        out["timestamp"] = aws_sdk_iot.types.location_timestamp.deserialize_json(
            data["timestamp"]
        )
    if "latitude" in data:
