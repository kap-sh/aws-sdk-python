...
if TYPE_CHECKING:
    import aws_sdk_iot.types.parameter_key
    import aws_sdk_iot.types.parameter_value

ParameterMap: TypeAlias = dict[
    "aws_sdk_iot.types.parameter_key.ParameterKey",
    "aws_sdk_iot.types.parameter_value.ParameterValue",
]
