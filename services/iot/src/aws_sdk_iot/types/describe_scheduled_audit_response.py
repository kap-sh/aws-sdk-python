...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeScheduledAuditResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DescribeScheduledAuditResponse:
    out: DescribeScheduledAuditResponse = {}  # type: ignore[typeddict-item]
