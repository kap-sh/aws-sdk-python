...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot.types.failed_things
    import aws_sdk_iot.types.in_progress_things
    import aws_sdk_iot.types.processing_target_name_list
    import aws_sdk_iot.types.queued_things
    import aws_sdk_iot.types.rejected_things
    import aws_sdk_iot.types.removed_things
    import aws_sdk_iot.types.succeeded_things
...
class JobProcessDetails(TypedDict, closed=True):
    ...
    number_of_canceled_things: NotRequired[
        "aws_sdk_iot.types.canceled_things.CanceledThings"
    ]
    """<p>The number of things that cancelled the job.</p>"""
    number_of_succeeded_things: NotRequired[
        "aws_sdk_iot.types.succeeded_things.SucceededThings"
    ]
    """<p>The number of things which successfully completed the job.</p>"""
    number_of_failed_things: NotRequired["aws_sdk_iot.types.failed_things.FailedThings"]
    """<p>The number of things that failed executing the job.</p>"""
    number_of_rejected_things: NotRequired[
        "aws_sdk_iot.types.rejected_things.RejectedThings"
    ]
    """<p>The number of things that rejected the job.</p>"""
    number_of_queued_things: NotRequired["aws_sdk_iot.types.queued_things.QueuedThings"]
    """<p>The number of things that are awaiting execution of the job.</p>"""
    number_of_in_progress_things: NotRequired[
        "aws_sdk_iot.types.in_progress_things.InProgressThings"
    ]
    """<p>The number of things currently executing the job.</p>"""
    number_of_removed_things: NotRequired[
        "aws_sdk_iot.types.removed_things.RemovedThings"
    ]
    ...
    number_of_timed_out_things: NotRequired[
        "aws_sdk_iot.types.timed_out_things.TimedOutThings"
    ]
...
def serialize_json(value: JobProcessDetails) -> dict:
    ...
    if "processing_targets" in value:
        ...
        out["processingTargets"] = (
            aws_sdk_iot.types.processing_target_name_list.serialize_json(
...
def deserialize_json(data: dict) -> JobProcessDetails:
    ...
    if "processingTargets" in data:
        ...
        out["processing_targets"] = (
            aws_sdk_iot.types.processing_target_name_list.deserialize_json(
