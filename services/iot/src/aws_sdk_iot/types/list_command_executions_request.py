...
class ListCommandExecutionsRequest(TypedDict):
    ...
    started_time_filter: NotRequired["aws_sdk_iot.types.time_filter.TimeFilter"]
    ...
    completed_time_filter: NotRequired["aws_sdk_iot.types.time_filter.TimeFilter"]
...
def serialize_json(value: ListCommandExecutionsRequest) -> dict:
    ...
    if "sort_order" in value:
        ...
        out["sortOrder"] = aws_sdk_iot.types.sort_order.serialize_json(
            value["sort_order"]
        )
    if "started_time_filter" in value:
        import aws_sdk_iot.types.time_filter

        out["startedTimeFilter"] = aws_sdk_iot.types.time_filter.serialize_json(
            value["started_time_filter"]
        )
    if "completed_time_filter" in value:
        import aws_sdk_iot.types.time_filter

        out["completedTimeFilter"] = aws_sdk_iot.types.time_filter.serialize_json(
...
def deserialize_json(data: dict) -> ListCommandExecutionsRequest:
    ...
    if "sortOrder" in data:
        ...
        out["sort_order"] = aws_sdk_iot.types.sort_order.deserialize_json(
            data["sortOrder"]
        )
    if "startedTimeFilter" in data:
        import aws_sdk_iot.types.time_filter

        out["started_time_filter"] = aws_sdk_iot.types.time_filter.deserialize_json(
            data["startedTimeFilter"]
        )
    if "completedTimeFilter" in data:
        import aws_sdk_iot.types.time_filter

        out["completed_time_filter"] = aws_sdk_iot.types.time_filter.deserialize_json(
