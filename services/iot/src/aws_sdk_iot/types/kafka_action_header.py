...
if TYPE_CHECKING:
    import aws_sdk_iot.types.kafka_header_key
    import aws_sdk_iot.types.kafka_header_value


class KafkaActionHeader(TypedDict):
    key: "aws_sdk_iot.types.kafka_header_key.KafkaHeaderKey"
    """<p>The key of the Kafka header.</p>"""
    value: "aws_sdk_iot.types.kafka_header_value.KafkaHeaderValue"
