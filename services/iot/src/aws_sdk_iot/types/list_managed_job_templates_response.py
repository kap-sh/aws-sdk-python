...
if TYPE_CHECKING:
    import aws_sdk_iot.types.managed_job_templates_summary_list
    import aws_sdk_iot.types.next_token


class ListManagedJobTemplatesResponse(TypedDict):
    managed_job_templates: NotRequired[
        "aws_sdk_iot.types.managed_job_templates_summary_list.ManagedJobTemplatesSummaryList"
    ]
...
def serialize_json(value: ListManagedJobTemplatesResponse) -> dict:
    ...
    if "managed_job_templates" in value:
        ...
        out["managedJobTemplates"] = (
            aws_sdk_iot.types.managed_job_templates_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListManagedJobTemplatesResponse:
    ...
    if "managedJobTemplates" in data:
        ...
        out["managed_job_templates"] = (
            aws_sdk_iot.types.managed_job_templates_summary_list.deserialize_json(
