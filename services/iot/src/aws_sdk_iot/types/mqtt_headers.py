...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot.types.correlation_data
    import aws_sdk_iot.types.message_expiry
    import aws_sdk_iot.types.payload_format_indicator
    import aws_sdk_iot.types.response_topic
...
class MqttHeaders(TypedDict):
    ...
    content_type: NotRequired["aws_sdk_iot.types.content_type.ContentType"]
    ...
    response_topic: NotRequired["aws_sdk_iot.types.response_topic.ResponseTopic"]
    ...
    correlation_data: NotRequired["aws_sdk_iot.types.correlation_data.CorrelationData"]
    ...
    message_expiry: NotRequired["aws_sdk_iot.types.message_expiry.MessageExpiry"]
    ...
    user_properties: NotRequired["aws_sdk_iot.types.user_properties.UserProperties"]
...
def serialize_json(value: MqttHeaders) -> dict:
    ...
    if "user_properties" in value:
        ...
        out["userProperties"] = aws_sdk_iot.types.user_properties.serialize_json(
...
def deserialize_json(data: dict) -> MqttHeaders:
    ...
    if "userProperties" in data:
        ...
        out["user_properties"] = aws_sdk_iot.types.user_properties.deserialize_json(
            data["userProperties"]
        )
    return out
