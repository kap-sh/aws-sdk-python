...
if TYPE_CHECKING:
    import aws_sdk_iot.types.asset_id
    import aws_sdk_iot.types.asset_property_alias
    import aws_sdk_iot.types.asset_property_entry_id
    import aws_sdk_iot.types.asset_property_id
    import aws_sdk_iot.types.asset_property_value_list


class PutAssetPropertyValueEntry(TypedDict):
    entry_id: NotRequired[
        "aws_sdk_iot.types.asset_property_entry_id.AssetPropertyEntryId"
    ]
    ...
    asset_id: NotRequired["aws_sdk_iot.types.asset_id.AssetId"]
    ...
    property_id: NotRequired["aws_sdk_iot.types.asset_property_id.AssetPropertyId"]
    ...
    property_alias: NotRequired[
        "aws_sdk_iot.types.asset_property_alias.AssetPropertyAlias"
    ]
    ...
    property_values: (
        "aws_sdk_iot.types.asset_property_value_list.AssetPropertyValueList"
    )
...
def serialize_json(value: PutAssetPropertyValueEntry) -> dict:
    ...
    out["propertyValues"] = aws_sdk_iot.types.asset_property_value_list.serialize_json(
...
def deserialize_json(data: dict) -> PutAssetPropertyValueEntry:
    ...
    if "propertyValues" in data:
        ...
        out["property_values"] = (
            aws_sdk_iot.types.asset_property_value_list.deserialize_json(
                data["propertyValues"]
            )
        )
    else:
