...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot.types.violation_event_type
...
class ViolationEvent(TypedDict):
    ...
    metric_value: NotRequired["aws_sdk_iot.types.metric_value.MetricValue"]
    ...
    violation_event_type: NotRequired[
        "aws_sdk_iot.types.violation_event_type.ViolationEventType"
    ]
    ...
    violation_event_time: NotRequired["aws_sdk_iot.types.timestamp.Timestamp"]
...
def serialize_json(value: ViolationEvent) -> dict:
    ...
    if "metric_value" in value:
        ...
        out["metricValue"] = aws_sdk_iot.types.metric_value.serialize_json(
            value["metric_value"]
        )
    ...
    if "violation_event_type" in value:
        ...
        out["violationEventType"] = (
            aws_sdk_iot.types.violation_event_type.serialize_json(
    ...
    if "violation_event_time" in value:
        ...
        out["violationEventTime"] = aws_sdk_iot.types.timestamp.serialize_json(
...
def deserialize_json(data: dict) -> ViolationEvent:
    ...
    if "metricValue" in data:
        ...
        out["metric_value"] = aws_sdk_iot.types.metric_value.deserialize_json(
            data["metricValue"]
        )
    ...
    if "violationEventType" in data:
        ...
        out["violation_event_type"] = (
            aws_sdk_iot.types.violation_event_type.deserialize_json(
    ...
    if "violationEventTime" in data:
        ...
        out["violation_event_time"] = aws_sdk_iot.types.timestamp.deserialize_json(
