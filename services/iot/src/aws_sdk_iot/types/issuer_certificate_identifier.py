...
if TYPE_CHECKING:
    import aws_sdk_iot.types.issuer_certificate_serial_number
    import aws_sdk_iot.types.issuer_certificate_subject
    import aws_sdk_iot.types.issuer_id


class IssuerCertificateIdentifier(TypedDict):
    issuer_certificate_subject: NotRequired[
        "aws_sdk_iot.types.issuer_certificate_subject.IssuerCertificateSubject"
    ]
    """<p>The subject of the issuer certificate.</p>"""
    issuer_id: NotRequired["aws_sdk_iot.types.issuer_id.IssuerId"]
    """<p>The issuer ID.</p>"""
    issuer_certificate_serial_number: NotRequired[
        "aws_sdk_iot.types.issuer_certificate_serial_number.IssuerCertificateSerialNumber"
    ]
