...
class DescribeJobExecutionResponse(TypedDict, closed=True):
    execution: NotRequired["aws_sdk_iot.types.job_execution.JobExecution"]
...
def serialize_json(value: DescribeJobExecutionResponse) -> dict:
    ...
    if "execution" in value:
        ...
        out["execution"] = aws_sdk_iot.types.job_execution.serialize_json(
            value["execution"]
        )
    return out
...
def deserialize_json(data: dict) -> DescribeJobExecutionResponse:
    ...
    if "execution" in data:
        ...
        out["execution"] = aws_sdk_iot.types.job_execution.deserialize_json(
            data["execution"]
        )
    return out
