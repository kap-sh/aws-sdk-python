...
class ListThingTypesResponse(TypedDict):
    thing_types: NotRequired["aws_sdk_iot.types.thing_type_list.ThingTypeList"]
    """<p>The thing types.</p>"""
...
def serialize_json(value: ListThingTypesResponse) -> dict:
    ...
    if "thing_types" in value:
        ...
        out["thingTypes"] = aws_sdk_iot.types.thing_type_list.serialize_json(
            value["thing_types"]
        )
...
def deserialize_json(data: dict) -> ListThingTypesResponse:
    ...
    if "thingTypes" in data:
        ...
        out["thing_types"] = aws_sdk_iot.types.thing_type_list.deserialize_json(
            data["thingTypes"]
        )
