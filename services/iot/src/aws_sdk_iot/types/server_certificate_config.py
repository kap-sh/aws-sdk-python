...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot.types.enable_ocsp_check
    import aws_sdk_iot.types.ocsp_lambda_arn


class ServerCertificateConfig(TypedDict):
    enable_ocsp_check: NotRequired[
        "aws_sdk_iot.types.enable_ocsp_check.EnableOCSPCheck"
    ]
    ...
    ocsp_lambda_arn: NotRequired["aws_sdk_iot.types.ocsp_lambda_arn.OCSPLambdaArn"]
