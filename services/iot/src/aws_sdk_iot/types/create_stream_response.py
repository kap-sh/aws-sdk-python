"""Generated from Smithy shape ``com.amazonaws.iot#CreateStreamResponse``."""
...
class CreateStreamResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateStreamResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateStreamResponse:
    out: CreateStreamResponse = {}  # type: ignore[typeddict-item]
    if "streamId" in data:
