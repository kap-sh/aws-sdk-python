...
ThingAttributeList: TypeAlias = list["aws_sdk_iot.types.thing_attribute.ThingAttribute"]
...
def serialize_json(value: ThingAttributeList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(aws_sdk_iot.types.thing_attribute.serialize_json(item))
    return out
...
def deserialize_json(data: list) -> ThingAttributeList:
    ...
    for item in data:
        out.append(aws_sdk_iot.types.thing_attribute.deserialize_json(item))
    return out
