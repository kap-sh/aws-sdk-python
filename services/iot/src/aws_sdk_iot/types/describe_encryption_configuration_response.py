...
class DescribeEncryptionConfigurationResponse(TypedDict):
    encryption_type: NotRequired["aws_sdk_iot.types.encryption_type.EncryptionType"]
    ...
    configuration_details: NotRequired[
        "aws_sdk_iot.types.configuration_details.ConfigurationDetails"
    ]
...
def serialize_json(value: DescribeEncryptionConfigurationResponse) -> dict:
    ...
    if "configuration_details" in value:
        ...
        out["configurationDetails"] = (
            aws_sdk_iot.types.configuration_details.serialize_json(
...
def deserialize_json(data: dict) -> DescribeEncryptionConfigurationResponse:
    ...
    if "configurationDetails" in data:
        ...
        out["configuration_details"] = (
            aws_sdk_iot.types.configuration_details.deserialize_json(
