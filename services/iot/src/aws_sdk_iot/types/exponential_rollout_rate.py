...
if TYPE_CHECKING:
    import aws_sdk_iot.types.increment_factor
    import aws_sdk_iot.types.rate_increase_criteria
    import aws_sdk_iot.types.rollout_rate_per_minute


class ExponentialRolloutRate(TypedDict):
    base_rate_per_minute: (
        "aws_sdk_iot.types.rollout_rate_per_minute.RolloutRatePerMinute"
    )
    ...
    increment_factor: "aws_sdk_iot.types.increment_factor.IncrementFactor"
    ...
    rate_increase_criteria: (
        "aws_sdk_iot.types.rate_increase_criteria.RateIncreaseCriteria"
    )
...
def serialize_json(value: ExponentialRolloutRate) -> dict:
    ...
    out["rateIncreaseCriteria"] = (
        aws_sdk_iot.types.rate_increase_criteria.serialize_json(
...
def deserialize_json(data: dict) -> ExponentialRolloutRate:
    ...
    if "rateIncreaseCriteria" in data:
        ...
        out["rate_increase_criteria"] = (
            aws_sdk_iot.types.rate_increase_criteria.deserialize_json(
