...
if TYPE_CHECKING:
    import aws_sdk_iot.types.code
    import aws_sdk_iot.types.ota_update_error_message


class ErrorInfo(TypedDict, closed=True):
    code: NotRequired["aws_sdk_iot.types.code.Code"]
    """<p>The error code.</p>"""
    message: NotRequired[
        "aws_sdk_iot.types.ota_update_error_message.OTAUpdateErrorMessage"
    ]
