...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot.types.target_violation_ids_for_detect_mitigation_actions


class DetectMitigationActionsTaskTarget(TypedDict):
    violation_ids: NotRequired[
        "aws_sdk_iot.types.target_violation_ids_for_detect_mitigation_actions.TargetViolationIdsForDetectMitigationActions"
    ]
...
def serialize_json(value: DetectMitigationActionsTaskTarget) -> dict:
    ...
    if "violation_ids" in value:
        ...
        out["violationIds"] = (
            aws_sdk_iot.types.target_violation_ids_for_detect_mitigation_actions.serialize_json(
                value["violation_ids"]
            )
        )
...
def deserialize_json(data: dict) -> DetectMitigationActionsTaskTarget:
    ...
    if "violationIds" in data:
        ...
        out["violation_ids"] = (
            aws_sdk_iot.types.target_violation_ids_for_detect_mitigation_actions.deserialize_json(
                data["violationIds"]
            )
        )
