...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot.types.transfer_data


class CertificateDescription(TypedDict):
    ...
    previous_owned_by: NotRequired["aws_sdk_iot.types.aws_account_id.AwsAccountId"]
    ...
    transfer_data: NotRequired["aws_sdk_iot.types.transfer_data.TransferData"]
...
def serialize_json(value: CertificateDescription) -> dict:
    ...
    if "transfer_data" in value:
        ...
        out["transferData"] = aws_sdk_iot.types.transfer_data.serialize_json(
            value["transfer_data"]
        )
...
def deserialize_json(data: dict) -> CertificateDescription:
    ...
    if "transferData" in data:
        ...
        out["transfer_data"] = aws_sdk_iot.types.transfer_data.deserialize_json(
            data["transferData"]
        )
