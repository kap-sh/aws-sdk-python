...
if TYPE_CHECKING:
    ...
    import aws_sdk_iot.types.principal_id
...
class TestInvokeAuthorizerResponse(TypedDict, closed=True):
    ...
    policy_documents: NotRequired["aws_sdk_iot.types.policy_documents.PolicyDocuments"]
    """<p>IAM policy documents.</p>"""
    refresh_after_in_seconds: NotRequired["aws_sdk_iot.types.seconds.Seconds"]
    """<p>The number of seconds after which the temporary credentials are refreshed.</p>"""
    disconnect_after_in_seconds: NotRequired["aws_sdk_iot.types.seconds.Seconds"]
...
def serialize_json(value: TestInvokeAuthorizerResponse) -> dict:
    ...
    if "policy_documents" in value:
        ...
        out["policyDocuments"] = aws_sdk_iot.types.policy_documents.serialize_json(
...
def deserialize_json(data: dict) -> TestInvokeAuthorizerResponse:
    ...
    if "policyDocuments" in data:
        ...
        out["policy_documents"] = aws_sdk_iot.types.policy_documents.deserialize_json(
