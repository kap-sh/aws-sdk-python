...
if TYPE_CHECKING:
    import aws_sdk_iot.types.ca_certificate_description
    import aws_sdk_iot.types.registration_config


class DescribeCACertificateResponse(TypedDict):
    certificate_description: NotRequired[
        "aws_sdk_iot.types.ca_certificate_description.CACertificateDescription"
    ]
...
def serialize_json(value: DescribeCACertificateResponse) -> dict:
    ...
    if "certificate_description" in value:
        ...
        out["certificateDescription"] = (
            aws_sdk_iot.types.ca_certificate_description.serialize_json(
...
def deserialize_json(data: dict) -> DescribeCACertificateResponse:
    ...
    if "certificateDescription" in data:
        ...
        out["certificate_description"] = (
            aws_sdk_iot.types.ca_certificate_description.deserialize_json(
