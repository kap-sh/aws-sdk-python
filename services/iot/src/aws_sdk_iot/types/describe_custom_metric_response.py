"""Generated from Smithy shape ``com.amazonaws.iot#DescribeCustomMetricResponse``."""
...
class DescribeCustomMetricResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeCustomMetricResponse) -> dict:
    out: dict = {}
