...
class UpdateSecurityProfileRequest(TypedDict, closed=True):
    ...
    delete_behaviors: "aws_sdk_iot.types.delete_behaviors.DeleteBehaviors"
    ...
    delete_alert_targets: "aws_sdk_iot.types.delete_alert_targets.DeleteAlertTargets"
    ...
    delete_additional_metrics_to_retain: "aws_sdk_iot.types.delete_additional_metrics_to_retain.DeleteAdditionalMetricsToRetain"
