...
if TYPE_CHECKING:
    import aws_sdk_iot.types.client_certificate_callback_arn


class ClientCertificateConfig(TypedDict):
    client_certificate_callback_arn: NotRequired[
        "aws_sdk_iot.types.client_certificate_callback_arn.ClientCertificateCallbackArn"
    ]
