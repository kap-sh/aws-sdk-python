...
class SchedulingConfig(TypedDict, closed=True):
    ...
    end_behavior: NotRequired["aws_sdk_iot.types.job_end_behavior.JobEndBehavior"]
...
def serialize_json(value: SchedulingConfig) -> dict:
    ...
    if "end_behavior" in value:
        ...
        out["endBehavior"] = aws_sdk_iot.types.job_end_behavior.serialize_json(
            value["end_behavior"]
        )
...
def deserialize_json(data: dict) -> SchedulingConfig:
    ...
    if "endBehavior" in data:
        ...
        out["end_behavior"] = aws_sdk_iot.types.job_end_behavior.deserialize_json(
            data["endBehavior"]
        )
