...
class IoTError(Exception):
    """Base class for all IoT service errors."""


class ServiceError(IoTError):
...
class SerializationError(IoTError):
    """Raised when a value cannot be serialized."""


class DeserializationError(IoTError):
...
class WaiterFailedError(IoTError):
...
class WaiterTimeoutError(IoTError):
