"""Generated from Smithy shape ``com.amazonaws.iot#RemoveThingFromThingGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.remove_thing_from_thing_group_response.RemoveThingFromThingGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_iot.types.remove_thing_from_thing_group_request.RemoveThingFromThingGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.remove_thing_from_thing_group_request.serialize_json(input)
    ).encode()
...
async def async_remove_thing_from_thing_group(
