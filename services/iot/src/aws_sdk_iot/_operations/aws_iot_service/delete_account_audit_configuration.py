"""Generated from Smithy shape ``com.amazonaws.iot#DeleteAccountAuditConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_account_audit_configuration_response.DeleteAccountAuditConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_account_audit_configuration_request.DeleteAccountAuditConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    params["deleteScheduledAudits"] = str(input_.get("delete_scheduled_audits", False))
...
async def async_delete_account_audit_configuration(
