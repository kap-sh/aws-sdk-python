...
def build_request(
    ...
    input: aws_sdk_iot.types.delete_account_audit_configuration_request.DeleteAccountAuditConfigurationRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    params["deleteScheduledAudits"] = str(input.get("delete_scheduled_audits", False))
