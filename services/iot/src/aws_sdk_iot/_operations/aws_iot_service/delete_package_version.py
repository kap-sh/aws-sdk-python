"""Generated from Smithy shape ``com.amazonaws.iot#DeletePackageVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_package_version_response.DeletePackageVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_iot.types.delete_package_version_request.DeletePackageVersionRequest,
) -> zapros.Request:
...
async def async_delete_package_version(
