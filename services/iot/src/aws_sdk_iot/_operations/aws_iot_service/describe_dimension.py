...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_dimension_response.DescribeDimensionResponse = (
        aws_sdk_iot.types.describe_dimension_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_dimension_request.DescribeDimensionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
