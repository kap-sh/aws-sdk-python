...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_authorizer_response.DeleteAuthorizerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_authorizer_request.DeleteAuthorizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
