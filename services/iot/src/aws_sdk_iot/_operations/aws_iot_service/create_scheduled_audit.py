...
def build_request(
    ...
    input: aws_sdk_iot.types.create_scheduled_audit_request.CreateScheduledAuditRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_scheduled_audit_request.serialize_json(input)
    ).encode()
