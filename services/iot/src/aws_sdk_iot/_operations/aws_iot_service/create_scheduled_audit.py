"""Generated from Smithy shape ``com.amazonaws.iot#CreateScheduledAudit``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_scheduled_audit_response.CreateScheduledAuditResponse = aws_sdk_iot.types.create_scheduled_audit_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_scheduled_audit_request.CreateScheduledAuditRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_scheduled_audit_request.serialize_json(input_)
    ).encode()
...
async def async_create_scheduled_audit(
