...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_audit_mitigation_actions_tasks_response.ListAuditMitigationActionsTasksResponse = aws_sdk_iot.types.list_audit_mitigation_actions_tasks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_audit_mitigation_actions_tasks_request.ListAuditMitigationActionsTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
