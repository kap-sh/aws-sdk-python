"""Generated from Smithy shape ``com.amazonaws.iot#DetachThingPrincipal``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.detach_thing_principal_response.DetachThingPrincipalResponse = {}  # type: ignore[typeddict-item]
    return out
