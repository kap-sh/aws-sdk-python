...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_thing_groups_response.ListThingGroupsResponse = (
        aws_sdk_iot.types.list_thing_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_thing_groups_request.ListThingGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
