...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_package_version_response.GetPackageVersionResponse = (
        aws_sdk_iot.types.get_package_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.get_package_version_request.GetPackageVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
