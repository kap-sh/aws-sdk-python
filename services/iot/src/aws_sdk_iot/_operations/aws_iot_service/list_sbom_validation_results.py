...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_sbom_validation_results_response.ListSbomValidationResultsResponse = aws_sdk_iot.types.list_sbom_validation_results_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.list_sbom_validation_results_request.ListSbomValidationResultsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "validation_result" in input:
        params["validationResult"] = str(input["validation_result"])
