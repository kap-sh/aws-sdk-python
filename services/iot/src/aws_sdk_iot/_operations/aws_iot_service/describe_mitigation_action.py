"""Generated from Smithy shape ``com.amazonaws.iot#DescribeMitigationAction``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_mitigation_action_response.DescribeMitigationActionResponse = aws_sdk_iot.types.describe_mitigation_action_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_mitigation_action_request.DescribeMitigationActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_mitigation_action(
