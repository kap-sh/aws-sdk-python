...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_audit_finding_response.DescribeAuditFindingResponse = aws_sdk_iot.types.describe_audit_finding_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_audit_finding_request.DescribeAuditFindingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
