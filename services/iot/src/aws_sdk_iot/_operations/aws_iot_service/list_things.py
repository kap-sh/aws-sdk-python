...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_things_request.ListThingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "attribute_name" in input_:
        params["attributeName"] = str(input_["attribute_name"])
    if "attribute_value" in input_:
        params["attributeValue"] = str(input_["attribute_value"])
    if "thing_type_name" in input_:
        params["thingTypeName"] = str(input_["thing_type_name"])
    params["usePrefixAttributeValue"] = str(
        input_.get("use_prefix_attribute_value", False)
    )
