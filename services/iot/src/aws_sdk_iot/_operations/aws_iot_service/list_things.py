...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_things_response.ListThingsResponse = (
        aws_sdk_iot.types.list_things_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.list_things_request.ListThingsRequest,
) -> zapros.Request:
    ...
    if "attribute_name" in input:
        params["attributeName"] = str(input["attribute_name"])
    if "attribute_value" in input:
        params["attributeValue"] = str(input["attribute_value"])
    if "thing_type_name" in input:
        params["thingTypeName"] = str(input["thing_type_name"])
    params["usePrefixAttributeValue"] = str(
        input.get("use_prefix_attribute_value", False)
    )
...
def list_things(
    ...
    input: aws_sdk_iot.types.list_things_request.ListThingsRequest,
) -> tuple[aws_sdk_iot.types.list_things_response.ListThingsResponse, zapros.Response]:
