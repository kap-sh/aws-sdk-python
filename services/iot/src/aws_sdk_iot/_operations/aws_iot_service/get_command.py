...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_command_response.GetCommandResponse = (
        aws_sdk_iot.types.get_command_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.get_command_request.GetCommandRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_command(
    ...
    input_: aws_sdk_iot.types.get_command_request.GetCommandRequest,
) -> tuple[aws_sdk_iot.types.get_command_response.GetCommandResponse, zapros.Response]:
