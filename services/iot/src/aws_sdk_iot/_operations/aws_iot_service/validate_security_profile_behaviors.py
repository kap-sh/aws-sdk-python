"""Generated from Smithy shape ``com.amazonaws.iot#ValidateSecurityProfileBehaviors``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.validate_security_profile_behaviors_response.ValidateSecurityProfileBehaviorsResponse = aws_sdk_iot.types.validate_security_profile_behaviors_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.validate_security_profile_behaviors_request.ValidateSecurityProfileBehaviorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_validate_security_profile_behaviors(
