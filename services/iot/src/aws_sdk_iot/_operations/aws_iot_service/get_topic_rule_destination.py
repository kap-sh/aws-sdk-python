"""Generated from Smithy shape ``com.amazonaws.iot#GetTopicRuleDestination``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_topic_rule_destination_response.GetTopicRuleDestinationResponse = aws_sdk_iot.types.get_topic_rule_destination_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.get_topic_rule_destination_request.GetTopicRuleDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/destinations/{arn+}"
...
async def async_get_topic_rule_destination(
