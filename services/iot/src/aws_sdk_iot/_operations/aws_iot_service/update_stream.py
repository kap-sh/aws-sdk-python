...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_stream_response.UpdateStreamResponse = (
        aws_sdk_iot.types.update_stream_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_stream_request.UpdateStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_stream_request.serialize_json(input_)
    ).encode()
...
def update_stream(
    ...
    aws_sdk_iot.types.update_stream_response.UpdateStreamResponse, zapros.Response
]:
