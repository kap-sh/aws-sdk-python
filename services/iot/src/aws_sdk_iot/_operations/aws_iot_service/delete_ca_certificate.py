...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_ca_certificate_response.DeleteCACertificateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_ca_certificate_request.DeleteCACertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
