...
def build_request(
    ...
    input: aws_sdk_iot.types.set_v2_logging_options_request.SetV2LoggingOptionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.set_v2_logging_options_request.serialize_json(input)
    ).encode()
