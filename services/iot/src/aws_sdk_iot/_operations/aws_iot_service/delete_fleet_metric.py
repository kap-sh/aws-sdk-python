"""Generated from Smithy shape ``com.amazonaws.iot#DeleteFleetMetric``."""
...
def build_request(
    ...
    input: aws_sdk_iot.types.delete_fleet_metric_request.DeleteFleetMetricRequest,
) -> zapros.Request:
...
async def async_delete_fleet_metric(
