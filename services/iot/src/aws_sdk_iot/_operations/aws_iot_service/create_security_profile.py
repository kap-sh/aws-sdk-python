...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_security_profile_response.CreateSecurityProfileResponse = aws_sdk_iot.types.create_security_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_security_profile_request.CreateSecurityProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_security_profile_request.serialize_json(input_)
    ).encode()
