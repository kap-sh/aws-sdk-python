...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_detect_mitigation_actions_executions_response.ListDetectMitigationActionsExecutionsResponse = aws_sdk_iot.types.list_detect_mitigation_actions_executions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_detect_mitigation_actions_executions_request.ListDetectMitigationActionsExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
