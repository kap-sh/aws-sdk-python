...
def build_request(
    ...
    input: aws_sdk_iot.types.list_detect_mitigation_actions_executions_request.ListDetectMitigationActionsExecutionsRequest,
) -> zapros.Request:
    ...
    if "violation_id" in input:
        params["violationId"] = str(input["violation_id"])
