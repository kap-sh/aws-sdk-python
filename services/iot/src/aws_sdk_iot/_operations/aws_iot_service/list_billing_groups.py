...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_billing_groups_response.ListBillingGroupsResponse = (
        aws_sdk_iot.types.list_billing_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_billing_groups_request.ListBillingGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
