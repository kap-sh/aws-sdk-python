...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_audit_findings_response.ListAuditFindingsResponse = (
        aws_sdk_iot.types.list_audit_findings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_audit_findings_request.ListAuditFindingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.list_audit_findings_request.serialize_json(input_)
    ).encode()
