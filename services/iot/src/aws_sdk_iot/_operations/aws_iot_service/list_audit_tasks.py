...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_audit_tasks_response.ListAuditTasksResponse = (
        aws_sdk_iot.types.list_audit_tasks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_audit_tasks_request.ListAuditTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "task_type" in input_:
        params["taskType"] = str(input_["task_type"])
...
def list_audit_tasks(
    ...
    aws_sdk_iot.types.list_audit_tasks_response.ListAuditTasksResponse, zapros.Response
]:
