"""Generated from Smithy shape ``com.amazonaws.iot#GetCardinality``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_cardinality_response.GetCardinalityResponse = (
        aws_sdk_iot.types.get_cardinality_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.get_cardinality_request.GetCardinalityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/indices/cardinality"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_iot.types.get_cardinality_request

    body: bytes | None = json.dumps(
        aws_sdk_iot.types.get_cardinality_request.serialize_json(input_)
    ).encode()
...
def get_cardinality(
    ...
    aws_sdk_iot.types.get_cardinality_response.GetCardinalityResponse, zapros.Response
]:
...
async def async_get_cardinality(
