"""Generated from Smithy shape ``com.amazonaws.iot#ListAttachedPolicies``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_attached_policies_response.ListAttachedPoliciesResponse = aws_sdk_iot.types.list_attached_policies_response.deserialize_json(
