"""Generated from Smithy shape ``com.amazonaws.iot#DeletePackage``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_package_response.DeletePackageResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_iot.types.delete_package_request.DeletePackageRequest,
) -> zapros.Request:
...
def delete_package(
    ...
    aws_sdk_iot.types.delete_package_response.DeletePackageResponse, zapros.Response
]:
