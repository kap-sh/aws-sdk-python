...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_authorizer_response.DescribeAuthorizerResponse = (
        aws_sdk_iot.types.describe_authorizer_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.describe_authorizer_request.DescribeAuthorizerRequest,
) -> zapros.Request:
