"""Generated from Smithy shape ``com.amazonaws.iot#ListThingRegistrationTaskReports``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_thing_registration_task_reports_response.ListThingRegistrationTaskReportsResponse = aws_sdk_iot.types.list_thing_registration_task_reports_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_thing_registration_task_reports_request.ListThingRegistrationTaskReportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/thing-registration-tasks/{taskId}/reports"
...
async def async_list_thing_registration_task_reports(
