"""Generated from Smithy shape ``com.amazonaws.iot#GetTopicRule``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_topic_rule_response.GetTopicRuleResponse = (
        aws_sdk_iot.types.get_topic_rule_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.get_topic_rule_request.GetTopicRuleRequest,
) -> zapros.Request:
...
def get_topic_rule(
    ...
    aws_sdk_iot.types.get_topic_rule_response.GetTopicRuleResponse, zapros.Response
]:
...
async def async_get_topic_rule(
