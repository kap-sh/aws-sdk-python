...
def build_request(
    ...
    input: aws_sdk_iot.types.create_provisioning_template_version_request.CreateProvisioningTemplateVersionRequest,
) -> zapros.Request:
    ...
    url = url.replace("{templateName}", quote(str(input["template_name"]), safe=""))
    params: dict[str, str] = {}
    params["setAsDefault"] = str(input.get("set_as_default", False))
