...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "VersionsLimitExceededException":
            import aws_sdk_iot.errors.versions_limit_exceeded_exception

            raise aws_sdk_iot.errors.versions_limit_exceeded_exception.VersionsLimitExceededException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_provisioning_template_version_response.CreateProvisioningTemplateVersionResponse = aws_sdk_iot.types.create_provisioning_template_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_provisioning_template_version_request.CreateProvisioningTemplateVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_provisioning_template_version_request.serialize_json(
            input_
        )
    ).encode()
