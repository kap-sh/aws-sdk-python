...
def build_request(
    ...
    input: aws_sdk_iot.types.list_commands_request.ListCommandsRequest,
) -> zapros.Request:
    ...
    if "command_parameter_name" in input:
        params["commandParameterName"] = str(input["command_parameter_name"])
