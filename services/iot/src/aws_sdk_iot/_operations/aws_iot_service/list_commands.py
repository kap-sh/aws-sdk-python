"""Generated from Smithy shape ``com.amazonaws.iot#ListCommands``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_commands_response.ListCommandsResponse = (
        aws_sdk_iot.types.list_commands_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_commands_request.ListCommandsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/commands"
    params: dict[str, str] = {}
    ...
    if "command_parameter_name" in input_:
        params["commandParameterName"] = str(input_["command_parameter_name"])
...
def list_commands(
    ...
    aws_sdk_iot.types.list_commands_response.ListCommandsResponse, zapros.Response
]:
