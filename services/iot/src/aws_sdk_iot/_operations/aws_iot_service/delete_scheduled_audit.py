...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_scheduled_audit_response.DeleteScheduledAuditResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_scheduled_audit_request.DeleteScheduledAuditRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
