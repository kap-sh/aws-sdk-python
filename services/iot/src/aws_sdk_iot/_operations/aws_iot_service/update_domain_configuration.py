...
def build_request(
    ...
    input: aws_sdk_iot.types.update_domain_configuration_request.UpdateDomainConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_domain_configuration_request.serialize_json(input)
    ).encode()
