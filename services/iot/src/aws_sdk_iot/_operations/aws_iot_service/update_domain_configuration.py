...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_domain_configuration_response.UpdateDomainConfigurationResponse = aws_sdk_iot.types.update_domain_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_domain_configuration_request.UpdateDomainConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_domain_configuration_request.serialize_json(input_)
    ).encode()
