"""Generated from Smithy shape ``com.amazonaws.iot#ListFleetMetrics``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_fleet_metrics_response.ListFleetMetricsResponse = (
        aws_sdk_iot.types.list_fleet_metrics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_fleet_metrics_request.ListFleetMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/fleet-metrics"
    params: dict[str, str] = {}
...
async def async_list_fleet_metrics(
