"""Generated from Smithy shape ``com.amazonaws.iot#ListAuditMitigationActionsExecutions``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_audit_mitigation_actions_executions_response.ListAuditMitigationActionsExecutionsResponse = aws_sdk_iot.types.list_audit_mitigation_actions_executions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_audit_mitigation_actions_executions_request.ListAuditMitigationActionsExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/audit/mitigationactions/executions"
    params: dict[str, str] = {}
    if "task_id" in input_:
        params["taskId"] = str(input_["task_id"])
    if "action_status" in input_:
        params["actionStatus"] = str(input_["action_status"])
...
async def async_list_audit_mitigation_actions_executions(
