...
def build_request(
    ...
    input: aws_sdk_iot.types.list_audit_mitigation_actions_executions_request.ListAuditMitigationActionsExecutionsRequest,
) -> zapros.Request:
    ...
    if "action_status" in input:
        params["actionStatus"] = str(input["action_status"])
    if "finding_id" in input:
        params["findingId"] = str(input["finding_id"])
