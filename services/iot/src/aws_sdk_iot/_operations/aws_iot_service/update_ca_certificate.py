...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_ca_certificate_request.UpdateCACertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    if "new_status" in input_:
        params["newStatus"] = str(input_["new_status"])
    if "new_auto_registration_status" in input_:
        params["newAutoRegistrationStatus"] = str(
