...
def build_request(
    ...
    input: aws_sdk_iot.types.list_metric_values_request.ListMetricValuesRequest,
) -> zapros.Request:
    ...
    if "dimension_value_operator" in input:
        params["dimensionValueOperator"] = str(input["dimension_value_operator"])
