...
def build_request(
    ...
    input: aws_sdk_iot.types.attach_security_profile_request.AttachSecurityProfileRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "security_profile_target_arn" in input:
        params["securityProfileTargetArn"] = str(input["security_profile_target_arn"])
