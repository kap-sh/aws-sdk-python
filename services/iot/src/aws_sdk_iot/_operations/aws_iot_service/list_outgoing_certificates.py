"""Generated from Smithy shape ``com.amazonaws.iot#ListOutgoingCertificates``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_outgoing_certificates_response.ListOutgoingCertificatesResponse = aws_sdk_iot.types.list_outgoing_certificates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_outgoing_certificates_request.ListOutgoingCertificatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/certificates-out-going"
    params: dict[str, str] = {}
...
async def async_list_outgoing_certificates(
