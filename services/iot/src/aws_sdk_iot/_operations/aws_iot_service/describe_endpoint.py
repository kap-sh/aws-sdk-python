"""Generated from Smithy shape ``com.amazonaws.iot#DescribeEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_endpoint_response.DescribeEndpointResponse = (
        aws_sdk_iot.types.describe_endpoint_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.describe_endpoint_request.DescribeEndpointRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "endpoint_type" in input:
        params["endpointType"] = str(input["endpoint_type"])
