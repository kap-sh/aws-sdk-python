...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_index_response.DescribeIndexResponse = (
        aws_sdk_iot.types.describe_index_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.describe_index_request.DescribeIndexRequest,
) -> zapros.Request:
...
def describe_index(
    ...
    aws_sdk_iot.types.describe_index_response.DescribeIndexResponse, zapros.Response
]:
