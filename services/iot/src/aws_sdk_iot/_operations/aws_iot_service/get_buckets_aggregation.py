...
def build_request(
    ...
    input: aws_sdk_iot.types.get_buckets_aggregation_request.GetBucketsAggregationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.get_buckets_aggregation_request.serialize_json(input)
    ).encode()
