"""Generated from Smithy shape ``com.amazonaws.iot#DescribeProvisioningTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_provisioning_template_response.DescribeProvisioningTemplateResponse = aws_sdk_iot.types.describe_provisioning_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_provisioning_template_request.DescribeProvisioningTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_provisioning_template(
