"""Generated from Smithy shape ``com.amazonaws.iot#DescribeJob``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_job_response.DescribeJobResponse = (
        aws_sdk_iot.types.describe_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_job_request.DescribeJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_job(
    ...
    aws_sdk_iot.types.describe_job_response.DescribeJobResponse, zapros.Response
]:
