...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_mitigation_actions_response.ListMitigationActionsResponse = aws_sdk_iot.types.list_mitigation_actions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_mitigation_actions_request.ListMitigationActionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
