"""Generated from Smithy shape ``com.amazonaws.iot#DescribeJobExecution``."""
...
import aws_sdk_iot.types.job_execution
...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_job_execution_response.DescribeJobExecutionResponse = aws_sdk_iot.types.describe_job_execution_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_job_execution_request.DescribeJobExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
