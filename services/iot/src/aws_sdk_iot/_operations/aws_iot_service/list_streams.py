...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_streams_response.ListStreamsResponse = (
        aws_sdk_iot.types.list_streams_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_streams_request.ListStreamsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_streams(
    ...
    aws_sdk_iot.types.list_streams_response.ListStreamsResponse, zapros.Response
]:
