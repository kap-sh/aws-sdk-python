...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_provisioning_templates_response.ListProvisioningTemplatesResponse = aws_sdk_iot.types.list_provisioning_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_provisioning_templates_request.ListProvisioningTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
