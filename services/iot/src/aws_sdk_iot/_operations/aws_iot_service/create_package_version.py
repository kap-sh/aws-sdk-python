...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_package_version_request.CreatePackageVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_package_version_request.serialize_json(input_)
    ).encode()
