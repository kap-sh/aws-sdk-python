...
def build_request(
    ...
    input_: aws_sdk_iot.types.reject_certificate_transfer_request.RejectCertificateTransferRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.reject_certificate_transfer_request.serialize_json(input_)
    ).encode()
