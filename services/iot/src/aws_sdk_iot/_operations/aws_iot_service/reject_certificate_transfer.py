...
def build_request(
    ...
    input: aws_sdk_iot.types.reject_certificate_transfer_request.RejectCertificateTransferRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.reject_certificate_transfer_request.serialize_json(input)
    ).encode()
