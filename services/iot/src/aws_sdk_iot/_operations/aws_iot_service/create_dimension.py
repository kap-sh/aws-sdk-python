...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_dimension_response.CreateDimensionResponse = (
        aws_sdk_iot.types.create_dimension_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_dimension_request.CreateDimensionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_dimension_request.serialize_json(input_)
    ).encode()
...
def create_dimension(
    ...
    aws_sdk_iot.types.create_dimension_response.CreateDimensionResponse, zapros.Response
]:
