"""Generated from Smithy shape ``com.amazonaws.iot#ListPackages``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_packages_response.ListPackagesResponse = (
        aws_sdk_iot.types.list_packages_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_packages_request.ListPackagesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/packages"
    params: dict[str, str] = {}
...
def list_packages(
    ...
    aws_sdk_iot.types.list_packages_response.ListPackagesResponse, zapros.Response
]:
