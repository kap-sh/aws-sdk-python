"""Generated from Smithy shape ``com.amazonaws.iot#DeleteProvisioningTemplateVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_provisioning_template_version_response.DeleteProvisioningTemplateVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_provisioning_template_version_request.DeleteProvisioningTemplateVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_provisioning_template_version(
