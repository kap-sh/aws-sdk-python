"""Generated from Smithy shape ``com.amazonaws.iot#AssociateTargetsWithJob``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.associate_targets_with_job_response.AssociateTargetsWithJobResponse = aws_sdk_iot.types.associate_targets_with_job_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.associate_targets_with_job_request.AssociateTargetsWithJobRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/jobs/{jobId}/targets"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.associate_targets_with_job_request.serialize_json(input)
    ).encode()
...
async def async_associate_targets_with_job(
