...
def build_request(
    ...
    input: aws_sdk_iot.types.get_thing_connectivity_data_request.GetThingConnectivityDataRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.get_thing_connectivity_data_request.serialize_json(input)
    ).encode()
