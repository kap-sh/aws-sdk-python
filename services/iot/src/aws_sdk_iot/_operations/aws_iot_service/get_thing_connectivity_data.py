...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_thing_connectivity_data_response.GetThingConnectivityDataResponse = aws_sdk_iot.types.get_thing_connectivity_data_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.get_thing_connectivity_data_request.GetThingConnectivityDataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.get_thing_connectivity_data_request.serialize_json(input_)
    ).encode()
