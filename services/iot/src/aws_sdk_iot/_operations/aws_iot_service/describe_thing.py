...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_thing_response.DescribeThingResponse = (
        aws_sdk_iot.types.describe_thing_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_thing_request.DescribeThingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_thing(
    ...
    aws_sdk_iot.types.describe_thing_response.DescribeThingResponse, zapros.Response
]:
