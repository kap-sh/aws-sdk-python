...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_dynamic_thing_group_response.UpdateDynamicThingGroupResponse = aws_sdk_iot.types.update_dynamic_thing_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_dynamic_thing_group_request.UpdateDynamicThingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_dynamic_thing_group_request.serialize_json(input_)
    ).encode()
