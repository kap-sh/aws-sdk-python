...
def build_request(
    ...
    input: aws_sdk_iot.types.update_dynamic_thing_group_request.UpdateDynamicThingGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_dynamic_thing_group_request.serialize_json(input)
    ).encode()
