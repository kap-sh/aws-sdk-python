...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_package_version_response.UpdatePackageVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_iot.types.update_package_version_request.UpdatePackageVersionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_package_version_request.serialize_json(input)
    ).encode()
