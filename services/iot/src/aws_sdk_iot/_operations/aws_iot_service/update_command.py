...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_command_response.UpdateCommandResponse = (
        aws_sdk_iot.types.update_command_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.update_command_request.UpdateCommandRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_command_request.serialize_json(input)
    ).encode()
...
def update_command(
    ...
    aws_sdk_iot.types.update_command_response.UpdateCommandResponse, zapros.Response
]:
