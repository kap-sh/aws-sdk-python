"""Generated from Smithy shape ``com.amazonaws.iot#UpdateDimension``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_dimension_response.UpdateDimensionResponse = (
        aws_sdk_iot.types.update_dimension_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_dimension_request.UpdateDimensionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/dimensions/{name}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_dimension_request.serialize_json(input_)
    ).encode()
...
def update_dimension(
    ...
    aws_sdk_iot.types.update_dimension_response.UpdateDimensionResponse, zapros.Response
]:
...
async def async_update_dimension(
