...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_authorizers_response.ListAuthorizersResponse = (
        aws_sdk_iot.types.list_authorizers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_authorizers_request.ListAuthorizersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_authorizers(
    ...
    aws_sdk_iot.types.list_authorizers_response.ListAuthorizersResponse, zapros.Response
]:
