...
def handle_response(
    ...
    out: aws_sdk_iot.types.associate_sbom_with_package_version_response.AssociateSbomWithPackageVersionResponse = aws_sdk_iot.types.associate_sbom_with_package_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.associate_sbom_with_package_version_request.AssociateSbomWithPackageVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.associate_sbom_with_package_version_request.serialize_json(
            input_
        )
    ).encode()
