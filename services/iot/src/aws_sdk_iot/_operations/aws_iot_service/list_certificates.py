...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_certificates_response.ListCertificatesResponse = (
        aws_sdk_iot.types.list_certificates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_certificates_request.ListCertificatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
