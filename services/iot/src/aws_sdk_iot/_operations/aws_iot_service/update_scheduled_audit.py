...
def build_request(
    ...
    input: aws_sdk_iot.types.update_scheduled_audit_request.UpdateScheduledAuditRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{scheduledAuditName}", quote(str(input["scheduled_audit_name"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_scheduled_audit_request.serialize_json(input)
    ).encode()
