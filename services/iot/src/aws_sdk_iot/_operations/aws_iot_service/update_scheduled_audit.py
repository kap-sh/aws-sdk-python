...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_scheduled_audit_response.UpdateScheduledAuditResponse = aws_sdk_iot.types.update_scheduled_audit_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_scheduled_audit_request.UpdateScheduledAuditRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_scheduled_audit_request.serialize_json(input_)
    ).encode()
