...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_topic_rule_destinations_response.ListTopicRuleDestinationsResponse = aws_sdk_iot.types.list_topic_rule_destinations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_topic_rule_destinations_request.ListTopicRuleDestinationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
