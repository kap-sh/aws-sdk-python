...
def build_request(
    ...
    input: aws_sdk_iot.types.set_default_authorizer_request.SetDefaultAuthorizerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.set_default_authorizer_request.serialize_json(input)
    ).encode()
