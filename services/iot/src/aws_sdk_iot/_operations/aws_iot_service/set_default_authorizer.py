...
def handle_response(
    ...
    out: aws_sdk_iot.types.set_default_authorizer_response.SetDefaultAuthorizerResponse = aws_sdk_iot.types.set_default_authorizer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.set_default_authorizer_request.SetDefaultAuthorizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.set_default_authorizer_request.serialize_json(input_)
    ).encode()
