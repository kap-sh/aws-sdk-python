"""Generated from Smithy shape ``com.amazonaws.iot#GetPercentiles``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_percentiles_response.GetPercentilesResponse = (
        aws_sdk_iot.types.get_percentiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.get_percentiles_request.GetPercentilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/indices/percentiles"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_iot.types.get_percentiles_request

    body: bytes | None = json.dumps(
        aws_sdk_iot.types.get_percentiles_request.serialize_json(input_)
    ).encode()
...
def get_percentiles(
    ...
    aws_sdk_iot.types.get_percentiles_response.GetPercentilesResponse, zapros.Response
]:
...
async def async_get_percentiles(
