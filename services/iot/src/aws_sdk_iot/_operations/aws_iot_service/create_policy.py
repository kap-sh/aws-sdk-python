...
import aws_sdk_iot.errors.malformed_policy_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MalformedPolicyException":
            raise aws_sdk_iot.errors.malformed_policy_exception.MalformedPolicyException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_policy_response.CreatePolicyResponse = (
        aws_sdk_iot.types.create_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_policy_request.CreatePolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_policy_request.serialize_json(input_)
    ).encode()
...
def create_policy(
    ...
    aws_sdk_iot.types.create_policy_response.CreatePolicyResponse, zapros.Response
]:
