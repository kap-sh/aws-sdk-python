...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_things_in_thing_group_response.ListThingsInThingGroupResponse = aws_sdk_iot.types.list_things_in_thing_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_things_in_thing_group_request.ListThingsInThingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
