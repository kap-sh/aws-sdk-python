...
def handle_response(
    ...
    out: aws_sdk_iot.types.confirm_topic_rule_destination_response.ConfirmTopicRuleDestinationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_iot.types.confirm_topic_rule_destination_request.ConfirmTopicRuleDestinationRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{confirmationToken+}", quote(str(input["confirmation_token"]), safe="/")
    )
    params: dict[str, str] = {}
