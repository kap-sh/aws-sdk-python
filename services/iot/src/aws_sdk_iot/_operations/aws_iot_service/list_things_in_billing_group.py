"""Generated from Smithy shape ``com.amazonaws.iot#ListThingsInBillingGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_things_in_billing_group_response.ListThingsInBillingGroupResponse = aws_sdk_iot.types.list_things_in_billing_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_things_in_billing_group_request.ListThingsInBillingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/billing-groups/{billingGroupName}/things"
    url = url.replace(
...
async def async_list_things_in_billing_group(
