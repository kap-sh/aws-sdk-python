...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_scheduled_audits_response.ListScheduledAuditsResponse = aws_sdk_iot.types.list_scheduled_audits_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_scheduled_audits_request.ListScheduledAuditsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
