...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_provisioning_template_response.CreateProvisioningTemplateResponse = aws_sdk_iot.types.create_provisioning_template_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.create_provisioning_template_request.CreateProvisioningTemplateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_provisioning_template_request.serialize_json(input)
    ).encode()
