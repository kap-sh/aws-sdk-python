...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_billing_group_response.DescribeBillingGroupResponse = aws_sdk_iot.types.describe_billing_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_billing_group_request.DescribeBillingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
