...
def handle_response(
    ...
    out: aws_sdk_iot.types.add_thing_to_thing_group_response.AddThingToThingGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.add_thing_to_thing_group_request.AddThingToThingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.add_thing_to_thing_group_request.serialize_json(input_)
    ).encode()
