...
def build_request(
    ...
    input: aws_sdk_iot.types.add_thing_to_thing_group_request.AddThingToThingGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.add_thing_to_thing_group_request.serialize_json(input)
    ).encode()
