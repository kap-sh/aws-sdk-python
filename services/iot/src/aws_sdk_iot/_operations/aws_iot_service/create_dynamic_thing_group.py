"""Generated from Smithy shape ``com.amazonaws.iot#CreateDynamicThingGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_dynamic_thing_group_response.CreateDynamicThingGroupResponse = aws_sdk_iot.types.create_dynamic_thing_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_dynamic_thing_group_request.CreateDynamicThingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_dynamic_thing_group_request.serialize_json(input_)
    ).encode()
...
async def async_create_dynamic_thing_group(
