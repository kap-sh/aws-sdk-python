...
def build_request(
    ...
    input: aws_sdk_iot.types.create_dynamic_thing_group_request.CreateDynamicThingGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_dynamic_thing_group_request.serialize_json(input)
    ).encode()
