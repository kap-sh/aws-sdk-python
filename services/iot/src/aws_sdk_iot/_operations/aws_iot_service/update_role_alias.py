...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_role_alias_response.UpdateRoleAliasResponse = (
        aws_sdk_iot.types.update_role_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_role_alias_request.UpdateRoleAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_role_alias_request.serialize_json(input_)
    ).encode()
