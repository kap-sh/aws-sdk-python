"""Generated from Smithy shape ``com.amazonaws.iot#DescribeThingType``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_thing_type_response.DescribeThingTypeResponse = (
        aws_sdk_iot.types.describe_thing_type_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.describe_thing_type_request.DescribeThingTypeRequest,
) -> zapros.Request:
...
async def async_describe_thing_type(
