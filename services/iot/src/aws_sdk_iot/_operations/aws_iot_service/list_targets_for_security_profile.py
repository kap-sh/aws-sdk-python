"""Generated from Smithy shape ``com.amazonaws.iot#ListTargetsForSecurityProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_targets_for_security_profile_response.ListTargetsForSecurityProfileResponse = aws_sdk_iot.types.list_targets_for_security_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_targets_for_security_profile_request.ListTargetsForSecurityProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_targets_for_security_profile(
