"""Generated from Smithy shape ``com.amazonaws.iot#DeleteThing``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_thing_response.DeleteThingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_iot.types.delete_thing_request.DeleteThingRequest,
) -> zapros.Request:
...
def delete_thing(
    ...
    aws_sdk_iot.types.delete_thing_response.DeleteThingResponse, zapros.Response
]:
