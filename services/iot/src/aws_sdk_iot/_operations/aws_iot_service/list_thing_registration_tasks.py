...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_thing_registration_tasks_response.ListThingRegistrationTasksResponse = aws_sdk_iot.types.list_thing_registration_tasks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_thing_registration_tasks_request.ListThingRegistrationTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
