...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_statistics_response.GetStatisticsResponse = (
        aws_sdk_iot.types.get_statistics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.get_statistics_request.GetStatisticsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.get_statistics_request.serialize_json(input_)
    ).encode()
...
def get_statistics(
    ...
    aws_sdk_iot.types.get_statistics_response.GetStatisticsResponse, zapros.Response
]:
