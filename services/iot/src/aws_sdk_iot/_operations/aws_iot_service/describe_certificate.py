...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_certificate_response.DescribeCertificateResponse = (
        aws_sdk_iot.types.describe_certificate_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_certificate_request.DescribeCertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
