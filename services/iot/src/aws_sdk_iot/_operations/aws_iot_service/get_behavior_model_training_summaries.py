...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_behavior_model_training_summaries_response.GetBehaviorModelTrainingSummariesResponse = aws_sdk_iot.types.get_behavior_model_training_summaries_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.get_behavior_model_training_summaries_request.GetBehaviorModelTrainingSummariesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
