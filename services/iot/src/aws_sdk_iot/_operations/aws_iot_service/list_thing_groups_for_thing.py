...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_thing_groups_for_thing_response.ListThingGroupsForThingResponse = aws_sdk_iot.types.list_thing_groups_for_thing_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_thing_groups_for_thing_request.ListThingGroupsForThingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
