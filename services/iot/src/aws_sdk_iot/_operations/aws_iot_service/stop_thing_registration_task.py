...
def handle_response(
    ...
    out: aws_sdk_iot.types.stop_thing_registration_task_response.StopThingRegistrationTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.stop_thing_registration_task_request.StopThingRegistrationTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
