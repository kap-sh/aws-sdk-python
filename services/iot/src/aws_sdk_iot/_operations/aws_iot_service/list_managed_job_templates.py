...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_managed_job_templates_response.ListManagedJobTemplatesResponse = aws_sdk_iot.types.list_managed_job_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_managed_job_templates_request.ListManagedJobTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
