...
def build_request(
    ...
    input: aws_sdk_iot.types.remove_thing_from_billing_group_request.RemoveThingFromBillingGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.remove_thing_from_billing_group_request.serialize_json(input)
    ).encode()
