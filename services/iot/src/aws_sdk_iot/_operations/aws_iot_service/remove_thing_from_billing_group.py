...
def handle_response(
    ...
    out: aws_sdk_iot.types.remove_thing_from_billing_group_response.RemoveThingFromBillingGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.remove_thing_from_billing_group_request.RemoveThingFromBillingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.remove_thing_from_billing_group_request.serialize_json(input_)
    ).encode()
