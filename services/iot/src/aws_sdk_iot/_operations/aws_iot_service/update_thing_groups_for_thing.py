...
def build_request(
    ...
    input: aws_sdk_iot.types.update_thing_groups_for_thing_request.UpdateThingGroupsForThingRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_thing_groups_for_thing_request.serialize_json(input)
    ).encode()
