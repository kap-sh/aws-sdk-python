...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_thing_response.CreateThingResponse = (
        aws_sdk_iot.types.create_thing_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_thing_request.CreateThingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_thing_request.serialize_json(input_)
    ).encode()
...
def create_thing(
    ...
    aws_sdk_iot.types.create_thing_response.CreateThingResponse, zapros.Response
]:
