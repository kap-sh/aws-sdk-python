...
def build_request(
    ...
    input: aws_sdk_iot.types.add_thing_to_billing_group_request.AddThingToBillingGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.add_thing_to_billing_group_request.serialize_json(input)
    ).encode()
