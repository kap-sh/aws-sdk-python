...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_registration_code_response.GetRegistrationCodeResponse = aws_sdk_iot.types.get_registration_code_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.get_registration_code_request.GetRegistrationCodeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
