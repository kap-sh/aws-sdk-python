"""Generated from Smithy shape ``com.amazonaws.iot#UpdatePackage``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_package_response.UpdatePackageResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_iot.types.update_package_request.UpdatePackageRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/packages/{packageName}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_package_request.serialize_json(input)
    ).encode()
...
def update_package(
    ...
    aws_sdk_iot.types.update_package_response.UpdatePackageResponse, zapros.Response
]:
...
async def async_update_package(
