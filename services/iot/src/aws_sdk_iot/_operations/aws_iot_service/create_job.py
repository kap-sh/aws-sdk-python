...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_job_response.CreateJobResponse = (
        aws_sdk_iot.types.create_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_job_request.CreateJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_job_request.serialize_json(input_)
    ).encode()
...
def create_job(
    ...
    input_: aws_sdk_iot.types.create_job_request.CreateJobRequest,
) -> tuple[aws_sdk_iot.types.create_job_response.CreateJobResponse, zapros.Response]:
