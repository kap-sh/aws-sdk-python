...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_detect_mitigation_actions_task_response.DescribeDetectMitigationActionsTaskResponse = aws_sdk_iot.types.describe_detect_mitigation_actions_task_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_detect_mitigation_actions_task_request.DescribeDetectMitigationActionsTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
