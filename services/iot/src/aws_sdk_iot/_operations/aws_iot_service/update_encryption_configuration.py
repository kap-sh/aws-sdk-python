...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_encryption_configuration_response.UpdateEncryptionConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_encryption_configuration_request.UpdateEncryptionConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_encryption_configuration_request.serialize_json(input_)
    ).encode()
