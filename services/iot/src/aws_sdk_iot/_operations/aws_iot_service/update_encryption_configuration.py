...
def build_request(
    ...
    input: aws_sdk_iot.types.update_encryption_configuration_request.UpdateEncryptionConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_encryption_configuration_request.serialize_json(input)
    ).encode()
