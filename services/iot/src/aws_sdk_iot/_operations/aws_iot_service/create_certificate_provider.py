...
def build_request(
    ...
    input: aws_sdk_iot.types.create_certificate_provider_request.CreateCertificateProviderRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["certificate_provider_name"]), safe=""),
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_certificate_provider_request.serialize_json(input)
    ).encode()
