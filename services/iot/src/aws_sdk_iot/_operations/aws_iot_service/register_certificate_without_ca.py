"""Generated from Smithy shape ``com.amazonaws.iot#RegisterCertificateWithoutCA``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.register_certificate_without_ca_response.RegisterCertificateWithoutCAResponse = aws_sdk_iot.types.register_certificate_without_ca_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.register_certificate_without_ca_request.RegisterCertificateWithoutCARequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.register_certificate_without_ca_request.serialize_json(input)
    ).encode()
...
async def async_register_certificate_without_ca(
