...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_job_executions_for_job_response.ListJobExecutionsForJobResponse = aws_sdk_iot.types.list_job_executions_for_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_job_executions_for_job_request.ListJobExecutionsForJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
