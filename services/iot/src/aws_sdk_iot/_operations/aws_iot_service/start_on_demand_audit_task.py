...
def handle_response(
    ...
    out: aws_sdk_iot.types.start_on_demand_audit_task_response.StartOnDemandAuditTaskResponse = aws_sdk_iot.types.start_on_demand_audit_task_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.start_on_demand_audit_task_request.StartOnDemandAuditTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.start_on_demand_audit_task_request.serialize_json(input_)
    ).encode()
