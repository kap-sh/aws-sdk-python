...
def build_request(
    ...
    input: aws_sdk_iot.types.start_on_demand_audit_task_request.StartOnDemandAuditTaskRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.start_on_demand_audit_task_request.serialize_json(input)
    ).encode()
