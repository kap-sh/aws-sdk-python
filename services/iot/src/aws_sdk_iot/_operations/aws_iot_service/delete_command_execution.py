...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_command_execution_response.DeleteCommandExecutionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_command_execution_request.DeleteCommandExecutionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
