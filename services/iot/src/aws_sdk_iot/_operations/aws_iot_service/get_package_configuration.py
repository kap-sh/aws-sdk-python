...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_package_configuration_response.GetPackageConfigurationResponse = aws_sdk_iot.types.get_package_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.get_package_configuration_request.GetPackageConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
