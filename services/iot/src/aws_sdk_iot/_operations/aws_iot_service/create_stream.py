...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_stream_response.CreateStreamResponse = (
        aws_sdk_iot.types.create_stream_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_stream_request.CreateStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_stream_request.serialize_json(input_)
    ).encode()
...
def create_stream(
    ...
    aws_sdk_iot.types.create_stream_response.CreateStreamResponse, zapros.Response
]:
