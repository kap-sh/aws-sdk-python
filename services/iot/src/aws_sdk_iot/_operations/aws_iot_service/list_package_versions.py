...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_package_versions_response.ListPackageVersionsResponse = aws_sdk_iot.types.list_package_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_package_versions_request.ListPackageVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
