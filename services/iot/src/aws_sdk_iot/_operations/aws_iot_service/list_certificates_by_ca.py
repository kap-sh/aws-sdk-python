...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_certificates_by_ca_response.ListCertificatesByCAResponse = aws_sdk_iot.types.list_certificates_by_ca_response.deserialize_json(
