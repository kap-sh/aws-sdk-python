...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_package_response.GetPackageResponse = (
        aws_sdk_iot.types.get_package_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.get_package_request.GetPackageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_package(
    ...
    input_: aws_sdk_iot.types.get_package_request.GetPackageRequest,
) -> tuple[aws_sdk_iot.types.get_package_response.GetPackageResponse, zapros.Response]:
