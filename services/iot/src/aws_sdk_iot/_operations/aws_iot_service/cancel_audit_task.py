...
def handle_response(
    ...
    out: aws_sdk_iot.types.cancel_audit_task_response.CancelAuditTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.cancel_audit_task_request.CancelAuditTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
