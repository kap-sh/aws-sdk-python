...
def handle_response(
    ...
    out: aws_sdk_iot.types.clear_default_authorizer_response.ClearDefaultAuthorizerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.clear_default_authorizer_request.ClearDefaultAuthorizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
