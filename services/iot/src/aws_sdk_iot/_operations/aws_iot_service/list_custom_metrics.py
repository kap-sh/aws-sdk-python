...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_custom_metrics_response.ListCustomMetricsResponse = (
        aws_sdk_iot.types.list_custom_metrics_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_custom_metrics_request.ListCustomMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
