...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_role_alias_response.CreateRoleAliasResponse = (
        aws_sdk_iot.types.create_role_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_role_alias_request.CreateRoleAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_role_alias_request.serialize_json(input_)
    ).encode()
