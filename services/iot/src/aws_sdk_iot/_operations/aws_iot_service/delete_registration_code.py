...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_registration_code_response.DeleteRegistrationCodeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_registration_code_request.DeleteRegistrationCodeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
