"""Generated from Smithy shape ``com.amazonaws.iot#DeleteCertificateProvider``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_certificate_provider_response.DeleteCertificateProviderResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_certificate_provider_request.DeleteCertificateProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_certificate_provider(
