"""Generated from Smithy shape ``com.amazonaws.iot#DisableTopicRule``."""
...
def build_request(
    ...
    input: aws_sdk_iot.types.disable_topic_rule_request.DisableTopicRuleRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/rules/{ruleName}/disable"
...
async def async_disable_topic_rule(
