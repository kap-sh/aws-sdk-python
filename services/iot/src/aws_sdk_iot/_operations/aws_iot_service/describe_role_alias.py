...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_role_alias_response.DescribeRoleAliasResponse = (
        aws_sdk_iot.types.describe_role_alias_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_role_alias_request.DescribeRoleAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
