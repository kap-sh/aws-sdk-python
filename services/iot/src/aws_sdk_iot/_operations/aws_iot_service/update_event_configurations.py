"""Generated from Smithy shape ``com.amazonaws.iot#UpdateEventConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_event_configurations_response.UpdateEventConfigurationsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_event_configurations_request.UpdateEventConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_event_configurations_request.serialize_json(input_)
    ).encode()
...
async def async_update_event_configurations(
