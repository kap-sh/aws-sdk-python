...
def build_request(
    ...
    input: aws_sdk_iot.types.update_event_configurations_request.UpdateEventConfigurationsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_event_configurations_request.serialize_json(input)
    ).encode()
