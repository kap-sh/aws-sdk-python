...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_command_response.DeleteCommandResponse = {}  # type: ignore[typeddict-item]
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_command_request.DeleteCommandRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_command(
    ...
    aws_sdk_iot.types.delete_command_response.DeleteCommandResponse, zapros.Response
]:
