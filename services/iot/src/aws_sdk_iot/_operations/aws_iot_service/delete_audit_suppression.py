...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_audit_suppression_response.DeleteAuditSuppressionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_audit_suppression_request.DeleteAuditSuppressionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.delete_audit_suppression_request.serialize_json(input_)
    ).encode()
