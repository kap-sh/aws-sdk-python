...
def build_request(
    ...
    input: aws_sdk_iot.types.delete_audit_suppression_request.DeleteAuditSuppressionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.delete_audit_suppression_request.serialize_json(input)
    ).encode()
