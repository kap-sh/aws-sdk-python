...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_principal_policies_response.ListPrincipalPoliciesResponse = aws_sdk_iot.types.list_principal_policies_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.list_principal_policies_request.ListPrincipalPoliciesRequest,
) -> zapros.Request:
    ...
    if "principal" in input:
        headers["x-amzn-iot-principal"] = str(input["principal"])
    body: bytes | None = b""
