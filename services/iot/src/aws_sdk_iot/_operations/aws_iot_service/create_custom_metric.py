...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_custom_metric_response.CreateCustomMetricResponse = (
        aws_sdk_iot.types.create_custom_metric_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_custom_metric_request.CreateCustomMetricRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_custom_metric_request.serialize_json(input_)
    ).encode()
