...
def handle_response(
    ...
    out: aws_sdk_iot.types.search_index_response.SearchIndexResponse = (
        aws_sdk_iot.types.search_index_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.search_index_request.SearchIndexRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.search_index_request.serialize_json(input_)
    ).encode()
...
def search_index(
    ...
    aws_sdk_iot.types.search_index_response.SearchIndexResponse, zapros.Response
]:
