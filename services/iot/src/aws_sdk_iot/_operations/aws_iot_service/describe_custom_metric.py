...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_custom_metric_response.DescribeCustomMetricResponse = aws_sdk_iot.types.describe_custom_metric_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_custom_metric_request.DescribeCustomMetricRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
