...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_detect_mitigation_actions_tasks_response.ListDetectMitigationActionsTasksResponse = aws_sdk_iot.types.list_detect_mitigation_actions_tasks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_detect_mitigation_actions_tasks_request.ListDetectMitigationActionsTasksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
