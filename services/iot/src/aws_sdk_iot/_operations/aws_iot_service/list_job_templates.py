...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_job_templates_response.ListJobTemplatesResponse = (
        aws_sdk_iot.types.list_job_templates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_job_templates_request.ListJobTemplatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
