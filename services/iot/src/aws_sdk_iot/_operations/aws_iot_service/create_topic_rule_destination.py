...
def build_request(
    ...
    input: aws_sdk_iot.types.create_topic_rule_destination_request.CreateTopicRuleDestinationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_topic_rule_destination_request.serialize_json(input)
    ).encode()
