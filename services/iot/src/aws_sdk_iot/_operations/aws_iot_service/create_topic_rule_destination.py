...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_topic_rule_destination_response.CreateTopicRuleDestinationResponse = aws_sdk_iot.types.create_topic_rule_destination_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_topic_rule_destination_request.CreateTopicRuleDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_topic_rule_destination_request.serialize_json(input_)
    ).encode()
