"""Generated from Smithy shape ``com.amazonaws.iot#CreateKeysAndCertificate``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_keys_and_certificate_response.CreateKeysAndCertificateResponse = aws_sdk_iot.types.create_keys_and_certificate_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.create_keys_and_certificate_request.CreateKeysAndCertificateRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/keys-and-certificate"
    params: dict[str, str] = {}
...
async def async_create_keys_and_certificate(
