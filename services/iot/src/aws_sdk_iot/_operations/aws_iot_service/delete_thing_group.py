...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_thing_group_response.DeleteThingGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_thing_group_request.DeleteThingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
