"""Generated from Smithy shape ``com.amazonaws.iot#ListThingTypes``."""
...
import aws_sdk_iot.types.thing_type_list
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_thing_types_response.ListThingTypesResponse = (
        aws_sdk_iot.types.list_thing_types_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_thing_types_request.ListThingTypesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/thing-types"
    params: dict[str, str] = {}
    if "next_token" in input_:
        params["nextToken"] = str(input_["next_token"])
    if "max_results" in input_:
        params["maxResults"] = str(input_["max_results"])
    if "thing_type_name" in input_:
        params["thingTypeName"] = str(input_["thing_type_name"])
...
def list_thing_types(
    ...
    aws_sdk_iot.types.list_thing_types_response.ListThingTypesResponse, zapros.Response
]:
...
async def async_list_thing_types(
