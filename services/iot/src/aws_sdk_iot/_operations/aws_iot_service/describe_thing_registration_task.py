"""Generated from Smithy shape ``com.amazonaws.iot#DescribeThingRegistrationTask``."""
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_thing_registration_task_request.DescribeThingRegistrationTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/thing-registration-tasks/{taskId}"
...
async def async_describe_thing_registration_task(
