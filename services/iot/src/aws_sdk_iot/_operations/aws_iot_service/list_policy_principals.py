...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_policy_principals_response.ListPolicyPrincipalsResponse = aws_sdk_iot.types.list_policy_principals_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.list_policy_principals_request.ListPolicyPrincipalsRequest,
) -> zapros.Request:
    ...
    if "policy_name" in input:
        headers["x-amzn-iot-policy"] = str(input["policy_name"])
    body: bytes | None = b""
