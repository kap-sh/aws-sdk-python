...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_provisioning_claim_response.CreateProvisioningClaimResponse = aws_sdk_iot.types.create_provisioning_claim_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_provisioning_claim_request.CreateProvisioningClaimRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
