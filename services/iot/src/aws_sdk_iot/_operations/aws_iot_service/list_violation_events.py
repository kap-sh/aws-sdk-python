...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_violation_events_response.ListViolationEventsResponse = aws_sdk_iot.types.list_violation_events_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_violation_events_request.ListViolationEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
