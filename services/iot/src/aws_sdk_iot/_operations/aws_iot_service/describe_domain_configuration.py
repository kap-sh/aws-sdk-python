...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_domain_configuration_response.DescribeDomainConfigurationResponse = aws_sdk_iot.types.describe_domain_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_domain_configuration_request.DescribeDomainConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
