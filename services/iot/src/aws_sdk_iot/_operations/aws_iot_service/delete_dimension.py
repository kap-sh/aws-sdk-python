...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_dimension_response.DeleteDimensionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_dimension_request.DeleteDimensionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_dimension(
    ...
    aws_sdk_iot.types.delete_dimension_response.DeleteDimensionResponse, zapros.Response
]:
