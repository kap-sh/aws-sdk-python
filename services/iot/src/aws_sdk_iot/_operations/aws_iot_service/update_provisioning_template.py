"""Generated from Smithy shape ``com.amazonaws.iot#UpdateProvisioningTemplate``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_provisioning_template_response.UpdateProvisioningTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_provisioning_template_request.UpdateProvisioningTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_provisioning_template_request.serialize_json(input_)
    ).encode()
...
async def async_update_provisioning_template(
