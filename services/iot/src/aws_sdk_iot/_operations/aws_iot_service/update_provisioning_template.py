...
def build_request(
    ...
    input: aws_sdk_iot.types.update_provisioning_template_request.UpdateProvisioningTemplateRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_provisioning_template_request.serialize_json(input)
    ).encode()
