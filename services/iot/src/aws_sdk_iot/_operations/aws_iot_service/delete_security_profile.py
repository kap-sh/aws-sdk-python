"""Generated from Smithy shape ``com.amazonaws.iot#DeleteSecurityProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_security_profile_response.DeleteSecurityProfileResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_iot.types.delete_security_profile_request.DeleteSecurityProfileRequest,
) -> zapros.Request:
...
async def async_delete_security_profile(
