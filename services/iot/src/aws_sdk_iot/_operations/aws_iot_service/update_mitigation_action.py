...
def build_request(
    ...
    input: aws_sdk_iot.types.update_mitigation_action_request.UpdateMitigationActionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_mitigation_action_request.serialize_json(input)
    ).encode()
