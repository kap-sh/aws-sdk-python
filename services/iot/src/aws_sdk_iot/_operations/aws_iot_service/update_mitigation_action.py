...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_mitigation_action_response.UpdateMitigationActionResponse = aws_sdk_iot.types.update_mitigation_action_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_mitigation_action_request.UpdateMitigationActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_mitigation_action_request.serialize_json(input_)
    ).encode()
