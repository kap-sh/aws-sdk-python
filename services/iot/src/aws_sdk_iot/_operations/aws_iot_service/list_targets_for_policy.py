...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_targets_for_policy_response.ListTargetsForPolicyResponse = aws_sdk_iot.types.list_targets_for_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_targets_for_policy_request.ListTargetsForPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
