"""Generated from Smithy shape ``com.amazonaws.iot#DescribeEncryptionConfiguration``."""
...
import aws_sdk_iot.types.configuration_details
...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_encryption_configuration_response.DescribeEncryptionConfigurationResponse = aws_sdk_iot.types.describe_encryption_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_encryption_configuration_request.DescribeEncryptionConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/encryption-configuration"
    params: dict[str, str] = {}
...
async def async_describe_encryption_configuration(
