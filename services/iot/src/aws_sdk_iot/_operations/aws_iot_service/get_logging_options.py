...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_logging_options_response.GetLoggingOptionsResponse = (
        aws_sdk_iot.types.get_logging_options_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.get_logging_options_request.GetLoggingOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
