...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_role_alias_response.DeleteRoleAliasResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_role_alias_request.DeleteRoleAliasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
