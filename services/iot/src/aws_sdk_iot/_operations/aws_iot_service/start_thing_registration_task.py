...
def handle_response(
    ...
    out: aws_sdk_iot.types.start_thing_registration_task_response.StartThingRegistrationTaskResponse = aws_sdk_iot.types.start_thing_registration_task_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.start_thing_registration_task_request.StartThingRegistrationTaskRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.start_thing_registration_task_request.serialize_json(input)
    ).encode()
