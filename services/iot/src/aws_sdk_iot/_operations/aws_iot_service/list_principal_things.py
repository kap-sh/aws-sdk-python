"""Generated from Smithy shape ``com.amazonaws.iot#ListPrincipalThings``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_principal_things_response.ListPrincipalThingsResponse = aws_sdk_iot.types.list_principal_things_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_principal_things_request.ListPrincipalThingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/principals/things"
    params: dict[str, str] = {}
...
async def async_list_principal_things(
