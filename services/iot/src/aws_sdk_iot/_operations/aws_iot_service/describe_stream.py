...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_stream_response.DescribeStreamResponse = (
        aws_sdk_iot.types.describe_stream_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_stream_request.DescribeStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def describe_stream(
    ...
    aws_sdk_iot.types.describe_stream_response.DescribeStreamResponse, zapros.Response
]:
