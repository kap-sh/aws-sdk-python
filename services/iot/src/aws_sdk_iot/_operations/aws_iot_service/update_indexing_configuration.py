...
def build_request(
    ...
    input: aws_sdk_iot.types.update_indexing_configuration_request.UpdateIndexingConfigurationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_indexing_configuration_request.serialize_json(input)
    ).encode()
