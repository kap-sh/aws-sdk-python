"""Generated from Smithy shape ``com.amazonaws.iot#DescribeCertificateProvider``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_certificate_provider_response.DescribeCertificateProviderResponse = aws_sdk_iot.types.describe_certificate_provider_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_certificate_provider_request.DescribeCertificateProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_certificate_provider(
