...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_audit_task_response.DescribeAuditTaskResponse = (
        aws_sdk_iot.types.describe_audit_task_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_audit_task_request.DescribeAuditTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
