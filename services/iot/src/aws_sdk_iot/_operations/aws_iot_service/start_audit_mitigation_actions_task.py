"""Generated from Smithy shape ``com.amazonaws.iot#StartAuditMitigationActionsTask``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.start_audit_mitigation_actions_task_response.StartAuditMitigationActionsTaskResponse = aws_sdk_iot.types.start_audit_mitigation_actions_task_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.start_audit_mitigation_actions_task_request.StartAuditMitigationActionsTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/audit/mitigationactions/tasks/{taskId}"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.start_audit_mitigation_actions_task_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_audit_mitigation_actions_task(
