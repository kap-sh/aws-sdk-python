...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_thing_principals_response.ListThingPrincipalsResponse = aws_sdk_iot.types.list_thing_principals_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_thing_principals_request.ListThingPrincipalsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
