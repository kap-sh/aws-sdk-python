...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_security_profiles_response.ListSecurityProfilesResponse = aws_sdk_iot.types.list_security_profiles_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.list_security_profiles_request.ListSecurityProfilesRequest,
) -> zapros.Request:
    ...
    if "dimension_name" in input:
        params["dimensionName"] = str(input["dimension_name"])
