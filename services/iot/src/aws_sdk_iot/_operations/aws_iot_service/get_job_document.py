...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_job_document_response.GetJobDocumentResponse = (
        aws_sdk_iot.types.get_job_document_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.get_job_document_request.GetJobDocumentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_job_document(
    ...
    aws_sdk_iot.types.get_job_document_response.GetJobDocumentResponse, zapros.Response
]:
