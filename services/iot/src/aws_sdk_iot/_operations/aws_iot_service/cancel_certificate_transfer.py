"""Generated from Smithy shape ``com.amazonaws.iot#CancelCertificateTransfer``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TransferAlreadyCompletedException":
            import aws_sdk_iot.errors.transfer_already_completed_exception

            raise aws_sdk_iot.errors.transfer_already_completed_exception.TransferAlreadyCompletedException.from_json(
                data
            )
...
def build_request(
    ...
    input_: aws_sdk_iot.types.cancel_certificate_transfer_request.CancelCertificateTransferRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/cancel-certificate-transfer/{certificateId}"
...
async def async_cancel_certificate_transfer(
