...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_event_configurations_response.DescribeEventConfigurationsResponse = aws_sdk_iot.types.describe_event_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_event_configurations_request.DescribeEventConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
