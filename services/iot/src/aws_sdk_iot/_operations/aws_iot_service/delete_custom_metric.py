...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_custom_metric_response.DeleteCustomMetricResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_custom_metric_request.DeleteCustomMetricRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
