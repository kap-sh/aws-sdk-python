...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_principal_things_v2_response.ListPrincipalThingsV2Response = aws_sdk_iot.types.list_principal_things_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_principal_things_v2_request.ListPrincipalThingsV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
