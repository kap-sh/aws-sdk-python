...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_managed_job_template_response.DescribeManagedJobTemplateResponse = aws_sdk_iot.types.describe_managed_job_template_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.describe_managed_job_template_request.DescribeManagedJobTemplateRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "template_version" in input:
        params["templateVersion"] = str(input["template_version"])
