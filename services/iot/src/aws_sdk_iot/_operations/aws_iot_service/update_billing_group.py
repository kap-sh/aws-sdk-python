...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_billing_group_response.UpdateBillingGroupResponse = (
        aws_sdk_iot.types.update_billing_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_billing_group_request.UpdateBillingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_billing_group_request.serialize_json(input_)
    ).encode()
