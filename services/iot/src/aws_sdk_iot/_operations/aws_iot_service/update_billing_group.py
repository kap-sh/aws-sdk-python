...
def build_request(
    ...
    input: aws_sdk_iot.types.update_billing_group_request.UpdateBillingGroupRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{billingGroupName}", quote(str(input["billing_group_name"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_billing_group_request.serialize_json(input)
    ).encode()
