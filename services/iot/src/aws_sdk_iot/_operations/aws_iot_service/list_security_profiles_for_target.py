...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_security_profiles_for_target_response.ListSecurityProfilesForTargetResponse = aws_sdk_iot.types.list_security_profiles_for_target_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_security_profiles_for_target_request.ListSecurityProfilesForTargetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
