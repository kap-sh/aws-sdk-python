...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_topic_rule_destination_response.DeleteTopicRuleDestinationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_topic_rule_destination_request.DeleteTopicRuleDestinationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
