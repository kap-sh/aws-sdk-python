...
def handle_response(
    ...
    out: aws_sdk_iot.types.attach_thing_principal_response.AttachThingPrincipalResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.attach_thing_principal_request.AttachThingPrincipalRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
