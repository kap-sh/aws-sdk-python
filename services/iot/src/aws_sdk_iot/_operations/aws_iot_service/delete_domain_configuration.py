"""Generated from Smithy shape ``com.amazonaws.iot#DeleteDomainConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_domain_configuration_response.DeleteDomainConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_domain_configuration_request.DeleteDomainConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_domain_configuration(
