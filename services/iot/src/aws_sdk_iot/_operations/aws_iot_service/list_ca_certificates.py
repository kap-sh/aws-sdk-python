...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_ca_certificates_response.ListCACertificatesResponse = (
        aws_sdk_iot.types.list_ca_certificates_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_ca_certificates_request.ListCACertificatesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
