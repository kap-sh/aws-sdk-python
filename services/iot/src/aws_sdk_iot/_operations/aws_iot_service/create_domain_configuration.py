...
def build_request(
    ...
    input: aws_sdk_iot.types.create_domain_configuration_request.CreateDomainConfigurationRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["domain_configuration_name"]), safe=""),
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_domain_configuration_request.serialize_json(input)
    ).encode()
