...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_domain_configuration_response.CreateDomainConfigurationResponse = aws_sdk_iot.types.create_domain_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_domain_configuration_request.CreateDomainConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_domain_configuration_request.serialize_json(input_)
    ).encode()
