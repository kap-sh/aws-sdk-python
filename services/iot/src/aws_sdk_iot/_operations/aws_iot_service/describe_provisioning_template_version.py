"""Generated from Smithy shape ``com.amazonaws.iot#DescribeProvisioningTemplateVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_provisioning_template_version_response.DescribeProvisioningTemplateVersionResponse = aws_sdk_iot.types.describe_provisioning_template_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_provisioning_template_version_request.DescribeProvisioningTemplateVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_provisioning_template_version(
