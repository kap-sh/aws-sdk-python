"""Generated from Smithy shape ``com.amazonaws.iot#ListCommandExecutions``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_command_executions_response.ListCommandExecutionsResponse = aws_sdk_iot.types.list_command_executions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_command_executions_request.ListCommandExecutionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.list_command_executions_request.serialize_json(input_)
    ).encode()
...
async def async_list_command_executions(
