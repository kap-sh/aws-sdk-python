...
def build_request(
    ...
    input: aws_sdk_iot.types.list_command_executions_request.ListCommandExecutionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.list_command_executions_request.serialize_json(input)
    ).encode()
