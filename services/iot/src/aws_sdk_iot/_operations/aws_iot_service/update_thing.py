...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_thing_response.UpdateThingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_thing_request.UpdateThingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_thing_request.serialize_json(input_)
    ).encode()
...
def update_thing(
    ...
    aws_sdk_iot.types.update_thing_response.UpdateThingResponse, zapros.Response
]:
