"""Generated from Smithy shape ``com.amazonaws.iot#DisassociateSbomFromPackageVersion``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.disassociate_sbom_from_package_version_response.DisassociateSbomFromPackageVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_iot.types.disassociate_sbom_from_package_version_request.DisassociateSbomFromPackageVersionRequest,
) -> zapros.Request:
    ...
    url = (
        endpoint.url.rstrip("/") + "/packages/{packageName}/versions/{versionName}/sbom"
    )
...
async def async_disassociate_sbom_from_package_version(
