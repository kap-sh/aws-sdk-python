...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_billing_group_response.DeleteBillingGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_billing_group_request.DeleteBillingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
