...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_authorizer_response.UpdateAuthorizerResponse = (
        aws_sdk_iot.types.update_authorizer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_authorizer_request.UpdateAuthorizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_authorizer_request.serialize_json(input_)
    ).encode()
