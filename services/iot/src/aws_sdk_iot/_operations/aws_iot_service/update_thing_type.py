...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_thing_type_response.UpdateThingTypeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_thing_type_request.UpdateThingTypeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_thing_type_request.serialize_json(input_)
    ).encode()
