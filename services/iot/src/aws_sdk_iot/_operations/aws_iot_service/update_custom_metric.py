...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_custom_metric_response.UpdateCustomMetricResponse = (
        aws_sdk_iot.types.update_custom_metric_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_custom_metric_request.UpdateCustomMetricRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_custom_metric_request.serialize_json(input_)
    ).encode()
