...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_effective_policies_response.GetEffectivePoliciesResponse = aws_sdk_iot.types.get_effective_policies_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.get_effective_policies_request.GetEffectivePoliciesRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.get_effective_policies_request.serialize_json(input)
    ).encode()
