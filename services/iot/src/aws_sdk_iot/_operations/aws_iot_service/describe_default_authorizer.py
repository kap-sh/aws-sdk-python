...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_default_authorizer_response.DescribeDefaultAuthorizerResponse = aws_sdk_iot.types.describe_default_authorizer_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_default_authorizer_request.DescribeDefaultAuthorizerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
