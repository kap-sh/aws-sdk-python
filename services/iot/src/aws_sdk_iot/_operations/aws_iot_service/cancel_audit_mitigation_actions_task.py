"""Generated from Smithy shape ``com.amazonaws.iot#CancelAuditMitigationActionsTask``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.cancel_audit_mitigation_actions_task_response.CancelAuditMitigationActionsTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.cancel_audit_mitigation_actions_task_request.CancelAuditMitigationActionsTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/audit/mitigationactions/tasks/{taskId}/cancel"
...
async def async_cancel_audit_mitigation_actions_task(
