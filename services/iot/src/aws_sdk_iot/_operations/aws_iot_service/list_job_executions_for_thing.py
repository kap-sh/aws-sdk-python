...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_job_executions_for_thing_response.ListJobExecutionsForThingResponse = aws_sdk_iot.types.list_job_executions_for_thing_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_job_executions_for_thing_request.ListJobExecutionsForThingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
