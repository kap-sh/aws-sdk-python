...
def build_request(
    ...
    input: aws_sdk_iot.types.update_topic_rule_destination_request.UpdateTopicRuleDestinationRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_topic_rule_destination_request.serialize_json(input)
    ).encode()
