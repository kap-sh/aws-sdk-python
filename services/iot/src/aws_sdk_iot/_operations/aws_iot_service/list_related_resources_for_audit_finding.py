"""Generated from Smithy shape ``com.amazonaws.iot#ListRelatedResourcesForAuditFinding``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_related_resources_for_audit_finding_response.ListRelatedResourcesForAuditFindingResponse = aws_sdk_iot.types.list_related_resources_for_audit_finding_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_related_resources_for_audit_finding_request.ListRelatedResourcesForAuditFindingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/audit/relatedResources"
    params: dict[str, str] = {}
...
async def async_list_related_resources_for_audit_finding(
