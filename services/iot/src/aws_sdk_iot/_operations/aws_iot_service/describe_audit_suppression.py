...
def build_request(
    ...
    input: aws_sdk_iot.types.describe_audit_suppression_request.DescribeAuditSuppressionRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.describe_audit_suppression_request.serialize_json(input)
    ).encode()
