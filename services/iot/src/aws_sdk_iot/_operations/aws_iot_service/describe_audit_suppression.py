...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_audit_suppression_request.DescribeAuditSuppressionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.describe_audit_suppression_request.serialize_json(input_)
    ).encode()
