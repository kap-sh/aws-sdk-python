...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_provisioning_template_response.DeleteProvisioningTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_provisioning_template_request.DeleteProvisioningTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
