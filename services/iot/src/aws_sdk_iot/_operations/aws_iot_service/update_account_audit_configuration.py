"""Generated from Smithy shape ``com.amazonaws.iot#UpdateAccountAuditConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_account_audit_configuration_response.UpdateAccountAuditConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_account_audit_configuration_request.UpdateAccountAuditConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_account_audit_configuration_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_account_audit_configuration(
