...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_stream_response.DeleteStreamResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_stream_request.DeleteStreamRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_stream(
    ...
    aws_sdk_iot.types.delete_stream_response.DeleteStreamResponse, zapros.Response
]:
