"""Generated from Smithy shape ``com.amazonaws.iot#DeleteThingType``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_thing_type_response.DeleteThingTypeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_iot.types.delete_thing_type_request.DeleteThingTypeRequest,
) -> zapros.Request:
...
async def async_delete_thing_type(
