...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_jobs_request.ListJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "target_selection" in input_:
        params["targetSelection"] = str(input_["target_selection"])
    if "max_results" in input_:
        params["maxResults"] = str(input_["max_results"])
    if "next_token" in input_:
        params["nextToken"] = str(input_["next_token"])
    if "thing_group_name" in input_:
        params["thingGroupName"] = str(input_["thing_group_name"])
    if "thing_group_id" in input_:
        params["thingGroupId"] = str(input_["thing_group_id"])
