...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_ota_updates_response.ListOTAUpdatesResponse = (
        aws_sdk_iot.types.list_ota_updates_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.list_ota_updates_request.ListOTAUpdatesRequest,
) -> zapros.Request:
    ...
    if "ota_update_status" in input:
        params["otaUpdateStatus"] = str(input["ota_update_status"])
...
def list_ota_updates(
    ...
    aws_sdk_iot.types.list_ota_updates_response.ListOTAUpdatesResponse, zapros.Response
]:
