...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TaskAlreadyExistsException":
            import aws_sdk_iot.errors.task_already_exists_exception

            raise aws_sdk_iot.errors.task_already_exists_exception.TaskAlreadyExistsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_iot.types.start_detect_mitigation_actions_task_response.StartDetectMitigationActionsTaskResponse = aws_sdk_iot.types.start_detect_mitigation_actions_task_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.start_detect_mitigation_actions_task_request.StartDetectMitigationActionsTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.start_detect_mitigation_actions_task_request.serialize_json(
            input_
        )
    ).encode()
