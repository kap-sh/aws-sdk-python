...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_fleet_metric_response.DescribeFleetMetricResponse = aws_sdk_iot.types.describe_fleet_metric_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_fleet_metric_request.DescribeFleetMetricRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
