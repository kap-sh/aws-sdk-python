"""Generated from Smithy shape ``com.amazonaws.iot#ListV2LoggingLevels``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NotConfiguredException":
            import aws_sdk_iot.errors.not_configured_exception

            raise aws_sdk_iot.errors.not_configured_exception.NotConfiguredException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_v2_logging_levels_response.ListV2LoggingLevelsResponse = aws_sdk_iot.types.list_v2_logging_levels_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.list_v2_logging_levels_request.ListV2LoggingLevelsRequest,
) -> zapros.Request:
    ...
    params: dict[str, str] = {}
    if "target_type" in input:
        params["targetType"] = str(input["target_type"])
...
async def async_list_v2_logging_levels(
