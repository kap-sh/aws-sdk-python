...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_role_aliases_response.ListRoleAliasesResponse = (
        aws_sdk_iot.types.list_role_aliases_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_role_aliases_request.ListRoleAliasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
