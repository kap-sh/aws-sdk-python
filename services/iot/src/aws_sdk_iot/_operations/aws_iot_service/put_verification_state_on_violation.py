...
def handle_response(
    ...
    out: aws_sdk_iot.types.put_verification_state_on_violation_response.PutVerificationStateOnViolationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_iot.types.put_verification_state_on_violation_request.PutVerificationStateOnViolationRequest,
) -> zapros.Request:
    ...
    url = url.replace("{violationId}", quote(str(input["violation_id"]), safe=""))
    params: dict[str, str] = {}
