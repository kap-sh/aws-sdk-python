...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_audit_mitigation_actions_task_response.DescribeAuditMitigationActionsTaskResponse = aws_sdk_iot.types.describe_audit_mitigation_actions_task_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_audit_mitigation_actions_task_request.DescribeAuditMitigationActionsTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
