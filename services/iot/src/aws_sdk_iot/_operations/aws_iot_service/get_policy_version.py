...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_policy_version_response.GetPolicyVersionResponse = (
        aws_sdk_iot.types.get_policy_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.get_policy_version_request.GetPolicyVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
