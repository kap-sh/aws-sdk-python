...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_policy_version_response.CreatePolicyVersionResponse = aws_sdk_iot.types.create_policy_version_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_policy_version_request.CreatePolicyVersionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_policy_version_request.serialize_json(input_)
    ).encode()
