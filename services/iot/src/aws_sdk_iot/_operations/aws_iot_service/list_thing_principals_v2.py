...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_thing_principals_v2_response.ListThingPrincipalsV2Response = aws_sdk_iot.types.list_thing_principals_v2_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_thing_principals_v2_request.ListThingPrincipalsV2Request,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
