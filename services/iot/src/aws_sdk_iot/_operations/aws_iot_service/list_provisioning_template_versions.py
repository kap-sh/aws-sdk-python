...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_provisioning_template_versions_response.ListProvisioningTemplateVersionsResponse = aws_sdk_iot.types.list_provisioning_template_versions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_provisioning_template_versions_request.ListProvisioningTemplateVersionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
