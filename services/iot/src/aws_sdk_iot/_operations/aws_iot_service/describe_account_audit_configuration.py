...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_account_audit_configuration_response.DescribeAccountAuditConfigurationResponse = aws_sdk_iot.types.describe_account_audit_configuration_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_account_audit_configuration_request.DescribeAccountAuditConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
