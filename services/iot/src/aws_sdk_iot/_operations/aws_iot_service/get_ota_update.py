"""Generated from Smithy shape ``com.amazonaws.iot#GetOTAUpdate``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_ota_update_response.GetOTAUpdateResponse = (
        aws_sdk_iot.types.get_ota_update_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.get_ota_update_request.GetOTAUpdateRequest,
) -> zapros.Request:
...
def get_ota_update(
    ...
    aws_sdk_iot.types.get_ota_update_response.GetOTAUpdateResponse, zapros.Response
]:
...
async def async_get_ota_update(
