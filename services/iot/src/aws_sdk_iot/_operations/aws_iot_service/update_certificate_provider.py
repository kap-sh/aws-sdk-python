...
def build_request(
    ...
    input: aws_sdk_iot.types.update_certificate_provider_request.UpdateCertificateProviderRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_certificate_provider_request.serialize_json(input)
    ).encode()
