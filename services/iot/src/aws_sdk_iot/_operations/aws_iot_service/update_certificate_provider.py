...
def handle_response(
    ...
    out: aws_sdk_iot.types.update_certificate_provider_response.UpdateCertificateProviderResponse = aws_sdk_iot.types.update_certificate_provider_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.update_certificate_provider_request.UpdateCertificateProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.update_certificate_provider_request.serialize_json(input_)
    ).encode()
