"""Generated from Smithy shape ``com.amazonaws.iot#DeprecateThingType``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.deprecate_thing_type_response.DeprecateThingTypeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_iot.types.deprecate_thing_type_request.DeprecateThingTypeRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/thing-types/{thingTypeName}/deprecate"
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.deprecate_thing_type_request.serialize_json(input)
    ).encode()
...
async def async_deprecate_thing_type(
