...
def handle_response(
    ...
    out: aws_sdk_iot.types.cancel_job_response.CancelJobResponse = (
        aws_sdk_iot.types.cancel_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.cancel_job_request.CancelJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.cancel_job_request.serialize_json(input_)
    ).encode()
...
def cancel_job(
    ...
    input_: aws_sdk_iot.types.cancel_job_request.CancelJobRequest,
) -> tuple[aws_sdk_iot.types.cancel_job_response.CancelJobResponse, zapros.Response]:
