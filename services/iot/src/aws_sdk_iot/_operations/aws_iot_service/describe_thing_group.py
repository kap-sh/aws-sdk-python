...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_thing_group_response.DescribeThingGroupResponse = (
        aws_sdk_iot.types.describe_thing_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_thing_group_request.DescribeThingGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
