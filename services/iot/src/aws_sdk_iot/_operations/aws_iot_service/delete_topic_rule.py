"""Generated from Smithy shape ``com.amazonaws.iot#DeleteTopicRule``."""
...
def build_request(
    ...
    input: aws_sdk_iot.types.delete_topic_rule_request.DeleteTopicRuleRequest,
) -> zapros.Request:
...
async def async_delete_topic_rule(
