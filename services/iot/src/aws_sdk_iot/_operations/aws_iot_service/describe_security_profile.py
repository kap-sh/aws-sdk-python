...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_security_profile_response.DescribeSecurityProfileResponse = aws_sdk_iot.types.describe_security_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_security_profile_request.DescribeSecurityProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
