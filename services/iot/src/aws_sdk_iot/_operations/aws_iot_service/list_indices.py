...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_indices_response.ListIndicesResponse = (
        aws_sdk_iot.types.list_indices_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_indices_request.ListIndicesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_indices(
    ...
    aws_sdk_iot.types.list_indices_response.ListIndicesResponse, zapros.Response
]:
