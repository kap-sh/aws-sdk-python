...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_job_template_response.CreateJobTemplateResponse = (
        aws_sdk_iot.types.create_job_template_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.create_job_template_request.CreateJobTemplateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_job_template_request.serialize_json(input_)
    ).encode()
