"""Generated from Smithy shape ``com.amazonaws.iot#ListDomainConfigurations``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_domain_configurations_response.ListDomainConfigurationsResponse = aws_sdk_iot.types.list_domain_configurations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_domain_configurations_request.ListDomainConfigurationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/domainConfigurations"
    params: dict[str, str] = {}
    if "marker" in input_:
        params["marker"] = str(input_["marker"])
    if "page_size" in input_:
        params["pageSize"] = str(input_["page_size"])
    if "service_type" in input_:
        params["serviceType"] = str(input_["service_type"])
...
async def async_list_domain_configurations(
