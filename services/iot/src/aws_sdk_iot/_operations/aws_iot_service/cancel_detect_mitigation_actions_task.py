...
def handle_response(
    ...
    out: aws_sdk_iot.types.cancel_detect_mitigation_actions_task_response.CancelDetectMitigationActionsTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.cancel_detect_mitigation_actions_task_request.CancelDetectMitigationActionsTaskRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
