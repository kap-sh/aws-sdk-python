"""Generated from Smithy shape ``com.amazonaws.iot#DeleteMitigationAction``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.delete_mitigation_action_response.DeleteMitigationActionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_iot.types.delete_mitigation_action_request.DeleteMitigationActionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_mitigation_action(
