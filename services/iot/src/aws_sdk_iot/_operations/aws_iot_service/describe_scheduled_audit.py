...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_scheduled_audit_response.DescribeScheduledAuditResponse = aws_sdk_iot.types.describe_scheduled_audit_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_scheduled_audit_request.DescribeScheduledAuditRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
