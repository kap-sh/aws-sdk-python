...
def handle_response(
    ...
    out: aws_sdk_iot.types.describe_ca_certificate_response.DescribeCACertificateResponse = aws_sdk_iot.types.describe_ca_certificate_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.describe_ca_certificate_request.DescribeCACertificateRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
