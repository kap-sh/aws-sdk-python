...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_dimensions_response.ListDimensionsResponse = (
        aws_sdk_iot.types.list_dimensions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_dimensions_request.ListDimensionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_dimensions(
    ...
    aws_sdk_iot.types.list_dimensions_response.ListDimensionsResponse, zapros.Response
]:
