...
def handle_response(
    ...
    out: aws_sdk_iot.types.get_v2_logging_options_response.GetV2LoggingOptionsResponse = aws_sdk_iot.types.get_v2_logging_options_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.get_v2_logging_options_request.GetV2LoggingOptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    params: dict[str, str] = {}
    params["verbose"] = str(input_.get("verbose", False))
