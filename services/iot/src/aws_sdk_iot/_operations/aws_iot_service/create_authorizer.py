...
def handle_response(
    ...
    out: aws_sdk_iot.types.create_authorizer_response.CreateAuthorizerResponse = (
        aws_sdk_iot.types.create_authorizer_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_iot.types.create_authorizer_request.CreateAuthorizerRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.create_authorizer_request.serialize_json(input)
    ).encode()
