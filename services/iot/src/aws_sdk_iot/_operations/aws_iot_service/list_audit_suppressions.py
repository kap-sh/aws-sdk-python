...
def build_request(
    ...
    input: aws_sdk_iot.types.list_audit_suppressions_request.ListAuditSuppressionsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.list_audit_suppressions_request.serialize_json(input)
    ).encode()
