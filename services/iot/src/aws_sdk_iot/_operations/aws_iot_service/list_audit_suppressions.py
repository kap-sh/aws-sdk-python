"""Generated from Smithy shape ``com.amazonaws.iot#ListAuditSuppressions``."""
...
def handle_response(
    ...
    out: aws_sdk_iot.types.list_audit_suppressions_response.ListAuditSuppressionsResponse = aws_sdk_iot.types.list_audit_suppressions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_iot.types.list_audit_suppressions_request.ListAuditSuppressionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/audit/suppressions/list"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        aws_sdk_iot.types.list_audit_suppressions_request.serialize_json(input_)
    ).encode()
...
async def async_list_audit_suppressions(
