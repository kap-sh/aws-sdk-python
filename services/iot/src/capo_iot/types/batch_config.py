...
if TYPE_CHECKING:
    import capo_iot.types.batch_across_topics
    import capo_iot.types.max_batch_open_ms
    import capo_iot.types.max_batch_size
    import capo_iot.types.max_batch_size_bytes


class BatchConfig(TypedDict, closed=True):
    max_batch_open_ms: NotRequired["capo_iot.types.max_batch_open_ms.MaxBatchOpenMs"]
    ...
    max_batch_size: NotRequired["capo_iot.types.max_batch_size.MaxBatchSize"]
    ...
    max_batch_size_bytes: NotRequired[
        "capo_iot.types.max_batch_size_bytes.MaxBatchSizeBytes"
    ]
    """<p>Maximum size of a message batch, in bytes.</p>"""
    batch_across_topics: "capo_iot.types.batch_across_topics.BatchAcrossTopics"
