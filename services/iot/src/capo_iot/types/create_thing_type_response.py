...
if TYPE_CHECKING:
    import capo_iot.types.thing_type_arn
    import capo_iot.types.thing_type_id
...
class CreateThingTypeResponse(TypedDict, closed=True):
    ...
    thing_type_arn: NotRequired["capo_iot.types.thing_type_arn.ThingTypeArn"]
    """<p>The Amazon Resource Name (ARN) of the thing type.</p>"""
    thing_type_id: NotRequired["capo_iot.types.thing_type_id.ThingTypeId"]
