...
if TYPE_CHECKING:
    import capo_iot.types.job_execution_summary_for_job_list
    import capo_iot.types.next_token


class ListJobExecutionsForJobResponse(TypedDict, closed=True):
    execution_summaries: NotRequired[
        "capo_iot.types.job_execution_summary_for_job_list.JobExecutionSummaryForJobList"
    ]
...
def serialize_json(value: ListJobExecutionsForJobResponse) -> dict:
    ...
    if "execution_summaries" in value:
        ...
        out["executionSummaries"] = (
            capo_iot.types.job_execution_summary_for_job_list.serialize_json(
...
def deserialize_json(data: dict) -> ListJobExecutionsForJobResponse:
    ...
    if "executionSummaries" in data:
        ...
        out["execution_summaries"] = (
            capo_iot.types.job_execution_summary_for_job_list.deserialize_json(
