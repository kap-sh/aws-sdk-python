...
class AuditMitigationActionsTaskTarget(TypedDict, closed=True):
    ...
    finding_ids: NotRequired["capo_iot.types.finding_ids.FindingIds"]
    ...
    audit_check_to_reason_code_filter: NotRequired[
        "capo_iot.types.audit_check_to_reason_code_filter.AuditCheckToReasonCodeFilter"
    ]
...
def serialize_json(value: AuditMitigationActionsTaskTarget) -> dict:
    ...
    if "finding_ids" in value:
        ...
        out["findingIds"] = capo_iot.types.finding_ids.serialize_json(
            value["finding_ids"]
        )
    if "audit_check_to_reason_code_filter" in value:
        ...
        out["auditCheckToReasonCodeFilter"] = (
            capo_iot.types.audit_check_to_reason_code_filter.serialize_json(
...
def deserialize_json(data: dict) -> AuditMitigationActionsTaskTarget:
    ...
    if "auditCheckToReasonCodeFilter" in data:
        ...
        out["audit_check_to_reason_code_filter"] = (
            capo_iot.types.audit_check_to_reason_code_filter.deserialize_json(
