"""Generated from Smithy shape ``com.amazonaws.iot#CreateCertificateProviderResponse``."""
...
class CreateCertificateProviderResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateCertificateProviderResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateCertificateProviderResponse:
    out: CreateCertificateProviderResponse = {}  # type: ignore[typeddict-item]
