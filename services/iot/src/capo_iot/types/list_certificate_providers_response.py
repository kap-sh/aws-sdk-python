...
if TYPE_CHECKING:
    import capo_iot.types.certificate_providers
    import capo_iot.types.marker


class ListCertificateProvidersResponse(TypedDict, closed=True):
    certificate_providers: NotRequired[
        "capo_iot.types.certificate_providers.CertificateProviders"
    ]
    """<p>The list of certificate providers in your Amazon Web Services account.</p>"""
    next_token: NotRequired["capo_iot.types.marker.Marker"]
...
def serialize_json(value: ListCertificateProvidersResponse) -> dict:
    ...
    if "certificate_providers" in value:
        ...
        out["certificateProviders"] = (
            capo_iot.types.certificate_providers.serialize_json(
...
def deserialize_json(data: dict) -> ListCertificateProvidersResponse:
    ...
    if "certificateProviders" in data:
        ...
        out["certificate_providers"] = (
            capo_iot.types.certificate_providers.deserialize_json(
