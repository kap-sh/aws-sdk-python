...
if TYPE_CHECKING:
    import capo_iot.types.aws_job_timeout_in_progress_timeout_in_minutes


class AwsJobTimeoutConfig(TypedDict, closed=True):
    in_progress_timeout_in_minutes: NotRequired[
        "capo_iot.types.aws_job_timeout_in_progress_timeout_in_minutes.AwsJobTimeoutInProgressTimeoutInMinutes"
    ]
