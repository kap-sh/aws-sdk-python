...
if TYPE_CHECKING:
    import capo_iot.types.field_name
    import capo_iot.types.field_type


class Field(TypedDict, closed=True):
    name: NotRequired["capo_iot.types.field_name.FieldName"]
    """<p>The name of the field.</p>"""
    type: NotRequired["capo_iot.types.field_type.FieldType"]
...
def serialize_json(value: Field) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = capo_iot.types.field_type.serialize_json(value["type"])
    return out
