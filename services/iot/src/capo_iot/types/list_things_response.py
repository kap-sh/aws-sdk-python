...
if TYPE_CHECKING:
    ...
    import capo_iot.types.thing_attribute_list


class ListThingsResponse(TypedDict, closed=True):
    things: NotRequired["capo_iot.types.thing_attribute_list.ThingAttributeList"]
    """<p>The things.</p>"""
...
def serialize_json(value: ListThingsResponse) -> dict:
    ...
    if "things" in value:
        ...
        out["things"] = capo_iot.types.thing_attribute_list.serialize_json(
            value["things"]
        )
...
def deserialize_json(data: dict) -> ListThingsResponse:
    ...
    if "things" in data:
        ...
        out["things"] = capo_iot.types.thing_attribute_list.deserialize_json(
            data["things"]
        )
