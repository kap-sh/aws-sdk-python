...
if TYPE_CHECKING:
    ...
    import capo_iot.types.certificate_path_on_device
    import capo_iot.types.platform
...
class SigningProfileParameter(TypedDict, closed=True):
    ...
    """<p>Certificate ARN.</p>"""
    platform: NotRequired["capo_iot.types.platform.Platform"]
    """<p>The hardware platform of your device.</p>"""
    certificate_path_on_device: NotRequired[
        "capo_iot.types.certificate_path_on_device.CertificatePathOnDevice"
    ]
