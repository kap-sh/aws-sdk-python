...
class ListJobExecutionsForThingResponse(TypedDict, closed=True):
    execution_summaries: NotRequired[
        "capo_iot.types.job_execution_summary_for_thing_list.JobExecutionSummaryForThingList"
    ]
...
def serialize_json(value: ListJobExecutionsForThingResponse) -> dict:
    ...
    if "execution_summaries" in value:
        ...
        out["executionSummaries"] = (
            capo_iot.types.job_execution_summary_for_thing_list.serialize_json(
...
def deserialize_json(data: dict) -> ListJobExecutionsForThingResponse:
    ...
    if "executionSummaries" in data:
        ...
        out["execution_summaries"] = (
            capo_iot.types.job_execution_summary_for_thing_list.deserialize_json(
