...
class GetBehaviorModelTrainingSummariesResponse(TypedDict, closed=True):
    summaries: NotRequired[
        "capo_iot.types.behavior_model_training_summaries.BehaviorModelTrainingSummaries"
    ]
...
def serialize_json(value: GetBehaviorModelTrainingSummariesResponse) -> dict:
    ...
    if "summaries" in value:
        ...
        out["summaries"] = (
            capo_iot.types.behavior_model_training_summaries.serialize_json(
                value["summaries"]
            )
        )
...
def deserialize_json(data: dict) -> GetBehaviorModelTrainingSummariesResponse:
    ...
    if "summaries" in data:
        ...
        out["summaries"] = (
            capo_iot.types.behavior_model_training_summaries.deserialize_json(
                data["summaries"]
            )
        )
