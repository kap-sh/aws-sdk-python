...
def serialize_json(value: VpcDestinationConfiguration) -> dict:
    ...
    out["subnetIds"] = capo_iot.types.subnet_id_list.serialize_json(value["subnet_ids"])
