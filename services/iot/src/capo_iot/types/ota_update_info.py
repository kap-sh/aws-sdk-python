...
if TYPE_CHECKING:
    ...
    import capo_iot.types.error_info
...
class OTAUpdateInfo(TypedDict, closed=True):
    ...
    targets: NotRequired["capo_iot.types.targets.Targets"]
    ...
    ota_update_files: NotRequired["capo_iot.types.ota_update_files.OTAUpdateFiles"]
    ...
    error_info: NotRequired["capo_iot.types.error_info.ErrorInfo"]
...
def serialize_json(value: OTAUpdateInfo) -> dict:
    ...
    if "ota_update_files" in value:
        ...
        out["otaUpdateFiles"] = capo_iot.types.ota_update_files.serialize_json(
    ...
    if "error_info" in value:
        ...
        out["errorInfo"] = capo_iot.types.error_info.serialize_json(value["error_info"])
...
def deserialize_json(data: dict) -> OTAUpdateInfo:
    ...
    if "otaUpdateFiles" in data:
        ...
        out["ota_update_files"] = capo_iot.types.ota_update_files.deserialize_json(
            data["otaUpdateFiles"]
        )
    ...
    if "errorInfo" in data:
        ...
        out["error_info"] = capo_iot.types.error_info.deserialize_json(
            data["errorInfo"]
        )
