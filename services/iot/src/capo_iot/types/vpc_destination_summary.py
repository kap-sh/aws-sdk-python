...
# --- restJson1 ser/de ---
def serialize_json(value: VpcDestinationSummary) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> VpcDestinationSummary:
    out: VpcDestinationSummary = {}  # type: ignore[typeddict-item]
