...
if TYPE_CHECKING:
    ...
    import capo_iot.types.consecutive_datapoints_to_alarm
    import capo_iot.types.consecutive_datapoints_to_clear
    import capo_iot.types.duration_seconds
...
class BehaviorCriteria(TypedDict, closed=True):
    comparison_operator: NotRequired[
        "capo_iot.types.comparison_operator.ComparisonOperator"
    ]
    ...
    duration_seconds: NotRequired["capo_iot.types.duration_seconds.DurationSeconds"]
    ...
    consecutive_datapoints_to_alarm: NotRequired[
        "capo_iot.types.consecutive_datapoints_to_alarm.ConsecutiveDatapointsToAlarm"
    ]
    ...
    consecutive_datapoints_to_clear: NotRequired[
        "capo_iot.types.consecutive_datapoints_to_clear.ConsecutiveDatapointsToClear"
    ]
    ...
    statistical_threshold: NotRequired[
        "capo_iot.types.statistical_threshold.StatisticalThreshold"
    ]
    ...
    ml_detection_config: NotRequired[
        "capo_iot.types.machine_learning_detection_config.MachineLearningDetectionConfig"
    ]
...
def serialize_json(value: BehaviorCriteria) -> dict:
    ...
    if "comparison_operator" in value:
        ...
        out["comparisonOperator"] = capo_iot.types.comparison_operator.serialize_json(
    ...
    if "statistical_threshold" in value:
        ...
        out["statisticalThreshold"] = (
            capo_iot.types.statistical_threshold.serialize_json(
    ...
    if "ml_detection_config" in value:
        ...
        out["mlDetectionConfig"] = (
            capo_iot.types.machine_learning_detection_config.serialize_json(
...
def deserialize_json(data: dict) -> BehaviorCriteria:
    ...
    if "comparisonOperator" in data:
        ...
        out["comparison_operator"] = (
            capo_iot.types.comparison_operator.deserialize_json(
    ...
    if "statisticalThreshold" in data:
        ...
        out["statistical_threshold"] = (
            capo_iot.types.statistical_threshold.deserialize_json(
    ...
    if "mlDetectionConfig" in data:
        ...
        out["ml_detection_config"] = (
            capo_iot.types.machine_learning_detection_config.deserialize_json(
