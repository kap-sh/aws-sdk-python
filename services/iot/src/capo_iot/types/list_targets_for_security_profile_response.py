...
if TYPE_CHECKING:
    ...
    import capo_iot.types.security_profile_targets


class ListTargetsForSecurityProfileResponse(TypedDict, closed=True):
    security_profile_targets: NotRequired[
        "capo_iot.types.security_profile_targets.SecurityProfileTargets"
    ]
...
def serialize_json(value: ListTargetsForSecurityProfileResponse) -> dict:
    ...
    if "security_profile_targets" in value:
        ...
        out["securityProfileTargets"] = (
            capo_iot.types.security_profile_targets.serialize_json(
...
def deserialize_json(data: dict) -> ListTargetsForSecurityProfileResponse:
    ...
    if "securityProfileTargets" in data:
        ...
        out["security_profile_targets"] = (
            capo_iot.types.security_profile_targets.deserialize_json(
