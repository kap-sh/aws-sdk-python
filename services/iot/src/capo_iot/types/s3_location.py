...
if TYPE_CHECKING:
    ...
    import capo_iot.types.s3_key
    import capo_iot.types.s3_version


class S3Location(TypedDict, closed=True):
    bucket: NotRequired["capo_iot.types.s3_bucket.S3Bucket"]
    """<p>The S3 bucket.</p>"""
    key: NotRequired["capo_iot.types.s3_key.S3Key"]
    """<p>The S3 key.</p>"""
    version: NotRequired["capo_iot.types.s3_version.S3Version"]
