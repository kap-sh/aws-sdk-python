"""Generated from Smithy shape ``com.amazonaws.iot#ListCustomMetrics``."""
...
import capo_iot.types.list_custom_metrics_request
import capo_iot.types.list_custom_metrics_response
...
def handle_response(
    ...
    out: capo_iot.types.list_custom_metrics_response.ListCustomMetricsResponse = (
        capo_iot.types.list_custom_metrics_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/custom-metrics"
    params: dict[str, str] = {}
...
async def async_list_custom_metrics(
