"""Generated from Smithy shape ``com.amazonaws.iot#CancelDetectMitigationActionsTask``."""
...
import capo_iot.types.cancel_detect_mitigation_actions_task_request
import capo_iot.types.cancel_detect_mitigation_actions_task_response
...
def handle_response(
    ...
    out: capo_iot.types.cancel_detect_mitigation_actions_task_response.CancelDetectMitigationActionsTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/detect/mitigationactions/tasks/{taskId}/cancel"
...
async def async_cancel_detect_mitigation_actions_task(
