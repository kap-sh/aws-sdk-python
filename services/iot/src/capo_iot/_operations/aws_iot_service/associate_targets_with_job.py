...
import capo_iot.types.associate_targets_with_job_request
import capo_iot.types.associate_targets_with_job_response
...
def handle_response(
    ...
    out: capo_iot.types.associate_targets_with_job_response.AssociateTargetsWithJobResponse = capo_iot.types.associate_targets_with_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.associate_targets_with_job_request.serialize_json(input_)
    ).encode()
