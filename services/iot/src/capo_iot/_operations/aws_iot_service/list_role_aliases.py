"""Generated from Smithy shape ``com.amazonaws.iot#ListRoleAliases``."""
...
import capo_iot.types.list_role_aliases_request
import capo_iot.types.list_role_aliases_response
...
def handle_response(
    ...
    out: capo_iot.types.list_role_aliases_response.ListRoleAliasesResponse = (
        capo_iot.types.list_role_aliases_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/role-aliases"
    params: dict[str, str] = {}
...
def list_role_aliases(
    ...
    capo_iot.types.list_role_aliases_response.ListRoleAliasesResponse, zapros.Response
]:
...
async def async_list_role_aliases(
