...
import capo_iot.types.get_topic_rule_request
import capo_iot.types.get_topic_rule_response
...
def handle_response(
    ...
    out: capo_iot.types.get_topic_rule_response.GetTopicRuleResponse = (
        capo_iot.types.get_topic_rule_response.deserialize_json(
...
def get_topic_rule(
    ...
    capo_iot.types.get_topic_rule_response.GetTopicRuleResponse, zapros.Response
]:
