"""Generated from Smithy shape ``com.amazonaws.iot#GetRegistrationCode``."""
...
import capo_iot.types.get_registration_code_request
import capo_iot.types.get_registration_code_response
...
def handle_response(
    ...
    out: capo_iot.types.get_registration_code_response.GetRegistrationCodeResponse = (
        capo_iot.types.get_registration_code_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/registrationcode"
    params: dict[str, str] = {}
...
async def async_get_registration_code(
