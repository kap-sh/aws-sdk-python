"""Generated from Smithy shape ``com.amazonaws.iot#AcceptCertificateTransfer``."""
...
import capo_iot.types.accept_certificate_transfer_request
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/accept-certificate-transfer/{certificateId}"
...
async def async_accept_certificate_transfer(
