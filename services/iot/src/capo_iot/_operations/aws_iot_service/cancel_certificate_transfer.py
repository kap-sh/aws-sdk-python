...
import capo_iot.errors.transfer_already_completed_exception
import capo_iot.errors.unauthorized_exception
import capo_iot.types.cancel_certificate_transfer_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TransferAlreadyCompletedException":
            raise capo_iot.errors.transfer_already_completed_exception.TransferAlreadyCompletedException.from_json(
                data
            )
