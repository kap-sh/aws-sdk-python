"""Generated from Smithy shape ``com.amazonaws.iot#GetPackageConfiguration``."""
...
import capo_iot.types.get_package_configuration_request
import capo_iot.types.get_package_configuration_response
...
def handle_response(
    ...
    out: capo_iot.types.get_package_configuration_response.GetPackageConfigurationResponse = capo_iot.types.get_package_configuration_response.deserialize_json(
...
async def async_get_package_configuration(
