"""Generated from Smithy shape ``com.amazonaws.iot#CreateAuthorizer``."""
...
import capo_iot.types.create_authorizer_request
import capo_iot.types.create_authorizer_response
...
def handle_response(
    ...
    out: capo_iot.types.create_authorizer_response.CreateAuthorizerResponse = (
        capo_iot.types.create_authorizer_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_authorizer_request.serialize_json(input_)
    ).encode()
...
def create_authorizer(
    ...
    capo_iot.types.create_authorizer_response.CreateAuthorizerResponse, zapros.Response
]:
