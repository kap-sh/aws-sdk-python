"""Generated from Smithy shape ``com.amazonaws.iot#DeleteRegistrationCode``."""
...
import capo_iot.types.delete_registration_code_request
import capo_iot.types.delete_registration_code_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_registration_code_response.DeleteRegistrationCodeResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_registration_code(
