"""Generated from Smithy shape ``com.amazonaws.iot#ListMitigationActions``."""
...
import capo_iot.types.list_mitigation_actions_request
import capo_iot.types.list_mitigation_actions_response
...
def handle_response(
    ...
    out: capo_iot.types.list_mitigation_actions_response.ListMitigationActionsResponse = capo_iot.types.list_mitigation_actions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/mitigationactions/actions"
    params: dict[str, str] = {}
...
async def async_list_mitigation_actions(
