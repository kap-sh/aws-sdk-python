"""Generated from Smithy shape ``com.amazonaws.iot#ListProvisioningTemplates``."""
...
import capo_iot.types.list_provisioning_templates_request
import capo_iot.types.list_provisioning_templates_response
...
def handle_response(
    ...
    out: capo_iot.types.list_provisioning_templates_response.ListProvisioningTemplatesResponse = capo_iot.types.list_provisioning_templates_response.deserialize_json(
...
async def async_list_provisioning_templates(
