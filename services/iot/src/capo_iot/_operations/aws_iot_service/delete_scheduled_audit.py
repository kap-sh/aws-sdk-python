"""Generated from Smithy shape ``com.amazonaws.iot#DeleteScheduledAudit``."""
...
import capo_iot.types.delete_scheduled_audit_request
import capo_iot.types.delete_scheduled_audit_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_scheduled_audit_response.DeleteScheduledAuditResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_scheduled_audit(
