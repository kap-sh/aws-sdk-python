"""Generated from Smithy shape ``com.amazonaws.iot#ListSecurityProfilesForTarget``."""
...
import capo_iot.types.list_security_profiles_for_target_request
import capo_iot.types.list_security_profiles_for_target_response
...
def handle_response(
    ...
    out: capo_iot.types.list_security_profiles_for_target_response.ListSecurityProfilesForTargetResponse = capo_iot.types.list_security_profiles_for_target_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/security-profiles-for-target"
    params: dict[str, str] = {}
...
async def async_list_security_profiles_for_target(
