"""Generated from Smithy shape ``com.amazonaws.iot#DeleteCommandExecution``."""
...
import capo_iot.types.delete_command_execution_request
import capo_iot.types.delete_command_execution_response
...
) -> capo_iot.types.delete_command_execution_response.DeleteCommandExecutionResponse:
    out: capo_iot.types.delete_command_execution_response.DeleteCommandExecutionResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_command_execution(
