"""Generated from Smithy shape ``com.amazonaws.iot#SetLoggingOptions``."""
...
def build_request(
    ...
    if "logging_options_payload" in input_:
        body: bytes | None = json.dumps(
            capo_iot.types.logging_options_payload.serialize_json(
                input_["logging_options_payload"]
            )
        ).encode()
...
async def async_set_logging_options(
