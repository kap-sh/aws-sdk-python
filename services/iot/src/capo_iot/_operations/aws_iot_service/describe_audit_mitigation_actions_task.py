"""Generated from Smithy shape ``com.amazonaws.iot#DescribeAuditMitigationActionsTask``."""
...
import capo_iot.types.describe_audit_mitigation_actions_task_request
import capo_iot.types.describe_audit_mitigation_actions_task_response
...
) -> capo_iot.types.describe_audit_mitigation_actions_task_response.DescribeAuditMitigationActionsTaskResponse:
    out: capo_iot.types.describe_audit_mitigation_actions_task_response.DescribeAuditMitigationActionsTaskResponse = capo_iot.types.describe_audit_mitigation_actions_task_response.deserialize_json(
...
async def async_describe_audit_mitigation_actions_task(
