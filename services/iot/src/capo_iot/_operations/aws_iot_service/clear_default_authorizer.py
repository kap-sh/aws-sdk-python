"""Generated from Smithy shape ``com.amazonaws.iot#ClearDefaultAuthorizer``."""
...
import capo_iot.types.clear_default_authorizer_request
import capo_iot.types.clear_default_authorizer_response
...
def handle_response(
    ...
    out: capo_iot.types.clear_default_authorizer_response.ClearDefaultAuthorizerResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_clear_default_authorizer(
