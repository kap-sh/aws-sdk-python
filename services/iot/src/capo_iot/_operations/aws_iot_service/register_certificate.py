...
import capo_iot.types.register_certificate_request
import capo_iot.types.register_certificate_response
...
def handle_response(
    ...
    out: capo_iot.types.register_certificate_response.RegisterCertificateResponse = (
        capo_iot.types.register_certificate_response.deserialize_json(
