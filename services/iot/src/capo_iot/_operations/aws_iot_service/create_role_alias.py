"""Generated from Smithy shape ``com.amazonaws.iot#CreateRoleAlias``."""
...
import capo_iot.types.create_role_alias_request
import capo_iot.types.create_role_alias_response
...
def handle_response(
    ...
    out: capo_iot.types.create_role_alias_response.CreateRoleAliasResponse = (
        capo_iot.types.create_role_alias_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/role-aliases/{roleAlias}"
    url = url.replace("{roleAlias}", quote(str(input_["role_alias"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_iot.types.create_role_alias_request.serialize_json(input_)
    ).encode()
...
def create_role_alias(
    ...
    capo_iot.types.create_role_alias_response.CreateRoleAliasResponse, zapros.Response
]:
...
async def async_create_role_alias(
