"""Generated from Smithy shape ``com.amazonaws.iot#SetDefaultPolicyVersion``."""
...
import capo_iot.types.set_default_policy_version_request
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/policies/{policyName}/version/{policyVersionId}"
