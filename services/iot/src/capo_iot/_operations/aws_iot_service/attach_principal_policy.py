"""Generated from Smithy shape ``com.amazonaws.iot#AttachPrincipalPolicy``."""
...
import capo_iot.types.attach_principal_policy_request
...
async def async_attach_principal_policy(
