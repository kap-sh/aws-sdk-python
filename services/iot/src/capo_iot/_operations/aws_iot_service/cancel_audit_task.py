"""Generated from Smithy shape ``com.amazonaws.iot#CancelAuditTask``."""
...
import capo_iot.types.cancel_audit_task_request
import capo_iot.types.cancel_audit_task_response
...
def handle_response(
    ...
    out: capo_iot.types.cancel_audit_task_response.CancelAuditTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/audit/tasks/{taskId}/cancel"
...
def cancel_audit_task(
    ...
    capo_iot.types.cancel_audit_task_response.CancelAuditTaskResponse, zapros.Response
]:
...
async def async_cancel_audit_task(
