"""Generated from Smithy shape ``com.amazonaws.iot#CreateThing``."""
...
import capo_iot.types.create_thing_request
import capo_iot.types.create_thing_response
...
def handle_response(
    ...
    out: capo_iot.types.create_thing_response.CreateThingResponse = (
        capo_iot.types.create_thing_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_thing_request.serialize_json(input_)
    ).encode()
...
def create_thing(
    ...
    input_: capo_iot.types.create_thing_request.CreateThingRequest,
) -> tuple[capo_iot.types.create_thing_response.CreateThingResponse, zapros.Response]:
