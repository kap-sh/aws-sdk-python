"""Generated from Smithy shape ``com.amazonaws.iot#UpdateFleetMetric``."""
...
import capo_iot.errors.version_conflict_exception
import capo_iot.types.aggregation_type
import capo_iot.types.fleet_metric_unit
import capo_iot.types.update_fleet_metric_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "VersionConflictException":
            raise capo_iot.errors.version_conflict_exception.VersionConflictException.from_json(
                data
            )
        case _:
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_fleet_metric_request.serialize_json(input_)
    ).encode()
...
async def async_update_fleet_metric(
