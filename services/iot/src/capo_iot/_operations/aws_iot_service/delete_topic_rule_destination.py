"""Generated from Smithy shape ``com.amazonaws.iot#DeleteTopicRuleDestination``."""
...
import capo_iot.types.delete_topic_rule_destination_request
import capo_iot.types.delete_topic_rule_destination_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_topic_rule_destination_response.DeleteTopicRuleDestinationResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_topic_rule_destination(
