"""Generated from Smithy shape ``com.amazonaws.iot#ListTargetsForPolicy``."""
...
import capo_iot.types.list_targets_for_policy_request
import capo_iot.types.list_targets_for_policy_response
...
def handle_response(
    ...
    out: capo_iot.types.list_targets_for_policy_response.ListTargetsForPolicyResponse = capo_iot.types.list_targets_for_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/policy-targets/{policyName}"
...
async def async_list_targets_for_policy(
