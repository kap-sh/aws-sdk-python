...
import capo_iot.types.update_package_request
import capo_iot.types.update_package_response
...
def handle_response(
    ...
    out: capo_iot.types.update_package_response.UpdatePackageResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_package_request.serialize_json(input_)
    ).encode()
...
def update_package(
    ...
    capo_iot.types.update_package_response.UpdatePackageResponse, zapros.Response
]:
