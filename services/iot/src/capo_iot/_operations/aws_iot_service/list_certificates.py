"""Generated from Smithy shape ``com.amazonaws.iot#ListCertificates``."""
...
import capo_iot.types.list_certificates_request
import capo_iot.types.list_certificates_response
...
def handle_response(
    ...
    out: capo_iot.types.list_certificates_response.ListCertificatesResponse = (
        capo_iot.types.list_certificates_response.deserialize_json(
...
def list_certificates(
    ...
    capo_iot.types.list_certificates_response.ListCertificatesResponse, zapros.Response
]:
