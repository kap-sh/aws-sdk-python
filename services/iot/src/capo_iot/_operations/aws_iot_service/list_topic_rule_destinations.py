"""Generated from Smithy shape ``com.amazonaws.iot#ListTopicRuleDestinations``."""
...
import capo_iot.types.list_topic_rule_destinations_request
import capo_iot.types.list_topic_rule_destinations_response
import capo_iot.types.topic_rule_destination_summaries
...
def handle_response(
    ...
    out: capo_iot.types.list_topic_rule_destinations_response.ListTopicRuleDestinationsResponse = capo_iot.types.list_topic_rule_destinations_response.deserialize_json(
...
async def async_list_topic_rule_destinations(
