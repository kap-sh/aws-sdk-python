"""Generated from Smithy shape ``com.amazonaws.iot#ListDetectMitigationActionsExecutions``."""
...
import capo_iot.types.detect_mitigation_action_execution_list
import capo_iot.types.list_detect_mitigation_actions_executions_request
import capo_iot.types.list_detect_mitigation_actions_executions_response
...
def handle_response(
    ...
    out: capo_iot.types.list_detect_mitigation_actions_executions_response.ListDetectMitigationActionsExecutionsResponse = capo_iot.types.list_detect_mitigation_actions_executions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/detect/mitigationactions/executions"
    params: dict[str, str] = {}
    if "task_id" in input_:
        params["taskId"] = str(input_["task_id"])
    if "violation_id" in input_:
        params["violationId"] = str(input_["violation_id"])
...
async def async_list_detect_mitigation_actions_executions(
