"""Generated from Smithy shape ``com.amazonaws.iot#CancelJob``."""
...
import capo_iot.types.cancel_job_request
import capo_iot.types.cancel_job_response
...
def handle_response(
    ...
    out: capo_iot.types.cancel_job_response.CancelJobResponse = (
        capo_iot.types.cancel_job_response.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_iot.types.cancel_job_response.CancelJobResponse = (
        capo_iot.types.cancel_job_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_iot.types.cancel_job_request.CancelJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def cancel_job(
    ...
    input_: capo_iot.types.cancel_job_request.CancelJobRequest,
) -> tuple[capo_iot.types.cancel_job_response.CancelJobResponse, zapros.Response]:
