"""Generated from Smithy shape ``com.amazonaws.iot#TestAuthorization``."""
...
import capo_iot.types.test_authorization_request
import capo_iot.types.test_authorization_response
...
def handle_response(
    ...
    out: capo_iot.types.test_authorization_response.TestAuthorizationResponse = (
        capo_iot.types.test_authorization_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.test_authorization_request.serialize_json(input_)
    ).encode()
