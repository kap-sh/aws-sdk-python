"""Generated from Smithy shape ``com.amazonaws.iot#ListAuthorizers``."""
...
import capo_iot.types.list_authorizers_request
import capo_iot.types.list_authorizers_response
...
def handle_response(
    ...
    out: capo_iot.types.list_authorizers_response.ListAuthorizersResponse = (
        capo_iot.types.list_authorizers_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/authorizers"
    params: dict[str, str] = {}
...
def list_authorizers(
    ...
    capo_iot.types.list_authorizers_response.ListAuthorizersResponse, zapros.Response
]:
...
async def async_list_authorizers(
