"""Generated from Smithy shape ``com.amazonaws.iot#GetPackageVersion``."""
...
import capo_iot.types.get_package_version_request
import capo_iot.types.get_package_version_response
...
def handle_response(
    ...
    out: capo_iot.types.get_package_version_response.GetPackageVersionResponse = (
        capo_iot.types.get_package_version_response.deserialize_json(
