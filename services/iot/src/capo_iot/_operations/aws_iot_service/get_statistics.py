"""Generated from Smithy shape ``com.amazonaws.iot#GetStatistics``."""
...
import capo_iot.types.get_statistics_request
import capo_iot.types.get_statistics_response
import capo_iot.types.statistics
...
def handle_response(
    ...
    out: capo_iot.types.get_statistics_response.GetStatisticsResponse = (
        capo_iot.types.get_statistics_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/indices/statistics"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_iot.types.get_statistics_request.serialize_json(input_)
    ).encode()
...
def get_statistics(
    ...
    capo_iot.types.get_statistics_response.GetStatisticsResponse, zapros.Response
]:
