"""Generated from Smithy shape ``com.amazonaws.iot#CancelJobExecution``."""
...
import capo_iot.errors.invalid_state_transition_exception
...
import capo_iot.types.cancel_job_execution_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidStateTransitionException":
            raise capo_iot.errors.invalid_state_transition_exception.InvalidStateTransitionException.from_json(
                data
            )
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/things/{thingName}/jobs/{jobId}/cancel"
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.cancel_job_execution_request.serialize_json(input_)
    ).encode()
...
async def async_cancel_job_execution(
