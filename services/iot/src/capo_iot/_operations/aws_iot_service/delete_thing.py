...
import capo_iot.types.delete_thing_request
import capo_iot.types.delete_thing_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_thing_response.DeleteThingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_thing(
    ...
    input_: capo_iot.types.delete_thing_request.DeleteThingRequest,
) -> tuple[capo_iot.types.delete_thing_response.DeleteThingResponse, zapros.Response]:
