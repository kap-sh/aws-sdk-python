"""Generated from Smithy shape ``com.amazonaws.iot#StopThingRegistrationTask``."""
...
import capo_iot.types.stop_thing_registration_task_request
import capo_iot.types.stop_thing_registration_task_response
...
def handle_response(
    ...
    out: capo_iot.types.stop_thing_registration_task_response.StopThingRegistrationTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/thing-registration-tasks/{taskId}/cancel"
...
async def async_stop_thing_registration_task(
