"""Generated from Smithy shape ``com.amazonaws.iot#CreatePolicyVersion``."""
...
import capo_iot.errors.malformed_policy_exception
...
import capo_iot.types.create_policy_version_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MalformedPolicyException":
            raise capo_iot.errors.malformed_policy_exception.MalformedPolicyException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_iot.types.create_policy_version_response.CreatePolicyVersionResponse = (
        capo_iot.types.create_policy_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_policy_version_request.serialize_json(input_)
    ).encode()
