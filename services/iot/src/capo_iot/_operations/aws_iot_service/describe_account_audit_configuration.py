"""Generated from Smithy shape ``com.amazonaws.iot#DescribeAccountAuditConfiguration``."""
...
import capo_iot.types.describe_account_audit_configuration_request
import capo_iot.types.describe_account_audit_configuration_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_account_audit_configuration_response.DescribeAccountAuditConfigurationResponse = capo_iot.types.describe_account_audit_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/audit/configuration"
    params: dict[str, str] = {}
...
async def async_describe_account_audit_configuration(
