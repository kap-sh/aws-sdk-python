...
import capo_iot.types.create_certificate_from_csr_request
import capo_iot.types.create_certificate_from_csr_response
...
def handle_response(
    ...
    out: capo_iot.types.create_certificate_from_csr_response.CreateCertificateFromCsrResponse = capo_iot.types.create_certificate_from_csr_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_certificate_from_csr_request.serialize_json(input_)
    ).encode()
