"""Generated from Smithy shape ``com.amazonaws.iot#DescribeThingGroup``."""
...
import capo_iot.types.describe_thing_group_request
import capo_iot.types.describe_thing_group_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_thing_group_response.DescribeThingGroupResponse = (
        capo_iot.types.describe_thing_group_response.deserialize_json(
...
async def async_describe_thing_group(
