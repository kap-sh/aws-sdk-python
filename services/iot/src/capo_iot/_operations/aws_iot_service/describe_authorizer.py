"""Generated from Smithy shape ``com.amazonaws.iot#DescribeAuthorizer``."""
...
import capo_iot.types.describe_authorizer_request
import capo_iot.types.describe_authorizer_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_authorizer_response.DescribeAuthorizerResponse = (
        capo_iot.types.describe_authorizer_response.deserialize_json(
...
async def async_describe_authorizer(
