"""Generated from Smithy shape ``com.amazonaws.iot#CreateDomainConfiguration``."""
...
import capo_iot.types.create_domain_configuration_request
import capo_iot.types.create_domain_configuration_response
...
def handle_response(
    ...
    out: capo_iot.types.create_domain_configuration_response.CreateDomainConfigurationResponse = capo_iot.types.create_domain_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_domain_configuration_request.serialize_json(input_)
    ).encode()
...
async def async_create_domain_configuration(
