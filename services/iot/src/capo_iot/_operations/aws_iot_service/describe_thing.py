"""Generated from Smithy shape ``com.amazonaws.iot#DescribeThing``."""
...
import capo_iot.types.describe_thing_request
import capo_iot.types.describe_thing_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_thing_response.DescribeThingResponse = (
        capo_iot.types.describe_thing_response.deserialize_json(
...
def describe_thing(
    ...
    capo_iot.types.describe_thing_response.DescribeThingResponse, zapros.Response
]:
...
async def async_describe_thing(
