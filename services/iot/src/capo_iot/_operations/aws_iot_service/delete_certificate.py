"""Generated from Smithy shape ``com.amazonaws.iot#DeleteCertificate``."""
...
import capo_iot.types.delete_certificate_request
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/certificates/{certificateId}"
