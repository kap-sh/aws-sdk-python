"""Generated from Smithy shape ``com.amazonaws.iot#DescribeFleetMetric``."""
...
import capo_iot.types.describe_fleet_metric_request
import capo_iot.types.describe_fleet_metric_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_fleet_metric_response.DescribeFleetMetricResponse = (
        capo_iot.types.describe_fleet_metric_response.deserialize_json(
...
async def async_describe_fleet_metric(
