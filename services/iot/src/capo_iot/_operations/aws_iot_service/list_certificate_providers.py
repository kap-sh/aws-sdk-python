...
import capo_iot.types.list_certificate_providers_request
import capo_iot.types.list_certificate_providers_response
...
def handle_response(
    ...
    out: capo_iot.types.list_certificate_providers_response.ListCertificateProvidersResponse = capo_iot.types.list_certificate_providers_response.deserialize_json(
