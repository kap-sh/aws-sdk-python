"""Generated from Smithy shape ``com.amazonaws.iot#GetCommandExecution``."""
...
import capo_iot.types.get_command_execution_request
import capo_iot.types.get_command_execution_response
...
) -> capo_iot.types.get_command_execution_response.GetCommandExecutionResponse:
    out: capo_iot.types.get_command_execution_response.GetCommandExecutionResponse = (
        capo_iot.types.get_command_execution_response.deserialize_json(
