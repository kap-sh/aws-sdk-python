"""Generated from Smithy shape ``com.amazonaws.iot#ListDetectMitigationActionsTasks``."""
...
import capo_iot.types.detect_mitigation_actions_task_summary_list
import capo_iot.types.list_detect_mitigation_actions_tasks_request
import capo_iot.types.list_detect_mitigation_actions_tasks_response
...
def handle_response(
    ...
    out: capo_iot.types.list_detect_mitigation_actions_tasks_response.ListDetectMitigationActionsTasksResponse = capo_iot.types.list_detect_mitigation_actions_tasks_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/detect/mitigationactions/tasks"
    params: dict[str, str] = {}
...
async def async_list_detect_mitigation_actions_tasks(
