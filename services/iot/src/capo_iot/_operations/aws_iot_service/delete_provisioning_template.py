"""Generated from Smithy shape ``com.amazonaws.iot#DeleteProvisioningTemplate``."""
...
import capo_iot.errors.delete_conflict_exception
...
import capo_iot.types.delete_provisioning_template_request
import capo_iot.types.delete_provisioning_template_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DeleteConflictException":
            raise capo_iot.errors.delete_conflict_exception.DeleteConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_iot.types.delete_provisioning_template_response.DeleteProvisioningTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/provisioning-templates/{templateName}"
...
async def async_delete_provisioning_template(
