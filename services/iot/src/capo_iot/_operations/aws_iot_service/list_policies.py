"""Generated from Smithy shape ``com.amazonaws.iot#ListPolicies``."""
...
import capo_iot.types.list_policies_request
import capo_iot.types.list_policies_response
...
def handle_response(
    ...
    out: capo_iot.types.list_policies_response.ListPoliciesResponse = (
        capo_iot.types.list_policies_response.deserialize_json(
...
def list_policies(
    ...
    input_: capo_iot.types.list_policies_request.ListPoliciesRequest,
) -> tuple[capo_iot.types.list_policies_response.ListPoliciesResponse, zapros.Response]:
