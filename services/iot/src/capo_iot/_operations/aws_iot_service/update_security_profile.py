...
import capo_iot.types.update_security_profile_request
import capo_iot.types.update_security_profile_response
...
def handle_response(
    ...
    out: capo_iot.types.update_security_profile_response.UpdateSecurityProfileResponse = capo_iot.types.update_security_profile_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{securityProfileName}", quote(str(input_["security_profile_name"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_security_profile_request.serialize_json(input_)
    ).encode()
