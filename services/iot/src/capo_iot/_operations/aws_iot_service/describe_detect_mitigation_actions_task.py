"""Generated from Smithy shape ``com.amazonaws.iot#DescribeDetectMitigationActionsTask``."""
...
import capo_iot.types.describe_detect_mitigation_actions_task_request
import capo_iot.types.describe_detect_mitigation_actions_task_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_detect_mitigation_actions_task_response.DescribeDetectMitigationActionsTaskResponse = capo_iot.types.describe_detect_mitigation_actions_task_response.deserialize_json(
...
async def async_describe_detect_mitigation_actions_task(
