"""Generated from Smithy shape ``com.amazonaws.iot#ListIndices``."""
...
import capo_iot.types.index_names_list
import capo_iot.types.list_indices_request
import capo_iot.types.list_indices_response
...
def handle_response(
    ...
    out: capo_iot.types.list_indices_response.ListIndicesResponse = (
        capo_iot.types.list_indices_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/indices"
    params: dict[str, str] = {}
...
def list_indices(
    ...
    input_: capo_iot.types.list_indices_request.ListIndicesRequest,
) -> tuple[capo_iot.types.list_indices_response.ListIndicesResponse, zapros.Response]:
