...
import capo_iot.types.create_ota_update_request
import capo_iot.types.create_ota_update_response
...
def handle_response(
    ...
    out: capo_iot.types.create_ota_update_response.CreateOTAUpdateResponse = (
        capo_iot.types.create_ota_update_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_ota_update_request.serialize_json(input_)
    ).encode()
...
def create_ota_update(
    ...
    capo_iot.types.create_ota_update_response.CreateOTAUpdateResponse, zapros.Response
]:
