"""Generated from Smithy shape ``com.amazonaws.iot#ListJobTemplates``."""
...
import capo_iot.types.list_job_templates_request
import capo_iot.types.list_job_templates_response
...
def handle_response(
    ...
    out: capo_iot.types.list_job_templates_response.ListJobTemplatesResponse = (
        capo_iot.types.list_job_templates_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/job-templates"
    params: dict[str, str] = {}
...
def list_job_templates(
    ...
    capo_iot.types.list_job_templates_response.ListJobTemplatesResponse, zapros.Response
]:
