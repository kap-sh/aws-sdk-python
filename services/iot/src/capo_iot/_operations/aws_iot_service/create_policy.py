"""Generated from Smithy shape ``com.amazonaws.iot#CreatePolicy``."""
...
import capo_iot.types.create_policy_request
import capo_iot.types.create_policy_response
...
def handle_response(
    ...
    out: capo_iot.types.create_policy_response.CreatePolicyResponse = (
        capo_iot.types.create_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/policies/{policyName}"
    url = url.replace("{policyName}", quote(str(input_["policy_name"]), safe=""))
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_iot.types.create_policy_request.serialize_json(input_)
    ).encode()
...
def create_policy(
    ...
    input_: capo_iot.types.create_policy_request.CreatePolicyRequest,
) -> tuple[capo_iot.types.create_policy_response.CreatePolicyResponse, zapros.Response]:
