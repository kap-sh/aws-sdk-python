"""Generated from Smithy shape ``com.amazonaws.iot#GetBehaviorModelTrainingSummaries``."""
...
import capo_iot.types.get_behavior_model_training_summaries_request
import capo_iot.types.get_behavior_model_training_summaries_response
...
def handle_response(
    ...
    out: capo_iot.types.get_behavior_model_training_summaries_response.GetBehaviorModelTrainingSummariesResponse = capo_iot.types.get_behavior_model_training_summaries_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/behavior-model-training/summaries"
    params: dict[str, str] = {}
...
async def async_get_behavior_model_training_summaries(
