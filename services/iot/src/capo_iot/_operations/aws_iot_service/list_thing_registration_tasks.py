"""Generated from Smithy shape ``com.amazonaws.iot#ListThingRegistrationTasks``."""
...
import capo_iot.types.list_thing_registration_tasks_request
import capo_iot.types.list_thing_registration_tasks_response
...
def handle_response(
    ...
    out: capo_iot.types.list_thing_registration_tasks_response.ListThingRegistrationTasksResponse = capo_iot.types.list_thing_registration_tasks_response.deserialize_json(
...
async def async_list_thing_registration_tasks(
