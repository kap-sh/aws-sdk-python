"""Generated from Smithy shape ``com.amazonaws.iot#ListCertificatesByCA``."""
...
import capo_iot.types.list_certificates_by_ca_request
import capo_iot.types.list_certificates_by_ca_response
...
def handle_response(
    ...
    out: capo_iot.types.list_certificates_by_ca_response.ListCertificatesByCAResponse = capo_iot.types.list_certificates_by_ca_response.deserialize_json(
