"""Generated from Smithy shape ``com.amazonaws.iot#AttachThingPrincipal``."""
...
import capo_iot.types.attach_thing_principal_request
import capo_iot.types.attach_thing_principal_response
...
def handle_response(
    ...
    out: capo_iot.types.attach_thing_principal_response.AttachThingPrincipalResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    params: dict[str, str] = {}
    if "thing_principal_type" in input_:
        params["thingPrincipalType"] = str(input_["thing_principal_type"])
...
async def async_attach_thing_principal(
