"""Generated from Smithy shape ``com.amazonaws.iot#CreateSecurityProfile``."""
...
import capo_iot.types.create_security_profile_request
import capo_iot.types.create_security_profile_response
...
def handle_response(
    ...
    out: capo_iot.types.create_security_profile_response.CreateSecurityProfileResponse = capo_iot.types.create_security_profile_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_security_profile_request.serialize_json(input_)
    ).encode()
...
async def async_create_security_profile(
