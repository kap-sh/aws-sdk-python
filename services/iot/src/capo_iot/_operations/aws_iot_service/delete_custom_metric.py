"""Generated from Smithy shape ``com.amazonaws.iot#DeleteCustomMetric``."""
...
import capo_iot.types.delete_custom_metric_request
import capo_iot.types.delete_custom_metric_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_custom_metric_response.DeleteCustomMetricResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_custom_metric(
