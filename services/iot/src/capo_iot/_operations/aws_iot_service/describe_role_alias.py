"""Generated from Smithy shape ``com.amazonaws.iot#DescribeRoleAlias``."""
...
import capo_iot.types.describe_role_alias_request
import capo_iot.types.describe_role_alias_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_role_alias_response.DescribeRoleAliasResponse = (
        capo_iot.types.describe_role_alias_response.deserialize_json(
...
async def async_describe_role_alias(
