"""Generated from Smithy shape ``com.amazonaws.iot#ListJobExecutionsForThing``."""
...
import capo_iot.types.list_job_executions_for_thing_request
import capo_iot.types.list_job_executions_for_thing_response
...
def handle_response(
    ...
    out: capo_iot.types.list_job_executions_for_thing_response.ListJobExecutionsForThingResponse = capo_iot.types.list_job_executions_for_thing_response.deserialize_json(
...
async def async_list_job_executions_for_thing(
