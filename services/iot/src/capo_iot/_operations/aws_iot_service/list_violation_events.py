"""Generated from Smithy shape ``com.amazonaws.iot#ListViolationEvents``."""
...
import capo_iot.types.list_violation_events_request
import capo_iot.types.list_violation_events_response
...
def handle_response(
    ...
    out: capo_iot.types.list_violation_events_response.ListViolationEventsResponse = (
        capo_iot.types.list_violation_events_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/violation-events"
    params: dict[str, str] = {}
...
async def async_list_violation_events(
