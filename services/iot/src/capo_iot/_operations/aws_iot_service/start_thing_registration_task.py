"""Generated from Smithy shape ``com.amazonaws.iot#StartThingRegistrationTask``."""
...
import capo_iot.types.start_thing_registration_task_request
import capo_iot.types.start_thing_registration_task_response
...
def handle_response(
    ...
    out: capo_iot.types.start_thing_registration_task_response.StartThingRegistrationTaskResponse = capo_iot.types.start_thing_registration_task_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.start_thing_registration_task_request.serialize_json(input_)
    ).encode()
...
async def async_start_thing_registration_task(
