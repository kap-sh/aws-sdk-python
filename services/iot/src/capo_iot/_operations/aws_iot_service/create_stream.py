"""Generated from Smithy shape ``com.amazonaws.iot#CreateStream``."""
...
import capo_iot.types.create_stream_request
import capo_iot.types.create_stream_response
...
def handle_response(
    ...
    out: capo_iot.types.create_stream_response.CreateStreamResponse = (
        capo_iot.types.create_stream_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_stream_request.serialize_json(input_)
    ).encode()
...
def create_stream(
    ...
    input_: capo_iot.types.create_stream_request.CreateStreamRequest,
) -> tuple[capo_iot.types.create_stream_response.CreateStreamResponse, zapros.Response]:
