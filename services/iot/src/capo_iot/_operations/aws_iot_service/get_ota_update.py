...
import capo_iot.types.get_ota_update_request
import capo_iot.types.get_ota_update_response
...
def handle_response(
    ...
    out: capo_iot.types.get_ota_update_response.GetOTAUpdateResponse = (
        capo_iot.types.get_ota_update_response.deserialize_json(
...
def get_ota_update(
    ...
    capo_iot.types.get_ota_update_response.GetOTAUpdateResponse, zapros.Response
]:
