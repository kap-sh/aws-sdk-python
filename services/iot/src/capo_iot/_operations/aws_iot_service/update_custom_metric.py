"""Generated from Smithy shape ``com.amazonaws.iot#UpdateCustomMetric``."""
...
import capo_iot.types.update_custom_metric_request
import capo_iot.types.update_custom_metric_response
...
def handle_response(
    ...
    out: capo_iot.types.update_custom_metric_response.UpdateCustomMetricResponse = (
        capo_iot.types.update_custom_metric_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_custom_metric_request.serialize_json(input_)
    ).encode()
...
async def async_update_custom_metric(
