"""Generated from Smithy shape ``com.amazonaws.iot#CreateCertificateProvider``."""
...
import capo_iot.types.create_certificate_provider_request
import capo_iot.types.create_certificate_provider_response
...
def handle_response(
    ...
    out: capo_iot.types.create_certificate_provider_response.CreateCertificateProviderResponse = capo_iot.types.create_certificate_provider_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_certificate_provider_request.serialize_json(input_)
    ).encode()
...
async def async_create_certificate_provider(
