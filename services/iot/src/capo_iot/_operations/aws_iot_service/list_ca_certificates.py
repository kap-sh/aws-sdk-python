"""Generated from Smithy shape ``com.amazonaws.iot#ListCACertificates``."""
...
import capo_iot.types.list_ca_certificates_request
import capo_iot.types.list_ca_certificates_response
...
def handle_response(
    ...
    out: capo_iot.types.list_ca_certificates_response.ListCACertificatesResponse = (
        capo_iot.types.list_ca_certificates_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/cacertificates"
    params: dict[str, str] = {}
...
async def async_list_ca_certificates(
