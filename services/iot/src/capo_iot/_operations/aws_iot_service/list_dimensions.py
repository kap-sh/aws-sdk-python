"""Generated from Smithy shape ``com.amazonaws.iot#ListDimensions``."""
...
import capo_iot.types.list_dimensions_request
import capo_iot.types.list_dimensions_response
...
def handle_response(
    ...
    out: capo_iot.types.list_dimensions_response.ListDimensionsResponse = (
        capo_iot.types.list_dimensions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/dimensions"
    params: dict[str, str] = {}
...
def list_dimensions(
    ...
    capo_iot.types.list_dimensions_response.ListDimensionsResponse, zapros.Response
]:
...
async def async_list_dimensions(
