...
import capo_iot.types.list_v2_logging_levels_request
import capo_iot.types.list_v2_logging_levels_response
...
def handle_response(
    ...
    out: capo_iot.types.list_v2_logging_levels_response.ListV2LoggingLevelsResponse = (
        capo_iot.types.list_v2_logging_levels_response.deserialize_json(
