"""Generated from Smithy shape ``com.amazonaws.iot#DeleteJob``."""
...
import capo_iot.types.delete_job_request
...
def build_request(
    ...
    input_: capo_iot.types.delete_job_request.DeleteJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
