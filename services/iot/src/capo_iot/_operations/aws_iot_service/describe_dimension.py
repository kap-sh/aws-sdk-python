"""Generated from Smithy shape ``com.amazonaws.iot#DescribeDimension``."""
...
import capo_iot.types.describe_dimension_request
import capo_iot.types.describe_dimension_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_dimension_response.DescribeDimensionResponse = (
        capo_iot.types.describe_dimension_response.deserialize_json(
...
async def async_describe_dimension(
