...
import capo_iot.types.delete_dynamic_thing_group_request
import capo_iot.types.delete_dynamic_thing_group_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_dynamic_thing_group_response.DeleteDynamicThingGroupResponse = {}  # type: ignore[typeddict-item]
    return out
