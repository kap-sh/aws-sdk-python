"""Generated from Smithy shape ``com.amazonaws.iot#ListScheduledAudits``."""
...
import capo_iot.types.list_scheduled_audits_request
import capo_iot.types.list_scheduled_audits_response
import capo_iot.types.scheduled_audit_metadata_list
...
def handle_response(
    ...
    out: capo_iot.types.list_scheduled_audits_response.ListScheduledAuditsResponse = (
        capo_iot.types.list_scheduled_audits_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/audit/scheduledaudits"
    params: dict[str, str] = {}
...
async def async_list_scheduled_audits(
