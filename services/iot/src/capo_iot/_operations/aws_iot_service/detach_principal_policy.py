"""Generated from Smithy shape ``com.amazonaws.iot#DetachPrincipalPolicy``."""
...
import capo_iot.types.detach_principal_policy_request
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/principal-policies/{policyName}"
...
async def async_detach_principal_policy(
