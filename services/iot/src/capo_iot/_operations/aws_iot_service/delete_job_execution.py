"""Generated from Smithy shape ``com.amazonaws.iot#DeleteJobExecution``."""
...
import capo_iot.types.delete_job_execution_request
...
def build_request(
    ...
    url = url.replace(
        "{executionNumber}", quote(str(input_["execution_number"]), safe="")
    )
    params: dict[str, str] = {}
...
async def async_delete_job_execution(
