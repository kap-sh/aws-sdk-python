"""Generated from Smithy shape ``com.amazonaws.iot#UpdateDomainConfiguration``."""
...
import capo_iot.types.update_domain_configuration_request
import capo_iot.types.update_domain_configuration_response
...
def handle_response(
    ...
    out: capo_iot.types.update_domain_configuration_response.UpdateDomainConfigurationResponse = capo_iot.types.update_domain_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(str(input_["domain_configuration_name"]), safe=""),
    )
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_iot.types.update_domain_configuration_request.serialize_json(input_)
    ).encode()
...
async def async_update_domain_configuration(
