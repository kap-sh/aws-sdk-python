...
import capo_iot.types.get_indexing_configuration_request
import capo_iot.types.get_indexing_configuration_response
...
def handle_response(
    ...
    out: capo_iot.types.get_indexing_configuration_response.GetIndexingConfigurationResponse = capo_iot.types.get_indexing_configuration_response.deserialize_json(
