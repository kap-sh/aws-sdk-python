"""Generated from Smithy shape ``com.amazonaws.iot#CreateBillingGroup``."""
...
import capo_iot.types.create_billing_group_request
import capo_iot.types.create_billing_group_response
...
def handle_response(
    ...
    out: capo_iot.types.create_billing_group_response.CreateBillingGroupResponse = (
        capo_iot.types.create_billing_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_billing_group_request.serialize_json(input_)
    ).encode()
