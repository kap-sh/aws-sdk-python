"""Generated from Smithy shape ``com.amazonaws.iot#UpdateJob``."""
...
import capo_iot.types.update_job_request
...
def build_request(
    ...
    input_: capo_iot.types.update_job_request.UpdateJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_job_request.serialize_json(input_)
    ).encode()
