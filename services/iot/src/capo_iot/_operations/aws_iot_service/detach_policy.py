"""Generated from Smithy shape ``com.amazonaws.iot#DetachPolicy``."""
...
import capo_iot.types.detach_policy_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.detach_policy_request.serialize_json(input_)
    ).encode()
