"""Generated from Smithy shape ``com.amazonaws.iot#DescribeBillingGroup``."""
...
import capo_iot.types.describe_billing_group_request
import capo_iot.types.describe_billing_group_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_billing_group_response.DescribeBillingGroupResponse = (
        capo_iot.types.describe_billing_group_response.deserialize_json(
...
async def async_describe_billing_group(
