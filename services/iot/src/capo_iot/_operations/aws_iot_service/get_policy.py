"""Generated from Smithy shape ``com.amazonaws.iot#GetPolicy``."""
...
import capo_iot.types.get_policy_request
import capo_iot.types.get_policy_response
...
def handle_response(
    ...
    out: capo_iot.types.get_policy_response.GetPolicyResponse = (
        capo_iot.types.get_policy_response.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_iot.types.get_policy_response.GetPolicyResponse = (
        capo_iot.types.get_policy_response.deserialize_json(
...
def get_policy(
    ...
    input_: capo_iot.types.get_policy_request.GetPolicyRequest,
) -> tuple[capo_iot.types.get_policy_response.GetPolicyResponse, zapros.Response]:
