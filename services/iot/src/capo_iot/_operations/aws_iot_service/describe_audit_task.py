"""Generated from Smithy shape ``com.amazonaws.iot#DescribeAuditTask``."""
...
import capo_iot.types.describe_audit_task_request
import capo_iot.types.describe_audit_task_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_audit_task_response.DescribeAuditTaskResponse = (
        capo_iot.types.describe_audit_task_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/audit/tasks/{taskId}"
...
async def async_describe_audit_task(
