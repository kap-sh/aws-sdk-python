...
import capo_iot.types.list_packages_request
import capo_iot.types.list_packages_response
import capo_iot.types.package_summary_list
...
def handle_response(
    ...
    out: capo_iot.types.list_packages_response.ListPackagesResponse = (
        capo_iot.types.list_packages_response.deserialize_json(
...
def list_packages(
    ...
    input_: capo_iot.types.list_packages_request.ListPackagesRequest,
) -> tuple[capo_iot.types.list_packages_response.ListPackagesResponse, zapros.Response]:
