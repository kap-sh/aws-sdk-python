"""Generated from Smithy shape ``com.amazonaws.iot#DeleteOTAUpdate``."""
...
import capo_iot.types.delete_ota_update_request
import capo_iot.types.delete_ota_update_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_ota_update_response.DeleteOTAUpdateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    params: dict[str, str] = {}
    params["deleteStream"] = str(input_.get("delete_stream", False))
    params["forceDeleteAWSJob"] = str(input_.get("force_delete_aws_job", False))
...
def delete_ota_update(
    ...
    capo_iot.types.delete_ota_update_response.DeleteOTAUpdateResponse, zapros.Response
]:
...
async def async_delete_ota_update(
