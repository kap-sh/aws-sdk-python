"""Generated from Smithy shape ``com.amazonaws.iot#DescribeCustomMetric``."""
...
import capo_iot.types.describe_custom_metric_request
import capo_iot.types.describe_custom_metric_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_custom_metric_response.DescribeCustomMetricResponse = (
        capo_iot.types.describe_custom_metric_response.deserialize_json(
...
async def async_describe_custom_metric(
