"""Generated from Smithy shape ``com.amazonaws.iot#ListAuditMitigationActionsTasks``."""
...
import capo_iot.types.audit_mitigation_actions_task_metadata_list
import capo_iot.types.audit_mitigation_actions_task_status
import capo_iot.types.list_audit_mitigation_actions_tasks_request
import capo_iot.types.list_audit_mitigation_actions_tasks_response
...
def handle_response(
    ...
    out: capo_iot.types.list_audit_mitigation_actions_tasks_response.ListAuditMitigationActionsTasksResponse = capo_iot.types.list_audit_mitigation_actions_tasks_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/audit/mitigationactions/tasks"
    params: dict[str, str] = {}
    if "audit_task_id" in input_:
        params["auditTaskId"] = str(input_["audit_task_id"])
    if "finding_id" in input_:
        params["findingId"] = str(input_["finding_id"])
    if "task_status" in input_:
        params["taskStatus"] = str(input_["task_status"])
...
async def async_list_audit_mitigation_actions_tasks(
