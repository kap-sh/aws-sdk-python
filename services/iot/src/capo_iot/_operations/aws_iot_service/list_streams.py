"""Generated from Smithy shape ``com.amazonaws.iot#ListStreams``."""
...
import capo_iot.types.list_streams_request
import capo_iot.types.list_streams_response
...
def handle_response(
    ...
    out: capo_iot.types.list_streams_response.ListStreamsResponse = (
        capo_iot.types.list_streams_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/streams"
    params: dict[str, str] = {}
...
def list_streams(
    ...
    input_: capo_iot.types.list_streams_request.ListStreamsRequest,
) -> tuple[capo_iot.types.list_streams_response.ListStreamsResponse, zapros.Response]:
