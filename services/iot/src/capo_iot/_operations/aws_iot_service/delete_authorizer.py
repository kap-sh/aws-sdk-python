"""Generated from Smithy shape ``com.amazonaws.iot#DeleteAuthorizer``."""
...
import capo_iot.types.delete_authorizer_request
import capo_iot.types.delete_authorizer_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_authorizer_response.DeleteAuthorizerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/authorizer/{authorizerName}"
    url = url.replace(
...
def delete_authorizer(
    ...
    capo_iot.types.delete_authorizer_response.DeleteAuthorizerResponse, zapros.Response
]:
...
async def async_delete_authorizer(
