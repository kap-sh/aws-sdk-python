"""Generated from Smithy shape ``com.amazonaws.iot#EnableTopicRule``."""
...
import capo_iot.types.enable_topic_rule_request
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/rules/{ruleName}/enable"
...
async def async_enable_topic_rule(
