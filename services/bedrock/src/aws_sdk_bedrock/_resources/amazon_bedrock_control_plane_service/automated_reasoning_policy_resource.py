...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock.types.cancel_automated_reasoning_policy_build_workflow_request
    import aws_sdk_bedrock.types.cancel_automated_reasoning_policy_build_workflow_response
    ...
    import aws_sdk_bedrock.types.delete_automated_reasoning_policy_build_workflow_request
    import aws_sdk_bedrock.types.delete_automated_reasoning_policy_build_workflow_response
    ...
    import aws_sdk_bedrock.types.delete_automated_reasoning_policy_test_case_request
    import aws_sdk_bedrock.types.delete_automated_reasoning_policy_test_case_response
    ...
    import aws_sdk_bedrock.types.get_automated_reasoning_policy_test_result_request
    import aws_sdk_bedrock.types.get_automated_reasoning_policy_test_result_response
    import aws_sdk_bedrock.types.idempotency_token
    import aws_sdk_bedrock.types.kms_key_id
    import aws_sdk_bedrock.types.list_automated_reasoning_policies_request
    import aws_sdk_bedrock.types.list_automated_reasoning_policies_response
    import aws_sdk_bedrock.types.list_automated_reasoning_policy_build_workflows_request
    import aws_sdk_bedrock.types.list_automated_reasoning_policy_build_workflows_response
    ...
    import aws_sdk_bedrock.types.list_automated_reasoning_policy_test_results_request
    import aws_sdk_bedrock.types.list_automated_reasoning_policy_test_results_response
...
class AutomatedReasoningPolicyResource:
    ...
    def create(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.create_automated_reasoning_policy_request.CreateAutomatedReasoningPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.create_automated_reasoning_policy_response.CreateAutomatedReasoningPolicyResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.create_automated_reasoning_policy

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.create_automated_reasoning_policy.create_automated_reasoning_policy(
    ...
    def read(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.get_automated_reasoning_policy_request.GetAutomatedReasoningPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.get_automated_reasoning_policy_response.GetAutomatedReasoningPolicyResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy.get_automated_reasoning_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.update_automated_reasoning_policy_request.UpdateAutomatedReasoningPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.update_automated_reasoning_policy_response.UpdateAutomatedReasoningPolicyResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.update_automated_reasoning_policy

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.update_automated_reasoning_policy.update_automated_reasoning_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        Raises:
            ...
            aws_sdk_bedrock.errors.conflict_exception.ConflictException: <p>Error occurred because of a conflict while performing an operation.</p>
            aws_sdk_bedrock.errors.internal_server_exception.InternalServerException: <p>An internal server error occurred. Retry your request.</p>
            aws_sdk_bedrock.errors.resource_in_use_exception.ResourceInUseException: <p>Thrown when attempting to delete or modify a resource that is currently being used by other resources or operations. For example, trying to delete an Automated Reasoning policy that is referenced by an active guardrail.</p>
            aws_sdk_bedrock.errors.resource_not_found_exception.ResourceNotFoundException: <p>The specified resource Amazon Resource Name (ARN) was not found. Check the Amazon Resource Name (ARN) and try your request again.</p>
            aws_sdk_bedrock.errors.throttling_exception.ThrottlingException: <p>The number of requests exceeds the limit. Resubmit your request later.</p>
            aws_sdk_bedrock.errors.validation_exception.ValidationException: <p>Input validation failed. Check your request parameters and retry the request.</p>
            aws_sdk_bedrock.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.delete_automated_reasoning_policy_request.DeleteAutomatedReasoningPolicyRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.delete_automated_reasoning_policy_response.DeleteAutomatedReasoningPolicyResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.delete_automated_reasoning_policy

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.delete_automated_reasoning_policy.delete_automated_reasoning_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_bedrock.types.list_automated_reasoning_policies_response.ListAutomatedReasoningPoliciesResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.list_automated_reasoning_policies_request.ListAutomatedReasoningPoliciesRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.list_automated_reasoning_policies_response.ListAutomatedReasoningPoliciesResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policies

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policies.list_automated_reasoning_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def cancel_automated_reasoning_policy_build_workflow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.cancel_automated_reasoning_policy_build_workflow_request.CancelAutomatedReasoningPolicyBuildWorkflowRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.cancel_automated_reasoning_policy_build_workflow_response.CancelAutomatedReasoningPolicyBuildWorkflowResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.cancel_automated_reasoning_policy_build_workflow

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.cancel_automated_reasoning_policy_build_workflow.cancel_automated_reasoning_policy_build_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_automated_reasoning_policy_test_case(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.create_automated_reasoning_policy_test_case_request.CreateAutomatedReasoningPolicyTestCaseRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.create_automated_reasoning_policy_test_case_response.CreateAutomatedReasoningPolicyTestCaseResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.create_automated_reasoning_policy_test_case

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.create_automated_reasoning_policy_test_case.create_automated_reasoning_policy_test_case(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_automated_reasoning_policy_version(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.create_automated_reasoning_policy_version_request.CreateAutomatedReasoningPolicyVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.create_automated_reasoning_policy_version_response.CreateAutomatedReasoningPolicyVersionResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.create_automated_reasoning_policy_version

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.create_automated_reasoning_policy_version.create_automated_reasoning_policy_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_automated_reasoning_policy_build_workflow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.delete_automated_reasoning_policy_build_workflow_request.DeleteAutomatedReasoningPolicyBuildWorkflowRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.delete_automated_reasoning_policy_build_workflow_response.DeleteAutomatedReasoningPolicyBuildWorkflowResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.delete_automated_reasoning_policy_build_workflow

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.delete_automated_reasoning_policy_build_workflow.delete_automated_reasoning_policy_build_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_automated_reasoning_policy_test_case(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.delete_automated_reasoning_policy_test_case_request.DeleteAutomatedReasoningPolicyTestCaseRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.delete_automated_reasoning_policy_test_case_response.DeleteAutomatedReasoningPolicyTestCaseResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.delete_automated_reasoning_policy_test_case

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.delete_automated_reasoning_policy_test_case.delete_automated_reasoning_policy_test_case(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def export_automated_reasoning_policy_version(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.export_automated_reasoning_policy_version_request.ExportAutomatedReasoningPolicyVersionRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.export_automated_reasoning_policy_version_response.ExportAutomatedReasoningPolicyVersionResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.export_automated_reasoning_policy_version

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.export_automated_reasoning_policy_version.export_automated_reasoning_policy_version(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_automated_reasoning_policy_annotations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.get_automated_reasoning_policy_annotations_request.GetAutomatedReasoningPolicyAnnotationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.get_automated_reasoning_policy_annotations_response.GetAutomatedReasoningPolicyAnnotationsResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_annotations

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_annotations.get_automated_reasoning_policy_annotations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_automated_reasoning_policy_build_workflow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.get_automated_reasoning_policy_build_workflow_request.GetAutomatedReasoningPolicyBuildWorkflowRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.get_automated_reasoning_policy_build_workflow_response.GetAutomatedReasoningPolicyBuildWorkflowResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_build_workflow

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_build_workflow.get_automated_reasoning_policy_build_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_automated_reasoning_policy_build_workflow_result_assets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.get_automated_reasoning_policy_build_workflow_result_assets_request.GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.get_automated_reasoning_policy_build_workflow_result_assets_response.GetAutomatedReasoningPolicyBuildWorkflowResultAssetsResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_build_workflow_result_assets

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_build_workflow_result_assets.get_automated_reasoning_policy_build_workflow_result_assets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_automated_reasoning_policy_next_scenario(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.get_automated_reasoning_policy_next_scenario_request.GetAutomatedReasoningPolicyNextScenarioRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.get_automated_reasoning_policy_next_scenario_response.GetAutomatedReasoningPolicyNextScenarioResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_next_scenario

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_next_scenario.get_automated_reasoning_policy_next_scenario(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_automated_reasoning_policy_test_case(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.get_automated_reasoning_policy_test_case_request.GetAutomatedReasoningPolicyTestCaseRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.get_automated_reasoning_policy_test_case_response.GetAutomatedReasoningPolicyTestCaseResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_test_case

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_test_case.get_automated_reasoning_policy_test_case(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_automated_reasoning_policy_test_result(
        ...
        *,
        config_overrides: Optional[BedrockClientConfig] = None,
    ) -> "aws_sdk_bedrock.types.get_automated_reasoning_policy_test_result_response.GetAutomatedReasoningPolicyTestResultResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.get_automated_reasoning_policy_test_result_request.GetAutomatedReasoningPolicyTestResultRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.get_automated_reasoning_policy_test_result_response.GetAutomatedReasoningPolicyTestResultResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_test_result

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_test_result.get_automated_reasoning_policy_test_result(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_automated_reasoning_policy_build_workflows(
        ...
        *,
        ...
        max_results: Optional["aws_sdk_bedrock.types.max_results.MaxResults"] = None,
    ) -> "aws_sdk_bedrock.types.list_automated_reasoning_policy_build_workflows_response.ListAutomatedReasoningPolicyBuildWorkflowsResponse":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.list_automated_reasoning_policy_build_workflows_request.ListAutomatedReasoningPolicyBuildWorkflowsRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.list_automated_reasoning_policy_build_workflows_response.ListAutomatedReasoningPolicyBuildWorkflowsResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policy_build_workflows

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policy_build_workflows.list_automated_reasoning_policy_build_workflows(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_automated_reasoning_policy_test_cases(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.list_automated_reasoning_policy_test_cases_request.ListAutomatedReasoningPolicyTestCasesRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.list_automated_reasoning_policy_test_cases_response.ListAutomatedReasoningPolicyTestCasesResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policy_test_cases

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policy_test_cases.list_automated_reasoning_policy_test_cases(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_automated_reasoning_policy_test_results(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.list_automated_reasoning_policy_test_results_request.ListAutomatedReasoningPolicyTestResultsRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.list_automated_reasoning_policy_test_results_response.ListAutomatedReasoningPolicyTestResultsResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policy_test_results

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policy_test_results.list_automated_reasoning_policy_test_results(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_automated_reasoning_policy_build_workflow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.start_automated_reasoning_policy_build_workflow_request.StartAutomatedReasoningPolicyBuildWorkflowRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.start_automated_reasoning_policy_build_workflow_response.StartAutomatedReasoningPolicyBuildWorkflowResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.start_automated_reasoning_policy_build_workflow

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.start_automated_reasoning_policy_build_workflow.start_automated_reasoning_policy_build_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_automated_reasoning_policy_test_workflow(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.start_automated_reasoning_policy_test_workflow_request.StartAutomatedReasoningPolicyTestWorkflowRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.start_automated_reasoning_policy_test_workflow_response.StartAutomatedReasoningPolicyTestWorkflowResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.start_automated_reasoning_policy_test_workflow

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.start_automated_reasoning_policy_test_workflow.start_automated_reasoning_policy_test_workflow(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_automated_reasoning_policy_annotations(
        ...
        last_updated_annotation_set_hash: "aws_sdk_bedrock.types.automated_reasoning_policy_hash.AutomatedReasoningPolicyHash",
        *,
        config_overrides: Optional[BedrockClientConfig] = None,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.update_automated_reasoning_policy_annotations_request.UpdateAutomatedReasoningPolicyAnnotationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.update_automated_reasoning_policy_annotations_response.UpdateAutomatedReasoningPolicyAnnotationsResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.update_automated_reasoning_policy_annotations

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.update_automated_reasoning_policy_annotations.update_automated_reasoning_policy_annotations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_automated_reasoning_policy_test_case(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_bedrock.types.update_automated_reasoning_policy_test_case_request.UpdateAutomatedReasoningPolicyTestCaseRequest]",
        ) -> OperationResponse[
            "aws_sdk_bedrock.types.update_automated_reasoning_policy_test_case_response.UpdateAutomatedReasoningPolicyTestCaseResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.update_automated_reasoning_policy_test_case

            output, http_response = (
                aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.update_automated_reasoning_policy_test_case.update_automated_reasoning_policy_test_case(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncAutomatedReasoningPolicyResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.create_automated_reasoning_policy_request.CreateAutomatedReasoningPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.create_automated_reasoning_policy_response.CreateAutomatedReasoningPolicyResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.create_automated_reasoning_policy
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.create_automated_reasoning_policy.async_create_automated_reasoning_policy(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.get_automated_reasoning_policy_request.GetAutomatedReasoningPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.get_automated_reasoning_policy_response.GetAutomatedReasoningPolicyResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy.async_get_automated_reasoning_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.update_automated_reasoning_policy_request.UpdateAutomatedReasoningPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.update_automated_reasoning_policy_response.UpdateAutomatedReasoningPolicyResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.update_automated_reasoning_policy
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.update_automated_reasoning_policy.async_update_automated_reasoning_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.delete_automated_reasoning_policy_request.DeleteAutomatedReasoningPolicyRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.delete_automated_reasoning_policy_response.DeleteAutomatedReasoningPolicyResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.delete_automated_reasoning_policy
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.delete_automated_reasoning_policy.async_delete_automated_reasoning_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.list_automated_reasoning_policies_request.ListAutomatedReasoningPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.list_automated_reasoning_policies_response.ListAutomatedReasoningPoliciesResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policies
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policies.async_list_automated_reasoning_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_automated_reasoning_policy_build_workflow(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.cancel_automated_reasoning_policy_build_workflow_request.CancelAutomatedReasoningPolicyBuildWorkflowRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.cancel_automated_reasoning_policy_build_workflow_response.CancelAutomatedReasoningPolicyBuildWorkflowResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.cancel_automated_reasoning_policy_build_workflow
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.cancel_automated_reasoning_policy_build_workflow.async_cancel_automated_reasoning_policy_build_workflow(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_automated_reasoning_policy_test_case(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.create_automated_reasoning_policy_test_case_request.CreateAutomatedReasoningPolicyTestCaseRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.create_automated_reasoning_policy_test_case_response.CreateAutomatedReasoningPolicyTestCaseResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.create_automated_reasoning_policy_test_case
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.create_automated_reasoning_policy_test_case.async_create_automated_reasoning_policy_test_case(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_automated_reasoning_policy_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.create_automated_reasoning_policy_version_request.CreateAutomatedReasoningPolicyVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.create_automated_reasoning_policy_version_response.CreateAutomatedReasoningPolicyVersionResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.create_automated_reasoning_policy_version
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.create_automated_reasoning_policy_version.async_create_automated_reasoning_policy_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_automated_reasoning_policy_build_workflow(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.delete_automated_reasoning_policy_build_workflow_request.DeleteAutomatedReasoningPolicyBuildWorkflowRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.delete_automated_reasoning_policy_build_workflow_response.DeleteAutomatedReasoningPolicyBuildWorkflowResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.delete_automated_reasoning_policy_build_workflow
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.delete_automated_reasoning_policy_build_workflow.async_delete_automated_reasoning_policy_build_workflow(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_automated_reasoning_policy_test_case(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.delete_automated_reasoning_policy_test_case_request.DeleteAutomatedReasoningPolicyTestCaseRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.delete_automated_reasoning_policy_test_case_response.DeleteAutomatedReasoningPolicyTestCaseResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.delete_automated_reasoning_policy_test_case
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.delete_automated_reasoning_policy_test_case.async_delete_automated_reasoning_policy_test_case(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def export_automated_reasoning_policy_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.export_automated_reasoning_policy_version_request.ExportAutomatedReasoningPolicyVersionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.export_automated_reasoning_policy_version_response.ExportAutomatedReasoningPolicyVersionResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.export_automated_reasoning_policy_version
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.export_automated_reasoning_policy_version.async_export_automated_reasoning_policy_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_automated_reasoning_policy_annotations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.get_automated_reasoning_policy_annotations_request.GetAutomatedReasoningPolicyAnnotationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.get_automated_reasoning_policy_annotations_response.GetAutomatedReasoningPolicyAnnotationsResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_annotations
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_annotations.async_get_automated_reasoning_policy_annotations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_automated_reasoning_policy_build_workflow(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.get_automated_reasoning_policy_build_workflow_request.GetAutomatedReasoningPolicyBuildWorkflowRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.get_automated_reasoning_policy_build_workflow_response.GetAutomatedReasoningPolicyBuildWorkflowResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_build_workflow
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_build_workflow.async_get_automated_reasoning_policy_build_workflow(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_automated_reasoning_policy_build_workflow_result_assets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.get_automated_reasoning_policy_build_workflow_result_assets_request.GetAutomatedReasoningPolicyBuildWorkflowResultAssetsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.get_automated_reasoning_policy_build_workflow_result_assets_response.GetAutomatedReasoningPolicyBuildWorkflowResultAssetsResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_build_workflow_result_assets
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_build_workflow_result_assets.async_get_automated_reasoning_policy_build_workflow_result_assets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_automated_reasoning_policy_next_scenario(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.get_automated_reasoning_policy_next_scenario_request.GetAutomatedReasoningPolicyNextScenarioRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.get_automated_reasoning_policy_next_scenario_response.GetAutomatedReasoningPolicyNextScenarioResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_next_scenario
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_next_scenario.async_get_automated_reasoning_policy_next_scenario(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_automated_reasoning_policy_test_case(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.get_automated_reasoning_policy_test_case_request.GetAutomatedReasoningPolicyTestCaseRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.get_automated_reasoning_policy_test_case_response.GetAutomatedReasoningPolicyTestCaseResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_test_case
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_test_case.async_get_automated_reasoning_policy_test_case(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_automated_reasoning_policy_test_result(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.get_automated_reasoning_policy_test_result_request.GetAutomatedReasoningPolicyTestResultRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.get_automated_reasoning_policy_test_result_response.GetAutomatedReasoningPolicyTestResultResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_test_result
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.get_automated_reasoning_policy_test_result.async_get_automated_reasoning_policy_test_result(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_automated_reasoning_policy_build_workflows(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.list_automated_reasoning_policy_build_workflows_request.ListAutomatedReasoningPolicyBuildWorkflowsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.list_automated_reasoning_policy_build_workflows_response.ListAutomatedReasoningPolicyBuildWorkflowsResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policy_build_workflows
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policy_build_workflows.async_list_automated_reasoning_policy_build_workflows(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_automated_reasoning_policy_test_cases(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.list_automated_reasoning_policy_test_cases_request.ListAutomatedReasoningPolicyTestCasesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.list_automated_reasoning_policy_test_cases_response.ListAutomatedReasoningPolicyTestCasesResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policy_test_cases
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policy_test_cases.async_list_automated_reasoning_policy_test_cases(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_automated_reasoning_policy_test_results(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.list_automated_reasoning_policy_test_results_request.ListAutomatedReasoningPolicyTestResultsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.list_automated_reasoning_policy_test_results_response.ListAutomatedReasoningPolicyTestResultsResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policy_test_results
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.list_automated_reasoning_policy_test_results.async_list_automated_reasoning_policy_test_results(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_automated_reasoning_policy_build_workflow(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.start_automated_reasoning_policy_build_workflow_request.StartAutomatedReasoningPolicyBuildWorkflowRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.start_automated_reasoning_policy_build_workflow_response.StartAutomatedReasoningPolicyBuildWorkflowResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.start_automated_reasoning_policy_build_workflow
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.start_automated_reasoning_policy_build_workflow.async_start_automated_reasoning_policy_build_workflow(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_automated_reasoning_policy_test_workflow(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.start_automated_reasoning_policy_test_workflow_request.StartAutomatedReasoningPolicyTestWorkflowRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.start_automated_reasoning_policy_test_workflow_response.StartAutomatedReasoningPolicyTestWorkflowResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.start_automated_reasoning_policy_test_workflow
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.start_automated_reasoning_policy_test_workflow.async_start_automated_reasoning_policy_test_workflow(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_automated_reasoning_policy_annotations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.update_automated_reasoning_policy_annotations_request.UpdateAutomatedReasoningPolicyAnnotationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.update_automated_reasoning_policy_annotations_response.UpdateAutomatedReasoningPolicyAnnotationsResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.update_automated_reasoning_policy_annotations
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.update_automated_reasoning_policy_annotations.async_update_automated_reasoning_policy_annotations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_automated_reasoning_policy_test_case(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_bedrock.types.update_automated_reasoning_policy_test_case_request.UpdateAutomatedReasoningPolicyTestCaseRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_bedrock.types.update_automated_reasoning_policy_test_case_response.UpdateAutomatedReasoningPolicyTestCaseResponse"
        ]:
            import aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.update_automated_reasoning_policy_test_case
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_bedrock._operations.amazon_bedrock_control_plane_service.update_automated_reasoning_policy_test_case.async_update_automated_reasoning_policy_test_case(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
