...
class BedrockError(Exception):
    """Base class for all Bedrock service errors."""


class ServiceError(BedrockError):
...
class SerializationError(BedrockError):
    """Raised when a value cannot be serialized."""


class DeserializationError(BedrockError):
...
class WaiterFailedError(BedrockError):
...
class WaiterTimeoutError(BedrockError):
