...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.create_inference_profile_response.CreateInferenceProfileResponse = aws_sdk_bedrock.types.create_inference_profile_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.create_inference_profile_request.CreateInferenceProfileRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock.types.create_inference_profile_request.serialize_json(input_)
    ).encode()
