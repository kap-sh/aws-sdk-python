"""Generated from Smithy shape ``com.amazonaws.bedrock#StartAutomatedReasoningPolicyTestWorkflow``."""
...
if TYPE_CHECKING:
    import aws_sdk_bedrock.types.start_automated_reasoning_policy_test_workflow_request
    import aws_sdk_bedrock.types.start_automated_reasoning_policy_test_workflow_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            import aws_sdk_bedrock.errors.resource_in_use_exception

            raise aws_sdk_bedrock.errors.resource_in_use_exception.ResourceInUseException.from_json(
                data
            )
...
) -> aws_sdk_bedrock.types.start_automated_reasoning_policy_test_workflow_response.StartAutomatedReasoningPolicyTestWorkflowResponse:
    import aws_sdk_bedrock.types.start_automated_reasoning_policy_test_workflow_response

    out: aws_sdk_bedrock.types.start_automated_reasoning_policy_test_workflow_response.StartAutomatedReasoningPolicyTestWorkflowResponse = aws_sdk_bedrock.types.start_automated_reasoning_policy_test_workflow_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.start_automated_reasoning_policy_test_workflow_request.StartAutomatedReasoningPolicyTestWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock.types.start_automated_reasoning_policy_test_workflow_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_start_automated_reasoning_policy_test_workflow(
