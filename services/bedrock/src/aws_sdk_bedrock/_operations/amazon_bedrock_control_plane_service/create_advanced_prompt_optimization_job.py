"""Generated from Smithy shape ``com.amazonaws.bedrock#CreateAdvancedPromptOptimizationJob``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.create_advanced_prompt_optimization_job_response.CreateAdvancedPromptOptimizationJobResponse = aws_sdk_bedrock.types.create_advanced_prompt_optimization_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.create_advanced_prompt_optimization_job_request.CreateAdvancedPromptOptimizationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock.types.create_advanced_prompt_optimization_job_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_advanced_prompt_optimization_job(
