...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock.types.update_automated_reasoning_policy_test_case_response
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.update_automated_reasoning_policy_test_case_response.UpdateAutomatedReasoningPolicyTestCaseResponse = aws_sdk_bedrock.types.update_automated_reasoning_policy_test_case_response.deserialize_json(
