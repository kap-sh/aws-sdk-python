"""Generated from Smithy shape ``com.amazonaws.bedrock#ListModelInvocationJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.list_model_invocation_jobs_response.ListModelInvocationJobsResponse = aws_sdk_bedrock.types.list_model_invocation_jobs_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_bedrock.types.list_model_invocation_jobs_request.ListModelInvocationJobsRequest,
) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/model-invocation-jobs"
    params: dict[str, str] = {}
...
async def async_list_model_invocation_jobs(
