"""Generated from Smithy shape ``com.amazonaws.bedrock#ListAutomatedReasoningPolicyBuildWorkflows``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.list_automated_reasoning_policy_build_workflows_response.ListAutomatedReasoningPolicyBuildWorkflowsResponse = aws_sdk_bedrock.types.list_automated_reasoning_policy_build_workflows_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.list_automated_reasoning_policy_build_workflows_request.ListAutomatedReasoningPolicyBuildWorkflowsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_automated_reasoning_policy_build_workflows(
