"""Generated from Smithy shape ``com.amazonaws.bedrock#ListAutomatedReasoningPolicyTestCases``."""
...
if TYPE_CHECKING:
    import aws_sdk_bedrock.types.list_automated_reasoning_policy_test_cases_request
    import aws_sdk_bedrock.types.list_automated_reasoning_policy_test_cases_response
...
) -> aws_sdk_bedrock.types.list_automated_reasoning_policy_test_cases_response.ListAutomatedReasoningPolicyTestCasesResponse:
    import aws_sdk_bedrock.types.list_automated_reasoning_policy_test_cases_response

    out: aws_sdk_bedrock.types.list_automated_reasoning_policy_test_cases_response.ListAutomatedReasoningPolicyTestCasesResponse = aws_sdk_bedrock.types.list_automated_reasoning_policy_test_cases_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.list_automated_reasoning_policy_test_cases_request.ListAutomatedReasoningPolicyTestCasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_automated_reasoning_policy_test_cases(
