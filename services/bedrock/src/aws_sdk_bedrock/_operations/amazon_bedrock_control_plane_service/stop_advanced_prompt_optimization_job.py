"""Generated from Smithy shape ``com.amazonaws.bedrock#StopAdvancedPromptOptimizationJob``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.stop_advanced_prompt_optimization_job_response.StopAdvancedPromptOptimizationJobResponse = {}  # type: ignore[typeddict-item]
    return out
