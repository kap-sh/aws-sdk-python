...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.delete_marketplace_model_endpoint_response.DeleteMarketplaceModelEndpointResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.delete_marketplace_model_endpoint_request.DeleteMarketplaceModelEndpointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
