...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.create_model_customization_job_response.CreateModelCustomizationJobResponse = aws_sdk_bedrock.types.create_model_customization_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.create_model_customization_job_request.CreateModelCustomizationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock.types.create_model_customization_job_request.serialize_json(
            input_
        )
    ).encode()
