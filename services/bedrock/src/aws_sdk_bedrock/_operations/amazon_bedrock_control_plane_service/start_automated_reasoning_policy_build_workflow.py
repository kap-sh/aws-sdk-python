"""Generated from Smithy shape ``com.amazonaws.bedrock#StartAutomatedReasoningPolicyBuildWorkflow``."""
...
if TYPE_CHECKING:
    import aws_sdk_bedrock.types.start_automated_reasoning_policy_build_workflow_request
    import aws_sdk_bedrock.types.start_automated_reasoning_policy_build_workflow_response
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.start_automated_reasoning_policy_build_workflow_response.StartAutomatedReasoningPolicyBuildWorkflowResponse = aws_sdk_bedrock.types.start_automated_reasoning_policy_build_workflow_response.deserialize_json(
