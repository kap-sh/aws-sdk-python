"""Generated from Smithy shape ``com.amazonaws.bedrock#CreateAutomatedReasoningPolicyTestCase``."""
...
import aws_sdk_bedrock.types.create_automated_reasoning_policy_test_case_response
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.create_automated_reasoning_policy_test_case_response.CreateAutomatedReasoningPolicyTestCaseResponse = aws_sdk_bedrock.types.create_automated_reasoning_policy_test_case_response.deserialize_json(
