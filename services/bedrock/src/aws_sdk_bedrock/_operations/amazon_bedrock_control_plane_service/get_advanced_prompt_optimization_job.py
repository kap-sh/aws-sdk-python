"""Generated from Smithy shape ``com.amazonaws.bedrock#GetAdvancedPromptOptimizationJob``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_advanced_prompt_optimization_job_response.GetAdvancedPromptOptimizationJobResponse = aws_sdk_bedrock.types.get_advanced_prompt_optimization_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.get_advanced_prompt_optimization_job_request.GetAdvancedPromptOptimizationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = (
        endpoint.url.rstrip("/") + "/advanced-prompt-optimization-jobs/{jobIdentifier}"
    )
...
async def async_get_advanced_prompt_optimization_job(
