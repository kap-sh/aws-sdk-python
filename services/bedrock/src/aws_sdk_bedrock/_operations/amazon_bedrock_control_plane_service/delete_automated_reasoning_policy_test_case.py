...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.delete_automated_reasoning_policy_test_case_response.DeleteAutomatedReasoningPolicyTestCaseResponse = {}  # type: ignore[typeddict-item]
    return out
