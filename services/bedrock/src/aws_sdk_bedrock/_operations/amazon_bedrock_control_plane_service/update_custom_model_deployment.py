...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.update_custom_model_deployment_response.UpdateCustomModelDeploymentResponse = aws_sdk_bedrock.types.update_custom_model_deployment_response.deserialize_json(
