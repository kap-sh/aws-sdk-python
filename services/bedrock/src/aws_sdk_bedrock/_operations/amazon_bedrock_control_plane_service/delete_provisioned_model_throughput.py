"""Generated from Smithy shape ``com.amazonaws.bedrock#DeleteProvisionedModelThroughput``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.delete_provisioned_model_throughput_response.DeleteProvisionedModelThroughputResponse = {}  # type: ignore[typeddict-item]
    return out
