"""Generated from Smithy shape ``com.amazonaws.bedrock#ListInferenceProfiles``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.list_inference_profiles_response.ListInferenceProfilesResponse = aws_sdk_bedrock.types.list_inference_profiles_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.list_inference_profiles_request.ListInferenceProfilesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "type_equals" in input_:
        params["type"] = str(input_["type_equals"])
