"""Generated from Smithy shape ``com.amazonaws.bedrock#ListModelImportJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.list_model_import_jobs_response.ListModelImportJobsResponse = aws_sdk_bedrock.types.list_model_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.list_model_import_jobs_request.ListModelImportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_model_import_jobs(
