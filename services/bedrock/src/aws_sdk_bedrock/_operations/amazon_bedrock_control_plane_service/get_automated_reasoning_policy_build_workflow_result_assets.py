"""Generated from Smithy shape ``com.amazonaws.bedrock#GetAutomatedReasoningPolicyBuildWorkflowResultAssets``."""
...
import aws_sdk_bedrock.types.automated_reasoning_policy_build_result_assets
import aws_sdk_bedrock.types.get_automated_reasoning_policy_build_workflow_result_assets_request
import aws_sdk_bedrock.types.get_automated_reasoning_policy_build_workflow_result_assets_response
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_automated_reasoning_policy_build_workflow_result_assets_response.GetAutomatedReasoningPolicyBuildWorkflowResultAssetsResponse = aws_sdk_bedrock.types.get_automated_reasoning_policy_build_workflow_result_assets_response.deserialize_json(
