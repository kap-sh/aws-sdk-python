...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.list_foundation_model_agreement_offers_response.ListFoundationModelAgreementOffersResponse = aws_sdk_bedrock.types.list_foundation_model_agreement_offers_response.deserialize_json(
