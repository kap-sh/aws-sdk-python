"""Generated from Smithy shape ``com.amazonaws.bedrock#ListModelCustomizationJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.list_model_customization_jobs_response.ListModelCustomizationJobsResponse = aws_sdk_bedrock.types.list_model_customization_jobs_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.list_model_customization_jobs_request.ListModelCustomizationJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_list_model_customization_jobs(
