"""Generated from Smithy shape ``com.amazonaws.bedrock#ListPromptRouters``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.list_prompt_routers_response.ListPromptRoutersResponse = aws_sdk_bedrock.types.list_prompt_routers_response.deserialize_json(
