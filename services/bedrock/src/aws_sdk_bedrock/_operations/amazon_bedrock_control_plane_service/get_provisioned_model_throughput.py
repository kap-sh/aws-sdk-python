"""Generated from Smithy shape ``com.amazonaws.bedrock#GetProvisionedModelThroughput``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_provisioned_model_throughput_response.GetProvisionedModelThroughputResponse = aws_sdk_bedrock.types.get_provisioned_model_throughput_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.get_provisioned_model_throughput_request.GetProvisionedModelThroughputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_provisioned_model_throughput(
