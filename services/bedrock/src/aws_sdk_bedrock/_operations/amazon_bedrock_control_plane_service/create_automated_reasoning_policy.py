"""Generated from Smithy shape ``com.amazonaws.bedrock#CreateAutomatedReasoningPolicy``."""
...
if TYPE_CHECKING:
    import aws_sdk_bedrock.types.create_automated_reasoning_policy_request
    import aws_sdk_bedrock.types.create_automated_reasoning_policy_response
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.create_automated_reasoning_policy_response.CreateAutomatedReasoningPolicyResponse = aws_sdk_bedrock.types.create_automated_reasoning_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/automated-reasoning-policies"
    params: dict[str, str] = {}
