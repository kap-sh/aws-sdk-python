...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_foundation_model_response.GetFoundationModelResponse = aws_sdk_bedrock.types.get_foundation_model_response.deserialize_json(
