"""Generated from Smithy shape ``com.amazonaws.bedrock#GetImportedModel``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_imported_model_response.GetImportedModelResponse = (
        aws_sdk_bedrock.types.get_imported_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.get_imported_model_request.GetImportedModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_imported_model(
