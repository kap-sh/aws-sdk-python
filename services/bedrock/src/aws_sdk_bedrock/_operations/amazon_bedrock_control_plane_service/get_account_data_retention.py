"""Generated from Smithy shape ``com.amazonaws.bedrock#GetAccountDataRetention``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_account_data_retention_response.GetAccountDataRetentionResponse = aws_sdk_bedrock.types.get_account_data_retention_response.deserialize_json(
