...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.delete_imported_model_response.DeleteImportedModelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.delete_imported_model_request.DeleteImportedModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
