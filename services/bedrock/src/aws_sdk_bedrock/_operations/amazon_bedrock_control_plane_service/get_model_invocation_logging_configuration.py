"""Generated from Smithy shape ``com.amazonaws.bedrock#GetModelInvocationLoggingConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_model_invocation_logging_configuration_response.GetModelInvocationLoggingConfigurationResponse = aws_sdk_bedrock.types.get_model_invocation_logging_configuration_response.deserialize_json(
