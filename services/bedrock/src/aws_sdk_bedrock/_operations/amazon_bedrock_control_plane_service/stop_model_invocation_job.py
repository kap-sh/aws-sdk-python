...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.stop_model_invocation_job_response.StopModelInvocationJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.stop_model_invocation_job_request.StopModelInvocationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/model-invocation-job/{jobIdentifier}/stop"
...
async def async_stop_model_invocation_job(
