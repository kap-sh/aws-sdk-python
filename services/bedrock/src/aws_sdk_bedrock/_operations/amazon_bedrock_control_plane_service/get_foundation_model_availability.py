"""Generated from Smithy shape ``com.amazonaws.bedrock#GetFoundationModelAvailability``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_foundation_model_availability_response.GetFoundationModelAvailabilityResponse = aws_sdk_bedrock.types.get_foundation_model_availability_response.deserialize_json(
