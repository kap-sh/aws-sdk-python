"""Generated from Smithy shape ``com.amazonaws.bedrock#GetUseCaseForModelAccess``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_use_case_for_model_access_response.GetUseCaseForModelAccessResponse = aws_sdk_bedrock.types.get_use_case_for_model_access_response.deserialize_json(
