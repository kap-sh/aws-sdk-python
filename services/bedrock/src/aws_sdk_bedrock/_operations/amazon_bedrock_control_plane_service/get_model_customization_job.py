...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_model_customization_job_response.GetModelCustomizationJobResponse = aws_sdk_bedrock.types.get_model_customization_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.get_model_customization_job_request.GetModelCustomizationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
