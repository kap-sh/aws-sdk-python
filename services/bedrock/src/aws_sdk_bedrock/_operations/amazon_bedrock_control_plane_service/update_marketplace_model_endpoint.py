...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.update_marketplace_model_endpoint_response.UpdateMarketplaceModelEndpointResponse = aws_sdk_bedrock.types.update_marketplace_model_endpoint_response.deserialize_json(
