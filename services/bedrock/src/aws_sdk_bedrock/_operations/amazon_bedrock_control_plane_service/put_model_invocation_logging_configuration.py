...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.put_model_invocation_logging_configuration_response.PutModelInvocationLoggingConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
