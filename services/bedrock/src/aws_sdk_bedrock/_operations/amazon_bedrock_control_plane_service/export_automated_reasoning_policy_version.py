"""Generated from Smithy shape ``com.amazonaws.bedrock#ExportAutomatedReasoningPolicyVersion``."""
...
if TYPE_CHECKING:
    import aws_sdk_bedrock.types.export_automated_reasoning_policy_version_request
    import aws_sdk_bedrock.types.export_automated_reasoning_policy_version_response
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.export_automated_reasoning_policy_version_response.ExportAutomatedReasoningPolicyVersionResponse = {
        "policy_definition": aws_sdk_bedrock.types.automated_reasoning_policy_definition.deserialize_json(
