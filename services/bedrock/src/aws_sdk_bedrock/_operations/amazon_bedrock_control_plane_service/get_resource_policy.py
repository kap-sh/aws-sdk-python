"""Generated from Smithy shape ``com.amazonaws.bedrock#GetResourcePolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_resource_policy_response.GetResourcePolicyResponse = aws_sdk_bedrock.types.get_resource_policy_response.deserialize_json(
