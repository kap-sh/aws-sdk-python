"""Generated from Smithy shape ``com.amazonaws.bedrock#GetModelCopyJob``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_model_copy_job_response.GetModelCopyJobResponse = (
        aws_sdk_bedrock.types.get_model_copy_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.get_model_copy_job_request.GetModelCopyJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/model-copy-jobs/{jobArn}"
...
async def async_get_model_copy_job(
