"""Generated from Smithy shape ``com.amazonaws.bedrock#UpdateAutomatedReasoningPolicy``."""
...
if TYPE_CHECKING:
    import aws_sdk_bedrock.types.update_automated_reasoning_policy_request
    import aws_sdk_bedrock.types.update_automated_reasoning_policy_response
...
) -> aws_sdk_bedrock.types.update_automated_reasoning_policy_response.UpdateAutomatedReasoningPolicyResponse:
    import aws_sdk_bedrock.types.update_automated_reasoning_policy_response

    out: aws_sdk_bedrock.types.update_automated_reasoning_policy_response.UpdateAutomatedReasoningPolicyResponse = aws_sdk_bedrock.types.update_automated_reasoning_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.update_automated_reasoning_policy_request.UpdateAutomatedReasoningPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock.types.update_automated_reasoning_policy_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_automated_reasoning_policy(
