...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_custom_model_response.GetCustomModelResponse = (
        aws_sdk_bedrock.types.get_custom_model_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.get_custom_model_request.GetCustomModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
