...
def build_request(
    ...
    input: aws_sdk_bedrock.types.create_model_import_job_request.CreateModelImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock.types.create_model_import_job_request.serialize_json(input)
    ).encode()
