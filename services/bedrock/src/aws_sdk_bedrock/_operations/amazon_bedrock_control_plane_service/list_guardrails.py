...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.list_guardrails_response.ListGuardrailsResponse = (
        aws_sdk_bedrock.types.list_guardrails_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_bedrock.types.list_guardrails_request.ListGuardrailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "guardrail_identifier" in input:
        params["guardrailIdentifier"] = str(input["guardrail_identifier"])
