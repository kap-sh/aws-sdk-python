"""Generated from Smithy shape ``com.amazonaws.bedrock#ListEnforcedGuardrailsConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.list_enforced_guardrails_configuration_response.ListEnforcedGuardrailsConfigurationResponse = aws_sdk_bedrock.types.list_enforced_guardrails_configuration_response.deserialize_json(
