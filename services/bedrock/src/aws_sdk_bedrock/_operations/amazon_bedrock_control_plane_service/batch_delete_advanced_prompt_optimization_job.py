...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.batch_delete_advanced_prompt_optimization_job_response.BatchDeleteAdvancedPromptOptimizationJobResponse = aws_sdk_bedrock.types.batch_delete_advanced_prompt_optimization_job_response.deserialize_json(
