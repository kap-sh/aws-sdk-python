"""Generated from Smithy shape ``com.amazonaws.bedrock#StopModelCustomizationJob``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.stop_model_customization_job_response.StopModelCustomizationJobResponse = {}  # type: ignore[typeddict-item]
    return out
