"""Generated from Smithy shape ``com.amazonaws.bedrock#RegisterMarketplaceModelEndpoint``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceUnavailableException":
            import aws_sdk_bedrock.errors.service_unavailable_exception

            raise aws_sdk_bedrock.errors.service_unavailable_exception.ServiceUnavailableException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.register_marketplace_model_endpoint_response.RegisterMarketplaceModelEndpointResponse = aws_sdk_bedrock.types.register_marketplace_model_endpoint_response.deserialize_json(
