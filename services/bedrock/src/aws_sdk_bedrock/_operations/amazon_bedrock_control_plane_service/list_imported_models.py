"""Generated from Smithy shape ``com.amazonaws.bedrock#ListImportedModels``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.list_imported_models_response.ListImportedModelsResponse = aws_sdk_bedrock.types.list_imported_models_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.list_imported_models_request.ListImportedModelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/imported-models"
    params: dict[str, str] = {}
...
async def async_list_imported_models(
