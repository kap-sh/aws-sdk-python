"""Generated from Smithy shape ``com.amazonaws.bedrock#UpdateAutomatedReasoningPolicyAnnotations``."""
...
import aws_sdk_bedrock.types.update_automated_reasoning_policy_annotations_request
import aws_sdk_bedrock.types.update_automated_reasoning_policy_annotations_response
...
) -> aws_sdk_bedrock.types.update_automated_reasoning_policy_annotations_response.UpdateAutomatedReasoningPolicyAnnotationsResponse:
    out: aws_sdk_bedrock.types.update_automated_reasoning_policy_annotations_response.UpdateAutomatedReasoningPolicyAnnotationsResponse = aws_sdk_bedrock.types.update_automated_reasoning_policy_annotations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.update_automated_reasoning_policy_annotations_request.UpdateAutomatedReasoningPolicyAnnotationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock.types.update_automated_reasoning_policy_annotations_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_automated_reasoning_policy_annotations(
