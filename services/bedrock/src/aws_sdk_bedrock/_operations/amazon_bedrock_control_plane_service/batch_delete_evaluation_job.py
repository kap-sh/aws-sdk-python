"""Generated from Smithy shape ``com.amazonaws.bedrock#BatchDeleteEvaluationJob``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.batch_delete_evaluation_job_response.BatchDeleteEvaluationJobResponse = aws_sdk_bedrock.types.batch_delete_evaluation_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.batch_delete_evaluation_job_request.BatchDeleteEvaluationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/evaluation-jobs/batch-delete"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_bedrock.types.batch_delete_evaluation_job_request

    body: bytes | None = json.dumps(
        aws_sdk_bedrock.types.batch_delete_evaluation_job_request.serialize_json(input_)
    ).encode()
...
async def async_batch_delete_evaluation_job(
