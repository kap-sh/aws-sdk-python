...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_model_invocation_job_response.GetModelInvocationJobResponse = aws_sdk_bedrock.types.get_model_invocation_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.get_model_invocation_job_request.GetModelInvocationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
