"""Generated from Smithy shape ``com.amazonaws.bedrock#CreatePromptRouter``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.create_prompt_router_response.CreatePromptRouterResponse = aws_sdk_bedrock.types.create_prompt_router_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.create_prompt_router_request.CreatePromptRouterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock.types.create_prompt_router_request.serialize_json(input_)
    ).encode()
...
async def async_create_prompt_router(
