...
def build_request(
    ...
    input: aws_sdk_bedrock.types.create_prompt_router_request.CreatePromptRouterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock.types.create_prompt_router_request.serialize_json(input)
    ).encode()
