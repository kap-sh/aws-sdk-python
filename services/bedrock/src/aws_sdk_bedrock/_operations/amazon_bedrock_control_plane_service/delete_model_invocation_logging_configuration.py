...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.delete_model_invocation_logging_configuration_response.DeleteModelInvocationLoggingConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
