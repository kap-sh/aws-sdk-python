"""Generated from Smithy shape ``com.amazonaws.bedrock#DeleteEnforcedGuardrailConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.delete_enforced_guardrail_configuration_response.DeleteEnforcedGuardrailConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.delete_enforced_guardrail_configuration_request.DeleteEnforcedGuardrailConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/enforcedGuardrailsConfiguration/{configId}"
...
async def async_delete_enforced_guardrail_configuration(
