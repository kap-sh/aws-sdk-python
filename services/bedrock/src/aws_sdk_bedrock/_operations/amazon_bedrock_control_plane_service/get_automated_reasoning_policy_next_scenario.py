"""Generated from Smithy shape ``com.amazonaws.bedrock#GetAutomatedReasoningPolicyNextScenario``."""
...
if TYPE_CHECKING:
    import aws_sdk_bedrock.types.get_automated_reasoning_policy_next_scenario_request
    import aws_sdk_bedrock.types.get_automated_reasoning_policy_next_scenario_response
...
) -> aws_sdk_bedrock.types.get_automated_reasoning_policy_next_scenario_response.GetAutomatedReasoningPolicyNextScenarioResponse:
    import aws_sdk_bedrock.types.get_automated_reasoning_policy_next_scenario_response

    out: aws_sdk_bedrock.types.get_automated_reasoning_policy_next_scenario_response.GetAutomatedReasoningPolicyNextScenarioResponse = aws_sdk_bedrock.types.get_automated_reasoning_policy_next_scenario_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.get_automated_reasoning_policy_next_scenario_request.GetAutomatedReasoningPolicyNextScenarioRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_automated_reasoning_policy_next_scenario(
