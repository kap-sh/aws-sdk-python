...
import aws_sdk_bedrock.types.automated_reasoning_policy_summaries
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.list_automated_reasoning_policies_response.ListAutomatedReasoningPoliciesResponse = aws_sdk_bedrock.types.list_automated_reasoning_policies_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.list_automated_reasoning_policies_request.ListAutomatedReasoningPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
