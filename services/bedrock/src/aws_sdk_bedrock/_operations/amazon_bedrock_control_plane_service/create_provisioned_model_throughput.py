...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.create_provisioned_model_throughput_response.CreateProvisionedModelThroughputResponse = aws_sdk_bedrock.types.create_provisioned_model_throughput_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.create_provisioned_model_throughput_request.CreateProvisionedModelThroughputRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
