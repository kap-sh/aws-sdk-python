...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.put_account_data_retention_response.PutAccountDataRetentionResponse = aws_sdk_bedrock.types.put_account_data_retention_response.deserialize_json(
