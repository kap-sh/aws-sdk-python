...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.list_evaluation_jobs_response.ListEvaluationJobsResponse = aws_sdk_bedrock.types.list_evaluation_jobs_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_bedrock.types.list_evaluation_jobs_request.ListEvaluationJobsRequest,
) -> zapros.Request:
    ...
    if "application_type_equals" in input:
        params["applicationTypeEquals"] = str(input["application_type_equals"])
