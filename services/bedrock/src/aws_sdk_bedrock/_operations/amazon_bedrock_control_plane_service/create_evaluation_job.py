...
def build_request(
    ...
    input: aws_sdk_bedrock.types.create_evaluation_job_request.CreateEvaluationJobRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock.types.create_evaluation_job_request.serialize_json(input)
    ).encode()
