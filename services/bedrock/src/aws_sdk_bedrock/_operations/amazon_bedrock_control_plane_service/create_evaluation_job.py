...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.create_evaluation_job_response.CreateEvaluationJobResponse = aws_sdk_bedrock.types.create_evaluation_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.create_evaluation_job_request.CreateEvaluationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock.types.create_evaluation_job_request.serialize_json(input_)
    ).encode()
