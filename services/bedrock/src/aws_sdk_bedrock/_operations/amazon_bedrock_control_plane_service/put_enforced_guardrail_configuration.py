...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.put_enforced_guardrail_configuration_response.PutEnforcedGuardrailConfigurationResponse = aws_sdk_bedrock.types.put_enforced_guardrail_configuration_response.deserialize_json(
