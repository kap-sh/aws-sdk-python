...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_model_import_job_response.GetModelImportJobResponse = aws_sdk_bedrock.types.get_model_import_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.get_model_import_job_request.GetModelImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
