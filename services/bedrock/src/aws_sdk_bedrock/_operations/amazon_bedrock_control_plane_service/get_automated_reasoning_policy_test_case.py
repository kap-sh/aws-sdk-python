"""Generated from Smithy shape ``com.amazonaws.bedrock#GetAutomatedReasoningPolicyTestCase``."""
...
if TYPE_CHECKING:
    import aws_sdk_bedrock.types.get_automated_reasoning_policy_test_case_request
    import aws_sdk_bedrock.types.get_automated_reasoning_policy_test_case_response
...
) -> aws_sdk_bedrock.types.get_automated_reasoning_policy_test_case_response.GetAutomatedReasoningPolicyTestCaseResponse:
    import aws_sdk_bedrock.types.get_automated_reasoning_policy_test_case_response

    out: aws_sdk_bedrock.types.get_automated_reasoning_policy_test_case_response.GetAutomatedReasoningPolicyTestCaseResponse = aws_sdk_bedrock.types.get_automated_reasoning_policy_test_case_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.get_automated_reasoning_policy_test_case_request.GetAutomatedReasoningPolicyTestCaseRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_automated_reasoning_policy_test_case(
