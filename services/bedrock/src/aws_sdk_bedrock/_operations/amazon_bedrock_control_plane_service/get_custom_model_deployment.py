"""Generated from Smithy shape ``com.amazonaws.bedrock#GetCustomModelDeployment``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_custom_model_deployment_response.GetCustomModelDeploymentResponse = aws_sdk_bedrock.types.get_custom_model_deployment_response.deserialize_json(
