...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.create_model_invocation_job_response.CreateModelInvocationJobResponse = aws_sdk_bedrock.types.create_model_invocation_job_response.deserialize_json(
