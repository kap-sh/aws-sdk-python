"""Generated from Smithy shape ``com.amazonaws.bedrock#DeleteAutomatedReasoningPolicy``."""
...
if TYPE_CHECKING:
    import aws_sdk_bedrock.types.delete_automated_reasoning_policy_request
    import aws_sdk_bedrock.types.delete_automated_reasoning_policy_response
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.delete_automated_reasoning_policy_response.DeleteAutomatedReasoningPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
