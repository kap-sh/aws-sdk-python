...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_marketplace_model_endpoint_response.GetMarketplaceModelEndpointResponse = aws_sdk_bedrock.types.get_marketplace_model_endpoint_response.deserialize_json(
