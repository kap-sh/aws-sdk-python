"""Generated from Smithy shape ``com.amazonaws.bedrock#GetAutomatedReasoningPolicyAnnotations``."""
...
if TYPE_CHECKING:
    import aws_sdk_bedrock.types.get_automated_reasoning_policy_annotations_request
    import aws_sdk_bedrock.types.get_automated_reasoning_policy_annotations_response
...
) -> aws_sdk_bedrock.types.get_automated_reasoning_policy_annotations_response.GetAutomatedReasoningPolicyAnnotationsResponse:
    import aws_sdk_bedrock.types.get_automated_reasoning_policy_annotations_response

    out: aws_sdk_bedrock.types.get_automated_reasoning_policy_annotations_response.GetAutomatedReasoningPolicyAnnotationsResponse = aws_sdk_bedrock.types.get_automated_reasoning_policy_annotations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.get_automated_reasoning_policy_annotations_request.GetAutomatedReasoningPolicyAnnotationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_automated_reasoning_policy_annotations(
