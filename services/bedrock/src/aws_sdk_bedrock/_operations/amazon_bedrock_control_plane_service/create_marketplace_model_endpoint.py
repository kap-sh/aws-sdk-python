"""Generated from Smithy shape ``com.amazonaws.bedrock#CreateMarketplaceModelEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.create_marketplace_model_endpoint_response.CreateMarketplaceModelEndpointResponse = aws_sdk_bedrock.types.create_marketplace_model_endpoint_response.deserialize_json(
