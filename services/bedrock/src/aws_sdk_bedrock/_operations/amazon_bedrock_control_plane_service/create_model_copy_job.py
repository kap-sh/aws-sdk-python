"""Generated from Smithy shape ``com.amazonaws.bedrock#CreateModelCopyJob``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.create_model_copy_job_response.CreateModelCopyJobResponse = aws_sdk_bedrock.types.create_model_copy_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.create_model_copy_job_request.CreateModelCopyJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_bedrock.types.create_model_copy_job_request.serialize_json(input_)
    ).encode()
...
async def async_create_model_copy_job(
