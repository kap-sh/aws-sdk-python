"""Generated from Smithy shape ``com.amazonaws.bedrock#GetAutomatedReasoningPolicyTestResult``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_automated_reasoning_policy_test_result_response.GetAutomatedReasoningPolicyTestResultResponse = aws_sdk_bedrock.types.get_automated_reasoning_policy_test_result_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.get_automated_reasoning_policy_test_result_request.GetAutomatedReasoningPolicyTestResultRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_get_automated_reasoning_policy_test_result(
