...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.stop_evaluation_job_response.StopEvaluationJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.stop_evaluation_job_request.StopEvaluationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
