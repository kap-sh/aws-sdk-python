...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_prompt_router_response.GetPromptRouterResponse = (
        aws_sdk_bedrock.types.get_prompt_router_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.get_prompt_router_request.GetPromptRouterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
