"""Generated from Smithy shape ``com.amazonaws.bedrock#ListMarketplaceModelEndpoints``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.list_marketplace_model_endpoints_response.ListMarketplaceModelEndpointsResponse = aws_sdk_bedrock.types.list_marketplace_model_endpoints_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.list_marketplace_model_endpoints_request.ListMarketplaceModelEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/marketplace-model/endpoints"
    params: dict[str, str] = {}
    if "max_results" in input_:
        params["maxResults"] = str(input_["max_results"])
    if "next_token" in input_:
        params["nextToken"] = str(input_["next_token"])
    if "model_source_equals" in input_:
        params["modelSourceIdentifier"] = str(input_["model_source_equals"])
...
async def async_list_marketplace_model_endpoints(
