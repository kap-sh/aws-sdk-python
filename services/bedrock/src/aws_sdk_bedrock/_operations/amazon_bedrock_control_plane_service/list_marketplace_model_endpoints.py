...
def build_request(
    ...
    input: aws_sdk_bedrock.types.list_marketplace_model_endpoints_request.ListMarketplaceModelEndpointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "model_source_equals" in input:
        params["modelSourceIdentifier"] = str(input["model_source_equals"])
