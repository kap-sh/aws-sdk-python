"""Generated from Smithy shape ``com.amazonaws.bedrock#DeleteCustomModelDeployment``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.delete_custom_model_deployment_response.DeleteCustomModelDeploymentResponse = {}  # type: ignore[typeddict-item]
    return out
