...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.create_foundation_model_agreement_response.CreateFoundationModelAgreementResponse = aws_sdk_bedrock.types.create_foundation_model_agreement_response.deserialize_json(
