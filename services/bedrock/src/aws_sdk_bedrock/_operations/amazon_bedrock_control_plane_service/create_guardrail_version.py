...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.create_guardrail_version_response.CreateGuardrailVersionResponse = aws_sdk_bedrock.types.create_guardrail_version_response.deserialize_json(
