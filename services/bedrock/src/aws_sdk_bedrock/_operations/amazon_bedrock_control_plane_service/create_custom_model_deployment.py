...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.create_custom_model_deployment_response.CreateCustomModelDeploymentResponse = aws_sdk_bedrock.types.create_custom_model_deployment_response.deserialize_json(
