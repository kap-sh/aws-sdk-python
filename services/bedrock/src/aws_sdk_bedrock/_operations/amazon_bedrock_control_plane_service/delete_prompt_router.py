"""Generated from Smithy shape ``com.amazonaws.bedrock#DeletePromptRouter``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.delete_prompt_router_response.DeletePromptRouterResponse = {}  # type: ignore[typeddict-item]
    return out
