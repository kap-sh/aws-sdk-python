"""Generated from Smithy shape ``com.amazonaws.bedrock#DeleteInferenceProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.delete_inference_profile_response.DeleteInferenceProfileResponse = {}  # type: ignore[typeddict-item]
    return out
