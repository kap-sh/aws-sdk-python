"""Generated from Smithy shape ``com.amazonaws.bedrock#GetInferenceProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_inference_profile_response.GetInferenceProfileResponse = aws_sdk_bedrock.types.get_inference_profile_response.deserialize_json(
