"""Generated from Smithy shape ``com.amazonaws.bedrock#GetEvaluationJob``."""
...
def handle_response(
    ...
    out: aws_sdk_bedrock.types.get_evaluation_job_response.GetEvaluationJobResponse = (
        aws_sdk_bedrock.types.get_evaluation_job_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.get_evaluation_job_request.GetEvaluationJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/evaluation-jobs/{jobIdentifier}"
...
async def async_get_evaluation_job(
