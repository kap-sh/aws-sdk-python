...
import aws_sdk_bedrock.types.get_automated_reasoning_policy_request
import aws_sdk_bedrock.types.get_automated_reasoning_policy_response
...
) -> aws_sdk_bedrock.types.get_automated_reasoning_policy_response.GetAutomatedReasoningPolicyResponse:
    out: aws_sdk_bedrock.types.get_automated_reasoning_policy_response.GetAutomatedReasoningPolicyResponse = aws_sdk_bedrock.types.get_automated_reasoning_policy_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_bedrock.types.get_automated_reasoning_policy_request.GetAutomatedReasoningPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
