...
class RFTConfig(TypedDict, closed=True):
    ...
    hyper_parameters: NotRequired[
        "aws_sdk_bedrock.types.rft_hyper_parameters.RFTHyperParameters"
    ]
...
def serialize_json(value: RFTConfig) -> dict:
    ...
    if "grader_config" in value:
        ...
        out["graderConfig"] = aws_sdk_bedrock.types.grader_config.serialize_json(
            value["grader_config"]
        )
    if "hyper_parameters" in value:
        ...
        out["hyperParameters"] = (
            aws_sdk_bedrock.types.rft_hyper_parameters.serialize_json(
...
def deserialize_json(data: dict) -> RFTConfig:
    ...
    if "graderConfig" in data:
        ...
        out["grader_config"] = aws_sdk_bedrock.types.grader_config.deserialize_json(
            data["graderConfig"]
        )
    if "hyperParameters" in data:
        ...
        out["hyper_parameters"] = (
            aws_sdk_bedrock.types.rft_hyper_parameters.deserialize_json(
