...
class CreateCustomModelRequest(TypedDict):
    ...
    model_tags: NotRequired["aws_sdk_bedrock.types.tag_list.TagList"]
...
def serialize_json(value: CreateCustomModelRequest) -> dict:
    ...
    if "model_source_config" in value:
        ...
        out["modelSourceConfig"] = (
            aws_sdk_bedrock.types.model_data_source.serialize_json(
    ...
    if "custom_model_data_source" in value:
        ...
        out["customModelDataSource"] = (
            aws_sdk_bedrock.types.custom_model_data_source.serialize_json(
    ...
    if "model_tags" in value:
        ...
        out["modelTags"] = aws_sdk_bedrock.types.tag_list.serialize_json(
            value["model_tags"]
        )
...
def deserialize_json(data: dict) -> CreateCustomModelRequest:
    ...
    if "customModelDataSource" in data:
        ...
        out["custom_model_data_source"] = (
            aws_sdk_bedrock.types.custom_model_data_source.deserialize_json(
    ...
    if "modelTags" in data:
        ...
        out["model_tags"] = aws_sdk_bedrock.types.tag_list.deserialize_json(
            data["modelTags"]
        )
