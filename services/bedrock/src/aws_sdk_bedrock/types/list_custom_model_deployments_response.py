...
class ListCustomModelDeploymentsResponse(TypedDict, closed=True):
    ...
    model_deployment_summaries: NotRequired[
        "aws_sdk_bedrock.types.custom_model_deployment_summary_list.CustomModelDeploymentSummaryList"
    ]
...
def serialize_json(value: ListCustomModelDeploymentsResponse) -> dict:
    ...
    if "model_deployment_summaries" in value:
        ...
        out["modelDeploymentSummaries"] = (
            aws_sdk_bedrock.types.custom_model_deployment_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListCustomModelDeploymentsResponse:
    ...
    if "modelDeploymentSummaries" in data:
        import aws_sdk_bedrock.types.custom_model_deployment_summary_list

        out["model_deployment_summaries"] = (
            aws_sdk_bedrock.types.custom_model_deployment_summary_list.deserialize_json(
