...
if TYPE_CHECKING:
    import aws_sdk_bedrock.types.offer_id
    import aws_sdk_bedrock.types.offer_token
    import aws_sdk_bedrock.types.term_details


class Offer(TypedDict):
    offer_id: NotRequired["aws_sdk_bedrock.types.offer_id.OfferId"]
    """<p>Offer Id for a model offer.</p>"""
    offer_token: "aws_sdk_bedrock.types.offer_token.OfferToken"
    """<p>Offer token.</p>"""
    term_details: "aws_sdk_bedrock.types.term_details.TermDetails"
...
def serialize_json(value: Offer) -> dict:
    ...
    out["termDetails"] = aws_sdk_bedrock.types.term_details.serialize_json(
        value["term_details"]
    )
    return out
...
def deserialize_json(data: dict) -> Offer:
    ...
    if "termDetails" in data:
        ...
        out["term_details"] = aws_sdk_bedrock.types.term_details.deserialize_json(
            data["termDetails"]
        )
    else:
