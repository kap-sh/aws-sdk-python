"""Generated from Smithy shape ``com.amazonaws.bedrock#GuardrailPiiEntityConfig``."""
...
# --- restJson1 ser/de ---
def serialize_json(value: GuardrailPiiEntityConfig) -> dict:
    out: dict = {}
    import aws_sdk_bedrock.types.guardrail_pii_entity_type
