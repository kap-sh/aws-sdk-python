...
class _AutomatedReasoningPolicyTypeValueAnnotation_updateTypeValue(TypedDict):
...
class _AutomatedReasoningPolicyTypeValueAnnotation_deleteTypeValue(TypedDict):
