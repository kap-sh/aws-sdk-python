...
if TYPE_CHECKING:
    import aws_sdk_bedrock.types.byte_content_blob
    import aws_sdk_bedrock.types.content_type
    import aws_sdk_bedrock.types.identifier


class ByteContentDoc(TypedDict):
    identifier: "aws_sdk_bedrock.types.identifier.Identifier"
    """<p>The file name of the document contained in the wrapper object.</p>"""
    content_type: "aws_sdk_bedrock.types.content_type.ContentType"
    """<p>The MIME type of the document contained in the wrapper object.</p>"""
    data: "aws_sdk_bedrock.types.byte_content_blob.ByteContentBlob"
...
def serialize_json(value: ByteContentDoc) -> dict:
    ...
    out["data"] = aws_sdk_bedrock.types.byte_content_blob.serialize_json(value["data"])
    return out
...
def deserialize_json(data: dict) -> ByteContentDoc:
    ...
    if "data" in data:
        ...
        out["data"] = aws_sdk_bedrock.types.byte_content_blob.deserialize_json(
            data["data"]
        )
    else:
