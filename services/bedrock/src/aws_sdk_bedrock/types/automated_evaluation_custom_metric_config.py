...
if TYPE_CHECKING:
    import aws_sdk_bedrock.types.automated_evaluation_custom_metrics
    import aws_sdk_bedrock.types.custom_metric_evaluator_model_config


class AutomatedEvaluationCustomMetricConfig(TypedDict):
    custom_metrics: "aws_sdk_bedrock.types.automated_evaluation_custom_metrics.AutomatedEvaluationCustomMetrics"
    """<p>Defines a list of custom metrics to be used in an Amazon Bedrock evaluation job.</p>"""
    evaluator_model_config: "aws_sdk_bedrock.types.custom_metric_evaluator_model_config.CustomMetricEvaluatorModelConfig"
...
def serialize_json(value: AutomatedEvaluationCustomMetricConfig) -> dict:
    ...
    out["customMetrics"] = (
        aws_sdk_bedrock.types.automated_evaluation_custom_metrics.serialize_json(
    ...
    out["evaluatorModelConfig"] = (
        aws_sdk_bedrock.types.custom_metric_evaluator_model_config.serialize_json(
...
def deserialize_json(data: dict) -> AutomatedEvaluationCustomMetricConfig:
    ...
    if "customMetrics" in data:
        ...
        out["custom_metrics"] = (
            aws_sdk_bedrock.types.automated_evaluation_custom_metrics.deserialize_json(
                data["customMetrics"]
            )
        )
    else:
    ...
    if "evaluatorModelConfig" in data:
        ...
        out["evaluator_model_config"] = (
            aws_sdk_bedrock.types.custom_metric_evaluator_model_config.deserialize_json(
