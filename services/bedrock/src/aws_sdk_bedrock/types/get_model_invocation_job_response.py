"""Generated from Smithy shape ``com.amazonaws.bedrock#GetModelInvocationJobResponse``."""
...
class GetModelInvocationJobResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetModelInvocationJobResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetModelInvocationJobResponse:
    out: GetModelInvocationJobResponse = {}  # type: ignore[typeddict-item]
    if "jobArn" in data:
        out["job_arn"] = data["jobArn"]
    else:
        raise DeserializationError("GetModelInvocationJobResponse.job_arn required")
    if "jobName" in data:
        out["job_name"] = data["jobName"]
    if "modelId" in data:
        out["model_id"] = data["modelId"]
    else:
        raise DeserializationError("GetModelInvocationJobResponse.model_id required")
    if "clientRequestToken" in data:
        out["client_request_token"] = data["clientRequestToken"]
    if "roleArn" in data:
        out["role_arn"] = data["roleArn"]
    else:
        raise DeserializationError("GetModelInvocationJobResponse.role_arn required")
    if "status" in data:
        import aws_sdk_bedrock.types.model_invocation_job_status
    ...
    if "submitTime" in data:
        ...
        raise DeserializationError("GetModelInvocationJobResponse.submit_time required")
    ...
    if "inputDataConfig" in data:
        ...
        raise DeserializationError(
            "GetModelInvocationJobResponse.input_data_config required"
        )
    if "outputDataConfig" in data:
        ...
        raise DeserializationError(
            "GetModelInvocationJobResponse.output_data_config required"
        )
