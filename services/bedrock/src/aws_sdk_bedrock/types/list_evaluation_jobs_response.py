...
class ListEvaluationJobsResponse(TypedDict, closed=True):
    ...
    job_summaries: NotRequired[
        "aws_sdk_bedrock.types.evaluation_summaries.EvaluationSummaries"
    ]
...
def serialize_json(value: ListEvaluationJobsResponse) -> dict:
    ...
    if "job_summaries" in value:
        ...
        out["jobSummaries"] = aws_sdk_bedrock.types.evaluation_summaries.serialize_json(
            value["job_summaries"]
        )
    return out
...
def deserialize_json(data: dict) -> ListEvaluationJobsResponse:
    ...
    if "jobSummaries" in data:
        ...
        out["job_summaries"] = (
            aws_sdk_bedrock.types.evaluation_summaries.deserialize_json(
                data["jobSummaries"]
            )
        )
    return out
