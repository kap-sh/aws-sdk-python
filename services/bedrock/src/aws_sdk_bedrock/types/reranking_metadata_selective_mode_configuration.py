...
class _RerankingMetadataSelectiveModeConfiguration_fieldsToInclude(TypedDict):
    fieldsToInclude: "aws_sdk_bedrock.types.fields_for_reranking.FieldsForReranking"


class _RerankingMetadataSelectiveModeConfiguration_fieldsToExclude(TypedDict):
    fieldsToExclude: "aws_sdk_bedrock.types.fields_for_reranking.FieldsForReranking"
...
def serialize_json(value: RerankingMetadataSelectiveModeConfiguration) -> dict:
    if "fieldsToInclude" in value:
        ...
        return {
            "fieldsToInclude": aws_sdk_bedrock.types.fields_for_reranking.serialize_json(
        ...
        return {
            "fieldsToExclude": aws_sdk_bedrock.types.fields_for_reranking.serialize_json(
...
def deserialize_json(data: dict) -> RerankingMetadataSelectiveModeConfiguration:
    if "fieldsToInclude" in data:
        ...
        return {
            "fieldsToInclude": aws_sdk_bedrock.types.fields_for_reranking.deserialize_json(
        ...
        return {
            "fieldsToExclude": aws_sdk_bedrock.types.fields_for_reranking.deserialize_json(
