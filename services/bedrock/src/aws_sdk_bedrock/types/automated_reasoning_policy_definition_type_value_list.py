...
if TYPE_CHECKING:
    import aws_sdk_bedrock.types.automated_reasoning_policy_definition_type_value

AutomatedReasoningPolicyDefinitionTypeValueList: TypeAlias = list[
    "aws_sdk_bedrock.types.automated_reasoning_policy_definition_type_value.AutomatedReasoningPolicyDefinitionTypeValue"
]
...
def serialize_json(value: AutomatedReasoningPolicyDefinitionTypeValueList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_bedrock.types.automated_reasoning_policy_definition_type_value.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> AutomatedReasoningPolicyDefinitionTypeValueList:
    ...
    for item in data:
        out.append(
            aws_sdk_bedrock.types.automated_reasoning_policy_definition_type_value.deserialize_json(
                item
            )
        )
    return out
