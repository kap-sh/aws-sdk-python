...
if TYPE_CHECKING:
    import aws_sdk_bedrock.types.s3_uri_folder


class AdvancedPromptOptimizationOutputConfig(TypedDict):
    s3_uri: "aws_sdk_bedrock.types.s3_uri_folder.S3UriFolder"
