...
if TYPE_CHECKING:
    ...
    import aws_sdk_bedrock.types.automated_reasoning_policy_rule_report
...
AutomatedReasoningPolicyRuleReportMap: TypeAlias = dict[
    ...
    "aws_sdk_bedrock.types.automated_reasoning_policy_rule_report.AutomatedReasoningPolicyRuleReport",
]
...
def serialize_json(input_to_serialize: AutomatedReasoningPolicyRuleReportMap) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = (
            aws_sdk_bedrock.types.automated_reasoning_policy_rule_report.serialize_json(
                value
            )
        )
    return out
...
def deserialize_json(data: dict) -> AutomatedReasoningPolicyRuleReportMap:
    ...
    for key, value in data.items():
        ...
        out[key] = (
            aws_sdk_bedrock.types.automated_reasoning_policy_rule_report.deserialize_json(
                value
            )
        )
    return out
