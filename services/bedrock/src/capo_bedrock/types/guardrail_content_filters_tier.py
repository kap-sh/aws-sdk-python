"""Generated from Smithy shape ``com.amazonaws.bedrock#GuardrailContentFiltersTier``."""
...
class GuardrailContentFiltersTier(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GuardrailContentFiltersTier) -> dict:
    out: dict = {}
    import capo_bedrock.types.guardrail_content_filters_tier_name
...
def deserialize_json(data: dict) -> GuardrailContentFiltersTier:
    out: GuardrailContentFiltersTier = {}  # type: ignore[typeddict-item]
    if "tierName" in data:
        import capo_bedrock.types.guardrail_content_filters_tier_name
        ...
        raise DeserializationError("GuardrailContentFiltersTier.tier_name required")
    return out
