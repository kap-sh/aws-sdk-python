...
class ListCustomModelsResponse(TypedDict, closed=True):
    ...
    model_summaries: NotRequired[
        "capo_bedrock.types.custom_model_summary_list.CustomModelSummaryList"
    ]
    """<p>Model summaries.</p>"""
...
def serialize_json(value: ListCustomModelsResponse) -> dict:
    ...
    if "model_summaries" in value:
        ...
        out["modelSummaries"] = (
            capo_bedrock.types.custom_model_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListCustomModelsResponse:
    ...
    if "modelSummaries" in data:
        ...
        out["model_summaries"] = (
            capo_bedrock.types.custom_model_summary_list.deserialize_json(
                data["modelSummaries"]
            )
        )
    return out
