...
if TYPE_CHECKING:
    import capo_bedrock.types.external_sources_retrieve_and_generate_configuration
    import capo_bedrock.types.knowledge_base_retrieve_and_generate_configuration
    import capo_bedrock.types.retrieve_and_generate_type


class RetrieveAndGenerateConfiguration(TypedDict, closed=True):
    type: "capo_bedrock.types.retrieve_and_generate_type.RetrieveAndGenerateType"
    ...
    knowledge_base_configuration: NotRequired[
        "capo_bedrock.types.knowledge_base_retrieve_and_generate_configuration.KnowledgeBaseRetrieveAndGenerateConfiguration"
    ]
    ...
    external_sources_configuration: NotRequired[
        "capo_bedrock.types.external_sources_retrieve_and_generate_configuration.ExternalSourcesRetrieveAndGenerateConfiguration"
    ]
...
def serialize_json(value: RetrieveAndGenerateConfiguration) -> dict:
    ...
    out["type"] = capo_bedrock.types.retrieve_and_generate_type.serialize_json(
        value["type"]
    )
    if "knowledge_base_configuration" in value:
        ...
        out["knowledgeBaseConfiguration"] = (
            capo_bedrock.types.knowledge_base_retrieve_and_generate_configuration.serialize_json(
    ...
    if "external_sources_configuration" in value:
        ...
        out["externalSourcesConfiguration"] = (
            capo_bedrock.types.external_sources_retrieve_and_generate_configuration.serialize_json(
...
def deserialize_json(data: dict) -> RetrieveAndGenerateConfiguration:
    ...
    if "type" in data:
        ...
        out["type"] = capo_bedrock.types.retrieve_and_generate_type.deserialize_json(
            data["type"]
        )
    else:
    ...
    if "knowledgeBaseConfiguration" in data:
        ...
        out["knowledge_base_configuration"] = (
            capo_bedrock.types.knowledge_base_retrieve_and_generate_configuration.deserialize_json(
    ...
    if "externalSourcesConfiguration" in data:
        ...
        out["external_sources_configuration"] = (
            capo_bedrock.types.external_sources_retrieve_and_generate_configuration.deserialize_json(
