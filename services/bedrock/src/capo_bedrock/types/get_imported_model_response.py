...
class GetImportedModelResponse(TypedDict, closed=True):
    model_arn: NotRequired["capo_bedrock.types.imported_model_arn.ImportedModelArn"]
    """<p>The Amazon Resource Name (ARN) associated with this imported model.</p>"""
    model_name: NotRequired["capo_bedrock.types.imported_model_name.ImportedModelName"]
    ...
    custom_model_units: NotRequired[
        "capo_bedrock.types.custom_model_units.CustomModelUnits"
    ]
...
def serialize_json(value: GetImportedModelResponse) -> dict:
    ...
    if "custom_model_units" in value:
        ...
        out["customModelUnits"] = capo_bedrock.types.custom_model_units.serialize_json(
...
def deserialize_json(data: dict) -> GetImportedModelResponse:
    ...
    if "customModelUnits" in data:
        ...
        out["custom_model_units"] = (
            capo_bedrock.types.custom_model_units.deserialize_json(
