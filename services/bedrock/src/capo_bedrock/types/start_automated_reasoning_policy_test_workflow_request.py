...
class StartAutomatedReasoningPolicyTestWorkflowRequest(TypedDict, closed=True):
    policy_arn: (
...
def serialize_json(value: StartAutomatedReasoningPolicyTestWorkflowRequest) -> dict:
    ...
    if "test_case_ids" in value:
        ...
        out["testCaseIds"] = (
            capo_bedrock.types.automated_reasoning_policy_test_case_id_list.serialize_json(
                value["test_case_ids"]
            )
        )
...
def deserialize_json(data: dict) -> StartAutomatedReasoningPolicyTestWorkflowRequest:
    ...
    if "testCaseIds" in data:
        ...
        out["test_case_ids"] = (
            capo_bedrock.types.automated_reasoning_policy_test_case_id_list.deserialize_json(
                data["testCaseIds"]
            )
        )
