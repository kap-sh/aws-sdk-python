"""Generated from Smithy shape ``com.amazonaws.bedrock#EvaluationOutputDataConfig``."""
...
class EvaluationOutputDataConfig(TypedDict, closed=True):
    s3_uri: "capo_bedrock.types.s3_uri.S3Uri"
    """<p>The Amazon S3 URI where the results of the evaluation job are saved.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: EvaluationOutputDataConfig) -> dict:
    out: dict = {}
