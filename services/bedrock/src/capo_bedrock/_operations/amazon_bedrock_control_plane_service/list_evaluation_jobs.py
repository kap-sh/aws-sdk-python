"""Generated from Smithy shape ``com.amazonaws.bedrock#ListEvaluationJobs``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.list_evaluation_jobs_response.ListEvaluationJobsResponse = (
        capo_bedrock.types.list_evaluation_jobs_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/evaluation-jobs"
    ...
    if "status_equals" in input_:
        params.append(
            (
                "statusEquals",
                capo_bedrock.types.evaluation_job_status.serialize_json(
                    input_["status_equals"]
                ),
            )
        )
    if "application_type_equals" in input_:
        params.append(
            (
                "applicationTypeEquals",
                capo_bedrock.types.application_type.serialize_json(
                    input_["application_type_equals"]
                ),
            )
        )
...
async def async_list_evaluation_jobs(
