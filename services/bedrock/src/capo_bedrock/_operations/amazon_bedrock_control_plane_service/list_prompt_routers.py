...
def handle_response(
    ...
    out: capo_bedrock.types.list_prompt_routers_response.ListPromptRoutersResponse = (
        capo_bedrock.types.list_prompt_routers_response.deserialize_json(
...
def build_request(
    ...
    params.append(
        (
            "type",
            capo_bedrock.types.prompt_router_type.serialize_json(
                input_.get("type", "default")
            ),
        )
    )
