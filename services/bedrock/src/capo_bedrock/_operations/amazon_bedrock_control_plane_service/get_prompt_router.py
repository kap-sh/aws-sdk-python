"""Generated from Smithy shape ``com.amazonaws.bedrock#GetPromptRouter``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.get_prompt_router_response.GetPromptRouterResponse = (
        capo_bedrock.types.get_prompt_router_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{promptRouterArn}", quote(input_["prompt_router_arn"], safe=""))
...
async def async_get_prompt_router(
