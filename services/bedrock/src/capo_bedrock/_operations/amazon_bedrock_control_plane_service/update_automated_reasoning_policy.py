...
def handle_response(
    ...
    out: capo_bedrock.types.update_automated_reasoning_policy_response.UpdateAutomatedReasoningPolicyResponse = capo_bedrock.types.update_automated_reasoning_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.update_automated_reasoning_policy_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
