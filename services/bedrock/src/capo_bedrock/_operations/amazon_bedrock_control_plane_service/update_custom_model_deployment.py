"""Generated from Smithy shape ``com.amazonaws.bedrock#UpdateCustomModelDeployment``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.update_custom_model_deployment_response.UpdateCustomModelDeploymentResponse = capo_bedrock.types.update_custom_model_deployment_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["custom_model_deployment_identifier"], safe=""),
    )
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_bedrock.types.update_custom_model_deployment_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
