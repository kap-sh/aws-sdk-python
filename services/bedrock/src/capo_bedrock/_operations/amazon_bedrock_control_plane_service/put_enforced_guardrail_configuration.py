"""Generated from Smithy shape ``com.amazonaws.bedrock#PutEnforcedGuardrailConfiguration``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.put_enforced_guardrail_configuration_response.PutEnforcedGuardrailConfigurationResponse = capo_bedrock.types.put_enforced_guardrail_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.put_enforced_guardrail_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
