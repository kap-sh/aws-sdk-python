...
def handle_response(
    ...
    out: capo_bedrock.types.list_model_import_jobs_response.ListModelImportJobsResponse = capo_bedrock.types.list_model_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    if "status_equals" in input_:
        params.append(
            (
                "statusEquals",
                capo_bedrock.types.model_import_job_status.serialize_json(
