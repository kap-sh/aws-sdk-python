...
def handle_response(
    ...
    out: capo_bedrock.types.list_model_customization_jobs_response.ListModelCustomizationJobsResponse = capo_bedrock.types.list_model_customization_jobs_response.deserialize_json(
...
def build_request(
    ...
    if "status_equals" in input_:
        params.append(
            (
                "statusEquals",
                capo_bedrock.types.fine_tuning_job_status.serialize_json(
