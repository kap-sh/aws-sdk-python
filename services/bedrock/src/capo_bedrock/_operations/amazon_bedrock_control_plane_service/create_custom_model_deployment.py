"""Generated from Smithy shape ``com.amazonaws.bedrock#CreateCustomModelDeployment``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.create_custom_model_deployment_response.CreateCustomModelDeploymentResponse = capo_bedrock.types.create_custom_model_deployment_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.create_custom_model_deployment_request.serialize_json(input_)
    ).encode()
