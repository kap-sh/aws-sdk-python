"""Generated from Smithy shape ``com.amazonaws.bedrock#PutModelInvocationLoggingConfiguration``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.put_model_invocation_logging_configuration_response.PutModelInvocationLoggingConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.put_model_invocation_logging_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
