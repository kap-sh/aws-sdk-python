...
def handle_response(
    ...
    out: capo_bedrock.types.get_custom_model_deployment_response.GetCustomModelDeploymentResponse = capo_bedrock.types.get_custom_model_deployment_response.deserialize_json(
