"""Generated from Smithy shape ``com.amazonaws.bedrock#ListGuardrails``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.list_guardrails_response.ListGuardrailsResponse = (
        capo_bedrock.types.list_guardrails_response.deserialize_json(
...
def build_request(
    ...
    if "guardrail_identifier" in input_:
        params.append(("guardrailIdentifier", input_["guardrail_identifier"]))
...
def list_guardrails(
    ...
    capo_bedrock.types.list_guardrails_response.ListGuardrailsResponse, zapros.Response
]:
...
async def async_list_guardrails(
