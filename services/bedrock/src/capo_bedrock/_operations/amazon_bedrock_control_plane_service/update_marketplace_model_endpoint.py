"""Generated from Smithy shape ``com.amazonaws.bedrock#UpdateMarketplaceModelEndpoint``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.update_marketplace_model_endpoint_response.UpdateMarketplaceModelEndpointResponse = capo_bedrock.types.update_marketplace_model_endpoint_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.update_marketplace_model_endpoint_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
