...
def handle_response(
    ...
    out: capo_bedrock.types.get_automated_reasoning_policy_annotations_response.GetAutomatedReasoningPolicyAnnotationsResponse = capo_bedrock.types.get_automated_reasoning_policy_annotations_response.deserialize_json(
