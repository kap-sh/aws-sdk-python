...
def handle_response(
    ...
    out: capo_bedrock.types.register_marketplace_model_endpoint_response.RegisterMarketplaceModelEndpointResponse = capo_bedrock.types.register_marketplace_model_endpoint_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.register_marketplace_model_endpoint_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
