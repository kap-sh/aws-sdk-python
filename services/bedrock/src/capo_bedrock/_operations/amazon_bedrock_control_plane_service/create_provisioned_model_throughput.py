"""Generated from Smithy shape ``com.amazonaws.bedrock#CreateProvisionedModelThroughput``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.create_provisioned_model_throughput_response.CreateProvisionedModelThroughputResponse = capo_bedrock.types.create_provisioned_model_throughput_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.create_provisioned_model_throughput_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_provisioned_model_throughput(
