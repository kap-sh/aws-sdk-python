"""Generated from Smithy shape ``com.amazonaws.bedrock#GetGuardrail``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.get_guardrail_response.GetGuardrailResponse = (
        capo_bedrock.types.get_guardrail_response.deserialize_json(
...
def get_guardrail(
    ...
    capo_bedrock.types.get_guardrail_response.GetGuardrailResponse, zapros.Response
]:
