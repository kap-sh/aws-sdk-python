...
def handle_response(
    ...
    out: capo_bedrock.types.get_automated_reasoning_policy_build_workflow_response.GetAutomatedReasoningPolicyBuildWorkflowResponse = capo_bedrock.types.get_automated_reasoning_policy_build_workflow_response.deserialize_json(
