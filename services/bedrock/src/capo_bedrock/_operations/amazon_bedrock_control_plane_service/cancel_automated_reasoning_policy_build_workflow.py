"""Generated from Smithy shape ``com.amazonaws.bedrock#CancelAutomatedReasoningPolicyBuildWorkflow``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.cancel_automated_reasoning_policy_build_workflow_response.CancelAutomatedReasoningPolicyBuildWorkflowResponse = {}  # type: ignore[typeddict-item]
    return out
