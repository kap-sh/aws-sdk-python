"""Generated from Smithy shape ``com.amazonaws.bedrock#PutResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.put_resource_policy_response.PutResourcePolicyResponse = (
        capo_bedrock.types.put_resource_policy_response.deserialize_json(
