...
def handle_response(
    ...
    out: capo_bedrock.types.get_provisioned_model_throughput_response.GetProvisionedModelThroughputResponse = capo_bedrock.types.get_provisioned_model_throughput_response.deserialize_json(
