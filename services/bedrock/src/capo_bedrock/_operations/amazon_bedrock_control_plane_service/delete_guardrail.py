"""Generated from Smithy shape ``com.amazonaws.bedrock#DeleteGuardrail``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.delete_guardrail_response.DeleteGuardrailResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    if "guardrail_version" in input_:
        params.append(("guardrailVersion", input_["guardrail_version"]))
