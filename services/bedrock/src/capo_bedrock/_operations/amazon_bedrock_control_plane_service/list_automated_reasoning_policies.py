"""Generated from Smithy shape ``com.amazonaws.bedrock#ListAutomatedReasoningPolicies``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.list_automated_reasoning_policies_response.ListAutomatedReasoningPoliciesResponse = capo_bedrock.types.list_automated_reasoning_policies_response.deserialize_json(
...
def build_request(
    ...
    if "policy_arn" in input_:
        params.append(("policyArn", input_["policy_arn"]))
    if "next_token" in input_:
        params.append(("nextToken", input_["next_token"]))
    params.append(("maxResults", str(input_.get("max_results", 25))))
...
async def async_list_automated_reasoning_policies(
