"""Generated from Smithy shape ``com.amazonaws.bedrock#DeleteAutomatedReasoningPolicyTestCase``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.delete_automated_reasoning_policy_test_case_response.DeleteAutomatedReasoningPolicyTestCaseResponse = {}  # type: ignore[typeddict-item]
    return out
