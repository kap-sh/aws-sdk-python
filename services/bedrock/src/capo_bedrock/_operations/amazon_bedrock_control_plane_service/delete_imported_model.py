"""Generated from Smithy shape ``com.amazonaws.bedrock#DeleteImportedModel``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.delete_imported_model_response.DeleteImportedModelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/imported-models/{modelIdentifier}"
    url = url.replace("{modelIdentifier}", quote(input_["model_identifier"], safe=""))
...
async def async_delete_imported_model(
