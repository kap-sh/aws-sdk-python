...
def handle_response(
    ...
    out: capo_bedrock.types.batch_delete_evaluation_job_response.BatchDeleteEvaluationJobResponse = capo_bedrock.types.batch_delete_evaluation_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.batch_delete_evaluation_job_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
