"""Generated from Smithy shape ``com.amazonaws.bedrock#DeleteCustomModel``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.delete_custom_model_response.DeleteCustomModelResponse = {}  # type: ignore[typeddict-item]
    return out
