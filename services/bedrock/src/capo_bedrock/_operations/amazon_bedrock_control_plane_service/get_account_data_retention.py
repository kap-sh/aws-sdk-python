...
def handle_response(
    ...
    out: capo_bedrock.types.get_account_data_retention_response.GetAccountDataRetentionResponse = capo_bedrock.types.get_account_data_retention_response.deserialize_json(
