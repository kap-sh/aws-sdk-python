"""Generated from Smithy shape ``com.amazonaws.bedrock#GetCustomModel``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.get_custom_model_response.GetCustomModelResponse = (
        capo_bedrock.types.get_custom_model_response.deserialize_json(
...
def get_custom_model(
    ...
    capo_bedrock.types.get_custom_model_response.GetCustomModelResponse, zapros.Response
]:
...
async def async_get_custom_model(
