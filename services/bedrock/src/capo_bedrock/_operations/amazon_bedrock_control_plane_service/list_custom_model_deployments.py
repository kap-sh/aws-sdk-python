...
def handle_response(
    ...
    out: capo_bedrock.types.list_custom_model_deployments_response.ListCustomModelDeploymentsResponse = capo_bedrock.types.list_custom_model_deployments_response.deserialize_json(
...
def build_request(
    ...
    if "created_after" in input_:
        params.append(
            (
                "createdAfter",
                capo_bedrock._protocol.serialize.fmt_date_time(input_["created_after"]),
            )
        )
    ...
    if "status_equals" in input_:
        params.append(
            (
                "statusEquals",
                capo_bedrock.types.custom_model_deployment_status.serialize_json(
                    input_["status_equals"]
                ),
            )
        )
    if "model_arn_equals" in input_:
        params.append(("modelArnEquals", input_["model_arn_equals"]))
