"""Generated from Smithy shape ``com.amazonaws.bedrock#DeleteMarketplaceModelEndpoint``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.delete_marketplace_model_endpoint_response.DeleteMarketplaceModelEndpointResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_marketplace_model_endpoint(
