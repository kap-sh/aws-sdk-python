...
def handle_response(
    ...
    out: capo_bedrock.types.get_automated_reasoning_policy_test_case_response.GetAutomatedReasoningPolicyTestCaseResponse = capo_bedrock.types.get_automated_reasoning_policy_test_case_response.deserialize_json(
