...
def handle_response(
    ...
    out: capo_bedrock.types.list_provisioned_model_throughputs_response.ListProvisionedModelThroughputsResponse = capo_bedrock.types.list_provisioned_model_throughputs_response.deserialize_json(
...
def build_request(
    ...
    if "status_equals" in input_:
        params.append(
            (
                "statusEquals",
                capo_bedrock.types.provisioned_model_status.serialize_json(
    ...
    if "sort_by" in input_:
        params.append(
            (
                "sortBy",
                capo_bedrock.types.sort_by_provisioned_models.serialize_json(
                    input_["sort_by"]
                ),
            )
        )
