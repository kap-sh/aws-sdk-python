...
def handle_response(
    ...
    out: capo_bedrock.types.get_inference_profile_response.GetInferenceProfileResponse = capo_bedrock.types.get_inference_profile_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["inference_profile_identifier"], safe=""),
    )
