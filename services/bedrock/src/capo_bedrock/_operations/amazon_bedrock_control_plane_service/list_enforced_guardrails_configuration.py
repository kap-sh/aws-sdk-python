...
def handle_response(
    ...
    out: capo_bedrock.types.list_enforced_guardrails_configuration_response.ListEnforcedGuardrailsConfigurationResponse = capo_bedrock.types.list_enforced_guardrails_configuration_response.deserialize_json(
