...
def handle_response(
    ...
    out: capo_bedrock.types.get_automated_reasoning_policy_test_result_response.GetAutomatedReasoningPolicyTestResultResponse = capo_bedrock.types.get_automated_reasoning_policy_test_result_response.deserialize_json(
