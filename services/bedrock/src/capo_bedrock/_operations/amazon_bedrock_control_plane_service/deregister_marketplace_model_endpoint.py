"""Generated from Smithy shape ``com.amazonaws.bedrock#DeregisterMarketplaceModelEndpoint``."""
...
import capo_bedrock.errors.service_unavailable_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceUnavailableException":
            raise capo_bedrock.errors.service_unavailable_exception.ServiceUnavailableException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_bedrock.types.deregister_marketplace_model_endpoint_response.DeregisterMarketplaceModelEndpointResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace("{endpointArn}", quote(input_["endpoint_arn"], safe=""))
