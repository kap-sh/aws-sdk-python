"""Generated from Smithy shape ``com.amazonaws.bedrock#PutAccountDataRetention``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.put_account_data_retention_response.PutAccountDataRetentionResponse = capo_bedrock.types.put_account_data_retention_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.put_account_data_retention_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
