"""Generated from Smithy shape ``com.amazonaws.bedrock#GetModelInvocationJob``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.get_model_invocation_job_response.GetModelInvocationJobResponse = capo_bedrock.types.get_model_invocation_job_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/model-invocation-job/{jobIdentifier}"
...
async def async_get_model_invocation_job(
