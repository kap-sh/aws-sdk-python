"""Generated from Smithy shape ``com.amazonaws.bedrock#DeleteModelInvocationLoggingConfiguration``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.delete_model_invocation_logging_configuration_response.DeleteModelInvocationLoggingConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/logging/modelinvocations"
    params: dict[str, str] = {}
