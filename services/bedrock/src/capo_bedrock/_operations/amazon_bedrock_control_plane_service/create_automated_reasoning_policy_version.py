...
def handle_response(
    ...
    out: capo_bedrock.types.create_automated_reasoning_policy_version_response.CreateAutomatedReasoningPolicyVersionResponse = capo_bedrock.types.create_automated_reasoning_policy_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.create_automated_reasoning_policy_version_request.serialize_json(
            input_
        )
    ).encode()
