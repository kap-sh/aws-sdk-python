"""Generated from Smithy shape ``com.amazonaws.bedrock#CreateFoundationModelAgreement``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.create_foundation_model_agreement_response.CreateFoundationModelAgreementResponse = capo_bedrock.types.create_foundation_model_agreement_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.create_foundation_model_agreement_request.serialize_json(
            input_
        )
    ).encode()
