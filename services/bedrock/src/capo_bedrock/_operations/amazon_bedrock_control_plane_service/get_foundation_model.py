"""Generated from Smithy shape ``com.amazonaws.bedrock#GetFoundationModel``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.get_foundation_model_response.GetFoundationModelResponse = (
        capo_bedrock.types.get_foundation_model_response.deserialize_json(
