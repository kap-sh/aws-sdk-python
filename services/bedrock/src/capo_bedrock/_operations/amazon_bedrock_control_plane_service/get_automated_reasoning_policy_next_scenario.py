...
def handle_response(
    ...
    out: capo_bedrock.types.get_automated_reasoning_policy_next_scenario_response.GetAutomatedReasoningPolicyNextScenarioResponse = capo_bedrock.types.get_automated_reasoning_policy_next_scenario_response.deserialize_json(
