...
def handle_response(
    ...
    out: capo_bedrock.types.list_marketplace_model_endpoints_response.ListMarketplaceModelEndpointsResponse = capo_bedrock.types.list_marketplace_model_endpoints_response.deserialize_json(
...
def build_request(
    ...
    if "model_source_equals" in input_:
        params.append(("modelSourceIdentifier", input_["model_source_equals"]))
