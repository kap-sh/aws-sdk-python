"""Generated from Smithy shape ``com.amazonaws.bedrock#GetModelImportJob``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.get_model_import_job_response.GetModelImportJobResponse = (
        capo_bedrock.types.get_model_import_job_response.deserialize_json(
...
async def async_get_model_import_job(
