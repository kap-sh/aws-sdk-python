...
def handle_response(
    ...
    out: capo_bedrock.types.get_foundation_model_availability_response.GetFoundationModelAvailabilityResponse = capo_bedrock.types.get_foundation_model_availability_response.deserialize_json(
