"""Generated from Smithy shape ``com.amazonaws.bedrock#CreateModelCustomizationJob``."""
...
import capo_bedrock.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            raise capo_bedrock.errors.too_many_tags_exception.TooManyTagsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_bedrock.types.create_model_customization_job_response.CreateModelCustomizationJobResponse = capo_bedrock.types.create_model_customization_job_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/model-customization-jobs"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_bedrock.types.create_model_customization_job_request.serialize_json(input_)
    ).encode()
...
async def async_create_model_customization_job(
