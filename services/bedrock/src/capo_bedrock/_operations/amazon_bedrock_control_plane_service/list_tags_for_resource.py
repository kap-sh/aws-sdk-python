"""Generated from Smithy shape ``com.amazonaws.bedrock#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_bedrock.types.list_tags_for_resource_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.list_tags_for_resource_request.serialize_json(input_)
    ).encode()
