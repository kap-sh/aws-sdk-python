...
def handle_response(
    ...
    out: capo_bedrock.types.create_automated_reasoning_policy_response.CreateAutomatedReasoningPolicyResponse = capo_bedrock.types.create_automated_reasoning_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.create_automated_reasoning_policy_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
