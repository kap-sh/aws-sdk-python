...
def handle_response(
    ...
    out: capo_bedrock.types.get_advanced_prompt_optimization_job_response.GetAdvancedPromptOptimizationJobResponse = capo_bedrock.types.get_advanced_prompt_optimization_job_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{jobIdentifier}", quote(input_["job_identifier"], safe=""))
