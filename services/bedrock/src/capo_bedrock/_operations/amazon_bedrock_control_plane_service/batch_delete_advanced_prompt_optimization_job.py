"""Generated from Smithy shape ``com.amazonaws.bedrock#BatchDeleteAdvancedPromptOptimizationJob``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.batch_delete_advanced_prompt_optimization_job_response.BatchDeleteAdvancedPromptOptimizationJobResponse = capo_bedrock.types.batch_delete_advanced_prompt_optimization_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.batch_delete_advanced_prompt_optimization_job_request.serialize_json(
            input_
        )
    ).encode()
