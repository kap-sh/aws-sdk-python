"""Generated from Smithy shape ``com.amazonaws.bedrock#CreateCustomModel``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.create_custom_model_response.CreateCustomModelResponse = (
        capo_bedrock.types.create_custom_model_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/custom-models/create-custom-model"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_bedrock.types.create_custom_model_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
