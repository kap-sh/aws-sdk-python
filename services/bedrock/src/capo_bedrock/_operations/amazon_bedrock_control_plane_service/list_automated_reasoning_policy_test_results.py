...
def handle_response(
    ...
    out: capo_bedrock.types.list_automated_reasoning_policy_test_results_response.ListAutomatedReasoningPolicyTestResultsResponse = capo_bedrock.types.list_automated_reasoning_policy_test_results_response.deserialize_json(
