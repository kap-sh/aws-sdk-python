"""Generated from Smithy shape ``com.amazonaws.bedrock#GetMarketplaceModelEndpoint``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.get_marketplace_model_endpoint_response.GetMarketplaceModelEndpointResponse = capo_bedrock.types.get_marketplace_model_endpoint_response.deserialize_json(
