"""Generated from Smithy shape ``com.amazonaws.bedrock#ListFoundationModelAgreementOffers``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.list_foundation_model_agreement_offers_response.ListFoundationModelAgreementOffersResponse = capo_bedrock.types.list_foundation_model_agreement_offers_response.deserialize_json(
...
def build_request(
    ...
    if "offer_type" in input_:
        params.append(
            (
                "offerType",
                capo_bedrock.types.offer_type.serialize_json(input_["offer_type"]),
            )
        )
