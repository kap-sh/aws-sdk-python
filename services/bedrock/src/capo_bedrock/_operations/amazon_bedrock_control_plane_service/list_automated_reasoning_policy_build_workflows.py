...
def handle_response(
    ...
    out: capo_bedrock.types.list_automated_reasoning_policy_build_workflows_response.ListAutomatedReasoningPolicyBuildWorkflowsResponse = capo_bedrock.types.list_automated_reasoning_policy_build_workflows_response.deserialize_json(
