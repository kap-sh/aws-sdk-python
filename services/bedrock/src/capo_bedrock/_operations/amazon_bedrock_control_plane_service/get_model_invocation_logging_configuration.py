...
def handle_response(
    ...
    out: capo_bedrock.types.get_model_invocation_logging_configuration_response.GetModelInvocationLoggingConfigurationResponse = capo_bedrock.types.get_model_invocation_logging_configuration_response.deserialize_json(
