"""Generated from Smithy shape ``com.amazonaws.bedrock#CreateEvaluationJob``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.create_evaluation_job_response.CreateEvaluationJobResponse = capo_bedrock.types.create_evaluation_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.create_evaluation_job_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_evaluation_job(
