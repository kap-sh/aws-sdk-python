"""Generated from Smithy shape ``com.amazonaws.bedrock#CreateInferenceProfile``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.create_inference_profile_response.CreateInferenceProfileResponse = capo_bedrock.types.create_inference_profile_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/inference-profiles"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_bedrock.types.create_inference_profile_request.serialize_json(input_)
    ).encode()
...
async def async_create_inference_profile(
