"""Generated from Smithy shape ``com.amazonaws.bedrock#CreateGuardrail``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.create_guardrail_response.CreateGuardrailResponse = (
        capo_bedrock.types.create_guardrail_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.create_guardrail_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
