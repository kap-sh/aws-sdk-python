"""Generated from Smithy shape ``com.amazonaws.bedrock#UpdateAutomatedReasoningPolicyTestCase``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.update_automated_reasoning_policy_test_case_response.UpdateAutomatedReasoningPolicyTestCaseResponse = capo_bedrock.types.update_automated_reasoning_policy_test_case_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{testCaseId}", quote(input_["test_case_id"], safe=""))
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_bedrock.types.update_automated_reasoning_policy_test_case_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
