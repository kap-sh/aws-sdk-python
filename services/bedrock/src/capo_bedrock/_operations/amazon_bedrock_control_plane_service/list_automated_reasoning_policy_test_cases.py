...
def handle_response(
    ...
    out: capo_bedrock.types.list_automated_reasoning_policy_test_cases_response.ListAutomatedReasoningPolicyTestCasesResponse = capo_bedrock.types.list_automated_reasoning_policy_test_cases_response.deserialize_json(
