"""Generated from Smithy shape ``com.amazonaws.bedrock#StopEvaluationJob``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.stop_evaluation_job_response.StopEvaluationJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/evaluation-job/{jobIdentifier}/stop"
...
async def async_stop_evaluation_job(
