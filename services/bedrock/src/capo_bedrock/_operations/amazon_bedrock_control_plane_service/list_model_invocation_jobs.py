...
def handle_response(
    ...
    out: capo_bedrock.types.list_model_invocation_jobs_response.ListModelInvocationJobsResponse = capo_bedrock.types.list_model_invocation_jobs_response.deserialize_json(
...
def build_request(
    ...
    if "status_equals" in input_:
        params.append(
            (
                "statusEquals",
                capo_bedrock.types.model_invocation_job_status.serialize_json(
