"""Generated from Smithy shape ``com.amazonaws.bedrock#GetModelCustomizationJob``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.get_model_customization_job_response.GetModelCustomizationJobResponse = capo_bedrock.types.get_model_customization_job_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/model-customization-jobs/{jobIdentifier}"
...
async def async_get_model_customization_job(
