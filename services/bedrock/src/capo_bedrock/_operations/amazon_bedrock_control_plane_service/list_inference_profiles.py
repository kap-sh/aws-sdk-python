...
def handle_response(
    ...
    out: capo_bedrock.types.list_inference_profiles_response.ListInferenceProfilesResponse = capo_bedrock.types.list_inference_profiles_response.deserialize_json(
...
def build_request(
    ...
    if "type_equals" in input_:
        params.append(
            (
                "type",
                capo_bedrock.types.inference_profile_type.serialize_json(
                    input_["type_equals"]
                ),
            )
        )
