...
def handle_response(
    ...
    out: capo_bedrock.types.update_guardrail_response.UpdateGuardrailResponse = (
        capo_bedrock.types.update_guardrail_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.update_guardrail_request.serialize_json(input_)
    ).encode()
