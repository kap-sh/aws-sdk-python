...
def handle_response(
    ...
    out: capo_bedrock.types.get_use_case_for_model_access_response.GetUseCaseForModelAccessResponse = capo_bedrock.types.get_use_case_for_model_access_response.deserialize_json(
