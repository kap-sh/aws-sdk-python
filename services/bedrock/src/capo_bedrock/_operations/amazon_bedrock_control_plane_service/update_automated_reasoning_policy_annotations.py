...
def handle_response(
    ...
    out: capo_bedrock.types.update_automated_reasoning_policy_annotations_response.UpdateAutomatedReasoningPolicyAnnotationsResponse = capo_bedrock.types.update_automated_reasoning_policy_annotations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.update_automated_reasoning_policy_annotations_request.serialize_json(
            input_
        )
    ).encode()
