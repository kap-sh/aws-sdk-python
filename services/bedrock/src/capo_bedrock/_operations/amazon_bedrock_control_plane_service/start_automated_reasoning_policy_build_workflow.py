...
def handle_response(
    ...
    out: capo_bedrock.types.start_automated_reasoning_policy_build_workflow_response.StartAutomatedReasoningPolicyBuildWorkflowResponse = capo_bedrock.types.start_automated_reasoning_policy_build_workflow_response.deserialize_json(
...
def build_request(
    ...
    if "client_request_token" in input_:
        headers["x-amz-client-token"] = input_["client_request_token"]
