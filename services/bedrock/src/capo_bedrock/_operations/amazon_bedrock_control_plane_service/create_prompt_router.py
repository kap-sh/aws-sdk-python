...
def handle_response(
    ...
    out: capo_bedrock.types.create_prompt_router_response.CreatePromptRouterResponse = (
        capo_bedrock.types.create_prompt_router_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.create_prompt_router_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
