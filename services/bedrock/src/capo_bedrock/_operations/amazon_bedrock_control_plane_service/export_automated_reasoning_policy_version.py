...
def handle_response(
    ...
    out: capo_bedrock.types.export_automated_reasoning_policy_version_response.ExportAutomatedReasoningPolicyVersionResponse = {
        "policy_definition": capo_bedrock.types.automated_reasoning_policy_definition.deserialize_json(
