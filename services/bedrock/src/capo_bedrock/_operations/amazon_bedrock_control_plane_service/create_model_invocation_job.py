"""Generated from Smithy shape ``com.amazonaws.bedrock#CreateModelInvocationJob``."""
...
def handle_response(
    ...
    out: capo_bedrock.types.create_model_invocation_job_response.CreateModelInvocationJobResponse = capo_bedrock.types.create_model_invocation_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bedrock.types.create_model_invocation_job_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
