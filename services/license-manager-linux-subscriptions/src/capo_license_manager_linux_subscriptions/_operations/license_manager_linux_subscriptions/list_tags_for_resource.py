"""Generated from Smithy shape ``com.amazonaws.licensemanagerlinuxsubscriptions#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_license_manager_linux_subscriptions.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_license_manager_linux_subscriptions.types.list_tags_for_resource_response.deserialize_json(
