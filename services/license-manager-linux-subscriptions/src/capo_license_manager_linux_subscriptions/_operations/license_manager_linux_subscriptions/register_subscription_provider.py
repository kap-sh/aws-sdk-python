...
def handle_response(
    ...
    out: capo_license_manager_linux_subscriptions.types.register_subscription_provider_response.RegisterSubscriptionProviderResponse = capo_license_manager_linux_subscriptions.types.register_subscription_provider_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager_linux_subscriptions.types.register_subscription_provider_request.serialize_json(
            input_
        )
    ).encode()
