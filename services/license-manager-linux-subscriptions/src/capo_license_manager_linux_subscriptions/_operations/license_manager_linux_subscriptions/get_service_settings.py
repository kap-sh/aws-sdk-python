"""Generated from Smithy shape ``com.amazonaws.licensemanagerlinuxsubscriptions#GetServiceSettings``."""
...
def handle_response(
    ...
    out: capo_license_manager_linux_subscriptions.types.get_service_settings_response.GetServiceSettingsResponse = capo_license_manager_linux_subscriptions.types.get_service_settings_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/subscription/GetServiceSettings"
    params: dict[str, str] = {}
