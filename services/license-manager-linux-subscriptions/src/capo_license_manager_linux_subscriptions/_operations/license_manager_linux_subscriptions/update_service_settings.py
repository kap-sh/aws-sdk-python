"""Generated from Smithy shape ``com.amazonaws.licensemanagerlinuxsubscriptions#UpdateServiceSettings``."""
...
def handle_response(
    ...
    out: capo_license_manager_linux_subscriptions.types.update_service_settings_response.UpdateServiceSettingsResponse = capo_license_manager_linux_subscriptions.types.update_service_settings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager_linux_subscriptions.types.update_service_settings_request.serialize_json(
            input_
        )
    ).encode()
