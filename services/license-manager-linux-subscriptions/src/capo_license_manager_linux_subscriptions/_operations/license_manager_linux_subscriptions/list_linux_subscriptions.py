...
def handle_response(
    ...
    out: capo_license_manager_linux_subscriptions.types.list_linux_subscriptions_response.ListLinuxSubscriptionsResponse = capo_license_manager_linux_subscriptions.types.list_linux_subscriptions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager_linux_subscriptions.types.list_linux_subscriptions_request.serialize_json(
            input_
        )
    ).encode()
