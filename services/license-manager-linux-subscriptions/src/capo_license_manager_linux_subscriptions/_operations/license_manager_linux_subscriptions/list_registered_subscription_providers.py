"""Generated from Smithy shape ``com.amazonaws.licensemanagerlinuxsubscriptions#ListRegisteredSubscriptionProviders``."""
...
import capo_license_manager_linux_subscriptions.types.registered_subscription_provider_list
...
def handle_response(
    ...
    out: capo_license_manager_linux_subscriptions.types.list_registered_subscription_providers_response.ListRegisteredSubscriptionProvidersResponse = capo_license_manager_linux_subscriptions.types.list_registered_subscription_providers_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager_linux_subscriptions.types.list_registered_subscription_providers_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_registered_subscription_providers(
