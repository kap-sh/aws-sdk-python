...
class ListLinuxSubscriptionInstancesResponse(TypedDict, closed=True):
    instances: NotRequired[
        "capo_license_manager_linux_subscriptions.types.instance_list.InstanceList"
    ]
...
def serialize_json(value: ListLinuxSubscriptionInstancesResponse) -> dict:
    ...
    if "instances" in value:
        ...
        out["Instances"] = (
            capo_license_manager_linux_subscriptions.types.instance_list.serialize_json(
                value["instances"]
            )
        )
...
def deserialize_json(data: dict) -> ListLinuxSubscriptionInstancesResponse:
    ...
    if "Instances" in data:
        ...
        out["instances"] = (
            capo_license_manager_linux_subscriptions.types.instance_list.deserialize_json(
                data["Instances"]
            )
        )
