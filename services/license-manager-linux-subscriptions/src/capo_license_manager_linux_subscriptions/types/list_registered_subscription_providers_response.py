...
class ListRegisteredSubscriptionProvidersResponse(TypedDict, closed=True):
    registered_subscription_providers: NotRequired[
        "capo_license_manager_linux_subscriptions.types.registered_subscription_provider_list.RegisteredSubscriptionProviderList"
    ]
...
def serialize_json(value: ListRegisteredSubscriptionProvidersResponse) -> dict:
    ...
    if "registered_subscription_providers" in value:
        ...
        out["RegisteredSubscriptionProviders"] = (
            capo_license_manager_linux_subscriptions.types.registered_subscription_provider_list.serialize_json(
...
def deserialize_json(data: dict) -> ListRegisteredSubscriptionProvidersResponse:
    ...
    if "RegisteredSubscriptionProviders" in data:
        ...
        out["registered_subscription_providers"] = (
            capo_license_manager_linux_subscriptions.types.registered_subscription_provider_list.deserialize_json(
