...
def serialize_json(value: Instance) -> dict:
    ...
    if "product_code" in value:
        ...
        out["ProductCode"] = (
            aws_sdk_license_manager_linux_subscriptions.types.product_code_list.serialize_json(
                value["product_code"]
            )
        )
...
def deserialize_json(data: dict) -> Instance:
    ...
    if "ProductCode" in data:
        ...
        out["product_code"] = (
            aws_sdk_license_manager_linux_subscriptions.types.product_code_list.deserialize_json(
                data["ProductCode"]
            )
        )
