...
from aws_sdk_license_manager_linux_subscriptions._services._aws_config import (
    aaws_config,
)
...
class AsyncLicenseManagerLinuxSubscriptionsClientConfig(TypedDict, total=False):
...
class AsyncLicenseManagerLinuxSubscriptionsClient:
    ...
    async def deregister_subscription_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_linux_subscriptions.types.deregister_subscription_provider_request.DeregisterSubscriptionProviderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_linux_subscriptions.types.deregister_subscription_provider_response.DeregisterSubscriptionProviderResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_linux_subscriptions._operations.license_manager_linux_subscriptions.deregister_subscription_provider.async_deregister_subscription_provider(
    ...
    async def get_registered_subscription_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_linux_subscriptions.types.get_registered_subscription_provider_request.GetRegisteredSubscriptionProviderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_linux_subscriptions.types.get_registered_subscription_provider_response.GetRegisteredSubscriptionProviderResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_linux_subscriptions._operations.license_manager_linux_subscriptions.get_registered_subscription_provider.async_get_registered_subscription_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_service_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_linux_subscriptions.types.get_service_settings_request.GetServiceSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_linux_subscriptions.types.get_service_settings_response.GetServiceSettingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_linux_subscriptions._operations.license_manager_linux_subscriptions.get_service_settings.async_get_service_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_linux_subscription_instances(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_linux_subscriptions.types.list_linux_subscription_instances_request.ListLinuxSubscriptionInstancesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_linux_subscriptions.types.list_linux_subscription_instances_response.ListLinuxSubscriptionInstancesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_linux_subscriptions._operations.license_manager_linux_subscriptions.list_linux_subscription_instances.async_list_linux_subscription_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_linux_subscription_instances(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[aws_sdk_license_manager_linux_subscriptions.types.instance.Instance]":
        _token = next_token
        while True:
    ...
    async def list_linux_subscriptions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_linux_subscriptions.types.list_linux_subscriptions_request.ListLinuxSubscriptionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_linux_subscriptions.types.list_linux_subscriptions_response.ListLinuxSubscriptionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_linux_subscriptions._operations.license_manager_linux_subscriptions.list_linux_subscriptions.async_list_linux_subscriptions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_linux_subscriptions(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[aws_sdk_license_manager_linux_subscriptions.types.subscription.Subscription]":
        _token = next_token
        while True:
    ...
    async def list_registered_subscription_providers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_linux_subscriptions.types.list_registered_subscription_providers_request.ListRegisteredSubscriptionProvidersRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_linux_subscriptions.types.list_registered_subscription_providers_response.ListRegisteredSubscriptionProvidersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_linux_subscriptions._operations.license_manager_linux_subscriptions.list_registered_subscription_providers.async_list_registered_subscription_providers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_registered_subscription_providers(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[aws_sdk_license_manager_linux_subscriptions.types.registered_subscription_provider.RegisteredSubscriptionProvider]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_linux_subscriptions.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_linux_subscriptions.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_linux_subscriptions._operations.license_manager_linux_subscriptions.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_subscription_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_linux_subscriptions.types.register_subscription_provider_request.RegisterSubscriptionProviderRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_linux_subscriptions.types.register_subscription_provider_response.RegisterSubscriptionProviderResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_linux_subscriptions._operations.license_manager_linux_subscriptions.register_subscription_provider.async_register_subscription_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_linux_subscriptions.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_linux_subscriptions.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_linux_subscriptions._operations.license_manager_linux_subscriptions.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_linux_subscriptions.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_linux_subscriptions.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_linux_subscriptions._operations.license_manager_linux_subscriptions.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_service_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_license_manager_linux_subscriptions.types.update_service_settings_request.UpdateServiceSettingsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_license_manager_linux_subscriptions.types.update_service_settings_response.UpdateServiceSettingsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_license_manager_linux_subscriptions._operations.license_manager_linux_subscriptions.update_service_settings.async_update_service_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
