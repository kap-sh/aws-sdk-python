"""Generated from Smithy shape ``com.amazonaws.licensemanagerlinuxsubscriptions#ListLinuxSubscriptions``."""
...
def handle_response(
    ...
    out: aws_sdk_license_manager_linux_subscriptions.types.list_linux_subscriptions_response.ListLinuxSubscriptionsResponse = aws_sdk_license_manager_linux_subscriptions.types.list_linux_subscriptions_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_license_manager_linux_subscriptions.types.list_linux_subscriptions_request.ListLinuxSubscriptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/subscription/ListLinuxSubscriptions"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_license_manager_linux_subscriptions.types.list_linux_subscriptions_request

    body: bytes | None = json.dumps(
        aws_sdk_license_manager_linux_subscriptions.types.list_linux_subscriptions_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_list_linux_subscriptions(
