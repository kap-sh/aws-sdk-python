...
def handle_response(
    ...
    out: aws_sdk_license_manager_linux_subscriptions.types.list_linux_subscription_instances_response.ListLinuxSubscriptionInstancesResponse = aws_sdk_license_manager_linux_subscriptions.types.list_linux_subscription_instances_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_license_manager_linux_subscriptions.types.list_linux_subscription_instances_request.ListLinuxSubscriptionInstancesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_license_manager_linux_subscriptions.types.list_linux_subscription_instances_request.serialize_json(
            input_
        )
    ).encode()
