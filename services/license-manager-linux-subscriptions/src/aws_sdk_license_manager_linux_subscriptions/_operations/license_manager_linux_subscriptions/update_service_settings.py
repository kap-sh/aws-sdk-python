...
def handle_response(
    ...
    out: aws_sdk_license_manager_linux_subscriptions.types.update_service_settings_response.UpdateServiceSettingsResponse = aws_sdk_license_manager_linux_subscriptions.types.update_service_settings_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_license_manager_linux_subscriptions.types.update_service_settings_request.UpdateServiceSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
