"""Generated from Smithy shape ``com.amazonaws.licensemanagerlinuxsubscriptions#UntagResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            import aws_sdk_license_manager_linux_subscriptions.errors.resource_not_found_exception

            raise aws_sdk_license_manager_linux_subscriptions.errors.resource_not_found_exception.ResourceNotFoundException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_license_manager_linux_subscriptions.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_license_manager_linux_subscriptions.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
