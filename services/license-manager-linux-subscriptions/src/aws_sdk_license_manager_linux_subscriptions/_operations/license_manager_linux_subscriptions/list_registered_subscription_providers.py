...
def handle_response(
    ...
    out: aws_sdk_license_manager_linux_subscriptions.types.list_registered_subscription_providers_response.ListRegisteredSubscriptionProvidersResponse = aws_sdk_license_manager_linux_subscriptions.types.list_registered_subscription_providers_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_license_manager_linux_subscriptions.types.list_registered_subscription_providers_request.ListRegisteredSubscriptionProvidersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
