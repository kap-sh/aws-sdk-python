...
class LicenseManagerLinuxSubscriptionsError(Exception):
    """Base class for all LicenseManagerLinuxSubscriptions service errors."""


class ServiceError(LicenseManagerLinuxSubscriptionsError):
...
class SerializationError(LicenseManagerLinuxSubscriptionsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(LicenseManagerLinuxSubscriptionsError):
...
class WaiterFailedError(LicenseManagerLinuxSubscriptionsError):
...
class WaiterTimeoutError(LicenseManagerLinuxSubscriptionsError):
