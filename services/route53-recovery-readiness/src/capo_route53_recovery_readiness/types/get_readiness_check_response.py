"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#GetReadinessCheckResponse``."""
...
class GetReadinessCheckResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetReadinessCheckResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetReadinessCheckResponse:
    out: GetReadinessCheckResponse = {}  # type: ignore[typeddict-item]
