"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#CellOutput``."""
...
class CellOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CellOutput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CellOutput:
    out: CellOutput = {}  # type: ignore[typeddict-item]
    if "cellArn" in data:
