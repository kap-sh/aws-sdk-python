"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#CreateRecoveryGroupResponse``."""
...
class CreateRecoveryGroupResponse(TypedDict, closed=True):
    cells: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateRecoveryGroupResponse) -> dict:
    out: dict = {}
    if "cells" in value:
        import capo_route53_recovery_readiness.types.__list_of__string
...
def deserialize_json(data: dict) -> CreateRecoveryGroupResponse:
    out: CreateRecoveryGroupResponse = {}  # type: ignore[typeddict-item]
    if "cells" in data:
        import capo_route53_recovery_readiness.types.__list_of__string
