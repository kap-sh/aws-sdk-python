"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#CreateResourceSetResponse``."""
...
class CreateResourceSetResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateResourceSetResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateResourceSetResponse:
    out: CreateResourceSetResponse = {}  # type: ignore[typeddict-item]
