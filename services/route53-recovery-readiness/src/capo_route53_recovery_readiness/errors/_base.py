...
class Route53RecoveryReadinessError(Exception):
    """Base class for all Route53RecoveryReadiness service errors."""


class ServiceError(Route53RecoveryReadinessError):
...
class SerializationError(Route53RecoveryReadinessError):
    """Raised when a value cannot be serialized."""


class DeserializationError(Route53RecoveryReadinessError):
...
class WaiterFailedError(Route53RecoveryReadinessError):
...
class WaiterTimeoutError(Route53RecoveryReadinessError):
