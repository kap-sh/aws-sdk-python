...
from ._services.async_route53_recovery_readiness import (
    AsyncRoute53RecoveryReadinessClient as AsyncRoute53RecoveryReadinessClient,
)
from ._services.route53_recovery_readiness import (
    Route53RecoveryReadinessClient as Route53RecoveryReadinessClient,
)
