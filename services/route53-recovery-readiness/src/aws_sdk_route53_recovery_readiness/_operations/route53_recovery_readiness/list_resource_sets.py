...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.list_resource_sets_response.ListResourceSetsResponse = aws_sdk_route53_recovery_readiness.types.list_resource_sets_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.list_resource_sets_request.ListResourceSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
