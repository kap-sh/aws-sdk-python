...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.get_architecture_recommendations_response.GetArchitectureRecommendationsResponse = aws_sdk_route53_recovery_readiness.types.get_architecture_recommendations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.get_architecture_recommendations_request.GetArchitectureRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
