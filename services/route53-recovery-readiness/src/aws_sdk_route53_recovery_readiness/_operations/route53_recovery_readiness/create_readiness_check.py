...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.create_readiness_check_response.CreateReadinessCheckResponse = aws_sdk_route53_recovery_readiness.types.create_readiness_check_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.create_readiness_check_request.CreateReadinessCheckRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
