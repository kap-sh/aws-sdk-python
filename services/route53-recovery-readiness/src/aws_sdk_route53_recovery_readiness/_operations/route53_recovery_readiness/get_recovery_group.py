...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.get_recovery_group_response.GetRecoveryGroupResponse = aws_sdk_route53_recovery_readiness.types.get_recovery_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.get_recovery_group_request.GetRecoveryGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
