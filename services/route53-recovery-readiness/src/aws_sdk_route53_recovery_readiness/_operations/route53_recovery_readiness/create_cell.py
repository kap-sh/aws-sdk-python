...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.create_cell_response.CreateCellResponse = aws_sdk_route53_recovery_readiness.types.create_cell_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.create_cell_request.CreateCellRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53_recovery_readiness.types.create_cell_request.serialize_json(
            input_
        )
    ).encode()
