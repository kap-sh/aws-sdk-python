...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.list_tags_for_resources_response.ListTagsForResourcesResponse = aws_sdk_route53_recovery_readiness.types.list_tags_for_resources_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.list_tags_for_resources_request.ListTagsForResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
