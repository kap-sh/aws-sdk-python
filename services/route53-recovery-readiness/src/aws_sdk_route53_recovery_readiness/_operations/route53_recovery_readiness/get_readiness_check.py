...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.get_readiness_check_response.GetReadinessCheckResponse = aws_sdk_route53_recovery_readiness.types.get_readiness_check_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_route53_recovery_readiness.types.get_readiness_check_request.GetReadinessCheckRequest,
) -> zapros.Request:
