...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.update_readiness_check_response.UpdateReadinessCheckResponse = aws_sdk_route53_recovery_readiness.types.update_readiness_check_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_route53_recovery_readiness.types.update_readiness_check_request.UpdateReadinessCheckRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ReadinessCheckName}", quote(str(input["readiness_check_name"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53_recovery_readiness.types.update_readiness_check_request.serialize_json(
            input
        )
    ).encode()
