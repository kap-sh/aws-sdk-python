...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.create_resource_set_response.CreateResourceSetResponse = aws_sdk_route53_recovery_readiness.types.create_resource_set_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.create_resource_set_request.CreateResourceSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53_recovery_readiness.types.create_resource_set_request.serialize_json(
            input_
        )
    ).encode()
