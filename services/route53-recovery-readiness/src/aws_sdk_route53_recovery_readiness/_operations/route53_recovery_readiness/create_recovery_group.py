...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.create_recovery_group_response.CreateRecoveryGroupResponse = aws_sdk_route53_recovery_readiness.types.create_recovery_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.create_recovery_group_request.CreateRecoveryGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53_recovery_readiness.types.create_recovery_group_request.serialize_json(
            input_
        )
    ).encode()
