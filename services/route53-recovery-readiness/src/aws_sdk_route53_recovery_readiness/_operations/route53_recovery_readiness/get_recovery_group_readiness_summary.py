...
def build_request(
    ...
    input: aws_sdk_route53_recovery_readiness.types.get_recovery_group_readiness_summary_request.GetRecoveryGroupReadinessSummaryRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{RecoveryGroupName}", quote(str(input["recovery_group_name"]), safe="")
    )
    params: dict[str, str] = {}
