"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#GetRecoveryGroupReadinessSummary``."""
...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.get_recovery_group_readiness_summary_response.GetRecoveryGroupReadinessSummaryResponse = aws_sdk_route53_recovery_readiness.types.get_recovery_group_readiness_summary_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.get_recovery_group_readiness_summary_request.GetRecoveryGroupReadinessSummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/recoverygroupreadiness/{RecoveryGroupName}"
    url = url.replace(
...
async def async_get_recovery_group_readiness_summary(
