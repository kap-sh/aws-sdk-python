...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.get_cell_response.GetCellResponse = (
        aws_sdk_route53_recovery_readiness.types.get_cell_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.get_cell_request.GetCellRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
