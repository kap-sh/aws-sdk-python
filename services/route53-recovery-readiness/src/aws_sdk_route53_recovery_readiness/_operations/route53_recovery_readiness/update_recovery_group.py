"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#UpdateRecoveryGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.update_recovery_group_response.UpdateRecoveryGroupResponse = aws_sdk_route53_recovery_readiness.types.update_recovery_group_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.update_recovery_group_request.UpdateRecoveryGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53_recovery_readiness.types.update_recovery_group_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_update_recovery_group(
