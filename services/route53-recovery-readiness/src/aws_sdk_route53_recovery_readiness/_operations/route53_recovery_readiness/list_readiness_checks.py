...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.list_readiness_checks_response.ListReadinessChecksResponse = aws_sdk_route53_recovery_readiness.types.list_readiness_checks_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.list_readiness_checks_request.ListReadinessChecksRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
