...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.get_cell_readiness_summary_response.GetCellReadinessSummaryResponse = aws_sdk_route53_recovery_readiness.types.get_cell_readiness_summary_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.get_cell_readiness_summary_request.GetCellReadinessSummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
