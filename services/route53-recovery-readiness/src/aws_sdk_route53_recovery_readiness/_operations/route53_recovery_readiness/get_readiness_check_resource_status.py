...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.get_readiness_check_resource_status_response.GetReadinessCheckResourceStatusResponse = aws_sdk_route53_recovery_readiness.types.get_readiness_check_resource_status_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_route53_recovery_readiness.types.get_readiness_check_resource_status_request.GetReadinessCheckResourceStatusRequest,
) -> zapros.Request:
