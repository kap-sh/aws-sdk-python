"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#CreateCrossAccountAuthorization``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            import aws_sdk_route53_recovery_readiness.errors.conflict_exception

            raise aws_sdk_route53_recovery_readiness.errors.conflict_exception.ConflictException.from_json(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.create_cross_account_authorization_response.CreateCrossAccountAuthorizationResponse = aws_sdk_route53_recovery_readiness.types.create_cross_account_authorization_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.create_cross_account_authorization_request.CreateCrossAccountAuthorizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53_recovery_readiness.types.create_cross_account_authorization_request.serialize_json(
            input_
        )
    ).encode()
...
async def async_create_cross_account_authorization(
