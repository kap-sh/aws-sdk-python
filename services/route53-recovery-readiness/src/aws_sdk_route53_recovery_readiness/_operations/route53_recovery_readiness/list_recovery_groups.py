...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.list_recovery_groups_response.ListRecoveryGroupsResponse = aws_sdk_route53_recovery_readiness.types.list_recovery_groups_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.list_recovery_groups_request.ListRecoveryGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
