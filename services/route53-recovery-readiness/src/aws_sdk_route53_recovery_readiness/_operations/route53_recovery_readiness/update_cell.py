...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.update_cell_response.UpdateCellResponse = aws_sdk_route53_recovery_readiness.types.update_cell_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.update_cell_request.UpdateCellRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53_recovery_readiness.types.update_cell_request.serialize_json(
            input_
        )
    ).encode()
