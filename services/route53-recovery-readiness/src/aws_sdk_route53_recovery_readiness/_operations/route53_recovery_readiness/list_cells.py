...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.list_cells_response.ListCellsResponse = aws_sdk_route53_recovery_readiness.types.list_cells_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.list_cells_request.ListCellsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
