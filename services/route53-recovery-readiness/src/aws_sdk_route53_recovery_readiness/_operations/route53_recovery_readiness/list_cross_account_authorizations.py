...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.list_cross_account_authorizations_response.ListCrossAccountAuthorizationsResponse = aws_sdk_route53_recovery_readiness.types.list_cross_account_authorizations_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.list_cross_account_authorizations_request.ListCrossAccountAuthorizationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
