"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#UntagResource``."""
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
