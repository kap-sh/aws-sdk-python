"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#UpdateResourceSet``."""
...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.update_resource_set_response.UpdateResourceSetResponse = aws_sdk_route53_recovery_readiness.types.update_resource_set_response.deserialize_json(
...
def build_request(
    ...
    input: aws_sdk_route53_recovery_readiness.types.update_resource_set_request.UpdateResourceSetRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{ResourceSetName}", quote(str(input["resource_set_name"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_route53_recovery_readiness.types.update_resource_set_request.serialize_json(
            input
        )
    ).encode()
...
async def async_update_resource_set(
