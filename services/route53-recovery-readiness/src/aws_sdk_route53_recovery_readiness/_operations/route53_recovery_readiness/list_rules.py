...
def handle_response(
    ...
    out: aws_sdk_route53_recovery_readiness.types.list_rules_response.ListRulesResponse = aws_sdk_route53_recovery_readiness.types.list_rules_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_route53_recovery_readiness.types.list_rules_request.ListRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
