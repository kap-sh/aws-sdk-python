...
if TYPE_CHECKING:
    import aws_sdk_route53_recovery_readiness.types.__list_of_recommendation
    import aws_sdk_route53_recovery_readiness.types.__string
    import aws_sdk_route53_recovery_readiness.types.last_audit_timestamp


class GetArchitectureRecommendationsResponse(TypedDict):
    last_audit_timestamp: NotRequired[
        "aws_sdk_route53_recovery_readiness.types.last_audit_timestamp.LastAuditTimestamp"
    ]
    ...
    recommendations: NotRequired[
        "aws_sdk_route53_recovery_readiness.types.__list_of_recommendation.__listOfRecommendation"
    ]
...
def serialize_json(value: GetArchitectureRecommendationsResponse) -> dict:
    ...
    if "last_audit_timestamp" in value:
        ...
        out["lastAuditTimestamp"] = (
            aws_sdk_route53_recovery_readiness.types.last_audit_timestamp.serialize_json(
    ...
    if "recommendations" in value:
        ...
        out["recommendations"] = (
            aws_sdk_route53_recovery_readiness.types.__list_of_recommendation.serialize_json(
...
def deserialize_json(data: dict) -> GetArchitectureRecommendationsResponse:
    ...
    if "lastAuditTimestamp" in data:
        ...
        out["last_audit_timestamp"] = (
            aws_sdk_route53_recovery_readiness.types.last_audit_timestamp.deserialize_json(
    ...
    if "recommendations" in data:
        ...
        out["recommendations"] = (
            aws_sdk_route53_recovery_readiness.types.__list_of_recommendation.deserialize_json(
