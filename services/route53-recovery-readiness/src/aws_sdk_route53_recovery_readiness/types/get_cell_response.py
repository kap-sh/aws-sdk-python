"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#GetCellResponse``."""
...
class GetCellResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetCellResponse) -> dict:
    out: dict = {}
