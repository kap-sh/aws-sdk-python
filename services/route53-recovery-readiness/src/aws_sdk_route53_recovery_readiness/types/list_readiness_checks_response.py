...
if TYPE_CHECKING:
    import aws_sdk_route53_recovery_readiness.types.__list_of_readiness_check_output
    import aws_sdk_route53_recovery_readiness.types.__string


class ListReadinessChecksResponse(TypedDict):
    next_token: NotRequired[
        "aws_sdk_route53_recovery_readiness.types.__string.__string"
    ]
    """<p>The token that identifies which batch of results you want to see.</p>"""
    readiness_checks: NotRequired[
        "aws_sdk_route53_recovery_readiness.types.__list_of_readiness_check_output.__listOfReadinessCheckOutput"
    ]
...
def serialize_json(value: ListReadinessChecksResponse) -> dict:
    ...
    if "readiness_checks" in value:
        ...
        out["readinessChecks"] = (
            aws_sdk_route53_recovery_readiness.types.__list_of_readiness_check_output.serialize_json(
...
def deserialize_json(data: dict) -> ListReadinessChecksResponse:
    ...
    if "readinessChecks" in data:
        ...
        out["readiness_checks"] = (
            aws_sdk_route53_recovery_readiness.types.__list_of_readiness_check_output.deserialize_json(
