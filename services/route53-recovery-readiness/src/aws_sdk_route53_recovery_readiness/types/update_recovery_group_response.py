"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#UpdateRecoveryGroupResponse``."""
...
class UpdateRecoveryGroupResponse(TypedDict, closed=True):
    cells: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateRecoveryGroupResponse) -> dict:
    out: dict = {}
    if "cells" in value:
        import aws_sdk_route53_recovery_readiness.types.__list_of__string
