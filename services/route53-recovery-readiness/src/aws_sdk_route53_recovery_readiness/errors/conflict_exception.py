"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.route53recoveryreadiness#ConflictException``."""
