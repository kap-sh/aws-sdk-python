...
class ListAdminAccountsForOrganizationResponse(TypedDict):
    admin_accounts: NotRequired[
        "aws_sdk_fms.types.admin_account_summary_list.AdminAccountSummaryList"
    ]
...
def serialize_aws_json_1_1(value: ListAdminAccountsForOrganizationResponse) -> dict:
    ...
    if "admin_accounts" in value:
        ...
        out["AdminAccounts"] = (
            aws_sdk_fms.types.admin_account_summary_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListAdminAccountsForOrganizationResponse:
    ...
    if "AdminAccounts" in data:
        ...
        out["admin_accounts"] = (
            aws_sdk_fms.types.admin_account_summary_list.deserialize_aws_json_1_1(
                data["AdminAccounts"]
            )
        )
