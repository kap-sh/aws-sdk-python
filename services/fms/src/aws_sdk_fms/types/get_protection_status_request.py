...
class GetProtectionStatusRequest(TypedDict, closed=True):
    ...
    start_time: NotRequired["aws_sdk_fms.types.time_stamp.TimeStamp"]
    ...
    end_time: NotRequired["aws_sdk_fms.types.time_stamp.TimeStamp"]
...
def serialize_aws_json_1_1(value: GetProtectionStatusRequest) -> dict:
    ...
    if "start_time" in value:
        ...
        out["StartTime"] = aws_sdk_fms.types.time_stamp.serialize_aws_json_1_1(
            value["start_time"]
        )
    if "end_time" in value:
        import aws_sdk_fms.types.time_stamp

        out["EndTime"] = aws_sdk_fms.types.time_stamp.serialize_aws_json_1_1(
            value["end_time"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetProtectionStatusRequest:
    ...
    if "StartTime" in data:
        ...
        out["start_time"] = aws_sdk_fms.types.time_stamp.deserialize_aws_json_1_1(
            data["StartTime"]
        )
    if "EndTime" in data:
        import aws_sdk_fms.types.time_stamp

        out["end_time"] = aws_sdk_fms.types.time_stamp.deserialize_aws_json_1_1(
            data["EndTime"]
        )
