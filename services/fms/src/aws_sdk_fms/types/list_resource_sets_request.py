"""Generated from Smithy shape ``com.amazonaws.fms#ListResourceSetsRequest``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListResourceSetsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListResourceSetsRequest:
