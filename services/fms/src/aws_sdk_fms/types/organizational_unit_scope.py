...
if TYPE_CHECKING:
    ...
    import aws_sdk_fms.types.organizational_unit_id_list


class OrganizationalUnitScope(TypedDict):
    organizational_units: NotRequired[
        "aws_sdk_fms.types.organizational_unit_id_list.OrganizationalUnitIdList"
    ]
    ...
    all_organizational_units_enabled: "aws_sdk_fms.types.boolean.Boolean"
    ...
    exclude_specified_organizational_units: "aws_sdk_fms.types.boolean.Boolean"
...
def serialize_aws_json_1_1(value: OrganizationalUnitScope) -> dict:
    ...
    if "organizational_units" in value:
        ...
        out["OrganizationalUnits"] = (
            aws_sdk_fms.types.organizational_unit_id_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> OrganizationalUnitScope:
    ...
    if "OrganizationalUnits" in data:
        ...
        out["organizational_units"] = (
            aws_sdk_fms.types.organizational_unit_id_list.deserialize_aws_json_1_1(
