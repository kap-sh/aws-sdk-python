...
ProtocolsListsData: TypeAlias = list[
    "aws_sdk_fms.types.protocols_list_data_summary.ProtocolsListDataSummary"
]
...
def serialize_aws_json_1_1(value: ProtocolsListsData) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_fms.types.protocols_list_data_summary.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ProtocolsListsData:
    ...
    for item in data:
        out.append(
            aws_sdk_fms.types.protocols_list_data_summary.deserialize_aws_json_1_1(item)
        )
    return out
