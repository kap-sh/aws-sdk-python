...
class NetworkFirewallInvalidRouteConfigurationViolation(TypedDict):
    affected_subnets: NotRequired["aws_sdk_fms.types.resource_id_list.ResourceIdList"]
    ...
    violating_route: NotRequired["aws_sdk_fms.types.route.Route"]
    ...
    actual_firewall_endpoint: NotRequired["aws_sdk_fms.types.resource_id.ResourceId"]
    """<p>The actual firewall endpoint.</p>"""
    expected_firewall_subnet_id: NotRequired["aws_sdk_fms.types.resource_id.ResourceId"]
    """<p>The expected subnet ID for the firewall.</p>"""
    actual_firewall_subnet_id: NotRequired["aws_sdk_fms.types.resource_id.ResourceId"]
...
def serialize_aws_json_1_1(
    ...
    if "violating_route" in value:
        ...
        out["ViolatingRoute"] = aws_sdk_fms.types.route.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "ViolatingRoute" in data:
        ...
        out["violating_route"] = aws_sdk_fms.types.route.deserialize_aws_json_1_1(
            data["ViolatingRoute"]
        )
