...
if TYPE_CHECKING:
    ...
    import aws_sdk_fms.types.resource_arn_list


class WebACLHasOutOfScopeResourcesViolation(TypedDict):
    web_acl_arn: NotRequired["aws_sdk_fms.types.resource_arn.ResourceArn"]
    """<p>The Amazon Resource Name (ARN) of the web ACL. </p>"""
    out_of_scope_resource_list: NotRequired[
        "aws_sdk_fms.types.resource_arn_list.ResourceArnList"
    ]
...
def serialize_aws_json_1_1(value: WebACLHasOutOfScopeResourcesViolation) -> dict:
    ...
    if "out_of_scope_resource_list" in value:
        ...
        out["OutOfScopeResourceList"] = (
            aws_sdk_fms.types.resource_arn_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> WebACLHasOutOfScopeResourcesViolation:
    ...
    if "OutOfScopeResourceList" in data:
        ...
        out["out_of_scope_resource_list"] = (
            aws_sdk_fms.types.resource_arn_list.deserialize_aws_json_1_1(
