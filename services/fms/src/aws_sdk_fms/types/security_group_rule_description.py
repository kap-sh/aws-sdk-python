...
class SecurityGroupRuleDescription(TypedDict, closed=True):
    ...
    prefix_list_id: NotRequired["aws_sdk_fms.types.resource_id.ResourceId"]
    """<p>The ID of the prefix list for the security group rule.</p>"""
    protocol: NotRequired["aws_sdk_fms.types.length_bounded_string.LengthBoundedString"]
    """<p>The IP protocol name (<code>tcp</code>, <code>udp</code>, <code>icmp</code>, <code>icmpv6</code>) or number.</p>"""
    from_port: NotRequired["aws_sdk_fms.types.ip_port_number.IPPortNumber"]
    ...
    to_port: NotRequired["aws_sdk_fms.types.ip_port_number.IPPortNumber"]
