...
if TYPE_CHECKING:
    import aws_sdk_fms.types.dns_rule_group_priorities
...
class DnsRuleGroupPriorityConflictViolation(TypedDict):
    ...
    conflicting_policy_id: NotRequired["aws_sdk_fms.types.policy_id.PolicyId"]
    ...
    unavailable_priorities: NotRequired[
        "aws_sdk_fms.types.dns_rule_group_priorities.DnsRuleGroupPriorities"
    ]
...
def serialize_aws_json_1_1(value: DnsRuleGroupPriorityConflictViolation) -> dict:
    ...
    if "unavailable_priorities" in value:
        ...
        out["UnavailablePriorities"] = (
            aws_sdk_fms.types.dns_rule_group_priorities.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DnsRuleGroupPriorityConflictViolation:
    ...
    if "UnavailablePriorities" in data:
        ...
        out["unavailable_priorities"] = (
            aws_sdk_fms.types.dns_rule_group_priorities.deserialize_aws_json_1_1(
