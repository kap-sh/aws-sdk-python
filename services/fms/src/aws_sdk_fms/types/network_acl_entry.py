...
if TYPE_CHECKING:
    ...
    import aws_sdk_fms.types.length_bounded_non_empty_string
    import aws_sdk_fms.types.length_bounded_string
    import aws_sdk_fms.types.network_acl_icmp_type_code
    import aws_sdk_fms.types.network_acl_port_range
    import aws_sdk_fms.types.network_acl_rule_action


class NetworkAclEntry(TypedDict):
    icmp_type_code: NotRequired[
        "aws_sdk_fms.types.network_acl_icmp_type_code.NetworkAclIcmpTypeCode"
    ]
    ...
    cidr_block: NotRequired[
        "aws_sdk_fms.types.length_bounded_non_empty_string.LengthBoundedNonEmptyString"
    ]
    ...
    rule_action: "aws_sdk_fms.types.network_acl_rule_action.NetworkAclRuleAction"
    """<p>Indicates whether to allow or deny the traffic that matches the rule.</p>"""
    egress: "aws_sdk_fms.types.boolean_object.BooleanObject"
...
def serialize_aws_json_1_1(value: NetworkAclEntry) -> dict:
    ...
    if "icmp_type_code" in value:
        ...
        out["IcmpTypeCode"] = (
            aws_sdk_fms.types.network_acl_icmp_type_code.serialize_aws_json_1_1(
    ...
    if "port_range" in value:
        ...
        out["PortRange"] = (
            aws_sdk_fms.types.network_acl_port_range.serialize_aws_json_1_1(
                value["port_range"]
            )
        )
    ...
    out["RuleAction"] = (
        aws_sdk_fms.types.network_acl_rule_action.serialize_aws_json_1_1(
            value["rule_action"]
        )
    )
...
def deserialize_aws_json_1_1(data: dict) -> NetworkAclEntry:
    ...
    if "IcmpTypeCode" in data:
        ...
        out["icmp_type_code"] = (
            aws_sdk_fms.types.network_acl_icmp_type_code.deserialize_aws_json_1_1(
                data["IcmpTypeCode"]
            )
        )
    if "Protocol" in data:
    ...
    if "PortRange" in data:
        ...
        out["port_range"] = (
            aws_sdk_fms.types.network_acl_port_range.deserialize_aws_json_1_1(
                data["PortRange"]
            )
        )
    ...
    if "RuleAction" in data:
        ...
        out["rule_action"] = (
            aws_sdk_fms.types.network_acl_rule_action.deserialize_aws_json_1_1(
                data["RuleAction"]
            )
        )
    else:
