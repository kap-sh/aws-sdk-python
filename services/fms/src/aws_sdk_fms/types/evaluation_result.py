...
if TYPE_CHECKING:
    ...
    import aws_sdk_fms.types.policy_compliance_status_type
    import aws_sdk_fms.types.resource_count


class EvaluationResult(TypedDict, closed=True):
    compliance_status: NotRequired[
        "aws_sdk_fms.types.policy_compliance_status_type.PolicyComplianceStatusType"
    ]
    """<p>Describes an Amazon Web Services account's compliance with the Firewall Manager policy.</p>"""
    violator_count: "aws_sdk_fms.types.resource_count.ResourceCount"
...
def serialize_aws_json_1_1(value: EvaluationResult) -> dict:
    ...
    if "compliance_status" in value:
        ...
        out["ComplianceStatus"] = (
            aws_sdk_fms.types.policy_compliance_status_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> EvaluationResult:
    ...
    if "ComplianceStatus" in data:
        ...
        out["compliance_status"] = (
            aws_sdk_fms.types.policy_compliance_status_type.deserialize_aws_json_1_1(
