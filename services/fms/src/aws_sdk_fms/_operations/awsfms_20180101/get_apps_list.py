"""Generated from Smithy shape ``com.amazonaws.fms#GetAppsList``."""
...
def handle_response(
    ...
    out: aws_sdk_fms.types.get_apps_list_response.GetAppsListResponse = (
        aws_sdk_fms.types.get_apps_list_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.get_apps_list_request.GetAppsListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.GetAppsList"
    import aws_sdk_fms.types.get_apps_list_request

    body: bytes | None = json.dumps(
        aws_sdk_fms.types.get_apps_list_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_apps_list(
    ...
    aws_sdk_fms.types.get_apps_list_response.GetAppsListResponse, zapros.Response
]:
