...
def build_request(
    ...
    input: aws_sdk_fms.types.list_protocols_lists_request.ListProtocolsListsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.list_protocols_lists_request.serialize_aws_json_1_1(input)
    ).encode()
