...
def handle_response(
    ...
    out: aws_sdk_fms.types.list_protocols_lists_response.ListProtocolsListsResponse = (
        aws_sdk_fms.types.list_protocols_lists_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.list_protocols_lists_request.ListProtocolsListsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.list_protocols_lists_request.serialize_aws_json_1_1(input_)
    ).encode()
