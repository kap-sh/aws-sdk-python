...
def build_request(
    ...
    input_: aws_sdk_fms.types.put_notification_channel_request.PutNotificationChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.put_notification_channel_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
