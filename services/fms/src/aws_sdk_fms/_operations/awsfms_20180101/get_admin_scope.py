"""Generated from Smithy shape ``com.amazonaws.fms#GetAdminScope``."""
...
def handle_response(
    ...
    out: aws_sdk_fms.types.get_admin_scope_response.GetAdminScopeResponse = (
        aws_sdk_fms.types.get_admin_scope_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.get_admin_scope_request.GetAdminScopeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.GetAdminScope"
    import aws_sdk_fms.types.get_admin_scope_request

    body: bytes | None = json.dumps(
        aws_sdk_fms.types.get_admin_scope_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_admin_scope(
    ...
    aws_sdk_fms.types.get_admin_scope_response.GetAdminScopeResponse, zapros.Response
]:
...
async def async_get_admin_scope(
