"""Generated from Smithy shape ``com.amazonaws.fms#AssociateThirdPartyFirewall``."""
...
def handle_response(
    ...
    out: aws_sdk_fms.types.associate_third_party_firewall_response.AssociateThirdPartyFirewallResponse = aws_sdk_fms.types.associate_third_party_firewall_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.associate_third_party_firewall_request.AssociateThirdPartyFirewallRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.AssociateThirdPartyFirewall"
    import aws_sdk_fms.types.associate_third_party_firewall_request

    body: bytes | None = json.dumps(
        aws_sdk_fms.types.associate_third_party_firewall_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_third_party_firewall(
