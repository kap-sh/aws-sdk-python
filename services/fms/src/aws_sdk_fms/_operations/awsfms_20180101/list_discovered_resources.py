...
def handle_response(
    ...
    out: aws_sdk_fms.types.list_discovered_resources_response.ListDiscoveredResourcesResponse = aws_sdk_fms.types.list_discovered_resources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.list_discovered_resources_request.ListDiscoveredResourcesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.list_discovered_resources_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
