...
def handle_response(
    ...
    out: aws_sdk_fms.types.list_apps_lists_response.ListAppsListsResponse = (
        aws_sdk_fms.types.list_apps_lists_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.list_apps_lists_request.ListAppsListsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.list_apps_lists_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_apps_lists(
    ...
    aws_sdk_fms.types.list_apps_lists_response.ListAppsListsResponse, zapros.Response
]:
