"""Generated from Smithy shape ``com.amazonaws.fms#GetViolationDetails``."""
...
def handle_response(
    ...
    out: aws_sdk_fms.types.get_violation_details_response.GetViolationDetailsResponse = aws_sdk_fms.types.get_violation_details_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_fms.types.get_violation_details_request.GetViolationDetailsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.get_violation_details_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_get_violation_details(
