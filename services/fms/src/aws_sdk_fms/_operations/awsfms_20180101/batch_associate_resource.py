"""Generated from Smithy shape ``com.amazonaws.fms#BatchAssociateResource``."""
...
def handle_response(
    ...
    out: aws_sdk_fms.types.batch_associate_resource_response.BatchAssociateResourceResponse = aws_sdk_fms.types.batch_associate_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_fms.types.batch_associate_resource_request.BatchAssociateResourceRequest,
) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.BatchAssociateResource"
    import aws_sdk_fms.types.batch_associate_resource_request

    body: bytes | None = json.dumps(
        aws_sdk_fms.types.batch_associate_resource_request.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_batch_associate_resource(
