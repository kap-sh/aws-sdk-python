"""Generated from Smithy shape ``com.amazonaws.fms#GetResourceSet``."""
...
def handle_response(
    ...
    out: aws_sdk_fms.types.get_resource_set_response.GetResourceSetResponse = (
        aws_sdk_fms.types.get_resource_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.get_resource_set_request.GetResourceSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.GetResourceSet"
    import aws_sdk_fms.types.get_resource_set_request

    body: bytes | None = json.dumps(
        aws_sdk_fms.types.get_resource_set_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_resource_set(
    ...
    aws_sdk_fms.types.get_resource_set_response.GetResourceSetResponse, zapros.Response
]:
