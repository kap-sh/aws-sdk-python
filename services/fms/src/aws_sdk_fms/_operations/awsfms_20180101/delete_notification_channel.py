"""Generated from Smithy shape ``com.amazonaws.fms#DeleteNotificationChannel``."""
...
def build_request(
    ...
    input_: aws_sdk_fms.types.delete_notification_channel_request.DeleteNotificationChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_notification_channel(
