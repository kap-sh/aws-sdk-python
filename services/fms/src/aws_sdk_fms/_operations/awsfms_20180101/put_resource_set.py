"""Generated from Smithy shape ``com.amazonaws.fms#PutResourceSet``."""
...
def handle_response(
    ...
    out: aws_sdk_fms.types.put_resource_set_response.PutResourceSetResponse = (
        aws_sdk_fms.types.put_resource_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.put_resource_set_request.PutResourceSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.PutResourceSet"
    import aws_sdk_fms.types.put_resource_set_request

    body: bytes | None = json.dumps(
        aws_sdk_fms.types.put_resource_set_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_resource_set(
    ...
    aws_sdk_fms.types.put_resource_set_response.PutResourceSetResponse, zapros.Response
]:
...
async def async_put_resource_set(
