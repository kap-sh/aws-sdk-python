"""Generated from Smithy shape ``com.amazonaws.fms#GetPolicy``."""
...
import aws_sdk_fms.errors.invalid_type_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTypeException":
            raise aws_sdk_fms.errors.invalid_type_exception.InvalidTypeException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_fms.types.get_policy_response.GetPolicyResponse = (
        aws_sdk_fms.types.get_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.get_policy_request.GetPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.get_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_policy(
    ...
    input_: aws_sdk_fms.types.get_policy_request.GetPolicyRequest,
) -> tuple[aws_sdk_fms.types.get_policy_response.GetPolicyResponse, zapros.Response]:
