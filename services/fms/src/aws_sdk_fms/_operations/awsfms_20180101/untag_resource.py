...
def handle_response(
    ...
    out: aws_sdk_fms.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_fms.types.untag_resource_request.UntagResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.untag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def untag_resource(
    ...
    aws_sdk_fms.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
