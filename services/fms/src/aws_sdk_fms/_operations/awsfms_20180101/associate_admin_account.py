...
def build_request(
    ...
    input: aws_sdk_fms.types.associate_admin_account_request.AssociateAdminAccountRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.associate_admin_account_request.serialize_aws_json_1_1(input)
    ).encode()
