...
def handle_response(
    ...
    out: aws_sdk_fms.types.put_apps_list_response.PutAppsListResponse = (
        aws_sdk_fms.types.put_apps_list_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.put_apps_list_request.PutAppsListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.put_apps_list_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_apps_list(
    ...
    aws_sdk_fms.types.put_apps_list_response.PutAppsListResponse, zapros.Response
]:
