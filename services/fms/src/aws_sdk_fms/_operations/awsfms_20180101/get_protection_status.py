...
def build_request(
    ...
    input: aws_sdk_fms.types.get_protection_status_request.GetProtectionStatusRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.get_protection_status_request.serialize_aws_json_1_1(input)
    ).encode()
