"""Generated from Smithy shape ``com.amazonaws.fms#GetComplianceDetail``."""
...
def handle_response(
    ...
    out: aws_sdk_fms.types.get_compliance_detail_response.GetComplianceDetailResponse = aws_sdk_fms.types.get_compliance_detail_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.get_compliance_detail_request.GetComplianceDetailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.get_compliance_detail_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_compliance_detail(
