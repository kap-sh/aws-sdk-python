...
def build_request(
    ...
    input: aws_sdk_fms.types.get_compliance_detail_request.GetComplianceDetailRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.get_compliance_detail_request.serialize_aws_json_1_1(input)
    ).encode()
