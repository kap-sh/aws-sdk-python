...
def build_request(
    ...
    input: aws_sdk_fms.types.delete_protocols_list_request.DeleteProtocolsListRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.delete_protocols_list_request.serialize_aws_json_1_1(input)
    ).encode()
