...
def handle_response(
    ...
    out: aws_sdk_fms.types.get_admin_account_response.GetAdminAccountResponse = (
        aws_sdk_fms.types.get_admin_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.get_admin_account_request.GetAdminAccountRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
