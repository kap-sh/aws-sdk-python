...
def handle_response(
    ...
    out: aws_sdk_fms.types.put_protocols_list_response.PutProtocolsListResponse = (
        aws_sdk_fms.types.put_protocols_list_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.put_protocols_list_request.PutProtocolsListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.put_protocols_list_request.serialize_aws_json_1_1(input_)
    ).encode()
