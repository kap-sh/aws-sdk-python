"""Generated from Smithy shape ``com.amazonaws.fms#GetThirdPartyFirewallAssociationStatus``."""
...
import aws_sdk_fms.errors.resource_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceNotFoundException":
            raise aws_sdk_fms.errors.resource_not_found_exception.ResourceNotFoundException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_fms.types.get_third_party_firewall_association_status_response.GetThirdPartyFirewallAssociationStatusResponse = aws_sdk_fms.types.get_third_party_firewall_association_status_response.deserialize_aws_json_1_1(
...
def get_signer(
...
) -> aws_sdk_fms._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_fms._auth._sigv4.build_sigv4_auth_scheme("fms", options.region)
        )
        if sigv4_config is not None:
            return aws_sdk_fms._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.get_third_party_firewall_association_status_request.GetThirdPartyFirewallAssociationStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.GetThirdPartyFirewallAssociationStatus"
    import aws_sdk_fms.types.get_third_party_firewall_association_status_request

    body: bytes | None = json.dumps(
        aws_sdk_fms.types.get_third_party_firewall_association_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_third_party_firewall_association_status(
