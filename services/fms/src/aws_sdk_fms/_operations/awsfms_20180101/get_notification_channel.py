...
def handle_response(
    ...
    out: aws_sdk_fms.types.get_notification_channel_response.GetNotificationChannelResponse = aws_sdk_fms.types.get_notification_channel_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.get_notification_channel_request.GetNotificationChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
