"""Generated from Smithy shape ``com.amazonaws.fms#ListAdminAccountsForOrganization``."""
...
import aws_sdk_fms.types.admin_account_summary_list
...
def handle_response(
    ...
    out: aws_sdk_fms.types.list_admin_accounts_for_organization_response.ListAdminAccountsForOrganizationResponse = aws_sdk_fms.types.list_admin_accounts_for_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.list_admin_accounts_for_organization_request.ListAdminAccountsForOrganizationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.ListAdminAccountsForOrganization"
    import aws_sdk_fms.types.list_admin_accounts_for_organization_request

    body: bytes | None = json.dumps(
        aws_sdk_fms.types.list_admin_accounts_for_organization_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_admin_accounts_for_organization(
