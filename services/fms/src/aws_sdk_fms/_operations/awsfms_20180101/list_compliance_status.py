...
def build_request(
    ...
    input: aws_sdk_fms.types.list_compliance_status_request.ListComplianceStatusRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.list_compliance_status_request.serialize_aws_json_1_1(input)
    ).encode()
