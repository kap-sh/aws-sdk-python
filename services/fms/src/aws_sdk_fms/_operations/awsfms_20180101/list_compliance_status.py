"""Generated from Smithy shape ``com.amazonaws.fms#ListComplianceStatus``."""
...
def handle_response(
    ...
    out: aws_sdk_fms.types.list_compliance_status_response.ListComplianceStatusResponse = aws_sdk_fms.types.list_compliance_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.list_compliance_status_request.ListComplianceStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.list_compliance_status_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_compliance_status(
