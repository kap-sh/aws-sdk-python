...
def handle_response(
    ...
    out: aws_sdk_fms.types.put_policy_response.PutPolicyResponse = (
        aws_sdk_fms.types.put_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.put_policy_request.PutPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.put_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_policy(
    ...
    input_: aws_sdk_fms.types.put_policy_request.PutPolicyRequest,
) -> tuple[aws_sdk_fms.types.put_policy_response.PutPolicyResponse, zapros.Response]:
