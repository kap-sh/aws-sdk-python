...
def handle_response(
    ...
    out: aws_sdk_fms.types.list_member_accounts_response.ListMemberAccountsResponse = (
        aws_sdk_fms.types.list_member_accounts_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.list_member_accounts_request.ListMemberAccountsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_fms.types.list_member_accounts_request.serialize_aws_json_1_1(input_)
    ).encode()
