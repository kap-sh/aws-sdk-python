"""Generated from Smithy shape ``com.amazonaws.fms#BatchDisassociateResource``."""
...
def handle_response(
    ...
    out: aws_sdk_fms.types.batch_disassociate_resource_response.BatchDisassociateResourceResponse = aws_sdk_fms.types.batch_disassociate_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.batch_disassociate_resource_request.BatchDisassociateResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.BatchDisassociateResource"
    import aws_sdk_fms.types.batch_disassociate_resource_request

    body: bytes | None = json.dumps(
        aws_sdk_fms.types.batch_disassociate_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_disassociate_resource(
