...
def handle_response(
    ...
    out: aws_sdk_fms.types.list_third_party_firewall_firewall_policies_response.ListThirdPartyFirewallFirewallPoliciesResponse = aws_sdk_fms.types.list_third_party_firewall_firewall_policies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_fms.types.list_third_party_firewall_firewall_policies_request.ListThirdPartyFirewallFirewallPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
