"""Generated from Smithy shape ``com.amazonaws.fms#NetworkFirewallMissingFirewallViolation``."""
...
class NetworkFirewallMissingFirewallViolation(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: NetworkFirewallMissingFirewallViolation) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> NetworkFirewallMissingFirewallViolation:
    out: NetworkFirewallMissingFirewallViolation = {}  # type: ignore[typeddict-item]
