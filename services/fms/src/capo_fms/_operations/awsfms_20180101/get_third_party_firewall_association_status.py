...
import capo_fms.errors.invalid_input_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidInputException":
            raise capo_fms.errors.invalid_input_exception.InvalidInputException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_fms.types.get_third_party_firewall_association_status_response.GetThirdPartyFirewallAssociationStatusResponse = capo_fms.types.get_third_party_firewall_association_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.get_third_party_firewall_association_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
