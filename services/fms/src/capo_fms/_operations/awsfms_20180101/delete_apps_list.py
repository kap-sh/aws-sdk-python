"""Generated from Smithy shape ``com.amazonaws.fms#DeleteAppsList``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.DeleteAppsList"
    body: bytes | None = json.dumps(
        capo_fms.types.delete_apps_list_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_apps_list(
