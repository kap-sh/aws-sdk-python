"""Generated from Smithy shape ``com.amazonaws.fms#ListResourceSets``."""
...
def handle_response(
    ...
    out: capo_fms.types.list_resource_sets_response.ListResourceSetsResponse = (
        capo_fms.types.list_resource_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.ListResourceSets"
    body: bytes | None = json.dumps(
        capo_fms.types.list_resource_sets_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_resource_sets(
    ...
    capo_fms.types.list_resource_sets_response.ListResourceSetsResponse, zapros.Response
]:
