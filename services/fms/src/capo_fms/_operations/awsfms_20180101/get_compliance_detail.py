...
def handle_response(
    ...
    out: capo_fms.types.get_compliance_detail_response.GetComplianceDetailResponse = (
        capo_fms.types.get_compliance_detail_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.get_compliance_detail_request.serialize_aws_json_1_1(input_)
    ).encode()
