"""Generated from Smithy shape ``com.amazonaws.fms#GetProtectionStatus``."""
...
def handle_response(
    ...
    out: capo_fms.types.get_protection_status_response.GetProtectionStatusResponse = (
        capo_fms.types.get_protection_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.get_protection_status_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_protection_status(
