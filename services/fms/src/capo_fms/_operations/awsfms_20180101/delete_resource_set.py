"""Generated from Smithy shape ``com.amazonaws.fms#DeleteResourceSet``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.DeleteResourceSet"
    body: bytes | None = json.dumps(
        capo_fms.types.delete_resource_set_request.serialize_aws_json_1_1(input_)
    ).encode()
