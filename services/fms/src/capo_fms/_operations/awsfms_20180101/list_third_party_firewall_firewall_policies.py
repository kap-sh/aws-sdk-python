"""Generated from Smithy shape ``com.amazonaws.fms#ListThirdPartyFirewallFirewallPolicies``."""
...
def handle_response(
    ...
    out: capo_fms.types.list_third_party_firewall_firewall_policies_response.ListThirdPartyFirewallFirewallPoliciesResponse = capo_fms.types.list_third_party_firewall_firewall_policies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.list_third_party_firewall_firewall_policies_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_third_party_firewall_firewall_policies(
