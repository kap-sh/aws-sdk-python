"""Generated from Smithy shape ``com.amazonaws.fms#ListResourceSetResources``."""
...
import capo_fms.types.resource_list
...
def handle_response(
    ...
    out: capo_fms.types.list_resource_set_resources_response.ListResourceSetResourcesResponse = capo_fms.types.list_resource_set_resources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.ListResourceSetResources"
    body: bytes | None = json.dumps(
        capo_fms.types.list_resource_set_resources_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_resource_set_resources(
