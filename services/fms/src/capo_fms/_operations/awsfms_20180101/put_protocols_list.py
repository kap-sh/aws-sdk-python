"""Generated from Smithy shape ``com.amazonaws.fms#PutProtocolsList``."""
...
def handle_response(
    ...
    out: capo_fms.types.put_protocols_list_response.PutProtocolsListResponse = (
        capo_fms.types.put_protocols_list_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.PutProtocolsList"
    body: bytes | None = json.dumps(
        capo_fms.types.put_protocols_list_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_protocols_list(
    ...
    capo_fms.types.put_protocols_list_response.PutProtocolsListResponse, zapros.Response
]:
...
async def async_put_protocols_list(
