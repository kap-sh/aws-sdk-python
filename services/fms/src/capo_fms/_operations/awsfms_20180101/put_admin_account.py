"""Generated from Smithy shape ``com.amazonaws.fms#PutAdminAccount``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.PutAdminAccount"
    body: bytes | None = json.dumps(
        capo_fms.types.put_admin_account_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_put_admin_account(
