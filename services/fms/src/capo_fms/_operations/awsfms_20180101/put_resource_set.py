...
def handle_response(
    ...
    out: capo_fms.types.put_resource_set_response.PutResourceSetResponse = (
        capo_fms.types.put_resource_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.put_resource_set_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def put_resource_set(
    ...
    capo_fms.types.put_resource_set_response.PutResourceSetResponse, zapros.Response
]:
