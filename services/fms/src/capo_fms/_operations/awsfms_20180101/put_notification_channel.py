"""Generated from Smithy shape ``com.amazonaws.fms#PutNotificationChannel``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.put_notification_channel_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_put_notification_channel(
