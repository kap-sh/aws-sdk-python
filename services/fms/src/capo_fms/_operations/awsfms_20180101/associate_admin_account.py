"""Generated from Smithy shape ``com.amazonaws.fms#AssociateAdminAccount``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.associate_admin_account_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_associate_admin_account(
