...
def handle_response(
    ...
    out: capo_fms.types.get_apps_list_response.GetAppsListResponse = (
        capo_fms.types.get_apps_list_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.get_apps_list_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_apps_list(
    ...
    input_: capo_fms.types.get_apps_list_request.GetAppsListRequest,
) -> tuple[capo_fms.types.get_apps_list_response.GetAppsListResponse, zapros.Response]:
