...
import capo_fms.errors.invalid_type_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTypeException":
            raise capo_fms.errors.invalid_type_exception.InvalidTypeException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_fms.types.get_policy_response.GetPolicyResponse = (
        capo_fms.types.get_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.get_policy_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_policy(
    ...
    input_: capo_fms.types.get_policy_request.GetPolicyRequest,
) -> tuple[capo_fms.types.get_policy_response.GetPolicyResponse, zapros.Response]:
