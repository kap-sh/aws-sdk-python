...
from aws_sdk_fms._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_1_for_region_af_south_1_with_fips_disabled():
    ...
    assert result.url == 'https://fms.af-south-1.amazonaws.com'
...
def test_2_for_region_af_south_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.af-south-1.amazonaws.com'
...
def test_3_for_region_ap_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.ap-east-1.amazonaws.com'
...
def test_4_for_region_ap_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.ap-east-1.amazonaws.com'
...
def test_5_for_region_ap_northeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.ap-northeast-1.amazonaws.com'
...
def test_6_for_region_ap_northeast_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.ap-northeast-1.amazonaws.com'
...
def test_7_for_region_ap_northeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.ap-northeast-2.amazonaws.com'
...
def test_8_for_region_ap_northeast_2_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.ap-northeast-2.amazonaws.com'
...
def test_9_for_region_ap_northeast_3_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.ap-northeast-3.amazonaws.com'
...
def test_10_for_region_ap_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.ap-south-1.amazonaws.com'

def test_11_for_region_ap_south_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.ap-south-1.amazonaws.com'
...
def test_12_for_region_ap_southeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.ap-southeast-1.amazonaws.com'

def test_13_for_region_ap_southeast_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.ap-southeast-1.amazonaws.com'
...
def test_14_for_region_ap_southeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.ap-southeast-2.amazonaws.com'

def test_15_for_region_ap_southeast_2_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.ap-southeast-2.amazonaws.com'
...
def test_16_for_region_ca_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.ca-central-1.amazonaws.com'

def test_17_for_region_ca_central_1_with_fips_enable():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.ca-central-1.amazonaws.com'
...
def test_18_for_region_eu_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.eu-central-1.amazonaws.com'

def test_19_for_region_eu_central_1_with_fips_enable():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.eu-central-1.amazonaws.com'
...
def test_20_for_region_eu_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.eu-north-1.amazonaws.com'
...
def test_21_for_region_eu_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.eu-south-1.amazonaws.com'

def test_22_for_region_eu_south_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.eu-south-1.amazonaws.com'
...
def test_23_for_region_eu_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.eu-west-1.amazonaws.com'

def test_24_for_region_eu_west_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.eu-west-1.amazonaws.com'
...
def test_25_for_region_eu_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.eu-west-2.amazonaws.com'

def test_26_for_region_eu_west_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.eu-west-2.amazonaws.com'
...
def test_27_for_region_eu_west_3_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.eu-west-3.amazonaws.com'

def test_28_for_region_eu_west_3_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.eu-west-3.amazonaws.com'
...
def test_29_for_region_me_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.me-south-1.amazonaws.com'

def test_30_for_region_me_south_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.me-south-1.amazonaws.com'
...
def test_31_for_region_sa_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.sa-east-1.amazonaws.com'

def test_32_for_region_sa_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.sa-east-1.amazonaws.com'
...
def test_33_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.us-east-1.amazonaws.com'
...
def test_34_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.us-east-1.amazonaws.com'
...
def test_35_for_region_us_east_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.us-east-2.amazonaws.com'

def test_36_for_region_us_east_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.us-east-2.amazonaws.com'
...
def test_37_for_region_us_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.us-west-1.amazonaws.com'

def test_38_for_region_us_west_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.us-west-1.amazonaws.com'
...
def test_39_for_region_us_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.us-west-2.amazonaws.com'

def test_40_for_region_us_west_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.us-west-2.amazonaws.com'
...
def test_41_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.us-east-1.api.aws'

def test_42_for_region_us_east_1_with_fips_disabled_():
    """For region us-east-1 with FIPS disabled and DualStack enabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://fms.us-east-1.api.aws'
...
def test_43_for_region_cn_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.cn-north-1.amazonaws.com.cn'

def test_44_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.cn-northwest-1.amazonaws.com.cn'

def test_45_for_region_cn_north_1_with_fips_enabled_():
    """For region cn-north-1 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='cn-north-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://fms-fips.cn-north-1.api.amazonwebservices.com.cn'

def test_46_for_region_cn_north_1_with_fips_enabled_():
    """For region cn-north-1 with FIPS enabled and DualStack disabled"""
    params = EndpointParams(Region='cn-north-1', UseFIPS=True, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://fms-fips.cn-north-1.amazonaws.com.cn'
...
def test_47_for_region_cn_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.cn-north-1.api.amazonwebservices.com.cn'
...
def test_48_for_region_us_gov_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.us-gov-east-1.amazonaws.com'
...
def test_49_for_region_us_gov_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.us-gov-east-1.amazonaws.com'

def test_50_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.us-gov-west-1.amazonaws.com'

def test_51_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://fms-fips.us-gov-west-1.amazonaws.com'

def test_52_for_region_us_gov_east_1_with_fips_enabl():
    """For region us-gov-east-1 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='us-gov-east-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://fms-fips.us-gov-east-1.api.aws'
...
def test_53_for_region_us_gov_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://fms.us-gov-east-1.api.aws'

def test_54_for_region_us_iso_east_1_with_fips_enabl():
    """For region us-iso-east-1 with FIPS enabled and DualStack disabled"""
    params = EndpointParams(Region='us-iso-east-1', UseFIPS=True, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://fms-fips.us-iso-east-1.c2s.ic.gov'

def test_55_for_region_us_iso_east_1_with_fips_disab():
    """For region us-iso-east-1 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='us-iso-east-1', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://fms.us-iso-east-1.c2s.ic.gov'

def test_56_for_region_us_isob_east_1_with_fips_enab():
    """For region us-isob-east-1 with FIPS enabled and DualStack disabled"""
    params = EndpointParams(Region='us-isob-east-1', UseFIPS=True, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://fms-fips.us-isob-east-1.sc2s.sgov.gov'

def test_57_for_region_us_isob_east_1_with_fips_disa():
    """For region us-isob-east-1 with FIPS disabled and DualStack disabled"""
    params = EndpointParams(Region='us-isob-east-1', UseFIPS=False, UseDualStack=False)
    result = resolve(params)
    assert result.url == 'https://fms.us-isob-east-1.sc2s.sgov.gov'

def test_58_for_custom_endpoint_with_region_set_and_():
    """For custom endpoint with region set and fips disabled and dualstack disabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=False, UseDualStack=False, Endpoint='https://example.com')
    result = resolve(params)
    assert result.url == 'https://example.com'

def test_59_for_custom_endpoint_with_region_not_set_():
    """For custom endpoint with region not set and fips disabled and dualstack disabled"""
    params = EndpointParams(UseFIPS=False, UseDualStack=False, Endpoint='https://example.com')
    result = resolve(params)
    assert result.url == 'https://example.com'

def test_60_for_custom_endpoint_with_fips_enabled_an():
...
def test_61_for_custom_endpoint_with_fips_disabled_a():
