import pytest
from capo_cloudfront_keyvaluestore._rule_engine._endpoint_rule_set import EndpointParams, resolve
from capo_cloudfront_keyvaluestore._rule_engine._endpoint_runtime import EndpointError
import re
import zapros

def test_fips_should_error():
    """FIPS should error"""
...
def test_kvs_arn_must_be_provided_to_use_this_ser():
...
def test_kvs_arn_must_be_a_valid_arn():
...
def test_provided_arn_was_not_a_valid_cloudfront_():
...
def test_provided_arn_must_be_a_global_resource_a():
...
def test_arn_resource_type_is_invalid__expected__():
...
def test_cloudfront_keyvaluestore_is_not_supporte():
...
def test_valid_account_based_endpoint():
...
def test_valid_account_based_endpoint__with_sdk_r():
...
def test_valid_arn__different_partition__should_e():
...
def test_valid_account_based_endpoint_with_fips__():
...
def test_custom_sdk_endpoint_override_with_path_a():
...
def test_custom_override_with_different_partition():
