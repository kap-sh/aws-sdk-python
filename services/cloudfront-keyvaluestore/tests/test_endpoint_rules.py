...
def test_2_kvs_arn_must_be_provided_to_use_this_service():
...
def test_10_valid_account_based_endpoint__with_sdk_region():
...
def test_11_valid_arn__different_partition__should_error():
