"""Generated from Smithy shape ``com.amazonaws.cloudfrontkeyvaluestore#GetKey``."""
...
def handle_response(
    ...
    out: capo_cloudfront_keyvaluestore.types.get_key_response.GetKeyResponse = (
        capo_cloudfront_keyvaluestore.types.get_key_response.deserialize_json(
...
def get_key(
    ...
    capo_cloudfront_keyvaluestore.types.get_key_response.GetKeyResponse, zapros.Response
]:
