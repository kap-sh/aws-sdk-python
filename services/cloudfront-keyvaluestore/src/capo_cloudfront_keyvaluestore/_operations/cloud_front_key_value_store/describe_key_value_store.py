...
def handle_response(
    ...
    out: capo_cloudfront_keyvaluestore.types.describe_key_value_store_response.DescribeKeyValueStoreResponse = capo_cloudfront_keyvaluestore.types.describe_key_value_store_response.deserialize_json(
