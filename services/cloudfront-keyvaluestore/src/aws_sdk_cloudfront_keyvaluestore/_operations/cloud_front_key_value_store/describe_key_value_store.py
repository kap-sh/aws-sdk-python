...
def handle_response(
    ...
    out: aws_sdk_cloudfront_keyvaluestore.types.describe_key_value_store_response.DescribeKeyValueStoreResponse = aws_sdk_cloudfront_keyvaluestore.types.describe_key_value_store_response.deserialize_json(
