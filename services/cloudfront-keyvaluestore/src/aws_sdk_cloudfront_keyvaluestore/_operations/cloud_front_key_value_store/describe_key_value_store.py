"""Generated from Smithy shape ``com.amazonaws.cloudfrontkeyvaluestore#DescribeKeyValueStore``."""
...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cloudfront_keyvaluestore.types.describe_key_value_store_response.DescribeKeyValueStoreResponse:
    import aws_sdk_cloudfront_keyvaluestore.types.describe_key_value_store_response
    out: aws_sdk_cloudfront_keyvaluestore.types.describe_key_value_store_response.DescribeKeyValueStoreResponse = aws_sdk_cloudfront_keyvaluestore.types.describe_key_value_store_response.deserialize_json(json.loads(response.read()))
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cloudfront_keyvaluestore.types.describe_key_value_store_request.DescribeKeyValueStoreRequest) -> zapros.Request:
...
def describe_key_value_store(options: OperationOptions, input: aws_sdk_cloudfront_keyvaluestore.types.describe_key_value_store_request.DescribeKeyValueStoreRequest) -> tuple[aws_sdk_cloudfront_keyvaluestore.types.describe_key_value_store_response.DescribeKeyValueStoreResponse, zapros.Response]:
...
async def async_describe_key_value_store(options: AsyncOperationOptions, input: aws_sdk_cloudfront_keyvaluestore.types.describe_key_value_store_request.DescribeKeyValueStoreRequest) -> tuple[aws_sdk_cloudfront_keyvaluestore.types.describe_key_value_store_response.DescribeKeyValueStoreResponse, zapros.Response]:
