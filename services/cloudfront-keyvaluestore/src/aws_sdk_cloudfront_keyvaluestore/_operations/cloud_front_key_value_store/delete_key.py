...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cloudfront_keyvaluestore.types.delete_key_response.DeleteKeyResponse:
    import aws_sdk_cloudfront_keyvaluestore.types.delete_key_response
    out: aws_sdk_cloudfront_keyvaluestore.types.delete_key_response.DeleteKeyResponse = aws_sdk_cloudfront_keyvaluestore.types.delete_key_response.deserialize_json(json.loads(response.read()))
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cloudfront_keyvaluestore.types.delete_key_request.DeleteKeyRequest) -> zapros.Request:
...
def delete_key(options: OperationOptions, input: aws_sdk_cloudfront_keyvaluestore.types.delete_key_request.DeleteKeyRequest) -> tuple[aws_sdk_cloudfront_keyvaluestore.types.delete_key_response.DeleteKeyResponse, zapros.Response]:
...
async def async_delete_key(options: AsyncOperationOptions, input: aws_sdk_cloudfront_keyvaluestore.types.delete_key_request.DeleteKeyRequest) -> tuple[aws_sdk_cloudfront_keyvaluestore.types.delete_key_response.DeleteKeyResponse, zapros.Response]:
