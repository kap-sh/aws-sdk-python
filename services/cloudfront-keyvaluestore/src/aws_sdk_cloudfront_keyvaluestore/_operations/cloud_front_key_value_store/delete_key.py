...
def handle_response(
    ...
    out: aws_sdk_cloudfront_keyvaluestore.types.delete_key_response.DeleteKeyResponse = aws_sdk_cloudfront_keyvaluestore.types.delete_key_response.deserialize_json(
