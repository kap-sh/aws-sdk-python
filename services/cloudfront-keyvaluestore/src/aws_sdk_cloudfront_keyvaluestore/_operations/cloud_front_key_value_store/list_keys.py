...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cloudfront_keyvaluestore.types.list_keys_response.ListKeysResponse:
    import aws_sdk_cloudfront_keyvaluestore.types.list_keys_response
    out: aws_sdk_cloudfront_keyvaluestore.types.list_keys_response.ListKeysResponse = aws_sdk_cloudfront_keyvaluestore.types.list_keys_response.deserialize_json(json.loads(response.read()))
    return out
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cloudfront_keyvaluestore.types.list_keys_request.ListKeysRequest) -> zapros.Request:
...
def list_keys(options: OperationOptions, input: aws_sdk_cloudfront_keyvaluestore.types.list_keys_request.ListKeysRequest) -> tuple[aws_sdk_cloudfront_keyvaluestore.types.list_keys_response.ListKeysResponse, zapros.Response]:
...
async def async_list_keys(options: AsyncOperationOptions, input: aws_sdk_cloudfront_keyvaluestore.types.list_keys_request.ListKeysRequest) -> tuple[aws_sdk_cloudfront_keyvaluestore.types.list_keys_response.ListKeysResponse, zapros.Response]:
