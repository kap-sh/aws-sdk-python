...
def handle_response(
    ...
    out: aws_sdk_cloudfront_keyvaluestore.types.put_key_response.PutKeyResponse = (
        aws_sdk_cloudfront_keyvaluestore.types.put_key_response.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_cloudfront_keyvaluestore.types.put_key_request.PutKeyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cloudfront_keyvaluestore.types.put_key_request.serialize_json(input_)
    ).encode()
