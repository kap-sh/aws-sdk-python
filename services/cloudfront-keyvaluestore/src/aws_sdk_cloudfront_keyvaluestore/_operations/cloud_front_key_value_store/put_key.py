...
def handle_response(response: zapros.Response, is_async: bool) -> aws_sdk_cloudfront_keyvaluestore.types.put_key_response.PutKeyResponse:
    import aws_sdk_cloudfront_keyvaluestore.types.put_key_response
    out: aws_sdk_cloudfront_keyvaluestore.types.put_key_response.PutKeyResponse = aws_sdk_cloudfront_keyvaluestore.types.put_key_response.deserialize_json(json.loads(response.read()))
...
def build_request(options: OperationOptions | AsyncOperationOptions, input: aws_sdk_cloudfront_keyvaluestore.types.put_key_request.PutKeyRequest) -> zapros.Request:
    ...
    import aws_sdk_cloudfront_keyvaluestore.types.put_key_request
    body: bytes | None = json.dumps(aws_sdk_cloudfront_keyvaluestore.types.put_key_request.serialize_json(input)).encode()
...
def put_key(options: OperationOptions, input: aws_sdk_cloudfront_keyvaluestore.types.put_key_request.PutKeyRequest) -> tuple[aws_sdk_cloudfront_keyvaluestore.types.put_key_response.PutKeyResponse, zapros.Response]:
...
async def async_put_key(options: AsyncOperationOptions, input: aws_sdk_cloudfront_keyvaluestore.types.put_key_request.PutKeyRequest) -> tuple[aws_sdk_cloudfront_keyvaluestore.types.put_key_response.PutKeyResponse, zapros.Response]:
