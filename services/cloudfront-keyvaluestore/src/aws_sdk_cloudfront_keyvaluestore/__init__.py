...
from ._services.async_cloud_front_key_value_store import (
    AsyncCloudFrontKeyValueStoreClient as AsyncCloudFrontKeyValueStoreClient,
)
from ._services.cloud_front_key_value_store import (
    CloudFrontKeyValueStoreClient as CloudFrontKeyValueStoreClient,
)
