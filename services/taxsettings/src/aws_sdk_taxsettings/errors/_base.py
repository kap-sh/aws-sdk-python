...
class TaxSettingsError(Exception):
    """Base class for all TaxSettings service errors."""


class ServiceError(TaxSettingsError):
...
class SerializationError(TaxSettingsError):
    """Raised when a value cannot be serialized."""


class DeserializationError(TaxSettingsError):
...
class WaiterFailedError(TaxSettingsError):
...
class WaiterTimeoutError(TaxSettingsError):
