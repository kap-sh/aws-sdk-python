"""Generated from Smithy shape ``com.amazonaws.taxsettings#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.taxsettings#AccessDeniedException``."""
