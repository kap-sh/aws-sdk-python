...
from aws_sdk_taxsettings._services._aws_config import aaws_config
...
class AsyncTaxSettingsClientConfig(TypedDict, total=False):
...
class AsyncTaxSettingsClient:
    ...
    async def batch_delete_tax_registration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.batch_delete_tax_registration_request.BatchDeleteTaxRegistrationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.batch_delete_tax_registration_response.BatchDeleteTaxRegistrationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.batch_delete_tax_registration.async_batch_delete_tax_registration(
    ...
    async def batch_get_tax_exemptions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.batch_get_tax_exemptions_request.BatchGetTaxExemptionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.batch_get_tax_exemptions_response.BatchGetTaxExemptionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.batch_get_tax_exemptions.async_batch_get_tax_exemptions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_put_tax_registration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.batch_put_tax_registration_request.BatchPutTaxRegistrationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.batch_put_tax_registration_response.BatchPutTaxRegistrationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.batch_put_tax_registration.async_batch_put_tax_registration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_supplemental_tax_registration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.delete_supplemental_tax_registration_request.DeleteSupplementalTaxRegistrationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.delete_supplemental_tax_registration_response.DeleteSupplementalTaxRegistrationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.delete_supplemental_tax_registration.async_delete_supplemental_tax_registration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_tax_registration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.delete_tax_registration_request.DeleteTaxRegistrationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.delete_tax_registration_response.DeleteTaxRegistrationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.delete_tax_registration.async_delete_tax_registration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_tax_exemption_types(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.get_tax_exemption_types_request.GetTaxExemptionTypesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.get_tax_exemption_types_response.GetTaxExemptionTypesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.get_tax_exemption_types.async_get_tax_exemption_types(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_tax_inheritance(
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.get_tax_inheritance_request.GetTaxInheritanceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.get_tax_inheritance_response.GetTaxInheritanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.get_tax_inheritance.async_get_tax_inheritance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_tax_registration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.get_tax_registration_request.GetTaxRegistrationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.get_tax_registration_response.GetTaxRegistrationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.get_tax_registration.async_get_tax_registration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_tax_registration_document(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.get_tax_registration_document_request.GetTaxRegistrationDocumentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.get_tax_registration_document_response.GetTaxRegistrationDocumentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.get_tax_registration_document.async_get_tax_registration_document(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_supplemental_tax_registrations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.list_supplemental_tax_registrations_request.ListSupplementalTaxRegistrationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.list_supplemental_tax_registrations_response.ListSupplementalTaxRegistrationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.list_supplemental_tax_registrations.async_list_supplemental_tax_registrations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_taxsettings.types.supplemental_tax_registration.SupplementalTaxRegistration]":
        _token = next_token
        while True:
    ...
    async def list_tax_exemptions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.list_tax_exemptions_request.ListTaxExemptionsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.list_tax_exemptions_response.ListTaxExemptionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.list_tax_exemptions.async_list_tax_exemptions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[tuple[aws_sdk_taxsettings.types.account_id.AccountId, aws_sdk_taxsettings.types.tax_exemption_details.TaxExemptionDetails]]":
        _token = next_token
        while True:
    ...
    async def list_tax_registrations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.list_tax_registrations_request.ListTaxRegistrationsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.list_tax_registrations_response.ListTaxRegistrationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.list_tax_registrations.async_list_tax_registrations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_taxsettings.types.account_details.AccountDetails]":
        _token = next_token
        while True:
    ...
    async def put_supplemental_tax_registration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.put_supplemental_tax_registration_request.PutSupplementalTaxRegistrationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.put_supplemental_tax_registration_response.PutSupplementalTaxRegistrationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.put_supplemental_tax_registration.async_put_supplemental_tax_registration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_tax_exemption(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.put_tax_exemption_request.PutTaxExemptionRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.put_tax_exemption_response.PutTaxExemptionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.put_tax_exemption.async_put_tax_exemption(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_tax_inheritance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.put_tax_inheritance_request.PutTaxInheritanceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.put_tax_inheritance_response.PutTaxInheritanceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.put_tax_inheritance.async_put_tax_inheritance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_tax_registration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_taxsettings.types.put_tax_registration_request.PutTaxRegistrationRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_taxsettings.types.put_tax_registration_response.PutTaxRegistrationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_taxsettings._operations.tax_settings.put_tax_registration.async_put_tax_registration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
