...
def serialize_json(value: RomaniaAdditionalInfo) -> dict:
    out: dict = {}
    import aws_sdk_taxsettings.types.tax_registration_number_type
    out["taxRegistrationNumberType"] = aws_sdk_taxsettings.types.tax_registration_number_type.serialize_json(value["tax_registration_number_type"])
    return out
...
def deserialize_json(data: dict) -> RomaniaAdditionalInfo:
    ...
    if "taxRegistrationNumberType" in data:
        import aws_sdk_taxsettings.types.tax_registration_number_type
        out["tax_registration_number_type"] = aws_sdk_taxsettings.types.tax_registration_number_type.deserialize_json(data["taxRegistrationNumberType"])
    else:
        raise DeserializationError("RomaniaAdditionalInfo.tax_registration_number_type required")
    return out