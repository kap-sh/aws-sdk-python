...
class TaxDocumentMetadata(TypedDict):
    tax_document_access_token: "aws_sdk_taxsettings.types.tax_document_access_token.TaxDocumentAccessToken"
...
def deserialize_json(data: dict) -> TaxDocumentMetadata:
    ...
    if "taxDocumentAccessToken" in data:
        ...
        raise DeserializationError("TaxDocumentMetadata.tax_document_access_token required")
