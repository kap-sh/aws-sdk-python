...
if TYPE_CHECKING:
    ...
    import aws_sdk_taxsettings.types.address_line3
    import aws_sdk_taxsettings.types.city
...
class Address(TypedDict):
    ...
    address_line3: NotRequired["aws_sdk_taxsettings.types.address_line3.AddressLine3"]
    ...
    district_or_county: NotRequired["aws_sdk_taxsettings.types.district.District"]
    ...
    city: "aws_sdk_taxsettings.types.city.City"
    ...
    postal_code: "aws_sdk_taxsettings.types.postal_code.PostalCode"
