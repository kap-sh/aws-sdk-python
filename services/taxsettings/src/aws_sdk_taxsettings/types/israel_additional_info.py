...
def serialize_json(value: IsraelAdditionalInfo) -> dict:
    out: dict = {}
    import aws_sdk_taxsettings.types.israel_dealer_type
    out["dealerType"] = aws_sdk_taxsettings.types.israel_dealer_type.serialize_json(value["dealer_type"])
    import aws_sdk_taxsettings.types.israel_customer_type
    out["customerType"] = aws_sdk_taxsettings.types.israel_customer_type.serialize_json(value["customer_type"])
    return out
...
def deserialize_json(data: dict) -> IsraelAdditionalInfo:
    ...
    if "dealerType" in data:
        import aws_sdk_taxsettings.types.israel_dealer_type
        out["dealer_type"] = aws_sdk_taxsettings.types.israel_dealer_type.deserialize_json(data["dealerType"])
    else:
        raise DeserializationError("IsraelAdditionalInfo.dealer_type required")
    if "customerType" in data:
        import aws_sdk_taxsettings.types.israel_customer_type
        out["customer_type"] = aws_sdk_taxsettings.types.israel_customer_type.deserialize_json(data["customerType"])
    else:
