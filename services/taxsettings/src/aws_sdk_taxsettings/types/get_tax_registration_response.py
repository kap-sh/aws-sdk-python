...
class GetTaxRegistrationResponse(TypedDict):
    tax_registration: NotRequired["aws_sdk_taxsettings.types.tax_registration.TaxRegistration"]
...
def serialize_json(value: GetTaxRegistrationResponse) -> dict:
    ...
    if "tax_registration" in value:
        import aws_sdk_taxsettings.types.tax_registration
        out["taxRegistration"] = aws_sdk_taxsettings.types.tax_registration.serialize_json(value["tax_registration"])
    return out
...
def deserialize_json(data: dict) -> GetTaxRegistrationResponse:
    ...
    if "taxRegistration" in data:
        import aws_sdk_taxsettings.types.tax_registration
        out["tax_registration"] = aws_sdk_taxsettings.types.tax_registration.deserialize_json(data["taxRegistration"])
    return out