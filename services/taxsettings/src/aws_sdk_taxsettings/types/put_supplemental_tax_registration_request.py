...
class PutSupplementalTaxRegistrationRequest(TypedDict):
...
def serialize_json(value: PutSupplementalTaxRegistrationRequest) -> dict:
    out: dict = {}
    import aws_sdk_taxsettings.types.supplemental_tax_registration_entry
    out["taxRegistrationEntry"] = aws_sdk_taxsettings.types.supplemental_tax_registration_entry.serialize_json(value["tax_registration_entry"])
    return out
...
def deserialize_json(data: dict) -> PutSupplementalTaxRegistrationRequest:
    ...
    if "taxRegistrationEntry" in data:
        import aws_sdk_taxsettings.types.supplemental_tax_registration_entry
        out["tax_registration_entry"] = aws_sdk_taxsettings.types.supplemental_tax_registration_entry.deserialize_json(data["taxRegistrationEntry"])
    else:
        raise DeserializationError("PutSupplementalTaxRegistrationRequest.tax_registration_entry required")
    return out