...
def serialize_json(value: BatchDeleteTaxRegistrationResponse) -> dict:
    out: dict = {}
    import aws_sdk_taxsettings.types.batch_delete_tax_registration_errors
    out["errors"] = aws_sdk_taxsettings.types.batch_delete_tax_registration_errors.serialize_json(value["errors"])
    return out
...
def deserialize_json(data: dict) -> BatchDeleteTaxRegistrationResponse:
    ...
    if "errors" in data:
        import aws_sdk_taxsettings.types.batch_delete_tax_registration_errors
        out["errors"] = aws_sdk_taxsettings.types.batch_delete_tax_registration_errors.deserialize_json(data["errors"])
    else:
