...
BatchDeleteTaxRegistrationErrors: TypeAlias = list[
    "aws_sdk_taxsettings.types.batch_delete_tax_registration_error.BatchDeleteTaxRegistrationError"
]
...
def serialize_json(value: BatchDeleteTaxRegistrationErrors) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_taxsettings.types.batch_delete_tax_registration_error.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> BatchDeleteTaxRegistrationErrors:
    ...
    for item in data:
        out.append(
            aws_sdk_taxsettings.types.batch_delete_tax_registration_error.deserialize_json(
                item
            )
        )
    return out
