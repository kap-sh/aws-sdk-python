...
BatchPutTaxRegistrationErrors: TypeAlias = list[
    "aws_sdk_taxsettings.types.batch_put_tax_registration_error.BatchPutTaxRegistrationError"
]
...
def serialize_json(value: BatchPutTaxRegistrationErrors) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_taxsettings.types.batch_put_tax_registration_error.serialize_json(
                item
            )
        )
    return out
...
def deserialize_json(data: list) -> BatchPutTaxRegistrationErrors:
    ...
    for item in data:
        out.append(
            aws_sdk_taxsettings.types.batch_put_tax_registration_error.deserialize_json(
                item
            )
        )
    return out
