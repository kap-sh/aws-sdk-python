...
class EstoniaAdditionalInfo(TypedDict):
    registry_commercial_code: "aws_sdk_taxsettings.types.registry_commercial_code.RegistryCommercialCode"
...
def deserialize_json(data: dict) -> EstoniaAdditionalInfo:
    ...
    if "registryCommercialCode" in data:
        ...
        raise DeserializationError("EstoniaAdditionalInfo.registry_commercial_code required")
    return out