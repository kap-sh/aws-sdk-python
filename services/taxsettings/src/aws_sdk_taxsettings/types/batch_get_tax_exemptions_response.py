...
class BatchGetTaxExemptionsResponse(TypedDict):
    tax_exemption_details_map: NotRequired["aws_sdk_taxsettings.types.tax_exemption_details_map.TaxExemptionDetailsMap"]
...
def serialize_json(value: BatchGetTaxExemptionsResponse) -> dict:
    ...
    if "tax_exemption_details_map" in value:
        import aws_sdk_taxsettings.types.tax_exemption_details_map
        out["taxExemptionDetailsMap"] = aws_sdk_taxsettings.types.tax_exemption_details_map.serialize_json(value["tax_exemption_details_map"])
    if "failed_accounts" in value:
        import aws_sdk_taxsettings.types.account_ids
        out["failedAccounts"] = aws_sdk_taxsettings.types.account_ids.serialize_json(value["failed_accounts"])
    return out
...
def deserialize_json(data: dict) -> BatchGetTaxExemptionsResponse:
    ...
    if "taxExemptionDetailsMap" in data:
        import aws_sdk_taxsettings.types.tax_exemption_details_map
        out["tax_exemption_details_map"] = aws_sdk_taxsettings.types.tax_exemption_details_map.deserialize_json(data["taxExemptionDetailsMap"])
    if "failedAccounts" in data:
        import aws_sdk_taxsettings.types.account_ids
        out["failed_accounts"] = aws_sdk_taxsettings.types.account_ids.deserialize_json(data["failedAccounts"])
    return out