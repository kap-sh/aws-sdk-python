...
class ChileAdditionalInfo(TypedDict, closed=True):
    document_type: NotRequired[
        "aws_sdk_taxsettings.types.chile_document_type.ChileDocumentType"
    ]
...
def serialize_json(value: ChileAdditionalInfo) -> dict:
    ...
    if "document_type" in value:
        ...
        out["documentType"] = (
            aws_sdk_taxsettings.types.chile_document_type.serialize_json(
                value["document_type"]
            )
        )
...
def deserialize_json(data: dict) -> ChileAdditionalInfo:
    ...
    if "documentType" in data:
        ...
        out["document_type"] = (
            aws_sdk_taxsettings.types.chile_document_type.deserialize_json(
                data["documentType"]
            )
        )
