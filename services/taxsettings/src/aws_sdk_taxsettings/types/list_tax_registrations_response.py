...
def serialize_json(value: ListTaxRegistrationsResponse) -> dict:
    out: dict = {}
    import aws_sdk_taxsettings.types.account_details_list
    out["accountDetails"] = aws_sdk_taxsettings.types.account_details_list.serialize_json(value["account_details"])
...
def deserialize_json(data: dict) -> ListTaxRegistrationsResponse:
    ...
    if "accountDetails" in data:
        import aws_sdk_taxsettings.types.account_details_list
        out["account_details"] = aws_sdk_taxsettings.types.account_details_list.deserialize_json(data["accountDetails"])
    else:
        raise DeserializationError("ListTaxRegistrationsResponse.account_details required")
