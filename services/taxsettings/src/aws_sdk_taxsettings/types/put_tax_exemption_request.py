...
def serialize_json(value: PutTaxExemptionRequest) -> dict:
    ...
    import aws_sdk_taxsettings.types.authority
    out["authority"] = aws_sdk_taxsettings.types.authority.serialize_json(value["authority"])
    out["exemptionType"] = value["exemption_type"]
    import aws_sdk_taxsettings.types.exemption_certificate
    out["exemptionCertificate"] = aws_sdk_taxsettings.types.exemption_certificate.serialize_json(value["exemption_certificate"])
    return out
...
def deserialize_json(data: dict) -> PutTaxExemptionRequest:
    ...
    if "authority" in data:
        import aws_sdk_taxsettings.types.authority
        out["authority"] = aws_sdk_taxsettings.types.authority.deserialize_json(data["authority"])
    else:
    ...
    if "exemptionCertificate" in data:
        import aws_sdk_taxsettings.types.exemption_certificate
        out["exemption_certificate"] = aws_sdk_taxsettings.types.exemption_certificate.deserialize_json(data["exemptionCertificate"])
    else:
        raise DeserializationError("PutTaxExemptionRequest.exemption_certificate required")
    return out