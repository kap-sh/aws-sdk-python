...
class AccountMetaData(TypedDict):
    ...
    address_type: NotRequired["aws_sdk_taxsettings.types.address_role_type.AddressRoleType"]
    """<p> The type of address associated with the legal profile. </p>"""
    address_role_map: NotRequired["aws_sdk_taxsettings.types.address_role_map.AddressRoleMap"]
...
def serialize_json(value: AccountMetaData) -> dict:
    ...
    if "address_type" in value:
        import aws_sdk_taxsettings.types.address_role_type
        out["addressType"] = aws_sdk_taxsettings.types.address_role_type.serialize_json(value["address_type"])
    if "address_role_map" in value:
        import aws_sdk_taxsettings.types.address_role_map
        out["addressRoleMap"] = aws_sdk_taxsettings.types.address_role_map.serialize_json(value["address_role_map"])
    return out
...
def deserialize_json(data: dict) -> AccountMetaData:
    ...
    if "addressType" in data:
        import aws_sdk_taxsettings.types.address_role_type
        out["address_type"] = aws_sdk_taxsettings.types.address_role_type.deserialize_json(data["addressType"])
    if "addressRoleMap" in data:
        import aws_sdk_taxsettings.types.address_role_map
        out["address_role_map"] = aws_sdk_taxsettings.types.address_role_map.deserialize_json(data["addressRoleMap"])
    return out