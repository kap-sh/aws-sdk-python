...
def deserialize_json(data: dict) -> SupplementalTaxRegistrationEntry:
    ...
    if "registrationId" in data:
        ...
        raise DeserializationError("SupplementalTaxRegistrationEntry.registration_id required")
    if "registrationType" in data:
        ...
        raise DeserializationError("SupplementalTaxRegistrationEntry.registration_type required")
    if "legalName" in data:
        out["legal_name"] = data["legalName"]
    else:
        raise DeserializationError("SupplementalTaxRegistrationEntry.legal_name required")
    if "address" in data:
        import aws_sdk_taxsettings.types.address
