...
class SpainAdditionalInfo(TypedDict):
...
def serialize_json(value: SpainAdditionalInfo) -> dict:
    out: dict = {}
    import aws_sdk_taxsettings.types.registration_type
    out["registrationType"] = aws_sdk_taxsettings.types.registration_type.serialize_json(value["registration_type"])
    return out
...
def deserialize_json(data: dict) -> SpainAdditionalInfo:
    ...
    if "registrationType" in data:
        import aws_sdk_taxsettings.types.registration_type
        out["registration_type"] = aws_sdk_taxsettings.types.registration_type.deserialize_json(data["registrationType"])
    else:
