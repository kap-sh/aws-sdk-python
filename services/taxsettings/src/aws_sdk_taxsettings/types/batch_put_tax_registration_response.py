...
class BatchPutTaxRegistrationResponse(TypedDict):
    status: NotRequired["aws_sdk_taxsettings.types.tax_registration_status.TaxRegistrationStatus"]
...
def serialize_json(value: BatchPutTaxRegistrationResponse) -> dict:
    ...
    import aws_sdk_taxsettings.types.batch_put_tax_registration_errors
    out["errors"] = aws_sdk_taxsettings.types.batch_put_tax_registration_errors.serialize_json(value["errors"])
    return out
...
def deserialize_json(data: dict) -> BatchPutTaxRegistrationResponse:
    ...
    if "errors" in data:
        import aws_sdk_taxsettings.types.batch_put_tax_registration_errors
        out["errors"] = aws_sdk_taxsettings.types.batch_put_tax_registration_errors.deserialize_json(data["errors"])
    else:
