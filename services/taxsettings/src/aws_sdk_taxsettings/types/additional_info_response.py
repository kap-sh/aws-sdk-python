...
class AdditionalInfoResponse(TypedDict):
    ...
    brazil_additional_info: NotRequired[
        "aws_sdk_taxsettings.types.brazil_additional_info.BrazilAdditionalInfo"
    ]
    ...
    india_additional_info: NotRequired[
        "aws_sdk_taxsettings.types.india_additional_info.IndiaAdditionalInfo"
    ]
...
def serialize_json(value: AdditionalInfoResponse) -> dict:
    ...
    if "brazil_additional_info" in value:
        ...
        out["brazilAdditionalInfo"] = (
            aws_sdk_taxsettings.types.brazil_additional_info.serialize_json(
    ...
    if "india_additional_info" in value:
        ...
        out["indiaAdditionalInfo"] = (
            aws_sdk_taxsettings.types.india_additional_info.serialize_json(
...
def deserialize_json(data: dict) -> AdditionalInfoResponse:
    ...
    if "brazilAdditionalInfo" in data:
        ...
        out["brazil_additional_info"] = (
            aws_sdk_taxsettings.types.brazil_additional_info.deserialize_json(
    ...
    if "indiaAdditionalInfo" in data:
        ...
        out["india_additional_info"] = (
            aws_sdk_taxsettings.types.india_additional_info.deserialize_json(
