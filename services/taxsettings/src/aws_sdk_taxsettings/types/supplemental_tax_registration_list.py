...
SupplementalTaxRegistrationList: TypeAlias = list[
    "aws_sdk_taxsettings.types.supplemental_tax_registration.SupplementalTaxRegistration"
]
...
def serialize_json(value: SupplementalTaxRegistrationList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_taxsettings.types.supplemental_tax_registration.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> SupplementalTaxRegistrationList:
    ...
    for item in data:
        out.append(
            aws_sdk_taxsettings.types.supplemental_tax_registration.deserialize_json(
                item
            )
        )
    return out
