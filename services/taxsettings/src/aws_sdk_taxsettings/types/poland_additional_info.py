...
class PolandAdditionalInfo(TypedDict):
    individual_registration_number: NotRequired["aws_sdk_taxsettings.types.individual_registration_number.IndividualRegistrationNumber"]
    ...
    tax_registration_number_type: NotRequired["aws_sdk_taxsettings.types.poland_tax_registration_number_type.PolandTaxRegistrationNumberType"]
...
def serialize_json(value: PolandAdditionalInfo) -> dict:
    ...
    if "tax_registration_number_type" in value:
        import aws_sdk_taxsettings.types.poland_tax_registration_number_type
        out["taxRegistrationNumberType"] = aws_sdk_taxsettings.types.poland_tax_registration_number_type.serialize_json(value["tax_registration_number_type"])
    return out
...
def deserialize_json(data: dict) -> PolandAdditionalInfo:
    ...
    if "taxRegistrationNumberType" in data:
        import aws_sdk_taxsettings.types.poland_tax_registration_number_type
        out["tax_registration_number_type"] = aws_sdk_taxsettings.types.poland_tax_registration_number_type.deserialize_json(data["taxRegistrationNumberType"])
    return out