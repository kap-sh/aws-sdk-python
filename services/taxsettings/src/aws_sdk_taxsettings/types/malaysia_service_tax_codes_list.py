...
MalaysiaServiceTaxCodesList: TypeAlias = list[
    "aws_sdk_taxsettings.types.malaysia_service_tax_code.MalaysiaServiceTaxCode"
]
...
def serialize_json(value: MalaysiaServiceTaxCodesList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_taxsettings.types.malaysia_service_tax_code.serialize_json(item)
        )
    return out
...
def deserialize_json(data: list) -> MalaysiaServiceTaxCodesList:
    ...
    for item in data:
        out.append(
            aws_sdk_taxsettings.types.malaysia_service_tax_code.deserialize_json(item)
        )
    return out
