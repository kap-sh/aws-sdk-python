...
if TYPE_CHECKING:
    import capo_taxsettings.types.date_string
    import capo_taxsettings.types.electronic_transaction_code_number
    import capo_taxsettings.types.enterprise_identification_number
    import capo_taxsettings.types.payment_voucher_number


class VietnamAdditionalInfo(TypedDict, closed=True):
    enterprise_identification_number: NotRequired[
        "capo_taxsettings.types.enterprise_identification_number.EnterpriseIdentificationNumber"
    ]
    ...
    electronic_transaction_code_number: NotRequired[
        "capo_taxsettings.types.electronic_transaction_code_number.ElectronicTransactionCodeNumber"
    ]
    ...
    payment_voucher_number: NotRequired[
        "capo_taxsettings.types.payment_voucher_number.PaymentVoucherNumber"
    ]
    ...
    payment_voucher_number_date: NotRequired[
        "capo_taxsettings.types.date_string.DateString"
    ]
