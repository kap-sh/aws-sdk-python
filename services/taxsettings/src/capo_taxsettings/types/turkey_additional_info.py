...
if TYPE_CHECKING:
    ...
    import capo_taxsettings.types.kep_email_id
    import capo_taxsettings.types.secondary_tax_id
    import capo_taxsettings.types.tax_office


class TurkeyAdditionalInfo(TypedDict, closed=True):
    tax_office: NotRequired["capo_taxsettings.types.tax_office.TaxOffice"]
    ...
    kep_email_id: NotRequired["capo_taxsettings.types.kep_email_id.KepEmailId"]
    ...
    secondary_tax_id: NotRequired[
        "capo_taxsettings.types.secondary_tax_id.SecondaryTaxId"
    ]
    """<p> Secondary tax ID (“harcama birimi VKN”si”). If one isn't provided, we will use your VKN as the secondary ID. </p>"""
    industries: NotRequired["capo_taxsettings.types.industries.Industries"]
...
def serialize_json(value: TurkeyAdditionalInfo) -> dict:
    ...
    if "industries" in value:
        ...
        out["industries"] = capo_taxsettings.types.industries.serialize_json(
            value["industries"]
        )
    return out
