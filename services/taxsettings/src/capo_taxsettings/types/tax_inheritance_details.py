...
if TYPE_CHECKING:
    ...
    import capo_taxsettings.types.inheritance_obtained_reason


class TaxInheritanceDetails(TypedDict, closed=True):
    parent_entity_id: NotRequired["capo_taxsettings.types.account_id.AccountId"]
    """<p> Tax inheritance parent account information associated with the account. </p>"""
    inheritance_obtained_reason: NotRequired[
        "capo_taxsettings.types.inheritance_obtained_reason.InheritanceObtainedReason"
    ]
