...
if TYPE_CHECKING:
    import capo_taxsettings.types.contracting_authority_code


class GreeceAdditionalInfo(TypedDict, closed=True):
    contracting_authority_code: NotRequired[
        "capo_taxsettings.types.contracting_authority_code.ContractingAuthorityCode"
    ]
