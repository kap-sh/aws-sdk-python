...
if TYPE_CHECKING:
    import capo_taxsettings.types.business_registration_number
    import capo_taxsettings.types.malaysia_service_tax_codes_list
    import capo_taxsettings.types.tax_information_number


class MalaysiaAdditionalInfo(TypedDict, closed=True):
    service_tax_codes: "capo_taxsettings.types.malaysia_service_tax_codes_list.MalaysiaServiceTaxCodesList"
    """<p>List of service tax codes for your TRN in Malaysia.</p>"""
    tax_information_number: NotRequired[
        "capo_taxsettings.types.tax_information_number.TaxInformationNumber"
    ]
    ...
    business_registration_number: NotRequired[
        "capo_taxsettings.types.business_registration_number.BusinessRegistrationNumber"
    ]
...
def serialize_json(value: MalaysiaAdditionalInfo) -> dict:
    ...
    out["serviceTaxCodes"] = (
        capo_taxsettings.types.malaysia_service_tax_codes_list.serialize_json(
...
def deserialize_json(data: dict) -> MalaysiaAdditionalInfo:
    ...
    if "serviceTaxCodes" in data:
        ...
        out["service_tax_codes"] = (
            capo_taxsettings.types.malaysia_service_tax_codes_list.deserialize_json(
