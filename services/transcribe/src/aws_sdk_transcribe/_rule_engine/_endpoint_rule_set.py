        ...
        if _locals["PartitionResult"] is not None:
                ...
                if p.UseDualStack is True:
                    if True is get_attr(
                        ...
                        if True is get_attr(
                            ...
                            return Endpoint(
                                url=interpolate(
                                    "https://transcribe-fips.{Region}.{PartitionResult#dualStackDnsSuffix}",
                                    p,
                                    _locals,
                                ),
                                properties={},
            ...
            if p.UseFIPS is True:
                if (
                    ...
                    if string_equals(
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://fips.transcribe.{Region}.amazonaws.com",
                                p,
                                _locals,
                            ),
                            properties={},
                    ...
                    return Endpoint(
                        url=interpolate(
                            "https://transcribe-fips.{Region}.{PartitionResult#dnsSuffix}",
                            p,
                            _locals,
                        ),
                        properties={},
            ...
            if p.UseDualStack is True:
                if True is get_attr(
                    ...
                    return Endpoint(
                        url=interpolate(
                            "https://transcribe.{Region}.{PartitionResult#dualStackDnsSuffix}",
                            p,
                            _locals,
                        ),
                        properties={},
            ...
            if string_equals(p.Region, interpolate("cn-north-1", p, _locals)):
                return Endpoint(
                    url=interpolate(
                        "https://cn.transcribe.cn-north-1.amazonaws.com.cn", p, _locals
                    ),
                    properties={},
                    headers={},
                )
            if string_equals(p.Region, interpolate("cn-northwest-1", p, _locals)):
                return Endpoint(
                    url=interpolate(
                        "https://cn.transcribe.cn-northwest-1.amazonaws.com.cn",
                        p,
                        _locals,
                    ),
                    properties={},
            ...
            return Endpoint(
                url=interpolate(
                    "https://transcribe.{Region}.{PartitionResult#dnsSuffix}",
                    p,
                    _locals,
                ),
                properties={},
