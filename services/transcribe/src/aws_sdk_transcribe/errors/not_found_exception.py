"""Generated from Smithy shape ``com.amazonaws.transcribe#NotFoundException``."""

from typing import TYPE_CHECKING, TypedDict

from typing_extensions import NotRequired

from aws_sdk_transcribe.errors import ServiceError

if TYPE_CHECKING:
    import aws_sdk_transcribe.types.string


class NotFoundException_(TypedDict):
    message: NotRequired["aws_sdk_transcribe.types.string.String"]
...
class NotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.transcribe#NotFoundException``."""
