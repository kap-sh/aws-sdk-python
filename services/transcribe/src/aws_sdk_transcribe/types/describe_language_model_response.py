...
class DescribeLanguageModelResponse(TypedDict):
    language_model: NotRequired["aws_sdk_transcribe.types.language_model.LanguageModel"]
...
def serialize_aws_json_1_1(value: DescribeLanguageModelResponse) -> dict:
    ...
    if "language_model" in value:
        ...
        out["LanguageModel"] = (
            aws_sdk_transcribe.types.language_model.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeLanguageModelResponse:
    ...
    if "LanguageModel" in data:
        ...
        out["language_model"] = (
            aws_sdk_transcribe.types.language_model.deserialize_aws_json_1_1(
                data["LanguageModel"]
            )
        )
    return out
