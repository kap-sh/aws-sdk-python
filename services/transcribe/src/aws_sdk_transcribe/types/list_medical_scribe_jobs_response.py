...
if TYPE_CHECKING:
    ...
    import aws_sdk_transcribe.types.medical_scribe_job_summaries
    import aws_sdk_transcribe.types.next_token


class ListMedicalScribeJobsResponse(TypedDict):
    status: NotRequired[
    ...
    medical_scribe_job_summaries: NotRequired[
        "aws_sdk_transcribe.types.medical_scribe_job_summaries.MedicalScribeJobSummaries"
    ]
...
def serialize_aws_json_1_1(value: ListMedicalScribeJobsResponse) -> dict:
    ...
    if "medical_scribe_job_summaries" in value:
        ...
        out["MedicalScribeJobSummaries"] = (
            aws_sdk_transcribe.types.medical_scribe_job_summaries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListMedicalScribeJobsResponse:
    ...
    if "MedicalScribeJobSummaries" in data:
        ...
        out["medical_scribe_job_summaries"] = (
            aws_sdk_transcribe.types.medical_scribe_job_summaries.deserialize_aws_json_1_1(
