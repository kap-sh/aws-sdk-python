"""Generated from Smithy shape ``com.amazonaws.transcribe#StartTranscriptionJobRequest``."""
...
class StartTranscriptionJobRequest(TypedDict, closed=True):
    ...
    output_bucket_name: NotRequired[
    ...
    output_key: NotRequired["aws_sdk_transcribe.types.output_key.OutputKey"]
    ...
    subtitles: NotRequired["aws_sdk_transcribe.types.subtitles.Subtitles"]
    ...
    r"""<p>Adds one or more custom tags, each in the form of a key:value pair, to a new transcription job at the time you start this new job.</p> <p>To learn more about using tags with Amazon Transcribe, refer to <a href=\"https://docs.aws.amazon.com/transcribe/latest/dg/tagging.html\">Tagging resources</a>.</p>"""
    ...
    r"""<p>Enables toxic speech detection in your transcript. If you include <code>ToxicityDetection</code> in your request, you must also include <code>ToxicityCategories</code>.</p> <p>For information on the types of toxic speech Amazon Transcribe can detect, see <a href=\"https://docs.aws.amazon.com/transcribe/latest/dg/toxic-language.html\">Detecting toxic speech</a>.</p>"""


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StartTranscriptionJobRequest) -> dict:
    out: dict = {}
    ...
    if "output_bucket_name" in value:
    ...
    if "subtitles" in value:
        ...
        out["Subtitles"] = aws_sdk_transcribe.types.subtitles.serialize_aws_json_1_1(
            value["subtitles"]
        )
    if "tags" in value:
        import aws_sdk_transcribe.types.tag_list
...
def deserialize_aws_json_1_1(data: dict) -> StartTranscriptionJobRequest:
    out: StartTranscriptionJobRequest = {}  # type: ignore[typeddict-item]
    ...
    if "Media" in data:
        ...
        raise DeserializationError("StartTranscriptionJobRequest.media required")
    ...
    if "Subtitles" in data:
        ...
        out["subtitles"] = aws_sdk_transcribe.types.subtitles.deserialize_aws_json_1_1(
            data["Subtitles"]
        )
    if "Tags" in data:
        import aws_sdk_transcribe.types.tag_list
