...
if TYPE_CHECKING:
    ...
    import aws_sdk_transcribe.types.medical_transcript
...
class MedicalTranscriptionJob(TypedDict):
    ...
    transcript: NotRequired[
        "aws_sdk_transcribe.types.medical_transcript.MedicalTranscript"
    ]
...
def serialize_aws_json_1_1(value: MedicalTranscriptionJob) -> dict:
    ...
    if "transcript" in value:
        ...
        out["Transcript"] = (
            aws_sdk_transcribe.types.medical_transcript.serialize_aws_json_1_1(
                value["transcript"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> MedicalTranscriptionJob:
    ...
    if "Transcript" in data:
        ...
        out["transcript"] = (
            aws_sdk_transcribe.types.medical_transcript.deserialize_aws_json_1_1(
                data["Transcript"]
            )
        )
