...
if TYPE_CHECKING:
    ...
    import aws_sdk_transcribe.types.clinical_note_generation_settings
...
class MedicalScribeSettings(TypedDict):
    ...
    clinical_note_generation_settings: NotRequired[
        "aws_sdk_transcribe.types.clinical_note_generation_settings.ClinicalNoteGenerationSettings"
    ]
...
def serialize_aws_json_1_1(value: MedicalScribeSettings) -> dict:
    ...
    if "clinical_note_generation_settings" in value:
        ...
        out["ClinicalNoteGenerationSettings"] = (
            aws_sdk_transcribe.types.clinical_note_generation_settings.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> MedicalScribeSettings:
    ...
    if "ClinicalNoteGenerationSettings" in data:
        ...
        out["clinical_note_generation_settings"] = (
            aws_sdk_transcribe.types.clinical_note_generation_settings.deserialize_aws_json_1_1(
