...
class StartMedicalTranscriptionJobRequest(TypedDict):
...
def serialize_aws_json_1_1(value: StartMedicalTranscriptionJobRequest) -> dict:
    ...
    if "settings" in value:
        ...
        out["Settings"] = (
            aws_sdk_transcribe.types.medical_transcription_setting.serialize_aws_json_1_1(
                value["settings"]
            )
        )
    ...
    out["Type"] = aws_sdk_transcribe.types.type.serialize_aws_json_1_1(value["type"])
    if "tags" in value:
        import aws_sdk_transcribe.types.tag_list
...
def deserialize_aws_json_1_1(data: dict) -> StartMedicalTranscriptionJobRequest:
    ...
    if "Settings" in data:
        ...
        out["settings"] = (
            aws_sdk_transcribe.types.medical_transcription_setting.deserialize_aws_json_1_1(
                data["Settings"]
            )
        )
