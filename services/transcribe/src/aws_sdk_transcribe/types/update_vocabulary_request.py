...
class UpdateVocabularyRequest(TypedDict):
    ...
    phrases: NotRequired["aws_sdk_transcribe.types.phrases.Phrases"]
    ...
    vocabulary_file_uri: NotRequired["aws_sdk_transcribe.types.uri.Uri"]
...
def serialize_aws_json_1_1(value: UpdateVocabularyRequest) -> dict:
    ...
    if "phrases" in value:
        ...
        out["Phrases"] = aws_sdk_transcribe.types.phrases.serialize_aws_json_1_1(
            value["phrases"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> UpdateVocabularyRequest:
    ...
    if "Phrases" in data:
        ...
        out["phrases"] = aws_sdk_transcribe.types.phrases.deserialize_aws_json_1_1(
            data["Phrases"]
        )
