...
def build_request(
    ...
    input: aws_sdk_transcribe.types.start_medical_scribe_job_request.StartMedicalScribeJobRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{MedicalScribeJobName}", quote(str(input["medical_scribe_job_name"]), safe="")
    )
    params: dict[str, str] = {}
