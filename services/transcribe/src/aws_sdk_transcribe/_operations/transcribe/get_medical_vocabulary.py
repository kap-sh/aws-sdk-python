...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.get_medical_vocabulary_response.GetMedicalVocabularyResponse = aws_sdk_transcribe.types.get_medical_vocabulary_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.get_medical_vocabulary_request.GetMedicalVocabularyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
