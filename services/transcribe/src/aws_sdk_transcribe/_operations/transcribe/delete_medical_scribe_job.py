"""Generated from Smithy shape ``com.amazonaws.transcribe#DeleteMedicalScribeJob``."""
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.delete_medical_scribe_job_request.DeleteMedicalScribeJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Transcribe.DeleteMedicalScribeJob"
    body: bytes | None = b""
...
async def async_delete_medical_scribe_job(
