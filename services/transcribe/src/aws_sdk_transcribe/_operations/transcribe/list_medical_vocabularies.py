...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.list_medical_vocabularies_response.ListMedicalVocabulariesResponse = aws_sdk_transcribe.types.list_medical_vocabularies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.list_medical_vocabularies_request.ListMedicalVocabulariesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
