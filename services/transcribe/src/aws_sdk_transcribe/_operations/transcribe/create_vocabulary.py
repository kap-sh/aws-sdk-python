...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.create_vocabulary_request.CreateVocabularyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transcribe.types.create_vocabulary_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
