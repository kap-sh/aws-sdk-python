...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.create_vocabulary_response.CreateVocabularyResponse = aws_sdk_transcribe.types.create_vocabulary_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_transcribe.types.create_vocabulary_request.CreateVocabularyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transcribe.types.create_vocabulary_request.serialize_aws_json_1_1(input)
    ).encode()
