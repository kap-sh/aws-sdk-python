...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.list_call_analytics_categories_response.ListCallAnalyticsCategoriesResponse = aws_sdk_transcribe.types.list_call_analytics_categories_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.list_call_analytics_categories_request.ListCallAnalyticsCategoriesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
