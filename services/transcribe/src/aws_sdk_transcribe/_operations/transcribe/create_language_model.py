...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.create_language_model_response.CreateLanguageModelResponse = aws_sdk_transcribe.types.create_language_model_response.deserialize_aws_json_1_1(
