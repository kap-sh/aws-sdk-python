"""Generated from Smithy shape ``com.amazonaws.transcribe#GetMedicalTranscriptionJob``."""
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.get_medical_transcription_job_request.GetMedicalTranscriptionJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Transcribe.GetMedicalTranscriptionJob"
    body: bytes | None = b""
...
async def async_get_medical_transcription_job(
