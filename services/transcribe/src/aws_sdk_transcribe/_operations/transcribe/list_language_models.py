...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.list_language_models_response.ListLanguageModelsResponse = aws_sdk_transcribe.types.list_language_models_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.list_language_models_request.ListLanguageModelsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
