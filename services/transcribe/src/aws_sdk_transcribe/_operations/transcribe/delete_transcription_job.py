"""Generated from Smithy shape ``com.amazonaws.transcribe#DeleteTranscriptionJob``."""
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.delete_transcription_job_request.DeleteTranscriptionJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_transcription_job(
