...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.list_vocabulary_filters_response.ListVocabularyFiltersResponse = aws_sdk_transcribe.types.list_vocabulary_filters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.list_vocabulary_filters_request.ListVocabularyFiltersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
