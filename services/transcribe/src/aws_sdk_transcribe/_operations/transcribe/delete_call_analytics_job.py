...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.delete_call_analytics_job_response.DeleteCallAnalyticsJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.delete_call_analytics_job_request.DeleteCallAnalyticsJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
