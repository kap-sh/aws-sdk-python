"""Generated from Smithy shape ``com.amazonaws.transcribe#CreateVocabularyFilter``."""
...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.create_vocabulary_filter_response.CreateVocabularyFilterResponse = aws_sdk_transcribe.types.create_vocabulary_filter_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_transcribe.types.create_vocabulary_filter_request.CreateVocabularyFilterRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{VocabularyFilterName}", quote(str(input["vocabulary_filter_name"]), safe="")
    )
    params: dict[str, str] = {}
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transcribe.types.create_vocabulary_filter_request.serialize_aws_json_1_1(
            input
        )
    ).encode()
...
async def async_create_vocabulary_filter(
