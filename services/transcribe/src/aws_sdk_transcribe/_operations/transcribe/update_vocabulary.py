"""Generated from Smithy shape ``com.amazonaws.transcribe#UpdateVocabulary``."""
...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.update_vocabulary_response.UpdateVocabularyResponse = aws_sdk_transcribe.types.update_vocabulary_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.update_vocabulary_request.UpdateVocabularyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transcribe.types.update_vocabulary_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_vocabulary(
