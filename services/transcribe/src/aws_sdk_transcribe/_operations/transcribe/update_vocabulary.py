...
def build_request(
    ...
    input: aws_sdk_transcribe.types.update_vocabulary_request.UpdateVocabularyRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transcribe.types.update_vocabulary_request.serialize_aws_json_1_1(input)
    ).encode()
