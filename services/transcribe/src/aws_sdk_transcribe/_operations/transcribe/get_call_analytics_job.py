...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.get_call_analytics_job_response.GetCallAnalyticsJobResponse = aws_sdk_transcribe.types.get_call_analytics_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.get_call_analytics_job_request.GetCallAnalyticsJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
