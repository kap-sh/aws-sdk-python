...
def build_request(
    ...
    input: aws_sdk_transcribe.types.get_call_analytics_job_request.GetCallAnalyticsJobRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{CallAnalyticsJobName}", quote(str(input["call_analytics_job_name"]), safe="")
    )
    params: dict[str, str] = {}
