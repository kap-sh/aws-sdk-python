"""Generated from Smithy shape ``com.amazonaws.transcribe#UpdateCallAnalyticsCategory``."""
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.update_call_analytics_category_request.UpdateCallAnalyticsCategoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Transcribe.UpdateCallAnalyticsCategory"
    import aws_sdk_transcribe.types.update_call_analytics_category_request

    body: bytes | None = json.dumps(
        aws_sdk_transcribe.types.update_call_analytics_category_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_call_analytics_category(
