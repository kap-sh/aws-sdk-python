"""Generated from Smithy shape ``com.amazonaws.transcribe#DeleteMedicalVocabulary``."""
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.delete_medical_vocabulary_request.DeleteMedicalVocabularyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Transcribe.DeleteMedicalVocabulary"
    body: bytes | None = b""
...
async def async_delete_medical_vocabulary(
