...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.list_medical_scribe_jobs_response.ListMedicalScribeJobsResponse = aws_sdk_transcribe.types.list_medical_scribe_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.list_medical_scribe_jobs_request.ListMedicalScribeJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
