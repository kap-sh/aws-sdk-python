...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.delete_call_analytics_category_response.DeleteCallAnalyticsCategoryResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.delete_call_analytics_category_request.DeleteCallAnalyticsCategoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
