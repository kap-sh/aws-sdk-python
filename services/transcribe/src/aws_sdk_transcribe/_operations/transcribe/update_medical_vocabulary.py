...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.update_medical_vocabulary_response.UpdateMedicalVocabularyResponse = aws_sdk_transcribe.types.update_medical_vocabulary_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.update_medical_vocabulary_request.UpdateMedicalVocabularyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
