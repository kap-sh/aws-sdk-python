...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.describe_language_model_response.DescribeLanguageModelResponse = aws_sdk_transcribe.types.describe_language_model_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.describe_language_model_request.DescribeLanguageModelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
