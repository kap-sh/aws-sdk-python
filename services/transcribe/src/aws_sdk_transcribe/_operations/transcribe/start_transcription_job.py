...
def build_request(
    ...
    input: aws_sdk_transcribe.types.start_transcription_job_request.StartTranscriptionJobRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        "{TranscriptionJobName}", quote(str(input["transcription_job_name"]), safe="")
    )
    params: dict[str, str] = {}
