...
def build_request(
    ...
    input: aws_sdk_transcribe.types.delete_medical_transcription_job_request.DeleteMedicalTranscriptionJobRequest,
) -> zapros.Request:
    ...
    url = url.replace(
        ...
        quote(str(input["medical_transcription_job_name"]), safe=""),
    )
    params: dict[str, str] = {}
