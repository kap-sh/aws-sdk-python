...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.start_medical_transcription_job_response.StartMedicalTranscriptionJobResponse = aws_sdk_transcribe.types.start_medical_transcription_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.start_medical_transcription_job_request.StartMedicalTranscriptionJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transcribe.types.start_medical_transcription_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
