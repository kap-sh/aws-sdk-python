...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.get_vocabulary_filter_response.GetVocabularyFilterResponse = aws_sdk_transcribe.types.get_vocabulary_filter_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.get_vocabulary_filter_request.GetVocabularyFilterRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
