"""Generated from Smithy shape ``com.amazonaws.transcribe#GetCallAnalyticsCategory``."""
...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.get_call_analytics_category_response.GetCallAnalyticsCategoryResponse = aws_sdk_transcribe.types.get_call_analytics_category_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.get_call_analytics_category_request.GetCallAnalyticsCategoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "Transcribe.GetCallAnalyticsCategory"
    body: bytes | None = b""
...
async def async_get_call_analytics_category(
