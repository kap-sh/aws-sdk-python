...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.get_medical_scribe_job_response.GetMedicalScribeJobResponse = aws_sdk_transcribe.types.get_medical_scribe_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.get_medical_scribe_job_request.GetMedicalScribeJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
