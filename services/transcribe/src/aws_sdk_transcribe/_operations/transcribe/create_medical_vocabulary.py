...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.create_medical_vocabulary_response.CreateMedicalVocabularyResponse = aws_sdk_transcribe.types.create_medical_vocabulary_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.create_medical_vocabulary_request.CreateMedicalVocabularyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transcribe.types.create_medical_vocabulary_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
