...
def build_request(
    ...
    input: aws_sdk_transcribe.types.create_call_analytics_category_request.CreateCallAnalyticsCategoryRequest,
) -> zapros.Request:
    ...
    url = url.replace("{CategoryName}", quote(str(input["category_name"]), safe=""))
    params: dict[str, str] = {}
