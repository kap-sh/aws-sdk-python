...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.create_call_analytics_category_response.CreateCallAnalyticsCategoryResponse = aws_sdk_transcribe.types.create_call_analytics_category_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.create_call_analytics_category_request.CreateCallAnalyticsCategoryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_transcribe.types.create_call_analytics_category_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
