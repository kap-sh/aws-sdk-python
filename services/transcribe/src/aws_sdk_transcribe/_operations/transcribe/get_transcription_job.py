...
def handle_response(
    ...
    out: aws_sdk_transcribe.types.get_transcription_job_response.GetTranscriptionJobResponse = aws_sdk_transcribe.types.get_transcription_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_transcribe.types.get_transcription_job_request.GetTranscriptionJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
