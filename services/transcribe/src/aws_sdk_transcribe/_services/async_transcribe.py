...
from aws_sdk_transcribe._services._aws_config import aaws_config
...
class AsyncTranscribeClientConfig(TypedDict, total=False, closed=True):
...
class AsyncTranscribeClient:
    ...
    def __init__(
        ...
        self._config = AsyncTranscribeClientConfig(
            {
