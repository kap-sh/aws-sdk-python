...
if TYPE_CHECKING:
    import capo_transcribe.types.medical_scribe_channel_id
    import capo_transcribe.types.medical_scribe_participant_role


class MedicalScribeChannelDefinition(TypedDict, closed=True):
    channel_id: "capo_transcribe.types.medical_scribe_channel_id.MedicalScribeChannelId"
    """<p>Specify the audio channel you want to define.</p>"""
    participant_role: "capo_transcribe.types.medical_scribe_participant_role.MedicalScribeParticipantRole"
...
def serialize_aws_json_1_1(value: MedicalScribeChannelDefinition) -> dict:
    ...
    out["ParticipantRole"] = (
        capo_transcribe.types.medical_scribe_participant_role.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> MedicalScribeChannelDefinition:
    ...
    if "ParticipantRole" in data:
        ...
        out["participant_role"] = (
            capo_transcribe.types.medical_scribe_participant_role.deserialize_aws_json_1_1(
