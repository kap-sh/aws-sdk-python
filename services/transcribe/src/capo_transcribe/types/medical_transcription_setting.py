...
if TYPE_CHECKING:
    ...
    import capo_transcribe.types.max_alternatives
...
class MedicalTranscriptionSetting(TypedDict, closed=True):
    ...
    show_alternatives: NotRequired["capo_transcribe.types.boolean.Boolean"]
    ...
    max_alternatives: NotRequired[
        "capo_transcribe.types.max_alternatives.MaxAlternatives"
    ]
