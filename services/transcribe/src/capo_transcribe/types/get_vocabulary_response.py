"""Generated from Smithy shape ``com.amazonaws.transcribe#GetVocabularyResponse``."""
...
class GetVocabularyResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetVocabularyResponse) -> dict:
    out: dict = {}
