...
from ._services.async_transcribe import AsyncTranscribeClient as AsyncTranscribeClient
from ._services.transcribe import TranscribeClient as TranscribeClient
