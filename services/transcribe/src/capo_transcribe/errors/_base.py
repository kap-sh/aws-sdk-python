...
class TranscribeError(Exception):
    """Base class for all Transcribe service errors."""


class ServiceError(TranscribeError):
...
class SerializationError(TranscribeError):
    """Raised when a value cannot be serialized."""


class DeserializationError(TranscribeError):
...
class WaiterFailedError(TranscribeError):
...
class WaiterTimeoutError(TranscribeError):
