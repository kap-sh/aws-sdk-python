"""Generated from Smithy shape ``com.amazonaws.transcribe#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.transcribe#LimitExceededException``."""
