"""Generated from Smithy shape ``com.amazonaws.transcribe#CreateLanguageModel``."""
...
def handle_response(
    ...
    out: capo_transcribe.types.create_language_model_response.CreateLanguageModelResponse = capo_transcribe.types.create_language_model_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_transcribe.types.create_language_model_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
