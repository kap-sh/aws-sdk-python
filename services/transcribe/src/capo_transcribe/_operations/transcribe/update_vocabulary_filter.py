...
def handle_response(
    ...
    out: capo_transcribe.types.update_vocabulary_filter_response.UpdateVocabularyFilterResponse = capo_transcribe.types.update_vocabulary_filter_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_transcribe.types.update_vocabulary_filter_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
