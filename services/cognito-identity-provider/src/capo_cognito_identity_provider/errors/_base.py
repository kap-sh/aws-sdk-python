...
class CognitoIdentityProviderError(Exception):
    """Base class for all CognitoIdentityProvider service errors."""


class ServiceError(CognitoIdentityProviderError):
...
class SerializationError(CognitoIdentityProviderError):
    """Raised when a value cannot be serialized."""


class DeserializationError(CognitoIdentityProviderError):
...
class WaiterFailedError(CognitoIdentityProviderError):
...
class WaiterTimeoutError(CognitoIdentityProviderError):
