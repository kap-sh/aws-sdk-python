"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#NotAuthorizedException``."""
...
class NotAuthorizedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cognitoidentityprovider#NotAuthorizedException``."""
