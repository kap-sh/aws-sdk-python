"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#GroupExistsException``."""
...
class GroupExistsException_(TypedDict, closed=True):
    message: NotRequired[
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GroupExistsException_) -> dict:
    out: dict = {}
    if "message" in value:
...
class GroupExistsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cognitoidentityprovider#GroupExistsException``."""
