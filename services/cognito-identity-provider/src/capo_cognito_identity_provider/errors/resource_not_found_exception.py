"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cognitoidentityprovider#ResourceNotFoundException``."""
