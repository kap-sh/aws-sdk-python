...
if TYPE_CHECKING:
    import capo_cognito_identity_provider.types.recovery_mechanisms_type


class AccountRecoverySettingType(TypedDict, closed=True):
    recovery_mechanisms: NotRequired[
        "capo_cognito_identity_provider.types.recovery_mechanisms_type.RecoveryMechanismsType"
    ]
...
def serialize_aws_json_1_1(value: AccountRecoverySettingType) -> dict:
    ...
    if "recovery_mechanisms" in value:
        ...
        out["RecoveryMechanisms"] = (
            capo_cognito_identity_provider.types.recovery_mechanisms_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AccountRecoverySettingType:
    ...
    if "RecoveryMechanisms" in data:
        ...
        out["recovery_mechanisms"] = (
            capo_cognito_identity_provider.types.recovery_mechanisms_type.deserialize_aws_json_1_1(
