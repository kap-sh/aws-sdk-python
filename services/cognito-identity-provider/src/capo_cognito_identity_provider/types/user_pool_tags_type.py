...
if TYPE_CHECKING:
    import capo_cognito_identity_provider.types.tag_keys_type
    import capo_cognito_identity_provider.types.tag_value_type

UserPoolTagsType: TypeAlias = dict[
    "capo_cognito_identity_provider.types.tag_keys_type.TagKeysType",
    "capo_cognito_identity_provider.types.tag_value_type.TagValueType",
]
