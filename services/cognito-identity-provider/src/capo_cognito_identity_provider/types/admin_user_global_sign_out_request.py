"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminUserGlobalSignOutRequest``."""
...
class AdminUserGlobalSignOutRequest(TypedDict, closed=True):
    user_pool_id: (
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AdminUserGlobalSignOutRequest) -> dict:
    out: dict = {}
