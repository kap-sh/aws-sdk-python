"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminRespondToAuthChallengeRequest``."""
...
class AdminRespondToAuthChallengeRequest(TypedDict, closed=True):
    user_pool_id: (
    ...
    context_data: NotRequired[
        "capo_cognito_identity_provider.types.context_data_type.ContextDataType"
    ]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AdminRespondToAuthChallengeRequest) -> dict:
    out: dict = {}
    ...
    if "challenge_responses" in value:
        ...
        out["ChallengeResponses"] = (
            capo_cognito_identity_provider.types.challenge_responses_type.serialize_aws_json_1_1(
    ...
    if "context_data" in value:
        ...
        out["ContextData"] = (
            capo_cognito_identity_provider.types.context_data_type.serialize_aws_json_1_1(
                value["context_data"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> AdminRespondToAuthChallengeRequest:
    ...
    if "ChallengeResponses" in data:
        ...
        out["challenge_responses"] = (
            capo_cognito_identity_provider.types.challenge_responses_type.deserialize_aws_json_1_1(
    ...
    if "ContextData" in data:
        ...
        out["context_data"] = (
            capo_cognito_identity_provider.types.context_data_type.deserialize_aws_json_1_1(
                data["ContextData"]
            )
        )
