"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminUpdateUserAttributesRequest``."""
...
class AdminUpdateUserAttributesRequest(TypedDict, closed=True):
    user_pool_id: (
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AdminUpdateUserAttributesRequest) -> dict:
    out: dict = {}
