"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ListIdentityProvidersRequest``."""
...
if TYPE_CHECKING:
    import capo_cognito_identity_provider.types.list_providers_limit_type
...
class ListIdentityProvidersRequest(TypedDict, closed=True):
    ...
    max_results: NotRequired[
        "capo_cognito_identity_provider.types.list_providers_limit_type.ListProvidersLimitType"
    ]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListIdentityProvidersRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListIdentityProvidersRequest:
    out: ListIdentityProvidersRequest = {}  # type: ignore[typeddict-item]
    if "UserPoolId" in data:
        out["user_pool_id"] = data["UserPoolId"]
    else:
        raise DeserializationError("ListIdentityProvidersRequest.user_pool_id required")
