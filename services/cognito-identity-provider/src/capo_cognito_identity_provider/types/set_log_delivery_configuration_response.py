...
class SetLogDeliveryConfigurationResponse(TypedDict, closed=True):
    log_delivery_configuration: NotRequired[
        "capo_cognito_identity_provider.types.log_delivery_configuration_type.LogDeliveryConfigurationType"
    ]
...
def serialize_aws_json_1_1(value: SetLogDeliveryConfigurationResponse) -> dict:
    ...
    if "log_delivery_configuration" in value:
        ...
        out["LogDeliveryConfiguration"] = (
            capo_cognito_identity_provider.types.log_delivery_configuration_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SetLogDeliveryConfigurationResponse:
    ...
    if "LogDeliveryConfiguration" in data:
        ...
        out["log_delivery_configuration"] = (
            capo_cognito_identity_provider.types.log_delivery_configuration_type.deserialize_aws_json_1_1(
