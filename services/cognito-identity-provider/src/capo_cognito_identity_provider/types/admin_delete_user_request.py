"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminDeleteUserRequest``."""
...
class AdminDeleteUserRequest(TypedDict, closed=True):
    user_pool_id: (
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AdminDeleteUserRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> AdminDeleteUserRequest:
    out: AdminDeleteUserRequest = {}  # type: ignore[typeddict-item]
    if "UserPoolId" in data:
        out["user_pool_id"] = data["UserPoolId"]
    else:
        raise DeserializationError("AdminDeleteUserRequest.user_pool_id required")
    if "Username" in data:
        out["username"] = data["Username"]
    else:
        raise DeserializationError("AdminDeleteUserRequest.username required")
    return out
