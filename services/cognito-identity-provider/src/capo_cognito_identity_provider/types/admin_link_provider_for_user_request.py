...
class AdminLinkProviderForUserRequest(TypedDict, closed=True):
    user_pool_id: "capo_cognito_identity_provider.types.string_type.StringType"
    """<p>The ID of the user pool where you want to link a federated identity.</p>"""
    destination_user: "capo_cognito_identity_provider.types.provider_user_identifier_type.ProviderUserIdentifierType"
    ...
    source_user: "capo_cognito_identity_provider.types.provider_user_identifier_type.ProviderUserIdentifierType"
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AdminLinkProviderForUserRequest) -> dict:
    out: dict = {}
    out["UserPoolId"] = value["user_pool_id"]
    import capo_cognito_identity_provider.types.provider_user_identifier_type

    out["DestinationUser"] = (
        capo_cognito_identity_provider.types.provider_user_identifier_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AdminLinkProviderForUserRequest:
    ...
    if "DestinationUser" in data:
        ...
        out["destination_user"] = (
            capo_cognito_identity_provider.types.provider_user_identifier_type.deserialize_aws_json_1_1(
    ...
    if "SourceUser" in data:
        ...
        raise DeserializationError(
            "AdminLinkProviderForUserRequest.source_user required"
        )
    return out
