...
if TYPE_CHECKING:
    ...
    import capo_cognito_identity_provider.types.custom_email_sender_lambda_version_type


class CustomEmailLambdaVersionConfigType(TypedDict, closed=True):
    lambda_version: "capo_cognito_identity_provider.types.custom_email_sender_lambda_version_type.CustomEmailSenderLambdaVersionType"
...
def serialize_aws_json_1_1(value: CustomEmailLambdaVersionConfigType) -> dict:
    ...
    out["LambdaVersion"] = (
        capo_cognito_identity_provider.types.custom_email_sender_lambda_version_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CustomEmailLambdaVersionConfigType:
    ...
    if "LambdaVersion" in data:
        ...
        out["lambda_version"] = (
            capo_cognito_identity_provider.types.custom_email_sender_lambda_version_type.deserialize_aws_json_1_1(
                data["LambdaVersion"]
            )
        )
    else:
