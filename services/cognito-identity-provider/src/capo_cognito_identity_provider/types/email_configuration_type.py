...
if TYPE_CHECKING:
    ...
    import capo_cognito_identity_provider.types.email_address_type
    import capo_cognito_identity_provider.types.email_sending_account_type
    import capo_cognito_identity_provider.types.ses_configuration_set
...
EmailConfigurationType = TypedDict(
    "EmailConfigurationType",
    {
        ...
        "reply_to_email_address": NotRequired[
            "capo_cognito_identity_provider.types.email_address_type.EmailAddressType"
        ],
        "email_sending_account": NotRequired[
            "capo_cognito_identity_provider.types.email_sending_account_type.EmailSendingAccountType"
        ],
        "from": NotRequired[
            "capo_cognito_identity_provider.types.string_type.StringType"
        ],
        "configuration_set": NotRequired[
            "capo_cognito_identity_provider.types.ses_configuration_set.SESConfigurationSet"
        ],
    },
    closed=True,
)
...
def serialize_aws_json_1_1(value: EmailConfigurationType) -> dict:
    ...
    if "email_sending_account" in value:
        ...
        out["EmailSendingAccount"] = (
            capo_cognito_identity_provider.types.email_sending_account_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> EmailConfigurationType:
    ...
    if "EmailSendingAccount" in data:
        ...
        out["email_sending_account"] = (
            capo_cognito_identity_provider.types.email_sending_account_type.deserialize_aws_json_1_1(
