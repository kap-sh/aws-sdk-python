"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#GetUserAuthFactors``."""
...
import capo_cognito_identity_provider.types.get_user_auth_factors_request
import capo_cognito_identity_provider.types.get_user_auth_factors_response
...
) -> capo_cognito_identity_provider.types.get_user_auth_factors_response.GetUserAuthFactorsResponse:
    out: capo_cognito_identity_provider.types.get_user_auth_factors_response.GetUserAuthFactorsResponse = capo_cognito_identity_provider.types.get_user_auth_factors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSCognitoIdentityProviderService.GetUserAuthFactors"
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.get_user_auth_factors_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_user_auth_factors(
