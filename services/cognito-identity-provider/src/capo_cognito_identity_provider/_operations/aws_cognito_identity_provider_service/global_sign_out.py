"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#GlobalSignOut``."""
...
import capo_cognito_identity_provider.types.global_sign_out_request
import capo_cognito_identity_provider.types.global_sign_out_response
...
def handle_response(
    ...
    capo_cognito_identity_provider.types.global_sign_out_response.GlobalSignOutResponse
):
    out: capo_cognito_identity_provider.types.global_sign_out_response.GlobalSignOutResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.global_sign_out_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_global_sign_out(
