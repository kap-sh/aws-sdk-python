"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DeleteManagedLoginBranding``."""
...
import capo_cognito_identity_provider.types.delete_managed_login_branding_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.delete_managed_login_branding_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_managed_login_branding(
