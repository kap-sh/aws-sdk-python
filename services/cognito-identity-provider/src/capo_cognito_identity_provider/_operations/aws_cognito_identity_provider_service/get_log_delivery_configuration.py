"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#GetLogDeliveryConfiguration``."""
...
import capo_cognito_identity_provider.types.log_delivery_configuration_type
...
) -> capo_cognito_identity_provider.types.get_log_delivery_configuration_response.GetLogDeliveryConfigurationResponse:
    out: capo_cognito_identity_provider.types.get_log_delivery_configuration_response.GetLogDeliveryConfigurationResponse = capo_cognito_identity_provider.types.get_log_delivery_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.get_log_delivery_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_log_delivery_configuration(
