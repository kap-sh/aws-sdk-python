"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#CreateGroup``."""
...
import capo_cognito_identity_provider.errors.group_exists_exception
...
import capo_cognito_identity_provider.types.create_group_request
import capo_cognito_identity_provider.types.create_group_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "GroupExistsException":
            raise capo_cognito_identity_provider.errors.group_exists_exception.GroupExistsException.from_aws_json_1_1(
                data
            )
...
) -> capo_cognito_identity_provider.types.create_group_response.CreateGroupResponse:
    out: capo_cognito_identity_provider.types.create_group_response.CreateGroupResponse = capo_cognito_identity_provider.types.create_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.create_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
