"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ListTerms``."""
...
import capo_cognito_identity_provider.types.list_terms_request
import capo_cognito_identity_provider.types.list_terms_response
...
) -> capo_cognito_identity_provider.types.list_terms_response.ListTermsResponse:
    out: capo_cognito_identity_provider.types.list_terms_response.ListTermsResponse = capo_cognito_identity_provider.types.list_terms_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSCognitoIdentityProviderService.ListTerms"
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.list_terms_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
