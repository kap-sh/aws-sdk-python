"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminUpdateAuthEventFeedback``."""
...
import capo_cognito_identity_provider.errors.user_pool_add_on_not_enabled_exception
import capo_cognito_identity_provider.types.admin_update_auth_event_feedback_request
import capo_cognito_identity_provider.types.admin_update_auth_event_feedback_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UserPoolAddOnNotEnabledException":
            raise capo_cognito_identity_provider.errors.user_pool_add_on_not_enabled_exception.UserPoolAddOnNotEnabledException.from_aws_json_1_1(
                data
            )
        case _:
...
) -> capo_cognito_identity_provider.types.admin_update_auth_event_feedback_response.AdminUpdateAuthEventFeedbackResponse:
    out: capo_cognito_identity_provider.types.admin_update_auth_event_feedback_response.AdminUpdateAuthEventFeedbackResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.admin_update_auth_event_feedback_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_admin_update_auth_event_feedback(
