"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminUpdateDeviceStatus``."""
...
import capo_cognito_identity_provider.types.admin_update_device_status_request
import capo_cognito_identity_provider.types.admin_update_device_status_response
...
) -> capo_cognito_identity_provider.types.admin_update_device_status_response.AdminUpdateDeviceStatusResponse:
    out: capo_cognito_identity_provider.types.admin_update_device_status_response.AdminUpdateDeviceStatusResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.admin_update_device_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_admin_update_device_status(
