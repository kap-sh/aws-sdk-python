"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminConfirmSignUp``."""
...
import capo_cognito_identity_provider.types.admin_confirm_sign_up_request
import capo_cognito_identity_provider.types.admin_confirm_sign_up_response
...
) -> capo_cognito_identity_provider.types.admin_confirm_sign_up_response.AdminConfirmSignUpResponse:
    out: capo_cognito_identity_provider.types.admin_confirm_sign_up_response.AdminConfirmSignUpResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.admin_confirm_sign_up_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_admin_confirm_sign_up(
