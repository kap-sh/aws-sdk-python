"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DescribeUserPoolClient``."""
...
import capo_cognito_identity_provider.types.describe_user_pool_client_request
import capo_cognito_identity_provider.types.describe_user_pool_client_response
...
) -> capo_cognito_identity_provider.types.describe_user_pool_client_response.DescribeUserPoolClientResponse:
    out: capo_cognito_identity_provider.types.describe_user_pool_client_response.DescribeUserPoolClientResponse = capo_cognito_identity_provider.types.describe_user_pool_client_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.describe_user_pool_client_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_user_pool_client(
