"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DescribeIdentityProvider``."""
...
import capo_cognito_identity_provider.types.describe_identity_provider_request
import capo_cognito_identity_provider.types.describe_identity_provider_response
...
) -> capo_cognito_identity_provider.types.describe_identity_provider_response.DescribeIdentityProviderResponse:
    out: capo_cognito_identity_provider.types.describe_identity_provider_response.DescribeIdentityProviderResponse = capo_cognito_identity_provider.types.describe_identity_provider_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.describe_identity_provider_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_identity_provider(
