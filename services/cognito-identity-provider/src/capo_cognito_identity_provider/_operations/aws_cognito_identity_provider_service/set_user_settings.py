"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#SetUserSettings``."""
...
import capo_cognito_identity_provider.types.set_user_settings_request
import capo_cognito_identity_provider.types.set_user_settings_response
...
) -> capo_cognito_identity_provider.types.set_user_settings_response.SetUserSettingsResponse:
    out: capo_cognito_identity_provider.types.set_user_settings_response.SetUserSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.set_user_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_set_user_settings(
