"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminDisableUser``."""
...
import capo_cognito_identity_provider.types.admin_disable_user_request
import capo_cognito_identity_provider.types.admin_disable_user_response
...
) -> capo_cognito_identity_provider.types.admin_disable_user_response.AdminDisableUserResponse:
    out: capo_cognito_identity_provider.types.admin_disable_user_response.AdminDisableUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.admin_disable_user_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_admin_disable_user(
