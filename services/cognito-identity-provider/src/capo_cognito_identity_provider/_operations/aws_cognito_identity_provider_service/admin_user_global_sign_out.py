"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminUserGlobalSignOut``."""
...
import capo_cognito_identity_provider.types.admin_user_global_sign_out_request
import capo_cognito_identity_provider.types.admin_user_global_sign_out_response
...
) -> capo_cognito_identity_provider.types.admin_user_global_sign_out_response.AdminUserGlobalSignOutResponse:
    out: capo_cognito_identity_provider.types.admin_user_global_sign_out_response.AdminUserGlobalSignOutResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.admin_user_global_sign_out_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_admin_user_global_sign_out(
