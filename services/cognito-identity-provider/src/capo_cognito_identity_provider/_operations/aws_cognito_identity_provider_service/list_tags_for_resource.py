"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ListTagsForResource``."""
...
import capo_cognito_identity_provider.types.list_tags_for_resource_request
import capo_cognito_identity_provider.types.list_tags_for_resource_response
...
) -> capo_cognito_identity_provider.types.list_tags_for_resource_response.ListTagsForResourceResponse:
    out: capo_cognito_identity_provider.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_cognito_identity_provider.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.list_tags_for_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
