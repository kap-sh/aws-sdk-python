"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ListUserPoolClients``."""
...
import capo_cognito_identity_provider.types.list_user_pool_clients_request
import capo_cognito_identity_provider.types.list_user_pool_clients_response
import capo_cognito_identity_provider.types.user_pool_client_list_type
...
) -> capo_cognito_identity_provider.types.list_user_pool_clients_response.ListUserPoolClientsResponse:
    out: capo_cognito_identity_provider.types.list_user_pool_clients_response.ListUserPoolClientsResponse = capo_cognito_identity_provider.types.list_user_pool_clients_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.list_user_pool_clients_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_user_pool_clients(
