"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DeleteUserPool``."""
...
import capo_cognito_identity_provider.types.delete_user_pool_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.delete_user_pool_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_user_pool(
