...
) -> capo_cognito_identity_provider.types.get_csv_header_response.GetCSVHeaderResponse:
    out: capo_cognito_identity_provider.types.get_csv_header_response.GetCSVHeaderResponse = capo_cognito_identity_provider.types.get_csv_header_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.get_csv_header_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
