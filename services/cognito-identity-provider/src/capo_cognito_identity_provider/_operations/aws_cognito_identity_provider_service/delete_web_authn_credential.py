"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DeleteWebAuthnCredential``."""
...
import capo_cognito_identity_provider.types.delete_web_authn_credential_request
import capo_cognito_identity_provider.types.delete_web_authn_credential_response
...
) -> capo_cognito_identity_provider.types.delete_web_authn_credential_response.DeleteWebAuthnCredentialResponse:
    out: capo_cognito_identity_provider.types.delete_web_authn_credential_response.DeleteWebAuthnCredentialResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.delete_web_authn_credential_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_web_authn_credential(
