...
import capo_cognito_identity_provider.errors.concurrent_modification_exception
...
import capo_cognito_identity_provider.errors.tier_change_not_allowed_exception
import capo_cognito_identity_provider.errors.too_many_requests_exception
import capo_cognito_identity_provider.errors.user_import_in_progress_exception
import capo_cognito_identity_provider.errors.user_pool_tagging_exception
...
import capo_cognito_identity_provider.types.update_user_pool_request
import capo_cognito_identity_provider.types.update_user_pool_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConcurrentModificationException":
            raise capo_cognito_identity_provider.errors.concurrent_modification_exception.ConcurrentModificationException.from_aws_json_1_1(
                data
            )
        ...
        case "TierChangeNotAllowedException":
            raise capo_cognito_identity_provider.errors.tier_change_not_allowed_exception.TierChangeNotAllowedException.from_aws_json_1_1(
                data
            )
        ...
        case "UserImportInProgressException":
            raise capo_cognito_identity_provider.errors.user_import_in_progress_exception.UserImportInProgressException.from_aws_json_1_1(
                data
            )
        case "UserPoolTaggingException":
            raise capo_cognito_identity_provider.errors.user_pool_tagging_exception.UserPoolTaggingException.from_aws_json_1_1(
                data
            )
        case _:
...
) -> capo_cognito_identity_provider.types.update_user_pool_response.UpdateUserPoolResponse:
    out: capo_cognito_identity_provider.types.update_user_pool_response.UpdateUserPoolResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.update_user_pool_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
