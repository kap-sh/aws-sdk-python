...
import capo_cognito_identity_provider.errors.precondition_not_met_exception
...
import capo_cognito_identity_provider.errors.unsupported_user_state_exception
...
import capo_cognito_identity_provider.errors.username_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PreconditionNotMetException":
            raise capo_cognito_identity_provider.errors.precondition_not_met_exception.PreconditionNotMetException.from_aws_json_1_1(
                data
            )
        ...
        case "UnsupportedUserStateException":
            raise capo_cognito_identity_provider.errors.unsupported_user_state_exception.UnsupportedUserStateException.from_aws_json_1_1(
                data
            )
        ...
        case "UsernameExistsException":
            raise capo_cognito_identity_provider.errors.username_exists_exception.UsernameExistsException.from_aws_json_1_1(
                data
            )
...
) -> capo_cognito_identity_provider.types.admin_create_user_response.AdminCreateUserResponse:
    out: capo_cognito_identity_provider.types.admin_create_user_response.AdminCreateUserResponse = capo_cognito_identity_provider.types.admin_create_user_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.admin_create_user_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
