"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#GetUserPoolMfaConfig``."""
...
import capo_cognito_identity_provider.types.get_user_pool_mfa_config_request
import capo_cognito_identity_provider.types.get_user_pool_mfa_config_response
...
) -> capo_cognito_identity_provider.types.get_user_pool_mfa_config_response.GetUserPoolMfaConfigResponse:
    out: capo_cognito_identity_provider.types.get_user_pool_mfa_config_response.GetUserPoolMfaConfigResponse = capo_cognito_identity_provider.types.get_user_pool_mfa_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.get_user_pool_mfa_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_user_pool_mfa_config(
