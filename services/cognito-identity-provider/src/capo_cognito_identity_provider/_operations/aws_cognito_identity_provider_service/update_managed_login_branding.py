"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#UpdateManagedLoginBranding``."""
...
) -> capo_cognito_identity_provider.types.update_managed_login_branding_response.UpdateManagedLoginBrandingResponse:
    out: capo_cognito_identity_provider.types.update_managed_login_branding_response.UpdateManagedLoginBrandingResponse = capo_cognito_identity_provider.types.update_managed_login_branding_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.update_managed_login_branding_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_managed_login_branding(
