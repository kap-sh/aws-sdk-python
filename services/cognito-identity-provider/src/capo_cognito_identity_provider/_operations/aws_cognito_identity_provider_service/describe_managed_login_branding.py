"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DescribeManagedLoginBranding``."""
...
import capo_cognito_identity_provider.types.describe_managed_login_branding_request
import capo_cognito_identity_provider.types.describe_managed_login_branding_response
...
) -> capo_cognito_identity_provider.types.describe_managed_login_branding_response.DescribeManagedLoginBrandingResponse:
    out: capo_cognito_identity_provider.types.describe_managed_login_branding_response.DescribeManagedLoginBrandingResponse = capo_cognito_identity_provider.types.describe_managed_login_branding_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.describe_managed_login_branding_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_managed_login_branding(
