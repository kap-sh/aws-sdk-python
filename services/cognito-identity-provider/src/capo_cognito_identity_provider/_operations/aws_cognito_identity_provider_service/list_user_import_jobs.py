"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ListUserImportJobs``."""
...
import capo_cognito_identity_provider.types.list_user_import_jobs_request
import capo_cognito_identity_provider.types.list_user_import_jobs_response
...
) -> capo_cognito_identity_provider.types.list_user_import_jobs_response.ListUserImportJobsResponse:
    out: capo_cognito_identity_provider.types.list_user_import_jobs_response.ListUserImportJobsResponse = capo_cognito_identity_provider.types.list_user_import_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.list_user_import_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_user_import_jobs(
