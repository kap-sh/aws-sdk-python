"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ListIdentityProviders``."""
...
import capo_cognito_identity_provider.types.list_identity_providers_request
import capo_cognito_identity_provider.types.list_identity_providers_response
...
) -> capo_cognito_identity_provider.types.list_identity_providers_response.ListIdentityProvidersResponse:
    out: capo_cognito_identity_provider.types.list_identity_providers_response.ListIdentityProvidersResponse = capo_cognito_identity_provider.types.list_identity_providers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.list_identity_providers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
