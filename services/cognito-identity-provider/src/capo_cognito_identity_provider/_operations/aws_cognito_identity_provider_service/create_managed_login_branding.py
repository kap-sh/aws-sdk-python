"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#CreateManagedLoginBranding``."""
...
import capo_cognito_identity_provider.errors.managed_login_branding_exists_exception
...
import capo_cognito_identity_provider.types.create_managed_login_branding_request
import capo_cognito_identity_provider.types.create_managed_login_branding_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ManagedLoginBrandingExistsException":
            raise capo_cognito_identity_provider.errors.managed_login_branding_exists_exception.ManagedLoginBrandingExistsException.from_aws_json_1_1(
                data
            )
...
) -> capo_cognito_identity_provider.types.create_managed_login_branding_response.CreateManagedLoginBrandingResponse:
    out: capo_cognito_identity_provider.types.create_managed_login_branding_response.CreateManagedLoginBrandingResponse = capo_cognito_identity_provider.types.create_managed_login_branding_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.create_managed_login_branding_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_managed_login_branding(
