"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminResetUserPassword``."""
...
import capo_cognito_identity_provider.types.admin_reset_user_password_request
import capo_cognito_identity_provider.types.admin_reset_user_password_response
...
) -> capo_cognito_identity_provider.types.admin_reset_user_password_response.AdminResetUserPasswordResponse:
    out: capo_cognito_identity_provider.types.admin_reset_user_password_response.AdminResetUserPasswordResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.admin_reset_user_password_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_admin_reset_user_password(
