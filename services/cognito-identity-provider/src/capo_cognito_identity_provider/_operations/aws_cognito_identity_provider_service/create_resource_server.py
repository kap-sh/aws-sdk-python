"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#CreateResourceServer``."""
...
import capo_cognito_identity_provider.types.create_resource_server_request
import capo_cognito_identity_provider.types.create_resource_server_response
...
) -> capo_cognito_identity_provider.types.create_resource_server_response.CreateResourceServerResponse:
    out: capo_cognito_identity_provider.types.create_resource_server_response.CreateResourceServerResponse = capo_cognito_identity_provider.types.create_resource_server_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.create_resource_server_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_resource_server(
