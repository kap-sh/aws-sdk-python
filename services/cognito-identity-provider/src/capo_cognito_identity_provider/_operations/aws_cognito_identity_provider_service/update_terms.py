"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#UpdateTerms``."""
...
import capo_cognito_identity_provider.errors.terms_exists_exception
...
import capo_cognito_identity_provider.types.update_terms_request
import capo_cognito_identity_provider.types.update_terms_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TermsExistsException":
            raise capo_cognito_identity_provider.errors.terms_exists_exception.TermsExistsException.from_aws_json_1_1(
                data
            )
...
) -> capo_cognito_identity_provider.types.update_terms_response.UpdateTermsResponse:
    out: capo_cognito_identity_provider.types.update_terms_response.UpdateTermsResponse = capo_cognito_identity_provider.types.update_terms_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSCognitoIdentityProviderService.UpdateTerms"
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.update_terms_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
