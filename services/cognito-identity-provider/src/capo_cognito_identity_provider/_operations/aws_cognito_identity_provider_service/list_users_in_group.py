"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ListUsersInGroup``."""
...
import capo_cognito_identity_provider.types.list_users_in_group_request
import capo_cognito_identity_provider.types.list_users_in_group_response
...
) -> capo_cognito_identity_provider.types.list_users_in_group_response.ListUsersInGroupResponse:
    out: capo_cognito_identity_provider.types.list_users_in_group_response.ListUsersInGroupResponse = capo_cognito_identity_provider.types.list_users_in_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.list_users_in_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_users_in_group(
