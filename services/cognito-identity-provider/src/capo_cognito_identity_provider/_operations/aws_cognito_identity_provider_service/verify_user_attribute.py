"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#VerifyUserAttribute``."""
...
import capo_cognito_identity_provider.types.verify_user_attribute_request
import capo_cognito_identity_provider.types.verify_user_attribute_response
...
) -> capo_cognito_identity_provider.types.verify_user_attribute_response.VerifyUserAttributeResponse:
    out: capo_cognito_identity_provider.types.verify_user_attribute_response.VerifyUserAttributeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.verify_user_attribute_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_verify_user_attribute(
