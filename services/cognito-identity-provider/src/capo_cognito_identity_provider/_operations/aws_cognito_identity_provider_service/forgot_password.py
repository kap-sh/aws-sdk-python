...
def handle_response(
    ...
    capo_cognito_identity_provider.types.forgot_password_response.ForgotPasswordResponse
):
    out: capo_cognito_identity_provider.types.forgot_password_response.ForgotPasswordResponse = capo_cognito_identity_provider.types.forgot_password_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.forgot_password_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
