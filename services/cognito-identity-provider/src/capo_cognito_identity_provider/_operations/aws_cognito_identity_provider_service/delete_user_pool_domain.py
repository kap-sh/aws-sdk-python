"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DeleteUserPoolDomain``."""
...
import capo_cognito_identity_provider.types.delete_user_pool_domain_request
import capo_cognito_identity_provider.types.delete_user_pool_domain_response
...
) -> capo_cognito_identity_provider.types.delete_user_pool_domain_response.DeleteUserPoolDomainResponse:
    out: capo_cognito_identity_provider.types.delete_user_pool_domain_response.DeleteUserPoolDomainResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.delete_user_pool_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_user_pool_domain(
