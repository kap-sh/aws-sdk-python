...
import capo_cognito_identity_provider.errors.web_authn_configuration_missing_exception
import capo_cognito_identity_provider.errors.web_authn_not_enabled_exception
import capo_cognito_identity_provider.types.start_web_authn_registration_request
import capo_cognito_identity_provider.types.start_web_authn_registration_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WebAuthnConfigurationMissingException":
            raise capo_cognito_identity_provider.errors.web_authn_configuration_missing_exception.WebAuthnConfigurationMissingException.from_aws_json_1_1(
                data
            )
        case "WebAuthnNotEnabledException":
            raise capo_cognito_identity_provider.errors.web_authn_not_enabled_exception.WebAuthnNotEnabledException.from_aws_json_1_1(
                data
            )
        case _:
...
) -> capo_cognito_identity_provider.types.start_web_authn_registration_response.StartWebAuthnRegistrationResponse:
    out: capo_cognito_identity_provider.types.start_web_authn_registration_response.StartWebAuthnRegistrationResponse = capo_cognito_identity_provider.types.start_web_authn_registration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.start_web_authn_registration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
