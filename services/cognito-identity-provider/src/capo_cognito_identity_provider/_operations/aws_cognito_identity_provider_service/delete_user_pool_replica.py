"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DeleteUserPoolReplica``."""
...
import capo_cognito_identity_provider.types.delete_user_pool_replica_request
import capo_cognito_identity_provider.types.delete_user_pool_replica_response
...
) -> capo_cognito_identity_provider.types.delete_user_pool_replica_response.DeleteUserPoolReplicaResponse:
    out: capo_cognito_identity_provider.types.delete_user_pool_replica_response.DeleteUserPoolReplicaResponse = capo_cognito_identity_provider.types.delete_user_pool_replica_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSCognitoIdentityProviderService.DeleteUserPoolReplica"
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.delete_user_pool_replica_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_user_pool_replica(
