...
import capo_cognito_identity_provider.types.admin_respond_to_auth_challenge_request
import capo_cognito_identity_provider.types.admin_respond_to_auth_challenge_response
...
) -> capo_cognito_identity_provider.types.admin_respond_to_auth_challenge_response.AdminRespondToAuthChallengeResponse:
    out: capo_cognito_identity_provider.types.admin_respond_to_auth_challenge_response.AdminRespondToAuthChallengeResponse = capo_cognito_identity_provider.types.admin_respond_to_auth_challenge_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.admin_respond_to_auth_challenge_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
