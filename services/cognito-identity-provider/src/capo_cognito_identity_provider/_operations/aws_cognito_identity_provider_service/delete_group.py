"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DeleteGroup``."""
...
import capo_cognito_identity_provider.types.delete_group_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.delete_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
