"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminSetUserSettings``."""
...
import capo_cognito_identity_provider.types.admin_set_user_settings_request
import capo_cognito_identity_provider.types.admin_set_user_settings_response
...
) -> capo_cognito_identity_provider.types.admin_set_user_settings_response.AdminSetUserSettingsResponse:
    out: capo_cognito_identity_provider.types.admin_set_user_settings_response.AdminSetUserSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.admin_set_user_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_admin_set_user_settings(
