"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#GetTokensFromRefreshToken``."""
...
import capo_cognito_identity_provider.errors.refresh_token_reuse_exception
...
import capo_cognito_identity_provider.types.get_tokens_from_refresh_token_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RefreshTokenReuseException":
            raise capo_cognito_identity_provider.errors.refresh_token_reuse_exception.RefreshTokenReuseException.from_aws_json_1_1(
                data
            )
...
) -> capo_cognito_identity_provider.types.get_tokens_from_refresh_token_response.GetTokensFromRefreshTokenResponse:
    out: capo_cognito_identity_provider.types.get_tokens_from_refresh_token_response.GetTokensFromRefreshTokenResponse = capo_cognito_identity_provider.types.get_tokens_from_refresh_token_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.get_tokens_from_refresh_token_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_tokens_from_refresh_token(
