"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ListResourceServers``."""
...
import capo_cognito_identity_provider.types.list_resource_servers_request
import capo_cognito_identity_provider.types.list_resource_servers_response
...
) -> capo_cognito_identity_provider.types.list_resource_servers_response.ListResourceServersResponse:
    out: capo_cognito_identity_provider.types.list_resource_servers_response.ListResourceServersResponse = capo_cognito_identity_provider.types.list_resource_servers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.list_resource_servers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_resource_servers(
