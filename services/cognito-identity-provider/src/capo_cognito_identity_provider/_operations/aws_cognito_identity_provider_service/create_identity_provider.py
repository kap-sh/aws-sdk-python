"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#CreateIdentityProvider``."""
...
import capo_cognito_identity_provider.errors.duplicate_provider_exception
...
import capo_cognito_identity_provider.types.create_identity_provider_request
import capo_cognito_identity_provider.types.create_identity_provider_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DuplicateProviderException":
            raise capo_cognito_identity_provider.errors.duplicate_provider_exception.DuplicateProviderException.from_aws_json_1_1(
                data
            )
...
) -> capo_cognito_identity_provider.types.create_identity_provider_response.CreateIdentityProviderResponse:
    out: capo_cognito_identity_provider.types.create_identity_provider_response.CreateIdentityProviderResponse = capo_cognito_identity_provider.types.create_identity_provider_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.create_identity_provider_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_identity_provider(
