...
import capo_cognito_identity_provider.types.delete_resource_server_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.delete_resource_server_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
