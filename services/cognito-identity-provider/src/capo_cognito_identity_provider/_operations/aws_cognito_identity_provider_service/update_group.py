"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#UpdateGroup``."""
...
import capo_cognito_identity_provider.types.update_group_request
import capo_cognito_identity_provider.types.update_group_response
...
) -> capo_cognito_identity_provider.types.update_group_response.UpdateGroupResponse:
    out: capo_cognito_identity_provider.types.update_group_response.UpdateGroupResponse = capo_cognito_identity_provider.types.update_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.update_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
