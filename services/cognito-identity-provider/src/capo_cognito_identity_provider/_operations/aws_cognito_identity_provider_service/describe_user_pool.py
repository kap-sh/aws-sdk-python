"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DescribeUserPool``."""
...
import capo_cognito_identity_provider.types.describe_user_pool_request
import capo_cognito_identity_provider.types.describe_user_pool_response
...
) -> capo_cognito_identity_provider.types.describe_user_pool_response.DescribeUserPoolResponse:
    out: capo_cognito_identity_provider.types.describe_user_pool_response.DescribeUserPoolResponse = capo_cognito_identity_provider.types.describe_user_pool_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.describe_user_pool_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_user_pool(
