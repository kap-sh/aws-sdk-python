"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminGetDevice``."""
...
) -> capo_cognito_identity_provider.types.admin_get_device_response.AdminGetDeviceResponse:
    out: capo_cognito_identity_provider.types.admin_get_device_response.AdminGetDeviceResponse = capo_cognito_identity_provider.types.admin_get_device_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.admin_get_device_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_admin_get_device(
