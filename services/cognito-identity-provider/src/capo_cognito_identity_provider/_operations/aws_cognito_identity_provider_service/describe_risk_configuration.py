...
) -> capo_cognito_identity_provider.types.describe_risk_configuration_response.DescribeRiskConfigurationResponse:
    out: capo_cognito_identity_provider.types.describe_risk_configuration_response.DescribeRiskConfigurationResponse = capo_cognito_identity_provider.types.describe_risk_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.describe_risk_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
