"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#SetUserPoolMfaConfig``."""
...
import capo_cognito_identity_provider.types.set_user_pool_mfa_config_request
import capo_cognito_identity_provider.types.set_user_pool_mfa_config_response
...
) -> capo_cognito_identity_provider.types.set_user_pool_mfa_config_response.SetUserPoolMfaConfigResponse:
    out: capo_cognito_identity_provider.types.set_user_pool_mfa_config_response.SetUserPoolMfaConfigResponse = capo_cognito_identity_provider.types.set_user_pool_mfa_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.set_user_pool_mfa_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_set_user_pool_mfa_config(
