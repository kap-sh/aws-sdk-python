"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#GetUserAttributeVerificationCode``."""
...
import capo_cognito_identity_provider.types.get_user_attribute_verification_code_request
import capo_cognito_identity_provider.types.get_user_attribute_verification_code_response
...
) -> capo_cognito_identity_provider.types.get_user_attribute_verification_code_response.GetUserAttributeVerificationCodeResponse:
    out: capo_cognito_identity_provider.types.get_user_attribute_verification_code_response.GetUserAttributeVerificationCodeResponse = capo_cognito_identity_provider.types.get_user_attribute_verification_code_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.get_user_attribute_verification_code_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_user_attribute_verification_code(
