"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#StartUserImportJob``."""
...
import capo_cognito_identity_provider.types.start_user_import_job_request
import capo_cognito_identity_provider.types.start_user_import_job_response
...
) -> capo_cognito_identity_provider.types.start_user_import_job_response.StartUserImportJobResponse:
    out: capo_cognito_identity_provider.types.start_user_import_job_response.StartUserImportJobResponse = capo_cognito_identity_provider.types.start_user_import_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.start_user_import_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_user_import_job(
