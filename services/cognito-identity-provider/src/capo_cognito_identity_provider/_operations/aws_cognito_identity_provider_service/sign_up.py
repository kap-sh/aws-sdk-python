"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#SignUp``."""
...
import capo_cognito_identity_provider.types.sign_up_request
import capo_cognito_identity_provider.types.sign_up_response
...
) -> capo_cognito_identity_provider.types.sign_up_response.SignUpResponse:
    out: capo_cognito_identity_provider.types.sign_up_response.SignUpResponse = (
        capo_cognito_identity_provider.types.sign_up_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.sign_up_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
