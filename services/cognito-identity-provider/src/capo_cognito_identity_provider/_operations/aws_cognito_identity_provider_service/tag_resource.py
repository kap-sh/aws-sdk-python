"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#TagResource``."""
...
import capo_cognito_identity_provider.types.tag_resource_request
import capo_cognito_identity_provider.types.tag_resource_response
...
) -> capo_cognito_identity_provider.types.tag_resource_response.TagResourceResponse:
    out: capo_cognito_identity_provider.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.tag_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
