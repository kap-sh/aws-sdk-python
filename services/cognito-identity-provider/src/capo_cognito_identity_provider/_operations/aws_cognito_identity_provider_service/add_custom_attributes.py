"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AddCustomAttributes``."""
...
import capo_cognito_identity_provider.types.add_custom_attributes_request
import capo_cognito_identity_provider.types.add_custom_attributes_response
import capo_cognito_identity_provider.types.custom_attributes_list_type
...
) -> capo_cognito_identity_provider.types.add_custom_attributes_response.AddCustomAttributesResponse:
    out: capo_cognito_identity_provider.types.add_custom_attributes_response.AddCustomAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.add_custom_attributes_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_add_custom_attributes(
