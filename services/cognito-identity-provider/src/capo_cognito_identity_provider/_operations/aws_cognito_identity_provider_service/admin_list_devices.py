"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminListDevices``."""
...
import capo_cognito_identity_provider.types.admin_list_devices_request
import capo_cognito_identity_provider.types.admin_list_devices_response
...
) -> capo_cognito_identity_provider.types.admin_list_devices_response.AdminListDevicesResponse:
    out: capo_cognito_identity_provider.types.admin_list_devices_response.AdminListDevicesResponse = capo_cognito_identity_provider.types.admin_list_devices_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.admin_list_devices_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_admin_list_devices(
