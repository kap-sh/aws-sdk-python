"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AssociateSoftwareToken``."""
...
import capo_cognito_identity_provider.errors.software_token_mfa_not_found_exception
import capo_cognito_identity_provider.types.associate_software_token_request
import capo_cognito_identity_provider.types.associate_software_token_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SoftwareTokenMFANotFoundException":
            raise capo_cognito_identity_provider.errors.software_token_mfa_not_found_exception.SoftwareTokenMFANotFoundException.from_aws_json_1_1(
                data
            )
        case _:
...
) -> capo_cognito_identity_provider.types.associate_software_token_response.AssociateSoftwareTokenResponse:
    out: capo_cognito_identity_provider.types.associate_software_token_response.AssociateSoftwareTokenResponse = capo_cognito_identity_provider.types.associate_software_token_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.associate_software_token_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_software_token(
