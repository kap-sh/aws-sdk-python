...
class WebAuthnRelyingPartyMismatchException_(TypedDict):
    message: NotRequired[
...
class WebAuthnRelyingPartyMismatchException(ServiceError):
    ...
    def __init__(self, data: WebAuthnRelyingPartyMismatchException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "WebAuthnRelyingPartyMismatchException":
