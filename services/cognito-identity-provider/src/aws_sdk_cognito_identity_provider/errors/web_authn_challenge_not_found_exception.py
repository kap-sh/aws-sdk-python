"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#WebAuthnChallengeNotFoundException``."""
...
class WebAuthnChallengeNotFoundException_(TypedDict, closed=True):
    message: NotRequired[
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: WebAuthnChallengeNotFoundException_) -> dict:
    out: dict = {}
    if "message" in value:
...
class WebAuthnChallengeNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cognitoidentityprovider#WebAuthnChallengeNotFoundException``."""
