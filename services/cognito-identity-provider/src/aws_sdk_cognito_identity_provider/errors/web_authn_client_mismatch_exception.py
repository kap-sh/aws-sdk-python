"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#WebAuthnClientMismatchException``."""
...
class WebAuthnClientMismatchException_(TypedDict, closed=True):
    message: NotRequired[
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: WebAuthnClientMismatchException_) -> dict:
    out: dict = {}
    if "message" in value:
...
class WebAuthnClientMismatchException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cognitoidentityprovider#WebAuthnClientMismatchException``."""
