"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cognitoidentityprovider#AccessDeniedException``."""
