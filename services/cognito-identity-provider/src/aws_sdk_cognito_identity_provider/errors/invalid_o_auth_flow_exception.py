...
class InvalidOAuthFlowException_(TypedDict):
    message: NotRequired[
...
class InvalidOAuthFlowException(ServiceError):
    ...
    def __init__(self, data: InvalidOAuthFlowException_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "InvalidOAuthFlowException":
