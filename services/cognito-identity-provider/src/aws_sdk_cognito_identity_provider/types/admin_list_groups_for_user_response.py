...
if TYPE_CHECKING:
    import aws_sdk_cognito_identity_provider.types.group_list_type
    import aws_sdk_cognito_identity_provider.types.pagination_key


class AdminListGroupsForUserResponse(TypedDict):
    groups: NotRequired[
        "aws_sdk_cognito_identity_provider.types.group_list_type.GroupListType"
    ]
...
def serialize_aws_json_1_1(value: AdminListGroupsForUserResponse) -> dict:
    ...
    if "groups" in value:
        ...
        out["Groups"] = (
            aws_sdk_cognito_identity_provider.types.group_list_type.serialize_aws_json_1_1(
                value["groups"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> AdminListGroupsForUserResponse:
    ...
    if "Groups" in data:
        ...
        out["groups"] = (
            aws_sdk_cognito_identity_provider.types.group_list_type.deserialize_aws_json_1_1(
                data["Groups"]
            )
        )
