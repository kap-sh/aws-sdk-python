...
class KeyConfigurationType(TypedDict):
    ...
    kms_key_arn: NotRequired[
        "aws_sdk_cognito_identity_provider.types.encryption_key_arn_type.EncryptionKeyArnType"
    ]
...
def serialize_aws_json_1_1(value: KeyConfigurationType) -> dict:
    ...
    if "key_type" in value:
        ...
        out["KeyType"] = (
            aws_sdk_cognito_identity_provider.types.encryption_key_type.serialize_aws_json_1_1(
                value["key_type"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> KeyConfigurationType:
    ...
    if "KeyType" in data:
        ...
        out["key_type"] = (
            aws_sdk_cognito_identity_provider.types.encryption_key_type.deserialize_aws_json_1_1(
                data["KeyType"]
            )
        )
