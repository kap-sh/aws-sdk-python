...
if TYPE_CHECKING:
    import aws_sdk_cognito_identity_provider.types.time_units_type


class TokenValidityUnitsType(TypedDict):
    access_token: NotRequired[
        "aws_sdk_cognito_identity_provider.types.time_units_type.TimeUnitsType"
    ]
...
def serialize_aws_json_1_1(value: TokenValidityUnitsType) -> dict:
    ...
    if "access_token" in value:
        ...
        out["AccessToken"] = (
            aws_sdk_cognito_identity_provider.types.time_units_type.serialize_aws_json_1_1(
                value["access_token"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> TokenValidityUnitsType:
    ...
    if "AccessToken" in data:
        ...
        out["access_token"] = (
            aws_sdk_cognito_identity_provider.types.time_units_type.deserialize_aws_json_1_1(
                data["AccessToken"]
            )
        )
    if "IdToken" in data:
