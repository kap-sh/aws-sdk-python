...
class AdminCreateUserConfigType(TypedDict):
    ...
    unused_account_validity_days: "aws_sdk_cognito_identity_provider.types.admin_create_user_unused_account_validity_days_type.AdminCreateUserUnusedAccountValidityDaysType"
...
def serialize_aws_json_1_1(value: AdminCreateUserConfigType) -> dict:
    ...
    if "invite_message_template" in value:
        ...
        out["InviteMessageTemplate"] = (
            aws_sdk_cognito_identity_provider.types.message_template_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AdminCreateUserConfigType:
    ...
    if "InviteMessageTemplate" in data:
        ...
        out["invite_message_template"] = (
            aws_sdk_cognito_identity_provider.types.message_template_type.deserialize_aws_json_1_1(
