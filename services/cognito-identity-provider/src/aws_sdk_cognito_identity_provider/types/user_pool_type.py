...
class UserPoolType(TypedDict):
    ...
    estimated_number_of_users: (
        "aws_sdk_cognito_identity_provider.types.integer_type.IntegerType"
    )
    ...
    arn: NotRequired["aws_sdk_cognito_identity_provider.types.arn_type.ArnType"]
