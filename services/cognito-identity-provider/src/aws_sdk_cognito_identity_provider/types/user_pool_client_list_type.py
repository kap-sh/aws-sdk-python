...
UserPoolClientListType: TypeAlias = list[
    "aws_sdk_cognito_identity_provider.types.user_pool_client_description.UserPoolClientDescription"
]
...
def serialize_aws_json_1_1(value: UserPoolClientListType) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_cognito_identity_provider.types.user_pool_client_description.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> UserPoolClientListType:
    ...
    for item in data:
        out.append(
            aws_sdk_cognito_identity_provider.types.user_pool_client_description.deserialize_aws_json_1_1(
                item
            )
        )
    return out
