...
if TYPE_CHECKING:
    ...
    import aws_sdk_cognito_identity_provider.types.css_version_type
    import aws_sdk_cognito_identity_provider.types.date_type
    import aws_sdk_cognito_identity_provider.types.image_url_type
    import aws_sdk_cognito_identity_provider.types.user_pool_id_type


class UICustomizationType(TypedDict):
    ...
    image_url: NotRequired[
        "aws_sdk_cognito_identity_provider.types.image_url_type.ImageUrlType"
    ]
    ...
    css_version: NotRequired[
        "aws_sdk_cognito_identity_provider.types.css_version_type.CSSVersionType"
    ]
