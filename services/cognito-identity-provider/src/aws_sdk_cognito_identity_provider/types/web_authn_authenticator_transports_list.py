...
if TYPE_CHECKING:
    import aws_sdk_cognito_identity_provider.types.web_authn_authenticator_transport_type

WebAuthnAuthenticatorTransportsList: TypeAlias = list[
    "aws_sdk_cognito_identity_provider.types.web_authn_authenticator_transport_type.WebAuthnAuthenticatorTransportType"
]
