...
class ListIdentityProvidersResponse(TypedDict, closed=True):
    providers: (
        "aws_sdk_cognito_identity_provider.types.providers_list_type.ProvidersListType"
    )
...
def serialize_aws_json_1_1(value: ListIdentityProvidersResponse) -> dict:
    ...
    out["Providers"] = (
        aws_sdk_cognito_identity_provider.types.providers_list_type.serialize_aws_json_1_1(
            value["providers"]
        )
    )
...
def deserialize_aws_json_1_1(data: dict) -> ListIdentityProvidersResponse:
    ...
    if "Providers" in data:
        ...
        out["providers"] = (
            aws_sdk_cognito_identity_provider.types.providers_list_type.deserialize_aws_json_1_1(
                data["Providers"]
            )
        )
    else:
