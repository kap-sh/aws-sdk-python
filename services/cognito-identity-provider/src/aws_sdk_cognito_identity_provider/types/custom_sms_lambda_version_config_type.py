...
if TYPE_CHECKING:
    ...
    import aws_sdk_cognito_identity_provider.types.custom_sms_sender_lambda_version_type


class CustomSMSLambdaVersionConfigType(TypedDict):
    lambda_version: "aws_sdk_cognito_identity_provider.types.custom_sms_sender_lambda_version_type.CustomSMSSenderLambdaVersionType"
...
def serialize_aws_json_1_1(value: CustomSMSLambdaVersionConfigType) -> dict:
    ...
    out["LambdaVersion"] = (
        aws_sdk_cognito_identity_provider.types.custom_sms_sender_lambda_version_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CustomSMSLambdaVersionConfigType:
    ...
    if "LambdaVersion" in data:
        ...
        out["lambda_version"] = (
            aws_sdk_cognito_identity_provider.types.custom_sms_sender_lambda_version_type.deserialize_aws_json_1_1(
                data["LambdaVersion"]
            )
        )
    else:
