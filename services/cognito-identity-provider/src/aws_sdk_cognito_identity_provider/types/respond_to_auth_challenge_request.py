"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#RespondToAuthChallengeRequest``."""
...
class RespondToAuthChallengeRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: RespondToAuthChallengeRequest) -> dict:
    out: dict = {}
    ...
    if "challenge_responses" in value:
        ...
        out["ChallengeResponses"] = (
            aws_sdk_cognito_identity_provider.types.challenge_responses_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RespondToAuthChallengeRequest:
    out: RespondToAuthChallengeRequest = {}  # type: ignore[typeddict-item]
    if "ClientId" in data:
        out["client_id"] = data["ClientId"]
    else:
        raise DeserializationError("RespondToAuthChallengeRequest.client_id required")
    if "ChallengeName" in data:
        ...
        raise DeserializationError(
            "RespondToAuthChallengeRequest.challenge_name required"
        )
    if "Session" in data:
    ...
    if "ChallengeResponses" in data:
        ...
        out["challenge_responses"] = (
            aws_sdk_cognito_identity_provider.types.challenge_responses_type.deserialize_aws_json_1_1(
