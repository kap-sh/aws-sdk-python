"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#CreateUserImportJobResponse``."""
...
class CreateUserImportJobResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateUserImportJobResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> CreateUserImportJobResponse:
    out: CreateUserImportJobResponse = {}  # type: ignore[typeddict-item]
