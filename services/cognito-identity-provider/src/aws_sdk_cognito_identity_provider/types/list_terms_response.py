...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListTermsResponse) -> dict:
    out: dict = {}
    import aws_sdk_cognito_identity_provider.types.terms_description_list_type

    out["Terms"] = (
        aws_sdk_cognito_identity_provider.types.terms_description_list_type.serialize_aws_json_1_1(
            value["terms"]
        )
    )
...
def deserialize_aws_json_1_1(data: dict) -> ListTermsResponse:
    ...
    if "Terms" in data:
        ...
        out["terms"] = (
            aws_sdk_cognito_identity_provider.types.terms_description_list_type.deserialize_aws_json_1_1(
                data["Terms"]
            )
        )
    else:
