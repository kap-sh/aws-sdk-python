...
if TYPE_CHECKING:
    import aws_sdk_cognito_identity_provider.types.account_takeover_action_notify_type
...
def serialize_aws_json_1_1(value: AccountTakeoverActionType) -> dict:
    ...
    out["EventAction"] = (
        aws_sdk_cognito_identity_provider.types.account_takeover_event_action_type.serialize_aws_json_1_1(
            value["event_action"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> AccountTakeoverActionType:
    ...
    if "EventAction" in data:
        ...
        out["event_action"] = (
            aws_sdk_cognito_identity_provider.types.account_takeover_event_action_type.deserialize_aws_json_1_1(
                data["EventAction"]
            )
        )
    else:
