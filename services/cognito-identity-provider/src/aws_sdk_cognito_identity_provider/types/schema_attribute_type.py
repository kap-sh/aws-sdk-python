...
if TYPE_CHECKING:
    ...
    import aws_sdk_cognito_identity_provider.types.custom_attribute_name_type
    import aws_sdk_cognito_identity_provider.types.number_attribute_constraints_type
...
class SchemaAttributeType(TypedDict):
    ...
    attribute_data_type: NotRequired[
        "aws_sdk_cognito_identity_provider.types.attribute_data_type.AttributeDataType"
    ]
    ...
    number_attribute_constraints: NotRequired[
        "aws_sdk_cognito_identity_provider.types.number_attribute_constraints_type.NumberAttributeConstraintsType"
    ]
    """<p>Specifies the constraints for an attribute of the number type.</p>"""
    string_attribute_constraints: NotRequired[
        "aws_sdk_cognito_identity_provider.types.string_attribute_constraints_type.StringAttributeConstraintsType"
    ]
...
def serialize_aws_json_1_1(value: SchemaAttributeType) -> dict:
    ...
    if "attribute_data_type" in value:
        ...
        out["AttributeDataType"] = (
            aws_sdk_cognito_identity_provider.types.attribute_data_type.serialize_aws_json_1_1(
    ...
    if "number_attribute_constraints" in value:
        ...
        out["NumberAttributeConstraints"] = (
            aws_sdk_cognito_identity_provider.types.number_attribute_constraints_type.serialize_aws_json_1_1(
    ...
    if "string_attribute_constraints" in value:
        ...
        out["StringAttributeConstraints"] = (
            aws_sdk_cognito_identity_provider.types.string_attribute_constraints_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SchemaAttributeType:
    ...
    if "AttributeDataType" in data:
        ...
        out["attribute_data_type"] = (
            aws_sdk_cognito_identity_provider.types.attribute_data_type.deserialize_aws_json_1_1(
    ...
    if "NumberAttributeConstraints" in data:
        ...
        out["number_attribute_constraints"] = (
            aws_sdk_cognito_identity_provider.types.number_attribute_constraints_type.deserialize_aws_json_1_1(
    ...
    if "StringAttributeConstraints" in data:
        ...
        out["string_attribute_constraints"] = (
            aws_sdk_cognito_identity_provider.types.string_attribute_constraints_type.deserialize_aws_json_1_1(
