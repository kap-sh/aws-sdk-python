"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminRespondToAuthChallengeResponse``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AdminRespondToAuthChallengeResponse) -> dict:
    out: dict = {}
