"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminResetUserPasswordRequest``."""
...
class AdminResetUserPasswordRequest(TypedDict, closed=True):
    user_pool_id: (
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AdminResetUserPasswordRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> AdminResetUserPasswordRequest:
    out: AdminResetUserPasswordRequest = {}  # type: ignore[typeddict-item]
    if "UserPoolId" in data:
        out["user_pool_id"] = data["UserPoolId"]
    else:
        raise DeserializationError(
            "AdminResetUserPasswordRequest.user_pool_id required"
        )
    if "Username" in data:
        out["username"] = data["Username"]
    else:
        raise DeserializationError("AdminResetUserPasswordRequest.username required")
