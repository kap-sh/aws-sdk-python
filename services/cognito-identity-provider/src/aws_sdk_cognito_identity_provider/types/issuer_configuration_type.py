...
def serialize_aws_json_1_1(value: IssuerConfigurationType) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = (
            aws_sdk_cognito_identity_provider.types.issuer_type.serialize_aws_json_1_1(
                value["type"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> IssuerConfigurationType:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_cognito_identity_provider.types.issuer_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    return out
