...
class ChallengeResponseType(TypedDict, closed=True):
    ...
    challenge_response: NotRequired[
        "aws_sdk_cognito_identity_provider.types.challenge_response.ChallengeResponse"
    ]
...
def serialize_aws_json_1_1(value: ChallengeResponseType) -> dict:
    ...
    if "challenge_name" in value:
        ...
        out["ChallengeName"] = (
            aws_sdk_cognito_identity_provider.types.challenge_name.serialize_aws_json_1_1(
    ...
    if "challenge_response" in value:
        ...
        out["ChallengeResponse"] = (
            aws_sdk_cognito_identity_provider.types.challenge_response.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ChallengeResponseType:
    ...
    if "ChallengeName" in data:
        ...
        out["challenge_name"] = (
            aws_sdk_cognito_identity_provider.types.challenge_name.deserialize_aws_json_1_1(
                data["ChallengeName"]
            )
        )
    if "ChallengeResponse" in data:
        ...
        out["challenge_response"] = (
            aws_sdk_cognito_identity_provider.types.challenge_response.deserialize_aws_json_1_1(
