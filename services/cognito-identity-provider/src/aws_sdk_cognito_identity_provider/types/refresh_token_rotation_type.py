...
if TYPE_CHECKING:
    import aws_sdk_cognito_identity_provider.types.feature_type
...
class RefreshTokenRotationType(TypedDict, closed=True):
    ...
    retry_grace_period_seconds: NotRequired[
        "aws_sdk_cognito_identity_provider.types.retry_grace_period_seconds_type.RetryGracePeriodSecondsType"
    ]
...
def serialize_aws_json_1_1(value: RefreshTokenRotationType) -> dict:
    ...
    out["Feature"] = (
        aws_sdk_cognito_identity_provider.types.feature_type.serialize_aws_json_1_1(
            value["feature"]
        )
    )
...
def deserialize_aws_json_1_1(data: dict) -> RefreshTokenRotationType:
    ...
    if "Feature" in data:
        ...
        out["feature"] = (
            aws_sdk_cognito_identity_provider.types.feature_type.deserialize_aws_json_1_1(
                data["Feature"]
            )
        )
    else:
