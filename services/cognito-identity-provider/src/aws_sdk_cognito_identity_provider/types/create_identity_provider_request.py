"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#CreateIdentityProviderRequest``."""
...
class CreateIdentityProviderRequest(TypedDict, closed=True):
    user_pool_id: (
    ...
    r"""<p>The name that you want to assign to the IdP. You can pass the identity provider name in the <code>identity_provider</code> query parameter of requests to the <a href=\"https://docs.aws.amazon.com/cognito/latest/developerguide/authorization-endpoint.html\">Authorize endpoint</a> to silently redirect to sign-in with the associated IdP.</p>"""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateIdentityProviderRequest) -> dict:
    out: dict = {}
    ...
    out["ProviderType"] = (
        aws_sdk_cognito_identity_provider.types.identity_provider_type_type.serialize_aws_json_1_1(
            value["provider_type"]
        )
    )
    import aws_sdk_cognito_identity_provider.types.provider_details_type
...
def deserialize_aws_json_1_1(data: dict) -> CreateIdentityProviderRequest:
    ...
    if "ProviderType" in data:
        ...
        out["provider_type"] = (
            aws_sdk_cognito_identity_provider.types.identity_provider_type_type.deserialize_aws_json_1_1(
                data["ProviderType"]
            )
        )
    else:
