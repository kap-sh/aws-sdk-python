...
from aws_sdk_cognito_identity_provider._services._aws_config import aws_config
...
class CognitoIdentityProviderClientConfig(TypedDict, total=False, closed=True):
...
class CognitoIdentityProviderClient:
    ...
    def __init__(
        ...
        self._config = CognitoIdentityProviderClientConfig(
            {
