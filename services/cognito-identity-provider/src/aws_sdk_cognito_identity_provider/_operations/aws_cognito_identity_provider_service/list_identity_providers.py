...
import aws_sdk_cognito_identity_provider.types.providers_list_type
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.list_identity_providers_response.ListIdentityProvidersResponse = aws_sdk_cognito_identity_provider.types.list_identity_providers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.list_identity_providers_request.ListIdentityProvidersRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.list_identity_providers_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
