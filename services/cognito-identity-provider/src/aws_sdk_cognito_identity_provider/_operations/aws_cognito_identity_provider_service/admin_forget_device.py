"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminForgetDevice``."""
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.admin_forget_device_request.AdminForgetDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.admin_forget_device_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_admin_forget_device(
