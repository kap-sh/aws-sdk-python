"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#UpdateAuthEventFeedback``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.update_auth_event_feedback_response.UpdateAuthEventFeedbackResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.update_auth_event_feedback_request.UpdateAuthEventFeedbackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.update_auth_event_feedback_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_auth_event_feedback(
