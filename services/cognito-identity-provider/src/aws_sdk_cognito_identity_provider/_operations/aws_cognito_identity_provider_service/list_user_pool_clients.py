...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.list_user_pool_clients_response.ListUserPoolClientsResponse = aws_sdk_cognito_identity_provider.types.list_user_pool_clients_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.list_user_pool_clients_request.ListUserPoolClientsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.list_user_pool_clients_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
