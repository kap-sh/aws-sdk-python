"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminRemoveUserFromGroup``."""
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.admin_remove_user_from_group_request.AdminRemoveUserFromGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_admin_remove_user_from_group(
