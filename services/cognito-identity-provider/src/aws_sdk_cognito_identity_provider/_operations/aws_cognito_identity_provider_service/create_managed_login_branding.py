...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ManagedLoginBrandingExistsException":
            import aws_sdk_cognito_identity_provider.errors.managed_login_branding_exists_exception

            raise aws_sdk_cognito_identity_provider.errors.managed_login_branding_exists_exception.ManagedLoginBrandingExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.create_managed_login_branding_response.CreateManagedLoginBrandingResponse = aws_sdk_cognito_identity_provider.types.create_managed_login_branding_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.create_managed_login_branding_request.CreateManagedLoginBrandingRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
