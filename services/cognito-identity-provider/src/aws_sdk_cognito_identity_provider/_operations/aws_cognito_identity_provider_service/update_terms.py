...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TermsExistsException":
            import aws_sdk_cognito_identity_provider.errors.terms_exists_exception

            raise aws_sdk_cognito_identity_provider.errors.terms_exists_exception.TermsExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.update_terms_response.UpdateTermsResponse = aws_sdk_cognito_identity_provider.types.update_terms_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.update_terms_request.UpdateTermsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.update_terms_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
