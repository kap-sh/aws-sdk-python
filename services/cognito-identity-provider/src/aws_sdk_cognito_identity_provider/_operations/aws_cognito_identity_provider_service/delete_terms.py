"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DeleteTerms``."""
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.delete_terms_request.DeleteTermsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSCognitoIdentityProviderService.DeleteTerms"
    import aws_sdk_cognito_identity_provider.types.delete_terms_request

    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.delete_terms_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
