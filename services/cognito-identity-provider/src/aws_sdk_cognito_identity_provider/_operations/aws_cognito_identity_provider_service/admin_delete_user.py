...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.admin_delete_user_request.AdminDeleteUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.admin_delete_user_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
