...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.get_user_auth_factors_response.GetUserAuthFactorsResponse = aws_sdk_cognito_identity_provider.types.get_user_auth_factors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.get_user_auth_factors_request.GetUserAuthFactorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.get_user_auth_factors_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
