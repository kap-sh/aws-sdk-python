...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.admin_set_user_mfa_preference_response.AdminSetUserMFAPreferenceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.admin_set_user_mfa_preference_request.AdminSetUserMFAPreferenceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
