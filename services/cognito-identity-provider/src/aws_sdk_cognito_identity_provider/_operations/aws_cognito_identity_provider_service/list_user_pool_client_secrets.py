...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.list_user_pool_client_secrets_response.ListUserPoolClientSecretsResponse = aws_sdk_cognito_identity_provider.types.list_user_pool_client_secrets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.list_user_pool_client_secrets_request.ListUserPoolClientSecretsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.list_user_pool_client_secrets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
