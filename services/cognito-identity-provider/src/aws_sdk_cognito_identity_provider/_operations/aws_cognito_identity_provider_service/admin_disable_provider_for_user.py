"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminDisableProviderForUser``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.admin_disable_provider_for_user_response.AdminDisableProviderForUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.admin_disable_provider_for_user_request.AdminDisableProviderForUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_admin_disable_provider_for_user(
