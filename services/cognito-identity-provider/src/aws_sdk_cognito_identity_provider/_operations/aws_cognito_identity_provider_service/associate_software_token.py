...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.associate_software_token_response.AssociateSoftwareTokenResponse = aws_sdk_cognito_identity_provider.types.associate_software_token_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.associate_software_token_request.AssociateSoftwareTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.associate_software_token_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
