...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.list_users_in_group_response.ListUsersInGroupResponse = aws_sdk_cognito_identity_provider.types.list_users_in_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.list_users_in_group_request.ListUsersInGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.list_users_in_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
