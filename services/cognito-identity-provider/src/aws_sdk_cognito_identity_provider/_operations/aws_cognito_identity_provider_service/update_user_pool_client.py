...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.update_user_pool_client_response.UpdateUserPoolClientResponse = aws_sdk_cognito_identity_provider.types.update_user_pool_client_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.update_user_pool_client_request.UpdateUserPoolClientRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
