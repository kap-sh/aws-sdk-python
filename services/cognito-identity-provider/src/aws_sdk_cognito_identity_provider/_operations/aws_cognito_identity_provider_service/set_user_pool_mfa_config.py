...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.set_user_pool_mfa_config_response.SetUserPoolMfaConfigResponse = aws_sdk_cognito_identity_provider.types.set_user_pool_mfa_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.set_user_pool_mfa_config_request.SetUserPoolMfaConfigRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.set_user_pool_mfa_config_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
