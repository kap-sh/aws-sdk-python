"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ChangePassword``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.change_password_response.ChangePasswordResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.change_password_request.ChangePasswordRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.change_password_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
