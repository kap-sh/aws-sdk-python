...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.admin_initiate_auth_response.AdminInitiateAuthResponse = aws_sdk_cognito_identity_provider.types.admin_initiate_auth_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.admin_initiate_auth_request.AdminInitiateAuthRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.admin_initiate_auth_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
