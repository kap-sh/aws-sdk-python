...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.verify_software_token_request.VerifySoftwareTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.verify_software_token_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
