"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminCreateUser``."""
...
import aws_sdk_cognito_identity_provider.errors.precondition_not_met_exception
...
import aws_sdk_cognito_identity_provider.errors.unsupported_user_state_exception
...
import aws_sdk_cognito_identity_provider.errors.username_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PreconditionNotMetException":
            raise aws_sdk_cognito_identity_provider.errors.precondition_not_met_exception.PreconditionNotMetException.from_aws_json_1_1(
                data
            )
        ...
        case "UnsupportedUserStateException":
            raise aws_sdk_cognito_identity_provider.errors.unsupported_user_state_exception.UnsupportedUserStateException.from_aws_json_1_1(
                data
            )
        ...
        case "UsernameExistsException":
            raise aws_sdk_cognito_identity_provider.errors.username_exists_exception.UsernameExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.admin_create_user_response.AdminCreateUserResponse = aws_sdk_cognito_identity_provider.types.admin_create_user_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.admin_create_user_request.AdminCreateUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.admin_create_user_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_admin_create_user(
