...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.update_device_status_response.UpdateDeviceStatusResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.update_device_status_request.UpdateDeviceStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.update_device_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
