...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.admin_user_global_sign_out_response.AdminUserGlobalSignOutResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.admin_user_global_sign_out_request.AdminUserGlobalSignOutRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.admin_user_global_sign_out_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
