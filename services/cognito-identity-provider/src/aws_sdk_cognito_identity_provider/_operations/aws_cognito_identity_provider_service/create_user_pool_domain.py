...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.create_user_pool_domain_response.CreateUserPoolDomainResponse = aws_sdk_cognito_identity_provider.types.create_user_pool_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.create_user_pool_domain_request.CreateUserPoolDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.create_user_pool_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
