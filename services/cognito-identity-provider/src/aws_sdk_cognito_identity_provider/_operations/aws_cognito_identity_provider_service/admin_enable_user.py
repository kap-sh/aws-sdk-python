"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminEnableUser``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.admin_enable_user_response.AdminEnableUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.admin_enable_user_request.AdminEnableUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.admin_enable_user_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_admin_enable_user(
