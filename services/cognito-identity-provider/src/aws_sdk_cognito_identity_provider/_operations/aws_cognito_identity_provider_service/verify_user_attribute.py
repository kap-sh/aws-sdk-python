...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.verify_user_attribute_response.VerifyUserAttributeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.verify_user_attribute_request.VerifyUserAttributeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.verify_user_attribute_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
