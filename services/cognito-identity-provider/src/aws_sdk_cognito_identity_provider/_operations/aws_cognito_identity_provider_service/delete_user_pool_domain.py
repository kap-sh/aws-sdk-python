...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.delete_user_pool_domain_response.DeleteUserPoolDomainResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.delete_user_pool_domain_request.DeleteUserPoolDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.delete_user_pool_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
