...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.admin_update_auth_event_feedback_response.AdminUpdateAuthEventFeedbackResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.admin_update_auth_event_feedback_request.AdminUpdateAuthEventFeedbackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
