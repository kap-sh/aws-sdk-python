"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DeleteUser``."""
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.delete_user_request.DeleteUserRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.delete_user_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
