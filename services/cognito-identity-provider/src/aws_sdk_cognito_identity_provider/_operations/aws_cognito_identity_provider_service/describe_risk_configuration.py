"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DescribeRiskConfiguration``."""
...
import aws_sdk_cognito_identity_provider.errors.user_pool_add_on_not_enabled_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UserPoolAddOnNotEnabledException":
            raise aws_sdk_cognito_identity_provider.errors.user_pool_add_on_not_enabled_exception.UserPoolAddOnNotEnabledException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.describe_risk_configuration_response.DescribeRiskConfigurationResponse = aws_sdk_cognito_identity_provider.types.describe_risk_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.describe_risk_configuration_request.DescribeRiskConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.describe_risk_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_risk_configuration(
