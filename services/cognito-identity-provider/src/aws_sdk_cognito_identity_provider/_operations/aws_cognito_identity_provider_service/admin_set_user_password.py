...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.admin_set_user_password_response.AdminSetUserPasswordResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.admin_set_user_password_request.AdminSetUserPasswordRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.admin_set_user_password_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
