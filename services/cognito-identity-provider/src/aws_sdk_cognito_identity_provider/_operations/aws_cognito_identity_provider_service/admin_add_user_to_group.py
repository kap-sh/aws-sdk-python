"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminAddUserToGroup``."""
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.admin_add_user_to_group_request.AdminAddUserToGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.admin_add_user_to_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_admin_add_user_to_group(
