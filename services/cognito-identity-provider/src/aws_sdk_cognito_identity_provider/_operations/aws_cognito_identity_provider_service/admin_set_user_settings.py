...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.admin_set_user_settings_response.AdminSetUserSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.admin_set_user_settings_request.AdminSetUserSettingsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.admin_set_user_settings_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
