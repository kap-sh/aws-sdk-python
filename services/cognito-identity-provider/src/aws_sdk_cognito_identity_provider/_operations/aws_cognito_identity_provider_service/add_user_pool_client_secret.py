"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AddUserPoolClientSecret``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            import aws_sdk_cognito_identity_provider.errors.access_denied_exception

            raise aws_sdk_cognito_identity_provider.errors.access_denied_exception.AccessDeniedException.from_aws_json_1_1(
                data
            )
        case "InternalServerException":
            import aws_sdk_cognito_identity_provider.errors.internal_server_exception

            raise aws_sdk_cognito_identity_provider.errors.internal_server_exception.InternalServerException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.add_user_pool_client_secret_response.AddUserPoolClientSecretResponse = aws_sdk_cognito_identity_provider.types.add_user_pool_client_secret_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.add_user_pool_client_secret_request.AddUserPoolClientSecretRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.add_user_pool_client_secret_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_add_user_pool_client_secret(
