"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DescribeResourceServer``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.describe_resource_server_response.DescribeResourceServerResponse = aws_sdk_cognito_identity_provider.types.describe_resource_server_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.describe_resource_server_request.DescribeResourceServerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.describe_resource_server_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_resource_server(
