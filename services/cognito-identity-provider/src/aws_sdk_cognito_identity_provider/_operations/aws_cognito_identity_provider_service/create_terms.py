...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.create_terms_response.CreateTermsResponse = aws_sdk_cognito_identity_provider.types.create_terms_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.create_terms_request.CreateTermsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.create_terms_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
