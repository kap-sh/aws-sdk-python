"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#CreateUserPoolClient``."""
...
import aws_sdk_cognito_identity_provider.errors.invalid_o_auth_flow_exception
...
import aws_sdk_cognito_identity_provider.errors.scope_does_not_exist_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidOAuthFlowException":
            raise aws_sdk_cognito_identity_provider.errors.invalid_o_auth_flow_exception.InvalidOAuthFlowException.from_aws_json_1_1(
                data
            )
        ...
        case "ScopeDoesNotExistException":
            raise aws_sdk_cognito_identity_provider.errors.scope_does_not_exist_exception.ScopeDoesNotExistException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.create_user_pool_client_response.CreateUserPoolClientResponse = aws_sdk_cognito_identity_provider.types.create_user_pool_client_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.create_user_pool_client_request.CreateUserPoolClientRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.create_user_pool_client_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_user_pool_client(
