...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.resend_confirmation_code_response.ResendConfirmationCodeResponse = aws_sdk_cognito_identity_provider.types.resend_confirmation_code_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.resend_confirmation_code_request.ResendConfirmationCodeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
