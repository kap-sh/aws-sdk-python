"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#CreateUserPoolReplica``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.create_user_pool_replica_response.CreateUserPoolReplicaResponse = aws_sdk_cognito_identity_provider.types.create_user_pool_replica_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.create_user_pool_replica_request.CreateUserPoolReplicaRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSCognitoIdentityProviderService.CreateUserPoolReplica"
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.create_user_pool_replica_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_user_pool_replica(
