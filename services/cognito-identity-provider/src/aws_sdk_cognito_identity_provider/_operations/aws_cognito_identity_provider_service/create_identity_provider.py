...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DuplicateProviderException":
            import aws_sdk_cognito_identity_provider.errors.duplicate_provider_exception

            raise aws_sdk_cognito_identity_provider.errors.duplicate_provider_exception.DuplicateProviderException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.create_identity_provider_response.CreateIdentityProviderResponse = aws_sdk_cognito_identity_provider.types.create_identity_provider_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.create_identity_provider_request.CreateIdentityProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.create_identity_provider_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
