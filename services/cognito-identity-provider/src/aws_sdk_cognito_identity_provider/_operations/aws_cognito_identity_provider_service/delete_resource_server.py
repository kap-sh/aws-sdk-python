"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DeleteResourceServer``."""
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.delete_resource_server_request.DeleteResourceServerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.delete_resource_server_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_resource_server(
