...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.set_log_delivery_configuration_response.SetLogDeliveryConfigurationResponse = aws_sdk_cognito_identity_provider.types.set_log_delivery_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.set_log_delivery_configuration_request.SetLogDeliveryConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.set_log_delivery_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
