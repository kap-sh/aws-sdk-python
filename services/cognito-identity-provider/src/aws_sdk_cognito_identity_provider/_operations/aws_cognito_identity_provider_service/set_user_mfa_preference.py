"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#SetUserMFAPreference``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.set_user_mfa_preference_response.SetUserMFAPreferenceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.set_user_mfa_preference_request.SetUserMFAPreferenceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.set_user_mfa_preference_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_set_user_mfa_preference(
