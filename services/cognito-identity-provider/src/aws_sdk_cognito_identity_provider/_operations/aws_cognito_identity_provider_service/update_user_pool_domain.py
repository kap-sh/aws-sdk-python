"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#UpdateUserPoolDomain``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.update_user_pool_domain_response.UpdateUserPoolDomainResponse = aws_sdk_cognito_identity_provider.types.update_user_pool_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.update_user_pool_domain_request.UpdateUserPoolDomainRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.update_user_pool_domain_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_user_pool_domain(
