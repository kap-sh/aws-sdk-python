...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "RefreshTokenReuseException":
            import aws_sdk_cognito_identity_provider.errors.refresh_token_reuse_exception

            raise aws_sdk_cognito_identity_provider.errors.refresh_token_reuse_exception.RefreshTokenReuseException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.get_tokens_from_refresh_token_response.GetTokensFromRefreshTokenResponse = aws_sdk_cognito_identity_provider.types.get_tokens_from_refresh_token_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.get_tokens_from_refresh_token_request.GetTokensFromRefreshTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
