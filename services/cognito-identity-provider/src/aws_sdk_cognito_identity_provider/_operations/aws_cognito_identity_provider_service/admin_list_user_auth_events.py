...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.admin_list_user_auth_events_response.AdminListUserAuthEventsResponse = aws_sdk_cognito_identity_provider.types.admin_list_user_auth_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.admin_list_user_auth_events_request.AdminListUserAuthEventsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
