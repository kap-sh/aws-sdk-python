...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.get_user_attribute_verification_code_response.GetUserAttributeVerificationCodeResponse = aws_sdk_cognito_identity_provider.types.get_user_attribute_verification_code_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.get_user_attribute_verification_code_request.GetUserAttributeVerificationCodeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.get_user_attribute_verification_code_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
