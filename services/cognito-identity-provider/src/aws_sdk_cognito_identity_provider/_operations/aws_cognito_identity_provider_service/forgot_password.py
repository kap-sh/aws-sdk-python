"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ForgotPassword``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.forgot_password_response.ForgotPasswordResponse = aws_sdk_cognito_identity_provider.types.forgot_password_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.forgot_password_request.ForgotPasswordRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.forgot_password_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
