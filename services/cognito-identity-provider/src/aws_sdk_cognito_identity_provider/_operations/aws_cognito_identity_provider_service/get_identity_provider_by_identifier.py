"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#GetIdentityProviderByIdentifier``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.get_identity_provider_by_identifier_response.GetIdentityProviderByIdentifierResponse = aws_sdk_cognito_identity_provider.types.get_identity_provider_by_identifier_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.get_identity_provider_by_identifier_request.GetIdentityProviderByIdentifierRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.get_identity_provider_by_identifier_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_identity_provider_by_identifier(
