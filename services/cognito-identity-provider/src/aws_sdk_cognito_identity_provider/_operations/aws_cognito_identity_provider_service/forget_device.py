"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ForgetDevice``."""
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.forget_device_request.ForgetDeviceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.forget_device_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
