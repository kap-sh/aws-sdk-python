...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.delete_web_authn_credential_response.DeleteWebAuthnCredentialResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.delete_web_authn_credential_request.DeleteWebAuthnCredentialRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.delete_web_authn_credential_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
