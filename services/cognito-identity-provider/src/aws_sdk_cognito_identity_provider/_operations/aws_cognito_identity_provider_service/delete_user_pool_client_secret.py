...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.delete_user_pool_client_secret_response.DeleteUserPoolClientSecretResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.delete_user_pool_client_secret_request.DeleteUserPoolClientSecretRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
