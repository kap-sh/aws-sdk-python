"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#CompleteWebAuthnRegistration``."""
...
import aws_sdk_cognito_identity_provider.errors.web_authn_challenge_not_found_exception
import aws_sdk_cognito_identity_provider.errors.web_authn_client_mismatch_exception
import aws_sdk_cognito_identity_provider.errors.web_authn_credential_not_supported_exception
import aws_sdk_cognito_identity_provider.errors.web_authn_not_enabled_exception
import aws_sdk_cognito_identity_provider.errors.web_authn_origin_not_allowed_exception
import aws_sdk_cognito_identity_provider.errors.web_authn_relying_party_mismatch_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WebAuthnChallengeNotFoundException":
            raise aws_sdk_cognito_identity_provider.errors.web_authn_challenge_not_found_exception.WebAuthnChallengeNotFoundException.from_aws_json_1_1(
                data
            )
        case "WebAuthnClientMismatchException":
            raise aws_sdk_cognito_identity_provider.errors.web_authn_client_mismatch_exception.WebAuthnClientMismatchException.from_aws_json_1_1(
                data
            )
        case "WebAuthnCredentialNotSupportedException":
            raise aws_sdk_cognito_identity_provider.errors.web_authn_credential_not_supported_exception.WebAuthnCredentialNotSupportedException.from_aws_json_1_1(
                data
            )
        ...
        case "WebAuthnOriginNotAllowedException":
            raise aws_sdk_cognito_identity_provider.errors.web_authn_origin_not_allowed_exception.WebAuthnOriginNotAllowedException.from_aws_json_1_1(
                data
            )
        case "WebAuthnRelyingPartyMismatchException":
            raise aws_sdk_cognito_identity_provider.errors.web_authn_relying_party_mismatch_exception.WebAuthnRelyingPartyMismatchException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.complete_web_authn_registration_response.CompleteWebAuthnRegistrationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.complete_web_authn_registration_request.CompleteWebAuthnRegistrationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_complete_web_authn_registration(
