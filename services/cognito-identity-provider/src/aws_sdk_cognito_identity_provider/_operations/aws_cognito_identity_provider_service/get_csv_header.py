"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#GetCSVHeader``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.get_csv_header_response.GetCSVHeaderResponse = aws_sdk_cognito_identity_provider.types.get_csv_header_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.get_csv_header_request.GetCSVHeaderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.get_csv_header_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_csv_header(
