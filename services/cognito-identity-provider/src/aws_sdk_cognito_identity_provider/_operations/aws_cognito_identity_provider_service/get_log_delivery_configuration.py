...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.get_log_delivery_configuration_response.GetLogDeliveryConfigurationResponse = aws_sdk_cognito_identity_provider.types.get_log_delivery_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.get_log_delivery_configuration_request.GetLogDeliveryConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.get_log_delivery_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
