...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.describe_identity_provider_response.DescribeIdentityProviderResponse = aws_sdk_cognito_identity_provider.types.describe_identity_provider_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.describe_identity_provider_request.DescribeIdentityProviderRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
