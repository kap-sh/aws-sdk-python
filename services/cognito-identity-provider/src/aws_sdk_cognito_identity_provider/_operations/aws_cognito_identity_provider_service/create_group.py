...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "GroupExistsException":
            import aws_sdk_cognito_identity_provider.errors.group_exists_exception

            raise aws_sdk_cognito_identity_provider.errors.group_exists_exception.GroupExistsException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.create_group_response.CreateGroupResponse = aws_sdk_cognito_identity_provider.types.create_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.create_group_request.CreateGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.create_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
