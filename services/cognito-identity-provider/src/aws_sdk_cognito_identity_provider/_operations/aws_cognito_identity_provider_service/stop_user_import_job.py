...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.stop_user_import_job_response.StopUserImportJobResponse = aws_sdk_cognito_identity_provider.types.stop_user_import_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.stop_user_import_job_request.StopUserImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.stop_user_import_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
