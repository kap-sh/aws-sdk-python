...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.describe_user_pool_response.DescribeUserPoolResponse = aws_sdk_cognito_identity_provider.types.describe_user_pool_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.describe_user_pool_request.DescribeUserPoolRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.describe_user_pool_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
