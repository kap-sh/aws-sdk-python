...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.sign_up_response.SignUpResponse = aws_sdk_cognito_identity_provider.types.sign_up_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.sign_up_request.SignUpRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
