"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ListWebAuthnCredentials``."""
...
def handle_response(
    ...
    out: aws_sdk_cognito_identity_provider.types.list_web_authn_credentials_response.ListWebAuthnCredentialsResponse = aws_sdk_cognito_identity_provider.types.list_web_authn_credentials_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_cognito_identity_provider.types.list_web_authn_credentials_request.ListWebAuthnCredentialsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_cognito_identity_provider.types.list_web_authn_credentials_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_web_authn_credentials(
