...
def resolve(p: EndpointParams) -> Endpoint:  # type: ignore
    ...
    if p.Region is not None:
        ...
        if _locals["PartitionResult"] is not None:
                    ...
                    if True is get_attr(
                        ...
                        if True is get_attr(
                            ...
                            if string_equals(
                                ...
                                return Endpoint(
                                    url=interpolate(
                                        "https://cognito-idp-fips.us-east-1.amazonaws.com",
                                        p,
                                        _locals,
                                    ),
                                    properties={},
                            ...
                            if string_equals(
                                ...
                                return Endpoint(
                                    url=interpolate(
                                        "https://cognito-idp-fips.us-east-2.amazonaws.com",
                                        p,
                                        _locals,
                                    ),
                                    properties={},
                            ...
                            if string_equals(
                                ...
                                return Endpoint(
                                    url=interpolate(
                                        "https://cognito-idp-fips.us-west-1.amazonaws.com",
                                        p,
                                        _locals,
                                    ),
                                    properties={},
                            ...
                            if string_equals(
                                ...
                                return Endpoint(
                                    url=interpolate(
                                        "https://cognito-idp-fips.us-west-2.amazonaws.com",
                                        p,
                                        _locals,
                                    ),
                                    properties={},
            ...
            if p.UseDualStack is True:
                if True is get_attr(
                    ...
                    if string_equals(
                        ...
                        return Endpoint(
                            url=interpolate(
                                "https://cognito-idp.{Region}.amazonaws.com", p, _locals
                            ),
                            properties={},
                            headers={},
                        )
            ...
            return Endpoint(
                url=interpolate(
                    "https://cognito-idp.{Region}.{PartitionResult#dnsSuffix}",
                    p,
                    _locals,
                ),
                properties={},
