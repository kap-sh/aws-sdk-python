...
from ._services.async_cognito_identity_provider import (
    AsyncCognitoIdentityProviderClient as AsyncCognitoIdentityProviderClient,
)
from ._services.cognito_identity_provider import (
    CognitoIdentityProviderClient as CognitoIdentityProviderClient,
)
