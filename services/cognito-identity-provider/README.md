...
```
pip install capo-cognito-identity-provider
```

## Usage

```python
from capo_cognito_identity_provider import AsyncCognitoIdentityProviderClient
...
```python
from capo_cognito_identity_provider import AsyncCognitoIdentityProviderClient
from capo_cognito_identity_provider.error import InternalErrorException
