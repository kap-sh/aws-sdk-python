...
```
pip install aws-sdk-cognito-identity-provider
```

## Usage

```python
from aws_sdk_cognito_identity_provider import AsyncCognitoIdentityProviderClient
...
```python
from aws_sdk_cognito_identity_provider import AsyncCognitoIdentityProviderClient
from aws_sdk_cognito_identity_provider.error import InternalErrorException
