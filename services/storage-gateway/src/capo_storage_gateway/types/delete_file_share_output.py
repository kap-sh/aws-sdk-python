"""Generated from Smithy shape ``com.amazonaws.storagegateway#DeleteFileShareOutput``."""
...
class DeleteFileShareOutput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteFileShareOutput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeleteFileShareOutput:
    out: DeleteFileShareOutput = {}  # type: ignore[typeddict-item]
