...
FileSystemAssociationSummaryList: TypeAlias = list[
    "capo_storage_gateway.types.file_system_association_summary.FileSystemAssociationSummary"
]
...
def serialize_aws_json_1_1(value: FileSystemAssociationSummaryList) -> list:
    ...
    for item in value:
        out.append(
            capo_storage_gateway.types.file_system_association_summary.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> FileSystemAssociationSummaryList:
    ...
    for item in data:
        out.append(
            capo_storage_gateway.types.file_system_association_summary.deserialize_aws_json_1_1(
                item
            )
        )
    return out
