...
class DescribeSnapshotScheduleOutput(TypedDict, closed=True):
    ...
    start_at: NotRequired["capo_storage_gateway.types.hour_of_day.HourOfDay"]
    ...
    recurrence_in_hours: NotRequired[
        "capo_storage_gateway.types.recurrence_in_hours.RecurrenceInHours"
    ]
    """<p>The number of hours between snapshots.</p>"""
    description: NotRequired["capo_storage_gateway.types.description.Description"]
