...
if TYPE_CHECKING:
    ...
    import capo_storage_gateway.types.tape_status
    import capo_storage_gateway.types.tape_usage
    import capo_storage_gateway.types.time
    import capo_storage_gateway.types.vtl_device_arn


class Tape(TypedDict, closed=True):
    tape_arn: NotRequired["capo_storage_gateway.types.tape_arn.TapeARN"]
    """<p>The Amazon Resource Name (ARN) of the virtual tape.</p>"""
    tape_barcode: NotRequired["capo_storage_gateway.types.tape_barcode.TapeBarcode"]
    """<p>The barcode that identifies a specific virtual tape.</p>"""
    tape_created_date: NotRequired["capo_storage_gateway.types.time.Time"]
    """<p>The date the virtual tape was created.</p>"""
    tape_size_in_bytes: NotRequired["capo_storage_gateway.types.tape_size.TapeSize"]
    """<p>The size, in bytes, of the virtual tape capacity.</p>"""
    tape_status: NotRequired["capo_storage_gateway.types.tape_status.TapeStatus"]
    """<p>The current state of the virtual tape.</p>"""
    vtl_device: NotRequired["capo_storage_gateway.types.vtl_device_arn.VTLDeviceARN"]
    """<p>The virtual tape library (VTL) device that the virtual tape is associated with.</p>"""
    progress: NotRequired["capo_storage_gateway.types.double_object.DoubleObject"]
    ...
    tape_used_in_bytes: NotRequired["capo_storage_gateway.types.tape_usage.TapeUsage"]
    ...
    pool_id: NotRequired["capo_storage_gateway.types.pool_id.PoolId"]
    ...
    worm: "capo_storage_gateway.types.boolean2.Boolean2"
    """<p>If the tape is archived as write-once-read-many (WORM), this value is <code>true</code>.</p>"""
    retention_start_date: NotRequired["capo_storage_gateway.types.time.Time"]
    """<p>The date that the tape is first archived with tape retention lock enabled.</p>"""
    pool_entry_date: NotRequired["capo_storage_gateway.types.time.Time"]
...
def serialize_aws_json_1_1(value: Tape) -> dict:
    ...
    if "tape_created_date" in value:
        ...
        out["TapeCreatedDate"] = capo_storage_gateway.types.time.serialize_aws_json_1_1(
    ...
    if "retention_start_date" in value:
        ...
        out["RetentionStartDate"] = (
            capo_storage_gateway.types.time.serialize_aws_json_1_1(
    ...
    if "pool_entry_date" in value:
        ...
        out["PoolEntryDate"] = capo_storage_gateway.types.time.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Tape:
    ...
    if "TapeCreatedDate" in data:
        ...
        out["tape_created_date"] = (
            capo_storage_gateway.types.time.deserialize_aws_json_1_1(
