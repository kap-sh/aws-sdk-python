"""Generated from Smithy shape ``com.amazonaws.storagegateway#UpdateAutomaticTapeCreationPolicyOutput``."""
...
class UpdateAutomaticTapeCreationPolicyOutput(TypedDict, closed=True):
    gateway_arn: NotRequired["capo_storage_gateway.types.gateway_arn.GatewayARN"]


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateAutomaticTapeCreationPolicyOutput) -> dict:
    out: dict = {}
