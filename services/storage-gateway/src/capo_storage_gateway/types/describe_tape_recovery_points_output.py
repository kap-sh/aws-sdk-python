...
class DescribeTapeRecoveryPointsOutput(TypedDict, closed=True):
    gateway_arn: NotRequired["capo_storage_gateway.types.gateway_arn.GatewayARN"]
    tape_recovery_point_infos: NotRequired[
        "capo_storage_gateway.types.tape_recovery_point_infos.TapeRecoveryPointInfos"
    ]
...
def serialize_aws_json_1_1(value: DescribeTapeRecoveryPointsOutput) -> dict:
    ...
    if "tape_recovery_point_infos" in value:
        ...
        out["TapeRecoveryPointInfos"] = (
            capo_storage_gateway.types.tape_recovery_point_infos.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeTapeRecoveryPointsOutput:
    ...
    if "TapeRecoveryPointInfos" in data:
        ...
        out["tape_recovery_point_infos"] = (
            capo_storage_gateway.types.tape_recovery_point_infos.deserialize_aws_json_1_1(
