"""Generated from Smithy shape ``com.amazonaws.storagegateway#ShutdownGateway``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.shutdown_gateway_output.ShutdownGatewayOutput = (
        capo_storage_gateway.types.shutdown_gateway_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.shutdown_gateway_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_shutdown_gateway(
