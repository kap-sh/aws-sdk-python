"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeUploadBuffer``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.describe_upload_buffer_output.DescribeUploadBufferOutput = capo_storage_gateway.types.describe_upload_buffer_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.describe_upload_buffer_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_upload_buffer(
