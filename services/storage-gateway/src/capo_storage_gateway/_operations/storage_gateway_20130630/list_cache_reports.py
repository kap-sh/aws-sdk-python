...
def handle_response(
    ...
    out: capo_storage_gateway.types.list_cache_reports_output.ListCacheReportsOutput = (
        capo_storage_gateway.types.list_cache_reports_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.list_cache_reports_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
