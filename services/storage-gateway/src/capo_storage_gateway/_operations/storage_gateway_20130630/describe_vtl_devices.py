"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeVTLDevices``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.describe_vtl_devices_output.DescribeVTLDevicesOutput = capo_storage_gateway.types.describe_vtl_devices_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.describe_vtl_devices_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_vtl_devices(
