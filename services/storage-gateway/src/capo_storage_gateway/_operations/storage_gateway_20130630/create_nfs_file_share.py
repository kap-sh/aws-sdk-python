...
def handle_response(
    ...
    out: capo_storage_gateway.types.create_nfs_file_share_output.CreateNFSFileShareOutput = capo_storage_gateway.types.create_nfs_file_share_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.create_nfs_file_share_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
