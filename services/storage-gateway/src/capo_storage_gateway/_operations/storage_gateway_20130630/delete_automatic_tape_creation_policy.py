"""Generated from Smithy shape ``com.amazonaws.storagegateway#DeleteAutomaticTapeCreationPolicy``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.delete_automatic_tape_creation_policy_output.DeleteAutomaticTapeCreationPolicyOutput = capo_storage_gateway.types.delete_automatic_tape_creation_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.delete_automatic_tape_creation_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_automatic_tape_creation_policy(
