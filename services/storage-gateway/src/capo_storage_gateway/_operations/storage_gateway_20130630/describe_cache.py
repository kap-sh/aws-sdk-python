"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeCache``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.describe_cache_output.DescribeCacheOutput = (
        capo_storage_gateway.types.describe_cache_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.describe_cache_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_cache(
