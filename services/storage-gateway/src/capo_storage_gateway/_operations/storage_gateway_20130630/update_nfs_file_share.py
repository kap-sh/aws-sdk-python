"""Generated from Smithy shape ``com.amazonaws.storagegateway#UpdateNFSFileShare``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.update_nfs_file_share_output.UpdateNFSFileShareOutput = capo_storage_gateway.types.update_nfs_file_share_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.update_nfs_file_share_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_nfs_file_share(
