...
import capo_storage_gateway.types.automatic_tape_creation_policy_infos
...
def handle_response(
    ...
    out: capo_storage_gateway.types.list_automatic_tape_creation_policies_output.ListAutomaticTapeCreationPoliciesOutput = capo_storage_gateway.types.list_automatic_tape_creation_policies_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.list_automatic_tape_creation_policies_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
