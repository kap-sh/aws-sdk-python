"""Generated from Smithy shape ``com.amazonaws.storagegateway#ResetCache``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.reset_cache_output.ResetCacheOutput = (
        capo_storage_gateway.types.reset_cache_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.reset_cache_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def reset_cache(
    ...
    capo_storage_gateway.types.reset_cache_output.ResetCacheOutput, zapros.Response
]:
