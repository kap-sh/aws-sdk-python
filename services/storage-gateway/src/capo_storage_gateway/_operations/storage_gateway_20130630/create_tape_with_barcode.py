"""Generated from Smithy shape ``com.amazonaws.storagegateway#CreateTapeWithBarcode``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.create_tape_with_barcode_output.CreateTapeWithBarcodeOutput = capo_storage_gateway.types.create_tape_with_barcode_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.create_tape_with_barcode_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_tape_with_barcode(
