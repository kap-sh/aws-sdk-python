"""Generated from Smithy shape ``com.amazonaws.storagegateway#ListFileSystemAssociations``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.list_file_system_associations_output.ListFileSystemAssociationsOutput = capo_storage_gateway.types.list_file_system_associations_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StorageGateway_20130630.ListFileSystemAssociations"
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.list_file_system_associations_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_file_system_associations(
