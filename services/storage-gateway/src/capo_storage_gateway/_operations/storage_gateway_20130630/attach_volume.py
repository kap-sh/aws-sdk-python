...
def handle_response(
    ...
    out: capo_storage_gateway.types.attach_volume_output.AttachVolumeOutput = (
        capo_storage_gateway.types.attach_volume_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.attach_volume_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def attach_volume(
    ...
    capo_storage_gateway.types.attach_volume_output.AttachVolumeOutput, zapros.Response
]:
