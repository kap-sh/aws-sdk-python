"""Generated from Smithy shape ``com.amazonaws.storagegateway#ListFileShares``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.list_file_shares_output.ListFileSharesOutput = (
        capo_storage_gateway.types.list_file_shares_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.list_file_shares_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_file_shares(
