...
def handle_response(
    ...
    out: capo_storage_gateway.types.list_local_disks_output.ListLocalDisksOutput = (
        capo_storage_gateway.types.list_local_disks_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.list_local_disks_input.serialize_aws_json_1_1(input_)
    ).encode()
