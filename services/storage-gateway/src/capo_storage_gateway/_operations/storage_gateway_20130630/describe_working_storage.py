...
def handle_response(
    ...
    out: capo_storage_gateway.types.describe_working_storage_output.DescribeWorkingStorageOutput = capo_storage_gateway.types.describe_working_storage_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.describe_working_storage_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
