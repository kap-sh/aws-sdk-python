"""Generated from Smithy shape ``com.amazonaws.storagegateway#DeleteCacheReport``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.delete_cache_report_output.DeleteCacheReportOutput = capo_storage_gateway.types.delete_cache_report_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StorageGateway_20130630.DeleteCacheReport"
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.delete_cache_report_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_cache_report(
