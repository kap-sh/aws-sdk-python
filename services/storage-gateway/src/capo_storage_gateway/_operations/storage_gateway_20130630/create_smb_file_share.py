"""Generated from Smithy shape ``com.amazonaws.storagegateway#CreateSMBFileShare``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.create_smb_file_share_output.CreateSMBFileShareOutput = capo_storage_gateway.types.create_smb_file_share_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.create_smb_file_share_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_smb_file_share(
