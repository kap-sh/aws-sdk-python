"""Generated from Smithy shape ``com.amazonaws.storagegateway#DeleteVolume``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.delete_volume_output.DeleteVolumeOutput = (
        capo_storage_gateway.types.delete_volume_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.delete_volume_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_volume(
    ...
    capo_storage_gateway.types.delete_volume_output.DeleteVolumeOutput, zapros.Response
]:
