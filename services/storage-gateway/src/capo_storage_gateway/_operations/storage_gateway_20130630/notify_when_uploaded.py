"""Generated from Smithy shape ``com.amazonaws.storagegateway#NotifyWhenUploaded``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.notify_when_uploaded_output.NotifyWhenUploadedOutput = capo_storage_gateway.types.notify_when_uploaded_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.notify_when_uploaded_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_notify_when_uploaded(
