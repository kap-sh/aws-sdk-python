"""Generated from Smithy shape ``com.amazonaws.storagegateway#ListGateways``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.list_gateways_output.ListGatewaysOutput = (
        capo_storage_gateway.types.list_gateways_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.list_gateways_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_gateways(
    ...
    capo_storage_gateway.types.list_gateways_output.ListGatewaysOutput, zapros.Response
]:
