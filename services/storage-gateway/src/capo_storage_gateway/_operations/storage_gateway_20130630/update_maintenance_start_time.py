"""Generated from Smithy shape ``com.amazonaws.storagegateway#UpdateMaintenanceStartTime``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.update_maintenance_start_time_output.UpdateMaintenanceStartTimeOutput = capo_storage_gateway.types.update_maintenance_start_time_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.update_maintenance_start_time_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_maintenance_start_time(
