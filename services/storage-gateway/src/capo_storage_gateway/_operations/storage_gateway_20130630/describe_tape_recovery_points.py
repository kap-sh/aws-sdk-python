...
import capo_storage_gateway.types.tape_recovery_point_infos
...
def handle_response(
    ...
    out: capo_storage_gateway.types.describe_tape_recovery_points_output.DescribeTapeRecoveryPointsOutput = capo_storage_gateway.types.describe_tape_recovery_points_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.describe_tape_recovery_points_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
