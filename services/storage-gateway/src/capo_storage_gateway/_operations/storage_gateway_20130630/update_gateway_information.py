"""Generated from Smithy shape ``com.amazonaws.storagegateway#UpdateGatewayInformation``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.update_gateway_information_output.UpdateGatewayInformationOutput = capo_storage_gateway.types.update_gateway_information_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.update_gateway_information_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_gateway_information(
