"""Generated from Smithy shape ``com.amazonaws.storagegateway#DetachVolume``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.detach_volume_output.DetachVolumeOutput = (
        capo_storage_gateway.types.detach_volume_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.detach_volume_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def detach_volume(
    ...
    capo_storage_gateway.types.detach_volume_output.DetachVolumeOutput, zapros.Response
]:
