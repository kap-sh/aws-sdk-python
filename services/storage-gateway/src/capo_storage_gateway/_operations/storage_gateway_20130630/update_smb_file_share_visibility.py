"""Generated from Smithy shape ``com.amazonaws.storagegateway#UpdateSMBFileShareVisibility``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.update_smb_file_share_visibility_output.UpdateSMBFileShareVisibilityOutput = capo_storage_gateway.types.update_smb_file_share_visibility_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StorageGateway_20130630.UpdateSMBFileShareVisibility"
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.update_smb_file_share_visibility_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_smb_file_share_visibility(
