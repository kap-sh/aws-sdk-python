"""Generated from Smithy shape ``com.amazonaws.storagegateway#ListVolumeInitiators``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.list_volume_initiators_output.ListVolumeInitiatorsOutput = capo_storage_gateway.types.list_volume_initiators_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.list_volume_initiators_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_volume_initiators(
