"""Generated from Smithy shape ``com.amazonaws.storagegateway#UpdateSMBLocalGroups``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.update_smb_local_groups_output.UpdateSMBLocalGroupsOutput = capo_storage_gateway.types.update_smb_local_groups_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StorageGateway_20130630.UpdateSMBLocalGroups"
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.update_smb_local_groups_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_smb_local_groups(
