"""Generated from Smithy shape ``com.amazonaws.storagegateway#ListTapes``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.list_tapes_output.ListTapesOutput = (
        capo_storage_gateway.types.list_tapes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.list_tapes_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_tapes(
    ...
    capo_storage_gateway.types.list_tapes_output.ListTapesOutput, zapros.Response
]:
