...
def handle_response(
    ...
    out: capo_storage_gateway.types.delete_chap_credentials_output.DeleteChapCredentialsOutput = capo_storage_gateway.types.delete_chap_credentials_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.delete_chap_credentials_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
