...
def handle_response(
    ...
    out: capo_storage_gateway.types.add_cache_output.AddCacheOutput = (
        capo_storage_gateway.types.add_cache_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.add_cache_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def add_cache(
    ...
    input_: capo_storage_gateway.types.add_cache_input.AddCacheInput,
) -> tuple[capo_storage_gateway.types.add_cache_output.AddCacheOutput, zapros.Response]:
