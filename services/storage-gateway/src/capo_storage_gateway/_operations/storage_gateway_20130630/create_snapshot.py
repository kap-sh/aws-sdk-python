"""Generated from Smithy shape ``com.amazonaws.storagegateway#CreateSnapshot``."""
...
import capo_storage_gateway.errors.service_unavailable_error
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceUnavailableError":
            raise capo_storage_gateway.errors.service_unavailable_error.ServiceUnavailableError.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_storage_gateway.types.create_snapshot_output.CreateSnapshotOutput = (
        capo_storage_gateway.types.create_snapshot_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.create_snapshot_input.serialize_aws_json_1_1(input_)
    ).encode()
