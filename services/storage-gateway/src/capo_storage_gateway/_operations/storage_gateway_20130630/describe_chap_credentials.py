"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeChapCredentials``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.describe_chap_credentials_output.DescribeChapCredentialsOutput = capo_storage_gateway.types.describe_chap_credentials_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.describe_chap_credentials_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_chap_credentials(
