"""Generated from Smithy shape ``com.amazonaws.storagegateway#UpdateChapCredentials``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.update_chap_credentials_output.UpdateChapCredentialsOutput = capo_storage_gateway.types.update_chap_credentials_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.update_chap_credentials_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_chap_credentials(
