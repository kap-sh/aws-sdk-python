"""Generated from Smithy shape ``com.amazonaws.storagegateway#StartGateway``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.start_gateway_output.StartGatewayOutput = (
        capo_storage_gateway.types.start_gateway_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.start_gateway_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_gateway(
    ...
    capo_storage_gateway.types.start_gateway_output.StartGatewayOutput, zapros.Response
]:
