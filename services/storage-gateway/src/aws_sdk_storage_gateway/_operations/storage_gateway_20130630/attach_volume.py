"""Generated from Smithy shape ``com.amazonaws.storagegateway#AttachVolume``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.attach_volume_output.AttachVolumeOutput = (
        aws_sdk_storage_gateway.types.attach_volume_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.attach_volume_input.AttachVolumeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.attach_volume_input.serialize_aws_json_1_1(input_)
    ).encode()
