...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.retrieve_tape_archive_output.RetrieveTapeArchiveOutput = aws_sdk_storage_gateway.types.retrieve_tape_archive_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.retrieve_tape_archive_input.RetrieveTapeArchiveInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.retrieve_tape_archive_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
