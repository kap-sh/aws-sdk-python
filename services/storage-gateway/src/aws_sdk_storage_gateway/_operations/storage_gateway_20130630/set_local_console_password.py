"""Generated from Smithy shape ``com.amazonaws.storagegateway#SetLocalConsolePassword``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.set_local_console_password_output.SetLocalConsolePasswordOutput = aws_sdk_storage_gateway.types.set_local_console_password_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.set_local_console_password_input.SetLocalConsolePasswordInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.set_local_console_password_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_set_local_console_password(
