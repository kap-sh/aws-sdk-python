"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeSMBSettings``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_smb_settings_output.DescribeSMBSettingsOutput = aws_sdk_storage_gateway.types.describe_smb_settings_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.describe_smb_settings_input.DescribeSMBSettingsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.describe_smb_settings_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_smb_settings(
