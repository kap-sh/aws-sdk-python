...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.update_smb_file_share_output.UpdateSMBFileShareOutput = aws_sdk_storage_gateway.types.update_smb_file_share_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.update_smb_file_share_input.UpdateSMBFileShareInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.update_smb_file_share_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
