...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.assign_tape_pool_output.AssignTapePoolOutput = (
        aws_sdk_storage_gateway.types.assign_tape_pool_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.assign_tape_pool_input.AssignTapePoolInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.assign_tape_pool_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
