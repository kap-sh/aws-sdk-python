"""Generated from Smithy shape ``com.amazonaws.storagegateway#CancelCacheReport``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.cancel_cache_report_output.CancelCacheReportOutput = aws_sdk_storage_gateway.types.cancel_cache_report_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.cancel_cache_report_input.CancelCacheReportInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StorageGateway_20130630.CancelCacheReport"
    import aws_sdk_storage_gateway.types.cancel_cache_report_input

    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.cancel_cache_report_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_cancel_cache_report(
