"""Generated from Smithy shape ``com.amazonaws.storagegateway#AddCache``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.add_cache_output.AddCacheOutput = (
        aws_sdk_storage_gateway.types.add_cache_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.add_cache_input.AddCacheInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.add_cache_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def add_cache(
    ...
    aws_sdk_storage_gateway.types.add_cache_output.AddCacheOutput, zapros.Response
]:
