"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeBandwidthRateLimit``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_bandwidth_rate_limit_output.DescribeBandwidthRateLimitOutput = aws_sdk_storage_gateway.types.describe_bandwidth_rate_limit_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.describe_bandwidth_rate_limit_input.DescribeBandwidthRateLimitInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.describe_bandwidth_rate_limit_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_bandwidth_rate_limit(
