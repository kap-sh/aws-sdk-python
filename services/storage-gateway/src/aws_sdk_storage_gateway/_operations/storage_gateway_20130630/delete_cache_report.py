...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.delete_cache_report_output.DeleteCacheReportOutput = aws_sdk_storage_gateway.types.delete_cache_report_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.delete_cache_report_input.DeleteCacheReportInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.delete_cache_report_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
