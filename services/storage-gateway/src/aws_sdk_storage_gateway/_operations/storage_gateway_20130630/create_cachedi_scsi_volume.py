"""Generated from Smithy shape ``com.amazonaws.storagegateway#CreateCachediSCSIVolume``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.create_cachedi_scsi_volume_output.CreateCachediSCSIVolumeOutput = aws_sdk_storage_gateway.types.create_cachedi_scsi_volume_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.create_cachedi_scsi_volume_input.CreateCachediSCSIVolumeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.create_cachedi_scsi_volume_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_cachedi_scsi_volume(
