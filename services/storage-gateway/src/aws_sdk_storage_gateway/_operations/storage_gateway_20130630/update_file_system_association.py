...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.update_file_system_association_output.UpdateFileSystemAssociationOutput = aws_sdk_storage_gateway.types.update_file_system_association_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.update_file_system_association_input.UpdateFileSystemAssociationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.update_file_system_association_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
