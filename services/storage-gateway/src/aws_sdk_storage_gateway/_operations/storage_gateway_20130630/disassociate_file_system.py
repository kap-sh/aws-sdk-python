...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.disassociate_file_system_output.DisassociateFileSystemOutput = aws_sdk_storage_gateway.types.disassociate_file_system_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.disassociate_file_system_input.DisassociateFileSystemInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.disassociate_file_system_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
