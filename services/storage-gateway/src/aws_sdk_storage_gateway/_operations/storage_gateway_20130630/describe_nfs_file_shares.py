"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeNFSFileShares``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_nfs_file_shares_output.DescribeNFSFileSharesOutput = aws_sdk_storage_gateway.types.describe_nfs_file_shares_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.describe_nfs_file_shares_input.DescribeNFSFileSharesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.describe_nfs_file_shares_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_nfs_file_shares(
