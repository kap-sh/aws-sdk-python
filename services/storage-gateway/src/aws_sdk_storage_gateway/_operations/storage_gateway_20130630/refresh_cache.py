...
def build_request(
    ...
    input: aws_sdk_storage_gateway.types.refresh_cache_input.RefreshCacheInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.refresh_cache_input.serialize_aws_json_1_1(input)
    ).encode()
