...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_cache_output.DescribeCacheOutput = (
        aws_sdk_storage_gateway.types.describe_cache_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_storage_gateway.types.describe_cache_input.DescribeCacheInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.describe_cache_input.serialize_aws_json_1_1(input)
    ).encode()
