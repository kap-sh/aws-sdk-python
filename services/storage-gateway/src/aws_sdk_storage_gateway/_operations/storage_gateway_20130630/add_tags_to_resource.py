...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.add_tags_to_resource_output.AddTagsToResourceOutput = aws_sdk_storage_gateway.types.add_tags_to_resource_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.add_tags_to_resource_input.AddTagsToResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.add_tags_to_resource_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
