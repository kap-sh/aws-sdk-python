...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.delete_automatic_tape_creation_policy_output.DeleteAutomaticTapeCreationPolicyOutput = aws_sdk_storage_gateway.types.delete_automatic_tape_creation_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.delete_automatic_tape_creation_policy_input.DeleteAutomaticTapeCreationPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.delete_automatic_tape_creation_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
