"""Generated from Smithy shape ``com.amazonaws.storagegateway#DeleteTapePool``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.delete_tape_pool_output.DeleteTapePoolOutput = (
        aws_sdk_storage_gateway.types.delete_tape_pool_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.delete_tape_pool_input.DeleteTapePoolInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StorageGateway_20130630.DeleteTapePool"
    import aws_sdk_storage_gateway.types.delete_tape_pool_input

    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.delete_tape_pool_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_tape_pool(
