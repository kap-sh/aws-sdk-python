"""Generated from Smithy shape ``com.amazonaws.storagegateway#ListVolumeRecoveryPoints``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.list_volume_recovery_points_output.ListVolumeRecoveryPointsOutput = aws_sdk_storage_gateway.types.list_volume_recovery_points_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.list_volume_recovery_points_input.ListVolumeRecoveryPointsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.list_volume_recovery_points_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_volume_recovery_points(
