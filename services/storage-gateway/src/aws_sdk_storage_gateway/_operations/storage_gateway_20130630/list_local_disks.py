"""Generated from Smithy shape ``com.amazonaws.storagegateway#ListLocalDisks``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.list_local_disks_output.ListLocalDisksOutput = (
        aws_sdk_storage_gateway.types.list_local_disks_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.list_local_disks_input.ListLocalDisksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.list_local_disks_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_local_disks(
