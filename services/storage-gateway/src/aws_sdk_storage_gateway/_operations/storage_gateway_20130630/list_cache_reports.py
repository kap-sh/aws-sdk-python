"""Generated from Smithy shape ``com.amazonaws.storagegateway#ListCacheReports``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.list_cache_reports_output.ListCacheReportsOutput = aws_sdk_storage_gateway.types.list_cache_reports_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.list_cache_reports_input.ListCacheReportsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StorageGateway_20130630.ListCacheReports"
    import aws_sdk_storage_gateway.types.list_cache_reports_input

    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.list_cache_reports_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_cache_reports(
