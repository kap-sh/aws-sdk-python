"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeGatewayInformation``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_gateway_information_output.DescribeGatewayInformationOutput = aws_sdk_storage_gateway.types.describe_gateway_information_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.describe_gateway_information_input.DescribeGatewayInformationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.describe_gateway_information_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_gateway_information(
