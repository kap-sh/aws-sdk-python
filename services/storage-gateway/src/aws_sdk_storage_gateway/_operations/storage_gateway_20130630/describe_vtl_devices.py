...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_vtl_devices_output.DescribeVTLDevicesOutput = aws_sdk_storage_gateway.types.describe_vtl_devices_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.describe_vtl_devices_input.DescribeVTLDevicesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.describe_vtl_devices_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
