"""Generated from Smithy shape ``com.amazonaws.storagegateway#CreateSnapshotFromVolumeRecoveryPoint``."""
...
import aws_sdk_storage_gateway.errors.service_unavailable_error
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceUnavailableError":
            raise aws_sdk_storage_gateway.errors.service_unavailable_error.ServiceUnavailableError.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.create_snapshot_from_volume_recovery_point_output.CreateSnapshotFromVolumeRecoveryPointOutput = aws_sdk_storage_gateway.types.create_snapshot_from_volume_recovery_point_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.create_snapshot_from_volume_recovery_point_input.CreateSnapshotFromVolumeRecoveryPointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_create_snapshot_from_volume_recovery_point(
