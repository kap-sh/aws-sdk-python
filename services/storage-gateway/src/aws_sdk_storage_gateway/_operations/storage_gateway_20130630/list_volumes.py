...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.list_volumes_output.ListVolumesOutput = (
        aws_sdk_storage_gateway.types.list_volumes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.list_volumes_input.ListVolumesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.list_volumes_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_volumes(
    ...
    aws_sdk_storage_gateway.types.list_volumes_output.ListVolumesOutput, zapros.Response
]:
