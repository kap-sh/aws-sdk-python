"""Generated from Smithy shape ``com.amazonaws.storagegateway#ListAutomaticTapeCreationPolicies``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.list_automatic_tape_creation_policies_output.ListAutomaticTapeCreationPoliciesOutput = aws_sdk_storage_gateway.types.list_automatic_tape_creation_policies_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.list_automatic_tape_creation_policies_input.ListAutomaticTapeCreationPoliciesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.list_automatic_tape_creation_policies_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_automatic_tape_creation_policies(
