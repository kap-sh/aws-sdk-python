"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeWorkingStorage``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_working_storage_output.DescribeWorkingStorageOutput = aws_sdk_storage_gateway.types.describe_working_storage_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.describe_working_storage_input.DescribeWorkingStorageInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.describe_working_storage_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_working_storage(
