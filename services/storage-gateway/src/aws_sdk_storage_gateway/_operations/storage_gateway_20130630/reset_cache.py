...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.reset_cache_output.ResetCacheOutput = (
        aws_sdk_storage_gateway.types.reset_cache_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.reset_cache_input.ResetCacheInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.reset_cache_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def reset_cache(
    ...
    aws_sdk_storage_gateway.types.reset_cache_output.ResetCacheOutput, zapros.Response
]:
