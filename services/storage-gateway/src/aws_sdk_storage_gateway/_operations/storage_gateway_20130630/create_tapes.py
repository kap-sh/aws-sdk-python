"""Generated from Smithy shape ``com.amazonaws.storagegateway#CreateTapes``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.create_tapes_output.CreateTapesOutput = (
        aws_sdk_storage_gateway.types.create_tapes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.create_tapes_input.CreateTapesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.create_tapes_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_tapes(
    ...
    aws_sdk_storage_gateway.types.create_tapes_output.CreateTapesOutput, zapros.Response
]:
