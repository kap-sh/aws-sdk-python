"""Generated from Smithy shape ``com.amazonaws.storagegateway#DeleteFileShare``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.delete_file_share_output.DeleteFileShareOutput = aws_sdk_storage_gateway.types.delete_file_share_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.delete_file_share_input.DeleteFileShareInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.delete_file_share_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_file_share(
