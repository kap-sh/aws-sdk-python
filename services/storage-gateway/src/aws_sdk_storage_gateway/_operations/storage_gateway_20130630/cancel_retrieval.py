...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.cancel_retrieval_output.CancelRetrievalOutput = (
        aws_sdk_storage_gateway.types.cancel_retrieval_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.cancel_retrieval_input.CancelRetrievalInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.cancel_retrieval_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
