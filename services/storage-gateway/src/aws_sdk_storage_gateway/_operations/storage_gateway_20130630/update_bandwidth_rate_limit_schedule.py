...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_schedule_output.UpdateBandwidthRateLimitScheduleOutput = aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_schedule_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_schedule_input.UpdateBandwidthRateLimitScheduleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_schedule_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
