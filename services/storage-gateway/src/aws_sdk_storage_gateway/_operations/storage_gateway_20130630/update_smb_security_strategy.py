"""Generated from Smithy shape ``com.amazonaws.storagegateway#UpdateSMBSecurityStrategy``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.update_smb_security_strategy_output.UpdateSMBSecurityStrategyOutput = aws_sdk_storage_gateway.types.update_smb_security_strategy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.update_smb_security_strategy_input.UpdateSMBSecurityStrategyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.update_smb_security_strategy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_smb_security_strategy(
