"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeBandwidthRateLimitSchedule``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_bandwidth_rate_limit_schedule_output.DescribeBandwidthRateLimitScheduleOutput = aws_sdk_storage_gateway.types.describe_bandwidth_rate_limit_schedule_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.describe_bandwidth_rate_limit_schedule_input.DescribeBandwidthRateLimitScheduleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_bandwidth_rate_limit_schedule(
