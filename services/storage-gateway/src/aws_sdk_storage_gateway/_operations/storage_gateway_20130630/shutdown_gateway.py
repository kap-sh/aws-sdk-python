...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.shutdown_gateway_output.ShutdownGatewayOutput = (
        aws_sdk_storage_gateway.types.shutdown_gateway_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.shutdown_gateway_input.ShutdownGatewayInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.shutdown_gateway_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
