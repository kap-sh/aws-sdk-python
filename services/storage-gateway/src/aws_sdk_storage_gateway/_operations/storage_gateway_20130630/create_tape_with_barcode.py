...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.create_tape_with_barcode_output.CreateTapeWithBarcodeOutput = aws_sdk_storage_gateway.types.create_tape_with_barcode_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.create_tape_with_barcode_input.CreateTapeWithBarcodeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.create_tape_with_barcode_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
