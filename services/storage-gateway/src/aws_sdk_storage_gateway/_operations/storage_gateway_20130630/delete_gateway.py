...
def build_request(
    ...
    input: aws_sdk_storage_gateway.types.delete_gateway_input.DeleteGatewayInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.delete_gateway_input.serialize_aws_json_1_1(input)
    ).encode()
