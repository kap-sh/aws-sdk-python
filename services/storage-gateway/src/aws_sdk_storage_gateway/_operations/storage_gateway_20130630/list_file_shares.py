...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.list_file_shares_output.ListFileSharesOutput = (
        aws_sdk_storage_gateway.types.list_file_shares_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.list_file_shares_input.ListFileSharesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.list_file_shares_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
