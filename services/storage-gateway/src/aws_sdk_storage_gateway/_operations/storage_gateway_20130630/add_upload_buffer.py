"""Generated from Smithy shape ``com.amazonaws.storagegateway#AddUploadBuffer``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.add_upload_buffer_output.AddUploadBufferOutput = aws_sdk_storage_gateway.types.add_upload_buffer_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.add_upload_buffer_input.AddUploadBufferInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.add_upload_buffer_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_add_upload_buffer(
