"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeTapes``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_tapes_output.DescribeTapesOutput = (
        aws_sdk_storage_gateway.types.describe_tapes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.describe_tapes_input.DescribeTapesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.describe_tapes_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_tapes(
