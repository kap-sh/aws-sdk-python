...
def build_request(
    ...
    input: aws_sdk_storage_gateway.types.describe_tapes_input.DescribeTapesInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.describe_tapes_input.serialize_aws_json_1_1(input)
    ).encode()
