"""Generated from Smithy shape ``com.amazonaws.storagegateway#CreateStorediSCSIVolume``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.create_storedi_scsi_volume_output.CreateStorediSCSIVolumeOutput = aws_sdk_storage_gateway.types.create_storedi_scsi_volume_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.create_storedi_scsi_volume_input.CreateStorediSCSIVolumeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.create_storedi_scsi_volume_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_storedi_scsi_volume(
