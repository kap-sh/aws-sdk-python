...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.evict_files_failing_upload_output.EvictFilesFailingUploadOutput = aws_sdk_storage_gateway.types.evict_files_failing_upload_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.evict_files_failing_upload_input.EvictFilesFailingUploadInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.evict_files_failing_upload_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
