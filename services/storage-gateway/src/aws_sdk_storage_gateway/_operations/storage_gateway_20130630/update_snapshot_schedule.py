"""Generated from Smithy shape ``com.amazonaws.storagegateway#UpdateSnapshotSchedule``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.update_snapshot_schedule_output.UpdateSnapshotScheduleOutput = aws_sdk_storage_gateway.types.update_snapshot_schedule_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.update_snapshot_schedule_input.UpdateSnapshotScheduleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.update_snapshot_schedule_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_snapshot_schedule(
