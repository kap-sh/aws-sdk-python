"""Generated from Smithy shape ``com.amazonaws.storagegateway#AssociateFileSystem``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.associate_file_system_output.AssociateFileSystemOutput = aws_sdk_storage_gateway.types.associate_file_system_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.associate_file_system_input.AssociateFileSystemInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "StorageGateway_20130630.AssociateFileSystem"
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.associate_file_system_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_associate_file_system(
