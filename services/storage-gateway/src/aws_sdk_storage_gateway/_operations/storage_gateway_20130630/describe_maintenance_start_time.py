...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_maintenance_start_time_output.DescribeMaintenanceStartTimeOutput = aws_sdk_storage_gateway.types.describe_maintenance_start_time_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.describe_maintenance_start_time_input.DescribeMaintenanceStartTimeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.describe_maintenance_start_time_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
