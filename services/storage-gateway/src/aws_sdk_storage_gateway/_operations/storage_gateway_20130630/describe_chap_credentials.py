...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_chap_credentials_output.DescribeChapCredentialsOutput = aws_sdk_storage_gateway.types.describe_chap_credentials_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.describe_chap_credentials_input.DescribeChapCredentialsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
