"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeSnapshotSchedule``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_snapshot_schedule_output.DescribeSnapshotScheduleOutput = aws_sdk_storage_gateway.types.describe_snapshot_schedule_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.describe_snapshot_schedule_input.DescribeSnapshotScheduleInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.describe_snapshot_schedule_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_snapshot_schedule(
