"""Generated from Smithy shape ``com.amazonaws.storagegateway#DeleteChapCredentials``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.delete_chap_credentials_output.DeleteChapCredentialsOutput = aws_sdk_storage_gateway.types.delete_chap_credentials_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.delete_chap_credentials_input.DeleteChapCredentialsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.delete_chap_credentials_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_chap_credentials(
