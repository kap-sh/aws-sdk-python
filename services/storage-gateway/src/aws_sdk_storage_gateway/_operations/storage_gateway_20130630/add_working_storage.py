"""Generated from Smithy shape ``com.amazonaws.storagegateway#AddWorkingStorage``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.add_working_storage_output.AddWorkingStorageOutput = aws_sdk_storage_gateway.types.add_working_storage_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.add_working_storage_input.AddWorkingStorageInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.add_working_storage_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_add_working_storage(
