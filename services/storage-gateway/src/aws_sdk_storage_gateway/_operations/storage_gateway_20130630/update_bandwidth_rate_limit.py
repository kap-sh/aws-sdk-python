"""Generated from Smithy shape ``com.amazonaws.storagegateway#UpdateBandwidthRateLimit``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_output.UpdateBandwidthRateLimitOutput = aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_input.UpdateBandwidthRateLimitInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_bandwidth_rate_limit(
