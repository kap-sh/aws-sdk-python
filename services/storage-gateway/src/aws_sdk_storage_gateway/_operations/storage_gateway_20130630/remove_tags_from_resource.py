...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.remove_tags_from_resource_output.RemoveTagsFromResourceOutput = aws_sdk_storage_gateway.types.remove_tags_from_resource_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.remove_tags_from_resource_input.RemoveTagsFromResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.remove_tags_from_resource_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
