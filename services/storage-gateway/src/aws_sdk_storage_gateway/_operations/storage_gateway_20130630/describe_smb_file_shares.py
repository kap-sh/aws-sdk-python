"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeSMBFileShares``."""
...
import aws_sdk_storage_gateway.types.smb_file_share_info_list
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_smb_file_shares_output.DescribeSMBFileSharesOutput = aws_sdk_storage_gateway.types.describe_smb_file_shares_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.describe_smb_file_shares_input.DescribeSMBFileSharesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.describe_smb_file_shares_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_smb_file_shares(
