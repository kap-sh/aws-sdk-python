...
def build_request(
    ...
    input: aws_sdk_storage_gateway.types.delete_volume_input.DeleteVolumeInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.delete_volume_input.serialize_aws_json_1_1(input)
    ).encode()
