...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.list_tapes_output.ListTapesOutput = (
        aws_sdk_storage_gateway.types.list_tapes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.list_tapes_input.ListTapesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.list_tapes_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_tapes(
    ...
    aws_sdk_storage_gateway.types.list_tapes_output.ListTapesOutput, zapros.Response
]:
