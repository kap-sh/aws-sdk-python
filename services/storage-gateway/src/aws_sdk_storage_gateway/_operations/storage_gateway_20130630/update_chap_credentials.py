...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.update_chap_credentials_output.UpdateChapCredentialsOutput = aws_sdk_storage_gateway.types.update_chap_credentials_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.update_chap_credentials_input.UpdateChapCredentialsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.update_chap_credentials_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
