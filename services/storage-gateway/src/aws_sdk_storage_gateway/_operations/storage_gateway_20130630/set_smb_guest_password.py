"""Generated from Smithy shape ``com.amazonaws.storagegateway#SetSMBGuestPassword``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.set_smb_guest_password_output.SetSMBGuestPasswordOutput = aws_sdk_storage_gateway.types.set_smb_guest_password_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.set_smb_guest_password_input.SetSMBGuestPasswordInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.set_smb_guest_password_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_set_smb_guest_password(
