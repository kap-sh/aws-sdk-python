"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeTapeRecoveryPoints``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_tape_recovery_points_output.DescribeTapeRecoveryPointsOutput = aws_sdk_storage_gateway.types.describe_tape_recovery_points_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.describe_tape_recovery_points_input.DescribeTapeRecoveryPointsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.describe_tape_recovery_points_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_tape_recovery_points(
