...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.join_domain_output.JoinDomainOutput = (
        aws_sdk_storage_gateway.types.join_domain_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.join_domain_input.JoinDomainInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.join_domain_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def join_domain(
    ...
    aws_sdk_storage_gateway.types.join_domain_output.JoinDomainOutput, zapros.Response
]:
