...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_cachedi_scsi_volumes_output.DescribeCachediSCSIVolumesOutput = aws_sdk_storage_gateway.types.describe_cachedi_scsi_volumes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.describe_cachedi_scsi_volumes_input.DescribeCachediSCSIVolumesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.describe_cachedi_scsi_volumes_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
