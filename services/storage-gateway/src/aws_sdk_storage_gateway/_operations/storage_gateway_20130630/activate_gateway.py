"""Generated from Smithy shape ``com.amazonaws.storagegateway#ActivateGateway``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.activate_gateway_output.ActivateGatewayOutput = (
        aws_sdk_storage_gateway.types.activate_gateway_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.activate_gateway_input.ActivateGatewayInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.activate_gateway_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_activate_gateway(
