"""Generated from Smithy shape ``com.amazonaws.storagegateway#CancelArchival``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.cancel_archival_output.CancelArchivalOutput = (
        aws_sdk_storage_gateway.types.cancel_archival_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.cancel_archival_input.CancelArchivalInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.cancel_archival_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_cancel_archival(
