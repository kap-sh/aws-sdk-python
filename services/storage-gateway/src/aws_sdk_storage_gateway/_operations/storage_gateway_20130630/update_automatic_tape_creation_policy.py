"""Generated from Smithy shape ``com.amazonaws.storagegateway#UpdateAutomaticTapeCreationPolicy``."""
...
from aws_sdk_storage_gateway.errors import UnknownServiceError
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.update_automatic_tape_creation_policy_output.UpdateAutomaticTapeCreationPolicyOutput = aws_sdk_storage_gateway.types.update_automatic_tape_creation_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.update_automatic_tape_creation_policy_input.UpdateAutomaticTapeCreationPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.update_automatic_tape_creation_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_automatic_tape_creation_policy(
