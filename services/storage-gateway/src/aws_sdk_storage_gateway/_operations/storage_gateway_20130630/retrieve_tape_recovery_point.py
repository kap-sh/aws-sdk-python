"""Generated from Smithy shape ``com.amazonaws.storagegateway#RetrieveTapeRecoveryPoint``."""
...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.retrieve_tape_recovery_point_output.RetrieveTapeRecoveryPointOutput = aws_sdk_storage_gateway.types.retrieve_tape_recovery_point_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.retrieve_tape_recovery_point_input.RetrieveTapeRecoveryPointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.retrieve_tape_recovery_point_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_retrieve_tape_recovery_point(
