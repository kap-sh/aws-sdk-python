...
def build_request(
    ...
    input: aws_sdk_storage_gateway.types.detach_volume_input.DetachVolumeInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.detach_volume_input.serialize_aws_json_1_1(input)
    ).encode()
