...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.describe_availability_monitor_test_output.DescribeAvailabilityMonitorTestOutput = aws_sdk_storage_gateway.types.describe_availability_monitor_test_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.describe_availability_monitor_test_input.DescribeAvailabilityMonitorTestInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.describe_availability_monitor_test_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
