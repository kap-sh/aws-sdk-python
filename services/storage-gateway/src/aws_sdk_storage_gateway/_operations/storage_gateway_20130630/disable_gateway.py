...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.disable_gateway_output.DisableGatewayOutput = (
        aws_sdk_storage_gateway.types.disable_gateway_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.disable_gateway_input.DisableGatewayInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.disable_gateway_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
