...
def handle_response(
    ...
    out: aws_sdk_storage_gateway.types.delete_tape_output.DeleteTapeOutput = (
        aws_sdk_storage_gateway.types.delete_tape_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_storage_gateway.types.delete_tape_input.DeleteTapeInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_storage_gateway.types.delete_tape_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_tape(
    ...
    aws_sdk_storage_gateway.types.delete_tape_output.DeleteTapeOutput, zapros.Response
]:
