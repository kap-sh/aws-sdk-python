"""Generated from Smithy shape ``com.amazonaws.storagegateway#InternalServerError``."""
...
class InternalServerError(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.storagegateway#InternalServerError``."""
