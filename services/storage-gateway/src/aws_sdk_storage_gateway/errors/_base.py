...
class StorageGatewayError(Exception):
    """Base class for all StorageGateway service errors."""


class ServiceError(StorageGatewayError):
...
class SerializationError(StorageGatewayError):
    """Raised when a value cannot be serialized."""


class DeserializationError(StorageGatewayError):
...
class WaiterFailedError(StorageGatewayError):
...
class WaiterTimeoutError(StorageGatewayError):
