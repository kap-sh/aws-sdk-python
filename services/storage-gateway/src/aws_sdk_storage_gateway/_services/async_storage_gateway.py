...
from aws_sdk_storage_gateway._auth._providers import (
    CredentialsProvider,
    IdentityProvider,
...
from aws_sdk_storage_gateway._services._aws_config import aaws_config
...
class AsyncStorageGatewayClientConfig(TypedDict, total=False, closed=True):
...
class AsyncStorageGatewayClient:
    ...
    def __init__(
        ...
        self._config = AsyncStorageGatewayClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncStorageGatewayClientConfig] = None
    ...
    async def activate_gateway(
        ...
        *,
        ...
        gateway_type: Optional[
            "aws_sdk_storage_gateway.types.gateway_type.GatewayType"
        ] = None,
        ...
        tags: Optional["aws_sdk_storage_gateway.types.tags.Tags"] = None,
    ) -> "aws_sdk_storage_gateway.types.activate_gateway_output.ActivateGatewayOutput":
        r"""<p>Activates the gateway you previously deployed on your host. In the activation process, you specify information such as the Amazon Web Services Region that you want to use for storing snapshots or tapes, the time zone for scheduled snapshots the gateway snapshot schedule window, an activation key, and a name for your gateway. The activation process also associates your gateway with your account. For more information, see <a>UpdateGatewayInformation</a>.</p> <note> <p>You must turn on the gateway VM before you can activate your gateway.</p> </note>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.activate_gateway_input.ActivateGatewayInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.activate_gateway_output.ActivateGatewayOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.activate_gateway.async_activate_gateway(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.activate_gateway_input.ActivateGatewayInput = {}  # type: ignore[typeddict-item]
    ...
    async def add_cache(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.add_cache_output.AddCacheOutput":
        r"""<p>Configures one or more gateway local disks as cache for a gateway. This operation is only supported in the cached volume, tape, and file gateway type (see <a href=\"https://docs.aws.amazon.com/storagegateway/latest/userguide/StorageGatewayConcepts.html\">How Storage Gateway works (architecture)</a>.</p> <p>In the request, you specify the gateway Amazon Resource Name (ARN) to which you want to add cache, and one or more disk IDs that you want to configure as cache.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.add_cache_input.AddCacheInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.add_cache_output.AddCacheOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.add_cache.async_add_cache(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.add_cache_input.AddCacheInput = {}  # type: ignore[typeddict-item]
    ...
    async def add_tags_to_resource(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.add_tags_to_resource_output.AddTagsToResourceOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.add_tags_to_resource_input.AddTagsToResourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.add_tags_to_resource_output.AddTagsToResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.add_tags_to_resource.async_add_tags_to_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.add_tags_to_resource_input.AddTagsToResourceInput = {}  # type: ignore[typeddict-item]
    ...
    async def add_upload_buffer(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.add_upload_buffer_output.AddUploadBufferOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.add_upload_buffer_input.AddUploadBufferInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.add_upload_buffer_output.AddUploadBufferOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.add_upload_buffer.async_add_upload_buffer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.add_upload_buffer_input.AddUploadBufferInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
        input_["disk_ids"] = disk_ids
    ...
    async def add_working_storage(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.add_working_storage_output.AddWorkingStorageOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.add_working_storage_input.AddWorkingStorageInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.add_working_storage_output.AddWorkingStorageOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.add_working_storage.async_add_working_storage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.add_working_storage_input.AddWorkingStorageInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
        input_["disk_ids"] = disk_ids
    ...
    async def assign_tape_pool(
        ...
        *,
        ...
        bypass_governance_retention: Optional[
            "aws_sdk_storage_gateway.types.boolean2.Boolean2"
        ] = None,
    ) -> "aws_sdk_storage_gateway.types.assign_tape_pool_output.AssignTapePoolOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.assign_tape_pool_input.AssignTapePoolInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.assign_tape_pool_output.AssignTapePoolOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.assign_tape_pool.async_assign_tape_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.assign_tape_pool_input.AssignTapePoolInput = {}  # type: ignore[typeddict-item]
    ...
    async def associate_file_system(
        ...
        gateway_arn: "aws_sdk_storage_gateway.types.gateway_arn.GatewayARN",
        location_arn: "aws_sdk_storage_gateway.types.file_system_location_arn.FileSystemLocationARN",
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
        tags: Optional["aws_sdk_storage_gateway.types.tags.Tags"] = None,
    ...
    ) -> "aws_sdk_storage_gateway.types.associate_file_system_output.AssociateFileSystemOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.associate_file_system_input.AssociateFileSystemInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.associate_file_system_output.AssociateFileSystemOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.associate_file_system.async_associate_file_system(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.associate_file_system_input.AssociateFileSystemInput = {}  # type: ignore[typeddict-item]
    ...
    async def attach_volume(
        ...
        network_interface_id: "aws_sdk_storage_gateway.types.network_interface_id.NetworkInterfaceId",
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
        target_name: Optional[
            "aws_sdk_storage_gateway.types.target_name.TargetName"
        ] = None,
        disk_id: Optional["aws_sdk_storage_gateway.types.disk_id.DiskId"] = None,
    ) -> "aws_sdk_storage_gateway.types.attach_volume_output.AttachVolumeOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.attach_volume_input.AttachVolumeInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.attach_volume_output.AttachVolumeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.attach_volume.async_attach_volume(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.attach_volume_input.AttachVolumeInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def cancel_archival(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.cancel_archival_output.CancelArchivalOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.cancel_archival_input.CancelArchivalInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.cancel_archival_output.CancelArchivalOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.cancel_archival.async_cancel_archival(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.cancel_archival_input.CancelArchivalInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
        input_["tape_arn"] = tape_arn
    ...
    async def cancel_cache_report(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.cancel_cache_report_output.CancelCacheReportOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.cancel_cache_report_input.CancelCacheReportInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.cancel_cache_report_output.CancelCacheReportOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.cancel_cache_report.async_cancel_cache_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.cancel_cache_report_input.CancelCacheReportInput = {}  # type: ignore[typeddict-item]
    ...
    async def cancel_retrieval(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.cancel_retrieval_output.CancelRetrievalOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.cancel_retrieval_input.CancelRetrievalInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.cancel_retrieval_output.CancelRetrievalOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.cancel_retrieval.async_cancel_retrieval(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.cancel_retrieval_input.CancelRetrievalInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
        input_["tape_arn"] = tape_arn
    ...
    async def create_cachedi_scsi_volume(
        ...
        *,
        ...
        source_volume_arn: Optional[
            "aws_sdk_storage_gateway.types.volume_arn.VolumeARN"
        ] = None,
        kms_encrypted: Optional["aws_sdk_storage_gateway.types.boolean.Boolean"] = None,
        kms_key: Optional["aws_sdk_storage_gateway.types.kms_key.KMSKey"] = None,
        tags: Optional["aws_sdk_storage_gateway.types.tags.Tags"] = None,
    ) -> "aws_sdk_storage_gateway.types.create_cachedi_scsi_volume_output.CreateCachediSCSIVolumeOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.create_cachedi_scsi_volume_input.CreateCachediSCSIVolumeInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.create_cachedi_scsi_volume_output.CreateCachediSCSIVolumeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.create_cachedi_scsi_volume.async_create_cachedi_scsi_volume(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.create_cachedi_scsi_volume_input.CreateCachediSCSIVolumeInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def create_nfs_file_share(
        ...
        *,
        ...
        encryption_type: Optional[
            "aws_sdk_storage_gateway.types.encryption_type.EncryptionType"
        ] = None,
        kms_encrypted: Optional["aws_sdk_storage_gateway.types.boolean.Boolean"] = None,
        kms_key: Optional["aws_sdk_storage_gateway.types.kms_key.KMSKey"] = None,
        ...
        object_acl: Optional[
            "aws_sdk_storage_gateway.types.object_acl.ObjectACL"
        ] = None,
        client_list: Optional[
            "aws_sdk_storage_gateway.types.file_share_client_list.FileShareClientList"
        ] = None,
        squash: Optional["aws_sdk_storage_gateway.types.squash.Squash"] = None,
        read_only: Optional["aws_sdk_storage_gateway.types.boolean.Boolean"] = None,
        guess_mime_type_enabled: Optional[
            "aws_sdk_storage_gateway.types.boolean.Boolean"
        ] = None,
        ...
        file_share_name: Optional[
            "aws_sdk_storage_gateway.types.file_share_name.FileShareName"
        ] = None,
        cache_attributes: Optional[
            "aws_sdk_storage_gateway.types.cache_attributes.CacheAttributes"
        ] = None,
        ...
        bucket_region: Optional[
            "aws_sdk_storage_gateway.types.region_id.RegionId"
        ] = None,
        audit_destination_arn: Optional[
            "aws_sdk_storage_gateway.types.audit_destination_arn.AuditDestinationARN"
        ] = None,
    ) -> "aws_sdk_storage_gateway.types.create_nfs_file_share_output.CreateNFSFileShareOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.create_nfs_file_share_input.CreateNFSFileShareInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.create_nfs_file_share_output.CreateNFSFileShareOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.create_nfs_file_share.async_create_nfs_file_share(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.create_nfs_file_share_input.CreateNFSFileShareInput = {}  # type: ignore[typeddict-item]
        input_["client_token"] = client_token
    ...
    async def create_smb_file_share(
        ...
        *,
        ...
        admin_user_list: Optional[
            "aws_sdk_storage_gateway.types.user_list.UserList"
        ] = None,
        ...
        authentication: Optional[
            "aws_sdk_storage_gateway.types.authentication.Authentication"
        ] = None,
        case_sensitivity: Optional[
            "aws_sdk_storage_gateway.types.case_sensitivity.CaseSensitivity"
        ] = None,
        tags: Optional["aws_sdk_storage_gateway.types.tags.Tags"] = None,
        file_share_name: Optional[
            "aws_sdk_storage_gateway.types.file_share_name.FileShareName"
    ...
    ) -> "aws_sdk_storage_gateway.types.create_smb_file_share_output.CreateSMBFileShareOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.create_smb_file_share_input.CreateSMBFileShareInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.create_smb_file_share_output.CreateSMBFileShareOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.create_smb_file_share.async_create_smb_file_share(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.create_smb_file_share_input.CreateSMBFileShareInput = {}  # type: ignore[typeddict-item]
        input_["client_token"] = client_token
        input_["gateway_arn"] = gateway_arn
        if encryption_type is not None:
            input_["encryption_type"] = encryption_type
    ...
    async def create_snapshot(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.create_snapshot_input.CreateSnapshotInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.create_snapshot_output.CreateSnapshotOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.create_snapshot.async_create_snapshot(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.create_snapshot_input.CreateSnapshotInput = {}  # type: ignore[typeddict-item]
        input_["volume_arn"] = volume_arn
    ...
    async def create_snapshot_from_volume_recovery_point(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.create_snapshot_from_volume_recovery_point_input.CreateSnapshotFromVolumeRecoveryPointInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.create_snapshot_from_volume_recovery_point_output.CreateSnapshotFromVolumeRecoveryPointOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.create_snapshot_from_volume_recovery_point.async_create_snapshot_from_volume_recovery_point(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.create_snapshot_from_volume_recovery_point_input.CreateSnapshotFromVolumeRecoveryPointInput = {}  # type: ignore[typeddict-item]
        input_["volume_arn"] = volume_arn
        input_["snapshot_description"] = snapshot_description
        if tags is not None:
            input_["tags"] = tags
    ...
    async def create_storedi_scsi_volume(
        ...
        *,
        ...
        kms_key: Optional["aws_sdk_storage_gateway.types.kms_key.KMSKey"] = None,
        tags: Optional["aws_sdk_storage_gateway.types.tags.Tags"] = None,
    ) -> "aws_sdk_storage_gateway.types.create_storedi_scsi_volume_output.CreateStorediSCSIVolumeOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.create_storedi_scsi_volume_input.CreateStorediSCSIVolumeInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.create_storedi_scsi_volume_output.CreateStorediSCSIVolumeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.create_storedi_scsi_volume.async_create_storedi_scsi_volume(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.create_storedi_scsi_volume_input.CreateStorediSCSIVolumeInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
        input_["disk_id"] = disk_id
        if snapshot_id is not None:
            input_["snapshot_id"] = snapshot_id
    ...
    async def create_tape_pool(
        ...
        *,
        ...
        tags: Optional["aws_sdk_storage_gateway.types.tags.Tags"] = None,
    ) -> "aws_sdk_storage_gateway.types.create_tape_pool_output.CreateTapePoolOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.create_tape_pool_input.CreateTapePoolInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.create_tape_pool_output.CreateTapePoolOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.create_tape_pool.async_create_tape_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.create_tape_pool_input.CreateTapePoolInput = {}  # type: ignore[typeddict-item]
    ...
    async def create_tapes(
        ...
        client_token: "aws_sdk_storage_gateway.types.client_token.ClientToken",
        num_tapes_to_create: "aws_sdk_storage_gateway.types.num_tapes_to_create.NumTapesToCreate",
        tape_barcode_prefix: "aws_sdk_storage_gateway.types.tape_barcode_prefix.TapeBarcodePrefix",
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
        kms_encrypted: Optional["aws_sdk_storage_gateway.types.boolean.Boolean"] = None,
        kms_key: Optional["aws_sdk_storage_gateway.types.kms_key.KMSKey"] = None,
        pool_id: Optional["aws_sdk_storage_gateway.types.pool_id.PoolId"] = None,
        worm: Optional["aws_sdk_storage_gateway.types.boolean2.Boolean2"] = None,
        tags: Optional["aws_sdk_storage_gateway.types.tags.Tags"] = None,
    ) -> "aws_sdk_storage_gateway.types.create_tapes_output.CreateTapesOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.create_tapes_input.CreateTapesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.create_tapes_output.CreateTapesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.create_tapes.async_create_tapes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.create_tapes_input.CreateTapesInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def create_tape_with_barcode(
        ...
        *,
        ...
        worm: Optional["aws_sdk_storage_gateway.types.boolean2.Boolean2"] = None,
        tags: Optional["aws_sdk_storage_gateway.types.tags.Tags"] = None,
    ) -> "aws_sdk_storage_gateway.types.create_tape_with_barcode_output.CreateTapeWithBarcodeOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.create_tape_with_barcode_input.CreateTapeWithBarcodeInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.create_tape_with_barcode_output.CreateTapeWithBarcodeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.create_tape_with_barcode.async_create_tape_with_barcode(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.create_tape_with_barcode_input.CreateTapeWithBarcodeInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
        input_["tape_size_in_bytes"] = tape_size_in_bytes
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.delete_automatic_tape_creation_policy.async_delete_automatic_tape_creation_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.delete_automatic_tape_creation_policy_input.DeleteAutomaticTapeCreationPolicyInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def delete_bandwidth_rate_limit(
        self,
        gateway_arn: "aws_sdk_storage_gateway.types.gateway_arn.GatewayARN",
        bandwidth_type: "aws_sdk_storage_gateway.types.bandwidth_type.BandwidthType",
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.delete_bandwidth_rate_limit_output.DeleteBandwidthRateLimitOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.delete_bandwidth_rate_limit_input.DeleteBandwidthRateLimitInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.delete_bandwidth_rate_limit_output.DeleteBandwidthRateLimitOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.delete_bandwidth_rate_limit.async_delete_bandwidth_rate_limit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.delete_bandwidth_rate_limit_input.DeleteBandwidthRateLimitInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def delete_cache_report(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.delete_cache_report_output.DeleteCacheReportOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.delete_cache_report_input.DeleteCacheReportInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.delete_cache_report_output.DeleteCacheReportOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.delete_cache_report.async_delete_cache_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.delete_cache_report_input.DeleteCacheReportInput = {}  # type: ignore[typeddict-item]
        input_["cache_report_arn"] = cache_report_arn
    ...
    async def delete_chap_credentials(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.delete_chap_credentials_output.DeleteChapCredentialsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.delete_chap_credentials_input.DeleteChapCredentialsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.delete_chap_credentials_output.DeleteChapCredentialsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.delete_chap_credentials.async_delete_chap_credentials(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.delete_chap_credentials_input.DeleteChapCredentialsInput = {}  # type: ignore[typeddict-item]
    ...
    async def delete_file_share(
        ...
        *,
    ...
    ) -> "aws_sdk_storage_gateway.types.delete_file_share_output.DeleteFileShareOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.delete_file_share_input.DeleteFileShareInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.delete_file_share_output.DeleteFileShareOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.delete_file_share.async_delete_file_share(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.delete_file_share_input.DeleteFileShareInput = {}  # type: ignore[typeddict-item]
    ...
    async def delete_gateway(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.delete_gateway_input.DeleteGatewayInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.delete_gateway_output.DeleteGatewayOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.delete_gateway.async_delete_gateway(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.delete_gateway_input.DeleteGatewayInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def delete_snapshot_schedule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.delete_snapshot_schedule_input.DeleteSnapshotScheduleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.delete_snapshot_schedule_output.DeleteSnapshotScheduleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.delete_snapshot_schedule.async_delete_snapshot_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.delete_snapshot_schedule_input.DeleteSnapshotScheduleInput = {}  # type: ignore[typeddict-item]
        input_["volume_arn"] = volume_arn
    ...
    async def delete_tape(
        ...
        *,
    ...
    ) -> "aws_sdk_storage_gateway.types.delete_tape_output.DeleteTapeOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.delete_tape_input.DeleteTapeInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.delete_tape_output.DeleteTapeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.delete_tape.async_delete_tape(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.delete_tape_input.DeleteTapeInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
        input_["tape_arn"] = tape_arn
        if bypass_governance_retention is not None:
            input_["bypass_governance_retention"] = bypass_governance_retention
    ...
    async def delete_tape_archive(
        ...
        *,
    ...
    ) -> "aws_sdk_storage_gateway.types.delete_tape_archive_output.DeleteTapeArchiveOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.delete_tape_archive_input.DeleteTapeArchiveInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.delete_tape_archive_output.DeleteTapeArchiveOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.delete_tape_archive.async_delete_tape_archive(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.delete_tape_archive_input.DeleteTapeArchiveInput = {}  # type: ignore[typeddict-item]
        input_["tape_arn"] = tape_arn
        if bypass_governance_retention is not None:
            input_["bypass_governance_retention"] = bypass_governance_retention
    ...
    async def delete_tape_pool(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.delete_tape_pool_output.DeleteTapePoolOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.delete_tape_pool_input.DeleteTapePoolInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.delete_tape_pool_output.DeleteTapePoolOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.delete_tape_pool.async_delete_tape_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.delete_tape_pool_input.DeleteTapePoolInput = {}  # type: ignore[typeddict-item]
    ...
    async def delete_volume(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.delete_volume_output.DeleteVolumeOutput":
        r"""<p>Deletes the specified storage volume that you previously created using the <a>CreateCachediSCSIVolume</a> or <a>CreateStorediSCSIVolume</a> API. This operation is only supported in the cached volume and stored volume types. For stored volume gateways, the local disk that was configured as the storage volume is not deleted. You can reuse the local disk to create another storage volume.</p> <p>Before you delete a volume, make sure there are no iSCSI connections to the volume you are deleting. You should also make sure there is no snapshot in progress. You can use the Amazon Elastic Compute Cloud (Amazon EC2) API to query snapshots on the volume you are deleting and check the snapshot status. For more information, go to <a href=\"https://docs.aws.amazon.com/AWSEC2/latest/APIReference/ApiReference-query-DescribeSnapshots.html\">DescribeSnapshots</a> in the <i>Amazon Elastic Compute Cloud API Reference</i>.</p> <p>In the request, you must provide the Amazon Resource Name (ARN) of the storage volume you want to delete.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.delete_volume_input.DeleteVolumeInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.delete_volume_output.DeleteVolumeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.delete_volume.async_delete_volume(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.delete_volume_input.DeleteVolumeInput = {}  # type: ignore[typeddict-item]
        input_["volume_arn"] = volume_arn
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_availability_monitor_test.async_describe_availability_monitor_test(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_availability_monitor_test_input.DescribeAvailabilityMonitorTestInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def describe_bandwidth_rate_limit(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_bandwidth_rate_limit_input.DescribeBandwidthRateLimitInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_bandwidth_rate_limit_output.DescribeBandwidthRateLimitOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_bandwidth_rate_limit.async_describe_bandwidth_rate_limit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_bandwidth_rate_limit_input.DescribeBandwidthRateLimitInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_bandwidth_rate_limit_schedule.async_describe_bandwidth_rate_limit_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_bandwidth_rate_limit_schedule_input.DescribeBandwidthRateLimitScheduleInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def describe_cache(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_cache_input.DescribeCacheInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_cache_output.DescribeCacheOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_cache.async_describe_cache(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_cache_input.DescribeCacheInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def describe_cachedi_scsi_volumes(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.describe_cachedi_scsi_volumes_output.DescribeCachediSCSIVolumesOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_cachedi_scsi_volumes_input.DescribeCachediSCSIVolumesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_cachedi_scsi_volumes_output.DescribeCachediSCSIVolumesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_cachedi_scsi_volumes.async_describe_cachedi_scsi_volumes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_cachedi_scsi_volumes_input.DescribeCachediSCSIVolumesInput = {}  # type: ignore[typeddict-item]
    ...
    async def describe_cache_report(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.describe_cache_report_output.DescribeCacheReportOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_cache_report_input.DescribeCacheReportInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_cache_report_output.DescribeCacheReportOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_cache_report.async_describe_cache_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_cache_report_input.DescribeCacheReportInput = {}  # type: ignore[typeddict-item]
        input_["cache_report_arn"] = cache_report_arn
    ...
    async def describe_chap_credentials(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.describe_chap_credentials_output.DescribeChapCredentialsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_chap_credentials_input.DescribeChapCredentialsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_chap_credentials_output.DescribeChapCredentialsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_chap_credentials.async_describe_chap_credentials(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_chap_credentials_input.DescribeChapCredentialsInput = {}  # type: ignore[typeddict-item]
        input_["target_arn"] = target_arn
    ...
    async def describe_file_system_associations(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.describe_file_system_associations_output.DescribeFileSystemAssociationsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_file_system_associations_input.DescribeFileSystemAssociationsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_file_system_associations_output.DescribeFileSystemAssociationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_file_system_associations.async_describe_file_system_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_file_system_associations_input.DescribeFileSystemAssociationsInput = {}  # type: ignore[typeddict-item]
    ...
    async def describe_gateway_information(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_gateway_information_input.DescribeGatewayInformationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_gateway_information_output.DescribeGatewayInformationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_gateway_information.async_describe_gateway_information(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_gateway_information_input.DescribeGatewayInformationInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def describe_maintenance_start_time(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_maintenance_start_time_input.DescribeMaintenanceStartTimeInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_maintenance_start_time_output.DescribeMaintenanceStartTimeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_maintenance_start_time.async_describe_maintenance_start_time(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_maintenance_start_time_input.DescribeMaintenanceStartTimeInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def describe_nfs_file_shares(
        self,
        file_share_arn_list: "aws_sdk_storage_gateway.types.file_share_arn_list.FileShareARNList",
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.describe_nfs_file_shares_output.DescribeNFSFileSharesOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_nfs_file_shares_input.DescribeNFSFileSharesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_nfs_file_shares_output.DescribeNFSFileSharesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_nfs_file_shares.async_describe_nfs_file_shares(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_nfs_file_shares_input.DescribeNFSFileSharesInput = {}  # type: ignore[typeddict-item]
    ...
    async def describe_smb_file_shares(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.describe_smb_file_shares_output.DescribeSMBFileSharesOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_smb_file_shares_input.DescribeSMBFileSharesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_smb_file_shares_output.DescribeSMBFileSharesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_smb_file_shares.async_describe_smb_file_shares(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_smb_file_shares_input.DescribeSMBFileSharesInput = {}  # type: ignore[typeddict-item]
        input_["file_share_arn_list"] = file_share_arn_list
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_smb_settings.async_describe_smb_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_smb_settings_input.DescribeSMBSettingsInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def describe_snapshot_schedule(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.describe_snapshot_schedule_output.DescribeSnapshotScheduleOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_snapshot_schedule_input.DescribeSnapshotScheduleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_snapshot_schedule_output.DescribeSnapshotScheduleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_snapshot_schedule.async_describe_snapshot_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_snapshot_schedule_input.DescribeSnapshotScheduleInput = {}  # type: ignore[typeddict-item]
        input_["volume_arn"] = volume_arn
    ...
    async def describe_storedi_scsi_volumes(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.describe_storedi_scsi_volumes_output.DescribeStorediSCSIVolumesOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_storedi_scsi_volumes_input.DescribeStorediSCSIVolumesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_storedi_scsi_volumes_output.DescribeStorediSCSIVolumesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_storedi_scsi_volumes.async_describe_storedi_scsi_volumes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_storedi_scsi_volumes_input.DescribeStorediSCSIVolumesInput = {}  # type: ignore[typeddict-item]
        input_["volume_ar_ns"] = volume_ar_ns
    ...
    async def describe_tape_archives(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
        tape_ar_ns: Optional[
            "aws_sdk_storage_gateway.types.tape_ar_ns.TapeARNs"
        ] = None,
        marker: Optional["aws_sdk_storage_gateway.types.marker.Marker"] = None,
        limit: Optional[
            "aws_sdk_storage_gateway.types.positive_int_object.PositiveIntObject"
        ] = None,
    ) -> "aws_sdk_storage_gateway.types.describe_tape_archives_output.DescribeTapeArchivesOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_tape_archives_input.DescribeTapeArchivesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_tape_archives_output.DescribeTapeArchivesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_tape_archives.async_describe_tape_archives(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_tape_archives_input.DescribeTapeArchivesInput = {}  # type: ignore[typeddict-item]
    ...
    ) -> "AsyncIterator[aws_sdk_storage_gateway.types.tape_archive.TapeArchive]":
        _token = marker
        while True:
    ...
    async def describe_tape_recovery_points(
        ...
        *,
    ...
    ) -> "aws_sdk_storage_gateway.types.describe_tape_recovery_points_output.DescribeTapeRecoveryPointsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_tape_recovery_points_input.DescribeTapeRecoveryPointsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_tape_recovery_points_output.DescribeTapeRecoveryPointsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_tape_recovery_points.async_describe_tape_recovery_points(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_tape_recovery_points_input.DescribeTapeRecoveryPointsInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
        if marker is not None:
            input_["marker"] = marker
        if limit is not None:
    ...
    ) -> "AsyncIterator[aws_sdk_storage_gateway.types.tape_recovery_point_info.TapeRecoveryPointInfo]":
        _token = marker
        while True:
    ...
    async def describe_tapes(
        ...
        *,
    ...
    ) -> "aws_sdk_storage_gateway.types.describe_tapes_output.DescribeTapesOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_tapes_input.DescribeTapesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_tapes_output.DescribeTapesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_tapes.async_describe_tapes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_tapes_input.DescribeTapesInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
        if tape_ar_ns is not None:
            input_["tape_ar_ns"] = tape_ar_ns
        if marker is not None:
    ...
    ) -> "AsyncIterator[aws_sdk_storage_gateway.types.tape.Tape]":
        _token = marker
        while True:
    ...
    async def describe_upload_buffer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_upload_buffer_input.DescribeUploadBufferInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_upload_buffer_output.DescribeUploadBufferOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_upload_buffer.async_describe_upload_buffer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_upload_buffer_input.DescribeUploadBufferInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def describe_vtl_devices(
        ...
        *,
        ...
        vtl_device_ar_ns: Optional[
            "aws_sdk_storage_gateway.types.vtl_device_ar_ns.VTLDeviceARNs"
        ] = None,
        marker: Optional["aws_sdk_storage_gateway.types.marker.Marker"] = None,
        limit: Optional[
            "aws_sdk_storage_gateway.types.positive_int_object.PositiveIntObject"
        ] = None,
    ) -> "aws_sdk_storage_gateway.types.describe_vtl_devices_output.DescribeVTLDevicesOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_vtl_devices_input.DescribeVTLDevicesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_vtl_devices_output.DescribeVTLDevicesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_vtl_devices.async_describe_vtl_devices(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_vtl_devices_input.DescribeVTLDevicesInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    ) -> "AsyncIterator[aws_sdk_storage_gateway.types.vtl_device.VTLDevice]":
        _token = marker
        while True:
    ...
    async def describe_working_storage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.describe_working_storage_input.DescribeWorkingStorageInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.describe_working_storage_output.DescribeWorkingStorageOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.describe_working_storage.async_describe_working_storage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.describe_working_storage_input.DescribeWorkingStorageInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def detach_volume(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
        force_detach: Optional["aws_sdk_storage_gateway.types.boolean.Boolean"] = None,
    ) -> "aws_sdk_storage_gateway.types.detach_volume_output.DetachVolumeOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.detach_volume_input.DetachVolumeInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.detach_volume_output.DetachVolumeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.detach_volume.async_detach_volume(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.detach_volume_input.DetachVolumeInput = {}  # type: ignore[typeddict-item]
        input_["volume_arn"] = volume_arn
    ...
    async def disable_gateway(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.disable_gateway_input.DisableGatewayInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.disable_gateway_output.DisableGatewayOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.disable_gateway.async_disable_gateway(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.disable_gateway_input.DisableGatewayInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def disassociate_file_system(
        ...
        *,
    ...
    ) -> "aws_sdk_storage_gateway.types.disassociate_file_system_output.DisassociateFileSystemOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.disassociate_file_system_input.DisassociateFileSystemInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.disassociate_file_system_output.DisassociateFileSystemOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.disassociate_file_system.async_disassociate_file_system(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.disassociate_file_system_input.DisassociateFileSystemInput = {}  # type: ignore[typeddict-item]
    ...
    async def evict_files_failing_upload(
        ...
        *,
    ...
    ) -> "aws_sdk_storage_gateway.types.evict_files_failing_upload_output.EvictFilesFailingUploadOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.evict_files_failing_upload_input.EvictFilesFailingUploadInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.evict_files_failing_upload_output.EvictFilesFailingUploadOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.evict_files_failing_upload.async_evict_files_failing_upload(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.evict_files_failing_upload_input.EvictFilesFailingUploadInput = {}  # type: ignore[typeddict-item]
        input_["file_share_arn"] = file_share_arn
    ...
    async def join_domain(
        ...
        *,
        ...
        domain_controllers: Optional[
            "aws_sdk_storage_gateway.types.hosts.Hosts"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.join_domain_input.JoinDomainInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.join_domain_output.JoinDomainOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.join_domain.async_join_domain(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.join_domain_input.JoinDomainInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.list_automatic_tape_creation_policies.async_list_automatic_tape_creation_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.list_automatic_tape_creation_policies_input.ListAutomaticTapeCreationPoliciesInput = {}  # type: ignore[typeddict-item]
    ...
    async def list_cache_reports(
        ...
        *,
        ...
        "aws_sdk_storage_gateway.types.list_cache_reports_output.ListCacheReportsOutput"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.list_cache_reports_input.ListCacheReportsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.list_cache_reports_output.ListCacheReportsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.list_cache_reports.async_list_cache_reports(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.list_cache_reports_input.ListCacheReportsInput = {}  # type: ignore[typeddict-item]
        if marker is not None:
            input_["marker"] = marker
    ...
    async def iter_list_cache_reports(
        ...
        *,
        ...
        "AsyncIterator[aws_sdk_storage_gateway.types.cache_report_info.CacheReportInfo]"
    ):
        _token = marker
        while True:
    ...
    async def list_file_shares(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.list_file_shares_input.ListFileSharesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.list_file_shares_output.ListFileSharesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.list_file_shares.async_list_file_shares(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.list_file_shares_input.ListFileSharesInput = {}  # type: ignore[typeddict-item]
        if gateway_arn is not None:
            input_["gateway_arn"] = gateway_arn
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_file_system_associations(
        ...
        *,
        ...
        marker: Optional["aws_sdk_storage_gateway.types.marker.Marker"] = None,
    ) -> "aws_sdk_storage_gateway.types.list_file_system_associations_output.ListFileSystemAssociationsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.list_file_system_associations_input.ListFileSystemAssociationsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.list_file_system_associations_output.ListFileSystemAssociationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.list_file_system_associations.async_list_file_system_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.list_file_system_associations_input.ListFileSystemAssociationsInput = {}  # type: ignore[typeddict-item]
        if gateway_arn is not None:
            input_["gateway_arn"] = gateway_arn
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_gateways(
        ...
        *,
    ...
    ) -> "aws_sdk_storage_gateway.types.list_gateways_output.ListGatewaysOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.list_gateways_input.ListGatewaysInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.list_gateways_output.ListGatewaysOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.list_gateways.async_list_gateways(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.list_gateways_input.ListGatewaysInput = {}  # type: ignore[typeddict-item]
        if marker is not None:
            input_["marker"] = marker
        if limit is not None:
            input_["limit"] = limit
    ...
    ) -> "AsyncIterator[aws_sdk_storage_gateway.types.gateway_info.GatewayInfo]":
        _token = marker
        while True:
    ...
    async def list_local_disks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.list_local_disks_input.ListLocalDisksInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.list_local_disks_output.ListLocalDisksOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.list_local_disks.async_list_local_disks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.list_local_disks_input.ListLocalDisksInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def list_tags_for_resource(
        ...
        *,
    ...
    ) -> "aws_sdk_storage_gateway.types.list_tags_for_resource_output.ListTagsForResourceOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.list_tags_for_resource_input.ListTagsForResourceInput = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
        if marker is not None:
            input_["marker"] = marker
        if limit is not None:
    ...
    ) -> "AsyncIterator[aws_sdk_storage_gateway.types.tag.Tag]":
        _token = marker
        while True:
    ...
    async def list_tape_pools(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
        pool_ar_ns: Optional[
            "aws_sdk_storage_gateway.types.pool_ar_ns.PoolARNs"
        ] = None,
        marker: Optional["aws_sdk_storage_gateway.types.marker.Marker"] = None,
        limit: Optional[
            "aws_sdk_storage_gateway.types.positive_int_object.PositiveIntObject"
        ] = None,
    ) -> "aws_sdk_storage_gateway.types.list_tape_pools_output.ListTapePoolsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.list_tape_pools_input.ListTapePoolsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.list_tape_pools_output.ListTapePoolsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.list_tape_pools.async_list_tape_pools(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.list_tape_pools_input.ListTapePoolsInput = {}  # type: ignore[typeddict-item]
    ...
    ) -> "AsyncIterator[aws_sdk_storage_gateway.types.pool_info.PoolInfo]":
        _token = marker
        while True:
    ...
    async def list_tapes(
        ...
        *,
    ...
    ) -> "aws_sdk_storage_gateway.types.list_tapes_output.ListTapesOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.list_tapes_input.ListTapesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.list_tapes_output.ListTapesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.list_tapes.async_list_tapes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.list_tapes_input.ListTapesInput = {}  # type: ignore[typeddict-item]
        if tape_ar_ns is not None:
            input_["tape_ar_ns"] = tape_ar_ns
        if marker is not None:
            input_["marker"] = marker
    ...
    ) -> "AsyncIterator[aws_sdk_storage_gateway.types.tape_info.TapeInfo]":
        _token = marker
        while True:
    ...
    async def list_volume_initiators(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.list_volume_initiators_output.ListVolumeInitiatorsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.list_volume_initiators_input.ListVolumeInitiatorsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.list_volume_initiators_output.ListVolumeInitiatorsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.list_volume_initiators.async_list_volume_initiators(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.list_volume_initiators_input.ListVolumeInitiatorsInput = {}  # type: ignore[typeddict-item]
        input_["volume_arn"] = volume_arn
    ...
    async def list_volume_recovery_points(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.list_volume_recovery_points_input.ListVolumeRecoveryPointsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.list_volume_recovery_points_output.ListVolumeRecoveryPointsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.list_volume_recovery_points.async_list_volume_recovery_points(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.list_volume_recovery_points_input.ListVolumeRecoveryPointsInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def list_volumes(
        ...
        *,
    ...
    ) -> "aws_sdk_storage_gateway.types.list_volumes_output.ListVolumesOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.list_volumes_input.ListVolumesInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.list_volumes_output.ListVolumesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.list_volumes.async_list_volumes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.list_volumes_input.ListVolumesInput = {}  # type: ignore[typeddict-item]
        if gateway_arn is not None:
            input_["gateway_arn"] = gateway_arn
        if marker is not None:
            input_["marker"] = marker
    ...
    ) -> "AsyncIterator[aws_sdk_storage_gateway.types.volume_info.VolumeInfo]":
        _token = marker
        while True:
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.notify_when_uploaded.async_notify_when_uploaded(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.notify_when_uploaded_input.NotifyWhenUploadedInput = {}  # type: ignore[typeddict-item]
        input_["file_share_arn"] = file_share_arn
    ...
    async def refresh_cache(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.refresh_cache_input.RefreshCacheInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.refresh_cache_output.RefreshCacheOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.refresh_cache.async_refresh_cache(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.refresh_cache_input.RefreshCacheInput = {}  # type: ignore[typeddict-item]
        input_["file_share_arn"] = file_share_arn
    ...
    async def remove_tags_from_resource(
        self,
        resource_arn: "aws_sdk_storage_gateway.types.resource_arn.ResourceARN",
        tag_keys: "aws_sdk_storage_gateway.types.tag_keys.TagKeys",
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.remove_tags_from_resource_output.RemoveTagsFromResourceOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.remove_tags_from_resource_input.RemoveTagsFromResourceInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.remove_tags_from_resource_output.RemoveTagsFromResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.remove_tags_from_resource.async_remove_tags_from_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.remove_tags_from_resource_input.RemoveTagsFromResourceInput = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
    ...
    async def reset_cache(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.reset_cache_input.ResetCacheInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.reset_cache_output.ResetCacheOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.reset_cache.async_reset_cache(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.reset_cache_input.ResetCacheInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def retrieve_tape_archive(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.retrieve_tape_archive_output.RetrieveTapeArchiveOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.retrieve_tape_archive_input.RetrieveTapeArchiveInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.retrieve_tape_archive_output.RetrieveTapeArchiveOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.retrieve_tape_archive.async_retrieve_tape_archive(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.retrieve_tape_archive_input.RetrieveTapeArchiveInput = {}  # type: ignore[typeddict-item]
        input_["tape_arn"] = tape_arn
        input_["gateway_arn"] = gateway_arn
    ...
    async def retrieve_tape_recovery_point(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.retrieve_tape_recovery_point_output.RetrieveTapeRecoveryPointOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.retrieve_tape_recovery_point_input.RetrieveTapeRecoveryPointInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.retrieve_tape_recovery_point_output.RetrieveTapeRecoveryPointOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.retrieve_tape_recovery_point.async_retrieve_tape_recovery_point(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.retrieve_tape_recovery_point_input.RetrieveTapeRecoveryPointInput = {}  # type: ignore[typeddict-item]
        input_["tape_arn"] = tape_arn
        input_["gateway_arn"] = gateway_arn
    ...
    async def set_local_console_password(
        self,
        gateway_arn: "aws_sdk_storage_gateway.types.gateway_arn.GatewayARN",
        local_console_password: "aws_sdk_storage_gateway.types.local_console_password.LocalConsolePassword",
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.set_local_console_password_output.SetLocalConsolePasswordOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.set_local_console_password_input.SetLocalConsolePasswordInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.set_local_console_password_output.SetLocalConsolePasswordOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.set_local_console_password.async_set_local_console_password(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.set_local_console_password_input.SetLocalConsolePasswordInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def set_smb_guest_password(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.set_smb_guest_password_output.SetSMBGuestPasswordOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.set_smb_guest_password_input.SetSMBGuestPasswordInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.set_smb_guest_password_output.SetSMBGuestPasswordOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.set_smb_guest_password.async_set_smb_guest_password(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.set_smb_guest_password_input.SetSMBGuestPasswordInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
        input_["password"] = password
    ...
    async def shutdown_gateway(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.shutdown_gateway_input.ShutdownGatewayInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.shutdown_gateway_output.ShutdownGatewayOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.shutdown_gateway.async_shutdown_gateway(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.shutdown_gateway_input.ShutdownGatewayInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.start_availability_monitor_test.async_start_availability_monitor_test(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.start_availability_monitor_test_input.StartAvailabilityMonitorTestInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def start_cache_report(
        ...
        *,
        ...
        "aws_sdk_storage_gateway.types.start_cache_report_output.StartCacheReportOutput"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.start_cache_report_input.StartCacheReportInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.start_cache_report_output.StartCacheReportOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.start_cache_report.async_start_cache_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.start_cache_report_input.StartCacheReportInput = {}  # type: ignore[typeddict-item]
        input_["file_share_arn"] = file_share_arn
        input_["role"] = role
        input_["location_arn"] = location_arn
        input_["bucket_region"] = bucket_region
    ...
    async def start_gateway(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.start_gateway_input.StartGatewayInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.start_gateway_output.StartGatewayOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.start_gateway.async_start_gateway(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.start_gateway_input.StartGatewayInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def update_automatic_tape_creation_policy(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.update_automatic_tape_creation_policy_output.UpdateAutomaticTapeCreationPolicyOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.update_automatic_tape_creation_policy_input.UpdateAutomaticTapeCreationPolicyInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.update_automatic_tape_creation_policy_output.UpdateAutomaticTapeCreationPolicyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.update_automatic_tape_creation_policy.async_update_automatic_tape_creation_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.update_automatic_tape_creation_policy_input.UpdateAutomaticTapeCreationPolicyInput = {}  # type: ignore[typeddict-item]
    ...
    async def update_bandwidth_rate_limit(
        ...
        *,
    ...
    ) -> "aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_output.UpdateBandwidthRateLimitOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_input.UpdateBandwidthRateLimitInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_output.UpdateBandwidthRateLimitOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.update_bandwidth_rate_limit.async_update_bandwidth_rate_limit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_input.UpdateBandwidthRateLimitInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def update_bandwidth_rate_limit_schedule(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_schedule_output.UpdateBandwidthRateLimitScheduleOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_schedule_input.UpdateBandwidthRateLimitScheduleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_schedule_output.UpdateBandwidthRateLimitScheduleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.update_bandwidth_rate_limit_schedule.async_update_bandwidth_rate_limit_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.update_bandwidth_rate_limit_schedule_input.UpdateBandwidthRateLimitScheduleInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def update_chap_credentials(
        self,
        target_arn: "aws_sdk_storage_gateway.types.target_arn.TargetARN",
        secret_to_authenticate_initiator: "aws_sdk_storage_gateway.types.chap_secret.ChapSecret",
        initiator_name: "aws_sdk_storage_gateway.types.iqn_name.IqnName",
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ...
    ) -> "aws_sdk_storage_gateway.types.update_chap_credentials_output.UpdateChapCredentialsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.update_chap_credentials_input.UpdateChapCredentialsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.update_chap_credentials_output.UpdateChapCredentialsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.update_chap_credentials.async_update_chap_credentials(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.update_chap_credentials_input.UpdateChapCredentialsInput = {}  # type: ignore[typeddict-item]
        input_["target_arn"] = target_arn
    ...
    async def update_file_system_association(
        ...
        *,
    ...
    ) -> "aws_sdk_storage_gateway.types.update_file_system_association_output.UpdateFileSystemAssociationOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.update_file_system_association_input.UpdateFileSystemAssociationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.update_file_system_association_output.UpdateFileSystemAssociationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.update_file_system_association.async_update_file_system_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.update_file_system_association_input.UpdateFileSystemAssociationInput = {}  # type: ignore[typeddict-item]
        input_["file_system_association_arn"] = file_system_association_arn
    ...
    async def update_gateway_information(
        ...
        *,
        ...
        gateway_name: Optional[
            "aws_sdk_storage_gateway.types.gateway_name.GatewayName"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.update_gateway_information_input.UpdateGatewayInformationInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.update_gateway_information_output.UpdateGatewayInformationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.update_gateway_information.async_update_gateway_information(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.update_gateway_information_input.UpdateGatewayInformationInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def update_gateway_software_now(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.update_gateway_software_now_input.UpdateGatewaySoftwareNowInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.update_gateway_software_now_output.UpdateGatewaySoftwareNowOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.update_gateway_software_now.async_update_gateway_software_now(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.update_gateway_software_now_input.UpdateGatewaySoftwareNowInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def update_maintenance_start_time(
        ...
        *,
        ...
        hour_of_day: Optional[
            "aws_sdk_storage_gateway.types.hour_of_day.HourOfDay"
        ] = None,
        minute_of_hour: Optional[
            "aws_sdk_storage_gateway.types.minute_of_hour.MinuteOfHour"
        ] = None,
        day_of_week: Optional[
            "aws_sdk_storage_gateway.types.day_of_week.DayOfWeek"
        ] = None,
        day_of_month: Optional[
            "aws_sdk_storage_gateway.types.day_of_month.DayOfMonth"
        ] = None,
        software_update_preferences: Optional[
            "aws_sdk_storage_gateway.types.software_update_preferences.SoftwareUpdatePreferences"
        ] = None,
    ) -> "aws_sdk_storage_gateway.types.update_maintenance_start_time_output.UpdateMaintenanceStartTimeOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.update_maintenance_start_time_input.UpdateMaintenanceStartTimeInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.update_maintenance_start_time_output.UpdateMaintenanceStartTimeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.update_maintenance_start_time.async_update_maintenance_start_time(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.update_maintenance_start_time_input.UpdateMaintenanceStartTimeInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def update_nfs_file_share(
        ...
        *,
    ...
    ) -> "aws_sdk_storage_gateway.types.update_nfs_file_share_output.UpdateNFSFileShareOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.update_nfs_file_share_input.UpdateNFSFileShareInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.update_nfs_file_share_output.UpdateNFSFileShareOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.update_nfs_file_share.async_update_nfs_file_share(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.update_nfs_file_share_input.UpdateNFSFileShareInput = {}  # type: ignore[typeddict-item]
        input_["file_share_arn"] = file_share_arn
        if encryption_type is not None:
            input_["encryption_type"] = encryption_type
        if kms_encrypted is not None:
    ...
    async def update_smb_file_share(
        ...
        *,
    ...
    ) -> "aws_sdk_storage_gateway.types.update_smb_file_share_output.UpdateSMBFileShareOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.update_smb_file_share_input.UpdateSMBFileShareInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.update_smb_file_share_output.UpdateSMBFileShareOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.update_smb_file_share.async_update_smb_file_share(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.update_smb_file_share_input.UpdateSMBFileShareInput = {}  # type: ignore[typeddict-item]
        input_["file_share_arn"] = file_share_arn
        if encryption_type is not None:
            input_["encryption_type"] = encryption_type
        if kms_encrypted is not None:
    ...
    async def update_smb_file_share_visibility(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.update_smb_file_share_visibility_output.UpdateSMBFileShareVisibilityOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.update_smb_file_share_visibility_input.UpdateSMBFileShareVisibilityInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.update_smb_file_share_visibility_output.UpdateSMBFileShareVisibilityOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.update_smb_file_share_visibility.async_update_smb_file_share_visibility(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.update_smb_file_share_visibility_input.UpdateSMBFileShareVisibilityInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def update_smb_local_groups(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.update_smb_local_groups_output.UpdateSMBLocalGroupsOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.update_smb_local_groups_input.UpdateSMBLocalGroupsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.update_smb_local_groups_output.UpdateSMBLocalGroupsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.update_smb_local_groups.async_update_smb_local_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.update_smb_local_groups_input.UpdateSMBLocalGroupsInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def update_smb_security_strategy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.update_smb_security_strategy_input.UpdateSMBSecurityStrategyInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.update_smb_security_strategy_output.UpdateSMBSecurityStrategyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.update_smb_security_strategy.async_update_smb_security_strategy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.update_smb_security_strategy_input.UpdateSMBSecurityStrategyInput = {}  # type: ignore[typeddict-item]
        input_["gateway_arn"] = gateway_arn
    ...
    async def update_snapshot_schedule(
        ...
        recurrence_in_hours: "aws_sdk_storage_gateway.types.recurrence_in_hours.RecurrenceInHours",
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
        description: Optional[
            "aws_sdk_storage_gateway.types.description.Description"
        ] = None,
        tags: Optional["aws_sdk_storage_gateway.types.tags.Tags"] = None,
    ) -> "aws_sdk_storage_gateway.types.update_snapshot_schedule_output.UpdateSnapshotScheduleOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.update_snapshot_schedule_input.UpdateSnapshotScheduleInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.update_snapshot_schedule_output.UpdateSnapshotScheduleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.update_snapshot_schedule.async_update_snapshot_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.update_snapshot_schedule_input.UpdateSnapshotScheduleInput = {}  # type: ignore[typeddict-item]
        input_["volume_arn"] = volume_arn
    ...
    async def update_vtl_device_type(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
    ) -> "aws_sdk_storage_gateway.types.update_vtl_device_type_output.UpdateVTLDeviceTypeOutput":
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_storage_gateway.types.update_vtl_device_type_input.UpdateVTLDeviceTypeInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_storage_gateway.types.update_vtl_device_type_output.UpdateVTLDeviceTypeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_storage_gateway._operations.storage_gateway_20130630.update_vtl_device_type.async_update_vtl_device_type(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: aws_sdk_storage_gateway.types.update_vtl_device_type_input.UpdateVTLDeviceTypeInput = {}  # type: ignore[typeddict-item]
