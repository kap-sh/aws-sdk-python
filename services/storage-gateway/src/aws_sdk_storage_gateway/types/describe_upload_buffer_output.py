...
class DescribeUploadBufferOutput(TypedDict):
    ...
    upload_buffer_used_in_bytes: "aws_sdk_storage_gateway.types.long.long"
    """<p>The total number of bytes being used in the gateway's upload buffer.</p>"""
    upload_buffer_allocated_in_bytes: "aws_sdk_storage_gateway.types.long.long"
