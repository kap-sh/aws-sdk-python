...
if TYPE_CHECKING:
    ...
    import aws_sdk_storage_gateway.types.file_system_association_id
    import aws_sdk_storage_gateway.types.file_system_association_status
    import aws_sdk_storage_gateway.types.gateway_arn


class FileSystemAssociationSummary(TypedDict):
    file_system_association_id: NotRequired[
        "aws_sdk_storage_gateway.types.file_system_association_id.FileSystemAssociationId"
    ]
