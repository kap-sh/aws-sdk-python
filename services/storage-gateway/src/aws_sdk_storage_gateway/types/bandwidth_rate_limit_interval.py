...
if TYPE_CHECKING:
    ...
    import aws_sdk_storage_gateway.types.days_of_week
...
class BandwidthRateLimitInterval(TypedDict):
    ...
    end_hour_of_day: "aws_sdk_storage_gateway.types.hour_of_day.HourOfDay"
    """<p> The hour of the day to end the bandwidth rate limit interval. </p>"""
    end_minute_of_hour: "aws_sdk_storage_gateway.types.minute_of_hour.MinuteOfHour"
    ...
    days_of_week: "aws_sdk_storage_gateway.types.days_of_week.DaysOfWeek"
...
def serialize_aws_json_1_1(value: BandwidthRateLimitInterval) -> dict:
    ...
    out["DaysOfWeek"] = (
        aws_sdk_storage_gateway.types.days_of_week.serialize_aws_json_1_1(
            value["days_of_week"]
        )
    )
...
def deserialize_aws_json_1_1(data: dict) -> BandwidthRateLimitInterval:
    ...
    if "DaysOfWeek" in data:
        ...
        out["days_of_week"] = (
            aws_sdk_storage_gateway.types.days_of_week.deserialize_aws_json_1_1(
                data["DaysOfWeek"]
            )
        )
    else:
