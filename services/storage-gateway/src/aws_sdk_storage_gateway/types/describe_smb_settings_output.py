...
class DescribeSMBSettingsOutput(TypedDict):
    gateway_arn: NotRequired["aws_sdk_storage_gateway.types.gateway_arn.GatewayARN"]
    domain_name: NotRequired["aws_sdk_storage_gateway.types.domain_name.DomainName"]
    ...
    smb_guest_password_set: NotRequired["aws_sdk_storage_gateway.types.boolean.Boolean"]
    ...
    file_shares_visible: NotRequired["aws_sdk_storage_gateway.types.boolean.Boolean"]
    ...
    smb_local_groups: NotRequired[
        "aws_sdk_storage_gateway.types.smb_local_groups.SMBLocalGroups"
    ]
