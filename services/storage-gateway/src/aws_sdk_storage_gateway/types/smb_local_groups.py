...
def serialize_aws_json_1_1(value: SMBLocalGroups) -> dict:
    ...
    if "gateway_admins" in value:
        import aws_sdk_storage_gateway.types.user_list
        out["GatewayAdmins"] = aws_sdk_storage_gateway.types.user_list.serialize_aws_json_1_1(value["gateway_admins"])
    return out
...
def deserialize_aws_json_1_1(data: dict) -> SMBLocalGroups:
    ...
    if "GatewayAdmins" in data:
        import aws_sdk_storage_gateway.types.user_list
        out["gateway_admins"] = aws_sdk_storage_gateway.types.user_list.deserialize_aws_json_1_1(data["GatewayAdmins"])
    return out