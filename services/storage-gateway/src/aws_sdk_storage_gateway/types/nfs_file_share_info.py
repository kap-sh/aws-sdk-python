...
if TYPE_CHECKING:
    ...
    import aws_sdk_storage_gateway.types.path
...
class NFSFileShareInfo(TypedDict):
    ...
    kms_encrypted: "aws_sdk_storage_gateway.types.boolean2.Boolean2"
    ...
    path: NotRequired["aws_sdk_storage_gateway.types.path.Path"]
    ...
    squash: NotRequired["aws_sdk_storage_gateway.types.squash.Squash"]
    ...
    guess_mime_type_enabled: NotRequired[
    ...
    bucket_region: NotRequired["aws_sdk_storage_gateway.types.region_id.RegionId"]
...
def serialize_aws_json_1_1(value: NFSFileShareInfo) -> dict:
    ...
    if "nfs_file_share_defaults" in value:
        ...
        out["NFSFileShareDefaults"] = (
            aws_sdk_storage_gateway.types.nfs_file_share_defaults.serialize_aws_json_1_1(
    ...
    if "encryption_type" in value:
        ...
        out["EncryptionType"] = (
            aws_sdk_storage_gateway.types.encryption_type.serialize_aws_json_1_1(
    ...
    if "object_acl" in value:
        ...
        out["ObjectACL"] = (
            aws_sdk_storage_gateway.types.object_acl.serialize_aws_json_1_1(
                value["object_acl"]
            )
        )
    if "client_list" in value:
        ...
        out["ClientList"] = (
            aws_sdk_storage_gateway.types.file_share_client_list.serialize_aws_json_1_1(
                value["client_list"]
            )
        )
    if "squash" in value:
...
def deserialize_aws_json_1_1(data: dict) -> NFSFileShareInfo:
    ...
    if "NFSFileShareDefaults" in data:
        ...
        out["nfs_file_share_defaults"] = (
            aws_sdk_storage_gateway.types.nfs_file_share_defaults.deserialize_aws_json_1_1(
    ...
    if "EncryptionType" in data:
        ...
        out["encryption_type"] = (
            aws_sdk_storage_gateway.types.encryption_type.deserialize_aws_json_1_1(
                data["EncryptionType"]
            )
        )
    ...
    if "ObjectACL" in data:
        ...
        out["object_acl"] = (
            aws_sdk_storage_gateway.types.object_acl.deserialize_aws_json_1_1(
                data["ObjectACL"]
            )
        )
    if "ClientList" in data:
        ...
        out["client_list"] = (
            aws_sdk_storage_gateway.types.file_share_client_list.deserialize_aws_json_1_1(
                data["ClientList"]
            )
        )
    if "Squash" in data:
