...
class RemoveTagsFromResourceInput(TypedDict):
...
def serialize_aws_json_1_1(value: RemoveTagsFromResourceInput) -> dict:
    ...
    out["TagKeys"] = aws_sdk_storage_gateway.types.tag_keys.serialize_aws_json_1_1(
        value["tag_keys"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> RemoveTagsFromResourceInput:
    ...
    if "TagKeys" in data:
        ...
        out["tag_keys"] = (
            aws_sdk_storage_gateway.types.tag_keys.deserialize_aws_json_1_1(
                data["TagKeys"]
            )
        )
    else:
