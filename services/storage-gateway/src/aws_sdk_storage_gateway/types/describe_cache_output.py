...
if TYPE_CHECKING:
    ...
    import aws_sdk_storage_gateway.types.double
    import aws_sdk_storage_gateway.types.gateway_arn
    import aws_sdk_storage_gateway.types.long


class DescribeCacheOutput(TypedDict):
    ...
    cache_allocated_in_bytes: "aws_sdk_storage_gateway.types.long.long"
    """<p>The amount of cache in bytes allocated to a gateway.</p>"""
    cache_used_percentage: "aws_sdk_storage_gateway.types.double.double"
    ...
    cache_dirty_percentage: "aws_sdk_storage_gateway.types.double.double"
    ...
    cache_hit_percentage: "aws_sdk_storage_gateway.types.double.double"
    ...
    cache_miss_percentage: "aws_sdk_storage_gateway.types.double.double"
