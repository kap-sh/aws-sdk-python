...
if TYPE_CHECKING:
    import aws_sdk_storage_gateway.types.storedi_scsi_volumes


class DescribeStorediSCSIVolumesOutput(TypedDict):
    storedi_scsi_volumes: NotRequired[
        "aws_sdk_storage_gateway.types.storedi_scsi_volumes.StorediSCSIVolumes"
    ]
...
def serialize_aws_json_1_1(value: DescribeStorediSCSIVolumesOutput) -> dict:
    ...
    if "storedi_scsi_volumes" in value:
        ...
        out["StorediSCSIVolumes"] = (
            aws_sdk_storage_gateway.types.storedi_scsi_volumes.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeStorediSCSIVolumesOutput:
    ...
    if "StorediSCSIVolumes" in data:
        ...
        out["storedi_scsi_volumes"] = (
            aws_sdk_storage_gateway.types.storedi_scsi_volumes.deserialize_aws_json_1_1(
