...
class DescribeVTLDevicesInput(TypedDict):
...
def serialize_aws_json_1_1(value: DescribeVTLDevicesInput) -> dict:
    ...
    if "vtl_device_ar_ns" in value:
        ...
        out["VTLDeviceARNs"] = (
            aws_sdk_storage_gateway.types.vtl_device_ar_ns.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeVTLDevicesInput:
    ...
    if "VTLDeviceARNs" in data:
        ...
        out["vtl_device_ar_ns"] = (
            aws_sdk_storage_gateway.types.vtl_device_ar_ns.deserialize_aws_json_1_1(
                data["VTLDeviceARNs"]
            )
        )
    if "Marker" in data:
