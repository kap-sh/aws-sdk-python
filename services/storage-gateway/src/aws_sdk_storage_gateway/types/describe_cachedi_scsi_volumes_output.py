...
if TYPE_CHECKING:
    import aws_sdk_storage_gateway.types.cachedi_scsi_volumes


class DescribeCachediSCSIVolumesOutput(TypedDict):
    cachedi_scsi_volumes: NotRequired[
        "aws_sdk_storage_gateway.types.cachedi_scsi_volumes.CachediSCSIVolumes"
    ]
...
def serialize_aws_json_1_1(value: DescribeCachediSCSIVolumesOutput) -> dict:
    ...
    if "cachedi_scsi_volumes" in value:
        ...
        out["CachediSCSIVolumes"] = (
            aws_sdk_storage_gateway.types.cachedi_scsi_volumes.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeCachediSCSIVolumesOutput:
    ...
    if "CachediSCSIVolumes" in data:
        ...
        out["cachedi_scsi_volumes"] = (
            aws_sdk_storage_gateway.types.cachedi_scsi_volumes.deserialize_aws_json_1_1(
