"""Generated from Smithy shape ``com.amazonaws.storagegateway#AssociateFileSystemOutput``."""
...
class AssociateFileSystemOutput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AssociateFileSystemOutput) -> dict:
    out: dict = {}
