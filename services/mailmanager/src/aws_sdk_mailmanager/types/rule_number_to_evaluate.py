...
if TYPE_CHECKING:
    import aws_sdk_mailmanager.types.rule_number_email_attribute


class _RuleNumberToEvaluate_Attribute(TypedDict):
    Attribute: (
        "aws_sdk_mailmanager.types.rule_number_email_attribute.RuleNumberEmailAttribute"
    )
...
def serialize_aws_json_1_0(value: RuleNumberToEvaluate) -> dict:
    if "Attribute" in value:
        ...
        return {
            "Attribute": aws_sdk_mailmanager.types.rule_number_email_attribute.serialize_aws_json_1_0(
                value["Attribute"]
            )
        }
    else:
...
def deserialize_aws_json_1_0(data: dict) -> RuleNumberToEvaluate:
    if "Attribute" in data:
        ...
        return {
            "Attribute": aws_sdk_mailmanager.types.rule_number_email_attribute.deserialize_aws_json_1_0(
                data["Attribute"]
            )
        }
    else:
