"""Generated from Smithy shape ``com.amazonaws.mailmanager#ListAddonInstancesRequest``."""
...
class ListAddonInstancesRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListAddonInstancesRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> ListAddonInstancesRequest:
    out: ListAddonInstancesRequest = {}  # type: ignore[typeddict-item]
