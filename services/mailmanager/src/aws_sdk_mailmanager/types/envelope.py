...
Envelope = TypedDict(
    "Envelope",
    {
        ...
        "to": NotRequired["aws_sdk_mailmanager.types.string_list.StringList"],
    },
)
...
def serialize_aws_json_1_0(value: Envelope) -> dict:
    ...
    if "to" in value:
        ...
        out["To"] = aws_sdk_mailmanager.types.string_list.serialize_aws_json_1_0(
            value["to"]
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> Envelope:
    ...
    if "To" in data:
        ...
        out["to"] = aws_sdk_mailmanager.types.string_list.deserialize_aws_json_1_0(
            data["To"]
        )
    return out
