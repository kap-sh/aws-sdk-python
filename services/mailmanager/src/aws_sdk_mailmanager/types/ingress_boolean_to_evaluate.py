...
if TYPE_CHECKING:
    ...
    import aws_sdk_mailmanager.types.ingress_is_in_address_list


class _IngressBooleanToEvaluate_Analysis(TypedDict):
    Analysis: "aws_sdk_mailmanager.types.ingress_analysis.IngressAnalysis"


class _IngressBooleanToEvaluate_IsInAddressList(TypedDict):
    IsInAddressList: (
        "aws_sdk_mailmanager.types.ingress_is_in_address_list.IngressIsInAddressList"
    )
...
def serialize_aws_json_1_0(value: IngressBooleanToEvaluate) -> dict:
    if "Analysis" in value:
        ...
        return {
            "IsInAddressList": aws_sdk_mailmanager.types.ingress_is_in_address_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> IngressBooleanToEvaluate:
    if "Analysis" in data:
        ...
        return {
            "IsInAddressList": aws_sdk_mailmanager.types.ingress_is_in_address_list.deserialize_aws_json_1_0(
