...
if TYPE_CHECKING:
    ...
    import aws_sdk_mailmanager.types.archive_arn
...
class GetArchiveResponse(TypedDict):
    ...
    archive_arn: "aws_sdk_mailmanager.types.archive_arn.ArchiveArn"
    """<p>The Amazon Resource Name (ARN) of the archive.</p>"""
    archive_state: "aws_sdk_mailmanager.types.archive_state.ArchiveState"
    ...
    retention: "aws_sdk_mailmanager.types.archive_retention.ArchiveRetention"
