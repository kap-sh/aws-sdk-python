...
if TYPE_CHECKING:
    import aws_sdk_mailmanager.types.s3_export_destination_configuration


class _ExportDestinationConfiguration_S3(TypedDict):
    S3: "aws_sdk_mailmanager.types.s3_export_destination_configuration.S3ExportDestinationConfiguration"
...
def serialize_aws_json_1_0(value: ExportDestinationConfiguration) -> dict:
    if "S3" in value:
        ...
        return {
            "S3": aws_sdk_mailmanager.types.s3_export_destination_configuration.serialize_aws_json_1_0(
                value["S3"]
            )
        }
    else:
...
def deserialize_aws_json_1_0(data: dict) -> ExportDestinationConfiguration:
    if "S3" in data:
        ...
        return {
            "S3": aws_sdk_mailmanager.types.s3_export_destination_configuration.deserialize_aws_json_1_0(
                data["S3"]
            )
        }
    else:
