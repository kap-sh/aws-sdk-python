...
if TYPE_CHECKING:
    ...
    import aws_sdk_mailmanager.types.lambda_function_arn
    import aws_sdk_mailmanager.types.lambda_invocation_type
    import aws_sdk_mailmanager.types.lambda_retry_time_minutes


class InvokeLambdaAction(TypedDict):
    ...
    function_arn: "aws_sdk_mailmanager.types.lambda_function_arn.LambdaFunctionArn"
    """<p>The Amazon Resource Name (ARN) of the Lambda function to invoke.</p>"""
    invocation_type: (
        "aws_sdk_mailmanager.types.lambda_invocation_type.LambdaInvocationType"
    )
    ...
    retry_time_minutes: NotRequired[
        "aws_sdk_mailmanager.types.lambda_retry_time_minutes.LambdaRetryTimeMinutes"
    ]
...
def serialize_aws_json_1_0(value: InvokeLambdaAction) -> dict:
    ...
    out["InvocationType"] = (
        aws_sdk_mailmanager.types.lambda_invocation_type.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> InvokeLambdaAction:
    ...
    if "InvocationType" in data:
        ...
        out["invocation_type"] = (
            aws_sdk_mailmanager.types.lambda_invocation_type.deserialize_aws_json_1_0(
                data["InvocationType"]
            )
        )
    else:
