...
class ListAddressListsResponse(TypedDict):
    address_lists: "aws_sdk_mailmanager.types.address_lists.AddressLists"
...
def serialize_aws_json_1_0(value: ListAddressListsResponse) -> dict:
    ...
    out["AddressLists"] = (
        aws_sdk_mailmanager.types.address_lists.serialize_aws_json_1_0(
            value["address_lists"]
        )
    )
...
def deserialize_aws_json_1_0(data: dict) -> ListAddressListsResponse:
    ...
    if "AddressLists" in data:
        ...
        out["address_lists"] = (
            aws_sdk_mailmanager.types.address_lists.deserialize_aws_json_1_0(
                data["AddressLists"]
            )
        )
    else:
