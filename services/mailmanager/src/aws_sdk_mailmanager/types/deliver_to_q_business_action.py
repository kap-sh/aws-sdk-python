...
if TYPE_CHECKING:
    ...
    import aws_sdk_mailmanager.types.q_business_application_id
    import aws_sdk_mailmanager.types.q_business_index_id


class DeliverToQBusinessAction(TypedDict):
    ...
    application_id: (
        "aws_sdk_mailmanager.types.q_business_application_id.QBusinessApplicationId"
    )
    """<p>The unique identifier of the Amazon Q Business application instance where the email content will be delivered.</p>"""
    index_id: "aws_sdk_mailmanager.types.q_business_index_id.QBusinessIndexId"
