...
from aws_sdk_mailmanager._services._aws_config import aaws_config
...
class AsyncMailManagerClientConfig(TypedDict, total=False):
...
class AsyncMailManagerClient:
    ...
    async def create_address_list_import_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.create_address_list_import_job_request.CreateAddressListImportJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.create_address_list_import_job_response.CreateAddressListImportJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.create_address_list_import_job.async_create_address_list_import_job(
    ...
    async def deregister_member_from_address_list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.deregister_member_from_address_list_request.DeregisterMemberFromAddressListRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.deregister_member_from_address_list_response.DeregisterMemberFromAddressListResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.deregister_member_from_address_list.async_deregister_member_from_address_list(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_address_list_import_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.get_address_list_import_job_request.GetAddressListImportJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.get_address_list_import_job_response.GetAddressListImportJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.get_address_list_import_job.async_get_address_list_import_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_archive_export(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.get_archive_export_request.GetArchiveExportRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.get_archive_export_response.GetArchiveExportResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.get_archive_export.async_get_archive_export(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_archive_message(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.get_archive_message_request.GetArchiveMessageRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.get_archive_message_response.GetArchiveMessageResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.get_archive_message.async_get_archive_message(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_archive_message_content(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.get_archive_message_content_request.GetArchiveMessageContentRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.get_archive_message_content_response.GetArchiveMessageContentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.get_archive_message_content.async_get_archive_message_content(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_archive_search(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.get_archive_search_request.GetArchiveSearchRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.get_archive_search_response.GetArchiveSearchResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.get_archive_search.async_get_archive_search(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_archive_search_results(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.get_archive_search_results_request.GetArchiveSearchResultsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.get_archive_search_results_response.GetArchiveSearchResultsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.get_archive_search_results.async_get_archive_search_results(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_member_of_address_list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.get_member_of_address_list_request.GetMemberOfAddressListRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.get_member_of_address_list_response.GetMemberOfAddressListResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.get_member_of_address_list.async_get_member_of_address_list(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_address_list_import_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.list_address_list_import_jobs_request.ListAddressListImportJobsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.list_address_list_import_jobs_response.ListAddressListImportJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.list_address_list_import_jobs.async_list_address_list_import_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_address_list_import_jobs(
        ...
        *,
        ...
        page_size: Optional["aws_sdk_mailmanager.types.page_size.PageSize"] = None,
    ) -> "AsyncIterator[aws_sdk_mailmanager.types.import_job.ImportJob]":
        _token = next_token
        while True:
    ...
    async def list_archive_exports(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.list_archive_exports_request.ListArchiveExportsRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.list_archive_exports_response.ListArchiveExportsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.list_archive_exports.async_list_archive_exports(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_archive_exports(
        ...
        *,
        ...
        page_size: Optional["aws_sdk_mailmanager.types.page_size.PageSize"] = None,
    ) -> "AsyncIterator[aws_sdk_mailmanager.types.export_summary.ExportSummary]":
        _token = next_token
        while True:
    ...
    async def list_archive_searches(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.list_archive_searches_request.ListArchiveSearchesRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.list_archive_searches_response.ListArchiveSearchesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.list_archive_searches.async_list_archive_searches(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_archive_searches(
        ...
        *,
        ...
        page_size: Optional["aws_sdk_mailmanager.types.page_size.PageSize"] = None,
    ) -> "AsyncIterator[aws_sdk_mailmanager.types.search_summary.SearchSummary]":
        _token = next_token
        while True:
    ...
    async def list_members_of_address_list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.list_members_of_address_list_request.ListMembersOfAddressListRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.list_members_of_address_list_response.ListMembersOfAddressListResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.list_members_of_address_list.async_list_members_of_address_list(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[aws_sdk_mailmanager.types.saved_address.SavedAddress]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_member_to_address_list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.register_member_to_address_list_request.RegisterMemberToAddressListRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.register_member_to_address_list_response.RegisterMemberToAddressListResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.register_member_to_address_list.async_register_member_to_address_list(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_address_list_import_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.start_address_list_import_job_request.StartAddressListImportJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.start_address_list_import_job_response.StartAddressListImportJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.start_address_list_import_job.async_start_address_list_import_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_archive_export(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.start_archive_export_request.StartArchiveExportRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.start_archive_export_response.StartArchiveExportResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.start_archive_export.async_start_archive_export(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_archive_search(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.start_archive_search_request.StartArchiveSearchRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.start_archive_search_response.StartArchiveSearchResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.start_archive_search.async_start_archive_search(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_address_list_import_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.stop_address_list_import_job_request.StopAddressListImportJobRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.stop_address_list_import_job_response.StopAddressListImportJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.stop_address_list_import_job.async_stop_address_list_import_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_archive_export(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.stop_archive_export_request.StopArchiveExportRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.stop_archive_export_response.StopArchiveExportResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.stop_archive_export.async_stop_archive_export(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_archive_search(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.stop_archive_search_request.StopArchiveSearchRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.stop_archive_search_response.StopArchiveSearchResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.stop_archive_search.async_stop_archive_search(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_mailmanager.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "aws_sdk_mailmanager.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_mailmanager._operations.mail_manager_svc.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
