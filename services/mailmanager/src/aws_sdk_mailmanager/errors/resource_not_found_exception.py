"""Generated from Smithy shape ``com.amazonaws.mailmanager#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.mailmanager#ResourceNotFoundException``."""
