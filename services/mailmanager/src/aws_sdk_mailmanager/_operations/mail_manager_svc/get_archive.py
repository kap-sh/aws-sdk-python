"""Generated from Smithy shape ``com.amazonaws.mailmanager#GetArchive``."""
...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.get_archive_response.GetArchiveResponse = (
        aws_sdk_mailmanager.types.get_archive_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.get_archive_request.GetArchiveRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "MailManagerSvc.GetArchive"
    import aws_sdk_mailmanager.types.get_archive_request

    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.get_archive_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_archive(
    ...
    aws_sdk_mailmanager.types.get_archive_response.GetArchiveResponse, zapros.Response
]:
