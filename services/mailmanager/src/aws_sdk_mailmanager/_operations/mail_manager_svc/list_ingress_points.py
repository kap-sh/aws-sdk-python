...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.list_ingress_points_response.ListIngressPointsResponse = aws_sdk_mailmanager.types.list_ingress_points_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.list_ingress_points_request.ListIngressPointsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.list_ingress_points_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
