...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.update_traffic_policy_response.UpdateTrafficPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.update_traffic_policy_request.UpdateTrafficPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.update_traffic_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
