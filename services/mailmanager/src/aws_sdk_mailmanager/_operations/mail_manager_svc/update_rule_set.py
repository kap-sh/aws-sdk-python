...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.update_rule_set_response.UpdateRuleSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.update_rule_set_request.UpdateRuleSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.update_rule_set_request.serialize_aws_json_1_0(input_)
    ).encode()
