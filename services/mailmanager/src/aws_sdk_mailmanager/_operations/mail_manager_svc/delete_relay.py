...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.delete_relay_response.DeleteRelayResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_mailmanager.types.delete_relay_request.DeleteRelayRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.delete_relay_request.serialize_aws_json_1_0(input)
    ).encode()
...
def delete_relay(
    ...
    aws_sdk_mailmanager.types.delete_relay_response.DeleteRelayResponse, zapros.Response
]:
