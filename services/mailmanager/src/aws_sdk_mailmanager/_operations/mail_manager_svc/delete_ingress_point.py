"""Generated from Smithy shape ``com.amazonaws.mailmanager#DeleteIngressPoint``."""
...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.delete_ingress_point_response.DeleteIngressPointResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.delete_ingress_point_request.DeleteIngressPointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "MailManagerSvc.DeleteIngressPoint"
    import aws_sdk_mailmanager.types.delete_ingress_point_request

    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.delete_ingress_point_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_ingress_point(
