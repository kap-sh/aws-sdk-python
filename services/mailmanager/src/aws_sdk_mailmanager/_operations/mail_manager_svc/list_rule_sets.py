"""Generated from Smithy shape ``com.amazonaws.mailmanager#ListRuleSets``."""
...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.list_rule_sets_response.ListRuleSetsResponse = (
        aws_sdk_mailmanager.types.list_rule_sets_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.list_rule_sets_request.ListRuleSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "MailManagerSvc.ListRuleSets"
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.list_rule_sets_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_list_rule_sets(
