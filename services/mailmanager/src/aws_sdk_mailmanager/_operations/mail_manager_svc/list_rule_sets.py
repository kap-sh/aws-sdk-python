...
def build_request(
    ...
    input: aws_sdk_mailmanager.types.list_rule_sets_request.ListRuleSetsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.list_rule_sets_request.serialize_aws_json_1_0(input)
    ).encode()
