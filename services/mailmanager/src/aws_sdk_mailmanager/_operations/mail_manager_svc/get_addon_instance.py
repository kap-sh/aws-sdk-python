...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.get_addon_instance_response.GetAddonInstanceResponse = aws_sdk_mailmanager.types.get_addon_instance_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.get_addon_instance_request.GetAddonInstanceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.get_addon_instance_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
