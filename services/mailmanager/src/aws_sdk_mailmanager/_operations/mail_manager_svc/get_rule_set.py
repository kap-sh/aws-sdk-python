...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.get_rule_set_response.GetRuleSetResponse = (
        aws_sdk_mailmanager.types.get_rule_set_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.get_rule_set_request.GetRuleSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.get_rule_set_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_rule_set(
    ...
    aws_sdk_mailmanager.types.get_rule_set_response.GetRuleSetResponse, zapros.Response
]:
