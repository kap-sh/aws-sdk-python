...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.get_archive_message_response.GetArchiveMessageResponse = aws_sdk_mailmanager.types.get_archive_message_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.get_archive_message_request.GetArchiveMessageRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.get_archive_message_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
