"""Generated from Smithy shape ``com.amazonaws.mailmanager#UpdateRelay``."""
...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.update_relay_response.UpdateRelayResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.update_relay_request.UpdateRelayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "MailManagerSvc.UpdateRelay"
    import aws_sdk_mailmanager.types.update_relay_request

    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.update_relay_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def update_relay(
    ...
    aws_sdk_mailmanager.types.update_relay_response.UpdateRelayResponse, zapros.Response
]:
