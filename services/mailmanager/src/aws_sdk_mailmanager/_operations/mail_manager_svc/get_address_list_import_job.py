"""Generated from Smithy shape ``com.amazonaws.mailmanager#GetAddressListImportJob``."""
...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.get_address_list_import_job_response.GetAddressListImportJobResponse = aws_sdk_mailmanager.types.get_address_list_import_job_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.get_address_list_import_job_request.GetAddressListImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "MailManagerSvc.GetAddressListImportJob"
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.get_address_list_import_job_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_get_address_list_import_job(
