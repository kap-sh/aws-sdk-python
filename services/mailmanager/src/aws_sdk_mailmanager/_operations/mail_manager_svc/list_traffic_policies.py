...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.list_traffic_policies_response.ListTrafficPoliciesResponse = aws_sdk_mailmanager.types.list_traffic_policies_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.list_traffic_policies_request.ListTrafficPoliciesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.list_traffic_policies_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
