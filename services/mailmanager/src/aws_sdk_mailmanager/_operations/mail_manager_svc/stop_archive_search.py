...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.stop_archive_search_response.StopArchiveSearchResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.stop_archive_search_request.StopArchiveSearchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.stop_archive_search_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
