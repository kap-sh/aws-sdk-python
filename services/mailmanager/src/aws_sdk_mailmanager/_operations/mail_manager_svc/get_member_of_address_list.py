...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.get_member_of_address_list_response.GetMemberOfAddressListResponse = aws_sdk_mailmanager.types.get_member_of_address_list_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.get_member_of_address_list_request.GetMemberOfAddressListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.get_member_of_address_list_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
