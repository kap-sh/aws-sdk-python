...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.list_addon_subscriptions_response.ListAddonSubscriptionsResponse = aws_sdk_mailmanager.types.list_addon_subscriptions_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.list_addon_subscriptions_request.ListAddonSubscriptionsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.list_addon_subscriptions_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
