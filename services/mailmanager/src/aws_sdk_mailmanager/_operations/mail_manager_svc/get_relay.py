...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.get_relay_response.GetRelayResponse = (
        aws_sdk_mailmanager.types.get_relay_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.get_relay_request.GetRelayRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.get_relay_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def get_relay(
    ...
    aws_sdk_mailmanager.types.get_relay_response.GetRelayResponse, zapros.Response
]:
