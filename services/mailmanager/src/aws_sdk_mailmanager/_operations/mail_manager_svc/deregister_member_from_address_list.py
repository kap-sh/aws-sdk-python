"""Generated from Smithy shape ``com.amazonaws.mailmanager#DeregisterMemberFromAddressList``."""
...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.deregister_member_from_address_list_response.DeregisterMemberFromAddressListResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.deregister_member_from_address_list_request.DeregisterMemberFromAddressListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "MailManagerSvc.DeregisterMemberFromAddressList"
    import aws_sdk_mailmanager.types.deregister_member_from_address_list_request

    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.deregister_member_from_address_list_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_deregister_member_from_address_list(
