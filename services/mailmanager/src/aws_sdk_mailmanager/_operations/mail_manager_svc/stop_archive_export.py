...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.stop_archive_export_response.StopArchiveExportResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.stop_archive_export_request.StopArchiveExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.stop_archive_export_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
