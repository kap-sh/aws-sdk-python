...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.stop_address_list_import_job_response.StopAddressListImportJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.stop_address_list_import_job_request.StopAddressListImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.stop_address_list_import_job_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
