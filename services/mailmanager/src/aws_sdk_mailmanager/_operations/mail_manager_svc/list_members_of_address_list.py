"""Generated from Smithy shape ``com.amazonaws.mailmanager#ListMembersOfAddressList``."""
...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.list_members_of_address_list_response.ListMembersOfAddressListResponse = aws_sdk_mailmanager.types.list_members_of_address_list_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.list_members_of_address_list_request.ListMembersOfAddressListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "MailManagerSvc.ListMembersOfAddressList"
    import aws_sdk_mailmanager.types.list_members_of_address_list_request

    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.list_members_of_address_list_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_members_of_address_list(
