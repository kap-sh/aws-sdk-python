...
def build_request(
    ...
    input: aws_sdk_mailmanager.types.create_rule_set_request.CreateRuleSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.create_rule_set_request.serialize_aws_json_1_0(input)
    ).encode()
