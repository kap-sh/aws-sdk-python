...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.create_rule_set_response.CreateRuleSetResponse = (
        aws_sdk_mailmanager.types.create_rule_set_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.create_rule_set_request.CreateRuleSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.create_rule_set_request.serialize_aws_json_1_0(input_)
    ).encode()
