...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.get_archive_message_content_response.GetArchiveMessageContentResponse = aws_sdk_mailmanager.types.get_archive_message_content_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.get_archive_message_content_request.GetArchiveMessageContentRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.get_archive_message_content_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
