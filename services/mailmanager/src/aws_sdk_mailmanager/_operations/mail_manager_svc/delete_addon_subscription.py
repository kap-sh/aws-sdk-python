"""Generated from Smithy shape ``com.amazonaws.mailmanager#DeleteAddonSubscription``."""
...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.delete_addon_subscription_response.DeleteAddonSubscriptionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.delete_addon_subscription_request.DeleteAddonSubscriptionRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "MailManagerSvc.DeleteAddonSubscription"
    import aws_sdk_mailmanager.types.delete_addon_subscription_request

    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.delete_addon_subscription_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_delete_addon_subscription(
