...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.list_archive_searches_response.ListArchiveSearchesResponse = aws_sdk_mailmanager.types.list_archive_searches_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.list_archive_searches_request.ListArchiveSearchesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.list_archive_searches_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
