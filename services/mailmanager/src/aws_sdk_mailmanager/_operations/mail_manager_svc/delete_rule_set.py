"""Generated from Smithy shape ``com.amazonaws.mailmanager#DeleteRuleSet``."""
...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.delete_rule_set_response.DeleteRuleSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.delete_rule_set_request.DeleteRuleSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "MailManagerSvc.DeleteRuleSet"
    import aws_sdk_mailmanager.types.delete_rule_set_request

    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.delete_rule_set_request.serialize_aws_json_1_0(input_)
    ).encode()
...
async def async_delete_rule_set(
