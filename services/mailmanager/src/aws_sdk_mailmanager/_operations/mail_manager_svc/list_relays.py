...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.list_relays_response.ListRelaysResponse = (
        aws_sdk_mailmanager.types.list_relays_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.list_relays_request.ListRelaysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.list_relays_request.serialize_aws_json_1_0(input_)
    ).encode()
...
def list_relays(
    ...
    aws_sdk_mailmanager.types.list_relays_response.ListRelaysResponse, zapros.Response
]:
