"""Generated from Smithy shape ``com.amazonaws.mailmanager#CreateIngressPoint``."""
...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.create_ingress_point_response.CreateIngressPointResponse = aws_sdk_mailmanager.types.create_ingress_point_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.create_ingress_point_request.CreateIngressPointRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "MailManagerSvc.CreateIngressPoint"
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.create_ingress_point_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_ingress_point(
