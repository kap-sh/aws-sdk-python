...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.delete_traffic_policy_response.DeleteTrafficPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.delete_traffic_policy_request.DeleteTrafficPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.delete_traffic_policy_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
