...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.start_archive_export_response.StartArchiveExportResponse = aws_sdk_mailmanager.types.start_archive_export_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.start_archive_export_request.StartArchiveExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.start_archive_export_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
