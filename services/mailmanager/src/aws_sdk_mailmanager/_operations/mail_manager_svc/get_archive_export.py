...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.get_archive_export_response.GetArchiveExportResponse = aws_sdk_mailmanager.types.get_archive_export_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.get_archive_export_request.GetArchiveExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.get_archive_export_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
