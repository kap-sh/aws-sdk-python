...
import aws_sdk_mailmanager.types.address_lists
...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.list_address_lists_response.ListAddressListsResponse = aws_sdk_mailmanager.types.list_address_lists_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.list_address_lists_request.ListAddressListsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.list_address_lists_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
