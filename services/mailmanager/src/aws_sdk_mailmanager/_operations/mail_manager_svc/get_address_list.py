...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.get_address_list_response.GetAddressListResponse = (
        aws_sdk_mailmanager.types.get_address_list_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input: aws_sdk_mailmanager.types.get_address_list_request.GetAddressListRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.get_address_list_request.serialize_aws_json_1_0(input)
    ).encode()
