...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.get_address_list_request.GetAddressListRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.get_address_list_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
