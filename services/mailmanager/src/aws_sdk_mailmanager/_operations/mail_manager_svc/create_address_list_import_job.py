"""Generated from Smithy shape ``com.amazonaws.mailmanager#CreateAddressListImportJob``."""
...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.create_address_list_import_job_response.CreateAddressListImportJobResponse = aws_sdk_mailmanager.types.create_address_list_import_job_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.create_address_list_import_job_request.CreateAddressListImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "MailManagerSvc.CreateAddressListImportJob"
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.create_address_list_import_job_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_create_address_list_import_job(
