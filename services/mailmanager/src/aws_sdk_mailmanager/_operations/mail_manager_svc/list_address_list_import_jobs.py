...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.list_address_list_import_jobs_response.ListAddressListImportJobsResponse = aws_sdk_mailmanager.types.list_address_list_import_jobs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.list_address_list_import_jobs_request.ListAddressListImportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.list_address_list_import_jobs_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
