...
def handle_response(
    ...
    out: aws_sdk_mailmanager.types.get_archive_search_response.GetArchiveSearchResponse = aws_sdk_mailmanager.types.get_archive_search_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    input_: aws_sdk_mailmanager.types.get_archive_search_request.GetArchiveSearchRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_mailmanager.types.get_archive_search_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
