...
class MailManagerError(Exception):
    """Base class for all MailManager service errors."""


class ServiceError(MailManagerError):
...
class SerializationError(MailManagerError):
    """Raised when a value cannot be serialized."""


class DeserializationError(MailManagerError):
...
class WaiterFailedError(MailManagerError):
...
class WaiterTimeoutError(MailManagerError):
