...
from capo_mailmanager._resources.mail_manager_svc.relay_resource import RelayResource
...
from capo_mailmanager._services._aws_config import aws_config
...
class MailManagerClientConfig(TypedDict, total=False, closed=True):
...
class MailManagerClient:
    ...
    def create_address_list_import_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.create_address_list_import_job_request.CreateAddressListImportJobRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.create_address_list_import_job_response.CreateAddressListImportJobResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.create_address_list_import_job.create_address_list_import_job(
    ...
    def deregister_member_from_address_list(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.deregister_member_from_address_list_request.DeregisterMemberFromAddressListRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.deregister_member_from_address_list_response.DeregisterMemberFromAddressListResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.deregister_member_from_address_list.deregister_member_from_address_list(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_address_list_import_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.get_address_list_import_job_request.GetAddressListImportJobRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.get_address_list_import_job_response.GetAddressListImportJobResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.get_address_list_import_job.get_address_list_import_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_archive_export(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.get_archive_export_request.GetArchiveExportRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.get_archive_export_response.GetArchiveExportResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.get_archive_export.get_archive_export(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_archive_message(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.get_archive_message_request.GetArchiveMessageRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.get_archive_message_response.GetArchiveMessageResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.get_archive_message.get_archive_message(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_archive_message_content(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.get_archive_message_content_request.GetArchiveMessageContentRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.get_archive_message_content_response.GetArchiveMessageContentResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.get_archive_message_content.get_archive_message_content(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_archive_search(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.get_archive_search_request.GetArchiveSearchRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.get_archive_search_response.GetArchiveSearchResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.get_archive_search.get_archive_search(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_archive_search_results(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.get_archive_search_results_request.GetArchiveSearchResultsRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.get_archive_search_results_response.GetArchiveSearchResultsResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.get_archive_search_results.get_archive_search_results(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_member_of_address_list(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.get_member_of_address_list_request.GetMemberOfAddressListRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.get_member_of_address_list_response.GetMemberOfAddressListResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.get_member_of_address_list.get_member_of_address_list(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_address_list_import_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.list_address_list_import_jobs_request.ListAddressListImportJobsRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.list_address_list_import_jobs_response.ListAddressListImportJobsResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.list_address_list_import_jobs.list_address_list_import_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_address_list_import_jobs(
        ...
        *,
        ...
        page_size: Optional["capo_mailmanager.types.page_size.PageSize"] = None,
    ) -> "Iterator[capo_mailmanager.types.import_job.ImportJob]":
        _token = next_token
        while True:
    ...
    def list_archive_exports(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.list_archive_exports_request.ListArchiveExportsRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.list_archive_exports_response.ListArchiveExportsResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.list_archive_exports.list_archive_exports(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_archive_exports(
        ...
        *,
        ...
        page_size: Optional["capo_mailmanager.types.page_size.PageSize"] = None,
    ) -> "Iterator[capo_mailmanager.types.export_summary.ExportSummary]":
        _token = next_token
        while True:
    ...
    def list_archive_searches(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.list_archive_searches_request.ListArchiveSearchesRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.list_archive_searches_response.ListArchiveSearchesResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.list_archive_searches.list_archive_searches(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_archive_searches(
        ...
        *,
        ...
        page_size: Optional["capo_mailmanager.types.page_size.PageSize"] = None,
    ) -> "Iterator[capo_mailmanager.types.search_summary.SearchSummary]":
        _token = next_token
        while True:
    ...
    def list_members_of_address_list(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.list_members_of_address_list_request.ListMembersOfAddressListRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.list_members_of_address_list_response.ListMembersOfAddressListResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.list_members_of_address_list.list_members_of_address_list(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_mailmanager.types.saved_address.SavedAddress]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_member_to_address_list(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.register_member_to_address_list_request.RegisterMemberToAddressListRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.register_member_to_address_list_response.RegisterMemberToAddressListResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.register_member_to_address_list.register_member_to_address_list(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_address_list_import_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.start_address_list_import_job_request.StartAddressListImportJobRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.start_address_list_import_job_response.StartAddressListImportJobResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.start_address_list_import_job.start_address_list_import_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_archive_export(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.start_archive_export_request.StartArchiveExportRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.start_archive_export_response.StartArchiveExportResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.start_archive_export.start_archive_export(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_archive_search(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.start_archive_search_request.StartArchiveSearchRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.start_archive_search_response.StartArchiveSearchResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.start_archive_search.start_archive_search(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_address_list_import_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.stop_address_list_import_job_request.StopAddressListImportJobRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.stop_address_list_import_job_response.StopAddressListImportJobResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.stop_address_list_import_job.stop_address_list_import_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_archive_export(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.stop_archive_export_request.StopArchiveExportRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.stop_archive_export_response.StopArchiveExportResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.stop_archive_export.stop_archive_export(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_archive_search(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.stop_archive_search_request.StopArchiveSearchRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.stop_archive_search_response.StopArchiveSearchResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.stop_archive_search.stop_archive_search(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mailmanager.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_mailmanager.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_mailmanager._operations.mail_manager_svc.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
