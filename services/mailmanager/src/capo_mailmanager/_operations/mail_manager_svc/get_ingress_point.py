...
def handle_response(
    ...
    out: capo_mailmanager.types.get_ingress_point_response.GetIngressPointResponse = (
        capo_mailmanager.types.get_ingress_point_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mailmanager.types.get_ingress_point_request.serialize_aws_json_1_0(input_)
    ).encode()
