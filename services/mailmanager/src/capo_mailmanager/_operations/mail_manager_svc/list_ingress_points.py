"""Generated from Smithy shape ``com.amazonaws.mailmanager#ListIngressPoints``."""
...
def handle_response(
    ...
    out: capo_mailmanager.types.list_ingress_points_response.ListIngressPointsResponse = capo_mailmanager.types.list_ingress_points_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "MailManagerSvc.ListIngressPoints"
    body: bytes | None = json.dumps(
        capo_mailmanager.types.list_ingress_points_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
...
async def async_list_ingress_points(
