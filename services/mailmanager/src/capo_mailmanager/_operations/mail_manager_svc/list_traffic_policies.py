"""Generated from Smithy shape ``com.amazonaws.mailmanager#ListTrafficPolicies``."""
...
def handle_response(
    ...
    out: capo_mailmanager.types.list_traffic_policies_response.ListTrafficPoliciesResponse = capo_mailmanager.types.list_traffic_policies_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "MailManagerSvc.ListTrafficPolicies"
    body: bytes | None = json.dumps(
        capo_mailmanager.types.list_traffic_policies_request.serialize_aws_json_1_0(
            input_
        )
    ).encode()
