...
class DbClusterSummary(TypedDict, closed=True):
    id: "capo_timestream_influxdb.types.db_cluster_id.DbClusterId"
    ...
    status: NotRequired["capo_timestream_influxdb.types.cluster_status.ClusterStatus"]
