...
from capo_timestream_influxdb._services._aws_config import aws_config
...
class TimestreamInfluxDBClientConfig(TypedDict, total=False, closed=True):
...
class TimestreamInfluxDBClient:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_influxdb.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_timestream_influxdb.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_timestream_influxdb._operations.amazon_timestream_influx_db.list_tags_for_resource.list_tags_for_resource(
        ...
        input_: capo_timestream_influxdb.types.list_tags_for_resource_request.ListTagsForResourceRequest = {}  # type: ignore[typeddict-item]
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_influxdb.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[None]:
            import capo_timestream_influxdb._operations.amazon_timestream_influx_db.tag_resource

            output, http_response = (
                capo_timestream_influxdb._operations.amazon_timestream_influx_db.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_timestream_influxdb.types.tag_resource_request.TagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
        input_["tags"] = tags
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_influxdb.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[None]:
            import capo_timestream_influxdb._operations.amazon_timestream_influx_db.untag_resource

            output, http_response = (
                capo_timestream_influxdb._operations.amazon_timestream_influx_db.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_timestream_influxdb.types.untag_resource_request.UntagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
