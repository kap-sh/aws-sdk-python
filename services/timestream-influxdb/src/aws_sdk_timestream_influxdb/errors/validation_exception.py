...
def serialize_aws_json_1_0(value: ValidationException_) -> dict:
    ...
    out["reason"] = (
        aws_sdk_timestream_influxdb.types.validation_exception_reason.serialize_aws_json_1_0(
            value["reason"]
        )
    )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> ValidationException_:
    ...
    if "reason" in data:
        ...
        out["reason"] = (
            aws_sdk_timestream_influxdb.types.validation_exception_reason.deserialize_aws_json_1_0(
                data["reason"]
            )
        )
    else:
