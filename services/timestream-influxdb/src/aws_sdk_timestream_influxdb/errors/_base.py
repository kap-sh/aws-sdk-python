...
class TimestreamInfluxDBError(Exception):
    """Base class for all TimestreamInfluxDB service errors."""

class ServiceError(TimestreamInfluxDBError):
...
class SerializationError(TimestreamInfluxDBError):
    """Raised when a value cannot be serialized."""

class DeserializationError(TimestreamInfluxDBError):
...
class WaiterFailedError(TimestreamInfluxDBError):
...
class WaiterTimeoutError(TimestreamInfluxDBError):
