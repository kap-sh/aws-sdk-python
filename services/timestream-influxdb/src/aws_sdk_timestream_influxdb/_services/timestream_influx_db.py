...
from aws_sdk_timestream_influxdb._services._pipeline import Interceptor, OperationOptions, OperationRequest, OperationResponse, execute_pipeline, retry
import time
...
class TimestreamInfluxDBClient:
    ...
    def list_tags_for_resource(self, resource_arn: "aws_sdk_timestream_influxdb.types.arn.Arn", *, config_overrides: Optional[TimestreamInfluxDBClientConfig] = None) -> "aws_sdk_timestream_influxdb.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        """<p>A list of tags applied to the resource.</p>

        Args:
            resource_arn: <p>The Amazon Resource Name (ARN) of the tagged resource.</p>
        """
        def _handler(req: 'OperationRequest[aws_sdk_timestream_influxdb.types.list_tags_for_resource_request.ListTagsForResourceRequest]') -> OperationResponse["aws_sdk_timestream_influxdb.types.list_tags_for_resource_response.ListTagsForResourceResponse"]:
            import aws_sdk_timestream_influxdb._operations.amazon_timestream_influx_db.list_tags_for_resource
            output, http_response = aws_sdk_timestream_influxdb._operations.amazon_timestream_influx_db.list_tags_for_resource.list_tags_for_resource(req.options, req.input)
    ...
    def tag_resource(self, resource_arn: "aws_sdk_timestream_influxdb.types.arn.Arn", tags: "aws_sdk_timestream_influxdb.types.request_tag_map.RequestTagMap", *, config_overrides: Optional[TimestreamInfluxDBClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_timestream_influxdb.types.tag_resource_request.TagResourceRequest]') -> OperationResponse[None]:
            import aws_sdk_timestream_influxdb._operations.amazon_timestream_influx_db.tag_resource
            output, http_response = aws_sdk_timestream_influxdb._operations.amazon_timestream_influx_db.tag_resource.tag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
        ...
        response = execute_pipeline(OperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    def untag_resource(self, resource_arn: "aws_sdk_timestream_influxdb.types.arn.Arn", tag_keys: "aws_sdk_timestream_influxdb.types.tag_keys.TagKeys", *, config_overrides: Optional[TimestreamInfluxDBClientConfig] = None) -> None:
        ...
        """
        def _handler(req: 'OperationRequest[aws_sdk_timestream_influxdb.types.untag_resource_request.UntagResourceRequest]') -> OperationResponse[None]:
            import aws_sdk_timestream_influxdb._operations.amazon_timestream_influx_db.untag_resource
            output, http_response = aws_sdk_timestream_influxdb._operations.amazon_timestream_influx_db.untag_resource.untag_resource(req.options, req.input)
            return OperationResponse(output=output, response=http_response)
