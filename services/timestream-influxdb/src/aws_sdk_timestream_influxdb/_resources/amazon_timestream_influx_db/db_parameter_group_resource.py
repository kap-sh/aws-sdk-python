...
class DbParameterGroupResource:
    ...
    def create(
        self,
        name: "aws_sdk_timestream_influxdb.types.db_parameter_group_name.DbParameterGroupName",
        *,
        config_overrides: Optional[TimestreamInfluxDBClientConfig] = None,
        description: Optional[str] = None,
        parameters: Optional[
            "aws_sdk_timestream_influxdb.types.parameters.Parameters"
        ] = None,
        tags: Optional[
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_influxdb.types.create_db_parameter_group_input.CreateDbParameterGroupInput]",
        ) -> OperationResponse[
            "aws_sdk_timestream_influxdb.types.create_db_parameter_group_output.CreateDbParameterGroupOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_influxdb._operations.amazon_timestream_influx_db.create_db_parameter_group.create_db_parameter_group(
    ...
    def read(
        ...
        *,
        config_overrides: Optional[TimestreamInfluxDBClientConfig] = None,
    ) -> "aws_sdk_timestream_influxdb.types.get_db_parameter_group_output.GetDbParameterGroupOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_influxdb.types.get_db_parameter_group_input.GetDbParameterGroupInput]",
        ) -> OperationResponse[
            "aws_sdk_timestream_influxdb.types.get_db_parameter_group_output.GetDbParameterGroupOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_influxdb._operations.amazon_timestream_influx_db.get_db_parameter_group.get_db_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
    ...
    ) -> "aws_sdk_timestream_influxdb.types.list_db_parameter_groups_output.ListDbParameterGroupsOutput":
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_timestream_influxdb.types.list_db_parameter_groups_input.ListDbParameterGroupsInput]",
        ) -> OperationResponse[
            "aws_sdk_timestream_influxdb.types.list_db_parameter_groups_output.ListDbParameterGroupsOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_timestream_influxdb._operations.amazon_timestream_influx_db.list_db_parameter_groups.list_db_parameter_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
...
class AsyncDbParameterGroupResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_influxdb.types.create_db_parameter_group_input.CreateDbParameterGroupInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_timestream_influxdb.types.create_db_parameter_group_output.CreateDbParameterGroupOutput"
        ]:
            import aws_sdk_timestream_influxdb._operations.amazon_timestream_influx_db.create_db_parameter_group
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_influxdb._operations.amazon_timestream_influx_db.create_db_parameter_group.async_create_db_parameter_group(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_influxdb.types.get_db_parameter_group_input.GetDbParameterGroupInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_timestream_influxdb.types.get_db_parameter_group_output.GetDbParameterGroupOutput"
        ]:
            import aws_sdk_timestream_influxdb._operations.amazon_timestream_influx_db.get_db_parameter_group
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_influxdb._operations.amazon_timestream_influx_db.get_db_parameter_group.async_get_db_parameter_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[aws_sdk_timestream_influxdb.types.list_db_parameter_groups_input.ListDbParameterGroupsInput]",
        ) -> AsyncOperationResponse[
            "aws_sdk_timestream_influxdb.types.list_db_parameter_groups_output.ListDbParameterGroupsOutput"
        ]:
            import aws_sdk_timestream_influxdb._operations.amazon_timestream_influx_db.list_db_parameter_groups
            ...
            (
                output,
                http_response,
            ) = await aws_sdk_timestream_influxdb._operations.amazon_timestream_influx_db.list_db_parameter_groups.async_list_db_parameter_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
