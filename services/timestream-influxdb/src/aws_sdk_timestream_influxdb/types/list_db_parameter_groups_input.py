"""Generated from Smithy shape ``com.amazonaws.timestreaminfluxdb#ListDbParameterGroupsInput``."""
...
class ListDbParameterGroupsInput(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListDbParameterGroupsInput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> ListDbParameterGroupsInput:
    out: ListDbParameterGroupsInput = {}  # type: ignore[typeddict-item]
