...
DbClusterSummaryList: TypeAlias = list[
    "aws_sdk_timestream_influxdb.types.db_cluster_summary.DbClusterSummary"
]
...
def serialize_aws_json_1_0(value: DbClusterSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_timestream_influxdb.types.db_cluster_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> DbClusterSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_timestream_influxdb.types.db_cluster_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
