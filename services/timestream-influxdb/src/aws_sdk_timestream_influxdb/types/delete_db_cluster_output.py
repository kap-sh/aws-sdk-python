"""Generated from Smithy shape ``com.amazonaws.timestreaminfluxdb#DeleteDbClusterOutput``."""
...
class DeleteDbClusterOutput(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DeleteDbClusterOutput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> DeleteDbClusterOutput:
    out: DeleteDbClusterOutput = {}  # type: ignore[typeddict-item]
