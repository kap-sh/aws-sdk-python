...
DbInstanceForClusterSummaryList: TypeAlias = list[
    "aws_sdk_timestream_influxdb.types.db_instance_for_cluster_summary.DbInstanceForClusterSummary"
]
...
def serialize_aws_json_1_0(value: DbInstanceForClusterSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_timestream_influxdb.types.db_instance_for_cluster_summary.serialize_aws_json_1_0(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: list) -> DbInstanceForClusterSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_timestream_influxdb.types.db_instance_for_cluster_summary.deserialize_aws_json_1_0(
                item
            )
        )
    return out
