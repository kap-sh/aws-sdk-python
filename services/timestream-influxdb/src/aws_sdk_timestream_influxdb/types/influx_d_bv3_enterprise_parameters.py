...
class InfluxDBv3EnterpriseParameters(TypedDict):
...
def deserialize_aws_json_1_0(data: dict) -> InfluxDBv3EnterpriseParameters:
    ...
    if "compactionMultipliers" in data:
        out["compaction_multipliers"] = data["compactionMultipliers"]
    if "compactionCleanupWait" in data:
        import aws_sdk_timestream_influxdb.types.duration
    ...
    if "compactionCheckInterval" in data:
        import aws_sdk_timestream_influxdb.types.duration
    ...
    if "catalogSyncInterval" in data:
        import aws_sdk_timestream_influxdb.types.duration
