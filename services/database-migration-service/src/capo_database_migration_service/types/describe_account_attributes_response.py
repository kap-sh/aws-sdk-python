...
class DescribeAccountAttributesResponse(TypedDict, closed=True):
    account_quotas: NotRequired[
        "capo_database_migration_service.types.account_quota_list.AccountQuotaList"
    ]
...
def serialize_aws_json_1_1(value: DescribeAccountAttributesResponse) -> dict:
    ...
    if "account_quotas" in value:
        ...
        out["AccountQuotas"] = (
            capo_database_migration_service.types.account_quota_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeAccountAttributesResponse:
    ...
    if "AccountQuotas" in data:
        ...
        out["account_quotas"] = (
            capo_database_migration_service.types.account_quota_list.deserialize_aws_json_1_1(
                data["AccountQuotas"]
            )
        )
