...
class DescribeRecommendationsResponse(TypedDict, closed=True):
    ...
    recommendations: NotRequired[
        "capo_database_migration_service.types.recommendation_list.RecommendationList"
    ]
...
def serialize_aws_json_1_1(value: DescribeRecommendationsResponse) -> dict:
    ...
    if "recommendations" in value:
        ...
        out["Recommendations"] = (
            capo_database_migration_service.types.recommendation_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeRecommendationsResponse:
    ...
    if "Recommendations" in data:
        ...
        out["recommendations"] = (
            capo_database_migration_service.types.recommendation_list.deserialize_aws_json_1_1(
