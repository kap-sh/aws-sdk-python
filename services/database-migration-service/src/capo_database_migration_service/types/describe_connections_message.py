"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeConnectionsMessage``."""
...
class DescribeConnectionsMessage(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeConnectionsMessage) -> dict:
    out: dict = {}
    if "filters" in value:
        import capo_database_migration_service.types.filter_list
...
def deserialize_aws_json_1_1(data: dict) -> DescribeConnectionsMessage:
    out: DescribeConnectionsMessage = {}  # type: ignore[typeddict-item]
    if "Filters" in data:
        import capo_database_migration_service.types.filter_list
