...
if TYPE_CHECKING:
    import capo_database_migration_service.types.replication_task_assessment_run_list
...
class DescribeReplicationTaskAssessmentRunsResponse(TypedDict, closed=True):
    ...
    replication_task_assessment_runs: NotRequired[
        "capo_database_migration_service.types.replication_task_assessment_run_list.ReplicationTaskAssessmentRunList"
    ]
...
def serialize_aws_json_1_1(
    ...
    if "replication_task_assessment_runs" in value:
        ...
        out["ReplicationTaskAssessmentRuns"] = (
            capo_database_migration_service.types.replication_task_assessment_run_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "ReplicationTaskAssessmentRuns" in data:
        ...
        out["replication_task_assessment_runs"] = (
            capo_database_migration_service.types.replication_task_assessment_run_list.deserialize_aws_json_1_1(
