"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#StartReplicationTaskAssessmentResponse``."""
...
class StartReplicationTaskAssessmentResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StartReplicationTaskAssessmentResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> StartReplicationTaskAssessmentResponse:
    out: StartReplicationTaskAssessmentResponse = {}  # type: ignore[typeddict-item]
