...
class ExportMetadataModelAssessmentResponse(TypedDict, closed=True):
    pdf_report: NotRequired[
        "capo_database_migration_service.types.export_metadata_model_assessment_result_entry.ExportMetadataModelAssessmentResultEntry"
    ]
...
def serialize_aws_json_1_1(value: ExportMetadataModelAssessmentResponse) -> dict:
    ...
    if "pdf_report" in value:
        ...
        out["PdfReport"] = (
            capo_database_migration_service.types.export_metadata_model_assessment_result_entry.serialize_aws_json_1_1(
                value["pdf_report"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ExportMetadataModelAssessmentResponse:
    ...
    if "PdfReport" in data:
        ...
        out["pdf_report"] = (
            capo_database_migration_service.types.export_metadata_model_assessment_result_entry.deserialize_aws_json_1_1(
                data["PdfReport"]
            )
        )
