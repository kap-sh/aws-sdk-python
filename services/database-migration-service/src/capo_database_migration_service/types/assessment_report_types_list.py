...
if TYPE_CHECKING:
    import capo_database_migration_service.types.assessment_report_type

AssessmentReportTypesList: TypeAlias = list[
    "capo_database_migration_service.types.assessment_report_type.AssessmentReportType"
]
...
def serialize_aws_json_1_1(value: AssessmentReportTypesList) -> list:
    ...
    for item in value:
        out.append(
            capo_database_migration_service.types.assessment_report_type.serialize_aws_json_1_1(
                item
            )
        )
    return out
