"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DeleteInstanceProfileResponse``."""
...
class DeleteInstanceProfileResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteInstanceProfileResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeleteInstanceProfileResponse:
    out: DeleteInstanceProfileResponse = {}  # type: ignore[typeddict-item]
