"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#MoveReplicationTaskResponse``."""
...
class MoveReplicationTaskResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: MoveReplicationTaskResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> MoveReplicationTaskResponse:
    out: MoveReplicationTaskResponse = {}  # type: ignore[typeddict-item]
