"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeRecommendationsRequest``."""
...
class DescribeRecommendationsRequest(TypedDict, closed=True):
    filters: NotRequired["capo_database_migration_service.types.filter_list.FilterList"]
    """<p>Filters applied to the target engine recommendations described in the form of key-value pairs.</p> <p>Valid filter names: <code>database-id</code> | <code>engine-name</code> </p>"""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeRecommendationsRequest) -> dict:
    out: dict = {}
    if "filters" in value:
        import capo_database_migration_service.types.filter_list
...
def deserialize_aws_json_1_1(data: dict) -> DescribeRecommendationsRequest:
    out: DescribeRecommendationsRequest = {}  # type: ignore[typeddict-item]
    if "Filters" in data:
        import capo_database_migration_service.types.filter_list
