"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#CreateEndpoint``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.create_endpoint_response.CreateEndpointResponse = capo_database_migration_service.types.create_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.create_endpoint_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
