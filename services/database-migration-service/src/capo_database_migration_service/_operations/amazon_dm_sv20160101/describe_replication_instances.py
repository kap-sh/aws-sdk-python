"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeReplicationInstances``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_replication_instances_response.DescribeReplicationInstancesResponse = capo_database_migration_service.types.describe_replication_instances_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_replication_instances_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_replication_instances(
