...
import capo_database_migration_service.types.event_category_group_list
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_event_categories_response.DescribeEventCategoriesResponse = capo_database_migration_service.types.describe_event_categories_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_event_categories_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
