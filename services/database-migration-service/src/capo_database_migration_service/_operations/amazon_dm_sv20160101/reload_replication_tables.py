"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#ReloadReplicationTables``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.reload_replication_tables_response.ReloadReplicationTablesResponse = capo_database_migration_service.types.reload_replication_tables_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.ReloadReplicationTables"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.reload_replication_tables_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_reload_replication_tables(
