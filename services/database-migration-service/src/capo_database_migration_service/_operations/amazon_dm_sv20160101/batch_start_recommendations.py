"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#BatchStartRecommendations``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.batch_start_recommendations_response.BatchStartRecommendationsResponse = capo_database_migration_service.types.batch_start_recommendations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.batch_start_recommendations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_batch_start_recommendations(
