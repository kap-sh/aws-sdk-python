"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DeleteReplicationTaskAssessmentRun``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.delete_replication_task_assessment_run_response.DeleteReplicationTaskAssessmentRunResponse = capo_database_migration_service.types.delete_replication_task_assessment_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DeleteReplicationTaskAssessmentRun"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.delete_replication_task_assessment_run_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_replication_task_assessment_run(
