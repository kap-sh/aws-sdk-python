...
def handle_response(
    ...
    out: capo_database_migration_service.types.add_tags_to_resource_response.AddTagsToResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.add_tags_to_resource_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
