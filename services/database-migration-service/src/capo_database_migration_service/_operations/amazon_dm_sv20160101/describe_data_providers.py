...
import capo_database_migration_service.types.data_provider_list
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_data_providers_response.DescribeDataProvidersResponse = capo_database_migration_service.types.describe_data_providers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_data_providers_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
