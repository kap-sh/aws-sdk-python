"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeRecommendationLimitations``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_recommendation_limitations_response.DescribeRecommendationLimitationsResponse = capo_database_migration_service.types.describe_recommendation_limitations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_recommendation_limitations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_recommendation_limitations(
