"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#CreateReplicationSubnetGroup``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.create_replication_subnet_group_response.CreateReplicationSubnetGroupResponse = capo_database_migration_service.types.create_replication_subnet_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.create_replication_subnet_group_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_replication_subnet_group(
