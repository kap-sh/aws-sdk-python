...
def handle_response(
    ...
    out: capo_database_migration_service.types.remove_tags_from_resource_response.RemoveTagsFromResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.remove_tags_from_resource_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
