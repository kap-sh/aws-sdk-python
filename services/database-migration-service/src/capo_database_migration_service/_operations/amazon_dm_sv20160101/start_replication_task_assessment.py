"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#StartReplicationTaskAssessment``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.start_replication_task_assessment_response.StartReplicationTaskAssessmentResponse = capo_database_migration_service.types.start_replication_task_assessment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.start_replication_task_assessment_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_replication_task_assessment(
