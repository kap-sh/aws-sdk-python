...
def handle_response(
    ...
    out: capo_database_migration_service.types.delete_instance_profile_response.DeleteInstanceProfileResponse = capo_database_migration_service.types.delete_instance_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.delete_instance_profile_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
