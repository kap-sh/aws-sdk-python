"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#CreateMigrationProject``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.create_migration_project_response.CreateMigrationProjectResponse = capo_database_migration_service.types.create_migration_project_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.create_migration_project_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_migration_project(
