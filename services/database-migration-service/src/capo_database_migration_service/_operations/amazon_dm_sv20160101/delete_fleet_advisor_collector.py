"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DeleteFleetAdvisorCollector``."""
...
import capo_database_migration_service.errors.collector_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CollectorNotFoundFault":
            raise capo_database_migration_service.errors.collector_not_found_fault.CollectorNotFoundFault.from_aws_json_1_1(
                data
            )
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DeleteFleetAdvisorCollector"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.delete_collector_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_fleet_advisor_collector(
