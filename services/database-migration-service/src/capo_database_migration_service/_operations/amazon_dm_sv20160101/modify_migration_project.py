"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#ModifyMigrationProject``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.modify_migration_project_response.ModifyMigrationProjectResponse = capo_database_migration_service.types.modify_migration_project_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.ModifyMigrationProject"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.modify_migration_project_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_modify_migration_project(
