"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#TestConnection``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.test_connection_response.TestConnectionResponse = capo_database_migration_service.types.test_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.test_connection_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
