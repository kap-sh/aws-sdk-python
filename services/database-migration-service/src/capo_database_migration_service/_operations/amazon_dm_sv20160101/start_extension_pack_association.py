"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#StartExtensionPackAssociation``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.start_extension_pack_association_response.StartExtensionPackAssociationResponse = capo_database_migration_service.types.start_extension_pack_association_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.StartExtensionPackAssociation"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.start_extension_pack_association_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_extension_pack_association(
