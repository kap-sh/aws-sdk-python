"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#CreateInstanceProfile``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.create_instance_profile_response.CreateInstanceProfileResponse = capo_database_migration_service.types.create_instance_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.CreateInstanceProfile"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.create_instance_profile_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
