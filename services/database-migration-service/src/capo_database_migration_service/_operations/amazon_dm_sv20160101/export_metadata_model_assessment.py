"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#ExportMetadataModelAssessment``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.export_metadata_model_assessment_response.ExportMetadataModelAssessmentResponse = capo_database_migration_service.types.export_metadata_model_assessment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.ExportMetadataModelAssessment"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.export_metadata_model_assessment_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_export_metadata_model_assessment(
