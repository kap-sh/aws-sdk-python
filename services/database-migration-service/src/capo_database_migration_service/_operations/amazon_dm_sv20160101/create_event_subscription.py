...
import capo_database_migration_service.errors.kms_throttling_fault
...
import capo_database_migration_service.errors.sns_invalid_topic_fault
import capo_database_migration_service.errors.sns_no_authorization_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "KMSThrottlingFault":
            raise capo_database_migration_service.errors.kms_throttling_fault.KMSThrottlingFault.from_aws_json_1_1(
                data
            )
        ...
        case "SNSInvalidTopicFault":
            raise capo_database_migration_service.errors.sns_invalid_topic_fault.SNSInvalidTopicFault.from_aws_json_1_1(
                data
            )
        case "SNSNoAuthorizationFault":
            raise capo_database_migration_service.errors.sns_no_authorization_fault.SNSNoAuthorizationFault.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_database_migration_service.types.create_event_subscription_response.CreateEventSubscriptionResponse = capo_database_migration_service.types.create_event_subscription_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.create_event_subscription_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
