...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_metadata_model_exports_as_script_response.DescribeMetadataModelExportsAsScriptResponse = capo_database_migration_service.types.describe_metadata_model_exports_as_script_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_metadata_model_exports_as_script_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
