"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeMetadataModelExportsToTarget``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_metadata_model_exports_to_target_response.DescribeMetadataModelExportsToTargetResponse = capo_database_migration_service.types.describe_metadata_model_exports_to_target_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeMetadataModelExportsToTarget"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_metadata_model_exports_to_target_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_metadata_model_exports_to_target(
