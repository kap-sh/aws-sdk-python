"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeEndpointTypes``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_endpoint_types_response.DescribeEndpointTypesResponse = capo_database_migration_service.types.describe_endpoint_types_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_endpoint_types_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_endpoint_types(
