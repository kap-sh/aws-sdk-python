"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#StartReplicationTaskAssessmentRun``."""
...
import capo_database_migration_service.errors.kms_access_denied_fault
import capo_database_migration_service.errors.kms_disabled_fault
import capo_database_migration_service.errors.kms_fault
import capo_database_migration_service.errors.kms_invalid_state_fault
import capo_database_migration_service.errors.kms_key_not_accessible_fault
import capo_database_migration_service.errors.kms_not_found_fault
...
import capo_database_migration_service.errors.s3_access_denied_fault
import capo_database_migration_service.errors.s3_resource_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "KMSAccessDeniedFault":
            raise capo_database_migration_service.errors.kms_access_denied_fault.KMSAccessDeniedFault.from_aws_json_1_1(
                data
            )
        case "KMSDisabledFault":
            raise capo_database_migration_service.errors.kms_disabled_fault.KMSDisabledFault.from_aws_json_1_1(
                data
            )
        case "KMSFault":
            raise capo_database_migration_service.errors.kms_fault.KMSFault.from_aws_json_1_1(
                data
            )
        case "KMSInvalidStateFault":
            raise capo_database_migration_service.errors.kms_invalid_state_fault.KMSInvalidStateFault.from_aws_json_1_1(
                data
            )
        case "KMSKeyNotAccessibleFault":
            raise capo_database_migration_service.errors.kms_key_not_accessible_fault.KMSKeyNotAccessibleFault.from_aws_json_1_1(
                data
            )
        case "KMSNotFoundFault":
            raise capo_database_migration_service.errors.kms_not_found_fault.KMSNotFoundFault.from_aws_json_1_1(
                data
            )
        ...
        case "S3AccessDeniedFault":
            raise capo_database_migration_service.errors.s3_access_denied_fault.S3AccessDeniedFault.from_aws_json_1_1(
                data
            )
        case "S3ResourceNotFoundFault":
            raise capo_database_migration_service.errors.s3_resource_not_found_fault.S3ResourceNotFoundFault.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_database_migration_service.types.start_replication_task_assessment_run_response.StartReplicationTaskAssessmentRunResponse = capo_database_migration_service.types.start_replication_task_assessment_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.StartReplicationTaskAssessmentRun"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.start_replication_task_assessment_run_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_replication_task_assessment_run(
