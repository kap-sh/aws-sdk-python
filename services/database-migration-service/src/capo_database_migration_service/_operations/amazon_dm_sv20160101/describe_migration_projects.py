...
import capo_database_migration_service.types.migration_project_list
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_migration_projects_response.DescribeMigrationProjectsResponse = capo_database_migration_service.types.describe_migration_projects_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_migration_projects_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
