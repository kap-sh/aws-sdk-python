...
import capo_database_migration_service.errors.invalid_operation_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidOperationFault":
            raise capo_database_migration_service.errors.invalid_operation_fault.InvalidOperationFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_database_migration_service.types.create_data_migration_response.CreateDataMigrationResponse = capo_database_migration_service.types.create_data_migration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.create_data_migration_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
