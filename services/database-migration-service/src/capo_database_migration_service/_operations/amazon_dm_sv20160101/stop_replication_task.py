"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#StopReplicationTask``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.stop_replication_task_response.StopReplicationTaskResponse = capo_database_migration_service.types.stop_replication_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.stop_replication_task_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_stop_replication_task(
