"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DeleteReplicationInstance``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.delete_replication_instance_response.DeleteReplicationInstanceResponse = capo_database_migration_service.types.delete_replication_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.delete_replication_instance_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_replication_instance(
