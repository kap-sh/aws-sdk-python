...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_fleet_advisor_lsa_analysis_response.DescribeFleetAdvisorLsaAnalysisResponse = capo_database_migration_service.types.describe_fleet_advisor_lsa_analysis_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_fleet_advisor_lsa_analysis_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
