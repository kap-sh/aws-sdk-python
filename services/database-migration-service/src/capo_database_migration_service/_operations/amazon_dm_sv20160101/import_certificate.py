"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#ImportCertificate``."""
...
import capo_database_migration_service.errors.invalid_certificate_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidCertificateFault":
            raise capo_database_migration_service.errors.invalid_certificate_fault.InvalidCertificateFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_database_migration_service.types.import_certificate_response.ImportCertificateResponse = capo_database_migration_service.types.import_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.import_certificate_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
