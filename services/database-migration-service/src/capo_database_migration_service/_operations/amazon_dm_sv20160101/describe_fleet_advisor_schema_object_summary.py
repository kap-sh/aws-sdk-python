...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_fleet_advisor_schema_object_summary_response.DescribeFleetAdvisorSchemaObjectSummaryResponse = capo_database_migration_service.types.describe_fleet_advisor_schema_object_summary_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_fleet_advisor_schema_object_summary_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
