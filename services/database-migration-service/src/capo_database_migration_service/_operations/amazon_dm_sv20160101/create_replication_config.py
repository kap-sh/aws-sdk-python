"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#CreateReplicationConfig``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.create_replication_config_response.CreateReplicationConfigResponse = capo_database_migration_service.types.create_replication_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.CreateReplicationConfig"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.create_replication_config_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_replication_config(
