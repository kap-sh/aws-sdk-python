"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#ModifyReplicationConfig``."""
...
import capo_database_migration_service.errors.invalid_subnet
import capo_database_migration_service.errors.kms_key_not_accessible_fault
import capo_database_migration_service.errors.replication_subnet_group_does_not_cover_enough_a_zs
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidSubnet":
            raise capo_database_migration_service.errors.invalid_subnet.InvalidSubnet.from_aws_json_1_1(
                data
            )
        ...
        case "ReplicationSubnetGroupDoesNotCoverEnoughAZs":
            raise capo_database_migration_service.errors.replication_subnet_group_does_not_cover_enough_a_zs.ReplicationSubnetGroupDoesNotCoverEnoughAZs.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_database_migration_service.types.modify_replication_config_response.ModifyReplicationConfigResponse = capo_database_migration_service.types.modify_replication_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.ModifyReplicationConfig"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.modify_replication_config_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_modify_replication_config(
