"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#StartMetadataModelExportToTarget``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.start_metadata_model_export_to_target_response.StartMetadataModelExportToTargetResponse = capo_database_migration_service.types.start_metadata_model_export_to_target_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.StartMetadataModelExportToTarget"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.start_metadata_model_export_to_target_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_metadata_model_export_to_target(
