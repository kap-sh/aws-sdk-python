...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_replication_instance_task_logs_response.DescribeReplicationInstanceTaskLogsResponse = capo_database_migration_service.types.describe_replication_instance_task_logs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_replication_instance_task_logs_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
