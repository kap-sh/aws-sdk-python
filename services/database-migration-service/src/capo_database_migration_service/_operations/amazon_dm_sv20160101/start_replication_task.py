...
def handle_response(
    ...
    out: capo_database_migration_service.types.start_replication_task_response.StartReplicationTaskResponse = capo_database_migration_service.types.start_replication_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.start_replication_task_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
