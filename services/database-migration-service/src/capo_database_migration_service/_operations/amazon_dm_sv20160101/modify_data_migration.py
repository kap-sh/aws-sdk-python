"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#ModifyDataMigration``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.modify_data_migration_response.ModifyDataMigrationResponse = capo_database_migration_service.types.modify_data_migration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.ModifyDataMigration"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.modify_data_migration_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_modify_data_migration(
