"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeReplicationSubnetGroups``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_replication_subnet_groups_response.DescribeReplicationSubnetGroupsResponse = capo_database_migration_service.types.describe_replication_subnet_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_replication_subnet_groups_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_replication_subnet_groups(
