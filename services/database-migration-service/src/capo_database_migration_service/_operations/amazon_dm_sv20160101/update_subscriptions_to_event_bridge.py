"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#UpdateSubscriptionsToEventBridge``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.update_subscriptions_to_event_bridge_response.UpdateSubscriptionsToEventBridgeResponse = capo_database_migration_service.types.update_subscriptions_to_event_bridge_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.UpdateSubscriptionsToEventBridge"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.update_subscriptions_to_event_bridge_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_subscriptions_to_event_bridge(
