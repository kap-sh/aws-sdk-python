...
def handle_response(
    ...
    out: capo_database_migration_service.types.cancel_replication_task_assessment_run_response.CancelReplicationTaskAssessmentRunResponse = capo_database_migration_service.types.cancel_replication_task_assessment_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.cancel_replication_task_assessment_run_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
