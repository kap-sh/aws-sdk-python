"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeCertificates``."""
...
import capo_database_migration_service.types.certificate_list
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_certificates_response.DescribeCertificatesResponse = capo_database_migration_service.types.describe_certificates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_certificates_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
