"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#CancelMetadataModelCreation``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.cancel_metadata_model_creation_response.CancelMetadataModelCreationResponse = capo_database_migration_service.types.cancel_metadata_model_creation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.CancelMetadataModelCreation"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.cancel_metadata_model_creation_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_cancel_metadata_model_creation(
