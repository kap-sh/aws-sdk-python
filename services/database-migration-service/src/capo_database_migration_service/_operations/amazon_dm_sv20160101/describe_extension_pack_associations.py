"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeExtensionPackAssociations``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_extension_pack_associations_response.DescribeExtensionPackAssociationsResponse = capo_database_migration_service.types.describe_extension_pack_associations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeExtensionPackAssociations"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_extension_pack_associations_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_extension_pack_associations(
