...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_metadata_model_children_response.DescribeMetadataModelChildrenResponse = capo_database_migration_service.types.describe_metadata_model_children_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_metadata_model_children_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
