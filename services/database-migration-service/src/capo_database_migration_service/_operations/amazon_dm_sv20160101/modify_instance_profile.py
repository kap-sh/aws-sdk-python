"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#ModifyInstanceProfile``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.modify_instance_profile_response.ModifyInstanceProfileResponse = capo_database_migration_service.types.modify_instance_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.ModifyInstanceProfile"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.modify_instance_profile_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_modify_instance_profile(
