...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_account_attributes_response.DescribeAccountAttributesResponse = capo_database_migration_service.types.describe_account_attributes_response.deserialize_aws_json_1_1(
