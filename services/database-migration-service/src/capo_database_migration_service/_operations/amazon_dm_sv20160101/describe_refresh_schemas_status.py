"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeRefreshSchemasStatus``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_refresh_schemas_status_response.DescribeRefreshSchemasStatusResponse = capo_database_migration_service.types.describe_refresh_schemas_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_refresh_schemas_status_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_refresh_schemas_status(
