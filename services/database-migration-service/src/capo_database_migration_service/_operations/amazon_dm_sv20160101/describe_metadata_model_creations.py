"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeMetadataModelCreations``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_metadata_model_creations_response.DescribeMetadataModelCreationsResponse = capo_database_migration_service.types.describe_metadata_model_creations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeMetadataModelCreations"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_metadata_model_creations_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_metadata_model_creations(
