...
class DatabaseMigrationServiceError(Exception):
    """Base class for all DatabaseMigrationService service errors."""


class ServiceError(DatabaseMigrationServiceError):
...
class SerializationError(DatabaseMigrationServiceError):
    """Raised when a value cannot be serialized."""


class DeserializationError(DatabaseMigrationServiceError):
...
class WaiterFailedError(DatabaseMigrationServiceError):
...
class WaiterTimeoutError(DatabaseMigrationServiceError):
