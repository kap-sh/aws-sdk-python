"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#SNSInvalidTopicFault``."""
...
class SNSInvalidTopicFault_(TypedDict):
    message: NotRequired[
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: SNSInvalidTopicFault_) -> dict:
    out: dict = {}
    if "message" in value:
...
def deserialize_aws_json_1_1(data: dict) -> SNSInvalidTopicFault_:
...
class SNSInvalidTopicFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.databasemigrationservice#SNSInvalidTopicFault``."""
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "SNSInvalidTopicFault":
