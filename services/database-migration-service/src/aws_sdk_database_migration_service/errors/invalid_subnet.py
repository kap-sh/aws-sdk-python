"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#InvalidSubnet``."""
...
class InvalidSubnet_(TypedDict):
    message: NotRequired[
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: InvalidSubnet_) -> dict:
    out: dict = {}
    if "message" in value:
...
def deserialize_aws_json_1_1(data: dict) -> InvalidSubnet_:
...
class InvalidSubnet(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.databasemigrationservice#InvalidSubnet``."""
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "InvalidSubnet":
