...
class UpgradeDependencyFailureFault_(TypedDict):
    message: NotRequired[
...
class UpgradeDependencyFailureFault(ServiceError):
    ...
    def __init__(self, data: UpgradeDependencyFailureFault_):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "UpgradeDependencyFailureFault":
