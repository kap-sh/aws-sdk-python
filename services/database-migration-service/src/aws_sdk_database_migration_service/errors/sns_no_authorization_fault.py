"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#SNSNoAuthorizationFault``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: SNSNoAuthorizationFault_) -> dict:
    out: dict = {}
    if "message" in value:
...
def deserialize_aws_json_1_1(data: dict) -> SNSNoAuthorizationFault_:
...
class SNSNoAuthorizationFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.databasemigrationservice#SNSNoAuthorizationFault``."""
    ...
    @classmethod
    def from_aws_json_1_1(cls, data: dict) -> "SNSNoAuthorizationFault":
