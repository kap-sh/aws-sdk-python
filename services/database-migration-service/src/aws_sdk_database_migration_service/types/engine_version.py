...
if TYPE_CHECKING:
    import aws_sdk_database_migration_service.types.available_upgrades_list
...
class EngineVersion(TypedDict):
    version: NotRequired["aws_sdk_database_migration_service.types.string.String"]
    """<p>The version number of the replication instance.</p>"""
    lifecycle: NotRequired["aws_sdk_database_migration_service.types.string.String"]
    ...
    launch_date: NotRequired["aws_sdk_database_migration_service.types.t_stamp.TStamp"]
    ...
    available_upgrades: NotRequired[
        "aws_sdk_database_migration_service.types.available_upgrades_list.AvailableUpgradesList"
    ]
...
def serialize_aws_json_1_1(value: EngineVersion) -> dict:
    ...
    if "available_upgrades" in value:
        ...
        out["AvailableUpgrades"] = (
            aws_sdk_database_migration_service.types.available_upgrades_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> EngineVersion:
    ...
    if "AvailableUpgrades" in data:
        ...
        out["available_upgrades"] = (
            aws_sdk_database_migration_service.types.available_upgrades_list.deserialize_aws_json_1_1(
