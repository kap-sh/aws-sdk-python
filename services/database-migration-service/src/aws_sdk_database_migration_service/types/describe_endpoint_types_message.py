"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeEndpointTypesMessage``."""
...
class DescribeEndpointTypesMessage(TypedDict, closed=True):
    filters: NotRequired[
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeEndpointTypesMessage) -> dict:
    out: dict = {}
    if "filters" in value:
        import aws_sdk_database_migration_service.types.filter_list
...
def deserialize_aws_json_1_1(data: dict) -> DescribeEndpointTypesMessage:
    out: DescribeEndpointTypesMessage = {}  # type: ignore[typeddict-item]
    if "Filters" in data:
        import aws_sdk_database_migration_service.types.filter_list
