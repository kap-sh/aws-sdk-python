"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#StopDataMigrationResponse``."""
...
class StopDataMigrationResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StopDataMigrationResponse) -> dict:
    out: dict = {}
