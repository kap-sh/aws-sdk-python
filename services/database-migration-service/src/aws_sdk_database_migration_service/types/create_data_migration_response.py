"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#CreateDataMigrationResponse``."""
...
class CreateDataMigrationResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateDataMigrationResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> CreateDataMigrationResponse:
    out: CreateDataMigrationResponse = {}  # type: ignore[typeddict-item]
