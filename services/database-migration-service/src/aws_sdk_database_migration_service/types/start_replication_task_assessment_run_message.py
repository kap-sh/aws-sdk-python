...
class StartReplicationTaskAssessmentRunMessage(TypedDict):
...
def serialize_aws_json_1_1(value: StartReplicationTaskAssessmentRunMessage) -> dict:
    ...
    if "include_only" in value:
        ...
        out["IncludeOnly"] = (
            aws_sdk_database_migration_service.types.include_test_list.serialize_aws_json_1_1(
                value["include_only"]
            )
        )
    if "exclude" in value:
        ...
        out["Exclude"] = (
            aws_sdk_database_migration_service.types.exclude_test_list.serialize_aws_json_1_1(
                value["exclude"]
            )
        )
    if "tags" in value:
...
def deserialize_aws_json_1_1(data: dict) -> StartReplicationTaskAssessmentRunMessage:
    ...
    if "IncludeOnly" in data:
        ...
        out["include_only"] = (
            aws_sdk_database_migration_service.types.include_test_list.deserialize_aws_json_1_1(
                data["IncludeOnly"]
            )
        )
    if "Exclude" in data:
        ...
        out["exclude"] = (
            aws_sdk_database_migration_service.types.exclude_test_list.deserialize_aws_json_1_1(
                data["Exclude"]
            )
        )
    if "Tags" in data:
