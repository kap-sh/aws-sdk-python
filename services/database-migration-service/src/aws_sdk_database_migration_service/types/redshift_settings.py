...
if TYPE_CHECKING:
    ...
    import aws_sdk_database_migration_service.types.encryption_mode_value
...
class RedshiftSettings(TypedDict):
    ...
    date_format: NotRequired["aws_sdk_database_migration_service.types.string.String"]
    ...
    time_format: NotRequired["aws_sdk_database_migration_service.types.string.String"]
...
def serialize_aws_json_1_1(value: RedshiftSettings) -> dict:
    ...
    if "encryption_mode" in value:
        ...
        out["EncryptionMode"] = (
            aws_sdk_database_migration_service.types.encryption_mode_value.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RedshiftSettings:
    ...
    if "EncryptionMode" in data:
        ...
        out["encryption_mode"] = (
            aws_sdk_database_migration_service.types.encryption_mode_value.deserialize_aws_json_1_1(
                data["EncryptionMode"]
            )
        )
