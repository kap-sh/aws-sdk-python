"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeSchemasMessage``."""
...
class DescribeSchemasMessage(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeSchemasMessage) -> dict:
    out: dict = {}
