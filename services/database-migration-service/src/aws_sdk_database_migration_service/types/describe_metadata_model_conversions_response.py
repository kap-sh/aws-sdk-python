"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeMetadataModelConversionsResponse``."""
...
class DescribeMetadataModelConversionsResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeMetadataModelConversionsResponse) -> dict:
    out: dict = {}
    if "marker" in value:
