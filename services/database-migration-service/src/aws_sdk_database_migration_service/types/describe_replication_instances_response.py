...
class DescribeReplicationInstancesResponse(TypedDict):
    ...
    replication_instances: NotRequired[
        "aws_sdk_database_migration_service.types.replication_instance_list.ReplicationInstanceList"
    ]
...
def serialize_aws_json_1_1(value: DescribeReplicationInstancesResponse) -> dict:
    ...
    if "replication_instances" in value:
        ...
        out["ReplicationInstances"] = (
            aws_sdk_database_migration_service.types.replication_instance_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeReplicationInstancesResponse:
    ...
    if "ReplicationInstances" in data:
        ...
        out["replication_instances"] = (
            aws_sdk_database_migration_service.types.replication_instance_list.deserialize_aws_json_1_1(
