...
if TYPE_CHECKING:
    ...
    import aws_sdk_database_migration_service.types.processed_object
...
class Progress(TypedDict):
    ...
    total_objects: "aws_sdk_database_migration_service.types.long.Long"
    """<p>The number of objects in this schema conversion operation.</p>"""
    progress_step: NotRequired["aws_sdk_database_migration_service.types.string.String"]
    ...
    processed_object: NotRequired[
        "aws_sdk_database_migration_service.types.processed_object.ProcessedObject"
    ]
...
def serialize_aws_json_1_1(value: Progress) -> dict:
    ...
    if "processed_object" in value:
        ...
        out["ProcessedObject"] = (
            aws_sdk_database_migration_service.types.processed_object.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Progress:
    ...
    if "ProcessedObject" in data:
        ...
        out["processed_object"] = (
            aws_sdk_database_migration_service.types.processed_object.deserialize_aws_json_1_1(
