...
if TYPE_CHECKING:
    ...
    import aws_sdk_database_migration_service.types.subnet_list


class ReplicationSubnetGroup(TypedDict):
    ...
    vpc_id: NotRequired["aws_sdk_database_migration_service.types.string.String"]
    ...
    subnets: NotRequired[
        "aws_sdk_database_migration_service.types.subnet_list.SubnetList"
    ]
...
def serialize_aws_json_1_1(value: ReplicationSubnetGroup) -> dict:
    ...
    if "subnets" in value:
        ...
        out["Subnets"] = (
            aws_sdk_database_migration_service.types.subnet_list.serialize_aws_json_1_1(
                value["subnets"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ReplicationSubnetGroup:
    ...
    if "Subnets" in data:
        ...
        out["subnets"] = (
            aws_sdk_database_migration_service.types.subnet_list.deserialize_aws_json_1_1(
                data["Subnets"]
            )
        )
