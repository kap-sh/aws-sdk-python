...
class StartDataMigrationMessage(TypedDict):
...
def serialize_aws_json_1_1(value: StartDataMigrationMessage) -> dict:
    ...
    out["StartType"] = (
        aws_sdk_database_migration_service.types.start_replication_migration_type_value.serialize_aws_json_1_1(
            value["start_type"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> StartDataMigrationMessage:
    ...
    if "StartType" in data:
        ...
        out["start_type"] = (
            aws_sdk_database_migration_service.types.start_replication_migration_type_value.deserialize_aws_json_1_1(
                data["StartType"]
            )
        )
    else:
