...
if TYPE_CHECKING:
    import aws_sdk_database_migration_service.types.replication_task_list
    import aws_sdk_database_migration_service.types.string


class DescribeReplicationTasksResponse(TypedDict):
    ...
    replication_tasks: NotRequired[
        "aws_sdk_database_migration_service.types.replication_task_list.ReplicationTaskList"
    ]
...
def serialize_aws_json_1_1(value: DescribeReplicationTasksResponse) -> dict:
    ...
    if "replication_tasks" in value:
        ...
        out["ReplicationTasks"] = (
            aws_sdk_database_migration_service.types.replication_task_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeReplicationTasksResponse:
    ...
    if "ReplicationTasks" in data:
        ...
        out["replication_tasks"] = (
            aws_sdk_database_migration_service.types.replication_task_list.deserialize_aws_json_1_1(
