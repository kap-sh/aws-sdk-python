"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeMetadataModelAssessmentsMessage``."""
...
class DescribeMetadataModelAssessmentsMessage(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeMetadataModelAssessmentsMessage) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DescribeMetadataModelAssessmentsMessage:
    out: DescribeMetadataModelAssessmentsMessage = {}  # type: ignore[typeddict-item]
    if "MigrationProjectIdentifier" in data:
        out["migration_project_identifier"] = data["MigrationProjectIdentifier"]
    else:
        raise DeserializationError(
            "DescribeMetadataModelAssessmentsMessage.migration_project_identifier required"
        )
    if "Filters" in data:
        import aws_sdk_database_migration_service.types.filter_list
