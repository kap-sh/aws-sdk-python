"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeExtensionPackAssociationsResponse``."""
...
class DescribeExtensionPackAssociationsResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeExtensionPackAssociationsResponse) -> dict:
    out: dict = {}
    if "marker" in value:
...
def deserialize_aws_json_1_1(data: dict) -> DescribeExtensionPackAssociationsResponse:
    out: DescribeExtensionPackAssociationsResponse = {}  # type: ignore[typeddict-item]
    if "Marker" in data:
