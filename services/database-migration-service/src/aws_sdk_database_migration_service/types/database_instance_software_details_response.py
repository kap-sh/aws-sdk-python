...
class DatabaseInstanceSoftwareDetailsResponse(TypedDict):
    ...
    service_pack: NotRequired["aws_sdk_database_migration_service.types.string.String"]
    """<p>The service pack level of the database.</p>"""
    support_level: NotRequired["aws_sdk_database_migration_service.types.string.String"]
    ...
    tooltip: NotRequired["aws_sdk_database_migration_service.types.string.String"]
