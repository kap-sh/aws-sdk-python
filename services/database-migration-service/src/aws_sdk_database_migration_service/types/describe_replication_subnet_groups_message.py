"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeReplicationSubnetGroupsMessage``."""
...
class DescribeReplicationSubnetGroupsMessage(TypedDict, closed=True):
    filters: NotRequired[
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeReplicationSubnetGroupsMessage) -> dict:
    out: dict = {}
    if "filters" in value:
        import aws_sdk_database_migration_service.types.filter_list
...
def deserialize_aws_json_1_1(data: dict) -> DescribeReplicationSubnetGroupsMessage:
    out: DescribeReplicationSubnetGroupsMessage = {}  # type: ignore[typeddict-item]
    if "Filters" in data:
        import aws_sdk_database_migration_service.types.filter_list
