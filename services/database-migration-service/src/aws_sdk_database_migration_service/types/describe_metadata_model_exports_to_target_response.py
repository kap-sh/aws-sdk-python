"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeMetadataModelExportsToTargetResponse``."""
...
class DescribeMetadataModelExportsToTargetResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeMetadataModelExportsToTargetResponse) -> dict:
    out: dict = {}
    if "marker" in value:
...
def deserialize_aws_json_1_1(
    ...
    out: DescribeMetadataModelExportsToTargetResponse = {}  # type: ignore[typeddict-item]
    if "Marker" in data:
