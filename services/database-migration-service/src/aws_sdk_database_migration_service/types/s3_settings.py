...
if TYPE_CHECKING:
    ...
    import aws_sdk_database_migration_service.types.canned_acl_for_objects_value
    import aws_sdk_database_migration_service.types.compression_type_value
    import aws_sdk_database_migration_service.types.data_format_value
    import aws_sdk_database_migration_service.types.date_partition_delimiter_value
    import aws_sdk_database_migration_service.types.date_partition_sequence_value
    import aws_sdk_database_migration_service.types.encoding_type_value
    ...
    import aws_sdk_database_migration_service.types.parquet_version_value
...
class S3Settings(TypedDict):
    ...
    csv_delimiter: NotRequired["aws_sdk_database_migration_service.types.string.String"]
    ...
    compression_type: NotRequired[
        "aws_sdk_database_migration_service.types.compression_type_value.CompressionTypeValue"
    ]
    ...
    data_format: NotRequired[
        "aws_sdk_database_migration_service.types.data_format_value.DataFormatValue"
    ]
    ...
    encoding_type: NotRequired[
        "aws_sdk_database_migration_service.types.encoding_type_value.EncodingTypeValue"
    ]
    ...
    parquet_version: NotRequired[
        "aws_sdk_database_migration_service.types.parquet_version_value.ParquetVersionValue"
    ]
    ...
    date_partition_sequence: NotRequired[
        "aws_sdk_database_migration_service.types.date_partition_sequence_value.DatePartitionSequenceValue"
    ]
    ...
    date_partition_delimiter: NotRequired[
        "aws_sdk_database_migration_service.types.date_partition_delimiter_value.DatePartitionDelimiterValue"
    ]
    ...
    cdc_path: NotRequired["aws_sdk_database_migration_service.types.string.String"]
    ...
    canned_acl_for_objects: NotRequired[
        "aws_sdk_database_migration_service.types.canned_acl_for_objects_value.CannedAclForObjectsValue"
    ]
    ...
    csv_null_value: NotRequired[
        "aws_sdk_database_migration_service.types.string.String"
    ]
    """<p>An optional parameter that specifies how DMS treats null values. While handling the null value, you can use this parameter to pass a user-defined string as null when writing to the target. For example, when target columns are nullable, you can use this option to differentiate between the empty string value and the null value. So, if you set this parameter value to the empty string (\"\" or ''), DMS treats the empty string as the null value instead of <code>NULL</code>.</p> <p>The default value is <code>NULL</code>. Valid values include any valid string.</p>"""
...
def serialize_aws_json_1_1(value: S3Settings) -> dict:
    ...
    if "compression_type" in value:
        ...
        out["CompressionType"] = (
            aws_sdk_database_migration_service.types.compression_type_value.serialize_aws_json_1_1(
    ...
    if "data_format" in value:
        ...
        out["DataFormat"] = (
            aws_sdk_database_migration_service.types.data_format_value.serialize_aws_json_1_1(
                value["data_format"]
            )
        )
    if "encoding_type" in value:
        ...
        out["EncodingType"] = (
            aws_sdk_database_migration_service.types.encoding_type_value.serialize_aws_json_1_1(
                value["encoding_type"]
            )
        )
    ...
    if "parquet_version" in value:
        ...
        out["ParquetVersion"] = (
            aws_sdk_database_migration_service.types.parquet_version_value.serialize_aws_json_1_1(
    ...
    if "date_partition_sequence" in value:
        ...
        out["DatePartitionSequence"] = (
            aws_sdk_database_migration_service.types.date_partition_sequence_value.serialize_aws_json_1_1(
    ...
    if "date_partition_delimiter" in value:
        ...
        out["DatePartitionDelimiter"] = (
            aws_sdk_database_migration_service.types.date_partition_delimiter_value.serialize_aws_json_1_1(
    ...
    if "canned_acl_for_objects" in value:
        ...
        out["CannedAclForObjects"] = (
            aws_sdk_database_migration_service.types.canned_acl_for_objects_value.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> S3Settings:
    ...
    if "CompressionType" in data:
        ...
        out["compression_type"] = (
            aws_sdk_database_migration_service.types.compression_type_value.deserialize_aws_json_1_1(
    ...
    if "DataFormat" in data:
        ...
        out["data_format"] = (
            aws_sdk_database_migration_service.types.data_format_value.deserialize_aws_json_1_1(
                data["DataFormat"]
            )
        )
    if "EncodingType" in data:
        ...
        out["encoding_type"] = (
            aws_sdk_database_migration_service.types.encoding_type_value.deserialize_aws_json_1_1(
                data["EncodingType"]
            )
        )
    ...
    if "ParquetVersion" in data:
        ...
        out["parquet_version"] = (
            aws_sdk_database_migration_service.types.parquet_version_value.deserialize_aws_json_1_1(
                data["ParquetVersion"]
            )
        )
    ...
    if "DatePartitionSequence" in data:
        ...
        out["date_partition_sequence"] = (
            aws_sdk_database_migration_service.types.date_partition_sequence_value.deserialize_aws_json_1_1(
    ...
    if "DatePartitionDelimiter" in data:
        ...
        out["date_partition_delimiter"] = (
            aws_sdk_database_migration_service.types.date_partition_delimiter_value.deserialize_aws_json_1_1(
    ...
    if "CannedAclForObjects" in data:
        ...
        out["canned_acl_for_objects"] = (
            aws_sdk_database_migration_service.types.canned_acl_for_objects_value.deserialize_aws_json_1_1(
