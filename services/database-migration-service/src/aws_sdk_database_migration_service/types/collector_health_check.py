...
if TYPE_CHECKING:
    ...
    import aws_sdk_database_migration_service.types.collector_status


class CollectorHealthCheck(TypedDict):
    collector_status: NotRequired[
        "aws_sdk_database_migration_service.types.collector_status.CollectorStatus"
    ]
...
def serialize_aws_json_1_1(value: CollectorHealthCheck) -> dict:
    ...
    if "collector_status" in value:
        ...
        out["CollectorStatus"] = (
            aws_sdk_database_migration_service.types.collector_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CollectorHealthCheck:
    ...
    if "CollectorStatus" in data:
        ...
        out["collector_status"] = (
            aws_sdk_database_migration_service.types.collector_status.deserialize_aws_json_1_1(
