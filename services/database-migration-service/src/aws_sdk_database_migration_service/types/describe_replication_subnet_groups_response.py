...
if TYPE_CHECKING:
    import aws_sdk_database_migration_service.types.replication_subnet_groups
    import aws_sdk_database_migration_service.types.string


class DescribeReplicationSubnetGroupsResponse(TypedDict):
    ...
    replication_subnet_groups: NotRequired[
        "aws_sdk_database_migration_service.types.replication_subnet_groups.ReplicationSubnetGroups"
    ]
...
def serialize_aws_json_1_1(value: DescribeReplicationSubnetGroupsResponse) -> dict:
    ...
    if "replication_subnet_groups" in value:
        ...
        out["ReplicationSubnetGroups"] = (
            aws_sdk_database_migration_service.types.replication_subnet_groups.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeReplicationSubnetGroupsResponse:
    ...
    if "ReplicationSubnetGroups" in data:
        ...
        out["replication_subnet_groups"] = (
            aws_sdk_database_migration_service.types.replication_subnet_groups.deserialize_aws_json_1_1(
