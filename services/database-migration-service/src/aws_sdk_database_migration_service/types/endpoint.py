...
if TYPE_CHECKING:
    ...
    import aws_sdk_database_migration_service.types.lakehouse_settings
...
class Endpoint(TypedDict):
    ...
    external_id: NotRequired["aws_sdk_database_migration_service.types.string.String"]
    ...
    lakehouse_settings: NotRequired[
        "aws_sdk_database_migration_service.types.lakehouse_settings.LakehouseSettings"
    ]
...
def serialize_aws_json_1_1(value: Endpoint) -> dict:
    ...
    if "lakehouse_settings" in value:
        ...
        out["LakehouseSettings"] = (
            aws_sdk_database_migration_service.types.lakehouse_settings.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Endpoint:
    ...
    if "LakehouseSettings" in data:
        ...
        out["lakehouse_settings"] = (
            aws_sdk_database_migration_service.types.lakehouse_settings.deserialize_aws_json_1_1(
