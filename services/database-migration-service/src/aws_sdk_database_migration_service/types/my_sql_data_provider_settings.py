"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#MySqlDataProviderSettings``."""
...
class MySqlDataProviderSettings(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: MySqlDataProviderSettings) -> dict:
    out: dict = {}
