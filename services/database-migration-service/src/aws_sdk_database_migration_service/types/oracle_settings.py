...
if TYPE_CHECKING:
    ...
    import aws_sdk_database_migration_service.types.char_length_semantics
    import aws_sdk_database_migration_service.types.integer_list
    import aws_sdk_database_migration_service.types.integer_optional
    import aws_sdk_database_migration_service.types.oracle_authentication_method
    import aws_sdk_database_migration_service.types.secret_string
    import aws_sdk_database_migration_service.types.string


class OracleSettings(TypedDict):
    ...
    extra_archived_log_dest_ids: NotRequired[
        "aws_sdk_database_migration_service.types.integer_list.IntegerList"
    ]
    ...
    asm_user: NotRequired["aws_sdk_database_migration_service.types.string.String"]
    ...
    char_length_semantics: NotRequired[
        "aws_sdk_database_migration_service.types.char_length_semantics.CharLengthSemantics"
    ]
    ...
    authentication_method: NotRequired[
        "aws_sdk_database_migration_service.types.oracle_authentication_method.OracleAuthenticationMethod"
    ]
...
def serialize_aws_json_1_1(value: OracleSettings) -> dict:
    ...
    if "extra_archived_log_dest_ids" in value:
        ...
        out["ExtraArchivedLogDestIds"] = (
            aws_sdk_database_migration_service.types.integer_list.serialize_aws_json_1_1(
    ...
    if "char_length_semantics" in value:
        ...
        out["CharLengthSemantics"] = (
            aws_sdk_database_migration_service.types.char_length_semantics.serialize_aws_json_1_1(
    ...
    if "authentication_method" in value:
        ...
        out["AuthenticationMethod"] = (
            aws_sdk_database_migration_service.types.oracle_authentication_method.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> OracleSettings:
    ...
    if "ExtraArchivedLogDestIds" in data:
        ...
        out["extra_archived_log_dest_ids"] = (
            aws_sdk_database_migration_service.types.integer_list.deserialize_aws_json_1_1(
    ...
    if "CharLengthSemantics" in data:
        ...
        out["char_length_semantics"] = (
            aws_sdk_database_migration_service.types.char_length_semantics.deserialize_aws_json_1_1(
    ...
    if "AuthenticationMethod" in data:
        ...
        out["authentication_method"] = (
            aws_sdk_database_migration_service.types.oracle_authentication_method.deserialize_aws_json_1_1(
