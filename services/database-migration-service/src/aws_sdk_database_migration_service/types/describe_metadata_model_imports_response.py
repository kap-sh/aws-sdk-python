"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeMetadataModelImportsResponse``."""
...
class DescribeMetadataModelImportsResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeMetadataModelImportsResponse) -> dict:
    out: dict = {}
    if "marker" in value:
...
def deserialize_aws_json_1_1(data: dict) -> DescribeMetadataModelImportsResponse:
    out: DescribeMetadataModelImportsResponse = {}  # type: ignore[typeddict-item]
    if "Marker" in data:
