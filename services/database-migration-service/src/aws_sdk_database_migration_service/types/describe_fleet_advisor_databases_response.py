...
if TYPE_CHECKING:
    import aws_sdk_database_migration_service.types.database_list
    import aws_sdk_database_migration_service.types.string


class DescribeFleetAdvisorDatabasesResponse(TypedDict):
    databases: NotRequired[
        "aws_sdk_database_migration_service.types.database_list.DatabaseList"
    ]
...
def serialize_aws_json_1_1(value: DescribeFleetAdvisorDatabasesResponse) -> dict:
    ...
    if "databases" in value:
        ...
        out["Databases"] = (
            aws_sdk_database_migration_service.types.database_list.serialize_aws_json_1_1(
                value["databases"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeFleetAdvisorDatabasesResponse:
    ...
    if "Databases" in data:
        ...
        out["databases"] = (
            aws_sdk_database_migration_service.types.database_list.deserialize_aws_json_1_1(
                data["Databases"]
            )
        )
