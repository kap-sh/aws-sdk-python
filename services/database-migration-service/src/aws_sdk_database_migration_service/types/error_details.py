...
if TYPE_CHECKING:
    import aws_sdk_database_migration_service.types.default_error_details


class _ErrorDetails_defaultErrorDetails(TypedDict):
    defaultErrorDetails: "aws_sdk_database_migration_service.types.default_error_details.DefaultErrorDetails"
...
def serialize_aws_json_1_1(value: ErrorDetails) -> dict:
    if "defaultErrorDetails" in value:
        ...
        return {
            "defaultErrorDetails": aws_sdk_database_migration_service.types.default_error_details.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ErrorDetails:
    if "defaultErrorDetails" in data:
        ...
        return {
            "defaultErrorDetails": aws_sdk_database_migration_service.types.default_error_details.deserialize_aws_json_1_1(
