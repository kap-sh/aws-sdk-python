...
class TableStatistics(TypedDict):
    ...
    """<p>The schema name.</p>"""
    table_name: NotRequired["aws_sdk_database_migration_service.types.string.String"]
    """<p>The name of the table.</p>"""
    inserts: "aws_sdk_database_migration_service.types.long.Long"
    """<p>The number of insert actions performed on a table.</p>"""
    deletes: "aws_sdk_database_migration_service.types.long.Long"
    """<p>The number of delete actions performed on a table.</p>"""
    updates: "aws_sdk_database_migration_service.types.long.Long"
    """<p>The number of update actions performed on a table.</p>"""
    ddls: "aws_sdk_database_migration_service.types.long.Long"
    ...
    full_load_rows: "aws_sdk_database_migration_service.types.long.Long"
    ...
    full_load_error_rows: "aws_sdk_database_migration_service.types.long.Long"
    ...
    table_state: NotRequired["aws_sdk_database_migration_service.types.string.String"]
    ...
    validation_pending_records: "aws_sdk_database_migration_service.types.long.Long"
    """<p>The number of records that have yet to be validated.</p>"""
    validation_failed_records: "aws_sdk_database_migration_service.types.long.Long"
    """<p>The number of records that failed validation.</p>"""
    validation_suspended_records: "aws_sdk_database_migration_service.types.long.Long"
    ...
    resync_state: NotRequired["aws_sdk_database_migration_service.types.string.String"]
