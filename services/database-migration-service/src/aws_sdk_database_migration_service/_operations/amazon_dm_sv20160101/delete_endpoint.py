"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DeleteEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.delete_endpoint_response.DeleteEndpointResponse = aws_sdk_database_migration_service.types.delete_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.delete_endpoint_message.DeleteEndpointMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.delete_endpoint_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
