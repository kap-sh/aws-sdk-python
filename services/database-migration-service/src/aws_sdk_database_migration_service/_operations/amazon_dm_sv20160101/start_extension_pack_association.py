...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.start_extension_pack_association_response.StartExtensionPackAssociationResponse = aws_sdk_database_migration_service.types.start_extension_pack_association_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.start_extension_pack_association_message.StartExtensionPackAssociationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.start_extension_pack_association_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
