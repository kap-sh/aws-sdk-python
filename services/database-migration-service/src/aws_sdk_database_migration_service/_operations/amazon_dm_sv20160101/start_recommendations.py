...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.start_recommendations_request.StartRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.start_recommendations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
