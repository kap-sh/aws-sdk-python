"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DeleteReplicationTask``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.delete_replication_task_response.DeleteReplicationTaskResponse = aws_sdk_database_migration_service.types.delete_replication_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.delete_replication_task_message.DeleteReplicationTaskMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.delete_replication_task_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_replication_task(
