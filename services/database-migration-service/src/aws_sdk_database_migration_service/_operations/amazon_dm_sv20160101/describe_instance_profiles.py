"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeInstanceProfiles``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_instance_profiles_response.DescribeInstanceProfilesResponse = aws_sdk_database_migration_service.types.describe_instance_profiles_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_instance_profiles_message.DescribeInstanceProfilesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeInstanceProfiles"
    import aws_sdk_database_migration_service.types.describe_instance_profiles_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_instance_profiles_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_instance_profiles(
