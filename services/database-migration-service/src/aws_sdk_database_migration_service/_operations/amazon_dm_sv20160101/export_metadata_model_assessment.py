...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.export_metadata_model_assessment_message.ExportMetadataModelAssessmentMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.export_metadata_model_assessment_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
