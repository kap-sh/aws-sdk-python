"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#ModifyEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.modify_endpoint_response.ModifyEndpointResponse = aws_sdk_database_migration_service.types.modify_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.modify_endpoint_message.ModifyEndpointMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.modify_endpoint_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_modify_endpoint(
