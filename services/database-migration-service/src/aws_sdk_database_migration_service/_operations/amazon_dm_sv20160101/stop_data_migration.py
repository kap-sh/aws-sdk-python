...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.stop_data_migration_response.StopDataMigrationResponse = aws_sdk_database_migration_service.types.stop_data_migration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.stop_data_migration_message.StopDataMigrationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.stop_data_migration_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
