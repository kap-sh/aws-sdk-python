...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_refresh_schemas_status_response.DescribeRefreshSchemasStatusResponse = aws_sdk_database_migration_service.types.describe_refresh_schemas_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_refresh_schemas_status_message.DescribeRefreshSchemasStatusMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_refresh_schemas_status_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
