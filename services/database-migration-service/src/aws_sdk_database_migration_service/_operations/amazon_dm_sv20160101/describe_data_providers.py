"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeDataProviders``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_data_providers_response.DescribeDataProvidersResponse = aws_sdk_database_migration_service.types.describe_data_providers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_data_providers_message.DescribeDataProvidersMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeDataProviders"
    import aws_sdk_database_migration_service.types.describe_data_providers_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_data_providers_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_data_providers(
