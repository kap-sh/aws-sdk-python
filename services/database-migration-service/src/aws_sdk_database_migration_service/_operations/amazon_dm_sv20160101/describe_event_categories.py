"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeEventCategories``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_event_categories_response.DescribeEventCategoriesResponse = aws_sdk_database_migration_service.types.describe_event_categories_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_event_categories_message.DescribeEventCategoriesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_event_categories_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
