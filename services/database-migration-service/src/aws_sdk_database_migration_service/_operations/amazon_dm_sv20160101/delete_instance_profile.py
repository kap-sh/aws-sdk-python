"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DeleteInstanceProfile``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.delete_instance_profile_response.DeleteInstanceProfileResponse = aws_sdk_database_migration_service.types.delete_instance_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.delete_instance_profile_message.DeleteInstanceProfileMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DeleteInstanceProfile"
    import aws_sdk_database_migration_service.types.delete_instance_profile_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.delete_instance_profile_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_instance_profile(
