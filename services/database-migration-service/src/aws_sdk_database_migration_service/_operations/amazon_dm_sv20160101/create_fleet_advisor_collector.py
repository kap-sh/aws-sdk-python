...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.create_fleet_advisor_collector_response.CreateFleetAdvisorCollectorResponse = aws_sdk_database_migration_service.types.create_fleet_advisor_collector_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.create_fleet_advisor_collector_request.CreateFleetAdvisorCollectorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.create_fleet_advisor_collector_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
