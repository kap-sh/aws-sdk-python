"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DeleteDataMigration``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.delete_data_migration_response.DeleteDataMigrationResponse = aws_sdk_database_migration_service.types.delete_data_migration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.delete_data_migration_message.DeleteDataMigrationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DeleteDataMigration"
    import aws_sdk_database_migration_service.types.delete_data_migration_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.delete_data_migration_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_data_migration(
