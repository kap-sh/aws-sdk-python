"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#ModifyReplicationInstance``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UpgradeDependencyFailureFault":
            import aws_sdk_database_migration_service.errors.upgrade_dependency_failure_fault

            raise aws_sdk_database_migration_service.errors.upgrade_dependency_failure_fault.UpgradeDependencyFailureFault.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.modify_replication_instance_response.ModifyReplicationInstanceResponse = aws_sdk_database_migration_service.types.modify_replication_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.modify_replication_instance_message.ModifyReplicationInstanceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.modify_replication_instance_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_modify_replication_instance(
