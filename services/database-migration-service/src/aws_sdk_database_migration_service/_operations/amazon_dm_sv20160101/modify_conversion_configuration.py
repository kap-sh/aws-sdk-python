"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#ModifyConversionConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.modify_conversion_configuration_response.ModifyConversionConfigurationResponse = aws_sdk_database_migration_service.types.modify_conversion_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.modify_conversion_configuration_message.ModifyConversionConfigurationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.ModifyConversionConfiguration"
    import aws_sdk_database_migration_service.types.modify_conversion_configuration_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.modify_conversion_configuration_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_modify_conversion_configuration(
