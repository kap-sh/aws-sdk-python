...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.create_endpoint_message.CreateEndpointMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.create_endpoint_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
