...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_replication_task_assessment_results_response.DescribeReplicationTaskAssessmentResultsResponse = aws_sdk_database_migration_service.types.describe_replication_task_assessment_results_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_replication_task_assessment_results_message.DescribeReplicationTaskAssessmentResultsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
