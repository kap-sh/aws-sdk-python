...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.start_metadata_model_creation_response.StartMetadataModelCreationResponse = aws_sdk_database_migration_service.types.start_metadata_model_creation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.start_metadata_model_creation_message.StartMetadataModelCreationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.start_metadata_model_creation_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
