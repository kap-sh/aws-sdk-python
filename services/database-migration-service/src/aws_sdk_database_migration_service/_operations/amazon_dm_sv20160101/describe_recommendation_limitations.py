...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_recommendation_limitations_response.DescribeRecommendationLimitationsResponse = aws_sdk_database_migration_service.types.describe_recommendation_limitations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_recommendation_limitations_request.DescribeRecommendationLimitationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
