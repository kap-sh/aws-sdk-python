"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DeleteReplicationSubnetGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.delete_replication_subnet_group_response.DeleteReplicationSubnetGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.delete_replication_subnet_group_message.DeleteReplicationSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.delete_replication_subnet_group_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_replication_subnet_group(
