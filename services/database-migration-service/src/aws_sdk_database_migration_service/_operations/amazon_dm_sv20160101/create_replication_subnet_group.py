...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.create_replication_subnet_group_response.CreateReplicationSubnetGroupResponse = aws_sdk_database_migration_service.types.create_replication_subnet_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.create_replication_subnet_group_message.CreateReplicationSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.create_replication_subnet_group_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
