...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.start_replication_task_assessment_run_message.StartReplicationTaskAssessmentRunMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.start_replication_task_assessment_run_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
