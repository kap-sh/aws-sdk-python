...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.update_subscriptions_to_event_bridge_response.UpdateSubscriptionsToEventBridgeResponse = aws_sdk_database_migration_service.types.update_subscriptions_to_event_bridge_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.update_subscriptions_to_event_bridge_message.UpdateSubscriptionsToEventBridgeMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.update_subscriptions_to_event_bridge_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
