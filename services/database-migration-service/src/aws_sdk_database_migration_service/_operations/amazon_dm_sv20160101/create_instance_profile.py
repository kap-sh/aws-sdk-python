...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.create_instance_profile_response.CreateInstanceProfileResponse = aws_sdk_database_migration_service.types.create_instance_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.create_instance_profile_message.CreateInstanceProfileMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.create_instance_profile_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
