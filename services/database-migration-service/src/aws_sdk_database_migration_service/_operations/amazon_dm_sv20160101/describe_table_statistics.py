"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeTableStatistics``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_table_statistics_response.DescribeTableStatisticsResponse = aws_sdk_database_migration_service.types.describe_table_statistics_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_table_statistics_message.DescribeTableStatisticsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_table_statistics_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_table_statistics(
