"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeReplicationTaskAssessmentRuns``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_replication_task_assessment_runs_response.DescribeReplicationTaskAssessmentRunsResponse = aws_sdk_database_migration_service.types.describe_replication_task_assessment_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_replication_task_assessment_runs_message.DescribeReplicationTaskAssessmentRunsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeReplicationTaskAssessmentRuns"
    import aws_sdk_database_migration_service.types.describe_replication_task_assessment_runs_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_replication_task_assessment_runs_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_replication_task_assessment_runs(
