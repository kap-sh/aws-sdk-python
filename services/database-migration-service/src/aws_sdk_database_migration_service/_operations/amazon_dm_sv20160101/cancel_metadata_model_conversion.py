...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.cancel_metadata_model_conversion_response.CancelMetadataModelConversionResponse = aws_sdk_database_migration_service.types.cancel_metadata_model_conversion_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.cancel_metadata_model_conversion_message.CancelMetadataModelConversionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.cancel_metadata_model_conversion_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
