...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.test_connection_response.TestConnectionResponse = aws_sdk_database_migration_service.types.test_connection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.test_connection_message.TestConnectionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.test_connection_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
