"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#StopReplication``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.stop_replication_response.StopReplicationResponse = aws_sdk_database_migration_service.types.stop_replication_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.stop_replication_message.StopReplicationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.StopReplication"
    import aws_sdk_database_migration_service.types.stop_replication_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.stop_replication_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
