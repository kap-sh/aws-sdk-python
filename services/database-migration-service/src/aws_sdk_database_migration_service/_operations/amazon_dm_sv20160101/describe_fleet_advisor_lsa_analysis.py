"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeFleetAdvisorLsaAnalysis``."""
...
import aws_sdk_database_migration_service.types.fleet_advisor_lsa_analysis_response_list
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_fleet_advisor_lsa_analysis_response.DescribeFleetAdvisorLsaAnalysisResponse = aws_sdk_database_migration_service.types.describe_fleet_advisor_lsa_analysis_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_fleet_advisor_lsa_analysis_request.DescribeFleetAdvisorLsaAnalysisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeFleetAdvisorLsaAnalysis"
    import aws_sdk_database_migration_service.types.describe_fleet_advisor_lsa_analysis_request

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_fleet_advisor_lsa_analysis_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_fleet_advisor_lsa_analysis(
