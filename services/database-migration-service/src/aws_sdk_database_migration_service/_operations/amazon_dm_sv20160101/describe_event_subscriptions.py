"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeEventSubscriptions``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_event_subscriptions_response.DescribeEventSubscriptionsResponse = aws_sdk_database_migration_service.types.describe_event_subscriptions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_event_subscriptions_message.DescribeEventSubscriptionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_event_subscriptions_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
