"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#RunFleetAdvisorLsaAnalysis``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.run_fleet_advisor_lsa_analysis_response.RunFleetAdvisorLsaAnalysisResponse = aws_sdk_database_migration_service.types.run_fleet_advisor_lsa_analysis_response.deserialize_aws_json_1_1(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.RunFleetAdvisorLsaAnalysis"
    body: bytes | None = b""
...
async def async_run_fleet_advisor_lsa_analysis(
