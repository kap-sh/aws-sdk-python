...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_orderable_replication_instances_message.DescribeOrderableReplicationInstancesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_orderable_replication_instances_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
