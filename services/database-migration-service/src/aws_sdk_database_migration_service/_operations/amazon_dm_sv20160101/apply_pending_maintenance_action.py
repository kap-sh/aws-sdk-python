...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.apply_pending_maintenance_action_response.ApplyPendingMaintenanceActionResponse = aws_sdk_database_migration_service.types.apply_pending_maintenance_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.apply_pending_maintenance_action_message.ApplyPendingMaintenanceActionMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.apply_pending_maintenance_action_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
