"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#ModifyDataProvider``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.modify_data_provider_response.ModifyDataProviderResponse = aws_sdk_database_migration_service.types.modify_data_provider_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.modify_data_provider_message.ModifyDataProviderMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.ModifyDataProvider"
    import aws_sdk_database_migration_service.types.modify_data_provider_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.modify_data_provider_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_modify_data_provider(
