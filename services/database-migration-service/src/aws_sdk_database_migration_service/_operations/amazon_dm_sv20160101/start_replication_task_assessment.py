...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.start_replication_task_assessment_response.StartReplicationTaskAssessmentResponse = aws_sdk_database_migration_service.types.start_replication_task_assessment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.start_replication_task_assessment_message.StartReplicationTaskAssessmentMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.start_replication_task_assessment_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
