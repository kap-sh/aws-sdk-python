...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.reload_replication_tables_response.ReloadReplicationTablesResponse = aws_sdk_database_migration_service.types.reload_replication_tables_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.reload_replication_tables_message.ReloadReplicationTablesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.reload_replication_tables_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
