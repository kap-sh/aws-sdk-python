"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeFleetAdvisorSchemaObjectSummary``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_fleet_advisor_schema_object_summary_response.DescribeFleetAdvisorSchemaObjectSummaryResponse = aws_sdk_database_migration_service.types.describe_fleet_advisor_schema_object_summary_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_fleet_advisor_schema_object_summary_request.DescribeFleetAdvisorSchemaObjectSummaryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_fleet_advisor_schema_object_summary(
