"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DeleteReplicationConfig``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.delete_replication_config_response.DeleteReplicationConfigResponse = aws_sdk_database_migration_service.types.delete_replication_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.delete_replication_config_message.DeleteReplicationConfigMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DeleteReplicationConfig"
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.delete_replication_config_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_replication_config(
