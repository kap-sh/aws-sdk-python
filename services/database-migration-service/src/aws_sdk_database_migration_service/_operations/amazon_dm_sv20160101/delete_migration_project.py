"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DeleteMigrationProject``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.delete_migration_project_response.DeleteMigrationProjectResponse = aws_sdk_database_migration_service.types.delete_migration_project_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.delete_migration_project_message.DeleteMigrationProjectMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DeleteMigrationProject"
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.delete_migration_project_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_migration_project(
