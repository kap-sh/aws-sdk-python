"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeRecommendations``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_recommendations_response.DescribeRecommendationsResponse = aws_sdk_database_migration_service.types.describe_recommendations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_recommendations_request.DescribeRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeRecommendations"
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_recommendations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_recommendations(
