"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeSchemas``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_schemas_response.DescribeSchemasResponse = aws_sdk_database_migration_service.types.describe_schemas_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_schemas_message.DescribeSchemasMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_schemas_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_schemas(
