...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.reboot_replication_instance_response.RebootReplicationInstanceResponse = aws_sdk_database_migration_service.types.reboot_replication_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.reboot_replication_instance_message.RebootReplicationInstanceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.reboot_replication_instance_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
