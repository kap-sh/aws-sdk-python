"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#RemoveTagsFromResource``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.remove_tags_from_resource_response.RemoveTagsFromResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.remove_tags_from_resource_message.RemoveTagsFromResourceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.remove_tags_from_resource_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
