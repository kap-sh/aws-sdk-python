"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeMetadataModelExportsAsScript``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_metadata_model_exports_as_script_response.DescribeMetadataModelExportsAsScriptResponse = aws_sdk_database_migration_service.types.describe_metadata_model_exports_as_script_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_metadata_model_exports_as_script_message.DescribeMetadataModelExportsAsScriptMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeMetadataModelExportsAsScript"
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_metadata_model_exports_as_script_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_metadata_model_exports_as_script(
