"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeApplicableIndividualAssessments``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_applicable_individual_assessments_response.DescribeApplicableIndividualAssessmentsResponse = aws_sdk_database_migration_service.types.describe_applicable_individual_assessments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_applicable_individual_assessments_message.DescribeApplicableIndividualAssessmentsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_applicable_individual_assessments(
