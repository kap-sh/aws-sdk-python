"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#StartDataMigration``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.start_data_migration_response.StartDataMigrationResponse = aws_sdk_database_migration_service.types.start_data_migration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.start_data_migration_message.StartDataMigrationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.StartDataMigration"
    import aws_sdk_database_migration_service.types.start_data_migration_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.start_data_migration_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_data_migration(
