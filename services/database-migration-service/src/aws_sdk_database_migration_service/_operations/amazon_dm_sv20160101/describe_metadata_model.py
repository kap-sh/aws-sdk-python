...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_metadata_model_response.DescribeMetadataModelResponse = aws_sdk_database_migration_service.types.describe_metadata_model_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_metadata_model_message.DescribeMetadataModelMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_metadata_model_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
