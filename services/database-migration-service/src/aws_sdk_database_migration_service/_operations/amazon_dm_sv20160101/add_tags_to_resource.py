"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#AddTagsToResource``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.add_tags_to_resource_response.AddTagsToResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.add_tags_to_resource_message.AddTagsToResourceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.add_tags_to_resource_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
