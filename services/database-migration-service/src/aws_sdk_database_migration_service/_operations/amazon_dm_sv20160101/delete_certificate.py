"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DeleteCertificate``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.delete_certificate_response.DeleteCertificateResponse = aws_sdk_database_migration_service.types.delete_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.delete_certificate_message.DeleteCertificateMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.delete_certificate_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
