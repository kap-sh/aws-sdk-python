"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#CreateReplicationInstance``."""
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.create_replication_instance_message.CreateReplicationInstanceMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.create_replication_instance_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_replication_instance(
