"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeFleetAdvisorCollectors``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_fleet_advisor_collectors_response.DescribeFleetAdvisorCollectorsResponse = aws_sdk_database_migration_service.types.describe_fleet_advisor_collectors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_fleet_advisor_collectors_request.DescribeFleetAdvisorCollectorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeFleetAdvisorCollectors"
    import aws_sdk_database_migration_service.types.describe_fleet_advisor_collectors_request

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_fleet_advisor_collectors_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_fleet_advisor_collectors(
