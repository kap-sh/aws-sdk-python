...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.delete_replication_task_assessment_run_response.DeleteReplicationTaskAssessmentRunResponse = aws_sdk_database_migration_service.types.delete_replication_task_assessment_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.delete_replication_task_assessment_run_message.DeleteReplicationTaskAssessmentRunMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.delete_replication_task_assessment_run_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
