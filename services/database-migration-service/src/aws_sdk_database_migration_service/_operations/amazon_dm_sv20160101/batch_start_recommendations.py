...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.batch_start_recommendations_response.BatchStartRecommendationsResponse = aws_sdk_database_migration_service.types.batch_start_recommendations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.batch_start_recommendations_request.BatchStartRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
