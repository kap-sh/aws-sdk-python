...
import aws_sdk_database_migration_service.errors.subnet_already_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubnetAlreadyInUse":
            raise aws_sdk_database_migration_service.errors.subnet_already_in_use.SubnetAlreadyInUse.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.modify_replication_subnet_group_response.ModifyReplicationSubnetGroupResponse = aws_sdk_database_migration_service.types.modify_replication_subnet_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.modify_replication_subnet_group_message.ModifyReplicationSubnetGroupMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.modify_replication_subnet_group_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
