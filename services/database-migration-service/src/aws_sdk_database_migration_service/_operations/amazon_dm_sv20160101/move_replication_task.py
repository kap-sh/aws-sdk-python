"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#MoveReplicationTask``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.move_replication_task_response.MoveReplicationTaskResponse = aws_sdk_database_migration_service.types.move_replication_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.move_replication_task_message.MoveReplicationTaskMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.MoveReplicationTask"
    import aws_sdk_database_migration_service.types.move_replication_task_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.move_replication_task_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_move_replication_task(
