...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_fleet_advisor_schemas_response.DescribeFleetAdvisorSchemasResponse = aws_sdk_database_migration_service.types.describe_fleet_advisor_schemas_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_fleet_advisor_schemas_request.DescribeFleetAdvisorSchemasRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_fleet_advisor_schemas_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
