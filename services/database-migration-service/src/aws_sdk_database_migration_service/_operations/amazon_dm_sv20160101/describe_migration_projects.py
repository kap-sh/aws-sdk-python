"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeMigrationProjects``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_migration_projects_response.DescribeMigrationProjectsResponse = aws_sdk_database_migration_service.types.describe_migration_projects_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_migration_projects_message.DescribeMigrationProjectsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeMigrationProjects"
    import aws_sdk_database_migration_service.types.describe_migration_projects_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_migration_projects_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_migration_projects(
