...
def build_request(
    ...
    input: aws_sdk_database_migration_service.types.describe_replication_task_individual_assessments_message.DescribeReplicationTaskIndividualAssessmentsMessage,
) -> zapros.Request:
