"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeReplicationTaskIndividualAssessments``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_replication_task_individual_assessments_response.DescribeReplicationTaskIndividualAssessmentsResponse = aws_sdk_database_migration_service.types.describe_replication_task_individual_assessments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_replication_task_individual_assessments_message.DescribeReplicationTaskIndividualAssessmentsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_replication_task_individual_assessments_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_replication_task_individual_assessments(
