...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.create_migration_project_response.CreateMigrationProjectResponse = aws_sdk_database_migration_service.types.create_migration_project_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.create_migration_project_message.CreateMigrationProjectMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
