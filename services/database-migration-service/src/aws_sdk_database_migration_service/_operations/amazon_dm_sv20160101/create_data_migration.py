"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#CreateDataMigration``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.create_data_migration_response.CreateDataMigrationResponse = aws_sdk_database_migration_service.types.create_data_migration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.create_data_migration_message.CreateDataMigrationMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.CreateDataMigration"
    import aws_sdk_database_migration_service.types.create_data_migration_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.create_data_migration_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_data_migration(
