"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeAccountAttributes``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_account_attributes_response.DescribeAccountAttributesResponse = aws_sdk_database_migration_service.types.describe_account_attributes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_account_attributes_message.DescribeAccountAttributesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
