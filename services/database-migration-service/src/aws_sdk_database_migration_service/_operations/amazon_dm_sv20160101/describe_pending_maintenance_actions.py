"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribePendingMaintenanceActions``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_pending_maintenance_actions_response.DescribePendingMaintenanceActionsResponse = aws_sdk_database_migration_service.types.describe_pending_maintenance_actions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_pending_maintenance_actions_message.DescribePendingMaintenanceActionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_pending_maintenance_actions_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
