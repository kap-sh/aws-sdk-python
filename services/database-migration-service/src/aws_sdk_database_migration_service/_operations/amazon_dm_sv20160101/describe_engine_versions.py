"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeEngineVersions``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_engine_versions_response.DescribeEngineVersionsResponse = aws_sdk_database_migration_service.types.describe_engine_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_engine_versions_message.DescribeEngineVersionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeEngineVersions"
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_engine_versions_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_engine_versions(
