...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_extension_pack_associations_response.DescribeExtensionPackAssociationsResponse = aws_sdk_database_migration_service.types.describe_extension_pack_associations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_extension_pack_associations_message.DescribeExtensionPackAssociationsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_extension_pack_associations_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
