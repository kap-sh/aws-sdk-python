"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#CancelReplicationTaskAssessmentRun``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.cancel_replication_task_assessment_run_response.CancelReplicationTaskAssessmentRunResponse = aws_sdk_database_migration_service.types.cancel_replication_task_assessment_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.cancel_replication_task_assessment_run_message.CancelReplicationTaskAssessmentRunMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.CancelReplicationTaskAssessmentRun"
    import aws_sdk_database_migration_service.types.cancel_replication_task_assessment_run_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.cancel_replication_task_assessment_run_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_cancel_replication_task_assessment_run(
