...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.get_target_selection_rules_response.GetTargetSelectionRulesResponse = aws_sdk_database_migration_service.types.get_target_selection_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.get_target_selection_rules_message.GetTargetSelectionRulesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.get_target_selection_rules_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
