"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DeleteDataProvider``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.delete_data_provider_response.DeleteDataProviderResponse = aws_sdk_database_migration_service.types.delete_data_provider_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.delete_data_provider_message.DeleteDataProviderMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DeleteDataProvider"
    import aws_sdk_database_migration_service.types.delete_data_provider_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.delete_data_provider_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_data_provider(
