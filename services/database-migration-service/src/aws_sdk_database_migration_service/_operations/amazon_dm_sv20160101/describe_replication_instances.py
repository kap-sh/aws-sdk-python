...
import aws_sdk_database_migration_service.types.replication_instance_list
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_replication_instances_response.DescribeReplicationInstancesResponse = aws_sdk_database_migration_service.types.describe_replication_instances_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_replication_instances_message.DescribeReplicationInstancesMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_replication_instances_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
