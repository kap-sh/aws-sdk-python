"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeMetadataModelConversions``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_metadata_model_conversions_response.DescribeMetadataModelConversionsResponse = aws_sdk_database_migration_service.types.describe_metadata_model_conversions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_metadata_model_conversions_message.DescribeMetadataModelConversionsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeMetadataModelConversions"
    import aws_sdk_database_migration_service.types.describe_metadata_model_conversions_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_metadata_model_conversions_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_metadata_model_conversions(
