"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeReplicationInstanceTaskLogs``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_replication_instance_task_logs_response.DescribeReplicationInstanceTaskLogsResponse = aws_sdk_database_migration_service.types.describe_replication_instance_task_logs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_replication_instance_task_logs_message.DescribeReplicationInstanceTaskLogsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_replication_instance_task_logs_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_replication_instance_task_logs(
