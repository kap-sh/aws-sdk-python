"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#StartMetadataModelAssessment``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.start_metadata_model_assessment_response.StartMetadataModelAssessmentResponse = aws_sdk_database_migration_service.types.start_metadata_model_assessment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.start_metadata_model_assessment_message.StartMetadataModelAssessmentMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.StartMetadataModelAssessment"
    import aws_sdk_database_migration_service.types.start_metadata_model_assessment_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.start_metadata_model_assessment_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_start_metadata_model_assessment(
