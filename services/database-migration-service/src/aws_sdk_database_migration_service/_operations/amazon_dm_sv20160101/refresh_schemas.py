...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.refresh_schemas_response.RefreshSchemasResponse = aws_sdk_database_migration_service.types.refresh_schemas_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.refresh_schemas_message.RefreshSchemasMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.refresh_schemas_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
