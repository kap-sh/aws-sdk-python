"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeReplicationConfigs``."""
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_replication_configs_response.DescribeReplicationConfigsResponse = aws_sdk_database_migration_service.types.describe_replication_configs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_replication_configs_message.DescribeReplicationConfigsMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeReplicationConfigs"
    import aws_sdk_database_migration_service.types.describe_replication_configs_message

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_replication_configs_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_replication_configs(
