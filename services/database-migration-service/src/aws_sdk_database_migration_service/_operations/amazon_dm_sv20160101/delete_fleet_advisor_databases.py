"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DeleteFleetAdvisorDatabases``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidOperationFault":
            import aws_sdk_database_migration_service.errors.invalid_operation_fault

            raise aws_sdk_database_migration_service.errors.invalid_operation_fault.InvalidOperationFault.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.delete_fleet_advisor_databases_response.DeleteFleetAdvisorDatabasesResponse = aws_sdk_database_migration_service.types.delete_fleet_advisor_databases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.delete_fleet_advisor_databases_request.DeleteFleetAdvisorDatabasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DeleteFleetAdvisorDatabases"
    import aws_sdk_database_migration_service.types.delete_fleet_advisor_databases_request

    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.delete_fleet_advisor_databases_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_fleet_advisor_databases(
