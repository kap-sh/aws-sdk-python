...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.describe_fleet_advisor_databases_response.DescribeFleetAdvisorDatabasesResponse = aws_sdk_database_migration_service.types.describe_fleet_advisor_databases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.describe_fleet_advisor_databases_request.DescribeFleetAdvisorDatabasesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.describe_fleet_advisor_databases_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
