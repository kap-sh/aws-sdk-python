...
def handle_response(
    ...
    out: aws_sdk_database_migration_service.types.modify_replication_config_response.ModifyReplicationConfigResponse = aws_sdk_database_migration_service.types.modify_replication_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_database_migration_service.types.modify_replication_config_message.ModifyReplicationConfigMessage,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_database_migration_service.types.modify_replication_config_message.serialize_aws_json_1_1(
            input_
        )
    ).encode()
