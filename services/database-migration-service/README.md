...
```
pip install aws-sdk-database-migration-service
```

## Usage

```python
from aws_sdk_database_migration_service import AsyncDatabaseMigrationServiceClient
...
```python
from aws_sdk_database_migration_service import AsyncDatabaseMigrationServiceClient
from aws_sdk_database_migration_service.error import InvalidResourceStateFault
