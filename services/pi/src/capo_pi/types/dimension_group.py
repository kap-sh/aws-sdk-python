...
class DimensionGroup(TypedDict, closed=True):
    group: "capo_pi.types.sanitized_string.SanitizedString"
    ...
    dimensions: NotRequired["capo_pi.types.sanitized_string_list.SanitizedStringList"]
    ...
    limit: NotRequired["capo_pi.types.limit.Limit"]
...
def serialize_aws_json_1_1(value: DimensionGroup) -> dict:
    ...
    if "dimensions" in value:
        ...
        out["Dimensions"] = capo_pi.types.sanitized_string_list.serialize_aws_json_1_1(
            value["dimensions"]
        )
    if "limit" in value:
...
def deserialize_aws_json_1_1(data: dict) -> DimensionGroup:
    ...
    if "Dimensions" in data:
        ...
        out["dimensions"] = (
            capo_pi.types.sanitized_string_list.deserialize_aws_json_1_1(
                data["Dimensions"]
            )
        )
    if "Limit" in data:
