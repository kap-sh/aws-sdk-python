"""Generated from Smithy shape ``com.amazonaws.pi#CreatePerformanceAnalysisReport``."""
...
def handle_response(
    ...
    out: capo_pi.types.create_performance_analysis_report_response.CreatePerformanceAnalysisReportResponse = capo_pi.types.create_performance_analysis_report_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pi.types.create_performance_analysis_report_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_performance_analysis_report(
