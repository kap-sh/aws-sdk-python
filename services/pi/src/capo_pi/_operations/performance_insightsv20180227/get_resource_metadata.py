"""Generated from Smithy shape ``com.amazonaws.pi#GetResourceMetadata``."""
...
def handle_response(
    ...
    out: capo_pi.types.get_resource_metadata_response.GetResourceMetadataResponse = (
        capo_pi.types.get_resource_metadata_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PerformanceInsightsv20180227.GetResourceMetadata"
    body: bytes | None = json.dumps(
        capo_pi.types.get_resource_metadata_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_resource_metadata(
