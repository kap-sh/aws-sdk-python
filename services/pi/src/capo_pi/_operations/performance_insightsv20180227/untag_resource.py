"""Generated from Smithy shape ``com.amazonaws.pi#UntagResource``."""
...
def handle_response(
    ...
    out: capo_pi.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PerformanceInsightsv20180227.UntagResource"
    body: bytes | None = json.dumps(
        capo_pi.types.untag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def untag_resource(
    ...
    capo_pi.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
