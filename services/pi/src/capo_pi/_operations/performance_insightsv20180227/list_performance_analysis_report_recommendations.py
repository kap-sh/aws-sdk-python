"""Generated from Smithy shape ``com.amazonaws.pi#ListPerformanceAnalysisReportRecommendations``."""
...
def handle_response(
    ...
    out: capo_pi.types.list_performance_analysis_report_recommendations_response.ListPerformanceAnalysisReportRecommendationsResponse = capo_pi.types.list_performance_analysis_report_recommendations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pi.types.list_performance_analysis_report_recommendations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_performance_analysis_report_recommendations(
