...
def handle_response(
    ...
    out: capo_pi.types.describe_dimension_keys_response.DescribeDimensionKeysResponse = capo_pi.types.describe_dimension_keys_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pi.types.describe_dimension_keys_request.serialize_aws_json_1_1(input_)
    ).encode()
