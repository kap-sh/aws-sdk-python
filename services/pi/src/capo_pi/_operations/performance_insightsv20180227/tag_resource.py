...
def handle_response(
    ...
    out: capo_pi.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pi.types.tag_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def tag_resource(
    ...
    input_: capo_pi.types.tag_resource_request.TagResourceRequest,
) -> tuple[capo_pi.types.tag_resource_response.TagResourceResponse, zapros.Response]:
