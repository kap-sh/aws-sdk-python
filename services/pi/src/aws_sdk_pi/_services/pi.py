...
from aws_sdk_pi._services._aws_config import aws_config
...
class PIClientConfig(TypedDict, total=False, closed=True):
...
class PIClient:
    ...
    def operation_options(
        self, config_overrides: Optional[PIClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: PIClientConfig = config_overrides or {}
    ...
    def create_performance_analysis_report(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pi.types.create_performance_analysis_report_request.CreatePerformanceAnalysisReportRequest]",
        ) -> OperationResponse[
            "aws_sdk_pi.types.create_performance_analysis_report_response.CreatePerformanceAnalysisReportResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pi._operations.performance_insightsv20180227.create_performance_analysis_report.create_performance_analysis_report(
    ...
    def delete_performance_analysis_report(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pi.types.delete_performance_analysis_report_request.DeletePerformanceAnalysisReportRequest]",
        ) -> OperationResponse[
            "aws_sdk_pi.types.delete_performance_analysis_report_response.DeletePerformanceAnalysisReportResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pi._operations.performance_insightsv20180227.delete_performance_analysis_report.delete_performance_analysis_report(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_dimension_keys(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pi.types.describe_dimension_keys_request.DescribeDimensionKeysRequest]",
        ) -> OperationResponse[
            "aws_sdk_pi.types.describe_dimension_keys_response.DescribeDimensionKeysResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pi._operations.performance_insightsv20180227.describe_dimension_keys.describe_dimension_keys(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_dimension_key_details(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pi.types.get_dimension_key_details_request.GetDimensionKeyDetailsRequest]",
        ) -> OperationResponse[
            "aws_sdk_pi.types.get_dimension_key_details_response.GetDimensionKeyDetailsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pi._operations.performance_insightsv20180227.get_dimension_key_details.get_dimension_key_details(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_performance_analysis_report(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pi.types.get_performance_analysis_report_request.GetPerformanceAnalysisReportRequest]",
        ) -> OperationResponse[
            "aws_sdk_pi.types.get_performance_analysis_report_response.GetPerformanceAnalysisReportResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pi._operations.performance_insightsv20180227.get_performance_analysis_report.get_performance_analysis_report(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_metadata(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pi.types.get_resource_metadata_request.GetResourceMetadataRequest]",
        ) -> OperationResponse[
            "aws_sdk_pi.types.get_resource_metadata_response.GetResourceMetadataResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pi._operations.performance_insightsv20180227.get_resource_metadata.get_resource_metadata(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_metrics(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pi.types.get_resource_metrics_request.GetResourceMetricsRequest]",
        ) -> OperationResponse[
            "aws_sdk_pi.types.get_resource_metrics_response.GetResourceMetricsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pi._operations.performance_insightsv20180227.get_resource_metrics.get_resource_metrics(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_available_resource_dimensions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pi.types.list_available_resource_dimensions_request.ListAvailableResourceDimensionsRequest]",
        ) -> OperationResponse[
            "aws_sdk_pi.types.list_available_resource_dimensions_response.ListAvailableResourceDimensionsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pi._operations.performance_insightsv20180227.list_available_resource_dimensions.list_available_resource_dimensions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_available_resource_metrics(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pi.types.list_available_resource_metrics_request.ListAvailableResourceMetricsRequest]",
        ) -> OperationResponse[
            "aws_sdk_pi.types.list_available_resource_metrics_response.ListAvailableResourceMetricsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pi._operations.performance_insightsv20180227.list_available_resource_metrics.list_available_resource_metrics(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_performance_analysis_report_recommendations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pi.types.list_performance_analysis_report_recommendations_request.ListPerformanceAnalysisReportRecommendationsRequest]",
        ) -> OperationResponse[
            "aws_sdk_pi.types.list_performance_analysis_report_recommendations_response.ListPerformanceAnalysisReportRecommendationsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pi._operations.performance_insightsv20180227.list_performance_analysis_report_recommendations.list_performance_analysis_report_recommendations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_performance_analysis_report_recommendations(
        self,
        service_type: "aws_sdk_pi.types.service_type.ServiceType",
        identifier: "aws_sdk_pi.types.identifier_string.IdentifierString",
        analysis_report_id: "aws_sdk_pi.types.analysis_report_id.AnalysisReportId",
        *,
        ...
        max_results: Optional["aws_sdk_pi.types.max_results.MaxResults"] = None,
        next_token: Optional["aws_sdk_pi.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_pi.types.recommendation.Recommendation]":
        _token = next_token
        while True:
            _response = self.list_performance_analysis_report_recommendations(
                service_type,
                identifier,
                analysis_report_id,
    ...
    def list_performance_analysis_reports(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pi.types.list_performance_analysis_reports_request.ListPerformanceAnalysisReportsRequest]",
        ) -> OperationResponse[
            "aws_sdk_pi.types.list_performance_analysis_reports_response.ListPerformanceAnalysisReportsResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pi._operations.performance_insightsv20180227.list_performance_analysis_reports.list_performance_analysis_reports(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pi.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_pi.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pi._operations.performance_insightsv20180227.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pi.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_pi.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pi._operations.performance_insightsv20180227.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_pi.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "aws_sdk_pi.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                aws_sdk_pi._operations.performance_insightsv20180227.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
