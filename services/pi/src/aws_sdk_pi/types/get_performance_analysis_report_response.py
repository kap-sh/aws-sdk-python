...
class GetPerformanceAnalysisReportResponse(TypedDict):
    analysis_report: NotRequired["aws_sdk_pi.types.analysis_report.AnalysisReport"]
...
def serialize_aws_json_1_1(value: GetPerformanceAnalysisReportResponse) -> dict:
    ...
    if "analysis_report" in value:
        ...
        out["AnalysisReport"] = aws_sdk_pi.types.analysis_report.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetPerformanceAnalysisReportResponse:
    ...
    if "AnalysisReport" in data:
        ...
        out["analysis_report"] = (
            aws_sdk_pi.types.analysis_report.deserialize_aws_json_1_1(
                data["AnalysisReport"]
            )
        )
    return out
