...
class DimensionKeyDetail(TypedDict):
    ...
    status: NotRequired["aws_sdk_pi.types.detail_status.DetailStatus"]
...
def serialize_aws_json_1_1(value: DimensionKeyDetail) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = aws_sdk_pi.types.detail_status.serialize_aws_json_1_1(
            value["status"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DimensionKeyDetail:
    ...
    if "Status" in data:
        ...
        out["status"] = aws_sdk_pi.types.detail_status.deserialize_aws_json_1_1(
            data["Status"]
        )
    return out
