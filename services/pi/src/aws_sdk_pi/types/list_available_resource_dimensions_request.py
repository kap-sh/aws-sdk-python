...
class ListAvailableResourceDimensionsRequest(TypedDict):
...
def serialize_aws_json_1_1(value: ListAvailableResourceDimensionsRequest) -> dict:
    ...
    out["Metrics"] = aws_sdk_pi.types.dimensions_metric_list.serialize_aws_json_1_1(
        value["metrics"]
    )
    ...
    if "authorized_actions" in value:
        ...
        out["AuthorizedActions"] = (
            aws_sdk_pi.types.authorized_actions_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListAvailableResourceDimensionsRequest:
    ...
    if "Metrics" in data:
        ...
        out["metrics"] = (
            aws_sdk_pi.types.dimensions_metric_list.deserialize_aws_json_1_1(
                data["Metrics"]
            )
        )
    else:
    ...
    if "AuthorizedActions" in data:
        ...
        out["authorized_actions"] = (
            aws_sdk_pi.types.authorized_actions_list.deserialize_aws_json_1_1(
