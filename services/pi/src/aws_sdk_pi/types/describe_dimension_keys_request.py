...
def serialize_aws_json_1_1(value: DescribeDimensionKeysRequest) -> dict:
    ...
    if "additional_metrics" in value:
        ...
        out["AdditionalMetrics"] = (
            aws_sdk_pi.types.additional_metrics_list.serialize_aws_json_1_1(
    ...
    if "partition_by" in value:
        ...
        out["PartitionBy"] = aws_sdk_pi.types.dimension_group.serialize_aws_json_1_1(
            value["partition_by"]
        )
    if "filter" in value:
        import aws_sdk_pi.types.metric_query_filter_map
...
def deserialize_aws_json_1_1(data: dict) -> DescribeDimensionKeysRequest:
    ...
    if "AdditionalMetrics" in data:
        ...
        out["additional_metrics"] = (
            aws_sdk_pi.types.additional_metrics_list.deserialize_aws_json_1_1(
    ...
    if "PartitionBy" in data:
        ...
        out["partition_by"] = aws_sdk_pi.types.dimension_group.deserialize_aws_json_1_1(
            data["PartitionBy"]
        )
    if "Filter" in data:
        import aws_sdk_pi.types.metric_query_filter_map
