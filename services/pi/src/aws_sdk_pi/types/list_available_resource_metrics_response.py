...
class ListAvailableResourceMetricsResponse(TypedDict):
    metrics: NotRequired[
        "aws_sdk_pi.types.response_resource_metric_list.ResponseResourceMetricList"
    ]
...
def serialize_aws_json_1_1(value: ListAvailableResourceMetricsResponse) -> dict:
    ...
    if "metrics" in value:
        ...
        out["Metrics"] = (
            aws_sdk_pi.types.response_resource_metric_list.serialize_aws_json_1_1(
                value["metrics"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListAvailableResourceMetricsResponse:
    ...
    if "Metrics" in data:
        ...
        out["metrics"] = (
            aws_sdk_pi.types.response_resource_metric_list.deserialize_aws_json_1_1(
                data["Metrics"]
            )
        )
