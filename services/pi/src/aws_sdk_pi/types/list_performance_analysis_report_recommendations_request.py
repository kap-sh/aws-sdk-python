...
class ListPerformanceAnalysisReportRecommendationsRequest(TypedDict):
...
def serialize_aws_json_1_1(
    ...
    if "recommendation_ids" in value:
        ...
        out["RecommendationIds"] = (
            aws_sdk_pi.types.recommendation_id_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if "RecommendationIds" in data:
        ...
        out["recommendation_ids"] = (
            aws_sdk_pi.types.recommendation_id_list.deserialize_aws_json_1_1(
