...
if TYPE_CHECKING:
    import aws_sdk_pi.types.response_resource_metric

ResponseResourceMetricList: TypeAlias = list[
    "aws_sdk_pi.types.response_resource_metric.ResponseResourceMetric"
]
...
def serialize_aws_json_1_1(value: ResponseResourceMetricList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_pi.types.response_resource_metric.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ResponseResourceMetricList:
    ...
    for item in data:
        out.append(
            aws_sdk_pi.types.response_resource_metric.deserialize_aws_json_1_1(item)
        )
    return out
