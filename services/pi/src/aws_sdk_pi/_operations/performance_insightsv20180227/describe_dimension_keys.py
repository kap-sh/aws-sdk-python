...
def build_request(
    ...
    input: aws_sdk_pi.types.describe_dimension_keys_request.DescribeDimensionKeysRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pi.types.describe_dimension_keys_request.serialize_aws_json_1_1(input)
    ).encode()
