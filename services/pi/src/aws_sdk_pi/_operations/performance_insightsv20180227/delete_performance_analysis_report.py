"""Generated from Smithy shape ``com.amazonaws.pi#DeletePerformanceAnalysisReport``."""
...
def handle_response(
    ...
    out: aws_sdk_pi.types.delete_performance_analysis_report_response.DeletePerformanceAnalysisReportResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_pi.types.delete_performance_analysis_report_request.DeletePerformanceAnalysisReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_delete_performance_analysis_report(
