"""Generated from Smithy shape ``com.amazonaws.pi#GetPerformanceAnalysisReport``."""
...
import aws_sdk_pi.types.analysis_report
...
def handle_response(
    ...
    out: aws_sdk_pi.types.get_performance_analysis_report_response.GetPerformanceAnalysisReportResponse = aws_sdk_pi.types.get_performance_analysis_report_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_pi.types.get_performance_analysis_report_request.GetPerformanceAnalysisReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pi.types.get_performance_analysis_report_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_performance_analysis_report(
