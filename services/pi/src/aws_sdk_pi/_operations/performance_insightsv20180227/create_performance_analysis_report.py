...
def handle_response(
    ...
    out: aws_sdk_pi.types.create_performance_analysis_report_response.CreatePerformanceAnalysisReportResponse = aws_sdk_pi.types.create_performance_analysis_report_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_pi.types.create_performance_analysis_report_request.CreatePerformanceAnalysisReportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pi.types.create_performance_analysis_report_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
