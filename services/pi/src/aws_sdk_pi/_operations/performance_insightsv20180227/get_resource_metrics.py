...
def handle_response(
    ...
    out: aws_sdk_pi.types.get_resource_metrics_response.GetResourceMetricsResponse = (
        aws_sdk_pi.types.get_resource_metrics_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_pi.types.get_resource_metrics_request.GetResourceMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pi.types.get_resource_metrics_request.serialize_aws_json_1_1(input_)
    ).encode()
