...
def build_request(
    ...
    input: aws_sdk_pi.types.get_resource_metrics_request.GetResourceMetricsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pi.types.get_resource_metrics_request.serialize_aws_json_1_1(input)
    ).encode()
