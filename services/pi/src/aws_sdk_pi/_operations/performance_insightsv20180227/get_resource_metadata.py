...
def build_request(
    ...
    input: aws_sdk_pi.types.get_resource_metadata_request.GetResourceMetadataRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pi.types.get_resource_metadata_request.serialize_aws_json_1_1(input)
    ).encode()
