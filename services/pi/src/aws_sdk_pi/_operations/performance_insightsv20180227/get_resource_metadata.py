...
def handle_response(
    ...
    out: aws_sdk_pi.types.get_resource_metadata_response.GetResourceMetadataResponse = (
        aws_sdk_pi.types.get_resource_metadata_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_pi.types.get_resource_metadata_request.GetResourceMetadataRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pi.types.get_resource_metadata_request.serialize_aws_json_1_1(input_)
    ).encode()
