...
import aws_sdk_pi.types.response_resource_metric_list
...
def handle_response(
    ...
    out: aws_sdk_pi.types.list_available_resource_metrics_response.ListAvailableResourceMetricsResponse = aws_sdk_pi.types.list_available_resource_metrics_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_pi.types.list_available_resource_metrics_request.ListAvailableResourceMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pi.types.list_available_resource_metrics_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
