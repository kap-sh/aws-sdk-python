...
def handle_response(
    ...
    out: aws_sdk_pi.types.list_performance_analysis_reports_response.ListPerformanceAnalysisReportsResponse = aws_sdk_pi.types.list_performance_analysis_reports_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_pi.types.list_performance_analysis_reports_request.ListPerformanceAnalysisReportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
