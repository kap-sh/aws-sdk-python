...
def handle_response(
    ...
    out: aws_sdk_pi.types.list_performance_analysis_report_recommendations_response.ListPerformanceAnalysisReportRecommendationsResponse = aws_sdk_pi.types.list_performance_analysis_report_recommendations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_pi.types.list_performance_analysis_report_recommendations_request.ListPerformanceAnalysisReportRecommendationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pi.types.list_performance_analysis_report_recommendations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
