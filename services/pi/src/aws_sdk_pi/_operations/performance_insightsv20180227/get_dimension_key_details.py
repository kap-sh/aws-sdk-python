...
def handle_response(
    ...
    out: aws_sdk_pi.types.get_dimension_key_details_response.GetDimensionKeyDetailsResponse = aws_sdk_pi.types.get_dimension_key_details_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_pi.types.get_dimension_key_details_request.GetDimensionKeyDetailsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pi.types.get_dimension_key_details_request.serialize_aws_json_1_1(input)
    ).encode()
