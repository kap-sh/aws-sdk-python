...
def build_request(
    ...
    input_: aws_sdk_pi.types.get_dimension_key_details_request.GetDimensionKeyDetailsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_pi.types.get_dimension_key_details_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
