...
from aws_sdk_oam._services._aws_config import aws_config
...
class OAMClientConfig(TypedDict, total=False):
...
class OAMClient:
    ...
    def create_link(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_oam.types.create_link_input.CreateLinkInput]",
        ) -> OperationResponse["aws_sdk_oam.types.create_link_output.CreateLinkOutput"]:
            import aws_sdk_oam._operations.oamservice.create_link

            output, http_response = (
                aws_sdk_oam._operations.oamservice.create_link.create_link(
    ...
    def create_sink(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_oam.types.create_sink_input.CreateSinkInput]",
        ) -> OperationResponse["aws_sdk_oam.types.create_sink_output.CreateSinkOutput"]:
            import aws_sdk_oam._operations.oamservice.create_sink

            output, http_response = (
                aws_sdk_oam._operations.oamservice.create_sink.create_sink(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_link(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_oam.types.delete_link_input.DeleteLinkInput]",
        ) -> OperationResponse["aws_sdk_oam.types.delete_link_output.DeleteLinkOutput"]:
            import aws_sdk_oam._operations.oamservice.delete_link

            output, http_response = (
                aws_sdk_oam._operations.oamservice.delete_link.delete_link(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_sink(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_oam.types.delete_sink_input.DeleteSinkInput]",
        ) -> OperationResponse["aws_sdk_oam.types.delete_sink_output.DeleteSinkOutput"]:
            import aws_sdk_oam._operations.oamservice.delete_sink

            output, http_response = (
                aws_sdk_oam._operations.oamservice.delete_sink.delete_sink(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_link(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_oam.types.get_link_input.GetLinkInput]",
        ) -> OperationResponse["aws_sdk_oam.types.get_link_output.GetLinkOutput"]:
            import aws_sdk_oam._operations.oamservice.get_link

            output, http_response = (
                aws_sdk_oam._operations.oamservice.get_link.get_link(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_sink(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_oam.types.get_sink_input.GetSinkInput]",
        ) -> OperationResponse["aws_sdk_oam.types.get_sink_output.GetSinkOutput"]:
            import aws_sdk_oam._operations.oamservice.get_sink

            output, http_response = (
                aws_sdk_oam._operations.oamservice.get_sink.get_sink(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_sink_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_oam.types.get_sink_policy_input.GetSinkPolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_oam.types.get_sink_policy_output.GetSinkPolicyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_oam._operations.oamservice.get_sink_policy.get_sink_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_attached_links(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_oam.types.list_attached_links_input.ListAttachedLinksInput]",
        ) -> OperationResponse[
            "aws_sdk_oam.types.list_attached_links_output.ListAttachedLinksOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_oam._operations.oamservice.list_attached_links.list_attached_links(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_attached_links(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_oam.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_oam.types.list_attached_links_item.ListAttachedLinksItem]":
        _token = next_token
        while True:
    ...
    def list_links(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_oam.types.list_links_input.ListLinksInput]",
        ) -> OperationResponse["aws_sdk_oam.types.list_links_output.ListLinksOutput"]:
            import aws_sdk_oam._operations.oamservice.list_links

            output, http_response = (
                aws_sdk_oam._operations.oamservice.list_links.list_links(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_links(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_oam.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_oam.types.list_links_item.ListLinksItem]":
        _token = next_token
        while True:
    ...
    def list_sinks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_oam.types.list_sinks_input.ListSinksInput]",
        ) -> OperationResponse["aws_sdk_oam.types.list_sinks_output.ListSinksOutput"]:
            import aws_sdk_oam._operations.oamservice.list_sinks

            output, http_response = (
                aws_sdk_oam._operations.oamservice.list_sinks.list_sinks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_sinks(
        ...
        *,
        ...
        next_token: Optional["aws_sdk_oam.types.next_token.NextToken"] = None,
    ) -> "Iterator[aws_sdk_oam.types.list_sinks_item.ListSinksItem]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_oam.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_oam.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_oam._operations.oamservice.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_sink_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_oam.types.put_sink_policy_input.PutSinkPolicyInput]",
        ) -> OperationResponse[
            "aws_sdk_oam.types.put_sink_policy_output.PutSinkPolicyOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_oam._operations.oamservice.put_sink_policy.put_sink_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_oam.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_oam.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_oam._operations.oamservice.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_oam.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[
            "aws_sdk_oam.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_oam._operations.oamservice.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_link(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_oam.types.update_link_input.UpdateLinkInput]",
        ) -> OperationResponse["aws_sdk_oam.types.update_link_output.UpdateLinkOutput"]:
            import aws_sdk_oam._operations.oamservice.update_link

            output, http_response = (
                aws_sdk_oam._operations.oamservice.update_link.update_link(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
