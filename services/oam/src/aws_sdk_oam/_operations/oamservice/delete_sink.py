...
def handle_response(
    ...
    out: aws_sdk_oam.types.delete_sink_output.DeleteSinkOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_oam.types.delete_sink_input.DeleteSinkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_oam.types.delete_sink_input.serialize_json(input_)
    ).encode()
...
def delete_sink(
    ...
    input_: aws_sdk_oam.types.delete_sink_input.DeleteSinkInput,
) -> tuple[aws_sdk_oam.types.delete_sink_output.DeleteSinkOutput, zapros.Response]:
