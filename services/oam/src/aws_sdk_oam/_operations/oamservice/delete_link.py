"""Generated from Smithy shape ``com.amazonaws.oam#DeleteLink``."""
...
def build_request(
    ...
    input_: aws_sdk_oam.types.delete_link_input.DeleteLinkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteLink"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_oam.types.delete_link_input

    body: bytes | None = json.dumps(
        aws_sdk_oam.types.delete_link_input.serialize_json(input_)
    ).encode()
...
def delete_link(
    ...
    input_: aws_sdk_oam.types.delete_link_input.DeleteLinkInput,
) -> tuple[aws_sdk_oam.types.delete_link_output.DeleteLinkOutput, zapros.Response]:
