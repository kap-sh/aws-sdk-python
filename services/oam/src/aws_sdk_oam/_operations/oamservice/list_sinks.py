"""Generated from Smithy shape ``com.amazonaws.oam#ListSinks``."""
...
def handle_response(
    ...
    out: aws_sdk_oam.types.list_sinks_output.ListSinksOutput = (
        aws_sdk_oam.types.list_sinks_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_oam.types.list_sinks_input.ListSinksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListSinks"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_oam.types.list_sinks_input

    body: bytes | None = json.dumps(
        aws_sdk_oam.types.list_sinks_input.serialize_json(input_)
    ).encode()
...
def list_sinks(
    options: OperationOptions, input_: aws_sdk_oam.types.list_sinks_input.ListSinksInput
) -> tuple[aws_sdk_oam.types.list_sinks_output.ListSinksOutput, zapros.Response]:
