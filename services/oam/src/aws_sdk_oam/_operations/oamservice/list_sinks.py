...
def build_request(
    ...
    input: aws_sdk_oam.types.list_sinks_input.ListSinksInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_oam.types.list_sinks_input.serialize_json(input)
    ).encode()
...
def list_sinks(
    options: OperationOptions, input: aws_sdk_oam.types.list_sinks_input.ListSinksInput
