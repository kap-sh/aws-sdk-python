...
def handle_response(
    ...
    out: aws_sdk_oam.types.put_sink_policy_output.PutSinkPolicyOutput = (
        aws_sdk_oam.types.put_sink_policy_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_oam.types.put_sink_policy_input.PutSinkPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_oam.types.put_sink_policy_input.serialize_json(input_)
    ).encode()
...
def put_sink_policy(
    ...
    aws_sdk_oam.types.put_sink_policy_output.PutSinkPolicyOutput, zapros.Response
]:
