...
async def async_handle_response(
    ...
    out: aws_sdk_oam.types.get_link_output.GetLinkOutput = (
        aws_sdk_oam.types.get_link_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_oam.types.get_link_input.GetLinkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_oam.types.get_link_input.serialize_json(input_)
    ).encode()
...
def get_link(
    options: OperationOptions, input_: aws_sdk_oam.types.get_link_input.GetLinkInput
