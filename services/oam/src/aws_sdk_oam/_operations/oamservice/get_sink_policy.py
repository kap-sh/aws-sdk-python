"""Generated from Smithy shape ``com.amazonaws.oam#GetSinkPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_oam.types.get_sink_policy_output.GetSinkPolicyOutput = (
        aws_sdk_oam.types.get_sink_policy_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_oam.types.get_sink_policy_input.GetSinkPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetSinkPolicy"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_oam.types.get_sink_policy_input

    body: bytes | None = json.dumps(
        aws_sdk_oam.types.get_sink_policy_input.serialize_json(input_)
    ).encode()
...
def get_sink_policy(
    ...
    aws_sdk_oam.types.get_sink_policy_output.GetSinkPolicyOutput, zapros.Response
]:
...
async def async_get_sink_policy(
