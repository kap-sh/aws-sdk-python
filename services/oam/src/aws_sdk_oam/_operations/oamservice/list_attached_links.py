...
import aws_sdk_oam.types.list_attached_links_items
...
def handle_response(
    ...
    out: aws_sdk_oam.types.list_attached_links_output.ListAttachedLinksOutput = (
        aws_sdk_oam.types.list_attached_links_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_oam.types.list_attached_links_input.ListAttachedLinksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_oam.types.list_attached_links_input.serialize_json(input_)
    ).encode()
