...
def build_request(
    ...
    input: aws_sdk_oam.types.list_links_input.ListLinksInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_oam.types.list_links_input.serialize_json(input)
    ).encode()
...
def list_links(
    options: OperationOptions, input: aws_sdk_oam.types.list_links_input.ListLinksInput
