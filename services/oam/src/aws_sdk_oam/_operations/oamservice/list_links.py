"""Generated from Smithy shape ``com.amazonaws.oam#ListLinks``."""
...
import aws_sdk_oam.types.list_links_items
...
def handle_response(
    ...
    out: aws_sdk_oam.types.list_links_output.ListLinksOutput = (
        aws_sdk_oam.types.list_links_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_oam.types.list_links_input.ListLinksInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/ListLinks"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_oam.types.list_links_input

    body: bytes | None = json.dumps(
        aws_sdk_oam.types.list_links_input.serialize_json(input_)
    ).encode()
...
def list_links(
    options: OperationOptions, input_: aws_sdk_oam.types.list_links_input.ListLinksInput
) -> tuple[aws_sdk_oam.types.list_links_output.ListLinksOutput, zapros.Response]:
