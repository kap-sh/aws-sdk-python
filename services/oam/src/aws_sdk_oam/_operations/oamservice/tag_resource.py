"""Generated from Smithy shape ``com.amazonaws.oam#TagResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            import aws_sdk_oam.errors.too_many_tags_exception

            raise aws_sdk_oam.errors.too_many_tags_exception.TooManyTagsException.from_json(
                data
            )
        case "ValidationException":
            import aws_sdk_oam.errors.validation_exception

            raise aws_sdk_oam.errors.validation_exception.ValidationException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: aws_sdk_oam.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def get_signer(
...
) -> aws_sdk_oam._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_oam._auth._sigv4.build_sigv4_auth_scheme("oam", options.region)
        )
        if sigv4_config is not None:
            return aws_sdk_oam._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_oam.types.tag_resource_input.TagResourceInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_oam.types.tag_resource_input.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    input_: aws_sdk_oam.types.tag_resource_input.TagResourceInput,
) -> tuple[aws_sdk_oam.types.tag_resource_output.TagResourceOutput, zapros.Response]:
