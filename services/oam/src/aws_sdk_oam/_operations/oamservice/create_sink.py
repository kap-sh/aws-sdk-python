...
def handle_response(
    ...
    out: aws_sdk_oam.types.create_sink_output.CreateSinkOutput = (
        aws_sdk_oam.types.create_sink_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_oam.types.create_sink_input.CreateSinkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_oam.types.create_sink_input.serialize_json(input_)
    ).encode()
...
def create_sink(
    ...
    input_: aws_sdk_oam.types.create_sink_input.CreateSinkInput,
) -> tuple[aws_sdk_oam.types.create_sink_output.CreateSinkOutput, zapros.Response]:
