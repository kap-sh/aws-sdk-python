"""Generated from Smithy shape ``com.amazonaws.oam#UpdateLink``."""
...
def handle_response(
    ...
    out: aws_sdk_oam.types.update_link_output.UpdateLinkOutput = (
        aws_sdk_oam.types.update_link_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_oam.types.update_link_input.UpdateLinkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/UpdateLink"
    params: dict[str, str] = {}
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    import aws_sdk_oam.types.update_link_input

    body: bytes | None = json.dumps(
        aws_sdk_oam.types.update_link_input.serialize_json(input_)
    ).encode()
...
def update_link(
    ...
    input_: aws_sdk_oam.types.update_link_input.UpdateLinkInput,
) -> tuple[aws_sdk_oam.types.update_link_output.UpdateLinkOutput, zapros.Response]:
