...
async def async_handle_response(
    ...
    out: aws_sdk_oam.types.get_sink_output.GetSinkOutput = (
        aws_sdk_oam.types.get_sink_output.deserialize_json(
...
def build_request(
    ...
    input_: aws_sdk_oam.types.get_sink_input.GetSinkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_oam.types.get_sink_input.serialize_json(input_)
    ).encode()
...
def get_sink(
    options: OperationOptions, input_: aws_sdk_oam.types.get_sink_input.GetSinkInput
