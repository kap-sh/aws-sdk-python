"""Generated from Smithy shape ``com.amazonaws.oam#ListLinksInput``."""
...
class ListLinksInput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListLinksInput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListLinksInput:
    out: ListLinksInput = {}  # type: ignore[typeddict-item]
