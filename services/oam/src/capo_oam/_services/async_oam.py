...
from capo_oam._services._aws_config import aaws_config
...
class AsyncOAMClientConfig(TypedDict, total=False, closed=True):
...
class AsyncOAMClient:
    ...
    async def create_link(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_oam.types.create_link_input.CreateLinkInput]",
        ) -> AsyncOperationResponse[
            "capo_oam.types.create_link_output.CreateLinkOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_oam._operations.oamservice.create_link.async_create_link(
    ...
    async def create_sink(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_oam.types.create_sink_input.CreateSinkInput]",
        ) -> AsyncOperationResponse[
            "capo_oam.types.create_sink_output.CreateSinkOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_oam._operations.oamservice.create_sink.async_create_sink(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_link(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_oam.types.delete_link_input.DeleteLinkInput]",
        ) -> AsyncOperationResponse[
            "capo_oam.types.delete_link_output.DeleteLinkOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_oam._operations.oamservice.delete_link.async_delete_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_sink(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_oam.types.delete_sink_input.DeleteSinkInput]",
        ) -> AsyncOperationResponse[
            "capo_oam.types.delete_sink_output.DeleteSinkOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_oam._operations.oamservice.delete_sink.async_delete_sink(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_link(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_oam.types.get_link_input.GetLinkInput]",
        ) -> AsyncOperationResponse["capo_oam.types.get_link_output.GetLinkOutput"]:
            import capo_oam._operations.oamservice.get_link

            (
                output,
                http_response,
            ) = await capo_oam._operations.oamservice.get_link.async_get_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sink(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_oam.types.get_sink_input.GetSinkInput]",
        ) -> AsyncOperationResponse["capo_oam.types.get_sink_output.GetSinkOutput"]:
            import capo_oam._operations.oamservice.get_sink

            (
                output,
                http_response,
            ) = await capo_oam._operations.oamservice.get_sink.async_get_sink(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sink_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_oam.types.get_sink_policy_input.GetSinkPolicyInput]",
        ) -> AsyncOperationResponse[
            "capo_oam.types.get_sink_policy_output.GetSinkPolicyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_oam._operations.oamservice.get_sink_policy.async_get_sink_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_attached_links(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_oam.types.list_attached_links_input.ListAttachedLinksInput]",
        ) -> AsyncOperationResponse[
            "capo_oam.types.list_attached_links_output.ListAttachedLinksOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_oam._operations.oamservice.list_attached_links.async_list_attached_links(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_attached_links(
        ...
        *,
        ...
        next_token: Optional["capo_oam.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_oam.types.list_attached_links_item.ListAttachedLinksItem]":
        _token = next_token
        while True:
    ...
    async def list_links(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_oam.types.list_links_input.ListLinksInput]",
        ) -> AsyncOperationResponse["capo_oam.types.list_links_output.ListLinksOutput"]:
            import capo_oam._operations.oamservice.list_links

            (
                output,
                http_response,
            ) = await capo_oam._operations.oamservice.list_links.async_list_links(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_links(
        ...
        *,
        ...
        next_token: Optional["capo_oam.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_oam.types.list_links_item.ListLinksItem]":
        _token = next_token
        while True:
    ...
    async def list_sinks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_oam.types.list_sinks_input.ListSinksInput]",
        ) -> AsyncOperationResponse["capo_oam.types.list_sinks_output.ListSinksOutput"]:
            import capo_oam._operations.oamservice.list_sinks

            (
                output,
                http_response,
            ) = await capo_oam._operations.oamservice.list_sinks.async_list_sinks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_sinks(
        ...
        *,
        ...
        next_token: Optional["capo_oam.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_oam.types.list_sinks_item.ListSinksItem]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_oam.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_oam.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_oam._operations.oamservice.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_sink_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_oam.types.put_sink_policy_input.PutSinkPolicyInput]",
        ) -> AsyncOperationResponse[
            "capo_oam.types.put_sink_policy_output.PutSinkPolicyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_oam._operations.oamservice.put_sink_policy.async_put_sink_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_oam.types.tag_resource_input.TagResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_oam.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_oam._operations.oamservice.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_oam.types.untag_resource_input.UntagResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_oam.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_oam._operations.oamservice.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_link(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_oam.types.update_link_input.UpdateLinkInput]",
        ) -> AsyncOperationResponse[
            "capo_oam.types.update_link_output.UpdateLinkOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_oam._operations.oamservice.update_link.async_update_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
