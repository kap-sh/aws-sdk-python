...
def handle_response(
    ...
    out: capo_oam.types.list_sinks_output.ListSinksOutput = (
        capo_oam.types.list_sinks_output.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_oam.types.list_sinks_output.ListSinksOutput = (
        capo_oam.types.list_sinks_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_oam.types.list_sinks_input.serialize_json(input_)
    ).encode()
...
def list_sinks(
    options: OperationOptions, input_: capo_oam.types.list_sinks_input.ListSinksInput
) -> tuple[capo_oam.types.list_sinks_output.ListSinksOutput, zapros.Response]:
