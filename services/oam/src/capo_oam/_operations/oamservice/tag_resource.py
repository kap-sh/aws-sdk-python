...
import capo_oam.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            raise capo_oam.errors.too_many_tags_exception.TooManyTagsException.from_json(
                data
            )
...
def handle_response(
    ...
    out: capo_oam.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_oam.types.tag_resource_input.serialize_json(input_)
    ).encode()
...
def tag_resource(
    ...
    input_: capo_oam.types.tag_resource_input.TagResourceInput,
) -> tuple[capo_oam.types.tag_resource_output.TagResourceOutput, zapros.Response]:
