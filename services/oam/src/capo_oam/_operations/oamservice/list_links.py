...
import capo_oam.types.list_links_items
...
def handle_response(
    ...
    out: capo_oam.types.list_links_output.ListLinksOutput = (
        capo_oam.types.list_links_output.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_oam.types.list_links_output.ListLinksOutput = (
        capo_oam.types.list_links_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_oam.types.list_links_input.serialize_json(input_)
    ).encode()
...
def list_links(
    options: OperationOptions, input_: capo_oam.types.list_links_input.ListLinksInput
) -> tuple[capo_oam.types.list_links_output.ListLinksOutput, zapros.Response]:
