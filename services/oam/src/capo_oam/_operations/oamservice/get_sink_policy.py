...
def handle_response(
    ...
    out: capo_oam.types.get_sink_policy_output.GetSinkPolicyOutput = (
        capo_oam.types.get_sink_policy_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_oam.types.get_sink_policy_input.serialize_json(input_)
    ).encode()
...
def get_sink_policy(
    ...
    input_: capo_oam.types.get_sink_policy_input.GetSinkPolicyInput,
) -> tuple[capo_oam.types.get_sink_policy_output.GetSinkPolicyOutput, zapros.Response]:
