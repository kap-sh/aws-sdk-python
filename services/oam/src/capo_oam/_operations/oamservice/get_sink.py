...
def handle_response(
    ...
    out: capo_oam.types.get_sink_output.GetSinkOutput = (
        capo_oam.types.get_sink_output.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_oam.types.get_sink_output.GetSinkOutput = (
        capo_oam.types.get_sink_output.deserialize_json(
...
def build_request(
    ...
    input_: capo_oam.types.get_sink_input.GetSinkInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_oam.types.get_sink_input.serialize_json(input_)
    ).encode()
...
def get_sink(
    options: OperationOptions, input_: capo_oam.types.get_sink_input.GetSinkInput
) -> tuple[capo_oam.types.get_sink_output.GetSinkOutput, zapros.Response]:
...
async def async_get_sink(
    options: AsyncOperationOptions, input_: capo_oam.types.get_sink_input.GetSinkInput
) -> tuple[capo_oam.types.get_sink_output.GetSinkOutput, zapros.Response]:
