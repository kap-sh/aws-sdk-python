...
def handle_response(
    ...
    out: aws_sdk_emr.types.list_instance_fleets_output.ListInstanceFleetsOutput = (
        aws_sdk_emr.types.list_instance_fleets_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.list_instance_fleets_input.ListInstanceFleetsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.list_instance_fleets_input.serialize_aws_json_1_1(input_)
    ).encode()
