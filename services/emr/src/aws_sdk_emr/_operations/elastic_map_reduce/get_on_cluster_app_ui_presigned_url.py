...
def handle_response(
    ...
    out: aws_sdk_emr.types.get_on_cluster_app_ui_presigned_url_output.GetOnClusterAppUIPresignedURLOutput = aws_sdk_emr.types.get_on_cluster_app_ui_presigned_url_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.get_on_cluster_app_ui_presigned_url_input.GetOnClusterAppUIPresignedURLInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.get_on_cluster_app_ui_presigned_url_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
