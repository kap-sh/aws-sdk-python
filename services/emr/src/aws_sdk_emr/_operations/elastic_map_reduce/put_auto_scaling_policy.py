...
def build_request(
    ...
    input: aws_sdk_emr.types.put_auto_scaling_policy_input.PutAutoScalingPolicyInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.put_auto_scaling_policy_input.serialize_aws_json_1_1(input)
    ).encode()
