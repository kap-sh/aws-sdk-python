...
def handle_response(
    ...
    out: aws_sdk_emr.types.put_auto_scaling_policy_output.PutAutoScalingPolicyOutput = (
        aws_sdk_emr.types.put_auto_scaling_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.put_auto_scaling_policy_input.PutAutoScalingPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.put_auto_scaling_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
