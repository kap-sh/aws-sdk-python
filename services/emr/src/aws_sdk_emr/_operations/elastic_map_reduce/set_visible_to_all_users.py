...
def build_request(
    ...
    input_: aws_sdk_emr.types.set_visible_to_all_users_input.SetVisibleToAllUsersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.set_visible_to_all_users_input.serialize_aws_json_1_1(input_)
    ).encode()
