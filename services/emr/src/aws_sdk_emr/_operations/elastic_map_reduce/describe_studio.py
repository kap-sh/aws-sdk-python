...
def handle_response(
    ...
    out: aws_sdk_emr.types.describe_studio_output.DescribeStudioOutput = (
        aws_sdk_emr.types.describe_studio_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.describe_studio_input.DescribeStudioInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.describe_studio_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_studio(
    ...
    aws_sdk_emr.types.describe_studio_output.DescribeStudioOutput, zapros.Response
]:
