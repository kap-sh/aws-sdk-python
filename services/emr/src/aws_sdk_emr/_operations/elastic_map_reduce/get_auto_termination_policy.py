"""Generated from Smithy shape ``com.amazonaws.emr#GetAutoTerminationPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_emr.types.get_auto_termination_policy_output.GetAutoTerminationPolicyOutput = aws_sdk_emr.types.get_auto_termination_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.get_auto_termination_policy_input.GetAutoTerminationPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.GetAutoTerminationPolicy"
    import aws_sdk_emr.types.get_auto_termination_policy_input

    body: bytes | None = json.dumps(
        aws_sdk_emr.types.get_auto_termination_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_auto_termination_policy(
