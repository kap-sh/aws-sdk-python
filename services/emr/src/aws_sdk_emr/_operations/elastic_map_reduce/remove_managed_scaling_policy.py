...
def handle_response(
    ...
    out: aws_sdk_emr.types.remove_managed_scaling_policy_output.RemoveManagedScalingPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_emr.types.remove_managed_scaling_policy_input.RemoveManagedScalingPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.RemoveManagedScalingPolicy"
    import aws_sdk_emr.types.remove_managed_scaling_policy_input

    body: bytes | None = json.dumps(
        aws_sdk_emr.types.remove_managed_scaling_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_remove_managed_scaling_policy(
