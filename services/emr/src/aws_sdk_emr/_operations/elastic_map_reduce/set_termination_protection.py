"""Generated from Smithy shape ``com.amazonaws.emr#SetTerminationProtection``."""
...
def build_request(
    ...
    input: aws_sdk_emr.types.set_termination_protection_input.SetTerminationProtectionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.set_termination_protection_input.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_set_termination_protection(
