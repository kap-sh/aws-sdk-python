...
def build_request(
    ...
    input_: aws_sdk_emr.types.create_studio_session_mapping_input.CreateStudioSessionMappingInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.create_studio_session_mapping_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
