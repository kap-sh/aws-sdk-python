...
def build_request(
    ...
    input_: aws_sdk_emr.types.describe_persistent_app_ui_input.DescribePersistentAppUIInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.describe_persistent_app_ui_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
