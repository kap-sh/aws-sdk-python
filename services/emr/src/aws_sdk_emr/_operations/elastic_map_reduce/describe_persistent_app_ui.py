...
def handle_response(
    ...
    out: aws_sdk_emr.types.describe_persistent_app_ui_output.DescribePersistentAppUIOutput = aws_sdk_emr.types.describe_persistent_app_ui_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_emr.types.describe_persistent_app_ui_input.DescribePersistentAppUIInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.describe_persistent_app_ui_input.serialize_aws_json_1_1(input)
    ).encode()
