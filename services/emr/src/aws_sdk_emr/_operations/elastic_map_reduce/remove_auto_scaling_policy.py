"""Generated from Smithy shape ``com.amazonaws.emr#RemoveAutoScalingPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_emr.types.remove_auto_scaling_policy_output.RemoveAutoScalingPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_emr.types.remove_auto_scaling_policy_input.RemoveAutoScalingPolicyInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.remove_auto_scaling_policy_input.serialize_aws_json_1_1(input)
    ).encode()
...
async def async_remove_auto_scaling_policy(
