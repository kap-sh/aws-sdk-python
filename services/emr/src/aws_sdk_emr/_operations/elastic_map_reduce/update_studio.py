"""Generated from Smithy shape ``com.amazonaws.emr#UpdateStudio``."""
...
def build_request(
    ...
    input_: aws_sdk_emr.types.update_studio_input.UpdateStudioInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.UpdateStudio"
    import aws_sdk_emr.types.update_studio_input

    body: bytes | None = json.dumps(
        aws_sdk_emr.types.update_studio_input.serialize_aws_json_1_1(input_)
    ).encode()
