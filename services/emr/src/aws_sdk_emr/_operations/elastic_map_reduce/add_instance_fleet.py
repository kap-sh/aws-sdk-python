...
def handle_response(
    ...
    out: aws_sdk_emr.types.add_instance_fleet_output.AddInstanceFleetOutput = (
        aws_sdk_emr.types.add_instance_fleet_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.add_instance_fleet_input.AddInstanceFleetInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.add_instance_fleet_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def add_instance_fleet(
    ...
    aws_sdk_emr.types.add_instance_fleet_output.AddInstanceFleetOutput, zapros.Response
]:
