...
def handle_response(
    ...
    out: aws_sdk_emr.types.create_security_configuration_output.CreateSecurityConfigurationOutput = aws_sdk_emr.types.create_security_configuration_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.create_security_configuration_input.CreateSecurityConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.create_security_configuration_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
