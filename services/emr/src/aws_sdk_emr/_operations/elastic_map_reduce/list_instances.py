...
def handle_response(
    ...
    out: aws_sdk_emr.types.list_instances_output.ListInstancesOutput = (
        aws_sdk_emr.types.list_instances_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.list_instances_input.ListInstancesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.list_instances_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_instances(
    ...
    aws_sdk_emr.types.list_instances_output.ListInstancesOutput, zapros.Response
]:
