...
def handle_response(
    ...
    out: aws_sdk_emr.types.add_job_flow_steps_output.AddJobFlowStepsOutput = (
        aws_sdk_emr.types.add_job_flow_steps_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.add_job_flow_steps_input.AddJobFlowStepsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.add_job_flow_steps_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def add_job_flow_steps(
    ...
    aws_sdk_emr.types.add_job_flow_steps_output.AddJobFlowStepsOutput, zapros.Response
]:
