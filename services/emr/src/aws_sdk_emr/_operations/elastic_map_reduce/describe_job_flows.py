"""Generated from Smithy shape ``com.amazonaws.emr#DescribeJobFlows``."""
...
def handle_response(
    ...
    out: aws_sdk_emr.types.describe_job_flows_output.DescribeJobFlowsOutput = (
        aws_sdk_emr.types.describe_job_flows_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.describe_job_flows_input.DescribeJobFlowsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.describe_job_flows_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_job_flows(
    ...
    aws_sdk_emr.types.describe_job_flows_output.DescribeJobFlowsOutput, zapros.Response
]:
...
async def async_describe_job_flows(
