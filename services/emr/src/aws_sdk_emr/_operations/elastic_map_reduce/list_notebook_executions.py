...
def handle_response(
    ...
    out: aws_sdk_emr.types.list_notebook_executions_output.ListNotebookExecutionsOutput = aws_sdk_emr.types.list_notebook_executions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.list_notebook_executions_input.ListNotebookExecutionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.list_notebook_executions_input.serialize_aws_json_1_1(input_)
    ).encode()
