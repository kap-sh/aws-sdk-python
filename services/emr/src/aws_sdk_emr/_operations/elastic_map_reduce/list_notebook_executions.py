...
def build_request(
    ...
    input: aws_sdk_emr.types.list_notebook_executions_input.ListNotebookExecutionsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.list_notebook_executions_input.serialize_aws_json_1_1(input)
    ).encode()
