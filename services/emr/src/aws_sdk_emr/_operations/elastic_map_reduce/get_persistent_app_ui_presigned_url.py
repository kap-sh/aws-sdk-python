...
def handle_response(
    ...
    out: aws_sdk_emr.types.get_persistent_app_ui_presigned_url_output.GetPersistentAppUIPresignedURLOutput = aws_sdk_emr.types.get_persistent_app_ui_presigned_url_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.get_persistent_app_ui_presigned_url_input.GetPersistentAppUIPresignedURLInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
