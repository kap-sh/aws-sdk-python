...
def build_request(
    ...
    input: aws_sdk_emr.types.modify_instance_fleet_input.ModifyInstanceFleetInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.modify_instance_fleet_input.serialize_aws_json_1_1(input)
    ).encode()
