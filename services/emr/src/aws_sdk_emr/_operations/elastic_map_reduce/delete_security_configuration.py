...
def handle_response(
    ...
    out: aws_sdk_emr.types.delete_security_configuration_output.DeleteSecurityConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_emr.types.delete_security_configuration_input.DeleteSecurityConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.delete_security_configuration_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
