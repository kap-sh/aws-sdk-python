...
def handle_response(
    ...
    out: aws_sdk_emr.types.describe_step_output.DescribeStepOutput = (
        aws_sdk_emr.types.describe_step_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.describe_step_input.DescribeStepInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.describe_step_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_step(
    ...
    input_: aws_sdk_emr.types.describe_step_input.DescribeStepInput,
) -> tuple[aws_sdk_emr.types.describe_step_output.DescribeStepOutput, zapros.Response]:
