...
def handle_response(
    ...
    out: aws_sdk_emr.types.list_release_labels_output.ListReleaseLabelsOutput = (
        aws_sdk_emr.types.list_release_labels_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.list_release_labels_input.ListReleaseLabelsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.list_release_labels_input.serialize_aws_json_1_1(input_)
    ).encode()
