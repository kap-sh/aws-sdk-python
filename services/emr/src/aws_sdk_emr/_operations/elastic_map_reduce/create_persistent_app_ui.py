...
def handle_response(
    ...
    out: aws_sdk_emr.types.create_persistent_app_ui_output.CreatePersistentAppUIOutput = aws_sdk_emr.types.create_persistent_app_ui_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.create_persistent_app_ui_input.CreatePersistentAppUIInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.create_persistent_app_ui_input.serialize_aws_json_1_1(input_)
    ).encode()
