...
def build_request(
    ...
    input: aws_sdk_emr.types.create_persistent_app_ui_input.CreatePersistentAppUIInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.create_persistent_app_ui_input.serialize_aws_json_1_1(input)
    ).encode()
