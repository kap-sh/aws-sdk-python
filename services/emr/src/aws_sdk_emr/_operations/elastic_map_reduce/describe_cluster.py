...
def handle_response(
    ...
    out: aws_sdk_emr.types.describe_cluster_output.DescribeClusterOutput = (
        aws_sdk_emr.types.describe_cluster_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.describe_cluster_input.DescribeClusterInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.describe_cluster_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_cluster(
    ...
    aws_sdk_emr.types.describe_cluster_output.DescribeClusterOutput, zapros.Response
]:
