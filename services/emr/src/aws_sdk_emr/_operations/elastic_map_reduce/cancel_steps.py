...
def build_request(
    ...
    input_: aws_sdk_emr.types.cancel_steps_input.CancelStepsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.cancel_steps_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def cancel_steps(
    ...
    input_: aws_sdk_emr.types.cancel_steps_input.CancelStepsInput,
) -> tuple[aws_sdk_emr.types.cancel_steps_output.CancelStepsOutput, zapros.Response]:
