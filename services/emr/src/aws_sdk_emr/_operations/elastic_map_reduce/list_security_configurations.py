...
def handle_response(
    ...
    out: aws_sdk_emr.types.list_security_configurations_output.ListSecurityConfigurationsOutput = aws_sdk_emr.types.list_security_configurations_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.list_security_configurations_input.ListSecurityConfigurationsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.list_security_configurations_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
