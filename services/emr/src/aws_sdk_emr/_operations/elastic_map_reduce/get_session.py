...
def handle_response(
    ...
    out: aws_sdk_emr.types.get_session_output.GetSessionOutput = (
        aws_sdk_emr.types.get_session_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.get_session_input.GetSessionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.get_session_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_session(
    ...
    input_: aws_sdk_emr.types.get_session_input.GetSessionInput,
) -> tuple[aws_sdk_emr.types.get_session_output.GetSessionOutput, zapros.Response]:
