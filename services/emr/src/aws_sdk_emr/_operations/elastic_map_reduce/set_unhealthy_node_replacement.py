...
def build_request(
    ...
    input_: aws_sdk_emr.types.set_unhealthy_node_replacement_input.SetUnhealthyNodeReplacementInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.set_unhealthy_node_replacement_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
