...
def handle_response(
    ...
    out: aws_sdk_emr.types.get_cluster_session_credentials_output.GetClusterSessionCredentialsOutput = aws_sdk_emr.types.get_cluster_session_credentials_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.get_cluster_session_credentials_input.GetClusterSessionCredentialsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.get_cluster_session_credentials_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
