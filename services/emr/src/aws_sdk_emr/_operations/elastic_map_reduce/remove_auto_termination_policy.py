"""Generated from Smithy shape ``com.amazonaws.emr#RemoveAutoTerminationPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_emr.types.remove_auto_termination_policy_output.RemoveAutoTerminationPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_emr.types.remove_auto_termination_policy_input.RemoveAutoTerminationPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.RemoveAutoTerminationPolicy"
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.remove_auto_termination_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_remove_auto_termination_policy(
