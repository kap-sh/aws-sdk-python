...
def handle_response(
    ...
    out: aws_sdk_emr.types.list_clusters_output.ListClustersOutput = (
        aws_sdk_emr.types.list_clusters_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.list_clusters_input.ListClustersInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.list_clusters_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_clusters(
    ...
    input_: aws_sdk_emr.types.list_clusters_input.ListClustersInput,
) -> tuple[aws_sdk_emr.types.list_clusters_output.ListClustersOutput, zapros.Response]:
