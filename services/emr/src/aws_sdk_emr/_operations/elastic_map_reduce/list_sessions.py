...
def handle_response(
    ...
    out: aws_sdk_emr.types.list_sessions_output.ListSessionsOutput = (
        aws_sdk_emr.types.list_sessions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.list_sessions_input.ListSessionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.list_sessions_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_sessions(
    ...
    input_: aws_sdk_emr.types.list_sessions_input.ListSessionsInput,
) -> tuple[aws_sdk_emr.types.list_sessions_output.ListSessionsOutput, zapros.Response]:
