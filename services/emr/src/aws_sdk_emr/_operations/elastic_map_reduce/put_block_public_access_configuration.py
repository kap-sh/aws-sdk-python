"""Generated from Smithy shape ``com.amazonaws.emr#PutBlockPublicAccessConfiguration``."""
...
def handle_response(
    ...
    out: aws_sdk_emr.types.put_block_public_access_configuration_output.PutBlockPublicAccessConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_emr.types.put_block_public_access_configuration_input.PutBlockPublicAccessConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.put_block_public_access_configuration_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_block_public_access_configuration(
