...
def build_request(
    ...
    input_: aws_sdk_emr.types.stop_notebook_execution_input.StopNotebookExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.stop_notebook_execution_input.serialize_aws_json_1_1(input_)
    ).encode()
