...
def build_request(
    ...
    input: aws_sdk_emr.types.stop_notebook_execution_input.StopNotebookExecutionInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.stop_notebook_execution_input.serialize_aws_json_1_1(input)
    ).encode()
