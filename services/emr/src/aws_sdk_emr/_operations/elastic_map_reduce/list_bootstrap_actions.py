...
def build_request(
    ...
    input: aws_sdk_emr.types.list_bootstrap_actions_input.ListBootstrapActionsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.list_bootstrap_actions_input.serialize_aws_json_1_1(input)
    ).encode()
