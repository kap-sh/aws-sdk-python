...
def handle_response(
    ...
    out: aws_sdk_emr.types.list_bootstrap_actions_output.ListBootstrapActionsOutput = (
        aws_sdk_emr.types.list_bootstrap_actions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.list_bootstrap_actions_input.ListBootstrapActionsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.list_bootstrap_actions_input.serialize_aws_json_1_1(input_)
    ).encode()
