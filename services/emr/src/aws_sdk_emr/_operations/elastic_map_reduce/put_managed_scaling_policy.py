...
def build_request(
    ...
    input_: aws_sdk_emr.types.put_managed_scaling_policy_input.PutManagedScalingPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.put_managed_scaling_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
