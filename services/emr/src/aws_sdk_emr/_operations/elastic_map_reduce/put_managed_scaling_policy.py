...
def handle_response(
    ...
    out: aws_sdk_emr.types.put_managed_scaling_policy_output.PutManagedScalingPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input: aws_sdk_emr.types.put_managed_scaling_policy_input.PutManagedScalingPolicyInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.put_managed_scaling_policy_input.serialize_aws_json_1_1(input)
    ).encode()
