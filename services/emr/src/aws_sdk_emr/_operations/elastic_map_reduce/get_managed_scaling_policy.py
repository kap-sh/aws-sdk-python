...
def handle_response(
    ...
    out: aws_sdk_emr.types.get_managed_scaling_policy_output.GetManagedScalingPolicyOutput = aws_sdk_emr.types.get_managed_scaling_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_emr.types.get_managed_scaling_policy_input.GetManagedScalingPolicyInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.get_managed_scaling_policy_input.serialize_aws_json_1_1(input)
    ).encode()
