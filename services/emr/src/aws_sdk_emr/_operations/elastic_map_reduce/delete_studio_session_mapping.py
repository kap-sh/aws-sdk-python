...
def build_request(
    ...
    input_: aws_sdk_emr.types.delete_studio_session_mapping_input.DeleteStudioSessionMappingInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.delete_studio_session_mapping_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
