"""Generated from Smithy shape ``com.amazonaws.emr#TerminateJobFlows``."""
...
def build_request(
    ...
    input_: aws_sdk_emr.types.terminate_job_flows_input.TerminateJobFlowsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.terminate_job_flows_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_terminate_job_flows(
