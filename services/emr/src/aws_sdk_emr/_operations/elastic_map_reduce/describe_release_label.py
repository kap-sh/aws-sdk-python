...
def build_request(
    ...
    input: aws_sdk_emr.types.describe_release_label_input.DescribeReleaseLabelInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.describe_release_label_input.serialize_aws_json_1_1(input)
    ).encode()
