...
def handle_response(
    ...
    out: aws_sdk_emr.types.describe_release_label_output.DescribeReleaseLabelOutput = (
        aws_sdk_emr.types.describe_release_label_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.describe_release_label_input.DescribeReleaseLabelInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.describe_release_label_input.serialize_aws_json_1_1(input_)
    ).encode()
