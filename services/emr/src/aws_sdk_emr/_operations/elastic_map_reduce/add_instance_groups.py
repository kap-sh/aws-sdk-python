"""Generated from Smithy shape ``com.amazonaws.emr#AddInstanceGroups``."""
...
def handle_response(
    ...
    out: aws_sdk_emr.types.add_instance_groups_output.AddInstanceGroupsOutput = (
        aws_sdk_emr.types.add_instance_groups_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.add_instance_groups_input.AddInstanceGroupsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.add_instance_groups_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_add_instance_groups(
