"""Generated from Smithy shape ``com.amazonaws.emr#ListStudioSessionMappings``."""
...
def handle_response(
    ...
    out: aws_sdk_emr.types.list_studio_session_mappings_output.ListStudioSessionMappingsOutput = aws_sdk_emr.types.list_studio_session_mappings_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.list_studio_session_mappings_input.ListStudioSessionMappingsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.ListStudioSessionMappings"
    import aws_sdk_emr.types.list_studio_session_mappings_input

    body: bytes | None = json.dumps(
        aws_sdk_emr.types.list_studio_session_mappings_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_studio_session_mappings(
