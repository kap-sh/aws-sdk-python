"""Generated from Smithy shape ``com.amazonaws.emr#SetKeepJobFlowAliveWhenNoSteps``."""
...
def build_request(
    ...
    input_: aws_sdk_emr.types.set_keep_job_flow_alive_when_no_steps_input.SetKeepJobFlowAliveWhenNoStepsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_set_keep_job_flow_alive_when_no_steps(
