...
def handle_response(
    ...
    out: aws_sdk_emr.types.get_block_public_access_configuration_output.GetBlockPublicAccessConfigurationOutput = aws_sdk_emr.types.get_block_public_access_configuration_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.get_block_public_access_configuration_input.GetBlockPublicAccessConfigurationInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
