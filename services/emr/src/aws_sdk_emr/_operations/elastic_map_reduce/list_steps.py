...
def build_request(
    ...
    input: aws_sdk_emr.types.list_steps_input.ListStepsInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.list_steps_input.serialize_aws_json_1_1(input)
    ).encode()
...
def list_steps(
    options: OperationOptions, input: aws_sdk_emr.types.list_steps_input.ListStepsInput
