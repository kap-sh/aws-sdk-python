"""Generated from Smithy shape ``com.amazonaws.emr#ListSteps``."""
...
def handle_response(
    ...
    out: aws_sdk_emr.types.list_steps_output.ListStepsOutput = (
        aws_sdk_emr.types.list_steps_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.list_steps_input.ListStepsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.list_steps_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_steps(
    options: OperationOptions, input_: aws_sdk_emr.types.list_steps_input.ListStepsInput
) -> tuple[aws_sdk_emr.types.list_steps_output.ListStepsOutput, zapros.Response]:
