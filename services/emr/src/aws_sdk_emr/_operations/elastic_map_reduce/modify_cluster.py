...
def handle_response(
    ...
    out: aws_sdk_emr.types.modify_cluster_output.ModifyClusterOutput = (
        aws_sdk_emr.types.modify_cluster_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.modify_cluster_input.ModifyClusterInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.modify_cluster_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def modify_cluster(
    ...
    aws_sdk_emr.types.modify_cluster_output.ModifyClusterOutput, zapros.Response
]:
