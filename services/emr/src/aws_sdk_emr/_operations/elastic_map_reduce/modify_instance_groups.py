...
def build_request(
    ...
    input_: aws_sdk_emr.types.modify_instance_groups_input.ModifyInstanceGroupsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.modify_instance_groups_input.serialize_aws_json_1_1(input_)
    ).encode()
