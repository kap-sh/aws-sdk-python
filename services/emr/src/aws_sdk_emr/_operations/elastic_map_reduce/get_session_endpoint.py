"""Generated from Smithy shape ``com.amazonaws.emr#GetSessionEndpoint``."""
...
def handle_response(
    ...
    out: aws_sdk_emr.types.get_session_endpoint_output.GetSessionEndpointOutput = (
        aws_sdk_emr.types.get_session_endpoint_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.get_session_endpoint_input.GetSessionEndpointInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.GetSessionEndpoint"
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.get_session_endpoint_input.serialize_aws_json_1_1(input_)
    ).encode()
