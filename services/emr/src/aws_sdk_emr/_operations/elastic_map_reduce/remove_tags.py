"""Generated from Smithy shape ``com.amazonaws.emr#RemoveTags``."""
...
def handle_response(
    ...
    out: aws_sdk_emr.types.remove_tags_output.RemoveTagsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_emr.types.remove_tags_input.RemoveTagsInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.remove_tags_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def remove_tags(
    ...
    input_: aws_sdk_emr.types.remove_tags_input.RemoveTagsInput,
) -> tuple[aws_sdk_emr.types.remove_tags_output.RemoveTagsOutput, zapros.Response]:
