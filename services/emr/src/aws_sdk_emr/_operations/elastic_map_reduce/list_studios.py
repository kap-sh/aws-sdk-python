"""Generated from Smithy shape ``com.amazonaws.emr#ListStudios``."""
...
def handle_response(
    ...
    out: aws_sdk_emr.types.list_studios_output.ListStudiosOutput = (
        aws_sdk_emr.types.list_studios_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.list_studios_input.ListStudiosInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.ListStudios"
    import aws_sdk_emr.types.list_studios_input

    body: bytes | None = json.dumps(
        aws_sdk_emr.types.list_studios_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_studios(
    ...
    input_: aws_sdk_emr.types.list_studios_input.ListStudiosInput,
) -> tuple[aws_sdk_emr.types.list_studios_output.ListStudiosOutput, zapros.Response]:
