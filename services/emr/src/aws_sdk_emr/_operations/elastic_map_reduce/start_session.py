"""Generated from Smithy shape ``com.amazonaws.emr#StartSession``."""
...
def handle_response(
    ...
    out: aws_sdk_emr.types.start_session_output.StartSessionOutput = (
        aws_sdk_emr.types.start_session_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.start_session_input.StartSessionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.StartSession"
    import aws_sdk_emr.types.start_session_input

    body: bytes | None = json.dumps(
        aws_sdk_emr.types.start_session_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def start_session(
    ...
    input_: aws_sdk_emr.types.start_session_input.StartSessionInput,
) -> tuple[aws_sdk_emr.types.start_session_output.StartSessionOutput, zapros.Response]:
