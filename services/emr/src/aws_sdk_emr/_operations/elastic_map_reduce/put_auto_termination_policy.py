"""Generated from Smithy shape ``com.amazonaws.emr#PutAutoTerminationPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_emr.types.put_auto_termination_policy_output.PutAutoTerminationPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_emr.types.put_auto_termination_policy_input.PutAutoTerminationPolicyInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.PutAutoTerminationPolicy"
    import aws_sdk_emr.types.put_auto_termination_policy_input

    body: bytes | None = json.dumps(
        aws_sdk_emr.types.put_auto_termination_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_put_auto_termination_policy(
