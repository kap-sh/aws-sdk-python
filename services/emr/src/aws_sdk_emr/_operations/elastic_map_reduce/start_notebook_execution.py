...
def handle_response(
    ...
    out: aws_sdk_emr.types.start_notebook_execution_output.StartNotebookExecutionOutput = aws_sdk_emr.types.start_notebook_execution_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.start_notebook_execution_input.StartNotebookExecutionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.start_notebook_execution_input.serialize_aws_json_1_1(input_)
    ).encode()
