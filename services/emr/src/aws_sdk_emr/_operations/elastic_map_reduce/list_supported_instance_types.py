...
def handle_response(
    ...
    out: aws_sdk_emr.types.list_supported_instance_types_output.ListSupportedInstanceTypesOutput = aws_sdk_emr.types.list_supported_instance_types_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.list_supported_instance_types_input.ListSupportedInstanceTypesInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.list_supported_instance_types_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
