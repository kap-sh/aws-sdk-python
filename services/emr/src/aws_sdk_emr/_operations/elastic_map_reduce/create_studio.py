...
def handle_response(
    ...
    out: aws_sdk_emr.types.create_studio_output.CreateStudioOutput = (
        aws_sdk_emr.types.create_studio_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_emr.types.create_studio_input.CreateStudioInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.create_studio_input.serialize_aws_json_1_1(input)
    ).encode()
...
def create_studio(
    ...
    input: aws_sdk_emr.types.create_studio_input.CreateStudioInput,
) -> tuple[aws_sdk_emr.types.create_studio_output.CreateStudioOutput, zapros.Response]:
