...
def handle_response(
    ...
    out: aws_sdk_emr.types.terminate_session_output.TerminateSessionOutput = (
        aws_sdk_emr.types.terminate_session_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_emr.types.terminate_session_input.TerminateSessionInput,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.terminate_session_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def terminate_session(
    ...
    aws_sdk_emr.types.terminate_session_output.TerminateSessionOutput, zapros.Response
]:
