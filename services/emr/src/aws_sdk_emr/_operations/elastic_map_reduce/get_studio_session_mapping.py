...
def handle_response(
    ...
    out: aws_sdk_emr.types.get_studio_session_mapping_output.GetStudioSessionMappingOutput = aws_sdk_emr.types.get_studio_session_mapping_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_emr.types.get_studio_session_mapping_input.GetStudioSessionMappingInput,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_emr.types.get_studio_session_mapping_input.serialize_aws_json_1_1(input)
    ).encode()
