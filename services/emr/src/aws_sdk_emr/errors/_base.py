...
class EMRError(Exception):
    """Base class for all EMR service errors."""


class ServiceError(EMRError):
...
class SerializationError(EMRError):
    """Raised when a value cannot be serialized."""


class DeserializationError(EMRError):
...
class WaiterFailedError(EMRError):
...
class WaiterTimeoutError(EMRError):
