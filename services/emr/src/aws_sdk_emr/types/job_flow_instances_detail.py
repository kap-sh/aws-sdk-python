...
if TYPE_CHECKING:
    ...
    import aws_sdk_emr.types.instance_group_detail_list
...
class JobFlowInstancesDetail(TypedDict):
    ...
    master_public_dns_name: NotRequired["aws_sdk_emr.types.xml_string.XmlString"]
    ...
    master_instance_id: NotRequired["aws_sdk_emr.types.xml_string.XmlString"]
    ...
    instance_groups: NotRequired[
        "aws_sdk_emr.types.instance_group_detail_list.InstanceGroupDetailList"
    ]
...
def serialize_aws_json_1_1(value: JobFlowInstancesDetail) -> dict:
    ...
    if "instance_groups" in value:
        ...
        out["InstanceGroups"] = (
            aws_sdk_emr.types.instance_group_detail_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> JobFlowInstancesDetail:
    ...
    if "InstanceGroups" in data:
        ...
        out["instance_groups"] = (
            aws_sdk_emr.types.instance_group_detail_list.deserialize_aws_json_1_1(
                data["InstanceGroups"]
            )
        )
