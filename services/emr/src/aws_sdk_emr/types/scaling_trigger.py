...
if TYPE_CHECKING:
    import aws_sdk_emr.types.cloud_watch_alarm_definition


class ScalingTrigger(TypedDict):
    cloud_watch_alarm_definition: NotRequired[
        "aws_sdk_emr.types.cloud_watch_alarm_definition.CloudWatchAlarmDefinition"
    ]
...
def serialize_aws_json_1_1(value: ScalingTrigger) -> dict:
    ...
    if "cloud_watch_alarm_definition" in value:
        ...
        out["CloudWatchAlarmDefinition"] = (
            aws_sdk_emr.types.cloud_watch_alarm_definition.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ScalingTrigger:
    ...
    if "CloudWatchAlarmDefinition" in data:
        ...
        out["cloud_watch_alarm_definition"] = (
            aws_sdk_emr.types.cloud_watch_alarm_definition.deserialize_aws_json_1_1(
