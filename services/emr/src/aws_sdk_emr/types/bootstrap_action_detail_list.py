...
if TYPE_CHECKING:
    import aws_sdk_emr.types.bootstrap_action_detail

BootstrapActionDetailList: TypeAlias = list[
    "aws_sdk_emr.types.bootstrap_action_detail.BootstrapActionDetail"
]
...
def serialize_aws_json_1_1(value: BootstrapActionDetailList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_emr.types.bootstrap_action_detail.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> BootstrapActionDetailList:
    ...
    for item in data:
        out.append(
            aws_sdk_emr.types.bootstrap_action_detail.deserialize_aws_json_1_1(item)
        )
    return out
