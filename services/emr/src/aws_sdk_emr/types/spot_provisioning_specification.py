...
if TYPE_CHECKING:
    ...
    import aws_sdk_emr.types.spot_provisioning_timeout_action
...
class SpotProvisioningSpecification(TypedDict):
    ...
    timeout_action: NotRequired[
        "aws_sdk_emr.types.spot_provisioning_timeout_action.SpotProvisioningTimeoutAction"
    ]
    ...
    block_duration_minutes: NotRequired["aws_sdk_emr.types.whole_number.WholeNumber"]
...
def serialize_aws_json_1_1(value: SpotProvisioningSpecification) -> dict:
    ...
    if "timeout_action" in value:
        ...
        out["TimeoutAction"] = (
            aws_sdk_emr.types.spot_provisioning_timeout_action.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SpotProvisioningSpecification:
    ...
    if "TimeoutAction" in data:
        ...
        out["timeout_action"] = (
            aws_sdk_emr.types.spot_provisioning_timeout_action.deserialize_aws_json_1_1(
                data["TimeoutAction"]
            )
        )
