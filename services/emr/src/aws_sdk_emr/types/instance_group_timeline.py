"""Generated from Smithy shape ``com.amazonaws.emr#InstanceGroupTimeline``."""
...
class InstanceGroupTimeline(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: InstanceGroupTimeline) -> dict:
    out: dict = {}
