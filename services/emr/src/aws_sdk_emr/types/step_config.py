...
if TYPE_CHECKING:
    ...
    import aws_sdk_emr.types.hadoop_jar_step_config
    import aws_sdk_emr.types.step_monitoring_configuration
...
class StepConfig(TypedDict):
    ...
    hadoop_jar_step: NotRequired[
        "aws_sdk_emr.types.hadoop_jar_step_config.HadoopJarStepConfig"
    ]
    """<p>The JAR file used for the step.</p>"""
    step_monitoring_configuration: NotRequired[
        "aws_sdk_emr.types.step_monitoring_configuration.StepMonitoringConfiguration"
    ]
...
def serialize_aws_json_1_1(value: StepConfig) -> dict:
    ...
    if "hadoop_jar_step" in value:
        ...
        out["HadoopJarStep"] = (
            aws_sdk_emr.types.hadoop_jar_step_config.serialize_aws_json_1_1(
    ...
    if "step_monitoring_configuration" in value:
        ...
        out["StepMonitoringConfiguration"] = (
            aws_sdk_emr.types.step_monitoring_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> StepConfig:
    ...
    if "HadoopJarStep" in data:
        ...
        out["hadoop_jar_step"] = (
            aws_sdk_emr.types.hadoop_jar_step_config.deserialize_aws_json_1_1(
                data["HadoopJarStep"]
            )
        )
    if "StepMonitoringConfiguration" in data:
        ...
        out["step_monitoring_configuration"] = (
            aws_sdk_emr.types.step_monitoring_configuration.deserialize_aws_json_1_1(
