...
if TYPE_CHECKING:
    import aws_sdk_emr.types.instance_group_modify_config

InstanceGroupModifyConfigList: TypeAlias = list[
    "aws_sdk_emr.types.instance_group_modify_config.InstanceGroupModifyConfig"
]
...
def serialize_aws_json_1_1(value: InstanceGroupModifyConfigList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_emr.types.instance_group_modify_config.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> InstanceGroupModifyConfigList:
    ...
    for item in data:
        out.append(
            aws_sdk_emr.types.instance_group_modify_config.deserialize_aws_json_1_1(
                item
            )
        )
    return out
