...
if TYPE_CHECKING:
    ...
    import aws_sdk_emr.types.throughput_val


class VolumeSpecification(TypedDict):
    volume_type: NotRequired["aws_sdk_emr.types.string.String"]
    """<p>The volume type. Volume types supported are gp3, gp2, io1, st1, sc1, and standard.</p>"""
    iops: NotRequired["aws_sdk_emr.types.integer.Integer"]
    """<p>The number of I/O operations per second (IOPS) that the volume supports.</p>"""
    size_in_gb: NotRequired["aws_sdk_emr.types.integer.Integer"]
    ...
    throughput: NotRequired["aws_sdk_emr.types.throughput_val.ThroughputVal"]
