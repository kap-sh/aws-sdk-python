"""Generated from Smithy shape ``com.amazonaws.emr#ListBootstrapActionsInput``."""
...
class ListBootstrapActionsInput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListBootstrapActionsInput) -> dict:
    out: dict = {}
