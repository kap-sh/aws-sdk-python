...
if TYPE_CHECKING:
    import aws_sdk_emr.types.instance_state_change_reason_code
    import aws_sdk_emr.types.string


class InstanceStateChangeReason(TypedDict):
    code: NotRequired[
        "aws_sdk_emr.types.instance_state_change_reason_code.InstanceStateChangeReasonCode"
    ]
...
def serialize_aws_json_1_1(value: InstanceStateChangeReason) -> dict:
    ...
    if "code" in value:
        ...
        out["Code"] = (
            aws_sdk_emr.types.instance_state_change_reason_code.serialize_aws_json_1_1(
                value["code"]
            )
        )
    if "message" in value:
...
def deserialize_aws_json_1_1(data: dict) -> InstanceStateChangeReason:
    ...
    if "Code" in data:
        ...
        out["code"] = (
            aws_sdk_emr.types.instance_state_change_reason_code.deserialize_aws_json_1_1(
                data["Code"]
            )
        )
    if "Message" in data:
