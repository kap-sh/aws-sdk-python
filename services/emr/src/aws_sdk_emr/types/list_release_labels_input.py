...
class ListReleaseLabelsInput(TypedDict):
    filters: NotRequired["aws_sdk_emr.types.release_label_filter.ReleaseLabelFilter"]
...
def serialize_aws_json_1_1(value: ListReleaseLabelsInput) -> dict:
    ...
    if "filters" in value:
        ...
        out["Filters"] = aws_sdk_emr.types.release_label_filter.serialize_aws_json_1_1(
            value["filters"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListReleaseLabelsInput:
    ...
    if "Filters" in data:
        ...
        out["filters"] = (
            aws_sdk_emr.types.release_label_filter.deserialize_aws_json_1_1(
                data["Filters"]
            )
        )
