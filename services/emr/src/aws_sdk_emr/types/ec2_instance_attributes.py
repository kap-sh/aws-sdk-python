...
class Ec2InstanceAttributes(TypedDict):
    ...
    ec2_availability_zone: NotRequired["aws_sdk_emr.types.string.String"]
    ...
    iam_instance_profile: NotRequired["aws_sdk_emr.types.string.String"]
    ...
    emr_managed_master_security_group: NotRequired["aws_sdk_emr.types.string.String"]
    """<p>The identifier of the Amazon EC2 security group for the master node.</p>"""
    emr_managed_slave_security_group: NotRequired["aws_sdk_emr.types.string.String"]
    """<p>The identifier of the Amazon EC2 security group for the core and task nodes.</p>"""
    service_access_security_group: NotRequired["aws_sdk_emr.types.string.String"]
    ...
    additional_master_security_groups: NotRequired[
        "aws_sdk_emr.types.string_list.StringList"
    ]
...
def serialize_aws_json_1_1(value: Ec2InstanceAttributes) -> dict:
    ...
    if "additional_master_security_groups" in value:
        ...
        out["AdditionalMasterSecurityGroups"] = (
            aws_sdk_emr.types.string_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Ec2InstanceAttributes:
    ...
    if "AdditionalMasterSecurityGroups" in data:
        ...
        out["additional_master_security_groups"] = (
            aws_sdk_emr.types.string_list.deserialize_aws_json_1_1(
