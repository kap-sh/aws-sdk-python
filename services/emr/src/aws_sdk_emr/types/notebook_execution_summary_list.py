...
NotebookExecutionSummaryList: TypeAlias = list[
    "aws_sdk_emr.types.notebook_execution_summary.NotebookExecutionSummary"
]
...
def serialize_aws_json_1_1(value: NotebookExecutionSummaryList) -> list:
    ...
    for item in value:
        out.append(
            aws_sdk_emr.types.notebook_execution_summary.serialize_aws_json_1_1(item)
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> NotebookExecutionSummaryList:
    ...
    for item in data:
        out.append(
            aws_sdk_emr.types.notebook_execution_summary.deserialize_aws_json_1_1(item)
        )
    return out
