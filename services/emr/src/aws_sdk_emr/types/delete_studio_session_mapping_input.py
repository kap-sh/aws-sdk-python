"""Generated from Smithy shape ``com.amazonaws.emr#DeleteStudioSessionMappingInput``."""
...
class DeleteStudioSessionMappingInput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteStudioSessionMappingInput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeleteStudioSessionMappingInput:
    out: DeleteStudioSessionMappingInput = {}  # type: ignore[typeddict-item]
    if "StudioId" in data:
