...
class ListSessionsOutput(TypedDict, closed=True):
    sessions: NotRequired["capo_emr.types.session_list.SessionList"]
...
def serialize_aws_json_1_1(value: ListSessionsOutput) -> dict:
    ...
    if "sessions" in value:
        ...
        out["Sessions"] = capo_emr.types.session_list.serialize_aws_json_1_1(
            value["sessions"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListSessionsOutput:
    ...
    if "Sessions" in data:
        ...
        out["sessions"] = capo_emr.types.session_list.deserialize_aws_json_1_1(
            data["Sessions"]
        )
