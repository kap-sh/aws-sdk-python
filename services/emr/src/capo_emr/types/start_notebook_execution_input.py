...
class StartNotebookExecutionInput(TypedDict, closed=True):
    ...
    relative_path: NotRequired["capo_emr.types.xml_string.XmlString"]
...
def serialize_aws_json_1_1(value: StartNotebookExecutionInput) -> dict:
    ...
    if "notebook_s3_location" in value:
        ...
        out["NotebookS3Location"] = (
            capo_emr.types.notebook_s3_location_from_input.serialize_aws_json_1_1(
    ...
    if "output_notebook_s3_location" in value:
        ...
        out["OutputNotebookS3Location"] = (
            capo_emr.types.output_notebook_s3_location_from_input.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> StartNotebookExecutionInput:
    ...
    if "NotebookS3Location" in data:
        ...
        out["notebook_s3_location"] = (
            capo_emr.types.notebook_s3_location_from_input.deserialize_aws_json_1_1(
    ...
    if "OutputNotebookS3Location" in data:
        ...
        out["output_notebook_s3_location"] = (
            capo_emr.types.output_notebook_s3_location_from_input.deserialize_aws_json_1_1(
