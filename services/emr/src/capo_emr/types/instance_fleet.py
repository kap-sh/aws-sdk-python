...
class InstanceFleet(TypedDict, closed=True):
    id: NotRequired["capo_emr.types.instance_fleet_id.InstanceFleetId"]
    ...
    status: NotRequired["capo_emr.types.instance_fleet_status.InstanceFleetStatus"]
    ...
    provisioned_on_demand_capacity: NotRequired[
        "capo_emr.types.whole_number.WholeNumber"
    ]
    ...
    provisioned_spot_capacity: NotRequired["capo_emr.types.whole_number.WholeNumber"]
    ...
    instance_type_specifications: NotRequired[
        "capo_emr.types.instance_type_specification_list.InstanceTypeSpecificationList"
    ]
...
def serialize_aws_json_1_1(value: InstanceFleet) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = capo_emr.types.instance_fleet_status.serialize_aws_json_1_1(
            value["status"]
        )
    ...
    if "instance_type_specifications" in value:
        ...
        out["InstanceTypeSpecifications"] = (
            capo_emr.types.instance_type_specification_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InstanceFleet:
    ...
    if "InstanceTypeSpecifications" in data:
        ...
        out["instance_type_specifications"] = (
            capo_emr.types.instance_type_specification_list.deserialize_aws_json_1_1(
