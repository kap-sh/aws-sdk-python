...
if TYPE_CHECKING:
    ...
    import capo_emr.types.studio_summary_list


class ListStudiosOutput(TypedDict, closed=True):
    studios: NotRequired["capo_emr.types.studio_summary_list.StudioSummaryList"]
...
def serialize_aws_json_1_1(value: ListStudiosOutput) -> dict:
    ...
    if "studios" in value:
        ...
        out["Studios"] = capo_emr.types.studio_summary_list.serialize_aws_json_1_1(
            value["studios"]
        )
    if "marker" in value:
...
def deserialize_aws_json_1_1(data: dict) -> ListStudiosOutput:
    ...
    if "Studios" in data:
        ...
        out["studios"] = capo_emr.types.studio_summary_list.deserialize_aws_json_1_1(
            data["Studios"]
        )
    if "Marker" in data:
