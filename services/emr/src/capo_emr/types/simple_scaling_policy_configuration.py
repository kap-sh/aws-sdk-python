...
class SimpleScalingPolicyConfiguration(TypedDict, closed=True):
    adjustment_type: NotRequired["capo_emr.types.adjustment_type.AdjustmentType"]
    ...
    scaling_adjustment: NotRequired["capo_emr.types.integer.Integer"]
    ...
    cool_down: NotRequired["capo_emr.types.integer.Integer"]
...
def serialize_aws_json_1_1(value: SimpleScalingPolicyConfiguration) -> dict:
    ...
    if "adjustment_type" in value:
        ...
        out["AdjustmentType"] = capo_emr.types.adjustment_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SimpleScalingPolicyConfiguration:
    ...
    if "AdjustmentType" in data:
        ...
        out["adjustment_type"] = (
            capo_emr.types.adjustment_type.deserialize_aws_json_1_1(
                data["AdjustmentType"]
            )
        )
