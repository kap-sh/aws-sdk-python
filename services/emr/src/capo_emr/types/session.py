...
class Session(TypedDict, closed=True):
    ...
    state_change_reason: NotRequired["capo_emr.types.xml_string.XmlString"]
...
def serialize_aws_json_1_1(value: Session) -> dict:
    ...
    if "created_at" in value:
        ...
        out["CreatedAt"] = capo_emr.types.date.serialize_aws_json_1_1(
            value["created_at"]
        )
    if "updated_at" in value:
        import capo_emr.types.date

        out["UpdatedAt"] = capo_emr.types.date.serialize_aws_json_1_1(
            value["updated_at"]
        )
    if "started_at" in value:
        import capo_emr.types.date

        out["StartedAt"] = capo_emr.types.date.serialize_aws_json_1_1(
            value["started_at"]
        )
    if "ended_at" in value:
        import capo_emr.types.date

        out["EndedAt"] = capo_emr.types.date.serialize_aws_json_1_1(value["ended_at"])
    if "idle_since" in value:
        import capo_emr.types.date

        out["IdleSince"] = capo_emr.types.date.serialize_aws_json_1_1(
            value["idle_since"]
        )
    ...
    if "monitoring_configuration" in value:
        ...
        out["MonitoringConfiguration"] = (
            capo_emr.types.session_monitoring_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Session:
    ...
    if "MonitoringConfiguration" in data:
        ...
        out["monitoring_configuration"] = (
            capo_emr.types.session_monitoring_configuration.deserialize_aws_json_1_1(
