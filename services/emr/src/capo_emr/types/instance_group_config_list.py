...
if TYPE_CHECKING:
    import capo_emr.types.instance_group_config

InstanceGroupConfigList: TypeAlias = list[
    "capo_emr.types.instance_group_config.InstanceGroupConfig"
]
...
def serialize_aws_json_1_1(value: InstanceGroupConfigList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_emr.types.instance_group_config.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> InstanceGroupConfigList:
    ...
    for item in data:
        out.append(capo_emr.types.instance_group_config.deserialize_aws_json_1_1(item))
    return out
