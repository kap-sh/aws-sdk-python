...
class Instance(TypedDict, closed=True):
    id: NotRequired["capo_emr.types.instance_id.InstanceId"]
    """<p>The unique identifier for the instance in Amazon EMR.</p>"""
    ec2_instance_id: NotRequired["capo_emr.types.instance_id.InstanceId"]
    """<p>The unique identifier of the instance in Amazon EC2.</p>"""
    public_dns_name: NotRequired["capo_emr.types.string.String"]
    """<p>The public DNS name of the instance.</p>"""
    public_ip_address: NotRequired["capo_emr.types.string.String"]
    """<p>The public IP address of the instance.</p>"""
    private_dns_name: NotRequired["capo_emr.types.string.String"]
    """<p>The private DNS name of the instance.</p>"""
    private_ip_address: NotRequired["capo_emr.types.string.String"]
    """<p>The private IP address of the instance.</p>"""
    status: NotRequired["capo_emr.types.instance_status.InstanceStatus"]
    """<p>The current status of the instance.</p>"""
    instance_group_id: NotRequired["capo_emr.types.string.String"]
    ...
    ebs_volumes: NotRequired["capo_emr.types.ebs_volume_list.EbsVolumeList"]
...
def serialize_aws_json_1_1(value: Instance) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = capo_emr.types.instance_status.serialize_aws_json_1_1(
            value["status"]
        )
    ...
    if "ebs_volumes" in value:
        ...
        out["EbsVolumes"] = capo_emr.types.ebs_volume_list.serialize_aws_json_1_1(
            value["ebs_volumes"]
        )
    return out
