...
InstanceFleetList: TypeAlias = list["capo_emr.types.instance_fleet.InstanceFleet"]
...
def serialize_aws_json_1_1(value: InstanceFleetList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_emr.types.instance_fleet.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> InstanceFleetList:
    ...
    for item in data:
        out.append(capo_emr.types.instance_fleet.deserialize_aws_json_1_1(item))
    return out
