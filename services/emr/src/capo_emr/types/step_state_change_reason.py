...
if TYPE_CHECKING:
    import capo_emr.types.step_state_change_reason_code
...
def serialize_aws_json_1_1(value: StepStateChangeReason) -> dict:
    ...
    if "code" in value:
        ...
        out["Code"] = (
            capo_emr.types.step_state_change_reason_code.serialize_aws_json_1_1(
                value["code"]
            )
        )
    if "message" in value:
...
def deserialize_aws_json_1_1(data: dict) -> StepStateChangeReason:
    ...
    if "Code" in data:
        ...
        out["code"] = (
            capo_emr.types.step_state_change_reason_code.deserialize_aws_json_1_1(
                data["Code"]
            )
        )
    if "Message" in data:
