...
class InstanceGroup(TypedDict, closed=True):
    id: NotRequired["capo_emr.types.instance_group_id.InstanceGroupId"]
    ...
    bid_price: NotRequired["capo_emr.types.string.String"]
    ...
    requested_instance_count: NotRequired["capo_emr.types.integer.Integer"]
    """<p>The target number of instances for the instance group.</p>"""
    running_instance_count: NotRequired["capo_emr.types.integer.Integer"]
    """<p>The number of instances currently running in this instance group.</p>"""
    status: NotRequired["capo_emr.types.instance_group_status.InstanceGroupStatus"]
    ...
    configurations_version: NotRequired["capo_emr.types.long.Long"]
    ...
    ebs_block_devices: NotRequired[
        "capo_emr.types.ebs_block_device_list.EbsBlockDeviceList"
    ]
    """<p>The EBS block devices that are mapped to this instance group.</p>"""
    ebs_optimized: NotRequired["capo_emr.types.boolean_object.BooleanObject"]
...
def serialize_aws_json_1_1(value: InstanceGroup) -> dict:
    ...
    if "instance_group_type" in value:
        ...
        out["InstanceGroupType"] = (
            capo_emr.types.instance_group_type.serialize_aws_json_1_1(
    ...
    if "status" in value:
        ...
        out["Status"] = capo_emr.types.instance_group_status.serialize_aws_json_1_1(
            value["status"]
        )
    ...
    if "ebs_block_devices" in value:
        ...
        out["EbsBlockDevices"] = (
            capo_emr.types.ebs_block_device_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InstanceGroup:
    ...
    if "InstanceGroupType" in data:
        ...
        out["instance_group_type"] = (
            capo_emr.types.instance_group_type.deserialize_aws_json_1_1(
    ...
    if "EbsBlockDevices" in data:
        ...
        out["ebs_block_devices"] = (
            capo_emr.types.ebs_block_device_list.deserialize_aws_json_1_1(
