"""Generated from Smithy shape ``com.amazonaws.emr#CreateSecurityConfigurationOutput``."""
...
class CreateSecurityConfigurationOutput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateSecurityConfigurationOutput) -> dict:
    out: dict = {}
    if "name" in value:
        out["Name"] = value["name"]
...
def deserialize_aws_json_1_1(data: dict) -> CreateSecurityConfigurationOutput:
    out: CreateSecurityConfigurationOutput = {}  # type: ignore[typeddict-item]
    if "Name" in data:
        out["name"] = data["Name"]
