"""Generated from Smithy shape ``com.amazonaws.emr#ListReleaseLabels``."""
...
import capo_emr.errors.internal_server_exception
import capo_emr.errors.invalid_request_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InternalServerException":
            raise capo_emr.errors.internal_server_exception.InternalServerException.from_aws_json_1_1(
                data
            )
        case "InvalidRequestException":
            raise capo_emr.errors.invalid_request_exception.InvalidRequestException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_emr.types.list_release_labels_output.ListReleaseLabelsOutput = (
        capo_emr.types.list_release_labels_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.ListReleaseLabels"
    body: bytes | None = json.dumps(
        capo_emr.types.list_release_labels_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_release_labels(
    ...
    capo_emr.types.list_release_labels_output.ListReleaseLabelsOutput, zapros.Response
]:
...
async def async_list_release_labels(
