"""Generated from Smithy shape ``com.amazonaws.emr#StartNotebookExecution``."""
...
def handle_response(
    ...
    out: capo_emr.types.start_notebook_execution_output.StartNotebookExecutionOutput = (
        capo_emr.types.start_notebook_execution_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.StartNotebookExecution"
    body: bytes | None = json.dumps(
        capo_emr.types.start_notebook_execution_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_start_notebook_execution(
