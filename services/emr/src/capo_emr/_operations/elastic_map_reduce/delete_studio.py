"""Generated from Smithy shape ``com.amazonaws.emr#DeleteStudio``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.DeleteStudio"
    body: bytes | None = json.dumps(
        capo_emr.types.delete_studio_input.serialize_aws_json_1_1(input_)
    ).encode()
