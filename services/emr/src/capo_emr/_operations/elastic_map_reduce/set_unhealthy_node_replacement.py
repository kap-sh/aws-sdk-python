"""Generated from Smithy shape ``com.amazonaws.emr#SetUnhealthyNodeReplacement``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.SetUnhealthyNodeReplacement"
    body: bytes | None = json.dumps(
        capo_emr.types.set_unhealthy_node_replacement_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_set_unhealthy_node_replacement(
