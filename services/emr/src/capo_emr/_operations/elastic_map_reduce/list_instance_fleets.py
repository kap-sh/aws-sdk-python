"""Generated from Smithy shape ``com.amazonaws.emr#ListInstanceFleets``."""
...
def handle_response(
    ...
    out: capo_emr.types.list_instance_fleets_output.ListInstanceFleetsOutput = (
        capo_emr.types.list_instance_fleets_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.list_instance_fleets_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_instance_fleets(
    ...
    capo_emr.types.list_instance_fleets_output.ListInstanceFleetsOutput, zapros.Response
]:
...
async def async_list_instance_fleets(
