"""Generated from Smithy shape ``com.amazonaws.emr#ListInstances``."""
...
def handle_response(
    ...
    out: capo_emr.types.list_instances_output.ListInstancesOutput = (
        capo_emr.types.list_instances_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.list_instances_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_instances(
    ...
    input_: capo_emr.types.list_instances_input.ListInstancesInput,
) -> tuple[capo_emr.types.list_instances_output.ListInstancesOutput, zapros.Response]:
