"""Generated from Smithy shape ``com.amazonaws.emr#ModifyInstanceFleet``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.modify_instance_fleet_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_modify_instance_fleet(
