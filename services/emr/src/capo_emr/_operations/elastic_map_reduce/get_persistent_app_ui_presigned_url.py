"""Generated from Smithy shape ``com.amazonaws.emr#GetPersistentAppUIPresignedURL``."""
...
def handle_response(
    ...
    out: capo_emr.types.get_persistent_app_ui_presigned_url_output.GetPersistentAppUIPresignedURLOutput = capo_emr.types.get_persistent_app_ui_presigned_url_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.get_persistent_app_ui_presigned_url_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_persistent_app_ui_presigned_url(
