"""Generated from Smithy shape ``com.amazonaws.emr#GetClusterSessionCredentials``."""
...
def handle_response(
    ...
    out: capo_emr.types.get_cluster_session_credentials_output.GetClusterSessionCredentialsOutput = capo_emr.types.get_cluster_session_credentials_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.GetClusterSessionCredentials"
    body: bytes | None = json.dumps(
        capo_emr.types.get_cluster_session_credentials_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_cluster_session_credentials(
