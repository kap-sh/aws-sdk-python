"""Generated from Smithy shape ``com.amazonaws.emr#ModifyCluster``."""
...
def handle_response(
    ...
    out: capo_emr.types.modify_cluster_output.ModifyClusterOutput = (
        capo_emr.types.modify_cluster_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.modify_cluster_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def modify_cluster(
    ...
    input_: capo_emr.types.modify_cluster_input.ModifyClusterInput,
) -> tuple[capo_emr.types.modify_cluster_output.ModifyClusterOutput, zapros.Response]:
