...
def handle_response(
    ...
    out: capo_emr.types.describe_security_configuration_output.DescribeSecurityConfigurationOutput = capo_emr.types.describe_security_configuration_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.describe_security_configuration_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
