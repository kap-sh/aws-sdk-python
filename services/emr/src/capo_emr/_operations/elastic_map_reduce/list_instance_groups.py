"""Generated from Smithy shape ``com.amazonaws.emr#ListInstanceGroups``."""
...
def handle_response(
    ...
    out: capo_emr.types.list_instance_groups_output.ListInstanceGroupsOutput = (
        capo_emr.types.list_instance_groups_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.list_instance_groups_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_instance_groups(
    ...
    capo_emr.types.list_instance_groups_output.ListInstanceGroupsOutput, zapros.Response
]:
...
async def async_list_instance_groups(
