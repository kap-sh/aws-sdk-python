"""Generated from Smithy shape ``com.amazonaws.emr#AddTags``."""
...
def handle_response(
    ...
    out: capo_emr.types.add_tags_output.AddTagsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.add_tags_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def add_tags(
    options: OperationOptions, input_: capo_emr.types.add_tags_input.AddTagsInput
) -> tuple[capo_emr.types.add_tags_output.AddTagsOutput, zapros.Response]:
...
async def async_add_tags(
    options: AsyncOperationOptions, input_: capo_emr.types.add_tags_input.AddTagsInput
) -> tuple[capo_emr.types.add_tags_output.AddTagsOutput, zapros.Response]:
