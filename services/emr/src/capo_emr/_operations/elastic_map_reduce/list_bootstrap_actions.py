"""Generated from Smithy shape ``com.amazonaws.emr#ListBootstrapActions``."""
...
def handle_response(
    ...
    out: capo_emr.types.list_bootstrap_actions_output.ListBootstrapActionsOutput = (
        capo_emr.types.list_bootstrap_actions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.list_bootstrap_actions_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_bootstrap_actions(
