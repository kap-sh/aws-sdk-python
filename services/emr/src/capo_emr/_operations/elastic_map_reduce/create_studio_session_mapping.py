"""Generated from Smithy shape ``com.amazonaws.emr#CreateStudioSessionMapping``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.CreateStudioSessionMapping"
    body: bytes | None = json.dumps(
        capo_emr.types.create_studio_session_mapping_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_studio_session_mapping(
