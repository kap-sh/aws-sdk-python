"""Generated from Smithy shape ``com.amazonaws.emr#ListSessions``."""
...
import capo_emr.types.session_list
...
def handle_response(
    ...
    out: capo_emr.types.list_sessions_output.ListSessionsOutput = (
        capo_emr.types.list_sessions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.ListSessions"
    body: bytes | None = json.dumps(
        capo_emr.types.list_sessions_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_sessions(
    ...
    input_: capo_emr.types.list_sessions_input.ListSessionsInput,
) -> tuple[capo_emr.types.list_sessions_output.ListSessionsOutput, zapros.Response]:
