"""Generated from Smithy shape ``com.amazonaws.emr#SetVisibleToAllUsers``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.set_visible_to_all_users_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_set_visible_to_all_users(
