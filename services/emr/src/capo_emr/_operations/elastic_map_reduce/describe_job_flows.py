...
def handle_response(
    ...
    out: capo_emr.types.describe_job_flows_output.DescribeJobFlowsOutput = (
        capo_emr.types.describe_job_flows_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.describe_job_flows_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_job_flows(
    ...
    capo_emr.types.describe_job_flows_output.DescribeJobFlowsOutput, zapros.Response
]:
