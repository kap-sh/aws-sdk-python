"""Generated from Smithy shape ``com.amazonaws.emr#DeleteSecurityConfiguration``."""
...
def handle_response(
    ...
    out: capo_emr.types.delete_security_configuration_output.DeleteSecurityConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.delete_security_configuration_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_security_configuration(
