"""Generated from Smithy shape ``com.amazonaws.emr#GetStudioSessionMapping``."""
...
def handle_response(
    ...
    out: capo_emr.types.get_studio_session_mapping_output.GetStudioSessionMappingOutput = capo_emr.types.get_studio_session_mapping_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.GetStudioSessionMapping"
    body: bytes | None = json.dumps(
        capo_emr.types.get_studio_session_mapping_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_studio_session_mapping(
