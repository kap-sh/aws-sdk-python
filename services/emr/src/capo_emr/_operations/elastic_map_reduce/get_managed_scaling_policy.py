"""Generated from Smithy shape ``com.amazonaws.emr#GetManagedScalingPolicy``."""
...
def handle_response(
    ...
    out: capo_emr.types.get_managed_scaling_policy_output.GetManagedScalingPolicyOutput = capo_emr.types.get_managed_scaling_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.GetManagedScalingPolicy"
    body: bytes | None = json.dumps(
        capo_emr.types.get_managed_scaling_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_managed_scaling_policy(
