"""Generated from Smithy shape ``com.amazonaws.emr#StopNotebookExecution``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.StopNotebookExecution"
    body: bytes | None = json.dumps(
        capo_emr.types.stop_notebook_execution_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_stop_notebook_execution(
