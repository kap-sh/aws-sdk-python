"""Generated from Smithy shape ``com.amazonaws.emr#DescribeStep``."""
...
def handle_response(
    ...
    out: capo_emr.types.describe_step_output.DescribeStepOutput = (
        capo_emr.types.describe_step_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.describe_step_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_step(
    ...
    input_: capo_emr.types.describe_step_input.DescribeStepInput,
) -> tuple[capo_emr.types.describe_step_output.DescribeStepOutput, zapros.Response]:
