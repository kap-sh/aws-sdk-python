"""Generated from Smithy shape ``com.amazonaws.emr#DescribeNotebookExecution``."""
...
def handle_response(
    ...
    out: capo_emr.types.describe_notebook_execution_output.DescribeNotebookExecutionOutput = capo_emr.types.describe_notebook_execution_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.DescribeNotebookExecution"
    body: bytes | None = json.dumps(
        capo_emr.types.describe_notebook_execution_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_notebook_execution(
