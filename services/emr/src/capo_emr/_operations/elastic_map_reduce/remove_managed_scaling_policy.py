...
def handle_response(
    ...
    out: capo_emr.types.remove_managed_scaling_policy_output.RemoveManagedScalingPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.remove_managed_scaling_policy_input.serialize_aws_json_1_1(
            input_
        )
    ).encode()
