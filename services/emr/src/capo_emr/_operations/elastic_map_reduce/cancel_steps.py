"""Generated from Smithy shape ``com.amazonaws.emr#CancelSteps``."""
...
import capo_emr.types.cancel_steps_info_list
...
def handle_response(
    ...
    out: capo_emr.types.cancel_steps_output.CancelStepsOutput = (
        capo_emr.types.cancel_steps_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.cancel_steps_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def cancel_steps(
    ...
    input_: capo_emr.types.cancel_steps_input.CancelStepsInput,
) -> tuple[capo_emr.types.cancel_steps_output.CancelStepsOutput, zapros.Response]:
