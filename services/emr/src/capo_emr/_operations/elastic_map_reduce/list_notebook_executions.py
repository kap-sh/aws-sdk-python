"""Generated from Smithy shape ``com.amazonaws.emr#ListNotebookExecutions``."""
...
def handle_response(
    ...
    out: capo_emr.types.list_notebook_executions_output.ListNotebookExecutionsOutput = (
        capo_emr.types.list_notebook_executions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.ListNotebookExecutions"
    body: bytes | None = json.dumps(
        capo_emr.types.list_notebook_executions_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_notebook_executions(
