"""Generated from Smithy shape ``com.amazonaws.emr#ListSecurityConfigurations``."""
...
def handle_response(
    ...
    out: capo_emr.types.list_security_configurations_output.ListSecurityConfigurationsOutput = capo_emr.types.list_security_configurations_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.list_security_configurations_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_security_configurations(
