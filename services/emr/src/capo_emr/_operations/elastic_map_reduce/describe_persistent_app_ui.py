"""Generated from Smithy shape ``com.amazonaws.emr#DescribePersistentAppUI``."""
...
def handle_response(
    ...
    out: capo_emr.types.describe_persistent_app_ui_output.DescribePersistentAppUIOutput = capo_emr.types.describe_persistent_app_ui_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.DescribePersistentAppUI"
    body: bytes | None = json.dumps(
        capo_emr.types.describe_persistent_app_ui_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_persistent_app_ui(
