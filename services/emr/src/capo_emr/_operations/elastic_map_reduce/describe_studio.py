"""Generated from Smithy shape ``com.amazonaws.emr#DescribeStudio``."""
...
def handle_response(
    ...
    out: capo_emr.types.describe_studio_output.DescribeStudioOutput = (
        capo_emr.types.describe_studio_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.DescribeStudio"
    body: bytes | None = json.dumps(
        capo_emr.types.describe_studio_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def describe_studio(
    ...
    input_: capo_emr.types.describe_studio_input.DescribeStudioInput,
) -> tuple[capo_emr.types.describe_studio_output.DescribeStudioOutput, zapros.Response]:
...
async def async_describe_studio(
