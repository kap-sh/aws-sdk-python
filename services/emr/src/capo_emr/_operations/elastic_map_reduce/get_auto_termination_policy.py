...
def handle_response(
    ...
    out: capo_emr.types.get_auto_termination_policy_output.GetAutoTerminationPolicyOutput = capo_emr.types.get_auto_termination_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.get_auto_termination_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
