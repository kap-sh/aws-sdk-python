"""Generated from Smithy shape ``com.amazonaws.emr#PutManagedScalingPolicy``."""
...
def handle_response(
    ...
    out: capo_emr.types.put_managed_scaling_policy_output.PutManagedScalingPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.PutManagedScalingPolicy"
    body: bytes | None = json.dumps(
        capo_emr.types.put_managed_scaling_policy_input.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_put_managed_scaling_policy(
