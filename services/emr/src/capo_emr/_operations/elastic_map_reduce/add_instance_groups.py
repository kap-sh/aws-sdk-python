...
def handle_response(
    ...
    out: capo_emr.types.add_instance_groups_output.AddInstanceGroupsOutput = (
        capo_emr.types.add_instance_groups_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.add_instance_groups_input.serialize_aws_json_1_1(input_)
    ).encode()
...
def add_instance_groups(
    ...
    capo_emr.types.add_instance_groups_output.AddInstanceGroupsOutput, zapros.Response
]:
