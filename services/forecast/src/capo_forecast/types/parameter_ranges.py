...
if TYPE_CHECKING:
    import capo_forecast.types.categorical_parameter_ranges
    import capo_forecast.types.continuous_parameter_ranges
    import capo_forecast.types.integer_parameter_ranges


class ParameterRanges(TypedDict, closed=True):
    categorical_parameter_ranges: NotRequired[
        "capo_forecast.types.categorical_parameter_ranges.CategoricalParameterRanges"
    ]
    """<p>Specifies the tunable range for each categorical hyperparameter.</p>"""
    continuous_parameter_ranges: NotRequired[
        "capo_forecast.types.continuous_parameter_ranges.ContinuousParameterRanges"
    ]
    """<p>Specifies the tunable range for each continuous hyperparameter.</p>"""
    integer_parameter_ranges: NotRequired[
        "capo_forecast.types.integer_parameter_ranges.IntegerParameterRanges"
    ]
...
def serialize_aws_json_1_1(value: ParameterRanges) -> dict:
    ...
    if "categorical_parameter_ranges" in value:
        ...
        out["CategoricalParameterRanges"] = (
            capo_forecast.types.categorical_parameter_ranges.serialize_aws_json_1_1(
    ...
    if "continuous_parameter_ranges" in value:
        ...
        out["ContinuousParameterRanges"] = (
            capo_forecast.types.continuous_parameter_ranges.serialize_aws_json_1_1(
    ...
    if "integer_parameter_ranges" in value:
        ...
        out["IntegerParameterRanges"] = (
            capo_forecast.types.integer_parameter_ranges.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ParameterRanges:
    ...
    if "CategoricalParameterRanges" in data:
        ...
        out["categorical_parameter_ranges"] = (
            capo_forecast.types.categorical_parameter_ranges.deserialize_aws_json_1_1(
    ...
    if "ContinuousParameterRanges" in data:
        ...
        out["continuous_parameter_ranges"] = (
            capo_forecast.types.continuous_parameter_ranges.deserialize_aws_json_1_1(
    ...
    if "IntegerParameterRanges" in data:
        ...
        out["integer_parameter_ranges"] = (
            capo_forecast.types.integer_parameter_ranges.deserialize_aws_json_1_1(
