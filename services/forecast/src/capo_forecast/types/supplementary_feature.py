...
class SupplementaryFeature(TypedDict, closed=True):
    name: "capo_forecast.types.name.Name"
    r"""<p>The name of the feature. Valid values: <code>\"holiday\"</code> and <code>\"weather\"</code>.</p>"""
    value: "capo_forecast.types.value.Value"
