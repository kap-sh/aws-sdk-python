...
def serialize_aws_json_1_1(value: TimeAlignmentBoundary) -> dict:
    ...
    if "month" in value:
        ...
        out["Month"] = capo_forecast.types.month.serialize_aws_json_1_1(value["month"])
    if "day_of_month" in value:
        out["DayOfMonth"] = value["day_of_month"]
    if "day_of_week" in value:
        import capo_forecast.types.day_of_week

        out["DayOfWeek"] = capo_forecast.types.day_of_week.serialize_aws_json_1_1(
            value["day_of_week"]
        )
    if "hour" in value:
        out["Hour"] = value["hour"]
