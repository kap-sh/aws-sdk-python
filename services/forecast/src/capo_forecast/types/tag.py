...
if TYPE_CHECKING:
    import capo_forecast.types.tag_key
    import capo_forecast.types.tag_value


class Tag(TypedDict, closed=True):
    key: "capo_forecast.types.tag_key.TagKey"
    ...
    value: "capo_forecast.types.tag_value.TagValue"
