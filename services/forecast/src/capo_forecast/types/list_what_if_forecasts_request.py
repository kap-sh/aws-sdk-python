"""Generated from Smithy shape ``com.amazonaws.forecast#ListWhatIfForecastsRequest``."""
...
class ListWhatIfForecastsRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListWhatIfForecastsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListWhatIfForecastsRequest:
    out: ListWhatIfForecastsRequest = {}  # type: ignore[typeddict-item]
