...
def serialize_aws_json_1_1(value: CreateDatasetRequest) -> dict:
    ...
    out["Domain"] = capo_forecast.types.domain.serialize_aws_json_1_1(value["domain"])
    import capo_forecast.types.dataset_type
