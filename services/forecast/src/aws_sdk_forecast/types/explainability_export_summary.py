"""Generated from Smithy shape ``com.amazonaws.forecast#ExplainabilityExportSummary``."""
...
class ExplainabilityExportSummary(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ExplainabilityExportSummary) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ExplainabilityExportSummary:
    out: ExplainabilityExportSummary = {}  # type: ignore[typeddict-item]
