...
class ForecastSummary(TypedDict):
    ...
    predictor_arn: NotRequired["aws_sdk_forecast.types.string.String"]
    """<p>The ARN of the predictor used to generate the forecast.</p>"""
    created_using_auto_predictor: NotRequired["aws_sdk_forecast.types.boolean.Boolean"]
    """<p>Whether the Forecast was created from an AutoPredictor.</p>"""
    dataset_group_arn: NotRequired["aws_sdk_forecast.types.string.String"]
