"""Generated from Smithy shape ``com.amazonaws.forecast#ListPredictorsRequest``."""
...
class ListPredictorsRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListPredictorsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListPredictorsRequest:
    out: ListPredictorsRequest = {}  # type: ignore[typeddict-item]
