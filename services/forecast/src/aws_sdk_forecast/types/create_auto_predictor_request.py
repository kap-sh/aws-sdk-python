...
class CreateAutoPredictorRequest(TypedDict):
    ...
    reference_predictor_arn: NotRequired["aws_sdk_forecast.types.arn.Arn"]
    ...
    explain_predictor: NotRequired["aws_sdk_forecast.types.boolean.Boolean"]
    ...
    monitor_config: NotRequired["aws_sdk_forecast.types.monitor_config.MonitorConfig"]
...
def serialize_aws_json_1_1(value: CreateAutoPredictorRequest) -> dict:
    ...
    if "monitor_config" in value:
        ...
        out["MonitorConfig"] = (
            aws_sdk_forecast.types.monitor_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CreateAutoPredictorRequest:
    ...
    if "MonitorConfig" in data:
        ...
        out["monitor_config"] = (
            aws_sdk_forecast.types.monitor_config.deserialize_aws_json_1_1(
                data["MonitorConfig"]
            )
        )
