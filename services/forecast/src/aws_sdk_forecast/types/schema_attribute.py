...
if TYPE_CHECKING:
    import aws_sdk_forecast.types.attribute_type
    import aws_sdk_forecast.types.name


class SchemaAttribute(TypedDict, closed=True):
    attribute_name: NotRequired["aws_sdk_forecast.types.name.Name"]
    """<p>The name of the dataset field.</p>"""
    attribute_type: NotRequired["aws_sdk_forecast.types.attribute_type.AttributeType"]
...
def serialize_aws_json_1_1(value: SchemaAttribute) -> dict:
    ...
    if "attribute_type" in value:
        ...
        out["AttributeType"] = (
            aws_sdk_forecast.types.attribute_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SchemaAttribute:
    ...
    if "AttributeType" in data:
        ...
        out["attribute_type"] = (
            aws_sdk_forecast.types.attribute_type.deserialize_aws_json_1_1(
                data["AttributeType"]
            )
        )
    return out
