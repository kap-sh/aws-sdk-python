...
if TYPE_CHECKING:
    import aws_sdk_forecast.types.configuration
...
def serialize_aws_json_1_1(value: AdditionalDataset) -> dict:
    ...
    if "configuration" in value:
        ...
        out["Configuration"] = (
            aws_sdk_forecast.types.configuration.serialize_aws_json_1_1(
                value["configuration"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> AdditionalDataset:
    ...
    if "Configuration" in data:
        ...
        out["configuration"] = (
            aws_sdk_forecast.types.configuration.deserialize_aws_json_1_1(
                data["Configuration"]
            )
        )
    return out
