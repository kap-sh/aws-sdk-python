"""Generated from Smithy shape ``com.amazonaws.forecast#ListWhatIfAnalysesRequest``."""
...
class ListWhatIfAnalysesRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListWhatIfAnalysesRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListWhatIfAnalysesRequest:
    out: ListWhatIfAnalysesRequest = {}  # type: ignore[typeddict-item]
