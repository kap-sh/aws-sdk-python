"""Generated from Smithy shape ``com.amazonaws.forecast#ListForecastExportJobsRequest``."""
...
class ListForecastExportJobsRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListForecastExportJobsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListForecastExportJobsRequest:
    out: ListForecastExportJobsRequest = {}  # type: ignore[typeddict-item]
