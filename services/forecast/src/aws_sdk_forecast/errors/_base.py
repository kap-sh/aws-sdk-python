...
class forecastError(Exception):
    """Base class for all forecast service errors."""


class ServiceError(forecastError):
...
class SerializationError(forecastError):
    """Raised when a value cannot be serialized."""


class DeserializationError(forecastError):
...
class WaiterFailedError(forecastError):
...
class WaiterTimeoutError(forecastError):
