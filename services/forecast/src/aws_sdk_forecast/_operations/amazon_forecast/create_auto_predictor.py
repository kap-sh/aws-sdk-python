...
def handle_response(
    ...
    out: aws_sdk_forecast.types.create_auto_predictor_response.CreateAutoPredictorResponse = aws_sdk_forecast.types.create_auto_predictor_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.create_auto_predictor_request.CreateAutoPredictorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.create_auto_predictor_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
