"""Generated from Smithy shape ``com.amazonaws.forecast#CreateExplainability``."""
...
def handle_response(
    ...
    out: aws_sdk_forecast.types.create_explainability_response.CreateExplainabilityResponse = aws_sdk_forecast.types.create_explainability_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.create_explainability_request.CreateExplainabilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonForecast.CreateExplainability"
    import aws_sdk_forecast.types.create_explainability_request

    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.create_explainability_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_explainability(
