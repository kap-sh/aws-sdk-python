...
def handle_response(
    ...
    out: aws_sdk_forecast.types.create_monitor_response.CreateMonitorResponse = (
        aws_sdk_forecast.types.create_monitor_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.create_monitor_request.CreateMonitorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.create_monitor_request.serialize_aws_json_1_1(input_)
    ).encode()
