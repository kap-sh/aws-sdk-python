...
def build_request(
    ...
    input: aws_sdk_forecast.types.delete_predictor_request.DeletePredictorRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.delete_predictor_request.serialize_aws_json_1_1(input)
    ).encode()
