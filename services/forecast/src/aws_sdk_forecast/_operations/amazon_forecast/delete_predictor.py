...
def build_request(
    ...
    input_: aws_sdk_forecast.types.delete_predictor_request.DeletePredictorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.delete_predictor_request.serialize_aws_json_1_1(input_)
    ).encode()
