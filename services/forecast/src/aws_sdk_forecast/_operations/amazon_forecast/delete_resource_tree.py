"""Generated from Smithy shape ``com.amazonaws.forecast#DeleteResourceTree``."""
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.delete_resource_tree_request.DeleteResourceTreeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonForecast.DeleteResourceTree"
    import aws_sdk_forecast.types.delete_resource_tree_request

    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.delete_resource_tree_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_resource_tree(
