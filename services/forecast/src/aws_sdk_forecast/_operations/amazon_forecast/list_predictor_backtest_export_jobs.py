"""Generated from Smithy shape ``com.amazonaws.forecast#ListPredictorBacktestExportJobs``."""
...
def handle_response(
    ...
    out: aws_sdk_forecast.types.list_predictor_backtest_export_jobs_response.ListPredictorBacktestExportJobsResponse = aws_sdk_forecast.types.list_predictor_backtest_export_jobs_response.deserialize_aws_json_1_1(
...
def get_signer(
...
) -> aws_sdk_forecast._auth._signers.Signer | None:
    ...
    if options.credentials_provider is not None:
        sigv4_config = (
            ...
            or aws_sdk_forecast._auth._sigv4.build_sigv4_auth_scheme(
                "forecast", options.region
            )
        )
        if sigv4_config is not None:
            return aws_sdk_forecast._auth._signers.SigV4Signer(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.list_predictor_backtest_export_jobs_request.ListPredictorBacktestExportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonForecast.ListPredictorBacktestExportJobs"
    import aws_sdk_forecast.types.list_predictor_backtest_export_jobs_request

    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.list_predictor_backtest_export_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_predictor_backtest_export_jobs(
