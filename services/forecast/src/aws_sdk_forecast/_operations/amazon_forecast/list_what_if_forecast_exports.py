"""Generated from Smithy shape ``com.amazonaws.forecast#ListWhatIfForecastExports``."""
...
def handle_response(
    ...
    out: aws_sdk_forecast.types.list_what_if_forecast_exports_response.ListWhatIfForecastExportsResponse = aws_sdk_forecast.types.list_what_if_forecast_exports_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.list_what_if_forecast_exports_request.ListWhatIfForecastExportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonForecast.ListWhatIfForecastExports"
    import aws_sdk_forecast.types.list_what_if_forecast_exports_request

    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.list_what_if_forecast_exports_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_what_if_forecast_exports(
