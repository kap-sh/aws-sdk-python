"""Generated from Smithy shape ``com.amazonaws.forecast#DeletePredictorBacktestExportJob``."""
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.delete_predictor_backtest_export_job_request.DeletePredictorBacktestExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonForecast.DeletePredictorBacktestExportJob"
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.delete_predictor_backtest_export_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_predictor_backtest_export_job(
