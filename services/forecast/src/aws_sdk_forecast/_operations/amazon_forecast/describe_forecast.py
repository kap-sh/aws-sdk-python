...
def handle_response(
    ...
    out: aws_sdk_forecast.types.describe_forecast_response.DescribeForecastResponse = (
        aws_sdk_forecast.types.describe_forecast_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.describe_forecast_request.DescribeForecastRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.describe_forecast_request.serialize_aws_json_1_1(input_)
    ).encode()
