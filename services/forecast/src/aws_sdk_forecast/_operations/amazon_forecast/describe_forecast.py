...
def build_request(
    ...
    input: aws_sdk_forecast.types.describe_forecast_request.DescribeForecastRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.describe_forecast_request.serialize_aws_json_1_1(input)
    ).encode()
