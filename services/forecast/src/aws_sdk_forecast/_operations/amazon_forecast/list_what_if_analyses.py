...
def handle_response(
    ...
    out: aws_sdk_forecast.types.list_what_if_analyses_response.ListWhatIfAnalysesResponse = aws_sdk_forecast.types.list_what_if_analyses_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.list_what_if_analyses_request.ListWhatIfAnalysesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.list_what_if_analyses_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
