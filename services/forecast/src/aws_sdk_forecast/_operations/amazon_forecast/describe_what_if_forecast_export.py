"""Generated from Smithy shape ``com.amazonaws.forecast#DescribeWhatIfForecastExport``."""
...
def handle_response(
    ...
    out: aws_sdk_forecast.types.describe_what_if_forecast_export_response.DescribeWhatIfForecastExportResponse = aws_sdk_forecast.types.describe_what_if_forecast_export_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.describe_what_if_forecast_export_request.DescribeWhatIfForecastExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonForecast.DescribeWhatIfForecastExport"
    import aws_sdk_forecast.types.describe_what_if_forecast_export_request

    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.describe_what_if_forecast_export_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_describe_what_if_forecast_export(
