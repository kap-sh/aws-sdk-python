"""Generated from Smithy shape ``com.amazonaws.forecast#ListExplainabilities``."""
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.list_explainabilities_request.ListExplainabilitiesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonForecast.ListExplainabilities"
    import aws_sdk_forecast.types.list_explainabilities_request

    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.list_explainabilities_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_explainabilities(
