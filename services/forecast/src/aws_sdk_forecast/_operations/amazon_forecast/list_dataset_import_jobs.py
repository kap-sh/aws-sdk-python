"""Generated from Smithy shape ``com.amazonaws.forecast#ListDatasetImportJobs``."""
...
import aws_sdk_forecast.types.dataset_import_jobs
...
def handle_response(
    ...
    out: aws_sdk_forecast.types.list_dataset_import_jobs_response.ListDatasetImportJobsResponse = aws_sdk_forecast.types.list_dataset_import_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.list_dataset_import_jobs_request.ListDatasetImportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.list_dataset_import_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_dataset_import_jobs(
