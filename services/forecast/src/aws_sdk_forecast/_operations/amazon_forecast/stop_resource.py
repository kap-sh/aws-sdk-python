"""Generated from Smithy shape ``com.amazonaws.forecast#StopResource``."""
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.stop_resource_request.StopResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonForecast.StopResource"
    import aws_sdk_forecast.types.stop_resource_request

    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.stop_resource_request.serialize_aws_json_1_1(input_)
    ).encode()
