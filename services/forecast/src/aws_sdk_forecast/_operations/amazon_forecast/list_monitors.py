...
def handle_response(
    ...
    out: aws_sdk_forecast.types.list_monitors_response.ListMonitorsResponse = (
        aws_sdk_forecast.types.list_monitors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.list_monitors_request.ListMonitorsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.list_monitors_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_monitors(
    ...
    aws_sdk_forecast.types.list_monitors_response.ListMonitorsResponse, zapros.Response
]:
