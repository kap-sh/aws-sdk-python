...
def build_request(
    ...
    input: aws_sdk_forecast.types.create_predictor_request.CreatePredictorRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.create_predictor_request.serialize_aws_json_1_1(input)
    ).encode()
