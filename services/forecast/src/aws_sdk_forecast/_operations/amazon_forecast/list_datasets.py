...
def handle_response(
    ...
    out: aws_sdk_forecast.types.list_datasets_response.ListDatasetsResponse = (
        aws_sdk_forecast.types.list_datasets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.list_datasets_request.ListDatasetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.list_datasets_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_datasets(
    ...
    aws_sdk_forecast.types.list_datasets_response.ListDatasetsResponse, zapros.Response
]:
