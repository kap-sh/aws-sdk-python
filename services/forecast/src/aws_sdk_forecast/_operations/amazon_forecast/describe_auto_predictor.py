...
def handle_response(
    ...
    out: aws_sdk_forecast.types.describe_auto_predictor_response.DescribeAutoPredictorResponse = aws_sdk_forecast.types.describe_auto_predictor_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.describe_auto_predictor_request.DescribeAutoPredictorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.describe_auto_predictor_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
