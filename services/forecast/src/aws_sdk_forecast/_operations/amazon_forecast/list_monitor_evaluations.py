...
def handle_response(
    ...
    out: aws_sdk_forecast.types.list_monitor_evaluations_response.ListMonitorEvaluationsResponse = aws_sdk_forecast.types.list_monitor_evaluations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.list_monitor_evaluations_request.ListMonitorEvaluationsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.list_monitor_evaluations_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
