...
def handle_response(
    ...
    out: aws_sdk_forecast.types.describe_explainability_export_response.DescribeExplainabilityExportResponse = aws_sdk_forecast.types.describe_explainability_export_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.describe_explainability_export_request.DescribeExplainabilityExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.describe_explainability_export_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
