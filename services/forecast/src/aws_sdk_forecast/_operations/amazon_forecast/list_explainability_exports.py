...
def handle_response(
    ...
    out: aws_sdk_forecast.types.list_explainability_exports_response.ListExplainabilityExportsResponse = aws_sdk_forecast.types.list_explainability_exports_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.list_explainability_exports_request.ListExplainabilityExportsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.list_explainability_exports_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
