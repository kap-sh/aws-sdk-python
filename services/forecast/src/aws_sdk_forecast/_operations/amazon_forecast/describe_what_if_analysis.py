"""Generated from Smithy shape ``com.amazonaws.forecast#DescribeWhatIfAnalysis``."""
...
def handle_response(
    ...
    out: aws_sdk_forecast.types.describe_what_if_analysis_response.DescribeWhatIfAnalysisResponse = aws_sdk_forecast.types.describe_what_if_analysis_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.describe_what_if_analysis_request.DescribeWhatIfAnalysisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
async def async_describe_what_if_analysis(
