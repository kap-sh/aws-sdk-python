...
def handle_response(
    ...
    out: aws_sdk_forecast.types.create_what_if_analysis_response.CreateWhatIfAnalysisResponse = aws_sdk_forecast.types.create_what_if_analysis_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.create_what_if_analysis_request.CreateWhatIfAnalysisRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.create_what_if_analysis_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
