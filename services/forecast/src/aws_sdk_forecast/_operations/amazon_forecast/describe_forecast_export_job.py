...
def handle_response(
    ...
    out: aws_sdk_forecast.types.describe_forecast_export_job_response.DescribeForecastExportJobResponse = aws_sdk_forecast.types.describe_forecast_export_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.describe_forecast_export_job_request.DescribeForecastExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.describe_forecast_export_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
