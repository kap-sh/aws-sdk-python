"""Generated from Smithy shape ``com.amazonaws.forecast#DeleteExplainability``."""
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.delete_explainability_request.DeleteExplainabilityRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonForecast.DeleteExplainability"
    import aws_sdk_forecast.types.delete_explainability_request

    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.delete_explainability_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_explainability(
