"""Generated from Smithy shape ``com.amazonaws.forecast#CreateWhatIfForecastExport``."""
...
def handle_response(
    ...
    out: aws_sdk_forecast.types.create_what_if_forecast_export_response.CreateWhatIfForecastExportResponse = aws_sdk_forecast.types.create_what_if_forecast_export_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.create_what_if_forecast_export_request.CreateWhatIfForecastExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonForecast.CreateWhatIfForecastExport"
    import aws_sdk_forecast.types.create_what_if_forecast_export_request

    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.create_what_if_forecast_export_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_what_if_forecast_export(
