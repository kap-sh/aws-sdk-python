"""Generated from Smithy shape ``com.amazonaws.forecast#DeleteDatasetGroup``."""
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.delete_dataset_group_request.DeleteDatasetGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.delete_dataset_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
