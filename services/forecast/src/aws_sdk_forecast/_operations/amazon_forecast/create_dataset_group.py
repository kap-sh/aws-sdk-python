...
def handle_response(
    ...
    out: aws_sdk_forecast.types.create_dataset_group_response.CreateDatasetGroupResponse = aws_sdk_forecast.types.create_dataset_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.create_dataset_group_request.CreateDatasetGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.create_dataset_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
