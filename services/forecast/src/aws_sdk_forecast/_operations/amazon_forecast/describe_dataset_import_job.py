...
def handle_response(
    ...
    out: aws_sdk_forecast.types.describe_dataset_import_job_response.DescribeDatasetImportJobResponse = aws_sdk_forecast.types.describe_dataset_import_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.describe_dataset_import_job_request.DescribeDatasetImportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.describe_dataset_import_job_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
