...
def build_request(
    ...
    input: aws_sdk_forecast.types.describe_monitor_request.DescribeMonitorRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.describe_monitor_request.serialize_aws_json_1_1(input)
    ).encode()
