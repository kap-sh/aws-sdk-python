"""Generated from Smithy shape ``com.amazonaws.forecast#DescribeMonitor``."""
...
def handle_response(
    ...
    out: aws_sdk_forecast.types.describe_monitor_response.DescribeMonitorResponse = (
        aws_sdk_forecast.types.describe_monitor_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.describe_monitor_request.DescribeMonitorRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonForecast.DescribeMonitor"
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.describe_monitor_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_describe_monitor(
