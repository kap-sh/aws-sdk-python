...
def handle_response(
    ...
    out: aws_sdk_forecast.types.create_predictor_backtest_export_job_response.CreatePredictorBacktestExportJobResponse = aws_sdk_forecast.types.create_predictor_backtest_export_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.create_predictor_backtest_export_job_request.CreatePredictorBacktestExportJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
