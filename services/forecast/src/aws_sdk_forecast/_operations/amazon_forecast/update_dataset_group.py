"""Generated from Smithy shape ``com.amazonaws.forecast#UpdateDatasetGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_forecast.types.update_dataset_group_response.UpdateDatasetGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.update_dataset_group_request.UpdateDatasetGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.update_dataset_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_dataset_group(
