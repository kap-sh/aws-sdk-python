...
def handle_response(
    ...
    out: aws_sdk_forecast.types.list_forecast_export_jobs_response.ListForecastExportJobsResponse = aws_sdk_forecast.types.list_forecast_export_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.list_forecast_export_jobs_request.ListForecastExportJobsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.list_forecast_export_jobs_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
