...
def handle_response(
    ...
    out: aws_sdk_forecast.types.get_accuracy_metrics_response.GetAccuracyMetricsResponse = aws_sdk_forecast.types.get_accuracy_metrics_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.get_accuracy_metrics_request.GetAccuracyMetricsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.get_accuracy_metrics_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
