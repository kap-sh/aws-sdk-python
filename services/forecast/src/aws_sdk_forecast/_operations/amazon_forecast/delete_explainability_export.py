"""Generated from Smithy shape ``com.amazonaws.forecast#DeleteExplainabilityExport``."""
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.delete_explainability_export_request.DeleteExplainabilityExportRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AmazonForecast.DeleteExplainabilityExport"
    import aws_sdk_forecast.types.delete_explainability_export_request

    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.delete_explainability_export_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_explainability_export(
