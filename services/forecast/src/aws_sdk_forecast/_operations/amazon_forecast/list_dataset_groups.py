...
def build_request(
    ...
    input_: aws_sdk_forecast.types.list_dataset_groups_request.ListDatasetGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.list_dataset_groups_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
