...
def handle_response(
    ...
    out: aws_sdk_forecast.types.list_dataset_groups_response.ListDatasetGroupsResponse = aws_sdk_forecast.types.list_dataset_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input: aws_sdk_forecast.types.list_dataset_groups_request.ListDatasetGroupsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.list_dataset_groups_request.serialize_aws_json_1_1(input)
    ).encode()
