"""Generated from Smithy shape ``com.amazonaws.forecast#DeleteForecast``."""
...
def build_request(
    ...
    input_: aws_sdk_forecast.types.delete_forecast_request.DeleteForecastRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.delete_forecast_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_delete_forecast(
