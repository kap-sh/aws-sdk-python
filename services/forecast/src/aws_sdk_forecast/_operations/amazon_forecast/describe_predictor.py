...
def build_request(
    ...
    input: aws_sdk_forecast.types.describe_predictor_request.DescribePredictorRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_forecast.types.describe_predictor_request.serialize_aws_json_1_1(input)
    ).encode()
