"""Generated from Smithy shape ``com.amazonaws.wafregional#WAFInvalidOperationException``."""
...
class WAFInvalidOperationException_(TypedDict):
...
class WAFInvalidOperationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.wafregional#WAFInvalidOperationException``."""
