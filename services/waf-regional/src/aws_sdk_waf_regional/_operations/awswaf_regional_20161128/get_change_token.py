"""Generated from Smithy shape ``com.amazonaws.wafregional#GetChangeToken``."""
...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.get_change_token_response.GetChangeTokenResponse = (
        aws_sdk_waf_regional.types.get_change_token_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.get_change_token_request.GetChangeTokenRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
