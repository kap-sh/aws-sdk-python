...
def build_request(
    ...
    input: aws_sdk_waf_regional.types.delete_web_acl_request.DeleteWebACLRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.delete_web_acl_request.serialize_aws_json_1_1(input)
    ).encode()
