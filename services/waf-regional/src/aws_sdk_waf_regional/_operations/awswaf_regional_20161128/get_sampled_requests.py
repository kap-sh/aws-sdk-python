"""Generated from Smithy shape ``com.amazonaws.wafregional#GetSampledRequests``."""
...
import aws_sdk_waf_regional.types.sampled_http_requests
...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.get_sampled_requests_response.GetSampledRequestsResponse = aws_sdk_waf_regional.types.get_sampled_requests_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.get_sampled_requests_request.GetSampledRequestsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.get_sampled_requests_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
