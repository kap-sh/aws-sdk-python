"""Generated from Smithy shape ``com.amazonaws.wafregional#CreateSizeConstraintSet``."""
...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.create_size_constraint_set_response.CreateSizeConstraintSetResponse = aws_sdk_waf_regional.types.create_size_constraint_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.create_size_constraint_set_request.CreateSizeConstraintSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
