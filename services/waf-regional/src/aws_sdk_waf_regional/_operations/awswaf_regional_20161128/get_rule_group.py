...
def build_request(
    ...
    input: aws_sdk_waf_regional.types.get_rule_group_request.GetRuleGroupRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.get_rule_group_request.serialize_aws_json_1_1(input)
    ).encode()
