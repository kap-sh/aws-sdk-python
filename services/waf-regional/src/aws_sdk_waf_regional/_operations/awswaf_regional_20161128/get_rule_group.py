"""Generated from Smithy shape ``com.amazonaws.wafregional#GetRuleGroup``."""
...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.get_rule_group_response.GetRuleGroupResponse = (
        aws_sdk_waf_regional.types.get_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.get_rule_group_request.GetRuleGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.get_rule_group_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_get_rule_group(
