"""Generated from Smithy shape ``com.amazonaws.wafregional#DeleteRegexPatternSet``."""
...
import aws_sdk_waf_regional.errors.waf_non_empty_entity_exception
import aws_sdk_waf_regional.errors.waf_nonexistent_item_exception
import aws_sdk_waf_regional.errors.waf_referenced_item_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFNonEmptyEntityException":
            raise aws_sdk_waf_regional.errors.waf_non_empty_entity_exception.WAFNonEmptyEntityException.from_aws_json_1_1(
                data
            )
        ...
        case "WAFReferencedItemException":
            raise aws_sdk_waf_regional.errors.waf_referenced_item_exception.WAFReferencedItemException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.delete_regex_pattern_set_response.DeleteRegexPatternSetResponse = aws_sdk_waf_regional.types.delete_regex_pattern_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.delete_regex_pattern_set_request.DeleteRegexPatternSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.delete_regex_pattern_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
