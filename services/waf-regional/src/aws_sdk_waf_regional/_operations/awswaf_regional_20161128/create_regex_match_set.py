"""Generated from Smithy shape ``com.amazonaws.wafregional#CreateRegexMatchSet``."""
...
import aws_sdk_waf_regional.types.regex_match_set
...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.create_regex_match_set_response.CreateRegexMatchSetResponse = aws_sdk_waf_regional.types.create_regex_match_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.create_regex_match_set_request.CreateRegexMatchSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.create_regex_match_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
