...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.create_rule_response.CreateRuleResponse = (
        aws_sdk_waf_regional.types.create_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.create_rule_request.CreateRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.create_rule_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def create_rule(
    ...
    aws_sdk_waf_regional.types.create_rule_response.CreateRuleResponse, zapros.Response
]:
