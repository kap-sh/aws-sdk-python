...
def build_request(
    ...
    input: aws_sdk_waf_regional.types.list_web_ac_ls_request.ListWebACLsRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.list_web_ac_ls_request.serialize_aws_json_1_1(input)
    ).encode()
