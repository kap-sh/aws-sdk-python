...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.list_web_ac_ls_response.ListWebACLsResponse = (
        aws_sdk_waf_regional.types.list_web_ac_ls_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.list_web_ac_ls_request.ListWebACLsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.list_web_ac_ls_request.serialize_aws_json_1_1(input_)
    ).encode()
