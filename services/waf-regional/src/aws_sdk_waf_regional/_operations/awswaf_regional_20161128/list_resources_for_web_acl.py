...
import aws_sdk_waf_regional.types.resource_arns
...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.list_resources_for_web_acl_response.ListResourcesForWebACLResponse = aws_sdk_waf_regional.types.list_resources_for_web_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.list_resources_for_web_acl_request.ListResourcesForWebACLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.list_resources_for_web_acl_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
