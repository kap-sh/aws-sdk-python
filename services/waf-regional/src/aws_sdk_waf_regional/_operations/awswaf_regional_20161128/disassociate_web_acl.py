...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.disassociate_web_acl_response.DisassociateWebACLResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.disassociate_web_acl_request.DisassociateWebACLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.disassociate_web_acl_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
