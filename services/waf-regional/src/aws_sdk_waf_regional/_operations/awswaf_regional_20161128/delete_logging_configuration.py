...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.delete_logging_configuration_response.DeleteLoggingConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.delete_logging_configuration_request.DeleteLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
