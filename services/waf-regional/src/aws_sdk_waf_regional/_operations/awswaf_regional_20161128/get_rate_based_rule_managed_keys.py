"""Generated from Smithy shape ``com.amazonaws.wafregional#GetRateBasedRuleManagedKeys``."""
...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.get_rate_based_rule_managed_keys_response.GetRateBasedRuleManagedKeysResponse = aws_sdk_waf_regional.types.get_rate_based_rule_managed_keys_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.get_rate_based_rule_managed_keys_request.GetRateBasedRuleManagedKeysRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSWAF_Regional_20161128.GetRateBasedRuleManagedKeys"
    import aws_sdk_waf_regional.types.get_rate_based_rule_managed_keys_request

    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.get_rate_based_rule_managed_keys_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
