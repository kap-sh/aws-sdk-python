"""Generated from Smithy shape ``com.amazonaws.wafregional#GetIPSet``."""
...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.get_ip_set_response.GetIPSetResponse = (
        aws_sdk_waf_regional.types.get_ip_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.get_ip_set_request.GetIPSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.get_ip_set_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_ip_set(
    ...
    aws_sdk_waf_regional.types.get_ip_set_response.GetIPSetResponse, zapros.Response
]:
