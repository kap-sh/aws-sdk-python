...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.update_rule_response.UpdateRuleResponse = (
        aws_sdk_waf_regional.types.update_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.update_rule_request.UpdateRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.update_rule_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_rule(
    ...
    aws_sdk_waf_regional.types.update_rule_response.UpdateRuleResponse, zapros.Response
]:
