...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "WAFEntityMigrationException":
            import aws_sdk_waf_regional.errors.waf_entity_migration_exception

            raise aws_sdk_waf_regional.errors.waf_entity_migration_exception.WAFEntityMigrationException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.create_web_acl_migration_stack_response.CreateWebACLMigrationStackResponse = aws_sdk_waf_regional.types.create_web_acl_migration_stack_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.create_web_acl_migration_stack_request.CreateWebACLMigrationStackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.create_web_acl_migration_stack_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
