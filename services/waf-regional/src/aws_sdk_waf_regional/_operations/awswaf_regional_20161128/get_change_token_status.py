...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.get_change_token_status_response.GetChangeTokenStatusResponse = aws_sdk_waf_regional.types.get_change_token_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.get_change_token_status_request.GetChangeTokenStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.get_change_token_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
