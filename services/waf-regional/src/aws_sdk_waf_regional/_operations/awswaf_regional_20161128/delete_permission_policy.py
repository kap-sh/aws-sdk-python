"""Generated from Smithy shape ``com.amazonaws.wafregional#DeletePermissionPolicy``."""
...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.delete_permission_policy_response.DeletePermissionPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.delete_permission_policy_request.DeletePermissionPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.delete_permission_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
