...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.update_rate_based_rule_response.UpdateRateBasedRuleResponse = aws_sdk_waf_regional.types.update_rate_based_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.update_rate_based_rule_request.UpdateRateBasedRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
