...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.list_ip_sets_response.ListIPSetsResponse = (
        aws_sdk_waf_regional.types.list_ip_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.list_ip_sets_request.ListIPSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.list_ip_sets_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_ip_sets(
    ...
    aws_sdk_waf_regional.types.list_ip_sets_response.ListIPSetsResponse, zapros.Response
]:
