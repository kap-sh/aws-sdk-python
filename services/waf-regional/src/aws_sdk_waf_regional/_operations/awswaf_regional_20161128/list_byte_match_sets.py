"""Generated from Smithy shape ``com.amazonaws.wafregional#ListByteMatchSets``."""
...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.list_byte_match_sets_response.ListByteMatchSetsResponse = aws_sdk_waf_regional.types.list_byte_match_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.list_byte_match_sets_request.ListByteMatchSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.list_byte_match_sets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
