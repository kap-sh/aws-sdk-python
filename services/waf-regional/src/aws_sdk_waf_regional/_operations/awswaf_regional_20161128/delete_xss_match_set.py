...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.delete_xss_match_set_response.DeleteXssMatchSetResponse = aws_sdk_waf_regional.types.delete_xss_match_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.delete_xss_match_set_request.DeleteXssMatchSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.delete_xss_match_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
