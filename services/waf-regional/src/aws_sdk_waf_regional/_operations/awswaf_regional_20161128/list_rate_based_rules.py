"""Generated from Smithy shape ``com.amazonaws.wafregional#ListRateBasedRules``."""
...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.list_rate_based_rules_response.ListRateBasedRulesResponse = aws_sdk_waf_regional.types.list_rate_based_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.list_rate_based_rules_request.ListRateBasedRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.list_rate_based_rules_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
