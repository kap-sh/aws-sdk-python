...
def build_request(
    ...
    input: aws_sdk_waf_regional.types.create_ip_set_request.CreateIPSetRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.create_ip_set_request.serialize_aws_json_1_1(input)
    ).encode()
