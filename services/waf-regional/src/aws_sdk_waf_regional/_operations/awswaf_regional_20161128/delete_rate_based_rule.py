...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.delete_rate_based_rule_response.DeleteRateBasedRuleResponse = aws_sdk_waf_regional.types.delete_rate_based_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.delete_rate_based_rule_request.DeleteRateBasedRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.delete_rate_based_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
