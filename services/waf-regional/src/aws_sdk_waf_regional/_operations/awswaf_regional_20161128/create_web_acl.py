...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.create_web_acl_response.CreateWebACLResponse = (
        aws_sdk_waf_regional.types.create_web_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.create_web_acl_request.CreateWebACLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.create_web_acl_request.serialize_aws_json_1_1(input_)
    ).encode()
