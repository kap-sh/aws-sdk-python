...
def build_request(
    ...
    input: aws_sdk_waf_regional.types.create_web_acl_request.CreateWebACLRequest,
) -> zapros.Request:
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.create_web_acl_request.serialize_aws_json_1_1(input)
    ).encode()
