...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.list_geo_match_sets_response.ListGeoMatchSetsResponse = aws_sdk_waf_regional.types.list_geo_match_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.list_geo_match_sets_request.ListGeoMatchSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.list_geo_match_sets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
