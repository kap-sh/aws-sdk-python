...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.list_rules_response.ListRulesResponse = (
        aws_sdk_waf_regional.types.list_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.list_rules_request.ListRulesRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.list_rules_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_rules(
    ...
    aws_sdk_waf_regional.types.list_rules_response.ListRulesResponse, zapros.Response
]:
