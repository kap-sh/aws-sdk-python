...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFInvalidRegexPatternException":
            import aws_sdk_waf_regional.errors.waf_invalid_regex_pattern_exception

            raise aws_sdk_waf_regional.errors.waf_invalid_regex_pattern_exception.WAFInvalidRegexPatternException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.update_regex_pattern_set_response.UpdateRegexPatternSetResponse = aws_sdk_waf_regional.types.update_regex_pattern_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.update_regex_pattern_set_request.UpdateRegexPatternSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.update_regex_pattern_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
