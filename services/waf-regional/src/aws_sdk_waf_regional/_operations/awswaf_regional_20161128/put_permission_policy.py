...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFInvalidPermissionPolicyException":
            import aws_sdk_waf_regional.errors.waf_invalid_permission_policy_exception

            raise aws_sdk_waf_regional.errors.waf_invalid_permission_policy_exception.WAFInvalidPermissionPolicyException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.put_permission_policy_response.PutPermissionPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.put_permission_policy_request.PutPermissionPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.put_permission_policy_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
