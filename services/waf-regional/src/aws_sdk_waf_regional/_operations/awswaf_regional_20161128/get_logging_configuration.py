...
def handle_response(
    ...
    out: aws_sdk_waf_regional.types.get_logging_configuration_response.GetLoggingConfigurationResponse = aws_sdk_waf_regional.types.get_logging_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: aws_sdk_waf_regional.types.get_logging_configuration_request.GetLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        aws_sdk_waf_regional.types.get_logging_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
