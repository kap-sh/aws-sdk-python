...
def serialize_aws_json_1_1(value: UpdateSqlInjectionMatchSetRequest) -> dict:
    ...
    out["Updates"] = (
        aws_sdk_waf_regional.types.sql_injection_match_set_updates.serialize_aws_json_1_1(
            value["updates"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UpdateSqlInjectionMatchSetRequest:
    ...
    if "Updates" in data:
        ...
        out["updates"] = (
            aws_sdk_waf_regional.types.sql_injection_match_set_updates.deserialize_aws_json_1_1(
                data["Updates"]
            )
        )
    else:
