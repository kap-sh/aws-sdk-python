"""Generated from Smithy shape ``com.amazonaws.wafregional#ListRegexMatchSetsRequest``."""
...
class ListRegexMatchSetsRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListRegexMatchSetsRequest) -> dict:
    out: dict = {}
