...
if TYPE_CHECKING:
    ...
    import aws_sdk_waf_regional.types.http_headers
    import aws_sdk_waf_regional.types.http_method
    import aws_sdk_waf_regional.types.http_version
    import aws_sdk_waf_regional.types.ip_string
...
class HTTPRequest(TypedDict):
    ...
    http_version: NotRequired["aws_sdk_waf_regional.types.http_version.HTTPVersion"]
    """<p>The HTTP version specified in the sampled web request, for example, <code>HTTP/1.1</code>.</p>"""
    headers: NotRequired["aws_sdk_waf_regional.types.http_headers.HTTPHeaders"]
...
def serialize_aws_json_1_1(value: HTTPRequest) -> dict:
    ...
    if "headers" in value:
        ...
        out["Headers"] = aws_sdk_waf_regional.types.http_headers.serialize_aws_json_1_1(
            value["headers"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> HTTPRequest:
    ...
    if "Headers" in data:
        ...
        out["headers"] = (
            aws_sdk_waf_regional.types.http_headers.deserialize_aws_json_1_1(
                data["Headers"]
            )
        )
    return out
