"""Generated from Smithy shape ``com.amazonaws.wafregional#WebACL``."""
...
class WebACL(TypedDict, closed=True):
    ...
    web_acl_arn: NotRequired["aws_sdk_waf_regional.types.resource_arn.ResourceArn"]
...
def serialize_aws_json_1_1(value: WebACL) -> dict:
    ...
    out["DefaultAction"] = aws_sdk_waf_regional.types.waf_action.serialize_aws_json_1_1(
        value["default_action"]
    )
    import aws_sdk_waf_regional.types.activated_rules

    out["Rules"] = aws_sdk_waf_regional.types.activated_rules.serialize_aws_json_1_1(
        value["rules"]
    )
...
def deserialize_aws_json_1_1(data: dict) -> WebACL:
    ...
    if "DefaultAction" in data:
        ...
        out["default_action"] = (
            aws_sdk_waf_regional.types.waf_action.deserialize_aws_json_1_1(
                data["DefaultAction"]
            )
        )
    else:
