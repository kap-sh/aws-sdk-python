...
class TimeWindow(TypedDict):
    start_time: "aws_sdk_waf_regional.types.timestamp.Timestamp"
    ...
    end_time: "aws_sdk_waf_regional.types.timestamp.Timestamp"
...
def serialize_aws_json_1_1(value: TimeWindow) -> dict:
    ...
    out["StartTime"] = aws_sdk_waf_regional.types.timestamp.serialize_aws_json_1_1(
        value["start_time"]
    )
    import aws_sdk_waf_regional.types.timestamp

    out["EndTime"] = aws_sdk_waf_regional.types.timestamp.serialize_aws_json_1_1(
        value["end_time"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> TimeWindow:
    ...
    if "EndTime" in data:
        ...
        out["end_time"] = aws_sdk_waf_regional.types.timestamp.deserialize_aws_json_1_1(
            data["EndTime"]
        )
    else:
