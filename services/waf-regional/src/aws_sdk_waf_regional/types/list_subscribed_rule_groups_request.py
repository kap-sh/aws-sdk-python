"""Generated from Smithy shape ``com.amazonaws.wafregional#ListSubscribedRuleGroupsRequest``."""
...
class ListSubscribedRuleGroupsRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListSubscribedRuleGroupsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListSubscribedRuleGroupsRequest:
    out: ListSubscribedRuleGroupsRequest = {}  # type: ignore[typeddict-item]
