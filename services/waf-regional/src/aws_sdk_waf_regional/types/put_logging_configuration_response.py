"""Generated from Smithy shape ``com.amazonaws.wafregional#PutLoggingConfigurationResponse``."""
...
class PutLoggingConfigurationResponse(TypedDict):
...
def serialize_aws_json_1_1(value: PutLoggingConfigurationResponse) -> dict:
    ...
    if "logging_configuration" in value:
        ...
        out["LoggingConfiguration"] = (
            aws_sdk_waf_regional.types.logging_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> PutLoggingConfigurationResponse:
    ...
    if "LoggingConfiguration" in data:
        ...
        out["logging_configuration"] = (
            aws_sdk_waf_regional.types.logging_configuration.deserialize_aws_json_1_1(
