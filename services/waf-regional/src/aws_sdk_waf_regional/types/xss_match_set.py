...
if TYPE_CHECKING:
    ...
    import aws_sdk_waf_regional.types.xss_match_tuples
...
class XssMatchSet(TypedDict):
    ...
    xss_match_tuples: "aws_sdk_waf_regional.types.xss_match_tuples.XssMatchTuples"
...
def serialize_aws_json_1_1(value: XssMatchSet) -> dict:
    ...
    out["XssMatchTuples"] = (
        aws_sdk_waf_regional.types.xss_match_tuples.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> XssMatchSet:
    ...
    if "XssMatchTuples" in data:
        ...
        out["xss_match_tuples"] = (
            aws_sdk_waf_regional.types.xss_match_tuples.deserialize_aws_json_1_1(
                data["XssMatchTuples"]
            )
        )
    else:
