...
if TYPE_CHECKING:
    ...
    import aws_sdk_waf_regional.types.ip_set_descriptor
...
class IPSetUpdate(TypedDict, closed=True):
    ...
    ip_set_descriptor: "aws_sdk_waf_regional.types.ip_set_descriptor.IPSetDescriptor"
...
def serialize_aws_json_1_1(value: IPSetUpdate) -> dict:
    ...
    out["IPSetDescriptor"] = (
        aws_sdk_waf_regional.types.ip_set_descriptor.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> IPSetUpdate:
    ...
    if "IPSetDescriptor" in data:
        ...
        out["ip_set_descriptor"] = (
            aws_sdk_waf_regional.types.ip_set_descriptor.deserialize_aws_json_1_1(
