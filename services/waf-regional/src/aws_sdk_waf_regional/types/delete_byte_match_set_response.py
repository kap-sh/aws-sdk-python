"""Generated from Smithy shape ``com.amazonaws.wafregional#DeleteByteMatchSetResponse``."""
...
class DeleteByteMatchSetResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteByteMatchSetResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeleteByteMatchSetResponse:
    out: DeleteByteMatchSetResponse = {}  # type: ignore[typeddict-item]
