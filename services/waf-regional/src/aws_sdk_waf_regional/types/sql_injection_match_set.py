...
class SqlInjectionMatchSet(TypedDict):
    ...
    sql_injection_match_tuples: (
        "aws_sdk_waf_regional.types.sql_injection_match_tuples.SqlInjectionMatchTuples"
    )
...
def serialize_aws_json_1_1(value: SqlInjectionMatchSet) -> dict:
    ...
    out["SqlInjectionMatchTuples"] = (
        aws_sdk_waf_regional.types.sql_injection_match_tuples.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SqlInjectionMatchSet:
    ...
    if "SqlInjectionMatchTuples" in data:
        ...
        out["sql_injection_match_tuples"] = (
            aws_sdk_waf_regional.types.sql_injection_match_tuples.deserialize_aws_json_1_1(
