"""Generated from Smithy shape ``com.amazonaws.wafregional#GetSqlInjectionMatchSetResponse``."""
...
class GetSqlInjectionMatchSetResponse(TypedDict):
    sql_injection_match_set: NotRequired[
        "aws_sdk_waf_regional.types.sql_injection_match_set.SqlInjectionMatchSet"
    ]
...
def serialize_aws_json_1_1(value: GetSqlInjectionMatchSetResponse) -> dict:
    ...
    if "sql_injection_match_set" in value:
        ...
        out["SqlInjectionMatchSet"] = (
            aws_sdk_waf_regional.types.sql_injection_match_set.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetSqlInjectionMatchSetResponse:
    ...
    if "SqlInjectionMatchSet" in data:
        ...
        out["sql_injection_match_set"] = (
            aws_sdk_waf_regional.types.sql_injection_match_set.deserialize_aws_json_1_1(
