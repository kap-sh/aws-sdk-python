...
class ListSqlInjectionMatchSetsResponse(TypedDict):
    ...
    sql_injection_match_sets: NotRequired[
        "aws_sdk_waf_regional.types.sql_injection_match_set_summaries.SqlInjectionMatchSetSummaries"
    ]
...
def serialize_aws_json_1_1(value: ListSqlInjectionMatchSetsResponse) -> dict:
    ...
    if "sql_injection_match_sets" in value:
        ...
        out["SqlInjectionMatchSets"] = (
            aws_sdk_waf_regional.types.sql_injection_match_set_summaries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListSqlInjectionMatchSetsResponse:
    ...
    if "SqlInjectionMatchSets" in data:
        ...
        out["sql_injection_match_sets"] = (
            aws_sdk_waf_regional.types.sql_injection_match_set_summaries.deserialize_aws_json_1_1(
