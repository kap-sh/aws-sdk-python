...
if TYPE_CHECKING:
    import aws_sdk_waf_regional.types.population_size
...
class GetSampledRequestsResponse(TypedDict):
    sampled_requests: NotRequired[
        "aws_sdk_waf_regional.types.sampled_http_requests.SampledHTTPRequests"
    ]
    """<p>A complex type that contains detailed information about each of the requests in the sample.</p>"""
    population_size: "aws_sdk_waf_regional.types.population_size.PopulationSize"
    ...
    time_window: NotRequired["aws_sdk_waf_regional.types.time_window.TimeWindow"]
...
def serialize_aws_json_1_1(value: GetSampledRequestsResponse) -> dict:
    ...
    if "sampled_requests" in value:
        ...
        out["SampledRequests"] = (
            aws_sdk_waf_regional.types.sampled_http_requests.serialize_aws_json_1_1(
    ...
    if "time_window" in value:
        ...
        out["TimeWindow"] = (
            aws_sdk_waf_regional.types.time_window.serialize_aws_json_1_1(
                value["time_window"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetSampledRequestsResponse:
    ...
    if "SampledRequests" in data:
        ...
        out["sampled_requests"] = (
            aws_sdk_waf_regional.types.sampled_http_requests.deserialize_aws_json_1_1(
