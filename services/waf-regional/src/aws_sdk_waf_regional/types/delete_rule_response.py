"""Generated from Smithy shape ``com.amazonaws.wafregional#DeleteRuleResponse``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteRuleResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeleteRuleResponse:
    out: DeleteRuleResponse = {}  # type: ignore[typeddict-item]
