...
if TYPE_CHECKING:
    import aws_sdk_waf_regional.types.waf_action_type


class WafAction(TypedDict, closed=True):
    type: "aws_sdk_waf_regional.types.waf_action_type.WafActionType"
...
def serialize_aws_json_1_1(value: WafAction) -> dict:
    ...
    out["Type"] = aws_sdk_waf_regional.types.waf_action_type.serialize_aws_json_1_1(
        value["type"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> WafAction:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_waf_regional.types.waf_action_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    else:
