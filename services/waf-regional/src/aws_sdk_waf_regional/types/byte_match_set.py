"""Generated from Smithy shape ``com.amazonaws.wafregional#ByteMatchSet``."""
...
class ByteMatchSet(TypedDict):
    ...
    byte_match_tuples: "aws_sdk_waf_regional.types.byte_match_tuples.ByteMatchTuples"
...
def serialize_aws_json_1_1(value: ByteMatchSet) -> dict:
    ...
    out["ByteMatchTuples"] = (
        aws_sdk_waf_regional.types.byte_match_tuples.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ByteMatchSet:
    ...
    if "ByteMatchTuples" in data:
        ...
        out["byte_match_tuples"] = (
            aws_sdk_waf_regional.types.byte_match_tuples.deserialize_aws_json_1_1(
