...
if TYPE_CHECKING:
    import aws_sdk_waf_regional.types.match_field_data
    import aws_sdk_waf_regional.types.match_field_type


class FieldToMatch(TypedDict, closed=True):
    type: "aws_sdk_waf_regional.types.match_field_type.MatchFieldType"
    ...
    data: NotRequired["aws_sdk_waf_regional.types.match_field_data.MatchFieldData"]
...
def serialize_aws_json_1_1(value: FieldToMatch) -> dict:
    ...
    out["Type"] = aws_sdk_waf_regional.types.match_field_type.serialize_aws_json_1_1(
        value["type"]
    )
    if "data" in value:
        out["Data"] = value["data"]
...
def deserialize_aws_json_1_1(data: dict) -> FieldToMatch:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            aws_sdk_waf_regional.types.match_field_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    else:
