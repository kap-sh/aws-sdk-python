...
if TYPE_CHECKING:
    import aws_sdk_waf_regional.types.log_destination_configs
    import aws_sdk_waf_regional.types.redacted_fields
...
class LoggingConfiguration(TypedDict):
    ...
    log_destination_configs: (
        "aws_sdk_waf_regional.types.log_destination_configs.LogDestinationConfigs"
    )
    """<p>An array of Amazon Kinesis Data Firehose ARNs.</p>"""
    redacted_fields: NotRequired[
        "aws_sdk_waf_regional.types.redacted_fields.RedactedFields"
    ]
...
def serialize_aws_json_1_1(value: LoggingConfiguration) -> dict:
    ...
    out["LogDestinationConfigs"] = (
        aws_sdk_waf_regional.types.log_destination_configs.serialize_aws_json_1_1(
    ...
    if "redacted_fields" in value:
        ...
        out["RedactedFields"] = (
            aws_sdk_waf_regional.types.redacted_fields.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> LoggingConfiguration:
    ...
    if "LogDestinationConfigs" in data:
        ...
        out["log_destination_configs"] = (
            aws_sdk_waf_regional.types.log_destination_configs.deserialize_aws_json_1_1(
    ...
    if "RedactedFields" in data:
        ...
        out["redacted_fields"] = (
            aws_sdk_waf_regional.types.redacted_fields.deserialize_aws_json_1_1(
                data["RedactedFields"]
            )
        )
    return out
