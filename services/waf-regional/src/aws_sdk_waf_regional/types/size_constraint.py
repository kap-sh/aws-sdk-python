"""Generated from Smithy shape ``com.amazonaws.wafregional#SizeConstraint``."""
...
if TYPE_CHECKING:
    import aws_sdk_waf_regional.types.comparison_operator
    import aws_sdk_waf_regional.types.field_to_match
    import aws_sdk_waf_regional.types.size
    import aws_sdk_waf_regional.types.text_transformation


class SizeConstraint(TypedDict):
    field_to_match: "aws_sdk_waf_regional.types.field_to_match.FieldToMatch"
    """<p>Specifies where in a web request to look for the size constraint.</p>"""
    text_transformation: (
        "aws_sdk_waf_regional.types.text_transformation.TextTransformation"
    )
    ...
    comparison_operator: (
        "aws_sdk_waf_regional.types.comparison_operator.ComparisonOperator"
    )
    ...
    size: "aws_sdk_waf_regional.types.size.Size"
...
def serialize_aws_json_1_1(value: SizeConstraint) -> dict:
    ...
    out["FieldToMatch"] = (
        aws_sdk_waf_regional.types.field_to_match.serialize_aws_json_1_1(
    ...
    out["TextTransformation"] = (
        aws_sdk_waf_regional.types.text_transformation.serialize_aws_json_1_1(
    ...
    out["ComparisonOperator"] = (
        aws_sdk_waf_regional.types.comparison_operator.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SizeConstraint:
    ...
    if "FieldToMatch" in data:
        ...
        out["field_to_match"] = (
            aws_sdk_waf_regional.types.field_to_match.deserialize_aws_json_1_1(
                data["FieldToMatch"]
            )
        )
    else:
    ...
    if "TextTransformation" in data:
        ...
        out["text_transformation"] = (
            aws_sdk_waf_regional.types.text_transformation.deserialize_aws_json_1_1(
    ...
    if "ComparisonOperator" in data:
        ...
        out["comparison_operator"] = (
            aws_sdk_waf_regional.types.comparison_operator.deserialize_aws_json_1_1(
