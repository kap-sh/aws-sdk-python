...
if TYPE_CHECKING:
    ...
    import aws_sdk_waf_regional.types.size_constraints
...
class SizeConstraintSet(TypedDict):
    ...
    size_constraints: "aws_sdk_waf_regional.types.size_constraints.SizeConstraints"
...
def serialize_aws_json_1_1(value: SizeConstraintSet) -> dict:
    ...
    out["SizeConstraints"] = (
        aws_sdk_waf_regional.types.size_constraints.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SizeConstraintSet:
    ...
    if "SizeConstraints" in data:
        ...
        out["size_constraints"] = (
            aws_sdk_waf_regional.types.size_constraints.deserialize_aws_json_1_1(
