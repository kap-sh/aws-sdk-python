...
class ListResourcesForWebACLResponse(TypedDict):
    resource_arns: NotRequired["aws_sdk_waf_regional.types.resource_arns.ResourceArns"]
...
def serialize_aws_json_1_1(value: ListResourcesForWebACLResponse) -> dict:
    ...
    if "resource_arns" in value:
        ...
        out["ResourceArns"] = (
            aws_sdk_waf_regional.types.resource_arns.serialize_aws_json_1_1(
                value["resource_arns"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListResourcesForWebACLResponse:
    ...
    if "ResourceArns" in data:
        ...
        out["resource_arns"] = (
            aws_sdk_waf_regional.types.resource_arns.deserialize_aws_json_1_1(
                data["ResourceArns"]
            )
        )
    return out
