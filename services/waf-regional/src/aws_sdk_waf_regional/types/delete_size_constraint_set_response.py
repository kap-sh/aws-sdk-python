"""Generated from Smithy shape ``com.amazonaws.wafregional#DeleteSizeConstraintSetResponse``."""
...
class DeleteSizeConstraintSetResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteSizeConstraintSetResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeleteSizeConstraintSetResponse:
    out: DeleteSizeConstraintSetResponse = {}  # type: ignore[typeddict-item]
