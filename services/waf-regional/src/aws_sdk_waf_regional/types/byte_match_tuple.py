...
if TYPE_CHECKING:
    import aws_sdk_waf_regional.types.byte_match_target_string
    import aws_sdk_waf_regional.types.field_to_match
    import aws_sdk_waf_regional.types.positional_constraint
...
class ByteMatchTuple(TypedDict):
    ...
    target_string: (
        "aws_sdk_waf_regional.types.byte_match_target_string.ByteMatchTargetString"
    )
    ...
    positional_constraint: (
        "aws_sdk_waf_regional.types.positional_constraint.PositionalConstraint"
    )
...
def serialize_aws_json_1_1(value: ByteMatchTuple) -> dict:
    ...
    out["TargetString"] = (
        aws_sdk_waf_regional.types.byte_match_target_string.serialize_aws_json_1_1(
            value["target_string"]
        )
    )
    import aws_sdk_waf_regional.types.text_transformation
    ...
    out["PositionalConstraint"] = (
        aws_sdk_waf_regional.types.positional_constraint.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ByteMatchTuple:
    ...
    if "TargetString" in data:
        ...
        out["target_string"] = (
            aws_sdk_waf_regional.types.byte_match_target_string.deserialize_aws_json_1_1(
                data["TargetString"]
            )
        )
    else:
    ...
    if "PositionalConstraint" in data:
        ...
        out["positional_constraint"] = (
            aws_sdk_waf_regional.types.positional_constraint.deserialize_aws_json_1_1(
