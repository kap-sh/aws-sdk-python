"""Generated from Smithy shape ``com.amazonaws.wafregional#GetRegexMatchSetResponse``."""
...
class GetRegexMatchSetResponse(TypedDict, closed=True):
    regex_match_set: NotRequired[
        "aws_sdk_waf_regional.types.regex_match_set.RegexMatchSet"
    ]
...
def serialize_aws_json_1_1(value: GetRegexMatchSetResponse) -> dict:
    ...
    if "regex_match_set" in value:
        ...
        out["RegexMatchSet"] = (
            aws_sdk_waf_regional.types.regex_match_set.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetRegexMatchSetResponse:
    ...
    if "RegexMatchSet" in data:
        ...
        out["regex_match_set"] = (
            aws_sdk_waf_regional.types.regex_match_set.deserialize_aws_json_1_1(
                data["RegexMatchSet"]
            )
        )
    return out
