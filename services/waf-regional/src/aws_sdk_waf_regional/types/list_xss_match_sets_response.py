...
class ListXssMatchSetsResponse(TypedDict, closed=True):
    ...
    xss_match_sets: NotRequired[
        "aws_sdk_waf_regional.types.xss_match_set_summaries.XssMatchSetSummaries"
    ]
...
def serialize_aws_json_1_1(value: ListXssMatchSetsResponse) -> dict:
    ...
    if "xss_match_sets" in value:
        ...
        out["XssMatchSets"] = (
            aws_sdk_waf_regional.types.xss_match_set_summaries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListXssMatchSetsResponse:
    ...
    if "XssMatchSets" in data:
        ...
        out["xss_match_sets"] = (
            aws_sdk_waf_regional.types.xss_match_set_summaries.deserialize_aws_json_1_1(
                data["XssMatchSets"]
            )
        )
    return out
