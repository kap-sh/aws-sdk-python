"""Generated from Smithy shape ``com.amazonaws.wafregional#UpdateByteMatchSetResponse``."""
...
class UpdateByteMatchSetResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateByteMatchSetResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> UpdateByteMatchSetResponse:
    out: UpdateByteMatchSetResponse = {}  # type: ignore[typeddict-item]
