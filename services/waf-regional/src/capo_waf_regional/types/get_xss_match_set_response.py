...
class GetXssMatchSetResponse(TypedDict, closed=True):
    xss_match_set: NotRequired["capo_waf_regional.types.xss_match_set.XssMatchSet"]
...
def serialize_aws_json_1_1(value: GetXssMatchSetResponse) -> dict:
    ...
    if "xss_match_set" in value:
        ...
        out["XssMatchSet"] = (
            capo_waf_regional.types.xss_match_set.serialize_aws_json_1_1(
                value["xss_match_set"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetXssMatchSetResponse:
    ...
    if "XssMatchSet" in data:
        ...
        out["xss_match_set"] = (
            capo_waf_regional.types.xss_match_set.deserialize_aws_json_1_1(
                data["XssMatchSet"]
            )
        )
    return out
