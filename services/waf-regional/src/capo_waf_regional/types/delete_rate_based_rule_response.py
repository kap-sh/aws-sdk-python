"""Generated from Smithy shape ``com.amazonaws.wafregional#DeleteRateBasedRuleResponse``."""
...
class DeleteRateBasedRuleResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteRateBasedRuleResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeleteRateBasedRuleResponse:
    out: DeleteRateBasedRuleResponse = {}  # type: ignore[typeddict-item]
