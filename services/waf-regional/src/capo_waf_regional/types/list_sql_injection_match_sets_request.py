"""Generated from Smithy shape ``com.amazonaws.wafregional#ListSqlInjectionMatchSetsRequest``."""
...
class ListSqlInjectionMatchSetsRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListSqlInjectionMatchSetsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListSqlInjectionMatchSetsRequest:
    out: ListSqlInjectionMatchSetsRequest = {}  # type: ignore[typeddict-item]
