...
if TYPE_CHECKING:
    import capo_waf_regional.types.waf_override_action_type


class WafOverrideAction(TypedDict, closed=True):
    type: "capo_waf_regional.types.waf_override_action_type.WafOverrideActionType"
...
def serialize_aws_json_1_1(value: WafOverrideAction) -> dict:
    ...
    out["Type"] = (
        capo_waf_regional.types.waf_override_action_type.serialize_aws_json_1_1(
            value["type"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> WafOverrideAction:
    ...
    if "Type" in data:
        ...
        out["type"] = (
            capo_waf_regional.types.waf_override_action_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    else:
