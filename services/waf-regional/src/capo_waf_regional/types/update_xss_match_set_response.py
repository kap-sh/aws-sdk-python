"""Generated from Smithy shape ``com.amazonaws.wafregional#UpdateXssMatchSetResponse``."""
...
class UpdateXssMatchSetResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateXssMatchSetResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> UpdateXssMatchSetResponse:
    out: UpdateXssMatchSetResponse = {}  # type: ignore[typeddict-item]
