...
SqlInjectionMatchTuples: TypeAlias = list[
    "capo_waf_regional.types.sql_injection_match_tuple.SqlInjectionMatchTuple"
]
...
def serialize_aws_json_1_1(value: SqlInjectionMatchTuples) -> list:
    ...
    for item in value:
        out.append(
            capo_waf_regional.types.sql_injection_match_tuple.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> SqlInjectionMatchTuples:
    ...
    for item in data:
        out.append(
            capo_waf_regional.types.sql_injection_match_tuple.deserialize_aws_json_1_1(
                item
            )
        )
    return out
