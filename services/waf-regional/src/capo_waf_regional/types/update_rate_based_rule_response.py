"""Generated from Smithy shape ``com.amazonaws.wafregional#UpdateRateBasedRuleResponse``."""
...
class UpdateRateBasedRuleResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateRateBasedRuleResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> UpdateRateBasedRuleResponse:
    out: UpdateRateBasedRuleResponse = {}  # type: ignore[typeddict-item]
