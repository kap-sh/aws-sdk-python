...
class WebACL(TypedDict, closed=True):
    ...
    rules: "capo_waf_regional.types.activated_rules.ActivatedRules"
    ...
    web_acl_arn: NotRequired["capo_waf_regional.types.resource_arn.ResourceArn"]
...
def serialize_aws_json_1_1(value: WebACL) -> dict:
    ...
    out["Rules"] = capo_waf_regional.types.activated_rules.serialize_aws_json_1_1(
        value["rules"]
    )
