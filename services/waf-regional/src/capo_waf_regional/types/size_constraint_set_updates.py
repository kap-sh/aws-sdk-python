...
if TYPE_CHECKING:
    import capo_waf_regional.types.size_constraint_set_update

SizeConstraintSetUpdates: TypeAlias = list[
    "capo_waf_regional.types.size_constraint_set_update.SizeConstraintSetUpdate"
]
...
def serialize_aws_json_1_1(value: SizeConstraintSetUpdates) -> list:
    ...
    for item in value:
        out.append(
            capo_waf_regional.types.size_constraint_set_update.serialize_aws_json_1_1(
                item
            )
        )
    return out
