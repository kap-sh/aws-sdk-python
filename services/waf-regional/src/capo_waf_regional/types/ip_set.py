...
if TYPE_CHECKING:
    import capo_waf_regional.types.ip_set_descriptors
...
class IPSet(TypedDict, closed=True):
    ...
    ip_set_descriptors: "capo_waf_regional.types.ip_set_descriptors.IPSetDescriptors"
...
def serialize_aws_json_1_1(value: IPSet) -> dict:
    ...
    out["IPSetDescriptors"] = (
        capo_waf_regional.types.ip_set_descriptors.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> IPSet:
    ...
    if "IPSetDescriptors" in data:
        ...
        out["ip_set_descriptors"] = (
            capo_waf_regional.types.ip_set_descriptors.deserialize_aws_json_1_1(
