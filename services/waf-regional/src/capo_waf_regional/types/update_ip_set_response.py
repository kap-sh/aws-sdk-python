"""Generated from Smithy shape ``com.amazonaws.wafregional#UpdateIPSetResponse``."""
...
class UpdateIPSetResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateIPSetResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> UpdateIPSetResponse:
    out: UpdateIPSetResponse = {}  # type: ignore[typeddict-item]
