...
class RuleGroupUpdate(TypedDict, closed=True):
    ...
    activated_rule: "capo_waf_regional.types.activated_rule.ActivatedRule"
...
def serialize_aws_json_1_1(value: RuleGroupUpdate) -> dict:
    ...
    out["ActivatedRule"] = (
        capo_waf_regional.types.activated_rule.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RuleGroupUpdate:
    ...
    if "ActivatedRule" in data:
        ...
        out["activated_rule"] = (
            capo_waf_regional.types.activated_rule.deserialize_aws_json_1_1(
                data["ActivatedRule"]
            )
        )
    else:
