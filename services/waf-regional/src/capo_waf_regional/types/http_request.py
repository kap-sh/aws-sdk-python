...
if TYPE_CHECKING:
    import capo_waf_regional.types.country
    import capo_waf_regional.types.http_headers
    import capo_waf_regional.types.http_method
    import capo_waf_regional.types.http_version
    import capo_waf_regional.types.ip_string
    import capo_waf_regional.types.uri_string


class HTTPRequest(TypedDict, closed=True):
    client_ip: NotRequired["capo_waf_regional.types.ip_string.IPString"]
    ...
    country: NotRequired["capo_waf_regional.types.country.Country"]
    ...
    uri: NotRequired["capo_waf_regional.types.uri_string.URIString"]
    """<p>The part of a web request that identifies the resource, for example, <code>/images/daily-ad.jpg</code>.</p>"""
    method: NotRequired["capo_waf_regional.types.http_method.HTTPMethod"]
    ...
    http_version: NotRequired["capo_waf_regional.types.http_version.HTTPVersion"]
    """<p>The HTTP version specified in the sampled web request, for example, <code>HTTP/1.1</code>.</p>"""
    headers: NotRequired["capo_waf_regional.types.http_headers.HTTPHeaders"]
...
def serialize_aws_json_1_1(value: HTTPRequest) -> dict:
    ...
    if "headers" in value:
        ...
        out["Headers"] = capo_waf_regional.types.http_headers.serialize_aws_json_1_1(
            value["headers"]
        )
    return out
