...
from ._services.async_waf_regional import (
    AsyncWAFRegionalClient as AsyncWAFRegionalClient,
)
from ._services.waf_regional import WAFRegionalClient as WAFRegionalClient
