"""Generated from Smithy shape ``com.amazonaws.wafregional#DeleteRateBasedRule``."""
...
import capo_waf_regional.errors.waf_non_empty_entity_exception
import capo_waf_regional.errors.waf_nonexistent_item_exception
import capo_waf_regional.errors.waf_referenced_item_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFNonEmptyEntityException":
            raise capo_waf_regional.errors.waf_non_empty_entity_exception.WAFNonEmptyEntityException.from_aws_json_1_1(
                data
            )
        ...
        case "WAFReferencedItemException":
            raise capo_waf_regional.errors.waf_referenced_item_exception.WAFReferencedItemException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_waf_regional.types.delete_rate_based_rule_response.DeleteRateBasedRuleResponse = capo_waf_regional.types.delete_rate_based_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.delete_rate_based_rule_request.DeleteRateBasedRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.delete_rate_based_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
