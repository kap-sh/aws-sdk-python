"""Generated from Smithy shape ``com.amazonaws.wafregional#CreateWebACLMigrationStack``."""
...
import capo_waf_regional.errors.waf_entity_migration_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "WAFEntityMigrationException":
            raise capo_waf_regional.errors.waf_entity_migration_exception.WAFEntityMigrationException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_waf_regional.types.create_web_acl_migration_stack_response.CreateWebACLMigrationStackResponse = capo_waf_regional.types.create_web_acl_migration_stack_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.create_web_acl_migration_stack_request.CreateWebACLMigrationStackRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSWAF_Regional_20161128.CreateWebACLMigrationStack"
    body: bytes | None = json.dumps(
        capo_waf_regional.types.create_web_acl_migration_stack_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_create_web_acl_migration_stack(
