"""Generated from Smithy shape ``com.amazonaws.wafregional#CreateRateBasedRule``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.create_rate_based_rule_response.CreateRateBasedRuleResponse = capo_waf_regional.types.create_rate_based_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.create_rate_based_rule_request.CreateRateBasedRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.create_rate_based_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
