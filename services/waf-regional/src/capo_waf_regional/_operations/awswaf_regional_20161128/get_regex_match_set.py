"""Generated from Smithy shape ``com.amazonaws.wafregional#GetRegexMatchSet``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.get_regex_match_set_response.GetRegexMatchSetResponse = capo_waf_regional.types.get_regex_match_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.get_regex_match_set_request.GetRegexMatchSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.get_regex_match_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
