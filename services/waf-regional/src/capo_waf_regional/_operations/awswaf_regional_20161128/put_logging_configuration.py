"""Generated from Smithy shape ``com.amazonaws.wafregional#PutLoggingConfiguration``."""
...
import capo_waf_regional.errors.waf_service_linked_role_error_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFServiceLinkedRoleErrorException":
            raise capo_waf_regional.errors.waf_service_linked_role_error_exception.WAFServiceLinkedRoleErrorException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_waf_regional.types.put_logging_configuration_response.PutLoggingConfigurationResponse = capo_waf_regional.types.put_logging_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.put_logging_configuration_request.PutLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.put_logging_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
