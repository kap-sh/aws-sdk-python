"""Generated from Smithy shape ``com.amazonaws.wafregional#ListIPSets``."""
...
import capo_waf_regional.types.ip_set_summaries
...
def handle_response(
    ...
    out: capo_waf_regional.types.list_ip_sets_response.ListIPSetsResponse = (
        capo_waf_regional.types.list_ip_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.list_ip_sets_request.ListIPSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.list_ip_sets_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def list_ip_sets(
    ...
    capo_waf_regional.types.list_ip_sets_response.ListIPSetsResponse, zapros.Response
]:
