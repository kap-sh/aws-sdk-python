"""Generated from Smithy shape ``com.amazonaws.wafregional#GetSizeConstraintSet``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.get_size_constraint_set_response.GetSizeConstraintSetResponse = capo_waf_regional.types.get_size_constraint_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.get_size_constraint_set_request.GetSizeConstraintSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.get_size_constraint_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
