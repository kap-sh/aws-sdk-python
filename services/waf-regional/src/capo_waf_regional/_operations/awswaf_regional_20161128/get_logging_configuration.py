"""Generated from Smithy shape ``com.amazonaws.wafregional#GetLoggingConfiguration``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.get_logging_configuration_response.GetLoggingConfigurationResponse = capo_waf_regional.types.get_logging_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.get_logging_configuration_request.GetLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.get_logging_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
