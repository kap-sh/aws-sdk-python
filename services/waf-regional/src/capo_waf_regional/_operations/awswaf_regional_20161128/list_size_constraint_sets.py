"""Generated from Smithy shape ``com.amazonaws.wafregional#ListSizeConstraintSets``."""
...
import capo_waf_regional.types.size_constraint_set_summaries
...
def handle_response(
    ...
    out: capo_waf_regional.types.list_size_constraint_sets_response.ListSizeConstraintSetsResponse = capo_waf_regional.types.list_size_constraint_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.list_size_constraint_sets_request.ListSizeConstraintSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.list_size_constraint_sets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_size_constraint_sets(
