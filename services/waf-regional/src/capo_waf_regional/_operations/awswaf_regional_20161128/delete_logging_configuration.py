"""Generated from Smithy shape ``com.amazonaws.wafregional#DeleteLoggingConfiguration``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.delete_logging_configuration_response.DeleteLoggingConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: capo_waf_regional.types.delete_logging_configuration_request.DeleteLoggingConfigurationRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.delete_logging_configuration_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
