"""Generated from Smithy shape ``com.amazonaws.wafregional#UpdateIPSet``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.update_ip_set_response.UpdateIPSetResponse = (
        capo_waf_regional.types.update_ip_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.update_ip_set_request.UpdateIPSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.update_ip_set_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def update_ip_set(
    ...
    capo_waf_regional.types.update_ip_set_response.UpdateIPSetResponse, zapros.Response
]:
