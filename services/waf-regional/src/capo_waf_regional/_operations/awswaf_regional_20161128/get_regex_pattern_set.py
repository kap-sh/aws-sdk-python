"""Generated from Smithy shape ``com.amazonaws.wafregional#GetRegexPatternSet``."""
...
import capo_waf_regional.types.regex_pattern_set
...
def handle_response(
    ...
    out: capo_waf_regional.types.get_regex_pattern_set_response.GetRegexPatternSetResponse = capo_waf_regional.types.get_regex_pattern_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.get_regex_pattern_set_request.GetRegexPatternSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.get_regex_pattern_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
