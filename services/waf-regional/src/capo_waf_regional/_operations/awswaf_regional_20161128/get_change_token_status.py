"""Generated from Smithy shape ``com.amazonaws.wafregional#GetChangeTokenStatus``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.get_change_token_status_response.GetChangeTokenStatusResponse = capo_waf_regional.types.get_change_token_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.get_change_token_status_request.GetChangeTokenStatusRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.get_change_token_status_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_change_token_status(
