"""Generated from Smithy shape ``com.amazonaws.wafregional#ListTagsForResource``."""
...
import capo_waf_regional.types.tag_info_for_resource
...
def handle_response(
    ...
    out: capo_waf_regional.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_waf_regional.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.list_tags_for_resource_request.ListTagsForResourceRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.list_tags_for_resource_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
