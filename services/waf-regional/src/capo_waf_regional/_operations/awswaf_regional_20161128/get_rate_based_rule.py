"""Generated from Smithy shape ``com.amazonaws.wafregional#GetRateBasedRule``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.get_rate_based_rule_response.GetRateBasedRuleResponse = capo_waf_regional.types.get_rate_based_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.get_rate_based_rule_request.GetRateBasedRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.get_rate_based_rule_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_get_rate_based_rule(
