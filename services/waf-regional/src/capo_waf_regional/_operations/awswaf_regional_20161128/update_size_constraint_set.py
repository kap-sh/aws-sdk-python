"""Generated from Smithy shape ``com.amazonaws.wafregional#UpdateSizeConstraintSet``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.update_size_constraint_set_response.UpdateSizeConstraintSetResponse = capo_waf_regional.types.update_size_constraint_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.update_size_constraint_set_request.UpdateSizeConstraintSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.update_size_constraint_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
