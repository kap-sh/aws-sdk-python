"""Generated from Smithy shape ``com.amazonaws.wafregional#ListActivatedRulesInRuleGroup``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.list_activated_rules_in_rule_group_response.ListActivatedRulesInRuleGroupResponse = capo_waf_regional.types.list_activated_rules_in_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.list_activated_rules_in_rule_group_request.ListActivatedRulesInRuleGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSWAF_Regional_20161128.ListActivatedRulesInRuleGroup"
    body: bytes | None = json.dumps(
        capo_waf_regional.types.list_activated_rules_in_rule_group_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
