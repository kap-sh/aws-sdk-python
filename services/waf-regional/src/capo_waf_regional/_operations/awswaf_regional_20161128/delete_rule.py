"""Generated from Smithy shape ``com.amazonaws.wafregional#DeleteRule``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.delete_rule_response.DeleteRuleResponse = (
        capo_waf_regional.types.delete_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.delete_rule_request.DeleteRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.delete_rule_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def delete_rule(
    ...
    capo_waf_regional.types.delete_rule_response.DeleteRuleResponse, zapros.Response
]:
