"""Generated from Smithy shape ``com.amazonaws.wafregional#ListResourcesForWebACL``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.list_resources_for_web_acl_response.ListResourcesForWebACLResponse = capo_waf_regional.types.list_resources_for_web_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.list_resources_for_web_acl_request.ListResourcesForWebACLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.list_resources_for_web_acl_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_resources_for_web_acl(
