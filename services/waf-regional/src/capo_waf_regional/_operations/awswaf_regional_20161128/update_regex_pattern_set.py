"""Generated from Smithy shape ``com.amazonaws.wafregional#UpdateRegexPatternSet``."""
...
import capo_waf_regional.errors.waf_invalid_regex_pattern_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFInvalidRegexPatternException":
            raise capo_waf_regional.errors.waf_invalid_regex_pattern_exception.WAFInvalidRegexPatternException.from_aws_json_1_1(
                data
            )
...
def handle_response(
    ...
    out: capo_waf_regional.types.update_regex_pattern_set_response.UpdateRegexPatternSetResponse = capo_waf_regional.types.update_regex_pattern_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.update_regex_pattern_set_request.UpdateRegexPatternSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.update_regex_pattern_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_regex_pattern_set(
