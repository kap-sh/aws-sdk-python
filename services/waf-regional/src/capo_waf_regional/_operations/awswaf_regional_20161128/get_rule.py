"""Generated from Smithy shape ``com.amazonaws.wafregional#GetRule``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.get_rule_response.GetRuleResponse = (
        capo_waf_regional.types.get_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.get_rule_request.GetRuleRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.get_rule_request.serialize_aws_json_1_1(input_)
    ).encode()
...
def get_rule(
    ...
    input_: capo_waf_regional.types.get_rule_request.GetRuleRequest,
) -> tuple[capo_waf_regional.types.get_rule_response.GetRuleResponse, zapros.Response]:
