"""Generated from Smithy shape ``com.amazonaws.wafregional#DeleteByteMatchSet``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.delete_byte_match_set_response.DeleteByteMatchSetResponse = capo_waf_regional.types.delete_byte_match_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.delete_byte_match_set_request.DeleteByteMatchSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.delete_byte_match_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_delete_byte_match_set(
