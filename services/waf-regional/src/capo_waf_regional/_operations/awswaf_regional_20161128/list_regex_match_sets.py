"""Generated from Smithy shape ``com.amazonaws.wafregional#ListRegexMatchSets``."""
...
import capo_waf_regional.types.regex_match_set_summaries
...
def handle_response(
    ...
    out: capo_waf_regional.types.list_regex_match_sets_response.ListRegexMatchSetsResponse = capo_waf_regional.types.list_regex_match_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.list_regex_match_sets_request.ListRegexMatchSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.list_regex_match_sets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_list_regex_match_sets(
