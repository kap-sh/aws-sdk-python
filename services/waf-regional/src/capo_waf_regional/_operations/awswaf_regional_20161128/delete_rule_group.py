"""Generated from Smithy shape ``com.amazonaws.wafregional#DeleteRuleGroup``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.delete_rule_group_response.DeleteRuleGroupResponse = (
        capo_waf_regional.types.delete_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.delete_rule_group_request.DeleteRuleGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.delete_rule_group_request.serialize_aws_json_1_1(input_)
    ).encode()
