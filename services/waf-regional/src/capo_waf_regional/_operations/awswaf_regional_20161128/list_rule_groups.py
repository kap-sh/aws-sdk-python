"""Generated from Smithy shape ``com.amazonaws.wafregional#ListRuleGroups``."""
...
import capo_waf_regional.types.rule_group_summaries
...
def handle_response(
    ...
    out: capo_waf_regional.types.list_rule_groups_response.ListRuleGroupsResponse = (
        capo_waf_regional.types.list_rule_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.list_rule_groups_request.ListRuleGroupsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.list_rule_groups_request.serialize_aws_json_1_1(input_)
    ).encode()
...
async def async_list_rule_groups(
