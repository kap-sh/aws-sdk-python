"""Generated from Smithy shape ``com.amazonaws.wafregional#ListSqlInjectionMatchSets``."""
...
import capo_waf_regional.types.sql_injection_match_set_summaries
...
def handle_response(
    ...
    out: capo_waf_regional.types.list_sql_injection_match_sets_response.ListSqlInjectionMatchSetsResponse = capo_waf_regional.types.list_sql_injection_match_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.list_sql_injection_match_sets_request.ListSqlInjectionMatchSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSWAF_Regional_20161128.ListSqlInjectionMatchSets"
    body: bytes | None = json.dumps(
        capo_waf_regional.types.list_sql_injection_match_sets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
