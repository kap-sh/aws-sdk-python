"""Generated from Smithy shape ``com.amazonaws.wafregional#UpdateWebACL``."""
...
import capo_waf_regional.errors.waf_subscription_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFSubscriptionNotFoundException":
            raise capo_waf_regional.errors.waf_subscription_not_found_exception.WAFSubscriptionNotFoundException.from_aws_json_1_1(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_waf_regional.types.update_web_acl_response.UpdateWebACLResponse = (
        capo_waf_regional.types.update_web_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.update_web_acl_request.UpdateWebACLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.update_web_acl_request.serialize_aws_json_1_1(input_)
    ).encode()
