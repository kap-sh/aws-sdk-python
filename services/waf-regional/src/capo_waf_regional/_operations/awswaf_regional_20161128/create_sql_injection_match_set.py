"""Generated from Smithy shape ``com.amazonaws.wafregional#CreateSqlInjectionMatchSet``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.create_sql_injection_match_set_response.CreateSqlInjectionMatchSetResponse = capo_waf_regional.types.create_sql_injection_match_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.create_sql_injection_match_set_request.CreateSqlInjectionMatchSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSWAF_Regional_20161128.CreateSqlInjectionMatchSet"
    body: bytes | None = json.dumps(
        capo_waf_regional.types.create_sql_injection_match_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
