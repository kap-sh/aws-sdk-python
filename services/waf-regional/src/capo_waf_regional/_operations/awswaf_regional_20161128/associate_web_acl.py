...
def handle_response(
    ...
    out: capo_waf_regional.types.associate_web_acl_response.AssociateWebACLResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: capo_waf_regional.types.associate_web_acl_request.AssociateWebACLRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.associate_web_acl_request.serialize_aws_json_1_1(input_)
    ).encode()
