"""Generated from Smithy shape ``com.amazonaws.wafregional#UpdateByteMatchSet``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.update_byte_match_set_response.UpdateByteMatchSetResponse = capo_waf_regional.types.update_byte_match_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.update_byte_match_set_request.UpdateByteMatchSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.update_byte_match_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
