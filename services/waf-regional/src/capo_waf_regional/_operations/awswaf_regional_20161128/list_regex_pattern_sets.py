"""Generated from Smithy shape ``com.amazonaws.wafregional#ListRegexPatternSets``."""
...
import capo_waf_regional.types.regex_pattern_set_summaries
...
def handle_response(
    ...
    out: capo_waf_regional.types.list_regex_pattern_sets_response.ListRegexPatternSetsResponse = capo_waf_regional.types.list_regex_pattern_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.list_regex_pattern_sets_request.ListRegexPatternSetsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.list_regex_pattern_sets_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
