"""Generated from Smithy shape ``com.amazonaws.wafregional#UpdateSqlInjectionMatchSet``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.update_sql_injection_match_set_response.UpdateSqlInjectionMatchSetResponse = capo_waf_regional.types.update_sql_injection_match_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_waf_regional.types.update_sql_injection_match_set_request.UpdateSqlInjectionMatchSetRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    headers["X-Amz-Target"] = "AWSWAF_Regional_20161128.UpdateSqlInjectionMatchSet"
    body: bytes | None = json.dumps(
        capo_waf_regional.types.update_sql_injection_match_set_request.serialize_aws_json_1_1(
            input_
        )
    ).encode()
...
async def async_update_sql_injection_match_set(
