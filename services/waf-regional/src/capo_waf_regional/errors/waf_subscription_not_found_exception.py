"""Generated from Smithy shape ``com.amazonaws.wafregional#WAFSubscriptionNotFoundException``."""
...
class WAFSubscriptionNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.wafregional#WAFSubscriptionNotFoundException``."""
