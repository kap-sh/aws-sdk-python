...
class WAFRegionalError(Exception):
    """Base class for all WAFRegional service errors."""


class ServiceError(WAFRegionalError):
...
class SerializationError(WAFRegionalError):
    """Raised when a value cannot be serialized."""


class DeserializationError(WAFRegionalError):
...
class WaiterFailedError(WAFRegionalError):
...
class WaiterTimeoutError(WAFRegionalError):
