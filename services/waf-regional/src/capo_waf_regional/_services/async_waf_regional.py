...
from capo_waf_regional._auth._identity import Credentials
from capo_waf_regional._auth._providers import (
    CredentialsProvider,
    IdentityProvider,
    StaticAwsCredentialsProvider,
    default_aws_credentials_chain,
)
from capo_waf_regional._auth._zapros_handler import AuthMiddleware
from capo_waf_regional._services._aws_config import aaws_config
...
if TYPE_CHECKING:
    import capo_waf_regional.types.associate_web_acl_request
    import capo_waf_regional.types.associate_web_acl_response
    import capo_waf_regional.types.byte_match_set_updates
    import capo_waf_regional.types.change_token
    import capo_waf_regional.types.create_byte_match_set_request
    import capo_waf_regional.types.create_byte_match_set_response
    import capo_waf_regional.types.create_geo_match_set_request
    import capo_waf_regional.types.create_geo_match_set_response
    import capo_waf_regional.types.create_ip_set_request
    import capo_waf_regional.types.create_ip_set_response
    import capo_waf_regional.types.create_rate_based_rule_request
    import capo_waf_regional.types.create_rate_based_rule_response
    import capo_waf_regional.types.create_regex_match_set_request
    import capo_waf_regional.types.create_regex_match_set_response
    import capo_waf_regional.types.create_regex_pattern_set_request
    import capo_waf_regional.types.create_regex_pattern_set_response
    import capo_waf_regional.types.create_rule_group_request
    import capo_waf_regional.types.create_rule_group_response
    import capo_waf_regional.types.create_rule_request
    import capo_waf_regional.types.create_rule_response
    import capo_waf_regional.types.create_size_constraint_set_request
    import capo_waf_regional.types.create_size_constraint_set_response
    import capo_waf_regional.types.create_sql_injection_match_set_request
    import capo_waf_regional.types.create_sql_injection_match_set_response
    import capo_waf_regional.types.create_web_acl_migration_stack_request
    import capo_waf_regional.types.create_web_acl_migration_stack_response
    import capo_waf_regional.types.create_web_acl_request
    import capo_waf_regional.types.create_web_acl_response
    import capo_waf_regional.types.create_xss_match_set_request
    import capo_waf_regional.types.create_xss_match_set_response
    import capo_waf_regional.types.delete_byte_match_set_request
    import capo_waf_regional.types.delete_byte_match_set_response
    import capo_waf_regional.types.delete_geo_match_set_request
    import capo_waf_regional.types.delete_geo_match_set_response
    import capo_waf_regional.types.delete_ip_set_request
    import capo_waf_regional.types.delete_ip_set_response
    import capo_waf_regional.types.delete_logging_configuration_request
    import capo_waf_regional.types.delete_logging_configuration_response
    import capo_waf_regional.types.delete_permission_policy_request
    import capo_waf_regional.types.delete_permission_policy_response
    import capo_waf_regional.types.delete_rate_based_rule_request
    import capo_waf_regional.types.delete_rate_based_rule_response
    import capo_waf_regional.types.delete_regex_match_set_request
    import capo_waf_regional.types.delete_regex_match_set_response
    import capo_waf_regional.types.delete_regex_pattern_set_request
    import capo_waf_regional.types.delete_regex_pattern_set_response
    import capo_waf_regional.types.delete_rule_group_request
    import capo_waf_regional.types.delete_rule_group_response
    import capo_waf_regional.types.delete_rule_request
    import capo_waf_regional.types.delete_rule_response
    import capo_waf_regional.types.delete_size_constraint_set_request
    import capo_waf_regional.types.delete_size_constraint_set_response
    import capo_waf_regional.types.delete_sql_injection_match_set_request
    import capo_waf_regional.types.delete_sql_injection_match_set_response
    import capo_waf_regional.types.delete_web_acl_request
    import capo_waf_regional.types.delete_web_acl_response
    import capo_waf_regional.types.delete_xss_match_set_request
    import capo_waf_regional.types.delete_xss_match_set_response
    import capo_waf_regional.types.disassociate_web_acl_request
    import capo_waf_regional.types.disassociate_web_acl_response
    import capo_waf_regional.types.geo_match_set_updates
    import capo_waf_regional.types.get_byte_match_set_request
    import capo_waf_regional.types.get_byte_match_set_response
    import capo_waf_regional.types.get_change_token_request
    import capo_waf_regional.types.get_change_token_response
    import capo_waf_regional.types.get_change_token_status_request
    import capo_waf_regional.types.get_change_token_status_response
    import capo_waf_regional.types.get_geo_match_set_request
    import capo_waf_regional.types.get_geo_match_set_response
    import capo_waf_regional.types.get_ip_set_request
    import capo_waf_regional.types.get_ip_set_response
    import capo_waf_regional.types.get_logging_configuration_request
    import capo_waf_regional.types.get_logging_configuration_response
    import capo_waf_regional.types.get_permission_policy_request
    import capo_waf_regional.types.get_permission_policy_response
    import capo_waf_regional.types.get_rate_based_rule_managed_keys_request
    import capo_waf_regional.types.get_rate_based_rule_managed_keys_response
    import capo_waf_regional.types.get_rate_based_rule_request
    import capo_waf_regional.types.get_rate_based_rule_response
    import capo_waf_regional.types.get_regex_match_set_request
    import capo_waf_regional.types.get_regex_match_set_response
    import capo_waf_regional.types.get_regex_pattern_set_request
    import capo_waf_regional.types.get_regex_pattern_set_response
    import capo_waf_regional.types.get_rule_group_request
    import capo_waf_regional.types.get_rule_group_response
    import capo_waf_regional.types.get_rule_request
    import capo_waf_regional.types.get_rule_response
    import capo_waf_regional.types.get_sampled_requests_max_items
    import capo_waf_regional.types.get_sampled_requests_request
    import capo_waf_regional.types.get_sampled_requests_response
    import capo_waf_regional.types.get_size_constraint_set_request
    import capo_waf_regional.types.get_size_constraint_set_response
    import capo_waf_regional.types.get_sql_injection_match_set_request
    import capo_waf_regional.types.get_sql_injection_match_set_response
    ...
    import capo_waf_regional.types.get_web_acl_request
    import capo_waf_regional.types.get_web_acl_response
    import capo_waf_regional.types.get_xss_match_set_request
    import capo_waf_regional.types.get_xss_match_set_response
    import capo_waf_regional.types.ignore_unsupported_type
    import capo_waf_regional.types.ip_set_updates
    import capo_waf_regional.types.list_activated_rules_in_rule_group_request
    import capo_waf_regional.types.list_activated_rules_in_rule_group_response
    import capo_waf_regional.types.list_byte_match_sets_request
    import capo_waf_regional.types.list_byte_match_sets_response
    import capo_waf_regional.types.list_geo_match_sets_request
    import capo_waf_regional.types.list_geo_match_sets_response
    import capo_waf_regional.types.list_ip_sets_request
    import capo_waf_regional.types.list_ip_sets_response
    import capo_waf_regional.types.list_logging_configurations_request
    import capo_waf_regional.types.list_logging_configurations_response
    import capo_waf_regional.types.list_rate_based_rules_request
    import capo_waf_regional.types.list_rate_based_rules_response
    import capo_waf_regional.types.list_regex_match_sets_request
    import capo_waf_regional.types.list_regex_match_sets_response
    import capo_waf_regional.types.list_regex_pattern_sets_request
    import capo_waf_regional.types.list_regex_pattern_sets_response
    import capo_waf_regional.types.list_resources_for_web_acl_request
    import capo_waf_regional.types.list_resources_for_web_acl_response
    import capo_waf_regional.types.list_rule_groups_request
    import capo_waf_regional.types.list_rule_groups_response
    import capo_waf_regional.types.list_rules_request
    import capo_waf_regional.types.list_rules_response
    import capo_waf_regional.types.list_size_constraint_sets_request
    import capo_waf_regional.types.list_size_constraint_sets_response
    import capo_waf_regional.types.list_sql_injection_match_sets_request
    import capo_waf_regional.types.list_sql_injection_match_sets_response
    import capo_waf_regional.types.list_subscribed_rule_groups_request
    import capo_waf_regional.types.list_subscribed_rule_groups_response
    import capo_waf_regional.types.list_tags_for_resource_request
    import capo_waf_regional.types.list_tags_for_resource_response
    import capo_waf_regional.types.list_web_ac_ls_request
    import capo_waf_regional.types.list_web_ac_ls_response
    import capo_waf_regional.types.list_xss_match_sets_request
    import capo_waf_regional.types.list_xss_match_sets_response
    ...
    import capo_waf_regional.types.policy_string
    import capo_waf_regional.types.put_logging_configuration_request
    import capo_waf_regional.types.put_logging_configuration_response
    import capo_waf_regional.types.put_permission_policy_request
    import capo_waf_regional.types.put_permission_policy_response
    ...
    import capo_waf_regional.types.resource_type
    import capo_waf_regional.types.rule_group_updates
    import capo_waf_regional.types.rule_updates
    import capo_waf_regional.types.s3_bucket_name
    import capo_waf_regional.types.size_constraint_set_updates
    import capo_waf_regional.types.sql_injection_match_set_updates
    import capo_waf_regional.types.tag_key_list
    import capo_waf_regional.types.tag_list
    import capo_waf_regional.types.tag_resource_request
    import capo_waf_regional.types.tag_resource_response
    import capo_waf_regional.types.time_window
    import capo_waf_regional.types.untag_resource_request
    import capo_waf_regional.types.untag_resource_response
    import capo_waf_regional.types.update_byte_match_set_request
    import capo_waf_regional.types.update_byte_match_set_response
    import capo_waf_regional.types.update_geo_match_set_request
    import capo_waf_regional.types.update_geo_match_set_response
    import capo_waf_regional.types.update_ip_set_request
    import capo_waf_regional.types.update_ip_set_response
    import capo_waf_regional.types.update_rate_based_rule_request
    import capo_waf_regional.types.update_rate_based_rule_response
    ...
    import capo_waf_regional.types.update_regex_pattern_set_request
    import capo_waf_regional.types.update_regex_pattern_set_response
    import capo_waf_regional.types.update_rule_group_request
    import capo_waf_regional.types.update_rule_group_response
    import capo_waf_regional.types.update_rule_request
    import capo_waf_regional.types.update_rule_response
    import capo_waf_regional.types.update_size_constraint_set_request
    import capo_waf_regional.types.update_size_constraint_set_response
    import capo_waf_regional.types.update_sql_injection_match_set_request
    import capo_waf_regional.types.update_sql_injection_match_set_response
    import capo_waf_regional.types.update_web_acl_request
    import capo_waf_regional.types.update_web_acl_response
    import capo_waf_regional.types.update_xss_match_set_request
    import capo_waf_regional.types.update_xss_match_set_response
...
class AsyncWAFRegionalClientConfig(TypedDict, total=False, closed=True):
...
class AsyncWAFRegionalClient:
    ...
    def __init__(
        ...
        self._config = AsyncWAFRegionalClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncWAFRegionalClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncWAFRegionalClientConfig = config_overrides or {}
    ...
    async def associate_web_acl(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.associate_web_acl_response.AssociateWebACLResponse":
        ...
        Raises:
            capo_waf_regional.errors.waf_internal_error_exception.WAFInternalErrorException: <p>The operation failed because of a system problem, even though the request was valid. Retry your request.</p>
            capo_waf_regional.errors.waf_invalid_account_exception.WAFInvalidAccountException: <p>The operation failed because you tried to create, update, or delete an object by using an invalid account identifier.</p>
            capo_waf_regional.errors.waf_invalid_parameter_exception.WAFInvalidParameterException: <p>The operation failed because AWS WAF didn't recognize a parameter in the request. For example:</p> <ul> <li> <p>You specified an invalid parameter name.</p> </li> <li> <p>You specified an invalid value.</p> </li> <li> <p>You tried to update an object (<code>ByteMatchSet</code>, <code>IPSet</code>, <code>Rule</code>, or <code>WebACL</code>) using an action other than <code>INSERT</code> or <code>DELETE</code>.</p> </li> <li> <p>You tried to create a <code>WebACL</code> with a <code>DefaultAction</code> <code>Type</code> other than <code>ALLOW</code>, <code>BLOCK</code>, or <code>COUNT</code>.</p> </li> <li> <p>You tried to create a <code>RateBasedRule</code> with a <code>RateKey</code> value other than <code>IP</code>.</p> </li> <li> <p>You tried to update a <code>WebACL</code> with a <code>WafAction</code> <code>Type</code> other than <code>ALLOW</code>, <code>BLOCK</code>, or <code>COUNT</code>.</p> </li> <li> <p>You tried to update a <code>ByteMatchSet</code> with a <code>FieldToMatch</code> <code>Type</code> other than HEADER, METHOD, QUERY_STRING, URI, or BODY.</p> </li> <li> <p>You tried to update a <code>ByteMatchSet</code> with a <code>Field</code> of <code>HEADER</code> but no value for <code>Data</code>.</p> </li> <li> <p>Your request references an ARN that is malformed, or corresponds to a resource with which a web ACL cannot be associated.</p> </li> </ul>
            capo_waf_regional.errors.waf_nonexistent_item_exception.WAFNonexistentItemException: <p>The operation failed because the referenced object doesn't exist.</p>
            capo_waf_regional.errors.waf_unavailable_entity_exception.WAFUnavailableEntityException: <p>The operation failed because the entity referenced is temporarily unavailable. Retry your request.</p>
            capo_waf_regional.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.associate_web_acl_request.AssociateWebACLRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.associate_web_acl_response.AssociateWebACLResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.associate_web_acl

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.associate_web_acl.async_associate_web_acl(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.associate_web_acl_request.AssociateWebACLRequest = {}  # type: ignore[typeddict-item]
    ...
    async def create_byte_match_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.create_byte_match_set_response.CreateByteMatchSetResponse":
        ...
        Raises:
            capo_waf_regional.errors.waf_disallowed_name_exception.WAFDisallowedNameException: <p>The name specified is invalid.</p>
            capo_waf_regional.errors.waf_internal_error_exception.WAFInternalErrorException: <p>The operation failed because of a system problem, even though the request was valid. Retry your request.</p>
            capo_waf_regional.errors.waf_invalid_account_exception.WAFInvalidAccountException: <p>The operation failed because you tried to create, update, or delete an object by using an invalid account identifier.</p>
            capo_waf_regional.errors.waf_invalid_parameter_exception.WAFInvalidParameterException: <p>The operation failed because AWS WAF didn't recognize a parameter in the request. For example:</p> <ul> <li> <p>You specified an invalid parameter name.</p> </li> <li> <p>You specified an invalid value.</p> </li> <li> <p>You tried to update an object (<code>ByteMatchSet</code>, <code>IPSet</code>, <code>Rule</code>, or <code>WebACL</code>) using an action other than <code>INSERT</code> or <code>DELETE</code>.</p> </li> <li> <p>You tried to create a <code>WebACL</code> with a <code>DefaultAction</code> <code>Type</code> other than <code>ALLOW</code>, <code>BLOCK</code>, or <code>COUNT</code>.</p> </li> <li> <p>You tried to create a <code>RateBasedRule</code> with a <code>RateKey</code> value other than <code>IP</code>.</p> </li> <li> <p>You tried to update a <code>WebACL</code> with a <code>WafAction</code> <code>Type</code> other than <code>ALLOW</code>, <code>BLOCK</code>, or <code>COUNT</code>.</p> </li> <li> <p>You tried to update a <code>ByteMatchSet</code> with a <code>FieldToMatch</code> <code>Type</code> other than HEADER, METHOD, QUERY_STRING, URI, or BODY.</p> </li> <li> <p>You tried to update a <code>ByteMatchSet</code> with a <code>Field</code> of <code>HEADER</code> but no value for <code>Data</code>.</p> </li> <li> <p>Your request references an ARN that is malformed, or corresponds to a resource with which a web ACL cannot be associated.</p> </li> </ul>
            capo_waf_regional.errors.waf_limits_exceeded_exception.WAFLimitsExceededException: <p>The operation exceeds a resource limit, for example, the maximum number of <code>WebACL</code> objects that you can create for an AWS account. For more information, see <a href=\"https://docs.aws.amazon.com/waf/latest/developerguide/limits.html\">Limits</a> in the <i>AWS WAF Developer Guide</i>.</p>
            capo_waf_regional.errors.waf_stale_data_exception.WAFStaleDataException: <p>The operation failed because you tried to create, update, or delete an object by using a change token that has already been used.</p>
            capo_waf_regional.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.create_byte_match_set_request.CreateByteMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.create_byte_match_set_response.CreateByteMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.create_byte_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.create_byte_match_set.async_create_byte_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.create_byte_match_set_request.CreateByteMatchSetRequest = {}  # type: ignore[typeddict-item]
        input_["name"] = name
    ...
    async def create_geo_match_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.create_geo_match_set_response.CreateGeoMatchSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.create_geo_match_set_request.CreateGeoMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.create_geo_match_set_response.CreateGeoMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.create_geo_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.create_geo_match_set.async_create_geo_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.create_geo_match_set_request.CreateGeoMatchSetRequest = {}  # type: ignore[typeddict-item]
        input_["name"] = name
        input_["change_token"] = change_token
    ...
    async def create_ip_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.create_ip_set_response.CreateIPSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.create_ip_set_request.CreateIPSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.create_ip_set_response.CreateIPSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.create_ip_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.create_ip_set.async_create_ip_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.create_ip_set_request.CreateIPSetRequest = {}  # type: ignore[typeddict-item]
        input_["name"] = name
        input_["change_token"] = change_token
    ...
    async def create_rate_based_rule(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
        tags: Optional["capo_waf_regional.types.tag_list.TagList"] = None,
    ) -> "capo_waf_regional.types.create_rate_based_rule_response.CreateRateBasedRuleResponse":
        ...
        Raises:
            capo_waf_regional.errors.waf_bad_request_exception.WAFBadRequestException: <p></p>
            capo_waf_regional.errors.waf_disallowed_name_exception.WAFDisallowedNameException: <p>The name specified is invalid.</p>
            capo_waf_regional.errors.waf_internal_error_exception.WAFInternalErrorException: <p>The operation failed because of a system problem, even though the request was valid. Retry your request.</p>
            capo_waf_regional.errors.waf_invalid_parameter_exception.WAFInvalidParameterException: <p>The operation failed because AWS WAF didn't recognize a parameter in the request. For example:</p> <ul> <li> <p>You specified an invalid parameter name.</p> </li> <li> <p>You specified an invalid value.</p> </li> <li> <p>You tried to update an object (<code>ByteMatchSet</code>, <code>IPSet</code>, <code>Rule</code>, or <code>WebACL</code>) using an action other than <code>INSERT</code> or <code>DELETE</code>.</p> </li> <li> <p>You tried to create a <code>WebACL</code> with a <code>DefaultAction</code> <code>Type</code> other than <code>ALLOW</code>, <code>BLOCK</code>, or <code>COUNT</code>.</p> </li> <li> <p>You tried to create a <code>RateBasedRule</code> with a <code>RateKey</code> value other than <code>IP</code>.</p> </li> <li> <p>You tried to update a <code>WebACL</code> with a <code>WafAction</code> <code>Type</code> other than <code>ALLOW</code>, <code>BLOCK</code>, or <code>COUNT</code>.</p> </li> <li> <p>You tried to update a <code>ByteMatchSet</code> with a <code>FieldToMatch</code> <code>Type</code> other than HEADER, METHOD, QUERY_STRING, URI, or BODY.</p> </li> <li> <p>You tried to update a <code>ByteMatchSet</code> with a <code>Field</code> of <code>HEADER</code> but no value for <code>Data</code>.</p> </li> <li> <p>Your request references an ARN that is malformed, or corresponds to a resource with which a web ACL cannot be associated.</p> </li> </ul>
            capo_waf_regional.errors.waf_limits_exceeded_exception.WAFLimitsExceededException: <p>The operation exceeds a resource limit, for example, the maximum number of <code>WebACL</code> objects that you can create for an AWS account. For more information, see <a href=\"https://docs.aws.amazon.com/waf/latest/developerguide/limits.html\">Limits</a> in the <i>AWS WAF Developer Guide</i>.</p>
            capo_waf_regional.errors.waf_stale_data_exception.WAFStaleDataException: <p>The operation failed because you tried to create, update, or delete an object by using a change token that has already been used.</p>
            capo_waf_regional.errors.waf_tag_operation_exception.WAFTagOperationException: <p></p>
            capo_waf_regional.errors.waf_tag_operation_internal_error_exception.WAFTagOperationInternalErrorException: <p></p>
            capo_waf_regional.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.create_rate_based_rule_request.CreateRateBasedRuleRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.create_rate_based_rule_response.CreateRateBasedRuleResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.create_rate_based_rule

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.create_rate_based_rule.async_create_rate_based_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.create_rate_based_rule_request.CreateRateBasedRuleRequest = {}  # type: ignore[typeddict-item]
        input_["name"] = name
    ...
    async def create_regex_match_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.create_regex_match_set_response.CreateRegexMatchSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.create_regex_match_set_request.CreateRegexMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.create_regex_match_set_response.CreateRegexMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.create_regex_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.create_regex_match_set.async_create_regex_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.create_regex_match_set_request.CreateRegexMatchSetRequest = {}  # type: ignore[typeddict-item]
        input_["name"] = name
        input_["change_token"] = change_token
    ...
    async def create_regex_pattern_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.create_regex_pattern_set_response.CreateRegexPatternSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.create_regex_pattern_set_request.CreateRegexPatternSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.create_regex_pattern_set_response.CreateRegexPatternSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.create_regex_pattern_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.create_regex_pattern_set.async_create_regex_pattern_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.create_regex_pattern_set_request.CreateRegexPatternSetRequest = {}  # type: ignore[typeddict-item]
        input_["name"] = name
        input_["change_token"] = change_token
    ...
    async def create_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.create_rule_request.CreateRuleRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.create_rule_response.CreateRuleResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.create_rule

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.create_rule.async_create_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.create_rule_request.CreateRuleRequest = {}  # type: ignore[typeddict-item]
        input_["name"] = name
        input_["metric_name"] = metric_name
        input_["change_token"] = change_token
        if tags is not None:
    ...
    async def create_rule_group(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
        tags: Optional["capo_waf_regional.types.tag_list.TagList"] = None,
    ) -> "capo_waf_regional.types.create_rule_group_response.CreateRuleGroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.create_rule_group_request.CreateRuleGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.create_rule_group_response.CreateRuleGroupResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.create_rule_group

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.create_rule_group.async_create_rule_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.create_rule_group_request.CreateRuleGroupRequest = {}  # type: ignore[typeddict-item]
        input_["name"] = name
        input_["metric_name"] = metric_name
        input_["change_token"] = change_token
        if tags is not None:
    ...
    async def create_size_constraint_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.create_size_constraint_set_response.CreateSizeConstraintSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.create_size_constraint_set_request.CreateSizeConstraintSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.create_size_constraint_set_response.CreateSizeConstraintSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.create_size_constraint_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.create_size_constraint_set.async_create_size_constraint_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.create_size_constraint_set_request.CreateSizeConstraintSetRequest = {}  # type: ignore[typeddict-item]
        input_["name"] = name
        input_["change_token"] = change_token
    ...
    async def create_sql_injection_match_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.create_sql_injection_match_set_response.CreateSqlInjectionMatchSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.create_sql_injection_match_set_request.CreateSqlInjectionMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.create_sql_injection_match_set_response.CreateSqlInjectionMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.create_sql_injection_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.create_sql_injection_match_set.async_create_sql_injection_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.create_sql_injection_match_set_request.CreateSqlInjectionMatchSetRequest = {}  # type: ignore[typeddict-item]
        input_["name"] = name
        input_["change_token"] = change_token
    ...
    async def create_web_acl(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
        tags: Optional["capo_waf_regional.types.tag_list.TagList"] = None,
    ) -> "capo_waf_regional.types.create_web_acl_response.CreateWebACLResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.create_web_acl_request.CreateWebACLRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.create_web_acl_response.CreateWebACLResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.create_web_acl

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.create_web_acl.async_create_web_acl(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.create_web_acl_request.CreateWebACLRequest = {}  # type: ignore[typeddict-item]
        input_["name"] = name
        input_["metric_name"] = metric_name
    ...
    async def create_web_acl_migration_stack(
        self,
        web_acl_id: "capo_waf_regional.types.resource_id.ResourceId",
        s3_bucket_name: "capo_waf_regional.types.s3_bucket_name.S3BucketName",
        ignore_unsupported_type: "capo_waf_regional.types.ignore_unsupported_type.IgnoreUnsupportedType",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.create_web_acl_migration_stack_response.CreateWebACLMigrationStackResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.create_web_acl_migration_stack_request.CreateWebACLMigrationStackRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.create_web_acl_migration_stack_response.CreateWebACLMigrationStackResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.create_web_acl_migration_stack

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.create_web_acl_migration_stack.async_create_web_acl_migration_stack(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.create_web_acl_migration_stack_request.CreateWebACLMigrationStackRequest = {}  # type: ignore[typeddict-item]
        input_["web_acl_id"] = web_acl_id
    ...
    async def create_xss_match_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.create_xss_match_set_response.CreateXssMatchSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.create_xss_match_set_request.CreateXssMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.create_xss_match_set_response.CreateXssMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.create_xss_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.create_xss_match_set.async_create_xss_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.create_xss_match_set_request.CreateXssMatchSetRequest = {}  # type: ignore[typeddict-item]
        input_["name"] = name
        input_["change_token"] = change_token
    ...
    async def delete_byte_match_set(
        self,
        byte_match_set_id: "capo_waf_regional.types.resource_id.ResourceId",
        change_token: "capo_waf_regional.types.change_token.ChangeToken",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.delete_byte_match_set_response.DeleteByteMatchSetResponse":
        ...
        Raises:
            capo_waf_regional.errors.waf_internal_error_exception.WAFInternalErrorException: <p>The operation failed because of a system problem, even though the request was valid. Retry your request.</p>
            capo_waf_regional.errors.waf_invalid_account_exception.WAFInvalidAccountException: <p>The operation failed because you tried to create, update, or delete an object by using an invalid account identifier.</p>
            capo_waf_regional.errors.waf_non_empty_entity_exception.WAFNonEmptyEntityException: <p>The operation failed because you tried to delete an object that isn't empty. For example:</p> <ul> <li> <p>You tried to delete a <code>WebACL</code> that still contains one or more <code>Rule</code> objects.</p> </li> <li> <p>You tried to delete a <code>Rule</code> that still contains one or more <code>ByteMatchSet</code> objects or other predicates.</p> </li> <li> <p>You tried to delete a <code>ByteMatchSet</code> that contains one or more <code>ByteMatchTuple</code> objects.</p> </li> <li> <p>You tried to delete an <code>IPSet</code> that references one or more IP addresses.</p> </li> </ul>
            capo_waf_regional.errors.waf_nonexistent_item_exception.WAFNonexistentItemException: <p>The operation failed because the referenced object doesn't exist.</p>
            capo_waf_regional.errors.waf_referenced_item_exception.WAFReferencedItemException: <p>The operation failed because you tried to delete an object that is still in use. For example:</p> <ul> <li> <p>You tried to delete a <code>ByteMatchSet</code> that is still referenced by a <code>Rule</code>.</p> </li> <li> <p>You tried to delete a <code>Rule</code> that is still referenced by a <code>WebACL</code>.</p> </li> </ul>
            capo_waf_regional.errors.waf_stale_data_exception.WAFStaleDataException: <p>The operation failed because you tried to create, update, or delete an object by using a change token that has already been used.</p>
            capo_waf_regional.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.delete_byte_match_set_request.DeleteByteMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.delete_byte_match_set_response.DeleteByteMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.delete_byte_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.delete_byte_match_set.async_delete_byte_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.delete_byte_match_set_request.DeleteByteMatchSetRequest = {}  # type: ignore[typeddict-item]
    ...
    async def delete_geo_match_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.delete_geo_match_set_response.DeleteGeoMatchSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.delete_geo_match_set_request.DeleteGeoMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.delete_geo_match_set_response.DeleteGeoMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.delete_geo_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.delete_geo_match_set.async_delete_geo_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.delete_geo_match_set_request.DeleteGeoMatchSetRequest = {}  # type: ignore[typeddict-item]
    ...
    async def delete_ip_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.delete_ip_set_response.DeleteIPSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.delete_ip_set_request.DeleteIPSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.delete_ip_set_response.DeleteIPSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.delete_ip_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.delete_ip_set.async_delete_ip_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.delete_ip_set_request.DeleteIPSetRequest = {}  # type: ignore[typeddict-item]
    ...
    async def delete_logging_configuration(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.delete_logging_configuration_response.DeleteLoggingConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.delete_logging_configuration_request.DeleteLoggingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.delete_logging_configuration_response.DeleteLoggingConfigurationResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.delete_logging_configuration

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.delete_logging_configuration.async_delete_logging_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.delete_logging_configuration_request.DeleteLoggingConfigurationRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
    ...
    async def delete_permission_policy(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.delete_permission_policy_response.DeletePermissionPolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.delete_permission_policy_request.DeletePermissionPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.delete_permission_policy_response.DeletePermissionPolicyResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.delete_permission_policy

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.delete_permission_policy.async_delete_permission_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.delete_permission_policy_request.DeletePermissionPolicyRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
    ...
    async def delete_rate_based_rule(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.delete_rate_based_rule_response.DeleteRateBasedRuleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.delete_rate_based_rule_request.DeleteRateBasedRuleRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.delete_rate_based_rule_response.DeleteRateBasedRuleResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.delete_rate_based_rule

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.delete_rate_based_rule.async_delete_rate_based_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.delete_rate_based_rule_request.DeleteRateBasedRuleRequest = {}  # type: ignore[typeddict-item]
    ...
    async def delete_regex_match_set(
        self,
        regex_match_set_id: "capo_waf_regional.types.resource_id.ResourceId",
        change_token: "capo_waf_regional.types.change_token.ChangeToken",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.delete_regex_match_set_response.DeleteRegexMatchSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.delete_regex_match_set_request.DeleteRegexMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.delete_regex_match_set_response.DeleteRegexMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.delete_regex_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.delete_regex_match_set.async_delete_regex_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.delete_regex_match_set_request.DeleteRegexMatchSetRequest = {}  # type: ignore[typeddict-item]
    ...
    async def delete_regex_pattern_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.delete_regex_pattern_set_response.DeleteRegexPatternSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.delete_regex_pattern_set_request.DeleteRegexPatternSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.delete_regex_pattern_set_response.DeleteRegexPatternSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.delete_regex_pattern_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.delete_regex_pattern_set.async_delete_regex_pattern_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.delete_regex_pattern_set_request.DeleteRegexPatternSetRequest = {}  # type: ignore[typeddict-item]
    ...
    async def delete_rule(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.delete_rule_response.DeleteRuleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.delete_rule_request.DeleteRuleRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.delete_rule_response.DeleteRuleResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.delete_rule

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.delete_rule.async_delete_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.delete_rule_request.DeleteRuleRequest = {}  # type: ignore[typeddict-item]
        input_["rule_id"] = rule_id
        input_["change_token"] = change_token
    ...
    async def delete_rule_group(
        self,
        rule_group_id: "capo_waf_regional.types.resource_id.ResourceId",
        change_token: "capo_waf_regional.types.change_token.ChangeToken",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.delete_rule_group_response.DeleteRuleGroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.delete_rule_group_request.DeleteRuleGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.delete_rule_group_response.DeleteRuleGroupResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.delete_rule_group

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.delete_rule_group.async_delete_rule_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.delete_rule_group_request.DeleteRuleGroupRequest = {}  # type: ignore[typeddict-item]
    ...
    async def delete_size_constraint_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.delete_size_constraint_set_response.DeleteSizeConstraintSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.delete_size_constraint_set_request.DeleteSizeConstraintSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.delete_size_constraint_set_response.DeleteSizeConstraintSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.delete_size_constraint_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.delete_size_constraint_set.async_delete_size_constraint_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.delete_size_constraint_set_request.DeleteSizeConstraintSetRequest = {}  # type: ignore[typeddict-item]
    ...
    async def delete_sql_injection_match_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.delete_sql_injection_match_set_response.DeleteSqlInjectionMatchSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.delete_sql_injection_match_set_request.DeleteSqlInjectionMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.delete_sql_injection_match_set_response.DeleteSqlInjectionMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.delete_sql_injection_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.delete_sql_injection_match_set.async_delete_sql_injection_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.delete_sql_injection_match_set_request.DeleteSqlInjectionMatchSetRequest = {}  # type: ignore[typeddict-item]
    ...
    async def delete_web_acl(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.delete_web_acl_response.DeleteWebACLResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.delete_web_acl_request.DeleteWebACLRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.delete_web_acl_response.DeleteWebACLResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.delete_web_acl

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.delete_web_acl.async_delete_web_acl(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.delete_web_acl_request.DeleteWebACLRequest = {}  # type: ignore[typeddict-item]
        input_["web_acl_id"] = web_acl_id
        input_["change_token"] = change_token
    ...
    async def delete_xss_match_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.delete_xss_match_set_response.DeleteXssMatchSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.delete_xss_match_set_request.DeleteXssMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.delete_xss_match_set_response.DeleteXssMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.delete_xss_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.delete_xss_match_set.async_delete_xss_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.delete_xss_match_set_request.DeleteXssMatchSetRequest = {}  # type: ignore[typeddict-item]
    ...
    async def disassociate_web_acl(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.disassociate_web_acl_response.DisassociateWebACLResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.disassociate_web_acl_request.DisassociateWebACLRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.disassociate_web_acl_response.DisassociateWebACLResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.disassociate_web_acl

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.disassociate_web_acl.async_disassociate_web_acl(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.disassociate_web_acl_request.DisassociateWebACLRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
    ...
    async def get_byte_match_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.get_byte_match_set_response.GetByteMatchSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_byte_match_set_request.GetByteMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_byte_match_set_response.GetByteMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_byte_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_byte_match_set.async_get_byte_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_byte_match_set_request.GetByteMatchSetRequest = {}  # type: ignore[typeddict-item]
        input_["byte_match_set_id"] = byte_match_set_id
    ...
    async def get_change_token(
        self, *, config_overrides: Optional[AsyncWAFRegionalClientConfig] = None
    ) -> "capo_waf_regional.types.get_change_token_response.GetChangeTokenResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_change_token_request.GetChangeTokenRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_change_token_response.GetChangeTokenResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_change_token

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_change_token.async_get_change_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_change_token_request.GetChangeTokenRequest = {}  # type: ignore[typeddict-item]
    ...
    async def get_change_token_status(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.get_change_token_status_response.GetChangeTokenStatusResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_change_token_status_request.GetChangeTokenStatusRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_change_token_status_response.GetChangeTokenStatusResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_change_token_status

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_change_token_status.async_get_change_token_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_change_token_status_request.GetChangeTokenStatusRequest = {}  # type: ignore[typeddict-item]
        input_["change_token"] = change_token
    ...
    async def get_geo_match_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.get_geo_match_set_response.GetGeoMatchSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_geo_match_set_request.GetGeoMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_geo_match_set_response.GetGeoMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_geo_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_geo_match_set.async_get_geo_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_geo_match_set_request.GetGeoMatchSetRequest = {}  # type: ignore[typeddict-item]
        input_["geo_match_set_id"] = geo_match_set_id
    ...
    async def get_ip_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.get_ip_set_response.GetIPSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_ip_set_request.GetIPSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_ip_set_response.GetIPSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_ip_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_ip_set.async_get_ip_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_ip_set_request.GetIPSetRequest = {}  # type: ignore[typeddict-item]
        input_["ip_set_id"] = ip_set_id
    ...
    async def get_logging_configuration(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.get_logging_configuration_response.GetLoggingConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_logging_configuration_request.GetLoggingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_logging_configuration_response.GetLoggingConfigurationResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_logging_configuration

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_logging_configuration.async_get_logging_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_logging_configuration_request.GetLoggingConfigurationRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
    ...
    async def get_permission_policy(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.get_permission_policy_response.GetPermissionPolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_permission_policy_request.GetPermissionPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_permission_policy_response.GetPermissionPolicyResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_permission_policy

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_permission_policy.async_get_permission_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_permission_policy_request.GetPermissionPolicyRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
    ...
    async def get_rate_based_rule(
        ...
        *,
        ...
        "capo_waf_regional.types.get_rate_based_rule_response.GetRateBasedRuleResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_rate_based_rule_request.GetRateBasedRuleRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_rate_based_rule_response.GetRateBasedRuleResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_rate_based_rule

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_rate_based_rule.async_get_rate_based_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_rate_based_rule_request.GetRateBasedRuleRequest = {}  # type: ignore[typeddict-item]
        input_["rule_id"] = rule_id
    ...
    async def get_rate_based_rule_managed_keys(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
        next_marker: Optional["capo_waf_regional.types.next_marker.NextMarker"] = None,
    ) -> "capo_waf_regional.types.get_rate_based_rule_managed_keys_response.GetRateBasedRuleManagedKeysResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_rate_based_rule_managed_keys_request.GetRateBasedRuleManagedKeysRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_rate_based_rule_managed_keys_response.GetRateBasedRuleManagedKeysResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_rate_based_rule_managed_keys

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_rate_based_rule_managed_keys.async_get_rate_based_rule_managed_keys(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_rate_based_rule_managed_keys_request.GetRateBasedRuleManagedKeysRequest = {}  # type: ignore[typeddict-item]
        input_["rule_id"] = rule_id
    ...
    async def get_regex_match_set(
        ...
        *,
        ...
        "capo_waf_regional.types.get_regex_match_set_response.GetRegexMatchSetResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_regex_match_set_request.GetRegexMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_regex_match_set_response.GetRegexMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_regex_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_regex_match_set.async_get_regex_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_regex_match_set_request.GetRegexMatchSetRequest = {}  # type: ignore[typeddict-item]
        input_["regex_match_set_id"] = regex_match_set_id
    ...
    async def get_regex_pattern_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_regex_pattern_set_request.GetRegexPatternSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_regex_pattern_set_response.GetRegexPatternSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_regex_pattern_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_regex_pattern_set.async_get_regex_pattern_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_regex_pattern_set_request.GetRegexPatternSetRequest = {}  # type: ignore[typeddict-item]
        input_["regex_pattern_set_id"] = regex_pattern_set_id
    ...
    async def get_rule(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.get_rule_response.GetRuleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_rule_request.GetRuleRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_rule_response.GetRuleResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_rule

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_rule.async_get_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_rule_request.GetRuleRequest = {}  # type: ignore[typeddict-item]
        input_["rule_id"] = rule_id
    ...
    async def get_rule_group(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.get_rule_group_response.GetRuleGroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_rule_group_request.GetRuleGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_rule_group_response.GetRuleGroupResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_rule_group

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_rule_group.async_get_rule_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_rule_group_request.GetRuleGroupRequest = {}  # type: ignore[typeddict-item]
        input_["rule_group_id"] = rule_group_id
    ...
    async def get_sampled_requests(
        ...
        web_acl_id: "capo_waf_regional.types.resource_id.ResourceId",
        rule_id: "capo_waf_regional.types.resource_id.ResourceId",
        time_window: "capo_waf_regional.types.time_window.TimeWindow",
        max_items: "capo_waf_regional.types.get_sampled_requests_max_items.GetSampledRequestsMaxItems",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.get_sampled_requests_response.GetSampledRequestsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_sampled_requests_request.GetSampledRequestsRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_sampled_requests_response.GetSampledRequestsResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_sampled_requests

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_sampled_requests.async_get_sampled_requests(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_sampled_requests_request.GetSampledRequestsRequest = {}  # type: ignore[typeddict-item]
        input_["web_acl_id"] = web_acl_id
        input_["rule_id"] = rule_id
    ...
    async def get_size_constraint_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.get_size_constraint_set_response.GetSizeConstraintSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_size_constraint_set_request.GetSizeConstraintSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_size_constraint_set_response.GetSizeConstraintSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_size_constraint_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_size_constraint_set.async_get_size_constraint_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_size_constraint_set_request.GetSizeConstraintSetRequest = {}  # type: ignore[typeddict-item]
        input_["size_constraint_set_id"] = size_constraint_set_id
    ...
    async def get_sql_injection_match_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.get_sql_injection_match_set_response.GetSqlInjectionMatchSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_sql_injection_match_set_request.GetSqlInjectionMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_sql_injection_match_set_response.GetSqlInjectionMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_sql_injection_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_sql_injection_match_set.async_get_sql_injection_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_sql_injection_match_set_request.GetSqlInjectionMatchSetRequest = {}  # type: ignore[typeddict-item]
        input_["sql_injection_match_set_id"] = sql_injection_match_set_id
    ...
    async def get_web_acl(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.get_web_acl_response.GetWebACLResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_web_acl_request.GetWebACLRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_web_acl_response.GetWebACLResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_web_acl

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_web_acl.async_get_web_acl(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_web_acl_request.GetWebACLRequest = {}  # type: ignore[typeddict-item]
        input_["web_acl_id"] = web_acl_id
    ...
    async def get_web_acl_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_web_acl_for_resource_request.GetWebACLForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_web_acl_for_resource_response.GetWebACLForResourceResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_web_acl_for_resource

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_web_acl_for_resource.async_get_web_acl_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_web_acl_for_resource_request.GetWebACLForResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
    ...
    async def get_xss_match_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.get_xss_match_set_response.GetXssMatchSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.get_xss_match_set_request.GetXssMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.get_xss_match_set_response.GetXssMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.get_xss_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.get_xss_match_set.async_get_xss_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.get_xss_match_set_request.GetXssMatchSetRequest = {}  # type: ignore[typeddict-item]
        input_["xss_match_set_id"] = xss_match_set_id
    ...
    async def list_activated_rules_in_rule_group(
        ...
        *,
        ...
        rule_group_id: Optional[
            "capo_waf_regional.types.resource_id.ResourceId"
        ] = None,
        next_marker: Optional["capo_waf_regional.types.next_marker.NextMarker"] = None,
        limit: Optional[
            "capo_waf_regional.types.pagination_limit.PaginationLimit"
        ] = None,
    ) -> "capo_waf_regional.types.list_activated_rules_in_rule_group_response.ListActivatedRulesInRuleGroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_activated_rules_in_rule_group_request.ListActivatedRulesInRuleGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_activated_rules_in_rule_group_response.ListActivatedRulesInRuleGroupResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_activated_rules_in_rule_group

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_activated_rules_in_rule_group.async_list_activated_rules_in_rule_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_activated_rules_in_rule_group_request.ListActivatedRulesInRuleGroupRequest = {}  # type: ignore[typeddict-item]
    ...
    async def list_byte_match_sets(
        ...
        *,
    ...
    ) -> "capo_waf_regional.types.list_byte_match_sets_response.ListByteMatchSetsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_byte_match_sets_request.ListByteMatchSetsRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_byte_match_sets_response.ListByteMatchSetsResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_byte_match_sets

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_byte_match_sets.async_list_byte_match_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_byte_match_sets_request.ListByteMatchSetsRequest = {}  # type: ignore[typeddict-item]
        if next_marker is not None:
            input_["next_marker"] = next_marker
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_geo_match_sets(
        ...
        *,
        ...
        "capo_waf_regional.types.list_geo_match_sets_response.ListGeoMatchSetsResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_geo_match_sets_request.ListGeoMatchSetsRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_geo_match_sets_response.ListGeoMatchSetsResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_geo_match_sets

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_geo_match_sets.async_list_geo_match_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_geo_match_sets_request.ListGeoMatchSetsRequest = {}  # type: ignore[typeddict-item]
        if next_marker is not None:
            input_["next_marker"] = next_marker
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_ip_sets(
        ...
        *,
    ...
    ) -> "capo_waf_regional.types.list_ip_sets_response.ListIPSetsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_ip_sets_request.ListIPSetsRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_ip_sets_response.ListIPSetsResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_ip_sets

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_ip_sets.async_list_ip_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_ip_sets_request.ListIPSetsRequest = {}  # type: ignore[typeddict-item]
        if next_marker is not None:
            input_["next_marker"] = next_marker
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_logging_configurations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_logging_configurations_request.ListLoggingConfigurationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_logging_configurations_response.ListLoggingConfigurationsResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_logging_configurations

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_logging_configurations.async_list_logging_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_logging_configurations_request.ListLoggingConfigurationsRequest = {}  # type: ignore[typeddict-item]
        if next_marker is not None:
            input_["next_marker"] = next_marker
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_rate_based_rules(
        ...
        *,
    ...
    ) -> "capo_waf_regional.types.list_rate_based_rules_response.ListRateBasedRulesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_rate_based_rules_request.ListRateBasedRulesRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_rate_based_rules_response.ListRateBasedRulesResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_rate_based_rules

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_rate_based_rules.async_list_rate_based_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_rate_based_rules_request.ListRateBasedRulesRequest = {}  # type: ignore[typeddict-item]
        if next_marker is not None:
            input_["next_marker"] = next_marker
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_regex_match_sets(
        ...
        *,
    ...
    ) -> "capo_waf_regional.types.list_regex_match_sets_response.ListRegexMatchSetsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_regex_match_sets_request.ListRegexMatchSetsRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_regex_match_sets_response.ListRegexMatchSetsResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_regex_match_sets

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_regex_match_sets.async_list_regex_match_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_regex_match_sets_request.ListRegexMatchSetsRequest = {}  # type: ignore[typeddict-item]
        if next_marker is not None:
            input_["next_marker"] = next_marker
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_regex_pattern_sets(
        ...
        *,
    ...
    ) -> "capo_waf_regional.types.list_regex_pattern_sets_response.ListRegexPatternSetsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_regex_pattern_sets_request.ListRegexPatternSetsRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_regex_pattern_sets_response.ListRegexPatternSetsResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_regex_pattern_sets

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_regex_pattern_sets.async_list_regex_pattern_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_regex_pattern_sets_request.ListRegexPatternSetsRequest = {}  # type: ignore[typeddict-item]
        if next_marker is not None:
            input_["next_marker"] = next_marker
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_resources_for_web_acl(
        ...
        *,
        ...
        resource_type: Optional[
            "capo_waf_regional.types.resource_type.ResourceType"
        ] = None,
    ) -> "capo_waf_regional.types.list_resources_for_web_acl_response.ListResourcesForWebACLResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_resources_for_web_acl_request.ListResourcesForWebACLRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_resources_for_web_acl_response.ListResourcesForWebACLResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_resources_for_web_acl

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_resources_for_web_acl.async_list_resources_for_web_acl(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_resources_for_web_acl_request.ListResourcesForWebACLRequest = {}  # type: ignore[typeddict-item]
        input_["web_acl_id"] = web_acl_id
    ...
    async def list_rule_groups(
        ...
        *,
    ...
    ) -> "capo_waf_regional.types.list_rule_groups_response.ListRuleGroupsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_rule_groups_request.ListRuleGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_rule_groups_response.ListRuleGroupsResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_rule_groups

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_rule_groups.async_list_rule_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_rule_groups_request.ListRuleGroupsRequest = {}  # type: ignore[typeddict-item]
        if next_marker is not None:
            input_["next_marker"] = next_marker
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_rules(
        ...
        *,
    ...
    ) -> "capo_waf_regional.types.list_rules_response.ListRulesResponse":
        r"""<note> <p>This is <b>AWS WAF Classic</b> documentation. For more information, see <a href=\"https://docs.aws.amazon.com/waf/latest/developerguide/classic-waf-chapter.html\">AWS WAF Classic</a> in the developer guide.</p> <p> <b>For the latest version of AWS WAF</b>, use the AWS WAFV2 API and see the <a href=\"https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html\">AWS WAF Developer Guide</a>. With the latest version, AWS WAF has a single set of endpoints for regional and global use. </p> </note> <p>Returns an array of <a>RuleSummary</a> objects.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_rules_request.ListRulesRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_rules_response.ListRulesResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_rules

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_rules.async_list_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_rules_request.ListRulesRequest = {}  # type: ignore[typeddict-item]
        if next_marker is not None:
            input_["next_marker"] = next_marker
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_size_constraint_sets(
        ...
        *,
    ...
    ) -> "capo_waf_regional.types.list_size_constraint_sets_response.ListSizeConstraintSetsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_size_constraint_sets_request.ListSizeConstraintSetsRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_size_constraint_sets_response.ListSizeConstraintSetsResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_size_constraint_sets

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_size_constraint_sets.async_list_size_constraint_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_size_constraint_sets_request.ListSizeConstraintSetsRequest = {}  # type: ignore[typeddict-item]
        if next_marker is not None:
            input_["next_marker"] = next_marker
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_sql_injection_match_sets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_sql_injection_match_sets_request.ListSqlInjectionMatchSetsRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_sql_injection_match_sets_response.ListSqlInjectionMatchSetsResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_sql_injection_match_sets

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_sql_injection_match_sets.async_list_sql_injection_match_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_sql_injection_match_sets_request.ListSqlInjectionMatchSetsRequest = {}  # type: ignore[typeddict-item]
        if next_marker is not None:
            input_["next_marker"] = next_marker
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_subscribed_rule_groups(
        ...
        *,
    ...
    ) -> "capo_waf_regional.types.list_subscribed_rule_groups_response.ListSubscribedRuleGroupsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_subscribed_rule_groups_request.ListSubscribedRuleGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_subscribed_rule_groups_response.ListSubscribedRuleGroupsResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_subscribed_rule_groups

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_subscribed_rule_groups.async_list_subscribed_rule_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_subscribed_rule_groups_request.ListSubscribedRuleGroupsRequest = {}  # type: ignore[typeddict-item]
        if next_marker is not None:
            input_["next_marker"] = next_marker
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_tags_for_resource(
        ...
        *,
    ...
    ) -> "capo_waf_regional.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_tags_for_resource

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_tags_for_resource_request.ListTagsForResourceRequest = {}  # type: ignore[typeddict-item]
        if next_marker is not None:
            input_["next_marker"] = next_marker
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_web_ac_ls(
        ...
        *,
    ...
    ) -> "capo_waf_regional.types.list_web_ac_ls_response.ListWebACLsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_web_ac_ls_request.ListWebACLsRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_web_ac_ls_response.ListWebACLsResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_web_ac_ls

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_web_ac_ls.async_list_web_ac_ls(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_web_ac_ls_request.ListWebACLsRequest = {}  # type: ignore[typeddict-item]
        if next_marker is not None:
            input_["next_marker"] = next_marker
        if limit is not None:
            input_["limit"] = limit
    ...
    async def list_xss_match_sets(
        ...
        *,
        ...
        "capo_waf_regional.types.list_xss_match_sets_response.ListXssMatchSetsResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.list_xss_match_sets_request.ListXssMatchSetsRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.list_xss_match_sets_response.ListXssMatchSetsResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.list_xss_match_sets

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.list_xss_match_sets.async_list_xss_match_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.list_xss_match_sets_request.ListXssMatchSetsRequest = {}  # type: ignore[typeddict-item]
        if next_marker is not None:
            input_["next_marker"] = next_marker
        if limit is not None:
            input_["limit"] = limit
    ...
    async def put_logging_configuration(
        self,
        logging_configuration: "capo_waf_regional.types.logging_configuration.LoggingConfiguration",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.put_logging_configuration_response.PutLoggingConfigurationResponse":
        ...
        Raises:
            capo_waf_regional.errors.waf_internal_error_exception.WAFInternalErrorException: <p>The operation failed because of a system problem, even though the request was valid. Retry your request.</p>
            capo_waf_regional.errors.waf_nonexistent_item_exception.WAFNonexistentItemException: <p>The operation failed because the referenced object doesn't exist.</p>
            capo_waf_regional.errors.waf_service_linked_role_error_exception.WAFServiceLinkedRoleErrorException: <p>AWS WAF is not able to access the service linked role. This can be caused by a previous <code>PutLoggingConfiguration</code> request, which can lock the service linked role for about 20 seconds. Please try your request again. The service linked role can also be locked by a previous <code>DeleteServiceLinkedRole</code> request, which can lock the role for 15 minutes or more. If you recently made a <code>DeleteServiceLinkedRole</code>, wait at least 15 minutes and try the request again. If you receive this same exception again, you will have to wait additional time until the role is unlocked.</p>
            capo_waf_regional.errors.waf_stale_data_exception.WAFStaleDataException: <p>The operation failed because you tried to create, update, or delete an object by using a change token that has already been used.</p>
            capo_waf_regional.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.put_logging_configuration_request.PutLoggingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.put_logging_configuration_response.PutLoggingConfigurationResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.put_logging_configuration

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.put_logging_configuration.async_put_logging_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.put_logging_configuration_request.PutLoggingConfigurationRequest = {}  # type: ignore[typeddict-item]
    ...
    async def put_permission_policy(
        self,
        resource_arn: "capo_waf_regional.types.resource_arn.ResourceArn",
        policy: "capo_waf_regional.types.policy_string.PolicyString",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.put_permission_policy_response.PutPermissionPolicyResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.put_permission_policy_request.PutPermissionPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.put_permission_policy_response.PutPermissionPolicyResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.put_permission_policy

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.put_permission_policy.async_put_permission_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.put_permission_policy_request.PutPermissionPolicyRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
    ...
    async def tag_resource(
        self,
        resource_arn: "capo_waf_regional.types.resource_arn.ResourceArn",
        tags: "capo_waf_regional.types.tag_list.TagList",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.tag_resource_response.TagResourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.tag_resource_response.TagResourceResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.tag_resource

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.tag_resource_request.TagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
        input_["tags"] = tags
    ...
    async def untag_resource(
        self,
        resource_arn: "capo_waf_regional.types.resource_arn.ResourceArn",
        tag_keys: "capo_waf_regional.types.tag_key_list.TagKeyList",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.untag_resource_response.UntagResourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.untag_resource_response.UntagResourceResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.untag_resource

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.untag_resource_request.UntagResourceRequest = {}  # type: ignore[typeddict-item]
        input_["resource_arn"] = resource_arn
    ...
    async def update_byte_match_set(
        ...
        byte_match_set_id: "capo_waf_regional.types.resource_id.ResourceId",
        change_token: "capo_waf_regional.types.change_token.ChangeToken",
        updates: "capo_waf_regional.types.byte_match_set_updates.ByteMatchSetUpdates",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.update_byte_match_set_response.UpdateByteMatchSetResponse":
        ...
        Raises:
            ...
            capo_waf_regional.errors.waf_invalid_parameter_exception.WAFInvalidParameterException: <p>The operation failed because AWS WAF didn't recognize a parameter in the request. For example:</p> <ul> <li> <p>You specified an invalid parameter name.</p> </li> <li> <p>You specified an invalid value.</p> </li> <li> <p>You tried to update an object (<code>ByteMatchSet</code>, <code>IPSet</code>, <code>Rule</code>, or <code>WebACL</code>) using an action other than <code>INSERT</code> or <code>DELETE</code>.</p> </li> <li> <p>You tried to create a <code>WebACL</code> with a <code>DefaultAction</code> <code>Type</code> other than <code>ALLOW</code>, <code>BLOCK</code>, or <code>COUNT</code>.</p> </li> <li> <p>You tried to create a <code>RateBasedRule</code> with a <code>RateKey</code> value other than <code>IP</code>.</p> </li> <li> <p>You tried to update a <code>WebACL</code> with a <code>WafAction</code> <code>Type</code> other than <code>ALLOW</code>, <code>BLOCK</code>, or <code>COUNT</code>.</p> </li> <li> <p>You tried to update a <code>ByteMatchSet</code> with a <code>FieldToMatch</code> <code>Type</code> other than HEADER, METHOD, QUERY_STRING, URI, or BODY.</p> </li> <li> <p>You tried to update a <code>ByteMatchSet</code> with a <code>Field</code> of <code>HEADER</code> but no value for <code>Data</code>.</p> </li> <li> <p>Your request references an ARN that is malformed, or corresponds to a resource with which a web ACL cannot be associated.</p> </li> </ul>
            capo_waf_regional.errors.waf_limits_exceeded_exception.WAFLimitsExceededException: <p>The operation exceeds a resource limit, for example, the maximum number of <code>WebACL</code> objects that you can create for an AWS account. For more information, see <a href=\"https://docs.aws.amazon.com/waf/latest/developerguide/limits.html\">Limits</a> in the <i>AWS WAF Developer Guide</i>.</p>
            capo_waf_regional.errors.waf_nonexistent_container_exception.WAFNonexistentContainerException: <p>The operation failed because you tried to add an object to or delete an object from another object that doesn't exist. For example:</p> <ul> <li> <p>You tried to add a <code>Rule</code> to or delete a <code>Rule</code> from a <code>WebACL</code> that doesn't exist.</p> </li> <li> <p>You tried to add a <code>ByteMatchSet</code> to or delete a <code>ByteMatchSet</code> from a <code>Rule</code> that doesn't exist.</p> </li> <li> <p>You tried to add an IP address to or delete an IP address from an <code>IPSet</code> that doesn't exist.</p> </li> <li> <p>You tried to add a <code>ByteMatchTuple</code> to or delete a <code>ByteMatchTuple</code> from a <code>ByteMatchSet</code> that doesn't exist.</p> </li> </ul>
            capo_waf_regional.errors.waf_nonexistent_item_exception.WAFNonexistentItemException: <p>The operation failed because the referenced object doesn't exist.</p>
            capo_waf_regional.errors.waf_stale_data_exception.WAFStaleDataException: <p>The operation failed because you tried to create, update, or delete an object by using a change token that has already been used.</p>
            capo_waf_regional.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.update_byte_match_set_request.UpdateByteMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.update_byte_match_set_response.UpdateByteMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.update_byte_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.update_byte_match_set.async_update_byte_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.update_byte_match_set_request.UpdateByteMatchSetRequest = {}  # type: ignore[typeddict-item]
        input_["byte_match_set_id"] = byte_match_set_id
        input_["change_token"] = change_token
    ...
    async def update_geo_match_set(
        ...
        geo_match_set_id: "capo_waf_regional.types.resource_id.ResourceId",
        change_token: "capo_waf_regional.types.change_token.ChangeToken",
        updates: "capo_waf_regional.types.geo_match_set_updates.GeoMatchSetUpdates",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.update_geo_match_set_response.UpdateGeoMatchSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.update_geo_match_set_request.UpdateGeoMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.update_geo_match_set_response.UpdateGeoMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.update_geo_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.update_geo_match_set.async_update_geo_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.update_geo_match_set_request.UpdateGeoMatchSetRequest = {}  # type: ignore[typeddict-item]
        input_["geo_match_set_id"] = geo_match_set_id
        input_["change_token"] = change_token
        input_["updates"] = updates
    ...
    async def update_ip_set(
        ...
        ip_set_id: "capo_waf_regional.types.resource_id.ResourceId",
        change_token: "capo_waf_regional.types.change_token.ChangeToken",
        updates: "capo_waf_regional.types.ip_set_updates.IPSetUpdates",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.update_ip_set_response.UpdateIPSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.update_ip_set_request.UpdateIPSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.update_ip_set_response.UpdateIPSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.update_ip_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.update_ip_set.async_update_ip_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.update_ip_set_request.UpdateIPSetRequest = {}  # type: ignore[typeddict-item]
        input_["ip_set_id"] = ip_set_id
        input_["change_token"] = change_token
        input_["updates"] = updates
    ...
    async def update_rate_based_rule(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.update_rate_based_rule_response.UpdateRateBasedRuleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.update_rate_based_rule_request.UpdateRateBasedRuleRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.update_rate_based_rule_response.UpdateRateBasedRuleResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.update_rate_based_rule

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.update_rate_based_rule.async_update_rate_based_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.update_rate_based_rule_request.UpdateRateBasedRuleRequest = {}  # type: ignore[typeddict-item]
        input_["rule_id"] = rule_id
        input_["change_token"] = change_token
        input_["updates"] = updates
        input_["rate_limit"] = rate_limit
    ...
    async def update_regex_match_set(
        self,
        regex_match_set_id: "capo_waf_regional.types.resource_id.ResourceId",
        updates: "capo_waf_regional.types.regex_match_set_updates.RegexMatchSetUpdates",
        change_token: "capo_waf_regional.types.change_token.ChangeToken",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.update_regex_match_set_request.UpdateRegexMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.update_regex_match_set_response.UpdateRegexMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.update_regex_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.update_regex_match_set.async_update_regex_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.update_regex_match_set_request.UpdateRegexMatchSetRequest = {}  # type: ignore[typeddict-item]
        input_["regex_match_set_id"] = regex_match_set_id
        input_["updates"] = updates
        input_["change_token"] = change_token
    ...
    async def update_regex_pattern_set(
        self,
        regex_pattern_set_id: "capo_waf_regional.types.resource_id.ResourceId",
        updates: "capo_waf_regional.types.regex_pattern_set_updates.RegexPatternSetUpdates",
        change_token: "capo_waf_regional.types.change_token.ChangeToken",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.update_regex_pattern_set_response.UpdateRegexPatternSetResponse":
        ...
        Raises:
            ...
            capo_waf_regional.errors.waf_invalid_account_exception.WAFInvalidAccountException: <p>The operation failed because you tried to create, update, or delete an object by using an invalid account identifier.</p>
            capo_waf_regional.errors.waf_invalid_operation_exception.WAFInvalidOperationException: <p>The operation failed because there was nothing to do. For example:</p> <ul> <li> <p>You tried to remove a <code>Rule</code> from a <code>WebACL</code>, but the <code>Rule</code> isn't in the specified <code>WebACL</code>.</p> </li> <li> <p>You tried to remove an IP address from an <code>IPSet</code>, but the IP address isn't in the specified <code>IPSet</code>.</p> </li> <li> <p>You tried to remove a <code>ByteMatchTuple</code> from a <code>ByteMatchSet</code>, but the <code>ByteMatchTuple</code> isn't in the specified <code>WebACL</code>.</p> </li> <li> <p>You tried to add a <code>Rule</code> to a <code>WebACL</code>, but the <code>Rule</code> already exists in the specified <code>WebACL</code>.</p> </li> <li> <p>You tried to add a <code>ByteMatchTuple</code> to a <code>ByteMatchSet</code>, but the <code>ByteMatchTuple</code> already exists in the specified <code>WebACL</code>.</p> </li> </ul>
            capo_waf_regional.errors.waf_invalid_regex_pattern_exception.WAFInvalidRegexPatternException: <p>The regular expression (regex) you specified in <code>RegexPatternString</code> is invalid.</p>
            capo_waf_regional.errors.waf_limits_exceeded_exception.WAFLimitsExceededException: <p>The operation exceeds a resource limit, for example, the maximum number of <code>WebACL</code> objects that you can create for an AWS account. For more information, see <a href=\"https://docs.aws.amazon.com/waf/latest/developerguide/limits.html\">Limits</a> in the <i>AWS WAF Developer Guide</i>.</p>
            capo_waf_regional.errors.waf_nonexistent_container_exception.WAFNonexistentContainerException: <p>The operation failed because you tried to add an object to or delete an object from another object that doesn't exist. For example:</p> <ul> <li> <p>You tried to add a <code>Rule</code> to or delete a <code>Rule</code> from a <code>WebACL</code> that doesn't exist.</p> </li> <li> <p>You tried to add a <code>ByteMatchSet</code> to or delete a <code>ByteMatchSet</code> from a <code>Rule</code> that doesn't exist.</p> </li> <li> <p>You tried to add an IP address to or delete an IP address from an <code>IPSet</code> that doesn't exist.</p> </li> <li> <p>You tried to add a <code>ByteMatchTuple</code> to or delete a <code>ByteMatchTuple</code> from a <code>ByteMatchSet</code> that doesn't exist.</p> </li> </ul>
            capo_waf_regional.errors.waf_nonexistent_item_exception.WAFNonexistentItemException: <p>The operation failed because the referenced object doesn't exist.</p>
            capo_waf_regional.errors.waf_stale_data_exception.WAFStaleDataException: <p>The operation failed because you tried to create, update, or delete an object by using a change token that has already been used.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.update_regex_pattern_set_request.UpdateRegexPatternSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.update_regex_pattern_set_response.UpdateRegexPatternSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.update_regex_pattern_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.update_regex_pattern_set.async_update_regex_pattern_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.update_regex_pattern_set_request.UpdateRegexPatternSetRequest = {}  # type: ignore[typeddict-item]
        input_["regex_pattern_set_id"] = regex_pattern_set_id
        input_["updates"] = updates
        input_["change_token"] = change_token
    ...
    async def update_rule(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.update_rule_response.UpdateRuleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.update_rule_request.UpdateRuleRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.update_rule_response.UpdateRuleResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.update_rule

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.update_rule.async_update_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.update_rule_request.UpdateRuleRequest = {}  # type: ignore[typeddict-item]
        input_["rule_id"] = rule_id
        input_["change_token"] = change_token
        input_["updates"] = updates
    ...
    async def update_rule_group(
        self,
        rule_group_id: "capo_waf_regional.types.resource_id.ResourceId",
        updates: "capo_waf_regional.types.rule_group_updates.RuleGroupUpdates",
        change_token: "capo_waf_regional.types.change_token.ChangeToken",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.update_rule_group_response.UpdateRuleGroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.update_rule_group_request.UpdateRuleGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.update_rule_group_response.UpdateRuleGroupResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.update_rule_group

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.update_rule_group.async_update_rule_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.update_rule_group_request.UpdateRuleGroupRequest = {}  # type: ignore[typeddict-item]
        input_["rule_group_id"] = rule_group_id
        input_["updates"] = updates
        input_["change_token"] = change_token
    ...
    async def update_size_constraint_set(
        ...
        size_constraint_set_id: "capo_waf_regional.types.resource_id.ResourceId",
        change_token: "capo_waf_regional.types.change_token.ChangeToken",
        updates: "capo_waf_regional.types.size_constraint_set_updates.SizeConstraintSetUpdates",
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.update_size_constraint_set_response.UpdateSizeConstraintSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.update_size_constraint_set_request.UpdateSizeConstraintSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.update_size_constraint_set_response.UpdateSizeConstraintSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.update_size_constraint_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.update_size_constraint_set.async_update_size_constraint_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.update_size_constraint_set_request.UpdateSizeConstraintSetRequest = {}  # type: ignore[typeddict-item]
        input_["size_constraint_set_id"] = size_constraint_set_id
        input_["change_token"] = change_token
        input_["updates"] = updates
    ...
    async def update_sql_injection_match_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.update_sql_injection_match_set_response.UpdateSqlInjectionMatchSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.update_sql_injection_match_set_request.UpdateSqlInjectionMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.update_sql_injection_match_set_response.UpdateSqlInjectionMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.update_sql_injection_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.update_sql_injection_match_set.async_update_sql_injection_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.update_sql_injection_match_set_request.UpdateSqlInjectionMatchSetRequest = {}  # type: ignore[typeddict-item]
        input_["sql_injection_match_set_id"] = sql_injection_match_set_id
        input_["change_token"] = change_token
        input_["updates"] = updates
    ...
    async def update_web_acl(
        ...
        *,
        ...
        default_action: Optional["capo_waf_regional.types.waf_action.WafAction"] = None,
    ) -> "capo_waf_regional.types.update_web_acl_response.UpdateWebACLResponse":
        ...
        Raises:
            ...
            capo_waf_regional.errors.waf_referenced_item_exception.WAFReferencedItemException: <p>The operation failed because you tried to delete an object that is still in use. For example:</p> <ul> <li> <p>You tried to delete a <code>ByteMatchSet</code> that is still referenced by a <code>Rule</code>.</p> </li> <li> <p>You tried to delete a <code>Rule</code> that is still referenced by a <code>WebACL</code>.</p> </li> </ul>
            capo_waf_regional.errors.waf_stale_data_exception.WAFStaleDataException: <p>The operation failed because you tried to create, update, or delete an object by using a change token that has already been used.</p>
            capo_waf_regional.errors.waf_subscription_not_found_exception.WAFSubscriptionNotFoundException: <p>The specified subscription does not exist.</p>
            capo_waf_regional.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.update_web_acl_request.UpdateWebACLRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.update_web_acl_response.UpdateWebACLResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.update_web_acl

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.update_web_acl.async_update_web_acl(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.update_web_acl_request.UpdateWebACLRequest = {}  # type: ignore[typeddict-item]
        input_["web_acl_id"] = web_acl_id
        input_["change_token"] = change_token
    ...
    async def update_xss_match_set(
        ...
        *,
        config_overrides: Optional[AsyncWAFRegionalClientConfig] = None,
    ) -> "capo_waf_regional.types.update_xss_match_set_response.UpdateXssMatchSetResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_waf_regional.types.update_xss_match_set_request.UpdateXssMatchSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_waf_regional.types.update_xss_match_set_response.UpdateXssMatchSetResponse"
        ]:
            import capo_waf_regional._operations.awswaf_regional_20161128.update_xss_match_set

            (
                output,
                http_response,
            ) = await capo_waf_regional._operations.awswaf_regional_20161128.update_xss_match_set.async_update_xss_match_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_waf_regional.types.update_xss_match_set_request.UpdateXssMatchSetRequest = {}  # type: ignore[typeddict-item]
        input_["xss_match_set_id"] = xss_match_set_id
        input_["change_token"] = change_token
        input_["updates"] = updates
