...
from aws_sdk_waf_regional._rule_engine._endpoint_runtime import EndpointError
import re
import zapros
...
def test_for_region_af_south_1_with_fips_disabled():
    ...
    assert result.url == 'https://waf-regional.af-south-1.amazonaws.com'

def test_for_region_af_south_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.af-south-1.amazonaws.com'
...
def test_for_region_ap_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.ap-east-1.amazonaws.com'

def test_for_region_ap_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.ap-east-1.amazonaws.com'
...
def test_for_region_ap_northeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.ap-northeast-1.amazonaws.com'

def test_for_region_ap_northeast_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.ap-northeast-1.amazonaws.com'
...
def test_for_region_ap_northeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.ap-northeast-2.amazonaws.com'

def test_for_region_ap_northeast_2_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.ap-northeast-2.amazonaws.com'
...
def test_for_region_ap_northeast_3_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.ap-northeast-3.amazonaws.com'

def test_for_region_ap_northeast_3_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.ap-northeast-3.amazonaws.com'
...
def test_for_region_ap_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.ap-south-1.amazonaws.com'

def test_for_region_ap_south_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.ap-south-1.amazonaws.com'
...
def test_for_region_ap_southeast_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.ap-southeast-1.amazonaws.com'

def test_for_region_ap_southeast_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.ap-southeast-1.amazonaws.com'
...
def test_for_region_ap_southeast_2_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.ap-southeast-2.amazonaws.com'

def test_for_region_ap_southeast_2_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.ap-southeast-2.amazonaws.com'
...
def test_for_region_ap_southeast_3_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.ap-southeast-3.amazonaws.com'

def test_for_region_ap_southeast_3_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.ap-southeast-3.amazonaws.com'
...
def test_for_region_ca_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.ca-central-1.amazonaws.com'
...
def test_for_region_ca_central_1_with_fips_enable():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.ca-central-1.amazonaws.com'
...
def test_for_region_eu_central_1_with_fips_disabl():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.eu-central-1.amazonaws.com'

def test_for_region_eu_central_1_with_fips_enable():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.eu-central-1.amazonaws.com'
...
def test_for_region_eu_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.eu-north-1.amazonaws.com'

def test_for_region_eu_north_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.eu-north-1.amazonaws.com'
...
def test_for_region_eu_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.eu-south-1.amazonaws.com'

def test_for_region_eu_south_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.eu-south-1.amazonaws.com'
...
def test_for_region_eu_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.eu-west-1.amazonaws.com'

def test_for_region_eu_west_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.eu-west-1.amazonaws.com'
...
def test_for_region_eu_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.eu-west-2.amazonaws.com'

def test_for_region_eu_west_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.eu-west-2.amazonaws.com'
...
def test_for_region_eu_west_3_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.eu-west-3.amazonaws.com'

def test_for_region_eu_west_3_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.eu-west-3.amazonaws.com'
...
def test_for_region_me_south_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.me-south-1.amazonaws.com'

def test_for_region_me_south_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.me-south-1.amazonaws.com'
...
def test_for_region_sa_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.sa-east-1.amazonaws.com'

def test_for_region_sa_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.sa-east-1.amazonaws.com'
...
def test_for_region_us_east_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.us-east-1.amazonaws.com'
...
def test_for_region_us_east_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.us-east-1.amazonaws.com'
...
def test_for_region_us_east_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.us-east-2.amazonaws.com'
...
def test_for_region_us_east_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.us-east-2.amazonaws.com'
...
def test_for_region_us_west_1_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.us-west-1.amazonaws.com'
...
def test_for_region_us_west_1_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.us-west-1.amazonaws.com'
...
def test_for_region_us_west_2_with_fips_disabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.us-west-2.amazonaws.com'
...
def test_for_region_us_west_2_with_fips_enabled_a():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.us-west-2.amazonaws.com'

def test_for_region_us_east_1_with_fips_enabled_a():
    """For region us-east-1 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.us-east-1.api.aws'

def test_for_region_us_east_1_with_fips_disabled_():
    """For region us-east-1 with FIPS disabled and DualStack enabled"""
    params = EndpointParams(Region='us-east-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://waf-regional.us-east-1.api.aws'
...
def test_for_region_cn_north_1_with_fips_disabled():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.cn-north-1.amazonaws.com.cn'
...
def test_for_region_cn_north_1_with_fips_enabled_():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.cn-north-1.amazonaws.com.cn'
...
def test_for_region_cn_northwest_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.cn-northwest-1.amazonaws.com.cn'
...
def test_for_region_cn_northwest_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.cn-northwest-1.amazonaws.com.cn'

def test_for_region_cn_north_1_with_fips_enabled_():
    """For region cn-north-1 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='cn-north-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.cn-north-1.api.amazonwebservices.com.cn'

def test_for_region_cn_north_1_with_fips_disabled():
    """For region cn-north-1 with FIPS disabled and DualStack enabled"""
    params = EndpointParams(Region='cn-north-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://waf-regional.cn-north-1.api.amazonwebservices.com.cn'
...
def test_for_region_us_gov_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.us-gov-east-1.amazonaws.com'
...
def test_for_region_us_gov_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.us-gov-east-1.amazonaws.com'
...
def test_for_region_us_gov_west_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.us-gov-west-1.amazonaws.com'
...
def test_for_region_us_gov_west_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.us-gov-west-1.amazonaws.com'

def test_for_region_us_gov_east_1_with_fips_enabl():
    """For region us-gov-east-1 with FIPS enabled and DualStack enabled"""
    params = EndpointParams(Region='us-gov-east-1', UseFIPS=True, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.us-gov-east-1.api.aws'

def test_for_region_us_gov_east_1_with_fips_disab():
    """For region us-gov-east-1 with FIPS disabled and DualStack enabled"""
    params = EndpointParams(Region='us-gov-east-1', UseFIPS=False, UseDualStack=True)
    result = resolve(params)
    assert result.url == 'https://waf-regional.us-gov-east-1.api.aws'
...
def test_for_region_us_iso_east_1_with_fips_enabl():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.us-iso-east-1.c2s.ic.gov'
...
def test_for_region_us_iso_east_1_with_fips_disab():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.us-iso-east-1.c2s.ic.gov'
...
def test_for_region_us_isob_east_1_with_fips_enab():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional-fips.us-isob-east-1.sc2s.sgov.gov'
...
def test_for_region_us_isob_east_1_with_fips_disa():
    ...
    result = resolve(params)
    assert result.url == 'https://waf-regional.us-isob-east-1.sc2s.sgov.gov'
