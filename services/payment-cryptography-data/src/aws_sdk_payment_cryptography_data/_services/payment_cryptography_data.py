...
from aws_sdk_payment_cryptography_data._services._aws_config import aws_config
...
class PaymentCryptographyDataClient:
    ...
    def decrypt_data(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography_data.types.decrypt_data_input.DecryptDataInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography_data.types.decrypt_data_output.DecryptDataOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography_data._operations.payment_cryptography_data_plane.decrypt_data.decrypt_data(
    ...
    def encrypt_data(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography_data.types.encrypt_data_input.EncryptDataInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography_data.types.encrypt_data_output.EncryptDataOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography_data._operations.payment_cryptography_data_plane.encrypt_data.encrypt_data(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def generate_as2805_kek_validation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography_data.types.generate_as2805_kek_validation_input.GenerateAs2805KekValidationInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography_data.types.generate_as2805_kek_validation_output.GenerateAs2805KekValidationOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography_data._operations.payment_cryptography_data_plane.generate_as2805_kek_validation.generate_as2805_kek_validation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def generate_auth_request_cryptogram(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography_data.types.generate_auth_request_cryptogram_input.GenerateAuthRequestCryptogramInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography_data.types.generate_auth_request_cryptogram_output.GenerateAuthRequestCryptogramOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography_data._operations.payment_cryptography_data_plane.generate_auth_request_cryptogram.generate_auth_request_cryptogram(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def generate_card_validation_data(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography_data.types.generate_card_validation_data_input.GenerateCardValidationDataInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography_data.types.generate_card_validation_data_output.GenerateCardValidationDataOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography_data._operations.payment_cryptography_data_plane.generate_card_validation_data.generate_card_validation_data(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def generate_mac(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography_data.types.generate_mac_input.GenerateMacInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography_data.types.generate_mac_output.GenerateMacOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography_data._operations.payment_cryptography_data_plane.generate_mac.generate_mac(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def generate_mac_emv_pin_change(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography_data.types.generate_mac_emv_pin_change_input.GenerateMacEmvPinChangeInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography_data.types.generate_mac_emv_pin_change_output.GenerateMacEmvPinChangeOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography_data._operations.payment_cryptography_data_plane.generate_mac_emv_pin_change.generate_mac_emv_pin_change(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def generate_pin_data(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography_data.types.generate_pin_data_input.GeneratePinDataInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography_data.types.generate_pin_data_output.GeneratePinDataOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography_data._operations.payment_cryptography_data_plane.generate_pin_data.generate_pin_data(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def re_encrypt_data(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography_data.types.re_encrypt_data_input.ReEncryptDataInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography_data.types.re_encrypt_data_output.ReEncryptDataOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography_data._operations.payment_cryptography_data_plane.re_encrypt_data.re_encrypt_data(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def translate_key_material(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography_data.types.translate_key_material_input.TranslateKeyMaterialInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography_data.types.translate_key_material_output.TranslateKeyMaterialOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography_data._operations.payment_cryptography_data_plane.translate_key_material.translate_key_material(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def translate_pin_data(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography_data.types.translate_pin_data_input.TranslatePinDataInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography_data.types.translate_pin_data_output.TranslatePinDataOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography_data._operations.payment_cryptography_data_plane.translate_pin_data.translate_pin_data(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def verify_auth_request_cryptogram(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography_data.types.verify_auth_request_cryptogram_input.VerifyAuthRequestCryptogramInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography_data.types.verify_auth_request_cryptogram_output.VerifyAuthRequestCryptogramOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography_data._operations.payment_cryptography_data_plane.verify_auth_request_cryptogram.verify_auth_request_cryptogram(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def verify_card_validation_data(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography_data.types.verify_card_validation_data_input.VerifyCardValidationDataInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography_data.types.verify_card_validation_data_output.VerifyCardValidationDataOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography_data._operations.payment_cryptography_data_plane.verify_card_validation_data.verify_card_validation_data(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def verify_mac(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography_data.types.verify_mac_input.VerifyMacInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography_data.types.verify_mac_output.VerifyMacOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography_data._operations.payment_cryptography_data_plane.verify_mac.verify_mac(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def verify_pin_data(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[aws_sdk_payment_cryptography_data.types.verify_pin_data_input.VerifyPinDataInput]",
        ) -> OperationResponse[
            "aws_sdk_payment_cryptography_data.types.verify_pin_data_output.VerifyPinDataOutput"
        ]:
            ...
            output, http_response = (
                aws_sdk_payment_cryptography_data._operations.payment_cryptography_data_plane.verify_pin_data.verify_pin_data(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
