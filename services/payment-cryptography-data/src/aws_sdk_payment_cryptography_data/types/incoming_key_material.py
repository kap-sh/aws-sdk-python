...
def serialize_json(value: IncomingKeyMaterial) -> dict:
    if "DiffieHellmanTr31KeyBlock" in value:
        ...
        return {
            "DiffieHellmanTr31KeyBlock": aws_sdk_payment_cryptography_data.types.incoming_diffie_hellman_tr31_key_block.serialize_json(
...
def deserialize_json(data: dict) -> IncomingKeyMaterial:
    if "DiffieHellmanTr31KeyBlock" in data:
        ...
        return {
            "DiffieHellmanTr31KeyBlock": aws_sdk_payment_cryptography_data.types.incoming_diffie_hellman_tr31_key_block.deserialize_json(
