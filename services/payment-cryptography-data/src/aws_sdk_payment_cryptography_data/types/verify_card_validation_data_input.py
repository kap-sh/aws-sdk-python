...
class VerifyCardValidationDataInput(TypedDict):
...
def serialize_json(value: VerifyCardValidationDataInput) -> dict:
    ...
    out["VerificationAttributes"] = (
        aws_sdk_payment_cryptography_data.types.card_verification_attributes.serialize_json(
...
def deserialize_json(data: dict) -> VerifyCardValidationDataInput:
    ...
    if "VerificationAttributes" in data:
        ...
        out["verification_attributes"] = (
            aws_sdk_payment_cryptography_data.types.card_verification_attributes.deserialize_json(
