...
if TYPE_CHECKING:
    ...
    import aws_sdk_payment_cryptography_data.types.pin_change_mac_output_type
...
class GenerateMacEmvPinChangeOutput(TypedDict, closed=True):
    ...
    mac: "aws_sdk_payment_cryptography_data.types.pin_change_mac_output_type.PinChangeMacOutputType"
    ...
    visa_amex_derivation_outputs: NotRequired[
        "aws_sdk_payment_cryptography_data.types.visa_amex_derivation_outputs.VisaAmexDerivationOutputs"
    ]
...
def serialize_json(value: GenerateMacEmvPinChangeOutput) -> dict:
    ...
    if "visa_amex_derivation_outputs" in value:
        ...
        out["VisaAmexDerivationOutputs"] = (
            aws_sdk_payment_cryptography_data.types.visa_amex_derivation_outputs.serialize_json(
...
def deserialize_json(data: dict) -> GenerateMacEmvPinChangeOutput:
    ...
    if "VisaAmexDerivationOutputs" in data:
        ...
        out["visa_amex_derivation_outputs"] = (
            aws_sdk_payment_cryptography_data.types.visa_amex_derivation_outputs.deserialize_json(
