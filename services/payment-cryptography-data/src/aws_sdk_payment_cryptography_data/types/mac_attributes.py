...
if TYPE_CHECKING:
    import aws_sdk_payment_cryptography_data.types.mac_algorithm
    import aws_sdk_payment_cryptography_data.types.mac_algorithm_dukpt
...
def serialize_json(value: MacAttributes) -> dict:
    if "Algorithm" in value:
        ...
        return {
            "Algorithm": aws_sdk_payment_cryptography_data.types.mac_algorithm.serialize_json(
                value["Algorithm"]
            )
        }
        ...
        return {
            "EmvMac": aws_sdk_payment_cryptography_data.types.mac_algorithm_emv.serialize_json(
                value["EmvMac"]
            )
        }
        ...
        return {
            "DukptIso9797Algorithm1": aws_sdk_payment_cryptography_data.types.mac_algorithm_dukpt.serialize_json(
        ...
        return {
            "DukptIso9797Algorithm3": aws_sdk_payment_cryptography_data.types.mac_algorithm_dukpt.serialize_json(
        ...
        return {
            "DukptCmac": aws_sdk_payment_cryptography_data.types.mac_algorithm_dukpt.serialize_json(
                value["DukptCmac"]
            )
        }
    else:
...
def deserialize_json(data: dict) -> MacAttributes:
    if "Algorithm" in data:
        ...
        return {
            "Algorithm": aws_sdk_payment_cryptography_data.types.mac_algorithm.deserialize_json(
                data["Algorithm"]
            )
        }
    elif "EmvMac" in data:
        ...
        return {
            "EmvMac": aws_sdk_payment_cryptography_data.types.mac_algorithm_emv.deserialize_json(
                data["EmvMac"]
            )
        }
        ...
        return {
            "DukptIso9797Algorithm1": aws_sdk_payment_cryptography_data.types.mac_algorithm_dukpt.deserialize_json(
        ...
        return {
            "DukptIso9797Algorithm3": aws_sdk_payment_cryptography_data.types.mac_algorithm_dukpt.deserialize_json(
        ...
        return {
            "DukptCmac": aws_sdk_payment_cryptography_data.types.mac_algorithm_dukpt.deserialize_json(
                data["DukptCmac"]
            )
        }
    else:
