...
if TYPE_CHECKING:
    ...
    import aws_sdk_payment_cryptography_data.types.emv_major_key_derivation_mode
...
class EmvEncryptionAttributes(TypedDict, closed=True):
    ...
    session_derivation_data: "aws_sdk_payment_cryptography_data.types.session_derivation_data_type.SessionDerivationDataType"
...
def serialize_json(value: EmvEncryptionAttributes) -> dict:
    ...
    out["MajorKeyDerivationMode"] = (
        aws_sdk_payment_cryptography_data.types.emv_major_key_derivation_mode.serialize_json(
...
def deserialize_json(data: dict) -> EmvEncryptionAttributes:
    ...
    if "MajorKeyDerivationMode" in data:
        ...
        out["major_key_derivation_mode"] = (
            aws_sdk_payment_cryptography_data.types.emv_major_key_derivation_mode.deserialize_json(
