...
class VerifyPinDataOutput(TypedDict, closed=True):
    verification_key_arn: "capo_payment_cryptography_data.types.key_arn.KeyArn"
    ...
    encryption_key_arn: "capo_payment_cryptography_data.types.key_arn.KeyArn"
