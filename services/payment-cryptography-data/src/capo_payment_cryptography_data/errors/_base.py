...
class PaymentCryptographyDataError(Exception):
    """Base class for all PaymentCryptographyData service errors."""


class ServiceError(PaymentCryptographyDataError):
...
class SerializationError(PaymentCryptographyDataError):
    """Raised when a value cannot be serialized."""


class DeserializationError(PaymentCryptographyDataError):
...
class WaiterFailedError(PaymentCryptographyDataError):
...
class WaiterTimeoutError(PaymentCryptographyDataError):
