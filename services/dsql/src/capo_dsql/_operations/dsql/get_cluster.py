...
def handle_response(
    ...
    out: capo_dsql.types.get_cluster_output.GetClusterOutput = (
        capo_dsql.types.get_cluster_output.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_dsql.types.get_cluster_output.GetClusterOutput = (
        capo_dsql.types.get_cluster_output.deserialize_json(
...
def get_cluster(
    options: OperationOptions, input_: capo_dsql.types.get_cluster_input.GetClusterInput
) -> tuple[capo_dsql.types.get_cluster_output.GetClusterOutput, zapros.Response]:
