"""Generated from Smithy shape ``com.amazonaws.dsql#DeleteCluster``."""
...
def handle_response(
    ...
    out: capo_dsql.types.delete_cluster_output.DeleteClusterOutput = (
        capo_dsql.types.delete_cluster_output.deserialize_json(
...
def build_request(
    ...
    if "client_token" in input_:
        params["client-token"] = str(input_["client_token"])
...
def delete_cluster(
    ...
    input_: capo_dsql.types.delete_cluster_input.DeleteClusterInput,
) -> tuple[capo_dsql.types.delete_cluster_output.DeleteClusterOutput, zapros.Response]:
