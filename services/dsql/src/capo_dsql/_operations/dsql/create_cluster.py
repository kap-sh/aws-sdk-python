...
import capo_dsql.errors.conflict_exception
import capo_dsql.errors.internal_server_exception
import capo_dsql.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_dsql.errors.conflict_exception.ConflictException.from_json(data)
        case "ServiceQuotaExceededException":
            raise capo_dsql.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data
            )
        case _:
...
def handle_response(
    ...
    out: capo_dsql.types.create_cluster_output.CreateClusterOutput = (
        capo_dsql.types.create_cluster_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dsql.types.create_cluster_input.serialize_json(input_)
    ).encode()
...
def create_cluster(
    ...
    input_: capo_dsql.types.create_cluster_input.CreateClusterInput,
) -> tuple[capo_dsql.types.create_cluster_output.CreateClusterOutput, zapros.Response]:
