...
from aws_sdk_dsql._auth._signers import SigV4Signer
from aws_sdk_dsql._auth._sigv4 import presign_sigv4
...
from aws_sdk_dsql._services._pipeline import AsyncInterceptor, AsyncOperationOptions, AsyncOperationRequest, AsyncOperationResponse, aexecute_pipeline, aretry
from aws_sdk_dsql._async import anysleep
import time
from aws_sdk_dsql.errors import ServiceError, WaiterFailedError, WaiterTimeoutError
import warnings
import aws_sdk_dsql._auth._signers
import aws_sdk_dsql._auth._sigv4
from aws_sdk_dsql._auth._identity import Credentials
from aws_sdk_dsql._auth._providers import CredentialsProvider, StaticAwsCredentialsProvider
if TYPE_CHECKING:
...
class AsyncDSQLClient:
    ...
    def __init__(self, http_handler: AsyncBaseHandler | None = None, operation_interceptors: Iterable[AsyncInterceptor[Any, Any]] | None = None, retry_max_attempts: int | None = None, use_fips: bool | None = None, endpoint: str | None = None, region: str | None = None, credentials: Credentials | None = None, credentials_provider: CredentialsProvider | None = None):
        ...
        self.config = AsyncDSQLClientConfig({"operation_interceptors": operation_interceptors or [], "retry_max_attempts": DEFAULT_RETRY_MAX_ATTEMPTS if retry_max_attempts is None else retry_max_attempts, "use_fips": use_fips, "endpoint": endpoint, "region": region, "credentials_provider": credentials_provider})
    def operation_options(self, config_overrides: Optional[AsyncDSQLClientConfig] = None) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
    ...
    async def list_tags_for_resource(self, resource_arn: "aws_sdk_dsql.types.arn.Arn", *, config_overrides: Optional[AsyncDSQLClientConfig] = None) -> "aws_sdk_dsql.types.list_tags_for_resource_output.ListTagsForResourceOutput":
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_dsql.types.list_tags_for_resource_input.ListTagsForResourceInput]') -> AsyncOperationResponse["aws_sdk_dsql.types.list_tags_for_resource_output.ListTagsForResourceOutput"]:
            import aws_sdk_dsql._operations.dsql.list_tags_for_resource
            output, http_response = await aws_sdk_dsql._operations.dsql.list_tags_for_resource.async_list_tags_for_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_dsql.types.list_tags_for_resource_input.ListTagsForResourceInput = {}  # type: ignore[typeddict-item]
        input["resource_arn"] = resource_arn

        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def tag_resource(self, resource_arn: "aws_sdk_dsql.types.arn.Arn", tags: "aws_sdk_dsql.types.tag_map.TagMap", *, config_overrides: Optional[AsyncDSQLClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_dsql.types.tag_resource_input.TagResourceInput]') -> AsyncOperationResponse[None]:
            import aws_sdk_dsql._operations.dsql.tag_resource
            output, http_response = await aws_sdk_dsql._operations.dsql.tag_resource.async_tag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_dsql.types.tag_resource_input.TagResourceInput = {}  # type: ignore[typeddict-item]
        input["resource_arn"] = resource_arn
        input["tags"] = tags

        response = await aexecute_pipeline(AsyncOperationRequest(input=input, options=options_), handler=_handler, interceptors=list(interceptors_))
        return response.output
    async def untag_resource(self, resource_arn: "aws_sdk_dsql.types.arn.Arn", tag_keys: "aws_sdk_dsql.types.tag_key_list.TagKeyList", *, config_overrides: Optional[AsyncDSQLClientConfig] = None) -> None:
        ...
        """
        async def _handler(req: 'AsyncOperationRequest[aws_sdk_dsql.types.untag_resource_input.UntagResourceInput]') -> AsyncOperationResponse[None]:
            import aws_sdk_dsql._operations.dsql.untag_resource
            output, http_response = await aws_sdk_dsql._operations.dsql.untag_resource.async_untag_resource(req.options, req.input)
            return AsyncOperationResponse(output=output, response=http_response)

        interceptors_, options_ = self.operation_options(config_overrides)
        input: aws_sdk_dsql.types.untag_resource_input.UntagResourceInput = {}  # type: ignore[typeddict-item]
        input["resource_arn"] = resource_arn
